...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.ListDefaultVocabulariesRequest();
  });
  ...
  describe('ListDefaultVocabulariesRequest', function() {
    it('should create an instance of ListDefaultVocabulariesRequest', function() {
      // uncomment below and update the code to test ListDefaultVocabulariesRequest
      //var instance = new AmazonConnectService.ListDefaultVocabulariesRequest();
      //expect(instance).to.be.a(AmazonConnectService.ListDefaultVocabulariesRequest);
    });
