...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.DescribeEvaluationFormResponseEvaluationForm();
  });
  ...
  describe('DescribeEvaluationFormResponseEvaluationForm', function() {
    it('should create an instance of DescribeEvaluationFormResponseEvaluationForm', function() {
      // uncomment below and update the code to test DescribeEvaluationFormResponseEvaluationForm
      //var instance = new AmazonConnectService.DescribeEvaluationFormResponseEvaluationForm();
      //expect(instance).to.be.a(AmazonConnectService.DescribeEvaluationFormResponseEvaluationForm);
    });
