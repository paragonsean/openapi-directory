...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.StopContactRequest();
  });
  ...
  describe('StopContactRequest', function() {
    it('should create an instance of StopContactRequest', function() {
      // uncomment below and update the code to test StopContactRequest
      //var instance = new AmazonConnectService.StopContactRequest();
      //expect(instance).to.be.a(AmazonConnectService.StopContactRequest);
    });
