...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.GetCurrentUserDataRequest();
  });
  ...
  describe('GetCurrentUserDataRequest', function() {
    it('should create an instance of GetCurrentUserDataRequest', function() {
      // uncomment below and update the code to test GetCurrentUserDataRequest
      //var instance = new AmazonConnectService.GetCurrentUserDataRequest();
      //expect(instance).to.be.a(AmazonConnectService.GetCurrentUserDataRequest);
    });
