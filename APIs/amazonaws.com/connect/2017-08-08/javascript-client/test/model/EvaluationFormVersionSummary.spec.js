...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormVersionSummary();
  });
  ...
  describe('EvaluationFormVersionSummary', function() {
    it('should create an instance of EvaluationFormVersionSummary', function() {
      // uncomment below and update the code to test EvaluationFormVersionSummary
      //var instance = new AmazonConnectService.EvaluationFormVersionSummary();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormVersionSummary);
    });
