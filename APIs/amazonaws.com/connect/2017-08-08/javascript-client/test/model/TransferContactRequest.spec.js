...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.TransferContactRequest();
  });
  ...
  describe('TransferContactRequest', function() {
    it('should create an instance of TransferContactRequest', function() {
      // uncomment below and update the code to test TransferContactRequest
      //var instance = new AmazonConnectService.TransferContactRequest();
      //expect(instance).to.be.a(AmazonConnectService.TransferContactRequest);
    });
