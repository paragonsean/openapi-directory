...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchHoursOfOperationsRequestSearchCriteria();
  });
  ...
  describe('SearchHoursOfOperationsRequestSearchCriteria', function() {
    it('should create an instance of SearchHoursOfOperationsRequestSearchCriteria', function() {
      // uncomment below and update the code to test SearchHoursOfOperationsRequestSearchCriteria
      //var instance = new AmazonConnectService.SearchHoursOfOperationsRequestSearchCriteria();
      //expect(instance).to.be.a(AmazonConnectService.SearchHoursOfOperationsRequestSearchCriteria);
    });
