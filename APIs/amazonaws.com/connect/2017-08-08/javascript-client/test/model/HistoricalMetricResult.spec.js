...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.HistoricalMetricResult();
  });
  ...
  describe('HistoricalMetricResult', function() {
    it('should create an instance of HistoricalMetricResult', function() {
      // uncomment below and update the code to test HistoricalMetricResult
      //var instance = new AmazonConnectService.HistoricalMetricResult();
      //expect(instance).to.be.a(AmazonConnectService.HistoricalMetricResult);
    });
