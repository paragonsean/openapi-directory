...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchQueuesRequest();
  });
  ...
  describe('SearchQueuesRequest', function() {
    it('should create an instance of SearchQueuesRequest', function() {
      // uncomment below and update the code to test SearchQueuesRequest
      //var instance = new AmazonConnectService.SearchQueuesRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchQueuesRequest);
    });
