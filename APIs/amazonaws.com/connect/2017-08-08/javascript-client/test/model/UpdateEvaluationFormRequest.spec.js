...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.UpdateEvaluationFormRequest();
  });
  ...
  describe('UpdateEvaluationFormRequest', function() {
    it('should create an instance of UpdateEvaluationFormRequest', function() {
      // uncomment below and update the code to test UpdateEvaluationFormRequest
      //var instance = new AmazonConnectService.UpdateEvaluationFormRequest();
      //expect(instance).to.be.a(AmazonConnectService.UpdateEvaluationFormRequest);
    });
    ...
    it('should have the property createNewVersion (base name: "CreateNewVersion")', function() {
      // uncomment below and update the code to test the property createNewVersion
      //var instance = new AmazonConnectService.UpdateEvaluationFormRequest();
      //expect(instance).to.be();
    });
