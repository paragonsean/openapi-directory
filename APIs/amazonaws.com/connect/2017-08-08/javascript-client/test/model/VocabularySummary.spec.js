...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.VocabularySummary();
  });
  ...
  describe('VocabularySummary', function() {
    it('should create an instance of VocabularySummary', function() {
      // uncomment below and update the code to test VocabularySummary
      //var instance = new AmazonConnectService.VocabularySummary();
      //expect(instance).to.be.a(AmazonConnectService.VocabularySummary);
    });
