...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.StartContactEvaluationRequest();
  });
  ...
  describe('StartContactEvaluationRequest', function() {
    it('should create an instance of StartContactEvaluationRequest', function() {
      // uncomment below and update the code to test StartContactEvaluationRequest
      //var instance = new AmazonConnectService.StartContactEvaluationRequest();
      //expect(instance).to.be.a(AmazonConnectService.StartContactEvaluationRequest);
    });
