...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchSecurityProfilesRequest();
  });
  ...
  describe('SearchSecurityProfilesRequest', function() {
    it('should create an instance of SearchSecurityProfilesRequest', function() {
      // uncomment below and update the code to test SearchSecurityProfilesRequest
      //var instance = new AmazonConnectService.SearchSecurityProfilesRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchSecurityProfilesRequest);
    });
