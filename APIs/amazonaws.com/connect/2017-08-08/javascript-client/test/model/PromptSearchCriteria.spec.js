...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.PromptSearchCriteria();
  });
  ...
  describe('PromptSearchCriteria', function() {
    it('should create an instance of PromptSearchCriteria', function() {
      // uncomment below and update the code to test PromptSearchCriteria
      //var instance = new AmazonConnectService.PromptSearchCriteria();
      //expect(instance).to.be.a(AmazonConnectService.PromptSearchCriteria);
    });
