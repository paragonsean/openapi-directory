...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.GetMetricDataRequest();
  });
  ...
  describe('GetMetricDataRequest', function() {
    it('should create an instance of GetMetricDataRequest', function() {
      // uncomment below and update the code to test GetMetricDataRequest
      //var instance = new AmazonConnectService.GetMetricDataRequest();
      //expect(instance).to.be.a(AmazonConnectService.GetMetricDataRequest);
    });
    ...
    it('should have the property historicalMetrics (base name: "HistoricalMetrics")', function() {
      // uncomment below and update the code to test the property historicalMetrics
      //var instance = new AmazonConnectService.GetMetricDataRequest();
      //expect(instance).to.be();
    });
