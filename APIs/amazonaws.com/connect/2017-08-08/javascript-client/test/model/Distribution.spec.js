...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.Distribution();
  });
  ...
  describe('Distribution', function() {
    it('should create an instance of Distribution', function() {
      ...
      //var instance = new AmazonConnectService.Distribution();
      //expect(instance).to.be.a(AmazonConnectService.Distribution);
    });
