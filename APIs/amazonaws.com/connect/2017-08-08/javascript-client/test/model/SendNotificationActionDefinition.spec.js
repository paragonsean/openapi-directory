...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SendNotificationActionDefinition();
  });
  ...
  describe('SendNotificationActionDefinition', function() {
    it('should create an instance of SendNotificationActionDefinition', function() {
      // uncomment below and update the code to test SendNotificationActionDefinition
      //var instance = new AmazonConnectService.SendNotificationActionDefinition();
      //expect(instance).to.be.a(AmazonConnectService.SendNotificationActionDefinition);
    });
