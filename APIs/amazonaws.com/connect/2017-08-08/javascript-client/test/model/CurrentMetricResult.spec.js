...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.CurrentMetricResult();
  });
  ...
  describe('CurrentMetricResult', function() {
    it('should create an instance of CurrentMetricResult', function() {
      // uncomment below and update the code to test CurrentMetricResult
      //var instance = new AmazonConnectService.CurrentMetricResult();
      //expect(instance).to.be.a(AmazonConnectService.CurrentMetricResult);
    });
