...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchRoutingProfilesRequest();
  });
  ...
  describe('SearchRoutingProfilesRequest', function() {
    it('should create an instance of SearchRoutingProfilesRequest', function() {
      // uncomment below and update the code to test SearchRoutingProfilesRequest
      //var instance = new AmazonConnectService.SearchRoutingProfilesRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchRoutingProfilesRequest);
    });
