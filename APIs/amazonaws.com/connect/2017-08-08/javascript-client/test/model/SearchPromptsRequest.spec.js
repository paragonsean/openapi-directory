...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchPromptsRequest();
  });
  ...
  describe('SearchPromptsRequest', function() {
    it('should create an instance of SearchPromptsRequest', function() {
      // uncomment below and update the code to test SearchPromptsRequest
      //var instance = new AmazonConnectService.SearchPromptsRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchPromptsRequest);
    });
