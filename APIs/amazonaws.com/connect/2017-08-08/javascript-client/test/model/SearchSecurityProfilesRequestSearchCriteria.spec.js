...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchSecurityProfilesRequestSearchCriteria();
  });
  ...
  describe('SearchSecurityProfilesRequestSearchCriteria', function() {
    it('should create an instance of SearchSecurityProfilesRequestSearchCriteria', function() {
      // uncomment below and update the code to test SearchSecurityProfilesRequestSearchCriteria
      //var instance = new AmazonConnectService.SearchSecurityProfilesRequestSearchCriteria();
      //expect(instance).to.be.a(AmazonConnectService.SearchSecurityProfilesRequestSearchCriteria);
    });
