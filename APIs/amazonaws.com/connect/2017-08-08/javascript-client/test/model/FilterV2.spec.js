...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.FilterV2();
  });
  ...
  describe('FilterV2', function() {
    it('should create an instance of FilterV2', function() {
      // uncomment below and update the code to test FilterV2
      //var instance = new AmazonConnectService.FilterV2();
      //expect(instance).to.be.a(AmazonConnectService.FilterV2);
    });
