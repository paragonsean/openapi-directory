...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.UserReference();
  });
  ...
  describe('UserReference', function() {
    it('should create an instance of UserReference', function() {
      ...
      //var instance = new AmazonConnectService.UserReference();
      //expect(instance).to.be.a(AmazonConnectService.UserReference);
    });
