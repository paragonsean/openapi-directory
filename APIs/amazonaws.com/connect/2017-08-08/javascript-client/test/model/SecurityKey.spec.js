...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SecurityKey();
  });
  ...
  describe('SecurityKey', function() {
    it('should create an instance of SecurityKey', function() {
      ...
      //var instance = new AmazonConnectService.SecurityKey();
      //expect(instance).to.be.a(AmazonConnectService.SecurityKey);
    });
