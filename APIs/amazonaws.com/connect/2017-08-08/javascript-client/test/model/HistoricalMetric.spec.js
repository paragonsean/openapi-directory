...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.HistoricalMetric();
  });
  ...
  describe('HistoricalMetric', function() {
    it('should create an instance of HistoricalMetric', function() {
      // uncomment below and update the code to test HistoricalMetric
      //var instance = new AmazonConnectService.HistoricalMetric();
      //expect(instance).to.be.a(AmazonConnectService.HistoricalMetric);
    });
