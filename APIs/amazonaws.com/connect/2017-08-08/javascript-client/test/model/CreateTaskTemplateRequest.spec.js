...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.CreateTaskTemplateRequest();
  });
  ...
  describe('CreateTaskTemplateRequest', function() {
    it('should create an instance of CreateTaskTemplateRequest', function() {
      // uncomment below and update the code to test CreateTaskTemplateRequest
      //var instance = new AmazonConnectService.CreateTaskTemplateRequest();
      //expect(instance).to.be.a(AmazonConnectService.CreateTaskTemplateRequest);
    });
