...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormNumericQuestionProperties();
  });
  ...
  describe('EvaluationFormNumericQuestionProperties', function() {
    it('should create an instance of EvaluationFormNumericQuestionProperties', function() {
      // uncomment below and update the code to test EvaluationFormNumericQuestionProperties
      //var instance = new AmazonConnectService.EvaluationFormNumericQuestionProperties();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormNumericQuestionProperties);
    });
