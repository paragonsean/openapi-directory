...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.StartTaskContactRequest();
  });
  ...
  describe('StartTaskContactRequest', function() {
    it('should create an instance of StartTaskContactRequest', function() {
      // uncomment below and update the code to test StartTaskContactRequest
      //var instance = new AmazonConnectService.StartTaskContactRequest();
      //expect(instance).to.be.a(AmazonConnectService.StartTaskContactRequest);
    });
