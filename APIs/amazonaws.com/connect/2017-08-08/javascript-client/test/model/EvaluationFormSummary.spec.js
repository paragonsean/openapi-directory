...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormSummary();
  });
  ...
  describe('EvaluationFormSummary', function() {
    it('should create an instance of EvaluationFormSummary', function() {
      // uncomment below and update the code to test EvaluationFormSummary
      //var instance = new AmazonConnectService.EvaluationFormSummary();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormSummary);
    });
    ...
    it('should have the property lastActivatedTime (base name: "LastActivatedTime")', function() {
      // uncomment below and update the code to test the property lastActivatedTime
      //var instance = new AmazonConnectService.EvaluationFormSummary();
      //expect(instance).to.be();
    });

    it('should have the property lastActivatedBy (base name: "LastActivatedBy")', function() {
      // uncomment below and update the code to test the property lastActivatedBy
      //var instance = new AmazonConnectService.EvaluationFormSummary();
      //expect(instance).to.be();
    });
