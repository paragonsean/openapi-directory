...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SuspendContactRecordingRequest();
  });
  ...
  describe('SuspendContactRecordingRequest', function() {
    it('should create an instance of SuspendContactRecordingRequest', function() {
      // uncomment below and update the code to test SuspendContactRecordingRequest
      //var instance = new AmazonConnectService.SuspendContactRecordingRequest();
      //expect(instance).to.be.a(AmazonConnectService.SuspendContactRecordingRequest);
    });
