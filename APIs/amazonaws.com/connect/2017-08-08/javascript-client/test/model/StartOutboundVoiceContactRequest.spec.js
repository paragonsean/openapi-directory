...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.StartOutboundVoiceContactRequest();
  });
  ...
  describe('StartOutboundVoiceContactRequest', function() {
    it('should create an instance of StartOutboundVoiceContactRequest', function() {
      // uncomment below and update the code to test StartOutboundVoiceContactRequest
      //var instance = new AmazonConnectService.StartOutboundVoiceContactRequest();
      //expect(instance).to.be.a(AmazonConnectService.StartOutboundVoiceContactRequest);
    });
    ...
    it('should have the property sourcePhoneNumber (base name: "SourcePhoneNumber")', function() {
      // uncomment below and update the code to test the property sourcePhoneNumber
      //var instance = new AmazonConnectService.StartOutboundVoiceContactRequest();
      //expect(instance).to.be();
    });
