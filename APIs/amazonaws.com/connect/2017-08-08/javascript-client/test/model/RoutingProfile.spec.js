...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.RoutingProfile();
  });
  ...
  describe('RoutingProfile', function() {
    it('should create an instance of RoutingProfile', function() {
      // uncomment below and update the code to test RoutingProfile
      //var instance = new AmazonConnectService.RoutingProfile();
      //expect(instance).to.be.a(AmazonConnectService.RoutingProfile);
    });
