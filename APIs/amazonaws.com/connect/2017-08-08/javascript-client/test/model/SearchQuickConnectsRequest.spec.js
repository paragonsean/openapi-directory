...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchQuickConnectsRequest();
  });
  ...
  describe('SearchQuickConnectsRequest', function() {
    it('should create an instance of SearchQuickConnectsRequest', function() {
      // uncomment below and update the code to test SearchQuickConnectsRequest
      //var instance = new AmazonConnectService.SearchQuickConnectsRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchQuickConnectsRequest);
    });
