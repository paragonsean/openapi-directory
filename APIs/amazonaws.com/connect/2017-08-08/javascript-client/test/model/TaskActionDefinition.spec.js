...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.TaskActionDefinition();
  });
  ...
  describe('TaskActionDefinition', function() {
    it('should create an instance of TaskActionDefinition', function() {
      // uncomment below and update the code to test TaskActionDefinition
      //var instance = new AmazonConnectService.TaskActionDefinition();
      //expect(instance).to.be.a(AmazonConnectService.TaskActionDefinition);
    });
