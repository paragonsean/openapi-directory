...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchResourceTagsRequest();
  });
  ...
  describe('SearchResourceTagsRequest', function() {
    it('should create an instance of SearchResourceTagsRequest', function() {
      // uncomment below and update the code to test SearchResourceTagsRequest
      //var instance = new AmazonConnectService.SearchResourceTagsRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchResourceTagsRequest);
    });
