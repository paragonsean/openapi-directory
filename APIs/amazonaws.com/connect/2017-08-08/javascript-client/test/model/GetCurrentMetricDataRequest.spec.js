...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.GetCurrentMetricDataRequest();
  });
  ...
  describe('GetCurrentMetricDataRequest', function() {
    it('should create an instance of GetCurrentMetricDataRequest', function() {
      // uncomment below and update the code to test GetCurrentMetricDataRequest
      //var instance = new AmazonConnectService.GetCurrentMetricDataRequest();
      //expect(instance).to.be.a(AmazonConnectService.GetCurrentMetricDataRequest);
    });
