...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.ReferenceSummary();
  });
  ...
  describe('ReferenceSummary', function() {
    it('should create an instance of ReferenceSummary', function() {
      // uncomment below and update the code to test ReferenceSummary
      //var instance = new AmazonConnectService.ReferenceSummary();
      //expect(instance).to.be.a(AmazonConnectService.ReferenceSummary);
    });
