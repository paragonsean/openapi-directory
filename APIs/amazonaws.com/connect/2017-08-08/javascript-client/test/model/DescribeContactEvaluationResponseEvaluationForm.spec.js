...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.DescribeContactEvaluationResponseEvaluationForm();
  });
  ...
  describe('DescribeContactEvaluationResponseEvaluationForm', function() {
    it('should create an instance of DescribeContactEvaluationResponseEvaluationForm', function() {
      // uncomment below and update the code to test DescribeContactEvaluationResponseEvaluationForm
      //var instance = new AmazonConnectService.DescribeContactEvaluationResponseEvaluationForm();
      //expect(instance).to.be.a(AmazonConnectService.DescribeContactEvaluationResponseEvaluationForm);
    });
