...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormQuestionTypePropertiesNumeric();
  });
  ...
  describe('EvaluationFormQuestionTypePropertiesNumeric', function() {
    it('should create an instance of EvaluationFormQuestionTypePropertiesNumeric', function() {
      // uncomment below and update the code to test EvaluationFormQuestionTypePropertiesNumeric
      //var instance = new AmazonConnectService.EvaluationFormQuestionTypePropertiesNumeric();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormQuestionTypePropertiesNumeric);
    });
