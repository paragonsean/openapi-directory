...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.EvaluationFormItem();
  });
  ...
  describe('EvaluationFormItem', function() {
    it('should create an instance of EvaluationFormItem', function() {
      // uncomment below and update the code to test EvaluationFormItem
      //var instance = new AmazonConnectService.EvaluationFormItem();
      //expect(instance).to.be.a(AmazonConnectService.EvaluationFormItem);
    });
