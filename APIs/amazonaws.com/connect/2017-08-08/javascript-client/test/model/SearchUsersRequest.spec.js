...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchUsersRequest();
  });
  ...
  describe('SearchUsersRequest', function() {
    it('should create an instance of SearchUsersRequest', function() {
      ...
      //var instance = new AmazonConnectService.SearchUsersRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchUsersRequest);
    });
