...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.UserSearchCriteria();
  });
  ...
  describe('UserSearchCriteria', function() {
    it('should create an instance of UserSearchCriteria', function() {
      // uncomment below and update the code to test UserSearchCriteria
      //var instance = new AmazonConnectService.UserSearchCriteria();
      //expect(instance).to.be.a(AmazonConnectService.UserSearchCriteria);
    });
