...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.StopContactRecordingRequest();
  });
  ...
  describe('StopContactRecordingRequest', function() {
    it('should create an instance of StopContactRecordingRequest', function() {
      // uncomment below and update the code to test StopContactRecordingRequest
      //var instance = new AmazonConnectService.StopContactRecordingRequest();
      //expect(instance).to.be.a(AmazonConnectService.StopContactRecordingRequest);
    });
