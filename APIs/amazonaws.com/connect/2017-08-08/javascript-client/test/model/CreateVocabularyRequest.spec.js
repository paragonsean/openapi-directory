...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.CreateVocabularyRequest();
  });
  ...
  describe('CreateVocabularyRequest', function() {
    it('should create an instance of CreateVocabularyRequest', function() {
      // uncomment below and update the code to test CreateVocabularyRequest
      //var instance = new AmazonConnectService.CreateVocabularyRequest();
      //expect(instance).to.be.a(AmazonConnectService.CreateVocabularyRequest);
    });
