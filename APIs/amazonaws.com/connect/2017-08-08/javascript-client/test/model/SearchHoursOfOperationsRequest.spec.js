...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.SearchHoursOfOperationsRequest();
  });
  ...
  describe('SearchHoursOfOperationsRequest', function() {
    it('should create an instance of SearchHoursOfOperationsRequest', function() {
      // uncomment below and update the code to test SearchHoursOfOperationsRequest
      //var instance = new AmazonConnectService.SearchHoursOfOperationsRequest();
      //expect(instance).to.be.a(AmazonConnectService.SearchHoursOfOperationsRequest);
    });
