...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.UpdateTaskTemplateResponse();
  });
  ...
  describe('UpdateTaskTemplateResponse', function() {
    it('should create an instance of UpdateTaskTemplateResponse', function() {
      // uncomment below and update the code to test UpdateTaskTemplateResponse
      //var instance = new AmazonConnectService.UpdateTaskTemplateResponse();
      //expect(instance).to.be.a(AmazonConnectService.UpdateTaskTemplateResponse);
    });
