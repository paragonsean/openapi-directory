...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.RuleActionSendNotificationAction();
  });
  ...
  describe('RuleActionSendNotificationAction', function() {
    it('should create an instance of RuleActionSendNotificationAction', function() {
      // uncomment below and update the code to test RuleActionSendNotificationAction
      //var instance = new AmazonConnectService.RuleActionSendNotificationAction();
      //expect(instance).to.be.a(AmazonConnectService.RuleActionSendNotificationAction);
    });
