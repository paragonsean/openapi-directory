...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectService.QueueSearchCriteria();
  });
  ...
  describe('QueueSearchCriteria', function() {
    it('should create an instance of QueueSearchCriteria', function() {
      // uncomment below and update the code to test QueueSearchCriteria
      //var instance = new AmazonConnectService.QueueSearchCriteria();
      //expect(instance).to.be.a(AmazonConnectService.QueueSearchCriteria);
    });
