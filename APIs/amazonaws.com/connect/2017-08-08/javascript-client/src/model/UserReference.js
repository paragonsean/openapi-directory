...
class UserReference {
    ...
    /**
     * Validates the JSON data with respect to <code>UserReference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserReference</code>.
     */
 ...
 * @member {String} Id
 */
UserReference.prototype['Id'] = undefined;

/**
 * @member {String} Arn
 */
UserReference.prototype['Arn'] = undefined;
