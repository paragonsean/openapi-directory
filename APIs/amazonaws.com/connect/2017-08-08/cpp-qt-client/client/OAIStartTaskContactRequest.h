...
/*
 * OAIStartTaskContactRequest.h
 *
 * 
 */

#ifndef OAIStartTaskContactRequest_H
#define OAIStartTaskContactRequest_H
...
class OAIStartTaskContactRequest : public OAIObject {
public:
    OAIStartTaskContactRequest();
    OAIStartTaskContactRequest(QString json);
    ~OAIStartTaskContactRequest() override;
    ...
    QMap getReferences() const;
    void setReferences(const QMap &references);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTaskContactRequest)

#endif // OAIStartTaskContactRequest_H
