...
/*
 * OAIUpdateContactAttributesRequest.h
 *
 * 
 */

#ifndef OAIUpdateContactAttributesRequest_H
#define OAIUpdateContactAttributesRequest_H
...
class OAIUpdateContactAttributesRequest : public OAIObject {
public:
    OAIUpdateContactAttributesRequest();
    OAIUpdateContactAttributesRequest(QString json);
    ~OAIUpdateContactAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContactAttributesRequest)

#endif // OAIUpdateContactAttributesRequest_H
