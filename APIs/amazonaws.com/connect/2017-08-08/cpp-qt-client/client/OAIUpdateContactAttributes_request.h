...
/*
 * OAIUpdateContactAttributes_request.h
 *
 * 
 */

#ifndef OAIUpdateContactAttributes_request_H
#define OAIUpdateContactAttributes_request_H
...
class OAIUpdateContactAttributes_request : public OAIObject {
public:
    OAIUpdateContactAttributes_request();
    OAIUpdateContactAttributes_request(QString json);
    ~OAIUpdateContactAttributes_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContactAttributes_request)

#endif // OAIUpdateContactAttributes_request_H
