...
/*
 * OAIDescribeInstanceStorageConfigResponse_StorageConfig.h
 *
 * 
 */

#ifndef OAIDescribeInstanceStorageConfigResponse_StorageConfig_H
#define OAIDescribeInstanceStorageConfigResponse_StorageConfig_H
...
class OAIDescribeInstanceStorageConfigResponse_StorageConfig : public OAIObject {
public:
    OAIDescribeInstanceStorageConfigResponse_StorageConfig();
    OAIDescribeInstanceStorageConfigResponse_StorageConfig(QString json);
    ~OAIDescribeInstanceStorageConfigResponse_StorageConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInstanceStorageConfigResponse_StorageConfig)

#endif // OAIDescribeInstanceStorageConfigResponse_StorageConfig_H
