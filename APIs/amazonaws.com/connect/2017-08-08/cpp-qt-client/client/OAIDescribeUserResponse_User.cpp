...
QString OAIDescribeUserResponse_User::getId() const {
    return m_id;
}
void OAIDescribeUserResponse_User::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeUserResponse_User::is_id_Valid() const{
    return m_id_isValid;
}
...
void OAIDescribeUserResponse_User::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIDescribeUserResponse_User::is_username_Set() const{
    return m_username_isSet;
}

bool OAIDescribeUserResponse_User::is_username_Valid() const{
    return m_username_isValid;
}

OAIUser_IdentityInfo OAIDescribeUserResponse_User::getIdentityInfo() const {
    return m_identity_info;
}
void OAIDescribeUserResponse_User::setIdentityInfo(const OAIUser_IdentityInfo &identity_info) {
    m_identity_info = identity_info;
    m_identity_info_isSet = true;
}

bool OAIDescribeUserResponse_User::is_identity_info_Set() const{
    return m_identity_info_isSet;
}

bool OAIDescribeUserResponse_User::is_identity_info_Valid() const{
    return m_identity_info_isValid;
}

OAIUser_PhoneConfig OAIDescribeUserResponse_User::getPhoneConfig() const {
    return m_phone_config;
}
void OAIDescribeUserResponse_User::setPhoneConfig(const OAIUser_PhoneConfig &phone_config) {
    m_phone_config = phone_config;
    m_phone_config_isSet = true;
}

bool OAIDescribeUserResponse_User::is_phone_config_Set() const{
    return m_phone_config_isSet;
}

bool OAIDescribeUserResponse_User::is_phone_config_Valid() const{
    return m_phone_config_isValid;
}

QString OAIDescribeUserResponse_User::getDirectoryUserId() const {
    return m_directory_user_id;
}
void OAIDescribeUserResponse_User::setDirectoryUserId(const QString &directory_user_id) {
    m_directory_user_id = directory_user_id;
    m_directory_user_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_directory_user_id_Set() const{
    return m_directory_user_id_isSet;
}

bool OAIDescribeUserResponse_User::is_directory_user_id_Valid() const{
    return m_directory_user_id_isValid;
}

QList OAIDescribeUserResponse_User::getSecurityProfileIds() const {
    return m_security_profile_ids;
}
void OAIDescribeUserResponse_User::setSecurityProfileIds(const QList &security_profile_ids) {
    m_security_profile_ids = security_profile_ids;
    m_security_profile_ids_isSet = true;
}

bool OAIDescribeUserResponse_User::is_security_profile_ids_Set() const{
    return m_security_profile_ids_isSet;
}

bool OAIDescribeUserResponse_User::is_security_profile_ids_Valid() const{
    return m_security_profile_ids_isValid;
}

QString OAIDescribeUserResponse_User::getRoutingProfileId() const {
    return m_routing_profile_id;
}
void OAIDescribeUserResponse_User::setRoutingProfileId(const QString &routing_profile_id) {
    m_routing_profile_id = routing_profile_id;
    m_routing_profile_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_routing_profile_id_Set() const{
    return m_routing_profile_id_isSet;
}

bool OAIDescribeUserResponse_User::is_routing_profile_id_Valid() const{
    return m_routing_profile_id_isValid;
}

QString OAIDescribeUserResponse_User::getHierarchyGroupId() const {
    return m_hierarchy_group_id;
}
void OAIDescribeUserResponse_User::setHierarchyGroupId(const QString &hierarchy_group_id) {
    m_hierarchy_group_id = hierarchy_group_id;
    m_hierarchy_group_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_hierarchy_group_id_Set() const{
    return m_hierarchy_group_id_isSet;
}

bool OAIDescribeUserResponse_User::is_hierarchy_group_id_Valid() const{
    return m_hierarchy_group_id_isValid;
}

QMap OAIDescribeUserResponse_User::getTags() const {
    return m_tags;
}
void OAIDescribeUserResponse_User::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
