...
/*
 * OAIStopContact_request.h
 *
 * 
 */

#ifndef OAIStopContact_request_H
#define OAIStopContact_request_H
...
class OAIStopContact_request : public OAIObject {
public:
    OAIStopContact_request();
    OAIStopContact_request(QString json);
    ~OAIStopContact_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopContact_request)

#endif // OAIStopContact_request_H
