...
/*
 * OAIQueueQuickConnectConfig.h
 *
 * Contains information about a queue for a quick connect. The flow must be of type Transfer to Queue.
 */

#ifndef OAIQueueQuickConnectConfig_H
#define OAIQueueQuickConnectConfig_H
...
class OAIQueueQuickConnectConfig : public OAIObject {
public:
    OAIQueueQuickConnectConfig();
    OAIQueueQuickConnectConfig(QString json);
    ~OAIQueueQuickConnectConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueueQuickConnectConfig)

#endif // OAIQueueQuickConnectConfig_H
