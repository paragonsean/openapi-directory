...
/*
 * OAIResumeContactRecordingRequest.h
 *
 * 
 */

#ifndef OAIResumeContactRecordingRequest_H
#define OAIResumeContactRecordingRequest_H
...
class OAIResumeContactRecordingRequest : public OAIObject {
public:
    OAIResumeContactRecordingRequest();
    OAIResumeContactRecordingRequest(QString json);
    ~OAIResumeContactRecordingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeContactRecordingRequest)

#endif // OAIResumeContactRecordingRequest_H
