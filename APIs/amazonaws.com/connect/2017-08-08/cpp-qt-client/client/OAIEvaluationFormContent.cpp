...
#include "OAIEvaluationFormContent.h"
...
OAIEvaluationFormContent::OAIEvaluationFormContent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluationFormContent::OAIEvaluationFormContent() {
    this->initializeModel();
}

OAIEvaluationFormContent::~OAIEvaluationFormContent() {}

void OAIEvaluationFormContent::initializeModel() {
...
void OAIEvaluationFormContent::fromJson(QString jsonString) {
...
void OAIEvaluationFormContent::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluationFormContent::asJson() const {
...
QJsonObject OAIEvaluationFormContent::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIEvaluationFormContent::getEvaluationFormVersion() const {
    return m_evaluation_form_version;
}
void OAIEvaluationFormContent::setEvaluationFormVersion(const qint32 &evaluation_form_version) {
    m_evaluation_form_version = evaluation_form_version;
    m_evaluation_form_version_isSet = true;
}

bool OAIEvaluationFormContent::is_evaluation_form_version_Set() const{
    return m_evaluation_form_version_isSet;
}

bool OAIEvaluationFormContent::is_evaluation_form_version_Valid() const{
    return m_evaluation_form_version_isValid;
}

QString OAIEvaluationFormContent::getEvaluationFormId() const {
    return m_evaluation_form_id;
}
void OAIEvaluationFormContent::setEvaluationFormId(const QString &evaluation_form_id) {
    m_evaluation_form_id = evaluation_form_id;
    m_evaluation_form_id_isSet = true;
}

bool OAIEvaluationFormContent::is_evaluation_form_id_Set() const{
    return m_evaluation_form_id_isSet;
}

bool OAIEvaluationFormContent::is_evaluation_form_id_Valid() const{
    return m_evaluation_form_id_isValid;
}

QString OAIEvaluationFormContent::getEvaluationFormArn() const {
    return m_evaluation_form_arn;
}
void OAIEvaluationFormContent::setEvaluationFormArn(const QString &evaluation_form_arn) {
    m_evaluation_form_arn = evaluation_form_arn;
    m_evaluation_form_arn_isSet = true;
}

bool OAIEvaluationFormContent::is_evaluation_form_arn_Set() const{
    return m_evaluation_form_arn_isSet;
}

bool OAIEvaluationFormContent::is_evaluation_form_arn_Valid() const{
    return m_evaluation_form_arn_isValid;
}

QString OAIEvaluationFormContent::getTitle() const {
    return m_title;
}
void OAIEvaluationFormContent::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIEvaluationFormContent::is_title_Set() const{
    return m_title_isSet;
}

bool OAIEvaluationFormContent::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIEvaluationFormContent::getDescription() const {
    return m_description;
}
void OAIEvaluationFormContent::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIEvaluationFormContent::is_description_Set() const{
    return m_description_isSet;
}

bool OAIEvaluationFormContent::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIEvaluationFormContent::getItems() const {
    return m_items;
}
void OAIEvaluationFormContent::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIEvaluationFormContent::is_items_Set() const{
    return m_items_isSet;
}

bool OAIEvaluationFormContent::is_items_Valid() const{
    return m_items_isValid;
}

OAICreateEvaluationFormRequest_ScoringStrategy OAIEvaluationFormContent::getScoringStrategy() const {
    return m_scoring_strategy;
}
void OAIEvaluationFormContent::setScoringStrategy(const OAICreateEvaluationFormRequest_ScoringStrategy &scoring_strategy) {
    m_scoring_strategy = scoring_strategy;
    m_scoring_strategy_isSet = true;
}

bool OAIEvaluationFormContent::is_scoring_strategy_Set() const{
    return m_scoring_strategy_isSet;
}

bool OAIEvaluationFormContent::is_scoring_strategy_Valid() const{
    return m_scoring_strategy_isValid;
}

bool OAIEvaluationFormContent::isSet() const {
...
bool OAIEvaluationFormContent::isValid() const {
