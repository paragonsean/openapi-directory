...
/*
 * OAIUserSearchSummary.h
 *
 * Information about the returned users.
 */

#ifndef OAIUserSearchSummary_H
#define OAIUserSearchSummary_H
...
namespace OpenAPI {
class OAIUserSearchSummary_IdentityInfo;
class OAIUserPhoneConfig;

class OAIUserSearchSummary : public OAIObject {
public:
    OAIUserSearchSummary();
    OAIUserSearchSummary(QString json);
    ~OAIUserSearchSummary() override;
    ...
    OAIUserSearchSummary_IdentityInfo getIdentityInfo() const;
    void setIdentityInfo(const OAIUserSearchSummary_IdentityInfo &identity_info);
    bool is_identity_info_Set() const;
    bool is_identity_info_Valid() const;

    OAIUserPhoneConfig getPhoneConfig() const;
    void setPhoneConfig(const OAIUserPhoneConfig &phone_config);
...
private:
    ...
    OAIUserSearchSummary_IdentityInfo m_identity_info;
    bool m_identity_info_isSet;
    bool m_identity_info_isValid;

    OAIUserPhoneConfig m_phone_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserSearchSummary)

#endif // OAIUserSearchSummary_H
