...
/*
 * OAICreateVocabulary_request.h
 *
 * 
 */

#ifndef OAICreateVocabulary_request_H
#define OAICreateVocabulary_request_H
...
class OAICreateVocabulary_request : public OAIObject {
public:
    OAICreateVocabulary_request();
    OAICreateVocabulary_request(QString json);
    ~OAICreateVocabulary_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVocabulary_request)

#endif // OAICreateVocabulary_request_H
