...
/*
 * OAIHierarchyPathReference.h
 *
 * Information about the levels in the hierarchy group.
 */

#ifndef OAIHierarchyPathReference_H
#define OAIHierarchyPathReference_H
...
class OAIHierarchyPathReference : public OAIObject {
public:
    OAIHierarchyPathReference();
    OAIHierarchyPathReference(QString json);
    ~OAIHierarchyPathReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHierarchyPathReference)

#endif // OAIHierarchyPathReference_H
