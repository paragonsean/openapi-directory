...
/*
 * OAIUser_PhoneConfig.h
 *
 * 
 */

#ifndef OAIUser_PhoneConfig_H
#define OAIUser_PhoneConfig_H
...
class OAIUser_PhoneConfig : public OAIObject {
public:
    OAIUser_PhoneConfig();
    OAIUser_PhoneConfig(QString json);
    ~OAIUser_PhoneConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_PhoneConfig)

#endif // OAIUser_PhoneConfig_H
