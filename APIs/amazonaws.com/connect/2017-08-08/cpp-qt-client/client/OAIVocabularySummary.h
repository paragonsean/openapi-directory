...
/*
 * OAIVocabularySummary.h
 *
 * Contains summary information about the custom vocabulary.
 */

#ifndef OAIVocabularySummary_H
#define OAIVocabularySummary_H
...
class OAIVocabularySummary : public OAIObject {
public:
    OAIVocabularySummary();
    OAIVocabularySummary(QString json);
    ~OAIVocabularySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVocabularySummary)

#endif // OAIVocabularySummary_H
