...
/*
 * OAIUserDataFilters.h
 *
 * A filter for the user data.
 */

#ifndef OAIUserDataFilters_H
#define OAIUserDataFilters_H
...
class OAIUserDataFilters : public OAIObject {
public:
    OAIUserDataFilters();
    OAIUserDataFilters(QString json);
    ~OAIUserDataFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserDataFilters)

#endif // OAIUserDataFilters_H
