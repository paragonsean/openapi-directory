...
/*
 * OAIResumeContactRecording_request.h
 *
 * 
 */

#ifndef OAIResumeContactRecording_request_H
#define OAIResumeContactRecording_request_H
...
class OAIResumeContactRecording_request : public OAIObject {
public:
    OAIResumeContactRecording_request();
    OAIResumeContactRecording_request(QString json);
    ~OAIResumeContactRecording_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeContactRecording_request)

#endif // OAIResumeContactRecording_request_H
