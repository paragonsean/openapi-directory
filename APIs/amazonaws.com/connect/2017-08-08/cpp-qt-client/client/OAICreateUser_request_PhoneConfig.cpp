...
OAICreateUser_request_PhoneConfig::OAICreateUser_request_PhoneConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUser_request_PhoneConfig::OAICreateUser_request_PhoneConfig() {
    this->initializeModel();
}

OAICreateUser_request_PhoneConfig::~OAICreateUser_request_PhoneConfig() {}

void OAICreateUser_request_PhoneConfig::initializeModel() {
...
void OAICreateUser_request_PhoneConfig::fromJson(QString jsonString) {
...
void OAICreateUser_request_PhoneConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateUser_request_PhoneConfig::asJson() const {
...
QJsonObject OAICreateUser_request_PhoneConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIPhoneType OAICreateUser_request_PhoneConfig::getPhoneType() const {
    return m_phone_type;
}
void OAICreateUser_request_PhoneConfig::setPhoneType(const OAIPhoneType &phone_type) {
    m_phone_type = phone_type;
    m_phone_type_isSet = true;
}

bool OAICreateUser_request_PhoneConfig::is_phone_type_Set() const{
    return m_phone_type_isSet;
}

bool OAICreateUser_request_PhoneConfig::is_phone_type_Valid() const{
    return m_phone_type_isValid;
}

bool OAICreateUser_request_PhoneConfig::getAutoAccept() const {
    return m_auto_accept;
}
void OAICreateUser_request_PhoneConfig::setAutoAccept(const bool &auto_accept) {
    m_auto_accept = auto_accept;
    m_auto_accept_isSet = true;
}

bool OAICreateUser_request_PhoneConfig::is_auto_accept_Set() const{
    return m_auto_accept_isSet;
}

bool OAICreateUser_request_PhoneConfig::is_auto_accept_Valid() const{
    return m_auto_accept_isValid;
}

qint32 OAICreateUser_request_PhoneConfig::getAfterContactWorkTimeLimit() const {
    return m_after_contact_work_time_limit;
}
void OAICreateUser_request_PhoneConfig::setAfterContactWorkTimeLimit(const qint32 &after_contact_work_time_limit) {
    m_after_contact_work_time_limit = after_contact_work_time_limit;
    m_after_contact_work_time_limit_isSet = true;
}

bool OAICreateUser_request_PhoneConfig::is_after_contact_work_time_limit_Set() const{
    return m_after_contact_work_time_limit_isSet;
}

bool OAICreateUser_request_PhoneConfig::is_after_contact_work_time_limit_Valid() const{
    return m_after_contact_work_time_limit_isValid;
}

QString OAICreateUser_request_PhoneConfig::getDeskPhoneNumber() const {
    return m_desk_phone_number;
}
void OAICreateUser_request_PhoneConfig::setDeskPhoneNumber(const QString &desk_phone_number) {
    m_desk_phone_number = desk_phone_number;
    m_desk_phone_number_isSet = true;
}

bool OAICreateUser_request_PhoneConfig::is_desk_phone_number_Set() const{
    return m_desk_phone_number_isSet;
}

bool OAICreateUser_request_PhoneConfig::is_desk_phone_number_Valid() const{
    return m_desk_phone_number_isValid;
}

bool OAICreateUser_request_PhoneConfig::isSet() const {
...
bool OAICreateUser_request_PhoneConfig::isValid() const {
