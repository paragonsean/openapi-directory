...
class OAIEvaluationAnswerData : public OAIObject {
public:
    OAIEvaluationAnswerData();
    OAIEvaluationAnswerData(QString json);
    ~OAIEvaluationAnswerData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluationAnswerData)

#endif // OAIEvaluationAnswerData_H
