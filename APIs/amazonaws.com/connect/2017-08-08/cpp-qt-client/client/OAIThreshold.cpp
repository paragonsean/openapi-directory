...
OAIComparison OAIThreshold::getComparison() const {
    return m_comparison;
}
void OAIThreshold::setComparison(const OAIComparison &comparison) {
    m_comparison = comparison;
    m_comparison_isSet = true;
}

bool OAIThreshold::is_comparison_Set() const{
    return m_comparison_isSet;
}

bool OAIThreshold::is_comparison_Valid() const{
    return m_comparison_isValid;
}

double OAIThreshold::getThresholdValue() const {
    return m_threshold_value;
}
void OAIThreshold::setThresholdValue(const double &threshold_value) {
    m_threshold_value = threshold_value;
    m_threshold_value_isSet = true;
}

bool OAIThreshold::is_threshold_value_Set() const{
    return m_threshold_value_isSet;
}

bool OAIThreshold::is_threshold_value_Valid() const{
