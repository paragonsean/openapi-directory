...
#include "OAIQuickConnectConfig.h"
...
OAIQuickConnectConfig::OAIQuickConnectConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQuickConnectConfig::OAIQuickConnectConfig() {
    this->initializeModel();
}

OAIQuickConnectConfig::~OAIQuickConnectConfig() {}

void OAIQuickConnectConfig::initializeModel() {
...
void OAIQuickConnectConfig::fromJson(QString jsonString) {
...
void OAIQuickConnectConfig::fromJsonObject(QJsonObject json) {
...
QString OAIQuickConnectConfig::asJson() const {
...
QJsonObject OAIQuickConnectConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIQuickConnectType OAIQuickConnectConfig::getQuickConnectType() const {
    return m_quick_connect_type;
}
void OAIQuickConnectConfig::setQuickConnectType(const OAIQuickConnectType &quick_connect_type) {
    m_quick_connect_type = quick_connect_type;
    m_quick_connect_type_isSet = true;
}

bool OAIQuickConnectConfig::is_quick_connect_type_Set() const{
    return m_quick_connect_type_isSet;
}

bool OAIQuickConnectConfig::is_quick_connect_type_Valid() const{
    return m_quick_connect_type_isValid;
}

OAICreateQuickConnect_request_QuickConnectConfig_UserConfig OAIQuickConnectConfig::getUserConfig() const {
    return m_user_config;
}
void OAIQuickConnectConfig::setUserConfig(const OAICreateQuickConnect_request_QuickConnectConfig_UserConfig &user_config) {
    m_user_config = user_config;
    m_user_config_isSet = true;
}

bool OAIQuickConnectConfig::is_user_config_Set() const{
    return m_user_config_isSet;
}

bool OAIQuickConnectConfig::is_user_config_Valid() const{
    return m_user_config_isValid;
}

OAICreateQuickConnect_request_QuickConnectConfig_QueueConfig OAIQuickConnectConfig::getQueueConfig() const {
    return m_queue_config;
}
void OAIQuickConnectConfig::setQueueConfig(const OAICreateQuickConnect_request_QuickConnectConfig_QueueConfig &queue_config) {
    m_queue_config = queue_config;
    m_queue_config_isSet = true;
}

bool OAIQuickConnectConfig::is_queue_config_Set() const{
    return m_queue_config_isSet;
}

bool OAIQuickConnectConfig::is_queue_config_Valid() const{
    return m_queue_config_isValid;
}

OAICreateQuickConnect_request_QuickConnectConfig_PhoneConfig OAIQuickConnectConfig::getPhoneConfig() const {
    return m_phone_config;
}
void OAIQuickConnectConfig::setPhoneConfig(const OAICreateQuickConnect_request_QuickConnectConfig_PhoneConfig &phone_config) {
    m_phone_config = phone_config;
    m_phone_config_isSet = true;
}

bool OAIQuickConnectConfig::is_phone_config_Set() const{
    return m_phone_config_isSet;
}

bool OAIQuickConnectConfig::is_phone_config_Valid() const{
    return m_phone_config_isValid;
}

bool OAIQuickConnectConfig::isSet() const {
...
bool OAIQuickConnectConfig::isValid() const {
