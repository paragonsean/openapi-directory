...
#ifndef OAIRuleTriggerEventSource_H
#define OAIRuleTriggerEventSource_H
...
class OAIRuleTriggerEventSource : public OAIObject {
public:
    OAIRuleTriggerEventSource();
    OAIRuleTriggerEventSource(QString json);
    ~OAIRuleTriggerEventSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleTriggerEventSource)

#endif // OAIRuleTriggerEventSource_H
