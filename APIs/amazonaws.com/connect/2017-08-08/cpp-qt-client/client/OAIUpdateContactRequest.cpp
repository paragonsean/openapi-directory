...
QString OAIUpdateContactRequest::getName() const {
    return m_name;
}
void OAIUpdateContactRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateContactRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateContactRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateContactRequest::getDescription() const {
    return m_description;
}
void OAIUpdateContactRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateContactRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateContactRequest::is_description_Valid() const{
    return m_description_isValid;
}

QMap OAIUpdateContactRequest::getReferences() const {
    return m_references;
}
void OAIUpdateContactRequest::setReferences(const QMap &references) {
    m_references = references;
    m_references_isSet = true;
}

bool OAIUpdateContactRequest::is_references_Set() const{
    return m_references_isSet;
}

bool OAIUpdateContactRequest::is_references_Valid() const{
