...
/*
 * OAIClaimPhoneNumberRequest.h
 *
 * 
 */

#ifndef OAIClaimPhoneNumberRequest_H
#define OAIClaimPhoneNumberRequest_H
...
class OAIClaimPhoneNumberRequest : public OAIObject {
public:
    OAIClaimPhoneNumberRequest();
    OAIClaimPhoneNumberRequest(QString json);
    ~OAIClaimPhoneNumberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClaimPhoneNumberRequest)

#endif // OAIClaimPhoneNumberRequest_H
