...
OAIDescribeInstanceResponse_Instance::OAIDescribeInstanceResponse_Instance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeInstanceResponse_Instance::OAIDescribeInstanceResponse_Instance() {
    this->initializeModel();
}

OAIDescribeInstanceResponse_Instance::~OAIDescribeInstanceResponse_Instance() {}

void OAIDescribeInstanceResponse_Instance::initializeModel() {
...
void OAIDescribeInstanceResponse_Instance::fromJson(QString jsonString) {
...
void OAIDescribeInstanceResponse_Instance::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeInstanceResponse_Instance::asJson() const {
...
QJsonObject OAIDescribeInstanceResponse_Instance::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDescribeInstanceResponse_Instance::getId() const {
    return m_id;
}
void OAIDescribeInstanceResponse_Instance::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDescribeInstanceResponse_Instance::getArn() const {
    return m_arn;
}
void OAIDescribeInstanceResponse_Instance::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDirectoryType OAIDescribeInstanceResponse_Instance::getIdentityManagementType() const {
    return m_identity_management_type;
}
void OAIDescribeInstanceResponse_Instance::setIdentityManagementType(const OAIDirectoryType &identity_management_type) {
    m_identity_management_type = identity_management_type;
    m_identity_management_type_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_identity_management_type_Set() const{
    return m_identity_management_type_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_identity_management_type_Valid() const{
    return m_identity_management_type_isValid;
}

QString OAIDescribeInstanceResponse_Instance::getInstanceAlias() const {
    return m_instance_alias;
}
void OAIDescribeInstanceResponse_Instance::setInstanceAlias(const QString &instance_alias) {
    m_instance_alias = instance_alias;
    m_instance_alias_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_alias_Set() const{
    return m_instance_alias_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_alias_Valid() const{
    return m_instance_alias_isValid;
}

QDateTime OAIDescribeInstanceResponse_Instance::getCreatedTime() const {
    return m_created_time;
}
void OAIDescribeInstanceResponse_Instance::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDescribeInstanceResponse_Instance::getServiceRole() const {
    return m_service_role;
}
void OAIDescribeInstanceResponse_Instance::setServiceRole(const QString &service_role) {
    m_service_role = service_role;
    m_service_role_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_service_role_Set() const{
    return m_service_role_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_service_role_Valid() const{
    return m_service_role_isValid;
}

OAIInstanceStatus OAIDescribeInstanceResponse_Instance::getInstanceStatus() const {
    return m_instance_status;
}
void OAIDescribeInstanceResponse_Instance::setInstanceStatus(const OAIInstanceStatus &instance_status) {
    m_instance_status = instance_status;
    m_instance_status_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_status_Set() const{
    return m_instance_status_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_status_Valid() const{
    return m_instance_status_isValid;
}

OAIInstance_StatusReason OAIDescribeInstanceResponse_Instance::getStatusReason() const {
    return m_status_reason;
}
void OAIDescribeInstanceResponse_Instance::setStatusReason(const OAIInstance_StatusReason &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_status_reason_Valid() const{
    return m_status_reason_isValid;
}

bool OAIDescribeInstanceResponse_Instance::getInboundCallsEnabled() const {
    return m_inbound_calls_enabled;
}
void OAIDescribeInstanceResponse_Instance::setInboundCallsEnabled(const bool &inbound_calls_enabled) {
    m_inbound_calls_enabled = inbound_calls_enabled;
    m_inbound_calls_enabled_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_inbound_calls_enabled_Set() const{
    return m_inbound_calls_enabled_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_inbound_calls_enabled_Valid() const{
    return m_inbound_calls_enabled_isValid;
}

bool OAIDescribeInstanceResponse_Instance::getOutboundCallsEnabled() const {
    return m_outbound_calls_enabled;
}
void OAIDescribeInstanceResponse_Instance::setOutboundCallsEnabled(const bool &outbound_calls_enabled) {
    m_outbound_calls_enabled = outbound_calls_enabled;
    m_outbound_calls_enabled_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_outbound_calls_enabled_Set() const{
    return m_outbound_calls_enabled_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_outbound_calls_enabled_Valid() const{
    return m_outbound_calls_enabled_isValid;
}

QString OAIDescribeInstanceResponse_Instance::getInstanceAccessUrl() const {
    return m_instance_access_url;
}
void OAIDescribeInstanceResponse_Instance::setInstanceAccessUrl(const QString &instance_access_url) {
    m_instance_access_url = instance_access_url;
    m_instance_access_url_isSet = true;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_access_url_Set() const{
    return m_instance_access_url_isSet;
}

bool OAIDescribeInstanceResponse_Instance::is_instance_access_url_Valid() const{
    return m_instance_access_url_isValid;
}

bool OAIDescribeInstanceResponse_Instance::isSet() const {
...
bool OAIDescribeInstanceResponse_Instance::isValid() const {
