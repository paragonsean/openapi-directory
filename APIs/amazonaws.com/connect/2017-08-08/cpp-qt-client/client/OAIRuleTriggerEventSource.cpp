...
#include "OAIRuleTriggerEventSource.h"
...
OAIRuleTriggerEventSource::OAIRuleTriggerEventSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleTriggerEventSource::OAIRuleTriggerEventSource() {
    this->initializeModel();
}

OAIRuleTriggerEventSource::~OAIRuleTriggerEventSource() {}

void OAIRuleTriggerEventSource::initializeModel() {
...
void OAIRuleTriggerEventSource::fromJson(QString jsonString) {
...
void OAIRuleTriggerEventSource::fromJsonObject(QJsonObject json) {
...
QString OAIRuleTriggerEventSource::asJson() const {
...
QJsonObject OAIRuleTriggerEventSource::asJsonObject() const {
    QJsonObject obj;
...
OAIEventSourceName OAIRuleTriggerEventSource::getEventSourceName() const {
    return m_event_source_name;
}
void OAIRuleTriggerEventSource::setEventSourceName(const OAIEventSourceName &event_source_name) {
    m_event_source_name = event_source_name;
    m_event_source_name_isSet = true;
}

bool OAIRuleTriggerEventSource::is_event_source_name_Set() const{
    return m_event_source_name_isSet;
}

bool OAIRuleTriggerEventSource::is_event_source_name_Valid() const{
    return m_event_source_name_isValid;
}

QString OAIRuleTriggerEventSource::getIntegrationAssociationId() const {
    return m_integration_association_id;
}
void OAIRuleTriggerEventSource::setIntegrationAssociationId(const QString &integration_association_id) {
    m_integration_association_id = integration_association_id;
    m_integration_association_id_isSet = true;
}

bool OAIRuleTriggerEventSource::is_integration_association_id_Set() const{
    return m_integration_association_id_isSet;
}

bool OAIRuleTriggerEventSource::is_integration_association_id_Valid() const{
    return m_integration_association_id_isValid;
}

bool OAIRuleTriggerEventSource::isSet() const {
...
bool OAIRuleTriggerEventSource::isValid() const {
