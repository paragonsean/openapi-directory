...
/*
 * OAIStopContactRequest.h
 *
 * 
 */

#ifndef OAIStopContactRequest_H
#define OAIStopContactRequest_H
...
class OAIStopContactRequest : public OAIObject {
public:
    OAIStopContactRequest();
    OAIStopContactRequest(QString json);
    ~OAIStopContactRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopContactRequest)

#endif // OAIStopContactRequest_H
