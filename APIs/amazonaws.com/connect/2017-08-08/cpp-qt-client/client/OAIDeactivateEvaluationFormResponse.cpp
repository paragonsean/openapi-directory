...
OAIDeactivateEvaluationFormResponse::OAIDeactivateEvaluationFormResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeactivateEvaluationFormResponse::OAIDeactivateEvaluationFormResponse() {
    this->initializeModel();
}

OAIDeactivateEvaluationFormResponse::~OAIDeactivateEvaluationFormResponse() {}

void OAIDeactivateEvaluationFormResponse::initializeModel() {
...
void OAIDeactivateEvaluationFormResponse::fromJson(QString jsonString) {
...
void OAIDeactivateEvaluationFormResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeactivateEvaluationFormResponse::asJson() const {
...
QJsonObject OAIDeactivateEvaluationFormResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeactivateEvaluationFormResponse::getEvaluationFormId() const {
    return m_evaluation_form_id;
}
void OAIDeactivateEvaluationFormResponse::setEvaluationFormId(const QString &evaluation_form_id) {
    m_evaluation_form_id = evaluation_form_id;
    m_evaluation_form_id_isSet = true;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_id_Set() const{
    return m_evaluation_form_id_isSet;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_id_Valid() const{
    return m_evaluation_form_id_isValid;
}

QString OAIDeactivateEvaluationFormResponse::getEvaluationFormArn() const {
    return m_evaluation_form_arn;
}
void OAIDeactivateEvaluationFormResponse::setEvaluationFormArn(const QString &evaluation_form_arn) {
    m_evaluation_form_arn = evaluation_form_arn;
    m_evaluation_form_arn_isSet = true;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_arn_Set() const{
    return m_evaluation_form_arn_isSet;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_arn_Valid() const{
    return m_evaluation_form_arn_isValid;
}

qint32 OAIDeactivateEvaluationFormResponse::getEvaluationFormVersion() const {
    return m_evaluation_form_version;
}
void OAIDeactivateEvaluationFormResponse::setEvaluationFormVersion(const qint32 &evaluation_form_version) {
    m_evaluation_form_version = evaluation_form_version;
    m_evaluation_form_version_isSet = true;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_version_Set() const{
    return m_evaluation_form_version_isSet;
}

bool OAIDeactivateEvaluationFormResponse::is_evaluation_form_version_Valid() const{
    return m_evaluation_form_version_isValid;
}

bool OAIDeactivateEvaluationFormResponse::isSet() const {
...
bool OAIDeactivateEvaluationFormResponse::isValid() const {
