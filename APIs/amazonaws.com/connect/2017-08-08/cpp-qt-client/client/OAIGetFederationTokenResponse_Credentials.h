...
/*
 * OAIGetFederationTokenResponse_Credentials.h
 *
 * 
 */

#ifndef OAIGetFederationTokenResponse_Credentials_H
#define OAIGetFederationTokenResponse_Credentials_H
...
class OAIGetFederationTokenResponse_Credentials : public OAIObject {
public:
    OAIGetFederationTokenResponse_Credentials();
    OAIGetFederationTokenResponse_Credentials(QString json);
    ~OAIGetFederationTokenResponse_Credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFederationTokenResponse_Credentials)

#endif // OAIGetFederationTokenResponse_Credentials_H
