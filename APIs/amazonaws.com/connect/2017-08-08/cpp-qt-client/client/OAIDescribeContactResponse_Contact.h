...
/*
 * OAIDescribeContactResponse_Contact.h
 *
 * 
 */

#ifndef OAIDescribeContactResponse_Contact_H
#define OAIDescribeContactResponse_Contact_H
...
class OAIDescribeContactResponse_Contact : public OAIObject {
public:
    OAIDescribeContactResponse_Contact();
    OAIDescribeContactResponse_Contact(QString json);
    ~OAIDescribeContactResponse_Contact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContactResponse_Contact)

#endif // OAIDescribeContactResponse_Contact_H
