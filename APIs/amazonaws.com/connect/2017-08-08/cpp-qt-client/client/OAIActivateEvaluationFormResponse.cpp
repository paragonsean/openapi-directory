...
OAIActivateEvaluationFormResponse::OAIActivateEvaluationFormResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActivateEvaluationFormResponse::OAIActivateEvaluationFormResponse() {
    this->initializeModel();
}

OAIActivateEvaluationFormResponse::~OAIActivateEvaluationFormResponse() {}

void OAIActivateEvaluationFormResponse::initializeModel() {
...
void OAIActivateEvaluationFormResponse::fromJson(QString jsonString) {
...
void OAIActivateEvaluationFormResponse::fromJsonObject(QJsonObject json) {
...
QString OAIActivateEvaluationFormResponse::asJson() const {
...
QJsonObject OAIActivateEvaluationFormResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActivateEvaluationFormResponse::getEvaluationFormId() const {
    return m_evaluation_form_id;
}
void OAIActivateEvaluationFormResponse::setEvaluationFormId(const QString &evaluation_form_id) {
    m_evaluation_form_id = evaluation_form_id;
    m_evaluation_form_id_isSet = true;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_id_Set() const{
    return m_evaluation_form_id_isSet;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_id_Valid() const{
    return m_evaluation_form_id_isValid;
}

QString OAIActivateEvaluationFormResponse::getEvaluationFormArn() const {
    return m_evaluation_form_arn;
}
void OAIActivateEvaluationFormResponse::setEvaluationFormArn(const QString &evaluation_form_arn) {
    m_evaluation_form_arn = evaluation_form_arn;
    m_evaluation_form_arn_isSet = true;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_arn_Set() const{
    return m_evaluation_form_arn_isSet;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_arn_Valid() const{
    return m_evaluation_form_arn_isValid;
}

qint32 OAIActivateEvaluationFormResponse::getEvaluationFormVersion() const {
    return m_evaluation_form_version;
}
void OAIActivateEvaluationFormResponse::setEvaluationFormVersion(const qint32 &evaluation_form_version) {
    m_evaluation_form_version = evaluation_form_version;
    m_evaluation_form_version_isSet = true;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_version_Set() const{
    return m_evaluation_form_version_isSet;
}

bool OAIActivateEvaluationFormResponse::is_evaluation_form_version_Valid() const{
    return m_evaluation_form_version_isValid;
}

bool OAIActivateEvaluationFormResponse::isSet() const {
...
bool OAIActivateEvaluationFormResponse::isValid() const {
