...
/*
 * OAIStartChatContactRequest_PersistentChat.h
 *
 * 
 */

#ifndef OAIStartChatContactRequest_PersistentChat_H
#define OAIStartChatContactRequest_PersistentChat_H
...
class OAIStartChatContactRequest_PersistentChat : public OAIObject {
public:
    OAIStartChatContactRequest_PersistentChat();
    OAIStartChatContactRequest_PersistentChat(QString json);
    ~OAIStartChatContactRequest_PersistentChat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartChatContactRequest_PersistentChat)

#endif // OAIStartChatContactRequest_PersistentChat_H
