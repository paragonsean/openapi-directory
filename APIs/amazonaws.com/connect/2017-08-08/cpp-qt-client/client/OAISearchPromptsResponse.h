...
/*
 * OAISearchPromptsResponse.h
 *
 * 
 */

#ifndef OAISearchPromptsResponse_H
#define OAISearchPromptsResponse_H
...
class OAISearchPromptsResponse : public OAIObject {
public:
    OAISearchPromptsResponse();
    OAISearchPromptsResponse(QString json);
    ~OAISearchPromptsResponse() override;
    ...
    QList getPrompts() const;
    void setPrompts(const QList &prompts);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchPromptsResponse)

#endif // OAISearchPromptsResponse_H
