...
/*
 * OAICreateRuleRequest_TriggerEventSource.h
 *
 * 
 */

#ifndef OAICreateRuleRequest_TriggerEventSource_H
#define OAICreateRuleRequest_TriggerEventSource_H
...
class OAICreateRuleRequest_TriggerEventSource : public OAIObject {
public:
    OAICreateRuleRequest_TriggerEventSource();
    OAICreateRuleRequest_TriggerEventSource(QString json);
    ~OAICreateRuleRequest_TriggerEventSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleRequest_TriggerEventSource)

#endif // OAICreateRuleRequest_TriggerEventSource_H
