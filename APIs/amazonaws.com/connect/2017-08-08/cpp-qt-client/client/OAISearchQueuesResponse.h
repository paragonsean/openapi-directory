...
/*
 * OAISearchQueuesResponse.h
 *
 * 
 */

#ifndef OAISearchQueuesResponse_H
#define OAISearchQueuesResponse_H
...
class OAISearchQueuesResponse : public OAIObject {
public:
    OAISearchQueuesResponse();
    OAISearchQueuesResponse(QString json);
    ~OAISearchQueuesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchQueuesResponse)

#endif // OAISearchQueuesResponse_H
