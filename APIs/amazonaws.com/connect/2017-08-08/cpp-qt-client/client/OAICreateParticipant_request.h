...
/*
 * OAICreateParticipant_request.h
 *
 * 
 */

#ifndef OAICreateParticipant_request_H
#define OAICreateParticipant_request_H
...
namespace OpenAPI {
class OAICreateParticipant_request_ParticipantDetails;

class OAICreateParticipant_request : public OAIObject {
public:
    OAICreateParticipant_request();
    OAICreateParticipant_request(QString json);
    ~OAICreateParticipant_request() override;
    ...
    OAICreateParticipant_request_ParticipantDetails getParticipantDetails() const;
    void setParticipantDetails(const OAICreateParticipant_request_ParticipantDetails &participant_details);
...
private:
    ...
    OAICreateParticipant_request_ParticipantDetails m_participant_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateParticipant_request)

#endif // OAICreateParticipant_request_H
