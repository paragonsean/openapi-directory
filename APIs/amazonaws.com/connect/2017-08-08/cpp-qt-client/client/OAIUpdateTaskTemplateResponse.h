...
/*
 * OAIUpdateTaskTemplateResponse.h
 *
 * 
 */

#ifndef OAIUpdateTaskTemplateResponse_H
#define OAIUpdateTaskTemplateResponse_H
...
class OAIUpdateTaskTemplateResponse : public OAIObject {
public:
    OAIUpdateTaskTemplateResponse();
    OAIUpdateTaskTemplateResponse(QString json);
    ~OAIUpdateTaskTemplateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTaskTemplateResponse)

#endif // OAIUpdateTaskTemplateResponse_H
