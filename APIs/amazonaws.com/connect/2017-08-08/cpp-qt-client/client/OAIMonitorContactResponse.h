...
/*
 * OAIMonitorContactResponse.h
 *
 * 
 */

#ifndef OAIMonitorContactResponse_H
#define OAIMonitorContactResponse_H
...
class OAIMonitorContactResponse : public OAIObject {
public:
    OAIMonitorContactResponse();
    OAIMonitorContactResponse(QString json);
    ~OAIMonitorContactResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitorContactResponse)

#endif // OAIMonitorContactResponse_H
