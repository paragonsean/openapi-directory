...
/*
 * OAIStopContactRecordingRequest.h
 *
 * 
 */

#ifndef OAIStopContactRecordingRequest_H
#define OAIStopContactRecordingRequest_H
...
class OAIStopContactRecordingRequest : public OAIObject {
public:
    OAIStopContactRecordingRequest();
    OAIStopContactRecordingRequest(QString json);
    ~OAIStopContactRecordingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopContactRecordingRequest)

#endif // OAIStopContactRecordingRequest_H
