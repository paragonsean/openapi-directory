...
QString OAIUpdateRuleRequest::getName() const {
    return m_name;
}
void OAIUpdateRuleRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateRuleRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateRuleRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateRuleRequest::getFunction() const {
    return m_function;
}
void OAIUpdateRuleRequest::setFunction(const QString &function) {
    m_function = function;
    m_function_isSet = true;
}

bool OAIUpdateRuleRequest::is_function_Set() const{
    return m_function_isSet;
}

bool OAIUpdateRuleRequest::is_function_Valid() const{
    return m_function_isValid;
}

QList OAIUpdateRuleRequest::getActions() const {
    return m_actions;
}
void OAIUpdateRuleRequest::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIUpdateRuleRequest::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIUpdateRuleRequest::is_actions_Valid() const{
    return m_actions_isValid;
}

OAIRulePublishStatus OAIUpdateRuleRequest::getPublishStatus() const {
    return m_publish_status;
}
void OAIUpdateRuleRequest::setPublishStatus(const OAIRulePublishStatus &publish_status) {
    m_publish_status = publish_status;
    m_publish_status_isSet = true;
}

bool OAIUpdateRuleRequest::is_publish_status_Set() const{
    return m_publish_status_isSet;
}

bool OAIUpdateRuleRequest::is_publish_status_Valid() const{
