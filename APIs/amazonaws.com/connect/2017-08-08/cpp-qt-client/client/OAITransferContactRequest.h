...
/*
 * OAITransferContactRequest.h
 *
 * 
 */

#ifndef OAITransferContactRequest_H
#define OAITransferContactRequest_H
...
class OAITransferContactRequest : public OAIObject {
public:
    OAITransferContactRequest();
    OAITransferContactRequest(QString json);
    ~OAITransferContactRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferContactRequest)

#endif // OAITransferContactRequest_H
