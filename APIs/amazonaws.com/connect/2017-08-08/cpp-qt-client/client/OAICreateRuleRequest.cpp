...
OAICreateRuleRequest_TriggerEventSource OAICreateRuleRequest::getTriggerEventSource() const {
    return m_trigger_event_source;
}
void OAICreateRuleRequest::setTriggerEventSource(const OAICreateRuleRequest_TriggerEventSource &trigger_event_source) {
    m_trigger_event_source = trigger_event_source;
    m_trigger_event_source_isSet = true;
}

bool OAICreateRuleRequest::is_trigger_event_source_Set() const{
    return m_trigger_event_source_isSet;
}

bool OAICreateRuleRequest::is_trigger_event_source_Valid() const{
    return m_trigger_event_source_isValid;
}

QString OAICreateRuleRequest::getFunction() const {
    return m_function;
}
void OAICreateRuleRequest::setFunction(const QString &function) {
    m_function = function;
    m_function_isSet = true;
}

bool OAICreateRuleRequest::is_function_Set() const{
    return m_function_isSet;
}

bool OAICreateRuleRequest::is_function_Valid() const{
    return m_function_isValid;
}

QList OAICreateRuleRequest::getActions() const {
    return m_actions;
}
void OAICreateRuleRequest::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAICreateRuleRequest::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAICreateRuleRequest::is_actions_Valid() const{
    return m_actions_isValid;
}

OAIRulePublishStatus OAICreateRuleRequest::getPublishStatus() const {
    return m_publish_status;
}
void OAICreateRuleRequest::setPublishStatus(const OAIRulePublishStatus &publish_status) {
    m_publish_status = publish_status;
    m_publish_status_isSet = true;
}

bool OAICreateRuleRequest::is_publish_status_Set() const{
    return m_publish_status_isSet;
}

bool OAICreateRuleRequest::is_publish_status_Valid() const{
