...
/*
 * OAIMonitorContactRequest.h
 *
 * 
 */

#ifndef OAIMonitorContactRequest_H
#define OAIMonitorContactRequest_H
...
class OAIMonitorContactRequest : public OAIObject {
public:
    OAIMonitorContactRequest();
    OAIMonitorContactRequest(QString json);
    ~OAIMonitorContactRequest() override;
    ...
    QList getAllowedMonitorCapabilities() const;
    void setAllowedMonitorCapabilities(const QList &allowed_monitor_capabilities);
...
private:
    ...
    QList m_allowed_monitor_capabilities;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitorContactRequest)

#endif // OAIMonitorContactRequest_H
