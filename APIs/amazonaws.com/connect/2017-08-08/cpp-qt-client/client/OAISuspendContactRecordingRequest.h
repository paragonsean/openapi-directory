...
/*
 * OAISuspendContactRecordingRequest.h
 *
 * 
 */

#ifndef OAISuspendContactRecordingRequest_H
#define OAISuspendContactRecordingRequest_H
...
class OAISuspendContactRecordingRequest : public OAIObject {
public:
    OAISuspendContactRecordingRequest();
    OAISuspendContactRecordingRequest(QString json);
    ~OAISuspendContactRecordingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuspendContactRecordingRequest)

#endif // OAISuspendContactRecordingRequest_H
