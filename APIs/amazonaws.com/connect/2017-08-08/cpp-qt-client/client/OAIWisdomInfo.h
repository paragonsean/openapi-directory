...
#ifndef OAIWisdomInfo_H
#define OAIWisdomInfo_H
...
class OAIWisdomInfo : public OAIObject {
public:
    OAIWisdomInfo();
    OAIWisdomInfo(QString json);
    ~OAIWisdomInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWisdomInfo)

#endif // OAIWisdomInfo_H
