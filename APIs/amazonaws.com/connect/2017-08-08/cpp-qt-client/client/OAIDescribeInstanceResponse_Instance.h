...
/*
 * OAIDescribeInstanceResponse_Instance.h
 *
 * 
 */

#ifndef OAIDescribeInstanceResponse_Instance_H
#define OAIDescribeInstanceResponse_Instance_H
...
namespace OpenAPI {
class OAIInstance_StatusReason;

class OAIDescribeInstanceResponse_Instance : public OAIObject {
public:
    OAIDescribeInstanceResponse_Instance();
    OAIDescribeInstanceResponse_Instance(QString json);
    ~OAIDescribeInstanceResponse_Instance() override;
    ...
    OAIInstance_StatusReason getStatusReason() const;
    void setStatusReason(const OAIInstance_StatusReason &status_reason);
...
private:
    ...
    OAIInstance_StatusReason m_status_reason;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInstanceResponse_Instance)

#endif // OAIDescribeInstanceResponse_Instance_H
