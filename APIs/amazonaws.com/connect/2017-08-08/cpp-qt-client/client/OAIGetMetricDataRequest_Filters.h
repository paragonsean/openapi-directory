...
/*
 * OAIGetMetricDataRequest_Filters.h
 *
 * 
 */

#ifndef OAIGetMetricDataRequest_Filters_H
#define OAIGetMetricDataRequest_Filters_H
...
class OAIGetMetricDataRequest_Filters : public OAIObject {
public:
    OAIGetMetricDataRequest_Filters();
    OAIGetMetricDataRequest_Filters(QString json);
    ~OAIGetMetricDataRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMetricDataRequest_Filters)

#endif // OAIGetMetricDataRequest_Filters_H
