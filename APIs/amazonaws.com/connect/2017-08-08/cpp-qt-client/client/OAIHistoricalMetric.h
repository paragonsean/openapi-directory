...
#ifndef OAIHistoricalMetric_H
#define OAIHistoricalMetric_H
...
class OAIHistoricalMetric : public OAIObject {
public:
    OAIHistoricalMetric();
    OAIHistoricalMetric(QString json);
    ~OAIHistoricalMetric() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalMetric)

#endif // OAIHistoricalMetric_H
