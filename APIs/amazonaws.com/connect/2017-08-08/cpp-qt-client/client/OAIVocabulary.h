...
#ifndef OAIVocabulary_H
#define OAIVocabulary_H
...
class OAIVocabulary : public OAIObject {
public:
    OAIVocabulary();
    OAIVocabulary(QString json);
    ~OAIVocabulary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVocabulary)

#endif // OAIVocabulary_H
