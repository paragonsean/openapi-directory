...
/*
 * OAIUpdateContactScheduleRequest.h
 *
 * 
 */

#ifndef OAIUpdateContactScheduleRequest_H
#define OAIUpdateContactScheduleRequest_H
...
class OAIUpdateContactScheduleRequest : public OAIObject {
public:
    OAIUpdateContactScheduleRequest();
    OAIUpdateContactScheduleRequest(QString json);
    ~OAIUpdateContactScheduleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContactScheduleRequest)

#endif // OAIUpdateContactScheduleRequest_H
