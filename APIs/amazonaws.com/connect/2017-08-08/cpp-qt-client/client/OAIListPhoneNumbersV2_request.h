...
/*
 * OAIListPhoneNumbersV2_request.h
 *
 * 
 */

#ifndef OAIListPhoneNumbersV2_request_H
#define OAIListPhoneNumbersV2_request_H
...
class OAIListPhoneNumbersV2_request : public OAIObject {
public:
    OAIListPhoneNumbersV2_request();
    OAIListPhoneNumbersV2_request(QString json);
    ~OAIListPhoneNumbersV2_request() override;
    ...
    QList<OAIPhoneNumberCountryCode> getPhoneNumberCountryCodes() const;
    void setPhoneNumberCountryCodes(const QList<OAIPhoneNumberCountryCode> &phone_number_country_codes);
    bool is_phone_number_country_codes_Set() const;
    bool is_phone_number_country_codes_Valid() const;

    QList<OAIPhoneNumberType> getPhoneNumberTypes() const;
    void setPhoneNumberTypes(const QList<OAIPhoneNumberType> &phone_number_types);
...
private:
    ...
    QList<OAIPhoneNumberCountryCode> m_phone_number_country_codes;
    bool m_phone_number_country_codes_isSet;
    bool m_phone_number_country_codes_isValid;

    QList<OAIPhoneNumberType> m_phone_number_types;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPhoneNumbersV2_request)

#endif // OAIListPhoneNumbersV2_request_H
