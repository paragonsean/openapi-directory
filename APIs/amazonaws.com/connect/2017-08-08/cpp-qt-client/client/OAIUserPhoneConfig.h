...
/*
 * OAIUserPhoneConfig.h
 *
 * Contains information about the phone configuration settings for a user.
 */

#ifndef OAIUserPhoneConfig_H
#define OAIUserPhoneConfig_H
...
class OAIUserPhoneConfig : public OAIObject {
public:
    OAIUserPhoneConfig();
    OAIUserPhoneConfig(QString json);
    ~OAIUserPhoneConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPhoneConfig)

#endif // OAIUserPhoneConfig_H
