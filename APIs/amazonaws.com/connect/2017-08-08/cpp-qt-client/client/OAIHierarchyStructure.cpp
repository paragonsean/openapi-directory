...
#include "OAIHierarchyStructure.h"
...
OAIHierarchyStructure::OAIHierarchyStructure(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHierarchyStructure::OAIHierarchyStructure() {
    this->initializeModel();
}

OAIHierarchyStructure::~OAIHierarchyStructure() {}

void OAIHierarchyStructure::initializeModel() {
...
void OAIHierarchyStructure::fromJson(QString jsonString) {
...
void OAIHierarchyStructure::fromJsonObject(QJsonObject json) {
...
QString OAIHierarchyStructure::asJson() const {
...
QJsonObject OAIHierarchyStructure::asJsonObject() const {
    QJsonObject obj;
...
OAIHierarchyStructure_LevelOne OAIHierarchyStructure::getLevelOne() const {
    return m_level_one;
}
void OAIHierarchyStructure::setLevelOne(const OAIHierarchyStructure_LevelOne &level_one) {
    m_level_one = level_one;
    m_level_one_isSet = true;
}

bool OAIHierarchyStructure::is_level_one_Set() const{
    return m_level_one_isSet;
}

bool OAIHierarchyStructure::is_level_one_Valid() const{
    return m_level_one_isValid;
}

OAIHierarchyStructure_LevelTwo OAIHierarchyStructure::getLevelTwo() const {
    return m_level_two;
}
void OAIHierarchyStructure::setLevelTwo(const OAIHierarchyStructure_LevelTwo &level_two) {
    m_level_two = level_two;
    m_level_two_isSet = true;
}

bool OAIHierarchyStructure::is_level_two_Set() const{
    return m_level_two_isSet;
}

bool OAIHierarchyStructure::is_level_two_Valid() const{
    return m_level_two_isValid;
}

OAIHierarchyStructure_LevelThree OAIHierarchyStructure::getLevelThree() const {
    return m_level_three;
}
void OAIHierarchyStructure::setLevelThree(const OAIHierarchyStructure_LevelThree &level_three) {
    m_level_three = level_three;
    m_level_three_isSet = true;
}

bool OAIHierarchyStructure::is_level_three_Set() const{
    return m_level_three_isSet;
}

bool OAIHierarchyStructure::is_level_three_Valid() const{
    return m_level_three_isValid;
}

OAIHierarchyStructure_LevelFour OAIHierarchyStructure::getLevelFour() const {
    return m_level_four;
}
void OAIHierarchyStructure::setLevelFour(const OAIHierarchyStructure_LevelFour &level_four) {
    m_level_four = level_four;
    m_level_four_isSet = true;
}

bool OAIHierarchyStructure::is_level_four_Set() const{
    return m_level_four_isSet;
}

bool OAIHierarchyStructure::is_level_four_Valid() const{
    return m_level_four_isValid;
}

OAIHierarchyStructure_LevelFive OAIHierarchyStructure::getLevelFive() const {
    return m_level_five;
}
void OAIHierarchyStructure::setLevelFive(const OAIHierarchyStructure_LevelFive &level_five) {
    m_level_five = level_five;
    m_level_five_isSet = true;
}

bool OAIHierarchyStructure::is_level_five_Set() const{
    return m_level_five_isSet;
}

bool OAIHierarchyStructure::is_level_five_Valid() const{
    return m_level_five_isValid;
}

bool OAIHierarchyStructure::isSet() const {
...
bool OAIHierarchyStructure::isValid() const {
