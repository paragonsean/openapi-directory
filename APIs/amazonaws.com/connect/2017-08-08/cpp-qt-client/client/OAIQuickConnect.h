...
#ifndef OAIQuickConnect_H
#define OAIQuickConnect_H
...
class OAIQuickConnect : public OAIObject {
public:
    OAIQuickConnect();
    OAIQuickConnect(QString json);
    ~OAIQuickConnect() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuickConnect)

#endif // OAIQuickConnect_H
