...
/*
 * OAITransferContactResponse.h
 *
 * 
 */

#ifndef OAITransferContactResponse_H
#define OAITransferContactResponse_H
...
class OAITransferContactResponse : public OAIObject {
public:
    OAITransferContactResponse();
    OAITransferContactResponse(QString json);
    ~OAITransferContactResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferContactResponse)

#endif // OAITransferContactResponse_H
