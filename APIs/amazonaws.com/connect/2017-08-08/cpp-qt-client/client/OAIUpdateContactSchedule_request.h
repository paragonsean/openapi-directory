...
/*
 * OAIUpdateContactSchedule_request.h
 *
 * 
 */

#ifndef OAIUpdateContactSchedule_request_H
#define OAIUpdateContactSchedule_request_H
...
class OAIUpdateContactSchedule_request : public OAIObject {
public:
    OAIUpdateContactSchedule_request();
    OAIUpdateContactSchedule_request(QString json);
    ~OAIUpdateContactSchedule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContactSchedule_request)

#endif // OAIUpdateContactSchedule_request_H
