...
OAICreateUserRequest_PhoneConfig::OAICreateUserRequest_PhoneConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserRequest_PhoneConfig::OAICreateUserRequest_PhoneConfig() {
    this->initializeModel();
}

OAICreateUserRequest_PhoneConfig::~OAICreateUserRequest_PhoneConfig() {}

void OAICreateUserRequest_PhoneConfig::initializeModel() {
...
void OAICreateUserRequest_PhoneConfig::fromJson(QString jsonString) {
...
void OAICreateUserRequest_PhoneConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserRequest_PhoneConfig::asJson() const {
...
QJsonObject OAICreateUserRequest_PhoneConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIPhoneType OAICreateUserRequest_PhoneConfig::getPhoneType() const {
    return m_phone_type;
}
void OAICreateUserRequest_PhoneConfig::setPhoneType(const OAIPhoneType &phone_type) {
    m_phone_type = phone_type;
    m_phone_type_isSet = true;
}

bool OAICreateUserRequest_PhoneConfig::is_phone_type_Set() const{
    return m_phone_type_isSet;
}

bool OAICreateUserRequest_PhoneConfig::is_phone_type_Valid() const{
    return m_phone_type_isValid;
}

bool OAICreateUserRequest_PhoneConfig::getAutoAccept() const {
    return m_auto_accept;
}
void OAICreateUserRequest_PhoneConfig::setAutoAccept(const bool &auto_accept) {
    m_auto_accept = auto_accept;
    m_auto_accept_isSet = true;
}

bool OAICreateUserRequest_PhoneConfig::is_auto_accept_Set() const{
    return m_auto_accept_isSet;
}

bool OAICreateUserRequest_PhoneConfig::is_auto_accept_Valid() const{
    return m_auto_accept_isValid;
}

qint32 OAICreateUserRequest_PhoneConfig::getAfterContactWorkTimeLimit() const {
    return m_after_contact_work_time_limit;
}
void OAICreateUserRequest_PhoneConfig::setAfterContactWorkTimeLimit(const qint32 &after_contact_work_time_limit) {
    m_after_contact_work_time_limit = after_contact_work_time_limit;
    m_after_contact_work_time_limit_isSet = true;
}

bool OAICreateUserRequest_PhoneConfig::is_after_contact_work_time_limit_Set() const{
    return m_after_contact_work_time_limit_isSet;
}

bool OAICreateUserRequest_PhoneConfig::is_after_contact_work_time_limit_Valid() const{
    return m_after_contact_work_time_limit_isValid;
}

QString OAICreateUserRequest_PhoneConfig::getDeskPhoneNumber() const {
    return m_desk_phone_number;
}
void OAICreateUserRequest_PhoneConfig::setDeskPhoneNumber(const QString &desk_phone_number) {
    m_desk_phone_number = desk_phone_number;
    m_desk_phone_number_isSet = true;
}

bool OAICreateUserRequest_PhoneConfig::is_desk_phone_number_Set() const{
    return m_desk_phone_number_isSet;
}

bool OAICreateUserRequest_PhoneConfig::is_desk_phone_number_Valid() const{
    return m_desk_phone_number_isValid;
}

bool OAICreateUserRequest_PhoneConfig::isSet() const {
...
bool OAICreateUserRequest_PhoneConfig::isValid() const {
