...
#ifndef OAIMetricResultV2_H
#define OAIMetricResultV2_H
...
class OAIMetricResultV2 : public OAIObject {
public:
    OAIMetricResultV2();
    OAIMetricResultV2(QString json);
    ~OAIMetricResultV2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricResultV2)

#endif // OAIMetricResultV2_H
