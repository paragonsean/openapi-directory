...
OAICreateRuleRequest_TriggerEventSource OAIRule::getTriggerEventSource() const {
    return m_trigger_event_source;
}
void OAIRule::setTriggerEventSource(const OAICreateRuleRequest_TriggerEventSource &trigger_event_source) {
    m_trigger_event_source = trigger_event_source;
    m_trigger_event_source_isSet = true;
}

bool OAIRule::is_trigger_event_source_Set() const{
    return m_trigger_event_source_isSet;
}

bool OAIRule::is_trigger_event_source_Valid() const{
    return m_trigger_event_source_isValid;
}

QString OAIRule::getFunction() const {
    return m_function;
}
void OAIRule::setFunction(const QString &function) {
    m_function = function;
    m_function_isSet = true;
}

bool OAIRule::is_function_Set() const{
    return m_function_isSet;
}

bool OAIRule::is_function_Valid() const{
...
OAIRulePublishStatus OAIRule::getPublishStatus() const {
    return m_publish_status;
}
void OAIRule::setPublishStatus(const OAIRulePublishStatus &publish_status) {
    m_publish_status = publish_status;
    m_publish_status_isSet = true;
}

bool OAIRule::is_publish_status_Set() const{
    return m_publish_status_isSet;
}

bool OAIRule::is_publish_status_Valid() const{
    return m_publish_status_isValid;
}

QDateTime OAIRule::getCreatedTime() const {
    return m_created_time;
}
void OAIRule::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRule::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRule::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QDateTime OAIRule::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIRule::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIRule::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIRule::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

QString OAIRule::getLastUpdatedBy() const {
    return m_last_updated_by;
}
void OAIRule::setLastUpdatedBy(const QString &last_updated_by) {
    m_last_updated_by = last_updated_by;
    m_last_updated_by_isSet = true;
}

bool OAIRule::is_last_updated_by_Set() const{
    return m_last_updated_by_isSet;
}

bool OAIRule::is_last_updated_by_Valid() const{
    return m_last_updated_by_isValid;
}

QMap OAIRule::getTags() const {
    return m_tags;
}
void OAIRule::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
