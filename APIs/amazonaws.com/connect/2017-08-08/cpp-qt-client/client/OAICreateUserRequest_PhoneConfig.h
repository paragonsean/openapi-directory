...
/*
 * OAICreateUserRequest_PhoneConfig.h
 *
 * 
 */

#ifndef OAICreateUserRequest_PhoneConfig_H
#define OAICreateUserRequest_PhoneConfig_H
...
class OAICreateUserRequest_PhoneConfig : public OAIObject {
public:
    OAICreateUserRequest_PhoneConfig();
    OAICreateUserRequest_PhoneConfig(QString json);
    ~OAICreateUserRequest_PhoneConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserRequest_PhoneConfig)

#endif // OAICreateUserRequest_PhoneConfig_H
