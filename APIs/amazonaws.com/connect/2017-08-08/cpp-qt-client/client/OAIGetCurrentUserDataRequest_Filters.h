...
/*
 * OAIGetCurrentUserDataRequest_Filters.h
 *
 * 
 */

#ifndef OAIGetCurrentUserDataRequest_Filters_H
#define OAIGetCurrentUserDataRequest_Filters_H
...
class OAIGetCurrentUserDataRequest_Filters : public OAIObject {
public:
    OAIGetCurrentUserDataRequest_Filters();
    OAIGetCurrentUserDataRequest_Filters(QString json);
    ~OAIGetCurrentUserDataRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCurrentUserDataRequest_Filters)

#endif // OAIGetCurrentUserDataRequest_Filters_H
