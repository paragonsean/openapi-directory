...
/*
 * OAIGetCurrentMetricDataRequest_Filters.h
 *
 * 
 */

#ifndef OAIGetCurrentMetricDataRequest_Filters_H
#define OAIGetCurrentMetricDataRequest_Filters_H
...
class OAIGetCurrentMetricDataRequest_Filters : public OAIObject {
public:
    OAIGetCurrentMetricDataRequest_Filters();
    OAIGetCurrentMetricDataRequest_Filters(QString json);
    ~OAIGetCurrentMetricDataRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCurrentMetricDataRequest_Filters)

#endif // OAIGetCurrentMetricDataRequest_Filters_H
