...
/*
 * OAIStartChatContact_request_PersistentChat.h
 *
...
#ifndef OAIStartChatContact_request_PersistentChat_H
#define OAIStartChatContact_request_PersistentChat_H
...
class OAIStartChatContact_request_PersistentChat : public OAIObject {
public:
    OAIStartChatContact_request_PersistentChat();
    OAIStartChatContact_request_PersistentChat(QString json);
    ~OAIStartChatContact_request_PersistentChat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartChatContact_request_PersistentChat)

#endif // OAIStartChatContact_request_PersistentChat_H
