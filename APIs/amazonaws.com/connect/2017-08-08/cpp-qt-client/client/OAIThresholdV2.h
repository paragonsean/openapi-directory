...
#ifndef OAIThresholdV2_H
#define OAIThresholdV2_H
...
class OAIThresholdV2 : public OAIObject {
public:
    OAIThresholdV2();
    OAIThresholdV2(QString json);
    ~OAIThresholdV2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThresholdV2)

#endif // OAIThresholdV2_H
