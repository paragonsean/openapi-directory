...
OAIThresholdV2::OAIThresholdV2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThresholdV2::OAIThresholdV2() {
    this->initializeModel();
}

OAIThresholdV2::~OAIThresholdV2() {}

void OAIThresholdV2::initializeModel() {
...
void OAIThresholdV2::fromJson(QString jsonString) {
...
void OAIThresholdV2::fromJsonObject(QJsonObject json) {
...
QString OAIThresholdV2::asJson() const {
...
QJsonObject OAIThresholdV2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIThresholdV2::getComparison() const {
    return m_comparison;
}
void OAIThresholdV2::setComparison(const QString &comparison) {
    m_comparison = comparison;
    m_comparison_isSet = true;
}

bool OAIThresholdV2::is_comparison_Set() const{
    return m_comparison_isSet;
}

bool OAIThresholdV2::is_comparison_Valid() const{
    return m_comparison_isValid;
}

double OAIThresholdV2::getThresholdValue() const {
    return m_threshold_value;
}
void OAIThresholdV2::setThresholdValue(const double &threshold_value) {
    m_threshold_value = threshold_value;
    m_threshold_value_isSet = true;
}

bool OAIThresholdV2::is_threshold_value_Set() const{
    return m_threshold_value_isSet;
}

bool OAIThresholdV2::is_threshold_value_Valid() const{
    return m_threshold_value_isValid;
}

bool OAIThresholdV2::isSet() const {
...
bool OAIThresholdV2::isValid() const {
