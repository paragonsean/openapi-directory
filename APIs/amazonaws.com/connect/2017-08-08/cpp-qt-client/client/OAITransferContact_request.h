...
/*
 * OAITransferContact_request.h
 *
 * 
 */

#ifndef OAITransferContact_request_H
#define OAITransferContact_request_H
...
class OAITransferContact_request : public OAIObject {
public:
    OAITransferContact_request();
    OAITransferContact_request(QString json);
    ~OAITransferContact_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferContact_request)

#endif // OAITransferContact_request_H
