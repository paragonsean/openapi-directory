...
|------------ | ------------- | ------------- | -------------|
|**evaluationFormVersion** | **Integer** | A version of the evaluation form to update. |  |
...
|**items** | [**List&lt;EvaluationFormItem&gt;**](EvaluationFormItem.md) | Items that are part of the evaluation form. The total number of sections and questions must not exceed 100 each. Questions must be contained in a section. |  |
