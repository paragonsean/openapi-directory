...
|**description** | **String** | The description of the hours of operation. |  [optional] |
|**timeZone** | **String** | The time zone of the hours of operation. |  |
|**config** | [**List&lt;HoursOfOperationConfig&gt;**](HoursOfOperationConfig.md) | Configuration information for the hours of operation: day, start time, and end time. |  |
