...
public class ChatMessage {
  ...
  public ChatMessage contentType(String contentType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentType, chatMessage.contentType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChatMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
