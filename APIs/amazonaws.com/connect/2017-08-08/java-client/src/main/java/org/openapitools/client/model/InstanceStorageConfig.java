...
public class InstanceStorageConfig {
  ...
  public InstanceStorageConfig() {
  }

  public InstanceStorageConfig associationId(String associationId) {
  ...
  public InstanceStorageConfig storageType(StorageType storageType) {
  ...
  public InstanceStorageConfig s3Config(AssociateInstanceStorageConfigRequestStorageConfigS3Config s3Config) {
  ...
  public InstanceStorageConfig kinesisVideoStreamConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisVideoStreamConfig kinesisVideoStreamConfig) {
  ...
  public InstanceStorageConfig kinesisStreamConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisStreamConfig kinesisStreamConfig) {
  ...
  public InstanceStorageConfig kinesisFirehoseConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisFirehoseConfig kinesisFirehoseConfig) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceStorageConfig instanceStorageConfig = (InstanceStorageConfig) o;
    return Objects.equals(this.associationId, instanceStorageConfig.associationId) &&
        Objects.equals(this.storageType, instanceStorageConfig.storageType) &&
        Objects.equals(this.s3Config, instanceStorageConfig.s3Config) &&
        Objects.equals(this.kinesisVideoStreamConfig, instanceStorageConfig.kinesisVideoStreamConfig) &&
        Objects.equals(this.kinesisStreamConfig, instanceStorageConfig.kinesisStreamConfig) &&
        Objects.equals(this.kinesisFirehoseConfig, instanceStorageConfig.kinesisFirehoseConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceStorageConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceStorageConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceStorageConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceStorageConfig is not found in the empty JSON string", InstanceStorageConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceStorageConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceStorageConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstanceStorageConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceStorageConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceStorageConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceStorageConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceStorageConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceStorageConfig>() {
           @Override
           public void write(JsonWriter out, InstanceStorageConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceStorageConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceStorageConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceStorageConfig
   * @throws IOException if the JSON string is invalid with respect to InstanceStorageConfig
   */
  public static InstanceStorageConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceStorageConfig.class);
  }

  /**
   * Convert an instance of InstanceStorageConfig to an JSON string
   *
   * @return JSON string
   */
