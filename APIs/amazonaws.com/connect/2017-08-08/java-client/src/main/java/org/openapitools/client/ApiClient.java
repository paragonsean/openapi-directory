...
public class ApiClient {
    ...
    private String basePath = "http://connect.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://connect.{region}.amazonaws.com",
      "The Amazon Connect multi-region endpoint",
    ...
    new ServerConfiguration(
      "http://connect.{region}.amazonaws.com.cn",
      "The Amazon Connect endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://connect.{region}.amazonaws.com.cn",
      "The Amazon Connect endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-08-08/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://connect.us-east-1.amazonaws.com
