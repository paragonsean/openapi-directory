...
public class DescribeUserResponseUser {
  ...
  public DescribeUserResponseUser() {
  }

  public DescribeUserResponseUser id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeUserResponseUser arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeUserResponseUser username(String username) {
  ...
  public DescribeUserResponseUser identityInfo(UserIdentityInfo identityInfo) {
  ...
  public DescribeUserResponseUser phoneConfig(UserPhoneConfig phoneConfig) {
  ...
  public DescribeUserResponseUser directoryUserId(String directoryUserId) {
  ...
  public DescribeUserResponseUser securityProfileIds(List securityProfileIds) {
  ...
  public DescribeUserResponseUser routingProfileId(String routingProfileId) {
  ...
  public DescribeUserResponseUser hierarchyGroupId(String hierarchyGroupId) {
  ...
  public DescribeUserResponseUser tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeUserResponseUser describeUserResponseUser = (DescribeUserResponseUser) o;
    return Objects.equals(this.id, describeUserResponseUser.id) &&
        Objects.equals(this.arn, describeUserResponseUser.arn) &&
        Objects.equals(this.username, describeUserResponseUser.username) &&
        Objects.equals(this.identityInfo, describeUserResponseUser.identityInfo) &&
        Objects.equals(this.phoneConfig, describeUserResponseUser.phoneConfig) &&
        Objects.equals(this.directoryUserId, describeUserResponseUser.directoryUserId) &&
        Objects.equals(this.securityProfileIds, describeUserResponseUser.securityProfileIds) &&
        Objects.equals(this.routingProfileId, describeUserResponseUser.routingProfileId) &&
        Objects.equals(this.hierarchyGroupId, describeUserResponseUser.hierarchyGroupId) &&
        Objects.equals(this.tags, describeUserResponseUser.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeUserResponseUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUserResponseUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUserResponseUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUserResponseUser is not found in the empty JSON string", DescribeUserResponseUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUserResponseUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUserResponseUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUserResponseUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUserResponseUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUserResponseUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUserResponseUser.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUserResponseUser>() {
           @Override
           public void write(JsonWriter out, DescribeUserResponseUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUserResponseUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUserResponseUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUserResponseUser
   * @throws IOException if the JSON string is invalid with respect to DescribeUserResponseUser
   */
  public static DescribeUserResponseUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUserResponseUser.class);
  }

  /**
   * Convert an instance of DescribeUserResponseUser to an JSON string
   *
   * @return JSON string
   */
