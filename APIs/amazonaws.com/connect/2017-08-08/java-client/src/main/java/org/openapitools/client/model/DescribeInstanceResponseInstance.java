...
public class DescribeInstanceResponseInstance {
  ...
  public DescribeInstanceResponseInstance() {
  }

  public DescribeInstanceResponseInstance id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DescribeInstanceResponseInstance arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeInstanceResponseInstance identityManagementType(DirectoryType identityManagementType) {
  ...
  public DescribeInstanceResponseInstance instanceAlias(String instanceAlias) {
  ...
  public DescribeInstanceResponseInstance createdTime(OffsetDateTime createdTime) {
  ...
  public DescribeInstanceResponseInstance serviceRole(String serviceRole) {
  ...
  public DescribeInstanceResponseInstance instanceStatus(InstanceStatus instanceStatus) {
  ...
  public DescribeInstanceResponseInstance statusReason(InstanceStatusReason statusReason) {
  ...
  public DescribeInstanceResponseInstance inboundCallsEnabled(Boolean inboundCallsEnabled) {
  ...
  public DescribeInstanceResponseInstance outboundCallsEnabled(Boolean outboundCallsEnabled) {
  ...
  public DescribeInstanceResponseInstance instanceAccessUrl(String instanceAccessUrl) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeInstanceResponseInstance describeInstanceResponseInstance = (DescribeInstanceResponseInstance) o;
    return Objects.equals(this.id, describeInstanceResponseInstance.id) &&
        Objects.equals(this.arn, describeInstanceResponseInstance.arn) &&
        Objects.equals(this.identityManagementType, describeInstanceResponseInstance.identityManagementType) &&
        Objects.equals(this.instanceAlias, describeInstanceResponseInstance.instanceAlias) &&
        Objects.equals(this.createdTime, describeInstanceResponseInstance.createdTime) &&
        Objects.equals(this.serviceRole, describeInstanceResponseInstance.serviceRole) &&
        Objects.equals(this.instanceStatus, describeInstanceResponseInstance.instanceStatus) &&
        Objects.equals(this.statusReason, describeInstanceResponseInstance.statusReason) &&
        Objects.equals(this.inboundCallsEnabled, describeInstanceResponseInstance.inboundCallsEnabled) &&
        Objects.equals(this.outboundCallsEnabled, describeInstanceResponseInstance.outboundCallsEnabled) &&
        Objects.equals(this.instanceAccessUrl, describeInstanceResponseInstance.instanceAccessUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInstanceResponseInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInstanceResponseInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInstanceResponseInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInstanceResponseInstance is not found in the empty JSON string", DescribeInstanceResponseInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInstanceResponseInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInstanceResponseInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInstanceResponseInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInstanceResponseInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInstanceResponseInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInstanceResponseInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInstanceResponseInstance>() {
           @Override
           public void write(JsonWriter out, DescribeInstanceResponseInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInstanceResponseInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInstanceResponseInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInstanceResponseInstance
   * @throws IOException if the JSON string is invalid with respect to DescribeInstanceResponseInstance
   */
  public static DescribeInstanceResponseInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInstanceResponseInstance.class);
  }

  /**
   * Convert an instance of DescribeInstanceResponseInstance to an JSON string
   *
   * @return JSON string
   */
