...
public class DescribeInstanceStorageConfigResponseStorageConfig {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig() {
  }

  public DescribeInstanceStorageConfigResponseStorageConfig associationId(String associationId) {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig storageType(StorageType storageType) {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig s3Config(AssociateInstanceStorageConfigRequestStorageConfigS3Config s3Config) {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig kinesisVideoStreamConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisVideoStreamConfig kinesisVideoStreamConfig) {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig kinesisStreamConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisStreamConfig kinesisStreamConfig) {
  ...
  public DescribeInstanceStorageConfigResponseStorageConfig kinesisFirehoseConfig(AssociateInstanceStorageConfigRequestStorageConfigKinesisFirehoseConfig kinesisFirehoseConfig) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeInstanceStorageConfigResponseStorageConfig describeInstanceStorageConfigResponseStorageConfig = (DescribeInstanceStorageConfigResponseStorageConfig) o;
    return Objects.equals(this.associationId, describeInstanceStorageConfigResponseStorageConfig.associationId) &&
        Objects.equals(this.storageType, describeInstanceStorageConfigResponseStorageConfig.storageType) &&
        Objects.equals(this.s3Config, describeInstanceStorageConfigResponseStorageConfig.s3Config) &&
        Objects.equals(this.kinesisVideoStreamConfig, describeInstanceStorageConfigResponseStorageConfig.kinesisVideoStreamConfig) &&
        Objects.equals(this.kinesisStreamConfig, describeInstanceStorageConfigResponseStorageConfig.kinesisStreamConfig) &&
        Objects.equals(this.kinesisFirehoseConfig, describeInstanceStorageConfigResponseStorageConfig.kinesisFirehoseConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeInstanceStorageConfigResponseStorageConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeInstanceStorageConfigResponseStorageConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeInstanceStorageConfigResponseStorageConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeInstanceStorageConfigResponseStorageConfig is not found in the empty JSON string", DescribeInstanceStorageConfigResponseStorageConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeInstanceStorageConfigResponseStorageConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeInstanceStorageConfigResponseStorageConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeInstanceStorageConfigResponseStorageConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeInstanceStorageConfigResponseStorageConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeInstanceStorageConfigResponseStorageConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeInstanceStorageConfigResponseStorageConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeInstanceStorageConfigResponseStorageConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeInstanceStorageConfigResponseStorageConfig>() {
           @Override
           public void write(JsonWriter out, DescribeInstanceStorageConfigResponseStorageConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeInstanceStorageConfigResponseStorageConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeInstanceStorageConfigResponseStorageConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeInstanceStorageConfigResponseStorageConfig
   * @throws IOException if the JSON string is invalid with respect to DescribeInstanceStorageConfigResponseStorageConfig
   */
  public static DescribeInstanceStorageConfigResponseStorageConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeInstanceStorageConfigResponseStorageConfig.class);
  }

  /**
   * Convert an instance of DescribeInstanceStorageConfigResponseStorageConfig to an JSON string
   *
   * @return JSON string
   */
