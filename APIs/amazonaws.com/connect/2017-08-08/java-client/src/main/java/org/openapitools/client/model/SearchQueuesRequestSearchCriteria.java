...
public class SearchQueuesRequestSearchCriteria {
  ...
  public SearchQueuesRequestSearchCriteria() {
  }

  public SearchQueuesRequestSearchCriteria orConditions(List orConditions) {
  ...
  public SearchQueuesRequestSearchCriteria andConditions(List andConditions) {
  ...
  public SearchQueuesRequestSearchCriteria stringCondition(SearchPromptsRequestSearchCriteriaStringCondition stringCondition) {
  ...
  public SearchQueuesRequestSearchCriteria queueTypeCondition(SearchableQueueType queueTypeCondition) {
  ...
  public boolean equals(Object o) {
    ...
    SearchQueuesRequestSearchCriteria searchQueuesRequestSearchCriteria = (SearchQueuesRequestSearchCriteria) o;
    return Objects.equals(this.orConditions, searchQueuesRequestSearchCriteria.orConditions) &&
        Objects.equals(this.andConditions, searchQueuesRequestSearchCriteria.andConditions) &&
        Objects.equals(this.stringCondition, searchQueuesRequestSearchCriteria.stringCondition) &&
        Objects.equals(this.queueTypeCondition, searchQueuesRequestSearchCriteria.queueTypeCondition);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchQueuesRequestSearchCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchQueuesRequestSearchCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchQueuesRequestSearchCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchQueuesRequestSearchCriteria is not found in the empty JSON string", SearchQueuesRequestSearchCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchQueuesRequestSearchCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchQueuesRequestSearchCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchQueuesRequestSearchCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchQueuesRequestSearchCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchQueuesRequestSearchCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchQueuesRequestSearchCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchQueuesRequestSearchCriteria>() {
           @Override
           public void write(JsonWriter out, SearchQueuesRequestSearchCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchQueuesRequestSearchCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchQueuesRequestSearchCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchQueuesRequestSearchCriteria
   * @throws IOException if the JSON string is invalid with respect to SearchQueuesRequestSearchCriteria
   */
  public static SearchQueuesRequestSearchCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchQueuesRequestSearchCriteria.class);
  }

  /**
   * Convert an instance of SearchQueuesRequestSearchCriteria to an JSON string
   *
   * @return JSON string
   */
