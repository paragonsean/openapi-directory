...
public class HierarchyGroupHierarchyPath {
  ...
  public HierarchyGroupHierarchyPath() {
  }

  public HierarchyGroupHierarchyPath levelOne(HierarchyPathLevelOne levelOne) {
  ...
  public HierarchyGroupHierarchyPath levelTwo(HierarchyPathLevelTwo levelTwo) {
  ...
  public HierarchyGroupHierarchyPath levelThree(HierarchyPathLevelThree levelThree) {
  ...
  public HierarchyGroupHierarchyPath levelFour(HierarchyPathLevelFour levelFour) {
  ...
  public HierarchyGroupHierarchyPath levelFive(HierarchyPathLevelFive levelFive) {
  ...
  public boolean equals(Object o) {
    ...
    HierarchyGroupHierarchyPath hierarchyGroupHierarchyPath = (HierarchyGroupHierarchyPath) o;
    return Objects.equals(this.levelOne, hierarchyGroupHierarchyPath.levelOne) &&
        Objects.equals(this.levelTwo, hierarchyGroupHierarchyPath.levelTwo) &&
        Objects.equals(this.levelThree, hierarchyGroupHierarchyPath.levelThree) &&
        Objects.equals(this.levelFour, hierarchyGroupHierarchyPath.levelFour) &&
        Objects.equals(this.levelFive, hierarchyGroupHierarchyPath.levelFive);
  }
  ...
  public String toString() {
    ...
    sb.append("class HierarchyGroupHierarchyPath {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HierarchyGroupHierarchyPath
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HierarchyGroupHierarchyPath.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HierarchyGroupHierarchyPath is not found in the empty JSON string", HierarchyGroupHierarchyPath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HierarchyGroupHierarchyPath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HierarchyGroupHierarchyPath` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HierarchyGroupHierarchyPath.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HierarchyGroupHierarchyPath' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HierarchyGroupHierarchyPath> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HierarchyGroupHierarchyPath.class));

       return (TypeAdapter<T>) new TypeAdapter<HierarchyGroupHierarchyPath>() {
           @Override
           public void write(JsonWriter out, HierarchyGroupHierarchyPath value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HierarchyGroupHierarchyPath read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HierarchyGroupHierarchyPath given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HierarchyGroupHierarchyPath
   * @throws IOException if the JSON string is invalid with respect to HierarchyGroupHierarchyPath
   */
  public static HierarchyGroupHierarchyPath fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HierarchyGroupHierarchyPath.class);
  }

  /**
   * Convert an instance of HierarchyGroupHierarchyPath to an JSON string
   *
   * @return JSON string
   */
