...
public class ListPhoneNumbersSummary {
  ...
  public ListPhoneNumbersSummary() {
  }

  public ListPhoneNumbersSummary phoneNumberId(String phoneNumberId) {
  ...
  public ListPhoneNumbersSummary phoneNumberArn(String phoneNumberArn) {
  ...
  public ListPhoneNumbersSummary phoneNumber(String phoneNumber) {
  ...
  public ListPhoneNumbersSummary phoneNumberCountryCode(PhoneNumberCountryCode phoneNumberCountryCode) {
  ...
  public ListPhoneNumbersSummary phoneNumberType(PhoneNumberType phoneNumberType) {
  ...
  public ListPhoneNumbersSummary targetArn(String targetArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.phoneNumberId, listPhoneNumbersSummary.phoneNumberId) &&
        Objects.equals(this.phoneNumberArn, listPhoneNumbersSummary.phoneNumberArn) &&
        Objects.equals(this.phoneNumber, listPhoneNumbersSummary.phoneNumber) &&
        Objects.equals(this.phoneNumberCountryCode, listPhoneNumbersSummary.phoneNumberCountryCode) &&
        Objects.equals(this.phoneNumberType, listPhoneNumbersSummary.phoneNumberType) &&
        Objects.equals(this.targetArn, listPhoneNumbersSummary.targetArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(phoneNumberId, phoneNumberArn, phoneNumber, phoneNumberCountryCode, phoneNumberType, targetArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPhoneNumbersSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPhoneNumbersSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPhoneNumbersSummary is not found in the empty JSON string", ListPhoneNumbersSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPhoneNumbersSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPhoneNumbersSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPhoneNumbersSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPhoneNumbersSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPhoneNumbersSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPhoneNumbersSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPhoneNumbersSummary>() {
           @Override
           public void write(JsonWriter out, ListPhoneNumbersSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPhoneNumbersSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPhoneNumbersSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPhoneNumbersSummary
   * @throws IOException if the JSON string is invalid with respect to ListPhoneNumbersSummary
   */
  public static ListPhoneNumbersSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPhoneNumbersSummary.class);
  }

  /**
   * Convert an instance of ListPhoneNumbersSummary to an JSON string
   *
   * @return JSON string
   */
