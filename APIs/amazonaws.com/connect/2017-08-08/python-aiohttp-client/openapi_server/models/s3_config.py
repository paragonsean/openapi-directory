...
class S3Config(Model):
    ...
    def __init__(self, bucket_name: str=None, bucket_prefix: str=None, encryption_config: S3ConfigEncryptionConfig=None):
        ...
        :param bucket_prefix: The bucket_prefix of this S3Config.
        :param encryption_config: The encryption_config of this S3Config.
        """
        self.openapi_types = {
            'bucket_name': str,
            'bucket_prefix': str,
    ...
    def bucket_prefix(self):
        """Gets the bucket_prefix of this S3Config.


        :return: The bucket_prefix of this S3Config.
        :rtype: str
        """
    ...
    def bucket_prefix(self, bucket_prefix):
        """Sets the bucket_prefix of this S3Config.
    ...
    def encryption_config(self):
        """Gets the encryption_config of this S3Config.


        :return: The encryption_config of this S3Config.
    ...
    def encryption_config(self, encryption_config):
        """Sets the encryption_config of this S3Config.
