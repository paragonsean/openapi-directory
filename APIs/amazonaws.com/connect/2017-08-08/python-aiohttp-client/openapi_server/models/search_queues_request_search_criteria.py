...
class SearchQueuesRequestSearchCriteria(Model):
    ...
    def __init__(self, or_conditions: List=None, and_conditions: List=None, string_condition: SearchPromptsRequestSearchCriteriaStringCondition=None, queue_type_condition: SearchableQueueType=None):
        """SearchQueuesRequestSearchCriteria - a model defined in OpenAPI

        :param or_conditions: The or_conditions of this SearchQueuesRequestSearchCriteria.
        :param and_conditions: The and_conditions of this SearchQueuesRequestSearchCriteria.
        :param string_condition: The string_condition of this SearchQueuesRequestSearchCriteria.
        :param queue_type_condition: The queue_type_condition of this SearchQueuesRequestSearchCriteria.
        """
        self.openapi_types = {
            'or_conditions': List,
            'and_conditions': List,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SearchQueuesRequestSearchCriteria':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SearchQueuesRequest_SearchCriteria of this SearchQueuesRequestSearchCriteria.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def or_conditions(self):
        """Gets the or_conditions of this SearchQueuesRequestSearchCriteria.


        :return: The or_conditions of this SearchQueuesRequestSearchCriteria.
        :rtype: List
        """
    ...
    def or_conditions(self, or_conditions):
        """Sets the or_conditions of this SearchQueuesRequestSearchCriteria.
    ...
    def and_conditions(self):
        """Gets the and_conditions of this SearchQueuesRequestSearchCriteria.


        :return: The and_conditions of this SearchQueuesRequestSearchCriteria.
        :rtype: List
        """
    ...
    def and_conditions(self, and_conditions):
        """Sets the and_conditions of this SearchQueuesRequestSearchCriteria.
    ...
    def string_condition(self):
        """Gets the string_condition of this SearchQueuesRequestSearchCriteria.


        :return: The string_condition of this SearchQueuesRequestSearchCriteria.
    ...
    def string_condition(self, string_condition):
        """Sets the string_condition of this SearchQueuesRequestSearchCriteria.
    ...
    def queue_type_condition(self):
        """Gets the queue_type_condition of this SearchQueuesRequestSearchCriteria.


        :return: The queue_type_condition of this SearchQueuesRequestSearchCriteria.
    ...
    def queue_type_condition(self, queue_type_condition):
        """Sets the queue_type_condition of this SearchQueuesRequestSearchCriteria.
