...
class UpdateRoutingProfileQueuesRequest(Model):
    ...
    def __init__(self, queue_configs: List[RoutingProfileQueueConfig]=None):
        """UpdateRoutingProfileQueuesRequest - a model defined in OpenAPI

        :param queue_configs: The queue_configs of this UpdateRoutingProfileQueuesRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateRoutingProfileQueuesRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateRoutingProfileQueues_request of this UpdateRoutingProfileQueuesRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def queue_configs(self):
        """Gets the queue_configs of this UpdateRoutingProfileQueuesRequest.

        The queues to be updated for this routing profile. Queues must first be associated to the routing profile. You can do this using AssociateRoutingProfileQueues.

        :return: The queue_configs of this UpdateRoutingProfileQueuesRequest.
    ...
    def queue_configs(self, queue_configs):
        """Sets the queue_configs of this UpdateRoutingProfileQueuesRequest.
