...
class EventSourceName(Model):
    ...
    def __init__(self):
        """EventSourceName - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EventSourceName':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EventSourceName of this EventSourceName.
        """
