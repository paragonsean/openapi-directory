...
public class ApiClient {
    ...
    private String basePath = "http://backupstorage.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://backupstorage.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://backupstorage.{region}.amazonaws.com",
      "The AWS Backup Storage multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://backupstorage.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://backupstorage.{region}.amazonaws.com.cn",
      "The AWS Backup Storage endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-04-10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://backupstorage.us-east-1.amazonaws.com
