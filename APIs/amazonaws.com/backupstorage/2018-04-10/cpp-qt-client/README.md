...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::deleteObjectSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::deleteObjectSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString job_id = create(); // QString | Backup job Id for the in-progress backup.
      ...
      QString object_name = create(); // QString | The name of the Object.
      ...
      apiInstance.deleteObject(job_idobject_namex_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
