...
class S3JobDefinition(Model):
    ...
    def __init__(self, bucket_criteria: CreateClassificationJobRequestS3JobDefinitionBucketCriteria=None, bucket_definitions: List=None, scoping: CreateClassificationJobRequestS3JobDefinitionScoping=None):
        """S3JobDefinition - a model defined in OpenAPI

        :param bucket_criteria: The bucket_criteria of this S3JobDefinition.
        :param bucket_definitions: The bucket_definitions of this S3JobDefinition.
        :param scoping: The scoping of this S3JobDefinition.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'S3JobDefinition':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The S3JobDefinition of this S3JobDefinition.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bucket_criteria(self):
        """Gets the bucket_criteria of this S3JobDefinition.


        :return: The bucket_criteria of this S3JobDefinition.
    ...
    def bucket_criteria(self, bucket_criteria):
        """Sets the bucket_criteria of this S3JobDefinition.
    ...
    def bucket_definitions(self):
        """Gets the bucket_definitions of this S3JobDefinition.


        :return: The bucket_definitions of this S3JobDefinition.
        :rtype: List
        """
    ...
    def bucket_definitions(self, bucket_definitions):
        """Sets the bucket_definitions of this S3JobDefinition.
    ...
    @property
    def scoping(self):
        """Gets the scoping of this S3JobDefinition.


        :return: The scoping of this S3JobDefinition.
    ...
    def scoping(self, scoping):
        """Sets the scoping of this S3JobDefinition.
