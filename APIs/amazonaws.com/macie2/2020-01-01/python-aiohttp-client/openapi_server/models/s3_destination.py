...
class S3Destination(Model):
    ...
    def __init__(self, bucket_name: str=None, key_prefix: str=None, kms_key_arn: str=None):
        ...
        :param kms_key_arn: The kms_key_arn of this S3Destination.
        """
        self.openapi_types = {
            'bucket_name': str,
            'key_prefix': str,
    ...
    def kms_key_arn(self):
        """Gets the kms_key_arn of this S3Destination.


        :return: The kms_key_arn of this S3Destination.
        :rtype: str
        """
    ...
    def kms_key_arn(self, kms_key_arn):
        """Sets the kms_key_arn of this S3Destination.
