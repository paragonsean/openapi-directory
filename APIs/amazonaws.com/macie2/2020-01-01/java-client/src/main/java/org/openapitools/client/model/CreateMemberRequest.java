...
public class CreateMemberRequest {
  ...
  private CreateMemberRequestAccount account;
  ...
  public CreateMemberRequest account(CreateMemberRequestAccount account) {
  ...
  public CreateMemberRequestAccount getAccount() {
    return account;
  }

  public void setAccount(CreateMemberRequestAccount account) {
    this.account = account;
  }


  public CreateMemberRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateMemberRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, createMemberRequest.account) &&
        Objects.equals(this.tags, createMemberRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      CreateMemberRequestAccount.validateJsonElement(jsonObj.get("account"));
  }
