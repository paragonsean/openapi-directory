...
public class MatchingResourceMatchingBucket {
  ...
  public MatchingResourceMatchingBucket() {
  }

  public MatchingResourceMatchingBucket accountId(String accountId) {
  ...
  public MatchingResourceMatchingBucket bucketName(String bucketName) {
  ...
  public MatchingResourceMatchingBucket classifiableObjectCount(Integer classifiableObjectCount) {
  ...
  public MatchingResourceMatchingBucket classifiableSizeInBytes(Integer classifiableSizeInBytes) {
  ...
  public MatchingResourceMatchingBucket errorCode(BucketMetadataErrorCode errorCode) {
  ...
  public MatchingResourceMatchingBucket errorMessage(String errorMessage) {
  ...
  public MatchingResourceMatchingBucket jobDetails(MatchingBucketJobDetails jobDetails) {
  ...
  public MatchingResourceMatchingBucket lastAutomatedDiscoveryTime(OffsetDateTime lastAutomatedDiscoveryTime) {
  ...
  public MatchingResourceMatchingBucket objectCount(Integer objectCount) {
  ...
  public MatchingResourceMatchingBucket objectCountByEncryptionType(BucketMetadataObjectCountByEncryptionType objectCountByEncryptionType) {
  ...
  public MatchingResourceMatchingBucket sensitivityScore(Integer sensitivityScore) {
  ...
  public MatchingResourceMatchingBucket sizeInBytes(Integer sizeInBytes) {
  ...
  public MatchingResourceMatchingBucket sizeInBytesCompressed(Integer sizeInBytesCompressed) {
  ...
  public MatchingResourceMatchingBucket unclassifiableObjectCount(BucketMetadataUnclassifiableObjectCount unclassifiableObjectCount) {
  ...
  public MatchingResourceMatchingBucket unclassifiableObjectSizeInBytes(BucketMetadataUnclassifiableObjectSizeInBytes unclassifiableObjectSizeInBytes) {
  ...
  public boolean equals(Object o) {
    ...
    MatchingResourceMatchingBucket matchingResourceMatchingBucket = (MatchingResourceMatchingBucket) o;
    return Objects.equals(this.accountId, matchingResourceMatchingBucket.accountId) &&
        Objects.equals(this.bucketName, matchingResourceMatchingBucket.bucketName) &&
        Objects.equals(this.classifiableObjectCount, matchingResourceMatchingBucket.classifiableObjectCount) &&
        Objects.equals(this.classifiableSizeInBytes, matchingResourceMatchingBucket.classifiableSizeInBytes) &&
        Objects.equals(this.errorCode, matchingResourceMatchingBucket.errorCode) &&
        Objects.equals(this.errorMessage, matchingResourceMatchingBucket.errorMessage) &&
        Objects.equals(this.jobDetails, matchingResourceMatchingBucket.jobDetails) &&
        Objects.equals(this.lastAutomatedDiscoveryTime, matchingResourceMatchingBucket.lastAutomatedDiscoveryTime) &&
        Objects.equals(this.objectCount, matchingResourceMatchingBucket.objectCount) &&
        Objects.equals(this.objectCountByEncryptionType, matchingResourceMatchingBucket.objectCountByEncryptionType) &&
        Objects.equals(this.sensitivityScore, matchingResourceMatchingBucket.sensitivityScore) &&
        Objects.equals(this.sizeInBytes, matchingResourceMatchingBucket.sizeInBytes) &&
        Objects.equals(this.sizeInBytesCompressed, matchingResourceMatchingBucket.sizeInBytesCompressed) &&
        Objects.equals(this.unclassifiableObjectCount, matchingResourceMatchingBucket.unclassifiableObjectCount) &&
        Objects.equals(this.unclassifiableObjectSizeInBytes, matchingResourceMatchingBucket.unclassifiableObjectSizeInBytes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatchingResourceMatchingBucket {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchingResourceMatchingBucket
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchingResourceMatchingBucket.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchingResourceMatchingBucket is not found in the empty JSON string", MatchingResourceMatchingBucket.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchingResourceMatchingBucket.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchingResourceMatchingBucket` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchingResourceMatchingBucket.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchingResourceMatchingBucket' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchingResourceMatchingBucket> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchingResourceMatchingBucket.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchingResourceMatchingBucket>() {
           @Override
           public void write(JsonWriter out, MatchingResourceMatchingBucket value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchingResourceMatchingBucket read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchingResourceMatchingBucket given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchingResourceMatchingBucket
   * @throws IOException if the JSON string is invalid with respect to MatchingResourceMatchingBucket
   */
  public static MatchingResourceMatchingBucket fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchingResourceMatchingBucket.class);
  }

  /**
   * Convert an instance of MatchingResourceMatchingBucket to an JSON string
   *
   * @return JSON string
   */
