...
public class Page {
  public static final String SERIALIZED_NAME_LINE_RANGE = "lineRange";
  @SerializedName(SERIALIZED_NAME_LINE_RANGE)
  private PageLineRange lineRange;

  public static final String SERIALIZED_NAME_OFFSET_RANGE = "offsetRange";
  @SerializedName(SERIALIZED_NAME_OFFSET_RANGE)
  private PageLineRange offsetRange;
  ...
  public Page lineRange(PageLineRange lineRange) {
  ...
  public PageLineRange getLineRange() {
    return lineRange;
  }

  public void setLineRange(PageLineRange lineRange) {
    this.lineRange = lineRange;
  }


  public Page offsetRange(PageLineRange offsetRange) {
   ...
   */
  @javax.annotation.Nullable
  public PageLineRange getOffsetRange() {
    return offsetRange;
  }

  public void setOffsetRange(PageLineRange offsetRange) {
    this.offsetRange = offsetRange;
  }
  ...
  public boolean equals(Object o) {
    ...
    Page page = (Page) o;
    return Objects.equals(this.lineRange, page.lineRange) &&
        Objects.equals(this.offsetRange, page.offsetRange) &&
        Objects.equals(this.pageNumber, page.pageNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lineRange, offsetRange, pageNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("    lineRange: ").append(toIndentedString(lineRange)).append("\n");
    sb.append("    offsetRange: ").append(toIndentedString(offsetRange)).append("\n");
  ...
  static {
    ...
    openapiFields.add("lineRange");
    openapiFields.add("offsetRange");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("lineRange") != null && !jsonObj.get("lineRange").isJsonNull()) {
        PageLineRange.validateJsonElement(jsonObj.get("lineRange"));
      }
      // validate the optional field `offsetRange`
      if (jsonObj.get("offsetRange") != null && !jsonObj.get("offsetRange").isJsonNull()) {
        PageLineRange.validateJsonElement(jsonObj.get("offsetRange"));
      }
