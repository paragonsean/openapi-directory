...
/*
 * OAITestCustomDataIdentifier_request.h
 *
 * 
 */

#ifndef OAITestCustomDataIdentifier_request_H
#define OAITestCustomDataIdentifier_request_H
...
class OAITestCustomDataIdentifier_request : public OAIObject {
public:
    OAITestCustomDataIdentifier_request();
    OAITestCustomDataIdentifier_request(QString json);
    ~OAITestCustomDataIdentifier_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestCustomDataIdentifier_request)

#endif // OAITestCustomDataIdentifier_request_H
