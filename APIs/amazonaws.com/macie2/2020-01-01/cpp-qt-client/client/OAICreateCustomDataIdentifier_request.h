...
/*
 * OAICreateCustomDataIdentifier_request.h
 *
 * 
 */

#ifndef OAICreateCustomDataIdentifier_request_H
#define OAICreateCustomDataIdentifier_request_H
...
namespace OpenAPI {
class OAISeverityLevel;

class OAICreateCustomDataIdentifier_request : public OAIObject {
public:
    OAICreateCustomDataIdentifier_request();
    OAICreateCustomDataIdentifier_request(QString json);
    ~OAICreateCustomDataIdentifier_request() override;
    ...
    QList<QString> getIgnoreWords() const;
    void setIgnoreWords(const QList<QString> &ignore_words);
    ...
    QList<OAISeverityLevel> getSeverityLevels() const;
    void setSeverityLevels(const QList<OAISeverityLevel> &severity_levels);
...
private:
    ...
    QList<OAISeverityLevel> m_severity_levels;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomDataIdentifier_request)

#endif // OAICreateCustomDataIdentifier_request_H
