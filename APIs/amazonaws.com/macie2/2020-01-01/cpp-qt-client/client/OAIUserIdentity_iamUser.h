...
/*
 * OAIUserIdentity_iamUser.h
 *
 * 
 */

#ifndef OAIUserIdentity_iamUser_H
#define OAIUserIdentity_iamUser_H
...
class OAIUserIdentity_iamUser : public OAIObject {
public:
    OAIUserIdentity_iamUser();
    OAIUserIdentity_iamUser(QString json);
    ~OAIUserIdentity_iamUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserIdentity_iamUser)

#endif // OAIUserIdentity_iamUser_H
