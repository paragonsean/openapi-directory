...
/*
 * OAIFindingActor_ipAddressDetails.h
 *
 * 
 */

#ifndef OAIFindingActor_ipAddressDetails_H
#define OAIFindingActor_ipAddressDetails_H
...
class OAIFindingActor_ipAddressDetails : public OAIObject {
public:
    OAIFindingActor_ipAddressDetails();
    OAIFindingActor_ipAddressDetails(QString json);
    ~OAIFindingActor_ipAddressDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindingActor_ipAddressDetails)

#endif // OAIFindingActor_ipAddressDetails_H
