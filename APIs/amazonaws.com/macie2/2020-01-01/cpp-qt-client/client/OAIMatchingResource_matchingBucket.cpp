...
OAIMatchingResource_matchingBucket::OAIMatchingResource_matchingBucket(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMatchingResource_matchingBucket::OAIMatchingResource_matchingBucket() {
    this->initializeModel();
}

OAIMatchingResource_matchingBucket::~OAIMatchingResource_matchingBucket() {}

void OAIMatchingResource_matchingBucket::initializeModel() {
...
void OAIMatchingResource_matchingBucket::fromJson(QString jsonString) {
...
void OAIMatchingResource_matchingBucket::fromJsonObject(QJsonObject json) {
...
QString OAIMatchingResource_matchingBucket::asJson() const {
...
QJsonObject OAIMatchingResource_matchingBucket::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMatchingResource_matchingBucket::getAccountId() const {
    return m_account_id;
}
void OAIMatchingResource_matchingBucket::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIMatchingResource_matchingBucket::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIMatchingResource_matchingBucket::getBucketName() const {
    return m_bucket_name;
}
void OAIMatchingResource_matchingBucket::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIMatchingResource_matchingBucket::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getClassifiableObjectCount() const {
    return m_classifiable_object_count;
}
void OAIMatchingResource_matchingBucket::setClassifiableObjectCount(const qint32 &classifiable_object_count) {
    m_classifiable_object_count = classifiable_object_count;
    m_classifiable_object_count_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_classifiable_object_count_Set() const{
    return m_classifiable_object_count_isSet;
}

bool OAIMatchingResource_matchingBucket::is_classifiable_object_count_Valid() const{
    return m_classifiable_object_count_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getClassifiableSizeInBytes() const {
    return m_classifiable_size_in_bytes;
}
void OAIMatchingResource_matchingBucket::setClassifiableSizeInBytes(const qint32 &classifiable_size_in_bytes) {
    m_classifiable_size_in_bytes = classifiable_size_in_bytes;
    m_classifiable_size_in_bytes_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_classifiable_size_in_bytes_Set() const{
    return m_classifiable_size_in_bytes_isSet;
}

bool OAIMatchingResource_matchingBucket::is_classifiable_size_in_bytes_Valid() const{
    return m_classifiable_size_in_bytes_isValid;
}

OAIBucketMetadataErrorCode OAIMatchingResource_matchingBucket::getErrorCode() const {
    return m_error_code;
}
void OAIMatchingResource_matchingBucket::setErrorCode(const OAIBucketMetadataErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIMatchingResource_matchingBucket::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIMatchingResource_matchingBucket::getErrorMessage() const {
    return m_error_message;
}
void OAIMatchingResource_matchingBucket::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIMatchingResource_matchingBucket::is_error_message_Valid() const{
    return m_error_message_isValid;
}

OAIMatchingBucket_jobDetails OAIMatchingResource_matchingBucket::getJobDetails() const {
    return m_job_details;
}
void OAIMatchingResource_matchingBucket::setJobDetails(const OAIMatchingBucket_jobDetails &job_details) {
    m_job_details = job_details;
    m_job_details_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_job_details_Set() const{
    return m_job_details_isSet;
}

bool OAIMatchingResource_matchingBucket::is_job_details_Valid() const{
    return m_job_details_isValid;
}

QDateTime OAIMatchingResource_matchingBucket::getLastAutomatedDiscoveryTime() const {
    return m_last_automated_discovery_time;
}
void OAIMatchingResource_matchingBucket::setLastAutomatedDiscoveryTime(const QDateTime &last_automated_discovery_time) {
    m_last_automated_discovery_time = last_automated_discovery_time;
    m_last_automated_discovery_time_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_last_automated_discovery_time_Set() const{
    return m_last_automated_discovery_time_isSet;
}

bool OAIMatchingResource_matchingBucket::is_last_automated_discovery_time_Valid() const{
    return m_last_automated_discovery_time_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getObjectCount() const {
    return m_object_count;
}
void OAIMatchingResource_matchingBucket::setObjectCount(const qint32 &object_count) {
    m_object_count = object_count;
    m_object_count_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_object_count_Set() const{
    return m_object_count_isSet;
}

bool OAIMatchingResource_matchingBucket::is_object_count_Valid() const{
    return m_object_count_isValid;
}

OAIBucketMetadata_objectCountByEncryptionType OAIMatchingResource_matchingBucket::getObjectCountByEncryptionType() const {
    return m_object_count_by_encryption_type;
}
void OAIMatchingResource_matchingBucket::setObjectCountByEncryptionType(const OAIBucketMetadata_objectCountByEncryptionType &object_count_by_encryption_type) {
    m_object_count_by_encryption_type = object_count_by_encryption_type;
    m_object_count_by_encryption_type_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_object_count_by_encryption_type_Set() const{
    return m_object_count_by_encryption_type_isSet;
}

bool OAIMatchingResource_matchingBucket::is_object_count_by_encryption_type_Valid() const{
    return m_object_count_by_encryption_type_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getSensitivityScore() const {
    return m_sensitivity_score;
}
void OAIMatchingResource_matchingBucket::setSensitivityScore(const qint32 &sensitivity_score) {
    m_sensitivity_score = sensitivity_score;
    m_sensitivity_score_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_sensitivity_score_Set() const{
    return m_sensitivity_score_isSet;
}

bool OAIMatchingResource_matchingBucket::is_sensitivity_score_Valid() const{
    return m_sensitivity_score_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getSizeInBytes() const {
    return m_size_in_bytes;
}
void OAIMatchingResource_matchingBucket::setSizeInBytes(const qint32 &size_in_bytes) {
    m_size_in_bytes = size_in_bytes;
    m_size_in_bytes_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_size_in_bytes_Set() const{
    return m_size_in_bytes_isSet;
}

bool OAIMatchingResource_matchingBucket::is_size_in_bytes_Valid() const{
    return m_size_in_bytes_isValid;
}

qint32 OAIMatchingResource_matchingBucket::getSizeInBytesCompressed() const {
    return m_size_in_bytes_compressed;
}
void OAIMatchingResource_matchingBucket::setSizeInBytesCompressed(const qint32 &size_in_bytes_compressed) {
    m_size_in_bytes_compressed = size_in_bytes_compressed;
    m_size_in_bytes_compressed_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_size_in_bytes_compressed_Set() const{
    return m_size_in_bytes_compressed_isSet;
}

bool OAIMatchingResource_matchingBucket::is_size_in_bytes_compressed_Valid() const{
    return m_size_in_bytes_compressed_isValid;
}

OAIBucketMetadata_unclassifiableObjectCount OAIMatchingResource_matchingBucket::getUnclassifiableObjectCount() const {
    return m_unclassifiable_object_count;
}
void OAIMatchingResource_matchingBucket::setUnclassifiableObjectCount(const OAIBucketMetadata_unclassifiableObjectCount &unclassifiable_object_count) {
    m_unclassifiable_object_count = unclassifiable_object_count;
    m_unclassifiable_object_count_isSet = true;
}

bool OAIMatchingResource_matchingBucket::is_unclassifiable_object_count_Set() const{
    return m_unclassifiable_object_count_isSet;
}

bool OAIMatchingResource_matchingBucket::is_unclassifiable_object_count_Valid() const{
    return m_unclassifiable_object_count_isValid;
}

OAIBucketMetadata_unclassifiableObjectSizeInBytes OAIMatchingResource_matchingBucket::getUnclassifiableObjectSizeInBytes() const {
    return m_unclassifiable_object_size_in_bytes;
}
void OAIMatchingResource_matchingBucket::setUnclassifiableObjectSizeInBytes(const OAIBucketMetadata_unclassifiableObjectSizeInBytes &unclassifiable_object_size_in_bytes) {
...
bool OAIMatchingResource_matchingBucket::is_unclassifiable_object_size_in_bytes_Set() const{
    return m_unclassifiable_object_size_in_bytes_isSet;
}

bool OAIMatchingResource_matchingBucket::is_unclassifiable_object_size_in_bytes_Valid() const{
    return m_unclassifiable_object_size_in_bytes_isValid;
}

bool OAIMatchingResource_matchingBucket::isSet() const {
...
bool OAIMatchingResource_matchingBucket::isValid() const {
