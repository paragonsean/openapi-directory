...
/*
 * OAIClassificationResult.h
 *
 * Provides the details of a sensitive data finding, including the types, number of occurrences, and locations of the sensitive data that was detected.
 */

#ifndef OAIClassificationResult_H
#define OAIClassificationResult_H
...
class OAIClassificationResult : public OAIObject {
public:
    OAIClassificationResult();
    OAIClassificationResult(QString json);
    ~OAIClassificationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClassificationResult)

#endif // OAIClassificationResult_H
