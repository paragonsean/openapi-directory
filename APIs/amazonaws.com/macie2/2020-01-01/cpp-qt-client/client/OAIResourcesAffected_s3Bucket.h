...
/*
 * OAIResourcesAffected_s3Bucket.h
 *
 * 
 */

#ifndef OAIResourcesAffected_s3Bucket_H
#define OAIResourcesAffected_s3Bucket_H
...
class OAIResourcesAffected_s3Bucket : public OAIObject {
public:
    OAIResourcesAffected_s3Bucket();
    OAIResourcesAffected_s3Bucket(QString json);
    ~OAIResourcesAffected_s3Bucket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourcesAffected_s3Bucket)

#endif // OAIResourcesAffected_s3Bucket_H
