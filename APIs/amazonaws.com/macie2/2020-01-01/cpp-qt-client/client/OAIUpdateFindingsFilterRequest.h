...
/*
 * OAIUpdateFindingsFilterRequest.h
 *
 * 
 */

#ifndef OAIUpdateFindingsFilterRequest_H
#define OAIUpdateFindingsFilterRequest_H
...
class OAIUpdateFindingsFilterRequest : public OAIObject {
public:
    OAIUpdateFindingsFilterRequest();
    OAIUpdateFindingsFilterRequest(QString json);
    ~OAIUpdateFindingsFilterRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFindingsFilterRequest)

#endif // OAIUpdateFindingsFilterRequest_H
