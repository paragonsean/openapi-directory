...
#ifndef OAIAssumedRole_H
#define OAIAssumedRole_H
...
class OAIAssumedRole : public OAIObject {
public:
    OAIAssumedRole();
    OAIAssumedRole(QString json);
    ~OAIAssumedRole() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssumedRole)

#endif // OAIAssumedRole_H
