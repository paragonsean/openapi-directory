...
#ifndef OAISessionIssuer_H
#define OAISessionIssuer_H
...
class OAISessionIssuer : public OAIObject {
public:
    OAISessionIssuer();
    OAISessionIssuer(QString json);
    ~OAISessionIssuer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISessionIssuer)

#endif // OAISessionIssuer_H
