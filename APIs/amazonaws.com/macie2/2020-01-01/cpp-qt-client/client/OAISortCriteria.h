...
#ifndef OAISortCriteria_H
#define OAISortCriteria_H
...
class OAISortCriteria : public OAIObject {
public:
    OAISortCriteria();
    OAISortCriteria(QString json);
    ~OAISortCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISortCriteria)

#endif // OAISortCriteria_H
