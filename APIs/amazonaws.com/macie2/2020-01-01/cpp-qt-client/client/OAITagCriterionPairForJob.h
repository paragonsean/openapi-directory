...
#ifndef OAITagCriterionPairForJob_H
#define OAITagCriterionPairForJob_H
...
class OAITagCriterionPairForJob : public OAIObject {
public:
    OAITagCriterionPairForJob();
    OAITagCriterionPairForJob(QString json);
    ~OAITagCriterionPairForJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagCriterionPairForJob)

#endif // OAITagCriterionPairForJob_H
