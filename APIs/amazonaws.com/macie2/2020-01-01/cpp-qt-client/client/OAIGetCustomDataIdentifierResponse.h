...
/*
 * OAIGetCustomDataIdentifierResponse.h
 *
 * 
 */

#ifndef OAIGetCustomDataIdentifierResponse_H
#define OAIGetCustomDataIdentifierResponse_H
...
class OAIGetCustomDataIdentifierResponse : public OAIObject {
public:
    OAIGetCustomDataIdentifierResponse();
    OAIGetCustomDataIdentifierResponse(QString json);
    ~OAIGetCustomDataIdentifierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCustomDataIdentifierResponse)

#endif // OAIGetCustomDataIdentifierResponse_H
