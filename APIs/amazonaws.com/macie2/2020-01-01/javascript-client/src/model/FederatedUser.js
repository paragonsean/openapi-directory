...
/**
 * The FederatedUser model module.
 * @module model/FederatedUser
 * @version 2020-01-01
 */
class FederatedUser {
    /**
     * Constructs a new <code>FederatedUser</code>.
     ...
     * @alias module:model/FederatedUser
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>FederatedUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FederatedUser} obj Optional instance to populate.
     * @return {module:model/FederatedUser} The populated <code>FederatedUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FederatedUser();
    ...
    /**
     * Validates the JSON data with respect to <code>FederatedUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FederatedUser</code>.
     */
