# AmazonMacie2.CreateInvitationsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountIds** | **[String]** | An array that lists Amazon Web Services account IDs, one for each account to send the invitation to. | 
