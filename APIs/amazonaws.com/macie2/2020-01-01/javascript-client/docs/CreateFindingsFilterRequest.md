# AmazonMacie2.CreateFindingsFilterRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**action** | **String** | The action to perform on findings that match the filter criteria. To suppress (automatically archive) findings that match the criteria, set this value to ARCHIVE. Valid values are: | 
...
**findingCriteria** | [**CreateFindingsFilterRequestFindingCriteria**](CreateFindingsFilterRequestFindingCriteria.md) |  | 
