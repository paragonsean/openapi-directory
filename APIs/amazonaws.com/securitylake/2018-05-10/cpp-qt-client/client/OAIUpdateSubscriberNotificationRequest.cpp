...
#include "OAIUpdateSubscriberNotificationRequest.h"
...
OAIUpdateSubscriberNotificationRequest::OAIUpdateSubscriberNotificationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubscriberNotificationRequest::OAIUpdateSubscriberNotificationRequest() {
    this->initializeModel();
}

OAIUpdateSubscriberNotificationRequest::~OAIUpdateSubscriberNotificationRequest() {}

void OAIUpdateSubscriberNotificationRequest::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAIUpdateSubscriberNotificationRequest::fromJson(QString jsonString) {
...
void OAIUpdateSubscriberNotificationRequest::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("configuration")]);
    m_configuration_isSet = !json[QString("configuration")].isNull() && m_configuration_isValid;
}

QString OAIUpdateSubscriberNotificationRequest::asJson() const {
...
QJsonObject OAIUpdateSubscriberNotificationRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateSubscriberNotificationRequest_configuration OAIUpdateSubscriberNotificationRequest::getConfiguration() const {
    return m_configuration;
}
void OAIUpdateSubscriberNotificationRequest::setConfiguration(const OAIUpdateSubscriberNotificationRequest_configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIUpdateSubscriberNotificationRequest::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIUpdateSubscriberNotificationRequest::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIUpdateSubscriberNotificationRequest::isSet() const {
...
bool OAIUpdateSubscriberNotificationRequest::isValid() const {
