...
OAICreateSubscriberResponse::OAICreateSubscriberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSubscriberResponse::OAICreateSubscriberResponse() {
    this->initializeModel();
}

OAICreateSubscriberResponse::~OAICreateSubscriberResponse() {}

void OAICreateSubscriberResponse::initializeModel() {

    m_subscriber_isSet = false;
    m_subscriber_isValid = false;
}

void OAICreateSubscriberResponse::fromJson(QString jsonString) {
...
void OAICreateSubscriberResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateSubscriberResponse::asJson() const {
...
QJsonObject OAICreateSubscriberResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateSubscriberResponse_subscriber OAICreateSubscriberResponse::getSubscriber() const {
    return m_subscriber;
}
void OAICreateSubscriberResponse::setSubscriber(const OAICreateSubscriberResponse_subscriber &subscriber) {
    m_subscriber = subscriber;
    m_subscriber_isSet = true;
}

bool OAICreateSubscriberResponse::is_subscriber_Set() const{
    return m_subscriber_isSet;
}

bool OAICreateSubscriberResponse::is_subscriber_Valid() const{
    return m_subscriber_isValid;
}

bool OAICreateSubscriberResponse::isSet() const {
...
bool OAICreateSubscriberResponse::isValid() const {
