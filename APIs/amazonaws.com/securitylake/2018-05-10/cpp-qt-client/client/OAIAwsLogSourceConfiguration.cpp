...
OAIAwsLogSourceConfiguration::OAIAwsLogSourceConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAwsLogSourceConfiguration::OAIAwsLogSourceConfiguration() {
    this->initializeModel();
}

OAIAwsLogSourceConfiguration::~OAIAwsLogSourceConfiguration() {}

void OAIAwsLogSourceConfiguration::initializeModel() {
...
void OAIAwsLogSourceConfiguration::fromJson(QString jsonString) {
...
void OAIAwsLogSourceConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIAwsLogSourceConfiguration::asJson() const {
...
QJsonObject OAIAwsLogSourceConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIAwsLogSourceConfiguration::getAccounts() const {
    return m_accounts;
}
void OAIAwsLogSourceConfiguration::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIAwsLogSourceConfiguration::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIAwsLogSourceConfiguration::is_accounts_Valid() const{
    return m_accounts_isValid;
}

QList OAIAwsLogSourceConfiguration::getRegions() const {
    return m_regions;
}
void OAIAwsLogSourceConfiguration::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIAwsLogSourceConfiguration::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIAwsLogSourceConfiguration::is_regions_Valid() const{
    return m_regions_isValid;
}

OAIAwsLogSourceName OAIAwsLogSourceConfiguration::getSourceName() const {
    return m_source_name;
}
void OAIAwsLogSourceConfiguration::setSourceName(const OAIAwsLogSourceName &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAIAwsLogSourceConfiguration::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAIAwsLogSourceConfiguration::is_source_name_Valid() const{
    return m_source_name_isValid;
}

QString OAIAwsLogSourceConfiguration::getSourceVersion() const {
    return m_source_version;
}
void OAIAwsLogSourceConfiguration::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAIAwsLogSourceConfiguration::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAIAwsLogSourceConfiguration::is_source_version_Valid() const{
    return m_source_version_isValid;
}

bool OAIAwsLogSourceConfiguration::isSet() const {
...
bool OAIAwsLogSourceConfiguration::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_regions_isValid && m_source_name_isValid && true;
}
