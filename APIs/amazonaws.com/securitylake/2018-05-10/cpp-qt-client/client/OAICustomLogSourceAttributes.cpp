...
#include "OAICustomLogSourceAttributes.h"
...
OAICustomLogSourceAttributes::OAICustomLogSourceAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomLogSourceAttributes::OAICustomLogSourceAttributes() {
    this->initializeModel();
}

OAICustomLogSourceAttributes::~OAICustomLogSourceAttributes() {}

void OAICustomLogSourceAttributes::initializeModel() {
...
void OAICustomLogSourceAttributes::fromJson(QString jsonString) {
...
void OAICustomLogSourceAttributes::fromJsonObject(QJsonObject json) {
...
QString OAICustomLogSourceAttributes::asJson() const {
...
QJsonObject OAICustomLogSourceAttributes::asJsonObject() const {
    QJsonObject obj;
...
QString OAICustomLogSourceAttributes::getCrawlerArn() const {
    return m_crawler_arn;
}
void OAICustomLogSourceAttributes::setCrawlerArn(const QString &crawler_arn) {
    m_crawler_arn = crawler_arn;
    m_crawler_arn_isSet = true;
}

bool OAICustomLogSourceAttributes::is_crawler_arn_Set() const{
    return m_crawler_arn_isSet;
}

bool OAICustomLogSourceAttributes::is_crawler_arn_Valid() const{
    return m_crawler_arn_isValid;
}

QString OAICustomLogSourceAttributes::getDatabaseArn() const {
    return m_database_arn;
}
void OAICustomLogSourceAttributes::setDatabaseArn(const QString &database_arn) {
    m_database_arn = database_arn;
    m_database_arn_isSet = true;
}

bool OAICustomLogSourceAttributes::is_database_arn_Set() const{
    return m_database_arn_isSet;
}

bool OAICustomLogSourceAttributes::is_database_arn_Valid() const{
    return m_database_arn_isValid;
}

QString OAICustomLogSourceAttributes::getTableArn() const {
    return m_table_arn;
}
void OAICustomLogSourceAttributes::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAICustomLogSourceAttributes::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAICustomLogSourceAttributes::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

bool OAICustomLogSourceAttributes::isSet() const {
...
bool OAICustomLogSourceAttributes::isValid() const {
