...
/*
 * OAIGetSubscriberResponse_subscriber.h
 *
 * 
 */

#ifndef OAIGetSubscriberResponse_subscriber_H
#define OAIGetSubscriberResponse_subscriber_H
...
class OAIGetSubscriberResponse_subscriber : public OAIObject {
public:
    OAIGetSubscriberResponse_subscriber();
    OAIGetSubscriberResponse_subscriber(QString json);
    ~OAIGetSubscriberResponse_subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSubscriberResponse_subscriber)

#endif // OAIGetSubscriberResponse_subscriber_H
