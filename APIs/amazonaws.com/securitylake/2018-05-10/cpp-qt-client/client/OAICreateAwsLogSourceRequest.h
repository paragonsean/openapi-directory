...
/*
 * OAICreateAwsLogSourceRequest.h
 *
 * 
 */

#ifndef OAICreateAwsLogSourceRequest_H
#define OAICreateAwsLogSourceRequest_H
...
class OAICreateAwsLogSourceRequest : public OAIObject {
public:
    OAICreateAwsLogSourceRequest();
    OAICreateAwsLogSourceRequest(QString json);
    ~OAICreateAwsLogSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAwsLogSourceRequest)

#endif // OAICreateAwsLogSourceRequest_H
