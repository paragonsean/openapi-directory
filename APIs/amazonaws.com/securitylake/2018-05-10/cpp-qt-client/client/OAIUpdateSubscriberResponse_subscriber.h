...
/*
 * OAIUpdateSubscriberResponse_subscriber.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberResponse_subscriber_H
#define OAIUpdateSubscriberResponse_subscriber_H
...
class OAIUpdateSubscriberResponse_subscriber : public OAIObject {
public:
    OAIUpdateSubscriberResponse_subscriber();
    OAIUpdateSubscriberResponse_subscriber(QString json);
    ~OAIUpdateSubscriberResponse_subscriber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberResponse_subscriber)

#endif // OAIUpdateSubscriberResponse_subscriber_H
