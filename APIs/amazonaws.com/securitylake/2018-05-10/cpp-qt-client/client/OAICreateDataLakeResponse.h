...
/*
 * OAICreateDataLakeResponse.h
 *
 * 
 */

#ifndef OAICreateDataLakeResponse_H
#define OAICreateDataLakeResponse_H
...
class OAICreateDataLakeResponse : public OAIObject {
public:
    OAICreateDataLakeResponse();
    OAICreateDataLakeResponse(QString json);
    ~OAICreateDataLakeResponse() override;
    ...
    QList getDataLakes() const;
    void setDataLakes(const QList &data_lakes);
    bool is_data_lakes_Set() const;
    bool is_data_lakes_Valid() const;
...
private:
    ...
    QList m_data_lakes;
    bool m_data_lakes_isSet;
    bool m_data_lakes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateDataLakeResponse)

#endif // OAICreateDataLakeResponse_H
