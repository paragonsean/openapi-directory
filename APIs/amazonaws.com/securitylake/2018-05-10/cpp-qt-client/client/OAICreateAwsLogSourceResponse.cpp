...
OAICreateAwsLogSourceResponse::OAICreateAwsLogSourceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAwsLogSourceResponse::OAICreateAwsLogSourceResponse() {
    this->initializeModel();
}

OAICreateAwsLogSourceResponse::~OAICreateAwsLogSourceResponse() {}

void OAICreateAwsLogSourceResponse::initializeModel() {

    m_failed_isSet = false;
    m_failed_isValid = false;
}

void OAICreateAwsLogSourceResponse::fromJson(QString jsonString) {
...
void OAICreateAwsLogSourceResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateAwsLogSourceResponse::asJson() const {
...
QJsonObject OAICreateAwsLogSourceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_failed.isSet()) {
...
QList OAICreateAwsLogSourceResponse::getFailed() const {
    return m_failed;
}
void OAICreateAwsLogSourceResponse::setFailed(const QList &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAICreateAwsLogSourceResponse::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAICreateAwsLogSourceResponse::is_failed_Valid() const{
    return m_failed_isValid;
}

bool OAICreateAwsLogSourceResponse::isSet() const {
...
bool OAICreateAwsLogSourceResponse::isValid() const {
