...
OAIGetSubscriberResponse::OAIGetSubscriberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSubscriberResponse::OAIGetSubscriberResponse() {
    this->initializeModel();
}

OAIGetSubscriberResponse::~OAIGetSubscriberResponse() {}

void OAIGetSubscriberResponse::initializeModel() {

    m_subscriber_isSet = false;
    m_subscriber_isValid = false;
}

void OAIGetSubscriberResponse::fromJson(QString jsonString) {
...
void OAIGetSubscriberResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetSubscriberResponse::asJson() const {
...
QJsonObject OAIGetSubscriberResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetSubscriberResponse_subscriber OAIGetSubscriberResponse::getSubscriber() const {
    return m_subscriber;
}
void OAIGetSubscriberResponse::setSubscriber(const OAIGetSubscriberResponse_subscriber &subscriber) {
    m_subscriber = subscriber;
    m_subscriber_isSet = true;
}

bool OAIGetSubscriberResponse::is_subscriber_Set() const{
    return m_subscriber_isSet;
}

bool OAIGetSubscriberResponse::is_subscriber_Valid() const{
    return m_subscriber_isValid;
}

bool OAIGetSubscriberResponse::isSet() const {
...
bool OAIGetSubscriberResponse::isValid() const {
