...
/*
 * OAIUpdateDataLakeResponse.h
 *
 * 
 */

#ifndef OAIUpdateDataLakeResponse_H
#define OAIUpdateDataLakeResponse_H
...
class OAIUpdateDataLakeResponse : public OAIObject {
public:
    OAIUpdateDataLakeResponse();
    OAIUpdateDataLakeResponse(QString json);
    ~OAIUpdateDataLakeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDataLakeResponse)

#endif // OAIUpdateDataLakeResponse_H
