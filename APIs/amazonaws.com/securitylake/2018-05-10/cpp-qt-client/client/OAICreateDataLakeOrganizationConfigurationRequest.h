...
/*
 * OAICreateDataLakeOrganizationConfigurationRequest.h
 *
 * 
 */

#ifndef OAICreateDataLakeOrganizationConfigurationRequest_H
#define OAICreateDataLakeOrganizationConfigurationRequest_H
...
class OAICreateDataLakeOrganizationConfigurationRequest : public OAIObject {
public:
    OAICreateDataLakeOrganizationConfigurationRequest();
    OAICreateDataLakeOrganizationConfigurationRequest(QString json);
    ~OAICreateDataLakeOrganizationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataLakeOrganizationConfigurationRequest)

#endif // OAICreateDataLakeOrganizationConfigurationRequest_H
