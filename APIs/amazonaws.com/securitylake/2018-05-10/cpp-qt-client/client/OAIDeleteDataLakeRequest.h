...
/*
 * OAIDeleteDataLakeRequest.h
 *
 * 
 */

#ifndef OAIDeleteDataLakeRequest_H
#define OAIDeleteDataLakeRequest_H
...
class OAIDeleteDataLakeRequest : public OAIObject {
public:
    OAIDeleteDataLakeRequest();
    OAIDeleteDataLakeRequest(QString json);
    ~OAIDeleteDataLakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDataLakeRequest)

#endif // OAIDeleteDataLakeRequest_H
