...
/*
 * OAICreateSubscriberNotificationResponse.h
 *
 * 
 */

#ifndef OAICreateSubscriberNotificationResponse_H
#define OAICreateSubscriberNotificationResponse_H
...
class OAICreateSubscriberNotificationResponse : public OAIObject {
public:
    OAICreateSubscriberNotificationResponse();
    OAICreateSubscriberNotificationResponse(QString json);
    ~OAICreateSubscriberNotificationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberNotificationResponse)

#endif // OAICreateSubscriberNotificationResponse_H
