...
OAICreateDataLakeResponse::OAICreateDataLakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDataLakeResponse::OAICreateDataLakeResponse() {
    this->initializeModel();
}

OAICreateDataLakeResponse::~OAICreateDataLakeResponse() {}

void OAICreateDataLakeResponse::initializeModel() {

    m_data_lakes_isSet = false;
    m_data_lakes_isValid = false;
}

void OAICreateDataLakeResponse::fromJson(QString jsonString) {
...
void OAICreateDataLakeResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateDataLakeResponse::asJson() const {
...
QJsonObject OAICreateDataLakeResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateDataLakeResponse::getDataLakes() const {
    return m_data_lakes;
}
void OAICreateDataLakeResponse::setDataLakes(const QList &data_lakes) {
    m_data_lakes = data_lakes;
    m_data_lakes_isSet = true;
}

bool OAICreateDataLakeResponse::is_data_lakes_Set() const{
    return m_data_lakes_isSet;
}

bool OAICreateDataLakeResponse::is_data_lakes_Valid() const{
    return m_data_lakes_isValid;
}

bool OAICreateDataLakeResponse::isSet() const {
...
bool OAICreateDataLakeResponse::isValid() const {
