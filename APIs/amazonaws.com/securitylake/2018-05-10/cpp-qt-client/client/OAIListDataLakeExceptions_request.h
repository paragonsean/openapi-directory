...
/*
 * OAIListDataLakeExceptions_request.h
 *
 * 
 */

#ifndef OAIListDataLakeExceptions_request_H
#define OAIListDataLakeExceptions_request_H
...
class OAIListDataLakeExceptions_request : public OAIObject {
public:
    OAIListDataLakeExceptions_request();
    OAIListDataLakeExceptions_request(QString json);
    ~OAIListDataLakeExceptions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataLakeExceptions_request)

#endif // OAIListDataLakeExceptions_request_H
