...
#include "OAIDataLakeLifecycleTransition.h"
...
OAIDataLakeLifecycleTransition::OAIDataLakeLifecycleTransition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeLifecycleTransition::OAIDataLakeLifecycleTransition() {
    this->initializeModel();
}

OAIDataLakeLifecycleTransition::~OAIDataLakeLifecycleTransition() {}

void OAIDataLakeLifecycleTransition::initializeModel() {
...
void OAIDataLakeLifecycleTransition::fromJson(QString jsonString) {
...
void OAIDataLakeLifecycleTransition::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeLifecycleTransition::asJson() const {
...
QJsonObject OAIDataLakeLifecycleTransition::asJsonObject() const {
    QJsonObject obj;
    if (m_days_isSet) {
...
qint32 OAIDataLakeLifecycleTransition::getDays() const {
    return m_days;
}
void OAIDataLakeLifecycleTransition::setDays(const qint32 &days) {
    m_days = days;
    m_days_isSet = true;
}

bool OAIDataLakeLifecycleTransition::is_days_Set() const{
    return m_days_isSet;
}

bool OAIDataLakeLifecycleTransition::is_days_Valid() const{
    return m_days_isValid;
}

QString OAIDataLakeLifecycleTransition::getStorageClass() const {
    return m_storage_class;
}
void OAIDataLakeLifecycleTransition::setStorageClass(const QString &storage_class) {
    m_storage_class = storage_class;
    m_storage_class_isSet = true;
}

bool OAIDataLakeLifecycleTransition::is_storage_class_Set() const{
    return m_storage_class_isSet;
}

bool OAIDataLakeLifecycleTransition::is_storage_class_Valid() const{
    return m_storage_class_isValid;
}

bool OAIDataLakeLifecycleTransition::isSet() const {
...
bool OAIDataLakeLifecycleTransition::isValid() const {
