...
#ifndef OAISubscriberResource_H
#define OAISubscriberResource_H
...
class OAISubscriberResource : public OAIObject {
public:
    OAISubscriberResource();
    OAISubscriberResource(QString json);
    ~OAISubscriberResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriberResource)

#endif // OAISubscriberResource_H
