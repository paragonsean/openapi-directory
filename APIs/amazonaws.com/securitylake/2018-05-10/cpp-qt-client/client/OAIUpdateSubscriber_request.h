...
/*
 * OAIUpdateSubscriber_request.h
 *
 * 
 */

#ifndef OAIUpdateSubscriber_request_H
#define OAIUpdateSubscriber_request_H
...
class OAIUpdateSubscriber_request : public OAIObject {
public:
    OAIUpdateSubscriber_request();
    OAIUpdateSubscriber_request(QString json);
    ~OAIUpdateSubscriber_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriber_request)

#endif // OAIUpdateSubscriber_request_H
