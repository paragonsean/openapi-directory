...
class OAIAwsLogSourceResource : public OAIObject {
public:
    OAIAwsLogSourceResource();
    OAIAwsLogSourceResource(QString json);
    ~OAIAwsLogSourceResource() override;
    ...
    OAIAwsLogSourceName getSourceName() const;
    void setSourceName(const OAIAwsLogSourceName &source_name);
...
private:
    ...
    OAIAwsLogSourceName m_source_name;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAwsLogSourceResource)

#endif // OAIAwsLogSourceResource_H
