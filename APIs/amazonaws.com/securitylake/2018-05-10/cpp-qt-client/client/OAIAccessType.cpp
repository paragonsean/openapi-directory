...
void OAIAccessType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("LAKEFORMATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccessType::LAKEFORMATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("S3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccessType::S3;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAccessType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAccessType::LAKEFORMATION:
            val = "LAKEFORMATION";
            break;
        case eOAIAccessType::S3:
            val = "S3";
            break;
        default:
            break;
