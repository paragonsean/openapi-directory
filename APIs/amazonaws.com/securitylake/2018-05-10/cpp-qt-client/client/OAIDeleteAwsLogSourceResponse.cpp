...
OAIDeleteAwsLogSourceResponse::OAIDeleteAwsLogSourceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAwsLogSourceResponse::OAIDeleteAwsLogSourceResponse() {
    this->initializeModel();
}

OAIDeleteAwsLogSourceResponse::~OAIDeleteAwsLogSourceResponse() {}

void OAIDeleteAwsLogSourceResponse::initializeModel() {

    m_failed_isSet = false;
    m_failed_isValid = false;
}

void OAIDeleteAwsLogSourceResponse::fromJson(QString jsonString) {
...
void OAIDeleteAwsLogSourceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAwsLogSourceResponse::asJson() const {
...
QJsonObject OAIDeleteAwsLogSourceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_failed.isSet()) {
...
QList OAIDeleteAwsLogSourceResponse::getFailed() const {
    return m_failed;
}
void OAIDeleteAwsLogSourceResponse::setFailed(const QList &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAIDeleteAwsLogSourceResponse::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAIDeleteAwsLogSourceResponse::is_failed_Valid() const{
    return m_failed_isValid;
}

bool OAIDeleteAwsLogSourceResponse::isSet() const {
...
bool OAIDeleteAwsLogSourceResponse::isValid() const {
