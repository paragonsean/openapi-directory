...
/*
 * OAIDeleteAwsLogSourceRequest.h
 *
 * 
 */

#ifndef OAIDeleteAwsLogSourceRequest_H
#define OAIDeleteAwsLogSourceRequest_H
...
class OAIDeleteAwsLogSourceRequest : public OAIObject {
public:
    OAIDeleteAwsLogSourceRequest();
    OAIDeleteAwsLogSourceRequest(QString json);
    ~OAIDeleteAwsLogSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAwsLogSourceRequest)

#endif // OAIDeleteAwsLogSourceRequest_H
