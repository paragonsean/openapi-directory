...
#include "OAIDataLakeUpdateStatus.h"
...
OAIDataLakeUpdateStatus::OAIDataLakeUpdateStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeUpdateStatus::OAIDataLakeUpdateStatus() {
    this->initializeModel();
}

OAIDataLakeUpdateStatus::~OAIDataLakeUpdateStatus() {}

void OAIDataLakeUpdateStatus::initializeModel() {
...
void OAIDataLakeUpdateStatus::fromJson(QString jsonString) {
...
void OAIDataLakeUpdateStatus::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeUpdateStatus::asJson() const {
...
QJsonObject OAIDataLakeUpdateStatus::asJsonObject() const {
    QJsonObject obj;
...
OAIDataLakeUpdateStatus_exception OAIDataLakeUpdateStatus::getException() const {
    return m_exception;
}
void OAIDataLakeUpdateStatus::setException(const OAIDataLakeUpdateStatus_exception &exception) {
    m_exception = exception;
    m_exception_isSet = true;
}

bool OAIDataLakeUpdateStatus::is_exception_Set() const{
    return m_exception_isSet;
}

bool OAIDataLakeUpdateStatus::is_exception_Valid() const{
    return m_exception_isValid;
}

QString OAIDataLakeUpdateStatus::getRequestId() const {
    return m_request_id;
}
void OAIDataLakeUpdateStatus::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIDataLakeUpdateStatus::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIDataLakeUpdateStatus::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIDataLakeStatus OAIDataLakeUpdateStatus::getStatus() const {
    return m_status;
}
void OAIDataLakeUpdateStatus::setStatus(const OAIDataLakeStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDataLakeUpdateStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDataLakeUpdateStatus::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDataLakeUpdateStatus::isSet() const {
...
bool OAIDataLakeUpdateStatus::isValid() const {
