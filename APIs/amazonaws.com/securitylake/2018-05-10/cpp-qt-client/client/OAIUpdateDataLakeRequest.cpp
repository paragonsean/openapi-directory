...
#include "OAIUpdateDataLakeRequest.h"
...
OAIUpdateDataLakeRequest::OAIUpdateDataLakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDataLakeRequest::OAIUpdateDataLakeRequest() {
    this->initializeModel();
}

OAIUpdateDataLakeRequest::~OAIUpdateDataLakeRequest() {}

void OAIUpdateDataLakeRequest::initializeModel() {

    m_configurations_isSet = false;
    m_configurations_isValid = false;
}

void OAIUpdateDataLakeRequest::fromJson(QString jsonString) {
...
void OAIUpdateDataLakeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDataLakeRequest::asJson() const {
...
QJsonObject OAIUpdateDataLakeRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateDataLakeRequest::getConfigurations() const {
    return m_configurations;
}
void OAIUpdateDataLakeRequest::setConfigurations(const QList &configurations) {
    m_configurations = configurations;
    m_configurations_isSet = true;
}

bool OAIUpdateDataLakeRequest::is_configurations_Set() const{
    return m_configurations_isSet;
}

bool OAIUpdateDataLakeRequest::is_configurations_Valid() const{
    return m_configurations_isValid;
}

bool OAIUpdateDataLakeRequest::isSet() const {
...
bool OAIUpdateDataLakeRequest::isValid() const {
