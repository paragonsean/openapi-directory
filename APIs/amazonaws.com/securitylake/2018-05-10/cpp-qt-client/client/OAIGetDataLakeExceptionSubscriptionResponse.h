...
/*
 * OAIGetDataLakeExceptionSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIGetDataLakeExceptionSubscriptionResponse_H
#define OAIGetDataLakeExceptionSubscriptionResponse_H
...
class OAIGetDataLakeExceptionSubscriptionResponse : public OAIObject {
public:
    OAIGetDataLakeExceptionSubscriptionResponse();
    OAIGetDataLakeExceptionSubscriptionResponse(QString json);
    ~OAIGetDataLakeExceptionSubscriptionResponse() override;
    ...
    qint32 getExceptionTimeToLive() const;
    void setExceptionTimeToLive(const qint32 &exception_time_to_live);
    bool is_exception_time_to_live_Set() const;
    bool is_exception_time_to_live_Valid() const;

    QString getNotificationEndpoint() const;
    void setNotificationEndpoint(const QString &notification_endpoint);
    bool is_notification_endpoint_Set() const;
    bool is_notification_endpoint_Valid() const;

    QString getSubscriptionProtocol() const;
    void setSubscriptionProtocol(const QString &subscription_protocol);
    bool is_subscription_protocol_Set() const;
    bool is_subscription_protocol_Valid() const;
...
private:
    ...
    qint32 m_exception_time_to_live;
    bool m_exception_time_to_live_isSet;
    bool m_exception_time_to_live_isValid;

    QString m_notification_endpoint;
    bool m_notification_endpoint_isSet;
    bool m_notification_endpoint_isValid;

    QString m_subscription_protocol;
    bool m_subscription_protocol_isSet;
    bool m_subscription_protocol_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDataLakeExceptionSubscriptionResponse)

#endif // OAIGetDataLakeExceptionSubscriptionResponse_H
