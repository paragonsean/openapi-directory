...
/*
 * OAIListDataLakeExceptionsResponse.h
 *
 * 
 */

#ifndef OAIListDataLakeExceptionsResponse_H
#define OAIListDataLakeExceptionsResponse_H
...
class OAIListDataLakeExceptionsResponse : public OAIObject {
public:
    OAIListDataLakeExceptionsResponse();
    OAIListDataLakeExceptionsResponse(QString json);
    ~OAIListDataLakeExceptionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataLakeExceptionsResponse)

#endif // OAIListDataLakeExceptionsResponse_H
