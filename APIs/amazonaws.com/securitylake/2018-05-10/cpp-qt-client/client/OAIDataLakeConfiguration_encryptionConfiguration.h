...
/*
 * OAIDataLakeConfiguration_encryptionConfiguration.h
 *
 * 
 */

#ifndef OAIDataLakeConfiguration_encryptionConfiguration_H
#define OAIDataLakeConfiguration_encryptionConfiguration_H
...
class OAIDataLakeConfiguration_encryptionConfiguration : public OAIObject {
public:
    OAIDataLakeConfiguration_encryptionConfiguration();
    OAIDataLakeConfiguration_encryptionConfiguration(QString json);
    ~OAIDataLakeConfiguration_encryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeConfiguration_encryptionConfiguration)

#endif // OAIDataLakeConfiguration_encryptionConfiguration_H
