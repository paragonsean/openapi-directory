...
#include "OAICreateSubscriberNotificationRequest.h"
...
OAICreateSubscriberNotificationRequest::OAICreateSubscriberNotificationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSubscriberNotificationRequest::OAICreateSubscriberNotificationRequest() {
    this->initializeModel();
}

OAICreateSubscriberNotificationRequest::~OAICreateSubscriberNotificationRequest() {}

void OAICreateSubscriberNotificationRequest::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAICreateSubscriberNotificationRequest::fromJson(QString jsonString) {
...
void OAICreateSubscriberNotificationRequest::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("configuration")]);
    m_configuration_isSet = !json[QString("configuration")].isNull() && m_configuration_isValid;
}

QString OAICreateSubscriberNotificationRequest::asJson() const {
...
QJsonObject OAICreateSubscriberNotificationRequest::asJsonObject() const {
    QJsonObject obj;
...
OAICreateSubscriberNotificationRequest_configuration OAICreateSubscriberNotificationRequest::getConfiguration() const {
    return m_configuration;
}
void OAICreateSubscriberNotificationRequest::setConfiguration(const OAICreateSubscriberNotificationRequest_configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAICreateSubscriberNotificationRequest::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAICreateSubscriberNotificationRequest::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAICreateSubscriberNotificationRequest::isSet() const {
...
bool OAICreateSubscriberNotificationRequest::isValid() const {
