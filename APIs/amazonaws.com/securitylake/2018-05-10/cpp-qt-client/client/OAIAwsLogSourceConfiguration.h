...
class OAIAwsLogSourceConfiguration : public OAIObject {
public:
    OAIAwsLogSourceConfiguration();
    OAIAwsLogSourceConfiguration(QString json);
    ~OAIAwsLogSourceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAwsLogSourceConfiguration)

#endif // OAIAwsLogSourceConfiguration_H
