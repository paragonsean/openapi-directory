...
OAIUpdateSubscriberResponse::OAIUpdateSubscriberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubscriberResponse::OAIUpdateSubscriberResponse() {
    this->initializeModel();
}

OAIUpdateSubscriberResponse::~OAIUpdateSubscriberResponse() {}

void OAIUpdateSubscriberResponse::initializeModel() {

    m_subscriber_isSet = false;
    m_subscriber_isValid = false;
}

void OAIUpdateSubscriberResponse::fromJson(QString jsonString) {
...
void OAIUpdateSubscriberResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSubscriberResponse::asJson() const {
...
QJsonObject OAIUpdateSubscriberResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateSubscriberResponse_subscriber OAIUpdateSubscriberResponse::getSubscriber() const {
    return m_subscriber;
}
void OAIUpdateSubscriberResponse::setSubscriber(const OAIUpdateSubscriberResponse_subscriber &subscriber) {
    m_subscriber = subscriber;
    m_subscriber_isSet = true;
}

bool OAIUpdateSubscriberResponse::is_subscriber_Set() const{
    return m_subscriber_isSet;
}

bool OAIUpdateSubscriberResponse::is_subscriber_Valid() const{
    return m_subscriber_isValid;
}

bool OAIUpdateSubscriberResponse::isSet() const {
...
bool OAIUpdateSubscriberResponse::isValid() const {
