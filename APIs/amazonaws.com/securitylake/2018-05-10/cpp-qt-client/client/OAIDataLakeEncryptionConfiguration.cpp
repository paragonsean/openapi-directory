...
#include "OAIDataLakeEncryptionConfiguration.h"
...
OAIDataLakeEncryptionConfiguration::OAIDataLakeEncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeEncryptionConfiguration::OAIDataLakeEncryptionConfiguration() {
    this->initializeModel();
}

OAIDataLakeEncryptionConfiguration::~OAIDataLakeEncryptionConfiguration() {}

void OAIDataLakeEncryptionConfiguration::initializeModel() {

    m_kms_key_id_isSet = false;
    m_kms_key_id_isValid = false;
}

void OAIDataLakeEncryptionConfiguration::fromJson(QString jsonString) {
...
void OAIDataLakeEncryptionConfiguration::fromJsonObject(QJsonObject json) {

    m_kms_key_id_isValid = ::OpenAPI::fromJsonValue(m_kms_key_id, json[QString("kmsKeyId")]);
    m_kms_key_id_isSet = !json[QString("kmsKeyId")].isNull() && m_kms_key_id_isValid;
}

QString OAIDataLakeEncryptionConfiguration::asJson() const {
...
QJsonObject OAIDataLakeEncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDataLakeEncryptionConfiguration::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIDataLakeEncryptionConfiguration::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIDataLakeEncryptionConfiguration::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIDataLakeEncryptionConfiguration::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIDataLakeEncryptionConfiguration::isSet() const {
...
bool OAIDataLakeEncryptionConfiguration::isValid() const {
