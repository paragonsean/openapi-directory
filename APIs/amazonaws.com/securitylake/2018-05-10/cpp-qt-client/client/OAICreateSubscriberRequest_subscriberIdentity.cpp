...
OAICreateSubscriberRequest_subscriberIdentity::OAICreateSubscriberRequest_subscriberIdentity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSubscriberRequest_subscriberIdentity::OAICreateSubscriberRequest_subscriberIdentity() {
    this->initializeModel();
}

OAICreateSubscriberRequest_subscriberIdentity::~OAICreateSubscriberRequest_subscriberIdentity() {}

void OAICreateSubscriberRequest_subscriberIdentity::initializeModel() {
...
void OAICreateSubscriberRequest_subscriberIdentity::fromJson(QString jsonString) {
...
void OAICreateSubscriberRequest_subscriberIdentity::fromJsonObject(QJsonObject json) {
...
QString OAICreateSubscriberRequest_subscriberIdentity::asJson() const {
...
QJsonObject OAICreateSubscriberRequest_subscriberIdentity::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSubscriberRequest_subscriberIdentity::getExternalId() const {
    return m_external_id;
}
void OAICreateSubscriberRequest_subscriberIdentity::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAICreateSubscriberRequest_subscriberIdentity::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAICreateSubscriberRequest_subscriberIdentity::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAICreateSubscriberRequest_subscriberIdentity::getPrincipal() const {
    return m_principal;
}
void OAICreateSubscriberRequest_subscriberIdentity::setPrincipal(const QString &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAICreateSubscriberRequest_subscriberIdentity::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAICreateSubscriberRequest_subscriberIdentity::is_principal_Valid() const{
    return m_principal_isValid;
}

bool OAICreateSubscriberRequest_subscriberIdentity::isSet() const {
...
bool OAICreateSubscriberRequest_subscriberIdentity::isValid() const {
