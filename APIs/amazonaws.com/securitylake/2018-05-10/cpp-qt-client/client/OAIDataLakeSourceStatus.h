...
/*
 * OAIDataLakeSourceStatus.h
 *
 * Retrieves the Logs status for the Amazon Security Lake account.
 */

#ifndef OAIDataLakeSourceStatus_H
#define OAIDataLakeSourceStatus_H

#include <QJsonObject>

#include "OAISourceCollectionStatus.h"
#include <QString>
...
class OAIDataLakeSourceStatus : public OAIObject {
public:
    OAIDataLakeSourceStatus();
    OAIDataLakeSourceStatus(QString json);
    ~OAIDataLakeSourceStatus() override;
    ...
    OAISourceCollectionStatus getStatus() const;
    void setStatus(const OAISourceCollectionStatus &status);
...
private:
    ...
    OAISourceCollectionStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeSourceStatus)

#endif // OAIDataLakeSourceStatus_H
