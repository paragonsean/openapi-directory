...
/*
 * OAIDataLakeAutoEnableNewAccountConfiguration.h
 *
 * Automatically enable new organization accounts as member accounts from an Amazon Security Lake administrator account.
 */

#ifndef OAIDataLakeAutoEnableNewAccountConfiguration_H
#define OAIDataLakeAutoEnableNewAccountConfiguration_H
...
class OAIDataLakeAutoEnableNewAccountConfiguration : public OAIObject {
public:
    OAIDataLakeAutoEnableNewAccountConfiguration();
    OAIDataLakeAutoEnableNewAccountConfiguration(QString json);
    ~OAIDataLakeAutoEnableNewAccountConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeAutoEnableNewAccountConfiguration)

#endif // OAIDataLakeAutoEnableNewAccountConfiguration_H
