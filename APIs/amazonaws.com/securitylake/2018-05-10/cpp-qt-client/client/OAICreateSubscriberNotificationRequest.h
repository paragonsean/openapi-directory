...
/*
 * OAICreateSubscriberNotificationRequest.h
 *
 * 
 */

#ifndef OAICreateSubscriberNotificationRequest_H
#define OAICreateSubscriberNotificationRequest_H

#include <QJsonObject>

#include "OAICreateSubscriberNotificationRequest_configuration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateSubscriberNotificationRequest_configuration;

class OAICreateSubscriberNotificationRequest : public OAIObject {
public:
    OAICreateSubscriberNotificationRequest();
    OAICreateSubscriberNotificationRequest(QString json);
    ~OAICreateSubscriberNotificationRequest() override;
    ...
    OAICreateSubscriberNotificationRequest_configuration getConfiguration() const;
    void setConfiguration(const OAICreateSubscriberNotificationRequest_configuration &configuration);
...
private:
    ...
    OAICreateSubscriberNotificationRequest_configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberNotificationRequest)

#endif // OAICreateSubscriberNotificationRequest_H
