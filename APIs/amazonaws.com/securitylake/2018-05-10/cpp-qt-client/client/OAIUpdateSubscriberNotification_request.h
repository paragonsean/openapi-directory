...
/*
 * OAIUpdateSubscriberNotification_request.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberNotification_request_H
#define OAIUpdateSubscriberNotification_request_H
...
namespace OpenAPI {
class OAIUpdateSubscriberNotification_request_configuration;

class OAIUpdateSubscriberNotification_request : public OAIObject {
public:
    OAIUpdateSubscriberNotification_request();
    OAIUpdateSubscriberNotification_request(QString json);
    ~OAIUpdateSubscriberNotification_request() override;
    ...
    OAIUpdateSubscriberNotification_request_configuration getConfiguration() const;
    void setConfiguration(const OAIUpdateSubscriberNotification_request_configuration &configuration);
...
private:
    ...
    OAIUpdateSubscriberNotification_request_configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberNotification_request)

#endif // OAIUpdateSubscriberNotification_request_H
