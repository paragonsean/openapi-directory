...
/*
 * OAICreateDataLakeRequest.h
 *
 * 
 */

#ifndef OAICreateDataLakeRequest_H
#define OAICreateDataLakeRequest_H
...
class OAICreateDataLakeRequest : public OAIObject {
public:
    OAICreateDataLakeRequest();
    OAICreateDataLakeRequest(QString json);
    ~OAICreateDataLakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataLakeRequest)

#endif // OAICreateDataLakeRequest_H
