...
/*
 * OAIListLogSources_request.h
 *
 * 
 */

#ifndef OAIListLogSources_request_H
#define OAIListLogSources_request_H
...
class OAIListLogSources_request : public OAIObject {
public:
    OAIListLogSources_request();
    OAIListLogSources_request(QString json);
    ~OAIListLogSources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLogSources_request)

#endif // OAIListLogSources_request_H
