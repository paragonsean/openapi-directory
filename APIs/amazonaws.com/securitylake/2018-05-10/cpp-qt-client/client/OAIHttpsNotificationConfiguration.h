...
/*
 * OAIHttpsNotificationConfiguration.h
 *
 * The configurations for HTTPS subscriber notification.
 */

#ifndef OAIHttpsNotificationConfiguration_H
#define OAIHttpsNotificationConfiguration_H
...
class OAIHttpsNotificationConfiguration : public OAIObject {
public:
    OAIHttpsNotificationConfiguration();
    OAIHttpsNotificationConfiguration(QString json);
    ~OAIHttpsNotificationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpsNotificationConfiguration)

#endif // OAIHttpsNotificationConfiguration_H
