...
/*
 * OAICreateCustomLogSource_request.h
 *
 * 
 */

#ifndef OAICreateCustomLogSource_request_H
#define OAICreateCustomLogSource_request_H
...
namespace OpenAPI {
class OAICreateCustomLogSource_request_configuration;

class OAICreateCustomLogSource_request : public OAIObject {
public:
    OAICreateCustomLogSource_request();
    OAICreateCustomLogSource_request(QString json);
    ~OAICreateCustomLogSource_request() override;
    ...
    OAICreateCustomLogSource_request_configuration getConfiguration() const;
    void setConfiguration(const OAICreateCustomLogSource_request_configuration &configuration);
    bool is_configuration_Set() const;
    bool is_configuration_Valid() const;

    QList<QString> getEventClasses() const;
    void setEventClasses(const QList<QString> &event_classes);
...
private:
    ...
    OAICreateCustomLogSource_request_configuration m_configuration;
    bool m_configuration_isSet;
    bool m_configuration_isValid;

    QList<QString> m_event_classes;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomLogSource_request)

#endif // OAICreateCustomLogSource_request_H
