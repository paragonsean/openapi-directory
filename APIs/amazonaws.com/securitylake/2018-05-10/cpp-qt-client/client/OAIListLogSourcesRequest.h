...
/*
 * OAIListLogSourcesRequest.h
 *
 * 
 */

#ifndef OAIListLogSourcesRequest_H
#define OAIListLogSourcesRequest_H
...
class OAIListLogSourcesRequest : public OAIObject {
public:
    OAIListLogSourcesRequest();
    OAIListLogSourcesRequest(QString json);
    ~OAIListLogSourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLogSourcesRequest)

#endif // OAIListLogSourcesRequest_H
