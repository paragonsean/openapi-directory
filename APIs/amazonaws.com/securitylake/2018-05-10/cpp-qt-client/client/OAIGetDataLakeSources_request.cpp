...
OAIGetDataLakeSources_request::OAIGetDataLakeSources_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataLakeSources_request::OAIGetDataLakeSources_request() {
    this->initializeModel();
}

OAIGetDataLakeSources_request::~OAIGetDataLakeSources_request() {}

void OAIGetDataLakeSources_request::initializeModel() {
...
void OAIGetDataLakeSources_request::fromJson(QString jsonString) {
...
void OAIGetDataLakeSources_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetDataLakeSources_request::asJson() const {
...
QJsonObject OAIGetDataLakeSources_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIGetDataLakeSources_request::getAccounts() const {
    return m_accounts;
}
void OAIGetDataLakeSources_request::setAccounts(const QList<QString> &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIGetDataLakeSources_request::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIGetDataLakeSources_request::is_accounts_Valid() const{
    return m_accounts_isValid;
}

qint32 OAIGetDataLakeSources_request::getMaxResults() const {
    return m_max_results;
}
void OAIGetDataLakeSources_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetDataLakeSources_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetDataLakeSources_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetDataLakeSources_request::getNextToken() const {
    return m_next_token;
}
void OAIGetDataLakeSources_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetDataLakeSources_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetDataLakeSources_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetDataLakeSources_request::isSet() const {
...
bool OAIGetDataLakeSources_request::isValid() const {
