...
#ifndef OAIAwsIdentity_H
#define OAIAwsIdentity_H
...
class OAIAwsIdentity : public OAIObject {
public:
    OAIAwsIdentity();
    OAIAwsIdentity(QString json);
    ~OAIAwsIdentity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAwsIdentity)

#endif // OAIAwsIdentity_H
