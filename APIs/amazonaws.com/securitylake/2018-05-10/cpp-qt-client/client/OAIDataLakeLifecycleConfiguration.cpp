...
#include "OAIDataLakeLifecycleConfiguration.h"
...
OAIDataLakeLifecycleConfiguration::OAIDataLakeLifecycleConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeLifecycleConfiguration::OAIDataLakeLifecycleConfiguration() {
    this->initializeModel();
}

OAIDataLakeLifecycleConfiguration::~OAIDataLakeLifecycleConfiguration() {}

void OAIDataLakeLifecycleConfiguration::initializeModel() {
...
void OAIDataLakeLifecycleConfiguration::fromJson(QString jsonString) {
...
void OAIDataLakeLifecycleConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeLifecycleConfiguration::asJson() const {
...
QJsonObject OAIDataLakeLifecycleConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIDataLakeLifecycleConfiguration_expiration OAIDataLakeLifecycleConfiguration::getExpiration() const {
    return m_expiration;
}
void OAIDataLakeLifecycleConfiguration::setExpiration(const OAIDataLakeLifecycleConfiguration_expiration &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAIDataLakeLifecycleConfiguration::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAIDataLakeLifecycleConfiguration::is_expiration_Valid() const{
    return m_expiration_isValid;
}

QList OAIDataLakeLifecycleConfiguration::getTransitions() const {
    return m_transitions;
}
void OAIDataLakeLifecycleConfiguration::setTransitions(const QList &transitions) {
    m_transitions = transitions;
    m_transitions_isSet = true;
}

bool OAIDataLakeLifecycleConfiguration::is_transitions_Set() const{
    return m_transitions_isSet;
}

bool OAIDataLakeLifecycleConfiguration::is_transitions_Valid() const{
    return m_transitions_isValid;
}

bool OAIDataLakeLifecycleConfiguration::isSet() const {
...
bool OAIDataLakeLifecycleConfiguration::isValid() const {
