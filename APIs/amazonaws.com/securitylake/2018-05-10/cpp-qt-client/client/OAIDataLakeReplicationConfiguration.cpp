...
#include "OAIDataLakeReplicationConfiguration.h"
...
OAIDataLakeReplicationConfiguration::OAIDataLakeReplicationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeReplicationConfiguration::OAIDataLakeReplicationConfiguration() {
    this->initializeModel();
}

OAIDataLakeReplicationConfiguration::~OAIDataLakeReplicationConfiguration() {}

void OAIDataLakeReplicationConfiguration::initializeModel() {
...
void OAIDataLakeReplicationConfiguration::fromJson(QString jsonString) {
...
void OAIDataLakeReplicationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeReplicationConfiguration::asJson() const {
...
QJsonObject OAIDataLakeReplicationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_regions.isSet()) {
...
QList OAIDataLakeReplicationConfiguration::getRegions() const {
    return m_regions;
}
void OAIDataLakeReplicationConfiguration::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIDataLakeReplicationConfiguration::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIDataLakeReplicationConfiguration::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIDataLakeReplicationConfiguration::getRoleArn() const {
    return m_role_arn;
}
void OAIDataLakeReplicationConfiguration::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIDataLakeReplicationConfiguration::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIDataLakeReplicationConfiguration::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIDataLakeReplicationConfiguration::isSet() const {
...
bool OAIDataLakeReplicationConfiguration::isValid() const {
