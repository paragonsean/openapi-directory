...
OAILogSourceResource_awsLogSource::OAILogSourceResource_awsLogSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogSourceResource_awsLogSource::OAILogSourceResource_awsLogSource() {
    this->initializeModel();
}

OAILogSourceResource_awsLogSource::~OAILogSourceResource_awsLogSource() {}

void OAILogSourceResource_awsLogSource::initializeModel() {
...
void OAILogSourceResource_awsLogSource::fromJson(QString jsonString) {
...
void OAILogSourceResource_awsLogSource::fromJsonObject(QJsonObject json) {
...
QString OAILogSourceResource_awsLogSource::asJson() const {
...
QJsonObject OAILogSourceResource_awsLogSource::asJsonObject() const {
    QJsonObject obj;
...
OAIAwsLogSourceName OAILogSourceResource_awsLogSource::getSourceName() const {
    return m_source_name;
}
void OAILogSourceResource_awsLogSource::setSourceName(const OAIAwsLogSourceName &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAILogSourceResource_awsLogSource::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAILogSourceResource_awsLogSource::is_source_name_Valid() const{
    return m_source_name_isValid;
}

QString OAILogSourceResource_awsLogSource::getSourceVersion() const {
    return m_source_version;
}
void OAILogSourceResource_awsLogSource::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAILogSourceResource_awsLogSource::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAILogSourceResource_awsLogSource::is_source_version_Valid() const{
    return m_source_version_isValid;
}

bool OAILogSourceResource_awsLogSource::isSet() const {
...
bool OAILogSourceResource_awsLogSource::isValid() const {
