...
/*
 * OAIDeleteDataLake_request.h
 *
 * 
 */

#ifndef OAIDeleteDataLake_request_H
#define OAIDeleteDataLake_request_H
...
class OAIDeleteDataLake_request : public OAIObject {
public:
    OAIDeleteDataLake_request();
    OAIDeleteDataLake_request(QString json);
    ~OAIDeleteDataLake_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDataLake_request)

#endif // OAIDeleteDataLake_request_H
