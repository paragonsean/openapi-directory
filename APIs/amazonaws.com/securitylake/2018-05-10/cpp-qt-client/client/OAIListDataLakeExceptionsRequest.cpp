...
#include "OAIListDataLakeExceptionsRequest.h"
...
OAIListDataLakeExceptionsRequest::OAIListDataLakeExceptionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDataLakeExceptionsRequest::OAIListDataLakeExceptionsRequest() {
    this->initializeModel();
}

OAIListDataLakeExceptionsRequest::~OAIListDataLakeExceptionsRequest() {}

void OAIListDataLakeExceptionsRequest::initializeModel() {
...
void OAIListDataLakeExceptionsRequest::fromJson(QString jsonString) {
...
void OAIListDataLakeExceptionsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListDataLakeExceptionsRequest::asJson() const {
...
QJsonObject OAIListDataLakeExceptionsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListDataLakeExceptionsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListDataLakeExceptionsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDataLakeExceptionsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDataLakeExceptionsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListDataLakeExceptionsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListDataLakeExceptionsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDataLakeExceptionsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDataLakeExceptionsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListDataLakeExceptionsRequest::getRegions() const {
    return m_regions;
}
void OAIListDataLakeExceptionsRequest::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIListDataLakeExceptionsRequest::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIListDataLakeExceptionsRequest::is_regions_Valid() const{
    return m_regions_isValid;
}

bool OAIListDataLakeExceptionsRequest::isSet() const {
...
bool OAIListDataLakeExceptionsRequest::isValid() const {
