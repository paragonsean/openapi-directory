...
/*
 * OAIUpdateDataLake_request.h
 *
 * 
 */

#ifndef OAIUpdateDataLake_request_H
#define OAIUpdateDataLake_request_H
...
class OAIUpdateDataLake_request : public OAIObject {
public:
    OAIUpdateDataLake_request();
    OAIUpdateDataLake_request(QString json);
    ~OAIUpdateDataLake_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDataLake_request)

#endif // OAIUpdateDataLake_request_H
