...
/*
 * OAICreateSubscriberResponse.h
 *
 * 
 */

#ifndef OAICreateSubscriberResponse_H
#define OAICreateSubscriberResponse_H
...
namespace OpenAPI {
class OAICreateSubscriberResponse_subscriber;

class OAICreateSubscriberResponse : public OAIObject {
public:
    OAICreateSubscriberResponse();
    OAICreateSubscriberResponse(QString json);
    ~OAICreateSubscriberResponse() override;
    ...
    OAICreateSubscriberResponse_subscriber getSubscriber() const;
    void setSubscriber(const OAICreateSubscriberResponse_subscriber &subscriber);
...
private:
    ...
    OAICreateSubscriberResponse_subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberResponse)

#endif // OAICreateSubscriberResponse_H
