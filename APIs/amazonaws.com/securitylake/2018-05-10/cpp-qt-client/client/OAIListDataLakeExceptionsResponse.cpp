...
OAIListDataLakeExceptionsResponse::OAIListDataLakeExceptionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDataLakeExceptionsResponse::OAIListDataLakeExceptionsResponse() {
    this->initializeModel();
}

OAIListDataLakeExceptionsResponse::~OAIListDataLakeExceptionsResponse() {}

void OAIListDataLakeExceptionsResponse::initializeModel() {
...
void OAIListDataLakeExceptionsResponse::fromJson(QString jsonString) {
...
void OAIListDataLakeExceptionsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListDataLakeExceptionsResponse::asJson() const {
...
QJsonObject OAIListDataLakeExceptionsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListDataLakeExceptionsResponse::getExceptions() const {
    return m_exceptions;
}
void OAIListDataLakeExceptionsResponse::setExceptions(const QList &exceptions) {
    m_exceptions = exceptions;
    m_exceptions_isSet = true;
}

bool OAIListDataLakeExceptionsResponse::is_exceptions_Set() const{
    return m_exceptions_isSet;
}

bool OAIListDataLakeExceptionsResponse::is_exceptions_Valid() const{
    return m_exceptions_isValid;
}

QString OAIListDataLakeExceptionsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDataLakeExceptionsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDataLakeExceptionsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDataLakeExceptionsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDataLakeExceptionsResponse::isSet() const {
...
bool OAIListDataLakeExceptionsResponse::isValid() const {
