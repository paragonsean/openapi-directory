...
#include "OAICustomLogSourceResource.h"
...
OAICustomLogSourceResource::OAICustomLogSourceResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomLogSourceResource::OAICustomLogSourceResource() {
    this->initializeModel();
}

OAICustomLogSourceResource::~OAICustomLogSourceResource() {}

void OAICustomLogSourceResource::initializeModel() {
...
void OAICustomLogSourceResource::fromJson(QString jsonString) {
...
void OAICustomLogSourceResource::fromJsonObject(QJsonObject json) {
...
QString OAICustomLogSourceResource::asJson() const {
...
QJsonObject OAICustomLogSourceResource::asJsonObject() const {
    QJsonObject obj;
...
OAICustomLogSourceResource_attributes OAICustomLogSourceResource::getAttributes() const {
    return m_attributes;
}
void OAICustomLogSourceResource::setAttributes(const OAICustomLogSourceResource_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICustomLogSourceResource::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICustomLogSourceResource::is_attributes_Valid() const{
    return m_attributes_isValid;
}

OAICustomLogSourceResource_provider OAICustomLogSourceResource::getProvider() const {
    return m_provider;
}
void OAICustomLogSourceResource::setProvider(const OAICustomLogSourceResource_provider &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAICustomLogSourceResource::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAICustomLogSourceResource::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAICustomLogSourceResource::getSourceName() const {
    return m_source_name;
}
void OAICustomLogSourceResource::setSourceName(const QString &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAICustomLogSourceResource::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAICustomLogSourceResource::is_source_name_Valid() const{
    return m_source_name_isValid;
}

QString OAICustomLogSourceResource::getSourceVersion() const {
    return m_source_version;
}
void OAICustomLogSourceResource::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAICustomLogSourceResource::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAICustomLogSourceResource::is_source_version_Valid() const{
    return m_source_version_isValid;
}

bool OAICustomLogSourceResource::isSet() const {
...
bool OAICustomLogSourceResource::isValid() const {
