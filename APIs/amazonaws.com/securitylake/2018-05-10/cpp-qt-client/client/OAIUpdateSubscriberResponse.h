...
/*
 * OAIUpdateSubscriberResponse.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberResponse_H
#define OAIUpdateSubscriberResponse_H
...
namespace OpenAPI {
class OAIUpdateSubscriberResponse_subscriber;

class OAIUpdateSubscriberResponse : public OAIObject {
public:
    OAIUpdateSubscriberResponse();
    OAIUpdateSubscriberResponse(QString json);
    ~OAIUpdateSubscriberResponse() override;
    ...
    OAIUpdateSubscriberResponse_subscriber getSubscriber() const;
    void setSubscriber(const OAIUpdateSubscriberResponse_subscriber &subscriber);
...
private:
    ...
    OAIUpdateSubscriberResponse_subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberResponse)

#endif // OAIUpdateSubscriberResponse_H
