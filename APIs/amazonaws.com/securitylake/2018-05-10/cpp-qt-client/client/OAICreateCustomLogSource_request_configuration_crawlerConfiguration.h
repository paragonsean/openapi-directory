...
/*
 * OAICreateCustomLogSource_request_configuration_crawlerConfiguration.h
 *
 * 
 */

#ifndef OAICreateCustomLogSource_request_configuration_crawlerConfiguration_H
#define OAICreateCustomLogSource_request_configuration_crawlerConfiguration_H
...
class OAICreateCustomLogSource_request_configuration_crawlerConfiguration : public OAIObject {
public:
    OAICreateCustomLogSource_request_configuration_crawlerConfiguration();
    OAICreateCustomLogSource_request_configuration_crawlerConfiguration(QString json);
    ~OAICreateCustomLogSource_request_configuration_crawlerConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomLogSource_request_configuration_crawlerConfiguration)

#endif // OAICreateCustomLogSource_request_configuration_crawlerConfiguration_H
