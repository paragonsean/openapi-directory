...
/*
 * OAIUpdateSubscriberNotificationResponse.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberNotificationResponse_H
#define OAIUpdateSubscriberNotificationResponse_H
...
class OAIUpdateSubscriberNotificationResponse : public OAIObject {
public:
    OAIUpdateSubscriberNotificationResponse();
    OAIUpdateSubscriberNotificationResponse(QString json);
    ~OAIUpdateSubscriberNotificationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberNotificationResponse)

#endif // OAIUpdateSubscriberNotificationResponse_H
