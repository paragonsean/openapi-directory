...
#include "OAIDeleteDataLakeRequest.h"
...
OAIDeleteDataLakeRequest::OAIDeleteDataLakeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDataLakeRequest::OAIDeleteDataLakeRequest() {
    this->initializeModel();
}

OAIDeleteDataLakeRequest::~OAIDeleteDataLakeRequest() {}

void OAIDeleteDataLakeRequest::initializeModel() {

    m_regions_isSet = false;
    m_regions_isValid = false;
}

void OAIDeleteDataLakeRequest::fromJson(QString jsonString) {
...
void OAIDeleteDataLakeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDataLakeRequest::asJson() const {
...
QJsonObject OAIDeleteDataLakeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_regions.isSet()) {
...
QList OAIDeleteDataLakeRequest::getRegions() const {
    return m_regions;
}
void OAIDeleteDataLakeRequest::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIDeleteDataLakeRequest::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIDeleteDataLakeRequest::is_regions_Valid() const{
    return m_regions_isValid;
}

bool OAIDeleteDataLakeRequest::isSet() const {
...
bool OAIDeleteDataLakeRequest::isValid() const {
