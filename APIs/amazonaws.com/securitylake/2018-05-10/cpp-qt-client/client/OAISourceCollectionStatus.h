...
/*
 * OAISourceCollectionStatus.h
 *
 * 
 */

#ifndef OAISourceCollectionStatus_H
#define OAISourceCollectionStatus_H
...
class OAISourceCollectionStatus : public OAIEnum {
public:
    OAISourceCollectionStatus();
    OAISourceCollectionStatus(QString json);
    ~OAISourceCollectionStatus() override;
    ...
    enum class eOAISourceCollectionStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COLLECTING, 
        MISCONFIGURED, 
        NOT_COLLECTING
    };
    OAISourceCollectionStatus::eOAISourceCollectionStatus getValue() const;
    void setValue(const OAISourceCollectionStatus::eOAISourceCollectionStatus& value);
...
private:
    ...
    eOAISourceCollectionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceCollectionStatus)

#endif // OAISourceCollectionStatus_H
