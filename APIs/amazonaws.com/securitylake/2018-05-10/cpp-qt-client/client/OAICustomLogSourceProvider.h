...
/*
 * OAICustomLogSourceProvider.h
 *
 * The details of the log provider for a third-party custom source.
 */

#ifndef OAICustomLogSourceProvider_H
#define OAICustomLogSourceProvider_H
...
class OAICustomLogSourceProvider : public OAIObject {
public:
    OAICustomLogSourceProvider();
    OAICustomLogSourceProvider(QString json);
    ~OAICustomLogSourceProvider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLogSourceProvider)

#endif // OAICustomLogSourceProvider_H
