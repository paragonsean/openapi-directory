...
#include "OAIAwsLogSourceResource.h"
...
OAIAwsLogSourceResource::OAIAwsLogSourceResource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAwsLogSourceResource::OAIAwsLogSourceResource() {
    this->initializeModel();
}

OAIAwsLogSourceResource::~OAIAwsLogSourceResource() {}

void OAIAwsLogSourceResource::initializeModel() {
...
void OAIAwsLogSourceResource::fromJson(QString jsonString) {
...
void OAIAwsLogSourceResource::fromJsonObject(QJsonObject json) {
...
QString OAIAwsLogSourceResource::asJson() const {
...
QJsonObject OAIAwsLogSourceResource::asJsonObject() const {
    QJsonObject obj;
...
OAIAwsLogSourceName OAIAwsLogSourceResource::getSourceName() const {
    return m_source_name;
}
void OAIAwsLogSourceResource::setSourceName(const OAIAwsLogSourceName &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAIAwsLogSourceResource::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAIAwsLogSourceResource::is_source_name_Valid() const{
    return m_source_name_isValid;
}

QString OAIAwsLogSourceResource::getSourceVersion() const {
    return m_source_version;
}
void OAIAwsLogSourceResource::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAIAwsLogSourceResource::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAIAwsLogSourceResource::is_source_version_Valid() const{
    return m_source_version_isValid;
}

bool OAIAwsLogSourceResource::isSet() const {
...
bool OAIAwsLogSourceResource::isValid() const {
