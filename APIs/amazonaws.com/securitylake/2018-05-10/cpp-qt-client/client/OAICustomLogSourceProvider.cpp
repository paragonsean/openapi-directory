...
#include "OAICustomLogSourceProvider.h"
...
OAICustomLogSourceProvider::OAICustomLogSourceProvider(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomLogSourceProvider::OAICustomLogSourceProvider() {
    this->initializeModel();
}

OAICustomLogSourceProvider::~OAICustomLogSourceProvider() {}

void OAICustomLogSourceProvider::initializeModel() {
...
void OAICustomLogSourceProvider::fromJson(QString jsonString) {
...
void OAICustomLogSourceProvider::fromJsonObject(QJsonObject json) {
...
QString OAICustomLogSourceProvider::asJson() const {
...
QJsonObject OAICustomLogSourceProvider::asJsonObject() const {
    QJsonObject obj;
    if (m_location_isSet) {
...
QString OAICustomLogSourceProvider::getLocation() const {
    return m_location;
}
void OAICustomLogSourceProvider::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAICustomLogSourceProvider::is_location_Set() const{
    return m_location_isSet;
}

bool OAICustomLogSourceProvider::is_location_Valid() const{
    return m_location_isValid;
}

QString OAICustomLogSourceProvider::getRoleArn() const {
    return m_role_arn;
}
void OAICustomLogSourceProvider::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICustomLogSourceProvider::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICustomLogSourceProvider::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAICustomLogSourceProvider::isSet() const {
...
bool OAICustomLogSourceProvider::isValid() const {
