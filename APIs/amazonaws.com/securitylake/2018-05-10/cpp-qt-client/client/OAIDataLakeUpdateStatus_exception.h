...
/*
 * OAIDataLakeUpdateStatus_exception.h
 *
 * 
 */

#ifndef OAIDataLakeUpdateStatus_exception_H
#define OAIDataLakeUpdateStatus_exception_H
...
class OAIDataLakeUpdateStatus_exception : public OAIObject {
public:
    OAIDataLakeUpdateStatus_exception();
    OAIDataLakeUpdateStatus_exception(QString json);
    ~OAIDataLakeUpdateStatus_exception() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeUpdateStatus_exception)

#endif // OAIDataLakeUpdateStatus_exception_H
