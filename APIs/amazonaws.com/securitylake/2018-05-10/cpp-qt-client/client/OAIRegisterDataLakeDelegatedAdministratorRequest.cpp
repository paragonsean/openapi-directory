...
#include "OAIRegisterDataLakeDelegatedAdministratorRequest.h"
...
OAIRegisterDataLakeDelegatedAdministratorRequest::OAIRegisterDataLakeDelegatedAdministratorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegisterDataLakeDelegatedAdministratorRequest::OAIRegisterDataLakeDelegatedAdministratorRequest() {
    this->initializeModel();
}

OAIRegisterDataLakeDelegatedAdministratorRequest::~OAIRegisterDataLakeDelegatedAdministratorRequest() {}

void OAIRegisterDataLakeDelegatedAdministratorRequest::initializeModel() {

    m_account_id_isSet = false;
    m_account_id_isValid = false;
}

void OAIRegisterDataLakeDelegatedAdministratorRequest::fromJson(QString jsonString) {
...
void OAIRegisterDataLakeDelegatedAdministratorRequest::fromJsonObject(QJsonObject json) {

    m_account_id_isValid = ::OpenAPI::fromJsonValue(m_account_id, json[QString("accountId")]);
    m_account_id_isSet = !json[QString("accountId")].isNull() && m_account_id_isValid;
}

QString OAIRegisterDataLakeDelegatedAdministratorRequest::asJson() const {
...
QJsonObject OAIRegisterDataLakeDelegatedAdministratorRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRegisterDataLakeDelegatedAdministratorRequest::getAccountId() const {
    return m_account_id;
}
void OAIRegisterDataLakeDelegatedAdministratorRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRegisterDataLakeDelegatedAdministratorRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRegisterDataLakeDelegatedAdministratorRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIRegisterDataLakeDelegatedAdministratorRequest::isSet() const {
...
bool OAIRegisterDataLakeDelegatedAdministratorRequest::isValid() const {
