...
#include "OAIDataLakeLifecycleExpiration.h"
...
OAIDataLakeLifecycleExpiration::OAIDataLakeLifecycleExpiration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeLifecycleExpiration::OAIDataLakeLifecycleExpiration() {
    this->initializeModel();
}

OAIDataLakeLifecycleExpiration::~OAIDataLakeLifecycleExpiration() {}

void OAIDataLakeLifecycleExpiration::initializeModel() {

    m_days_isSet = false;
    m_days_isValid = false;
}

void OAIDataLakeLifecycleExpiration::fromJson(QString jsonString) {
...
void OAIDataLakeLifecycleExpiration::fromJsonObject(QJsonObject json) {

    m_days_isValid = ::OpenAPI::fromJsonValue(m_days, json[QString("days")]);
    m_days_isSet = !json[QString("days")].isNull() && m_days_isValid;
}

QString OAIDataLakeLifecycleExpiration::asJson() const {
...
QJsonObject OAIDataLakeLifecycleExpiration::asJsonObject() const {
    QJsonObject obj;
    if (m_days_isSet) {
...
qint32 OAIDataLakeLifecycleExpiration::getDays() const {
    return m_days;
}
void OAIDataLakeLifecycleExpiration::setDays(const qint32 &days) {
    m_days = days;
    m_days_isSet = true;
}

bool OAIDataLakeLifecycleExpiration::is_days_Set() const{
    return m_days_isSet;
}

bool OAIDataLakeLifecycleExpiration::is_days_Valid() const{
    return m_days_isValid;
}

bool OAIDataLakeLifecycleExpiration::isSet() const {
...
bool OAIDataLakeLifecycleExpiration::isValid() const {
