...
/*
 * OAIDataLakeLifecycleConfiguration_expiration.h
 *
 * 
 */

#ifndef OAIDataLakeLifecycleConfiguration_expiration_H
#define OAIDataLakeLifecycleConfiguration_expiration_H
...
class OAIDataLakeLifecycleConfiguration_expiration : public OAIObject {
public:
    OAIDataLakeLifecycleConfiguration_expiration();
    OAIDataLakeLifecycleConfiguration_expiration(QString json);
    ~OAIDataLakeLifecycleConfiguration_expiration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeLifecycleConfiguration_expiration)

#endif // OAIDataLakeLifecycleConfiguration_expiration_H
