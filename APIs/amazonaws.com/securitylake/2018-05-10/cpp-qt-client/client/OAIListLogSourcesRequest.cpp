...
#include "OAIListLogSourcesRequest.h"
...
OAIListLogSourcesRequest::OAIListLogSourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListLogSourcesRequest::OAIListLogSourcesRequest() {
    this->initializeModel();
}

OAIListLogSourcesRequest::~OAIListLogSourcesRequest() {}

void OAIListLogSourcesRequest::initializeModel() {
...
void OAIListLogSourcesRequest::fromJson(QString jsonString) {
...
void OAIListLogSourcesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListLogSourcesRequest::asJson() const {
...
QJsonObject OAIListLogSourcesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIListLogSourcesRequest::getAccounts() const {
    return m_accounts;
}
void OAIListLogSourcesRequest::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIListLogSourcesRequest::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIListLogSourcesRequest::is_accounts_Valid() const{
    return m_accounts_isValid;
}

qint32 OAIListLogSourcesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListLogSourcesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListLogSourcesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListLogSourcesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListLogSourcesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListLogSourcesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListLogSourcesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListLogSourcesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListLogSourcesRequest::getRegions() const {
    return m_regions;
}
void OAIListLogSourcesRequest::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIListLogSourcesRequest::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIListLogSourcesRequest::is_regions_Valid() const{
    return m_regions_isValid;
}

QList OAIListLogSourcesRequest::getSources() const {
    return m_sources;
}
void OAIListLogSourcesRequest::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAIListLogSourcesRequest::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAIListLogSourcesRequest::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAIListLogSourcesRequest::isSet() const {
...
bool OAIListLogSourcesRequest::isValid() const {
