...
/*
 * OAICreateAwsLogSource_request.h
 *
 * 
 */

#ifndef OAICreateAwsLogSource_request_H
#define OAICreateAwsLogSource_request_H

#include <QJsonObject>

#include "OAIAwsLogSourceConfiguration.h"
#include <QList>
...
namespace OpenAPI {
class OAIAwsLogSourceConfiguration;

class OAICreateAwsLogSource_request : public OAIObject {
public:
    OAICreateAwsLogSource_request();
    OAICreateAwsLogSource_request(QString json);
    ~OAICreateAwsLogSource_request() override;
    ...
    QList<OAIAwsLogSourceConfiguration> getSources() const;
    void setSources(const QList<OAIAwsLogSourceConfiguration> &sources);
...
private:
    ...
    QList<OAIAwsLogSourceConfiguration> m_sources;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAwsLogSource_request)

#endif // OAICreateAwsLogSource_request_H
