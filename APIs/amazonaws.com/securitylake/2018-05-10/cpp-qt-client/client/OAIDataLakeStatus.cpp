...
OAIDataLakeStatus::OAIDataLakeStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeStatus::OAIDataLakeStatus() {
    this->initializeModel();
}

OAIDataLakeStatus::~OAIDataLakeStatus() {}

void OAIDataLakeStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDataLakeStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDataLakeStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INITIALIZED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataLakeStatus::INITIALIZED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataLakeStatus::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COMPLETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataLakeStatus::COMPLETED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDataLakeStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDataLakeStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDataLakeStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDataLakeStatus::INITIALIZED:
            val = "INITIALIZED";
            break;
        case eOAIDataLakeStatus::PENDING:
            val = "PENDING";
            break;
        case eOAIDataLakeStatus::COMPLETED:
            val = "COMPLETED";
            break;
        case eOAIDataLakeStatus::FAILED:
            val = "FAILED";
            break;
        default:
            break;
...
QJsonValue OAIDataLakeStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDataLakeStatus::eOAIDataLakeStatus OAIDataLakeStatus::getValue() const {
    return m_value;
}

void OAIDataLakeStatus::setValue(const OAIDataLakeStatus::eOAIDataLakeStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDataLakeStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIDataLakeStatus::isValid() const {
