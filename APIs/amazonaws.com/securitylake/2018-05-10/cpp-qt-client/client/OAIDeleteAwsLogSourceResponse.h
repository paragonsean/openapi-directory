...
/*
 * OAIDeleteAwsLogSourceResponse.h
 *
 * 
 */

#ifndef OAIDeleteAwsLogSourceResponse_H
#define OAIDeleteAwsLogSourceResponse_H
...
class OAIDeleteAwsLogSourceResponse : public OAIObject {
public:
    OAIDeleteAwsLogSourceResponse();
    OAIDeleteAwsLogSourceResponse(QString json);
    ~OAIDeleteAwsLogSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAwsLogSourceResponse)

#endif // OAIDeleteAwsLogSourceResponse_H
