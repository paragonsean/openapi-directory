...
OAIListDataLakesResponse::OAIListDataLakesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDataLakesResponse::OAIListDataLakesResponse() {
    this->initializeModel();
}

OAIListDataLakesResponse::~OAIListDataLakesResponse() {}

void OAIListDataLakesResponse::initializeModel() {

    m_data_lakes_isSet = false;
    m_data_lakes_isValid = false;
}

void OAIListDataLakesResponse::fromJson(QString jsonString) {
...
void OAIListDataLakesResponse::fromJsonObject(QJsonObject json) {

    m_data_lakes_isValid = ::OpenAPI::fromJsonValue(m_data_lakes, json[QString("dataLakes")]);
    m_data_lakes_isSet = !json[QString("dataLakes")].isNull() && m_data_lakes_isValid;
}

QString OAIListDataLakesResponse::asJson() const {
...
QJsonObject OAIListDataLakesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data_lakes.isSet()) {
        obj.insert(QString("dataLakes"), ::OpenAPI::toJsonValue(m_data_lakes));
    }
    return obj;
}

QList OAIListDataLakesResponse::getDataLakes() const {
    return m_data_lakes;
}
void OAIListDataLakesResponse::setDataLakes(const QList &data_lakes) {
    m_data_lakes = data_lakes;
    m_data_lakes_isSet = true;
}

bool OAIListDataLakesResponse::is_data_lakes_Set() const{
    return m_data_lakes_isSet;
}

bool OAIListDataLakesResponse::is_data_lakes_Valid() const{
    return m_data_lakes_isValid;
}

bool OAIListDataLakesResponse::isSet() const {
...
bool OAIListDataLakesResponse::isValid() const {
