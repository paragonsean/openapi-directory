...
/*
 * OAICreateCustomLogSourceResponse.h
 *
 * 
 */

#ifndef OAICreateCustomLogSourceResponse_H
#define OAICreateCustomLogSourceResponse_H
...
namespace OpenAPI {
class OAICreateCustomLogSourceResponse_source;

class OAICreateCustomLogSourceResponse : public OAIObject {
public:
    OAICreateCustomLogSourceResponse();
    OAICreateCustomLogSourceResponse(QString json);
    ~OAICreateCustomLogSourceResponse() override;
    ...
    OAICreateCustomLogSourceResponse_source getSource() const;
    void setSource(const OAICreateCustomLogSourceResponse_source &source);
...
private:
    ...
    OAICreateCustomLogSourceResponse_source m_source;
    bool m_source_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomLogSourceResponse)

#endif // OAICreateCustomLogSourceResponse_H
