...
#include "OAICreateAwsLogSourceRequest.h"
...
OAICreateAwsLogSourceRequest::OAICreateAwsLogSourceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAwsLogSourceRequest::OAICreateAwsLogSourceRequest() {
    this->initializeModel();
}

OAICreateAwsLogSourceRequest::~OAICreateAwsLogSourceRequest() {}

void OAICreateAwsLogSourceRequest::initializeModel() {

    m_sources_isSet = false;
    m_sources_isValid = false;
}

void OAICreateAwsLogSourceRequest::fromJson(QString jsonString) {
...
void OAICreateAwsLogSourceRequest::fromJsonObject(QJsonObject json) {

    m_sources_isValid = ::OpenAPI::fromJsonValue(m_sources, json[QString("sources")]);
    m_sources_isSet = !json[QString("sources")].isNull() && m_sources_isValid;
}

QString OAICreateAwsLogSourceRequest::asJson() const {
...
QJsonObject OAICreateAwsLogSourceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_sources.isSet()) {
...
QList OAICreateAwsLogSourceRequest::getSources() const {
    return m_sources;
}
void OAICreateAwsLogSourceRequest::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAICreateAwsLogSourceRequest::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAICreateAwsLogSourceRequest::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAICreateAwsLogSourceRequest::isSet() const {
...
bool OAICreateAwsLogSourceRequest::isValid() const {
