...
#include "OAIGetDataLakeSourcesRequest.h"
...
OAIGetDataLakeSourcesRequest::OAIGetDataLakeSourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataLakeSourcesRequest::OAIGetDataLakeSourcesRequest() {
    this->initializeModel();
}

OAIGetDataLakeSourcesRequest::~OAIGetDataLakeSourcesRequest() {}

void OAIGetDataLakeSourcesRequest::initializeModel() {
...
void OAIGetDataLakeSourcesRequest::fromJson(QString jsonString) {
...
void OAIGetDataLakeSourcesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetDataLakeSourcesRequest::asJson() const {
...
QJsonObject OAIGetDataLakeSourcesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIGetDataLakeSourcesRequest::getAccounts() const {
    return m_accounts;
}
void OAIGetDataLakeSourcesRequest::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIGetDataLakeSourcesRequest::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIGetDataLakeSourcesRequest::is_accounts_Valid() const{
    return m_accounts_isValid;
}

qint32 OAIGetDataLakeSourcesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetDataLakeSourcesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetDataLakeSourcesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetDataLakeSourcesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetDataLakeSourcesRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetDataLakeSourcesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetDataLakeSourcesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetDataLakeSourcesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetDataLakeSourcesRequest::isSet() const {
...
bool OAIGetDataLakeSourcesRequest::isValid() const {
