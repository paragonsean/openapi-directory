...
/*
 * OAICreateSubscriber_request_subscriberIdentity.h
 *
 * The AWS identity.
 */

#ifndef OAICreateSubscriber_request_subscriberIdentity_H
#define OAICreateSubscriber_request_subscriberIdentity_H
...
class OAICreateSubscriber_request_subscriberIdentity : public OAIObject {
public:
    OAICreateSubscriber_request_subscriberIdentity();
    OAICreateSubscriber_request_subscriberIdentity(QString json);
    ~OAICreateSubscriber_request_subscriberIdentity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriber_request_subscriberIdentity)

#endif // OAICreateSubscriber_request_subscriberIdentity_H
