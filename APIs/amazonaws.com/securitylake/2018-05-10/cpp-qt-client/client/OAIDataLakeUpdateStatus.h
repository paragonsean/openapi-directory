...
#ifndef OAIDataLakeUpdateStatus_H
#define OAIDataLakeUpdateStatus_H
...
class OAIDataLakeUpdateStatus : public OAIObject {
public:
    OAIDataLakeUpdateStatus();
    OAIDataLakeUpdateStatus(QString json);
    ~OAIDataLakeUpdateStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeUpdateStatus)

#endif // OAIDataLakeUpdateStatus_H
