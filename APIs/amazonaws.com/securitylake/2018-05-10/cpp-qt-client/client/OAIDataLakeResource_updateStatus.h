...
/*
 * OAIDataLakeResource_updateStatus.h
 *
 * 
 */

#ifndef OAIDataLakeResource_updateStatus_H
#define OAIDataLakeResource_updateStatus_H
...
namespace OpenAPI {
class OAIDataLakeUpdateStatus_exception;

class OAIDataLakeResource_updateStatus : public OAIObject {
public:
    OAIDataLakeResource_updateStatus();
    OAIDataLakeResource_updateStatus(QString json);
    ~OAIDataLakeResource_updateStatus() override;
    ...
    OAIDataLakeUpdateStatus_exception getException() const;
    void setException(const OAIDataLakeUpdateStatus_exception &exception);
    ...
    OAIDataLakeStatus getStatus() const;
    void setStatus(const OAIDataLakeStatus &status);
...
private:
    ...
    OAIDataLakeUpdateStatus_exception m_exception;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeResource_updateStatus)

#endif // OAIDataLakeResource_updateStatus_H
