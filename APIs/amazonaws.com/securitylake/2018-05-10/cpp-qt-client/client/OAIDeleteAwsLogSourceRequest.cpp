...
#include "OAIDeleteAwsLogSourceRequest.h"
...
OAIDeleteAwsLogSourceRequest::OAIDeleteAwsLogSourceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAwsLogSourceRequest::OAIDeleteAwsLogSourceRequest() {
    this->initializeModel();
}

OAIDeleteAwsLogSourceRequest::~OAIDeleteAwsLogSourceRequest() {}

void OAIDeleteAwsLogSourceRequest::initializeModel() {

    m_sources_isSet = false;
    m_sources_isValid = false;
}

void OAIDeleteAwsLogSourceRequest::fromJson(QString jsonString) {
...
void OAIDeleteAwsLogSourceRequest::fromJsonObject(QJsonObject json) {

    m_sources_isValid = ::OpenAPI::fromJsonValue(m_sources, json[QString("sources")]);
    m_sources_isSet = !json[QString("sources")].isNull() && m_sources_isValid;
}

QString OAIDeleteAwsLogSourceRequest::asJson() const {
...
QJsonObject OAIDeleteAwsLogSourceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_sources.isSet()) {
...
QList OAIDeleteAwsLogSourceRequest::getSources() const {
    return m_sources;
}
void OAIDeleteAwsLogSourceRequest::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAIDeleteAwsLogSourceRequest::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAIDeleteAwsLogSourceRequest::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAIDeleteAwsLogSourceRequest::isSet() const {
...
bool OAIDeleteAwsLogSourceRequest::isValid() const {
