...
/*
 * OAICustomLogSourceResource_attributes.h
 *
 * 
 */

#ifndef OAICustomLogSourceResource_attributes_H
#define OAICustomLogSourceResource_attributes_H
...
class OAICustomLogSourceResource_attributes : public OAIObject {
public:
    OAICustomLogSourceResource_attributes();
    OAICustomLogSourceResource_attributes(QString json);
    ~OAICustomLogSourceResource_attributes() override;
    ...
    QString getCrawlerArn() const;
    void setCrawlerArn(const QString &crawler_arn);
    bool is_crawler_arn_Set() const;
    bool is_crawler_arn_Valid() const;
...
private:
    ...
    QString m_crawler_arn;
    bool m_crawler_arn_isSet;
    bool m_crawler_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLogSourceResource_attributes)

#endif // OAICustomLogSourceResource_attributes_H
