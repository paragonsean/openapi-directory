...
/*
 * OAICustomLogSourceResource_provider.h
 *
 * 
 */

#ifndef OAICustomLogSourceResource_provider_H
#define OAICustomLogSourceResource_provider_H
...
class OAICustomLogSourceResource_provider : public OAIObject {
public:
    OAICustomLogSourceResource_provider();
    OAICustomLogSourceResource_provider(QString json);
    ~OAICustomLogSourceResource_provider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLogSourceResource_provider)

#endif // OAICustomLogSourceResource_provider_H
