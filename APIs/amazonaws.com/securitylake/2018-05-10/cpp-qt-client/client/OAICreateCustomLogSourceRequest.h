...
/*
 * OAICreateCustomLogSourceRequest.h
 *
 * 
 */

#ifndef OAICreateCustomLogSourceRequest_H
#define OAICreateCustomLogSourceRequest_H

#include <QJsonObject>

#include "OAICreateCustomLogSourceRequest_configuration.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateCustomLogSourceRequest_configuration;

class OAICreateCustomLogSourceRequest : public OAIObject {
public:
    OAICreateCustomLogSourceRequest();
    OAICreateCustomLogSourceRequest(QString json);
    ~OAICreateCustomLogSourceRequest() override;
    ...
    OAICreateCustomLogSourceRequest_configuration getConfiguration() const;
    void setConfiguration(const OAICreateCustomLogSourceRequest_configuration &configuration);
...
private:
    ...
    OAICreateCustomLogSourceRequest_configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomLogSourceRequest)

#endif // OAICreateCustomLogSourceRequest_H
