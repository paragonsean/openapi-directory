...
/*
 * OAIRegisterDataLakeDelegatedAdministratorRequest.h
 *
 * 
 */

#ifndef OAIRegisterDataLakeDelegatedAdministratorRequest_H
#define OAIRegisterDataLakeDelegatedAdministratorRequest_H
...
class OAIRegisterDataLakeDelegatedAdministratorRequest : public OAIObject {
public:
    OAIRegisterDataLakeDelegatedAdministratorRequest();
    OAIRegisterDataLakeDelegatedAdministratorRequest(QString json);
    ~OAIRegisterDataLakeDelegatedAdministratorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterDataLakeDelegatedAdministratorRequest)

#endif // OAIRegisterDataLakeDelegatedAdministratorRequest_H
