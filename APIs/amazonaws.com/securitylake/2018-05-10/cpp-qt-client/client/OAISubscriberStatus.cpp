...
QString OAISubscriberStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAISubscriberStatus::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAISubscriberStatus::DEACTIVATED:
            val = "DEACTIVATED";
            break;
        case eOAISubscriberStatus::PENDING:
            val = "PENDING";
            break;
        case eOAISubscriberStatus::READY:
            val = "READY";
            break;
        default:
            break;
