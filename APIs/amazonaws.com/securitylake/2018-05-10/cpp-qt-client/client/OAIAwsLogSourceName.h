...
/*
 * OAIAwsLogSourceName.h
 *
 * 
 */

#ifndef OAIAwsLogSourceName_H
#define OAIAwsLogSourceName_H
...
class OAIAwsLogSourceName : public OAIEnum {
public:
    OAIAwsLogSourceName();
    OAIAwsLogSourceName(QString json);
    ~OAIAwsLogSourceName() override;
    ...
    enum class eOAIAwsLogSourceName {
    ...
    OAIAwsLogSourceName::eOAIAwsLogSourceName getValue() const;
    void setValue(const OAIAwsLogSourceName::eOAIAwsLogSourceName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAwsLogSourceName)

#endif // OAIAwsLogSourceName_H
