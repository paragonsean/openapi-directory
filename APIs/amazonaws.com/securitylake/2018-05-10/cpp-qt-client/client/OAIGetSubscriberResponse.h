...
/*
 * OAIGetSubscriberResponse.h
 *
 * 
 */

#ifndef OAIGetSubscriberResponse_H
#define OAIGetSubscriberResponse_H

#include <QJsonObject>

#include "OAIGetSubscriberResponse_subscriber.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetSubscriberResponse_subscriber;

class OAIGetSubscriberResponse : public OAIObject {
public:
    OAIGetSubscriberResponse();
    OAIGetSubscriberResponse(QString json);
    ~OAIGetSubscriberResponse() override;
    ...
    OAIGetSubscriberResponse_subscriber getSubscriber() const;
    void setSubscriber(const OAIGetSubscriberResponse_subscriber &subscriber);
...
private:
    ...
    OAIGetSubscriberResponse_subscriber m_subscriber;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSubscriberResponse)

#endif // OAIGetSubscriberResponse_H
