...
class OAIDataLakeUpdateException : public OAIObject {
public:
    OAIDataLakeUpdateException();
    OAIDataLakeUpdateException(QString json);
    ~OAIDataLakeUpdateException() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeUpdateException)

#endif // OAIDataLakeUpdateException_H
