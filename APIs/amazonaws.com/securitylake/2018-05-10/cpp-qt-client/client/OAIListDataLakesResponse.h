...
/*
 * OAIListDataLakesResponse.h
 *
 * 
 */

#ifndef OAIListDataLakesResponse_H
#define OAIListDataLakesResponse_H
...
class OAIListDataLakesResponse : public OAIObject {
public:
    OAIListDataLakesResponse();
    OAIListDataLakesResponse(QString json);
    ~OAIListDataLakesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataLakesResponse)

#endif // OAIListDataLakesResponse_H
