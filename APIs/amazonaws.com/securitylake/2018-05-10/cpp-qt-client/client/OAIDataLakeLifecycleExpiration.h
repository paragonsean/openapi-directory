...
/*
 * OAIDataLakeLifecycleExpiration.h
 *
 * Provide expiration lifecycle details of Amazon Security Lake object.
 */

#ifndef OAIDataLakeLifecycleExpiration_H
#define OAIDataLakeLifecycleExpiration_H
...
class OAIDataLakeLifecycleExpiration : public OAIObject {
public:
    OAIDataLakeLifecycleExpiration();
    OAIDataLakeLifecycleExpiration(QString json);
    ~OAIDataLakeLifecycleExpiration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeLifecycleExpiration)

#endif // OAIDataLakeLifecycleExpiration_H
