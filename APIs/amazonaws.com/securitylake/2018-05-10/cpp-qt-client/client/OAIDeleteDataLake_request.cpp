...
OAIDeleteDataLake_request::OAIDeleteDataLake_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDataLake_request::OAIDeleteDataLake_request() {
    this->initializeModel();
}

OAIDeleteDataLake_request::~OAIDeleteDataLake_request() {}

void OAIDeleteDataLake_request::initializeModel() {

    m_regions_isSet = false;
    m_regions_isValid = false;
}

void OAIDeleteDataLake_request::fromJson(QString jsonString) {
...
void OAIDeleteDataLake_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDataLake_request::asJson() const {
...
QJsonObject OAIDeleteDataLake_request::asJsonObject() const {
    QJsonObject obj;
    if (m_regions.size() > 0) {
...
QList<QString> OAIDeleteDataLake_request::getRegions() const {
    return m_regions;
}
void OAIDeleteDataLake_request::setRegions(const QList<QString> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIDeleteDataLake_request::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIDeleteDataLake_request::is_regions_Valid() const{
    return m_regions_isValid;
}

bool OAIDeleteDataLake_request::isSet() const {
...
bool OAIDeleteDataLake_request::isValid() const {
