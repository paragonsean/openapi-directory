...
/*
 * OAIGetDataLakeSources_request.h
 *
 * 
 */

#ifndef OAIGetDataLakeSources_request_H
#define OAIGetDataLakeSources_request_H
...
class OAIGetDataLakeSources_request : public OAIObject {
public:
    OAIGetDataLakeSources_request();
    OAIGetDataLakeSources_request(QString json);
    ~OAIGetDataLakeSources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataLakeSources_request)

#endif // OAIGetDataLakeSources_request_H
