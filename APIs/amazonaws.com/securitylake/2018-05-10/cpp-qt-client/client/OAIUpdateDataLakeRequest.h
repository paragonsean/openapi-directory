...
/*
 * OAIUpdateDataLakeRequest.h
 *
 * 
 */

#ifndef OAIUpdateDataLakeRequest_H
#define OAIUpdateDataLakeRequest_H
...
class OAIUpdateDataLakeRequest : public OAIObject {
public:
    OAIUpdateDataLakeRequest();
    OAIUpdateDataLakeRequest(QString json);
    ~OAIUpdateDataLakeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDataLakeRequest)

#endif // OAIUpdateDataLakeRequest_H
