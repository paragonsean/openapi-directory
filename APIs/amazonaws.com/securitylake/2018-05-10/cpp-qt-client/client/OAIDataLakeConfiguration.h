...
/*
 * OAIDataLakeConfiguration.h
 *
 * Provides details of Amazon Security Lake object.
 */

#ifndef OAIDataLakeConfiguration_H
#define OAIDataLakeConfiguration_H
...
class OAIDataLakeConfiguration : public OAIObject {
public:
    OAIDataLakeConfiguration();
    OAIDataLakeConfiguration(QString json);
    ~OAIDataLakeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeConfiguration)

#endif // OAIDataLakeConfiguration_H
