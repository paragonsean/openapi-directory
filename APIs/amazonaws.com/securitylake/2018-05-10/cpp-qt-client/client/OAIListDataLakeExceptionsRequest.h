...
/*
 * OAIListDataLakeExceptionsRequest.h
 *
 * 
 */

#ifndef OAIListDataLakeExceptionsRequest_H
#define OAIListDataLakeExceptionsRequest_H
...
class OAIListDataLakeExceptionsRequest : public OAIObject {
public:
    OAIListDataLakeExceptionsRequest();
    OAIListDataLakeExceptionsRequest(QString json);
    ~OAIListDataLakeExceptionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataLakeExceptionsRequest)

#endif // OAIListDataLakeExceptionsRequest_H
