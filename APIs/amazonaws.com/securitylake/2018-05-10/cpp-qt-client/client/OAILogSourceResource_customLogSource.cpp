...
OAILogSourceResource_customLogSource::OAILogSourceResource_customLogSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogSourceResource_customLogSource::OAILogSourceResource_customLogSource() {
    this->initializeModel();
}

OAILogSourceResource_customLogSource::~OAILogSourceResource_customLogSource() {}

void OAILogSourceResource_customLogSource::initializeModel() {
...
void OAILogSourceResource_customLogSource::fromJson(QString jsonString) {
...
void OAILogSourceResource_customLogSource::fromJsonObject(QJsonObject json) {
...
QString OAILogSourceResource_customLogSource::asJson() const {
...
QJsonObject OAILogSourceResource_customLogSource::asJsonObject() const {
    QJsonObject obj;
...
OAICustomLogSourceResource_attributes OAILogSourceResource_customLogSource::getAttributes() const {
    return m_attributes;
}
void OAILogSourceResource_customLogSource::setAttributes(const OAICustomLogSourceResource_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAILogSourceResource_customLogSource::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAILogSourceResource_customLogSource::is_attributes_Valid() const{
    return m_attributes_isValid;
}

OAICustomLogSourceResource_provider OAILogSourceResource_customLogSource::getProvider() const {
    return m_provider;
}
void OAILogSourceResource_customLogSource::setProvider(const OAICustomLogSourceResource_provider &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAILogSourceResource_customLogSource::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAILogSourceResource_customLogSource::is_provider_Valid() const{
    return m_provider_isValid;
}

QString OAILogSourceResource_customLogSource::getSourceName() const {
    return m_source_name;
}
void OAILogSourceResource_customLogSource::setSourceName(const QString &source_name) {
    m_source_name = source_name;
    m_source_name_isSet = true;
}

bool OAILogSourceResource_customLogSource::is_source_name_Set() const{
    return m_source_name_isSet;
}

bool OAILogSourceResource_customLogSource::is_source_name_Valid() const{
    return m_source_name_isValid;
}

QString OAILogSourceResource_customLogSource::getSourceVersion() const {
    return m_source_version;
}
void OAILogSourceResource_customLogSource::setSourceVersion(const QString &source_version) {
    m_source_version = source_version;
    m_source_version_isSet = true;
}

bool OAILogSourceResource_customLogSource::is_source_version_Set() const{
    return m_source_version_isSet;
}

bool OAILogSourceResource_customLogSource::is_source_version_Valid() const{
    return m_source_version_isValid;
}

bool OAILogSourceResource_customLogSource::isSet() const {
...
bool OAILogSourceResource_customLogSource::isValid() const {
