...
OAICreateCustomLogSourceResponse::OAICreateCustomLogSourceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomLogSourceResponse::OAICreateCustomLogSourceResponse() {
    this->initializeModel();
}

OAICreateCustomLogSourceResponse::~OAICreateCustomLogSourceResponse() {}

void OAICreateCustomLogSourceResponse::initializeModel() {

    m_source_isSet = false;
    m_source_isValid = false;
}

void OAICreateCustomLogSourceResponse::fromJson(QString jsonString) {
...
void OAICreateCustomLogSourceResponse::fromJsonObject(QJsonObject json) {

    m_source_isValid = ::OpenAPI::fromJsonValue(m_source, json[QString("source")]);
    m_source_isSet = !json[QString("source")].isNull() && m_source_isValid;
}

QString OAICreateCustomLogSourceResponse::asJson() const {
...
QJsonObject OAICreateCustomLogSourceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
OAICreateCustomLogSourceResponse_source OAICreateCustomLogSourceResponse::getSource() const {
    return m_source;
}
void OAICreateCustomLogSourceResponse::setSource(const OAICreateCustomLogSourceResponse_source &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAICreateCustomLogSourceResponse::is_source_Set() const{
    return m_source_isSet;
}

bool OAICreateCustomLogSourceResponse::is_source_Valid() const{
    return m_source_isValid;
}

bool OAICreateCustomLogSourceResponse::isSet() const {
...
bool OAICreateCustomLogSourceResponse::isValid() const {
