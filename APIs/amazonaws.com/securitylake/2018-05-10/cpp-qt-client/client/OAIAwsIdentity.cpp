...
OAIAwsIdentity::OAIAwsIdentity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAwsIdentity::OAIAwsIdentity() {
    this->initializeModel();
}

OAIAwsIdentity::~OAIAwsIdentity() {}

void OAIAwsIdentity::initializeModel() {
...
void OAIAwsIdentity::fromJson(QString jsonString) {
...
void OAIAwsIdentity::fromJsonObject(QJsonObject json) {
...
QString OAIAwsIdentity::asJson() const {
...
QJsonObject OAIAwsIdentity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAwsIdentity::getExternalId() const {
    return m_external_id;
}
void OAIAwsIdentity::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIAwsIdentity::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIAwsIdentity::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAIAwsIdentity::getPrincipal() const {
    return m_principal;
}
void OAIAwsIdentity::setPrincipal(const QString &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIAwsIdentity::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIAwsIdentity::is_principal_Valid() const{
    return m_principal_isValid;
}

bool OAIAwsIdentity::isSet() const {
...
bool OAIAwsIdentity::isValid() const {
