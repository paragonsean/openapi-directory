...
OAIListSubscribersResponse::OAIListSubscribersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListSubscribersResponse::OAIListSubscribersResponse() {
    this->initializeModel();
}

OAIListSubscribersResponse::~OAIListSubscribersResponse() {}

void OAIListSubscribersResponse::initializeModel() {
...
void OAIListSubscribersResponse::fromJson(QString jsonString) {
...
void OAIListSubscribersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListSubscribersResponse::asJson() const {
...
QJsonObject OAIListSubscribersResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListSubscribersResponse::getNextToken() const {
    return m_next_token;
}
void OAIListSubscribersResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListSubscribersResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListSubscribersResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListSubscribersResponse::getSubscribers() const {
    return m_subscribers;
}
void OAIListSubscribersResponse::setSubscribers(const QList &subscribers) {
    m_subscribers = subscribers;
    m_subscribers_isSet = true;
}

bool OAIListSubscribersResponse::is_subscribers_Set() const{
    return m_subscribers_isSet;
}

bool OAIListSubscribersResponse::is_subscribers_Valid() const{
    return m_subscribers_isValid;
}

bool OAIListSubscribersResponse::isSet() const {
...
bool OAIListSubscribersResponse::isValid() const {
