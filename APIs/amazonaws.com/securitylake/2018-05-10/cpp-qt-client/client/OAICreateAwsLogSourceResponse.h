...
/*
 * OAICreateAwsLogSourceResponse.h
 *
 * 
 */

#ifndef OAICreateAwsLogSourceResponse_H
#define OAICreateAwsLogSourceResponse_H
...
class OAICreateAwsLogSourceResponse : public OAIObject {
public:
    OAICreateAwsLogSourceResponse();
    OAICreateAwsLogSourceResponse(QString json);
    ~OAICreateAwsLogSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAwsLogSourceResponse)

#endif // OAICreateAwsLogSourceResponse_H
