...
#include "OAIDataLakeSourceStatus.h"
...
OAIDataLakeSourceStatus::OAIDataLakeSourceStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeSourceStatus::OAIDataLakeSourceStatus() {
    this->initializeModel();
}

OAIDataLakeSourceStatus::~OAIDataLakeSourceStatus() {}

void OAIDataLakeSourceStatus::initializeModel() {
...
void OAIDataLakeSourceStatus::fromJson(QString jsonString) {
...
void OAIDataLakeSourceStatus::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeSourceStatus::asJson() const {
...
QJsonObject OAIDataLakeSourceStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_resource_isSet) {
...
QString OAIDataLakeSourceStatus::getResource() const {
    return m_resource;
}
void OAIDataLakeSourceStatus::setResource(const QString &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIDataLakeSourceStatus::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIDataLakeSourceStatus::is_resource_Valid() const{
    return m_resource_isValid;
}

OAISourceCollectionStatus OAIDataLakeSourceStatus::getStatus() const {
    return m_status;
}
void OAIDataLakeSourceStatus::setStatus(const OAISourceCollectionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDataLakeSourceStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDataLakeSourceStatus::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIDataLakeSourceStatus::isSet() const {
...
bool OAIDataLakeSourceStatus::isValid() const {
