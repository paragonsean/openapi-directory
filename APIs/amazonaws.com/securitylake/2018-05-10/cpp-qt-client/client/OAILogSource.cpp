...
OAILogSource::OAILogSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogSource::OAILogSource() {
    this->initializeModel();
}

OAILogSource::~OAILogSource() {}

void OAILogSource::initializeModel() {
...
void OAILogSource::fromJson(QString jsonString) {
...
void OAILogSource::fromJsonObject(QJsonObject json) {
...
QString OAILogSource::asJson() const {
...
QJsonObject OAILogSource::asJsonObject() const {
    QJsonObject obj;
    if (m_account_isSet) {
...
QString OAILogSource::getAccount() const {
    return m_account;
}
void OAILogSource::setAccount(const QString &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAILogSource::is_account_Set() const{
    return m_account_isSet;
}

bool OAILogSource::is_account_Valid() const{
    return m_account_isValid;
}

QString OAILogSource::getRegion() const {
    return m_region;
}
void OAILogSource::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAILogSource::is_region_Set() const{
    return m_region_isSet;
}

bool OAILogSource::is_region_Valid() const{
    return m_region_isValid;
}

QList OAILogSource::getSources() const {
    return m_sources;
}
void OAILogSource::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAILogSource::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAILogSource::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAILogSource::isSet() const {
...
bool OAILogSource::isValid() const {
