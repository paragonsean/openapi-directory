...
/*
 * OAIUpdateSubscriberNotificationRequest.h
 *
 * 
 */

#ifndef OAIUpdateSubscriberNotificationRequest_H
#define OAIUpdateSubscriberNotificationRequest_H
...
namespace OpenAPI {
class OAIUpdateSubscriberNotificationRequest_configuration;

class OAIUpdateSubscriberNotificationRequest : public OAIObject {
public:
    OAIUpdateSubscriberNotificationRequest();
    OAIUpdateSubscriberNotificationRequest(QString json);
    ~OAIUpdateSubscriberNotificationRequest() override;
    ...
    OAIUpdateSubscriberNotificationRequest_configuration getConfiguration() const;
    void setConfiguration(const OAIUpdateSubscriberNotificationRequest_configuration &configuration);
...
private:
    ...
    OAIUpdateSubscriberNotificationRequest_configuration m_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubscriberNotificationRequest)

#endif // OAIUpdateSubscriberNotificationRequest_H
