...
OAIDeleteAwsLogSource_request::OAIDeleteAwsLogSource_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAwsLogSource_request::OAIDeleteAwsLogSource_request() {
    this->initializeModel();
}

OAIDeleteAwsLogSource_request::~OAIDeleteAwsLogSource_request() {}

void OAIDeleteAwsLogSource_request::initializeModel() {

    m_sources_isSet = false;
    m_sources_isValid = false;
}

void OAIDeleteAwsLogSource_request::fromJson(QString jsonString) {
...
void OAIDeleteAwsLogSource_request::fromJsonObject(QJsonObject json) {

    m_sources_isValid = ::OpenAPI::fromJsonValue(m_sources, json[QString("sources")]);
    m_sources_isSet = !json[QString("sources")].isNull() && m_sources_isValid;
}

QString OAIDeleteAwsLogSource_request::asJson() const {
...
QJsonObject OAIDeleteAwsLogSource_request::asJsonObject() const {
    QJsonObject obj;
    if (m_sources.size() > 0) {
...
QList<OAIAwsLogSourceConfiguration> OAIDeleteAwsLogSource_request::getSources() const {
    return m_sources;
}
void OAIDeleteAwsLogSource_request::setSources(const QList<OAIAwsLogSourceConfiguration> &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAIDeleteAwsLogSource_request::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAIDeleteAwsLogSource_request::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAIDeleteAwsLogSource_request::isSet() const {
...
bool OAIDeleteAwsLogSource_request::isValid() const {
