...
#include "OAIDataLakeUpdateException.h"
...
OAIDataLakeUpdateException::OAIDataLakeUpdateException(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeUpdateException::OAIDataLakeUpdateException() {
    this->initializeModel();
}

OAIDataLakeUpdateException::~OAIDataLakeUpdateException() {}

void OAIDataLakeUpdateException::initializeModel() {
...
void OAIDataLakeUpdateException::fromJson(QString jsonString) {
...
void OAIDataLakeUpdateException::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeUpdateException::asJson() const {
...
QJsonObject OAIDataLakeUpdateException::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIDataLakeUpdateException::getCode() const {
    return m_code;
}
void OAIDataLakeUpdateException::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDataLakeUpdateException::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDataLakeUpdateException::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDataLakeUpdateException::getReason() const {
    return m_reason;
}
void OAIDataLakeUpdateException::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDataLakeUpdateException::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDataLakeUpdateException::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIDataLakeUpdateException::isSet() const {
...
bool OAIDataLakeUpdateException::isValid() const {
