...
OAIUpdateDataLake_request::OAIUpdateDataLake_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDataLake_request::OAIUpdateDataLake_request() {
    this->initializeModel();
}

OAIUpdateDataLake_request::~OAIUpdateDataLake_request() {}

void OAIUpdateDataLake_request::initializeModel() {

    m_configurations_isSet = false;
    m_configurations_isValid = false;
}

void OAIUpdateDataLake_request::fromJson(QString jsonString) {
...
void OAIUpdateDataLake_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDataLake_request::asJson() const {
...
QJsonObject OAIUpdateDataLake_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDataLakeConfiguration> OAIUpdateDataLake_request::getConfigurations() const {
    return m_configurations;
}
void OAIUpdateDataLake_request::setConfigurations(const QList<OAIDataLakeConfiguration> &configurations) {
    m_configurations = configurations;
    m_configurations_isSet = true;
}

bool OAIUpdateDataLake_request::is_configurations_Set() const{
    return m_configurations_isSet;
}

bool OAIUpdateDataLake_request::is_configurations_Valid() const{
    return m_configurations_isValid;
}

bool OAIUpdateDataLake_request::isSet() const {
...
bool OAIUpdateDataLake_request::isValid() const {
