...
/*
 * OAISubscriberStatus.h
 *
 * 
 */

#ifndef OAISubscriberStatus_H
#define OAISubscriberStatus_H
...
class OAISubscriberStatus : public OAIEnum {
public:
    OAISubscriberStatus();
    OAISubscriberStatus(QString json);
    ~OAISubscriberStatus() override;
    ...
    enum class eOAISubscriberStatus {
    ...
    OAISubscriberStatus::eOAISubscriberStatus getValue() const;
    void setValue(const OAISubscriberStatus::eOAISubscriberStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriberStatus)

#endif // OAISubscriberStatus_H
