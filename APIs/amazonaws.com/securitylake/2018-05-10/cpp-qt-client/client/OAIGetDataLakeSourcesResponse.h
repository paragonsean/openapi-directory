...
/*
 * OAIGetDataLakeSourcesResponse.h
 *
 * 
 */

#ifndef OAIGetDataLakeSourcesResponse_H
#define OAIGetDataLakeSourcesResponse_H
...
class OAIGetDataLakeSourcesResponse : public OAIObject {
public:
    OAIGetDataLakeSourcesResponse();
    OAIGetDataLakeSourcesResponse(QString json);
    ~OAIGetDataLakeSourcesResponse() override;
    ...
    QList getDataLakeSources() const;
    void setDataLakeSources(const QList &data_lake_sources);
    bool is_data_lake_sources_Set() const;
    bool is_data_lake_sources_Valid() const;
...
private:
    ...
    QList m_data_lake_sources;
    bool m_data_lake_sources_isSet;
    bool m_data_lake_sources_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataLakeSourcesResponse)

#endif // OAIGetDataLakeSourcesResponse_H
