...
#ifndef OAILogSource_H
#define OAILogSource_H
...
class OAILogSource : public OAIObject {
public:
    OAILogSource();
    OAILogSource(QString json);
    ~OAILogSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogSource)

#endif // OAILogSource_H
