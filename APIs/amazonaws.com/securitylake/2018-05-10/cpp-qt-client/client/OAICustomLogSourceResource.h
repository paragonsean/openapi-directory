...
/*
 * OAICustomLogSourceResource.h
 *
 * Amazon Security Lake can collect logs and events from third-party custom sources.
 */

#ifndef OAICustomLogSourceResource_H
#define OAICustomLogSourceResource_H
...
class OAICustomLogSourceResource : public OAIObject {
public:
    OAICustomLogSourceResource();
    OAICustomLogSourceResource(QString json);
    ~OAICustomLogSourceResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLogSourceResource)

#endif // OAICustomLogSourceResource_H
