...
/*
 * OAICreateSubscriberRequest_subscriberIdentity.h
 *
 * 
 */

#ifndef OAICreateSubscriberRequest_subscriberIdentity_H
#define OAICreateSubscriberRequest_subscriberIdentity_H
...
class OAICreateSubscriberRequest_subscriberIdentity : public OAIObject {
public:
    OAICreateSubscriberRequest_subscriberIdentity();
    OAICreateSubscriberRequest_subscriberIdentity(QString json);
    ~OAICreateSubscriberRequest_subscriberIdentity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSubscriberRequest_subscriberIdentity)

#endif // OAICreateSubscriberRequest_subscriberIdentity_H
