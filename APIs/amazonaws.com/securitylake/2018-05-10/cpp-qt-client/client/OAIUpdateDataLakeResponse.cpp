...
OAIUpdateDataLakeResponse::OAIUpdateDataLakeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDataLakeResponse::OAIUpdateDataLakeResponse() {
    this->initializeModel();
}

OAIUpdateDataLakeResponse::~OAIUpdateDataLakeResponse() {}

void OAIUpdateDataLakeResponse::initializeModel() {

    m_data_lakes_isSet = false;
    m_data_lakes_isValid = false;
}

void OAIUpdateDataLakeResponse::fromJson(QString jsonString) {
...
void OAIUpdateDataLakeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDataLakeResponse::asJson() const {
...
QJsonObject OAIUpdateDataLakeResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateDataLakeResponse::getDataLakes() const {
    return m_data_lakes;
}
void OAIUpdateDataLakeResponse::setDataLakes(const QList &data_lakes) {
    m_data_lakes = data_lakes;
    m_data_lakes_isSet = true;
}

bool OAIUpdateDataLakeResponse::is_data_lakes_Set() const{
    return m_data_lakes_isSet;
}

bool OAIUpdateDataLakeResponse::is_data_lakes_Valid() const{
    return m_data_lakes_isValid;
}

bool OAIUpdateDataLakeResponse::isSet() const {
...
bool OAIUpdateDataLakeResponse::isValid() const {
