...
OAIDataLakeConfiguration_replicationConfiguration::OAIDataLakeConfiguration_replicationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLakeConfiguration_replicationConfiguration::OAIDataLakeConfiguration_replicationConfiguration() {
    this->initializeModel();
}

OAIDataLakeConfiguration_replicationConfiguration::~OAIDataLakeConfiguration_replicationConfiguration() {}

void OAIDataLakeConfiguration_replicationConfiguration::initializeModel() {
...
void OAIDataLakeConfiguration_replicationConfiguration::fromJson(QString jsonString) {
...
void OAIDataLakeConfiguration_replicationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIDataLakeConfiguration_replicationConfiguration::asJson() const {
...
QJsonObject OAIDataLakeConfiguration_replicationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_regions.isSet()) {
...
QList OAIDataLakeConfiguration_replicationConfiguration::getRegions() const {
    return m_regions;
}
void OAIDataLakeConfiguration_replicationConfiguration::setRegions(const QList &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIDataLakeConfiguration_replicationConfiguration::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIDataLakeConfiguration_replicationConfiguration::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIDataLakeConfiguration_replicationConfiguration::getRoleArn() const {
    return m_role_arn;
}
void OAIDataLakeConfiguration_replicationConfiguration::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIDataLakeConfiguration_replicationConfiguration::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIDataLakeConfiguration_replicationConfiguration::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIDataLakeConfiguration_replicationConfiguration::isSet() const {
...
bool OAIDataLakeConfiguration_replicationConfiguration::isValid() const {
