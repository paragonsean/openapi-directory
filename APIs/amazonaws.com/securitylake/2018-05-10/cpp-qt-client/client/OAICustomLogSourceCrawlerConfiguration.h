...
/*
 * OAICustomLogSourceCrawlerConfiguration.h
 *
 * The configuration for the Glue Crawler for the third-party custom source.
 */

#ifndef OAICustomLogSourceCrawlerConfiguration_H
#define OAICustomLogSourceCrawlerConfiguration_H
...
class OAICustomLogSourceCrawlerConfiguration : public OAIObject {
public:
    OAICustomLogSourceCrawlerConfiguration();
    OAICustomLogSourceCrawlerConfiguration(QString json);
    ~OAICustomLogSourceCrawlerConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLogSourceCrawlerConfiguration)

#endif // OAICustomLogSourceCrawlerConfiguration_H
