...
/*
 * OAIListLogSourcesResponse.h
 *
 * 
 */

#ifndef OAIListLogSourcesResponse_H
#define OAIListLogSourcesResponse_H
...
class OAIListLogSourcesResponse : public OAIObject {
public:
    OAIListLogSourcesResponse();
    OAIListLogSourcesResponse(QString json);
    ~OAIListLogSourcesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLogSourcesResponse)

#endif // OAIListLogSourcesResponse_H
