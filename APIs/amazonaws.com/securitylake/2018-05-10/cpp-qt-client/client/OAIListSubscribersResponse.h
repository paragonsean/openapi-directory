...
/*
 * OAIListSubscribersResponse.h
 *
 * 
 */

#ifndef OAIListSubscribersResponse_H
#define OAIListSubscribersResponse_H
...
class OAIListSubscribersResponse : public OAIObject {
public:
    OAIListSubscribersResponse();
    OAIListSubscribersResponse(QString json);
    ~OAIListSubscribersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscribersResponse)

#endif // OAIListSubscribersResponse_H
