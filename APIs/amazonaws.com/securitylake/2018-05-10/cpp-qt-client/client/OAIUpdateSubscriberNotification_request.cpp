...
OAIUpdateSubscriberNotification_request::OAIUpdateSubscriberNotification_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubscriberNotification_request::OAIUpdateSubscriberNotification_request() {
    this->initializeModel();
}

OAIUpdateSubscriberNotification_request::~OAIUpdateSubscriberNotification_request() {}

void OAIUpdateSubscriberNotification_request::initializeModel() {

    m_configuration_isSet = false;
    m_configuration_isValid = false;
}

void OAIUpdateSubscriberNotification_request::fromJson(QString jsonString) {
...
void OAIUpdateSubscriberNotification_request::fromJsonObject(QJsonObject json) {

    m_configuration_isValid = ::OpenAPI::fromJsonValue(m_configuration, json[QString("configuration")]);
    m_configuration_isSet = !json[QString("configuration")].isNull() && m_configuration_isValid;
}

QString OAIUpdateSubscriberNotification_request::asJson() const {
...
QJsonObject OAIUpdateSubscriberNotification_request::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateSubscriberNotification_request_configuration OAIUpdateSubscriberNotification_request::getConfiguration() const {
    return m_configuration;
}
void OAIUpdateSubscriberNotification_request::setConfiguration(const OAIUpdateSubscriberNotification_request_configuration &configuration) {
    m_configuration = configuration;
    m_configuration_isSet = true;
}

bool OAIUpdateSubscriberNotification_request::is_configuration_Set() const{
    return m_configuration_isSet;
}

bool OAIUpdateSubscriberNotification_request::is_configuration_Valid() const{
    return m_configuration_isValid;
}

bool OAIUpdateSubscriberNotification_request::isSet() const {
...
bool OAIUpdateSubscriberNotification_request::isValid() const {
