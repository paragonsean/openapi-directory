...
OAICreateSubscriber_request_subscriberIdentity::OAICreateSubscriber_request_subscriberIdentity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSubscriber_request_subscriberIdentity::OAICreateSubscriber_request_subscriberIdentity() {
    this->initializeModel();
}

OAICreateSubscriber_request_subscriberIdentity::~OAICreateSubscriber_request_subscriberIdentity() {}

void OAICreateSubscriber_request_subscriberIdentity::initializeModel() {
...
void OAICreateSubscriber_request_subscriberIdentity::fromJson(QString jsonString) {
...
void OAICreateSubscriber_request_subscriberIdentity::fromJsonObject(QJsonObject json) {
...
QString OAICreateSubscriber_request_subscriberIdentity::asJson() const {
...
QJsonObject OAICreateSubscriber_request_subscriberIdentity::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSubscriber_request_subscriberIdentity::getExternalId() const {
    return m_external_id;
}
void OAICreateSubscriber_request_subscriberIdentity::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAICreateSubscriber_request_subscriberIdentity::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAICreateSubscriber_request_subscriberIdentity::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAICreateSubscriber_request_subscriberIdentity::getPrincipal() const {
    return m_principal;
}
void OAICreateSubscriber_request_subscriberIdentity::setPrincipal(const QString &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAICreateSubscriber_request_subscriberIdentity::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAICreateSubscriber_request_subscriberIdentity::is_principal_Valid() const{
    return m_principal_isValid;
}

bool OAICreateSubscriber_request_subscriberIdentity::isSet() const {
...
bool OAICreateSubscriber_request_subscriberIdentity::isValid() const {
