...
/*
 * OAIDeleteDataLakeOrganizationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteDataLakeOrganizationConfigurationRequest_H
#define OAIDeleteDataLakeOrganizationConfigurationRequest_H
...
class OAIDeleteDataLakeOrganizationConfigurationRequest : public OAIObject {
public:
    OAIDeleteDataLakeOrganizationConfigurationRequest();
    OAIDeleteDataLakeOrganizationConfigurationRequest(QString json);
    ~OAIDeleteDataLakeOrganizationConfigurationRequest() override;
    ...
    QList getAutoEnableNewAccount() const;
    void setAutoEnableNewAccount(const QList &auto_enable_new_account);
    bool is_auto_enable_new_account_Set() const;
    bool is_auto_enable_new_account_Valid() const;
...
private:
    ...
    QList m_auto_enable_new_account;
    bool m_auto_enable_new_account_isSet;
    bool m_auto_enable_new_account_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDataLakeOrganizationConfigurationRequest)

#endif // OAIDeleteDataLakeOrganizationConfigurationRequest_H
