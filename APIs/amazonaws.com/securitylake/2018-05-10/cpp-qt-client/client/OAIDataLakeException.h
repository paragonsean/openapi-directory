...
/*
 * OAIDataLakeException.h
 *
 * The details for an Amazon Security Lake exception.
 */

#ifndef OAIDataLakeException_H
#define OAIDataLakeException_H
...
class OAIDataLakeException : public OAIObject {
public:
    OAIDataLakeException();
    OAIDataLakeException(QString json);
    ~OAIDataLakeException() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLakeException)

#endif // OAIDataLakeException_H
