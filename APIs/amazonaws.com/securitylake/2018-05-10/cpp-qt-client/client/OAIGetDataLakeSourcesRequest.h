...
/*
 * OAIGetDataLakeSourcesRequest.h
 *
 * 
 */

#ifndef OAIGetDataLakeSourcesRequest_H
#define OAIGetDataLakeSourcesRequest_H
...
class OAIGetDataLakeSourcesRequest : public OAIObject {
public:
    OAIGetDataLakeSourcesRequest();
    OAIGetDataLakeSourcesRequest(QString json);
    ~OAIGetDataLakeSourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataLakeSourcesRequest)

#endif // OAIGetDataLakeSourcesRequest_H
