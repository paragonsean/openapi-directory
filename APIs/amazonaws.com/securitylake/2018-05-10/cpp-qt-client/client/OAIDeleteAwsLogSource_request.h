...
/*
 * OAIDeleteAwsLogSource_request.h
 *
 * 
 */

#ifndef OAIDeleteAwsLogSource_request_H
#define OAIDeleteAwsLogSource_request_H
...
class OAIDeleteAwsLogSource_request : public OAIObject {
public:
    OAIDeleteAwsLogSource_request();
    OAIDeleteAwsLogSource_request(QString json);
    ~OAIDeleteAwsLogSource_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAwsLogSource_request)

#endif // OAIDeleteAwsLogSource_request_H
