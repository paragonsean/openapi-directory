...
public class ListLogSourcesRequest {
  ...
  public ListLogSourcesRequest() {
  }

  public ListLogSourcesRequest accounts(List<String> accounts) {
    this.accounts = accounts;
    return this;
  }

  public ListLogSourcesRequest addAccountsItem(String accountsItem) {
  ...
  public ListLogSourcesRequest maxResults(Integer maxResults) {
  ...
  public ListLogSourcesRequest nextToken(String nextToken) {
  ...
  public ListLogSourcesRequest regions(List<String> regions) {
    this.regions = regions;
    return this;
  }

  public ListLogSourcesRequest addRegionsItem(String regionsItem) {
  ...
  public ListLogSourcesRequest sources(List<LogSourceResource> sources) {
    this.sources = sources;
    return this;
  }

  public ListLogSourcesRequest addSourcesItem(LogSourceResource sourcesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ListLogSourcesRequest listLogSourcesRequest = (ListLogSourcesRequest) o;
    return Objects.equals(this.accounts, listLogSourcesRequest.accounts) &&
        Objects.equals(this.maxResults, listLogSourcesRequest.maxResults) &&
        Objects.equals(this.nextToken, listLogSourcesRequest.nextToken) &&
        Objects.equals(this.regions, listLogSourcesRequest.regions) &&
        Objects.equals(this.sources, listLogSourcesRequest.sources);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accounts, maxResults, nextToken, regions, sources);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListLogSourcesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListLogSourcesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListLogSourcesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListLogSourcesRequest is not found in the empty JSON string", ListLogSourcesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListLogSourcesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListLogSourcesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListLogSourcesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListLogSourcesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListLogSourcesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListLogSourcesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListLogSourcesRequest>() {
           @Override
           public void write(JsonWriter out, ListLogSourcesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListLogSourcesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListLogSourcesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListLogSourcesRequest
   * @throws IOException if the JSON string is invalid with respect to ListLogSourcesRequest
   */
  public static ListLogSourcesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListLogSourcesRequest.class);
  }

  /**
   * Convert an instance of ListLogSourcesRequest to an JSON string
   *
   * @return JSON string
   */
