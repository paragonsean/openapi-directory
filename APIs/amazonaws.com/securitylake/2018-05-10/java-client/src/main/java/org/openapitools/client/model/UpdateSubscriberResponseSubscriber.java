...
public class UpdateSubscriberResponseSubscriber {
  ...
  public UpdateSubscriberResponseSubscriber() {
  }

  public UpdateSubscriberResponseSubscriber accessTypes(List accessTypes) {
  ...
  public UpdateSubscriberResponseSubscriber createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateSubscriberResponseSubscriber resourceShareArn(String resourceShareArn) {
  ...
  public UpdateSubscriberResponseSubscriber resourceShareName(String resourceShareName) {
  ...
  public UpdateSubscriberResponseSubscriber roleArn(String roleArn) {
  ...
  public UpdateSubscriberResponseSubscriber s3BucketArn(String s3BucketArn) {
  ...
  public UpdateSubscriberResponseSubscriber sources(List sources) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberArn(String subscriberArn) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberDescription(String subscriberDescription) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberEndpoint(String subscriberEndpoint) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberId(String subscriberId) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberIdentity(CreateSubscriberRequestSubscriberIdentity subscriberIdentity) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberName(String subscriberName) {
  ...
  public UpdateSubscriberResponseSubscriber subscriberStatus(SubscriberStatus subscriberStatus) {
  ...
  public UpdateSubscriberResponseSubscriber updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSubscriberResponseSubscriber updateSubscriberResponseSubscriber = (UpdateSubscriberResponseSubscriber) o;
    return Objects.equals(this.accessTypes, updateSubscriberResponseSubscriber.accessTypes) &&
        Objects.equals(this.createdAt, updateSubscriberResponseSubscriber.createdAt) &&
        Objects.equals(this.resourceShareArn, updateSubscriberResponseSubscriber.resourceShareArn) &&
        Objects.equals(this.resourceShareName, updateSubscriberResponseSubscriber.resourceShareName) &&
        Objects.equals(this.roleArn, updateSubscriberResponseSubscriber.roleArn) &&
        Objects.equals(this.s3BucketArn, updateSubscriberResponseSubscriber.s3BucketArn) &&
        Objects.equals(this.sources, updateSubscriberResponseSubscriber.sources) &&
        Objects.equals(this.subscriberArn, updateSubscriberResponseSubscriber.subscriberArn) &&
        Objects.equals(this.subscriberDescription, updateSubscriberResponseSubscriber.subscriberDescription) &&
        Objects.equals(this.subscriberEndpoint, updateSubscriberResponseSubscriber.subscriberEndpoint) &&
        Objects.equals(this.subscriberId, updateSubscriberResponseSubscriber.subscriberId) &&
        Objects.equals(this.subscriberIdentity, updateSubscriberResponseSubscriber.subscriberIdentity) &&
        Objects.equals(this.subscriberName, updateSubscriberResponseSubscriber.subscriberName) &&
        Objects.equals(this.subscriberStatus, updateSubscriberResponseSubscriber.subscriberStatus) &&
        Objects.equals(this.updatedAt, updateSubscriberResponseSubscriber.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSubscriberResponseSubscriber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubscriberResponseSubscriber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubscriberResponseSubscriber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSubscriberResponseSubscriber is not found in the empty JSON string", UpdateSubscriberResponseSubscriber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubscriberResponseSubscriber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubscriberResponseSubscriber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSubscriberResponseSubscriber.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubscriberResponseSubscriber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubscriberResponseSubscriber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubscriberResponseSubscriber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubscriberResponseSubscriber.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubscriberResponseSubscriber>() {
           @Override
           public void write(JsonWriter out, UpdateSubscriberResponseSubscriber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubscriberResponseSubscriber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubscriberResponseSubscriber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubscriberResponseSubscriber
   * @throws IOException if the JSON string is invalid with respect to UpdateSubscriberResponseSubscriber
   */
  public static UpdateSubscriberResponseSubscriber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubscriberResponseSubscriber.class);
  }

  /**
   * Convert an instance of UpdateSubscriberResponseSubscriber to an JSON string
   *
   * @return JSON string
   */
