...
public class CreateDataLakeExceptionSubscriptionRequest {
  ...
  public CreateDataLakeExceptionSubscriptionRequest exceptionTimeToLive(Integer exceptionTimeToLive) {
  ...
  public CreateDataLakeExceptionSubscriptionRequest notificationEndpoint(String notificationEndpoint) {
  ...
  public CreateDataLakeExceptionSubscriptionRequest subscriptionProtocol(String subscriptionProtocol) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDataLakeExceptionSubscriptionRequest createDataLakeExceptionSubscriptionRequest = (CreateDataLakeExceptionSubscriptionRequest) o;
    return Objects.equals(this.exceptionTimeToLive, createDataLakeExceptionSubscriptionRequest.exceptionTimeToLive) &&
        Objects.equals(this.notificationEndpoint, createDataLakeExceptionSubscriptionRequest.notificationEndpoint) &&
        Objects.equals(this.subscriptionProtocol, createDataLakeExceptionSubscriptionRequest.subscriptionProtocol);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDataLakeExceptionSubscriptionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDataLakeExceptionSubscriptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDataLakeExceptionSubscriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDataLakeExceptionSubscriptionRequest is not found in the empty JSON string", CreateDataLakeExceptionSubscriptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDataLakeExceptionSubscriptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDataLakeExceptionSubscriptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDataLakeExceptionSubscriptionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDataLakeExceptionSubscriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDataLakeExceptionSubscriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDataLakeExceptionSubscriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDataLakeExceptionSubscriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDataLakeExceptionSubscriptionRequest>() {
           @Override
           public void write(JsonWriter out, CreateDataLakeExceptionSubscriptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDataLakeExceptionSubscriptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDataLakeExceptionSubscriptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDataLakeExceptionSubscriptionRequest
   * @throws IOException if the JSON string is invalid with respect to CreateDataLakeExceptionSubscriptionRequest
   */
  public static CreateDataLakeExceptionSubscriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDataLakeExceptionSubscriptionRequest.class);
  }

  /**
   * Convert an instance of CreateDataLakeExceptionSubscriptionRequest to an JSON string
   *
   * @return JSON string
   */
