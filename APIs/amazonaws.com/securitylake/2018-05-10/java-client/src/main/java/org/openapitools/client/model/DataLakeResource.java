...
import org.openapitools.client.model.DataLakeResourceUpdateStatus;
...
public class DataLakeResource {
  public static final String SERIALIZED_NAME_CREATE_STATUS = "createStatus";
  @SerializedName(SERIALIZED_NAME_CREATE_STATUS)
  private DataLakeStatus createStatus;
  ...
  private DataLakeResourceUpdateStatus updateStatus;

  public DataLakeResource() {
  }

  public DataLakeResource createStatus(DataLakeStatus createStatus) {
  ...
  public DataLakeStatus getCreateStatus() {
    return createStatus;
  }

  public void setCreateStatus(DataLakeStatus createStatus) {
    this.createStatus = createStatus;
  }


  public DataLakeResource dataLakeArn(String dataLakeArn) {
  ...
  public DataLakeResource encryptionConfiguration(DataLakeConfigurationEncryptionConfiguration encryptionConfiguration) {
  ...
  public DataLakeResource lifecycleConfiguration(DataLakeConfigurationLifecycleConfiguration lifecycleConfiguration) {
  ...
  public DataLakeResource region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DataLakeResource replicationConfiguration(DataLakeConfigurationReplicationConfiguration replicationConfiguration) {
  ...
  public DataLakeResource s3BucketArn(String s3BucketArn) {
  ...
  public DataLakeResource updateStatus(DataLakeResourceUpdateStatus updateStatus) {
   ...
   */
  @javax.annotation.Nullable
  public DataLakeResourceUpdateStatus getUpdateStatus() {
    return updateStatus;
  }

  public void setUpdateStatus(DataLakeResourceUpdateStatus updateStatus) {
    this.updateStatus = updateStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    DataLakeResource dataLakeResource = (DataLakeResource) o;
    return Objects.equals(this.createStatus, dataLakeResource.createStatus) &&
        Objects.equals(this.dataLakeArn, dataLakeResource.dataLakeArn) &&
        Objects.equals(this.encryptionConfiguration, dataLakeResource.encryptionConfiguration) &&
        Objects.equals(this.lifecycleConfiguration, dataLakeResource.lifecycleConfiguration) &&
        Objects.equals(this.region, dataLakeResource.region) &&
        Objects.equals(this.replicationConfiguration, dataLakeResource.replicationConfiguration) &&
        Objects.equals(this.s3BucketArn, dataLakeResource.s3BucketArn) &&
        Objects.equals(this.updateStatus, dataLakeResource.updateStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createStatus, dataLakeArn, encryptionConfiguration, lifecycleConfiguration, region, replicationConfiguration, s3BucketArn, updateStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataLakeResource {\n");
  ...
  static {
    ...
    openapiFields.add("createStatus");
    ...
    openapiRequiredFields.add("dataLakeArn");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataLakeResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataLakeResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataLakeResource is not found in the empty JSON string", DataLakeResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataLakeResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataLakeResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataLakeResource.openapiRequiredFields) {
      ...
      if (jsonObj.get("createStatus") != null && !jsonObj.get("createStatus").isJsonNull()) {
        DataLakeStatus.validateJsonElement(jsonObj.get("createStatus"));
      }
      // validate the required field `dataLakeArn`
      ...
      if (jsonObj.get("updateStatus") != null && !jsonObj.get("updateStatus").isJsonNull()) {
        DataLakeResourceUpdateStatus.validateJsonElement(jsonObj.get("updateStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataLakeResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataLakeResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataLakeResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataLakeResource.class));

       return (TypeAdapter<T>) new TypeAdapter<DataLakeResource>() {
           @Override
           public void write(JsonWriter out, DataLakeResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataLakeResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataLakeResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataLakeResource
   * @throws IOException if the JSON string is invalid with respect to DataLakeResource
   */
  public static DataLakeResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataLakeResource.class);
  }

  /**
   * Convert an instance of DataLakeResource to an JSON string
   *
   * @return JSON string
   */
