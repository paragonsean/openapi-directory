...
/**
 * Gets or Sets SourceCollectionStatus
 */
@JsonAdapter(SourceCollectionStatus.Adapter.class)
public enum SourceCollectionStatus {
  ...
  SourceCollectionStatus(String value) {
    this.value = value;
  }
  ...
  public static SourceCollectionStatus fromValue(String value) {
    for (SourceCollectionStatus b : SourceCollectionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<SourceCollectionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final SourceCollectionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SourceCollectionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SourceCollectionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SourceCollectionStatus.fromValue(value);
  }
}
