...
public class LogSource {
  ...
  public LogSource account(String account) {
  ...
  public LogSource region(String region) {
    this.region = region;
    return this;
  }
  ...
  public LogSource sources(List sources) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, logSource.account) &&
        Objects.equals(this.region, logSource.region) &&
        Objects.equals(this.sources, logSource.sources);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, region, sources);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LogSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogSource is not found in the empty JSON string", LogSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogSource.class));

       return (TypeAdapter<T>) new TypeAdapter<LogSource>() {
           @Override
           public void write(JsonWriter out, LogSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogSource
   * @throws IOException if the JSON string is invalid with respect to LogSource
   */
  public static LogSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogSource.class);
  }

  /**
   * Convert an instance of LogSource to an JSON string
   *
   * @return JSON string
   */
