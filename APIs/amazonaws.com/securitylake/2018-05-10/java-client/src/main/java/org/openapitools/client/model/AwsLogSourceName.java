...
/**
 * Gets or Sets AwsLogSourceName
 */
@JsonAdapter(AwsLogSourceName.Adapter.class)
public enum AwsLogSourceName {
  ...
  public static AwsLogSourceName fromValue(String value) {
    for (AwsLogSourceName b : AwsLogSourceName.values()) {
  ...
  public static class Adapter extends TypeAdapter<AwsLogSourceName> {
    @Override
    public void write(final JsonWriter jsonWriter, final AwsLogSourceName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AwsLogSourceName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AwsLogSourceName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AwsLogSourceName.fromValue(value);
  }
}
