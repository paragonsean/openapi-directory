...
public class DataLakeException {
  ...
  public DataLakeException exception(String exception) {
  ...
  public DataLakeException region(String region) {
    this.region = region;
    return this;
  }
  ...
  public DataLakeException remediation(String remediation) {
  ...
  public DataLakeException timestamp(OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    DataLakeException dataLakeException = (DataLakeException) o;
    return Objects.equals(this.exception, dataLakeException.exception) &&
        Objects.equals(this.region, dataLakeException.region) &&
        Objects.equals(this.remediation, dataLakeException.remediation) &&
        Objects.equals(this.timestamp, dataLakeException.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exception, region, remediation, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataLakeException {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataLakeException
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataLakeException.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataLakeException is not found in the empty JSON string", DataLakeException.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataLakeException.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataLakeException` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `exception`
      if (jsonObj.get("exception") != null && !jsonObj.get("exception").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("exception"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataLakeException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataLakeException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataLakeException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataLakeException.class));

       return (TypeAdapter<T>) new TypeAdapter<DataLakeException>() {
           @Override
           public void write(JsonWriter out, DataLakeException value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataLakeException read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataLakeException given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataLakeException
   * @throws IOException if the JSON string is invalid with respect to DataLakeException
   */
  public static DataLakeException fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataLakeException.class);
  }

  /**
   * Convert an instance of DataLakeException to an JSON string
   *
   * @return JSON string
   */
