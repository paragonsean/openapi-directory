...
public class SubscriberResource {
  ...
  public SubscriberResource accessTypes(List accessTypes) {
  ...
  public SubscriberResource createdAt(OffsetDateTime createdAt) {
  ...
  public SubscriberResource resourceShareArn(String resourceShareArn) {
  ...
  public SubscriberResource resourceShareName(String resourceShareName) {
  ...
  public SubscriberResource roleArn(String roleArn) {
  ...
  public SubscriberResource s3BucketArn(String s3BucketArn) {
  ...
  public SubscriberResource sources(List sources) {
  ...
  public SubscriberResource subscriberArn(String subscriberArn) {
  ...
  public SubscriberResource subscriberDescription(String subscriberDescription) {
  ...
  public SubscriberResource subscriberEndpoint(String subscriberEndpoint) {
  ...
  public SubscriberResource subscriberId(String subscriberId) {
  ...
  public SubscriberResource subscriberIdentity(CreateSubscriberRequestSubscriberIdentity subscriberIdentity) {
  ...
  public SubscriberResource subscriberName(String subscriberName) {
  ...
  public SubscriberResource subscriberStatus(SubscriberStatus subscriberStatus) {
  ...
  public SubscriberResource updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    SubscriberResource subscriberResource = (SubscriberResource) o;
    return Objects.equals(this.accessTypes, subscriberResource.accessTypes) &&
        Objects.equals(this.createdAt, subscriberResource.createdAt) &&
        Objects.equals(this.resourceShareArn, subscriberResource.resourceShareArn) &&
        Objects.equals(this.resourceShareName, subscriberResource.resourceShareName) &&
        Objects.equals(this.roleArn, subscriberResource.roleArn) &&
        Objects.equals(this.s3BucketArn, subscriberResource.s3BucketArn) &&
        Objects.equals(this.sources, subscriberResource.sources) &&
        Objects.equals(this.subscriberArn, subscriberResource.subscriberArn) &&
        Objects.equals(this.subscriberDescription, subscriberResource.subscriberDescription) &&
        Objects.equals(this.subscriberEndpoint, subscriberResource.subscriberEndpoint) &&
        Objects.equals(this.subscriberId, subscriberResource.subscriberId) &&
        Objects.equals(this.subscriberIdentity, subscriberResource.subscriberIdentity) &&
        Objects.equals(this.subscriberName, subscriberResource.subscriberName) &&
        Objects.equals(this.subscriberStatus, subscriberResource.subscriberStatus) &&
        Objects.equals(this.updatedAt, subscriberResource.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriberResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscriberResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriberResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriberResource is not found in the empty JSON string", SubscriberResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriberResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriberResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubscriberResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriberResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriberResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriberResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriberResource.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriberResource>() {
           @Override
           public void write(JsonWriter out, SubscriberResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriberResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscriberResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscriberResource
   * @throws IOException if the JSON string is invalid with respect to SubscriberResource
   */
  public static SubscriberResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriberResource.class);
  }

  /**
   * Convert an instance of SubscriberResource to an JSON string
   *
   * @return JSON string
   */
