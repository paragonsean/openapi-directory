...
/**
 * The ListDataLakesResponse model module.
 * @module model/ListDataLakesResponse
 * @version 2018-05-10
 */
class ListDataLakesResponse {
    /**
     * Constructs a new <code>ListDataLakesResponse</code>.
     * @alias module:model/ListDataLakesResponse
     */
    constructor() { 
        
        ListDataLakesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDataLakesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDataLakesResponse} obj Optional instance to populate.
     * @return {module:model/ListDataLakesResponse} The populated <code>ListDataLakesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDataLakesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDataLakesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDataLakesResponse</code>.
     */
 ...
 */
ListDataLakesResponse.prototype['dataLakes'] = undefined;
...
export default ListDataLakesResponse;
