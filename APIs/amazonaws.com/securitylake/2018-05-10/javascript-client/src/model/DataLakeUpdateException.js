...
/**
 * The DataLakeUpdateException model module.
 * @module model/DataLakeUpdateException
 * @version 2018-05-10
 */
class DataLakeUpdateException {
    /**
     * Constructs a new <code>DataLakeUpdateException</code>.
     * The details of the last &lt;code&gt;UpdateDataLake&lt;/code&gt; or &lt;code&gt;DeleteDataLake&lt;/code&gt; API request which failed.
     * @alias module:model/DataLakeUpdateException
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DataLakeUpdateException</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeUpdateException} obj Optional instance to populate.
     * @return {module:model/DataLakeUpdateException} The populated <code>DataLakeUpdateException</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeUpdateException();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeUpdateException</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeUpdateException</code>.
     */
...
export default DataLakeUpdateException;
