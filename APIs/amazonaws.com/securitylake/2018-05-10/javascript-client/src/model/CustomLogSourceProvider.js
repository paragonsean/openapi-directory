...
/**
 * The CustomLogSourceProvider model module.
 * @module model/CustomLogSourceProvider
 * @version 2018-05-10
 */
class CustomLogSourceProvider {
    /**
     * Constructs a new <code>CustomLogSourceProvider</code>.
     * The details of the log provider for a third-party custom source.
     * @alias module:model/CustomLogSourceProvider
     */
    constructor() { 
        
        CustomLogSourceProvider.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomLogSourceProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomLogSourceProvider} obj Optional instance to populate.
     * @return {module:model/CustomLogSourceProvider} The populated <code>CustomLogSourceProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomLogSourceProvider();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomLogSourceProvider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomLogSourceProvider</code>.
     */
 ...
 */
CustomLogSourceProvider.prototype['location'] = undefined;

/**
 * @member {String} roleArn
 */
CustomLogSourceProvider.prototype['roleArn'] = undefined;
...
export default CustomLogSourceProvider;
