...
* @readonly
*/
export default class AwsLogSourceName {
    ...
    /**
    * Returns a <code>AwsLogSourceName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AwsLogSourceName} The enum <code>AwsLogSourceName</code> value.
    */
