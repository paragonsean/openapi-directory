...
/**
 * The AwsIdentity model module.
 * @module model/AwsIdentity
 * @version 2018-05-10
 */
class AwsIdentity {
    /**
     * Constructs a new <code>AwsIdentity</code>.
     * The AWS identity.
     * @alias module:model/AwsIdentity
    ...
    /**
     * Constructs a <code>AwsIdentity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AwsIdentity} obj Optional instance to populate.
     * @return {module:model/AwsIdentity} The populated <code>AwsIdentity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AwsIdentity();
    ...
    /**
     * Validates the JSON data with respect to <code>AwsIdentity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AwsIdentity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AwsIdentity.RequiredProperties) {
...
AwsIdentity.RequiredProperties = ["externalId", "principal"];
