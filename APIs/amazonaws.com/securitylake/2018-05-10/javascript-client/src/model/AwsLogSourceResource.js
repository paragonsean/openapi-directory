...
/**
 * The AwsLogSourceResource model module.
 * @module model/AwsLogSourceResource
 * @version 2018-05-10
 */
class AwsLogSourceResource {
    /**
     * Constructs a new <code>AwsLogSourceResource</code>.
     * Amazon Security Lake can collect logs and events from natively-supported Amazon Web Services services.
     * @alias module:model/AwsLogSourceResource
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AwsLogSourceResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AwsLogSourceResource} obj Optional instance to populate.
     * @return {module:model/AwsLogSourceResource} The populated <code>AwsLogSourceResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AwsLogSourceResource();
    ...
    /**
     * Validates the JSON data with respect to <code>AwsLogSourceResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AwsLogSourceResource</code>.
     */
...
export default AwsLogSourceResource;
