...
/**
 * The ListLogSourcesResponse model module.
 * @module model/ListLogSourcesResponse
 * @version 2018-05-10
 */
class ListLogSourcesResponse {
    /**
     * Constructs a new <code>ListLogSourcesResponse</code>.
     * @alias module:model/ListLogSourcesResponse
     */
    constructor() { 
        
        ListLogSourcesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListLogSourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLogSourcesResponse} obj Optional instance to populate.
     * @return {module:model/ListLogSourcesResponse} The populated <code>ListLogSourcesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListLogSourcesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLogSourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLogSourcesResponse</code>.
     */
 ...
 */
ListLogSourcesResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} sources
 */
ListLogSourcesResponse.prototype['sources'] = undefined;
...
export default ListLogSourcesResponse;
