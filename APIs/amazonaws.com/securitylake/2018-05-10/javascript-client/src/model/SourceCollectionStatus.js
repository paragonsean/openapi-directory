...
* @readonly
*/
export default class SourceCollectionStatus {
    ...
    /**
    * Returns a <code>SourceCollectionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SourceCollectionStatus} The enum <code>SourceCollectionStatus</code> value.
    */
