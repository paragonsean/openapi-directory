...
/**
 * The DataLakeLifecycleExpiration model module.
 * @module model/DataLakeLifecycleExpiration
 * @version 2018-05-10
 */
class DataLakeLifecycleExpiration {
    /**
     * Constructs a new <code>DataLakeLifecycleExpiration</code>.
     * Provide expiration lifecycle details of Amazon Security Lake object.
     * @alias module:model/DataLakeLifecycleExpiration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DataLakeLifecycleExpiration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeLifecycleExpiration} obj Optional instance to populate.
     * @return {module:model/DataLakeLifecycleExpiration} The populated <code>DataLakeLifecycleExpiration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeLifecycleExpiration();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeLifecycleExpiration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeLifecycleExpiration</code>.
     */
...
export default DataLakeLifecycleExpiration;
