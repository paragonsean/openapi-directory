...
import UpdateSubscriberResponseSubscriber from './UpdateSubscriberResponseSubscriber';

/**
 * The UpdateSubscriberResponse model module.
 * @module model/UpdateSubscriberResponse
 * @version 2018-05-10
 */
class UpdateSubscriberResponse {
    /**
     * Constructs a new <code>UpdateSubscriberResponse</code>.
     * @alias module:model/UpdateSubscriberResponse
     */
    constructor() { 
        
        UpdateSubscriberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSubscriberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSubscriberResponse} obj Optional instance to populate.
     * @return {module:model/UpdateSubscriberResponse} The populated <code>UpdateSubscriberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSubscriberResponse();

            if (data.hasOwnProperty('subscriber')) {
                obj['subscriber'] = UpdateSubscriberResponseSubscriber.constructFromObject(data['subscriber']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubscriberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubscriberResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `subscriber`
        if (data['subscriber']) { // data not null
          UpdateSubscriberResponseSubscriber.validateJSON(data['subscriber']);
        }
...
/**
 * @member {module:model/UpdateSubscriberResponseSubscriber} subscriber
 */
UpdateSubscriberResponse.prototype['subscriber'] = undefined;
...
export default UpdateSubscriberResponse;
