...
import GetSubscriberResponseSubscriber from './GetSubscriberResponseSubscriber';

/**
 * The GetSubscriberResponse model module.
 * @module model/GetSubscriberResponse
 * @version 2018-05-10
 */
class GetSubscriberResponse {
    /**
     * Constructs a new <code>GetSubscriberResponse</code>.
     * @alias module:model/GetSubscriberResponse
     */
    constructor() { 
        
        GetSubscriberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSubscriberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSubscriberResponse} obj Optional instance to populate.
     * @return {module:model/GetSubscriberResponse} The populated <code>GetSubscriberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSubscriberResponse();

            if (data.hasOwnProperty('subscriber')) {
                obj['subscriber'] = GetSubscriberResponseSubscriber.constructFromObject(data['subscriber']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSubscriberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSubscriberResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `subscriber`
        if (data['subscriber']) { // data not null
          GetSubscriberResponseSubscriber.validateJSON(data['subscriber']);
        }
...
/**
 * @member {module:model/GetSubscriberResponseSubscriber} subscriber
 */
GetSubscriberResponse.prototype['subscriber'] = undefined;
...
export default GetSubscriberResponse;
