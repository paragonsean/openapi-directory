...
/**
 * The LogSource model module.
 * @module model/LogSource
 * @version 2018-05-10
 */
class LogSource {
    /**
     * Constructs a new <code>LogSource</code>.
     * Amazon Security Lake can collect logs and events from natively-supported Amazon Web Services services and custom sources. 
     * @alias module:model/LogSource
     */
    constructor() { 
        
        LogSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LogSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogSource} obj Optional instance to populate.
     * @return {module:model/LogSource} The populated <code>LogSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogSource();
    ...
    /**
     * Validates the JSON data with respect to <code>LogSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogSource</code>.
     */
 ...
 */
LogSource.prototype['account'] = undefined;

/**
 * @member {String} region
 */
LogSource.prototype['region'] = undefined;

/**
 * @member {Array} sources
 */
LogSource.prototype['sources'] = undefined;
