...
import CustomLogSourceConfiguration from './CustomLogSourceConfiguration';

/**
 * The CreateCustomLogSourceRequestConfiguration model module.
 * @module model/CreateCustomLogSourceRequestConfiguration
 * @version 2018-05-10
 */
class CreateCustomLogSourceRequestConfiguration {
    /**
     * Constructs a new <code>CreateCustomLogSourceRequestConfiguration</code>.
     * @alias module:model/CreateCustomLogSourceRequestConfiguration
     * @implements module:model/CustomLogSourceConfiguration
    ...
    constructor(crawlerConfiguration, providerIdentity) { 
        ...
        CreateCustomLogSourceRequestConfiguration.initialize(this, crawlerConfiguration, providerIdentity);
    }
    ...
    /**
     * Constructs a <code>CreateCustomLogSourceRequestConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCustomLogSourceRequestConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateCustomLogSourceRequestConfiguration} The populated <code>CreateCustomLogSourceRequestConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCustomLogSourceRequestConfiguration();
            CustomLogSourceConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomLogSourceRequestConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomLogSourceRequestConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCustomLogSourceRequestConfiguration.RequiredProperties) {
...
CreateCustomLogSourceRequestConfiguration.RequiredProperties = ["crawlerConfiguration", "providerIdentity"];

/**
 * @member {module:model/CreateCustomLogSourceRequestConfigurationCrawlerConfiguration} crawlerConfiguration
 */
CreateCustomLogSourceRequestConfiguration.prototype['crawlerConfiguration'] = undefined;

/**
 * @member {module:model/CreateCustomLogSourceRequestConfigurationProviderIdentity} providerIdentity
 */
CreateCustomLogSourceRequestConfiguration.prototype['providerIdentity'] = undefined;


// Implement CustomLogSourceConfiguration interface:
/**
 * @member {module:model/CreateCustomLogSourceRequestConfigurationCrawlerConfiguration} crawlerConfiguration
 */
...
export default CreateCustomLogSourceRequestConfiguration;
