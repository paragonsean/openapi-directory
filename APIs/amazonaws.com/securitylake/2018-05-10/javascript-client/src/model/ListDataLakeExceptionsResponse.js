...
/**
 * The ListDataLakeExceptionsResponse model module.
 * @module model/ListDataLakeExceptionsResponse
 * @version 2018-05-10
 */
class ListDataLakeExceptionsResponse {
    /**
     * Constructs a new <code>ListDataLakeExceptionsResponse</code>.
     * @alias module:model/ListDataLakeExceptionsResponse
     */
    constructor() { 
        
        ListDataLakeExceptionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDataLakeExceptionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDataLakeExceptionsResponse} obj Optional instance to populate.
     * @return {module:model/ListDataLakeExceptionsResponse} The populated <code>ListDataLakeExceptionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDataLakeExceptionsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDataLakeExceptionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDataLakeExceptionsResponse</code>.
     */
 ...
 */
ListDataLakeExceptionsResponse.prototype['exceptions'] = undefined;

/**
 * @member {String} nextToken
 */
ListDataLakeExceptionsResponse.prototype['nextToken'] = undefined;
...
export default ListDataLakeExceptionsResponse;
