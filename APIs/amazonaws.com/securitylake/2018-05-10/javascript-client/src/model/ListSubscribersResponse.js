...
/**
 * The ListSubscribersResponse model module.
 * @module model/ListSubscribersResponse
 * @version 2018-05-10
 */
class ListSubscribersResponse {
    /**
     * Constructs a new <code>ListSubscribersResponse</code>.
     * @alias module:model/ListSubscribersResponse
     */
    constructor() { 
        
        ListSubscribersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSubscribersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSubscribersResponse} obj Optional instance to populate.
     * @return {module:model/ListSubscribersResponse} The populated <code>ListSubscribersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSubscribersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSubscribersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSubscribersResponse</code>.
     */
 ...
 */
ListSubscribersResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} subscribers
 */
ListSubscribersResponse.prototype['subscribers'] = undefined;
...
export default ListSubscribersResponse;
