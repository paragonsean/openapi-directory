...
import CreateSubscriberResponseSubscriber from './CreateSubscriberResponseSubscriber';

/**
 * The CreateSubscriberResponse model module.
 * @module model/CreateSubscriberResponse
 * @version 2018-05-10
 */
class CreateSubscriberResponse {
    /**
     * Constructs a new <code>CreateSubscriberResponse</code>.
     * @alias module:model/CreateSubscriberResponse
     */
    constructor() { 
        
        CreateSubscriberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSubscriberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSubscriberResponse} obj Optional instance to populate.
     * @return {module:model/CreateSubscriberResponse} The populated <code>CreateSubscriberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSubscriberResponse();

            if (data.hasOwnProperty('subscriber')) {
                obj['subscriber'] = CreateSubscriberResponseSubscriber.constructFromObject(data['subscriber']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSubscriberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSubscriberResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `subscriber`
        if (data['subscriber']) { // data not null
          CreateSubscriberResponseSubscriber.validateJSON(data['subscriber']);
        }
...
/**
 * @member {module:model/CreateSubscriberResponseSubscriber} subscriber
 */
CreateSubscriberResponse.prototype['subscriber'] = undefined;
...
export default CreateSubscriberResponse;
