...
/**
 * The DataLakeLifecycleTransition model module.
 * @module model/DataLakeLifecycleTransition
 * @version 2018-05-10
 */
class DataLakeLifecycleTransition {
    /**
     * Constructs a new <code>DataLakeLifecycleTransition</code>.
     * Provide transition lifecycle details of Amazon Security Lake object.
     * @alias module:model/DataLakeLifecycleTransition
     */
    constructor() { 
        
        DataLakeLifecycleTransition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataLakeLifecycleTransition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeLifecycleTransition} obj Optional instance to populate.
     * @return {module:model/DataLakeLifecycleTransition} The populated <code>DataLakeLifecycleTransition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeLifecycleTransition();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeLifecycleTransition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeLifecycleTransition</code>.
     */
    static validateJSON(data) {
        ...
        if (data['storageClass']) { // data not null
          String.validateJSON(data['storageClass']);
        }
 ...
 * @member {Number} days
 */
DataLakeLifecycleTransition.prototype['days'] = undefined;

/**
 * @member {String} storageClass
 */
DataLakeLifecycleTransition.prototype['storageClass'] = undefined;
...
export default DataLakeLifecycleTransition;
