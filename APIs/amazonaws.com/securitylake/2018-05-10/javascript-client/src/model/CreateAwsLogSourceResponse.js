...
/**
 * The CreateAwsLogSourceResponse model module.
 * @module model/CreateAwsLogSourceResponse
 * @version 2018-05-10
 */
class CreateAwsLogSourceResponse {
    /**
     * Constructs a new <code>CreateAwsLogSourceResponse</code>.
     * @alias module:model/CreateAwsLogSourceResponse
     */
    constructor() { 
        
        CreateAwsLogSourceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAwsLogSourceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAwsLogSourceResponse} obj Optional instance to populate.
     * @return {module:model/CreateAwsLogSourceResponse} The populated <code>CreateAwsLogSourceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAwsLogSourceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAwsLogSourceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAwsLogSourceResponse</code>.
     */
 ...
 * @member {Array} failed
 */
CreateAwsLogSourceResponse.prototype['failed'] = undefined;
...
export default CreateAwsLogSourceResponse;
