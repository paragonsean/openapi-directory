...
/**
 * The CustomLogSourceCrawlerConfiguration model module.
 * @module model/CustomLogSourceCrawlerConfiguration
 * @version 2018-05-10
 */
class CustomLogSourceCrawlerConfiguration {
    /**
     * Constructs a new <code>CustomLogSourceCrawlerConfiguration</code>.
     * The configuration for the Glue Crawler for the third-party custom source.
     * @alias module:model/CustomLogSourceCrawlerConfiguration
     * @param roleArn {String} 
     */
    constructor(roleArn) { 
        
        CustomLogSourceCrawlerConfiguration.initialize(this, roleArn);
    }
    ...
    /**
     * Constructs a <code>CustomLogSourceCrawlerConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomLogSourceCrawlerConfiguration} obj Optional instance to populate.
     * @return {module:model/CustomLogSourceCrawlerConfiguration} The populated <code>CustomLogSourceCrawlerConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomLogSourceCrawlerConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomLogSourceCrawlerConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomLogSourceCrawlerConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomLogSourceCrawlerConfiguration.RequiredProperties) {
...
CustomLogSourceCrawlerConfiguration.RequiredProperties = ["roleArn"];

/**
 * @member {String} roleArn
 */
CustomLogSourceCrawlerConfiguration.prototype['roleArn'] = undefined;
...
export default CustomLogSourceCrawlerConfiguration;
