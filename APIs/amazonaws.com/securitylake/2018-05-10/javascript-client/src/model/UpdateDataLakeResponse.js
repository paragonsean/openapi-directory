...
/**
 * The UpdateDataLakeResponse model module.
 * @module model/UpdateDataLakeResponse
 * @version 2018-05-10
 */
class UpdateDataLakeResponse {
    /**
     * Constructs a new <code>UpdateDataLakeResponse</code>.
     * @alias module:model/UpdateDataLakeResponse
     */
    constructor() { 
        
        UpdateDataLakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDataLakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDataLakeResponse} obj Optional instance to populate.
     * @return {module:model/UpdateDataLakeResponse} The populated <code>UpdateDataLakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDataLakeResponse();

            if (data.hasOwnProperty('dataLakes')) {
                obj['dataLakes'] = ApiClient.convertToType(data['dataLakes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDataLakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDataLakeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `dataLakes`
        if (data['dataLakes']) { // data not null
          Array.validateJSON(data['dataLakes']);
        }
...
/**
 * @member {Array} dataLakes
 */
UpdateDataLakeResponse.prototype['dataLakes'] = undefined;
...
export default UpdateDataLakeResponse;
