...
import DataLakeUpdateStatusException from './DataLakeUpdateStatusException';

/**
 * The DataLakeUpdateStatus model module.
 * @module model/DataLakeUpdateStatus
 * @version 2018-05-10
 */
class DataLakeUpdateStatus {
    /**
     * Constructs a new <code>DataLakeUpdateStatus</code>.
     ...
     * @alias module:model/DataLakeUpdateStatus
     */
    constructor() { 
        
        DataLakeUpdateStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataLakeUpdateStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeUpdateStatus} obj Optional instance to populate.
     * @return {module:model/DataLakeUpdateStatus} The populated <code>DataLakeUpdateStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeUpdateStatus();

            if (data.hasOwnProperty('exception')) {
                obj['exception'] = DataLakeUpdateStatusException.constructFromObject(data['exception']);
            }
            if (data.hasOwnProperty('requestId')) {
                obj['requestId'] = ApiClient.convertToType(data['requestId'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], DataLakeStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeUpdateStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeUpdateStatus</code>.
     */
    static validateJSON(data) {
        // validate the optional field `exception`
        if (data['exception']) { // data not null
          DataLakeUpdateStatusException.validateJSON(data['exception']);
        }
        ...
        if (data['status']) { // data not null
          DataLakeStatus.validateJSON(data['status']);
        }
...
/**
 * @member {module:model/DataLakeUpdateStatusException} exception
 */
DataLakeUpdateStatus.prototype['exception'] = undefined;

/**
 * @member {String} requestId
 */
DataLakeUpdateStatus.prototype['requestId'] = undefined;

/**
 * @member {module:model/DataLakeStatus} status
 */
DataLakeUpdateStatus.prototype['status'] = undefined;
...
export default DataLakeUpdateStatus;
