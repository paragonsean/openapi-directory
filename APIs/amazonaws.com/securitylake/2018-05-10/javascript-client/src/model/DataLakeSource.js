...
/**
 * The DataLakeSource model module.
 * @module model/DataLakeSource
 * @version 2018-05-10
 */
class DataLakeSource {
    /**
     * Constructs a new <code>DataLakeSource</code>.
     ...
     * @alias module:model/DataLakeSource
     */
    constructor() { 
        
        DataLakeSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataLakeSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeSource} obj Optional instance to populate.
     * @return {module:model/DataLakeSource} The populated <code>DataLakeSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeSource();

            if (data.hasOwnProperty('account')) {
                obj['account'] = ApiClient.convertToType(data['account'], 'String');
            }
            if (data.hasOwnProperty('eventClasses')) {
                obj['eventClasses'] = ApiClient.convertToType(data['eventClasses'], Array);
            }
            if (data.hasOwnProperty('sourceName')) {
                obj['sourceName'] = ApiClient.convertToType(data['sourceName'], 'String');
            }
            if (data.hasOwnProperty('sourceStatuses')) {
                obj['sourceStatuses'] = ApiClient.convertToType(data['sourceStatuses'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeSource</code>.
     */
    static validateJSON(data) {
        ...
        if (data['eventClasses']) { // data not null
          Array.validateJSON(data['eventClasses']);
        }
        ...
        if (data['sourceStatuses']) { // data not null
          Array.validateJSON(data['sourceStatuses']);
        }
 ...
 */
DataLakeSource.prototype['account'] = undefined;

/**
 * @member {Array} eventClasses
 */
DataLakeSource.prototype['eventClasses'] = undefined;

/**
 * @member {String} sourceName
 */
DataLakeSource.prototype['sourceName'] = undefined;

/**
 * @member {Array} sourceStatuses
 */
DataLakeSource.prototype['sourceStatuses'] = undefined;
