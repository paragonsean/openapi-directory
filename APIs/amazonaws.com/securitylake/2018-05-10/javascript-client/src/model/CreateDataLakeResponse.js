...
/**
 * The CreateDataLakeResponse model module.
 * @module model/CreateDataLakeResponse
 * @version 2018-05-10
 */
class CreateDataLakeResponse {
    /**
     * Constructs a new <code>CreateDataLakeResponse</code>.
     * @alias module:model/CreateDataLakeResponse
     */
    constructor() { 
        
        CreateDataLakeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDataLakeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDataLakeResponse} obj Optional instance to populate.
     * @return {module:model/CreateDataLakeResponse} The populated <code>CreateDataLakeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDataLakeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDataLakeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDataLakeResponse</code>.
     */
 ...
 */
CreateDataLakeResponse.prototype['dataLakes'] = undefined;
...
export default CreateDataLakeResponse;
