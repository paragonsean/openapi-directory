...
/**
 * The GetDataLakeSourcesRequest model module.
 * @module model/GetDataLakeSourcesRequest
 * @version 2018-05-10
 */
class GetDataLakeSourcesRequest {
    /**
     * Constructs a new <code>GetDataLakeSourcesRequest</code>.
     * @alias module:model/GetDataLakeSourcesRequest
     */
    constructor() { 
        
        GetDataLakeSourcesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataLakeSourcesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDataLakeSourcesRequest} obj Optional instance to populate.
     * @return {module:model/GetDataLakeSourcesRequest} The populated <code>GetDataLakeSourcesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataLakeSourcesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataLakeSourcesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataLakeSourcesRequest</code>.
     */
 ...
 */
GetDataLakeSourcesRequest.prototype['accounts'] = undefined;

/**
 * The maximum limit of accounts for which the static snapshot of the current Region, including enabled accounts and log sources, is retrieved.
 * @member {Number} maxResults
 */
GetDataLakeSourcesRequest.prototype['maxResults'] = undefined;
 ...
 */
GetDataLakeSourcesRequest.prototype['nextToken'] = undefined;
...
export default GetDataLakeSourcesRequest;
