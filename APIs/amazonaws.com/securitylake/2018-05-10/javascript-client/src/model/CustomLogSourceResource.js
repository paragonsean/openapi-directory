...
/**
 * The CustomLogSourceResource model module.
 * @module model/CustomLogSourceResource
 * @version 2018-05-10
 */
class CustomLogSourceResource {
    /**
     * Constructs a new <code>CustomLogSourceResource</code>.
     * Amazon Security Lake can collect logs and events from third-party custom sources.
     * @alias module:model/CustomLogSourceResource
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CustomLogSourceResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomLogSourceResource} obj Optional instance to populate.
     * @return {module:model/CustomLogSourceResource} The populated <code>CustomLogSourceResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomLogSourceResource();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomLogSourceResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomLogSourceResource</code>.
     */
...
export default CustomLogSourceResource;
