...
/**
 * The DataLakeException model module.
 * @module model/DataLakeException
 * @version 2018-05-10
 */
class DataLakeException {
    /**
     * Constructs a new <code>DataLakeException</code>.
     * The details for an Amazon Security Lake exception.
     * @alias module:model/DataLakeException
     */
    constructor() { 
        
        DataLakeException.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataLakeException</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeException} obj Optional instance to populate.
     * @return {module:model/DataLakeException} The populated <code>DataLakeException</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeException();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeException</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeException</code>.
     */
    static validateJSON(data) {
        // validate the optional field `exception`
        if (data['exception']) { // data not null
          String.validateJSON(data['exception']);
        }
 ...
 */
DataLakeException.prototype['exception'] = undefined;

/**
 * @member {String} region
 */
DataLakeException.prototype['region'] = undefined;

/**
 * @member {String} remediation
 */
DataLakeException.prototype['remediation'] = undefined;

/**
 * @member {Date} timestamp
 */
DataLakeException.prototype['timestamp'] = undefined;
...
export default DataLakeException;
