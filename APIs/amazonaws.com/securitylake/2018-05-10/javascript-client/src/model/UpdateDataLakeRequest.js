...
/**
 * The UpdateDataLakeRequest model module.
 * @module model/UpdateDataLakeRequest
 * @version 2018-05-10
 */
class UpdateDataLakeRequest {
    /**
     * Constructs a new <code>UpdateDataLakeRequest</code>.
     * @alias module:model/UpdateDataLakeRequest
    ...
    constructor(configurations) { 
        ...
        UpdateDataLakeRequest.initialize(this, configurations);
    }
    ...
    /**
     * Constructs a <code>UpdateDataLakeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDataLakeRequest} obj Optional instance to populate.
     * @return {module:model/UpdateDataLakeRequest} The populated <code>UpdateDataLakeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDataLakeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDataLakeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDataLakeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDataLakeRequest.RequiredProperties) {
...
UpdateDataLakeRequest.RequiredProperties = ["configurations"];

/**
 * Specify the Region or Regions that will contribute data to the rollup region.
 * @member {Array.<module:model/DataLakeConfiguration>} configurations
 */
UpdateDataLakeRequest.prototype['configurations'] = undefined;
...
export default UpdateDataLakeRequest;
