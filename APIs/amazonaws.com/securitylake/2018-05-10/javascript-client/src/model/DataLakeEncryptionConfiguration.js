...
/**
 * The DataLakeEncryptionConfiguration model module.
 * @module model/DataLakeEncryptionConfiguration
 * @version 2018-05-10
 */
class DataLakeEncryptionConfiguration {
    /**
     * Constructs a new <code>DataLakeEncryptionConfiguration</code>.
     * Provides encryption details of Amazon Security Lake object.
     * @alias module:model/DataLakeEncryptionConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DataLakeEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/DataLakeEncryptionConfiguration} The populated <code>DataLakeEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeEncryptionConfiguration</code>.
     */
...
export default DataLakeEncryptionConfiguration;
