...
/**
 * The DeleteAwsLogSourceResponse model module.
 * @module model/DeleteAwsLogSourceResponse
 * @version 2018-05-10
 */
class DeleteAwsLogSourceResponse {
    /**
     * Constructs a new <code>DeleteAwsLogSourceResponse</code>.
     * @alias module:model/DeleteAwsLogSourceResponse
     */
    constructor() { 
        
        DeleteAwsLogSourceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteAwsLogSourceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAwsLogSourceResponse} obj Optional instance to populate.
     * @return {module:model/DeleteAwsLogSourceResponse} The populated <code>DeleteAwsLogSourceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAwsLogSourceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAwsLogSourceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAwsLogSourceResponse</code>.
     */
 ...
 * @member {Array} failed
 */
DeleteAwsLogSourceResponse.prototype['failed'] = undefined;
...
export default DeleteAwsLogSourceResponse;
