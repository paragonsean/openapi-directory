...
/**
 * The DataLakeReplicationConfiguration model module.
 * @module model/DataLakeReplicationConfiguration
 * @version 2018-05-10
 */
class DataLakeReplicationConfiguration {
    /**
     * Constructs a new <code>DataLakeReplicationConfiguration</code>.
     * Provides replication details of Amazon Security Lake object.
     * @alias module:model/DataLakeReplicationConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DataLakeReplicationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataLakeReplicationConfiguration} obj Optional instance to populate.
     * @return {module:model/DataLakeReplicationConfiguration} The populated <code>DataLakeReplicationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataLakeReplicationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>DataLakeReplicationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataLakeReplicationConfiguration</code>.
     */
...
export default DataLakeReplicationConfiguration;
