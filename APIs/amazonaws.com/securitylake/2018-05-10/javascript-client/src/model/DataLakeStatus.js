...
* @readonly
*/
export default class DataLakeStatus {
    ...
    /**
    * Returns a <code>DataLakeStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DataLakeStatus} The enum <code>DataLakeStatus</code> value.
    */
