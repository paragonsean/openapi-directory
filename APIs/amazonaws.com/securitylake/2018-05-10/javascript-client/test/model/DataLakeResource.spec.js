...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeResource();
  });
  ...
  describe('DataLakeResource', function() {
    it('should create an instance of DataLakeResource', function() {
      // uncomment below and update the code to test DataLakeResource
      //var instance = new AmazonSecurityLake.DataLakeResource();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeResource);
    });

    it('should have the property createStatus (base name: "createStatus")', function() {
      // uncomment below and update the code to test the property createStatus
      //var instance = new AmazonSecurityLake.DataLakeResource();
