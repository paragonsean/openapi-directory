...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DeleteAwsLogSourceResponse();
  });
  ...
  describe('DeleteAwsLogSourceResponse', function() {
    it('should create an instance of DeleteAwsLogSourceResponse', function() {
      // uncomment below and update the code to test DeleteAwsLogSourceResponse
      //var instance = new AmazonSecurityLake.DeleteAwsLogSourceResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.DeleteAwsLogSourceResponse);
    });
