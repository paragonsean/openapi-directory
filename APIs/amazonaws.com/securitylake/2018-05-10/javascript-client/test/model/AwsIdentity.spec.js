...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.AwsIdentity();
  });
  ...
  describe('AwsIdentity', function() {
    it('should create an instance of AwsIdentity', function() {
      // uncomment below and update the code to test AwsIdentity
      //var instance = new AmazonSecurityLake.AwsIdentity();
      //expect(instance).to.be.a(AmazonSecurityLake.AwsIdentity);
    });
