...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateAwsLogSourceResponse();
  });
  ...
  describe('CreateAwsLogSourceResponse', function() {
    it('should create an instance of CreateAwsLogSourceResponse', function() {
      // uncomment below and update the code to test CreateAwsLogSourceResponse
      //var instance = new AmazonSecurityLake.CreateAwsLogSourceResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateAwsLogSourceResponse);
    });
