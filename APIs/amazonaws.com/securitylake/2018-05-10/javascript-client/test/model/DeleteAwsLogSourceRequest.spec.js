...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DeleteAwsLogSourceRequest();
  });
  ...
  describe('DeleteAwsLogSourceRequest', function() {
    it('should create an instance of DeleteAwsLogSourceRequest', function() {
      // uncomment below and update the code to test DeleteAwsLogSourceRequest
      //var instance = new AmazonSecurityLake.DeleteAwsLogSourceRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.DeleteAwsLogSourceRequest);
    });
