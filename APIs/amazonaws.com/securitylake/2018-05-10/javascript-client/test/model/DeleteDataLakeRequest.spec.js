...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DeleteDataLakeRequest();
  });
  ...
  describe('DeleteDataLakeRequest', function() {
    it('should create an instance of DeleteDataLakeRequest', function() {
      // uncomment below and update the code to test DeleteDataLakeRequest
      //var instance = new AmazonSecurityLake.DeleteDataLakeRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.DeleteDataLakeRequest);
    });
