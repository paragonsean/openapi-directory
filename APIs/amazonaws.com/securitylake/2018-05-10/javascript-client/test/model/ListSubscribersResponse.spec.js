...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListSubscribersResponse();
  });
  ...
  describe('ListSubscribersResponse', function() {
    it('should create an instance of ListSubscribersResponse', function() {
      // uncomment below and update the code to test ListSubscribersResponse
      //var instance = new AmazonSecurityLake.ListSubscribersResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.ListSubscribersResponse);
    });
