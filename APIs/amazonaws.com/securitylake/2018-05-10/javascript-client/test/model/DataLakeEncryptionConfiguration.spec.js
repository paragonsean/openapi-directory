...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeEncryptionConfiguration();
  });
  ...
  describe('DataLakeEncryptionConfiguration', function() {
    it('should create an instance of DataLakeEncryptionConfiguration', function() {
      // uncomment below and update the code to test DataLakeEncryptionConfiguration
      //var instance = new AmazonSecurityLake.DataLakeEncryptionConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeEncryptionConfiguration);
    });
