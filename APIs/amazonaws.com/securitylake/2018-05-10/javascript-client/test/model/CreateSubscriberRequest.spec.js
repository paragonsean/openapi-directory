...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberRequest();
  });
  ...
  describe('CreateSubscriberRequest', function() {
    it('should create an instance of CreateSubscriberRequest', function() {
      // uncomment below and update the code to test CreateSubscriberRequest
      //var instance = new AmazonSecurityLake.CreateSubscriberRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberRequest);
    });
