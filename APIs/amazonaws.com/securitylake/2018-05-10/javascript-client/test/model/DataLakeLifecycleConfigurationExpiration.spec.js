...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeLifecycleConfigurationExpiration();
  });
  ...
  describe('DataLakeLifecycleConfigurationExpiration', function() {
    it('should create an instance of DataLakeLifecycleConfigurationExpiration', function() {
      // uncomment below and update the code to test DataLakeLifecycleConfigurationExpiration
      //var instance = new AmazonSecurityLake.DataLakeLifecycleConfigurationExpiration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeLifecycleConfigurationExpiration);
    });
