...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeConfigurationEncryptionConfiguration();
  });
  ...
  describe('DataLakeConfigurationEncryptionConfiguration', function() {
    it('should create an instance of DataLakeConfigurationEncryptionConfiguration', function() {
      // uncomment below and update the code to test DataLakeConfigurationEncryptionConfiguration
      //var instance = new AmazonSecurityLake.DataLakeConfigurationEncryptionConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeConfigurationEncryptionConfiguration);
    });
