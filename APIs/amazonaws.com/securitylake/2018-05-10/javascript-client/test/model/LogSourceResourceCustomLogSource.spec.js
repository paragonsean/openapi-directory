...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.LogSourceResourceCustomLogSource();
  });
  ...
  describe('LogSourceResourceCustomLogSource', function() {
    it('should create an instance of LogSourceResourceCustomLogSource', function() {
      // uncomment below and update the code to test LogSourceResourceCustomLogSource
      //var instance = new AmazonSecurityLake.LogSourceResourceCustomLogSource();
      //expect(instance).to.be.a(AmazonSecurityLake.LogSourceResourceCustomLogSource);
    });
