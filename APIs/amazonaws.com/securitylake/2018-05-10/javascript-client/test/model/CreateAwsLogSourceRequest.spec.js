...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateAwsLogSourceRequest();
  });
  ...
  describe('CreateAwsLogSourceRequest', function() {
    it('should create an instance of CreateAwsLogSourceRequest', function() {
      // uncomment below and update the code to test CreateAwsLogSourceRequest
      //var instance = new AmazonSecurityLake.CreateAwsLogSourceRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateAwsLogSourceRequest);
    });
