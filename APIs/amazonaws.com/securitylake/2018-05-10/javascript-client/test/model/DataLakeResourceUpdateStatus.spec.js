...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeResourceUpdateStatus();
  });
  ...
  describe('DataLakeResourceUpdateStatus', function() {
    it('should create an instance of DataLakeResourceUpdateStatus', function() {
      // uncomment below and update the code to test DataLakeResourceUpdateStatus
      //var instance = new AmazonSecurityLake.DataLakeResourceUpdateStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeResourceUpdateStatus);
    });
