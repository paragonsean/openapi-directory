...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeSourceStatus();
  });
  ...
  describe('DataLakeSourceStatus', function() {
    it('should create an instance of DataLakeSourceStatus', function() {
      // uncomment below and update the code to test DataLakeSourceStatus
      //var instance = new AmazonSecurityLake.DataLakeSourceStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeSourceStatus);
    });
