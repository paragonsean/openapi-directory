...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateCustomLogSourceResponseSource();
  });
  ...
  describe('CreateCustomLogSourceResponseSource', function() {
    it('should create an instance of CreateCustomLogSourceResponseSource', function() {
      // uncomment below and update the code to test CreateCustomLogSourceResponseSource
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceResponseSource();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateCustomLogSourceResponseSource);
    });
