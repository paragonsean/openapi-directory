...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeReplicationConfiguration();
  });
  ...
  describe('DataLakeReplicationConfiguration', function() {
    it('should create an instance of DataLakeReplicationConfiguration', function() {
      // uncomment below and update the code to test DataLakeReplicationConfiguration
      //var instance = new AmazonSecurityLake.DataLakeReplicationConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeReplicationConfiguration);
    });
