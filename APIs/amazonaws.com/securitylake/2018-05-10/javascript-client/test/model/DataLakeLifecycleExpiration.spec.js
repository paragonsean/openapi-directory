...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeLifecycleExpiration();
  });
  ...
  describe('DataLakeLifecycleExpiration', function() {
    it('should create an instance of DataLakeLifecycleExpiration', function() {
      // uncomment below and update the code to test DataLakeLifecycleExpiration
      //var instance = new AmazonSecurityLake.DataLakeLifecycleExpiration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeLifecycleExpiration);
    });
