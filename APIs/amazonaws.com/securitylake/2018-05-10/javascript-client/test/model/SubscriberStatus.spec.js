...
(function(root, factory) {
  ...
  describe('SubscriberStatus', function() {
    it('should create an instance of SubscriberStatus', function() {
      // uncomment below and update the code to test SubscriberStatus
      //var instance = new AmazonSecurityLake.SubscriberStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.SubscriberStatus);
    });
