...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceProvider();
  });
  ...
  describe('CustomLogSourceProvider', function() {
    it('should create an instance of CustomLogSourceProvider', function() {
      // uncomment below and update the code to test CustomLogSourceProvider
      //var instance = new AmazonSecurityLake.CustomLogSourceProvider();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceProvider);
    });
