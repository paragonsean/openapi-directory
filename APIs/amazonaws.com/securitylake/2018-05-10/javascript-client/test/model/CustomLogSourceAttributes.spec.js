...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceAttributes();
  });
  ...
  describe('CustomLogSourceAttributes', function() {
    it('should create an instance of CustomLogSourceAttributes', function() {
      // uncomment below and update the code to test CustomLogSourceAttributes
      //var instance = new AmazonSecurityLake.CustomLogSourceAttributes();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceAttributes);
    });

    it('should have the property crawlerArn (base name: "crawlerArn")', function() {
      // uncomment below and update the code to test the property crawlerArn
      //var instance = new AmazonSecurityLake.CustomLogSourceAttributes();
