...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberNotificationResponse();
  });
  ...
  describe('CreateSubscriberNotificationResponse', function() {
    it('should create an instance of CreateSubscriberNotificationResponse', function() {
      // uncomment below and update the code to test CreateSubscriberNotificationResponse
      //var instance = new AmazonSecurityLake.CreateSubscriberNotificationResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberNotificationResponse);
    });
