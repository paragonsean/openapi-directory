...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeException();
  });
  ...
  describe('DataLakeException', function() {
    it('should create an instance of DataLakeException', function() {
      // uncomment below and update the code to test DataLakeException
      //var instance = new AmazonSecurityLake.DataLakeException();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeException);
    });
