...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberNotificationRequest();
  });
  ...
  describe('CreateSubscriberNotificationRequest', function() {
    it('should create an instance of CreateSubscriberNotificationRequest', function() {
      // uncomment below and update the code to test CreateSubscriberNotificationRequest
      //var instance = new AmazonSecurityLake.CreateSubscriberNotificationRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberNotificationRequest);
    });
