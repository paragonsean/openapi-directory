...
(function(root, factory) {
  ...
  describe('SourceCollectionStatus', function() {
    it('should create an instance of SourceCollectionStatus', function() {
      // uncomment below and update the code to test SourceCollectionStatus
      //var instance = new AmazonSecurityLake.SourceCollectionStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.SourceCollectionStatus);
    });
