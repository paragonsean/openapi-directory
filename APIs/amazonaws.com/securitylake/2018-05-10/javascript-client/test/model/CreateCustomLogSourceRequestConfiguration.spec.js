...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateCustomLogSourceRequestConfiguration();
  });
  ...
  describe('CreateCustomLogSourceRequestConfiguration', function() {
    it('should create an instance of CreateCustomLogSourceRequestConfiguration', function() {
      // uncomment below and update the code to test CreateCustomLogSourceRequestConfiguration
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceRequestConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateCustomLogSourceRequestConfiguration);
    });
