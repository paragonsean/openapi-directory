...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListLogSourcesRequest();
  });
  ...
  describe('ListLogSourcesRequest', function() {
    it('should create an instance of ListLogSourcesRequest', function() {
      // uncomment below and update the code to test ListLogSourcesRequest
      //var instance = new AmazonSecurityLake.ListLogSourcesRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.ListLogSourcesRequest);
    });
