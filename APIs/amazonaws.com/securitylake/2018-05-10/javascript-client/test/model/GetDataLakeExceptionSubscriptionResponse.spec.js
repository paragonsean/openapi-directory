...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.GetDataLakeExceptionSubscriptionResponse();
  });
  ...
  describe('GetDataLakeExceptionSubscriptionResponse', function() {
    it('should create an instance of GetDataLakeExceptionSubscriptionResponse', function() {
      // uncomment below and update the code to test GetDataLakeExceptionSubscriptionResponse
      //var instance = new AmazonSecurityLake.GetDataLakeExceptionSubscriptionResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.GetDataLakeExceptionSubscriptionResponse);
    });
