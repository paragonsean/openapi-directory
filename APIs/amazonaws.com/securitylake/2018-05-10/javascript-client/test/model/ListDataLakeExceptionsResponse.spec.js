...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListDataLakeExceptionsResponse();
  });
  ...
  describe('ListDataLakeExceptionsResponse', function() {
    it('should create an instance of ListDataLakeExceptionsResponse', function() {
      // uncomment below and update the code to test ListDataLakeExceptionsResponse
      //var instance = new AmazonSecurityLake.ListDataLakeExceptionsResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.ListDataLakeExceptionsResponse);
    });
