...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateDataLakeOrganizationConfigurationRequest();
  });
  ...
  describe('CreateDataLakeOrganizationConfigurationRequest', function() {
    it('should create an instance of CreateDataLakeOrganizationConfigurationRequest', function() {
      // uncomment below and update the code to test CreateDataLakeOrganizationConfigurationRequest
      //var instance = new AmazonSecurityLake.CreateDataLakeOrganizationConfigurationRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateDataLakeOrganizationConfigurationRequest);
    });

    it('should have the property autoEnableNewAccount (base name: "autoEnableNewAccount")', function() {
      // uncomment below and update the code to test the property autoEnableNewAccount
      //var instance = new AmazonSecurityLake.CreateDataLakeOrganizationConfigurationRequest();
