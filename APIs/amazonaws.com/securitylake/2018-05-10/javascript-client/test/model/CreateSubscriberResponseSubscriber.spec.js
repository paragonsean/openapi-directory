...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberResponseSubscriber();
  });
  ...
  describe('CreateSubscriberResponseSubscriber', function() {
    it('should create an instance of CreateSubscriberResponseSubscriber', function() {
      // uncomment below and update the code to test CreateSubscriberResponseSubscriber
      //var instance = new AmazonSecurityLake.CreateSubscriberResponseSubscriber();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberResponseSubscriber);
    });
