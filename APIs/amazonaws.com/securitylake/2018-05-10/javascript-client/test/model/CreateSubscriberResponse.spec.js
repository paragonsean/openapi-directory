...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberResponse();
  });
  ...
  describe('CreateSubscriberResponse', function() {
    it('should create an instance of CreateSubscriberResponse', function() {
      // uncomment below and update the code to test CreateSubscriberResponse
      //var instance = new AmazonSecurityLake.CreateSubscriberResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberResponse);
    });
