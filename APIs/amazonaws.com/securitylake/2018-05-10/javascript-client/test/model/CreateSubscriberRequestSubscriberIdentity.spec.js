...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberRequestSubscriberIdentity();
  });
  ...
  describe('CreateSubscriberRequestSubscriberIdentity', function() {
    it('should create an instance of CreateSubscriberRequestSubscriberIdentity', function() {
      // uncomment below and update the code to test CreateSubscriberRequestSubscriberIdentity
      //var instance = new AmazonSecurityLake.CreateSubscriberRequestSubscriberIdentity();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberRequestSubscriberIdentity);
    });
