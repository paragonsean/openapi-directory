...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceConfiguration();
  });
  ...
  describe('CustomLogSourceConfiguration', function() {
    it('should create an instance of CustomLogSourceConfiguration', function() {
      // uncomment below and update the code to test CustomLogSourceConfiguration
      //var instance = new AmazonSecurityLake.CustomLogSourceConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceConfiguration);
    });

    it('should have the property crawlerConfiguration (base name: "crawlerConfiguration")', function() {
      // uncomment below and update the code to test the property crawlerConfiguration
      //var instance = new AmazonSecurityLake.CustomLogSourceConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property providerIdentity (base name: "providerIdentity")', function() {
      // uncomment below and update the code to test the property providerIdentity
      //var instance = new AmazonSecurityLake.CustomLogSourceConfiguration();
      //expect(instance).to.be();
    });
