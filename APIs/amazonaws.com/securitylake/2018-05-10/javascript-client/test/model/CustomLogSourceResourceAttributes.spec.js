...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceResourceAttributes();
  });
  ...
  describe('CustomLogSourceResourceAttributes', function() {
    it('should create an instance of CustomLogSourceResourceAttributes', function() {
      // uncomment below and update the code to test CustomLogSourceResourceAttributes
      //var instance = new AmazonSecurityLake.CustomLogSourceResourceAttributes();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceResourceAttributes);
    });
