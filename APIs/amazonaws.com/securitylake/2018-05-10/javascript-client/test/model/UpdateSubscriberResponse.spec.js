...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberResponse();
  });
  ...
  describe('UpdateSubscriberResponse', function() {
    it('should create an instance of UpdateSubscriberResponse', function() {
      // uncomment below and update the code to test UpdateSubscriberResponse
      //var instance = new AmazonSecurityLake.UpdateSubscriberResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberResponse);
    });
