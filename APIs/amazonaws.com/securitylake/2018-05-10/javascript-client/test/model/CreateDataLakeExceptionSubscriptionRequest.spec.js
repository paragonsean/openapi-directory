...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateDataLakeExceptionSubscriptionRequest();
  });
  ...
  describe('CreateDataLakeExceptionSubscriptionRequest', function() {
    it('should create an instance of CreateDataLakeExceptionSubscriptionRequest', function() {
      // uncomment below and update the code to test CreateDataLakeExceptionSubscriptionRequest
      //var instance = new AmazonSecurityLake.CreateDataLakeExceptionSubscriptionRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateDataLakeExceptionSubscriptionRequest);
    });
