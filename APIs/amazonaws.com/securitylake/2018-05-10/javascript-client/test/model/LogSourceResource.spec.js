...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.LogSourceResource();
  });
  ...
  describe('LogSourceResource', function() {
    it('should create an instance of LogSourceResource', function() {
      // uncomment below and update the code to test LogSourceResource
      //var instance = new AmazonSecurityLake.LogSourceResource();
      //expect(instance).to.be.a(AmazonSecurityLake.LogSourceResource);
    });

    it('should have the property awsLogSource (base name: "awsLogSource")', function() {
      // uncomment below and update the code to test the property awsLogSource
      //var instance = new AmazonSecurityLake.LogSourceResource();
      //expect(instance).to.be();
    });

    it('should have the property customLogSource (base name: "customLogSource")', function() {
      // uncomment below and update the code to test the property customLogSource
      //var instance = new AmazonSecurityLake.LogSourceResource();
      //expect(instance).to.be();
    });
