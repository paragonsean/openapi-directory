...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.HttpsNotificationConfiguration();
  });
  ...
  describe('HttpsNotificationConfiguration', function() {
    it('should create an instance of HttpsNotificationConfiguration', function() {
      // uncomment below and update the code to test HttpsNotificationConfiguration
      //var instance = new AmazonSecurityLake.HttpsNotificationConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.HttpsNotificationConfiguration);
    });
