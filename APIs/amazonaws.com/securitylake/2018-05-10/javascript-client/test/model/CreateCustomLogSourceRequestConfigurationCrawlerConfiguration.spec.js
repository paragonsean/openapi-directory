...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateCustomLogSourceRequestConfigurationCrawlerConfiguration();
  });
  ...
  describe('CreateCustomLogSourceRequestConfigurationCrawlerConfiguration', function() {
    it('should create an instance of CreateCustomLogSourceRequestConfigurationCrawlerConfiguration', function() {
      // uncomment below and update the code to test CreateCustomLogSourceRequestConfigurationCrawlerConfiguration
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceRequestConfigurationCrawlerConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateCustomLogSourceRequestConfigurationCrawlerConfiguration);
    });
