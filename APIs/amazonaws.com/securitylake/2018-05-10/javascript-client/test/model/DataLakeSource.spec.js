...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeSource();
  });
  ...
  describe('DataLakeSource', function() {
    it('should create an instance of DataLakeSource', function() {
      // uncomment below and update the code to test DataLakeSource
      //var instance = new AmazonSecurityLake.DataLakeSource();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeSource);
    });
    ...
    it('should have the property sourceStatuses (base name: "sourceStatuses")', function() {
      // uncomment below and update the code to test the property sourceStatuses
      //var instance = new AmazonSecurityLake.DataLakeSource();
      //expect(instance).to.be();
    });
