...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeConfiguration();
  });
  ...
  describe('DataLakeConfiguration', function() {
    it('should create an instance of DataLakeConfiguration', function() {
      // uncomment below and update the code to test DataLakeConfiguration
      //var instance = new AmazonSecurityLake.DataLakeConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeConfiguration);
    });
    ...
    it('should have the property lifecycleConfiguration (base name: "lifecycleConfiguration")', function() {
      // uncomment below and update the code to test the property lifecycleConfiguration
      //var instance = new AmazonSecurityLake.DataLakeConfiguration();
      //expect(instance).to.be();
    });
