...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.SubscriberResource();
  });
  ...
  describe('SubscriberResource', function() {
    it('should create an instance of SubscriberResource', function() {
      // uncomment below and update the code to test SubscriberResource
      //var instance = new AmazonSecurityLake.SubscriberResource();
      //expect(instance).to.be.a(AmazonSecurityLake.SubscriberResource);
    });
