...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceResourceProvider();
  });
  ...
  describe('CustomLogSourceResourceProvider', function() {
    it('should create an instance of CustomLogSourceResourceProvider', function() {
      // uncomment below and update the code to test CustomLogSourceResourceProvider
      //var instance = new AmazonSecurityLake.CustomLogSourceResourceProvider();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceResourceProvider);
    });
