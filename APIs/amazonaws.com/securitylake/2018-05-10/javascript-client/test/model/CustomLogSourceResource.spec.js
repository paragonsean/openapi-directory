...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceResource();
  });
  ...
  describe('CustomLogSourceResource', function() {
    it('should create an instance of CustomLogSourceResource', function() {
      // uncomment below and update the code to test CustomLogSourceResource
      //var instance = new AmazonSecurityLake.CustomLogSourceResource();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceResource);
    });
