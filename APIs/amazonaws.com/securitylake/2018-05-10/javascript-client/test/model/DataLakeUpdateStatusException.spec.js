...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeUpdateStatusException();
  });
  ...
  describe('DataLakeUpdateStatusException', function() {
    it('should create an instance of DataLakeUpdateStatusException', function() {
      // uncomment below and update the code to test DataLakeUpdateStatusException
      //var instance = new AmazonSecurityLake.DataLakeUpdateStatusException();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeUpdateStatusException);
    });
