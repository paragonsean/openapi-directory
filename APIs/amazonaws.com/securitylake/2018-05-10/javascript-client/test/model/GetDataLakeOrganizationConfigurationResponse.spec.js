...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.GetDataLakeOrganizationConfigurationResponse();
  });
  ...
  describe('GetDataLakeOrganizationConfigurationResponse', function() {
    it('should create an instance of GetDataLakeOrganizationConfigurationResponse', function() {
      // uncomment below and update the code to test GetDataLakeOrganizationConfigurationResponse
      //var instance = new AmazonSecurityLake.GetDataLakeOrganizationConfigurationResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.GetDataLakeOrganizationConfigurationResponse);
    });
