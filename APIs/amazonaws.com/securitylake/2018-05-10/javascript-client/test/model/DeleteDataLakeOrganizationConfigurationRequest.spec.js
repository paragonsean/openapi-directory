...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DeleteDataLakeOrganizationConfigurationRequest();
  });
  ...
  describe('DeleteDataLakeOrganizationConfigurationRequest', function() {
    it('should create an instance of DeleteDataLakeOrganizationConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteDataLakeOrganizationConfigurationRequest
      //var instance = new AmazonSecurityLake.DeleteDataLakeOrganizationConfigurationRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.DeleteDataLakeOrganizationConfigurationRequest);
    });
