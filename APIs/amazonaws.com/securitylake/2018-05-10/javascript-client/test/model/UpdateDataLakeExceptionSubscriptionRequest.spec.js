...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateDataLakeExceptionSubscriptionRequest();
  });
  ...
  describe('UpdateDataLakeExceptionSubscriptionRequest', function() {
    it('should create an instance of UpdateDataLakeExceptionSubscriptionRequest', function() {
      // uncomment below and update the code to test UpdateDataLakeExceptionSubscriptionRequest
      //var instance = new AmazonSecurityLake.UpdateDataLakeExceptionSubscriptionRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateDataLakeExceptionSubscriptionRequest);
    });

    it('should have the property exceptionTimeToLive (base name: "exceptionTimeToLive")', function() {
      // uncomment below and update the code to test the property exceptionTimeToLive
      //var instance = new AmazonSecurityLake.UpdateDataLakeExceptionSubscriptionRequest();
    ...
    it('should have the property subscriptionProtocol (base name: "subscriptionProtocol")', function() {
      // uncomment below and update the code to test the property subscriptionProtocol
      //var instance = new AmazonSecurityLake.UpdateDataLakeExceptionSubscriptionRequest();
      //expect(instance).to.be();
    });
