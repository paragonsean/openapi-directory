...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfiguration();
  });
  ...
  describe('UpdateSubscriberNotificationRequestConfiguration', function() {
    it('should create an instance of UpdateSubscriberNotificationRequestConfiguration', function() {
      // uncomment below and update the code to test UpdateSubscriberNotificationRequestConfiguration
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberNotificationRequestConfiguration);
    });
