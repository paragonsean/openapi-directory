...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateCustomLogSourceResponse();
  });
  ...
  describe('CreateCustomLogSourceResponse', function() {
    it('should create an instance of CreateCustomLogSourceResponse', function() {
      // uncomment below and update the code to test CreateCustomLogSourceResponse
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateCustomLogSourceResponse);
    });
