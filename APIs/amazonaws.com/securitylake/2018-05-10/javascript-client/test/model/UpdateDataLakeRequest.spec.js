...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateDataLakeRequest();
  });
  ...
  describe('UpdateDataLakeRequest', function() {
    it('should create an instance of UpdateDataLakeRequest', function() {
      // uncomment below and update the code to test UpdateDataLakeRequest
      //var instance = new AmazonSecurityLake.UpdateDataLakeRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateDataLakeRequest);
    });
