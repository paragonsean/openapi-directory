...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateSubscriberNotificationRequestConfiguration();
  });
  ...
  describe('CreateSubscriberNotificationRequestConfiguration', function() {
    it('should create an instance of CreateSubscriberNotificationRequestConfiguration', function() {
      // uncomment below and update the code to test CreateSubscriberNotificationRequestConfiguration
      //var instance = new AmazonSecurityLake.CreateSubscriberNotificationRequestConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateSubscriberNotificationRequestConfiguration);
    });
