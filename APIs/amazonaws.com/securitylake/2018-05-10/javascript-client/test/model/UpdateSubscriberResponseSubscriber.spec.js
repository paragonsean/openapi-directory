...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberResponseSubscriber();
  });
  ...
  describe('UpdateSubscriberResponseSubscriber', function() {
    it('should create an instance of UpdateSubscriberResponseSubscriber', function() {
      // uncomment below and update the code to test UpdateSubscriberResponseSubscriber
      //var instance = new AmazonSecurityLake.UpdateSubscriberResponseSubscriber();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberResponseSubscriber);
    });
