...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateDataLakeResponse();
  });
  ...
  describe('CreateDataLakeResponse', function() {
    it('should create an instance of CreateDataLakeResponse', function() {
      // uncomment below and update the code to test CreateDataLakeResponse
      //var instance = new AmazonSecurityLake.CreateDataLakeResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateDataLakeResponse);
    });

    it('should have the property dataLakes (base name: "dataLakes")', function() {
      // uncomment below and update the code to test the property dataLakes
      //var instance = new AmazonSecurityLake.CreateDataLakeResponse();
