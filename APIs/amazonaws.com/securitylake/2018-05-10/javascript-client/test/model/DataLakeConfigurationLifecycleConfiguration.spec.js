...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeConfigurationLifecycleConfiguration();
  });
  ...
  describe('DataLakeConfigurationLifecycleConfiguration', function() {
    it('should create an instance of DataLakeConfigurationLifecycleConfiguration', function() {
      // uncomment below and update the code to test DataLakeConfigurationLifecycleConfiguration
      //var instance = new AmazonSecurityLake.DataLakeConfigurationLifecycleConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeConfigurationLifecycleConfiguration);
    });
