...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeUpdateException();
  });
  ...
  describe('DataLakeUpdateException', function() {
    it('should create an instance of DataLakeUpdateException', function() {
      // uncomment below and update the code to test DataLakeUpdateException
      //var instance = new AmazonSecurityLake.DataLakeUpdateException();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeUpdateException);
    });
