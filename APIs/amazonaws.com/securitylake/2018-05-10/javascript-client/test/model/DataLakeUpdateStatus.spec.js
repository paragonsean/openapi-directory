...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeUpdateStatus();
  });
  ...
  describe('DataLakeUpdateStatus', function() {
    it('should create an instance of DataLakeUpdateStatus', function() {
      // uncomment below and update the code to test DataLakeUpdateStatus
      //var instance = new AmazonSecurityLake.DataLakeUpdateStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeUpdateStatus);
    });
