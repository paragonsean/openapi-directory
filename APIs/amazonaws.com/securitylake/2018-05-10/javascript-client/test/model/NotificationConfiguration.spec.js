...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.NotificationConfiguration();
  });
  ...
  describe('NotificationConfiguration', function() {
    it('should create an instance of NotificationConfiguration', function() {
      // uncomment below and update the code to test NotificationConfiguration
      //var instance = new AmazonSecurityLake.NotificationConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.NotificationConfiguration);
    });

    it('should have the property httpsNotificationConfiguration (base name: "httpsNotificationConfiguration")', function() {
      // uncomment below and update the code to test the property httpsNotificationConfiguration
      //var instance = new AmazonSecurityLake.NotificationConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property sqsNotificationConfiguration (base name: "sqsNotificationConfiguration")', function() {
      // uncomment below and update the code to test the property sqsNotificationConfiguration
      //var instance = new AmazonSecurityLake.NotificationConfiguration();
      //expect(instance).to.be();
    });
