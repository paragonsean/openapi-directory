...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.LogSourceResourceAwsLogSource();
  });
  ...
  describe('LogSourceResourceAwsLogSource', function() {
    it('should create an instance of LogSourceResourceAwsLogSource', function() {
      // uncomment below and update the code to test LogSourceResourceAwsLogSource
      //var instance = new AmazonSecurityLake.LogSourceResourceAwsLogSource();
      //expect(instance).to.be.a(AmazonSecurityLake.LogSourceResourceAwsLogSource);
    });
