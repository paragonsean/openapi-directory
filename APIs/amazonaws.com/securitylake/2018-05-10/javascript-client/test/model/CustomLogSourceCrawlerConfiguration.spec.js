...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CustomLogSourceCrawlerConfiguration();
  });
  ...
  describe('CustomLogSourceCrawlerConfiguration', function() {
    it('should create an instance of CustomLogSourceCrawlerConfiguration', function() {
      // uncomment below and update the code to test CustomLogSourceCrawlerConfiguration
      //var instance = new AmazonSecurityLake.CustomLogSourceCrawlerConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.CustomLogSourceCrawlerConfiguration);
    });
