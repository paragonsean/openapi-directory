...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonSecurityLake.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.ListTagsForResourceResponse);
    });
