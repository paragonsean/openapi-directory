...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeLifecycleConfiguration();
  });
  ...
  describe('DataLakeLifecycleConfiguration', function() {
    it('should create an instance of DataLakeLifecycleConfiguration', function() {
      // uncomment below and update the code to test DataLakeLifecycleConfiguration
      //var instance = new AmazonSecurityLake.DataLakeLifecycleConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeLifecycleConfiguration);
    });
