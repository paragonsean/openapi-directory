...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeLifecycleTransition();
  });
  ...
  describe('DataLakeLifecycleTransition', function() {
    it('should create an instance of DataLakeLifecycleTransition', function() {
      // uncomment below and update the code to test DataLakeLifecycleTransition
      //var instance = new AmazonSecurityLake.DataLakeLifecycleTransition();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeLifecycleTransition);
    });
