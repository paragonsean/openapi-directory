...
(function(root, factory) {
  ...
  describe('AwsLogSourceName', function() {
    it('should create an instance of AwsLogSourceName', function() {
      // uncomment below and update the code to test AwsLogSourceName
      //var instance = new AmazonSecurityLake.AwsLogSourceName();
      //expect(instance).to.be.a(AmazonSecurityLake.AwsLogSourceName);
    });
