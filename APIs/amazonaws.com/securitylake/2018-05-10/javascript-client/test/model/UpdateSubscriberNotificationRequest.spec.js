...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequest();
  });
  ...
  describe('UpdateSubscriberNotificationRequest', function() {
    it('should create an instance of UpdateSubscriberNotificationRequest', function() {
      // uncomment below and update the code to test UpdateSubscriberNotificationRequest
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberNotificationRequest);
    });
