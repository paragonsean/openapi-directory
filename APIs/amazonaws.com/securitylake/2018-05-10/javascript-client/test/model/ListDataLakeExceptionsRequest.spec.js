...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListDataLakeExceptionsRequest();
  });
  ...
  describe('ListDataLakeExceptionsRequest', function() {
    it('should create an instance of ListDataLakeExceptionsRequest', function() {
      // uncomment below and update the code to test ListDataLakeExceptionsRequest
      //var instance = new AmazonSecurityLake.ListDataLakeExceptionsRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.ListDataLakeExceptionsRequest);
    });
