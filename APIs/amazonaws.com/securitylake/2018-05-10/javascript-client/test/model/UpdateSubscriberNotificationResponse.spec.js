...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberNotificationResponse();
  });
  ...
  describe('UpdateSubscriberNotificationResponse', function() {
    it('should create an instance of UpdateSubscriberNotificationResponse', function() {
      // uncomment below and update the code to test UpdateSubscriberNotificationResponse
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberNotificationResponse);
    });
