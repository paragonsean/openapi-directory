...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.AwsLogSourceConfiguration();
  });
  ...
  describe('AwsLogSourceConfiguration', function() {
    it('should create an instance of AwsLogSourceConfiguration', function() {
      // uncomment below and update the code to test AwsLogSourceConfiguration
      //var instance = new AmazonSecurityLake.AwsLogSourceConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.AwsLogSourceConfiguration);
    });
