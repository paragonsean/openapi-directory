...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.RegisterDataLakeDelegatedAdministratorRequest();
  });
  ...
  describe('RegisterDataLakeDelegatedAdministratorRequest', function() {
    it('should create an instance of RegisterDataLakeDelegatedAdministratorRequest', function() {
      // uncomment below and update the code to test RegisterDataLakeDelegatedAdministratorRequest
      //var instance = new AmazonSecurityLake.RegisterDataLakeDelegatedAdministratorRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.RegisterDataLakeDelegatedAdministratorRequest);
    });
