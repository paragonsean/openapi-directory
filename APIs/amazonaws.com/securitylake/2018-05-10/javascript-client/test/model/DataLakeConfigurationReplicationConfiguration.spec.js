...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeConfigurationReplicationConfiguration();
  });
  ...
  describe('DataLakeConfigurationReplicationConfiguration', function() {
    it('should create an instance of DataLakeConfigurationReplicationConfiguration', function() {
      // uncomment below and update the code to test DataLakeConfigurationReplicationConfiguration
      //var instance = new AmazonSecurityLake.DataLakeConfigurationReplicationConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeConfigurationReplicationConfiguration);
    });
