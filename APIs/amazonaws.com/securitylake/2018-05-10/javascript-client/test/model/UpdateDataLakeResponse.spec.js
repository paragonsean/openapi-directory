...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateDataLakeResponse();
  });
  ...
  describe('UpdateDataLakeResponse', function() {
    it('should create an instance of UpdateDataLakeResponse', function() {
      // uncomment below and update the code to test UpdateDataLakeResponse
      //var instance = new AmazonSecurityLake.UpdateDataLakeResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateDataLakeResponse);
    });
