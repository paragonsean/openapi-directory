...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonSecurityLake.TagResourceRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.TagResourceRequest);
    });
