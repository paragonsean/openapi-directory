...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.GetDataLakeSourcesRequest();
  });
  ...
  describe('GetDataLakeSourcesRequest', function() {
    it('should create an instance of GetDataLakeSourcesRequest', function() {
      // uncomment below and update the code to test GetDataLakeSourcesRequest
      //var instance = new AmazonSecurityLake.GetDataLakeSourcesRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.GetDataLakeSourcesRequest);
    });
