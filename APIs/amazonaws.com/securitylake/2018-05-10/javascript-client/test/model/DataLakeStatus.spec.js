...
(function(root, factory) {
  ...
  describe('DataLakeStatus', function() {
    it('should create an instance of DataLakeStatus', function() {
      // uncomment below and update the code to test DataLakeStatus
      //var instance = new AmazonSecurityLake.DataLakeStatus();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeStatus);
    });
