...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListLogSourcesResponse();
  });
  ...
  describe('ListLogSourcesResponse', function() {
    it('should create an instance of ListLogSourcesResponse', function() {
      // uncomment below and update the code to test ListLogSourcesResponse
      //var instance = new AmazonSecurityLake.ListLogSourcesResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.ListLogSourcesResponse);
    });
