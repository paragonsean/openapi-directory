...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration();
  });
  ...
  describe('UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration', function() {
    it('should create an instance of UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration', function() {
      // uncomment below and update the code to test UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration);
    });

    it('should have the property authorizationApiKeyName (base name: "authorizationApiKeyName")', function() {
      // uncomment below and update the code to test the property authorizationApiKeyName
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property authorizationApiKeyValue (base name: "authorizationApiKeyValue")', function() {
      // uncomment below and update the code to test the property authorizationApiKeyValue
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetRoleArn (base name: "targetRoleArn")', function() {
      // uncomment below and update the code to test the property targetRoleArn
      //var instance = new AmazonSecurityLake.UpdateSubscriberNotificationRequestConfigurationHttpsNotificationConfiguration();
      //expect(instance).to.be();
    });
