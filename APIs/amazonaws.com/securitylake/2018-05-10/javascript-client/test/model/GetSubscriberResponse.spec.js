...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.GetSubscriberResponse();
  });
  ...
  describe('GetSubscriberResponse', function() {
    it('should create an instance of GetSubscriberResponse', function() {
      // uncomment below and update the code to test GetSubscriberResponse
      //var instance = new AmazonSecurityLake.GetSubscriberResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.GetSubscriberResponse);
    });
