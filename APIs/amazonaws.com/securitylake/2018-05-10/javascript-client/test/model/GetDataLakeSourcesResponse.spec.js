...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.GetDataLakeSourcesResponse();
  });
  ...
  describe('GetDataLakeSourcesResponse', function() {
    it('should create an instance of GetDataLakeSourcesResponse', function() {
      // uncomment below and update the code to test GetDataLakeSourcesResponse
      //var instance = new AmazonSecurityLake.GetDataLakeSourcesResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.GetDataLakeSourcesResponse);
    });

    it('should have the property dataLakeArn (base name: "dataLakeArn")', function() {
      // uncomment below and update the code to test the property dataLakeArn
      //var instance = new AmazonSecurityLake.GetDataLakeSourcesResponse();
      //expect(instance).to.be();
    });

    it('should have the property dataLakeSources (base name: "dataLakeSources")', function() {
      // uncomment below and update the code to test the property dataLakeSources
      //var instance = new AmazonSecurityLake.GetDataLakeSourcesResponse();
      //expect(instance).to.be();
    });
