...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.AwsLogSourceResource();
  });
  ...
  describe('AwsLogSourceResource', function() {
    it('should create an instance of AwsLogSourceResource', function() {
      // uncomment below and update the code to test AwsLogSourceResource
      //var instance = new AmazonSecurityLake.AwsLogSourceResource();
      //expect(instance).to.be.a(AmazonSecurityLake.AwsLogSourceResource);
    });
