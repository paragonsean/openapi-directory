...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateDataLakeRequest();
  });
  ...
  describe('CreateDataLakeRequest', function() {
    it('should create an instance of CreateDataLakeRequest', function() {
      // uncomment below and update the code to test CreateDataLakeRequest
      //var instance = new AmazonSecurityLake.CreateDataLakeRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateDataLakeRequest);
    });
    ...
    it('should have the property metaStoreManagerRoleArn (base name: "metaStoreManagerRoleArn")', function() {
      // uncomment below and update the code to test the property metaStoreManagerRoleArn
      //var instance = new AmazonSecurityLake.CreateDataLakeRequest();
      //expect(instance).to.be();
    });
