...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.ListDataLakesResponse();
  });
  ...
  describe('ListDataLakesResponse', function() {
    it('should create an instance of ListDataLakesResponse', function() {
      // uncomment below and update the code to test ListDataLakesResponse
      //var instance = new AmazonSecurityLake.ListDataLakesResponse();
      //expect(instance).to.be.a(AmazonSecurityLake.ListDataLakesResponse);
    });
