...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.DataLakeAutoEnableNewAccountConfiguration();
  });
  ...
  describe('DataLakeAutoEnableNewAccountConfiguration', function() {
    it('should create an instance of DataLakeAutoEnableNewAccountConfiguration', function() {
      // uncomment below and update the code to test DataLakeAutoEnableNewAccountConfiguration
      //var instance = new AmazonSecurityLake.DataLakeAutoEnableNewAccountConfiguration();
      //expect(instance).to.be.a(AmazonSecurityLake.DataLakeAutoEnableNewAccountConfiguration);
    });
