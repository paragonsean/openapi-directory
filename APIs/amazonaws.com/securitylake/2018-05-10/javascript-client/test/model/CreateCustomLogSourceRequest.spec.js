...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSecurityLake.CreateCustomLogSourceRequest();
  });
  ...
  describe('CreateCustomLogSourceRequest', function() {
    it('should create an instance of CreateCustomLogSourceRequest', function() {
      // uncomment below and update the code to test CreateCustomLogSourceRequest
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceRequest();
      //expect(instance).to.be.a(AmazonSecurityLake.CreateCustomLogSourceRequest);
    });
    ...
    it('should have the property eventClasses (base name: "eventClasses")', function() {
      // uncomment below and update the code to test the property eventClasses
      //var instance = new AmazonSecurityLake.CreateCustomLogSourceRequest();
      //expect(instance).to.be();
    });
