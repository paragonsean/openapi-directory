...
class CustomLogSourceConfiguration(Model):
    ...
    def __init__(self, crawler_configuration: CreateCustomLogSourceRequestConfigurationCrawlerConfiguration=None, provider_identity: CreateCustomLogSourceRequestConfigurationProviderIdentity=None):
        """CustomLogSourceConfiguration - a model defined in OpenAPI

        :param crawler_configuration: The crawler_configuration of this CustomLogSourceConfiguration.
        :param provider_identity: The provider_identity of this CustomLogSourceConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomLogSourceConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomLogSourceConfiguration of this CustomLogSourceConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def crawler_configuration(self):
        """Gets the crawler_configuration of this CustomLogSourceConfiguration.


        :return: The crawler_configuration of this CustomLogSourceConfiguration.
    ...
    def crawler_configuration(self, crawler_configuration):
        """Sets the crawler_configuration of this CustomLogSourceConfiguration.
    ...
    def provider_identity(self):
        """Gets the provider_identity of this CustomLogSourceConfiguration.


        :return: The provider_identity of this CustomLogSourceConfiguration.
    ...
    def provider_identity(self, provider_identity):
        """Sets the provider_identity of this CustomLogSourceConfiguration.
