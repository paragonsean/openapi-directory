...
class CreateChannelRequestElasticChannelConfiguration(Model):
    ...
    def __init__(self, maximum_sub_channels: int=None, target_memberships_per_sub_channel: int=None, minimum_membership_percentage: int=None):
        """CreateChannelRequestElasticChannelConfiguration - a model defined in OpenAPI

        :param maximum_sub_channels: The maximum_sub_channels of this CreateChannelRequestElasticChannelConfiguration.
        :param target_memberships_per_sub_channel: The target_memberships_per_sub_channel of this CreateChannelRequestElasticChannelConfiguration.
        :param minimum_membership_percentage: The minimum_membership_percentage of this CreateChannelRequestElasticChannelConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateChannelRequestElasticChannelConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateChannelRequest_ElasticChannelConfiguration of this CreateChannelRequestElasticChannelConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def maximum_sub_channels(self):
        """Gets the maximum_sub_channels of this CreateChannelRequestElasticChannelConfiguration.


        :return: The maximum_sub_channels of this CreateChannelRequestElasticChannelConfiguration.
        :rtype: int
        """
    ...
    def maximum_sub_channels(self, maximum_sub_channels):
        """Sets the maximum_sub_channels of this CreateChannelRequestElasticChannelConfiguration.
    ...
    def target_memberships_per_sub_channel(self):
        """Gets the target_memberships_per_sub_channel of this CreateChannelRequestElasticChannelConfiguration.


        :return: The target_memberships_per_sub_channel of this CreateChannelRequestElasticChannelConfiguration.
        :rtype: int
        """
    ...
    def target_memberships_per_sub_channel(self, target_memberships_per_sub_channel):
        """Sets the target_memberships_per_sub_channel of this CreateChannelRequestElasticChannelConfiguration.
    ...
    def minimum_membership_percentage(self):
        """Gets the minimum_membership_percentage of this CreateChannelRequestElasticChannelConfiguration.


        :return: The minimum_membership_percentage of this CreateChannelRequestElasticChannelConfiguration.
        :rtype: int
        """
    ...
    def minimum_membership_percentage(self, minimum_membership_percentage):
        """Sets the minimum_membership_percentage of this CreateChannelRequestElasticChannelConfiguration.
