...
/*
 * OAIBatchChannelMemberships.h
 *
 * The membership information, including member ARNs, the channel ARN, and membership types.
 */

#ifndef OAIBatchChannelMemberships_H
#define OAIBatchChannelMemberships_H
...
class OAIBatchChannelMemberships : public OAIObject {
public:
    OAIBatchChannelMemberships();
    OAIBatchChannelMemberships(QString json);
    ~OAIBatchChannelMemberships() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchChannelMemberships)

#endif // OAIBatchChannelMemberships_H
