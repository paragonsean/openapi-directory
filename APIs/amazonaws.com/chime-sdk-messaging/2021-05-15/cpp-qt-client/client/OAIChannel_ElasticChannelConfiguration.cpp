...
OAIChannel_ElasticChannelConfiguration::OAIChannel_ElasticChannelConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannel_ElasticChannelConfiguration::OAIChannel_ElasticChannelConfiguration() {
    this->initializeModel();
}

OAIChannel_ElasticChannelConfiguration::~OAIChannel_ElasticChannelConfiguration() {}

void OAIChannel_ElasticChannelConfiguration::initializeModel() {
...
void OAIChannel_ElasticChannelConfiguration::fromJson(QString jsonString) {
...
void OAIChannel_ElasticChannelConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIChannel_ElasticChannelConfiguration::asJson() const {
...
QJsonObject OAIChannel_ElasticChannelConfiguration::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIChannel_ElasticChannelConfiguration::getMaximumSubChannels() const {
    return m_maximum_sub_channels;
}
void OAIChannel_ElasticChannelConfiguration::setMaximumSubChannels(const qint32 &maximum_sub_channels) {
    m_maximum_sub_channels = maximum_sub_channels;
    m_maximum_sub_channels_isSet = true;
}

bool OAIChannel_ElasticChannelConfiguration::is_maximum_sub_channels_Set() const{
    return m_maximum_sub_channels_isSet;
}

bool OAIChannel_ElasticChannelConfiguration::is_maximum_sub_channels_Valid() const{
    return m_maximum_sub_channels_isValid;
}

qint32 OAIChannel_ElasticChannelConfiguration::getTargetMembershipsPerSubChannel() const {
    return m_target_memberships_per_sub_channel;
}
void OAIChannel_ElasticChannelConfiguration::setTargetMembershipsPerSubChannel(const qint32 &target_memberships_per_sub_channel) {
    m_target_memberships_per_sub_channel = target_memberships_per_sub_channel;
    m_target_memberships_per_sub_channel_isSet = true;
}

bool OAIChannel_ElasticChannelConfiguration::is_target_memberships_per_sub_channel_Set() const{
    return m_target_memberships_per_sub_channel_isSet;
}

bool OAIChannel_ElasticChannelConfiguration::is_target_memberships_per_sub_channel_Valid() const{
    return m_target_memberships_per_sub_channel_isValid;
}

qint32 OAIChannel_ElasticChannelConfiguration::getMinimumMembershipPercentage() const {
    return m_minimum_membership_percentage;
}
void OAIChannel_ElasticChannelConfiguration::setMinimumMembershipPercentage(const qint32 &minimum_membership_percentage) {
    m_minimum_membership_percentage = minimum_membership_percentage;
    m_minimum_membership_percentage_isSet = true;
}

bool OAIChannel_ElasticChannelConfiguration::is_minimum_membership_percentage_Set() const{
    return m_minimum_membership_percentage_isSet;
}

bool OAIChannel_ElasticChannelConfiguration::is_minimum_membership_percentage_Valid() const{
    return m_minimum_membership_percentage_isValid;
}

bool OAIChannel_ElasticChannelConfiguration::isSet() const {
...
bool OAIChannel_ElasticChannelConfiguration::isValid() const {
