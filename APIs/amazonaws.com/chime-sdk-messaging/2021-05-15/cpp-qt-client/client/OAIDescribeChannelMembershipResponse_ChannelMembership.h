...
/*
 * OAIDescribeChannelMembershipResponse_ChannelMembership.h
 *
 * 
 */

#ifndef OAIDescribeChannelMembershipResponse_ChannelMembership_H
#define OAIDescribeChannelMembershipResponse_ChannelMembership_H
...
class OAIDescribeChannelMembershipResponse_ChannelMembership : public OAIObject {
public:
    OAIDescribeChannelMembershipResponse_ChannelMembership();
    OAIDescribeChannelMembershipResponse_ChannelMembership(QString json);
    ~OAIDescribeChannelMembershipResponse_ChannelMembership() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeChannelMembershipResponse_ChannelMembership)

#endif // OAIDescribeChannelMembershipResponse_ChannelMembership_H
