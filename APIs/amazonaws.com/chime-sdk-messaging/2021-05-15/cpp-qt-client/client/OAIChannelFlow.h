...
#ifndef OAIChannelFlow_H
#define OAIChannelFlow_H
...
class OAIChannelFlow : public OAIObject {
public:
    OAIChannelFlow();
    OAIChannelFlow(QString json);
    ~OAIChannelFlow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelFlow)

#endif // OAIChannelFlow_H
