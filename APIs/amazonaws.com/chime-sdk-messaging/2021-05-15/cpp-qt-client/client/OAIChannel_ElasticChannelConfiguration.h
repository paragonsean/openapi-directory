...
/*
 * OAIChannel_ElasticChannelConfiguration.h
 *
 * 
 */

#ifndef OAIChannel_ElasticChannelConfiguration_H
#define OAIChannel_ElasticChannelConfiguration_H
...
class OAIChannel_ElasticChannelConfiguration : public OAIObject {
public:
    OAIChannel_ElasticChannelConfiguration();
    OAIChannel_ElasticChannelConfiguration(QString json);
    ~OAIChannel_ElasticChannelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannel_ElasticChannelConfiguration)

#endif // OAIChannel_ElasticChannelConfiguration_H
