...
/*
 * OAICreateChannelRequest_ElasticChannelConfiguration.h
 *
 * 
 */

#ifndef OAICreateChannelRequest_ElasticChannelConfiguration_H
#define OAICreateChannelRequest_ElasticChannelConfiguration_H
...
class OAICreateChannelRequest_ElasticChannelConfiguration : public OAIObject {
public:
    OAICreateChannelRequest_ElasticChannelConfiguration();
    OAICreateChannelRequest_ElasticChannelConfiguration(QString json);
    ~OAICreateChannelRequest_ElasticChannelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelRequest_ElasticChannelConfiguration)

#endif // OAICreateChannelRequest_ElasticChannelConfiguration_H
