...
QString OAIChannel::getChannelFlowArn() const {
    return m_channel_flow_arn;
}
void OAIChannel::setChannelFlowArn(const QString &channel_flow_arn) {
    m_channel_flow_arn = channel_flow_arn;
    m_channel_flow_arn_isSet = true;
}

bool OAIChannel::is_channel_flow_arn_Set() const{
    return m_channel_flow_arn_isSet;
}

bool OAIChannel::is_channel_flow_arn_Valid() const{
    return m_channel_flow_arn_isValid;
}

OAIChannel_ElasticChannelConfiguration OAIChannel::getElasticChannelConfiguration() const {
    return m_elastic_channel_configuration;
}
void OAIChannel::setElasticChannelConfiguration(const OAIChannel_ElasticChannelConfiguration &elastic_channel_configuration) {
    m_elastic_channel_configuration = elastic_channel_configuration;
    m_elastic_channel_configuration_isSet = true;
}

bool OAIChannel::is_elastic_channel_configuration_Set() const{
    return m_elastic_channel_configuration_isSet;
}

bool OAIChannel::is_elastic_channel_configuration_Valid() const{
    return m_elastic_channel_configuration_isValid;
}

OAIChannel_ExpirationSettings OAIChannel::getExpirationSettings() const {
    return m_expiration_settings;
}
void OAIChannel::setExpirationSettings(const OAIChannel_ExpirationSettings &expiration_settings) {
    m_expiration_settings = expiration_settings;
    m_expiration_settings_isSet = true;
}

bool OAIChannel::is_expiration_settings_Set() const{
    return m_expiration_settings_isSet;
}

bool OAIChannel::is_expiration_settings_Valid() const{
