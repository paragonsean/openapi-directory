...
/*
 * OAIChannelFlowCallback_request_ChannelMessage.h
 *
 * Stores information about a callback.
 */

#ifndef OAIChannelFlowCallback_request_ChannelMessage_H
#define OAIChannelFlowCallback_request_ChannelMessage_H
...
class OAIChannelFlowCallback_request_ChannelMessage : public OAIObject {
public:
    OAIChannelFlowCallback_request_ChannelMessage();
    OAIChannelFlowCallback_request_ChannelMessage(QString json);
    ~OAIChannelFlowCallback_request_ChannelMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelFlowCallback_request_ChannelMessage)

#endif // OAIChannelFlowCallback_request_ChannelMessage_H
