...
/*
 * OAICreateChannel_request_ElasticChannelConfiguration.h
 *
 * The attributes required to configure and create an elastic channel. An elastic channel can support a maximum of 1-million members.
 */

#ifndef OAICreateChannel_request_ElasticChannelConfiguration_H
#define OAICreateChannel_request_ElasticChannelConfiguration_H
...
class OAICreateChannel_request_ElasticChannelConfiguration : public OAIObject {
public:
    OAICreateChannel_request_ElasticChannelConfiguration();
    OAICreateChannel_request_ElasticChannelConfiguration(QString json);
    ~OAICreateChannel_request_ElasticChannelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannel_request_ElasticChannelConfiguration)

#endif // OAICreateChannel_request_ElasticChannelConfiguration_H
