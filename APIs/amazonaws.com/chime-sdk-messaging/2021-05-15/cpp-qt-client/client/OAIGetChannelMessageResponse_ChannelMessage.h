...
/*
 * OAIGetChannelMessageResponse_ChannelMessage.h
 *
 * 
 */

#ifndef OAIGetChannelMessageResponse_ChannelMessage_H
#define OAIGetChannelMessageResponse_ChannelMessage_H
...
class OAISendChannelMessageResponse_Status;

class OAIGetChannelMessageResponse_ChannelMessage : public OAIObject {
public:
    OAIGetChannelMessageResponse_ChannelMessage();
    OAIGetChannelMessageResponse_ChannelMessage(QString json);
    ~OAIGetChannelMessageResponse_ChannelMessage() override;
    ...
    OAISendChannelMessageResponse_Status getStatus() const;
    void setStatus(const OAISendChannelMessageResponse_Status &status);
...
private:
    ...
    OAISendChannelMessageResponse_Status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChannelMessageResponse_ChannelMessage)

#endif // OAIGetChannelMessageResponse_ChannelMessage_H
