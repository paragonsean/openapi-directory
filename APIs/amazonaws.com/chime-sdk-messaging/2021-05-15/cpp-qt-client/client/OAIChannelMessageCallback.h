...
/*
 * OAIChannelMessageCallback.h
 *
 * Stores information about a callback.
 */

#ifndef OAIChannelMessageCallback_H
#define OAIChannelMessageCallback_H
...
class OAIChannelMessageCallback : public OAIObject {
public:
    OAIChannelMessageCallback();
    OAIChannelMessageCallback(QString json);
    ~OAIChannelMessageCallback() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelMessageCallback)

#endif // OAIChannelMessageCallback_H
