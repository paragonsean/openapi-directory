...
public class MessageAttributeValue {
  ...
  public MessageAttributeValue stringValues(List stringValues) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stringValues, messageAttributeValue.stringValues);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("StringValues") != null && !jsonObj.get("StringValues").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("StringValues"));
      }
  }
