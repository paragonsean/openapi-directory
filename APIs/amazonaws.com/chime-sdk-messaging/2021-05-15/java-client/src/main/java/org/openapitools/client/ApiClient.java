...
public class ApiClient {
    ...
    private String basePath = "http://messaging-chime.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://messaging-chime.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://messaging-chime.{region}.amazonaws.com",
      "The Amazon Chime SDK Messaging multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://messaging-chime.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://messaging-chime.{region}.amazonaws.com.cn",
      "The Amazon Chime SDK Messaging endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-05-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://messaging-chime.us-east-1.amazonaws.com
