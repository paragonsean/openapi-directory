# AmazonChimeSdkMessaging.BatchCreateChannelMembershipRequest
...
**memberArns** | **[String]** | The ARNs of the members you want to add to the channel. Only &lt;code&gt;AppInstanceUsers&lt;/code&gt; and &lt;code&gt;AppInstanceBots&lt;/code&gt; can be added as a channel member. | 
