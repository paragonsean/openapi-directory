...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.Identity();
  });
  ...
  describe('Identity', function() {
    it('should create an instance of Identity', function() {
      ...
      //var instance = new AmazonChimeSdkMessaging.Identity();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.Identity);
    });
