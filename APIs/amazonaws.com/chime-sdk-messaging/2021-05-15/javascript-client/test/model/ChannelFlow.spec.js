...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.ChannelFlow();
  });
  ...
  describe('ChannelFlow', function() {
    it('should create an instance of ChannelFlow', function() {
      // uncomment below and update the code to test ChannelFlow
      //var instance = new AmazonChimeSdkMessaging.ChannelFlow();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.ChannelFlow);
    });
