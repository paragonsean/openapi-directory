...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.CreateChannelFlowRequest();
  });
  ...
  describe('CreateChannelFlowRequest', function() {
    it('should create an instance of CreateChannelFlowRequest', function() {
      // uncomment below and update the code to test CreateChannelFlowRequest
      //var instance = new AmazonChimeSdkMessaging.CreateChannelFlowRequest();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.CreateChannelFlowRequest);
    });
