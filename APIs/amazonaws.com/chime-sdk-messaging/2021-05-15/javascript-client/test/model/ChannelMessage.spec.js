...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.ChannelMessage();
  });
  ...
  describe('ChannelMessage', function() {
    it('should create an instance of ChannelMessage', function() {
      // uncomment below and update the code to test ChannelMessage
      //var instance = new AmazonChimeSdkMessaging.ChannelMessage();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.ChannelMessage);
    });
