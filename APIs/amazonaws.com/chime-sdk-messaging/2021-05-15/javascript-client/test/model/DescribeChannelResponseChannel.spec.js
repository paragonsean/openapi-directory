...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.DescribeChannelResponseChannel();
  });
  ...
  describe('DescribeChannelResponseChannel', function() {
    it('should create an instance of DescribeChannelResponseChannel', function() {
      // uncomment below and update the code to test DescribeChannelResponseChannel
      //var instance = new AmazonChimeSdkMessaging.DescribeChannelResponseChannel();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.DescribeChannelResponseChannel);
    });
