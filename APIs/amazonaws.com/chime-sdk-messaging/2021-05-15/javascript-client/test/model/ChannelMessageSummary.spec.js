...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChimeSdkMessaging.ChannelMessageSummary();
  });
  ...
  describe('ChannelMessageSummary', function() {
    it('should create an instance of ChannelMessageSummary', function() {
      // uncomment below and update the code to test ChannelMessageSummary
      //var instance = new AmazonChimeSdkMessaging.ChannelMessageSummary();
      //expect(instance).to.be.a(AmazonChimeSdkMessaging.ChannelMessageSummary);
    });
