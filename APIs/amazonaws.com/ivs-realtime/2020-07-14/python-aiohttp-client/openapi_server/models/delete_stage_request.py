...
class DeleteStageRequest(Model):
    ...
    def __init__(self, arn: str=None):
        """DeleteStageRequest - a model defined in OpenAPI

        :param arn: The arn of this DeleteStageRequest.
        """
        self.openapi_types = {
            'arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteStageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteStage_request of this DeleteStageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def arn(self):
        """Gets the arn of this DeleteStageRequest.

        ARN of the stage to be deleted.

        :return: The arn of this DeleteStageRequest.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this DeleteStageRequest.
