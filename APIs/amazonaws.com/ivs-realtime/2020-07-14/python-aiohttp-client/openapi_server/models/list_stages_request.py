...
class ListStagesRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListStagesRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListStagesRequest.
        :param next_token: The next_token of this ListStagesRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListStagesRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListStages_request of this ListStagesRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListStagesRequest.

        Maximum number of results to return. Default: 50.

        :return: The max_results of this ListStagesRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListStagesRequest.
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListStagesRequest.
