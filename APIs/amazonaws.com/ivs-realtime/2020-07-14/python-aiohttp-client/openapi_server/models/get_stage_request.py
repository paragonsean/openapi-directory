...
class GetStageRequest(Model):
    ...
    def __init__(self, arn: str=None):
        """GetStageRequest - a model defined in OpenAPI

        :param arn: The arn of this GetStageRequest.
        """
        self.openapi_types = {
            'arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetStageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetStage_request of this GetStageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def arn(self):
        """Gets the arn of this GetStageRequest.

        ARN of the stage for which the information is to be retrieved.

        :return: The arn of this GetStageRequest.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this GetStageRequest.
