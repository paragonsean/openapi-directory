...
async def test_create_participant_token(client):
    """Test case for create_participant_token

    
    """
    body = {"duration":"","capabilities":"","stageArn":"","attributes":"","userId":""}
    headers = { 
...
async def test_create_stage(client):
    ...
    """
    body = {"participantTokenConfigurations":"","name":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_disconnect_participant(client):
    ...
    """
    body = {"participantId":"","reason":"","stageArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_participant(client):
    """Test case for get_participant

    
    """
    body = {"participantId":"","stageArn":"","sessionId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_stage(client):
...
async def test_get_stage_session(client):
    """Test case for get_stage_session

    
    """
    body = {"stageArn":"","sessionId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_participant_events(client):
    """Test case for list_participant_events

    
    """
    body = {"participantId":"","stageArn":"","maxResults":"","nextToken":"","sessionId":""}
...
async def test_list_participants(client):
    ...
    """
    body = {"filterByUserId":"","filterByState":"","stageArn":"","maxResults":"","nextToken":"","filterByPublished":"","sessionId":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_stage_sessions(client):
    """Test case for list_stage_sessions

    
    """
    body = {"stageArn":"","maxResults":"","nextToken":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
