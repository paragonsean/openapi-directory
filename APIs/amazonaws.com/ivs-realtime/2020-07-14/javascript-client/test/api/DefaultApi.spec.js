...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AmazonInteractiveVideoServiceRealTime);
  }
}(this, function(expect, AmazonInteractiveVideoServiceRealTime) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('createParticipantToken', function() {
      it('should call createParticipantToken successfully', function(done) {
        //uncomment below and update the code to test createParticipantToken
        //instance.createParticipantToken(function(error) {
    ...
    describe('disconnectParticipant', function() {
      it('should call disconnectParticipant successfully', function(done) {
        //uncomment below and update the code to test disconnectParticipant
        //instance.disconnectParticipant(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getStageSession', function() {
      it('should call getStageSession successfully', function(done) {
        //uncomment below and update the code to test getStageSession
        //instance.getStageSession(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listParticipantEvents', function() {
      it('should call listParticipantEvents successfully', function(done) {
        //uncomment below and update the code to test listParticipantEvents
        //instance.listParticipantEvents(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listStageSessions', function() {
      it('should call listStageSessions successfully', function(done) {
        //uncomment below and update the code to test listStageSessions
        //instance.listStageSessions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
