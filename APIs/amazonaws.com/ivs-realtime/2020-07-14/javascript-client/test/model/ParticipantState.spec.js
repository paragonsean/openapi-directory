...
(function(root, factory) {
  ...
  describe('ParticipantState', function() {
    it('should create an instance of ParticipantState', function() {
      // uncomment below and update the code to test ParticipantState
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantState();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ParticipantState);
    });
