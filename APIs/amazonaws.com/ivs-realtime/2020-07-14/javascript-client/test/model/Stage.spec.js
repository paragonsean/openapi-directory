...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.Stage();
  });
  ...
  describe('Stage', function() {
    it('should create an instance of Stage', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.Stage();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.Stage);
    });
