...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.Participant();
  });
  ...
  describe('Participant', function() {
    it('should create an instance of Participant', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.Participant();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.Participant);
    });
