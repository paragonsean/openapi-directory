...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantEventsRequest();
  });
  ...
  describe('ListParticipantEventsRequest', function() {
    it('should create an instance of ListParticipantEventsRequest', function() {
      // uncomment below and update the code to test ListParticipantEventsRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantEventsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListParticipantEventsRequest);
    });
    ...
    it('should have the property stageArn (base name: "stageArn")', function() {
      // uncomment below and update the code to test the property stageArn
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantEventsRequest();
      //expect(instance).to.be();
    });
