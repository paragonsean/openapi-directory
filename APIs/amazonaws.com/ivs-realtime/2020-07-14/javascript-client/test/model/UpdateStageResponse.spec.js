...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageResponse();
  });
  ...
  describe('UpdateStageResponse', function() {
    it('should create an instance of UpdateStageResponse', function() {
      // uncomment below and update the code to test UpdateStageResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.UpdateStageResponse);
    });
