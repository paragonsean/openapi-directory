...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.StageSummary();
  });
  ...
  describe('StageSummary', function() {
    it('should create an instance of StageSummary', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.StageSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.StageSummary);
    });

    it('should have the property activeSessionId (base name: "activeSessionId")', function() {
      // uncomment below and update the code to test the property activeSessionId
      //var instance = new AmazonInteractiveVideoServiceRealTime.StageSummary();
