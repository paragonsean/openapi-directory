...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateStageRequest();
  });
  ...
  describe('CreateStageRequest', function() {
    it('should create an instance of CreateStageRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateStageRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateStageRequest);
    });
    ...
    it('should have the property participantTokenConfigurations (base name: "participantTokenConfigurations")', function() {
      // uncomment below and update the code to test the property participantTokenConfigurations
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateStageRequest();
      //expect(instance).to.be();
    });
