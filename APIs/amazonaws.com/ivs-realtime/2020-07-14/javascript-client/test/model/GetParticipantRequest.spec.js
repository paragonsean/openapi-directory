...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantRequest();
  });
  ...
  describe('GetParticipantRequest', function() {
    it('should create an instance of GetParticipantRequest', function() {
      // uncomment below and update the code to test GetParticipantRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetParticipantRequest);
    });
