...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListStageSessionsResponse();
  });
  ...
  describe('ListStageSessionsResponse', function() {
    it('should create an instance of ListStageSessionsResponse', function() {
      // uncomment below and update the code to test ListStageSessionsResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListStageSessionsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListStageSessionsResponse);
    });
    ...
    it('should have the property stageSessions (base name: "stageSessions")', function() {
      // uncomment below and update the code to test the property stageSessions
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListStageSessionsResponse();
      //expect(instance).to.be();
    });
