...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListStageSessionsRequest();
  });
  ...
  describe('ListStageSessionsRequest', function() {
    it('should create an instance of ListStageSessionsRequest', function() {
      // uncomment below and update the code to test ListStageSessionsRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListStageSessionsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListStageSessionsRequest);
    });
