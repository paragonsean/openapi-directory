...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.TagResourceRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.TagResourceRequest);
    });
