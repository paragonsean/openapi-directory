...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest();
  });
  ...
  describe('ListParticipantsRequest', function() {
    it('should create an instance of ListParticipantsRequest', function() {
      // uncomment below and update the code to test ListParticipantsRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest);
    });

    it('should have the property filterByPublished (base name: "filterByPublished")', function() {
      // uncomment below and update the code to test the property filterByPublished
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest();
      //expect(instance).to.be();
    });

    it('should have the property filterByState (base name: "filterByState")', function() {
      // uncomment below and update the code to test the property filterByState
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest();
      //expect(instance).to.be();
    });

    it('should have the property filterByUserId (base name: "filterByUserId")', function() {
      // uncomment below and update the code to test the property filterByUserId
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsRequest();
      //expect(instance).to.be();
    });
