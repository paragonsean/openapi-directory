...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.DisconnectParticipantRequest();
  });
  ...
  describe('DisconnectParticipantRequest', function() {
    it('should create an instance of DisconnectParticipantRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.DisconnectParticipantRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.DisconnectParticipantRequest);
    });
