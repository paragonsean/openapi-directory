...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageResponse();
  });
  ...
  describe('GetStageResponse', function() {
    it('should create an instance of GetStageResponse', function() {
      // uncomment below and update the code to test GetStageResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageResponse);
    });
