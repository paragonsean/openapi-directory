...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ParticipantTokenConfiguration();
  });
  ...
  describe('ParticipantTokenConfiguration', function() {
    it('should create an instance of ParticipantTokenConfiguration', function() {
      // uncomment below and update the code to test ParticipantTokenConfiguration
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantTokenConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ParticipantTokenConfiguration);
    });
