...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateStageResponseStage();
  });
  ...
  describe('CreateStageResponseStage', function() {
    it('should create an instance of CreateStageResponseStage', function() {
      // uncomment below and update the code to test CreateStageResponseStage
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateStageResponseStage();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateStageResponseStage);
    });
