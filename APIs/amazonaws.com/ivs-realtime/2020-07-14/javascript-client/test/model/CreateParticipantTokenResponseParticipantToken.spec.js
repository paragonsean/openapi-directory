...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponseParticipantToken();
  });
  ...
  describe('CreateParticipantTokenResponseParticipantToken', function() {
    it('should create an instance of CreateParticipantTokenResponseParticipantToken', function() {
      // uncomment below and update the code to test CreateParticipantTokenResponseParticipantToken
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponseParticipantToken();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponseParticipantToken);
    });
