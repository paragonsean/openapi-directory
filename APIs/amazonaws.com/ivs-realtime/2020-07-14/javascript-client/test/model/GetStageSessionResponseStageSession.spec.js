...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionResponseStageSession();
  });
  ...
  describe('GetStageSessionResponseStageSession', function() {
    it('should create an instance of GetStageSessionResponseStageSession', function() {
      // uncomment below and update the code to test GetStageSessionResponseStageSession
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionResponseStageSession();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageSessionResponseStageSession);
    });
