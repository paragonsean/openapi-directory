...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageRequest();
  });
  ...
  describe('GetStageRequest', function() {
    it('should create an instance of GetStageRequest', function() {
      // uncomment below and update the code to test GetStageRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageRequest);
    });
