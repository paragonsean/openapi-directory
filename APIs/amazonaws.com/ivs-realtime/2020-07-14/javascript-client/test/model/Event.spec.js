...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.Event();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.Event);
    });
    ...
    it('should have the property remoteParticipantId (base name: "remoteParticipantId")', function() {
      // uncomment below and update the code to test the property remoteParticipantId
      //var instance = new AmazonInteractiveVideoServiceRealTime.Event();
      //expect(instance).to.be();
    });
