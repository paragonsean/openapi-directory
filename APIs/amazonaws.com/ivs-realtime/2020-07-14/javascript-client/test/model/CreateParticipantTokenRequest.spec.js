...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenRequest();
  });
  ...
  describe('CreateParticipantTokenRequest', function() {
    it('should create an instance of CreateParticipantTokenRequest', function() {
      // uncomment below and update the code to test CreateParticipantTokenRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenRequest);
    });
