...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ParticipantToken();
  });
  ...
  describe('ParticipantToken', function() {
    it('should create an instance of ParticipantToken', function() {
      // uncomment below and update the code to test ParticipantToken
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantToken();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ParticipantToken);
    });
