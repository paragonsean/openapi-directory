...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.StageSession();
  });
  ...
  describe('StageSession', function() {
    it('should create an instance of StageSession', function() {
      // uncomment below and update the code to test StageSession
      //var instance = new AmazonInteractiveVideoServiceRealTime.StageSession();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.StageSession);
    });
