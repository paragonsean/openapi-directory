...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageRequest();
  });
  ...
  describe('UpdateStageRequest', function() {
    it('should create an instance of UpdateStageRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.UpdateStageRequest);
    });
