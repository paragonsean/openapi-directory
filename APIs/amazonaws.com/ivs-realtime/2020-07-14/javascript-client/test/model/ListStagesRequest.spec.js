...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListStagesRequest();
  });
  ...
  describe('ListStagesRequest', function() {
    it('should create an instance of ListStagesRequest', function() {
      // uncomment below and update the code to test ListStagesRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListStagesRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListStagesRequest);
    });
