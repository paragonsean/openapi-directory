...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListStagesResponse();
  });
  ...
  describe('ListStagesResponse', function() {
    it('should create an instance of ListStagesResponse', function() {
      // uncomment below and update the code to test ListStagesResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListStagesResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListStagesResponse);
    });
