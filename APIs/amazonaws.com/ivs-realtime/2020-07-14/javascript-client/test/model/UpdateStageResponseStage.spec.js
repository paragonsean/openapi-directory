...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageResponseStage();
  });
  ...
  describe('UpdateStageResponseStage', function() {
    it('should create an instance of UpdateStageResponseStage', function() {
      // uncomment below and update the code to test UpdateStageResponseStage
      //var instance = new AmazonInteractiveVideoServiceRealTime.UpdateStageResponseStage();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.UpdateStageResponseStage);
    });
