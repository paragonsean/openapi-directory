...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateStageResponse();
  });
  ...
  describe('CreateStageResponse', function() {
    it('should create an instance of CreateStageResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateStageResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateStageResponse);
    });

    it('should have the property participantTokens (base name: "participantTokens")', function() {
      // uncomment below and update the code to test the property participantTokens
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateStageResponse();
