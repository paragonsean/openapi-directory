...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.StageSessionSummary();
  });
  ...
  describe('StageSessionSummary', function() {
    it('should create an instance of StageSessionSummary', function() {
      // uncomment below and update the code to test StageSessionSummary
      //var instance = new AmazonInteractiveVideoServiceRealTime.StageSessionSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.StageSessionSummary);
    });
