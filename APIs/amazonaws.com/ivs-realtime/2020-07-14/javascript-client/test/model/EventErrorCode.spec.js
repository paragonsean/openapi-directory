...
(function(root, factory) {
  ...
  describe('EventErrorCode', function() {
    it('should create an instance of EventErrorCode', function() {
      // uncomment below and update the code to test EventErrorCode
      //var instance = new AmazonInteractiveVideoServiceRealTime.EventErrorCode();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.EventErrorCode);
    });
