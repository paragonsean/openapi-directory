...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponse();
  });
  ...
  describe('CreateParticipantTokenResponse', function() {
    it('should create an instance of CreateParticipantTokenResponse', function() {
      // uncomment below and update the code to test CreateParticipantTokenResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.CreateParticipantTokenResponse);
    });
