...
(function(root, factory) {
  ...
  describe('ParticipantTokenCapability', function() {
    it('should create an instance of ParticipantTokenCapability', function() {
      // uncomment below and update the code to test ParticipantTokenCapability
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantTokenCapability();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ParticipantTokenCapability);
    });
