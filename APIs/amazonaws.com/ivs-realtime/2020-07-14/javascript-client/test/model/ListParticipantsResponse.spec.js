...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsResponse();
  });
  ...
  describe('ListParticipantsResponse', function() {
    it('should create an instance of ListParticipantsResponse', function() {
      // uncomment below and update the code to test ListParticipantsResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListParticipantsResponse);
    });
