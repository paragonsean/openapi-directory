...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageResponseStage();
  });
  ...
  describe('GetStageResponseStage', function() {
    it('should create an instance of GetStageResponseStage', function() {
      // uncomment below and update the code to test GetStageResponseStage
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageResponseStage();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageResponseStage);
    });
