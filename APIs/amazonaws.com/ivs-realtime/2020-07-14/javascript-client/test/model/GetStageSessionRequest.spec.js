...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionRequest();
  });
  ...
  describe('GetStageSessionRequest', function() {
    it('should create an instance of GetStageSessionRequest', function() {
      // uncomment below and update the code to test GetStageSessionRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageSessionRequest);
    });
