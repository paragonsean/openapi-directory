...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantEventsResponse();
  });
  ...
  describe('ListParticipantEventsResponse', function() {
    it('should create an instance of ListParticipantEventsResponse', function() {
      // uncomment below and update the code to test ListParticipantEventsResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.ListParticipantEventsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ListParticipantEventsResponse);
    });
