...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantResponse();
  });
  ...
  describe('GetParticipantResponse', function() {
    it('should create an instance of GetParticipantResponse', function() {
      // uncomment below and update the code to test GetParticipantResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetParticipantResponse);
    });
