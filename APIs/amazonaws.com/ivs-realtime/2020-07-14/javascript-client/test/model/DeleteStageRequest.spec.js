...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.DeleteStageRequest();
  });
  ...
  describe('DeleteStageRequest', function() {
    it('should create an instance of DeleteStageRequest', function() {
      // uncomment below and update the code to test DeleteStageRequest
      //var instance = new AmazonInteractiveVideoServiceRealTime.DeleteStageRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.DeleteStageRequest);
    });
