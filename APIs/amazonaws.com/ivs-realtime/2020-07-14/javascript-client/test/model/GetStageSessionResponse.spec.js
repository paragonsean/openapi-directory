...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionResponse();
  });
  ...
  describe('GetStageSessionResponse', function() {
    it('should create an instance of GetStageSessionResponse', function() {
      // uncomment below and update the code to test GetStageSessionResponse
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetStageSessionResponse);
    });

    it('should have the property stageSession (base name: "stageSession")', function() {
      // uncomment below and update the code to test the property stageSession
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetStageSessionResponse();
