...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantResponseParticipant();
  });
  ...
  describe('GetParticipantResponseParticipant', function() {
    it('should create an instance of GetParticipantResponseParticipant', function() {
      // uncomment below and update the code to test GetParticipantResponseParticipant
      //var instance = new AmazonInteractiveVideoServiceRealTime.GetParticipantResponseParticipant();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.GetParticipantResponseParticipant);
    });
