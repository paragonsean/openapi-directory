...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoServiceRealTime.ParticipantSummary();
  });
  ...
  describe('ParticipantSummary', function() {
    it('should create an instance of ParticipantSummary', function() {
      // uncomment below and update the code to test ParticipantSummary
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoServiceRealTime.ParticipantSummary);
    });

    it('should have the property firstJoinTime (base name: "firstJoinTime")', function() {
      // uncomment below and update the code to test the property firstJoinTime
      //var instance = new AmazonInteractiveVideoServiceRealTime.ParticipantSummary();
