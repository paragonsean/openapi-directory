...
/**
 * The GetParticipantRequest model module.
 * @module model/GetParticipantRequest
 * @version 2020-07-14
 */
class GetParticipantRequest {
    /**
     * Constructs a new <code>GetParticipantRequest</code>.
     * @alias module:model/GetParticipantRequest
     * @param participantId {String} Unique identifier for the participant. This is assigned by IVS and returned by <a>CreateParticipantToken</a>.
    ...
    constructor(participantId, sessionId, stageArn) { 
        ...
        GetParticipantRequest.initialize(this, participantId, sessionId, stageArn);
    }
    ...
    /**
     * Constructs a <code>GetParticipantRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetParticipantRequest} obj Optional instance to populate.
     * @return {module:model/GetParticipantRequest} The populated <code>GetParticipantRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetParticipantRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetParticipantRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetParticipantRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetParticipantRequest.RequiredProperties) {
...
GetParticipantRequest.RequiredProperties = ["participantId", "sessionId", "stageArn"];
 ...
 */
GetParticipantRequest.prototype['participantId'] = undefined;

/**
 * ID of a session within the stage.
 * @member {String} sessionId
 */
GetParticipantRequest.prototype['sessionId'] = undefined;

/**
 * Stage ARN.
 * @member {String} stageArn
 */
GetParticipantRequest.prototype['stageArn'] = undefined;
...
export default GetParticipantRequest;
