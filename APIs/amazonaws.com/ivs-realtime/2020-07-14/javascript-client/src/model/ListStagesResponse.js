...
/**
 * The ListStagesResponse model module.
 * @module model/ListStagesResponse
 * @version 2020-07-14
 */
class ListStagesResponse {
    /**
     * Constructs a new <code>ListStagesResponse</code>.
     * @alias module:model/ListStagesResponse
     * @param stages {Array} 
     */
    constructor(stages) { 
        
        ListStagesResponse.initialize(this, stages);
    }
    ...
    /**
     * Constructs a <code>ListStagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStagesResponse} obj Optional instance to populate.
     * @return {module:model/ListStagesResponse} The populated <code>ListStagesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStagesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStagesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStagesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStagesResponse.RequiredProperties) {
...
ListStagesResponse.RequiredProperties = ["stages"];

/**
 * @member {String} nextToken
 */
ListStagesResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} stages
 */
ListStagesResponse.prototype['stages'] = undefined;
...
export default ListStagesResponse;
