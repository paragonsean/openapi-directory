...
/**
 * The GetStageRequest model module.
 * @module model/GetStageRequest
 * @version 2020-07-14
 */
class GetStageRequest {
    /**
     * Constructs a new <code>GetStageRequest</code>.
     * @alias module:model/GetStageRequest
     * @param arn {String} ARN of the stage for which the information is to be retrieved.
     */
    constructor(arn) { 
        
        GetStageRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>GetStageRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStageRequest} obj Optional instance to populate.
     * @return {module:model/GetStageRequest} The populated <code>GetStageRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStageRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStageRequest.RequiredProperties) {
...
GetStageRequest.RequiredProperties = ["arn"];

/**
 * ARN of the stage for which the information is to be retrieved.
 * @member {String} arn
 */
GetStageRequest.prototype['arn'] = undefined;
...
export default GetStageRequest;
