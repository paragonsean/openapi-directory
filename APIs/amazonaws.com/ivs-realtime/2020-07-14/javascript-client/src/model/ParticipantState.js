...
export default class ParticipantState {
    ...
    /**
    * Returns a <code>ParticipantState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ParticipantState} The enum <code>ParticipantState</code> value.
    */
