...
/**
 * The ListStageSessionsResponse model module.
 * @module model/ListStageSessionsResponse
 * @version 2020-07-14
 */
class ListStageSessionsResponse {
    /**
     * Constructs a new <code>ListStageSessionsResponse</code>.
     * @alias module:model/ListStageSessionsResponse
     * @param stageSessions {Array} 
     */
    constructor(stageSessions) { 
        
        ListStageSessionsResponse.initialize(this, stageSessions);
    }
     ...
     */
    static initialize(obj, stageSessions) { 
        obj['stageSessions'] = stageSessions;
    }

    /**
     * Constructs a <code>ListStageSessionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStageSessionsResponse} obj Optional instance to populate.
     * @return {module:model/ListStageSessionsResponse} The populated <code>ListStageSessionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStageSessionsResponse();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('stageSessions')) {
                obj['stageSessions'] = ApiClient.convertToType(data['stageSessions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListStageSessionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStageSessionsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStageSessionsResponse.RequiredProperties) {
        ...
        // validate the optional field `stageSessions`
        if (data['stageSessions']) { // data not null
          Array.validateJSON(data['stageSessions']);
        }
...
ListStageSessionsResponse.RequiredProperties = ["stageSessions"];

/**
 * @member {String} nextToken
 */
ListStageSessionsResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} stageSessions
 */
ListStageSessionsResponse.prototype['stageSessions'] = undefined;
...
export default ListStageSessionsResponse;
