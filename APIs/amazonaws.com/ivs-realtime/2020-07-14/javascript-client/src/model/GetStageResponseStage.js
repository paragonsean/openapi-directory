...
/**
 * The GetStageResponseStage model module.
 * @module model/GetStageResponseStage
 * @version 2020-07-14
 */
class GetStageResponseStage {
    /**
     * Constructs a new <code>GetStageResponseStage</code>.
     * @alias module:model/GetStageResponseStage
     * @implements module:model/Stage
     * @param arn {String} 
     */
    constructor(arn) { 
        Stage.initialize(this, arn);
        GetStageResponseStage.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>GetStageResponseStage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStageResponseStage} obj Optional instance to populate.
     * @return {module:model/GetStageResponseStage} The populated <code>GetStageResponseStage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStageResponseStage();
            Stage.constructFromObject(data, obj);

            if (data.hasOwnProperty('activeSessionId')) {
                obj['activeSessionId'] = ApiClient.convertToType(data['activeSessionId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStageResponseStage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStageResponseStage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStageResponseStage.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `activeSessionId`
        if (data['activeSessionId']) { // data not null
          String.validateJSON(data['activeSessionId']);
        }
...
GetStageResponseStage.RequiredProperties = ["arn"];

/**
 * @member {String} activeSessionId
 */
GetStageResponseStage.prototype['activeSessionId'] = undefined;

/**
 * @member {String} arn
 */
GetStageResponseStage.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
GetStageResponseStage.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
GetStageResponseStage.prototype['tags'] = undefined;
 ...
 * @member {String} activeSessionId
 */
Stage.prototype['activeSessionId'] = undefined;
/**
 * @member {String} arn
 */
Stage.prototype['arn'] = undefined;
/**
 * @member {String} name
 */
...
export default GetStageResponseStage;
