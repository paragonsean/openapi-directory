...
/**
 * The UpdateStageResponseStage model module.
 * @module model/UpdateStageResponseStage
 * @version 2020-07-14
 */
class UpdateStageResponseStage {
    /**
     * Constructs a new <code>UpdateStageResponseStage</code>.
     * @alias module:model/UpdateStageResponseStage
     * @implements module:model/Stage
     * @param arn {String} 
     */
    constructor(arn) { 
        Stage.initialize(this, arn);
        UpdateStageResponseStage.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>UpdateStageResponseStage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateStageResponseStage} obj Optional instance to populate.
     * @return {module:model/UpdateStageResponseStage} The populated <code>UpdateStageResponseStage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateStageResponseStage();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateStageResponseStage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateStageResponseStage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateStageResponseStage.RequiredProperties) {
...
UpdateStageResponseStage.RequiredProperties = ["arn"];

/**
 * @member {String} activeSessionId
 */
UpdateStageResponseStage.prototype['activeSessionId'] = undefined;

/**
 * @member {String} arn
 */
UpdateStageResponseStage.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
UpdateStageResponseStage.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
UpdateStageResponseStage.prototype['tags'] = undefined;
...
export default UpdateStageResponseStage;
