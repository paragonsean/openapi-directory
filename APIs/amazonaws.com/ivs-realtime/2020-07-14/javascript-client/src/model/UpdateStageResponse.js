...
import UpdateStageResponseStage from './UpdateStageResponseStage';
...
class UpdateStageResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stage')) {
                obj['stage'] = UpdateStageResponseStage.constructFromObject(data['stage']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['stage']) { // data not null
          UpdateStageResponseStage.validateJSON(data['stage']);
        }
...
/**
 * @member {module:model/UpdateStageResponseStage} stage
 */
UpdateStageResponse.prototype['stage'] = undefined;
