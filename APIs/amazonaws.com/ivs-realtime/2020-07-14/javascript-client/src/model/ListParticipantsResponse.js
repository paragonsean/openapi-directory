...
/**
 * The ListParticipantsResponse model module.
 * @module model/ListParticipantsResponse
 * @version 2020-07-14
 */
class ListParticipantsResponse {
    /**
     * Constructs a new <code>ListParticipantsResponse</code>.
     * @alias module:model/ListParticipantsResponse
     * @param participants {Array} 
     */
    constructor(participants) { 
        
        ListParticipantsResponse.initialize(this, participants);
    }
    ...
    /**
     * Constructs a <code>ListParticipantsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListParticipantsResponse} obj Optional instance to populate.
     * @return {module:model/ListParticipantsResponse} The populated <code>ListParticipantsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListParticipantsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListParticipantsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListParticipantsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListParticipantsResponse.RequiredProperties) {
...
ListParticipantsResponse.RequiredProperties = ["participants"];

/**
 * @member {String} nextToken
 */
ListParticipantsResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} participants
 */
ListParticipantsResponse.prototype['participants'] = undefined;
...
export default ListParticipantsResponse;
