...
import GetStageSessionResponseStageSession from './GetStageSessionResponseStageSession';

/**
 * The GetStageSessionResponse model module.
 * @module model/GetStageSessionResponse
 * @version 2020-07-14
 */
class GetStageSessionResponse {
    /**
     * Constructs a new <code>GetStageSessionResponse</code>.
     * @alias module:model/GetStageSessionResponse
     */
    constructor() { 
        
        GetStageSessionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStageSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStageSessionResponse} obj Optional instance to populate.
     * @return {module:model/GetStageSessionResponse} The populated <code>GetStageSessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStageSessionResponse();

            if (data.hasOwnProperty('stageSession')) {
                obj['stageSession'] = GetStageSessionResponseStageSession.constructFromObject(data['stageSession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStageSessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStageSessionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `stageSession`
        if (data['stageSession']) { // data not null
          GetStageSessionResponseStageSession.validateJSON(data['stageSession']);
        }
...
/**
 * @member {module:model/GetStageSessionResponseStageSession} stageSession
 */
GetStageSessionResponse.prototype['stageSession'] = undefined;
...
export default GetStageSessionResponse;
