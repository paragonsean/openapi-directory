...
* @readonly
*/
export default class ParticipantTokenCapability {
    ...
    /**
    * Returns a <code>ParticipantTokenCapability</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ParticipantTokenCapability} The enum <code>ParticipantTokenCapability</code> value.
    */
