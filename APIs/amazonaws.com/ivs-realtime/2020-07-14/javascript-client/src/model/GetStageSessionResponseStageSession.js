...
/**
 * The GetStageSessionResponseStageSession model module.
 * @module model/GetStageSessionResponseStageSession
 * @version 2020-07-14
 */
class GetStageSessionResponseStageSession {
    /**
     * Constructs a new <code>GetStageSessionResponseStageSession</code>.
     * @alias module:model/GetStageSessionResponseStageSession
     * @implements module:model/StageSession
     */
    constructor() { 
        StageSession.initialize(this);
        GetStageSessionResponseStageSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStageSessionResponseStageSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStageSessionResponseStageSession} obj Optional instance to populate.
     * @return {module:model/GetStageSessionResponseStageSession} The populated <code>GetStageSessionResponseStageSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStageSessionResponseStageSession();
            StageSession.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetStageSessionResponseStageSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStageSessionResponseStageSession</code>.
     */
 ...
 * @member {Date} endTime
 */
GetStageSessionResponseStageSession.prototype['endTime'] = undefined;

/**
 * @member {String} sessionId
 */
GetStageSessionResponseStageSession.prototype['sessionId'] = undefined;

/**
 * @member {Date} startTime
 */
GetStageSessionResponseStageSession.prototype['startTime'] = undefined;


// Implement StageSession interface:
/**
 * @member {Date} endTime
 */
StageSession.prototype['endTime'] = undefined;
/**
 * @member {String} sessionId
 */
StageSession.prototype['sessionId'] = undefined;
/**
 * @member {Date} startTime
 */
StageSession.prototype['startTime'] = undefined;




export default GetStageSessionResponseStageSession;
