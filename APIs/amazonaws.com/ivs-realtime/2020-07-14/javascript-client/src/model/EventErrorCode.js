...
* @readonly
*/
export default class EventErrorCode {
    ...
    /**
    * Returns a <code>EventErrorCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventErrorCode} The enum <code>EventErrorCode</code> value.
    */
