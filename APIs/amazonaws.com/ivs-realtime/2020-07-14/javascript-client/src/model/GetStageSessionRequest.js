...
/**
 * The GetStageSessionRequest model module.
 * @module model/GetStageSessionRequest
 * @version 2020-07-14
 */
class GetStageSessionRequest {
    /**
     * Constructs a new <code>GetStageSessionRequest</code>.
     * @alias module:model/GetStageSessionRequest
     * @param sessionId {String} ID of a session within the stage.
     * @param stageArn {String} ARN of the stage for which the information is to be retrieved.
     */
    constructor(sessionId, stageArn) { 
        
        GetStageSessionRequest.initialize(this, sessionId, stageArn);
    }
     ...
     */
    static initialize(obj, sessionId, stageArn) { 
        obj['sessionId'] = sessionId;
        obj['stageArn'] = stageArn;
    }

    /**
     * Constructs a <code>GetStageSessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStageSessionRequest} obj Optional instance to populate.
     * @return {module:model/GetStageSessionRequest} The populated <code>GetStageSessionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStageSessionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStageSessionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStageSessionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStageSessionRequest.RequiredProperties) {
...
GetStageSessionRequest.RequiredProperties = ["sessionId", "stageArn"];

/**
 * ID of a session within the stage.
 * @member {String} sessionId
 */
GetStageSessionRequest.prototype['sessionId'] = undefined;

/**
 * ARN of the stage for which the information is to be retrieved.
 * @member {String} stageArn
 */
GetStageSessionRequest.prototype['stageArn'] = undefined;
...
export default GetStageSessionRequest;
