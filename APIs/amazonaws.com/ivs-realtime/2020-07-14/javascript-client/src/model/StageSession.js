...
/**
 * The StageSession model module.
 * @module model/StageSession
 * @version 2020-07-14
 */
class StageSession {
    /**
     * Constructs a new <code>StageSession</code>.
     ...
     * @alias module:model/StageSession
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StageSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageSession} obj Optional instance to populate.
     * @return {module:model/StageSession} The populated <code>StageSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageSession();
    ...
    /**
     * Validates the JSON data with respect to <code>StageSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageSession</code>.
     */
