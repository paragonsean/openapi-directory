...
import ParticipantTokenConfiguration from './ParticipantTokenConfiguration';
...
class CreateStageRequest {
    ...
    constructor() { 
        ...
        CreateStageRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('participantTokenConfigurations')) {
                obj['participantTokenConfigurations'] = ApiClient.convertToType(data['participantTokenConfigurations'], [ParticipantTokenConfiguration]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['participantTokenConfigurations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['participantTokenConfigurations'])) {
                throw new Error("Expected the field `participantTokenConfigurations` to be an array in the JSON data but got " + data['participantTokenConfigurations']);
            }
            // validate the optional field `participantTokenConfigurations` (array)
            for (const item of data['participantTokenConfigurations']) {
                ParticipantTokenConfiguration.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ParticipantTokenConfiguration>} participantTokenConfigurations
 */
CreateStageRequest.prototype['participantTokenConfigurations'] = undefined;
