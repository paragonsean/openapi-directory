...
import GetStageResponseStage from './GetStageResponseStage';
...
class GetStageResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stage')) {
                obj['stage'] = GetStageResponseStage.constructFromObject(data['stage']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['stage']) { // data not null
          GetStageResponseStage.validateJSON(data['stage']);
        }
...
/**
 * @member {module:model/GetStageResponseStage} stage
 */
GetStageResponse.prototype['stage'] = undefined;
