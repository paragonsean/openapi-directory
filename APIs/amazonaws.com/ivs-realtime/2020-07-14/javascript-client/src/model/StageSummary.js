...
class StageSummary {
    ...
    constructor(arn) { 
        ...
        StageSummary.initialize(this, arn);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of StageSummary.RequiredProperties) {
...
StageSummary.RequiredProperties = ["arn"];

/**
 * @member {String} activeSessionId
 */
StageSummary.prototype['activeSessionId'] = undefined;

/**
 * @member {String} arn
 */
StageSummary.prototype['arn'] = undefined;
