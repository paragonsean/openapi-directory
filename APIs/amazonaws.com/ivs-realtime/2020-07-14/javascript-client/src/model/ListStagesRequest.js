...
/**
 * The ListStagesRequest model module.
 * @module model/ListStagesRequest
 * @version 2020-07-14
 */
class ListStagesRequest {
    /**
     * Constructs a new <code>ListStagesRequest</code>.
     * @alias module:model/ListStagesRequest
     */
    constructor() { 
        
        ListStagesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListStagesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStagesRequest} obj Optional instance to populate.
     * @return {module:model/ListStagesRequest} The populated <code>ListStagesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStagesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStagesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStagesRequest</code>.
     */
...
export default ListStagesRequest;
