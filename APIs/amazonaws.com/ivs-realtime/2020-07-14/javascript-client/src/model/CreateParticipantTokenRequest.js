...
import ParticipantTokenCapability from './ParticipantTokenCapability';

/**
 * The CreateParticipantTokenRequest model module.
 * @module model/CreateParticipantTokenRequest
 * @version 2020-07-14
 */
class CreateParticipantTokenRequest {
    /**
     * Constructs a new <code>CreateParticipantTokenRequest</code>.
     * @alias module:model/CreateParticipantTokenRequest
     * @param stageArn {String} ARN of the stage to which this token is scoped.
     */
    constructor(stageArn) { 
        
        CreateParticipantTokenRequest.initialize(this, stageArn);
    }
     ...
     */
    static initialize(obj, stageArn) { 
        obj['stageArn'] = stageArn;
    }

    /**
     * Constructs a <code>CreateParticipantTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateParticipantTokenRequest} obj Optional instance to populate.
     * @return {module:model/CreateParticipantTokenRequest} The populated <code>CreateParticipantTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateParticipantTokenRequest();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ApiClient.convertToType(data['attributes'], {'String': 'String'});
            }
            if (data.hasOwnProperty('capabilities')) {
                obj['capabilities'] = ApiClient.convertToType(data['capabilities'], [ParticipantTokenCapability]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateParticipantTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateParticipantTokenRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateParticipantTokenRequest.RequiredProperties) {
...
CreateParticipantTokenRequest.RequiredProperties = ["stageArn"];
 ...
 */
CreateParticipantTokenRequest.prototype['attributes'] = undefined;

/**
 * Set of capabilities that the user is allowed to perform in the stage. Default: <code>PUBLISH, SUBSCRIBE</code>.
 * @member {Array.<module:model/ParticipantTokenCapability>} capabilities
 */
CreateParticipantTokenRequest.prototype['capabilities'] = undefined;

/**
 * Duration (in minutes), after which the token expires. Default: 720 (12 hours).
 * @member {Number} duration
 */
CreateParticipantTokenRequest.prototype['duration'] = undefined;

/**
 * ARN of the stage to which this token is scoped.
 * @member {String} stageArn
 */
CreateParticipantTokenRequest.prototype['stageArn'] = undefined;
 ...
 */
CreateParticipantTokenRequest.prototype['userId'] = undefined;
...
export default CreateParticipantTokenRequest;
