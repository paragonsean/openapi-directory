...
/**
 * The StageSessionSummary model module.
 * @module model/StageSessionSummary
 * @version 2020-07-14
 */
class StageSessionSummary {
    /**
     * Constructs a new <code>StageSessionSummary</code>.
     * Summary information about a stage session.
     * @alias module:model/StageSessionSummary
     */
    constructor() { 
        
        StageSessionSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StageSessionSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StageSessionSummary} obj Optional instance to populate.
     * @return {module:model/StageSessionSummary} The populated <code>StageSessionSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StageSessionSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>StageSessionSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StageSessionSummary</code>.
     */
 ...
 * @member {Date} endTime
 */
StageSessionSummary.prototype['endTime'] = undefined;

/**
 * @member {String} sessionId
 */
StageSessionSummary.prototype['sessionId'] = undefined;

/**
 * @member {Date} startTime
 */
StageSessionSummary.prototype['startTime'] = undefined;
...
export default StageSessionSummary;
