...
/**
 * The ParticipantSummary model module.
 * @module model/ParticipantSummary
 * @version 2020-07-14
 */
class ParticipantSummary {
    /**
     * Constructs a new <code>ParticipantSummary</code>.
     * Summary object describing a participant that has joined a stage.
     * @alias module:model/ParticipantSummary
     */
    constructor() { 
        
        ParticipantSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ParticipantSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ParticipantSummary} obj Optional instance to populate.
     * @return {module:model/ParticipantSummary} The populated <code>ParticipantSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParticipantSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ParticipantSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParticipantSummary</code>.
     */
 ...
 */
ParticipantSummary.prototype['firstJoinTime'] = undefined;

/**
 * @member {String} participantId
 */
ParticipantSummary.prototype['participantId'] = undefined;

/**
 * @member {Boolean} published
 */
ParticipantSummary.prototype['published'] = undefined;

/**
 * @member {module:model/ParticipantState} state
 */
ParticipantSummary.prototype['state'] = undefined;

/**
 * @member {String} userId
 */
ParticipantSummary.prototype['userId'] = undefined;
