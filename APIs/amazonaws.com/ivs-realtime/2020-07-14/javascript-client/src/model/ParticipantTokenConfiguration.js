...
/**
 * The ParticipantTokenConfiguration model module.
 * @module model/ParticipantTokenConfiguration
 * @version 2020-07-14
 */
class ParticipantTokenConfiguration {
    /**
     * Constructs a new <code>ParticipantTokenConfiguration</code>.
     * Object specifying a participant token configuration in a stage.
     * @alias module:model/ParticipantTokenConfiguration
     */
    constructor() { 
        
        ParticipantTokenConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ParticipantTokenConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ParticipantTokenConfiguration} obj Optional instance to populate.
     * @return {module:model/ParticipantTokenConfiguration} The populated <code>ParticipantTokenConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ParticipantTokenConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ParticipantTokenConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParticipantTokenConfiguration</code>.
     */
 ...
 */
ParticipantTokenConfiguration.prototype['attributes'] = undefined;

/**
 * @member {Array} capabilities
 */
ParticipantTokenConfiguration.prototype['capabilities'] = undefined;

/**
 * @member {Number} duration
 */
ParticipantTokenConfiguration.prototype['duration'] = undefined;

/**
 * @member {String} userId
 */
ParticipantTokenConfiguration.prototype['userId'] = undefined;
...
export default ParticipantTokenConfiguration;
