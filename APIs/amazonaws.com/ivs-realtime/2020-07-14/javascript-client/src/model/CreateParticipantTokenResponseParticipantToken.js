...
/**
 * The CreateParticipantTokenResponseParticipantToken model module.
 * @module model/CreateParticipantTokenResponseParticipantToken
 * @version 2020-07-14
 */
class CreateParticipantTokenResponseParticipantToken {
    /**
     * Constructs a new <code>CreateParticipantTokenResponseParticipantToken</code>.
     * @alias module:model/CreateParticipantTokenResponseParticipantToken
     * @implements module:model/ParticipantToken
     */
    constructor() { 
        ParticipantToken.initialize(this);
        CreateParticipantTokenResponseParticipantToken.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateParticipantTokenResponseParticipantToken</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateParticipantTokenResponseParticipantToken} obj Optional instance to populate.
     * @return {module:model/CreateParticipantTokenResponseParticipantToken} The populated <code>CreateParticipantTokenResponseParticipantToken</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateParticipantTokenResponseParticipantToken();
            ParticipantToken.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateParticipantTokenResponseParticipantToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateParticipantTokenResponseParticipantToken</code>.
     */
 ...
 */
CreateParticipantTokenResponseParticipantToken.prototype['attributes'] = undefined;

/**
 * @member {Array} capabilities
 */
CreateParticipantTokenResponseParticipantToken.prototype['capabilities'] = undefined;

/**
 * @member {Number} duration
 */
CreateParticipantTokenResponseParticipantToken.prototype['duration'] = undefined;

/**
 * @member {Date} expirationTime
 */
CreateParticipantTokenResponseParticipantToken.prototype['expirationTime'] = undefined;

/**
 * @member {String} participantId
 */
CreateParticipantTokenResponseParticipantToken.prototype['participantId'] = undefined;

/**
 * @member {String} token
 */
CreateParticipantTokenResponseParticipantToken.prototype['token'] = undefined;

/**
 * @member {String} userId
 */
CreateParticipantTokenResponseParticipantToken.prototype['userId'] = undefined;


// Implement ParticipantToken interface:
/**
 * @member {Object} attributes
 */
...
export default CreateParticipantTokenResponseParticipantToken;
