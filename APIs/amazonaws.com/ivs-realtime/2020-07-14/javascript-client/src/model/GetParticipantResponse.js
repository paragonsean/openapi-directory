...
import GetParticipantResponseParticipant from './GetParticipantResponseParticipant';

/**
 * The GetParticipantResponse model module.
 * @module model/GetParticipantResponse
 * @version 2020-07-14
 */
class GetParticipantResponse {
    /**
     * Constructs a new <code>GetParticipantResponse</code>.
     * @alias module:model/GetParticipantResponse
     */
    constructor() { 
        
        GetParticipantResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetParticipantResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetParticipantResponse} obj Optional instance to populate.
     * @return {module:model/GetParticipantResponse} The populated <code>GetParticipantResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetParticipantResponse();

            if (data.hasOwnProperty('participant')) {
                obj['participant'] = GetParticipantResponseParticipant.constructFromObject(data['participant']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetParticipantResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetParticipantResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `participant`
        if (data['participant']) { // data not null
          GetParticipantResponseParticipant.validateJSON(data['participant']);
        }
...
/**
 * @member {module:model/GetParticipantResponseParticipant} participant
 */
GetParticipantResponse.prototype['participant'] = undefined;
...
export default GetParticipantResponse;
