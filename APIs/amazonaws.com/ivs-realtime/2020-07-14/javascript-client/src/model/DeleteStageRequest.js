...
/**
 * The DeleteStageRequest model module.
 * @module model/DeleteStageRequest
 * @version 2020-07-14
 */
class DeleteStageRequest {
    /**
     * Constructs a new <code>DeleteStageRequest</code>.
     * @alias module:model/DeleteStageRequest
     * @param arn {String} ARN of the stage to be deleted.
     */
    constructor(arn) { 
        
        DeleteStageRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeleteStageRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteStageRequest} obj Optional instance to populate.
     * @return {module:model/DeleteStageRequest} The populated <code>DeleteStageRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteStageRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteStageRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteStageRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteStageRequest.RequiredProperties) {
...
DeleteStageRequest.RequiredProperties = ["arn"];

/**
 * ARN of the stage to be deleted.
 * @member {String} arn
 */
DeleteStageRequest.prototype['arn'] = undefined;
...
export default DeleteStageRequest;
