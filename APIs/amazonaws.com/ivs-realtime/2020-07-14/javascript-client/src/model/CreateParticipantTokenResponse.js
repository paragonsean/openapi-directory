...
import CreateParticipantTokenResponseParticipantToken from './CreateParticipantTokenResponseParticipantToken';

/**
 * The CreateParticipantTokenResponse model module.
 * @module model/CreateParticipantTokenResponse
 * @version 2020-07-14
 */
class CreateParticipantTokenResponse {
    /**
     * Constructs a new <code>CreateParticipantTokenResponse</code>.
     * @alias module:model/CreateParticipantTokenResponse
     */
    constructor() { 
        
        CreateParticipantTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateParticipantTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateParticipantTokenResponse} obj Optional instance to populate.
     * @return {module:model/CreateParticipantTokenResponse} The populated <code>CreateParticipantTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateParticipantTokenResponse();

            if (data.hasOwnProperty('participantToken')) {
                obj['participantToken'] = CreateParticipantTokenResponseParticipantToken.constructFromObject(data['participantToken']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateParticipantTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateParticipantTokenResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `participantToken`
        if (data['participantToken']) { // data not null
          CreateParticipantTokenResponseParticipantToken.validateJSON(data['participantToken']);
        }
...
/**
 * @member {module:model/CreateParticipantTokenResponseParticipantToken} participantToken
 */
CreateParticipantTokenResponse.prototype['participantToken'] = undefined;
...
export default CreateParticipantTokenResponse;
