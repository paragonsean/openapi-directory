...
/**
 * The ListParticipantEventsResponse model module.
 * @module model/ListParticipantEventsResponse
 * @version 2020-07-14
 */
class ListParticipantEventsResponse {
    /**
     * Constructs a new <code>ListParticipantEventsResponse</code>.
     * @alias module:model/ListParticipantEventsResponse
     * @param events {Array} 
     */
    constructor(events) { 
        
        ListParticipantEventsResponse.initialize(this, events);
    }
    ...
    /**
     * Constructs a <code>ListParticipantEventsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListParticipantEventsResponse} obj Optional instance to populate.
     * @return {module:model/ListParticipantEventsResponse} The populated <code>ListParticipantEventsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListParticipantEventsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListParticipantEventsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListParticipantEventsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListParticipantEventsResponse.RequiredProperties) {
...
ListParticipantEventsResponse.RequiredProperties = ["events"];

/**
 * @member {Array} events
 */
ListParticipantEventsResponse.prototype['events'] = undefined;

/**
 * @member {String} nextToken
 */
ListParticipantEventsResponse.prototype['nextToken'] = undefined;
...
export default ListParticipantEventsResponse;
