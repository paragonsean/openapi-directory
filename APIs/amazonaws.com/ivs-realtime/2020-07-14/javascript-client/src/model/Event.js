...
import EventErrorCode from './EventErrorCode';
...
class Event {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errorCode')) {
                obj['errorCode'] = ApiClient.convertToType(data['errorCode'], EventErrorCode);
            }
            if (data.hasOwnProperty('eventTime')) {
                obj['eventTime'] = ApiClient.convertToType(data['eventTime'], 'Date');
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], EventName);
            }
            if (data.hasOwnProperty('participantId')) {
                obj['participantId'] = ApiClient.convertToType(data['participantId'], 'String');
            }
            if (data.hasOwnProperty('remoteParticipantId')) {
                obj['remoteParticipantId'] = ApiClient.convertToType(data['remoteParticipantId'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['errorCode']) { // data not null
          EventErrorCode.validateJSON(data['errorCode']);
        }
        ...
        if (data['name']) { // data not null
          EventName.validateJSON(data['name']);
        }
        ...
        if (data['remoteParticipantId']) { // data not null
          String.validateJSON(data['remoteParticipantId']);
        }
...
/**
 * @member {module:model/EventErrorCode} errorCode
 */
Event.prototype['errorCode'] = undefined;
 ...
 */
Event.prototype['participantId'] = undefined;

/**
 * @member {String} remoteParticipantId
 */
Event.prototype['remoteParticipantId'] = undefined;
