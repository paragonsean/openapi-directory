...
/**
 * The CreateStageResponseStage model module.
 * @module model/CreateStageResponseStage
 * @version 2020-07-14
 */
class CreateStageResponseStage {
    /**
     * Constructs a new <code>CreateStageResponseStage</code>.
     * @alias module:model/CreateStageResponseStage
     * @implements module:model/Stage
     * @param arn {String} 
     */
    constructor(arn) { 
        Stage.initialize(this, arn);
        CreateStageResponseStage.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>CreateStageResponseStage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStageResponseStage} obj Optional instance to populate.
     * @return {module:model/CreateStageResponseStage} The populated <code>CreateStageResponseStage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStageResponseStage();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStageResponseStage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStageResponseStage</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateStageResponseStage.RequiredProperties) {
...
CreateStageResponseStage.RequiredProperties = ["arn"];

/**
 * @member {String} activeSessionId
 */
CreateStageResponseStage.prototype['activeSessionId'] = undefined;

/**
 * @member {String} arn
 */
CreateStageResponseStage.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
CreateStageResponseStage.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
CreateStageResponseStage.prototype['tags'] = undefined;
...
export default CreateStageResponseStage;
