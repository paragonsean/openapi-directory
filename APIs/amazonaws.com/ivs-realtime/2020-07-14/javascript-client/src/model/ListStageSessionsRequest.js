...
/**
 * The ListStageSessionsRequest model module.
 * @module model/ListStageSessionsRequest
 * @version 2020-07-14
 */
class ListStageSessionsRequest {
    /**
     * Constructs a new <code>ListStageSessionsRequest</code>.
     * @alias module:model/ListStageSessionsRequest
     * @param stageArn {String} Stage ARN.
     */
    constructor(stageArn) { 
        
        ListStageSessionsRequest.initialize(this, stageArn);
    }
    ...
    /**
     * Constructs a <code>ListStageSessionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStageSessionsRequest} obj Optional instance to populate.
     * @return {module:model/ListStageSessionsRequest} The populated <code>ListStageSessionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStageSessionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStageSessionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStageSessionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStageSessionsRequest.RequiredProperties) {
...
ListStageSessionsRequest.RequiredProperties = ["stageArn"];

/**
 * Maximum number of results to return. Default: 50.
 * @member {Number} maxResults
 */
ListStageSessionsRequest.prototype['maxResults'] = undefined;

/**
 * The first stage to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListStageSessionsRequest.prototype['nextToken'] = undefined;

/**
 * Stage ARN.
 * @member {String} stageArn
 */
ListStageSessionsRequest.prototype['stageArn'] = undefined;
...
export default ListStageSessionsRequest;
