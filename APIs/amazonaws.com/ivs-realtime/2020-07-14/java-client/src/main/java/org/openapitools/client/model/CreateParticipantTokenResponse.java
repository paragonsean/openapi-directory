...
import org.openapitools.client.model.CreateParticipantTokenResponseParticipantToken;
...
public class CreateParticipantTokenResponse {
  ...
  private CreateParticipantTokenResponseParticipantToken participantToken;

  public CreateParticipantTokenResponse() {
  }

  public CreateParticipantTokenResponse participantToken(CreateParticipantTokenResponseParticipantToken participantToken) {
  ...
  public CreateParticipantTokenResponseParticipantToken getParticipantToken() {
    return participantToken;
  }

  public void setParticipantToken(CreateParticipantTokenResponseParticipantToken participantToken) {
    this.participantToken = participantToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateParticipantTokenResponse createParticipantTokenResponse = (CreateParticipantTokenResponse) o;
    return Objects.equals(this.participantToken, createParticipantTokenResponse.participantToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(participantToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateParticipantTokenResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateParticipantTokenResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateParticipantTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateParticipantTokenResponse is not found in the empty JSON string", CreateParticipantTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateParticipantTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateParticipantTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("participantToken") != null && !jsonObj.get("participantToken").isJsonNull()) {
        CreateParticipantTokenResponseParticipantToken.validateJsonElement(jsonObj.get("participantToken"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateParticipantTokenResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateParticipantTokenResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateParticipantTokenResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateParticipantTokenResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateParticipantTokenResponse>() {
           @Override
           public void write(JsonWriter out, CreateParticipantTokenResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateParticipantTokenResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateParticipantTokenResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateParticipantTokenResponse
   * @throws IOException if the JSON string is invalid with respect to CreateParticipantTokenResponse
   */
  public static CreateParticipantTokenResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateParticipantTokenResponse.class);
  }

  /**
   * Convert an instance of CreateParticipantTokenResponse to an JSON string
   *
   * @return JSON string
   */
