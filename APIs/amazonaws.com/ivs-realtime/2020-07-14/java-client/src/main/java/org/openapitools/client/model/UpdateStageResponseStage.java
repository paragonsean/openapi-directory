...
public class UpdateStageResponseStage {
  ...
  public UpdateStageResponseStage() {
  }

  public UpdateStageResponseStage activeSessionId(String activeSessionId) {
  ...
  public UpdateStageResponseStage arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateStageResponseStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateStageResponseStage tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateStageResponseStage updateStageResponseStage = (UpdateStageResponseStage) o;
    return Objects.equals(this.activeSessionId, updateStageResponseStage.activeSessionId) &&
        Objects.equals(this.arn, updateStageResponseStage.arn) &&
        Objects.equals(this.name, updateStageResponseStage.name) &&
        Objects.equals(this.tags, updateStageResponseStage.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateStageResponseStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateStageResponseStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateStageResponseStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateStageResponseStage is not found in the empty JSON string", UpdateStageResponseStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateStageResponseStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateStageResponseStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateStageResponseStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateStageResponseStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateStageResponseStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateStageResponseStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateStageResponseStage.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateStageResponseStage>() {
           @Override
           public void write(JsonWriter out, UpdateStageResponseStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateStageResponseStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateStageResponseStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateStageResponseStage
   * @throws IOException if the JSON string is invalid with respect to UpdateStageResponseStage
   */
  public static UpdateStageResponseStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateStageResponseStage.class);
  }

  /**
   * Convert an instance of UpdateStageResponseStage to an JSON string
   *
   * @return JSON string
   */
