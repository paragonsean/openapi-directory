...
import org.openapitools.client.model.GetStageSessionResponseStageSession;
...
public class GetStageSessionResponse {
  public static final String SERIALIZED_NAME_STAGE_SESSION = "stageSession";
  @SerializedName(SERIALIZED_NAME_STAGE_SESSION)
  private GetStageSessionResponseStageSession stageSession;

  public GetStageSessionResponse() {
  }

  public GetStageSessionResponse stageSession(GetStageSessionResponseStageSession stageSession) {
  ...
  public GetStageSessionResponseStageSession getStageSession() {
    return stageSession;
  }

  public void setStageSession(GetStageSessionResponseStageSession stageSession) {
    this.stageSession = stageSession;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStageSessionResponse getStageSessionResponse = (GetStageSessionResponse) o;
    return Objects.equals(this.stageSession, getStageSessionResponse.stageSession);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stageSession);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStageSessionResponse {\n");
    sb.append("    stageSession: ").append(toIndentedString(stageSession)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("stageSession");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStageSessionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStageSessionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStageSessionResponse is not found in the empty JSON string", GetStageSessionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStageSessionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStageSessionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `stageSession`
      if (jsonObj.get("stageSession") != null && !jsonObj.get("stageSession").isJsonNull()) {
        GetStageSessionResponseStageSession.validateJsonElement(jsonObj.get("stageSession"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStageSessionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStageSessionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStageSessionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStageSessionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStageSessionResponse>() {
           @Override
           public void write(JsonWriter out, GetStageSessionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStageSessionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStageSessionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStageSessionResponse
   * @throws IOException if the JSON string is invalid with respect to GetStageSessionResponse
   */
  public static GetStageSessionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStageSessionResponse.class);
  }

  /**
   * Convert an instance of GetStageSessionResponse to an JSON string
   *
   * @return JSON string
   */
