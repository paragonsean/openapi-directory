...
public class GetStageRequest {
  ...
  public GetStageRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStageRequest getStageRequest = (GetStageRequest) o;
    return Objects.equals(this.arn, getStageRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStageRequest is not found in the empty JSON string", GetStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStageRequest>() {
           @Override
           public void write(JsonWriter out, GetStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStageRequest
   * @throws IOException if the JSON string is invalid with respect to GetStageRequest
   */
  public static GetStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStageRequest.class);
  }

  /**
   * Convert an instance of GetStageRequest to an JSON string
   *
   * @return JSON string
   */
