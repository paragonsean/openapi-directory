...
import org.openapitools.client.model.ParticipantTokenConfiguration;
...
public class CreateStageRequest {
  ...
  public static final String SERIALIZED_NAME_PARTICIPANT_TOKEN_CONFIGURATIONS = "participantTokenConfigurations";
  @SerializedName(SERIALIZED_NAME_PARTICIPANT_TOKEN_CONFIGURATIONS)
  private List<ParticipantTokenConfiguration> participantTokenConfigurations = new ArrayList<>();
  ...
  public CreateStageRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateStageRequest participantTokenConfigurations(List<ParticipantTokenConfiguration> participantTokenConfigurations) {
    this.participantTokenConfigurations = participantTokenConfigurations;
    return this;
  }

  public CreateStageRequest addParticipantTokenConfigurationsItem(ParticipantTokenConfiguration participantTokenConfigurationsItem) {
    if (this.participantTokenConfigurations == null) {
      this.participantTokenConfigurations = new ArrayList<>();
    }
    this.participantTokenConfigurations.add(participantTokenConfigurationsItem);
    return this;
  }
  ...
  public void setParticipantTokenConfigurations(List<ParticipantTokenConfiguration> participantTokenConfigurations) {
    this.participantTokenConfigurations = participantTokenConfigurations;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createStageRequest.name) &&
        Objects.equals(this.participantTokenConfigurations, createStageRequest.participantTokenConfigurations) &&
        Objects.equals(this.tags, createStageRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, participantTokenConfigurations, tags);
  }
  ...
  public String toString() {
    ...
    sb.append("    participantTokenConfigurations: ").append(toIndentedString(participantTokenConfigurations)).append("\n");
  ...
  static {
    ...
    openapiFields.add("participantTokenConfigurations");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("participantTokenConfigurations") != null && !jsonObj.get("participantTokenConfigurations").isJsonNull()) {
        JsonArray jsonArrayparticipantTokenConfigurations = jsonObj.getAsJsonArray("participantTokenConfigurations");
        if (jsonArrayparticipantTokenConfigurations != null) {
          // ensure the json data is an array
          if (!jsonObj.get("participantTokenConfigurations").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `participantTokenConfigurations` to be an array in the JSON string but got `%s`", jsonObj.get("participantTokenConfigurations").toString()));
          }

          // validate the optional field `participantTokenConfigurations` (array)
          for (int i = 0; i < jsonArrayparticipantTokenConfigurations.size(); i++) {
            ParticipantTokenConfiguration.validateJsonElement(jsonArrayparticipantTokenConfigurations.get(i));
          };
        }
      }
  }
