...
public class CreateStageResponse {
  public static final String SERIALIZED_NAME_PARTICIPANT_TOKENS = "participantTokens";
  @SerializedName(SERIALIZED_NAME_PARTICIPANT_TOKENS)
  private List participantTokens;

  public static final String SERIALIZED_NAME_STAGE = "stage";
  @SerializedName(SERIALIZED_NAME_STAGE)
  private CreateStageResponseStage stage;

  public CreateStageResponse() {
  }

  public CreateStageResponse participantTokens(List participantTokens) {
    this.participantTokens = participantTokens;
    return this;
  }

  /**
   * Get participantTokens
   * @return participantTokens
   */
  @javax.annotation.Nullable
  public List getParticipantTokens() {
    return participantTokens;
  }

  public void setParticipantTokens(List participantTokens) {
    this.participantTokens = participantTokens;
  }


  public CreateStageResponse stage(CreateStageResponseStage stage) {
    this.stage = stage;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CreateStageResponseStage getStage() {
    return stage;
  }

  public void setStage(CreateStageResponseStage stage) {
    this.stage = stage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.participantTokens, createStageResponse.participantTokens) &&
        Objects.equals(this.stage, createStageResponse.stage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(participantTokens, stage);
  }
  ...
  public String toString() {
    ...
    sb.append("    participantTokens: ").append(toIndentedString(participantTokens)).append("\n");
  ...
  static {
    ...
    openapiFields.add("participantTokens");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `participantTokens`
      if (jsonObj.get("participantTokens") != null && !jsonObj.get("participantTokens").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("participantTokens"));
      }
      // validate the optional field `stage`
      if (jsonObj.get("stage") != null && !jsonObj.get("stage").isJsonNull()) {
        CreateStageResponseStage.validateJsonElement(jsonObj.get("stage"));
      }
  }
