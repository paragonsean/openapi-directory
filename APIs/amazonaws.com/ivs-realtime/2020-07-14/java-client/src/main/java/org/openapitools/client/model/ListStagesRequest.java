...
public class ListStagesRequest {
  ...
  public ListStagesRequest maxResults(Integer maxResults) {
  ...
  public ListStagesRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListStagesRequest listStagesRequest = (ListStagesRequest) o;
    return Objects.equals(this.maxResults, listStagesRequest.maxResults) &&
        Objects.equals(this.nextToken, listStagesRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListStagesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStagesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStagesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStagesRequest is not found in the empty JSON string", ListStagesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStagesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStagesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStagesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStagesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStagesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStagesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStagesRequest>() {
           @Override
           public void write(JsonWriter out, ListStagesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStagesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStagesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStagesRequest
   * @throws IOException if the JSON string is invalid with respect to ListStagesRequest
   */
  public static ListStagesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStagesRequest.class);
  }

  /**
   * Convert an instance of ListStagesRequest to an JSON string
   *
   * @return JSON string
   */
