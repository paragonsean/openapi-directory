...
/**
 * Gets or Sets EventErrorCode
 */
@JsonAdapter(EventErrorCode.Adapter.class)
public enum EventErrorCode {
  ...
  public static EventErrorCode fromValue(String value) {
    for (EventErrorCode b : EventErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventErrorCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventErrorCode.fromValue(value);
  }
}
