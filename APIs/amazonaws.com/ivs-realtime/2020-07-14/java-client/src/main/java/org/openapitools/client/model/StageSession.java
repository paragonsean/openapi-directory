...
public class StageSession {
  ...
  public StageSession endTime(OffsetDateTime endTime) {
  ...
  public StageSession sessionId(String sessionId) {
  ...
  public StageSession startTime(OffsetDateTime startTime) {
  ...
  public boolean equals(Object o) {
    ...
    StageSession stageSession = (StageSession) o;
    return Objects.equals(this.endTime, stageSession.endTime) &&
        Objects.equals(this.sessionId, stageSession.sessionId) &&
        Objects.equals(this.startTime, stageSession.startTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageSession is not found in the empty JSON string", StageSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageSession.class));

       return (TypeAdapter<T>) new TypeAdapter<StageSession>() {
           @Override
           public void write(JsonWriter out, StageSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageSession
   * @throws IOException if the JSON string is invalid with respect to StageSession
   */
  public static StageSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageSession.class);
  }

  /**
   * Convert an instance of StageSession to an JSON string
   *
   * @return JSON string
   */
