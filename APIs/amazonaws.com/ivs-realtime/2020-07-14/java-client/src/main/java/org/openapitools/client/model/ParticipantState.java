...
/**
 * Gets or Sets ParticipantState
 */
@JsonAdapter(ParticipantState.Adapter.class)
public enum ParticipantState {
  ...
  public static ParticipantState fromValue(String value) {
    for (ParticipantState b : ParticipantState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ParticipantState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ParticipantState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ParticipantState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ParticipantState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ParticipantState.fromValue(value);
  }
}
