...
public class StageSessionSummary {
  ...
  public StageSessionSummary() {
  }

  public StageSessionSummary endTime(OffsetDateTime endTime) {
  ...
  public StageSessionSummary sessionId(String sessionId) {
  ...
  public StageSessionSummary startTime(OffsetDateTime startTime) {
  ...
  public boolean equals(Object o) {
    ...
    StageSessionSummary stageSessionSummary = (StageSessionSummary) o;
    return Objects.equals(this.endTime, stageSessionSummary.endTime) &&
        Objects.equals(this.sessionId, stageSessionSummary.sessionId) &&
        Objects.equals(this.startTime, stageSessionSummary.startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class StageSessionSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StageSessionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StageSessionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StageSessionSummary is not found in the empty JSON string", StageSessionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageSessionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageSessionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StageSessionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StageSessionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StageSessionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StageSessionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StageSessionSummary>() {
           @Override
           public void write(JsonWriter out, StageSessionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StageSessionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StageSessionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StageSessionSummary
   * @throws IOException if the JSON string is invalid with respect to StageSessionSummary
   */
  public static StageSessionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StageSessionSummary.class);
  }

  /**
   * Convert an instance of StageSessionSummary to an JSON string
   *
   * @return JSON string
   */
