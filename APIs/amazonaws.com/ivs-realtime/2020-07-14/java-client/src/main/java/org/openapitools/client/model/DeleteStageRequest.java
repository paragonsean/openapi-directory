...
public class DeleteStageRequest {
  ...
  public DeleteStageRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteStageRequest deleteStageRequest = (DeleteStageRequest) o;
    return Objects.equals(this.arn, deleteStageRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteStageRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteStageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteStageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteStageRequest is not found in the empty JSON string", DeleteStageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteStageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteStageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteStageRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteStageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteStageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteStageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteStageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteStageRequest>() {
           @Override
           public void write(JsonWriter out, DeleteStageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteStageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteStageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteStageRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteStageRequest
   */
  public static DeleteStageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteStageRequest.class);
  }

  /**
   * Convert an instance of DeleteStageRequest to an JSON string
   *
   * @return JSON string
   */
