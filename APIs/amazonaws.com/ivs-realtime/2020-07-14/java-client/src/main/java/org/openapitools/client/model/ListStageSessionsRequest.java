...
public class ListStageSessionsRequest {
  ...
  public ListStageSessionsRequest() {
  }

  public ListStageSessionsRequest maxResults(Integer maxResults) {
  ...
  public ListStageSessionsRequest nextToken(String nextToken) {
  ...
  public ListStageSessionsRequest stageArn(String stageArn) {
  ...
  public boolean equals(Object o) {
    ...
    ListStageSessionsRequest listStageSessionsRequest = (ListStageSessionsRequest) o;
    return Objects.equals(this.maxResults, listStageSessionsRequest.maxResults) &&
        Objects.equals(this.nextToken, listStageSessionsRequest.nextToken) &&
        Objects.equals(this.stageArn, listStageSessionsRequest.stageArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxResults, nextToken, stageArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListStageSessionsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStageSessionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStageSessionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStageSessionsRequest is not found in the empty JSON string", ListStageSessionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStageSessionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStageSessionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListStageSessionsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStageSessionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStageSessionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStageSessionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStageSessionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStageSessionsRequest>() {
           @Override
           public void write(JsonWriter out, ListStageSessionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStageSessionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStageSessionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStageSessionsRequest
   * @throws IOException if the JSON string is invalid with respect to ListStageSessionsRequest
   */
  public static ListStageSessionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStageSessionsRequest.class);
  }

  /**
   * Convert an instance of ListStageSessionsRequest to an JSON string
   *
   * @return JSON string
   */
