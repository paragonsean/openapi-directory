...
public class CreateStageResponseStage {
  ...
  public CreateStageResponseStage() {
  }

  public CreateStageResponseStage activeSessionId(String activeSessionId) {
  ...
  public CreateStageResponseStage arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateStageResponseStage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateStageResponseStage tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateStageResponseStage createStageResponseStage = (CreateStageResponseStage) o;
    return Objects.equals(this.activeSessionId, createStageResponseStage.activeSessionId) &&
        Objects.equals(this.arn, createStageResponseStage.arn) &&
        Objects.equals(this.name, createStageResponseStage.name) &&
        Objects.equals(this.tags, createStageResponseStage.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStageResponseStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStageResponseStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStageResponseStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStageResponseStage is not found in the empty JSON string", CreateStageResponseStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStageResponseStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStageResponseStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateStageResponseStage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStageResponseStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStageResponseStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStageResponseStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStageResponseStage.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStageResponseStage>() {
           @Override
           public void write(JsonWriter out, CreateStageResponseStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStageResponseStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStageResponseStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStageResponseStage
   * @throws IOException if the JSON string is invalid with respect to CreateStageResponseStage
   */
  public static CreateStageResponseStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStageResponseStage.class);
  }

  /**
   * Convert an instance of CreateStageResponseStage to an JSON string
   *
   * @return JSON string
   */
