...
public class GetStageSessionRequest {
  ...
  public GetStageSessionRequest() {
  }

  public GetStageSessionRequest sessionId(String sessionId) {
  ...
  public GetStageSessionRequest stageArn(String stageArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetStageSessionRequest getStageSessionRequest = (GetStageSessionRequest) o;
    return Objects.equals(this.sessionId, getStageSessionRequest.sessionId) &&
        Objects.equals(this.stageArn, getStageSessionRequest.stageArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sessionId, stageArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStageSessionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStageSessionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStageSessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStageSessionRequest is not found in the empty JSON string", GetStageSessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStageSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStageSessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStageSessionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStageSessionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStageSessionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStageSessionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStageSessionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStageSessionRequest>() {
           @Override
           public void write(JsonWriter out, GetStageSessionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStageSessionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStageSessionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStageSessionRequest
   * @throws IOException if the JSON string is invalid with respect to GetStageSessionRequest
   */
  public static GetStageSessionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStageSessionRequest.class);
  }

  /**
   * Convert an instance of GetStageSessionRequest to an JSON string
   *
   * @return JSON string
   */
