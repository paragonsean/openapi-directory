...
public class ListParticipantsResponse {
  ...
  public ListParticipantsResponse nextToken(String nextToken) {
  ...
  public ListParticipantsResponse participants(List participants) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listParticipantsResponse.nextToken) &&
        Objects.equals(this.participants, listParticipantsResponse.participants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, participants);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListParticipantsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListParticipantsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListParticipantsResponse is not found in the empty JSON string", ListParticipantsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListParticipantsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListParticipantsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListParticipantsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListParticipantsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListParticipantsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListParticipantsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListParticipantsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListParticipantsResponse>() {
           @Override
           public void write(JsonWriter out, ListParticipantsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListParticipantsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListParticipantsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListParticipantsResponse
   * @throws IOException if the JSON string is invalid with respect to ListParticipantsResponse
   */
  public static ListParticipantsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListParticipantsResponse.class);
  }

  /**
   * Convert an instance of ListParticipantsResponse to an JSON string
   *
   * @return JSON string
   */
