...
/**
 * Gets or Sets ParticipantTokenCapability
 */
@JsonAdapter(ParticipantTokenCapability.Adapter.class)
public enum ParticipantTokenCapability {
  ...
  ParticipantTokenCapability(String value) {
    this.value = value;
  }
  ...
  public static ParticipantTokenCapability fromValue(String value) {
    for (ParticipantTokenCapability b : ParticipantTokenCapability.values()) {
  ...
  public static class Adapter extends TypeAdapter<ParticipantTokenCapability> {
    @Override
    public void write(final JsonWriter jsonWriter, final ParticipantTokenCapability enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ParticipantTokenCapability read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ParticipantTokenCapability.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ParticipantTokenCapability.fromValue(value);
  }
}
