...
public class ParticipantSummary {
  ...
  public ParticipantSummary firstJoinTime(OffsetDateTime firstJoinTime) {
  ...
  public ParticipantSummary participantId(String participantId) {
  ...
  public ParticipantSummary published(Boolean published) {
  ...
  public ParticipantSummary state(ParticipantState state) {
    this.state = state;
    return this;
  }
  ...
  public ParticipantSummary userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstJoinTime, participantSummary.firstJoinTime) &&
        Objects.equals(this.participantId, participantSummary.participantId) &&
        Objects.equals(this.published, participantSummary.published) &&
        Objects.equals(this.state, participantSummary.state) &&
        Objects.equals(this.userId, participantSummary.userId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstJoinTime, participantId, published, state, userId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParticipantSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParticipantSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParticipantSummary is not found in the empty JSON string", ParticipantSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParticipantSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParticipantSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParticipantSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParticipantSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParticipantSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParticipantSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ParticipantSummary>() {
           @Override
           public void write(JsonWriter out, ParticipantSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ParticipantSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ParticipantSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParticipantSummary
   * @throws IOException if the JSON string is invalid with respect to ParticipantSummary
   */
  public static ParticipantSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParticipantSummary.class);
  }

  /**
   * Convert an instance of ParticipantSummary to an JSON string
   *
   * @return JSON string
   */
