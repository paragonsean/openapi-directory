...
public class ListParticipantEventsRequest {
  ...
  public ListParticipantEventsRequest() {
  }

  public ListParticipantEventsRequest maxResults(Integer maxResults) {
  ...
  public ListParticipantEventsRequest nextToken(String nextToken) {
  ...
  public ListParticipantEventsRequest participantId(String participantId) {
  ...
  public ListParticipantEventsRequest sessionId(String sessionId) {
  ...
  public ListParticipantEventsRequest stageArn(String stageArn) {
  ...
  public boolean equals(Object o) {
    ...
    ListParticipantEventsRequest listParticipantEventsRequest = (ListParticipantEventsRequest) o;
    return Objects.equals(this.maxResults, listParticipantEventsRequest.maxResults) &&
        Objects.equals(this.nextToken, listParticipantEventsRequest.nextToken) &&
        Objects.equals(this.participantId, listParticipantEventsRequest.participantId) &&
        Objects.equals(this.sessionId, listParticipantEventsRequest.sessionId) &&
        Objects.equals(this.stageArn, listParticipantEventsRequest.stageArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxResults, nextToken, participantId, sessionId, stageArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListParticipantEventsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListParticipantEventsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListParticipantEventsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListParticipantEventsRequest is not found in the empty JSON string", ListParticipantEventsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListParticipantEventsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListParticipantEventsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListParticipantEventsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListParticipantEventsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListParticipantEventsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListParticipantEventsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListParticipantEventsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListParticipantEventsRequest>() {
           @Override
           public void write(JsonWriter out, ListParticipantEventsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListParticipantEventsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListParticipantEventsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListParticipantEventsRequest
   * @throws IOException if the JSON string is invalid with respect to ListParticipantEventsRequest
   */
  public static ListParticipantEventsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListParticipantEventsRequest.class);
  }

  /**
   * Convert an instance of ListParticipantEventsRequest to an JSON string
   *
   * @return JSON string
   */
