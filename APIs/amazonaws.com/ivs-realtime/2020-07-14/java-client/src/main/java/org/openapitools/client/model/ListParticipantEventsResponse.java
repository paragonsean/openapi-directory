...
public class ListParticipantEventsResponse {
  ...
  public ListParticipantEventsResponse() {
  }

  public ListParticipantEventsResponse events(List events) {
    this.events = events;
    return this;
  }
  ...
  public ListParticipantEventsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListParticipantEventsResponse listParticipantEventsResponse = (ListParticipantEventsResponse) o;
    return Objects.equals(this.events, listParticipantEventsResponse.events) &&
        Objects.equals(this.nextToken, listParticipantEventsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListParticipantEventsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListParticipantEventsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListParticipantEventsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListParticipantEventsResponse is not found in the empty JSON string", ListParticipantEventsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListParticipantEventsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListParticipantEventsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListParticipantEventsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListParticipantEventsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListParticipantEventsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListParticipantEventsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListParticipantEventsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListParticipantEventsResponse>() {
           @Override
           public void write(JsonWriter out, ListParticipantEventsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListParticipantEventsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListParticipantEventsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListParticipantEventsResponse
   * @throws IOException if the JSON string is invalid with respect to ListParticipantEventsResponse
   */
  public static ListParticipantEventsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListParticipantEventsResponse.class);
  }

  /**
   * Convert an instance of ListParticipantEventsResponse to an JSON string
   *
   * @return JSON string
   */
