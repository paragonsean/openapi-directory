...
public class ParticipantToken {
  ...
  public ParticipantToken attributes(Map attributes) {
  ...
  public ParticipantToken capabilities(List capabilities) {
  ...
  public ParticipantToken duration(Integer duration) {
  ...
  public ParticipantToken expirationTime(OffsetDateTime expirationTime) {
  ...
  public ParticipantToken participantId(String participantId) {
  ...
  public ParticipantToken token(String token) {
    this.token = token;
    return this;
  }
  ...
  public ParticipantToken userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ParticipantToken participantToken = (ParticipantToken) o;
    return Objects.equals(this.attributes, participantToken.attributes) &&
        Objects.equals(this.capabilities, participantToken.capabilities) &&
        Objects.equals(this.duration, participantToken.duration) &&
        Objects.equals(this.expirationTime, participantToken.expirationTime) &&
        Objects.equals(this.participantId, participantToken.participantId) &&
        Objects.equals(this.token, participantToken.token) &&
        Objects.equals(this.userId, participantToken.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParticipantToken {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParticipantToken
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParticipantToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParticipantToken is not found in the empty JSON string", ParticipantToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParticipantToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParticipantToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParticipantToken.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParticipantToken' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParticipantToken> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParticipantToken.class));

       return (TypeAdapter<T>) new TypeAdapter<ParticipantToken>() {
           @Override
           public void write(JsonWriter out, ParticipantToken value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ParticipantToken read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ParticipantToken given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ParticipantToken
   * @throws IOException if the JSON string is invalid with respect to ParticipantToken
   */
  public static ParticipantToken fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParticipantToken.class);
  }

  /**
   * Convert an instance of ParticipantToken to an JSON string
   *
   * @return JSON string
   */
