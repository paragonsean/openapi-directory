...
import org.openapitools.client.model.GetParticipantResponseParticipant;
...
public class GetParticipantResponse {
  ...
  private GetParticipantResponseParticipant participant;

  public GetParticipantResponse() {
  }

  public GetParticipantResponse participant(GetParticipantResponseParticipant participant) {
  ...
  public GetParticipantResponseParticipant getParticipant() {
    return participant;
  }

  public void setParticipant(GetParticipantResponseParticipant participant) {
    this.participant = participant;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetParticipantResponse getParticipantResponse = (GetParticipantResponse) o;
    return Objects.equals(this.participant, getParticipantResponse.participant);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetParticipantResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetParticipantResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetParticipantResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetParticipantResponse is not found in the empty JSON string", GetParticipantResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetParticipantResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetParticipantResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `participant`
      if (jsonObj.get("participant") != null && !jsonObj.get("participant").isJsonNull()) {
        GetParticipantResponseParticipant.validateJsonElement(jsonObj.get("participant"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetParticipantResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetParticipantResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetParticipantResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetParticipantResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetParticipantResponse>() {
           @Override
           public void write(JsonWriter out, GetParticipantResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetParticipantResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetParticipantResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetParticipantResponse
   * @throws IOException if the JSON string is invalid with respect to GetParticipantResponse
   */
  public static GetParticipantResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetParticipantResponse.class);
  }

  /**
   * Convert an instance of GetParticipantResponse to an JSON string
   *
   * @return JSON string
   */
