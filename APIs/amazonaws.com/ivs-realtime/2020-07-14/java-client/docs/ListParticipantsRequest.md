...
|**filterByState** | [**FilterByStateEnum**](#FilterByStateEnum) | Filters the response list to only show participants in the specified state. Only one of &lt;code&gt;filterByUserId&lt;/code&gt;, &lt;code&gt;filterByPublished&lt;/code&gt;, or &lt;code&gt;filterByState&lt;/code&gt; can be provided per request. |  [optional] |
