...
/*
 * OAIParticipantToken.h
 *
 * Object specifying a participant token in a stage.
 */

#ifndef OAIParticipantToken_H
#define OAIParticipantToken_H
...
class OAIParticipantToken : public OAIObject {
public:
    OAIParticipantToken();
    OAIParticipantToken(QString json);
    ~OAIParticipantToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipantToken)

#endif // OAIParticipantToken_H
