...
/*
 * OAIGetStageSessionRequest.h
 *
 * 
 */

#ifndef OAIGetStageSessionRequest_H
#define OAIGetStageSessionRequest_H
...
class OAIGetStageSessionRequest : public OAIObject {
public:
    OAIGetStageSessionRequest();
    OAIGetStageSessionRequest(QString json);
    ~OAIGetStageSessionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageSessionRequest)

#endif // OAIGetStageSessionRequest_H
