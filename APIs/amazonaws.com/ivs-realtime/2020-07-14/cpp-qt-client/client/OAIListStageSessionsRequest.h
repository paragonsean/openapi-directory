...
/*
 * OAIListStageSessionsRequest.h
 *
 * 
 */

#ifndef OAIListStageSessionsRequest_H
#define OAIListStageSessionsRequest_H
...
class OAIListStageSessionsRequest : public OAIObject {
public:
    OAIListStageSessionsRequest();
    OAIListStageSessionsRequest(QString json);
    ~OAIListStageSessionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStageSessionsRequest)

#endif // OAIListStageSessionsRequest_H
