...
QString OAIDisconnectParticipant_request::getParticipantId() const {
    return m_participant_id;
}
void OAIDisconnectParticipant_request::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIDisconnectParticipant_request::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIDisconnectParticipant_request::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QString OAIDisconnectParticipant_request::getReason() const {
    return m_reason;
}
void OAIDisconnectParticipant_request::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDisconnectParticipant_request::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDisconnectParticipant_request::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIDisconnectParticipant_request::getStageArn() const {
    return m_stage_arn;
}
void OAIDisconnectParticipant_request::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIDisconnectParticipant_request::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIDisconnectParticipant_request::is_stage_arn_Valid() const{
