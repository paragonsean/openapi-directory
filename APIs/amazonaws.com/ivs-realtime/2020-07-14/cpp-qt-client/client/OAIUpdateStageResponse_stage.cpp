...
#include "OAIUpdateStageResponse_stage.h"
...
OAIUpdateStageResponse_stage::OAIUpdateStageResponse_stage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStageResponse_stage::OAIUpdateStageResponse_stage() {
    this->initializeModel();
}

OAIUpdateStageResponse_stage::~OAIUpdateStageResponse_stage() {}

void OAIUpdateStageResponse_stage::initializeModel() {
...
void OAIUpdateStageResponse_stage::fromJson(QString jsonString) {
...
void OAIUpdateStageResponse_stage::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateStageResponse_stage::asJson() const {
...
QJsonObject OAIUpdateStageResponse_stage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateStageResponse_stage::getActiveSessionId() const {
    return m_active_session_id;
}
void OAIUpdateStageResponse_stage::setActiveSessionId(const QString &active_session_id) {
    m_active_session_id = active_session_id;
    m_active_session_id_isSet = true;
}

bool OAIUpdateStageResponse_stage::is_active_session_id_Set() const{
    return m_active_session_id_isSet;
}

bool OAIUpdateStageResponse_stage::is_active_session_id_Valid() const{
    return m_active_session_id_isValid;
}

QString OAIUpdateStageResponse_stage::getArn() const {
    return m_arn;
}
void OAIUpdateStageResponse_stage::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateStageResponse_stage::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateStageResponse_stage::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateStageResponse_stage::getName() const {
    return m_name;
}
void OAIUpdateStageResponse_stage::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateStageResponse_stage::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateStageResponse_stage::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIUpdateStageResponse_stage::getTags() const {
    return m_tags;
}
void OAIUpdateStageResponse_stage::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateStageResponse_stage::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateStageResponse_stage::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUpdateStageResponse_stage::isSet() const {
...
bool OAIUpdateStageResponse_stage::isValid() const {
