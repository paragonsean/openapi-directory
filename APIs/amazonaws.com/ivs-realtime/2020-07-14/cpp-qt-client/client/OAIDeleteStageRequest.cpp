...
#include "OAIDeleteStageRequest.h"
...
OAIDeleteStageRequest::OAIDeleteStageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteStageRequest::OAIDeleteStageRequest() {
    this->initializeModel();
}

OAIDeleteStageRequest::~OAIDeleteStageRequest() {}

void OAIDeleteStageRequest::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteStageRequest::fromJson(QString jsonString) {
...
void OAIDeleteStageRequest::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteStageRequest::asJson() const {
...
QJsonObject OAIDeleteStageRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteStageRequest::getArn() const {
    return m_arn;
}
void OAIDeleteStageRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteStageRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteStageRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteStageRequest::isSet() const {
...
bool OAIDeleteStageRequest::isValid() const {
