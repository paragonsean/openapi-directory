...
/*
 * OAICreateParticipantTokenRequest.h
 *
 * 
 */

#ifndef OAICreateParticipantTokenRequest_H
#define OAICreateParticipantTokenRequest_H
...
class OAICreateParticipantTokenRequest : public OAIObject {
public:
    OAICreateParticipantTokenRequest();
    OAICreateParticipantTokenRequest(QString json);
    ~OAICreateParticipantTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateParticipantTokenRequest)

#endif // OAICreateParticipantTokenRequest_H
