...
/*
 * OAIGetParticipantResponse.h
 *
 * 
 */

#ifndef OAIGetParticipantResponse_H
#define OAIGetParticipantResponse_H

#include <QJsonObject>

#include "OAIGetParticipantResponse_participant.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetParticipantResponse_participant;

class OAIGetParticipantResponse : public OAIObject {
public:
    OAIGetParticipantResponse();
    OAIGetParticipantResponse(QString json);
    ~OAIGetParticipantResponse() override;
    ...
    OAIGetParticipantResponse_participant getParticipant() const;
    void setParticipant(const OAIGetParticipantResponse_participant &participant);
...
private:
    ...
    OAIGetParticipantResponse_participant m_participant;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetParticipantResponse)

#endif // OAIGetParticipantResponse_H
