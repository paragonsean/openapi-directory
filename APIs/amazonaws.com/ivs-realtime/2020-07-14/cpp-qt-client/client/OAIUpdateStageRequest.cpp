...
QString OAIUpdateStageRequest::getArn() const {
    return m_arn;
}
void OAIUpdateStageRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateStageRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateStageRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateStageRequest::getName() const {
    return m_name;
}
void OAIUpdateStageRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateStageRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateStageRequest::is_name_Valid() const{
