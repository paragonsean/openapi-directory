...
/*
 * OAICreateParticipantToken_request.h
 *
 * 
 */

#ifndef OAICreateParticipantToken_request_H
#define OAICreateParticipantToken_request_H
...
class OAICreateParticipantToken_request : public OAIObject {
public:
    OAICreateParticipantToken_request();
    OAICreateParticipantToken_request(QString json);
    ~OAICreateParticipantToken_request() override;
    ...
    QList<OAIParticipantTokenCapability> getCapabilities() const;
    void setCapabilities(const QList<OAIParticipantTokenCapability> &capabilities);
...
private:
    ...
    QList<OAIParticipantTokenCapability> m_capabilities;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateParticipantToken_request)

#endif // OAICreateParticipantToken_request_H
