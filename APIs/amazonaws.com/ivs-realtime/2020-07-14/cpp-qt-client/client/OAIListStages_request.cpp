...
OAIListStages_request::OAIListStages_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStages_request::OAIListStages_request() {
    this->initializeModel();
}

OAIListStages_request::~OAIListStages_request() {}

void OAIListStages_request::initializeModel() {
...
void OAIListStages_request::fromJson(QString jsonString) {
...
void OAIListStages_request::fromJsonObject(QJsonObject json) {
...
QString OAIListStages_request::asJson() const {
...
QJsonObject OAIListStages_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListStages_request::getMaxResults() const {
    return m_max_results;
}
void OAIListStages_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStages_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStages_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStages_request::getNextToken() const {
    return m_next_token;
}
void OAIListStages_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStages_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStages_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStages_request::isSet() const {
...
bool OAIListStages_request::isValid() const {
