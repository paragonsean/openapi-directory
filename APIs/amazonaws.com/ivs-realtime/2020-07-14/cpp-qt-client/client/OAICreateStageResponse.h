...
namespace OpenAPI {
class OAICreateStageResponse_stage;
...
public:
    ...
    QList getParticipantTokens() const;
    void setParticipantTokens(const QList &participant_tokens);
    bool is_participant_tokens_Set() const;
    bool is_participant_tokens_Valid() const;

    OAICreateStageResponse_stage getStage() const;
    void setStage(const OAICreateStageResponse_stage &stage);
...
private:
    ...
    QList m_participant_tokens;
    bool m_participant_tokens_isSet;
    bool m_participant_tokens_isValid;

    OAICreateStageResponse_stage m_stage;
    bool m_stage_isSet;
