...
/*
 * OAIDisconnectParticipant_request.h
 *
 * 
 */

#ifndef OAIDisconnectParticipant_request_H
#define OAIDisconnectParticipant_request_H
...
class OAIDisconnectParticipant_request : public OAIObject {
public:
    OAIDisconnectParticipant_request();
    OAIDisconnectParticipant_request(QString json);
    ~OAIDisconnectParticipant_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisconnectParticipant_request)

#endif // OAIDisconnectParticipant_request_H
