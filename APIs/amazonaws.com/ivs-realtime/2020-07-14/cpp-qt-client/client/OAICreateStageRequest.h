...
public:
    ...
    QList getParticipantTokenConfigurations() const;
    void setParticipantTokenConfigurations(const QList &participant_token_configurations);
    bool is_participant_token_configurations_Set() const;
    bool is_participant_token_configurations_Valid() const;
...
private:
    ...
    QList m_participant_token_configurations;
    bool m_participant_token_configurations_isSet;
    bool m_participant_token_configurations_isValid;
