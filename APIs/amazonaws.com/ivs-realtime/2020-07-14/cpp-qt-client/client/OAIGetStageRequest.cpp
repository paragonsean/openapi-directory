...
OAIGetStageRequest::OAIGetStageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStageRequest::OAIGetStageRequest() {
    this->initializeModel();
}

OAIGetStageRequest::~OAIGetStageRequest() {}

void OAIGetStageRequest::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetStageRequest::fromJson(QString jsonString) {
...
void OAIGetStageRequest::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetStageRequest::asJson() const {
...
QJsonObject OAIGetStageRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetStageRequest::getArn() const {
    return m_arn;
}
void OAIGetStageRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStageRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStageRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetStageRequest::isSet() const {
...
bool OAIGetStageRequest::isValid() const {
