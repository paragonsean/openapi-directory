...
#ifndef OAIEventName_H
#define OAIEventName_H
...
class OAIEventName : public OAIEnum {
public:
    OAIEventName();
    OAIEventName(QString json);
    ~OAIEventName() override;
    ...
    OAIEventName::eOAIEventName getValue() const;
    void setValue(const OAIEventName::eOAIEventName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventName)

#endif // OAIEventName_H
