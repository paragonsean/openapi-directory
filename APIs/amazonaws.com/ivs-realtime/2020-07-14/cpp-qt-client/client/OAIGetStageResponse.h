...
/*
 * OAIGetStageResponse.h
 *
 * 
 */

#ifndef OAIGetStageResponse_H
#define OAIGetStageResponse_H
...
namespace OpenAPI {
class OAIGetStageResponse_stage;

class OAIGetStageResponse : public OAIObject {
public:
    OAIGetStageResponse();
    OAIGetStageResponse(QString json);
    ~OAIGetStageResponse() override;
    ...
    OAIGetStageResponse_stage getStage() const;
    void setStage(const OAIGetStageResponse_stage &stage);
...
private:
    ...
    OAIGetStageResponse_stage m_stage;
    bool m_stage_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageResponse)

#endif // OAIGetStageResponse_H
