...
/*
 * OAIListParticipantsResponse.h
 *
 * 
 */

#ifndef OAIListParticipantsResponse_H
#define OAIListParticipantsResponse_H
...
class OAIListParticipantsResponse : public OAIObject {
public:
    OAIListParticipantsResponse();
    OAIListParticipantsResponse(QString json);
    ~OAIListParticipantsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipantsResponse)

#endif // OAIListParticipantsResponse_H
