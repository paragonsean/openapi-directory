...
OAIListStagesResponse::OAIListStagesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStagesResponse::OAIListStagesResponse() {
    this->initializeModel();
}

OAIListStagesResponse::~OAIListStagesResponse() {}

void OAIListStagesResponse::initializeModel() {
...
void OAIListStagesResponse::fromJson(QString jsonString) {
...
void OAIListStagesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListStagesResponse::asJson() const {
...
QJsonObject OAIListStagesResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStagesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStagesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStagesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStagesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStagesResponse::getStages() const {
    return m_stages;
}
void OAIListStagesResponse::setStages(const QList &stages) {
    m_stages = stages;
    m_stages_isSet = true;
}

bool OAIListStagesResponse::is_stages_Set() const{
    return m_stages_isSet;
}

bool OAIListStagesResponse::is_stages_Valid() const{
    return m_stages_isValid;
}

bool OAIListStagesResponse::isSet() const {
...
bool OAIListStagesResponse::isValid() const {
