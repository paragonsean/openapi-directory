...
/*
 * OAIGetParticipantRequest.h
 *
 * 
 */

#ifndef OAIGetParticipantRequest_H
#define OAIGetParticipantRequest_H
...
class OAIGetParticipantRequest : public OAIObject {
public:
    OAIGetParticipantRequest();
    OAIGetParticipantRequest(QString json);
    ~OAIGetParticipantRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetParticipantRequest)

#endif // OAIGetParticipantRequest_H
