...
/*
 * OAIDeleteStage_request.h
 *
 * 
 */

#ifndef OAIDeleteStage_request_H
#define OAIDeleteStage_request_H
...
class OAIDeleteStage_request : public OAIObject {
public:
    OAIDeleteStage_request();
    OAIDeleteStage_request(QString json);
    ~OAIDeleteStage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStage_request)

#endif // OAIDeleteStage_request_H
