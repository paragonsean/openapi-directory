...
/*
 * OAIGetParticipantResponse_participant.h
 *
 * 
 */

#ifndef OAIGetParticipantResponse_participant_H
#define OAIGetParticipantResponse_participant_H
...
class OAIGetParticipantResponse_participant : public OAIObject {
public:
    OAIGetParticipantResponse_participant();
    OAIGetParticipantResponse_participant(QString json);
    ~OAIGetParticipantResponse_participant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetParticipantResponse_participant)

#endif // OAIGetParticipantResponse_participant_H
