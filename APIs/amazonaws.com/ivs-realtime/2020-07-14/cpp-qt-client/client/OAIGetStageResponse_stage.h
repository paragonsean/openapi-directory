...
/*
 * OAIGetStageResponse_stage.h
 *
 * 
 */

#ifndef OAIGetStageResponse_stage_H
#define OAIGetStageResponse_stage_H
...
class OAIGetStageResponse_stage : public OAIObject {
public:
    OAIGetStageResponse_stage();
    OAIGetStageResponse_stage(QString json);
    ~OAIGetStageResponse_stage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageResponse_stage)

#endif // OAIGetStageResponse_stage_H
