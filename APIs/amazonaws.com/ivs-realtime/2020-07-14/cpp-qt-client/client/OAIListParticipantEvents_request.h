...
/*
 * OAIListParticipantEvents_request.h
 *
 * 
 */

#ifndef OAIListParticipantEvents_request_H
#define OAIListParticipantEvents_request_H
...
class OAIListParticipantEvents_request : public OAIObject {
public:
    OAIListParticipantEvents_request();
    OAIListParticipantEvents_request(QString json);
    ~OAIListParticipantEvents_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipantEvents_request)

#endif // OAIListParticipantEvents_request_H
