...
OAIListStageSessions_request::OAIListStageSessions_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStageSessions_request::OAIListStageSessions_request() {
    this->initializeModel();
}

OAIListStageSessions_request::~OAIListStageSessions_request() {}

void OAIListStageSessions_request::initializeModel() {
...
void OAIListStageSessions_request::fromJson(QString jsonString) {
...
void OAIListStageSessions_request::fromJsonObject(QJsonObject json) {
...
QString OAIListStageSessions_request::asJson() const {
...
QJsonObject OAIListStageSessions_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListStageSessions_request::getMaxResults() const {
    return m_max_results;
}
void OAIListStageSessions_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStageSessions_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStageSessions_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStageSessions_request::getNextToken() const {
    return m_next_token;
}
void OAIListStageSessions_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStageSessions_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStageSessions_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListStageSessions_request::getStageArn() const {
    return m_stage_arn;
}
void OAIListStageSessions_request::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIListStageSessions_request::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIListStageSessions_request::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

bool OAIListStageSessions_request::isSet() const {
...
bool OAIListStageSessions_request::isValid() const {
