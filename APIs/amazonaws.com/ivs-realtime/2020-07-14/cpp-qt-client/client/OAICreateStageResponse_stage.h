...
/*
 * OAICreateStageResponse_stage.h
 *
 * 
 */

#ifndef OAICreateStageResponse_stage_H
#define OAICreateStageResponse_stage_H
...
class OAICreateStageResponse_stage : public OAIObject {
public:
    OAICreateStageResponse_stage();
    OAICreateStageResponse_stage(QString json);
    ~OAICreateStageResponse_stage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStageResponse_stage)

#endif // OAICreateStageResponse_stage_H
