...
OAICreateParticipantToken_request::OAICreateParticipantToken_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateParticipantToken_request::OAICreateParticipantToken_request() {
    this->initializeModel();
}

OAICreateParticipantToken_request::~OAICreateParticipantToken_request() {}

void OAICreateParticipantToken_request::initializeModel() {
...
void OAICreateParticipantToken_request::fromJson(QString jsonString) {
...
void OAICreateParticipantToken_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateParticipantToken_request::asJson() const {
...
QJsonObject OAICreateParticipantToken_request::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAICreateParticipantToken_request::getAttributes() const {
    return m_attributes;
}
void OAICreateParticipantToken_request::setAttributes(const QMap<QString, QString> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICreateParticipantToken_request::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICreateParticipantToken_request::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList<OAIParticipantTokenCapability> OAICreateParticipantToken_request::getCapabilities() const {
    return m_capabilities;
}
void OAICreateParticipantToken_request::setCapabilities(const QList<OAIParticipantTokenCapability> &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAICreateParticipantToken_request::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAICreateParticipantToken_request::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

qint32 OAICreateParticipantToken_request::getDuration() const {
    return m_duration;
}
void OAICreateParticipantToken_request::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAICreateParticipantToken_request::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAICreateParticipantToken_request::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAICreateParticipantToken_request::getStageArn() const {
    return m_stage_arn;
}
void OAICreateParticipantToken_request::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAICreateParticipantToken_request::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAICreateParticipantToken_request::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

QString OAICreateParticipantToken_request::getUserId() const {
    return m_user_id;
}
void OAICreateParticipantToken_request::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAICreateParticipantToken_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAICreateParticipantToken_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAICreateParticipantToken_request::isSet() const {
...
bool OAICreateParticipantToken_request::isValid() const {
