...
/*
 * OAICreateParticipantTokenResponse.h
 *
 * 
 */

#ifndef OAICreateParticipantTokenResponse_H
#define OAICreateParticipantTokenResponse_H
...
namespace OpenAPI {
class OAICreateParticipantTokenResponse_participantToken;

class OAICreateParticipantTokenResponse : public OAIObject {
public:
    OAICreateParticipantTokenResponse();
    OAICreateParticipantTokenResponse(QString json);
    ~OAICreateParticipantTokenResponse() override;
    ...
    OAICreateParticipantTokenResponse_participantToken getParticipantToken() const;
    void setParticipantToken(const OAICreateParticipantTokenResponse_participantToken &participant_token);
    bool is_participant_token_Set() const;
    bool is_participant_token_Valid() const;
...
private:
    ...
    OAICreateParticipantTokenResponse_participantToken m_participant_token;
    bool m_participant_token_isSet;
    bool m_participant_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateParticipantTokenResponse)

#endif // OAICreateParticipantTokenResponse_H
