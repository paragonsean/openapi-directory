...
QString OAIDisconnectParticipantRequest::getParticipantId() const {
    return m_participant_id;
}
void OAIDisconnectParticipantRequest::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIDisconnectParticipantRequest::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIDisconnectParticipantRequest::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QString OAIDisconnectParticipantRequest::getReason() const {
    return m_reason;
}
void OAIDisconnectParticipantRequest::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIDisconnectParticipantRequest::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIDisconnectParticipantRequest::is_reason_Valid() const{
    return m_reason_isValid;
}

QString OAIDisconnectParticipantRequest::getStageArn() const {
    return m_stage_arn;
}
void OAIDisconnectParticipantRequest::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIDisconnectParticipantRequest::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIDisconnectParticipantRequest::is_stage_arn_Valid() const{
...
bool OAIDisconnectParticipantRequest::isValid() const {
    ...
    return m_participant_id_isValid && m_stage_arn_isValid && true;
}
