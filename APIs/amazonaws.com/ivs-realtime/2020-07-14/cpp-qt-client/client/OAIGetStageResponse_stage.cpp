...
#include "OAIGetStageResponse_stage.h"
...
OAIGetStageResponse_stage::OAIGetStageResponse_stage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStageResponse_stage::OAIGetStageResponse_stage() {
    this->initializeModel();
}

OAIGetStageResponse_stage::~OAIGetStageResponse_stage() {}

void OAIGetStageResponse_stage::initializeModel() {
...
void OAIGetStageResponse_stage::fromJson(QString jsonString) {
...
void OAIGetStageResponse_stage::fromJsonObject(QJsonObject json) {
...
QString OAIGetStageResponse_stage::asJson() const {
...
QJsonObject OAIGetStageResponse_stage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStageResponse_stage::getActiveSessionId() const {
    return m_active_session_id;
}
void OAIGetStageResponse_stage::setActiveSessionId(const QString &active_session_id) {
    m_active_session_id = active_session_id;
    m_active_session_id_isSet = true;
}

bool OAIGetStageResponse_stage::is_active_session_id_Set() const{
    return m_active_session_id_isSet;
}

bool OAIGetStageResponse_stage::is_active_session_id_Valid() const{
    return m_active_session_id_isValid;
}

QString OAIGetStageResponse_stage::getArn() const {
    return m_arn;
}
void OAIGetStageResponse_stage::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStageResponse_stage::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStageResponse_stage::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetStageResponse_stage::getName() const {
    return m_name;
}
void OAIGetStageResponse_stage::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetStageResponse_stage::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetStageResponse_stage::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIGetStageResponse_stage::getTags() const {
    return m_tags;
}
void OAIGetStageResponse_stage::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetStageResponse_stage::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetStageResponse_stage::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetStageResponse_stage::isSet() const {
...
bool OAIGetStageResponse_stage::isValid() const {
