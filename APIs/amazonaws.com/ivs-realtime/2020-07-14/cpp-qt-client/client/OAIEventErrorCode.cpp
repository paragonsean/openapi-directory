...
OAIEventErrorCode::OAIEventErrorCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventErrorCode::OAIEventErrorCode() {
    this->initializeModel();
}

OAIEventErrorCode::~OAIEventErrorCode() {}

void OAIEventErrorCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventErrorCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventErrorCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INSUFFICIENT_CAPABILITIES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventErrorCode::INSUFFICIENT_CAPABILITIES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("QUOTA_EXCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventErrorCode::QUOTA_EXCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PUBLISHER_NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventErrorCode::PUBLISHER_NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventErrorCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventErrorCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventErrorCode::INSUFFICIENT_CAPABILITIES:
            val = "INSUFFICIENT_CAPABILITIES";
            break;
        case eOAIEventErrorCode::QUOTA_EXCEEDED:
            val = "QUOTA_EXCEEDED";
            break;
        case eOAIEventErrorCode::PUBLISHER_NOT_FOUND:
            val = "PUBLISHER_NOT_FOUND";
            break;
        default:
            break;
    }
...
QJsonValue OAIEventErrorCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventErrorCode::eOAIEventErrorCode OAIEventErrorCode::getValue() const {
    return m_value;
}

void OAIEventErrorCode::setValue(const OAIEventErrorCode::eOAIEventErrorCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventErrorCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventErrorCode::isValid() const {
