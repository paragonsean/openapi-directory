...
OAICreateParticipantTokenResponse::OAICreateParticipantTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateParticipantTokenResponse::OAICreateParticipantTokenResponse() {
    this->initializeModel();
}

OAICreateParticipantTokenResponse::~OAICreateParticipantTokenResponse() {}

void OAICreateParticipantTokenResponse::initializeModel() {

    m_participant_token_isSet = false;
    m_participant_token_isValid = false;
}

void OAICreateParticipantTokenResponse::fromJson(QString jsonString) {
...
void OAICreateParticipantTokenResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateParticipantTokenResponse::asJson() const {
...
QJsonObject OAICreateParticipantTokenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_participant_token.isSet()) {
        obj.insert(QString("participantToken"), ::OpenAPI::toJsonValue(m_participant_token));
    }
    return obj;
}

OAICreateParticipantTokenResponse_participantToken OAICreateParticipantTokenResponse::getParticipantToken() const {
    return m_participant_token;
}
void OAICreateParticipantTokenResponse::setParticipantToken(const OAICreateParticipantTokenResponse_participantToken &participant_token) {
    m_participant_token = participant_token;
    m_participant_token_isSet = true;
}

bool OAICreateParticipantTokenResponse::is_participant_token_Set() const{
    return m_participant_token_isSet;
}

bool OAICreateParticipantTokenResponse::is_participant_token_Valid() const{
    return m_participant_token_isValid;
}

bool OAICreateParticipantTokenResponse::isSet() const {
...
bool OAICreateParticipantTokenResponse::isValid() const {
