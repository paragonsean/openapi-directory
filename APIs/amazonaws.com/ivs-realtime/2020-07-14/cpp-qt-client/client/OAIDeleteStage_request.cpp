...
OAIDeleteStage_request::OAIDeleteStage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteStage_request::OAIDeleteStage_request() {
    this->initializeModel();
}

OAIDeleteStage_request::~OAIDeleteStage_request() {}

void OAIDeleteStage_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteStage_request::fromJson(QString jsonString) {
...
void OAIDeleteStage_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteStage_request::asJson() const {
...
QJsonObject OAIDeleteStage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteStage_request::getArn() const {
    return m_arn;
}
void OAIDeleteStage_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteStage_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteStage_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteStage_request::isSet() const {
...
bool OAIDeleteStage_request::isValid() const {
