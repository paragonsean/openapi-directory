...
#include "OAIListStageSessionsRequest.h"
...
OAIListStageSessionsRequest::OAIListStageSessionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStageSessionsRequest::OAIListStageSessionsRequest() {
    this->initializeModel();
}

OAIListStageSessionsRequest::~OAIListStageSessionsRequest() {}

void OAIListStageSessionsRequest::initializeModel() {
...
void OAIListStageSessionsRequest::fromJson(QString jsonString) {
...
void OAIListStageSessionsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListStageSessionsRequest::asJson() const {
...
QJsonObject OAIListStageSessionsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListStageSessionsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListStageSessionsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStageSessionsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStageSessionsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStageSessionsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListStageSessionsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStageSessionsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStageSessionsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListStageSessionsRequest::getStageArn() const {
    return m_stage_arn;
}
void OAIListStageSessionsRequest::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIListStageSessionsRequest::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIListStageSessionsRequest::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

bool OAIListStageSessionsRequest::isSet() const {
...
bool OAIListStageSessionsRequest::isValid() const {
