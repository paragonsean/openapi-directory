...
#ifndef OAIStageSession_H
#define OAIStageSession_H
...
class OAIStageSession : public OAIObject {
public:
    OAIStageSession();
    OAIStageSession(QString json);
    ~OAIStageSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageSession)

#endif // OAIStageSession_H
