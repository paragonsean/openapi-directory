...
QString OAIStageSummary::getActiveSessionId() const {
    return m_active_session_id;
}
void OAIStageSummary::setActiveSessionId(const QString &active_session_id) {
    m_active_session_id = active_session_id;
    m_active_session_id_isSet = true;
}

bool OAIStageSummary::is_active_session_id_Set() const{
    return m_active_session_id_isSet;
}

bool OAIStageSummary::is_active_session_id_Valid() const{
    return m_active_session_id_isValid;
}

QString OAIStageSummary::getArn() const {
    return m_arn;
}
void OAIStageSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStageSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStageSummary::is_arn_Valid() const{
