...
/*
 * OAIParticipantState.h
 *
 * 
 */

#ifndef OAIParticipantState_H
#define OAIParticipantState_H
...
class OAIParticipantState : public OAIEnum {
public:
    OAIParticipantState();
    OAIParticipantState(QString json);
    ~OAIParticipantState() override;
    ...
    enum class eOAIParticipantState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CONNECTED, 
        DISCONNECTED
    };
    OAIParticipantState::eOAIParticipantState getValue() const;
    void setValue(const OAIParticipantState::eOAIParticipantState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipantState)

#endif // OAIParticipantState_H
