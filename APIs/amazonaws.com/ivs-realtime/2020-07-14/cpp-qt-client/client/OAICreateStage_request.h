...
#include "OAIParticipantTokenConfiguration.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIParticipantTokenConfiguration;
...
public:
    ...
    QList<OAIParticipantTokenConfiguration> getParticipantTokenConfigurations() const;
    void setParticipantTokenConfigurations(const QList<OAIParticipantTokenConfiguration> &participant_token_configurations);
...
private:
    ...
    QList<OAIParticipantTokenConfiguration> m_participant_token_configurations;
