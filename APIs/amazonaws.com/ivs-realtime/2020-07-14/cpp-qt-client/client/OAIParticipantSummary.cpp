...
#include "OAIParticipantSummary.h"
...
OAIParticipantSummary::OAIParticipantSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParticipantSummary::OAIParticipantSummary() {
    this->initializeModel();
}

OAIParticipantSummary::~OAIParticipantSummary() {}

void OAIParticipantSummary::initializeModel() {
...
void OAIParticipantSummary::fromJson(QString jsonString) {
...
void OAIParticipantSummary::fromJsonObject(QJsonObject json) {
...
QString OAIParticipantSummary::asJson() const {
...
QJsonObject OAIParticipantSummary::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIParticipantSummary::getFirstJoinTime() const {
    return m_first_join_time;
}
void OAIParticipantSummary::setFirstJoinTime(const QDateTime &first_join_time) {
    m_first_join_time = first_join_time;
    m_first_join_time_isSet = true;
}

bool OAIParticipantSummary::is_first_join_time_Set() const{
    return m_first_join_time_isSet;
}

bool OAIParticipantSummary::is_first_join_time_Valid() const{
    return m_first_join_time_isValid;
}

QString OAIParticipantSummary::getParticipantId() const {
    return m_participant_id;
}
void OAIParticipantSummary::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIParticipantSummary::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIParticipantSummary::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

bool OAIParticipantSummary::getPublished() const {
    return m_published;
}
void OAIParticipantSummary::setPublished(const bool &published) {
    m_published = published;
    m_published_isSet = true;
}

bool OAIParticipantSummary::is_published_Set() const{
    return m_published_isSet;
}

bool OAIParticipantSummary::is_published_Valid() const{
    return m_published_isValid;
}

OAIParticipantState OAIParticipantSummary::getState() const {
    return m_state;
}
void OAIParticipantSummary::setState(const OAIParticipantState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIParticipantSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIParticipantSummary::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIParticipantSummary::getUserId() const {
    return m_user_id;
}
void OAIParticipantSummary::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIParticipantSummary::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIParticipantSummary::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIParticipantSummary::isSet() const {
...
bool OAIParticipantSummary::isValid() const {
