...
OAIGetStageSession_request::OAIGetStageSession_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStageSession_request::OAIGetStageSession_request() {
    this->initializeModel();
}

OAIGetStageSession_request::~OAIGetStageSession_request() {}

void OAIGetStageSession_request::initializeModel() {
...
void OAIGetStageSession_request::fromJson(QString jsonString) {
...
void OAIGetStageSession_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetStageSession_request::asJson() const {
...
QJsonObject OAIGetStageSession_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStageSession_request::getSessionId() const {
    return m_session_id;
}
void OAIGetStageSession_request::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIGetStageSession_request::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIGetStageSession_request::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QString OAIGetStageSession_request::getStageArn() const {
    return m_stage_arn;
}
void OAIGetStageSession_request::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIGetStageSession_request::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIGetStageSession_request::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

bool OAIGetStageSession_request::isSet() const {
...
bool OAIGetStageSession_request::isValid() const {
