...
/*
 * OAIGetStageRequest.h
 *
 * 
 */

#ifndef OAIGetStageRequest_H
#define OAIGetStageRequest_H
...
class OAIGetStageRequest : public OAIObject {
public:
    OAIGetStageRequest();
    OAIGetStageRequest(QString json);
    ~OAIGetStageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageRequest)

#endif // OAIGetStageRequest_H
