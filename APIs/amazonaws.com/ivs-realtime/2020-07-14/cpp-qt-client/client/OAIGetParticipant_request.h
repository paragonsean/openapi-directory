...
/*
 * OAIGetParticipant_request.h
 *
 * 
 */

#ifndef OAIGetParticipant_request_H
#define OAIGetParticipant_request_H
...
class OAIGetParticipant_request : public OAIObject {
public:
    OAIGetParticipant_request();
    OAIGetParticipant_request(QString json);
    ~OAIGetParticipant_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetParticipant_request)

#endif // OAIGetParticipant_request_H
