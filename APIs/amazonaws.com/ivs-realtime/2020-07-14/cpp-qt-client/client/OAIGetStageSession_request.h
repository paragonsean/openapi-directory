...
/*
 * OAIGetStageSession_request.h
 *
 * 
 */

#ifndef OAIGetStageSession_request_H
#define OAIGetStageSession_request_H
...
class OAIGetStageSession_request : public OAIObject {
public:
    OAIGetStageSession_request();
    OAIGetStageSession_request(QString json);
    ~OAIGetStageSession_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageSession_request)

#endif // OAIGetStageSession_request_H
