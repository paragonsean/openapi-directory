...
#include "OAIParticipantTokenCapability.h"
...
OAIParticipantTokenCapability::OAIParticipantTokenCapability(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParticipantTokenCapability::OAIParticipantTokenCapability() {
    this->initializeModel();
}

OAIParticipantTokenCapability::~OAIParticipantTokenCapability() {}

void OAIParticipantTokenCapability::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIParticipantTokenCapability::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIParticipantTokenCapability::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PUBLISH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIParticipantTokenCapability::PUBLISH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SUBSCRIBE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIParticipantTokenCapability::SUBSCRIBE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIParticipantTokenCapability::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIParticipantTokenCapability::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIParticipantTokenCapability::PUBLISH:
            val = "PUBLISH";
            break;
        case eOAIParticipantTokenCapability::SUBSCRIBE:
            val = "SUBSCRIBE";
            break;
        default:
            break;
...
QJsonValue OAIParticipantTokenCapability::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIParticipantTokenCapability::eOAIParticipantTokenCapability OAIParticipantTokenCapability::getValue() const {
    return m_value;
}

void OAIParticipantTokenCapability::setValue(const OAIParticipantTokenCapability::eOAIParticipantTokenCapability& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIParticipantTokenCapability::isSet() const {
    
    return m_value_isSet;
}

bool OAIParticipantTokenCapability::isValid() const {
