...
/*
 * OAIListStageSessions_request.h
 *
 * 
 */

#ifndef OAIListStageSessions_request_H
#define OAIListStageSessions_request_H
...
class OAIListStageSessions_request : public OAIObject {
public:
    OAIListStageSessions_request();
    OAIListStageSessions_request(QString json);
    ~OAIListStageSessions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStageSessions_request)

#endif // OAIListStageSessions_request_H
