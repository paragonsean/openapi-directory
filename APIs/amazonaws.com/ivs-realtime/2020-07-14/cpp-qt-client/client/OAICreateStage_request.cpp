...
QJsonObject OAICreateStage_request::asJsonObject() const {
    ...
    if (m_participant_token_configurations.size() > 0) {
...
QString OAICreateStage_request::getName() const {
    return m_name;
}
void OAICreateStage_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateStage_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateStage_request::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIParticipantTokenConfiguration> OAICreateStage_request::getParticipantTokenConfigurations() const {
    return m_participant_token_configurations;
}
void OAICreateStage_request::setParticipantTokenConfigurations(const QList<OAIParticipantTokenConfiguration> &participant_token_configurations) {
    m_participant_token_configurations = participant_token_configurations;
    m_participant_token_configurations_isSet = true;
}

bool OAICreateStage_request::is_participant_token_configurations_Set() const{
    return m_participant_token_configurations_isSet;
}

bool OAICreateStage_request::is_participant_token_configurations_Valid() const{
