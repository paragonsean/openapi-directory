...
#ifndef OAIEventErrorCode_H
#define OAIEventErrorCode_H
...
class OAIEventErrorCode : public OAIEnum {
public:
    OAIEventErrorCode();
    OAIEventErrorCode(QString json);
    ~OAIEventErrorCode() override;
    ...
    enum class eOAIEventErrorCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INSUFFICIENT_CAPABILITIES, 
        QUOTA_EXCEEDED, 
        PUBLISHER_NOT_FOUND
    };
    OAIEventErrorCode::eOAIEventErrorCode getValue() const;
    void setValue(const OAIEventErrorCode::eOAIEventErrorCode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventErrorCode)

#endif // OAIEventErrorCode_H
