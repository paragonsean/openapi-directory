...
OAIListParticipantsResponse::OAIListParticipantsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListParticipantsResponse::OAIListParticipantsResponse() {
    this->initializeModel();
}

OAIListParticipantsResponse::~OAIListParticipantsResponse() {}

void OAIListParticipantsResponse::initializeModel() {
...
void OAIListParticipantsResponse::fromJson(QString jsonString) {
...
void OAIListParticipantsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListParticipantsResponse::asJson() const {
...
QJsonObject OAIListParticipantsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListParticipantsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListParticipantsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListParticipantsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListParticipantsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListParticipantsResponse::getParticipants() const {
    return m_participants;
}
void OAIListParticipantsResponse::setParticipants(const QList &participants) {
    m_participants = participants;
    m_participants_isSet = true;
}

bool OAIListParticipantsResponse::is_participants_Set() const{
    return m_participants_isSet;
}

bool OAIListParticipantsResponse::is_participants_Valid() const{
    return m_participants_isValid;
}

bool OAIListParticipantsResponse::isSet() const {
...
bool OAIListParticipantsResponse::isValid() const {
