...
OAIGetParticipantResponse::OAIGetParticipantResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetParticipantResponse::OAIGetParticipantResponse() {
    this->initializeModel();
}

OAIGetParticipantResponse::~OAIGetParticipantResponse() {}

void OAIGetParticipantResponse::initializeModel() {

    m_participant_isSet = false;
    m_participant_isValid = false;
}

void OAIGetParticipantResponse::fromJson(QString jsonString) {
...
void OAIGetParticipantResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetParticipantResponse::asJson() const {
...
QJsonObject OAIGetParticipantResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetParticipantResponse_participant OAIGetParticipantResponse::getParticipant() const {
    return m_participant;
}
void OAIGetParticipantResponse::setParticipant(const OAIGetParticipantResponse_participant &participant) {
    m_participant = participant;
    m_participant_isSet = true;
}

bool OAIGetParticipantResponse::is_participant_Set() const{
    return m_participant_isSet;
}

bool OAIGetParticipantResponse::is_participant_Valid() const{
    return m_participant_isValid;
}

bool OAIGetParticipantResponse::isSet() const {
...
bool OAIGetParticipantResponse::isValid() const {
