...
/*
 * OAIStageSessionSummary.h
 *
 * Summary information about a stage session.
 */

#ifndef OAIStageSessionSummary_H
#define OAIStageSessionSummary_H
...
class OAIStageSessionSummary : public OAIObject {
public:
    OAIStageSessionSummary();
    OAIStageSessionSummary(QString json);
    ~OAIStageSessionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageSessionSummary)

#endif // OAIStageSessionSummary_H
