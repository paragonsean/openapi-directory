...
/*
 * OAIListStagesResponse.h
 *
 * 
 */

#ifndef OAIListStagesResponse_H
#define OAIListStagesResponse_H
...
class OAIListStagesResponse : public OAIObject {
public:
    OAIListStagesResponse();
    OAIListStagesResponse(QString json);
    ~OAIListStagesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStagesResponse)

#endif // OAIListStagesResponse_H
