...
OAIListParticipantEventsResponse::OAIListParticipantEventsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListParticipantEventsResponse::OAIListParticipantEventsResponse() {
    this->initializeModel();
}

OAIListParticipantEventsResponse::~OAIListParticipantEventsResponse() {}

void OAIListParticipantEventsResponse::initializeModel() {
...
void OAIListParticipantEventsResponse::fromJson(QString jsonString) {
...
void OAIListParticipantEventsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListParticipantEventsResponse::asJson() const {
...
QJsonObject OAIListParticipantEventsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_events.isSet()) {
...
QList OAIListParticipantEventsResponse::getEvents() const {
    return m_events;
}
void OAIListParticipantEventsResponse::setEvents(const QList &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIListParticipantEventsResponse::is_events_Set() const{
    return m_events_isSet;
}

bool OAIListParticipantEventsResponse::is_events_Valid() const{
    return m_events_isValid;
}

QString OAIListParticipantEventsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListParticipantEventsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListParticipantEventsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListParticipantEventsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListParticipantEventsResponse::isSet() const {
...
bool OAIListParticipantEventsResponse::isValid() const {
