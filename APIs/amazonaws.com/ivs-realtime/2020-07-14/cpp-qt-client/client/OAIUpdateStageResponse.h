...
namespace OpenAPI {
class OAIUpdateStageResponse_stage;
...
public:
    ...
    OAIUpdateStageResponse_stage getStage() const;
    void setStage(const OAIUpdateStageResponse_stage &stage);
...
private:
    ...
    OAIUpdateStageResponse_stage m_stage;
    bool m_stage_isSet;
