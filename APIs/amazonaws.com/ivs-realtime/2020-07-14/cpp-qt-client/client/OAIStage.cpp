...
QString OAIStage::getActiveSessionId() const {
    return m_active_session_id;
}
void OAIStage::setActiveSessionId(const QString &active_session_id) {
    m_active_session_id = active_session_id;
    m_active_session_id_isSet = true;
}

bool OAIStage::is_active_session_id_Set() const{
    return m_active_session_id_isSet;
}

bool OAIStage::is_active_session_id_Valid() const{
    return m_active_session_id_isValid;
}

QString OAIStage::getArn() const {
    return m_arn;
}
void OAIStage::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStage::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStage::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIStage::getName() const {
    return m_name;
}
void OAIStage::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStage::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStage::is_name_Valid() const{
