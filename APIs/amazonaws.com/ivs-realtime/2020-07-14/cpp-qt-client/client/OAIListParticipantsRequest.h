...
/*
 * OAIListParticipantsRequest.h
 *
 * 
 */

#ifndef OAIListParticipantsRequest_H
#define OAIListParticipantsRequest_H
...
class OAIListParticipantsRequest : public OAIObject {
public:
    OAIListParticipantsRequest();
    OAIListParticipantsRequest(QString json);
    ~OAIListParticipantsRequest() override;
    ...
    void setFilterByPublished(const bool &filter_by_published);
    bool is_filter_by_published_Set() const;
    bool is_filter_by_published_Valid() const;

    OAIParticipantState getFilterByState() const;
    void setFilterByState(const OAIParticipantState &filter_by_state);
    bool is_filter_by_state_Set() const;
    bool is_filter_by_state_Valid() const;

    QString getFilterByUserId() const;
    void setFilterByUserId(const QString &filter_by_user_id);
    bool is_filter_by_user_id_Set() const;
    bool is_filter_by_user_id_Valid() const;
...
private:
    ...
    bool m_filter_by_published;
    bool m_filter_by_published_isSet;
    bool m_filter_by_published_isValid;

    OAIParticipantState m_filter_by_state;
    bool m_filter_by_state_isSet;
    bool m_filter_by_state_isValid;

    QString m_filter_by_user_id;
    bool m_filter_by_user_id_isSet;
    bool m_filter_by_user_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipantsRequest)

#endif // OAIListParticipantsRequest_H
