...
/*
 * OAIListStageSessionsResponse.h
 *
 * 
 */

#ifndef OAIListStageSessionsResponse_H
#define OAIListStageSessionsResponse_H
...
class OAIListStageSessionsResponse : public OAIObject {
public:
    OAIListStageSessionsResponse();
    OAIListStageSessionsResponse(QString json);
    ~OAIListStageSessionsResponse() override;
    ...
    QList getStageSessions() const;
    void setStageSessions(const QList &stage_sessions);
    bool is_stage_sessions_Set() const;
    bool is_stage_sessions_Valid() const;
...
private:
    ...
    QList m_stage_sessions;
    bool m_stage_sessions_isSet;
    bool m_stage_sessions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListStageSessionsResponse)

#endif // OAIListStageSessionsResponse_H
