...
OAIListParticipantEvents_request::OAIListParticipantEvents_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListParticipantEvents_request::OAIListParticipantEvents_request() {
    this->initializeModel();
}

OAIListParticipantEvents_request::~OAIListParticipantEvents_request() {}

void OAIListParticipantEvents_request::initializeModel() {
...
void OAIListParticipantEvents_request::fromJson(QString jsonString) {
...
void OAIListParticipantEvents_request::fromJsonObject(QJsonObject json) {
...
QString OAIListParticipantEvents_request::asJson() const {
...
QJsonObject OAIListParticipantEvents_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListParticipantEvents_request::getMaxResults() const {
    return m_max_results;
}
void OAIListParticipantEvents_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListParticipantEvents_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListParticipantEvents_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListParticipantEvents_request::getNextToken() const {
    return m_next_token;
}
void OAIListParticipantEvents_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListParticipantEvents_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListParticipantEvents_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QString OAIListParticipantEvents_request::getParticipantId() const {
    return m_participant_id;
}
void OAIListParticipantEvents_request::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIListParticipantEvents_request::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIListParticipantEvents_request::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QString OAIListParticipantEvents_request::getSessionId() const {
    return m_session_id;
}
void OAIListParticipantEvents_request::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIListParticipantEvents_request::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIListParticipantEvents_request::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QString OAIListParticipantEvents_request::getStageArn() const {
    return m_stage_arn;
}
void OAIListParticipantEvents_request::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIListParticipantEvents_request::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIListParticipantEvents_request::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

bool OAIListParticipantEvents_request::isSet() const {
...
bool OAIListParticipantEvents_request::isValid() const {
