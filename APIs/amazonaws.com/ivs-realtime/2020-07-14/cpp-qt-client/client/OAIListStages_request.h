...
/*
 * OAIListStages_request.h
 *
 * 
 */

#ifndef OAIListStages_request_H
#define OAIListStages_request_H
...
class OAIListStages_request : public OAIObject {
public:
    OAIListStages_request();
    OAIListStages_request(QString json);
    ~OAIListStages_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStages_request)

#endif // OAIListStages_request_H
