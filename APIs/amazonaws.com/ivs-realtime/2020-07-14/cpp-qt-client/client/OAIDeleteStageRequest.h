...
/*
 * OAIDeleteStageRequest.h
 *
 * 
 */

#ifndef OAIDeleteStageRequest_H
#define OAIDeleteStageRequest_H
...
class OAIDeleteStageRequest : public OAIObject {
public:
    OAIDeleteStageRequest();
    OAIDeleteStageRequest(QString json);
    ~OAIDeleteStageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStageRequest)

#endif // OAIDeleteStageRequest_H
