...
QString OAIUpdateStage_request::getArn() const {
    return m_arn;
}
void OAIUpdateStage_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateStage_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateStage_request::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateStage_request::getName() const {
    return m_name;
}
void OAIUpdateStage_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateStage_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateStage_request::is_name_Valid() const{
