...
/*
 * OAIListParticipantEventsResponse.h
 *
 * 
 */

#ifndef OAIListParticipantEventsResponse_H
#define OAIListParticipantEventsResponse_H
...
class OAIListParticipantEventsResponse : public OAIObject {
public:
    OAIListParticipantEventsResponse();
    OAIListParticipantEventsResponse(QString json);
    ~OAIListParticipantEventsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipantEventsResponse)

#endif // OAIListParticipantEventsResponse_H
