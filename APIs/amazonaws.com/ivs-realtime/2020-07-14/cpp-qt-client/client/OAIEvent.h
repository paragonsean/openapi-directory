...
public:
    ...
    OAIEventErrorCode getErrorCode() const;
    void setErrorCode(const OAIEventErrorCode &error_code);
    ...
    OAIEventName getName() const;
    void setName(const OAIEventName &name);
    ...
    QString getRemoteParticipantId() const;
    void setRemoteParticipantId(const QString &remote_participant_id);
    bool is_remote_participant_id_Set() const;
    bool is_remote_participant_id_Valid() const;
...
private:
    ...
    OAIEventErrorCode m_error_code;
    ...
    QString m_remote_participant_id;
    bool m_remote_participant_id_isSet;
    bool m_remote_participant_id_isValid;
};
