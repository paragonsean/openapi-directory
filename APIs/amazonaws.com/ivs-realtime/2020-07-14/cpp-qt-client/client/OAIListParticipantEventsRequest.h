...
/*
 * OAIListParticipantEventsRequest.h
 *
 * 
 */

#ifndef OAIListParticipantEventsRequest_H
#define OAIListParticipantEventsRequest_H
...
class OAIListParticipantEventsRequest : public OAIObject {
public:
    OAIListParticipantEventsRequest();
    OAIListParticipantEventsRequest(QString json);
    ~OAIListParticipantEventsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipantEventsRequest)

#endif // OAIListParticipantEventsRequest_H
