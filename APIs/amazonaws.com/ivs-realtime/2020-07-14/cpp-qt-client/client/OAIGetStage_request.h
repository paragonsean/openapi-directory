...
/*
 * OAIGetStage_request.h
 *
 * 
 */

#ifndef OAIGetStage_request_H
#define OAIGetStage_request_H
...
class OAIGetStage_request : public OAIObject {
public:
    OAIGetStage_request();
    OAIGetStage_request(QString json);
    ~OAIGetStage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStage_request)

#endif // OAIGetStage_request_H
