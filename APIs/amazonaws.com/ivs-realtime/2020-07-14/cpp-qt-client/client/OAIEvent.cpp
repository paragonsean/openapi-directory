...
void OAIEvent::initializeModel() {
    ...
    m_remote_participant_id_isSet = false;
    m_remote_participant_id_isValid = false;
}
...
void OAIEvent::fromJsonObject(QJsonObject json) {
    ...
    m_remote_participant_id_isValid = ::OpenAPI::fromJsonValue(m_remote_participant_id, json[QString("remoteParticipantId")]);
    m_remote_participant_id_isSet = !json[QString("remoteParticipantId")].isNull() && m_remote_participant_id_isValid;
}
...
QJsonObject OAIEvent::asJsonObject() const {
    ...
    if (m_remote_participant_id_isSet) {
        obj.insert(QString("remoteParticipantId"), ::OpenAPI::toJsonValue(m_remote_participant_id));
    }
    return obj;
}

OAIEventErrorCode OAIEvent::getErrorCode() const {
    return m_error_code;
}
void OAIEvent::setErrorCode(const OAIEventErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIEvent::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIEvent::is_error_code_Valid() const{
...
OAIEventName OAIEvent::getName() const {
    return m_name;
}
void OAIEvent::setName(const OAIEventName &name) {
    m_name = name;
    m_name_isSet = true;
}
...
QString OAIEvent::getParticipantId() const {
    return m_participant_id;
}
void OAIEvent::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIEvent::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIEvent::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QString OAIEvent::getRemoteParticipantId() const {
    return m_remote_participant_id;
}
void OAIEvent::setRemoteParticipantId(const QString &remote_participant_id) {
    m_remote_participant_id = remote_participant_id;
    m_remote_participant_id_isSet = true;
}

bool OAIEvent::is_remote_participant_id_Set() const{
    return m_remote_participant_id_isSet;
}

bool OAIEvent::is_remote_participant_id_Valid() const{
    return m_remote_participant_id_isValid;
}
