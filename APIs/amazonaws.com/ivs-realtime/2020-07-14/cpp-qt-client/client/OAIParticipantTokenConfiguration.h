...
/*
 * OAIParticipantTokenConfiguration.h
 *
 * Object specifying a participant token configuration in a stage.
 */

#ifndef OAIParticipantTokenConfiguration_H
#define OAIParticipantTokenConfiguration_H
...
class OAIParticipantTokenConfiguration : public OAIObject {
public:
    OAIParticipantTokenConfiguration();
    OAIParticipantTokenConfiguration(QString json);
    ~OAIParticipantTokenConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipantTokenConfiguration)

#endif // OAIParticipantTokenConfiguration_H
