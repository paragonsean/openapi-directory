...
OAIGetStageResponse::OAIGetStageResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStageResponse::OAIGetStageResponse() {
    this->initializeModel();
}

OAIGetStageResponse::~OAIGetStageResponse() {}

void OAIGetStageResponse::initializeModel() {

    m_stage_isSet = false;
    m_stage_isValid = false;
}

void OAIGetStageResponse::fromJson(QString jsonString) {
...
QJsonObject OAIGetStageResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_stage.isSet()) {
...
OAIGetStageResponse_stage OAIGetStageResponse::getStage() const {
    return m_stage;
}
void OAIGetStageResponse::setStage(const OAIGetStageResponse_stage &stage) {
    m_stage = stage;
    m_stage_isSet = true;
}

bool OAIGetStageResponse::is_stage_Set() const{
    return m_stage_isSet;
}

bool OAIGetStageResponse::is_stage_Valid() const{
    return m_stage_isValid;
}

bool OAIGetStageResponse::isSet() const {
...
bool OAIGetStageResponse::isValid() const {
