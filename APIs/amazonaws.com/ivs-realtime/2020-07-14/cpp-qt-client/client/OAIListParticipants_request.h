...
/*
 * OAIListParticipants_request.h
 *
 * 
 */

#ifndef OAIListParticipants_request_H
#define OAIListParticipants_request_H
...
class OAIListParticipants_request : public OAIObject {
public:
    OAIListParticipants_request();
    OAIListParticipants_request(QString json);
    ~OAIListParticipants_request() override;
    ...
    bool isFilterByPublished() const;
    ...
    QString getFilterByState() const;
    void setFilterByState(const QString &filter_by_state);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListParticipants_request)

#endif // OAIListParticipants_request_H
