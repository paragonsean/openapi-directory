...
OAIUpdateStageResponse_stage OAIUpdateStageResponse::getStage() const {
    return m_stage;
}
void OAIUpdateStageResponse::setStage(const OAIUpdateStageResponse_stage &stage) {
    m_stage = stage;
    m_stage_isSet = true;
}

bool OAIUpdateStageResponse::is_stage_Set() const{
    return m_stage_isSet;
}

bool OAIUpdateStageResponse::is_stage_Valid() const{
