...
void OAICreateStageResponse::initializeModel() {
    ...
    m_participant_tokens_isSet = false;
    m_participant_tokens_isValid = false;
...
void OAICreateStageResponse::fromJsonObject(QJsonObject json) {
    ...
    m_participant_tokens_isValid = ::OpenAPI::fromJsonValue(m_participant_tokens, json[QString("participantTokens")]);
    m_participant_tokens_isSet = !json[QString("participantTokens")].isNull() && m_participant_tokens_isValid;
...
QJsonObject OAICreateStageResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_participant_tokens.isSet()) {
        obj.insert(QString("participantTokens"), ::OpenAPI::toJsonValue(m_participant_tokens));
    }
    if (m_stage.isSet()) {
...
QList OAICreateStageResponse::getParticipantTokens() const {
    return m_participant_tokens;
}
void OAICreateStageResponse::setParticipantTokens(const QList &participant_tokens) {
    m_participant_tokens = participant_tokens;
    m_participant_tokens_isSet = true;
}

bool OAICreateStageResponse::is_participant_tokens_Set() const{
    return m_participant_tokens_isSet;
}

bool OAICreateStageResponse::is_participant_tokens_Valid() const{
    return m_participant_tokens_isValid;
}

OAICreateStageResponse_stage OAICreateStageResponse::getStage() const {
    return m_stage;
}
void OAICreateStageResponse::setStage(const OAICreateStageResponse_stage &stage) {
    m_stage = stage;
    m_stage_isSet = true;
}

bool OAICreateStageResponse::is_stage_Set() const{
    return m_stage_isSet;
}

bool OAICreateStageResponse::is_stage_Valid() const{
