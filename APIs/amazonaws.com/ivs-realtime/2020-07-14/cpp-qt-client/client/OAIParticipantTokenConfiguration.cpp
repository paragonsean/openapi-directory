...
OAIParticipantTokenConfiguration::OAIParticipantTokenConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParticipantTokenConfiguration::OAIParticipantTokenConfiguration() {
    this->initializeModel();
}

OAIParticipantTokenConfiguration::~OAIParticipantTokenConfiguration() {}

void OAIParticipantTokenConfiguration::initializeModel() {
...
void OAIParticipantTokenConfiguration::fromJson(QString jsonString) {
...
void OAIParticipantTokenConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIParticipantTokenConfiguration::asJson() const {
...
QJsonObject OAIParticipantTokenConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIParticipantTokenConfiguration::getAttributes() const {
    return m_attributes;
}
void OAIParticipantTokenConfiguration::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIParticipantTokenConfiguration::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIParticipantTokenConfiguration::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList OAIParticipantTokenConfiguration::getCapabilities() const {
    return m_capabilities;
}
void OAIParticipantTokenConfiguration::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIParticipantTokenConfiguration::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIParticipantTokenConfiguration::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

qint32 OAIParticipantTokenConfiguration::getDuration() const {
    return m_duration;
}
void OAIParticipantTokenConfiguration::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIParticipantTokenConfiguration::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIParticipantTokenConfiguration::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIParticipantTokenConfiguration::getUserId() const {
    return m_user_id;
}
void OAIParticipantTokenConfiguration::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIParticipantTokenConfiguration::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIParticipantTokenConfiguration::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIParticipantTokenConfiguration::isSet() const {
...
bool OAIParticipantTokenConfiguration::isValid() const {
