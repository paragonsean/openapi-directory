...
OAIParticipantToken::OAIParticipantToken(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParticipantToken::OAIParticipantToken() {
    this->initializeModel();
}

OAIParticipantToken::~OAIParticipantToken() {}

void OAIParticipantToken::initializeModel() {
...
void OAIParticipantToken::fromJson(QString jsonString) {
...
void OAIParticipantToken::fromJsonObject(QJsonObject json) {
...
QString OAIParticipantToken::asJson() const {
...
QJsonObject OAIParticipantToken::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIParticipantToken::getAttributes() const {
    return m_attributes;
}
void OAIParticipantToken::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIParticipantToken::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIParticipantToken::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList OAIParticipantToken::getCapabilities() const {
    return m_capabilities;
}
void OAIParticipantToken::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIParticipantToken::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIParticipantToken::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

qint32 OAIParticipantToken::getDuration() const {
    return m_duration;
}
void OAIParticipantToken::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIParticipantToken::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIParticipantToken::is_duration_Valid() const{
    return m_duration_isValid;
}

QDateTime OAIParticipantToken::getExpirationTime() const {
    return m_expiration_time;
}
void OAIParticipantToken::setExpirationTime(const QDateTime &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAIParticipantToken::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAIParticipantToken::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAIParticipantToken::getParticipantId() const {
    return m_participant_id;
}
void OAIParticipantToken::setParticipantId(const QString &participant_id) {
    m_participant_id = participant_id;
    m_participant_id_isSet = true;
}

bool OAIParticipantToken::is_participant_id_Set() const{
    return m_participant_id_isSet;
}

bool OAIParticipantToken::is_participant_id_Valid() const{
    return m_participant_id_isValid;
}

QString OAIParticipantToken::getToken() const {
    return m_token;
}
void OAIParticipantToken::setToken(const QString &token) {
    m_token = token;
    m_token_isSet = true;
}

bool OAIParticipantToken::is_token_Set() const{
    return m_token_isSet;
}

bool OAIParticipantToken::is_token_Valid() const{
    return m_token_isValid;
}

QString OAIParticipantToken::getUserId() const {
    return m_user_id;
}
void OAIParticipantToken::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIParticipantToken::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIParticipantToken::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIParticipantToken::isSet() const {
...
bool OAIParticipantToken::isValid() const {
