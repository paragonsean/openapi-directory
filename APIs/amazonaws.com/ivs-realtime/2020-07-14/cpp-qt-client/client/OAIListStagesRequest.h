...
/*
 * OAIListStagesRequest.h
 *
 * 
 */

#ifndef OAIListStagesRequest_H
#define OAIListStagesRequest_H
...
class OAIListStagesRequest : public OAIObject {
public:
    OAIListStagesRequest();
    OAIListStagesRequest(QString json);
    ~OAIListStagesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStagesRequest)

#endif // OAIListStagesRequest_H
