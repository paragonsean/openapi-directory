...
OAIListStageSessionsResponse::OAIListStageSessionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStageSessionsResponse::OAIListStageSessionsResponse() {
    this->initializeModel();
}

OAIListStageSessionsResponse::~OAIListStageSessionsResponse() {}

void OAIListStageSessionsResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_stage_sessions_isSet = false;
    m_stage_sessions_isValid = false;
}

void OAIListStageSessionsResponse::fromJson(QString jsonString) {
...
void OAIListStageSessionsResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_stage_sessions_isValid = ::OpenAPI::fromJsonValue(m_stage_sessions, json[QString("stageSessions")]);
    m_stage_sessions_isSet = !json[QString("stageSessions")].isNull() && m_stage_sessions_isValid;
}

QString OAIListStageSessionsResponse::asJson() const {
...
QJsonObject OAIListStageSessionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_stage_sessions.isSet()) {
        obj.insert(QString("stageSessions"), ::OpenAPI::toJsonValue(m_stage_sessions));
    }
    return obj;
}

QString OAIListStageSessionsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStageSessionsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStageSessionsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStageSessionsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStageSessionsResponse::getStageSessions() const {
    return m_stage_sessions;
}
void OAIListStageSessionsResponse::setStageSessions(const QList &stage_sessions) {
    m_stage_sessions = stage_sessions;
    m_stage_sessions_isSet = true;
}

bool OAIListStageSessionsResponse::is_stage_sessions_Set() const{
    return m_stage_sessions_isSet;
}

bool OAIListStageSessionsResponse::is_stage_sessions_Valid() const{
    return m_stage_sessions_isValid;
}

bool OAIListStageSessionsResponse::isSet() const {
...
bool OAIListStageSessionsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_stage_sessions_isValid && true;
}
