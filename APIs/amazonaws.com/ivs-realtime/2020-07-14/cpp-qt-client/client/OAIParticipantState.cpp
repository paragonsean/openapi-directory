...
OAIParticipantState::OAIParticipantState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParticipantState::OAIParticipantState() {
    this->initializeModel();
}

OAIParticipantState::~OAIParticipantState() {}

void OAIParticipantState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIParticipantState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIParticipantState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CONNECTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIParticipantState::CONNECTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISCONNECTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIParticipantState::DISCONNECTED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIParticipantState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIParticipantState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIParticipantState::CONNECTED:
            val = "CONNECTED";
            break;
        case eOAIParticipantState::DISCONNECTED:
            val = "DISCONNECTED";
            break;
        default:
            break;
...
QJsonValue OAIParticipantState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIParticipantState::eOAIParticipantState OAIParticipantState::getValue() const {
    return m_value;
}

void OAIParticipantState::setValue(const OAIParticipantState::eOAIParticipantState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIParticipantState::isSet() const {
    
    return m_value_isSet;
}

bool OAIParticipantState::isValid() const {
