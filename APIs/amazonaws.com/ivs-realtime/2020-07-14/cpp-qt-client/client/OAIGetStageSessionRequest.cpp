...
#include "OAIGetStageSessionRequest.h"
...
OAIGetStageSessionRequest::OAIGetStageSessionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStageSessionRequest::OAIGetStageSessionRequest() {
    this->initializeModel();
}

OAIGetStageSessionRequest::~OAIGetStageSessionRequest() {}

void OAIGetStageSessionRequest::initializeModel() {
...
void OAIGetStageSessionRequest::fromJson(QString jsonString) {
...
void OAIGetStageSessionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetStageSessionRequest::asJson() const {
...
QJsonObject OAIGetStageSessionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStageSessionRequest::getSessionId() const {
    return m_session_id;
}
void OAIGetStageSessionRequest::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIGetStageSessionRequest::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIGetStageSessionRequest::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QString OAIGetStageSessionRequest::getStageArn() const {
    return m_stage_arn;
}
void OAIGetStageSessionRequest::setStageArn(const QString &stage_arn) {
    m_stage_arn = stage_arn;
    m_stage_arn_isSet = true;
}

bool OAIGetStageSessionRequest::is_stage_arn_Set() const{
    return m_stage_arn_isSet;
}

bool OAIGetStageSessionRequest::is_stage_arn_Valid() const{
    return m_stage_arn_isValid;
}

bool OAIGetStageSessionRequest::isSet() const {
...
bool OAIGetStageSessionRequest::isValid() const {
