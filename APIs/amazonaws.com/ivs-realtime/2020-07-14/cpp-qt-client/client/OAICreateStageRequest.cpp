...
void OAICreateStageRequest::initializeModel() {
    ...
    m_participant_token_configurations_isSet = false;
    m_participant_token_configurations_isValid = false;
...
void OAICreateStageRequest::fromJsonObject(QJsonObject json) {
    ...
    m_participant_token_configurations_isValid = ::OpenAPI::fromJsonValue(m_participant_token_configurations, json[QString("participantTokenConfigurations")]);
    m_participant_token_configurations_isSet = !json[QString("participantTokenConfigurations")].isNull() && m_participant_token_configurations_isValid;
...
QJsonObject OAICreateStageRequest::asJsonObject() const {
    ...
    if (m_participant_token_configurations.isSet()) {
        obj.insert(QString("participantTokenConfigurations"), ::OpenAPI::toJsonValue(m_participant_token_configurations));
    }
    if (m_tags.isSet()) {
...
QString OAICreateStageRequest::getName() const {
    return m_name;
}
void OAICreateStageRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateStageRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateStageRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateStageRequest::getParticipantTokenConfigurations() const {
    return m_participant_token_configurations;
}
void OAICreateStageRequest::setParticipantTokenConfigurations(const QList &participant_token_configurations) {
    m_participant_token_configurations = participant_token_configurations;
    m_participant_token_configurations_isSet = true;
}

bool OAICreateStageRequest::is_participant_token_configurations_Set() const{
    return m_participant_token_configurations_isSet;
}

bool OAICreateStageRequest::is_participant_token_configurations_Valid() const{
    return m_participant_token_configurations_isValid;
}
