...
/*
 * OAIUpdateStageResponse_stage.h
 *
 * 
 */

#ifndef OAIUpdateStageResponse_stage_H
#define OAIUpdateStageResponse_stage_H
...
class OAIUpdateStageResponse_stage : public OAIObject {
public:
    OAIUpdateStageResponse_stage();
    OAIUpdateStageResponse_stage(QString json);
    ~OAIUpdateStageResponse_stage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStageResponse_stage)

#endif // OAIUpdateStageResponse_stage_H
