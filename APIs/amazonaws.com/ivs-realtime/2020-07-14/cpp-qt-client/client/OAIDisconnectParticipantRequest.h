...
/*
 * OAIDisconnectParticipantRequest.h
 *
 * 
 */

#ifndef OAIDisconnectParticipantRequest_H
#define OAIDisconnectParticipantRequest_H
...
class OAIDisconnectParticipantRequest : public OAIObject {
public:
    OAIDisconnectParticipantRequest();
    OAIDisconnectParticipantRequest(QString json);
    ~OAIDisconnectParticipantRequest() override;
    ...
    QString getStageArn() const;
    void setStageArn(const QString &stage_arn);
    bool is_stage_arn_Set() const;
    bool is_stage_arn_Valid() const;
...
private:
    ...
    QString m_stage_arn;
    bool m_stage_arn_isSet;
    bool m_stage_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDisconnectParticipantRequest)

#endif // OAIDisconnectParticipantRequest_H
