...
OAIStageSession::OAIStageSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStageSession::OAIStageSession() {
    this->initializeModel();
}

OAIStageSession::~OAIStageSession() {}

void OAIStageSession::initializeModel() {
...
void OAIStageSession::fromJson(QString jsonString) {
...
void OAIStageSession::fromJsonObject(QJsonObject json) {
...
QString OAIStageSession::asJson() const {
...
QJsonObject OAIStageSession::asJsonObject() const {
    QJsonObject obj;
    if (m_end_time_isSet) {
...
QDateTime OAIStageSession::getEndTime() const {
    return m_end_time;
}
void OAIStageSession::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIStageSession::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIStageSession::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIStageSession::getSessionId() const {
    return m_session_id;
}
void OAIStageSession::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAIStageSession::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAIStageSession::is_session_id_Valid() const{
    return m_session_id_isValid;
}

QDateTime OAIStageSession::getStartTime() const {
    return m_start_time;
}
void OAIStageSession::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStageSession::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStageSession::is_start_time_Valid() const{
    return m_start_time_isValid;
}

bool OAIStageSession::isSet() const {
...
bool OAIStageSession::isValid() const {
