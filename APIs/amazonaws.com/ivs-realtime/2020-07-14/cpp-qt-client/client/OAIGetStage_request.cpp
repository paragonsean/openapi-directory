...
OAIGetStage_request::OAIGetStage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStage_request::OAIGetStage_request() {
    this->initializeModel();
}

OAIGetStage_request::~OAIGetStage_request() {}

void OAIGetStage_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetStage_request::fromJson(QString jsonString) {
...
void OAIGetStage_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetStage_request::asJson() const {
...
QJsonObject OAIGetStage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetStage_request::getArn() const {
    return m_arn;
}
void OAIGetStage_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStage_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStage_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetStage_request::isSet() const {
...
bool OAIGetStage_request::isValid() const {
