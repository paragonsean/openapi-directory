...
/*
 * OAIGetStageSessionResponse_stageSession.h
 *
 * 
 */

#ifndef OAIGetStageSessionResponse_stageSession_H
#define OAIGetStageSessionResponse_stageSession_H
...
class OAIGetStageSessionResponse_stageSession : public OAIObject {
public:
    OAIGetStageSessionResponse_stageSession();
    OAIGetStageSessionResponse_stageSession(QString json);
    ~OAIGetStageSessionResponse_stageSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStageSessionResponse_stageSession)

#endif // OAIGetStageSessionResponse_stageSession_H
