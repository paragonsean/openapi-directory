...
/*
 * OAIGetStageSessionResponse.h
 *
 * 
 */

#ifndef OAIGetStageSessionResponse_H
#define OAIGetStageSessionResponse_H
...
namespace OpenAPI {
class OAIGetStageSessionResponse_stageSession;

class OAIGetStageSessionResponse : public OAIObject {
public:
    OAIGetStageSessionResponse();
    OAIGetStageSessionResponse(QString json);
    ~OAIGetStageSessionResponse() override;
    ...
    OAIGetStageSessionResponse_stageSession getStageSession() const;
    void setStageSession(const OAIGetStageSessionResponse_stageSession &stage_session);
    bool is_stage_session_Set() const;
    bool is_stage_session_Valid() const;
...
private:
    ...
    OAIGetStageSessionResponse_stageSession m_stage_session;
    bool m_stage_session_isSet;
    bool m_stage_session_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetStageSessionResponse)

#endif // OAIGetStageSessionResponse_H
