...
async def test_associate_user_to_permission_group(client):
    """Test case for associate_user_to_permission_group
    ...
    response = await client.request(
        method='POST',
        path='/permission-group/{permission_group_id}/users/{user_id}'.format(permission_group_id='permission_group_id_example', user_id='user_id_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_changeset(client):
    """Test case for create_changeset

    
    """
    body = {"formatParams":"","clientToken":"","changeType":"","sourceParams":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/datasets/{dataset_id}/changesetsv2'.format(dataset_id='dataset_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_data_view(client):
    """Test case for create_data_view

    
    """
    body = {"autoUpdate":"","destinationTypeParams":{"s3DestinationExportFileFormat":"","destinationType":"","s3DestinationExportFileFormatOptions":""},"sortColumns":"","clientToken":"","partitionColumns":"","asOfTimestamp":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/datasets/{dataset_id}/dataviewsv2'.format(dataset_id='dataset_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_dataset(client):
    ...
    """
    body = {"datasetTitle":"","datasetDescription":"","permissionGroupParams":{"permissionGroupId":"","datasetPermissions":""},"clientToken":"","kind":"","schemaDefinition":{"tabularSchemaConfig":{"primaryKeyColumns":"","columns":""}},"ownerInfo":{"phoneNumber":"","name":"","email":""},"alias":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_permission_group(client):
    ...
    """
    body = {"applicationPermissions":"","clientToken":"","name":"","description":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_user(client):
    ...
    """
    body = {"ApiAccess":"","firstName":"","lastName":"","emailAddress":"","clientToken":"","apiAccessPrincipalArn":"","type":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_dataset(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/datasetsv2/{dataset_id}'.format(dataset_id='dataset_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_permission_group(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/permission-group/{permission_group_id}'.format(permission_group_id='permission_group_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disable_user(client):
    ...
    response = await client.request(
        method='POST',
        path='/user/{user_id}/disable'.format(user_id='user_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_user_from_permission_group(client):
    """Test case for disassociate_user_from_permission_group
...
async def test_enable_user(client):
    ...
    response = await client.request(
        method='POST',
        path='/user/{user_id}/enable'.format(user_id='user_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_changeset(client):
    ...
    response = await client.request(
        method='GET',
        path='/datasets/{dataset_id}/changesetsv2/{changeset_id}'.format(dataset_id='dataset_id_example', changeset_id='changeset_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_data_view(client):
    """Test case for get_data_view
    ...
    response = await client.request(
        method='GET',
        path='/datasets/{dataset_id}/dataviewsv2/{dataview_id}'.format(dataview_id='dataview_id_example', dataset_id='dataset_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_external_data_view_access_details(client):
    """Test case for get_external_data_view_access_details
    ...
    response = await client.request(
        method='POST',
        path='/datasets/{dataset_id}/dataviewsv2/{dataview_id}/external-access-details'.format(dataview_id='dataview_id_example', dataset_id='dataset_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_programmatic_access_credentials(client):
    """Test case for get_programmatic_access_credentials

    
    """
    params = [('durationInMinutes', 56),
...
async def test_get_working_location(client):
    """Test case for get_working_location
...
async def test_list_data_views(client):
    """Test case for list_data_views
...
async def test_list_permission_groups(client):
    ...
    response = await client.request(
        method='GET',
        path='/permission-group#maxResults',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_permission_groups_by_user(client):
    """Test case for list_permission_groups_by_user
    ...
    response = await client.request(
        method='GET',
        path='/user/{user_id}/permission-groups#maxResults'.format(user_id='user_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_users_by_permission_group(client):
    """Test case for list_users_by_permission_group
    ...
    response = await client.request(
        method='GET',
        path='/permission-group/{permission_group_id}/users#maxResults'.format(permission_group_id='permission_group_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reset_user_password(client):
    ...
    response = await client.request(
        method='POST',
        path='/user/{user_id}/password'.format(user_id='user_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_changeset(client):
    """Test case for update_changeset

    
    """
    body = {"formatParams":"","clientToken":"","sourceParams":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_dataset(client):
    ...
    """
    body = {"datasetTitle":"","datasetDescription":"","clientToken":"","kind":"","schemaDefinition":{"tabularSchemaConfig":{"primaryKeyColumns":"","columns":""}},"alias":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_user(client):
    ...
    """
    body = {"firstName":"","lastName":"","apiAccess":"","clientToken":"","apiAccessPrincipalArn":"","type":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
