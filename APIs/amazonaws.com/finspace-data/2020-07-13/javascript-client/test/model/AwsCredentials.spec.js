...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.AwsCredentials();
  });
  ...
  describe('AwsCredentials', function() {
    it('should create an instance of AwsCredentials', function() {
      ...
      //var instance = new FinSpacePublicApi.AwsCredentials();
      //expect(instance).to.be.a(FinSpacePublicApi.AwsCredentials);
    });
