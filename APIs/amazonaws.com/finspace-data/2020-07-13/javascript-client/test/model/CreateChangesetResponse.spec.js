...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.CreateChangesetResponse();
  });
  ...
  describe('CreateChangesetResponse', function() {
    it('should create an instance of CreateChangesetResponse', function() {
      // uncomment below and update the code to test CreateChangesetResponse
      //var instance = new FinSpacePublicApi.CreateChangesetResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.CreateChangesetResponse);
    });
