...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.UpdateChangesetResponse();
  });
  ...
  describe('UpdateChangesetResponse', function() {
    it('should create an instance of UpdateChangesetResponse', function() {
      // uncomment below and update the code to test UpdateChangesetResponse
      //var instance = new FinSpacePublicApi.UpdateChangesetResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.UpdateChangesetResponse);
    });
