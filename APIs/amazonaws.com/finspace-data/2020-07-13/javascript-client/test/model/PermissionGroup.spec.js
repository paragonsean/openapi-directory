...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.PermissionGroup();
  });
  ...
  describe('PermissionGroup', function() {
    it('should create an instance of PermissionGroup', function() {
      ...
      //var instance = new FinSpacePublicApi.PermissionGroup();
      //expect(instance).to.be.a(FinSpacePublicApi.PermissionGroup);
    });
