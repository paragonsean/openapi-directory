...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.SchemaDefinition();
  });
  ...
  describe('SchemaDefinition', function() {
    it('should create an instance of SchemaDefinition', function() {
      ...
      //var instance = new FinSpacePublicApi.SchemaDefinition();
      //expect(instance).to.be.a(FinSpacePublicApi.SchemaDefinition);
    });
