...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.UpdateDatasetResponse();
  });
  ...
  describe('UpdateDatasetResponse', function() {
    it('should create an instance of UpdateDatasetResponse', function() {
      ...
      //var instance = new FinSpacePublicApi.UpdateDatasetResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.UpdateDatasetResponse);
    });
