...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.ListUsersResponse();
  });
  ...
  describe('ListUsersResponse', function() {
    it('should create an instance of ListUsersResponse', function() {
      ...
      //var instance = new FinSpacePublicApi.ListUsersResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.ListUsersResponse);
    });
