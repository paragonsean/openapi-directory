...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.GetExternalDataViewAccessDetailsResponseCredentials();
  });
  ...
  describe('GetExternalDataViewAccessDetailsResponseCredentials', function() {
    it('should create an instance of GetExternalDataViewAccessDetailsResponseCredentials', function() {
      // uncomment below and update the code to test GetExternalDataViewAccessDetailsResponseCredentials
      //var instance = new FinSpacePublicApi.GetExternalDataViewAccessDetailsResponseCredentials();
      //expect(instance).to.be.a(FinSpacePublicApi.GetExternalDataViewAccessDetailsResponseCredentials);
    });
