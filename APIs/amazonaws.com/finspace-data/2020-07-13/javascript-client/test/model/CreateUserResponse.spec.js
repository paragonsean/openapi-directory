...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.CreateUserResponse();
  });
  ...
  describe('CreateUserResponse', function() {
    it('should create an instance of CreateUserResponse', function() {
      ...
      //var instance = new FinSpacePublicApi.CreateUserResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.CreateUserResponse);
    });
