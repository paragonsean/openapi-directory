...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinSpacePublicApi.GetDatasetResponse();
  });
  ...
  describe('GetDatasetResponse', function() {
    it('should create an instance of GetDatasetResponse', function() {
      // uncomment below and update the code to test GetDatasetResponse
      //var instance = new FinSpacePublicApi.GetDatasetResponse();
      //expect(instance).to.be.a(FinSpacePublicApi.GetDatasetResponse);
    });
