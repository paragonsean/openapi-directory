...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://finspace-api.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://finspace-api.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2020-07-13/Javascript'
        };
