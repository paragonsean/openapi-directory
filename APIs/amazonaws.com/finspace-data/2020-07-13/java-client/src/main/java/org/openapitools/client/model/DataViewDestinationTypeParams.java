...
public class DataViewDestinationTypeParams {
  ...
  public DataViewDestinationTypeParams() {
  }

  public DataViewDestinationTypeParams destinationType(String destinationType) {
  ...
  public DataViewDestinationTypeParams s3DestinationExportFileFormat(ExportFileFormat s3DestinationExportFileFormat) {
  ...
  public DataViewDestinationTypeParams s3DestinationExportFileFormatOptions(Map s3DestinationExportFileFormatOptions) {
  ...
  public boolean equals(Object o) {
    ...
    DataViewDestinationTypeParams dataViewDestinationTypeParams = (DataViewDestinationTypeParams) o;
    return Objects.equals(this.destinationType, dataViewDestinationTypeParams.destinationType) &&
        Objects.equals(this.s3DestinationExportFileFormat, dataViewDestinationTypeParams.s3DestinationExportFileFormat) &&
        Objects.equals(this.s3DestinationExportFileFormatOptions, dataViewDestinationTypeParams.s3DestinationExportFileFormatOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataViewDestinationTypeParams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataViewDestinationTypeParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataViewDestinationTypeParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataViewDestinationTypeParams is not found in the empty JSON string", DataViewDestinationTypeParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataViewDestinationTypeParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataViewDestinationTypeParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataViewDestinationTypeParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataViewDestinationTypeParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataViewDestinationTypeParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataViewDestinationTypeParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataViewDestinationTypeParams.class));

       return (TypeAdapter<T>) new TypeAdapter<DataViewDestinationTypeParams>() {
           @Override
           public void write(JsonWriter out, DataViewDestinationTypeParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataViewDestinationTypeParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataViewDestinationTypeParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataViewDestinationTypeParams
   * @throws IOException if the JSON string is invalid with respect to DataViewDestinationTypeParams
   */
  public static DataViewDestinationTypeParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataViewDestinationTypeParams.class);
  }

  /**
   * Convert an instance of DataViewDestinationTypeParams to an JSON string
   *
   * @return JSON string
   */
