...
public class SchemaDefinition {
  ...
  public SchemaDefinition columns(List columns) {
  ...
  public SchemaDefinition primaryKeyColumns(List primaryKeyColumns) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, schemaDefinition.columns) &&
        Objects.equals(this.primaryKeyColumns, schemaDefinition.primaryKeyColumns);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SchemaDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchemaDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchemaDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SchemaDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
