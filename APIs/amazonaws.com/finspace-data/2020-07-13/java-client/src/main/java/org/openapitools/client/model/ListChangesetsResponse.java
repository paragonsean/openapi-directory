...
public class ListChangesetsResponse {
  public static final String SERIALIZED_NAME_CHANGESETS = "changesets";
  @SerializedName(SERIALIZED_NAME_CHANGESETS)
  ...
  public ListChangesetsResponse changesets(List changesets) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.changesets, listChangesetsResponse.changesets) &&
        Objects.equals(this.nextToken, listChangesetsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(changesets, nextToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("changesets") != null && !jsonObj.get("changesets").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("changesets"));
      }
