...
/*
 * OAIUpdateChangesetResponse.h
 *
 * The response from a update changeset operation.
 */

#ifndef OAIUpdateChangesetResponse_H
#define OAIUpdateChangesetResponse_H
...
class OAIUpdateChangesetResponse : public OAIObject {
public:
    OAIUpdateChangesetResponse();
    OAIUpdateChangesetResponse(QString json);
    ~OAIUpdateChangesetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChangesetResponse)

#endif // OAIUpdateChangesetResponse_H
