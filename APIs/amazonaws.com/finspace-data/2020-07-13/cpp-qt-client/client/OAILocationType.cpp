...
void OAILocationType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("INGESTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAILocationType::INGESTION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SAGEMAKER", Qt::CaseInsensitive) == 0) {
        m_value = eOAILocationType::SAGEMAKER;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAILocationType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAILocationType::INGESTION:
            val = "INGESTION";
            break;
        case eOAILocationType::SAGEMAKER:
            val = "SAGEMAKER";
            break;
        default:
            break;
