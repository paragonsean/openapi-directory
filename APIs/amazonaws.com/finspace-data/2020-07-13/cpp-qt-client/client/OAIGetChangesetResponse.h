...
/*
 * OAIGetChangesetResponse.h
 *
 * The response from a describe changeset operation
 */

#ifndef OAIGetChangesetResponse_H
#define OAIGetChangesetResponse_H
...
class OAIGetChangesetResponse : public OAIObject {
public:
    OAIGetChangesetResponse();
    OAIGetChangesetResponse(QString json);
    ~OAIGetChangesetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChangesetResponse)

#endif // OAIGetChangesetResponse_H
