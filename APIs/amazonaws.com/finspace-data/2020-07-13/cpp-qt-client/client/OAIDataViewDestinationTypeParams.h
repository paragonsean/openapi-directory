...
/*
 * OAIDataViewDestinationTypeParams.h
 *
 * Structure for the Dataview destination type parameters.
 */

#ifndef OAIDataViewDestinationTypeParams_H
#define OAIDataViewDestinationTypeParams_H
...
class OAIDataViewDestinationTypeParams : public OAIObject {
public:
    OAIDataViewDestinationTypeParams();
    OAIDataViewDestinationTypeParams(QString json);
    ~OAIDataViewDestinationTypeParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataViewDestinationTypeParams)

#endif // OAIDataViewDestinationTypeParams_H
