...
void OAICreateDatasetResponse::setDatasetId(const QString &dataset_id) {
    m_dataset_id = dataset_id;
    m_dataset_id_isSet = true;
}

bool OAICreateDatasetResponse::is_dataset_id_Set() const{
    return m_dataset_id_isSet;
}

bool OAICreateDatasetResponse::is_dataset_id_Valid() const{
