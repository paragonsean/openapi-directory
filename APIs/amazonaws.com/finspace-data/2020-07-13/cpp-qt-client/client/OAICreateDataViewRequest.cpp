...
#include "OAICreateDataViewRequest.h"
...
OAICreateDataViewRequest::OAICreateDataViewRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDataViewRequest::OAICreateDataViewRequest() {
    this->initializeModel();
}

OAICreateDataViewRequest::~OAICreateDataViewRequest() {}

void OAICreateDataViewRequest::initializeModel() {
...
void OAICreateDataViewRequest::fromJson(QString jsonString) {
...
void OAICreateDataViewRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateDataViewRequest::asJson() const {
...
QJsonObject OAICreateDataViewRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateDataViewRequest::getClientToken() const {
    return m_client_token;
}
void OAICreateDataViewRequest::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreateDataViewRequest::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreateDataViewRequest::is_client_token_Valid() const{
    return m_client_token_isValid;
}

bool OAICreateDataViewRequest::getAutoUpdate() const {
    return m_auto_update;
}
void OAICreateDataViewRequest::setAutoUpdate(const bool &auto_update) {
    m_auto_update = auto_update;
    m_auto_update_isSet = true;
}

bool OAICreateDataViewRequest::is_auto_update_Set() const{
    return m_auto_update_isSet;
}

bool OAICreateDataViewRequest::is_auto_update_Valid() const{
    return m_auto_update_isValid;
}

QList OAICreateDataViewRequest::getSortColumns() const {
    return m_sort_columns;
}
void OAICreateDataViewRequest::setSortColumns(const QList &sort_columns) {
    m_sort_columns = sort_columns;
    m_sort_columns_isSet = true;
}

bool OAICreateDataViewRequest::is_sort_columns_Set() const{
    return m_sort_columns_isSet;
}

bool OAICreateDataViewRequest::is_sort_columns_Valid() const{
    return m_sort_columns_isValid;
}

QList OAICreateDataViewRequest::getPartitionColumns() const {
    return m_partition_columns;
}
void OAICreateDataViewRequest::setPartitionColumns(const QList &partition_columns) {
    m_partition_columns = partition_columns;
    m_partition_columns_isSet = true;
}

bool OAICreateDataViewRequest::is_partition_columns_Set() const{
    return m_partition_columns_isSet;
}

bool OAICreateDataViewRequest::is_partition_columns_Valid() const{
    return m_partition_columns_isValid;
}

qint32 OAICreateDataViewRequest::getAsOfTimestamp() const {
    return m_as_of_timestamp;
}
void OAICreateDataViewRequest::setAsOfTimestamp(const qint32 &as_of_timestamp) {
    m_as_of_timestamp = as_of_timestamp;
    m_as_of_timestamp_isSet = true;
}

bool OAICreateDataViewRequest::is_as_of_timestamp_Set() const{
    return m_as_of_timestamp_isSet;
}

bool OAICreateDataViewRequest::is_as_of_timestamp_Valid() const{
    return m_as_of_timestamp_isValid;
}

OAIGetDataViewResponse_destinationTypeParams OAICreateDataViewRequest::getDestinationTypeParams() const {
    return m_destination_type_params;
}
void OAICreateDataViewRequest::setDestinationTypeParams(const OAIGetDataViewResponse_destinationTypeParams &destination_type_params) {
    m_destination_type_params = destination_type_params;
    m_destination_type_params_isSet = true;
}

bool OAICreateDataViewRequest::is_destination_type_params_Set() const{
    return m_destination_type_params_isSet;
}

bool OAICreateDataViewRequest::is_destination_type_params_Valid() const{
    return m_destination_type_params_isValid;
}

bool OAICreateDataViewRequest::isSet() const {
...
bool OAICreateDataViewRequest::isValid() const {
