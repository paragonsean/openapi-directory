...
#include "OAIDataViewDestinationTypeParams.h"
...
OAIDataViewDestinationTypeParams::OAIDataViewDestinationTypeParams(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataViewDestinationTypeParams::OAIDataViewDestinationTypeParams() {
    this->initializeModel();
}

OAIDataViewDestinationTypeParams::~OAIDataViewDestinationTypeParams() {}

void OAIDataViewDestinationTypeParams::initializeModel() {
...
void OAIDataViewDestinationTypeParams::fromJson(QString jsonString) {
...
void OAIDataViewDestinationTypeParams::fromJsonObject(QJsonObject json) {
...
QString OAIDataViewDestinationTypeParams::asJson() const {
...
QJsonObject OAIDataViewDestinationTypeParams::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDataViewDestinationTypeParams::getDestinationType() const {
    return m_destination_type;
}
void OAIDataViewDestinationTypeParams::setDestinationType(const QString &destination_type) {
    m_destination_type = destination_type;
    m_destination_type_isSet = true;
}

bool OAIDataViewDestinationTypeParams::is_destination_type_Set() const{
    return m_destination_type_isSet;
}

bool OAIDataViewDestinationTypeParams::is_destination_type_Valid() const{
    return m_destination_type_isValid;
}

OAIExportFileFormat OAIDataViewDestinationTypeParams::getS3DestinationExportFileFormat() const {
    return m_s3_destination_export_file_format;
}
void OAIDataViewDestinationTypeParams::setS3DestinationExportFileFormat(const OAIExportFileFormat &s3_destination_export_file_format) {
    m_s3_destination_export_file_format = s3_destination_export_file_format;
    m_s3_destination_export_file_format_isSet = true;
}

bool OAIDataViewDestinationTypeParams::is_s3_destination_export_file_format_Set() const{
    return m_s3_destination_export_file_format_isSet;
}

bool OAIDataViewDestinationTypeParams::is_s3_destination_export_file_format_Valid() const{
    return m_s3_destination_export_file_format_isValid;
}

QMap OAIDataViewDestinationTypeParams::getS3DestinationExportFileFormatOptions() const {
    return m_s3_destination_export_file_format_options;
}
void OAIDataViewDestinationTypeParams::setS3DestinationExportFileFormatOptions(const QMap &s3_destination_export_file_format_options) {
...
bool OAIDataViewDestinationTypeParams::is_s3_destination_export_file_format_options_Set() const{
    return m_s3_destination_export_file_format_options_isSet;
}

bool OAIDataViewDestinationTypeParams::is_s3_destination_export_file_format_options_Valid() const{
    return m_s3_destination_export_file_format_options_isValid;
}

bool OAIDataViewDestinationTypeParams::isSet() const {
...
bool OAIDataViewDestinationTypeParams::isValid() const {
