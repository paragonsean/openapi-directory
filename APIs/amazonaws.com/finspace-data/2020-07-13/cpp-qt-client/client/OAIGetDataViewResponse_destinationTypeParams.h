...
/*
 * OAIGetDataViewResponse_destinationTypeParams.h
 *
 * 
 */

#ifndef OAIGetDataViewResponse_destinationTypeParams_H
#define OAIGetDataViewResponse_destinationTypeParams_H
...
class OAIGetDataViewResponse_destinationTypeParams : public OAIObject {
public:
    OAIGetDataViewResponse_destinationTypeParams();
    OAIGetDataViewResponse_destinationTypeParams(QString json);
    ~OAIGetDataViewResponse_destinationTypeParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataViewResponse_destinationTypeParams)

#endif // OAIGetDataViewResponse_destinationTypeParams_H
