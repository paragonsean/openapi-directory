...
OAIGetDataViewResponse_destinationTypeParams::OAIGetDataViewResponse_destinationTypeParams(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDataViewResponse_destinationTypeParams::OAIGetDataViewResponse_destinationTypeParams() {
    this->initializeModel();
}

OAIGetDataViewResponse_destinationTypeParams::~OAIGetDataViewResponse_destinationTypeParams() {}

void OAIGetDataViewResponse_destinationTypeParams::initializeModel() {
...
void OAIGetDataViewResponse_destinationTypeParams::fromJson(QString jsonString) {
...
void OAIGetDataViewResponse_destinationTypeParams::fromJsonObject(QJsonObject json) {
...
QString OAIGetDataViewResponse_destinationTypeParams::asJson() const {
...
QJsonObject OAIGetDataViewResponse_destinationTypeParams::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDataViewResponse_destinationTypeParams::getDestinationType() const {
    return m_destination_type;
}
void OAIGetDataViewResponse_destinationTypeParams::setDestinationType(const QString &destination_type) {
    m_destination_type = destination_type;
    m_destination_type_isSet = true;
}

bool OAIGetDataViewResponse_destinationTypeParams::is_destination_type_Set() const{
    return m_destination_type_isSet;
}

bool OAIGetDataViewResponse_destinationTypeParams::is_destination_type_Valid() const{
    return m_destination_type_isValid;
}

OAIExportFileFormat OAIGetDataViewResponse_destinationTypeParams::getS3DestinationExportFileFormat() const {
    return m_s3_destination_export_file_format;
}
void OAIGetDataViewResponse_destinationTypeParams::setS3DestinationExportFileFormat(const OAIExportFileFormat &s3_destination_export_file_format) {
    m_s3_destination_export_file_format = s3_destination_export_file_format;
    m_s3_destination_export_file_format_isSet = true;
}

bool OAIGetDataViewResponse_destinationTypeParams::is_s3_destination_export_file_format_Set() const{
    return m_s3_destination_export_file_format_isSet;
}

bool OAIGetDataViewResponse_destinationTypeParams::is_s3_destination_export_file_format_Valid() const{
    return m_s3_destination_export_file_format_isValid;
}

QMap OAIGetDataViewResponse_destinationTypeParams::getS3DestinationExportFileFormatOptions() const {
    return m_s3_destination_export_file_format_options;
}
void OAIGetDataViewResponse_destinationTypeParams::setS3DestinationExportFileFormatOptions(const QMap &s3_destination_export_file_format_options) {
...
bool OAIGetDataViewResponse_destinationTypeParams::is_s3_destination_export_file_format_options_Set() const{
    return m_s3_destination_export_file_format_options_isSet;
}

bool OAIGetDataViewResponse_destinationTypeParams::is_s3_destination_export_file_format_options_Valid() const{
    return m_s3_destination_export_file_format_options_isValid;
}

bool OAIGetDataViewResponse_destinationTypeParams::isSet() const {
...
bool OAIGetDataViewResponse_destinationTypeParams::isValid() const {
