...
/*
 * OAIDataViewSummary_destinationTypeProperties.h
 *
 * 
 */

#ifndef OAIDataViewSummary_destinationTypeProperties_H
#define OAIDataViewSummary_destinationTypeProperties_H
...
class OAIDataViewSummary_destinationTypeProperties : public OAIObject {
public:
    OAIDataViewSummary_destinationTypeProperties();
    OAIDataViewSummary_destinationTypeProperties(QString json);
    ~OAIDataViewSummary_destinationTypeProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataViewSummary_destinationTypeProperties)

#endif // OAIDataViewSummary_destinationTypeProperties_H
