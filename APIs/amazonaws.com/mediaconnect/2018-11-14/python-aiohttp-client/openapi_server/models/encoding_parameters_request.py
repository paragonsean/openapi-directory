...
class EncodingParametersRequest(Model):
    ...
    def __init__(self, compression_factor: float=None, encoder_profile: EncoderProfile=None):
        """EncodingParametersRequest - a model defined in OpenAPI

        :param compression_factor: The compression_factor of this EncodingParametersRequest.
        :param encoder_profile: The encoder_profile of this EncodingParametersRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EncodingParametersRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EncodingParametersRequest of this EncodingParametersRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def compression_factor(self):
        """Gets the compression_factor of this EncodingParametersRequest.


        :return: The compression_factor of this EncodingParametersRequest.
        :rtype: float
        """
    ...
    def compression_factor(self, compression_factor):
        """Sets the compression_factor of this EncodingParametersRequest.
    ...
    def encoder_profile(self):
        """Gets the encoder_profile of this EncodingParametersRequest.


        :return: The encoder_profile of this EncodingParametersRequest.
    ...
    def encoder_profile(self, encoder_profile):
        """Sets the encoder_profile of this EncodingParametersRequest.
