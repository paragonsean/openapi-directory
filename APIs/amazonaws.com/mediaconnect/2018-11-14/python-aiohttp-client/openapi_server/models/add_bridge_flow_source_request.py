...
class AddBridgeFlowSourceRequest(Model):
    ...
    def __init__(self, flow_arn: str=None, flow_vpc_interface_attachment: UpdateBridgeSourceRequestFlowSourceFlowVpcInterfaceAttachment=None, name: str=None):
        """AddBridgeFlowSourceRequest - a model defined in OpenAPI

        :param flow_arn: The flow_arn of this AddBridgeFlowSourceRequest.
        :param flow_vpc_interface_attachment: The flow_vpc_interface_attachment of this AddBridgeFlowSourceRequest.
        :param name: The name of this AddBridgeFlowSourceRequest.
        """
        self.openapi_types = {
            'flow_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddBridgeFlowSourceRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddBridgeFlowSourceRequest of this AddBridgeFlowSourceRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def flow_arn(self):
        """Gets the flow_arn of this AddBridgeFlowSourceRequest.


        :return: The flow_arn of this AddBridgeFlowSourceRequest.
        :rtype: str
        """
    ...
    def flow_arn(self, flow_arn):
        """Sets the flow_arn of this AddBridgeFlowSourceRequest.
    ...
    def flow_vpc_interface_attachment(self):
        """Gets the flow_vpc_interface_attachment of this AddBridgeFlowSourceRequest.


        :return: The flow_vpc_interface_attachment of this AddBridgeFlowSourceRequest.
    ...
    def flow_vpc_interface_attachment(self, flow_vpc_interface_attachment):
        """Sets the flow_vpc_interface_attachment of this AddBridgeFlowSourceRequest.
    ...
    @property
    def name(self):
        """Gets the name of this AddBridgeFlowSourceRequest.


        :return: The name of this AddBridgeFlowSourceRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AddBridgeFlowSourceRequest.
