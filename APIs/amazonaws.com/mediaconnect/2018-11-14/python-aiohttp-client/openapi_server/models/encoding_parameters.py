...
class EncodingParameters(Model):
    ...
    def __init__(self, compression_factor: float=None, encoder_profile: EncoderProfile=None):
        """EncodingParameters - a model defined in OpenAPI

        :param compression_factor: The compression_factor of this EncodingParameters.
        :param encoder_profile: The encoder_profile of this EncodingParameters.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EncodingParameters':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EncodingParameters of this EncodingParameters.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def compression_factor(self):
        """Gets the compression_factor of this EncodingParameters.


        :return: The compression_factor of this EncodingParameters.
        :rtype: float
        """
    ...
    def compression_factor(self, compression_factor):
        """Sets the compression_factor of this EncodingParameters.
    ...
    def encoder_profile(self):
        """Gets the encoder_profile of this EncodingParameters.


        :return: The encoder_profile of this EncodingParameters.
    ...
    def encoder_profile(self, encoder_profile):
        """Sets the encoder_profile of this EncodingParameters.
