...
class FlowSource(Model):
    ...
    def __init__(self, data_transfer_subscriber_fee_percent: int=None, decryption: SourceDecryption=None, description: str=None, entitlement_arn: str=None, ingest_ip: str=None, ingest_port: int=None, media_stream_source_configurations: List=None, name: str=None, sender_control_port: int=None, sender_ip_address: str=None, source_arn: str=None, transport: SourceTransport=None, vpc_interface_name: str=None, whitelist_cidr: str=None, gateway_bridge_source: SourceGatewayBridgeSource=None):
        """FlowSource - a model defined in OpenAPI

        :param data_transfer_subscriber_fee_percent: The data_transfer_subscriber_fee_percent of this FlowSource.
        :param decryption: The decryption of this FlowSource.
        :param description: The description of this FlowSource.
        :param entitlement_arn: The entitlement_arn of this FlowSource.
        :param ingest_ip: The ingest_ip of this FlowSource.
        :param ingest_port: The ingest_port of this FlowSource.
        :param media_stream_source_configurations: The media_stream_source_configurations of this FlowSource.
        :param name: The name of this FlowSource.
        :param sender_control_port: The sender_control_port of this FlowSource.
        :param sender_ip_address: The sender_ip_address of this FlowSource.
        :param source_arn: The source_arn of this FlowSource.
        :param transport: The transport of this FlowSource.
        :param vpc_interface_name: The vpc_interface_name of this FlowSource.
        :param whitelist_cidr: The whitelist_cidr of this FlowSource.
        :param gateway_bridge_source: The gateway_bridge_source of this FlowSource.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FlowSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Flow_Source of this FlowSource.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_transfer_subscriber_fee_percent(self):
        """Gets the data_transfer_subscriber_fee_percent of this FlowSource.


        :return: The data_transfer_subscriber_fee_percent of this FlowSource.
        :rtype: int
        """
    ...
    def data_transfer_subscriber_fee_percent(self, data_transfer_subscriber_fee_percent):
        """Sets the data_transfer_subscriber_fee_percent of this FlowSource.
    ...
    @property
    def decryption(self):
        """Gets the decryption of this FlowSource.
    ...
    def decryption(self, decryption):
        """Sets the decryption of this FlowSource.
    ...
    def description(self):
        """Gets the description of this FlowSource.
    ...
    def description(self, description):
        """Sets the description of this FlowSource.
    ...
    def entitlement_arn(self):
        """Gets the entitlement_arn of this FlowSource.


        :return: The entitlement_arn of this FlowSource.
        :rtype: str
        """
    ...
    def entitlement_arn(self, entitlement_arn):
        """Sets the entitlement_arn of this FlowSource.
    ...
    @property
    def ingest_ip(self):
        """Gets the ingest_ip of this FlowSource.


        :return: The ingest_ip of this FlowSource.
        :rtype: str
        """
    ...
    def ingest_ip(self, ingest_ip):
        """Sets the ingest_ip of this FlowSource.
    ...
    def ingest_port(self):
        """Gets the ingest_port of this FlowSource.


        :return: The ingest_port of this FlowSource.
        :rtype: int
        """
    ...
    def ingest_port(self, ingest_port):
        """Sets the ingest_port of this FlowSource.
    ...
    def media_stream_source_configurations(self):
        """Gets the media_stream_source_configurations of this FlowSource.


        :return: The media_stream_source_configurations of this FlowSource.
        :rtype: List
        """
    ...
    def media_stream_source_configurations(self, media_stream_source_configurations):
        """Sets the media_stream_source_configurations of this FlowSource.
    ...
    @property
    def name(self):
        """Gets the name of this FlowSource.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FlowSource.
    ...
    def sender_control_port(self):
        """Gets the sender_control_port of this FlowSource.


        :return: The sender_control_port of this FlowSource.
        :rtype: int
        """
    ...
    def sender_control_port(self, sender_control_port):
        """Sets the sender_control_port of this FlowSource.
    ...
    def sender_ip_address(self):
        """Gets the sender_ip_address of this FlowSource.


        :return: The sender_ip_address of this FlowSource.
        :rtype: str
        """
    ...
    def sender_ip_address(self, sender_ip_address):
        """Sets the sender_ip_address of this FlowSource.
    ...
    @property
    def source_arn(self):
        """Gets the source_arn of this FlowSource.


        :return: The source_arn of this FlowSource.
        :rtype: str
        """
    ...
    def source_arn(self, source_arn):
        """Sets the source_arn of this FlowSource.
    ...
    @property
    def transport(self):
        """Gets the transport of this FlowSource.


        :return: The transport of this FlowSource.
    ...
    def transport(self, transport):
        """Sets the transport of this FlowSource.
    ...
    def vpc_interface_name(self):
        """Gets the vpc_interface_name of this FlowSource.


        :return: The vpc_interface_name of this FlowSource.
        :rtype: str
        """
    ...
    def vpc_interface_name(self, vpc_interface_name):
        """Sets the vpc_interface_name of this FlowSource.
    ...
    def whitelist_cidr(self):
        """Gets the whitelist_cidr of this FlowSource.


        :return: The whitelist_cidr of this FlowSource.
        :rtype: str
        """
    ...
    def whitelist_cidr(self, whitelist_cidr):
        """Sets the whitelist_cidr of this FlowSource.
    ...
    def gateway_bridge_source(self):
        """Gets the gateway_bridge_source of this FlowSource.


        :return: The gateway_bridge_source of this FlowSource.
    ...
    def gateway_bridge_source(self, gateway_bridge_source):
        """Sets the gateway_bridge_source of this FlowSource.
