...
class GatewayInstance(Model):
    ...
    def __init__(self, bridge_placement: BridgePlacement=None, connection_status: ConnectionStatus=None, gateway_arn: str=None, gateway_instance_arn: str=None, instance_id: str=None, instance_messages: List=None, instance_state: InstanceState=None, running_bridge_count: int=None):
        """GatewayInstance - a model defined in OpenAPI

        :param bridge_placement: The bridge_placement of this GatewayInstance.
        :param connection_status: The connection_status of this GatewayInstance.
        :param gateway_arn: The gateway_arn of this GatewayInstance.
        :param gateway_instance_arn: The gateway_instance_arn of this GatewayInstance.
        :param instance_id: The instance_id of this GatewayInstance.
        :param instance_messages: The instance_messages of this GatewayInstance.
        :param instance_state: The instance_state of this GatewayInstance.
        :param running_bridge_count: The running_bridge_count of this GatewayInstance.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GatewayInstance':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GatewayInstance of this GatewayInstance.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bridge_placement(self):
        """Gets the bridge_placement of this GatewayInstance.


        :return: The bridge_placement of this GatewayInstance.
    ...
    def bridge_placement(self, bridge_placement):
        """Sets the bridge_placement of this GatewayInstance.
    ...
    def connection_status(self):
        """Gets the connection_status of this GatewayInstance.


        :return: The connection_status of this GatewayInstance.
    ...
    def connection_status(self, connection_status):
        """Sets the connection_status of this GatewayInstance.
    ...
    def gateway_arn(self):
        """Gets the gateway_arn of this GatewayInstance.


        :return: The gateway_arn of this GatewayInstance.
        :rtype: str
        """
    ...
    def gateway_arn(self, gateway_arn):
        """Sets the gateway_arn of this GatewayInstance.
    ...
    def gateway_instance_arn(self):
        """Gets the gateway_instance_arn of this GatewayInstance.


        :return: The gateway_instance_arn of this GatewayInstance.
        :rtype: str
        """
    ...
    def gateway_instance_arn(self, gateway_instance_arn):
        """Sets the gateway_instance_arn of this GatewayInstance.
    ...
    def instance_id(self):
        """Gets the instance_id of this GatewayInstance.


        :return: The instance_id of this GatewayInstance.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        """Sets the instance_id of this GatewayInstance.
    ...
    def instance_messages(self):
        """Gets the instance_messages of this GatewayInstance.


        :return: The instance_messages of this GatewayInstance.
        :rtype: List
        """
    ...
    def instance_messages(self, instance_messages):
        """Sets the instance_messages of this GatewayInstance.
    ...
    def instance_state(self):
        """Gets the instance_state of this GatewayInstance.


        :return: The instance_state of this GatewayInstance.
        :rtype: InstanceState
        """
    ...
    def instance_state(self, instance_state):
        """Sets the instance_state of this GatewayInstance.
    ...
    def running_bridge_count(self):
        """Gets the running_bridge_count of this GatewayInstance.


        :return: The running_bridge_count of this GatewayInstance.
        :rtype: int
        """
    ...
    def running_bridge_count(self, running_bridge_count):
        """Sets the running_bridge_count of this GatewayInstance.
