...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.VpcInterfaceRequest();
  });
  ...
  describe('VpcInterfaceRequest', function() {
    it('should create an instance of VpcInterfaceRequest', function() {
      // uncomment below and update the code to test VpcInterfaceRequest
      //var instance = new AwsMediaConnect.VpcInterfaceRequest();
      //expect(instance).to.be.a(AwsMediaConnect.VpcInterfaceRequest);
    });
