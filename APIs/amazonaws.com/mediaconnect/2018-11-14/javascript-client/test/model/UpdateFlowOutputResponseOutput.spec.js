...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateFlowOutputResponseOutput();
  });
  ...
  describe('UpdateFlowOutputResponseOutput', function() {
    it('should create an instance of UpdateFlowOutputResponseOutput', function() {
      // uncomment below and update the code to test UpdateFlowOutputResponseOutput
      //var instance = new AwsMediaConnect.UpdateFlowOutputResponseOutput();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateFlowOutputResponseOutput);
    });
