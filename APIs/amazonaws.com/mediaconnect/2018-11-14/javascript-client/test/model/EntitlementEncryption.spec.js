...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.EntitlementEncryption();
  });
  ...
  describe('EntitlementEncryption', function() {
    it('should create an instance of EntitlementEncryption', function() {
      // uncomment below and update the code to test EntitlementEncryption
      //var instance = new AwsMediaConnect.EntitlementEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.EntitlementEncryption);
    });
