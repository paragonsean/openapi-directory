...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateFlowOutputRequestEncryption();
  });
  ...
  describe('UpdateFlowOutputRequestEncryption', function() {
    it('should create an instance of UpdateFlowOutputRequestEncryption', function() {
      // uncomment below and update the code to test UpdateFlowOutputRequestEncryption
      //var instance = new AwsMediaConnect.UpdateFlowOutputRequestEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateFlowOutputRequestEncryption);
    });
