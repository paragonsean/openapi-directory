...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateFlowSourceResponseSource();
  });
  ...
  describe('UpdateFlowSourceResponseSource', function() {
    it('should create an instance of UpdateFlowSourceResponseSource', function() {
      // uncomment below and update the code to test UpdateFlowSourceResponseSource
      //var instance = new AwsMediaConnect.UpdateFlowSourceResponseSource();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateFlowSourceResponseSource);
    });
