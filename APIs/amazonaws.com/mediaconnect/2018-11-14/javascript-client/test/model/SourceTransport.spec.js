...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.SourceTransport();
  });
  ...
  describe('SourceTransport', function() {
    it('should create an instance of SourceTransport', function() {
      // uncomment below and update the code to test SourceTransport
      //var instance = new AwsMediaConnect.SourceTransport();
      //expect(instance).to.be.a(AwsMediaConnect.SourceTransport);
    });
