...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.AddOutputRequestEncryption();
  });
  ...
  describe('AddOutputRequestEncryption', function() {
    it('should create an instance of AddOutputRequestEncryption', function() {
      // uncomment below and update the code to test AddOutputRequestEncryption
      //var instance = new AwsMediaConnect.AddOutputRequestEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.AddOutputRequestEncryption);
    });
