...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.ListReservationsResponse();
  });
  ...
  describe('ListReservationsResponse', function() {
    it('should create an instance of ListReservationsResponse', function() {
      ...
      //var instance = new AwsMediaConnect.ListReservationsResponse();
      //expect(instance).to.be.a(AwsMediaConnect.ListReservationsResponse);
    });
