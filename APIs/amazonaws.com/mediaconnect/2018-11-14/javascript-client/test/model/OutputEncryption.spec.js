...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.OutputEncryption();
  });
  ...
  describe('OutputEncryption', function() {
    it('should create an instance of OutputEncryption', function() {
      // uncomment below and update the code to test OutputEncryption
      //var instance = new AwsMediaConnect.OutputEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.OutputEncryption);
    });
