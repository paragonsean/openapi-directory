...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.CreateFlowResponseFlow();
  });
  ...
  describe('CreateFlowResponseFlow', function() {
    it('should create an instance of CreateFlowResponseFlow', function() {
      // uncomment below and update the code to test CreateFlowResponseFlow
      //var instance = new AwsMediaConnect.CreateFlowResponseFlow();
      //expect(instance).to.be.a(AwsMediaConnect.CreateFlowResponseFlow);
    });
