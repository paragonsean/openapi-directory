...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.ListGatewaysResponse();
  });
  ...
  describe('ListGatewaysResponse', function() {
    it('should create an instance of ListGatewaysResponse', function() {
      ...
      //var instance = new AwsMediaConnect.ListGatewaysResponse();
      //expect(instance).to.be.a(AwsMediaConnect.ListGatewaysResponse);
    });
