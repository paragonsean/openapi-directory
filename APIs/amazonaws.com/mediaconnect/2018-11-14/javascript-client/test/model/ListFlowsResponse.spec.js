...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.ListFlowsResponse();
  });
  ...
  describe('ListFlowsResponse', function() {
    it('should create an instance of ListFlowsResponse', function() {
      ...
      //var instance = new AwsMediaConnect.ListFlowsResponse();
      //expect(instance).to.be.a(AwsMediaConnect.ListFlowsResponse);
    });
