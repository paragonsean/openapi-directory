...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateFlowSourceRequestDecryption();
  });
  ...
  describe('UpdateFlowSourceRequestDecryption', function() {
    it('should create an instance of UpdateFlowSourceRequestDecryption', function() {
      // uncomment below and update the code to test UpdateFlowSourceRequestDecryption
      //var instance = new AwsMediaConnect.UpdateFlowSourceRequestDecryption();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateFlowSourceRequestDecryption);
    });
