...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateEncryption();
  });
  ...
  describe('UpdateEncryption', function() {
    it('should create an instance of UpdateEncryption', function() {
      // uncomment below and update the code to test UpdateEncryption
      //var instance = new AwsMediaConnect.UpdateEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateEncryption);
    });
