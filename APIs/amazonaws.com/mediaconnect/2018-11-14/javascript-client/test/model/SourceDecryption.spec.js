...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.SourceDecryption();
  });
  ...
  describe('SourceDecryption', function() {
    it('should create an instance of SourceDecryption', function() {
      // uncomment below and update the code to test SourceDecryption
      //var instance = new AwsMediaConnect.SourceDecryption();
      //expect(instance).to.be.a(AwsMediaConnect.SourceDecryption);
    });
