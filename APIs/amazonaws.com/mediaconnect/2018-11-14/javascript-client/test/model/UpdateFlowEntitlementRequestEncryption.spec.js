...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.UpdateFlowEntitlementRequestEncryption();
  });
  ...
  describe('UpdateFlowEntitlementRequestEncryption', function() {
    it('should create an instance of UpdateFlowEntitlementRequestEncryption', function() {
      // uncomment below and update the code to test UpdateFlowEntitlementRequestEncryption
      //var instance = new AwsMediaConnect.UpdateFlowEntitlementRequestEncryption();
      //expect(instance).to.be.a(AwsMediaConnect.UpdateFlowEntitlementRequestEncryption);
    });
