...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.ListEntitlementsResponse();
  });
  ...
  describe('ListEntitlementsResponse', function() {
    it('should create an instance of ListEntitlementsResponse', function() {
      // uncomment below and update the code to test ListEntitlementsResponse
      //var instance = new AwsMediaConnect.ListEntitlementsResponse();
      //expect(instance).to.be.a(AwsMediaConnect.ListEntitlementsResponse);
    });
