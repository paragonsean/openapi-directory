...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.CreateFlowRequestSourceDecryption();
  });
  ...
  describe('CreateFlowRequestSourceDecryption', function() {
    it('should create an instance of CreateFlowRequestSourceDecryption', function() {
      // uncomment below and update the code to test CreateFlowRequestSourceDecryption
      //var instance = new AwsMediaConnect.CreateFlowRequestSourceDecryption();
      //expect(instance).to.be.a(AwsMediaConnect.CreateFlowRequestSourceDecryption);
    });
