...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.SetSourceRequest();
  });
  ...
  describe('SetSourceRequest', function() {
    it('should create an instance of SetSourceRequest', function() {
      // uncomment below and update the code to test SetSourceRequest
      //var instance = new AwsMediaConnect.SetSourceRequest();
      //expect(instance).to.be.a(AwsMediaConnect.SetSourceRequest);
    });
