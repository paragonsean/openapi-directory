...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaConnect.EgressGatewayBridge();
  });
  ...
  describe('EgressGatewayBridge', function() {
    it('should create an instance of EgressGatewayBridge', function() {
      // uncomment below and update the code to test EgressGatewayBridge
      //var instance = new AwsMediaConnect.EgressGatewayBridge();
      //expect(instance).to.be.a(AwsMediaConnect.EgressGatewayBridge);
    });
