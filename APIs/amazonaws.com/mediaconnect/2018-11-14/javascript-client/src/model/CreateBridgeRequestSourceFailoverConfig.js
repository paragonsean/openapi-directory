...
/**
 * The CreateBridgeRequestSourceFailoverConfig model module.
 * @module model/CreateBridgeRequestSourceFailoverConfig
 * @version 2018-11-14
 */
class CreateBridgeRequestSourceFailoverConfig {
    /**
     * Constructs a new <code>CreateBridgeRequestSourceFailoverConfig</code>.
     * @alias module:model/CreateBridgeRequestSourceFailoverConfig
     * @implements module:model/FailoverConfig
     */
    constructor() { 
        FailoverConfig.initialize(this);
        CreateBridgeRequestSourceFailoverConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateBridgeRequestSourceFailoverConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateBridgeRequestSourceFailoverConfig} obj Optional instance to populate.
     * @return {module:model/CreateBridgeRequestSourceFailoverConfig} The populated <code>CreateBridgeRequestSourceFailoverConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateBridgeRequestSourceFailoverConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBridgeRequestSourceFailoverConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBridgeRequestSourceFailoverConfig</code>.
     */
 ...
 */
CreateBridgeRequestSourceFailoverConfig.prototype['FailoverMode'] = undefined;

/**
 * @member {Number} RecoveryWindow
 */
CreateBridgeRequestSourceFailoverConfig.prototype['RecoveryWindow'] = undefined;

/**
 * @member {module:model/CreateBridgeRequestSourceFailoverConfigSourcePriority} SourcePriority
 */
CreateBridgeRequestSourceFailoverConfig.prototype['SourcePriority'] = undefined;

/**
 * @member {module:model/State} State
 */
CreateBridgeRequestSourceFailoverConfig.prototype['State'] = undefined;
...
export default CreateBridgeRequestSourceFailoverConfig;
