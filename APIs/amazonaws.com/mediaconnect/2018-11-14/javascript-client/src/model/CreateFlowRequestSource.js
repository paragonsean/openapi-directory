...
/**
 * The CreateFlowRequestSource model module.
 * @module model/CreateFlowRequestSource
 * @version 2018-11-14
 */
class CreateFlowRequestSource {
    /**
     * Constructs a new <code>CreateFlowRequestSource</code>.
     * @alias module:model/CreateFlowRequestSource
     * @implements module:model/SetSourceRequest
     */
    constructor() { 
        SetSourceRequest.initialize(this);
        CreateFlowRequestSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFlowRequestSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFlowRequestSource} obj Optional instance to populate.
     * @return {module:model/CreateFlowRequestSource} The populated <code>CreateFlowRequestSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFlowRequestSource();
            SetSourceRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFlowRequestSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFlowRequestSource</code>.
     */
 ...
 */
CreateFlowRequestSource.prototype['Decryption'] = undefined;

/**
 * @member {String} Description
 */
CreateFlowRequestSource.prototype['Description'] = undefined;

/**
 * @member {String} EntitlementArn
 */
CreateFlowRequestSource.prototype['EntitlementArn'] = undefined;

/**
 * @member {Number} IngestPort
 */
CreateFlowRequestSource.prototype['IngestPort'] = undefined;

/**
 * @member {Number} MaxBitrate
 */
CreateFlowRequestSource.prototype['MaxBitrate'] = undefined;

/**
 * @member {Number} MaxLatency
 */
CreateFlowRequestSource.prototype['MaxLatency'] = undefined;

/**
 * @member {Number} MaxSyncBuffer
 */
CreateFlowRequestSource.prototype['MaxSyncBuffer'] = undefined;

/**
 * @member {Array} MediaStreamSourceConfigurations
 */
CreateFlowRequestSource.prototype['MediaStreamSourceConfigurations'] = undefined;

/**
 * @member {Number} MinLatency
 */
CreateFlowRequestSource.prototype['MinLatency'] = undefined;

/**
 * @member {String} Name
 */
CreateFlowRequestSource.prototype['Name'] = undefined;

/**
 * @member {module:model/Protocol} Protocol
 */
CreateFlowRequestSource.prototype['Protocol'] = undefined;

/**
 * @member {Number} SenderControlPort
 */
CreateFlowRequestSource.prototype['SenderControlPort'] = undefined;

/**
 * @member {String} SenderIpAddress
 */
CreateFlowRequestSource.prototype['SenderIpAddress'] = undefined;

/**
 * @member {String} SourceListenerAddress
 */
CreateFlowRequestSource.prototype['SourceListenerAddress'] = undefined;

/**
 * @member {Number} SourceListenerPort
 */
CreateFlowRequestSource.prototype['SourceListenerPort'] = undefined;

/**
 * @member {String} StreamId
 */
CreateFlowRequestSource.prototype['StreamId'] = undefined;

/**
 * @member {String} VpcInterfaceName
 */
CreateFlowRequestSource.prototype['VpcInterfaceName'] = undefined;

/**
 * @member {String} WhitelistCidr
 */
CreateFlowRequestSource.prototype['WhitelistCidr'] = undefined;

/**
 * @member {module:model/CreateFlowRequestSourceGatewayBridgeSource} GatewayBridgeSource
 */
CreateFlowRequestSource.prototype['GatewayBridgeSource'] = undefined;


// Implement SetSourceRequest interface:
/**
 * @member {module:model/CreateFlowRequestSourceDecryption} Decryption
 */
...
export default CreateFlowRequestSource;
