...
/**
 * The UpdateFlowEntitlementResponseEntitlement model module.
 * @module model/UpdateFlowEntitlementResponseEntitlement
 * @version 2018-11-14
 */
class UpdateFlowEntitlementResponseEntitlement {
    /**
     * Constructs a new <code>UpdateFlowEntitlementResponseEntitlement</code>.
     * @alias module:model/UpdateFlowEntitlementResponseEntitlement
    ...
    constructor(entitlementArn, name, subscribers) { 
        ...
        UpdateFlowEntitlementResponseEntitlement.initialize(this, entitlementArn, name, subscribers);
    }
    ...
    /**
     * Constructs a <code>UpdateFlowEntitlementResponseEntitlement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFlowEntitlementResponseEntitlement} obj Optional instance to populate.
     * @return {module:model/UpdateFlowEntitlementResponseEntitlement} The populated <code>UpdateFlowEntitlementResponseEntitlement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFlowEntitlementResponseEntitlement();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFlowEntitlementResponseEntitlement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFlowEntitlementResponseEntitlement</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFlowEntitlementResponseEntitlement.RequiredProperties) {
...
UpdateFlowEntitlementResponseEntitlement.RequiredProperties = ["EntitlementArn", "Name", "Subscribers"];

/**
 * @member {Number} DataTransferSubscriberFeePercent
 */
UpdateFlowEntitlementResponseEntitlement.prototype['DataTransferSubscriberFeePercent'] = undefined;

/**
 * @member {String} Description
 */
UpdateFlowEntitlementResponseEntitlement.prototype['Description'] = undefined;

/**
 * @member {module:model/EntitlementEncryption} Encryption
 */
UpdateFlowEntitlementResponseEntitlement.prototype['Encryption'] = undefined;

/**
 * @member {String} EntitlementArn
 */
UpdateFlowEntitlementResponseEntitlement.prototype['EntitlementArn'] = undefined;

/**
 * @member {module:model/EntitlementStatus} EntitlementStatus
 */
UpdateFlowEntitlementResponseEntitlement.prototype['EntitlementStatus'] = undefined;

/**
 * @member {String} Name
 */
UpdateFlowEntitlementResponseEntitlement.prototype['Name'] = undefined;

/**
 * @member {Array} Subscribers
 */
UpdateFlowEntitlementResponseEntitlement.prototype['Subscribers'] = undefined;
...
export default UpdateFlowEntitlementResponseEntitlement;
