...
/**
 * The UpdateFailoverConfig model module.
 * @module model/UpdateFailoverConfig
 * @version 2018-11-14
 */
class UpdateFailoverConfig {
    /**
     * Constructs a new <code>UpdateFailoverConfig</code>.
     * The settings for source failover.
     * @alias module:model/UpdateFailoverConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdateFailoverConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFailoverConfig} obj Optional instance to populate.
     * @return {module:model/UpdateFailoverConfig} The populated <code>UpdateFailoverConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFailoverConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFailoverConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFailoverConfig</code>.
     */
...
export default UpdateFailoverConfig;
