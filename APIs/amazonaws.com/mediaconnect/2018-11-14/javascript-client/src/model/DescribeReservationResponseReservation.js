...
/**
 * The DescribeReservationResponseReservation model module.
 * @module model/DescribeReservationResponseReservation
 * @version 2018-11-14
 */
class DescribeReservationResponseReservation {
    /**
     * Constructs a new <code>DescribeReservationResponseReservation</code>.
     * @alias module:model/DescribeReservationResponseReservation
    ...
    constructor(currencyCode, duration, durationUnits, end, offeringArn, offeringDescription, pricePerUnit, priceUnits, reservationArn, reservationName, reservationState, resourceSpecification, start) { 
        ...
        DescribeReservationResponseReservation.initialize(this, currencyCode, duration, durationUnits, end, offeringArn, offeringDescription, pricePerUnit, priceUnits, reservationArn, reservationName, reservationState, resourceSpecification, start);
    }
    ...
    /**
     * Constructs a <code>DescribeReservationResponseReservation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeReservationResponseReservation} obj Optional instance to populate.
     * @return {module:model/DescribeReservationResponseReservation} The populated <code>DescribeReservationResponseReservation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeReservationResponseReservation();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeReservationResponseReservation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeReservationResponseReservation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeReservationResponseReservation.RequiredProperties) {
...
DescribeReservationResponseReservation.RequiredProperties = ["CurrencyCode", "Duration", "DurationUnits", "End", "OfferingArn", "OfferingDescription", "PricePerUnit", "PriceUnits", "ReservationArn", "ReservationName", "ReservationState", "ResourceSpecification", "Start"];

/**
 * @member {String} CurrencyCode
 */
DescribeReservationResponseReservation.prototype['CurrencyCode'] = undefined;

/**
 * @member {Number} Duration
 */
DescribeReservationResponseReservation.prototype['Duration'] = undefined;

/**
 * @member {module:model/DurationUnits} DurationUnits
 */
DescribeReservationResponseReservation.prototype['DurationUnits'] = undefined;

/**
 * @member {String} End
 */
DescribeReservationResponseReservation.prototype['End'] = undefined;

/**
 * @member {String} OfferingArn
 */
DescribeReservationResponseReservation.prototype['OfferingArn'] = undefined;

/**
 * @member {String} OfferingDescription
 */
DescribeReservationResponseReservation.prototype['OfferingDescription'] = undefined;

/**
 * @member {String} PricePerUnit
 */
DescribeReservationResponseReservation.prototype['PricePerUnit'] = undefined;

/**
 * @member {module:model/PriceUnits} PriceUnits
 */
DescribeReservationResponseReservation.prototype['PriceUnits'] = undefined;

/**
 * @member {String} ReservationArn
 */
DescribeReservationResponseReservation.prototype['ReservationArn'] = undefined;

/**
 * @member {String} ReservationName
 */
DescribeReservationResponseReservation.prototype['ReservationName'] = undefined;

/**
 * @member {module:model/ReservationState} ReservationState
 */
DescribeReservationResponseReservation.prototype['ReservationState'] = undefined;

/**
 * @member {module:model/ReservationResourceSpecification} ResourceSpecification
 */
DescribeReservationResponseReservation.prototype['ResourceSpecification'] = undefined;

/**
 * @member {String} Start
 */
DescribeReservationResponseReservation.prototype['Start'] = undefined;
...
export default DescribeReservationResponseReservation;
