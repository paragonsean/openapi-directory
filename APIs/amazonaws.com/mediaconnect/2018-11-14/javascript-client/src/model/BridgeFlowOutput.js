...
/**
 * The BridgeFlowOutput model module.
 * @module model/BridgeFlowOutput
 * @version 2018-11-14
 */
class BridgeFlowOutput {
    /**
     * Constructs a new <code>BridgeFlowOutput</code>.
     * The output of the bridge. A flow output is delivered to the AWS cloud.
     * @alias module:model/BridgeFlowOutput
    ...
    /**
     * Constructs a <code>BridgeFlowOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BridgeFlowOutput} obj Optional instance to populate.
     * @return {module:model/BridgeFlowOutput} The populated <code>BridgeFlowOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BridgeFlowOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>BridgeFlowOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BridgeFlowOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BridgeFlowOutput.RequiredProperties) {
...
BridgeFlowOutput.RequiredProperties = ["FlowArn", "FlowSourceArn", "Name"];
...
export default BridgeFlowOutput;
