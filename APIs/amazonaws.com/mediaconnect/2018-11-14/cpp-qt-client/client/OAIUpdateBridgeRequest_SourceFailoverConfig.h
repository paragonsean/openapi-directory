...
/*
 * OAIUpdateBridgeRequest_SourceFailoverConfig.h
 *
 * 
 */

#ifndef OAIUpdateBridgeRequest_SourceFailoverConfig_H
#define OAIUpdateBridgeRequest_SourceFailoverConfig_H
...
class OAIUpdateBridgeRequest_SourceFailoverConfig : public OAIObject {
public:
    OAIUpdateBridgeRequest_SourceFailoverConfig();
    OAIUpdateBridgeRequest_SourceFailoverConfig(QString json);
    ~OAIUpdateBridgeRequest_SourceFailoverConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBridgeRequest_SourceFailoverConfig)

#endif // OAIUpdateBridgeRequest_SourceFailoverConfig_H
