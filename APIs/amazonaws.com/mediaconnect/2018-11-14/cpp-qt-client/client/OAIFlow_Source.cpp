...
OAIFlow_Source::OAIFlow_Source(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFlow_Source::OAIFlow_Source() {
    this->initializeModel();
}

OAIFlow_Source::~OAIFlow_Source() {}

void OAIFlow_Source::initializeModel() {
...
void OAIFlow_Source::fromJson(QString jsonString) {
...
void OAIFlow_Source::fromJsonObject(QJsonObject json) {
...
QString OAIFlow_Source::asJson() const {
...
QJsonObject OAIFlow_Source::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIFlow_Source::getDataTransferSubscriberFeePercent() const {
    return m_data_transfer_subscriber_fee_percent;
}
void OAIFlow_Source::setDataTransferSubscriberFeePercent(const qint32 &data_transfer_subscriber_fee_percent) {
...
bool OAIFlow_Source::is_data_transfer_subscriber_fee_percent_Set() const{
    return m_data_transfer_subscriber_fee_percent_isSet;
}

bool OAIFlow_Source::is_data_transfer_subscriber_fee_percent_Valid() const{
    return m_data_transfer_subscriber_fee_percent_isValid;
}

OAISource_Decryption OAIFlow_Source::getDecryption() const {
    return m_decryption;
}
void OAIFlow_Source::setDecryption(const OAISource_Decryption &decryption) {
    m_decryption = decryption;
    m_decryption_isSet = true;
}

bool OAIFlow_Source::is_decryption_Set() const{
    return m_decryption_isSet;
}

bool OAIFlow_Source::is_decryption_Valid() const{
    return m_decryption_isValid;
}

QString OAIFlow_Source::getDescription() const {
    return m_description;
}
void OAIFlow_Source::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIFlow_Source::is_description_Set() const{
    return m_description_isSet;
}

bool OAIFlow_Source::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIFlow_Source::getEntitlementArn() const {
    return m_entitlement_arn;
}
void OAIFlow_Source::setEntitlementArn(const QString &entitlement_arn) {
    m_entitlement_arn = entitlement_arn;
    m_entitlement_arn_isSet = true;
}

bool OAIFlow_Source::is_entitlement_arn_Set() const{
    return m_entitlement_arn_isSet;
}

bool OAIFlow_Source::is_entitlement_arn_Valid() const{
    return m_entitlement_arn_isValid;
}

QString OAIFlow_Source::getIngestIp() const {
    return m_ingest_ip;
}
void OAIFlow_Source::setIngestIp(const QString &ingest_ip) {
    m_ingest_ip = ingest_ip;
    m_ingest_ip_isSet = true;
}

bool OAIFlow_Source::is_ingest_ip_Set() const{
    return m_ingest_ip_isSet;
}

bool OAIFlow_Source::is_ingest_ip_Valid() const{
    return m_ingest_ip_isValid;
}

qint32 OAIFlow_Source::getIngestPort() const {
    return m_ingest_port;
}
void OAIFlow_Source::setIngestPort(const qint32 &ingest_port) {
    m_ingest_port = ingest_port;
    m_ingest_port_isSet = true;
}

bool OAIFlow_Source::is_ingest_port_Set() const{
    return m_ingest_port_isSet;
}

bool OAIFlow_Source::is_ingest_port_Valid() const{
    return m_ingest_port_isValid;
}

QList OAIFlow_Source::getMediaStreamSourceConfigurations() const {
    return m_media_stream_source_configurations;
}
void OAIFlow_Source::setMediaStreamSourceConfigurations(const QList &media_stream_source_configurations) {
    m_media_stream_source_configurations = media_stream_source_configurations;
    m_media_stream_source_configurations_isSet = true;
}

bool OAIFlow_Source::is_media_stream_source_configurations_Set() const{
    return m_media_stream_source_configurations_isSet;
}

bool OAIFlow_Source::is_media_stream_source_configurations_Valid() const{
    return m_media_stream_source_configurations_isValid;
}

QString OAIFlow_Source::getName() const {
    return m_name;
}
void OAIFlow_Source::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFlow_Source::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFlow_Source::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIFlow_Source::getSenderControlPort() const {
    return m_sender_control_port;
}
void OAIFlow_Source::setSenderControlPort(const qint32 &sender_control_port) {
    m_sender_control_port = sender_control_port;
    m_sender_control_port_isSet = true;
}

bool OAIFlow_Source::is_sender_control_port_Set() const{
    return m_sender_control_port_isSet;
}

bool OAIFlow_Source::is_sender_control_port_Valid() const{
    return m_sender_control_port_isValid;
}

QString OAIFlow_Source::getSenderIpAddress() const {
    return m_sender_ip_address;
}
void OAIFlow_Source::setSenderIpAddress(const QString &sender_ip_address) {
    m_sender_ip_address = sender_ip_address;
    m_sender_ip_address_isSet = true;
}

bool OAIFlow_Source::is_sender_ip_address_Set() const{
    return m_sender_ip_address_isSet;
}

bool OAIFlow_Source::is_sender_ip_address_Valid() const{
    return m_sender_ip_address_isValid;
}

QString OAIFlow_Source::getSourceArn() const {
    return m_source_arn;
}
void OAIFlow_Source::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIFlow_Source::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIFlow_Source::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

OAISource_Transport OAIFlow_Source::getTransport() const {
    return m_transport;
}
void OAIFlow_Source::setTransport(const OAISource_Transport &transport) {
    m_transport = transport;
    m_transport_isSet = true;
}

bool OAIFlow_Source::is_transport_Set() const{
    return m_transport_isSet;
}

bool OAIFlow_Source::is_transport_Valid() const{
    return m_transport_isValid;
}

QString OAIFlow_Source::getVpcInterfaceName() const {
    return m_vpc_interface_name;
}
void OAIFlow_Source::setVpcInterfaceName(const QString &vpc_interface_name) {
    m_vpc_interface_name = vpc_interface_name;
    m_vpc_interface_name_isSet = true;
}

bool OAIFlow_Source::is_vpc_interface_name_Set() const{
    return m_vpc_interface_name_isSet;
}

bool OAIFlow_Source::is_vpc_interface_name_Valid() const{
    return m_vpc_interface_name_isValid;
}

QString OAIFlow_Source::getWhitelistCidr() const {
    return m_whitelist_cidr;
}
void OAIFlow_Source::setWhitelistCidr(const QString &whitelist_cidr) {
    m_whitelist_cidr = whitelist_cidr;
    m_whitelist_cidr_isSet = true;
}

bool OAIFlow_Source::is_whitelist_cidr_Set() const{
    return m_whitelist_cidr_isSet;
}

bool OAIFlow_Source::is_whitelist_cidr_Valid() const{
    return m_whitelist_cidr_isValid;
}

OAISource_GatewayBridgeSource OAIFlow_Source::getGatewayBridgeSource() const {
    return m_gateway_bridge_source;
}
void OAIFlow_Source::setGatewayBridgeSource(const OAISource_GatewayBridgeSource &gateway_bridge_source) {
    m_gateway_bridge_source = gateway_bridge_source;
    m_gateway_bridge_source_isSet = true;
}

bool OAIFlow_Source::is_gateway_bridge_source_Set() const{
    return m_gateway_bridge_source_isSet;
}

bool OAIFlow_Source::is_gateway_bridge_source_Valid() const{
    return m_gateway_bridge_source_isValid;
}

bool OAIFlow_Source::isSet() const {
...
bool OAIFlow_Source::isValid() const {
