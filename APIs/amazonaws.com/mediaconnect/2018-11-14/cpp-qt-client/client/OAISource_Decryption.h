...
/*
 * OAISource_Decryption.h
 *
 * 
 */

#ifndef OAISource_Decryption_H
#define OAISource_Decryption_H
...
class OAISource_Decryption : public OAIObject {
public:
    OAISource_Decryption();
    OAISource_Decryption(QString json);
    ~OAISource_Decryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISource_Decryption)

#endif // OAISource_Decryption_H
