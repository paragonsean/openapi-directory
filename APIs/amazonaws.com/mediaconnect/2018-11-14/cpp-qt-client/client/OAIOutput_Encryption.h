...
/*
 * OAIOutput_Encryption.h
 *
 * 
 */

#ifndef OAIOutput_Encryption_H
#define OAIOutput_Encryption_H
...
class OAIOutput_Encryption : public OAIObject {
public:
    OAIOutput_Encryption();
    OAIOutput_Encryption(QString json);
    ~OAIOutput_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutput_Encryption)

#endif // OAIOutput_Encryption_H
