...
#ifndef OAITransport_H
#define OAITransport_H
...
class OAITransport : public OAIObject {
public:
    OAITransport();
    OAITransport(QString json);
    ~OAITransport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransport)

#endif // OAITransport_H
