...
/*
 * OAIAddBridgeNetworkOutputRequest.h
 *
 * Add a network output to an existing bridge.
 */

#ifndef OAIAddBridgeNetworkOutputRequest_H
#define OAIAddBridgeNetworkOutputRequest_H
...
class OAIAddBridgeNetworkOutputRequest : public OAIObject {
public:
    OAIAddBridgeNetworkOutputRequest();
    OAIAddBridgeNetworkOutputRequest(QString json);
    ~OAIAddBridgeNetworkOutputRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddBridgeNetworkOutputRequest)

#endif // OAIAddBridgeNetworkOutputRequest_H
