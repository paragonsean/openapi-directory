...
#include "OAIMediaStreamOutputConfiguration.h"
...
OAIMediaStreamOutputConfiguration::OAIMediaStreamOutputConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMediaStreamOutputConfiguration::OAIMediaStreamOutputConfiguration() {
    this->initializeModel();
}

OAIMediaStreamOutputConfiguration::~OAIMediaStreamOutputConfiguration() {}

void OAIMediaStreamOutputConfiguration::initializeModel() {
...
void OAIMediaStreamOutputConfiguration::fromJson(QString jsonString) {
...
void OAIMediaStreamOutputConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIMediaStreamOutputConfiguration::asJson() const {
...
QJsonObject OAIMediaStreamOutputConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIMediaStreamOutputConfiguration::getDestinationConfigurations() const {
    return m_destination_configurations;
}
void OAIMediaStreamOutputConfiguration::setDestinationConfigurations(const QList &destination_configurations) {
    m_destination_configurations = destination_configurations;
    m_destination_configurations_isSet = true;
}

bool OAIMediaStreamOutputConfiguration::is_destination_configurations_Set() const{
    return m_destination_configurations_isSet;
}

bool OAIMediaStreamOutputConfiguration::is_destination_configurations_Valid() const{
    return m_destination_configurations_isValid;
}

OAIEncodingName OAIMediaStreamOutputConfiguration::getEncodingName() const {
    return m_encoding_name;
}
void OAIMediaStreamOutputConfiguration::setEncodingName(const OAIEncodingName &encoding_name) {
    m_encoding_name = encoding_name;
    m_encoding_name_isSet = true;
}

bool OAIMediaStreamOutputConfiguration::is_encoding_name_Set() const{
    return m_encoding_name_isSet;
}

bool OAIMediaStreamOutputConfiguration::is_encoding_name_Valid() const{
    return m_encoding_name_isValid;
}

OAIMediaStreamOutputConfiguration_EncodingParameters OAIMediaStreamOutputConfiguration::getEncodingParameters() const {
    return m_encoding_parameters;
}
void OAIMediaStreamOutputConfiguration::setEncodingParameters(const OAIMediaStreamOutputConfiguration_EncodingParameters &encoding_parameters) {
    m_encoding_parameters = encoding_parameters;
    m_encoding_parameters_isSet = true;
}

bool OAIMediaStreamOutputConfiguration::is_encoding_parameters_Set() const{
    return m_encoding_parameters_isSet;
}

bool OAIMediaStreamOutputConfiguration::is_encoding_parameters_Valid() const{
    return m_encoding_parameters_isValid;
}

QString OAIMediaStreamOutputConfiguration::getMediaStreamName() const {
    return m_media_stream_name;
}
void OAIMediaStreamOutputConfiguration::setMediaStreamName(const QString &media_stream_name) {
    m_media_stream_name = media_stream_name;
    m_media_stream_name_isSet = true;
}

bool OAIMediaStreamOutputConfiguration::is_media_stream_name_Set() const{
    return m_media_stream_name_isSet;
}

bool OAIMediaStreamOutputConfiguration::is_media_stream_name_Valid() const{
    return m_media_stream_name_isValid;
}

bool OAIMediaStreamOutputConfiguration::isSet() const {
...
bool OAIMediaStreamOutputConfiguration::isValid() const {
