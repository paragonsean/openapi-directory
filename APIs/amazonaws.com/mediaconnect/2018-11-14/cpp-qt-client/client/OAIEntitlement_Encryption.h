...
/*
 * OAIEntitlement_Encryption.h
 *
 * 
 */

#ifndef OAIEntitlement_Encryption_H
#define OAIEntitlement_Encryption_H
...
class OAIEntitlement_Encryption : public OAIObject {
public:
    OAIEntitlement_Encryption();
    OAIEntitlement_Encryption(QString json);
    ~OAIEntitlement_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntitlement_Encryption)

#endif // OAIEntitlement_Encryption_H
