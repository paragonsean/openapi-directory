...
/*
 * OAIOutput_Transport.h
 *
 * 
 */

#ifndef OAIOutput_Transport_H
#define OAIOutput_Transport_H
...
class OAIOutput_Transport : public OAIObject {
public:
    OAIOutput_Transport();
    OAIOutput_Transport(QString json);
    ~OAIOutput_Transport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutput_Transport)

#endif // OAIOutput_Transport_H
