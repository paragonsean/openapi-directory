...
/*
 * OAIUpdateFailoverConfig.h
 *
 * The settings for source failover.
 */

#ifndef OAIUpdateFailoverConfig_H
#define OAIUpdateFailoverConfig_H
...
class OAIUpdateFailoverConfig : public OAIObject {
public:
    OAIUpdateFailoverConfig();
    OAIUpdateFailoverConfig(QString json);
    ~OAIUpdateFailoverConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFailoverConfig)

#endif // OAIUpdateFailoverConfig_H
