...
/*
 * OAIBridgeNetworkOutput.h
 *
 * The output of the bridge. A network output is delivered to your premises.
 */

#ifndef OAIBridgeNetworkOutput_H
#define OAIBridgeNetworkOutput_H
...
class OAIBridgeNetworkOutput : public OAIObject {
public:
    OAIBridgeNetworkOutput();
    OAIBridgeNetworkOutput(QString json);
    ~OAIBridgeNetworkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBridgeNetworkOutput)

#endif // OAIBridgeNetworkOutput_H
