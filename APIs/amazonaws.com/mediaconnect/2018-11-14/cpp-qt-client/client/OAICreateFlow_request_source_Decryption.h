...
/*
 * OAICreateFlow_request_source_Decryption.h
 *
 * 
 */

#ifndef OAICreateFlow_request_source_Decryption_H
#define OAICreateFlow_request_source_Decryption_H
...
class OAICreateFlow_request_source_Decryption : public OAIObject {
public:
    OAICreateFlow_request_source_Decryption();
    OAICreateFlow_request_source_Decryption(QString json);
    ~OAICreateFlow_request_source_Decryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFlow_request_source_Decryption)

#endif // OAICreateFlow_request_source_Decryption_H
