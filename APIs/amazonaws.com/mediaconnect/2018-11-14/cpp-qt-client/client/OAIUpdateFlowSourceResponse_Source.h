...
/*
 * OAIUpdateFlowSourceResponse_Source.h
 *
 * 
 */

#ifndef OAIUpdateFlowSourceResponse_Source_H
#define OAIUpdateFlowSourceResponse_Source_H
...
class OAIUpdateFlowSourceResponse_Source : public OAIObject {
public:
    OAIUpdateFlowSourceResponse_Source();
    OAIUpdateFlowSourceResponse_Source(QString json);
    ~OAIUpdateFlowSourceResponse_Source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowSourceResponse_Source)

#endif // OAIUpdateFlowSourceResponse_Source_H
