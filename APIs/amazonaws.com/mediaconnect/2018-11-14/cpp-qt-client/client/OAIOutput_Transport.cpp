...
OAIOutput_Transport::OAIOutput_Transport(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOutput_Transport::OAIOutput_Transport() {
    this->initializeModel();
}

OAIOutput_Transport::~OAIOutput_Transport() {}

void OAIOutput_Transport::initializeModel() {
...
void OAIOutput_Transport::fromJson(QString jsonString) {
...
void OAIOutput_Transport::fromJsonObject(QJsonObject json) {
...
QString OAIOutput_Transport::asJson() const {
...
QJsonObject OAIOutput_Transport::asJsonObject() const {
    QJsonObject obj;
...
QList OAIOutput_Transport::getCidrAllowList() const {
    return m_cidr_allow_list;
}
void OAIOutput_Transport::setCidrAllowList(const QList &cidr_allow_list) {
    m_cidr_allow_list = cidr_allow_list;
    m_cidr_allow_list_isSet = true;
}

bool OAIOutput_Transport::is_cidr_allow_list_Set() const{
    return m_cidr_allow_list_isSet;
}

bool OAIOutput_Transport::is_cidr_allow_list_Valid() const{
    return m_cidr_allow_list_isValid;
}

qint32 OAIOutput_Transport::getMaxBitrate() const {
    return m_max_bitrate;
}
void OAIOutput_Transport::setMaxBitrate(const qint32 &max_bitrate) {
    m_max_bitrate = max_bitrate;
    m_max_bitrate_isSet = true;
}

bool OAIOutput_Transport::is_max_bitrate_Set() const{
    return m_max_bitrate_isSet;
}

bool OAIOutput_Transport::is_max_bitrate_Valid() const{
    return m_max_bitrate_isValid;
}

qint32 OAIOutput_Transport::getMaxLatency() const {
    return m_max_latency;
}
void OAIOutput_Transport::setMaxLatency(const qint32 &max_latency) {
    m_max_latency = max_latency;
    m_max_latency_isSet = true;
}

bool OAIOutput_Transport::is_max_latency_Set() const{
    return m_max_latency_isSet;
}

bool OAIOutput_Transport::is_max_latency_Valid() const{
    return m_max_latency_isValid;
}

qint32 OAIOutput_Transport::getMaxSyncBuffer() const {
    return m_max_sync_buffer;
}
void OAIOutput_Transport::setMaxSyncBuffer(const qint32 &max_sync_buffer) {
    m_max_sync_buffer = max_sync_buffer;
    m_max_sync_buffer_isSet = true;
}

bool OAIOutput_Transport::is_max_sync_buffer_Set() const{
    return m_max_sync_buffer_isSet;
}

bool OAIOutput_Transport::is_max_sync_buffer_Valid() const{
    return m_max_sync_buffer_isValid;
}

qint32 OAIOutput_Transport::getMinLatency() const {
    return m_min_latency;
}
void OAIOutput_Transport::setMinLatency(const qint32 &min_latency) {
    m_min_latency = min_latency;
    m_min_latency_isSet = true;
}

bool OAIOutput_Transport::is_min_latency_Set() const{
    return m_min_latency_isSet;
}

bool OAIOutput_Transport::is_min_latency_Valid() const{
    return m_min_latency_isValid;
}

OAIProtocol OAIOutput_Transport::getProtocol() const {
    return m_protocol;
}
void OAIOutput_Transport::setProtocol(const OAIProtocol &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIOutput_Transport::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIOutput_Transport::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIOutput_Transport::getRemoteId() const {
    return m_remote_id;
}
void OAIOutput_Transport::setRemoteId(const QString &remote_id) {
    m_remote_id = remote_id;
    m_remote_id_isSet = true;
}

bool OAIOutput_Transport::is_remote_id_Set() const{
    return m_remote_id_isSet;
}

bool OAIOutput_Transport::is_remote_id_Valid() const{
    return m_remote_id_isValid;
}

qint32 OAIOutput_Transport::getSenderControlPort() const {
    return m_sender_control_port;
}
void OAIOutput_Transport::setSenderControlPort(const qint32 &sender_control_port) {
    m_sender_control_port = sender_control_port;
    m_sender_control_port_isSet = true;
}

bool OAIOutput_Transport::is_sender_control_port_Set() const{
    return m_sender_control_port_isSet;
}

bool OAIOutput_Transport::is_sender_control_port_Valid() const{
    return m_sender_control_port_isValid;
}

QString OAIOutput_Transport::getSenderIpAddress() const {
    return m_sender_ip_address;
}
void OAIOutput_Transport::setSenderIpAddress(const QString &sender_ip_address) {
    m_sender_ip_address = sender_ip_address;
    m_sender_ip_address_isSet = true;
}

bool OAIOutput_Transport::is_sender_ip_address_Set() const{
    return m_sender_ip_address_isSet;
}

bool OAIOutput_Transport::is_sender_ip_address_Valid() const{
    return m_sender_ip_address_isValid;
}

qint32 OAIOutput_Transport::getSmoothingLatency() const {
    return m_smoothing_latency;
}
void OAIOutput_Transport::setSmoothingLatency(const qint32 &smoothing_latency) {
    m_smoothing_latency = smoothing_latency;
    m_smoothing_latency_isSet = true;
}

bool OAIOutput_Transport::is_smoothing_latency_Set() const{
    return m_smoothing_latency_isSet;
}

bool OAIOutput_Transport::is_smoothing_latency_Valid() const{
    return m_smoothing_latency_isValid;
}

QString OAIOutput_Transport::getSourceListenerAddress() const {
    return m_source_listener_address;
}
void OAIOutput_Transport::setSourceListenerAddress(const QString &source_listener_address) {
    m_source_listener_address = source_listener_address;
    m_source_listener_address_isSet = true;
}

bool OAIOutput_Transport::is_source_listener_address_Set() const{
    return m_source_listener_address_isSet;
}

bool OAIOutput_Transport::is_source_listener_address_Valid() const{
    return m_source_listener_address_isValid;
}

qint32 OAIOutput_Transport::getSourceListenerPort() const {
    return m_source_listener_port;
}
void OAIOutput_Transport::setSourceListenerPort(const qint32 &source_listener_port) {
    m_source_listener_port = source_listener_port;
    m_source_listener_port_isSet = true;
}

bool OAIOutput_Transport::is_source_listener_port_Set() const{
    return m_source_listener_port_isSet;
}

bool OAIOutput_Transport::is_source_listener_port_Valid() const{
    return m_source_listener_port_isValid;
}

QString OAIOutput_Transport::getStreamId() const {
    return m_stream_id;
}
void OAIOutput_Transport::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIOutput_Transport::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIOutput_Transport::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

bool OAIOutput_Transport::isSet() const {
...
bool OAIOutput_Transport::isValid() const {
