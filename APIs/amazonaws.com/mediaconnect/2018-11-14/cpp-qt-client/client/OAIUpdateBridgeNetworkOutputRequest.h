...
/*
 * OAIUpdateBridgeNetworkOutputRequest.h
 *
 * Update an existing network output.
 */

#ifndef OAIUpdateBridgeNetworkOutputRequest_H
#define OAIUpdateBridgeNetworkOutputRequest_H
...
class OAIUpdateBridgeNetworkOutputRequest : public OAIObject {
public:
    OAIUpdateBridgeNetworkOutputRequest();
    OAIUpdateBridgeNetworkOutputRequest(QString json);
    ~OAIUpdateBridgeNetworkOutputRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBridgeNetworkOutputRequest)

#endif // OAIUpdateBridgeNetworkOutputRequest_H
