...
/*
 * OAIUpdateFlowOutputRequest_Encryption.h
 *
 * 
 */

#ifndef OAIUpdateFlowOutputRequest_Encryption_H
#define OAIUpdateFlowOutputRequest_Encryption_H
...
class OAIUpdateFlowOutputRequest_Encryption : public OAIObject {
public:
    OAIUpdateFlowOutputRequest_Encryption();
    OAIUpdateFlowOutputRequest_Encryption(QString json);
    ~OAIUpdateFlowOutputRequest_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowOutputRequest_Encryption)

#endif // OAIUpdateFlowOutputRequest_Encryption_H
