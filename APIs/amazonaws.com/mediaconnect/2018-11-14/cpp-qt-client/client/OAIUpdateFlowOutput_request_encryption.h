...
/*
 * OAIUpdateFlowOutput_request_encryption.h
 *
 * Information about the encryption of the flow.
 */

#ifndef OAIUpdateFlowOutput_request_encryption_H
#define OAIUpdateFlowOutput_request_encryption_H
...
class OAIUpdateFlowOutput_request_encryption : public OAIObject {
public:
    OAIUpdateFlowOutput_request_encryption();
    OAIUpdateFlowOutput_request_encryption(QString json);
    ~OAIUpdateFlowOutput_request_encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowOutput_request_encryption)

#endif // OAIUpdateFlowOutput_request_encryption_H
