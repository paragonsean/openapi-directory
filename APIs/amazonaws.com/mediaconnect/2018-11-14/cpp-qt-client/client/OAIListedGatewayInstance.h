...
/*
 * OAIListedGatewayInstance.h
 *
 * Provides a summary of an instance.
 */

#ifndef OAIListedGatewayInstance_H
#define OAIListedGatewayInstance_H
...
class OAIListedGatewayInstance : public OAIObject {
public:
    OAIListedGatewayInstance();
    OAIListedGatewayInstance(QString json);
    ~OAIListedGatewayInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListedGatewayInstance)

#endif // OAIListedGatewayInstance_H
