...
/*
 * OAIAddOutputRequest_Encryption.h
 *
 * 
 */

#ifndef OAIAddOutputRequest_Encryption_H
#define OAIAddOutputRequest_Encryption_H
...
class OAIAddOutputRequest_Encryption : public OAIObject {
public:
    OAIAddOutputRequest_Encryption();
    OAIAddOutputRequest_Encryption(QString json);
    ~OAIAddOutputRequest_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddOutputRequest_Encryption)

#endif // OAIAddOutputRequest_Encryption_H
