...
/*
 * OAICreateFlowRequest_Source.h
 *
 * 
 */

#ifndef OAICreateFlowRequest_Source_H
#define OAICreateFlowRequest_Source_H

#include <QJsonObject>

#include "OAICreateFlow_request_source_Decryption.h"
#include "OAICreateFlow_request_source_GatewayBridgeSource.h"
...
namespace OpenAPI {
class OAICreateFlow_request_source_Decryption;
class OAICreateFlow_request_source_GatewayBridgeSource;

class OAICreateFlowRequest_Source : public OAIObject {
public:
    OAICreateFlowRequest_Source();
    OAICreateFlowRequest_Source(QString json);
    ~OAICreateFlowRequest_Source() override;
    ...
    OAICreateFlow_request_source_Decryption getDecryption() const;
    void setDecryption(const OAICreateFlow_request_source_Decryption &decryption);
    ...
    OAICreateFlow_request_source_GatewayBridgeSource getGatewayBridgeSource() const;
    void setGatewayBridgeSource(const OAICreateFlow_request_source_GatewayBridgeSource &gateway_bridge_source);
...
private:
    ...
    OAICreateFlow_request_source_Decryption m_decryption;
    ...
    OAICreateFlow_request_source_GatewayBridgeSource m_gateway_bridge_source;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFlowRequest_Source)

#endif // OAICreateFlowRequest_Source_H
