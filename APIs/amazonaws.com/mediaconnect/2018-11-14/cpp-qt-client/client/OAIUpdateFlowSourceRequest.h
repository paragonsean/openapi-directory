...
/*
 * OAIUpdateFlowSourceRequest.h
 *
 * A request to update the source of a flow.
 */

#ifndef OAIUpdateFlowSourceRequest_H
#define OAIUpdateFlowSourceRequest_H
...
namespace OpenAPI {
class OAIUpdateFlowSourceRequest_Decryption;
class OAIUpdateFlowSourceRequest_GatewayBridgeSource;

class OAIUpdateFlowSourceRequest : public OAIObject {
public:
    OAIUpdateFlowSourceRequest();
    OAIUpdateFlowSourceRequest(QString json);
    ~OAIUpdateFlowSourceRequest() override;
    ...
    OAIUpdateFlowSourceRequest_Decryption getDecryption() const;
    void setDecryption(const OAIUpdateFlowSourceRequest_Decryption &decryption);
    ...
    OAIUpdateFlowSourceRequest_GatewayBridgeSource getGatewayBridgeSource() const;
    void setGatewayBridgeSource(const OAIUpdateFlowSourceRequest_GatewayBridgeSource &gateway_bridge_source);
...
private:
    ...
    OAIUpdateFlowSourceRequest_Decryption m_decryption;
    ...
    OAIUpdateFlowSourceRequest_GatewayBridgeSource m_gateway_bridge_source;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowSourceRequest)

#endif // OAIUpdateFlowSourceRequest_H
