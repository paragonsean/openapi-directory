...
qint32 OAISource::getDataTransferSubscriberFeePercent() const {
    return m_data_transfer_subscriber_fee_percent;
}
void OAISource::setDataTransferSubscriberFeePercent(const qint32 &data_transfer_subscriber_fee_percent) {
...
bool OAISource::is_data_transfer_subscriber_fee_percent_Set() const{
    return m_data_transfer_subscriber_fee_percent_isSet;
}

bool OAISource::is_data_transfer_subscriber_fee_percent_Valid() const{
    return m_data_transfer_subscriber_fee_percent_isValid;
}

OAISource_Decryption OAISource::getDecryption() const {
    return m_decryption;
}
void OAISource::setDecryption(const OAISource_Decryption &decryption) {
    m_decryption = decryption;
    m_decryption_isSet = true;
}

bool OAISource::is_decryption_Set() const{
    return m_decryption_isSet;
}

bool OAISource::is_decryption_Valid() const{
...
QString OAISource::getEntitlementArn() const {
    return m_entitlement_arn;
}
void OAISource::setEntitlementArn(const QString &entitlement_arn) {
    m_entitlement_arn = entitlement_arn;
    m_entitlement_arn_isSet = true;
}

bool OAISource::is_entitlement_arn_Set() const{
    return m_entitlement_arn_isSet;
}

bool OAISource::is_entitlement_arn_Valid() const{
    return m_entitlement_arn_isValid;
}

QString OAISource::getIngestIp() const {
    return m_ingest_ip;
}
void OAISource::setIngestIp(const QString &ingest_ip) {
    m_ingest_ip = ingest_ip;
    m_ingest_ip_isSet = true;
}

bool OAISource::is_ingest_ip_Set() const{
    return m_ingest_ip_isSet;
}

bool OAISource::is_ingest_ip_Valid() const{
    return m_ingest_ip_isValid;
}

qint32 OAISource::getIngestPort() const {
    return m_ingest_port;
}
void OAISource::setIngestPort(const qint32 &ingest_port) {
    m_ingest_port = ingest_port;
    m_ingest_port_isSet = true;
}

bool OAISource::is_ingest_port_Set() const{
    return m_ingest_port_isSet;
}

bool OAISource::is_ingest_port_Valid() const{
    return m_ingest_port_isValid;
}

QList OAISource::getMediaStreamSourceConfigurations() const {
    return m_media_stream_source_configurations;
}
void OAISource::setMediaStreamSourceConfigurations(const QList &media_stream_source_configurations) {
    m_media_stream_source_configurations = media_stream_source_configurations;
    m_media_stream_source_configurations_isSet = true;
}

bool OAISource::is_media_stream_source_configurations_Set() const{
    return m_media_stream_source_configurations_isSet;
}

bool OAISource::is_media_stream_source_configurations_Valid() const{
...
qint32 OAISource::getSenderControlPort() const {
    return m_sender_control_port;
}
void OAISource::setSenderControlPort(const qint32 &sender_control_port) {
    m_sender_control_port = sender_control_port;
    m_sender_control_port_isSet = true;
}

bool OAISource::is_sender_control_port_Set() const{
    return m_sender_control_port_isSet;
}

bool OAISource::is_sender_control_port_Valid() const{
    return m_sender_control_port_isValid;
}

QString OAISource::getSenderIpAddress() const {
    return m_sender_ip_address;
}
void OAISource::setSenderIpAddress(const QString &sender_ip_address) {
    m_sender_ip_address = sender_ip_address;
    m_sender_ip_address_isSet = true;
}

bool OAISource::is_sender_ip_address_Set() const{
    return m_sender_ip_address_isSet;
}

bool OAISource::is_sender_ip_address_Valid() const{
    return m_sender_ip_address_isValid;
}

QString OAISource::getSourceArn() const {
    return m_source_arn;
}
void OAISource::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAISource::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAISource::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

OAISource_Transport OAISource::getTransport() const {
    return m_transport;
}
void OAISource::setTransport(const OAISource_Transport &transport) {
    m_transport = transport;
    m_transport_isSet = true;
}

bool OAISource::is_transport_Set() const{
    return m_transport_isSet;
}

bool OAISource::is_transport_Valid() const{
    return m_transport_isValid;
}

QString OAISource::getVpcInterfaceName() const {
    return m_vpc_interface_name;
}
void OAISource::setVpcInterfaceName(const QString &vpc_interface_name) {
    m_vpc_interface_name = vpc_interface_name;
    m_vpc_interface_name_isSet = true;
}

bool OAISource::is_vpc_interface_name_Set() const{
    return m_vpc_interface_name_isSet;
}

bool OAISource::is_vpc_interface_name_Valid() const{
    return m_vpc_interface_name_isValid;
}

QString OAISource::getWhitelistCidr() const {
    return m_whitelist_cidr;
}
void OAISource::setWhitelistCidr(const QString &whitelist_cidr) {
    m_whitelist_cidr = whitelist_cidr;
    m_whitelist_cidr_isSet = true;
}

bool OAISource::is_whitelist_cidr_Set() const{
    return m_whitelist_cidr_isSet;
}

bool OAISource::is_whitelist_cidr_Valid() const{
    return m_whitelist_cidr_isValid;
}

OAISource_GatewayBridgeSource OAISource::getGatewayBridgeSource() const {
    return m_gateway_bridge_source;
}
void OAISource::setGatewayBridgeSource(const OAISource_GatewayBridgeSource &gateway_bridge_source) {
    m_gateway_bridge_source = gateway_bridge_source;
    m_gateway_bridge_source_isSet = true;
}

bool OAISource::is_gateway_bridge_source_Set() const{
    return m_gateway_bridge_source_isSet;
}

bool OAISource::is_gateway_bridge_source_Valid() const{
