...
/*
 * OAIUpdateBridgeOutputRequest_NetworkOutput.h
 *
 * 
 */

#ifndef OAIUpdateBridgeOutputRequest_NetworkOutput_H
#define OAIUpdateBridgeOutputRequest_NetworkOutput_H
...
class OAIUpdateBridgeOutputRequest_NetworkOutput : public OAIObject {
public:
    OAIUpdateBridgeOutputRequest_NetworkOutput();
    OAIUpdateBridgeOutputRequest_NetworkOutput(QString json);
    ~OAIUpdateBridgeOutputRequest_NetworkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBridgeOutputRequest_NetworkOutput)

#endif // OAIUpdateBridgeOutputRequest_NetworkOutput_H
