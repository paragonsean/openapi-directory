...
OAICreateBridgeResponse_Bridge::OAICreateBridgeResponse_Bridge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBridgeResponse_Bridge::OAICreateBridgeResponse_Bridge() {
    this->initializeModel();
}

OAICreateBridgeResponse_Bridge::~OAICreateBridgeResponse_Bridge() {}

void OAICreateBridgeResponse_Bridge::initializeModel() {
...
void OAICreateBridgeResponse_Bridge::fromJson(QString jsonString) {
...
void OAICreateBridgeResponse_Bridge::fromJsonObject(QJsonObject json) {
...
QString OAICreateBridgeResponse_Bridge::asJson() const {
...
QJsonObject OAICreateBridgeResponse_Bridge::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBridgeResponse_Bridge::getBridgeArn() const {
    return m_bridge_arn;
}
void OAICreateBridgeResponse_Bridge::setBridgeArn(const QString &bridge_arn) {
    m_bridge_arn = bridge_arn;
    m_bridge_arn_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_arn_Set() const{
    return m_bridge_arn_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_arn_Valid() const{
    return m_bridge_arn_isValid;
}

QList OAICreateBridgeResponse_Bridge::getBridgeMessages() const {
    return m_bridge_messages;
}
void OAICreateBridgeResponse_Bridge::setBridgeMessages(const QList &bridge_messages) {
    m_bridge_messages = bridge_messages;
    m_bridge_messages_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_messages_Set() const{
    return m_bridge_messages_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_messages_Valid() const{
    return m_bridge_messages_isValid;
}

OAIBridgeState OAICreateBridgeResponse_Bridge::getBridgeState() const {
    return m_bridge_state;
}
void OAICreateBridgeResponse_Bridge::setBridgeState(const OAIBridgeState &bridge_state) {
    m_bridge_state = bridge_state;
    m_bridge_state_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_state_Set() const{
    return m_bridge_state_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_bridge_state_Valid() const{
    return m_bridge_state_isValid;
}

OAIBridge_EgressGatewayBridge OAICreateBridgeResponse_Bridge::getEgressGatewayBridge() const {
    return m_egress_gateway_bridge;
}
void OAICreateBridgeResponse_Bridge::setEgressGatewayBridge(const OAIBridge_EgressGatewayBridge &egress_gateway_bridge) {
    m_egress_gateway_bridge = egress_gateway_bridge;
    m_egress_gateway_bridge_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_egress_gateway_bridge_Set() const{
    return m_egress_gateway_bridge_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_egress_gateway_bridge_Valid() const{
    return m_egress_gateway_bridge_isValid;
}

OAIBridge_IngressGatewayBridge OAICreateBridgeResponse_Bridge::getIngressGatewayBridge() const {
    return m_ingress_gateway_bridge;
}
void OAICreateBridgeResponse_Bridge::setIngressGatewayBridge(const OAIBridge_IngressGatewayBridge &ingress_gateway_bridge) {
    m_ingress_gateway_bridge = ingress_gateway_bridge;
    m_ingress_gateway_bridge_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_ingress_gateway_bridge_Set() const{
    return m_ingress_gateway_bridge_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_ingress_gateway_bridge_Valid() const{
    return m_ingress_gateway_bridge_isValid;
}

QString OAICreateBridgeResponse_Bridge::getName() const {
    return m_name;
}
void OAICreateBridgeResponse_Bridge::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateBridgeResponse_Bridge::getOutputs() const {
    return m_outputs;
}
void OAICreateBridgeResponse_Bridge::setOutputs(const QList &outputs) {
    m_outputs = outputs;
    m_outputs_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_outputs_Set() const{
    return m_outputs_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_outputs_Valid() const{
    return m_outputs_isValid;
}

QString OAICreateBridgeResponse_Bridge::getPlacementArn() const {
    return m_placement_arn;
}
void OAICreateBridgeResponse_Bridge::setPlacementArn(const QString &placement_arn) {
    m_placement_arn = placement_arn;
    m_placement_arn_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_placement_arn_Set() const{
    return m_placement_arn_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_placement_arn_Valid() const{
    return m_placement_arn_isValid;
}

OAIBridge_SourceFailoverConfig OAICreateBridgeResponse_Bridge::getSourceFailoverConfig() const {
    return m_source_failover_config;
}
void OAICreateBridgeResponse_Bridge::setSourceFailoverConfig(const OAIBridge_SourceFailoverConfig &source_failover_config) {
    m_source_failover_config = source_failover_config;
    m_source_failover_config_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_source_failover_config_Set() const{
    return m_source_failover_config_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_source_failover_config_Valid() const{
    return m_source_failover_config_isValid;
}

QList OAICreateBridgeResponse_Bridge::getSources() const {
    return m_sources;
}
void OAICreateBridgeResponse_Bridge::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAICreateBridgeResponse_Bridge::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAICreateBridgeResponse_Bridge::is_sources_Valid() const{
    return m_sources_isValid;
}

bool OAICreateBridgeResponse_Bridge::isSet() const {
...
bool OAICreateBridgeResponse_Bridge::isValid() const {
