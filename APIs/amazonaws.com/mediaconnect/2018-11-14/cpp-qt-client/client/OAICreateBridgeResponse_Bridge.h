...
/*
 * OAICreateBridgeResponse_Bridge.h
 *
 * 
 */

#ifndef OAICreateBridgeResponse_Bridge_H
#define OAICreateBridgeResponse_Bridge_H
...
class OAICreateBridgeResponse_Bridge : public OAIObject {
public:
    OAICreateBridgeResponse_Bridge();
    OAICreateBridgeResponse_Bridge(QString json);
    ~OAICreateBridgeResponse_Bridge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBridgeResponse_Bridge)

#endif // OAICreateBridgeResponse_Bridge_H
