...
OAIAlgorithm OAIEncryption::getAlgorithm() const {
    return m_algorithm;
}
void OAIEncryption::setAlgorithm(const OAIAlgorithm &algorithm) {
    m_algorithm = algorithm;
    m_algorithm_isSet = true;
}

bool OAIEncryption::is_algorithm_Set() const{
    return m_algorithm_isSet;
}

bool OAIEncryption::is_algorithm_Valid() const{
...
QString OAIEncryption::getDeviceId() const {
    return m_device_id;
}
void OAIEncryption::setDeviceId(const QString &device_id) {
    m_device_id = device_id;
    m_device_id_isSet = true;
}

bool OAIEncryption::is_device_id_Set() const{
    return m_device_id_isSet;
}

bool OAIEncryption::is_device_id_Valid() const{
    return m_device_id_isValid;
}

OAIKeyType OAIEncryption::getKeyType() const {
    return m_key_type;
}
void OAIEncryption::setKeyType(const OAIKeyType &key_type) {
    m_key_type = key_type;
    m_key_type_isSet = true;
}

bool OAIEncryption::is_key_type_Set() const{
    return m_key_type_isSet;
}

bool OAIEncryption::is_key_type_Valid() const{
    return m_key_type_isValid;
}

QString OAIEncryption::getRegion() const {
    return m_region;
}
void OAIEncryption::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIEncryption::is_region_Set() const{
    return m_region_isSet;
}

bool OAIEncryption::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIEncryption::getResourceId() const {
    return m_resource_id;
}
void OAIEncryption::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIEncryption::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIEncryption::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

QString OAIEncryption::getRoleArn() const {
    return m_role_arn;
}
void OAIEncryption::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIEncryption::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIEncryption::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIEncryption::getSecretArn() const {
    return m_secret_arn;
}
void OAIEncryption::setSecretArn(const QString &secret_arn) {
    m_secret_arn = secret_arn;
    m_secret_arn_isSet = true;
}

bool OAIEncryption::is_secret_arn_Set() const{
    return m_secret_arn_isSet;
}

bool OAIEncryption::is_secret_arn_Valid() const{
    return m_secret_arn_isValid;
}

QString OAIEncryption::getUrl() const {
    return m_url;
}
void OAIEncryption::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIEncryption::is_url_Set() const{
    return m_url_isSet;
}

bool OAIEncryption::is_url_Valid() const{
