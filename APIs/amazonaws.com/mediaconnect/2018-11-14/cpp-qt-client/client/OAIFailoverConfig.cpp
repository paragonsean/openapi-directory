...
OAIFailoverConfig::OAIFailoverConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFailoverConfig::OAIFailoverConfig() {
    this->initializeModel();
}

OAIFailoverConfig::~OAIFailoverConfig() {}

void OAIFailoverConfig::initializeModel() {
...
void OAIFailoverConfig::fromJson(QString jsonString) {
...
void OAIFailoverConfig::fromJsonObject(QJsonObject json) {
...
QString OAIFailoverConfig::asJson() const {
...
QJsonObject OAIFailoverConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIFailoverMode OAIFailoverConfig::getFailoverMode() const {
    return m_failover_mode;
}
void OAIFailoverConfig::setFailoverMode(const OAIFailoverMode &failover_mode) {
    m_failover_mode = failover_mode;
    m_failover_mode_isSet = true;
}

bool OAIFailoverConfig::is_failover_mode_Set() const{
    return m_failover_mode_isSet;
}

bool OAIFailoverConfig::is_failover_mode_Valid() const{
    return m_failover_mode_isValid;
}

qint32 OAIFailoverConfig::getRecoveryWindow() const {
    return m_recovery_window;
}
void OAIFailoverConfig::setRecoveryWindow(const qint32 &recovery_window) {
    m_recovery_window = recovery_window;
    m_recovery_window_isSet = true;
}

bool OAIFailoverConfig::is_recovery_window_Set() const{
    return m_recovery_window_isSet;
}

bool OAIFailoverConfig::is_recovery_window_Valid() const{
    return m_recovery_window_isValid;
}

OAICreateBridge_request_sourceFailoverConfig_SourcePriority OAIFailoverConfig::getSourcePriority() const {
    return m_source_priority;
}
void OAIFailoverConfig::setSourcePriority(const OAICreateBridge_request_sourceFailoverConfig_SourcePriority &source_priority) {
    m_source_priority = source_priority;
    m_source_priority_isSet = true;
}

bool OAIFailoverConfig::is_source_priority_Set() const{
    return m_source_priority_isSet;
}

bool OAIFailoverConfig::is_source_priority_Valid() const{
    return m_source_priority_isValid;
}

OAIState OAIFailoverConfig::getState() const {
    return m_state;
}
void OAIFailoverConfig::setState(const OAIState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIFailoverConfig::is_state_Set() const{
    return m_state_isSet;
}

bool OAIFailoverConfig::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIFailoverConfig::isSet() const {
...
bool OAIFailoverConfig::isValid() const {
