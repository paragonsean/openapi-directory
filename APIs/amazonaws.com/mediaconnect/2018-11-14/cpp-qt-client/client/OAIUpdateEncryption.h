...
/*
 * OAIUpdateEncryption.h
 *
 * Information about the encryption of the flow.
 */

#ifndef OAIUpdateEncryption_H
#define OAIUpdateEncryption_H
...
class OAIUpdateEncryption : public OAIObject {
public:
    OAIUpdateEncryption();
    OAIUpdateEncryption(QString json);
    ~OAIUpdateEncryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEncryption)

#endif // OAIUpdateEncryption_H
