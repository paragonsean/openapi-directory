...
/*
 * OAIGrantEntitlementRequest_Encryption.h
 *
 * 
 */

#ifndef OAIGrantEntitlementRequest_Encryption_H
#define OAIGrantEntitlementRequest_Encryption_H
...
class OAIGrantEntitlementRequest_Encryption : public OAIObject {
public:
    OAIGrantEntitlementRequest_Encryption();
    OAIGrantEntitlementRequest_Encryption(QString json);
    ~OAIGrantEntitlementRequest_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGrantEntitlementRequest_Encryption)

#endif // OAIGrantEntitlementRequest_Encryption_H
