...
OAIUpdateFlowOutputResponse_Output::OAIUpdateFlowOutputResponse_Output(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFlowOutputResponse_Output::OAIUpdateFlowOutputResponse_Output() {
    this->initializeModel();
}

OAIUpdateFlowOutputResponse_Output::~OAIUpdateFlowOutputResponse_Output() {}

void OAIUpdateFlowOutputResponse_Output::initializeModel() {
...
void OAIUpdateFlowOutputResponse_Output::fromJson(QString jsonString) {
...
void OAIUpdateFlowOutputResponse_Output::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFlowOutputResponse_Output::asJson() const {
...
QJsonObject OAIUpdateFlowOutputResponse_Output::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUpdateFlowOutputResponse_Output::getDataTransferSubscriberFeePercent() const {
    return m_data_transfer_subscriber_fee_percent;
}
void OAIUpdateFlowOutputResponse_Output::setDataTransferSubscriberFeePercent(const qint32 &data_transfer_subscriber_fee_percent) {
...
bool OAIUpdateFlowOutputResponse_Output::is_data_transfer_subscriber_fee_percent_Set() const{
    return m_data_transfer_subscriber_fee_percent_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_data_transfer_subscriber_fee_percent_Valid() const{
    return m_data_transfer_subscriber_fee_percent_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getDescription() const {
    return m_description;
}
void OAIUpdateFlowOutputResponse_Output::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getDestination() const {
    return m_destination;
}
void OAIUpdateFlowOutputResponse_Output::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIOutput_Encryption OAIUpdateFlowOutputResponse_Output::getEncryption() const {
    return m_encryption;
}
void OAIUpdateFlowOutputResponse_Output::setEncryption(const OAIOutput_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_encryption_Valid() const{
    return m_encryption_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getEntitlementArn() const {
    return m_entitlement_arn;
}
void OAIUpdateFlowOutputResponse_Output::setEntitlementArn(const QString &entitlement_arn) {
    m_entitlement_arn = entitlement_arn;
    m_entitlement_arn_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_entitlement_arn_Set() const{
    return m_entitlement_arn_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_entitlement_arn_Valid() const{
    return m_entitlement_arn_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getListenerAddress() const {
    return m_listener_address;
}
void OAIUpdateFlowOutputResponse_Output::setListenerAddress(const QString &listener_address) {
    m_listener_address = listener_address;
    m_listener_address_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_listener_address_Set() const{
    return m_listener_address_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_listener_address_Valid() const{
    return m_listener_address_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getMediaLiveInputArn() const {
    return m_media_live_input_arn;
}
void OAIUpdateFlowOutputResponse_Output::setMediaLiveInputArn(const QString &media_live_input_arn) {
    m_media_live_input_arn = media_live_input_arn;
    m_media_live_input_arn_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_media_live_input_arn_Set() const{
    return m_media_live_input_arn_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_media_live_input_arn_Valid() const{
    return m_media_live_input_arn_isValid;
}

QList OAIUpdateFlowOutputResponse_Output::getMediaStreamOutputConfigurations() const {
    return m_media_stream_output_configurations;
}
void OAIUpdateFlowOutputResponse_Output::setMediaStreamOutputConfigurations(const QList &media_stream_output_configurations) {
    m_media_stream_output_configurations = media_stream_output_configurations;
    m_media_stream_output_configurations_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_media_stream_output_configurations_Set() const{
    return m_media_stream_output_configurations_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_media_stream_output_configurations_Valid() const{
    return m_media_stream_output_configurations_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getName() const {
    return m_name;
}
void OAIUpdateFlowOutputResponse_Output::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getOutputArn() const {
    return m_output_arn;
}
void OAIUpdateFlowOutputResponse_Output::setOutputArn(const QString &output_arn) {
    m_output_arn = output_arn;
    m_output_arn_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_output_arn_Set() const{
    return m_output_arn_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_output_arn_Valid() const{
    return m_output_arn_isValid;
}

qint32 OAIUpdateFlowOutputResponse_Output::getPort() const {
    return m_port;
}
void OAIUpdateFlowOutputResponse_Output::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_port_Set() const{
    return m_port_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_port_Valid() const{
    return m_port_isValid;
}

OAIOutput_Transport OAIUpdateFlowOutputResponse_Output::getTransport() const {
    return m_transport;
}
void OAIUpdateFlowOutputResponse_Output::setTransport(const OAIOutput_Transport &transport) {
    m_transport = transport;
    m_transport_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_transport_Set() const{
    return m_transport_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_transport_Valid() const{
    return m_transport_isValid;
}

OAIAddOutputRequest_VpcInterfaceAttachment OAIUpdateFlowOutputResponse_Output::getVpcInterfaceAttachment() const {
    return m_vpc_interface_attachment;
}
void OAIUpdateFlowOutputResponse_Output::setVpcInterfaceAttachment(const OAIAddOutputRequest_VpcInterfaceAttachment &vpc_interface_attachment) {
    m_vpc_interface_attachment = vpc_interface_attachment;
    m_vpc_interface_attachment_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_vpc_interface_attachment_Set() const{
    return m_vpc_interface_attachment_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_vpc_interface_attachment_Valid() const{
    return m_vpc_interface_attachment_isValid;
}

QString OAIUpdateFlowOutputResponse_Output::getBridgeArn() const {
    return m_bridge_arn;
}
void OAIUpdateFlowOutputResponse_Output::setBridgeArn(const QString &bridge_arn) {
    m_bridge_arn = bridge_arn;
    m_bridge_arn_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_bridge_arn_Set() const{
    return m_bridge_arn_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_bridge_arn_Valid() const{
    return m_bridge_arn_isValid;
}

QList OAIUpdateFlowOutputResponse_Output::getBridgePorts() const {
    return m_bridge_ports;
}
void OAIUpdateFlowOutputResponse_Output::setBridgePorts(const QList &bridge_ports) {
    m_bridge_ports = bridge_ports;
    m_bridge_ports_isSet = true;
}

bool OAIUpdateFlowOutputResponse_Output::is_bridge_ports_Set() const{
    return m_bridge_ports_isSet;
}

bool OAIUpdateFlowOutputResponse_Output::is_bridge_ports_Valid() const{
    return m_bridge_ports_isValid;
}

bool OAIUpdateFlowOutputResponse_Output::isSet() const {
...
bool OAIUpdateFlowOutputResponse_Output::isValid() const {
