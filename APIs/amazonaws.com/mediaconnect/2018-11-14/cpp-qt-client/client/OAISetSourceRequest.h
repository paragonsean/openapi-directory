...
/*
 * OAISetSourceRequest.h
 *
 * The settings for the source of the flow.
 */

#ifndef OAISetSourceRequest_H
#define OAISetSourceRequest_H
...
class OAISetSourceRequest : public OAIObject {
public:
    OAISetSourceRequest();
    OAISetSourceRequest(QString json);
    ~OAISetSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetSourceRequest)

#endif // OAISetSourceRequest_H
