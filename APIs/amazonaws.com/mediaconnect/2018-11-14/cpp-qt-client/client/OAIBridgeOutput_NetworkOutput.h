...
/*
 * OAIBridgeOutput_NetworkOutput.h
 *
 * 
 */

#ifndef OAIBridgeOutput_NetworkOutput_H
#define OAIBridgeOutput_NetworkOutput_H
...
class OAIBridgeOutput_NetworkOutput : public OAIObject {
public:
    OAIBridgeOutput_NetworkOutput();
    OAIBridgeOutput_NetworkOutput(QString json);
    ~OAIBridgeOutput_NetworkOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBridgeOutput_NetworkOutput)

#endif // OAIBridgeOutput_NetworkOutput_H
