...
/*
 * OAIUpdateFlowSourceRequest_Decryption.h
 *
 * 
 */

#ifndef OAIUpdateFlowSourceRequest_Decryption_H
#define OAIUpdateFlowSourceRequest_Decryption_H
...
class OAIUpdateFlowSourceRequest_Decryption : public OAIObject {
public:
    OAIUpdateFlowSourceRequest_Decryption();
    OAIUpdateFlowSourceRequest_Decryption(QString json);
    ~OAIUpdateFlowSourceRequest_Decryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowSourceRequest_Decryption)

#endif // OAIUpdateFlowSourceRequest_Decryption_H
