...
OAIDurationUnits OAIOffering::getDurationUnits() const {
    return m_duration_units;
}
void OAIOffering::setDurationUnits(const OAIDurationUnits &duration_units) {
...
QString OAIOffering::getOfferingArn() const {
    return m_offering_arn;
}
void OAIOffering::setOfferingArn(const QString &offering_arn) {
    m_offering_arn = offering_arn;
    m_offering_arn_isSet = true;
}

bool OAIOffering::is_offering_arn_Set() const{
    return m_offering_arn_isSet;
}

bool OAIOffering::is_offering_arn_Valid() const{
...
QString OAIOffering::getPricePerUnit() const {
    return m_price_per_unit;
}
void OAIOffering::setPricePerUnit(const QString &price_per_unit) {
    m_price_per_unit = price_per_unit;
    m_price_per_unit_isSet = true;
}

bool OAIOffering::is_price_per_unit_Set() const{
    return m_price_per_unit_isSet;
}

bool OAIOffering::is_price_per_unit_Valid() const{
    return m_price_per_unit_isValid;
}

OAIPriceUnits OAIOffering::getPriceUnits() const {
    return m_price_units;
}
void OAIOffering::setPriceUnits(const OAIPriceUnits &price_units) {
    m_price_units = price_units;
    m_price_units_isSet = true;
}

bool OAIOffering::is_price_units_Set() const{
    return m_price_units_isSet;
}

bool OAIOffering::is_price_units_Valid() const{
    return m_price_units_isValid;
}

OAIOffering_ResourceSpecification OAIOffering::getResourceSpecification() const {
    return m_resource_specification;
}
void OAIOffering::setResourceSpecification(const OAIOffering_ResourceSpecification &resource_specification) {
