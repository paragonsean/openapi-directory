...
/*
 * OAIUpdateFlowMediaStreamResponse_MediaStream.h
 *
 * 
 */

#ifndef OAIUpdateFlowMediaStreamResponse_MediaStream_H
#define OAIUpdateFlowMediaStreamResponse_MediaStream_H
...
class OAIUpdateFlowMediaStreamResponse_MediaStream : public OAIObject {
public:
    OAIUpdateFlowMediaStreamResponse_MediaStream();
    OAIUpdateFlowMediaStreamResponse_MediaStream(QString json);
    ~OAIUpdateFlowMediaStreamResponse_MediaStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowMediaStreamResponse_MediaStream)

#endif // OAIUpdateFlowMediaStreamResponse_MediaStream_H
