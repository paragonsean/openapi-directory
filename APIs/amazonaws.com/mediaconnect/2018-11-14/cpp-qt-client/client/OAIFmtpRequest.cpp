...
OAIFmtpRequest::OAIFmtpRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFmtpRequest::OAIFmtpRequest() {
    this->initializeModel();
}

OAIFmtpRequest::~OAIFmtpRequest() {}

void OAIFmtpRequest::initializeModel() {
...
void OAIFmtpRequest::fromJson(QString jsonString) {
...
void OAIFmtpRequest::fromJsonObject(QJsonObject json) {
...
QString OAIFmtpRequest::asJson() const {
...
QJsonObject OAIFmtpRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFmtpRequest::getChannelOrder() const {
    return m_channel_order;
}
void OAIFmtpRequest::setChannelOrder(const QString &channel_order) {
    m_channel_order = channel_order;
    m_channel_order_isSet = true;
}

bool OAIFmtpRequest::is_channel_order_Set() const{
    return m_channel_order_isSet;
}

bool OAIFmtpRequest::is_channel_order_Valid() const{
    return m_channel_order_isValid;
}

OAIColorimetry OAIFmtpRequest::getColorimetry() const {
    return m_colorimetry;
}
void OAIFmtpRequest::setColorimetry(const OAIColorimetry &colorimetry) {
    m_colorimetry = colorimetry;
    m_colorimetry_isSet = true;
}

bool OAIFmtpRequest::is_colorimetry_Set() const{
    return m_colorimetry_isSet;
}

bool OAIFmtpRequest::is_colorimetry_Valid() const{
    return m_colorimetry_isValid;
}

QString OAIFmtpRequest::getExactFramerate() const {
    return m_exact_framerate;
}
void OAIFmtpRequest::setExactFramerate(const QString &exact_framerate) {
    m_exact_framerate = exact_framerate;
    m_exact_framerate_isSet = true;
}

bool OAIFmtpRequest::is_exact_framerate_Set() const{
    return m_exact_framerate_isSet;
}

bool OAIFmtpRequest::is_exact_framerate_Valid() const{
    return m_exact_framerate_isValid;
}

QString OAIFmtpRequest::getPar() const {
    return m_par;
}
void OAIFmtpRequest::setPar(const QString &par) {
    m_par = par;
    m_par_isSet = true;
}

bool OAIFmtpRequest::is_par_Set() const{
    return m_par_isSet;
}

bool OAIFmtpRequest::is_par_Valid() const{
    return m_par_isValid;
}

OAIRange OAIFmtpRequest::getRange() const {
    return m_range;
}
void OAIFmtpRequest::setRange(const OAIRange &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAIFmtpRequest::is_range_Set() const{
    return m_range_isSet;
}

bool OAIFmtpRequest::is_range_Valid() const{
    return m_range_isValid;
}

OAIScanMode OAIFmtpRequest::getScanMode() const {
    return m_scan_mode;
}
void OAIFmtpRequest::setScanMode(const OAIScanMode &scan_mode) {
    m_scan_mode = scan_mode;
    m_scan_mode_isSet = true;
}

bool OAIFmtpRequest::is_scan_mode_Set() const{
    return m_scan_mode_isSet;
}

bool OAIFmtpRequest::is_scan_mode_Valid() const{
    return m_scan_mode_isValid;
}

OAITcs OAIFmtpRequest::getTcs() const {
    return m_tcs;
}
void OAIFmtpRequest::setTcs(const OAITcs &tcs) {
    m_tcs = tcs;
    m_tcs_isSet = true;
}

bool OAIFmtpRequest::is_tcs_Set() const{
    return m_tcs_isSet;
}

bool OAIFmtpRequest::is_tcs_Valid() const{
    return m_tcs_isValid;
}

bool OAIFmtpRequest::isSet() const {
...
bool OAIFmtpRequest::isValid() const {
