...
#ifndef OAIFailoverConfig_H
#define OAIFailoverConfig_H
...
class OAIFailoverConfig : public OAIObject {
public:
    OAIFailoverConfig();
    OAIFailoverConfig(QString json);
    ~OAIFailoverConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailoverConfig)

#endif // OAIFailoverConfig_H
