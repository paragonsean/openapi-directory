...
/*
 * OAIDescribeGatewayInstanceResponse_GatewayInstance.h
 *
 * 
 */

#ifndef OAIDescribeGatewayInstanceResponse_GatewayInstance_H
#define OAIDescribeGatewayInstanceResponse_GatewayInstance_H
...
class OAIDescribeGatewayInstanceResponse_GatewayInstance : public OAIObject {
public:
    OAIDescribeGatewayInstanceResponse_GatewayInstance();
    OAIDescribeGatewayInstanceResponse_GatewayInstance(QString json);
    ~OAIDescribeGatewayInstanceResponse_GatewayInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeGatewayInstanceResponse_GatewayInstance)

#endif // OAIDescribeGatewayInstanceResponse_GatewayInstance_H
