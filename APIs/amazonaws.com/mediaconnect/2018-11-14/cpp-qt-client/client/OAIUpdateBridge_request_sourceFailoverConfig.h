...
/*
 * OAIUpdateBridge_request_sourceFailoverConfig.h
 *
 * The settings for source failover.
 */

#ifndef OAIUpdateBridge_request_sourceFailoverConfig_H
#define OAIUpdateBridge_request_sourceFailoverConfig_H
...
class OAIUpdateBridge_request_sourceFailoverConfig : public OAIObject {
public:
    OAIUpdateBridge_request_sourceFailoverConfig();
    OAIUpdateBridge_request_sourceFailoverConfig(QString json);
    ~OAIUpdateBridge_request_sourceFailoverConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBridge_request_sourceFailoverConfig)

#endif // OAIUpdateBridge_request_sourceFailoverConfig_H
