...
/*
 * OAIBridge_SourceFailoverConfig.h
 *
 * 
 */

#ifndef OAIBridge_SourceFailoverConfig_H
#define OAIBridge_SourceFailoverConfig_H
...
class OAIBridge_SourceFailoverConfig : public OAIObject {
public:
    OAIBridge_SourceFailoverConfig();
    OAIBridge_SourceFailoverConfig(QString json);
    ~OAIBridge_SourceFailoverConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBridge_SourceFailoverConfig)

#endif // OAIBridge_SourceFailoverConfig_H
