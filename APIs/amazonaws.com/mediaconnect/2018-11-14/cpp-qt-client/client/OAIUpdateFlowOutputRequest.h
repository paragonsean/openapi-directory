...
/*
 * OAIUpdateFlowOutputRequest.h
 *
 * The fields that you want to update in the output.
 */

#ifndef OAIUpdateFlowOutputRequest_H
#define OAIUpdateFlowOutputRequest_H
...
namespace OpenAPI {
class OAIUpdateFlowOutputRequest_Encryption;
class OAIAddOutputRequest_VpcInterfaceAttachment;

class OAIUpdateFlowOutputRequest : public OAIObject {
public:
    OAIUpdateFlowOutputRequest();
    OAIUpdateFlowOutputRequest(QString json);
    ~OAIUpdateFlowOutputRequest() override;
    ...
    OAIUpdateFlowOutputRequest_Encryption getEncryption() const;
    void setEncryption(const OAIUpdateFlowOutputRequest_Encryption &encryption);
...
private:
    ...
    OAIUpdateFlowOutputRequest_Encryption m_encryption;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFlowOutputRequest)

#endif // OAIUpdateFlowOutputRequest_H
