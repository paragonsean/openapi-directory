...
OAIDurationUnits OAIReservation::getDurationUnits() const {
    return m_duration_units;
}
void OAIReservation::setDurationUnits(const OAIDurationUnits &duration_units) {
...
QString OAIReservation::getOfferingArn() const {
    return m_offering_arn;
}
void OAIReservation::setOfferingArn(const QString &offering_arn) {
    m_offering_arn = offering_arn;
    m_offering_arn_isSet = true;
}

bool OAIReservation::is_offering_arn_Set() const{
    return m_offering_arn_isSet;
}

bool OAIReservation::is_offering_arn_Valid() const{
...
QString OAIReservation::getPricePerUnit() const {
    return m_price_per_unit;
}
void OAIReservation::setPricePerUnit(const QString &price_per_unit) {
    m_price_per_unit = price_per_unit;
    m_price_per_unit_isSet = true;
}

bool OAIReservation::is_price_per_unit_Set() const{
    return m_price_per_unit_isSet;
}

bool OAIReservation::is_price_per_unit_Valid() const{
    return m_price_per_unit_isValid;
}

OAIPriceUnits OAIReservation::getPriceUnits() const {
    return m_price_units;
}
void OAIReservation::setPriceUnits(const OAIPriceUnits &price_units) {
    m_price_units = price_units;
    m_price_units_isSet = true;
}

bool OAIReservation::is_price_units_Set() const{
    return m_price_units_isSet;
}

bool OAIReservation::is_price_units_Valid() const{
    return m_price_units_isValid;
}

QString OAIReservation::getReservationArn() const {
    return m_reservation_arn;
}
void OAIReservation::setReservationArn(const QString &reservation_arn) {
    m_reservation_arn = reservation_arn;
    m_reservation_arn_isSet = true;
}

bool OAIReservation::is_reservation_arn_Set() const{
    return m_reservation_arn_isSet;
}

bool OAIReservation::is_reservation_arn_Valid() const{
    return m_reservation_arn_isValid;
}

QString OAIReservation::getReservationName() const {
    return m_reservation_name;
}
void OAIReservation::setReservationName(const QString &reservation_name) {
    m_reservation_name = reservation_name;
    m_reservation_name_isSet = true;
}

bool OAIReservation::is_reservation_name_Set() const{
    return m_reservation_name_isSet;
}

bool OAIReservation::is_reservation_name_Valid() const{
    return m_reservation_name_isValid;
}

OAIReservationState OAIReservation::getReservationState() const {
    return m_reservation_state;
}
void OAIReservation::setReservationState(const OAIReservationState &reservation_state) {
    m_reservation_state = reservation_state;
    m_reservation_state_isSet = true;
}

bool OAIReservation::is_reservation_state_Set() const{
    return m_reservation_state_isSet;
}

bool OAIReservation::is_reservation_state_Valid() const{
    return m_reservation_state_isValid;
}

OAIReservation_ResourceSpecification OAIReservation::getResourceSpecification() const {
    return m_resource_specification;
}
void OAIReservation::setResourceSpecification(const OAIReservation_ResourceSpecification &resource_specification) {
