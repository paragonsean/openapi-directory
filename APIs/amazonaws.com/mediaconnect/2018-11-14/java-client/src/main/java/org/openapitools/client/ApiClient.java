...
public class ApiClient {
    ...
    private String basePath = "http://mediaconnect.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://mediaconnect.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://mediaconnect.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mediaconnect.{region}.amazonaws.com.cn",
      "The AWS MediaConnect endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mediaconnect.us-east-1.amazonaws.com
