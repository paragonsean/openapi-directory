...
public class UpdateFlowSourceResponseSource {
  ...
  public UpdateFlowSourceResponseSource() {
  }

  public UpdateFlowSourceResponseSource dataTransferSubscriberFeePercent(Integer dataTransferSubscriberFeePercent) {
  ...
  public UpdateFlowSourceResponseSource decryption(SourceDecryption decryption) {
  ...
  public UpdateFlowSourceResponseSource description(String description) {
  ...
  public UpdateFlowSourceResponseSource entitlementArn(String entitlementArn) {
  ...
  public UpdateFlowSourceResponseSource ingestIp(String ingestIp) {
  ...
  public UpdateFlowSourceResponseSource ingestPort(Integer ingestPort) {
  ...
  public UpdateFlowSourceResponseSource mediaStreamSourceConfigurations(List mediaStreamSourceConfigurations) {
  ...
  public UpdateFlowSourceResponseSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateFlowSourceResponseSource senderControlPort(Integer senderControlPort) {
  ...
  public UpdateFlowSourceResponseSource senderIpAddress(String senderIpAddress) {
  ...
  public UpdateFlowSourceResponseSource sourceArn(String sourceArn) {
  ...
  public UpdateFlowSourceResponseSource transport(SourceTransport transport) {
  ...
  public UpdateFlowSourceResponseSource vpcInterfaceName(String vpcInterfaceName) {
  ...
  public UpdateFlowSourceResponseSource whitelistCidr(String whitelistCidr) {
  ...
  public UpdateFlowSourceResponseSource gatewayBridgeSource(SourceGatewayBridgeSource gatewayBridgeSource) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFlowSourceResponseSource updateFlowSourceResponseSource = (UpdateFlowSourceResponseSource) o;
    return Objects.equals(this.dataTransferSubscriberFeePercent, updateFlowSourceResponseSource.dataTransferSubscriberFeePercent) &&
        Objects.equals(this.decryption, updateFlowSourceResponseSource.decryption) &&
        Objects.equals(this.description, updateFlowSourceResponseSource.description) &&
        Objects.equals(this.entitlementArn, updateFlowSourceResponseSource.entitlementArn) &&
        Objects.equals(this.ingestIp, updateFlowSourceResponseSource.ingestIp) &&
        Objects.equals(this.ingestPort, updateFlowSourceResponseSource.ingestPort) &&
        Objects.equals(this.mediaStreamSourceConfigurations, updateFlowSourceResponseSource.mediaStreamSourceConfigurations) &&
        Objects.equals(this.name, updateFlowSourceResponseSource.name) &&
        Objects.equals(this.senderControlPort, updateFlowSourceResponseSource.senderControlPort) &&
        Objects.equals(this.senderIpAddress, updateFlowSourceResponseSource.senderIpAddress) &&
        Objects.equals(this.sourceArn, updateFlowSourceResponseSource.sourceArn) &&
        Objects.equals(this.transport, updateFlowSourceResponseSource.transport) &&
        Objects.equals(this.vpcInterfaceName, updateFlowSourceResponseSource.vpcInterfaceName) &&
        Objects.equals(this.whitelistCidr, updateFlowSourceResponseSource.whitelistCidr) &&
        Objects.equals(this.gatewayBridgeSource, updateFlowSourceResponseSource.gatewayBridgeSource);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFlowSourceResponseSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFlowSourceResponseSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFlowSourceResponseSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFlowSourceResponseSource is not found in the empty JSON string", UpdateFlowSourceResponseSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFlowSourceResponseSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFlowSourceResponseSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFlowSourceResponseSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFlowSourceResponseSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFlowSourceResponseSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFlowSourceResponseSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFlowSourceResponseSource.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFlowSourceResponseSource>() {
           @Override
           public void write(JsonWriter out, UpdateFlowSourceResponseSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFlowSourceResponseSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFlowSourceResponseSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFlowSourceResponseSource
   * @throws IOException if the JSON string is invalid with respect to UpdateFlowSourceResponseSource
   */
  public static UpdateFlowSourceResponseSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFlowSourceResponseSource.class);
  }

  /**
   * Convert an instance of UpdateFlowSourceResponseSource to an JSON string
   *
   * @return JSON string
   */
