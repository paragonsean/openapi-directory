...
public class UpdateFailoverConfig {
  ...
  public UpdateFailoverConfig() {
  }

  public UpdateFailoverConfig failoverMode(FailoverMode failoverMode) {
  ...
  public UpdateFailoverConfig recoveryWindow(Integer recoveryWindow) {
  ...
  public UpdateFailoverConfig sourcePriority(CreateBridgeRequestSourceFailoverConfigSourcePriority sourcePriority) {
  ...
  public UpdateFailoverConfig state(State state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateFailoverConfig updateFailoverConfig = (UpdateFailoverConfig) o;
    return Objects.equals(this.failoverMode, updateFailoverConfig.failoverMode) &&
        Objects.equals(this.recoveryWindow, updateFailoverConfig.recoveryWindow) &&
        Objects.equals(this.sourcePriority, updateFailoverConfig.sourcePriority) &&
        Objects.equals(this.state, updateFailoverConfig.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFailoverConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFailoverConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFailoverConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFailoverConfig is not found in the empty JSON string", UpdateFailoverConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFailoverConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFailoverConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFailoverConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFailoverConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFailoverConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFailoverConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFailoverConfig>() {
           @Override
           public void write(JsonWriter out, UpdateFailoverConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFailoverConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFailoverConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFailoverConfig
   * @throws IOException if the JSON string is invalid with respect to UpdateFailoverConfig
   */
  public static UpdateFailoverConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFailoverConfig.class);
  }

  /**
   * Convert an instance of UpdateFailoverConfig to an JSON string
   *
   * @return JSON string
   */
