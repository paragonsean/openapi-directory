...
public class FmtpRequest {
  ...
  public FmtpRequest channelOrder(String channelOrder) {
  ...
  public FmtpRequest colorimetry(Colorimetry colorimetry) {
  ...
  public FmtpRequest exactFramerate(String exactFramerate) {
  ...
  public FmtpRequest par(String par) {
    this.par = par;
    return this;
  }
  ...
  public FmtpRequest range(Range range) {
    this.range = range;
    return this;
  }
  ...
  public FmtpRequest scanMode(ScanMode scanMode) {
  ...
  public FmtpRequest tcs(Tcs tcs) {
    this.tcs = tcs;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FmtpRequest fmtpRequest = (FmtpRequest) o;
    return Objects.equals(this.channelOrder, fmtpRequest.channelOrder) &&
        Objects.equals(this.colorimetry, fmtpRequest.colorimetry) &&
        Objects.equals(this.exactFramerate, fmtpRequest.exactFramerate) &&
        Objects.equals(this.par, fmtpRequest.par) &&
        Objects.equals(this.range, fmtpRequest.range) &&
        Objects.equals(this.scanMode, fmtpRequest.scanMode) &&
        Objects.equals(this.tcs, fmtpRequest.tcs);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FmtpRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FmtpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FmtpRequest is not found in the empty JSON string", FmtpRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FmtpRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FmtpRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FmtpRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FmtpRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FmtpRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FmtpRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FmtpRequest>() {
           @Override
           public void write(JsonWriter out, FmtpRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FmtpRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FmtpRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FmtpRequest
   * @throws IOException if the JSON string is invalid with respect to FmtpRequest
   */
  public static FmtpRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FmtpRequest.class);
  }

  /**
   * Convert an instance of FmtpRequest to an JSON string
   *
   * @return JSON string
   */
