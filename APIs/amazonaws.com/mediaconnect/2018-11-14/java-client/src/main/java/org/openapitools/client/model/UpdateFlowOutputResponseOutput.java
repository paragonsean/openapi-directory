...
public class UpdateFlowOutputResponseOutput {
  ...
  public UpdateFlowOutputResponseOutput() {
  }

  public UpdateFlowOutputResponseOutput dataTransferSubscriberFeePercent(Integer dataTransferSubscriberFeePercent) {
  ...
  public UpdateFlowOutputResponseOutput description(String description) {
  ...
  public UpdateFlowOutputResponseOutput destination(String destination) {
  ...
  public UpdateFlowOutputResponseOutput encryption(OutputEncryption encryption) {
  ...
  public UpdateFlowOutputResponseOutput entitlementArn(String entitlementArn) {
  ...
  public UpdateFlowOutputResponseOutput listenerAddress(String listenerAddress) {
  ...
  public UpdateFlowOutputResponseOutput mediaLiveInputArn(String mediaLiveInputArn) {
  ...
  public UpdateFlowOutputResponseOutput mediaStreamOutputConfigurations(List mediaStreamOutputConfigurations) {
  ...
  public UpdateFlowOutputResponseOutput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateFlowOutputResponseOutput outputArn(String outputArn) {
  ...
  public UpdateFlowOutputResponseOutput port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public UpdateFlowOutputResponseOutput transport(OutputTransport transport) {
  ...
  public UpdateFlowOutputResponseOutput vpcInterfaceAttachment(AddOutputRequestVpcInterfaceAttachment vpcInterfaceAttachment) {
  ...
  public UpdateFlowOutputResponseOutput bridgeArn(String bridgeArn) {
  ...
  public UpdateFlowOutputResponseOutput bridgePorts(List bridgePorts) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFlowOutputResponseOutput updateFlowOutputResponseOutput = (UpdateFlowOutputResponseOutput) o;
    return Objects.equals(this.dataTransferSubscriberFeePercent, updateFlowOutputResponseOutput.dataTransferSubscriberFeePercent) &&
        Objects.equals(this.description, updateFlowOutputResponseOutput.description) &&
        Objects.equals(this.destination, updateFlowOutputResponseOutput.destination) &&
        Objects.equals(this.encryption, updateFlowOutputResponseOutput.encryption) &&
        Objects.equals(this.entitlementArn, updateFlowOutputResponseOutput.entitlementArn) &&
        Objects.equals(this.listenerAddress, updateFlowOutputResponseOutput.listenerAddress) &&
        Objects.equals(this.mediaLiveInputArn, updateFlowOutputResponseOutput.mediaLiveInputArn) &&
        Objects.equals(this.mediaStreamOutputConfigurations, updateFlowOutputResponseOutput.mediaStreamOutputConfigurations) &&
        Objects.equals(this.name, updateFlowOutputResponseOutput.name) &&
        Objects.equals(this.outputArn, updateFlowOutputResponseOutput.outputArn) &&
        Objects.equals(this.port, updateFlowOutputResponseOutput.port) &&
        Objects.equals(this.transport, updateFlowOutputResponseOutput.transport) &&
        Objects.equals(this.vpcInterfaceAttachment, updateFlowOutputResponseOutput.vpcInterfaceAttachment) &&
        Objects.equals(this.bridgeArn, updateFlowOutputResponseOutput.bridgeArn) &&
        Objects.equals(this.bridgePorts, updateFlowOutputResponseOutput.bridgePorts);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFlowOutputResponseOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFlowOutputResponseOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFlowOutputResponseOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFlowOutputResponseOutput is not found in the empty JSON string", UpdateFlowOutputResponseOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFlowOutputResponseOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFlowOutputResponseOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFlowOutputResponseOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFlowOutputResponseOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFlowOutputResponseOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFlowOutputResponseOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFlowOutputResponseOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFlowOutputResponseOutput>() {
           @Override
           public void write(JsonWriter out, UpdateFlowOutputResponseOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFlowOutputResponseOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFlowOutputResponseOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFlowOutputResponseOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateFlowOutputResponseOutput
   */
  public static UpdateFlowOutputResponseOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFlowOutputResponseOutput.class);
  }

  /**
   * Convert an instance of UpdateFlowOutputResponseOutput to an JSON string
   *
   * @return JSON string
   */
