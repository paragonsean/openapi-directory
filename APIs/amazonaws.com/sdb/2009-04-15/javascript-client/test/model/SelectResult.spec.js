...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleDb.SelectResult();
  });
  ...
  describe('SelectResult', function() {
    it('should create an instance of SelectResult', function() {
      // uncomment below and update the code to test SelectResult
      //var instance = new AmazonSimpleDb.SelectResult();
      //expect(instance).to.be.a(AmazonSimpleDb.SelectResult);
    });
