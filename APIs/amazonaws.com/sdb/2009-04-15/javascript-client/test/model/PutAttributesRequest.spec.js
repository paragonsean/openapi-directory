...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleDb.PutAttributesRequest();
  });
  ...
  describe('PutAttributesRequest', function() {
    it('should create an instance of PutAttributesRequest', function() {
      // uncomment below and update the code to test PutAttributesRequest
      //var instance = new AmazonSimpleDb.PutAttributesRequest();
      //expect(instance).to.be.a(AmazonSimpleDb.PutAttributesRequest);
    });
