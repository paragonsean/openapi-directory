...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleDb.CreateDomainRequest();
  });
  ...
  describe('CreateDomainRequest', function() {
    it('should create an instance of CreateDomainRequest', function() {
      ...
      //var instance = new AmazonSimpleDb.CreateDomainRequest();
      //expect(instance).to.be.a(AmazonSimpleDb.CreateDomainRequest);
    });
