...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleDb.DeleteAttributesRequest();
  });
  ...
  describe('DeleteAttributesRequest', function() {
    it('should create an instance of DeleteAttributesRequest', function() {
      // uncomment below and update the code to test DeleteAttributesRequest
      //var instance = new AmazonSimpleDb.DeleteAttributesRequest();
      //expect(instance).to.be.a(AmazonSimpleDb.DeleteAttributesRequest);
    });
