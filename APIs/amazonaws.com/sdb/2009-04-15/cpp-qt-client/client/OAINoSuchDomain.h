...
#ifndef OAINoSuchDomain_H
#define OAINoSuchDomain_H
...
class OAINoSuchDomain : public OAIObject {
public:
    OAINoSuchDomain();
    OAINoSuchDomain(QString json);
    ~OAINoSuchDomain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINoSuchDomain)

#endif // OAINoSuchDomain_H
