...
public class ApiClient {
    ...
    private String basePath = "http://sdb.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2009-04-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sdb.amazonaws.com
