...
/*
 * OAITerminologyProperties.h
 *
 * The properties of the custom terminology.
 */

#ifndef OAITerminologyProperties_H
#define OAITerminologyProperties_H
...
class OAITerminologyProperties : public OAIObject {
public:
    OAITerminologyProperties();
    OAITerminologyProperties(QString json);
    ~OAITerminologyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminologyProperties)

#endif // OAITerminologyProperties_H
