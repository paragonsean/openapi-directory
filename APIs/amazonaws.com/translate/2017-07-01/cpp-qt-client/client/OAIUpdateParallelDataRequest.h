...
/*
 * OAIUpdateParallelDataRequest.h
 *
 * 
 */

#ifndef OAIUpdateParallelDataRequest_H
#define OAIUpdateParallelDataRequest_H
...
class OAIUpdateParallelDataRequest : public OAIObject {
public:
    OAIUpdateParallelDataRequest();
    OAIUpdateParallelDataRequest(QString json);
    ~OAIUpdateParallelDataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateParallelDataRequest)

#endif // OAIUpdateParallelDataRequest_H
