...
/*
 * OAIGetTerminologyResponse_TerminologyProperties.h
 *
 * 
 */

#ifndef OAIGetTerminologyResponse_TerminologyProperties_H
#define OAIGetTerminologyResponse_TerminologyProperties_H
...
class OAIGetTerminologyResponse_TerminologyProperties : public OAIObject {
public:
    OAIGetTerminologyResponse_TerminologyProperties();
    OAIGetTerminologyResponse_TerminologyProperties(QString json);
    ~OAIGetTerminologyResponse_TerminologyProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTerminologyResponse_TerminologyProperties)

#endif // OAIGetTerminologyResponse_TerminologyProperties_H
