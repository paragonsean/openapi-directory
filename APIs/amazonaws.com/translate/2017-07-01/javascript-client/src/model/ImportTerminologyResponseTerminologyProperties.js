...
/**
 * The ImportTerminologyResponseTerminologyProperties model module.
 * @module model/ImportTerminologyResponseTerminologyProperties
 * @version 2017-07-01
 */
class ImportTerminologyResponseTerminologyProperties {
    /**
     * Constructs a new <code>ImportTerminologyResponseTerminologyProperties</code>.
     * @alias module:model/ImportTerminologyResponseTerminologyProperties
     * @implements module:model/TerminologyProperties
     */
    constructor() { 
        TerminologyProperties.initialize(this);
        ImportTerminologyResponseTerminologyProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImportTerminologyResponseTerminologyProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportTerminologyResponseTerminologyProperties} obj Optional instance to populate.
     * @return {module:model/ImportTerminologyResponseTerminologyProperties} The populated <code>ImportTerminologyResponseTerminologyProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportTerminologyResponseTerminologyProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportTerminologyResponseTerminologyProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportTerminologyResponseTerminologyProperties</code>.
     */
 ...
 * @member {String} Name
 */
ImportTerminologyResponseTerminologyProperties.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
ImportTerminologyResponseTerminologyProperties.prototype['Description'] = undefined;

/**
 * @member {String} Arn
 */
ImportTerminologyResponseTerminologyProperties.prototype['Arn'] = undefined;

/**
 * @member {String} SourceLanguageCode
 */
ImportTerminologyResponseTerminologyProperties.prototype['SourceLanguageCode'] = undefined;

/**
 * @member {Array} TargetLanguageCodes
 */
ImportTerminologyResponseTerminologyProperties.prototype['TargetLanguageCodes'] = undefined;

/**
 * @member {module:model/TerminologyPropertiesEncryptionKey} EncryptionKey
 */
ImportTerminologyResponseTerminologyProperties.prototype['EncryptionKey'] = undefined;

/**
 * @member {Number} SizeBytes
 */
ImportTerminologyResponseTerminologyProperties.prototype['SizeBytes'] = undefined;

/**
 * @member {Number} TermCount
 */
ImportTerminologyResponseTerminologyProperties.prototype['TermCount'] = undefined;

/**
 * @member {Date} CreatedAt
 */
ImportTerminologyResponseTerminologyProperties.prototype['CreatedAt'] = undefined;

/**
 * @member {Date} LastUpdatedAt
 */
ImportTerminologyResponseTerminologyProperties.prototype['LastUpdatedAt'] = undefined;

/**
 * @member {module:model/Directionality} Directionality
 */
ImportTerminologyResponseTerminologyProperties.prototype['Directionality'] = undefined;

/**
 * @member {String} Message
 */
ImportTerminologyResponseTerminologyProperties.prototype['Message'] = undefined;

/**
 * @member {Number} SkippedTermCount
 */
ImportTerminologyResponseTerminologyProperties.prototype['SkippedTermCount'] = undefined;

/**
 * @member {module:model/TerminologyDataFormat} Format
 */
ImportTerminologyResponseTerminologyProperties.prototype['Format'] = undefined;
...
export default ImportTerminologyResponseTerminologyProperties;
