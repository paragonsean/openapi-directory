...
public class Term {
  ...
  public Term sourceText(String sourceText) {
  ...
  public Term targetText(String targetText) {
  ...
  public boolean equals(Object o) {
    ...
    Term term = (Term) o;
    return Objects.equals(this.sourceText, term.sourceText) &&
        Objects.equals(this.targetText, term.targetText);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("SourceText") != null && !jsonObj.get("SourceText").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("SourceText"));
      }
      // validate the optional field `TargetText`
      if (jsonObj.get("TargetText") != null && !jsonObj.get("TargetText").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("TargetText"));
      }
  }
