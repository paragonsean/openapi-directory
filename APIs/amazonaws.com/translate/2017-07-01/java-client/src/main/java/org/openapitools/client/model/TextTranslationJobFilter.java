...
public class TextTranslationJobFilter {
  ...
  public TextTranslationJobFilter jobName(String jobName) {
  ...
  public TextTranslationJobFilter jobStatus(JobStatus jobStatus) {
  ...
  public TextTranslationJobFilter submittedBeforeTime(OffsetDateTime submittedBeforeTime) {
  ...
  public TextTranslationJobFilter submittedAfterTime(OffsetDateTime submittedAfterTime) {
  ...
  public boolean equals(Object o) {
    ...
    TextTranslationJobFilter textTranslationJobFilter = (TextTranslationJobFilter) o;
    return Objects.equals(this.jobName, textTranslationJobFilter.jobName) &&
        Objects.equals(this.jobStatus, textTranslationJobFilter.jobStatus) &&
        Objects.equals(this.submittedBeforeTime, textTranslationJobFilter.submittedBeforeTime) &&
        Objects.equals(this.submittedAfterTime, textTranslationJobFilter.submittedAfterTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class TextTranslationJobFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextTranslationJobFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextTranslationJobFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextTranslationJobFilter is not found in the empty JSON string", TextTranslationJobFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextTranslationJobFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextTranslationJobFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextTranslationJobFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextTranslationJobFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextTranslationJobFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextTranslationJobFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<TextTranslationJobFilter>() {
           @Override
           public void write(JsonWriter out, TextTranslationJobFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextTranslationJobFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextTranslationJobFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextTranslationJobFilter
   * @throws IOException if the JSON string is invalid with respect to TextTranslationJobFilter
   */
  public static TextTranslationJobFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextTranslationJobFilter.class);
  }

  /**
   * Convert an instance of TextTranslationJobFilter to an JSON string
   *
   * @return JSON string
   */
