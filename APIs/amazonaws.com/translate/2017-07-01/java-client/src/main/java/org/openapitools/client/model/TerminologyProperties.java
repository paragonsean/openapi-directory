...
public class TerminologyProperties {
  ...
  public TerminologyProperties name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TerminologyProperties description(String description) {
  ...
  public TerminologyProperties arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public TerminologyProperties sourceLanguageCode(String sourceLanguageCode) {
  ...
  public TerminologyProperties targetLanguageCodes(List targetLanguageCodes) {
  ...
  public TerminologyProperties encryptionKey(TerminologyPropertiesEncryptionKey encryptionKey) {
  ...
  public TerminologyProperties sizeBytes(Integer sizeBytes) {
  ...
  public TerminologyProperties termCount(Integer termCount) {
  ...
  public TerminologyProperties createdAt(OffsetDateTime createdAt) {
  ...
  public TerminologyProperties lastUpdatedAt(OffsetDateTime lastUpdatedAt) {
  ...
  public TerminologyProperties directionality(Directionality directionality) {
  ...
  public TerminologyProperties message(String message) {
  ...
  public TerminologyProperties skippedTermCount(Integer skippedTermCount) {
  ...
  public TerminologyProperties format(TerminologyDataFormat format) {
    this.format = format;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TerminologyProperties terminologyProperties = (TerminologyProperties) o;
    return Objects.equals(this.name, terminologyProperties.name) &&
        Objects.equals(this.description, terminologyProperties.description) &&
        Objects.equals(this.arn, terminologyProperties.arn) &&
        Objects.equals(this.sourceLanguageCode, terminologyProperties.sourceLanguageCode) &&
        Objects.equals(this.targetLanguageCodes, terminologyProperties.targetLanguageCodes) &&
        Objects.equals(this.encryptionKey, terminologyProperties.encryptionKey) &&
        Objects.equals(this.sizeBytes, terminologyProperties.sizeBytes) &&
        Objects.equals(this.termCount, terminologyProperties.termCount) &&
        Objects.equals(this.createdAt, terminologyProperties.createdAt) &&
        Objects.equals(this.lastUpdatedAt, terminologyProperties.lastUpdatedAt) &&
        Objects.equals(this.directionality, terminologyProperties.directionality) &&
        Objects.equals(this.message, terminologyProperties.message) &&
        Objects.equals(this.skippedTermCount, terminologyProperties.skippedTermCount) &&
        Objects.equals(this.format, terminologyProperties.format);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminologyProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TerminologyProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TerminologyProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminologyProperties is not found in the empty JSON string", TerminologyProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TerminologyProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminologyProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TerminologyProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TerminologyProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TerminologyProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TerminologyProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<TerminologyProperties>() {
           @Override
           public void write(JsonWriter out, TerminologyProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TerminologyProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TerminologyProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TerminologyProperties
   * @throws IOException if the JSON string is invalid with respect to TerminologyProperties
   */
  public static TerminologyProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminologyProperties.class);
  }

  /**
   * Convert an instance of TerminologyProperties to an JSON string
   *
   * @return JSON string
   */
