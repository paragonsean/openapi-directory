...
export default class DefaultApi {
    ...
    */
     ...
     * @param {module:model/String} pretty 
     ...
     */
    search(q, format, pretty, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      if (format === undefined || format === null) {
        throw new Error("Missing the required parameter 'format' when calling search");
      }
      // verify the required parameter 'pretty' is set
      if (pretty === undefined || pretty === null) {
        throw new Error("Missing the required parameter 'pretty' when calling search");
      }
      ...
      let queryParams = {
        ...
        'q': q,
        'q.options': opts['qOptions'],
        'q.parser': opts['qParser'],
        'return': opts['_return'],
        'size': opts['size'],
        'sort': opts['sort'],
        'start': opts['start'],
      ...
      return this.apiClient.callApi(
        '/2013-01-01/search#format=sdk&pretty=true&q', 'GET',
     ...
     */
    suggest(q, suggester, format, pretty, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling suggest");
      }
      // verify the required parameter 'suggester' is set
      if (suggester === undefined || suggester === null) {
        throw new Error("Missing the required parameter 'suggester' when calling suggest");
      }
      // verify the required parameter 'format' is set
      if (format === undefined || format === null) {
        throw new Error("Missing the required parameter 'format' when calling suggest");
      }
      // verify the required parameter 'pretty' is set
      if (pretty === undefined || pretty === null) {
        throw new Error("Missing the required parameter 'pretty' when calling suggest");
      }
      ...
      return this.apiClient.callApi(
        '/2013-01-01/suggest#format=sdk&pretty=true&q&suggester', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the uploadDocuments operation.
     * @callback module:api/DefaultApi~uploadDocumentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UploadDocumentsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} contentType <p>The format of the batch you are uploading. Amazon CloudSearch supports two document batch formats:</p> <ul> <li>application/json</li> <li>application/xml</li> </ul>
     * @param {module:model/String} format 
     * @param {module:model/UploadDocumentsRequest} uploadDocumentsRequest 
     * @param {Object} opts Optional parameters
     * @param {String} [xAmzContentSha256] 
     * @param {String} [xAmzDate] 
     * @param {String} [xAmzAlgorithm] 
     ...
     * @param {String} [xAmzSignature] 
     * @param {String} [xAmzSignedHeaders] 
     * @param {module:api/DefaultApi~uploadDocumentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UploadDocumentsResponse}
     */
    uploadDocuments(contentType, format, uploadDocumentsRequest, opts, callback) {
      opts = opts || {};
      let postBody = uploadDocumentsRequest;
      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling uploadDocuments");
      }
      // verify the required parameter 'format' is set
      if (format === undefined || format === null) {
        throw new Error("Missing the required parameter 'format' when calling uploadDocuments");
      }
      // verify the required parameter 'uploadDocumentsRequest' is set
      if (uploadDocumentsRequest === undefined || uploadDocumentsRequest === null) {
        throw new Error("Missing the required parameter 'uploadDocumentsRequest' when calling uploadDocuments");
      }
      ...
      let accepts = ['application/json'];
      let returnType = UploadDocumentsResponse;
      return this.apiClient.callApi(
        '/2013-01-01/documents/batch#format=sdk&Content-Type', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
