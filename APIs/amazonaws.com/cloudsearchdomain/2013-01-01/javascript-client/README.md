# amazon_cloud_search_domain

AmazonCloudSearchDomain - JavaScript client for amazon_cloud_search_domain
...
```shell
npm install amazon_cloud_search_domain --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your amazon_cloud_search_domain from, and run:
...
```javascript
var AmazonCloudSearchDomain = require('amazon_cloud_search_domain');

var defaultClient = AmazonCloudSearchDomain.ApiClient.instance;
...
api.search(q, format, pretty, opts, callback);
...
------------ | ------------- | ------------- | -------------
*AmazonCloudSearchDomain.DefaultApi* | [**search**](docs/DefaultApi.md#search) | **GET** /2013-01-01/search#format&#x3D;sdk&amp;pretty&#x3D;true&amp;q | 
*AmazonCloudSearchDomain.DefaultApi* | [**suggest**](docs/DefaultApi.md#suggest) | **GET** /2013-01-01/suggest#format&#x3D;sdk&amp;pretty&#x3D;true&amp;q&amp;suggester | 
*AmazonCloudSearchDomain.DefaultApi* | [**uploadDocuments**](docs/DefaultApi.md#uploadDocuments) | **POST** /2013-01-01/documents/batch#format&#x3D;sdk&amp;Content-Type | 


## Documentation for Models

 - [AmazonCloudSearchDomain.Bucket](docs/Bucket.md)
 - [AmazonCloudSearchDomain.BucketInfo](docs/BucketInfo.md)
 - [AmazonCloudSearchDomain.ContentType](docs/ContentType.md)
 - [AmazonCloudSearchDomain.DocumentServiceException](docs/DocumentServiceException.md)
 - [AmazonCloudSearchDomain.DocumentServiceWarning](docs/DocumentServiceWarning.md)
 - [AmazonCloudSearchDomain.FieldStats](docs/FieldStats.md)
 - [AmazonCloudSearchDomain.Hit](docs/Hit.md)
 - [AmazonCloudSearchDomain.Hits](docs/Hits.md)
 - [AmazonCloudSearchDomain.QueryParser](docs/QueryParser.md)
 - [AmazonCloudSearchDomain.SearchException](docs/SearchException.md)
 - [AmazonCloudSearchDomain.SearchResponse](docs/SearchResponse.md)
 - [AmazonCloudSearchDomain.SearchResponseHits](docs/SearchResponseHits.md)
 - [AmazonCloudSearchDomain.SearchResponseStatus](docs/SearchResponseStatus.md)
 - [AmazonCloudSearchDomain.SearchStatus](docs/SearchStatus.md)
 - [AmazonCloudSearchDomain.SuggestModel](docs/SuggestModel.md)
 - [AmazonCloudSearchDomain.SuggestResponse](docs/SuggestResponse.md)
 - [AmazonCloudSearchDomain.SuggestResponseStatus](docs/SuggestResponseStatus.md)
 - [AmazonCloudSearchDomain.SuggestResponseSuggest](docs/SuggestResponseSuggest.md)
 - [AmazonCloudSearchDomain.SuggestStatus](docs/SuggestStatus.md)
 - [AmazonCloudSearchDomain.SuggestionMatch](docs/SuggestionMatch.md)
 - [AmazonCloudSearchDomain.UploadDocumentsRequest](docs/UploadDocumentsRequest.md)
 - [AmazonCloudSearchDomain.UploadDocumentsResponse](docs/UploadDocumentsResponse.md)
