...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SearchResponseHits();
  });
  ...
  describe('SearchResponseHits', function() {
    it('should create an instance of SearchResponseHits', function() {
      ...
      //var instance = new AmazonCloudSearchDomain.SearchResponseHits();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SearchResponseHits);
    });
