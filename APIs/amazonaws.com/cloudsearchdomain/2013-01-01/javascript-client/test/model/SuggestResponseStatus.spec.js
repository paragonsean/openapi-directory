...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SuggestResponseStatus();
  });
  ...
  describe('SuggestResponseStatus', function() {
    it('should create an instance of SuggestResponseStatus', function() {
      // uncomment below and update the code to test SuggestResponseStatus
      //var instance = new AmazonCloudSearchDomain.SuggestResponseStatus();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SuggestResponseStatus);
    });
