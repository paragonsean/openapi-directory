...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SuggestResponse();
  });
  ...
  describe('SuggestResponse', function() {
    it('should create an instance of SuggestResponse', function() {
      ...
      //var instance = new AmazonCloudSearchDomain.SuggestResponse();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SuggestResponse);
    });
