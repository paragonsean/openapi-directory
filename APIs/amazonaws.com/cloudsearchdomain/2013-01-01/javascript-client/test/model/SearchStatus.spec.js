...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SearchStatus();
  });
  ...
  describe('SearchStatus', function() {
    it('should create an instance of SearchStatus', function() {
      // uncomment below and update the code to test SearchStatus
      //var instance = new AmazonCloudSearchDomain.SearchStatus();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SearchStatus);
    });
