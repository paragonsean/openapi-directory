...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.BucketInfo();
  });
  ...
  describe('BucketInfo', function() {
    it('should create an instance of BucketInfo', function() {
      ...
      //var instance = new AmazonCloudSearchDomain.BucketInfo();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.BucketInfo);
    });
