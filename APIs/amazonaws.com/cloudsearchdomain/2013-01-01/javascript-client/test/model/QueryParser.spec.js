...
(function(root, factory) {
  ...
  describe('QueryParser', function() {
    it('should create an instance of QueryParser', function() {
      // uncomment below and update the code to test QueryParser
      //var instance = new AmazonCloudSearchDomain.QueryParser();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.QueryParser);
    });
