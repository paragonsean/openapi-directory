...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SearchException();
  });
  ...
  describe('SearchException', function() {
    it('should create an instance of SearchException', function() {
      // uncomment below and update the code to test SearchException
      //var instance = new AmazonCloudSearchDomain.SearchException();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SearchException);
    });
