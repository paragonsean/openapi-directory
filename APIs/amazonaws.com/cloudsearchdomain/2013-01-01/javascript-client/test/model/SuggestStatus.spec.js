...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SuggestStatus();
  });
  ...
  describe('SuggestStatus', function() {
    it('should create an instance of SuggestStatus', function() {
      // uncomment below and update the code to test SuggestStatus
      //var instance = new AmazonCloudSearchDomain.SuggestStatus();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SuggestStatus);
    });
