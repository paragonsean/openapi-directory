...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SearchResponse();
  });
  ...
  describe('SearchResponse', function() {
    it('should create an instance of SearchResponse', function() {
      ...
      //var instance = new AmazonCloudSearchDomain.SearchResponse();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SearchResponse);
    });
