...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SuggestModel();
  });
  ...
  describe('SuggestModel', function() {
    it('should create an instance of SuggestModel', function() {
      // uncomment below and update the code to test SuggestModel
      //var instance = new AmazonCloudSearchDomain.SuggestModel();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SuggestModel);
    });
