...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.Hits();
  });
  ...
  describe('Hits', function() {
    it('should create an instance of Hits', function() {
      // uncomment below and update the code to test Hits
      //var instance = new AmazonCloudSearchDomain.Hits();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.Hits);
    });
