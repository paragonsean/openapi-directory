...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.SearchResponseStatus();
  });
  ...
  describe('SearchResponseStatus', function() {
    it('should create an instance of SearchResponseStatus', function() {
      // uncomment below and update the code to test SearchResponseStatus
      //var instance = new AmazonCloudSearchDomain.SearchResponseStatus();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.SearchResponseStatus);
    });
