...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.UploadDocumentsRequest();
  });
  ...
  describe('UploadDocumentsRequest', function() {
    it('should create an instance of UploadDocumentsRequest', function() {
      // uncomment below and update the code to test UploadDocumentsRequest
      //var instance = new AmazonCloudSearchDomain.UploadDocumentsRequest();
      //expect(instance).to.be.a(AmazonCloudSearchDomain.UploadDocumentsRequest);
    });
