...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearchDomain.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('uploadDocuments', function() {
      it('should call uploadDocuments successfully', function(done) {
        //uncomment below and update the code to test uploadDocuments
        //instance.uploadDocuments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
