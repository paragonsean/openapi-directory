...
/*
 * OAISuggestResponse_suggest.h
 *
 * 
 */

#ifndef OAISuggestResponse_suggest_H
#define OAISuggestResponse_suggest_H
...
class OAISuggestResponse_suggest : public OAIObject {
public:
    OAISuggestResponse_suggest();
    OAISuggestResponse_suggest(QString json);
    ~OAISuggestResponse_suggest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuggestResponse_suggest)

#endif // OAISuggestResponse_suggest_H
