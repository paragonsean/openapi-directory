...
/*
 * OAISearchResponse_hits.h
 *
 * 
 */

#ifndef OAISearchResponse_hits_H
#define OAISearchResponse_hits_H
...
class OAISearchResponse_hits : public OAIObject {
public:
    OAISearchResponse_hits();
    OAISearchResponse_hits(QString json);
    ~OAISearchResponse_hits() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchResponse_hits)

#endif // OAISearchResponse_hits_H
