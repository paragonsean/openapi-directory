...
/*
 * OAIUploadDocumentsRequest.h
 *
 * Container for the parameters to the &lt;code&gt;UploadDocuments&lt;/code&gt; request.
 */

#ifndef OAIUploadDocumentsRequest_H
#define OAIUploadDocumentsRequest_H
...
class OAIUploadDocumentsRequest : public OAIObject {
public:
    OAIUploadDocumentsRequest();
    OAIUploadDocumentsRequest(QString json);
    ~OAIUploadDocumentsRequest() override;
    ...
    void setDocuments(const QString &documents);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadDocumentsRequest)

#endif // OAIUploadDocumentsRequest_H
