...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ResolverDnssecConfig();
  });
  ...
  describe('ResolverDnssecConfig', function() {
    it('should create an instance of ResolverDnssecConfig', function() {
      // uncomment below and update the code to test ResolverDnssecConfig
      //var instance = new AmazonRoute53Resolver.ResolverDnssecConfig();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ResolverDnssecConfig);
    });
