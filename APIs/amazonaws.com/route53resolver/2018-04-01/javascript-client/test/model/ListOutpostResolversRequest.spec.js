...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListOutpostResolversRequest();
  });
  ...
  describe('ListOutpostResolversRequest', function() {
    it('should create an instance of ListOutpostResolversRequest', function() {
      // uncomment below and update the code to test ListOutpostResolversRequest
      //var instance = new AmazonRoute53Resolver.ListOutpostResolversRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListOutpostResolversRequest);
    });
