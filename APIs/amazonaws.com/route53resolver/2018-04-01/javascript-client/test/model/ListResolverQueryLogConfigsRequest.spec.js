...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverQueryLogConfigsRequest();
  });
  ...
  describe('ListResolverQueryLogConfigsRequest', function() {
    it('should create an instance of ListResolverQueryLogConfigsRequest', function() {
      // uncomment below and update the code to test ListResolverQueryLogConfigsRequest
      //var instance = new AmazonRoute53Resolver.ListResolverQueryLogConfigsRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverQueryLogConfigsRequest);
    });
