...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.GetOutpostResolverResponseOutpostResolver();
  });
  ...
  describe('GetOutpostResolverResponseOutpostResolver', function() {
    it('should create an instance of GetOutpostResolverResponseOutpostResolver', function() {
      // uncomment below and update the code to test GetOutpostResolverResponseOutpostResolver
      //var instance = new AmazonRoute53Resolver.GetOutpostResolverResponseOutpostResolver();
      //expect(instance).to.be.a(AmazonRoute53Resolver.GetOutpostResolverResponseOutpostResolver);
    });
