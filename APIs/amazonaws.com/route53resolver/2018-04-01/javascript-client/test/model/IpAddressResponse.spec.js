...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.IpAddressResponse();
  });
  ...
  describe('IpAddressResponse', function() {
    it('should create an instance of IpAddressResponse', function() {
      // uncomment below and update the code to test IpAddressResponse
      //var instance = new AmazonRoute53Resolver.IpAddressResponse();
      //expect(instance).to.be.a(AmazonRoute53Resolver.IpAddressResponse);
    });
