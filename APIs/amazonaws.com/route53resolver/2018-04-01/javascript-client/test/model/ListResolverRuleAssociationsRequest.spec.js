...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverRuleAssociationsRequest();
  });
  ...
  describe('ListResolverRuleAssociationsRequest', function() {
    it('should create an instance of ListResolverRuleAssociationsRequest', function() {
      // uncomment below and update the code to test ListResolverRuleAssociationsRequest
      //var instance = new AmazonRoute53Resolver.ListResolverRuleAssociationsRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverRuleAssociationsRequest);
    });
