...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverEndpointsRequest();
  });
  ...
  describe('ListResolverEndpointsRequest', function() {
    it('should create an instance of ListResolverEndpointsRequest', function() {
      // uncomment below and update the code to test ListResolverEndpointsRequest
      //var instance = new AmazonRoute53Resolver.ListResolverEndpointsRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverEndpointsRequest);
    });
