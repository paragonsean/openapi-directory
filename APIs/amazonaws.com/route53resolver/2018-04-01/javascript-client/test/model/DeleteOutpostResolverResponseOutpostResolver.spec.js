...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.DeleteOutpostResolverResponseOutpostResolver();
  });
  ...
  describe('DeleteOutpostResolverResponseOutpostResolver', function() {
    it('should create an instance of DeleteOutpostResolverResponseOutpostResolver', function() {
      // uncomment below and update the code to test DeleteOutpostResolverResponseOutpostResolver
      //var instance = new AmazonRoute53Resolver.DeleteOutpostResolverResponseOutpostResolver();
      //expect(instance).to.be.a(AmazonRoute53Resolver.DeleteOutpostResolverResponseOutpostResolver);
    });
