...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverQueryLogConfigAssociationsRequest();
  });
  ...
  describe('ListResolverQueryLogConfigAssociationsRequest', function() {
    it('should create an instance of ListResolverQueryLogConfigAssociationsRequest', function() {
      // uncomment below and update the code to test ListResolverQueryLogConfigAssociationsRequest
      //var instance = new AmazonRoute53Resolver.ListResolverQueryLogConfigAssociationsRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverQueryLogConfigAssociationsRequest);
    });
