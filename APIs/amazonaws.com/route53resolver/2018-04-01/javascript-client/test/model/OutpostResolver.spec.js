...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.OutpostResolver();
  });
  ...
  describe('OutpostResolver', function() {
    it('should create an instance of OutpostResolver', function() {
      // uncomment below and update the code to test OutpostResolver
      //var instance = new AmazonRoute53Resolver.OutpostResolver();
      //expect(instance).to.be.a(AmazonRoute53Resolver.OutpostResolver);
    });
