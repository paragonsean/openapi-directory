...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverEndpointIpAddressesResponse();
  });
  ...
  describe('ListResolverEndpointIpAddressesResponse', function() {
    it('should create an instance of ListResolverEndpointIpAddressesResponse', function() {
      // uncomment below and update the code to test ListResolverEndpointIpAddressesResponse
      //var instance = new AmazonRoute53Resolver.ListResolverEndpointIpAddressesResponse();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverEndpointIpAddressesResponse);
    });
