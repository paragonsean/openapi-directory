...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverDnssecConfigsRequest();
  });
  ...
  describe('ListResolverDnssecConfigsRequest', function() {
    it('should create an instance of ListResolverDnssecConfigsRequest', function() {
      // uncomment below and update the code to test ListResolverDnssecConfigsRequest
      //var instance = new AmazonRoute53Resolver.ListResolverDnssecConfigsRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverDnssecConfigsRequest);
    });
