...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.IpAddressUpdate();
  });
  ...
  describe('IpAddressUpdate', function() {
    it('should create an instance of IpAddressUpdate', function() {
      // uncomment below and update the code to test IpAddressUpdate
      //var instance = new AmazonRoute53Resolver.IpAddressUpdate();
      //expect(instance).to.be.a(AmazonRoute53Resolver.IpAddressUpdate);
    });
