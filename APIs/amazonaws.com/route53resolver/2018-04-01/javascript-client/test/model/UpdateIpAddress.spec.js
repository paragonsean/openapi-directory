...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.UpdateIpAddress();
  });
  ...
  describe('UpdateIpAddress', function() {
    it('should create an instance of UpdateIpAddress', function() {
      // uncomment below and update the code to test UpdateIpAddress
      //var instance = new AmazonRoute53Resolver.UpdateIpAddress();
      //expect(instance).to.be.a(AmazonRoute53Resolver.UpdateIpAddress);
    });
