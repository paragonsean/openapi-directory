...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.UpdateOutpostResolverResponseOutpostResolver();
  });
  ...
  describe('UpdateOutpostResolverResponseOutpostResolver', function() {
    it('should create an instance of UpdateOutpostResolverResponseOutpostResolver', function() {
      // uncomment below and update the code to test UpdateOutpostResolverResponseOutpostResolver
      //var instance = new AmazonRoute53Resolver.UpdateOutpostResolverResponseOutpostResolver();
      //expect(instance).to.be.a(AmazonRoute53Resolver.UpdateOutpostResolverResponseOutpostResolver);
    });
