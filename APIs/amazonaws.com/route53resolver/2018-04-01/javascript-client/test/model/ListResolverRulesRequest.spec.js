...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.ListResolverRulesRequest();
  });
  ...
  describe('ListResolverRulesRequest', function() {
    it('should create an instance of ListResolverRulesRequest', function() {
      // uncomment below and update the code to test ListResolverRulesRequest
      //var instance = new AmazonRoute53Resolver.ListResolverRulesRequest();
      //expect(instance).to.be.a(AmazonRoute53Resolver.ListResolverRulesRequest);
    });
