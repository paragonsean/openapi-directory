...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Resolver.CreateOutpostResolverResponseOutpostResolver();
  });
  ...
  describe('CreateOutpostResolverResponseOutpostResolver', function() {
    it('should create an instance of CreateOutpostResolverResponseOutpostResolver', function() {
      // uncomment below and update the code to test CreateOutpostResolverResponseOutpostResolver
      //var instance = new AmazonRoute53Resolver.CreateOutpostResolverResponseOutpostResolver();
      //expect(instance).to.be.a(AmazonRoute53Resolver.CreateOutpostResolverResponseOutpostResolver);
    });
