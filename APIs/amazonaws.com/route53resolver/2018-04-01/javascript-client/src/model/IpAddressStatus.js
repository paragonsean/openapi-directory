...
* @readonly
*/
export default class IpAddressStatus {
    ...
    /**
    * Returns a <code>IpAddressStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IpAddressStatus} The enum <code>IpAddressStatus</code> value.
    */
