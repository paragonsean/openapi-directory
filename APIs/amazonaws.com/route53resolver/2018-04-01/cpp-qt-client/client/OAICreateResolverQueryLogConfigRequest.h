...
/*
 * OAICreateResolverQueryLogConfigRequest.h
 *
 * 
 */

#ifndef OAICreateResolverQueryLogConfigRequest_H
#define OAICreateResolverQueryLogConfigRequest_H
...
class OAICreateResolverQueryLogConfigRequest : public OAIObject {
public:
    OAICreateResolverQueryLogConfigRequest();
    OAICreateResolverQueryLogConfigRequest(QString json);
    ~OAICreateResolverQueryLogConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResolverQueryLogConfigRequest)

#endif // OAICreateResolverQueryLogConfigRequest_H
