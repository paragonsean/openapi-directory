...
/*
 * OAIUpdateOutpostResolverResponse_OutpostResolver.h
 *
 * 
 */

#ifndef OAIUpdateOutpostResolverResponse_OutpostResolver_H
#define OAIUpdateOutpostResolverResponse_OutpostResolver_H
...
class OAIUpdateOutpostResolverResponse_OutpostResolver : public OAIObject {
public:
    OAIUpdateOutpostResolverResponse_OutpostResolver();
    OAIUpdateOutpostResolverResponse_OutpostResolver(QString json);
    ~OAIUpdateOutpostResolverResponse_OutpostResolver() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOutpostResolverResponse_OutpostResolver)

#endif // OAIUpdateOutpostResolverResponse_OutpostResolver_H
