...
/*
 * OAIFirewallRuleGroupMetadata.h
 *
...
#ifndef OAIFirewallRuleGroupMetadata_H
#define OAIFirewallRuleGroupMetadata_H
...
class OAIFirewallRuleGroupMetadata : public OAIObject {
public:
    OAIFirewallRuleGroupMetadata();
    OAIFirewallRuleGroupMetadata(QString json);
    ~OAIFirewallRuleGroupMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallRuleGroupMetadata)

#endif // OAIFirewallRuleGroupMetadata_H
