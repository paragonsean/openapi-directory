...
class OAIOutpostResolver : public OAIObject {
public:
    OAIOutpostResolver();
    OAIOutpostResolver(QString json);
    ~OAIOutpostResolver() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutpostResolver)

#endif // OAIOutpostResolver_H
