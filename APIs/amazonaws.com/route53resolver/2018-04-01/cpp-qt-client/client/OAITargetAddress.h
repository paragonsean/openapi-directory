...
#ifndef OAITargetAddress_H
#define OAITargetAddress_H
...
class OAITargetAddress : public OAIObject {
public:
    OAITargetAddress();
    OAITargetAddress(QString json);
    ~OAITargetAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetAddress)

#endif // OAITargetAddress_H
