...
#ifndef OAIIpAddressUpdate_H
#define OAIIpAddressUpdate_H
...
class OAIIpAddressUpdate : public OAIObject {
public:
    OAIIpAddressUpdate();
    OAIIpAddressUpdate(QString json);
    ~OAIIpAddressUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressUpdate)

#endif // OAIIpAddressUpdate_H
