...
#ifndef OAIFirewallDomainList_H
#define OAIFirewallDomainList_H
...
class OAIFirewallDomainList : public OAIObject {
public:
    OAIFirewallDomainList();
    OAIFirewallDomainList(QString json);
    ~OAIFirewallDomainList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallDomainList)

#endif // OAIFirewallDomainList_H
