...
/*
 * OAICreateResolverRuleResponse_ResolverRule.h
 *
 * 
 */

#ifndef OAICreateResolverRuleResponse_ResolverRule_H
#define OAICreateResolverRuleResponse_ResolverRule_H
...
class OAICreateResolverRuleResponse_ResolverRule : public OAIObject {
public:
    OAICreateResolverRuleResponse_ResolverRule();
    OAICreateResolverRuleResponse_ResolverRule(QString json);
    ~OAICreateResolverRuleResponse_ResolverRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResolverRuleResponse_ResolverRule)

#endif // OAICreateResolverRuleResponse_ResolverRule_H
