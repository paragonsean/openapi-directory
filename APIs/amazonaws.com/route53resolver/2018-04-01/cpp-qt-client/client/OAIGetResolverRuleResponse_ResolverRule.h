...
/*
 * OAIGetResolverRuleResponse_ResolverRule.h
 *
 * 
 */

#ifndef OAIGetResolverRuleResponse_ResolverRule_H
#define OAIGetResolverRuleResponse_ResolverRule_H
...
class OAIGetResolverRuleResponse_ResolverRule : public OAIObject {
public:
    OAIGetResolverRuleResponse_ResolverRule();
    OAIGetResolverRuleResponse_ResolverRule(QString json);
    ~OAIGetResolverRuleResponse_ResolverRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResolverRuleResponse_ResolverRule)

#endif // OAIGetResolverRuleResponse_ResolverRule_H
