...
/*
 * OAIUpdateResolverRuleResponse_ResolverRule.h
 *
 * 
 */

#ifndef OAIUpdateResolverRuleResponse_ResolverRule_H
#define OAIUpdateResolverRuleResponse_ResolverRule_H
...
class OAIUpdateResolverRuleResponse_ResolverRule : public OAIObject {
public:
    OAIUpdateResolverRuleResponse_ResolverRule();
    OAIUpdateResolverRuleResponse_ResolverRule(QString json);
    ~OAIUpdateResolverRuleResponse_ResolverRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResolverRuleResponse_ResolverRule)

#endif // OAIUpdateResolverRuleResponse_ResolverRule_H
