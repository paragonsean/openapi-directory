...
/*
 * OAICreateOutpostResolverResponse_OutpostResolver.h
 *
 * 
 */

#ifndef OAICreateOutpostResolverResponse_OutpostResolver_H
#define OAICreateOutpostResolverResponse_OutpostResolver_H

#include <QJsonObject>

#include "OAIOutpostResolverStatus.h"
#include <QString>
...
class OAICreateOutpostResolverResponse_OutpostResolver : public OAIObject {
public:
    OAICreateOutpostResolverResponse_OutpostResolver();
    OAICreateOutpostResolverResponse_OutpostResolver(QString json);
    ~OAICreateOutpostResolverResponse_OutpostResolver() override;
    ...
    OAIOutpostResolverStatus getStatus() const;
    void setStatus(const OAIOutpostResolverStatus &status);
...
private:
    ...
    OAIOutpostResolverStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOutpostResolverResponse_OutpostResolver)

#endif // OAICreateOutpostResolverResponse_OutpostResolver_H
