...
#ifndef OAIResolverRule_H
#define OAIResolverRule_H
...
class OAIResolverRule : public OAIObject {
public:
    OAIResolverRule();
    OAIResolverRule(QString json);
    ~OAIResolverRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolverRule)

#endif // OAIResolverRule_H
