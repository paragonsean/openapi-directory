...
#ifndef OAIResolverEndpoint_H
#define OAIResolverEndpoint_H
...
class OAIResolverEndpoint : public OAIObject {
public:
    OAIResolverEndpoint();
    OAIResolverEndpoint(QString json);
    ~OAIResolverEndpoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolverEndpoint)

#endif // OAIResolverEndpoint_H
