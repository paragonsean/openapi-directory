...
/*
 * OAICreateResolverRuleRequest.h
 *
 * 
 */

#ifndef OAICreateResolverRuleRequest_H
#define OAICreateResolverRuleRequest_H
...
class OAICreateResolverRuleRequest : public OAIObject {
public:
    OAICreateResolverRuleRequest();
    OAICreateResolverRuleRequest(QString json);
    ~OAICreateResolverRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResolverRuleRequest)

#endif // OAICreateResolverRuleRequest_H
