...
void OAIShareStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("NOT_SHARED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIShareStatus::NOT_SHARED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHARED_WITH_ME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIShareStatus::SHARED_WITH_ME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHARED_BY_ME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIShareStatus::SHARED_BY_ME;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIShareStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIShareStatus::NOT_SHARED:
            val = "NOT_SHARED";
            break;
        case eOAIShareStatus::SHARED_WITH_ME:
            val = "SHARED_WITH_ME";
            break;
        case eOAIShareStatus::SHARED_BY_ME:
            val = "SHARED_BY_ME";
            break;
        default:
            break;
