...
/*
 * OAICreateOutpostResolverRequest.h
 *
 * 
 */

#ifndef OAICreateOutpostResolverRequest_H
#define OAICreateOutpostResolverRequest_H
...
class OAICreateOutpostResolverRequest : public OAIObject {
public:
    OAICreateOutpostResolverRequest();
    OAICreateOutpostResolverRequest(QString json);
    ~OAICreateOutpostResolverRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOutpostResolverRequest)

#endif // OAICreateOutpostResolverRequest_H
