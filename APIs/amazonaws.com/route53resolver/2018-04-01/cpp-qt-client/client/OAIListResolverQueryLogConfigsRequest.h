...
/*
 * OAIListResolverQueryLogConfigsRequest.h
 *
 * 
 */

#ifndef OAIListResolverQueryLogConfigsRequest_H
#define OAIListResolverQueryLogConfigsRequest_H
...
class OAIListResolverQueryLogConfigsRequest : public OAIObject {
public:
    OAIListResolverQueryLogConfigsRequest();
    OAIListResolverQueryLogConfigsRequest(QString json);
    ~OAIListResolverQueryLogConfigsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResolverQueryLogConfigsRequest)

#endif // OAIListResolverQueryLogConfigsRequest_H
