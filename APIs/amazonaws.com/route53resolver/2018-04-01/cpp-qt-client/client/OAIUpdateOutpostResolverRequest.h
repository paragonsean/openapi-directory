...
/*
 * OAIUpdateOutpostResolverRequest.h
 *
 * 
 */

#ifndef OAIUpdateOutpostResolverRequest_H
#define OAIUpdateOutpostResolverRequest_H
...
class OAIUpdateOutpostResolverRequest : public OAIObject {
public:
    OAIUpdateOutpostResolverRequest();
    OAIUpdateOutpostResolverRequest(QString json);
    ~OAIUpdateOutpostResolverRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOutpostResolverRequest)

#endif // OAIUpdateOutpostResolverRequest_H
