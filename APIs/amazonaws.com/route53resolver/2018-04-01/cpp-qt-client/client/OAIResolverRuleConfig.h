...
#ifndef OAIResolverRuleConfig_H
#define OAIResolverRuleConfig_H
...
class OAIResolverRuleConfig : public OAIObject {
public:
    OAIResolverRuleConfig();
    OAIResolverRuleConfig(QString json);
    ~OAIResolverRuleConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolverRuleConfig)

#endif // OAIResolverRuleConfig_H
