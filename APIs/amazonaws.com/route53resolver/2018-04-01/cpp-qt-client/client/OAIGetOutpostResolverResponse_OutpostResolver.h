...
/*
 * OAIGetOutpostResolverResponse_OutpostResolver.h
 *
 * 
 */

#ifndef OAIGetOutpostResolverResponse_OutpostResolver_H
#define OAIGetOutpostResolverResponse_OutpostResolver_H
...
class OAIGetOutpostResolverResponse_OutpostResolver : public OAIObject {
public:
    OAIGetOutpostResolverResponse_OutpostResolver();
    OAIGetOutpostResolverResponse_OutpostResolver(QString json);
    ~OAIGetOutpostResolverResponse_OutpostResolver() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOutpostResolverResponse_OutpostResolver)

#endif // OAIGetOutpostResolverResponse_OutpostResolver_H
