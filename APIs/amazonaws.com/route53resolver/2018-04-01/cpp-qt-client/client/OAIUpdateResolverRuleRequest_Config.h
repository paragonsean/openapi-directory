...
/*
 * OAIUpdateResolverRuleRequest_Config.h
 *
 * 
 */

#ifndef OAIUpdateResolverRuleRequest_Config_H
#define OAIUpdateResolverRuleRequest_Config_H
...
class OAIUpdateResolverRuleRequest_Config : public OAIObject {
public:
    OAIUpdateResolverRuleRequest_Config();
    OAIUpdateResolverRuleRequest_Config(QString json);
    ~OAIUpdateResolverRuleRequest_Config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResolverRuleRequest_Config)

#endif // OAIUpdateResolverRuleRequest_Config_H
