...
#ifndef OAIIpAddressResponse_H
#define OAIIpAddressResponse_H
...
class OAIIpAddressResponse : public OAIObject {
public:
    OAIIpAddressResponse();
    OAIIpAddressResponse(QString json);
    ~OAIIpAddressResponse() override;
    ...
    OAIIpAddressStatus getStatus() const;
    void setStatus(const OAIIpAddressStatus &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpAddressResponse)

#endif // OAIIpAddressResponse_H
