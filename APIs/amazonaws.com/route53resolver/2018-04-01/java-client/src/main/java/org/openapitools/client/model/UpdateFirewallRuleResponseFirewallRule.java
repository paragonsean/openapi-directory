...
public class UpdateFirewallRuleResponseFirewallRule {
  ...
  public UpdateFirewallRuleResponseFirewallRule() {
  }

  public UpdateFirewallRuleResponseFirewallRule firewallRuleGroupId(String firewallRuleGroupId) {
  ...
  public UpdateFirewallRuleResponseFirewallRule firewallDomainListId(String firewallDomainListId) {
  ...
  public UpdateFirewallRuleResponseFirewallRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateFirewallRuleResponseFirewallRule priority(Integer priority) {
  ...
  public UpdateFirewallRuleResponseFirewallRule action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public UpdateFirewallRuleResponseFirewallRule blockResponse(BlockResponse blockResponse) {
  ...
  public UpdateFirewallRuleResponseFirewallRule blockOverrideDomain(String blockOverrideDomain) {
  ...
  public UpdateFirewallRuleResponseFirewallRule blockOverrideDnsType(BlockOverrideDnsType blockOverrideDnsType) {
  ...
  public UpdateFirewallRuleResponseFirewallRule blockOverrideTtl(Integer blockOverrideTtl) {
  ...
  public UpdateFirewallRuleResponseFirewallRule creatorRequestId(String creatorRequestId) {
  ...
  public UpdateFirewallRuleResponseFirewallRule creationTime(String creationTime) {
  ...
  public UpdateFirewallRuleResponseFirewallRule modificationTime(String modificationTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallRuleResponseFirewallRule updateFirewallRuleResponseFirewallRule = (UpdateFirewallRuleResponseFirewallRule) o;
    return Objects.equals(this.firewallRuleGroupId, updateFirewallRuleResponseFirewallRule.firewallRuleGroupId) &&
        Objects.equals(this.firewallDomainListId, updateFirewallRuleResponseFirewallRule.firewallDomainListId) &&
        Objects.equals(this.name, updateFirewallRuleResponseFirewallRule.name) &&
        Objects.equals(this.priority, updateFirewallRuleResponseFirewallRule.priority) &&
        Objects.equals(this.action, updateFirewallRuleResponseFirewallRule.action) &&
        Objects.equals(this.blockResponse, updateFirewallRuleResponseFirewallRule.blockResponse) &&
        Objects.equals(this.blockOverrideDomain, updateFirewallRuleResponseFirewallRule.blockOverrideDomain) &&
        Objects.equals(this.blockOverrideDnsType, updateFirewallRuleResponseFirewallRule.blockOverrideDnsType) &&
        Objects.equals(this.blockOverrideTtl, updateFirewallRuleResponseFirewallRule.blockOverrideTtl) &&
        Objects.equals(this.creatorRequestId, updateFirewallRuleResponseFirewallRule.creatorRequestId) &&
        Objects.equals(this.creationTime, updateFirewallRuleResponseFirewallRule.creationTime) &&
        Objects.equals(this.modificationTime, updateFirewallRuleResponseFirewallRule.modificationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFirewallRuleResponseFirewallRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallRuleResponseFirewallRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallRuleResponseFirewallRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallRuleResponseFirewallRule is not found in the empty JSON string", UpdateFirewallRuleResponseFirewallRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallRuleResponseFirewallRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallRuleResponseFirewallRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallRuleResponseFirewallRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallRuleResponseFirewallRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallRuleResponseFirewallRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallRuleResponseFirewallRule.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallRuleResponseFirewallRule>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallRuleResponseFirewallRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallRuleResponseFirewallRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallRuleResponseFirewallRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallRuleResponseFirewallRule
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallRuleResponseFirewallRule
   */
  public static UpdateFirewallRuleResponseFirewallRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallRuleResponseFirewallRule.class);
  }

  /**
   * Convert an instance of UpdateFirewallRuleResponseFirewallRule to an JSON string
   *
   * @return JSON string
   */
