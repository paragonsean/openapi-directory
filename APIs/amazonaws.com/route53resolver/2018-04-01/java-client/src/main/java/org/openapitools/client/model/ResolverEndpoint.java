...
public class ResolverEndpoint {
  ...
  public ResolverEndpoint id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ResolverEndpoint creatorRequestId(String creatorRequestId) {
  ...
  public ResolverEndpoint arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ResolverEndpoint name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResolverEndpoint securityGroupIds(List securityGroupIds) {
  ...
  public ResolverEndpoint direction(ResolverEndpointDirection direction) {
  ...
  public ResolverEndpoint ipAddressCount(Integer ipAddressCount) {
  ...
  public ResolverEndpoint hostVPCId(String hostVPCId) {
  ...
  public ResolverEndpoint status(ResolverEndpointStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResolverEndpoint statusMessage(String statusMessage) {
  ...
  public ResolverEndpoint creationTime(String creationTime) {
  ...
  public ResolverEndpoint modificationTime(String modificationTime) {
  ...
  public ResolverEndpoint resolverEndpointType(ResolverEndpointType resolverEndpointType) {
  ...
  public ResolverEndpoint outpostArn(String outpostArn) {
  ...
  public ResolverEndpoint preferredInstanceType(String preferredInstanceType) {
  ...
  public boolean equals(Object o) {
    ...
    ResolverEndpoint resolverEndpoint = (ResolverEndpoint) o;
    return Objects.equals(this.id, resolverEndpoint.id) &&
        Objects.equals(this.creatorRequestId, resolverEndpoint.creatorRequestId) &&
        Objects.equals(this.arn, resolverEndpoint.arn) &&
        Objects.equals(this.name, resolverEndpoint.name) &&
        Objects.equals(this.securityGroupIds, resolverEndpoint.securityGroupIds) &&
        Objects.equals(this.direction, resolverEndpoint.direction) &&
        Objects.equals(this.ipAddressCount, resolverEndpoint.ipAddressCount) &&
        Objects.equals(this.hostVPCId, resolverEndpoint.hostVPCId) &&
        Objects.equals(this.status, resolverEndpoint.status) &&
        Objects.equals(this.statusMessage, resolverEndpoint.statusMessage) &&
        Objects.equals(this.creationTime, resolverEndpoint.creationTime) &&
        Objects.equals(this.modificationTime, resolverEndpoint.modificationTime) &&
        Objects.equals(this.resolverEndpointType, resolverEndpoint.resolverEndpointType) &&
        Objects.equals(this.outpostArn, resolverEndpoint.outpostArn) &&
        Objects.equals(this.preferredInstanceType, resolverEndpoint.preferredInstanceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResolverEndpoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolverEndpoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolverEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolverEndpoint is not found in the empty JSON string", ResolverEndpoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolverEndpoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolverEndpoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolverEndpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolverEndpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolverEndpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolverEndpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolverEndpoint>() {
           @Override
           public void write(JsonWriter out, ResolverEndpoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolverEndpoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolverEndpoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolverEndpoint
   * @throws IOException if the JSON string is invalid with respect to ResolverEndpoint
   */
  public static ResolverEndpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolverEndpoint.class);
  }

  /**
   * Convert an instance of ResolverEndpoint to an JSON string
   *
   * @return JSON string
   */
