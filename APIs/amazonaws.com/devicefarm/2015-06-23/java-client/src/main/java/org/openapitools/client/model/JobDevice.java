...
public class JobDevice {
  ...
  public JobDevice arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public JobDevice name(String name) {
    this.name = name;
    return this;
  }
  ...
  public JobDevice manufacturer(String manufacturer) {
  ...
  public JobDevice model(String model) {
    this.model = model;
    return this;
  }
  ...
  public JobDevice modelId(String modelId) {
  ...
  public JobDevice formFactor(DeviceFormFactor formFactor) {
  ...
  public JobDevice platform(DevicePlatform platform) {
  ...
  public JobDevice cpu(DeviceCpu cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public JobDevice resolution(DeviceResolution resolution) {
  ...
  public JobDevice heapSize(Integer heapSize) {
  ...
  public JobDevice memory(Integer memory) {
    this.memory = memory;
    return this;
  }
  ...
  public JobDevice image(String image) {
    this.image = image;
    return this;
  }
  ...
  public JobDevice carrier(String carrier) {
  ...
  public JobDevice radio(String radio) {
    this.radio = radio;
    return this;
  }
  ...
  public JobDevice remoteAccessEnabled(Boolean remoteAccessEnabled) {
  ...
  public JobDevice remoteDebugEnabled(Boolean remoteDebugEnabled) {
  ...
  public JobDevice fleetType(String fleetType) {
  ...
  public JobDevice fleetName(String fleetName) {
  ...
  public JobDevice instances(List instances) {
  ...
  public JobDevice availability(DeviceAvailability availability) {
  ...
  public boolean equals(Object o) {
    ...
    JobDevice jobDevice = (JobDevice) o;
    return Objects.equals(this.arn, jobDevice.arn) &&
        Objects.equals(this.name, jobDevice.name) &&
        Objects.equals(this.manufacturer, jobDevice.manufacturer) &&
        Objects.equals(this.model, jobDevice.model) &&
        Objects.equals(this.modelId, jobDevice.modelId) &&
        Objects.equals(this.formFactor, jobDevice.formFactor) &&
        Objects.equals(this.platform, jobDevice.platform) &&
        Objects.equals(this.os, jobDevice.os) &&
        Objects.equals(this.cpu, jobDevice.cpu) &&
        Objects.equals(this.resolution, jobDevice.resolution) &&
        Objects.equals(this.heapSize, jobDevice.heapSize) &&
        Objects.equals(this.memory, jobDevice.memory) &&
        Objects.equals(this.image, jobDevice.image) &&
        Objects.equals(this.carrier, jobDevice.carrier) &&
        Objects.equals(this.radio, jobDevice.radio) &&
        Objects.equals(this.remoteAccessEnabled, jobDevice.remoteAccessEnabled) &&
        Objects.equals(this.remoteDebugEnabled, jobDevice.remoteDebugEnabled) &&
        Objects.equals(this.fleetType, jobDevice.fleetType) &&
        Objects.equals(this.fleetName, jobDevice.fleetName) &&
        Objects.equals(this.instances, jobDevice.instances) &&
        Objects.equals(this.availability, jobDevice.availability);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDevice is not found in the empty JSON string", JobDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDevice>() {
           @Override
           public void write(JsonWriter out, JobDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDevice
   * @throws IOException if the JSON string is invalid with respect to JobDevice
   */
  public static JobDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDevice.class);
  }

  /**
   * Convert an instance of JobDevice to an JSON string
   *
   * @return JSON string
   */
