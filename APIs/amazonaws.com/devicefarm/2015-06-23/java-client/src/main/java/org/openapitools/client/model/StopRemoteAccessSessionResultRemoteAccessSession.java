...
public class StopRemoteAccessSessionResultRemoteAccessSession {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession() {
  }

  public StopRemoteAccessSessionResultRemoteAccessSession arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession created(OffsetDateTime created) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession status(ExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession result(ExecutionResult result) {
    this.result = result;
    return this;
  }
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession message(String message) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession started(OffsetDateTime started) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession stopped(OffsetDateTime stopped) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession device(RemoteAccessSessionDevice device) {
    this.device = device;
    return this;
  }
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession instanceArn(String instanceArn) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession remoteDebugEnabled(Boolean remoteDebugEnabled) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession remoteRecordEnabled(Boolean remoteRecordEnabled) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession remoteRecordAppArn(String remoteRecordAppArn) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession hostAddress(String hostAddress) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession clientId(String clientId) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession billingMethod(BillingMethod billingMethod) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession deviceMinutes(RemoteAccessSessionDeviceMinutes deviceMinutes) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession endpoint(String endpoint) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession deviceUdid(String deviceUdid) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession interactionMode(InteractionMode interactionMode) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession skipAppResign(Boolean skipAppResign) {
  ...
  public StopRemoteAccessSessionResultRemoteAccessSession vpcConfig(CreateProjectRequestVpcConfig vpcConfig) {
  ...
  public boolean equals(Object o) {
    ...
    StopRemoteAccessSessionResultRemoteAccessSession stopRemoteAccessSessionResultRemoteAccessSession = (StopRemoteAccessSessionResultRemoteAccessSession) o;
    return Objects.equals(this.arn, stopRemoteAccessSessionResultRemoteAccessSession.arn) &&
        Objects.equals(this.name, stopRemoteAccessSessionResultRemoteAccessSession.name) &&
        Objects.equals(this.created, stopRemoteAccessSessionResultRemoteAccessSession.created) &&
        Objects.equals(this.status, stopRemoteAccessSessionResultRemoteAccessSession.status) &&
        Objects.equals(this.result, stopRemoteAccessSessionResultRemoteAccessSession.result) &&
        Objects.equals(this.message, stopRemoteAccessSessionResultRemoteAccessSession.message) &&
        Objects.equals(this.started, stopRemoteAccessSessionResultRemoteAccessSession.started) &&
        Objects.equals(this.stopped, stopRemoteAccessSessionResultRemoteAccessSession.stopped) &&
        Objects.equals(this.device, stopRemoteAccessSessionResultRemoteAccessSession.device) &&
        Objects.equals(this.instanceArn, stopRemoteAccessSessionResultRemoteAccessSession.instanceArn) &&
        Objects.equals(this.remoteDebugEnabled, stopRemoteAccessSessionResultRemoteAccessSession.remoteDebugEnabled) &&
        Objects.equals(this.remoteRecordEnabled, stopRemoteAccessSessionResultRemoteAccessSession.remoteRecordEnabled) &&
        Objects.equals(this.remoteRecordAppArn, stopRemoteAccessSessionResultRemoteAccessSession.remoteRecordAppArn) &&
        Objects.equals(this.hostAddress, stopRemoteAccessSessionResultRemoteAccessSession.hostAddress) &&
        Objects.equals(this.clientId, stopRemoteAccessSessionResultRemoteAccessSession.clientId) &&
        Objects.equals(this.billingMethod, stopRemoteAccessSessionResultRemoteAccessSession.billingMethod) &&
        Objects.equals(this.deviceMinutes, stopRemoteAccessSessionResultRemoteAccessSession.deviceMinutes) &&
        Objects.equals(this.endpoint, stopRemoteAccessSessionResultRemoteAccessSession.endpoint) &&
        Objects.equals(this.deviceUdid, stopRemoteAccessSessionResultRemoteAccessSession.deviceUdid) &&
        Objects.equals(this.interactionMode, stopRemoteAccessSessionResultRemoteAccessSession.interactionMode) &&
        Objects.equals(this.skipAppResign, stopRemoteAccessSessionResultRemoteAccessSession.skipAppResign) &&
        Objects.equals(this.vpcConfig, stopRemoteAccessSessionResultRemoteAccessSession.vpcConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class StopRemoteAccessSessionResultRemoteAccessSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopRemoteAccessSessionResultRemoteAccessSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopRemoteAccessSessionResultRemoteAccessSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopRemoteAccessSessionResultRemoteAccessSession is not found in the empty JSON string", StopRemoteAccessSessionResultRemoteAccessSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopRemoteAccessSessionResultRemoteAccessSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopRemoteAccessSessionResultRemoteAccessSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopRemoteAccessSessionResultRemoteAccessSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopRemoteAccessSessionResultRemoteAccessSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopRemoteAccessSessionResultRemoteAccessSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopRemoteAccessSessionResultRemoteAccessSession.class));

       return (TypeAdapter<T>) new TypeAdapter<StopRemoteAccessSessionResultRemoteAccessSession>() {
           @Override
           public void write(JsonWriter out, StopRemoteAccessSessionResultRemoteAccessSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopRemoteAccessSessionResultRemoteAccessSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopRemoteAccessSessionResultRemoteAccessSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopRemoteAccessSessionResultRemoteAccessSession
   * @throws IOException if the JSON string is invalid with respect to StopRemoteAccessSessionResultRemoteAccessSession
   */
  public static StopRemoteAccessSessionResultRemoteAccessSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopRemoteAccessSessionResultRemoteAccessSession.class);
  }

  /**
   * Convert an instance of StopRemoteAccessSessionResultRemoteAccessSession to an JSON string
   *
   * @return JSON string
   */
