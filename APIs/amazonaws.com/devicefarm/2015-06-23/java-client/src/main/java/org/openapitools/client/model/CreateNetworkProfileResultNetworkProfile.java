...
public class CreateNetworkProfileResultNetworkProfile {
  ...
  public CreateNetworkProfileResultNetworkProfile() {
  }

  public CreateNetworkProfileResultNetworkProfile arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateNetworkProfileResultNetworkProfile name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateNetworkProfileResultNetworkProfile description(String description) {
  ...
  public CreateNetworkProfileResultNetworkProfile type(NetworkProfileType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateNetworkProfileResultNetworkProfile uplinkBandwidthBits(Integer uplinkBandwidthBits) {
  ...
  public CreateNetworkProfileResultNetworkProfile downlinkBandwidthBits(Integer downlinkBandwidthBits) {
  ...
  public CreateNetworkProfileResultNetworkProfile uplinkDelayMs(Integer uplinkDelayMs) {
  ...
  public CreateNetworkProfileResultNetworkProfile downlinkDelayMs(Integer downlinkDelayMs) {
  ...
  public CreateNetworkProfileResultNetworkProfile uplinkJitterMs(Integer uplinkJitterMs) {
  ...
  public CreateNetworkProfileResultNetworkProfile downlinkJitterMs(Integer downlinkJitterMs) {
  ...
  public CreateNetworkProfileResultNetworkProfile uplinkLossPercent(Integer uplinkLossPercent) {
  ...
  public CreateNetworkProfileResultNetworkProfile downlinkLossPercent(Integer downlinkLossPercent) {
  ...
  public boolean equals(Object o) {
    ...
    CreateNetworkProfileResultNetworkProfile createNetworkProfileResultNetworkProfile = (CreateNetworkProfileResultNetworkProfile) o;
    return Objects.equals(this.arn, createNetworkProfileResultNetworkProfile.arn) &&
        Objects.equals(this.name, createNetworkProfileResultNetworkProfile.name) &&
        Objects.equals(this.description, createNetworkProfileResultNetworkProfile.description) &&
        Objects.equals(this.type, createNetworkProfileResultNetworkProfile.type) &&
        Objects.equals(this.uplinkBandwidthBits, createNetworkProfileResultNetworkProfile.uplinkBandwidthBits) &&
        Objects.equals(this.downlinkBandwidthBits, createNetworkProfileResultNetworkProfile.downlinkBandwidthBits) &&
        Objects.equals(this.uplinkDelayMs, createNetworkProfileResultNetworkProfile.uplinkDelayMs) &&
        Objects.equals(this.downlinkDelayMs, createNetworkProfileResultNetworkProfile.downlinkDelayMs) &&
        Objects.equals(this.uplinkJitterMs, createNetworkProfileResultNetworkProfile.uplinkJitterMs) &&
        Objects.equals(this.downlinkJitterMs, createNetworkProfileResultNetworkProfile.downlinkJitterMs) &&
        Objects.equals(this.uplinkLossPercent, createNetworkProfileResultNetworkProfile.uplinkLossPercent) &&
        Objects.equals(this.downlinkLossPercent, createNetworkProfileResultNetworkProfile.downlinkLossPercent);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNetworkProfileResultNetworkProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNetworkProfileResultNetworkProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNetworkProfileResultNetworkProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateNetworkProfileResultNetworkProfile is not found in the empty JSON string", CreateNetworkProfileResultNetworkProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNetworkProfileResultNetworkProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateNetworkProfileResultNetworkProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNetworkProfileResultNetworkProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNetworkProfileResultNetworkProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNetworkProfileResultNetworkProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNetworkProfileResultNetworkProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNetworkProfileResultNetworkProfile>() {
           @Override
           public void write(JsonWriter out, CreateNetworkProfileResultNetworkProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNetworkProfileResultNetworkProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNetworkProfileResultNetworkProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNetworkProfileResultNetworkProfile
   * @throws IOException if the JSON string is invalid with respect to CreateNetworkProfileResultNetworkProfile
   */
  public static CreateNetworkProfileResultNetworkProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNetworkProfileResultNetworkProfile.class);
  }

  /**
   * Convert an instance of CreateNetworkProfileResultNetworkProfile to an JSON string
   *
   * @return JSON string
   */
