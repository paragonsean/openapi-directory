...
public class DevicePoolCompatibilityResultDevice {
  ...
  public DevicePoolCompatibilityResultDevice() {
  }

  public DevicePoolCompatibilityResultDevice arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice manufacturer(String manufacturer) {
  ...
  public DevicePoolCompatibilityResultDevice model(String model) {
    this.model = model;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice modelId(String modelId) {
  ...
  public DevicePoolCompatibilityResultDevice formFactor(DeviceFormFactor formFactor) {
  ...
  public DevicePoolCompatibilityResultDevice platform(DevicePlatform platform) {
  ...
  public DevicePoolCompatibilityResultDevice os(String os) {
    this.os = os;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice cpu(DeviceCpu cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice resolution(DeviceResolution resolution) {
  ...
  public DevicePoolCompatibilityResultDevice heapSize(Integer heapSize) {
  ...
  public DevicePoolCompatibilityResultDevice memory(Integer memory) {
    this.memory = memory;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice image(String image) {
    this.image = image;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice carrier(String carrier) {
  ...
  public DevicePoolCompatibilityResultDevice radio(String radio) {
    this.radio = radio;
    return this;
  }
  ...
  public DevicePoolCompatibilityResultDevice remoteAccessEnabled(Boolean remoteAccessEnabled) {
  ...
  public DevicePoolCompatibilityResultDevice remoteDebugEnabled(Boolean remoteDebugEnabled) {
  ...
  public DevicePoolCompatibilityResultDevice fleetType(String fleetType) {
  ...
  public DevicePoolCompatibilityResultDevice fleetName(String fleetName) {
  ...
  public DevicePoolCompatibilityResultDevice instances(List instances) {
  ...
  public DevicePoolCompatibilityResultDevice availability(DeviceAvailability availability) {
  ...
  public boolean equals(Object o) {
    ...
    DevicePoolCompatibilityResultDevice devicePoolCompatibilityResultDevice = (DevicePoolCompatibilityResultDevice) o;
    return Objects.equals(this.arn, devicePoolCompatibilityResultDevice.arn) &&
        Objects.equals(this.name, devicePoolCompatibilityResultDevice.name) &&
        Objects.equals(this.manufacturer, devicePoolCompatibilityResultDevice.manufacturer) &&
        Objects.equals(this.model, devicePoolCompatibilityResultDevice.model) &&
        Objects.equals(this.modelId, devicePoolCompatibilityResultDevice.modelId) &&
        Objects.equals(this.formFactor, devicePoolCompatibilityResultDevice.formFactor) &&
        Objects.equals(this.platform, devicePoolCompatibilityResultDevice.platform) &&
        Objects.equals(this.os, devicePoolCompatibilityResultDevice.os) &&
        Objects.equals(this.cpu, devicePoolCompatibilityResultDevice.cpu) &&
        Objects.equals(this.resolution, devicePoolCompatibilityResultDevice.resolution) &&
        Objects.equals(this.heapSize, devicePoolCompatibilityResultDevice.heapSize) &&
        Objects.equals(this.memory, devicePoolCompatibilityResultDevice.memory) &&
        Objects.equals(this.image, devicePoolCompatibilityResultDevice.image) &&
        Objects.equals(this.carrier, devicePoolCompatibilityResultDevice.carrier) &&
        Objects.equals(this.radio, devicePoolCompatibilityResultDevice.radio) &&
        Objects.equals(this.remoteAccessEnabled, devicePoolCompatibilityResultDevice.remoteAccessEnabled) &&
        Objects.equals(this.remoteDebugEnabled, devicePoolCompatibilityResultDevice.remoteDebugEnabled) &&
        Objects.equals(this.fleetType, devicePoolCompatibilityResultDevice.fleetType) &&
        Objects.equals(this.fleetName, devicePoolCompatibilityResultDevice.fleetName) &&
        Objects.equals(this.instances, devicePoolCompatibilityResultDevice.instances) &&
        Objects.equals(this.availability, devicePoolCompatibilityResultDevice.availability);
  }
  ...
  public String toString() {
    ...
    sb.append("class DevicePoolCompatibilityResultDevice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DevicePoolCompatibilityResultDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DevicePoolCompatibilityResultDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DevicePoolCompatibilityResultDevice is not found in the empty JSON string", DevicePoolCompatibilityResultDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DevicePoolCompatibilityResultDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DevicePoolCompatibilityResultDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DevicePoolCompatibilityResultDevice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DevicePoolCompatibilityResultDevice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DevicePoolCompatibilityResultDevice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DevicePoolCompatibilityResultDevice.class));

       return (TypeAdapter<T>) new TypeAdapter<DevicePoolCompatibilityResultDevice>() {
           @Override
           public void write(JsonWriter out, DevicePoolCompatibilityResultDevice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DevicePoolCompatibilityResultDevice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DevicePoolCompatibilityResultDevice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DevicePoolCompatibilityResultDevice
   * @throws IOException if the JSON string is invalid with respect to DevicePoolCompatibilityResultDevice
   */
  public static DevicePoolCompatibilityResultDevice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DevicePoolCompatibilityResultDevice.class);
  }

  /**
   * Convert an instance of DevicePoolCompatibilityResultDevice to an JSON string
   *
   * @return JSON string
   */
