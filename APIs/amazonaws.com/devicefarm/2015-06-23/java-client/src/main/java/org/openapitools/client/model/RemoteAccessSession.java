...
public class RemoteAccessSession {
  ...
  public RemoteAccessSession arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RemoteAccessSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RemoteAccessSession created(OffsetDateTime created) {
  ...
  public RemoteAccessSession status(ExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RemoteAccessSession result(ExecutionResult result) {
    this.result = result;
    return this;
  }
  ...
  public RemoteAccessSession message(String message) {
  ...
  public RemoteAccessSession started(OffsetDateTime started) {
  ...
  public RemoteAccessSession stopped(OffsetDateTime stopped) {
  ...
  public RemoteAccessSession device(RemoteAccessSessionDevice device) {
    this.device = device;
    return this;
  }
  ...
  public RemoteAccessSession instanceArn(String instanceArn) {
  ...
  public RemoteAccessSession remoteDebugEnabled(Boolean remoteDebugEnabled) {
  ...
  public RemoteAccessSession remoteRecordEnabled(Boolean remoteRecordEnabled) {
  ...
  public RemoteAccessSession remoteRecordAppArn(String remoteRecordAppArn) {
  ...
  public RemoteAccessSession hostAddress(String hostAddress) {
  ...
  public RemoteAccessSession clientId(String clientId) {
  ...
  public RemoteAccessSession billingMethod(BillingMethod billingMethod) {
  ...
  public RemoteAccessSession deviceMinutes(RemoteAccessSessionDeviceMinutes deviceMinutes) {
  ...
  public RemoteAccessSession endpoint(String endpoint) {
  ...
  public RemoteAccessSession deviceUdid(String deviceUdid) {
  ...
  public RemoteAccessSession interactionMode(InteractionMode interactionMode) {
  ...
  public RemoteAccessSession skipAppResign(Boolean skipAppResign) {
  ...
  public RemoteAccessSession vpcConfig(CreateProjectRequestVpcConfig vpcConfig) {
  ...
  public boolean equals(Object o) {
    ...
    RemoteAccessSession remoteAccessSession = (RemoteAccessSession) o;
    return Objects.equals(this.arn, remoteAccessSession.arn) &&
        Objects.equals(this.name, remoteAccessSession.name) &&
        Objects.equals(this.created, remoteAccessSession.created) &&
        Objects.equals(this.status, remoteAccessSession.status) &&
        Objects.equals(this.result, remoteAccessSession.result) &&
        Objects.equals(this.message, remoteAccessSession.message) &&
        Objects.equals(this.started, remoteAccessSession.started) &&
        Objects.equals(this.stopped, remoteAccessSession.stopped) &&
        Objects.equals(this.device, remoteAccessSession.device) &&
        Objects.equals(this.instanceArn, remoteAccessSession.instanceArn) &&
        Objects.equals(this.remoteDebugEnabled, remoteAccessSession.remoteDebugEnabled) &&
        Objects.equals(this.remoteRecordEnabled, remoteAccessSession.remoteRecordEnabled) &&
        Objects.equals(this.remoteRecordAppArn, remoteAccessSession.remoteRecordAppArn) &&
        Objects.equals(this.hostAddress, remoteAccessSession.hostAddress) &&
        Objects.equals(this.clientId, remoteAccessSession.clientId) &&
        Objects.equals(this.billingMethod, remoteAccessSession.billingMethod) &&
        Objects.equals(this.deviceMinutes, remoteAccessSession.deviceMinutes) &&
        Objects.equals(this.endpoint, remoteAccessSession.endpoint) &&
        Objects.equals(this.deviceUdid, remoteAccessSession.deviceUdid) &&
        Objects.equals(this.interactionMode, remoteAccessSession.interactionMode) &&
        Objects.equals(this.skipAppResign, remoteAccessSession.skipAppResign) &&
        Objects.equals(this.vpcConfig, remoteAccessSession.vpcConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoteAccessSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoteAccessSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoteAccessSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoteAccessSession is not found in the empty JSON string", RemoteAccessSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoteAccessSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoteAccessSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoteAccessSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoteAccessSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoteAccessSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoteAccessSession.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoteAccessSession>() {
           @Override
           public void write(JsonWriter out, RemoteAccessSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoteAccessSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoteAccessSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoteAccessSession
   * @throws IOException if the JSON string is invalid with respect to RemoteAccessSession
   */
  public static RemoteAccessSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoteAccessSession.class);
  }

  /**
   * Convert an instance of RemoteAccessSession to an JSON string
   *
   * @return JSON string
   */
