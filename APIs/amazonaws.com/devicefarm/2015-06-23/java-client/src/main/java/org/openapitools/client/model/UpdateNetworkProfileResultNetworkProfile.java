...
public class UpdateNetworkProfileResultNetworkProfile {
  ...
  public UpdateNetworkProfileResultNetworkProfile() {
  }

  public UpdateNetworkProfileResultNetworkProfile arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateNetworkProfileResultNetworkProfile name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateNetworkProfileResultNetworkProfile description(String description) {
  ...
  public UpdateNetworkProfileResultNetworkProfile type(NetworkProfileType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateNetworkProfileResultNetworkProfile uplinkBandwidthBits(Integer uplinkBandwidthBits) {
  ...
  public UpdateNetworkProfileResultNetworkProfile downlinkBandwidthBits(Integer downlinkBandwidthBits) {
  ...
  public UpdateNetworkProfileResultNetworkProfile uplinkDelayMs(Integer uplinkDelayMs) {
  ...
  public UpdateNetworkProfileResultNetworkProfile downlinkDelayMs(Integer downlinkDelayMs) {
  ...
  public UpdateNetworkProfileResultNetworkProfile uplinkJitterMs(Integer uplinkJitterMs) {
  ...
  public UpdateNetworkProfileResultNetworkProfile downlinkJitterMs(Integer downlinkJitterMs) {
  ...
  public UpdateNetworkProfileResultNetworkProfile uplinkLossPercent(Integer uplinkLossPercent) {
  ...
  public UpdateNetworkProfileResultNetworkProfile downlinkLossPercent(Integer downlinkLossPercent) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkProfileResultNetworkProfile updateNetworkProfileResultNetworkProfile = (UpdateNetworkProfileResultNetworkProfile) o;
    return Objects.equals(this.arn, updateNetworkProfileResultNetworkProfile.arn) &&
        Objects.equals(this.name, updateNetworkProfileResultNetworkProfile.name) &&
        Objects.equals(this.description, updateNetworkProfileResultNetworkProfile.description) &&
        Objects.equals(this.type, updateNetworkProfileResultNetworkProfile.type) &&
        Objects.equals(this.uplinkBandwidthBits, updateNetworkProfileResultNetworkProfile.uplinkBandwidthBits) &&
        Objects.equals(this.downlinkBandwidthBits, updateNetworkProfileResultNetworkProfile.downlinkBandwidthBits) &&
        Objects.equals(this.uplinkDelayMs, updateNetworkProfileResultNetworkProfile.uplinkDelayMs) &&
        Objects.equals(this.downlinkDelayMs, updateNetworkProfileResultNetworkProfile.downlinkDelayMs) &&
        Objects.equals(this.uplinkJitterMs, updateNetworkProfileResultNetworkProfile.uplinkJitterMs) &&
        Objects.equals(this.downlinkJitterMs, updateNetworkProfileResultNetworkProfile.downlinkJitterMs) &&
        Objects.equals(this.uplinkLossPercent, updateNetworkProfileResultNetworkProfile.uplinkLossPercent) &&
        Objects.equals(this.downlinkLossPercent, updateNetworkProfileResultNetworkProfile.downlinkLossPercent);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNetworkProfileResultNetworkProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkProfileResultNetworkProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkProfileResultNetworkProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkProfileResultNetworkProfile is not found in the empty JSON string", UpdateNetworkProfileResultNetworkProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkProfileResultNetworkProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkProfileResultNetworkProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkProfileResultNetworkProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkProfileResultNetworkProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkProfileResultNetworkProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkProfileResultNetworkProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkProfileResultNetworkProfile>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkProfileResultNetworkProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkProfileResultNetworkProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkProfileResultNetworkProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkProfileResultNetworkProfile
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkProfileResultNetworkProfile
   */
  public static UpdateNetworkProfileResultNetworkProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkProfileResultNetworkProfile.class);
  }

  /**
   * Convert an instance of UpdateNetworkProfileResultNetworkProfile to an JSON string
   *
   * @return JSON string
   */
