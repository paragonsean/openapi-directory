...
public class ScheduleRunRequestConfiguration {
  ...
  public ScheduleRunRequestConfiguration() {
  }

  public ScheduleRunRequestConfiguration extraDataPackageArn(String extraDataPackageArn) {
  ...
  public ScheduleRunRequestConfiguration networkProfileArn(String networkProfileArn) {
  ...
  public ScheduleRunRequestConfiguration locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public ScheduleRunRequestConfiguration location(ScheduleRunConfigurationLocation location) {
  ...
  public ScheduleRunRequestConfiguration vpceConfigurationArns(List vpceConfigurationArns) {
  ...
  public ScheduleRunRequestConfiguration customerArtifactPaths(ScheduleRunConfigurationCustomerArtifactPaths customerArtifactPaths) {
  ...
  public ScheduleRunRequestConfiguration radios(ScheduleRunConfigurationRadios radios) {
    this.radios = radios;
    return this;
  }
  ...
  public ScheduleRunRequestConfiguration auxiliaryApps(List auxiliaryApps) {
  ...
  public ScheduleRunRequestConfiguration billingMethod(BillingMethod billingMethod) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleRunRequestConfiguration scheduleRunRequestConfiguration = (ScheduleRunRequestConfiguration) o;
    return Objects.equals(this.extraDataPackageArn, scheduleRunRequestConfiguration.extraDataPackageArn) &&
        Objects.equals(this.networkProfileArn, scheduleRunRequestConfiguration.networkProfileArn) &&
        Objects.equals(this.locale, scheduleRunRequestConfiguration.locale) &&
        Objects.equals(this.location, scheduleRunRequestConfiguration.location) &&
        Objects.equals(this.vpceConfigurationArns, scheduleRunRequestConfiguration.vpceConfigurationArns) &&
        Objects.equals(this.customerArtifactPaths, scheduleRunRequestConfiguration.customerArtifactPaths) &&
        Objects.equals(this.radios, scheduleRunRequestConfiguration.radios) &&
        Objects.equals(this.auxiliaryApps, scheduleRunRequestConfiguration.auxiliaryApps) &&
        Objects.equals(this.billingMethod, scheduleRunRequestConfiguration.billingMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleRunRequestConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleRunRequestConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleRunRequestConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleRunRequestConfiguration is not found in the empty JSON string", ScheduleRunRequestConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleRunRequestConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleRunRequestConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleRunRequestConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleRunRequestConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleRunRequestConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleRunRequestConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleRunRequestConfiguration>() {
           @Override
           public void write(JsonWriter out, ScheduleRunRequestConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleRunRequestConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleRunRequestConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleRunRequestConfiguration
   * @throws IOException if the JSON string is invalid with respect to ScheduleRunRequestConfiguration
   */
  public static ScheduleRunRequestConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleRunRequestConfiguration.class);
  }

  /**
   * Convert an instance of ScheduleRunRequestConfiguration to an JSON string
   *
   * @return JSON string
   */
