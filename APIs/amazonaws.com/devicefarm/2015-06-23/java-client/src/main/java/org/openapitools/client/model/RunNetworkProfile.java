...
public class RunNetworkProfile {
  ...
  public RunNetworkProfile() {
  }

  public RunNetworkProfile arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RunNetworkProfile name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RunNetworkProfile description(String description) {
  ...
  public RunNetworkProfile type(NetworkProfileType type) {
    this.type = type;
    return this;
  }
  ...
  public RunNetworkProfile uplinkBandwidthBits(Integer uplinkBandwidthBits) {
  ...
  public RunNetworkProfile downlinkBandwidthBits(Integer downlinkBandwidthBits) {
  ...
  public RunNetworkProfile uplinkDelayMs(Integer uplinkDelayMs) {
  ...
  public RunNetworkProfile downlinkDelayMs(Integer downlinkDelayMs) {
  ...
  public RunNetworkProfile uplinkJitterMs(Integer uplinkJitterMs) {
  ...
  public RunNetworkProfile downlinkJitterMs(Integer downlinkJitterMs) {
  ...
  public RunNetworkProfile uplinkLossPercent(Integer uplinkLossPercent) {
  ...
  public RunNetworkProfile downlinkLossPercent(Integer downlinkLossPercent) {
  ...
  public boolean equals(Object o) {
    ...
    RunNetworkProfile runNetworkProfile = (RunNetworkProfile) o;
    return Objects.equals(this.arn, runNetworkProfile.arn) &&
        Objects.equals(this.name, runNetworkProfile.name) &&
        Objects.equals(this.description, runNetworkProfile.description) &&
        Objects.equals(this.type, runNetworkProfile.type) &&
        Objects.equals(this.uplinkBandwidthBits, runNetworkProfile.uplinkBandwidthBits) &&
        Objects.equals(this.downlinkBandwidthBits, runNetworkProfile.downlinkBandwidthBits) &&
        Objects.equals(this.uplinkDelayMs, runNetworkProfile.uplinkDelayMs) &&
        Objects.equals(this.downlinkDelayMs, runNetworkProfile.downlinkDelayMs) &&
        Objects.equals(this.uplinkJitterMs, runNetworkProfile.uplinkJitterMs) &&
        Objects.equals(this.downlinkJitterMs, runNetworkProfile.downlinkJitterMs) &&
        Objects.equals(this.uplinkLossPercent, runNetworkProfile.uplinkLossPercent) &&
        Objects.equals(this.downlinkLossPercent, runNetworkProfile.downlinkLossPercent);
  }
  ...
  public String toString() {
    ...
    sb.append("class RunNetworkProfile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunNetworkProfile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunNetworkProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RunNetworkProfile is not found in the empty JSON string", RunNetworkProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunNetworkProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RunNetworkProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunNetworkProfile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunNetworkProfile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunNetworkProfile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunNetworkProfile.class));

       return (TypeAdapter<T>) new TypeAdapter<RunNetworkProfile>() {
           @Override
           public void write(JsonWriter out, RunNetworkProfile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RunNetworkProfile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RunNetworkProfile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunNetworkProfile
   * @throws IOException if the JSON string is invalid with respect to RunNetworkProfile
   */
  public static RunNetworkProfile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunNetworkProfile.class);
  }

  /**
   * Convert an instance of RunNetworkProfile to an JSON string
   *
   * @return JSON string
   */
