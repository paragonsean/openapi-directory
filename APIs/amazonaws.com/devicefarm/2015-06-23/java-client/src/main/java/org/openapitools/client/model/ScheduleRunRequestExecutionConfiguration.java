...
public class ScheduleRunRequestExecutionConfiguration {
  ...
  public ScheduleRunRequestExecutionConfiguration() {
  }

  public ScheduleRunRequestExecutionConfiguration jobTimeoutMinutes(Integer jobTimeoutMinutes) {
  ...
  public ScheduleRunRequestExecutionConfiguration accountsCleanup(Boolean accountsCleanup) {
  ...
  public ScheduleRunRequestExecutionConfiguration appPackagesCleanup(Boolean appPackagesCleanup) {
  ...
  public ScheduleRunRequestExecutionConfiguration videoCapture(Boolean videoCapture) {
  ...
  public ScheduleRunRequestExecutionConfiguration skipAppResign(Boolean skipAppResign) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleRunRequestExecutionConfiguration scheduleRunRequestExecutionConfiguration = (ScheduleRunRequestExecutionConfiguration) o;
    return Objects.equals(this.jobTimeoutMinutes, scheduleRunRequestExecutionConfiguration.jobTimeoutMinutes) &&
        Objects.equals(this.accountsCleanup, scheduleRunRequestExecutionConfiguration.accountsCleanup) &&
        Objects.equals(this.appPackagesCleanup, scheduleRunRequestExecutionConfiguration.appPackagesCleanup) &&
        Objects.equals(this.videoCapture, scheduleRunRequestExecutionConfiguration.videoCapture) &&
        Objects.equals(this.skipAppResign, scheduleRunRequestExecutionConfiguration.skipAppResign);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleRunRequestExecutionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleRunRequestExecutionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleRunRequestExecutionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleRunRequestExecutionConfiguration is not found in the empty JSON string", ScheduleRunRequestExecutionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleRunRequestExecutionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleRunRequestExecutionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleRunRequestExecutionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleRunRequestExecutionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleRunRequestExecutionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleRunRequestExecutionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleRunRequestExecutionConfiguration>() {
           @Override
           public void write(JsonWriter out, ScheduleRunRequestExecutionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleRunRequestExecutionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleRunRequestExecutionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleRunRequestExecutionConfiguration
   * @throws IOException if the JSON string is invalid with respect to ScheduleRunRequestExecutionConfiguration
   */
  public static ScheduleRunRequestExecutionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleRunRequestExecutionConfiguration.class);
  }

  /**
   * Convert an instance of ScheduleRunRequestExecutionConfiguration to an JSON string
   *
   * @return JSON string
   */
