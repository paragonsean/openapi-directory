...
public class ScheduleRunResultRun {
  ...
  public ScheduleRunResultRun() {
  }

  public ScheduleRunResultRun arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ScheduleRunResultRun name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ScheduleRunResultRun type(TestType type) {
    this.type = type;
    return this;
  }
  ...
  public ScheduleRunResultRun platform(DevicePlatform platform) {
  ...
  public ScheduleRunResultRun created(OffsetDateTime created) {
  ...
  public ScheduleRunResultRun status(ExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ScheduleRunResultRun result(ExecutionResult result) {
    this.result = result;
    return this;
  }
  ...
  public ScheduleRunResultRun started(OffsetDateTime started) {
  ...
  public ScheduleRunResultRun stopped(OffsetDateTime stopped) {
  ...
  public ScheduleRunResultRun counters(RunCounters counters) {
  ...
  public ScheduleRunResultRun message(String message) {
  ...
  public ScheduleRunResultRun totalJobs(Integer totalJobs) {
  ...
  public ScheduleRunResultRun completedJobs(Integer completedJobs) {
  ...
  public ScheduleRunResultRun billingMethod(BillingMethod billingMethod) {
  ...
  public ScheduleRunResultRun deviceMinutes(RunDeviceMinutes deviceMinutes) {
  ...
  public ScheduleRunResultRun networkProfile(RunNetworkProfile networkProfile) {
  ...
  public ScheduleRunResultRun parsingResultUrl(String parsingResultUrl) {
  ...
  public ScheduleRunResultRun resultCode(ExecutionResultCode resultCode) {
  ...
  public ScheduleRunResultRun seed(Integer seed) {
    this.seed = seed;
    return this;
  }
  ...
  public ScheduleRunResultRun appUpload(String appUpload) {
  ...
  public ScheduleRunResultRun eventCount(Integer eventCount) {
  ...
  public ScheduleRunResultRun jobTimeoutMinutes(Integer jobTimeoutMinutes) {
  ...
  public ScheduleRunResultRun devicePoolArn(String devicePoolArn) {
  ...
  public ScheduleRunResultRun locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public ScheduleRunResultRun radios(ScheduleRunConfigurationRadios radios) {
    this.radios = radios;
    return this;
  }
  ...
  public ScheduleRunResultRun location(ScheduleRunConfigurationLocation location) {
  ...
  public ScheduleRunResultRun customerArtifactPaths(RunCustomerArtifactPaths customerArtifactPaths) {
  ...
  public ScheduleRunResultRun webUrl(String webUrl) {
    this.webUrl = webUrl;
    return this;
  }
  ...
  public ScheduleRunResultRun skipAppResign(Boolean skipAppResign) {
  ...
  public ScheduleRunResultRun testSpecArn(String testSpecArn) {
  ...
  public ScheduleRunResultRun deviceSelectionResult(RunDeviceSelectionResult deviceSelectionResult) {
  ...
  public ScheduleRunResultRun vpcConfig(CreateProjectRequestVpcConfig vpcConfig) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleRunResultRun scheduleRunResultRun = (ScheduleRunResultRun) o;
    return Objects.equals(this.arn, scheduleRunResultRun.arn) &&
        Objects.equals(this.name, scheduleRunResultRun.name) &&
        Objects.equals(this.type, scheduleRunResultRun.type) &&
        Objects.equals(this.platform, scheduleRunResultRun.platform) &&
        Objects.equals(this.created, scheduleRunResultRun.created) &&
        Objects.equals(this.status, scheduleRunResultRun.status) &&
        Objects.equals(this.result, scheduleRunResultRun.result) &&
        Objects.equals(this.started, scheduleRunResultRun.started) &&
        Objects.equals(this.stopped, scheduleRunResultRun.stopped) &&
        Objects.equals(this.counters, scheduleRunResultRun.counters) &&
        Objects.equals(this.message, scheduleRunResultRun.message) &&
        Objects.equals(this.totalJobs, scheduleRunResultRun.totalJobs) &&
        Objects.equals(this.completedJobs, scheduleRunResultRun.completedJobs) &&
        Objects.equals(this.billingMethod, scheduleRunResultRun.billingMethod) &&
        Objects.equals(this.deviceMinutes, scheduleRunResultRun.deviceMinutes) &&
        Objects.equals(this.networkProfile, scheduleRunResultRun.networkProfile) &&
        Objects.equals(this.parsingResultUrl, scheduleRunResultRun.parsingResultUrl) &&
        Objects.equals(this.resultCode, scheduleRunResultRun.resultCode) &&
        Objects.equals(this.seed, scheduleRunResultRun.seed) &&
        Objects.equals(this.appUpload, scheduleRunResultRun.appUpload) &&
        Objects.equals(this.eventCount, scheduleRunResultRun.eventCount) &&
        Objects.equals(this.jobTimeoutMinutes, scheduleRunResultRun.jobTimeoutMinutes) &&
        Objects.equals(this.devicePoolArn, scheduleRunResultRun.devicePoolArn) &&
        Objects.equals(this.locale, scheduleRunResultRun.locale) &&
        Objects.equals(this.radios, scheduleRunResultRun.radios) &&
        Objects.equals(this.location, scheduleRunResultRun.location) &&
        Objects.equals(this.customerArtifactPaths, scheduleRunResultRun.customerArtifactPaths) &&
        Objects.equals(this.webUrl, scheduleRunResultRun.webUrl) &&
        Objects.equals(this.skipAppResign, scheduleRunResultRun.skipAppResign) &&
        Objects.equals(this.testSpecArn, scheduleRunResultRun.testSpecArn) &&
        Objects.equals(this.deviceSelectionResult, scheduleRunResultRun.deviceSelectionResult) &&
        Objects.equals(this.vpcConfig, scheduleRunResultRun.vpcConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleRunResultRun {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleRunResultRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleRunResultRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleRunResultRun is not found in the empty JSON string", ScheduleRunResultRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleRunResultRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleRunResultRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleRunResultRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleRunResultRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleRunResultRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleRunResultRun.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleRunResultRun>() {
           @Override
           public void write(JsonWriter out, ScheduleRunResultRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleRunResultRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleRunResultRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleRunResultRun
   * @throws IOException if the JSON string is invalid with respect to ScheduleRunResultRun
   */
  public static ScheduleRunResultRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleRunResultRun.class);
  }

  /**
   * Convert an instance of ScheduleRunResultRun to an JSON string
   *
   * @return JSON string
   */
