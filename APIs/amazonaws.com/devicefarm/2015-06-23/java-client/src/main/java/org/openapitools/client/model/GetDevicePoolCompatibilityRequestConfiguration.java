...
public class GetDevicePoolCompatibilityRequestConfiguration {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration() {
  }

  public GetDevicePoolCompatibilityRequestConfiguration extraDataPackageArn(String extraDataPackageArn) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration networkProfileArn(String networkProfileArn) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration locale(String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public GetDevicePoolCompatibilityRequestConfiguration location(ScheduleRunConfigurationLocation location) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration vpceConfigurationArns(List vpceConfigurationArns) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration customerArtifactPaths(ScheduleRunConfigurationCustomerArtifactPaths customerArtifactPaths) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration radios(ScheduleRunConfigurationRadios radios) {
    this.radios = radios;
    return this;
  }
  ...
  public GetDevicePoolCompatibilityRequestConfiguration auxiliaryApps(List auxiliaryApps) {
  ...
  public GetDevicePoolCompatibilityRequestConfiguration billingMethod(BillingMethod billingMethod) {
  ...
  public boolean equals(Object o) {
    ...
    GetDevicePoolCompatibilityRequestConfiguration getDevicePoolCompatibilityRequestConfiguration = (GetDevicePoolCompatibilityRequestConfiguration) o;
    return Objects.equals(this.extraDataPackageArn, getDevicePoolCompatibilityRequestConfiguration.extraDataPackageArn) &&
        Objects.equals(this.networkProfileArn, getDevicePoolCompatibilityRequestConfiguration.networkProfileArn) &&
        Objects.equals(this.locale, getDevicePoolCompatibilityRequestConfiguration.locale) &&
        Objects.equals(this.location, getDevicePoolCompatibilityRequestConfiguration.location) &&
        Objects.equals(this.vpceConfigurationArns, getDevicePoolCompatibilityRequestConfiguration.vpceConfigurationArns) &&
        Objects.equals(this.customerArtifactPaths, getDevicePoolCompatibilityRequestConfiguration.customerArtifactPaths) &&
        Objects.equals(this.radios, getDevicePoolCompatibilityRequestConfiguration.radios) &&
        Objects.equals(this.auxiliaryApps, getDevicePoolCompatibilityRequestConfiguration.auxiliaryApps) &&
        Objects.equals(this.billingMethod, getDevicePoolCompatibilityRequestConfiguration.billingMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDevicePoolCompatibilityRequestConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDevicePoolCompatibilityRequestConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDevicePoolCompatibilityRequestConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDevicePoolCompatibilityRequestConfiguration is not found in the empty JSON string", GetDevicePoolCompatibilityRequestConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDevicePoolCompatibilityRequestConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDevicePoolCompatibilityRequestConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDevicePoolCompatibilityRequestConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDevicePoolCompatibilityRequestConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDevicePoolCompatibilityRequestConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDevicePoolCompatibilityRequestConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDevicePoolCompatibilityRequestConfiguration>() {
           @Override
           public void write(JsonWriter out, GetDevicePoolCompatibilityRequestConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDevicePoolCompatibilityRequestConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDevicePoolCompatibilityRequestConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDevicePoolCompatibilityRequestConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetDevicePoolCompatibilityRequestConfiguration
   */
  public static GetDevicePoolCompatibilityRequestConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDevicePoolCompatibilityRequestConfiguration.class);
  }

  /**
   * Convert an instance of GetDevicePoolCompatibilityRequestConfiguration to an JSON string
   *
   * @return JSON string
   */
