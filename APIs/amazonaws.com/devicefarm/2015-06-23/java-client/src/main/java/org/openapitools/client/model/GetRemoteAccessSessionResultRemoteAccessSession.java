...
public class GetRemoteAccessSessionResultRemoteAccessSession {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession() {
  }

  public GetRemoteAccessSessionResultRemoteAccessSession arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession created(OffsetDateTime created) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession status(ExecutionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession result(ExecutionResult result) {
    this.result = result;
    return this;
  }
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession message(String message) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession started(OffsetDateTime started) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession stopped(OffsetDateTime stopped) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession device(RemoteAccessSessionDevice device) {
    this.device = device;
    return this;
  }
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession instanceArn(String instanceArn) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession remoteDebugEnabled(Boolean remoteDebugEnabled) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession remoteRecordEnabled(Boolean remoteRecordEnabled) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession remoteRecordAppArn(String remoteRecordAppArn) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession hostAddress(String hostAddress) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession clientId(String clientId) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession billingMethod(BillingMethod billingMethod) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession deviceMinutes(RemoteAccessSessionDeviceMinutes deviceMinutes) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession endpoint(String endpoint) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession deviceUdid(String deviceUdid) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession interactionMode(InteractionMode interactionMode) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession skipAppResign(Boolean skipAppResign) {
  ...
  public GetRemoteAccessSessionResultRemoteAccessSession vpcConfig(CreateProjectRequestVpcConfig vpcConfig) {
  ...
  public boolean equals(Object o) {
    ...
    GetRemoteAccessSessionResultRemoteAccessSession getRemoteAccessSessionResultRemoteAccessSession = (GetRemoteAccessSessionResultRemoteAccessSession) o;
    return Objects.equals(this.arn, getRemoteAccessSessionResultRemoteAccessSession.arn) &&
        Objects.equals(this.name, getRemoteAccessSessionResultRemoteAccessSession.name) &&
        Objects.equals(this.created, getRemoteAccessSessionResultRemoteAccessSession.created) &&
        Objects.equals(this.status, getRemoteAccessSessionResultRemoteAccessSession.status) &&
        Objects.equals(this.result, getRemoteAccessSessionResultRemoteAccessSession.result) &&
        Objects.equals(this.message, getRemoteAccessSessionResultRemoteAccessSession.message) &&
        Objects.equals(this.started, getRemoteAccessSessionResultRemoteAccessSession.started) &&
        Objects.equals(this.stopped, getRemoteAccessSessionResultRemoteAccessSession.stopped) &&
        Objects.equals(this.device, getRemoteAccessSessionResultRemoteAccessSession.device) &&
        Objects.equals(this.instanceArn, getRemoteAccessSessionResultRemoteAccessSession.instanceArn) &&
        Objects.equals(this.remoteDebugEnabled, getRemoteAccessSessionResultRemoteAccessSession.remoteDebugEnabled) &&
        Objects.equals(this.remoteRecordEnabled, getRemoteAccessSessionResultRemoteAccessSession.remoteRecordEnabled) &&
        Objects.equals(this.remoteRecordAppArn, getRemoteAccessSessionResultRemoteAccessSession.remoteRecordAppArn) &&
        Objects.equals(this.hostAddress, getRemoteAccessSessionResultRemoteAccessSession.hostAddress) &&
        Objects.equals(this.clientId, getRemoteAccessSessionResultRemoteAccessSession.clientId) &&
        Objects.equals(this.billingMethod, getRemoteAccessSessionResultRemoteAccessSession.billingMethod) &&
        Objects.equals(this.deviceMinutes, getRemoteAccessSessionResultRemoteAccessSession.deviceMinutes) &&
        Objects.equals(this.endpoint, getRemoteAccessSessionResultRemoteAccessSession.endpoint) &&
        Objects.equals(this.deviceUdid, getRemoteAccessSessionResultRemoteAccessSession.deviceUdid) &&
        Objects.equals(this.interactionMode, getRemoteAccessSessionResultRemoteAccessSession.interactionMode) &&
        Objects.equals(this.skipAppResign, getRemoteAccessSessionResultRemoteAccessSession.skipAppResign) &&
        Objects.equals(this.vpcConfig, getRemoteAccessSessionResultRemoteAccessSession.vpcConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRemoteAccessSessionResultRemoteAccessSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRemoteAccessSessionResultRemoteAccessSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRemoteAccessSessionResultRemoteAccessSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRemoteAccessSessionResultRemoteAccessSession is not found in the empty JSON string", GetRemoteAccessSessionResultRemoteAccessSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRemoteAccessSessionResultRemoteAccessSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRemoteAccessSessionResultRemoteAccessSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRemoteAccessSessionResultRemoteAccessSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRemoteAccessSessionResultRemoteAccessSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRemoteAccessSessionResultRemoteAccessSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRemoteAccessSessionResultRemoteAccessSession.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRemoteAccessSessionResultRemoteAccessSession>() {
           @Override
           public void write(JsonWriter out, GetRemoteAccessSessionResultRemoteAccessSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRemoteAccessSessionResultRemoteAccessSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRemoteAccessSessionResultRemoteAccessSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRemoteAccessSessionResultRemoteAccessSession
   * @throws IOException if the JSON string is invalid with respect to GetRemoteAccessSessionResultRemoteAccessSession
   */
  public static GetRemoteAccessSessionResultRemoteAccessSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRemoteAccessSessionResultRemoteAccessSession.class);
  }

  /**
   * Convert an instance of GetRemoteAccessSessionResultRemoteAccessSession to an JSON string
   *
   * @return JSON string
   */
