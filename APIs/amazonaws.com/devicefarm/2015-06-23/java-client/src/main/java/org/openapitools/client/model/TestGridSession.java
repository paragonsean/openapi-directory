...
public class TestGridSession {
  ...
  public TestGridSession arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public TestGridSession status(TestGridSessionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TestGridSession created(OffsetDateTime created) {
  ...
  public TestGridSession ended(OffsetDateTime ended) {
    this.ended = ended;
    return this;
  }
  ...
  public TestGridSession billingMinutes(Double billingMinutes) {
  ...
  public TestGridSession seleniumProperties(String seleniumProperties) {
  ...
  public boolean equals(Object o) {
    ...
    TestGridSession testGridSession = (TestGridSession) o;
    return Objects.equals(this.arn, testGridSession.arn) &&
        Objects.equals(this.status, testGridSession.status) &&
        Objects.equals(this.created, testGridSession.created) &&
        Objects.equals(this.ended, testGridSession.ended) &&
        Objects.equals(this.billingMinutes, testGridSession.billingMinutes) &&
        Objects.equals(this.seleniumProperties, testGridSession.seleniumProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestGridSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestGridSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestGridSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestGridSession is not found in the empty JSON string", TestGridSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestGridSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestGridSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestGridSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestGridSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestGridSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestGridSession.class));

       return (TypeAdapter<T>) new TypeAdapter<TestGridSession>() {
           @Override
           public void write(JsonWriter out, TestGridSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestGridSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestGridSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestGridSession
   * @throws IOException if the JSON string is invalid with respect to TestGridSession
   */
  public static TestGridSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestGridSession.class);
  }

  /**
   * Convert an instance of TestGridSession to an JSON string
   *
   * @return JSON string
   */
