...
public class CPU {
  ...
  public CPU frequency(String frequency) {
  ...
  public CPU architecture(String architecture) {
  ...
  public boolean equals(Object o) {
    ...
    CPU CPU = (CPU) o;
    return Objects.equals(this.frequency, CPU.frequency) &&
        Objects.equals(this.architecture, CPU.architecture) &&
        Objects.equals(this.clock, CPU.clock);
  }

  @Override
  public int hashCode() {
    return Objects.hash(frequency, architecture, clock);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("frequency") != null && !jsonObj.get("frequency").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("frequency"));
      }
      ...
      if (jsonObj.get("clock") != null && !jsonObj.get("clock").isJsonNull()) {
        Double.validateJsonElement(jsonObj.get("clock"));
      }
  }
