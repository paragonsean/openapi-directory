...
class DeleteProjectRequest(Model):
    ...
    def __init__(self, arn: str=None):
        ...
        :param arn: The arn of this DeleteProjectRequest.
        """
        self.openapi_types = {
            'arn': str
        }
    ...
    @property
    def arn(self):
        """Gets the arn of this DeleteProjectRequest.


        :return: The arn of this DeleteProjectRequest.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this DeleteProjectRequest.
