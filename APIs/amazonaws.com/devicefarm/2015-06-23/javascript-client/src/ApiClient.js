...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://devicefarm.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://devicefarm.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-06-23/Javascript'
        };
