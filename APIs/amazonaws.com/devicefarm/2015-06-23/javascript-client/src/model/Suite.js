...
/**
 * The Suite model module.
 * @module model/Suite
 * @version 2015-06-23
 */
class Suite {
    /**
     * Constructs a new <code>Suite</code>.
     * Represents a collection of one or more tests.
     * @alias module:model/Suite
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Suite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Suite} obj Optional instance to populate.
     * @return {module:model/Suite} The populated <code>Suite</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Suite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Suite</code>.
     */
