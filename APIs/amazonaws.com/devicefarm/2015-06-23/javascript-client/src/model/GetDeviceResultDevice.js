...
/**
 * The GetDeviceResultDevice model module.
 * @module model/GetDeviceResultDevice
 * @version 2015-06-23
 */
class GetDeviceResultDevice {
    /**
     * Constructs a new <code>GetDeviceResultDevice</code>.
     * @alias module:model/GetDeviceResultDevice
     * @implements module:model/Device
     */
    constructor() { 
        Device.initialize(this);
        GetDeviceResultDevice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDeviceResultDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDeviceResultDevice} obj Optional instance to populate.
     * @return {module:model/GetDeviceResultDevice} The populated <code>GetDeviceResultDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDeviceResultDevice();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDeviceResultDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDeviceResultDevice</code>.
     */
 ...
 * @member {String} arn
 */
GetDeviceResultDevice.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
GetDeviceResultDevice.prototype['name'] = undefined;

/**
 * @member {String} manufacturer
 */
GetDeviceResultDevice.prototype['manufacturer'] = undefined;

/**
 * @member {String} model
 */
GetDeviceResultDevice.prototype['model'] = undefined;

/**
 * @member {String} modelId
 */
GetDeviceResultDevice.prototype['modelId'] = undefined;

/**
 * @member {module:model/DeviceFormFactor} formFactor
 */
GetDeviceResultDevice.prototype['formFactor'] = undefined;

/**
 * @member {module:model/DevicePlatform} platform
 */
GetDeviceResultDevice.prototype['platform'] = undefined;

/**
 * @member {String} os
 */
GetDeviceResultDevice.prototype['os'] = undefined;

/**
 * @member {module:model/DeviceCpu} cpu
 */
GetDeviceResultDevice.prototype['cpu'] = undefined;

/**
 * @member {module:model/DeviceResolution} resolution
 */
GetDeviceResultDevice.prototype['resolution'] = undefined;

/**
 * @member {Number} heapSize
 */
GetDeviceResultDevice.prototype['heapSize'] = undefined;

/**
 * @member {Number} memory
 */
GetDeviceResultDevice.prototype['memory'] = undefined;

/**
 * @member {String} image
 */
GetDeviceResultDevice.prototype['image'] = undefined;

/**
 * @member {String} carrier
 */
GetDeviceResultDevice.prototype['carrier'] = undefined;

/**
 * @member {String} radio
 */
GetDeviceResultDevice.prototype['radio'] = undefined;

/**
 * @member {Boolean} remoteAccessEnabled
 */
GetDeviceResultDevice.prototype['remoteAccessEnabled'] = undefined;

/**
 * @member {Boolean} remoteDebugEnabled
 */
GetDeviceResultDevice.prototype['remoteDebugEnabled'] = undefined;

/**
 * @member {String} fleetType
 */
GetDeviceResultDevice.prototype['fleetType'] = undefined;

/**
 * @member {String} fleetName
 */
GetDeviceResultDevice.prototype['fleetName'] = undefined;

/**
 * @member {Array} instances
 */
GetDeviceResultDevice.prototype['instances'] = undefined;

/**
 * @member {module:model/DeviceAvailability} availability
 */
GetDeviceResultDevice.prototype['availability'] = undefined;
...
export default GetDeviceResultDevice;
