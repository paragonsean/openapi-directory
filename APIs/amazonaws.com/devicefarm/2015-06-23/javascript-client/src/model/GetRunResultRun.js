...
/**
 * The GetRunResultRun model module.
 * @module model/GetRunResultRun
 * @version 2015-06-23
 */
class GetRunResultRun {
    /**
     * Constructs a new <code>GetRunResultRun</code>.
     * @alias module:model/GetRunResultRun
     * @implements module:model/Run
     */
    constructor() { 
        Run.initialize(this);
        GetRunResultRun.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRunResultRun</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRunResultRun} obj Optional instance to populate.
     * @return {module:model/GetRunResultRun} The populated <code>GetRunResultRun</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRunResultRun();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRunResultRun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRunResultRun</code>.
     */
 ...
 * @member {String} arn
 */
GetRunResultRun.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
GetRunResultRun.prototype['name'] = undefined;

/**
 * @member {module:model/TestType} type
 */
GetRunResultRun.prototype['type'] = undefined;

/**
 * @member {module:model/DevicePlatform} platform
 */
GetRunResultRun.prototype['platform'] = undefined;

/**
 * @member {Date} created
 */
GetRunResultRun.prototype['created'] = undefined;

/**
 * @member {module:model/ExecutionStatus} status
 */
GetRunResultRun.prototype['status'] = undefined;

/**
 * @member {module:model/ExecutionResult} result
 */
GetRunResultRun.prototype['result'] = undefined;

/**
 * @member {Date} started
 */
GetRunResultRun.prototype['started'] = undefined;

/**
 * @member {Date} stopped
 */
GetRunResultRun.prototype['stopped'] = undefined;

/**
 * @member {module:model/RunCounters} counters
 */
GetRunResultRun.prototype['counters'] = undefined;

/**
 * @member {String} message
 */
GetRunResultRun.prototype['message'] = undefined;

/**
 * @member {Number} totalJobs
 */
GetRunResultRun.prototype['totalJobs'] = undefined;

/**
 * @member {Number} completedJobs
 */
GetRunResultRun.prototype['completedJobs'] = undefined;

/**
 * @member {module:model/BillingMethod} billingMethod
 */
GetRunResultRun.prototype['billingMethod'] = undefined;

/**
 * @member {module:model/RunDeviceMinutes} deviceMinutes
 */
GetRunResultRun.prototype['deviceMinutes'] = undefined;

/**
 * @member {module:model/RunNetworkProfile} networkProfile
 */
GetRunResultRun.prototype['networkProfile'] = undefined;

/**
 * @member {String} parsingResultUrl
 */
GetRunResultRun.prototype['parsingResultUrl'] = undefined;

/**
 * @member {module:model/ExecutionResultCode} resultCode
 */
GetRunResultRun.prototype['resultCode'] = undefined;

/**
 * @member {Number} seed
 */
GetRunResultRun.prototype['seed'] = undefined;

/**
 * @member {String} appUpload
 */
GetRunResultRun.prototype['appUpload'] = undefined;

/**
 * @member {Number} eventCount
 */
GetRunResultRun.prototype['eventCount'] = undefined;

/**
 * @member {Number} jobTimeoutMinutes
 */
GetRunResultRun.prototype['jobTimeoutMinutes'] = undefined;

/**
 * @member {String} devicePoolArn
 */
GetRunResultRun.prototype['devicePoolArn'] = undefined;

/**
 * @member {String} locale
 */
GetRunResultRun.prototype['locale'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationRadios} radios
 */
GetRunResultRun.prototype['radios'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationLocation} location
 */
GetRunResultRun.prototype['location'] = undefined;

/**
 * @member {module:model/RunCustomerArtifactPaths} customerArtifactPaths
 */
GetRunResultRun.prototype['customerArtifactPaths'] = undefined;

/**
 * @member {String} webUrl
 */
GetRunResultRun.prototype['webUrl'] = undefined;

/**
 * @member {Boolean} skipAppResign
 */
GetRunResultRun.prototype['skipAppResign'] = undefined;

/**
 * @member {String} testSpecArn
 */
GetRunResultRun.prototype['testSpecArn'] = undefined;

/**
 * @member {module:model/RunDeviceSelectionResult} deviceSelectionResult
 */
GetRunResultRun.prototype['deviceSelectionResult'] = undefined;

/**
 * @member {module:model/CreateProjectRequestVpcConfig} vpcConfig
 */
GetRunResultRun.prototype['vpcConfig'] = undefined;
...
export default GetRunResultRun;
