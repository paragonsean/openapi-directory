...
/**
 * The DevicePool model module.
 * @module model/DevicePool
 * @version 2015-06-23
 */
class DevicePool {
    /**
     * Constructs a new <code>DevicePool</code>.
     * Represents a collection of device types.
     * @alias module:model/DevicePool
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DevicePool</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DevicePool} obj Optional instance to populate.
     * @return {module:model/DevicePool} The populated <code>DevicePool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DevicePool();
    ...
    /**
     * Validates the JSON data with respect to <code>DevicePool</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DevicePool</code>.
     */
