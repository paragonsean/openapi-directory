...
export default class DeviceAttribute {
    ...
    /**
    * Returns a <code>DeviceAttribute</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeviceAttribute} The enum <code>DeviceAttribute</code> value.
    */
