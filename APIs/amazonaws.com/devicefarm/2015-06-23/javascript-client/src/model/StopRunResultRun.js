...
/**
 * The StopRunResultRun model module.
 * @module model/StopRunResultRun
 * @version 2015-06-23
 */
class StopRunResultRun {
    /**
     * Constructs a new <code>StopRunResultRun</code>.
     * @alias module:model/StopRunResultRun
     * @implements module:model/Run
     */
    constructor() { 
        Run.initialize(this);
        StopRunResultRun.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopRunResultRun</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopRunResultRun} obj Optional instance to populate.
     * @return {module:model/StopRunResultRun} The populated <code>StopRunResultRun</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopRunResultRun();
    ...
    /**
     * Validates the JSON data with respect to <code>StopRunResultRun</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopRunResultRun</code>.
     */
 ...
 * @member {String} arn
 */
StopRunResultRun.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
StopRunResultRun.prototype['name'] = undefined;

/**
 * @member {module:model/TestType} type
 */
StopRunResultRun.prototype['type'] = undefined;

/**
 * @member {module:model/DevicePlatform} platform
 */
StopRunResultRun.prototype['platform'] = undefined;

/**
 * @member {Date} created
 */
StopRunResultRun.prototype['created'] = undefined;

/**
 * @member {module:model/ExecutionStatus} status
 */
StopRunResultRun.prototype['status'] = undefined;

/**
 * @member {module:model/ExecutionResult} result
 */
StopRunResultRun.prototype['result'] = undefined;

/**
 * @member {Date} started
 */
StopRunResultRun.prototype['started'] = undefined;

/**
 * @member {Date} stopped
 */
StopRunResultRun.prototype['stopped'] = undefined;

/**
 * @member {module:model/RunCounters} counters
 */
StopRunResultRun.prototype['counters'] = undefined;

/**
 * @member {String} message
 */
StopRunResultRun.prototype['message'] = undefined;

/**
 * @member {Number} totalJobs
 */
StopRunResultRun.prototype['totalJobs'] = undefined;

/**
 * @member {Number} completedJobs
 */
StopRunResultRun.prototype['completedJobs'] = undefined;

/**
 * @member {module:model/BillingMethod} billingMethod
 */
StopRunResultRun.prototype['billingMethod'] = undefined;

/**
 * @member {module:model/RunDeviceMinutes} deviceMinutes
 */
StopRunResultRun.prototype['deviceMinutes'] = undefined;

/**
 * @member {module:model/RunNetworkProfile} networkProfile
 */
StopRunResultRun.prototype['networkProfile'] = undefined;

/**
 * @member {String} parsingResultUrl
 */
StopRunResultRun.prototype['parsingResultUrl'] = undefined;

/**
 * @member {module:model/ExecutionResultCode} resultCode
 */
StopRunResultRun.prototype['resultCode'] = undefined;

/**
 * @member {Number} seed
 */
StopRunResultRun.prototype['seed'] = undefined;

/**
 * @member {String} appUpload
 */
StopRunResultRun.prototype['appUpload'] = undefined;

/**
 * @member {Number} eventCount
 */
StopRunResultRun.prototype['eventCount'] = undefined;

/**
 * @member {Number} jobTimeoutMinutes
 */
StopRunResultRun.prototype['jobTimeoutMinutes'] = undefined;

/**
 * @member {String} devicePoolArn
 */
StopRunResultRun.prototype['devicePoolArn'] = undefined;

/**
 * @member {String} locale
 */
StopRunResultRun.prototype['locale'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationRadios} radios
 */
StopRunResultRun.prototype['radios'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationLocation} location
 */
StopRunResultRun.prototype['location'] = undefined;

/**
 * @member {module:model/RunCustomerArtifactPaths} customerArtifactPaths
 */
StopRunResultRun.prototype['customerArtifactPaths'] = undefined;

/**
 * @member {String} webUrl
 */
StopRunResultRun.prototype['webUrl'] = undefined;

/**
 * @member {Boolean} skipAppResign
 */
StopRunResultRun.prototype['skipAppResign'] = undefined;

/**
 * @member {String} testSpecArn
 */
StopRunResultRun.prototype['testSpecArn'] = undefined;

/**
 * @member {module:model/RunDeviceSelectionResult} deviceSelectionResult
 */
StopRunResultRun.prototype['deviceSelectionResult'] = undefined;

/**
 * @member {module:model/CreateProjectRequestVpcConfig} vpcConfig
 */
StopRunResultRun.prototype['vpcConfig'] = undefined;
...
export default StopRunResultRun;
