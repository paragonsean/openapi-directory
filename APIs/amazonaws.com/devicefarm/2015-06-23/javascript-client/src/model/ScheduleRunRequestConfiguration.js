...
/**
 * The ScheduleRunRequestConfiguration model module.
 * @module model/ScheduleRunRequestConfiguration
 * @version 2015-06-23
 */
class ScheduleRunRequestConfiguration {
    /**
     * Constructs a new <code>ScheduleRunRequestConfiguration</code>.
     * @alias module:model/ScheduleRunRequestConfiguration
     * @implements module:model/ScheduleRunConfiguration
     */
    constructor() { 
        ScheduleRunConfiguration.initialize(this);
        ScheduleRunRequestConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleRunRequestConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleRunRequestConfiguration} obj Optional instance to populate.
     * @return {module:model/ScheduleRunRequestConfiguration} The populated <code>ScheduleRunRequestConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleRunRequestConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleRunRequestConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleRunRequestConfiguration</code>.
     */
 ...
 */
ScheduleRunRequestConfiguration.prototype['extraDataPackageArn'] = undefined;

/**
 * @member {String} networkProfileArn
 */
ScheduleRunRequestConfiguration.prototype['networkProfileArn'] = undefined;

/**
 * @member {String} locale
 */
ScheduleRunRequestConfiguration.prototype['locale'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationLocation} location
 */
ScheduleRunRequestConfiguration.prototype['location'] = undefined;

/**
 * @member {Array} vpceConfigurationArns
 */
ScheduleRunRequestConfiguration.prototype['vpceConfigurationArns'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationCustomerArtifactPaths} customerArtifactPaths
 */
ScheduleRunRequestConfiguration.prototype['customerArtifactPaths'] = undefined;

/**
 * @member {module:model/ScheduleRunConfigurationRadios} radios
 */
ScheduleRunRequestConfiguration.prototype['radios'] = undefined;

/**
 * @member {Array} auxiliaryApps
 */
ScheduleRunRequestConfiguration.prototype['auxiliaryApps'] = undefined;

/**
 * @member {module:model/BillingMethod} billingMethod
 */
ScheduleRunRequestConfiguration.prototype['billingMethod'] = undefined;
...
export default ScheduleRunRequestConfiguration;
