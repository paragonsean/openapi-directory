...
/**
 * The DevicePoolCompatibilityResultDevice model module.
 * @module model/DevicePoolCompatibilityResultDevice
 * @version 2015-06-23
 */
class DevicePoolCompatibilityResultDevice {
    /**
     * Constructs a new <code>DevicePoolCompatibilityResultDevice</code>.
     * @alias module:model/DevicePoolCompatibilityResultDevice
     * @implements module:model/Device
     */
    constructor() { 
        Device.initialize(this);
        DevicePoolCompatibilityResultDevice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DevicePoolCompatibilityResultDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DevicePoolCompatibilityResultDevice} obj Optional instance to populate.
     * @return {module:model/DevicePoolCompatibilityResultDevice} The populated <code>DevicePoolCompatibilityResultDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DevicePoolCompatibilityResultDevice();
    ...
    /**
     * Validates the JSON data with respect to <code>DevicePoolCompatibilityResultDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DevicePoolCompatibilityResultDevice</code>.
     */
 ...
 * @member {String} arn
 */
DevicePoolCompatibilityResultDevice.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
DevicePoolCompatibilityResultDevice.prototype['name'] = undefined;

/**
 * @member {String} manufacturer
 */
DevicePoolCompatibilityResultDevice.prototype['manufacturer'] = undefined;

/**
 * @member {String} model
 */
DevicePoolCompatibilityResultDevice.prototype['model'] = undefined;

/**
 * @member {String} modelId
 */
DevicePoolCompatibilityResultDevice.prototype['modelId'] = undefined;

/**
 * @member {module:model/DeviceFormFactor} formFactor
 */
DevicePoolCompatibilityResultDevice.prototype['formFactor'] = undefined;

/**
 * @member {module:model/DevicePlatform} platform
 */
DevicePoolCompatibilityResultDevice.prototype['platform'] = undefined;

/**
 * @member {String} os
 */
DevicePoolCompatibilityResultDevice.prototype['os'] = undefined;

/**
 * @member {module:model/DeviceCpu} cpu
 */
DevicePoolCompatibilityResultDevice.prototype['cpu'] = undefined;

/**
 * @member {module:model/DeviceResolution} resolution
 */
DevicePoolCompatibilityResultDevice.prototype['resolution'] = undefined;

/**
 * @member {Number} heapSize
 */
DevicePoolCompatibilityResultDevice.prototype['heapSize'] = undefined;

/**
 * @member {Number} memory
 */
DevicePoolCompatibilityResultDevice.prototype['memory'] = undefined;

/**
 * @member {String} image
 */
DevicePoolCompatibilityResultDevice.prototype['image'] = undefined;

/**
 * @member {String} carrier
 */
DevicePoolCompatibilityResultDevice.prototype['carrier'] = undefined;

/**
 * @member {String} radio
 */
DevicePoolCompatibilityResultDevice.prototype['radio'] = undefined;

/**
 * @member {Boolean} remoteAccessEnabled
 */
DevicePoolCompatibilityResultDevice.prototype['remoteAccessEnabled'] = undefined;

/**
 * @member {Boolean} remoteDebugEnabled
 */
DevicePoolCompatibilityResultDevice.prototype['remoteDebugEnabled'] = undefined;

/**
 * @member {String} fleetType
 */
DevicePoolCompatibilityResultDevice.prototype['fleetType'] = undefined;

/**
 * @member {String} fleetName
 */
DevicePoolCompatibilityResultDevice.prototype['fleetName'] = undefined;

/**
 * @member {Array} instances
 */
DevicePoolCompatibilityResultDevice.prototype['instances'] = undefined;

/**
 * @member {module:model/DeviceAvailability} availability
 */
DevicePoolCompatibilityResultDevice.prototype['availability'] = undefined;
...
export default DevicePoolCompatibilityResultDevice;
