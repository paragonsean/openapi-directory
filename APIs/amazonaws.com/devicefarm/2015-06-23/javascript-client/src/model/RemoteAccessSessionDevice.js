...
/**
 * The RemoteAccessSessionDevice model module.
 * @module model/RemoteAccessSessionDevice
 * @version 2015-06-23
 */
class RemoteAccessSessionDevice {
    /**
     * Constructs a new <code>RemoteAccessSessionDevice</code>.
     * @alias module:model/RemoteAccessSessionDevice
     * @implements module:model/Device
     */
    constructor() { 
        Device.initialize(this);
        RemoteAccessSessionDevice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoteAccessSessionDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoteAccessSessionDevice} obj Optional instance to populate.
     * @return {module:model/RemoteAccessSessionDevice} The populated <code>RemoteAccessSessionDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoteAccessSessionDevice();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoteAccessSessionDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoteAccessSessionDevice</code>.
     */
 ...
 * @member {String} arn
 */
RemoteAccessSessionDevice.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
RemoteAccessSessionDevice.prototype['name'] = undefined;

/**
 * @member {String} manufacturer
 */
RemoteAccessSessionDevice.prototype['manufacturer'] = undefined;

/**
 * @member {String} model
 */
RemoteAccessSessionDevice.prototype['model'] = undefined;

/**
 * @member {String} modelId
 */
RemoteAccessSessionDevice.prototype['modelId'] = undefined;

/**
 * @member {module:model/DeviceFormFactor} formFactor
 */
RemoteAccessSessionDevice.prototype['formFactor'] = undefined;

/**
 * @member {module:model/DevicePlatform} platform
 */
RemoteAccessSessionDevice.prototype['platform'] = undefined;

/**
 * @member {String} os
 */
RemoteAccessSessionDevice.prototype['os'] = undefined;

/**
 * @member {module:model/DeviceCpu} cpu
 */
RemoteAccessSessionDevice.prototype['cpu'] = undefined;

/**
 * @member {module:model/DeviceResolution} resolution
 */
RemoteAccessSessionDevice.prototype['resolution'] = undefined;

/**
 * @member {Number} heapSize
 */
RemoteAccessSessionDevice.prototype['heapSize'] = undefined;

/**
 * @member {Number} memory
 */
RemoteAccessSessionDevice.prototype['memory'] = undefined;

/**
 * @member {String} image
 */
RemoteAccessSessionDevice.prototype['image'] = undefined;

/**
 * @member {String} carrier
 */
RemoteAccessSessionDevice.prototype['carrier'] = undefined;

/**
 * @member {String} radio
 */
RemoteAccessSessionDevice.prototype['radio'] = undefined;

/**
 * @member {Boolean} remoteAccessEnabled
 */
RemoteAccessSessionDevice.prototype['remoteAccessEnabled'] = undefined;

/**
 * @member {Boolean} remoteDebugEnabled
 */
RemoteAccessSessionDevice.prototype['remoteDebugEnabled'] = undefined;

/**
 * @member {String} fleetType
 */
RemoteAccessSessionDevice.prototype['fleetType'] = undefined;

/**
 * @member {String} fleetName
 */
RemoteAccessSessionDevice.prototype['fleetName'] = undefined;

/**
 * @member {Array} instances
 */
RemoteAccessSessionDevice.prototype['instances'] = undefined;

/**
 * @member {module:model/DeviceAvailability} availability
 */
RemoteAccessSessionDevice.prototype['availability'] = undefined;
...
export default RemoteAccessSessionDevice;
