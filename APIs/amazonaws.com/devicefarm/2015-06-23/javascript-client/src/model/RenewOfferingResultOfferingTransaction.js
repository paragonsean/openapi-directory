...
/**
 * The RenewOfferingResultOfferingTransaction model module.
 * @module model/RenewOfferingResultOfferingTransaction
 * @version 2015-06-23
 */
class RenewOfferingResultOfferingTransaction {
    /**
     * Constructs a new <code>RenewOfferingResultOfferingTransaction</code>.
     * @alias module:model/RenewOfferingResultOfferingTransaction
     * @implements module:model/OfferingTransaction
     */
    constructor() { 
        OfferingTransaction.initialize(this);
        RenewOfferingResultOfferingTransaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RenewOfferingResultOfferingTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RenewOfferingResultOfferingTransaction} obj Optional instance to populate.
     * @return {module:model/RenewOfferingResultOfferingTransaction} The populated <code>RenewOfferingResultOfferingTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RenewOfferingResultOfferingTransaction();
    ...
    /**
     * Validates the JSON data with respect to <code>RenewOfferingResultOfferingTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RenewOfferingResultOfferingTransaction</code>.
     */
 ...
 */
RenewOfferingResultOfferingTransaction.prototype['offeringStatus'] = undefined;

/**
 * @member {String} transactionId
 */
RenewOfferingResultOfferingTransaction.prototype['transactionId'] = undefined;

/**
 * @member {String} offeringPromotionId
 */
RenewOfferingResultOfferingTransaction.prototype['offeringPromotionId'] = undefined;

/**
 * @member {Date} createdOn
 */
RenewOfferingResultOfferingTransaction.prototype['createdOn'] = undefined;

/**
 * @member {module:model/OfferingTransactionCost} cost
 */
RenewOfferingResultOfferingTransaction.prototype['cost'] = undefined;
...
export default RenewOfferingResultOfferingTransaction;
