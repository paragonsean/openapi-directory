...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.RunCounters();
  });
  ...
  describe('RunCounters', function() {
    it('should create an instance of RunCounters', function() {
      // uncomment below and update the code to test RunCounters
      //var instance = new AwsDeviceFarm.RunCounters();
      //expect(instance).to.be.a(AwsDeviceFarm.RunCounters);
    });
