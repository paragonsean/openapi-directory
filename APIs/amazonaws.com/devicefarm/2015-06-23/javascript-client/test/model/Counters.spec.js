...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.Counters();
  });
  ...
  describe('Counters', function() {
    it('should create an instance of Counters', function() {
      // uncomment below and update the code to test Counters
      //var instance = new AwsDeviceFarm.Counters();
      //expect(instance).to.be.a(AwsDeviceFarm.Counters);
    });
