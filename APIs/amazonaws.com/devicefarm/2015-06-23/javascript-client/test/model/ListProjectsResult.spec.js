...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListProjectsResult();
  });
  ...
  describe('ListProjectsResult', function() {
    it('should create an instance of ListProjectsResult', function() {
      ...
      //var instance = new AwsDeviceFarm.ListProjectsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListProjectsResult);
    });
