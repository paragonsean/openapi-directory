...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.CreateDevicePoolResultDevicePool();
  });
  ...
  describe('CreateDevicePoolResultDevicePool', function() {
    it('should create an instance of CreateDevicePoolResultDevicePool', function() {
      // uncomment below and update the code to test CreateDevicePoolResultDevicePool
      //var instance = new AwsDeviceFarm.CreateDevicePoolResultDevicePool();
      //expect(instance).to.be.a(AwsDeviceFarm.CreateDevicePoolResultDevicePool);
    });
