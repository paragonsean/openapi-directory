...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListUploadsRequest();
  });
  ...
  describe('ListUploadsRequest', function() {
    it('should create an instance of ListUploadsRequest', function() {
      // uncomment below and update the code to test ListUploadsRequest
      //var instance = new AwsDeviceFarm.ListUploadsRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListUploadsRequest);
    });
