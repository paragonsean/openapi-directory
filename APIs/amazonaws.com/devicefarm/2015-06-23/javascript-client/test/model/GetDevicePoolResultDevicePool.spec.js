...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.GetDevicePoolResultDevicePool();
  });
  ...
  describe('GetDevicePoolResultDevicePool', function() {
    it('should create an instance of GetDevicePoolResultDevicePool', function() {
      // uncomment below and update the code to test GetDevicePoolResultDevicePool
      //var instance = new AwsDeviceFarm.GetDevicePoolResultDevicePool();
      //expect(instance).to.be.a(AwsDeviceFarm.GetDevicePoolResultDevicePool);
    });
