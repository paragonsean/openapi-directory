...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListDevicesResult();
  });
  ...
  describe('ListDevicesResult', function() {
    it('should create an instance of ListDevicesResult', function() {
      // uncomment below and update the code to test ListDevicesResult
      //var instance = new AwsDeviceFarm.ListDevicesResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListDevicesResult);
    });
