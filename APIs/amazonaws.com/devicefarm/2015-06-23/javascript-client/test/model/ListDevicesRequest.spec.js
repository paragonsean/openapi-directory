...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListDevicesRequest();
  });
  ...
  describe('ListDevicesRequest', function() {
    it('should create an instance of ListDevicesRequest', function() {
      ...
      //var instance = new AwsDeviceFarm.ListDevicesRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListDevicesRequest);
    });
