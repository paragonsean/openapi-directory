...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListJobsRequest();
  });
  ...
  describe('ListJobsRequest', function() {
    it('should create an instance of ListJobsRequest', function() {
      // uncomment below and update the code to test ListJobsRequest
      //var instance = new AwsDeviceFarm.ListJobsRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListJobsRequest);
    });
