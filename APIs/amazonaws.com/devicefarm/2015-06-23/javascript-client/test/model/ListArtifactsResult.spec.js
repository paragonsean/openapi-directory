...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListArtifactsResult();
  });
  ...
  describe('ListArtifactsResult', function() {
    it('should create an instance of ListArtifactsResult', function() {
      // uncomment below and update the code to test ListArtifactsResult
      //var instance = new AwsDeviceFarm.ListArtifactsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListArtifactsResult);
    });
