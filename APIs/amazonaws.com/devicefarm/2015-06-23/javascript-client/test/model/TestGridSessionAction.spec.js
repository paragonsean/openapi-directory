...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.TestGridSessionAction();
  });
  ...
  describe('TestGridSessionAction', function() {
    it('should create an instance of TestGridSessionAction', function() {
      // uncomment below and update the code to test TestGridSessionAction
      //var instance = new AwsDeviceFarm.TestGridSessionAction();
      //expect(instance).to.be.a(AwsDeviceFarm.TestGridSessionAction);
    });
