...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.JobDevice();
  });
  ...
  describe('JobDevice', function() {
    it('should create an instance of JobDevice', function() {
      // uncomment below and update the code to test JobDevice
      //var instance = new AwsDeviceFarm.JobDevice();
      //expect(instance).to.be.a(AwsDeviceFarm.JobDevice);
    });
