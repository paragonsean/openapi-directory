...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ProblemDevice();
  });
  ...
  describe('ProblemDevice', function() {
    it('should create an instance of ProblemDevice', function() {
      // uncomment below and update the code to test ProblemDevice
      //var instance = new AwsDeviceFarm.ProblemDevice();
      //expect(instance).to.be.a(AwsDeviceFarm.ProblemDevice);
    });
