...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.GetDeviceResultDevice();
  });
  ...
  describe('GetDeviceResultDevice', function() {
    it('should create an instance of GetDeviceResultDevice', function() {
      // uncomment below and update the code to test GetDeviceResultDevice
      //var instance = new AwsDeviceFarm.GetDeviceResultDevice();
      //expect(instance).to.be.a(AwsDeviceFarm.GetDeviceResultDevice);
    });
