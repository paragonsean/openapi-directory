...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.CreateProjectRequestVpcConfig();
  });
  ...
  describe('CreateProjectRequestVpcConfig', function() {
    it('should create an instance of CreateProjectRequestVpcConfig', function() {
      // uncomment below and update the code to test CreateProjectRequestVpcConfig
      //var instance = new AwsDeviceFarm.CreateProjectRequestVpcConfig();
      //expect(instance).to.be.a(AwsDeviceFarm.CreateProjectRequestVpcConfig);
    });
