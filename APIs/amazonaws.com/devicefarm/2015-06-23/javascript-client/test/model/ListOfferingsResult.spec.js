...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListOfferingsResult();
  });
  ...
  describe('ListOfferingsResult', function() {
    it('should create an instance of ListOfferingsResult', function() {
      // uncomment below and update the code to test ListOfferingsResult
      //var instance = new AwsDeviceFarm.ListOfferingsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListOfferingsResult);
    });
