...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListRunsResult();
  });
  ...
  describe('ListRunsResult', function() {
    it('should create an instance of ListRunsResult', function() {
      // uncomment below and update the code to test ListRunsResult
      //var instance = new AwsDeviceFarm.ListRunsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListRunsResult);
    });
