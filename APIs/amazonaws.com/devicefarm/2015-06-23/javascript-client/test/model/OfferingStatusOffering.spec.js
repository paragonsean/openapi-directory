...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.OfferingStatusOffering();
  });
  ...
  describe('OfferingStatusOffering', function() {
    it('should create an instance of OfferingStatusOffering', function() {
      // uncomment below and update the code to test OfferingStatusOffering
      //var instance = new AwsDeviceFarm.OfferingStatusOffering();
      //expect(instance).to.be.a(AwsDeviceFarm.OfferingStatusOffering);
    });
