...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListSuitesRequest();
  });
  ...
  describe('ListSuitesRequest', function() {
    it('should create an instance of ListSuitesRequest', function() {
      // uncomment below and update the code to test ListSuitesRequest
      //var instance = new AwsDeviceFarm.ListSuitesRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListSuitesRequest);
    });
