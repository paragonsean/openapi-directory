...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.SuiteCounters();
  });
  ...
  describe('SuiteCounters', function() {
    it('should create an instance of SuiteCounters', function() {
      // uncomment below and update the code to test SuiteCounters
      //var instance = new AwsDeviceFarm.SuiteCounters();
      //expect(instance).to.be.a(AwsDeviceFarm.SuiteCounters);
    });
