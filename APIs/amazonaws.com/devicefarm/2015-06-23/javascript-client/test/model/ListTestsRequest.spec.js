...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListTestsRequest();
  });
  ...
  describe('ListTestsRequest', function() {
    it('should create an instance of ListTestsRequest', function() {
      // uncomment below and update the code to test ListTestsRequest
      //var instance = new AwsDeviceFarm.ListTestsRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListTestsRequest);
    });
