...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.CreateTestGridProjectRequestVpcConfig();
  });
  ...
  describe('CreateTestGridProjectRequestVpcConfig', function() {
    it('should create an instance of CreateTestGridProjectRequestVpcConfig', function() {
      // uncomment below and update the code to test CreateTestGridProjectRequestVpcConfig
      //var instance = new AwsDeviceFarm.CreateTestGridProjectRequestVpcConfig();
      //expect(instance).to.be.a(AwsDeviceFarm.CreateTestGridProjectRequestVpcConfig);
    });
