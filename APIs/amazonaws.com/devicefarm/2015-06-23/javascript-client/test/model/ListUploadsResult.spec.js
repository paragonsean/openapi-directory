...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListUploadsResult();
  });
  ...
  describe('ListUploadsResult', function() {
    it('should create an instance of ListUploadsResult', function() {
      // uncomment below and update the code to test ListUploadsResult
      //var instance = new AwsDeviceFarm.ListUploadsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListUploadsResult);
    });
