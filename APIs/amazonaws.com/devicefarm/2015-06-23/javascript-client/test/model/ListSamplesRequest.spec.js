...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListSamplesRequest();
  });
  ...
  describe('ListSamplesRequest', function() {
    it('should create an instance of ListSamplesRequest', function() {
      // uncomment below and update the code to test ListSamplesRequest
      //var instance = new AwsDeviceFarm.ListSamplesRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListSamplesRequest);
    });
