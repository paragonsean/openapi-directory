...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.JobCounters();
  });
  ...
  describe('JobCounters', function() {
    it('should create an instance of JobCounters', function() {
      // uncomment below and update the code to test JobCounters
      //var instance = new AwsDeviceFarm.JobCounters();
      //expect(instance).to.be.a(AwsDeviceFarm.JobCounters);
    });
