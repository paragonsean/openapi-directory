...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.TestGridProject();
  });
  ...
  describe('TestGridProject', function() {
    it('should create an instance of TestGridProject', function() {
      // uncomment below and update the code to test TestGridProject
      //var instance = new AwsDeviceFarm.TestGridProject();
      //expect(instance).to.be.a(AwsDeviceFarm.TestGridProject);
    });
