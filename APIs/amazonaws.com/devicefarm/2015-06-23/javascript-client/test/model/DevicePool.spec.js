...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.DevicePool();
  });
  ...
  describe('DevicePool', function() {
    it('should create an instance of DevicePool', function() {
      // uncomment below and update the code to test DevicePool
      //var instance = new AwsDeviceFarm.DevicePool();
      //expect(instance).to.be.a(AwsDeviceFarm.DevicePool);
    });
