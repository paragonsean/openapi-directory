...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.Radios();
  });
  ...
  describe('Radios', function() {
    it('should create an instance of Radios', function() {
      // uncomment below and update the code to test Radios
      //var instance = new AwsDeviceFarm.Radios();
      //expect(instance).to.be.a(AwsDeviceFarm.Radios);
    });
