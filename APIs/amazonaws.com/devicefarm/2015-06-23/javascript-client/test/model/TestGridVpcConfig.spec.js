...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.TestGridVpcConfig();
  });
  ...
  describe('TestGridVpcConfig', function() {
    it('should create an instance of TestGridVpcConfig', function() {
      // uncomment below and update the code to test TestGridVpcConfig
      //var instance = new AwsDeviceFarm.TestGridVpcConfig();
      //expect(instance).to.be.a(AwsDeviceFarm.TestGridVpcConfig);
    });
