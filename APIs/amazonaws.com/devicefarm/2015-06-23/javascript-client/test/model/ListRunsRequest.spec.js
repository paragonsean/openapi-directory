...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListRunsRequest();
  });
  ...
  describe('ListRunsRequest', function() {
    it('should create an instance of ListRunsRequest', function() {
      // uncomment below and update the code to test ListRunsRequest
      //var instance = new AwsDeviceFarm.ListRunsRequest();
      //expect(instance).to.be.a(AwsDeviceFarm.ListRunsRequest);
    });
