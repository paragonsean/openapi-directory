...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListTestsResult();
  });
  ...
  describe('ListTestsResult', function() {
    it('should create an instance of ListTestsResult', function() {
      // uncomment below and update the code to test ListTestsResult
      //var instance = new AwsDeviceFarm.ListTestsResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListTestsResult);
    });
