...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDeviceFarm.ListSamplesResult();
  });
  ...
  describe('ListSamplesResult', function() {
    it('should create an instance of ListSamplesResult', function() {
      // uncomment below and update the code to test ListSamplesResult
      //var instance = new AwsDeviceFarm.ListSamplesResult();
      //expect(instance).to.be.a(AwsDeviceFarm.ListSamplesResult);
    });
