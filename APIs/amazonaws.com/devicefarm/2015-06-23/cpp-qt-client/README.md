...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateDevicePoolRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateDevicePoolRequest Example::create(){
    OAICreateDevicePoolRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createDevicePoolSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createDevicePoolSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateDevicePoolRequest oai_create_device_pool_request = create(); // OAICreateDevicePoolRequest | 
      ...
      apiInstance.createDevicePool(x_amz_targetoai_create_device_pool_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
