...
/*
 * OAIUpdateUploadResult_upload.h
 *
 * 
 */

#ifndef OAIUpdateUploadResult_upload_H
#define OAIUpdateUploadResult_upload_H
...
class OAIUpdateUploadResult_upload : public OAIObject {
public:
    OAIUpdateUploadResult_upload();
    OAIUpdateUploadResult_upload(QString json);
    ~OAIUpdateUploadResult_upload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUploadResult_upload)

#endif // OAIUpdateUploadResult_upload_H
