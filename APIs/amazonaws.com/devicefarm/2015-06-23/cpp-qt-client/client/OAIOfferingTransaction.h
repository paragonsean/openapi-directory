...
/*
 * OAIOfferingTransaction.h
 *
 * Represents the metadata of an offering transaction.
 */

#ifndef OAIOfferingTransaction_H
#define OAIOfferingTransaction_H
...
class OAIOfferingTransaction : public OAIObject {
public:
    OAIOfferingTransaction();
    OAIOfferingTransaction(QString json);
    ~OAIOfferingTransaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingTransaction)

#endif // OAIOfferingTransaction_H
