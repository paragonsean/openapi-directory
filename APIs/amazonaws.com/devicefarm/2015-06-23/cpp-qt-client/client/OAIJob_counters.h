...
#ifndef OAIJob_counters_H
#define OAIJob_counters_H
...
class OAIJob_counters : public OAIObject {
public:
    OAIJob_counters();
    OAIJob_counters(QString json);
    ~OAIJob_counters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJob_counters)

#endif // OAIJob_counters_H
