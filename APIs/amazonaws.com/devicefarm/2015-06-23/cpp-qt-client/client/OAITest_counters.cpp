...
OAITest_counters::OAITest_counters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITest_counters::OAITest_counters() {
    this->initializeModel();
}

OAITest_counters::~OAITest_counters() {}

void OAITest_counters::initializeModel() {
...
void OAITest_counters::fromJson(QString jsonString) {
...
void OAITest_counters::fromJsonObject(QJsonObject json) {
...
QString OAITest_counters::asJson() const {
...
QJsonObject OAITest_counters::asJsonObject() const {
    QJsonObject obj;
    if (m_total_isSet) {
...
qint32 OAITest_counters::getTotal() const {
    return m_total;
}
void OAITest_counters::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAITest_counters::is_total_Set() const{
    return m_total_isSet;
}

bool OAITest_counters::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAITest_counters::getPassed() const {
    return m_passed;
}
void OAITest_counters::setPassed(const qint32 &passed) {
    m_passed = passed;
    m_passed_isSet = true;
}

bool OAITest_counters::is_passed_Set() const{
    return m_passed_isSet;
}

bool OAITest_counters::is_passed_Valid() const{
    return m_passed_isValid;
}

qint32 OAITest_counters::getFailed() const {
    return m_failed;
}
void OAITest_counters::setFailed(const qint32 &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAITest_counters::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAITest_counters::is_failed_Valid() const{
    return m_failed_isValid;
}

qint32 OAITest_counters::getWarned() const {
    return m_warned;
}
void OAITest_counters::setWarned(const qint32 &warned) {
    m_warned = warned;
    m_warned_isSet = true;
}

bool OAITest_counters::is_warned_Set() const{
    return m_warned_isSet;
}

bool OAITest_counters::is_warned_Valid() const{
    return m_warned_isValid;
}

qint32 OAITest_counters::getErrored() const {
    return m_errored;
}
void OAITest_counters::setErrored(const qint32 &errored) {
    m_errored = errored;
    m_errored_isSet = true;
}

bool OAITest_counters::is_errored_Set() const{
    return m_errored_isSet;
}

bool OAITest_counters::is_errored_Valid() const{
    return m_errored_isValid;
}

qint32 OAITest_counters::getStopped() const {
    return m_stopped;
}
void OAITest_counters::setStopped(const qint32 &stopped) {
    m_stopped = stopped;
    m_stopped_isSet = true;
}

bool OAITest_counters::is_stopped_Set() const{
    return m_stopped_isSet;
}

bool OAITest_counters::is_stopped_Valid() const{
    return m_stopped_isValid;
}

qint32 OAITest_counters::getSkipped() const {
    return m_skipped;
}
void OAITest_counters::setSkipped(const qint32 &skipped) {
    m_skipped = skipped;
    m_skipped_isSet = true;
}

bool OAITest_counters::is_skipped_Set() const{
    return m_skipped_isSet;
}

bool OAITest_counters::is_skipped_Valid() const{
    return m_skipped_isValid;
}

bool OAITest_counters::isSet() const {
...
bool OAITest_counters::isValid() const {
