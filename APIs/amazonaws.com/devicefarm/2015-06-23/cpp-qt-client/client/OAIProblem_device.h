...
#ifndef OAIProblem_device_H
#define OAIProblem_device_H
...
class OAIProblem_device : public OAIObject {
public:
    OAIProblem_device();
    OAIProblem_device(QString json);
    ~OAIProblem_device() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProblem_device)

#endif // OAIProblem_device_H
