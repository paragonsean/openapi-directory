...
/*
 * OAIStopRunResult_run.h
 *
 * 
 */

#ifndef OAIStopRunResult_run_H
#define OAIStopRunResult_run_H
...
class OAIStopRunResult_run : public OAIObject {
public:
    OAIStopRunResult_run();
    OAIStopRunResult_run(QString json);
    ~OAIStopRunResult_run() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopRunResult_run)

#endif // OAIStopRunResult_run_H
