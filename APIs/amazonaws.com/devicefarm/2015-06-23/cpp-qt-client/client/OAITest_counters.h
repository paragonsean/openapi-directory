...
#ifndef OAITest_counters_H
#define OAITest_counters_H
...
class OAITest_counters : public OAIObject {
public:
    OAITest_counters();
    OAITest_counters(QString json);
    ~OAITest_counters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITest_counters)

#endif // OAITest_counters_H
