...
#include "OAISuite_counters.h"
#include "OAISuite_deviceMinutes.h"
...
namespace OpenAPI {
class OAISuite_counters;
class OAISuite_deviceMinutes;

class OAISuite : public OAIObject {
public:
    OAISuite();
    OAISuite(QString json);
    ~OAISuite() override;
    ...
    OAISuite_counters getCounters() const;
    void setCounters(const OAISuite_counters &counters);
    ...
    OAISuite_deviceMinutes getDeviceMinutes() const;
    void setDeviceMinutes(const OAISuite_deviceMinutes &device_minutes);
...
private:
    ...
    OAISuite_deviceMinutes m_device_minutes;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuite)
