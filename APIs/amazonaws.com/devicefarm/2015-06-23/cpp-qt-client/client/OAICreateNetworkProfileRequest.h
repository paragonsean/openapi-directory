...
/*
 * OAICreateNetworkProfileRequest.h
 *
 * 
 */

#ifndef OAICreateNetworkProfileRequest_H
#define OAICreateNetworkProfileRequest_H
...
class OAICreateNetworkProfileRequest : public OAIObject {
public:
    OAICreateNetworkProfileRequest();
    OAICreateNetworkProfileRequest(QString json);
    ~OAICreateNetworkProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkProfileRequest)

#endif // OAICreateNetworkProfileRequest_H
