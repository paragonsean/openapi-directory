...
#ifndef OAICounters_H
#define OAICounters_H
...
class OAICounters : public OAIObject {
public:
    OAICounters();
    OAICounters(QString json);
    ~OAICounters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICounters)
