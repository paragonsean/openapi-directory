...
/*
 * OAICreateTestGridProjectRequest_vpcConfig.h
 *
 * 
 */

#ifndef OAICreateTestGridProjectRequest_vpcConfig_H
#define OAICreateTestGridProjectRequest_vpcConfig_H
...
class OAICreateTestGridProjectRequest_vpcConfig : public OAIObject {
public:
    OAICreateTestGridProjectRequest_vpcConfig();
    OAICreateTestGridProjectRequest_vpcConfig(QString json);
    ~OAICreateTestGridProjectRequest_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTestGridProjectRequest_vpcConfig)

#endif // OAICreateTestGridProjectRequest_vpcConfig_H
