...
/*
 * OAIRenewOfferingResult_offeringTransaction.h
 *
 * 
 */

#ifndef OAIRenewOfferingResult_offeringTransaction_H
#define OAIRenewOfferingResult_offeringTransaction_H
...
class OAIRenewOfferingResult_offeringTransaction : public OAIObject {
public:
    OAIRenewOfferingResult_offeringTransaction();
    OAIRenewOfferingResult_offeringTransaction(QString json);
    ~OAIRenewOfferingResult_offeringTransaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRenewOfferingResult_offeringTransaction)

#endif // OAIRenewOfferingResult_offeringTransaction_H
