...
OAIGetDeviceResult_device::OAIGetDeviceResult_device(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDeviceResult_device::OAIGetDeviceResult_device() {
    this->initializeModel();
}

OAIGetDeviceResult_device::~OAIGetDeviceResult_device() {}

void OAIGetDeviceResult_device::initializeModel() {
...
void OAIGetDeviceResult_device::fromJson(QString jsonString) {
...
void OAIGetDeviceResult_device::fromJsonObject(QJsonObject json) {
...
QString OAIGetDeviceResult_device::asJson() const {
...
QJsonObject OAIGetDeviceResult_device::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetDeviceResult_device::getArn() const {
    return m_arn;
}
void OAIGetDeviceResult_device::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetDeviceResult_device::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetDeviceResult_device::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetDeviceResult_device::getName() const {
    return m_name;
}
void OAIGetDeviceResult_device::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetDeviceResult_device::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetDeviceResult_device::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGetDeviceResult_device::getManufacturer() const {
    return m_manufacturer;
}
void OAIGetDeviceResult_device::setManufacturer(const QString &manufacturer) {
    m_manufacturer = manufacturer;
    m_manufacturer_isSet = true;
}

bool OAIGetDeviceResult_device::is_manufacturer_Set() const{
    return m_manufacturer_isSet;
}

bool OAIGetDeviceResult_device::is_manufacturer_Valid() const{
    return m_manufacturer_isValid;
}

QString OAIGetDeviceResult_device::getModel() const {
    return m_model;
}
void OAIGetDeviceResult_device::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIGetDeviceResult_device::is_model_Set() const{
    return m_model_isSet;
}

bool OAIGetDeviceResult_device::is_model_Valid() const{
    return m_model_isValid;
}

QString OAIGetDeviceResult_device::getModelId() const {
    return m_model_id;
}
void OAIGetDeviceResult_device::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIGetDeviceResult_device::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIGetDeviceResult_device::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIDeviceFormFactor OAIGetDeviceResult_device::getFormFactor() const {
    return m_form_factor;
}
void OAIGetDeviceResult_device::setFormFactor(const OAIDeviceFormFactor &form_factor) {
    m_form_factor = form_factor;
    m_form_factor_isSet = true;
}

bool OAIGetDeviceResult_device::is_form_factor_Set() const{
    return m_form_factor_isSet;
}

bool OAIGetDeviceResult_device::is_form_factor_Valid() const{
    return m_form_factor_isValid;
}

OAIDevicePlatform OAIGetDeviceResult_device::getPlatform() const {
    return m_platform;
}
void OAIGetDeviceResult_device::setPlatform(const OAIDevicePlatform &platform) {
    m_platform = platform;
    m_platform_isSet = true;
}

bool OAIGetDeviceResult_device::is_platform_Set() const{
    return m_platform_isSet;
}

bool OAIGetDeviceResult_device::is_platform_Valid() const{
    return m_platform_isValid;
}

QString OAIGetDeviceResult_device::getOs() const {
    return m_os;
}
void OAIGetDeviceResult_device::setOs(const QString &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAIGetDeviceResult_device::is_os_Set() const{
    return m_os_isSet;
}

bool OAIGetDeviceResult_device::is_os_Valid() const{
    return m_os_isValid;
}

OAIDevice_cpu OAIGetDeviceResult_device::getCpu() const {
    return m_cpu;
}
void OAIGetDeviceResult_device::setCpu(const OAIDevice_cpu &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIGetDeviceResult_device::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIGetDeviceResult_device::is_cpu_Valid() const{
    return m_cpu_isValid;
}

OAIDevice_resolution OAIGetDeviceResult_device::getResolution() const {
    return m_resolution;
}
void OAIGetDeviceResult_device::setResolution(const OAIDevice_resolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIGetDeviceResult_device::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIGetDeviceResult_device::is_resolution_Valid() const{
    return m_resolution_isValid;
}

qint32 OAIGetDeviceResult_device::getHeapSize() const {
    return m_heap_size;
}
void OAIGetDeviceResult_device::setHeapSize(const qint32 &heap_size) {
    m_heap_size = heap_size;
    m_heap_size_isSet = true;
}

bool OAIGetDeviceResult_device::is_heap_size_Set() const{
    return m_heap_size_isSet;
}

bool OAIGetDeviceResult_device::is_heap_size_Valid() const{
    return m_heap_size_isValid;
}

qint32 OAIGetDeviceResult_device::getMemory() const {
    return m_memory;
}
void OAIGetDeviceResult_device::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIGetDeviceResult_device::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIGetDeviceResult_device::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIGetDeviceResult_device::getImage() const {
    return m_image;
}
void OAIGetDeviceResult_device::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIGetDeviceResult_device::is_image_Set() const{
    return m_image_isSet;
}

bool OAIGetDeviceResult_device::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIGetDeviceResult_device::getCarrier() const {
    return m_carrier;
}
void OAIGetDeviceResult_device::setCarrier(const QString &carrier) {
    m_carrier = carrier;
    m_carrier_isSet = true;
}

bool OAIGetDeviceResult_device::is_carrier_Set() const{
    return m_carrier_isSet;
}

bool OAIGetDeviceResult_device::is_carrier_Valid() const{
    return m_carrier_isValid;
}

QString OAIGetDeviceResult_device::getRadio() const {
    return m_radio;
}
void OAIGetDeviceResult_device::setRadio(const QString &radio) {
    m_radio = radio;
    m_radio_isSet = true;
}

bool OAIGetDeviceResult_device::is_radio_Set() const{
    return m_radio_isSet;
}

bool OAIGetDeviceResult_device::is_radio_Valid() const{
    return m_radio_isValid;
}

bool OAIGetDeviceResult_device::getRemoteAccessEnabled() const {
    return m_remote_access_enabled;
}
void OAIGetDeviceResult_device::setRemoteAccessEnabled(const bool &remote_access_enabled) {
    m_remote_access_enabled = remote_access_enabled;
    m_remote_access_enabled_isSet = true;
}

bool OAIGetDeviceResult_device::is_remote_access_enabled_Set() const{
    return m_remote_access_enabled_isSet;
}

bool OAIGetDeviceResult_device::is_remote_access_enabled_Valid() const{
    return m_remote_access_enabled_isValid;
}

bool OAIGetDeviceResult_device::getRemoteDebugEnabled() const {
    return m_remote_debug_enabled;
}
void OAIGetDeviceResult_device::setRemoteDebugEnabled(const bool &remote_debug_enabled) {
    m_remote_debug_enabled = remote_debug_enabled;
    m_remote_debug_enabled_isSet = true;
}

bool OAIGetDeviceResult_device::is_remote_debug_enabled_Set() const{
    return m_remote_debug_enabled_isSet;
}

bool OAIGetDeviceResult_device::is_remote_debug_enabled_Valid() const{
    return m_remote_debug_enabled_isValid;
}

QString OAIGetDeviceResult_device::getFleetType() const {
    return m_fleet_type;
}
void OAIGetDeviceResult_device::setFleetType(const QString &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAIGetDeviceResult_device::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAIGetDeviceResult_device::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

QString OAIGetDeviceResult_device::getFleetName() const {
    return m_fleet_name;
}
void OAIGetDeviceResult_device::setFleetName(const QString &fleet_name) {
    m_fleet_name = fleet_name;
    m_fleet_name_isSet = true;
}

bool OAIGetDeviceResult_device::is_fleet_name_Set() const{
    return m_fleet_name_isSet;
}

bool OAIGetDeviceResult_device::is_fleet_name_Valid() const{
    return m_fleet_name_isValid;
}

QList OAIGetDeviceResult_device::getInstances() const {
    return m_instances;
}
void OAIGetDeviceResult_device::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIGetDeviceResult_device::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIGetDeviceResult_device::is_instances_Valid() const{
    return m_instances_isValid;
}

OAIDeviceAvailability OAIGetDeviceResult_device::getAvailability() const {
    return m_availability;
}
void OAIGetDeviceResult_device::setAvailability(const OAIDeviceAvailability &availability) {
    m_availability = availability;
    m_availability_isSet = true;
}

bool OAIGetDeviceResult_device::is_availability_Set() const{
    return m_availability_isSet;
}

bool OAIGetDeviceResult_device::is_availability_Valid() const{
    return m_availability_isValid;
}

bool OAIGetDeviceResult_device::isSet() const {
...
bool OAIGetDeviceResult_device::isValid() const {
