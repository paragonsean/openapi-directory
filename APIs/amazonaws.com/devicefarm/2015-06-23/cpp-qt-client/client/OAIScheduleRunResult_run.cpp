...
#include "OAIScheduleRunResult_run.h"
...
OAIScheduleRunResult_run::OAIScheduleRunResult_run(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleRunResult_run::OAIScheduleRunResult_run() {
    this->initializeModel();
}

OAIScheduleRunResult_run::~OAIScheduleRunResult_run() {}

void OAIScheduleRunResult_run::initializeModel() {
...
void OAIScheduleRunResult_run::fromJson(QString jsonString) {
...
void OAIScheduleRunResult_run::fromJsonObject(QJsonObject json) {
...
QString OAIScheduleRunResult_run::asJson() const {
...
QJsonObject OAIScheduleRunResult_run::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIScheduleRunResult_run::getArn() const {
    return m_arn;
}
void OAIScheduleRunResult_run::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIScheduleRunResult_run::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIScheduleRunResult_run::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIScheduleRunResult_run::getName() const {
    return m_name;
}
void OAIScheduleRunResult_run::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIScheduleRunResult_run::is_name_Set() const{
    return m_name_isSet;
}

bool OAIScheduleRunResult_run::is_name_Valid() const{
    return m_name_isValid;
}

OAITestType OAIScheduleRunResult_run::getType() const {
    return m_type;
}
void OAIScheduleRunResult_run::setType(const OAITestType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIScheduleRunResult_run::is_type_Set() const{
    return m_type_isSet;
}

bool OAIScheduleRunResult_run::is_type_Valid() const{
    return m_type_isValid;
}

OAIDevicePlatform OAIScheduleRunResult_run::getPlatform() const {
    return m_platform;
}
void OAIScheduleRunResult_run::setPlatform(const OAIDevicePlatform &platform) {
    m_platform = platform;
    m_platform_isSet = true;
}

bool OAIScheduleRunResult_run::is_platform_Set() const{
    return m_platform_isSet;
}

bool OAIScheduleRunResult_run::is_platform_Valid() const{
    return m_platform_isValid;
}

QDateTime OAIScheduleRunResult_run::getCreated() const {
    return m_created;
}
void OAIScheduleRunResult_run::setCreated(const QDateTime &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIScheduleRunResult_run::is_created_Set() const{
    return m_created_isSet;
}

bool OAIScheduleRunResult_run::is_created_Valid() const{
    return m_created_isValid;
}

OAIExecutionStatus OAIScheduleRunResult_run::getStatus() const {
    return m_status;
}
void OAIScheduleRunResult_run::setStatus(const OAIExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIScheduleRunResult_run::is_status_Set() const{
    return m_status_isSet;
}

bool OAIScheduleRunResult_run::is_status_Valid() const{
    return m_status_isValid;
}

OAIExecutionResult OAIScheduleRunResult_run::getResult() const {
    return m_result;
}
void OAIScheduleRunResult_run::setResult(const OAIExecutionResult &result) {
    m_result = result;
    m_result_isSet = true;
}

bool OAIScheduleRunResult_run::is_result_Set() const{
    return m_result_isSet;
}

bool OAIScheduleRunResult_run::is_result_Valid() const{
    return m_result_isValid;
}

QDateTime OAIScheduleRunResult_run::getStarted() const {
    return m_started;
}
void OAIScheduleRunResult_run::setStarted(const QDateTime &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAIScheduleRunResult_run::is_started_Set() const{
    return m_started_isSet;
}

bool OAIScheduleRunResult_run::is_started_Valid() const{
    return m_started_isValid;
}

QDateTime OAIScheduleRunResult_run::getStopped() const {
    return m_stopped;
}
void OAIScheduleRunResult_run::setStopped(const QDateTime &stopped) {
    m_stopped = stopped;
    m_stopped_isSet = true;
}

bool OAIScheduleRunResult_run::is_stopped_Set() const{
    return m_stopped_isSet;
}

bool OAIScheduleRunResult_run::is_stopped_Valid() const{
    return m_stopped_isValid;
}

OAIRun_counters OAIScheduleRunResult_run::getCounters() const {
    return m_counters;
}
void OAIScheduleRunResult_run::setCounters(const OAIRun_counters &counters) {
    m_counters = counters;
    m_counters_isSet = true;
}

bool OAIScheduleRunResult_run::is_counters_Set() const{
    return m_counters_isSet;
}

bool OAIScheduleRunResult_run::is_counters_Valid() const{
    return m_counters_isValid;
}

QString OAIScheduleRunResult_run::getMessage() const {
    return m_message;
}
void OAIScheduleRunResult_run::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIScheduleRunResult_run::is_message_Set() const{
    return m_message_isSet;
}

bool OAIScheduleRunResult_run::is_message_Valid() const{
    return m_message_isValid;
}

qint32 OAIScheduleRunResult_run::getTotalJobs() const {
    return m_total_jobs;
}
void OAIScheduleRunResult_run::setTotalJobs(const qint32 &total_jobs) {
    m_total_jobs = total_jobs;
    m_total_jobs_isSet = true;
}

bool OAIScheduleRunResult_run::is_total_jobs_Set() const{
    return m_total_jobs_isSet;
}

bool OAIScheduleRunResult_run::is_total_jobs_Valid() const{
    return m_total_jobs_isValid;
}

qint32 OAIScheduleRunResult_run::getCompletedJobs() const {
    return m_completed_jobs;
}
void OAIScheduleRunResult_run::setCompletedJobs(const qint32 &completed_jobs) {
    m_completed_jobs = completed_jobs;
    m_completed_jobs_isSet = true;
}

bool OAIScheduleRunResult_run::is_completed_jobs_Set() const{
    return m_completed_jobs_isSet;
}

bool OAIScheduleRunResult_run::is_completed_jobs_Valid() const{
    return m_completed_jobs_isValid;
}

OAIBillingMethod OAIScheduleRunResult_run::getBillingMethod() const {
    return m_billing_method;
}
void OAIScheduleRunResult_run::setBillingMethod(const OAIBillingMethod &billing_method) {
    m_billing_method = billing_method;
    m_billing_method_isSet = true;
}

bool OAIScheduleRunResult_run::is_billing_method_Set() const{
    return m_billing_method_isSet;
}

bool OAIScheduleRunResult_run::is_billing_method_Valid() const{
    return m_billing_method_isValid;
}

OAIRun_deviceMinutes OAIScheduleRunResult_run::getDeviceMinutes() const {
    return m_device_minutes;
}
void OAIScheduleRunResult_run::setDeviceMinutes(const OAIRun_deviceMinutes &device_minutes) {
    m_device_minutes = device_minutes;
    m_device_minutes_isSet = true;
}

bool OAIScheduleRunResult_run::is_device_minutes_Set() const{
    return m_device_minutes_isSet;
}

bool OAIScheduleRunResult_run::is_device_minutes_Valid() const{
    return m_device_minutes_isValid;
}

OAIRun_networkProfile OAIScheduleRunResult_run::getNetworkProfile() const {
    return m_network_profile;
}
void OAIScheduleRunResult_run::setNetworkProfile(const OAIRun_networkProfile &network_profile) {
    m_network_profile = network_profile;
    m_network_profile_isSet = true;
}

bool OAIScheduleRunResult_run::is_network_profile_Set() const{
    return m_network_profile_isSet;
}

bool OAIScheduleRunResult_run::is_network_profile_Valid() const{
    return m_network_profile_isValid;
}

QString OAIScheduleRunResult_run::getParsingResultUrl() const {
    return m_parsing_result_url;
}
void OAIScheduleRunResult_run::setParsingResultUrl(const QString &parsing_result_url) {
    m_parsing_result_url = parsing_result_url;
    m_parsing_result_url_isSet = true;
}

bool OAIScheduleRunResult_run::is_parsing_result_url_Set() const{
    return m_parsing_result_url_isSet;
}

bool OAIScheduleRunResult_run::is_parsing_result_url_Valid() const{
    return m_parsing_result_url_isValid;
}

OAIExecutionResultCode OAIScheduleRunResult_run::getResultCode() const {
    return m_result_code;
}
void OAIScheduleRunResult_run::setResultCode(const OAIExecutionResultCode &result_code) {
    m_result_code = result_code;
    m_result_code_isSet = true;
}

bool OAIScheduleRunResult_run::is_result_code_Set() const{
    return m_result_code_isSet;
}

bool OAIScheduleRunResult_run::is_result_code_Valid() const{
    return m_result_code_isValid;
}

qint32 OAIScheduleRunResult_run::getSeed() const {
    return m_seed;
}
void OAIScheduleRunResult_run::setSeed(const qint32 &seed) {
    m_seed = seed;
    m_seed_isSet = true;
}

bool OAIScheduleRunResult_run::is_seed_Set() const{
    return m_seed_isSet;
}

bool OAIScheduleRunResult_run::is_seed_Valid() const{
    return m_seed_isValid;
}

QString OAIScheduleRunResult_run::getAppUpload() const {
    return m_app_upload;
}
void OAIScheduleRunResult_run::setAppUpload(const QString &app_upload) {
    m_app_upload = app_upload;
    m_app_upload_isSet = true;
}

bool OAIScheduleRunResult_run::is_app_upload_Set() const{
    return m_app_upload_isSet;
}

bool OAIScheduleRunResult_run::is_app_upload_Valid() const{
    return m_app_upload_isValid;
}

qint32 OAIScheduleRunResult_run::getEventCount() const {
    return m_event_count;
}
void OAIScheduleRunResult_run::setEventCount(const qint32 &event_count) {
    m_event_count = event_count;
    m_event_count_isSet = true;
}

bool OAIScheduleRunResult_run::is_event_count_Set() const{
    return m_event_count_isSet;
}

bool OAIScheduleRunResult_run::is_event_count_Valid() const{
    return m_event_count_isValid;
}

qint32 OAIScheduleRunResult_run::getJobTimeoutMinutes() const {
    return m_job_timeout_minutes;
}
void OAIScheduleRunResult_run::setJobTimeoutMinutes(const qint32 &job_timeout_minutes) {
    m_job_timeout_minutes = job_timeout_minutes;
    m_job_timeout_minutes_isSet = true;
}

bool OAIScheduleRunResult_run::is_job_timeout_minutes_Set() const{
    return m_job_timeout_minutes_isSet;
}

bool OAIScheduleRunResult_run::is_job_timeout_minutes_Valid() const{
    return m_job_timeout_minutes_isValid;
}

QString OAIScheduleRunResult_run::getDevicePoolArn() const {
    return m_device_pool_arn;
}
void OAIScheduleRunResult_run::setDevicePoolArn(const QString &device_pool_arn) {
    m_device_pool_arn = device_pool_arn;
    m_device_pool_arn_isSet = true;
}

bool OAIScheduleRunResult_run::is_device_pool_arn_Set() const{
    return m_device_pool_arn_isSet;
}

bool OAIScheduleRunResult_run::is_device_pool_arn_Valid() const{
    return m_device_pool_arn_isValid;
}

QString OAIScheduleRunResult_run::getLocale() const {
    return m_locale;
}
void OAIScheduleRunResult_run::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIScheduleRunResult_run::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIScheduleRunResult_run::is_locale_Valid() const{
    return m_locale_isValid;
}

OAIScheduleRunConfiguration_radios OAIScheduleRunResult_run::getRadios() const {
    return m_radios;
}
void OAIScheduleRunResult_run::setRadios(const OAIScheduleRunConfiguration_radios &radios) {
    m_radios = radios;
    m_radios_isSet = true;
}

bool OAIScheduleRunResult_run::is_radios_Set() const{
    return m_radios_isSet;
}

bool OAIScheduleRunResult_run::is_radios_Valid() const{
    return m_radios_isValid;
}

OAIScheduleRunConfiguration_location OAIScheduleRunResult_run::getLocation() const {
    return m_location;
}
void OAIScheduleRunResult_run::setLocation(const OAIScheduleRunConfiguration_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIScheduleRunResult_run::is_location_Set() const{
    return m_location_isSet;
}

bool OAIScheduleRunResult_run::is_location_Valid() const{
    return m_location_isValid;
}

OAIRun_customerArtifactPaths OAIScheduleRunResult_run::getCustomerArtifactPaths() const {
    return m_customer_artifact_paths;
}
void OAIScheduleRunResult_run::setCustomerArtifactPaths(const OAIRun_customerArtifactPaths &customer_artifact_paths) {
    m_customer_artifact_paths = customer_artifact_paths;
    m_customer_artifact_paths_isSet = true;
}

bool OAIScheduleRunResult_run::is_customer_artifact_paths_Set() const{
    return m_customer_artifact_paths_isSet;
}

bool OAIScheduleRunResult_run::is_customer_artifact_paths_Valid() const{
    return m_customer_artifact_paths_isValid;
}

QString OAIScheduleRunResult_run::getWebUrl() const {
    return m_web_url;
}
void OAIScheduleRunResult_run::setWebUrl(const QString &web_url) {
    m_web_url = web_url;
    m_web_url_isSet = true;
}

bool OAIScheduleRunResult_run::is_web_url_Set() const{
    return m_web_url_isSet;
}

bool OAIScheduleRunResult_run::is_web_url_Valid() const{
    return m_web_url_isValid;
}

bool OAIScheduleRunResult_run::getSkipAppResign() const {
    return m_skip_app_resign;
}
void OAIScheduleRunResult_run::setSkipAppResign(const bool &skip_app_resign) {
    m_skip_app_resign = skip_app_resign;
    m_skip_app_resign_isSet = true;
}

bool OAIScheduleRunResult_run::is_skip_app_resign_Set() const{
    return m_skip_app_resign_isSet;
}

bool OAIScheduleRunResult_run::is_skip_app_resign_Valid() const{
    return m_skip_app_resign_isValid;
}

QString OAIScheduleRunResult_run::getTestSpecArn() const {
    return m_test_spec_arn;
}
void OAIScheduleRunResult_run::setTestSpecArn(const QString &test_spec_arn) {
    m_test_spec_arn = test_spec_arn;
    m_test_spec_arn_isSet = true;
}

bool OAIScheduleRunResult_run::is_test_spec_arn_Set() const{
    return m_test_spec_arn_isSet;
}

bool OAIScheduleRunResult_run::is_test_spec_arn_Valid() const{
    return m_test_spec_arn_isValid;
}

OAIRun_deviceSelectionResult OAIScheduleRunResult_run::getDeviceSelectionResult() const {
    return m_device_selection_result;
}
void OAIScheduleRunResult_run::setDeviceSelectionResult(const OAIRun_deviceSelectionResult &device_selection_result) {
    m_device_selection_result = device_selection_result;
    m_device_selection_result_isSet = true;
}

bool OAIScheduleRunResult_run::is_device_selection_result_Set() const{
    return m_device_selection_result_isSet;
}

bool OAIScheduleRunResult_run::is_device_selection_result_Valid() const{
    return m_device_selection_result_isValid;
}

OAICreateProjectRequest_vpcConfig OAIScheduleRunResult_run::getVpcConfig() const {
    return m_vpc_config;
}
void OAIScheduleRunResult_run::setVpcConfig(const OAICreateProjectRequest_vpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAIScheduleRunResult_run::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAIScheduleRunResult_run::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

bool OAIScheduleRunResult_run::isSet() const {
...
bool OAIScheduleRunResult_run::isValid() const {
