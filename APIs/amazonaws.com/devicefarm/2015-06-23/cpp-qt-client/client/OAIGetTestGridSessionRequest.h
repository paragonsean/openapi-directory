...
/*
 * OAIGetTestGridSessionRequest.h
 *
 * 
 */

#ifndef OAIGetTestGridSessionRequest_H
#define OAIGetTestGridSessionRequest_H
...
class OAIGetTestGridSessionRequest : public OAIObject {
public:
    OAIGetTestGridSessionRequest();
    OAIGetTestGridSessionRequest(QString json);
    ~OAIGetTestGridSessionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTestGridSessionRequest)

#endif // OAIGetTestGridSessionRequest_H
