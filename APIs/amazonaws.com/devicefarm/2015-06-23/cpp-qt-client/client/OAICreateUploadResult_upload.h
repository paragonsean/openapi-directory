...
/*
 * OAICreateUploadResult_upload.h
 *
 * 
 */

#ifndef OAICreateUploadResult_upload_H
#define OAICreateUploadResult_upload_H
...
class OAICreateUploadResult_upload : public OAIObject {
public:
    OAICreateUploadResult_upload();
    OAICreateUploadResult_upload(QString json);
    ~OAICreateUploadResult_upload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUploadResult_upload)

#endif // OAICreateUploadResult_upload_H
