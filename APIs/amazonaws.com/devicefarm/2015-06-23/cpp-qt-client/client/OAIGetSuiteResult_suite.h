...
/*
 * OAIGetSuiteResult_suite.h
 *
 * 
 */

#ifndef OAIGetSuiteResult_suite_H
#define OAIGetSuiteResult_suite_H
...
class OAIGetSuiteResult_suite : public OAIObject {
public:
    OAIGetSuiteResult_suite();
    OAIGetSuiteResult_suite(QString json);
    ~OAIGetSuiteResult_suite() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSuiteResult_suite)

#endif // OAIGetSuiteResult_suite_H
