...
/*
 * OAIInstallToRemoteAccessSessionResult_appUpload.h
 *
 * 
 */

#ifndef OAIInstallToRemoteAccessSessionResult_appUpload_H
#define OAIInstallToRemoteAccessSessionResult_appUpload_H
...
class OAIInstallToRemoteAccessSessionResult_appUpload : public OAIObject {
public:
    OAIInstallToRemoteAccessSessionResult_appUpload();
    OAIInstallToRemoteAccessSessionResult_appUpload(QString json);
    ~OAIInstallToRemoteAccessSessionResult_appUpload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstallToRemoteAccessSessionResult_appUpload)

#endif // OAIInstallToRemoteAccessSessionResult_appUpload_H
