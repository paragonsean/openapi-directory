...
#ifndef OAITestGridSession_H
#define OAITestGridSession_H
...
class OAITestGridSession : public OAIObject {
public:
    OAITestGridSession();
    OAITestGridSession(QString json);
    ~OAITestGridSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestGridSession)

#endif // OAITestGridSession_H
