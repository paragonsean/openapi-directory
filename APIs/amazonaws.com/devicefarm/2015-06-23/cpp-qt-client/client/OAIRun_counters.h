...
#ifndef OAIRun_counters_H
#define OAIRun_counters_H
...
class OAIRun_counters : public OAIObject {
public:
    OAIRun_counters();
    OAIRun_counters(QString json);
    ~OAIRun_counters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRun_counters)

#endif // OAIRun_counters_H
