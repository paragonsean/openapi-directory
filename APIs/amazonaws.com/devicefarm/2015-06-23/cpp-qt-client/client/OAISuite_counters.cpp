...
OAISuite_counters::OAISuite_counters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISuite_counters::OAISuite_counters() {
    this->initializeModel();
}

OAISuite_counters::~OAISuite_counters() {}

void OAISuite_counters::initializeModel() {
...
void OAISuite_counters::fromJson(QString jsonString) {
...
void OAISuite_counters::fromJsonObject(QJsonObject json) {
...
QString OAISuite_counters::asJson() const {
...
QJsonObject OAISuite_counters::asJsonObject() const {
    QJsonObject obj;
    if (m_total_isSet) {
...
qint32 OAISuite_counters::getTotal() const {
    return m_total;
}
void OAISuite_counters::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAISuite_counters::is_total_Set() const{
    return m_total_isSet;
}

bool OAISuite_counters::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAISuite_counters::getPassed() const {
    return m_passed;
}
void OAISuite_counters::setPassed(const qint32 &passed) {
    m_passed = passed;
    m_passed_isSet = true;
}

bool OAISuite_counters::is_passed_Set() const{
    return m_passed_isSet;
}

bool OAISuite_counters::is_passed_Valid() const{
    return m_passed_isValid;
}

qint32 OAISuite_counters::getFailed() const {
    return m_failed;
}
void OAISuite_counters::setFailed(const qint32 &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAISuite_counters::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAISuite_counters::is_failed_Valid() const{
    return m_failed_isValid;
}

qint32 OAISuite_counters::getWarned() const {
    return m_warned;
}
void OAISuite_counters::setWarned(const qint32 &warned) {
    m_warned = warned;
    m_warned_isSet = true;
}

bool OAISuite_counters::is_warned_Set() const{
    return m_warned_isSet;
}

bool OAISuite_counters::is_warned_Valid() const{
    return m_warned_isValid;
}

qint32 OAISuite_counters::getErrored() const {
    return m_errored;
}
void OAISuite_counters::setErrored(const qint32 &errored) {
    m_errored = errored;
    m_errored_isSet = true;
}

bool OAISuite_counters::is_errored_Set() const{
    return m_errored_isSet;
}

bool OAISuite_counters::is_errored_Valid() const{
    return m_errored_isValid;
}

qint32 OAISuite_counters::getStopped() const {
    return m_stopped;
}
void OAISuite_counters::setStopped(const qint32 &stopped) {
    m_stopped = stopped;
    m_stopped_isSet = true;
}

bool OAISuite_counters::is_stopped_Set() const{
    return m_stopped_isSet;
}

bool OAISuite_counters::is_stopped_Valid() const{
    return m_stopped_isValid;
}

qint32 OAISuite_counters::getSkipped() const {
    return m_skipped;
}
void OAISuite_counters::setSkipped(const qint32 &skipped) {
    m_skipped = skipped;
    m_skipped_isSet = true;
}

bool OAISuite_counters::is_skipped_Set() const{
    return m_skipped_isSet;
}

bool OAISuite_counters::is_skipped_Valid() const{
    return m_skipped_isValid;
}

bool OAISuite_counters::isSet() const {
...
bool OAISuite_counters::isValid() const {
