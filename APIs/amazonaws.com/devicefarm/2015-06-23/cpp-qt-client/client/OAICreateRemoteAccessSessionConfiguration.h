...
/*
 * OAICreateRemoteAccessSessionConfiguration.h
 *
 * Configuration settings for a remote access session, including billing method.
 */

#ifndef OAICreateRemoteAccessSessionConfiguration_H
#define OAICreateRemoteAccessSessionConfiguration_H
...
class OAICreateRemoteAccessSessionConfiguration : public OAIObject {
public:
    OAICreateRemoteAccessSessionConfiguration();
    OAICreateRemoteAccessSessionConfiguration(QString json);
    ~OAICreateRemoteAccessSessionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRemoteAccessSessionConfiguration)

#endif // OAICreateRemoteAccessSessionConfiguration_H
