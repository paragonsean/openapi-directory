...
/*
 * OAIUpdateNetworkProfileRequest.h
 *
 * 
 */

#ifndef OAIUpdateNetworkProfileRequest_H
#define OAIUpdateNetworkProfileRequest_H
...
class OAIUpdateNetworkProfileRequest : public OAIObject {
public:
    OAIUpdateNetworkProfileRequest();
    OAIUpdateNetworkProfileRequest(QString json);
    ~OAIUpdateNetworkProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkProfileRequest)

#endif // OAIUpdateNetworkProfileRequest_H
