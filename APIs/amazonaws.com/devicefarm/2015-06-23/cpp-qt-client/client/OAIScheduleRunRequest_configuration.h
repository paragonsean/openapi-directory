...
/*
 * OAIScheduleRunRequest_configuration.h
 *
 * 
 */

#ifndef OAIScheduleRunRequest_configuration_H
#define OAIScheduleRunRequest_configuration_H
...
class OAIScheduleRunRequest_configuration : public OAIObject {
public:
    OAIScheduleRunRequest_configuration();
    OAIScheduleRunRequest_configuration(QString json);
    ~OAIScheduleRunRequest_configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleRunRequest_configuration)

#endif // OAIScheduleRunRequest_configuration_H
