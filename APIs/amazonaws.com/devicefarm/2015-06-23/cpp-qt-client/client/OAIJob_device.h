...
#ifndef OAIJob_device_H
#define OAIJob_device_H
...
class OAIJob_device : public OAIObject {
public:
    OAIJob_device();
    OAIJob_device(QString json);
    ~OAIJob_device() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJob_device)

#endif // OAIJob_device_H
