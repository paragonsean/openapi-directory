...
/*
 * OAIGetRemoteAccessSessionResult_remoteAccessSession.h
 *
 * 
 */

#ifndef OAIGetRemoteAccessSessionResult_remoteAccessSession_H
#define OAIGetRemoteAccessSessionResult_remoteAccessSession_H
...
class OAIGetRemoteAccessSessionResult_remoteAccessSession : public OAIObject {
public:
    OAIGetRemoteAccessSessionResult_remoteAccessSession();
    OAIGetRemoteAccessSessionResult_remoteAccessSession(QString json);
    ~OAIGetRemoteAccessSessionResult_remoteAccessSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRemoteAccessSessionResult_remoteAccessSession)

#endif // OAIGetRemoteAccessSessionResult_remoteAccessSession_H
