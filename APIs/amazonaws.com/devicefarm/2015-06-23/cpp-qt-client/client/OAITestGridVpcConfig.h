...
/*
 * OAITestGridVpcConfig.h
 *
 * The VPC security groups and subnets that are attached to a project.
 */

#ifndef OAITestGridVpcConfig_H
#define OAITestGridVpcConfig_H
...
class OAITestGridVpcConfig : public OAIObject {
public:
    OAITestGridVpcConfig();
    OAITestGridVpcConfig(QString json);
    ~OAITestGridVpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestGridVpcConfig)

#endif // OAITestGridVpcConfig_H
