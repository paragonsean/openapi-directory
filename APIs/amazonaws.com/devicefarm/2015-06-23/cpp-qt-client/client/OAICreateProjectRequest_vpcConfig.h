...
/*
 * OAICreateProjectRequest_vpcConfig.h
 *
 * 
 */

#ifndef OAICreateProjectRequest_vpcConfig_H
#define OAICreateProjectRequest_vpcConfig_H
...
class OAICreateProjectRequest_vpcConfig : public OAIObject {
public:
    OAICreateProjectRequest_vpcConfig();
    OAICreateProjectRequest_vpcConfig(QString json);
    ~OAICreateProjectRequest_vpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectRequest_vpcConfig)

#endif // OAICreateProjectRequest_vpcConfig_H
