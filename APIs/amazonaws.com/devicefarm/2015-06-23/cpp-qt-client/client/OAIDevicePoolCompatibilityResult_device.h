...
/*
 * OAIDevicePoolCompatibilityResult_device.h
 *
 * 
 */

#ifndef OAIDevicePoolCompatibilityResult_device_H
#define OAIDevicePoolCompatibilityResult_device_H
...
class OAIDevicePoolCompatibilityResult_device : public OAIObject {
public:
    OAIDevicePoolCompatibilityResult_device();
    OAIDevicePoolCompatibilityResult_device(QString json);
    ~OAIDevicePoolCompatibilityResult_device() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevicePoolCompatibilityResult_device)

#endif // OAIDevicePoolCompatibilityResult_device_H
