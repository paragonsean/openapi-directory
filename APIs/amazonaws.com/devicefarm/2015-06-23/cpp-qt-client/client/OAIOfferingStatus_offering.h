...
/*
 * OAIOfferingStatus_offering.h
 *
 * 
 */

#ifndef OAIOfferingStatus_offering_H
#define OAIOfferingStatus_offering_H
...
class OAIOfferingStatus_offering : public OAIObject {
public:
    OAIOfferingStatus_offering();
    OAIOfferingStatus_offering(QString json);
    ~OAIOfferingStatus_offering() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingStatus_offering)

#endif // OAIOfferingStatus_offering_H
