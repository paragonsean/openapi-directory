...
/*
 * OAIUpdateNetworkProfileResult_networkProfile.h
 *
 * 
 */

#ifndef OAIUpdateNetworkProfileResult_networkProfile_H
#define OAIUpdateNetworkProfileResult_networkProfile_H
...
class OAIUpdateNetworkProfileResult_networkProfile : public OAIObject {
public:
    OAIUpdateNetworkProfileResult_networkProfile();
    OAIUpdateNetworkProfileResult_networkProfile(QString json);
    ~OAIUpdateNetworkProfileResult_networkProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkProfileResult_networkProfile)

#endif // OAIUpdateNetworkProfileResult_networkProfile_H
