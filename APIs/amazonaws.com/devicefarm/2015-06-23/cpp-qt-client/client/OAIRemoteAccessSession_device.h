...
/*
 * OAIRemoteAccessSession_device.h
 *
 * 
 */

#ifndef OAIRemoteAccessSession_device_H
#define OAIRemoteAccessSession_device_H
...
class OAIRemoteAccessSession_device : public OAIObject {
public:
    OAIRemoteAccessSession_device();
    OAIRemoteAccessSession_device(QString json);
    ~OAIRemoteAccessSession_device() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoteAccessSession_device)

#endif // OAIRemoteAccessSession_device_H
