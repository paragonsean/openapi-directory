...
/*
 * OAICreateProjectResult_project.h
 *
 * 
 */

#ifndef OAICreateProjectResult_project_H
#define OAICreateProjectResult_project_H
...
class OAICreateProjectResult_project : public OAIObject {
public:
    OAICreateProjectResult_project();
    OAICreateProjectResult_project(QString json);
    ~OAICreateProjectResult_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectResult_project)

#endif // OAICreateProjectResult_project_H
