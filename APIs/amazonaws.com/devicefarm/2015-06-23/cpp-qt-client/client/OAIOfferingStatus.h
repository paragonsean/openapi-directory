...
#ifndef OAIOfferingStatus_H
#define OAIOfferingStatus_H
...
class OAIOfferingStatus : public OAIObject {
public:
    OAIOfferingStatus();
    OAIOfferingStatus(QString json);
    ~OAIOfferingStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferingStatus)

#endif // OAIOfferingStatus_H
