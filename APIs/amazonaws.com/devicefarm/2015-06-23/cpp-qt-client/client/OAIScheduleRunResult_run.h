...
/*
 * OAIScheduleRunResult_run.h
 *
 * 
 */

#ifndef OAIScheduleRunResult_run_H
#define OAIScheduleRunResult_run_H
...
class OAIScheduleRunResult_run : public OAIObject {
public:
    OAIScheduleRunResult_run();
    OAIScheduleRunResult_run(QString json);
    ~OAIScheduleRunResult_run() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleRunResult_run)

#endif // OAIScheduleRunResult_run_H
