...
OAIProblem_device::OAIProblem_device(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProblem_device::OAIProblem_device() {
    this->initializeModel();
}

OAIProblem_device::~OAIProblem_device() {}

void OAIProblem_device::initializeModel() {
...
void OAIProblem_device::fromJson(QString jsonString) {
...
void OAIProblem_device::fromJsonObject(QJsonObject json) {
...
QString OAIProblem_device::asJson() const {
...
QJsonObject OAIProblem_device::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIProblem_device::getArn() const {
    return m_arn;
}
void OAIProblem_device::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIProblem_device::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIProblem_device::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIProblem_device::getName() const {
    return m_name;
}
void OAIProblem_device::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProblem_device::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProblem_device::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIProblem_device::getManufacturer() const {
    return m_manufacturer;
}
void OAIProblem_device::setManufacturer(const QString &manufacturer) {
    m_manufacturer = manufacturer;
    m_manufacturer_isSet = true;
}

bool OAIProblem_device::is_manufacturer_Set() const{
    return m_manufacturer_isSet;
}

bool OAIProblem_device::is_manufacturer_Valid() const{
    return m_manufacturer_isValid;
}

QString OAIProblem_device::getModel() const {
    return m_model;
}
void OAIProblem_device::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIProblem_device::is_model_Set() const{
    return m_model_isSet;
}

bool OAIProblem_device::is_model_Valid() const{
    return m_model_isValid;
}

QString OAIProblem_device::getModelId() const {
    return m_model_id;
}
void OAIProblem_device::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIProblem_device::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIProblem_device::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIDeviceFormFactor OAIProblem_device::getFormFactor() const {
    return m_form_factor;
}
void OAIProblem_device::setFormFactor(const OAIDeviceFormFactor &form_factor) {
    m_form_factor = form_factor;
    m_form_factor_isSet = true;
}

bool OAIProblem_device::is_form_factor_Set() const{
    return m_form_factor_isSet;
}

bool OAIProblem_device::is_form_factor_Valid() const{
    return m_form_factor_isValid;
}

OAIDevicePlatform OAIProblem_device::getPlatform() const {
    return m_platform;
}
void OAIProblem_device::setPlatform(const OAIDevicePlatform &platform) {
    m_platform = platform;
    m_platform_isSet = true;
}

bool OAIProblem_device::is_platform_Set() const{
    return m_platform_isSet;
}

bool OAIProblem_device::is_platform_Valid() const{
    return m_platform_isValid;
}

QString OAIProblem_device::getOs() const {
    return m_os;
}
void OAIProblem_device::setOs(const QString &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAIProblem_device::is_os_Set() const{
    return m_os_isSet;
}

bool OAIProblem_device::is_os_Valid() const{
    return m_os_isValid;
}

OAIDevice_cpu OAIProblem_device::getCpu() const {
    return m_cpu;
}
void OAIProblem_device::setCpu(const OAIDevice_cpu &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIProblem_device::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIProblem_device::is_cpu_Valid() const{
    return m_cpu_isValid;
}

OAIDevice_resolution OAIProblem_device::getResolution() const {
    return m_resolution;
}
void OAIProblem_device::setResolution(const OAIDevice_resolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIProblem_device::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIProblem_device::is_resolution_Valid() const{
    return m_resolution_isValid;
}

qint32 OAIProblem_device::getHeapSize() const {
    return m_heap_size;
}
void OAIProblem_device::setHeapSize(const qint32 &heap_size) {
    m_heap_size = heap_size;
    m_heap_size_isSet = true;
}

bool OAIProblem_device::is_heap_size_Set() const{
    return m_heap_size_isSet;
}

bool OAIProblem_device::is_heap_size_Valid() const{
    return m_heap_size_isValid;
}

qint32 OAIProblem_device::getMemory() const {
    return m_memory;
}
void OAIProblem_device::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIProblem_device::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIProblem_device::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIProblem_device::getImage() const {
    return m_image;
}
void OAIProblem_device::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIProblem_device::is_image_Set() const{
    return m_image_isSet;
}

bool OAIProblem_device::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIProblem_device::getCarrier() const {
    return m_carrier;
}
void OAIProblem_device::setCarrier(const QString &carrier) {
    m_carrier = carrier;
    m_carrier_isSet = true;
}

bool OAIProblem_device::is_carrier_Set() const{
    return m_carrier_isSet;
}

bool OAIProblem_device::is_carrier_Valid() const{
    return m_carrier_isValid;
}

QString OAIProblem_device::getRadio() const {
    return m_radio;
}
void OAIProblem_device::setRadio(const QString &radio) {
    m_radio = radio;
    m_radio_isSet = true;
}

bool OAIProblem_device::is_radio_Set() const{
    return m_radio_isSet;
}

bool OAIProblem_device::is_radio_Valid() const{
    return m_radio_isValid;
}

bool OAIProblem_device::getRemoteAccessEnabled() const {
    return m_remote_access_enabled;
}
void OAIProblem_device::setRemoteAccessEnabled(const bool &remote_access_enabled) {
    m_remote_access_enabled = remote_access_enabled;
    m_remote_access_enabled_isSet = true;
}

bool OAIProblem_device::is_remote_access_enabled_Set() const{
    return m_remote_access_enabled_isSet;
}

bool OAIProblem_device::is_remote_access_enabled_Valid() const{
    return m_remote_access_enabled_isValid;
}

bool OAIProblem_device::getRemoteDebugEnabled() const {
    return m_remote_debug_enabled;
}
void OAIProblem_device::setRemoteDebugEnabled(const bool &remote_debug_enabled) {
    m_remote_debug_enabled = remote_debug_enabled;
    m_remote_debug_enabled_isSet = true;
}

bool OAIProblem_device::is_remote_debug_enabled_Set() const{
    return m_remote_debug_enabled_isSet;
}

bool OAIProblem_device::is_remote_debug_enabled_Valid() const{
    return m_remote_debug_enabled_isValid;
}

QString OAIProblem_device::getFleetType() const {
    return m_fleet_type;
}
void OAIProblem_device::setFleetType(const QString &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAIProblem_device::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAIProblem_device::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

QString OAIProblem_device::getFleetName() const {
    return m_fleet_name;
}
void OAIProblem_device::setFleetName(const QString &fleet_name) {
    m_fleet_name = fleet_name;
    m_fleet_name_isSet = true;
}

bool OAIProblem_device::is_fleet_name_Set() const{
    return m_fleet_name_isSet;
}

bool OAIProblem_device::is_fleet_name_Valid() const{
    return m_fleet_name_isValid;
}

QList OAIProblem_device::getInstances() const {
    return m_instances;
}
void OAIProblem_device::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIProblem_device::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIProblem_device::is_instances_Valid() const{
    return m_instances_isValid;
}

OAIDeviceAvailability OAIProblem_device::getAvailability() const {
    return m_availability;
}
void OAIProblem_device::setAvailability(const OAIDeviceAvailability &availability) {
    m_availability = availability;
    m_availability_isSet = true;
}

bool OAIProblem_device::is_availability_Set() const{
    return m_availability_isSet;
}

bool OAIProblem_device::is_availability_Valid() const{
    return m_availability_isValid;
}

bool OAIProblem_device::isSet() const {
...
bool OAIProblem_device::isValid() const {
