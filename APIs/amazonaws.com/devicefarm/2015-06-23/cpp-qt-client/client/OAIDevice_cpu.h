...
#ifndef OAIDevice_cpu_H
#define OAIDevice_cpu_H
...
class OAIDevice_cpu : public OAIObject {
public:
    OAIDevice_cpu();
    OAIDevice_cpu(QString json);
    ~OAIDevice_cpu() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevice_cpu)

#endif // OAIDevice_cpu_H
