...
#include "OAITestGridVpcConfig.h"
...
OAITestGridVpcConfig::OAITestGridVpcConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestGridVpcConfig::OAITestGridVpcConfig() {
    this->initializeModel();
}

OAITestGridVpcConfig::~OAITestGridVpcConfig() {}

void OAITestGridVpcConfig::initializeModel() {
...
void OAITestGridVpcConfig::fromJson(QString jsonString) {
...
void OAITestGridVpcConfig::fromJsonObject(QJsonObject json) {
...
QString OAITestGridVpcConfig::asJson() const {
...
QJsonObject OAITestGridVpcConfig::asJsonObject() const {
    QJsonObject obj;
...
QList OAITestGridVpcConfig::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAITestGridVpcConfig::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAITestGridVpcConfig::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAITestGridVpcConfig::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAITestGridVpcConfig::getSubnetIds() const {
    return m_subnet_ids;
}
void OAITestGridVpcConfig::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAITestGridVpcConfig::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAITestGridVpcConfig::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QString OAITestGridVpcConfig::getVpcId() const {
    return m_vpc_id;
}
void OAITestGridVpcConfig::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAITestGridVpcConfig::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAITestGridVpcConfig::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

bool OAITestGridVpcConfig::isSet() const {
...
bool OAITestGridVpcConfig::isValid() const {
