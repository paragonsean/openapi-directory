...
QString OAIDevice::getArn() const {
    return m_arn;
}
void OAIDevice::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDevice::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDevice::is_arn_Valid() const{
...
QString OAIDevice::getModelId() const {
    return m_model_id;
}
void OAIDevice::setModelId(const QString &model_id) {
    m_model_id = model_id;
    m_model_id_isSet = true;
}

bool OAIDevice::is_model_id_Set() const{
    return m_model_id_isSet;
}

bool OAIDevice::is_model_id_Valid() const{
    return m_model_id_isValid;
}

OAIDeviceFormFactor OAIDevice::getFormFactor() const {
    return m_form_factor;
}
void OAIDevice::setFormFactor(const OAIDeviceFormFactor &form_factor) {
    m_form_factor = form_factor;
    m_form_factor_isSet = true;
}

bool OAIDevice::is_form_factor_Set() const{
    return m_form_factor_isSet;
}

bool OAIDevice::is_form_factor_Valid() const{
    return m_form_factor_isValid;
}

OAIDevicePlatform OAIDevice::getPlatform() const {
    return m_platform;
}
void OAIDevice::setPlatform(const OAIDevicePlatform &platform) {
    m_platform = platform;
...
QString OAIDevice::getOs() const {
    return m_os;
}
void OAIDevice::setOs(const QString &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAIDevice::is_os_Set() const{
    return m_os_isSet;
}

bool OAIDevice::is_os_Valid() const{
    return m_os_isValid;
}

OAIDevice_cpu OAIDevice::getCpu() const {
    return m_cpu;
}
void OAIDevice::setCpu(const OAIDevice_cpu &cpu) {
    m_cpu = cpu;
    m_cpu_isSet = true;
}

bool OAIDevice::is_cpu_Set() const{
    return m_cpu_isSet;
}

bool OAIDevice::is_cpu_Valid() const{
    return m_cpu_isValid;
}

OAIDevice_resolution OAIDevice::getResolution() const {
    return m_resolution;
}
void OAIDevice::setResolution(const OAIDevice_resolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIDevice::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIDevice::is_resolution_Valid() const{
    return m_resolution_isValid;
}

qint32 OAIDevice::getHeapSize() const {
    return m_heap_size;
}
void OAIDevice::setHeapSize(const qint32 &heap_size) {
    m_heap_size = heap_size;
    m_heap_size_isSet = true;
}

bool OAIDevice::is_heap_size_Set() const{
    return m_heap_size_isSet;
}

bool OAIDevice::is_heap_size_Valid() const{
    return m_heap_size_isValid;
}

qint32 OAIDevice::getMemory() const {
    return m_memory;
}
void OAIDevice::setMemory(const qint32 &memory) {
    m_memory = memory;
    m_memory_isSet = true;
}

bool OAIDevice::is_memory_Set() const{
    return m_memory_isSet;
}

bool OAIDevice::is_memory_Valid() const{
    return m_memory_isValid;
}

QString OAIDevice::getImage() const {
    return m_image;
}
void OAIDevice::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDevice::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDevice::is_image_Valid() const{
    return m_image_isValid;
}

QString OAIDevice::getCarrier() const {
    return m_carrier;
}
void OAIDevice::setCarrier(const QString &carrier) {
    m_carrier = carrier;
    m_carrier_isSet = true;
}

bool OAIDevice::is_carrier_Set() const{
    return m_carrier_isSet;
}

bool OAIDevice::is_carrier_Valid() const{
    return m_carrier_isValid;
}

QString OAIDevice::getRadio() const {
    return m_radio;
}
void OAIDevice::setRadio(const QString &radio) {
    m_radio = radio;
    m_radio_isSet = true;
}

bool OAIDevice::is_radio_Set() const{
    return m_radio_isSet;
}

bool OAIDevice::is_radio_Valid() const{
    return m_radio_isValid;
}

bool OAIDevice::getRemoteAccessEnabled() const {
    return m_remote_access_enabled;
}
void OAIDevice::setRemoteAccessEnabled(const bool &remote_access_enabled) {
    m_remote_access_enabled = remote_access_enabled;
    m_remote_access_enabled_isSet = true;
}

bool OAIDevice::is_remote_access_enabled_Set() const{
    return m_remote_access_enabled_isSet;
}

bool OAIDevice::is_remote_access_enabled_Valid() const{
    return m_remote_access_enabled_isValid;
}

bool OAIDevice::getRemoteDebugEnabled() const {
    return m_remote_debug_enabled;
}
void OAIDevice::setRemoteDebugEnabled(const bool &remote_debug_enabled) {
    m_remote_debug_enabled = remote_debug_enabled;
    m_remote_debug_enabled_isSet = true;
}

bool OAIDevice::is_remote_debug_enabled_Set() const{
    return m_remote_debug_enabled_isSet;
}

bool OAIDevice::is_remote_debug_enabled_Valid() const{
    return m_remote_debug_enabled_isValid;
}

QString OAIDevice::getFleetType() const {
    return m_fleet_type;
}
void OAIDevice::setFleetType(const QString &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAIDevice::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAIDevice::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

QString OAIDevice::getFleetName() const {
    return m_fleet_name;
}
void OAIDevice::setFleetName(const QString &fleet_name) {
    m_fleet_name = fleet_name;
    m_fleet_name_isSet = true;
}

bool OAIDevice::is_fleet_name_Set() const{
    return m_fleet_name_isSet;
}

bool OAIDevice::is_fleet_name_Valid() const{
    return m_fleet_name_isValid;
}

QList OAIDevice::getInstances() const {
    return m_instances;
}
void OAIDevice::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAIDevice::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAIDevice::is_instances_Valid() const{
    return m_instances_isValid;
}

OAIDeviceAvailability OAIDevice::getAvailability() const {
    return m_availability;
}
void OAIDevice::setAvailability(const OAIDeviceAvailability &availability) {
    m_availability = availability;
    m_availability_isSet = true;
}

bool OAIDevice::is_availability_Set() const{
    return m_availability_isSet;
}

bool OAIDevice::is_availability_Valid() const{
