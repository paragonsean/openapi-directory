...
/*
 * OAIRun_networkProfile.h
 *
 * 
 */

#ifndef OAIRun_networkProfile_H
#define OAIRun_networkProfile_H
...
class OAIRun_networkProfile : public OAIObject {
public:
    OAIRun_networkProfile();
    OAIRun_networkProfile(QString json);
    ~OAIRun_networkProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRun_networkProfile)

#endif // OAIRun_networkProfile_H
