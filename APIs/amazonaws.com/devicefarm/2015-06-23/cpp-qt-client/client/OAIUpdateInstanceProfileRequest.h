...
/*
 * OAIUpdateInstanceProfileRequest.h
 *
 * 
 */

#ifndef OAIUpdateInstanceProfileRequest_H
#define OAIUpdateInstanceProfileRequest_H
...
class OAIUpdateInstanceProfileRequest : public OAIObject {
public:
    OAIUpdateInstanceProfileRequest();
    OAIUpdateInstanceProfileRequest(QString json);
    ~OAIUpdateInstanceProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateInstanceProfileRequest)

#endif // OAIUpdateInstanceProfileRequest_H
