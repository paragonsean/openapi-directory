...
OAIScheduleRunRequest_executionConfiguration::OAIScheduleRunRequest_executionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleRunRequest_executionConfiguration::OAIScheduleRunRequest_executionConfiguration() {
    this->initializeModel();
}

OAIScheduleRunRequest_executionConfiguration::~OAIScheduleRunRequest_executionConfiguration() {}

void OAIScheduleRunRequest_executionConfiguration::initializeModel() {
...
void OAIScheduleRunRequest_executionConfiguration::fromJson(QString jsonString) {
...
void OAIScheduleRunRequest_executionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIScheduleRunRequest_executionConfiguration::asJson() const {
...
QJsonObject OAIScheduleRunRequest_executionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIScheduleRunRequest_executionConfiguration::getJobTimeoutMinutes() const {
    return m_job_timeout_minutes;
}
void OAIScheduleRunRequest_executionConfiguration::setJobTimeoutMinutes(const qint32 &job_timeout_minutes) {
    m_job_timeout_minutes = job_timeout_minutes;
    m_job_timeout_minutes_isSet = true;
}

bool OAIScheduleRunRequest_executionConfiguration::is_job_timeout_minutes_Set() const{
    return m_job_timeout_minutes_isSet;
}

bool OAIScheduleRunRequest_executionConfiguration::is_job_timeout_minutes_Valid() const{
    return m_job_timeout_minutes_isValid;
}

bool OAIScheduleRunRequest_executionConfiguration::getAccountsCleanup() const {
    return m_accounts_cleanup;
}
void OAIScheduleRunRequest_executionConfiguration::setAccountsCleanup(const bool &accounts_cleanup) {
    m_accounts_cleanup = accounts_cleanup;
    m_accounts_cleanup_isSet = true;
}

bool OAIScheduleRunRequest_executionConfiguration::is_accounts_cleanup_Set() const{
    return m_accounts_cleanup_isSet;
}

bool OAIScheduleRunRequest_executionConfiguration::is_accounts_cleanup_Valid() const{
    return m_accounts_cleanup_isValid;
}

bool OAIScheduleRunRequest_executionConfiguration::getAppPackagesCleanup() const {
    return m_app_packages_cleanup;
}
void OAIScheduleRunRequest_executionConfiguration::setAppPackagesCleanup(const bool &app_packages_cleanup) {
    m_app_packages_cleanup = app_packages_cleanup;
    m_app_packages_cleanup_isSet = true;
}

bool OAIScheduleRunRequest_executionConfiguration::is_app_packages_cleanup_Set() const{
    return m_app_packages_cleanup_isSet;
}

bool OAIScheduleRunRequest_executionConfiguration::is_app_packages_cleanup_Valid() const{
    return m_app_packages_cleanup_isValid;
}

bool OAIScheduleRunRequest_executionConfiguration::getVideoCapture() const {
    return m_video_capture;
}
void OAIScheduleRunRequest_executionConfiguration::setVideoCapture(const bool &video_capture) {
    m_video_capture = video_capture;
    m_video_capture_isSet = true;
}

bool OAIScheduleRunRequest_executionConfiguration::is_video_capture_Set() const{
    return m_video_capture_isSet;
}

bool OAIScheduleRunRequest_executionConfiguration::is_video_capture_Valid() const{
    return m_video_capture_isValid;
}

bool OAIScheduleRunRequest_executionConfiguration::getSkipAppResign() const {
    return m_skip_app_resign;
}
void OAIScheduleRunRequest_executionConfiguration::setSkipAppResign(const bool &skip_app_resign) {
    m_skip_app_resign = skip_app_resign;
    m_skip_app_resign_isSet = true;
}

bool OAIScheduleRunRequest_executionConfiguration::is_skip_app_resign_Set() const{
    return m_skip_app_resign_isSet;
}

bool OAIScheduleRunRequest_executionConfiguration::is_skip_app_resign_Valid() const{
    return m_skip_app_resign_isValid;
}

bool OAIScheduleRunRequest_executionConfiguration::isSet() const {
...
bool OAIScheduleRunRequest_executionConfiguration::isValid() const {
