...
/*
 * OAICreateInstanceProfileRequest.h
 *
 * 
 */

#ifndef OAICreateInstanceProfileRequest_H
#define OAICreateInstanceProfileRequest_H
...
class OAICreateInstanceProfileRequest : public OAIObject {
public:
    OAICreateInstanceProfileRequest();
    OAICreateInstanceProfileRequest(QString json);
    ~OAICreateInstanceProfileRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInstanceProfileRequest)

#endif // OAICreateInstanceProfileRequest_H
