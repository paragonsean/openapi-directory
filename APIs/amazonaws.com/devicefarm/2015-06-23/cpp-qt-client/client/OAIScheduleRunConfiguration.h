...
/*
 * OAIScheduleRunConfiguration.h
 *
 * Represents the settings for a run. Includes things like location, radio states, auxiliary apps, and network profiles.
 */

#ifndef OAIScheduleRunConfiguration_H
#define OAIScheduleRunConfiguration_H
...
class OAIScheduleRunConfiguration : public OAIObject {
public:
    OAIScheduleRunConfiguration();
    OAIScheduleRunConfiguration(QString json);
    ~OAIScheduleRunConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleRunConfiguration)

#endif // OAIScheduleRunConfiguration_H
