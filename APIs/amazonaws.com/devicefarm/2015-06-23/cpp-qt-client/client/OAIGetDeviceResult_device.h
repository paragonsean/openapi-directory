...
/*
 * OAIGetDeviceResult_device.h
 *
 * 
 */

#ifndef OAIGetDeviceResult_device_H
#define OAIGetDeviceResult_device_H
...
class OAIGetDeviceResult_device : public OAIObject {
public:
    OAIGetDeviceResult_device();
    OAIGetDeviceResult_device(QString json);
    ~OAIGetDeviceResult_device() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDeviceResult_device)

#endif // OAIGetDeviceResult_device_H
