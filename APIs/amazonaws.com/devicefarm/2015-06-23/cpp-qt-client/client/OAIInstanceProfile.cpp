...
OAIInstanceProfile::OAIInstanceProfile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceProfile::OAIInstanceProfile() {
    this->initializeModel();
}

OAIInstanceProfile::~OAIInstanceProfile() {}

void OAIInstanceProfile::initializeModel() {
...
void OAIInstanceProfile::fromJson(QString jsonString) {
...
void OAIInstanceProfile::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceProfile::asJson() const {
...
QJsonObject OAIInstanceProfile::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIInstanceProfile::getArn() const {
    return m_arn;
}
void OAIInstanceProfile::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIInstanceProfile::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIInstanceProfile::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIInstanceProfile::getPackageCleanup() const {
    return m_package_cleanup;
}
void OAIInstanceProfile::setPackageCleanup(const bool &package_cleanup) {
    m_package_cleanup = package_cleanup;
    m_package_cleanup_isSet = true;
}

bool OAIInstanceProfile::is_package_cleanup_Set() const{
    return m_package_cleanup_isSet;
}

bool OAIInstanceProfile::is_package_cleanup_Valid() const{
    return m_package_cleanup_isValid;
}

QList OAIInstanceProfile::getExcludeAppPackagesFromCleanup() const {
    return m_exclude_app_packages_from_cleanup;
}
void OAIInstanceProfile::setExcludeAppPackagesFromCleanup(const QList &exclude_app_packages_from_cleanup) {
    m_exclude_app_packages_from_cleanup = exclude_app_packages_from_cleanup;
    m_exclude_app_packages_from_cleanup_isSet = true;
}

bool OAIInstanceProfile::is_exclude_app_packages_from_cleanup_Set() const{
    return m_exclude_app_packages_from_cleanup_isSet;
}

bool OAIInstanceProfile::is_exclude_app_packages_from_cleanup_Valid() const{
    return m_exclude_app_packages_from_cleanup_isValid;
}

bool OAIInstanceProfile::getRebootAfterUse() const {
    return m_reboot_after_use;
}
void OAIInstanceProfile::setRebootAfterUse(const bool &reboot_after_use) {
    m_reboot_after_use = reboot_after_use;
    m_reboot_after_use_isSet = true;
}

bool OAIInstanceProfile::is_reboot_after_use_Set() const{
    return m_reboot_after_use_isSet;
}

bool OAIInstanceProfile::is_reboot_after_use_Valid() const{
    return m_reboot_after_use_isValid;
}

QString OAIInstanceProfile::getName() const {
    return m_name;
}
void OAIInstanceProfile::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInstanceProfile::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInstanceProfile::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIInstanceProfile::getDescription() const {
    return m_description;
}
void OAIInstanceProfile::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIInstanceProfile::is_description_Set() const{
    return m_description_isSet;
}

bool OAIInstanceProfile::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIInstanceProfile::isSet() const {
...
bool OAIInstanceProfile::isValid() const {
