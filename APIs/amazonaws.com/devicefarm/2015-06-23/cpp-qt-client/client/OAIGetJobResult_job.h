...
/*
 * OAIGetJobResult_job.h
 *
 * 
 */

#ifndef OAIGetJobResult_job_H
#define OAIGetJobResult_job_H
...
class OAIGetJobResult_job : public OAIObject {
public:
    OAIGetJobResult_job();
    OAIGetJobResult_job(QString json);
    ~OAIGetJobResult_job() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobResult_job)

#endif // OAIGetJobResult_job_H
