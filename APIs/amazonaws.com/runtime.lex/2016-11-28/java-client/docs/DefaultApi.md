...
# **deleteSession**
> DeleteSessionResponse deleteSession(botName, botAlias, userId, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
<a id="getSession"></a>
# **getSession**
> GetSessionResponse getSession(botName, botAlias, userId, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, checkpointLabelFilter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String botName = "botName_example"; // String | The name of the bot that contains the session data.
    String botAlias = "botAlias_example"; // String | The alias in use for the bot that contains the session data.
    String userId = "userId_example"; // String | The ID of the client application user. Amazon Lex uses this to identify a user's conversation with your bot. 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    String xAmzSignature = "xAmzSignature_example"; // String | 
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    String checkpointLabelFilter = "checkpointLabelFilter_example"; // String | <p>A string used to filter the intents returned in the <code>recentIntentSummaryView</code> structure. </p> <p>When you specify a filter, only intents with their <code>checkpointLabel</code> field set to that string are returned.</p>
    try {
      GetSessionResponse result = apiInstance.getSession(botName, botAlias, userId, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, checkpointLabelFilter);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="postContent"></a>
# **postContent**
> PostContentResponse postContent(botName, botAlias, userId, contentType, postContentRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmzLexSessionAttributes, xAmzLexRequestAttributes, accept, xAmzLexActiveContexts)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xAmzLexActiveContexts = "xAmzLexActiveContexts_example"; // String | <p>A list of contexts active for the request. A context can be activated when a previous intent is fulfilled, or by including the context in the request,</p> <p>If you don't specify a list of contexts, Amazon Lex will use the current list of contexts for the session. If you specify an empty list, all contexts for the session are cleared.</p>
    try {
      PostContentResponse result = apiInstance.postContent(botName, botAlias, userId, contentType, postContentRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, xAmzLexSessionAttributes, xAmzLexRequestAttributes, accept, xAmzLexActiveContexts);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#postContent");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **483** | InternalFailureException |  -  |
| **484** | ConflictException |  -  |
| **485** | UnsupportedMediaTypeException |  -  |
| **486** | NotAcceptableException |  -  |
| **487** | RequestTimeoutException |  -  |
| **488** | DependencyFailedException |  -  |
| **489** | BadGatewayException |  -  |
| **490** | LoopDetectedException |  -  |

<a id="postText"></a>
# **postText**
> PostTextResponse postText(botName, botAlias, userId, postTextRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders)
...
public class Example {
  public static void main(String[] args) {
    ...
    String botAlias = "botAlias_example"; // String | The alias of the Amazon Lex bot.
    String userId = "userId_example"; // String | <p>The ID of the client application user. Amazon Lex uses this to identify a user's conversation with your bot. At runtime, each request must contain the <code>userID</code> field.</p> <p>To decide the user ID to use for your application, consider the following factors.</p> <ul> <li> <p>The <code>userID</code> field must not contain any personally identifiable information of the user, for example, name, personal identification numbers, or other end user personal information.</p> </li> <li> <p>If you want a user to start a conversation on one device and continue on another device, use a user-specific identifier.</p> </li> <li> <p>If you want the same user to be able to have two independent conversations on two different devices, choose a device-specific identifier.</p> </li> <li> <p>A user can't have two independent conversations with two different versions of the same bot. For example, a user can't have a conversation with the PROD and BETA versions of the same bot. If you anticipate that a user will need to have conversation with two different versions, for example, while testing, include the bot alias in the user ID to separate the two conversations.</p> </li> </ul>
    ...
    String xAmzSignedHeaders = "xAmzSignedHeaders_example"; // String | 
    try {
      PostTextResponse result = apiInstance.postText(botName, botAlias, userId, postTextRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#postText");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **487** | LoopDetectedException |  -  |

<a id="putSession"></a>
# **putSession**
> PutSessionResponse putSession(botName, botAlias, userId, putSessionRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, accept)
...
public class Example {
  public static void main(String[] args) {
    ...
    String botAlias = "botAlias_example"; // String | The alias in use for the bot that contains the session data.
    String userId = "userId_example"; // String | The ID of the client application user. Amazon Lex uses this to identify a user's conversation with your bot. 
    PutSessionRequest putSessionRequest = new PutSessionRequest(); // PutSessionRequest | 
    String xAmzContentSha256 = "xAmzContentSha256_example"; // String | 
    String xAmzDate = "xAmzDate_example"; // String | 
    String xAmzAlgorithm = "xAmzAlgorithm_example"; // String | 
    String xAmzCredential = "xAmzCredential_example"; // String | 
    ...
    try {
      PutSessionResponse result = apiInstance.putSession(botName, botAlias, userId, putSessionRequest, xAmzContentSha256, xAmzDate, xAmzAlgorithm, xAmzCredential, xAmzSecurityToken, xAmzSignature, xAmzSignedHeaders, accept);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DefaultApi#putSession");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **483** | InternalFailureException |  -  |
| **484** | ConflictException |  -  |
| **485** | NotAcceptableException |  -  |
| **486** | DependencyFailedException |  -  |
| **487** | BadGatewayException |  -  |
