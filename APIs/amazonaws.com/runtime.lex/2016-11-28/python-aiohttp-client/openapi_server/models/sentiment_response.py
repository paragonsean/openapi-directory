...
class SentimentResponse(Model):
    ...
    def __init__(self, sentiment_label: str=None, sentiment_score: str=None):
        ...
        :param sentiment_label: The sentiment_label of this SentimentResponse.
        :param sentiment_score: The sentiment_score of this SentimentResponse.
        """
        self.openapi_types = {
            'sentiment_label': str,
            'sentiment_score': str
    ...
    def sentiment_label(self):
        """Gets the sentiment_label of this SentimentResponse.


        :return: The sentiment_label of this SentimentResponse.
        :rtype: str
        """
    ...
    def sentiment_label(self, sentiment_label):
        """Sets the sentiment_label of this SentimentResponse.
    ...
    def sentiment_score(self):
        """Gets the sentiment_score of this SentimentResponse.


        :return: The sentiment_score of this SentimentResponse.
        :rtype: str
        """
    ...
    def sentiment_score(self, sentiment_score):
        """Sets the sentiment_score of this SentimentResponse.
