...
/*
 * OAIPostTextResponse_responseCard.h
 *
 * 
 */

#ifndef OAIPostTextResponse_responseCard_H
#define OAIPostTextResponse_responseCard_H
...
class OAIPostTextResponse_responseCard : public OAIObject {
public:
    OAIPostTextResponse_responseCard();
    OAIPostTextResponse_responseCard(QString json);
    ~OAIPostTextResponse_responseCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostTextResponse_responseCard)

#endif // OAIPostTextResponse_responseCard_H
