...
/*
 * OAIActiveContextTimeToLive.h
 *
 * The length of time or number of turns that a context remains active.
 */

#ifndef OAIActiveContextTimeToLive_H
#define OAIActiveContextTimeToLive_H
...
class OAIActiveContextTimeToLive : public OAIObject {
public:
    OAIActiveContextTimeToLive();
    OAIActiveContextTimeToLive(QString json);
    ~OAIActiveContextTimeToLive() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActiveContextTimeToLive)

#endif // OAIActiveContextTimeToLive_H
