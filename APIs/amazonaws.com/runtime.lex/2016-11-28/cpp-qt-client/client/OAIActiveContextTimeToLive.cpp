...
#include "OAIActiveContextTimeToLive.h"
...
OAIActiveContextTimeToLive::OAIActiveContextTimeToLive(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActiveContextTimeToLive::OAIActiveContextTimeToLive() {
    this->initializeModel();
}

OAIActiveContextTimeToLive::~OAIActiveContextTimeToLive() {}

void OAIActiveContextTimeToLive::initializeModel() {
...
void OAIActiveContextTimeToLive::fromJson(QString jsonString) {
...
void OAIActiveContextTimeToLive::fromJsonObject(QJsonObject json) {
...
QString OAIActiveContextTimeToLive::asJson() const {
...
QJsonObject OAIActiveContextTimeToLive::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIActiveContextTimeToLive::getTimeToLiveInSeconds() const {
    return m_time_to_live_in_seconds;
}
void OAIActiveContextTimeToLive::setTimeToLiveInSeconds(const qint32 &time_to_live_in_seconds) {
    m_time_to_live_in_seconds = time_to_live_in_seconds;
    m_time_to_live_in_seconds_isSet = true;
}

bool OAIActiveContextTimeToLive::is_time_to_live_in_seconds_Set() const{
    return m_time_to_live_in_seconds_isSet;
}

bool OAIActiveContextTimeToLive::is_time_to_live_in_seconds_Valid() const{
    return m_time_to_live_in_seconds_isValid;
}

qint32 OAIActiveContextTimeToLive::getTurnsToLive() const {
    return m_turns_to_live;
}
void OAIActiveContextTimeToLive::setTurnsToLive(const qint32 &turns_to_live) {
    m_turns_to_live = turns_to_live;
    m_turns_to_live_isSet = true;
}

bool OAIActiveContextTimeToLive::is_turns_to_live_Set() const{
    return m_turns_to_live_isSet;
}

bool OAIActiveContextTimeToLive::is_turns_to_live_Valid() const{
    return m_turns_to_live_isValid;
}

bool OAIActiveContextTimeToLive::isSet() const {
...
bool OAIActiveContextTimeToLive::isValid() const {
