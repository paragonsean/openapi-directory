...
/*
 * OAIPutSession_request_dialogAction.h
 *
...
#ifndef OAIPutSession_request_dialogAction_H
#define OAIPutSession_request_dialogAction_H
...
class OAIPutSession_request_dialogAction : public OAIObject {
public:
    OAIPutSession_request_dialogAction();
    OAIPutSession_request_dialogAction(QString json);
    ~OAIPutSession_request_dialogAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSession_request_dialogAction)

#endif // OAIPutSession_request_dialogAction_H
