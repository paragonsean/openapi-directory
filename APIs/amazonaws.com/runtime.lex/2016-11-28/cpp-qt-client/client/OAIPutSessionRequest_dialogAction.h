...
/*
 * OAIPutSessionRequest_dialogAction.h
 *
 * 
 */

#ifndef OAIPutSessionRequest_dialogAction_H
#define OAIPutSessionRequest_dialogAction_H
...
class OAIPutSessionRequest_dialogAction : public OAIObject {
public:
    OAIPutSessionRequest_dialogAction();
    OAIPutSessionRequest_dialogAction(QString json);
    ~OAIPutSessionRequest_dialogAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSessionRequest_dialogAction)

#endif // OAIPutSessionRequest_dialogAction_H
