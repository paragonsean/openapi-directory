...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexRuntimeService.GetSessionResponseDialogAction();
  });
  ...
  describe('GetSessionResponseDialogAction', function() {
    it('should create an instance of GetSessionResponseDialogAction', function() {
      // uncomment below and update the code to test GetSessionResponseDialogAction
      //var instance = new AmazonLexRuntimeService.GetSessionResponseDialogAction();
      //expect(instance).to.be.a(AmazonLexRuntimeService.GetSessionResponseDialogAction);
    });
