...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexRuntimeService.PostTextRequest();
  });
  ...
  describe('PostTextRequest', function() {
    it('should create an instance of PostTextRequest', function() {
      // uncomment below and update the code to test PostTextRequest
      //var instance = new AmazonLexRuntimeService.PostTextRequest();
      //expect(instance).to.be.a(AmazonLexRuntimeService.PostTextRequest);
    });
