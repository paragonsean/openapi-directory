...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexRuntimeService.PutSessionRequestDialogAction();
  });
  ...
  describe('PutSessionRequestDialogAction', function() {
    it('should create an instance of PutSessionRequestDialogAction', function() {
      // uncomment below and update the code to test PutSessionRequestDialogAction
      //var instance = new AmazonLexRuntimeService.PutSessionRequestDialogAction();
      //expect(instance).to.be.a(AmazonLexRuntimeService.PutSessionRequestDialogAction);
    });
