...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexRuntimeService.PredictedIntent();
  });
  ...
  describe('PredictedIntent', function() {
    it('should create an instance of PredictedIntent', function() {
      // uncomment below and update the code to test PredictedIntent
      //var instance = new AmazonLexRuntimeService.PredictedIntent();
      //expect(instance).to.be.a(AmazonLexRuntimeService.PredictedIntent);
    });
