...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexRuntimeService.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('postContent', function() {
      it('should call postContent successfully', function(done) {
        //uncomment below and update the code to test postContent
        //instance.postContent(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postText', function() {
      it('should call postText successfully', function(done) {
        //uncomment below and update the code to test postText
        //instance.postText(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putSession', function() {
      it('should call putSession successfully', function(done) {
        //uncomment below and update the code to test putSession
        //instance.putSession(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
