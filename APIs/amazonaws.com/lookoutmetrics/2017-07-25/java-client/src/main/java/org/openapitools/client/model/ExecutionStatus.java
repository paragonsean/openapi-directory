...
public class ExecutionStatus {
  ...
  private AnomalyDetectionTaskStatus status;
  ...
  public ExecutionStatus timestamp(String timestamp) {
  ...
  public ExecutionStatus status(AnomalyDetectionTaskStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AnomalyDetectionTaskStatus getStatus() {
    return status;
  }

  public void setStatus(AnomalyDetectionTaskStatus status) {
    this.status = status;
  }


  public ExecutionStatus failureReason(String failureReason) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timestamp, executionStatus.timestamp) &&
        Objects.equals(this.status, executionStatus.status) &&
        Objects.equals(this.failureReason, executionStatus.failureReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, status, failureReason);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        AnomalyDetectionTaskStatus.validateJsonElement(jsonObj.get("Status"));
      }
