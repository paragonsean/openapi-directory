...
public class DescribeAlertResponseAlert {
  ...
  public DescribeAlertResponseAlert() {
  }

  public DescribeAlertResponseAlert action(AlertAction action) {
    this.action = action;
    return this;
  }
  ...
  public DescribeAlertResponseAlert alertDescription(String alertDescription) {
  ...
  public DescribeAlertResponseAlert alertArn(String alertArn) {
  ...
  public DescribeAlertResponseAlert anomalyDetectorArn(String anomalyDetectorArn) {
  ...
  public DescribeAlertResponseAlert alertName(String alertName) {
  ...
  public DescribeAlertResponseAlert alertSensitivityThreshold(Integer alertSensitivityThreshold) {
  ...
  public DescribeAlertResponseAlert alertType(AlertType alertType) {
  ...
  public DescribeAlertResponseAlert alertStatus(AlertStatus alertStatus) {
  ...
  public DescribeAlertResponseAlert lastModificationTime(OffsetDateTime lastModificationTime) {
  ...
  public DescribeAlertResponseAlert creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeAlertResponseAlert alertFilters(AlertAlertFilters alertFilters) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAlertResponseAlert describeAlertResponseAlert = (DescribeAlertResponseAlert) o;
    return Objects.equals(this.action, describeAlertResponseAlert.action) &&
        Objects.equals(this.alertDescription, describeAlertResponseAlert.alertDescription) &&
        Objects.equals(this.alertArn, describeAlertResponseAlert.alertArn) &&
        Objects.equals(this.anomalyDetectorArn, describeAlertResponseAlert.anomalyDetectorArn) &&
        Objects.equals(this.alertName, describeAlertResponseAlert.alertName) &&
        Objects.equals(this.alertSensitivityThreshold, describeAlertResponseAlert.alertSensitivityThreshold) &&
        Objects.equals(this.alertType, describeAlertResponseAlert.alertType) &&
        Objects.equals(this.alertStatus, describeAlertResponseAlert.alertStatus) &&
        Objects.equals(this.lastModificationTime, describeAlertResponseAlert.lastModificationTime) &&
        Objects.equals(this.creationTime, describeAlertResponseAlert.creationTime) &&
        Objects.equals(this.alertFilters, describeAlertResponseAlert.alertFilters);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAlertResponseAlert {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAlertResponseAlert
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAlertResponseAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAlertResponseAlert is not found in the empty JSON string", DescribeAlertResponseAlert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAlertResponseAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAlertResponseAlert` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAlertResponseAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAlertResponseAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAlertResponseAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAlertResponseAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAlertResponseAlert>() {
           @Override
           public void write(JsonWriter out, DescribeAlertResponseAlert value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAlertResponseAlert read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAlertResponseAlert given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAlertResponseAlert
   * @throws IOException if the JSON string is invalid with respect to DescribeAlertResponseAlert
   */
  public static DescribeAlertResponseAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAlertResponseAlert.class);
  }

  /**
   * Convert an instance of DescribeAlertResponseAlert to an JSON string
   *
   * @return JSON string
   */
