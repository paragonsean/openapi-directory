...
public class AthenaSourceConfig {
  ...
  public AthenaSourceConfig roleArn(String roleArn) {
  ...
  public AthenaSourceConfig databaseName(String databaseName) {
  ...
  public AthenaSourceConfig dataCatalog(String dataCatalog) {
  ...
  public AthenaSourceConfig tableName(String tableName) {
  ...
  public AthenaSourceConfig workGroupName(String workGroupName) {
  ...
  public AthenaSourceConfig s3ResultsPath(String s3ResultsPath) {
  ...
  public AthenaSourceConfig backTestConfiguration(CloudWatchConfigBackTestConfiguration backTestConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    AthenaSourceConfig athenaSourceConfig = (AthenaSourceConfig) o;
    return Objects.equals(this.roleArn, athenaSourceConfig.roleArn) &&
        Objects.equals(this.databaseName, athenaSourceConfig.databaseName) &&
        Objects.equals(this.dataCatalog, athenaSourceConfig.dataCatalog) &&
        Objects.equals(this.tableName, athenaSourceConfig.tableName) &&
        Objects.equals(this.workGroupName, athenaSourceConfig.workGroupName) &&
        Objects.equals(this.s3ResultsPath, athenaSourceConfig.s3ResultsPath) &&
        Objects.equals(this.backTestConfiguration, athenaSourceConfig.backTestConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class AthenaSourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AthenaSourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AthenaSourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AthenaSourceConfig is not found in the empty JSON string", AthenaSourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AthenaSourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AthenaSourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AthenaSourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AthenaSourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AthenaSourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AthenaSourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AthenaSourceConfig>() {
           @Override
           public void write(JsonWriter out, AthenaSourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AthenaSourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AthenaSourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AthenaSourceConfig
   * @throws IOException if the JSON string is invalid with respect to AthenaSourceConfig
   */
  public static AthenaSourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AthenaSourceConfig.class);
  }

  /**
   * Convert an instance of AthenaSourceConfig to an JSON string
   *
   * @return JSON string
   */
