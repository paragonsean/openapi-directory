...
public class CreateMetricSetRequestMetricSource {
  ...
  public CreateMetricSetRequestMetricSource() {
  }

  public CreateMetricSetRequestMetricSource s3SourceConfig(S3SourceConfig s3SourceConfig) {
  ...
  public CreateMetricSetRequestMetricSource appFlowConfig(CreateMetricSetRequestMetricSourceAppFlowConfig appFlowConfig) {
  ...
  public CreateMetricSetRequestMetricSource cloudWatchConfig(CreateMetricSetRequestMetricSourceCloudWatchConfig cloudWatchConfig) {
  ...
  public CreateMetricSetRequestMetricSource rdSSourceConfig(CreateMetricSetRequestMetricSourceRDSSourceConfig rdSSourceConfig) {
  ...
  public CreateMetricSetRequestMetricSource redshiftSourceConfig(CreateMetricSetRequestMetricSourceRedshiftSourceConfig redshiftSourceConfig) {
  ...
  public CreateMetricSetRequestMetricSource athenaSourceConfig(CreateMetricSetRequestMetricSourceAthenaSourceConfig athenaSourceConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CreateMetricSetRequestMetricSource createMetricSetRequestMetricSource = (CreateMetricSetRequestMetricSource) o;
    return Objects.equals(this.s3SourceConfig, createMetricSetRequestMetricSource.s3SourceConfig) &&
        Objects.equals(this.appFlowConfig, createMetricSetRequestMetricSource.appFlowConfig) &&
        Objects.equals(this.cloudWatchConfig, createMetricSetRequestMetricSource.cloudWatchConfig) &&
        Objects.equals(this.rdSSourceConfig, createMetricSetRequestMetricSource.rdSSourceConfig) &&
        Objects.equals(this.redshiftSourceConfig, createMetricSetRequestMetricSource.redshiftSourceConfig) &&
        Objects.equals(this.athenaSourceConfig, createMetricSetRequestMetricSource.athenaSourceConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateMetricSetRequestMetricSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMetricSetRequestMetricSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMetricSetRequestMetricSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMetricSetRequestMetricSource is not found in the empty JSON string", CreateMetricSetRequestMetricSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMetricSetRequestMetricSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMetricSetRequestMetricSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMetricSetRequestMetricSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMetricSetRequestMetricSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMetricSetRequestMetricSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMetricSetRequestMetricSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMetricSetRequestMetricSource>() {
           @Override
           public void write(JsonWriter out, CreateMetricSetRequestMetricSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMetricSetRequestMetricSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMetricSetRequestMetricSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMetricSetRequestMetricSource
   * @throws IOException if the JSON string is invalid with respect to CreateMetricSetRequestMetricSource
   */
  public static CreateMetricSetRequestMetricSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMetricSetRequestMetricSource.class);
  }

  /**
   * Convert an instance of CreateMetricSetRequestMetricSource to an JSON string
   *
   * @return JSON string
   */
