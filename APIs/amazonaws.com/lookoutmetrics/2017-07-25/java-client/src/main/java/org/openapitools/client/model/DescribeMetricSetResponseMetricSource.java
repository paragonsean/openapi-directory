...
public class DescribeMetricSetResponseMetricSource {
  ...
  public DescribeMetricSetResponseMetricSource() {
  }

  public DescribeMetricSetResponseMetricSource s3SourceConfig(S3SourceConfig s3SourceConfig) {
  ...
  public DescribeMetricSetResponseMetricSource appFlowConfig(CreateMetricSetRequestMetricSourceAppFlowConfig appFlowConfig) {
  ...
  public DescribeMetricSetResponseMetricSource cloudWatchConfig(CreateMetricSetRequestMetricSourceCloudWatchConfig cloudWatchConfig) {
  ...
  public DescribeMetricSetResponseMetricSource rdSSourceConfig(CreateMetricSetRequestMetricSourceRDSSourceConfig rdSSourceConfig) {
  ...
  public DescribeMetricSetResponseMetricSource redshiftSourceConfig(CreateMetricSetRequestMetricSourceRedshiftSourceConfig redshiftSourceConfig) {
  ...
  public DescribeMetricSetResponseMetricSource athenaSourceConfig(CreateMetricSetRequestMetricSourceAthenaSourceConfig athenaSourceConfig) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeMetricSetResponseMetricSource describeMetricSetResponseMetricSource = (DescribeMetricSetResponseMetricSource) o;
    return Objects.equals(this.s3SourceConfig, describeMetricSetResponseMetricSource.s3SourceConfig) &&
        Objects.equals(this.appFlowConfig, describeMetricSetResponseMetricSource.appFlowConfig) &&
        Objects.equals(this.cloudWatchConfig, describeMetricSetResponseMetricSource.cloudWatchConfig) &&
        Objects.equals(this.rdSSourceConfig, describeMetricSetResponseMetricSource.rdSSourceConfig) &&
        Objects.equals(this.redshiftSourceConfig, describeMetricSetResponseMetricSource.redshiftSourceConfig) &&
        Objects.equals(this.athenaSourceConfig, describeMetricSetResponseMetricSource.athenaSourceConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeMetricSetResponseMetricSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeMetricSetResponseMetricSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeMetricSetResponseMetricSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeMetricSetResponseMetricSource is not found in the empty JSON string", DescribeMetricSetResponseMetricSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeMetricSetResponseMetricSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeMetricSetResponseMetricSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeMetricSetResponseMetricSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeMetricSetResponseMetricSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeMetricSetResponseMetricSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeMetricSetResponseMetricSource.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeMetricSetResponseMetricSource>() {
           @Override
           public void write(JsonWriter out, DescribeMetricSetResponseMetricSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeMetricSetResponseMetricSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeMetricSetResponseMetricSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeMetricSetResponseMetricSource
   * @throws IOException if the JSON string is invalid with respect to DescribeMetricSetResponseMetricSource
   */
  public static DescribeMetricSetResponseMetricSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeMetricSetResponseMetricSource.class);
  }

  /**
   * Convert an instance of DescribeMetricSetResponseMetricSource to an JSON string
   *
   * @return JSON string
   */
