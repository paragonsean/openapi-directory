...
|**relationshipTypeFilter** | [**RelationshipTypeFilterEnum**](#RelationshipTypeFilterEnum) | Filter for potential causes (&lt;code&gt;CAUSE_OF_INPUT_ANOMALY_GROUP&lt;/code&gt;) or downstream effects (&lt;code&gt;EFFECT_OF_INPUT_ANOMALY_GROUP&lt;/code&gt;) of the anomaly group. |  [optional] |
