...
/*
 * OAIAlert_AlertFilters.h
 *
 * 
 */

#ifndef OAIAlert_AlertFilters_H
#define OAIAlert_AlertFilters_H
...
class OAIAlert_AlertFilters : public OAIObject {
public:
    OAIAlert_AlertFilters();
    OAIAlert_AlertFilters(QString json);
    ~OAIAlert_AlertFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlert_AlertFilters)

#endif // OAIAlert_AlertFilters_H
