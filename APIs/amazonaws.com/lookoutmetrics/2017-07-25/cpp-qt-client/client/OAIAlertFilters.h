...
#ifndef OAIAlertFilters_H
#define OAIAlertFilters_H
...
class OAIAlertFilters : public OAIObject {
public:
    OAIAlertFilters();
    OAIAlertFilters(QString json);
    ~OAIAlertFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlertFilters)

#endif // OAIAlertFilters_H
