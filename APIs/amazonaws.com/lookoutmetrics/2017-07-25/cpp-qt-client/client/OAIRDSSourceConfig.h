...
/*
 * OAIRDSSourceConfig.h
 *
 * Contains information about the Amazon Relational Database Service (RDS) configuration.
 */

#ifndef OAIRDSSourceConfig_H
#define OAIRDSSourceConfig_H
...
class OAIRDSSourceConfig : public OAIObject {
public:
    OAIRDSSourceConfig();
    OAIRDSSourceConfig(QString json);
    ~OAIRDSSourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRDSSourceConfig)

#endif // OAIRDSSourceConfig_H
