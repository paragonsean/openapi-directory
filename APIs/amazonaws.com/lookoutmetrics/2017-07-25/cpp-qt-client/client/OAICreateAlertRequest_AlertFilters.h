...
/*
 * OAICreateAlertRequest_AlertFilters.h
 *
 * 
 */

#ifndef OAICreateAlertRequest_AlertFilters_H
#define OAICreateAlertRequest_AlertFilters_H
...
class OAICreateAlertRequest_AlertFilters : public OAIObject {
public:
    OAICreateAlertRequest_AlertFilters();
    OAICreateAlertRequest_AlertFilters(QString json);
    ~OAICreateAlertRequest_AlertFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAlertRequest_AlertFilters)

#endif // OAICreateAlertRequest_AlertFilters_H
