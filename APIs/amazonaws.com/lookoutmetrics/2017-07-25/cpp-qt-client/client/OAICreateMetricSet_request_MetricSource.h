...
/*
 * OAICreateMetricSet_request_MetricSource.h
 *
 * Contains information about source data used to generate metrics.
 */

#ifndef OAICreateMetricSet_request_MetricSource_H
#define OAICreateMetricSet_request_MetricSource_H
...
class OAICreateMetricSet_request_MetricSource : public OAIObject {
public:
    OAICreateMetricSet_request_MetricSource();
    OAICreateMetricSet_request_MetricSource(QString json);
    ~OAICreateMetricSet_request_MetricSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMetricSet_request_MetricSource)

#endif // OAICreateMetricSet_request_MetricSource_H
