...
OAIUpdateMetricSet_request::OAIUpdateMetricSet_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateMetricSet_request::OAIUpdateMetricSet_request() {
    this->initializeModel();
}

OAIUpdateMetricSet_request::~OAIUpdateMetricSet_request() {}

void OAIUpdateMetricSet_request::initializeModel() {
...
void OAIUpdateMetricSet_request::fromJson(QString jsonString) {
...
void OAIUpdateMetricSet_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateMetricSet_request::asJson() const {
...
QJsonObject OAIUpdateMetricSet_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateMetricSet_request::getMetricSetArn() const {
    return m_metric_set_arn;
}
void OAIUpdateMetricSet_request::setMetricSetArn(const QString &metric_set_arn) {
    m_metric_set_arn = metric_set_arn;
    m_metric_set_arn_isSet = true;
}

bool OAIUpdateMetricSet_request::is_metric_set_arn_Set() const{
    return m_metric_set_arn_isSet;
}

bool OAIUpdateMetricSet_request::is_metric_set_arn_Valid() const{
    return m_metric_set_arn_isValid;
}

QString OAIUpdateMetricSet_request::getMetricSetDescription() const {
    return m_metric_set_description;
}
void OAIUpdateMetricSet_request::setMetricSetDescription(const QString &metric_set_description) {
    m_metric_set_description = metric_set_description;
    m_metric_set_description_isSet = true;
}

bool OAIUpdateMetricSet_request::is_metric_set_description_Set() const{
    return m_metric_set_description_isSet;
}

bool OAIUpdateMetricSet_request::is_metric_set_description_Valid() const{
    return m_metric_set_description_isValid;
}

QList<OAIMetric> OAIUpdateMetricSet_request::getMetricList() const {
    return m_metric_list;
}
void OAIUpdateMetricSet_request::setMetricList(const QList<OAIMetric> &metric_list) {
    m_metric_list = metric_list;
    m_metric_list_isSet = true;
}

bool OAIUpdateMetricSet_request::is_metric_list_Set() const{
    return m_metric_list_isSet;
}

bool OAIUpdateMetricSet_request::is_metric_list_Valid() const{
    return m_metric_list_isValid;
}

qint32 OAIUpdateMetricSet_request::getOffset() const {
    return m_offset;
}
void OAIUpdateMetricSet_request::setOffset(const qint32 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIUpdateMetricSet_request::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIUpdateMetricSet_request::is_offset_Valid() const{
    return m_offset_isValid;
}

OAICreateMetricSet_request_TimestampColumn OAIUpdateMetricSet_request::getTimestampColumn() const {
    return m_timestamp_column;
}
void OAIUpdateMetricSet_request::setTimestampColumn(const OAICreateMetricSet_request_TimestampColumn &timestamp_column) {
    m_timestamp_column = timestamp_column;
    m_timestamp_column_isSet = true;
}

bool OAIUpdateMetricSet_request::is_timestamp_column_Set() const{
    return m_timestamp_column_isSet;
}

bool OAIUpdateMetricSet_request::is_timestamp_column_Valid() const{
    return m_timestamp_column_isValid;
}

QList<QString> OAIUpdateMetricSet_request::getDimensionList() const {
    return m_dimension_list;
}
void OAIUpdateMetricSet_request::setDimensionList(const QList<QString> &dimension_list) {
    m_dimension_list = dimension_list;
    m_dimension_list_isSet = true;
}

bool OAIUpdateMetricSet_request::is_dimension_list_Set() const{
    return m_dimension_list_isSet;
}

bool OAIUpdateMetricSet_request::is_dimension_list_Valid() const{
    return m_dimension_list_isValid;
}

QString OAIUpdateMetricSet_request::getMetricSetFrequency() const {
    return m_metric_set_frequency;
}
void OAIUpdateMetricSet_request::setMetricSetFrequency(const QString &metric_set_frequency) {
    m_metric_set_frequency = metric_set_frequency;
    m_metric_set_frequency_isSet = true;
}

bool OAIUpdateMetricSet_request::is_metric_set_frequency_Set() const{
    return m_metric_set_frequency_isSet;
}

bool OAIUpdateMetricSet_request::is_metric_set_frequency_Valid() const{
    return m_metric_set_frequency_isValid;
}

OAICreateMetricSet_request_MetricSource OAIUpdateMetricSet_request::getMetricSource() const {
    return m_metric_source;
}
void OAIUpdateMetricSet_request::setMetricSource(const OAICreateMetricSet_request_MetricSource &metric_source) {
    m_metric_source = metric_source;
    m_metric_source_isSet = true;
}

bool OAIUpdateMetricSet_request::is_metric_source_Set() const{
    return m_metric_source_isSet;
}

bool OAIUpdateMetricSet_request::is_metric_source_Valid() const{
    return m_metric_source_isValid;
}

QList<OAIMetricSetDimensionFilter> OAIUpdateMetricSet_request::getDimensionFilterList() const {
    return m_dimension_filter_list;
}
void OAIUpdateMetricSet_request::setDimensionFilterList(const QList<OAIMetricSetDimensionFilter> &dimension_filter_list) {
    m_dimension_filter_list = dimension_filter_list;
    m_dimension_filter_list_isSet = true;
}

bool OAIUpdateMetricSet_request::is_dimension_filter_list_Set() const{
    return m_dimension_filter_list_isSet;
}

bool OAIUpdateMetricSet_request::is_dimension_filter_list_Valid() const{
    return m_dimension_filter_list_isValid;
}

bool OAIUpdateMetricSet_request::isSet() const {
...
bool OAIUpdateMetricSet_request::isValid() const {
