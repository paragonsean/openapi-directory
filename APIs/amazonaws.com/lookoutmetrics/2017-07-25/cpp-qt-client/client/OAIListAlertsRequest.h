...
/*
 * OAIListAlertsRequest.h
 *
 * 
 */

#ifndef OAIListAlertsRequest_H
#define OAIListAlertsRequest_H
...
class OAIListAlertsRequest : public OAIObject {
public:
    OAIListAlertsRequest();
    OAIListAlertsRequest(QString json);
    ~OAIListAlertsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAlertsRequest)

#endif // OAIListAlertsRequest_H
