...
/*
 * OAIUpdateAlert_request.h
 *
 * 
 */

#ifndef OAIUpdateAlert_request_H
#define OAIUpdateAlert_request_H
...
class OAIUpdateAlert_request : public OAIObject {
public:
    OAIUpdateAlert_request();
    OAIUpdateAlert_request(QString json);
    ~OAIUpdateAlert_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAlert_request)

#endif // OAIUpdateAlert_request_H
