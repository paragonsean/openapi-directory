...
/*
 * OAIAnomalyDetectorSummary.h
 *
 * Contains information about an an anomaly detector.
 */

#ifndef OAIAnomalyDetectorSummary_H
#define OAIAnomalyDetectorSummary_H
...
class OAIAnomalyDetectorSummary : public OAIObject {
public:
    OAIAnomalyDetectorSummary();
    OAIAnomalyDetectorSummary(QString json);
    ~OAIAnomalyDetectorSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnomalyDetectorSummary)

#endif // OAIAnomalyDetectorSummary_H
