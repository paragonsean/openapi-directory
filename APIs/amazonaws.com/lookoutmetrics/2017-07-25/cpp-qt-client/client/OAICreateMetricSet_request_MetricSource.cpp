...
OAICreateMetricSet_request_MetricSource::OAICreateMetricSet_request_MetricSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMetricSet_request_MetricSource::OAICreateMetricSet_request_MetricSource() {
    this->initializeModel();
}

OAICreateMetricSet_request_MetricSource::~OAICreateMetricSet_request_MetricSource() {}

void OAICreateMetricSet_request_MetricSource::initializeModel() {
...
void OAICreateMetricSet_request_MetricSource::fromJson(QString jsonString) {
...
void OAICreateMetricSet_request_MetricSource::fromJsonObject(QJsonObject json) {
...
QString OAICreateMetricSet_request_MetricSource::asJson() const {
...
QJsonObject OAICreateMetricSet_request_MetricSource::asJsonObject() const {
    QJsonObject obj;
...
OAIS3SourceConfig OAICreateMetricSet_request_MetricSource::getS3SourceConfig() const {
    return m_s3_source_config;
}
void OAICreateMetricSet_request_MetricSource::setS3SourceConfig(const OAIS3SourceConfig &s3_source_config) {
    m_s3_source_config = s3_source_config;
    m_s3_source_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_s3_source_config_Set() const{
    return m_s3_source_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_s3_source_config_Valid() const{
    return m_s3_source_config_isValid;
}

OAICreateMetricSet_request_MetricSource_AppFlowConfig OAICreateMetricSet_request_MetricSource::getAppFlowConfig() const {
    return m_app_flow_config;
}
void OAICreateMetricSet_request_MetricSource::setAppFlowConfig(const OAICreateMetricSet_request_MetricSource_AppFlowConfig &app_flow_config) {
    m_app_flow_config = app_flow_config;
    m_app_flow_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_app_flow_config_Set() const{
    return m_app_flow_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_app_flow_config_Valid() const{
    return m_app_flow_config_isValid;
}

OAICreateMetricSet_request_MetricSource_CloudWatchConfig OAICreateMetricSet_request_MetricSource::getCloudWatchConfig() const {
    return m_cloud_watch_config;
}
void OAICreateMetricSet_request_MetricSource::setCloudWatchConfig(const OAICreateMetricSet_request_MetricSource_CloudWatchConfig &cloud_watch_config) {
    m_cloud_watch_config = cloud_watch_config;
    m_cloud_watch_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_cloud_watch_config_Set() const{
    return m_cloud_watch_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_cloud_watch_config_Valid() const{
    return m_cloud_watch_config_isValid;
}

OAICreateMetricSet_request_MetricSource_RDSSourceConfig OAICreateMetricSet_request_MetricSource::getRdsSourceConfig() const {
    return m_rds_source_config;
}
void OAICreateMetricSet_request_MetricSource::setRdsSourceConfig(const OAICreateMetricSet_request_MetricSource_RDSSourceConfig &rds_source_config) {
    m_rds_source_config = rds_source_config;
    m_rds_source_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_rds_source_config_Set() const{
    return m_rds_source_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_rds_source_config_Valid() const{
    return m_rds_source_config_isValid;
}

OAICreateMetricSet_request_MetricSource_RedshiftSourceConfig OAICreateMetricSet_request_MetricSource::getRedshiftSourceConfig() const {
    return m_redshift_source_config;
}
void OAICreateMetricSet_request_MetricSource::setRedshiftSourceConfig(const OAICreateMetricSet_request_MetricSource_RedshiftSourceConfig &redshift_source_config) {
    m_redshift_source_config = redshift_source_config;
    m_redshift_source_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_redshift_source_config_Set() const{
    return m_redshift_source_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_redshift_source_config_Valid() const{
    return m_redshift_source_config_isValid;
}

OAICreateMetricSet_request_MetricSource_AthenaSourceConfig OAICreateMetricSet_request_MetricSource::getAthenaSourceConfig() const {
    return m_athena_source_config;
}
void OAICreateMetricSet_request_MetricSource::setAthenaSourceConfig(const OAICreateMetricSet_request_MetricSource_AthenaSourceConfig &athena_source_config) {
    m_athena_source_config = athena_source_config;
    m_athena_source_config_isSet = true;
}

bool OAICreateMetricSet_request_MetricSource::is_athena_source_config_Set() const{
    return m_athena_source_config_isSet;
}

bool OAICreateMetricSet_request_MetricSource::is_athena_source_config_Valid() const{
    return m_athena_source_config_isValid;
}

bool OAICreateMetricSet_request_MetricSource::isSet() const {
...
bool OAICreateMetricSet_request_MetricSource::isValid() const {
