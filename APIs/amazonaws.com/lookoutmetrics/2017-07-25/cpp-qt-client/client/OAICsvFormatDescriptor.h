...
/*
 * OAICsvFormatDescriptor.h
 *
 * Contains information about how a source CSV data file should be analyzed.
 */

#ifndef OAICsvFormatDescriptor_H
#define OAICsvFormatDescriptor_H
...
class OAICsvFormatDescriptor : public OAIObject {
public:
    OAICsvFormatDescriptor();
    OAICsvFormatDescriptor(QString json);
    ~OAICsvFormatDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICsvFormatDescriptor)

#endif // OAICsvFormatDescriptor_H
