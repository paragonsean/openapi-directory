...
/*
 * OAIGetDataQualityMetricsRequest.h
 *
 * 
 */

#ifndef OAIGetDataQualityMetricsRequest_H
#define OAIGetDataQualityMetricsRequest_H
...
class OAIGetDataQualityMetricsRequest : public OAIObject {
public:
    OAIGetDataQualityMetricsRequest();
    OAIGetDataQualityMetricsRequest(QString json);
    ~OAIGetDataQualityMetricsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDataQualityMetricsRequest)

#endif // OAIGetDataQualityMetricsRequest_H
