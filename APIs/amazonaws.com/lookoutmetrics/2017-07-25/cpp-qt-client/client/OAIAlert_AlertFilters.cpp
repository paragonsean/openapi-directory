...
OAIAlert_AlertFilters::OAIAlert_AlertFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlert_AlertFilters::OAIAlert_AlertFilters() {
    this->initializeModel();
}

OAIAlert_AlertFilters::~OAIAlert_AlertFilters() {}

void OAIAlert_AlertFilters::initializeModel() {
...
void OAIAlert_AlertFilters::fromJson(QString jsonString) {
...
void OAIAlert_AlertFilters::fromJsonObject(QJsonObject json) {
...
QString OAIAlert_AlertFilters::asJson() const {
...
QJsonObject OAIAlert_AlertFilters::asJsonObject() const {
    QJsonObject obj;
...
QList OAIAlert_AlertFilters::getMetricList() const {
    return m_metric_list;
}
void OAIAlert_AlertFilters::setMetricList(const QList &metric_list) {
    m_metric_list = metric_list;
    m_metric_list_isSet = true;
}

bool OAIAlert_AlertFilters::is_metric_list_Set() const{
    return m_metric_list_isSet;
}

bool OAIAlert_AlertFilters::is_metric_list_Valid() const{
    return m_metric_list_isValid;
}

QList OAIAlert_AlertFilters::getDimensionFilterList() const {
    return m_dimension_filter_list;
}
void OAIAlert_AlertFilters::setDimensionFilterList(const QList &dimension_filter_list) {
    m_dimension_filter_list = dimension_filter_list;
    m_dimension_filter_list_isSet = true;
}

bool OAIAlert_AlertFilters::is_dimension_filter_list_Set() const{
    return m_dimension_filter_list_isSet;
}

bool OAIAlert_AlertFilters::is_dimension_filter_list_Valid() const{
    return m_dimension_filter_list_isValid;
}

bool OAIAlert_AlertFilters::isSet() const {
...
bool OAIAlert_AlertFilters::isValid() const {
