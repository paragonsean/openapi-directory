...
/*
 * OAIListMetricSets_request.h
 *
 * 
 */

#ifndef OAIListMetricSets_request_H
#define OAIListMetricSets_request_H
...
class OAIListMetricSets_request : public OAIObject {
public:
    OAIListMetricSets_request();
    OAIListMetricSets_request(QString json);
    ~OAIListMetricSets_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMetricSets_request)

#endif // OAIListMetricSets_request_H
