...
OAIDescribeAlertResponse_Alert::OAIDescribeAlertResponse_Alert(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeAlertResponse_Alert::OAIDescribeAlertResponse_Alert() {
    this->initializeModel();
}

OAIDescribeAlertResponse_Alert::~OAIDescribeAlertResponse_Alert() {}

void OAIDescribeAlertResponse_Alert::initializeModel() {
...
void OAIDescribeAlertResponse_Alert::fromJson(QString jsonString) {
...
void OAIDescribeAlertResponse_Alert::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeAlertResponse_Alert::asJson() const {
...
QJsonObject OAIDescribeAlertResponse_Alert::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIAlert_Action OAIDescribeAlertResponse_Alert::getAction() const {
    return m_action;
}
void OAIDescribeAlertResponse_Alert::setAction(const OAIAlert_Action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_action_Set() const{
    return m_action_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_action_Valid() const{
    return m_action_isValid;
}

QString OAIDescribeAlertResponse_Alert::getAlertDescription() const {
    return m_alert_description;
}
void OAIDescribeAlertResponse_Alert::setAlertDescription(const QString &alert_description) {
    m_alert_description = alert_description;
    m_alert_description_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_description_Set() const{
    return m_alert_description_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_description_Valid() const{
    return m_alert_description_isValid;
}

QString OAIDescribeAlertResponse_Alert::getAlertArn() const {
    return m_alert_arn;
}
void OAIDescribeAlertResponse_Alert::setAlertArn(const QString &alert_arn) {
    m_alert_arn = alert_arn;
    m_alert_arn_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_arn_Set() const{
    return m_alert_arn_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_arn_Valid() const{
    return m_alert_arn_isValid;
}

QString OAIDescribeAlertResponse_Alert::getAnomalyDetectorArn() const {
    return m_anomaly_detector_arn;
}
void OAIDescribeAlertResponse_Alert::setAnomalyDetectorArn(const QString &anomaly_detector_arn) {
    m_anomaly_detector_arn = anomaly_detector_arn;
    m_anomaly_detector_arn_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_anomaly_detector_arn_Set() const{
    return m_anomaly_detector_arn_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_anomaly_detector_arn_Valid() const{
    return m_anomaly_detector_arn_isValid;
}

QString OAIDescribeAlertResponse_Alert::getAlertName() const {
    return m_alert_name;
}
void OAIDescribeAlertResponse_Alert::setAlertName(const QString &alert_name) {
    m_alert_name = alert_name;
    m_alert_name_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_name_Set() const{
    return m_alert_name_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_name_Valid() const{
    return m_alert_name_isValid;
}

qint32 OAIDescribeAlertResponse_Alert::getAlertSensitivityThreshold() const {
    return m_alert_sensitivity_threshold;
}
void OAIDescribeAlertResponse_Alert::setAlertSensitivityThreshold(const qint32 &alert_sensitivity_threshold) {
    m_alert_sensitivity_threshold = alert_sensitivity_threshold;
    m_alert_sensitivity_threshold_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_sensitivity_threshold_Set() const{
    return m_alert_sensitivity_threshold_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_sensitivity_threshold_Valid() const{
    return m_alert_sensitivity_threshold_isValid;
}

OAIAlertType OAIDescribeAlertResponse_Alert::getAlertType() const {
    return m_alert_type;
}
void OAIDescribeAlertResponse_Alert::setAlertType(const OAIAlertType &alert_type) {
    m_alert_type = alert_type;
    m_alert_type_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_type_Set() const{
    return m_alert_type_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_type_Valid() const{
    return m_alert_type_isValid;
}

OAIAlertStatus OAIDescribeAlertResponse_Alert::getAlertStatus() const {
    return m_alert_status;
}
void OAIDescribeAlertResponse_Alert::setAlertStatus(const OAIAlertStatus &alert_status) {
    m_alert_status = alert_status;
    m_alert_status_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_status_Set() const{
    return m_alert_status_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_status_Valid() const{
    return m_alert_status_isValid;
}

QDateTime OAIDescribeAlertResponse_Alert::getLastModificationTime() const {
    return m_last_modification_time;
}
void OAIDescribeAlertResponse_Alert::setLastModificationTime(const QDateTime &last_modification_time) {
    m_last_modification_time = last_modification_time;
    m_last_modification_time_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_last_modification_time_Set() const{
    return m_last_modification_time_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_last_modification_time_Valid() const{
    return m_last_modification_time_isValid;
}

QDateTime OAIDescribeAlertResponse_Alert::getCreationTime() const {
    return m_creation_time;
}
void OAIDescribeAlertResponse_Alert::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAIAlert_AlertFilters OAIDescribeAlertResponse_Alert::getAlertFilters() const {
    return m_alert_filters;
}
void OAIDescribeAlertResponse_Alert::setAlertFilters(const OAIAlert_AlertFilters &alert_filters) {
    m_alert_filters = alert_filters;
    m_alert_filters_isSet = true;
}

bool OAIDescribeAlertResponse_Alert::is_alert_filters_Set() const{
    return m_alert_filters_isSet;
}

bool OAIDescribeAlertResponse_Alert::is_alert_filters_Valid() const{
    return m_alert_filters_isValid;
}

bool OAIDescribeAlertResponse_Alert::isSet() const {
...
bool OAIDescribeAlertResponse_Alert::isValid() const {
