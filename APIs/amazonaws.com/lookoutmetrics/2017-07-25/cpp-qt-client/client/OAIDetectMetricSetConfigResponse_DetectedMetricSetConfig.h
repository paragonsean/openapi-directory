...
/*
 * OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig.h
 *
 * 
 */

#ifndef OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig_H
#define OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig_H
...
class OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig : public OAIObject {
public:
    OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig();
    OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig(QString json);
    ~OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig)

#endif // OAIDetectMetricSetConfigResponse_DetectedMetricSetConfig_H
