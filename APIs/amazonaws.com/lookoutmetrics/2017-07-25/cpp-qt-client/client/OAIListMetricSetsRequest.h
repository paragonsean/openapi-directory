...
/*
 * OAIListMetricSetsRequest.h
 *
 * 
 */

#ifndef OAIListMetricSetsRequest_H
#define OAIListMetricSetsRequest_H
...
class OAIListMetricSetsRequest : public OAIObject {
public:
    OAIListMetricSetsRequest();
    OAIListMetricSetsRequest(QString json);
    ~OAIListMetricSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMetricSetsRequest)

#endif // OAIListMetricSetsRequest_H
