...
/*
 * OAIListAlerts_request.h
 *
 * 
 */

#ifndef OAIListAlerts_request_H
#define OAIListAlerts_request_H
...
class OAIListAlerts_request : public OAIObject {
public:
    OAIListAlerts_request();
    OAIListAlerts_request(QString json);
    ~OAIListAlerts_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAlerts_request)

#endif // OAIListAlerts_request_H
