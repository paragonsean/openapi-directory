...
#ifndef OAIMetricSource_H
#define OAIMetricSource_H
...
class OAIMetricSource : public OAIObject {
public:
    OAIMetricSource();
    OAIMetricSource(QString json);
    ~OAIMetricSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricSource)

#endif // OAIMetricSource_H
