...
/*
 * OAICreateMetricSetRequest.h
 *
 * 
 */

#ifndef OAICreateMetricSetRequest_H
#define OAICreateMetricSetRequest_H
...
class OAICreateMetricSetRequest_MetricSource;

class OAICreateMetricSetRequest : public OAIObject {
public:
    OAICreateMetricSetRequest();
    OAICreateMetricSetRequest(QString json);
    ~OAICreateMetricSetRequest() override;
    ...
    OAICreateMetricSetRequest_MetricSource getMetricSource() const;
    void setMetricSource(const OAICreateMetricSetRequest_MetricSource &metric_source);
...
private:
    ...
    OAICreateMetricSetRequest_MetricSource m_metric_source;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMetricSetRequest)

#endif // OAICreateMetricSetRequest_H
