...
/*
 * OAIDetectedField_Value.h
 *
 * 
 */

#ifndef OAIDetectedField_Value_H
#define OAIDetectedField_Value_H
...
class OAIDetectedField_Value : public OAIObject {
public:
    OAIDetectedField_Value();
    OAIDetectedField_Value(QString json);
    ~OAIDetectedField_Value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectedField_Value)

#endif // OAIDetectedField_Value_H
