...
/*
 * OAIDescribeMetricSetResponse_MetricSource.h
 *
 * 
 */

#ifndef OAIDescribeMetricSetResponse_MetricSource_H
#define OAIDescribeMetricSetResponse_MetricSource_H
...
class OAIDescribeMetricSetResponse_MetricSource : public OAIObject {
public:
    OAIDescribeMetricSetResponse_MetricSource();
    OAIDescribeMetricSetResponse_MetricSource(QString json);
    ~OAIDescribeMetricSetResponse_MetricSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeMetricSetResponse_MetricSource)

#endif // OAIDescribeMetricSetResponse_MetricSource_H
