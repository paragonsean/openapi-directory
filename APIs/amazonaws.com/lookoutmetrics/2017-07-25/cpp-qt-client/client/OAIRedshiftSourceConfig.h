...
/*
 * OAIRedshiftSourceConfig.h
 *
 * Provides information about the Amazon Redshift database configuration.
 */

#ifndef OAIRedshiftSourceConfig_H
#define OAIRedshiftSourceConfig_H
...
class OAIRedshiftSourceConfig : public OAIObject {
public:
    OAIRedshiftSourceConfig();
    OAIRedshiftSourceConfig(QString json);
    ~OAIRedshiftSourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftSourceConfig)

#endif // OAIRedshiftSourceConfig_H
