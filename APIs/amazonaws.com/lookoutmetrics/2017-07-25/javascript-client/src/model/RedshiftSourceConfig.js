...
/**
 * The RedshiftSourceConfig model module.
 * @module model/RedshiftSourceConfig
 * @version 2017-07-25
 */
class RedshiftSourceConfig {
    /**
     * Constructs a new <code>RedshiftSourceConfig</code>.
     * Provides information about the Amazon Redshift database configuration.
     * @alias module:model/RedshiftSourceConfig
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RedshiftSourceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedshiftSourceConfig} obj Optional instance to populate.
     * @return {module:model/RedshiftSourceConfig} The populated <code>RedshiftSourceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedshiftSourceConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>RedshiftSourceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedshiftSourceConfig</code>.
     */
...
export default RedshiftSourceConfig;
