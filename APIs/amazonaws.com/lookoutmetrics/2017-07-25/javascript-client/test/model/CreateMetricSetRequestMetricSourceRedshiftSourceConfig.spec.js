...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRedshiftSourceConfig();
  });
  ...
  describe('CreateMetricSetRequestMetricSourceRedshiftSourceConfig', function() {
    it('should create an instance of CreateMetricSetRequestMetricSourceRedshiftSourceConfig', function() {
      // uncomment below and update the code to test CreateMetricSetRequestMetricSourceRedshiftSourceConfig
      //var instance = new AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRedshiftSourceConfig();
      //expect(instance).to.be.a(AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRedshiftSourceConfig);
    });
