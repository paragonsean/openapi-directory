...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForMetrics.TimestampColumn();
  });
  ...
  describe('TimestampColumn', function() {
    it('should create an instance of TimestampColumn', function() {
      // uncomment below and update the code to test TimestampColumn
      //var instance = new AmazonLookoutForMetrics.TimestampColumn();
      //expect(instance).to.be.a(AmazonLookoutForMetrics.TimestampColumn);
    });
