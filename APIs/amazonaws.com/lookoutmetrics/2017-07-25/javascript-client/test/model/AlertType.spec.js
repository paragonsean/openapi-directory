...
(function(root, factory) {
  ...
  describe('AlertType', function() {
    it('should create an instance of AlertType', function() {
      // uncomment below and update the code to test AlertType
      //var instance = new AmazonLookoutForMetrics.AlertType();
      //expect(instance).to.be.a(AmazonLookoutForMetrics.AlertType);
    });
