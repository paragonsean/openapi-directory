...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRDSSourceConfig();
  });
  ...
  describe('CreateMetricSetRequestMetricSourceRDSSourceConfig', function() {
    it('should create an instance of CreateMetricSetRequestMetricSourceRDSSourceConfig', function() {
      // uncomment below and update the code to test CreateMetricSetRequestMetricSourceRDSSourceConfig
      //var instance = new AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRDSSourceConfig();
      //expect(instance).to.be.a(AmazonLookoutForMetrics.CreateMetricSetRequestMetricSourceRDSSourceConfig);
    });
