...
class ActivateAnomalyDetectorRequest(Model):
    ...
    def __init__(self, anomaly_detector_arn: str=None):
        """ActivateAnomalyDetectorRequest - a model defined in OpenAPI

        :param anomaly_detector_arn: The anomaly_detector_arn of this ActivateAnomalyDetectorRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ActivateAnomalyDetectorRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ActivateAnomalyDetector_request of this ActivateAnomalyDetectorRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def anomaly_detector_arn(self):
        """Gets the anomaly_detector_arn of this ActivateAnomalyDetectorRequest.

        The ARN of the anomaly detector.

        :return: The anomaly_detector_arn of this ActivateAnomalyDetectorRequest.
        :rtype: str
        """
    ...
    def anomaly_detector_arn(self, anomaly_detector_arn):
        """Sets the anomaly_detector_arn of this ActivateAnomalyDetectorRequest.
