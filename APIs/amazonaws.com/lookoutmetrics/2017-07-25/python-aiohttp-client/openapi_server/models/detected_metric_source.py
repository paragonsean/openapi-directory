...
class DetectedMetricSource(Model):
    ...
    def __init__(self, s3_source_config: DetectedMetricSourceS3SourceConfig=None):
        """DetectedMetricSource - a model defined in OpenAPI

        :param s3_source_config: The s3_source_config of this DetectedMetricSource.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DetectedMetricSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DetectedMetricSource of this DetectedMetricSource.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_source_config(self):
        """Gets the s3_source_config of this DetectedMetricSource.


        :return: The s3_source_config of this DetectedMetricSource.
    ...
    def s3_source_config(self, s3_source_config):
        """Sets the s3_source_config of this DetectedMetricSource.
