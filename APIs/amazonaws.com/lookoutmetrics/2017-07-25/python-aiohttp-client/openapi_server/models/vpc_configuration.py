...
class VpcConfiguration(Model):
    ...
    def __init__(self, subnet_id_list: List=None, security_group_id_list: List=None):
        ...
        :param subnet_id_list: The subnet_id_list of this VpcConfiguration.
        :param security_group_id_list: The security_group_id_list of this VpcConfiguration.
        """
        self.openapi_types = {
            'subnet_id_list': List,
    ...
    def subnet_id_list(self):
        """Gets the subnet_id_list of this VpcConfiguration.


        :return: The subnet_id_list of this VpcConfiguration.
        :rtype: List
        """
    ...
    def subnet_id_list(self, subnet_id_list):
        """Sets the subnet_id_list of this VpcConfiguration.
    ...
    def security_group_id_list(self):
        """Gets the security_group_id_list of this VpcConfiguration.


        :return: The security_group_id_list of this VpcConfiguration.
        :rtype: List
        """
    ...
    def security_group_id_list(self, security_group_id_list):
        """Sets the security_group_id_list of this VpcConfiguration.
