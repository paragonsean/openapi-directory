...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPolly.SynthesisTask();
  });
  ...
  describe('SynthesisTask', function() {
    it('should create an instance of SynthesisTask', function() {
      // uncomment below and update the code to test SynthesisTask
      //var instance = new AmazonPolly.SynthesisTask();
      //expect(instance).to.be.a(AmazonPolly.SynthesisTask);
    });
