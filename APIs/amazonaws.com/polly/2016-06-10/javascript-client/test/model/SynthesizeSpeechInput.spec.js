...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPolly.SynthesizeSpeechInput();
  });
  ...
  describe('SynthesizeSpeechInput', function() {
    it('should create an instance of SynthesizeSpeechInput', function() {
      // uncomment below and update the code to test SynthesizeSpeechInput
      //var instance = new AmazonPolly.SynthesizeSpeechInput();
      //expect(instance).to.be.a(AmazonPolly.SynthesizeSpeechInput);
    });
