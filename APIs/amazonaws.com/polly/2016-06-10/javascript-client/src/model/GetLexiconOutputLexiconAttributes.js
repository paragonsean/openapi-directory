...
/**
 * The GetLexiconOutputLexiconAttributes model module.
 * @module model/GetLexiconOutputLexiconAttributes
 * @version 2016-06-10
 */
class GetLexiconOutputLexiconAttributes {
    /**
     * Constructs a new <code>GetLexiconOutputLexiconAttributes</code>.
     * @alias module:model/GetLexiconOutputLexiconAttributes
     * @implements module:model/LexiconAttributes
     */
    constructor() { 
        LexiconAttributes.initialize(this);
        GetLexiconOutputLexiconAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLexiconOutputLexiconAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLexiconOutputLexiconAttributes} obj Optional instance to populate.
     * @return {module:model/GetLexiconOutputLexiconAttributes} The populated <code>GetLexiconOutputLexiconAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLexiconOutputLexiconAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLexiconOutputLexiconAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLexiconOutputLexiconAttributes</code>.
     */
 ...
 */
GetLexiconOutputLexiconAttributes.prototype['Alphabet'] = undefined;

/**
 * @member {module:model/LanguageCode} LanguageCode
 */
GetLexiconOutputLexiconAttributes.prototype['LanguageCode'] = undefined;

/**
 * @member {Date} LastModified
 */
GetLexiconOutputLexiconAttributes.prototype['LastModified'] = undefined;

/**
 * @member {String} LexiconArn
 */
GetLexiconOutputLexiconAttributes.prototype['LexiconArn'] = undefined;

/**
 * @member {Number} LexemesCount
 */
GetLexiconOutputLexiconAttributes.prototype['LexemesCount'] = undefined;

/**
 * @member {Number} Size
 */
GetLexiconOutputLexiconAttributes.prototype['Size'] = undefined;
...
export default GetLexiconOutputLexiconAttributes;
