...
/**
 * The GetSpeechSynthesisTaskOutputSynthesisTask model module.
 * @module model/GetSpeechSynthesisTaskOutputSynthesisTask
 * @version 2016-06-10
 */
class GetSpeechSynthesisTaskOutputSynthesisTask {
    /**
     * Constructs a new <code>GetSpeechSynthesisTaskOutputSynthesisTask</code>.
     * @alias module:model/GetSpeechSynthesisTaskOutputSynthesisTask
     * @implements module:model/SynthesisTask
     */
    constructor() { 
        SynthesisTask.initialize(this);
        GetSpeechSynthesisTaskOutputSynthesisTask.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSpeechSynthesisTaskOutputSynthesisTask</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSpeechSynthesisTaskOutputSynthesisTask} obj Optional instance to populate.
     * @return {module:model/GetSpeechSynthesisTaskOutputSynthesisTask} The populated <code>GetSpeechSynthesisTaskOutputSynthesisTask</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSpeechSynthesisTaskOutputSynthesisTask();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSpeechSynthesisTaskOutputSynthesisTask</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSpeechSynthesisTaskOutputSynthesisTask</code>.
     */
 ...
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['Engine'] = undefined;

/**
 * @member {String} TaskId
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['TaskId'] = undefined;

/**
 * @member {module:model/TaskStatus} TaskStatus
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['TaskStatus'] = undefined;

/**
 * @member {String} TaskStatusReason
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['TaskStatusReason'] = undefined;

/**
 * @member {String} OutputUri
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['OutputUri'] = undefined;

/**
 * @member {Date} CreationTime
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['CreationTime'] = undefined;

/**
 * @member {Number} RequestCharacters
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['RequestCharacters'] = undefined;

/**
 * @member {String} SnsTopicArn
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['SnsTopicArn'] = undefined;

/**
 * @member {Array} LexiconNames
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['LexiconNames'] = undefined;

/**
 * @member {module:model/OutputFormat} OutputFormat
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['OutputFormat'] = undefined;

/**
 * @member {String} SampleRate
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['SampleRate'] = undefined;

/**
 * @member {Array} SpeechMarkTypes
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['SpeechMarkTypes'] = undefined;

/**
 * @member {module:model/TextType} TextType
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['TextType'] = undefined;

/**
 * @member {module:model/VoiceId} VoiceId
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['VoiceId'] = undefined;

/**
 * @member {module:model/LanguageCode} LanguageCode
 */
GetSpeechSynthesisTaskOutputSynthesisTask.prototype['LanguageCode'] = undefined;
...
export default GetSpeechSynthesisTaskOutputSynthesisTask;
