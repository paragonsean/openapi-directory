...
/**
 * The SynthesisTask model module.
 * @module model/SynthesisTask
 * @version 2016-06-10
 */
class SynthesisTask {
    /**
     * Constructs a new <code>SynthesisTask</code>.
     * SynthesisTask object that provides information about a speech synthesis task.
     * @alias module:model/SynthesisTask
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SynthesisTask</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SynthesisTask} obj Optional instance to populate.
     * @return {module:model/SynthesisTask} The populated <code>SynthesisTask</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SynthesisTask();
    ...
    /**
     * Validates the JSON data with respect to <code>SynthesisTask</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SynthesisTask</code>.
     */
