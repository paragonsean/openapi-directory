...
public class SynthesisTask {
  ...
  public SynthesisTask engine(Engine engine) {
    this.engine = engine;
    return this;
  }
  ...
  public SynthesisTask taskId(String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public SynthesisTask taskStatus(TaskStatus taskStatus) {
  ...
  public SynthesisTask taskStatusReason(String taskStatusReason) {
  ...
  public SynthesisTask outputUri(String outputUri) {
  ...
  public SynthesisTask creationTime(OffsetDateTime creationTime) {
  ...
  public SynthesisTask requestCharacters(Integer requestCharacters) {
  ...
  public SynthesisTask snsTopicArn(String snsTopicArn) {
  ...
  public SynthesisTask lexiconNames(List lexiconNames) {
  ...
  public SynthesisTask outputFormat(OutputFormat outputFormat) {
  ...
  public SynthesisTask sampleRate(String sampleRate) {
  ...
  public SynthesisTask speechMarkTypes(List speechMarkTypes) {
  ...
  public SynthesisTask textType(TextType textType) {
  ...
  public SynthesisTask voiceId(VoiceId voiceId) {
  ...
  public SynthesisTask languageCode(LanguageCode languageCode) {
  ...
  public boolean equals(Object o) {
    ...
    SynthesisTask synthesisTask = (SynthesisTask) o;
    return Objects.equals(this.engine, synthesisTask.engine) &&
        Objects.equals(this.taskId, synthesisTask.taskId) &&
        Objects.equals(this.taskStatus, synthesisTask.taskStatus) &&
        Objects.equals(this.taskStatusReason, synthesisTask.taskStatusReason) &&
        Objects.equals(this.outputUri, synthesisTask.outputUri) &&
        Objects.equals(this.creationTime, synthesisTask.creationTime) &&
        Objects.equals(this.requestCharacters, synthesisTask.requestCharacters) &&
        Objects.equals(this.snsTopicArn, synthesisTask.snsTopicArn) &&
        Objects.equals(this.lexiconNames, synthesisTask.lexiconNames) &&
        Objects.equals(this.outputFormat, synthesisTask.outputFormat) &&
        Objects.equals(this.sampleRate, synthesisTask.sampleRate) &&
        Objects.equals(this.speechMarkTypes, synthesisTask.speechMarkTypes) &&
        Objects.equals(this.textType, synthesisTask.textType) &&
        Objects.equals(this.voiceId, synthesisTask.voiceId) &&
        Objects.equals(this.languageCode, synthesisTask.languageCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SynthesisTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SynthesisTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SynthesisTask is not found in the empty JSON string", SynthesisTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SynthesisTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SynthesisTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SynthesisTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SynthesisTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SynthesisTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SynthesisTask.class));

       return (TypeAdapter<T>) new TypeAdapter<SynthesisTask>() {
           @Override
           public void write(JsonWriter out, SynthesisTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SynthesisTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SynthesisTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SynthesisTask
   * @throws IOException if the JSON string is invalid with respect to SynthesisTask
   */
  public static SynthesisTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SynthesisTask.class);
  }

  /**
   * Convert an instance of SynthesisTask to an JSON string
   *
   * @return JSON string
   */
