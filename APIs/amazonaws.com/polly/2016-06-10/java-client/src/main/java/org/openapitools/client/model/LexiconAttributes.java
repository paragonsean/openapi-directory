...
public class LexiconAttributes {
  ...
  public LexiconAttributes alphabet(String alphabet) {
  ...
  public LexiconAttributes languageCode(LanguageCode languageCode) {
  ...
  public LexiconAttributes lastModified(OffsetDateTime lastModified) {
  ...
  public LexiconAttributes lexiconArn(String lexiconArn) {
  ...
  public LexiconAttributes lexemesCount(Integer lexemesCount) {
  ...
  public LexiconAttributes size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LexiconAttributes lexiconAttributes = (LexiconAttributes) o;
    return Objects.equals(this.alphabet, lexiconAttributes.alphabet) &&
        Objects.equals(this.languageCode, lexiconAttributes.languageCode) &&
        Objects.equals(this.lastModified, lexiconAttributes.lastModified) &&
        Objects.equals(this.lexiconArn, lexiconAttributes.lexiconArn) &&
        Objects.equals(this.lexemesCount, lexiconAttributes.lexemesCount) &&
        Objects.equals(this.size, lexiconAttributes.size);
  }
  ...
  public String toString() {
    ...
    sb.append("class LexiconAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LexiconAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LexiconAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LexiconAttributes is not found in the empty JSON string", LexiconAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LexiconAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LexiconAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LexiconAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LexiconAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LexiconAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LexiconAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<LexiconAttributes>() {
           @Override
           public void write(JsonWriter out, LexiconAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LexiconAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LexiconAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LexiconAttributes
   * @throws IOException if the JSON string is invalid with respect to LexiconAttributes
   */
  public static LexiconAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LexiconAttributes.class);
  }

  /**
   * Convert an instance of LexiconAttributes to an JSON string
   *
   * @return JSON string
   */
