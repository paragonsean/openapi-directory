...
public class StartSpeechSynthesisTaskOutputSynthesisTask {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask() {
  }

  public StartSpeechSynthesisTaskOutputSynthesisTask engine(Engine engine) {
    this.engine = engine;
    return this;
  }
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask taskId(String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask taskStatus(TaskStatus taskStatus) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask taskStatusReason(String taskStatusReason) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask outputUri(String outputUri) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask creationTime(OffsetDateTime creationTime) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask requestCharacters(Integer requestCharacters) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask snsTopicArn(String snsTopicArn) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask lexiconNames(List lexiconNames) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask outputFormat(OutputFormat outputFormat) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask sampleRate(String sampleRate) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask speechMarkTypes(List speechMarkTypes) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask textType(TextType textType) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask voiceId(VoiceId voiceId) {
  ...
  public StartSpeechSynthesisTaskOutputSynthesisTask languageCode(LanguageCode languageCode) {
  ...
  public boolean equals(Object o) {
    ...
    StartSpeechSynthesisTaskOutputSynthesisTask startSpeechSynthesisTaskOutputSynthesisTask = (StartSpeechSynthesisTaskOutputSynthesisTask) o;
    return Objects.equals(this.engine, startSpeechSynthesisTaskOutputSynthesisTask.engine) &&
        Objects.equals(this.taskId, startSpeechSynthesisTaskOutputSynthesisTask.taskId) &&
        Objects.equals(this.taskStatus, startSpeechSynthesisTaskOutputSynthesisTask.taskStatus) &&
        Objects.equals(this.taskStatusReason, startSpeechSynthesisTaskOutputSynthesisTask.taskStatusReason) &&
        Objects.equals(this.outputUri, startSpeechSynthesisTaskOutputSynthesisTask.outputUri) &&
        Objects.equals(this.creationTime, startSpeechSynthesisTaskOutputSynthesisTask.creationTime) &&
        Objects.equals(this.requestCharacters, startSpeechSynthesisTaskOutputSynthesisTask.requestCharacters) &&
        Objects.equals(this.snsTopicArn, startSpeechSynthesisTaskOutputSynthesisTask.snsTopicArn) &&
        Objects.equals(this.lexiconNames, startSpeechSynthesisTaskOutputSynthesisTask.lexiconNames) &&
        Objects.equals(this.outputFormat, startSpeechSynthesisTaskOutputSynthesisTask.outputFormat) &&
        Objects.equals(this.sampleRate, startSpeechSynthesisTaskOutputSynthesisTask.sampleRate) &&
        Objects.equals(this.speechMarkTypes, startSpeechSynthesisTaskOutputSynthesisTask.speechMarkTypes) &&
        Objects.equals(this.textType, startSpeechSynthesisTaskOutputSynthesisTask.textType) &&
        Objects.equals(this.voiceId, startSpeechSynthesisTaskOutputSynthesisTask.voiceId) &&
        Objects.equals(this.languageCode, startSpeechSynthesisTaskOutputSynthesisTask.languageCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartSpeechSynthesisTaskOutputSynthesisTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartSpeechSynthesisTaskOutputSynthesisTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartSpeechSynthesisTaskOutputSynthesisTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartSpeechSynthesisTaskOutputSynthesisTask is not found in the empty JSON string", StartSpeechSynthesisTaskOutputSynthesisTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartSpeechSynthesisTaskOutputSynthesisTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartSpeechSynthesisTaskOutputSynthesisTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartSpeechSynthesisTaskOutputSynthesisTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartSpeechSynthesisTaskOutputSynthesisTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartSpeechSynthesisTaskOutputSynthesisTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartSpeechSynthesisTaskOutputSynthesisTask.class));

       return (TypeAdapter<T>) new TypeAdapter<StartSpeechSynthesisTaskOutputSynthesisTask>() {
           @Override
           public void write(JsonWriter out, StartSpeechSynthesisTaskOutputSynthesisTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartSpeechSynthesisTaskOutputSynthesisTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartSpeechSynthesisTaskOutputSynthesisTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartSpeechSynthesisTaskOutputSynthesisTask
   * @throws IOException if the JSON string is invalid with respect to StartSpeechSynthesisTaskOutputSynthesisTask
   */
  public static StartSpeechSynthesisTaskOutputSynthesisTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartSpeechSynthesisTaskOutputSynthesisTask.class);
  }

  /**
   * Convert an instance of StartSpeechSynthesisTaskOutputSynthesisTask to an JSON string
   *
   * @return JSON string
   */
