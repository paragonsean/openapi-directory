...
#ifndef OAILexiconAttributes_H
#define OAILexiconAttributes_H
...
class OAILexiconAttributes : public OAIObject {
public:
    OAILexiconAttributes();
    OAILexiconAttributes(QString json);
    ~OAILexiconAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILexiconAttributes)

#endif // OAILexiconAttributes_H
