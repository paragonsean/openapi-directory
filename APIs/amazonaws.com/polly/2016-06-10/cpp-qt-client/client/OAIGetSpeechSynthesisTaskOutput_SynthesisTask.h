...
/*
 * OAIGetSpeechSynthesisTaskOutput_SynthesisTask.h
 *
 * 
 */

#ifndef OAIGetSpeechSynthesisTaskOutput_SynthesisTask_H
#define OAIGetSpeechSynthesisTaskOutput_SynthesisTask_H
...
class OAIGetSpeechSynthesisTaskOutput_SynthesisTask : public OAIObject {
public:
    OAIGetSpeechSynthesisTaskOutput_SynthesisTask();
    OAIGetSpeechSynthesisTaskOutput_SynthesisTask(QString json);
    ~OAIGetSpeechSynthesisTaskOutput_SynthesisTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSpeechSynthesisTaskOutput_SynthesisTask)

#endif // OAIGetSpeechSynthesisTaskOutput_SynthesisTask_H
