...
#ifndef OAISynthesisTask_H
#define OAISynthesisTask_H
...
class OAISynthesisTask : public OAIObject {
public:
    OAISynthesisTask();
    OAISynthesisTask(QString json);
    ~OAISynthesisTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISynthesisTask)

#endif // OAISynthesisTask_H
