...
/*
 * OAIGetLexiconOutput_LexiconAttributes.h
 *
 * 
 */

#ifndef OAIGetLexiconOutput_LexiconAttributes_H
#define OAIGetLexiconOutput_LexiconAttributes_H
...
class OAIGetLexiconOutput_LexiconAttributes : public OAIObject {
public:
    OAIGetLexiconOutput_LexiconAttributes();
    OAIGetLexiconOutput_LexiconAttributes(QString json);
    ~OAIGetLexiconOutput_LexiconAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLexiconOutput_LexiconAttributes)

#endif // OAIGetLexiconOutput_LexiconAttributes_H
