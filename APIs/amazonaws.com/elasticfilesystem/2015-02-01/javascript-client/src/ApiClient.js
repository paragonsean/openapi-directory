...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://elasticfilesystem.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://elasticfilesystem.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2015-02-01/Javascript'
        };
