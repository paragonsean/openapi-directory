...
import BackupPolicyDescriptionBackupPolicy from './BackupPolicyDescriptionBackupPolicy';
...
class BackupPolicyDescription {
    ...
    constructor() { 
        ...
        BackupPolicyDescription.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('BackupPolicy')) {
                obj['BackupPolicy'] = BackupPolicyDescriptionBackupPolicy.constructFromObject(data['BackupPolicy']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['BackupPolicy']) { // data not null
          BackupPolicyDescriptionBackupPolicy.validateJSON(data['BackupPolicy']);
        }
...
/**
 * @member {module:model/BackupPolicyDescriptionBackupPolicy} BackupPolicy
 */
BackupPolicyDescription.prototype['BackupPolicy'] = undefined;
