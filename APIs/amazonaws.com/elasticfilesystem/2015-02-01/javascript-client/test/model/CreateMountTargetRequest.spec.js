...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticFileSystem.CreateMountTargetRequest();
  });
  ...
  describe('CreateMountTargetRequest', function() {
    it('should create an instance of CreateMountTargetRequest', function() {
      // uncomment below and update the code to test CreateMountTargetRequest
      //var instance = new AmazonElasticFileSystem.CreateMountTargetRequest();
      //expect(instance).to.be.a(AmazonElasticFileSystem.CreateMountTargetRequest);
    });
