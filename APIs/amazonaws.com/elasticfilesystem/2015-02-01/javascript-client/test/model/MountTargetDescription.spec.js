...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticFileSystem.MountTargetDescription();
  });
  ...
  describe('MountTargetDescription', function() {
    it('should create an instance of MountTargetDescription', function() {
      // uncomment below and update the code to test MountTargetDescription
      //var instance = new AmazonElasticFileSystem.MountTargetDescription();
      //expect(instance).to.be.a(AmazonElasticFileSystem.MountTargetDescription);
    });
