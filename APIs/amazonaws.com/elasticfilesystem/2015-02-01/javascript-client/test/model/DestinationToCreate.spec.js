...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticFileSystem.DestinationToCreate();
  });
  ...
  describe('DestinationToCreate', function() {
    it('should create an instance of DestinationToCreate', function() {
      // uncomment below and update the code to test DestinationToCreate
      //var instance = new AmazonElasticFileSystem.DestinationToCreate();
      //expect(instance).to.be.a(AmazonElasticFileSystem.DestinationToCreate);
    });
