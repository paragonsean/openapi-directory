...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticFileSystem.UpdateFileSystemRequest();
  });
  ...
  describe('UpdateFileSystemRequest', function() {
    it('should create an instance of UpdateFileSystemRequest', function() {
      // uncomment below and update the code to test UpdateFileSystemRequest
      //var instance = new AmazonElasticFileSystem.UpdateFileSystemRequest();
      //expect(instance).to.be.a(AmazonElasticFileSystem.UpdateFileSystemRequest);
    });
