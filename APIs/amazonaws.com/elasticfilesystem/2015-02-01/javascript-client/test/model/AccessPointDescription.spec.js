...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonElasticFileSystem.AccessPointDescription();
  });
  ...
  describe('AccessPointDescription', function() {
    it('should create an instance of AccessPointDescription', function() {
      // uncomment below and update the code to test AccessPointDescription
      //var instance = new AmazonElasticFileSystem.AccessPointDescription();
      //expect(instance).to.be.a(AmazonElasticFileSystem.AccessPointDescription);
    });
