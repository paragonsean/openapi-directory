# AmazonElasticFileSystem.CreateMountTargetRequest
...
**securityGroups** | **[String]** | Up to five VPC security group IDs, of the form &lt;code&gt;sg-xxxxxxxx&lt;/code&gt;. These must be for the same VPC as subnet specified. | [optional] 
