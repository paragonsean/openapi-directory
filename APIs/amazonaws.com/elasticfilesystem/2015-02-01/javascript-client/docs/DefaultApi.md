# AmazonElasticFileSystem.DefaultApi
...
> AccessPointDescription createAccessPoint(createAccessPointRequest, opts)
...
```javascript
import AmazonElasticFileSystem from 'amazon_elastic_file_system';
let defaultClient = AmazonElasticFileSystem.ApiClient.instance;
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let createAccessPointRequest = new AmazonElasticFileSystem.CreateAccessPointRequest(); // CreateAccessPointRequest | 
let opts = {
...
apiInstance.createAccessPoint(createAccessPointRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> FileSystemDescription createFileSystem(createFileSystemRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let createFileSystemRequest = new AmazonElasticFileSystem.CreateFileSystemRequest(); // CreateFileSystemRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.createFileSystem(createFileSystemRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> MountTargetDescription createMountTarget(createMountTargetRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let createMountTargetRequest = new AmazonElasticFileSystem.CreateMountTargetRequest(); // CreateMountTargetRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.createMountTarget(createMountTargetRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReplicationConfigurationDescription createReplicationConfiguration(sourceFileSystemId, createReplicationConfigurationRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let sourceFileSystemId = "sourceFileSystemId_example"; // String | Specifies the Amazon EFS file system that you want to replicate. This file system cannot already be a source or destination file system in another replication configuration.
let createReplicationConfigurationRequest = new AmazonElasticFileSystem.CreateReplicationConfigurationRequest(); // CreateReplicationConfigurationRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.createReplicationConfiguration(sourceFileSystemId, createReplicationConfigurationRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> createTags(fileSystemId, createTagsRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system whose tags you want to modify (String). This operation modifies the tags only, not the file system.
let createTagsRequest = new AmazonElasticFileSystem.CreateTagsRequest(); // CreateTagsRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.createTags(fileSystemId, createTagsRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> deleteAccessPoint(accessPointId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let accessPointId = "accessPointId_example"; // String | The ID of the access point that you want to delete.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteAccessPoint(accessPointId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> deleteFileSystem(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system you want to delete.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteFileSystem(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> deleteFileSystemPolicy(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | Specifies the EFS file system for which to delete the <code>FileSystemPolicy</code>.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteFileSystemPolicy(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> deleteMountTarget(mountTargetId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let mountTargetId = "mountTargetId_example"; // String | The ID of the mount target to delete (String).
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteMountTarget(mountTargetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> deleteReplicationConfiguration(sourceFileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let sourceFileSystemId = "sourceFileSystemId_example"; // String | The ID of the source file system in the replication configuration.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteReplicationConfiguration(sourceFileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> deleteTags(fileSystemId, deleteTagsRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system whose tags you want to delete (String).
let deleteTagsRequest = new AmazonElasticFileSystem.DeleteTagsRequest(); // DeleteTagsRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.deleteTags(fileSystemId, deleteTagsRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> DescribeAccessPointsResponse describeAccessPoints(opts)
...
let opts = {
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'maxResults': 56, // Number | (Optional) When retrieving all access points for a file system, you can optionally specify the <code>MaxItems</code> parameter to limit the number of objects returned in a response. The default value is 100. 
  'nextToken': "nextToken_example", // String |  <code>NextToken</code> is present if the response is paginated. You can use <code>NextMarker</code> in the subsequent request to fetch the next page of access point descriptions.
  'accessPointId': "accessPointId_example", // String | (Optional) Specifies an EFS access point to describe in the response; mutually exclusive with <code>FileSystemId</code>.
  'fileSystemId': "fileSystemId_example" // String | (Optional) If you provide a <code>FileSystemId</code>, EFS returns all access points for that file system; mutually exclusive with <code>AccessPointId</code>.
};
apiInstance.describeAccessPoints(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmzSignature** | **String**|  | [optional] 
 **xAmzSignedHeaders** | **String**|  | [optional] 
 **maxResults** | **Number**| (Optional) When retrieving all access points for a file system, you can optionally specify the &lt;code&gt;MaxItems&lt;/code&gt; parameter to limit the number of objects returned in a response. The default value is 100.  | [optional] 
...
> DescribeAccountPreferencesResponse describeAccountPreferences(describeAccountPreferencesRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let describeAccountPreferencesRequest = new AmazonElasticFileSystem.DescribeAccountPreferencesRequest(); // DescribeAccountPreferencesRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.describeAccountPreferences(describeAccountPreferencesRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BackupPolicyDescription describeBackupPolicy(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | Specifies which EFS file system to retrieve the <code>BackupPolicy</code> for.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.describeBackupPolicy(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> FileSystemPolicyDescription describeFileSystemPolicy(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | Specifies which EFS file system to retrieve the <code>FileSystemPolicy</code> for.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.describeFileSystemPolicy(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DescribeFileSystemsResponse describeFileSystems(opts)
...
let opts = {
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'maxItems': 56, // Number | (Optional) Specifies the maximum number of file systems to return in the response (integer). This number is automatically set to 100. The response is paginated at 100 per page if you have more than 100 file systems. 
  'marker': "marker_example", // String | (Optional) Opaque pagination token returned from a previous <code>DescribeFileSystems</code> operation (String). If present, specifies to continue the list from where the returning call had left off. 
  'creationToken': "creationToken_example", // String | (Optional) Restricts the list to the file system with this creation token (String). You specify a creation token when you create an Amazon EFS file system.
  'fileSystemId': "fileSystemId_example" // String | (Optional) ID of the file system whose description you want to retrieve (String).
};
apiInstance.describeFileSystems(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmzSignature** | **String**|  | [optional] 
 **xAmzSignedHeaders** | **String**|  | [optional] 
 **maxItems** | **Number**| (Optional) Specifies the maximum number of file systems to return in the response (integer). This number is automatically set to 100. The response is paginated at 100 per page if you have more than 100 file systems.  | [optional] 
...
> LifecycleConfigurationDescription describeLifecycleConfiguration(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system whose <code>LifecycleConfiguration</code> object you want to retrieve (String).
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.describeLifecycleConfiguration(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DescribeMountTargetSecurityGroupsResponse describeMountTargetSecurityGroups(mountTargetId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let mountTargetId = "mountTargetId_example"; // String | The ID of the mount target whose security groups you want to retrieve.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.describeMountTargetSecurityGroups(mountTargetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DescribeMountTargetsResponse describeMountTargets(opts)
...
let opts = {
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'maxItems': 56, // Number | (Optional) Maximum number of mount targets to return in the response. Currently, this number is automatically set to 10, and other values are ignored. The response is paginated at 100 per page if you have more than 100 mount targets.
  'marker': "marker_example", // String | (Optional) Opaque pagination token returned from a previous <code>DescribeMountTargets</code> operation (String). If present, it specifies to continue the list from where the previous returning call left off.
  'fileSystemId': "fileSystemId_example", // String | (Optional) ID of the file system whose mount targets you want to list (String). It must be included in your request if an <code>AccessPointId</code> or <code>MountTargetId</code> is not included. Accepts either a file system ID or ARN as input.
  'mountTargetId': "mountTargetId_example", // String | (Optional) ID of the mount target that you want to have described (String). It must be included in your request if <code>FileSystemId</code> is not included. Accepts either a mount target ID or ARN as input.
  'accessPointId': "accessPointId_example" // String | (Optional) The ID of the access point whose mount targets that you want to list. It must be included in your request if a <code>FileSystemId</code> or <code>MountTargetId</code> is not included in your request. Accepts either an access point ID or ARN as input.
};
apiInstance.describeMountTargets(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmzSignature** | **String**|  | [optional] 
 **xAmzSignedHeaders** | **String**|  | [optional] 
 **maxItems** | **Number**| (Optional) Maximum number of mount targets to return in the response. Currently, this number is automatically set to 10, and other values are ignored. The response is paginated at 100 per page if you have more than 100 mount targets. | [optional] 
...
> DescribeReplicationConfigurationsResponse describeReplicationConfigurations(opts)
...
let opts = {
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'fileSystemId': "fileSystemId_example", // String | You can retrieve the replication configuration for a specific file system by providing its file system ID.
  'nextToken': "nextToken_example", // String |  <code>NextToken</code> is present if the response is paginated. You can use <code>NextToken</code> in a subsequent request to fetch the next page of output.
  'maxResults': 56 // Number | (Optional) To limit the number of objects returned in a response, you can specify the <code>MaxItems</code> parameter. The default value is 100. 
};
apiInstance.describeReplicationConfigurations(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **maxResults** | **Number**| (Optional) To limit the number of objects returned in a response, you can specify the &lt;code&gt;MaxItems&lt;/code&gt; parameter. The default value is 100.  | [optional] 
...
> DescribeTagsResponse describeTags(fileSystemId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system whose tag set you want to retrieve.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'maxItems': 56, // Number | (Optional) The maximum number of file system tags to return in the response. Currently, this number is automatically set to 100, and other values are ignored. The response is paginated at 100 per page if you have more than 100 tags.
  'marker': "marker_example" // String | (Optional) An opaque pagination token returned from a previous <code>DescribeTags</code> operation (String). If present, it specifies to continue the list from where the previous call left off.
};
apiInstance.describeTags(fileSystemId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmzSignature** | **String**|  | [optional] 
 **xAmzSignedHeaders** | **String**|  | [optional] 
 **maxItems** | **Number**| (Optional) The maximum number of file system tags to return in the response. Currently, this number is automatically set to 100, and other values are ignored. The response is paginated at 100 per page if you have more than 100 tags. | [optional] 
...
> ListTagsForResourceResponse listTagsForResource(resourceId, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let resourceId = "resourceId_example"; // String | Specifies the EFS resource you want to retrieve tags for. You can retrieve tags for EFS file systems and access points using this API endpoint.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
  ...
  'xAmzSignature': "xAmzSignature_example", // String | 
  'xAmzSignedHeaders': "xAmzSignedHeaders_example", // String | 
  'maxResults': 56, // Number | (Optional) Specifies the maximum number of tag objects to return in the response. The default value is 100.
  'nextToken': "nextToken_example" // String | (Optional) You can use <code>NextToken</code> in a subsequent request to fetch the next page of access point descriptions if the response payload was paginated.
};
apiInstance.listTagsForResource(resourceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **xAmzSignature** | **String**|  | [optional] 
 **xAmzSignedHeaders** | **String**|  | [optional] 
 **maxResults** | **Number**| (Optional) Specifies the maximum number of tag objects to return in the response. The default value is 100. | [optional] 
...
> modifyMountTargetSecurityGroups(mountTargetId, modifyMountTargetSecurityGroupsRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let mountTargetId = "mountTargetId_example"; // String | The ID of the mount target whose security groups you want to modify.
let modifyMountTargetSecurityGroupsRequest = new AmazonElasticFileSystem.ModifyMountTargetSecurityGroupsRequest(); // ModifyMountTargetSecurityGroupsRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.modifyMountTargetSecurityGroups(mountTargetId, modifyMountTargetSecurityGroupsRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> PutAccountPreferencesResponse putAccountPreferences(putAccountPreferencesRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let putAccountPreferencesRequest = new AmazonElasticFileSystem.PutAccountPreferencesRequest(); // PutAccountPreferencesRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.putAccountPreferences(putAccountPreferencesRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BackupPolicyDescription putBackupPolicy(fileSystemId, putBackupPolicyRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | Specifies which EFS file system to update the backup policy for.
let putBackupPolicyRequest = new AmazonElasticFileSystem.PutBackupPolicyRequest(); // PutBackupPolicyRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.putBackupPolicy(fileSystemId, putBackupPolicyRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> FileSystemPolicyDescription putFileSystemPolicy(fileSystemId, putFileSystemPolicyRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the EFS file system that you want to create or update the <code>FileSystemPolicy</code> for.
let putFileSystemPolicyRequest = new AmazonElasticFileSystem.PutFileSystemPolicyRequest(); // PutFileSystemPolicyRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.putFileSystemPolicy(fileSystemId, putFileSystemPolicyRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> LifecycleConfigurationDescription putLifecycleConfiguration(fileSystemId, putLifecycleConfigurationRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system for which you are creating the <code>LifecycleConfiguration</code> object (String).
let putLifecycleConfigurationRequest = new AmazonElasticFileSystem.PutLifecycleConfigurationRequest(); // PutLifecycleConfigurationRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.putLifecycleConfiguration(fileSystemId, putLifecycleConfigurationRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> tagResource(resourceId, tagResourceRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let resourceId = "resourceId_example"; // String | The ID specifying the EFS resource that you want to create a tag for.
let tagResourceRequest = new AmazonElasticFileSystem.TagResourceRequest(); // TagResourceRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.tagResource(resourceId, tagResourceRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> untagResource(resourceId, tagKeys, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let resourceId = "resourceId_example"; // String | Specifies the EFS resource that you want to remove tags from.
let tagKeys = ["null"]; // [String] | The keys of the key-value tag pairs that you want to remove from the specified EFS resource.
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.untagResource(resourceId, tagKeys, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **tagKeys** | [**[String]**](String.md)| The keys of the key-value tag pairs that you want to remove from the specified EFS resource. | 
 **xAmzContentSha256** | **String**|  | [optional] 
 **xAmzDate** | **String**|  | [optional] 
 **xAmzAlgorithm** | **String**|  | [optional] 
 **xAmzCredential** | **String**|  | [optional] 
...
> FileSystemDescription updateFileSystem(fileSystemId, updateFileSystemRequest, opts)
...
let apiInstance = new AmazonElasticFileSystem.DefaultApi();
let fileSystemId = "fileSystemId_example"; // String | The ID of the file system that you want to update.
let updateFileSystemRequest = new AmazonElasticFileSystem.UpdateFileSystemRequest(); // UpdateFileSystemRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.updateFileSystem(fileSystemId, updateFileSystemRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
