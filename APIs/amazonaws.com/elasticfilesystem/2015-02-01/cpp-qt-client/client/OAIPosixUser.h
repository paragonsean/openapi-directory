...
#ifndef OAIPosixUser_H
#define OAIPosixUser_H
...
class OAIPosixUser : public OAIObject {
public:
    OAIPosixUser();
    OAIPosixUser(QString json);
    ~OAIPosixUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosixUser)

#endif // OAIPosixUser_H
