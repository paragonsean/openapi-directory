...
/*
 * OAICreateAccessPoint_request_RootDirectory.h
 *
...
#ifndef OAICreateAccessPoint_request_RootDirectory_H
#define OAICreateAccessPoint_request_RootDirectory_H
...
class OAICreateAccessPoint_request_RootDirectory : public OAIObject {
public:
    OAICreateAccessPoint_request_RootDirectory();
    OAICreateAccessPoint_request_RootDirectory(QString json);
    ~OAICreateAccessPoint_request_RootDirectory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessPoint_request_RootDirectory)

#endif // OAICreateAccessPoint_request_RootDirectory_H
