...
/*
 * OAIDescribeTagsResponse.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeTagsResponse_H
#define OAIDescribeTagsResponse_H
...
class OAIDescribeTagsResponse : public OAIObject {
public:
    OAIDescribeTagsResponse();
    OAIDescribeTagsResponse(QString json);
    ~OAIDescribeTagsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTagsResponse)

#endif // OAIDescribeTagsResponse_H
