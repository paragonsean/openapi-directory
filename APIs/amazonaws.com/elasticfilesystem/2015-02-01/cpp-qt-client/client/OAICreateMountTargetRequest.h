...
/*
 * OAICreateMountTargetRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAICreateMountTargetRequest_H
#define OAICreateMountTargetRequest_H
...
class OAICreateMountTargetRequest : public OAIObject {
public:
    OAICreateMountTargetRequest();
    OAICreateMountTargetRequest(QString json);
    ~OAICreateMountTargetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMountTargetRequest)

#endif // OAICreateMountTargetRequest_H
