...
async def test_create_access_point(client):
    ...
    """
    body = {"FileSystemId":"","RootDirectory":{"Path":"","CreationInfo":{"OwnerGid":"","OwnerUid":"","Permissions":""}},"ClientToken":"","PosixUser":{"Uid":"","SecondaryGids":"","Gid":""},"Tags":""}
    headers = { 
...
async def test_create_file_system(client):
    ...
    """
    body = {"CreationToken":"","KmsKeyId":"","PerformanceMode":"","Encrypted":"","Backup":"","ProvisionedThroughputInMibps":"","AvailabilityZoneName":"","ThroughputMode":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_mount_target(client):
    """Test case for create_mount_target

    
    """
    body = {"SecurityGroups":"","FileSystemId":"","IpAddress":"","SubnetId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_replication_configuration(client):
    """Test case for create_replication_configuration
    ...
    response = await client.request(
        method='POST',
        path='/2015-02-01/file-systems/{source_file_system_id}/replication-configuration'.format(source_file_system_id='source_file_system_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_tags(client):
    ...
    response = await client.request(
        method='POST',
        path='/2015-02-01/create-tags/{file_system_id}'.format(file_system_id='file_system_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_access_point(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2015-02-01/access-points/{access_point_id}'.format(access_point_id='access_point_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_file_system(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2015-02-01/file-systems/{file_system_id}'.format(file_system_id='file_system_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_file_system_policy(client):
    """Test case for delete_file_system_policy
    ...
    response = await client.request(
        method='DELETE',
        path='/2015-02-01/file-systems/{file_system_id}/policy'.format(file_system_id='file_system_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_mount_target(client):
    """Test case for delete_mount_target
    ...
    response = await client.request(
        method='DELETE',
        path='/2015-02-01/mount-targets/{mount_target_id}'.format(mount_target_id='mount_target_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_replication_configuration(client):
    """Test case for delete_replication_configuration
...
async def test_delete_tags(client):
    ...
    response = await client.request(
        method='POST',
        path='/2015-02-01/delete-tags/{file_system_id}'.format(file_system_id='file_system_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_access_points(client):
    """Test case for describe_access_points
    ...
    params = [('MaxResults', 56),
                    ...
                    ('FileSystemId', 'file_system_id_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_describe_account_preferences(client):
    """Test case for describe_account_preferences
...
async def test_describe_backup_policy(client):
    """Test case for describe_backup_policy
    ...
    response = await client.request(
        method='GET',
        path='/2015-02-01/file-systems/{file_system_id}/backup-policy'.format(file_system_id='file_system_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_file_system_policy(client):
    """Test case for describe_file_system_policy
...
async def test_describe_file_systems(client):
    ...
    params = [('MaxItems', 56),
                    ...
                    ('CreationToken', 'creation_token_example'),
                    ('FileSystemId', 'file_system_id_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_lifecycle_configuration(client):
    """Test case for describe_lifecycle_configuration
    ...
    response = await client.request(
        method='GET',
        path='/2015-02-01/file-systems/{file_system_id}/lifecycle-configuration'.format(file_system_id='file_system_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_mount_target_security_groups(client):
    """Test case for describe_mount_target_security_groups
    ...
    response = await client.request(
        method='GET',
        path='/2015-02-01/mount-targets/{mount_target_id}/security-groups'.format(mount_target_id='mount_target_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_mount_targets(client):
    """Test case for describe_mount_targets
    ...
    params = [('MaxItems', 56),
                    ('Marker', 'marker_example'),
                    ('FileSystemId', 'file_system_id_example'),
                    ('MountTargetId', 'mount_target_id_example'),
                    ('AccessPointId', 'access_point_id_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_describe_replication_configurations(client):
    """Test case for describe_replication_configurations

    
    """
    params = [('FileSystemId', 'file_system_id_example'),
                    ('NextToken', 'next_token_example'),
                    ('MaxResults', 56)]
    headers = { 
        'Accept': 'application/json',
...
async def test_describe_tags(client):
    ...
    response = await client.request(
        method='GET',
        path='/2015-02-01/tags/{file_system_id}'.format(file_system_id='file_system_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='GET',
        path='/2015-02-01/resource-tags/{resource_id}'.format(resource_id='resource_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_modify_mount_target_security_groups(client):
    """Test case for modify_mount_target_security_groups
...
async def test_put_account_preferences(client):
    """Test case for put_account_preferences
...
async def test_put_backup_policy(client):
    """Test case for put_backup_policy
...
async def test_put_file_system_policy(client):
    """Test case for put_file_system_policy

    
    """
    body = {"Policy":"","BypassPolicyLockoutSafetyCheck":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_put_lifecycle_configuration(client):
    """Test case for put_lifecycle_configuration
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/2015-02-01/resource-tags/{resource_idtag_key}'.format(resource_id='resource_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_file_system(client):
    ...
    """
    body = {"ProvisionedThroughputInMibps":"","ThroughputMode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
