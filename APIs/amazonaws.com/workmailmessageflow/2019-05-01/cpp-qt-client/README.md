...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getRawMessageContentSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getRawMessageContentSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString message_id = create(); // QString | The identifier of the email message to retrieve.
      ...
      apiInstance.getRawMessageContent(message_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
