...
#ifndef OAIRawMessageContent_H
#define OAIRawMessageContent_H
...
class OAIRawMessageContent : public OAIObject {
public:
    OAIRawMessageContent();
    OAIRawMessageContent(QString json);
    ~OAIRawMessageContent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRawMessageContent)

#endif // OAIRawMessageContent_H
