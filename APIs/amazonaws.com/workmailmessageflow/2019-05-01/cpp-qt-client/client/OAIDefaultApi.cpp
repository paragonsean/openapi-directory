...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://workmailmessageflow.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://workmailmessageflow.{region}.amazonaws.com"),
    "The Amazon WorkMail Message Flow multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://workmailmessageflow.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://workmailmessageflow.{region}.amazonaws.com.cn"),
    "The Amazon WorkMail Message Flow endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
    
    _serverConfigs.insert("getRawMessageContent", defaultConf);
    _serverIndices.insert("getRawMessageContent", 0);
    _serverConfigs.insert("putRawMessageContent", defaultConf);
    _serverIndices.insert("putRawMessageContent", 0);
}
...
void OAIDefaultApi::getRawMessageContent(const QString &message_id, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["getRawMessageContent"][_serverIndices.value("getRawMessageContent")].URL()+"/messages/{messageId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getRawMessageContentCallback);
...
void OAIDefaultApi::getRawMessageContentCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetRawMessageContentResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getRawMessageContentSignal(output);
        Q_EMIT getRawMessageContentSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getRawMessageContentSignalE(output, error_type, error_str);
        Q_EMIT getRawMessageContentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getRawMessageContentSignalError(output, error_type, error_str);
        Q_EMIT getRawMessageContentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::putRawMessageContent(const QString &message_id, const OAIPutRawMessageContent_request &oai_put_raw_message_content_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["putRawMessageContent"][_serverIndices.value("putRawMessageContent")].URL()+"/messages/{messageId}");
...

    {
        ...
        QByteArray output = oai_put_raw_message_content_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::putRawMessageContentCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::putRawMessageContentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT putRawMessageContentSignal(output);
        Q_EMIT putRawMessageContentSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT putRawMessageContentSignalE(output, error_type, error_str);
        Q_EMIT putRawMessageContentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT putRawMessageContentSignalError(output, error_type, error_str);
        Q_EMIT putRawMessageContentSignalErrorFull(worker, error_type, error_str);
    }
}
