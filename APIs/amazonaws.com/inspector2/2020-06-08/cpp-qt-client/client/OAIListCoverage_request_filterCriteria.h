...
/*
 * OAIListCoverage_request_filterCriteria.h
 *
 * A structure that identifies filter criteria for &lt;code&gt;GetCoverageStatistics&lt;/code&gt;.
 */

#ifndef OAIListCoverage_request_filterCriteria_H
#define OAIListCoverage_request_filterCriteria_H
...
class OAIListCoverage_request_filterCriteria : public OAIObject {
public:
    OAIListCoverage_request_filterCriteria();
    OAIListCoverage_request_filterCriteria(QString json);
    ~OAIListCoverage_request_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCoverage_request_filterCriteria)

#endif // OAIListCoverage_request_filterCriteria_H
