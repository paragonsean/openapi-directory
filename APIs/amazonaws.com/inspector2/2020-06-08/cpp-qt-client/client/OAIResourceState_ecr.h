...
/*
 * OAIResourceState_ecr.h
 *
 * 
 */

#ifndef OAIResourceState_ecr_H
#define OAIResourceState_ecr_H
...
class OAIResourceState_ecr : public OAIObject {
public:
    OAIResourceState_ecr();
    OAIResourceState_ecr(QString json);
    ~OAIResourceState_ecr() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceState_ecr)

#endif // OAIResourceState_ecr_H
