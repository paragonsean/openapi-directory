...
OAIListCoverageRequest_filterCriteria::OAIListCoverageRequest_filterCriteria(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListCoverageRequest_filterCriteria::OAIListCoverageRequest_filterCriteria() {
    this->initializeModel();
}

OAIListCoverageRequest_filterCriteria::~OAIListCoverageRequest_filterCriteria() {}

void OAIListCoverageRequest_filterCriteria::initializeModel() {
...
void OAIListCoverageRequest_filterCriteria::fromJson(QString jsonString) {
...
void OAIListCoverageRequest_filterCriteria::fromJsonObject(QJsonObject json) {
...
QString OAIListCoverageRequest_filterCriteria::asJson() const {
...
QJsonObject OAIListCoverageRequest_filterCriteria::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListCoverageRequest_filterCriteria::getAccountId() const {
    return m_account_id;
}
void OAIListCoverageRequest_filterCriteria::setAccountId(const QList &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getEc2InstanceTags() const {
    return m_ec2_instance_tags;
}
void OAIListCoverageRequest_filterCriteria::setEc2InstanceTags(const QList &ec2_instance_tags) {
    m_ec2_instance_tags = ec2_instance_tags;
    m_ec2_instance_tags_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_ec2_instance_tags_Set() const{
    return m_ec2_instance_tags_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_ec2_instance_tags_Valid() const{
    return m_ec2_instance_tags_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getEcrImageTags() const {
    return m_ecr_image_tags;
}
void OAIListCoverageRequest_filterCriteria::setEcrImageTags(const QList &ecr_image_tags) {
    m_ecr_image_tags = ecr_image_tags;
    m_ecr_image_tags_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_ecr_image_tags_Set() const{
    return m_ecr_image_tags_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_ecr_image_tags_Valid() const{
    return m_ecr_image_tags_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getEcrRepositoryName() const {
    return m_ecr_repository_name;
}
void OAIListCoverageRequest_filterCriteria::setEcrRepositoryName(const QList &ecr_repository_name) {
    m_ecr_repository_name = ecr_repository_name;
    m_ecr_repository_name_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_ecr_repository_name_Set() const{
    return m_ecr_repository_name_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_ecr_repository_name_Valid() const{
    return m_ecr_repository_name_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getLambdaFunctionName() const {
    return m_lambda_function_name;
}
void OAIListCoverageRequest_filterCriteria::setLambdaFunctionName(const QList &lambda_function_name) {
    m_lambda_function_name = lambda_function_name;
    m_lambda_function_name_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_name_Set() const{
    return m_lambda_function_name_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_name_Valid() const{
    return m_lambda_function_name_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getLambdaFunctionRuntime() const {
    return m_lambda_function_runtime;
}
void OAIListCoverageRequest_filterCriteria::setLambdaFunctionRuntime(const QList &lambda_function_runtime) {
    m_lambda_function_runtime = lambda_function_runtime;
    m_lambda_function_runtime_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_runtime_Set() const{
    return m_lambda_function_runtime_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_runtime_Valid() const{
    return m_lambda_function_runtime_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getLambdaFunctionTags() const {
    return m_lambda_function_tags;
}
void OAIListCoverageRequest_filterCriteria::setLambdaFunctionTags(const QList &lambda_function_tags) {
    m_lambda_function_tags = lambda_function_tags;
    m_lambda_function_tags_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_tags_Set() const{
    return m_lambda_function_tags_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_lambda_function_tags_Valid() const{
    return m_lambda_function_tags_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getLastScannedAt() const {
    return m_last_scanned_at;
}
void OAIListCoverageRequest_filterCriteria::setLastScannedAt(const QList &last_scanned_at) {
    m_last_scanned_at = last_scanned_at;
    m_last_scanned_at_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_last_scanned_at_Set() const{
    return m_last_scanned_at_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_last_scanned_at_Valid() const{
    return m_last_scanned_at_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getResourceId() const {
    return m_resource_id;
}
void OAIListCoverageRequest_filterCriteria::setResourceId(const QList &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getResourceType() const {
    return m_resource_type;
}
void OAIListCoverageRequest_filterCriteria::setResourceType(const QList &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getScanStatusCode() const {
    return m_scan_status_code;
}
void OAIListCoverageRequest_filterCriteria::setScanStatusCode(const QList &scan_status_code) {
    m_scan_status_code = scan_status_code;
    m_scan_status_code_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_status_code_Set() const{
    return m_scan_status_code_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_status_code_Valid() const{
    return m_scan_status_code_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getScanStatusReason() const {
    return m_scan_status_reason;
}
void OAIListCoverageRequest_filterCriteria::setScanStatusReason(const QList &scan_status_reason) {
    m_scan_status_reason = scan_status_reason;
    m_scan_status_reason_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_status_reason_Set() const{
    return m_scan_status_reason_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_status_reason_Valid() const{
    return m_scan_status_reason_isValid;
}

QList OAIListCoverageRequest_filterCriteria::getScanType() const {
    return m_scan_type;
}
void OAIListCoverageRequest_filterCriteria::setScanType(const QList &scan_type) {
    m_scan_type = scan_type;
    m_scan_type_isSet = true;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_type_Set() const{
    return m_scan_type_isSet;
}

bool OAIListCoverageRequest_filterCriteria::is_scan_type_Valid() const{
    return m_scan_type_isValid;
}

bool OAIListCoverageRequest_filterCriteria::isSet() const {
...
bool OAIListCoverageRequest_filterCriteria::isValid() const {
