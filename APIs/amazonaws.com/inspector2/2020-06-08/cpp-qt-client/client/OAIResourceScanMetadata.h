...
/*
 * OAIResourceScanMetadata.h
 *
 * An object that contains details about the metadata for an Amazon ECR resource.
 */

#ifndef OAIResourceScanMetadata_H
#define OAIResourceScanMetadata_H
...
class OAIResourceScanMetadata : public OAIObject {
public:
    OAIResourceScanMetadata();
    OAIResourceScanMetadata(QString json);
    ~OAIResourceScanMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceScanMetadata)

#endif // OAIResourceScanMetadata_H
