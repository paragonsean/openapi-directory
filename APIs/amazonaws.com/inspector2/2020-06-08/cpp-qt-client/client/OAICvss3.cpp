...
OAICvss3::OAICvss3(QString json) {
...
void OAICvss3::fromJson(QString jsonString) {
...
void OAICvss3::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICvss3::asJsonObject() const {
    QJsonObject obj;
...
double OAICvss3::getBaseScore() const {
    return m_base_score;
}
void OAICvss3::setBaseScore(const double &base_score) {
    m_base_score = base_score;
    m_base_score_isSet = true;
}

bool OAICvss3::is_base_score_Set() const{
    return m_base_score_isSet;
}

bool OAICvss3::is_base_score_Valid() const{
    return m_base_score_isValid;
}

QString OAICvss3::getScoringVector() const {
    return m_scoring_vector;
}
void OAICvss3::setScoringVector(const QString &scoring_vector) {
    m_scoring_vector = scoring_vector;
    m_scoring_vector_isSet = true;
}

bool OAICvss3::is_scoring_vector_Set() const{
    return m_scoring_vector_isSet;
}

bool OAICvss3::is_scoring_vector_Valid() const{
    return m_scoring_vector_isValid;
}

bool OAICvss3::isSet() const {
