...
OAIEnableResponse::OAIEnableResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnableResponse::OAIEnableResponse() {
    this->initializeModel();
}

OAIEnableResponse::~OAIEnableResponse() {}

void OAIEnableResponse::initializeModel() {
...
void OAIEnableResponse::fromJson(QString jsonString) {
...
void OAIEnableResponse::fromJsonObject(QJsonObject json) {
...
QString OAIEnableResponse::asJson() const {
...
QJsonObject OAIEnableResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_accounts.isSet()) {
...
QList OAIEnableResponse::getAccounts() const {
    return m_accounts;
}
void OAIEnableResponse::setAccounts(const QList &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIEnableResponse::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIEnableResponse::is_accounts_Valid() const{
    return m_accounts_isValid;
}

QList OAIEnableResponse::getFailedAccounts() const {
    return m_failed_accounts;
}
void OAIEnableResponse::setFailedAccounts(const QList &failed_accounts) {
    m_failed_accounts = failed_accounts;
    m_failed_accounts_isSet = true;
}

bool OAIEnableResponse::is_failed_accounts_Set() const{
    return m_failed_accounts_isSet;
}

bool OAIEnableResponse::is_failed_accounts_Valid() const{
    return m_failed_accounts_isValid;
}

bool OAIEnableResponse::isSet() const {
...
bool OAIEnableResponse::isValid() const {
