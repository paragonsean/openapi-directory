...
/*
 * OAIResourceDetails_awsLambdaFunction.h
 *
 * 
 */

#ifndef OAIResourceDetails_awsLambdaFunction_H
#define OAIResourceDetails_awsLambdaFunction_H
...
class OAIResourceDetails_awsLambdaFunction : public OAIObject {
public:
    OAIResourceDetails_awsLambdaFunction();
    OAIResourceDetails_awsLambdaFunction(QString json);
    ~OAIResourceDetails_awsLambdaFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceDetails_awsLambdaFunction)

#endif // OAIResourceDetails_awsLambdaFunction_H
