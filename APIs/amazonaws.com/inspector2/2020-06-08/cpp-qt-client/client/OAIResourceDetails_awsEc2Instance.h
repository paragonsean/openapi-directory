...
/*
 * OAIResourceDetails_awsEc2Instance.h
 *
 * 
 */

#ifndef OAIResourceDetails_awsEc2Instance_H
#define OAIResourceDetails_awsEc2Instance_H
...
class OAIResourceDetails_awsEc2Instance : public OAIObject {
public:
    OAIResourceDetails_awsEc2Instance();
    OAIResourceDetails_awsEc2Instance(QString json);
    ~OAIResourceDetails_awsEc2Instance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceDetails_awsEc2Instance)

#endif // OAIResourceDetails_awsEc2Instance_H
