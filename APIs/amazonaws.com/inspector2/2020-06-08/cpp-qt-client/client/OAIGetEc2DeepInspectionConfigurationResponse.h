...
/*
 * OAIGetEc2DeepInspectionConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetEc2DeepInspectionConfigurationResponse_H
#define OAIGetEc2DeepInspectionConfigurationResponse_H
...
class OAIGetEc2DeepInspectionConfigurationResponse : public OAIObject {
public:
    OAIGetEc2DeepInspectionConfigurationResponse();
    OAIGetEc2DeepInspectionConfigurationResponse(QString json);
    ~OAIGetEc2DeepInspectionConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEc2DeepInspectionConfigurationResponse)

#endif // OAIGetEc2DeepInspectionConfigurationResponse_H
