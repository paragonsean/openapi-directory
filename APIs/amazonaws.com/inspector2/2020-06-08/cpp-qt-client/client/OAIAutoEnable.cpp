...
OAIAutoEnable::OAIAutoEnable(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutoEnable::OAIAutoEnable() {
    this->initializeModel();
}

OAIAutoEnable::~OAIAutoEnable() {}

void OAIAutoEnable::initializeModel() {
...
void OAIAutoEnable::fromJson(QString jsonString) {
...
void OAIAutoEnable::fromJsonObject(QJsonObject json) {
...
QString OAIAutoEnable::asJson() const {
...
QJsonObject OAIAutoEnable::asJsonObject() const {
    QJsonObject obj;
    if (m_ec2_isSet) {
...
bool OAIAutoEnable::getEc2() const {
    return m_ec2;
}
void OAIAutoEnable::setEc2(const bool &ec2) {
    m_ec2 = ec2;
    m_ec2_isSet = true;
}

bool OAIAutoEnable::is_ec2_Set() const{
    return m_ec2_isSet;
}

bool OAIAutoEnable::is_ec2_Valid() const{
    return m_ec2_isValid;
}

bool OAIAutoEnable::getEcr() const {
    return m_ecr;
}
void OAIAutoEnable::setEcr(const bool &ecr) {
    m_ecr = ecr;
    m_ecr_isSet = true;
}

bool OAIAutoEnable::is_ecr_Set() const{
    return m_ecr_isSet;
}

bool OAIAutoEnable::is_ecr_Valid() const{
    return m_ecr_isValid;
}

bool OAIAutoEnable::getLambda() const {
    return m_lambda;
}
void OAIAutoEnable::setLambda(const bool &lambda) {
    m_lambda = lambda;
    m_lambda_isSet = true;
}

bool OAIAutoEnable::is_lambda_Set() const{
    return m_lambda_isSet;
}

bool OAIAutoEnable::is_lambda_Valid() const{
    return m_lambda_isValid;
}

bool OAIAutoEnable::getLambdaCode() const {
    return m_lambda_code;
}
void OAIAutoEnable::setLambdaCode(const bool &lambda_code) {
    m_lambda_code = lambda_code;
    m_lambda_code_isSet = true;
}

bool OAIAutoEnable::is_lambda_code_Set() const{
    return m_lambda_code_isSet;
}

bool OAIAutoEnable::is_lambda_code_Valid() const{
    return m_lambda_code_isValid;
}

bool OAIAutoEnable::isSet() const {
...
bool OAIAutoEnable::isValid() const {
