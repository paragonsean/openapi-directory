...
/*
 * OAICreateFilter_request_filterCriteria.h
 *
 * Details on the criteria used to define the filter.
 */

#ifndef OAICreateFilter_request_filterCriteria_H
#define OAICreateFilter_request_filterCriteria_H
...
class OAICreateFilter_request_filterCriteria : public OAIObject {
public:
    OAICreateFilter_request_filterCriteria();
    OAICreateFilter_request_filterCriteria(QString json);
    ~OAICreateFilter_request_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFilter_request_filterCriteria)

#endif // OAICreateFilter_request_filterCriteria_H
