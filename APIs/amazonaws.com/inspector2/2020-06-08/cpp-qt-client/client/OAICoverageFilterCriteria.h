...
/*
 * OAICoverageFilterCriteria.h
 *
 * A structure that identifies filter criteria for &lt;code&gt;GetCoverageStatistics&lt;/code&gt;.
 */

#ifndef OAICoverageFilterCriteria_H
#define OAICoverageFilterCriteria_H
...
class OAICoverageFilterCriteria : public OAIObject {
public:
    OAICoverageFilterCriteria();
    OAICoverageFilterCriteria(QString json);
    ~OAICoverageFilterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoverageFilterCriteria)

#endif // OAICoverageFilterCriteria_H
