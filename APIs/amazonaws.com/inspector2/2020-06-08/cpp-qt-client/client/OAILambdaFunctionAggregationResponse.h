...
/*
 * OAILambdaFunctionAggregationResponse.h
 *
 * A response that contains the results of an AWS Lambda function finding aggregation.
 */

#ifndef OAILambdaFunctionAggregationResponse_H
#define OAILambdaFunctionAggregationResponse_H
...
class OAILambdaFunctionAggregationResponse : public OAIObject {
public:
    OAILambdaFunctionAggregationResponse();
    OAILambdaFunctionAggregationResponse(QString json);
    ~OAILambdaFunctionAggregationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionAggregationResponse)

#endif // OAILambdaFunctionAggregationResponse_H
