...
/*
 * OAIResourceDetails_awsEcrContainerImage.h
 *
 * 
 */

#ifndef OAIResourceDetails_awsEcrContainerImage_H
#define OAIResourceDetails_awsEcrContainerImage_H
...
class OAIResourceDetails_awsEcrContainerImage : public OAIObject {
public:
    OAIResourceDetails_awsEcrContainerImage();
    OAIResourceDetails_awsEcrContainerImage(QString json);
    ~OAIResourceDetails_awsEcrContainerImage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceDetails_awsEcrContainerImage)

#endif // OAIResourceDetails_awsEcrContainerImage_H
