...
/*
 * OAIFilter_criteria.h
 *
 * 
 */

#ifndef OAIFilter_criteria_H
#define OAIFilter_criteria_H
...
class OAIFilter_criteria : public OAIObject {
public:
    OAIFilter_criteria();
    OAIFilter_criteria(QString json);
    ~OAIFilter_criteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilter_criteria)

#endif // OAIFilter_criteria_H
