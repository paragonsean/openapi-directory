...
#include "OAIEc2InstanceAggregation.h"
...
OAIEc2InstanceAggregation::OAIEc2InstanceAggregation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEc2InstanceAggregation::OAIEc2InstanceAggregation() {
    this->initializeModel();
}

OAIEc2InstanceAggregation::~OAIEc2InstanceAggregation() {}

void OAIEc2InstanceAggregation::initializeModel() {
...
void OAIEc2InstanceAggregation::fromJson(QString jsonString) {
...
void OAIEc2InstanceAggregation::fromJsonObject(QJsonObject json) {
...
QString OAIEc2InstanceAggregation::asJson() const {
...
QJsonObject OAIEc2InstanceAggregation::asJsonObject() const {
    QJsonObject obj;
    if (m_amis.isSet()) {
...
QList OAIEc2InstanceAggregation::getAmis() const {
    return m_amis;
}
void OAIEc2InstanceAggregation::setAmis(const QList &amis) {
    m_amis = amis;
    m_amis_isSet = true;
}

bool OAIEc2InstanceAggregation::is_amis_Set() const{
    return m_amis_isSet;
}

bool OAIEc2InstanceAggregation::is_amis_Valid() const{
    return m_amis_isValid;
}

QList OAIEc2InstanceAggregation::getInstanceIds() const {
    return m_instance_ids;
}
void OAIEc2InstanceAggregation::setInstanceIds(const QList &instance_ids) {
    m_instance_ids = instance_ids;
    m_instance_ids_isSet = true;
}

bool OAIEc2InstanceAggregation::is_instance_ids_Set() const{
    return m_instance_ids_isSet;
}

bool OAIEc2InstanceAggregation::is_instance_ids_Valid() const{
    return m_instance_ids_isValid;
}

QList OAIEc2InstanceAggregation::getInstanceTags() const {
    return m_instance_tags;
}
void OAIEc2InstanceAggregation::setInstanceTags(const QList &instance_tags) {
    m_instance_tags = instance_tags;
    m_instance_tags_isSet = true;
}

bool OAIEc2InstanceAggregation::is_instance_tags_Set() const{
    return m_instance_tags_isSet;
}

bool OAIEc2InstanceAggregation::is_instance_tags_Valid() const{
    return m_instance_tags_isValid;
}

QList OAIEc2InstanceAggregation::getOperatingSystems() const {
    return m_operating_systems;
}
void OAIEc2InstanceAggregation::setOperatingSystems(const QList &operating_systems) {
    m_operating_systems = operating_systems;
    m_operating_systems_isSet = true;
}

bool OAIEc2InstanceAggregation::is_operating_systems_Set() const{
    return m_operating_systems_isSet;
}

bool OAIEc2InstanceAggregation::is_operating_systems_Valid() const{
    return m_operating_systems_isValid;
}

OAIEc2InstanceSortBy OAIEc2InstanceAggregation::getSortBy() const {
    return m_sort_by;
}
void OAIEc2InstanceAggregation::setSortBy(const OAIEc2InstanceSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIEc2InstanceAggregation::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIEc2InstanceAggregation::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAISortOrder OAIEc2InstanceAggregation::getSortOrder() const {
    return m_sort_order;
}
void OAIEc2InstanceAggregation::setSortOrder(const OAISortOrder &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIEc2InstanceAggregation::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIEc2InstanceAggregation::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

bool OAIEc2InstanceAggregation::isSet() const {
...
bool OAIEc2InstanceAggregation::isValid() const {
