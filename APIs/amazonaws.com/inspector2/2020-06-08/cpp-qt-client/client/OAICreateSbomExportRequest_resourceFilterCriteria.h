...
/*
 * OAICreateSbomExportRequest_resourceFilterCriteria.h
 *
 * 
 */

#ifndef OAICreateSbomExportRequest_resourceFilterCriteria_H
#define OAICreateSbomExportRequest_resourceFilterCriteria_H
...
class OAICreateSbomExportRequest_resourceFilterCriteria : public OAIObject {
public:
    OAICreateSbomExportRequest_resourceFilterCriteria();
    OAICreateSbomExportRequest_resourceFilterCriteria(QString json);
    ~OAICreateSbomExportRequest_resourceFilterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSbomExportRequest_resourceFilterCriteria)

#endif // OAICreateSbomExportRequest_resourceFilterCriteria_H
