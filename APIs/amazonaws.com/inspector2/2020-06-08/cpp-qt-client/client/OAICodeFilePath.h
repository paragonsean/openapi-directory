...
#ifndef OAICodeFilePath_H
#define OAICodeFilePath_H
...
class OAICodeFilePath : public OAIObject {
public:
    OAICodeFilePath();
    OAICodeFilePath(QString json);
    ~OAICodeFilePath() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeFilePath)

#endif // OAICodeFilePath_H
