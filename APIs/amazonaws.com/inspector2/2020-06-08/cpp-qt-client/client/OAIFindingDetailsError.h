...
class OAIFindingDetailsError : public OAIObject {
public:
    OAIFindingDetailsError();
    OAIFindingDetailsError(QString json);
    ~OAIFindingDetailsError() override;
    ...
    OAIFindingDetailsErrorCode getErrorCode() const;
    void setErrorCode(const OAIFindingDetailsErrorCode &error_code);
...
private:
    ...
    OAIFindingDetailsErrorCode m_error_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindingDetailsError)

#endif // OAIFindingDetailsError_H
