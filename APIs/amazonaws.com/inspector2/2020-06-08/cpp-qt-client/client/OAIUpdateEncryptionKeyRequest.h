...
/*
 * OAIUpdateEncryptionKeyRequest.h
 *
 * 
 */

#ifndef OAIUpdateEncryptionKeyRequest_H
#define OAIUpdateEncryptionKeyRequest_H
...
class OAIUpdateEncryptionKeyRequest : public OAIObject {
public:
    OAIUpdateEncryptionKeyRequest();
    OAIUpdateEncryptionKeyRequest(QString json);
    ~OAIUpdateEncryptionKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEncryptionKeyRequest)

#endif // OAIUpdateEncryptionKeyRequest_H
