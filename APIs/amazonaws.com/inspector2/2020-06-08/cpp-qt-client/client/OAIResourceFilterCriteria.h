...
/*
 * OAIResourceFilterCriteria.h
 *
 * The resource filter criteria for a Software bill of materials (SBOM) report.
 */

#ifndef OAIResourceFilterCriteria_H
#define OAIResourceFilterCriteria_H
...
class OAIResourceFilterCriteria : public OAIObject {
public:
    OAIResourceFilterCriteria();
    OAIResourceFilterCriteria(QString json);
    ~OAIResourceFilterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceFilterCriteria)

#endif // OAIResourceFilterCriteria_H
