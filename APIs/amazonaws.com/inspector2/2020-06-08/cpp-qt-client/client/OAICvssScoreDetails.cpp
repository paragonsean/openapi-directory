...
QString OAICvssScoreDetails::getCvssSource() const {
    return m_cvss_source;
}
void OAICvssScoreDetails::setCvssSource(const QString &cvss_source) {
    m_cvss_source = cvss_source;
    m_cvss_source_isSet = true;
}

bool OAICvssScoreDetails::is_cvss_source_Set() const{
    return m_cvss_source_isSet;
}

bool OAICvssScoreDetails::is_cvss_source_Valid() const{
