...
/*
 * OAIUpdateFilterRequest_filterCriteria.h
 *
 * 
 */

#ifndef OAIUpdateFilterRequest_filterCriteria_H
#define OAIUpdateFilterRequest_filterCriteria_H
...
class OAIUpdateFilterRequest_filterCriteria : public OAIObject {
public:
    OAIUpdateFilterRequest_filterCriteria();
    OAIUpdateFilterRequest_filterCriteria(QString json);
    ~OAIUpdateFilterRequest_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFilterRequest_filterCriteria)

#endif // OAIUpdateFilterRequest_filterCriteria_H
