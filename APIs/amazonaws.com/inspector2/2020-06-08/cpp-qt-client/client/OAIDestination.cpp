...
QString OAIDestination::getBucketName() const {
    return m_bucket_name;
}
void OAIDestination::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIDestination::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIDestination::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

QString OAIDestination::getKeyPrefix() const {
    return m_key_prefix;
}
void OAIDestination::setKeyPrefix(const QString &key_prefix) {
    m_key_prefix = key_prefix;
    m_key_prefix_isSet = true;
}

bool OAIDestination::is_key_prefix_Set() const{
    return m_key_prefix_isSet;
}

bool OAIDestination::is_key_prefix_Valid() const{
    return m_key_prefix_isValid;
}

QString OAIDestination::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIDestination::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIDestination::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIDestination::is_kms_key_arn_Valid() const{
