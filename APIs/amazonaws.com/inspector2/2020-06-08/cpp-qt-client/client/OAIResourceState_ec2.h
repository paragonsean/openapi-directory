...
/*
 * OAIResourceState_ec2.h
 *
 * 
 */

#ifndef OAIResourceState_ec2_H
#define OAIResourceState_ec2_H
...
class OAIResourceState_ec2 : public OAIObject {
public:
    OAIResourceState_ec2();
    OAIResourceState_ec2(QString json);
    ~OAIResourceState_ec2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceState_ec2)

#endif // OAIResourceState_ec2_H
