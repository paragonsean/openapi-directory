...
/*
 * OAIAggregationResponse_lambdaLayerAggregation.h
 *
 * 
 */

#ifndef OAIAggregationResponse_lambdaLayerAggregation_H
#define OAIAggregationResponse_lambdaLayerAggregation_H
...
class OAIAggregationResponse_lambdaLayerAggregation : public OAIObject {
public:
    OAIAggregationResponse_lambdaLayerAggregation();
    OAIAggregationResponse_lambdaLayerAggregation(QString json);
    ~OAIAggregationResponse_lambdaLayerAggregation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregationResponse_lambdaLayerAggregation)

#endif // OAIAggregationResponse_lambdaLayerAggregation_H
