...
/*
 * OAICreateFindingsReportRequest_filterCriteria.h
 *
 * 
 */

#ifndef OAICreateFindingsReportRequest_filterCriteria_H
#define OAICreateFindingsReportRequest_filterCriteria_H
...
class OAICreateFindingsReportRequest_filterCriteria : public OAIObject {
public:
    OAICreateFindingsReportRequest_filterCriteria();
    OAICreateFindingsReportRequest_filterCriteria(QString json);
    ~OAICreateFindingsReportRequest_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFindingsReportRequest_filterCriteria)

#endif // OAICreateFindingsReportRequest_filterCriteria_H
