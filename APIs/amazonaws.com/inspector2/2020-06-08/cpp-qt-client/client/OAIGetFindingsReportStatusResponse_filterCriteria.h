...
/*
 * OAIGetFindingsReportStatusResponse_filterCriteria.h
 *
 * 
 */

#ifndef OAIGetFindingsReportStatusResponse_filterCriteria_H
#define OAIGetFindingsReportStatusResponse_filterCriteria_H
...
class OAIGetFindingsReportStatusResponse_filterCriteria : public OAIObject {
public:
    OAIGetFindingsReportStatusResponse_filterCriteria();
    OAIGetFindingsReportStatusResponse_filterCriteria(QString json);
    ~OAIGetFindingsReportStatusResponse_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFindingsReportStatusResponse_filterCriteria)

#endif // OAIGetFindingsReportStatusResponse_filterCriteria_H
