...
/*
 * OAICreateFilterRequest_filterCriteria.h
 *
 * 
 */

#ifndef OAICreateFilterRequest_filterCriteria_H
#define OAICreateFilterRequest_filterCriteria_H
...
class OAICreateFilterRequest_filterCriteria : public OAIObject {
public:
    OAICreateFilterRequest_filterCriteria();
    OAICreateFilterRequest_filterCriteria(QString json);
    ~OAICreateFilterRequest_filterCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFilterRequest_filterCriteria)

#endif // OAICreateFilterRequest_filterCriteria_H
