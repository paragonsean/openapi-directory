...
/*
 * OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation.h
 *
 * 
 */

#ifndef OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation_H
#define OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation_H
...
class OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation : public OAIObject {
public:
    OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation();
    OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation(QString json);
    ~OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation)

#endif // OAIListFindingAggregations_request_aggregationRequest_ec2InstanceAggregation_H
