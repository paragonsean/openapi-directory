...
class Example : public QObject {
    Q_OBJECT
    OAIAssociateMember_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIAssociateMember_request Example::create(){
    OAIAssociateMember_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateMemberSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateMemberSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAssociateMember_request oai_associate_member_request = create(); // OAIAssociateMember_request | 
      ...
      apiInstance.associateMember(oai_associate_member_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
