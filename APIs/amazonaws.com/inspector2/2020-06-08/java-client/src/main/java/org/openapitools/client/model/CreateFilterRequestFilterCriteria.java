...
public class CreateFilterRequestFilterCriteria {
  ...
  public CreateFilterRequestFilterCriteria() {
  }

  public CreateFilterRequestFilterCriteria awsAccountId(List awsAccountId) {
  ...
  public CreateFilterRequestFilterCriteria codeVulnerabilityDetectorName(List codeVulnerabilityDetectorName) {
  ...
  public CreateFilterRequestFilterCriteria codeVulnerabilityDetectorTags(List codeVulnerabilityDetectorTags) {
  ...
  public CreateFilterRequestFilterCriteria codeVulnerabilityFilePath(List codeVulnerabilityFilePath) {
  ...
  public CreateFilterRequestFilterCriteria componentId(List componentId) {
  ...
  public CreateFilterRequestFilterCriteria componentType(List componentType) {
  ...
  public CreateFilterRequestFilterCriteria ec2InstanceImageId(List ec2InstanceImageId) {
  ...
  public CreateFilterRequestFilterCriteria ec2InstanceSubnetId(List ec2InstanceSubnetId) {
  ...
  public CreateFilterRequestFilterCriteria ec2InstanceVpcId(List ec2InstanceVpcId) {
  ...
  public CreateFilterRequestFilterCriteria ecrImageArchitecture(List ecrImageArchitecture) {
  ...
  public CreateFilterRequestFilterCriteria ecrImageHash(List ecrImageHash) {
  ...
  public CreateFilterRequestFilterCriteria ecrImagePushedAt(List ecrImagePushedAt) {
  ...
  public CreateFilterRequestFilterCriteria ecrImageRegistry(List ecrImageRegistry) {
  ...
  public CreateFilterRequestFilterCriteria ecrImageRepositoryName(List ecrImageRepositoryName) {
  ...
  public CreateFilterRequestFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public CreateFilterRequestFilterCriteria epssScore(List epssScore) {
  ...
  public CreateFilterRequestFilterCriteria exploitAvailable(List exploitAvailable) {
  ...
  public CreateFilterRequestFilterCriteria findingArn(List findingArn) {
  ...
  public CreateFilterRequestFilterCriteria findingStatus(List findingStatus) {
  ...
  public CreateFilterRequestFilterCriteria findingType(List findingType) {
  ...
  public CreateFilterRequestFilterCriteria firstObservedAt(List firstObservedAt) {
  ...
  public CreateFilterRequestFilterCriteria fixAvailable(List fixAvailable) {
  ...
  public CreateFilterRequestFilterCriteria inspectorScore(List inspectorScore) {
  ...
  public CreateFilterRequestFilterCriteria lambdaFunctionExecutionRoleArn(List lambdaFunctionExecutionRoleArn) {
  ...
  public CreateFilterRequestFilterCriteria lambdaFunctionLastModifiedAt(List lambdaFunctionLastModifiedAt) {
  ...
  public CreateFilterRequestFilterCriteria lambdaFunctionLayers(List lambdaFunctionLayers) {
  ...
  public CreateFilterRequestFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public CreateFilterRequestFilterCriteria lambdaFunctionRuntime(List lambdaFunctionRuntime) {
  ...
  public CreateFilterRequestFilterCriteria lastObservedAt(List lastObservedAt) {
  ...
  public CreateFilterRequestFilterCriteria networkProtocol(List networkProtocol) {
  ...
  public CreateFilterRequestFilterCriteria portRange(List portRange) {
  ...
  public CreateFilterRequestFilterCriteria relatedVulnerabilities(List relatedVulnerabilities) {
  ...
  public CreateFilterRequestFilterCriteria resourceId(List resourceId) {
  ...
  public CreateFilterRequestFilterCriteria resourceTags(List resourceTags) {
  ...
  public CreateFilterRequestFilterCriteria resourceType(List resourceType) {
  ...
  public CreateFilterRequestFilterCriteria severity(List severity) {
  ...
  public CreateFilterRequestFilterCriteria title(List title) {
    this.title = title;
    return this;
  }
  ...
  public CreateFilterRequestFilterCriteria updatedAt(List updatedAt) {
  ...
  public CreateFilterRequestFilterCriteria vendorSeverity(List vendorSeverity) {
  ...
  public CreateFilterRequestFilterCriteria vulnerabilityId(List vulnerabilityId) {
  ...
  public CreateFilterRequestFilterCriteria vulnerabilitySource(List vulnerabilitySource) {
  ...
  public CreateFilterRequestFilterCriteria vulnerablePackages(List vulnerablePackages) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFilterRequestFilterCriteria createFilterRequestFilterCriteria = (CreateFilterRequestFilterCriteria) o;
    return Objects.equals(this.awsAccountId, createFilterRequestFilterCriteria.awsAccountId) &&
        Objects.equals(this.codeVulnerabilityDetectorName, createFilterRequestFilterCriteria.codeVulnerabilityDetectorName) &&
        Objects.equals(this.codeVulnerabilityDetectorTags, createFilterRequestFilterCriteria.codeVulnerabilityDetectorTags) &&
        Objects.equals(this.codeVulnerabilityFilePath, createFilterRequestFilterCriteria.codeVulnerabilityFilePath) &&
        Objects.equals(this.componentId, createFilterRequestFilterCriteria.componentId) &&
        Objects.equals(this.componentType, createFilterRequestFilterCriteria.componentType) &&
        Objects.equals(this.ec2InstanceImageId, createFilterRequestFilterCriteria.ec2InstanceImageId) &&
        Objects.equals(this.ec2InstanceSubnetId, createFilterRequestFilterCriteria.ec2InstanceSubnetId) &&
        Objects.equals(this.ec2InstanceVpcId, createFilterRequestFilterCriteria.ec2InstanceVpcId) &&
        Objects.equals(this.ecrImageArchitecture, createFilterRequestFilterCriteria.ecrImageArchitecture) &&
        Objects.equals(this.ecrImageHash, createFilterRequestFilterCriteria.ecrImageHash) &&
        Objects.equals(this.ecrImagePushedAt, createFilterRequestFilterCriteria.ecrImagePushedAt) &&
        Objects.equals(this.ecrImageRegistry, createFilterRequestFilterCriteria.ecrImageRegistry) &&
        Objects.equals(this.ecrImageRepositoryName, createFilterRequestFilterCriteria.ecrImageRepositoryName) &&
        Objects.equals(this.ecrImageTags, createFilterRequestFilterCriteria.ecrImageTags) &&
        Objects.equals(this.epssScore, createFilterRequestFilterCriteria.epssScore) &&
        Objects.equals(this.exploitAvailable, createFilterRequestFilterCriteria.exploitAvailable) &&
        Objects.equals(this.findingArn, createFilterRequestFilterCriteria.findingArn) &&
        Objects.equals(this.findingStatus, createFilterRequestFilterCriteria.findingStatus) &&
        Objects.equals(this.findingType, createFilterRequestFilterCriteria.findingType) &&
        Objects.equals(this.firstObservedAt, createFilterRequestFilterCriteria.firstObservedAt) &&
        Objects.equals(this.fixAvailable, createFilterRequestFilterCriteria.fixAvailable) &&
        Objects.equals(this.inspectorScore, createFilterRequestFilterCriteria.inspectorScore) &&
        Objects.equals(this.lambdaFunctionExecutionRoleArn, createFilterRequestFilterCriteria.lambdaFunctionExecutionRoleArn) &&
        Objects.equals(this.lambdaFunctionLastModifiedAt, createFilterRequestFilterCriteria.lambdaFunctionLastModifiedAt) &&
        Objects.equals(this.lambdaFunctionLayers, createFilterRequestFilterCriteria.lambdaFunctionLayers) &&
        Objects.equals(this.lambdaFunctionName, createFilterRequestFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionRuntime, createFilterRequestFilterCriteria.lambdaFunctionRuntime) &&
        Objects.equals(this.lastObservedAt, createFilterRequestFilterCriteria.lastObservedAt) &&
        Objects.equals(this.networkProtocol, createFilterRequestFilterCriteria.networkProtocol) &&
        Objects.equals(this.portRange, createFilterRequestFilterCriteria.portRange) &&
        Objects.equals(this.relatedVulnerabilities, createFilterRequestFilterCriteria.relatedVulnerabilities) &&
        Objects.equals(this.resourceId, createFilterRequestFilterCriteria.resourceId) &&
        Objects.equals(this.resourceTags, createFilterRequestFilterCriteria.resourceTags) &&
        Objects.equals(this.resourceType, createFilterRequestFilterCriteria.resourceType) &&
        Objects.equals(this.severity, createFilterRequestFilterCriteria.severity) &&
        Objects.equals(this.title, createFilterRequestFilterCriteria.title) &&
        Objects.equals(this.updatedAt, createFilterRequestFilterCriteria.updatedAt) &&
        Objects.equals(this.vendorSeverity, createFilterRequestFilterCriteria.vendorSeverity) &&
        Objects.equals(this.vulnerabilityId, createFilterRequestFilterCriteria.vulnerabilityId) &&
        Objects.equals(this.vulnerabilitySource, createFilterRequestFilterCriteria.vulnerabilitySource) &&
        Objects.equals(this.vulnerablePackages, createFilterRequestFilterCriteria.vulnerablePackages);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFilterRequestFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFilterRequestFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFilterRequestFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFilterRequestFilterCriteria is not found in the empty JSON string", CreateFilterRequestFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFilterRequestFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFilterRequestFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFilterRequestFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFilterRequestFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFilterRequestFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFilterRequestFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFilterRequestFilterCriteria>() {
           @Override
           public void write(JsonWriter out, CreateFilterRequestFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFilterRequestFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFilterRequestFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFilterRequestFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to CreateFilterRequestFilterCriteria
   */
  public static CreateFilterRequestFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFilterRequestFilterCriteria.class);
  }

  /**
   * Convert an instance of CreateFilterRequestFilterCriteria to an JSON string
   *
   * @return JSON string
   */
