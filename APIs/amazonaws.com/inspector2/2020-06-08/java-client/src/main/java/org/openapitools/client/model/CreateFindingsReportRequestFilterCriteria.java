...
public class CreateFindingsReportRequestFilterCriteria {
  ...
  public CreateFindingsReportRequestFilterCriteria() {
  }

  public CreateFindingsReportRequestFilterCriteria awsAccountId(List awsAccountId) {
  ...
  public CreateFindingsReportRequestFilterCriteria codeVulnerabilityDetectorName(List codeVulnerabilityDetectorName) {
  ...
  public CreateFindingsReportRequestFilterCriteria codeVulnerabilityDetectorTags(List codeVulnerabilityDetectorTags) {
  ...
  public CreateFindingsReportRequestFilterCriteria codeVulnerabilityFilePath(List codeVulnerabilityFilePath) {
  ...
  public CreateFindingsReportRequestFilterCriteria componentId(List componentId) {
  ...
  public CreateFindingsReportRequestFilterCriteria componentType(List componentType) {
  ...
  public CreateFindingsReportRequestFilterCriteria ec2InstanceImageId(List ec2InstanceImageId) {
  ...
  public CreateFindingsReportRequestFilterCriteria ec2InstanceSubnetId(List ec2InstanceSubnetId) {
  ...
  public CreateFindingsReportRequestFilterCriteria ec2InstanceVpcId(List ec2InstanceVpcId) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImageArchitecture(List ecrImageArchitecture) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImageHash(List ecrImageHash) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImagePushedAt(List ecrImagePushedAt) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImageRegistry(List ecrImageRegistry) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImageRepositoryName(List ecrImageRepositoryName) {
  ...
  public CreateFindingsReportRequestFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public CreateFindingsReportRequestFilterCriteria epssScore(List epssScore) {
  ...
  public CreateFindingsReportRequestFilterCriteria exploitAvailable(List exploitAvailable) {
  ...
  public CreateFindingsReportRequestFilterCriteria findingArn(List findingArn) {
  ...
  public CreateFindingsReportRequestFilterCriteria findingStatus(List findingStatus) {
  ...
  public CreateFindingsReportRequestFilterCriteria findingType(List findingType) {
  ...
  public CreateFindingsReportRequestFilterCriteria firstObservedAt(List firstObservedAt) {
  ...
  public CreateFindingsReportRequestFilterCriteria fixAvailable(List fixAvailable) {
  ...
  public CreateFindingsReportRequestFilterCriteria inspectorScore(List inspectorScore) {
  ...
  public CreateFindingsReportRequestFilterCriteria lambdaFunctionExecutionRoleArn(List lambdaFunctionExecutionRoleArn) {
  ...
  public CreateFindingsReportRequestFilterCriteria lambdaFunctionLastModifiedAt(List lambdaFunctionLastModifiedAt) {
  ...
  public CreateFindingsReportRequestFilterCriteria lambdaFunctionLayers(List lambdaFunctionLayers) {
  ...
  public CreateFindingsReportRequestFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public CreateFindingsReportRequestFilterCriteria lambdaFunctionRuntime(List lambdaFunctionRuntime) {
  ...
  public CreateFindingsReportRequestFilterCriteria lastObservedAt(List lastObservedAt) {
  ...
  public CreateFindingsReportRequestFilterCriteria networkProtocol(List networkProtocol) {
  ...
  public CreateFindingsReportRequestFilterCriteria portRange(List portRange) {
  ...
  public CreateFindingsReportRequestFilterCriteria relatedVulnerabilities(List relatedVulnerabilities) {
  ...
  public CreateFindingsReportRequestFilterCriteria resourceId(List resourceId) {
  ...
  public CreateFindingsReportRequestFilterCriteria resourceTags(List resourceTags) {
  ...
  public CreateFindingsReportRequestFilterCriteria resourceType(List resourceType) {
  ...
  public CreateFindingsReportRequestFilterCriteria severity(List severity) {
  ...
  public CreateFindingsReportRequestFilterCriteria title(List title) {
    this.title = title;
    return this;
  }
  ...
  public CreateFindingsReportRequestFilterCriteria updatedAt(List updatedAt) {
  ...
  public CreateFindingsReportRequestFilterCriteria vendorSeverity(List vendorSeverity) {
  ...
  public CreateFindingsReportRequestFilterCriteria vulnerabilityId(List vulnerabilityId) {
  ...
  public CreateFindingsReportRequestFilterCriteria vulnerabilitySource(List vulnerabilitySource) {
  ...
  public CreateFindingsReportRequestFilterCriteria vulnerablePackages(List vulnerablePackages) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFindingsReportRequestFilterCriteria createFindingsReportRequestFilterCriteria = (CreateFindingsReportRequestFilterCriteria) o;
    return Objects.equals(this.awsAccountId, createFindingsReportRequestFilterCriteria.awsAccountId) &&
        Objects.equals(this.codeVulnerabilityDetectorName, createFindingsReportRequestFilterCriteria.codeVulnerabilityDetectorName) &&
        Objects.equals(this.codeVulnerabilityDetectorTags, createFindingsReportRequestFilterCriteria.codeVulnerabilityDetectorTags) &&
        Objects.equals(this.codeVulnerabilityFilePath, createFindingsReportRequestFilterCriteria.codeVulnerabilityFilePath) &&
        Objects.equals(this.componentId, createFindingsReportRequestFilterCriteria.componentId) &&
        Objects.equals(this.componentType, createFindingsReportRequestFilterCriteria.componentType) &&
        Objects.equals(this.ec2InstanceImageId, createFindingsReportRequestFilterCriteria.ec2InstanceImageId) &&
        Objects.equals(this.ec2InstanceSubnetId, createFindingsReportRequestFilterCriteria.ec2InstanceSubnetId) &&
        Objects.equals(this.ec2InstanceVpcId, createFindingsReportRequestFilterCriteria.ec2InstanceVpcId) &&
        Objects.equals(this.ecrImageArchitecture, createFindingsReportRequestFilterCriteria.ecrImageArchitecture) &&
        Objects.equals(this.ecrImageHash, createFindingsReportRequestFilterCriteria.ecrImageHash) &&
        Objects.equals(this.ecrImagePushedAt, createFindingsReportRequestFilterCriteria.ecrImagePushedAt) &&
        Objects.equals(this.ecrImageRegistry, createFindingsReportRequestFilterCriteria.ecrImageRegistry) &&
        Objects.equals(this.ecrImageRepositoryName, createFindingsReportRequestFilterCriteria.ecrImageRepositoryName) &&
        Objects.equals(this.ecrImageTags, createFindingsReportRequestFilterCriteria.ecrImageTags) &&
        Objects.equals(this.epssScore, createFindingsReportRequestFilterCriteria.epssScore) &&
        Objects.equals(this.exploitAvailable, createFindingsReportRequestFilterCriteria.exploitAvailable) &&
        Objects.equals(this.findingArn, createFindingsReportRequestFilterCriteria.findingArn) &&
        Objects.equals(this.findingStatus, createFindingsReportRequestFilterCriteria.findingStatus) &&
        Objects.equals(this.findingType, createFindingsReportRequestFilterCriteria.findingType) &&
        Objects.equals(this.firstObservedAt, createFindingsReportRequestFilterCriteria.firstObservedAt) &&
        Objects.equals(this.fixAvailable, createFindingsReportRequestFilterCriteria.fixAvailable) &&
        Objects.equals(this.inspectorScore, createFindingsReportRequestFilterCriteria.inspectorScore) &&
        Objects.equals(this.lambdaFunctionExecutionRoleArn, createFindingsReportRequestFilterCriteria.lambdaFunctionExecutionRoleArn) &&
        Objects.equals(this.lambdaFunctionLastModifiedAt, createFindingsReportRequestFilterCriteria.lambdaFunctionLastModifiedAt) &&
        Objects.equals(this.lambdaFunctionLayers, createFindingsReportRequestFilterCriteria.lambdaFunctionLayers) &&
        Objects.equals(this.lambdaFunctionName, createFindingsReportRequestFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionRuntime, createFindingsReportRequestFilterCriteria.lambdaFunctionRuntime) &&
        Objects.equals(this.lastObservedAt, createFindingsReportRequestFilterCriteria.lastObservedAt) &&
        Objects.equals(this.networkProtocol, createFindingsReportRequestFilterCriteria.networkProtocol) &&
        Objects.equals(this.portRange, createFindingsReportRequestFilterCriteria.portRange) &&
        Objects.equals(this.relatedVulnerabilities, createFindingsReportRequestFilterCriteria.relatedVulnerabilities) &&
        Objects.equals(this.resourceId, createFindingsReportRequestFilterCriteria.resourceId) &&
        Objects.equals(this.resourceTags, createFindingsReportRequestFilterCriteria.resourceTags) &&
        Objects.equals(this.resourceType, createFindingsReportRequestFilterCriteria.resourceType) &&
        Objects.equals(this.severity, createFindingsReportRequestFilterCriteria.severity) &&
        Objects.equals(this.title, createFindingsReportRequestFilterCriteria.title) &&
        Objects.equals(this.updatedAt, createFindingsReportRequestFilterCriteria.updatedAt) &&
        Objects.equals(this.vendorSeverity, createFindingsReportRequestFilterCriteria.vendorSeverity) &&
        Objects.equals(this.vulnerabilityId, createFindingsReportRequestFilterCriteria.vulnerabilityId) &&
        Objects.equals(this.vulnerabilitySource, createFindingsReportRequestFilterCriteria.vulnerabilitySource) &&
        Objects.equals(this.vulnerablePackages, createFindingsReportRequestFilterCriteria.vulnerablePackages);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFindingsReportRequestFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFindingsReportRequestFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFindingsReportRequestFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFindingsReportRequestFilterCriteria is not found in the empty JSON string", CreateFindingsReportRequestFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFindingsReportRequestFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFindingsReportRequestFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFindingsReportRequestFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFindingsReportRequestFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFindingsReportRequestFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFindingsReportRequestFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFindingsReportRequestFilterCriteria>() {
           @Override
           public void write(JsonWriter out, CreateFindingsReportRequestFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFindingsReportRequestFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFindingsReportRequestFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFindingsReportRequestFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to CreateFindingsReportRequestFilterCriteria
   */
  public static CreateFindingsReportRequestFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFindingsReportRequestFilterCriteria.class);
  }

  /**
   * Convert an instance of CreateFindingsReportRequestFilterCriteria to an JSON string
   *
   * @return JSON string
   */
