...
public class State {
  ...
  public State errorCode(ErrorCode errorCode) {
  ...
  public State errorMessage(String errorMessage) {
  ...
  public State status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    State state = (State) o;
    return Objects.equals(this.errorCode, state.errorCode) &&
        Objects.equals(this.errorMessage, state.errorMessage) &&
