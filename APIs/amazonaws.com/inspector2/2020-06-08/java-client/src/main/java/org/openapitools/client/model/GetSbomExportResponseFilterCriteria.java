...
public class GetSbomExportResponseFilterCriteria {
  ...
  public GetSbomExportResponseFilterCriteria() {
  }

  public GetSbomExportResponseFilterCriteria accountId(List accountId) {
  ...
  public GetSbomExportResponseFilterCriteria ec2InstanceTags(List ec2InstanceTags) {
  ...
  public GetSbomExportResponseFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public GetSbomExportResponseFilterCriteria ecrRepositoryName(List ecrRepositoryName) {
  ...
  public GetSbomExportResponseFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public GetSbomExportResponseFilterCriteria lambdaFunctionTags(List lambdaFunctionTags) {
  ...
  public GetSbomExportResponseFilterCriteria resourceId(List resourceId) {
  ...
  public GetSbomExportResponseFilterCriteria resourceType(List resourceType) {
  ...
  public boolean equals(Object o) {
    ...
    GetSbomExportResponseFilterCriteria getSbomExportResponseFilterCriteria = (GetSbomExportResponseFilterCriteria) o;
    return Objects.equals(this.accountId, getSbomExportResponseFilterCriteria.accountId) &&
        Objects.equals(this.ec2InstanceTags, getSbomExportResponseFilterCriteria.ec2InstanceTags) &&
        Objects.equals(this.ecrImageTags, getSbomExportResponseFilterCriteria.ecrImageTags) &&
        Objects.equals(this.ecrRepositoryName, getSbomExportResponseFilterCriteria.ecrRepositoryName) &&
        Objects.equals(this.lambdaFunctionName, getSbomExportResponseFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionTags, getSbomExportResponseFilterCriteria.lambdaFunctionTags) &&
        Objects.equals(this.resourceId, getSbomExportResponseFilterCriteria.resourceId) &&
        Objects.equals(this.resourceType, getSbomExportResponseFilterCriteria.resourceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSbomExportResponseFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSbomExportResponseFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSbomExportResponseFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSbomExportResponseFilterCriteria is not found in the empty JSON string", GetSbomExportResponseFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSbomExportResponseFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSbomExportResponseFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSbomExportResponseFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSbomExportResponseFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSbomExportResponseFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSbomExportResponseFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSbomExportResponseFilterCriteria>() {
           @Override
           public void write(JsonWriter out, GetSbomExportResponseFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSbomExportResponseFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSbomExportResponseFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSbomExportResponseFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to GetSbomExportResponseFilterCriteria
   */
  public static GetSbomExportResponseFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSbomExportResponseFilterCriteria.class);
  }

  /**
   * Convert an instance of GetSbomExportResponseFilterCriteria to an JSON string
   *
   * @return JSON string
   */
