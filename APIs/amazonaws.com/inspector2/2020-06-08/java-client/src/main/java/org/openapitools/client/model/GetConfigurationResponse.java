...
public class GetConfigurationResponse {
  ...
  private GetConfigurationResponseEcrConfiguration ecrConfiguration;

  public GetConfigurationResponse() {
  }

  public GetConfigurationResponse ecrConfiguration(GetConfigurationResponseEcrConfiguration ecrConfiguration) {
  ...
  public GetConfigurationResponseEcrConfiguration getEcrConfiguration() {
    return ecrConfiguration;
  }

  public void setEcrConfiguration(GetConfigurationResponseEcrConfiguration ecrConfiguration) {
    this.ecrConfiguration = ecrConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ecrConfiguration, getConfigurationResponse.ecrConfiguration);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetConfigurationResponse is not found in the empty JSON string", GetConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ecrConfiguration`
      if (jsonObj.get("ecrConfiguration") != null && !jsonObj.get("ecrConfiguration").isJsonNull()) {
        GetConfigurationResponseEcrConfiguration.validateJsonElement(jsonObj.get("ecrConfiguration"));
      }
  }
