...
public class UpdateFilterRequestFilterCriteria {
  ...
  public UpdateFilterRequestFilterCriteria() {
  }

  public UpdateFilterRequestFilterCriteria awsAccountId(List awsAccountId) {
  ...
  public UpdateFilterRequestFilterCriteria codeVulnerabilityDetectorName(List codeVulnerabilityDetectorName) {
  ...
  public UpdateFilterRequestFilterCriteria codeVulnerabilityDetectorTags(List codeVulnerabilityDetectorTags) {
  ...
  public UpdateFilterRequestFilterCriteria codeVulnerabilityFilePath(List codeVulnerabilityFilePath) {
  ...
  public UpdateFilterRequestFilterCriteria componentId(List componentId) {
  ...
  public UpdateFilterRequestFilterCriteria componentType(List componentType) {
  ...
  public UpdateFilterRequestFilterCriteria ec2InstanceImageId(List ec2InstanceImageId) {
  ...
  public UpdateFilterRequestFilterCriteria ec2InstanceSubnetId(List ec2InstanceSubnetId) {
  ...
  public UpdateFilterRequestFilterCriteria ec2InstanceVpcId(List ec2InstanceVpcId) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImageArchitecture(List ecrImageArchitecture) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImageHash(List ecrImageHash) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImagePushedAt(List ecrImagePushedAt) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImageRegistry(List ecrImageRegistry) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImageRepositoryName(List ecrImageRepositoryName) {
  ...
  public UpdateFilterRequestFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public UpdateFilterRequestFilterCriteria epssScore(List epssScore) {
  ...
  public UpdateFilterRequestFilterCriteria exploitAvailable(List exploitAvailable) {
  ...
  public UpdateFilterRequestFilterCriteria findingArn(List findingArn) {
  ...
  public UpdateFilterRequestFilterCriteria findingStatus(List findingStatus) {
  ...
  public UpdateFilterRequestFilterCriteria findingType(List findingType) {
  ...
  public UpdateFilterRequestFilterCriteria firstObservedAt(List firstObservedAt) {
  ...
  public UpdateFilterRequestFilterCriteria fixAvailable(List fixAvailable) {
  ...
  public UpdateFilterRequestFilterCriteria inspectorScore(List inspectorScore) {
  ...
  public UpdateFilterRequestFilterCriteria lambdaFunctionExecutionRoleArn(List lambdaFunctionExecutionRoleArn) {
  ...
  public UpdateFilterRequestFilterCriteria lambdaFunctionLastModifiedAt(List lambdaFunctionLastModifiedAt) {
  ...
  public UpdateFilterRequestFilterCriteria lambdaFunctionLayers(List lambdaFunctionLayers) {
  ...
  public UpdateFilterRequestFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public UpdateFilterRequestFilterCriteria lambdaFunctionRuntime(List lambdaFunctionRuntime) {
  ...
  public UpdateFilterRequestFilterCriteria lastObservedAt(List lastObservedAt) {
  ...
  public UpdateFilterRequestFilterCriteria networkProtocol(List networkProtocol) {
  ...
  public UpdateFilterRequestFilterCriteria portRange(List portRange) {
  ...
  public UpdateFilterRequestFilterCriteria relatedVulnerabilities(List relatedVulnerabilities) {
  ...
  public UpdateFilterRequestFilterCriteria resourceId(List resourceId) {
  ...
  public UpdateFilterRequestFilterCriteria resourceTags(List resourceTags) {
  ...
  public UpdateFilterRequestFilterCriteria resourceType(List resourceType) {
  ...
  public UpdateFilterRequestFilterCriteria severity(List severity) {
  ...
  public UpdateFilterRequestFilterCriteria title(List title) {
    this.title = title;
    return this;
  }
  ...
  public UpdateFilterRequestFilterCriteria updatedAt(List updatedAt) {
  ...
  public UpdateFilterRequestFilterCriteria vendorSeverity(List vendorSeverity) {
  ...
  public UpdateFilterRequestFilterCriteria vulnerabilityId(List vulnerabilityId) {
  ...
  public UpdateFilterRequestFilterCriteria vulnerabilitySource(List vulnerabilitySource) {
  ...
  public UpdateFilterRequestFilterCriteria vulnerablePackages(List vulnerablePackages) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFilterRequestFilterCriteria updateFilterRequestFilterCriteria = (UpdateFilterRequestFilterCriteria) o;
    return Objects.equals(this.awsAccountId, updateFilterRequestFilterCriteria.awsAccountId) &&
        Objects.equals(this.codeVulnerabilityDetectorName, updateFilterRequestFilterCriteria.codeVulnerabilityDetectorName) &&
        Objects.equals(this.codeVulnerabilityDetectorTags, updateFilterRequestFilterCriteria.codeVulnerabilityDetectorTags) &&
        Objects.equals(this.codeVulnerabilityFilePath, updateFilterRequestFilterCriteria.codeVulnerabilityFilePath) &&
        Objects.equals(this.componentId, updateFilterRequestFilterCriteria.componentId) &&
        Objects.equals(this.componentType, updateFilterRequestFilterCriteria.componentType) &&
        Objects.equals(this.ec2InstanceImageId, updateFilterRequestFilterCriteria.ec2InstanceImageId) &&
        Objects.equals(this.ec2InstanceSubnetId, updateFilterRequestFilterCriteria.ec2InstanceSubnetId) &&
        Objects.equals(this.ec2InstanceVpcId, updateFilterRequestFilterCriteria.ec2InstanceVpcId) &&
        Objects.equals(this.ecrImageArchitecture, updateFilterRequestFilterCriteria.ecrImageArchitecture) &&
        Objects.equals(this.ecrImageHash, updateFilterRequestFilterCriteria.ecrImageHash) &&
        Objects.equals(this.ecrImagePushedAt, updateFilterRequestFilterCriteria.ecrImagePushedAt) &&
        Objects.equals(this.ecrImageRegistry, updateFilterRequestFilterCriteria.ecrImageRegistry) &&
        Objects.equals(this.ecrImageRepositoryName, updateFilterRequestFilterCriteria.ecrImageRepositoryName) &&
        Objects.equals(this.ecrImageTags, updateFilterRequestFilterCriteria.ecrImageTags) &&
        Objects.equals(this.epssScore, updateFilterRequestFilterCriteria.epssScore) &&
        Objects.equals(this.exploitAvailable, updateFilterRequestFilterCriteria.exploitAvailable) &&
        Objects.equals(this.findingArn, updateFilterRequestFilterCriteria.findingArn) &&
        Objects.equals(this.findingStatus, updateFilterRequestFilterCriteria.findingStatus) &&
        Objects.equals(this.findingType, updateFilterRequestFilterCriteria.findingType) &&
        Objects.equals(this.firstObservedAt, updateFilterRequestFilterCriteria.firstObservedAt) &&
        Objects.equals(this.fixAvailable, updateFilterRequestFilterCriteria.fixAvailable) &&
        Objects.equals(this.inspectorScore, updateFilterRequestFilterCriteria.inspectorScore) &&
        Objects.equals(this.lambdaFunctionExecutionRoleArn, updateFilterRequestFilterCriteria.lambdaFunctionExecutionRoleArn) &&
        Objects.equals(this.lambdaFunctionLastModifiedAt, updateFilterRequestFilterCriteria.lambdaFunctionLastModifiedAt) &&
        Objects.equals(this.lambdaFunctionLayers, updateFilterRequestFilterCriteria.lambdaFunctionLayers) &&
        Objects.equals(this.lambdaFunctionName, updateFilterRequestFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionRuntime, updateFilterRequestFilterCriteria.lambdaFunctionRuntime) &&
        Objects.equals(this.lastObservedAt, updateFilterRequestFilterCriteria.lastObservedAt) &&
        Objects.equals(this.networkProtocol, updateFilterRequestFilterCriteria.networkProtocol) &&
        Objects.equals(this.portRange, updateFilterRequestFilterCriteria.portRange) &&
        Objects.equals(this.relatedVulnerabilities, updateFilterRequestFilterCriteria.relatedVulnerabilities) &&
        Objects.equals(this.resourceId, updateFilterRequestFilterCriteria.resourceId) &&
        Objects.equals(this.resourceTags, updateFilterRequestFilterCriteria.resourceTags) &&
        Objects.equals(this.resourceType, updateFilterRequestFilterCriteria.resourceType) &&
        Objects.equals(this.severity, updateFilterRequestFilterCriteria.severity) &&
        Objects.equals(this.title, updateFilterRequestFilterCriteria.title) &&
        Objects.equals(this.updatedAt, updateFilterRequestFilterCriteria.updatedAt) &&
        Objects.equals(this.vendorSeverity, updateFilterRequestFilterCriteria.vendorSeverity) &&
        Objects.equals(this.vulnerabilityId, updateFilterRequestFilterCriteria.vulnerabilityId) &&
        Objects.equals(this.vulnerabilitySource, updateFilterRequestFilterCriteria.vulnerabilitySource) &&
        Objects.equals(this.vulnerablePackages, updateFilterRequestFilterCriteria.vulnerablePackages);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFilterRequestFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFilterRequestFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFilterRequestFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFilterRequestFilterCriteria is not found in the empty JSON string", UpdateFilterRequestFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFilterRequestFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFilterRequestFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFilterRequestFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFilterRequestFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFilterRequestFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFilterRequestFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFilterRequestFilterCriteria>() {
           @Override
           public void write(JsonWriter out, UpdateFilterRequestFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFilterRequestFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFilterRequestFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFilterRequestFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to UpdateFilterRequestFilterCriteria
   */
  public static UpdateFilterRequestFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFilterRequestFilterCriteria.class);
  }

  /**
   * Convert an instance of UpdateFilterRequestFilterCriteria to an JSON string
   *
   * @return JSON string
   */
