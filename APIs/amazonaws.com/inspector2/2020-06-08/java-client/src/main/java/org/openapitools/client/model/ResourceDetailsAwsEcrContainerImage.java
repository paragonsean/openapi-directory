...
public class ResourceDetailsAwsEcrContainerImage {
  ...
  static {
    ...
    openapiRequiredFields.add("imageHash");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ResourceDetailsAwsEcrContainerImage.openapiRequiredFields) {
      ...
      // validate the required field `imageHash`
