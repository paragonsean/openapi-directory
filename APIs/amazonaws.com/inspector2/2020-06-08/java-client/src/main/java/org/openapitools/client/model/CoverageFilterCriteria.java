...
public class CoverageFilterCriteria {
  ...
  public CoverageFilterCriteria() {
  }

  public CoverageFilterCriteria accountId(List accountId) {
  ...
  public CoverageFilterCriteria ec2InstanceTags(List ec2InstanceTags) {
  ...
  public CoverageFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public CoverageFilterCriteria ecrRepositoryName(List ecrRepositoryName) {
  ...
  public CoverageFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public CoverageFilterCriteria lambdaFunctionRuntime(List lambdaFunctionRuntime) {
  ...
  public CoverageFilterCriteria lambdaFunctionTags(List lambdaFunctionTags) {
  ...
  public CoverageFilterCriteria lastScannedAt(List lastScannedAt) {
  ...
  public CoverageFilterCriteria resourceId(List resourceId) {
  ...
  public CoverageFilterCriteria resourceType(List resourceType) {
  ...
  public CoverageFilterCriteria scanStatusCode(List scanStatusCode) {
  ...
  public CoverageFilterCriteria scanStatusReason(List scanStatusReason) {
  ...
  public CoverageFilterCriteria scanType(List scanType) {
  ...
  public boolean equals(Object o) {
    ...
    CoverageFilterCriteria coverageFilterCriteria = (CoverageFilterCriteria) o;
    return Objects.equals(this.accountId, coverageFilterCriteria.accountId) &&
        Objects.equals(this.ec2InstanceTags, coverageFilterCriteria.ec2InstanceTags) &&
        Objects.equals(this.ecrImageTags, coverageFilterCriteria.ecrImageTags) &&
        Objects.equals(this.ecrRepositoryName, coverageFilterCriteria.ecrRepositoryName) &&
        Objects.equals(this.lambdaFunctionName, coverageFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionRuntime, coverageFilterCriteria.lambdaFunctionRuntime) &&
        Objects.equals(this.lambdaFunctionTags, coverageFilterCriteria.lambdaFunctionTags) &&
        Objects.equals(this.lastScannedAt, coverageFilterCriteria.lastScannedAt) &&
        Objects.equals(this.resourceId, coverageFilterCriteria.resourceId) &&
        Objects.equals(this.resourceType, coverageFilterCriteria.resourceType) &&
        Objects.equals(this.scanStatusCode, coverageFilterCriteria.scanStatusCode) &&
        Objects.equals(this.scanStatusReason, coverageFilterCriteria.scanStatusReason) &&
        Objects.equals(this.scanType, coverageFilterCriteria.scanType);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoverageFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CoverageFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CoverageFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CoverageFilterCriteria is not found in the empty JSON string", CoverageFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CoverageFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CoverageFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CoverageFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CoverageFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CoverageFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CoverageFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<CoverageFilterCriteria>() {
           @Override
           public void write(JsonWriter out, CoverageFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CoverageFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CoverageFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CoverageFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to CoverageFilterCriteria
   */
  public static CoverageFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CoverageFilterCriteria.class);
  }

  /**
   * Convert an instance of CoverageFilterCriteria to an JSON string
   *
   * @return JSON string
   */
