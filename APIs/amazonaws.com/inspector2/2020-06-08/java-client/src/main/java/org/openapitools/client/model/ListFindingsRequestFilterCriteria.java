...
public class ListFindingsRequestFilterCriteria {
  ...
  public ListFindingsRequestFilterCriteria() {
  }

  public ListFindingsRequestFilterCriteria awsAccountId(List awsAccountId) {
  ...
  public ListFindingsRequestFilterCriteria codeVulnerabilityDetectorName(List codeVulnerabilityDetectorName) {
  ...
  public ListFindingsRequestFilterCriteria codeVulnerabilityDetectorTags(List codeVulnerabilityDetectorTags) {
  ...
  public ListFindingsRequestFilterCriteria codeVulnerabilityFilePath(List codeVulnerabilityFilePath) {
  ...
  public ListFindingsRequestFilterCriteria componentId(List componentId) {
  ...
  public ListFindingsRequestFilterCriteria componentType(List componentType) {
  ...
  public ListFindingsRequestFilterCriteria ec2InstanceImageId(List ec2InstanceImageId) {
  ...
  public ListFindingsRequestFilterCriteria ec2InstanceSubnetId(List ec2InstanceSubnetId) {
  ...
  public ListFindingsRequestFilterCriteria ec2InstanceVpcId(List ec2InstanceVpcId) {
  ...
  public ListFindingsRequestFilterCriteria ecrImageArchitecture(List ecrImageArchitecture) {
  ...
  public ListFindingsRequestFilterCriteria ecrImageHash(List ecrImageHash) {
  ...
  public ListFindingsRequestFilterCriteria ecrImagePushedAt(List ecrImagePushedAt) {
  ...
  public ListFindingsRequestFilterCriteria ecrImageRegistry(List ecrImageRegistry) {
  ...
  public ListFindingsRequestFilterCriteria ecrImageRepositoryName(List ecrImageRepositoryName) {
  ...
  public ListFindingsRequestFilterCriteria ecrImageTags(List ecrImageTags) {
  ...
  public ListFindingsRequestFilterCriteria epssScore(List epssScore) {
  ...
  public ListFindingsRequestFilterCriteria exploitAvailable(List exploitAvailable) {
  ...
  public ListFindingsRequestFilterCriteria findingArn(List findingArn) {
  ...
  public ListFindingsRequestFilterCriteria findingStatus(List findingStatus) {
  ...
  public ListFindingsRequestFilterCriteria findingType(List findingType) {
  ...
  public ListFindingsRequestFilterCriteria firstObservedAt(List firstObservedAt) {
  ...
  public ListFindingsRequestFilterCriteria fixAvailable(List fixAvailable) {
  ...
  public ListFindingsRequestFilterCriteria inspectorScore(List inspectorScore) {
  ...
  public ListFindingsRequestFilterCriteria lambdaFunctionExecutionRoleArn(List lambdaFunctionExecutionRoleArn) {
  ...
  public ListFindingsRequestFilterCriteria lambdaFunctionLastModifiedAt(List lambdaFunctionLastModifiedAt) {
  ...
  public ListFindingsRequestFilterCriteria lambdaFunctionLayers(List lambdaFunctionLayers) {
  ...
  public ListFindingsRequestFilterCriteria lambdaFunctionName(List lambdaFunctionName) {
  ...
  public ListFindingsRequestFilterCriteria lambdaFunctionRuntime(List lambdaFunctionRuntime) {
  ...
  public ListFindingsRequestFilterCriteria lastObservedAt(List lastObservedAt) {
  ...
  public ListFindingsRequestFilterCriteria networkProtocol(List networkProtocol) {
  ...
  public ListFindingsRequestFilterCriteria portRange(List portRange) {
  ...
  public ListFindingsRequestFilterCriteria relatedVulnerabilities(List relatedVulnerabilities) {
  ...
  public ListFindingsRequestFilterCriteria resourceId(List resourceId) {
  ...
  public ListFindingsRequestFilterCriteria resourceTags(List resourceTags) {
  ...
  public ListFindingsRequestFilterCriteria resourceType(List resourceType) {
  ...
  public ListFindingsRequestFilterCriteria severity(List severity) {
  ...
  public ListFindingsRequestFilterCriteria title(List title) {
    this.title = title;
    return this;
  }
  ...
  public ListFindingsRequestFilterCriteria updatedAt(List updatedAt) {
  ...
  public ListFindingsRequestFilterCriteria vendorSeverity(List vendorSeverity) {
  ...
  public ListFindingsRequestFilterCriteria vulnerabilityId(List vulnerabilityId) {
  ...
  public ListFindingsRequestFilterCriteria vulnerabilitySource(List vulnerabilitySource) {
  ...
  public ListFindingsRequestFilterCriteria vulnerablePackages(List vulnerablePackages) {
  ...
  public boolean equals(Object o) {
    ...
    ListFindingsRequestFilterCriteria listFindingsRequestFilterCriteria = (ListFindingsRequestFilterCriteria) o;
    return Objects.equals(this.awsAccountId, listFindingsRequestFilterCriteria.awsAccountId) &&
        Objects.equals(this.codeVulnerabilityDetectorName, listFindingsRequestFilterCriteria.codeVulnerabilityDetectorName) &&
        Objects.equals(this.codeVulnerabilityDetectorTags, listFindingsRequestFilterCriteria.codeVulnerabilityDetectorTags) &&
        Objects.equals(this.codeVulnerabilityFilePath, listFindingsRequestFilterCriteria.codeVulnerabilityFilePath) &&
        Objects.equals(this.componentId, listFindingsRequestFilterCriteria.componentId) &&
        Objects.equals(this.componentType, listFindingsRequestFilterCriteria.componentType) &&
        Objects.equals(this.ec2InstanceImageId, listFindingsRequestFilterCriteria.ec2InstanceImageId) &&
        Objects.equals(this.ec2InstanceSubnetId, listFindingsRequestFilterCriteria.ec2InstanceSubnetId) &&
        Objects.equals(this.ec2InstanceVpcId, listFindingsRequestFilterCriteria.ec2InstanceVpcId) &&
        Objects.equals(this.ecrImageArchitecture, listFindingsRequestFilterCriteria.ecrImageArchitecture) &&
        Objects.equals(this.ecrImageHash, listFindingsRequestFilterCriteria.ecrImageHash) &&
        Objects.equals(this.ecrImagePushedAt, listFindingsRequestFilterCriteria.ecrImagePushedAt) &&
        Objects.equals(this.ecrImageRegistry, listFindingsRequestFilterCriteria.ecrImageRegistry) &&
        Objects.equals(this.ecrImageRepositoryName, listFindingsRequestFilterCriteria.ecrImageRepositoryName) &&
        Objects.equals(this.ecrImageTags, listFindingsRequestFilterCriteria.ecrImageTags) &&
        Objects.equals(this.epssScore, listFindingsRequestFilterCriteria.epssScore) &&
        Objects.equals(this.exploitAvailable, listFindingsRequestFilterCriteria.exploitAvailable) &&
        Objects.equals(this.findingArn, listFindingsRequestFilterCriteria.findingArn) &&
        Objects.equals(this.findingStatus, listFindingsRequestFilterCriteria.findingStatus) &&
        Objects.equals(this.findingType, listFindingsRequestFilterCriteria.findingType) &&
        Objects.equals(this.firstObservedAt, listFindingsRequestFilterCriteria.firstObservedAt) &&
        Objects.equals(this.fixAvailable, listFindingsRequestFilterCriteria.fixAvailable) &&
        Objects.equals(this.inspectorScore, listFindingsRequestFilterCriteria.inspectorScore) &&
        Objects.equals(this.lambdaFunctionExecutionRoleArn, listFindingsRequestFilterCriteria.lambdaFunctionExecutionRoleArn) &&
        Objects.equals(this.lambdaFunctionLastModifiedAt, listFindingsRequestFilterCriteria.lambdaFunctionLastModifiedAt) &&
        Objects.equals(this.lambdaFunctionLayers, listFindingsRequestFilterCriteria.lambdaFunctionLayers) &&
        Objects.equals(this.lambdaFunctionName, listFindingsRequestFilterCriteria.lambdaFunctionName) &&
        Objects.equals(this.lambdaFunctionRuntime, listFindingsRequestFilterCriteria.lambdaFunctionRuntime) &&
        Objects.equals(this.lastObservedAt, listFindingsRequestFilterCriteria.lastObservedAt) &&
        Objects.equals(this.networkProtocol, listFindingsRequestFilterCriteria.networkProtocol) &&
        Objects.equals(this.portRange, listFindingsRequestFilterCriteria.portRange) &&
        Objects.equals(this.relatedVulnerabilities, listFindingsRequestFilterCriteria.relatedVulnerabilities) &&
        Objects.equals(this.resourceId, listFindingsRequestFilterCriteria.resourceId) &&
        Objects.equals(this.resourceTags, listFindingsRequestFilterCriteria.resourceTags) &&
        Objects.equals(this.resourceType, listFindingsRequestFilterCriteria.resourceType) &&
        Objects.equals(this.severity, listFindingsRequestFilterCriteria.severity) &&
        Objects.equals(this.title, listFindingsRequestFilterCriteria.title) &&
        Objects.equals(this.updatedAt, listFindingsRequestFilterCriteria.updatedAt) &&
        Objects.equals(this.vendorSeverity, listFindingsRequestFilterCriteria.vendorSeverity) &&
        Objects.equals(this.vulnerabilityId, listFindingsRequestFilterCriteria.vulnerabilityId) &&
        Objects.equals(this.vulnerabilitySource, listFindingsRequestFilterCriteria.vulnerabilitySource) &&
        Objects.equals(this.vulnerablePackages, listFindingsRequestFilterCriteria.vulnerablePackages);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListFindingsRequestFilterCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFindingsRequestFilterCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFindingsRequestFilterCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFindingsRequestFilterCriteria is not found in the empty JSON string", ListFindingsRequestFilterCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFindingsRequestFilterCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFindingsRequestFilterCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFindingsRequestFilterCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFindingsRequestFilterCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFindingsRequestFilterCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFindingsRequestFilterCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFindingsRequestFilterCriteria>() {
           @Override
           public void write(JsonWriter out, ListFindingsRequestFilterCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFindingsRequestFilterCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFindingsRequestFilterCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFindingsRequestFilterCriteria
   * @throws IOException if the JSON string is invalid with respect to ListFindingsRequestFilterCriteria
   */
  public static ListFindingsRequestFilterCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFindingsRequestFilterCriteria.class);
  }

  /**
   * Convert an instance of ListFindingsRequestFilterCriteria to an JSON string
   *
   * @return JSON string
   */
