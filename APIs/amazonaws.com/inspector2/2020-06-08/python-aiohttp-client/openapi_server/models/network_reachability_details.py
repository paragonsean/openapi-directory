...
class NetworkReachabilityDetails(Model):
    ...
    def __init__(self, network_path: NetworkReachabilityDetailsNetworkPath=None, open_port_range: NetworkReachabilityDetailsOpenPortRange=None, protocol: NetworkProtocol=None):
        """NetworkReachabilityDetails - a model defined in OpenAPI

        :param network_path: The network_path of this NetworkReachabilityDetails.
        :param open_port_range: The open_port_range of this NetworkReachabilityDetails.
        :param protocol: The protocol of this NetworkReachabilityDetails.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NetworkReachabilityDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NetworkReachabilityDetails of this NetworkReachabilityDetails.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def network_path(self):
        """Gets the network_path of this NetworkReachabilityDetails.


        :return: The network_path of this NetworkReachabilityDetails.
    ...
    def network_path(self, network_path):
        """Sets the network_path of this NetworkReachabilityDetails.
    ...
    def open_port_range(self):
        """Gets the open_port_range of this NetworkReachabilityDetails.


        :return: The open_port_range of this NetworkReachabilityDetails.
    ...
    def open_port_range(self, open_port_range):
        """Sets the open_port_range of this NetworkReachabilityDetails.
    ...
    @property
    def protocol(self):
        """Gets the protocol of this NetworkReachabilityDetails.


        :return: The protocol of this NetworkReachabilityDetails.
    ...
    def protocol(self, protocol):
        """Sets the protocol of this NetworkReachabilityDetails.
