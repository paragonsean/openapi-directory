...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ResourceDetailsAwsEc2Instance();
  });
  ...
  describe('ResourceDetailsAwsEc2Instance', function() {
    it('should create an instance of ResourceDetailsAwsEc2Instance', function() {
      // uncomment below and update the code to test ResourceDetailsAwsEc2Instance
      //var instance = new Inspector2.ResourceDetailsAwsEc2Instance();
      //expect(instance).to.be.a(Inspector2.ResourceDetailsAwsEc2Instance);
    });
