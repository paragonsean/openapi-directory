...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AccountAggregation();
  });
  ...
  describe('AccountAggregation', function() {
    it('should create an instance of AccountAggregation', function() {
      // uncomment below and update the code to test AccountAggregation
      //var instance = new Inspector2.AccountAggregation();
      //expect(instance).to.be.a(Inspector2.AccountAggregation);
    });
