...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AtigData();
  });
  ...
  describe('AtigData', function() {
    it('should create an instance of AtigData', function() {
      // uncomment below and update the code to test AtigData
      //var instance = new Inspector2.AtigData();
      //expect(instance).to.be.a(Inspector2.AtigData);
    });
