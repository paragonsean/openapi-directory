...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListUsageTotalsRequest();
  });
  ...
  describe('ListUsageTotalsRequest', function() {
    it('should create an instance of ListUsageTotalsRequest', function() {
      // uncomment below and update the code to test ListUsageTotalsRequest
      //var instance = new Inspector2.ListUsageTotalsRequest();
      //expect(instance).to.be.a(Inspector2.ListUsageTotalsRequest);
    });
