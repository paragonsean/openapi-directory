...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.RepositoryAggregation();
  });
  ...
  describe('RepositoryAggregation', function() {
    it('should create an instance of RepositoryAggregation', function() {
      // uncomment below and update the code to test RepositoryAggregation
      //var instance = new Inspector2.RepositoryAggregation();
      //expect(instance).to.be.a(Inspector2.RepositoryAggregation);
    });
