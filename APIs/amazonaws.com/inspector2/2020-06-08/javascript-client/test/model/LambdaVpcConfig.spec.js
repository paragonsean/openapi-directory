...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.LambdaVpcConfig();
  });
  ...
  describe('LambdaVpcConfig', function() {
    it('should create an instance of LambdaVpcConfig', function() {
      // uncomment below and update the code to test LambdaVpcConfig
      //var instance = new Inspector2.LambdaVpcConfig();
      //expect(instance).to.be.a(Inspector2.LambdaVpcConfig);
    });
