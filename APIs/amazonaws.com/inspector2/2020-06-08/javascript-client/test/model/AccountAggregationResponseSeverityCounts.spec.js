...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AccountAggregationResponseSeverityCounts();
  });
  ...
  describe('AccountAggregationResponseSeverityCounts', function() {
    it('should create an instance of AccountAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test AccountAggregationResponseSeverityCounts
      //var instance = new Inspector2.AccountAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.AccountAggregationResponseSeverityCounts);
    });
