...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ImageLayerAggregationResponseSeverityCounts();
  });
  ...
  describe('ImageLayerAggregationResponseSeverityCounts', function() {
    it('should create an instance of ImageLayerAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test ImageLayerAggregationResponseSeverityCounts
      //var instance = new Inspector2.ImageLayerAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.ImageLayerAggregationResponseSeverityCounts);
    });
