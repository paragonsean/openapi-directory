...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.CreateFilterRequestFilterCriteria();
  });
  ...
  describe('CreateFilterRequestFilterCriteria', function() {
    it('should create an instance of CreateFilterRequestFilterCriteria', function() {
      // uncomment below and update the code to test CreateFilterRequestFilterCriteria
      //var instance = new Inspector2.CreateFilterRequestFilterCriteria();
      //expect(instance).to.be.a(Inspector2.CreateFilterRequestFilterCriteria);
    });
