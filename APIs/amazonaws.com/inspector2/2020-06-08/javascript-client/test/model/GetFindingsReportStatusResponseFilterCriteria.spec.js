...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.GetFindingsReportStatusResponseFilterCriteria();
  });
  ...
  describe('GetFindingsReportStatusResponseFilterCriteria', function() {
    it('should create an instance of GetFindingsReportStatusResponseFilterCriteria', function() {
      // uncomment below and update the code to test GetFindingsReportStatusResponseFilterCriteria
      //var instance = new Inspector2.GetFindingsReportStatusResponseFilterCriteria();
      //expect(instance).to.be.a(Inspector2.GetFindingsReportStatusResponseFilterCriteria);
    });
