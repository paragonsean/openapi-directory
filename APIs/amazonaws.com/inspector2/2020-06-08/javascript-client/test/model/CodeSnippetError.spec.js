...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.CodeSnippetError();
  });
  ...
  describe('CodeSnippetError', function() {
    it('should create an instance of CodeSnippetError', function() {
      // uncomment below and update the code to test CodeSnippetError
      //var instance = new Inspector2.CodeSnippetError();
      //expect(instance).to.be.a(Inspector2.CodeSnippetError);
    });
