...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AwsEcrContainerAggregationResponseSeverityCounts();
  });
  ...
  describe('AwsEcrContainerAggregationResponseSeverityCounts', function() {
    it('should create an instance of AwsEcrContainerAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test AwsEcrContainerAggregationResponseSeverityCounts
      //var instance = new Inspector2.AwsEcrContainerAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.AwsEcrContainerAggregationResponseSeverityCounts);
    });
