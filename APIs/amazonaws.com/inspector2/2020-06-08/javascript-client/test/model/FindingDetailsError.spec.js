...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.FindingDetailsError();
  });
  ...
  describe('FindingDetailsError', function() {
    it('should create an instance of FindingDetailsError', function() {
      // uncomment below and update the code to test FindingDetailsError
      //var instance = new Inspector2.FindingDetailsError();
      //expect(instance).to.be.a(Inspector2.FindingDetailsError);
    });
