...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.Ec2Metadata();
  });
  ...
  describe('Ec2Metadata', function() {
    it('should create an instance of Ec2Metadata', function() {
      // uncomment below and update the code to test Ec2Metadata
      //var instance = new Inspector2.Ec2Metadata();
      //expect(instance).to.be.a(Inspector2.Ec2Metadata);
    });
