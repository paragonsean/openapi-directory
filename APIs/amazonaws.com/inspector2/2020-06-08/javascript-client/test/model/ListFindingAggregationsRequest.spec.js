...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListFindingAggregationsRequest();
  });
  ...
  describe('ListFindingAggregationsRequest', function() {
    it('should create an instance of ListFindingAggregationsRequest', function() {
      // uncomment below and update the code to test ListFindingAggregationsRequest
      //var instance = new Inspector2.ListFindingAggregationsRequest();
      //expect(instance).to.be.a(Inspector2.ListFindingAggregationsRequest);
    });
    ...
    it('should have the property aggregationRequest (base name: "aggregationRequest")', function() {
      // uncomment below and update the code to test the property aggregationRequest
      //var instance = new Inspector2.ListFindingAggregationsRequest();
      //expect(instance).to.be();
    });
