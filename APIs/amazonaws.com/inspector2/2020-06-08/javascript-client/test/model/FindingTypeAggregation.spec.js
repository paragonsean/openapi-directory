...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.FindingTypeAggregation();
  });
  ...
  describe('FindingTypeAggregation', function() {
    it('should create an instance of FindingTypeAggregation', function() {
      // uncomment below and update the code to test FindingTypeAggregation
      //var instance = new Inspector2.FindingTypeAggregation();
      //expect(instance).to.be.a(Inspector2.FindingTypeAggregation);
    });
