...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.UpdateEncryptionKeyRequest();
  });
  ...
  describe('UpdateEncryptionKeyRequest', function() {
    it('should create an instance of UpdateEncryptionKeyRequest', function() {
      // uncomment below and update the code to test UpdateEncryptionKeyRequest
      //var instance = new Inspector2.UpdateEncryptionKeyRequest();
      //expect(instance).to.be.a(Inspector2.UpdateEncryptionKeyRequest);
    });
