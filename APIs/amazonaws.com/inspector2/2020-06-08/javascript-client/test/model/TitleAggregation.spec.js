...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.TitleAggregation();
  });
  ...
  describe('TitleAggregation', function() {
    it('should create an instance of TitleAggregation', function() {
      // uncomment below and update the code to test TitleAggregation
      //var instance = new Inspector2.TitleAggregation();
      //expect(instance).to.be.a(Inspector2.TitleAggregation);
    });
