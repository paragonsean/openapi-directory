...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.UpdateFilterRequestFilterCriteria();
  });
  ...
  describe('UpdateFilterRequestFilterCriteria', function() {
    it('should create an instance of UpdateFilterRequestFilterCriteria', function() {
      // uncomment below and update the code to test UpdateFilterRequestFilterCriteria
      //var instance = new Inspector2.UpdateFilterRequestFilterCriteria();
      //expect(instance).to.be.a(Inspector2.UpdateFilterRequestFilterCriteria);
    });
