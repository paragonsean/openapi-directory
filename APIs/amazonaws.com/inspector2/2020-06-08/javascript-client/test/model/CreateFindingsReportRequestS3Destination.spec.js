...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.CreateFindingsReportRequestS3Destination();
  });
  ...
  describe('CreateFindingsReportRequestS3Destination', function() {
    it('should create an instance of CreateFindingsReportRequestS3Destination', function() {
      // uncomment below and update the code to test CreateFindingsReportRequestS3Destination
      //var instance = new Inspector2.CreateFindingsReportRequestS3Destination();
      //expect(instance).to.be.a(Inspector2.CreateFindingsReportRequestS3Destination);
    });
