...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListFiltersResponse();
  });
  ...
  describe('ListFiltersResponse', function() {
    it('should create an instance of ListFiltersResponse', function() {
      // uncomment below and update the code to test ListFiltersResponse
      //var instance = new Inspector2.ListFiltersResponse();
      //expect(instance).to.be.a(Inspector2.ListFiltersResponse);
    });
