...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListAccountPermissionsRequest();
  });
  ...
  describe('ListAccountPermissionsRequest', function() {
    it('should create an instance of ListAccountPermissionsRequest', function() {
      // uncomment below and update the code to test ListAccountPermissionsRequest
      //var instance = new Inspector2.ListAccountPermissionsRequest();
      //expect(instance).to.be.a(Inspector2.ListAccountPermissionsRequest);
    });
