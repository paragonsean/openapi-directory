...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.RepositoryAggregationResponseSeverityCounts();
  });
  ...
  describe('RepositoryAggregationResponseSeverityCounts', function() {
    it('should create an instance of RepositoryAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test RepositoryAggregationResponseSeverityCounts
      //var instance = new Inspector2.RepositoryAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.RepositoryAggregationResponseSeverityCounts);
    });
