...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.SortCriteria();
  });
  ...
  describe('SortCriteria', function() {
    it('should create an instance of SortCriteria', function() {
      // uncomment below and update the code to test SortCriteria
      //var instance = new Inspector2.SortCriteria();
      //expect(instance).to.be.a(Inspector2.SortCriteria);
    });
