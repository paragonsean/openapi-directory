...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AwsLambdaFunctionDetails();
  });
  ...
  describe('AwsLambdaFunctionDetails', function() {
    it('should create an instance of AwsLambdaFunctionDetails', function() {
      // uncomment below and update the code to test AwsLambdaFunctionDetails
      //var instance = new Inspector2.AwsLambdaFunctionDetails();
      //expect(instance).to.be.a(Inspector2.AwsLambdaFunctionDetails);
    });
