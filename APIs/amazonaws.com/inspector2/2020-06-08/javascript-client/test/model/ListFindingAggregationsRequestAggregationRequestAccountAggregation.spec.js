...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListFindingAggregationsRequestAggregationRequestAccountAggregation();
  });
  ...
  describe('ListFindingAggregationsRequestAggregationRequestAccountAggregation', function() {
    it('should create an instance of ListFindingAggregationsRequestAggregationRequestAccountAggregation', function() {
      // uncomment below and update the code to test ListFindingAggregationsRequestAggregationRequestAccountAggregation
      //var instance = new Inspector2.ListFindingAggregationsRequestAggregationRequestAccountAggregation();
      //expect(instance).to.be.a(Inspector2.ListFindingAggregationsRequestAggregationRequestAccountAggregation);
    });
