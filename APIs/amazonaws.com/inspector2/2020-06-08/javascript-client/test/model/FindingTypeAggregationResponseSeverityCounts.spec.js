...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.FindingTypeAggregationResponseSeverityCounts();
  });
  ...
  describe('FindingTypeAggregationResponseSeverityCounts', function() {
    it('should create an instance of FindingTypeAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test FindingTypeAggregationResponseSeverityCounts
      //var instance = new Inspector2.FindingTypeAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.FindingTypeAggregationResponseSeverityCounts);
    });
