...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.AmiAggregationResponseSeverityCounts();
  });
  ...
  describe('AmiAggregationResponseSeverityCounts', function() {
    it('should create an instance of AmiAggregationResponseSeverityCounts', function() {
      // uncomment below and update the code to test AmiAggregationResponseSeverityCounts
      //var instance = new Inspector2.AmiAggregationResponseSeverityCounts();
      //expect(instance).to.be.a(Inspector2.AmiAggregationResponseSeverityCounts);
    });
