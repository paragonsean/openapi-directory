...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Inspector2.ListFindingsRequestFilterCriteria();
  });
  ...
  describe('ListFindingsRequestFilterCriteria', function() {
    it('should create an instance of ListFindingsRequestFilterCriteria', function() {
      // uncomment below and update the code to test ListFindingsRequestFilterCriteria
      //var instance = new Inspector2.ListFindingsRequestFilterCriteria();
      //expect(instance).to.be.a(Inspector2.ListFindingsRequestFilterCriteria);
    });
