...
class ResourceDetailsAwsEcrContainerImage {
    ...
    constructor(imageHash, registry, repositoryName) { 
        ...
        ResourceDetailsAwsEcrContainerImage.initialize(this, imageHash, registry, repositoryName);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ResourceDetailsAwsEcrContainerImage.RequiredProperties) {
...
ResourceDetailsAwsEcrContainerImage.RequiredProperties = ["imageHash", "registry", "repositoryName"];
