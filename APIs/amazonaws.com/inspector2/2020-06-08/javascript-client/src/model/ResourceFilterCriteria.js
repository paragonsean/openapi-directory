...
/**
 * The ResourceFilterCriteria model module.
 * @module model/ResourceFilterCriteria
 * @version 2020-06-08
 */
class ResourceFilterCriteria {
    /**
     * Constructs a new <code>ResourceFilterCriteria</code>.
     * The resource filter criteria for a Software bill of materials (SBOM) report.
     * @alias module:model/ResourceFilterCriteria
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ResourceFilterCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceFilterCriteria} obj Optional instance to populate.
     * @return {module:model/ResourceFilterCriteria} The populated <code>ResourceFilterCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceFilterCriteria();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceFilterCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceFilterCriteria</code>.
     */
...
export default ResourceFilterCriteria;
