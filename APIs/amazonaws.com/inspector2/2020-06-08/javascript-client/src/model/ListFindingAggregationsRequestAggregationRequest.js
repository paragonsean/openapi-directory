...
/**
 * The ListFindingAggregationsRequestAggregationRequest model module.
 * @module model/ListFindingAggregationsRequestAggregationRequest
 * @version 2020-06-08
 */
class ListFindingAggregationsRequestAggregationRequest {
    /**
     * Constructs a new <code>ListFindingAggregationsRequestAggregationRequest</code>.
     * @alias module:model/ListFindingAggregationsRequestAggregationRequest
     * @implements module:model/AggregationRequest
     */
    constructor() { 
        AggregationRequest.initialize(this);
        ListFindingAggregationsRequestAggregationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFindingAggregationsRequestAggregationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFindingAggregationsRequestAggregationRequest} obj Optional instance to populate.
     * @return {module:model/ListFindingAggregationsRequestAggregationRequest} The populated <code>ListFindingAggregationsRequestAggregationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFindingAggregationsRequestAggregationRequest();
            AggregationRequest.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ListFindingAggregationsRequestAggregationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFindingAggregationsRequestAggregationRequest</code>.
     */
 ...
 */
ListFindingAggregationsRequestAggregationRequest.prototype['accountAggregation'] = undefined;

/**
 * @member {module:model/ListFindingAggregationsRequestAggregationRequestAmiAggregation} amiAggregation
 */
ListFindingAggregationsRequestAggregationRequest.prototype['amiAggregation'] = undefined;
...
export default ListFindingAggregationsRequestAggregationRequest;
