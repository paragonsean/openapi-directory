...
/**
 * The ResourceDetailsAwsLambdaFunction model module.
 * @module model/ResourceDetailsAwsLambdaFunction
 * @version 2020-06-08
 */
class ResourceDetailsAwsLambdaFunction {
    /**
     * Constructs a new <code>ResourceDetailsAwsLambdaFunction</code>.
     * @alias module:model/ResourceDetailsAwsLambdaFunction
     * @implements module:model/AwsLambdaFunctionDetails
    ...
    constructor(codeSha256, executionRoleArn, functionName, runtime, version) { 
        ...
        ResourceDetailsAwsLambdaFunction.initialize(this, codeSha256, executionRoleArn, functionName, runtime, version);
    }
    ...
    /**
     * Constructs a <code>ResourceDetailsAwsLambdaFunction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceDetailsAwsLambdaFunction} obj Optional instance to populate.
     * @return {module:model/ResourceDetailsAwsLambdaFunction} The populated <code>ResourceDetailsAwsLambdaFunction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceDetailsAwsLambdaFunction();
            AwsLambdaFunctionDetails.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceDetailsAwsLambdaFunction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceDetailsAwsLambdaFunction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResourceDetailsAwsLambdaFunction.RequiredProperties) {
...
ResourceDetailsAwsLambdaFunction.RequiredProperties = ["codeSha256", "executionRoleArn", "functionName", "runtime", "version"];

/**
 * @member {Array} architectures
 */
ResourceDetailsAwsLambdaFunction.prototype['architectures'] = undefined;

/**
 * @member {String} codeSha256
 */
ResourceDetailsAwsLambdaFunction.prototype['codeSha256'] = undefined;

/**
 * @member {String} executionRoleArn
 */
ResourceDetailsAwsLambdaFunction.prototype['executionRoleArn'] = undefined;

/**
 * @member {String} functionName
 */
ResourceDetailsAwsLambdaFunction.prototype['functionName'] = undefined;

/**
 * @member {Date} lastModifiedAt
 */
ResourceDetailsAwsLambdaFunction.prototype['lastModifiedAt'] = undefined;

/**
 * @member {Array} layers
 */
ResourceDetailsAwsLambdaFunction.prototype['layers'] = undefined;

/**
 * @member {module:model/PackageType} packageType
 */
ResourceDetailsAwsLambdaFunction.prototype['packageType'] = undefined;

/**
 * @member {module:model/Runtime} runtime
 */
ResourceDetailsAwsLambdaFunction.prototype['runtime'] = undefined;

/**
 * @member {String} version
 */
ResourceDetailsAwsLambdaFunction.prototype['version'] = undefined;

/**
 * @member {module:model/AwsLambdaFunctionDetailsVpcConfig} vpcConfig
 */
ResourceDetailsAwsLambdaFunction.prototype['vpcConfig'] = undefined;


// Implement AwsLambdaFunctionDetails interface:
/**
 * @member {Array} architectures
 */
...
export default ResourceDetailsAwsLambdaFunction;
