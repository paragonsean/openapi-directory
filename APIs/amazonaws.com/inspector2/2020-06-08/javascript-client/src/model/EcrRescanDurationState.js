...
/**
 * The EcrRescanDurationState model module.
 * @module model/EcrRescanDurationState
 * @version 2020-06-08
 */
class EcrRescanDurationState {
    /**
     * Constructs a new <code>EcrRescanDurationState</code>.
     * Details about the state of any changes to the ECR automated re-scan duration setting.
     * @alias module:model/EcrRescanDurationState
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EcrRescanDurationState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EcrRescanDurationState} obj Optional instance to populate.
     * @return {module:model/EcrRescanDurationState} The populated <code>EcrRescanDurationState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EcrRescanDurationState();
    ...
    /**
     * Validates the JSON data with respect to <code>EcrRescanDurationState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EcrRescanDurationState</code>.
     */
...
export default EcrRescanDurationState;
