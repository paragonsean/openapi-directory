...
/**
 * The CreateFilterRequestFilterCriteria model module.
 * @module model/CreateFilterRequestFilterCriteria
 * @version 2020-06-08
 */
class CreateFilterRequestFilterCriteria {
    /**
     * Constructs a new <code>CreateFilterRequestFilterCriteria</code>.
     * @alias module:model/CreateFilterRequestFilterCriteria
     * @implements module:model/FilterCriteria
     */
    constructor() { 
        FilterCriteria.initialize(this);
        CreateFilterRequestFilterCriteria.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFilterRequestFilterCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFilterRequestFilterCriteria} obj Optional instance to populate.
     * @return {module:model/CreateFilterRequestFilterCriteria} The populated <code>CreateFilterRequestFilterCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFilterRequestFilterCriteria();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFilterRequestFilterCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFilterRequestFilterCriteria</code>.
     */
 ...
 */
CreateFilterRequestFilterCriteria.prototype['awsAccountId'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorName
 */
CreateFilterRequestFilterCriteria.prototype['codeVulnerabilityDetectorName'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorTags
 */
CreateFilterRequestFilterCriteria.prototype['codeVulnerabilityDetectorTags'] = undefined;

/**
 * @member {Array} codeVulnerabilityFilePath
 */
CreateFilterRequestFilterCriteria.prototype['codeVulnerabilityFilePath'] = undefined;

/**
 * @member {Array} componentId
 */
CreateFilterRequestFilterCriteria.prototype['componentId'] = undefined;

/**
 * @member {Array} componentType
 */
CreateFilterRequestFilterCriteria.prototype['componentType'] = undefined;

/**
 * @member {Array} ec2InstanceImageId
 */
CreateFilterRequestFilterCriteria.prototype['ec2InstanceImageId'] = undefined;

/**
 * @member {Array} ec2InstanceSubnetId
 */
CreateFilterRequestFilterCriteria.prototype['ec2InstanceSubnetId'] = undefined;

/**
 * @member {Array} ec2InstanceVpcId
 */
CreateFilterRequestFilterCriteria.prototype['ec2InstanceVpcId'] = undefined;

/**
 * @member {Array} ecrImageArchitecture
 */
CreateFilterRequestFilterCriteria.prototype['ecrImageArchitecture'] = undefined;

/**
 * @member {Array} ecrImageHash
 */
CreateFilterRequestFilterCriteria.prototype['ecrImageHash'] = undefined;

/**
 * @member {Array} ecrImagePushedAt
 */
CreateFilterRequestFilterCriteria.prototype['ecrImagePushedAt'] = undefined;

/**
 * @member {Array} ecrImageRegistry
 */
CreateFilterRequestFilterCriteria.prototype['ecrImageRegistry'] = undefined;

/**
 * @member {Array} ecrImageRepositoryName
 */
CreateFilterRequestFilterCriteria.prototype['ecrImageRepositoryName'] = undefined;

/**
 * @member {Array} ecrImageTags
 */
CreateFilterRequestFilterCriteria.prototype['ecrImageTags'] = undefined;

/**
 * @member {Array} epssScore
 */
CreateFilterRequestFilterCriteria.prototype['epssScore'] = undefined;

/**
 * @member {Array} exploitAvailable
 */
CreateFilterRequestFilterCriteria.prototype['exploitAvailable'] = undefined;

/**
 * @member {Array} findingArn
 */
CreateFilterRequestFilterCriteria.prototype['findingArn'] = undefined;

/**
 * @member {Array} findingStatus
 */
CreateFilterRequestFilterCriteria.prototype['findingStatus'] = undefined;

/**
 * @member {Array} findingType
 */
CreateFilterRequestFilterCriteria.prototype['findingType'] = undefined;

/**
 * @member {Array} firstObservedAt
 */
CreateFilterRequestFilterCriteria.prototype['firstObservedAt'] = undefined;

/**
 * @member {Array} fixAvailable
 */
CreateFilterRequestFilterCriteria.prototype['fixAvailable'] = undefined;

/**
 * @member {Array} inspectorScore
 */
CreateFilterRequestFilterCriteria.prototype['inspectorScore'] = undefined;

/**
 * @member {Array} lambdaFunctionExecutionRoleArn
 */
CreateFilterRequestFilterCriteria.prototype['lambdaFunctionExecutionRoleArn'] = undefined;

/**
 * @member {Array} lambdaFunctionLastModifiedAt
 */
CreateFilterRequestFilterCriteria.prototype['lambdaFunctionLastModifiedAt'] = undefined;

/**
 * @member {Array} lambdaFunctionLayers
 */
CreateFilterRequestFilterCriteria.prototype['lambdaFunctionLayers'] = undefined;

/**
 * @member {Array} lambdaFunctionName
 */
CreateFilterRequestFilterCriteria.prototype['lambdaFunctionName'] = undefined;

/**
 * @member {Array} lambdaFunctionRuntime
 */
CreateFilterRequestFilterCriteria.prototype['lambdaFunctionRuntime'] = undefined;

/**
 * @member {Array} lastObservedAt
 */
CreateFilterRequestFilterCriteria.prototype['lastObservedAt'] = undefined;

/**
 * @member {Array} networkProtocol
 */
CreateFilterRequestFilterCriteria.prototype['networkProtocol'] = undefined;

/**
 * @member {Array} portRange
 */
CreateFilterRequestFilterCriteria.prototype['portRange'] = undefined;

/**
 * @member {Array} relatedVulnerabilities
 */
CreateFilterRequestFilterCriteria.prototype['relatedVulnerabilities'] = undefined;

/**
 * @member {Array} resourceId
 */
CreateFilterRequestFilterCriteria.prototype['resourceId'] = undefined;

/**
 * @member {Array} resourceTags
 */
CreateFilterRequestFilterCriteria.prototype['resourceTags'] = undefined;

/**
 * @member {Array} resourceType
 */
CreateFilterRequestFilterCriteria.prototype['resourceType'] = undefined;

/**
 * @member {Array} severity
 */
CreateFilterRequestFilterCriteria.prototype['severity'] = undefined;

/**
 * @member {Array} title
 */
CreateFilterRequestFilterCriteria.prototype['title'] = undefined;

/**
 * @member {Array} updatedAt
 */
CreateFilterRequestFilterCriteria.prototype['updatedAt'] = undefined;

/**
 * @member {Array} vendorSeverity
 */
CreateFilterRequestFilterCriteria.prototype['vendorSeverity'] = undefined;

/**
 * @member {Array} vulnerabilityId
 */
CreateFilterRequestFilterCriteria.prototype['vulnerabilityId'] = undefined;

/**
 * @member {Array} vulnerabilitySource
 */
CreateFilterRequestFilterCriteria.prototype['vulnerabilitySource'] = undefined;

/**
 * @member {Array} vulnerablePackages
 */
CreateFilterRequestFilterCriteria.prototype['vulnerablePackages'] = undefined;
...
export default CreateFilterRequestFilterCriteria;
