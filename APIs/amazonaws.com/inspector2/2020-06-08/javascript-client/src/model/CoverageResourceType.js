...
* @readonly
*/
export default class CoverageResourceType {
    ...
    /**
    * Returns a <code>CoverageResourceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CoverageResourceType} The enum <code>CoverageResourceType</code> value.
    */
