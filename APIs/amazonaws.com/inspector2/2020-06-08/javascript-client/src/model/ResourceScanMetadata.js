...
/**
 * The ResourceScanMetadata model module.
 * @module model/ResourceScanMetadata
 * @version 2020-06-08
 */
class ResourceScanMetadata {
    /**
     * Constructs a new <code>ResourceScanMetadata</code>.
     * An object that contains details about the metadata for an Amazon ECR resource.
     * @alias module:model/ResourceScanMetadata
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ResourceScanMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceScanMetadata} obj Optional instance to populate.
     * @return {module:model/ResourceScanMetadata} The populated <code>ResourceScanMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceScanMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceScanMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceScanMetadata</code>.
     */
...
export default ResourceScanMetadata;
