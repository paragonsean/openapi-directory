...
/**
 * The AggregationResponseEc2InstanceAggregation model module.
 * @module model/AggregationResponseEc2InstanceAggregation
 * @version 2020-06-08
 */
class AggregationResponseEc2InstanceAggregation {
    /**
     * Constructs a new <code>AggregationResponseEc2InstanceAggregation</code>.
     * @alias module:model/AggregationResponseEc2InstanceAggregation
     * @implements module:model/Ec2InstanceAggregationResponse
     * @param instanceId {String} 
     */
    constructor(instanceId) { 
        Ec2InstanceAggregationResponse.initialize(this, instanceId);
        AggregationResponseEc2InstanceAggregation.initialize(this, instanceId);
    }
    ...
    /**
     * Constructs a <code>AggregationResponseEc2InstanceAggregation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AggregationResponseEc2InstanceAggregation} obj Optional instance to populate.
     * @return {module:model/AggregationResponseEc2InstanceAggregation} The populated <code>AggregationResponseEc2InstanceAggregation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregationResponseEc2InstanceAggregation();
            Ec2InstanceAggregationResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AggregationResponseEc2InstanceAggregation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregationResponseEc2InstanceAggregation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AggregationResponseEc2InstanceAggregation.RequiredProperties) {
...
AggregationResponseEc2InstanceAggregation.RequiredProperties = ["instanceId"];

/**
 * @member {String} accountId
 */
AggregationResponseEc2InstanceAggregation.prototype['accountId'] = undefined;

/**
 * @member {String} ami
 */
AggregationResponseEc2InstanceAggregation.prototype['ami'] = undefined;

/**
 * @member {String} instanceId
 */
AggregationResponseEc2InstanceAggregation.prototype['instanceId'] = undefined;

/**
 * @member {Object} instanceTags
 */
AggregationResponseEc2InstanceAggregation.prototype['instanceTags'] = undefined;

/**
 * @member {Number} networkFindings
 */
AggregationResponseEc2InstanceAggregation.prototype['networkFindings'] = undefined;

/**
 * @member {String} operatingSystem
 */
AggregationResponseEc2InstanceAggregation.prototype['operatingSystem'] = undefined;

/**
 * @member {module:model/AmiAggregationResponseSeverityCounts} severityCounts
 */
AggregationResponseEc2InstanceAggregation.prototype['severityCounts'] = undefined;


// Implement Ec2InstanceAggregationResponse interface:
/**
 * @member {String} accountId
 */
...
export default AggregationResponseEc2InstanceAggregation;
