...
/**
 * The CodeFilePath model module.
 * @module model/CodeFilePath
 * @version 2020-06-08
 */
class CodeFilePath {
    /**
     * Constructs a new <code>CodeFilePath</code>.
     * Contains information on where a code vulnerability is located in your Lambda function.
     * @alias module:model/CodeFilePath
    ...
    /**
     * Constructs a <code>CodeFilePath</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeFilePath} obj Optional instance to populate.
     * @return {module:model/CodeFilePath} The populated <code>CodeFilePath</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeFilePath();
    ...
    /**
     * Validates the JSON data with respect to <code>CodeFilePath</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeFilePath</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CodeFilePath.RequiredProperties) {
...
CodeFilePath.RequiredProperties = ["endLine", "fileName", "filePath", "startLine"];
