...
/**
 * The NetworkReachabilityDetails model module.
 * @module model/NetworkReachabilityDetails
 * @version 2020-06-08
 */
class NetworkReachabilityDetails {
    /**
     * Constructs a new <code>NetworkReachabilityDetails</code>.
     * Contains the details of a network reachability finding.
     * @alias module:model/NetworkReachabilityDetails
    ...
    /**
     * Constructs a <code>NetworkReachabilityDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworkReachabilityDetails} obj Optional instance to populate.
     * @return {module:model/NetworkReachabilityDetails} The populated <code>NetworkReachabilityDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworkReachabilityDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworkReachabilityDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworkReachabilityDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NetworkReachabilityDetails.RequiredProperties) {
...
NetworkReachabilityDetails.RequiredProperties = ["networkPath", "openPortRange", "protocol"];
...
export default NetworkReachabilityDetails;
