...
/**
 * The ListFindingsRequestFilterCriteria model module.
 * @module model/ListFindingsRequestFilterCriteria
 * @version 2020-06-08
 */
class ListFindingsRequestFilterCriteria {
    /**
     * Constructs a new <code>ListFindingsRequestFilterCriteria</code>.
     * @alias module:model/ListFindingsRequestFilterCriteria
     * @implements module:model/FilterCriteria
     */
    constructor() { 
        FilterCriteria.initialize(this);
        ListFindingsRequestFilterCriteria.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFindingsRequestFilterCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFindingsRequestFilterCriteria} obj Optional instance to populate.
     * @return {module:model/ListFindingsRequestFilterCriteria} The populated <code>ListFindingsRequestFilterCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFindingsRequestFilterCriteria();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFindingsRequestFilterCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFindingsRequestFilterCriteria</code>.
     */
 ...
 */
ListFindingsRequestFilterCriteria.prototype['awsAccountId'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorName
 */
ListFindingsRequestFilterCriteria.prototype['codeVulnerabilityDetectorName'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorTags
 */
ListFindingsRequestFilterCriteria.prototype['codeVulnerabilityDetectorTags'] = undefined;

/**
 * @member {Array} codeVulnerabilityFilePath
 */
ListFindingsRequestFilterCriteria.prototype['codeVulnerabilityFilePath'] = undefined;

/**
 * @member {Array} componentId
 */
ListFindingsRequestFilterCriteria.prototype['componentId'] = undefined;

/**
 * @member {Array} componentType
 */
ListFindingsRequestFilterCriteria.prototype['componentType'] = undefined;

/**
 * @member {Array} ec2InstanceImageId
 */
ListFindingsRequestFilterCriteria.prototype['ec2InstanceImageId'] = undefined;

/**
 * @member {Array} ec2InstanceSubnetId
 */
ListFindingsRequestFilterCriteria.prototype['ec2InstanceSubnetId'] = undefined;

/**
 * @member {Array} ec2InstanceVpcId
 */
ListFindingsRequestFilterCriteria.prototype['ec2InstanceVpcId'] = undefined;

/**
 * @member {Array} ecrImageArchitecture
 */
ListFindingsRequestFilterCriteria.prototype['ecrImageArchitecture'] = undefined;

/**
 * @member {Array} ecrImageHash
 */
ListFindingsRequestFilterCriteria.prototype['ecrImageHash'] = undefined;

/**
 * @member {Array} ecrImagePushedAt
 */
ListFindingsRequestFilterCriteria.prototype['ecrImagePushedAt'] = undefined;

/**
 * @member {Array} ecrImageRegistry
 */
ListFindingsRequestFilterCriteria.prototype['ecrImageRegistry'] = undefined;

/**
 * @member {Array} ecrImageRepositoryName
 */
ListFindingsRequestFilterCriteria.prototype['ecrImageRepositoryName'] = undefined;

/**
 * @member {Array} ecrImageTags
 */
ListFindingsRequestFilterCriteria.prototype['ecrImageTags'] = undefined;

/**
 * @member {Array} epssScore
 */
ListFindingsRequestFilterCriteria.prototype['epssScore'] = undefined;

/**
 * @member {Array} exploitAvailable
 */
ListFindingsRequestFilterCriteria.prototype['exploitAvailable'] = undefined;

/**
 * @member {Array} findingArn
 */
ListFindingsRequestFilterCriteria.prototype['findingArn'] = undefined;

/**
 * @member {Array} findingStatus
 */
ListFindingsRequestFilterCriteria.prototype['findingStatus'] = undefined;

/**
 * @member {Array} findingType
 */
ListFindingsRequestFilterCriteria.prototype['findingType'] = undefined;

/**
 * @member {Array} firstObservedAt
 */
ListFindingsRequestFilterCriteria.prototype['firstObservedAt'] = undefined;

/**
 * @member {Array} fixAvailable
 */
ListFindingsRequestFilterCriteria.prototype['fixAvailable'] = undefined;

/**
 * @member {Array} inspectorScore
 */
ListFindingsRequestFilterCriteria.prototype['inspectorScore'] = undefined;

/**
 * @member {Array} lambdaFunctionExecutionRoleArn
 */
ListFindingsRequestFilterCriteria.prototype['lambdaFunctionExecutionRoleArn'] = undefined;

/**
 * @member {Array} lambdaFunctionLastModifiedAt
 */
ListFindingsRequestFilterCriteria.prototype['lambdaFunctionLastModifiedAt'] = undefined;

/**
 * @member {Array} lambdaFunctionLayers
 */
ListFindingsRequestFilterCriteria.prototype['lambdaFunctionLayers'] = undefined;

/**
 * @member {Array} lambdaFunctionName
 */
ListFindingsRequestFilterCriteria.prototype['lambdaFunctionName'] = undefined;

/**
 * @member {Array} lambdaFunctionRuntime
 */
ListFindingsRequestFilterCriteria.prototype['lambdaFunctionRuntime'] = undefined;

/**
 * @member {Array} lastObservedAt
 */
ListFindingsRequestFilterCriteria.prototype['lastObservedAt'] = undefined;

/**
 * @member {Array} networkProtocol
 */
ListFindingsRequestFilterCriteria.prototype['networkProtocol'] = undefined;

/**
 * @member {Array} portRange
 */
ListFindingsRequestFilterCriteria.prototype['portRange'] = undefined;

/**
 * @member {Array} relatedVulnerabilities
 */
ListFindingsRequestFilterCriteria.prototype['relatedVulnerabilities'] = undefined;

/**
 * @member {Array} resourceId
 */
ListFindingsRequestFilterCriteria.prototype['resourceId'] = undefined;

/**
 * @member {Array} resourceTags
 */
ListFindingsRequestFilterCriteria.prototype['resourceTags'] = undefined;

/**
 * @member {Array} resourceType
 */
ListFindingsRequestFilterCriteria.prototype['resourceType'] = undefined;

/**
 * @member {Array} severity
 */
ListFindingsRequestFilterCriteria.prototype['severity'] = undefined;

/**
 * @member {Array} title
 */
ListFindingsRequestFilterCriteria.prototype['title'] = undefined;

/**
 * @member {Array} updatedAt
 */
ListFindingsRequestFilterCriteria.prototype['updatedAt'] = undefined;

/**
 * @member {Array} vendorSeverity
 */
ListFindingsRequestFilterCriteria.prototype['vendorSeverity'] = undefined;

/**
 * @member {Array} vulnerabilityId
 */
ListFindingsRequestFilterCriteria.prototype['vulnerabilityId'] = undefined;

/**
 * @member {Array} vulnerabilitySource
 */
ListFindingsRequestFilterCriteria.prototype['vulnerabilitySource'] = undefined;

/**
 * @member {Array} vulnerablePackages
 */
ListFindingsRequestFilterCriteria.prototype['vulnerablePackages'] = undefined;
...
export default ListFindingsRequestFilterCriteria;
