...
/**
 * The CreateFindingsReportRequestFilterCriteria model module.
 * @module model/CreateFindingsReportRequestFilterCriteria
 * @version 2020-06-08
 */
class CreateFindingsReportRequestFilterCriteria {
    /**
     * Constructs a new <code>CreateFindingsReportRequestFilterCriteria</code>.
     * @alias module:model/CreateFindingsReportRequestFilterCriteria
     * @implements module:model/FilterCriteria
     */
    constructor() { 
        FilterCriteria.initialize(this);
        CreateFindingsReportRequestFilterCriteria.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFindingsReportRequestFilterCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFindingsReportRequestFilterCriteria} obj Optional instance to populate.
     * @return {module:model/CreateFindingsReportRequestFilterCriteria} The populated <code>CreateFindingsReportRequestFilterCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFindingsReportRequestFilterCriteria();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFindingsReportRequestFilterCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFindingsReportRequestFilterCriteria</code>.
     */
 ...
 */
CreateFindingsReportRequestFilterCriteria.prototype['awsAccountId'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorName
 */
CreateFindingsReportRequestFilterCriteria.prototype['codeVulnerabilityDetectorName'] = undefined;

/**
 * @member {Array} codeVulnerabilityDetectorTags
 */
CreateFindingsReportRequestFilterCriteria.prototype['codeVulnerabilityDetectorTags'] = undefined;

/**
 * @member {Array} codeVulnerabilityFilePath
 */
CreateFindingsReportRequestFilterCriteria.prototype['codeVulnerabilityFilePath'] = undefined;

/**
 * @member {Array} componentId
 */
CreateFindingsReportRequestFilterCriteria.prototype['componentId'] = undefined;

/**
 * @member {Array} componentType
 */
CreateFindingsReportRequestFilterCriteria.prototype['componentType'] = undefined;

/**
 * @member {Array} ec2InstanceImageId
 */
CreateFindingsReportRequestFilterCriteria.prototype['ec2InstanceImageId'] = undefined;

/**
 * @member {Array} ec2InstanceSubnetId
 */
CreateFindingsReportRequestFilterCriteria.prototype['ec2InstanceSubnetId'] = undefined;

/**
 * @member {Array} ec2InstanceVpcId
 */
CreateFindingsReportRequestFilterCriteria.prototype['ec2InstanceVpcId'] = undefined;

/**
 * @member {Array} ecrImageArchitecture
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImageArchitecture'] = undefined;

/**
 * @member {Array} ecrImageHash
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImageHash'] = undefined;

/**
 * @member {Array} ecrImagePushedAt
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImagePushedAt'] = undefined;

/**
 * @member {Array} ecrImageRegistry
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImageRegistry'] = undefined;

/**
 * @member {Array} ecrImageRepositoryName
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImageRepositoryName'] = undefined;

/**
 * @member {Array} ecrImageTags
 */
CreateFindingsReportRequestFilterCriteria.prototype['ecrImageTags'] = undefined;

/**
 * @member {Array} epssScore
 */
CreateFindingsReportRequestFilterCriteria.prototype['epssScore'] = undefined;

/**
 * @member {Array} exploitAvailable
 */
CreateFindingsReportRequestFilterCriteria.prototype['exploitAvailable'] = undefined;

/**
 * @member {Array} findingArn
 */
CreateFindingsReportRequestFilterCriteria.prototype['findingArn'] = undefined;

/**
 * @member {Array} findingStatus
 */
CreateFindingsReportRequestFilterCriteria.prototype['findingStatus'] = undefined;

/**
 * @member {Array} findingType
 */
CreateFindingsReportRequestFilterCriteria.prototype['findingType'] = undefined;

/**
 * @member {Array} firstObservedAt
 */
CreateFindingsReportRequestFilterCriteria.prototype['firstObservedAt'] = undefined;

/**
 * @member {Array} fixAvailable
 */
CreateFindingsReportRequestFilterCriteria.prototype['fixAvailable'] = undefined;

/**
 * @member {Array} inspectorScore
 */
CreateFindingsReportRequestFilterCriteria.prototype['inspectorScore'] = undefined;

/**
 * @member {Array} lambdaFunctionExecutionRoleArn
 */
CreateFindingsReportRequestFilterCriteria.prototype['lambdaFunctionExecutionRoleArn'] = undefined;

/**
 * @member {Array} lambdaFunctionLastModifiedAt
 */
CreateFindingsReportRequestFilterCriteria.prototype['lambdaFunctionLastModifiedAt'] = undefined;

/**
 * @member {Array} lambdaFunctionLayers
 */
CreateFindingsReportRequestFilterCriteria.prototype['lambdaFunctionLayers'] = undefined;

/**
 * @member {Array} lambdaFunctionName
 */
CreateFindingsReportRequestFilterCriteria.prototype['lambdaFunctionName'] = undefined;

/**
 * @member {Array} lambdaFunctionRuntime
 */
CreateFindingsReportRequestFilterCriteria.prototype['lambdaFunctionRuntime'] = undefined;

/**
 * @member {Array} lastObservedAt
 */
CreateFindingsReportRequestFilterCriteria.prototype['lastObservedAt'] = undefined;

/**
 * @member {Array} networkProtocol
 */
CreateFindingsReportRequestFilterCriteria.prototype['networkProtocol'] = undefined;

/**
 * @member {Array} portRange
 */
CreateFindingsReportRequestFilterCriteria.prototype['portRange'] = undefined;

/**
 * @member {Array} relatedVulnerabilities
 */
CreateFindingsReportRequestFilterCriteria.prototype['relatedVulnerabilities'] = undefined;

/**
 * @member {Array} resourceId
 */
CreateFindingsReportRequestFilterCriteria.prototype['resourceId'] = undefined;

/**
 * @member {Array} resourceTags
 */
CreateFindingsReportRequestFilterCriteria.prototype['resourceTags'] = undefined;

/**
 * @member {Array} resourceType
 */
CreateFindingsReportRequestFilterCriteria.prototype['resourceType'] = undefined;

/**
 * @member {Array} severity
 */
CreateFindingsReportRequestFilterCriteria.prototype['severity'] = undefined;

/**
 * @member {Array} title
 */
CreateFindingsReportRequestFilterCriteria.prototype['title'] = undefined;

/**
 * @member {Array} updatedAt
 */
CreateFindingsReportRequestFilterCriteria.prototype['updatedAt'] = undefined;

/**
 * @member {Array} vendorSeverity
 */
CreateFindingsReportRequestFilterCriteria.prototype['vendorSeverity'] = undefined;

/**
 * @member {Array} vulnerabilityId
 */
CreateFindingsReportRequestFilterCriteria.prototype['vulnerabilityId'] = undefined;

/**
 * @member {Array} vulnerabilitySource
 */
CreateFindingsReportRequestFilterCriteria.prototype['vulnerabilitySource'] = undefined;

/**
 * @member {Array} vulnerablePackages
 */
CreateFindingsReportRequestFilterCriteria.prototype['vulnerablePackages'] = undefined;
...
export default CreateFindingsReportRequestFilterCriteria;
