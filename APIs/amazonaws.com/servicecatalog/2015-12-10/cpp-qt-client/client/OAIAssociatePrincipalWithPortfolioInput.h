...
/*
 * OAIAssociatePrincipalWithPortfolioInput.h
 *
 * 
 */

#ifndef OAIAssociatePrincipalWithPortfolioInput_H
#define OAIAssociatePrincipalWithPortfolioInput_H
...
class OAIAssociatePrincipalWithPortfolioInput : public OAIObject {
public:
    OAIAssociatePrincipalWithPortfolioInput();
    OAIAssociatePrincipalWithPortfolioInput(QString json);
    ~OAIAssociatePrincipalWithPortfolioInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatePrincipalWithPortfolioInput)

#endif // OAIAssociatePrincipalWithPortfolioInput_H
