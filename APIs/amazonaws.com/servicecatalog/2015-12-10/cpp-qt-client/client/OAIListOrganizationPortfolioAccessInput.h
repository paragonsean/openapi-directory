...
/*
 * OAIListOrganizationPortfolioAccessInput.h
 *
 * 
 */

#ifndef OAIListOrganizationPortfolioAccessInput_H
#define OAIListOrganizationPortfolioAccessInput_H
...
class OAIListOrganizationPortfolioAccessInput : public OAIObject {
public:
    OAIListOrganizationPortfolioAccessInput();
    OAIListOrganizationPortfolioAccessInput(QString json);
    ~OAIListOrganizationPortfolioAccessInput() override;
    ...
    OAIOrganizationNodeType getOrganizationNodeType() const;
    void setOrganizationNodeType(const OAIOrganizationNodeType &organization_node_type);
    bool is_organization_node_type_Set() const;
    bool is_organization_node_type_Valid() const;
...
private:
    ...
    OAIOrganizationNodeType m_organization_node_type;
    bool m_organization_node_type_isSet;
    bool m_organization_node_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationPortfolioAccessInput)

#endif // OAIListOrganizationPortfolioAccessInput_H
