...
/*
 * OAIListStackInstancesForProvisionedProductInput.h
 *
 * 
 */

#ifndef OAIListStackInstancesForProvisionedProductInput_H
#define OAIListStackInstancesForProvisionedProductInput_H
...
class OAIListStackInstancesForProvisionedProductInput : public OAIObject {
public:
    OAIListStackInstancesForProvisionedProductInput();
    OAIListStackInstancesForProvisionedProductInput(QString json);
    ~OAIListStackInstancesForProvisionedProductInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStackInstancesForProvisionedProductInput)

#endif // OAIListStackInstancesForProvisionedProductInput_H
