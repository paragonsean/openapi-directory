...
/*
 * OAIDescribeProductOutput_ProductViewSummary.h
 *
 * 
 */

#ifndef OAIDescribeProductOutput_ProductViewSummary_H
#define OAIDescribeProductOutput_ProductViewSummary_H
...
class OAIDescribeProductOutput_ProductViewSummary : public OAIObject {
public:
    OAIDescribeProductOutput_ProductViewSummary();
    OAIDescribeProductOutput_ProductViewSummary(QString json);
    ~OAIDescribeProductOutput_ProductViewSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProductOutput_ProductViewSummary)

#endif // OAIDescribeProductOutput_ProductViewSummary_H
