...
/*
 * OAIDescribeProvisionedProductPlanInput.h
 *
 * 
 */

#ifndef OAIDescribeProvisionedProductPlanInput_H
#define OAIDescribeProvisionedProductPlanInput_H
...
class OAIDescribeProvisionedProductPlanInput : public OAIObject {
public:
    OAIDescribeProvisionedProductPlanInput();
    OAIDescribeProvisionedProductPlanInput(QString json);
    ~OAIDescribeProvisionedProductPlanInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProvisionedProductPlanInput)

#endif // OAIDescribeProvisionedProductPlanInput_H
