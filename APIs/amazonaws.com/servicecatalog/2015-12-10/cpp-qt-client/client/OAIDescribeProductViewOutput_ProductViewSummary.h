...
/*
 * OAIDescribeProductViewOutput_ProductViewSummary.h
 *
 * 
 */

#ifndef OAIDescribeProductViewOutput_ProductViewSummary_H
#define OAIDescribeProductViewOutput_ProductViewSummary_H
...
class OAIDescribeProductViewOutput_ProductViewSummary : public OAIObject {
public:
    OAIDescribeProductViewOutput_ProductViewSummary();
    OAIDescribeProductViewOutput_ProductViewSummary(QString json);
    ~OAIDescribeProductViewOutput_ProductViewSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProductViewOutput_ProductViewSummary)

#endif // OAIDescribeProductViewOutput_ProductViewSummary_H
