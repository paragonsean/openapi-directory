...
/*
 * OAIProvisioningArtifactParameter_ParameterConstraints.h
 *
 * 
 */

#ifndef OAIProvisioningArtifactParameter_ParameterConstraints_H
#define OAIProvisioningArtifactParameter_ParameterConstraints_H
...
class OAIProvisioningArtifactParameter_ParameterConstraints : public OAIObject {
public:
    OAIProvisioningArtifactParameter_ParameterConstraints();
    OAIProvisioningArtifactParameter_ParameterConstraints(QString json);
    ~OAIProvisioningArtifactParameter_ParameterConstraints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioningArtifactParameter_ParameterConstraints)

#endif // OAIProvisioningArtifactParameter_ParameterConstraints_H
