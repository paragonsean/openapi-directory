...
/*
 * OAIDescribeRecordOutput_RecordDetail.h
 *
 * 
 */

#ifndef OAIDescribeRecordOutput_RecordDetail_H
#define OAIDescribeRecordOutput_RecordDetail_H
...
class OAIDescribeRecordOutput_RecordDetail : public OAIObject {
public:
    OAIDescribeRecordOutput_RecordDetail();
    OAIDescribeRecordOutput_RecordDetail(QString json);
    ~OAIDescribeRecordOutput_RecordDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRecordOutput_RecordDetail)

#endif // OAIDescribeRecordOutput_RecordDetail_H
