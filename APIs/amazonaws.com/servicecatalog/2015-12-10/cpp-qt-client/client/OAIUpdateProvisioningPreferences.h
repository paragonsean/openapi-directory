...
/*
 * OAIUpdateProvisioningPreferences.h
 *
 * The user-defined preferences that will be applied when updating a provisioned product. Not all preferences are applicable to all provisioned product types.
 */

#ifndef OAIUpdateProvisioningPreferences_H
#define OAIUpdateProvisioningPreferences_H
...
class OAIUpdateProvisioningPreferences : public OAIObject {
public:
    OAIUpdateProvisioningPreferences();
    OAIUpdateProvisioningPreferences(QString json);
    ~OAIUpdateProvisioningPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProvisioningPreferences)

#endif // OAIUpdateProvisioningPreferences_H
