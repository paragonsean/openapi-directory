...
OAIRejectPortfolioShareInput::OAIRejectPortfolioShareInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRejectPortfolioShareInput::OAIRejectPortfolioShareInput() {
    this->initializeModel();
}

OAIRejectPortfolioShareInput::~OAIRejectPortfolioShareInput() {}

void OAIRejectPortfolioShareInput::initializeModel() {
...
void OAIRejectPortfolioShareInput::fromJson(QString jsonString) {
...
void OAIRejectPortfolioShareInput::fromJsonObject(QJsonObject json) {
...
QString OAIRejectPortfolioShareInput::asJson() const {
...
QJsonObject OAIRejectPortfolioShareInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRejectPortfolioShareInput::getAcceptLanguage() const {
    return m_accept_language;
}
void OAIRejectPortfolioShareInput::setAcceptLanguage(const QString &accept_language) {
    m_accept_language = accept_language;
    m_accept_language_isSet = true;
}

bool OAIRejectPortfolioShareInput::is_accept_language_Set() const{
    return m_accept_language_isSet;
}

bool OAIRejectPortfolioShareInput::is_accept_language_Valid() const{
    return m_accept_language_isValid;
}

QString OAIRejectPortfolioShareInput::getPortfolioId() const {
    return m_portfolio_id;
}
void OAIRejectPortfolioShareInput::setPortfolioId(const QString &portfolio_id) {
    m_portfolio_id = portfolio_id;
    m_portfolio_id_isSet = true;
}

bool OAIRejectPortfolioShareInput::is_portfolio_id_Set() const{
    return m_portfolio_id_isSet;
}

bool OAIRejectPortfolioShareInput::is_portfolio_id_Valid() const{
    return m_portfolio_id_isValid;
}

OAIPortfolioShareType OAIRejectPortfolioShareInput::getPortfolioShareType() const {
    return m_portfolio_share_type;
}
void OAIRejectPortfolioShareInput::setPortfolioShareType(const OAIPortfolioShareType &portfolio_share_type) {
    m_portfolio_share_type = portfolio_share_type;
    m_portfolio_share_type_isSet = true;
}

bool OAIRejectPortfolioShareInput::is_portfolio_share_type_Set() const{
    return m_portfolio_share_type_isSet;
}

bool OAIRejectPortfolioShareInput::is_portfolio_share_type_Valid() const{
    return m_portfolio_share_type_isValid;
}

bool OAIRejectPortfolioShareInput::isSet() const {
...
bool OAIRejectPortfolioShareInput::isValid() const {
