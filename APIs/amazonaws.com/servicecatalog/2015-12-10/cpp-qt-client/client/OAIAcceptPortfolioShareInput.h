...
/*
 * OAIAcceptPortfolioShareInput.h
 *
 * 
 */

#ifndef OAIAcceptPortfolioShareInput_H
#define OAIAcceptPortfolioShareInput_H
...
class OAIAcceptPortfolioShareInput : public OAIObject {
public:
    OAIAcceptPortfolioShareInput();
    OAIAcceptPortfolioShareInput(QString json);
    ~OAIAcceptPortfolioShareInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptPortfolioShareInput)

#endif // OAIAcceptPortfolioShareInput_H
