...
/*
 * OAIDescribeRecordInput.h
 *
 * 
 */

#ifndef OAIDescribeRecordInput_H
#define OAIDescribeRecordInput_H
...
class OAIDescribeRecordInput : public OAIObject {
public:
    OAIDescribeRecordInput();
    OAIDescribeRecordInput(QString json);
    ~OAIDescribeRecordInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRecordInput)

#endif // OAIDescribeRecordInput_H
