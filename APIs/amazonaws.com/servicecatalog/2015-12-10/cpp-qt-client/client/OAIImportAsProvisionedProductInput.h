...
/*
 * OAIImportAsProvisionedProductInput.h
 *
 * 
 */

#ifndef OAIImportAsProvisionedProductInput_H
#define OAIImportAsProvisionedProductInput_H
...
class OAIImportAsProvisionedProductInput : public OAIObject {
public:
    OAIImportAsProvisionedProductInput();
    OAIImportAsProvisionedProductInput(QString json);
    ~OAIImportAsProvisionedProductInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAsProvisionedProductInput)

#endif // OAIImportAsProvisionedProductInput_H
