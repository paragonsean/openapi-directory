...
#ifndef OAIRecordDetail_H
#define OAIRecordDetail_H
...
class OAIRecordDetail : public OAIObject {
public:
    OAIRecordDetail();
    OAIRecordDetail(QString json);
    ~OAIRecordDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecordDetail)

#endif // OAIRecordDetail_H
