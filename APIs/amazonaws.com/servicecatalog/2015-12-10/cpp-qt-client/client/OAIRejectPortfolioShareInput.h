...
/*
 * OAIRejectPortfolioShareInput.h
 *
 * 
 */

#ifndef OAIRejectPortfolioShareInput_H
#define OAIRejectPortfolioShareInput_H
...
class OAIRejectPortfolioShareInput : public OAIObject {
public:
    OAIRejectPortfolioShareInput();
    OAIRejectPortfolioShareInput(QString json);
    ~OAIRejectPortfolioShareInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRejectPortfolioShareInput)

#endif // OAIRejectPortfolioShareInput_H
