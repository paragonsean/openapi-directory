...
/*
 * OAICreatePortfolioShareInput.h
 *
 * 
 */

#ifndef OAICreatePortfolioShareInput_H
#define OAICreatePortfolioShareInput_H
...
namespace OpenAPI {
class OAICreatePortfolioShareInput_OrganizationNode;

class OAICreatePortfolioShareInput : public OAIObject {
public:
    OAICreatePortfolioShareInput();
    OAICreatePortfolioShareInput(QString json);
    ~OAICreatePortfolioShareInput() override;
    ...
    OAICreatePortfolioShareInput_OrganizationNode getOrganizationNode() const;
    void setOrganizationNode(const OAICreatePortfolioShareInput_OrganizationNode &organization_node);
...
private:
    ...
    OAICreatePortfolioShareInput_OrganizationNode m_organization_node;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePortfolioShareInput)

#endif // OAICreatePortfolioShareInput_H
