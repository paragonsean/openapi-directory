...
/*
 * OAIListServiceActionsInput.h
 *
 * 
 */

#ifndef OAIListServiceActionsInput_H
#define OAIListServiceActionsInput_H
...
class OAIListServiceActionsInput : public OAIObject {
public:
    OAIListServiceActionsInput();
    OAIListServiceActionsInput(QString json);
    ~OAIListServiceActionsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListServiceActionsInput)

#endif // OAIListServiceActionsInput_H
