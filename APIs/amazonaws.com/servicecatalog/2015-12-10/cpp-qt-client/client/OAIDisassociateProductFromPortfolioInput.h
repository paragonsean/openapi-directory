...
/*
 * OAIDisassociateProductFromPortfolioInput.h
 *
 * 
 */

#ifndef OAIDisassociateProductFromPortfolioInput_H
#define OAIDisassociateProductFromPortfolioInput_H
...
class OAIDisassociateProductFromPortfolioInput : public OAIObject {
public:
    OAIDisassociateProductFromPortfolioInput();
    OAIDisassociateProductFromPortfolioInput(QString json);
    ~OAIDisassociateProductFromPortfolioInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateProductFromPortfolioInput)

#endif // OAIDisassociateProductFromPortfolioInput_H
