...
/*
 * OAIListProvisioningArtifactsInput.h
 *
 * 
 */

#ifndef OAIListProvisioningArtifactsInput_H
#define OAIListProvisioningArtifactsInput_H
...
class OAIListProvisioningArtifactsInput : public OAIObject {
public:
    OAIListProvisioningArtifactsInput();
    OAIListProvisioningArtifactsInput(QString json);
    ~OAIListProvisioningArtifactsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProvisioningArtifactsInput)

#endif // OAIListProvisioningArtifactsInput_H
