...
QString OAIParameterConstraints::getAllowedPattern() const {
    return m_allowed_pattern;
}
void OAIParameterConstraints::setAllowedPattern(const QString &allowed_pattern) {
    m_allowed_pattern = allowed_pattern;
    m_allowed_pattern_isSet = true;
}

bool OAIParameterConstraints::is_allowed_pattern_Set() const{
    return m_allowed_pattern_isSet;
}

bool OAIParameterConstraints::is_allowed_pattern_Valid() const{
    return m_allowed_pattern_isValid;
}

QString OAIParameterConstraints::getConstraintDescription() const {
    return m_constraint_description;
}
void OAIParameterConstraints::setConstraintDescription(const QString &constraint_description) {
    m_constraint_description = constraint_description;
    m_constraint_description_isSet = true;
}

bool OAIParameterConstraints::is_constraint_description_Set() const{
    return m_constraint_description_isSet;
}

bool OAIParameterConstraints::is_constraint_description_Valid() const{
    return m_constraint_description_isValid;
}

QString OAIParameterConstraints::getMaxLength() const {
    return m_max_length;
}
void OAIParameterConstraints::setMaxLength(const QString &max_length) {
    m_max_length = max_length;
    m_max_length_isSet = true;
}

bool OAIParameterConstraints::is_max_length_Set() const{
    return m_max_length_isSet;
}

bool OAIParameterConstraints::is_max_length_Valid() const{
    return m_max_length_isValid;
}

QString OAIParameterConstraints::getMinLength() const {
    return m_min_length;
}
void OAIParameterConstraints::setMinLength(const QString &min_length) {
    m_min_length = min_length;
    m_min_length_isSet = true;
}

bool OAIParameterConstraints::is_min_length_Set() const{
    return m_min_length_isSet;
}

bool OAIParameterConstraints::is_min_length_Valid() const{
    return m_min_length_isValid;
}

QString OAIParameterConstraints::getMaxValue() const {
    return m_max_value;
}
void OAIParameterConstraints::setMaxValue(const QString &max_value) {
    m_max_value = max_value;
    m_max_value_isSet = true;
}

bool OAIParameterConstraints::is_max_value_Set() const{
    return m_max_value_isSet;
}

bool OAIParameterConstraints::is_max_value_Valid() const{
    return m_max_value_isValid;
}

QString OAIParameterConstraints::getMinValue() const {
    return m_min_value;
}
void OAIParameterConstraints::setMinValue(const QString &min_value) {
    m_min_value = min_value;
    m_min_value_isSet = true;
}

bool OAIParameterConstraints::is_min_value_Set() const{
    return m_min_value_isSet;
}

bool OAIParameterConstraints::is_min_value_Valid() const{
