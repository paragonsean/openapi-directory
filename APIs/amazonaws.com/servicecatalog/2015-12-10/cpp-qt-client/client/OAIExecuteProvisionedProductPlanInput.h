...
/*
 * OAIExecuteProvisionedProductPlanInput.h
 *
 * 
 */

#ifndef OAIExecuteProvisionedProductPlanInput_H
#define OAIExecuteProvisionedProductPlanInput_H
...
class OAIExecuteProvisionedProductPlanInput : public OAIObject {
public:
    OAIExecuteProvisionedProductPlanInput();
    OAIExecuteProvisionedProductPlanInput(QString json);
    ~OAIExecuteProvisionedProductPlanInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteProvisionedProductPlanInput)

#endif // OAIExecuteProvisionedProductPlanInput_H
