...
/*
 * OAIListBudgetsForResourceOutput.h
 *
 * 
 */

#ifndef OAIListBudgetsForResourceOutput_H
#define OAIListBudgetsForResourceOutput_H
...
class OAIListBudgetsForResourceOutput : public OAIObject {
public:
    OAIListBudgetsForResourceOutput();
    OAIListBudgetsForResourceOutput(QString json);
    ~OAIListBudgetsForResourceOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBudgetsForResourceOutput)

#endif // OAIListBudgetsForResourceOutput_H
