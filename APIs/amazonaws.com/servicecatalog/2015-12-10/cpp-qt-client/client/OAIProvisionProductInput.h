...
/*
 * OAIProvisionProductInput.h
 *
 * 
 */

#ifndef OAIProvisionProductInput_H
#define OAIProvisionProductInput_H

#include <QJsonObject>

#include "OAIProvisionProductInput_ProvisioningPreferences.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIProvisionProductInput_ProvisioningPreferences;

class OAIProvisionProductInput : public OAIObject {
public:
    OAIProvisionProductInput();
    OAIProvisionProductInput(QString json);
    ~OAIProvisionProductInput() override;
    ...
    OAIProvisionProductInput_ProvisioningPreferences getProvisioningPreferences() const;
    void setProvisioningPreferences(const OAIProvisionProductInput_ProvisioningPreferences &provisioning_preferences);
    ...
    QString getProvisionToken() const;
    void setProvisionToken(const QString &provision_token);
    bool is_provision_token_Set() const;
    bool is_provision_token_Valid() const;
...
private:
    ...
    OAIProvisionProductInput_ProvisioningPreferences m_provisioning_preferences;
    ...
    QString m_provision_token;
    bool m_provision_token_isSet;
    bool m_provision_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProvisionProductInput)

#endif // OAIProvisionProductInput_H
