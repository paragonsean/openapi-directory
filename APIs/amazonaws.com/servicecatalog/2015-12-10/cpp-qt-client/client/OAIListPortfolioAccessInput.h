...
/*
 * OAIListPortfolioAccessInput.h
 *
 * 
 */

#ifndef OAIListPortfolioAccessInput_H
#define OAIListPortfolioAccessInput_H
...
class OAIListPortfolioAccessInput : public OAIObject {
public:
    OAIListPortfolioAccessInput();
    OAIListPortfolioAccessInput(QString json);
    ~OAIListPortfolioAccessInput() override;
    ...
    QString getOrganizationParentId() const;
    void setOrganizationParentId(const QString &organization_parent_id);
    bool is_organization_parent_id_Set() const;
    bool is_organization_parent_id_Valid() const;
...
private:
    ...
    QString m_organization_parent_id;
    bool m_organization_parent_id_isSet;
    bool m_organization_parent_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPortfolioAccessInput)

#endif // OAIListPortfolioAccessInput_H
