...
/*
 * OAIDescribePortfolioSharesInput.h
 *
 * 
 */

#ifndef OAIDescribePortfolioSharesInput_H
#define OAIDescribePortfolioSharesInput_H
...
class OAIDescribePortfolioSharesInput : public OAIObject {
public:
    OAIDescribePortfolioSharesInput();
    OAIDescribePortfolioSharesInput(QString json);
    ~OAIDescribePortfolioSharesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePortfolioSharesInput)

#endif // OAIDescribePortfolioSharesInput_H
