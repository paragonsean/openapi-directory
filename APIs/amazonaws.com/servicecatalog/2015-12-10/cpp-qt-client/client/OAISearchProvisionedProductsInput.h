...
/*
 * OAISearchProvisionedProductsInput.h
 *
 * 
 */

#ifndef OAISearchProvisionedProductsInput_H
#define OAISearchProvisionedProductsInput_H
...
class OAISearchProvisionedProductsInput : public OAIObject {
public:
    OAISearchProvisionedProductsInput();
    OAISearchProvisionedProductsInput(QString json);
    ~OAISearchProvisionedProductsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchProvisionedProductsInput)

#endif // OAISearchProvisionedProductsInput_H
