...
/*
 * OAIListPrincipalsForPortfolioInput.h
 *
 * 
 */

#ifndef OAIListPrincipalsForPortfolioInput_H
#define OAIListPrincipalsForPortfolioInput_H
...
class OAIListPrincipalsForPortfolioInput : public OAIObject {
public:
    OAIListPrincipalsForPortfolioInput();
    OAIListPrincipalsForPortfolioInput(QString json);
    ~OAIListPrincipalsForPortfolioInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPrincipalsForPortfolioInput)

#endif // OAIListPrincipalsForPortfolioInput_H
