...
/*
 * OAIDeleteProvisioningArtifactInput.h
 *
 * 
 */

#ifndef OAIDeleteProvisioningArtifactInput_H
#define OAIDeleteProvisioningArtifactInput_H
...
class OAIDeleteProvisioningArtifactInput : public OAIObject {
public:
    OAIDeleteProvisioningArtifactInput();
    OAIDeleteProvisioningArtifactInput(QString json);
    ~OAIDeleteProvisioningArtifactInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProvisioningArtifactInput)

#endif // OAIDeleteProvisioningArtifactInput_H
