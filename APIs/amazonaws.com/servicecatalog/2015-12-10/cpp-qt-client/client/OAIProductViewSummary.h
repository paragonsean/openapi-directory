...
/*
 * OAIProductViewSummary.h
 *
 * Summary information about a product view.
 */

#ifndef OAIProductViewSummary_H
#define OAIProductViewSummary_H
...
class OAIProductViewSummary : public OAIObject {
public:
    OAIProductViewSummary();
    OAIProductViewSummary(QString json);
    ~OAIProductViewSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductViewSummary)

#endif // OAIProductViewSummary_H
