...
/*
 * OAIDescribeProvisioningParametersInput.h
 *
 * 
 */

#ifndef OAIDescribeProvisioningParametersInput_H
#define OAIDescribeProvisioningParametersInput_H
...
class OAIDescribeProvisioningParametersInput : public OAIObject {
public:
    OAIDescribeProvisioningParametersInput();
    OAIDescribeProvisioningParametersInput(QString json);
    ~OAIDescribeProvisioningParametersInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProvisioningParametersInput)

#endif // OAIDescribeProvisioningParametersInput_H
