...
/*
 * OAIListPortfoliosForProductInput.h
 *
 * 
 */

#ifndef OAIListPortfoliosForProductInput_H
#define OAIListPortfoliosForProductInput_H
...
class OAIListPortfoliosForProductInput : public OAIObject {
public:
    OAIListPortfoliosForProductInput();
    OAIListPortfoliosForProductInput(QString json);
    ~OAIListPortfoliosForProductInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPortfoliosForProductInput)

#endif // OAIListPortfoliosForProductInput_H
