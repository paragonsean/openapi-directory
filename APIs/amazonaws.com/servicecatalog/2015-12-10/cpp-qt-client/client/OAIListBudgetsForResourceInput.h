...
/*
 * OAIListBudgetsForResourceInput.h
 *
 * 
 */

#ifndef OAIListBudgetsForResourceInput_H
#define OAIListBudgetsForResourceInput_H
...
class OAIListBudgetsForResourceInput : public OAIObject {
public:
    OAIListBudgetsForResourceInput();
    OAIListBudgetsForResourceInput(QString json);
    ~OAIListBudgetsForResourceInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBudgetsForResourceInput)

#endif // OAIListBudgetsForResourceInput_H
