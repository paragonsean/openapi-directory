...
/*
 * OAIDescribeProvisionedProductInput.h
 *
...
#ifndef OAIDescribeProvisionedProductInput_H
#define OAIDescribeProvisionedProductInput_H
...
class OAIDescribeProvisionedProductInput : public OAIObject {
public:
    OAIDescribeProvisionedProductInput();
    OAIDescribeProvisionedProductInput(QString json);
    ~OAIDescribeProvisionedProductInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProvisionedProductInput)

#endif // OAIDescribeProvisionedProductInput_H
