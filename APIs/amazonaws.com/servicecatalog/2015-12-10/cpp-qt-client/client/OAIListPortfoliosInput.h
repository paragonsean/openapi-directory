...
/*
 * OAIListPortfoliosInput.h
 *
 * 
 */

#ifndef OAIListPortfoliosInput_H
#define OAIListPortfoliosInput_H
...
class OAIListPortfoliosInput : public OAIObject {
public:
    OAIListPortfoliosInput();
    OAIListPortfoliosInput(QString json);
    ~OAIListPortfoliosInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPortfoliosInput)

#endif // OAIListPortfoliosInput_H
