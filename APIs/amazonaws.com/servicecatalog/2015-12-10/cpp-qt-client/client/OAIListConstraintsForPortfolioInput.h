...
/*
 * OAIListConstraintsForPortfolioInput.h
 *
 * 
 */

#ifndef OAIListConstraintsForPortfolioInput_H
#define OAIListConstraintsForPortfolioInput_H
...
class OAIListConstraintsForPortfolioInput : public OAIObject {
public:
    OAIListConstraintsForPortfolioInput();
    OAIListConstraintsForPortfolioInput(QString json);
    ~OAIListConstraintsForPortfolioInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListConstraintsForPortfolioInput)

#endif // OAIListConstraintsForPortfolioInput_H
