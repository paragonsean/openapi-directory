...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribeRecordInput();
  });
  ...
  describe('DescribeRecordInput', function() {
    it('should create an instance of DescribeRecordInput', function() {
      // uncomment below and update the code to test DescribeRecordInput
      //var instance = new AwsServiceCatalog.DescribeRecordInput();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribeRecordInput);
    });
