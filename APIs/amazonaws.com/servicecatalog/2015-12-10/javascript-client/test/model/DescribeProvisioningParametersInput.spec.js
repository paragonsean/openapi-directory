...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribeProvisioningParametersInput();
  });
  ...
  describe('DescribeProvisioningParametersInput', function() {
    it('should create an instance of DescribeProvisioningParametersInput', function() {
      // uncomment below and update the code to test DescribeProvisioningParametersInput
      //var instance = new AwsServiceCatalog.DescribeProvisioningParametersInput();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribeProvisioningParametersInput);
    });
