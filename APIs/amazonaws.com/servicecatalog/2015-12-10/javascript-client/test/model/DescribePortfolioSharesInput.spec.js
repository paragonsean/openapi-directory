...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribePortfolioSharesInput();
  });
  ...
  describe('DescribePortfolioSharesInput', function() {
    it('should create an instance of DescribePortfolioSharesInput', function() {
      // uncomment below and update the code to test DescribePortfolioSharesInput
      //var instance = new AwsServiceCatalog.DescribePortfolioSharesInput();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribePortfolioSharesInput);
    });
