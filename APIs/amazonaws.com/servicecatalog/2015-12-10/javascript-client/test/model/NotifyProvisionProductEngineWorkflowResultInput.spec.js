...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.NotifyProvisionProductEngineWorkflowResultInput();
  });
  ...
  describe('NotifyProvisionProductEngineWorkflowResultInput', function() {
    it('should create an instance of NotifyProvisionProductEngineWorkflowResultInput', function() {
      // uncomment below and update the code to test NotifyProvisionProductEngineWorkflowResultInput
      //var instance = new AwsServiceCatalog.NotifyProvisionProductEngineWorkflowResultInput();
      //expect(instance).to.be.a(AwsServiceCatalog.NotifyProvisionProductEngineWorkflowResultInput);
    });
