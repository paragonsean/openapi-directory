...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ExecuteProvisionedProductPlanInput();
  });
  ...
  describe('ExecuteProvisionedProductPlanInput', function() {
    it('should create an instance of ExecuteProvisionedProductPlanInput', function() {
      // uncomment below and update the code to test ExecuteProvisionedProductPlanInput
      //var instance = new AwsServiceCatalog.ExecuteProvisionedProductPlanInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ExecuteProvisionedProductPlanInput);
    });
