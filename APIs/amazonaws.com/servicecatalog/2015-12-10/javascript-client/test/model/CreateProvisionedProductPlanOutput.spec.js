...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreateProvisionedProductPlanOutput();
  });
  ...
  describe('CreateProvisionedProductPlanOutput', function() {
    it('should create an instance of CreateProvisionedProductPlanOutput', function() {
      // uncomment below and update the code to test CreateProvisionedProductPlanOutput
      //var instance = new AwsServiceCatalog.CreateProvisionedProductPlanOutput();
      //expect(instance).to.be.a(AwsServiceCatalog.CreateProvisionedProductPlanOutput);
    });
