...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreateServiceActionInput();
  });
  ...
  describe('CreateServiceActionInput', function() {
    it('should create an instance of CreateServiceActionInput', function() {
      // uncomment below and update the code to test CreateServiceActionInput
      //var instance = new AwsServiceCatalog.CreateServiceActionInput();
      //expect(instance).to.be.a(AwsServiceCatalog.CreateServiceActionInput);
    });
