...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreatePortfolioOutputPortfolioDetail();
  });
  ...
  describe('CreatePortfolioOutputPortfolioDetail', function() {
    it('should create an instance of CreatePortfolioOutputPortfolioDetail', function() {
      // uncomment below and update the code to test CreatePortfolioOutputPortfolioDetail
      //var instance = new AwsServiceCatalog.CreatePortfolioOutputPortfolioDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.CreatePortfolioOutputPortfolioDetail);
    });
