...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListPortfoliosInput();
  });
  ...
  describe('ListPortfoliosInput', function() {
    it('should create an instance of ListPortfoliosInput', function() {
      // uncomment below and update the code to test ListPortfoliosInput
      //var instance = new AwsServiceCatalog.ListPortfoliosInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListPortfoliosInput);
    });
