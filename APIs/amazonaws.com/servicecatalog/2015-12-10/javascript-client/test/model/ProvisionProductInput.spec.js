...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ProvisionProductInput();
  });
  ...
  describe('ProvisionProductInput', function() {
    it('should create an instance of ProvisionProductInput', function() {
      // uncomment below and update the code to test ProvisionProductInput
      //var instance = new AwsServiceCatalog.ProvisionProductInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ProvisionProductInput);
    });
    ...
    it('should have the property provisionToken (base name: "ProvisionToken")', function() {
      // uncomment below and update the code to test the property provisionToken
      //var instance = new AwsServiceCatalog.ProvisionProductInput();
      //expect(instance).to.be();
    });
