...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.UpdatePortfolioInput();
  });
  ...
  describe('UpdatePortfolioInput', function() {
    it('should create an instance of UpdatePortfolioInput', function() {
      // uncomment below and update the code to test UpdatePortfolioInput
      //var instance = new AwsServiceCatalog.UpdatePortfolioInput();
      //expect(instance).to.be.a(AwsServiceCatalog.UpdatePortfolioInput);
    });
