...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribeProvisioningArtifactInput();
  });
  ...
  describe('DescribeProvisioningArtifactInput', function() {
    it('should create an instance of DescribeProvisioningArtifactInput', function() {
      // uncomment below and update the code to test DescribeProvisioningArtifactInput
      //var instance = new AwsServiceCatalog.DescribeProvisioningArtifactInput();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribeProvisioningArtifactInput);
    });
    ...
    it('should have the property includeProvisioningArtifactParameters (base name: "IncludeProvisioningArtifactParameters")', function() {
      // uncomment below and update the code to test the property includeProvisioningArtifactParameters
      //var instance = new AwsServiceCatalog.DescribeProvisioningArtifactInput();
      //expect(instance).to.be();
    });
