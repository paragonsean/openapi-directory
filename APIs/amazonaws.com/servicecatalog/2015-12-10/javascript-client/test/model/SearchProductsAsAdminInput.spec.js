...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.SearchProductsAsAdminInput();
  });
  ...
  describe('SearchProductsAsAdminInput', function() {
    it('should create an instance of SearchProductsAsAdminInput', function() {
      // uncomment below and update the code to test SearchProductsAsAdminInput
      //var instance = new AwsServiceCatalog.SearchProductsAsAdminInput();
      //expect(instance).to.be.a(AwsServiceCatalog.SearchProductsAsAdminInput);
    });
    ...
    it('should have the property productSource (base name: "ProductSource")', function() {
      // uncomment below and update the code to test the property productSource
      //var instance = new AwsServiceCatalog.SearchProductsAsAdminInput();
      //expect(instance).to.be();
    });
