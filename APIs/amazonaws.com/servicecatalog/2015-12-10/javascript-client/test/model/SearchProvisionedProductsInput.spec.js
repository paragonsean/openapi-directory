...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.SearchProvisionedProductsInput();
  });
  ...
  describe('SearchProvisionedProductsInput', function() {
    it('should create an instance of SearchProvisionedProductsInput', function() {
      // uncomment below and update the code to test SearchProvisionedProductsInput
      //var instance = new AwsServiceCatalog.SearchProvisionedProductsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.SearchProvisionedProductsInput);
    });
