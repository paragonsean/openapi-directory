...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ExecuteProvisionedProductPlanOutputRecordDetail();
  });
  ...
  describe('ExecuteProvisionedProductPlanOutputRecordDetail', function() {
    it('should create an instance of ExecuteProvisionedProductPlanOutputRecordDetail', function() {
      // uncomment below and update the code to test ExecuteProvisionedProductPlanOutputRecordDetail
      //var instance = new AwsServiceCatalog.ExecuteProvisionedProductPlanOutputRecordDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.ExecuteProvisionedProductPlanOutputRecordDetail);
    });
