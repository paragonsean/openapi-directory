...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListPrincipalsForPortfolioInput();
  });
  ...
  describe('ListPrincipalsForPortfolioInput', function() {
    it('should create an instance of ListPrincipalsForPortfolioInput', function() {
      // uncomment below and update the code to test ListPrincipalsForPortfolioInput
      //var instance = new AwsServiceCatalog.ListPrincipalsForPortfolioInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListPrincipalsForPortfolioInput);
    });
