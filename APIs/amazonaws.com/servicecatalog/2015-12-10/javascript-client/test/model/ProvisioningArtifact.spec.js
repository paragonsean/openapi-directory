...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ProvisioningArtifact();
  });
  ...
  describe('ProvisioningArtifact', function() {
    it('should create an instance of ProvisioningArtifact', function() {
      // uncomment below and update the code to test ProvisioningArtifact
      //var instance = new AwsServiceCatalog.ProvisioningArtifact();
      //expect(instance).to.be.a(AwsServiceCatalog.ProvisioningArtifact);
    });
