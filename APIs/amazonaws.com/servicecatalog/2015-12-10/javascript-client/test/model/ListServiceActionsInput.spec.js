...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListServiceActionsInput();
  });
  ...
  describe('ListServiceActionsInput', function() {
    it('should create an instance of ListServiceActionsInput', function() {
      // uncomment below and update the code to test ListServiceActionsInput
      //var instance = new AwsServiceCatalog.ListServiceActionsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListServiceActionsInput);
    });
