...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ResourceDetail();
  });
  ...
  describe('ResourceDetail', function() {
    it('should create an instance of ResourceDetail', function() {
      // uncomment below and update the code to test ResourceDetail
      //var instance = new AwsServiceCatalog.ResourceDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.ResourceDetail);
    });
