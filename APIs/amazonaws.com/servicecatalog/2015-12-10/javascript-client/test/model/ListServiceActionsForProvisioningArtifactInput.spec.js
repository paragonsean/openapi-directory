...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListServiceActionsForProvisioningArtifactInput();
  });
  ...
  describe('ListServiceActionsForProvisioningArtifactInput', function() {
    it('should create an instance of ListServiceActionsForProvisioningArtifactInput', function() {
      // uncomment below and update the code to test ListServiceActionsForProvisioningArtifactInput
      //var instance = new AwsServiceCatalog.ListServiceActionsForProvisioningArtifactInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListServiceActionsForProvisioningArtifactInput);
    });
