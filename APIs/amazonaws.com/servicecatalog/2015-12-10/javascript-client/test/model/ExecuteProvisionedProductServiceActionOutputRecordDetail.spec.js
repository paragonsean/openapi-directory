...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ExecuteProvisionedProductServiceActionOutputRecordDetail();
  });
  ...
  describe('ExecuteProvisionedProductServiceActionOutputRecordDetail', function() {
    it('should create an instance of ExecuteProvisionedProductServiceActionOutputRecordDetail', function() {
      // uncomment below and update the code to test ExecuteProvisionedProductServiceActionOutputRecordDetail
      //var instance = new AwsServiceCatalog.ExecuteProvisionedProductServiceActionOutputRecordDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.ExecuteProvisionedProductServiceActionOutputRecordDetail);
    });
