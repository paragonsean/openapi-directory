...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.UpdateServiceActionInput();
  });
  ...
  describe('UpdateServiceActionInput', function() {
    it('should create an instance of UpdateServiceActionInput', function() {
      // uncomment below and update the code to test UpdateServiceActionInput
      //var instance = new AwsServiceCatalog.UpdateServiceActionInput();
      //expect(instance).to.be.a(AwsServiceCatalog.UpdateServiceActionInput);
    });
