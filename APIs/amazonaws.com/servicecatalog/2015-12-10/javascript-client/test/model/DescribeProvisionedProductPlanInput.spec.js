...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribeProvisionedProductPlanInput();
  });
  ...
  describe('DescribeProvisionedProductPlanInput', function() {
    it('should create an instance of DescribeProvisionedProductPlanInput', function() {
      // uncomment below and update the code to test DescribeProvisionedProductPlanInput
      //var instance = new AwsServiceCatalog.DescribeProvisionedProductPlanInput();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribeProvisionedProductPlanInput);
    });
