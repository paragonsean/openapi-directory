...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListPortfoliosForProductInput();
  });
  ...
  describe('ListPortfoliosForProductInput', function() {
    it('should create an instance of ListPortfoliosForProductInput', function() {
      // uncomment below and update the code to test ListPortfoliosForProductInput
      //var instance = new AwsServiceCatalog.ListPortfoliosForProductInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListPortfoliosForProductInput);
    });
