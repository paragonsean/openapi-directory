...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListConstraintsForPortfolioInput();
  });
  ...
  describe('ListConstraintsForPortfolioInput', function() {
    it('should create an instance of ListConstraintsForPortfolioInput', function() {
      // uncomment below and update the code to test ListConstraintsForPortfolioInput
      //var instance = new AwsServiceCatalog.ListConstraintsForPortfolioInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListConstraintsForPortfolioInput);
    });
