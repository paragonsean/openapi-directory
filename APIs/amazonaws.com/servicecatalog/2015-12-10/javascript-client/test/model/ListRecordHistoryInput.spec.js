...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListRecordHistoryInput();
  });
  ...
  describe('ListRecordHistoryInput', function() {
    it('should create an instance of ListRecordHistoryInput', function() {
      // uncomment below and update the code to test ListRecordHistoryInput
      //var instance = new AwsServiceCatalog.ListRecordHistoryInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListRecordHistoryInput);
    });
