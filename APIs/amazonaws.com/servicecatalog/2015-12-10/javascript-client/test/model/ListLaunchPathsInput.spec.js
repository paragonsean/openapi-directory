...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListLaunchPathsInput();
  });
  ...
  describe('ListLaunchPathsInput', function() {
    it('should create an instance of ListLaunchPathsInput', function() {
      // uncomment below and update the code to test ListLaunchPathsInput
      //var instance = new AwsServiceCatalog.ListLaunchPathsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListLaunchPathsInput);
    });
