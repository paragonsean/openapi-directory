...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListBudgetsForResourceInput();
  });
  ...
  describe('ListBudgetsForResourceInput', function() {
    it('should create an instance of ListBudgetsForResourceInput', function() {
      // uncomment below and update the code to test ListBudgetsForResourceInput
      //var instance = new AwsServiceCatalog.ListBudgetsForResourceInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListBudgetsForResourceInput);
    });
