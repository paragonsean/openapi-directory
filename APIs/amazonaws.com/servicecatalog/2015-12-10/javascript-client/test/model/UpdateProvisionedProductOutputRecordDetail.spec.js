...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.UpdateProvisionedProductOutputRecordDetail();
  });
  ...
  describe('UpdateProvisionedProductOutputRecordDetail', function() {
    it('should create an instance of UpdateProvisionedProductOutputRecordDetail', function() {
      // uncomment below and update the code to test UpdateProvisionedProductOutputRecordDetail
      //var instance = new AwsServiceCatalog.UpdateProvisionedProductOutputRecordDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.UpdateProvisionedProductOutputRecordDetail);
    });
