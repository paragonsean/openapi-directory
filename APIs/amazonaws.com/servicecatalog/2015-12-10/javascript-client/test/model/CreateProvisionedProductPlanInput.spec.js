...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreateProvisionedProductPlanInput();
  });
  ...
  describe('CreateProvisionedProductPlanInput', function() {
    it('should create an instance of CreateProvisionedProductPlanInput', function() {
      // uncomment below and update the code to test CreateProvisionedProductPlanInput
      //var instance = new AwsServiceCatalog.CreateProvisionedProductPlanInput();
      //expect(instance).to.be.a(AwsServiceCatalog.CreateProvisionedProductPlanInput);
    });
