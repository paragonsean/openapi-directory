...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ParameterConstraints();
  });
  ...
  describe('ParameterConstraints', function() {
    it('should create an instance of ParameterConstraints', function() {
      ...
      //var instance = new AwsServiceCatalog.ParameterConstraints();
      //expect(instance).to.be.a(AwsServiceCatalog.ParameterConstraints);
    });
