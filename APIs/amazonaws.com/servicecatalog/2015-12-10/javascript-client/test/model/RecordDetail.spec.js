...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.RecordDetail();
  });
  ...
  describe('RecordDetail', function() {
    it('should create an instance of RecordDetail', function() {
      // uncomment below and update the code to test RecordDetail
      //var instance = new AwsServiceCatalog.RecordDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.RecordDetail);
    });
