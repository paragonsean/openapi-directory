...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreateConstraintInput();
  });
  ...
  describe('CreateConstraintInput', function() {
    it('should create an instance of CreateConstraintInput', function() {
      // uncomment below and update the code to test CreateConstraintInput
      //var instance = new AwsServiceCatalog.CreateConstraintInput();
      //expect(instance).to.be.a(AwsServiceCatalog.CreateConstraintInput);
    });
