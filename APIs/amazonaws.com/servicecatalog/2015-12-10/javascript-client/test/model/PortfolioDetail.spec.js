...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.PortfolioDetail();
  });
  ...
  describe('PortfolioDetail', function() {
    it('should create an instance of PortfolioDetail', function() {
      ...
      //var instance = new AwsServiceCatalog.PortfolioDetail();
      //expect(instance).to.be.a(AwsServiceCatalog.PortfolioDetail);
    });
