...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListTagOptionsInput();
  });
  ...
  describe('ListTagOptionsInput', function() {
    it('should create an instance of ListTagOptionsInput', function() {
      // uncomment below and update the code to test ListTagOptionsInput
      //var instance = new AwsServiceCatalog.ListTagOptionsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListTagOptionsInput);
    });
