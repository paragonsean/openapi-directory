...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails();
  });
  ...
  describe('DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails', function() {
    it('should create an instance of DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails', function() {
      // uncomment below and update the code to test DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails
      //var instance = new AwsServiceCatalog.DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails();
      //expect(instance).to.be.a(AwsServiceCatalog.DescribeProvisionedProductPlanOutputProvisionedProductPlanDetails);
    });
