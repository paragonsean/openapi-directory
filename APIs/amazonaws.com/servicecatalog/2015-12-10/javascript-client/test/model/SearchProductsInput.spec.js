...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.SearchProductsInput();
  });
  ...
  describe('SearchProductsInput', function() {
    it('should create an instance of SearchProductsInput', function() {
      // uncomment below and update the code to test SearchProductsInput
      //var instance = new AwsServiceCatalog.SearchProductsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.SearchProductsInput);
    });
