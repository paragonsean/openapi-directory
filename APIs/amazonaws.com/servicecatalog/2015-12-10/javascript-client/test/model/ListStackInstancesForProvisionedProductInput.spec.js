...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.ListStackInstancesForProvisionedProductInput();
  });
  ...
  describe('ListStackInstancesForProvisionedProductInput', function() {
    it('should create an instance of ListStackInstancesForProvisionedProductInput', function() {
      // uncomment below and update the code to test ListStackInstancesForProvisionedProductInput
      //var instance = new AwsServiceCatalog.ListStackInstancesForProvisionedProductInput();
      //expect(instance).to.be.a(AwsServiceCatalog.ListStackInstancesForProvisionedProductInput);
    });
