...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.GetProvisionedProductOutputsInput();
  });
  ...
  describe('GetProvisionedProductOutputsInput', function() {
    it('should create an instance of GetProvisionedProductOutputsInput', function() {
      // uncomment below and update the code to test GetProvisionedProductOutputsInput
      //var instance = new AwsServiceCatalog.GetProvisionedProductOutputsInput();
      //expect(instance).to.be.a(AwsServiceCatalog.GetProvisionedProductOutputsInput);
    });
    ...
    it('should have the property outputKeys (base name: "OutputKeys")', function() {
      // uncomment below and update the code to test the property outputKeys
      //var instance = new AwsServiceCatalog.GetProvisionedProductOutputsInput();
      //expect(instance).to.be();
    });
