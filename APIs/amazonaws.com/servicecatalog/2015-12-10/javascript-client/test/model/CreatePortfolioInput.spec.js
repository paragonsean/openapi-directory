...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServiceCatalog.CreatePortfolioInput();
  });
  ...
  describe('CreatePortfolioInput', function() {
    it('should create an instance of CreatePortfolioInput', function() {
      // uncomment below and update the code to test CreatePortfolioInput
      //var instance = new AwsServiceCatalog.CreatePortfolioInput();
      //expect(instance).to.be.a(AwsServiceCatalog.CreatePortfolioInput);
    });
