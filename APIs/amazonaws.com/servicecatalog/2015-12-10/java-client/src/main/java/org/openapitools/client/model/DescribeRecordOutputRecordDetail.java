...
public class DescribeRecordOutputRecordDetail {
  ...
  public DescribeRecordOutputRecordDetail() {
  }

  public DescribeRecordOutputRecordDetail recordId(String recordId) {
  ...
  public DescribeRecordOutputRecordDetail provisionedProductName(String provisionedProductName) {
  ...
  public DescribeRecordOutputRecordDetail status(RecordStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeRecordOutputRecordDetail createdTime(OffsetDateTime createdTime) {
  ...
  public DescribeRecordOutputRecordDetail updatedTime(OffsetDateTime updatedTime) {
  ...
  public DescribeRecordOutputRecordDetail provisionedProductType(String provisionedProductType) {
  ...
  public DescribeRecordOutputRecordDetail recordType(String recordType) {
  ...
  public DescribeRecordOutputRecordDetail provisionedProductId(String provisionedProductId) {
  ...
  public DescribeRecordOutputRecordDetail productId(String productId) {
  ...
  public DescribeRecordOutputRecordDetail provisioningArtifactId(String provisioningArtifactId) {
  ...
  public DescribeRecordOutputRecordDetail pathId(String pathId) {
    this.pathId = pathId;
    return this;
  }
  ...
  public DescribeRecordOutputRecordDetail recordErrors(List recordErrors) {
  ...
  public DescribeRecordOutputRecordDetail recordTags(List recordTags) {
  ...
  public DescribeRecordOutputRecordDetail launchRoleArn(String launchRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeRecordOutputRecordDetail describeRecordOutputRecordDetail = (DescribeRecordOutputRecordDetail) o;
    return Objects.equals(this.recordId, describeRecordOutputRecordDetail.recordId) &&
        Objects.equals(this.provisionedProductName, describeRecordOutputRecordDetail.provisionedProductName) &&
        Objects.equals(this.status, describeRecordOutputRecordDetail.status) &&
        Objects.equals(this.createdTime, describeRecordOutputRecordDetail.createdTime) &&
        Objects.equals(this.updatedTime, describeRecordOutputRecordDetail.updatedTime) &&
        Objects.equals(this.provisionedProductType, describeRecordOutputRecordDetail.provisionedProductType) &&
        Objects.equals(this.recordType, describeRecordOutputRecordDetail.recordType) &&
        Objects.equals(this.provisionedProductId, describeRecordOutputRecordDetail.provisionedProductId) &&
        Objects.equals(this.productId, describeRecordOutputRecordDetail.productId) &&
        Objects.equals(this.provisioningArtifactId, describeRecordOutputRecordDetail.provisioningArtifactId) &&
        Objects.equals(this.pathId, describeRecordOutputRecordDetail.pathId) &&
        Objects.equals(this.recordErrors, describeRecordOutputRecordDetail.recordErrors) &&
        Objects.equals(this.recordTags, describeRecordOutputRecordDetail.recordTags) &&
        Objects.equals(this.launchRoleArn, describeRecordOutputRecordDetail.launchRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeRecordOutputRecordDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRecordOutputRecordDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRecordOutputRecordDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRecordOutputRecordDetail is not found in the empty JSON string", DescribeRecordOutputRecordDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRecordOutputRecordDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRecordOutputRecordDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRecordOutputRecordDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRecordOutputRecordDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRecordOutputRecordDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRecordOutputRecordDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRecordOutputRecordDetail>() {
           @Override
           public void write(JsonWriter out, DescribeRecordOutputRecordDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRecordOutputRecordDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRecordOutputRecordDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRecordOutputRecordDetail
   * @throws IOException if the JSON string is invalid with respect to DescribeRecordOutputRecordDetail
   */
  public static DescribeRecordOutputRecordDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRecordOutputRecordDetail.class);
  }

  /**
   * Convert an instance of DescribeRecordOutputRecordDetail to an JSON string
   *
   * @return JSON string
   */
