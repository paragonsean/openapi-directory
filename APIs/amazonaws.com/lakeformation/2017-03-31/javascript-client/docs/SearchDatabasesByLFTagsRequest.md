# AwsLakeFormation.SearchDatabasesByLFTagsRequest
...
**expression** | [**[LFTag]**](LFTag.md) | A list of conditions (&lt;code&gt;LFTag&lt;/code&gt; structures) to search for in database resources. | 
