# AwsLakeFormation.AssumeDecoratedRoleWithSAMLRequest
...
**durationSeconds** | **Number** | The time period, between 900 and 43,200 seconds, for the timeout of the temporary credentials. | [optional] 
