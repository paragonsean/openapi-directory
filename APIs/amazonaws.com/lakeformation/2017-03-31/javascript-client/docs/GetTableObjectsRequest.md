# AwsLakeFormation.GetTableObjectsRequest
...
**queryAsOfTime** | **Date** | The time as of when to read the governed table contents. If not set, the most recent transaction commit time is used. Cannot be specified along with &lt;code&gt;TransactionId&lt;/code&gt;. | [optional] 
...
**maxResults** | **Number** | Specifies how many values to return in a page. | [optional] 
