# AwsLakeFormation.BatchRevokePermissionsRequest
...
**entries** | [**[BatchPermissionsRequestEntry]**](BatchPermissionsRequestEntry.md) | A list of up to 20 entries for resource permissions to be revoked by batch operation to the principal. | 
