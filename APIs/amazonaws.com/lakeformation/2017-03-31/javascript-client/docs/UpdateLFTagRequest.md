# AwsLakeFormation.UpdateLFTagRequest
...
**tagValuesToDelete** | **[String]** | A list of LF-tag values to delete from the LF-tag. | [optional] 
**tagValuesToAdd** | **[String]** | A list of LF-tag values to add from the LF-tag. | [optional] 
