...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://lakeformation.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://lakeformation.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-03-31/Javascript'
        };
