...
/**
 * The GrantPermissionsRequestResource model module.
 * @module model/GrantPermissionsRequestResource
 * @version 2017-03-31
 */
class GrantPermissionsRequestResource {
    /**
     * Constructs a new <code>GrantPermissionsRequestResource</code>.
     * @alias module:model/GrantPermissionsRequestResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        GrantPermissionsRequestResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GrantPermissionsRequestResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GrantPermissionsRequestResource} obj Optional instance to populate.
     * @return {module:model/GrantPermissionsRequestResource} The populated <code>GrantPermissionsRequestResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GrantPermissionsRequestResource();
    ...
    /**
     * Validates the JSON data with respect to <code>GrantPermissionsRequestResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GrantPermissionsRequestResource</code>.
     */
...
export default GrantPermissionsRequestResource;
