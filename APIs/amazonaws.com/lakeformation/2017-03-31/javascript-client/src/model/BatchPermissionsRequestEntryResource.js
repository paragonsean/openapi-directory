...
/**
 * The BatchPermissionsRequestEntryResource model module.
 * @module model/BatchPermissionsRequestEntryResource
 * @version 2017-03-31
 */
class BatchPermissionsRequestEntryResource {
    /**
     * Constructs a new <code>BatchPermissionsRequestEntryResource</code>.
     * @alias module:model/BatchPermissionsRequestEntryResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        BatchPermissionsRequestEntryResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchPermissionsRequestEntryResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchPermissionsRequestEntryResource} obj Optional instance to populate.
     * @return {module:model/BatchPermissionsRequestEntryResource} The populated <code>BatchPermissionsRequestEntryResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchPermissionsRequestEntryResource();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchPermissionsRequestEntryResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchPermissionsRequestEntryResource</code>.
     */
 ...
 */
BatchPermissionsRequestEntryResource.prototype['Catalog'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDatabase} Database
 */
BatchPermissionsRequestEntryResource.prototype['Database'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTable} Table
 */
BatchPermissionsRequestEntryResource.prototype['Table'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTableWithColumns} TableWithColumns
 */
BatchPermissionsRequestEntryResource.prototype['TableWithColumns'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataLocation} DataLocation
 */
BatchPermissionsRequestEntryResource.prototype['DataLocation'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataCellsFilter} DataCellsFilter
 */
BatchPermissionsRequestEntryResource.prototype['DataCellsFilter'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTag} LFTag
 */
BatchPermissionsRequestEntryResource.prototype['LFTag'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTagPolicy} LFTagPolicy
 */
BatchPermissionsRequestEntryResource.prototype['LFTagPolicy'] = undefined;
...
export default BatchPermissionsRequestEntryResource;
