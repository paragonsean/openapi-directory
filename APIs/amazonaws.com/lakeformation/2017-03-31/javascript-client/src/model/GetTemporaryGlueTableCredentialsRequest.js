...
/**
 * The GetTemporaryGlueTableCredentialsRequest model module.
 * @module model/GetTemporaryGlueTableCredentialsRequest
 * @version 2017-03-31
 */
class GetTemporaryGlueTableCredentialsRequest {
    /**
     * Constructs a new <code>GetTemporaryGlueTableCredentialsRequest</code>.
     * @alias module:model/GetTemporaryGlueTableCredentialsRequest
     * @param tableArn {String} The ARN identifying a table in the Data Catalog for the temporary credentials request.
     */
    constructor(tableArn) { 
        
        GetTemporaryGlueTableCredentialsRequest.initialize(this, tableArn);
    }
     ...
     */
    static initialize(obj, tableArn) { 
        obj['TableArn'] = tableArn;
    }

    /**
     * Constructs a <code>GetTemporaryGlueTableCredentialsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemporaryGlueTableCredentialsRequest} obj Optional instance to populate.
     * @return {module:model/GetTemporaryGlueTableCredentialsRequest} The populated <code>GetTemporaryGlueTableCredentialsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemporaryGlueTableCredentialsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemporaryGlueTableCredentialsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemporaryGlueTableCredentialsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTemporaryGlueTableCredentialsRequest.RequiredProperties) {
...
GetTemporaryGlueTableCredentialsRequest.RequiredProperties = ["TableArn"];

/**
 * The ARN identifying a table in the Data Catalog for the temporary credentials request.
 * @member {String} TableArn
 */
GetTemporaryGlueTableCredentialsRequest.prototype['TableArn'] = undefined;

/**
 * Filters the request based on the user having been granted a list of specified permissions on the requested resource(s).
 * @member {Array.<module:model/Permission>} Permissions
 */
GetTemporaryGlueTableCredentialsRequest.prototype['Permissions'] = undefined;

/**
 * The time period, between 900 and 21,600 seconds, for the timeout of the temporary credentials.
 * @member {Number} DurationSeconds
 */
GetTemporaryGlueTableCredentialsRequest.prototype['DurationSeconds'] = undefined;

/**
 * @member {module:model/GetTemporaryGluePartitionCredentialsRequestAuditContext} AuditContext
 */
GetTemporaryGlueTableCredentialsRequest.prototype['AuditContext'] = undefined;
 ...
 */
GetTemporaryGlueTableCredentialsRequest.prototype['SupportedPermissionTypes'] = undefined;
...
export default GetTemporaryGlueTableCredentialsRequest;
