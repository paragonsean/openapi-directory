...
/**
 * The RemoveLFTagsFromResourceRequestResource model module.
 * @module model/RemoveLFTagsFromResourceRequestResource
 * @version 2017-03-31
 */
class RemoveLFTagsFromResourceRequestResource {
    /**
     * Constructs a new <code>RemoveLFTagsFromResourceRequestResource</code>.
     * @alias module:model/RemoveLFTagsFromResourceRequestResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        RemoveLFTagsFromResourceRequestResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveLFTagsFromResourceRequestResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveLFTagsFromResourceRequestResource} obj Optional instance to populate.
     * @return {module:model/RemoveLFTagsFromResourceRequestResource} The populated <code>RemoveLFTagsFromResourceRequestResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveLFTagsFromResourceRequestResource();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveLFTagsFromResourceRequestResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveLFTagsFromResourceRequestResource</code>.
     */
 ...
 */
RemoveLFTagsFromResourceRequestResource.prototype['Catalog'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDatabase} Database
 */
RemoveLFTagsFromResourceRequestResource.prototype['Database'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTable} Table
 */
RemoveLFTagsFromResourceRequestResource.prototype['Table'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTableWithColumns} TableWithColumns
 */
RemoveLFTagsFromResourceRequestResource.prototype['TableWithColumns'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataLocation} DataLocation
 */
RemoveLFTagsFromResourceRequestResource.prototype['DataLocation'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataCellsFilter} DataCellsFilter
 */
RemoveLFTagsFromResourceRequestResource.prototype['DataCellsFilter'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTag} LFTag
 */
RemoveLFTagsFromResourceRequestResource.prototype['LFTag'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTagPolicy} LFTagPolicy
 */
RemoveLFTagsFromResourceRequestResource.prototype['LFTagPolicy'] = undefined;
...
export default RemoveLFTagsFromResourceRequestResource;
