...
/**
 * The GetResourceLFTagsRequestResource model module.
 * @module model/GetResourceLFTagsRequestResource
 * @version 2017-03-31
 */
class GetResourceLFTagsRequestResource {
    /**
     * Constructs a new <code>GetResourceLFTagsRequestResource</code>.
     * @alias module:model/GetResourceLFTagsRequestResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        GetResourceLFTagsRequestResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetResourceLFTagsRequestResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetResourceLFTagsRequestResource} obj Optional instance to populate.
     * @return {module:model/GetResourceLFTagsRequestResource} The populated <code>GetResourceLFTagsRequestResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetResourceLFTagsRequestResource();
    ...
    /**
     * Validates the JSON data with respect to <code>GetResourceLFTagsRequestResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetResourceLFTagsRequestResource</code>.
     */
...
export default GetResourceLFTagsRequestResource;
