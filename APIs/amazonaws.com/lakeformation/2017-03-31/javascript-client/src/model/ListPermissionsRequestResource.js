...
/**
 * The ListPermissionsRequestResource model module.
 * @module model/ListPermissionsRequestResource
 * @version 2017-03-31
 */
class ListPermissionsRequestResource {
    /**
     * Constructs a new <code>ListPermissionsRequestResource</code>.
     * @alias module:model/ListPermissionsRequestResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        ListPermissionsRequestResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPermissionsRequestResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPermissionsRequestResource} obj Optional instance to populate.
     * @return {module:model/ListPermissionsRequestResource} The populated <code>ListPermissionsRequestResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPermissionsRequestResource();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPermissionsRequestResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPermissionsRequestResource</code>.
     */
...
export default ListPermissionsRequestResource;
