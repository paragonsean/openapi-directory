...
/**
 * The PrincipalResourcePermissionsResource model module.
 * @module model/PrincipalResourcePermissionsResource
 * @version 2017-03-31
 */
class PrincipalResourcePermissionsResource {
    /**
     * Constructs a new <code>PrincipalResourcePermissionsResource</code>.
     * @alias module:model/PrincipalResourcePermissionsResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        PrincipalResourcePermissionsResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PrincipalResourcePermissionsResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrincipalResourcePermissionsResource} obj Optional instance to populate.
     * @return {module:model/PrincipalResourcePermissionsResource} The populated <code>PrincipalResourcePermissionsResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrincipalResourcePermissionsResource();
    ...
    /**
     * Validates the JSON data with respect to <code>PrincipalResourcePermissionsResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrincipalResourcePermissionsResource</code>.
     */
 ...
 */
PrincipalResourcePermissionsResource.prototype['Catalog'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDatabase} Database
 */
PrincipalResourcePermissionsResource.prototype['Database'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTable} Table
 */
PrincipalResourcePermissionsResource.prototype['Table'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceTableWithColumns} TableWithColumns
 */
PrincipalResourcePermissionsResource.prototype['TableWithColumns'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataLocation} DataLocation
 */
PrincipalResourcePermissionsResource.prototype['DataLocation'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceDataCellsFilter} DataCellsFilter
 */
PrincipalResourcePermissionsResource.prototype['DataCellsFilter'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTag} LFTag
 */
PrincipalResourcePermissionsResource.prototype['LFTag'] = undefined;

/**
 * @member {module:model/AddLFTagsToResourceRequestResourceLFTagPolicy} LFTagPolicy
 */
PrincipalResourcePermissionsResource.prototype['LFTagPolicy'] = undefined;
...
export default PrincipalResourcePermissionsResource;
