...
/**
 * The RevokePermissionsRequestResource model module.
 * @module model/RevokePermissionsRequestResource
 * @version 2017-03-31
 */
class RevokePermissionsRequestResource {
    /**
     * Constructs a new <code>RevokePermissionsRequestResource</code>.
     * @alias module:model/RevokePermissionsRequestResource
     * @implements module:model/Resource
     */
    constructor() { 
        Resource.initialize(this);
        RevokePermissionsRequestResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RevokePermissionsRequestResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevokePermissionsRequestResource} obj Optional instance to populate.
     * @return {module:model/RevokePermissionsRequestResource} The populated <code>RevokePermissionsRequestResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevokePermissionsRequestResource();
    ...
    /**
     * Validates the JSON data with respect to <code>RevokePermissionsRequestResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevokePermissionsRequestResource</code>.
     */
...
export default RevokePermissionsRequestResource;
