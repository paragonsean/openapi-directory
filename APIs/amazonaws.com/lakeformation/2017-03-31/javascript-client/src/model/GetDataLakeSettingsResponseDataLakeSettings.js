...
/**
 * The GetDataLakeSettingsResponseDataLakeSettings model module.
 * @module model/GetDataLakeSettingsResponseDataLakeSettings
 * @version 2017-03-31
 */
class GetDataLakeSettingsResponseDataLakeSettings {
    /**
     * Constructs a new <code>GetDataLakeSettingsResponseDataLakeSettings</code>.
     * @alias module:model/GetDataLakeSettingsResponseDataLakeSettings
     * @implements module:model/DataLakeSettings
     */
    constructor() { 
        DataLakeSettings.initialize(this);
        GetDataLakeSettingsResponseDataLakeSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDataLakeSettingsResponseDataLakeSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDataLakeSettingsResponseDataLakeSettings} obj Optional instance to populate.
     * @return {module:model/GetDataLakeSettingsResponseDataLakeSettings} The populated <code>GetDataLakeSettingsResponseDataLakeSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDataLakeSettingsResponseDataLakeSettings();
            DataLakeSettings.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetDataLakeSettingsResponseDataLakeSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDataLakeSettingsResponseDataLakeSettings</code>.
     */
 ...
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['DataLakeAdmins'] = undefined;

/**
 * @member {Array} ReadOnlyAdmins
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['ReadOnlyAdmins'] = undefined;

/**
 * @member {Array} CreateDatabaseDefaultPermissions
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['CreateDatabaseDefaultPermissions'] = undefined;

/**
 * @member {Array} CreateTableDefaultPermissions
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['CreateTableDefaultPermissions'] = undefined;

/**
 * @member {Object} Parameters
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['Parameters'] = undefined;

/**
 * @member {Array} TrustedResourceOwners
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['TrustedResourceOwners'] = undefined;

/**
 * @member {Boolean} AllowExternalDataFiltering
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['AllowExternalDataFiltering'] = undefined;

/**
 * @member {Boolean} AllowFullTableExternalDataAccess
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['AllowFullTableExternalDataAccess'] = undefined;

/**
 * @member {Array} ExternalDataFilteringAllowList
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['ExternalDataFilteringAllowList'] = undefined;

/**
 * @member {Array} AuthorizedSessionTagValueList
 */
GetDataLakeSettingsResponseDataLakeSettings.prototype['AuthorizedSessionTagValueList'] = undefined;


// Implement DataLakeSettings interface:
/**
 * @member {Array} DataLakeAdmins
 */
...
export default GetDataLakeSettingsResponseDataLakeSettings;
