...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.ListTransactionsRequest();
  });
  ...
  describe('ListTransactionsRequest', function() {
    it('should create an instance of ListTransactionsRequest', function() {
      ...
      //var instance = new AwsLakeFormation.ListTransactionsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.ListTransactionsRequest);
    });
