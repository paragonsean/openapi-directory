...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.GetEffectivePermissionsForPathRequest();
  });
  ...
  describe('GetEffectivePermissionsForPathRequest', function() {
    it('should create an instance of GetEffectivePermissionsForPathRequest', function() {
      // uncomment below and update the code to test GetEffectivePermissionsForPathRequest
      //var instance = new AwsLakeFormation.GetEffectivePermissionsForPathRequest();
      //expect(instance).to.be.a(AwsLakeFormation.GetEffectivePermissionsForPathRequest);
    });
