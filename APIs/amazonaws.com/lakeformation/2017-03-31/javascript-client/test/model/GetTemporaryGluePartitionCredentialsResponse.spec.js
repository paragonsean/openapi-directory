...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.GetTemporaryGluePartitionCredentialsResponse();
  });
  ...
  describe('GetTemporaryGluePartitionCredentialsResponse', function() {
    it('should create an instance of GetTemporaryGluePartitionCredentialsResponse', function() {
      // uncomment below and update the code to test GetTemporaryGluePartitionCredentialsResponse
      //var instance = new AwsLakeFormation.GetTemporaryGluePartitionCredentialsResponse();
      //expect(instance).to.be.a(AwsLakeFormation.GetTemporaryGluePartitionCredentialsResponse);
    });
