...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.SearchDatabasesByLFTagsRequest();
  });
  ...
  describe('SearchDatabasesByLFTagsRequest', function() {
    it('should create an instance of SearchDatabasesByLFTagsRequest', function() {
      // uncomment below and update the code to test SearchDatabasesByLFTagsRequest
      //var instance = new AwsLakeFormation.SearchDatabasesByLFTagsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.SearchDatabasesByLFTagsRequest);
    });
