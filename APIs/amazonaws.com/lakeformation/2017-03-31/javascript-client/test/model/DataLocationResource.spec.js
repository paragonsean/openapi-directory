...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.DataLocationResource();
  });
  ...
  describe('DataLocationResource', function() {
    it('should create an instance of DataLocationResource', function() {
      // uncomment below and update the code to test DataLocationResource
      //var instance = new AwsLakeFormation.DataLocationResource();
      //expect(instance).to.be.a(AwsLakeFormation.DataLocationResource);
    });
