...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.LFTagPolicyResource();
  });
  ...
  describe('LFTagPolicyResource', function() {
    it('should create an instance of LFTagPolicyResource', function() {
      // uncomment below and update the code to test LFTagPolicyResource
      //var instance = new AwsLakeFormation.LFTagPolicyResource();
      //expect(instance).to.be.a(AwsLakeFormation.LFTagPolicyResource);
    });
