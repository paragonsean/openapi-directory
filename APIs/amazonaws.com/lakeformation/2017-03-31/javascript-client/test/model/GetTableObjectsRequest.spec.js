...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.GetTableObjectsRequest();
  });
  ...
  describe('GetTableObjectsRequest', function() {
    it('should create an instance of GetTableObjectsRequest', function() {
      // uncomment below and update the code to test GetTableObjectsRequest
      //var instance = new AwsLakeFormation.GetTableObjectsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.GetTableObjectsRequest);
    });
    ...
    it('should have the property queryAsOfTime (base name: "QueryAsOfTime")', function() {
      // uncomment below and update the code to test the property queryAsOfTime
      //var instance = new AwsLakeFormation.GetTableObjectsRequest();
      //expect(instance).to.be();
    });

    it('should have the property partitionPredicate (base name: "PartitionPredicate")', function() {
      // uncomment below and update the code to test the property partitionPredicate
      //var instance = new AwsLakeFormation.GetTableObjectsRequest();
      //expect(instance).to.be();
    });
