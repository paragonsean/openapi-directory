...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.AssumeDecoratedRoleWithSAMLResponse();
  });
  ...
  describe('AssumeDecoratedRoleWithSAMLResponse', function() {
    it('should create an instance of AssumeDecoratedRoleWithSAMLResponse', function() {
      // uncomment below and update the code to test AssumeDecoratedRoleWithSAMLResponse
      //var instance = new AwsLakeFormation.AssumeDecoratedRoleWithSAMLResponse();
      //expect(instance).to.be.a(AwsLakeFormation.AssumeDecoratedRoleWithSAMLResponse);
    });
