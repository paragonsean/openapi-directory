...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.DeleteObjectsOnCancelRequest();
  });
  ...
  describe('DeleteObjectsOnCancelRequest', function() {
    it('should create an instance of DeleteObjectsOnCancelRequest', function() {
      // uncomment below and update the code to test DeleteObjectsOnCancelRequest
      //var instance = new AwsLakeFormation.DeleteObjectsOnCancelRequest();
      //expect(instance).to.be.a(AwsLakeFormation.DeleteObjectsOnCancelRequest);
    });
