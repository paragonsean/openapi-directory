...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.ListTableStorageOptimizersRequest();
  });
  ...
  describe('ListTableStorageOptimizersRequest', function() {
    it('should create an instance of ListTableStorageOptimizersRequest', function() {
      // uncomment below and update the code to test ListTableStorageOptimizersRequest
      //var instance = new AwsLakeFormation.ListTableStorageOptimizersRequest();
      //expect(instance).to.be.a(AwsLakeFormation.ListTableStorageOptimizersRequest);
    });
    ...
    it('should have the property storageOptimizerType (base name: "StorageOptimizerType")', function() {
      // uncomment below and update the code to test the property storageOptimizerType
      //var instance = new AwsLakeFormation.ListTableStorageOptimizersRequest();
      //expect(instance).to.be();
    });
