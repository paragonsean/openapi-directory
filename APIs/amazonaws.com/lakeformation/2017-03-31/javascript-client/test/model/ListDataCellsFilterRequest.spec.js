...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.ListDataCellsFilterRequest();
  });
  ...
  describe('ListDataCellsFilterRequest', function() {
    it('should create an instance of ListDataCellsFilterRequest', function() {
      // uncomment below and update the code to test ListDataCellsFilterRequest
      //var instance = new AwsLakeFormation.ListDataCellsFilterRequest();
      //expect(instance).to.be.a(AwsLakeFormation.ListDataCellsFilterRequest);
    });
