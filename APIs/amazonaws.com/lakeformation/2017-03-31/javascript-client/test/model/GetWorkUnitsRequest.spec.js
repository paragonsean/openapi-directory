...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.GetWorkUnitsRequest();
  });
  ...
  describe('GetWorkUnitsRequest', function() {
    it('should create an instance of GetWorkUnitsRequest', function() {
      // uncomment below and update the code to test GetWorkUnitsRequest
      //var instance = new AwsLakeFormation.GetWorkUnitsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.GetWorkUnitsRequest);
    });
