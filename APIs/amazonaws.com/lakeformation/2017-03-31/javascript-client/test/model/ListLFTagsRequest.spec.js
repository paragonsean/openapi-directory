...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.ListLFTagsRequest();
  });
  ...
  describe('ListLFTagsRequest', function() {
    it('should create an instance of ListLFTagsRequest', function() {
      // uncomment below and update the code to test ListLFTagsRequest
      //var instance = new AwsLakeFormation.ListLFTagsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.ListLFTagsRequest);
    });
    ...
    it('should have the property resourceShareType (base name: "ResourceShareType")', function() {
      // uncomment below and update the code to test the property resourceShareType
      //var instance = new AwsLakeFormation.ListLFTagsRequest();
      //expect(instance).to.be();
    });
