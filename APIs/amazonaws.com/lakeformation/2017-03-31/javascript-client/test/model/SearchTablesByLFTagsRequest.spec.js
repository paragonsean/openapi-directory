...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLakeFormation.SearchTablesByLFTagsRequest();
  });
  ...
  describe('SearchTablesByLFTagsRequest', function() {
    it('should create an instance of SearchTablesByLFTagsRequest', function() {
      // uncomment below and update the code to test SearchTablesByLFTagsRequest
      //var instance = new AwsLakeFormation.SearchTablesByLFTagsRequest();
      //expect(instance).to.be.a(AwsLakeFormation.SearchTablesByLFTagsRequest);
    });
