...
class RemoveLFTagsFromResourceRequest(Model):
    ...
    def __init__(self, catalog_id: str=None, resource: AddLFTagsToResourceRequestResource=None, lf_tags: List[LFTagPair]=None):
        """RemoveLFTagsFromResourceRequest - a model defined in OpenAPI

        :param catalog_id: The catalog_id of this RemoveLFTagsFromResourceRequest.
        :param resource: The resource of this RemoveLFTagsFromResourceRequest.
        :param lf_tags: The lf_tags of this RemoveLFTagsFromResourceRequest.
        """
        self.openapi_types = {
            'catalog_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RemoveLFTagsFromResourceRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RemoveLFTagsFromResource_request of this RemoveLFTagsFromResourceRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def catalog_id(self):
        """Gets the catalog_id of this RemoveLFTagsFromResourceRequest.

        The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. 

        :return: The catalog_id of this RemoveLFTagsFromResourceRequest.
        :rtype: str
        """
    ...
    def catalog_id(self, catalog_id):
        """Sets the catalog_id of this RemoveLFTagsFromResourceRequest.
    ...
    @property
    def resource(self):
        """Gets the resource of this RemoveLFTagsFromResourceRequest.


        :return: The resource of this RemoveLFTagsFromResourceRequest.
    ...
    def resource(self, resource):
        """Sets the resource of this RemoveLFTagsFromResourceRequest.
    ...
    @property
    def lf_tags(self):
        """Gets the lf_tags of this RemoveLFTagsFromResourceRequest.

        The LF-tags to be removed from the resource.

        :return: The lf_tags of this RemoveLFTagsFromResourceRequest.
    ...
    def lf_tags(self, lf_tags):
        """Sets the lf_tags of this RemoveLFTagsFromResourceRequest.
