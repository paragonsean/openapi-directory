...
async def test_add_lf_tags_to_resource(client):
    """Test case for add_lf_tags_to_resource

    
    """
    body = {"LFTags":"","Resource":{"LFTag":{"TagKey":"","CatalogId":"","TagValues":""},"Table":{"DatabaseName":"","CatalogId":"","TableWildcard":"","Name":""},"DataCellsFilter":{"TableName":"","DatabaseName":"","TableCatalogId":"","Name":""},"TableWithColumns":{"ColumnNames":"","DatabaseName":"","CatalogId":"","Name":"","ColumnWildcard":{"ExcludedColumnNames":""}},"LFTagPolicy":{"Expression":"","ResourceType":"","CatalogId":""},"Database":{"CatalogId":"","Name":""},"DataLocation":{"ResourceArn":"","CatalogId":""},"Catalog":""},"CatalogId":""}
    headers = { 
...
async def test_assume_decorated_role_with_saml(client):
    """Test case for assume_decorated_role_with_saml

    
    """
    body = {"SAMLAssertion":"","PrincipalArn":"","DurationSeconds":"","RoleArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_grant_permissions(client):
    """Test case for batch_grant_permissions

    
    """
    body = {"Entries":"","CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_batch_revoke_permissions(client):
    """Test case for batch_revoke_permissions
...
async def test_commit_transaction(client):
...
async def test_create_data_cells_filter(client):
    """Test case for create_data_cells_filter

    
    """
    body = {"TableData":{"VersionId":"","TableName":"","ColumnNames":"","RowFilter":{"AllRowsWildcard":"","FilterExpression":""},"DatabaseName":"","TableCatalogId":"","Name":"","ColumnWildcard":{"ExcludedColumnNames":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_lf_tag(client):
    """Test case for create_lf_tag

    
    """
    body = {"TagKey":"","CatalogId":"","TagValues":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_data_cells_filter(client):
    """Test case for delete_data_cells_filter

    
    """
    body = {"TableName":"","DatabaseName":"","TableCatalogId":"","Name":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_lf_tag(client):
    """Test case for delete_lf_tag

    
    """
    body = {"TagKey":"","CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_objects_on_cancel(client):
    """Test case for delete_objects_on_cancel

    
    """
    body = {"TableName":"","DatabaseName":"","Objects":"","CatalogId":"","TransactionId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_deregister_resource(client):
    """Test case for deregister_resource
...
async def test_describe_resource(client):
...
async def test_describe_transaction(client):
...
async def test_extend_transaction(client):
    """Test case for extend_transaction
...
async def test_get_data_cells_filter(client):
    """Test case for get_data_cells_filter
...
async def test_get_data_lake_settings(client):
    """Test case for get_data_lake_settings
...
async def test_get_effective_permissions_for_path(client):
    """Test case for get_effective_permissions_for_path

    
    """
    body = {"ResourceArn":"","NextToken":"","MaxResults":"","CatalogId":""}
...
async def test_get_lf_tag(client):
    """Test case for get_lf_tag
...
async def test_get_query_state(client):
    """Test case for get_query_state
...
async def test_get_query_statistics(client):
    """Test case for get_query_statistics
...
async def test_get_resource_lf_tags(client):
    """Test case for get_resource_lf_tags

    
    """
    body = {"ShowAssignedLFTags":"","Resource":{"LFTag":{"TagKey":"","CatalogId":"","TagValues":""},"Table":{"DatabaseName":"","CatalogId":"","TableWildcard":"","Name":""},"DataCellsFilter":{"TableName":"","DatabaseName":"","TableCatalogId":"","Name":""},"TableWithColumns":{"ColumnNames":"","DatabaseName":"","CatalogId":"","Name":"","ColumnWildcard":{"ExcludedColumnNames":""}},"LFTagPolicy":{"Expression":"","ResourceType":"","CatalogId":""},"Database":{"CatalogId":"","Name":""},"DataLocation":{"ResourceArn":"","CatalogId":""},"Catalog":""},"CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_table_objects(client):
    """Test case for get_table_objects

    
    """
    body = {"TableName":"","QueryAsOfTime":"","PartitionPredicate":"","NextToken":"","MaxResults":"","DatabaseName":"","CatalogId":"","TransactionId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_get_temporary_glue_partition_credentials(client):
    """Test case for get_temporary_glue_partition_credentials

    
    """
    body = {"Partition":{"Values":""},"TableArn":"","Permissions":"","DurationSeconds":"","AuditContext":{"AdditionalAuditContext":""},"SupportedPermissionTypes":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_temporary_glue_table_credentials(client):
    """Test case for get_temporary_glue_table_credentials

    
    """
    body = {"TableArn":"","Permissions":"","DurationSeconds":"","AuditContext":{"AdditionalAuditContext":""},"SupportedPermissionTypes":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_work_unit_results(client):
    """Test case for get_work_unit_results

    
    """
    body = {"WorkUnitToken":"","QueryId":"","WorkUnitId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_work_units(client):
    """Test case for get_work_units

    
    """
    body = {"NextToken":"","PageSize":"","QueryId":""}
...
async def test_grant_permissions(client):
    ...
    """
    body = {"Resource":{"LFTag":{"TagKey":"","CatalogId":"","TagValues":""},"Table":{"DatabaseName":"","CatalogId":"","TableWildcard":"","Name":""},"DataCellsFilter":{"TableName":"","DatabaseName":"","TableCatalogId":"","Name":""},"TableWithColumns":{"ColumnNames":"","DatabaseName":"","CatalogId":"","Name":"","ColumnWildcard":{"ExcludedColumnNames":""}},"LFTagPolicy":{"Expression":"","ResourceType":"","CatalogId":""},"Database":{"CatalogId":"","Name":""},"DataLocation":{"ResourceArn":"","CatalogId":""},"Catalog":""},"Permissions":"","CatalogId":"","Principal":{"DataLakePrincipalIdentifier":""},"PermissionsWithGrantOption":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_data_cells_filter(client):
    """Test case for list_data_cells_filter

    
    """
    body = {"Table":{"DatabaseName":"","CatalogId":"","TableWildcard":"","Name":""},"NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_lf_tags(client):
    """Test case for list_lf_tags

    
    """
    body = {"ResourceShareType":"","NextToken":"","MaxResults":"","CatalogId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_permissions(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","IncludeRelated":"","Resource":{"LFTag":{"TagKey":"","CatalogId":"","TagValues":""},"Table":{"DatabaseName":"","CatalogId":"","TableWildcard":"","Name":""},"DataCellsFilter":{"TableName":"","DatabaseName":"","TableCatalogId":"","Name":""},"TableWithColumns":{"ColumnNames":"","DatabaseName":"","CatalogId":"","Name":"","ColumnWildcard":{"ExcludedColumnNames":""}},"LFTagPolicy":{"Expression":"","ResourceType":"","CatalogId":""},"Database":{"CatalogId":"","Name":""},"DataLocation":{"ResourceArn":"","CatalogId":""},"Catalog":""},"ResourceType":"","CatalogId":"","Principal":{"DataLakePrincipalIdentifier":""}}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_resources(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","FilterConditionList":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_table_storage_optimizers(client):
    """Test case for list_table_storage_optimizers

    
    """
    body = {"TableName":"","StorageOptimizerType":"","NextToken":"","MaxResults":"","DatabaseName":"","CatalogId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_transactions(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","StatusFilter":"","CatalogId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_put_data_lake_settings(client):
    """Test case for put_data_lake_settings

    
    """
    body = {"DataLakeSettings":{"AllowExternalDataFiltering":"","ExternalDataFilteringAllowList":"","CreateTableDefaultPermissions":"","Parameters":"","ReadOnlyAdmins":"","AllowFullTableExternalDataAccess":"","CreateDatabaseDefaultPermissions":"","AuthorizedSessionTagValueList":"","DataLakeAdmins":"","TrustedResourceOwners":""},"CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_register_resource(client):
    """Test case for register_resource

    
    """
    body = {"ResourceArn":"","WithFederation":"","UseServiceLinkedRole":"","RoleArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_remove_lf_tags_from_resource(client):
    """Test case for remove_lf_tags_from_resource
...
async def test_search_databases_by_lf_tags(client):
    """Test case for search_databases_by_lf_tags

    
    """
    body = {"NextToken":"","Expression":"","MaxResults":"","CatalogId":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_search_tables_by_lf_tags(client):
    """Test case for search_tables_by_lf_tags
...
async def test_start_query_planning(client):
    """Test case for start_query_planning

    
    """
    body = {"QueryPlanningContext":{"QueryAsOfTime":"","DatabaseName":"","QueryParameters":"","CatalogId":"","TransactionId":""},"QueryString":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_start_transaction(client):
...
async def test_update_data_cells_filter(client):
    """Test case for update_data_cells_filter
...
async def test_update_lf_tag(client):
    """Test case for update_lf_tag

    
    """
    body = {"TagValuesToAdd":"","TagValuesToDelete":"","TagKey":"","CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_resource(client):
    ...
    """
    body = {"ResourceArn":"","WithFederation":"","RoleArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_table_objects(client):
    """Test case for update_table_objects

    
    """
    body = {"TableName":"","WriteOperations":"","DatabaseName":"","CatalogId":"","TransactionId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_table_storage_optimizer(client):
    """Test case for update_table_storage_optimizer

    
    """
    body = {"TableName":"","StorageOptimizerConfig":"","DatabaseName":"","CatalogId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
