...
/*
 * OAIQueryPlanningContext.h
 *
 * A structure containing information about the query plan.
 */

#ifndef OAIQueryPlanningContext_H
#define OAIQueryPlanningContext_H
...
class OAIQueryPlanningContext : public OAIObject {
public:
    OAIQueryPlanningContext();
    OAIQueryPlanningContext(QString json);
    ~OAIQueryPlanningContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryPlanningContext)

#endif // OAIQueryPlanningContext_H
