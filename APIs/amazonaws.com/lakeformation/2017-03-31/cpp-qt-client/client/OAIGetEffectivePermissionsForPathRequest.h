...
/*
 * OAIGetEffectivePermissionsForPathRequest.h
 *
 * 
 */

#ifndef OAIGetEffectivePermissionsForPathRequest_H
#define OAIGetEffectivePermissionsForPathRequest_H
...
class OAIGetEffectivePermissionsForPathRequest : public OAIObject {
public:
    OAIGetEffectivePermissionsForPathRequest();
    OAIGetEffectivePermissionsForPathRequest(QString json);
    ~OAIGetEffectivePermissionsForPathRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEffectivePermissionsForPathRequest)

#endif // OAIGetEffectivePermissionsForPathRequest_H
