...
/*
 * OAIDeleteLFTagRequest.h
 *
 * 
 */

#ifndef OAIDeleteLFTagRequest_H
#define OAIDeleteLFTagRequest_H
...
class OAIDeleteLFTagRequest : public OAIObject {
public:
    OAIDeleteLFTagRequest();
    OAIDeleteLFTagRequest(QString json);
    ~OAIDeleteLFTagRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLFTagRequest)

#endif // OAIDeleteLFTagRequest_H
