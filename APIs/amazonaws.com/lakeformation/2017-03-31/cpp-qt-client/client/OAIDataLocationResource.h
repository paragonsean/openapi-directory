...
/*
 * OAIDataLocationResource.h
 *
 * A structure for a data location object where permissions are granted or revoked. 
 */

#ifndef OAIDataLocationResource_H
#define OAIDataLocationResource_H
...
class OAIDataLocationResource : public OAIObject {
public:
    OAIDataLocationResource();
    OAIDataLocationResource(QString json);
    ~OAIDataLocationResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLocationResource)

#endif // OAIDataLocationResource_H
