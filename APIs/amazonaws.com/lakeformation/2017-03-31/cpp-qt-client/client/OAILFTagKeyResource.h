...
/*
 * OAILFTagKeyResource.h
 *
 * A structure containing an LF-tag key and values for a resource.
 */

#ifndef OAILFTagKeyResource_H
#define OAILFTagKeyResource_H
...
class OAILFTagKeyResource : public OAIObject {
public:
    OAILFTagKeyResource();
    OAILFTagKeyResource(QString json);
    ~OAILFTagKeyResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFTagKeyResource)

#endif // OAILFTagKeyResource_H
