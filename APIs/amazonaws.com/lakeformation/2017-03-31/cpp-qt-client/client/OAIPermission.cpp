...
void OAIPermission::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("DESCRIBE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermission::DESCRIBE;
        m_value_isSet = m_value_isValid = true;
    }
    ...
    else if ( jsonString.compare("CREATE_LF_TAG", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermission::CREATE_LF_TAG;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ASSOCIATE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermission::ASSOCIATE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GRANT_WITH_LF_TAG_EXPRESSION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermission::GRANT_WITH_LF_TAG_EXPRESSION;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPermission::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIPermission::DATA_LOCATION_ACCESS:
            ...
            break;
        case eOAIPermission::CREATE_LF_TAG:
            val = "CREATE_LF_TAG";
            break;
        case eOAIPermission::ASSOCIATE:
            val = "ASSOCIATE";
            break;
        case eOAIPermission::GRANT_WITH_LF_TAG_EXPRESSION:
            val = "GRANT_WITH_LF_TAG_EXPRESSION";
            break;
        default:
            break;
    }
