...
/*
 * OAIGetLFTagResponse.h
 *
 * 
 */

#ifndef OAIGetLFTagResponse_H
#define OAIGetLFTagResponse_H
...
class OAIGetLFTagResponse : public OAIObject {
public:
    OAIGetLFTagResponse();
    OAIGetLFTagResponse(QString json);
    ~OAIGetLFTagResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLFTagResponse)

#endif // OAIGetLFTagResponse_H
