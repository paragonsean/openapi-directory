...
/*
 * OAIDeleteLFTag_request.h
 *
 * 
 */

#ifndef OAIDeleteLFTag_request_H
#define OAIDeleteLFTag_request_H
...
class OAIDeleteLFTag_request : public OAIObject {
public:
    OAIDeleteLFTag_request();
    OAIDeleteLFTag_request(QString json);
    ~OAIDeleteLFTag_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLFTag_request)

#endif // OAIDeleteLFTag_request_H
