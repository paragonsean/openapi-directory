...
/*
 * OAICreateLFTagRequest.h
 *
 * 
 */

#ifndef OAICreateLFTagRequest_H
#define OAICreateLFTagRequest_H
...
class OAICreateLFTagRequest : public OAIObject {
public:
    OAICreateLFTagRequest();
    OAICreateLFTagRequest(QString json);
    ~OAICreateLFTagRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLFTagRequest)

#endif // OAICreateLFTagRequest_H
