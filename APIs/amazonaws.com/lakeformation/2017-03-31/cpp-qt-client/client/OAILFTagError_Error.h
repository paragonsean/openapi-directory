...
/*
 * OAILFTagError_Error.h
 *
 * 
 */

#ifndef OAILFTagError_Error_H
#define OAILFTagError_Error_H
...
class OAILFTagError_Error : public OAIObject {
public:
    OAILFTagError_Error();
    OAILFTagError_Error(QString json);
    ~OAILFTagError_Error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFTagError_Error)

#endif // OAILFTagError_Error_H
