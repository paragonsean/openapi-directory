...
/*
 * OAIGetTableObjectsRequest.h
 *
 * 
 */

#ifndef OAIGetTableObjectsRequest_H
#define OAIGetTableObjectsRequest_H
...
class OAIGetTableObjectsRequest : public OAIObject {
public:
    OAIGetTableObjectsRequest();
    OAIGetTableObjectsRequest(QString json);
    ~OAIGetTableObjectsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTableObjectsRequest)

#endif // OAIGetTableObjectsRequest_H
