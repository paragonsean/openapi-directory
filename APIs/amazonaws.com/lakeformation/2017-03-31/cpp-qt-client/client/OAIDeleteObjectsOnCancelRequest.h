...
/*
 * OAIDeleteObjectsOnCancelRequest.h
 *
 * 
 */

#ifndef OAIDeleteObjectsOnCancelRequest_H
#define OAIDeleteObjectsOnCancelRequest_H
...
class OAIDeleteObjectsOnCancelRequest : public OAIObject {
public:
    OAIDeleteObjectsOnCancelRequest();
    OAIDeleteObjectsOnCancelRequest(QString json);
    ~OAIDeleteObjectsOnCancelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteObjectsOnCancelRequest)

#endif // OAIDeleteObjectsOnCancelRequest_H
