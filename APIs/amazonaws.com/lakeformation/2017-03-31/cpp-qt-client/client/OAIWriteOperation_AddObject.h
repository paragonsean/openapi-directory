...
/*
 * OAIWriteOperation_AddObject.h
 *
 * 
 */

#ifndef OAIWriteOperation_AddObject_H
#define OAIWriteOperation_AddObject_H
...
class OAIWriteOperation_AddObject : public OAIObject {
public:
    OAIWriteOperation_AddObject();
    OAIWriteOperation_AddObject(QString json);
    ~OAIWriteOperation_AddObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWriteOperation_AddObject)

#endif // OAIWriteOperation_AddObject_H
