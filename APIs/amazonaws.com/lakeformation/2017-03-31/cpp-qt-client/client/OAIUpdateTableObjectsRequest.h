...
/*
 * OAIUpdateTableObjectsRequest.h
 *
 * 
 */

#ifndef OAIUpdateTableObjectsRequest_H
#define OAIUpdateTableObjectsRequest_H
...
class OAIUpdateTableObjectsRequest : public OAIObject {
public:
    OAIUpdateTableObjectsRequest();
    OAIUpdateTableObjectsRequest(QString json);
    ~OAIUpdateTableObjectsRequest() override;
    ...
    QList getWriteOperations() const;
    void setWriteOperations(const QList &write_operations);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTableObjectsRequest)

#endif // OAIUpdateTableObjectsRequest_H
