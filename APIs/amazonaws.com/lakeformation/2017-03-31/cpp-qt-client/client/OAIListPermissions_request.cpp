...
QString OAIListPermissions_request::getCatalogId() const {
    return m_catalog_id;
}
void OAIListPermissions_request::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAIListPermissions_request::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAIListPermissions_request::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

OAIGrantPermissions_request_Principal OAIListPermissions_request::getPrincipal() const {
    return m_principal;
}
void OAIListPermissions_request::setPrincipal(const OAIGrantPermissions_request_Principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIListPermissions_request::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIListPermissions_request::is_principal_Valid() const{
...
OAIAddLFTagsToResource_request_Resource OAIListPermissions_request::getResource() const {
    return m_resource;
}
void OAIListPermissions_request::setResource(const OAIAddLFTagsToResource_request_Resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIListPermissions_request::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIListPermissions_request::is_resource_Valid() const{
...
QString OAIListPermissions_request::getIncludeRelated() const {
    return m_include_related;
}
void OAIListPermissions_request::setIncludeRelated(const QString &include_related) {
    m_include_related = include_related;
    m_include_related_isSet = true;
}

bool OAIListPermissions_request::is_include_related_Set() const{
    return m_include_related_isSet;
}

bool OAIListPermissions_request::is_include_related_Valid() const{
