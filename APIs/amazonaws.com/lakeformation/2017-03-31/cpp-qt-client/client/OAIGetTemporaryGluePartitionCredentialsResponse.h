...
/*
 * OAIGetTemporaryGluePartitionCredentialsResponse.h
 *
 * 
 */

#ifndef OAIGetTemporaryGluePartitionCredentialsResponse_H
#define OAIGetTemporaryGluePartitionCredentialsResponse_H
...
class OAIGetTemporaryGluePartitionCredentialsResponse : public OAIObject {
public:
    OAIGetTemporaryGluePartitionCredentialsResponse();
    OAIGetTemporaryGluePartitionCredentialsResponse(QString json);
    ~OAIGetTemporaryGluePartitionCredentialsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTemporaryGluePartitionCredentialsResponse)

#endif // OAIGetTemporaryGluePartitionCredentialsResponse_H
