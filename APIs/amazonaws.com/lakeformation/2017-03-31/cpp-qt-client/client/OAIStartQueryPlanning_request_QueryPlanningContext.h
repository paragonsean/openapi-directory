...
/*
 * OAIStartQueryPlanning_request_QueryPlanningContext.h
 *
 * A structure containing information about the query plan.
 */

#ifndef OAIStartQueryPlanning_request_QueryPlanningContext_H
#define OAIStartQueryPlanning_request_QueryPlanningContext_H
...
class OAIStartQueryPlanning_request_QueryPlanningContext : public OAIObject {
public:
    OAIStartQueryPlanning_request_QueryPlanningContext();
    OAIStartQueryPlanning_request_QueryPlanningContext(QString json);
    ~OAIStartQueryPlanning_request_QueryPlanningContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartQueryPlanning_request_QueryPlanningContext)

#endif // OAIStartQueryPlanning_request_QueryPlanningContext_H
