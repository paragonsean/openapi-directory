...
/*
 * OAIAssumeDecoratedRoleWithSAMLResponse.h
 *
 * 
 */

#ifndef OAIAssumeDecoratedRoleWithSAMLResponse_H
#define OAIAssumeDecoratedRoleWithSAMLResponse_H
...
class OAIAssumeDecoratedRoleWithSAMLResponse : public OAIObject {
public:
    OAIAssumeDecoratedRoleWithSAMLResponse();
    OAIAssumeDecoratedRoleWithSAMLResponse(QString json);
    ~OAIAssumeDecoratedRoleWithSAMLResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssumeDecoratedRoleWithSAMLResponse)

#endif // OAIAssumeDecoratedRoleWithSAMLResponse_H
