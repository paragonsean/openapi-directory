...
OAILFTagError_LFTag::OAILFTagError_LFTag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILFTagError_LFTag::OAILFTagError_LFTag() {
    this->initializeModel();
}

OAILFTagError_LFTag::~OAILFTagError_LFTag() {}

void OAILFTagError_LFTag::initializeModel() {
...
void OAILFTagError_LFTag::fromJson(QString jsonString) {
...
void OAILFTagError_LFTag::fromJsonObject(QJsonObject json) {
...
QString OAILFTagError_LFTag::asJson() const {
...
QJsonObject OAILFTagError_LFTag::asJsonObject() const {
    QJsonObject obj;
...
QString OAILFTagError_LFTag::getCatalogId() const {
    return m_catalog_id;
}
void OAILFTagError_LFTag::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAILFTagError_LFTag::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAILFTagError_LFTag::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAILFTagError_LFTag::getTagKey() const {
    return m_tag_key;
}
void OAILFTagError_LFTag::setTagKey(const QString &tag_key) {
    m_tag_key = tag_key;
    m_tag_key_isSet = true;
}

bool OAILFTagError_LFTag::is_tag_key_Set() const{
    return m_tag_key_isSet;
}

bool OAILFTagError_LFTag::is_tag_key_Valid() const{
    return m_tag_key_isValid;
}

QList OAILFTagError_LFTag::getTagValues() const {
    return m_tag_values;
}
void OAILFTagError_LFTag::setTagValues(const QList &tag_values) {
    m_tag_values = tag_values;
    m_tag_values_isSet = true;
}

bool OAILFTagError_LFTag::is_tag_values_Set() const{
    return m_tag_values_isSet;
}

bool OAILFTagError_LFTag::is_tag_values_Valid() const{
    return m_tag_values_isValid;
}

bool OAILFTagError_LFTag::isSet() const {
...
bool OAILFTagError_LFTag::isValid() const {
