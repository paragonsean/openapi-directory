...
#ifndef OAILFTagPair_H
#define OAILFTagPair_H
...
class OAILFTagPair : public OAIObject {
public:
    OAILFTagPair();
    OAILFTagPair(QString json);
    ~OAILFTagPair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFTagPair)

#endif // OAILFTagPair_H
