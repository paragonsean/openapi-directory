...
/*
 * OAIGetTemporaryGluePartitionCredentialsRequest.h
 *
 * 
 */

#ifndef OAIGetTemporaryGluePartitionCredentialsRequest_H
#define OAIGetTemporaryGluePartitionCredentialsRequest_H
...
namespace OpenAPI {
class OAIGetTemporaryGluePartitionCredentialsRequest_Partition;
class OAIGetTemporaryGluePartitionCredentialsRequest_AuditContext;

class OAIGetTemporaryGluePartitionCredentialsRequest : public OAIObject {
public:
    OAIGetTemporaryGluePartitionCredentialsRequest();
    OAIGetTemporaryGluePartitionCredentialsRequest(QString json);
    ~OAIGetTemporaryGluePartitionCredentialsRequest() override;
    ...
    OAIGetTemporaryGluePartitionCredentialsRequest_Partition getPartition() const;
    void setPartition(const OAIGetTemporaryGluePartitionCredentialsRequest_Partition &partition);
...
private:
    ...
    OAIGetTemporaryGluePartitionCredentialsRequest_Partition m_partition;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTemporaryGluePartitionCredentialsRequest)

#endif // OAIGetTemporaryGluePartitionCredentialsRequest_H
