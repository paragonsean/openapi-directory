...
QString OAIListTransactions_request::getCatalogId() const {
    return m_catalog_id;
}
void OAIListTransactions_request::setCatalogId(const QString &catalog_id) {
    m_catalog_id = catalog_id;
    m_catalog_id_isSet = true;
}

bool OAIListTransactions_request::is_catalog_id_Set() const{
    return m_catalog_id_isSet;
}

bool OAIListTransactions_request::is_catalog_id_Valid() const{
    return m_catalog_id_isValid;
}

QString OAIListTransactions_request::getStatusFilter() const {
    return m_status_filter;
}
void OAIListTransactions_request::setStatusFilter(const QString &status_filter) {
    m_status_filter = status_filter;
    m_status_filter_isSet = true;
}

bool OAIListTransactions_request::is_status_filter_Set() const{
    return m_status_filter_isSet;
}

bool OAIListTransactions_request::is_status_filter_Valid() const{
