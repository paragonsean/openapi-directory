...
|**partition** | [**GetTemporaryGluePartitionCredentialsRequestPartition**](GetTemporaryGluePartitionCredentialsRequestPartition.md) |  |  |
...
|**supportedPermissionTypes** | **List&lt;PermissionType&gt;** | A list of supported permission types for the partition. Valid values are &lt;code&gt;COLUMN_PERMISSION&lt;/code&gt; and &lt;code&gt;CELL_FILTER_PERMISSION&lt;/code&gt;. |  [optional] |
