...
|**writeOperations** | [**List&lt;WriteOperation&gt;**](WriteOperation.md) | A list of &lt;code&gt;WriteOperation&lt;/code&gt; objects that define an object to add to or delete from the manifest for a governed table. |  |
