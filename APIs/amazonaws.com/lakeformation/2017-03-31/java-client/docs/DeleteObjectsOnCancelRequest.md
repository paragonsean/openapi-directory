...
|**objects** | [**List&lt;VirtualObject&gt;**](VirtualObject.md) | A list of VirtualObject structures, which indicates the Amazon S3 objects to be deleted if the transaction cancels. |  |
