...
|**entries** | [**List&lt;BatchPermissionsRequestEntry&gt;**](BatchPermissionsRequestEntry.md) | A list of up to 20 entries for resource permissions to be granted by batch operation to the principal. |  |
