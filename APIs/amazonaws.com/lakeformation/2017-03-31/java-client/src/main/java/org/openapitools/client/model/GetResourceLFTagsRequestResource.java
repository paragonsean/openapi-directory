...
public class GetResourceLFTagsRequestResource {
  ...
  public GetResourceLFTagsRequestResource() {
  }

  public GetResourceLFTagsRequestResource catalog(Object catalog) {
  ...
  public GetResourceLFTagsRequestResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public GetResourceLFTagsRequestResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public GetResourceLFTagsRequestResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public GetResourceLFTagsRequestResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public GetResourceLFTagsRequestResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public GetResourceLFTagsRequestResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public GetResourceLFTagsRequestResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    GetResourceLFTagsRequestResource getResourceLFTagsRequestResource = (GetResourceLFTagsRequestResource) o;
    return Objects.equals(this.catalog, getResourceLFTagsRequestResource.catalog) &&
        Objects.equals(this.database, getResourceLFTagsRequestResource.database) &&
        Objects.equals(this.table, getResourceLFTagsRequestResource.table) &&
        Objects.equals(this.tableWithColumns, getResourceLFTagsRequestResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, getResourceLFTagsRequestResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, getResourceLFTagsRequestResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, getResourceLFTagsRequestResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, getResourceLFTagsRequestResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetResourceLFTagsRequestResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetResourceLFTagsRequestResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetResourceLFTagsRequestResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetResourceLFTagsRequestResource is not found in the empty JSON string", GetResourceLFTagsRequestResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetResourceLFTagsRequestResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetResourceLFTagsRequestResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetResourceLFTagsRequestResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetResourceLFTagsRequestResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetResourceLFTagsRequestResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetResourceLFTagsRequestResource.class));

       return (TypeAdapter<T>) new TypeAdapter<GetResourceLFTagsRequestResource>() {
           @Override
           public void write(JsonWriter out, GetResourceLFTagsRequestResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetResourceLFTagsRequestResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetResourceLFTagsRequestResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetResourceLFTagsRequestResource
   * @throws IOException if the JSON string is invalid with respect to GetResourceLFTagsRequestResource
   */
  public static GetResourceLFTagsRequestResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetResourceLFTagsRequestResource.class);
  }

  /**
   * Convert an instance of GetResourceLFTagsRequestResource to an JSON string
   *
   * @return JSON string
   */
