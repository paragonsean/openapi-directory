...
public class AddLFTagsToResourceRequestResource {
  ...
  public AddLFTagsToResourceRequestResource() {
  }

  public AddLFTagsToResourceRequestResource catalog(Object catalog) {
  ...
  public AddLFTagsToResourceRequestResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public AddLFTagsToResourceRequestResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public AddLFTagsToResourceRequestResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public AddLFTagsToResourceRequestResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public AddLFTagsToResourceRequestResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public AddLFTagsToResourceRequestResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public AddLFTagsToResourceRequestResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    AddLFTagsToResourceRequestResource addLFTagsToResourceRequestResource = (AddLFTagsToResourceRequestResource) o;
    return Objects.equals(this.catalog, addLFTagsToResourceRequestResource.catalog) &&
        Objects.equals(this.database, addLFTagsToResourceRequestResource.database) &&
        Objects.equals(this.table, addLFTagsToResourceRequestResource.table) &&
        Objects.equals(this.tableWithColumns, addLFTagsToResourceRequestResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, addLFTagsToResourceRequestResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, addLFTagsToResourceRequestResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, addLFTagsToResourceRequestResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, addLFTagsToResourceRequestResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddLFTagsToResourceRequestResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddLFTagsToResourceRequestResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddLFTagsToResourceRequestResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLFTagsToResourceRequestResource is not found in the empty JSON string", AddLFTagsToResourceRequestResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddLFTagsToResourceRequestResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddLFTagsToResourceRequestResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLFTagsToResourceRequestResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLFTagsToResourceRequestResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLFTagsToResourceRequestResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLFTagsToResourceRequestResource.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLFTagsToResourceRequestResource>() {
           @Override
           public void write(JsonWriter out, AddLFTagsToResourceRequestResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddLFTagsToResourceRequestResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddLFTagsToResourceRequestResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddLFTagsToResourceRequestResource
   * @throws IOException if the JSON string is invalid with respect to AddLFTagsToResourceRequestResource
   */
  public static AddLFTagsToResourceRequestResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLFTagsToResourceRequestResource.class);
  }

  /**
   * Convert an instance of AddLFTagsToResourceRequestResource to an JSON string
   *
   * @return JSON string
   */
