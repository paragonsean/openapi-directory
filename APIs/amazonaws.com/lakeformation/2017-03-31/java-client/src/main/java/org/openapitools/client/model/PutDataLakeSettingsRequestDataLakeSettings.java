...
public class PutDataLakeSettingsRequestDataLakeSettings {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings() {
  }

  public PutDataLakeSettingsRequestDataLakeSettings dataLakeAdmins(List dataLakeAdmins) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings readOnlyAdmins(List readOnlyAdmins) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings createDatabaseDefaultPermissions(List createDatabaseDefaultPermissions) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings createTableDefaultPermissions(List createTableDefaultPermissions) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings parameters(Map parameters) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings trustedResourceOwners(List trustedResourceOwners) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings allowExternalDataFiltering(Boolean allowExternalDataFiltering) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings allowFullTableExternalDataAccess(Boolean allowFullTableExternalDataAccess) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings externalDataFilteringAllowList(List externalDataFilteringAllowList) {
  ...
  public PutDataLakeSettingsRequestDataLakeSettings authorizedSessionTagValueList(List authorizedSessionTagValueList) {
  ...
  public boolean equals(Object o) {
    ...
    PutDataLakeSettingsRequestDataLakeSettings putDataLakeSettingsRequestDataLakeSettings = (PutDataLakeSettingsRequestDataLakeSettings) o;
    return Objects.equals(this.dataLakeAdmins, putDataLakeSettingsRequestDataLakeSettings.dataLakeAdmins) &&
        Objects.equals(this.readOnlyAdmins, putDataLakeSettingsRequestDataLakeSettings.readOnlyAdmins) &&
        Objects.equals(this.createDatabaseDefaultPermissions, putDataLakeSettingsRequestDataLakeSettings.createDatabaseDefaultPermissions) &&
        Objects.equals(this.createTableDefaultPermissions, putDataLakeSettingsRequestDataLakeSettings.createTableDefaultPermissions) &&
        Objects.equals(this.parameters, putDataLakeSettingsRequestDataLakeSettings.parameters) &&
        Objects.equals(this.trustedResourceOwners, putDataLakeSettingsRequestDataLakeSettings.trustedResourceOwners) &&
        Objects.equals(this.allowExternalDataFiltering, putDataLakeSettingsRequestDataLakeSettings.allowExternalDataFiltering) &&
        Objects.equals(this.allowFullTableExternalDataAccess, putDataLakeSettingsRequestDataLakeSettings.allowFullTableExternalDataAccess) &&
        Objects.equals(this.externalDataFilteringAllowList, putDataLakeSettingsRequestDataLakeSettings.externalDataFilteringAllowList) &&
        Objects.equals(this.authorizedSessionTagValueList, putDataLakeSettingsRequestDataLakeSettings.authorizedSessionTagValueList);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDataLakeSettingsRequestDataLakeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDataLakeSettingsRequestDataLakeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDataLakeSettingsRequestDataLakeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDataLakeSettingsRequestDataLakeSettings is not found in the empty JSON string", PutDataLakeSettingsRequestDataLakeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDataLakeSettingsRequestDataLakeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDataLakeSettingsRequestDataLakeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDataLakeSettingsRequestDataLakeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDataLakeSettingsRequestDataLakeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDataLakeSettingsRequestDataLakeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDataLakeSettingsRequestDataLakeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDataLakeSettingsRequestDataLakeSettings>() {
           @Override
           public void write(JsonWriter out, PutDataLakeSettingsRequestDataLakeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDataLakeSettingsRequestDataLakeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDataLakeSettingsRequestDataLakeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDataLakeSettingsRequestDataLakeSettings
   * @throws IOException if the JSON string is invalid with respect to PutDataLakeSettingsRequestDataLakeSettings
   */
  public static PutDataLakeSettingsRequestDataLakeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDataLakeSettingsRequestDataLakeSettings.class);
  }

  /**
   * Convert an instance of PutDataLakeSettingsRequestDataLakeSettings to an JSON string
   *
   * @return JSON string
   */
