...
public class BatchPermissionsRequestEntryResource {
  ...
  public BatchPermissionsRequestEntryResource() {
  }

  public BatchPermissionsRequestEntryResource catalog(Object catalog) {
  ...
  public BatchPermissionsRequestEntryResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public BatchPermissionsRequestEntryResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public BatchPermissionsRequestEntryResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public BatchPermissionsRequestEntryResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public BatchPermissionsRequestEntryResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public BatchPermissionsRequestEntryResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public BatchPermissionsRequestEntryResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    BatchPermissionsRequestEntryResource batchPermissionsRequestEntryResource = (BatchPermissionsRequestEntryResource) o;
    return Objects.equals(this.catalog, batchPermissionsRequestEntryResource.catalog) &&
        Objects.equals(this.database, batchPermissionsRequestEntryResource.database) &&
        Objects.equals(this.table, batchPermissionsRequestEntryResource.table) &&
        Objects.equals(this.tableWithColumns, batchPermissionsRequestEntryResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, batchPermissionsRequestEntryResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, batchPermissionsRequestEntryResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, batchPermissionsRequestEntryResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, batchPermissionsRequestEntryResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchPermissionsRequestEntryResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchPermissionsRequestEntryResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchPermissionsRequestEntryResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchPermissionsRequestEntryResource is not found in the empty JSON string", BatchPermissionsRequestEntryResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchPermissionsRequestEntryResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchPermissionsRequestEntryResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchPermissionsRequestEntryResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchPermissionsRequestEntryResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchPermissionsRequestEntryResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchPermissionsRequestEntryResource.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchPermissionsRequestEntryResource>() {
           @Override
           public void write(JsonWriter out, BatchPermissionsRequestEntryResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchPermissionsRequestEntryResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchPermissionsRequestEntryResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchPermissionsRequestEntryResource
   * @throws IOException if the JSON string is invalid with respect to BatchPermissionsRequestEntryResource
   */
  public static BatchPermissionsRequestEntryResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchPermissionsRequestEntryResource.class);
  }

  /**
   * Convert an instance of BatchPermissionsRequestEntryResource to an JSON string
   *
   * @return JSON string
   */
