...
public class PlanningStatistics {
  ...
  public PlanningStatistics estimatedDataToScanBytes(Integer estimatedDataToScanBytes) {
  ...
  public PlanningStatistics planningTimeMillis(Integer planningTimeMillis) {
  ...
  public PlanningStatistics queueTimeMillis(Integer queueTimeMillis) {
  ...
  public PlanningStatistics workUnitsGeneratedCount(Integer workUnitsGeneratedCount) {
  ...
  public boolean equals(Object o) {
    ...
    PlanningStatistics planningStatistics = (PlanningStatistics) o;
    return Objects.equals(this.estimatedDataToScanBytes, planningStatistics.estimatedDataToScanBytes) &&
        Objects.equals(this.planningTimeMillis, planningStatistics.planningTimeMillis) &&
        Objects.equals(this.queueTimeMillis, planningStatistics.queueTimeMillis) &&
        Objects.equals(this.workUnitsGeneratedCount, planningStatistics.workUnitsGeneratedCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlanningStatistics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlanningStatistics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanningStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlanningStatistics is not found in the empty JSON string", PlanningStatistics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlanningStatistics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlanningStatistics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlanningStatistics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlanningStatistics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlanningStatistics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlanningStatistics.class));

       return (TypeAdapter<T>) new TypeAdapter<PlanningStatistics>() {
           @Override
           public void write(JsonWriter out, PlanningStatistics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlanningStatistics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlanningStatistics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlanningStatistics
   * @throws IOException if the JSON string is invalid with respect to PlanningStatistics
   */
  public static PlanningStatistics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlanningStatistics.class);
  }

  /**
   * Convert an instance of PlanningStatistics to an JSON string
   *
   * @return JSON string
   */
