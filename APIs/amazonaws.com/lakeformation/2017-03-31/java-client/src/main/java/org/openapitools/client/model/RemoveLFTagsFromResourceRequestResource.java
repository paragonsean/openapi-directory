...
public class RemoveLFTagsFromResourceRequestResource {
  ...
  public RemoveLFTagsFromResourceRequestResource() {
  }

  public RemoveLFTagsFromResourceRequestResource catalog(Object catalog) {
  ...
  public RemoveLFTagsFromResourceRequestResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public RemoveLFTagsFromResourceRequestResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public RemoveLFTagsFromResourceRequestResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public RemoveLFTagsFromResourceRequestResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public RemoveLFTagsFromResourceRequestResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public RemoveLFTagsFromResourceRequestResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public RemoveLFTagsFromResourceRequestResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveLFTagsFromResourceRequestResource removeLFTagsFromResourceRequestResource = (RemoveLFTagsFromResourceRequestResource) o;
    return Objects.equals(this.catalog, removeLFTagsFromResourceRequestResource.catalog) &&
        Objects.equals(this.database, removeLFTagsFromResourceRequestResource.database) &&
        Objects.equals(this.table, removeLFTagsFromResourceRequestResource.table) &&
        Objects.equals(this.tableWithColumns, removeLFTagsFromResourceRequestResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, removeLFTagsFromResourceRequestResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, removeLFTagsFromResourceRequestResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, removeLFTagsFromResourceRequestResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, removeLFTagsFromResourceRequestResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveLFTagsFromResourceRequestResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveLFTagsFromResourceRequestResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveLFTagsFromResourceRequestResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemoveLFTagsFromResourceRequestResource is not found in the empty JSON string", RemoveLFTagsFromResourceRequestResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveLFTagsFromResourceRequestResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemoveLFTagsFromResourceRequestResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveLFTagsFromResourceRequestResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveLFTagsFromResourceRequestResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveLFTagsFromResourceRequestResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveLFTagsFromResourceRequestResource.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveLFTagsFromResourceRequestResource>() {
           @Override
           public void write(JsonWriter out, RemoveLFTagsFromResourceRequestResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveLFTagsFromResourceRequestResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveLFTagsFromResourceRequestResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveLFTagsFromResourceRequestResource
   * @throws IOException if the JSON string is invalid with respect to RemoveLFTagsFromResourceRequestResource
   */
  public static RemoveLFTagsFromResourceRequestResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveLFTagsFromResourceRequestResource.class);
  }

  /**
   * Convert an instance of RemoveLFTagsFromResourceRequestResource to an JSON string
   *
   * @return JSON string
   */
