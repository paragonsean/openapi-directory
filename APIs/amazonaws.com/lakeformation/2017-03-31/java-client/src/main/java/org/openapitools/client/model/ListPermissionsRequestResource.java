...
public class ListPermissionsRequestResource {
  ...
  public ListPermissionsRequestResource() {
  }

  public ListPermissionsRequestResource catalog(Object catalog) {
  ...
  public ListPermissionsRequestResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public ListPermissionsRequestResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public ListPermissionsRequestResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public ListPermissionsRequestResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public ListPermissionsRequestResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public ListPermissionsRequestResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public ListPermissionsRequestResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    ListPermissionsRequestResource listPermissionsRequestResource = (ListPermissionsRequestResource) o;
    return Objects.equals(this.catalog, listPermissionsRequestResource.catalog) &&
        Objects.equals(this.database, listPermissionsRequestResource.database) &&
        Objects.equals(this.table, listPermissionsRequestResource.table) &&
        Objects.equals(this.tableWithColumns, listPermissionsRequestResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, listPermissionsRequestResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, listPermissionsRequestResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, listPermissionsRequestResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, listPermissionsRequestResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPermissionsRequestResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPermissionsRequestResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPermissionsRequestResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPermissionsRequestResource is not found in the empty JSON string", ListPermissionsRequestResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPermissionsRequestResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPermissionsRequestResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPermissionsRequestResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPermissionsRequestResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPermissionsRequestResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPermissionsRequestResource.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPermissionsRequestResource>() {
           @Override
           public void write(JsonWriter out, ListPermissionsRequestResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPermissionsRequestResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPermissionsRequestResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPermissionsRequestResource
   * @throws IOException if the JSON string is invalid with respect to ListPermissionsRequestResource
   */
  public static ListPermissionsRequestResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPermissionsRequestResource.class);
  }

  /**
   * Convert an instance of ListPermissionsRequestResource to an JSON string
   *
   * @return JSON string
   */
