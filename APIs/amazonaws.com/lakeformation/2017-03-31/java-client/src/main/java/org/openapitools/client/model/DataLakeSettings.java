...
public class DataLakeSettings {
  ...
  public DataLakeSettings dataLakeAdmins(List dataLakeAdmins) {
  ...
  public DataLakeSettings readOnlyAdmins(List readOnlyAdmins) {
  ...
  public DataLakeSettings createDatabaseDefaultPermissions(List createDatabaseDefaultPermissions) {
  ...
  public DataLakeSettings createTableDefaultPermissions(List createTableDefaultPermissions) {
  ...
  public DataLakeSettings parameters(Map parameters) {
  ...
  public DataLakeSettings trustedResourceOwners(List trustedResourceOwners) {
  ...
  public DataLakeSettings allowExternalDataFiltering(Boolean allowExternalDataFiltering) {
  ...
  public DataLakeSettings allowFullTableExternalDataAccess(Boolean allowFullTableExternalDataAccess) {
  ...
  public DataLakeSettings externalDataFilteringAllowList(List externalDataFilteringAllowList) {
  ...
  public DataLakeSettings authorizedSessionTagValueList(List authorizedSessionTagValueList) {
  ...
  public boolean equals(Object o) {
    ...
    DataLakeSettings dataLakeSettings = (DataLakeSettings) o;
    return Objects.equals(this.dataLakeAdmins, dataLakeSettings.dataLakeAdmins) &&
        Objects.equals(this.readOnlyAdmins, dataLakeSettings.readOnlyAdmins) &&
        Objects.equals(this.createDatabaseDefaultPermissions, dataLakeSettings.createDatabaseDefaultPermissions) &&
        Objects.equals(this.createTableDefaultPermissions, dataLakeSettings.createTableDefaultPermissions) &&
        Objects.equals(this.parameters, dataLakeSettings.parameters) &&
        Objects.equals(this.trustedResourceOwners, dataLakeSettings.trustedResourceOwners) &&
        Objects.equals(this.allowExternalDataFiltering, dataLakeSettings.allowExternalDataFiltering) &&
        Objects.equals(this.allowFullTableExternalDataAccess, dataLakeSettings.allowFullTableExternalDataAccess) &&
        Objects.equals(this.externalDataFilteringAllowList, dataLakeSettings.externalDataFilteringAllowList) &&
        Objects.equals(this.authorizedSessionTagValueList, dataLakeSettings.authorizedSessionTagValueList);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataLakeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataLakeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataLakeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataLakeSettings is not found in the empty JSON string", DataLakeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataLakeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataLakeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataLakeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataLakeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataLakeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataLakeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<DataLakeSettings>() {
           @Override
           public void write(JsonWriter out, DataLakeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataLakeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataLakeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataLakeSettings
   * @throws IOException if the JSON string is invalid with respect to DataLakeSettings
   */
  public static DataLakeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataLakeSettings.class);
  }

  /**
   * Convert an instance of DataLakeSettings to an JSON string
   *
   * @return JSON string
   */
