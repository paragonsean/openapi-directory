...
public class ListTransactionsRequest {
   ...
   */
  @JsonAdapter(StatusFilterEnum.Adapter.class)
  public enum StatusFilterEnum {
    ...
    public static StatusFilterEnum fromValue(String value) {
      for (StatusFilterEnum b : StatusFilterEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<StatusFilterEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StatusFilterEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StatusFilterEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return StatusFilterEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      StatusFilterEnum.fromValue(value);
    }
  }
  ...
  public ListTransactionsRequest catalogId(String catalogId) {
  ...
  public ListTransactionsRequest statusFilter(StatusFilterEnum statusFilter) {
   ...
   */
  @javax.annotation.Nullable
  public StatusFilterEnum getStatusFilter() {
    return statusFilter;
  }

  public void setStatusFilter(StatusFilterEnum statusFilter) {
    this.statusFilter = statusFilter;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.catalogId, listTransactionsRequest.catalogId) &&
        Objects.equals(this.statusFilter, listTransactionsRequest.statusFilter) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(catalogId, statusFilter, maxResults, nextToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("StatusFilter") != null && !jsonObj.get("StatusFilter").isJsonNull()) && !jsonObj.get("StatusFilter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `StatusFilter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("StatusFilter").toString()));
      }
      // validate the optional field `StatusFilter`
      if (jsonObj.get("StatusFilter") != null && !jsonObj.get("StatusFilter").isJsonNull()) {
        StatusFilterEnum.validateJsonElement(jsonObj.get("StatusFilter"));
      }
