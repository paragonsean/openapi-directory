...
public class PrincipalResourcePermissionsResource {
  ...
  public PrincipalResourcePermissionsResource() {
  }

  public PrincipalResourcePermissionsResource catalog(Object catalog) {
  ...
  public PrincipalResourcePermissionsResource database(AddLFTagsToResourceRequestResourceDatabase database) {
  ...
  public PrincipalResourcePermissionsResource table(AddLFTagsToResourceRequestResourceTable table) {
    this.table = table;
    return this;
  }
  ...
  public PrincipalResourcePermissionsResource tableWithColumns(AddLFTagsToResourceRequestResourceTableWithColumns tableWithColumns) {
  ...
  public PrincipalResourcePermissionsResource dataLocation(AddLFTagsToResourceRequestResourceDataLocation dataLocation) {
  ...
  public PrincipalResourcePermissionsResource dataCellsFilter(AddLFTagsToResourceRequestResourceDataCellsFilter dataCellsFilter) {
  ...
  public PrincipalResourcePermissionsResource lfTag(AddLFTagsToResourceRequestResourceLFTag lfTag) {
    this.lfTag = lfTag;
    return this;
  }
  ...
  public PrincipalResourcePermissionsResource lfTagPolicy(AddLFTagsToResourceRequestResourceLFTagPolicy lfTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    PrincipalResourcePermissionsResource principalResourcePermissionsResource = (PrincipalResourcePermissionsResource) o;
    return Objects.equals(this.catalog, principalResourcePermissionsResource.catalog) &&
        Objects.equals(this.database, principalResourcePermissionsResource.database) &&
        Objects.equals(this.table, principalResourcePermissionsResource.table) &&
        Objects.equals(this.tableWithColumns, principalResourcePermissionsResource.tableWithColumns) &&
        Objects.equals(this.dataLocation, principalResourcePermissionsResource.dataLocation) &&
        Objects.equals(this.dataCellsFilter, principalResourcePermissionsResource.dataCellsFilter) &&
        Objects.equals(this.lfTag, principalResourcePermissionsResource.lfTag) &&
        Objects.equals(this.lfTagPolicy, principalResourcePermissionsResource.lfTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrincipalResourcePermissionsResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrincipalResourcePermissionsResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrincipalResourcePermissionsResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrincipalResourcePermissionsResource is not found in the empty JSON string", PrincipalResourcePermissionsResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrincipalResourcePermissionsResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrincipalResourcePermissionsResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrincipalResourcePermissionsResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrincipalResourcePermissionsResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrincipalResourcePermissionsResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrincipalResourcePermissionsResource.class));

       return (TypeAdapter<T>) new TypeAdapter<PrincipalResourcePermissionsResource>() {
           @Override
           public void write(JsonWriter out, PrincipalResourcePermissionsResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PrincipalResourcePermissionsResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PrincipalResourcePermissionsResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PrincipalResourcePermissionsResource
   * @throws IOException if the JSON string is invalid with respect to PrincipalResourcePermissionsResource
   */
  public static PrincipalResourcePermissionsResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrincipalResourcePermissionsResource.class);
  }

  /**
   * Convert an instance of PrincipalResourcePermissionsResource to an JSON string
   *
   * @return JSON string
   */
