...
public class FileUploaderFieldConfig {
  ...
  public FileUploaderFieldConfig accessLevel(StorageAccessLevel accessLevel) {
  ...
  public FileUploaderFieldConfig acceptedFileTypes(List acceptedFileTypes) {
  ...
  public FileUploaderFieldConfig showThumbnails(Boolean showThumbnails) {
  ...
  public FileUploaderFieldConfig isResumable(Boolean isResumable) {
  ...
  public FileUploaderFieldConfig maxFileCount(Integer maxFileCount) {
  ...
  public FileUploaderFieldConfig maxSize(Integer maxSize) {
