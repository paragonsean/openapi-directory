...
public class ActionParametersAnchor {
  ...
  public ActionParametersAnchor() {
  }

  public ActionParametersAnchor value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersAnchor bindingProperties(ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersAnchor collectionBindingProperties(ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersAnchor defaultValue(String defaultValue) {
  ...
  public ActionParametersAnchor model(String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersAnchor bindings(Map bindings) {
  ...
  public ActionParametersAnchor event(String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersAnchor userAttribute(String userAttribute) {
  ...
  public ActionParametersAnchor concat(List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersAnchor condition(ComponentPropertyCondition condition) {
  ...
  public ActionParametersAnchor configured(Boolean configured) {
  ...
  public ActionParametersAnchor type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersAnchor importedValue(String importedValue) {
  ...
  public ActionParametersAnchor componentName(String componentName) {
  ...
  public ActionParametersAnchor property(String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersAnchor actionParametersAnchor = (ActionParametersAnchor) o;
    return Objects.equals(this.value, actionParametersAnchor.value) &&
        Objects.equals(this.bindingProperties, actionParametersAnchor.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersAnchor.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersAnchor.defaultValue) &&
        Objects.equals(this.model, actionParametersAnchor.model) &&
        Objects.equals(this.bindings, actionParametersAnchor.bindings) &&
        Objects.equals(this.event, actionParametersAnchor.event) &&
        Objects.equals(this.userAttribute, actionParametersAnchor.userAttribute) &&
        Objects.equals(this.concat, actionParametersAnchor.concat) &&
        Objects.equals(this.condition, actionParametersAnchor.condition) &&
        Objects.equals(this.configured, actionParametersAnchor.configured) &&
        Objects.equals(this.type, actionParametersAnchor.type) &&
        Objects.equals(this.importedValue, actionParametersAnchor.importedValue) &&
        Objects.equals(this.componentName, actionParametersAnchor.componentName) &&
        Objects.equals(this.property, actionParametersAnchor.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersAnchor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersAnchor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersAnchor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersAnchor is not found in the empty JSON string", ActionParametersAnchor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersAnchor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersAnchor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersAnchor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersAnchor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersAnchor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersAnchor.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersAnchor>() {
           @Override
           public void write(JsonWriter out, ActionParametersAnchor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersAnchor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersAnchor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersAnchor
   * @throws IOException if the JSON string is invalid with respect to ActionParametersAnchor
   */
  public static ActionParametersAnchor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersAnchor.class);
  }

  /**
   * Convert an instance of ActionParametersAnchor to an JSON string
   *
   * @return JSON string
   */
