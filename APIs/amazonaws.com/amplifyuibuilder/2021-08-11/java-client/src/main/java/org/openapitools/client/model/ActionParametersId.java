...
public class ActionParametersId {
  ...
  public ActionParametersId() {
  }

  public ActionParametersId value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersId bindingProperties(ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersId collectionBindingProperties(ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersId defaultValue(String defaultValue) {
  ...
  public ActionParametersId model(String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersId bindings(Map bindings) {
  ...
  public ActionParametersId event(String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersId userAttribute(String userAttribute) {
  ...
  public ActionParametersId concat(List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersId condition(ComponentPropertyCondition condition) {
  ...
  public ActionParametersId configured(Boolean configured) {
  ...
  public ActionParametersId type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersId importedValue(String importedValue) {
  ...
  public ActionParametersId componentName(String componentName) {
  ...
  public ActionParametersId property(String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersId actionParametersId = (ActionParametersId) o;
    return Objects.equals(this.value, actionParametersId.value) &&
        Objects.equals(this.bindingProperties, actionParametersId.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersId.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersId.defaultValue) &&
        Objects.equals(this.model, actionParametersId.model) &&
        Objects.equals(this.bindings, actionParametersId.bindings) &&
        Objects.equals(this.event, actionParametersId.event) &&
        Objects.equals(this.userAttribute, actionParametersId.userAttribute) &&
        Objects.equals(this.concat, actionParametersId.concat) &&
        Objects.equals(this.condition, actionParametersId.condition) &&
        Objects.equals(this.configured, actionParametersId.configured) &&
        Objects.equals(this.type, actionParametersId.type) &&
        Objects.equals(this.importedValue, actionParametersId.importedValue) &&
        Objects.equals(this.componentName, actionParametersId.componentName) &&
        Objects.equals(this.property, actionParametersId.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersId {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersId is not found in the empty JSON string", ActionParametersId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersId.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersId>() {
           @Override
           public void write(JsonWriter out, ActionParametersId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersId
   * @throws IOException if the JSON string is invalid with respect to ActionParametersId
   */
  public static ActionParametersId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersId.class);
  }

  /**
   * Convert an instance of ActionParametersId to an JSON string
   *
   * @return JSON string
   */
