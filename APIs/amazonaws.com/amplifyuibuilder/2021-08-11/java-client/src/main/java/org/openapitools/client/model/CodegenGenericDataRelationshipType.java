...
public class CodegenGenericDataRelationshipType {
  ...
  public CodegenGenericDataRelationshipType() {
  }

  public CodegenGenericDataRelationshipType type(GenericDataRelationshipType type) {
    this.type = type;
    return this;
  }
  ...
  public CodegenGenericDataRelationshipType relatedModelName(String relatedModelName) {
  ...
  public CodegenGenericDataRelationshipType relatedModelFields(List relatedModelFields) {
  ...
  public CodegenGenericDataRelationshipType canUnlinkAssociatedModel(Boolean canUnlinkAssociatedModel) {
  ...
  public CodegenGenericDataRelationshipType relatedJoinFieldName(String relatedJoinFieldName) {
  ...
  public CodegenGenericDataRelationshipType relatedJoinTableName(String relatedJoinTableName) {
  ...
  public CodegenGenericDataRelationshipType belongsToFieldOnRelatedModel(String belongsToFieldOnRelatedModel) {
  ...
  public CodegenGenericDataRelationshipType associatedFields(List associatedFields) {
  ...
  public CodegenGenericDataRelationshipType isHasManyIndex(Boolean isHasManyIndex) {
  ...
  public boolean equals(Object o) {
    ...
    CodegenGenericDataRelationshipType codegenGenericDataRelationshipType = (CodegenGenericDataRelationshipType) o;
    return Objects.equals(this.type, codegenGenericDataRelationshipType.type) &&
        Objects.equals(this.relatedModelName, codegenGenericDataRelationshipType.relatedModelName) &&
        Objects.equals(this.relatedModelFields, codegenGenericDataRelationshipType.relatedModelFields) &&
        Objects.equals(this.canUnlinkAssociatedModel, codegenGenericDataRelationshipType.canUnlinkAssociatedModel) &&
        Objects.equals(this.relatedJoinFieldName, codegenGenericDataRelationshipType.relatedJoinFieldName) &&
        Objects.equals(this.relatedJoinTableName, codegenGenericDataRelationshipType.relatedJoinTableName) &&
        Objects.equals(this.belongsToFieldOnRelatedModel, codegenGenericDataRelationshipType.belongsToFieldOnRelatedModel) &&
        Objects.equals(this.associatedFields, codegenGenericDataRelationshipType.associatedFields) &&
        Objects.equals(this.isHasManyIndex, codegenGenericDataRelationshipType.isHasManyIndex);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodegenGenericDataRelationshipType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodegenGenericDataRelationshipType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodegenGenericDataRelationshipType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodegenGenericDataRelationshipType is not found in the empty JSON string", CodegenGenericDataRelationshipType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodegenGenericDataRelationshipType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodegenGenericDataRelationshipType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CodegenGenericDataRelationshipType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodegenGenericDataRelationshipType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodegenGenericDataRelationshipType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodegenGenericDataRelationshipType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodegenGenericDataRelationshipType.class));

       return (TypeAdapter<T>) new TypeAdapter<CodegenGenericDataRelationshipType>() {
           @Override
           public void write(JsonWriter out, CodegenGenericDataRelationshipType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodegenGenericDataRelationshipType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodegenGenericDataRelationshipType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodegenGenericDataRelationshipType
   * @throws IOException if the JSON string is invalid with respect to CodegenGenericDataRelationshipType
   */
  public static CodegenGenericDataRelationshipType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodegenGenericDataRelationshipType.class);
  }

  /**
   * Convert an instance of CodegenGenericDataRelationshipType to an JSON string
   *
   * @return JSON string
   */
