...
public class ActionParametersUrl {
  ...
  public ActionParametersUrl() {
  }

  public ActionParametersUrl value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersUrl bindingProperties(ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersUrl collectionBindingProperties(ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersUrl defaultValue(String defaultValue) {
  ...
  public ActionParametersUrl model(String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersUrl bindings(Map bindings) {
  ...
  public ActionParametersUrl event(String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersUrl userAttribute(String userAttribute) {
  ...
  public ActionParametersUrl concat(List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersUrl condition(ComponentPropertyCondition condition) {
  ...
  public ActionParametersUrl configured(Boolean configured) {
  ...
  public ActionParametersUrl type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersUrl importedValue(String importedValue) {
  ...
  public ActionParametersUrl componentName(String componentName) {
  ...
  public ActionParametersUrl property(String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersUrl actionParametersUrl = (ActionParametersUrl) o;
    return Objects.equals(this.value, actionParametersUrl.value) &&
        Objects.equals(this.bindingProperties, actionParametersUrl.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersUrl.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersUrl.defaultValue) &&
        Objects.equals(this.model, actionParametersUrl.model) &&
        Objects.equals(this.bindings, actionParametersUrl.bindings) &&
        Objects.equals(this.event, actionParametersUrl.event) &&
        Objects.equals(this.userAttribute, actionParametersUrl.userAttribute) &&
        Objects.equals(this.concat, actionParametersUrl.concat) &&
        Objects.equals(this.condition, actionParametersUrl.condition) &&
        Objects.equals(this.configured, actionParametersUrl.configured) &&
        Objects.equals(this.type, actionParametersUrl.type) &&
        Objects.equals(this.importedValue, actionParametersUrl.importedValue) &&
        Objects.equals(this.componentName, actionParametersUrl.componentName) &&
        Objects.equals(this.property, actionParametersUrl.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersUrl {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersUrl is not found in the empty JSON string", ActionParametersUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersUrl>() {
           @Override
           public void write(JsonWriter out, ActionParametersUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersUrl
   * @throws IOException if the JSON string is invalid with respect to ActionParametersUrl
   */
  public static ActionParametersUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersUrl.class);
  }

  /**
   * Convert an instance of ActionParametersUrl to an JSON string
   *
   * @return JSON string
   */
