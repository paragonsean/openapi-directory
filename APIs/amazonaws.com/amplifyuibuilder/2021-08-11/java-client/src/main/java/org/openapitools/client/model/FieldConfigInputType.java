...
public class FieldConfigInputType {
  ...
  public FieldConfigInputType() {
  }

  public FieldConfigInputType type(String type) {
    this.type = type;
    return this;
  }
  ...
  public FieldConfigInputType required(Boolean required) {
  ...
  public FieldConfigInputType readOnly(Boolean readOnly) {
  ...
  public FieldConfigInputType placeholder(String placeholder) {
  ...
  public FieldConfigInputType defaultValue(String defaultValue) {
  ...
  public FieldConfigInputType descriptiveText(String descriptiveText) {
  ...
  public FieldConfigInputType defaultChecked(Boolean defaultChecked) {
  ...
  public FieldConfigInputType defaultCountryCode(String defaultCountryCode) {
  ...
  public FieldConfigInputType valueMappings(FieldInputConfigValueMappings valueMappings) {
  ...
  public FieldConfigInputType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FieldConfigInputType minValue(Float minValue) {
  ...
  public FieldConfigInputType maxValue(Float maxValue) {
  ...
  public FieldConfigInputType step(Float step) {
    this.step = step;
    return this;
  }
  ...
  public FieldConfigInputType value(String value) {
    this.value = value;
    return this;
  }
  ...
  public FieldConfigInputType isArray(Boolean isArray) {
  ...
  public FieldConfigInputType fileUploaderConfig(FieldInputConfigFileUploaderConfig fileUploaderConfig) {
  ...
  public boolean equals(Object o) {
    ...
    FieldConfigInputType fieldConfigInputType = (FieldConfigInputType) o;
    return Objects.equals(this.type, fieldConfigInputType.type) &&
        Objects.equals(this.required, fieldConfigInputType.required) &&
        Objects.equals(this.readOnly, fieldConfigInputType.readOnly) &&
        Objects.equals(this.placeholder, fieldConfigInputType.placeholder) &&
        Objects.equals(this.defaultValue, fieldConfigInputType.defaultValue) &&
        Objects.equals(this.descriptiveText, fieldConfigInputType.descriptiveText) &&
        Objects.equals(this.defaultChecked, fieldConfigInputType.defaultChecked) &&
        Objects.equals(this.defaultCountryCode, fieldConfigInputType.defaultCountryCode) &&
        Objects.equals(this.valueMappings, fieldConfigInputType.valueMappings) &&
        Objects.equals(this.name, fieldConfigInputType.name) &&
        Objects.equals(this.minValue, fieldConfigInputType.minValue) &&
        Objects.equals(this.maxValue, fieldConfigInputType.maxValue) &&
        Objects.equals(this.step, fieldConfigInputType.step) &&
        Objects.equals(this.value, fieldConfigInputType.value) &&
        Objects.equals(this.isArray, fieldConfigInputType.isArray) &&
        Objects.equals(this.fileUploaderConfig, fieldConfigInputType.fileUploaderConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class FieldConfigInputType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FieldConfigInputType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FieldConfigInputType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FieldConfigInputType is not found in the empty JSON string", FieldConfigInputType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FieldConfigInputType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldConfigInputType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FieldConfigInputType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FieldConfigInputType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FieldConfigInputType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FieldConfigInputType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FieldConfigInputType.class));

       return (TypeAdapter<T>) new TypeAdapter<FieldConfigInputType>() {
           @Override
           public void write(JsonWriter out, FieldConfigInputType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FieldConfigInputType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FieldConfigInputType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FieldConfigInputType
   * @throws IOException if the JSON string is invalid with respect to FieldConfigInputType
   */
  public static FieldConfigInputType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FieldConfigInputType.class);
  }

  /**
   * Convert an instance of FieldConfigInputType to an JSON string
   *
   * @return JSON string
   */
