...
public class UpdateFormData {
  ...
  public UpdateFormData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateFormData dataType(CreateFormRequestFormToCreateDataType dataType) {
  ...
  public UpdateFormData formActionType(FormActionType formActionType) {
  ...
  public UpdateFormData fields(Map fields) {
    this.fields = fields;
    return this;
  }
  ...
  public UpdateFormData style(CreateFormRequestFormToCreateStyle style) {
    this.style = style;
    return this;
  }
  ...
  public UpdateFormData sectionalElements(Map sectionalElements) {
  ...
  public UpdateFormData schemaVersion(String schemaVersion) {
  ...
  public UpdateFormData cta(CreateFormRequestFormToCreateCta cta) {
    this.cta = cta;
    return this;
  }
  ...
  public UpdateFormData labelDecorator(LabelDecorator labelDecorator) {
