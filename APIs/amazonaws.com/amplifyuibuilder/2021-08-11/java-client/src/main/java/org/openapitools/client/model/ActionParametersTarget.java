...
public class ActionParametersTarget {
  ...
  public ActionParametersTarget() {
  }

  public ActionParametersTarget value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersTarget bindingProperties(ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersTarget collectionBindingProperties(ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersTarget defaultValue(String defaultValue) {
  ...
  public ActionParametersTarget model(String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersTarget bindings(Map bindings) {
  ...
  public ActionParametersTarget event(String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersTarget userAttribute(String userAttribute) {
  ...
  public ActionParametersTarget concat(List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersTarget condition(ComponentPropertyCondition condition) {
  ...
  public ActionParametersTarget configured(Boolean configured) {
  ...
  public ActionParametersTarget type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersTarget importedValue(String importedValue) {
  ...
  public ActionParametersTarget componentName(String componentName) {
  ...
  public ActionParametersTarget property(String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersTarget actionParametersTarget = (ActionParametersTarget) o;
    return Objects.equals(this.value, actionParametersTarget.value) &&
        Objects.equals(this.bindingProperties, actionParametersTarget.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersTarget.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersTarget.defaultValue) &&
        Objects.equals(this.model, actionParametersTarget.model) &&
        Objects.equals(this.bindings, actionParametersTarget.bindings) &&
        Objects.equals(this.event, actionParametersTarget.event) &&
        Objects.equals(this.userAttribute, actionParametersTarget.userAttribute) &&
        Objects.equals(this.concat, actionParametersTarget.concat) &&
        Objects.equals(this.condition, actionParametersTarget.condition) &&
        Objects.equals(this.configured, actionParametersTarget.configured) &&
        Objects.equals(this.type, actionParametersTarget.type) &&
        Objects.equals(this.importedValue, actionParametersTarget.importedValue) &&
        Objects.equals(this.componentName, actionParametersTarget.componentName) &&
        Objects.equals(this.property, actionParametersTarget.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersTarget {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersTarget is not found in the empty JSON string", ActionParametersTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersTarget>() {
           @Override
           public void write(JsonWriter out, ActionParametersTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersTarget
   * @throws IOException if the JSON string is invalid with respect to ActionParametersTarget
   */
  public static ActionParametersTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersTarget.class);
  }

  /**
   * Convert an instance of ActionParametersTarget to an JSON string
   *
   * @return JSON string
   */
