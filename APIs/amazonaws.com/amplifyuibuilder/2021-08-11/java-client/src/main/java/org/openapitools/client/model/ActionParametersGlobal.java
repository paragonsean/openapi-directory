...
public class ActionParametersGlobal {
  ...
  public ActionParametersGlobal() {
  }

  public ActionParametersGlobal value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ActionParametersGlobal bindingProperties(ComponentPropertyBindingProperties bindingProperties) {
  ...
  public ActionParametersGlobal collectionBindingProperties(ComponentPropertyCollectionBindingProperties collectionBindingProperties) {
  ...
  public ActionParametersGlobal defaultValue(String defaultValue) {
  ...
  public ActionParametersGlobal model(String model) {
    this.model = model;
    return this;
  }
  ...
  public ActionParametersGlobal bindings(Map bindings) {
  ...
  public ActionParametersGlobal event(String event) {
    this.event = event;
    return this;
  }
  ...
  public ActionParametersGlobal userAttribute(String userAttribute) {
  ...
  public ActionParametersGlobal concat(List concat) {
    this.concat = concat;
    return this;
  }
  ...
  public ActionParametersGlobal condition(ComponentPropertyCondition condition) {
  ...
  public ActionParametersGlobal configured(Boolean configured) {
  ...
  public ActionParametersGlobal type(String type) {
    this.type = type;
    return this;
  }
  ...
  public ActionParametersGlobal importedValue(String importedValue) {
  ...
  public ActionParametersGlobal componentName(String componentName) {
  ...
  public ActionParametersGlobal property(String property) {
  ...
  public boolean equals(Object o) {
    ...
    ActionParametersGlobal actionParametersGlobal = (ActionParametersGlobal) o;
    return Objects.equals(this.value, actionParametersGlobal.value) &&
        Objects.equals(this.bindingProperties, actionParametersGlobal.bindingProperties) &&
        Objects.equals(this.collectionBindingProperties, actionParametersGlobal.collectionBindingProperties) &&
        Objects.equals(this.defaultValue, actionParametersGlobal.defaultValue) &&
        Objects.equals(this.model, actionParametersGlobal.model) &&
        Objects.equals(this.bindings, actionParametersGlobal.bindings) &&
        Objects.equals(this.event, actionParametersGlobal.event) &&
        Objects.equals(this.userAttribute, actionParametersGlobal.userAttribute) &&
        Objects.equals(this.concat, actionParametersGlobal.concat) &&
        Objects.equals(this.condition, actionParametersGlobal.condition) &&
        Objects.equals(this.configured, actionParametersGlobal.configured) &&
        Objects.equals(this.type, actionParametersGlobal.type) &&
        Objects.equals(this.importedValue, actionParametersGlobal.importedValue) &&
        Objects.equals(this.componentName, actionParametersGlobal.componentName) &&
        Objects.equals(this.property, actionParametersGlobal.property);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionParametersGlobal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionParametersGlobal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionParametersGlobal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionParametersGlobal is not found in the empty JSON string", ActionParametersGlobal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionParametersGlobal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionParametersGlobal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionParametersGlobal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionParametersGlobal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionParametersGlobal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionParametersGlobal.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionParametersGlobal>() {
           @Override
           public void write(JsonWriter out, ActionParametersGlobal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionParametersGlobal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionParametersGlobal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionParametersGlobal
   * @throws IOException if the JSON string is invalid with respect to ActionParametersGlobal
   */
  public static ActionParametersGlobal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionParametersGlobal.class);
  }

  /**
   * Convert an instance of ActionParametersGlobal to an JSON string
   *
   * @return JSON string
   */
