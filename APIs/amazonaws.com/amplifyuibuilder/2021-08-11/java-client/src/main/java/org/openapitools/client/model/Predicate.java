...
public class Predicate {
  ...
  public Predicate field(String field) {
    this.field = field;
    return this;
  }
  ...
  public Predicate operator(String operator) {
  ...
  public Predicate operand(String operand) {
  ...
  public Predicate operandType(String operandType) {
