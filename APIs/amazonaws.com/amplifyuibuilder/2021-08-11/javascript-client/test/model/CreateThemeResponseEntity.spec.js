...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CreateThemeResponseEntity();
  });
  ...
  describe('CreateThemeResponseEntity', function() {
    it('should create an instance of CreateThemeResponseEntity', function() {
      // uncomment below and update the code to test CreateThemeResponseEntity
      //var instance = new AwsAmplifyUiBuilder.CreateThemeResponseEntity();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CreateThemeResponseEntity);
    });
