...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FieldConfig();
  });
  ...
  describe('FieldConfig', function() {
    it('should create an instance of FieldConfig', function() {
      // uncomment below and update the code to test FieldConfig
      //var instance = new AwsAmplifyUiBuilder.FieldConfig();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FieldConfig);
    });
