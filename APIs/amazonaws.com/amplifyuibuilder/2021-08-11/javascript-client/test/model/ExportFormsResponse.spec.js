...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ExportFormsResponse();
  });
  ...
  describe('ExportFormsResponse', function() {
    it('should create an instance of ExportFormsResponse', function() {
      // uncomment below and update the code to test ExportFormsResponse
      //var instance = new AwsAmplifyUiBuilder.ExportFormsResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ExportFormsResponse);
    });
