...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersGlobal();
  });
  ...
  describe('ActionParametersGlobal', function() {
    it('should create an instance of ActionParametersGlobal', function() {
      // uncomment below and update the code to test ActionParametersGlobal
      //var instance = new AwsAmplifyUiBuilder.ActionParametersGlobal();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersGlobal);
    });
