...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormCta();
  });
  ...
  describe('FormCta', function() {
    it('should create an instance of FormCta', function() {
      // uncomment below and update the code to test FormCta
      //var instance = new AwsAmplifyUiBuilder.FormCta();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormCta);
    });
