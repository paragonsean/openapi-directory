...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.UpdateComponentRequestUpdatedComponent();
  });
  ...
  describe('UpdateComponentRequestUpdatedComponent', function() {
    it('should create an instance of UpdateComponentRequestUpdatedComponent', function() {
      // uncomment below and update the code to test UpdateComponentRequestUpdatedComponent
      //var instance = new AwsAmplifyUiBuilder.UpdateComponentRequestUpdatedComponent();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.UpdateComponentRequestUpdatedComponent);
    });
