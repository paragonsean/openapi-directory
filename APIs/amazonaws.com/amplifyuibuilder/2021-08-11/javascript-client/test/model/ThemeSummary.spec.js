...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ThemeSummary();
  });
  ...
  describe('ThemeSummary', function() {
    it('should create an instance of ThemeSummary', function() {
      // uncomment below and update the code to test ThemeSummary
      //var instance = new AwsAmplifyUiBuilder.ThemeSummary();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ThemeSummary);
    });
