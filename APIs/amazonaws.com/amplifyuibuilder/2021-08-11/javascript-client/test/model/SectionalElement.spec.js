...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.SectionalElement();
  });
  ...
  describe('SectionalElement', function() {
    it('should create an instance of SectionalElement', function() {
      // uncomment below and update the code to test SectionalElement
      //var instance = new AwsAmplifyUiBuilder.SectionalElement();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.SectionalElement);
    });
