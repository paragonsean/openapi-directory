...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentConditionPropertyElse();
  });
  ...
  describe('ComponentConditionPropertyElse', function() {
    it('should create an instance of ComponentConditionPropertyElse', function() {
      // uncomment below and update the code to test ComponentConditionPropertyElse
      //var instance = new AwsAmplifyUiBuilder.ComponentConditionPropertyElse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentConditionPropertyElse);
    });
