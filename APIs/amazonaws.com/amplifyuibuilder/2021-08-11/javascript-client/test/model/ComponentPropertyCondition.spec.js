...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentPropertyCondition();
  });
  ...
  describe('ComponentPropertyCondition', function() {
    it('should create an instance of ComponentPropertyCondition', function() {
      // uncomment below and update the code to test ComponentPropertyCondition
      //var instance = new AwsAmplifyUiBuilder.ComponentPropertyCondition();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentPropertyCondition);
    });
    ...
    it('should have the property _else (base name: "else")', function() {
      // uncomment below and update the code to test the property _else
      //var instance = new AwsAmplifyUiBuilder.ComponentPropertyCondition();
      //expect(instance).to.be();
    });

    it('should have the property operandType (base name: "operandType")', function() {
      // uncomment below and update the code to test the property operandType
      //var instance = new AwsAmplifyUiBuilder.ComponentPropertyCondition();
      //expect(instance).to.be();
    });
