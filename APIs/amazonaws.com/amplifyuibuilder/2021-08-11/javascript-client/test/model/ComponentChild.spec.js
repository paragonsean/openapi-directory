...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentChild();
  });
  ...
  describe('ComponentChild', function() {
    it('should create an instance of ComponentChild', function() {
      // uncomment below and update the code to test ComponentChild
      //var instance = new AwsAmplifyUiBuilder.ComponentChild();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentChild);
    });
