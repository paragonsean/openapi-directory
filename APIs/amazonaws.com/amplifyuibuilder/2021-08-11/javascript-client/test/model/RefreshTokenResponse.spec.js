...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.RefreshTokenResponse();
  });
  ...
  describe('RefreshTokenResponse', function() {
    it('should create an instance of RefreshTokenResponse', function() {
      // uncomment below and update the code to test RefreshTokenResponse
      //var instance = new AwsAmplifyUiBuilder.RefreshTokenResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.RefreshTokenResponse);
    });
