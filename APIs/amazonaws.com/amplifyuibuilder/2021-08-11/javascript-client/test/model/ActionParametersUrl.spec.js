...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersUrl();
  });
  ...
  describe('ActionParametersUrl', function() {
    it('should create an instance of ActionParametersUrl', function() {
      // uncomment below and update the code to test ActionParametersUrl
      //var instance = new AwsAmplifyUiBuilder.ActionParametersUrl();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersUrl);
    });
