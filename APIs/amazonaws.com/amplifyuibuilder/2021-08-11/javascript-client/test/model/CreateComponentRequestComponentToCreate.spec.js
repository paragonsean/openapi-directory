...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CreateComponentRequestComponentToCreate();
  });
  ...
  describe('CreateComponentRequestComponentToCreate', function() {
    it('should create an instance of CreateComponentRequestComponentToCreate', function() {
      // uncomment below and update the code to test CreateComponentRequestComponentToCreate
      //var instance = new AwsAmplifyUiBuilder.CreateComponentRequestComponentToCreate();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CreateComponentRequestComponentToCreate);
    });
