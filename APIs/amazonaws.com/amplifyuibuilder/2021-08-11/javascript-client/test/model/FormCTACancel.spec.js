...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormCTACancel();
  });
  ...
  describe('FormCTACancel', function() {
    it('should create an instance of FormCTACancel', function() {
      // uncomment below and update the code to test FormCTACancel
      //var instance = new AwsAmplifyUiBuilder.FormCTACancel();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormCTACancel);
    });
