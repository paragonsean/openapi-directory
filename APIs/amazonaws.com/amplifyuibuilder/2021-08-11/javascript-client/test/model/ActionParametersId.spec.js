...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersId();
  });
  ...
  describe('ActionParametersId', function() {
    it('should create an instance of ActionParametersId', function() {
      // uncomment below and update the code to test ActionParametersId
      //var instance = new AwsAmplifyUiBuilder.ActionParametersId();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersId);
    });
