...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersAnchor();
  });
  ...
  describe('ActionParametersAnchor', function() {
    it('should create an instance of ActionParametersAnchor', function() {
      // uncomment below and update the code to test ActionParametersAnchor
      //var instance = new AwsAmplifyUiBuilder.ActionParametersAnchor();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersAnchor);
    });
