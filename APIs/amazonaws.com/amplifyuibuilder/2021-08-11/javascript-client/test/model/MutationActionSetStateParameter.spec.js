...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.MutationActionSetStateParameter();
  });
  ...
  describe('MutationActionSetStateParameter', function() {
    it('should create an instance of MutationActionSetStateParameter', function() {
      // uncomment below and update the code to test MutationActionSetStateParameter
      //var instance = new AwsAmplifyUiBuilder.MutationActionSetStateParameter();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.MutationActionSetStateParameter);
    });
