...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.SortProperty();
  });
  ...
  describe('SortProperty', function() {
    it('should create an instance of SortProperty', function() {
      // uncomment below and update the code to test SortProperty
      //var instance = new AwsAmplifyUiBuilder.SortProperty();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.SortProperty);
    });
