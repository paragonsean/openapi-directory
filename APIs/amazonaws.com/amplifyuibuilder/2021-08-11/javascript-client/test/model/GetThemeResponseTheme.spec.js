...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.GetThemeResponseTheme();
  });
  ...
  describe('GetThemeResponseTheme', function() {
    it('should create an instance of GetThemeResponseTheme', function() {
      // uncomment below and update the code to test GetThemeResponseTheme
      //var instance = new AwsAmplifyUiBuilder.GetThemeResponseTheme();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.GetThemeResponseTheme);
    });
