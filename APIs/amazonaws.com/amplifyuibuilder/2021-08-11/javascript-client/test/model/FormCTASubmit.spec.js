...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormCTASubmit();
  });
  ...
  describe('FormCTASubmit', function() {
    it('should create an instance of FormCTASubmit', function() {
      // uncomment below and update the code to test FormCTASubmit
      //var instance = new AwsAmplifyUiBuilder.FormCTASubmit();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormCTASubmit);
    });
