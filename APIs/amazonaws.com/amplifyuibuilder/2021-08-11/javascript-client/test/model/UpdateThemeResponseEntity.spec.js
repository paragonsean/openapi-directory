...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.UpdateThemeResponseEntity();
  });
  ...
  describe('UpdateThemeResponseEntity', function() {
    it('should create an instance of UpdateThemeResponseEntity', function() {
      // uncomment below and update the code to test UpdateThemeResponseEntity
      //var instance = new AwsAmplifyUiBuilder.UpdateThemeResponseEntity();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.UpdateThemeResponseEntity);
    });
