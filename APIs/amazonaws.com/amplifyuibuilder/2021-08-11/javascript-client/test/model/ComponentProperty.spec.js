...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentProperty();
  });
  ...
  describe('ComponentProperty', function() {
    it('should create an instance of ComponentProperty', function() {
      // uncomment below and update the code to test ComponentProperty
      //var instance = new AwsAmplifyUiBuilder.ComponentProperty();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentProperty);
    });
