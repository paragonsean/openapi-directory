...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.Predicate();
  });
  ...
  describe('Predicate', function() {
    it('should create an instance of Predicate', function() {
      // uncomment below and update the code to test Predicate
      //var instance = new AwsAmplifyUiBuilder.Predicate();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.Predicate);
    });
