...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormCTAClear();
  });
  ...
  describe('FormCTAClear', function() {
    it('should create an instance of FormCTAClear', function() {
      // uncomment below and update the code to test FormCTAClear
      //var instance = new AwsAmplifyUiBuilder.FormCTAClear();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormCTAClear);
    });
