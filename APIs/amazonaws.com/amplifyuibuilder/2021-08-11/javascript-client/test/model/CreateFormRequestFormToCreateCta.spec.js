...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CreateFormRequestFormToCreateCta();
  });
  ...
  describe('CreateFormRequestFormToCreateCta', function() {
    it('should create an instance of CreateFormRequestFormToCreateCta', function() {
      // uncomment below and update the code to test CreateFormRequestFormToCreateCta
      //var instance = new AwsAmplifyUiBuilder.CreateFormRequestFormToCreateCta();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CreateFormRequestFormToCreateCta);
    });
