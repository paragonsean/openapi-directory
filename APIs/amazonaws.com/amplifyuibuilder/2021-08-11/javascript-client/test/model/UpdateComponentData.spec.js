...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.UpdateComponentData();
  });
  ...
  describe('UpdateComponentData', function() {
    it('should create an instance of UpdateComponentData', function() {
      // uncomment below and update the code to test UpdateComponentData
      //var instance = new AwsAmplifyUiBuilder.UpdateComponentData();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.UpdateComponentData);
    });
