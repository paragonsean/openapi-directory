...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ListThemesResponse();
  });
  ...
  describe('ListThemesResponse', function() {
    it('should create an instance of ListThemesResponse', function() {
      // uncomment below and update the code to test ListThemesResponse
      //var instance = new AwsAmplifyUiBuilder.ListThemesResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ListThemesResponse);
    });
