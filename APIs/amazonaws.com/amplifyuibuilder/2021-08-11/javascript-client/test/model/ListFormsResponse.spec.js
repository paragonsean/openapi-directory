...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ListFormsResponse();
  });
  ...
  describe('ListFormsResponse', function() {
    it('should create an instance of ListFormsResponse', function() {
      // uncomment below and update the code to test ListFormsResponse
      //var instance = new AwsAmplifyUiBuilder.ListFormsResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ListFormsResponse);
    });
