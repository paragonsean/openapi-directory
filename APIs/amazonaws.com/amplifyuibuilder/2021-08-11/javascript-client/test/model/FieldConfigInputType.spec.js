...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FieldConfigInputType();
  });
  ...
  describe('FieldConfigInputType', function() {
    it('should create an instance of FieldConfigInputType', function() {
      // uncomment below and update the code to test FieldConfigInputType
      //var instance = new AwsAmplifyUiBuilder.FieldConfigInputType();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FieldConfigInputType);
    });
