...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormBindingElement();
  });
  ...
  describe('FormBindingElement', function() {
    it('should create an instance of FormBindingElement', function() {
      // uncomment below and update the code to test FormBindingElement
      //var instance = new AwsAmplifyUiBuilder.FormBindingElement();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormBindingElement);
    });
