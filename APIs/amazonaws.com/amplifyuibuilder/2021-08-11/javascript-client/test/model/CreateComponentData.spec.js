...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CreateComponentData();
  });
  ...
  describe('CreateComponentData', function() {
    it('should create an instance of CreateComponentData', function() {
      // uncomment below and update the code to test CreateComponentData
      //var instance = new AwsAmplifyUiBuilder.CreateComponentData();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CreateComponentData);
    });
