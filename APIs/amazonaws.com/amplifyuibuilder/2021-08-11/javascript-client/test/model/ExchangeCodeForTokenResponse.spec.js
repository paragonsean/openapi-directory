...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ExchangeCodeForTokenResponse();
  });
  ...
  describe('ExchangeCodeForTokenResponse', function() {
    it('should create an instance of ExchangeCodeForTokenResponse', function() {
      // uncomment below and update the code to test ExchangeCodeForTokenResponse
      //var instance = new AwsAmplifyUiBuilder.ExchangeCodeForTokenResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ExchangeCodeForTokenResponse);
    });
