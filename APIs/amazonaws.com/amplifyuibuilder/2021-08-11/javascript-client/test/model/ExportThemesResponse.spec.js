...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ExportThemesResponse();
  });
  ...
  describe('ExportThemesResponse', function() {
    it('should create an instance of ExportThemesResponse', function() {
      // uncomment below and update the code to test ExportThemesResponse
      //var instance = new AwsAmplifyUiBuilder.ExportThemesResponse();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ExportThemesResponse);
    });
