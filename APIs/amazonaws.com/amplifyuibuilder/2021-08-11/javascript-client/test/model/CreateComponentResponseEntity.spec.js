...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CreateComponentResponseEntity();
  });
  ...
  describe('CreateComponentResponseEntity', function() {
    it('should create an instance of CreateComponentResponseEntity', function() {
      // uncomment below and update the code to test CreateComponentResponseEntity
      //var instance = new AwsAmplifyUiBuilder.CreateComponentResponseEntity();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CreateComponentResponseEntity);
    });
