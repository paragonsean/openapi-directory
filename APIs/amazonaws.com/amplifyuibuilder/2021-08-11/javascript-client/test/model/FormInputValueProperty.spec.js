...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormInputValueProperty();
  });
  ...
  describe('FormInputValueProperty', function() {
    it('should create an instance of FormInputValueProperty', function() {
      // uncomment below and update the code to test FormInputValueProperty
      //var instance = new AwsAmplifyUiBuilder.FormInputValueProperty();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormInputValueProperty);
    });
