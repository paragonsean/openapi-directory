...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormSummary();
  });
  ...
  describe('FormSummary', function() {
    it('should create an instance of FormSummary', function() {
      // uncomment below and update the code to test FormSummary
      //var instance = new AwsAmplifyUiBuilder.FormSummary();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormSummary);
    });
