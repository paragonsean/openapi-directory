...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.CodegenJob();
  });
  ...
  describe('CodegenJob', function() {
    it('should create an instance of CodegenJob', function() {
      // uncomment below and update the code to test CodegenJob
      //var instance = new AwsAmplifyUiBuilder.CodegenJob();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.CodegenJob);
    });
