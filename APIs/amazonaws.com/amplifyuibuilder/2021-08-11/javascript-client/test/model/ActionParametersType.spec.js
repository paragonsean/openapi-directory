...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersType();
  });
  ...
  describe('ActionParametersType', function() {
    it('should create an instance of ActionParametersType', function() {
      // uncomment below and update the code to test ActionParametersType
      //var instance = new AwsAmplifyUiBuilder.ActionParametersType();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersType);
    });
