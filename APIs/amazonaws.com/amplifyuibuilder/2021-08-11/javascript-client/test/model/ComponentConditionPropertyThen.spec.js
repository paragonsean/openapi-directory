...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentConditionPropertyThen();
  });
  ...
  describe('ComponentConditionPropertyThen', function() {
    it('should create an instance of ComponentConditionPropertyThen', function() {
      // uncomment below and update the code to test ComponentConditionPropertyThen
      //var instance = new AwsAmplifyUiBuilder.ComponentConditionPropertyThen();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentConditionPropertyThen);
    });
