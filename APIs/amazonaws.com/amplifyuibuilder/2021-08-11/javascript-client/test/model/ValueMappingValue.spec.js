...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ValueMappingValue();
  });
  ...
  describe('ValueMappingValue', function() {
    it('should create an instance of ValueMappingValue', function() {
      // uncomment below and update the code to test ValueMappingValue
      //var instance = new AwsAmplifyUiBuilder.ValueMappingValue();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ValueMappingValue);
    });
