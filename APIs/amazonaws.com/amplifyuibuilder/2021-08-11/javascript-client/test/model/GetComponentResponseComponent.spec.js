...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.GetComponentResponseComponent();
  });
  ...
  describe('GetComponentResponseComponent', function() {
    it('should create an instance of GetComponentResponseComponent', function() {
      // uncomment below and update the code to test GetComponentResponseComponent
      //var instance = new AwsAmplifyUiBuilder.GetComponentResponseComponent();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.GetComponentResponseComponent);
    });
