...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.FormButton();
  });
  ...
  describe('FormButton', function() {
    it('should create an instance of FormButton', function() {
      // uncomment below and update the code to test FormButton
      //var instance = new AwsAmplifyUiBuilder.FormButton();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.FormButton);
    });
