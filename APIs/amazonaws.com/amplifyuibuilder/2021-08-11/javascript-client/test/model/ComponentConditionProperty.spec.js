...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentConditionProperty();
  });
  ...
  describe('ComponentConditionProperty', function() {
    it('should create an instance of ComponentConditionProperty', function() {
      // uncomment below and update the code to test ComponentConditionProperty
      //var instance = new AwsAmplifyUiBuilder.ComponentConditionProperty();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentConditionProperty);
    });
