...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.StartCodegenJobResponseEntity();
  });
  ...
  describe('StartCodegenJobResponseEntity', function() {
    it('should create an instance of StartCodegenJobResponseEntity', function() {
      // uncomment below and update the code to test StartCodegenJobResponseEntity
      //var instance = new AwsAmplifyUiBuilder.StartCodegenJobResponseEntity();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.StartCodegenJobResponseEntity);
    });
