...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ComponentDataConfigurationPredicate();
  });
  ...
  describe('ComponentDataConfigurationPredicate', function() {
    it('should create an instance of ComponentDataConfigurationPredicate', function() {
      // uncomment below and update the code to test ComponentDataConfigurationPredicate
      //var instance = new AwsAmplifyUiBuilder.ComponentDataConfigurationPredicate();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ComponentDataConfigurationPredicate);
    });
