...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.UpdateComponentResponseEntity();
  });
  ...
  describe('UpdateComponentResponseEntity', function() {
    it('should create an instance of UpdateComponentResponseEntity', function() {
      // uncomment below and update the code to test UpdateComponentResponseEntity
      //var instance = new AwsAmplifyUiBuilder.UpdateComponentResponseEntity();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.UpdateComponentResponseEntity);
    });
