...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAmplifyUiBuilder.ActionParametersState();
  });
  ...
  describe('ActionParametersState', function() {
    it('should create an instance of ActionParametersState', function() {
      // uncomment below and update the code to test ActionParametersState
      //var instance = new AwsAmplifyUiBuilder.ActionParametersState();
      //expect(instance).to.be.a(AwsAmplifyUiBuilder.ActionParametersState);
    });
