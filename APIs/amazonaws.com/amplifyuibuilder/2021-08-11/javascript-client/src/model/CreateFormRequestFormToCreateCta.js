...
/**
 * The CreateFormRequestFormToCreateCta model module.
 * @module model/CreateFormRequestFormToCreateCta
 * @version 2021-08-11
 */
class CreateFormRequestFormToCreateCta {
    /**
     * Constructs a new <code>CreateFormRequestFormToCreateCta</code>.
     * @alias module:model/CreateFormRequestFormToCreateCta
     * @implements module:model/FormCTA
     */
    constructor() { 
        FormCTA.initialize(this);
        CreateFormRequestFormToCreateCta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFormRequestFormToCreateCta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFormRequestFormToCreateCta} obj Optional instance to populate.
     * @return {module:model/CreateFormRequestFormToCreateCta} The populated <code>CreateFormRequestFormToCreateCta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFormRequestFormToCreateCta();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFormRequestFormToCreateCta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFormRequestFormToCreateCta</code>.
     */
 ...
 */
CreateFormRequestFormToCreateCta.prototype['position'] = undefined;

/**
 * @member {module:model/FormCTAClear} clear
 */
CreateFormRequestFormToCreateCta.prototype['clear'] = undefined;

/**
 * @member {module:model/FormCTACancel} cancel
 */
CreateFormRequestFormToCreateCta.prototype['cancel'] = undefined;

/**
 * @member {module:model/FormCTASubmit} submit
 */
CreateFormRequestFormToCreateCta.prototype['submit'] = undefined;
...
export default CreateFormRequestFormToCreateCta;
