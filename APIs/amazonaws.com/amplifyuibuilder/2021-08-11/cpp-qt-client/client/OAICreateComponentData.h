...
/*
 * OAICreateComponentData.h
 *
 * Represents all of the information that is required to create a component.
 */

#ifndef OAICreateComponentData_H
#define OAICreateComponentData_H
...
class OAICreateComponentData : public OAIObject {
public:
    OAICreateComponentData();
    OAICreateComponentData(QString json);
    ~OAICreateComponentData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateComponentData)

#endif // OAICreateComponentData_H
