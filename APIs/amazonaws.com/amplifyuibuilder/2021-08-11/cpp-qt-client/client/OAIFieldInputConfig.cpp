...
OAIFieldInputConfig::OAIFieldInputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFieldInputConfig::OAIFieldInputConfig() {
    this->initializeModel();
}

OAIFieldInputConfig::~OAIFieldInputConfig() {}

void OAIFieldInputConfig::initializeModel() {
...
void OAIFieldInputConfig::fromJson(QString jsonString) {
...
void OAIFieldInputConfig::fromJsonObject(QJsonObject json) {
...
QString OAIFieldInputConfig::asJson() const {
...
QJsonObject OAIFieldInputConfig::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAIFieldInputConfig::getType() const {
    return m_type;
}
void OAIFieldInputConfig::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFieldInputConfig::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFieldInputConfig::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFieldInputConfig::getRequired() const {
    return m_required;
}
void OAIFieldInputConfig::setRequired(const bool &required) {
    m_required = required;
    m_required_isSet = true;
}

bool OAIFieldInputConfig::is_required_Set() const{
    return m_required_isSet;
}

bool OAIFieldInputConfig::is_required_Valid() const{
    return m_required_isValid;
}

bool OAIFieldInputConfig::getReadOnly() const {
    return m_read_only;
}
void OAIFieldInputConfig::setReadOnly(const bool &read_only) {
    m_read_only = read_only;
    m_read_only_isSet = true;
}

bool OAIFieldInputConfig::is_read_only_Set() const{
    return m_read_only_isSet;
}

bool OAIFieldInputConfig::is_read_only_Valid() const{
    return m_read_only_isValid;
}

QString OAIFieldInputConfig::getPlaceholder() const {
    return m_placeholder;
}
void OAIFieldInputConfig::setPlaceholder(const QString &placeholder) {
    m_placeholder = placeholder;
    m_placeholder_isSet = true;
}

bool OAIFieldInputConfig::is_placeholder_Set() const{
    return m_placeholder_isSet;
}

bool OAIFieldInputConfig::is_placeholder_Valid() const{
    return m_placeholder_isValid;
}

QString OAIFieldInputConfig::getDefaultValue() const {
    return m_default_value;
}
void OAIFieldInputConfig::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIFieldInputConfig::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIFieldInputConfig::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIFieldInputConfig::getDescriptiveText() const {
    return m_descriptive_text;
}
void OAIFieldInputConfig::setDescriptiveText(const QString &descriptive_text) {
    m_descriptive_text = descriptive_text;
    m_descriptive_text_isSet = true;
}

bool OAIFieldInputConfig::is_descriptive_text_Set() const{
    return m_descriptive_text_isSet;
}

bool OAIFieldInputConfig::is_descriptive_text_Valid() const{
    return m_descriptive_text_isValid;
}

bool OAIFieldInputConfig::getDefaultChecked() const {
    return m_default_checked;
}
void OAIFieldInputConfig::setDefaultChecked(const bool &default_checked) {
    m_default_checked = default_checked;
    m_default_checked_isSet = true;
}

bool OAIFieldInputConfig::is_default_checked_Set() const{
    return m_default_checked_isSet;
}

bool OAIFieldInputConfig::is_default_checked_Valid() const{
    return m_default_checked_isValid;
}

QString OAIFieldInputConfig::getDefaultCountryCode() const {
    return m_default_country_code;
}
void OAIFieldInputConfig::setDefaultCountryCode(const QString &default_country_code) {
    m_default_country_code = default_country_code;
    m_default_country_code_isSet = true;
}

bool OAIFieldInputConfig::is_default_country_code_Set() const{
    return m_default_country_code_isSet;
}

bool OAIFieldInputConfig::is_default_country_code_Valid() const{
    return m_default_country_code_isValid;
}

OAIFieldInputConfig_valueMappings OAIFieldInputConfig::getValueMappings() const {
    return m_value_mappings;
}
void OAIFieldInputConfig::setValueMappings(const OAIFieldInputConfig_valueMappings &value_mappings) {
    m_value_mappings = value_mappings;
    m_value_mappings_isSet = true;
}

bool OAIFieldInputConfig::is_value_mappings_Set() const{
    return m_value_mappings_isSet;
}

bool OAIFieldInputConfig::is_value_mappings_Valid() const{
    return m_value_mappings_isValid;
}

QString OAIFieldInputConfig::getName() const {
    return m_name;
}
void OAIFieldInputConfig::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFieldInputConfig::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFieldInputConfig::is_name_Valid() const{
    return m_name_isValid;
}

float OAIFieldInputConfig::getMinValue() const {
    return m_min_value;
}
void OAIFieldInputConfig::setMinValue(const float &min_value) {
    m_min_value = min_value;
    m_min_value_isSet = true;
}

bool OAIFieldInputConfig::is_min_value_Set() const{
    return m_min_value_isSet;
}

bool OAIFieldInputConfig::is_min_value_Valid() const{
    return m_min_value_isValid;
}

float OAIFieldInputConfig::getMaxValue() const {
    return m_max_value;
}
void OAIFieldInputConfig::setMaxValue(const float &max_value) {
    m_max_value = max_value;
    m_max_value_isSet = true;
}

bool OAIFieldInputConfig::is_max_value_Set() const{
    return m_max_value_isSet;
}

bool OAIFieldInputConfig::is_max_value_Valid() const{
    return m_max_value_isValid;
}

float OAIFieldInputConfig::getStep() const {
    return m_step;
}
void OAIFieldInputConfig::setStep(const float &step) {
    m_step = step;
    m_step_isSet = true;
}

bool OAIFieldInputConfig::is_step_Set() const{
    return m_step_isSet;
}

bool OAIFieldInputConfig::is_step_Valid() const{
    return m_step_isValid;
}

QString OAIFieldInputConfig::getValue() const {
    return m_value;
}
void OAIFieldInputConfig::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFieldInputConfig::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFieldInputConfig::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIFieldInputConfig::getIsArray() const {
    return m_is_array;
}
void OAIFieldInputConfig::setIsArray(const bool &is_array) {
    m_is_array = is_array;
    m_is_array_isSet = true;
}

bool OAIFieldInputConfig::is_is_array_Set() const{
    return m_is_array_isSet;
}

bool OAIFieldInputConfig::is_is_array_Valid() const{
    return m_is_array_isValid;
}

OAIFieldInputConfig_fileUploaderConfig OAIFieldInputConfig::getFileUploaderConfig() const {
    return m_file_uploader_config;
}
void OAIFieldInputConfig::setFileUploaderConfig(const OAIFieldInputConfig_fileUploaderConfig &file_uploader_config) {
    m_file_uploader_config = file_uploader_config;
    m_file_uploader_config_isSet = true;
}

bool OAIFieldInputConfig::is_file_uploader_config_Set() const{
    return m_file_uploader_config_isSet;
}

bool OAIFieldInputConfig::is_file_uploader_config_Valid() const{
    return m_file_uploader_config_isValid;
}

bool OAIFieldInputConfig::isSet() const {
...
bool OAIFieldInputConfig::isValid() const {
