...
#include "OAIGraphQLRenderConfig.h"
...
OAIGraphQLRenderConfig::OAIGraphQLRenderConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGraphQLRenderConfig::OAIGraphQLRenderConfig() {
    this->initializeModel();
}

OAIGraphQLRenderConfig::~OAIGraphQLRenderConfig() {}

void OAIGraphQLRenderConfig::initializeModel() {
...
void OAIGraphQLRenderConfig::fromJson(QString jsonString) {
...
void OAIGraphQLRenderConfig::fromJsonObject(QJsonObject json) {
...
QString OAIGraphQLRenderConfig::asJson() const {
...
QJsonObject OAIGraphQLRenderConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGraphQLRenderConfig::getTypesFilePath() const {
    return m_types_file_path;
}
void OAIGraphQLRenderConfig::setTypesFilePath(const QString &types_file_path) {
    m_types_file_path = types_file_path;
    m_types_file_path_isSet = true;
}

bool OAIGraphQLRenderConfig::is_types_file_path_Set() const{
    return m_types_file_path_isSet;
}

bool OAIGraphQLRenderConfig::is_types_file_path_Valid() const{
    return m_types_file_path_isValid;
}

QString OAIGraphQLRenderConfig::getQueriesFilePath() const {
    return m_queries_file_path;
}
void OAIGraphQLRenderConfig::setQueriesFilePath(const QString &queries_file_path) {
    m_queries_file_path = queries_file_path;
    m_queries_file_path_isSet = true;
}

bool OAIGraphQLRenderConfig::is_queries_file_path_Set() const{
    return m_queries_file_path_isSet;
}

bool OAIGraphQLRenderConfig::is_queries_file_path_Valid() const{
    return m_queries_file_path_isValid;
}

QString OAIGraphQLRenderConfig::getMutationsFilePath() const {
    return m_mutations_file_path;
}
void OAIGraphQLRenderConfig::setMutationsFilePath(const QString &mutations_file_path) {
    m_mutations_file_path = mutations_file_path;
    m_mutations_file_path_isSet = true;
}

bool OAIGraphQLRenderConfig::is_mutations_file_path_Set() const{
    return m_mutations_file_path_isSet;
}

bool OAIGraphQLRenderConfig::is_mutations_file_path_Valid() const{
    return m_mutations_file_path_isValid;
}

QString OAIGraphQLRenderConfig::getSubscriptionsFilePath() const {
    return m_subscriptions_file_path;
}
void OAIGraphQLRenderConfig::setSubscriptionsFilePath(const QString &subscriptions_file_path) {
    m_subscriptions_file_path = subscriptions_file_path;
    m_subscriptions_file_path_isSet = true;
}

bool OAIGraphQLRenderConfig::is_subscriptions_file_path_Set() const{
    return m_subscriptions_file_path_isSet;
}

bool OAIGraphQLRenderConfig::is_subscriptions_file_path_Valid() const{
    return m_subscriptions_file_path_isValid;
}

QString OAIGraphQLRenderConfig::getFragmentsFilePath() const {
    return m_fragments_file_path;
}
void OAIGraphQLRenderConfig::setFragmentsFilePath(const QString &fragments_file_path) {
    m_fragments_file_path = fragments_file_path;
    m_fragments_file_path_isSet = true;
}

bool OAIGraphQLRenderConfig::is_fragments_file_path_Set() const{
    return m_fragments_file_path_isSet;
}

bool OAIGraphQLRenderConfig::is_fragments_file_path_Valid() const{
    return m_fragments_file_path_isValid;
}

bool OAIGraphQLRenderConfig::isSet() const {
...
bool OAIGraphQLRenderConfig::isValid() const {
