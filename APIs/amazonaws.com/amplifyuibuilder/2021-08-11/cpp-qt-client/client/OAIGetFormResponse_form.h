...
/*
 * OAIGetFormResponse_form.h
 *
 * 
 */

#ifndef OAIGetFormResponse_form_H
#define OAIGetFormResponse_form_H
...
class OAIGetFormResponse_form : public OAIObject {
public:
    OAIGetFormResponse_form();
    OAIGetFormResponse_form(QString json);
    ~OAIGetFormResponse_form() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFormResponse_form)

#endif // OAIGetFormResponse_form_H
