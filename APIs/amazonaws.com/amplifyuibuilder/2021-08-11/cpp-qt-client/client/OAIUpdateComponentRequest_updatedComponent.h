...
/*
 * OAIUpdateComponentRequest_updatedComponent.h
 *
 * 
 */

#ifndef OAIUpdateComponentRequest_updatedComponent_H
#define OAIUpdateComponentRequest_updatedComponent_H
...
class OAIUpdateComponentRequest_updatedComponent : public OAIObject {
public:
    OAIUpdateComponentRequest_updatedComponent();
    OAIUpdateComponentRequest_updatedComponent(QString json);
    ~OAIUpdateComponentRequest_updatedComponent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateComponentRequest_updatedComponent)

#endif // OAIUpdateComponentRequest_updatedComponent_H
