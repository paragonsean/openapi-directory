...
/*
 * OAICodegenJobSummary.h
 *
 * A summary of the basic information about the code generation job.
 */

#ifndef OAICodegenJobSummary_H
#define OAICodegenJobSummary_H
...
class OAICodegenJobSummary : public OAIObject {
public:
    OAICodegenJobSummary();
    OAICodegenJobSummary(QString json);
    ~OAICodegenJobSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodegenJobSummary)

#endif // OAICodegenJobSummary_H
