...
OAIFieldInputConfig_fileUploaderConfig::OAIFieldInputConfig_fileUploaderConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFieldInputConfig_fileUploaderConfig::OAIFieldInputConfig_fileUploaderConfig() {
    this->initializeModel();
}

OAIFieldInputConfig_fileUploaderConfig::~OAIFieldInputConfig_fileUploaderConfig() {}

void OAIFieldInputConfig_fileUploaderConfig::initializeModel() {
...
void OAIFieldInputConfig_fileUploaderConfig::fromJson(QString jsonString) {
...
void OAIFieldInputConfig_fileUploaderConfig::fromJsonObject(QJsonObject json) {
...
QString OAIFieldInputConfig_fileUploaderConfig::asJson() const {
...
QJsonObject OAIFieldInputConfig_fileUploaderConfig::asJsonObject() const {
    QJsonObject obj;
...
OAIStorageAccessLevel OAIFieldInputConfig_fileUploaderConfig::getAccessLevel() const {
    return m_access_level;
}
void OAIFieldInputConfig_fileUploaderConfig::setAccessLevel(const OAIStorageAccessLevel &access_level) {
    m_access_level = access_level;
    m_access_level_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_access_level_Set() const{
    return m_access_level_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_access_level_Valid() const{
    return m_access_level_isValid;
}

QList OAIFieldInputConfig_fileUploaderConfig::getAcceptedFileTypes() const {
    return m_accepted_file_types;
}
void OAIFieldInputConfig_fileUploaderConfig::setAcceptedFileTypes(const QList &accepted_file_types) {
    m_accepted_file_types = accepted_file_types;
    m_accepted_file_types_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_accepted_file_types_Set() const{
    return m_accepted_file_types_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_accepted_file_types_Valid() const{
    return m_accepted_file_types_isValid;
}

bool OAIFieldInputConfig_fileUploaderConfig::getShowThumbnails() const {
    return m_show_thumbnails;
}
void OAIFieldInputConfig_fileUploaderConfig::setShowThumbnails(const bool &show_thumbnails) {
    m_show_thumbnails = show_thumbnails;
    m_show_thumbnails_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_show_thumbnails_Set() const{
    return m_show_thumbnails_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_show_thumbnails_Valid() const{
    return m_show_thumbnails_isValid;
}

bool OAIFieldInputConfig_fileUploaderConfig::getIsResumable() const {
    return m_is_resumable;
}
void OAIFieldInputConfig_fileUploaderConfig::setIsResumable(const bool &is_resumable) {
    m_is_resumable = is_resumable;
    m_is_resumable_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_is_resumable_Set() const{
    return m_is_resumable_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_is_resumable_Valid() const{
    return m_is_resumable_isValid;
}

qint32 OAIFieldInputConfig_fileUploaderConfig::getMaxFileCount() const {
    return m_max_file_count;
}
void OAIFieldInputConfig_fileUploaderConfig::setMaxFileCount(const qint32 &max_file_count) {
    m_max_file_count = max_file_count;
    m_max_file_count_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_max_file_count_Set() const{
    return m_max_file_count_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_max_file_count_Valid() const{
    return m_max_file_count_isValid;
}

qint32 OAIFieldInputConfig_fileUploaderConfig::getMaxSize() const {
    return m_max_size;
}
void OAIFieldInputConfig_fileUploaderConfig::setMaxSize(const qint32 &max_size) {
    m_max_size = max_size;
    m_max_size_isSet = true;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_max_size_Set() const{
    return m_max_size_isSet;
}

bool OAIFieldInputConfig_fileUploaderConfig::is_max_size_Valid() const{
    return m_max_size_isValid;
}

bool OAIFieldInputConfig_fileUploaderConfig::isSet() const {
...
bool OAIFieldInputConfig_fileUploaderConfig::isValid() const {
