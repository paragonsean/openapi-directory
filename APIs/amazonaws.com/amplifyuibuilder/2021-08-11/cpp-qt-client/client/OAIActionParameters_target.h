...
/*
 * OAIActionParameters_target.h
 *
 * 
 */

#ifndef OAIActionParameters_target_H
#define OAIActionParameters_target_H
...
class OAIActionParameters_target : public OAIObject {
public:
    OAIActionParameters_target();
    OAIActionParameters_target(QString json);
    ~OAIActionParameters_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_target)

#endif // OAIActionParameters_target_H
