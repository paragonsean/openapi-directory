...
/*
 * OAICreateThemeResponse_entity.h
 *
 * 
 */

#ifndef OAICreateThemeResponse_entity_H
#define OAICreateThemeResponse_entity_H
...
class OAICreateThemeResponse_entity : public OAIObject {
public:
    OAICreateThemeResponse_entity();
    OAICreateThemeResponse_entity(QString json);
    ~OAICreateThemeResponse_entity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateThemeResponse_entity)

#endif // OAICreateThemeResponse_entity_H
