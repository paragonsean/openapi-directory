...
/*
 * OAIActionParameters_url.h
 *
 * 
 */

#ifndef OAIActionParameters_url_H
#define OAIActionParameters_url_H
...
class OAIActionParameters_url : public OAIObject {
public:
    OAIActionParameters_url();
    OAIActionParameters_url(QString json);
    ~OAIActionParameters_url() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_url)

#endif // OAIActionParameters_url_H
