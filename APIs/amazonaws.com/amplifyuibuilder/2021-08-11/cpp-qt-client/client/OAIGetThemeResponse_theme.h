...
/*
 * OAIGetThemeResponse_theme.h
 *
 * 
 */

#ifndef OAIGetThemeResponse_theme_H
#define OAIGetThemeResponse_theme_H
...
class OAIGetThemeResponse_theme : public OAIObject {
public:
    OAIGetThemeResponse_theme();
    OAIGetThemeResponse_theme(QString json);
    ~OAIGetThemeResponse_theme() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetThemeResponse_theme)

#endif // OAIGetThemeResponse_theme_H
