...
#ifndef OAICreateFormData_H
#define OAICreateFormData_H
...
class OAICreateFormData : public OAIObject {
public:
    OAICreateFormData();
    OAICreateFormData(QString json);
    ~OAICreateFormData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFormData)

#endif // OAICreateFormData_H
