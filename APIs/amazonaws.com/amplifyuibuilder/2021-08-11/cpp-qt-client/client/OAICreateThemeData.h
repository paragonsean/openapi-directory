...
/*
 * OAICreateThemeData.h
 *
 * Represents all of the information that is required to create a theme.
 */

#ifndef OAICreateThemeData_H
#define OAICreateThemeData_H
...
class OAICreateThemeData : public OAIObject {
public:
    OAICreateThemeData();
    OAICreateThemeData(QString json);
    ~OAICreateThemeData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateThemeData)

#endif // OAICreateThemeData_H
