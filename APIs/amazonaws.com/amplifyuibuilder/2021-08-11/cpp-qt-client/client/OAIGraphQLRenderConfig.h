...
/*
 * OAIGraphQLRenderConfig.h
 *
 * Describes the GraphQL configuration for an API for a code generation job.
 */

#ifndef OAIGraphQLRenderConfig_H
#define OAIGraphQLRenderConfig_H
...
class OAIGraphQLRenderConfig : public OAIObject {
public:
    OAIGraphQLRenderConfig();
    OAIGraphQLRenderConfig(QString json);
    ~OAIGraphQLRenderConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGraphQLRenderConfig)

#endif // OAIGraphQLRenderConfig_H
