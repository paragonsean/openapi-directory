...
/*
 * OAIMutationActionSetStateParameter_set.h
 *
 * 
 */

#ifndef OAIMutationActionSetStateParameter_set_H
#define OAIMutationActionSetStateParameter_set_H
...
class OAIMutationActionSetStateParameter_set : public OAIObject {
public:
    OAIMutationActionSetStateParameter_set();
    OAIMutationActionSetStateParameter_set(QString json);
    ~OAIMutationActionSetStateParameter_set() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMutationActionSetStateParameter_set)

#endif // OAIMutationActionSetStateParameter_set_H
