...
/*
 * OAIRefreshTokenResponse.h
 *
 * 
 */

#ifndef OAIRefreshTokenResponse_H
#define OAIRefreshTokenResponse_H
...
class OAIRefreshTokenResponse : public OAIObject {
public:
    OAIRefreshTokenResponse();
    OAIRefreshTokenResponse(QString json);
    ~OAIRefreshTokenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshTokenResponse)

#endif // OAIRefreshTokenResponse_H
