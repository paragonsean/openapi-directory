...
/*
 * OAIActionParameters_type.h
 *
 * 
 */

#ifndef OAIActionParameters_type_H
#define OAIActionParameters_type_H
...
class OAIActionParameters_type : public OAIObject {
public:
    OAIActionParameters_type();
    OAIActionParameters_type(QString json);
    ~OAIActionParameters_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_type)

#endif // OAIActionParameters_type_H
