...
/*
 * OAIFormDataTypeConfig.h
 *
 * Describes the data type configuration for the data source associated with a form.
 */

#ifndef OAIFormDataTypeConfig_H
#define OAIFormDataTypeConfig_H
...
class OAIFormDataTypeConfig : public OAIObject {
public:
    OAIFormDataTypeConfig();
    OAIFormDataTypeConfig(QString json);
    ~OAIFormDataTypeConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormDataTypeConfig)

#endif // OAIFormDataTypeConfig_H
