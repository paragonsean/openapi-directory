...
/*
 * OAIComponentProperty_condition.h
 *
 * 
 */

#ifndef OAIComponentProperty_condition_H
#define OAIComponentProperty_condition_H
...
class OAIComponentProperty_condition : public OAIObject {
public:
    OAIComponentProperty_condition();
    OAIComponentProperty_condition(QString json);
    ~OAIComponentProperty_condition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentProperty_condition)

#endif // OAIComponentProperty_condition_H
