...
/*
 * OAIActionParameters_id.h
 *
 * 
 */

#ifndef OAIActionParameters_id_H
#define OAIActionParameters_id_H
...
class OAIActionParameters_id : public OAIObject {
public:
    OAIActionParameters_id();
    OAIActionParameters_id(QString json);
    ~OAIActionParameters_id() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_id)

#endif // OAIActionParameters_id_H
