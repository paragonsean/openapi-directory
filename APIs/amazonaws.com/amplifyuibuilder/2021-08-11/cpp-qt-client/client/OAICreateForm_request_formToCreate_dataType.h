...
/*
 * OAICreateForm_request_formToCreate_dataType.h
 *
 * 
 */

#ifndef OAICreateForm_request_formToCreate_dataType_H
#define OAICreateForm_request_formToCreate_dataType_H
...
class OAICreateForm_request_formToCreate_dataType : public OAIObject {
public:
    OAICreateForm_request_formToCreate_dataType();
    OAICreateForm_request_formToCreate_dataType(QString json);
    ~OAICreateForm_request_formToCreate_dataType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateForm_request_formToCreate_dataType)

#endif // OAICreateForm_request_formToCreate_dataType_H
