...
#include "OAIComponentProperty.h"
...
OAIComponentProperty::OAIComponentProperty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComponentProperty::OAIComponentProperty() {
    this->initializeModel();
}

OAIComponentProperty::~OAIComponentProperty() {}

void OAIComponentProperty::initializeModel() {
...
void OAIComponentProperty::fromJson(QString jsonString) {
...
void OAIComponentProperty::fromJsonObject(QJsonObject json) {
...
QString OAIComponentProperty::asJson() const {
...
QJsonObject OAIComponentProperty::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAIComponentProperty::getValue() const {
    return m_value;
}
void OAIComponentProperty::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIComponentProperty::is_value_Set() const{
    return m_value_isSet;
}

bool OAIComponentProperty::is_value_Valid() const{
    return m_value_isValid;
}

OAIComponentProperty_bindingProperties OAIComponentProperty::getBindingProperties() const {
    return m_binding_properties;
}
void OAIComponentProperty::setBindingProperties(const OAIComponentProperty_bindingProperties &binding_properties) {
    m_binding_properties = binding_properties;
    m_binding_properties_isSet = true;
}

bool OAIComponentProperty::is_binding_properties_Set() const{
    return m_binding_properties_isSet;
}

bool OAIComponentProperty::is_binding_properties_Valid() const{
    return m_binding_properties_isValid;
}

OAIComponentProperty_collectionBindingProperties OAIComponentProperty::getCollectionBindingProperties() const {
    return m_collection_binding_properties;
}
void OAIComponentProperty::setCollectionBindingProperties(const OAIComponentProperty_collectionBindingProperties &collection_binding_properties) {
    m_collection_binding_properties = collection_binding_properties;
    m_collection_binding_properties_isSet = true;
}

bool OAIComponentProperty::is_collection_binding_properties_Set() const{
    return m_collection_binding_properties_isSet;
}

bool OAIComponentProperty::is_collection_binding_properties_Valid() const{
    return m_collection_binding_properties_isValid;
}

QString OAIComponentProperty::getDefaultValue() const {
    return m_default_value;
}
void OAIComponentProperty::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIComponentProperty::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIComponentProperty::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIComponentProperty::getModel() const {
    return m_model;
}
void OAIComponentProperty::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIComponentProperty::is_model_Set() const{
    return m_model_isSet;
}

bool OAIComponentProperty::is_model_Valid() const{
    return m_model_isValid;
}

QMap OAIComponentProperty::getBindings() const {
    return m_bindings;
}
void OAIComponentProperty::setBindings(const QMap &bindings) {
    m_bindings = bindings;
    m_bindings_isSet = true;
}

bool OAIComponentProperty::is_bindings_Set() const{
    return m_bindings_isSet;
}

bool OAIComponentProperty::is_bindings_Valid() const{
    return m_bindings_isValid;
}

QString OAIComponentProperty::getEvent() const {
    return m_event;
}
void OAIComponentProperty::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIComponentProperty::is_event_Set() const{
    return m_event_isSet;
}

bool OAIComponentProperty::is_event_Valid() const{
    return m_event_isValid;
}

QString OAIComponentProperty::getUserAttribute() const {
    return m_user_attribute;
}
void OAIComponentProperty::setUserAttribute(const QString &user_attribute) {
    m_user_attribute = user_attribute;
    m_user_attribute_isSet = true;
}

bool OAIComponentProperty::is_user_attribute_Set() const{
    return m_user_attribute_isSet;
}

bool OAIComponentProperty::is_user_attribute_Valid() const{
    return m_user_attribute_isValid;
}

QList OAIComponentProperty::getConcat() const {
    return m_concat;
}
void OAIComponentProperty::setConcat(const QList &concat) {
    m_concat = concat;
    m_concat_isSet = true;
}

bool OAIComponentProperty::is_concat_Set() const{
    return m_concat_isSet;
}

bool OAIComponentProperty::is_concat_Valid() const{
    return m_concat_isValid;
}

OAIComponentProperty_condition OAIComponentProperty::getCondition() const {
    return m_condition;
}
void OAIComponentProperty::setCondition(const OAIComponentProperty_condition &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAIComponentProperty::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAIComponentProperty::is_condition_Valid() const{
    return m_condition_isValid;
}

bool OAIComponentProperty::getConfigured() const {
    return m_configured;
}
void OAIComponentProperty::setConfigured(const bool &configured) {
    m_configured = configured;
    m_configured_isSet = true;
}

bool OAIComponentProperty::is_configured_Set() const{
    return m_configured_isSet;
}

bool OAIComponentProperty::is_configured_Valid() const{
    return m_configured_isValid;
}

QString OAIComponentProperty::getType() const {
    return m_type;
}
void OAIComponentProperty::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIComponentProperty::is_type_Set() const{
    return m_type_isSet;
}

bool OAIComponentProperty::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIComponentProperty::getImportedValue() const {
    return m_imported_value;
}
void OAIComponentProperty::setImportedValue(const QString &imported_value) {
    m_imported_value = imported_value;
    m_imported_value_isSet = true;
}

bool OAIComponentProperty::is_imported_value_Set() const{
    return m_imported_value_isSet;
}

bool OAIComponentProperty::is_imported_value_Valid() const{
    return m_imported_value_isValid;
}

QString OAIComponentProperty::getComponentName() const {
    return m_component_name;
}
void OAIComponentProperty::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIComponentProperty::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIComponentProperty::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QString OAIComponentProperty::getProperty() const {
    return m_property;
}
void OAIComponentProperty::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIComponentProperty::is_property_Set() const{
    return m_property_isSet;
}

bool OAIComponentProperty::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIComponentProperty::isSet() const {
...
bool OAIComponentProperty::isValid() const {
