...
/*
 * OAIComponentConditionProperty_then.h
 *
 * 
 */

#ifndef OAIComponentConditionProperty_then_H
#define OAIComponentConditionProperty_then_H
...
class OAIComponentConditionProperty_then : public OAIObject {
public:
    OAIComponentConditionProperty_then();
    OAIComponentConditionProperty_then(QString json);
    ~OAIComponentConditionProperty_then() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentConditionProperty_then)

#endif // OAIComponentConditionProperty_then_H
