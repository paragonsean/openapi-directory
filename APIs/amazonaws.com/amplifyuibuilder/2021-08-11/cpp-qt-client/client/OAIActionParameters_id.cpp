...
OAIActionParameters_id::OAIActionParameters_id(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionParameters_id::OAIActionParameters_id() {
    this->initializeModel();
}

OAIActionParameters_id::~OAIActionParameters_id() {}

void OAIActionParameters_id::initializeModel() {
...
void OAIActionParameters_id::fromJson(QString jsonString) {
...
void OAIActionParameters_id::fromJsonObject(QJsonObject json) {
...
QString OAIActionParameters_id::asJson() const {
...
QJsonObject OAIActionParameters_id::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAIActionParameters_id::getValue() const {
    return m_value;
}
void OAIActionParameters_id::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIActionParameters_id::is_value_Set() const{
    return m_value_isSet;
}

bool OAIActionParameters_id::is_value_Valid() const{
    return m_value_isValid;
}

OAIComponentProperty_bindingProperties OAIActionParameters_id::getBindingProperties() const {
    return m_binding_properties;
}
void OAIActionParameters_id::setBindingProperties(const OAIComponentProperty_bindingProperties &binding_properties) {
    m_binding_properties = binding_properties;
    m_binding_properties_isSet = true;
}

bool OAIActionParameters_id::is_binding_properties_Set() const{
    return m_binding_properties_isSet;
}

bool OAIActionParameters_id::is_binding_properties_Valid() const{
    return m_binding_properties_isValid;
}

OAIComponentProperty_collectionBindingProperties OAIActionParameters_id::getCollectionBindingProperties() const {
    return m_collection_binding_properties;
}
void OAIActionParameters_id::setCollectionBindingProperties(const OAIComponentProperty_collectionBindingProperties &collection_binding_properties) {
    m_collection_binding_properties = collection_binding_properties;
    m_collection_binding_properties_isSet = true;
}

bool OAIActionParameters_id::is_collection_binding_properties_Set() const{
    return m_collection_binding_properties_isSet;
}

bool OAIActionParameters_id::is_collection_binding_properties_Valid() const{
    return m_collection_binding_properties_isValid;
}

QString OAIActionParameters_id::getDefaultValue() const {
    return m_default_value;
}
void OAIActionParameters_id::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIActionParameters_id::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIActionParameters_id::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIActionParameters_id::getModel() const {
    return m_model;
}
void OAIActionParameters_id::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIActionParameters_id::is_model_Set() const{
    return m_model_isSet;
}

bool OAIActionParameters_id::is_model_Valid() const{
    return m_model_isValid;
}

QMap OAIActionParameters_id::getBindings() const {
    return m_bindings;
}
void OAIActionParameters_id::setBindings(const QMap &bindings) {
    m_bindings = bindings;
    m_bindings_isSet = true;
}

bool OAIActionParameters_id::is_bindings_Set() const{
    return m_bindings_isSet;
}

bool OAIActionParameters_id::is_bindings_Valid() const{
    return m_bindings_isValid;
}

QString OAIActionParameters_id::getEvent() const {
    return m_event;
}
void OAIActionParameters_id::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIActionParameters_id::is_event_Set() const{
    return m_event_isSet;
}

bool OAIActionParameters_id::is_event_Valid() const{
    return m_event_isValid;
}

QString OAIActionParameters_id::getUserAttribute() const {
    return m_user_attribute;
}
void OAIActionParameters_id::setUserAttribute(const QString &user_attribute) {
    m_user_attribute = user_attribute;
    m_user_attribute_isSet = true;
}

bool OAIActionParameters_id::is_user_attribute_Set() const{
    return m_user_attribute_isSet;
}

bool OAIActionParameters_id::is_user_attribute_Valid() const{
    return m_user_attribute_isValid;
}

QList OAIActionParameters_id::getConcat() const {
    return m_concat;
}
void OAIActionParameters_id::setConcat(const QList &concat) {
    m_concat = concat;
    m_concat_isSet = true;
}

bool OAIActionParameters_id::is_concat_Set() const{
    return m_concat_isSet;
}

bool OAIActionParameters_id::is_concat_Valid() const{
    return m_concat_isValid;
}

OAIComponentProperty_condition OAIActionParameters_id::getCondition() const {
    return m_condition;
}
void OAIActionParameters_id::setCondition(const OAIComponentProperty_condition &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAIActionParameters_id::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAIActionParameters_id::is_condition_Valid() const{
    return m_condition_isValid;
}

bool OAIActionParameters_id::getConfigured() const {
    return m_configured;
}
void OAIActionParameters_id::setConfigured(const bool &configured) {
    m_configured = configured;
    m_configured_isSet = true;
}

bool OAIActionParameters_id::is_configured_Set() const{
    return m_configured_isSet;
}

bool OAIActionParameters_id::is_configured_Valid() const{
    return m_configured_isValid;
}

QString OAIActionParameters_id::getType() const {
    return m_type;
}
void OAIActionParameters_id::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActionParameters_id::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActionParameters_id::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIActionParameters_id::getImportedValue() const {
    return m_imported_value;
}
void OAIActionParameters_id::setImportedValue(const QString &imported_value) {
    m_imported_value = imported_value;
    m_imported_value_isSet = true;
}

bool OAIActionParameters_id::is_imported_value_Set() const{
    return m_imported_value_isSet;
}

bool OAIActionParameters_id::is_imported_value_Valid() const{
    return m_imported_value_isValid;
}

QString OAIActionParameters_id::getComponentName() const {
    return m_component_name;
}
void OAIActionParameters_id::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIActionParameters_id::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIActionParameters_id::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QString OAIActionParameters_id::getProperty() const {
    return m_property;
}
void OAIActionParameters_id::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIActionParameters_id::is_property_Set() const{
    return m_property_isSet;
}

bool OAIActionParameters_id::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIActionParameters_id::isSet() const {
...
bool OAIActionParameters_id::isValid() const {
