...
/*
 * OAICreateFormRequest_formToCreate.h
 *
 * 
 */

#ifndef OAICreateFormRequest_formToCreate_H
#define OAICreateFormRequest_formToCreate_H
...
class OAICreateFormRequest_formToCreate : public OAIObject {
public:
    OAICreateFormRequest_formToCreate();
    OAICreateFormRequest_formToCreate(QString json);
    ~OAICreateFormRequest_formToCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFormRequest_formToCreate)

#endif // OAICreateFormRequest_formToCreate_H
