...
/*
 * OAIActionParameters_global.h
 *
 * 
 */

#ifndef OAIActionParameters_global_H
#define OAIActionParameters_global_H
...
class OAIActionParameters_global : public OAIObject {
public:
    OAIActionParameters_global();
    OAIActionParameters_global(QString json);
    ~OAIActionParameters_global() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_global)

#endif // OAIActionParameters_global_H
