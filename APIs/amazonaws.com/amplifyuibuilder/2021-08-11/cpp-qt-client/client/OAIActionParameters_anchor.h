...
/*
 * OAIActionParameters_anchor.h
 *
 * 
 */

#ifndef OAIActionParameters_anchor_H
#define OAIActionParameters_anchor_H
...
class OAIActionParameters_anchor : public OAIObject {
public:
    OAIActionParameters_anchor();
    OAIActionParameters_anchor(QString json);
    ~OAIActionParameters_anchor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters_anchor)

#endif // OAIActionParameters_anchor_H
