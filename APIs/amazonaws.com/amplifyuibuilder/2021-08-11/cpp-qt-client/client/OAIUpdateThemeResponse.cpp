...
OAIUpdateThemeResponse_entity OAIUpdateThemeResponse::getEntity() const {
    return m_entity;
}
void OAIUpdateThemeResponse::setEntity(const OAIUpdateThemeResponse_entity &entity) {
    m_entity = entity;
    m_entity_isSet = true;
}

bool OAIUpdateThemeResponse::is_entity_Set() const{
    return m_entity_isSet;
}

bool OAIUpdateThemeResponse::is_entity_Valid() const{
