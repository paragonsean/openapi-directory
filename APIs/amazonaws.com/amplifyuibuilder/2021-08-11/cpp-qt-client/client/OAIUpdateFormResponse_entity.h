...
/*
 * OAIUpdateFormResponse_entity.h
 *
 * 
 */

#ifndef OAIUpdateFormResponse_entity_H
#define OAIUpdateFormResponse_entity_H
...
class OAIUpdateFormResponse_entity : public OAIObject {
public:
    OAIUpdateFormResponse_entity();
    OAIUpdateFormResponse_entity(QString json);
    ~OAIUpdateFormResponse_entity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFormResponse_entity)

#endif // OAIUpdateFormResponse_entity_H
