...
#ifndef OAIUpdateFormData_H
#define OAIUpdateFormData_H
...
class OAIUpdateFormData : public OAIObject {
public:
    OAIUpdateFormData();
    OAIUpdateFormData(QString json);
    ~OAIUpdateFormData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFormData)

#endif // OAIUpdateFormData_H
