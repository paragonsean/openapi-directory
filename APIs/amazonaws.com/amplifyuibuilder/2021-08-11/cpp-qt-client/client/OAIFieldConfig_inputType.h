...
/*
 * OAIFieldConfig_inputType.h
 *
 * 
 */

#ifndef OAIFieldConfig_inputType_H
#define OAIFieldConfig_inputType_H
...
class OAIFieldConfig_inputType : public OAIObject {
public:
    OAIFieldConfig_inputType();
    OAIFieldConfig_inputType(QString json);
    ~OAIFieldConfig_inputType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldConfig_inputType)

#endif // OAIFieldConfig_inputType_H
