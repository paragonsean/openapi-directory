...
OAIActionParameters_anchor::OAIActionParameters_anchor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionParameters_anchor::OAIActionParameters_anchor() {
    this->initializeModel();
}

OAIActionParameters_anchor::~OAIActionParameters_anchor() {}

void OAIActionParameters_anchor::initializeModel() {
...
void OAIActionParameters_anchor::fromJson(QString jsonString) {
...
void OAIActionParameters_anchor::fromJsonObject(QJsonObject json) {
...
QString OAIActionParameters_anchor::asJson() const {
...
QJsonObject OAIActionParameters_anchor::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAIActionParameters_anchor::getValue() const {
    return m_value;
}
void OAIActionParameters_anchor::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIActionParameters_anchor::is_value_Set() const{
    return m_value_isSet;
}

bool OAIActionParameters_anchor::is_value_Valid() const{
    return m_value_isValid;
}

OAIComponentProperty_bindingProperties OAIActionParameters_anchor::getBindingProperties() const {
    return m_binding_properties;
}
void OAIActionParameters_anchor::setBindingProperties(const OAIComponentProperty_bindingProperties &binding_properties) {
    m_binding_properties = binding_properties;
    m_binding_properties_isSet = true;
}

bool OAIActionParameters_anchor::is_binding_properties_Set() const{
    return m_binding_properties_isSet;
}

bool OAIActionParameters_anchor::is_binding_properties_Valid() const{
    return m_binding_properties_isValid;
}

OAIComponentProperty_collectionBindingProperties OAIActionParameters_anchor::getCollectionBindingProperties() const {
    return m_collection_binding_properties;
}
void OAIActionParameters_anchor::setCollectionBindingProperties(const OAIComponentProperty_collectionBindingProperties &collection_binding_properties) {
    m_collection_binding_properties = collection_binding_properties;
    m_collection_binding_properties_isSet = true;
}

bool OAIActionParameters_anchor::is_collection_binding_properties_Set() const{
    return m_collection_binding_properties_isSet;
}

bool OAIActionParameters_anchor::is_collection_binding_properties_Valid() const{
    return m_collection_binding_properties_isValid;
}

QString OAIActionParameters_anchor::getDefaultValue() const {
    return m_default_value;
}
void OAIActionParameters_anchor::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIActionParameters_anchor::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIActionParameters_anchor::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIActionParameters_anchor::getModel() const {
    return m_model;
}
void OAIActionParameters_anchor::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIActionParameters_anchor::is_model_Set() const{
    return m_model_isSet;
}

bool OAIActionParameters_anchor::is_model_Valid() const{
    return m_model_isValid;
}

QMap OAIActionParameters_anchor::getBindings() const {
    return m_bindings;
}
void OAIActionParameters_anchor::setBindings(const QMap &bindings) {
    m_bindings = bindings;
    m_bindings_isSet = true;
}

bool OAIActionParameters_anchor::is_bindings_Set() const{
    return m_bindings_isSet;
}

bool OAIActionParameters_anchor::is_bindings_Valid() const{
    return m_bindings_isValid;
}

QString OAIActionParameters_anchor::getEvent() const {
    return m_event;
}
void OAIActionParameters_anchor::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIActionParameters_anchor::is_event_Set() const{
    return m_event_isSet;
}

bool OAIActionParameters_anchor::is_event_Valid() const{
    return m_event_isValid;
}

QString OAIActionParameters_anchor::getUserAttribute() const {
    return m_user_attribute;
}
void OAIActionParameters_anchor::setUserAttribute(const QString &user_attribute) {
    m_user_attribute = user_attribute;
    m_user_attribute_isSet = true;
}

bool OAIActionParameters_anchor::is_user_attribute_Set() const{
    return m_user_attribute_isSet;
}

bool OAIActionParameters_anchor::is_user_attribute_Valid() const{
    return m_user_attribute_isValid;
}

QList OAIActionParameters_anchor::getConcat() const {
    return m_concat;
}
void OAIActionParameters_anchor::setConcat(const QList &concat) {
    m_concat = concat;
    m_concat_isSet = true;
}

bool OAIActionParameters_anchor::is_concat_Set() const{
    return m_concat_isSet;
}

bool OAIActionParameters_anchor::is_concat_Valid() const{
    return m_concat_isValid;
}

OAIComponentProperty_condition OAIActionParameters_anchor::getCondition() const {
    return m_condition;
}
void OAIActionParameters_anchor::setCondition(const OAIComponentProperty_condition &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAIActionParameters_anchor::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAIActionParameters_anchor::is_condition_Valid() const{
    return m_condition_isValid;
}

bool OAIActionParameters_anchor::getConfigured() const {
    return m_configured;
}
void OAIActionParameters_anchor::setConfigured(const bool &configured) {
    m_configured = configured;
    m_configured_isSet = true;
}

bool OAIActionParameters_anchor::is_configured_Set() const{
    return m_configured_isSet;
}

bool OAIActionParameters_anchor::is_configured_Valid() const{
    return m_configured_isValid;
}

QString OAIActionParameters_anchor::getType() const {
    return m_type;
}
void OAIActionParameters_anchor::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActionParameters_anchor::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActionParameters_anchor::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIActionParameters_anchor::getImportedValue() const {
    return m_imported_value;
}
void OAIActionParameters_anchor::setImportedValue(const QString &imported_value) {
    m_imported_value = imported_value;
    m_imported_value_isSet = true;
}

bool OAIActionParameters_anchor::is_imported_value_Set() const{
    return m_imported_value_isSet;
}

bool OAIActionParameters_anchor::is_imported_value_Valid() const{
    return m_imported_value_isValid;
}

QString OAIActionParameters_anchor::getComponentName() const {
    return m_component_name;
}
void OAIActionParameters_anchor::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIActionParameters_anchor::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIActionParameters_anchor::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QString OAIActionParameters_anchor::getProperty() const {
    return m_property;
}
void OAIActionParameters_anchor::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIActionParameters_anchor::is_property_Set() const{
    return m_property_isSet;
}

bool OAIActionParameters_anchor::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIActionParameters_anchor::isSet() const {
...
bool OAIActionParameters_anchor::isValid() const {
