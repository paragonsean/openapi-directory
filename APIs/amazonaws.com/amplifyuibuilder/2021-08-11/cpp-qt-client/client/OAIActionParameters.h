...
#ifndef OAIActionParameters_H
#define OAIActionParameters_H
...
class OAIActionParameters : public OAIObject {
public:
    OAIActionParameters();
    OAIActionParameters(QString json);
    ~OAIActionParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionParameters)

#endif // OAIActionParameters_H
