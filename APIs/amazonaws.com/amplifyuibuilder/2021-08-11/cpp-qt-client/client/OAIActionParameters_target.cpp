...
OAIActionParameters_target::OAIActionParameters_target(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionParameters_target::OAIActionParameters_target() {
    this->initializeModel();
}

OAIActionParameters_target::~OAIActionParameters_target() {}

void OAIActionParameters_target::initializeModel() {
...
void OAIActionParameters_target::fromJson(QString jsonString) {
...
void OAIActionParameters_target::fromJsonObject(QJsonObject json) {
...
QString OAIActionParameters_target::asJson() const {
...
QJsonObject OAIActionParameters_target::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
QString OAIActionParameters_target::getValue() const {
    return m_value;
}
void OAIActionParameters_target::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIActionParameters_target::is_value_Set() const{
    return m_value_isSet;
}

bool OAIActionParameters_target::is_value_Valid() const{
    return m_value_isValid;
}

OAIComponentProperty_bindingProperties OAIActionParameters_target::getBindingProperties() const {
    return m_binding_properties;
}
void OAIActionParameters_target::setBindingProperties(const OAIComponentProperty_bindingProperties &binding_properties) {
    m_binding_properties = binding_properties;
    m_binding_properties_isSet = true;
}

bool OAIActionParameters_target::is_binding_properties_Set() const{
    return m_binding_properties_isSet;
}

bool OAIActionParameters_target::is_binding_properties_Valid() const{
    return m_binding_properties_isValid;
}

OAIComponentProperty_collectionBindingProperties OAIActionParameters_target::getCollectionBindingProperties() const {
    return m_collection_binding_properties;
}
void OAIActionParameters_target::setCollectionBindingProperties(const OAIComponentProperty_collectionBindingProperties &collection_binding_properties) {
    m_collection_binding_properties = collection_binding_properties;
    m_collection_binding_properties_isSet = true;
}

bool OAIActionParameters_target::is_collection_binding_properties_Set() const{
    return m_collection_binding_properties_isSet;
}

bool OAIActionParameters_target::is_collection_binding_properties_Valid() const{
    return m_collection_binding_properties_isValid;
}

QString OAIActionParameters_target::getDefaultValue() const {
    return m_default_value;
}
void OAIActionParameters_target::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIActionParameters_target::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIActionParameters_target::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIActionParameters_target::getModel() const {
    return m_model;
}
void OAIActionParameters_target::setModel(const QString &model) {
    m_model = model;
    m_model_isSet = true;
}

bool OAIActionParameters_target::is_model_Set() const{
    return m_model_isSet;
}

bool OAIActionParameters_target::is_model_Valid() const{
    return m_model_isValid;
}

QMap OAIActionParameters_target::getBindings() const {
    return m_bindings;
}
void OAIActionParameters_target::setBindings(const QMap &bindings) {
    m_bindings = bindings;
    m_bindings_isSet = true;
}

bool OAIActionParameters_target::is_bindings_Set() const{
    return m_bindings_isSet;
}

bool OAIActionParameters_target::is_bindings_Valid() const{
    return m_bindings_isValid;
}

QString OAIActionParameters_target::getEvent() const {
    return m_event;
}
void OAIActionParameters_target::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAIActionParameters_target::is_event_Set() const{
    return m_event_isSet;
}

bool OAIActionParameters_target::is_event_Valid() const{
    return m_event_isValid;
}

QString OAIActionParameters_target::getUserAttribute() const {
    return m_user_attribute;
}
void OAIActionParameters_target::setUserAttribute(const QString &user_attribute) {
    m_user_attribute = user_attribute;
    m_user_attribute_isSet = true;
}

bool OAIActionParameters_target::is_user_attribute_Set() const{
    return m_user_attribute_isSet;
}

bool OAIActionParameters_target::is_user_attribute_Valid() const{
    return m_user_attribute_isValid;
}

QList OAIActionParameters_target::getConcat() const {
    return m_concat;
}
void OAIActionParameters_target::setConcat(const QList &concat) {
    m_concat = concat;
    m_concat_isSet = true;
}

bool OAIActionParameters_target::is_concat_Set() const{
    return m_concat_isSet;
}

bool OAIActionParameters_target::is_concat_Valid() const{
    return m_concat_isValid;
}

OAIComponentProperty_condition OAIActionParameters_target::getCondition() const {
    return m_condition;
}
void OAIActionParameters_target::setCondition(const OAIComponentProperty_condition &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAIActionParameters_target::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAIActionParameters_target::is_condition_Valid() const{
    return m_condition_isValid;
}

bool OAIActionParameters_target::getConfigured() const {
    return m_configured;
}
void OAIActionParameters_target::setConfigured(const bool &configured) {
    m_configured = configured;
    m_configured_isSet = true;
}

bool OAIActionParameters_target::is_configured_Set() const{
    return m_configured_isSet;
}

bool OAIActionParameters_target::is_configured_Valid() const{
    return m_configured_isValid;
}

QString OAIActionParameters_target::getType() const {
    return m_type;
}
void OAIActionParameters_target::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActionParameters_target::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActionParameters_target::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIActionParameters_target::getImportedValue() const {
    return m_imported_value;
}
void OAIActionParameters_target::setImportedValue(const QString &imported_value) {
    m_imported_value = imported_value;
    m_imported_value_isSet = true;
}

bool OAIActionParameters_target::is_imported_value_Set() const{
    return m_imported_value_isSet;
}

bool OAIActionParameters_target::is_imported_value_Valid() const{
    return m_imported_value_isValid;
}

QString OAIActionParameters_target::getComponentName() const {
    return m_component_name;
}
void OAIActionParameters_target::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIActionParameters_target::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIActionParameters_target::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QString OAIActionParameters_target::getProperty() const {
    return m_property;
}
void OAIActionParameters_target::setProperty(const QString &property) {
    m_property = property;
    m_property_isSet = true;
}

bool OAIActionParameters_target::is_property_Set() const{
    return m_property_isSet;
}

bool OAIActionParameters_target::is_property_Valid() const{
    return m_property_isValid;
}

bool OAIActionParameters_target::isSet() const {
...
bool OAIActionParameters_target::isValid() const {
