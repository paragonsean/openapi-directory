...
/*
 * OAIUpdateThemeResponse_entity.h
 *
 * 
 */

#ifndef OAIUpdateThemeResponse_entity_H
#define OAIUpdateThemeResponse_entity_H
...
class OAIUpdateThemeResponse_entity : public OAIObject {
public:
    OAIUpdateThemeResponse_entity();
    OAIUpdateThemeResponse_entity(QString json);
    ~OAIUpdateThemeResponse_entity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateThemeResponse_entity)

#endif // OAIUpdateThemeResponse_entity_H
