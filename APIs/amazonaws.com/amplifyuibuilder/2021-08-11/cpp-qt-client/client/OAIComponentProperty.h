...
#ifndef OAIComponentProperty_H
#define OAIComponentProperty_H
...
class OAIComponentProperty : public OAIObject {
public:
    OAIComponentProperty();
    OAIComponentProperty(QString json);
    ~OAIComponentProperty() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentProperty)

#endif // OAIComponentProperty_H
