...
/*
 * OAICreateForm_request_formToCreate.h
 *
 * Represents all of the information that is required to create a form.
 */

#ifndef OAICreateForm_request_formToCreate_H
#define OAICreateForm_request_formToCreate_H
...
class OAICreateForm_request_formToCreate : public OAIObject {
public:
    OAICreateForm_request_formToCreate();
    OAICreateForm_request_formToCreate(QString json);
    ~OAICreateForm_request_formToCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateForm_request_formToCreate)

#endif // OAICreateForm_request_formToCreate_H
