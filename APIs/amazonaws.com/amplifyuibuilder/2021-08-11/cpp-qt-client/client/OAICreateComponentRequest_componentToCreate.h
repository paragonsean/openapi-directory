...
/*
 * OAICreateComponentRequest_componentToCreate.h
 *
 * 
 */

#ifndef OAICreateComponentRequest_componentToCreate_H
#define OAICreateComponentRequest_componentToCreate_H
...
class OAICreateComponentRequest_componentToCreate : public OAIObject {
public:
    OAICreateComponentRequest_componentToCreate();
    OAICreateComponentRequest_componentToCreate(QString json);
    ~OAICreateComponentRequest_componentToCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateComponentRequest_componentToCreate)

#endif // OAICreateComponentRequest_componentToCreate_H
