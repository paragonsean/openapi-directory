...
/*
 * OAIFileUploaderFieldConfig.h
 *
 * Describes the configuration for the file uploader field.
 */

#ifndef OAIFileUploaderFieldConfig_H
#define OAIFileUploaderFieldConfig_H
...
class OAIFileUploaderFieldConfig : public OAIObject {
public:
    OAIFileUploaderFieldConfig();
    OAIFileUploaderFieldConfig(QString json);
    ~OAIFileUploaderFieldConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileUploaderFieldConfig)

#endif // OAIFileUploaderFieldConfig_H
