...
#ifndef OAIValueMappings_H
#define OAIValueMappings_H
...
class OAIValueMappings : public OAIObject {
public:
    OAIValueMappings();
    OAIValueMappings(QString json);
    ~OAIValueMappings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValueMappings)

#endif // OAIValueMappings_H
