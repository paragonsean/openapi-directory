...
/*
 * OAIUpdateForm_request_updatedForm.h
 *
 * Updates and saves all of the information about a form, based on form ID.
 */

#ifndef OAIUpdateForm_request_updatedForm_H
#define OAIUpdateForm_request_updatedForm_H
...
class OAIUpdateForm_request_updatedForm : public OAIObject {
public:
    OAIUpdateForm_request_updatedForm();
    OAIUpdateForm_request_updatedForm(QString json);
    ~OAIUpdateForm_request_updatedForm() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateForm_request_updatedForm)

#endif // OAIUpdateForm_request_updatedForm_H
