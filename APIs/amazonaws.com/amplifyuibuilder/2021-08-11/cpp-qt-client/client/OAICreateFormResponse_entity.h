...
/*
 * OAICreateFormResponse_entity.h
 *
 * 
 */

#ifndef OAICreateFormResponse_entity_H
#define OAICreateFormResponse_entity_H
...
class OAICreateFormResponse_entity : public OAIObject {
public:
    OAICreateFormResponse_entity();
    OAICreateFormResponse_entity(QString json);
    ~OAICreateFormResponse_entity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFormResponse_entity)

#endif // OAICreateFormResponse_entity_H
