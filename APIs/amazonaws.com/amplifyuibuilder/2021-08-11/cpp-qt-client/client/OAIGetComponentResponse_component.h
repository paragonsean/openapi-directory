...
/*
 * OAIGetComponentResponse_component.h
 *
 * 
 */

#ifndef OAIGetComponentResponse_component_H
#define OAIGetComponentResponse_component_H
...
class OAIGetComponentResponse_component : public OAIObject {
public:
    OAIGetComponentResponse_component();
    OAIGetComponentResponse_component(QString json);
    ~OAIGetComponentResponse_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetComponentResponse_component)

#endif // OAIGetComponentResponse_component_H
