...
/**
 * The CertificateDetail model module.
 * @module model/CertificateDetail
 * @version 2015-12-08
 */
class CertificateDetail {
    /**
     * Constructs a new <code>CertificateDetail</code>.
     ...
     * @alias module:model/CertificateDetail
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CertificateDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CertificateDetail} obj Optional instance to populate.
     * @return {module:model/CertificateDetail} The populated <code>CertificateDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CertificateDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>CertificateDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CertificateDetail</code>.
     */
