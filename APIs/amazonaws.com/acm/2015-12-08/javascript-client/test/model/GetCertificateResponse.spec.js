...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManager.GetCertificateResponse();
  });
  ...
  describe('GetCertificateResponse', function() {
    it('should create an instance of GetCertificateResponse', function() {
      ...
      //var instance = new AwsCertificateManager.GetCertificateResponse();
      //expect(instance).to.be.a(AwsCertificateManager.GetCertificateResponse);
    });
