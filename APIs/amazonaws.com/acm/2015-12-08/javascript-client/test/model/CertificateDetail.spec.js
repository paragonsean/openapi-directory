...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCertificateManager.CertificateDetail();
  });
  ...
  describe('CertificateDetail', function() {
    it('should create an instance of CertificateDetail', function() {
      // uncomment below and update the code to test CertificateDetail
      //var instance = new AwsCertificateManager.CertificateDetail();
      //expect(instance).to.be.a(AwsCertificateManager.CertificateDetail);
    });
