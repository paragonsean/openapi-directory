...
async def test_add_tags_to_certificate(client):
    """Test case for add_tags_to_certificate

    
    """
    body = {"Tags":"","CertificateArn":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.AddTagsToCertificate',
        headers=headers,
        json=body,
        )
...
async def test_delete_certificate(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.DeleteCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_certificate(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.DescribeCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_export_certificate(client):
    ...
    """
    body = {"Passphrase":"","CertificateArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.ExportCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_account_configuration(client):
    """Test case for get_account_configuration
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.GetAccountConfiguration',
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_certificate(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.GetCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_import_certificate(client):
    ...
    """
    body = {"PrivateKey":"","CertificateChain":"","Tags":"","CertificateArn":"","Certificate":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.ImportCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_certificates(client):
    ...
    """
    body = {"Includes":{"keyUsage":"","extendedKeyUsage":"","keyTypes":""},"CertificateStatuses":"","NextToken":"","SortBy":"","SortOrder":"","MaxItems":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.ListCertificates',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_certificate(client):
    """Test case for list_tags_for_certificate
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.ListTagsForCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_account_configuration(client):
    """Test case for put_account_configuration

    
    """
    body = {"ExpiryEvents":{"DaysBeforeExpiry":""},"IdempotencyToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.PutAccountConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_remove_tags_from_certificate(client):
    """Test case for remove_tags_from_certificate
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_renew_certificate(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.RenewCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_request_certificate(client):
    """Test case for request_certificate

    
    """
    body = {"IdempotencyToken":"","Options":{"CertificateTransparencyLoggingPreference":""},"CertificateAuthorityArn":"","DomainValidationOptions":"","DomainName":"","ValidationMethod":"","SubjectAlternativeNames":"","Tags":"","KeyAlgorithm":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.RequestCertificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resend_validation_email(client):
    """Test case for resend_validation_email

    
    """
    body = {"Domain":"","ValidationDomain":"","CertificateArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.ResendValidationEmail',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_certificate_options(client):
    """Test case for update_certificate_options

    
    """
    body = {"Options":{"CertificateTransparencyLoggingPreference":""},"CertificateArn":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=CertificateManager.UpdateCertificateOptions',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
