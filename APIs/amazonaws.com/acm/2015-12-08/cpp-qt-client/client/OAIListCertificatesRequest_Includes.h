...
/*
 * OAIListCertificatesRequest_Includes.h
 *
 * 
 */

#ifndef OAIListCertificatesRequest_Includes_H
#define OAIListCertificatesRequest_Includes_H
...
class OAIListCertificatesRequest_Includes : public OAIObject {
public:
    OAIListCertificatesRequest_Includes();
    OAIListCertificatesRequest_Includes(QString json);
    ~OAIListCertificatesRequest_Includes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCertificatesRequest_Includes)

#endif // OAIListCertificatesRequest_Includes_H
