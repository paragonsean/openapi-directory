...
/*
 * OAICertificateDetail_RenewalSummary.h
 *
 * 
 */

#ifndef OAICertificateDetail_RenewalSummary_H
#define OAICertificateDetail_RenewalSummary_H
...
class OAICertificateDetail_RenewalSummary : public OAIObject {
public:
    OAICertificateDetail_RenewalSummary();
    OAICertificateDetail_RenewalSummary(QString json);
    ~OAICertificateDetail_RenewalSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateDetail_RenewalSummary)

#endif // OAICertificateDetail_RenewalSummary_H
