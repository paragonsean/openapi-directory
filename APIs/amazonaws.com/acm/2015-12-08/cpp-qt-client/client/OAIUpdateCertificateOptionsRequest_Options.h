...
/*
 * OAIUpdateCertificateOptionsRequest_Options.h
 *
 * 
 */

#ifndef OAIUpdateCertificateOptionsRequest_Options_H
#define OAIUpdateCertificateOptionsRequest_Options_H
...
class OAIUpdateCertificateOptionsRequest_Options : public OAIObject {
public:
    OAIUpdateCertificateOptionsRequest_Options();
    OAIUpdateCertificateOptionsRequest_Options(QString json);
    ~OAIUpdateCertificateOptionsRequest_Options() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCertificateOptionsRequest_Options)

#endif // OAIUpdateCertificateOptionsRequest_Options_H
