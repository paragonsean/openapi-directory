...
OAIRenewalSummary::OAIRenewalSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRenewalSummary::OAIRenewalSummary() {
    this->initializeModel();
}

OAIRenewalSummary::~OAIRenewalSummary() {}

void OAIRenewalSummary::initializeModel() {
...
void OAIRenewalSummary::fromJson(QString jsonString) {
...
void OAIRenewalSummary::fromJsonObject(QJsonObject json) {
...
QString OAIRenewalSummary::asJson() const {
...
QJsonObject OAIRenewalSummary::asJsonObject() const {
    QJsonObject obj;
...
OAIRenewalStatus OAIRenewalSummary::getRenewalStatus() const {
    return m_renewal_status;
}
void OAIRenewalSummary::setRenewalStatus(const OAIRenewalStatus &renewal_status) {
    m_renewal_status = renewal_status;
    m_renewal_status_isSet = true;
}

bool OAIRenewalSummary::is_renewal_status_Set() const{
    return m_renewal_status_isSet;
}

bool OAIRenewalSummary::is_renewal_status_Valid() const{
    return m_renewal_status_isValid;
}

QList OAIRenewalSummary::getDomainValidationOptions() const {
    return m_domain_validation_options;
}
void OAIRenewalSummary::setDomainValidationOptions(const QList &domain_validation_options) {
    m_domain_validation_options = domain_validation_options;
    m_domain_validation_options_isSet = true;
}

bool OAIRenewalSummary::is_domain_validation_options_Set() const{
    return m_domain_validation_options_isSet;
}

bool OAIRenewalSummary::is_domain_validation_options_Valid() const{
    return m_domain_validation_options_isValid;
}

OAIFailureReason OAIRenewalSummary::getRenewalStatusReason() const {
    return m_renewal_status_reason;
}
void OAIRenewalSummary::setRenewalStatusReason(const OAIFailureReason &renewal_status_reason) {
    m_renewal_status_reason = renewal_status_reason;
    m_renewal_status_reason_isSet = true;
}

bool OAIRenewalSummary::is_renewal_status_reason_Set() const{
    return m_renewal_status_reason_isSet;
}

bool OAIRenewalSummary::is_renewal_status_reason_Valid() const{
    return m_renewal_status_reason_isValid;
}

QDateTime OAIRenewalSummary::getUpdatedAt() const {
    return m_updated_at;
}
void OAIRenewalSummary::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIRenewalSummary::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIRenewalSummary::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIRenewalSummary::isSet() const {
...
bool OAIRenewalSummary::isValid() const {
