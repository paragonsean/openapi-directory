...
/*
 * OAIDescribeCertificateResponse_Certificate.h
 *
 * 
 */

#ifndef OAIDescribeCertificateResponse_Certificate_H
#define OAIDescribeCertificateResponse_Certificate_H
...
class OAIDescribeCertificateResponse_Certificate : public OAIObject {
public:
    OAIDescribeCertificateResponse_Certificate();
    OAIDescribeCertificateResponse_Certificate(QString json);
    ~OAIDescribeCertificateResponse_Certificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificateResponse_Certificate)

#endif // OAIDescribeCertificateResponse_Certificate_H
