...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QString job_arn = create(); // QString | The ARN of the Amazon Braket job to cancel.
      ...
      apiInstance.cancelJob(job_arnx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
