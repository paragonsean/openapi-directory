...
/*
 * OAIJobCheckpointConfig.h
 *
 * Contains information about the output locations for job checkpoint data.
 */

#ifndef OAIJobCheckpointConfig_H
#define OAIJobCheckpointConfig_H
...
class OAIJobCheckpointConfig : public OAIObject {
public:
    OAIJobCheckpointConfig();
    OAIJobCheckpointConfig(QString json);
    ~OAIJobCheckpointConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobCheckpointConfig)

#endif // OAIJobCheckpointConfig_H
