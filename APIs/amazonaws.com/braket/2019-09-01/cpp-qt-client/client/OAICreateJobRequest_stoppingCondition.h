...
/*
 * OAICreateJobRequest_stoppingCondition.h
 *
 * 
 */

#ifndef OAICreateJobRequest_stoppingCondition_H
#define OAICreateJobRequest_stoppingCondition_H
...
class OAICreateJobRequest_stoppingCondition : public OAIObject {
public:
    OAICreateJobRequest_stoppingCondition();
    OAICreateJobRequest_stoppingCondition(QString json);
    ~OAICreateJobRequest_stoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_stoppingCondition)

#endif // OAICreateJobRequest_stoppingCondition_H
