...
class OAIScriptModeConfig : public OAIObject {
public:
    OAIScriptModeConfig();
    OAIScriptModeConfig(QString json);
    ~OAIScriptModeConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScriptModeConfig)

#endif // OAIScriptModeConfig_H
