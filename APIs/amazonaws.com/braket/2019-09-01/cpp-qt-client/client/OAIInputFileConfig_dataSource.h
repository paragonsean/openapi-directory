...
/*
 * OAIInputFileConfig_dataSource.h
 *
 * 
 */

#ifndef OAIInputFileConfig_dataSource_H
#define OAIInputFileConfig_dataSource_H
...
class OAIInputFileConfig_dataSource : public OAIObject {
public:
    OAIInputFileConfig_dataSource();
    OAIInputFileConfig_dataSource(QString json);
    ~OAIInputFileConfig_dataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInputFileConfig_dataSource)

#endif // OAIInputFileConfig_dataSource_H
