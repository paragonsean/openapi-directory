...
QString OAIDeviceConfig::getDevice() const {
    return m_device;
}
void OAIDeviceConfig::setDevice(const QString &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIDeviceConfig::is_device_Set() const{
    return m_device_isSet;
}

bool OAIDeviceConfig::is_device_Valid() const{
