...
/*
 * OAICreateJob_request_checkpointConfig.h
 *
 * Contains information about the output locations for job checkpoint data.
 */

#ifndef OAICreateJob_request_checkpointConfig_H
#define OAICreateJob_request_checkpointConfig_H
...
class OAICreateJob_request_checkpointConfig : public OAIObject {
public:
    OAICreateJob_request_checkpointConfig();
    OAICreateJob_request_checkpointConfig(QString json);
    ~OAICreateJob_request_checkpointConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_checkpointConfig)

#endif // OAICreateJob_request_checkpointConfig_H
