...
/*
 * OAICreateJobRequest_outputDataConfig.h
 *
 * 
 */

#ifndef OAICreateJobRequest_outputDataConfig_H
#define OAICreateJobRequest_outputDataConfig_H
...
class OAICreateJobRequest_outputDataConfig : public OAIObject {
public:
    OAICreateJobRequest_outputDataConfig();
    OAICreateJobRequest_outputDataConfig(QString json);
    ~OAICreateJobRequest_outputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_outputDataConfig)

#endif // OAICreateJobRequest_outputDataConfig_H
