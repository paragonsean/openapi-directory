...
/*
 * OAICreateQuantumTaskRequest.h
 *
 * 
 */

#ifndef OAICreateQuantumTaskRequest_H
#define OAICreateQuantumTaskRequest_H
...
class OAICreateQuantumTaskRequest : public OAIObject {
public:
    OAICreateQuantumTaskRequest();
    OAICreateQuantumTaskRequest(QString json);
    ~OAICreateQuantumTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateQuantumTaskRequest)

#endif // OAICreateQuantumTaskRequest_H
