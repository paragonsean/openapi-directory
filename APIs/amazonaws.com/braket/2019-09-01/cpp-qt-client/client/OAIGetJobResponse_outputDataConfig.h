...
/*
 * OAIGetJobResponse_outputDataConfig.h
 *
 * 
 */

#ifndef OAIGetJobResponse_outputDataConfig_H
#define OAIGetJobResponse_outputDataConfig_H
...
class OAIGetJobResponse_outputDataConfig : public OAIObject {
public:
    OAIGetJobResponse_outputDataConfig();
    OAIGetJobResponse_outputDataConfig(QString json);
    ~OAIGetJobResponse_outputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobResponse_outputDataConfig)

#endif // OAIGetJobResponse_outputDataConfig_H
