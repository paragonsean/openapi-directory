...
/*
 * OAISearchQuantumTasksFilter.h
 *
 * A filter to use to search for tasks.
 */

#ifndef OAISearchQuantumTasksFilter_H
#define OAISearchQuantumTasksFilter_H
...
class OAISearchQuantumTasksFilter : public OAIObject {
public:
    OAISearchQuantumTasksFilter();
    OAISearchQuantumTasksFilter(QString json);
    ~OAISearchQuantumTasksFilter() override;
    ...
    OAISearchQuantumTasksFilterOperator getROperator() const;
    void setROperator(const OAISearchQuantumTasksFilterOperator &r_operator);
...
private:
    ...
    OAISearchQuantumTasksFilterOperator m_r_operator;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchQuantumTasksFilter)

#endif // OAISearchQuantumTasksFilter_H
