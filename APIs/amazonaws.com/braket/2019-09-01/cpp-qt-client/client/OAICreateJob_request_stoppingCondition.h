...
/*
 * OAICreateJob_request_stoppingCondition.h
 *
 * Specifies limits for how long an Amazon Braket job can run. 
 */

#ifndef OAICreateJob_request_stoppingCondition_H
#define OAICreateJob_request_stoppingCondition_H
...
class OAICreateJob_request_stoppingCondition : public OAIObject {
public:
    OAICreateJob_request_stoppingCondition();
    OAICreateJob_request_stoppingCondition(QString json);
    ~OAICreateJob_request_stoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_stoppingCondition)

#endif // OAICreateJob_request_stoppingCondition_H
