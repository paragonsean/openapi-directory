...
/*
 * OAISearchJobsFilter.h
 *
 * A filter used to search for Amazon Braket jobs.
 */

#ifndef OAISearchJobsFilter_H
#define OAISearchJobsFilter_H
...
class OAISearchJobsFilter : public OAIObject {
public:
    OAISearchJobsFilter();
    OAISearchJobsFilter(QString json);
    ~OAISearchJobsFilter() override;
    ...
    OAISearchJobsFilterOperator getROperator() const;
    void setROperator(const OAISearchJobsFilterOperator &r_operator);
...
private:
    ...
    OAISearchJobsFilterOperator m_r_operator;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchJobsFilter)

#endif // OAISearchJobsFilter_H
