...
/*
 * OAICreateJobRequest_instanceConfig.h
 *
 * 
 */

#ifndef OAICreateJobRequest_instanceConfig_H
#define OAICreateJobRequest_instanceConfig_H
...
class OAICreateJobRequest_instanceConfig : public OAIObject {
public:
    OAICreateJobRequest_instanceConfig();
    OAICreateJobRequest_instanceConfig(QString json);
    ~OAICreateJobRequest_instanceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_instanceConfig)

#endif // OAICreateJobRequest_instanceConfig_H
