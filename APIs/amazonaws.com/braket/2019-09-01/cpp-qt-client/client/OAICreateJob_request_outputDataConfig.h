...
/*
 * OAICreateJob_request_outputDataConfig.h
 *
 * Specifies the path to the S3 location where you want to store job artifacts and the encryption key used to store them.
 */

#ifndef OAICreateJob_request_outputDataConfig_H
#define OAICreateJob_request_outputDataConfig_H
...
class OAICreateJob_request_outputDataConfig : public OAIObject {
public:
    OAICreateJob_request_outputDataConfig();
    OAICreateJob_request_outputDataConfig(QString json);
    ~OAICreateJob_request_outputDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_outputDataConfig)

#endif // OAICreateJob_request_outputDataConfig_H
