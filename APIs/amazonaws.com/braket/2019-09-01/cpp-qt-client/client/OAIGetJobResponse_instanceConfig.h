...
/*
 * OAIGetJobResponse_instanceConfig.h
 *
 * 
 */

#ifndef OAIGetJobResponse_instanceConfig_H
#define OAIGetJobResponse_instanceConfig_H
...
class OAIGetJobResponse_instanceConfig : public OAIObject {
public:
    OAIGetJobResponse_instanceConfig();
    OAIGetJobResponse_instanceConfig(QString json);
    ~OAIGetJobResponse_instanceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobResponse_instanceConfig)

#endif // OAIGetJobResponse_instanceConfig_H
