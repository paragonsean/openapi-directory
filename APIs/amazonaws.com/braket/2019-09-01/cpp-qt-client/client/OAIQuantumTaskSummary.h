...
/*
 * OAIQuantumTaskSummary.h
 *
 * Includes information about a quantum task.
 */

#ifndef OAIQuantumTaskSummary_H
#define OAIQuantumTaskSummary_H
...
class OAIQuantumTaskSummary : public OAIObject {
public:
    OAIQuantumTaskSummary();
    OAIQuantumTaskSummary(QString json);
    ~OAIQuantumTaskSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuantumTaskSummary)

#endif // OAIQuantumTaskSummary_H
