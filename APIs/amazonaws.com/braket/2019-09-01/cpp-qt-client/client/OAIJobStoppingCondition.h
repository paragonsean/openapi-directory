...
/*
 * OAIJobStoppingCondition.h
 *
 * Specifies limits for how long an Amazon Braket job can run. 
 */

#ifndef OAIJobStoppingCondition_H
#define OAIJobStoppingCondition_H
...
class OAIJobStoppingCondition : public OAIObject {
public:
    OAIJobStoppingCondition();
    OAIJobStoppingCondition(QString json);
    ~OAIJobStoppingCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobStoppingCondition)

#endif // OAIJobStoppingCondition_H
