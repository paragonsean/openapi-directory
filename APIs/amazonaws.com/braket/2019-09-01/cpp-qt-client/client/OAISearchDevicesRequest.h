...
/*
 * OAISearchDevicesRequest.h
 *
 * 
 */

#ifndef OAISearchDevicesRequest_H
#define OAISearchDevicesRequest_H
...
class OAISearchDevicesRequest : public OAIObject {
public:
    OAISearchDevicesRequest();
    OAISearchDevicesRequest(QString json);
    ~OAISearchDevicesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchDevicesRequest)

#endif // OAISearchDevicesRequest_H
