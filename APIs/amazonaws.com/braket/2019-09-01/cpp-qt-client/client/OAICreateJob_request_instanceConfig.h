...
/*
 * OAICreateJob_request_instanceConfig.h
 *
 * Configures the resource instances to use while running the Amazon Braket hybrid job on Amazon Braket.
 */

#ifndef OAICreateJob_request_instanceConfig_H
#define OAICreateJob_request_instanceConfig_H
...
class OAICreateJob_request_instanceConfig : public OAIObject {
public:
    OAICreateJob_request_instanceConfig();
    OAICreateJob_request_instanceConfig(QString json);
    ~OAICreateJob_request_instanceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_instanceConfig)

#endif // OAICreateJob_request_instanceConfig_H
