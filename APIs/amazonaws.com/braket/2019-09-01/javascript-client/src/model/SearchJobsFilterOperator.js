...
* @readonly
*/
export default class SearchJobsFilterOperator {
    ...
    /**
    * Returns a <code>SearchJobsFilterOperator</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SearchJobsFilterOperator} The enum <code>SearchJobsFilterOperator</code> value.
    */
