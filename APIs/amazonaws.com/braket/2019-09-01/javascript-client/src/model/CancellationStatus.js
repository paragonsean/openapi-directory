...
export default class CancellationStatus {
    ...
    /**
    * Returns a <code>CancellationStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CancellationStatus} The enum <code>CancellationStatus</code> value.
    */
