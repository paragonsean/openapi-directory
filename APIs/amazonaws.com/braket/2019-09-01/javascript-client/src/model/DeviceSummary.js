...
class DeviceSummary {
     ...
     */
    constructor(deviceArn, deviceName, deviceStatus, deviceType, providerName) { 
        
        DeviceSummary.initialize(this, deviceArn, deviceName, deviceStatus, deviceType, providerName);
    }
     ...
     */
    static initialize(obj, deviceArn, deviceName, deviceStatus, deviceType, providerName) { 
...
DeviceSummary.RequiredProperties = ["deviceArn", "deviceName", "deviceStatus", "deviceType", "providerName"];
 ...
 */
DeviceSummary.prototype['deviceStatus'] = undefined;

/**
 * @member {module:model/DeviceType} deviceType
 */
DeviceSummary.prototype['deviceType'] = undefined;

/**
 * @member {String} providerName
 */
DeviceSummary.prototype['providerName'] = undefined;
