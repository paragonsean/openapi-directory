...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.JobEventDetails();
  });
  ...
  describe('JobEventDetails', function() {
    it('should create an instance of JobEventDetails', function() {
      // uncomment below and update the code to test JobEventDetails
      //var instance = new Braket.JobEventDetails();
      //expect(instance).to.be.a(Braket.JobEventDetails);
    });
    ...
    it('should have the property timeOfEvent (base name: "timeOfEvent")', function() {
      // uncomment below and update the code to test the property timeOfEvent
      //var instance = new Braket.JobEventDetails();
      //expect(instance).to.be();
    });
