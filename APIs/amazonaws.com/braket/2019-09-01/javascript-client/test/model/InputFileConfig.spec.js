...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.InputFileConfig();
  });
  ...
  describe('InputFileConfig', function() {
    it('should create an instance of InputFileConfig', function() {
      // uncomment below and update the code to test InputFileConfig
      //var instance = new Braket.InputFileConfig();
      //expect(instance).to.be.a(Braket.InputFileConfig);
    });
