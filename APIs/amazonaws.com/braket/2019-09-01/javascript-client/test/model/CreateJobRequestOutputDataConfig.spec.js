...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.CreateJobRequestOutputDataConfig();
  });
  ...
  describe('CreateJobRequestOutputDataConfig', function() {
    it('should create an instance of CreateJobRequestOutputDataConfig', function() {
      // uncomment below and update the code to test CreateJobRequestOutputDataConfig
      //var instance = new Braket.CreateJobRequestOutputDataConfig();
      //expect(instance).to.be.a(Braket.CreateJobRequestOutputDataConfig);
    });
