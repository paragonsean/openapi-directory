...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.SearchJobsFilter();
  });
  ...
  describe('SearchJobsFilter', function() {
    it('should create an instance of SearchJobsFilter', function() {
      // uncomment below and update the code to test SearchJobsFilter
      //var instance = new Braket.SearchJobsFilter();
      //expect(instance).to.be.a(Braket.SearchJobsFilter);
    });
