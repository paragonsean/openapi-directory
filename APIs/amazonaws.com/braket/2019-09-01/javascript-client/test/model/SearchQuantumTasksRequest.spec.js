...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.SearchQuantumTasksRequest();
  });
  ...
  describe('SearchQuantumTasksRequest', function() {
    it('should create an instance of SearchQuantumTasksRequest', function() {
      // uncomment below and update the code to test SearchQuantumTasksRequest
      //var instance = new Braket.SearchQuantumTasksRequest();
      //expect(instance).to.be.a(Braket.SearchQuantumTasksRequest);
    });
