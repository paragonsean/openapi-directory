...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.CreateJobRequestInstanceConfig();
  });
  ...
  describe('CreateJobRequestInstanceConfig', function() {
    it('should create an instance of CreateJobRequestInstanceConfig', function() {
      // uncomment below and update the code to test CreateJobRequestInstanceConfig
      //var instance = new Braket.CreateJobRequestInstanceConfig();
      //expect(instance).to.be.a(Braket.CreateJobRequestInstanceConfig);
    });
