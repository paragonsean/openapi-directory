...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.JobOutputDataConfig();
  });
  ...
  describe('JobOutputDataConfig', function() {
    it('should create an instance of JobOutputDataConfig', function() {
      // uncomment below and update the code to test JobOutputDataConfig
      //var instance = new Braket.JobOutputDataConfig();
      //expect(instance).to.be.a(Braket.JobOutputDataConfig);
    });
