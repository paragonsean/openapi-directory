...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.GetDeviceResponse();
  });
  ...
  describe('GetDeviceResponse', function() {
    it('should create an instance of GetDeviceResponse', function() {
      // uncomment below and update the code to test GetDeviceResponse
      //var instance = new Braket.GetDeviceResponse();
      //expect(instance).to.be.a(Braket.GetDeviceResponse);
    });
