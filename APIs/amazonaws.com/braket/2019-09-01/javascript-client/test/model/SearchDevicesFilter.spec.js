...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.SearchDevicesFilter();
  });
  ...
  describe('SearchDevicesFilter', function() {
    it('should create an instance of SearchDevicesFilter', function() {
      // uncomment below and update the code to test SearchDevicesFilter
      //var instance = new Braket.SearchDevicesFilter();
      //expect(instance).to.be.a(Braket.SearchDevicesFilter);
    });
