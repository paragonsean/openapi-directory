...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.SearchDevicesRequest();
  });
  ...
  describe('SearchDevicesRequest', function() {
    it('should create an instance of SearchDevicesRequest', function() {
      // uncomment below and update the code to test SearchDevicesRequest
      //var instance = new Braket.SearchDevicesRequest();
      //expect(instance).to.be.a(Braket.SearchDevicesRequest);
    });
