...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.DataSourceS3DataSource();
  });
  ...
  describe('DataSourceS3DataSource', function() {
    it('should create an instance of DataSourceS3DataSource', function() {
      // uncomment below and update the code to test DataSourceS3DataSource
      //var instance = new Braket.DataSourceS3DataSource();
      //expect(instance).to.be.a(Braket.DataSourceS3DataSource);
    });
