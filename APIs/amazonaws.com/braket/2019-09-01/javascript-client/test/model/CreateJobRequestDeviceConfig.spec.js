...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.CreateJobRequestDeviceConfig();
  });
  ...
  describe('CreateJobRequestDeviceConfig', function() {
    it('should create an instance of CreateJobRequestDeviceConfig', function() {
      // uncomment below and update the code to test CreateJobRequestDeviceConfig
      //var instance = new Braket.CreateJobRequestDeviceConfig();
      //expect(instance).to.be.a(Braket.CreateJobRequestDeviceConfig);
    });
