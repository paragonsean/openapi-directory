...
(function(root, factory) {
  ...
  describe('QuantumTaskStatus', function() {
    it('should create an instance of QuantumTaskStatus', function() {
      // uncomment below and update the code to test QuantumTaskStatus
      //var instance = new Braket.QuantumTaskStatus();
      //expect(instance).to.be.a(Braket.QuantumTaskStatus);
    });
