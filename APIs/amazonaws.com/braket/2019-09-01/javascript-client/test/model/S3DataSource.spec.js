...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.S3DataSource();
  });
  ...
  describe('S3DataSource', function() {
    it('should create an instance of S3DataSource', function() {
      // uncomment below and update the code to test S3DataSource
      //var instance = new Braket.S3DataSource();
      //expect(instance).to.be.a(Braket.S3DataSource);
    });
