...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.SearchQuantumTasksFilter();
  });
  ...
  describe('SearchQuantumTasksFilter', function() {
    it('should create an instance of SearchQuantumTasksFilter', function() {
      // uncomment below and update the code to test SearchQuantumTasksFilter
      //var instance = new Braket.SearchQuantumTasksFilter();
      //expect(instance).to.be.a(Braket.SearchQuantumTasksFilter);
    });
