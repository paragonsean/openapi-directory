...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.GetJobResponseOutputDataConfig();
  });
  ...
  describe('GetJobResponseOutputDataConfig', function() {
    it('should create an instance of GetJobResponseOutputDataConfig', function() {
      // uncomment below and update the code to test GetJobResponseOutputDataConfig
      //var instance = new Braket.GetJobResponseOutputDataConfig();
      //expect(instance).to.be.a(Braket.GetJobResponseOutputDataConfig);
    });
