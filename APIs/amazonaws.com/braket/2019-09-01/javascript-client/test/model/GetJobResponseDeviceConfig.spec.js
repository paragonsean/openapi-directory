...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.GetJobResponseDeviceConfig();
  });
  ...
  describe('GetJobResponseDeviceConfig', function() {
    it('should create an instance of GetJobResponseDeviceConfig', function() {
      // uncomment below and update the code to test GetJobResponseDeviceConfig
      //var instance = new Braket.GetJobResponseDeviceConfig();
      //expect(instance).to.be.a(Braket.GetJobResponseDeviceConfig);
    });
