...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Braket.CancelQuantumTaskRequest();
  });
  ...
  describe('CancelQuantumTaskRequest', function() {
    it('should create an instance of CancelQuantumTaskRequest', function() {
      // uncomment below and update the code to test CancelQuantumTaskRequest
      //var instance = new Braket.CancelQuantumTaskRequest();
      //expect(instance).to.be.a(Braket.CancelQuantumTaskRequest);
    });
