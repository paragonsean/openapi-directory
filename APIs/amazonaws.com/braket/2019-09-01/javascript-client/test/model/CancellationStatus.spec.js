...
(function(root, factory) {
  ...
  describe('CancellationStatus', function() {
    it('should create an instance of CancellationStatus', function() {
      // uncomment below and update the code to test CancellationStatus
      //var instance = new Braket.CancellationStatus();
      //expect(instance).to.be.a(Braket.CancellationStatus);
    });
