...
(function(root, factory) {
  ...
  describe('JobEventType', function() {
    it('should create an instance of JobEventType', function() {
      // uncomment below and update the code to test JobEventType
      //var instance = new Braket.JobEventType();
      //expect(instance).to.be.a(Braket.JobEventType);
    });
