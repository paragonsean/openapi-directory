...
(function(root, factory) {
  ...
  describe('JobPrimaryStatus', function() {
    it('should create an instance of JobPrimaryStatus', function() {
      // uncomment below and update the code to test JobPrimaryStatus
      //var instance = new Braket.JobPrimaryStatus();
      //expect(instance).to.be.a(Braket.JobPrimaryStatus);
    });
