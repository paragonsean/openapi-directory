...
(function(root, factory) {
  ...
  describe('SearchQuantumTasksFilterOperator', function() {
    it('should create an instance of SearchQuantumTasksFilterOperator', function() {
      // uncomment below and update the code to test SearchQuantumTasksFilterOperator
      //var instance = new Braket.SearchQuantumTasksFilterOperator();
      //expect(instance).to.be.a(Braket.SearchQuantumTasksFilterOperator);
    });
