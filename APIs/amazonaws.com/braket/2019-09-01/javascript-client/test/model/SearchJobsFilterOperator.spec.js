...
(function(root, factory) {
  ...
  describe('SearchJobsFilterOperator', function() {
    it('should create an instance of SearchJobsFilterOperator', function() {
      // uncomment below and update the code to test SearchJobsFilterOperator
      //var instance = new Braket.SearchJobsFilterOperator();
      //expect(instance).to.be.a(Braket.SearchJobsFilterOperator);
    });
