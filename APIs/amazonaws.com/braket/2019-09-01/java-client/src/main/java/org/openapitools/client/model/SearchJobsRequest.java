...
public class SearchJobsRequest {
  ...
  private List<SearchJobsFilter> filters = new ArrayList<>();
  ...
  public SearchJobsRequest filters(List<SearchJobsFilter> filters) {
    this.filters = filters;
    return this;
  }

  public SearchJobsRequest addFiltersItem(SearchJobsFilter filtersItem) {
  ...
  public void setFilters(List<SearchJobsFilter> filters) {
    this.filters = filters;
  }


  public SearchJobsRequest maxResults(Integer maxResults) {
  ...
  public SearchJobsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, searchJobsRequest.filters) &&
        Objects.equals(this.maxResults, searchJobsRequest.maxResults) &&
        Objects.equals(this.nextToken, searchJobsRequest.nextToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : SearchJobsRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayfilters.size(); i++) {
        SearchJobsFilter.validateJsonElement(jsonArrayfilters.get(i));
      };
