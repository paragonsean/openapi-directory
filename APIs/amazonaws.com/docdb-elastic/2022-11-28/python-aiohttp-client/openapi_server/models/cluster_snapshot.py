...
class ClusterSnapshot(Model):
    ...
    def __init__(self, admin_user_name: str=None, cluster_arn: str=None, cluster_creation_time: str=None, kms_key_id: str=None, snapshot_arn: str=None, snapshot_creation_time: str=None, snapshot_name: str=None, status: Status=None, subnet_ids: List=None, vpc_security_group_ids: List=None):
        """ClusterSnapshot - a model defined in OpenAPI

        :param admin_user_name: The admin_user_name of this ClusterSnapshot.
        :param cluster_arn: The cluster_arn of this ClusterSnapshot.
        :param cluster_creation_time: The cluster_creation_time of this ClusterSnapshot.
        :param kms_key_id: The kms_key_id of this ClusterSnapshot.
        :param snapshot_arn: The snapshot_arn of this ClusterSnapshot.
        :param snapshot_creation_time: The snapshot_creation_time of this ClusterSnapshot.
        :param snapshot_name: The snapshot_name of this ClusterSnapshot.
        :param status: The status of this ClusterSnapshot.
        :param subnet_ids: The subnet_ids of this ClusterSnapshot.
        :param vpc_security_group_ids: The vpc_security_group_ids of this ClusterSnapshot.
        """
        self.openapi_types = {
            'admin_user_name': str,
            'cluster_arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ClusterSnapshot':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ClusterSnapshot of this ClusterSnapshot.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def admin_user_name(self):
        """Gets the admin_user_name of this ClusterSnapshot.


        :return: The admin_user_name of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def admin_user_name(self, admin_user_name):
        """Sets the admin_user_name of this ClusterSnapshot.
    ...
    def cluster_arn(self):
        """Gets the cluster_arn of this ClusterSnapshot.


        :return: The cluster_arn of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def cluster_arn(self, cluster_arn):
        """Sets the cluster_arn of this ClusterSnapshot.
    ...
    def cluster_creation_time(self):
        """Gets the cluster_creation_time of this ClusterSnapshot.


        :return: The cluster_creation_time of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def cluster_creation_time(self, cluster_creation_time):
        """Sets the cluster_creation_time of this ClusterSnapshot.
    ...
    @property
    def kms_key_id(self):
        """Gets the kms_key_id of this ClusterSnapshot.


        :return: The kms_key_id of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def kms_key_id(self, kms_key_id):
        """Sets the kms_key_id of this ClusterSnapshot.
    ...
    def snapshot_arn(self):
        """Gets the snapshot_arn of this ClusterSnapshot.


        :return: The snapshot_arn of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def snapshot_arn(self, snapshot_arn):
        """Sets the snapshot_arn of this ClusterSnapshot.
    ...
    def snapshot_creation_time(self):
        """Gets the snapshot_creation_time of this ClusterSnapshot.


        :return: The snapshot_creation_time of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def snapshot_creation_time(self, snapshot_creation_time):
        """Sets the snapshot_creation_time of this ClusterSnapshot.
    ...
    def snapshot_name(self):
        """Gets the snapshot_name of this ClusterSnapshot.


        :return: The snapshot_name of this ClusterSnapshot.
        :rtype: str
        """
    ...
    def snapshot_name(self, snapshot_name):
        """Sets the snapshot_name of this ClusterSnapshot.
    ...
    @property
    def status(self):
        """Gets the status of this ClusterSnapshot.


        :return: The status of this ClusterSnapshot.
        :rtype: Status
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ClusterSnapshot.
    ...
    @property
    def subnet_ids(self):
        """Gets the subnet_ids of this ClusterSnapshot.


        :return: The subnet_ids of this ClusterSnapshot.
        :rtype: List
        """
    ...
    def subnet_ids(self, subnet_ids):
        """Sets the subnet_ids of this ClusterSnapshot.
    ...
    def vpc_security_group_ids(self):
        """Gets the vpc_security_group_ids of this ClusterSnapshot.


        :return: The vpc_security_group_ids of this ClusterSnapshot.
        :rtype: List
        """
    ...
    def vpc_security_group_ids(self, vpc_security_group_ids):
        """Sets the vpc_security_group_ids of this ClusterSnapshot.
