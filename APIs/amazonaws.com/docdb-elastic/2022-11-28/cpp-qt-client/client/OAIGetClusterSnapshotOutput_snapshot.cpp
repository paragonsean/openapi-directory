...
OAIGetClusterSnapshotOutput_snapshot::OAIGetClusterSnapshotOutput_snapshot(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetClusterSnapshotOutput_snapshot::OAIGetClusterSnapshotOutput_snapshot() {
    this->initializeModel();
}

OAIGetClusterSnapshotOutput_snapshot::~OAIGetClusterSnapshotOutput_snapshot() {}

void OAIGetClusterSnapshotOutput_snapshot::initializeModel() {
...
void OAIGetClusterSnapshotOutput_snapshot::fromJson(QString jsonString) {
...
void OAIGetClusterSnapshotOutput_snapshot::fromJsonObject(QJsonObject json) {
...
QString OAIGetClusterSnapshotOutput_snapshot::asJson() const {
...
QJsonObject OAIGetClusterSnapshotOutput_snapshot::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetClusterSnapshotOutput_snapshot::getAdminUserName() const {
    return m_admin_user_name;
}
void OAIGetClusterSnapshotOutput_snapshot::setAdminUserName(const QString &admin_user_name) {
    m_admin_user_name = admin_user_name;
    m_admin_user_name_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_admin_user_name_Set() const{
    return m_admin_user_name_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_admin_user_name_Valid() const{
    return m_admin_user_name_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getClusterArn() const {
    return m_cluster_arn;
}
void OAIGetClusterSnapshotOutput_snapshot::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getClusterCreationTime() const {
    return m_cluster_creation_time;
}
void OAIGetClusterSnapshotOutput_snapshot::setClusterCreationTime(const QString &cluster_creation_time) {
    m_cluster_creation_time = cluster_creation_time;
    m_cluster_creation_time_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_cluster_creation_time_Set() const{
    return m_cluster_creation_time_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_cluster_creation_time_Valid() const{
    return m_cluster_creation_time_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIGetClusterSnapshotOutput_snapshot::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getSnapshotArn() const {
    return m_snapshot_arn;
}
void OAIGetClusterSnapshotOutput_snapshot::setSnapshotArn(const QString &snapshot_arn) {
    m_snapshot_arn = snapshot_arn;
    m_snapshot_arn_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_arn_Set() const{
    return m_snapshot_arn_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_arn_Valid() const{
    return m_snapshot_arn_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getSnapshotCreationTime() const {
    return m_snapshot_creation_time;
}
void OAIGetClusterSnapshotOutput_snapshot::setSnapshotCreationTime(const QString &snapshot_creation_time) {
    m_snapshot_creation_time = snapshot_creation_time;
    m_snapshot_creation_time_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_creation_time_Set() const{
    return m_snapshot_creation_time_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_creation_time_Valid() const{
    return m_snapshot_creation_time_isValid;
}

QString OAIGetClusterSnapshotOutput_snapshot::getSnapshotName() const {
    return m_snapshot_name;
}
void OAIGetClusterSnapshotOutput_snapshot::setSnapshotName(const QString &snapshot_name) {
    m_snapshot_name = snapshot_name;
    m_snapshot_name_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_name_Set() const{
    return m_snapshot_name_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_snapshot_name_Valid() const{
    return m_snapshot_name_isValid;
}

OAIStatus OAIGetClusterSnapshotOutput_snapshot::getStatus() const {
    return m_status;
}
void OAIGetClusterSnapshotOutput_snapshot::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIGetClusterSnapshotOutput_snapshot::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIGetClusterSnapshotOutput_snapshot::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIGetClusterSnapshotOutput_snapshot::getVpcSecurityGroupIds() const {
    return m_vpc_security_group_ids;
}
void OAIGetClusterSnapshotOutput_snapshot::setVpcSecurityGroupIds(const QList &vpc_security_group_ids) {
    m_vpc_security_group_ids = vpc_security_group_ids;
    m_vpc_security_group_ids_isSet = true;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_vpc_security_group_ids_Set() const{
    return m_vpc_security_group_ids_isSet;
}

bool OAIGetClusterSnapshotOutput_snapshot::is_vpc_security_group_ids_Valid() const{
    return m_vpc_security_group_ids_isValid;
}

bool OAIGetClusterSnapshotOutput_snapshot::isSet() const {
...
bool OAIGetClusterSnapshotOutput_snapshot::isValid() const {
