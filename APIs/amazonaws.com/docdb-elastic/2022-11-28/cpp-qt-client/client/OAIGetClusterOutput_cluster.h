...
/*
 * OAIGetClusterOutput_cluster.h
 *
 * 
 */

#ifndef OAIGetClusterOutput_cluster_H
#define OAIGetClusterOutput_cluster_H
...
class OAIGetClusterOutput_cluster : public OAIObject {
public:
    OAIGetClusterOutput_cluster();
    OAIGetClusterOutput_cluster(QString json);
    ~OAIGetClusterOutput_cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClusterOutput_cluster)

#endif // OAIGetClusterOutput_cluster_H
