...
/*
 * OAICreateClusterOutput_cluster.h
 *
 * 
 */

#ifndef OAICreateClusterOutput_cluster_H
#define OAICreateClusterOutput_cluster_H
...
class OAICreateClusterOutput_cluster : public OAIObject {
public:
    OAICreateClusterOutput_cluster();
    OAICreateClusterOutput_cluster(QString json);
    ~OAICreateClusterOutput_cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterOutput_cluster)

#endif // OAICreateClusterOutput_cluster_H
