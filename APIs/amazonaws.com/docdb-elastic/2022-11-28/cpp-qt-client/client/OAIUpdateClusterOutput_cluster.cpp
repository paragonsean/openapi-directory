...
OAIUpdateClusterOutput_cluster::OAIUpdateClusterOutput_cluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClusterOutput_cluster::OAIUpdateClusterOutput_cluster() {
    this->initializeModel();
}

OAIUpdateClusterOutput_cluster::~OAIUpdateClusterOutput_cluster() {}

void OAIUpdateClusterOutput_cluster::initializeModel() {
...
void OAIUpdateClusterOutput_cluster::fromJson(QString jsonString) {
...
void OAIUpdateClusterOutput_cluster::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateClusterOutput_cluster::asJson() const {
...
QJsonObject OAIUpdateClusterOutput_cluster::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateClusterOutput_cluster::getAdminUserName() const {
    return m_admin_user_name;
}
void OAIUpdateClusterOutput_cluster::setAdminUserName(const QString &admin_user_name) {
    m_admin_user_name = admin_user_name;
    m_admin_user_name_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_admin_user_name_Set() const{
    return m_admin_user_name_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_admin_user_name_Valid() const{
    return m_admin_user_name_isValid;
}

OAIAuth OAIUpdateClusterOutput_cluster::getAuthType() const {
    return m_auth_type;
}
void OAIUpdateClusterOutput_cluster::setAuthType(const OAIAuth &auth_type) {
    m_auth_type = auth_type;
    m_auth_type_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_auth_type_Set() const{
    return m_auth_type_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_auth_type_Valid() const{
    return m_auth_type_isValid;
}

QString OAIUpdateClusterOutput_cluster::getClusterArn() const {
    return m_cluster_arn;
}
void OAIUpdateClusterOutput_cluster::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIUpdateClusterOutput_cluster::getClusterEndpoint() const {
    return m_cluster_endpoint;
}
void OAIUpdateClusterOutput_cluster::setClusterEndpoint(const QString &cluster_endpoint) {
    m_cluster_endpoint = cluster_endpoint;
    m_cluster_endpoint_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_endpoint_Set() const{
    return m_cluster_endpoint_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_endpoint_Valid() const{
    return m_cluster_endpoint_isValid;
}

QString OAIUpdateClusterOutput_cluster::getClusterName() const {
    return m_cluster_name;
}
void OAIUpdateClusterOutput_cluster::setClusterName(const QString &cluster_name) {
    m_cluster_name = cluster_name;
    m_cluster_name_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_name_Set() const{
    return m_cluster_name_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_cluster_name_Valid() const{
    return m_cluster_name_isValid;
}

QString OAIUpdateClusterOutput_cluster::getCreateTime() const {
    return m_create_time;
}
void OAIUpdateClusterOutput_cluster::setCreateTime(const QString &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIUpdateClusterOutput_cluster::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIUpdateClusterOutput_cluster::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIUpdateClusterOutput_cluster::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAIUpdateClusterOutput_cluster::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_preferred_maintenance_window_Valid() const{
    return m_preferred_maintenance_window_isValid;
}

qint32 OAIUpdateClusterOutput_cluster::getShardCapacity() const {
    return m_shard_capacity;
}
void OAIUpdateClusterOutput_cluster::setShardCapacity(const qint32 &shard_capacity) {
    m_shard_capacity = shard_capacity;
    m_shard_capacity_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_shard_capacity_Set() const{
    return m_shard_capacity_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_shard_capacity_Valid() const{
    return m_shard_capacity_isValid;
}

qint32 OAIUpdateClusterOutput_cluster::getShardCount() const {
    return m_shard_count;
}
void OAIUpdateClusterOutput_cluster::setShardCount(const qint32 &shard_count) {
    m_shard_count = shard_count;
    m_shard_count_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_shard_count_Set() const{
    return m_shard_count_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_shard_count_Valid() const{
    return m_shard_count_isValid;
}

OAIStatus OAIUpdateClusterOutput_cluster::getStatus() const {
    return m_status;
}
void OAIUpdateClusterOutput_cluster::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIUpdateClusterOutput_cluster::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIUpdateClusterOutput_cluster::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIUpdateClusterOutput_cluster::getVpcSecurityGroupIds() const {
    return m_vpc_security_group_ids;
}
void OAIUpdateClusterOutput_cluster::setVpcSecurityGroupIds(const QList &vpc_security_group_ids) {
    m_vpc_security_group_ids = vpc_security_group_ids;
    m_vpc_security_group_ids_isSet = true;
}

bool OAIUpdateClusterOutput_cluster::is_vpc_security_group_ids_Set() const{
    return m_vpc_security_group_ids_isSet;
}

bool OAIUpdateClusterOutput_cluster::is_vpc_security_group_ids_Valid() const{
    return m_vpc_security_group_ids_isValid;
}

bool OAIUpdateClusterOutput_cluster::isSet() const {
...
bool OAIUpdateClusterOutput_cluster::isValid() const {
