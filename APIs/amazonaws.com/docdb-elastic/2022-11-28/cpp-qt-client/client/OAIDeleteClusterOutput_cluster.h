...
/*
 * OAIDeleteClusterOutput_cluster.h
 *
 * 
 */

#ifndef OAIDeleteClusterOutput_cluster_H
#define OAIDeleteClusterOutput_cluster_H
...
class OAIDeleteClusterOutput_cluster : public OAIObject {
public:
    OAIDeleteClusterOutput_cluster();
    OAIDeleteClusterOutput_cluster(QString json);
    ~OAIDeleteClusterOutput_cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteClusterOutput_cluster)

#endif // OAIDeleteClusterOutput_cluster_H
