...
/*
 * OAIGetClusterSnapshotOutput_snapshot.h
 *
 * 
 */

#ifndef OAIGetClusterSnapshotOutput_snapshot_H
#define OAIGetClusterSnapshotOutput_snapshot_H
...
class OAIGetClusterSnapshotOutput_snapshot : public OAIObject {
public:
    OAIGetClusterSnapshotOutput_snapshot();
    OAIGetClusterSnapshotOutput_snapshot(QString json);
    ~OAIGetClusterSnapshotOutput_snapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClusterSnapshotOutput_snapshot)

#endif // OAIGetClusterSnapshotOutput_snapshot_H
