...
/*
 * OAICreateClusterSnapshotOutput_snapshot.h
 *
 * 
 */

#ifndef OAICreateClusterSnapshotOutput_snapshot_H
#define OAICreateClusterSnapshotOutput_snapshot_H
...
class OAICreateClusterSnapshotOutput_snapshot : public OAIObject {
public:
    OAICreateClusterSnapshotOutput_snapshot();
    OAICreateClusterSnapshotOutput_snapshot(QString json);
    ~OAICreateClusterSnapshotOutput_snapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterSnapshotOutput_snapshot)

#endif // OAICreateClusterSnapshotOutput_snapshot_H
