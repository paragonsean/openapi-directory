...
/*
 * OAIClusterSnapshot.h
 *
 * Returns information about a specific Elastic DocumentDB snapshot.
 */

#ifndef OAIClusterSnapshot_H
#define OAIClusterSnapshot_H
...
class OAIClusterSnapshot : public OAIObject {
public:
    OAIClusterSnapshot();
    OAIClusterSnapshot(QString json);
    ~OAIClusterSnapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterSnapshot)

#endif // OAIClusterSnapshot_H
