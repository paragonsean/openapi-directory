...
/*
 * OAIRestoreClusterFromSnapshotOutput_cluster.h
 *
 * 
 */

#ifndef OAIRestoreClusterFromSnapshotOutput_cluster_H
#define OAIRestoreClusterFromSnapshotOutput_cluster_H
...
class OAIRestoreClusterFromSnapshotOutput_cluster : public OAIObject {
public:
    OAIRestoreClusterFromSnapshotOutput_cluster();
    OAIRestoreClusterFromSnapshotOutput_cluster(QString json);
    ~OAIRestoreClusterFromSnapshotOutput_cluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreClusterFromSnapshotOutput_cluster)

#endif // OAIRestoreClusterFromSnapshotOutput_cluster_H
