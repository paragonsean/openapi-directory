...
/*
 * OAIUpdateClusterInput.h
 *
 * 
 */

#ifndef OAIUpdateClusterInput_H
#define OAIUpdateClusterInput_H
...
class OAIUpdateClusterInput : public OAIObject {
public:
    OAIUpdateClusterInput();
    OAIUpdateClusterInput(QString json);
    ~OAIUpdateClusterInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClusterInput)

#endif // OAIUpdateClusterInput_H
