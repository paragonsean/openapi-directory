...
OAICreateClusterOutput_cluster::OAICreateClusterOutput_cluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClusterOutput_cluster::OAICreateClusterOutput_cluster() {
    this->initializeModel();
}

OAICreateClusterOutput_cluster::~OAICreateClusterOutput_cluster() {}

void OAICreateClusterOutput_cluster::initializeModel() {
...
void OAICreateClusterOutput_cluster::fromJson(QString jsonString) {
...
void OAICreateClusterOutput_cluster::fromJsonObject(QJsonObject json) {
...
QString OAICreateClusterOutput_cluster::asJson() const {
...
QJsonObject OAICreateClusterOutput_cluster::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateClusterOutput_cluster::getAdminUserName() const {
    return m_admin_user_name;
}
void OAICreateClusterOutput_cluster::setAdminUserName(const QString &admin_user_name) {
    m_admin_user_name = admin_user_name;
    m_admin_user_name_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_admin_user_name_Set() const{
    return m_admin_user_name_isSet;
}

bool OAICreateClusterOutput_cluster::is_admin_user_name_Valid() const{
    return m_admin_user_name_isValid;
}

OAIAuth OAICreateClusterOutput_cluster::getAuthType() const {
    return m_auth_type;
}
void OAICreateClusterOutput_cluster::setAuthType(const OAIAuth &auth_type) {
    m_auth_type = auth_type;
    m_auth_type_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_auth_type_Set() const{
    return m_auth_type_isSet;
}

bool OAICreateClusterOutput_cluster::is_auth_type_Valid() const{
    return m_auth_type_isValid;
}

QString OAICreateClusterOutput_cluster::getClusterArn() const {
    return m_cluster_arn;
}
void OAICreateClusterOutput_cluster::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAICreateClusterOutput_cluster::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAICreateClusterOutput_cluster::getClusterEndpoint() const {
    return m_cluster_endpoint;
}
void OAICreateClusterOutput_cluster::setClusterEndpoint(const QString &cluster_endpoint) {
    m_cluster_endpoint = cluster_endpoint;
    m_cluster_endpoint_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_cluster_endpoint_Set() const{
    return m_cluster_endpoint_isSet;
}

bool OAICreateClusterOutput_cluster::is_cluster_endpoint_Valid() const{
    return m_cluster_endpoint_isValid;
}

QString OAICreateClusterOutput_cluster::getClusterName() const {
    return m_cluster_name;
}
void OAICreateClusterOutput_cluster::setClusterName(const QString &cluster_name) {
    m_cluster_name = cluster_name;
    m_cluster_name_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_cluster_name_Set() const{
    return m_cluster_name_isSet;
}

bool OAICreateClusterOutput_cluster::is_cluster_name_Valid() const{
    return m_cluster_name_isValid;
}

QString OAICreateClusterOutput_cluster::getCreateTime() const {
    return m_create_time;
}
void OAICreateClusterOutput_cluster::setCreateTime(const QString &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAICreateClusterOutput_cluster::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAICreateClusterOutput_cluster::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAICreateClusterOutput_cluster::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAICreateClusterOutput_cluster::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAICreateClusterOutput_cluster::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAICreateClusterOutput_cluster::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAICreateClusterOutput_cluster::is_preferred_maintenance_window_Valid() const{
    return m_preferred_maintenance_window_isValid;
}

qint32 OAICreateClusterOutput_cluster::getShardCapacity() const {
    return m_shard_capacity;
}
void OAICreateClusterOutput_cluster::setShardCapacity(const qint32 &shard_capacity) {
    m_shard_capacity = shard_capacity;
    m_shard_capacity_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_shard_capacity_Set() const{
    return m_shard_capacity_isSet;
}

bool OAICreateClusterOutput_cluster::is_shard_capacity_Valid() const{
    return m_shard_capacity_isValid;
}

qint32 OAICreateClusterOutput_cluster::getShardCount() const {
    return m_shard_count;
}
void OAICreateClusterOutput_cluster::setShardCount(const qint32 &shard_count) {
    m_shard_count = shard_count;
    m_shard_count_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_shard_count_Set() const{
    return m_shard_count_isSet;
}

bool OAICreateClusterOutput_cluster::is_shard_count_Valid() const{
    return m_shard_count_isValid;
}

OAIStatus OAICreateClusterOutput_cluster::getStatus() const {
    return m_status;
}
void OAICreateClusterOutput_cluster::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateClusterOutput_cluster::is_status_Valid() const{
    return m_status_isValid;
}

QList OAICreateClusterOutput_cluster::getSubnetIds() const {
    return m_subnet_ids;
}
void OAICreateClusterOutput_cluster::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAICreateClusterOutput_cluster::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAICreateClusterOutput_cluster::getVpcSecurityGroupIds() const {
    return m_vpc_security_group_ids;
}
void OAICreateClusterOutput_cluster::setVpcSecurityGroupIds(const QList &vpc_security_group_ids) {
    m_vpc_security_group_ids = vpc_security_group_ids;
    m_vpc_security_group_ids_isSet = true;
}

bool OAICreateClusterOutput_cluster::is_vpc_security_group_ids_Set() const{
    return m_vpc_security_group_ids_isSet;
}

bool OAICreateClusterOutput_cluster::is_vpc_security_group_ids_Valid() const{
    return m_vpc_security_group_ids_isValid;
}

bool OAICreateClusterOutput_cluster::isSet() const {
...
bool OAICreateClusterOutput_cluster::isValid() const {
