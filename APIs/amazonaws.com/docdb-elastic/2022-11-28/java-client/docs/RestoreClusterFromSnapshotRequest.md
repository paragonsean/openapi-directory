...
|**subnetIds** | **List&lt;String&gt;** | The Amazon EC2 subnet IDs for the Elastic DocumentDB cluster. |  [optional] |
|**tags** | **Map&lt;String, String&gt;** | A list of the tag names to be assigned to the restored DB cluster, in the form of an array of key-value pairs in which the key is the tag name and the value is the key value. |  [optional] |
|**vpcSecurityGroupIds** | **List&lt;String&gt;** | A list of EC2 VPC security groups to associate with the Elastic DocumentDB cluster. |  [optional] |
