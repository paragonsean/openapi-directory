# AmazonDocumentDbElasticClusters.CreateClusterRequest
...
**shardCapacity** | **Number** | The capacity of each shard in the new Elastic DocumentDB cluster. | 
**shardCount** | **Number** | The number of shards to create in the new Elastic DocumentDB cluster. | 
**subnetIds** | **[String]** | The Amazon EC2 subnet IDs for the new Elastic DocumentDB cluster. | [optional] 
**tags** | **{String: String}** | The tags to be assigned to the new Elastic DocumentDB cluster. | [optional] 
