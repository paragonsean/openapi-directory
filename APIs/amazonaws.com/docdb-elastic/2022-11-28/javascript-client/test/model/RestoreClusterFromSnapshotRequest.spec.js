...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotRequest();
  });
  ...
  describe('RestoreClusterFromSnapshotRequest', function() {
    it('should create an instance of RestoreClusterFromSnapshotRequest', function() {
      // uncomment below and update the code to test RestoreClusterFromSnapshotRequest
      //var instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotRequest();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotRequest);
    });
