...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.UpdateClusterOutputCluster();
  });
  ...
  describe('UpdateClusterOutputCluster', function() {
    it('should create an instance of UpdateClusterOutputCluster', function() {
      // uncomment below and update the code to test UpdateClusterOutputCluster
      //var instance = new AmazonDocumentDbElasticClusters.UpdateClusterOutputCluster();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.UpdateClusterOutputCluster);
    });
