...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotOutputCluster();
  });
  ...
  describe('RestoreClusterFromSnapshotOutputCluster', function() {
    it('should create an instance of RestoreClusterFromSnapshotOutputCluster', function() {
      // uncomment below and update the code to test RestoreClusterFromSnapshotOutputCluster
      //var instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotOutputCluster();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotOutputCluster);
    });
