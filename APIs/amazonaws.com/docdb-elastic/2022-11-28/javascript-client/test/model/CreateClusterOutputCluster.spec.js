...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.CreateClusterOutputCluster();
  });
  ...
  describe('CreateClusterOutputCluster', function() {
    it('should create an instance of CreateClusterOutputCluster', function() {
      // uncomment below and update the code to test CreateClusterOutputCluster
      //var instance = new AmazonDocumentDbElasticClusters.CreateClusterOutputCluster();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.CreateClusterOutputCluster);
    });
