...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.DeleteClusterOutputCluster();
  });
  ...
  describe('DeleteClusterOutputCluster', function() {
    it('should create an instance of DeleteClusterOutputCluster', function() {
      // uncomment below and update the code to test DeleteClusterOutputCluster
      //var instance = new AmazonDocumentDbElasticClusters.DeleteClusterOutputCluster();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.DeleteClusterOutputCluster);
    });
