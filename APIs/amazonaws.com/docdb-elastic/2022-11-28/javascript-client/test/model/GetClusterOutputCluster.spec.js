...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.GetClusterOutputCluster();
  });
  ...
  describe('GetClusterOutputCluster', function() {
    it('should create an instance of GetClusterOutputCluster', function() {
      // uncomment below and update the code to test GetClusterOutputCluster
      //var instance = new AmazonDocumentDbElasticClusters.GetClusterOutputCluster();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.GetClusterOutputCluster);
    });
