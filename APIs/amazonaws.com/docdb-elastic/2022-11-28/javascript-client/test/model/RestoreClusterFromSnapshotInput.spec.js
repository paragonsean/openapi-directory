...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotInput();
  });
  ...
  describe('RestoreClusterFromSnapshotInput', function() {
    it('should create an instance of RestoreClusterFromSnapshotInput', function() {
      // uncomment below and update the code to test RestoreClusterFromSnapshotInput
      //var instance = new AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotInput();
      //expect(instance).to.be.a(AmazonDocumentDbElasticClusters.RestoreClusterFromSnapshotInput);
    });
