...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://docdb-elastic.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://docdb-elastic.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2022-11-28/Javascript'
        };
