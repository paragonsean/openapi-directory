...
/**
 * The UpdateClusterOutputCluster model module.
 * @module model/UpdateClusterOutputCluster
 * @version 2022-11-28
 */
class UpdateClusterOutputCluster {
    /**
     * Constructs a new <code>UpdateClusterOutputCluster</code>.
     * @alias module:model/UpdateClusterOutputCluster
    ...
    constructor(adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds) { 
        ...
        UpdateClusterOutputCluster.initialize(this, adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds);
    }
    ...
    /**
     * Constructs a <code>UpdateClusterOutputCluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateClusterOutputCluster} obj Optional instance to populate.
     * @return {module:model/UpdateClusterOutputCluster} The populated <code>UpdateClusterOutputCluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateClusterOutputCluster();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateClusterOutputCluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateClusterOutputCluster</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateClusterOutputCluster.RequiredProperties) {
...
UpdateClusterOutputCluster.RequiredProperties = ["adminUserName", "authType", "clusterArn", "clusterEndpoint", "clusterName", "createTime", "kmsKeyId", "preferredMaintenanceWindow", "shardCapacity", "shardCount", "status", "subnetIds", "vpcSecurityGroupIds"];

/**
 * @member {String} adminUserName
 */
UpdateClusterOutputCluster.prototype['adminUserName'] = undefined;

/**
 * @member {module:model/Auth} authType
 */
UpdateClusterOutputCluster.prototype['authType'] = undefined;

/**
 * @member {String} clusterArn
 */
UpdateClusterOutputCluster.prototype['clusterArn'] = undefined;

/**
 * @member {String} clusterEndpoint
 */
UpdateClusterOutputCluster.prototype['clusterEndpoint'] = undefined;

/**
 * @member {String} clusterName
 */
UpdateClusterOutputCluster.prototype['clusterName'] = undefined;

/**
 * @member {String} createTime
 */
UpdateClusterOutputCluster.prototype['createTime'] = undefined;

/**
 * @member {String} kmsKeyId
 */
UpdateClusterOutputCluster.prototype['kmsKeyId'] = undefined;

/**
 * @member {String} preferredMaintenanceWindow
 */
UpdateClusterOutputCluster.prototype['preferredMaintenanceWindow'] = undefined;

/**
 * @member {Number} shardCapacity
 */
UpdateClusterOutputCluster.prototype['shardCapacity'] = undefined;

/**
 * @member {Number} shardCount
 */
UpdateClusterOutputCluster.prototype['shardCount'] = undefined;

/**
 * @member {module:model/Status} status
 */
UpdateClusterOutputCluster.prototype['status'] = undefined;

/**
 * @member {Array} subnetIds
 */
UpdateClusterOutputCluster.prototype['subnetIds'] = undefined;

/**
 * @member {Array} vpcSecurityGroupIds
 */
UpdateClusterOutputCluster.prototype['vpcSecurityGroupIds'] = undefined;
...
export default UpdateClusterOutputCluster;
