...
/**
 * The CreateClusterOutputCluster model module.
 * @module model/CreateClusterOutputCluster
 * @version 2022-11-28
 */
class CreateClusterOutputCluster {
    /**
     * Constructs a new <code>CreateClusterOutputCluster</code>.
     * @alias module:model/CreateClusterOutputCluster
    ...
    constructor(adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds) { 
        ...
        CreateClusterOutputCluster.initialize(this, adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds);
    }
    ...
    /**
     * Constructs a <code>CreateClusterOutputCluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClusterOutputCluster} obj Optional instance to populate.
     * @return {module:model/CreateClusterOutputCluster} The populated <code>CreateClusterOutputCluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClusterOutputCluster();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClusterOutputCluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClusterOutputCluster</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateClusterOutputCluster.RequiredProperties) {
...
CreateClusterOutputCluster.RequiredProperties = ["adminUserName", "authType", "clusterArn", "clusterEndpoint", "clusterName", "createTime", "kmsKeyId", "preferredMaintenanceWindow", "shardCapacity", "shardCount", "status", "subnetIds", "vpcSecurityGroupIds"];

/**
 * @member {String} adminUserName
 */
CreateClusterOutputCluster.prototype['adminUserName'] = undefined;

/**
 * @member {module:model/Auth} authType
 */
CreateClusterOutputCluster.prototype['authType'] = undefined;

/**
 * @member {String} clusterArn
 */
CreateClusterOutputCluster.prototype['clusterArn'] = undefined;

/**
 * @member {String} clusterEndpoint
 */
CreateClusterOutputCluster.prototype['clusterEndpoint'] = undefined;

/**
 * @member {String} clusterName
 */
CreateClusterOutputCluster.prototype['clusterName'] = undefined;

/**
 * @member {String} createTime
 */
CreateClusterOutputCluster.prototype['createTime'] = undefined;

/**
 * @member {String} kmsKeyId
 */
CreateClusterOutputCluster.prototype['kmsKeyId'] = undefined;

/**
 * @member {String} preferredMaintenanceWindow
 */
CreateClusterOutputCluster.prototype['preferredMaintenanceWindow'] = undefined;

/**
 * @member {Number} shardCapacity
 */
CreateClusterOutputCluster.prototype['shardCapacity'] = undefined;

/**
 * @member {Number} shardCount
 */
CreateClusterOutputCluster.prototype['shardCount'] = undefined;

/**
 * @member {module:model/Status} status
 */
CreateClusterOutputCluster.prototype['status'] = undefined;

/**
 * @member {Array} subnetIds
 */
CreateClusterOutputCluster.prototype['subnetIds'] = undefined;

/**
 * @member {Array} vpcSecurityGroupIds
 */
CreateClusterOutputCluster.prototype['vpcSecurityGroupIds'] = undefined;
...
export default CreateClusterOutputCluster;
