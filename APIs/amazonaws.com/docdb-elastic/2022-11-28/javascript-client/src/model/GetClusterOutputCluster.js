...
/**
 * The GetClusterOutputCluster model module.
 * @module model/GetClusterOutputCluster
 * @version 2022-11-28
 */
class GetClusterOutputCluster {
    /**
     * Constructs a new <code>GetClusterOutputCluster</code>.
     * @alias module:model/GetClusterOutputCluster
    ...
    constructor(adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds) { 
        ...
        GetClusterOutputCluster.initialize(this, adminUserName, authType, clusterArn, clusterEndpoint, clusterName, createTime, kmsKeyId, preferredMaintenanceWindow, shardCapacity, shardCount, status, subnetIds, vpcSecurityGroupIds);
    }
    ...
    /**
     * Constructs a <code>GetClusterOutputCluster</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetClusterOutputCluster} obj Optional instance to populate.
     * @return {module:model/GetClusterOutputCluster} The populated <code>GetClusterOutputCluster</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetClusterOutputCluster();
    ...
    /**
     * Validates the JSON data with respect to <code>GetClusterOutputCluster</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetClusterOutputCluster</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetClusterOutputCluster.RequiredProperties) {
...
GetClusterOutputCluster.RequiredProperties = ["adminUserName", "authType", "clusterArn", "clusterEndpoint", "clusterName", "createTime", "kmsKeyId", "preferredMaintenanceWindow", "shardCapacity", "shardCount", "status", "subnetIds", "vpcSecurityGroupIds"];

/**
 * @member {String} adminUserName
 */
GetClusterOutputCluster.prototype['adminUserName'] = undefined;

/**
 * @member {module:model/Auth} authType
 */
GetClusterOutputCluster.prototype['authType'] = undefined;

/**
 * @member {String} clusterArn
 */
GetClusterOutputCluster.prototype['clusterArn'] = undefined;

/**
 * @member {String} clusterEndpoint
 */
GetClusterOutputCluster.prototype['clusterEndpoint'] = undefined;

/**
 * @member {String} clusterName
 */
GetClusterOutputCluster.prototype['clusterName'] = undefined;

/**
 * @member {String} createTime
 */
GetClusterOutputCluster.prototype['createTime'] = undefined;

/**
 * @member {String} kmsKeyId
 */
GetClusterOutputCluster.prototype['kmsKeyId'] = undefined;

/**
 * @member {String} preferredMaintenanceWindow
 */
GetClusterOutputCluster.prototype['preferredMaintenanceWindow'] = undefined;

/**
 * @member {Number} shardCapacity
 */
GetClusterOutputCluster.prototype['shardCapacity'] = undefined;

/**
 * @member {Number} shardCount
 */
GetClusterOutputCluster.prototype['shardCount'] = undefined;

/**
 * @member {module:model/Status} status
 */
GetClusterOutputCluster.prototype['status'] = undefined;

/**
 * @member {Array} subnetIds
 */
GetClusterOutputCluster.prototype['subnetIds'] = undefined;

/**
 * @member {Array} vpcSecurityGroupIds
 */
GetClusterOutputCluster.prototype['vpcSecurityGroupIds'] = undefined;
...
export default GetClusterOutputCluster;
