...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.TaskObject();
  });
  ...
  describe('TaskObject', function() {
    it('should create an instance of TaskObject', function() {
      // uncomment below and update the code to test TaskObject
      //var instance = new AwsDataPipeline.TaskObject();
      //expect(instance).to.be.a(AwsDataPipeline.TaskObject);
    });
