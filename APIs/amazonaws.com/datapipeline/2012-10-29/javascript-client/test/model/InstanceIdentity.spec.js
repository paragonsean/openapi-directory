...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.InstanceIdentity();
  });
  ...
  describe('InstanceIdentity', function() {
    it('should create an instance of InstanceIdentity', function() {
      // uncomment below and update the code to test InstanceIdentity
      //var instance = new AwsDataPipeline.InstanceIdentity();
      //expect(instance).to.be.a(AwsDataPipeline.InstanceIdentity);
    });
