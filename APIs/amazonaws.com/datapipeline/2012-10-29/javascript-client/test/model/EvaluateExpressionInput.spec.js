...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.EvaluateExpressionInput();
  });
  ...
  describe('EvaluateExpressionInput', function() {
    it('should create an instance of EvaluateExpressionInput', function() {
      // uncomment below and update the code to test EvaluateExpressionInput
      //var instance = new AwsDataPipeline.EvaluateExpressionInput();
      //expect(instance).to.be.a(AwsDataPipeline.EvaluateExpressionInput);
    });
