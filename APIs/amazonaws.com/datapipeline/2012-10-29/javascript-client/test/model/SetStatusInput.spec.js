...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.SetStatusInput();
  });
  ...
  describe('SetStatusInput', function() {
    it('should create an instance of SetStatusInput', function() {
      // uncomment below and update the code to test SetStatusInput
      //var instance = new AwsDataPipeline.SetStatusInput();
      //expect(instance).to.be.a(AwsDataPipeline.SetStatusInput);
    });
