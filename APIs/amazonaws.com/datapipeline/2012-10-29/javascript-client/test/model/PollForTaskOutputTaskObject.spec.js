...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.PollForTaskOutputTaskObject();
  });
  ...
  describe('PollForTaskOutputTaskObject', function() {
    it('should create an instance of PollForTaskOutputTaskObject', function() {
      // uncomment below and update the code to test PollForTaskOutputTaskObject
      //var instance = new AwsDataPipeline.PollForTaskOutputTaskObject();
      //expect(instance).to.be.a(AwsDataPipeline.PollForTaskOutputTaskObject);
    });
