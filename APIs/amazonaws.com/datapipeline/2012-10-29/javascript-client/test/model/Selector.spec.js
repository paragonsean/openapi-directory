...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.Selector();
  });
  ...
  describe('Selector', function() {
    it('should create an instance of Selector', function() {
      // uncomment below and update the code to test Selector
      //var instance = new AwsDataPipeline.Selector();
      //expect(instance).to.be.a(AwsDataPipeline.Selector);
    });
