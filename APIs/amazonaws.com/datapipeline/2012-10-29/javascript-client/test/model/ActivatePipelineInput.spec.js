...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataPipeline.ActivatePipelineInput();
  });
  ...
  describe('ActivatePipelineInput', function() {
    it('should create an instance of ActivatePipelineInput', function() {
      // uncomment below and update the code to test ActivatePipelineInput
      //var instance = new AwsDataPipeline.ActivatePipelineInput();
      //expect(instance).to.be.a(AwsDataPipeline.ActivatePipelineInput);
    });
