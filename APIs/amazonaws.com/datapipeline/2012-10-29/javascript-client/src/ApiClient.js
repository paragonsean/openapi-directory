...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://datapipeline.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://datapipeline.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2012-10-29/Javascript'
        };
