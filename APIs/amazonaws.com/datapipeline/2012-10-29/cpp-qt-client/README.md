...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIActivatePipelineInput create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIActivatePipelineInput Example::create(){
    OAIActivatePipelineInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::activatePipelineSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::activatePipelineSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIActivatePipelineInput oai_activate_pipeline_input = create(); // OAIActivatePipelineInput | 
      ...
      apiInstance.activatePipeline(x_amz_targetoai_activate_pipeline_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
