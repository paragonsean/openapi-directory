...
/*
 * OAIActivatePipelineInput.h
 *
 * Contains the parameters for ActivatePipeline.
 */

#ifndef OAIActivatePipelineInput_H
#define OAIActivatePipelineInput_H
...
class OAIActivatePipelineInput : public OAIObject {
public:
    OAIActivatePipelineInput();
    OAIActivatePipelineInput(QString json);
    ~OAIActivatePipelineInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivatePipelineInput)

#endif // OAIActivatePipelineInput_H
