...
/*
 * OAIValidatePipelineDefinitionInput.h
 *
 * Contains the parameters for ValidatePipelineDefinition.
 */

#ifndef OAIValidatePipelineDefinitionInput_H
#define OAIValidatePipelineDefinitionInput_H
...
class OAIValidatePipelineDefinitionInput : public OAIObject {
public:
    OAIValidatePipelineDefinitionInput();
    OAIValidatePipelineDefinitionInput(QString json);
    ~OAIValidatePipelineDefinitionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidatePipelineDefinitionInput)

#endif // OAIValidatePipelineDefinitionInput_H
