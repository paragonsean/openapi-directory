...
/*
 * OAIValidationWarning.h
 *
 * Defines a validation warning. Validation warnings do not prevent pipeline activation. The set of validation warnings that can be returned are defined by AWS Data Pipeline.
 */

#ifndef OAIValidationWarning_H
#define OAIValidationWarning_H
...
class OAIValidationWarning : public OAIObject {
public:
    OAIValidationWarning();
    OAIValidationWarning(QString json);
    ~OAIValidationWarning() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationWarning)

#endif // OAIValidationWarning_H
