...
/*
 * OAIDescribeObjectsOutput.h
 *
 * Contains the output of DescribeObjects.
 */

#ifndef OAIDescribeObjectsOutput_H
#define OAIDescribeObjectsOutput_H
...
class OAIDescribeObjectsOutput : public OAIObject {
public:
    OAIDescribeObjectsOutput();
    OAIDescribeObjectsOutput(QString json);
    ~OAIDescribeObjectsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeObjectsOutput)

#endif // OAIDescribeObjectsOutput_H
