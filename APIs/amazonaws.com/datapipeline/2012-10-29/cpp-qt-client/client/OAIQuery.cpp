...
QList OAIQuery::getSelectors() const {
    return m_selectors;
}
void OAIQuery::setSelectors(const QList &selectors) {
    m_selectors = selectors;
    m_selectors_isSet = true;
}

bool OAIQuery::is_selectors_Set() const{
    return m_selectors_isSet;
}

bool OAIQuery::is_selectors_Valid() const{
