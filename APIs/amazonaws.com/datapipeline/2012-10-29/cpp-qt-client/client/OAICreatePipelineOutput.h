...
/*
 * OAICreatePipelineOutput.h
 *
 * Contains the output of CreatePipeline.
 */

#ifndef OAICreatePipelineOutput_H
#define OAICreatePipelineOutput_H
...
class OAICreatePipelineOutput : public OAIObject {
public:
    OAICreatePipelineOutput();
    OAICreatePipelineOutput(QString json);
    ~OAICreatePipelineOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePipelineOutput)

#endif // OAICreatePipelineOutput_H
