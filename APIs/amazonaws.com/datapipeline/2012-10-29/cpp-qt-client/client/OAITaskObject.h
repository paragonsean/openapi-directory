...
#ifndef OAITaskObject_H
#define OAITaskObject_H
...
class OAITaskObject : public OAIObject {
public:
    OAITaskObject();
    OAITaskObject(QString json);
    ~OAITaskObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskObject)

#endif // OAITaskObject_H
