...
/*
 * OAIParameterAttribute.h
 *
 * The attributes allowed or specified with a parameter object.
 */

#ifndef OAIParameterAttribute_H
#define OAIParameterAttribute_H
...
class OAIParameterAttribute : public OAIObject {
public:
    OAIParameterAttribute();
    OAIParameterAttribute(QString json);
    ~OAIParameterAttribute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterAttribute)

#endif // OAIParameterAttribute_H
