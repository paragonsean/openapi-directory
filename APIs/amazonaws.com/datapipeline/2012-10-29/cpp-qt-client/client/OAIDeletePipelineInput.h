...
/*
 * OAIDeletePipelineInput.h
 *
 * Contains the parameters for DeletePipeline.
 */

#ifndef OAIDeletePipelineInput_H
#define OAIDeletePipelineInput_H
...
class OAIDeletePipelineInput : public OAIObject {
public:
    OAIDeletePipelineInput();
    OAIDeletePipelineInput(QString json);
    ~OAIDeletePipelineInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePipelineInput)

#endif // OAIDeletePipelineInput_H
