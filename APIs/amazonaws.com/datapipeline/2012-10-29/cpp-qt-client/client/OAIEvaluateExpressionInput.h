...
/*
 * OAIEvaluateExpressionInput.h
 *
 * Contains the parameters for EvaluateExpression.
 */

#ifndef OAIEvaluateExpressionInput_H
#define OAIEvaluateExpressionInput_H
...
class OAIEvaluateExpressionInput : public OAIObject {
public:
    OAIEvaluateExpressionInput();
    OAIEvaluateExpressionInput(QString json);
    ~OAIEvaluateExpressionInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateExpressionInput)

#endif // OAIEvaluateExpressionInput_H
