...
async def test_activate_pipeline(client):
    """Test case for activate_pipeline

    
    """
    body = {"startTimestamp":"","pipelineId":"","parameterValues":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.ActivatePipeline',
        headers=headers,
        json=body,
        )
...
async def test_add_tags(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.AddTags',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_pipeline(client):
    ...
    """
    body = {"name":"","description":"","uniqueId":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.CreatePipeline',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deactivate_pipeline(client):
    """Test case for deactivate_pipeline

    
    """
    body = {"cancelActive":"","pipelineId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.DeactivatePipeline',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_pipeline(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.DeletePipeline',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_objects(client):
    """Test case for describe_objects

    
    """
    body = {"evaluateExpressions":"","marker":"","pipelineId":"","objectIds":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.DescribeObjects',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_pipelines(client):
    """Test case for describe_pipelines
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.DescribePipelines',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_evaluate_expression(client):
    """Test case for evaluate_expression

    
    """
    body = {"expression":"","objectId":"","pipelineId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.EvaluateExpression',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_pipeline_definition(client):
    """Test case for get_pipeline_definition

    
    """
    body = {"version":"","pipelineId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.GetPipelineDefinition',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_pipelines(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.ListPipelines',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_poll_for_task(client):
    """Test case for poll_for_task

    
    """
    body = {"hostname":"","instanceIdentity":{"signature":"","document":""},"workerGroup":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.PollForTask',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_pipeline_definition(client):
    """Test case for put_pipeline_definition

    
    """
    body = {"pipelineObjects":"","pipelineId":"","parameterObjects":"","parameterValues":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.PutPipelineDefinition',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_query_objects(client):
    """Test case for query_objects

    
    """
    body = {"sphere":"","marker":"","query":{"selectors":""},"limit":"","pipelineId":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.QueryObjects',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_remove_tags(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.RemoveTags',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_report_task_progress(client):
    """Test case for report_task_progress
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.ReportTaskProgress',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_report_task_runner_heartbeat(client):
    """Test case for report_task_runner_heartbeat

    
    """
    body = {"taskrunnerId":"","hostname":"","workerGroup":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.ReportTaskRunnerHeartbeat',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_status(client):
    ...
    """
    body = {"pipelineId":"","objectIds":"","status":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.SetStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_task_status(client):
    """Test case for set_task_status

    
    """
    body = {"errorStackTrace":"","errorMessage":"","errorId":"","taskId":"","taskStatus":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.SetTaskStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_validate_pipeline_definition(client):
    """Test case for validate_pipeline_definition
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=DataPipeline.ValidatePipelineDefinition',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
