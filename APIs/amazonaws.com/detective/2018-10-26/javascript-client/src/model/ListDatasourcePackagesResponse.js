...
/**
 * The ListDatasourcePackagesResponse model module.
 * @module model/ListDatasourcePackagesResponse
 * @version 2018-10-26
 */
class ListDatasourcePackagesResponse {
    /**
     * Constructs a new <code>ListDatasourcePackagesResponse</code>.
     * @alias module:model/ListDatasourcePackagesResponse
     */
    constructor() { 
        
        ListDatasourcePackagesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDatasourcePackagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasourcePackagesResponse} obj Optional instance to populate.
     * @return {module:model/ListDatasourcePackagesResponse} The populated <code>ListDatasourcePackagesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasourcePackagesResponse();

            if (data.hasOwnProperty('DatasourcePackages')) {
                obj['DatasourcePackages'] = ApiClient.convertToType(data['DatasourcePackages'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasourcePackagesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasourcePackagesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DatasourcePackages`
        if (data['DatasourcePackages']) { // data not null
          Object.validateJSON(data['DatasourcePackages']);
        }
...
/**
 * @member {Object} DatasourcePackages
 */
ListDatasourcePackagesResponse.prototype['DatasourcePackages'] = undefined;

/**
 * @member {String} NextToken
 */
ListDatasourcePackagesResponse.prototype['NextToken'] = undefined;
...
export default ListDatasourcePackagesResponse;
