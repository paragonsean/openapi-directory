...
/**
 * The MembershipDatasources model module.
 * @module model/MembershipDatasources
 * @version 2018-10-26
 */
class MembershipDatasources {
    /**
     * Constructs a new <code>MembershipDatasources</code>.
     * Details on data source packages for members of the behavior graph.
     * @alias module:model/MembershipDatasources
     */
    constructor() { 
        
        MembershipDatasources.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MembershipDatasources</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MembershipDatasources} obj Optional instance to populate.
     * @return {module:model/MembershipDatasources} The populated <code>MembershipDatasources</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MembershipDatasources();
            ...
            if (data.hasOwnProperty('DatasourcePackageIngestHistory')) {
                obj['DatasourcePackageIngestHistory'] = ApiClient.convertToType(data['DatasourcePackageIngestHistory'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MembershipDatasources</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MembershipDatasources</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DatasourcePackageIngestHistory']) { // data not null
          Object.validateJSON(data['DatasourcePackageIngestHistory']);
        }
 ...
 */
MembershipDatasources.prototype['AccountId'] = undefined;

/**
 * @member {String} GraphArn
 */
MembershipDatasources.prototype['GraphArn'] = undefined;

/**
 * @member {Object} DatasourcePackageIngestHistory
 */
MembershipDatasources.prototype['DatasourcePackageIngestHistory'] = undefined;
...
export default MembershipDatasources;
