...
/**
 * The CreateMembersResponse model module.
 * @module model/CreateMembersResponse
 * @version 2018-10-26
 */
class CreateMembersResponse {
    /**
     * Constructs a new <code>CreateMembersResponse</code>.
     * @alias module:model/CreateMembersResponse
     */
    constructor() { 
        
        CreateMembersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMembersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMembersResponse} obj Optional instance to populate.
     * @return {module:model/CreateMembersResponse} The populated <code>CreateMembersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMembersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMembersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMembersResponse</code>.
     */
 ...
 */
CreateMembersResponse.prototype['Members'] = undefined;

/**
 * @member {Array} UnprocessedAccounts
 */
CreateMembersResponse.prototype['UnprocessedAccounts'] = undefined;
...
export default CreateMembersResponse;
