...
class Administrator {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DelegationTime')) {
                obj['DelegationTime'] = ApiClient.convertToType(data['DelegationTime'], 'Date');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['DelegationTime']) { // data not null
          Date.validateJSON(data['DelegationTime']);
        }
 ...
 */
Administrator.prototype['AccountId'] = undefined;

/**
 * @member {String} GraphArn
 */
Administrator.prototype['GraphArn'] = undefined;

/**
 * @member {Date} DelegationTime
 */
Administrator.prototype['DelegationTime'] = undefined;
