...
* @readonly
*/
export default class DatasourcePackage {
    
        /**
         * value: "DETECTIVE_CORE"
         * @const
         */
        ...
        /**
         * value: "ASFF_SECURITYHUB_FINDING"
         * @const
         */
    ...
    /**
    * Returns a <code>DatasourcePackage</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DatasourcePackage} The enum <code>DatasourcePackage</code> value.
    */
