...
class EnableOrganizationAdminAccountRequest {
     ...
     * @param accountId {String} The Amazon Web Services account identifier of the account to designate as the Detective administrator account for the organization.
     */
    constructor(accountId) { 
        
        EnableOrganizationAdminAccountRequest.initialize(this, accountId);
    }
...
EnableOrganizationAdminAccountRequest.RequiredProperties = ["AccountId"];
 ...
 */
EnableOrganizationAdminAccountRequest.prototype['AccountId'] = undefined;
