...
/**
 * The DeleteMembersRequest model module.
 * @module model/DeleteMembersRequest
 * @version 2018-10-26
 */
class DeleteMembersRequest {
    /**
     * Constructs a new <code>DeleteMembersRequest</code>.
     * @alias module:model/DeleteMembersRequest
     * @param graphArn {String} The ARN of the behavior graph to remove members from.
     * @param accountIds {Array.<String>} The list of Amazon Web Services account identifiers for the member accounts to remove from the behavior graph. You can remove up to 50 member accounts at a time.
     */
    constructor(graphArn, accountIds) { 
        
        DeleteMembersRequest.initialize(this, graphArn, accountIds);
    }
    ...
    /**
     * Constructs a <code>DeleteMembersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMembersRequest} obj Optional instance to populate.
     * @return {module:model/DeleteMembersRequest} The populated <code>DeleteMembersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMembersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMembersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMembersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteMembersRequest.RequiredProperties) {
...
DeleteMembersRequest.RequiredProperties = ["GraphArn", "AccountIds"];

/**
 * The ARN of the behavior graph to remove members from.
 * @member {String} GraphArn
 */
DeleteMembersRequest.prototype['GraphArn'] = undefined;
 ...
 */
DeleteMembersRequest.prototype['AccountIds'] = undefined;
...
export default DeleteMembersRequest;
