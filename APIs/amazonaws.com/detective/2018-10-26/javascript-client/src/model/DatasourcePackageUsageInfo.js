...
/**
 * The DatasourcePackageUsageInfo model module.
 * @module model/DatasourcePackageUsageInfo
 * @version 2018-10-26
 */
class DatasourcePackageUsageInfo {
    /**
     * Constructs a new <code>DatasourcePackageUsageInfo</code>.
     * Information on the usage of a data source package in the behavior graph.
     * @alias module:model/DatasourcePackageUsageInfo
     */
    constructor() { 
        
        DatasourcePackageUsageInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasourcePackageUsageInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasourcePackageUsageInfo} obj Optional instance to populate.
     * @return {module:model/DatasourcePackageUsageInfo} The populated <code>DatasourcePackageUsageInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasourcePackageUsageInfo();

            if (data.hasOwnProperty('VolumeUsageInBytes')) {
                obj['VolumeUsageInBytes'] = ApiClient.convertToType(data['VolumeUsageInBytes'], 'Number');
            }
            if (data.hasOwnProperty('VolumeUsageUpdateTime')) {
                obj['VolumeUsageUpdateTime'] = ApiClient.convertToType(data['VolumeUsageUpdateTime'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatasourcePackageUsageInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasourcePackageUsageInfo</code>.
     */
    static validateJSON(data) {
        ...
        if (data['VolumeUsageUpdateTime']) { // data not null
          Date.validateJSON(data['VolumeUsageUpdateTime']);
        }
 ...
 */
DatasourcePackageUsageInfo.prototype['VolumeUsageInBytes'] = undefined;

/**
 * @member {Date} VolumeUsageUpdateTime
 */
DatasourcePackageUsageInfo.prototype['VolumeUsageUpdateTime'] = undefined;
...
export default DatasourcePackageUsageInfo;
