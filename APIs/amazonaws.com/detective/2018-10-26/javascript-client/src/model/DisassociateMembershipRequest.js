...
/**
 * The DisassociateMembershipRequest model module.
 * @module model/DisassociateMembershipRequest
 * @version 2018-10-26
 */
class DisassociateMembershipRequest {
    /**
     * Constructs a new <code>DisassociateMembershipRequest</code>.
     * @alias module:model/DisassociateMembershipRequest
     * @param graphArn {String} <p>The ARN of the behavior graph to remove the member account from.</p> <p>The member account's member status in the behavior graph must be <code>ENABLED</code>.</p>
     */
    constructor(graphArn) { 
        
        DisassociateMembershipRequest.initialize(this, graphArn);
    }
    ...
    /**
     * Constructs a <code>DisassociateMembershipRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateMembershipRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateMembershipRequest} The populated <code>DisassociateMembershipRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateMembershipRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateMembershipRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateMembershipRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateMembershipRequest.RequiredProperties) {
...
DisassociateMembershipRequest.RequiredProperties = ["GraphArn"];
 ...
 */
DisassociateMembershipRequest.prototype['GraphArn'] = undefined;
...
export default DisassociateMembershipRequest;
