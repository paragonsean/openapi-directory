...
/**
 * The DescribeOrganizationConfigurationRequest model module.
 * @module model/DescribeOrganizationConfigurationRequest
 * @version 2018-10-26
 */
class DescribeOrganizationConfigurationRequest {
    /**
     * Constructs a new <code>DescribeOrganizationConfigurationRequest</code>.
     * @alias module:model/DescribeOrganizationConfigurationRequest
     * @param graphArn {String} The ARN of the organization behavior graph.
     */
    constructor(graphArn) { 
        
        DescribeOrganizationConfigurationRequest.initialize(this, graphArn);
    }
    ...
    /**
     * Constructs a <code>DescribeOrganizationConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOrganizationConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeOrganizationConfigurationRequest} The populated <code>DescribeOrganizationConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOrganizationConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOrganizationConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOrganizationConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeOrganizationConfigurationRequest.RequiredProperties) {
...
DescribeOrganizationConfigurationRequest.RequiredProperties = ["GraphArn"];

/**
 * The ARN of the organization behavior graph.
 * @member {String} GraphArn
 */
DescribeOrganizationConfigurationRequest.prototype['GraphArn'] = undefined;
...
export default DescribeOrganizationConfigurationRequest;
