...
* @readonly
*/
export default class DatasourcePackageIngestState {
    ...
    /**
    * Returns a <code>DatasourcePackageIngestState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DatasourcePackageIngestState} The enum <code>DatasourcePackageIngestState</code> value.
    */
