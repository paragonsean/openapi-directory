...
/**
 * The DeleteMembersResponse model module.
 * @module model/DeleteMembersResponse
 * @version 2018-10-26
 */
class DeleteMembersResponse {
    /**
     * Constructs a new <code>DeleteMembersResponse</code>.
     * @alias module:model/DeleteMembersResponse
     */
    constructor() { 
        
        DeleteMembersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteMembersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMembersResponse} obj Optional instance to populate.
     * @return {module:model/DeleteMembersResponse} The populated <code>DeleteMembersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMembersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMembersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMembersResponse</code>.
     */
 ...
 */
DeleteMembersResponse.prototype['AccountIds'] = undefined;

/**
 * @member {Array} UnprocessedAccounts
 */
DeleteMembersResponse.prototype['UnprocessedAccounts'] = undefined;
...
export default DeleteMembersResponse;
