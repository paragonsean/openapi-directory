...
/**
 * The BatchGetMembershipDatasourcesResponse model module.
 * @module model/BatchGetMembershipDatasourcesResponse
 * @version 2018-10-26
 */
class BatchGetMembershipDatasourcesResponse {
    /**
     * Constructs a new <code>BatchGetMembershipDatasourcesResponse</code>.
     * @alias module:model/BatchGetMembershipDatasourcesResponse
     */
    constructor() { 
        
        BatchGetMembershipDatasourcesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetMembershipDatasourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetMembershipDatasourcesResponse} obj Optional instance to populate.
     * @return {module:model/BatchGetMembershipDatasourcesResponse} The populated <code>BatchGetMembershipDatasourcesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetMembershipDatasourcesResponse();

            if (data.hasOwnProperty('MembershipDatasources')) {
                obj['MembershipDatasources'] = ApiClient.convertToType(data['MembershipDatasources'], Array);
            }
            if (data.hasOwnProperty('UnprocessedGraphs')) {
                obj['UnprocessedGraphs'] = ApiClient.convertToType(data['UnprocessedGraphs'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetMembershipDatasourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetMembershipDatasourcesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MembershipDatasources`
        if (data['MembershipDatasources']) { // data not null
          Array.validateJSON(data['MembershipDatasources']);
        }
        // validate the optional field `UnprocessedGraphs`
        if (data['UnprocessedGraphs']) { // data not null
          Array.validateJSON(data['UnprocessedGraphs']);
        }
...
/**
 * @member {Array} MembershipDatasources
 */
BatchGetMembershipDatasourcesResponse.prototype['MembershipDatasources'] = undefined;

/**
 * @member {Array} UnprocessedGraphs
 */
BatchGetMembershipDatasourcesResponse.prototype['UnprocessedGraphs'] = undefined;
...
export default BatchGetMembershipDatasourcesResponse;
