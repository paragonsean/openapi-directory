...
/**
 * The GetMembersRequest model module.
 * @module model/GetMembersRequest
 * @version 2018-10-26
 */
class GetMembersRequest {
    /**
     * Constructs a new <code>GetMembersRequest</code>.
     * @alias module:model/GetMembersRequest
     * @param graphArn {String} The ARN of the behavior graph for which to request the member details.
     * @param accountIds {Array.<String>} <p>The list of Amazon Web Services account identifiers for the member account for which to return member details. You can request details for up to 50 member accounts at a time.</p> <p>You cannot use <code>GetMembers</code> to retrieve information about member accounts that were removed from the behavior graph.</p>
     */
    constructor(graphArn, accountIds) { 
        
        GetMembersRequest.initialize(this, graphArn, accountIds);
    }
    ...
    /**
     * Constructs a <code>GetMembersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMembersRequest} obj Optional instance to populate.
     * @return {module:model/GetMembersRequest} The populated <code>GetMembersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMembersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMembersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMembersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMembersRequest.RequiredProperties) {
...
GetMembersRequest.RequiredProperties = ["GraphArn", "AccountIds"];

/**
 * The ARN of the behavior graph for which to request the member details.
 * @member {String} GraphArn
 */
GetMembersRequest.prototype['GraphArn'] = undefined;
 ...
 */
GetMembersRequest.prototype['AccountIds'] = undefined;
