...
import DatasourcePackageIngestState from './DatasourcePackageIngestState';

/**
 * The DatasourcePackageIngestDetail model module.
 * @module model/DatasourcePackageIngestDetail
 * @version 2018-10-26
 */
class DatasourcePackageIngestDetail {
    /**
     * Constructs a new <code>DatasourcePackageIngestDetail</code>.
     * Details about the data source packages ingested by your behavior graph.
     * @alias module:model/DatasourcePackageIngestDetail
     */
    constructor() { 
        
        DatasourcePackageIngestDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatasourcePackageIngestDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatasourcePackageIngestDetail} obj Optional instance to populate.
     * @return {module:model/DatasourcePackageIngestDetail} The populated <code>DatasourcePackageIngestDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatasourcePackageIngestDetail();

            if (data.hasOwnProperty('DatasourcePackageIngestState')) {
                obj['DatasourcePackageIngestState'] = ApiClient.convertToType(data['DatasourcePackageIngestState'], DatasourcePackageIngestState);
            }
            if (data.hasOwnProperty('LastIngestStateChange')) {
                obj['LastIngestStateChange'] = ApiClient.convertToType(data['LastIngestStateChange'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatasourcePackageIngestDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatasourcePackageIngestDetail</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DatasourcePackageIngestState`
        if (data['DatasourcePackageIngestState']) { // data not null
          DatasourcePackageIngestState.validateJSON(data['DatasourcePackageIngestState']);
        }
        // validate the optional field `LastIngestStateChange`
        if (data['LastIngestStateChange']) { // data not null
          Object.validateJSON(data['LastIngestStateChange']);
        }
...
/**
 * @member {module:model/DatasourcePackageIngestState} DatasourcePackageIngestState
 */
DatasourcePackageIngestDetail.prototype['DatasourcePackageIngestState'] = undefined;

/**
 * @member {Object} LastIngestStateChange
 */
DatasourcePackageIngestDetail.prototype['LastIngestStateChange'] = undefined;
...
export default DatasourcePackageIngestDetail;
