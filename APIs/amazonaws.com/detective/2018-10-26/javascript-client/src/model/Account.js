...
class Account {
     ...
     */
    constructor(accountId, emailAddress) { 
        
        Account.initialize(this, accountId, emailAddress);
    }
     ...
     */
    static initialize(obj, accountId, emailAddress) { 
...
Account.RequiredProperties = ["AccountId", "EmailAddress"];
