...
/**
 * The CreateMembersRequest model module.
 * @module model/CreateMembersRequest
 * @version 2018-10-26
 */
class CreateMembersRequest {
    /**
     * Constructs a new <code>CreateMembersRequest</code>.
     * @alias module:model/CreateMembersRequest
     * @param graphArn {String} The ARN of the behavior graph.
     * @param accounts {Array.<module:model/Account>} The list of Amazon Web Services accounts to invite or to enable. You can invite or enable up to 50 accounts at a time. For each invited account, the account list contains the account identifier and the Amazon Web Services account root user email address. For organization accounts in the organization behavior graph, the email address is not required.
     */
    constructor(graphArn, accounts) { 
        
        CreateMembersRequest.initialize(this, graphArn, accounts);
    }
     ...
     */
    static initialize(obj, graphArn, accounts) { 
        obj['GraphArn'] = graphArn;
        obj['Accounts'] = accounts;
    }

    /**
     * Constructs a <code>CreateMembersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMembersRequest} obj Optional instance to populate.
     * @return {module:model/CreateMembersRequest} The populated <code>CreateMembersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMembersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMembersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMembersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateMembersRequest.RequiredProperties) {
...
CreateMembersRequest.RequiredProperties = ["GraphArn", "Accounts"];

/**
 * The ARN of the behavior graph.
 * @member {String} GraphArn
 */
CreateMembersRequest.prototype['GraphArn'] = undefined;

/**
 * Customized message text to include in the invitation email message to the invited member accounts.
 * @member {String} Message
 */
CreateMembersRequest.prototype['Message'] = undefined;
 ...
 */
CreateMembersRequest.prototype['DisableEmailNotification'] = undefined;
 ...
 */
CreateMembersRequest.prototype['Accounts'] = undefined;
...
export default CreateMembersRequest;
