...
class ListMembersResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MemberDetails')) {
                obj['MemberDetails'] = ApiClient.convertToType(data['MemberDetails'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['MemberDetails']) { // data not null
          Array.validateJSON(data['MemberDetails']);
        }
...
/**
 * @member {Array} MemberDetails
 */
ListMembersResponse.prototype['MemberDetails'] = undefined;
