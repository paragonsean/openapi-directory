...
/**
 * The StartMonitoringMemberRequest model module.
 * @module model/StartMonitoringMemberRequest
 * @version 2018-10-26
 */
class StartMonitoringMemberRequest {
    /**
     * Constructs a new <code>StartMonitoringMemberRequest</code>.
     * @alias module:model/StartMonitoringMemberRequest
     * @param graphArn {String} The ARN of the behavior graph.
     * @param accountId {String} <p>The account ID of the member account to try to enable.</p> <p>The account must be an invited member account with a status of <code>ACCEPTED_BUT_DISABLED</code>. </p>
     */
    constructor(graphArn, accountId) { 
        
        StartMonitoringMemberRequest.initialize(this, graphArn, accountId);
    }
     ...
     */
    static initialize(obj, graphArn, accountId) { 
        obj['GraphArn'] = graphArn;
        obj['AccountId'] = accountId;
    }

    /**
     * Constructs a <code>StartMonitoringMemberRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMonitoringMemberRequest} obj Optional instance to populate.
     * @return {module:model/StartMonitoringMemberRequest} The populated <code>StartMonitoringMemberRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMonitoringMemberRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMonitoringMemberRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMonitoringMemberRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartMonitoringMemberRequest.RequiredProperties) {
...
StartMonitoringMemberRequest.RequiredProperties = ["GraphArn", "AccountId"];

/**
 * The ARN of the behavior graph.
 * @member {String} GraphArn
 */
StartMonitoringMemberRequest.prototype['GraphArn'] = undefined;
 ...
 */
StartMonitoringMemberRequest.prototype['AccountId'] = undefined;
...
export default StartMonitoringMemberRequest;
