...
/**
 * The ListDatasourcePackagesRequest model module.
 * @module model/ListDatasourcePackagesRequest
 * @version 2018-10-26
 */
class ListDatasourcePackagesRequest {
    /**
     * Constructs a new <code>ListDatasourcePackagesRequest</code>.
     * @alias module:model/ListDatasourcePackagesRequest
     * @param graphArn {String} The ARN of the behavior graph.
     */
    constructor(graphArn) { 
        
        ListDatasourcePackagesRequest.initialize(this, graphArn);
    }
     ...
     */
    static initialize(obj, graphArn) { 
        obj['GraphArn'] = graphArn;
    }

    /**
     * Constructs a <code>ListDatasourcePackagesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatasourcePackagesRequest} obj Optional instance to populate.
     * @return {module:model/ListDatasourcePackagesRequest} The populated <code>ListDatasourcePackagesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatasourcePackagesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatasourcePackagesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatasourcePackagesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDatasourcePackagesRequest.RequiredProperties) {
...
ListDatasourcePackagesRequest.RequiredProperties = ["GraphArn"];

/**
 * The ARN of the behavior graph.
 * @member {String} GraphArn
 */
ListDatasourcePackagesRequest.prototype['GraphArn'] = undefined;

/**
 * For requests to get the next page of results, the pagination token that was returned with the previous set of results. The initial request does not include a pagination token.
 * @member {String} NextToken
 */
ListDatasourcePackagesRequest.prototype['NextToken'] = undefined;

/**
 * The maximum number of results to return.
 * @member {Number} MaxResults
 */
ListDatasourcePackagesRequest.prototype['MaxResults'] = undefined;
...
export default ListDatasourcePackagesRequest;
