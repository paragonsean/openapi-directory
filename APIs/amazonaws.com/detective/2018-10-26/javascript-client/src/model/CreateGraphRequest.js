...
/**
 * The CreateGraphRequest model module.
 * @module model/CreateGraphRequest
 * @version 2018-10-26
 */
class CreateGraphRequest {
    /**
     * Constructs a new <code>CreateGraphRequest</code>.
     * @alias module:model/CreateGraphRequest
     */
    constructor() { 
        
        CreateGraphRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGraphRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGraphRequest} obj Optional instance to populate.
     * @return {module:model/CreateGraphRequest} The populated <code>CreateGraphRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGraphRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGraphRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGraphRequest</code>.
     */
 ...
 */
CreateGraphRequest.prototype['Tags'] = undefined;
...
export default CreateGraphRequest;
