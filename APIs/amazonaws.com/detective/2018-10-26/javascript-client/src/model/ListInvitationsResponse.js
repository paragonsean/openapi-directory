...
class ListInvitationsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Invitations')) {
                obj['Invitations'] = ApiClient.convertToType(data['Invitations'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Invitations']) { // data not null
          Array.validateJSON(data['Invitations']);
        }
 ...
 */
ListInvitationsResponse.prototype['NextToken'] = undefined;
