...
class AcceptInvitationRequest {
     ...
     * @param graphArn {String} <p>The ARN of the behavior graph that the member account is accepting the invitation for.</p> <p>The member account status in the behavior graph must be <code>INVITED</code>.</p>
     */
    constructor(graphArn) { 
        
        AcceptInvitationRequest.initialize(this, graphArn);
    }
...
AcceptInvitationRequest.RequiredProperties = ["GraphArn"];
 ...
 */
AcceptInvitationRequest.prototype['GraphArn'] = undefined;
