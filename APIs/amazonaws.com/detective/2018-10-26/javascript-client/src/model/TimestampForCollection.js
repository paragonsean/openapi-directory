...
/**
 * The TimestampForCollection model module.
 * @module model/TimestampForCollection
 * @version 2018-10-26
 */
class TimestampForCollection {
    /**
     * Constructs a new <code>TimestampForCollection</code>.
     * Details on when data collection began for a source package.
     * @alias module:model/TimestampForCollection
     */
    constructor() { 
        
        TimestampForCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimestampForCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimestampForCollection} obj Optional instance to populate.
     * @return {module:model/TimestampForCollection} The populated <code>TimestampForCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimestampForCollection();
    ...
    /**
     * Validates the JSON data with respect to <code>TimestampForCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimestampForCollection</code>.
     */
 ...
 */
TimestampForCollection.prototype['Timestamp'] = undefined;
...
export default TimestampForCollection;
