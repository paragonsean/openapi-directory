...
/**
 * The UnprocessedGraph model module.
 * @module model/UnprocessedGraph
 * @version 2018-10-26
 */
class UnprocessedGraph {
    /**
     * Constructs a new <code>UnprocessedGraph</code>.
     * Behavior graphs that could not be processed in the request.
     * @alias module:model/UnprocessedGraph
     */
    constructor() { 
        
        UnprocessedGraph.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnprocessedGraph</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnprocessedGraph} obj Optional instance to populate.
     * @return {module:model/UnprocessedGraph} The populated <code>UnprocessedGraph</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnprocessedGraph();
    ...
    /**
     * Validates the JSON data with respect to <code>UnprocessedGraph</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnprocessedGraph</code>.
     */
 ...
 */
UnprocessedGraph.prototype['GraphArn'] = undefined;

/**
 * @member {String} Reason
 */
UnprocessedGraph.prototype['Reason'] = undefined;
...
export default UnprocessedGraph;
