...
/**
 * The BatchGetGraphMemberDatasourcesResponse model module.
 * @module model/BatchGetGraphMemberDatasourcesResponse
 * @version 2018-10-26
 */
class BatchGetGraphMemberDatasourcesResponse {
    /**
     * Constructs a new <code>BatchGetGraphMemberDatasourcesResponse</code>.
     * @alias module:model/BatchGetGraphMemberDatasourcesResponse
     */
    constructor() { 
        
        BatchGetGraphMemberDatasourcesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetGraphMemberDatasourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetGraphMemberDatasourcesResponse} obj Optional instance to populate.
     * @return {module:model/BatchGetGraphMemberDatasourcesResponse} The populated <code>BatchGetGraphMemberDatasourcesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetGraphMemberDatasourcesResponse();

            if (data.hasOwnProperty('MemberDatasources')) {
                obj['MemberDatasources'] = ApiClient.convertToType(data['MemberDatasources'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetGraphMemberDatasourcesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetGraphMemberDatasourcesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MemberDatasources`
        if (data['MemberDatasources']) { // data not null
          Array.validateJSON(data['MemberDatasources']);
        }
...
/**
 * @member {Array} MemberDatasources
 */
BatchGetGraphMemberDatasourcesResponse.prototype['MemberDatasources'] = undefined;

/**
 * @member {Array} UnprocessedAccounts
 */
BatchGetGraphMemberDatasourcesResponse.prototype['UnprocessedAccounts'] = undefined;
...
export default BatchGetGraphMemberDatasourcesResponse;
