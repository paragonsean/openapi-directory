...
/**
 * The ListGraphsResponse model module.
 * @module model/ListGraphsResponse
 * @version 2018-10-26
 */
class ListGraphsResponse {
    /**
     * Constructs a new <code>ListGraphsResponse</code>.
     * @alias module:model/ListGraphsResponse
     */
    constructor() { 
        
        ListGraphsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListGraphsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListGraphsResponse} obj Optional instance to populate.
     * @return {module:model/ListGraphsResponse} The populated <code>ListGraphsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListGraphsResponse();

            if (data.hasOwnProperty('GraphList')) {
                obj['GraphList'] = ApiClient.convertToType(data['GraphList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListGraphsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListGraphsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `GraphList`
        if (data['GraphList']) { // data not null
          Array.validateJSON(data['GraphList']);
        }
...
/**
 * @member {Array} GraphList
 */
ListGraphsResponse.prototype['GraphList'] = undefined;

/**
 * @member {String} NextToken
 */
ListGraphsResponse.prototype['NextToken'] = undefined;
...
export default ListGraphsResponse;
