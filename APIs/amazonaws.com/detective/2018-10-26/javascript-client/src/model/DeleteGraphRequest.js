...
/**
 * The DeleteGraphRequest model module.
 * @module model/DeleteGraphRequest
 * @version 2018-10-26
 */
class DeleteGraphRequest {
    /**
     * Constructs a new <code>DeleteGraphRequest</code>.
     * @alias module:model/DeleteGraphRequest
     * @param graphArn {String} The ARN of the behavior graph to disable.
     */
    constructor(graphArn) { 
        
        DeleteGraphRequest.initialize(this, graphArn);
    }
    ...
    /**
     * Constructs a <code>DeleteGraphRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteGraphRequest} obj Optional instance to populate.
     * @return {module:model/DeleteGraphRequest} The populated <code>DeleteGraphRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteGraphRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteGraphRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteGraphRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteGraphRequest.RequiredProperties) {
...
DeleteGraphRequest.RequiredProperties = ["GraphArn"];

/**
 * The ARN of the behavior graph to disable.
 * @member {String} GraphArn
 */
DeleteGraphRequest.prototype['GraphArn'] = undefined;
...
export default DeleteGraphRequest;
