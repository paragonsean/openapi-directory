...
/**
 * The RejectInvitationRequest model module.
 * @module model/RejectInvitationRequest
 * @version 2018-10-26
 */
class RejectInvitationRequest {
    /**
     * Constructs a new <code>RejectInvitationRequest</code>.
     * @alias module:model/RejectInvitationRequest
     * @param graphArn {String} <p>The ARN of the behavior graph to reject the invitation to.</p> <p>The member account's current member status in the behavior graph must be <code>INVITED</code>.</p>
     */
    constructor(graphArn) { 
        
        RejectInvitationRequest.initialize(this, graphArn);
    }
    ...
    /**
     * Constructs a <code>RejectInvitationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RejectInvitationRequest} obj Optional instance to populate.
     * @return {module:model/RejectInvitationRequest} The populated <code>RejectInvitationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RejectInvitationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RejectInvitationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RejectInvitationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RejectInvitationRequest.RequiredProperties) {
...
RejectInvitationRequest.RequiredProperties = ["GraphArn"];
 ...
 */
RejectInvitationRequest.prototype['GraphArn'] = undefined;
