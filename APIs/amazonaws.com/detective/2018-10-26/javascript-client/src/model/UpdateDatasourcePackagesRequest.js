...
import DatasourcePackage from './DatasourcePackage';

/**
 * The UpdateDatasourcePackagesRequest model module.
 * @module model/UpdateDatasourcePackagesRequest
 * @version 2018-10-26
 */
class UpdateDatasourcePackagesRequest {
    /**
     * Constructs a new <code>UpdateDatasourcePackagesRequest</code>.
     * @alias module:model/UpdateDatasourcePackagesRequest
     * @param graphArn {String} The ARN of the behavior graph.
     * @param datasourcePackages {Array.<module:model/DatasourcePackage>} The data source package start for the behavior graph.
     */
    constructor(graphArn, datasourcePackages) { 
        
        UpdateDatasourcePackagesRequest.initialize(this, graphArn, datasourcePackages);
    }
     ...
     */
    static initialize(obj, graphArn, datasourcePackages) { 
        obj['GraphArn'] = graphArn;
        obj['DatasourcePackages'] = datasourcePackages;
    }

    /**
     * Constructs a <code>UpdateDatasourcePackagesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDatasourcePackagesRequest} obj Optional instance to populate.
     * @return {module:model/UpdateDatasourcePackagesRequest} The populated <code>UpdateDatasourcePackagesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDatasourcePackagesRequest();

            if (data.hasOwnProperty('GraphArn')) {
                obj['GraphArn'] = ApiClient.convertToType(data['GraphArn'], 'String');
            }
            if (data.hasOwnProperty('DatasourcePackages')) {
                obj['DatasourcePackages'] = ApiClient.convertToType(data['DatasourcePackages'], [DatasourcePackage]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDatasourcePackagesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDatasourcePackagesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDatasourcePackagesRequest.RequiredProperties) {
        ...
        if (!Array.isArray(data['DatasourcePackages'])) {
            throw new Error("Expected the field `DatasourcePackages` to be an array in the JSON data but got " + data['DatasourcePackages']);
        }
...
UpdateDatasourcePackagesRequest.RequiredProperties = ["GraphArn", "DatasourcePackages"];

/**
 * The ARN of the behavior graph.
 * @member {String} GraphArn
 */
UpdateDatasourcePackagesRequest.prototype['GraphArn'] = undefined;

/**
 * The data source package start for the behavior graph.
 * @member {Array.<module:model/DatasourcePackage>} DatasourcePackages
 */
UpdateDatasourcePackagesRequest.prototype['DatasourcePackages'] = undefined;
...
export default UpdateDatasourcePackagesRequest;
