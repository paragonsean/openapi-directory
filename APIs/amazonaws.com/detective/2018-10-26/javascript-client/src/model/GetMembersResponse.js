...
/**
 * The GetMembersResponse model module.
 * @module model/GetMembersResponse
 * @version 2018-10-26
 */
class GetMembersResponse {
    /**
     * Constructs a new <code>GetMembersResponse</code>.
     * @alias module:model/GetMembersResponse
     */
    constructor() { 
        
        GetMembersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetMembersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMembersResponse} obj Optional instance to populate.
     * @return {module:model/GetMembersResponse} The populated <code>GetMembersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMembersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMembersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMembersResponse</code>.
     */
 ...
 */
GetMembersResponse.prototype['MemberDetails'] = undefined;

/**
 * @member {Array} UnprocessedAccounts
 */
GetMembersResponse.prototype['UnprocessedAccounts'] = undefined;
