...
/**
 * The ListInvitationsRequest model module.
 * @module model/ListInvitationsRequest
 * @version 2018-10-26
 */
class ListInvitationsRequest {
    /**
     * Constructs a new <code>ListInvitationsRequest</code>.
     * @alias module:model/ListInvitationsRequest
     */
    constructor() { 
        
        ListInvitationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListInvitationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListInvitationsRequest} obj Optional instance to populate.
     * @return {module:model/ListInvitationsRequest} The populated <code>ListInvitationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListInvitationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListInvitationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInvitationsRequest</code>.
     */
 ...
 */
ListInvitationsRequest.prototype['NextToken'] = undefined;

/**
 * The maximum number of behavior graph invitations to return in the response. The total must be less than the overall limit on the number of results to return, which is currently 200.
 * @member {Number} MaxResults
 */
ListInvitationsRequest.prototype['MaxResults'] = undefined;
...
export default ListInvitationsRequest;
