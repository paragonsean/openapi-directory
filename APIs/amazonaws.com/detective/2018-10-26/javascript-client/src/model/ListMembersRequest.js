...
class ListMembersRequest {
     ...
     * @param graphArn {String} The ARN of the behavior graph for which to retrieve the list of member accounts.
     */
    constructor(graphArn) { 
        
        ListMembersRequest.initialize(this, graphArn);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListMembersRequest.RequiredProperties) {
...
ListMembersRequest.RequiredProperties = ["GraphArn"];

/**
 * The ARN of the behavior graph for which to retrieve the list of member accounts.
 * @member {String} GraphArn
 */
ListMembersRequest.prototype['GraphArn'] = undefined;
