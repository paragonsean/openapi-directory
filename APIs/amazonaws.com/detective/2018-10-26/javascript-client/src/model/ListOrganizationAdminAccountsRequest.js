...
/**
 * The ListOrganizationAdminAccountsRequest model module.
 * @module model/ListOrganizationAdminAccountsRequest
 * @version 2018-10-26
 */
class ListOrganizationAdminAccountsRequest {
    /**
     * Constructs a new <code>ListOrganizationAdminAccountsRequest</code>.
     * @alias module:model/ListOrganizationAdminAccountsRequest
     */
    constructor() { 
        
        ListOrganizationAdminAccountsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListOrganizationAdminAccountsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOrganizationAdminAccountsRequest} obj Optional instance to populate.
     * @return {module:model/ListOrganizationAdminAccountsRequest} The populated <code>ListOrganizationAdminAccountsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListOrganizationAdminAccountsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListOrganizationAdminAccountsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListOrganizationAdminAccountsRequest</code>.
     */
 ...
 */
ListOrganizationAdminAccountsRequest.prototype['NextToken'] = undefined;

/**
 * The maximum number of results to return.
 * @member {Number} MaxResults
 */
ListOrganizationAdminAccountsRequest.prototype['MaxResults'] = undefined;
...
export default ListOrganizationAdminAccountsRequest;
