...
/**
 * The BatchGetMembershipDatasourcesRequest model module.
 * @module model/BatchGetMembershipDatasourcesRequest
 * @version 2018-10-26
 */
class BatchGetMembershipDatasourcesRequest {
    /**
     * Constructs a new <code>BatchGetMembershipDatasourcesRequest</code>.
     * @alias module:model/BatchGetMembershipDatasourcesRequest
     * @param graphArns {Array.<String>} The ARN of the behavior graph.
     */
    constructor(graphArns) { 
        
        BatchGetMembershipDatasourcesRequest.initialize(this, graphArns);
    }
     ...
     */
    static initialize(obj, graphArns) { 
        obj['GraphArns'] = graphArns;
    }

    /**
     * Constructs a <code>BatchGetMembershipDatasourcesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetMembershipDatasourcesRequest} obj Optional instance to populate.
     * @return {module:model/BatchGetMembershipDatasourcesRequest} The populated <code>BatchGetMembershipDatasourcesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetMembershipDatasourcesRequest();

            if (data.hasOwnProperty('GraphArns')) {
                obj['GraphArns'] = ApiClient.convertToType(data['GraphArns'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetMembershipDatasourcesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetMembershipDatasourcesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchGetMembershipDatasourcesRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['GraphArns'])) {
            throw new Error("Expected the field `GraphArns` to be an array in the JSON data but got " + data['GraphArns']);
        }
...
BatchGetMembershipDatasourcesRequest.RequiredProperties = ["GraphArns"];

/**
 * The ARN of the behavior graph.
 * @member {Array.<String>} GraphArns
 */
BatchGetMembershipDatasourcesRequest.prototype['GraphArns'] = undefined;
...
export default BatchGetMembershipDatasourcesRequest;
