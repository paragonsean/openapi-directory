...
* @readonly
*/
export default class MemberDisabledReason {
    
        /**
         * value: "VOLUME_TOO_HIGH"
         * @const
         */
    ...
    /**
    * Returns a <code>MemberDisabledReason</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MemberDisabledReason} The enum <code>MemberDisabledReason</code> value.
    */
