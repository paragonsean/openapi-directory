...
class ListOrganizationAdminAccountsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Administrators')) {
                obj['Administrators'] = ApiClient.convertToType(data['Administrators'], Array);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Administrators']) { // data not null
          Array.validateJSON(data['Administrators']);
        }
...
/**
 * @member {Array} Administrators
 */
ListOrganizationAdminAccountsResponse.prototype['Administrators'] = undefined;
