...
/**
 * The CreateGraphResponse model module.
 * @module model/CreateGraphResponse
 * @version 2018-10-26
 */
class CreateGraphResponse {
    /**
     * Constructs a new <code>CreateGraphResponse</code>.
     * @alias module:model/CreateGraphResponse
     */
    constructor() { 
        
        CreateGraphResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateGraphResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateGraphResponse} obj Optional instance to populate.
     * @return {module:model/CreateGraphResponse} The populated <code>CreateGraphResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateGraphResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateGraphResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateGraphResponse</code>.
     */
 ...
 */
CreateGraphResponse.prototype['GraphArn'] = undefined;
...
export default CreateGraphResponse;
