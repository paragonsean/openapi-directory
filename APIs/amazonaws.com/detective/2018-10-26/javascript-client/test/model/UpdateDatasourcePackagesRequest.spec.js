...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.UpdateDatasourcePackagesRequest();
  });
  ...
  describe('UpdateDatasourcePackagesRequest', function() {
    it('should create an instance of UpdateDatasourcePackagesRequest', function() {
      // uncomment below and update the code to test UpdateDatasourcePackagesRequest
      //var instance = new AmazonDetective.UpdateDatasourcePackagesRequest();
      //expect(instance).to.be.a(AmazonDetective.UpdateDatasourcePackagesRequest);
    });
    ...
    it('should have the property datasourcePackages (base name: "DatasourcePackages")', function() {
      // uncomment below and update the code to test the property datasourcePackages
      //var instance = new AmazonDetective.UpdateDatasourcePackagesRequest();
      //expect(instance).to.be();
    });
