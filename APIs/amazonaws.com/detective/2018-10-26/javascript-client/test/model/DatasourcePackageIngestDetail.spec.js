...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DatasourcePackageIngestDetail();
  });
  ...
  describe('DatasourcePackageIngestDetail', function() {
    it('should create an instance of DatasourcePackageIngestDetail', function() {
      // uncomment below and update the code to test DatasourcePackageIngestDetail
      //var instance = new AmazonDetective.DatasourcePackageIngestDetail();
      //expect(instance).to.be.a(AmazonDetective.DatasourcePackageIngestDetail);
    });

    it('should have the property datasourcePackageIngestState (base name: "DatasourcePackageIngestState")', function() {
      // uncomment below and update the code to test the property datasourcePackageIngestState
      //var instance = new AmazonDetective.DatasourcePackageIngestDetail();
      //expect(instance).to.be();
    });

    it('should have the property lastIngestStateChange (base name: "LastIngestStateChange")', function() {
      // uncomment below and update the code to test the property lastIngestStateChange
      //var instance = new AmazonDetective.DatasourcePackageIngestDetail();
      //expect(instance).to.be();
    });
