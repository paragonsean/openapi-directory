...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.CreateMembersRequest();
  });
  ...
  describe('CreateMembersRequest', function() {
    it('should create an instance of CreateMembersRequest', function() {
      // uncomment below and update the code to test CreateMembersRequest
      //var instance = new AmazonDetective.CreateMembersRequest();
      //expect(instance).to.be.a(AmazonDetective.CreateMembersRequest);
    });
    ...
    it('should have the property disableEmailNotification (base name: "DisableEmailNotification")', function() {
      // uncomment below and update the code to test the property disableEmailNotification
      //var instance = new AmazonDetective.CreateMembersRequest();
      //expect(instance).to.be();
    });
