...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.RejectInvitationRequest();
  });
  ...
  describe('RejectInvitationRequest', function() {
    it('should create an instance of RejectInvitationRequest', function() {
      // uncomment below and update the code to test RejectInvitationRequest
      //var instance = new AmazonDetective.RejectInvitationRequest();
      //expect(instance).to.be.a(AmazonDetective.RejectInvitationRequest);
    });
