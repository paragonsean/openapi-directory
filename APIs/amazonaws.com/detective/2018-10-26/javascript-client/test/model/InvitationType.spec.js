...
(function(root, factory) {
  ...
  describe('InvitationType', function() {
    it('should create an instance of InvitationType', function() {
      // uncomment below and update the code to test InvitationType
      //var instance = new AmazonDetective.InvitationType();
      //expect(instance).to.be.a(AmazonDetective.InvitationType);
    });
