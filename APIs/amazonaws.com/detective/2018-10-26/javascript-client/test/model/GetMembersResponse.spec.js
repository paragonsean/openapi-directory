...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.GetMembersResponse();
  });
  ...
  describe('GetMembersResponse', function() {
    it('should create an instance of GetMembersResponse', function() {
      // uncomment below and update the code to test GetMembersResponse
      //var instance = new AmazonDetective.GetMembersResponse();
      //expect(instance).to.be.a(AmazonDetective.GetMembersResponse);
    });
