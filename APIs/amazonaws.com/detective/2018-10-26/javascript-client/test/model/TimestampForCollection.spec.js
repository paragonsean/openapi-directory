...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.TimestampForCollection();
  });
  ...
  describe('TimestampForCollection', function() {
    it('should create an instance of TimestampForCollection', function() {
      // uncomment below and update the code to test TimestampForCollection
      //var instance = new AmazonDetective.TimestampForCollection();
      //expect(instance).to.be.a(AmazonDetective.TimestampForCollection);
    });
