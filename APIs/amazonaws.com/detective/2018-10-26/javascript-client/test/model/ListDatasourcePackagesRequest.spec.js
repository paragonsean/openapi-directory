...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListDatasourcePackagesRequest();
  });
  ...
  describe('ListDatasourcePackagesRequest', function() {
    it('should create an instance of ListDatasourcePackagesRequest', function() {
      // uncomment below and update the code to test ListDatasourcePackagesRequest
      //var instance = new AmazonDetective.ListDatasourcePackagesRequest();
      //expect(instance).to.be.a(AmazonDetective.ListDatasourcePackagesRequest);
    });
