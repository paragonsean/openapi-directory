...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.UpdateOrganizationConfigurationRequest();
  });
  ...
  describe('UpdateOrganizationConfigurationRequest', function() {
    it('should create an instance of UpdateOrganizationConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateOrganizationConfigurationRequest
      //var instance = new AmazonDetective.UpdateOrganizationConfigurationRequest();
      //expect(instance).to.be.a(AmazonDetective.UpdateOrganizationConfigurationRequest);
    });
    ...
    it('should have the property autoEnable (base name: "AutoEnable")', function() {
      // uncomment below and update the code to test the property autoEnable
      //var instance = new AmazonDetective.UpdateOrganizationConfigurationRequest();
      //expect(instance).to.be();
    });
