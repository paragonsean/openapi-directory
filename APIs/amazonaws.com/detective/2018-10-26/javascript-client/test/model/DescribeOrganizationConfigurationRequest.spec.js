...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DescribeOrganizationConfigurationRequest();
  });
  ...
  describe('DescribeOrganizationConfigurationRequest', function() {
    it('should create an instance of DescribeOrganizationConfigurationRequest', function() {
      // uncomment below and update the code to test DescribeOrganizationConfigurationRequest
      //var instance = new AmazonDetective.DescribeOrganizationConfigurationRequest();
      //expect(instance).to.be.a(AmazonDetective.DescribeOrganizationConfigurationRequest);
    });
