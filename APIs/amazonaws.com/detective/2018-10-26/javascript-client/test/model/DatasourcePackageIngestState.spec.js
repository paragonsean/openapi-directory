...
(function(root, factory) {
  ...
  describe('DatasourcePackageIngestState', function() {
    it('should create an instance of DatasourcePackageIngestState', function() {
      // uncomment below and update the code to test DatasourcePackageIngestState
      //var instance = new AmazonDetective.DatasourcePackageIngestState();
      //expect(instance).to.be.a(AmazonDetective.DatasourcePackageIngestState);
    });
