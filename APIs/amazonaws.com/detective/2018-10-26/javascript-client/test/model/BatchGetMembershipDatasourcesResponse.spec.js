...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.BatchGetMembershipDatasourcesResponse();
  });
  ...
  describe('BatchGetMembershipDatasourcesResponse', function() {
    it('should create an instance of BatchGetMembershipDatasourcesResponse', function() {
      // uncomment below and update the code to test BatchGetMembershipDatasourcesResponse
      //var instance = new AmazonDetective.BatchGetMembershipDatasourcesResponse();
      //expect(instance).to.be.a(AmazonDetective.BatchGetMembershipDatasourcesResponse);
    });

    it('should have the property membershipDatasources (base name: "MembershipDatasources")', function() {
      // uncomment below and update the code to test the property membershipDatasources
      //var instance = new AmazonDetective.BatchGetMembershipDatasourcesResponse();
      //expect(instance).to.be();
    });

    it('should have the property unprocessedGraphs (base name: "UnprocessedGraphs")', function() {
      // uncomment below and update the code to test the property unprocessedGraphs
      //var instance = new AmazonDetective.BatchGetMembershipDatasourcesResponse();
      //expect(instance).to.be();
    });
