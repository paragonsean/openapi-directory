...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DeleteMembersResponse();
  });
  ...
  describe('DeleteMembersResponse', function() {
    it('should create an instance of DeleteMembersResponse', function() {
      // uncomment below and update the code to test DeleteMembersResponse
      //var instance = new AmazonDetective.DeleteMembersResponse();
      //expect(instance).to.be.a(AmazonDetective.DeleteMembersResponse);
    });
