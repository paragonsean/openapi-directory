...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DisassociateMembershipRequest();
  });
  ...
  describe('DisassociateMembershipRequest', function() {
    it('should create an instance of DisassociateMembershipRequest', function() {
      // uncomment below and update the code to test DisassociateMembershipRequest
      //var instance = new AmazonDetective.DisassociateMembershipRequest();
      //expect(instance).to.be.a(AmazonDetective.DisassociateMembershipRequest);
    });
