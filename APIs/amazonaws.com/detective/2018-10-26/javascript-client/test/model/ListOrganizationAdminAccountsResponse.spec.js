...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListOrganizationAdminAccountsResponse();
  });
  ...
  describe('ListOrganizationAdminAccountsResponse', function() {
    it('should create an instance of ListOrganizationAdminAccountsResponse', function() {
      // uncomment below and update the code to test ListOrganizationAdminAccountsResponse
      //var instance = new AmazonDetective.ListOrganizationAdminAccountsResponse();
      //expect(instance).to.be.a(AmazonDetective.ListOrganizationAdminAccountsResponse);
    });

    it('should have the property administrators (base name: "Administrators")', function() {
      // uncomment below and update the code to test the property administrators
      //var instance = new AmazonDetective.ListOrganizationAdminAccountsResponse();
