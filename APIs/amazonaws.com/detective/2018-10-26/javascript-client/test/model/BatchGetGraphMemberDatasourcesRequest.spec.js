...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.BatchGetGraphMemberDatasourcesRequest();
  });
  ...
  describe('BatchGetGraphMemberDatasourcesRequest', function() {
    it('should create an instance of BatchGetGraphMemberDatasourcesRequest', function() {
      // uncomment below and update the code to test BatchGetGraphMemberDatasourcesRequest
      //var instance = new AmazonDetective.BatchGetGraphMemberDatasourcesRequest();
      //expect(instance).to.be.a(AmazonDetective.BatchGetGraphMemberDatasourcesRequest);
    });
