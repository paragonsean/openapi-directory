...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DeleteMembersRequest();
  });
  ...
  describe('DeleteMembersRequest', function() {
    it('should create an instance of DeleteMembersRequest', function() {
      // uncomment below and update the code to test DeleteMembersRequest
      //var instance = new AmazonDetective.DeleteMembersRequest();
      //expect(instance).to.be.a(AmazonDetective.DeleteMembersRequest);
    });
