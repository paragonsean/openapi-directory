...
(function(root, factory) {
  ...
  describe('DatasourcePackage', function() {
    it('should create an instance of DatasourcePackage', function() {
      // uncomment below and update the code to test DatasourcePackage
      //var instance = new AmazonDetective.DatasourcePackage();
      //expect(instance).to.be.a(AmazonDetective.DatasourcePackage);
    });
