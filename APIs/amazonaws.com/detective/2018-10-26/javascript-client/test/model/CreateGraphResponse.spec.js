...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.CreateGraphResponse();
  });
  ...
  describe('CreateGraphResponse', function() {
    it('should create an instance of CreateGraphResponse', function() {
      // uncomment below and update the code to test CreateGraphResponse
      //var instance = new AmazonDetective.CreateGraphResponse();
      //expect(instance).to.be.a(AmazonDetective.CreateGraphResponse);
    });
