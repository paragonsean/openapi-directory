...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.StartMonitoringMemberRequest();
  });
  ...
  describe('StartMonitoringMemberRequest', function() {
    it('should create an instance of StartMonitoringMemberRequest', function() {
      // uncomment below and update the code to test StartMonitoringMemberRequest
      //var instance = new AmazonDetective.StartMonitoringMemberRequest();
      //expect(instance).to.be.a(AmazonDetective.StartMonitoringMemberRequest);
    });
