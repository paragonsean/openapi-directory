...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListGraphsResponse();
  });
  ...
  describe('ListGraphsResponse', function() {
    it('should create an instance of ListGraphsResponse', function() {
      // uncomment below and update the code to test ListGraphsResponse
      //var instance = new AmazonDetective.ListGraphsResponse();
      //expect(instance).to.be.a(AmazonDetective.ListGraphsResponse);
    });

    it('should have the property graphList (base name: "GraphList")', function() {
      // uncomment below and update the code to test the property graphList
      //var instance = new AmazonDetective.ListGraphsResponse();
