...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonDetective.TagResourceRequest();
      //expect(instance).to.be.a(AmazonDetective.TagResourceRequest);
    });
