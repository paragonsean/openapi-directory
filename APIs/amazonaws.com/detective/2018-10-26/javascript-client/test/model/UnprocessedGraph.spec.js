...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.UnprocessedGraph();
  });
  ...
  describe('UnprocessedGraph', function() {
    it('should create an instance of UnprocessedGraph', function() {
      // uncomment below and update the code to test UnprocessedGraph
      //var instance = new AmazonDetective.UnprocessedGraph();
      //expect(instance).to.be.a(AmazonDetective.UnprocessedGraph);
    });
