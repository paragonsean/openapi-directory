...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DatasourcePackageUsageInfo();
  });
  ...
  describe('DatasourcePackageUsageInfo', function() {
    it('should create an instance of DatasourcePackageUsageInfo', function() {
      // uncomment below and update the code to test DatasourcePackageUsageInfo
      //var instance = new AmazonDetective.DatasourcePackageUsageInfo();
      //expect(instance).to.be.a(AmazonDetective.DatasourcePackageUsageInfo);
    });
    ...
    it('should have the property volumeUsageUpdateTime (base name: "VolumeUsageUpdateTime")', function() {
      // uncomment below and update the code to test the property volumeUsageUpdateTime
      //var instance = new AmazonDetective.DatasourcePackageUsageInfo();
      //expect(instance).to.be();
    });
