...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.BatchGetGraphMemberDatasourcesResponse();
  });
  ...
  describe('BatchGetGraphMemberDatasourcesResponse', function() {
    it('should create an instance of BatchGetGraphMemberDatasourcesResponse', function() {
      // uncomment below and update the code to test BatchGetGraphMemberDatasourcesResponse
      //var instance = new AmazonDetective.BatchGetGraphMemberDatasourcesResponse();
      //expect(instance).to.be.a(AmazonDetective.BatchGetGraphMemberDatasourcesResponse);
    });

    it('should have the property memberDatasources (base name: "MemberDatasources")', function() {
      // uncomment below and update the code to test the property memberDatasources
      //var instance = new AmazonDetective.BatchGetGraphMemberDatasourcesResponse();
