...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.GetMembersRequest();
  });
  ...
  describe('GetMembersRequest', function() {
    it('should create an instance of GetMembersRequest', function() {
      // uncomment below and update the code to test GetMembersRequest
      //var instance = new AmazonDetective.GetMembersRequest();
      //expect(instance).to.be.a(AmazonDetective.GetMembersRequest);
    });
