...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.MembershipDatasources();
  });
  ...
  describe('MembershipDatasources', function() {
    it('should create an instance of MembershipDatasources', function() {
      // uncomment below and update the code to test MembershipDatasources
      //var instance = new AmazonDetective.MembershipDatasources();
      //expect(instance).to.be.a(AmazonDetective.MembershipDatasources);
    });
    ...
    it('should have the property datasourcePackageIngestHistory (base name: "DatasourcePackageIngestHistory")', function() {
      // uncomment below and update the code to test the property datasourcePackageIngestHistory
      //var instance = new AmazonDetective.MembershipDatasources();
      //expect(instance).to.be();
    });
