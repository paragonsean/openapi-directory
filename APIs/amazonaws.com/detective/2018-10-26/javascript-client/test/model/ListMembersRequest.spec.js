...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListMembersRequest();
  });
  ...
  describe('ListMembersRequest', function() {
    it('should create an instance of ListMembersRequest', function() {
      // uncomment below and update the code to test ListMembersRequest
      //var instance = new AmazonDetective.ListMembersRequest();
      //expect(instance).to.be.a(AmazonDetective.ListMembersRequest);
    });
