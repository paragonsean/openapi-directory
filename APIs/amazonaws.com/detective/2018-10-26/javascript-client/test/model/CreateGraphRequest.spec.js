...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.CreateGraphRequest();
  });
  ...
  describe('CreateGraphRequest', function() {
    it('should create an instance of CreateGraphRequest', function() {
      // uncomment below and update the code to test CreateGraphRequest
      //var instance = new AmazonDetective.CreateGraphRequest();
      //expect(instance).to.be.a(AmazonDetective.CreateGraphRequest);
    });
