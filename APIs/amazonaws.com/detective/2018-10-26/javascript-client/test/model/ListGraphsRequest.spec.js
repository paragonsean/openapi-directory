...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListGraphsRequest();
  });
  ...
  describe('ListGraphsRequest', function() {
    it('should create an instance of ListGraphsRequest', function() {
      // uncomment below and update the code to test ListGraphsRequest
      //var instance = new AmazonDetective.ListGraphsRequest();
      //expect(instance).to.be.a(AmazonDetective.ListGraphsRequest);
    });
