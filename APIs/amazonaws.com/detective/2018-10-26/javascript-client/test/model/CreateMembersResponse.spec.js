...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.CreateMembersResponse();
  });
  ...
  describe('CreateMembersResponse', function() {
    it('should create an instance of CreateMembersResponse', function() {
      // uncomment below and update the code to test CreateMembersResponse
      //var instance = new AmazonDetective.CreateMembersResponse();
      //expect(instance).to.be.a(AmazonDetective.CreateMembersResponse);
    });
    ...
    it('should have the property unprocessedAccounts (base name: "UnprocessedAccounts")', function() {
      // uncomment below and update the code to test the property unprocessedAccounts
      //var instance = new AmazonDetective.CreateMembersResponse();
      //expect(instance).to.be();
    });
