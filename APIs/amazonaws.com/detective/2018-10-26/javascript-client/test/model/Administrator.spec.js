...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.Administrator();
  });
  ...
  describe('Administrator', function() {
    it('should create an instance of Administrator', function() {
      ...
      //var instance = new AmazonDetective.Administrator();
      //expect(instance).to.be.a(AmazonDetective.Administrator);
    });
    ...
    it('should have the property delegationTime (base name: "DelegationTime")', function() {
      // uncomment below and update the code to test the property delegationTime
      //var instance = new AmazonDetective.Administrator();
      //expect(instance).to.be();
    });
