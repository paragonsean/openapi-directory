...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DescribeOrganizationConfigurationResponse();
  });
  ...
  describe('DescribeOrganizationConfigurationResponse', function() {
    it('should create an instance of DescribeOrganizationConfigurationResponse', function() {
      ...
      //var instance = new AmazonDetective.DescribeOrganizationConfigurationResponse();
      //expect(instance).to.be.a(AmazonDetective.DescribeOrganizationConfigurationResponse);
    });
