...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListInvitationsRequest();
  });
  ...
  describe('ListInvitationsRequest', function() {
    it('should create an instance of ListInvitationsRequest', function() {
      // uncomment below and update the code to test ListInvitationsRequest
      //var instance = new AmazonDetective.ListInvitationsRequest();
      //expect(instance).to.be.a(AmazonDetective.ListInvitationsRequest);
    });
