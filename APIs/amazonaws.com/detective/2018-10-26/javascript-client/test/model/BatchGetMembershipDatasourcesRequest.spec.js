...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.BatchGetMembershipDatasourcesRequest();
  });
  ...
  describe('BatchGetMembershipDatasourcesRequest', function() {
    it('should create an instance of BatchGetMembershipDatasourcesRequest', function() {
      // uncomment below and update the code to test BatchGetMembershipDatasourcesRequest
      //var instance = new AmazonDetective.BatchGetMembershipDatasourcesRequest();
      //expect(instance).to.be.a(AmazonDetective.BatchGetMembershipDatasourcesRequest);
    });

    it('should have the property graphArns (base name: "GraphArns")', function() {
      // uncomment below and update the code to test the property graphArns
      //var instance = new AmazonDetective.BatchGetMembershipDatasourcesRequest();
