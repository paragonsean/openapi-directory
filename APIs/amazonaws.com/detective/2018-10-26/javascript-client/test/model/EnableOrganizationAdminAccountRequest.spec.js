...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.EnableOrganizationAdminAccountRequest();
  });
  ...
  describe('EnableOrganizationAdminAccountRequest', function() {
    it('should create an instance of EnableOrganizationAdminAccountRequest', function() {
      ...
      //var instance = new AmazonDetective.EnableOrganizationAdminAccountRequest();
      //expect(instance).to.be.a(AmazonDetective.EnableOrganizationAdminAccountRequest);
    });
