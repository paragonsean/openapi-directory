...
(function(root, factory) {
  ...
  describe('MemberDisabledReason', function() {
    it('should create an instance of MemberDisabledReason', function() {
      // uncomment below and update the code to test MemberDisabledReason
      //var instance = new AmazonDetective.MemberDisabledReason();
      //expect(instance).to.be.a(AmazonDetective.MemberDisabledReason);
    });
