...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.UnprocessedAccount();
  });
  ...
  describe('UnprocessedAccount', function() {
    it('should create an instance of UnprocessedAccount', function() {
      // uncomment below and update the code to test UnprocessedAccount
      //var instance = new AmazonDetective.UnprocessedAccount();
      //expect(instance).to.be.a(AmazonDetective.UnprocessedAccount);
    });
