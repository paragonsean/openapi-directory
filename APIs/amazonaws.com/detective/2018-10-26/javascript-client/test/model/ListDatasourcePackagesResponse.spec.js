...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListDatasourcePackagesResponse();
  });
  ...
  describe('ListDatasourcePackagesResponse', function() {
    it('should create an instance of ListDatasourcePackagesResponse', function() {
      // uncomment below and update the code to test ListDatasourcePackagesResponse
      //var instance = new AmazonDetective.ListDatasourcePackagesResponse();
      //expect(instance).to.be.a(AmazonDetective.ListDatasourcePackagesResponse);
    });
