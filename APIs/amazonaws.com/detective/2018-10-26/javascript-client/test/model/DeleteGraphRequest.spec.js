...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.DeleteGraphRequest();
  });
  ...
  describe('DeleteGraphRequest', function() {
    it('should create an instance of DeleteGraphRequest', function() {
      // uncomment below and update the code to test DeleteGraphRequest
      //var instance = new AmazonDetective.DeleteGraphRequest();
      //expect(instance).to.be.a(AmazonDetective.DeleteGraphRequest);
    });
