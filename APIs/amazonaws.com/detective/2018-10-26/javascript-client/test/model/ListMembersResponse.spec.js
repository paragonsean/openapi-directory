...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListMembersResponse();
  });
  ...
  describe('ListMembersResponse', function() {
    it('should create an instance of ListMembersResponse', function() {
      ...
      //var instance = new AmazonDetective.ListMembersResponse();
      //expect(instance).to.be.a(AmazonDetective.ListMembersResponse);
    });
