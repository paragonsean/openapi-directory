...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListOrganizationAdminAccountsRequest();
  });
  ...
  describe('ListOrganizationAdminAccountsRequest', function() {
    it('should create an instance of ListOrganizationAdminAccountsRequest', function() {
      // uncomment below and update the code to test ListOrganizationAdminAccountsRequest
      //var instance = new AmazonDetective.ListOrganizationAdminAccountsRequest();
      //expect(instance).to.be.a(AmazonDetective.ListOrganizationAdminAccountsRequest);
    });
