...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.ListInvitationsResponse();
  });
  ...
  describe('ListInvitationsResponse', function() {
    it('should create an instance of ListInvitationsResponse', function() {
      ...
      //var instance = new AmazonDetective.ListInvitationsResponse();
      //expect(instance).to.be.a(AmazonDetective.ListInvitationsResponse);
    });
