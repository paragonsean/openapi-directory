...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDetective.AcceptInvitationRequest();
  });
  ...
  describe('AcceptInvitationRequest', function() {
    it('should create an instance of AcceptInvitationRequest', function() {
      // uncomment below and update the code to test AcceptInvitationRequest
      //var instance = new AmazonDetective.AcceptInvitationRequest();
      //expect(instance).to.be.a(AmazonDetective.AcceptInvitationRequest);
    });
