...
/*
 * OAITimestampForCollection.h
 *
 * Details on when data collection began for a source package.
 */

#ifndef OAITimestampForCollection_H
#define OAITimestampForCollection_H
...
class OAITimestampForCollection : public OAIObject {
public:
    OAITimestampForCollection();
    OAITimestampForCollection(QString json);
    ~OAITimestampForCollection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimestampForCollection)

#endif // OAITimestampForCollection_H
