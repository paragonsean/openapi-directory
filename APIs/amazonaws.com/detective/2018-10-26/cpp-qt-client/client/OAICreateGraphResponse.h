...
/*
 * OAICreateGraphResponse.h
 *
 * 
 */

#ifndef OAICreateGraphResponse_H
#define OAICreateGraphResponse_H
...
class OAICreateGraphResponse : public OAIObject {
public:
    OAICreateGraphResponse();
    OAICreateGraphResponse(QString json);
    ~OAICreateGraphResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGraphResponse)

#endif // OAICreateGraphResponse_H
