...
#include "OAIListDatasourcePackagesRequest.h"
...
OAIListDatasourcePackagesRequest::OAIListDatasourcePackagesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatasourcePackagesRequest::OAIListDatasourcePackagesRequest() {
    this->initializeModel();
}

OAIListDatasourcePackagesRequest::~OAIListDatasourcePackagesRequest() {}

void OAIListDatasourcePackagesRequest::initializeModel() {
...
void OAIListDatasourcePackagesRequest::fromJson(QString jsonString) {
...
void OAIListDatasourcePackagesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListDatasourcePackagesRequest::asJson() const {
...
QJsonObject OAIListDatasourcePackagesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListDatasourcePackagesRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIListDatasourcePackagesRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIListDatasourcePackagesRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIListDatasourcePackagesRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAIListDatasourcePackagesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListDatasourcePackagesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatasourcePackagesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatasourcePackagesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListDatasourcePackagesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListDatasourcePackagesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDatasourcePackagesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDatasourcePackagesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListDatasourcePackagesRequest::isSet() const {
...
bool OAIListDatasourcePackagesRequest::isValid() const {
