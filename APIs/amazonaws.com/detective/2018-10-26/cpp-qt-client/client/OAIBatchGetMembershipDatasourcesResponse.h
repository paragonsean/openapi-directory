...
/*
 * OAIBatchGetMembershipDatasourcesResponse.h
 *
 * 
 */

#ifndef OAIBatchGetMembershipDatasourcesResponse_H
#define OAIBatchGetMembershipDatasourcesResponse_H
...
class OAIBatchGetMembershipDatasourcesResponse : public OAIObject {
public:
    OAIBatchGetMembershipDatasourcesResponse();
    OAIBatchGetMembershipDatasourcesResponse(QString json);
    ~OAIBatchGetMembershipDatasourcesResponse() override;
    ...
    QList getMembershipDatasources() const;
    void setMembershipDatasources(const QList &membership_datasources);
    bool is_membership_datasources_Set() const;
    bool is_membership_datasources_Valid() const;

    QList getUnprocessedGraphs() const;
    void setUnprocessedGraphs(const QList &unprocessed_graphs);
    bool is_unprocessed_graphs_Set() const;
    bool is_unprocessed_graphs_Valid() const;
...
private:
    ...
    QList m_membership_datasources;
    bool m_membership_datasources_isSet;
    bool m_membership_datasources_isValid;

    QList m_unprocessed_graphs;
    bool m_unprocessed_graphs_isSet;
    bool m_unprocessed_graphs_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetMembershipDatasourcesResponse)

#endif // OAIBatchGetMembershipDatasourcesResponse_H
