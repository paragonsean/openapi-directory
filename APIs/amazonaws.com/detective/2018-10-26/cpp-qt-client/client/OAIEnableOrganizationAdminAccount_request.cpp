...
QString OAIEnableOrganizationAdminAccount_request::getAccountId() const {
    return m_account_id;
}
void OAIEnableOrganizationAdminAccount_request::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIEnableOrganizationAdminAccount_request::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIEnableOrganizationAdminAccount_request::is_account_id_Valid() const{
