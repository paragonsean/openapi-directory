...
QString OAIAcceptInvitationRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIAcceptInvitationRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIAcceptInvitationRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIAcceptInvitationRequest::is_graph_arn_Valid() const{
