...
/*
 * OAIDisassociateMembership_request.h
 *
 * 
 */

#ifndef OAIDisassociateMembership_request_H
#define OAIDisassociateMembership_request_H
...
class OAIDisassociateMembership_request : public OAIObject {
public:
    OAIDisassociateMembership_request();
    OAIDisassociateMembership_request(QString json);
    ~OAIDisassociateMembership_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateMembership_request)

#endif // OAIDisassociateMembership_request_H
