...
OAICreateGraph_request::OAICreateGraph_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGraph_request::OAICreateGraph_request() {
    this->initializeModel();
}

OAICreateGraph_request::~OAICreateGraph_request() {}

void OAICreateGraph_request::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAICreateGraph_request::fromJson(QString jsonString) {
...
void OAICreateGraph_request::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAICreateGraph_request::asJson() const {
...
QJsonObject OAICreateGraph_request::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.size() > 0) {
...
QMap<QString, QString> OAICreateGraph_request::getTags() const {
    return m_tags;
}
void OAICreateGraph_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateGraph_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateGraph_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateGraph_request::isSet() const {
...
bool OAICreateGraph_request::isValid() const {
