...
/*
 * OAIBatchGetGraphMemberDatasourcesResponse.h
 *
 * 
 */

#ifndef OAIBatchGetGraphMemberDatasourcesResponse_H
#define OAIBatchGetGraphMemberDatasourcesResponse_H
...
class OAIBatchGetGraphMemberDatasourcesResponse : public OAIObject {
public:
    OAIBatchGetGraphMemberDatasourcesResponse();
    OAIBatchGetGraphMemberDatasourcesResponse(QString json);
    ~OAIBatchGetGraphMemberDatasourcesResponse() override;
    ...
    QList getMemberDatasources() const;
    void setMemberDatasources(const QList &member_datasources);
    bool is_member_datasources_Set() const;
    bool is_member_datasources_Valid() const;
...
private:
    ...
    QList m_member_datasources;
    bool m_member_datasources_isSet;
    bool m_member_datasources_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetGraphMemberDatasourcesResponse)

#endif // OAIBatchGetGraphMemberDatasourcesResponse_H
