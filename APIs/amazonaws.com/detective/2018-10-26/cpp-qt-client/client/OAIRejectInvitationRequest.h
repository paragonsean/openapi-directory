...
/*
 * OAIRejectInvitationRequest.h
 *
 * 
 */

#ifndef OAIRejectInvitationRequest_H
#define OAIRejectInvitationRequest_H
...
class OAIRejectInvitationRequest : public OAIObject {
public:
    OAIRejectInvitationRequest();
    OAIRejectInvitationRequest(QString json);
    ~OAIRejectInvitationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRejectInvitationRequest)

#endif // OAIRejectInvitationRequest_H
