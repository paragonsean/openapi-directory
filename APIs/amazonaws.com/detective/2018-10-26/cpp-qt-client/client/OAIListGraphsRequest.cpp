...
#include "OAIListGraphsRequest.h"
...
OAIListGraphsRequest::OAIListGraphsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGraphsRequest::OAIListGraphsRequest() {
    this->initializeModel();
}

OAIListGraphsRequest::~OAIListGraphsRequest() {}

void OAIListGraphsRequest::initializeModel() {
...
void OAIListGraphsRequest::fromJson(QString jsonString) {
...
void OAIListGraphsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListGraphsRequest::asJson() const {
...
QJsonObject OAIListGraphsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListGraphsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListGraphsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGraphsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGraphsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListGraphsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListGraphsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListGraphsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListGraphsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListGraphsRequest::isSet() const {
...
bool OAIListGraphsRequest::isValid() const {
