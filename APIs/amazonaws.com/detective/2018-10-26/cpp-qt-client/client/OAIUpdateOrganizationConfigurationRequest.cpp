...
QString OAIUpdateOrganizationConfigurationRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIUpdateOrganizationConfigurationRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIUpdateOrganizationConfigurationRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIUpdateOrganizationConfigurationRequest::is_graph_arn_Valid() const{
