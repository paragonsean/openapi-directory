...
OAIDeleteMembersResponse::OAIDeleteMembersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMembersResponse::OAIDeleteMembersResponse() {
    this->initializeModel();
}

OAIDeleteMembersResponse::~OAIDeleteMembersResponse() {}

void OAIDeleteMembersResponse::initializeModel() {
...
void OAIDeleteMembersResponse::fromJson(QString jsonString) {
...
void OAIDeleteMembersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMembersResponse::asJson() const {
...
QJsonObject OAIDeleteMembersResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDeleteMembersResponse::getAccountIds() const {
    return m_account_ids;
}
void OAIDeleteMembersResponse::setAccountIds(const QList &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIDeleteMembersResponse::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIDeleteMembersResponse::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

QList OAIDeleteMembersResponse::getUnprocessedAccounts() const {
    return m_unprocessed_accounts;
}
void OAIDeleteMembersResponse::setUnprocessedAccounts(const QList &unprocessed_accounts) {
    m_unprocessed_accounts = unprocessed_accounts;
    m_unprocessed_accounts_isSet = true;
}

bool OAIDeleteMembersResponse::is_unprocessed_accounts_Set() const{
    return m_unprocessed_accounts_isSet;
}

bool OAIDeleteMembersResponse::is_unprocessed_accounts_Valid() const{
    return m_unprocessed_accounts_isValid;
}

bool OAIDeleteMembersResponse::isSet() const {
...
bool OAIDeleteMembersResponse::isValid() const {
