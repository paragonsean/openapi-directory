...
/*
 * OAIDescribeOrganizationConfiguration_request.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationConfiguration_request_H
#define OAIDescribeOrganizationConfiguration_request_H
...
class OAIDescribeOrganizationConfiguration_request : public OAIObject {
public:
    OAIDescribeOrganizationConfiguration_request();
    OAIDescribeOrganizationConfiguration_request(QString json);
    ~OAIDescribeOrganizationConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationConfiguration_request)

#endif // OAIDescribeOrganizationConfiguration_request_H
