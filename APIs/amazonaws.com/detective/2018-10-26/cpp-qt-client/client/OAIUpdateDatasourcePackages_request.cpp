...
OAIUpdateDatasourcePackages_request::OAIUpdateDatasourcePackages_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDatasourcePackages_request::OAIUpdateDatasourcePackages_request() {
    this->initializeModel();
}

OAIUpdateDatasourcePackages_request::~OAIUpdateDatasourcePackages_request() {}

void OAIUpdateDatasourcePackages_request::initializeModel() {
...
void OAIUpdateDatasourcePackages_request::fromJson(QString jsonString) {
...
void OAIUpdateDatasourcePackages_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDatasourcePackages_request::asJson() const {
...
QJsonObject OAIUpdateDatasourcePackages_request::asJsonObject() const {
    QJsonObject obj;
    if (m_graph_arn_isSet) {
        obj.insert(QString("GraphArn"), ::OpenAPI::toJsonValue(m_graph_arn));
    }
    if (m_datasource_packages.size() > 0) {
        obj.insert(QString("DatasourcePackages"), ::OpenAPI::toJsonValue(m_datasource_packages));
    }
    return obj;
}

QString OAIUpdateDatasourcePackages_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIUpdateDatasourcePackages_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIUpdateDatasourcePackages_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIUpdateDatasourcePackages_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList<OAIDatasourcePackage> OAIUpdateDatasourcePackages_request::getDatasourcePackages() const {
    return m_datasource_packages;
}
void OAIUpdateDatasourcePackages_request::setDatasourcePackages(const QList<OAIDatasourcePackage> &datasource_packages) {
    m_datasource_packages = datasource_packages;
    m_datasource_packages_isSet = true;
}

bool OAIUpdateDatasourcePackages_request::is_datasource_packages_Set() const{
    return m_datasource_packages_isSet;
}

bool OAIUpdateDatasourcePackages_request::is_datasource_packages_Valid() const{
    return m_datasource_packages_isValid;
}

bool OAIUpdateDatasourcePackages_request::isSet() const {
...
bool OAIUpdateDatasourcePackages_request::isValid() const {
