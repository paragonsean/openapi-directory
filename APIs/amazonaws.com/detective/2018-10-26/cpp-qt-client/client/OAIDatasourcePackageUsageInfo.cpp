...
#include "OAIDatasourcePackageUsageInfo.h"
...
OAIDatasourcePackageUsageInfo::OAIDatasourcePackageUsageInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasourcePackageUsageInfo::OAIDatasourcePackageUsageInfo() {
    this->initializeModel();
}

OAIDatasourcePackageUsageInfo::~OAIDatasourcePackageUsageInfo() {}

void OAIDatasourcePackageUsageInfo::initializeModel() {

    m_volume_usage_in_bytes_isSet = false;
    m_volume_usage_in_bytes_isValid = false;

    m_volume_usage_update_time_isSet = false;
    m_volume_usage_update_time_isValid = false;
}

void OAIDatasourcePackageUsageInfo::fromJson(QString jsonString) {
...
void OAIDatasourcePackageUsageInfo::fromJsonObject(QJsonObject json) {
    ...
    m_volume_usage_update_time_isValid = ::OpenAPI::fromJsonValue(m_volume_usage_update_time, json[QString("VolumeUsageUpdateTime")]);
    m_volume_usage_update_time_isSet = !json[QString("VolumeUsageUpdateTime")].isNull() && m_volume_usage_update_time_isValid;
}

QString OAIDatasourcePackageUsageInfo::asJson() const {
...
QJsonObject OAIDatasourcePackageUsageInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_volume_usage_in_bytes_isSet) {
        obj.insert(QString("VolumeUsageInBytes"), ::OpenAPI::toJsonValue(m_volume_usage_in_bytes));
    }
    if (m_volume_usage_update_time_isSet) {
        obj.insert(QString("VolumeUsageUpdateTime"), ::OpenAPI::toJsonValue(m_volume_usage_update_time));
    }
    return obj;
}

qint32 OAIDatasourcePackageUsageInfo::getVolumeUsageInBytes() const {
    return m_volume_usage_in_bytes;
}
void OAIDatasourcePackageUsageInfo::setVolumeUsageInBytes(const qint32 &volume_usage_in_bytes) {
    m_volume_usage_in_bytes = volume_usage_in_bytes;
    m_volume_usage_in_bytes_isSet = true;
}

bool OAIDatasourcePackageUsageInfo::is_volume_usage_in_bytes_Set() const{
    return m_volume_usage_in_bytes_isSet;
}

bool OAIDatasourcePackageUsageInfo::is_volume_usage_in_bytes_Valid() const{
    return m_volume_usage_in_bytes_isValid;
}

QDateTime OAIDatasourcePackageUsageInfo::getVolumeUsageUpdateTime() const {
    return m_volume_usage_update_time;
}
void OAIDatasourcePackageUsageInfo::setVolumeUsageUpdateTime(const QDateTime &volume_usage_update_time) {
    m_volume_usage_update_time = volume_usage_update_time;
    m_volume_usage_update_time_isSet = true;
}

bool OAIDatasourcePackageUsageInfo::is_volume_usage_update_time_Set() const{
    return m_volume_usage_update_time_isSet;
}

bool OAIDatasourcePackageUsageInfo::is_volume_usage_update_time_Valid() const{
    return m_volume_usage_update_time_isValid;
}

bool OAIDatasourcePackageUsageInfo::isSet() const {
...
bool OAIDatasourcePackageUsageInfo::isValid() const {
