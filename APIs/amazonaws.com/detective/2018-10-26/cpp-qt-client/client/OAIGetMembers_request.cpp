...
OAIGetMembers_request::OAIGetMembers_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMembers_request::OAIGetMembers_request() {
    this->initializeModel();
}

OAIGetMembers_request::~OAIGetMembers_request() {}

void OAIGetMembers_request::initializeModel() {
...
void OAIGetMembers_request::fromJson(QString jsonString) {
...
void OAIGetMembers_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetMembers_request::asJson() const {
...
QJsonObject OAIGetMembers_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMembers_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIGetMembers_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIGetMembers_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIGetMembers_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList<QString> OAIGetMembers_request::getAccountIds() const {
    return m_account_ids;
}
void OAIGetMembers_request::setAccountIds(const QList<QString> &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIGetMembers_request::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIGetMembers_request::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIGetMembers_request::isSet() const {
...
bool OAIGetMembers_request::isValid() const {
