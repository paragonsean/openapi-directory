...
#include "OAIStartMonitoringMemberRequest.h"
...
OAIStartMonitoringMemberRequest::OAIStartMonitoringMemberRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMonitoringMemberRequest::OAIStartMonitoringMemberRequest() {
    this->initializeModel();
}

OAIStartMonitoringMemberRequest::~OAIStartMonitoringMemberRequest() {}

void OAIStartMonitoringMemberRequest::initializeModel() {
...
void OAIStartMonitoringMemberRequest::fromJson(QString jsonString) {
...
void OAIStartMonitoringMemberRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartMonitoringMemberRequest::asJson() const {
...
QJsonObject OAIStartMonitoringMemberRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartMonitoringMemberRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIStartMonitoringMemberRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIStartMonitoringMemberRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIStartMonitoringMemberRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAIStartMonitoringMemberRequest::getAccountId() const {
    return m_account_id;
}
void OAIStartMonitoringMemberRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIStartMonitoringMemberRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIStartMonitoringMemberRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIStartMonitoringMemberRequest::isSet() const {
...
bool OAIStartMonitoringMemberRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_graph_arn_isValid && m_account_id_isValid && true;
}
