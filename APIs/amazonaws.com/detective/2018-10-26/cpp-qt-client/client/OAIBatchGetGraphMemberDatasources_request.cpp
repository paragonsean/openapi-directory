...
OAIBatchGetGraphMemberDatasources_request::OAIBatchGetGraphMemberDatasources_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetGraphMemberDatasources_request::OAIBatchGetGraphMemberDatasources_request() {
    this->initializeModel();
}

OAIBatchGetGraphMemberDatasources_request::~OAIBatchGetGraphMemberDatasources_request() {}

void OAIBatchGetGraphMemberDatasources_request::initializeModel() {
...
void OAIBatchGetGraphMemberDatasources_request::fromJson(QString jsonString) {
...
void OAIBatchGetGraphMemberDatasources_request::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetGraphMemberDatasources_request::asJson() const {
...
QJsonObject OAIBatchGetGraphMemberDatasources_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchGetGraphMemberDatasources_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIBatchGetGraphMemberDatasources_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIBatchGetGraphMemberDatasources_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIBatchGetGraphMemberDatasources_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList<QString> OAIBatchGetGraphMemberDatasources_request::getAccountIds() const {
    return m_account_ids;
}
void OAIBatchGetGraphMemberDatasources_request::setAccountIds(const QList<QString> &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIBatchGetGraphMemberDatasources_request::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIBatchGetGraphMemberDatasources_request::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIBatchGetGraphMemberDatasources_request::isSet() const {
...
bool OAIBatchGetGraphMemberDatasources_request::isValid() const {
