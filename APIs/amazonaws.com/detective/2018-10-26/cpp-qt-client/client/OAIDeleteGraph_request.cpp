...
OAIDeleteGraph_request::OAIDeleteGraph_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGraph_request::OAIDeleteGraph_request() {
    this->initializeModel();
}

OAIDeleteGraph_request::~OAIDeleteGraph_request() {}

void OAIDeleteGraph_request::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDeleteGraph_request::fromJson(QString jsonString) {
...
void OAIDeleteGraph_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGraph_request::asJson() const {
...
QJsonObject OAIDeleteGraph_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGraph_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIDeleteGraph_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDeleteGraph_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDeleteGraph_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDeleteGraph_request::isSet() const {
...
bool OAIDeleteGraph_request::isValid() const {
