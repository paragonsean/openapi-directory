...
#include "OAIDescribeOrganizationConfigurationRequest.h"
...
OAIDescribeOrganizationConfigurationRequest::OAIDescribeOrganizationConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationConfigurationRequest::OAIDescribeOrganizationConfigurationRequest() {
    this->initializeModel();
}

OAIDescribeOrganizationConfigurationRequest::~OAIDescribeOrganizationConfigurationRequest() {}

void OAIDescribeOrganizationConfigurationRequest::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDescribeOrganizationConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeOrganizationConfigurationRequest::asJson() const {
...
QJsonObject OAIDescribeOrganizationConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeOrganizationConfigurationRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIDescribeOrganizationConfigurationRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDescribeOrganizationConfigurationRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDescribeOrganizationConfigurationRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDescribeOrganizationConfigurationRequest::isSet() const {
...
bool OAIDescribeOrganizationConfigurationRequest::isValid() const {
