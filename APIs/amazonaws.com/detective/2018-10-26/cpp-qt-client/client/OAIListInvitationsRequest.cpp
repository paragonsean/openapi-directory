...
#include "OAIListInvitationsRequest.h"
...
OAIListInvitationsRequest::OAIListInvitationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListInvitationsRequest::OAIListInvitationsRequest() {
    this->initializeModel();
}

OAIListInvitationsRequest::~OAIListInvitationsRequest() {}

void OAIListInvitationsRequest::initializeModel() {
...
void OAIListInvitationsRequest::fromJson(QString jsonString) {
...
void OAIListInvitationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListInvitationsRequest::asJson() const {
...
QJsonObject OAIListInvitationsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListInvitationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListInvitationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListInvitationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListInvitationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListInvitationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListInvitationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListInvitationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListInvitationsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListInvitationsRequest::isSet() const {
...
bool OAIListInvitationsRequest::isValid() const {
