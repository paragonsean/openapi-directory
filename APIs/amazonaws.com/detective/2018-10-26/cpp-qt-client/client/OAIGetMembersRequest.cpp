...
#include "OAIGetMembersRequest.h"
...
OAIGetMembersRequest::OAIGetMembersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMembersRequest::OAIGetMembersRequest() {
    this->initializeModel();
}

OAIGetMembersRequest::~OAIGetMembersRequest() {}

void OAIGetMembersRequest::initializeModel() {
...
void OAIGetMembersRequest::fromJson(QString jsonString) {
...
void OAIGetMembersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetMembersRequest::asJson() const {
...
QJsonObject OAIGetMembersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetMembersRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIGetMembersRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIGetMembersRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIGetMembersRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList OAIGetMembersRequest::getAccountIds() const {
    return m_account_ids;
}
void OAIGetMembersRequest::setAccountIds(const QList &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIGetMembersRequest::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIGetMembersRequest::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIGetMembersRequest::isSet() const {
...
bool OAIGetMembersRequest::isValid() const {
