...
QString OAIAccount::getEmailAddress() const {
    return m_email_address;
}
void OAIAccount::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIAccount::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIAccount::is_email_address_Valid() const{
...
bool OAIAccount::isValid() const {
    ...
    return m_account_id_isValid && m_email_address_isValid && true;
}
