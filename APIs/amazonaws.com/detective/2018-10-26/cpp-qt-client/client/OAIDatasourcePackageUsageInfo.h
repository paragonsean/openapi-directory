...
/*
 * OAIDatasourcePackageUsageInfo.h
 *
 * Information on the usage of a data source package in the behavior graph.
 */

#ifndef OAIDatasourcePackageUsageInfo_H
#define OAIDatasourcePackageUsageInfo_H
...
class OAIDatasourcePackageUsageInfo : public OAIObject {
public:
    OAIDatasourcePackageUsageInfo();
    OAIDatasourcePackageUsageInfo(QString json);
    ~OAIDatasourcePackageUsageInfo() override;
    ...
    QDateTime getVolumeUsageUpdateTime() const;
    void setVolumeUsageUpdateTime(const QDateTime &volume_usage_update_time);
    bool is_volume_usage_update_time_Set() const;
    bool is_volume_usage_update_time_Valid() const;
...
private:
    ...
    QDateTime m_volume_usage_update_time;
    bool m_volume_usage_update_time_isSet;
    bool m_volume_usage_update_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDatasourcePackageUsageInfo)

#endif // OAIDatasourcePackageUsageInfo_H
