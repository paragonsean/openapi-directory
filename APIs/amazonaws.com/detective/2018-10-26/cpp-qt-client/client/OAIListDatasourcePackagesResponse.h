...
/*
 * OAIListDatasourcePackagesResponse.h
 *
 * 
 */

#ifndef OAIListDatasourcePackagesResponse_H
#define OAIListDatasourcePackagesResponse_H
...
class OAIListDatasourcePackagesResponse : public OAIObject {
public:
    OAIListDatasourcePackagesResponse();
    OAIListDatasourcePackagesResponse(QString json);
    ~OAIListDatasourcePackagesResponse() override;
    ...
    QMap getDatasourcePackages() const;
    void setDatasourcePackages(const QMap &datasource_packages);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatasourcePackagesResponse)

#endif // OAIListDatasourcePackagesResponse_H
