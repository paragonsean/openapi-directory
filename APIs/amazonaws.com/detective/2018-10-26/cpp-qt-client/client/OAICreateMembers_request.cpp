...
OAICreateMembers_request::OAICreateMembers_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMembers_request::OAICreateMembers_request() {
    this->initializeModel();
}

OAICreateMembers_request::~OAICreateMembers_request() {}

void OAICreateMembers_request::initializeModel() {
...
void OAICreateMembers_request::fromJson(QString jsonString) {
...
void OAICreateMembers_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateMembers_request::asJson() const {
...
QJsonObject OAICreateMembers_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateMembers_request::getGraphArn() const {
    return m_graph_arn;
}
void OAICreateMembers_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAICreateMembers_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAICreateMembers_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAICreateMembers_request::getMessage() const {
    return m_message;
}
void OAICreateMembers_request::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICreateMembers_request::is_message_Set() const{
    return m_message_isSet;
}

bool OAICreateMembers_request::is_message_Valid() const{
    return m_message_isValid;
}

bool OAICreateMembers_request::isDisableEmailNotification() const {
    return m_disable_email_notification;
}
void OAICreateMembers_request::setDisableEmailNotification(const bool &disable_email_notification) {
    m_disable_email_notification = disable_email_notification;
    m_disable_email_notification_isSet = true;
}

bool OAICreateMembers_request::is_disable_email_notification_Set() const{
    return m_disable_email_notification_isSet;
}

bool OAICreateMembers_request::is_disable_email_notification_Valid() const{
    return m_disable_email_notification_isValid;
}

QList<OAIAccount> OAICreateMembers_request::getAccounts() const {
    return m_accounts;
}
void OAICreateMembers_request::setAccounts(const QList<OAIAccount> &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAICreateMembers_request::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAICreateMembers_request::is_accounts_Valid() const{
    return m_accounts_isValid;
}

bool OAICreateMembers_request::isSet() const {
...
bool OAICreateMembers_request::isValid() const {
