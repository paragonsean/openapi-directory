...
QString OAIUnprocessedAccount::getReason() const {
    return m_reason;
}
void OAIUnprocessedAccount::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIUnprocessedAccount::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIUnprocessedAccount::is_reason_Valid() const{
