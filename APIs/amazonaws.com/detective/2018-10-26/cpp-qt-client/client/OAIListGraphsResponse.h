...
/*
 * OAIListGraphsResponse.h
 *
 * 
 */

#ifndef OAIListGraphsResponse_H
#define OAIListGraphsResponse_H
...
class OAIListGraphsResponse : public OAIObject {
public:
    OAIListGraphsResponse();
    OAIListGraphsResponse(QString json);
    ~OAIListGraphsResponse() override;
    ...
    QList getGraphList() const;
    void setGraphList(const QList &graph_list);
    bool is_graph_list_Set() const;
    bool is_graph_list_Valid() const;
...
private:
    ...
    QList m_graph_list;
    bool m_graph_list_isSet;
    bool m_graph_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGraphsResponse)

#endif // OAIListGraphsResponse_H
