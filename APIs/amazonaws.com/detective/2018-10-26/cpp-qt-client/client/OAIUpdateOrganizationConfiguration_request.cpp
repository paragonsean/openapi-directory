...
QString OAIUpdateOrganizationConfiguration_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIUpdateOrganizationConfiguration_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIUpdateOrganizationConfiguration_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIUpdateOrganizationConfiguration_request::is_graph_arn_Valid() const{
