...
#include "OAIDatasourcePackage.h"
...
OAIDatasourcePackage::OAIDatasourcePackage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasourcePackage::OAIDatasourcePackage() {
    this->initializeModel();
}

OAIDatasourcePackage::~OAIDatasourcePackage() {}

void OAIDatasourcePackage::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDatasourcePackage::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDatasourcePackage::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DETECTIVE_CORE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackage::DETECTIVE_CORE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EKS_AUDIT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackage::EKS_AUDIT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ASFF_SECURITYHUB_FINDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackage::ASFF_SECURITYHUB_FINDING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDatasourcePackage::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDatasourcePackage::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDatasourcePackage::DETECTIVE_CORE:
            val = "DETECTIVE_CORE";
            break;
        case eOAIDatasourcePackage::EKS_AUDIT:
            val = "EKS_AUDIT";
            break;
        case eOAIDatasourcePackage::ASFF_SECURITYHUB_FINDING:
            val = "ASFF_SECURITYHUB_FINDING";
            break;
        default:
            break;
    }
...
QJsonValue OAIDatasourcePackage::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDatasourcePackage::eOAIDatasourcePackage OAIDatasourcePackage::getValue() const {
    return m_value;
}

void OAIDatasourcePackage::setValue(const OAIDatasourcePackage::eOAIDatasourcePackage& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDatasourcePackage::isSet() const {
    
    return m_value_isSet;
}

bool OAIDatasourcePackage::isValid() const {
