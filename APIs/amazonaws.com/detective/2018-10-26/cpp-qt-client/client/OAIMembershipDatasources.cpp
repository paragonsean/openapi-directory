...
#include "OAIMembershipDatasources.h"
...
OAIMembershipDatasources::OAIMembershipDatasources(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMembershipDatasources::OAIMembershipDatasources() {
    this->initializeModel();
}

OAIMembershipDatasources::~OAIMembershipDatasources() {}

void OAIMembershipDatasources::initializeModel() {
    ...
    m_datasource_package_ingest_history_isSet = false;
    m_datasource_package_ingest_history_isValid = false;
}

void OAIMembershipDatasources::fromJson(QString jsonString) {
...
void OAIMembershipDatasources::fromJsonObject(QJsonObject json) {
    ...
    m_datasource_package_ingest_history_isValid = ::OpenAPI::fromJsonValue(m_datasource_package_ingest_history, json[QString("DatasourcePackageIngestHistory")]);
    m_datasource_package_ingest_history_isSet = !json[QString("DatasourcePackageIngestHistory")].isNull() && m_datasource_package_ingest_history_isValid;
}

QString OAIMembershipDatasources::asJson() const {
...
QJsonObject OAIMembershipDatasources::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_datasource_package_ingest_history.isSet()) {
        obj.insert(QString("DatasourcePackageIngestHistory"), ::OpenAPI::toJsonValue(m_datasource_package_ingest_history));
    }
    return obj;
}

QString OAIMembershipDatasources::getAccountId() const {
    return m_account_id;
}
void OAIMembershipDatasources::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIMembershipDatasources::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIMembershipDatasources::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIMembershipDatasources::getGraphArn() const {
    return m_graph_arn;
}
void OAIMembershipDatasources::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIMembershipDatasources::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIMembershipDatasources::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QMap OAIMembershipDatasources::getDatasourcePackageIngestHistory() const {
    return m_datasource_package_ingest_history;
}
void OAIMembershipDatasources::setDatasourcePackageIngestHistory(const QMap &datasource_package_ingest_history) {
    m_datasource_package_ingest_history = datasource_package_ingest_history;
    m_datasource_package_ingest_history_isSet = true;
}

bool OAIMembershipDatasources::is_datasource_package_ingest_history_Set() const{
    return m_datasource_package_ingest_history_isSet;
}

bool OAIMembershipDatasources::is_datasource_package_ingest_history_Valid() const{
    return m_datasource_package_ingest_history_isValid;
}

bool OAIMembershipDatasources::isSet() const {
...
bool OAIMembershipDatasources::isValid() const {
