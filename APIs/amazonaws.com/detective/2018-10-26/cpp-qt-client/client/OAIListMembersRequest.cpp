...
QString OAIListMembersRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIListMembersRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIListMembersRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIListMembersRequest::is_graph_arn_Valid() const{
