...
OAIDisassociateMembership_request::OAIDisassociateMembership_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateMembership_request::OAIDisassociateMembership_request() {
    this->initializeModel();
}

OAIDisassociateMembership_request::~OAIDisassociateMembership_request() {}

void OAIDisassociateMembership_request::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDisassociateMembership_request::fromJson(QString jsonString) {
...
void OAIDisassociateMembership_request::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateMembership_request::asJson() const {
...
QJsonObject OAIDisassociateMembership_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateMembership_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIDisassociateMembership_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDisassociateMembership_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDisassociateMembership_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDisassociateMembership_request::isSet() const {
...
bool OAIDisassociateMembership_request::isValid() const {
