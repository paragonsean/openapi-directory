...
#include "OAIDeleteGraphRequest.h"
...
OAIDeleteGraphRequest::OAIDeleteGraphRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGraphRequest::OAIDeleteGraphRequest() {
    this->initializeModel();
}

OAIDeleteGraphRequest::~OAIDeleteGraphRequest() {}

void OAIDeleteGraphRequest::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDeleteGraphRequest::fromJson(QString jsonString) {
...
void OAIDeleteGraphRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGraphRequest::asJson() const {
...
QJsonObject OAIDeleteGraphRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGraphRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIDeleteGraphRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDeleteGraphRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDeleteGraphRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDeleteGraphRequest::isSet() const {
...
bool OAIDeleteGraphRequest::isValid() const {
