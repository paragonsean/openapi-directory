...
/*
 * OAIListOrganizationAdminAccountsRequest.h
 *
 * 
 */

#ifndef OAIListOrganizationAdminAccountsRequest_H
#define OAIListOrganizationAdminAccountsRequest_H
...
class OAIListOrganizationAdminAccountsRequest : public OAIObject {
public:
    OAIListOrganizationAdminAccountsRequest();
    OAIListOrganizationAdminAccountsRequest(QString json);
    ~OAIListOrganizationAdminAccountsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationAdminAccountsRequest)

#endif // OAIListOrganizationAdminAccountsRequest_H
