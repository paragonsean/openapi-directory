...
OAIListInvitations_request::OAIListInvitations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListInvitations_request::OAIListInvitations_request() {
    this->initializeModel();
}

OAIListInvitations_request::~OAIListInvitations_request() {}

void OAIListInvitations_request::initializeModel() {
...
void OAIListInvitations_request::fromJson(QString jsonString) {
...
void OAIListInvitations_request::fromJsonObject(QJsonObject json) {
...
QString OAIListInvitations_request::asJson() const {
...
QJsonObject OAIListInvitations_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListInvitations_request::getNextToken() const {
    return m_next_token;
}
void OAIListInvitations_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListInvitations_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListInvitations_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListInvitations_request::getMaxResults() const {
    return m_max_results;
}
void OAIListInvitations_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListInvitations_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListInvitations_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListInvitations_request::isSet() const {
...
bool OAIListInvitations_request::isValid() const {
