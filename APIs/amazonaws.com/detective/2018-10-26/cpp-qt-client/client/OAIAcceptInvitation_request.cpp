...
QString OAIAcceptInvitation_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIAcceptInvitation_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIAcceptInvitation_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIAcceptInvitation_request::is_graph_arn_Valid() const{
