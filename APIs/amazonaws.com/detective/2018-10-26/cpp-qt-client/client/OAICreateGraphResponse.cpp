...
OAICreateGraphResponse::OAICreateGraphResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGraphResponse::OAICreateGraphResponse() {
    this->initializeModel();
}

OAICreateGraphResponse::~OAICreateGraphResponse() {}

void OAICreateGraphResponse::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAICreateGraphResponse::fromJson(QString jsonString) {
...
void OAICreateGraphResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateGraphResponse::asJson() const {
...
QJsonObject OAICreateGraphResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateGraphResponse::getGraphArn() const {
    return m_graph_arn;
}
void OAICreateGraphResponse::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAICreateGraphResponse::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAICreateGraphResponse::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAICreateGraphResponse::isSet() const {
...
bool OAICreateGraphResponse::isValid() const {
