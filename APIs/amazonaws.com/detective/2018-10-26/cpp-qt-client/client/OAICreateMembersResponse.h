...
/*
 * OAICreateMembersResponse.h
 *
 * 
 */

#ifndef OAICreateMembersResponse_H
#define OAICreateMembersResponse_H
...
class OAICreateMembersResponse : public OAIObject {
public:
    OAICreateMembersResponse();
    OAICreateMembersResponse(QString json);
    ~OAICreateMembersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMembersResponse)

#endif // OAICreateMembersResponse_H
