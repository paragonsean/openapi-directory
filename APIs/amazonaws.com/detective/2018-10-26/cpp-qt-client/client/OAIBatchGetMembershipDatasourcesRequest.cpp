...
#include "OAIBatchGetMembershipDatasourcesRequest.h"
...
OAIBatchGetMembershipDatasourcesRequest::OAIBatchGetMembershipDatasourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetMembershipDatasourcesRequest::OAIBatchGetMembershipDatasourcesRequest() {
    this->initializeModel();
}

OAIBatchGetMembershipDatasourcesRequest::~OAIBatchGetMembershipDatasourcesRequest() {}

void OAIBatchGetMembershipDatasourcesRequest::initializeModel() {

    m_graph_arns_isSet = false;
    m_graph_arns_isValid = false;
}

void OAIBatchGetMembershipDatasourcesRequest::fromJson(QString jsonString) {
...
void OAIBatchGetMembershipDatasourcesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetMembershipDatasourcesRequest::asJson() const {
...
QJsonObject OAIBatchGetMembershipDatasourcesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_graph_arns.isSet()) {
        obj.insert(QString("GraphArns"), ::OpenAPI::toJsonValue(m_graph_arns));
    }
    return obj;
}

QList OAIBatchGetMembershipDatasourcesRequest::getGraphArns() const {
    return m_graph_arns;
}
void OAIBatchGetMembershipDatasourcesRequest::setGraphArns(const QList &graph_arns) {
    m_graph_arns = graph_arns;
    m_graph_arns_isSet = true;
}

bool OAIBatchGetMembershipDatasourcesRequest::is_graph_arns_Set() const{
    return m_graph_arns_isSet;
}

bool OAIBatchGetMembershipDatasourcesRequest::is_graph_arns_Valid() const{
    return m_graph_arns_isValid;
}

bool OAIBatchGetMembershipDatasourcesRequest::isSet() const {
...
bool OAIBatchGetMembershipDatasourcesRequest::isValid() const {
