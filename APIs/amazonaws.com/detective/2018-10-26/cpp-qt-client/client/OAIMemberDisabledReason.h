...
/*
 * OAIMemberDisabledReason.h
 *
 * 
 */

#ifndef OAIMemberDisabledReason_H
#define OAIMemberDisabledReason_H
...
class OAIMemberDisabledReason : public OAIEnum {
public:
    OAIMemberDisabledReason();
    OAIMemberDisabledReason(QString json);
    ~OAIMemberDisabledReason() override;
    ...
    enum class eOAIMemberDisabledReason {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TOO_HIGH, 
        UNKNOWN
    };
    OAIMemberDisabledReason::eOAIMemberDisabledReason getValue() const;
    void setValue(const OAIMemberDisabledReason::eOAIMemberDisabledReason& value);
...
private:
    ...
    eOAIMemberDisabledReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberDisabledReason)

#endif // OAIMemberDisabledReason_H
