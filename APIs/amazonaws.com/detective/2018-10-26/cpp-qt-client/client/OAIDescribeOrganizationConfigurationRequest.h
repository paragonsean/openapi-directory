...
/*
 * OAIDescribeOrganizationConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDescribeOrganizationConfigurationRequest_H
#define OAIDescribeOrganizationConfigurationRequest_H
...
class OAIDescribeOrganizationConfigurationRequest : public OAIObject {
public:
    OAIDescribeOrganizationConfigurationRequest();
    OAIDescribeOrganizationConfigurationRequest(QString json);
    ~OAIDescribeOrganizationConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrganizationConfigurationRequest)

#endif // OAIDescribeOrganizationConfigurationRequest_H
