...
OAIBatchGetGraphMemberDatasourcesResponse::OAIBatchGetGraphMemberDatasourcesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetGraphMemberDatasourcesResponse::OAIBatchGetGraphMemberDatasourcesResponse() {
    this->initializeModel();
}

OAIBatchGetGraphMemberDatasourcesResponse::~OAIBatchGetGraphMemberDatasourcesResponse() {}

void OAIBatchGetGraphMemberDatasourcesResponse::initializeModel() {

    m_member_datasources_isSet = false;
    m_member_datasources_isValid = false;

    m_unprocessed_accounts_isSet = false;
    m_unprocessed_accounts_isValid = false;
}

void OAIBatchGetGraphMemberDatasourcesResponse::fromJson(QString jsonString) {
...
void OAIBatchGetGraphMemberDatasourcesResponse::fromJsonObject(QJsonObject json) {

    m_member_datasources_isValid = ::OpenAPI::fromJsonValue(m_member_datasources, json[QString("MemberDatasources")]);
    m_member_datasources_isSet = !json[QString("MemberDatasources")].isNull() && m_member_datasources_isValid;
...
QString OAIBatchGetGraphMemberDatasourcesResponse::asJson() const {
...
QJsonObject OAIBatchGetGraphMemberDatasourcesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_member_datasources.isSet()) {
        obj.insert(QString("MemberDatasources"), ::OpenAPI::toJsonValue(m_member_datasources));
    }
...
QList OAIBatchGetGraphMemberDatasourcesResponse::getMemberDatasources() const {
    return m_member_datasources;
}
void OAIBatchGetGraphMemberDatasourcesResponse::setMemberDatasources(const QList &member_datasources) {
    m_member_datasources = member_datasources;
    m_member_datasources_isSet = true;
}

bool OAIBatchGetGraphMemberDatasourcesResponse::is_member_datasources_Set() const{
    return m_member_datasources_isSet;
}

bool OAIBatchGetGraphMemberDatasourcesResponse::is_member_datasources_Valid() const{
    return m_member_datasources_isValid;
}

QList OAIBatchGetGraphMemberDatasourcesResponse::getUnprocessedAccounts() const {
    return m_unprocessed_accounts;
}
void OAIBatchGetGraphMemberDatasourcesResponse::setUnprocessedAccounts(const QList &unprocessed_accounts) {
    m_unprocessed_accounts = unprocessed_accounts;
    m_unprocessed_accounts_isSet = true;
}

bool OAIBatchGetGraphMemberDatasourcesResponse::is_unprocessed_accounts_Set() const{
    return m_unprocessed_accounts_isSet;
}

bool OAIBatchGetGraphMemberDatasourcesResponse::is_unprocessed_accounts_Valid() const{
    return m_unprocessed_accounts_isValid;
}

bool OAIBatchGetGraphMemberDatasourcesResponse::isSet() const {
...
bool OAIBatchGetGraphMemberDatasourcesResponse::isValid() const {
