...
/*
 * OAIStartMonitoringMemberRequest.h
 *
 * 
 */

#ifndef OAIStartMonitoringMemberRequest_H
#define OAIStartMonitoringMemberRequest_H
...
class OAIStartMonitoringMemberRequest : public OAIObject {
public:
    OAIStartMonitoringMemberRequest();
    OAIStartMonitoringMemberRequest(QString json);
    ~OAIStartMonitoringMemberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMonitoringMemberRequest)

#endif // OAIStartMonitoringMemberRequest_H
