...
#include "OAITimestampForCollection.h"
...
OAITimestampForCollection::OAITimestampForCollection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimestampForCollection::OAITimestampForCollection() {
    this->initializeModel();
}

OAITimestampForCollection::~OAITimestampForCollection() {}

void OAITimestampForCollection::initializeModel() {

    m_timestamp_isSet = false;
    m_timestamp_isValid = false;
}

void OAITimestampForCollection::fromJson(QString jsonString) {
...
void OAITimestampForCollection::fromJsonObject(QJsonObject json) {

    m_timestamp_isValid = ::OpenAPI::fromJsonValue(m_timestamp, json[QString("Timestamp")]);
    m_timestamp_isSet = !json[QString("Timestamp")].isNull() && m_timestamp_isValid;
}

QString OAITimestampForCollection::asJson() const {
...
QJsonObject OAITimestampForCollection::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAITimestampForCollection::getTimestamp() const {
    return m_timestamp;
}
void OAITimestampForCollection::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAITimestampForCollection::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAITimestampForCollection::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

bool OAITimestampForCollection::isSet() const {
...
bool OAITimestampForCollection::isValid() const {
