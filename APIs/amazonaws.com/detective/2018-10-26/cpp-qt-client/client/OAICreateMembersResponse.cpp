...
OAICreateMembersResponse::OAICreateMembersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMembersResponse::OAICreateMembersResponse() {
    this->initializeModel();
}

OAICreateMembersResponse::~OAICreateMembersResponse() {}

void OAICreateMembersResponse::initializeModel() {
...
void OAICreateMembersResponse::fromJson(QString jsonString) {
...
void OAICreateMembersResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateMembersResponse::asJson() const {
...
QJsonObject OAICreateMembersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_members.isSet()) {
...
QList OAICreateMembersResponse::getMembers() const {
    return m_members;
}
void OAICreateMembersResponse::setMembers(const QList &members) {
    m_members = members;
    m_members_isSet = true;
}

bool OAICreateMembersResponse::is_members_Set() const{
    return m_members_isSet;
}

bool OAICreateMembersResponse::is_members_Valid() const{
    return m_members_isValid;
}

QList OAICreateMembersResponse::getUnprocessedAccounts() const {
    return m_unprocessed_accounts;
}
void OAICreateMembersResponse::setUnprocessedAccounts(const QList &unprocessed_accounts) {
    m_unprocessed_accounts = unprocessed_accounts;
    m_unprocessed_accounts_isSet = true;
}

bool OAICreateMembersResponse::is_unprocessed_accounts_Set() const{
    return m_unprocessed_accounts_isSet;
}

bool OAICreateMembersResponse::is_unprocessed_accounts_Valid() const{
    return m_unprocessed_accounts_isValid;
}

bool OAICreateMembersResponse::isSet() const {
...
bool OAICreateMembersResponse::isValid() const {
