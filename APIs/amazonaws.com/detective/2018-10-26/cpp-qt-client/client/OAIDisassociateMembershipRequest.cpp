...
#include "OAIDisassociateMembershipRequest.h"
...
OAIDisassociateMembershipRequest::OAIDisassociateMembershipRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateMembershipRequest::OAIDisassociateMembershipRequest() {
    this->initializeModel();
}

OAIDisassociateMembershipRequest::~OAIDisassociateMembershipRequest() {}

void OAIDisassociateMembershipRequest::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDisassociateMembershipRequest::fromJson(QString jsonString) {
...
void OAIDisassociateMembershipRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateMembershipRequest::asJson() const {
...
QJsonObject OAIDisassociateMembershipRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateMembershipRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIDisassociateMembershipRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDisassociateMembershipRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDisassociateMembershipRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDisassociateMembershipRequest::isSet() const {
...
bool OAIDisassociateMembershipRequest::isValid() const {
