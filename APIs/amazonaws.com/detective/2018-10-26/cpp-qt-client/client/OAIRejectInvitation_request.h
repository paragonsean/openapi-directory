...
/*
 * OAIRejectInvitation_request.h
 *
 * 
 */

#ifndef OAIRejectInvitation_request_H
#define OAIRejectInvitation_request_H
...
class OAIRejectInvitation_request : public OAIObject {
public:
    OAIRejectInvitation_request();
    OAIRejectInvitation_request(QString json);
    ~OAIRejectInvitation_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRejectInvitation_request)

#endif // OAIRejectInvitation_request_H
