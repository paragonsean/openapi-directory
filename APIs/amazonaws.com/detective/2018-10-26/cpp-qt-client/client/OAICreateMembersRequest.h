...
/*
 * OAICreateMembersRequest.h
 *
 * 
 */

#ifndef OAICreateMembersRequest_H
#define OAICreateMembersRequest_H
...
class OAICreateMembersRequest : public OAIObject {
public:
    OAICreateMembersRequest();
    OAICreateMembersRequest(QString json);
    ~OAICreateMembersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMembersRequest)

#endif // OAICreateMembersRequest_H
