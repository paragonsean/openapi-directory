...
/*
 * OAIStartMonitoringMember_request.h
 *
 * 
 */

#ifndef OAIStartMonitoringMember_request_H
#define OAIStartMonitoringMember_request_H
...
class OAIStartMonitoringMember_request : public OAIObject {
public:
    OAIStartMonitoringMember_request();
    OAIStartMonitoringMember_request(QString json);
    ~OAIStartMonitoringMember_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMonitoringMember_request)

#endif // OAIStartMonitoringMember_request_H
