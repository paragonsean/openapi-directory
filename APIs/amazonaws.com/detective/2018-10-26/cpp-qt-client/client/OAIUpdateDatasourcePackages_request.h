...
/*
 * OAIUpdateDatasourcePackages_request.h
 *
 * 
 */

#ifndef OAIUpdateDatasourcePackages_request_H
#define OAIUpdateDatasourcePackages_request_H
...
class OAIUpdateDatasourcePackages_request : public OAIObject {
public:
    OAIUpdateDatasourcePackages_request();
    OAIUpdateDatasourcePackages_request(QString json);
    ~OAIUpdateDatasourcePackages_request() override;
    ...
    QList<OAIDatasourcePackage> getDatasourcePackages() const;
    void setDatasourcePackages(const QList<OAIDatasourcePackage> &datasource_packages);
...
private:
    ...
    QList<OAIDatasourcePackage> m_datasource_packages;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDatasourcePackages_request)

#endif // OAIUpdateDatasourcePackages_request_H
