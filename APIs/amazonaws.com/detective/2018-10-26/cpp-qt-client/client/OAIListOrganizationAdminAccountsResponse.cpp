...
void OAIListOrganizationAdminAccountsResponse::initializeModel() {
    ...
    m_administrators_isSet = false;
    m_administrators_isValid = false;
...
void OAIListOrganizationAdminAccountsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_administrators_isValid = ::OpenAPI::fromJsonValue(m_administrators, json[QString("Administrators")]);
    m_administrators_isSet = !json[QString("Administrators")].isNull() && m_administrators_isValid;
...
QJsonObject OAIListOrganizationAdminAccountsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_administrators.isSet()) {
        obj.insert(QString("Administrators"), ::OpenAPI::toJsonValue(m_administrators));
    }
...
QList OAIListOrganizationAdminAccountsResponse::getAdministrators() const {
    return m_administrators;
}
void OAIListOrganizationAdminAccountsResponse::setAdministrators(const QList &administrators) {
    m_administrators = administrators;
    m_administrators_isSet = true;
}

bool OAIListOrganizationAdminAccountsResponse::is_administrators_Set() const{
    return m_administrators_isSet;
}

bool OAIListOrganizationAdminAccountsResponse::is_administrators_Valid() const{
    return m_administrators_isValid;
}
