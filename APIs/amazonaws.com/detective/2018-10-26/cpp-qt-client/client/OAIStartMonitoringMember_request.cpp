...
OAIStartMonitoringMember_request::OAIStartMonitoringMember_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartMonitoringMember_request::OAIStartMonitoringMember_request() {
    this->initializeModel();
}

OAIStartMonitoringMember_request::~OAIStartMonitoringMember_request() {}

void OAIStartMonitoringMember_request::initializeModel() {
...
void OAIStartMonitoringMember_request::fromJson(QString jsonString) {
...
void OAIStartMonitoringMember_request::fromJsonObject(QJsonObject json) {
...
QString OAIStartMonitoringMember_request::asJson() const {
...
QJsonObject OAIStartMonitoringMember_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartMonitoringMember_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIStartMonitoringMember_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIStartMonitoringMember_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIStartMonitoringMember_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAIStartMonitoringMember_request::getAccountId() const {
    return m_account_id;
}
void OAIStartMonitoringMember_request::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIStartMonitoringMember_request::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIStartMonitoringMember_request::is_account_id_Valid() const{
    return m_account_id_isValid;
}

bool OAIStartMonitoringMember_request::isSet() const {
...
bool OAIStartMonitoringMember_request::isValid() const {
