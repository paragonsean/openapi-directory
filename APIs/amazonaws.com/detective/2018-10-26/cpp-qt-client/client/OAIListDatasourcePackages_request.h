...
/*
 * OAIListDatasourcePackages_request.h
 *
 * 
 */

#ifndef OAIListDatasourcePackages_request_H
#define OAIListDatasourcePackages_request_H
...
class OAIListDatasourcePackages_request : public OAIObject {
public:
    OAIListDatasourcePackages_request();
    OAIListDatasourcePackages_request(QString json);
    ~OAIListDatasourcePackages_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatasourcePackages_request)

#endif // OAIListDatasourcePackages_request_H
