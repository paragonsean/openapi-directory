...
/*
 * OAIGetMembers_request.h
 *
 * 
 */

#ifndef OAIGetMembers_request_H
#define OAIGetMembers_request_H
...
class OAIGetMembers_request : public OAIObject {
public:
    OAIGetMembers_request();
    OAIGetMembers_request(QString json);
    ~OAIGetMembers_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMembers_request)

#endif // OAIGetMembers_request_H
