...
OAIRejectInvitation_request::OAIRejectInvitation_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRejectInvitation_request::OAIRejectInvitation_request() {
    this->initializeModel();
}

OAIRejectInvitation_request::~OAIRejectInvitation_request() {}

void OAIRejectInvitation_request::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIRejectInvitation_request::fromJson(QString jsonString) {
...
void OAIRejectInvitation_request::fromJsonObject(QJsonObject json) {
...
QString OAIRejectInvitation_request::asJson() const {
...
QJsonObject OAIRejectInvitation_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRejectInvitation_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIRejectInvitation_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIRejectInvitation_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIRejectInvitation_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIRejectInvitation_request::isSet() const {
...
bool OAIRejectInvitation_request::isValid() const {
