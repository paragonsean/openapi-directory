...
/*
 * OAIListInvitations_request.h
 *
 * 
 */

#ifndef OAIListInvitations_request_H
#define OAIListInvitations_request_H
...
class OAIListInvitations_request : public OAIObject {
public:
    OAIListInvitations_request();
    OAIListInvitations_request(QString json);
    ~OAIListInvitations_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListInvitations_request)

#endif // OAIListInvitations_request_H
