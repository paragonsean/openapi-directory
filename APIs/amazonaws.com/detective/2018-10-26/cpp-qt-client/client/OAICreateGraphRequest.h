...
/*
 * OAICreateGraphRequest.h
 *
 * 
 */

#ifndef OAICreateGraphRequest_H
#define OAICreateGraphRequest_H
...
class OAICreateGraphRequest : public OAIObject {
public:
    OAICreateGraphRequest();
    OAICreateGraphRequest(QString json);
    ~OAICreateGraphRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGraphRequest)

#endif // OAICreateGraphRequest_H
