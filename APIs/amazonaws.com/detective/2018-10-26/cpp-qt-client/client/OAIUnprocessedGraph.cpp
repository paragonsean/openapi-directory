...
OAIUnprocessedGraph::OAIUnprocessedGraph(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnprocessedGraph::OAIUnprocessedGraph() {
    this->initializeModel();
}

OAIUnprocessedGraph::~OAIUnprocessedGraph() {}

void OAIUnprocessedGraph::initializeModel() {
...
void OAIUnprocessedGraph::fromJson(QString jsonString) {
...
void OAIUnprocessedGraph::fromJsonObject(QJsonObject json) {
...
QString OAIUnprocessedGraph::asJson() const {
...
QJsonObject OAIUnprocessedGraph::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUnprocessedGraph::getGraphArn() const {
    return m_graph_arn;
}
void OAIUnprocessedGraph::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIUnprocessedGraph::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIUnprocessedGraph::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAIUnprocessedGraph::getReason() const {
    return m_reason;
}
void OAIUnprocessedGraph::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIUnprocessedGraph::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIUnprocessedGraph::is_reason_Valid() const{
    return m_reason_isValid;
}

bool OAIUnprocessedGraph::isSet() const {
...
bool OAIUnprocessedGraph::isValid() const {
