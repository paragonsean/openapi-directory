...
/*
 * OAIDeleteGraph_request.h
 *
 * 
 */

#ifndef OAIDeleteGraph_request_H
#define OAIDeleteGraph_request_H
...
class OAIDeleteGraph_request : public OAIObject {
public:
    OAIDeleteGraph_request();
    OAIDeleteGraph_request(QString json);
    ~OAIDeleteGraph_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGraph_request)

#endif // OAIDeleteGraph_request_H
