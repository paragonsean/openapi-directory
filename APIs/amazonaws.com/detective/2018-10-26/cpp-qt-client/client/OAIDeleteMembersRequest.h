...
/*
 * OAIDeleteMembersRequest.h
 *
 * 
 */

#ifndef OAIDeleteMembersRequest_H
#define OAIDeleteMembersRequest_H
...
class OAIDeleteMembersRequest : public OAIObject {
public:
    OAIDeleteMembersRequest();
    OAIDeleteMembersRequest(QString json);
    ~OAIDeleteMembersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMembersRequest)

#endif // OAIDeleteMembersRequest_H
