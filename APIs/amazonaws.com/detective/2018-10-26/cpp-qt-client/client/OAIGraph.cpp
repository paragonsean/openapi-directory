...
QString OAIGraph::getArn() const {
    return m_arn;
}
void OAIGraph::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGraph::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGraph::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIGraph::getCreatedTime() const {
    return m_created_time;
}
void OAIGraph::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIGraph::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIGraph::is_created_time_Valid() const{
