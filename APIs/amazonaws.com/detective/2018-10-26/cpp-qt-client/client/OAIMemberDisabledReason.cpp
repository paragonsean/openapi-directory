...
OAIMemberDisabledReason::OAIMemberDisabledReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMemberDisabledReason::OAIMemberDisabledReason() {
    this->initializeModel();
}

OAIMemberDisabledReason::~OAIMemberDisabledReason() {}

void OAIMemberDisabledReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMemberDisabledReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMemberDisabledReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("VOLUME_TOO_HIGH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMemberDisabledReason::TOO_HIGH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("VOLUME_UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMemberDisabledReason::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMemberDisabledReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMemberDisabledReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMemberDisabledReason::TOO_HIGH:
            val = "VOLUME_TOO_HIGH";
            break;
        case eOAIMemberDisabledReason::UNKNOWN:
            val = "VOLUME_UNKNOWN";
            break;
        default:
            break;
...
QJsonValue OAIMemberDisabledReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMemberDisabledReason::eOAIMemberDisabledReason OAIMemberDisabledReason::getValue() const {
    return m_value;
}

void OAIMemberDisabledReason::setValue(const OAIMemberDisabledReason::eOAIMemberDisabledReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMemberDisabledReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIMemberDisabledReason::isValid() const {
