...
/*
 * OAIDatasourcePackageIngestDetail.h
 *
 * Details about the data source packages ingested by your behavior graph.
 */

#ifndef OAIDatasourcePackageIngestDetail_H
#define OAIDatasourcePackageIngestDetail_H
...
class OAIDatasourcePackageIngestDetail : public OAIObject {
public:
    OAIDatasourcePackageIngestDetail();
    OAIDatasourcePackageIngestDetail(QString json);
    ~OAIDatasourcePackageIngestDetail() override;
    ...
    OAIDatasourcePackageIngestState getDatasourcePackageIngestState() const;
    void setDatasourcePackageIngestState(const OAIDatasourcePackageIngestState &datasource_package_ingest_state);
    bool is_datasource_package_ingest_state_Set() const;
    bool is_datasource_package_ingest_state_Valid() const;

    QMap getLastIngestStateChange() const;
    void setLastIngestStateChange(const QMap &last_ingest_state_change);
    bool is_last_ingest_state_change_Set() const;
    bool is_last_ingest_state_change_Valid() const;
...
private:
    ...
    OAIDatasourcePackageIngestState m_datasource_package_ingest_state;
    bool m_datasource_package_ingest_state_isSet;
    bool m_datasource_package_ingest_state_isValid;

    QMap m_last_ingest_state_change;
    bool m_last_ingest_state_change_isSet;
    bool m_last_ingest_state_change_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDatasourcePackageIngestDetail)

#endif // OAIDatasourcePackageIngestDetail_H
