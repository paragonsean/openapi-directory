...
OAIListGraphsResponse::OAIListGraphsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGraphsResponse::OAIListGraphsResponse() {
    this->initializeModel();
}

OAIListGraphsResponse::~OAIListGraphsResponse() {}

void OAIListGraphsResponse::initializeModel() {

    m_graph_list_isSet = false;
    m_graph_list_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListGraphsResponse::fromJson(QString jsonString) {
...
void OAIListGraphsResponse::fromJsonObject(QJsonObject json) {

    m_graph_list_isValid = ::OpenAPI::fromJsonValue(m_graph_list, json[QString("GraphList")]);
    m_graph_list_isSet = !json[QString("GraphList")].isNull() && m_graph_list_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListGraphsResponse::asJson() const {
...
QJsonObject OAIListGraphsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_graph_list.isSet()) {
        obj.insert(QString("GraphList"), ::OpenAPI::toJsonValue(m_graph_list));
    }
...
QList OAIListGraphsResponse::getGraphList() const {
    return m_graph_list;
}
void OAIListGraphsResponse::setGraphList(const QList &graph_list) {
    m_graph_list = graph_list;
    m_graph_list_isSet = true;
}

bool OAIListGraphsResponse::is_graph_list_Set() const{
    return m_graph_list_isSet;
}

bool OAIListGraphsResponse::is_graph_list_Valid() const{
    return m_graph_list_isValid;
}

QString OAIListGraphsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListGraphsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGraphsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGraphsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListGraphsResponse::isSet() const {
...
bool OAIListGraphsResponse::isValid() const {
