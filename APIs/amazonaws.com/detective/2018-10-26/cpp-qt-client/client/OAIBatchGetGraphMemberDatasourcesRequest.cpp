...
#include "OAIBatchGetGraphMemberDatasourcesRequest.h"
...
OAIBatchGetGraphMemberDatasourcesRequest::OAIBatchGetGraphMemberDatasourcesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetGraphMemberDatasourcesRequest::OAIBatchGetGraphMemberDatasourcesRequest() {
    this->initializeModel();
}

OAIBatchGetGraphMemberDatasourcesRequest::~OAIBatchGetGraphMemberDatasourcesRequest() {}

void OAIBatchGetGraphMemberDatasourcesRequest::initializeModel() {
...
void OAIBatchGetGraphMemberDatasourcesRequest::fromJson(QString jsonString) {
...
void OAIBatchGetGraphMemberDatasourcesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetGraphMemberDatasourcesRequest::asJson() const {
...
QJsonObject OAIBatchGetGraphMemberDatasourcesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchGetGraphMemberDatasourcesRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIBatchGetGraphMemberDatasourcesRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIBatchGetGraphMemberDatasourcesRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIBatchGetGraphMemberDatasourcesRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList OAIBatchGetGraphMemberDatasourcesRequest::getAccountIds() const {
    return m_account_ids;
}
void OAIBatchGetGraphMemberDatasourcesRequest::setAccountIds(const QList &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIBatchGetGraphMemberDatasourcesRequest::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIBatchGetGraphMemberDatasourcesRequest::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIBatchGetGraphMemberDatasourcesRequest::isSet() const {
...
bool OAIBatchGetGraphMemberDatasourcesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_graph_arn_isValid && m_account_ids_isValid && true;
}
