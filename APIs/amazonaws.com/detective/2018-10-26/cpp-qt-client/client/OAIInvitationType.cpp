...
OAIInvitationType::OAIInvitationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInvitationType::OAIInvitationType() {
    this->initializeModel();
}

OAIInvitationType::~OAIInvitationType() {}

void OAIInvitationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIInvitationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIInvitationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INVITATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIInvitationType::INVITATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ORGANIZATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIInvitationType::ORGANIZATION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIInvitationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIInvitationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIInvitationType::INVITATION:
            val = "INVITATION";
            break;
        case eOAIInvitationType::ORGANIZATION:
            val = "ORGANIZATION";
            break;
        default:
            break;
...
QJsonValue OAIInvitationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIInvitationType::eOAIInvitationType OAIInvitationType::getValue() const {
    return m_value;
}

void OAIInvitationType::setValue(const OAIInvitationType::eOAIInvitationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIInvitationType::isSet() const {
    
    return m_value_isSet;
}

bool OAIInvitationType::isValid() const {
