...
OAIListDatasourcePackagesResponse::OAIListDatasourcePackagesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatasourcePackagesResponse::OAIListDatasourcePackagesResponse() {
    this->initializeModel();
}

OAIListDatasourcePackagesResponse::~OAIListDatasourcePackagesResponse() {}

void OAIListDatasourcePackagesResponse::initializeModel() {
...
void OAIListDatasourcePackagesResponse::fromJson(QString jsonString) {
...
void OAIListDatasourcePackagesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListDatasourcePackagesResponse::asJson() const {
...
QJsonObject OAIListDatasourcePackagesResponse::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIListDatasourcePackagesResponse::getDatasourcePackages() const {
    return m_datasource_packages;
}
void OAIListDatasourcePackagesResponse::setDatasourcePackages(const QMap &datasource_packages) {
    m_datasource_packages = datasource_packages;
    m_datasource_packages_isSet = true;
}

bool OAIListDatasourcePackagesResponse::is_datasource_packages_Set() const{
    return m_datasource_packages_isSet;
}

bool OAIListDatasourcePackagesResponse::is_datasource_packages_Valid() const{
    return m_datasource_packages_isValid;
}

QString OAIListDatasourcePackagesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDatasourcePackagesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatasourcePackagesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatasourcePackagesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDatasourcePackagesResponse::isSet() const {
...
bool OAIListDatasourcePackagesResponse::isValid() const {
