...
/*
 * OAIDeleteMembersResponse.h
 *
 * 
 */

#ifndef OAIDeleteMembersResponse_H
#define OAIDeleteMembersResponse_H
...
class OAIDeleteMembersResponse : public OAIObject {
public:
    OAIDeleteMembersResponse();
    OAIDeleteMembersResponse(QString json);
    ~OAIDeleteMembersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMembersResponse)

#endif // OAIDeleteMembersResponse_H
