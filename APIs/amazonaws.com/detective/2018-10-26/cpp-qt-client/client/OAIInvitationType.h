...
#ifndef OAIInvitationType_H
#define OAIInvitationType_H
...
class OAIInvitationType : public OAIEnum {
public:
    OAIInvitationType();
    OAIInvitationType(QString json);
    ~OAIInvitationType() override;
    ...
    enum class eOAIInvitationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INVITATION, 
        ORGANIZATION
    };
    OAIInvitationType::eOAIInvitationType getValue() const;
    void setValue(const OAIInvitationType::eOAIInvitationType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvitationType)

#endif // OAIInvitationType_H
