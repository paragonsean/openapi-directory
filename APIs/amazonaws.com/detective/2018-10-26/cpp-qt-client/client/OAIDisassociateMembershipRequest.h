...
/*
 * OAIDisassociateMembershipRequest.h
 *
 * 
 */

#ifndef OAIDisassociateMembershipRequest_H
#define OAIDisassociateMembershipRequest_H
...
class OAIDisassociateMembershipRequest : public OAIObject {
public:
    OAIDisassociateMembershipRequest();
    OAIDisassociateMembershipRequest(QString json);
    ~OAIDisassociateMembershipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateMembershipRequest)

#endif // OAIDisassociateMembershipRequest_H
