...
#include "OAIDeleteMembersRequest.h"
...
OAIDeleteMembersRequest::OAIDeleteMembersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMembersRequest::OAIDeleteMembersRequest() {
    this->initializeModel();
}

OAIDeleteMembersRequest::~OAIDeleteMembersRequest() {}

void OAIDeleteMembersRequest::initializeModel() {
...
void OAIDeleteMembersRequest::fromJson(QString jsonString) {
...
void OAIDeleteMembersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMembersRequest::asJson() const {
...
QJsonObject OAIDeleteMembersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteMembersRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIDeleteMembersRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDeleteMembersRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDeleteMembersRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList OAIDeleteMembersRequest::getAccountIds() const {
    return m_account_ids;
}
void OAIDeleteMembersRequest::setAccountIds(const QList &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIDeleteMembersRequest::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIDeleteMembersRequest::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIDeleteMembersRequest::isSet() const {
...
bool OAIDeleteMembersRequest::isValid() const {
