...
/*
 * OAICreateMembers_request.h
 *
 * 
 */

#ifndef OAICreateMembers_request_H
#define OAICreateMembers_request_H
...
class OAICreateMembers_request : public OAIObject {
public:
    OAICreateMembers_request();
    OAICreateMembers_request(QString json);
    ~OAICreateMembers_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMembers_request)

#endif // OAICreateMembers_request_H
