...
OAIBatchGetMembershipDatasources_request::OAIBatchGetMembershipDatasources_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetMembershipDatasources_request::OAIBatchGetMembershipDatasources_request() {
    this->initializeModel();
}

OAIBatchGetMembershipDatasources_request::~OAIBatchGetMembershipDatasources_request() {}

void OAIBatchGetMembershipDatasources_request::initializeModel() {

    m_graph_arns_isSet = false;
    m_graph_arns_isValid = false;
}

void OAIBatchGetMembershipDatasources_request::fromJson(QString jsonString) {
...
void OAIBatchGetMembershipDatasources_request::fromJsonObject(QJsonObject json) {

    m_graph_arns_isValid = ::OpenAPI::fromJsonValue(m_graph_arns, json[QString("GraphArns")]);
    m_graph_arns_isSet = !json[QString("GraphArns")].isNull() && m_graph_arns_isValid;
}

QString OAIBatchGetMembershipDatasources_request::asJson() const {
...
QJsonObject OAIBatchGetMembershipDatasources_request::asJsonObject() const {
    QJsonObject obj;
    if (m_graph_arns.size() > 0) {
        obj.insert(QString("GraphArns"), ::OpenAPI::toJsonValue(m_graph_arns));
    }
    return obj;
}

QList<QString> OAIBatchGetMembershipDatasources_request::getGraphArns() const {
    return m_graph_arns;
}
void OAIBatchGetMembershipDatasources_request::setGraphArns(const QList<QString> &graph_arns) {
    m_graph_arns = graph_arns;
    m_graph_arns_isSet = true;
}

bool OAIBatchGetMembershipDatasources_request::is_graph_arns_Set() const{
    return m_graph_arns_isSet;
}

bool OAIBatchGetMembershipDatasources_request::is_graph_arns_Valid() const{
    return m_graph_arns_isValid;
}

bool OAIBatchGetMembershipDatasources_request::isSet() const {
...
bool OAIBatchGetMembershipDatasources_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_graph_arns_isValid && true;
}
