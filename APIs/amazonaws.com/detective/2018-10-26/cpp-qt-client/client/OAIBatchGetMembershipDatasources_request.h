...
/*
 * OAIBatchGetMembershipDatasources_request.h
 *
 * 
 */

#ifndef OAIBatchGetMembershipDatasources_request_H
#define OAIBatchGetMembershipDatasources_request_H
...
class OAIBatchGetMembershipDatasources_request : public OAIObject {
public:
    OAIBatchGetMembershipDatasources_request();
    OAIBatchGetMembershipDatasources_request(QString json);
    ~OAIBatchGetMembershipDatasources_request() override;
    ...
    QList<QString> getGraphArns() const;
    void setGraphArns(const QList<QString> &graph_arns);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetMembershipDatasources_request)

#endif // OAIBatchGetMembershipDatasources_request_H
