...
/*
 * OAIListOrganizationAdminAccounts_request.h
 *
 * 
 */

#ifndef OAIListOrganizationAdminAccounts_request_H
#define OAIListOrganizationAdminAccounts_request_H
...
class OAIListOrganizationAdminAccounts_request : public OAIObject {
public:
    OAIListOrganizationAdminAccounts_request();
    OAIListOrganizationAdminAccounts_request(QString json);
    ~OAIListOrganizationAdminAccounts_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationAdminAccounts_request)

#endif // OAIListOrganizationAdminAccounts_request_H
