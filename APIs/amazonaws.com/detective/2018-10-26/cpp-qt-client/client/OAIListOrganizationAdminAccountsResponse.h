...
public:
    ...
    QList getAdministrators() const;
    void setAdministrators(const QList &administrators);
    bool is_administrators_Set() const;
    bool is_administrators_Valid() const;
...
private:
    ...
    QList m_administrators;
    bool m_administrators_isSet;
    bool m_administrators_isValid;
