...
/*
 * OAIListGraphsRequest.h
 *
 * 
 */

#ifndef OAIListGraphsRequest_H
#define OAIListGraphsRequest_H
...
class OAIListGraphsRequest : public OAIObject {
public:
    OAIListGraphsRequest();
    OAIListGraphsRequest(QString json);
    ~OAIListGraphsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGraphsRequest)

#endif // OAIListGraphsRequest_H
