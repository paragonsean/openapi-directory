...
OAIListGraphs_request::OAIListGraphs_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListGraphs_request::OAIListGraphs_request() {
    this->initializeModel();
}

OAIListGraphs_request::~OAIListGraphs_request() {}

void OAIListGraphs_request::initializeModel() {
...
void OAIListGraphs_request::fromJson(QString jsonString) {
...
void OAIListGraphs_request::fromJsonObject(QJsonObject json) {
...
QString OAIListGraphs_request::asJson() const {
...
QJsonObject OAIListGraphs_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListGraphs_request::getNextToken() const {
    return m_next_token;
}
void OAIListGraphs_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGraphs_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGraphs_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListGraphs_request::getMaxResults() const {
    return m_max_results;
}
void OAIListGraphs_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListGraphs_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListGraphs_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListGraphs_request::isSet() const {
...
bool OAIListGraphs_request::isValid() const {
