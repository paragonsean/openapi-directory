...
/*
 * OAIUnprocessedGraph.h
 *
 * Behavior graphs that could not be processed in the request.
 */

#ifndef OAIUnprocessedGraph_H
#define OAIUnprocessedGraph_H
...
class OAIUnprocessedGraph : public OAIObject {
public:
    OAIUnprocessedGraph();
    OAIUnprocessedGraph(QString json);
    ~OAIUnprocessedGraph() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnprocessedGraph)

#endif // OAIUnprocessedGraph_H
