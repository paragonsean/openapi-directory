...
/*
 * OAIMembershipDatasources.h
 *
 * Details on data source packages for members of the behavior graph.
 */

#ifndef OAIMembershipDatasources_H
#define OAIMembershipDatasources_H
...
class OAIMembershipDatasources : public OAIObject {
public:
    OAIMembershipDatasources();
    OAIMembershipDatasources(QString json);
    ~OAIMembershipDatasources() override;
    ...
    QMap getDatasourcePackageIngestHistory() const;
    void setDatasourcePackageIngestHistory(const QMap &datasource_package_ingest_history);
    bool is_datasource_package_ingest_history_Set() const;
    bool is_datasource_package_ingest_history_Valid() const;
...
private:
    ...
    QMap m_datasource_package_ingest_history;
    bool m_datasource_package_ingest_history_isSet;
    bool m_datasource_package_ingest_history_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMembershipDatasources)

#endif // OAIMembershipDatasources_H
