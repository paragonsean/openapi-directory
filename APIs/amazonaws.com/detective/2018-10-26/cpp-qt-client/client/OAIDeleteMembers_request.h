...
/*
 * OAIDeleteMembers_request.h
 *
 * 
 */

#ifndef OAIDeleteMembers_request_H
#define OAIDeleteMembers_request_H
...
class OAIDeleteMembers_request : public OAIObject {
public:
    OAIDeleteMembers_request();
    OAIDeleteMembers_request(QString json);
    ~OAIDeleteMembers_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMembers_request)

#endif // OAIDeleteMembers_request_H
