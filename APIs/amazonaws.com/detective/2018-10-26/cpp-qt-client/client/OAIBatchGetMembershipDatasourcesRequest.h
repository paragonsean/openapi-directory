...
/*
 * OAIBatchGetMembershipDatasourcesRequest.h
 *
 * 
 */

#ifndef OAIBatchGetMembershipDatasourcesRequest_H
#define OAIBatchGetMembershipDatasourcesRequest_H
...
class OAIBatchGetMembershipDatasourcesRequest : public OAIObject {
public:
    OAIBatchGetMembershipDatasourcesRequest();
    OAIBatchGetMembershipDatasourcesRequest(QString json);
    ~OAIBatchGetMembershipDatasourcesRequest() override;
    ...
    QList getGraphArns() const;
    void setGraphArns(const QList &graph_arns);
    bool is_graph_arns_Set() const;
    bool is_graph_arns_Valid() const;
...
private:
    ...
    QList m_graph_arns;
    bool m_graph_arns_isSet;
    bool m_graph_arns_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetMembershipDatasourcesRequest)

#endif // OAIBatchGetMembershipDatasourcesRequest_H
