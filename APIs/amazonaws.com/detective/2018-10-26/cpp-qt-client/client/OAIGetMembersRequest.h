...
/*
 * OAIGetMembersRequest.h
 *
 * 
 */

#ifndef OAIGetMembersRequest_H
#define OAIGetMembersRequest_H
...
class OAIGetMembersRequest : public OAIObject {
public:
    OAIGetMembersRequest();
    OAIGetMembersRequest(QString json);
    ~OAIGetMembersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMembersRequest)

#endif // OAIGetMembersRequest_H
