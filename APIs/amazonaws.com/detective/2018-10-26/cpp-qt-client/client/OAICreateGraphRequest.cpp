...
#include "OAICreateGraphRequest.h"
...
OAICreateGraphRequest::OAICreateGraphRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateGraphRequest::OAICreateGraphRequest() {
    this->initializeModel();
}

OAICreateGraphRequest::~OAICreateGraphRequest() {}

void OAICreateGraphRequest::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAICreateGraphRequest::fromJson(QString jsonString) {
...
void OAICreateGraphRequest::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAICreateGraphRequest::asJson() const {
...
QJsonObject OAICreateGraphRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAICreateGraphRequest::getTags() const {
    return m_tags;
}
void OAICreateGraphRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateGraphRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateGraphRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateGraphRequest::isSet() const {
...
bool OAICreateGraphRequest::isValid() const {
