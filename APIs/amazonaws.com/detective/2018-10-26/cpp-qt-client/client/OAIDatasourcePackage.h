...
/*
 * OAIDatasourcePackage.h
 *
 * 
 */

#ifndef OAIDatasourcePackage_H
#define OAIDatasourcePackage_H
...
class OAIDatasourcePackage : public OAIEnum {
public:
    OAIDatasourcePackage();
    OAIDatasourcePackage(QString json);
    ~OAIDatasourcePackage() override;
    ...
    enum class eOAIDatasourcePackage {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DETECTIVE_CORE, 
        EKS_AUDIT, 
        ASFF_SECURITYHUB_FINDING
    };
    OAIDatasourcePackage::eOAIDatasourcePackage getValue() const;
    void setValue(const OAIDatasourcePackage::eOAIDatasourcePackage& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasourcePackage)

#endif // OAIDatasourcePackage_H
