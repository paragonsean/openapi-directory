...
/*
 * OAICreateGraph_request.h
 *
 * 
 */

#ifndef OAICreateGraph_request_H
#define OAICreateGraph_request_H
...
class OAICreateGraph_request : public OAIObject {
public:
    OAICreateGraph_request();
    OAICreateGraph_request(QString json);
    ~OAICreateGraph_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGraph_request)

#endif // OAICreateGraph_request_H
