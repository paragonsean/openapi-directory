...
#include "OAIListOrganizationAdminAccountsRequest.h"
...
OAIListOrganizationAdminAccountsRequest::OAIListOrganizationAdminAccountsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListOrganizationAdminAccountsRequest::OAIListOrganizationAdminAccountsRequest() {
    this->initializeModel();
}

OAIListOrganizationAdminAccountsRequest::~OAIListOrganizationAdminAccountsRequest() {}

void OAIListOrganizationAdminAccountsRequest::initializeModel() {
...
void OAIListOrganizationAdminAccountsRequest::fromJson(QString jsonString) {
...
void OAIListOrganizationAdminAccountsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListOrganizationAdminAccountsRequest::asJson() const {
...
QJsonObject OAIListOrganizationAdminAccountsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListOrganizationAdminAccountsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListOrganizationAdminAccountsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListOrganizationAdminAccountsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListOrganizationAdminAccountsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListOrganizationAdminAccountsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListOrganizationAdminAccountsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListOrganizationAdminAccountsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListOrganizationAdminAccountsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListOrganizationAdminAccountsRequest::isSet() const {
...
bool OAIListOrganizationAdminAccountsRequest::isValid() const {
