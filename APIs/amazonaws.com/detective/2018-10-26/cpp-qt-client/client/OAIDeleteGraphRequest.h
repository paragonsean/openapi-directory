...
/*
 * OAIDeleteGraphRequest.h
 *
 * 
 */

#ifndef OAIDeleteGraphRequest_H
#define OAIDeleteGraphRequest_H
...
class OAIDeleteGraphRequest : public OAIObject {
public:
    OAIDeleteGraphRequest();
    OAIDeleteGraphRequest(QString json);
    ~OAIDeleteGraphRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGraphRequest)

#endif // OAIDeleteGraphRequest_H
