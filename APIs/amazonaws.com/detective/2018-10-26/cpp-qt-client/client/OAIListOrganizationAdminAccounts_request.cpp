...
OAIListOrganizationAdminAccounts_request::OAIListOrganizationAdminAccounts_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListOrganizationAdminAccounts_request::OAIListOrganizationAdminAccounts_request() {
    this->initializeModel();
}

OAIListOrganizationAdminAccounts_request::~OAIListOrganizationAdminAccounts_request() {}

void OAIListOrganizationAdminAccounts_request::initializeModel() {
...
void OAIListOrganizationAdminAccounts_request::fromJson(QString jsonString) {
...
void OAIListOrganizationAdminAccounts_request::fromJsonObject(QJsonObject json) {
...
QString OAIListOrganizationAdminAccounts_request::asJson() const {
...
QJsonObject OAIListOrganizationAdminAccounts_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListOrganizationAdminAccounts_request::getNextToken() const {
    return m_next_token;
}
void OAIListOrganizationAdminAccounts_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListOrganizationAdminAccounts_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListOrganizationAdminAccounts_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListOrganizationAdminAccounts_request::getMaxResults() const {
    return m_max_results;
}
void OAIListOrganizationAdminAccounts_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListOrganizationAdminAccounts_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListOrganizationAdminAccounts_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListOrganizationAdminAccounts_request::isSet() const {
...
bool OAIListOrganizationAdminAccounts_request::isValid() const {
