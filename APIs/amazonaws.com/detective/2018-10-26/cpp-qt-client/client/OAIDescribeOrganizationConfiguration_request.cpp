...
OAIDescribeOrganizationConfiguration_request::OAIDescribeOrganizationConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeOrganizationConfiguration_request::OAIDescribeOrganizationConfiguration_request() {
    this->initializeModel();
}

OAIDescribeOrganizationConfiguration_request::~OAIDescribeOrganizationConfiguration_request() {}

void OAIDescribeOrganizationConfiguration_request::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIDescribeOrganizationConfiguration_request::fromJson(QString jsonString) {
...
void OAIDescribeOrganizationConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeOrganizationConfiguration_request::asJson() const {
...
QJsonObject OAIDescribeOrganizationConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeOrganizationConfiguration_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIDescribeOrganizationConfiguration_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDescribeOrganizationConfiguration_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDescribeOrganizationConfiguration_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIDescribeOrganizationConfiguration_request::isSet() const {
...
bool OAIDescribeOrganizationConfiguration_request::isValid() const {
