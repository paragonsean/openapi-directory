...
#include "OAIDatasourcePackageIngestState.h"
...
OAIDatasourcePackageIngestState::OAIDatasourcePackageIngestState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasourcePackageIngestState::OAIDatasourcePackageIngestState() {
    this->initializeModel();
}

OAIDatasourcePackageIngestState::~OAIDatasourcePackageIngestState() {}

void OAIDatasourcePackageIngestState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDatasourcePackageIngestState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDatasourcePackageIngestState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("STARTED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackageIngestState::STARTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOPPED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackageIngestState::STOPPED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DISABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDatasourcePackageIngestState::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDatasourcePackageIngestState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDatasourcePackageIngestState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDatasourcePackageIngestState::STARTED:
            val = "STARTED";
            break;
        case eOAIDatasourcePackageIngestState::STOPPED:
            val = "STOPPED";
            break;
        case eOAIDatasourcePackageIngestState::DISABLED:
            val = "DISABLED";
            break;
        default:
            break;
...
QJsonValue OAIDatasourcePackageIngestState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDatasourcePackageIngestState::eOAIDatasourcePackageIngestState OAIDatasourcePackageIngestState::getValue() const {
    return m_value;
}

void OAIDatasourcePackageIngestState::setValue(const OAIDatasourcePackageIngestState::eOAIDatasourcePackageIngestState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDatasourcePackageIngestState::isSet() const {
    
    return m_value_isSet;
}

bool OAIDatasourcePackageIngestState::isValid() const {
