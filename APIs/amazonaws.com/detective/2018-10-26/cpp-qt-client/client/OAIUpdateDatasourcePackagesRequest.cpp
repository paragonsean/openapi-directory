...
#include "OAIUpdateDatasourcePackagesRequest.h"
...
OAIUpdateDatasourcePackagesRequest::OAIUpdateDatasourcePackagesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDatasourcePackagesRequest::OAIUpdateDatasourcePackagesRequest() {
    this->initializeModel();
}

OAIUpdateDatasourcePackagesRequest::~OAIUpdateDatasourcePackagesRequest() {}

void OAIUpdateDatasourcePackagesRequest::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;

    m_datasource_packages_isSet = false;
    m_datasource_packages_isValid = false;
}

void OAIUpdateDatasourcePackagesRequest::fromJson(QString jsonString) {
...
void OAIUpdateDatasourcePackagesRequest::fromJsonObject(QJsonObject json) {
    ...
    m_datasource_packages_isValid = ::OpenAPI::fromJsonValue(m_datasource_packages, json[QString("DatasourcePackages")]);
    m_datasource_packages_isSet = !json[QString("DatasourcePackages")].isNull() && m_datasource_packages_isValid;
}

QString OAIUpdateDatasourcePackagesRequest::asJson() const {
...
QJsonObject OAIUpdateDatasourcePackagesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_graph_arn_isSet) {
        obj.insert(QString("GraphArn"), ::OpenAPI::toJsonValue(m_graph_arn));
    }
    if (m_datasource_packages.isSet()) {
        obj.insert(QString("DatasourcePackages"), ::OpenAPI::toJsonValue(m_datasource_packages));
    }
    return obj;
}

QString OAIUpdateDatasourcePackagesRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIUpdateDatasourcePackagesRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIUpdateDatasourcePackagesRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIUpdateDatasourcePackagesRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList OAIUpdateDatasourcePackagesRequest::getDatasourcePackages() const {
    return m_datasource_packages;
}
void OAIUpdateDatasourcePackagesRequest::setDatasourcePackages(const QList &datasource_packages) {
    m_datasource_packages = datasource_packages;
    m_datasource_packages_isSet = true;
}

bool OAIUpdateDatasourcePackagesRequest::is_datasource_packages_Set() const{
    return m_datasource_packages_isSet;
}

bool OAIUpdateDatasourcePackagesRequest::is_datasource_packages_Valid() const{
    return m_datasource_packages_isValid;
}

bool OAIUpdateDatasourcePackagesRequest::isSet() const {
...
bool OAIUpdateDatasourcePackagesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_graph_arn_isValid && m_datasource_packages_isValid && true;
}
