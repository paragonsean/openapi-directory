...
OAIGetMembersResponse::OAIGetMembersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMembersResponse::OAIGetMembersResponse() {
    this->initializeModel();
}

OAIGetMembersResponse::~OAIGetMembersResponse() {}

void OAIGetMembersResponse::initializeModel() {
...
void OAIGetMembersResponse::fromJson(QString jsonString) {
...
void OAIGetMembersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetMembersResponse::asJson() const {
...
QJsonObject OAIGetMembersResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIGetMembersResponse::getMemberDetails() const {
    return m_member_details;
}
void OAIGetMembersResponse::setMemberDetails(const QList &member_details) {
    m_member_details = member_details;
    m_member_details_isSet = true;
}

bool OAIGetMembersResponse::is_member_details_Set() const{
    return m_member_details_isSet;
}

bool OAIGetMembersResponse::is_member_details_Valid() const{
    return m_member_details_isValid;
}

QList OAIGetMembersResponse::getUnprocessedAccounts() const {
    return m_unprocessed_accounts;
}
void OAIGetMembersResponse::setUnprocessedAccounts(const QList &unprocessed_accounts) {
    m_unprocessed_accounts = unprocessed_accounts;
    m_unprocessed_accounts_isSet = true;
}

bool OAIGetMembersResponse::is_unprocessed_accounts_Set() const{
    return m_unprocessed_accounts_isSet;
}

bool OAIGetMembersResponse::is_unprocessed_accounts_Valid() const{
    return m_unprocessed_accounts_isValid;
}

bool OAIGetMembersResponse::isSet() const {
...
bool OAIGetMembersResponse::isValid() const {
