...
/*
 * OAIBatchGetGraphMemberDatasources_request.h
 *
 * 
 */

#ifndef OAIBatchGetGraphMemberDatasources_request_H
#define OAIBatchGetGraphMemberDatasources_request_H
...
class OAIBatchGetGraphMemberDatasources_request : public OAIObject {
public:
    OAIBatchGetGraphMemberDatasources_request();
    OAIBatchGetGraphMemberDatasources_request(QString json);
    ~OAIBatchGetGraphMemberDatasources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetGraphMemberDatasources_request)

#endif // OAIBatchGetGraphMemberDatasources_request_H
