...
/*
 * OAIGetMembersResponse.h
 *
 * 
 */

#ifndef OAIGetMembersResponse_H
#define OAIGetMembersResponse_H
...
class OAIGetMembersResponse : public OAIObject {
public:
    OAIGetMembersResponse();
    OAIGetMembersResponse(QString json);
    ~OAIGetMembersResponse() override;
    ...
    QList getMemberDetails() const;
    void setMemberDetails(const QList &member_details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMembersResponse)

#endif // OAIGetMembersResponse_H
