...
/*
 * OAIListGraphs_request.h
 *
 * 
 */

#ifndef OAIListGraphs_request_H
#define OAIListGraphs_request_H
...
class OAIListGraphs_request : public OAIObject {
public:
    OAIListGraphs_request();
    OAIListGraphs_request(QString json);
    ~OAIListGraphs_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGraphs_request)

#endif // OAIListGraphs_request_H
