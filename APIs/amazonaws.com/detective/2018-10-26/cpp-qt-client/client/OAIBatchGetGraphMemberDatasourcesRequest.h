...
/*
 * OAIBatchGetGraphMemberDatasourcesRequest.h
 *
 * 
 */

#ifndef OAIBatchGetGraphMemberDatasourcesRequest_H
#define OAIBatchGetGraphMemberDatasourcesRequest_H
...
class OAIBatchGetGraphMemberDatasourcesRequest : public OAIObject {
public:
    OAIBatchGetGraphMemberDatasourcesRequest();
    OAIBatchGetGraphMemberDatasourcesRequest(QString json);
    ~OAIBatchGetGraphMemberDatasourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetGraphMemberDatasourcesRequest)

#endif // OAIBatchGetGraphMemberDatasourcesRequest_H
