...
OAIDeleteMembers_request::OAIDeleteMembers_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMembers_request::OAIDeleteMembers_request() {
    this->initializeModel();
}

OAIDeleteMembers_request::~OAIDeleteMembers_request() {}

void OAIDeleteMembers_request::initializeModel() {
...
void OAIDeleteMembers_request::fromJson(QString jsonString) {
...
void OAIDeleteMembers_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMembers_request::asJson() const {
...
QJsonObject OAIDeleteMembers_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteMembers_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIDeleteMembers_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIDeleteMembers_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIDeleteMembers_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QList<QString> OAIDeleteMembers_request::getAccountIds() const {
    return m_account_ids;
}
void OAIDeleteMembers_request::setAccountIds(const QList<QString> &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIDeleteMembers_request::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIDeleteMembers_request::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

bool OAIDeleteMembers_request::isSet() const {
...
bool OAIDeleteMembers_request::isValid() const {
