...
/*
 * OAIEnableOrganizationAdminAccount_request.h
 *
 * 
 */

#ifndef OAIEnableOrganizationAdminAccount_request_H
#define OAIEnableOrganizationAdminAccount_request_H
...
class OAIEnableOrganizationAdminAccount_request : public OAIObject {
public:
    OAIEnableOrganizationAdminAccount_request();
    OAIEnableOrganizationAdminAccount_request(QString json);
    ~OAIEnableOrganizationAdminAccount_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableOrganizationAdminAccount_request)

#endif // OAIEnableOrganizationAdminAccount_request_H
