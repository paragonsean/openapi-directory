...
/*
 * OAIUpdateDatasourcePackagesRequest.h
 *
 * 
 */

#ifndef OAIUpdateDatasourcePackagesRequest_H
#define OAIUpdateDatasourcePackagesRequest_H
...
class OAIUpdateDatasourcePackagesRequest : public OAIObject {
public:
    OAIUpdateDatasourcePackagesRequest();
    OAIUpdateDatasourcePackagesRequest(QString json);
    ~OAIUpdateDatasourcePackagesRequest() override;
    ...
    QList getDatasourcePackages() const;
    void setDatasourcePackages(const QList &datasource_packages);
    bool is_datasource_packages_Set() const;
    bool is_datasource_packages_Valid() const;
...
private:
    ...
    QList m_datasource_packages;
    bool m_datasource_packages_isSet;
    bool m_datasource_packages_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDatasourcePackagesRequest)

#endif // OAIUpdateDatasourcePackagesRequest_H
