...
QString OAIEnableOrganizationAdminAccountRequest::getAccountId() const {
    return m_account_id;
}
void OAIEnableOrganizationAdminAccountRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIEnableOrganizationAdminAccountRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIEnableOrganizationAdminAccountRequest::is_account_id_Valid() const{
