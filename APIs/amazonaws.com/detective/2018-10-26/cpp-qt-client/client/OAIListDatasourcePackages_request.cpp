...
OAIListDatasourcePackages_request::OAIListDatasourcePackages_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatasourcePackages_request::OAIListDatasourcePackages_request() {
    this->initializeModel();
}

OAIListDatasourcePackages_request::~OAIListDatasourcePackages_request() {}

void OAIListDatasourcePackages_request::initializeModel() {
...
void OAIListDatasourcePackages_request::fromJson(QString jsonString) {
...
void OAIListDatasourcePackages_request::fromJsonObject(QJsonObject json) {
...
QString OAIListDatasourcePackages_request::asJson() const {
...
QJsonObject OAIListDatasourcePackages_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListDatasourcePackages_request::getGraphArn() const {
    return m_graph_arn;
}
void OAIListDatasourcePackages_request::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIListDatasourcePackages_request::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIListDatasourcePackages_request::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

QString OAIListDatasourcePackages_request::getNextToken() const {
    return m_next_token;
}
void OAIListDatasourcePackages_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatasourcePackages_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatasourcePackages_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListDatasourcePackages_request::getMaxResults() const {
    return m_max_results;
}
void OAIListDatasourcePackages_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDatasourcePackages_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDatasourcePackages_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListDatasourcePackages_request::isSet() const {
...
bool OAIListDatasourcePackages_request::isValid() const {
