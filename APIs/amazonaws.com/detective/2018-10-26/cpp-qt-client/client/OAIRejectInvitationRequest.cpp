...
#include "OAIRejectInvitationRequest.h"
...
OAIRejectInvitationRequest::OAIRejectInvitationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRejectInvitationRequest::OAIRejectInvitationRequest() {
    this->initializeModel();
}

OAIRejectInvitationRequest::~OAIRejectInvitationRequest() {}

void OAIRejectInvitationRequest::initializeModel() {

    m_graph_arn_isSet = false;
    m_graph_arn_isValid = false;
}

void OAIRejectInvitationRequest::fromJson(QString jsonString) {
...
void OAIRejectInvitationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIRejectInvitationRequest::asJson() const {
...
QJsonObject OAIRejectInvitationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRejectInvitationRequest::getGraphArn() const {
    return m_graph_arn;
}
void OAIRejectInvitationRequest::setGraphArn(const QString &graph_arn) {
    m_graph_arn = graph_arn;
    m_graph_arn_isSet = true;
}

bool OAIRejectInvitationRequest::is_graph_arn_Set() const{
    return m_graph_arn_isSet;
}

bool OAIRejectInvitationRequest::is_graph_arn_Valid() const{
    return m_graph_arn_isValid;
}

bool OAIRejectInvitationRequest::isSet() const {
...
bool OAIRejectInvitationRequest::isValid() const {
