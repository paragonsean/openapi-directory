...
/**
 * Gets or Sets MemberDisabledReason
 */
@JsonAdapter(MemberDisabledReason.Adapter.class)
public enum MemberDisabledReason {
  
  TOO_HIGH("VOLUME_TOO_HIGH"),
  
  UNKNOWN("VOLUME_UNKNOWN");

  private String value;

  MemberDisabledReason(String value) {
    this.value = value;
  }
  ...
  public static MemberDisabledReason fromValue(String value) {
    for (MemberDisabledReason b : MemberDisabledReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<MemberDisabledReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final MemberDisabledReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MemberDisabledReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MemberDisabledReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MemberDisabledReason.fromValue(value);
  }
}
