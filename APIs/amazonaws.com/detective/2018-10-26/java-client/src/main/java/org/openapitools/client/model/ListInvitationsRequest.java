...
public class ListInvitationsRequest {
  ...
  public ListInvitationsRequest nextToken(String nextToken) {
  ...
  public ListInvitationsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listInvitationsRequest.nextToken) &&
        Objects.equals(this.maxResults, listInvitationsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListInvitationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListInvitationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListInvitationsRequest is not found in the empty JSON string", ListInvitationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListInvitationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListInvitationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListInvitationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListInvitationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListInvitationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListInvitationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListInvitationsRequest>() {
           @Override
           public void write(JsonWriter out, ListInvitationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListInvitationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListInvitationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListInvitationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListInvitationsRequest
   */
  public static ListInvitationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInvitationsRequest.class);
  }

  /**
   * Convert an instance of ListInvitationsRequest to an JSON string
   *
   * @return JSON string
   */
