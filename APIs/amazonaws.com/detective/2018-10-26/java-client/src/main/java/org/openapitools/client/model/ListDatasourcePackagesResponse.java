...
public class ListDatasourcePackagesResponse {
  ...
  private Map datasourcePackages;
  ...
  public ListDatasourcePackagesResponse datasourcePackages(Map datasourcePackages) {
    this.datasourcePackages = datasourcePackages;
    return this;
  }

  /**
   * Get datasourcePackages
   * @return datasourcePackages
   */
  @javax.annotation.Nullable
  public Map getDatasourcePackages() {
    return datasourcePackages;
  }

  public void setDatasourcePackages(Map datasourcePackages) {
    this.datasourcePackages = datasourcePackages;
  }


  public ListDatasourcePackagesResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListDatasourcePackagesResponse listDatasourcePackagesResponse = (ListDatasourcePackagesResponse) o;
    return Objects.equals(this.datasourcePackages, listDatasourcePackagesResponse.datasourcePackages) &&
        Objects.equals(this.nextToken, listDatasourcePackagesResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datasourcePackages, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListDatasourcePackagesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDatasourcePackagesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDatasourcePackagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDatasourcePackagesResponse is not found in the empty JSON string", ListDatasourcePackagesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDatasourcePackagesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDatasourcePackagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `DatasourcePackages`
      if (jsonObj.get("DatasourcePackages") != null && !jsonObj.get("DatasourcePackages").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("DatasourcePackages"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDatasourcePackagesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDatasourcePackagesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDatasourcePackagesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDatasourcePackagesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDatasourcePackagesResponse>() {
           @Override
           public void write(JsonWriter out, ListDatasourcePackagesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDatasourcePackagesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDatasourcePackagesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDatasourcePackagesResponse
   * @throws IOException if the JSON string is invalid with respect to ListDatasourcePackagesResponse
   */
  public static ListDatasourcePackagesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDatasourcePackagesResponse.class);
  }

  /**
   * Convert an instance of ListDatasourcePackagesResponse to an JSON string
   *
   * @return JSON string
   */
