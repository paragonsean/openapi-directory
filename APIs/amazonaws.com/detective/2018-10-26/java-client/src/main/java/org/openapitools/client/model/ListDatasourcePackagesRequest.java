...
public class ListDatasourcePackagesRequest {
  ...
  public ListDatasourcePackagesRequest() {
  }

  public ListDatasourcePackagesRequest graphArn(String graphArn) {
  ...
  public ListDatasourcePackagesRequest nextToken(String nextToken) {
  ...
  public ListDatasourcePackagesRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListDatasourcePackagesRequest listDatasourcePackagesRequest = (ListDatasourcePackagesRequest) o;
    return Objects.equals(this.graphArn, listDatasourcePackagesRequest.graphArn) &&
        Objects.equals(this.nextToken, listDatasourcePackagesRequest.nextToken) &&
        Objects.equals(this.maxResults, listDatasourcePackagesRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graphArn, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListDatasourcePackagesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDatasourcePackagesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDatasourcePackagesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDatasourcePackagesRequest is not found in the empty JSON string", ListDatasourcePackagesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDatasourcePackagesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDatasourcePackagesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListDatasourcePackagesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDatasourcePackagesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDatasourcePackagesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDatasourcePackagesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDatasourcePackagesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDatasourcePackagesRequest>() {
           @Override
           public void write(JsonWriter out, ListDatasourcePackagesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDatasourcePackagesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDatasourcePackagesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDatasourcePackagesRequest
   * @throws IOException if the JSON string is invalid with respect to ListDatasourcePackagesRequest
   */
  public static ListDatasourcePackagesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDatasourcePackagesRequest.class);
  }

  /**
   * Convert an instance of ListDatasourcePackagesRequest to an JSON string
   *
   * @return JSON string
   */
