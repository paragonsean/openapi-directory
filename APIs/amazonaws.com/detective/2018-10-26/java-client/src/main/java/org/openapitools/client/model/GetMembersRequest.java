...
public class GetMembersRequest {
  ...
  public GetMembersRequest graphArn(String graphArn) {
  ...
  public GetMembersRequest accountIds(List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public GetMembersRequest addAccountIdsItem(String accountIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetMembersRequest getMembersRequest = (GetMembersRequest) o;
    return Objects.equals(this.graphArn, getMembersRequest.graphArn) &&
        Objects.equals(this.accountIds, getMembersRequest.accountIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graphArn, accountIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetMembersRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMembersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMembersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetMembersRequest is not found in the empty JSON string", GetMembersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMembersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMembersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetMembersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMembersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMembersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMembersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMembersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMembersRequest>() {
           @Override
           public void write(JsonWriter out, GetMembersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMembersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMembersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMembersRequest
   * @throws IOException if the JSON string is invalid with respect to GetMembersRequest
   */
  public static GetMembersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMembersRequest.class);
  }

  /**
   * Convert an instance of GetMembersRequest to an JSON string
   *
   * @return JSON string
   */
