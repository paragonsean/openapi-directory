...
/**
 * Gets or Sets DatasourcePackageIngestState
 */
@JsonAdapter(DatasourcePackageIngestState.Adapter.class)
public enum DatasourcePackageIngestState {
  ...
  DatasourcePackageIngestState(String value) {
    this.value = value;
  }
  ...
  public static DatasourcePackageIngestState fromValue(String value) {
    for (DatasourcePackageIngestState b : DatasourcePackageIngestState.values()) {
  ...
  public static class Adapter extends TypeAdapter<DatasourcePackageIngestState> {
    @Override
    public void write(final JsonWriter jsonWriter, final DatasourcePackageIngestState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DatasourcePackageIngestState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DatasourcePackageIngestState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DatasourcePackageIngestState.fromValue(value);
  }
}
