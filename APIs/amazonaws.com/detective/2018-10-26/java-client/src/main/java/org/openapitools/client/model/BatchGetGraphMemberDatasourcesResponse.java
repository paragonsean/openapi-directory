...
public class BatchGetGraphMemberDatasourcesResponse {
  public static final String SERIALIZED_NAME_MEMBER_DATASOURCES = "MemberDatasources";
  @SerializedName(SERIALIZED_NAME_MEMBER_DATASOURCES)
  private List memberDatasources;
  ...
  public BatchGetGraphMemberDatasourcesResponse memberDatasources(List memberDatasources) {
    this.memberDatasources = memberDatasources;
    return this;
  }

  /**
   * Get memberDatasources
   * @return memberDatasources
   */
  @javax.annotation.Nullable
  public List getMemberDatasources() {
    return memberDatasources;
  }

  public void setMemberDatasources(List memberDatasources) {
    this.memberDatasources = memberDatasources;
  }


  public BatchGetGraphMemberDatasourcesResponse unprocessedAccounts(List unprocessedAccounts) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetGraphMemberDatasourcesResponse batchGetGraphMemberDatasourcesResponse = (BatchGetGraphMemberDatasourcesResponse) o;
    return Objects.equals(this.memberDatasources, batchGetGraphMemberDatasourcesResponse.memberDatasources) &&
        Objects.equals(this.unprocessedAccounts, batchGetGraphMemberDatasourcesResponse.unprocessedAccounts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memberDatasources, unprocessedAccounts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetGraphMemberDatasourcesResponse {\n");
    sb.append("    memberDatasources: ").append(toIndentedString(memberDatasources)).append("\n");
  ...
  static {
    ...
    openapiFields.add("MemberDatasources");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetGraphMemberDatasourcesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetGraphMemberDatasourcesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetGraphMemberDatasourcesResponse is not found in the empty JSON string", BatchGetGraphMemberDatasourcesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetGraphMemberDatasourcesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetGraphMemberDatasourcesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MemberDatasources`
      if (jsonObj.get("MemberDatasources") != null && !jsonObj.get("MemberDatasources").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("MemberDatasources"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetGraphMemberDatasourcesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetGraphMemberDatasourcesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetGraphMemberDatasourcesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetGraphMemberDatasourcesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetGraphMemberDatasourcesResponse>() {
           @Override
           public void write(JsonWriter out, BatchGetGraphMemberDatasourcesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetGraphMemberDatasourcesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetGraphMemberDatasourcesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetGraphMemberDatasourcesResponse
   * @throws IOException if the JSON string is invalid with respect to BatchGetGraphMemberDatasourcesResponse
   */
  public static BatchGetGraphMemberDatasourcesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetGraphMemberDatasourcesResponse.class);
  }

  /**
   * Convert an instance of BatchGetGraphMemberDatasourcesResponse to an JSON string
   *
   * @return JSON string
   */
