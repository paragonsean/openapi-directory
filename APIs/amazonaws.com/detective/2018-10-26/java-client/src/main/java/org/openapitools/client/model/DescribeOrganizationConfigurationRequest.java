...
public class DescribeOrganizationConfigurationRequest {
  ...
  public DescribeOrganizationConfigurationRequest graphArn(String graphArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeOrganizationConfigurationRequest describeOrganizationConfigurationRequest = (DescribeOrganizationConfigurationRequest) o;
    return Objects.equals(this.graphArn, describeOrganizationConfigurationRequest.graphArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeOrganizationConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeOrganizationConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeOrganizationConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeOrganizationConfigurationRequest is not found in the empty JSON string", DescribeOrganizationConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeOrganizationConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeOrganizationConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeOrganizationConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeOrganizationConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeOrganizationConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeOrganizationConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeOrganizationConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeOrganizationConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DescribeOrganizationConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeOrganizationConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeOrganizationConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeOrganizationConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeOrganizationConfigurationRequest
   */
  public static DescribeOrganizationConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeOrganizationConfigurationRequest.class);
  }

  /**
   * Convert an instance of DescribeOrganizationConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
