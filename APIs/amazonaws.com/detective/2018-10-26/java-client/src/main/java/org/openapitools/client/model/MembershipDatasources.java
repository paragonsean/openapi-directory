...
public class MembershipDatasources {
  ...
  public static final String SERIALIZED_NAME_DATASOURCE_PACKAGE_INGEST_HISTORY = "DatasourcePackageIngestHistory";
  @SerializedName(SERIALIZED_NAME_DATASOURCE_PACKAGE_INGEST_HISTORY)
  private Map datasourcePackageIngestHistory;

  public MembershipDatasources() {
  }

  public MembershipDatasources accountId(String accountId) {
  ...
  public MembershipDatasources graphArn(String graphArn) {
  ...
  public MembershipDatasources datasourcePackageIngestHistory(Map datasourcePackageIngestHistory) {
    this.datasourcePackageIngestHistory = datasourcePackageIngestHistory;
    return this;
  }

  /**
   * Get datasourcePackageIngestHistory
   * @return datasourcePackageIngestHistory
   */
  @javax.annotation.Nullable
  public Map getDatasourcePackageIngestHistory() {
    return datasourcePackageIngestHistory;
  }

  public void setDatasourcePackageIngestHistory(Map datasourcePackageIngestHistory) {
    this.datasourcePackageIngestHistory = datasourcePackageIngestHistory;
  }
  ...
  public boolean equals(Object o) {
    ...
    MembershipDatasources membershipDatasources = (MembershipDatasources) o;
    return Objects.equals(this.accountId, membershipDatasources.accountId) &&
        Objects.equals(this.graphArn, membershipDatasources.graphArn) &&
        Objects.equals(this.datasourcePackageIngestHistory, membershipDatasources.datasourcePackageIngestHistory);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, graphArn, datasourcePackageIngestHistory);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MembershipDatasources {\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    graphArn: ").append(toIndentedString(graphArn)).append("\n");
    sb.append("    datasourcePackageIngestHistory: ").append(toIndentedString(datasourcePackageIngestHistory)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DatasourcePackageIngestHistory");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MembershipDatasources
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MembershipDatasources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MembershipDatasources is not found in the empty JSON string", MembershipDatasources.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MembershipDatasources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MembershipDatasources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `DatasourcePackageIngestHistory`
      if (jsonObj.get("DatasourcePackageIngestHistory") != null && !jsonObj.get("DatasourcePackageIngestHistory").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("DatasourcePackageIngestHistory"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipDatasources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipDatasources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipDatasources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipDatasources.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipDatasources>() {
           @Override
           public void write(JsonWriter out, MembershipDatasources value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MembershipDatasources read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MembershipDatasources given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MembershipDatasources
   * @throws IOException if the JSON string is invalid with respect to MembershipDatasources
   */
  public static MembershipDatasources fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipDatasources.class);
  }

  /**
   * Convert an instance of MembershipDatasources to an JSON string
   *
   * @return JSON string
   */
