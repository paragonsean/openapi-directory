...
public class DeleteGraphRequest {
  ...
  public DeleteGraphRequest graphArn(String graphArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.graphArn, deleteGraphRequest.graphArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteGraphRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteGraphRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteGraphRequest is not found in the empty JSON string", DeleteGraphRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteGraphRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteGraphRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteGraphRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteGraphRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteGraphRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteGraphRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteGraphRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteGraphRequest>() {
           @Override
           public void write(JsonWriter out, DeleteGraphRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteGraphRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteGraphRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteGraphRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteGraphRequest
   */
  public static DeleteGraphRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteGraphRequest.class);
  }

  /**
   * Convert an instance of DeleteGraphRequest to an JSON string
   *
   * @return JSON string
   */
