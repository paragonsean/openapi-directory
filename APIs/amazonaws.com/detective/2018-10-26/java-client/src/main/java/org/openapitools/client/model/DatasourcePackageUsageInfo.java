...
public class DatasourcePackageUsageInfo {
  ...
  public static final String SERIALIZED_NAME_VOLUME_USAGE_UPDATE_TIME = "VolumeUsageUpdateTime";
  @SerializedName(SERIALIZED_NAME_VOLUME_USAGE_UPDATE_TIME)
  private OffsetDateTime volumeUsageUpdateTime;

  public DatasourcePackageUsageInfo() {
  }

  public DatasourcePackageUsageInfo volumeUsageInBytes(Integer volumeUsageInBytes) {
  ...
  public DatasourcePackageUsageInfo volumeUsageUpdateTime(OffsetDateTime volumeUsageUpdateTime) {
    this.volumeUsageUpdateTime = volumeUsageUpdateTime;
    return this;
  }

  /**
   * Get volumeUsageUpdateTime
   * @return volumeUsageUpdateTime
   */
  @javax.annotation.Nullable
  public OffsetDateTime getVolumeUsageUpdateTime() {
    return volumeUsageUpdateTime;
  }

  public void setVolumeUsageUpdateTime(OffsetDateTime volumeUsageUpdateTime) {
    this.volumeUsageUpdateTime = volumeUsageUpdateTime;
  }
  ...
  public boolean equals(Object o) {
    ...
    DatasourcePackageUsageInfo datasourcePackageUsageInfo = (DatasourcePackageUsageInfo) o;
    return Objects.equals(this.volumeUsageInBytes, datasourcePackageUsageInfo.volumeUsageInBytes) &&
        Objects.equals(this.volumeUsageUpdateTime, datasourcePackageUsageInfo.volumeUsageUpdateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volumeUsageInBytes, volumeUsageUpdateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatasourcePackageUsageInfo {\n");
    sb.append("    volumeUsageInBytes: ").append(toIndentedString(volumeUsageInBytes)).append("\n");
    sb.append("    volumeUsageUpdateTime: ").append(toIndentedString(volumeUsageUpdateTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("VolumeUsageUpdateTime");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasourcePackageUsageInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasourcePackageUsageInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasourcePackageUsageInfo is not found in the empty JSON string", DatasourcePackageUsageInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasourcePackageUsageInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasourcePackageUsageInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `VolumeUsageUpdateTime`
      if (jsonObj.get("VolumeUsageUpdateTime") != null && !jsonObj.get("VolumeUsageUpdateTime").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("VolumeUsageUpdateTime"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasourcePackageUsageInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasourcePackageUsageInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasourcePackageUsageInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasourcePackageUsageInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasourcePackageUsageInfo>() {
           @Override
           public void write(JsonWriter out, DatasourcePackageUsageInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasourcePackageUsageInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasourcePackageUsageInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasourcePackageUsageInfo
   * @throws IOException if the JSON string is invalid with respect to DatasourcePackageUsageInfo
   */
  public static DatasourcePackageUsageInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasourcePackageUsageInfo.class);
  }

  /**
   * Convert an instance of DatasourcePackageUsageInfo to an JSON string
   *
   * @return JSON string
   */
