...
public class StartMonitoringMemberRequest {
  ...
  public StartMonitoringMemberRequest() {
  }

  public StartMonitoringMemberRequest graphArn(String graphArn) {
  ...
  public StartMonitoringMemberRequest accountId(String accountId) {
  ...
  public boolean equals(Object o) {
    ...
    StartMonitoringMemberRequest startMonitoringMemberRequest = (StartMonitoringMemberRequest) o;
    return Objects.equals(this.graphArn, startMonitoringMemberRequest.graphArn) &&
        Objects.equals(this.accountId, startMonitoringMemberRequest.accountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graphArn, accountId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartMonitoringMemberRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartMonitoringMemberRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartMonitoringMemberRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartMonitoringMemberRequest is not found in the empty JSON string", StartMonitoringMemberRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartMonitoringMemberRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartMonitoringMemberRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartMonitoringMemberRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartMonitoringMemberRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartMonitoringMemberRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartMonitoringMemberRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartMonitoringMemberRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartMonitoringMemberRequest>() {
           @Override
           public void write(JsonWriter out, StartMonitoringMemberRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartMonitoringMemberRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartMonitoringMemberRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartMonitoringMemberRequest
   * @throws IOException if the JSON string is invalid with respect to StartMonitoringMemberRequest
   */
  public static StartMonitoringMemberRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartMonitoringMemberRequest.class);
  }

  /**
   * Convert an instance of StartMonitoringMemberRequest to an JSON string
   *
   * @return JSON string
   */
