...
public class BatchGetGraphMemberDatasourcesRequest {
  ...
  public BatchGetGraphMemberDatasourcesRequest graphArn(String graphArn) {
  ...
  public BatchGetGraphMemberDatasourcesRequest accountIds(List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public BatchGetGraphMemberDatasourcesRequest addAccountIdsItem(String accountIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetGraphMemberDatasourcesRequest batchGetGraphMemberDatasourcesRequest = (BatchGetGraphMemberDatasourcesRequest) o;
    return Objects.equals(this.graphArn, batchGetGraphMemberDatasourcesRequest.graphArn) &&
        Objects.equals(this.accountIds, batchGetGraphMemberDatasourcesRequest.accountIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchGetGraphMemberDatasourcesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetGraphMemberDatasourcesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetGraphMemberDatasourcesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetGraphMemberDatasourcesRequest is not found in the empty JSON string", BatchGetGraphMemberDatasourcesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetGraphMemberDatasourcesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetGraphMemberDatasourcesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetGraphMemberDatasourcesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetGraphMemberDatasourcesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetGraphMemberDatasourcesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetGraphMemberDatasourcesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetGraphMemberDatasourcesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetGraphMemberDatasourcesRequest>() {
           @Override
           public void write(JsonWriter out, BatchGetGraphMemberDatasourcesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetGraphMemberDatasourcesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetGraphMemberDatasourcesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetGraphMemberDatasourcesRequest
   * @throws IOException if the JSON string is invalid with respect to BatchGetGraphMemberDatasourcesRequest
   */
  public static BatchGetGraphMemberDatasourcesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetGraphMemberDatasourcesRequest.class);
  }

  /**
   * Convert an instance of BatchGetGraphMemberDatasourcesRequest to an JSON string
   *
   * @return JSON string
   */
