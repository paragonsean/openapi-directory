...
public class RejectInvitationRequest {
  ...
  public RejectInvitationRequest graphArn(String graphArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.graphArn, rejectInvitationRequest.graphArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RejectInvitationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RejectInvitationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RejectInvitationRequest is not found in the empty JSON string", RejectInvitationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RejectInvitationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RejectInvitationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RejectInvitationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RejectInvitationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RejectInvitationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RejectInvitationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RejectInvitationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RejectInvitationRequest>() {
           @Override
           public void write(JsonWriter out, RejectInvitationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RejectInvitationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RejectInvitationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RejectInvitationRequest
   * @throws IOException if the JSON string is invalid with respect to RejectInvitationRequest
   */
  public static RejectInvitationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RejectInvitationRequest.class);
  }

  /**
   * Convert an instance of RejectInvitationRequest to an JSON string
   *
   * @return JSON string
   */
