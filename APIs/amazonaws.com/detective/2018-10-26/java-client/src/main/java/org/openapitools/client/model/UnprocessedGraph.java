...
public class UnprocessedGraph {
  ...
  public UnprocessedGraph graphArn(String graphArn) {
  ...
  public UnprocessedGraph reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UnprocessedGraph unprocessedGraph = (UnprocessedGraph) o;
    return Objects.equals(this.graphArn, unprocessedGraph.graphArn) &&
        Objects.equals(this.reason, unprocessedGraph.reason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graphArn, reason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnprocessedGraph {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnprocessedGraph
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnprocessedGraph.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnprocessedGraph is not found in the empty JSON string", UnprocessedGraph.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnprocessedGraph.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnprocessedGraph` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnprocessedGraph.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnprocessedGraph' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnprocessedGraph> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnprocessedGraph.class));

       return (TypeAdapter<T>) new TypeAdapter<UnprocessedGraph>() {
           @Override
           public void write(JsonWriter out, UnprocessedGraph value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnprocessedGraph read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnprocessedGraph given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnprocessedGraph
   * @throws IOException if the JSON string is invalid with respect to UnprocessedGraph
   */
  public static UnprocessedGraph fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnprocessedGraph.class);
  }

  /**
   * Convert an instance of UnprocessedGraph to an JSON string
   *
   * @return JSON string
   */
