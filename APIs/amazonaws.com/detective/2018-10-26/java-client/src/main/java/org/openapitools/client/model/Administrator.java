...
public class Administrator {
  ...
  public static final String SERIALIZED_NAME_DELEGATION_TIME = "DelegationTime";
  @SerializedName(SERIALIZED_NAME_DELEGATION_TIME)
  private OffsetDateTime delegationTime;

  public Administrator() {
  }

  public Administrator accountId(String accountId) {
  ...
  public Administrator graphArn(String graphArn) {
  ...
  public Administrator delegationTime(OffsetDateTime delegationTime) {
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getDelegationTime() {
    return delegationTime;
  }

  public void setDelegationTime(OffsetDateTime delegationTime) {
    this.delegationTime = delegationTime;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, administrator.accountId) &&
        Objects.equals(this.graphArn, administrator.graphArn) &&
        Objects.equals(this.delegationTime, administrator.delegationTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, graphArn, delegationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    delegationTime: ").append(toIndentedString(delegationTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DelegationTime");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Administrator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Administrator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Administrator is not found in the empty JSON string", Administrator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Administrator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Administrator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `DelegationTime`
      if (jsonObj.get("DelegationTime") != null && !jsonObj.get("DelegationTime").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("DelegationTime"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Administrator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Administrator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Administrator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Administrator.class));

       return (TypeAdapter<T>) new TypeAdapter<Administrator>() {
           @Override
           public void write(JsonWriter out, Administrator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Administrator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Administrator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Administrator
   * @throws IOException if the JSON string is invalid with respect to Administrator
   */
  public static Administrator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Administrator.class);
  }

  /**
   * Convert an instance of Administrator to an JSON string
   *
   * @return JSON string
   */
