...
public class ListOrganizationAdminAccountsRequest {
  ...
  public ListOrganizationAdminAccountsRequest nextToken(String nextToken) {
  ...
  public ListOrganizationAdminAccountsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListOrganizationAdminAccountsRequest listOrganizationAdminAccountsRequest = (ListOrganizationAdminAccountsRequest) o;
    return Objects.equals(this.nextToken, listOrganizationAdminAccountsRequest.nextToken) &&
        Objects.equals(this.maxResults, listOrganizationAdminAccountsRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListOrganizationAdminAccountsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListOrganizationAdminAccountsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListOrganizationAdminAccountsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListOrganizationAdminAccountsRequest is not found in the empty JSON string", ListOrganizationAdminAccountsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListOrganizationAdminAccountsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListOrganizationAdminAccountsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListOrganizationAdminAccountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListOrganizationAdminAccountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListOrganizationAdminAccountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListOrganizationAdminAccountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListOrganizationAdminAccountsRequest>() {
           @Override
           public void write(JsonWriter out, ListOrganizationAdminAccountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListOrganizationAdminAccountsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListOrganizationAdminAccountsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListOrganizationAdminAccountsRequest
   * @throws IOException if the JSON string is invalid with respect to ListOrganizationAdminAccountsRequest
   */
  public static ListOrganizationAdminAccountsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOrganizationAdminAccountsRequest.class);
  }

  /**
   * Convert an instance of ListOrganizationAdminAccountsRequest to an JSON string
   *
   * @return JSON string
   */
