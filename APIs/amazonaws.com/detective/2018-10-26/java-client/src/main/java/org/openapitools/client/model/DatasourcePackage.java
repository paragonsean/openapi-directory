...
/**
 * Gets or Sets DatasourcePackage
 */
@JsonAdapter(DatasourcePackage.Adapter.class)
public enum DatasourcePackage {
  ...
  DatasourcePackage(String value) {
    this.value = value;
  }
  ...
  public static DatasourcePackage fromValue(String value) {
    for (DatasourcePackage b : DatasourcePackage.values()) {
  ...
  public static class Adapter extends TypeAdapter<DatasourcePackage> {
    @Override
    public void write(final JsonWriter jsonWriter, final DatasourcePackage enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DatasourcePackage read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DatasourcePackage.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DatasourcePackage.fromValue(value);
  }
}
