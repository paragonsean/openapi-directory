...
public class ListGraphsRequest {
  ...
  public ListGraphsRequest() {
  }

  public ListGraphsRequest nextToken(String nextToken) {
  ...
  public ListGraphsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listGraphsRequest.nextToken) &&
        Objects.equals(this.maxResults, listGraphsRequest.maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGraphsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGraphsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGraphsRequest is not found in the empty JSON string", ListGraphsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGraphsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGraphsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGraphsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGraphsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGraphsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGraphsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGraphsRequest>() {
           @Override
           public void write(JsonWriter out, ListGraphsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGraphsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGraphsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGraphsRequest
   * @throws IOException if the JSON string is invalid with respect to ListGraphsRequest
   */
  public static ListGraphsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGraphsRequest.class);
  }

  /**
   * Convert an instance of ListGraphsRequest to an JSON string
   *
   * @return JSON string
   */
