...
public class TimestampForCollection {
  ...
  public TimestampForCollection timestamp(OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    TimestampForCollection timestampForCollection = (TimestampForCollection) o;
    return Objects.equals(this.timestamp, timestampForCollection.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimestampForCollection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimestampForCollection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimestampForCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimestampForCollection is not found in the empty JSON string", TimestampForCollection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimestampForCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimestampForCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimestampForCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimestampForCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimestampForCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimestampForCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<TimestampForCollection>() {
           @Override
           public void write(JsonWriter out, TimestampForCollection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimestampForCollection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimestampForCollection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimestampForCollection
   * @throws IOException if the JSON string is invalid with respect to TimestampForCollection
   */
  public static TimestampForCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimestampForCollection.class);
  }

  /**
   * Convert an instance of TimestampForCollection to an JSON string
   *
   * @return JSON string
   */
