...
public class ListGraphsResponse {
  public static final String SERIALIZED_NAME_GRAPH_LIST = "GraphList";
  @SerializedName(SERIALIZED_NAME_GRAPH_LIST)
  ...
  public ListGraphsResponse graphList(List graphList) {
  ...
  public ListGraphsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.graphList, listGraphsResponse.graphList) &&
        Objects.equals(this.nextToken, listGraphsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(graphList, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListGraphsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGraphsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGraphsResponse is not found in the empty JSON string", ListGraphsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGraphsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGraphsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `GraphList`
      if (jsonObj.get("GraphList") != null && !jsonObj.get("GraphList").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("GraphList"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGraphsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGraphsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGraphsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGraphsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGraphsResponse>() {
           @Override
           public void write(JsonWriter out, ListGraphsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGraphsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListGraphsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListGraphsResponse
   * @throws IOException if the JSON string is invalid with respect to ListGraphsResponse
   */
  public static ListGraphsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGraphsResponse.class);
  }

  /**
   * Convert an instance of ListGraphsResponse to an JSON string
   *
   * @return JSON string
   */
