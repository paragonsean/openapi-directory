...
public class BatchGetChannelRequest {
  ...
  public BatchGetChannelRequest() {
  }

  public BatchGetChannelRequest arns(List<String> arns) {
    this.arns = arns;
    return this;
  }

  public BatchGetChannelRequest addArnsItem(String arnsItem) {
    if (this.arns == null) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetChannelRequest batchGetChannelRequest = (BatchGetChannelRequest) o;
    return Objects.equals(this.arns, batchGetChannelRequest.arns);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchGetChannelRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("arns");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetChannelRequest is not found in the empty JSON string", BatchGetChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetChannelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetChannelRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetChannelRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("arns") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("arns").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetChannelRequest>() {
           @Override
           public void write(JsonWriter out, BatchGetChannelRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetChannelRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetChannelRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetChannelRequest
   * @throws IOException if the JSON string is invalid with respect to BatchGetChannelRequest
   */
  public static BatchGetChannelRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetChannelRequest.class);
  }

  /**
   * Convert an instance of BatchGetChannelRequest to an JSON string
   *
   * @return JSON string
   */
