...
public class StreamSessionChannel {
  ...
  public StreamSessionChannel() {
  }

  public StreamSessionChannel arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StreamSessionChannel authorized(Boolean authorized) {
  ...
  public StreamSessionChannel ingestEndpoint(String ingestEndpoint) {
  ...
  public StreamSessionChannel insecureIngest(Boolean insecureIngest) {
  ...
  public StreamSessionChannel latencyMode(ChannelLatencyMode latencyMode) {
  ...
  public StreamSessionChannel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StreamSessionChannel playbackUrl(String playbackUrl) {
  ...
  public StreamSessionChannel preset(TranscodePreset preset) {
    this.preset = preset;
    return this;
  }
  ...
  public StreamSessionChannel recordingConfigurationArn(String recordingConfigurationArn) {
  ...
  public StreamSessionChannel tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StreamSessionChannel type(ChannelType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamSessionChannel streamSessionChannel = (StreamSessionChannel) o;
    return Objects.equals(this.arn, streamSessionChannel.arn) &&
        Objects.equals(this.authorized, streamSessionChannel.authorized) &&
        Objects.equals(this.ingestEndpoint, streamSessionChannel.ingestEndpoint) &&
        Objects.equals(this.insecureIngest, streamSessionChannel.insecureIngest) &&
        Objects.equals(this.latencyMode, streamSessionChannel.latencyMode) &&
        Objects.equals(this.name, streamSessionChannel.name) &&
        Objects.equals(this.playbackUrl, streamSessionChannel.playbackUrl) &&
        Objects.equals(this.preset, streamSessionChannel.preset) &&
        Objects.equals(this.recordingConfigurationArn, streamSessionChannel.recordingConfigurationArn) &&
        Objects.equals(this.tags, streamSessionChannel.tags) &&
        Objects.equals(this.type, streamSessionChannel.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamSessionChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSessionChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSessionChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSessionChannel is not found in the empty JSON string", StreamSessionChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSessionChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSessionChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSessionChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSessionChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSessionChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSessionChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSessionChannel>() {
           @Override
           public void write(JsonWriter out, StreamSessionChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSessionChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSessionChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSessionChannel
   * @throws IOException if the JSON string is invalid with respect to StreamSessionChannel
   */
  public static StreamSessionChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSessionChannel.class);
  }

  /**
   * Convert an instance of StreamSessionChannel to an JSON string
   *
   * @return JSON string
   */
