...
public class ListPlaybackKeyPairsResponse {
  ...
  public ListPlaybackKeyPairsResponse() {
  }

  public ListPlaybackKeyPairsResponse keyPairs(List keyPairs) {
  ...
  public ListPlaybackKeyPairsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPlaybackKeyPairsResponse listPlaybackKeyPairsResponse = (ListPlaybackKeyPairsResponse) o;
    return Objects.equals(this.keyPairs, listPlaybackKeyPairsResponse.keyPairs) &&
        Objects.equals(this.nextToken, listPlaybackKeyPairsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPlaybackKeyPairsResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("keyPairs");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPlaybackKeyPairsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPlaybackKeyPairsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPlaybackKeyPairsResponse is not found in the empty JSON string", ListPlaybackKeyPairsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPlaybackKeyPairsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPlaybackKeyPairsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPlaybackKeyPairsResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `keyPairs`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPlaybackKeyPairsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPlaybackKeyPairsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPlaybackKeyPairsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPlaybackKeyPairsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPlaybackKeyPairsResponse>() {
           @Override
           public void write(JsonWriter out, ListPlaybackKeyPairsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPlaybackKeyPairsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPlaybackKeyPairsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPlaybackKeyPairsResponse
   * @throws IOException if the JSON string is invalid with respect to ListPlaybackKeyPairsResponse
   */
  public static ListPlaybackKeyPairsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPlaybackKeyPairsResponse.class);
  }

  /**
   * Convert an instance of ListPlaybackKeyPairsResponse to an JSON string
   *
   * @return JSON string
   */
