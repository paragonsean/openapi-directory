...
import org.openapitools.client.model.CreateRecordingConfigurationRequestDestinationConfigurationS3;
...
public class CreateRecordingConfigurationRequestDestinationConfiguration {
  public static final String SERIALIZED_NAME_S3 = "s3";
  @SerializedName(SERIALIZED_NAME_S3)
  private CreateRecordingConfigurationRequestDestinationConfigurationS3 s3;

  public CreateRecordingConfigurationRequestDestinationConfiguration() {
  }

  public CreateRecordingConfigurationRequestDestinationConfiguration s3(CreateRecordingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public CreateRecordingConfigurationRequestDestinationConfigurationS3 getS3() {
    return s3;
  }

  public void setS3(CreateRecordingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationRequestDestinationConfiguration createRecordingConfigurationRequestDestinationConfiguration = (CreateRecordingConfigurationRequestDestinationConfiguration) o;
    return Objects.equals(this.s3, createRecordingConfigurationRequestDestinationConfiguration.s3);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRecordingConfigurationRequestDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationRequestDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationRequestDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationRequestDestinationConfiguration is not found in the empty JSON string", CreateRecordingConfigurationRequestDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationRequestDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationRequestDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `s3`
      if (jsonObj.get("s3") != null && !jsonObj.get("s3").isJsonNull()) {
        CreateRecordingConfigurationRequestDestinationConfigurationS3.validateJsonElement(jsonObj.get("s3"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationRequestDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationRequestDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationRequestDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationRequestDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationRequestDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationRequestDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationRequestDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationRequestDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationRequestDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationRequestDestinationConfiguration
   */
  public static CreateRecordingConfigurationRequestDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationRequestDestinationConfiguration.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationRequestDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
