...
public class StreamSessionSummary {
  ...
  public static final String SERIALIZED_NAME_HAS_ERROR_EVENT = "hasErrorEvent";
  @SerializedName(SERIALIZED_NAME_HAS_ERROR_EVENT)
  ...
  public StreamSessionSummary endTime(OffsetDateTime endTime) {
  ...
  public StreamSessionSummary hasErrorEvent(Boolean hasErrorEvent) {
  ...
  public StreamSessionSummary startTime(OffsetDateTime startTime) {
  ...
  public StreamSessionSummary streamId(String streamId) {
  ...
  public boolean equals(Object o) {
    ...
    StreamSessionSummary streamSessionSummary = (StreamSessionSummary) o;
    return Objects.equals(this.endTime, streamSessionSummary.endTime) &&
        Objects.equals(this.hasErrorEvent, streamSessionSummary.hasErrorEvent) &&
        Objects.equals(this.startTime, streamSessionSummary.startTime) &&
        Objects.equals(this.streamId, streamSessionSummary.streamId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endTime, hasErrorEvent, startTime, streamId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamSessionSummary {\n");
    sb.append("    endTime: ").append(toIndentedString(endTime)).append("\n");
    sb.append("    hasErrorEvent: ").append(toIndentedString(hasErrorEvent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("hasErrorEvent");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSessionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSessionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSessionSummary is not found in the empty JSON string", StreamSessionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSessionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSessionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `hasErrorEvent`
      if (jsonObj.get("hasErrorEvent") != null && !jsonObj.get("hasErrorEvent").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("hasErrorEvent"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSessionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSessionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSessionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSessionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSessionSummary>() {
           @Override
           public void write(JsonWriter out, StreamSessionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSessionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSessionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSessionSummary
   * @throws IOException if the JSON string is invalid with respect to StreamSessionSummary
   */
  public static StreamSessionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSessionSummary.class);
  }

  /**
   * Convert an instance of StreamSessionSummary to an JSON string
   *
   * @return JSON string
   */
