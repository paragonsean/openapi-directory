...
public class CreateStreamKeyResponseStreamKey {
  ...
  public CreateStreamKeyResponseStreamKey() {
  }

  public CreateStreamKeyResponseStreamKey arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateStreamKeyResponseStreamKey channelArn(String channelArn) {
  ...
  public CreateStreamKeyResponseStreamKey tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateStreamKeyResponseStreamKey value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamKeyResponseStreamKey createStreamKeyResponseStreamKey = (CreateStreamKeyResponseStreamKey) o;
    return Objects.equals(this.arn, createStreamKeyResponseStreamKey.arn) &&
        Objects.equals(this.channelArn, createStreamKeyResponseStreamKey.channelArn) &&
        Objects.equals(this.tags, createStreamKeyResponseStreamKey.tags) &&
        Objects.equals(this.value, createStreamKeyResponseStreamKey.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamKeyResponseStreamKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamKeyResponseStreamKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamKeyResponseStreamKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamKeyResponseStreamKey is not found in the empty JSON string", CreateStreamKeyResponseStreamKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamKeyResponseStreamKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamKeyResponseStreamKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamKeyResponseStreamKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamKeyResponseStreamKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamKeyResponseStreamKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamKeyResponseStreamKey.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamKeyResponseStreamKey>() {
           @Override
           public void write(JsonWriter out, CreateStreamKeyResponseStreamKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamKeyResponseStreamKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamKeyResponseStreamKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamKeyResponseStreamKey
   * @throws IOException if the JSON string is invalid with respect to CreateStreamKeyResponseStreamKey
   */
  public static CreateStreamKeyResponseStreamKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamKeyResponseStreamKey.class);
  }

  /**
   * Convert an instance of CreateStreamKeyResponseStreamKey to an JSON string
   *
   * @return JSON string
   */
