...
public class StreamKeySummary {
  ...
  public StreamKeySummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StreamKeySummary channelArn(String channelArn) {
  ...
  public StreamKeySummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamKeySummary streamKeySummary = (StreamKeySummary) o;
    return Objects.equals(this.arn, streamKeySummary.arn) &&
        Objects.equals(this.channelArn, streamKeySummary.channelArn) &&
        Objects.equals(this.tags, streamKeySummary.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, channelArn, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamKeySummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamKeySummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamKeySummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamKeySummary is not found in the empty JSON string", StreamKeySummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamKeySummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamKeySummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamKeySummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamKeySummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamKeySummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamKeySummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamKeySummary>() {
           @Override
           public void write(JsonWriter out, StreamKeySummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamKeySummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamKeySummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamKeySummary
   * @throws IOException if the JSON string is invalid with respect to StreamKeySummary
   */
  public static StreamKeySummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamKeySummary.class);
  }

  /**
   * Convert an instance of StreamKeySummary to an JSON string
   *
   * @return JSON string
   */
