...
import org.openapitools.client.model.IngestConfigurationAudio;
import org.openapitools.client.model.IngestConfigurationVideo;
...
public class StreamSessionIngestConfiguration {
  public static final String SERIALIZED_NAME_AUDIO = "audio";
  @SerializedName(SERIALIZED_NAME_AUDIO)
  private IngestConfigurationAudio audio;

  public static final String SERIALIZED_NAME_VIDEO = "video";
  @SerializedName(SERIALIZED_NAME_VIDEO)
  private IngestConfigurationVideo video;

  public StreamSessionIngestConfiguration() {
  }

  public StreamSessionIngestConfiguration audio(IngestConfigurationAudio audio) {
    this.audio = audio;
    return this;
  }
  ...
  public IngestConfigurationAudio getAudio() {
    return audio;
  }

  public void setAudio(IngestConfigurationAudio audio) {
    this.audio = audio;
  }


  public StreamSessionIngestConfiguration video(IngestConfigurationVideo video) {
    this.video = video;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public IngestConfigurationVideo getVideo() {
    return video;
  }

  public void setVideo(IngestConfigurationVideo video) {
    this.video = video;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamSessionIngestConfiguration streamSessionIngestConfiguration = (StreamSessionIngestConfiguration) o;
    return Objects.equals(this.audio, streamSessionIngestConfiguration.audio) &&
        Objects.equals(this.video, streamSessionIngestConfiguration.video);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamSessionIngestConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSessionIngestConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSessionIngestConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSessionIngestConfiguration is not found in the empty JSON string", StreamSessionIngestConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSessionIngestConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSessionIngestConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `audio`
      if (jsonObj.get("audio") != null && !jsonObj.get("audio").isJsonNull()) {
        IngestConfigurationAudio.validateJsonElement(jsonObj.get("audio"));
      }
      // validate the optional field `video`
      if (jsonObj.get("video") != null && !jsonObj.get("video").isJsonNull()) {
        IngestConfigurationVideo.validateJsonElement(jsonObj.get("video"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSessionIngestConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSessionIngestConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSessionIngestConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSessionIngestConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSessionIngestConfiguration>() {
           @Override
           public void write(JsonWriter out, StreamSessionIngestConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSessionIngestConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSessionIngestConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSessionIngestConfiguration
   * @throws IOException if the JSON string is invalid with respect to StreamSessionIngestConfiguration
   */
  public static StreamSessionIngestConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSessionIngestConfiguration.class);
  }

  /**
   * Convert an instance of StreamSessionIngestConfiguration to an JSON string
   *
   * @return JSON string
   */
