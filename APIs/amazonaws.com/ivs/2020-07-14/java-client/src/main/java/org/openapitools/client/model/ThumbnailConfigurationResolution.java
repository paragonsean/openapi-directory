...
/**
 * Gets or Sets ThumbnailConfigurationResolution
 */
@JsonAdapter(ThumbnailConfigurationResolution.Adapter.class)
public enum ThumbnailConfigurationResolution {
  ...
  ThumbnailConfigurationResolution(String value) {
    this.value = value;
  }
  ...
  public static ThumbnailConfigurationResolution fromValue(String value) {
    for (ThumbnailConfigurationResolution b : ThumbnailConfigurationResolution.values()) {
  ...
  public static class Adapter extends TypeAdapter<ThumbnailConfigurationResolution> {
    @Override
    public void write(final JsonWriter jsonWriter, final ThumbnailConfigurationResolution enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ThumbnailConfigurationResolution read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ThumbnailConfigurationResolution.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ThumbnailConfigurationResolution.fromValue(value);
  }
}
