...
import org.openapitools.client.model.GetStreamResponseStream;
...
public class GetStreamResponse {
  ...
  private GetStreamResponseStream stream;

  public GetStreamResponse() {
  }

  public GetStreamResponse stream(GetStreamResponseStream stream) {
    this.stream = stream;
    return this;
  }
  ...
  public GetStreamResponseStream getStream() {
    return stream;
  }

  public void setStream(GetStreamResponseStream stream) {
    this.stream = stream;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.stream, getStreamResponse.stream);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("stream") != null && !jsonObj.get("stream").isJsonNull()) {
        GetStreamResponseStream.validateJsonElement(jsonObj.get("stream"));
      }
  }
