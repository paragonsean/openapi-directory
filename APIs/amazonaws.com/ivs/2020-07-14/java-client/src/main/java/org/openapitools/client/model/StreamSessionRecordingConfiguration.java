...
public class StreamSessionRecordingConfiguration {
  ...
  public StreamSessionRecordingConfiguration() {
  }

  public StreamSessionRecordingConfiguration arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StreamSessionRecordingConfiguration destinationConfiguration(RecordingConfigurationDestinationConfiguration destinationConfiguration) {
  ...
  public StreamSessionRecordingConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StreamSessionRecordingConfiguration recordingReconnectWindowSeconds(Integer recordingReconnectWindowSeconds) {
  ...
  public StreamSessionRecordingConfiguration renditionConfiguration(CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration) {
  ...
  public StreamSessionRecordingConfiguration state(RecordingConfigurationState state) {
    this.state = state;
    return this;
  }
  ...
  public StreamSessionRecordingConfiguration tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StreamSessionRecordingConfiguration thumbnailConfiguration(CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    StreamSessionRecordingConfiguration streamSessionRecordingConfiguration = (StreamSessionRecordingConfiguration) o;
    return Objects.equals(this.arn, streamSessionRecordingConfiguration.arn) &&
        Objects.equals(this.destinationConfiguration, streamSessionRecordingConfiguration.destinationConfiguration) &&
        Objects.equals(this.name, streamSessionRecordingConfiguration.name) &&
        Objects.equals(this.recordingReconnectWindowSeconds, streamSessionRecordingConfiguration.recordingReconnectWindowSeconds) &&
        Objects.equals(this.renditionConfiguration, streamSessionRecordingConfiguration.renditionConfiguration) &&
        Objects.equals(this.state, streamSessionRecordingConfiguration.state) &&
        Objects.equals(this.tags, streamSessionRecordingConfiguration.tags) &&
        Objects.equals(this.thumbnailConfiguration, streamSessionRecordingConfiguration.thumbnailConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamSessionRecordingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSessionRecordingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSessionRecordingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSessionRecordingConfiguration is not found in the empty JSON string", StreamSessionRecordingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSessionRecordingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSessionRecordingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StreamSessionRecordingConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSessionRecordingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSessionRecordingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSessionRecordingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSessionRecordingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSessionRecordingConfiguration>() {
           @Override
           public void write(JsonWriter out, StreamSessionRecordingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSessionRecordingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSessionRecordingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSessionRecordingConfiguration
   * @throws IOException if the JSON string is invalid with respect to StreamSessionRecordingConfiguration
   */
  public static StreamSessionRecordingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSessionRecordingConfiguration.class);
  }

  /**
   * Convert an instance of StreamSessionRecordingConfiguration to an JSON string
   *
   * @return JSON string
   */
