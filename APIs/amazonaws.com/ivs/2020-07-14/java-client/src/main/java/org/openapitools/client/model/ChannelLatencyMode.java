...
/**
 * Gets or Sets ChannelLatencyMode
 */
@JsonAdapter(ChannelLatencyMode.Adapter.class)
public enum ChannelLatencyMode {
  ...
  public static ChannelLatencyMode fromValue(String value) {
    for (ChannelLatencyMode b : ChannelLatencyMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChannelLatencyMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelLatencyMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChannelLatencyMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChannelLatencyMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChannelLatencyMode.fromValue(value);
  }
}
