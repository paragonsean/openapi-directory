...
public class RenditionConfiguration {
  ...
  public RenditionConfiguration() {
  }

  public RenditionConfiguration renditionSelection(RenditionConfigurationRenditionSelection renditionSelection) {
  ...
  public RenditionConfiguration renditions(List renditions) {
  ...
  public boolean equals(Object o) {
    ...
    RenditionConfiguration renditionConfiguration = (RenditionConfiguration) o;
    return Objects.equals(this.renditionSelection, renditionConfiguration.renditionSelection) &&
        Objects.equals(this.renditions, renditionConfiguration.renditions);
  }
  ...
  public String toString() {
    ...
    sb.append("class RenditionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RenditionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RenditionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RenditionConfiguration is not found in the empty JSON string", RenditionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RenditionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RenditionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RenditionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RenditionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RenditionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RenditionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<RenditionConfiguration>() {
           @Override
           public void write(JsonWriter out, RenditionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RenditionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RenditionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RenditionConfiguration
   * @throws IOException if the JSON string is invalid with respect to RenditionConfiguration
   */
  public static RenditionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RenditionConfiguration.class);
  }

  /**
   * Convert an instance of RenditionConfiguration to an JSON string
   *
   * @return JSON string
   */
