...
/**
 * Gets or Sets RecordingConfigurationState
 */
@JsonAdapter(RecordingConfigurationState.Adapter.class)
public enum RecordingConfigurationState {
  ...
  RecordingConfigurationState(String value) {
    this.value = value;
  }
  ...
  public static RecordingConfigurationState fromValue(String value) {
    for (RecordingConfigurationState b : RecordingConfigurationState.values()) {
  ...
  public static class Adapter extends TypeAdapter<RecordingConfigurationState> {
    @Override
    public void write(final JsonWriter jsonWriter, final RecordingConfigurationState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RecordingConfigurationState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RecordingConfigurationState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RecordingConfigurationState.fromValue(value);
  }
}
