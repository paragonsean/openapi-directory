...
import org.openapitools.client.model.CreateStreamKeyResponseStreamKey;
...
public class CreateStreamKeyResponse {
  ...
  private CreateStreamKeyResponseStreamKey streamKey;

  public CreateStreamKeyResponse() {
  }

  public CreateStreamKeyResponse streamKey(CreateStreamKeyResponseStreamKey streamKey) {
  ...
  public CreateStreamKeyResponseStreamKey getStreamKey() {
    return streamKey;
  }

  public void setStreamKey(CreateStreamKeyResponseStreamKey streamKey) {
    this.streamKey = streamKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamKeyResponse createStreamKeyResponse = (CreateStreamKeyResponse) o;
    return Objects.equals(this.streamKey, createStreamKeyResponse.streamKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamKeyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamKeyResponse is not found in the empty JSON string", CreateStreamKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `streamKey`
      if (jsonObj.get("streamKey") != null && !jsonObj.get("streamKey").isJsonNull()) {
        CreateStreamKeyResponseStreamKey.validateJsonElement(jsonObj.get("streamKey"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamKeyResponse>() {
           @Override
           public void write(JsonWriter out, CreateStreamKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamKeyResponse
   * @throws IOException if the JSON string is invalid with respect to CreateStreamKeyResponse
   */
  public static CreateStreamKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamKeyResponse.class);
  }

  /**
   * Convert an instance of CreateStreamKeyResponse to an JSON string
   *
   * @return JSON string
   */
