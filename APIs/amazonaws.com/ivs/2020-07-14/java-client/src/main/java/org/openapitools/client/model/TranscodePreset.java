...
/**
 * Gets or Sets TranscodePreset
 */
@JsonAdapter(TranscodePreset.Adapter.class)
public enum TranscodePreset {
  ...
  public static TranscodePreset fromValue(String value) {
    for (TranscodePreset b : TranscodePreset.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscodePreset> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscodePreset enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscodePreset read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscodePreset.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscodePreset.fromValue(value);
  }
}
