...
public class DeleteStreamKeyRequest {
  ...
  public DeleteStreamKeyRequest() {
  }

  public DeleteStreamKeyRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteStreamKeyRequest deleteStreamKeyRequest = (DeleteStreamKeyRequest) o;
    return Objects.equals(this.arn, deleteStreamKeyRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteStreamKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteStreamKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteStreamKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteStreamKeyRequest is not found in the empty JSON string", DeleteStreamKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteStreamKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteStreamKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteStreamKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteStreamKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteStreamKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteStreamKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteStreamKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteStreamKeyRequest>() {
           @Override
           public void write(JsonWriter out, DeleteStreamKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteStreamKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteStreamKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteStreamKeyRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteStreamKeyRequest
   */
  public static DeleteStreamKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteStreamKeyRequest.class);
  }

  /**
   * Convert an instance of DeleteStreamKeyRequest to an JSON string
   *
   * @return JSON string
   */
