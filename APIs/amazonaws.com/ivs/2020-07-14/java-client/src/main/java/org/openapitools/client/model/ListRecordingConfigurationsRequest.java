...
public class ListRecordingConfigurationsRequest {
  ...
  public ListRecordingConfigurationsRequest() {
  }

  public ListRecordingConfigurationsRequest maxResults(Integer maxResults) {
  ...
  public ListRecordingConfigurationsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListRecordingConfigurationsRequest listRecordingConfigurationsRequest = (ListRecordingConfigurationsRequest) o;
    return Objects.equals(this.maxResults, listRecordingConfigurationsRequest.maxResults) &&
        Objects.equals(this.nextToken, listRecordingConfigurationsRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListRecordingConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRecordingConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRecordingConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRecordingConfigurationsRequest is not found in the empty JSON string", ListRecordingConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRecordingConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRecordingConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRecordingConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRecordingConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRecordingConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRecordingConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRecordingConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, ListRecordingConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRecordingConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRecordingConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRecordingConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListRecordingConfigurationsRequest
   */
  public static ListRecordingConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRecordingConfigurationsRequest.class);
  }

  /**
   * Convert an instance of ListRecordingConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
