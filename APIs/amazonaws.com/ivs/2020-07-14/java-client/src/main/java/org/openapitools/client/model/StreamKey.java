...
public class StreamKey {
  ...
  public StreamKey arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StreamKey channelArn(String channelArn) {
  ...
  public StreamKey tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public StreamKey value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, streamKey.arn) &&
        Objects.equals(this.channelArn, streamKey.channelArn) &&
        Objects.equals(this.tags, streamKey.tags) &&
        Objects.equals(this.value, streamKey.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, channelArn, tags, value);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamKey is not found in the empty JSON string", StreamKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamKey.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamKey>() {
           @Override
           public void write(JsonWriter out, StreamKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamKey
   * @throws IOException if the JSON string is invalid with respect to StreamKey
   */
  public static StreamKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamKey.class);
  }

  /**
   * Convert an instance of StreamKey to an JSON string
   *
   * @return JSON string
   */
