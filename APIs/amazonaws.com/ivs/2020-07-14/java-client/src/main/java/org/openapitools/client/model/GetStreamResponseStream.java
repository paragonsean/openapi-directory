...
import org.openapitools.client.model.StreamHealth;
...
public class GetStreamResponseStream {
  ...
  public static final String SERIALIZED_NAME_VIEWER_COUNT = "viewerCount";
  @SerializedName(SERIALIZED_NAME_VIEWER_COUNT)
  private Integer viewerCount;

  public GetStreamResponseStream() {
  }

  public GetStreamResponseStream channelArn(String channelArn) {
  ...
  public GetStreamResponseStream health(StreamHealth health) {
    this.health = health;
    return this;
  }
  ...
  public void setHealth(StreamHealth health) {
    this.health = health;
  }


  public GetStreamResponseStream playbackUrl(String playbackUrl) {
  ...
  public GetStreamResponseStream startTime(OffsetDateTime startTime) {
  ...
  public GetStreamResponseStream state(StreamState state) {
    this.state = state;
    return this;
  }
  ...
  public GetStreamResponseStream streamId(String streamId) {
  ...
  public GetStreamResponseStream viewerCount(Integer viewerCount) {
  ...
  public boolean equals(Object o) {
    ...
    GetStreamResponseStream getStreamResponseStream = (GetStreamResponseStream) o;
    return Objects.equals(this.channelArn, getStreamResponseStream.channelArn) &&
        Objects.equals(this.health, getStreamResponseStream.health) &&
        Objects.equals(this.playbackUrl, getStreamResponseStream.playbackUrl) &&
        Objects.equals(this.startTime, getStreamResponseStream.startTime) &&
        Objects.equals(this.state, getStreamResponseStream.state) &&
        Objects.equals(this.streamId, getStreamResponseStream.streamId) &&
        Objects.equals(this.viewerCount, getStreamResponseStream.viewerCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, health, playbackUrl, startTime, state, streamId, viewerCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStreamResponseStream {\n");
    ...
    sb.append("    viewerCount: ").append(toIndentedString(viewerCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamResponseStream
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamResponseStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamResponseStream is not found in the empty JSON string", GetStreamResponseStream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamResponseStream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamResponseStream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("health") != null && !jsonObj.get("health").isJsonNull()) {
        StreamHealth.validateJsonElement(jsonObj.get("health"));
      }
      ...
      if (jsonObj.get("state") != null && !jsonObj.get("state").isJsonNull()) {
        StreamState.validateJsonElement(jsonObj.get("state"));
      }
      ...
      // validate the optional field `viewerCount`
      if (jsonObj.get("viewerCount") != null && !jsonObj.get("viewerCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("viewerCount"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamResponseStream.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamResponseStream' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamResponseStream> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamResponseStream.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamResponseStream>() {
           @Override
           public void write(JsonWriter out, GetStreamResponseStream value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamResponseStream read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamResponseStream given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamResponseStream
   * @throws IOException if the JSON string is invalid with respect to GetStreamResponseStream
   */
  public static GetStreamResponseStream fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamResponseStream.class);
  }

  /**
   * Convert an instance of GetStreamResponseStream to an JSON string
   *
   * @return JSON string
   */
