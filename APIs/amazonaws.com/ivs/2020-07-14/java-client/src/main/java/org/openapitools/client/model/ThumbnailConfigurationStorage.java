...
/**
 * Gets or Sets ThumbnailConfigurationStorage
 */
@JsonAdapter(ThumbnailConfigurationStorage.Adapter.class)
public enum ThumbnailConfigurationStorage {
  ...
  ThumbnailConfigurationStorage(String value) {
    this.value = value;
  }
  ...
  public static ThumbnailConfigurationStorage fromValue(String value) {
    for (ThumbnailConfigurationStorage b : ThumbnailConfigurationStorage.values()) {
  ...
  public static class Adapter extends TypeAdapter<ThumbnailConfigurationStorage> {
    @Override
    public void write(final JsonWriter jsonWriter, final ThumbnailConfigurationStorage enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ThumbnailConfigurationStorage read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ThumbnailConfigurationStorage.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ThumbnailConfigurationStorage.fromValue(value);
  }
}
