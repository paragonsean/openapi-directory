...
public class ListStreamKeysRequest {
  ...
  public ListStreamKeysRequest() {
  }

  public ListStreamKeysRequest channelArn(String channelArn) {
  ...
  public ListStreamKeysRequest maxResults(Integer maxResults) {
  ...
  public ListStreamKeysRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListStreamKeysRequest listStreamKeysRequest = (ListStreamKeysRequest) o;
    return Objects.equals(this.channelArn, listStreamKeysRequest.channelArn) &&
        Objects.equals(this.maxResults, listStreamKeysRequest.maxResults) &&
        Objects.equals(this.nextToken, listStreamKeysRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListStreamKeysRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamKeysRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamKeysRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamKeysRequest is not found in the empty JSON string", ListStreamKeysRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamKeysRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamKeysRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListStreamKeysRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamKeysRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamKeysRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamKeysRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamKeysRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamKeysRequest>() {
           @Override
           public void write(JsonWriter out, ListStreamKeysRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamKeysRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamKeysRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamKeysRequest
   * @throws IOException if the JSON string is invalid with respect to ListStreamKeysRequest
   */
  public static ListStreamKeysRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamKeysRequest.class);
  }

  /**
   * Convert an instance of ListStreamKeysRequest to an JSON string
   *
   * @return JSON string
   */
