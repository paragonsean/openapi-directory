...
public class S3DestinationConfiguration {
  ...
  public S3DestinationConfiguration() {
  }

  public S3DestinationConfiguration bucketName(String bucketName) {
  ...
  public boolean equals(Object o) {
    ...
    S3DestinationConfiguration s3DestinationConfiguration = (S3DestinationConfiguration) o;
    return Objects.equals(this.bucketName, s3DestinationConfiguration.bucketName);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3DestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3DestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3DestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3DestinationConfiguration is not found in the empty JSON string", S3DestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3DestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3DestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3DestinationConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3DestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3DestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3DestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3DestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<S3DestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, S3DestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3DestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3DestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3DestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to S3DestinationConfiguration
   */
  public static S3DestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3DestinationConfiguration.class);
  }

  /**
   * Convert an instance of S3DestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
