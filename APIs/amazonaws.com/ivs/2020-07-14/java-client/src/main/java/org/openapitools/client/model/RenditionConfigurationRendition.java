...
/**
 * Gets or Sets RenditionConfigurationRendition
 */
@JsonAdapter(RenditionConfigurationRendition.Adapter.class)
public enum RenditionConfigurationRendition {
  ...
  RenditionConfigurationRendition(String value) {
    this.value = value;
  }
  ...
  public static RenditionConfigurationRendition fromValue(String value) {
    for (RenditionConfigurationRendition b : RenditionConfigurationRendition.values()) {
  ...
  public static class Adapter extends TypeAdapter<RenditionConfigurationRendition> {
    @Override
    public void write(final JsonWriter jsonWriter, final RenditionConfigurationRendition enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RenditionConfigurationRendition read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RenditionConfigurationRendition.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RenditionConfigurationRendition.fromValue(value);
  }
}
