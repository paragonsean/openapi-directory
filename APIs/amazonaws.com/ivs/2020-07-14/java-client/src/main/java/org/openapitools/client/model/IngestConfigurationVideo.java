...
public class IngestConfigurationVideo {
  ...
  public IngestConfigurationVideo() {
  }

  public IngestConfigurationVideo avcLevel(String avcLevel) {
  ...
  public IngestConfigurationVideo avcProfile(String avcProfile) {
  ...
  public IngestConfigurationVideo codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public IngestConfigurationVideo encoder(String encoder) {
  ...
  public IngestConfigurationVideo targetBitrate(Integer targetBitrate) {
  ...
  public IngestConfigurationVideo targetFramerate(Integer targetFramerate) {
  ...
  public IngestConfigurationVideo videoHeight(Integer videoHeight) {
  ...
  public IngestConfigurationVideo videoWidth(Integer videoWidth) {
  ...
  public boolean equals(Object o) {
    ...
    IngestConfigurationVideo ingestConfigurationVideo = (IngestConfigurationVideo) o;
    return Objects.equals(this.avcLevel, ingestConfigurationVideo.avcLevel) &&
        Objects.equals(this.avcProfile, ingestConfigurationVideo.avcProfile) &&
        Objects.equals(this.codec, ingestConfigurationVideo.codec) &&
        Objects.equals(this.encoder, ingestConfigurationVideo.encoder) &&
        Objects.equals(this.targetBitrate, ingestConfigurationVideo.targetBitrate) &&
        Objects.equals(this.targetFramerate, ingestConfigurationVideo.targetFramerate) &&
        Objects.equals(this.videoHeight, ingestConfigurationVideo.videoHeight) &&
        Objects.equals(this.videoWidth, ingestConfigurationVideo.videoWidth);
  }
  ...
  public String toString() {
    ...
    sb.append("class IngestConfigurationVideo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IngestConfigurationVideo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IngestConfigurationVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IngestConfigurationVideo is not found in the empty JSON string", IngestConfigurationVideo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IngestConfigurationVideo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IngestConfigurationVideo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestConfigurationVideo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestConfigurationVideo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestConfigurationVideo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestConfigurationVideo.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestConfigurationVideo>() {
           @Override
           public void write(JsonWriter out, IngestConfigurationVideo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IngestConfigurationVideo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IngestConfigurationVideo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IngestConfigurationVideo
   * @throws IOException if the JSON string is invalid with respect to IngestConfigurationVideo
   */
  public static IngestConfigurationVideo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestConfigurationVideo.class);
  }

  /**
   * Convert an instance of IngestConfigurationVideo to an JSON string
   *
   * @return JSON string
   */
