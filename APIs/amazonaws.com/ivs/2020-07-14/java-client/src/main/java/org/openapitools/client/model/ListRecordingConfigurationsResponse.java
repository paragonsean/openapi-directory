...
public class ListRecordingConfigurationsResponse {
  ...
  public static final String SERIALIZED_NAME_RECORDING_CONFIGURATIONS = "recordingConfigurations";
  @SerializedName(SERIALIZED_NAME_RECORDING_CONFIGURATIONS)
  private List recordingConfigurations;

  public ListRecordingConfigurationsResponse() {
  }

  public ListRecordingConfigurationsResponse nextToken(String nextToken) {
  ...
  public ListRecordingConfigurationsResponse recordingConfigurations(List recordingConfigurations) {
    this.recordingConfigurations = recordingConfigurations;
    return this;
  }

  /**
   * Get recordingConfigurations
   * @return recordingConfigurations
   */
  @javax.annotation.Nonnull
  public List getRecordingConfigurations() {
    return recordingConfigurations;
  }

  public void setRecordingConfigurations(List recordingConfigurations) {
    this.recordingConfigurations = recordingConfigurations;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListRecordingConfigurationsResponse listRecordingConfigurationsResponse = (ListRecordingConfigurationsResponse) o;
    return Objects.equals(this.nextToken, listRecordingConfigurationsResponse.nextToken) &&
        Objects.equals(this.recordingConfigurations, listRecordingConfigurationsResponse.recordingConfigurations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, recordingConfigurations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListRecordingConfigurationsResponse {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    recordingConfigurations: ").append(toIndentedString(recordingConfigurations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("recordingConfigurations");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("recordingConfigurations");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRecordingConfigurationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRecordingConfigurationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRecordingConfigurationsResponse is not found in the empty JSON string", ListRecordingConfigurationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRecordingConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRecordingConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListRecordingConfigurationsResponse.openapiRequiredFields) {
      ...
      // validate the required field `recordingConfigurations`
      List.validateJsonElement(jsonObj.get("recordingConfigurations"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRecordingConfigurationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRecordingConfigurationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRecordingConfigurationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRecordingConfigurationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRecordingConfigurationsResponse>() {
           @Override
           public void write(JsonWriter out, ListRecordingConfigurationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRecordingConfigurationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRecordingConfigurationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRecordingConfigurationsResponse
   * @throws IOException if the JSON string is invalid with respect to ListRecordingConfigurationsResponse
   */
  public static ListRecordingConfigurationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRecordingConfigurationsResponse.class);
  }

  /**
   * Convert an instance of ListRecordingConfigurationsResponse to an JSON string
   *
   * @return JSON string
   */
