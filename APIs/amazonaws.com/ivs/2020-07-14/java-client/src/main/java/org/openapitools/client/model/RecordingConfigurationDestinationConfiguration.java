...
public class RecordingConfigurationDestinationConfiguration {
  ...
  public RecordingConfigurationDestinationConfiguration() {
  }

  public RecordingConfigurationDestinationConfiguration s3(CreateRecordingConfigurationRequestDestinationConfigurationS3 s3) {
    this.s3 = s3;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RecordingConfigurationDestinationConfiguration recordingConfigurationDestinationConfiguration = (RecordingConfigurationDestinationConfiguration) o;
    return Objects.equals(this.s3, recordingConfigurationDestinationConfiguration.s3);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecordingConfigurationDestinationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecordingConfigurationDestinationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecordingConfigurationDestinationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecordingConfigurationDestinationConfiguration is not found in the empty JSON string", RecordingConfigurationDestinationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecordingConfigurationDestinationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecordingConfigurationDestinationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecordingConfigurationDestinationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecordingConfigurationDestinationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecordingConfigurationDestinationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecordingConfigurationDestinationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<RecordingConfigurationDestinationConfiguration>() {
           @Override
           public void write(JsonWriter out, RecordingConfigurationDestinationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecordingConfigurationDestinationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecordingConfigurationDestinationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecordingConfigurationDestinationConfiguration
   * @throws IOException if the JSON string is invalid with respect to RecordingConfigurationDestinationConfiguration
   */
  public static RecordingConfigurationDestinationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecordingConfigurationDestinationConfiguration.class);
  }

  /**
   * Convert an instance of RecordingConfigurationDestinationConfiguration to an JSON string
   *
   * @return JSON string
   */
