...
import org.openapitools.client.model.CreateRecordingConfigurationRequestRenditionConfiguration;
import org.openapitools.client.model.CreateRecordingConfigurationRequestThumbnailConfiguration;
import org.openapitools.client.model.RecordingConfigurationDestinationConfiguration;
import org.openapitools.client.model.RecordingConfigurationState;
...
public class CreateRecordingConfigurationResponseRecordingConfiguration {
  ...
  private RecordingConfigurationDestinationConfiguration destinationConfiguration;

  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public static final String SERIALIZED_NAME_RECORDING_RECONNECT_WINDOW_SECONDS = "recordingReconnectWindowSeconds";
  @SerializedName(SERIALIZED_NAME_RECORDING_RECONNECT_WINDOW_SECONDS)
  private Integer recordingReconnectWindowSeconds;

  public static final String SERIALIZED_NAME_RENDITION_CONFIGURATION = "renditionConfiguration";
  @SerializedName(SERIALIZED_NAME_RENDITION_CONFIGURATION)
  private CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration;

  public static final String SERIALIZED_NAME_STATE = "state";
  @SerializedName(SERIALIZED_NAME_STATE)
  private RecordingConfigurationState state;
  ...
  private CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration;

  public CreateRecordingConfigurationResponseRecordingConfiguration() {
  }

  public CreateRecordingConfigurationResponseRecordingConfiguration arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateRecordingConfigurationResponseRecordingConfiguration destinationConfiguration(RecordingConfigurationDestinationConfiguration destinationConfiguration) {
   ...
   */
  @javax.annotation.Nonnull
  public RecordingConfigurationDestinationConfiguration getDestinationConfiguration() {
    return destinationConfiguration;
  }

  public void setDestinationConfiguration(RecordingConfigurationDestinationConfiguration destinationConfiguration) {
    this.destinationConfiguration = destinationConfiguration;
  }


  public CreateRecordingConfigurationResponseRecordingConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRecordingConfigurationResponseRecordingConfiguration recordingReconnectWindowSeconds(Integer recordingReconnectWindowSeconds) {
    this.recordingReconnectWindowSeconds = recordingReconnectWindowSeconds;
    return this;
  }

  /**
   * Get recordingReconnectWindowSeconds
  ...
  public CreateRecordingConfigurationResponseRecordingConfiguration renditionConfiguration(CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration) {
    this.renditionConfiguration = renditionConfiguration;
    return this;
  }

  /**
   * Get renditionConfiguration
   * @return renditionConfiguration
   */
  @javax.annotation.Nullable
  public CreateRecordingConfigurationRequestRenditionConfiguration getRenditionConfiguration() {
    return renditionConfiguration;
  }

  public void setRenditionConfiguration(CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration) {
    this.renditionConfiguration = renditionConfiguration;
  }


  public CreateRecordingConfigurationResponseRecordingConfiguration state(RecordingConfigurationState state) {
    this.state = state;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RecordingConfigurationState getState() {
    return state;
  }

  public void setState(RecordingConfigurationState state) {
    this.state = state;
  }


  public CreateRecordingConfigurationResponseRecordingConfiguration tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateRecordingConfigurationResponseRecordingConfiguration thumbnailConfiguration(CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public CreateRecordingConfigurationRequestThumbnailConfiguration getThumbnailConfiguration() {
    return thumbnailConfiguration;
  }

  public void setThumbnailConfiguration(CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration) {
    this.thumbnailConfiguration = thumbnailConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationResponseRecordingConfiguration createRecordingConfigurationResponseRecordingConfiguration = (CreateRecordingConfigurationResponseRecordingConfiguration) o;
    return Objects.equals(this.arn, createRecordingConfigurationResponseRecordingConfiguration.arn) &&
        Objects.equals(this.destinationConfiguration, createRecordingConfigurationResponseRecordingConfiguration.destinationConfiguration) &&
        Objects.equals(this.name, createRecordingConfigurationResponseRecordingConfiguration.name) &&
        Objects.equals(this.recordingReconnectWindowSeconds, createRecordingConfigurationResponseRecordingConfiguration.recordingReconnectWindowSeconds) &&
        Objects.equals(this.renditionConfiguration, createRecordingConfigurationResponseRecordingConfiguration.renditionConfiguration) &&
        Objects.equals(this.state, createRecordingConfigurationResponseRecordingConfiguration.state) &&
        Objects.equals(this.tags, createRecordingConfigurationResponseRecordingConfiguration.tags) &&
        Objects.equals(this.thumbnailConfiguration, createRecordingConfigurationResponseRecordingConfiguration.thumbnailConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, destinationConfiguration, name, recordingReconnectWindowSeconds, renditionConfiguration, state, tags, thumbnailConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRecordingConfigurationResponseRecordingConfiguration {\n");
    sb.append("    arn: ").append(toIndentedString(arn)).append("\n");
    sb.append("    destinationConfiguration: ").append(toIndentedString(destinationConfiguration)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    recordingReconnectWindowSeconds: ").append(toIndentedString(recordingReconnectWindowSeconds)).append("\n");
    sb.append("    renditionConfiguration: ").append(toIndentedString(renditionConfiguration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("recordingReconnectWindowSeconds");
    openapiFields.add("renditionConfiguration");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationResponseRecordingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationResponseRecordingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationResponseRecordingConfiguration is not found in the empty JSON string", CreateRecordingConfigurationResponseRecordingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationResponseRecordingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationResponseRecordingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRecordingConfigurationResponseRecordingConfiguration.openapiRequiredFields) {
      ...
      RecordingConfigurationDestinationConfiguration.validateJsonElement(jsonObj.get("destinationConfiguration"));
      // validate the optional field `name`
      if (jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("name"));
      }
      // validate the optional field `recordingReconnectWindowSeconds`
      if (jsonObj.get("recordingReconnectWindowSeconds") != null && !jsonObj.get("recordingReconnectWindowSeconds").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("recordingReconnectWindowSeconds"));
      }
      // validate the optional field `renditionConfiguration`
      if (jsonObj.get("renditionConfiguration") != null && !jsonObj.get("renditionConfiguration").isJsonNull()) {
        CreateRecordingConfigurationRequestRenditionConfiguration.validateJsonElement(jsonObj.get("renditionConfiguration"));
      }
      // validate the required field `state`
      RecordingConfigurationState.validateJsonElement(jsonObj.get("state"));
      ...
      if (jsonObj.get("thumbnailConfiguration") != null && !jsonObj.get("thumbnailConfiguration").isJsonNull()) {
        CreateRecordingConfigurationRequestThumbnailConfiguration.validateJsonElement(jsonObj.get("thumbnailConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationResponseRecordingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationResponseRecordingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationResponseRecordingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationResponseRecordingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationResponseRecordingConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationResponseRecordingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationResponseRecordingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationResponseRecordingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationResponseRecordingConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationResponseRecordingConfiguration
   */
  public static CreateRecordingConfigurationResponseRecordingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationResponseRecordingConfiguration.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationResponseRecordingConfiguration to an JSON string
   *
   * @return JSON string
   */
