...
import org.openapitools.client.model.CreateRecordingConfigurationRequestDestinationConfiguration;
...
public class CreateRecordingConfigurationRequest {
  ...
  private CreateRecordingConfigurationRequestDestinationConfiguration destinationConfiguration;
  ...
  public CreateRecordingConfigurationRequest() {
  }

  public CreateRecordingConfigurationRequest destinationConfiguration(CreateRecordingConfigurationRequestDestinationConfiguration destinationConfiguration) {
  ...
  public CreateRecordingConfigurationRequestDestinationConfiguration getDestinationConfiguration() {
    return destinationConfiguration;
  }

  public void setDestinationConfiguration(CreateRecordingConfigurationRequestDestinationConfiguration destinationConfiguration) {
    this.destinationConfiguration = destinationConfiguration;
  }


  public CreateRecordingConfigurationRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRecordingConfigurationRequest recordingReconnectWindowSeconds(Integer recordingReconnectWindowSeconds) {
  ...
  public CreateRecordingConfigurationRequest renditionConfiguration(CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration) {
  ...
  public CreateRecordingConfigurationRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateRecordingConfigurationRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreateRecordingConfigurationRequest thumbnailConfiguration(CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationRequest createRecordingConfigurationRequest = (CreateRecordingConfigurationRequest) o;
    return Objects.equals(this.destinationConfiguration, createRecordingConfigurationRequest.destinationConfiguration) &&
        Objects.equals(this.name, createRecordingConfigurationRequest.name) &&
        Objects.equals(this.recordingReconnectWindowSeconds, createRecordingConfigurationRequest.recordingReconnectWindowSeconds) &&
        Objects.equals(this.renditionConfiguration, createRecordingConfigurationRequest.renditionConfiguration) &&
        Objects.equals(this.tags, createRecordingConfigurationRequest.tags) &&
        Objects.equals(this.thumbnailConfiguration, createRecordingConfigurationRequest.thumbnailConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(destinationConfiguration, name, recordingReconnectWindowSeconds, renditionConfiguration, tags, thumbnailConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRecordingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationRequest is not found in the empty JSON string", CreateRecordingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRecordingConfigurationRequest.openapiRequiredFields) {
      ...
      CreateRecordingConfigurationRequestDestinationConfiguration.validateJsonElement(jsonObj.get("destinationConfiguration"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationRequest
   */
  public static CreateRecordingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationRequest.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
