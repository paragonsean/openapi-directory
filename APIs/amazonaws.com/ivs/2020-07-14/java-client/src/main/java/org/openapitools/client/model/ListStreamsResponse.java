...
public class ListStreamsResponse {
  ...
  public ListStreamsResponse nextToken(String nextToken) {
  ...
  public ListStreamsResponse streams(List streams) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listStreamsResponse.nextToken) &&
        Objects.equals(this.streams, listStreamsResponse.streams);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, streams);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ListStreamsResponse.openapiRequiredFields) {
