...
import org.openapitools.client.model.BatchStartViewerSessionRevocationViewerSession;
...
public class BatchStartViewerSessionRevocationRequest {
  public static final String SERIALIZED_NAME_VIEWER_SESSIONS = "viewerSessions";
  @SerializedName(SERIALIZED_NAME_VIEWER_SESSIONS)
  private List<BatchStartViewerSessionRevocationViewerSession> viewerSessions = new ArrayList<>();

  public BatchStartViewerSessionRevocationRequest() {
  }

  public BatchStartViewerSessionRevocationRequest viewerSessions(List<BatchStartViewerSessionRevocationViewerSession> viewerSessions) {
    this.viewerSessions = viewerSessions;
    return this;
  }

  public BatchStartViewerSessionRevocationRequest addViewerSessionsItem(BatchStartViewerSessionRevocationViewerSession viewerSessionsItem) {
    if (this.viewerSessions == null) {
      this.viewerSessions = new ArrayList<>();
    }
    this.viewerSessions.add(viewerSessionsItem);
    return this;
  }
  ...
  public void setViewerSessions(List<BatchStartViewerSessionRevocationViewerSession> viewerSessions) {
    this.viewerSessions = viewerSessions;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchStartViewerSessionRevocationRequest batchStartViewerSessionRevocationRequest = (BatchStartViewerSessionRevocationRequest) o;
    return Objects.equals(this.viewerSessions, batchStartViewerSessionRevocationRequest.viewerSessions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(viewerSessions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchStartViewerSessionRevocationRequest {\n");
    sb.append("    viewerSessions: ").append(toIndentedString(viewerSessions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("viewerSessions");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("viewerSessions");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchStartViewerSessionRevocationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchStartViewerSessionRevocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchStartViewerSessionRevocationRequest is not found in the empty JSON string", BatchStartViewerSessionRevocationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchStartViewerSessionRevocationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchStartViewerSessionRevocationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchStartViewerSessionRevocationRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("viewerSessions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `viewerSessions` to be an array in the JSON string but got `%s`", jsonObj.get("viewerSessions").toString()));
      }

      JsonArray jsonArrayviewerSessions = jsonObj.getAsJsonArray("viewerSessions");
      // validate the required field `viewerSessions` (array)
      for (int i = 0; i < jsonArrayviewerSessions.size(); i++) {
        BatchStartViewerSessionRevocationViewerSession.validateJsonElement(jsonArrayviewerSessions.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchStartViewerSessionRevocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchStartViewerSessionRevocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchStartViewerSessionRevocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchStartViewerSessionRevocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchStartViewerSessionRevocationRequest>() {
           @Override
           public void write(JsonWriter out, BatchStartViewerSessionRevocationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchStartViewerSessionRevocationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchStartViewerSessionRevocationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchStartViewerSessionRevocationRequest
   * @throws IOException if the JSON string is invalid with respect to BatchStartViewerSessionRevocationRequest
   */
  public static BatchStartViewerSessionRevocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchStartViewerSessionRevocationRequest.class);
  }

  /**
   * Convert an instance of BatchStartViewerSessionRevocationRequest to an JSON string
   *
   * @return JSON string
   */
