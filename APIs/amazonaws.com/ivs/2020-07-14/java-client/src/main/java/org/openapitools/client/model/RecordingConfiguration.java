...
public class RecordingConfiguration {
  ...
  public RecordingConfiguration arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RecordingConfiguration destinationConfiguration(RecordingConfigurationDestinationConfiguration destinationConfiguration) {
  ...
  public RecordingConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RecordingConfiguration recordingReconnectWindowSeconds(Integer recordingReconnectWindowSeconds) {
  ...
  public RecordingConfiguration renditionConfiguration(CreateRecordingConfigurationRequestRenditionConfiguration renditionConfiguration) {
  ...
  public RecordingConfiguration state(RecordingConfigurationState state) {
    this.state = state;
    return this;
  }
  ...
  public RecordingConfiguration tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RecordingConfiguration thumbnailConfiguration(CreateRecordingConfigurationRequestThumbnailConfiguration thumbnailConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    RecordingConfiguration recordingConfiguration = (RecordingConfiguration) o;
    return Objects.equals(this.arn, recordingConfiguration.arn) &&
        Objects.equals(this.destinationConfiguration, recordingConfiguration.destinationConfiguration) &&
        Objects.equals(this.name, recordingConfiguration.name) &&
        Objects.equals(this.recordingReconnectWindowSeconds, recordingConfiguration.recordingReconnectWindowSeconds) &&
        Objects.equals(this.renditionConfiguration, recordingConfiguration.renditionConfiguration) &&
        Objects.equals(this.state, recordingConfiguration.state) &&
        Objects.equals(this.tags, recordingConfiguration.tags) &&
        Objects.equals(this.thumbnailConfiguration, recordingConfiguration.thumbnailConfiguration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecordingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecordingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecordingConfiguration is not found in the empty JSON string", RecordingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecordingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecordingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecordingConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecordingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecordingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecordingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecordingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<RecordingConfiguration>() {
           @Override
           public void write(JsonWriter out, RecordingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecordingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecordingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecordingConfiguration
   * @throws IOException if the JSON string is invalid with respect to RecordingConfiguration
   */
  public static RecordingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecordingConfiguration.class);
  }

  /**
   * Convert an instance of RecordingConfiguration to an JSON string
   *
   * @return JSON string
   */
