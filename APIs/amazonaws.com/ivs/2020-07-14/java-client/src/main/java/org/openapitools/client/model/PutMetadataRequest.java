...
public class PutMetadataRequest {
  ...
  public PutMetadataRequest channelArn(String channelArn) {
  ...
  public PutMetadataRequest metadata(String metadata) {
  ...
  public boolean equals(Object o) {
    ...
    PutMetadataRequest putMetadataRequest = (PutMetadataRequest) o;
    return Objects.equals(this.channelArn, putMetadataRequest.channelArn) &&
        Objects.equals(this.metadata, putMetadataRequest.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, metadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutMetadataRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutMetadataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutMetadataRequest is not found in the empty JSON string", PutMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutMetadataRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutMetadataRequest>() {
           @Override
           public void write(JsonWriter out, PutMetadataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutMetadataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutMetadataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutMetadataRequest
   * @throws IOException if the JSON string is invalid with respect to PutMetadataRequest
   */
  public static PutMetadataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutMetadataRequest.class);
  }

  /**
   * Convert an instance of PutMetadataRequest to an JSON string
   *
   * @return JSON string
   */
