...
public class AudioConfiguration {
  ...
  public AudioConfiguration channels(Integer channels) {
  ...
  public AudioConfiguration codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public AudioConfiguration sampleRate(Integer sampleRate) {
  ...
  public AudioConfiguration targetBitrate(Integer targetBitrate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channels, audioConfiguration.channels) &&
        Objects.equals(this.codec, audioConfiguration.codec) &&
        Objects.equals(this.sampleRate, audioConfiguration.sampleRate) &&
        Objects.equals(this.targetBitrate, audioConfiguration.targetBitrate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudioConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudioConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudioConfiguration is not found in the empty JSON string", AudioConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudioConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudioConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudioConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudioConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudioConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudioConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AudioConfiguration>() {
           @Override
           public void write(JsonWriter out, AudioConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudioConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AudioConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudioConfiguration
   * @throws IOException if the JSON string is invalid with respect to AudioConfiguration
   */
  public static AudioConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudioConfiguration.class);
  }

  /**
   * Convert an instance of AudioConfiguration to an JSON string
   *
   * @return JSON string
   */
