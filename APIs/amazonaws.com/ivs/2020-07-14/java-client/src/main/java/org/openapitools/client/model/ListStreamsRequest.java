...
import org.openapitools.client.model.ListStreamsRequestFilterBy;
...
public class ListStreamsRequest {
  ...
  private ListStreamsRequestFilterBy filterBy;
  ...
  public ListStreamsRequest filterBy(ListStreamsRequestFilterBy filterBy) {
  ...
  public ListStreamsRequestFilterBy getFilterBy() {
    return filterBy;
  }

  public void setFilterBy(ListStreamsRequestFilterBy filterBy) {
    this.filterBy = filterBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filterBy, listStreamsRequest.filterBy) &&
        Objects.equals(this.maxResults, listStreamsRequest.maxResults) &&
        Objects.equals(this.nextToken, listStreamsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filterBy, maxResults, nextToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `filterBy`
      if (jsonObj.get("filterBy") != null && !jsonObj.get("filterBy").isJsonNull()) {
        ListStreamsRequestFilterBy.validateJsonElement(jsonObj.get("filterBy"));
      }
