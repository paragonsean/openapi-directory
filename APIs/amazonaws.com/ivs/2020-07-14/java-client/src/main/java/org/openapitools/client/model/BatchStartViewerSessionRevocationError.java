...
public class BatchStartViewerSessionRevocationError {
  ...
  public BatchStartViewerSessionRevocationError channelArn(String channelArn) {
  ...
  public BatchStartViewerSessionRevocationError code(String code) {
    this.code = code;
    return this;
  }
  ...
  public BatchStartViewerSessionRevocationError message(String message) {
  ...
  public BatchStartViewerSessionRevocationError viewerId(String viewerId) {
  ...
  public boolean equals(Object o) {
    ...
    BatchStartViewerSessionRevocationError batchStartViewerSessionRevocationError = (BatchStartViewerSessionRevocationError) o;
    return Objects.equals(this.channelArn, batchStartViewerSessionRevocationError.channelArn) &&
        Objects.equals(this.code, batchStartViewerSessionRevocationError.code) &&
        Objects.equals(this.message, batchStartViewerSessionRevocationError.message) &&
        Objects.equals(this.viewerId, batchStartViewerSessionRevocationError.viewerId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, code, message, viewerId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchStartViewerSessionRevocationError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchStartViewerSessionRevocationError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchStartViewerSessionRevocationError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchStartViewerSessionRevocationError is not found in the empty JSON string", BatchStartViewerSessionRevocationError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchStartViewerSessionRevocationError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchStartViewerSessionRevocationError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchStartViewerSessionRevocationError.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchStartViewerSessionRevocationError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchStartViewerSessionRevocationError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchStartViewerSessionRevocationError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchStartViewerSessionRevocationError.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchStartViewerSessionRevocationError>() {
           @Override
           public void write(JsonWriter out, BatchStartViewerSessionRevocationError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchStartViewerSessionRevocationError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchStartViewerSessionRevocationError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchStartViewerSessionRevocationError
   * @throws IOException if the JSON string is invalid with respect to BatchStartViewerSessionRevocationError
   */
  public static BatchStartViewerSessionRevocationError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchStartViewerSessionRevocationError.class);
  }

  /**
   * Convert an instance of BatchStartViewerSessionRevocationError to an JSON string
   *
   * @return JSON string
   */
