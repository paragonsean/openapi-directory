...
import org.openapitools.client.model.RenditionConfigurationRenditionSelection;
...
public class CreateRecordingConfigurationRequestRenditionConfiguration {
  public static final String SERIALIZED_NAME_RENDITION_SELECTION = "renditionSelection";
  @SerializedName(SERIALIZED_NAME_RENDITION_SELECTION)
  private RenditionConfigurationRenditionSelection renditionSelection;
  ...
  public CreateRecordingConfigurationRequestRenditionConfiguration() {
  }

  public CreateRecordingConfigurationRequestRenditionConfiguration renditionSelection(RenditionConfigurationRenditionSelection renditionSelection) {
    this.renditionSelection = renditionSelection;
    return this;
  }

  /**
   * Get renditionSelection
   * @return renditionSelection
   */
  @javax.annotation.Nullable
  public RenditionConfigurationRenditionSelection getRenditionSelection() {
    return renditionSelection;
  }

  public void setRenditionSelection(RenditionConfigurationRenditionSelection renditionSelection) {
    this.renditionSelection = renditionSelection;
  }


  public CreateRecordingConfigurationRequestRenditionConfiguration renditions(List renditions) {
  ...
  public void setRenditions(List renditions) {
    this.renditions = renditions;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationRequestRenditionConfiguration createRecordingConfigurationRequestRenditionConfiguration = (CreateRecordingConfigurationRequestRenditionConfiguration) o;
    return Objects.equals(this.renditionSelection, createRecordingConfigurationRequestRenditionConfiguration.renditionSelection) &&
        Objects.equals(this.renditions, createRecordingConfigurationRequestRenditionConfiguration.renditions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(renditionSelection, renditions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRecordingConfigurationRequestRenditionConfiguration {\n");
    sb.append("    renditionSelection: ").append(toIndentedString(renditionSelection)).append("\n");
  ...
  static {
    ...
    openapiFields.add("renditionSelection");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationRequestRenditionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationRequestRenditionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationRequestRenditionConfiguration is not found in the empty JSON string", CreateRecordingConfigurationRequestRenditionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationRequestRenditionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationRequestRenditionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `renditionSelection`
      if (jsonObj.get("renditionSelection") != null && !jsonObj.get("renditionSelection").isJsonNull()) {
        RenditionConfigurationRenditionSelection.validateJsonElement(jsonObj.get("renditionSelection"));
      }
      // validate the optional field `renditions`
      if (jsonObj.get("renditions") != null && !jsonObj.get("renditions").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("renditions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationRequestRenditionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationRequestRenditionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationRequestRenditionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationRequestRenditionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationRequestRenditionConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationRequestRenditionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationRequestRenditionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationRequestRenditionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationRequestRenditionConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationRequestRenditionConfiguration
   */
  public static CreateRecordingConfigurationRequestRenditionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationRequestRenditionConfiguration.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationRequestRenditionConfiguration to an JSON string
   *
   * @return JSON string
   */
