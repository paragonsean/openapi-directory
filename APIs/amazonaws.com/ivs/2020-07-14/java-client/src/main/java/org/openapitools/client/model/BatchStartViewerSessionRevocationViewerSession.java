...
public class BatchStartViewerSessionRevocationViewerSession {
  ...
  public static final String SERIALIZED_NAME_VIEWER_SESSION_VERSIONS_LESS_THAN_OR_EQUAL_TO = "viewerSessionVersionsLessThanOrEqualTo";
  @SerializedName(SERIALIZED_NAME_VIEWER_SESSION_VERSIONS_LESS_THAN_OR_EQUAL_TO)
  private Integer viewerSessionVersionsLessThanOrEqualTo;

  public BatchStartViewerSessionRevocationViewerSession() {
  }

  public BatchStartViewerSessionRevocationViewerSession channelArn(String channelArn) {
  ...
  public BatchStartViewerSessionRevocationViewerSession viewerId(String viewerId) {
  ...
  public BatchStartViewerSessionRevocationViewerSession viewerSessionVersionsLessThanOrEqualTo(Integer viewerSessionVersionsLessThanOrEqualTo) {
    this.viewerSessionVersionsLessThanOrEqualTo = viewerSessionVersionsLessThanOrEqualTo;
    return this;
  }

  /**
   * Get viewerSessionVersionsLessThanOrEqualTo
  ...
  public boolean equals(Object o) {
    ...
    BatchStartViewerSessionRevocationViewerSession batchStartViewerSessionRevocationViewerSession = (BatchStartViewerSessionRevocationViewerSession) o;
    return Objects.equals(this.channelArn, batchStartViewerSessionRevocationViewerSession.channelArn) &&
        Objects.equals(this.viewerId, batchStartViewerSessionRevocationViewerSession.viewerId) &&
        Objects.equals(this.viewerSessionVersionsLessThanOrEqualTo, batchStartViewerSessionRevocationViewerSession.viewerSessionVersionsLessThanOrEqualTo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, viewerId, viewerSessionVersionsLessThanOrEqualTo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchStartViewerSessionRevocationViewerSession {\n");
    sb.append("    channelArn: ").append(toIndentedString(channelArn)).append("\n");
    sb.append("    viewerId: ").append(toIndentedString(viewerId)).append("\n");
    sb.append("    viewerSessionVersionsLessThanOrEqualTo: ").append(toIndentedString(viewerSessionVersionsLessThanOrEqualTo)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("viewerSessionVersionsLessThanOrEqualTo");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("channelArn");
    openapiRequiredFields.add("viewerId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchStartViewerSessionRevocationViewerSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchStartViewerSessionRevocationViewerSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchStartViewerSessionRevocationViewerSession is not found in the empty JSON string", BatchStartViewerSessionRevocationViewerSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchStartViewerSessionRevocationViewerSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchStartViewerSessionRevocationViewerSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchStartViewerSessionRevocationViewerSession.openapiRequiredFields) {
      ...
      // validate the required field `viewerId`
      String.validateJsonElement(jsonObj.get("viewerId"));
      // validate the optional field `viewerSessionVersionsLessThanOrEqualTo`
      if (jsonObj.get("viewerSessionVersionsLessThanOrEqualTo") != null && !jsonObj.get("viewerSessionVersionsLessThanOrEqualTo").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("viewerSessionVersionsLessThanOrEqualTo"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchStartViewerSessionRevocationViewerSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchStartViewerSessionRevocationViewerSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchStartViewerSessionRevocationViewerSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchStartViewerSessionRevocationViewerSession.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchStartViewerSessionRevocationViewerSession>() {
           @Override
           public void write(JsonWriter out, BatchStartViewerSessionRevocationViewerSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchStartViewerSessionRevocationViewerSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchStartViewerSessionRevocationViewerSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchStartViewerSessionRevocationViewerSession
   * @throws IOException if the JSON string is invalid with respect to BatchStartViewerSessionRevocationViewerSession
   */
  public static BatchStartViewerSessionRevocationViewerSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchStartViewerSessionRevocationViewerSession.class);
  }

  /**
   * Convert an instance of BatchStartViewerSessionRevocationViewerSession to an JSON string
   *
   * @return JSON string
   */
