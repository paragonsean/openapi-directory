...
public class RecordingConfigurationSummary {
  ...
  public RecordingConfigurationSummary() {
  }

  public RecordingConfigurationSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RecordingConfigurationSummary destinationConfiguration(RecordingConfigurationDestinationConfiguration destinationConfiguration) {
  ...
  public RecordingConfigurationSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RecordingConfigurationSummary state(RecordingConfigurationState state) {
    this.state = state;
    return this;
  }
  ...
  public RecordingConfigurationSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RecordingConfigurationSummary recordingConfigurationSummary = (RecordingConfigurationSummary) o;
    return Objects.equals(this.arn, recordingConfigurationSummary.arn) &&
        Objects.equals(this.destinationConfiguration, recordingConfigurationSummary.destinationConfiguration) &&
        Objects.equals(this.name, recordingConfigurationSummary.name) &&
        Objects.equals(this.state, recordingConfigurationSummary.state) &&
        Objects.equals(this.tags, recordingConfigurationSummary.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, destinationConfiguration, name, state, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecordingConfigurationSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecordingConfigurationSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecordingConfigurationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecordingConfigurationSummary is not found in the empty JSON string", RecordingConfigurationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecordingConfigurationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecordingConfigurationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecordingConfigurationSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecordingConfigurationSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecordingConfigurationSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecordingConfigurationSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecordingConfigurationSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<RecordingConfigurationSummary>() {
           @Override
           public void write(JsonWriter out, RecordingConfigurationSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecordingConfigurationSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecordingConfigurationSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecordingConfigurationSummary
   * @throws IOException if the JSON string is invalid with respect to RecordingConfigurationSummary
   */
  public static RecordingConfigurationSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecordingConfigurationSummary.class);
  }

  /**
   * Convert an instance of RecordingConfigurationSummary to an JSON string
   *
   * @return JSON string
   */
