...
import org.openapitools.client.model.StreamSessionChannel;
import org.openapitools.client.model.StreamSessionIngestConfiguration;
import org.openapitools.client.model.StreamSessionRecordingConfiguration;
...
public class GetStreamSessionResponseStreamSession {
  public static final String SERIALIZED_NAME_CHANNEL = "channel";
  @SerializedName(SERIALIZED_NAME_CHANNEL)
  private StreamSessionChannel channel;

  public static final String SERIALIZED_NAME_END_TIME = "endTime";
  @SerializedName(SERIALIZED_NAME_END_TIME)
  private OffsetDateTime endTime;

  public static final String SERIALIZED_NAME_INGEST_CONFIGURATION = "ingestConfiguration";
  @SerializedName(SERIALIZED_NAME_INGEST_CONFIGURATION)
  private StreamSessionIngestConfiguration ingestConfiguration;

  public static final String SERIALIZED_NAME_RECORDING_CONFIGURATION = "recordingConfiguration";
  @SerializedName(SERIALIZED_NAME_RECORDING_CONFIGURATION)
  private StreamSessionRecordingConfiguration recordingConfiguration;
  ...
  public static final String SERIALIZED_NAME_TRUNCATED_EVENTS = "truncatedEvents";
  @SerializedName(SERIALIZED_NAME_TRUNCATED_EVENTS)
  private List truncatedEvents;

  public GetStreamSessionResponseStreamSession() {
  }

  public GetStreamSessionResponseStreamSession channel(StreamSessionChannel channel) {
  ...
  public StreamSessionChannel getChannel() {
    return channel;
  }

  public void setChannel(StreamSessionChannel channel) {
    this.channel = channel;
  }


  public GetStreamSessionResponseStreamSession endTime(OffsetDateTime endTime) {
  ...
  public GetStreamSessionResponseStreamSession ingestConfiguration(StreamSessionIngestConfiguration ingestConfiguration) {
    this.ingestConfiguration = ingestConfiguration;
    return this;
  }

  /**
   * Get ingestConfiguration
   * @return ingestConfiguration
   */
  @javax.annotation.Nullable
  public StreamSessionIngestConfiguration getIngestConfiguration() {
    return ingestConfiguration;
  }

  public void setIngestConfiguration(StreamSessionIngestConfiguration ingestConfiguration) {
    this.ingestConfiguration = ingestConfiguration;
  }


  public GetStreamSessionResponseStreamSession recordingConfiguration(StreamSessionRecordingConfiguration recordingConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public StreamSessionRecordingConfiguration getRecordingConfiguration() {
    return recordingConfiguration;
  }

  public void setRecordingConfiguration(StreamSessionRecordingConfiguration recordingConfiguration) {
    this.recordingConfiguration = recordingConfiguration;
  }


  public GetStreamSessionResponseStreamSession startTime(OffsetDateTime startTime) {
  ...
  public GetStreamSessionResponseStreamSession streamId(String streamId) {
  ...
  public GetStreamSessionResponseStreamSession truncatedEvents(List truncatedEvents) {
   ...
   */
  @javax.annotation.Nullable
  public List getTruncatedEvents() {
    return truncatedEvents;
  }

  public void setTruncatedEvents(List truncatedEvents) {
    this.truncatedEvents = truncatedEvents;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStreamSessionResponseStreamSession getStreamSessionResponseStreamSession = (GetStreamSessionResponseStreamSession) o;
    return Objects.equals(this.channel, getStreamSessionResponseStreamSession.channel) &&
        Objects.equals(this.endTime, getStreamSessionResponseStreamSession.endTime) &&
        Objects.equals(this.ingestConfiguration, getStreamSessionResponseStreamSession.ingestConfiguration) &&
        Objects.equals(this.recordingConfiguration, getStreamSessionResponseStreamSession.recordingConfiguration) &&
        Objects.equals(this.startTime, getStreamSessionResponseStreamSession.startTime) &&
        Objects.equals(this.streamId, getStreamSessionResponseStreamSession.streamId) &&
        Objects.equals(this.truncatedEvents, getStreamSessionResponseStreamSession.truncatedEvents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channel, endTime, ingestConfiguration, recordingConfiguration, startTime, streamId, truncatedEvents);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStreamSessionResponseStreamSession {\n");
    sb.append("    channel: ").append(toIndentedString(channel)).append("\n");
    sb.append("    endTime: ").append(toIndentedString(endTime)).append("\n");
    sb.append("    ingestConfiguration: ").append(toIndentedString(ingestConfiguration)).append("\n");
    sb.append("    recordingConfiguration: ").append(toIndentedString(recordingConfiguration)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ingestConfiguration");
    openapiFields.add("recordingConfiguration");
    openapiFields.add("startTime");
    openapiFields.add("streamId");
    openapiFields.add("truncatedEvents");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamSessionResponseStreamSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamSessionResponseStreamSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamSessionResponseStreamSession is not found in the empty JSON string", GetStreamSessionResponseStreamSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamSessionResponseStreamSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamSessionResponseStreamSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `channel`
      if (jsonObj.get("channel") != null && !jsonObj.get("channel").isJsonNull()) {
        StreamSessionChannel.validateJsonElement(jsonObj.get("channel"));
      }
      // validate the optional field `endTime`
      if (jsonObj.get("endTime") != null && !jsonObj.get("endTime").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("endTime"));
      }
      // validate the optional field `ingestConfiguration`
      if (jsonObj.get("ingestConfiguration") != null && !jsonObj.get("ingestConfiguration").isJsonNull()) {
        StreamSessionIngestConfiguration.validateJsonElement(jsonObj.get("ingestConfiguration"));
      }
      // validate the optional field `recordingConfiguration`
      if (jsonObj.get("recordingConfiguration") != null && !jsonObj.get("recordingConfiguration").isJsonNull()) {
        StreamSessionRecordingConfiguration.validateJsonElement(jsonObj.get("recordingConfiguration"));
      }
      ...
      // validate the optional field `truncatedEvents`
      if (jsonObj.get("truncatedEvents") != null && !jsonObj.get("truncatedEvents").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("truncatedEvents"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamSessionResponseStreamSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamSessionResponseStreamSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamSessionResponseStreamSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamSessionResponseStreamSession.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamSessionResponseStreamSession>() {
           @Override
           public void write(JsonWriter out, GetStreamSessionResponseStreamSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamSessionResponseStreamSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamSessionResponseStreamSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamSessionResponseStreamSession
   * @throws IOException if the JSON string is invalid with respect to GetStreamSessionResponseStreamSession
   */
  public static GetStreamSessionResponseStreamSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamSessionResponseStreamSession.class);
  }

  /**
   * Convert an instance of GetStreamSessionResponseStreamSession to an JSON string
   *
   * @return JSON string
   */
