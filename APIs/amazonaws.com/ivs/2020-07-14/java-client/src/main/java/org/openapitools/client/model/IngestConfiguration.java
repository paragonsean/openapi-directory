...
public class IngestConfiguration {
  ...
  public IngestConfiguration audio(IngestConfigurationAudio audio) {
    this.audio = audio;
    return this;
  }
  ...
  public IngestConfiguration video(IngestConfigurationVideo video) {
    this.video = video;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IngestConfiguration ingestConfiguration = (IngestConfiguration) o;
    return Objects.equals(this.audio, ingestConfiguration.audio) &&
        Objects.equals(this.video, ingestConfiguration.video);
  }
  ...
  public String toString() {
    ...
    sb.append("class IngestConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IngestConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IngestConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IngestConfiguration is not found in the empty JSON string", IngestConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IngestConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IngestConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestConfiguration>() {
           @Override
           public void write(JsonWriter out, IngestConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IngestConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IngestConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IngestConfiguration
   * @throws IOException if the JSON string is invalid with respect to IngestConfiguration
   */
  public static IngestConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestConfiguration.class);
  }

  /**
   * Convert an instance of IngestConfiguration to an JSON string
   *
   * @return JSON string
   */
