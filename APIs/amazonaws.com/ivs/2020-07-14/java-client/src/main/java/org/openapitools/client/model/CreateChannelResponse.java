...
import org.openapitools.client.model.CreateChannelResponseStreamKey;
...
public class CreateChannelResponse {
  ...
  private CreateChannelResponseChannel channel;

  public static final String SERIALIZED_NAME_STREAM_KEY = "streamKey";
  @SerializedName(SERIALIZED_NAME_STREAM_KEY)
  private CreateChannelResponseStreamKey streamKey;

  public CreateChannelResponse() {
  }

  public CreateChannelResponse channel(CreateChannelResponseChannel channel) {
  ...
  public CreateChannelResponseChannel getChannel() {
    return channel;
  }

  public void setChannel(CreateChannelResponseChannel channel) {
    this.channel = channel;
  }


  public CreateChannelResponse streamKey(CreateChannelResponseStreamKey streamKey) {
   ...
   */
  @javax.annotation.Nullable
  public CreateChannelResponseStreamKey getStreamKey() {
    return streamKey;
  }

  public void setStreamKey(CreateChannelResponseStreamKey streamKey) {
    this.streamKey = streamKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channel, createChannelResponse.channel) &&
        Objects.equals(this.streamKey, createChannelResponse.streamKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channel, streamKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("channel") != null && !jsonObj.get("channel").isJsonNull()) {
        CreateChannelResponseChannel.validateJsonElement(jsonObj.get("channel"));
      }
      // validate the optional field `streamKey`
      if (jsonObj.get("streamKey") != null && !jsonObj.get("streamKey").isJsonNull()) {
        CreateChannelResponseStreamKey.validateJsonElement(jsonObj.get("streamKey"));
      }
  }
