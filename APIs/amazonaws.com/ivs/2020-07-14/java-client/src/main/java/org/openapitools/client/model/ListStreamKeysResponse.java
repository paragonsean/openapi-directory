...
public class ListStreamKeysResponse {
  ...
  public static final String SERIALIZED_NAME_STREAM_KEYS = "streamKeys";
  @SerializedName(SERIALIZED_NAME_STREAM_KEYS)
  private List streamKeys;

  public ListStreamKeysResponse() {
  }

  public ListStreamKeysResponse nextToken(String nextToken) {
  ...
  public ListStreamKeysResponse streamKeys(List streamKeys) {
  ...
  public List getStreamKeys() {
    return streamKeys;
  }

  public void setStreamKeys(List streamKeys) {
    this.streamKeys = streamKeys;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListStreamKeysResponse listStreamKeysResponse = (ListStreamKeysResponse) o;
    return Objects.equals(this.nextToken, listStreamKeysResponse.nextToken) &&
        Objects.equals(this.streamKeys, listStreamKeysResponse.streamKeys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, streamKeys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListStreamKeysResponse {\n");
  ...
  static {
    ...
    openapiFields.add("streamKeys");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("streamKeys");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamKeysResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamKeysResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamKeysResponse is not found in the empty JSON string", ListStreamKeysResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamKeysResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamKeysResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListStreamKeysResponse.openapiRequiredFields) {
      ...
      // validate the required field `streamKeys`
      List.validateJsonElement(jsonObj.get("streamKeys"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamKeysResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamKeysResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamKeysResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamKeysResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamKeysResponse>() {
           @Override
           public void write(JsonWriter out, ListStreamKeysResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamKeysResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamKeysResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamKeysResponse
   * @throws IOException if the JSON string is invalid with respect to ListStreamKeysResponse
   */
  public static ListStreamKeysResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamKeysResponse.class);
  }

  /**
   * Convert an instance of ListStreamKeysResponse to an JSON string
   *
   * @return JSON string
   */
