...
public class CreateRecordingConfigurationRequestDestinationConfigurationS3 {
  public static final String SERIALIZED_NAME_BUCKET_NAME = "bucketName";
  @SerializedName(SERIALIZED_NAME_BUCKET_NAME)
  private String bucketName;

  public CreateRecordingConfigurationRequestDestinationConfigurationS3() {
  }

  public CreateRecordingConfigurationRequestDestinationConfigurationS3 bucketName(String bucketName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationRequestDestinationConfigurationS3 createRecordingConfigurationRequestDestinationConfigurationS3 = (CreateRecordingConfigurationRequestDestinationConfigurationS3) o;
    return Objects.equals(this.bucketName, createRecordingConfigurationRequestDestinationConfigurationS3.bucketName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRecordingConfigurationRequestDestinationConfigurationS3 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationRequestDestinationConfigurationS3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationRequestDestinationConfigurationS3 is not found in the empty JSON string", CreateRecordingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationRequestDestinationConfigurationS3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationRequestDestinationConfigurationS3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRecordingConfigurationRequestDestinationConfigurationS3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationRequestDestinationConfigurationS3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationRequestDestinationConfigurationS3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationRequestDestinationConfigurationS3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationRequestDestinationConfigurationS3.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationRequestDestinationConfigurationS3>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationRequestDestinationConfigurationS3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationRequestDestinationConfigurationS3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationRequestDestinationConfigurationS3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationRequestDestinationConfigurationS3
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationRequestDestinationConfigurationS3
   */
  public static CreateRecordingConfigurationRequestDestinationConfigurationS3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationRequestDestinationConfigurationS3.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationRequestDestinationConfigurationS3 to an JSON string
   *
   * @return JSON string
   */
