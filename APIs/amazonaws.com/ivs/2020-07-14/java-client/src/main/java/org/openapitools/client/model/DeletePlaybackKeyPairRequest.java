...
public class DeletePlaybackKeyPairRequest {
  ...
  public DeletePlaybackKeyPairRequest() {
  }

  public DeletePlaybackKeyPairRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeletePlaybackKeyPairRequest deletePlaybackKeyPairRequest = (DeletePlaybackKeyPairRequest) o;
    return Objects.equals(this.arn, deletePlaybackKeyPairRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePlaybackKeyPairRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePlaybackKeyPairRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePlaybackKeyPairRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePlaybackKeyPairRequest is not found in the empty JSON string", DeletePlaybackKeyPairRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePlaybackKeyPairRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePlaybackKeyPairRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePlaybackKeyPairRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePlaybackKeyPairRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePlaybackKeyPairRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePlaybackKeyPairRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePlaybackKeyPairRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePlaybackKeyPairRequest>() {
           @Override
           public void write(JsonWriter out, DeletePlaybackKeyPairRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePlaybackKeyPairRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePlaybackKeyPairRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePlaybackKeyPairRequest
   * @throws IOException if the JSON string is invalid with respect to DeletePlaybackKeyPairRequest
   */
  public static DeletePlaybackKeyPairRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePlaybackKeyPairRequest.class);
  }

  /**
   * Convert an instance of DeletePlaybackKeyPairRequest to an JSON string
   *
   * @return JSON string
   */
