...
public class BatchGetStreamKeyResponse {
  ...
  public BatchGetStreamKeyResponse errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public BatchGetStreamKeyResponse streamKeys(List streamKeys) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetStreamKeyResponse batchGetStreamKeyResponse = (BatchGetStreamKeyResponse) o;
    return Objects.equals(this.errors, batchGetStreamKeyResponse.errors) &&
        Objects.equals(this.streamKeys, batchGetStreamKeyResponse.streamKeys);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errors, streamKeys);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetStreamKeyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetStreamKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetStreamKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetStreamKeyResponse is not found in the empty JSON string", BatchGetStreamKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetStreamKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetStreamKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `streamKeys`
      if (jsonObj.get("streamKeys") != null && !jsonObj.get("streamKeys").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetStreamKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetStreamKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetStreamKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetStreamKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetStreamKeyResponse>() {
           @Override
           public void write(JsonWriter out, BatchGetStreamKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetStreamKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetStreamKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetStreamKeyResponse
   * @throws IOException if the JSON string is invalid with respect to BatchGetStreamKeyResponse
   */
  public static BatchGetStreamKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetStreamKeyResponse.class);
  }

  /**
   * Convert an instance of BatchGetStreamKeyResponse to an JSON string
   *
   * @return JSON string
   */
