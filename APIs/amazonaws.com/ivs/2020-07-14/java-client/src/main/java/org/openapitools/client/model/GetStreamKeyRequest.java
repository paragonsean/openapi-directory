...
public class GetStreamKeyRequest {
  ...
  public GetStreamKeyRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStreamKeyRequest getStreamKeyRequest = (GetStreamKeyRequest) o;
    return Objects.equals(this.arn, getStreamKeyRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStreamKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamKeyRequest is not found in the empty JSON string", GetStreamKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStreamKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamKeyRequest>() {
           @Override
           public void write(JsonWriter out, GetStreamKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamKeyRequest
   * @throws IOException if the JSON string is invalid with respect to GetStreamKeyRequest
   */
  public static GetStreamKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamKeyRequest.class);
  }

  /**
   * Convert an instance of GetStreamKeyRequest to an JSON string
   *
   * @return JSON string
   */
