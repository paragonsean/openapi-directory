...
public class GetPlaybackKeyPairResponseKeyPair {
  ...
  public GetPlaybackKeyPairResponseKeyPair() {
  }

  public GetPlaybackKeyPairResponseKeyPair arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetPlaybackKeyPairResponseKeyPair fingerprint(String fingerprint) {
  ...
  public GetPlaybackKeyPairResponseKeyPair name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetPlaybackKeyPairResponseKeyPair tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPlaybackKeyPairResponseKeyPair getPlaybackKeyPairResponseKeyPair = (GetPlaybackKeyPairResponseKeyPair) o;
    return Objects.equals(this.arn, getPlaybackKeyPairResponseKeyPair.arn) &&
        Objects.equals(this.fingerprint, getPlaybackKeyPairResponseKeyPair.fingerprint) &&
        Objects.equals(this.name, getPlaybackKeyPairResponseKeyPair.name) &&
        Objects.equals(this.tags, getPlaybackKeyPairResponseKeyPair.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPlaybackKeyPairResponseKeyPair {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPlaybackKeyPairResponseKeyPair
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPlaybackKeyPairResponseKeyPair.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPlaybackKeyPairResponseKeyPair is not found in the empty JSON string", GetPlaybackKeyPairResponseKeyPair.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPlaybackKeyPairResponseKeyPair.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPlaybackKeyPairResponseKeyPair` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPlaybackKeyPairResponseKeyPair.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPlaybackKeyPairResponseKeyPair' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPlaybackKeyPairResponseKeyPair> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPlaybackKeyPairResponseKeyPair.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPlaybackKeyPairResponseKeyPair>() {
           @Override
           public void write(JsonWriter out, GetPlaybackKeyPairResponseKeyPair value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPlaybackKeyPairResponseKeyPair read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPlaybackKeyPairResponseKeyPair given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPlaybackKeyPairResponseKeyPair
   * @throws IOException if the JSON string is invalid with respect to GetPlaybackKeyPairResponseKeyPair
   */
  public static GetPlaybackKeyPairResponseKeyPair fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPlaybackKeyPairResponseKeyPair.class);
  }

  /**
   * Convert an instance of GetPlaybackKeyPairResponseKeyPair to an JSON string
   *
   * @return JSON string
   */
