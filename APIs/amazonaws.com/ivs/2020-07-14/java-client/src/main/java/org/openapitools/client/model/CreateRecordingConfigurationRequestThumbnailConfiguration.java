...
public class CreateRecordingConfigurationRequestThumbnailConfiguration {
  public static final String SERIALIZED_NAME_RECORDING_MODE = "recordingMode";
  ...
  private ThumbnailConfigurationResolution resolution;

  public static final String SERIALIZED_NAME_STORAGE = "storage";
  @SerializedName(SERIALIZED_NAME_STORAGE)
  private List storage;

  public static final String SERIALIZED_NAME_TARGET_INTERVAL_SECONDS = "targetIntervalSeconds";
  @SerializedName(SERIALIZED_NAME_TARGET_INTERVAL_SECONDS)
  private Integer targetIntervalSeconds;

  public CreateRecordingConfigurationRequestThumbnailConfiguration() {
  }

  public CreateRecordingConfigurationRequestThumbnailConfiguration recordingMode(RecordingMode recordingMode) {
  ...
  public CreateRecordingConfigurationRequestThumbnailConfiguration resolution(ThumbnailConfigurationResolution resolution) {
   ...
   */
  @javax.annotation.Nullable
  public ThumbnailConfigurationResolution getResolution() {
    return resolution;
  }

  public void setResolution(ThumbnailConfigurationResolution resolution) {
    this.resolution = resolution;
  }


  public CreateRecordingConfigurationRequestThumbnailConfiguration storage(List storage) {
  ...
  public CreateRecordingConfigurationRequestThumbnailConfiguration targetIntervalSeconds(Integer targetIntervalSeconds) {
    this.targetIntervalSeconds = targetIntervalSeconds;
    return this;
  }

  /**
   * Get targetIntervalSeconds
   * @return targetIntervalSeconds
   */
  @javax.annotation.Nullable
  public Integer getTargetIntervalSeconds() {
    return targetIntervalSeconds;
  }

  public void setTargetIntervalSeconds(Integer targetIntervalSeconds) {
    this.targetIntervalSeconds = targetIntervalSeconds;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationRequestThumbnailConfiguration createRecordingConfigurationRequestThumbnailConfiguration = (CreateRecordingConfigurationRequestThumbnailConfiguration) o;
    return Objects.equals(this.recordingMode, createRecordingConfigurationRequestThumbnailConfiguration.recordingMode) &&
        Objects.equals(this.resolution, createRecordingConfigurationRequestThumbnailConfiguration.resolution) &&
        Objects.equals(this.storage, createRecordingConfigurationRequestThumbnailConfiguration.storage) &&
        Objects.equals(this.targetIntervalSeconds, createRecordingConfigurationRequestThumbnailConfiguration.targetIntervalSeconds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordingMode, resolution, storage, targetIntervalSeconds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateRecordingConfigurationRequestThumbnailConfiguration {\n");
    sb.append("    recordingMode: ").append(toIndentedString(recordingMode)).append("\n");
    sb.append("    resolution: ").append(toIndentedString(resolution)).append("\n");
    sb.append("    storage: ").append(toIndentedString(storage)).append("\n");
    sb.append("    targetIntervalSeconds: ").append(toIndentedString(targetIntervalSeconds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("recordingMode");
    openapiFields.add("resolution");
    openapiFields.add("storage");
    openapiFields.add("targetIntervalSeconds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationRequestThumbnailConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationRequestThumbnailConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationRequestThumbnailConfiguration is not found in the empty JSON string", CreateRecordingConfigurationRequestThumbnailConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationRequestThumbnailConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationRequestThumbnailConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `recordingMode`
      if (jsonObj.get("recordingMode") != null && !jsonObj.get("recordingMode").isJsonNull()) {
        RecordingMode.validateJsonElement(jsonObj.get("recordingMode"));
      }
      // validate the optional field `resolution`
      if (jsonObj.get("resolution") != null && !jsonObj.get("resolution").isJsonNull()) {
        ThumbnailConfigurationResolution.validateJsonElement(jsonObj.get("resolution"));
      }
      ...
      if (jsonObj.get("targetIntervalSeconds") != null && !jsonObj.get("targetIntervalSeconds").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("targetIntervalSeconds"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationRequestThumbnailConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationRequestThumbnailConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationRequestThumbnailConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationRequestThumbnailConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationRequestThumbnailConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationRequestThumbnailConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationRequestThumbnailConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationRequestThumbnailConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationRequestThumbnailConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationRequestThumbnailConfiguration
   */
  public static CreateRecordingConfigurationRequestThumbnailConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationRequestThumbnailConfiguration.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationRequestThumbnailConfiguration to an JSON string
   *
   * @return JSON string
   */
