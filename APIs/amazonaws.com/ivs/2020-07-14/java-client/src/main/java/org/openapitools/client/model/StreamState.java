 ...
 */
@JsonAdapter(StreamState.Adapter.class)
public enum StreamState {
  ...
  public static StreamState fromValue(String value) {
    for (StreamState b : StreamState.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamState> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamState.fromValue(value);
  }
}
