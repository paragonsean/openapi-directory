...
public class CreateChannelResponseChannel {
  ...
  public static final String SERIALIZED_NAME_INGEST_ENDPOINT = "ingestEndpoint";
  @SerializedName(SERIALIZED_NAME_INGEST_ENDPOINT)
  ...
  public CreateChannelResponseChannel() {
  }

  public CreateChannelResponseChannel arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateChannelResponseChannel authorized(Boolean authorized) {
  ...
  public CreateChannelResponseChannel ingestEndpoint(String ingestEndpoint) {
  ...
  public CreateChannelResponseChannel insecureIngest(Boolean insecureIngest) {
  ...
  public CreateChannelResponseChannel latencyMode(ChannelLatencyMode latencyMode) {
  ...
  public CreateChannelResponseChannel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateChannelResponseChannel playbackUrl(String playbackUrl) {
  ...
  public CreateChannelResponseChannel preset(TranscodePreset preset) {
    this.preset = preset;
    return this;
  }
  ...
  public CreateChannelResponseChannel recordingConfigurationArn(String recordingConfigurationArn) {
  ...
  public CreateChannelResponseChannel tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateChannelResponseChannel type(ChannelType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateChannelResponseChannel createChannelResponseChannel = (CreateChannelResponseChannel) o;
    return Objects.equals(this.arn, createChannelResponseChannel.arn) &&
        Objects.equals(this.authorized, createChannelResponseChannel.authorized) &&
        Objects.equals(this.ingestEndpoint, createChannelResponseChannel.ingestEndpoint) &&
        Objects.equals(this.insecureIngest, createChannelResponseChannel.insecureIngest) &&
        Objects.equals(this.latencyMode, createChannelResponseChannel.latencyMode) &&
        Objects.equals(this.name, createChannelResponseChannel.name) &&
        Objects.equals(this.playbackUrl, createChannelResponseChannel.playbackUrl) &&
        Objects.equals(this.preset, createChannelResponseChannel.preset) &&
        Objects.equals(this.recordingConfigurationArn, createChannelResponseChannel.recordingConfigurationArn) &&
        Objects.equals(this.tags, createChannelResponseChannel.tags) &&
        Objects.equals(this.type, createChannelResponseChannel.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, authorized, ingestEndpoint, insecureIngest, latencyMode, name, playbackUrl, preset, recordingConfigurationArn, tags, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateChannelResponseChannel {\n");
    sb.append("    arn: ").append(toIndentedString(arn)).append("\n");
    sb.append("    authorized: ").append(toIndentedString(authorized)).append("\n");
    sb.append("    ingestEndpoint: ").append(toIndentedString(ingestEndpoint)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ingestEndpoint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChannelResponseChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChannelResponseChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChannelResponseChannel is not found in the empty JSON string", CreateChannelResponseChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChannelResponseChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateChannelResponseChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `ingestEndpoint`
      if (jsonObj.get("ingestEndpoint") != null && !jsonObj.get("ingestEndpoint").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ingestEndpoint"));
      }
      ...
      if (jsonObj.get("playbackUrl") != null && !jsonObj.get("playbackUrl").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChannelResponseChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChannelResponseChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChannelResponseChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChannelResponseChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChannelResponseChannel>() {
           @Override
           public void write(JsonWriter out, CreateChannelResponseChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChannelResponseChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChannelResponseChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChannelResponseChannel
   * @throws IOException if the JSON string is invalid with respect to CreateChannelResponseChannel
   */
  public static CreateChannelResponseChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChannelResponseChannel.class);
  }

  /**
   * Convert an instance of CreateChannelResponseChannel to an JSON string
   *
   * @return JSON string
   */
