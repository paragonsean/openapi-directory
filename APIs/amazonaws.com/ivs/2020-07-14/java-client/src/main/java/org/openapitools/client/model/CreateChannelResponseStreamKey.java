...
public class CreateChannelResponseStreamKey {
  ...
  public CreateChannelResponseStreamKey() {
  }

  public CreateChannelResponseStreamKey arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateChannelResponseStreamKey channelArn(String channelArn) {
  ...
  public CreateChannelResponseStreamKey tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateChannelResponseStreamKey value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateChannelResponseStreamKey createChannelResponseStreamKey = (CreateChannelResponseStreamKey) o;
    return Objects.equals(this.arn, createChannelResponseStreamKey.arn) &&
        Objects.equals(this.channelArn, createChannelResponseStreamKey.channelArn) &&
        Objects.equals(this.tags, createChannelResponseStreamKey.tags) &&
        Objects.equals(this.value, createChannelResponseStreamKey.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateChannelResponseStreamKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChannelResponseStreamKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChannelResponseStreamKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateChannelResponseStreamKey is not found in the empty JSON string", CreateChannelResponseStreamKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChannelResponseStreamKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateChannelResponseStreamKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChannelResponseStreamKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChannelResponseStreamKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChannelResponseStreamKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChannelResponseStreamKey.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChannelResponseStreamKey>() {
           @Override
           public void write(JsonWriter out, CreateChannelResponseStreamKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChannelResponseStreamKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChannelResponseStreamKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChannelResponseStreamKey
   * @throws IOException if the JSON string is invalid with respect to CreateChannelResponseStreamKey
   */
  public static CreateChannelResponseStreamKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChannelResponseStreamKey.class);
  }

  /**
   * Convert an instance of CreateChannelResponseStreamKey to an JSON string
   *
   * @return JSON string
   */
