...
public class PlaybackKeyPairSummary {
  ...
  public PlaybackKeyPairSummary() {
  }

  public PlaybackKeyPairSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public PlaybackKeyPairSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaybackKeyPairSummary tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlaybackKeyPairSummary playbackKeyPairSummary = (PlaybackKeyPairSummary) o;
    return Objects.equals(this.arn, playbackKeyPairSummary.arn) &&
        Objects.equals(this.name, playbackKeyPairSummary.name) &&
        Objects.equals(this.tags, playbackKeyPairSummary.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, name, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PlaybackKeyPairSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaybackKeyPairSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaybackKeyPairSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaybackKeyPairSummary is not found in the empty JSON string", PlaybackKeyPairSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaybackKeyPairSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaybackKeyPairSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaybackKeyPairSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaybackKeyPairSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaybackKeyPairSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaybackKeyPairSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaybackKeyPairSummary>() {
           @Override
           public void write(JsonWriter out, PlaybackKeyPairSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaybackKeyPairSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaybackKeyPairSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaybackKeyPairSummary
   * @throws IOException if the JSON string is invalid with respect to PlaybackKeyPairSummary
   */
  public static PlaybackKeyPairSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaybackKeyPairSummary.class);
  }

  /**
   * Convert an instance of PlaybackKeyPairSummary to an JSON string
   *
   * @return JSON string
   */
