...
public class ImportPlaybackKeyPairRequest {
  ...
  public static final String SERIALIZED_NAME_PUBLIC_KEY_MATERIAL = "publicKeyMaterial";
  @SerializedName(SERIALIZED_NAME_PUBLIC_KEY_MATERIAL)
  ...
  public ImportPlaybackKeyPairRequest() {
  }

  public ImportPlaybackKeyPairRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportPlaybackKeyPairRequest publicKeyMaterial(String publicKeyMaterial) {
  ...
  public ImportPlaybackKeyPairRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public ImportPlaybackKeyPairRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    ImportPlaybackKeyPairRequest importPlaybackKeyPairRequest = (ImportPlaybackKeyPairRequest) o;
    return Objects.equals(this.name, importPlaybackKeyPairRequest.name) &&
        Objects.equals(this.publicKeyMaterial, importPlaybackKeyPairRequest.publicKeyMaterial) &&
        Objects.equals(this.tags, importPlaybackKeyPairRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, publicKeyMaterial, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportPlaybackKeyPairRequest {\n");
  ...
  static {
    ...
    openapiFields.add("publicKeyMaterial");
    openapiFields.add("tags");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("publicKeyMaterial");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportPlaybackKeyPairRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportPlaybackKeyPairRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportPlaybackKeyPairRequest is not found in the empty JSON string", ImportPlaybackKeyPairRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportPlaybackKeyPairRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportPlaybackKeyPairRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportPlaybackKeyPairRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("publicKeyMaterial").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `publicKeyMaterial` to be a primitive type in the JSON string but got `%s`", jsonObj.get("publicKeyMaterial").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportPlaybackKeyPairRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportPlaybackKeyPairRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportPlaybackKeyPairRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportPlaybackKeyPairRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportPlaybackKeyPairRequest>() {
           @Override
           public void write(JsonWriter out, ImportPlaybackKeyPairRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportPlaybackKeyPairRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportPlaybackKeyPairRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportPlaybackKeyPairRequest
   * @throws IOException if the JSON string is invalid with respect to ImportPlaybackKeyPairRequest
   */
  public static ImportPlaybackKeyPairRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportPlaybackKeyPairRequest.class);
  }

  /**
   * Convert an instance of ImportPlaybackKeyPairRequest to an JSON string
   *
   * @return JSON string
   */
