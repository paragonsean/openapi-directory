...
/**
 * Gets or Sets StreamHealth
 */
@JsonAdapter(StreamHealth.Adapter.class)
public enum StreamHealth {
  ...
  public static StreamHealth fromValue(String value) {
    for (StreamHealth b : StreamHealth.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamHealth> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamHealth enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamHealth read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamHealth.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamHealth.fromValue(value);
  }
}
