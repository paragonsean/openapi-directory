...
import org.openapitools.client.model.GetStreamSessionResponseStreamSession;
...
public class GetStreamSessionResponse {
  public static final String SERIALIZED_NAME_STREAM_SESSION = "streamSession";
  @SerializedName(SERIALIZED_NAME_STREAM_SESSION)
  private GetStreamSessionResponseStreamSession streamSession;

  public GetStreamSessionResponse() {
  }

  public GetStreamSessionResponse streamSession(GetStreamSessionResponseStreamSession streamSession) {
  ...
  public GetStreamSessionResponseStreamSession getStreamSession() {
    return streamSession;
  }

  public void setStreamSession(GetStreamSessionResponseStreamSession streamSession) {
    this.streamSession = streamSession;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStreamSessionResponse getStreamSessionResponse = (GetStreamSessionResponse) o;
    return Objects.equals(this.streamSession, getStreamSessionResponse.streamSession);
  }

  @Override
  public int hashCode() {
    return Objects.hash(streamSession);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStreamSessionResponse {\n");
    sb.append("    streamSession: ").append(toIndentedString(streamSession)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("streamSession");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamSessionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamSessionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamSessionResponse is not found in the empty JSON string", GetStreamSessionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamSessionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamSessionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `streamSession`
      if (jsonObj.get("streamSession") != null && !jsonObj.get("streamSession").isJsonNull()) {
        GetStreamSessionResponseStreamSession.validateJsonElement(jsonObj.get("streamSession"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamSessionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamSessionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamSessionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamSessionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamSessionResponse>() {
           @Override
           public void write(JsonWriter out, GetStreamSessionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamSessionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamSessionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamSessionResponse
   * @throws IOException if the JSON string is invalid with respect to GetStreamSessionResponse
   */
  public static GetStreamSessionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamSessionResponse.class);
  }

  /**
   * Convert an instance of GetStreamSessionResponse to an JSON string
   *
   * @return JSON string
   */
