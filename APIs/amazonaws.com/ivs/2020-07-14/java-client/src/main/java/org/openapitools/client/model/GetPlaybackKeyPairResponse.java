...
import org.openapitools.client.model.GetPlaybackKeyPairResponseKeyPair;
...
public class GetPlaybackKeyPairResponse {
  ...
  private GetPlaybackKeyPairResponseKeyPair keyPair;

  public GetPlaybackKeyPairResponse() {
  }

  public GetPlaybackKeyPairResponse keyPair(GetPlaybackKeyPairResponseKeyPair keyPair) {
  ...
  public GetPlaybackKeyPairResponseKeyPair getKeyPair() {
    return keyPair;
  }

  public void setKeyPair(GetPlaybackKeyPairResponseKeyPair keyPair) {
    this.keyPair = keyPair;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPlaybackKeyPairResponse getPlaybackKeyPairResponse = (GetPlaybackKeyPairResponse) o;
    return Objects.equals(this.keyPair, getPlaybackKeyPairResponse.keyPair);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPlaybackKeyPairResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPlaybackKeyPairResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPlaybackKeyPairResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPlaybackKeyPairResponse is not found in the empty JSON string", GetPlaybackKeyPairResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPlaybackKeyPairResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPlaybackKeyPairResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `keyPair`
      if (jsonObj.get("keyPair") != null && !jsonObj.get("keyPair").isJsonNull()) {
        GetPlaybackKeyPairResponseKeyPair.validateJsonElement(jsonObj.get("keyPair"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPlaybackKeyPairResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPlaybackKeyPairResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPlaybackKeyPairResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPlaybackKeyPairResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPlaybackKeyPairResponse>() {
           @Override
           public void write(JsonWriter out, GetPlaybackKeyPairResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPlaybackKeyPairResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPlaybackKeyPairResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPlaybackKeyPairResponse
   * @throws IOException if the JSON string is invalid with respect to GetPlaybackKeyPairResponse
   */
  public static GetPlaybackKeyPairResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPlaybackKeyPairResponse.class);
  }

  /**
   * Convert an instance of GetPlaybackKeyPairResponse to an JSON string
   *
   * @return JSON string
   */
