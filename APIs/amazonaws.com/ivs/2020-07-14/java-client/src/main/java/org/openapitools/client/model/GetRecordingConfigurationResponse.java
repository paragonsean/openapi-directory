...
import org.openapitools.client.model.CreateRecordingConfigurationResponseRecordingConfiguration;
...
public class GetRecordingConfigurationResponse {
  ...
  private CreateRecordingConfigurationResponseRecordingConfiguration recordingConfiguration;

  public GetRecordingConfigurationResponse() {
  }

  public GetRecordingConfigurationResponse recordingConfiguration(CreateRecordingConfigurationResponseRecordingConfiguration recordingConfiguration) {
  ...
  public CreateRecordingConfigurationResponseRecordingConfiguration getRecordingConfiguration() {
    return recordingConfiguration;
  }

  public void setRecordingConfiguration(CreateRecordingConfigurationResponseRecordingConfiguration recordingConfiguration) {
    this.recordingConfiguration = recordingConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRecordingConfigurationResponse getRecordingConfigurationResponse = (GetRecordingConfigurationResponse) o;
    return Objects.equals(this.recordingConfiguration, getRecordingConfigurationResponse.recordingConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordingConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetRecordingConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRecordingConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRecordingConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRecordingConfigurationResponse is not found in the empty JSON string", GetRecordingConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRecordingConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRecordingConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("recordingConfiguration") != null && !jsonObj.get("recordingConfiguration").isJsonNull()) {
        CreateRecordingConfigurationResponseRecordingConfiguration.validateJsonElement(jsonObj.get("recordingConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRecordingConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRecordingConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRecordingConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRecordingConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRecordingConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, GetRecordingConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRecordingConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRecordingConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRecordingConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to GetRecordingConfigurationResponse
   */
  public static GetRecordingConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRecordingConfigurationResponse.class);
  }

  /**
   * Convert an instance of GetRecordingConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
