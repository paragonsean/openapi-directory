...
public class CreateRecordingConfigurationResponse {
  ...
  public CreateRecordingConfigurationResponse recordingConfiguration(CreateRecordingConfigurationResponseRecordingConfiguration recordingConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRecordingConfigurationResponse createRecordingConfigurationResponse = (CreateRecordingConfigurationResponse) o;
    return Objects.equals(this.recordingConfiguration, createRecordingConfigurationResponse.recordingConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRecordingConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecordingConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecordingConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRecordingConfigurationResponse is not found in the empty JSON string", CreateRecordingConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRecordingConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRecordingConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRecordingConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRecordingConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRecordingConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRecordingConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRecordingConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, CreateRecordingConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRecordingConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRecordingConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRecordingConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to CreateRecordingConfigurationResponse
   */
  public static CreateRecordingConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRecordingConfigurationResponse.class);
  }

  /**
   * Convert an instance of CreateRecordingConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
