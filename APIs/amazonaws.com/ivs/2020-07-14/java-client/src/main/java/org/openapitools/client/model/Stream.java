...
public class Stream {
  ...
  public Stream channelArn(String channelArn) {
  ...
  public Stream health(StreamHealth health) {
    this.health = health;
    return this;
  }
  ...
  public Stream playbackUrl(String playbackUrl) {
  ...
  public Stream startTime(OffsetDateTime startTime) {
  ...
  public Stream state(StreamState state) {
    this.state = state;
    return this;
  }
  ...
  public Stream viewerCount(Integer viewerCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channelArn, stream.channelArn) &&
        Objects.equals(this.health, stream.health) &&
        Objects.equals(this.playbackUrl, stream.playbackUrl) &&
        Objects.equals(this.startTime, stream.startTime) &&
        Objects.equals(this.state, stream.state) &&
        Objects.equals(this.streamId, stream.streamId) &&
        Objects.equals(this.viewerCount, stream.viewerCount);
  }
