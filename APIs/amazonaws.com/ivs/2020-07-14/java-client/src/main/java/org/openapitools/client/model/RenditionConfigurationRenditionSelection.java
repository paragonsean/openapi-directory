...
/**
 * Gets or Sets RenditionConfigurationRenditionSelection
 */
@JsonAdapter(RenditionConfigurationRenditionSelection.Adapter.class)
public enum RenditionConfigurationRenditionSelection {
  ...
  RenditionConfigurationRenditionSelection(String value) {
    this.value = value;
  }
  ...
  public static RenditionConfigurationRenditionSelection fromValue(String value) {
    for (RenditionConfigurationRenditionSelection b : RenditionConfigurationRenditionSelection.values()) {
  ...
  public static class Adapter extends TypeAdapter<RenditionConfigurationRenditionSelection> {
    @Override
    public void write(final JsonWriter jsonWriter, final RenditionConfigurationRenditionSelection enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RenditionConfigurationRenditionSelection read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RenditionConfigurationRenditionSelection.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RenditionConfigurationRenditionSelection.fromValue(value);
  }
}
