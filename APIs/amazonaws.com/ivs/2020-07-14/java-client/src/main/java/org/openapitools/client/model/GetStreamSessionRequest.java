...
public class GetStreamSessionRequest {
  ...
  public GetStreamSessionRequest() {
  }

  public GetStreamSessionRequest channelArn(String channelArn) {
  ...
  public GetStreamSessionRequest streamId(String streamId) {
  ...
  public boolean equals(Object o) {
    ...
    GetStreamSessionRequest getStreamSessionRequest = (GetStreamSessionRequest) o;
    return Objects.equals(this.channelArn, getStreamSessionRequest.channelArn) &&
        Objects.equals(this.streamId, getStreamSessionRequest.streamId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, streamId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetStreamSessionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamSessionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamSessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamSessionRequest is not found in the empty JSON string", GetStreamSessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamSessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStreamSessionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamSessionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamSessionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamSessionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamSessionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamSessionRequest>() {
           @Override
           public void write(JsonWriter out, GetStreamSessionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamSessionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamSessionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamSessionRequest
   * @throws IOException if the JSON string is invalid with respect to GetStreamSessionRequest
   */
  public static GetStreamSessionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamSessionRequest.class);
  }

  /**
   * Convert an instance of GetStreamSessionRequest to an JSON string
   *
   * @return JSON string
   */
