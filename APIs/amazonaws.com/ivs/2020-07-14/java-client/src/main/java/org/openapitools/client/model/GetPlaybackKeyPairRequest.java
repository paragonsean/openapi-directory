...
public class GetPlaybackKeyPairRequest {
  ...
  public GetPlaybackKeyPairRequest() {
  }

  public GetPlaybackKeyPairRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPlaybackKeyPairRequest getPlaybackKeyPairRequest = (GetPlaybackKeyPairRequest) o;
    return Objects.equals(this.arn, getPlaybackKeyPairRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPlaybackKeyPairRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPlaybackKeyPairRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPlaybackKeyPairRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPlaybackKeyPairRequest is not found in the empty JSON string", GetPlaybackKeyPairRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPlaybackKeyPairRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPlaybackKeyPairRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPlaybackKeyPairRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPlaybackKeyPairRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPlaybackKeyPairRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPlaybackKeyPairRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPlaybackKeyPairRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPlaybackKeyPairRequest>() {
           @Override
           public void write(JsonWriter out, GetPlaybackKeyPairRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPlaybackKeyPairRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPlaybackKeyPairRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPlaybackKeyPairRequest
   * @throws IOException if the JSON string is invalid with respect to GetPlaybackKeyPairRequest
   */
  public static GetPlaybackKeyPairRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPlaybackKeyPairRequest.class);
  }

  /**
   * Convert an instance of GetPlaybackKeyPairRequest to an JSON string
   *
   * @return JSON string
   */
