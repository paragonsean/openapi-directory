...
public class ListPlaybackKeyPairsRequest {
  ...
  public ListPlaybackKeyPairsRequest() {
  }

  public ListPlaybackKeyPairsRequest maxResults(Integer maxResults) {
  ...
  public ListPlaybackKeyPairsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPlaybackKeyPairsRequest listPlaybackKeyPairsRequest = (ListPlaybackKeyPairsRequest) o;
    return Objects.equals(this.maxResults, listPlaybackKeyPairsRequest.maxResults) &&
        Objects.equals(this.nextToken, listPlaybackKeyPairsRequest.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPlaybackKeyPairsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPlaybackKeyPairsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPlaybackKeyPairsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPlaybackKeyPairsRequest is not found in the empty JSON string", ListPlaybackKeyPairsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPlaybackKeyPairsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPlaybackKeyPairsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPlaybackKeyPairsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPlaybackKeyPairsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPlaybackKeyPairsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPlaybackKeyPairsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPlaybackKeyPairsRequest>() {
           @Override
           public void write(JsonWriter out, ListPlaybackKeyPairsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPlaybackKeyPairsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPlaybackKeyPairsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPlaybackKeyPairsRequest
   * @throws IOException if the JSON string is invalid with respect to ListPlaybackKeyPairsRequest
   */
  public static ListPlaybackKeyPairsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPlaybackKeyPairsRequest.class);
  }

  /**
   * Convert an instance of ListPlaybackKeyPairsRequest to an JSON string
   *
   * @return JSON string
   */
