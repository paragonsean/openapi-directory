...
public class BatchGetStreamKeyRequest {
  ...
  public BatchGetStreamKeyRequest() {
  }

  public BatchGetStreamKeyRequest arns(List<String> arns) {
    this.arns = arns;
    return this;
  }

  public BatchGetStreamKeyRequest addArnsItem(String arnsItem) {
    if (this.arns == null) {
  ...
  public boolean equals(Object o) {
    ...
    BatchGetStreamKeyRequest batchGetStreamKeyRequest = (BatchGetStreamKeyRequest) o;
    return Objects.equals(this.arns, batchGetStreamKeyRequest.arns);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchGetStreamKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetStreamKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetStreamKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetStreamKeyRequest is not found in the empty JSON string", BatchGetStreamKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetStreamKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetStreamKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchGetStreamKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetStreamKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetStreamKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetStreamKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetStreamKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetStreamKeyRequest>() {
           @Override
           public void write(JsonWriter out, BatchGetStreamKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetStreamKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetStreamKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetStreamKeyRequest
   * @throws IOException if the JSON string is invalid with respect to BatchGetStreamKeyRequest
   */
  public static BatchGetStreamKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetStreamKeyRequest.class);
  }

  /**
   * Convert an instance of BatchGetStreamKeyRequest to an JSON string
   *
   * @return JSON string
   */
