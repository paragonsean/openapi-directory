...
public class BatchGetChannelResponse {
  ...
  public BatchGetChannelResponse channels(List channels) {
  ...
  public BatchGetChannelResponse errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchGetChannelResponse batchGetChannelResponse = (BatchGetChannelResponse) o;
    return Objects.equals(this.channels, batchGetChannelResponse.channels) &&
        Objects.equals(this.errors, batchGetChannelResponse.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channels, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchGetChannelResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchGetChannelResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchGetChannelResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchGetChannelResponse is not found in the empty JSON string", BatchGetChannelResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchGetChannelResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchGetChannelResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchGetChannelResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchGetChannelResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchGetChannelResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchGetChannelResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchGetChannelResponse>() {
           @Override
           public void write(JsonWriter out, BatchGetChannelResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchGetChannelResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchGetChannelResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchGetChannelResponse
   * @throws IOException if the JSON string is invalid with respect to BatchGetChannelResponse
   */
  public static BatchGetChannelResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchGetChannelResponse.class);
  }

  /**
   * Convert an instance of BatchGetChannelResponse to an JSON string
   *
   * @return JSON string
   */
