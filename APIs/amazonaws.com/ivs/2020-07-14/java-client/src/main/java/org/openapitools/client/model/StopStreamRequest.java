...
public class StopStreamRequest {
  ...
  public StopStreamRequest channelArn(String channelArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channelArn, stopStreamRequest.channelArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StopStreamRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StopStreamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StopStreamRequest is not found in the empty JSON string", StopStreamRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StopStreamRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StopStreamRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StopStreamRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StopStreamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StopStreamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StopStreamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StopStreamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StopStreamRequest>() {
           @Override
           public void write(JsonWriter out, StopStreamRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StopStreamRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StopStreamRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StopStreamRequest
   * @throws IOException if the JSON string is invalid with respect to StopStreamRequest
   */
  public static StopStreamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StopStreamRequest.class);
  }

  /**
   * Convert an instance of StopStreamRequest to an JSON string
   *
   * @return JSON string
   */
