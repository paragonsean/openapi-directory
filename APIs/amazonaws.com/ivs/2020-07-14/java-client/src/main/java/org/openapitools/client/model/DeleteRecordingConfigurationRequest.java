...
public class DeleteRecordingConfigurationRequest {
  ...
  public DeleteRecordingConfigurationRequest() {
  }

  public DeleteRecordingConfigurationRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRecordingConfigurationRequest deleteRecordingConfigurationRequest = (DeleteRecordingConfigurationRequest) o;
    return Objects.equals(this.arn, deleteRecordingConfigurationRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRecordingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRecordingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRecordingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRecordingConfigurationRequest is not found in the empty JSON string", DeleteRecordingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRecordingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRecordingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteRecordingConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRecordingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRecordingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRecordingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRecordingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRecordingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DeleteRecordingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRecordingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRecordingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRecordingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteRecordingConfigurationRequest
   */
  public static DeleteRecordingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRecordingConfigurationRequest.class);
  }

  /**
   * Convert an instance of DeleteRecordingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
