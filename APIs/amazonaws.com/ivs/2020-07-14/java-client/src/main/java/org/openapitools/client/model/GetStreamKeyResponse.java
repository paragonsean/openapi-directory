...
import org.openapitools.client.model.GetStreamKeyResponseStreamKey;
...
public class GetStreamKeyResponse {
  ...
  private GetStreamKeyResponseStreamKey streamKey;

  public GetStreamKeyResponse() {
  }

  public GetStreamKeyResponse streamKey(GetStreamKeyResponseStreamKey streamKey) {
  ...
  public GetStreamKeyResponseStreamKey getStreamKey() {
    return streamKey;
  }

  public void setStreamKey(GetStreamKeyResponseStreamKey streamKey) {
    this.streamKey = streamKey;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStreamKeyResponse getStreamKeyResponse = (GetStreamKeyResponse) o;
    return Objects.equals(this.streamKey, getStreamKeyResponse.streamKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamKeyResponse is not found in the empty JSON string", GetStreamKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `streamKey`
      if (jsonObj.get("streamKey") != null && !jsonObj.get("streamKey").isJsonNull()) {
        GetStreamKeyResponseStreamKey.validateJsonElement(jsonObj.get("streamKey"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamKeyResponse>() {
           @Override
           public void write(JsonWriter out, GetStreamKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamKeyResponse
   * @throws IOException if the JSON string is invalid with respect to GetStreamKeyResponse
   */
  public static GetStreamKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamKeyResponse.class);
  }

  /**
   * Convert an instance of GetStreamKeyResponse to an JSON string
   *
   * @return JSON string
   */
