...
public class ListStreamSessionsResponse {
  ...
  public static final String SERIALIZED_NAME_STREAM_SESSIONS = "streamSessions";
  @SerializedName(SERIALIZED_NAME_STREAM_SESSIONS)
  private List streamSessions;

  public ListStreamSessionsResponse() {
  }

  public ListStreamSessionsResponse nextToken(String nextToken) {
  ...
  public ListStreamSessionsResponse streamSessions(List streamSessions) {
  ...
  public List getStreamSessions() {
    return streamSessions;
  }

  public void setStreamSessions(List streamSessions) {
    this.streamSessions = streamSessions;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListStreamSessionsResponse listStreamSessionsResponse = (ListStreamSessionsResponse) o;
    return Objects.equals(this.nextToken, listStreamSessionsResponse.nextToken) &&
        Objects.equals(this.streamSessions, listStreamSessionsResponse.streamSessions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, streamSessions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListStreamSessionsResponse {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    streamSessions: ").append(toIndentedString(streamSessions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("streamSessions");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("streamSessions");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamSessionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamSessionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamSessionsResponse is not found in the empty JSON string", ListStreamSessionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamSessionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamSessionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListStreamSessionsResponse.openapiRequiredFields) {
      ...
      // validate the required field `streamSessions`
      List.validateJsonElement(jsonObj.get("streamSessions"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamSessionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamSessionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamSessionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamSessionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamSessionsResponse>() {
           @Override
           public void write(JsonWriter out, ListStreamSessionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamSessionsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamSessionsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamSessionsResponse
   * @throws IOException if the JSON string is invalid with respect to ListStreamSessionsResponse
   */
  public static ListStreamSessionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamSessionsResponse.class);
  }

  /**
   * Convert an instance of ListStreamSessionsResponse to an JSON string
   *
   * @return JSON string
   */
