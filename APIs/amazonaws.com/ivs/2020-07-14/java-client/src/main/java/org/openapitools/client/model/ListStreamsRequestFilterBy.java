...
public class ListStreamsRequestFilterBy {
  public static final String SERIALIZED_NAME_HEALTH = "health";
  @SerializedName(SERIALIZED_NAME_HEALTH)
  private StreamHealth health;

  public ListStreamsRequestFilterBy() {
  }

  public ListStreamsRequestFilterBy health(StreamHealth health) {
    this.health = health;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListStreamsRequestFilterBy listStreamsRequestFilterBy = (ListStreamsRequestFilterBy) o;
    return Objects.equals(this.health, listStreamsRequestFilterBy.health);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListStreamsRequestFilterBy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamsRequestFilterBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamsRequestFilterBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamsRequestFilterBy is not found in the empty JSON string", ListStreamsRequestFilterBy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamsRequestFilterBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamsRequestFilterBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamsRequestFilterBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamsRequestFilterBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamsRequestFilterBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamsRequestFilterBy.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamsRequestFilterBy>() {
           @Override
           public void write(JsonWriter out, ListStreamsRequestFilterBy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamsRequestFilterBy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamsRequestFilterBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamsRequestFilterBy
   * @throws IOException if the JSON string is invalid with respect to ListStreamsRequestFilterBy
   */
  public static ListStreamsRequestFilterBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamsRequestFilterBy.class);
  }

  /**
   * Convert an instance of ListStreamsRequestFilterBy to an JSON string
   *
   * @return JSON string
   */
