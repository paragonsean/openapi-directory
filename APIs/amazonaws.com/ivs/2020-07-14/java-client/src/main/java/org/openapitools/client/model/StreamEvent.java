...
public class StreamEvent {
  ...
  public StreamEvent eventTime(OffsetDateTime eventTime) {
  ...
  public StreamEvent name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StreamEvent type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamEvent streamEvent = (StreamEvent) o;
    return Objects.equals(this.eventTime, streamEvent.eventTime) &&
        Objects.equals(this.name, streamEvent.name) &&
        Objects.equals(this.type, streamEvent.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventTime, name, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamEvent is not found in the empty JSON string", StreamEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamEvent>() {
           @Override
           public void write(JsonWriter out, StreamEvent value) throws IOException {
  ...
  /**
   * Create an instance of StreamEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamEvent
   * @throws IOException if the JSON string is invalid with respect to StreamEvent
   */
  public static StreamEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamEvent.class);
  }

  /**
   * Convert an instance of StreamEvent to an JSON string
   *
   * @return JSON string
   */
