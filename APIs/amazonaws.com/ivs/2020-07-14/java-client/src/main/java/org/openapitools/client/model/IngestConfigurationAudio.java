...
public class IngestConfigurationAudio {
  ...
  public IngestConfigurationAudio() {
  }

  public IngestConfigurationAudio channels(Integer channels) {
  ...
  public IngestConfigurationAudio codec(String codec) {
    this.codec = codec;
    return this;
  }
  ...
  public IngestConfigurationAudio sampleRate(Integer sampleRate) {
  ...
  public IngestConfigurationAudio targetBitrate(Integer targetBitrate) {
  ...
  public boolean equals(Object o) {
    ...
    IngestConfigurationAudio ingestConfigurationAudio = (IngestConfigurationAudio) o;
    return Objects.equals(this.channels, ingestConfigurationAudio.channels) &&
        Objects.equals(this.codec, ingestConfigurationAudio.codec) &&
        Objects.equals(this.sampleRate, ingestConfigurationAudio.sampleRate) &&
        Objects.equals(this.targetBitrate, ingestConfigurationAudio.targetBitrate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channels, codec, sampleRate, targetBitrate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IngestConfigurationAudio {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IngestConfigurationAudio
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IngestConfigurationAudio.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IngestConfigurationAudio is not found in the empty JSON string", IngestConfigurationAudio.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IngestConfigurationAudio.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IngestConfigurationAudio` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestConfigurationAudio.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestConfigurationAudio' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestConfigurationAudio> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestConfigurationAudio.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestConfigurationAudio>() {
           @Override
           public void write(JsonWriter out, IngestConfigurationAudio value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IngestConfigurationAudio read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IngestConfigurationAudio given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IngestConfigurationAudio
   * @throws IOException if the JSON string is invalid with respect to IngestConfigurationAudio
   */
  public static IngestConfigurationAudio fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestConfigurationAudio.class);
  }

  /**
   * Convert an instance of IngestConfigurationAudio to an JSON string
   *
   * @return JSON string
   */
