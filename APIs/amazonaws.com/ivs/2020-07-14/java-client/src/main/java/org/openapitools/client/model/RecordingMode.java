...
/**
 * Gets or Sets RecordingMode
 */
@JsonAdapter(RecordingMode.Adapter.class)
public enum RecordingMode {
  ...
  public static RecordingMode fromValue(String value) {
    for (RecordingMode b : RecordingMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<RecordingMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final RecordingMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RecordingMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RecordingMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RecordingMode.fromValue(value);
  }
}
