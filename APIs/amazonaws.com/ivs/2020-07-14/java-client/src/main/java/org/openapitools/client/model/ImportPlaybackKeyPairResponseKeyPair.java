...
public class ImportPlaybackKeyPairResponseKeyPair {
  ...
  public ImportPlaybackKeyPairResponseKeyPair() {
  }

  public ImportPlaybackKeyPairResponseKeyPair arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ImportPlaybackKeyPairResponseKeyPair fingerprint(String fingerprint) {
  ...
  public ImportPlaybackKeyPairResponseKeyPair name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportPlaybackKeyPairResponseKeyPair tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportPlaybackKeyPairResponseKeyPair importPlaybackKeyPairResponseKeyPair = (ImportPlaybackKeyPairResponseKeyPair) o;
    return Objects.equals(this.arn, importPlaybackKeyPairResponseKeyPair.arn) &&
        Objects.equals(this.fingerprint, importPlaybackKeyPairResponseKeyPair.fingerprint) &&
        Objects.equals(this.name, importPlaybackKeyPairResponseKeyPair.name) &&
        Objects.equals(this.tags, importPlaybackKeyPairResponseKeyPair.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportPlaybackKeyPairResponseKeyPair {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportPlaybackKeyPairResponseKeyPair
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportPlaybackKeyPairResponseKeyPair.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportPlaybackKeyPairResponseKeyPair is not found in the empty JSON string", ImportPlaybackKeyPairResponseKeyPair.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportPlaybackKeyPairResponseKeyPair.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportPlaybackKeyPairResponseKeyPair` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportPlaybackKeyPairResponseKeyPair.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportPlaybackKeyPairResponseKeyPair' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportPlaybackKeyPairResponseKeyPair> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportPlaybackKeyPairResponseKeyPair.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportPlaybackKeyPairResponseKeyPair>() {
           @Override
           public void write(JsonWriter out, ImportPlaybackKeyPairResponseKeyPair value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportPlaybackKeyPairResponseKeyPair read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportPlaybackKeyPairResponseKeyPair given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportPlaybackKeyPairResponseKeyPair
   * @throws IOException if the JSON string is invalid with respect to ImportPlaybackKeyPairResponseKeyPair
   */
  public static ImportPlaybackKeyPairResponseKeyPair fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportPlaybackKeyPairResponseKeyPair.class);
  }

  /**
   * Convert an instance of ImportPlaybackKeyPairResponseKeyPair to an JSON string
   *
   * @return JSON string
   */
