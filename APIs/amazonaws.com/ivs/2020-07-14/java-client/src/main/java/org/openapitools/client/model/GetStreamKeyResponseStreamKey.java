...
public class GetStreamKeyResponseStreamKey {
  ...
  public GetStreamKeyResponseStreamKey() {
  }

  public GetStreamKeyResponseStreamKey arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetStreamKeyResponseStreamKey channelArn(String channelArn) {
  ...
  public GetStreamKeyResponseStreamKey tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetStreamKeyResponseStreamKey value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStreamKeyResponseStreamKey getStreamKeyResponseStreamKey = (GetStreamKeyResponseStreamKey) o;
    return Objects.equals(this.arn, getStreamKeyResponseStreamKey.arn) &&
        Objects.equals(this.channelArn, getStreamKeyResponseStreamKey.channelArn) &&
        Objects.equals(this.tags, getStreamKeyResponseStreamKey.tags) &&
        Objects.equals(this.value, getStreamKeyResponseStreamKey.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStreamKeyResponseStreamKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamKeyResponseStreamKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamKeyResponseStreamKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamKeyResponseStreamKey is not found in the empty JSON string", GetStreamKeyResponseStreamKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamKeyResponseStreamKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamKeyResponseStreamKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamKeyResponseStreamKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamKeyResponseStreamKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamKeyResponseStreamKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamKeyResponseStreamKey.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamKeyResponseStreamKey>() {
           @Override
           public void write(JsonWriter out, GetStreamKeyResponseStreamKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamKeyResponseStreamKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamKeyResponseStreamKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamKeyResponseStreamKey
   * @throws IOException if the JSON string is invalid with respect to GetStreamKeyResponseStreamKey
   */
  public static GetStreamKeyResponseStreamKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamKeyResponseStreamKey.class);
  }

  /**
   * Convert an instance of GetStreamKeyResponseStreamKey to an JSON string
   *
   * @return JSON string
   */
