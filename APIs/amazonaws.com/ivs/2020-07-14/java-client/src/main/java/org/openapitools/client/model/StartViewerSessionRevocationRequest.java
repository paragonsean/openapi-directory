...
public class StartViewerSessionRevocationRequest {
  ...
  public StartViewerSessionRevocationRequest() {
  }

  public StartViewerSessionRevocationRequest channelArn(String channelArn) {
  ...
  public StartViewerSessionRevocationRequest viewerId(String viewerId) {
  ...
  public StartViewerSessionRevocationRequest viewerSessionVersionsLessThanOrEqualTo(Integer viewerSessionVersionsLessThanOrEqualTo) {
  ...
  public boolean equals(Object o) {
    ...
    StartViewerSessionRevocationRequest startViewerSessionRevocationRequest = (StartViewerSessionRevocationRequest) o;
    return Objects.equals(this.channelArn, startViewerSessionRevocationRequest.channelArn) &&
        Objects.equals(this.viewerId, startViewerSessionRevocationRequest.viewerId) &&
        Objects.equals(this.viewerSessionVersionsLessThanOrEqualTo, startViewerSessionRevocationRequest.viewerSessionVersionsLessThanOrEqualTo);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartViewerSessionRevocationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartViewerSessionRevocationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartViewerSessionRevocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartViewerSessionRevocationRequest is not found in the empty JSON string", StartViewerSessionRevocationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartViewerSessionRevocationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartViewerSessionRevocationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartViewerSessionRevocationRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("viewerId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartViewerSessionRevocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartViewerSessionRevocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartViewerSessionRevocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartViewerSessionRevocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<StartViewerSessionRevocationRequest>() {
           @Override
           public void write(JsonWriter out, StartViewerSessionRevocationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartViewerSessionRevocationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartViewerSessionRevocationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartViewerSessionRevocationRequest
   * @throws IOException if the JSON string is invalid with respect to StartViewerSessionRevocationRequest
   */
  public static StartViewerSessionRevocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartViewerSessionRevocationRequest.class);
  }

  /**
   * Convert an instance of StartViewerSessionRevocationRequest to an JSON string
   *
   * @return JSON string
   */
