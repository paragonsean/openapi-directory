...
public class StreamSummary {
  ...
  public StreamSummary channelArn(String channelArn) {
  ...
  public StreamSummary health(StreamHealth health) {
    this.health = health;
    return this;
  }
  ...
  public StreamSummary startTime(OffsetDateTime startTime) {
  ...
  public StreamSummary state(StreamState state) {
    this.state = state;
    return this;
  }
  ...
  public StreamSummary streamId(String streamId) {
  ...
  public StreamSummary viewerCount(Integer viewerCount) {
  ...
  public boolean equals(Object o) {
    ...
    StreamSummary streamSummary = (StreamSummary) o;
    return Objects.equals(this.channelArn, streamSummary.channelArn) &&
        Objects.equals(this.health, streamSummary.health) &&
        Objects.equals(this.startTime, streamSummary.startTime) &&
        Objects.equals(this.state, streamSummary.state) &&
        Objects.equals(this.streamId, streamSummary.streamId) &&
        Objects.equals(this.viewerCount, streamSummary.viewerCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, health, startTime, state, streamId, viewerCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StreamSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSummary is not found in the empty JSON string", StreamSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSummary>() {
           @Override
           public void write(JsonWriter out, StreamSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSummary
   * @throws IOException if the JSON string is invalid with respect to StreamSummary
   */
  public static StreamSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSummary.class);
  }

  /**
   * Convert an instance of StreamSummary to an JSON string
   *
   * @return JSON string
   */
