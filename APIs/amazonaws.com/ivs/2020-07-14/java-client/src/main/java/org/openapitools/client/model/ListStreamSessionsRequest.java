...
public class ListStreamSessionsRequest {
  ...
  public ListStreamSessionsRequest() {
  }

  public ListStreamSessionsRequest channelArn(String channelArn) {
  ...
  public ListStreamSessionsRequest maxResults(Integer maxResults) {
  ...
  public ListStreamSessionsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListStreamSessionsRequest listStreamSessionsRequest = (ListStreamSessionsRequest) o;
    return Objects.equals(this.channelArn, listStreamSessionsRequest.channelArn) &&
        Objects.equals(this.maxResults, listStreamSessionsRequest.maxResults) &&
        Objects.equals(this.nextToken, listStreamSessionsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelArn, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListStreamSessionsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListStreamSessionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListStreamSessionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListStreamSessionsRequest is not found in the empty JSON string", ListStreamSessionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListStreamSessionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListStreamSessionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListStreamSessionsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListStreamSessionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListStreamSessionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListStreamSessionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListStreamSessionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListStreamSessionsRequest>() {
           @Override
           public void write(JsonWriter out, ListStreamSessionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListStreamSessionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListStreamSessionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListStreamSessionsRequest
   * @throws IOException if the JSON string is invalid with respect to ListStreamSessionsRequest
   */
  public static ListStreamSessionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListStreamSessionsRequest.class);
  }

  /**
   * Convert an instance of ListStreamSessionsRequest to an JSON string
   *
   * @return JSON string
   */
