...
import org.openapitools.client.model.ImportPlaybackKeyPairResponseKeyPair;
...
public class ImportPlaybackKeyPairResponse {
  ...
  private ImportPlaybackKeyPairResponseKeyPair keyPair;

  public ImportPlaybackKeyPairResponse() {
  }

  public ImportPlaybackKeyPairResponse keyPair(ImportPlaybackKeyPairResponseKeyPair keyPair) {
  ...
  public ImportPlaybackKeyPairResponseKeyPair getKeyPair() {
    return keyPair;
  }

  public void setKeyPair(ImportPlaybackKeyPairResponseKeyPair keyPair) {
    this.keyPair = keyPair;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportPlaybackKeyPairResponse importPlaybackKeyPairResponse = (ImportPlaybackKeyPairResponse) o;
    return Objects.equals(this.keyPair, importPlaybackKeyPairResponse.keyPair);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportPlaybackKeyPairResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportPlaybackKeyPairResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportPlaybackKeyPairResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportPlaybackKeyPairResponse is not found in the empty JSON string", ImportPlaybackKeyPairResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportPlaybackKeyPairResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportPlaybackKeyPairResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `keyPair`
      if (jsonObj.get("keyPair") != null && !jsonObj.get("keyPair").isJsonNull()) {
        ImportPlaybackKeyPairResponseKeyPair.validateJsonElement(jsonObj.get("keyPair"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportPlaybackKeyPairResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportPlaybackKeyPairResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportPlaybackKeyPairResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportPlaybackKeyPairResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportPlaybackKeyPairResponse>() {
           @Override
           public void write(JsonWriter out, ImportPlaybackKeyPairResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportPlaybackKeyPairResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportPlaybackKeyPairResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportPlaybackKeyPairResponse
   * @throws IOException if the JSON string is invalid with respect to ImportPlaybackKeyPairResponse
   */
  public static ImportPlaybackKeyPairResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportPlaybackKeyPairResponse.class);
  }

  /**
   * Convert an instance of ImportPlaybackKeyPairResponse to an JSON string
   *
   * @return JSON string
   */
