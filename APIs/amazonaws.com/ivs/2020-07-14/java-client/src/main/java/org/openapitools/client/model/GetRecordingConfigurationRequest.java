...
public class GetRecordingConfigurationRequest {
  ...
  public GetRecordingConfigurationRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRecordingConfigurationRequest getRecordingConfigurationRequest = (GetRecordingConfigurationRequest) o;
    return Objects.equals(this.arn, getRecordingConfigurationRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRecordingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRecordingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRecordingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRecordingConfigurationRequest is not found in the empty JSON string", GetRecordingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRecordingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRecordingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRecordingConfigurationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRecordingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRecordingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRecordingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRecordingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRecordingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, GetRecordingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRecordingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRecordingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRecordingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to GetRecordingConfigurationRequest
   */
  public static GetRecordingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRecordingConfigurationRequest.class);
  }

  /**
   * Convert an instance of GetRecordingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
