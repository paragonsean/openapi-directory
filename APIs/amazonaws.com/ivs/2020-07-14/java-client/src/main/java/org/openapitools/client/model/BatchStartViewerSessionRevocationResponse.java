...
public class BatchStartViewerSessionRevocationResponse {
  ...
  public BatchStartViewerSessionRevocationResponse errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchStartViewerSessionRevocationResponse batchStartViewerSessionRevocationResponse = (BatchStartViewerSessionRevocationResponse) o;
    return Objects.equals(this.errors, batchStartViewerSessionRevocationResponse.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchStartViewerSessionRevocationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchStartViewerSessionRevocationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchStartViewerSessionRevocationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchStartViewerSessionRevocationResponse is not found in the empty JSON string", BatchStartViewerSessionRevocationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchStartViewerSessionRevocationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchStartViewerSessionRevocationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchStartViewerSessionRevocationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchStartViewerSessionRevocationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchStartViewerSessionRevocationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchStartViewerSessionRevocationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchStartViewerSessionRevocationResponse>() {
           @Override
           public void write(JsonWriter out, BatchStartViewerSessionRevocationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchStartViewerSessionRevocationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchStartViewerSessionRevocationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchStartViewerSessionRevocationResponse
   * @throws IOException if the JSON string is invalid with respect to BatchStartViewerSessionRevocationResponse
   */
  public static BatchStartViewerSessionRevocationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchStartViewerSessionRevocationResponse.class);
  }

  /**
   * Convert an instance of BatchStartViewerSessionRevocationResponse to an JSON string
   *
   * @return JSON string
   */
