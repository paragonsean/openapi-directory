...
public class ListChannelsRequest {
  public static final String SERIALIZED_NAME_FILTER_BY_NAME = "filterByName";
  @SerializedName(SERIALIZED_NAME_FILTER_BY_NAME)
  private String filterByName;

  public static final String SERIALIZED_NAME_FILTER_BY_RECORDING_CONFIGURATION_ARN = "filterByRecordingConfigurationArn";
  @SerializedName(SERIALIZED_NAME_FILTER_BY_RECORDING_CONFIGURATION_ARN)
  ...
  public ListChannelsRequest filterByName(String filterByName) {
  ...
  public ListChannelsRequest filterByRecordingConfigurationArn(String filterByRecordingConfigurationArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filterByName, listChannelsRequest.filterByName) &&
        Objects.equals(this.filterByRecordingConfigurationArn, listChannelsRequest.filterByRecordingConfigurationArn) &&
        Objects.equals(this.maxResults, listChannelsRequest.maxResults) &&
        Objects.equals(this.nextToken, listChannelsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filterByName, filterByRecordingConfigurationArn, maxResults, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    filterByName: ").append(toIndentedString(filterByName)).append("\n");
    sb.append("    filterByRecordingConfigurationArn: ").append(toIndentedString(filterByRecordingConfigurationArn)).append("\n");
  ...
  static {
    ...
    openapiFields.add("filterByName");
    openapiFields.add("filterByRecordingConfigurationArn");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("filterByName") != null && !jsonObj.get("filterByName").isJsonNull()) && !jsonObj.get("filterByName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `filterByName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("filterByName").toString()));
      }
      if ((jsonObj.get("filterByRecordingConfigurationArn") != null && !jsonObj.get("filterByRecordingConfigurationArn").isJsonNull()) && !jsonObj.get("filterByRecordingConfigurationArn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `filterByRecordingConfigurationArn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("filterByRecordingConfigurationArn").toString()));
      }
