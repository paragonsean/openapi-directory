...
public class GetStreamRequest {
  ...
  public GetStreamRequest channelArn(String channelArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channelArn, getStreamRequest.channelArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStreamRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStreamRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStreamRequest is not found in the empty JSON string", GetStreamRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStreamRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStreamRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStreamRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStreamRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStreamRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStreamRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStreamRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStreamRequest>() {
           @Override
           public void write(JsonWriter out, GetStreamRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStreamRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStreamRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStreamRequest
   * @throws IOException if the JSON string is invalid with respect to GetStreamRequest
   */
  public static GetStreamRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStreamRequest.class);
  }

  /**
   * Convert an instance of GetStreamRequest to an JSON string
   *
   * @return JSON string
   */
