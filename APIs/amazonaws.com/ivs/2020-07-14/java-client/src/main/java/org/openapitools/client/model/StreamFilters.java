...
public class StreamFilters {
  ...
  public StreamFilters health(StreamHealth health) {
    this.health = health;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamFilters streamFilters = (StreamFilters) o;
    return Objects.equals(this.health, streamFilters.health);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamFilters is not found in the empty JSON string", StreamFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamFilters>() {
           @Override
           public void write(JsonWriter out, StreamFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamFilters
   * @throws IOException if the JSON string is invalid with respect to StreamFilters
   */
  public static StreamFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamFilters.class);
  }

  /**
   * Convert an instance of StreamFilters to an JSON string
   *
   * @return JSON string
   */
