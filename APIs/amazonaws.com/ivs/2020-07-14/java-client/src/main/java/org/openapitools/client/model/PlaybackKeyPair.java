...
public class PlaybackKeyPair {
  ...
  public PlaybackKeyPair arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public PlaybackKeyPair fingerprint(String fingerprint) {
  ...
  public PlaybackKeyPair name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaybackKeyPair tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlaybackKeyPair playbackKeyPair = (PlaybackKeyPair) o;
    return Objects.equals(this.arn, playbackKeyPair.arn) &&
        Objects.equals(this.fingerprint, playbackKeyPair.fingerprint) &&
        Objects.equals(this.name, playbackKeyPair.name) &&
        Objects.equals(this.tags, playbackKeyPair.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, fingerprint, name, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PlaybackKeyPair {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaybackKeyPair
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaybackKeyPair.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaybackKeyPair is not found in the empty JSON string", PlaybackKeyPair.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaybackKeyPair.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaybackKeyPair` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaybackKeyPair.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaybackKeyPair' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaybackKeyPair> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaybackKeyPair.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaybackKeyPair>() {
           @Override
           public void write(JsonWriter out, PlaybackKeyPair value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaybackKeyPair read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaybackKeyPair given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaybackKeyPair
   * @throws IOException if the JSON string is invalid with respect to PlaybackKeyPair
   */
  public static PlaybackKeyPair fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaybackKeyPair.class);
  }

  /**
   * Convert an instance of PlaybackKeyPair to an JSON string
   *
   * @return JSON string
   */
