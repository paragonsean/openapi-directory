...
public class StreamSession {
  ...
  public StreamSession channel(StreamSessionChannel channel) {
  ...
  public StreamSession endTime(OffsetDateTime endTime) {
  ...
  public StreamSession ingestConfiguration(StreamSessionIngestConfiguration ingestConfiguration) {
  ...
  public StreamSession recordingConfiguration(StreamSessionRecordingConfiguration recordingConfiguration) {
  ...
  public StreamSession startTime(OffsetDateTime startTime) {
  ...
  public StreamSession streamId(String streamId) {
  ...
  public StreamSession truncatedEvents(List truncatedEvents) {
  ...
  public boolean equals(Object o) {
    ...
    StreamSession streamSession = (StreamSession) o;
    return Objects.equals(this.channel, streamSession.channel) &&
        Objects.equals(this.endTime, streamSession.endTime) &&
        Objects.equals(this.ingestConfiguration, streamSession.ingestConfiguration) &&
        Objects.equals(this.recordingConfiguration, streamSession.recordingConfiguration) &&
        Objects.equals(this.startTime, streamSession.startTime) &&
        Objects.equals(this.streamId, streamSession.streamId) &&
        Objects.equals(this.truncatedEvents, streamSession.truncatedEvents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamSession is not found in the empty JSON string", StreamSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamSession.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamSession>() {
           @Override
           public void write(JsonWriter out, StreamSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamSession
   * @throws IOException if the JSON string is invalid with respect to StreamSession
   */
  public static StreamSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamSession.class);
  }

  /**
   * Convert an instance of StreamSession to an JSON string
   *
   * @return JSON string
   */
