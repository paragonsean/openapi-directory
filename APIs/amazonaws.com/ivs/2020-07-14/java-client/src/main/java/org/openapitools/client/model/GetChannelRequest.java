...
public class GetChannelRequest {
  ...
  public GetChannelRequest arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetChannelRequest getChannelRequest = (GetChannelRequest) o;
    return Objects.equals(this.arn, getChannelRequest.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetChannelRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetChannelRequest is not found in the empty JSON string", GetChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetChannelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetChannelRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetChannelRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetChannelRequest>() {
           @Override
           public void write(JsonWriter out, GetChannelRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetChannelRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetChannelRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetChannelRequest
   * @throws IOException if the JSON string is invalid with respect to GetChannelRequest
   */
  public static GetChannelRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetChannelRequest.class);
  }

  /**
   * Convert an instance of GetChannelRequest to an JSON string
   *
   * @return JSON string
   */
