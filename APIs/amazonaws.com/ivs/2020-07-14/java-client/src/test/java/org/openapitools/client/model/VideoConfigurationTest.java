...
/**
 * Model tests for VideoConfiguration
 */
public class VideoConfigurationTest {
    private final VideoConfiguration model = new VideoConfiguration();
