...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.VideoConfiguration();
  });
  ...
  describe('VideoConfiguration', function() {
    it('should create an instance of VideoConfiguration', function() {
      // uncomment below and update the code to test VideoConfiguration
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.VideoConfiguration);
    });

    it('should have the property avcLevel (base name: "avcLevel")', function() {
      // uncomment below and update the code to test the property avcLevel
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property avcProfile (base name: "avcProfile")', function() {
      // uncomment below and update the code to test the property avcProfile
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property targetBitrate (base name: "targetBitrate")', function() {
      // uncomment below and update the code to test the property targetBitrate
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property targetFramerate (base name: "targetFramerate")', function() {
      // uncomment below and update the code to test the property targetFramerate
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property videoHeight (base name: "videoHeight")', function() {
      // uncomment below and update the code to test the property videoHeight
      //var instance = new AmazonInteractiveVideoService.VideoConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property videoWidth (base name: "videoWidth")', function() {
