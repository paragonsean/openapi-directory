...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StartViewerSessionRevocationRequest();
  });
  ...
  describe('StartViewerSessionRevocationRequest', function() {
    it('should create an instance of StartViewerSessionRevocationRequest', function() {
      // uncomment below and update the code to test StartViewerSessionRevocationRequest
      //var instance = new AmazonInteractiveVideoService.StartViewerSessionRevocationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StartViewerSessionRevocationRequest);
    });
