...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamKey();
  });
  ...
  describe('StreamKey', function() {
    it('should create an instance of StreamKey', function() {
      // uncomment below and update the code to test StreamKey
      //var instance = new AmazonInteractiveVideoService.StreamKey();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamKey);
    });
