...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequest();
  });
  ...
  describe('CreateRecordingConfigurationRequest', function() {
    it('should create an instance of CreateRecordingConfigurationRequest', function() {
      // uncomment below and update the code to test CreateRecordingConfigurationRequest
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateRecordingConfigurationRequest);
    });
