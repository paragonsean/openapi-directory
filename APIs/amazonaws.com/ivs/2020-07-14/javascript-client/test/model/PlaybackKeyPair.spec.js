...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.PlaybackKeyPair();
  });
  ...
  describe('PlaybackKeyPair', function() {
    it('should create an instance of PlaybackKeyPair', function() {
      // uncomment below and update the code to test PlaybackKeyPair
      //var instance = new AmazonInteractiveVideoService.PlaybackKeyPair();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.PlaybackKeyPair);
    });
