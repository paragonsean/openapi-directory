...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListPlaybackKeyPairsRequest();
  });
  ...
  describe('ListPlaybackKeyPairsRequest', function() {
    it('should create an instance of ListPlaybackKeyPairsRequest', function() {
      // uncomment below and update the code to test ListPlaybackKeyPairsRequest
      //var instance = new AmazonInteractiveVideoService.ListPlaybackKeyPairsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListPlaybackKeyPairsRequest);
    });
