...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.BatchStartViewerSessionRevocationError();
  });
  ...
  describe('BatchStartViewerSessionRevocationError', function() {
    it('should create an instance of BatchStartViewerSessionRevocationError', function() {
      // uncomment below and update the code to test BatchStartViewerSessionRevocationError
      //var instance = new AmazonInteractiveVideoService.BatchStartViewerSessionRevocationError();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.BatchStartViewerSessionRevocationError);
    });
