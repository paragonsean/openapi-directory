...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSummary();
  });
  ...
  describe('StreamSummary', function() {
    it('should create an instance of StreamSummary', function() {
      // uncomment below and update the code to test StreamSummary
      //var instance = new AmazonInteractiveVideoService.StreamSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSummary);
    });
    ...
    it('should have the property viewerCount (base name: "viewerCount")', function() {
      // uncomment below and update the code to test the property viewerCount
      //var instance = new AmazonInteractiveVideoService.StreamSummary();
      //expect(instance).to.be();
    });
