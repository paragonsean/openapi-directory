...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.ListChannelsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListChannelsResponse);
    });
