...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamKeysRequest();
  });
  ...
  describe('ListStreamKeysRequest', function() {
    it('should create an instance of ListStreamKeysRequest', function() {
      // uncomment below and update the code to test ListStreamKeysRequest
      //var instance = new AmazonInteractiveVideoService.ListStreamKeysRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamKeysRequest);
    });
