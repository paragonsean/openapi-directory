...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.BatchGetChannelResponse();
  });
  ...
  describe('BatchGetChannelResponse', function() {
    it('should create an instance of BatchGetChannelResponse', function() {
      // uncomment below and update the code to test BatchGetChannelResponse
      //var instance = new AmazonInteractiveVideoService.BatchGetChannelResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.BatchGetChannelResponse);
    });
