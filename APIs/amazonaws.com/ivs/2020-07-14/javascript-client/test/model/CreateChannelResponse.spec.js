...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateChannelResponse();
  });
  ...
  describe('CreateChannelResponse', function() {
    it('should create an instance of CreateChannelResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.CreateChannelResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateChannelResponse);
    });
