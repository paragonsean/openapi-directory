...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.BatchError();
  });
  ...
  describe('BatchError', function() {
    it('should create an instance of BatchError', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.BatchError();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.BatchError);
    });
