...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamEvent();
  });
  ...
  describe('StreamEvent', function() {
    it('should create an instance of StreamEvent', function() {
      // uncomment below and update the code to test StreamEvent
      //var instance = new AmazonInteractiveVideoService.StreamEvent();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamEvent);
    });
