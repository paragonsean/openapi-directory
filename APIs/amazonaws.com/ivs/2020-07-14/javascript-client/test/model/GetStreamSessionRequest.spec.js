...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.GetStreamSessionRequest();
  });
  ...
  describe('GetStreamSessionRequest', function() {
    it('should create an instance of GetStreamSessionRequest', function() {
      // uncomment below and update the code to test GetStreamSessionRequest
      //var instance = new AmazonInteractiveVideoService.GetStreamSessionRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.GetStreamSessionRequest);
    });
