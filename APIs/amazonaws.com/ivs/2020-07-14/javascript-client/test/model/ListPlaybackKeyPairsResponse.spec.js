...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListPlaybackKeyPairsResponse();
  });
  ...
  describe('ListPlaybackKeyPairsResponse', function() {
    it('should create an instance of ListPlaybackKeyPairsResponse', function() {
      // uncomment below and update the code to test ListPlaybackKeyPairsResponse
      //var instance = new AmazonInteractiveVideoService.ListPlaybackKeyPairsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListPlaybackKeyPairsResponse);
    });
