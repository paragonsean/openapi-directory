...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamSessionsRequest();
  });
  ...
  describe('ListStreamSessionsRequest', function() {
    it('should create an instance of ListStreamSessionsRequest', function() {
      // uncomment below and update the code to test ListStreamSessionsRequest
      //var instance = new AmazonInteractiveVideoService.ListStreamSessionsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamSessionsRequest);
    });
