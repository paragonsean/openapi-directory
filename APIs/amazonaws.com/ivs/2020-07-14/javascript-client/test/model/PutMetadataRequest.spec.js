...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.PutMetadataRequest();
  });
  ...
  describe('PutMetadataRequest', function() {
    it('should create an instance of PutMetadataRequest', function() {
      // uncomment below and update the code to test PutMetadataRequest
      //var instance = new AmazonInteractiveVideoService.PutMetadataRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.PutMetadataRequest);
    });
