...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.RenditionConfiguration();
  });
  ...
  describe('RenditionConfiguration', function() {
    it('should create an instance of RenditionConfiguration', function() {
      // uncomment below and update the code to test RenditionConfiguration
      //var instance = new AmazonInteractiveVideoService.RenditionConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.RenditionConfiguration);
    });
