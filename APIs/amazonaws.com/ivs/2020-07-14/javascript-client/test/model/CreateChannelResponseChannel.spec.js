...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateChannelResponseChannel();
  });
  ...
  describe('CreateChannelResponseChannel', function() {
    it('should create an instance of CreateChannelResponseChannel', function() {
      // uncomment below and update the code to test CreateChannelResponseChannel
      //var instance = new AmazonInteractiveVideoService.CreateChannelResponseChannel();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateChannelResponseChannel);
    });
