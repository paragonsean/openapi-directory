...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.Channel();
  });
  ...
  describe('Channel', function() {
    it('should create an instance of Channel', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.Channel();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.Channel);
    });
    ...
    it('should have the property ingestEndpoint (base name: "ingestEndpoint")', function() {
      // uncomment below and update the code to test the property ingestEndpoint
      //var instance = new AmazonInteractiveVideoService.Channel();
      //expect(instance).to.be();
    });

    it('should have the property insecureIngest (base name: "insecureIngest")', function() {
      // uncomment below and update the code to test the property insecureIngest
      //var instance = new AmazonInteractiveVideoService.Channel();
      //expect(instance).to.be();
    });

    it('should have the property latencyMode (base name: "latencyMode")', function() {
    ...
    it('should have the property recordingConfigurationArn (base name: "recordingConfigurationArn")', function() {
      // uncomment below and update the code to test the property recordingConfigurationArn
      //var instance = new AmazonInteractiveVideoService.Channel();
      //expect(instance).to.be();
    });
