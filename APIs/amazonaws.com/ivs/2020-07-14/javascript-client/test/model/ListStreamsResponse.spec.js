...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamsResponse();
  });
  ...
  describe('ListStreamsResponse', function() {
    it('should create an instance of ListStreamsResponse', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.ListStreamsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamsResponse);
    });
