...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.GetStreamResponseStream();
  });
  ...
  describe('GetStreamResponseStream', function() {
    it('should create an instance of GetStreamResponseStream', function() {
      // uncomment below and update the code to test GetStreamResponseStream
      //var instance = new AmazonInteractiveVideoService.GetStreamResponseStream();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.GetStreamResponseStream);
    });
