...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestThumbnailConfiguration();
  });
  ...
  describe('CreateRecordingConfigurationRequestThumbnailConfiguration', function() {
    it('should create an instance of CreateRecordingConfigurationRequestThumbnailConfiguration', function() {
      // uncomment below and update the code to test CreateRecordingConfigurationRequestThumbnailConfiguration
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestThumbnailConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateRecordingConfigurationRequestThumbnailConfiguration);
    });

    it('should have the property recordingMode (base name: "recordingMode")', function() {
      // uncomment below and update the code to test the property recordingMode
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestThumbnailConfiguration();
    ...
    it('should have the property targetIntervalSeconds (base name: "targetIntervalSeconds")', function() {
      // uncomment below and update the code to test the property targetIntervalSeconds
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestThumbnailConfiguration();
      //expect(instance).to.be();
    });
