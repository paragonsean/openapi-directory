...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.UpdateChannelRequest();
  });
  ...
  describe('UpdateChannelRequest', function() {
    it('should create an instance of UpdateChannelRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.UpdateChannelRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.UpdateChannelRequest);
    });
