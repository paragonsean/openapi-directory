...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListRecordingConfigurationsRequest();
  });
  ...
  describe('ListRecordingConfigurationsRequest', function() {
    it('should create an instance of ListRecordingConfigurationsRequest', function() {
      // uncomment below and update the code to test ListRecordingConfigurationsRequest
      //var instance = new AmazonInteractiveVideoService.ListRecordingConfigurationsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListRecordingConfigurationsRequest);
    });
