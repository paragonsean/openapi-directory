...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.AudioConfiguration();
  });
  ...
  describe('AudioConfiguration', function() {
    it('should create an instance of AudioConfiguration', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.AudioConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.AudioConfiguration);
    });
