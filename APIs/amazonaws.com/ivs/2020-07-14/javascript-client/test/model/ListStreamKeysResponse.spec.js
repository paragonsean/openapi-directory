...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamKeysResponse();
  });
  ...
  describe('ListStreamKeysResponse', function() {
    it('should create an instance of ListStreamKeysResponse', function() {
      // uncomment below and update the code to test ListStreamKeysResponse
      //var instance = new AmazonInteractiveVideoService.ListStreamKeysResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamKeysResponse);
    });
