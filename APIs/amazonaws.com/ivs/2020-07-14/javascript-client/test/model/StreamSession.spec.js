...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSession();
  });
  ...
  describe('StreamSession', function() {
    it('should create an instance of StreamSession', function() {
      // uncomment below and update the code to test StreamSession
      //var instance = new AmazonInteractiveVideoService.StreamSession();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSession);
    });
    ...
    it('should have the property ingestConfiguration (base name: "ingestConfiguration")', function() {
      // uncomment below and update the code to test the property ingestConfiguration
      //var instance = new AmazonInteractiveVideoService.StreamSession();
      //expect(instance).to.be();
    });

    it('should have the property recordingConfiguration (base name: "recordingConfiguration")', function() {
      // uncomment below and update the code to test the property recordingConfiguration
      //var instance = new AmazonInteractiveVideoService.StreamSession();
      //expect(instance).to.be();
    });
    ...
    it('should have the property truncatedEvents (base name: "truncatedEvents")', function() {
      // uncomment below and update the code to test the property truncatedEvents
      //var instance = new AmazonInteractiveVideoService.StreamSession();
      //expect(instance).to.be();
    });
