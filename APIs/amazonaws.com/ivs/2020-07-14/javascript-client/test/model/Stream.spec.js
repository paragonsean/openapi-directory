...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.Stream();
  });
  ...
  describe('Stream', function() {
    it('should create an instance of Stream', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.Stream();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.Stream);
    });
