...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListRecordingConfigurationsResponse();
  });
  ...
  describe('ListRecordingConfigurationsResponse', function() {
    it('should create an instance of ListRecordingConfigurationsResponse', function() {
      // uncomment below and update the code to test ListRecordingConfigurationsResponse
      //var instance = new AmazonInteractiveVideoService.ListRecordingConfigurationsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListRecordingConfigurationsResponse);
    });
    ...
    it('should have the property recordingConfigurations (base name: "recordingConfigurations")', function() {
      // uncomment below and update the code to test the property recordingConfigurations
      //var instance = new AmazonInteractiveVideoService.ListRecordingConfigurationsResponse();
      //expect(instance).to.be();
    });
