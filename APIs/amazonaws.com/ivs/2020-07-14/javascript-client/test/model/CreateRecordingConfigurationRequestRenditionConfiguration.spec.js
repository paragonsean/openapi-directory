...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestRenditionConfiguration();
  });
  ...
  describe('CreateRecordingConfigurationRequestRenditionConfiguration', function() {
    it('should create an instance of CreateRecordingConfigurationRequestRenditionConfiguration', function() {
      // uncomment below and update the code to test CreateRecordingConfigurationRequestRenditionConfiguration
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestRenditionConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateRecordingConfigurationRequestRenditionConfiguration);
    });

    it('should have the property renditionSelection (base name: "renditionSelection")', function() {
      // uncomment below and update the code to test the property renditionSelection
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationRequestRenditionConfiguration();
