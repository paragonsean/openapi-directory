...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ThumbnailConfiguration();
  });
  ...
  describe('ThumbnailConfiguration', function() {
    it('should create an instance of ThumbnailConfiguration', function() {
      // uncomment below and update the code to test ThumbnailConfiguration
      //var instance = new AmazonInteractiveVideoService.ThumbnailConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ThumbnailConfiguration);
    });
