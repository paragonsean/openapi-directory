...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ImportPlaybackKeyPairResponseKeyPair();
  });
  ...
  describe('ImportPlaybackKeyPairResponseKeyPair', function() {
    it('should create an instance of ImportPlaybackKeyPairResponseKeyPair', function() {
      // uncomment below and update the code to test ImportPlaybackKeyPairResponseKeyPair
      //var instance = new AmazonInteractiveVideoService.ImportPlaybackKeyPairResponseKeyPair();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ImportPlaybackKeyPairResponseKeyPair);
    });
