...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSessionIngestConfiguration();
  });
  ...
  describe('StreamSessionIngestConfiguration', function() {
    it('should create an instance of StreamSessionIngestConfiguration', function() {
      // uncomment below and update the code to test StreamSessionIngestConfiguration
      //var instance = new AmazonInteractiveVideoService.StreamSessionIngestConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSessionIngestConfiguration);
    });
