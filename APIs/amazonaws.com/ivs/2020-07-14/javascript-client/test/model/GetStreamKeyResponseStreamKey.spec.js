...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.GetStreamKeyResponseStreamKey();
  });
  ...
  describe('GetStreamKeyResponseStreamKey', function() {
    it('should create an instance of GetStreamKeyResponseStreamKey', function() {
      // uncomment below and update the code to test GetStreamKeyResponseStreamKey
      //var instance = new AmazonInteractiveVideoService.GetStreamKeyResponseStreamKey();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.GetStreamKeyResponseStreamKey);
    });
