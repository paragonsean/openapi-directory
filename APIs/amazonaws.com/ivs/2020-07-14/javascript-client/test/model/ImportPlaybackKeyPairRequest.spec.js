...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ImportPlaybackKeyPairRequest();
  });
  ...
  describe('ImportPlaybackKeyPairRequest', function() {
    it('should create an instance of ImportPlaybackKeyPairRequest', function() {
      // uncomment below and update the code to test ImportPlaybackKeyPairRequest
      //var instance = new AmazonInteractiveVideoService.ImportPlaybackKeyPairRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ImportPlaybackKeyPairRequest);
    });
    ...
    it('should have the property publicKeyMaterial (base name: "publicKeyMaterial")', function() {
      // uncomment below and update the code to test the property publicKeyMaterial
      //var instance = new AmazonInteractiveVideoService.ImportPlaybackKeyPairRequest();
      //expect(instance).to.be();
    });
