...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.IngestConfigurationAudio();
  });
  ...
  describe('IngestConfigurationAudio', function() {
    it('should create an instance of IngestConfigurationAudio', function() {
      // uncomment below and update the code to test IngestConfigurationAudio
      //var instance = new AmazonInteractiveVideoService.IngestConfigurationAudio();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.IngestConfigurationAudio);
    });
