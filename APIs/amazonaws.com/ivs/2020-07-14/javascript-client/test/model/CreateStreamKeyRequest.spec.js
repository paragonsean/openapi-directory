...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateStreamKeyRequest();
  });
  ...
  describe('CreateStreamKeyRequest', function() {
    it('should create an instance of CreateStreamKeyRequest', function() {
      // uncomment below and update the code to test CreateStreamKeyRequest
      //var instance = new AmazonInteractiveVideoService.CreateStreamKeyRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateStreamKeyRequest);
    });
