...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamKeySummary();
  });
  ...
  describe('StreamKeySummary', function() {
    it('should create an instance of StreamKeySummary', function() {
      // uncomment below and update the code to test StreamKeySummary
      //var instance = new AmazonInteractiveVideoService.StreamKeySummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamKeySummary);
    });
