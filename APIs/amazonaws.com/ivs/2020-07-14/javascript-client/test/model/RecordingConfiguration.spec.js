...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.RecordingConfiguration();
  });
  ...
  describe('RecordingConfiguration', function() {
    it('should create an instance of RecordingConfiguration', function() {
      // uncomment below and update the code to test RecordingConfiguration
      //var instance = new AmazonInteractiveVideoService.RecordingConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.RecordingConfiguration);
    });
