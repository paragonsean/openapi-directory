...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamSessionsResponse();
  });
  ...
  describe('ListStreamSessionsResponse', function() {
    it('should create an instance of ListStreamSessionsResponse', function() {
      // uncomment below and update the code to test ListStreamSessionsResponse
      //var instance = new AmazonInteractiveVideoService.ListStreamSessionsResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamSessionsResponse);
    });
    ...
    it('should have the property streamSessions (base name: "streamSessions")', function() {
      // uncomment below and update the code to test the property streamSessions
      //var instance = new AmazonInteractiveVideoService.ListStreamSessionsResponse();
      //expect(instance).to.be();
    });
