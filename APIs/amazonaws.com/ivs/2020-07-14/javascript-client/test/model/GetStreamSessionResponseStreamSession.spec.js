...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.GetStreamSessionResponseStreamSession();
  });
  ...
  describe('GetStreamSessionResponseStreamSession', function() {
    it('should create an instance of GetStreamSessionResponseStreamSession', function() {
      // uncomment below and update the code to test GetStreamSessionResponseStreamSession
      //var instance = new AmazonInteractiveVideoService.GetStreamSessionResponseStreamSession();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.GetStreamSessionResponseStreamSession);
    });
