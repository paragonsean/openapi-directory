...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateChannelRequest();
  });
  ...
  describe('CreateChannelRequest', function() {
    it('should create an instance of CreateChannelRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.CreateChannelRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateChannelRequest);
    });
