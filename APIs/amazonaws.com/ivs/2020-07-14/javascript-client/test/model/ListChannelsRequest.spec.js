...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListChannelsRequest();
  });
  ...
  describe('ListChannelsRequest', function() {
    it('should create an instance of ListChannelsRequest', function() {
      // uncomment below and update the code to test ListChannelsRequest
      //var instance = new AmazonInteractiveVideoService.ListChannelsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListChannelsRequest);
    });

    it('should have the property filterByName (base name: "filterByName")', function() {
      // uncomment below and update the code to test the property filterByName
      //var instance = new AmazonInteractiveVideoService.ListChannelsRequest();
      //expect(instance).to.be();
    });

    it('should have the property filterByRecordingConfigurationArn (base name: "filterByRecordingConfigurationArn")', function() {
      // uncomment below and update the code to test the property filterByRecordingConfigurationArn
      //var instance = new AmazonInteractiveVideoService.ListChannelsRequest();
      //expect(instance).to.be();
    });
