...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateChannelResponseStreamKey();
  });
  ...
  describe('CreateChannelResponseStreamKey', function() {
    it('should create an instance of CreateChannelResponseStreamKey', function() {
      // uncomment below and update the code to test CreateChannelResponseStreamKey
      //var instance = new AmazonInteractiveVideoService.CreateChannelResponseStreamKey();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateChannelResponseStreamKey);
    });
