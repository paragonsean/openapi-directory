...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSessionChannel();
  });
  ...
  describe('StreamSessionChannel', function() {
    it('should create an instance of StreamSessionChannel', function() {
      // uncomment below and update the code to test StreamSessionChannel
      //var instance = new AmazonInteractiveVideoService.StreamSessionChannel();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSessionChannel);
    });
