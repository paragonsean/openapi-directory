...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.BatchStartViewerSessionRevocationViewerSession();
  });
  ...
  describe('BatchStartViewerSessionRevocationViewerSession', function() {
    it('should create an instance of BatchStartViewerSessionRevocationViewerSession', function() {
      // uncomment below and update the code to test BatchStartViewerSessionRevocationViewerSession
      //var instance = new AmazonInteractiveVideoService.BatchStartViewerSessionRevocationViewerSession();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.BatchStartViewerSessionRevocationViewerSession);
    });
    ...
    it('should have the property viewerSessionVersionsLessThanOrEqualTo (base name: "viewerSessionVersionsLessThanOrEqualTo")', function() {
      // uncomment below and update the code to test the property viewerSessionVersionsLessThanOrEqualTo
      //var instance = new AmazonInteractiveVideoService.BatchStartViewerSessionRevocationViewerSession();
      //expect(instance).to.be();
    });
