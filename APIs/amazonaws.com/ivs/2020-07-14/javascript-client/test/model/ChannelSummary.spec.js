...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ChannelSummary();
  });
  ...
  describe('ChannelSummary', function() {
    it('should create an instance of ChannelSummary', function() {
      // uncomment below and update the code to test ChannelSummary
      //var instance = new AmazonInteractiveVideoService.ChannelSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ChannelSummary);
    });
