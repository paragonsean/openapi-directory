...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.IngestConfigurationVideo();
  });
  ...
  describe('IngestConfigurationVideo', function() {
    it('should create an instance of IngestConfigurationVideo', function() {
      // uncomment below and update the code to test IngestConfigurationVideo
      //var instance = new AmazonInteractiveVideoService.IngestConfigurationVideo();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.IngestConfigurationVideo);
    });
