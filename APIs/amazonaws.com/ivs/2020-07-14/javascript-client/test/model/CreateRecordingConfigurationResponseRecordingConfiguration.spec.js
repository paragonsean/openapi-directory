...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.AmazonInteractiveVideoService);
  }
}(this, function(expect, AmazonInteractiveVideoService) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration();
  });
  ...
  describe('CreateRecordingConfigurationResponseRecordingConfiguration', function() {
    it('should create an instance of CreateRecordingConfigurationResponseRecordingConfiguration', function() {
      // uncomment below and update the code to test CreateRecordingConfigurationResponseRecordingConfiguration
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration);
    });
    ...
    it('should have the property destinationConfiguration (base name: "destinationConfiguration")', function() {
      // uncomment below and update the code to test the property destinationConfiguration
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recordingReconnectWindowSeconds (base name: "recordingReconnectWindowSeconds")', function() {
      // uncomment below and update the code to test the property recordingReconnectWindowSeconds
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property renditionConfiguration (base name: "renditionConfiguration")', function() {
      // uncomment below and update the code to test the property renditionConfiguration
      //var instance = new AmazonInteractiveVideoService.CreateRecordingConfigurationResponseRecordingConfiguration();
      //expect(instance).to.be();
    });
