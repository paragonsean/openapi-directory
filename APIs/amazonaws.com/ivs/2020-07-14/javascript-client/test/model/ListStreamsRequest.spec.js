...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.ListStreamsRequest();
  });
  ...
  describe('ListStreamsRequest', function() {
    it('should create an instance of ListStreamsRequest', function() {
      ...
      //var instance = new AmazonInteractiveVideoService.ListStreamsRequest();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.ListStreamsRequest);
    });
