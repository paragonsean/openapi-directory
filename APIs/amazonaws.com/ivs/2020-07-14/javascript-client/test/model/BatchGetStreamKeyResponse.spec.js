...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.BatchGetStreamKeyResponse();
  });
  ...
  describe('BatchGetStreamKeyResponse', function() {
    it('should create an instance of BatchGetStreamKeyResponse', function() {
      // uncomment below and update the code to test BatchGetStreamKeyResponse
      //var instance = new AmazonInteractiveVideoService.BatchGetStreamKeyResponse();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.BatchGetStreamKeyResponse);
    });
    ...
    it('should have the property streamKeys (base name: "streamKeys")', function() {
      // uncomment below and update the code to test the property streamKeys
      //var instance = new AmazonInteractiveVideoService.BatchGetStreamKeyResponse();
      //expect(instance).to.be();
    });
