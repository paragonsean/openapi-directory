...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.CreateStreamKeyResponseStreamKey();
  });
  ...
  describe('CreateStreamKeyResponseStreamKey', function() {
    it('should create an instance of CreateStreamKeyResponseStreamKey', function() {
      // uncomment below and update the code to test CreateStreamKeyResponseStreamKey
      //var instance = new AmazonInteractiveVideoService.CreateStreamKeyResponseStreamKey();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.CreateStreamKeyResponseStreamKey);
    });
