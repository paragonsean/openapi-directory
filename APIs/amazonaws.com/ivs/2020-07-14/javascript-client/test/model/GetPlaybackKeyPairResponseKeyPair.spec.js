...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.GetPlaybackKeyPairResponseKeyPair();
  });
  ...
  describe('GetPlaybackKeyPairResponseKeyPair', function() {
    it('should create an instance of GetPlaybackKeyPairResponseKeyPair', function() {
      // uncomment below and update the code to test GetPlaybackKeyPairResponseKeyPair
      //var instance = new AmazonInteractiveVideoService.GetPlaybackKeyPairResponseKeyPair();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.GetPlaybackKeyPairResponseKeyPair);
    });
