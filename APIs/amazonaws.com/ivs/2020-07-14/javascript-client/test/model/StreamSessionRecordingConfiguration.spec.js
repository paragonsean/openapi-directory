...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSessionRecordingConfiguration();
  });
  ...
  describe('StreamSessionRecordingConfiguration', function() {
    it('should create an instance of StreamSessionRecordingConfiguration', function() {
      // uncomment below and update the code to test StreamSessionRecordingConfiguration
      //var instance = new AmazonInteractiveVideoService.StreamSessionRecordingConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSessionRecordingConfiguration);
    });
