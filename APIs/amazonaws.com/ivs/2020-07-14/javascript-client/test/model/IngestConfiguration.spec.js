...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.IngestConfiguration();
  });
  ...
  describe('IngestConfiguration', function() {
    it('should create an instance of IngestConfiguration', function() {
      // uncomment below and update the code to test IngestConfiguration
      //var instance = new AmazonInteractiveVideoService.IngestConfiguration();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.IngestConfiguration);
    });
