...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.PlaybackKeyPairSummary();
  });
  ...
  describe('PlaybackKeyPairSummary', function() {
    it('should create an instance of PlaybackKeyPairSummary', function() {
      // uncomment below and update the code to test PlaybackKeyPairSummary
      //var instance = new AmazonInteractiveVideoService.PlaybackKeyPairSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.PlaybackKeyPairSummary);
    });
