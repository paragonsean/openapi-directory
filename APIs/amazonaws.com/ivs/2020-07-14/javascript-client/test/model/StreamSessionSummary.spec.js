...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.StreamSessionSummary();
  });
  ...
  describe('StreamSessionSummary', function() {
    it('should create an instance of StreamSessionSummary', function() {
      // uncomment below and update the code to test StreamSessionSummary
      //var instance = new AmazonInteractiveVideoService.StreamSessionSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.StreamSessionSummary);
    });
    ...
    it('should have the property hasErrorEvent (base name: "hasErrorEvent")', function() {
      // uncomment below and update the code to test the property hasErrorEvent
      //var instance = new AmazonInteractiveVideoService.StreamSessionSummary();
      //expect(instance).to.be();
    });
