...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonInteractiveVideoService.RecordingConfigurationSummary();
  });
  ...
  describe('RecordingConfigurationSummary', function() {
    it('should create an instance of RecordingConfigurationSummary', function() {
      // uncomment below and update the code to test RecordingConfigurationSummary
      //var instance = new AmazonInteractiveVideoService.RecordingConfigurationSummary();
      //expect(instance).to.be.a(AmazonInteractiveVideoService.RecordingConfigurationSummary);
    });
