...
/**
 * The GetStreamKeyRequest model module.
 * @module model/GetStreamKeyRequest
 * @version 2020-07-14
 */
class GetStreamKeyRequest {
    /**
     * Constructs a new <code>GetStreamKeyRequest</code>.
     * @alias module:model/GetStreamKeyRequest
     * @param arn {String} ARN for the stream key to be retrieved.
     */
    constructor(arn) { 
        
        GetStreamKeyRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>GetStreamKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamKeyRequest} obj Optional instance to populate.
     * @return {module:model/GetStreamKeyRequest} The populated <code>GetStreamKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStreamKeyRequest.RequiredProperties) {
...
GetStreamKeyRequest.RequiredProperties = ["arn"];

/**
 * ARN for the stream key to be retrieved.
 * @member {String} arn
 */
GetStreamKeyRequest.prototype['arn'] = undefined;
...
export default GetStreamKeyRequest;
