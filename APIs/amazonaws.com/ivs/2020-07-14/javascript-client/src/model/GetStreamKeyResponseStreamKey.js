...
/**
 * The GetStreamKeyResponseStreamKey model module.
 * @module model/GetStreamKeyResponseStreamKey
 * @version 2020-07-14
 */
class GetStreamKeyResponseStreamKey {
    /**
     * Constructs a new <code>GetStreamKeyResponseStreamKey</code>.
     * @alias module:model/GetStreamKeyResponseStreamKey
     * @implements module:model/StreamKey
     */
    constructor() { 
        StreamKey.initialize(this);
        GetStreamKeyResponseStreamKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamKeyResponseStreamKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamKeyResponseStreamKey} obj Optional instance to populate.
     * @return {module:model/GetStreamKeyResponseStreamKey} The populated <code>GetStreamKeyResponseStreamKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamKeyResponseStreamKey();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamKeyResponseStreamKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamKeyResponseStreamKey</code>.
     */
 ...
 * @member {String} arn
 */
GetStreamKeyResponseStreamKey.prototype['arn'] = undefined;

/**
 * @member {String} channelArn
 */
GetStreamKeyResponseStreamKey.prototype['channelArn'] = undefined;

/**
 * @member {Object} tags
 */
GetStreamKeyResponseStreamKey.prototype['tags'] = undefined;

/**
 * @member {String} value
 */
GetStreamKeyResponseStreamKey.prototype['value'] = undefined;
...
export default GetStreamKeyResponseStreamKey;
