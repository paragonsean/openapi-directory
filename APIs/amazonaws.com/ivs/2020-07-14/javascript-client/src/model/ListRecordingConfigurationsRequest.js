...
/**
 * The ListRecordingConfigurationsRequest model module.
 * @module model/ListRecordingConfigurationsRequest
 * @version 2020-07-14
 */
class ListRecordingConfigurationsRequest {
    /**
     * Constructs a new <code>ListRecordingConfigurationsRequest</code>.
     * @alias module:model/ListRecordingConfigurationsRequest
     */
    constructor() { 
        
        ListRecordingConfigurationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRecordingConfigurationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRecordingConfigurationsRequest} obj Optional instance to populate.
     * @return {module:model/ListRecordingConfigurationsRequest} The populated <code>ListRecordingConfigurationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRecordingConfigurationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRecordingConfigurationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRecordingConfigurationsRequest</code>.
     */
 ...
 */
ListRecordingConfigurationsRequest.prototype['maxResults'] = undefined;

/**
 * The first recording configuration to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListRecordingConfigurationsRequest.prototype['nextToken'] = undefined;
...
export default ListRecordingConfigurationsRequest;
