...
import IngestConfigurationAudio from './IngestConfigurationAudio';
import IngestConfigurationVideo from './IngestConfigurationVideo';

/**
 * The IngestConfiguration model module.
 * @module model/IngestConfiguration
 * @version 2020-07-14
 */
class IngestConfiguration {
    /**
     * Constructs a new <code>IngestConfiguration</code>.
     * Object specifying the ingest configuration set up by the broadcaster, usually in an encoder.
     * @alias module:model/IngestConfiguration
     */
    constructor() { 
        
        IngestConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IngestConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IngestConfiguration} obj Optional instance to populate.
     * @return {module:model/IngestConfiguration} The populated <code>IngestConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IngestConfiguration();

            if (data.hasOwnProperty('audio')) {
                obj['audio'] = IngestConfigurationAudio.constructFromObject(data['audio']);
            }
            if (data.hasOwnProperty('video')) {
                obj['video'] = IngestConfigurationVideo.constructFromObject(data['video']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IngestConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IngestConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `audio`
        if (data['audio']) { // data not null
          IngestConfigurationAudio.validateJSON(data['audio']);
        }
        // validate the optional field `video`
        if (data['video']) { // data not null
          IngestConfigurationVideo.validateJSON(data['video']);
        }
...
/**
 * @member {module:model/IngestConfigurationAudio} audio
 */
IngestConfiguration.prototype['audio'] = undefined;

/**
 * @member {module:model/IngestConfigurationVideo} video
 */
IngestConfiguration.prototype['video'] = undefined;
...
export default IngestConfiguration;
