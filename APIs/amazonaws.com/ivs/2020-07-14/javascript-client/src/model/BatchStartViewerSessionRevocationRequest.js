...
import BatchStartViewerSessionRevocationViewerSession from './BatchStartViewerSessionRevocationViewerSession';

/**
 * The BatchStartViewerSessionRevocationRequest model module.
 * @module model/BatchStartViewerSessionRevocationRequest
 * @version 2020-07-14
 */
class BatchStartViewerSessionRevocationRequest {
    /**
     * Constructs a new <code>BatchStartViewerSessionRevocationRequest</code>.
     * @alias module:model/BatchStartViewerSessionRevocationRequest
     * @param viewerSessions {Array.<module:model/BatchStartViewerSessionRevocationViewerSession>} Array of viewer sessions, one per channel-ARN and viewer-ID pair.
     */
    constructor(viewerSessions) { 
        
        BatchStartViewerSessionRevocationRequest.initialize(this, viewerSessions);
    }
     ...
     */
    static initialize(obj, viewerSessions) { 
        obj['viewerSessions'] = viewerSessions;
    }

    /**
     * Constructs a <code>BatchStartViewerSessionRevocationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchStartViewerSessionRevocationRequest} obj Optional instance to populate.
     * @return {module:model/BatchStartViewerSessionRevocationRequest} The populated <code>BatchStartViewerSessionRevocationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchStartViewerSessionRevocationRequest();

            if (data.hasOwnProperty('viewerSessions')) {
                obj['viewerSessions'] = ApiClient.convertToType(data['viewerSessions'], [BatchStartViewerSessionRevocationViewerSession]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchStartViewerSessionRevocationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchStartViewerSessionRevocationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchStartViewerSessionRevocationRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['viewerSessions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['viewerSessions'])) {
                throw new Error("Expected the field `viewerSessions` to be an array in the JSON data but got " + data['viewerSessions']);
            }
            // validate the optional field `viewerSessions` (array)
            for (const item of data['viewerSessions']) {
                BatchStartViewerSessionRevocationViewerSession.validateJSON(item);
            };
        }
...
BatchStartViewerSessionRevocationRequest.RequiredProperties = ["viewerSessions"];

/**
 * Array of viewer sessions, one per channel-ARN and viewer-ID pair.
 * @member {Array.<module:model/BatchStartViewerSessionRevocationViewerSession>} viewerSessions
 */
BatchStartViewerSessionRevocationRequest.prototype['viewerSessions'] = undefined;
...
export default BatchStartViewerSessionRevocationRequest;
