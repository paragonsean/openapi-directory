...
/**
 * The StreamSessionSummary model module.
 * @module model/StreamSessionSummary
 * @version 2020-07-14
 */
class StreamSessionSummary {
    /**
     * Constructs a new <code>StreamSessionSummary</code>.
     * Summary information about a stream session.
     * @alias module:model/StreamSessionSummary
     */
    constructor() { 
        
        StreamSessionSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamSessionSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSessionSummary} obj Optional instance to populate.
     * @return {module:model/StreamSessionSummary} The populated <code>StreamSessionSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSessionSummary();

            if (data.hasOwnProperty('endTime')) {
                obj['endTime'] = ApiClient.convertToType(data['endTime'], 'Date');
            }
            if (data.hasOwnProperty('hasErrorEvent')) {
                obj['hasErrorEvent'] = ApiClient.convertToType(data['hasErrorEvent'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSessionSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSessionSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['hasErrorEvent']) { // data not null
          Boolean.validateJSON(data['hasErrorEvent']);
        }
 ...
 * @member {Date} endTime
 */
StreamSessionSummary.prototype['endTime'] = undefined;

/**
 * @member {Boolean} hasErrorEvent
 */
StreamSessionSummary.prototype['hasErrorEvent'] = undefined;

/**
 * @member {Date} startTime
 */
StreamSessionSummary.prototype['startTime'] = undefined;

/**
 * @member {String} streamId
 */
StreamSessionSummary.prototype['streamId'] = undefined;
...
export default StreamSessionSummary;
