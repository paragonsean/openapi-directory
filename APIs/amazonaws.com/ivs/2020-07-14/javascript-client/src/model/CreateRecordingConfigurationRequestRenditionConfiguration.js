...
import RenditionConfiguration from './RenditionConfiguration';
import RenditionConfigurationRenditionSelection from './RenditionConfigurationRenditionSelection';

/**
 * The CreateRecordingConfigurationRequestRenditionConfiguration model module.
 * @module model/CreateRecordingConfigurationRequestRenditionConfiguration
 * @version 2020-07-14
 */
class CreateRecordingConfigurationRequestRenditionConfiguration {
    /**
     * Constructs a new <code>CreateRecordingConfigurationRequestRenditionConfiguration</code>.
     * @alias module:model/CreateRecordingConfigurationRequestRenditionConfiguration
     * @implements module:model/RenditionConfiguration
     */
    constructor() { 
        RenditionConfiguration.initialize(this);
        CreateRecordingConfigurationRequestRenditionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationRequestRenditionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} The populated <code>CreateRecordingConfigurationRequestRenditionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationRequestRenditionConfiguration();
            RenditionConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationRequestRenditionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationRequestRenditionConfiguration</code>.
     */
 ...
 */
CreateRecordingConfigurationRequestRenditionConfiguration.prototype['renditionSelection'] = undefined;

/**
 * @member {Array} renditions
 */
CreateRecordingConfigurationRequestRenditionConfiguration.prototype['renditions'] = undefined;


// Implement RenditionConfiguration interface:
/**
 * @member {module:model/RenditionConfigurationRenditionSelection} renditionSelection
 */
...
export default CreateRecordingConfigurationRequestRenditionConfiguration;
