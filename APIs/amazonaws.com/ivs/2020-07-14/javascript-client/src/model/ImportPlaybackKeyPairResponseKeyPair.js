...
/**
 * The ImportPlaybackKeyPairResponseKeyPair model module.
 * @module model/ImportPlaybackKeyPairResponseKeyPair
 * @version 2020-07-14
 */
class ImportPlaybackKeyPairResponseKeyPair {
    /**
     * Constructs a new <code>ImportPlaybackKeyPairResponseKeyPair</code>.
     * @alias module:model/ImportPlaybackKeyPairResponseKeyPair
     * @implements module:model/PlaybackKeyPair
     */
    constructor() { 
        PlaybackKeyPair.initialize(this);
        ImportPlaybackKeyPairResponseKeyPair.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImportPlaybackKeyPairResponseKeyPair</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportPlaybackKeyPairResponseKeyPair} obj Optional instance to populate.
     * @return {module:model/ImportPlaybackKeyPairResponseKeyPair} The populated <code>ImportPlaybackKeyPairResponseKeyPair</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportPlaybackKeyPairResponseKeyPair();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportPlaybackKeyPairResponseKeyPair</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportPlaybackKeyPairResponseKeyPair</code>.
     */
 ...
 * @member {String} arn
 */
ImportPlaybackKeyPairResponseKeyPair.prototype['arn'] = undefined;

/**
 * @member {String} fingerprint
 */
ImportPlaybackKeyPairResponseKeyPair.prototype['fingerprint'] = undefined;

/**
 * @member {String} name
 */
ImportPlaybackKeyPairResponseKeyPair.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
ImportPlaybackKeyPairResponseKeyPair.prototype['tags'] = undefined;
...
export default ImportPlaybackKeyPairResponseKeyPair;
