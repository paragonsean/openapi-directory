...
import GetStreamResponseStream from './GetStreamResponseStream';

/**
 * The GetStreamResponse model module.
 * @module model/GetStreamResponse
 * @version 2020-07-14
 */
class GetStreamResponse {
    /**
     * Constructs a new <code>GetStreamResponse</code>.
     * @alias module:model/GetStreamResponse
     */
    constructor() { 
        
        GetStreamResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamResponse} obj Optional instance to populate.
     * @return {module:model/GetStreamResponse} The populated <code>GetStreamResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamResponse();

            if (data.hasOwnProperty('stream')) {
                obj['stream'] = GetStreamResponseStream.constructFromObject(data['stream']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `stream`
        if (data['stream']) { // data not null
          GetStreamResponseStream.validateJSON(data['stream']);
        }
...
/**
 * @member {module:model/GetStreamResponseStream} stream
 */
GetStreamResponse.prototype['stream'] = undefined;
