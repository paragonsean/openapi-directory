...
/**
 * The CreateRecordingConfigurationRequestDestinationConfigurationS3 model module.
 * @module model/CreateRecordingConfigurationRequestDestinationConfigurationS3
 * @version 2020-07-14
 */
class CreateRecordingConfigurationRequestDestinationConfigurationS3 {
    /**
     * Constructs a new <code>CreateRecordingConfigurationRequestDestinationConfigurationS3</code>.
     * @alias module:model/CreateRecordingConfigurationRequestDestinationConfigurationS3
     * @implements module:model/S3DestinationConfiguration
     * @param bucketName {String} 
     */
    constructor(bucketName) { 
        S3DestinationConfiguration.initialize(this, bucketName);
        CreateRecordingConfigurationRequestDestinationConfigurationS3.initialize(this, bucketName);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationRequestDestinationConfigurationS3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationRequestDestinationConfigurationS3} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationRequestDestinationConfigurationS3} The populated <code>CreateRecordingConfigurationRequestDestinationConfigurationS3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationRequestDestinationConfigurationS3();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationRequestDestinationConfigurationS3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationRequestDestinationConfigurationS3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRecordingConfigurationRequestDestinationConfigurationS3.RequiredProperties) {
...
CreateRecordingConfigurationRequestDestinationConfigurationS3.RequiredProperties = ["bucketName"];

/**
 * @member {String} bucketName
 */
CreateRecordingConfigurationRequestDestinationConfigurationS3.prototype['bucketName'] = undefined;
...
export default CreateRecordingConfigurationRequestDestinationConfigurationS3;
