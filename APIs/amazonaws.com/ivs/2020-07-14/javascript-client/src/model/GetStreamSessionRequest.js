...
/**
 * The GetStreamSessionRequest model module.
 * @module model/GetStreamSessionRequest
 * @version 2020-07-14
 */
class GetStreamSessionRequest {
    /**
     * Constructs a new <code>GetStreamSessionRequest</code>.
     * @alias module:model/GetStreamSessionRequest
     * @param channelArn {String} ARN of the channel resource
     */
    constructor(channelArn) { 
        
        GetStreamSessionRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>GetStreamSessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamSessionRequest} obj Optional instance to populate.
     * @return {module:model/GetStreamSessionRequest} The populated <code>GetStreamSessionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamSessionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamSessionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamSessionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStreamSessionRequest.RequiredProperties) {
...
GetStreamSessionRequest.RequiredProperties = ["channelArn"];

/**
 * ARN of the channel resource
 * @member {String} channelArn
 */
GetStreamSessionRequest.prototype['channelArn'] = undefined;
 ...
 */
GetStreamSessionRequest.prototype['streamId'] = undefined;
...
export default GetStreamSessionRequest;
