...
/**
 * The ListStreamsRequestFilterBy model module.
 * @module model/ListStreamsRequestFilterBy
 * @version 2020-07-14
 */
class ListStreamsRequestFilterBy {
    /**
     * Constructs a new <code>ListStreamsRequestFilterBy</code>.
     * @alias module:model/ListStreamsRequestFilterBy
     * @implements module:model/StreamFilters
     */
    constructor() { 
        StreamFilters.initialize(this);
        ListStreamsRequestFilterBy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListStreamsRequestFilterBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamsRequestFilterBy} obj Optional instance to populate.
     * @return {module:model/ListStreamsRequestFilterBy} The populated <code>ListStreamsRequestFilterBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamsRequestFilterBy();
            StreamFilters.constructFromObject(data, obj);

            if (data.hasOwnProperty('health')) {
                obj['health'] = ApiClient.convertToType(data['health'], StreamHealth);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamsRequestFilterBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamsRequestFilterBy</code>.
     */
    static validateJSON(data) {
        // validate the optional field `health`
        if (data['health']) { // data not null
          StreamHealth.validateJSON(data['health']);
        }
...
/**
 * @member {module:model/StreamHealth} health
 */
ListStreamsRequestFilterBy.prototype['health'] = undefined;


// Implement StreamFilters interface:
/**
 * @member {module:model/StreamHealth} health
 */
StreamFilters.prototype['health'] = undefined;




export default ListStreamsRequestFilterBy;
