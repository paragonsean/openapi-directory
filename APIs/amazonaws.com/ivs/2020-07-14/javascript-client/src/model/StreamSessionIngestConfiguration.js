...
/**
 * The StreamSessionIngestConfiguration model module.
 * @module model/StreamSessionIngestConfiguration
 * @version 2020-07-14
 */
class StreamSessionIngestConfiguration {
    /**
     * Constructs a new <code>StreamSessionIngestConfiguration</code>.
     * @alias module:model/StreamSessionIngestConfiguration
     * @implements module:model/IngestConfiguration
     */
    constructor() { 
        IngestConfiguration.initialize(this);
        StreamSessionIngestConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamSessionIngestConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSessionIngestConfiguration} obj Optional instance to populate.
     * @return {module:model/StreamSessionIngestConfiguration} The populated <code>StreamSessionIngestConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSessionIngestConfiguration();
            IngestConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSessionIngestConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSessionIngestConfiguration</code>.
     */
 ...
 */
StreamSessionIngestConfiguration.prototype['audio'] = undefined;

/**
 * @member {module:model/IngestConfigurationVideo} video
 */
StreamSessionIngestConfiguration.prototype['video'] = undefined;


// Implement IngestConfiguration interface:
/**
 * @member {module:model/IngestConfigurationAudio} audio
 */
...
export default StreamSessionIngestConfiguration;
