...
/**
 * The CreateRecordingConfigurationResponseRecordingConfiguration model module.
 * @module model/CreateRecordingConfigurationResponseRecordingConfiguration
 * @version 2020-07-14
 */
class CreateRecordingConfigurationResponseRecordingConfiguration {
    /**
     * Constructs a new <code>CreateRecordingConfigurationResponseRecordingConfiguration</code>.
     * @alias module:model/CreateRecordingConfigurationResponseRecordingConfiguration
    ...
    constructor(arn, destinationConfiguration, state) { 
        ...
        CreateRecordingConfigurationResponseRecordingConfiguration.initialize(this, arn, destinationConfiguration, state);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationResponseRecordingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationResponseRecordingConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationResponseRecordingConfiguration} The populated <code>CreateRecordingConfigurationResponseRecordingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationResponseRecordingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationResponseRecordingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationResponseRecordingConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRecordingConfigurationResponseRecordingConfiguration.RequiredProperties) {
...
CreateRecordingConfigurationResponseRecordingConfiguration.RequiredProperties = ["arn", "destinationConfiguration", "state"];

/**
 * @member {String} arn
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['arn'] = undefined;

/**
 * @member {module:model/RecordingConfigurationDestinationConfiguration} destinationConfiguration
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} name
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['name'] = undefined;

/**
 * @member {Number} recordingReconnectWindowSeconds
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['recordingReconnectWindowSeconds'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} renditionConfiguration
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['renditionConfiguration'] = undefined;

/**
 * @member {module:model/RecordingConfigurationState} state
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['tags'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} thumbnailConfiguration
 */
CreateRecordingConfigurationResponseRecordingConfiguration.prototype['thumbnailConfiguration'] = undefined;
...
export default CreateRecordingConfigurationResponseRecordingConfiguration;
