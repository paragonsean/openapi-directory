...
class ListStreamsResponse {
    ...
    constructor(streams) { 
        ...
        ListStreamsResponse.initialize(this, streams);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListStreamsResponse.RequiredProperties) {
...
ListStreamsResponse.RequiredProperties = ["streams"];

/**
 * @member {String} nextToken
 */
ListStreamsResponse.prototype['nextToken'] = undefined;
