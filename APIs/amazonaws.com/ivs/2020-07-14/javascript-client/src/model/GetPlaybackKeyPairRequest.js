...
/**
 * The GetPlaybackKeyPairRequest model module.
 * @module model/GetPlaybackKeyPairRequest
 * @version 2020-07-14
 */
class GetPlaybackKeyPairRequest {
    /**
     * Constructs a new <code>GetPlaybackKeyPairRequest</code>.
     * @alias module:model/GetPlaybackKeyPairRequest
     * @param arn {String} ARN of the key pair to be returned.
     */
    constructor(arn) { 
        
        GetPlaybackKeyPairRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>GetPlaybackKeyPairRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPlaybackKeyPairRequest} obj Optional instance to populate.
     * @return {module:model/GetPlaybackKeyPairRequest} The populated <code>GetPlaybackKeyPairRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPlaybackKeyPairRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPlaybackKeyPairRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPlaybackKeyPairRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPlaybackKeyPairRequest.RequiredProperties) {
...
GetPlaybackKeyPairRequest.RequiredProperties = ["arn"];

/**
 * ARN of the key pair to be returned.
 * @member {String} arn
 */
GetPlaybackKeyPairRequest.prototype['arn'] = undefined;
...
export default GetPlaybackKeyPairRequest;
