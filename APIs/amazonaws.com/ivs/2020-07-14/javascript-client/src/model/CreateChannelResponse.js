...
import CreateChannelResponseStreamKey from './CreateChannelResponseStreamKey';
...
class CreateChannelResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('streamKey')) {
                obj['streamKey'] = CreateChannelResponseStreamKey.constructFromObject(data['streamKey']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['streamKey']) { // data not null
          CreateChannelResponseStreamKey.validateJSON(data['streamKey']);
        }
...
/**
 * @member {module:model/CreateChannelResponseStreamKey} streamKey
 */
CreateChannelResponse.prototype['streamKey'] = undefined;
