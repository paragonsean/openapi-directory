...
/**
 * The BatchStartViewerSessionRevocationResponse model module.
 * @module model/BatchStartViewerSessionRevocationResponse
 * @version 2020-07-14
 */
class BatchStartViewerSessionRevocationResponse {
    /**
     * Constructs a new <code>BatchStartViewerSessionRevocationResponse</code>.
     * @alias module:model/BatchStartViewerSessionRevocationResponse
     */
    constructor() { 
        
        BatchStartViewerSessionRevocationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchStartViewerSessionRevocationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchStartViewerSessionRevocationResponse} obj Optional instance to populate.
     * @return {module:model/BatchStartViewerSessionRevocationResponse} The populated <code>BatchStartViewerSessionRevocationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchStartViewerSessionRevocationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchStartViewerSessionRevocationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchStartViewerSessionRevocationResponse</code>.
     */
 ...
 * @member {Array} errors
 */
BatchStartViewerSessionRevocationResponse.prototype['errors'] = undefined;
...
export default BatchStartViewerSessionRevocationResponse;
