...
/**
 * The GetStreamRequest model module.
 * @module model/GetStreamRequest
 * @version 2020-07-14
 */
class GetStreamRequest {
    /**
     * Constructs a new <code>GetStreamRequest</code>.
     * @alias module:model/GetStreamRequest
     * @param channelArn {String} Channel ARN for stream to be accessed.
     */
    constructor(channelArn) { 
        
        GetStreamRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>GetStreamRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamRequest} obj Optional instance to populate.
     * @return {module:model/GetStreamRequest} The populated <code>GetStreamRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStreamRequest.RequiredProperties) {
...
GetStreamRequest.RequiredProperties = ["channelArn"];

/**
 * Channel ARN for stream to be accessed.
 * @member {String} channelArn
 */
GetStreamRequest.prototype['channelArn'] = undefined;
...
export default GetStreamRequest;
