...
/**
 * The IngestConfigurationAudio model module.
 * @module model/IngestConfigurationAudio
 * @version 2020-07-14
 */
class IngestConfigurationAudio {
    /**
     * Constructs a new <code>IngestConfigurationAudio</code>.
     * @alias module:model/IngestConfigurationAudio
     * @implements module:model/AudioConfiguration
     */
    constructor() { 
        AudioConfiguration.initialize(this);
        IngestConfigurationAudio.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IngestConfigurationAudio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IngestConfigurationAudio} obj Optional instance to populate.
     * @return {module:model/IngestConfigurationAudio} The populated <code>IngestConfigurationAudio</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IngestConfigurationAudio();
            AudioConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>IngestConfigurationAudio</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IngestConfigurationAudio</code>.
     */
 ...
 */
IngestConfigurationAudio.prototype['channels'] = undefined;

/**
 * @member {String} codec
 */
IngestConfigurationAudio.prototype['codec'] = undefined;

/**
 * @member {Number} sampleRate
 */
IngestConfigurationAudio.prototype['sampleRate'] = undefined;

/**
 * @member {Number} targetBitrate
 */
IngestConfigurationAudio.prototype['targetBitrate'] = undefined;


// Implement AudioConfiguration interface:
/**
 * @member {Number} channels
 */
...
export default IngestConfigurationAudio;
