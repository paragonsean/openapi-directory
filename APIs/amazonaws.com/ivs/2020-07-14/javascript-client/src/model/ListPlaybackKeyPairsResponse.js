...
/**
 * The ListPlaybackKeyPairsResponse model module.
 * @module model/ListPlaybackKeyPairsResponse
 * @version 2020-07-14
 */
class ListPlaybackKeyPairsResponse {
    /**
     * Constructs a new <code>ListPlaybackKeyPairsResponse</code>.
     * @alias module:model/ListPlaybackKeyPairsResponse
     * @param keyPairs {Array} 
     */
    constructor(keyPairs) { 
        
        ListPlaybackKeyPairsResponse.initialize(this, keyPairs);
    }
     ...
     */
    static initialize(obj, keyPairs) { 
        obj['keyPairs'] = keyPairs;
    }

    /**
     * Constructs a <code>ListPlaybackKeyPairsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPlaybackKeyPairsResponse} obj Optional instance to populate.
     * @return {module:model/ListPlaybackKeyPairsResponse} The populated <code>ListPlaybackKeyPairsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPlaybackKeyPairsResponse();

            if (data.hasOwnProperty('keyPairs')) {
                obj['keyPairs'] = ApiClient.convertToType(data['keyPairs'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPlaybackKeyPairsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPlaybackKeyPairsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPlaybackKeyPairsResponse.RequiredProperties) {
        ...
        if (data['keyPairs']) { // data not null
          Array.validateJSON(data['keyPairs']);
        }
...
ListPlaybackKeyPairsResponse.RequiredProperties = ["keyPairs"];

/**
 * @member {Array} keyPairs
 */
ListPlaybackKeyPairsResponse.prototype['keyPairs'] = undefined;

/**
 * @member {String} nextToken
 */
ListPlaybackKeyPairsResponse.prototype['nextToken'] = undefined;
...
export default ListPlaybackKeyPairsResponse;
