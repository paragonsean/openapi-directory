...
import GetPlaybackKeyPairResponseKeyPair from './GetPlaybackKeyPairResponseKeyPair';

/**
 * The GetPlaybackKeyPairResponse model module.
 * @module model/GetPlaybackKeyPairResponse
 * @version 2020-07-14
 */
class GetPlaybackKeyPairResponse {
    /**
     * Constructs a new <code>GetPlaybackKeyPairResponse</code>.
     * @alias module:model/GetPlaybackKeyPairResponse
     */
    constructor() { 
        
        GetPlaybackKeyPairResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPlaybackKeyPairResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPlaybackKeyPairResponse} obj Optional instance to populate.
     * @return {module:model/GetPlaybackKeyPairResponse} The populated <code>GetPlaybackKeyPairResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPlaybackKeyPairResponse();

            if (data.hasOwnProperty('keyPair')) {
                obj['keyPair'] = GetPlaybackKeyPairResponseKeyPair.constructFromObject(data['keyPair']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPlaybackKeyPairResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPlaybackKeyPairResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `keyPair`
        if (data['keyPair']) { // data not null
          GetPlaybackKeyPairResponseKeyPair.validateJSON(data['keyPair']);
        }
...
/**
 * @member {module:model/GetPlaybackKeyPairResponseKeyPair} keyPair
 */
GetPlaybackKeyPairResponse.prototype['keyPair'] = undefined;
...
export default GetPlaybackKeyPairResponse;
