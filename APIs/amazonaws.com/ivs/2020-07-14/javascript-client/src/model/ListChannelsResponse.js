...
class ListChannelsResponse {
    ...
    constructor(channels) { 
        ...
        ListChannelsResponse.initialize(this, channels);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListChannelsResponse.RequiredProperties) {
...
ListChannelsResponse.RequiredProperties = ["channels"];
