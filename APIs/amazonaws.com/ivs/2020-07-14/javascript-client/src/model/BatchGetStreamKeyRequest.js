...
/**
 * The BatchGetStreamKeyRequest model module.
 * @module model/BatchGetStreamKeyRequest
 * @version 2020-07-14
 */
class BatchGetStreamKeyRequest {
    /**
     * Constructs a new <code>BatchGetStreamKeyRequest</code>.
     * @alias module:model/BatchGetStreamKeyRequest
     * @param arns {Array.<String>} Array of ARNs, one per stream key.
     */
    constructor(arns) { 
        
        BatchGetStreamKeyRequest.initialize(this, arns);
    }
     ...
     */
    static initialize(obj, arns) { 
        obj['arns'] = arns;
    }

    /**
     * Constructs a <code>BatchGetStreamKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetStreamKeyRequest} obj Optional instance to populate.
     * @return {module:model/BatchGetStreamKeyRequest} The populated <code>BatchGetStreamKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetStreamKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetStreamKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetStreamKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchGetStreamKeyRequest.RequiredProperties) {
...
BatchGetStreamKeyRequest.RequiredProperties = ["arns"];

/**
 * Array of ARNs, one per stream key.
 * @member {Array.<String>} arns
 */
BatchGetStreamKeyRequest.prototype['arns'] = undefined;
...
export default BatchGetStreamKeyRequest;
