...
/**
 * The GetStreamResponseStream model module.
 * @module model/GetStreamResponseStream
 * @version 2020-07-14
 */
class GetStreamResponseStream {
    /**
     * Constructs a new <code>GetStreamResponseStream</code>.
     * @alias module:model/GetStreamResponseStream
     * @implements module:model/Stream
     */
    constructor() { 
        Stream.initialize(this);
        GetStreamResponseStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamResponseStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamResponseStream} obj Optional instance to populate.
     * @return {module:model/GetStreamResponseStream} The populated <code>GetStreamResponseStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamResponseStream();
            Stream.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ApiClient.convertToType(data['state'], StreamState);
            }
            if (data.hasOwnProperty('streamId')) {
                obj['streamId'] = ApiClient.convertToType(data['streamId'], 'String');
            }
            if (data.hasOwnProperty('viewerCount')) {
                obj['viewerCount'] = ApiClient.convertToType(data['viewerCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamResponseStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamResponseStream</code>.
     */
    static validateJSON(data) {
        ...
        if (data['state']) { // data not null
          StreamState.validateJSON(data['state']);
        }
        ...
        if (data['viewerCount']) { // data not null
          Number.validateJSON(data['viewerCount']);
        }
 ...
 */
GetStreamResponseStream.prototype['channelArn'] = undefined;

/**
 * @member {module:model/StreamHealth} health
 */
GetStreamResponseStream.prototype['health'] = undefined;

/**
 * @member {String} playbackUrl
 */
GetStreamResponseStream.prototype['playbackUrl'] = undefined;

/**
 * @member {Date} startTime
 */
GetStreamResponseStream.prototype['startTime'] = undefined;

/**
 * @member {module:model/StreamState} state
 */
GetStreamResponseStream.prototype['state'] = undefined;

/**
 * @member {String} streamId
 */
GetStreamResponseStream.prototype['streamId'] = undefined;

/**
 * @member {Number} viewerCount
 */
GetStreamResponseStream.prototype['viewerCount'] = undefined;
 ...
 * @member {String} channelArn
 */
Stream.prototype['channelArn'] = undefined;
/**
 * @member {module:model/StreamHealth} health
 */
Stream.prototype['health'] = undefined;
/**
 * @member {String} playbackUrl
 */
Stream.prototype['playbackUrl'] = undefined;
/**
 * @member {Date} startTime
 */
Stream.prototype['startTime'] = undefined;
/**
 * @member {module:model/StreamState} state
 */
 ...
 * @member {String} streamId
 */
Stream.prototype['streamId'] = undefined;
/**
 * @member {Number} viewerCount
 */
Stream.prototype['viewerCount'] = undefined;




export default GetStreamResponseStream;
