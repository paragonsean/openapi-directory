...
/**
 * The PlaybackKeyPair model module.
 * @module model/PlaybackKeyPair
 * @version 2020-07-14
 */
class PlaybackKeyPair {
    /**
     * Constructs a new <code>PlaybackKeyPair</code>.
     * A key pair used to sign and validate a playback authorization token.
     * @alias module:model/PlaybackKeyPair
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PlaybackKeyPair</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlaybackKeyPair} obj Optional instance to populate.
     * @return {module:model/PlaybackKeyPair} The populated <code>PlaybackKeyPair</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaybackKeyPair();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaybackKeyPair</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaybackKeyPair</code>.
     */
...
export default PlaybackKeyPair;
