...
/**
 * The BatchGetStreamKeyResponse model module.
 * @module model/BatchGetStreamKeyResponse
 * @version 2020-07-14
 */
class BatchGetStreamKeyResponse {
    /**
     * Constructs a new <code>BatchGetStreamKeyResponse</code>.
     * @alias module:model/BatchGetStreamKeyResponse
     */
    constructor() { 
        
        BatchGetStreamKeyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetStreamKeyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetStreamKeyResponse} obj Optional instance to populate.
     * @return {module:model/BatchGetStreamKeyResponse} The populated <code>BatchGetStreamKeyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetStreamKeyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetStreamKeyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetStreamKeyResponse</code>.
     */
 ...
 * @member {Array} errors
 */
BatchGetStreamKeyResponse.prototype['errors'] = undefined;

/**
 * @member {Array} streamKeys
 */
BatchGetStreamKeyResponse.prototype['streamKeys'] = undefined;
...
export default BatchGetStreamKeyResponse;
