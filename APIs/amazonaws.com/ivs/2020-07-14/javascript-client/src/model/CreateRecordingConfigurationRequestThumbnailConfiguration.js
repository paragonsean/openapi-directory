...
import ThumbnailConfigurationResolution from './ThumbnailConfigurationResolution';

/**
 * The CreateRecordingConfigurationRequestThumbnailConfiguration model module.
 * @module model/CreateRecordingConfigurationRequestThumbnailConfiguration
 * @version 2020-07-14
 */
class CreateRecordingConfigurationRequestThumbnailConfiguration {
    /**
     * Constructs a new <code>CreateRecordingConfigurationRequestThumbnailConfiguration</code>.
     * @alias module:model/CreateRecordingConfigurationRequestThumbnailConfiguration
     * @implements module:model/ThumbnailConfiguration
     */
    constructor() { 
        ThumbnailConfiguration.initialize(this);
        CreateRecordingConfigurationRequestThumbnailConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationRequestThumbnailConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} The populated <code>CreateRecordingConfigurationRequestThumbnailConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationRequestThumbnailConfiguration();
            ThumbnailConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('recordingMode')) {
                obj['recordingMode'] = ApiClient.convertToType(data['recordingMode'], RecordingMode);
            }
            if (data.hasOwnProperty('resolution')) {
                obj['resolution'] = ApiClient.convertToType(data['resolution'], ThumbnailConfigurationResolution);
            }
            if (data.hasOwnProperty('storage')) {
                obj['storage'] = ApiClient.convertToType(data['storage'], Array);
            }
            if (data.hasOwnProperty('targetIntervalSeconds')) {
                obj['targetIntervalSeconds'] = ApiClient.convertToType(data['targetIntervalSeconds'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationRequestThumbnailConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationRequestThumbnailConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `recordingMode`
        if (data['recordingMode']) { // data not null
          RecordingMode.validateJSON(data['recordingMode']);
        }
        // validate the optional field `resolution`
        if (data['resolution']) { // data not null
          ThumbnailConfigurationResolution.validateJSON(data['resolution']);
        }
        // validate the optional field `storage`
        if (data['storage']) { // data not null
          Array.validateJSON(data['storage']);
        }
        // validate the optional field `targetIntervalSeconds`
        if (data['targetIntervalSeconds']) { // data not null
          Number.validateJSON(data['targetIntervalSeconds']);
        }
...
/**
 * @member {module:model/RecordingMode} recordingMode
 */
CreateRecordingConfigurationRequestThumbnailConfiguration.prototype['recordingMode'] = undefined;

/**
 * @member {module:model/ThumbnailConfigurationResolution} resolution
 */
CreateRecordingConfigurationRequestThumbnailConfiguration.prototype['resolution'] = undefined;

/**
 * @member {Array} storage
 */
CreateRecordingConfigurationRequestThumbnailConfiguration.prototype['storage'] = undefined;

/**
 * @member {Number} targetIntervalSeconds
 */
CreateRecordingConfigurationRequestThumbnailConfiguration.prototype['targetIntervalSeconds'] = undefined;
 ...
 * @member {module:model/RecordingMode} recordingMode
 */
ThumbnailConfiguration.prototype['recordingMode'] = undefined;
/**
 * @member {module:model/ThumbnailConfigurationResolution} resolution
 */
ThumbnailConfiguration.prototype['resolution'] = undefined;
/**
 * @member {Array} storage
 */
ThumbnailConfiguration.prototype['storage'] = undefined;
/**
 * @member {Number} targetIntervalSeconds
 */
ThumbnailConfiguration.prototype['targetIntervalSeconds'] = undefined;




export default CreateRecordingConfigurationRequestThumbnailConfiguration;
