...
/**
 * The GetStreamSessionResponseStreamSession model module.
 * @module model/GetStreamSessionResponseStreamSession
 * @version 2020-07-14
 */
class GetStreamSessionResponseStreamSession {
    /**
     * Constructs a new <code>GetStreamSessionResponseStreamSession</code>.
     * @alias module:model/GetStreamSessionResponseStreamSession
     * @implements module:model/StreamSession
     */
    constructor() { 
        StreamSession.initialize(this);
        GetStreamSessionResponseStreamSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamSessionResponseStreamSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamSessionResponseStreamSession} obj Optional instance to populate.
     * @return {module:model/GetStreamSessionResponseStreamSession} The populated <code>GetStreamSessionResponseStreamSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamSessionResponseStreamSession();
            StreamSession.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamSessionResponseStreamSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamSessionResponseStreamSession</code>.
     */
 ...
 */
GetStreamSessionResponseStreamSession.prototype['channel'] = undefined;

/**
 * @member {Date} endTime
 */
GetStreamSessionResponseStreamSession.prototype['endTime'] = undefined;

/**
 * @member {module:model/StreamSessionIngestConfiguration} ingestConfiguration
 */
GetStreamSessionResponseStreamSession.prototype['ingestConfiguration'] = undefined;

/**
 * @member {module:model/StreamSessionRecordingConfiguration} recordingConfiguration
 */
GetStreamSessionResponseStreamSession.prototype['recordingConfiguration'] = undefined;

/**
 * @member {Date} startTime
 */
GetStreamSessionResponseStreamSession.prototype['startTime'] = undefined;

/**
 * @member {String} streamId
 */
GetStreamSessionResponseStreamSession.prototype['streamId'] = undefined;

/**
 * @member {Array} truncatedEvents
 */
GetStreamSessionResponseStreamSession.prototype['truncatedEvents'] = undefined;


// Implement StreamSession interface:
/**
 * @member {module:model/StreamSessionChannel} channel
 */
...
export default GetStreamSessionResponseStreamSession;
