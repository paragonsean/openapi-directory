...
class DeleteChannelRequest {
     ...
     * @param arn {String} ARN of the channel to be deleted.
     */
    constructor(arn) { 
        
        DeleteChannelRequest.initialize(this, arn);
    }
...
DeleteChannelRequest.RequiredProperties = ["arn"];

/**
 * ARN of the channel to be deleted.
 * @member {String} arn
 */
DeleteChannelRequest.prototype['arn'] = undefined;
