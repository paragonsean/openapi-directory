...
/**
 * The BatchStartViewerSessionRevocationError model module.
 * @module model/BatchStartViewerSessionRevocationError
 * @version 2020-07-14
 */
class BatchStartViewerSessionRevocationError {
    /**
     * Constructs a new <code>BatchStartViewerSessionRevocationError</code>.
     ...
     * @alias module:model/BatchStartViewerSessionRevocationError
     * @param channelArn {String} 
     * @param viewerId {String} 
     */
    constructor(channelArn, viewerId) { 
        
        BatchStartViewerSessionRevocationError.initialize(this, channelArn, viewerId);
    }
    ...
    /**
     * Constructs a <code>BatchStartViewerSessionRevocationError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchStartViewerSessionRevocationError} obj Optional instance to populate.
     * @return {module:model/BatchStartViewerSessionRevocationError} The populated <code>BatchStartViewerSessionRevocationError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchStartViewerSessionRevocationError();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchStartViewerSessionRevocationError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchStartViewerSessionRevocationError</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchStartViewerSessionRevocationError.RequiredProperties) {
...
BatchStartViewerSessionRevocationError.RequiredProperties = ["channelArn", "viewerId"];

/**
 * @member {String} channelArn
 */
BatchStartViewerSessionRevocationError.prototype['channelArn'] = undefined;

/**
 * @member {String} code
 */
BatchStartViewerSessionRevocationError.prototype['code'] = undefined;

/**
 * @member {String} message
 */
BatchStartViewerSessionRevocationError.prototype['message'] = undefined;

/**
 * @member {String} viewerId
 */
BatchStartViewerSessionRevocationError.prototype['viewerId'] = undefined;
...
export default BatchStartViewerSessionRevocationError;
