...
/**
 * The RecordingConfiguration model module.
 * @module model/RecordingConfiguration
 * @version 2020-07-14
 */
class RecordingConfiguration {
    /**
     * Constructs a new <code>RecordingConfiguration</code>.
     * An object representing a configuration to record a channel stream.
     * @alias module:model/RecordingConfiguration
     * @param arn {String} 
    ...
    /**
     * Constructs a <code>RecordingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecordingConfiguration} obj Optional instance to populate.
     * @return {module:model/RecordingConfiguration} The populated <code>RecordingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RecordingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecordingConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecordingConfiguration.RequiredProperties) {
...
RecordingConfiguration.RequiredProperties = ["arn", "destinationConfiguration", "state"];
...
export default RecordingConfiguration;
