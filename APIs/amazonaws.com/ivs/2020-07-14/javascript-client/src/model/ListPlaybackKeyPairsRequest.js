...
/**
 * The ListPlaybackKeyPairsRequest model module.
 * @module model/ListPlaybackKeyPairsRequest
 * @version 2020-07-14
 */
class ListPlaybackKeyPairsRequest {
    /**
     * Constructs a new <code>ListPlaybackKeyPairsRequest</code>.
     * @alias module:model/ListPlaybackKeyPairsRequest
     */
    constructor() { 
        
        ListPlaybackKeyPairsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPlaybackKeyPairsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPlaybackKeyPairsRequest} obj Optional instance to populate.
     * @return {module:model/ListPlaybackKeyPairsRequest} The populated <code>ListPlaybackKeyPairsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPlaybackKeyPairsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPlaybackKeyPairsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPlaybackKeyPairsRequest</code>.
     */
 ...
 */
ListPlaybackKeyPairsRequest.prototype['maxResults'] = undefined;

/**
 * The first key pair to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListPlaybackKeyPairsRequest.prototype['nextToken'] = undefined;
...
export default ListPlaybackKeyPairsRequest;
