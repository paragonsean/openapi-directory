...
/**
 * The GetRecordingConfigurationRequest model module.
 * @module model/GetRecordingConfigurationRequest
 * @version 2020-07-14
 */
class GetRecordingConfigurationRequest {
    /**
     * Constructs a new <code>GetRecordingConfigurationRequest</code>.
     * @alias module:model/GetRecordingConfigurationRequest
     * @param arn {String} ARN of the recording configuration to be retrieved.
     */
    constructor(arn) { 
        
        GetRecordingConfigurationRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>GetRecordingConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRecordingConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/GetRecordingConfigurationRequest} The populated <code>GetRecordingConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRecordingConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRecordingConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRecordingConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRecordingConfigurationRequest.RequiredProperties) {
...
GetRecordingConfigurationRequest.RequiredProperties = ["arn"];

/**
 * ARN of the recording configuration to be retrieved.
 * @member {String} arn
 */
GetRecordingConfigurationRequest.prototype['arn'] = undefined;
...
export default GetRecordingConfigurationRequest;
