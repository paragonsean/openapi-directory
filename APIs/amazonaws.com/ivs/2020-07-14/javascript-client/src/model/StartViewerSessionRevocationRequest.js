...
/**
 * The StartViewerSessionRevocationRequest model module.
 * @module model/StartViewerSessionRevocationRequest
 * @version 2020-07-14
 */
class StartViewerSessionRevocationRequest {
    /**
     * Constructs a new <code>StartViewerSessionRevocationRequest</code>.
     * @alias module:model/StartViewerSessionRevocationRequest
     * @param channelArn {String} The ARN of the channel associated with the viewer session to revoke.
     * @param viewerId {String} The ID of the viewer associated with the viewer session to revoke. Do not use this field for personally identifying, confidential, or sensitive information.
     */
    constructor(channelArn, viewerId) { 
        
        StartViewerSessionRevocationRequest.initialize(this, channelArn, viewerId);
    }
    ...
    /**
     * Constructs a <code>StartViewerSessionRevocationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartViewerSessionRevocationRequest} obj Optional instance to populate.
     * @return {module:model/StartViewerSessionRevocationRequest} The populated <code>StartViewerSessionRevocationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartViewerSessionRevocationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartViewerSessionRevocationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartViewerSessionRevocationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartViewerSessionRevocationRequest.RequiredProperties) {
...
StartViewerSessionRevocationRequest.RequiredProperties = ["channelArn", "viewerId"];

/**
 * The ARN of the channel associated with the viewer session to revoke.
 * @member {String} channelArn
 */
StartViewerSessionRevocationRequest.prototype['channelArn'] = undefined;

/**
 * The ID of the viewer associated with the viewer session to revoke. Do not use this field for personally identifying, confidential, or sensitive information.
 * @member {String} viewerId
 */
StartViewerSessionRevocationRequest.prototype['viewerId'] = undefined;

/**
 * An optional filter on which versions of the viewer session to revoke. All versions less than or equal to the specified version will be revoked. Default: 0.
 * @member {Number} viewerSessionVersionsLessThanOrEqualTo
 */
StartViewerSessionRevocationRequest.prototype['viewerSessionVersionsLessThanOrEqualTo'] = undefined;
...
export default StartViewerSessionRevocationRequest;
