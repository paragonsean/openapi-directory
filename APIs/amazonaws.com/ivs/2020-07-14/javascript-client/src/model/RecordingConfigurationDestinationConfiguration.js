...
/**
 * The RecordingConfigurationDestinationConfiguration model module.
 * @module model/RecordingConfigurationDestinationConfiguration
 * @version 2020-07-14
 */
class RecordingConfigurationDestinationConfiguration {
    /**
     * Constructs a new <code>RecordingConfigurationDestinationConfiguration</code>.
     * @alias module:model/RecordingConfigurationDestinationConfiguration
     * @implements module:model/DestinationConfiguration
     */
    constructor() { 
        DestinationConfiguration.initialize(this);
        RecordingConfigurationDestinationConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RecordingConfigurationDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecordingConfigurationDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/RecordingConfigurationDestinationConfiguration} The populated <code>RecordingConfigurationDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordingConfigurationDestinationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RecordingConfigurationDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecordingConfigurationDestinationConfiguration</code>.
     */
 ...
 */
RecordingConfigurationDestinationConfiguration.prototype['s3'] = undefined;
...
export default RecordingConfigurationDestinationConfiguration;
