...
import ChannelLatencyMode from './ChannelLatencyMode';
import ChannelType from './ChannelType';
import TranscodePreset from './TranscodePreset';
...
class ChannelSummary {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('latencyMode')) {
                obj['latencyMode'] = ApiClient.convertToType(data['latencyMode'], ChannelLatencyMode);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('preset')) {
                obj['preset'] = ApiClient.convertToType(data['preset'], TranscodePreset);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['authorized']) { // data not null
          Boolean.validateJSON(data['authorized']);
        }
        // validate the optional field `insecureIngest`
        if (data['insecureIngest']) { // data not null
          Boolean.validateJSON(data['insecureIngest']);
        }
        // validate the optional field `latencyMode`
        if (data['latencyMode']) { // data not null
          ChannelLatencyMode.validateJSON(data['latencyMode']);
        }
        ...
        if (data['preset']) { // data not null
          TranscodePreset.validateJSON(data['preset']);
        }
        // validate the optional field `recordingConfigurationArn`
        if (data['recordingConfigurationArn']) { // data not null
          String.validateJSON(data['recordingConfigurationArn']);
        }
 ...
 */
ChannelSummary.prototype['authorized'] = undefined;

/**
 * @member {Boolean} insecureIngest
 */
ChannelSummary.prototype['insecureIngest'] = undefined;

/**
 * @member {module:model/ChannelLatencyMode} latencyMode
 */
ChannelSummary.prototype['latencyMode'] = undefined;
...
/**
 * @member {module:model/TranscodePreset} preset
 */
ChannelSummary.prototype['preset'] = undefined;

/**
 * @member {String} recordingConfigurationArn
 */
ChannelSummary.prototype['recordingConfigurationArn'] = undefined;
 ...
 */
ChannelSummary.prototype['type'] = undefined;
