...
import ImportPlaybackKeyPairResponseKeyPair from './ImportPlaybackKeyPairResponseKeyPair';

/**
 * The ImportPlaybackKeyPairResponse model module.
 * @module model/ImportPlaybackKeyPairResponse
 * @version 2020-07-14
 */
class ImportPlaybackKeyPairResponse {
    /**
     * Constructs a new <code>ImportPlaybackKeyPairResponse</code>.
     * @alias module:model/ImportPlaybackKeyPairResponse
     */
    constructor() { 
        
        ImportPlaybackKeyPairResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImportPlaybackKeyPairResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportPlaybackKeyPairResponse} obj Optional instance to populate.
     * @return {module:model/ImportPlaybackKeyPairResponse} The populated <code>ImportPlaybackKeyPairResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportPlaybackKeyPairResponse();

            if (data.hasOwnProperty('keyPair')) {
                obj['keyPair'] = ImportPlaybackKeyPairResponseKeyPair.constructFromObject(data['keyPair']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportPlaybackKeyPairResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportPlaybackKeyPairResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `keyPair`
        if (data['keyPair']) { // data not null
          ImportPlaybackKeyPairResponseKeyPair.validateJSON(data['keyPair']);
        }
...
/**
 * @member {module:model/ImportPlaybackKeyPairResponseKeyPair} keyPair
 */
ImportPlaybackKeyPairResponse.prototype['keyPair'] = undefined;
...
export default ImportPlaybackKeyPairResponse;
