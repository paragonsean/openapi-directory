...
/**
 * The StreamFilters model module.
 * @module model/StreamFilters
 * @version 2020-07-14
 */
class StreamFilters {
    /**
     * Constructs a new <code>StreamFilters</code>.
     * Object specifying the stream attribute on which to filter.
     * @alias module:model/StreamFilters
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamFilters} obj Optional instance to populate.
     * @return {module:model/StreamFilters} The populated <code>StreamFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamFilters</code>.
     */
