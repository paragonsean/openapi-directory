...
/**
 * The StreamSummary model module.
 * @module model/StreamSummary
 * @version 2020-07-14
 */
class StreamSummary {
    /**
     * Constructs a new <code>StreamSummary</code>.
     * Summary information about a stream.
     * @alias module:model/StreamSummary
     */
    constructor() { 
        
        StreamSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSummary} obj Optional instance to populate.
     * @return {module:model/StreamSummary} The populated <code>StreamSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSummary</code>.
     */
 ...
 */
StreamSummary.prototype['channelArn'] = undefined;

/**
 * @member {module:model/StreamHealth} health
 */
StreamSummary.prototype['health'] = undefined;

/**
 * @member {Date} startTime
 */
StreamSummary.prototype['startTime'] = undefined;

/**
 * @member {module:model/StreamState} state
 */
StreamSummary.prototype['state'] = undefined;

/**
 * @member {String} streamId
 */
StreamSummary.prototype['streamId'] = undefined;

/**
 * @member {Number} viewerCount
 */
StreamSummary.prototype['viewerCount'] = undefined;
