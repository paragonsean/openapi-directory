...
/**
 * The ListStreamKeysRequest model module.
 * @module model/ListStreamKeysRequest
 * @version 2020-07-14
 */
class ListStreamKeysRequest {
    /**
     * Constructs a new <code>ListStreamKeysRequest</code>.
     * @alias module:model/ListStreamKeysRequest
     * @param channelArn {String} Channel ARN used to filter the list.
     */
    constructor(channelArn) { 
        
        ListStreamKeysRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>ListStreamKeysRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamKeysRequest} obj Optional instance to populate.
     * @return {module:model/ListStreamKeysRequest} The populated <code>ListStreamKeysRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamKeysRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamKeysRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamKeysRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStreamKeysRequest.RequiredProperties) {
...
ListStreamKeysRequest.RequiredProperties = ["channelArn"];

/**
 * Channel ARN used to filter the list.
 * @member {String} channelArn
 */
ListStreamKeysRequest.prototype['channelArn'] = undefined;

/**
 * Maximum number of streamKeys to return. Default: 1.
 * @member {Number} maxResults
 */
ListStreamKeysRequest.prototype['maxResults'] = undefined;

/**
 * The first stream key to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListStreamKeysRequest.prototype['nextToken'] = undefined;
...
export default ListStreamKeysRequest;
