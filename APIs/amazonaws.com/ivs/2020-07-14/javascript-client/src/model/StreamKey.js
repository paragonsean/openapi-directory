...
/**
 * The StreamKey model module.
 * @module model/StreamKey
 * @version 2020-07-14
 */
class StreamKey {
    /**
     * Constructs a new <code>StreamKey</code>.
     * Object specifying a stream key.
     * @alias module:model/StreamKey
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamKey} obj Optional instance to populate.
     * @return {module:model/StreamKey} The populated <code>StreamKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamKey();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamKey</code>.
     */
