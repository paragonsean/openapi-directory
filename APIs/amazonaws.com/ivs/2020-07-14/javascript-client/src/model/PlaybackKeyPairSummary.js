...
/**
 * The PlaybackKeyPairSummary model module.
 * @module model/PlaybackKeyPairSummary
 * @version 2020-07-14
 */
class PlaybackKeyPairSummary {
    /**
     * Constructs a new <code>PlaybackKeyPairSummary</code>.
     * Summary information about a playback key pair.
     * @alias module:model/PlaybackKeyPairSummary
     */
    constructor() { 
        
        PlaybackKeyPairSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlaybackKeyPairSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlaybackKeyPairSummary} obj Optional instance to populate.
     * @return {module:model/PlaybackKeyPairSummary} The populated <code>PlaybackKeyPairSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaybackKeyPairSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaybackKeyPairSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaybackKeyPairSummary</code>.
     */
 ...
 * @member {String} arn
 */
PlaybackKeyPairSummary.prototype['arn'] = undefined;

/**
 * @member {String} name
 */
PlaybackKeyPairSummary.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
PlaybackKeyPairSummary.prototype['tags'] = undefined;
...
export default PlaybackKeyPairSummary;
