...
import CreateRecordingConfigurationResponseRecordingConfiguration from './CreateRecordingConfigurationResponseRecordingConfiguration';

/**
 * The CreateRecordingConfigurationResponse model module.
 * @module model/CreateRecordingConfigurationResponse
 * @version 2020-07-14
 */
class CreateRecordingConfigurationResponse {
    /**
     * Constructs a new <code>CreateRecordingConfigurationResponse</code>.
     * @alias module:model/CreateRecordingConfigurationResponse
     */
    constructor() { 
        
        CreateRecordingConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationResponse} The populated <code>CreateRecordingConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationResponse();

            if (data.hasOwnProperty('recordingConfiguration')) {
                obj['recordingConfiguration'] = CreateRecordingConfigurationResponseRecordingConfiguration.constructFromObject(data['recordingConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `recordingConfiguration`
        if (data['recordingConfiguration']) { // data not null
          CreateRecordingConfigurationResponseRecordingConfiguration.validateJSON(data['recordingConfiguration']);
        }
...
/**
 * @member {module:model/CreateRecordingConfigurationResponseRecordingConfiguration} recordingConfiguration
 */
CreateRecordingConfigurationResponse.prototype['recordingConfiguration'] = undefined;
...
export default CreateRecordingConfigurationResponse;
