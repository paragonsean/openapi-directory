...
/**
 * The ListStreamSessionsRequest model module.
 * @module model/ListStreamSessionsRequest
 * @version 2020-07-14
 */
class ListStreamSessionsRequest {
    /**
     * Constructs a new <code>ListStreamSessionsRequest</code>.
     * @alias module:model/ListStreamSessionsRequest
     * @param channelArn {String} Channel ARN used to filter the list.
     */
    constructor(channelArn) { 
        
        ListStreamSessionsRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>ListStreamSessionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamSessionsRequest} obj Optional instance to populate.
     * @return {module:model/ListStreamSessionsRequest} The populated <code>ListStreamSessionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamSessionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamSessionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamSessionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStreamSessionsRequest.RequiredProperties) {
...
ListStreamSessionsRequest.RequiredProperties = ["channelArn"];

/**
 * Channel ARN used to filter the list.
 * @member {String} channelArn
 */
ListStreamSessionsRequest.prototype['channelArn'] = undefined;

/**
 * Maximum number of streams to return. Default: 100.
 * @member {Number} maxResults
 */
ListStreamSessionsRequest.prototype['maxResults'] = undefined;

/**
 * The first stream to retrieve. This is used for pagination; see the <code>nextToken</code> response field.
 * @member {String} nextToken
 */
ListStreamSessionsRequest.prototype['nextToken'] = undefined;
...
export default ListStreamSessionsRequest;
