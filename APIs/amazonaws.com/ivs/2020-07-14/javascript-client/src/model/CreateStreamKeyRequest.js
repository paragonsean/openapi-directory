...
/**
 * The CreateStreamKeyRequest model module.
 * @module model/CreateStreamKeyRequest
 * @version 2020-07-14
 */
class CreateStreamKeyRequest {
    /**
     * Constructs a new <code>CreateStreamKeyRequest</code>.
     * @alias module:model/CreateStreamKeyRequest
     * @param channelArn {String} ARN of the channel for which to create the stream key.
     */
    constructor(channelArn) { 
        
        CreateStreamKeyRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>CreateStreamKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamKeyRequest} obj Optional instance to populate.
     * @return {module:model/CreateStreamKeyRequest} The populated <code>CreateStreamKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateStreamKeyRequest.RequiredProperties) {
...
CreateStreamKeyRequest.RequiredProperties = ["channelArn"];

/**
 * ARN of the channel for which to create the stream key.
 * @member {String} channelArn
 */
CreateStreamKeyRequest.prototype['channelArn'] = undefined;
 ...
 */
CreateStreamKeyRequest.prototype['tags'] = undefined;
...
export default CreateStreamKeyRequest;
