...
/**
 * The DeleteRecordingConfigurationRequest model module.
 * @module model/DeleteRecordingConfigurationRequest
 * @version 2020-07-14
 */
class DeleteRecordingConfigurationRequest {
    /**
     * Constructs a new <code>DeleteRecordingConfigurationRequest</code>.
     * @alias module:model/DeleteRecordingConfigurationRequest
     * @param arn {String} ARN of the recording configuration to be deleted.
     */
    constructor(arn) { 
        
        DeleteRecordingConfigurationRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeleteRecordingConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRecordingConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DeleteRecordingConfigurationRequest} The populated <code>DeleteRecordingConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRecordingConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRecordingConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRecordingConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteRecordingConfigurationRequest.RequiredProperties) {
...
DeleteRecordingConfigurationRequest.RequiredProperties = ["arn"];

/**
 * ARN of the recording configuration to be deleted.
 * @member {String} arn
 */
DeleteRecordingConfigurationRequest.prototype['arn'] = undefined;
...
export default DeleteRecordingConfigurationRequest;
