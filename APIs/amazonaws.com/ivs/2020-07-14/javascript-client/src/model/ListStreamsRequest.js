...
import ListStreamsRequestFilterBy from './ListStreamsRequestFilterBy';
...
class ListStreamsRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('filterBy')) {
                obj['filterBy'] = ListStreamsRequestFilterBy.constructFromObject(data['filterBy']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['filterBy']) { // data not null
          ListStreamsRequestFilterBy.validateJSON(data['filterBy']);
        }
...
/**
 * @member {module:model/ListStreamsRequestFilterBy} filterBy
 */
ListStreamsRequest.prototype['filterBy'] = undefined;
