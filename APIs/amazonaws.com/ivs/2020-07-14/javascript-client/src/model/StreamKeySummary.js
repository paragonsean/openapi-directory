...
/**
 * The StreamKeySummary model module.
 * @module model/StreamKeySummary
 * @version 2020-07-14
 */
class StreamKeySummary {
    /**
     * Constructs a new <code>StreamKeySummary</code>.
     * Summary information about a stream key.
     * @alias module:model/StreamKeySummary
     */
    constructor() { 
        
        StreamKeySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamKeySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamKeySummary} obj Optional instance to populate.
     * @return {module:model/StreamKeySummary} The populated <code>StreamKeySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamKeySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamKeySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamKeySummary</code>.
     */
 ...
 * @member {String} arn
 */
StreamKeySummary.prototype['arn'] = undefined;

/**
 * @member {String} channelArn
 */
StreamKeySummary.prototype['channelArn'] = undefined;

/**
 * @member {Object} tags
 */
StreamKeySummary.prototype['tags'] = undefined;
...
export default StreamKeySummary;
