...
import StreamSessionChannel from './StreamSessionChannel';
import StreamSessionIngestConfiguration from './StreamSessionIngestConfiguration';
import StreamSessionRecordingConfiguration from './StreamSessionRecordingConfiguration';

/**
 * The StreamSession model module.
 * @module model/StreamSession
 * @version 2020-07-14
 */
class StreamSession {
    /**
     * Constructs a new <code>StreamSession</code>.
     ...
     * @alias module:model/StreamSession
     */
    constructor() { 
        
        StreamSession.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSession} obj Optional instance to populate.
     * @return {module:model/StreamSession} The populated <code>StreamSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSession();

            if (data.hasOwnProperty('channel')) {
                obj['channel'] = StreamSessionChannel.constructFromObject(data['channel']);
            }
            if (data.hasOwnProperty('endTime')) {
                obj['endTime'] = ApiClient.convertToType(data['endTime'], 'Date');
            }
            if (data.hasOwnProperty('ingestConfiguration')) {
                obj['ingestConfiguration'] = StreamSessionIngestConfiguration.constructFromObject(data['ingestConfiguration']);
            }
            if (data.hasOwnProperty('recordingConfiguration')) {
                obj['recordingConfiguration'] = StreamSessionRecordingConfiguration.constructFromObject(data['recordingConfiguration']);
            }
            ...
            if (data.hasOwnProperty('truncatedEvents')) {
                obj['truncatedEvents'] = ApiClient.convertToType(data['truncatedEvents'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSession</code>.
     */
    static validateJSON(data) {
        // validate the optional field `channel`
        if (data['channel']) { // data not null
          StreamSessionChannel.validateJSON(data['channel']);
        }
        ...
        if (data['ingestConfiguration']) { // data not null
          StreamSessionIngestConfiguration.validateJSON(data['ingestConfiguration']);
        }
        // validate the optional field `recordingConfiguration`
        if (data['recordingConfiguration']) { // data not null
          StreamSessionRecordingConfiguration.validateJSON(data['recordingConfiguration']);
        }
        ...
        if (data['truncatedEvents']) { // data not null
          Array.validateJSON(data['truncatedEvents']);
        }
...
/**
 * @member {module:model/StreamSessionChannel} channel
 */
StreamSession.prototype['channel'] = undefined;

/**
 * @member {Date} endTime
 */
StreamSession.prototype['endTime'] = undefined;

/**
 * @member {module:model/StreamSessionIngestConfiguration} ingestConfiguration
 */
StreamSession.prototype['ingestConfiguration'] = undefined;

/**
 * @member {module:model/StreamSessionRecordingConfiguration} recordingConfiguration
 */
StreamSession.prototype['recordingConfiguration'] = undefined;

/**
 * @member {Date} startTime
 */
StreamSession.prototype['startTime'] = undefined;

/**
 * @member {String} streamId
 */
StreamSession.prototype['streamId'] = undefined;

/**
 * @member {Array} truncatedEvents
 */
StreamSession.prototype['truncatedEvents'] = undefined;
