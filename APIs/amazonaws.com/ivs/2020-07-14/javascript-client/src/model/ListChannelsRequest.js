...
class ListChannelsRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('filterByName')) {
                obj['filterByName'] = ApiClient.convertToType(data['filterByName'], 'String');
            }
            if (data.hasOwnProperty('filterByRecordingConfigurationArn')) {
                obj['filterByRecordingConfigurationArn'] = ApiClient.convertToType(data['filterByRecordingConfigurationArn'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['filterByName'] && !(typeof data['filterByName'] === 'string' || data['filterByName'] instanceof String)) {
            throw new Error("Expected the field `filterByName` to be a primitive type in the JSON string but got " + data['filterByName']);
        }
        // ensure the json data is a string
        if (data['filterByRecordingConfigurationArn'] && !(typeof data['filterByRecordingConfigurationArn'] === 'string' || data['filterByRecordingConfigurationArn'] instanceof String)) {
            throw new Error("Expected the field `filterByRecordingConfigurationArn` to be a primitive type in the JSON string but got " + data['filterByRecordingConfigurationArn']);
        }
        // ensure the json data is a string
 ...
 * @member {String} filterByName
 */
ListChannelsRequest.prototype['filterByName'] = undefined;

/**
 * Filters the channel list to match the specified recording-configuration ARN.
 * @member {String} filterByRecordingConfigurationArn
 */
ListChannelsRequest.prototype['filterByRecordingConfigurationArn'] = undefined;
