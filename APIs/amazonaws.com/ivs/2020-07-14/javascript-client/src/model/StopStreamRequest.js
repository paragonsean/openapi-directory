...
/**
 * The StopStreamRequest model module.
 * @module model/StopStreamRequest
 * @version 2020-07-14
 */
class StopStreamRequest {
    /**
     * Constructs a new <code>StopStreamRequest</code>.
     * @alias module:model/StopStreamRequest
     * @param channelArn {String} ARN of the channel for which the stream is to be stopped.
     */
    constructor(channelArn) { 
        
        StopStreamRequest.initialize(this, channelArn);
    }
    ...
    /**
     * Constructs a <code>StopStreamRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopStreamRequest} obj Optional instance to populate.
     * @return {module:model/StopStreamRequest} The populated <code>StopStreamRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopStreamRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopStreamRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopStreamRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopStreamRequest.RequiredProperties) {
...
StopStreamRequest.RequiredProperties = ["channelArn"];

/**
 * ARN of the channel for which the stream is to be stopped.
 * @member {String} channelArn
 */
StopStreamRequest.prototype['channelArn'] = undefined;
...
export default StopStreamRequest;
