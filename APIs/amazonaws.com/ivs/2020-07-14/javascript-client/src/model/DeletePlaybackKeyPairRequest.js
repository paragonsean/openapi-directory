...
/**
 * The DeletePlaybackKeyPairRequest model module.
 * @module model/DeletePlaybackKeyPairRequest
 * @version 2020-07-14
 */
class DeletePlaybackKeyPairRequest {
    /**
     * Constructs a new <code>DeletePlaybackKeyPairRequest</code>.
     * @alias module:model/DeletePlaybackKeyPairRequest
     * @param arn {String} ARN of the key pair to be deleted.
     */
    constructor(arn) { 
        
        DeletePlaybackKeyPairRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeletePlaybackKeyPairRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePlaybackKeyPairRequest} obj Optional instance to populate.
     * @return {module:model/DeletePlaybackKeyPairRequest} The populated <code>DeletePlaybackKeyPairRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePlaybackKeyPairRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePlaybackKeyPairRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePlaybackKeyPairRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePlaybackKeyPairRequest.RequiredProperties) {
...
DeletePlaybackKeyPairRequest.RequiredProperties = ["arn"];

/**
 * ARN of the key pair to be deleted.
 * @member {String} arn
 */
DeletePlaybackKeyPairRequest.prototype['arn'] = undefined;
...
export default DeletePlaybackKeyPairRequest;
