...
/**
 * The GetRecordingConfigurationResponse model module.
 * @module model/GetRecordingConfigurationResponse
 * @version 2020-07-14
 */
class GetRecordingConfigurationResponse {
    /**
     * Constructs a new <code>GetRecordingConfigurationResponse</code>.
     * @alias module:model/GetRecordingConfigurationResponse
     */
    constructor() { 
        
        GetRecordingConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRecordingConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRecordingConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/GetRecordingConfigurationResponse} The populated <code>GetRecordingConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRecordingConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRecordingConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRecordingConfigurationResponse</code>.
     */
 ...
 */
GetRecordingConfigurationResponse.prototype['recordingConfiguration'] = undefined;
...
export default GetRecordingConfigurationResponse;
