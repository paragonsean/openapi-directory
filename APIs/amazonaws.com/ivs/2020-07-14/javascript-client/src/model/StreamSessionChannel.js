...
/**
 * The StreamSessionChannel model module.
 * @module model/StreamSessionChannel
 * @version 2020-07-14
 */
class StreamSessionChannel {
    /**
     * Constructs a new <code>StreamSessionChannel</code>.
     * @alias module:model/StreamSessionChannel
     * @implements module:model/Channel
     */
    constructor() { 
        Channel.initialize(this);
        StreamSessionChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamSessionChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSessionChannel} obj Optional instance to populate.
     * @return {module:model/StreamSessionChannel} The populated <code>StreamSessionChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSessionChannel();
            ...
            if (data.hasOwnProperty('ingestEndpoint')) {
                obj['ingestEndpoint'] = ApiClient.convertToType(data['ingestEndpoint'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSessionChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSessionChannel</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ingestEndpoint']) { // data not null
          String.validateJSON(data['ingestEndpoint']);
        }
 ...
 * @member {String} arn
 */
StreamSessionChannel.prototype['arn'] = undefined;

/**
 * @member {Boolean} authorized
 */
StreamSessionChannel.prototype['authorized'] = undefined;

/**
 * @member {String} ingestEndpoint
 */
StreamSessionChannel.prototype['ingestEndpoint'] = undefined;

/**
 * @member {Boolean} insecureIngest
 */
StreamSessionChannel.prototype['insecureIngest'] = undefined;

/**
 * @member {module:model/ChannelLatencyMode} latencyMode
 */
StreamSessionChannel.prototype['latencyMode'] = undefined;

/**
 * @member {String} name
 */
StreamSessionChannel.prototype['name'] = undefined;

/**
 * @member {String} playbackUrl
 */
StreamSessionChannel.prototype['playbackUrl'] = undefined;

/**
 * @member {module:model/TranscodePreset} preset
 */
StreamSessionChannel.prototype['preset'] = undefined;

/**
 * @member {String} recordingConfigurationArn
 */
StreamSessionChannel.prototype['recordingConfigurationArn'] = undefined;

/**
 * @member {Object} tags
 */
StreamSessionChannel.prototype['tags'] = undefined;

/**
 * @member {module:model/ChannelType} type
 */
StreamSessionChannel.prototype['type'] = undefined;
 ...
 * @member {Boolean} authorized
 */
Channel.prototype['authorized'] = undefined;
/**
 * @member {String} ingestEndpoint
 */
Channel.prototype['ingestEndpoint'] = undefined;
/**
 * @member {Boolean} insecureIngest
 */
Channel.prototype['insecureIngest'] = undefined;
/**
 * @member {module:model/ChannelLatencyMode} latencyMode
 */
Channel.prototype['latencyMode'] = undefined;
/**
 * @member {String} name
 */
 ...
 * @member {String} playbackUrl
 */
Channel.prototype['playbackUrl'] = undefined;
/**
 * @member {module:model/TranscodePreset} preset
 */
Channel.prototype['preset'] = undefined;
/**
 * @member {String} recordingConfigurationArn
 */
Channel.prototype['recordingConfigurationArn'] = undefined;
/**
 * @member {Object} tags
 */
...
export default StreamSessionChannel;
