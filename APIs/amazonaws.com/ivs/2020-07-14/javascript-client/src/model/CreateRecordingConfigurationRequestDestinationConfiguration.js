...
import CreateRecordingConfigurationRequestDestinationConfigurationS3 from './CreateRecordingConfigurationRequestDestinationConfigurationS3';
import DestinationConfiguration from './DestinationConfiguration';

/**
 * The CreateRecordingConfigurationRequestDestinationConfiguration model module.
 * @module model/CreateRecordingConfigurationRequestDestinationConfiguration
 * @version 2020-07-14
 */
class CreateRecordingConfigurationRequestDestinationConfiguration {
    /**
     * Constructs a new <code>CreateRecordingConfigurationRequestDestinationConfiguration</code>.
     * @alias module:model/CreateRecordingConfigurationRequestDestinationConfiguration
     * @implements module:model/DestinationConfiguration
     */
    constructor() { 
        DestinationConfiguration.initialize(this);
        CreateRecordingConfigurationRequestDestinationConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRecordingConfigurationRequestDestinationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationRequestDestinationConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationRequestDestinationConfiguration} The populated <code>CreateRecordingConfigurationRequestDestinationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationRequestDestinationConfiguration();
            DestinationConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('s3')) {
                obj['s3'] = CreateRecordingConfigurationRequestDestinationConfigurationS3.constructFromObject(data['s3']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationRequestDestinationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationRequestDestinationConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `s3`
        if (data['s3']) { // data not null
          CreateRecordingConfigurationRequestDestinationConfigurationS3.validateJSON(data['s3']);
        }
...
/**
 * @member {module:model/CreateRecordingConfigurationRequestDestinationConfigurationS3} s3
 */
CreateRecordingConfigurationRequestDestinationConfiguration.prototype['s3'] = undefined;
...
export default CreateRecordingConfigurationRequestDestinationConfiguration;
