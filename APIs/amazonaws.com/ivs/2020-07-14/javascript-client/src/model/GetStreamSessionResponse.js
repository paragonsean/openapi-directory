...
import GetStreamSessionResponseStreamSession from './GetStreamSessionResponseStreamSession';

/**
 * The GetStreamSessionResponse model module.
 * @module model/GetStreamSessionResponse
 * @version 2020-07-14
 */
class GetStreamSessionResponse {
    /**
     * Constructs a new <code>GetStreamSessionResponse</code>.
     * @alias module:model/GetStreamSessionResponse
     */
    constructor() { 
        
        GetStreamSessionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamSessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamSessionResponse} obj Optional instance to populate.
     * @return {module:model/GetStreamSessionResponse} The populated <code>GetStreamSessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamSessionResponse();

            if (data.hasOwnProperty('streamSession')) {
                obj['streamSession'] = GetStreamSessionResponseStreamSession.constructFromObject(data['streamSession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamSessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamSessionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `streamSession`
        if (data['streamSession']) { // data not null
          GetStreamSessionResponseStreamSession.validateJSON(data['streamSession']);
        }
...
/**
 * @member {module:model/GetStreamSessionResponseStreamSession} streamSession
 */
GetStreamSessionResponse.prototype['streamSession'] = undefined;
...
export default GetStreamSessionResponse;
