...
/**
 * The CreateChannelResponseStreamKey model module.
 * @module model/CreateChannelResponseStreamKey
 * @version 2020-07-14
 */
class CreateChannelResponseStreamKey {
    /**
     * Constructs a new <code>CreateChannelResponseStreamKey</code>.
     * @alias module:model/CreateChannelResponseStreamKey
     * @implements module:model/StreamKey
     */
    constructor() { 
        StreamKey.initialize(this);
        CreateChannelResponseStreamKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateChannelResponseStreamKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateChannelResponseStreamKey} obj Optional instance to populate.
     * @return {module:model/CreateChannelResponseStreamKey} The populated <code>CreateChannelResponseStreamKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateChannelResponseStreamKey();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateChannelResponseStreamKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateChannelResponseStreamKey</code>.
     */
 ...
 * @member {String} arn
 */
CreateChannelResponseStreamKey.prototype['arn'] = undefined;

/**
 * @member {String} channelArn
 */
CreateChannelResponseStreamKey.prototype['channelArn'] = undefined;

/**
 * @member {Object} tags
 */
CreateChannelResponseStreamKey.prototype['tags'] = undefined;

/**
 * @member {String} value
 */
CreateChannelResponseStreamKey.prototype['value'] = undefined;
...
export default CreateChannelResponseStreamKey;
