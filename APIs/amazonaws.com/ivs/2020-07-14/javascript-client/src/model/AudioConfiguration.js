...
class AudioConfiguration {
    ...
    constructor() { 
        ...
        AudioConfiguration.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AudioConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>AudioConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AudioConfiguration</code>.
     */
    static validateJSON(data) {
        ...
        if (data['targetBitrate']) { // data not null
          Number.validateJSON(data['targetBitrate']);
        }
 ...
 */
AudioConfiguration.prototype['channels'] = undefined;

/**
 * @member {String} codec
 */
AudioConfiguration.prototype['codec'] = undefined;

/**
 * @member {Number} sampleRate
 */
AudioConfiguration.prototype['sampleRate'] = undefined;

/**
 * @member {Number} targetBitrate
 */
AudioConfiguration.prototype['targetBitrate'] = undefined;
