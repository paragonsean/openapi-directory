...
/**
 * The ImportPlaybackKeyPairRequest model module.
 * @module model/ImportPlaybackKeyPairRequest
 * @version 2020-07-14
 */
class ImportPlaybackKeyPairRequest {
    /**
     * Constructs a new <code>ImportPlaybackKeyPairRequest</code>.
     * @alias module:model/ImportPlaybackKeyPairRequest
     * @param publicKeyMaterial {String} The public portion of a customer-generated key pair.
     */
    constructor(publicKeyMaterial) { 
        
        ImportPlaybackKeyPairRequest.initialize(this, publicKeyMaterial);
    }
     ...
     */
    static initialize(obj, publicKeyMaterial) { 
        obj['publicKeyMaterial'] = publicKeyMaterial;
    }

    /**
     * Constructs a <code>ImportPlaybackKeyPairRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportPlaybackKeyPairRequest} obj Optional instance to populate.
     * @return {module:model/ImportPlaybackKeyPairRequest} The populated <code>ImportPlaybackKeyPairRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportPlaybackKeyPairRequest();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('publicKeyMaterial')) {
                obj['publicKeyMaterial'] = ApiClient.convertToType(data['publicKeyMaterial'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportPlaybackKeyPairRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportPlaybackKeyPairRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportPlaybackKeyPairRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['publicKeyMaterial'] && !(typeof data['publicKeyMaterial'] === 'string' || data['publicKeyMaterial'] instanceof String)) {
            throw new Error("Expected the field `publicKeyMaterial` to be a primitive type in the JSON string but got " + data['publicKeyMaterial']);
        }
...
ImportPlaybackKeyPairRequest.RequiredProperties = ["publicKeyMaterial"];

/**
 * Playback-key-pair name. The value does not need to be unique.
 * @member {String} name
 */
ImportPlaybackKeyPairRequest.prototype['name'] = undefined;

/**
 * The public portion of a customer-generated key pair.
 * @member {String} publicKeyMaterial
 */
ImportPlaybackKeyPairRequest.prototype['publicKeyMaterial'] = undefined;
 ...
 */
ImportPlaybackKeyPairRequest.prototype['tags'] = undefined;
...
export default ImportPlaybackKeyPairRequest;
