...
/**
 * The ListStreamKeysResponse model module.
 * @module model/ListStreamKeysResponse
 * @version 2020-07-14
 */
class ListStreamKeysResponse {
    /**
     * Constructs a new <code>ListStreamKeysResponse</code>.
     * @alias module:model/ListStreamKeysResponse
     * @param streamKeys {Array} 
     */
    constructor(streamKeys) { 
        
        ListStreamKeysResponse.initialize(this, streamKeys);
    }
     ...
     */
    static initialize(obj, streamKeys) { 
        obj['streamKeys'] = streamKeys;
    }

    /**
     * Constructs a <code>ListStreamKeysResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamKeysResponse} obj Optional instance to populate.
     * @return {module:model/ListStreamKeysResponse} The populated <code>ListStreamKeysResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamKeysResponse();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('streamKeys')) {
                obj['streamKeys'] = ApiClient.convertToType(data['streamKeys'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamKeysResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamKeysResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStreamKeysResponse.RequiredProperties) {
        ...
        if (data['streamKeys']) { // data not null
          Array.validateJSON(data['streamKeys']);
        }
...
ListStreamKeysResponse.RequiredProperties = ["streamKeys"];

/**
 * @member {String} nextToken
 */
ListStreamKeysResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} streamKeys
 */
ListStreamKeysResponse.prototype['streamKeys'] = undefined;
...
export default ListStreamKeysResponse;
