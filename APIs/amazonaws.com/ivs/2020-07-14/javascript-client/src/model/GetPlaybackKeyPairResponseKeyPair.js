...
/**
 * The GetPlaybackKeyPairResponseKeyPair model module.
 * @module model/GetPlaybackKeyPairResponseKeyPair
 * @version 2020-07-14
 */
class GetPlaybackKeyPairResponseKeyPair {
    /**
     * Constructs a new <code>GetPlaybackKeyPairResponseKeyPair</code>.
     * @alias module:model/GetPlaybackKeyPairResponseKeyPair
     * @implements module:model/PlaybackKeyPair
     */
    constructor() { 
        PlaybackKeyPair.initialize(this);
        GetPlaybackKeyPairResponseKeyPair.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPlaybackKeyPairResponseKeyPair</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPlaybackKeyPairResponseKeyPair} obj Optional instance to populate.
     * @return {module:model/GetPlaybackKeyPairResponseKeyPair} The populated <code>GetPlaybackKeyPairResponseKeyPair</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPlaybackKeyPairResponseKeyPair();
            PlaybackKeyPair.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetPlaybackKeyPairResponseKeyPair</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPlaybackKeyPairResponseKeyPair</code>.
     */
 ...
 * @member {String} arn
 */
GetPlaybackKeyPairResponseKeyPair.prototype['arn'] = undefined;

/**
 * @member {String} fingerprint
 */
GetPlaybackKeyPairResponseKeyPair.prototype['fingerprint'] = undefined;

/**
 * @member {String} name
 */
GetPlaybackKeyPairResponseKeyPair.prototype['name'] = undefined;

/**
 * @member {Object} tags
 */
GetPlaybackKeyPairResponseKeyPair.prototype['tags'] = undefined;


// Implement PlaybackKeyPair interface:
/**
 * @member {String} arn
 */
PlaybackKeyPair.prototype['arn'] = undefined;
/**
 * @member {String} fingerprint
 */
PlaybackKeyPair.prototype['fingerprint'] = undefined;
/**
 * @member {String} name
 */
PlaybackKeyPair.prototype['name'] = undefined;
/**
 * @member {Object} tags
 */
PlaybackKeyPair.prototype['tags'] = undefined;




export default GetPlaybackKeyPairResponseKeyPair;
