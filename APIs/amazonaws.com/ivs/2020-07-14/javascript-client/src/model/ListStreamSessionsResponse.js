...
/**
 * The ListStreamSessionsResponse model module.
 * @module model/ListStreamSessionsResponse
 * @version 2020-07-14
 */
class ListStreamSessionsResponse {
    /**
     * Constructs a new <code>ListStreamSessionsResponse</code>.
     * @alias module:model/ListStreamSessionsResponse
     * @param streamSessions {Array} 
     */
    constructor(streamSessions) { 
        
        ListStreamSessionsResponse.initialize(this, streamSessions);
    }
     ...
     */
    static initialize(obj, streamSessions) { 
        obj['streamSessions'] = streamSessions;
    }

    /**
     * Constructs a <code>ListStreamSessionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListStreamSessionsResponse} obj Optional instance to populate.
     * @return {module:model/ListStreamSessionsResponse} The populated <code>ListStreamSessionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListStreamSessionsResponse();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('streamSessions')) {
                obj['streamSessions'] = ApiClient.convertToType(data['streamSessions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListStreamSessionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListStreamSessionsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListStreamSessionsResponse.RequiredProperties) {
        ...
        // validate the optional field `streamSessions`
        if (data['streamSessions']) { // data not null
          Array.validateJSON(data['streamSessions']);
        }
...
ListStreamSessionsResponse.RequiredProperties = ["streamSessions"];

/**
 * @member {String} nextToken
 */
ListStreamSessionsResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} streamSessions
 */
ListStreamSessionsResponse.prototype['streamSessions'] = undefined;
...
export default ListStreamSessionsResponse;
