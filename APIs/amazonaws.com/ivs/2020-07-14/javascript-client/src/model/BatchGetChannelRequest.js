...
/**
 * The BatchGetChannelRequest model module.
 * @module model/BatchGetChannelRequest
 * @version 2020-07-14
 */
class BatchGetChannelRequest {
    /**
     * Constructs a new <code>BatchGetChannelRequest</code>.
     * @alias module:model/BatchGetChannelRequest
     * @param arns {Array.<String>} Array of ARNs, one per channel.
     */
    constructor(arns) { 
        
        BatchGetChannelRequest.initialize(this, arns);
    }
    ...
    /**
     * Constructs a <code>BatchGetChannelRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetChannelRequest} obj Optional instance to populate.
     * @return {module:model/BatchGetChannelRequest} The populated <code>BatchGetChannelRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetChannelRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetChannelRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetChannelRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchGetChannelRequest.RequiredProperties) {
...
BatchGetChannelRequest.RequiredProperties = ["arns"];

/**
 * Array of ARNs, one per channel.
 * @member {Array.<String>} arns
 */
BatchGetChannelRequest.prototype['arns'] = undefined;
...
export default BatchGetChannelRequest;
