...
/**
 * The DeleteStreamKeyRequest model module.
 * @module model/DeleteStreamKeyRequest
 * @version 2020-07-14
 */
class DeleteStreamKeyRequest {
    /**
     * Constructs a new <code>DeleteStreamKeyRequest</code>.
     * @alias module:model/DeleteStreamKeyRequest
     * @param arn {String} ARN of the stream key to be deleted.
     */
    constructor(arn) { 
        
        DeleteStreamKeyRequest.initialize(this, arn);
    }
    ...
    /**
     * Constructs a <code>DeleteStreamKeyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteStreamKeyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteStreamKeyRequest} The populated <code>DeleteStreamKeyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteStreamKeyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteStreamKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteStreamKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteStreamKeyRequest.RequiredProperties) {
...
DeleteStreamKeyRequest.RequiredProperties = ["arn"];

/**
 * ARN of the stream key to be deleted.
 * @member {String} arn
 */
DeleteStreamKeyRequest.prototype['arn'] = undefined;
...
export default DeleteStreamKeyRequest;
