...
/**
 * The CreateStreamKeyResponseStreamKey model module.
 * @module model/CreateStreamKeyResponseStreamKey
 * @version 2020-07-14
 */
class CreateStreamKeyResponseStreamKey {
    /**
     * Constructs a new <code>CreateStreamKeyResponseStreamKey</code>.
     * @alias module:model/CreateStreamKeyResponseStreamKey
     * @implements module:model/StreamKey
     */
    constructor() { 
        StreamKey.initialize(this);
        CreateStreamKeyResponseStreamKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamKeyResponseStreamKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamKeyResponseStreamKey} obj Optional instance to populate.
     * @return {module:model/CreateStreamKeyResponseStreamKey} The populated <code>CreateStreamKeyResponseStreamKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamKeyResponseStreamKey();
            StreamKey.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamKeyResponseStreamKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamKeyResponseStreamKey</code>.
     */
 ...
 * @member {String} arn
 */
CreateStreamKeyResponseStreamKey.prototype['arn'] = undefined;

/**
 * @member {String} channelArn
 */
CreateStreamKeyResponseStreamKey.prototype['channelArn'] = undefined;

/**
 * @member {Object} tags
 */
CreateStreamKeyResponseStreamKey.prototype['tags'] = undefined;

/**
 * @member {String} value
 */
CreateStreamKeyResponseStreamKey.prototype['value'] = undefined;


// Implement StreamKey interface:
/**
 * @member {String} arn
 */
StreamKey.prototype['arn'] = undefined;
/**
 * @member {String} channelArn
 */
StreamKey.prototype['channelArn'] = undefined;
/**
 * @member {Object} tags
 */
StreamKey.prototype['tags'] = undefined;
/**
 * @member {String} value
 */
StreamKey.prototype['value'] = undefined;




export default CreateStreamKeyResponseStreamKey;
