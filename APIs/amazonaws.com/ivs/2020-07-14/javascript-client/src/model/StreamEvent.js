...
/**
 * The StreamEvent model module.
 * @module model/StreamEvent
 * @version 2020-07-14
 */
class StreamEvent {
    /**
     * Constructs a new <code>StreamEvent</code>.
     ...
     * @alias module:model/StreamEvent
     */
    constructor() { 
        
        StreamEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StreamEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamEvent} obj Optional instance to populate.
     * @return {module:model/StreamEvent} The populated <code>StreamEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamEvent</code>.
     */
 ...
 */
StreamEvent.prototype['eventTime'] = undefined;

/**
 * @member {String} name
 */
StreamEvent.prototype['name'] = undefined;

/**
 * @member {String} type
 */
StreamEvent.prototype['type'] = undefined;
