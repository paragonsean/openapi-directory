...
/**
 * The IngestConfigurationVideo model module.
 * @module model/IngestConfigurationVideo
 * @version 2020-07-14
 */
class IngestConfigurationVideo {
    /**
     * Constructs a new <code>IngestConfigurationVideo</code>.
     * @alias module:model/IngestConfigurationVideo
     * @implements module:model/VideoConfiguration
     */
    constructor() { 
        VideoConfiguration.initialize(this);
        IngestConfigurationVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IngestConfigurationVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IngestConfigurationVideo} obj Optional instance to populate.
     * @return {module:model/IngestConfigurationVideo} The populated <code>IngestConfigurationVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IngestConfigurationVideo();
            VideoConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>IngestConfigurationVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IngestConfigurationVideo</code>.
     */
 ...
 */
IngestConfigurationVideo.prototype['avcLevel'] = undefined;

/**
 * @member {String} avcProfile
 */
IngestConfigurationVideo.prototype['avcProfile'] = undefined;

/**
 * @member {String} codec
 */
IngestConfigurationVideo.prototype['codec'] = undefined;

/**
 * @member {String} encoder
 */
IngestConfigurationVideo.prototype['encoder'] = undefined;

/**
 * @member {Number} targetBitrate
 */
IngestConfigurationVideo.prototype['targetBitrate'] = undefined;

/**
 * @member {Number} targetFramerate
 */
IngestConfigurationVideo.prototype['targetFramerate'] = undefined;

/**
 * @member {Number} videoHeight
 */
IngestConfigurationVideo.prototype['videoHeight'] = undefined;

/**
 * @member {Number} videoWidth
 */
IngestConfigurationVideo.prototype['videoWidth'] = undefined;


// Implement VideoConfiguration interface:
/**
 * @member {String} avcLevel
 */
...
export default IngestConfigurationVideo;
