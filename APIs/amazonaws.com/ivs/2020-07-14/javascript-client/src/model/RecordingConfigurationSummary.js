...
/**
 * The RecordingConfigurationSummary model module.
 * @module model/RecordingConfigurationSummary
 * @version 2020-07-14
 */
class RecordingConfigurationSummary {
    /**
     * Constructs a new <code>RecordingConfigurationSummary</code>.
     * Summary information about a RecordingConfiguration.
     * @alias module:model/RecordingConfigurationSummary
     * @param arn {String} 
    ...
    constructor(arn, destinationConfiguration, state) { 
        ...
        RecordingConfigurationSummary.initialize(this, arn, destinationConfiguration, state);
    }
    ...
    /**
     * Constructs a <code>RecordingConfigurationSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecordingConfigurationSummary} obj Optional instance to populate.
     * @return {module:model/RecordingConfigurationSummary} The populated <code>RecordingConfigurationSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecordingConfigurationSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>RecordingConfigurationSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecordingConfigurationSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecordingConfigurationSummary.RequiredProperties) {
...
RecordingConfigurationSummary.RequiredProperties = ["arn", "destinationConfiguration", "state"];

/**
 * @member {String} arn
 */
RecordingConfigurationSummary.prototype['arn'] = undefined;

/**
 * @member {module:model/RecordingConfigurationDestinationConfiguration} destinationConfiguration
 */
RecordingConfigurationSummary.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} name
 */
RecordingConfigurationSummary.prototype['name'] = undefined;

/**
 * @member {module:model/RecordingConfigurationState} state
 */
RecordingConfigurationSummary.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
RecordingConfigurationSummary.prototype['tags'] = undefined;
...
export default RecordingConfigurationSummary;
