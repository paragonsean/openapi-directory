...
/**
 * The PutMetadataRequest model module.
 * @module model/PutMetadataRequest
 * @version 2020-07-14
 */
class PutMetadataRequest {
    /**
     * Constructs a new <code>PutMetadataRequest</code>.
     * @alias module:model/PutMetadataRequest
     * @param channelArn {String} ARN of the channel into which metadata is inserted. This channel must have an active stream.
     * @param metadata {String} Metadata to insert into the stream. Maximum: 1 KB per request.
     */
    constructor(channelArn, metadata) { 
        
        PutMetadataRequest.initialize(this, channelArn, metadata);
    }
     ...
     */
    static initialize(obj, channelArn, metadata) { 
        obj['channelArn'] = channelArn;
        obj['metadata'] = metadata;
    }

    /**
     * Constructs a <code>PutMetadataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutMetadataRequest} obj Optional instance to populate.
     * @return {module:model/PutMetadataRequest} The populated <code>PutMetadataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutMetadataRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutMetadataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutMetadataRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutMetadataRequest.RequiredProperties) {
...
PutMetadataRequest.RequiredProperties = ["channelArn", "metadata"];

/**
 * ARN of the channel into which metadata is inserted. This channel must have an active stream.
 * @member {String} channelArn
 */
PutMetadataRequest.prototype['channelArn'] = undefined;

/**
 * Metadata to insert into the stream. Maximum: 1 KB per request.
 * @member {String} metadata
 */
PutMetadataRequest.prototype['metadata'] = undefined;
...
export default PutMetadataRequest;
