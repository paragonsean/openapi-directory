...
/**
 * The BatchGetChannelResponse model module.
 * @module model/BatchGetChannelResponse
 * @version 2020-07-14
 */
class BatchGetChannelResponse {
    /**
     * Constructs a new <code>BatchGetChannelResponse</code>.
     * @alias module:model/BatchGetChannelResponse
     */
    constructor() { 
        
        BatchGetChannelResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchGetChannelResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchGetChannelResponse} obj Optional instance to populate.
     * @return {module:model/BatchGetChannelResponse} The populated <code>BatchGetChannelResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchGetChannelResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchGetChannelResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchGetChannelResponse</code>.
     */
 ...
 */
BatchGetChannelResponse.prototype['channels'] = undefined;

/**
 * @member {Array} errors
 */
BatchGetChannelResponse.prototype['errors'] = undefined;
...
export default BatchGetChannelResponse;
