...
import GetStreamKeyResponseStreamKey from './GetStreamKeyResponseStreamKey';

/**
 * The GetStreamKeyResponse model module.
 * @module model/GetStreamKeyResponse
 * @version 2020-07-14
 */
class GetStreamKeyResponse {
    /**
     * Constructs a new <code>GetStreamKeyResponse</code>.
     * @alias module:model/GetStreamKeyResponse
     */
    constructor() { 
        
        GetStreamKeyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetStreamKeyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStreamKeyResponse} obj Optional instance to populate.
     * @return {module:model/GetStreamKeyResponse} The populated <code>GetStreamKeyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStreamKeyResponse();

            if (data.hasOwnProperty('streamKey')) {
                obj['streamKey'] = GetStreamKeyResponseStreamKey.constructFromObject(data['streamKey']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetStreamKeyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStreamKeyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `streamKey`
        if (data['streamKey']) { // data not null
          GetStreamKeyResponseStreamKey.validateJSON(data['streamKey']);
        }
...
/**
 * @member {module:model/GetStreamKeyResponseStreamKey} streamKey
 */
GetStreamKeyResponse.prototype['streamKey'] = undefined;
...
export default GetStreamKeyResponse;
