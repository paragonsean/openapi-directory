...
import RecordingConfigurationDestinationConfiguration from './RecordingConfigurationDestinationConfiguration';
import RecordingConfigurationState from './RecordingConfigurationState';

/**
 * The StreamSessionRecordingConfiguration model module.
 * @module model/StreamSessionRecordingConfiguration
 * @version 2020-07-14
 */
class StreamSessionRecordingConfiguration {
    /**
     * Constructs a new <code>StreamSessionRecordingConfiguration</code>.
     * @alias module:model/StreamSessionRecordingConfiguration
     * @implements module:model/RecordingConfiguration
     * @param arn {String} 
     * @param destinationConfiguration {module:model/RecordingConfigurationDestinationConfiguration} 
     * @param state {module:model/RecordingConfigurationState} 
     */
    constructor(arn, destinationConfiguration, state) { 
        RecordingConfiguration.initialize(this, arn, destinationConfiguration, state);
        StreamSessionRecordingConfiguration.initialize(this, arn, destinationConfiguration, state);
    }
     ...
     */
    static initialize(obj, arn, destinationConfiguration, state) { 
        obj['arn'] = arn;
    ...
    /**
     * Constructs a <code>StreamSessionRecordingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamSessionRecordingConfiguration} obj Optional instance to populate.
     * @return {module:model/StreamSessionRecordingConfiguration} The populated <code>StreamSessionRecordingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamSessionRecordingConfiguration();
            RecordingConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('arn')) {
                obj['arn'] = ApiClient.convertToType(data['arn'], 'String');
            }
            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = RecordingConfigurationDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ApiClient.convertToType(data['state'], RecordingConfigurationState);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamSessionRecordingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamSessionRecordingConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StreamSessionRecordingConfiguration.RequiredProperties) {
        ...
        if (data['destinationConfiguration']) { // data not null
          RecordingConfigurationDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
        ...
        if (data['recordingReconnectWindowSeconds']) { // data not null
          Number.validateJSON(data['recordingReconnectWindowSeconds']);
        }
        ...
        if (data['state']) { // data not null
          RecordingConfigurationState.validateJSON(data['state']);
        }
...
StreamSessionRecordingConfiguration.RequiredProperties = ["arn", "destinationConfiguration", "state"];

/**
 * @member {String} arn
 */
StreamSessionRecordingConfiguration.prototype['arn'] = undefined;

/**
 * @member {module:model/RecordingConfigurationDestinationConfiguration} destinationConfiguration
 */
StreamSessionRecordingConfiguration.prototype['destinationConfiguration'] = undefined;

/**
 * @member {String} name
 */
StreamSessionRecordingConfiguration.prototype['name'] = undefined;

/**
 * @member {Number} recordingReconnectWindowSeconds
 */
StreamSessionRecordingConfiguration.prototype['recordingReconnectWindowSeconds'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} renditionConfiguration
 */
StreamSessionRecordingConfiguration.prototype['renditionConfiguration'] = undefined;

/**
 * @member {module:model/RecordingConfigurationState} state
 */
StreamSessionRecordingConfiguration.prototype['state'] = undefined;

/**
 * @member {Object} tags
 */
StreamSessionRecordingConfiguration.prototype['tags'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} thumbnailConfiguration
 */
StreamSessionRecordingConfiguration.prototype['thumbnailConfiguration'] = undefined;


// Implement RecordingConfiguration interface:
/**
 * @member {String} arn
 */
RecordingConfiguration.prototype['arn'] = undefined;
/**
 * @member {module:model/RecordingConfigurationDestinationConfiguration} destinationConfiguration
 */
RecordingConfiguration.prototype['destinationConfiguration'] = undefined;
/**
 * @member {String} name
 */
RecordingConfiguration.prototype['name'] = undefined;
/**
 * @member {Number} recordingReconnectWindowSeconds
 */
RecordingConfiguration.prototype['recordingReconnectWindowSeconds'] = undefined;
/**
 * @member {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} renditionConfiguration
 */
RecordingConfiguration.prototype['renditionConfiguration'] = undefined;
/**
 * @member {module:model/RecordingConfigurationState} state
 */
RecordingConfiguration.prototype['state'] = undefined;
/**
 * @member {Object} tags
 */
RecordingConfiguration.prototype['tags'] = undefined;
/**
 * @member {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} thumbnailConfiguration
 */
RecordingConfiguration.prototype['thumbnailConfiguration'] = undefined;




export default StreamSessionRecordingConfiguration;
