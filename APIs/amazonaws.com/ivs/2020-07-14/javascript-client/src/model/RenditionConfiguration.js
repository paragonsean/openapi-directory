...
import RenditionConfigurationRenditionSelection from './RenditionConfigurationRenditionSelection';

/**
 * The RenditionConfiguration model module.
 * @module model/RenditionConfiguration
 * @version 2020-07-14
 */
class RenditionConfiguration {
    /**
     * Constructs a new <code>RenditionConfiguration</code>.
     * Object that describes which renditions should be recorded for a stream.
     * @alias module:model/RenditionConfiguration
     */
    constructor() { 
        
        RenditionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RenditionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RenditionConfiguration} obj Optional instance to populate.
     * @return {module:model/RenditionConfiguration} The populated <code>RenditionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RenditionConfiguration();

            if (data.hasOwnProperty('renditionSelection')) {
                obj['renditionSelection'] = ApiClient.convertToType(data['renditionSelection'], RenditionConfigurationRenditionSelection);
            }
            if (data.hasOwnProperty('renditions')) {
                obj['renditions'] = ApiClient.convertToType(data['renditions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RenditionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RenditionConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `renditionSelection`
        if (data['renditionSelection']) { // data not null
          RenditionConfigurationRenditionSelection.validateJSON(data['renditionSelection']);
        }
        // validate the optional field `renditions`
        if (data['renditions']) { // data not null
          Array.validateJSON(data['renditions']);
        }
...
/**
 * @member {module:model/RenditionConfigurationRenditionSelection} renditionSelection
 */
RenditionConfiguration.prototype['renditionSelection'] = undefined;

/**
 * @member {Array} renditions
 */
RenditionConfiguration.prototype['renditions'] = undefined;
...
export default RenditionConfiguration;
