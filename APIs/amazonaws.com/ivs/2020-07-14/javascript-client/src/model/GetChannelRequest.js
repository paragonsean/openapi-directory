...
class GetChannelRequest {
     ...
     * @param arn {String} ARN of the channel for which the configuration is to be retrieved.
     */
    constructor(arn) { 
        
        GetChannelRequest.initialize(this, arn);
    }
...
GetChannelRequest.RequiredProperties = ["arn"];

/**
 * ARN of the channel for which the configuration is to be retrieved.
 * @member {String} arn
 */
GetChannelRequest.prototype['arn'] = undefined;
