...
/**
 * The BatchStartViewerSessionRevocationViewerSession model module.
 * @module model/BatchStartViewerSessionRevocationViewerSession
 * @version 2020-07-14
 */
class BatchStartViewerSessionRevocationViewerSession {
    /**
     * Constructs a new <code>BatchStartViewerSessionRevocationViewerSession</code>.
     * A viewer session to revoke in the call to &lt;a&gt;BatchStartViewerSessionRevocation&lt;/a&gt;.
     * @alias module:model/BatchStartViewerSessionRevocationViewerSession
     * @param channelArn {String} 
     * @param viewerId {String} 
     */
    constructor(channelArn, viewerId) { 
        
        BatchStartViewerSessionRevocationViewerSession.initialize(this, channelArn, viewerId);
    }
     ...
     */
    static initialize(obj, channelArn, viewerId) { 
        obj['channelArn'] = channelArn;
        obj['viewerId'] = viewerId;
    }

    /**
     * Constructs a <code>BatchStartViewerSessionRevocationViewerSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchStartViewerSessionRevocationViewerSession} obj Optional instance to populate.
     * @return {module:model/BatchStartViewerSessionRevocationViewerSession} The populated <code>BatchStartViewerSessionRevocationViewerSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchStartViewerSessionRevocationViewerSession();
            ...
            if (data.hasOwnProperty('viewerSessionVersionsLessThanOrEqualTo')) {
                obj['viewerSessionVersionsLessThanOrEqualTo'] = ApiClient.convertToType(data['viewerSessionVersionsLessThanOrEqualTo'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchStartViewerSessionRevocationViewerSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchStartViewerSessionRevocationViewerSession</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchStartViewerSessionRevocationViewerSession.RequiredProperties) {
        ...
        // validate the optional field `viewerId`
        if (data['viewerId']) { // data not null
          String.validateJSON(data['viewerId']);
        }
        // validate the optional field `viewerSessionVersionsLessThanOrEqualTo`
        if (data['viewerSessionVersionsLessThanOrEqualTo']) { // data not null
          Number.validateJSON(data['viewerSessionVersionsLessThanOrEqualTo']);
        }
...
BatchStartViewerSessionRevocationViewerSession.RequiredProperties = ["channelArn", "viewerId"];

/**
 * @member {String} channelArn
 */
BatchStartViewerSessionRevocationViewerSession.prototype['channelArn'] = undefined;

/**
 * @member {String} viewerId
 */
BatchStartViewerSessionRevocationViewerSession.prototype['viewerId'] = undefined;

/**
 * @member {Number} viewerSessionVersionsLessThanOrEqualTo
 */
BatchStartViewerSessionRevocationViewerSession.prototype['viewerSessionVersionsLessThanOrEqualTo'] = undefined;
...
export default BatchStartViewerSessionRevocationViewerSession;
