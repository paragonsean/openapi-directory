...
/**
 * The VideoConfiguration model module.
 * @module model/VideoConfiguration
 * @version 2020-07-14
 */
class VideoConfiguration {
    /**
     * Constructs a new <code>VideoConfiguration</code>.
     ...
     * @alias module:model/VideoConfiguration
     */
    constructor() { 
        
        VideoConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VideoConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoConfiguration} obj Optional instance to populate.
     * @return {module:model/VideoConfiguration} The populated <code>VideoConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoConfiguration();

            if (data.hasOwnProperty('avcLevel')) {
                obj['avcLevel'] = ApiClient.convertToType(data['avcLevel'], 'String');
            }
            if (data.hasOwnProperty('avcProfile')) {
                obj['avcProfile'] = ApiClient.convertToType(data['avcProfile'], 'String');
            }
            ...
            if (data.hasOwnProperty('videoHeight')) {
                obj['videoHeight'] = ApiClient.convertToType(data['videoHeight'], 'Number');
            }
            if (data.hasOwnProperty('videoWidth')) {
                obj['videoWidth'] = ApiClient.convertToType(data['videoWidth'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VideoConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `avcLevel`
        if (data['avcLevel']) { // data not null
          String.validateJSON(data['avcLevel']);
        }
        // validate the optional field `avcProfile`
        if (data['avcProfile']) { // data not null
          String.validateJSON(data['avcProfile']);
        }
        ...
        if (data['encoder']) { // data not null
          String.validateJSON(data['encoder']);
        }
        ...
        if (data['targetFramerate']) { // data not null
          Number.validateJSON(data['targetFramerate']);
        }
        // validate the optional field `videoHeight`
        if (data['videoHeight']) { // data not null
          Number.validateJSON(data['videoHeight']);
        }
        // validate the optional field `videoWidth`
        if (data['videoWidth']) { // data not null
          Number.validateJSON(data['videoWidth']);
        }
...
/**
 * @member {String} avcLevel
 */
VideoConfiguration.prototype['avcLevel'] = undefined;

/**
 * @member {String} avcProfile
 */
VideoConfiguration.prototype['avcProfile'] = undefined;

/**
 * @member {String} codec
 */
VideoConfiguration.prototype['codec'] = undefined;

/**
 * @member {String} encoder
 */
VideoConfiguration.prototype['encoder'] = undefined;

/**
 * @member {Number} targetBitrate
 */
VideoConfiguration.prototype['targetBitrate'] = undefined;

/**
 * @member {Number} targetFramerate
 */
VideoConfiguration.prototype['targetFramerate'] = undefined;

/**
 * @member {Number} videoHeight
 */
VideoConfiguration.prototype['videoHeight'] = undefined;

/**
 * @member {Number} videoWidth
 */
VideoConfiguration.prototype['videoWidth'] = undefined;
