...
/**
 * The ListRecordingConfigurationsResponse model module.
 * @module model/ListRecordingConfigurationsResponse
 * @version 2020-07-14
 */
class ListRecordingConfigurationsResponse {
    /**
     * Constructs a new <code>ListRecordingConfigurationsResponse</code>.
     * @alias module:model/ListRecordingConfigurationsResponse
     * @param recordingConfigurations {Array} 
     */
    constructor(recordingConfigurations) { 
        
        ListRecordingConfigurationsResponse.initialize(this, recordingConfigurations);
    }
     ...
     */
    static initialize(obj, recordingConfigurations) { 
        obj['recordingConfigurations'] = recordingConfigurations;
    }

    /**
     * Constructs a <code>ListRecordingConfigurationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRecordingConfigurationsResponse} obj Optional instance to populate.
     * @return {module:model/ListRecordingConfigurationsResponse} The populated <code>ListRecordingConfigurationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRecordingConfigurationsResponse();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('recordingConfigurations')) {
                obj['recordingConfigurations'] = ApiClient.convertToType(data['recordingConfigurations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRecordingConfigurationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRecordingConfigurationsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListRecordingConfigurationsResponse.RequiredProperties) {
        ...
        // validate the optional field `recordingConfigurations`
        if (data['recordingConfigurations']) { // data not null
          Array.validateJSON(data['recordingConfigurations']);
        }
...
ListRecordingConfigurationsResponse.RequiredProperties = ["recordingConfigurations"];

/**
 * @member {String} nextToken
 */
ListRecordingConfigurationsResponse.prototype['nextToken'] = undefined;

/**
 * @member {Array} recordingConfigurations
 */
ListRecordingConfigurationsResponse.prototype['recordingConfigurations'] = undefined;
...
export default ListRecordingConfigurationsResponse;
