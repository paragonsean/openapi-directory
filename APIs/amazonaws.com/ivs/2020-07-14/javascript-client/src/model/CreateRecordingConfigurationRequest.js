...
import CreateRecordingConfigurationRequestDestinationConfiguration from './CreateRecordingConfigurationRequestDestinationConfiguration';
import CreateRecordingConfigurationRequestRenditionConfiguration from './CreateRecordingConfigurationRequestRenditionConfiguration';
import CreateRecordingConfigurationRequestThumbnailConfiguration from './CreateRecordingConfigurationRequestThumbnailConfiguration';

/**
 * The CreateRecordingConfigurationRequest model module.
 * @module model/CreateRecordingConfigurationRequest
 * @version 2020-07-14
 */
class CreateRecordingConfigurationRequest {
    /**
     * Constructs a new <code>CreateRecordingConfigurationRequest</code>.
     * @alias module:model/CreateRecordingConfigurationRequest
     * @param destinationConfiguration {module:model/CreateRecordingConfigurationRequestDestinationConfiguration} 
     */
    constructor(destinationConfiguration) { 
        
        CreateRecordingConfigurationRequest.initialize(this, destinationConfiguration);
    }
     ...
     */
    static initialize(obj, destinationConfiguration) { 
        obj['destinationConfiguration'] = destinationConfiguration;
    }

    /**
     * Constructs a <code>CreateRecordingConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRecordingConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/CreateRecordingConfigurationRequest} The populated <code>CreateRecordingConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRecordingConfigurationRequest();

            if (data.hasOwnProperty('destinationConfiguration')) {
                obj['destinationConfiguration'] = CreateRecordingConfigurationRequestDestinationConfiguration.constructFromObject(data['destinationConfiguration']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('recordingReconnectWindowSeconds')) {
                obj['recordingReconnectWindowSeconds'] = ApiClient.convertToType(data['recordingReconnectWindowSeconds'], 'Number');
            }
            if (data.hasOwnProperty('renditionConfiguration')) {
                obj['renditionConfiguration'] = CreateRecordingConfigurationRequestRenditionConfiguration.constructFromObject(data['renditionConfiguration']);
            }
            if (data.hasOwnProperty('tags')) {
                obj['tags'] = ApiClient.convertToType(data['tags'], {'String': 'String'});
            }
            if (data.hasOwnProperty('thumbnailConfiguration')) {
                obj['thumbnailConfiguration'] = CreateRecordingConfigurationRequestThumbnailConfiguration.constructFromObject(data['thumbnailConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRecordingConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRecordingConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRecordingConfigurationRequest.RequiredProperties) {
        ...
        if (data['destinationConfiguration']) { // data not null
          CreateRecordingConfigurationRequestDestinationConfiguration.validateJSON(data['destinationConfiguration']);
        }
        ...
        if (data['renditionConfiguration']) { // data not null
          CreateRecordingConfigurationRequestRenditionConfiguration.validateJSON(data['renditionConfiguration']);
        }
        // validate the optional field `thumbnailConfiguration`
        if (data['thumbnailConfiguration']) { // data not null
          CreateRecordingConfigurationRequestThumbnailConfiguration.validateJSON(data['thumbnailConfiguration']);
        }
...
CreateRecordingConfigurationRequest.RequiredProperties = ["destinationConfiguration"];

/**
 * @member {module:model/CreateRecordingConfigurationRequestDestinationConfiguration} destinationConfiguration
 */
CreateRecordingConfigurationRequest.prototype['destinationConfiguration'] = undefined;

/**
 * Recording-configuration name. The value does not need to be unique.
 * @member {String} name
 */
CreateRecordingConfigurationRequest.prototype['name'] = undefined;

/**
 * If a broadcast disconnects and then reconnects within the specified interval, the multiple streams will be considered a single broadcast and merged together. Default: 0.
 * @member {Number} recordingReconnectWindowSeconds
 */
CreateRecordingConfigurationRequest.prototype['recordingReconnectWindowSeconds'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestRenditionConfiguration} renditionConfiguration
 */
CreateRecordingConfigurationRequest.prototype['renditionConfiguration'] = undefined;
 ...
 */
CreateRecordingConfigurationRequest.prototype['tags'] = undefined;

/**
 * @member {module:model/CreateRecordingConfigurationRequestThumbnailConfiguration} thumbnailConfiguration
 */
CreateRecordingConfigurationRequest.prototype['thumbnailConfiguration'] = undefined;
...
export default CreateRecordingConfigurationRequest;
