...
import CreateStreamKeyResponseStreamKey from './CreateStreamKeyResponseStreamKey';

/**
 * The CreateStreamKeyResponse model module.
 * @module model/CreateStreamKeyResponse
 * @version 2020-07-14
 */
class CreateStreamKeyResponse {
    /**
     * Constructs a new <code>CreateStreamKeyResponse</code>.
     * @alias module:model/CreateStreamKeyResponse
     */
    constructor() { 
        
        CreateStreamKeyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamKeyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamKeyResponse} obj Optional instance to populate.
     * @return {module:model/CreateStreamKeyResponse} The populated <code>CreateStreamKeyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamKeyResponse();

            if (data.hasOwnProperty('streamKey')) {
                obj['streamKey'] = CreateStreamKeyResponseStreamKey.constructFromObject(data['streamKey']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamKeyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamKeyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `streamKey`
        if (data['streamKey']) { // data not null
          CreateStreamKeyResponseStreamKey.validateJSON(data['streamKey']);
        }
...
/**
 * @member {module:model/CreateStreamKeyResponseStreamKey} streamKey
 */
CreateStreamKeyResponse.prototype['streamKey'] = undefined;
...
export default CreateStreamKeyResponse;
