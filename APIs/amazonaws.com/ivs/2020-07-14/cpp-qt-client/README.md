...
class Example : public QObject {
    Q_OBJECT
    OAIBatchGetChannel_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAIBatchGetChannel_request Example::create(){
    OAIBatchGetChannel_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::batchGetChannelSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::batchGetChannelSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBatchGetChannel_request oai_batch_get_channel_request = create(); // OAIBatchGetChannel_request | 
      ...
      apiInstance.batchGetChannel(oai_batch_get_channel_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
