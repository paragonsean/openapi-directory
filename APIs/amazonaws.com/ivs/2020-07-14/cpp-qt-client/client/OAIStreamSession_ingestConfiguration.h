...
/*
 * OAIStreamSession_ingestConfiguration.h
 *
 * 
 */

#ifndef OAIStreamSession_ingestConfiguration_H
#define OAIStreamSession_ingestConfiguration_H
...
class OAIStreamSession_ingestConfiguration : public OAIObject {
public:
    OAIStreamSession_ingestConfiguration();
    OAIStreamSession_ingestConfiguration(QString json);
    ~OAIStreamSession_ingestConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamSession_ingestConfiguration)

#endif // OAIStreamSession_ingestConfiguration_H
