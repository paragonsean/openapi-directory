...
/*
 * OAIImportPlaybackKeyPair_request.h
 *
 * 
 */

#ifndef OAIImportPlaybackKeyPair_request_H
#define OAIImportPlaybackKeyPair_request_H
...
class OAIImportPlaybackKeyPair_request : public OAIObject {
public:
    OAIImportPlaybackKeyPair_request();
    OAIImportPlaybackKeyPair_request(QString json);
    ~OAIImportPlaybackKeyPair_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportPlaybackKeyPair_request)

#endif // OAIImportPlaybackKeyPair_request_H
