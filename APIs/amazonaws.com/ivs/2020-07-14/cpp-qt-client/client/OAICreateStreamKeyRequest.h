...
/*
 * OAICreateStreamKeyRequest.h
 *
 * 
 */

#ifndef OAICreateStreamKeyRequest_H
#define OAICreateStreamKeyRequest_H
...
class OAICreateStreamKeyRequest : public OAIObject {
public:
    OAICreateStreamKeyRequest();
    OAICreateStreamKeyRequest(QString json);
    ~OAICreateStreamKeyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamKeyRequest)

#endif // OAICreateStreamKeyRequest_H
