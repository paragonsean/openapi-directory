...
#include "OAIGetStreamKeyResponse_streamKey.h"
...
OAIGetStreamKeyResponse_streamKey::OAIGetStreamKeyResponse_streamKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamKeyResponse_streamKey::OAIGetStreamKeyResponse_streamKey() {
    this->initializeModel();
}

OAIGetStreamKeyResponse_streamKey::~OAIGetStreamKeyResponse_streamKey() {}

void OAIGetStreamKeyResponse_streamKey::initializeModel() {
...
void OAIGetStreamKeyResponse_streamKey::fromJson(QString jsonString) {
...
void OAIGetStreamKeyResponse_streamKey::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamKeyResponse_streamKey::asJson() const {
...
QJsonObject OAIGetStreamKeyResponse_streamKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetStreamKeyResponse_streamKey::getArn() const {
    return m_arn;
}
void OAIGetStreamKeyResponse_streamKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStreamKeyResponse_streamKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStreamKeyResponse_streamKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetStreamKeyResponse_streamKey::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStreamKeyResponse_streamKey::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStreamKeyResponse_streamKey::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStreamKeyResponse_streamKey::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAIGetStreamKeyResponse_streamKey::getTags() const {
    return m_tags;
}
void OAIGetStreamKeyResponse_streamKey::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetStreamKeyResponse_streamKey::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetStreamKeyResponse_streamKey::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIGetStreamKeyResponse_streamKey::getValue() const {
    return m_value;
}
void OAIGetStreamKeyResponse_streamKey::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIGetStreamKeyResponse_streamKey::is_value_Set() const{
    return m_value_isSet;
}

bool OAIGetStreamKeyResponse_streamKey::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIGetStreamKeyResponse_streamKey::isSet() const {
...
bool OAIGetStreamKeyResponse_streamKey::isValid() const {
