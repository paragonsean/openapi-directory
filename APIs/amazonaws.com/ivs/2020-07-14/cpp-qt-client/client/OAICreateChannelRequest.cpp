...
bool OAICreateChannelRequest::getAuthorized() const {
    return m_authorized;
}
void OAICreateChannelRequest::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAICreateChannelRequest::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAICreateChannelRequest::is_authorized_Valid() const{
    return m_authorized_isValid;
}

bool OAICreateChannelRequest::getInsecureIngest() const {
    return m_insecure_ingest;
}
void OAICreateChannelRequest::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAICreateChannelRequest::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAICreateChannelRequest::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

OAIChannelLatencyMode OAICreateChannelRequest::getLatencyMode() const {
    return m_latency_mode;
}
void OAICreateChannelRequest::setLatencyMode(const OAIChannelLatencyMode &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAICreateChannelRequest::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAICreateChannelRequest::is_latency_mode_Valid() const{
...
OAITranscodePreset OAICreateChannelRequest::getPreset() const {
    return m_preset;
}
void OAICreateChannelRequest::setPreset(const OAITranscodePreset &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAICreateChannelRequest::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAICreateChannelRequest::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAICreateChannelRequest::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAICreateChannelRequest::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAICreateChannelRequest::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAICreateChannelRequest::is_recording_configuration_arn_Valid() const{
...
OAIChannelType OAICreateChannelRequest::getType() const {
    return m_type;
}
void OAICreateChannelRequest::setType(const OAIChannelType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateChannelRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateChannelRequest::is_type_Valid() const{
