...
void OAIListChannelsRequest::initializeModel() {
    ...
    m_filter_by_name_isSet = false;
    m_filter_by_name_isValid = false;

    m_filter_by_recording_configuration_arn_isSet = false;
    m_filter_by_recording_configuration_arn_isValid = false;
...
void OAIListChannelsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_filter_by_name_isValid = ::OpenAPI::fromJsonValue(m_filter_by_name, json[QString("filterByName")]);
    m_filter_by_name_isSet = !json[QString("filterByName")].isNull() && m_filter_by_name_isValid;

    m_filter_by_recording_configuration_arn_isValid = ::OpenAPI::fromJsonValue(m_filter_by_recording_configuration_arn, json[QString("filterByRecordingConfigurationArn")]);
    m_filter_by_recording_configuration_arn_isSet = !json[QString("filterByRecordingConfigurationArn")].isNull() && m_filter_by_recording_configuration_arn_isValid;
...
QJsonObject OAIListChannelsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filter_by_name_isSet) {
        obj.insert(QString("filterByName"), ::OpenAPI::toJsonValue(m_filter_by_name));
    }
    if (m_filter_by_recording_configuration_arn_isSet) {
        obj.insert(QString("filterByRecordingConfigurationArn"), ::OpenAPI::toJsonValue(m_filter_by_recording_configuration_arn));
    }
...
QString OAIListChannelsRequest::getFilterByName() const {
    return m_filter_by_name;
}
void OAIListChannelsRequest::setFilterByName(const QString &filter_by_name) {
    m_filter_by_name = filter_by_name;
    m_filter_by_name_isSet = true;
}

bool OAIListChannelsRequest::is_filter_by_name_Set() const{
    return m_filter_by_name_isSet;
}

bool OAIListChannelsRequest::is_filter_by_name_Valid() const{
    return m_filter_by_name_isValid;
}

QString OAIListChannelsRequest::getFilterByRecordingConfigurationArn() const {
    return m_filter_by_recording_configuration_arn;
}
void OAIListChannelsRequest::setFilterByRecordingConfigurationArn(const QString &filter_by_recording_configuration_arn) {
    m_filter_by_recording_configuration_arn = filter_by_recording_configuration_arn;
    m_filter_by_recording_configuration_arn_isSet = true;
}

bool OAIListChannelsRequest::is_filter_by_recording_configuration_arn_Set() const{
    return m_filter_by_recording_configuration_arn_isSet;
}

bool OAIListChannelsRequest::is_filter_by_recording_configuration_arn_Valid() const{
    return m_filter_by_recording_configuration_arn_isValid;
}
