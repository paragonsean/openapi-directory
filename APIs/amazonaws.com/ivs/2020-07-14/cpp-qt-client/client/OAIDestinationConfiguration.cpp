...
OAICreateRecordingConfiguration_request_destinationConfiguration_s3 OAIDestinationConfiguration::getS3() const {
    return m_s3;
}
void OAIDestinationConfiguration::setS3(const OAICreateRecordingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIDestinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIDestinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}
