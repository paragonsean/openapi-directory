...
OAIBatchGetChannel_request::OAIBatchGetChannel_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetChannel_request::OAIBatchGetChannel_request() {
    this->initializeModel();
}

OAIBatchGetChannel_request::~OAIBatchGetChannel_request() {}

void OAIBatchGetChannel_request::initializeModel() {

    m_arns_isSet = false;
    m_arns_isValid = false;
}

void OAIBatchGetChannel_request::fromJson(QString jsonString) {
...
QJsonObject OAIBatchGetChannel_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arns.size() > 0) {
...
QList<QString> OAIBatchGetChannel_request::getArns() const {
    return m_arns;
}
void OAIBatchGetChannel_request::setArns(const QList<QString> &arns) {
    m_arns = arns;
    m_arns_isSet = true;
}

bool OAIBatchGetChannel_request::is_arns_Set() const{
    return m_arns_isSet;
}

bool OAIBatchGetChannel_request::is_arns_Valid() const{
    return m_arns_isValid;
}

bool OAIBatchGetChannel_request::isSet() const {
...
bool OAIBatchGetChannel_request::isValid() const {
