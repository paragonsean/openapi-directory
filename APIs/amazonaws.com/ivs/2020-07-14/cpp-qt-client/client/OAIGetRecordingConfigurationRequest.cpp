...
#include "OAIGetRecordingConfigurationRequest.h"
...
OAIGetRecordingConfigurationRequest::OAIGetRecordingConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRecordingConfigurationRequest::OAIGetRecordingConfigurationRequest() {
    this->initializeModel();
}

OAIGetRecordingConfigurationRequest::~OAIGetRecordingConfigurationRequest() {}

void OAIGetRecordingConfigurationRequest::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetRecordingConfigurationRequest::fromJson(QString jsonString) {
...
void OAIGetRecordingConfigurationRequest::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetRecordingConfigurationRequest::asJson() const {
...
QJsonObject OAIGetRecordingConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetRecordingConfigurationRequest::getArn() const {
    return m_arn;
}
void OAIGetRecordingConfigurationRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetRecordingConfigurationRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetRecordingConfigurationRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetRecordingConfigurationRequest::isSet() const {
...
bool OAIGetRecordingConfigurationRequest::isValid() const {
