...
/*
 * OAIListPlaybackKeyPairsRequest.h
 *
 * 
 */

#ifndef OAIListPlaybackKeyPairsRequest_H
#define OAIListPlaybackKeyPairsRequest_H
...
class OAIListPlaybackKeyPairsRequest : public OAIObject {
public:
    OAIListPlaybackKeyPairsRequest();
    OAIListPlaybackKeyPairsRequest(QString json);
    ~OAIListPlaybackKeyPairsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPlaybackKeyPairsRequest)

#endif // OAIListPlaybackKeyPairsRequest_H
