...
/*
 * OAIStreamSessionSummary.h
 *
 * Summary information about a stream session.
 */

#ifndef OAIStreamSessionSummary_H
#define OAIStreamSessionSummary_H
...
class OAIStreamSessionSummary : public OAIObject {
public:
    OAIStreamSessionSummary();
    OAIStreamSessionSummary(QString json);
    ~OAIStreamSessionSummary() override;
    ...
    bool getHasErrorEvent() const;
    void setHasErrorEvent(const bool &has_error_event);
    bool is_has_error_event_Set() const;
    bool is_has_error_event_Valid() const;
...
private:
    ...
    bool m_has_error_event;
    bool m_has_error_event_isSet;
    bool m_has_error_event_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamSessionSummary)

#endif // OAIStreamSessionSummary_H
