...
#include "OAIListStreamKeysRequest.h"
...
OAIListStreamKeysRequest::OAIListStreamKeysRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamKeysRequest::OAIListStreamKeysRequest() {
    this->initializeModel();
}

OAIListStreamKeysRequest::~OAIListStreamKeysRequest() {}

void OAIListStreamKeysRequest::initializeModel() {
...
void OAIListStreamKeysRequest::fromJson(QString jsonString) {
...
void OAIListStreamKeysRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamKeysRequest::asJson() const {
...
QJsonObject OAIListStreamKeysRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStreamKeysRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIListStreamKeysRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIListStreamKeysRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIListStreamKeysRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

qint32 OAIListStreamKeysRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamKeysRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamKeysRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamKeysRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStreamKeysRequest::getNextToken() const {
    return m_next_token;
}
void OAIListStreamKeysRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamKeysRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamKeysRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStreamKeysRequest::isSet() const {
...
bool OAIListStreamKeysRequest::isValid() const {
