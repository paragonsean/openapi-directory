...
/*
 * OAIStreamSession_recordingConfiguration.h
 *
 * 
 */

#ifndef OAIStreamSession_recordingConfiguration_H
#define OAIStreamSession_recordingConfiguration_H
...
class OAIStreamSession_recordingConfiguration : public OAIObject {
public:
    OAIStreamSession_recordingConfiguration();
    OAIStreamSession_recordingConfiguration(QString json);
    ~OAIStreamSession_recordingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamSession_recordingConfiguration)

#endif // OAIStreamSession_recordingConfiguration_H
