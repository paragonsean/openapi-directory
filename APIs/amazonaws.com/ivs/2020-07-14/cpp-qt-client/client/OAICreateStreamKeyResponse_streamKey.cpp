...
#include "OAICreateStreamKeyResponse_streamKey.h"
...
OAICreateStreamKeyResponse_streamKey::OAICreateStreamKeyResponse_streamKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamKeyResponse_streamKey::OAICreateStreamKeyResponse_streamKey() {
    this->initializeModel();
}

OAICreateStreamKeyResponse_streamKey::~OAICreateStreamKeyResponse_streamKey() {}

void OAICreateStreamKeyResponse_streamKey::initializeModel() {
...
void OAICreateStreamKeyResponse_streamKey::fromJson(QString jsonString) {
...
void OAICreateStreamKeyResponse_streamKey::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamKeyResponse_streamKey::asJson() const {
...
QJsonObject OAICreateStreamKeyResponse_streamKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateStreamKeyResponse_streamKey::getArn() const {
    return m_arn;
}
void OAICreateStreamKeyResponse_streamKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateStreamKeyResponse_streamKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateStreamKeyResponse_streamKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAICreateStreamKeyResponse_streamKey::getChannelArn() const {
    return m_channel_arn;
}
void OAICreateStreamKeyResponse_streamKey::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAICreateStreamKeyResponse_streamKey::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAICreateStreamKeyResponse_streamKey::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAICreateStreamKeyResponse_streamKey::getTags() const {
    return m_tags;
}
void OAICreateStreamKeyResponse_streamKey::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateStreamKeyResponse_streamKey::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateStreamKeyResponse_streamKey::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateStreamKeyResponse_streamKey::getValue() const {
    return m_value;
}
void OAICreateStreamKeyResponse_streamKey::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateStreamKeyResponse_streamKey::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateStreamKeyResponse_streamKey::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateStreamKeyResponse_streamKey::isSet() const {
...
bool OAICreateStreamKeyResponse_streamKey::isValid() const {
