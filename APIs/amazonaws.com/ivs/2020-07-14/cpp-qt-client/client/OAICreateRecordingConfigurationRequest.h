...
/*
 * OAICreateRecordingConfigurationRequest.h
 *
 * 
 */

#ifndef OAICreateRecordingConfigurationRequest_H
#define OAICreateRecordingConfigurationRequest_H

#include <QJsonObject>

#include "OAICreateRecordingConfigurationRequest_destinationConfiguration.h"
...
namespace OpenAPI {
class OAICreateRecordingConfigurationRequest_destinationConfiguration;
...
class OAICreateRecordingConfigurationRequest : public OAIObject {
public:
    OAICreateRecordingConfigurationRequest();
    OAICreateRecordingConfigurationRequest(QString json);
    ~OAICreateRecordingConfigurationRequest() override;
    ...
    OAICreateRecordingConfigurationRequest_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAICreateRecordingConfigurationRequest_destinationConfiguration &destination_configuration);
...
private:
    ...
    OAICreateRecordingConfigurationRequest_destinationConfiguration m_destination_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRecordingConfigurationRequest)

#endif // OAICreateRecordingConfigurationRequest_H
