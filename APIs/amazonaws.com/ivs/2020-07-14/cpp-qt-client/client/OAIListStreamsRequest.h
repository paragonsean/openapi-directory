...
/*
 * OAIListStreamsRequest.h
 *
 * 
 */

#ifndef OAIListStreamsRequest_H
#define OAIListStreamsRequest_H
...
namespace OpenAPI {
class OAIListStreamsRequest_filterBy;

class OAIListStreamsRequest : public OAIObject {
public:
    OAIListStreamsRequest();
    OAIListStreamsRequest(QString json);
    ~OAIListStreamsRequest() override;
    ...
    OAIListStreamsRequest_filterBy getFilterBy() const;
    void setFilterBy(const OAIListStreamsRequest_filterBy &filter_by);
...
private:
    ...
    OAIListStreamsRequest_filterBy m_filter_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamsRequest)

#endif // OAIListStreamsRequest_H
