...
#include "OAIRecordingConfigurationSummary.h"
...
OAIRecordingConfigurationSummary::OAIRecordingConfigurationSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecordingConfigurationSummary::OAIRecordingConfigurationSummary() {
    this->initializeModel();
}

OAIRecordingConfigurationSummary::~OAIRecordingConfigurationSummary() {}

void OAIRecordingConfigurationSummary::initializeModel() {
...
void OAIRecordingConfigurationSummary::fromJson(QString jsonString) {
...
void OAIRecordingConfigurationSummary::fromJsonObject(QJsonObject json) {
...
QString OAIRecordingConfigurationSummary::asJson() const {
...
QJsonObject OAIRecordingConfigurationSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIRecordingConfigurationSummary::getArn() const {
    return m_arn;
}
void OAIRecordingConfigurationSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRecordingConfigurationSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRecordingConfigurationSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIRecordingConfiguration_destinationConfiguration OAIRecordingConfigurationSummary::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIRecordingConfigurationSummary::setDestinationConfiguration(const OAIRecordingConfiguration_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIRecordingConfigurationSummary::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIRecordingConfigurationSummary::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIRecordingConfigurationSummary::getName() const {
    return m_name;
}
void OAIRecordingConfigurationSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRecordingConfigurationSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRecordingConfigurationSummary::is_name_Valid() const{
    return m_name_isValid;
}

OAIRecordingConfigurationState OAIRecordingConfigurationSummary::getState() const {
    return m_state;
}
void OAIRecordingConfigurationSummary::setState(const OAIRecordingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIRecordingConfigurationSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIRecordingConfigurationSummary::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIRecordingConfigurationSummary::getTags() const {
    return m_tags;
}
void OAIRecordingConfigurationSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIRecordingConfigurationSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIRecordingConfigurationSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIRecordingConfigurationSummary::isSet() const {
...
bool OAIRecordingConfigurationSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_arn_isValid && m_destination_configuration_isValid && m_state_isValid && true;
}
