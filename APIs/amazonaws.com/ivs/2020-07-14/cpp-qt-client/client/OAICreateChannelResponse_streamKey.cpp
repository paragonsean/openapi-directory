...
#include "OAICreateChannelResponse_streamKey.h"
...
OAICreateChannelResponse_streamKey::OAICreateChannelResponse_streamKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChannelResponse_streamKey::OAICreateChannelResponse_streamKey() {
    this->initializeModel();
}

OAICreateChannelResponse_streamKey::~OAICreateChannelResponse_streamKey() {}

void OAICreateChannelResponse_streamKey::initializeModel() {
...
void OAICreateChannelResponse_streamKey::fromJson(QString jsonString) {
...
void OAICreateChannelResponse_streamKey::fromJsonObject(QJsonObject json) {
...
QString OAICreateChannelResponse_streamKey::asJson() const {
...
QJsonObject OAICreateChannelResponse_streamKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateChannelResponse_streamKey::getArn() const {
    return m_arn;
}
void OAICreateChannelResponse_streamKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateChannelResponse_streamKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateChannelResponse_streamKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAICreateChannelResponse_streamKey::getChannelArn() const {
    return m_channel_arn;
}
void OAICreateChannelResponse_streamKey::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAICreateChannelResponse_streamKey::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAICreateChannelResponse_streamKey::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAICreateChannelResponse_streamKey::getTags() const {
    return m_tags;
}
void OAICreateChannelResponse_streamKey::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateChannelResponse_streamKey::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateChannelResponse_streamKey::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateChannelResponse_streamKey::getValue() const {
    return m_value;
}
void OAICreateChannelResponse_streamKey::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICreateChannelResponse_streamKey::is_value_Set() const{
    return m_value_isSet;
}

bool OAICreateChannelResponse_streamKey::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICreateChannelResponse_streamKey::isSet() const {
...
bool OAICreateChannelResponse_streamKey::isValid() const {
