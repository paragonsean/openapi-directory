...
OAIStreamSession_channel::OAIStreamSession_channel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSession_channel::OAIStreamSession_channel() {
    this->initializeModel();
}

OAIStreamSession_channel::~OAIStreamSession_channel() {}

void OAIStreamSession_channel::initializeModel() {
...
void OAIStreamSession_channel::fromJson(QString jsonString) {
...
void OAIStreamSession_channel::fromJsonObject(QJsonObject json) {
...
QString OAIStreamSession_channel::asJson() const {
...
QJsonObject OAIStreamSession_channel::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamSession_channel::getArn() const {
    return m_arn;
}
void OAIStreamSession_channel::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamSession_channel::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamSession_channel::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIStreamSession_channel::getAuthorized() const {
    return m_authorized;
}
void OAIStreamSession_channel::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAIStreamSession_channel::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAIStreamSession_channel::is_authorized_Valid() const{
    return m_authorized_isValid;
}

QString OAIStreamSession_channel::getIngestEndpoint() const {
    return m_ingest_endpoint;
}
void OAIStreamSession_channel::setIngestEndpoint(const QString &ingest_endpoint) {
    m_ingest_endpoint = ingest_endpoint;
    m_ingest_endpoint_isSet = true;
}

bool OAIStreamSession_channel::is_ingest_endpoint_Set() const{
    return m_ingest_endpoint_isSet;
}

bool OAIStreamSession_channel::is_ingest_endpoint_Valid() const{
    return m_ingest_endpoint_isValid;
}

bool OAIStreamSession_channel::getInsecureIngest() const {
    return m_insecure_ingest;
}
void OAIStreamSession_channel::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAIStreamSession_channel::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAIStreamSession_channel::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

OAIChannelLatencyMode OAIStreamSession_channel::getLatencyMode() const {
    return m_latency_mode;
}
void OAIStreamSession_channel::setLatencyMode(const OAIChannelLatencyMode &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAIStreamSession_channel::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAIStreamSession_channel::is_latency_mode_Valid() const{
    return m_latency_mode_isValid;
}

QString OAIStreamSession_channel::getName() const {
    return m_name;
}
void OAIStreamSession_channel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStreamSession_channel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStreamSession_channel::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIStreamSession_channel::getPlaybackUrl() const {
    return m_playback_url;
}
void OAIStreamSession_channel::setPlaybackUrl(const QString &playback_url) {
    m_playback_url = playback_url;
    m_playback_url_isSet = true;
}

bool OAIStreamSession_channel::is_playback_url_Set() const{
    return m_playback_url_isSet;
}

bool OAIStreamSession_channel::is_playback_url_Valid() const{
    return m_playback_url_isValid;
}

OAITranscodePreset OAIStreamSession_channel::getPreset() const {
    return m_preset;
}
void OAIStreamSession_channel::setPreset(const OAITranscodePreset &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIStreamSession_channel::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIStreamSession_channel::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIStreamSession_channel::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAIStreamSession_channel::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAIStreamSession_channel::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAIStreamSession_channel::is_recording_configuration_arn_Valid() const{
    return m_recording_configuration_arn_isValid;
}

QMap OAIStreamSession_channel::getTags() const {
    return m_tags;
}
void OAIStreamSession_channel::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStreamSession_channel::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStreamSession_channel::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIChannelType OAIStreamSession_channel::getType() const {
    return m_type;
}
void OAIStreamSession_channel::setType(const OAIChannelType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIStreamSession_channel::is_type_Set() const{
    return m_type_isSet;
}

bool OAIStreamSession_channel::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIStreamSession_channel::isSet() const {
...
bool OAIStreamSession_channel::isValid() const {
