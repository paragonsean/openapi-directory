...
OAIImportPlaybackKeyPair_request::OAIImportPlaybackKeyPair_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportPlaybackKeyPair_request::OAIImportPlaybackKeyPair_request() {
    this->initializeModel();
}

OAIImportPlaybackKeyPair_request::~OAIImportPlaybackKeyPair_request() {}

void OAIImportPlaybackKeyPair_request::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_public_key_material_isSet = false;
    m_public_key_material_isValid = false;

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAIImportPlaybackKeyPair_request::fromJson(QString jsonString) {
...
void OAIImportPlaybackKeyPair_request::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;

    m_public_key_material_isValid = ::OpenAPI::fromJsonValue(m_public_key_material, json[QString("publicKeyMaterial")]);
    m_public_key_material_isSet = !json[QString("publicKeyMaterial")].isNull() && m_public_key_material_isValid;

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("tags")]);
    m_tags_isSet = !json[QString("tags")].isNull() && m_tags_isValid;
}

QString OAIImportPlaybackKeyPair_request::asJson() const {
...
QJsonObject OAIImportPlaybackKeyPair_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_public_key_material_isSet) {
        obj.insert(QString("publicKeyMaterial"), ::OpenAPI::toJsonValue(m_public_key_material));
    }
    if (m_tags.size() > 0) {
...
QString OAIImportPlaybackKeyPair_request::getName() const {
    return m_name;
}
void OAIImportPlaybackKeyPair_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImportPlaybackKeyPair_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImportPlaybackKeyPair_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIImportPlaybackKeyPair_request::getPublicKeyMaterial() const {
    return m_public_key_material;
}
void OAIImportPlaybackKeyPair_request::setPublicKeyMaterial(const QString &public_key_material) {
    m_public_key_material = public_key_material;
    m_public_key_material_isSet = true;
}

bool OAIImportPlaybackKeyPair_request::is_public_key_material_Set() const{
    return m_public_key_material_isSet;
}

bool OAIImportPlaybackKeyPair_request::is_public_key_material_Valid() const{
    return m_public_key_material_isValid;
}

QMap<QString, QString> OAIImportPlaybackKeyPair_request::getTags() const {
    return m_tags;
}
void OAIImportPlaybackKeyPair_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIImportPlaybackKeyPair_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIImportPlaybackKeyPair_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIImportPlaybackKeyPair_request::isSet() const {
...
bool OAIImportPlaybackKeyPair_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_public_key_material_isValid && true;
}
