...
bool OAICreateChannel_request::isAuthorized() const {
    return m_authorized;
}
void OAICreateChannel_request::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAICreateChannel_request::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAICreateChannel_request::is_authorized_Valid() const{
    return m_authorized_isValid;
}

bool OAICreateChannel_request::isInsecureIngest() const {
    return m_insecure_ingest;
}
void OAICreateChannel_request::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAICreateChannel_request::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAICreateChannel_request::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

QString OAICreateChannel_request::getLatencyMode() const {
    return m_latency_mode;
}
void OAICreateChannel_request::setLatencyMode(const QString &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAICreateChannel_request::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAICreateChannel_request::is_latency_mode_Valid() const{
...
QString OAICreateChannel_request::getPreset() const {
    return m_preset;
}
void OAICreateChannel_request::setPreset(const QString &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAICreateChannel_request::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAICreateChannel_request::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAICreateChannel_request::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAICreateChannel_request::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAICreateChannel_request::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAICreateChannel_request::is_recording_configuration_arn_Valid() const{
...
QString OAICreateChannel_request::getType() const {
    return m_type;
}
void OAICreateChannel_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateChannel_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateChannel_request::is_type_Valid() const{
