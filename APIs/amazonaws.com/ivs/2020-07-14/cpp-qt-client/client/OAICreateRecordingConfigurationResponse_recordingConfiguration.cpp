...
#include "OAICreateRecordingConfigurationResponse_recordingConfiguration.h"
...
OAICreateRecordingConfigurationResponse_recordingConfiguration::OAICreateRecordingConfigurationResponse_recordingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationResponse_recordingConfiguration::OAICreateRecordingConfigurationResponse_recordingConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfigurationResponse_recordingConfiguration::~OAICreateRecordingConfigurationResponse_recordingConfiguration() {}

void OAICreateRecordingConfigurationResponse_recordingConfiguration::initializeModel() {
...
void OAICreateRecordingConfigurationResponse_recordingConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationResponse_recordingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfigurationResponse_recordingConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationResponse_recordingConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateRecordingConfigurationResponse_recordingConfiguration::getArn() const {
    return m_arn;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIRecordingConfiguration_destinationConfiguration OAICreateRecordingConfigurationResponse_recordingConfiguration::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setDestinationConfiguration(const OAIRecordingConfiguration_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateRecordingConfigurationResponse_recordingConfiguration::getName() const {
    return m_name;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICreateRecordingConfigurationResponse_recordingConfiguration::getRecordingReconnectWindowSeconds() const {
    return m_recording_reconnect_window_seconds;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds) {
    m_recording_reconnect_window_seconds = recording_reconnect_window_seconds;
    m_recording_reconnect_window_seconds_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_recording_reconnect_window_seconds_Set() const{
    return m_recording_reconnect_window_seconds_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_recording_reconnect_window_seconds_Valid() const{
    return m_recording_reconnect_window_seconds_isValid;
}

OAICreateRecordingConfigurationRequest_renditionConfiguration OAICreateRecordingConfigurationResponse_recordingConfiguration::getRenditionConfiguration() const {
    return m_rendition_configuration;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setRenditionConfiguration(const OAICreateRecordingConfigurationRequest_renditionConfiguration &rendition_configuration) {
    m_rendition_configuration = rendition_configuration;
    m_rendition_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_rendition_configuration_Set() const{
    return m_rendition_configuration_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_rendition_configuration_Valid() const{
    return m_rendition_configuration_isValid;
}

OAIRecordingConfigurationState OAICreateRecordingConfigurationResponse_recordingConfiguration::getState() const {
    return m_state;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setState(const OAIRecordingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_state_Set() const{
    return m_state_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAICreateRecordingConfigurationResponse_recordingConfiguration::getTags() const {
    return m_tags;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration OAICreateRecordingConfigurationResponse_recordingConfiguration::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAICreateRecordingConfigurationResponse_recordingConfiguration::setThumbnailConfiguration(const OAICreateRecordingConfigurationRequest_thumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAICreateRecordingConfigurationResponse_recordingConfiguration::isSet() const {
...
bool OAICreateRecordingConfigurationResponse_recordingConfiguration::isValid() const {
