...
OAIDeleteRecordingConfiguration_request::OAIDeleteRecordingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRecordingConfiguration_request::OAIDeleteRecordingConfiguration_request() {
    this->initializeModel();
}

OAIDeleteRecordingConfiguration_request::~OAIDeleteRecordingConfiguration_request() {}

void OAIDeleteRecordingConfiguration_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteRecordingConfiguration_request::fromJson(QString jsonString) {
...
void OAIDeleteRecordingConfiguration_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteRecordingConfiguration_request::asJson() const {
...
QJsonObject OAIDeleteRecordingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteRecordingConfiguration_request::getArn() const {
    return m_arn;
}
void OAIDeleteRecordingConfiguration_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteRecordingConfiguration_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteRecordingConfiguration_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteRecordingConfiguration_request::isSet() const {
...
bool OAIDeleteRecordingConfiguration_request::isValid() const {
