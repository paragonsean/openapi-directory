...
#include "OAIIngestConfiguration_audio.h"
...
OAIIngestConfiguration_audio::OAIIngestConfiguration_audio(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIngestConfiguration_audio::OAIIngestConfiguration_audio() {
    this->initializeModel();
}

OAIIngestConfiguration_audio::~OAIIngestConfiguration_audio() {}

void OAIIngestConfiguration_audio::initializeModel() {
    ...
    m_target_bitrate_isSet = false;
    m_target_bitrate_isValid = false;
}

void OAIIngestConfiguration_audio::fromJson(QString jsonString) {
...
void OAIIngestConfiguration_audio::fromJsonObject(QJsonObject json) {
    ...
    m_target_bitrate_isValid = ::OpenAPI::fromJsonValue(m_target_bitrate, json[QString("targetBitrate")]);
    m_target_bitrate_isSet = !json[QString("targetBitrate")].isNull() && m_target_bitrate_isValid;
}

QString OAIIngestConfiguration_audio::asJson() const {
...
QJsonObject OAIIngestConfiguration_audio::asJsonObject() const {
    QJsonObject obj;
    if (m_channels_isSet) {
    ...
    if (m_target_bitrate_isSet) {
        obj.insert(QString("targetBitrate"), ::OpenAPI::toJsonValue(m_target_bitrate));
    }
    return obj;
}

qint32 OAIIngestConfiguration_audio::getChannels() const {
    return m_channels;
}
void OAIIngestConfiguration_audio::setChannels(const qint32 &channels) {
    m_channels = channels;
    m_channels_isSet = true;
}

bool OAIIngestConfiguration_audio::is_channels_Set() const{
    return m_channels_isSet;
}

bool OAIIngestConfiguration_audio::is_channels_Valid() const{
    return m_channels_isValid;
}

QString OAIIngestConfiguration_audio::getCodec() const {
    return m_codec;
}
void OAIIngestConfiguration_audio::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIIngestConfiguration_audio::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIIngestConfiguration_audio::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIIngestConfiguration_audio::getSampleRate() const {
    return m_sample_rate;
}
void OAIIngestConfiguration_audio::setSampleRate(const qint32 &sample_rate) {
    m_sample_rate = sample_rate;
    m_sample_rate_isSet = true;
}

bool OAIIngestConfiguration_audio::is_sample_rate_Set() const{
    return m_sample_rate_isSet;
}

bool OAIIngestConfiguration_audio::is_sample_rate_Valid() const{
    return m_sample_rate_isValid;
}

qint32 OAIIngestConfiguration_audio::getTargetBitrate() const {
    return m_target_bitrate;
}
void OAIIngestConfiguration_audio::setTargetBitrate(const qint32 &target_bitrate) {
    m_target_bitrate = target_bitrate;
    m_target_bitrate_isSet = true;
}

bool OAIIngestConfiguration_audio::is_target_bitrate_Set() const{
    return m_target_bitrate_isSet;
}

bool OAIIngestConfiguration_audio::is_target_bitrate_Valid() const{
    return m_target_bitrate_isValid;
}

bool OAIIngestConfiguration_audio::isSet() const {
...
bool OAIIngestConfiguration_audio::isValid() const {
