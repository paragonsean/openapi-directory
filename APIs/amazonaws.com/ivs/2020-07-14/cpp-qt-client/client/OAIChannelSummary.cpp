...
bool OAIChannelSummary::getAuthorized() const {
    return m_authorized;
}
void OAIChannelSummary::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAIChannelSummary::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAIChannelSummary::is_authorized_Valid() const{
    return m_authorized_isValid;
}

bool OAIChannelSummary::getInsecureIngest() const {
    return m_insecure_ingest;
}
void OAIChannelSummary::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAIChannelSummary::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAIChannelSummary::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

OAIChannelLatencyMode OAIChannelSummary::getLatencyMode() const {
    return m_latency_mode;
}
void OAIChannelSummary::setLatencyMode(const OAIChannelLatencyMode &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAIChannelSummary::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAIChannelSummary::is_latency_mode_Valid() const{
...
OAITranscodePreset OAIChannelSummary::getPreset() const {
    return m_preset;
}
void OAIChannelSummary::setPreset(const OAITranscodePreset &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIChannelSummary::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIChannelSummary::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIChannelSummary::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAIChannelSummary::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAIChannelSummary::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAIChannelSummary::is_recording_configuration_arn_Valid() const{
...
OAIChannelType OAIChannelSummary::getType() const {
    return m_type;
}
void OAIChannelSummary::setType(const OAIChannelType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIChannelSummary::is_type_Set() const{
    return m_type_isSet;
}

bool OAIChannelSummary::is_type_Valid() const{
