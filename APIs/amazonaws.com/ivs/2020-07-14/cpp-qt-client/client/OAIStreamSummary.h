...
#ifndef OAIStreamSummary_H
#define OAIStreamSummary_H
...
class OAIStreamSummary : public OAIObject {
public:
    OAIStreamSummary();
    OAIStreamSummary(QString json);
    ~OAIStreamSummary() override;
    ...
    OAIStreamHealth getHealth() const;
    void setHealth(const OAIStreamHealth &health);
    ...
    OAIStreamState getState() const;
    void setState(const OAIStreamState &state);
    ...
    qint32 getViewerCount() const;
    void setViewerCount(const qint32 &viewer_count);
    bool is_viewer_count_Set() const;
    bool is_viewer_count_Valid() const;
...
private:
    ...
    qint32 m_viewer_count;
    bool m_viewer_count_isSet;
    bool m_viewer_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStreamSummary)

#endif // OAIStreamSummary_H
