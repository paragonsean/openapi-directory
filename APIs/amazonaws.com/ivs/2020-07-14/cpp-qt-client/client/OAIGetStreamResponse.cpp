...
OAIGetStreamResponse::OAIGetStreamResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamResponse::OAIGetStreamResponse() {
    this->initializeModel();
}

OAIGetStreamResponse::~OAIGetStreamResponse() {}

void OAIGetStreamResponse::initializeModel() {

    m_stream_isSet = false;
    m_stream_isValid = false;
}

void OAIGetStreamResponse::fromJson(QString jsonString) {
...
void OAIGetStreamResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamResponse::asJson() const {
...
QJsonObject OAIGetStreamResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_stream.isSet()) {
...
OAIGetStreamResponse_stream OAIGetStreamResponse::getStream() const {
    return m_stream;
}
void OAIGetStreamResponse::setStream(const OAIGetStreamResponse_stream &stream) {
    m_stream = stream;
    m_stream_isSet = true;
}

bool OAIGetStreamResponse::is_stream_Set() const{
    return m_stream_isSet;
}

bool OAIGetStreamResponse::is_stream_Valid() const{
    return m_stream_isValid;
}

bool OAIGetStreamResponse::isSet() const {
...
bool OAIGetStreamResponse::isValid() const {
