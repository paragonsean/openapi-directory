...
OAIListPlaybackKeyPairs_request::OAIListPlaybackKeyPairs_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPlaybackKeyPairs_request::OAIListPlaybackKeyPairs_request() {
    this->initializeModel();
}

OAIListPlaybackKeyPairs_request::~OAIListPlaybackKeyPairs_request() {}

void OAIListPlaybackKeyPairs_request::initializeModel() {
...
void OAIListPlaybackKeyPairs_request::fromJson(QString jsonString) {
...
void OAIListPlaybackKeyPairs_request::fromJsonObject(QJsonObject json) {
...
QString OAIListPlaybackKeyPairs_request::asJson() const {
...
QJsonObject OAIListPlaybackKeyPairs_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListPlaybackKeyPairs_request::getMaxResults() const {
    return m_max_results;
}
void OAIListPlaybackKeyPairs_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPlaybackKeyPairs_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPlaybackKeyPairs_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListPlaybackKeyPairs_request::getNextToken() const {
    return m_next_token;
}
void OAIListPlaybackKeyPairs_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPlaybackKeyPairs_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPlaybackKeyPairs_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPlaybackKeyPairs_request::isSet() const {
...
bool OAIListPlaybackKeyPairs_request::isValid() const {
