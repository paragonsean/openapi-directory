...
OAIChannelLatencyMode::OAIChannelLatencyMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelLatencyMode::OAIChannelLatencyMode() {
    this->initializeModel();
}

OAIChannelLatencyMode::~OAIChannelLatencyMode() {}

void OAIChannelLatencyMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChannelLatencyMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChannelLatencyMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NORMAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelLatencyMode::NORMAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelLatencyMode::LOW;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChannelLatencyMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChannelLatencyMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChannelLatencyMode::NORMAL:
            val = "NORMAL";
            break;
        case eOAIChannelLatencyMode::LOW:
            val = "LOW";
            break;
        default:
            break;
...
QJsonValue OAIChannelLatencyMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChannelLatencyMode::eOAIChannelLatencyMode OAIChannelLatencyMode::getValue() const {
    return m_value;
}

void OAIChannelLatencyMode::setValue(const OAIChannelLatencyMode::eOAIChannelLatencyMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChannelLatencyMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIChannelLatencyMode::isValid() const {
