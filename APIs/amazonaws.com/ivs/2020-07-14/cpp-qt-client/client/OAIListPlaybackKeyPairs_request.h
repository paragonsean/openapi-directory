...
/*
 * OAIListPlaybackKeyPairs_request.h
 *
 * 
 */

#ifndef OAIListPlaybackKeyPairs_request_H
#define OAIListPlaybackKeyPairs_request_H
...
class OAIListPlaybackKeyPairs_request : public OAIObject {
public:
    OAIListPlaybackKeyPairs_request();
    OAIListPlaybackKeyPairs_request(QString json);
    ~OAIListPlaybackKeyPairs_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPlaybackKeyPairs_request)

#endif // OAIListPlaybackKeyPairs_request_H
