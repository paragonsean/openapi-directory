...
OAIBatchStartViewerSessionRevocation_request::OAIBatchStartViewerSessionRevocation_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchStartViewerSessionRevocation_request::OAIBatchStartViewerSessionRevocation_request() {
    this->initializeModel();
}

OAIBatchStartViewerSessionRevocation_request::~OAIBatchStartViewerSessionRevocation_request() {}

void OAIBatchStartViewerSessionRevocation_request::initializeModel() {

    m_viewer_sessions_isSet = false;
    m_viewer_sessions_isValid = false;
}

void OAIBatchStartViewerSessionRevocation_request::fromJson(QString jsonString) {
...
void OAIBatchStartViewerSessionRevocation_request::fromJsonObject(QJsonObject json) {

    m_viewer_sessions_isValid = ::OpenAPI::fromJsonValue(m_viewer_sessions, json[QString("viewerSessions")]);
    m_viewer_sessions_isSet = !json[QString("viewerSessions")].isNull() && m_viewer_sessions_isValid;
}

QString OAIBatchStartViewerSessionRevocation_request::asJson() const {
...
QJsonObject OAIBatchStartViewerSessionRevocation_request::asJsonObject() const {
    QJsonObject obj;
    if (m_viewer_sessions.size() > 0) {
        obj.insert(QString("viewerSessions"), ::OpenAPI::toJsonValue(m_viewer_sessions));
    }
    return obj;
}

QList<OAIBatchStartViewerSessionRevocationViewerSession> OAIBatchStartViewerSessionRevocation_request::getViewerSessions() const {
    return m_viewer_sessions;
}
void OAIBatchStartViewerSessionRevocation_request::setViewerSessions(const QList<OAIBatchStartViewerSessionRevocationViewerSession> &viewer_sessions) {
    m_viewer_sessions = viewer_sessions;
    m_viewer_sessions_isSet = true;
}

bool OAIBatchStartViewerSessionRevocation_request::is_viewer_sessions_Set() const{
    return m_viewer_sessions_isSet;
}

bool OAIBatchStartViewerSessionRevocation_request::is_viewer_sessions_Valid() const{
    return m_viewer_sessions_isValid;
}

bool OAIBatchStartViewerSessionRevocation_request::isSet() const {
...
bool OAIBatchStartViewerSessionRevocation_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_viewer_sessions_isValid && true;
}
