...
QString OAIUpdateChannelRequest::getArn() const {
    return m_arn;
}
void OAIUpdateChannelRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateChannelRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateChannelRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIUpdateChannelRequest::getAuthorized() const {
    return m_authorized;
}
void OAIUpdateChannelRequest::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAIUpdateChannelRequest::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAIUpdateChannelRequest::is_authorized_Valid() const{
    return m_authorized_isValid;
}

bool OAIUpdateChannelRequest::getInsecureIngest() const {
    return m_insecure_ingest;
}
void OAIUpdateChannelRequest::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAIUpdateChannelRequest::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAIUpdateChannelRequest::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

OAIChannelLatencyMode OAIUpdateChannelRequest::getLatencyMode() const {
    return m_latency_mode;
}
void OAIUpdateChannelRequest::setLatencyMode(const OAIChannelLatencyMode &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAIUpdateChannelRequest::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAIUpdateChannelRequest::is_latency_mode_Valid() const{
...
OAITranscodePreset OAIUpdateChannelRequest::getPreset() const {
    return m_preset;
}
void OAIUpdateChannelRequest::setPreset(const OAITranscodePreset &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIUpdateChannelRequest::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIUpdateChannelRequest::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIUpdateChannelRequest::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAIUpdateChannelRequest::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAIUpdateChannelRequest::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAIUpdateChannelRequest::is_recording_configuration_arn_Valid() const{
    return m_recording_configuration_arn_isValid;
}

OAIChannelType OAIUpdateChannelRequest::getType() const {
    return m_type;
}
void OAIUpdateChannelRequest::setType(const OAIChannelType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateChannelRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateChannelRequest::is_type_Valid() const{
