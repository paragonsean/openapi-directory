...
#include "OAIIngestConfiguration.h"
...
OAIIngestConfiguration::OAIIngestConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIngestConfiguration::OAIIngestConfiguration() {
    this->initializeModel();
}

OAIIngestConfiguration::~OAIIngestConfiguration() {}

void OAIIngestConfiguration::initializeModel() {
...
void OAIIngestConfiguration::fromJson(QString jsonString) {
...
void OAIIngestConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIIngestConfiguration::asJson() const {
...
QJsonObject OAIIngestConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_audio.isSet()) {
...
OAIIngestConfiguration_audio OAIIngestConfiguration::getAudio() const {
    return m_audio;
}
void OAIIngestConfiguration::setAudio(const OAIIngestConfiguration_audio &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIIngestConfiguration::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIIngestConfiguration::is_audio_Valid() const{
    return m_audio_isValid;
}

OAIIngestConfiguration_video OAIIngestConfiguration::getVideo() const {
    return m_video;
}
void OAIIngestConfiguration::setVideo(const OAIIngestConfiguration_video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIIngestConfiguration::is_video_Set() const{
    return m_video_isSet;
}

bool OAIIngestConfiguration::is_video_Valid() const{
    return m_video_isValid;
}

bool OAIIngestConfiguration::isSet() const {
...
bool OAIIngestConfiguration::isValid() const {
