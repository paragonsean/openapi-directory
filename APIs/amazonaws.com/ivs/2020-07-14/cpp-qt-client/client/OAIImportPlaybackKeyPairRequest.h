...
/*
 * OAIImportPlaybackKeyPairRequest.h
 *
 * 
 */

#ifndef OAIImportPlaybackKeyPairRequest_H
#define OAIImportPlaybackKeyPairRequest_H
...
class OAIImportPlaybackKeyPairRequest : public OAIObject {
public:
    OAIImportPlaybackKeyPairRequest();
    OAIImportPlaybackKeyPairRequest(QString json);
    ~OAIImportPlaybackKeyPairRequest() override;
    ...
    QString getPublicKeyMaterial() const;
    void setPublicKeyMaterial(const QString &public_key_material);
    bool is_public_key_material_Set() const;
    bool is_public_key_material_Valid() const;
...
private:
    ...
    QString m_public_key_material;
    bool m_public_key_material_isSet;
    bool m_public_key_material_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportPlaybackKeyPairRequest)

#endif // OAIImportPlaybackKeyPairRequest_H
