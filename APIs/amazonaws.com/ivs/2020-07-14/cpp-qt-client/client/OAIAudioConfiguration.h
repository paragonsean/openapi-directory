...
#ifndef OAIAudioConfiguration_H
#define OAIAudioConfiguration_H
...
class OAIAudioConfiguration : public OAIObject {
public:
    OAIAudioConfiguration();
    OAIAudioConfiguration(QString json);
    ~OAIAudioConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudioConfiguration)

#endif // OAIAudioConfiguration_H
