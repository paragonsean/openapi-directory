...
/*
 * OAIIngestConfiguration_audio.h
 *
 * 
 */

#ifndef OAIIngestConfiguration_audio_H
#define OAIIngestConfiguration_audio_H
...
class OAIIngestConfiguration_audio : public OAIObject {
public:
    OAIIngestConfiguration_audio();
    OAIIngestConfiguration_audio(QString json);
    ~OAIIngestConfiguration_audio() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngestConfiguration_audio)

#endif // OAIIngestConfiguration_audio_H
