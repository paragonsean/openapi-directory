...
/*
 * OAIListStreamKeysResponse.h
 *
 * 
 */

#ifndef OAIListStreamKeysResponse_H
#define OAIListStreamKeysResponse_H
...
class OAIListStreamKeysResponse : public OAIObject {
public:
    OAIListStreamKeysResponse();
    OAIListStreamKeysResponse(QString json);
    ~OAIListStreamKeysResponse() override;
    ...
    QList getStreamKeys() const;
    void setStreamKeys(const QList &stream_keys);
    bool is_stream_keys_Set() const;
    bool is_stream_keys_Valid() const;
...
private:
    ...
    QList m_stream_keys;
    bool m_stream_keys_isSet;
    bool m_stream_keys_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListStreamKeysResponse)

#endif // OAIListStreamKeysResponse_H
