...
#include "OAIListPlaybackKeyPairsRequest.h"
...
OAIListPlaybackKeyPairsRequest::OAIListPlaybackKeyPairsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPlaybackKeyPairsRequest::OAIListPlaybackKeyPairsRequest() {
    this->initializeModel();
}

OAIListPlaybackKeyPairsRequest::~OAIListPlaybackKeyPairsRequest() {}

void OAIListPlaybackKeyPairsRequest::initializeModel() {
...
void OAIListPlaybackKeyPairsRequest::fromJson(QString jsonString) {
...
void OAIListPlaybackKeyPairsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListPlaybackKeyPairsRequest::asJson() const {
...
QJsonObject OAIListPlaybackKeyPairsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListPlaybackKeyPairsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListPlaybackKeyPairsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPlaybackKeyPairsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPlaybackKeyPairsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListPlaybackKeyPairsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListPlaybackKeyPairsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPlaybackKeyPairsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPlaybackKeyPairsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPlaybackKeyPairsRequest::isSet() const {
...
bool OAIListPlaybackKeyPairsRequest::isValid() const {
