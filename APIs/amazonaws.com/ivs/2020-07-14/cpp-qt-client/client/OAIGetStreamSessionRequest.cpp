...
#include "OAIGetStreamSessionRequest.h"
...
OAIGetStreamSessionRequest::OAIGetStreamSessionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamSessionRequest::OAIGetStreamSessionRequest() {
    this->initializeModel();
}

OAIGetStreamSessionRequest::~OAIGetStreamSessionRequest() {}

void OAIGetStreamSessionRequest::initializeModel() {
...
void OAIGetStreamSessionRequest::fromJson(QString jsonString) {
...
void OAIGetStreamSessionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamSessionRequest::asJson() const {
...
QJsonObject OAIGetStreamSessionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStreamSessionRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStreamSessionRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStreamSessionRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStreamSessionRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIGetStreamSessionRequest::getStreamId() const {
    return m_stream_id;
}
void OAIGetStreamSessionRequest::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIGetStreamSessionRequest::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIGetStreamSessionRequest::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

bool OAIGetStreamSessionRequest::isSet() const {
...
bool OAIGetStreamSessionRequest::isValid() const {
