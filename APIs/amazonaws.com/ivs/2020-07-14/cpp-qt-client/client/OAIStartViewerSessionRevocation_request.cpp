...
OAIStartViewerSessionRevocation_request::OAIStartViewerSessionRevocation_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartViewerSessionRevocation_request::OAIStartViewerSessionRevocation_request() {
    this->initializeModel();
}

OAIStartViewerSessionRevocation_request::~OAIStartViewerSessionRevocation_request() {}

void OAIStartViewerSessionRevocation_request::initializeModel() {
...
void OAIStartViewerSessionRevocation_request::fromJson(QString jsonString) {
...
void OAIStartViewerSessionRevocation_request::fromJsonObject(QJsonObject json) {
...
QString OAIStartViewerSessionRevocation_request::asJson() const {
...
QJsonObject OAIStartViewerSessionRevocation_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartViewerSessionRevocation_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIStartViewerSessionRevocation_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStartViewerSessionRevocation_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStartViewerSessionRevocation_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIStartViewerSessionRevocation_request::getViewerId() const {
    return m_viewer_id;
}
void OAIStartViewerSessionRevocation_request::setViewerId(const QString &viewer_id) {
    m_viewer_id = viewer_id;
    m_viewer_id_isSet = true;
}

bool OAIStartViewerSessionRevocation_request::is_viewer_id_Set() const{
    return m_viewer_id_isSet;
}

bool OAIStartViewerSessionRevocation_request::is_viewer_id_Valid() const{
    return m_viewer_id_isValid;
}

qint32 OAIStartViewerSessionRevocation_request::getViewerSessionVersionsLessThanOrEqualTo() const {
    return m_viewer_session_versions_less_than_or_equal_to;
}
void OAIStartViewerSessionRevocation_request::setViewerSessionVersionsLessThanOrEqualTo(const qint32 &viewer_session_versions_less_than_or_equal_to) {
...
bool OAIStartViewerSessionRevocation_request::is_viewer_session_versions_less_than_or_equal_to_Set() const{
    return m_viewer_session_versions_less_than_or_equal_to_isSet;
}

bool OAIStartViewerSessionRevocation_request::is_viewer_session_versions_less_than_or_equal_to_Valid() const{
    return m_viewer_session_versions_less_than_or_equal_to_isValid;
}

bool OAIStartViewerSessionRevocation_request::isSet() const {
...
bool OAIStartViewerSessionRevocation_request::isValid() const {
