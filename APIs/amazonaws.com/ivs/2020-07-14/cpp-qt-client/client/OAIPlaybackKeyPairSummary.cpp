...
#include "OAIPlaybackKeyPairSummary.h"
...
OAIPlaybackKeyPairSummary::OAIPlaybackKeyPairSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlaybackKeyPairSummary::OAIPlaybackKeyPairSummary() {
    this->initializeModel();
}

OAIPlaybackKeyPairSummary::~OAIPlaybackKeyPairSummary() {}

void OAIPlaybackKeyPairSummary::initializeModel() {
...
void OAIPlaybackKeyPairSummary::fromJson(QString jsonString) {
...
void OAIPlaybackKeyPairSummary::fromJsonObject(QJsonObject json) {
...
QString OAIPlaybackKeyPairSummary::asJson() const {
...
QJsonObject OAIPlaybackKeyPairSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIPlaybackKeyPairSummary::getArn() const {
    return m_arn;
}
void OAIPlaybackKeyPairSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIPlaybackKeyPairSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIPlaybackKeyPairSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIPlaybackKeyPairSummary::getName() const {
    return m_name;
}
void OAIPlaybackKeyPairSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPlaybackKeyPairSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPlaybackKeyPairSummary::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIPlaybackKeyPairSummary::getTags() const {
    return m_tags;
}
void OAIPlaybackKeyPairSummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPlaybackKeyPairSummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPlaybackKeyPairSummary::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIPlaybackKeyPairSummary::isSet() const {
...
bool OAIPlaybackKeyPairSummary::isValid() const {
