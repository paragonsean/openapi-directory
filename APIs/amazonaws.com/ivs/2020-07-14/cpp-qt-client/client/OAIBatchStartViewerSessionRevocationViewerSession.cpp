...
#include "OAIBatchStartViewerSessionRevocationViewerSession.h"
...
OAIBatchStartViewerSessionRevocationViewerSession::OAIBatchStartViewerSessionRevocationViewerSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchStartViewerSessionRevocationViewerSession::OAIBatchStartViewerSessionRevocationViewerSession() {
    this->initializeModel();
}

OAIBatchStartViewerSessionRevocationViewerSession::~OAIBatchStartViewerSessionRevocationViewerSession() {}

void OAIBatchStartViewerSessionRevocationViewerSession::initializeModel() {
    ...
    m_viewer_session_versions_less_than_or_equal_to_isSet = false;
    m_viewer_session_versions_less_than_or_equal_to_isValid = false;
}

void OAIBatchStartViewerSessionRevocationViewerSession::fromJson(QString jsonString) {
...
void OAIBatchStartViewerSessionRevocationViewerSession::fromJsonObject(QJsonObject json) {
    ...
    m_viewer_session_versions_less_than_or_equal_to_isValid = ::OpenAPI::fromJsonValue(m_viewer_session_versions_less_than_or_equal_to, json[QString("viewerSessionVersionsLessThanOrEqualTo")]);
    m_viewer_session_versions_less_than_or_equal_to_isSet = !json[QString("viewerSessionVersionsLessThanOrEqualTo")].isNull() && m_viewer_session_versions_less_than_or_equal_to_isValid;
}

QString OAIBatchStartViewerSessionRevocationViewerSession::asJson() const {
...
QJsonObject OAIBatchStartViewerSessionRevocationViewerSession::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_viewer_session_versions_less_than_or_equal_to_isSet) {
        obj.insert(QString("viewerSessionVersionsLessThanOrEqualTo"), ::OpenAPI::toJsonValue(m_viewer_session_versions_less_than_or_equal_to));
    }
    return obj;
}

QString OAIBatchStartViewerSessionRevocationViewerSession::getChannelArn() const {
    return m_channel_arn;
}
void OAIBatchStartViewerSessionRevocationViewerSession::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIBatchStartViewerSessionRevocationViewerSession::getViewerId() const {
    return m_viewer_id;
}
void OAIBatchStartViewerSessionRevocationViewerSession::setViewerId(const QString &viewer_id) {
    m_viewer_id = viewer_id;
    m_viewer_id_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_viewer_id_Set() const{
    return m_viewer_id_isSet;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_viewer_id_Valid() const{
    return m_viewer_id_isValid;
}

qint32 OAIBatchStartViewerSessionRevocationViewerSession::getViewerSessionVersionsLessThanOrEqualTo() const {
    return m_viewer_session_versions_less_than_or_equal_to;
}
void OAIBatchStartViewerSessionRevocationViewerSession::setViewerSessionVersionsLessThanOrEqualTo(const qint32 &viewer_session_versions_less_than_or_equal_to) {
    m_viewer_session_versions_less_than_or_equal_to = viewer_session_versions_less_than_or_equal_to;
    m_viewer_session_versions_less_than_or_equal_to_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_viewer_session_versions_less_than_or_equal_to_Set() const{
    return m_viewer_session_versions_less_than_or_equal_to_isSet;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::is_viewer_session_versions_less_than_or_equal_to_Valid() const{
    return m_viewer_session_versions_less_than_or_equal_to_isValid;
}

bool OAIBatchStartViewerSessionRevocationViewerSession::isSet() const {
...
bool OAIBatchStartViewerSessionRevocationViewerSession::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_channel_arn_isValid && m_viewer_id_isValid && true;
}
