...
#include "OAIImportPlaybackKeyPairResponse_keyPair.h"
...
OAIImportPlaybackKeyPairResponse_keyPair::OAIImportPlaybackKeyPairResponse_keyPair(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportPlaybackKeyPairResponse_keyPair::OAIImportPlaybackKeyPairResponse_keyPair() {
    this->initializeModel();
}

OAIImportPlaybackKeyPairResponse_keyPair::~OAIImportPlaybackKeyPairResponse_keyPair() {}

void OAIImportPlaybackKeyPairResponse_keyPair::initializeModel() {
...
void OAIImportPlaybackKeyPairResponse_keyPair::fromJson(QString jsonString) {
...
void OAIImportPlaybackKeyPairResponse_keyPair::fromJsonObject(QJsonObject json) {
...
QString OAIImportPlaybackKeyPairResponse_keyPair::asJson() const {
...
QJsonObject OAIImportPlaybackKeyPairResponse_keyPair::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIImportPlaybackKeyPairResponse_keyPair::getArn() const {
    return m_arn;
}
void OAIImportPlaybackKeyPairResponse_keyPair::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIImportPlaybackKeyPairResponse_keyPair::getFingerprint() const {
    return m_fingerprint;
}
void OAIImportPlaybackKeyPairResponse_keyPair::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QString OAIImportPlaybackKeyPairResponse_keyPair::getName() const {
    return m_name;
}
void OAIImportPlaybackKeyPairResponse_keyPair::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIImportPlaybackKeyPairResponse_keyPair::getTags() const {
    return m_tags;
}
void OAIImportPlaybackKeyPairResponse_keyPair::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIImportPlaybackKeyPairResponse_keyPair::isSet() const {
...
bool OAIImportPlaybackKeyPairResponse_keyPair::isValid() const {
