...
#include "OAIBatchGetChannelRequest.h"
...
OAIBatchGetChannelRequest::OAIBatchGetChannelRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetChannelRequest::OAIBatchGetChannelRequest() {
    this->initializeModel();
}

OAIBatchGetChannelRequest::~OAIBatchGetChannelRequest() {}

void OAIBatchGetChannelRequest::initializeModel() {

    m_arns_isSet = false;
    m_arns_isValid = false;
}

void OAIBatchGetChannelRequest::fromJson(QString jsonString) {
...
QJsonObject OAIBatchGetChannelRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arns.isSet()) {
...
QList OAIBatchGetChannelRequest::getArns() const {
    return m_arns;
}
void OAIBatchGetChannelRequest::setArns(const QList &arns) {
    m_arns = arns;
    m_arns_isSet = true;
}

bool OAIBatchGetChannelRequest::is_arns_Set() const{
    return m_arns_isSet;
}

bool OAIBatchGetChannelRequest::is_arns_Valid() const{
    return m_arns_isValid;
}

bool OAIBatchGetChannelRequest::isSet() const {
...
bool OAIBatchGetChannelRequest::isValid() const {
