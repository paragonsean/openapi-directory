...
#include "OAIListStreams_request_filterBy.h"
...
OAIListStreams_request_filterBy::OAIListStreams_request_filterBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreams_request_filterBy::OAIListStreams_request_filterBy() {
    this->initializeModel();
}

OAIListStreams_request_filterBy::~OAIListStreams_request_filterBy() {}

void OAIListStreams_request_filterBy::initializeModel() {

    m_health_isSet = false;
    m_health_isValid = false;
}

void OAIListStreams_request_filterBy::fromJson(QString jsonString) {
...
void OAIListStreams_request_filterBy::fromJsonObject(QJsonObject json) {
...
QString OAIListStreams_request_filterBy::asJson() const {
...
QJsonObject OAIListStreams_request_filterBy::asJsonObject() const {
    QJsonObject obj;
    if (m_health.isSet()) {
...
OAIStreamHealth OAIListStreams_request_filterBy::getHealth() const {
    return m_health;
}
void OAIListStreams_request_filterBy::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIListStreams_request_filterBy::is_health_Set() const{
    return m_health_isSet;
}

bool OAIListStreams_request_filterBy::is_health_Valid() const{
    return m_health_isValid;
}

bool OAIListStreams_request_filterBy::isSet() const {
...
bool OAIListStreams_request_filterBy::isValid() const {
