...
#include "OAIStreamSession_ingestConfiguration.h"
...
OAIStreamSession_ingestConfiguration::OAIStreamSession_ingestConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSession_ingestConfiguration::OAIStreamSession_ingestConfiguration() {
    this->initializeModel();
}

OAIStreamSession_ingestConfiguration::~OAIStreamSession_ingestConfiguration() {}

void OAIStreamSession_ingestConfiguration::initializeModel() {
...
void OAIStreamSession_ingestConfiguration::fromJson(QString jsonString) {
...
void OAIStreamSession_ingestConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIStreamSession_ingestConfiguration::asJson() const {
...
QJsonObject OAIStreamSession_ingestConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_audio.isSet()) {
...
OAIIngestConfiguration_audio OAIStreamSession_ingestConfiguration::getAudio() const {
    return m_audio;
}
void OAIStreamSession_ingestConfiguration::setAudio(const OAIIngestConfiguration_audio &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIStreamSession_ingestConfiguration::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIStreamSession_ingestConfiguration::is_audio_Valid() const{
    return m_audio_isValid;
}

OAIIngestConfiguration_video OAIStreamSession_ingestConfiguration::getVideo() const {
    return m_video;
}
void OAIStreamSession_ingestConfiguration::setVideo(const OAIIngestConfiguration_video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStreamSession_ingestConfiguration::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStreamSession_ingestConfiguration::is_video_Valid() const{
    return m_video_isValid;
}

bool OAIStreamSession_ingestConfiguration::isSet() const {
...
bool OAIStreamSession_ingestConfiguration::isValid() const {
