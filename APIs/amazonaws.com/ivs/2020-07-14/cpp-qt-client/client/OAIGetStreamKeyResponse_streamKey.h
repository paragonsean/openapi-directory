...
/*
 * OAIGetStreamKeyResponse_streamKey.h
 *
 * 
 */

#ifndef OAIGetStreamKeyResponse_streamKey_H
#define OAIGetStreamKeyResponse_streamKey_H
...
class OAIGetStreamKeyResponse_streamKey : public OAIObject {
public:
    OAIGetStreamKeyResponse_streamKey();
    OAIGetStreamKeyResponse_streamKey(QString json);
    ~OAIGetStreamKeyResponse_streamKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStreamKeyResponse_streamKey)

#endif // OAIGetStreamKeyResponse_streamKey_H
