...
OAIStreamHealth::OAIStreamHealth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamHealth::OAIStreamHealth() {
    this->initializeModel();
}

OAIStreamHealth::~OAIStreamHealth() {}

void OAIStreamHealth::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStreamHealth::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStreamHealth::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HEALTHY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamHealth::HEALTHY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STARVING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamHealth::STARVING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamHealth::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStreamHealth::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStreamHealth::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStreamHealth::HEALTHY:
            val = "HEALTHY";
            break;
        case eOAIStreamHealth::STARVING:
            val = "STARVING";
            break;
        case eOAIStreamHealth::UNKNOWN:
            val = "UNKNOWN";
            break;
        default:
            break;
...
QJsonValue OAIStreamHealth::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStreamHealth::eOAIStreamHealth OAIStreamHealth::getValue() const {
    return m_value;
}

void OAIStreamHealth::setValue(const OAIStreamHealth::eOAIStreamHealth& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStreamHealth::isSet() const {
    
    return m_value_isSet;
}

bool OAIStreamHealth::isValid() const {
