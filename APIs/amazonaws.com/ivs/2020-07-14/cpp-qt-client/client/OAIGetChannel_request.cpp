...
OAIGetChannel_request::OAIGetChannel_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetChannel_request::OAIGetChannel_request() {
    this->initializeModel();
}

OAIGetChannel_request::~OAIGetChannel_request() {}

void OAIGetChannel_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetChannel_request::fromJson(QString jsonString) {
...
void OAIGetChannel_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetChannel_request::asJson() const {
...
QJsonObject OAIGetChannel_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetChannel_request::getArn() const {
    return m_arn;
}
void OAIGetChannel_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetChannel_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetChannel_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetChannel_request::isSet() const {
...
bool OAIGetChannel_request::isValid() const {
