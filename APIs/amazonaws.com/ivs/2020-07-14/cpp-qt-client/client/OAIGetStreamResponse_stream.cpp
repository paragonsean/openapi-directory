...
#include "OAIGetStreamResponse_stream.h"
...
OAIGetStreamResponse_stream::OAIGetStreamResponse_stream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamResponse_stream::OAIGetStreamResponse_stream() {
    this->initializeModel();
}

OAIGetStreamResponse_stream::~OAIGetStreamResponse_stream() {}

void OAIGetStreamResponse_stream::initializeModel() {
...
void OAIGetStreamResponse_stream::fromJson(QString jsonString) {
...
void OAIGetStreamResponse_stream::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamResponse_stream::asJson() const {
...
QJsonObject OAIGetStreamResponse_stream::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStreamResponse_stream::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStreamResponse_stream::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStreamResponse_stream::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStreamResponse_stream::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

OAIStreamHealth OAIGetStreamResponse_stream::getHealth() const {
    return m_health;
}
void OAIGetStreamResponse_stream::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIGetStreamResponse_stream::is_health_Set() const{
    return m_health_isSet;
}

bool OAIGetStreamResponse_stream::is_health_Valid() const{
    return m_health_isValid;
}

QString OAIGetStreamResponse_stream::getPlaybackUrl() const {
    return m_playback_url;
}
void OAIGetStreamResponse_stream::setPlaybackUrl(const QString &playback_url) {
    m_playback_url = playback_url;
    m_playback_url_isSet = true;
}

bool OAIGetStreamResponse_stream::is_playback_url_Set() const{
    return m_playback_url_isSet;
}

bool OAIGetStreamResponse_stream::is_playback_url_Valid() const{
    return m_playback_url_isValid;
}

QDateTime OAIGetStreamResponse_stream::getStartTime() const {
    return m_start_time;
}
void OAIGetStreamResponse_stream::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIGetStreamResponse_stream::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIGetStreamResponse_stream::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIStreamState OAIGetStreamResponse_stream::getState() const {
    return m_state;
}
void OAIGetStreamResponse_stream::setState(const OAIStreamState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIGetStreamResponse_stream::is_state_Set() const{
    return m_state_isSet;
}

bool OAIGetStreamResponse_stream::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIGetStreamResponse_stream::getStreamId() const {
    return m_stream_id;
}
void OAIGetStreamResponse_stream::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIGetStreamResponse_stream::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIGetStreamResponse_stream::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

qint32 OAIGetStreamResponse_stream::getViewerCount() const {
    return m_viewer_count;
}
void OAIGetStreamResponse_stream::setViewerCount(const qint32 &viewer_count) {
    m_viewer_count = viewer_count;
    m_viewer_count_isSet = true;
}

bool OAIGetStreamResponse_stream::is_viewer_count_Set() const{
    return m_viewer_count_isSet;
}

bool OAIGetStreamResponse_stream::is_viewer_count_Valid() const{
    return m_viewer_count_isValid;
}

bool OAIGetStreamResponse_stream::isSet() const {
...
bool OAIGetStreamResponse_stream::isValid() const {
