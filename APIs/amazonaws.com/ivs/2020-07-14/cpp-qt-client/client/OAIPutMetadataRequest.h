...
/*
 * OAIPutMetadataRequest.h
 *
 * 
 */

#ifndef OAIPutMetadataRequest_H
#define OAIPutMetadataRequest_H
...
class OAIPutMetadataRequest : public OAIObject {
public:
    OAIPutMetadataRequest();
    OAIPutMetadataRequest(QString json);
    ~OAIPutMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutMetadataRequest)

#endif // OAIPutMetadataRequest_H
