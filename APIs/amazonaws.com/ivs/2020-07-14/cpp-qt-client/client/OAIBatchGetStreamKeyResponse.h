...
/*
 * OAIBatchGetStreamKeyResponse.h
 *
 * 
 */

#ifndef OAIBatchGetStreamKeyResponse_H
#define OAIBatchGetStreamKeyResponse_H
...
class OAIBatchGetStreamKeyResponse : public OAIObject {
public:
    OAIBatchGetStreamKeyResponse();
    OAIBatchGetStreamKeyResponse(QString json);
    ~OAIBatchGetStreamKeyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetStreamKeyResponse)

#endif // OAIBatchGetStreamKeyResponse_H
