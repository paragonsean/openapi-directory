...
/*
 * OAIPlaybackKeyPair.h
 *
 * A key pair used to sign and validate a playback authorization token.
 */

#ifndef OAIPlaybackKeyPair_H
#define OAIPlaybackKeyPair_H
...
class OAIPlaybackKeyPair : public OAIObject {
public:
    OAIPlaybackKeyPair();
    OAIPlaybackKeyPair(QString json);
    ~OAIPlaybackKeyPair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaybackKeyPair)

#endif // OAIPlaybackKeyPair_H
