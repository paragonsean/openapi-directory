...
OAIListStreamKeys_request::OAIListStreamKeys_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamKeys_request::OAIListStreamKeys_request() {
    this->initializeModel();
}

OAIListStreamKeys_request::~OAIListStreamKeys_request() {}

void OAIListStreamKeys_request::initializeModel() {
...
void OAIListStreamKeys_request::fromJson(QString jsonString) {
...
void OAIListStreamKeys_request::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamKeys_request::asJson() const {
...
QJsonObject OAIListStreamKeys_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStreamKeys_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIListStreamKeys_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIListStreamKeys_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIListStreamKeys_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

qint32 OAIListStreamKeys_request::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamKeys_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamKeys_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamKeys_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStreamKeys_request::getNextToken() const {
    return m_next_token;
}
void OAIListStreamKeys_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamKeys_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamKeys_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStreamKeys_request::isSet() const {
...
bool OAIListStreamKeys_request::isValid() const {
