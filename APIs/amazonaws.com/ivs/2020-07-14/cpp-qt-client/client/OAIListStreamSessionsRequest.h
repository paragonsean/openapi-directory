...
/*
 * OAIListStreamSessionsRequest.h
 *
 * 
 */

#ifndef OAIListStreamSessionsRequest_H
#define OAIListStreamSessionsRequest_H
...
class OAIListStreamSessionsRequest : public OAIObject {
public:
    OAIListStreamSessionsRequest();
    OAIListStreamSessionsRequest(QString json);
    ~OAIListStreamSessionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamSessionsRequest)

#endif // OAIListStreamSessionsRequest_H
