...
/*
 * OAICreateStreamKey_request.h
 *
 * 
 */

#ifndef OAICreateStreamKey_request_H
#define OAICreateStreamKey_request_H
...
class OAICreateStreamKey_request : public OAIObject {
public:
    OAICreateStreamKey_request();
    OAICreateStreamKey_request(QString json);
    ~OAICreateStreamKey_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamKey_request)

#endif // OAICreateStreamKey_request_H
