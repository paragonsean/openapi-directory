...
/*
 * OAICreateRecordingConfigurationResponse_recordingConfiguration.h
 *
 * 
 */

#ifndef OAICreateRecordingConfigurationResponse_recordingConfiguration_H
#define OAICreateRecordingConfigurationResponse_recordingConfiguration_H
...
class OAICreateRecordingConfigurationResponse_recordingConfiguration : public OAIObject {
public:
    OAICreateRecordingConfigurationResponse_recordingConfiguration();
    OAICreateRecordingConfigurationResponse_recordingConfiguration(QString json);
    ~OAICreateRecordingConfigurationResponse_recordingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRecordingConfigurationResponse_recordingConfiguration)

#endif // OAICreateRecordingConfigurationResponse_recordingConfiguration_H
