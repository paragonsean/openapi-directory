...
OAICreateStreamKeyResponse::OAICreateStreamKeyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamKeyResponse::OAICreateStreamKeyResponse() {
    this->initializeModel();
}

OAICreateStreamKeyResponse::~OAICreateStreamKeyResponse() {}

void OAICreateStreamKeyResponse::initializeModel() {

    m_stream_key_isSet = false;
    m_stream_key_isValid = false;
}

void OAICreateStreamKeyResponse::fromJson(QString jsonString) {
...
void OAICreateStreamKeyResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamKeyResponse::asJson() const {
...
QJsonObject OAICreateStreamKeyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_stream_key.isSet()) {
        obj.insert(QString("streamKey"), ::OpenAPI::toJsonValue(m_stream_key));
    }
    return obj;
}

OAICreateStreamKeyResponse_streamKey OAICreateStreamKeyResponse::getStreamKey() const {
    return m_stream_key;
}
void OAICreateStreamKeyResponse::setStreamKey(const OAICreateStreamKeyResponse_streamKey &stream_key) {
    m_stream_key = stream_key;
    m_stream_key_isSet = true;
}

bool OAICreateStreamKeyResponse::is_stream_key_Set() const{
    return m_stream_key_isSet;
}

bool OAICreateStreamKeyResponse::is_stream_key_Valid() const{
    return m_stream_key_isValid;
}

bool OAICreateStreamKeyResponse::isSet() const {
...
bool OAICreateStreamKeyResponse::isValid() const {
