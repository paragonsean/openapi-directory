...
OAITranscodePreset::OAITranscodePreset(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscodePreset::OAITranscodePreset() {
    this->initializeModel();
}

OAITranscodePreset::~OAITranscodePreset() {}

void OAITranscodePreset::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscodePreset::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscodePreset::fromJson(QString jsonString) {
    
    if ( jsonString.compare("HIGHER_BANDWIDTH_DELIVERY", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscodePreset::HIGHER_BANDWIDTH_DELIVERY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONSTRAINED_BANDWIDTH_DELIVERY", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscodePreset::CONSTRAINED_BANDWIDTH_DELIVERY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscodePreset::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscodePreset::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscodePreset::HIGHER_BANDWIDTH_DELIVERY:
            val = "HIGHER_BANDWIDTH_DELIVERY";
            break;
        case eOAITranscodePreset::CONSTRAINED_BANDWIDTH_DELIVERY:
            val = "CONSTRAINED_BANDWIDTH_DELIVERY";
            break;
        default:
            break;
    }
...
QJsonValue OAITranscodePreset::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscodePreset::eOAITranscodePreset OAITranscodePreset::getValue() const {
    return m_value;
}

void OAITranscodePreset::setValue(const OAITranscodePreset::eOAITranscodePreset& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscodePreset::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscodePreset::isValid() const {
