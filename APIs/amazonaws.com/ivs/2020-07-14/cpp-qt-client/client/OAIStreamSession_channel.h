...
/*
 * OAIStreamSession_channel.h
 *
 * 
 */

#ifndef OAIStreamSession_channel_H
#define OAIStreamSession_channel_H

#include <QJsonObject>

#include "OAIChannelLatencyMode.h"
#include "OAIChannelType.h"
#include "OAITranscodePreset.h"
#include <QMap>
#include <QString>
...
class OAIStreamSession_channel : public OAIObject {
public:
    OAIStreamSession_channel();
    OAIStreamSession_channel(QString json);
    ~OAIStreamSession_channel() override;
    ...
    QString getIngestEndpoint() const;
    void setIngestEndpoint(const QString &ingest_endpoint);
    bool is_ingest_endpoint_Set() const;
    bool is_ingest_endpoint_Valid() const;

    bool getInsecureIngest() const;
    void setInsecureIngest(const bool &insecure_ingest);
    bool is_insecure_ingest_Set() const;
    bool is_insecure_ingest_Valid() const;

    OAIChannelLatencyMode getLatencyMode() const;
    void setLatencyMode(const OAIChannelLatencyMode &latency_mode);
    ...
    OAITranscodePreset getPreset() const;
    void setPreset(const OAITranscodePreset &preset);
    bool is_preset_Set() const;
    bool is_preset_Valid() const;

    QString getRecordingConfigurationArn() const;
    void setRecordingConfigurationArn(const QString &recording_configuration_arn);
    bool is_recording_configuration_arn_Set() const;
    bool is_recording_configuration_arn_Valid() const;
...
private:
    ...
    QString m_ingest_endpoint;
    bool m_ingest_endpoint_isSet;
    bool m_ingest_endpoint_isValid;

    bool m_insecure_ingest;
    bool m_insecure_ingest_isSet;
    bool m_insecure_ingest_isValid;

    OAIChannelLatencyMode m_latency_mode;
    ...
    OAITranscodePreset m_preset;
    bool m_preset_isSet;
    bool m_preset_isValid;

    QString m_recording_configuration_arn;
    bool m_recording_configuration_arn_isSet;
    bool m_recording_configuration_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamSession_channel)

#endif // OAIStreamSession_channel_H
