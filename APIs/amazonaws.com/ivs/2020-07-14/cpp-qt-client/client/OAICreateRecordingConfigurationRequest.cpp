...
#include "OAICreateRecordingConfigurationRequest.h"
...
OAICreateRecordingConfigurationRequest::OAICreateRecordingConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationRequest::OAICreateRecordingConfigurationRequest() {
    this->initializeModel();
}

OAICreateRecordingConfigurationRequest::~OAICreateRecordingConfigurationRequest() {}

void OAICreateRecordingConfigurationRequest::initializeModel() {
    ...
    m_recording_reconnect_window_seconds_isSet = false;
    m_recording_reconnect_window_seconds_isValid = false;

    m_rendition_configuration_isSet = false;
    m_rendition_configuration_isValid = false;
...
void OAICreateRecordingConfigurationRequest::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationRequest::fromJsonObject(QJsonObject json) {
    ...
    m_recording_reconnect_window_seconds_isValid = ::OpenAPI::fromJsonValue(m_recording_reconnect_window_seconds, json[QString("recordingReconnectWindowSeconds")]);
    m_recording_reconnect_window_seconds_isSet = !json[QString("recordingReconnectWindowSeconds")].isNull() && m_recording_reconnect_window_seconds_isValid;

    m_rendition_configuration_isValid = ::OpenAPI::fromJsonValue(m_rendition_configuration, json[QString("renditionConfiguration")]);
    m_rendition_configuration_isSet = !json[QString("renditionConfiguration")].isNull() && m_rendition_configuration_isValid;
...
QString OAICreateRecordingConfigurationRequest::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_recording_reconnect_window_seconds_isSet) {
        obj.insert(QString("recordingReconnectWindowSeconds"), ::OpenAPI::toJsonValue(m_recording_reconnect_window_seconds));
    }
    if (m_rendition_configuration.isSet()) {
        obj.insert(QString("renditionConfiguration"), ::OpenAPI::toJsonValue(m_rendition_configuration));
    }
    if (m_tags.isSet()) {
...
OAICreateRecordingConfigurationRequest_destinationConfiguration OAICreateRecordingConfigurationRequest::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateRecordingConfigurationRequest::setDestinationConfiguration(const OAICreateRecordingConfigurationRequest_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateRecordingConfigurationRequest::getName() const {
    return m_name;
}
void OAICreateRecordingConfigurationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICreateRecordingConfigurationRequest::getRecordingReconnectWindowSeconds() const {
    return m_recording_reconnect_window_seconds;
}
void OAICreateRecordingConfigurationRequest::setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds) {
    m_recording_reconnect_window_seconds = recording_reconnect_window_seconds;
    m_recording_reconnect_window_seconds_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_recording_reconnect_window_seconds_Set() const{
    return m_recording_reconnect_window_seconds_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_recording_reconnect_window_seconds_Valid() const{
    return m_recording_reconnect_window_seconds_isValid;
}

OAICreateRecordingConfigurationRequest_renditionConfiguration OAICreateRecordingConfigurationRequest::getRenditionConfiguration() const {
    return m_rendition_configuration;
}
void OAICreateRecordingConfigurationRequest::setRenditionConfiguration(const OAICreateRecordingConfigurationRequest_renditionConfiguration &rendition_configuration) {
    m_rendition_configuration = rendition_configuration;
    m_rendition_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_rendition_configuration_Set() const{
    return m_rendition_configuration_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_rendition_configuration_Valid() const{
    return m_rendition_configuration_isValid;
}

QMap OAICreateRecordingConfigurationRequest::getTags() const {
    return m_tags;
}
void OAICreateRecordingConfigurationRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration OAICreateRecordingConfigurationRequest::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAICreateRecordingConfigurationRequest::setThumbnailConfiguration(const OAICreateRecordingConfigurationRequest_thumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationRequest::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAICreateRecordingConfigurationRequest::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAICreateRecordingConfigurationRequest::isSet() const {
...
bool OAICreateRecordingConfigurationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_destination_configuration_isValid && true;
}
