...
#include "OAICreateRecordingConfigurationRequest_renditionConfiguration.h"
...
OAICreateRecordingConfigurationRequest_renditionConfiguration::OAICreateRecordingConfigurationRequest_renditionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationRequest_renditionConfiguration::OAICreateRecordingConfigurationRequest_renditionConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfigurationRequest_renditionConfiguration::~OAICreateRecordingConfigurationRequest_renditionConfiguration() {}

void OAICreateRecordingConfigurationRequest_renditionConfiguration::initializeModel() {
...
void OAICreateRecordingConfigurationRequest_renditionConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationRequest_renditionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfigurationRequest_renditionConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationRequest_renditionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIRenditionConfigurationRenditionSelection OAICreateRecordingConfigurationRequest_renditionConfiguration::getRenditionSelection() const {
    return m_rendition_selection;
}
void OAICreateRecordingConfigurationRequest_renditionConfiguration::setRenditionSelection(const OAIRenditionConfigurationRenditionSelection &rendition_selection) {
    m_rendition_selection = rendition_selection;
    m_rendition_selection_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_renditionConfiguration::is_rendition_selection_Set() const{
    return m_rendition_selection_isSet;
}

bool OAICreateRecordingConfigurationRequest_renditionConfiguration::is_rendition_selection_Valid() const{
    return m_rendition_selection_isValid;
}

QList OAICreateRecordingConfigurationRequest_renditionConfiguration::getRenditions() const {
    return m_renditions;
}
void OAICreateRecordingConfigurationRequest_renditionConfiguration::setRenditions(const QList &renditions) {
    m_renditions = renditions;
    m_renditions_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_renditionConfiguration::is_renditions_Set() const{
    return m_renditions_isSet;
}

bool OAICreateRecordingConfigurationRequest_renditionConfiguration::is_renditions_Valid() const{
    return m_renditions_isValid;
}

bool OAICreateRecordingConfigurationRequest_renditionConfiguration::isSet() const {
...
bool OAICreateRecordingConfigurationRequest_renditionConfiguration::isValid() const {
