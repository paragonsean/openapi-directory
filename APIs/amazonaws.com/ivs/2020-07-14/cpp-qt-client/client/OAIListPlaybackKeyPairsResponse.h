...
/*
 * OAIListPlaybackKeyPairsResponse.h
 *
 * 
 */

#ifndef OAIListPlaybackKeyPairsResponse_H
#define OAIListPlaybackKeyPairsResponse_H
...
class OAIListPlaybackKeyPairsResponse : public OAIObject {
public:
    OAIListPlaybackKeyPairsResponse();
    OAIListPlaybackKeyPairsResponse(QString json);
    ~OAIListPlaybackKeyPairsResponse() override;
    ...
    QList getKeyPairs() const;
    void setKeyPairs(const QList &key_pairs);
    bool is_key_pairs_Set() const;
    bool is_key_pairs_Valid() const;
...
private:
    ...
    QList m_key_pairs;
    bool m_key_pairs_isSet;
    bool m_key_pairs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPlaybackKeyPairsResponse)

#endif // OAIListPlaybackKeyPairsResponse_H
