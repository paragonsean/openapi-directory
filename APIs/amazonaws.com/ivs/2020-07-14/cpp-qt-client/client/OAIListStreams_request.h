...
namespace OpenAPI {
class OAIListStreams_request_filterBy;
...
public:
    ...
    OAIListStreams_request_filterBy getFilterBy() const;
    void setFilterBy(const OAIListStreams_request_filterBy &filter_by);
...
private:
    ...
    OAIListStreams_request_filterBy m_filter_by;
