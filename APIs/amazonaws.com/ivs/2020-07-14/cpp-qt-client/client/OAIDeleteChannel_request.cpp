...
OAIDeleteChannel_request::OAIDeleteChannel_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteChannel_request::OAIDeleteChannel_request() {
    this->initializeModel();
}

OAIDeleteChannel_request::~OAIDeleteChannel_request() {}

void OAIDeleteChannel_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteChannel_request::fromJson(QString jsonString) {
...
void OAIDeleteChannel_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteChannel_request::asJson() const {
...
QJsonObject OAIDeleteChannel_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteChannel_request::getArn() const {
    return m_arn;
}
void OAIDeleteChannel_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteChannel_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteChannel_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteChannel_request::isSet() const {
...
bool OAIDeleteChannel_request::isValid() const {
