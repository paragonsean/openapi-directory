...
OAIGetStreamSession_request::OAIGetStreamSession_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamSession_request::OAIGetStreamSession_request() {
    this->initializeModel();
}

OAIGetStreamSession_request::~OAIGetStreamSession_request() {}

void OAIGetStreamSession_request::initializeModel() {
...
void OAIGetStreamSession_request::fromJson(QString jsonString) {
...
void OAIGetStreamSession_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamSession_request::asJson() const {
...
QJsonObject OAIGetStreamSession_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStreamSession_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStreamSession_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStreamSession_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStreamSession_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIGetStreamSession_request::getStreamId() const {
    return m_stream_id;
}
void OAIGetStreamSession_request::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIGetStreamSession_request::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIGetStreamSession_request::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

bool OAIGetStreamSession_request::isSet() const {
...
bool OAIGetStreamSession_request::isValid() const {
