...
#include "OAICreateStreamKeyRequest.h"
...
OAICreateStreamKeyRequest::OAICreateStreamKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamKeyRequest::OAICreateStreamKeyRequest() {
    this->initializeModel();
}

OAICreateStreamKeyRequest::~OAICreateStreamKeyRequest() {}

void OAICreateStreamKeyRequest::initializeModel() {
...
void OAICreateStreamKeyRequest::fromJson(QString jsonString) {
...
void OAICreateStreamKeyRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamKeyRequest::asJson() const {
...
QJsonObject OAICreateStreamKeyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateStreamKeyRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAICreateStreamKeyRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAICreateStreamKeyRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAICreateStreamKeyRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAICreateStreamKeyRequest::getTags() const {
    return m_tags;
}
void OAICreateStreamKeyRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateStreamKeyRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateStreamKeyRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateStreamKeyRequest::isSet() const {
...
bool OAICreateStreamKeyRequest::isValid() const {
