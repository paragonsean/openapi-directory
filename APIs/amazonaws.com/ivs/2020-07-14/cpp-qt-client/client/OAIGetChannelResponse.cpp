...
OAICreateChannelResponse_channel OAIGetChannelResponse::getChannel() const {
    return m_channel;
}
void OAIGetChannelResponse::setChannel(const OAICreateChannelResponse_channel &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIGetChannelResponse::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIGetChannelResponse::is_channel_Valid() const{
