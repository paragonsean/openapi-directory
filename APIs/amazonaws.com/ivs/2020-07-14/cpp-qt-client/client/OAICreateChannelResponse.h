...
class OAICreateChannelResponse_streamKey;
...
public:
    ...
    OAICreateChannelResponse_streamKey getStreamKey() const;
    void setStreamKey(const OAICreateChannelResponse_streamKey &stream_key);
...
private:
    ...
    OAICreateChannelResponse_streamKey m_stream_key;
