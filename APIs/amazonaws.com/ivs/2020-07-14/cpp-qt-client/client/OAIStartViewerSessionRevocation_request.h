...
/*
 * OAIStartViewerSessionRevocation_request.h
 *
 * 
 */

#ifndef OAIStartViewerSessionRevocation_request_H
#define OAIStartViewerSessionRevocation_request_H
...
class OAIStartViewerSessionRevocation_request : public OAIObject {
public:
    OAIStartViewerSessionRevocation_request();
    OAIStartViewerSessionRevocation_request(QString json);
    ~OAIStartViewerSessionRevocation_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartViewerSessionRevocation_request)

#endif // OAIStartViewerSessionRevocation_request_H
