...
/*
 * OAICreateChannelResponse_streamKey.h
 *
 * 
 */

#ifndef OAICreateChannelResponse_streamKey_H
#define OAICreateChannelResponse_streamKey_H
...
class OAICreateChannelResponse_streamKey : public OAIObject {
public:
    OAICreateChannelResponse_streamKey();
    OAICreateChannelResponse_streamKey(QString json);
    ~OAICreateChannelResponse_streamKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelResponse_streamKey)

#endif // OAICreateChannelResponse_streamKey_H
