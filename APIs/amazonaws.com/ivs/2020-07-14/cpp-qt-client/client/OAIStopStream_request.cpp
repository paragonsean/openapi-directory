...
OAIStopStream_request::OAIStopStream_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopStream_request::OAIStopStream_request() {
    this->initializeModel();
}

OAIStopStream_request::~OAIStopStream_request() {}

void OAIStopStream_request::initializeModel() {

    m_channel_arn_isSet = false;
    m_channel_arn_isValid = false;
}

void OAIStopStream_request::fromJson(QString jsonString) {
...
void OAIStopStream_request::fromJsonObject(QJsonObject json) {
...
QString OAIStopStream_request::asJson() const {
...
QJsonObject OAIStopStream_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopStream_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIStopStream_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStopStream_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStopStream_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

bool OAIStopStream_request::isSet() const {
...
bool OAIStopStream_request::isValid() const {
