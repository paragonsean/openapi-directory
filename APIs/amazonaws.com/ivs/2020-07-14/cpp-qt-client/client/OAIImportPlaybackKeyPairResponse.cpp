...
OAIImportPlaybackKeyPairResponse::OAIImportPlaybackKeyPairResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportPlaybackKeyPairResponse::OAIImportPlaybackKeyPairResponse() {
    this->initializeModel();
}

OAIImportPlaybackKeyPairResponse::~OAIImportPlaybackKeyPairResponse() {}

void OAIImportPlaybackKeyPairResponse::initializeModel() {

    m_key_pair_isSet = false;
    m_key_pair_isValid = false;
}

void OAIImportPlaybackKeyPairResponse::fromJson(QString jsonString) {
...
void OAIImportPlaybackKeyPairResponse::fromJsonObject(QJsonObject json) {
...
QString OAIImportPlaybackKeyPairResponse::asJson() const {
...
QJsonObject OAIImportPlaybackKeyPairResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_pair.isSet()) {
...
OAIImportPlaybackKeyPairResponse_keyPair OAIImportPlaybackKeyPairResponse::getKeyPair() const {
    return m_key_pair;
}
void OAIImportPlaybackKeyPairResponse::setKeyPair(const OAIImportPlaybackKeyPairResponse_keyPair &key_pair) {
    m_key_pair = key_pair;
    m_key_pair_isSet = true;
}

bool OAIImportPlaybackKeyPairResponse::is_key_pair_Set() const{
    return m_key_pair_isSet;
}

bool OAIImportPlaybackKeyPairResponse::is_key_pair_Valid() const{
    return m_key_pair_isValid;
}

bool OAIImportPlaybackKeyPairResponse::isSet() const {
...
bool OAIImportPlaybackKeyPairResponse::isValid() const {
