...
OAICreateRecordingConfiguration_request_destinationConfiguration::OAICreateRecordingConfiguration_request_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfiguration_request_destinationConfiguration::OAICreateRecordingConfiguration_request_destinationConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfiguration_request_destinationConfiguration::~OAICreateRecordingConfiguration_request_destinationConfiguration() {}

void OAICreateRecordingConfiguration_request_destinationConfiguration::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAICreateRecordingConfiguration_request_destinationConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfiguration_request_destinationConfiguration::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAICreateRecordingConfiguration_request_destinationConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfiguration_request_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAICreateRecordingConfiguration_request_destinationConfiguration_s3 OAICreateRecordingConfiguration_request_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAICreateRecordingConfiguration_request_destinationConfiguration::setS3(const OAICreateRecordingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration::isSet() const {
...
bool OAICreateRecordingConfiguration_request_destinationConfiguration::isValid() const {
