...
QString OAIUpdateChannel_request::getArn() const {
    return m_arn;
}
void OAIUpdateChannel_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateChannel_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateChannel_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIUpdateChannel_request::isAuthorized() const {
    return m_authorized;
}
void OAIUpdateChannel_request::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAIUpdateChannel_request::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAIUpdateChannel_request::is_authorized_Valid() const{
    return m_authorized_isValid;
}

bool OAIUpdateChannel_request::isInsecureIngest() const {
    return m_insecure_ingest;
}
void OAIUpdateChannel_request::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAIUpdateChannel_request::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAIUpdateChannel_request::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

QString OAIUpdateChannel_request::getLatencyMode() const {
    return m_latency_mode;
}
void OAIUpdateChannel_request::setLatencyMode(const QString &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAIUpdateChannel_request::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAIUpdateChannel_request::is_latency_mode_Valid() const{
...
QString OAIUpdateChannel_request::getPreset() const {
    return m_preset;
}
void OAIUpdateChannel_request::setPreset(const QString &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIUpdateChannel_request::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIUpdateChannel_request::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIUpdateChannel_request::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAIUpdateChannel_request::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAIUpdateChannel_request::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAIUpdateChannel_request::is_recording_configuration_arn_Valid() const{
    return m_recording_configuration_arn_isValid;
}

QString OAIUpdateChannel_request::getType() const {
    return m_type;
}
void OAIUpdateChannel_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateChannel_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateChannel_request::is_type_Valid() const{
