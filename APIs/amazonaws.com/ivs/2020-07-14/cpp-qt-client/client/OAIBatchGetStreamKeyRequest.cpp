...
#include "OAIBatchGetStreamKeyRequest.h"
...
OAIBatchGetStreamKeyRequest::OAIBatchGetStreamKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetStreamKeyRequest::OAIBatchGetStreamKeyRequest() {
    this->initializeModel();
}

OAIBatchGetStreamKeyRequest::~OAIBatchGetStreamKeyRequest() {}

void OAIBatchGetStreamKeyRequest::initializeModel() {

    m_arns_isSet = false;
    m_arns_isValid = false;
}

void OAIBatchGetStreamKeyRequest::fromJson(QString jsonString) {
...
QJsonObject OAIBatchGetStreamKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arns.isSet()) {
...
QList OAIBatchGetStreamKeyRequest::getArns() const {
    return m_arns;
}
void OAIBatchGetStreamKeyRequest::setArns(const QList &arns) {
    m_arns = arns;
    m_arns_isSet = true;
}

bool OAIBatchGetStreamKeyRequest::is_arns_Set() const{
    return m_arns_isSet;
}

bool OAIBatchGetStreamKeyRequest::is_arns_Valid() const{
    return m_arns_isValid;
}

bool OAIBatchGetStreamKeyRequest::isSet() const {
...
bool OAIBatchGetStreamKeyRequest::isValid() const {
