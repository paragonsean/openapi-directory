...
#include "OAIStreamSessionSummary.h"
...
OAIStreamSessionSummary::OAIStreamSessionSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSessionSummary::OAIStreamSessionSummary() {
    this->initializeModel();
}

OAIStreamSessionSummary::~OAIStreamSessionSummary() {}

void OAIStreamSessionSummary::initializeModel() {

    m_end_time_isSet = false;
    m_end_time_isValid = false;

    m_has_error_event_isSet = false;
    m_has_error_event_isValid = false;
...
void OAIStreamSessionSummary::fromJson(QString jsonString) {
...
void OAIStreamSessionSummary::fromJsonObject(QJsonObject json) {

    m_end_time_isValid = ::OpenAPI::fromJsonValue(m_end_time, json[QString("endTime")]);
    m_end_time_isSet = !json[QString("endTime")].isNull() && m_end_time_isValid;

    m_has_error_event_isValid = ::OpenAPI::fromJsonValue(m_has_error_event, json[QString("hasErrorEvent")]);
    m_has_error_event_isSet = !json[QString("hasErrorEvent")].isNull() && m_has_error_event_isValid;
...
QString OAIStreamSessionSummary::asJson() const {
...
QJsonObject OAIStreamSessionSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_end_time_isSet) {
        obj.insert(QString("endTime"), ::OpenAPI::toJsonValue(m_end_time));
    }
    if (m_has_error_event_isSet) {
        obj.insert(QString("hasErrorEvent"), ::OpenAPI::toJsonValue(m_has_error_event));
    }
...
QDateTime OAIStreamSessionSummary::getEndTime() const {
    return m_end_time;
}
void OAIStreamSessionSummary::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIStreamSessionSummary::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIStreamSessionSummary::is_end_time_Valid() const{
    return m_end_time_isValid;
}

bool OAIStreamSessionSummary::getHasErrorEvent() const {
    return m_has_error_event;
}
void OAIStreamSessionSummary::setHasErrorEvent(const bool &has_error_event) {
    m_has_error_event = has_error_event;
    m_has_error_event_isSet = true;
}

bool OAIStreamSessionSummary::is_has_error_event_Set() const{
    return m_has_error_event_isSet;
}

bool OAIStreamSessionSummary::is_has_error_event_Valid() const{
    return m_has_error_event_isValid;
}

QDateTime OAIStreamSessionSummary::getStartTime() const {
    return m_start_time;
}
void OAIStreamSessionSummary::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStreamSessionSummary::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStreamSessionSummary::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIStreamSessionSummary::getStreamId() const {
    return m_stream_id;
}
void OAIStreamSessionSummary::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIStreamSessionSummary::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIStreamSessionSummary::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

bool OAIStreamSessionSummary::isSet() const {
...
bool OAIStreamSessionSummary::isValid() const {
