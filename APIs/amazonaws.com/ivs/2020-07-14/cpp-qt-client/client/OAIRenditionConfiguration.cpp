...
#include "OAIRenditionConfiguration.h"
...
OAIRenditionConfiguration::OAIRenditionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRenditionConfiguration::OAIRenditionConfiguration() {
    this->initializeModel();
}

OAIRenditionConfiguration::~OAIRenditionConfiguration() {}

void OAIRenditionConfiguration::initializeModel() {
...
void OAIRenditionConfiguration::fromJson(QString jsonString) {
...
void OAIRenditionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRenditionConfiguration::asJson() const {
...
QJsonObject OAIRenditionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIRenditionConfigurationRenditionSelection OAIRenditionConfiguration::getRenditionSelection() const {
    return m_rendition_selection;
}
void OAIRenditionConfiguration::setRenditionSelection(const OAIRenditionConfigurationRenditionSelection &rendition_selection) {
    m_rendition_selection = rendition_selection;
    m_rendition_selection_isSet = true;
}

bool OAIRenditionConfiguration::is_rendition_selection_Set() const{
    return m_rendition_selection_isSet;
}

bool OAIRenditionConfiguration::is_rendition_selection_Valid() const{
    return m_rendition_selection_isValid;
}

QList OAIRenditionConfiguration::getRenditions() const {
    return m_renditions;
}
void OAIRenditionConfiguration::setRenditions(const QList &renditions) {
    m_renditions = renditions;
    m_renditions_isSet = true;
}

bool OAIRenditionConfiguration::is_renditions_Set() const{
    return m_renditions_isSet;
}

bool OAIRenditionConfiguration::is_renditions_Valid() const{
    return m_renditions_isValid;
}

bool OAIRenditionConfiguration::isSet() const {
...
bool OAIRenditionConfiguration::isValid() const {
