...
OAIListRecordingConfigurations_request::OAIListRecordingConfigurations_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRecordingConfigurations_request::OAIListRecordingConfigurations_request() {
    this->initializeModel();
}

OAIListRecordingConfigurations_request::~OAIListRecordingConfigurations_request() {}

void OAIListRecordingConfigurations_request::initializeModel() {
...
void OAIListRecordingConfigurations_request::fromJson(QString jsonString) {
...
void OAIListRecordingConfigurations_request::fromJsonObject(QJsonObject json) {
...
QString OAIListRecordingConfigurations_request::asJson() const {
...
QJsonObject OAIListRecordingConfigurations_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListRecordingConfigurations_request::getMaxResults() const {
    return m_max_results;
}
void OAIListRecordingConfigurations_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRecordingConfigurations_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRecordingConfigurations_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListRecordingConfigurations_request::getNextToken() const {
    return m_next_token;
}
void OAIListRecordingConfigurations_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRecordingConfigurations_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRecordingConfigurations_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRecordingConfigurations_request::isSet() const {
...
bool OAIListRecordingConfigurations_request::isValid() const {
