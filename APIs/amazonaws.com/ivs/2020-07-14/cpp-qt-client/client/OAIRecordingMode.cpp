...
OAIRecordingMode::OAIRecordingMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecordingMode::OAIRecordingMode() {
    this->initializeModel();
}

OAIRecordingMode::~OAIRecordingMode() {}

void OAIRecordingMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRecordingMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRecordingMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DISABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecordingMode::DISABLED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INTERVAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecordingMode::INTERVAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRecordingMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRecordingMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRecordingMode::DISABLED:
            val = "DISABLED";
            break;
        case eOAIRecordingMode::INTERVAL:
            val = "INTERVAL";
            break;
        default:
            break;
...
QJsonValue OAIRecordingMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRecordingMode::eOAIRecordingMode OAIRecordingMode::getValue() const {
    return m_value;
}

void OAIRecordingMode::setValue(const OAIRecordingMode::eOAIRecordingMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRecordingMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIRecordingMode::isValid() const {
