...
OAIDeletePlaybackKeyPair_request::OAIDeletePlaybackKeyPair_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePlaybackKeyPair_request::OAIDeletePlaybackKeyPair_request() {
    this->initializeModel();
}

OAIDeletePlaybackKeyPair_request::~OAIDeletePlaybackKeyPair_request() {}

void OAIDeletePlaybackKeyPair_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeletePlaybackKeyPair_request::fromJson(QString jsonString) {
...
void OAIDeletePlaybackKeyPair_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeletePlaybackKeyPair_request::asJson() const {
...
QJsonObject OAIDeletePlaybackKeyPair_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeletePlaybackKeyPair_request::getArn() const {
    return m_arn;
}
void OAIDeletePlaybackKeyPair_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeletePlaybackKeyPair_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeletePlaybackKeyPair_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeletePlaybackKeyPair_request::isSet() const {
...
bool OAIDeletePlaybackKeyPair_request::isValid() const {
