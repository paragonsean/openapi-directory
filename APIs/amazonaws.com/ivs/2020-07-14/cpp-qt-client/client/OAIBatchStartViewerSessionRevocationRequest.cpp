...
#include "OAIBatchStartViewerSessionRevocationRequest.h"
...
OAIBatchStartViewerSessionRevocationRequest::OAIBatchStartViewerSessionRevocationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchStartViewerSessionRevocationRequest::OAIBatchStartViewerSessionRevocationRequest() {
    this->initializeModel();
}

OAIBatchStartViewerSessionRevocationRequest::~OAIBatchStartViewerSessionRevocationRequest() {}

void OAIBatchStartViewerSessionRevocationRequest::initializeModel() {

    m_viewer_sessions_isSet = false;
    m_viewer_sessions_isValid = false;
}

void OAIBatchStartViewerSessionRevocationRequest::fromJson(QString jsonString) {
...
void OAIBatchStartViewerSessionRevocationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchStartViewerSessionRevocationRequest::asJson() const {
...
QJsonObject OAIBatchStartViewerSessionRevocationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_viewer_sessions.isSet()) {
        obj.insert(QString("viewerSessions"), ::OpenAPI::toJsonValue(m_viewer_sessions));
    }
    return obj;
}

QList OAIBatchStartViewerSessionRevocationRequest::getViewerSessions() const {
    return m_viewer_sessions;
}
void OAIBatchStartViewerSessionRevocationRequest::setViewerSessions(const QList &viewer_sessions) {
    m_viewer_sessions = viewer_sessions;
    m_viewer_sessions_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationRequest::is_viewer_sessions_Set() const{
    return m_viewer_sessions_isSet;
}

bool OAIBatchStartViewerSessionRevocationRequest::is_viewer_sessions_Valid() const{
    return m_viewer_sessions_isValid;
}

bool OAIBatchStartViewerSessionRevocationRequest::isSet() const {
...
bool OAIBatchStartViewerSessionRevocationRequest::isValid() const {
