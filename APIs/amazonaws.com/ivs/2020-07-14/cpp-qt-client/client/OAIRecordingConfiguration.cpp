...
#include "OAIRecordingConfiguration.h"
...
OAIRecordingConfiguration::OAIRecordingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecordingConfiguration::OAIRecordingConfiguration() {
    this->initializeModel();
}

OAIRecordingConfiguration::~OAIRecordingConfiguration() {}

void OAIRecordingConfiguration::initializeModel() {
...
void OAIRecordingConfiguration::fromJson(QString jsonString) {
...
void OAIRecordingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRecordingConfiguration::asJson() const {
...
QJsonObject OAIRecordingConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIRecordingConfiguration::getArn() const {
    return m_arn;
}
void OAIRecordingConfiguration::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRecordingConfiguration::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRecordingConfiguration::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIRecordingConfiguration_destinationConfiguration OAIRecordingConfiguration::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIRecordingConfiguration::setDestinationConfiguration(const OAIRecordingConfiguration_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIRecordingConfiguration::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIRecordingConfiguration::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIRecordingConfiguration::getName() const {
    return m_name;
}
void OAIRecordingConfiguration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRecordingConfiguration::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRecordingConfiguration::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIRecordingConfiguration::getRecordingReconnectWindowSeconds() const {
    return m_recording_reconnect_window_seconds;
}
void OAIRecordingConfiguration::setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds) {
    m_recording_reconnect_window_seconds = recording_reconnect_window_seconds;
    m_recording_reconnect_window_seconds_isSet = true;
}

bool OAIRecordingConfiguration::is_recording_reconnect_window_seconds_Set() const{
    return m_recording_reconnect_window_seconds_isSet;
}

bool OAIRecordingConfiguration::is_recording_reconnect_window_seconds_Valid() const{
    return m_recording_reconnect_window_seconds_isValid;
}

OAICreateRecordingConfigurationRequest_renditionConfiguration OAIRecordingConfiguration::getRenditionConfiguration() const {
    return m_rendition_configuration;
}
void OAIRecordingConfiguration::setRenditionConfiguration(const OAICreateRecordingConfigurationRequest_renditionConfiguration &rendition_configuration) {
    m_rendition_configuration = rendition_configuration;
    m_rendition_configuration_isSet = true;
}

bool OAIRecordingConfiguration::is_rendition_configuration_Set() const{
    return m_rendition_configuration_isSet;
}

bool OAIRecordingConfiguration::is_rendition_configuration_Valid() const{
    return m_rendition_configuration_isValid;
}

OAIRecordingConfigurationState OAIRecordingConfiguration::getState() const {
    return m_state;
}
void OAIRecordingConfiguration::setState(const OAIRecordingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIRecordingConfiguration::is_state_Set() const{
    return m_state_isSet;
}

bool OAIRecordingConfiguration::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIRecordingConfiguration::getTags() const {
    return m_tags;
}
void OAIRecordingConfiguration::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIRecordingConfiguration::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIRecordingConfiguration::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration OAIRecordingConfiguration::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAIRecordingConfiguration::setThumbnailConfiguration(const OAICreateRecordingConfigurationRequest_thumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAIRecordingConfiguration::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAIRecordingConfiguration::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAIRecordingConfiguration::isSet() const {
...
bool OAIRecordingConfiguration::isValid() const {
