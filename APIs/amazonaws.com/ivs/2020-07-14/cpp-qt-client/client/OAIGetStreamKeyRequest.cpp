...
#include "OAIGetStreamKeyRequest.h"
...
OAIGetStreamKeyRequest::OAIGetStreamKeyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamKeyRequest::OAIGetStreamKeyRequest() {
    this->initializeModel();
}

OAIGetStreamKeyRequest::~OAIGetStreamKeyRequest() {}

void OAIGetStreamKeyRequest::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetStreamKeyRequest::fromJson(QString jsonString) {
...
void OAIGetStreamKeyRequest::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetStreamKeyRequest::asJson() const {
...
QJsonObject OAIGetStreamKeyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetStreamKeyRequest::getArn() const {
    return m_arn;
}
void OAIGetStreamKeyRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStreamKeyRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStreamKeyRequest::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetStreamKeyRequest::isSet() const {
...
bool OAIGetStreamKeyRequest::isValid() const {
