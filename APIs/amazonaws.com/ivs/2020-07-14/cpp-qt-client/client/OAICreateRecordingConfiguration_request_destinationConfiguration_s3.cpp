...
#include "OAICreateRecordingConfiguration_request_destinationConfiguration_s3.h"
...
OAICreateRecordingConfiguration_request_destinationConfiguration_s3::OAICreateRecordingConfiguration_request_destinationConfiguration_s3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfiguration_request_destinationConfiguration_s3::OAICreateRecordingConfiguration_request_destinationConfiguration_s3() {
    this->initializeModel();
}

OAICreateRecordingConfiguration_request_destinationConfiguration_s3::~OAICreateRecordingConfiguration_request_destinationConfiguration_s3() {}

void OAICreateRecordingConfiguration_request_destinationConfiguration_s3::initializeModel() {

    m_bucket_name_isSet = false;
    m_bucket_name_isValid = false;
}

void OAICreateRecordingConfiguration_request_destinationConfiguration_s3::fromJson(QString jsonString) {
...
void OAICreateRecordingConfiguration_request_destinationConfiguration_s3::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfiguration_request_destinationConfiguration_s3::asJson() const {
...
QJsonObject OAICreateRecordingConfiguration_request_destinationConfiguration_s3::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRecordingConfiguration_request_destinationConfiguration_s3::getBucketName() const {
    return m_bucket_name;
}
void OAICreateRecordingConfiguration_request_destinationConfiguration_s3::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration_s3::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration_s3::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

bool OAICreateRecordingConfiguration_request_destinationConfiguration_s3::isSet() const {
...
bool OAICreateRecordingConfiguration_request_destinationConfiguration_s3::isValid() const {
