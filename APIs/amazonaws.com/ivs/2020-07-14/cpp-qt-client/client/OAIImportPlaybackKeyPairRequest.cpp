...
#include "OAIImportPlaybackKeyPairRequest.h"
...
OAIImportPlaybackKeyPairRequest::OAIImportPlaybackKeyPairRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportPlaybackKeyPairRequest::OAIImportPlaybackKeyPairRequest() {
    this->initializeModel();
}

OAIImportPlaybackKeyPairRequest::~OAIImportPlaybackKeyPairRequest() {}

void OAIImportPlaybackKeyPairRequest::initializeModel() {
...
void OAIImportPlaybackKeyPairRequest::fromJson(QString jsonString) {
...
void OAIImportPlaybackKeyPairRequest::fromJsonObject(QJsonObject json) {
...
QString OAIImportPlaybackKeyPairRequest::asJson() const {
...
QJsonObject OAIImportPlaybackKeyPairRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIImportPlaybackKeyPairRequest::getName() const {
    return m_name;
}
void OAIImportPlaybackKeyPairRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIImportPlaybackKeyPairRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIImportPlaybackKeyPairRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIImportPlaybackKeyPairRequest::getPublicKeyMaterial() const {
    return m_public_key_material;
}
void OAIImportPlaybackKeyPairRequest::setPublicKeyMaterial(const QString &public_key_material) {
    m_public_key_material = public_key_material;
    m_public_key_material_isSet = true;
}

bool OAIImportPlaybackKeyPairRequest::is_public_key_material_Set() const{
    return m_public_key_material_isSet;
}

bool OAIImportPlaybackKeyPairRequest::is_public_key_material_Valid() const{
    return m_public_key_material_isValid;
}

QMap OAIImportPlaybackKeyPairRequest::getTags() const {
    return m_tags;
}
void OAIImportPlaybackKeyPairRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIImportPlaybackKeyPairRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIImportPlaybackKeyPairRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIImportPlaybackKeyPairRequest::isSet() const {
...
bool OAIImportPlaybackKeyPairRequest::isValid() const {
