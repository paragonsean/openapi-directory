...
#include "OAIAudioConfiguration.h"
...
OAIAudioConfiguration::OAIAudioConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAudioConfiguration::OAIAudioConfiguration() {
    this->initializeModel();
}

OAIAudioConfiguration::~OAIAudioConfiguration() {}

void OAIAudioConfiguration::initializeModel() {
...
void OAIAudioConfiguration::fromJson(QString jsonString) {
...
void OAIAudioConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIAudioConfiguration::asJson() const {
...
QJsonObject OAIAudioConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_channels_isSet) {
...
qint32 OAIAudioConfiguration::getChannels() const {
    return m_channels;
}
void OAIAudioConfiguration::setChannels(const qint32 &channels) {
    m_channels = channels;
    m_channels_isSet = true;
}

bool OAIAudioConfiguration::is_channels_Set() const{
    return m_channels_isSet;
}

bool OAIAudioConfiguration::is_channels_Valid() const{
    return m_channels_isValid;
}

QString OAIAudioConfiguration::getCodec() const {
    return m_codec;
}
void OAIAudioConfiguration::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIAudioConfiguration::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIAudioConfiguration::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIAudioConfiguration::getSampleRate() const {
    return m_sample_rate;
}
void OAIAudioConfiguration::setSampleRate(const qint32 &sample_rate) {
    m_sample_rate = sample_rate;
    m_sample_rate_isSet = true;
}

bool OAIAudioConfiguration::is_sample_rate_Set() const{
    return m_sample_rate_isSet;
}

bool OAIAudioConfiguration::is_sample_rate_Valid() const{
    return m_sample_rate_isValid;
}

qint32 OAIAudioConfiguration::getTargetBitrate() const {
    return m_target_bitrate;
}
void OAIAudioConfiguration::setTargetBitrate(const qint32 &target_bitrate) {
    m_target_bitrate = target_bitrate;
    m_target_bitrate_isSet = true;
}

bool OAIAudioConfiguration::is_target_bitrate_Set() const{
    return m_target_bitrate_isSet;
}

bool OAIAudioConfiguration::is_target_bitrate_Valid() const{
    return m_target_bitrate_isValid;
}

bool OAIAudioConfiguration::isSet() const {
...
bool OAIAudioConfiguration::isValid() const {
