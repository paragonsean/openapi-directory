...
OAICreateRecordingConfigurationRequest_destinationConfiguration::OAICreateRecordingConfigurationRequest_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationRequest_destinationConfiguration::OAICreateRecordingConfigurationRequest_destinationConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfigurationRequest_destinationConfiguration::~OAICreateRecordingConfigurationRequest_destinationConfiguration() {}

void OAICreateRecordingConfigurationRequest_destinationConfiguration::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAICreateRecordingConfigurationRequest_destinationConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationRequest_destinationConfiguration::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAICreateRecordingConfigurationRequest_destinationConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationRequest_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAICreateRecordingConfiguration_request_destinationConfiguration_s3 OAICreateRecordingConfigurationRequest_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAICreateRecordingConfigurationRequest_destinationConfiguration::setS3(const OAICreateRecordingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAICreateRecordingConfigurationRequest_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAICreateRecordingConfigurationRequest_destinationConfiguration::isSet() const {
...
bool OAICreateRecordingConfigurationRequest_destinationConfiguration::isValid() const {
