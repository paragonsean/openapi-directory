...
bool OAICreateChannelResponse_channel::getAuthorized() const {
    return m_authorized;
}
void OAICreateChannelResponse_channel::setAuthorized(const bool &authorized) {
    m_authorized = authorized;
    m_authorized_isSet = true;
}

bool OAICreateChannelResponse_channel::is_authorized_Set() const{
    return m_authorized_isSet;
}

bool OAICreateChannelResponse_channel::is_authorized_Valid() const{
    return m_authorized_isValid;
}

QString OAICreateChannelResponse_channel::getIngestEndpoint() const {
    return m_ingest_endpoint;
}
void OAICreateChannelResponse_channel::setIngestEndpoint(const QString &ingest_endpoint) {
    m_ingest_endpoint = ingest_endpoint;
    m_ingest_endpoint_isSet = true;
}

bool OAICreateChannelResponse_channel::is_ingest_endpoint_Set() const{
    return m_ingest_endpoint_isSet;
}

bool OAICreateChannelResponse_channel::is_ingest_endpoint_Valid() const{
    return m_ingest_endpoint_isValid;
}

bool OAICreateChannelResponse_channel::getInsecureIngest() const {
    return m_insecure_ingest;
}
void OAICreateChannelResponse_channel::setInsecureIngest(const bool &insecure_ingest) {
    m_insecure_ingest = insecure_ingest;
    m_insecure_ingest_isSet = true;
}

bool OAICreateChannelResponse_channel::is_insecure_ingest_Set() const{
    return m_insecure_ingest_isSet;
}

bool OAICreateChannelResponse_channel::is_insecure_ingest_Valid() const{
    return m_insecure_ingest_isValid;
}

OAIChannelLatencyMode OAICreateChannelResponse_channel::getLatencyMode() const {
    return m_latency_mode;
}
void OAICreateChannelResponse_channel::setLatencyMode(const OAIChannelLatencyMode &latency_mode) {
    m_latency_mode = latency_mode;
    m_latency_mode_isSet = true;
}

bool OAICreateChannelResponse_channel::is_latency_mode_Set() const{
    return m_latency_mode_isSet;
}

bool OAICreateChannelResponse_channel::is_latency_mode_Valid() const{
...
QString OAICreateChannelResponse_channel::getPlaybackUrl() const {
    return m_playback_url;
}
void OAICreateChannelResponse_channel::setPlaybackUrl(const QString &playback_url) {
    m_playback_url = playback_url;
    m_playback_url_isSet = true;
}

bool OAICreateChannelResponse_channel::is_playback_url_Set() const{
    return m_playback_url_isSet;
}

bool OAICreateChannelResponse_channel::is_playback_url_Valid() const{
    return m_playback_url_isValid;
}

OAITranscodePreset OAICreateChannelResponse_channel::getPreset() const {
    return m_preset;
}
void OAICreateChannelResponse_channel::setPreset(const OAITranscodePreset &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAICreateChannelResponse_channel::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAICreateChannelResponse_channel::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAICreateChannelResponse_channel::getRecordingConfigurationArn() const {
    return m_recording_configuration_arn;
}
void OAICreateChannelResponse_channel::setRecordingConfigurationArn(const QString &recording_configuration_arn) {
    m_recording_configuration_arn = recording_configuration_arn;
    m_recording_configuration_arn_isSet = true;
}

bool OAICreateChannelResponse_channel::is_recording_configuration_arn_Set() const{
    return m_recording_configuration_arn_isSet;
}

bool OAICreateChannelResponse_channel::is_recording_configuration_arn_Valid() const{
...
OAIChannelType OAICreateChannelResponse_channel::getType() const {
    return m_type;
}
void OAICreateChannelResponse_channel::setType(const OAIChannelType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateChannelResponse_channel::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateChannelResponse_channel::is_type_Valid() const{
