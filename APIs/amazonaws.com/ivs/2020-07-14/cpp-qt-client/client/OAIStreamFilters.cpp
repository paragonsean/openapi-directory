...
OAIStreamFilters::OAIStreamFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamFilters::OAIStreamFilters() {
    this->initializeModel();
}

OAIStreamFilters::~OAIStreamFilters() {}

void OAIStreamFilters::initializeModel() {

    m_health_isSet = false;
    m_health_isValid = false;
}

void OAIStreamFilters::fromJson(QString jsonString) {
...
void OAIStreamFilters::fromJsonObject(QJsonObject json) {
...
QString OAIStreamFilters::asJson() const {
...
QJsonObject OAIStreamFilters::asJsonObject() const {
    QJsonObject obj;
    if (m_health.isSet()) {
...
OAIStreamHealth OAIStreamFilters::getHealth() const {
    return m_health;
}
void OAIStreamFilters::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIStreamFilters::is_health_Set() const{
    return m_health_isSet;
}

bool OAIStreamFilters::is_health_Valid() const{
    return m_health_isValid;
}

bool OAIStreamFilters::isSet() const {
...
bool OAIStreamFilters::isValid() const {
