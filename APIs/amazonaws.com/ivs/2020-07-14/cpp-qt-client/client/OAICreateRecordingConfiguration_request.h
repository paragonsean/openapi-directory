...
/*
 * OAICreateRecordingConfiguration_request.h
 *
 * 
 */

#ifndef OAICreateRecordingConfiguration_request_H
#define OAICreateRecordingConfiguration_request_H

#include <QJsonObject>

#include "OAICreateRecordingConfiguration_request_destinationConfiguration.h"
...
namespace OpenAPI {
class OAICreateRecordingConfiguration_request_destinationConfiguration;
class OAICreateRecordingConfiguration_request_renditionConfiguration;
class OAICreateRecordingConfiguration_request_thumbnailConfiguration;

class OAICreateRecordingConfiguration_request : public OAIObject {
public:
    OAICreateRecordingConfiguration_request();
    OAICreateRecordingConfiguration_request(QString json);
    ~OAICreateRecordingConfiguration_request() override;
    ...
    OAICreateRecordingConfiguration_request_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAICreateRecordingConfiguration_request_destinationConfiguration &destination_configuration);
    ...
    OAICreateRecordingConfiguration_request_renditionConfiguration getRenditionConfiguration() const;
    void setRenditionConfiguration(const OAICreateRecordingConfiguration_request_renditionConfiguration &rendition_configuration);
    ...
    OAICreateRecordingConfiguration_request_thumbnailConfiguration getThumbnailConfiguration() const;
    void setThumbnailConfiguration(const OAICreateRecordingConfiguration_request_thumbnailConfiguration &thumbnail_configuration);
...
private:
    ...
    OAICreateRecordingConfiguration_request_destinationConfiguration m_destination_configuration;
    ...
    OAICreateRecordingConfiguration_request_renditionConfiguration m_rendition_configuration;
    ...
    OAICreateRecordingConfiguration_request_thumbnailConfiguration m_thumbnail_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRecordingConfiguration_request)

#endif // OAICreateRecordingConfiguration_request_H
