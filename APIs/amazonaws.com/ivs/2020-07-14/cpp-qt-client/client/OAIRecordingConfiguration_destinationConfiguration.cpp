...
OAIRecordingConfiguration_destinationConfiguration::OAIRecordingConfiguration_destinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecordingConfiguration_destinationConfiguration::OAIRecordingConfiguration_destinationConfiguration() {
    this->initializeModel();
}

OAIRecordingConfiguration_destinationConfiguration::~OAIRecordingConfiguration_destinationConfiguration() {}

void OAIRecordingConfiguration_destinationConfiguration::initializeModel() {

    m_s3_isSet = false;
    m_s3_isValid = false;
}

void OAIRecordingConfiguration_destinationConfiguration::fromJson(QString jsonString) {
...
void OAIRecordingConfiguration_destinationConfiguration::fromJsonObject(QJsonObject json) {

    m_s3_isValid = ::OpenAPI::fromJsonValue(m_s3, json[QString("s3")]);
    m_s3_isSet = !json[QString("s3")].isNull() && m_s3_isValid;
}

QString OAIRecordingConfiguration_destinationConfiguration::asJson() const {
...
QJsonObject OAIRecordingConfiguration_destinationConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_s3.isSet()) {
...
OAICreateRecordingConfiguration_request_destinationConfiguration_s3 OAIRecordingConfiguration_destinationConfiguration::getS3() const {
    return m_s3;
}
void OAIRecordingConfiguration_destinationConfiguration::setS3(const OAICreateRecordingConfiguration_request_destinationConfiguration_s3 &s3) {
    m_s3 = s3;
    m_s3_isSet = true;
}

bool OAIRecordingConfiguration_destinationConfiguration::is_s3_Set() const{
    return m_s3_isSet;
}

bool OAIRecordingConfiguration_destinationConfiguration::is_s3_Valid() const{
    return m_s3_isValid;
}

bool OAIRecordingConfiguration_destinationConfiguration::isSet() const {
...
bool OAIRecordingConfiguration_destinationConfiguration::isValid() const {
