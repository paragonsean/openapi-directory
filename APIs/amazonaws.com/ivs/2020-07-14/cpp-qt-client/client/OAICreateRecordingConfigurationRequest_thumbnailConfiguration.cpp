...
OAICreateRecordingConfigurationRequest_thumbnailConfiguration::OAICreateRecordingConfigurationRequest_thumbnailConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration::OAICreateRecordingConfigurationRequest_thumbnailConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration::~OAICreateRecordingConfigurationRequest_thumbnailConfiguration() {}

void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::initializeModel() {
...
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfigurationRequest_thumbnailConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationRequest_thumbnailConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIRecordingMode OAICreateRecordingConfigurationRequest_thumbnailConfiguration::getRecordingMode() const {
    return m_recording_mode;
}
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::setRecordingMode(const OAIRecordingMode &recording_mode) {
    m_recording_mode = recording_mode;
    m_recording_mode_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_recording_mode_Set() const{
    return m_recording_mode_isSet;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_recording_mode_Valid() const{
    return m_recording_mode_isValid;
}

OAIThumbnailConfigurationResolution OAICreateRecordingConfigurationRequest_thumbnailConfiguration::getResolution() const {
    return m_resolution;
}
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::setResolution(const OAIThumbnailConfigurationResolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_resolution_Valid() const{
    return m_resolution_isValid;
}

QList OAICreateRecordingConfigurationRequest_thumbnailConfiguration::getStorage() const {
    return m_storage;
}
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::setStorage(const QList &storage) {
    m_storage = storage;
    m_storage_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_storage_Set() const{
    return m_storage_isSet;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_storage_Valid() const{
    return m_storage_isValid;
}

qint32 OAICreateRecordingConfigurationRequest_thumbnailConfiguration::getTargetIntervalSeconds() const {
    return m_target_interval_seconds;
}
void OAICreateRecordingConfigurationRequest_thumbnailConfiguration::setTargetIntervalSeconds(const qint32 &target_interval_seconds) {
    m_target_interval_seconds = target_interval_seconds;
    m_target_interval_seconds_isSet = true;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_target_interval_seconds_Set() const{
    return m_target_interval_seconds_isSet;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::is_target_interval_seconds_Valid() const{
    return m_target_interval_seconds_isValid;
}

bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::isSet() const {
...
bool OAICreateRecordingConfigurationRequest_thumbnailConfiguration::isValid() const {
