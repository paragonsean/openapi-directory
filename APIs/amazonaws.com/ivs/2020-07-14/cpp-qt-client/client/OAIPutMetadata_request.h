...
/*
 * OAIPutMetadata_request.h
 *
 * 
 */

#ifndef OAIPutMetadata_request_H
#define OAIPutMetadata_request_H
...
class OAIPutMetadata_request : public OAIObject {
public:
    OAIPutMetadata_request();
    OAIPutMetadata_request(QString json);
    ~OAIPutMetadata_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutMetadata_request)

#endif // OAIPutMetadata_request_H
