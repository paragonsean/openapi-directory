...
/*
 * OAIBatchStartViewerSessionRevocationError.h
 *
...
#ifndef OAIBatchStartViewerSessionRevocationError_H
#define OAIBatchStartViewerSessionRevocationError_H
...
class OAIBatchStartViewerSessionRevocationError : public OAIObject {
public:
    OAIBatchStartViewerSessionRevocationError();
    OAIBatchStartViewerSessionRevocationError(QString json);
    ~OAIBatchStartViewerSessionRevocationError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchStartViewerSessionRevocationError)

#endif // OAIBatchStartViewerSessionRevocationError_H
