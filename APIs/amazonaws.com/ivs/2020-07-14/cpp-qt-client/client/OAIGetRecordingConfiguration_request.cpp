...
OAIGetRecordingConfiguration_request::OAIGetRecordingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRecordingConfiguration_request::OAIGetRecordingConfiguration_request() {
    this->initializeModel();
}

OAIGetRecordingConfiguration_request::~OAIGetRecordingConfiguration_request() {}

void OAIGetRecordingConfiguration_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetRecordingConfiguration_request::fromJson(QString jsonString) {
...
void OAIGetRecordingConfiguration_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetRecordingConfiguration_request::asJson() const {
...
QJsonObject OAIGetRecordingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetRecordingConfiguration_request::getArn() const {
    return m_arn;
}
void OAIGetRecordingConfiguration_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetRecordingConfiguration_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetRecordingConfiguration_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetRecordingConfiguration_request::isSet() const {
...
bool OAIGetRecordingConfiguration_request::isValid() const {
