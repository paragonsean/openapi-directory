...
QString OAIListStreamsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStreamsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStreamsResponse::getStreams() const {
    return m_streams;
}
void OAIListStreamsResponse::setStreams(const QList &streams) {
    m_streams = streams;
