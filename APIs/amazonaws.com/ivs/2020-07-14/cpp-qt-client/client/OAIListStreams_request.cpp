...
OAIListStreams_request_filterBy OAIListStreams_request::getFilterBy() const {
    return m_filter_by;
}
void OAIListStreams_request::setFilterBy(const OAIListStreams_request_filterBy &filter_by) {
    m_filter_by = filter_by;
    m_filter_by_isSet = true;
}

bool OAIListStreams_request::is_filter_by_Set() const{
    return m_filter_by_isSet;
}

bool OAIListStreams_request::is_filter_by_Valid() const{
