...
/*
 * OAIGetStreamSession_request.h
 *
 * 
 */

#ifndef OAIGetStreamSession_request_H
#define OAIGetStreamSession_request_H
...
class OAIGetStreamSession_request : public OAIObject {
public:
    OAIGetStreamSession_request();
    OAIGetStreamSession_request(QString json);
    ~OAIGetStreamSession_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStreamSession_request)

#endif // OAIGetStreamSession_request_H
