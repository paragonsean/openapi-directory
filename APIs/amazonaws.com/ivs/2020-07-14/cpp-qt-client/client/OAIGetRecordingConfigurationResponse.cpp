...
OAIGetRecordingConfigurationResponse::OAIGetRecordingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRecordingConfigurationResponse::OAIGetRecordingConfigurationResponse() {
    this->initializeModel();
}

OAIGetRecordingConfigurationResponse::~OAIGetRecordingConfigurationResponse() {}

void OAIGetRecordingConfigurationResponse::initializeModel() {

    m_recording_configuration_isSet = false;
    m_recording_configuration_isValid = false;
}

void OAIGetRecordingConfigurationResponse::fromJson(QString jsonString) {
...
void OAIGetRecordingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetRecordingConfigurationResponse::asJson() const {
...
QJsonObject OAIGetRecordingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRecordingConfigurationResponse_recordingConfiguration OAIGetRecordingConfigurationResponse::getRecordingConfiguration() const {
    return m_recording_configuration;
}
void OAIGetRecordingConfigurationResponse::setRecordingConfiguration(const OAICreateRecordingConfigurationResponse_recordingConfiguration &recording_configuration) {
    m_recording_configuration = recording_configuration;
    m_recording_configuration_isSet = true;
}

bool OAIGetRecordingConfigurationResponse::is_recording_configuration_Set() const{
    return m_recording_configuration_isSet;
}

bool OAIGetRecordingConfigurationResponse::is_recording_configuration_Valid() const{
    return m_recording_configuration_isValid;
}

bool OAIGetRecordingConfigurationResponse::isSet() const {
...
bool OAIGetRecordingConfigurationResponse::isValid() const {
