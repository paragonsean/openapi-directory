...
OAICreateChannelResponse_streamKey OAICreateChannelResponse::getStreamKey() const {
    return m_stream_key;
}
void OAICreateChannelResponse::setStreamKey(const OAICreateChannelResponse_streamKey &stream_key) {
    m_stream_key = stream_key;
    m_stream_key_isSet = true;
}

bool OAICreateChannelResponse::is_stream_key_Set() const{
    return m_stream_key_isSet;
}

bool OAICreateChannelResponse::is_stream_key_Valid() const{
