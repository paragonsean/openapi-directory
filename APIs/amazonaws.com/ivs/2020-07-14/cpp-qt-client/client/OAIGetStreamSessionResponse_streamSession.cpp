...
#include "OAIGetStreamSessionResponse_streamSession.h"
...
OAIGetStreamSessionResponse_streamSession::OAIGetStreamSessionResponse_streamSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamSessionResponse_streamSession::OAIGetStreamSessionResponse_streamSession() {
    this->initializeModel();
}

OAIGetStreamSessionResponse_streamSession::~OAIGetStreamSessionResponse_streamSession() {}

void OAIGetStreamSessionResponse_streamSession::initializeModel() {
    ...
    m_ingest_configuration_isSet = false;
    m_ingest_configuration_isValid = false;

    m_recording_configuration_isSet = false;
    m_recording_configuration_isValid = false;
    ...
    m_truncated_events_isSet = false;
    m_truncated_events_isValid = false;
}

void OAIGetStreamSessionResponse_streamSession::fromJson(QString jsonString) {
...
void OAIGetStreamSessionResponse_streamSession::fromJsonObject(QJsonObject json) {
    ...
    m_ingest_configuration_isValid = ::OpenAPI::fromJsonValue(m_ingest_configuration, json[QString("ingestConfiguration")]);
    m_ingest_configuration_isSet = !json[QString("ingestConfiguration")].isNull() && m_ingest_configuration_isValid;

    m_recording_configuration_isValid = ::OpenAPI::fromJsonValue(m_recording_configuration, json[QString("recordingConfiguration")]);
    m_recording_configuration_isSet = !json[QString("recordingConfiguration")].isNull() && m_recording_configuration_isValid;
    ...
    m_truncated_events_isValid = ::OpenAPI::fromJsonValue(m_truncated_events, json[QString("truncatedEvents")]);
    m_truncated_events_isSet = !json[QString("truncatedEvents")].isNull() && m_truncated_events_isValid;
}

QString OAIGetStreamSessionResponse_streamSession::asJson() const {
...
QJsonObject OAIGetStreamSessionResponse_streamSession::asJsonObject() const {
    QJsonObject obj;
    if (m_channel.isSet()) {
    ...
    if (m_ingest_configuration.isSet()) {
        obj.insert(QString("ingestConfiguration"), ::OpenAPI::toJsonValue(m_ingest_configuration));
    }
    if (m_recording_configuration.isSet()) {
        obj.insert(QString("recordingConfiguration"), ::OpenAPI::toJsonValue(m_recording_configuration));
    }
    ...
    if (m_truncated_events.isSet()) {
        obj.insert(QString("truncatedEvents"), ::OpenAPI::toJsonValue(m_truncated_events));
    }
    return obj;
}

OAIStreamSession_channel OAIGetStreamSessionResponse_streamSession::getChannel() const {
    return m_channel;
}
void OAIGetStreamSessionResponse_streamSession::setChannel(const OAIStreamSession_channel &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_channel_Valid() const{
    return m_channel_isValid;
}

QDateTime OAIGetStreamSessionResponse_streamSession::getEndTime() const {
    return m_end_time;
}
void OAIGetStreamSessionResponse_streamSession::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_end_time_Valid() const{
    return m_end_time_isValid;
}

OAIStreamSession_ingestConfiguration OAIGetStreamSessionResponse_streamSession::getIngestConfiguration() const {
    return m_ingest_configuration;
}
void OAIGetStreamSessionResponse_streamSession::setIngestConfiguration(const OAIStreamSession_ingestConfiguration &ingest_configuration) {
    m_ingest_configuration = ingest_configuration;
    m_ingest_configuration_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_ingest_configuration_Set() const{
    return m_ingest_configuration_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_ingest_configuration_Valid() const{
    return m_ingest_configuration_isValid;
}

OAIStreamSession_recordingConfiguration OAIGetStreamSessionResponse_streamSession::getRecordingConfiguration() const {
    return m_recording_configuration;
}
void OAIGetStreamSessionResponse_streamSession::setRecordingConfiguration(const OAIStreamSession_recordingConfiguration &recording_configuration) {
    m_recording_configuration = recording_configuration;
    m_recording_configuration_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_recording_configuration_Set() const{
    return m_recording_configuration_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_recording_configuration_Valid() const{
    return m_recording_configuration_isValid;
}

QDateTime OAIGetStreamSessionResponse_streamSession::getStartTime() const {
    return m_start_time;
}
void OAIGetStreamSessionResponse_streamSession::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIGetStreamSessionResponse_streamSession::getStreamId() const {
    return m_stream_id;
}
void OAIGetStreamSessionResponse_streamSession::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

QList OAIGetStreamSessionResponse_streamSession::getTruncatedEvents() const {
    return m_truncated_events;
}
void OAIGetStreamSessionResponse_streamSession::setTruncatedEvents(const QList &truncated_events) {
    m_truncated_events = truncated_events;
    m_truncated_events_isSet = true;
}

bool OAIGetStreamSessionResponse_streamSession::is_truncated_events_Set() const{
    return m_truncated_events_isSet;
}

bool OAIGetStreamSessionResponse_streamSession::is_truncated_events_Valid() const{
    return m_truncated_events_isValid;
}

bool OAIGetStreamSessionResponse_streamSession::isSet() const {
...
bool OAIGetStreamSessionResponse_streamSession::isValid() const {
