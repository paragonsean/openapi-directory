...
#ifndef OAIVideoConfiguration_H
#define OAIVideoConfiguration_H
...
class OAIVideoConfiguration : public OAIObject {
public:
    OAIVideoConfiguration();
    OAIVideoConfiguration(QString json);
    ~OAIVideoConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoConfiguration)

#endif // OAIVideoConfiguration_H
