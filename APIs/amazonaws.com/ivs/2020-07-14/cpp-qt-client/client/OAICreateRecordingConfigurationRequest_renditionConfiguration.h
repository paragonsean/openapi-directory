...
/*
 * OAICreateRecordingConfigurationRequest_renditionConfiguration.h
 *
 * 
 */

#ifndef OAICreateRecordingConfigurationRequest_renditionConfiguration_H
#define OAICreateRecordingConfigurationRequest_renditionConfiguration_H
...
class OAICreateRecordingConfigurationRequest_renditionConfiguration : public OAIObject {
public:
    OAICreateRecordingConfigurationRequest_renditionConfiguration();
    OAICreateRecordingConfigurationRequest_renditionConfiguration(QString json);
    ~OAICreateRecordingConfigurationRequest_renditionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRecordingConfigurationRequest_renditionConfiguration)

#endif // OAICreateRecordingConfigurationRequest_renditionConfiguration_H
