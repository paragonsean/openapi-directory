...
/*
 * OAIIngestConfiguration_video.h
 *
 * 
 */

#ifndef OAIIngestConfiguration_video_H
#define OAIIngestConfiguration_video_H
...
class OAIIngestConfiguration_video : public OAIObject {
public:
    OAIIngestConfiguration_video();
    OAIIngestConfiguration_video(QString json);
    ~OAIIngestConfiguration_video() override;
    ...
    QString getAvcLevel() const;
    void setAvcLevel(const QString &avc_level);
    bool is_avc_level_Set() const;
    bool is_avc_level_Valid() const;

    QString getAvcProfile() const;
    void setAvcProfile(const QString &avc_profile);
    bool is_avc_profile_Set() const;
    bool is_avc_profile_Valid() const;
    ...
    void setTargetBitrate(const qint32 &target_bitrate);
    bool is_target_bitrate_Set() const;
    bool is_target_bitrate_Valid() const;

    qint32 getTargetFramerate() const;
    void setTargetFramerate(const qint32 &target_framerate);
    bool is_target_framerate_Set() const;
    bool is_target_framerate_Valid() const;
...
private:
    ...
    QString m_avc_level;
    bool m_avc_level_isSet;
    bool m_avc_level_isValid;

    QString m_avc_profile;
    bool m_avc_profile_isSet;
    bool m_avc_profile_isValid;
    ...
    qint32 m_target_bitrate;
    bool m_target_bitrate_isSet;
    bool m_target_bitrate_isValid;

    qint32 m_target_framerate;
    bool m_target_framerate_isSet;
    bool m_target_framerate_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngestConfiguration_video)

#endif // OAIIngestConfiguration_video_H
