...
/*
 * OAIListStreamKeysRequest.h
 *
 * 
 */

#ifndef OAIListStreamKeysRequest_H
#define OAIListStreamKeysRequest_H
...
class OAIListStreamKeysRequest : public OAIObject {
public:
    OAIListStreamKeysRequest();
    OAIListStreamKeysRequest(QString json);
    ~OAIListStreamKeysRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamKeysRequest)

#endif // OAIListStreamKeysRequest_H
