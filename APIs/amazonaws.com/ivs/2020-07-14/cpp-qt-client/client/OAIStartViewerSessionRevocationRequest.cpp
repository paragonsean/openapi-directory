...
#include "OAIStartViewerSessionRevocationRequest.h"
...
OAIStartViewerSessionRevocationRequest::OAIStartViewerSessionRevocationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartViewerSessionRevocationRequest::OAIStartViewerSessionRevocationRequest() {
    this->initializeModel();
}

OAIStartViewerSessionRevocationRequest::~OAIStartViewerSessionRevocationRequest() {}

void OAIStartViewerSessionRevocationRequest::initializeModel() {
...
void OAIStartViewerSessionRevocationRequest::fromJson(QString jsonString) {
...
void OAIStartViewerSessionRevocationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartViewerSessionRevocationRequest::asJson() const {
...
QJsonObject OAIStartViewerSessionRevocationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartViewerSessionRevocationRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIStartViewerSessionRevocationRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStartViewerSessionRevocationRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStartViewerSessionRevocationRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIStartViewerSessionRevocationRequest::getViewerId() const {
    return m_viewer_id;
}
void OAIStartViewerSessionRevocationRequest::setViewerId(const QString &viewer_id) {
    m_viewer_id = viewer_id;
    m_viewer_id_isSet = true;
}

bool OAIStartViewerSessionRevocationRequest::is_viewer_id_Set() const{
    return m_viewer_id_isSet;
}

bool OAIStartViewerSessionRevocationRequest::is_viewer_id_Valid() const{
    return m_viewer_id_isValid;
}

qint32 OAIStartViewerSessionRevocationRequest::getViewerSessionVersionsLessThanOrEqualTo() const {
    return m_viewer_session_versions_less_than_or_equal_to;
}
void OAIStartViewerSessionRevocationRequest::setViewerSessionVersionsLessThanOrEqualTo(const qint32 &viewer_session_versions_less_than_or_equal_to) {
...
bool OAIStartViewerSessionRevocationRequest::is_viewer_session_versions_less_than_or_equal_to_Set() const{
    return m_viewer_session_versions_less_than_or_equal_to_isSet;
}

bool OAIStartViewerSessionRevocationRequest::is_viewer_session_versions_less_than_or_equal_to_Valid() const{
    return m_viewer_session_versions_less_than_or_equal_to_isValid;
}

bool OAIStartViewerSessionRevocationRequest::isSet() const {
...
bool OAIStartViewerSessionRevocationRequest::isValid() const {
