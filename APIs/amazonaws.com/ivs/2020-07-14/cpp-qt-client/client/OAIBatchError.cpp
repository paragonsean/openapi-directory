...
QString OAIBatchError::getArn() const {
    return m_arn;
}
void OAIBatchError::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIBatchError::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIBatchError::is_arn_Valid() const{
...
QString OAIBatchError::getMessage() const {
    return m_message;
}
void OAIBatchError::setMessage(const QString &message) {
    m_message = message;
