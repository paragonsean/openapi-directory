...
OAIGetStream_request::OAIGetStream_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStream_request::OAIGetStream_request() {
    this->initializeModel();
}

OAIGetStream_request::~OAIGetStream_request() {}

void OAIGetStream_request::initializeModel() {

    m_channel_arn_isSet = false;
    m_channel_arn_isValid = false;
}

void OAIGetStream_request::fromJson(QString jsonString) {
...
void OAIGetStream_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetStream_request::asJson() const {
...
QJsonObject OAIGetStream_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStream_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStream_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStream_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStream_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

bool OAIGetStream_request::isSet() const {
...
bool OAIGetStream_request::isValid() const {
