...
/*
 * OAIRenditionConfigurationRendition.h
 *
 * 
 */

#ifndef OAIRenditionConfigurationRendition_H
#define OAIRenditionConfigurationRendition_H
...
class OAIRenditionConfigurationRendition : public OAIEnum {
public:
    OAIRenditionConfigurationRendition();
    OAIRenditionConfigurationRendition(QString json);
    ~OAIRenditionConfigurationRendition() override;
    ...
    enum class eOAIRenditionConfigurationRendition {
    ...
    OAIRenditionConfigurationRendition::eOAIRenditionConfigurationRendition getValue() const;
    void setValue(const OAIRenditionConfigurationRendition::eOAIRenditionConfigurationRendition& value);
...
private:
    ...
    eOAIRenditionConfigurationRendition m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRenditionConfigurationRendition)

#endif // OAIRenditionConfigurationRendition_H
