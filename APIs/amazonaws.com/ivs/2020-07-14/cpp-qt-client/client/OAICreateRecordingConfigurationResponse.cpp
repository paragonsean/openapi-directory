...
OAICreateRecordingConfigurationResponse::OAICreateRecordingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfigurationResponse::OAICreateRecordingConfigurationResponse() {
    this->initializeModel();
}

OAICreateRecordingConfigurationResponse::~OAICreateRecordingConfigurationResponse() {}

void OAICreateRecordingConfigurationResponse::initializeModel() {

    m_recording_configuration_isSet = false;
    m_recording_configuration_isValid = false;
}

void OAICreateRecordingConfigurationResponse::fromJson(QString jsonString) {
...
void OAICreateRecordingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfigurationResponse::asJson() const {
...
QJsonObject OAICreateRecordingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRecordingConfigurationResponse_recordingConfiguration OAICreateRecordingConfigurationResponse::getRecordingConfiguration() const {
    return m_recording_configuration;
}
void OAICreateRecordingConfigurationResponse::setRecordingConfiguration(const OAICreateRecordingConfigurationResponse_recordingConfiguration &recording_configuration) {
    m_recording_configuration = recording_configuration;
    m_recording_configuration_isSet = true;
}

bool OAICreateRecordingConfigurationResponse::is_recording_configuration_Set() const{
    return m_recording_configuration_isSet;
}

bool OAICreateRecordingConfigurationResponse::is_recording_configuration_Valid() const{
    return m_recording_configuration_isValid;
}

bool OAICreateRecordingConfigurationResponse::isSet() const {
...
bool OAICreateRecordingConfigurationResponse::isValid() const {
