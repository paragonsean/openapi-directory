...
#include "OAIBatchStartViewerSessionRevocationError.h"
...
OAIBatchStartViewerSessionRevocationError::OAIBatchStartViewerSessionRevocationError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchStartViewerSessionRevocationError::OAIBatchStartViewerSessionRevocationError() {
    this->initializeModel();
}

OAIBatchStartViewerSessionRevocationError::~OAIBatchStartViewerSessionRevocationError() {}

void OAIBatchStartViewerSessionRevocationError::initializeModel() {
...
void OAIBatchStartViewerSessionRevocationError::fromJson(QString jsonString) {
...
void OAIBatchStartViewerSessionRevocationError::fromJsonObject(QJsonObject json) {
...
QString OAIBatchStartViewerSessionRevocationError::asJson() const {
...
QJsonObject OAIBatchStartViewerSessionRevocationError::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBatchStartViewerSessionRevocationError::getChannelArn() const {
    return m_channel_arn;
}
void OAIBatchStartViewerSessionRevocationError::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationError::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIBatchStartViewerSessionRevocationError::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIBatchStartViewerSessionRevocationError::getCode() const {
    return m_code;
}
void OAIBatchStartViewerSessionRevocationError::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationError::is_code_Set() const{
    return m_code_isSet;
}

bool OAIBatchStartViewerSessionRevocationError::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIBatchStartViewerSessionRevocationError::getMessage() const {
    return m_message;
}
void OAIBatchStartViewerSessionRevocationError::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationError::is_message_Set() const{
    return m_message_isSet;
}

bool OAIBatchStartViewerSessionRevocationError::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIBatchStartViewerSessionRevocationError::getViewerId() const {
    return m_viewer_id;
}
void OAIBatchStartViewerSessionRevocationError::setViewerId(const QString &viewer_id) {
    m_viewer_id = viewer_id;
    m_viewer_id_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationError::is_viewer_id_Set() const{
    return m_viewer_id_isSet;
}

bool OAIBatchStartViewerSessionRevocationError::is_viewer_id_Valid() const{
    return m_viewer_id_isValid;
}

bool OAIBatchStartViewerSessionRevocationError::isSet() const {
...
bool OAIBatchStartViewerSessionRevocationError::isValid() const {
