...
OAIRenditionConfigurationRenditionSelection::OAIRenditionConfigurationRenditionSelection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRenditionConfigurationRenditionSelection::OAIRenditionConfigurationRenditionSelection() {
    this->initializeModel();
}

OAIRenditionConfigurationRenditionSelection::~OAIRenditionConfigurationRenditionSelection() {}

void OAIRenditionConfigurationRenditionSelection::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRenditionConfigurationRenditionSelection::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRenditionConfigurationRenditionSelection::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRenditionSelection::ALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRenditionSelection::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CUSTOM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRenditionSelection::CUSTOM;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRenditionConfigurationRenditionSelection::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRenditionConfigurationRenditionSelection::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRenditionConfigurationRenditionSelection::ALL:
            val = "ALL";
            break;
        case eOAIRenditionConfigurationRenditionSelection::NONE:
            val = "NONE";
            break;
        case eOAIRenditionConfigurationRenditionSelection::CUSTOM:
            val = "CUSTOM";
            break;
        default:
            break;
...
QJsonValue OAIRenditionConfigurationRenditionSelection::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRenditionConfigurationRenditionSelection::eOAIRenditionConfigurationRenditionSelection OAIRenditionConfigurationRenditionSelection::getValue() const {
    return m_value;
}

void OAIRenditionConfigurationRenditionSelection::setValue(const OAIRenditionConfigurationRenditionSelection::eOAIRenditionConfigurationRenditionSelection& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRenditionConfigurationRenditionSelection::isSet() const {
    
    return m_value_isSet;
}

bool OAIRenditionConfigurationRenditionSelection::isValid() const {
