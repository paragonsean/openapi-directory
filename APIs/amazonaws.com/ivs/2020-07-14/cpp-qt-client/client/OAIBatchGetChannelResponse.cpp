...
OAIBatchGetChannelResponse::OAIBatchGetChannelResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetChannelResponse::OAIBatchGetChannelResponse() {
    this->initializeModel();
}

OAIBatchGetChannelResponse::~OAIBatchGetChannelResponse() {}

void OAIBatchGetChannelResponse::initializeModel() {
...
void OAIBatchGetChannelResponse::fromJson(QString jsonString) {
...
void OAIBatchGetChannelResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetChannelResponse::asJson() const {
...
QJsonObject OAIBatchGetChannelResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_channels.isSet()) {
...
QList OAIBatchGetChannelResponse::getChannels() const {
    return m_channels;
}
void OAIBatchGetChannelResponse::setChannels(const QList &channels) {
    m_channels = channels;
    m_channels_isSet = true;
}

bool OAIBatchGetChannelResponse::is_channels_Set() const{
    return m_channels_isSet;
}

bool OAIBatchGetChannelResponse::is_channels_Valid() const{
    return m_channels_isValid;
}

QList OAIBatchGetChannelResponse::getErrors() const {
    return m_errors;
}
void OAIBatchGetChannelResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchGetChannelResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchGetChannelResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchGetChannelResponse::isSet() const {
...
bool OAIBatchGetChannelResponse::isValid() const {
