...
OAIStreamKey::OAIStreamKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamKey::OAIStreamKey() {
    this->initializeModel();
}

OAIStreamKey::~OAIStreamKey() {}

void OAIStreamKey::initializeModel() {
...
void OAIStreamKey::fromJson(QString jsonString) {
...
void OAIStreamKey::fromJsonObject(QJsonObject json) {
...
QString OAIStreamKey::asJson() const {
...
QJsonObject OAIStreamKey::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamKey::getArn() const {
    return m_arn;
}
void OAIStreamKey::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamKey::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamKey::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIStreamKey::getChannelArn() const {
    return m_channel_arn;
}
void OAIStreamKey::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStreamKey::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStreamKey::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAIStreamKey::getTags() const {
    return m_tags;
}
void OAIStreamKey::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStreamKey::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStreamKey::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIStreamKey::getValue() const {
    return m_value;
}
void OAIStreamKey::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIStreamKey::is_value_Set() const{
    return m_value_isSet;
}

bool OAIStreamKey::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIStreamKey::isSet() const {
...
bool OAIStreamKey::isValid() const {
