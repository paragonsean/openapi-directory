...
OAIStreamState::OAIStreamState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamState::OAIStreamState() {
    this->initializeModel();
}

OAIStreamState::~OAIStreamState() {}

void OAIStreamState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStreamState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStreamState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("LIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamState::LIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OFFLINE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamState::OFFLINE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStreamState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStreamState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStreamState::LIVE:
            val = "LIVE";
            break;
        case eOAIStreamState::OFFLINE:
            val = "OFFLINE";
            break;
        default:
            break;
...
QJsonValue OAIStreamState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStreamState::eOAIStreamState OAIStreamState::getValue() const {
    return m_value;
}

void OAIStreamState::setValue(const OAIStreamState::eOAIStreamState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStreamState::isSet() const {
    
    return m_value_isSet;
}

bool OAIStreamState::isValid() const {
