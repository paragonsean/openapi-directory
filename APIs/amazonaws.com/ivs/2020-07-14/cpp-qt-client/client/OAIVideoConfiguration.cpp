...
#include "OAIVideoConfiguration.h"
...
OAIVideoConfiguration::OAIVideoConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoConfiguration::OAIVideoConfiguration() {
    this->initializeModel();
}

OAIVideoConfiguration::~OAIVideoConfiguration() {}

void OAIVideoConfiguration::initializeModel() {
...
void OAIVideoConfiguration::fromJson(QString jsonString) {
...
void OAIVideoConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIVideoConfiguration::asJson() const {
...
QJsonObject OAIVideoConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVideoConfiguration::getAvcLevel() const {
    return m_avc_level;
}
void OAIVideoConfiguration::setAvcLevel(const QString &avc_level) {
    m_avc_level = avc_level;
    m_avc_level_isSet = true;
}

bool OAIVideoConfiguration::is_avc_level_Set() const{
    return m_avc_level_isSet;
}

bool OAIVideoConfiguration::is_avc_level_Valid() const{
    return m_avc_level_isValid;
}

QString OAIVideoConfiguration::getAvcProfile() const {
    return m_avc_profile;
}
void OAIVideoConfiguration::setAvcProfile(const QString &avc_profile) {
    m_avc_profile = avc_profile;
    m_avc_profile_isSet = true;
}

bool OAIVideoConfiguration::is_avc_profile_Set() const{
    return m_avc_profile_isSet;
}

bool OAIVideoConfiguration::is_avc_profile_Valid() const{
    return m_avc_profile_isValid;
}

QString OAIVideoConfiguration::getCodec() const {
    return m_codec;
}
void OAIVideoConfiguration::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIVideoConfiguration::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIVideoConfiguration::is_codec_Valid() const{
    return m_codec_isValid;
}

QString OAIVideoConfiguration::getEncoder() const {
    return m_encoder;
}
void OAIVideoConfiguration::setEncoder(const QString &encoder) {
    m_encoder = encoder;
    m_encoder_isSet = true;
}

bool OAIVideoConfiguration::is_encoder_Set() const{
    return m_encoder_isSet;
}

bool OAIVideoConfiguration::is_encoder_Valid() const{
    return m_encoder_isValid;
}

qint32 OAIVideoConfiguration::getTargetBitrate() const {
    return m_target_bitrate;
}
void OAIVideoConfiguration::setTargetBitrate(const qint32 &target_bitrate) {
    m_target_bitrate = target_bitrate;
    m_target_bitrate_isSet = true;
}

bool OAIVideoConfiguration::is_target_bitrate_Set() const{
    return m_target_bitrate_isSet;
}

bool OAIVideoConfiguration::is_target_bitrate_Valid() const{
    return m_target_bitrate_isValid;
}

qint32 OAIVideoConfiguration::getTargetFramerate() const {
    return m_target_framerate;
}
void OAIVideoConfiguration::setTargetFramerate(const qint32 &target_framerate) {
    m_target_framerate = target_framerate;
    m_target_framerate_isSet = true;
}

bool OAIVideoConfiguration::is_target_framerate_Set() const{
    return m_target_framerate_isSet;
}

bool OAIVideoConfiguration::is_target_framerate_Valid() const{
    return m_target_framerate_isValid;
}

qint32 OAIVideoConfiguration::getVideoHeight() const {
    return m_video_height;
}
void OAIVideoConfiguration::setVideoHeight(const qint32 &video_height) {
    m_video_height = video_height;
    m_video_height_isSet = true;
}

bool OAIVideoConfiguration::is_video_height_Set() const{
    return m_video_height_isSet;
}

bool OAIVideoConfiguration::is_video_height_Valid() const{
    return m_video_height_isValid;
}

qint32 OAIVideoConfiguration::getVideoWidth() const {
    return m_video_width;
}
void OAIVideoConfiguration::setVideoWidth(const qint32 &video_width) {
    m_video_width = video_width;
    m_video_width_isSet = true;
}

bool OAIVideoConfiguration::is_video_width_Set() const{
    return m_video_width_isSet;
}

bool OAIVideoConfiguration::is_video_width_Valid() const{
    return m_video_width_isValid;
}

bool OAIVideoConfiguration::isSet() const {
...
bool OAIVideoConfiguration::isValid() const {
