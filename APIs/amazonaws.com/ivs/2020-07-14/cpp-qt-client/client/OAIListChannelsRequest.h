...
/*
 * OAIListChannelsRequest.h
 *
 * 
 */

#ifndef OAIListChannelsRequest_H
#define OAIListChannelsRequest_H
...
class OAIListChannelsRequest : public OAIObject {
public:
    OAIListChannelsRequest();
    OAIListChannelsRequest(QString json);
    ~OAIListChannelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChannelsRequest)

#endif // OAIListChannelsRequest_H
