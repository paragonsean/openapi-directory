...
OAIDeleteStreamKey_request::OAIDeleteStreamKey_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteStreamKey_request::OAIDeleteStreamKey_request() {
    this->initializeModel();
}

OAIDeleteStreamKey_request::~OAIDeleteStreamKey_request() {}

void OAIDeleteStreamKey_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIDeleteStreamKey_request::fromJson(QString jsonString) {
...
void OAIDeleteStreamKey_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIDeleteStreamKey_request::asJson() const {
...
QJsonObject OAIDeleteStreamKey_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteStreamKey_request::getArn() const {
    return m_arn;
}
void OAIDeleteStreamKey_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteStreamKey_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteStreamKey_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIDeleteStreamKey_request::isSet() const {
...
bool OAIDeleteStreamKey_request::isValid() const {
