...
/*
 * OAIGetPlaybackKeyPairResponse_keyPair.h
 *
 * 
 */

#ifndef OAIGetPlaybackKeyPairResponse_keyPair_H
#define OAIGetPlaybackKeyPairResponse_keyPair_H
...
class OAIGetPlaybackKeyPairResponse_keyPair : public OAIObject {
public:
    OAIGetPlaybackKeyPairResponse_keyPair();
    OAIGetPlaybackKeyPairResponse_keyPair(QString json);
    ~OAIGetPlaybackKeyPairResponse_keyPair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPlaybackKeyPairResponse_keyPair)

#endif // OAIGetPlaybackKeyPairResponse_keyPair_H
