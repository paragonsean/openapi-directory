...
/*
 * OAIGetStreamSessionRequest.h
 *
 * 
 */

#ifndef OAIGetStreamSessionRequest_H
#define OAIGetStreamSessionRequest_H
...
class OAIGetStreamSessionRequest : public OAIObject {
public:
    OAIGetStreamSessionRequest();
    OAIGetStreamSessionRequest(QString json);
    ~OAIGetStreamSessionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStreamSessionRequest)

#endif // OAIGetStreamSessionRequest_H
