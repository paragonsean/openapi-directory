...
#include "OAICreateRecordingConfiguration_request_thumbnailConfiguration.h"
...
OAICreateRecordingConfiguration_request_thumbnailConfiguration::OAICreateRecordingConfiguration_request_thumbnailConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfiguration_request_thumbnailConfiguration::OAICreateRecordingConfiguration_request_thumbnailConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfiguration_request_thumbnailConfiguration::~OAICreateRecordingConfiguration_request_thumbnailConfiguration() {}

void OAICreateRecordingConfiguration_request_thumbnailConfiguration::initializeModel() {

    m_recording_mode_isSet = false;
    m_recording_mode_isValid = false;
    ...
    m_target_interval_seconds_isSet = false;
    m_target_interval_seconds_isValid = false;
}

void OAICreateRecordingConfiguration_request_thumbnailConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfiguration_request_thumbnailConfiguration::fromJsonObject(QJsonObject json) {

    m_recording_mode_isValid = ::OpenAPI::fromJsonValue(m_recording_mode, json[QString("recordingMode")]);
    m_recording_mode_isSet = !json[QString("recordingMode")].isNull() && m_recording_mode_isValid;
    ...
    m_target_interval_seconds_isValid = ::OpenAPI::fromJsonValue(m_target_interval_seconds, json[QString("targetIntervalSeconds")]);
    m_target_interval_seconds_isSet = !json[QString("targetIntervalSeconds")].isNull() && m_target_interval_seconds_isValid;
}

QString OAICreateRecordingConfiguration_request_thumbnailConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfiguration_request_thumbnailConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_recording_mode.isSet()) {
        obj.insert(QString("recordingMode"), ::OpenAPI::toJsonValue(m_recording_mode));
    }
    ...
    if (m_target_interval_seconds_isSet) {
        obj.insert(QString("targetIntervalSeconds"), ::OpenAPI::toJsonValue(m_target_interval_seconds));
    }
    return obj;
}

OAIRecordingMode OAICreateRecordingConfiguration_request_thumbnailConfiguration::getRecordingMode() const {
    return m_recording_mode;
}
void OAICreateRecordingConfiguration_request_thumbnailConfiguration::setRecordingMode(const OAIRecordingMode &recording_mode) {
    m_recording_mode = recording_mode;
    m_recording_mode_isSet = true;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_recording_mode_Set() const{
    return m_recording_mode_isSet;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_recording_mode_Valid() const{
    return m_recording_mode_isValid;
}

OAIThumbnailConfigurationResolution OAICreateRecordingConfiguration_request_thumbnailConfiguration::getResolution() const {
    return m_resolution;
}
void OAICreateRecordingConfiguration_request_thumbnailConfiguration::setResolution(const OAIThumbnailConfigurationResolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_resolution_Valid() const{
    return m_resolution_isValid;
}

QList OAICreateRecordingConfiguration_request_thumbnailConfiguration::getStorage() const {
    return m_storage;
}
void OAICreateRecordingConfiguration_request_thumbnailConfiguration::setStorage(const QList &storage) {
    m_storage = storage;
    m_storage_isSet = true;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_storage_Set() const{
    return m_storage_isSet;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_storage_Valid() const{
    return m_storage_isValid;
}

qint32 OAICreateRecordingConfiguration_request_thumbnailConfiguration::getTargetIntervalSeconds() const {
    return m_target_interval_seconds;
}
void OAICreateRecordingConfiguration_request_thumbnailConfiguration::setTargetIntervalSeconds(const qint32 &target_interval_seconds) {
    m_target_interval_seconds = target_interval_seconds;
    m_target_interval_seconds_isSet = true;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_target_interval_seconds_Set() const{
    return m_target_interval_seconds_isSet;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::is_target_interval_seconds_Valid() const{
    return m_target_interval_seconds_isValid;
}

bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::isSet() const {
...
bool OAICreateRecordingConfiguration_request_thumbnailConfiguration::isValid() const {
