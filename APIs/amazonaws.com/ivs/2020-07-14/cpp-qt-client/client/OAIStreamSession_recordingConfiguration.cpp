...
#include "OAIStreamSession_recordingConfiguration.h"
...
OAIStreamSession_recordingConfiguration::OAIStreamSession_recordingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSession_recordingConfiguration::OAIStreamSession_recordingConfiguration() {
    this->initializeModel();
}

OAIStreamSession_recordingConfiguration::~OAIStreamSession_recordingConfiguration() {}

void OAIStreamSession_recordingConfiguration::initializeModel() {
...
void OAIStreamSession_recordingConfiguration::fromJson(QString jsonString) {
...
void OAIStreamSession_recordingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIStreamSession_recordingConfiguration::asJson() const {
...
QJsonObject OAIStreamSession_recordingConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamSession_recordingConfiguration::getArn() const {
    return m_arn;
}
void OAIStreamSession_recordingConfiguration::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIRecordingConfiguration_destinationConfiguration OAIStreamSession_recordingConfiguration::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAIStreamSession_recordingConfiguration::setDestinationConfiguration(const OAIRecordingConfiguration_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAIStreamSession_recordingConfiguration::getName() const {
    return m_name;
}
void OAIStreamSession_recordingConfiguration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIStreamSession_recordingConfiguration::getRecordingReconnectWindowSeconds() const {
    return m_recording_reconnect_window_seconds;
}
void OAIStreamSession_recordingConfiguration::setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds) {
    m_recording_reconnect_window_seconds = recording_reconnect_window_seconds;
    m_recording_reconnect_window_seconds_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_recording_reconnect_window_seconds_Set() const{
    return m_recording_reconnect_window_seconds_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_recording_reconnect_window_seconds_Valid() const{
    return m_recording_reconnect_window_seconds_isValid;
}

OAICreateRecordingConfigurationRequest_renditionConfiguration OAIStreamSession_recordingConfiguration::getRenditionConfiguration() const {
    return m_rendition_configuration;
}
void OAIStreamSession_recordingConfiguration::setRenditionConfiguration(const OAICreateRecordingConfigurationRequest_renditionConfiguration &rendition_configuration) {
    m_rendition_configuration = rendition_configuration;
    m_rendition_configuration_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_rendition_configuration_Set() const{
    return m_rendition_configuration_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_rendition_configuration_Valid() const{
    return m_rendition_configuration_isValid;
}

OAIRecordingConfigurationState OAIStreamSession_recordingConfiguration::getState() const {
    return m_state;
}
void OAIStreamSession_recordingConfiguration::setState(const OAIRecordingConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_state_Set() const{
    return m_state_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_state_Valid() const{
    return m_state_isValid;
}

QMap OAIStreamSession_recordingConfiguration::getTags() const {
    return m_tags;
}
void OAIStreamSession_recordingConfiguration::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateRecordingConfigurationRequest_thumbnailConfiguration OAIStreamSession_recordingConfiguration::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAIStreamSession_recordingConfiguration::setThumbnailConfiguration(const OAICreateRecordingConfigurationRequest_thumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAIStreamSession_recordingConfiguration::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAIStreamSession_recordingConfiguration::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAIStreamSession_recordingConfiguration::isSet() const {
...
bool OAIStreamSession_recordingConfiguration::isValid() const {
