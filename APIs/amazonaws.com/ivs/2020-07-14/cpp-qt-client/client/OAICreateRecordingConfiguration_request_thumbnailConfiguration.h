...
/*
 * OAICreateRecordingConfiguration_request_thumbnailConfiguration.h
 *
 * An object representing a configuration of thumbnails for recorded video.
 */

#ifndef OAICreateRecordingConfiguration_request_thumbnailConfiguration_H
#define OAICreateRecordingConfiguration_request_thumbnailConfiguration_H

#include <QJsonObject>

#include "OAIRecordingMode.h"
#include "OAIThumbnailConfigurationResolution.h"
#include <QList>
...
class OAICreateRecordingConfiguration_request_thumbnailConfiguration : public OAIObject {
public:
    OAICreateRecordingConfiguration_request_thumbnailConfiguration();
    OAICreateRecordingConfiguration_request_thumbnailConfiguration(QString json);
    ~OAICreateRecordingConfiguration_request_thumbnailConfiguration() override;
    ...
    OAIRecordingMode getRecordingMode() const;
    void setRecordingMode(const OAIRecordingMode &recording_mode);
    bool is_recording_mode_Set() const;
    bool is_recording_mode_Valid() const;

    OAIThumbnailConfigurationResolution getResolution() const;
    void setResolution(const OAIThumbnailConfigurationResolution &resolution);
    ...
    qint32 getTargetIntervalSeconds() const;
    void setTargetIntervalSeconds(const qint32 &target_interval_seconds);
    bool is_target_interval_seconds_Set() const;
    bool is_target_interval_seconds_Valid() const;
...
private:
    ...
    OAIRecordingMode m_recording_mode;
    bool m_recording_mode_isSet;
    bool m_recording_mode_isValid;

    OAIThumbnailConfigurationResolution m_resolution;
    ...
    qint32 m_target_interval_seconds;
    bool m_target_interval_seconds_isSet;
    bool m_target_interval_seconds_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateRecordingConfiguration_request_thumbnailConfiguration)

#endif // OAICreateRecordingConfiguration_request_thumbnailConfiguration_H
