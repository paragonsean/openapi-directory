...
#include "OAICreateRecordingConfiguration_request_renditionConfiguration.h"
...
OAICreateRecordingConfiguration_request_renditionConfiguration::OAICreateRecordingConfiguration_request_renditionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfiguration_request_renditionConfiguration::OAICreateRecordingConfiguration_request_renditionConfiguration() {
    this->initializeModel();
}

OAICreateRecordingConfiguration_request_renditionConfiguration::~OAICreateRecordingConfiguration_request_renditionConfiguration() {}

void OAICreateRecordingConfiguration_request_renditionConfiguration::initializeModel() {

    m_rendition_selection_isSet = false;
    m_rendition_selection_isValid = false;

    m_renditions_isSet = false;
    m_renditions_isValid = false;
}

void OAICreateRecordingConfiguration_request_renditionConfiguration::fromJson(QString jsonString) {
...
void OAICreateRecordingConfiguration_request_renditionConfiguration::fromJsonObject(QJsonObject json) {

    m_rendition_selection_isValid = ::OpenAPI::fromJsonValue(m_rendition_selection, json[QString("renditionSelection")]);
    m_rendition_selection_isSet = !json[QString("renditionSelection")].isNull() && m_rendition_selection_isValid;
...
QString OAICreateRecordingConfiguration_request_renditionConfiguration::asJson() const {
...
QJsonObject OAICreateRecordingConfiguration_request_renditionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_rendition_selection.isSet()) {
        obj.insert(QString("renditionSelection"), ::OpenAPI::toJsonValue(m_rendition_selection));
    }
    if (m_renditions.isSet()) {
        obj.insert(QString("renditions"), ::OpenAPI::toJsonValue(m_renditions));
    }
    return obj;
}

OAIRenditionConfigurationRenditionSelection OAICreateRecordingConfiguration_request_renditionConfiguration::getRenditionSelection() const {
    return m_rendition_selection;
}
void OAICreateRecordingConfiguration_request_renditionConfiguration::setRenditionSelection(const OAIRenditionConfigurationRenditionSelection &rendition_selection) {
    m_rendition_selection = rendition_selection;
    m_rendition_selection_isSet = true;
}

bool OAICreateRecordingConfiguration_request_renditionConfiguration::is_rendition_selection_Set() const{
    return m_rendition_selection_isSet;
}

bool OAICreateRecordingConfiguration_request_renditionConfiguration::is_rendition_selection_Valid() const{
    return m_rendition_selection_isValid;
}

QList OAICreateRecordingConfiguration_request_renditionConfiguration::getRenditions() const {
    return m_renditions;
}
void OAICreateRecordingConfiguration_request_renditionConfiguration::setRenditions(const QList &renditions) {
    m_renditions = renditions;
    m_renditions_isSet = true;
}

bool OAICreateRecordingConfiguration_request_renditionConfiguration::is_renditions_Set() const{
    return m_renditions_isSet;
}

bool OAICreateRecordingConfiguration_request_renditionConfiguration::is_renditions_Valid() const{
    return m_renditions_isValid;
}

bool OAICreateRecordingConfiguration_request_renditionConfiguration::isSet() const {
...
bool OAICreateRecordingConfiguration_request_renditionConfiguration::isValid() const {
