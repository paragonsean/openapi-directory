...
OAIIngestConfiguration_video::OAIIngestConfiguration_video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIngestConfiguration_video::OAIIngestConfiguration_video() {
    this->initializeModel();
}

OAIIngestConfiguration_video::~OAIIngestConfiguration_video() {}

void OAIIngestConfiguration_video::initializeModel() {

    m_avc_level_isSet = false;
    m_avc_level_isValid = false;

    m_avc_profile_isSet = false;
    m_avc_profile_isValid = false;
    ...
    m_target_framerate_isSet = false;
    m_target_framerate_isValid = false;
...
void OAIIngestConfiguration_video::fromJson(QString jsonString) {
...
void OAIIngestConfiguration_video::fromJsonObject(QJsonObject json) {

    m_avc_level_isValid = ::OpenAPI::fromJsonValue(m_avc_level, json[QString("avcLevel")]);
    m_avc_level_isSet = !json[QString("avcLevel")].isNull() && m_avc_level_isValid;

    m_avc_profile_isValid = ::OpenAPI::fromJsonValue(m_avc_profile, json[QString("avcProfile")]);
    m_avc_profile_isSet = !json[QString("avcProfile")].isNull() && m_avc_profile_isValid;
    ...
    m_target_framerate_isValid = ::OpenAPI::fromJsonValue(m_target_framerate, json[QString("targetFramerate")]);
    m_target_framerate_isSet = !json[QString("targetFramerate")].isNull() && m_target_framerate_isValid;

    m_video_height_isValid = ::OpenAPI::fromJsonValue(m_video_height, json[QString("videoHeight")]);
    m_video_height_isSet = !json[QString("videoHeight")].isNull() && m_video_height_isValid;

    m_video_width_isValid = ::OpenAPI::fromJsonValue(m_video_width, json[QString("videoWidth")]);
    m_video_width_isSet = !json[QString("videoWidth")].isNull() && m_video_width_isValid;
}

QString OAIIngestConfiguration_video::asJson() const {
...
QJsonObject OAIIngestConfiguration_video::asJsonObject() const {
    QJsonObject obj;
    if (m_avc_level_isSet) {
        obj.insert(QString("avcLevel"), ::OpenAPI::toJsonValue(m_avc_level));
    }
    if (m_avc_profile_isSet) {
        obj.insert(QString("avcProfile"), ::OpenAPI::toJsonValue(m_avc_profile));
    }
    if (m_codec_isSet) {
    ...
    if (m_target_framerate_isSet) {
        obj.insert(QString("targetFramerate"), ::OpenAPI::toJsonValue(m_target_framerate));
    }
    if (m_video_height_isSet) {
        obj.insert(QString("videoHeight"), ::OpenAPI::toJsonValue(m_video_height));
    }
    if (m_video_width_isSet) {
        obj.insert(QString("videoWidth"), ::OpenAPI::toJsonValue(m_video_width));
    }
    return obj;
}

QString OAIIngestConfiguration_video::getAvcLevel() const {
    return m_avc_level;
}
void OAIIngestConfiguration_video::setAvcLevel(const QString &avc_level) {
    m_avc_level = avc_level;
    m_avc_level_isSet = true;
}

bool OAIIngestConfiguration_video::is_avc_level_Set() const{
    return m_avc_level_isSet;
}

bool OAIIngestConfiguration_video::is_avc_level_Valid() const{
    return m_avc_level_isValid;
}

QString OAIIngestConfiguration_video::getAvcProfile() const {
    return m_avc_profile;
}
void OAIIngestConfiguration_video::setAvcProfile(const QString &avc_profile) {
    m_avc_profile = avc_profile;
    m_avc_profile_isSet = true;
}

bool OAIIngestConfiguration_video::is_avc_profile_Set() const{
    return m_avc_profile_isSet;
}

bool OAIIngestConfiguration_video::is_avc_profile_Valid() const{
    return m_avc_profile_isValid;
}

QString OAIIngestConfiguration_video::getCodec() const {
    return m_codec;
}
void OAIIngestConfiguration_video::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIIngestConfiguration_video::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIIngestConfiguration_video::is_codec_Valid() const{
    return m_codec_isValid;
}

QString OAIIngestConfiguration_video::getEncoder() const {
    return m_encoder;
}
void OAIIngestConfiguration_video::setEncoder(const QString &encoder) {
    m_encoder = encoder;
    m_encoder_isSet = true;
}

bool OAIIngestConfiguration_video::is_encoder_Set() const{
    return m_encoder_isSet;
}

bool OAIIngestConfiguration_video::is_encoder_Valid() const{
    return m_encoder_isValid;
}

qint32 OAIIngestConfiguration_video::getTargetBitrate() const {
    return m_target_bitrate;
}
void OAIIngestConfiguration_video::setTargetBitrate(const qint32 &target_bitrate) {
    m_target_bitrate = target_bitrate;
    m_target_bitrate_isSet = true;
}

bool OAIIngestConfiguration_video::is_target_bitrate_Set() const{
    return m_target_bitrate_isSet;
}

bool OAIIngestConfiguration_video::is_target_bitrate_Valid() const{
    return m_target_bitrate_isValid;
}

qint32 OAIIngestConfiguration_video::getTargetFramerate() const {
    return m_target_framerate;
}
void OAIIngestConfiguration_video::setTargetFramerate(const qint32 &target_framerate) {
    m_target_framerate = target_framerate;
    m_target_framerate_isSet = true;
}

bool OAIIngestConfiguration_video::is_target_framerate_Set() const{
    return m_target_framerate_isSet;
}

bool OAIIngestConfiguration_video::is_target_framerate_Valid() const{
    return m_target_framerate_isValid;
}

qint32 OAIIngestConfiguration_video::getVideoHeight() const {
    return m_video_height;
}
void OAIIngestConfiguration_video::setVideoHeight(const qint32 &video_height) {
    m_video_height = video_height;
    m_video_height_isSet = true;
}

bool OAIIngestConfiguration_video::is_video_height_Set() const{
    return m_video_height_isSet;
}

bool OAIIngestConfiguration_video::is_video_height_Valid() const{
    return m_video_height_isValid;
}

qint32 OAIIngestConfiguration_video::getVideoWidth() const {
    return m_video_width;
}
void OAIIngestConfiguration_video::setVideoWidth(const qint32 &video_width) {
    m_video_width = video_width;
    m_video_width_isSet = true;
}

bool OAIIngestConfiguration_video::is_video_width_Set() const{
    return m_video_width_isSet;
}

bool OAIIngestConfiguration_video::is_video_width_Valid() const{
    return m_video_width_isValid;
}

bool OAIIngestConfiguration_video::isSet() const {
...
bool OAIIngestConfiguration_video::isValid() const {
