...
OAIListPlaybackKeyPairsResponse::OAIListPlaybackKeyPairsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPlaybackKeyPairsResponse::OAIListPlaybackKeyPairsResponse() {
    this->initializeModel();
}

OAIListPlaybackKeyPairsResponse::~OAIListPlaybackKeyPairsResponse() {}

void OAIListPlaybackKeyPairsResponse::initializeModel() {

    m_key_pairs_isSet = false;
    m_key_pairs_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListPlaybackKeyPairsResponse::fromJson(QString jsonString) {
...
void OAIListPlaybackKeyPairsResponse::fromJsonObject(QJsonObject json) {

    m_key_pairs_isValid = ::OpenAPI::fromJsonValue(m_key_pairs, json[QString("keyPairs")]);
    m_key_pairs_isSet = !json[QString("keyPairs")].isNull() && m_key_pairs_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListPlaybackKeyPairsResponse::asJson() const {
...
QJsonObject OAIListPlaybackKeyPairsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_pairs.isSet()) {
        obj.insert(QString("keyPairs"), ::OpenAPI::toJsonValue(m_key_pairs));
    }
...
QList OAIListPlaybackKeyPairsResponse::getKeyPairs() const {
    return m_key_pairs;
}
void OAIListPlaybackKeyPairsResponse::setKeyPairs(const QList &key_pairs) {
    m_key_pairs = key_pairs;
    m_key_pairs_isSet = true;
}

bool OAIListPlaybackKeyPairsResponse::is_key_pairs_Set() const{
    return m_key_pairs_isSet;
}

bool OAIListPlaybackKeyPairsResponse::is_key_pairs_Valid() const{
    return m_key_pairs_isValid;
}

QString OAIListPlaybackKeyPairsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListPlaybackKeyPairsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPlaybackKeyPairsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPlaybackKeyPairsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPlaybackKeyPairsResponse::isSet() const {
...
bool OAIListPlaybackKeyPairsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_pairs_isValid && true;
}
