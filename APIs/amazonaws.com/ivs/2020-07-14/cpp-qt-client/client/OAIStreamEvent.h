...
#ifndef OAIStreamEvent_H
#define OAIStreamEvent_H
...
class OAIStreamEvent : public OAIObject {
public:
    OAIStreamEvent();
    OAIStreamEvent(QString json);
    ~OAIStreamEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamEvent)

#endif // OAIStreamEvent_H
