...
/*
 * OAIPlaybackKeyPairSummary.h
 *
 * Summary information about a playback key pair.
 */

#ifndef OAIPlaybackKeyPairSummary_H
#define OAIPlaybackKeyPairSummary_H
...
class OAIPlaybackKeyPairSummary : public OAIObject {
public:
    OAIPlaybackKeyPairSummary();
    OAIPlaybackKeyPairSummary(QString json);
    ~OAIPlaybackKeyPairSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaybackKeyPairSummary)

#endif // OAIPlaybackKeyPairSummary_H
