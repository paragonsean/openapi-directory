...
/*
 * OAIListStreamSessions_request.h
 *
 * 
 */

#ifndef OAIListStreamSessions_request_H
#define OAIListStreamSessions_request_H
...
class OAIListStreamSessions_request : public OAIObject {
public:
    OAIListStreamSessions_request();
    OAIListStreamSessions_request(QString json);
    ~OAIListStreamSessions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamSessions_request)

#endif // OAIListStreamSessions_request_H
