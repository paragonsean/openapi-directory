...
#include "OAIPutMetadataRequest.h"
...
OAIPutMetadataRequest::OAIPutMetadataRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutMetadataRequest::OAIPutMetadataRequest() {
    this->initializeModel();
}

OAIPutMetadataRequest::~OAIPutMetadataRequest() {}

void OAIPutMetadataRequest::initializeModel() {
...
void OAIPutMetadataRequest::fromJson(QString jsonString) {
...
void OAIPutMetadataRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutMetadataRequest::asJson() const {
...
QJsonObject OAIPutMetadataRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutMetadataRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIPutMetadataRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIPutMetadataRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIPutMetadataRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIPutMetadataRequest::getMetadata() const {
    return m_metadata;
}
void OAIPutMetadataRequest::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIPutMetadataRequest::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIPutMetadataRequest::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIPutMetadataRequest::isSet() const {
...
bool OAIPutMetadataRequest::isValid() const {
