...
QString OAIDeleteChannelRequest::getArn() const {
    return m_arn;
}
void OAIDeleteChannelRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteChannelRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteChannelRequest::is_arn_Valid() const{
