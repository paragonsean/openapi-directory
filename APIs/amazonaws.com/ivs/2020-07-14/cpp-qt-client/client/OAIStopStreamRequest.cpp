...
#include "OAIStopStreamRequest.h"
...
OAIStopStreamRequest::OAIStopStreamRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopStreamRequest::OAIStopStreamRequest() {
    this->initializeModel();
}

OAIStopStreamRequest::~OAIStopStreamRequest() {}

void OAIStopStreamRequest::initializeModel() {

    m_channel_arn_isSet = false;
    m_channel_arn_isValid = false;
}

void OAIStopStreamRequest::fromJson(QString jsonString) {
...
void OAIStopStreamRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopStreamRequest::asJson() const {
...
QJsonObject OAIStopStreamRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopStreamRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIStopStreamRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStopStreamRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStopStreamRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

bool OAIStopStreamRequest::isSet() const {
...
bool OAIStopStreamRequest::isValid() const {
