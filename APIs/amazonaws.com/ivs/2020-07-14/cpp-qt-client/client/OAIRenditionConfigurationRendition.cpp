...
#include "OAIRenditionConfigurationRendition.h"
...
OAIRenditionConfigurationRendition::OAIRenditionConfigurationRendition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRenditionConfigurationRendition::OAIRenditionConfigurationRendition() {
    this->initializeModel();
}

OAIRenditionConfigurationRendition::~OAIRenditionConfigurationRendition() {}

void OAIRenditionConfigurationRendition::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRenditionConfigurationRendition::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRenditionConfigurationRendition::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FULL_HD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRendition::FULL_HD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRendition::HD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRendition::SD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOWEST_RESOLUTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRenditionConfigurationRendition::LOWEST_RESOLUTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRenditionConfigurationRendition::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRenditionConfigurationRendition::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRenditionConfigurationRendition::FULL_HD:
            val = "FULL_HD";
            break;
        case eOAIRenditionConfigurationRendition::HD:
            val = "HD";
            break;
        case eOAIRenditionConfigurationRendition::SD:
            val = "SD";
            break;
        case eOAIRenditionConfigurationRendition::LOWEST_RESOLUTION:
...
QJsonValue OAIRenditionConfigurationRendition::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRenditionConfigurationRendition::eOAIRenditionConfigurationRendition OAIRenditionConfigurationRendition::getValue() const {
    return m_value;
}

void OAIRenditionConfigurationRendition::setValue(const OAIRenditionConfigurationRendition::eOAIRenditionConfigurationRendition& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRenditionConfigurationRendition::isSet() const {
    
    return m_value_isSet;
}

bool OAIRenditionConfigurationRendition::isValid() const {
