...
OAIGetStreamKey_request::OAIGetStreamKey_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamKey_request::OAIGetStreamKey_request() {
    this->initializeModel();
}

OAIGetStreamKey_request::~OAIGetStreamKey_request() {}

void OAIGetStreamKey_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetStreamKey_request::fromJson(QString jsonString) {
...
void OAIGetStreamKey_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetStreamKey_request::asJson() const {
...
QJsonObject OAIGetStreamKey_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetStreamKey_request::getArn() const {
    return m_arn;
}
void OAIGetStreamKey_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetStreamKey_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetStreamKey_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetStreamKey_request::isSet() const {
...
bool OAIGetStreamKey_request::isValid() const {
