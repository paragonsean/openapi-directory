...
/*
 * OAIListRecordingConfigurations_request.h
 *
 * 
 */

#ifndef OAIListRecordingConfigurations_request_H
#define OAIListRecordingConfigurations_request_H
...
class OAIListRecordingConfigurations_request : public OAIObject {
public:
    OAIListRecordingConfigurations_request();
    OAIListRecordingConfigurations_request(QString json);
    ~OAIListRecordingConfigurations_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRecordingConfigurations_request)

#endif // OAIListRecordingConfigurations_request_H
