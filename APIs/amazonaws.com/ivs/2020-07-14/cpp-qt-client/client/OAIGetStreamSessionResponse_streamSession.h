...
/*
 * OAIGetStreamSessionResponse_streamSession.h
 *
 * 
 */

#ifndef OAIGetStreamSessionResponse_streamSession_H
#define OAIGetStreamSessionResponse_streamSession_H

#include <QJsonObject>

#include "OAIStreamSession_channel.h"
...
namespace OpenAPI {
class OAIStreamSession_channel;
class OAIStreamSession_ingestConfiguration;
class OAIStreamSession_recordingConfiguration;

class OAIGetStreamSessionResponse_streamSession : public OAIObject {
public:
    OAIGetStreamSessionResponse_streamSession();
    OAIGetStreamSessionResponse_streamSession(QString json);
    ~OAIGetStreamSessionResponse_streamSession() override;
    ...
    OAIStreamSession_channel getChannel() const;
    void setChannel(const OAIStreamSession_channel &channel);
    ...
    OAIStreamSession_ingestConfiguration getIngestConfiguration() const;
    void setIngestConfiguration(const OAIStreamSession_ingestConfiguration &ingest_configuration);
    bool is_ingest_configuration_Set() const;
    bool is_ingest_configuration_Valid() const;

    OAIStreamSession_recordingConfiguration getRecordingConfiguration() const;
    void setRecordingConfiguration(const OAIStreamSession_recordingConfiguration &recording_configuration);
    bool is_recording_configuration_Set() const;
    bool is_recording_configuration_Valid() const;
    ...
    QList getTruncatedEvents() const;
    void setTruncatedEvents(const QList &truncated_events);
    bool is_truncated_events_Set() const;
    bool is_truncated_events_Valid() const;
...
private:
    ...
    OAIStreamSession_channel m_channel;
    ...
    OAIStreamSession_ingestConfiguration m_ingest_configuration;
    bool m_ingest_configuration_isSet;
    bool m_ingest_configuration_isValid;

    OAIStreamSession_recordingConfiguration m_recording_configuration;
    bool m_recording_configuration_isSet;
    bool m_recording_configuration_isValid;
    ...
    QList m_truncated_events;
    bool m_truncated_events_isSet;
    bool m_truncated_events_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetStreamSessionResponse_streamSession)

#endif // OAIGetStreamSessionResponse_streamSession_H
