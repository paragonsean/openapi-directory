...
QString OAIGetChannelRequest::getArn() const {
    return m_arn;
}
void OAIGetChannelRequest::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetChannelRequest::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetChannelRequest::is_arn_Valid() const{
