...
/*
 * OAIStartViewerSessionRevocationRequest.h
 *
 * 
 */

#ifndef OAIStartViewerSessionRevocationRequest_H
#define OAIStartViewerSessionRevocationRequest_H
...
class OAIStartViewerSessionRevocationRequest : public OAIObject {
public:
    OAIStartViewerSessionRevocationRequest();
    OAIStartViewerSessionRevocationRequest(QString json);
    ~OAIStartViewerSessionRevocationRequest() override;
    ...
    qint32 getViewerSessionVersionsLessThanOrEqualTo() const;
    void setViewerSessionVersionsLessThanOrEqualTo(const qint32 &viewer_session_versions_less_than_or_equal_to);
    bool is_viewer_session_versions_less_than_or_equal_to_Set() const;
    bool is_viewer_session_versions_less_than_or_equal_to_Valid() const;
...
private:
    ...
    qint32 m_viewer_session_versions_less_than_or_equal_to;
    bool m_viewer_session_versions_less_than_or_equal_to_isSet;
    bool m_viewer_session_versions_less_than_or_equal_to_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartViewerSessionRevocationRequest)

#endif // OAIStartViewerSessionRevocationRequest_H
