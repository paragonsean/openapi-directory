...
void OAIChannelType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("BASIC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelType::BASIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STANDARD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelType::STANDARD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADVANCED_SD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelType::ADVANCED_SD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADVANCED_HD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChannelType::ADVANCED_HD;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIChannelType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIChannelType::BASIC:
            val = "BASIC";
            break;
        case eOAIChannelType::STANDARD:
            val = "STANDARD";
            break;
        case eOAIChannelType::ADVANCED_SD:
            val = "ADVANCED_SD";
            break;
        case eOAIChannelType::ADVANCED_HD:
            val = "ADVANCED_HD";
            break;
        default:
            break;
