...
OAIListStreamSessions_request::OAIListStreamSessions_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamSessions_request::OAIListStreamSessions_request() {
    this->initializeModel();
}

OAIListStreamSessions_request::~OAIListStreamSessions_request() {}

void OAIListStreamSessions_request::initializeModel() {
...
void OAIListStreamSessions_request::fromJson(QString jsonString) {
...
void OAIListStreamSessions_request::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamSessions_request::asJson() const {
...
QJsonObject OAIListStreamSessions_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStreamSessions_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIListStreamSessions_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIListStreamSessions_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIListStreamSessions_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

qint32 OAIListStreamSessions_request::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamSessions_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamSessions_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamSessions_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStreamSessions_request::getNextToken() const {
    return m_next_token;
}
void OAIListStreamSessions_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamSessions_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamSessions_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStreamSessions_request::isSet() const {
...
bool OAIListStreamSessions_request::isValid() const {
