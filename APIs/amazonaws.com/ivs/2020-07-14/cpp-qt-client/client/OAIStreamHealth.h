...
#ifndef OAIStreamHealth_H
#define OAIStreamHealth_H
...
class OAIStreamHealth : public OAIEnum {
public:
    OAIStreamHealth();
    OAIStreamHealth(QString json);
    ~OAIStreamHealth() override;
    ...
    enum class eOAIStreamHealth {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        HEALTHY, 
        STARVING, 
        UNKNOWN
    };
    OAIStreamHealth::eOAIStreamHealth getValue() const;
    void setValue(const OAIStreamHealth::eOAIStreamHealth& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamHealth)

#endif // OAIStreamHealth_H
