...
OAICreateRecordingConfiguration_request::OAICreateRecordingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRecordingConfiguration_request::OAICreateRecordingConfiguration_request() {
    this->initializeModel();
}

OAICreateRecordingConfiguration_request::~OAICreateRecordingConfiguration_request() {}

void OAICreateRecordingConfiguration_request::initializeModel() {
...
void OAICreateRecordingConfiguration_request::fromJson(QString jsonString) {
...
void OAICreateRecordingConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateRecordingConfiguration_request::asJson() const {
...
QJsonObject OAICreateRecordingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRecordingConfiguration_request_destinationConfiguration OAICreateRecordingConfiguration_request::getDestinationConfiguration() const {
    return m_destination_configuration;
}
void OAICreateRecordingConfiguration_request::setDestinationConfiguration(const OAICreateRecordingConfiguration_request_destinationConfiguration &destination_configuration) {
    m_destination_configuration = destination_configuration;
    m_destination_configuration_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_destination_configuration_Set() const{
    return m_destination_configuration_isSet;
}

bool OAICreateRecordingConfiguration_request::is_destination_configuration_Valid() const{
    return m_destination_configuration_isValid;
}

QString OAICreateRecordingConfiguration_request::getName() const {
    return m_name;
}
void OAICreateRecordingConfiguration_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateRecordingConfiguration_request::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAICreateRecordingConfiguration_request::getRecordingReconnectWindowSeconds() const {
    return m_recording_reconnect_window_seconds;
}
void OAICreateRecordingConfiguration_request::setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds) {
    m_recording_reconnect_window_seconds = recording_reconnect_window_seconds;
    m_recording_reconnect_window_seconds_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_recording_reconnect_window_seconds_Set() const{
    return m_recording_reconnect_window_seconds_isSet;
}

bool OAICreateRecordingConfiguration_request::is_recording_reconnect_window_seconds_Valid() const{
    return m_recording_reconnect_window_seconds_isValid;
}

OAICreateRecordingConfiguration_request_renditionConfiguration OAICreateRecordingConfiguration_request::getRenditionConfiguration() const {
    return m_rendition_configuration;
}
void OAICreateRecordingConfiguration_request::setRenditionConfiguration(const OAICreateRecordingConfiguration_request_renditionConfiguration &rendition_configuration) {
    m_rendition_configuration = rendition_configuration;
    m_rendition_configuration_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_rendition_configuration_Set() const{
    return m_rendition_configuration_isSet;
}

bool OAICreateRecordingConfiguration_request::is_rendition_configuration_Valid() const{
    return m_rendition_configuration_isValid;
}

QMap<QString, QString> OAICreateRecordingConfiguration_request::getTags() const {
    return m_tags;
}
void OAICreateRecordingConfiguration_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRecordingConfiguration_request::is_tags_Valid() const{
    return m_tags_isValid;
}

OAICreateRecordingConfiguration_request_thumbnailConfiguration OAICreateRecordingConfiguration_request::getThumbnailConfiguration() const {
    return m_thumbnail_configuration;
}
void OAICreateRecordingConfiguration_request::setThumbnailConfiguration(const OAICreateRecordingConfiguration_request_thumbnailConfiguration &thumbnail_configuration) {
    m_thumbnail_configuration = thumbnail_configuration;
    m_thumbnail_configuration_isSet = true;
}

bool OAICreateRecordingConfiguration_request::is_thumbnail_configuration_Set() const{
    return m_thumbnail_configuration_isSet;
}

bool OAICreateRecordingConfiguration_request::is_thumbnail_configuration_Valid() const{
    return m_thumbnail_configuration_isValid;
}

bool OAICreateRecordingConfiguration_request::isSet() const {
...
bool OAICreateRecordingConfiguration_request::isValid() const {
