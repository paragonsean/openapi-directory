...
/*
 * OAIBatchGetChannelResponse.h
 *
 * 
 */

#ifndef OAIBatchGetChannelResponse_H
#define OAIBatchGetChannelResponse_H
...
class OAIBatchGetChannelResponse : public OAIObject {
public:
    OAIBatchGetChannelResponse();
    OAIBatchGetChannelResponse(QString json);
    ~OAIBatchGetChannelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetChannelResponse)

#endif // OAIBatchGetChannelResponse_H
