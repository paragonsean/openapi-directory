...
QString OAIStream::getChannelArn() const {
    return m_channel_arn;
}
void OAIStream::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStream::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStream::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

OAIStreamHealth OAIStream::getHealth() const {
    return m_health;
}
void OAIStream::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIStream::is_health_Set() const{
    return m_health_isSet;
}

bool OAIStream::is_health_Valid() const{
    return m_health_isValid;
}

QString OAIStream::getPlaybackUrl() const {
    return m_playback_url;
}
void OAIStream::setPlaybackUrl(const QString &playback_url) {
    m_playback_url = playback_url;
    m_playback_url_isSet = true;
}

bool OAIStream::is_playback_url_Set() const{
    return m_playback_url_isSet;
}

bool OAIStream::is_playback_url_Valid() const{
    return m_playback_url_isValid;
}

QDateTime OAIStream::getStartTime() const {
    return m_start_time;
}
void OAIStream::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStream::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStream::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIStreamState OAIStream::getState() const {
    return m_state;
}
void OAIStream::setState(const OAIStreamState &state) {
    m_state = state;
    m_state_isSet = true;
}
...
QString OAIStream::getStreamId() const {
    return m_stream_id;
}
void OAIStream::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIStream::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIStream::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

qint32 OAIStream::getViewerCount() const {
    return m_viewer_count;
}
void OAIStream::setViewerCount(const qint32 &viewer_count) {
    m_viewer_count = viewer_count;
    m_viewer_count_isSet = true;
}

bool OAIStream::is_viewer_count_Set() const{
    return m_viewer_count_isSet;
}

bool OAIStream::is_viewer_count_Valid() const{
