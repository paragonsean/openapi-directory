...
OAIStreamKeySummary::OAIStreamKeySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamKeySummary::OAIStreamKeySummary() {
    this->initializeModel();
}

OAIStreamKeySummary::~OAIStreamKeySummary() {}

void OAIStreamKeySummary::initializeModel() {
...
void OAIStreamKeySummary::fromJson(QString jsonString) {
...
void OAIStreamKeySummary::fromJsonObject(QJsonObject json) {
...
QString OAIStreamKeySummary::asJson() const {
...
QJsonObject OAIStreamKeySummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamKeySummary::getArn() const {
    return m_arn;
}
void OAIStreamKeySummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamKeySummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamKeySummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIStreamKeySummary::getChannelArn() const {
    return m_channel_arn;
}
void OAIStreamKeySummary::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStreamKeySummary::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStreamKeySummary::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap OAIStreamKeySummary::getTags() const {
    return m_tags;
}
void OAIStreamKeySummary::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIStreamKeySummary::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIStreamKeySummary::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIStreamKeySummary::isSet() const {
...
bool OAIStreamKeySummary::isValid() const {
