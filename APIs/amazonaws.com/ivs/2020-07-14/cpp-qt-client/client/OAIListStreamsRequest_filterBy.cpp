...
#include "OAIListStreamsRequest_filterBy.h"
...
OAIListStreamsRequest_filterBy::OAIListStreamsRequest_filterBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamsRequest_filterBy::OAIListStreamsRequest_filterBy() {
    this->initializeModel();
}

OAIListStreamsRequest_filterBy::~OAIListStreamsRequest_filterBy() {}

void OAIListStreamsRequest_filterBy::initializeModel() {

    m_health_isSet = false;
    m_health_isValid = false;
}

void OAIListStreamsRequest_filterBy::fromJson(QString jsonString) {
...
void OAIListStreamsRequest_filterBy::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamsRequest_filterBy::asJson() const {
...
QJsonObject OAIListStreamsRequest_filterBy::asJsonObject() const {
    QJsonObject obj;
    if (m_health.isSet()) {
...
OAIStreamHealth OAIListStreamsRequest_filterBy::getHealth() const {
    return m_health;
}
void OAIListStreamsRequest_filterBy::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIListStreamsRequest_filterBy::is_health_Set() const{
    return m_health_isSet;
}

bool OAIListStreamsRequest_filterBy::is_health_Valid() const{
    return m_health_isValid;
}

bool OAIListStreamsRequest_filterBy::isSet() const {
...
bool OAIListStreamsRequest_filterBy::isValid() const {
