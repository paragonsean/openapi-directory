...
/*
 * OAIRecordingConfiguration.h
 *
 * An object representing a configuration to record a channel stream.
 */

#ifndef OAIRecordingConfiguration_H
#define OAIRecordingConfiguration_H

#include <QJsonObject>

#include "OAICreateRecordingConfigurationRequest_renditionConfiguration.h"
#include "OAICreateRecordingConfigurationRequest_thumbnailConfiguration.h"
#include "OAIRecordingConfigurationState.h"
#include "OAIRecordingConfiguration_destinationConfiguration.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIRecordingConfiguration_destinationConfiguration;
class OAICreateRecordingConfigurationRequest_renditionConfiguration;
class OAICreateRecordingConfigurationRequest_thumbnailConfiguration;

class OAIRecordingConfiguration : public OAIObject {
public:
    OAIRecordingConfiguration();
    OAIRecordingConfiguration(QString json);
    ~OAIRecordingConfiguration() override;
    ...
    OAIRecordingConfiguration_destinationConfiguration getDestinationConfiguration() const;
    void setDestinationConfiguration(const OAIRecordingConfiguration_destinationConfiguration &destination_configuration);
    ...
    qint32 getRecordingReconnectWindowSeconds() const;
    void setRecordingReconnectWindowSeconds(const qint32 &recording_reconnect_window_seconds);
    bool is_recording_reconnect_window_seconds_Set() const;
    bool is_recording_reconnect_window_seconds_Valid() const;

    OAICreateRecordingConfigurationRequest_renditionConfiguration getRenditionConfiguration() const;
    void setRenditionConfiguration(const OAICreateRecordingConfigurationRequest_renditionConfiguration &rendition_configuration);
    bool is_rendition_configuration_Set() const;
    bool is_rendition_configuration_Valid() const;

    OAIRecordingConfigurationState getState() const;
    void setState(const OAIRecordingConfigurationState &state);
    ...
    OAICreateRecordingConfigurationRequest_thumbnailConfiguration getThumbnailConfiguration() const;
    void setThumbnailConfiguration(const OAICreateRecordingConfigurationRequest_thumbnailConfiguration &thumbnail_configuration);
...
private:
    ...
    OAIRecordingConfiguration_destinationConfiguration m_destination_configuration;
    ...
    qint32 m_recording_reconnect_window_seconds;
    bool m_recording_reconnect_window_seconds_isSet;
    bool m_recording_reconnect_window_seconds_isValid;

    OAICreateRecordingConfigurationRequest_renditionConfiguration m_rendition_configuration;
    bool m_rendition_configuration_isSet;
    bool m_rendition_configuration_isValid;

    OAIRecordingConfigurationState m_state;
    bool m_state_isSet;
    ...
    OAICreateRecordingConfigurationRequest_thumbnailConfiguration m_thumbnail_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecordingConfiguration)

#endif // OAIRecordingConfiguration_H
