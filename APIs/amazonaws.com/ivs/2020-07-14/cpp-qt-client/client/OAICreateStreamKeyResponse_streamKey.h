...
/*
 * OAICreateStreamKeyResponse_streamKey.h
 *
 * 
 */

#ifndef OAICreateStreamKeyResponse_streamKey_H
#define OAICreateStreamKeyResponse_streamKey_H
...
class OAICreateStreamKeyResponse_streamKey : public OAIObject {
public:
    OAICreateStreamKeyResponse_streamKey();
    OAICreateStreamKeyResponse_streamKey(QString json);
    ~OAICreateStreamKeyResponse_streamKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamKeyResponse_streamKey)

#endif // OAICreateStreamKeyResponse_streamKey_H
