...
OAIStreamSummary::OAIStreamSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSummary::OAIStreamSummary() {
    this->initializeModel();
}

OAIStreamSummary::~OAIStreamSummary() {}

void OAIStreamSummary::initializeModel() {
    ...
    m_viewer_count_isSet = false;
    m_viewer_count_isValid = false;
}

void OAIStreamSummary::fromJson(QString jsonString) {
...
void OAIStreamSummary::fromJsonObject(QJsonObject json) {
    ...
    m_viewer_count_isValid = ::OpenAPI::fromJsonValue(m_viewer_count, json[QString("viewerCount")]);
    m_viewer_count_isSet = !json[QString("viewerCount")].isNull() && m_viewer_count_isValid;
}

QString OAIStreamSummary::asJson() const {
...
QJsonObject OAIStreamSummary::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_viewer_count_isSet) {
        obj.insert(QString("viewerCount"), ::OpenAPI::toJsonValue(m_viewer_count));
    }
    return obj;
}

QString OAIStreamSummary::getChannelArn() const {
    return m_channel_arn;
}
void OAIStreamSummary::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIStreamSummary::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIStreamSummary::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

OAIStreamHealth OAIStreamSummary::getHealth() const {
    return m_health;
}
void OAIStreamSummary::setHealth(const OAIStreamHealth &health) {
    m_health = health;
    m_health_isSet = true;
}

bool OAIStreamSummary::is_health_Set() const{
    return m_health_isSet;
}

bool OAIStreamSummary::is_health_Valid() const{
    return m_health_isValid;
}

QDateTime OAIStreamSummary::getStartTime() const {
    return m_start_time;
}
void OAIStreamSummary::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStreamSummary::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStreamSummary::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIStreamState OAIStreamSummary::getState() const {
    return m_state;
}
void OAIStreamSummary::setState(const OAIStreamState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIStreamSummary::is_state_Set() const{
    return m_state_isSet;
}

bool OAIStreamSummary::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIStreamSummary::getStreamId() const {
    return m_stream_id;
}
void OAIStreamSummary::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIStreamSummary::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIStreamSummary::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

qint32 OAIStreamSummary::getViewerCount() const {
    return m_viewer_count;
}
void OAIStreamSummary::setViewerCount(const qint32 &viewer_count) {
    m_viewer_count = viewer_count;
    m_viewer_count_isSet = true;
}

bool OAIStreamSummary::is_viewer_count_Set() const{
    return m_viewer_count_isSet;
}

bool OAIStreamSummary::is_viewer_count_Valid() const{
    return m_viewer_count_isValid;
}

bool OAIStreamSummary::isSet() const {
...
bool OAIStreamSummary::isValid() const {
