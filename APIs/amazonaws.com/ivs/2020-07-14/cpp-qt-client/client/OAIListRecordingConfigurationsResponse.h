...
/*
 * OAIListRecordingConfigurationsResponse.h
 *
 * 
 */

#ifndef OAIListRecordingConfigurationsResponse_H
#define OAIListRecordingConfigurationsResponse_H
...
class OAIListRecordingConfigurationsResponse : public OAIObject {
public:
    OAIListRecordingConfigurationsResponse();
    OAIListRecordingConfigurationsResponse(QString json);
    ~OAIListRecordingConfigurationsResponse() override;
    ...
    QList getRecordingConfigurations() const;
    void setRecordingConfigurations(const QList &recording_configurations);
    bool is_recording_configurations_Set() const;
    bool is_recording_configurations_Valid() const;
...
private:
    ...
    QList m_recording_configurations;
    bool m_recording_configurations_isSet;
    bool m_recording_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListRecordingConfigurationsResponse)

#endif // OAIListRecordingConfigurationsResponse_H
