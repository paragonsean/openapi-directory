...
OAIListChannels_request::OAIListChannels_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListChannels_request::OAIListChannels_request() {
    this->initializeModel();
}

OAIListChannels_request::~OAIListChannels_request() {}

void OAIListChannels_request::initializeModel() {
...
void OAIListChannels_request::fromJson(QString jsonString) {
...
void OAIListChannels_request::fromJsonObject(QJsonObject json) {
...
QString OAIListChannels_request::asJson() const {
...
QJsonObject OAIListChannels_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListChannels_request::getFilterByName() const {
    return m_filter_by_name;
}
void OAIListChannels_request::setFilterByName(const QString &filter_by_name) {
    m_filter_by_name = filter_by_name;
    m_filter_by_name_isSet = true;
}

bool OAIListChannels_request::is_filter_by_name_Set() const{
    return m_filter_by_name_isSet;
}

bool OAIListChannels_request::is_filter_by_name_Valid() const{
    return m_filter_by_name_isValid;
}

QString OAIListChannels_request::getFilterByRecordingConfigurationArn() const {
    return m_filter_by_recording_configuration_arn;
}
void OAIListChannels_request::setFilterByRecordingConfigurationArn(const QString &filter_by_recording_configuration_arn) {
...
bool OAIListChannels_request::is_filter_by_recording_configuration_arn_Set() const{
    return m_filter_by_recording_configuration_arn_isSet;
}

bool OAIListChannels_request::is_filter_by_recording_configuration_arn_Valid() const{
    return m_filter_by_recording_configuration_arn_isValid;
}

qint32 OAIListChannels_request::getMaxResults() const {
    return m_max_results;
}
void OAIListChannels_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListChannels_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListChannels_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListChannels_request::getNextToken() const {
    return m_next_token;
}
void OAIListChannels_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListChannels_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListChannels_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListChannels_request::isSet() const {
...
bool OAIListChannels_request::isValid() const {
