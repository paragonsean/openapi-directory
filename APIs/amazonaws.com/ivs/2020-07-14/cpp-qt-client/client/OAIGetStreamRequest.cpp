...
OAIGetStreamRequest::OAIGetStreamRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamRequest::OAIGetStreamRequest() {
    this->initializeModel();
}

OAIGetStreamRequest::~OAIGetStreamRequest() {}

void OAIGetStreamRequest::initializeModel() {

    m_channel_arn_isSet = false;
    m_channel_arn_isValid = false;
}

void OAIGetStreamRequest::fromJson(QString jsonString) {
...
void OAIGetStreamRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamRequest::asJson() const {
...
QJsonObject OAIGetStreamRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetStreamRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIGetStreamRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIGetStreamRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIGetStreamRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

bool OAIGetStreamRequest::isSet() const {
...
bool OAIGetStreamRequest::isValid() const {
