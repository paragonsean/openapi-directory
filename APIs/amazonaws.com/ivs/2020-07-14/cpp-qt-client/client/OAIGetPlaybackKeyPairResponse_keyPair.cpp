...
#include "OAIGetPlaybackKeyPairResponse_keyPair.h"
...
OAIGetPlaybackKeyPairResponse_keyPair::OAIGetPlaybackKeyPairResponse_keyPair(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPlaybackKeyPairResponse_keyPair::OAIGetPlaybackKeyPairResponse_keyPair() {
    this->initializeModel();
}

OAIGetPlaybackKeyPairResponse_keyPair::~OAIGetPlaybackKeyPairResponse_keyPair() {}

void OAIGetPlaybackKeyPairResponse_keyPair::initializeModel() {
...
void OAIGetPlaybackKeyPairResponse_keyPair::fromJson(QString jsonString) {
...
void OAIGetPlaybackKeyPairResponse_keyPair::fromJsonObject(QJsonObject json) {
...
QString OAIGetPlaybackKeyPairResponse_keyPair::asJson() const {
...
QJsonObject OAIGetPlaybackKeyPairResponse_keyPair::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetPlaybackKeyPairResponse_keyPair::getArn() const {
    return m_arn;
}
void OAIGetPlaybackKeyPairResponse_keyPair::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIGetPlaybackKeyPairResponse_keyPair::getFingerprint() const {
    return m_fingerprint;
}
void OAIGetPlaybackKeyPairResponse_keyPair::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QString OAIGetPlaybackKeyPairResponse_keyPair::getName() const {
    return m_name;
}
void OAIGetPlaybackKeyPairResponse_keyPair::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_name_Valid() const{
    return m_name_isValid;
}

QMap OAIGetPlaybackKeyPairResponse_keyPair::getTags() const {
    return m_tags;
}
void OAIGetPlaybackKeyPairResponse_keyPair::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetPlaybackKeyPairResponse_keyPair::isSet() const {
...
bool OAIGetPlaybackKeyPairResponse_keyPair::isValid() const {
