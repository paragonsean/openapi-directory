...
OAIStreamSession::OAIStreamSession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamSession::OAIStreamSession() {
    this->initializeModel();
}

OAIStreamSession::~OAIStreamSession() {}

void OAIStreamSession::initializeModel() {
...
void OAIStreamSession::fromJson(QString jsonString) {
...
void OAIStreamSession::fromJsonObject(QJsonObject json) {
...
QString OAIStreamSession::asJson() const {
...
QJsonObject OAIStreamSession::asJsonObject() const {
    QJsonObject obj;
    if (m_channel.isSet()) {
...
OAIStreamSession_channel OAIStreamSession::getChannel() const {
    return m_channel;
}
void OAIStreamSession::setChannel(const OAIStreamSession_channel &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIStreamSession::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIStreamSession::is_channel_Valid() const{
    return m_channel_isValid;
}

QDateTime OAIStreamSession::getEndTime() const {
    return m_end_time;
}
void OAIStreamSession::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIStreamSession::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIStreamSession::is_end_time_Valid() const{
    return m_end_time_isValid;
}

OAIStreamSession_ingestConfiguration OAIStreamSession::getIngestConfiguration() const {
    return m_ingest_configuration;
}
void OAIStreamSession::setIngestConfiguration(const OAIStreamSession_ingestConfiguration &ingest_configuration) {
    m_ingest_configuration = ingest_configuration;
    m_ingest_configuration_isSet = true;
}

bool OAIStreamSession::is_ingest_configuration_Set() const{
    return m_ingest_configuration_isSet;
}

bool OAIStreamSession::is_ingest_configuration_Valid() const{
    return m_ingest_configuration_isValid;
}

OAIStreamSession_recordingConfiguration OAIStreamSession::getRecordingConfiguration() const {
    return m_recording_configuration;
}
void OAIStreamSession::setRecordingConfiguration(const OAIStreamSession_recordingConfiguration &recording_configuration) {
    m_recording_configuration = recording_configuration;
    m_recording_configuration_isSet = true;
}

bool OAIStreamSession::is_recording_configuration_Set() const{
    return m_recording_configuration_isSet;
}

bool OAIStreamSession::is_recording_configuration_Valid() const{
    return m_recording_configuration_isValid;
}

QDateTime OAIStreamSession::getStartTime() const {
    return m_start_time;
}
void OAIStreamSession::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIStreamSession::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIStreamSession::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QString OAIStreamSession::getStreamId() const {
    return m_stream_id;
}
void OAIStreamSession::setStreamId(const QString &stream_id) {
    m_stream_id = stream_id;
    m_stream_id_isSet = true;
}

bool OAIStreamSession::is_stream_id_Set() const{
    return m_stream_id_isSet;
}

bool OAIStreamSession::is_stream_id_Valid() const{
    return m_stream_id_isValid;
}

QList OAIStreamSession::getTruncatedEvents() const {
    return m_truncated_events;
}
void OAIStreamSession::setTruncatedEvents(const QList &truncated_events) {
    m_truncated_events = truncated_events;
    m_truncated_events_isSet = true;
}

bool OAIStreamSession::is_truncated_events_Set() const{
    return m_truncated_events_isSet;
}

bool OAIStreamSession::is_truncated_events_Valid() const{
    return m_truncated_events_isValid;
}

bool OAIStreamSession::isSet() const {
...
bool OAIStreamSession::isValid() const {
