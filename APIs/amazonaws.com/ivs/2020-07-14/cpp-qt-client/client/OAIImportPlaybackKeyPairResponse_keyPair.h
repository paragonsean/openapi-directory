...
/*
 * OAIImportPlaybackKeyPairResponse_keyPair.h
 *
 * 
 */

#ifndef OAIImportPlaybackKeyPairResponse_keyPair_H
#define OAIImportPlaybackKeyPairResponse_keyPair_H
...
class OAIImportPlaybackKeyPairResponse_keyPair : public OAIObject {
public:
    OAIImportPlaybackKeyPairResponse_keyPair();
    OAIImportPlaybackKeyPairResponse_keyPair(QString json);
    ~OAIImportPlaybackKeyPairResponse_keyPair() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportPlaybackKeyPairResponse_keyPair)

#endif // OAIImportPlaybackKeyPairResponse_keyPair_H
