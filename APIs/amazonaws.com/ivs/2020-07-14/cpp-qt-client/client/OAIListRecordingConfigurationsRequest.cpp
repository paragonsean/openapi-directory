...
#include "OAIListRecordingConfigurationsRequest.h"
...
OAIListRecordingConfigurationsRequest::OAIListRecordingConfigurationsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRecordingConfigurationsRequest::OAIListRecordingConfigurationsRequest() {
    this->initializeModel();
}

OAIListRecordingConfigurationsRequest::~OAIListRecordingConfigurationsRequest() {}

void OAIListRecordingConfigurationsRequest::initializeModel() {
...
void OAIListRecordingConfigurationsRequest::fromJson(QString jsonString) {
...
void OAIListRecordingConfigurationsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListRecordingConfigurationsRequest::asJson() const {
...
QJsonObject OAIListRecordingConfigurationsRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListRecordingConfigurationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListRecordingConfigurationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListRecordingConfigurationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListRecordingConfigurationsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListRecordingConfigurationsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListRecordingConfigurationsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRecordingConfigurationsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRecordingConfigurationsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRecordingConfigurationsRequest::isSet() const {
...
bool OAIListRecordingConfigurationsRequest::isValid() const {
