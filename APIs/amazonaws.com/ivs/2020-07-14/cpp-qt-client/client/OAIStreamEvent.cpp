...
OAIStreamEvent::OAIStreamEvent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamEvent::OAIStreamEvent() {
    this->initializeModel();
}

OAIStreamEvent::~OAIStreamEvent() {}

void OAIStreamEvent::initializeModel() {
...
void OAIStreamEvent::fromJson(QString jsonString) {
...
void OAIStreamEvent::fromJsonObject(QJsonObject json) {
...
QString OAIStreamEvent::asJson() const {
...
QJsonObject OAIStreamEvent::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIStreamEvent::getEventTime() const {
    return m_event_time;
}
void OAIStreamEvent::setEventTime(const QDateTime &event_time) {
    m_event_time = event_time;
    m_event_time_isSet = true;
}

bool OAIStreamEvent::is_event_time_Set() const{
    return m_event_time_isSet;
}

bool OAIStreamEvent::is_event_time_Valid() const{
    return m_event_time_isValid;
}

QString OAIStreamEvent::getName() const {
    return m_name;
}
void OAIStreamEvent::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStreamEvent::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStreamEvent::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIStreamEvent::getType() const {
    return m_type;
}
void OAIStreamEvent::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIStreamEvent::is_type_Set() const{
    return m_type_isSet;
}

bool OAIStreamEvent::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIStreamEvent::isSet() const {
...
bool OAIStreamEvent::isValid() const {
