...
/*
 * OAIBatchStartViewerSessionRevocationViewerSession.h
 *
 * A viewer session to revoke in the call to &lt;a&gt;BatchStartViewerSessionRevocation&lt;/a&gt;.
 */

#ifndef OAIBatchStartViewerSessionRevocationViewerSession_H
#define OAIBatchStartViewerSessionRevocationViewerSession_H
...
class OAIBatchStartViewerSessionRevocationViewerSession : public OAIObject {
public:
    OAIBatchStartViewerSessionRevocationViewerSession();
    OAIBatchStartViewerSessionRevocationViewerSession(QString json);
    ~OAIBatchStartViewerSessionRevocationViewerSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchStartViewerSessionRevocationViewerSession)

#endif // OAIBatchStartViewerSessionRevocationViewerSession_H
