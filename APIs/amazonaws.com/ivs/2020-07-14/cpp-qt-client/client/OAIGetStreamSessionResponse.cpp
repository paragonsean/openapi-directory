...
OAIGetStreamSessionResponse::OAIGetStreamSessionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamSessionResponse::OAIGetStreamSessionResponse() {
    this->initializeModel();
}

OAIGetStreamSessionResponse::~OAIGetStreamSessionResponse() {}

void OAIGetStreamSessionResponse::initializeModel() {

    m_stream_session_isSet = false;
    m_stream_session_isValid = false;
}

void OAIGetStreamSessionResponse::fromJson(QString jsonString) {
...
void OAIGetStreamSessionResponse::fromJsonObject(QJsonObject json) {

    m_stream_session_isValid = ::OpenAPI::fromJsonValue(m_stream_session, json[QString("streamSession")]);
    m_stream_session_isSet = !json[QString("streamSession")].isNull() && m_stream_session_isValid;
}

QString OAIGetStreamSessionResponse::asJson() const {
...
QJsonObject OAIGetStreamSessionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_stream_session.isSet()) {
        obj.insert(QString("streamSession"), ::OpenAPI::toJsonValue(m_stream_session));
    }
    return obj;
}

OAIGetStreamSessionResponse_streamSession OAIGetStreamSessionResponse::getStreamSession() const {
    return m_stream_session;
}
void OAIGetStreamSessionResponse::setStreamSession(const OAIGetStreamSessionResponse_streamSession &stream_session) {
    m_stream_session = stream_session;
    m_stream_session_isSet = true;
}

bool OAIGetStreamSessionResponse::is_stream_session_Set() const{
    return m_stream_session_isSet;
}

bool OAIGetStreamSessionResponse::is_stream_session_Valid() const{
    return m_stream_session_isValid;
}

bool OAIGetStreamSessionResponse::isSet() const {
...
bool OAIGetStreamSessionResponse::isValid() const {
