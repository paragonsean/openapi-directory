...
/*
 * OAIRenditionConfiguration.h
 *
 * Object that describes which renditions should be recorded for a stream.
 */

#ifndef OAIRenditionConfiguration_H
#define OAIRenditionConfiguration_H

#include <QJsonObject>

#include "OAIRenditionConfigurationRenditionSelection.h"
#include <QList>
...
class OAIRenditionConfiguration : public OAIObject {
public:
    OAIRenditionConfiguration();
    OAIRenditionConfiguration(QString json);
    ~OAIRenditionConfiguration() override;
    ...
    OAIRenditionConfigurationRenditionSelection getRenditionSelection() const;
    void setRenditionSelection(const OAIRenditionConfigurationRenditionSelection &rendition_selection);
    bool is_rendition_selection_Set() const;
    bool is_rendition_selection_Valid() const;

    QList getRenditions() const;
    void setRenditions(const QList &renditions);
    bool is_renditions_Set() const;
    bool is_renditions_Valid() const;
...
private:
    ...
    OAIRenditionConfigurationRenditionSelection m_rendition_selection;
    bool m_rendition_selection_isSet;
    bool m_rendition_selection_isValid;

    QList m_renditions;
    bool m_renditions_isSet;
    bool m_renditions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRenditionConfiguration)

#endif // OAIRenditionConfiguration_H
