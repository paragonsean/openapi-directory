...
OAIGetStreamKeyResponse::OAIGetStreamKeyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetStreamKeyResponse::OAIGetStreamKeyResponse() {
    this->initializeModel();
}

OAIGetStreamKeyResponse::~OAIGetStreamKeyResponse() {}

void OAIGetStreamKeyResponse::initializeModel() {

    m_stream_key_isSet = false;
    m_stream_key_isValid = false;
}

void OAIGetStreamKeyResponse::fromJson(QString jsonString) {
...
void OAIGetStreamKeyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetStreamKeyResponse::asJson() const {
...
QJsonObject OAIGetStreamKeyResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetStreamKeyResponse_streamKey OAIGetStreamKeyResponse::getStreamKey() const {
    return m_stream_key;
}
void OAIGetStreamKeyResponse::setStreamKey(const OAIGetStreamKeyResponse_streamKey &stream_key) {
    m_stream_key = stream_key;
    m_stream_key_isSet = true;
}

bool OAIGetStreamKeyResponse::is_stream_key_Set() const{
    return m_stream_key_isSet;
}

bool OAIGetStreamKeyResponse::is_stream_key_Valid() const{
    return m_stream_key_isValid;
}

bool OAIGetStreamKeyResponse::isSet() const {
...
bool OAIGetStreamKeyResponse::isValid() const {
