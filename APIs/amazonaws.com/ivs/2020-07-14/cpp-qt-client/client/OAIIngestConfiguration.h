...
/*
 * OAIIngestConfiguration.h
 *
 * Object specifying the ingest configuration set up by the broadcaster, usually in an encoder.
 */

#ifndef OAIIngestConfiguration_H
#define OAIIngestConfiguration_H

#include <QJsonObject>

#include "OAIIngestConfiguration_audio.h"
#include "OAIIngestConfiguration_video.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIIngestConfiguration_audio;
class OAIIngestConfiguration_video;

class OAIIngestConfiguration : public OAIObject {
public:
    OAIIngestConfiguration();
    OAIIngestConfiguration(QString json);
    ~OAIIngestConfiguration() override;
    ...
    OAIIngestConfiguration_audio getAudio() const;
    void setAudio(const OAIIngestConfiguration_audio &audio);
    bool is_audio_Set() const;
    bool is_audio_Valid() const;

    OAIIngestConfiguration_video getVideo() const;
    void setVideo(const OAIIngestConfiguration_video &video);
...
private:
    ...
    OAIIngestConfiguration_audio m_audio;
    bool m_audio_isSet;
    bool m_audio_isValid;

    OAIIngestConfiguration_video m_video;
    bool m_video_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngestConfiguration)

#endif // OAIIngestConfiguration_H
