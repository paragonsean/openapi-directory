...
OAIPutMetadata_request::OAIPutMetadata_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutMetadata_request::OAIPutMetadata_request() {
    this->initializeModel();
}

OAIPutMetadata_request::~OAIPutMetadata_request() {}

void OAIPutMetadata_request::initializeModel() {
...
void OAIPutMetadata_request::fromJson(QString jsonString) {
...
void OAIPutMetadata_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutMetadata_request::asJson() const {
...
QJsonObject OAIPutMetadata_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutMetadata_request::getChannelArn() const {
    return m_channel_arn;
}
void OAIPutMetadata_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIPutMetadata_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIPutMetadata_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAIPutMetadata_request::getMetadata() const {
    return m_metadata;
}
void OAIPutMetadata_request::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIPutMetadata_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIPutMetadata_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIPutMetadata_request::isSet() const {
...
bool OAIPutMetadata_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_channel_arn_isValid && m_metadata_isValid && true;
}
