...
#ifndef OAIStreamSession_H
#define OAIStreamSession_H
...
class OAIStreamSession : public OAIObject {
public:
    OAIStreamSession();
    OAIStreamSession(QString json);
    ~OAIStreamSession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamSession)

#endif // OAIStreamSession_H
