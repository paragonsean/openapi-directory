...
/*
 * OAIListStreamSessionsResponse.h
 *
 * 
 */

#ifndef OAIListStreamSessionsResponse_H
#define OAIListStreamSessionsResponse_H
...
class OAIListStreamSessionsResponse : public OAIObject {
public:
    OAIListStreamSessionsResponse();
    OAIListStreamSessionsResponse(QString json);
    ~OAIListStreamSessionsResponse() override;
    ...
    QList getStreamSessions() const;
    void setStreamSessions(const QList &stream_sessions);
    bool is_stream_sessions_Set() const;
    bool is_stream_sessions_Valid() const;
...
private:
    ...
    QList m_stream_sessions;
    bool m_stream_sessions_isSet;
    bool m_stream_sessions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListStreamSessionsResponse)

#endif // OAIListStreamSessionsResponse_H
