...
OAIBatchStartViewerSessionRevocationResponse::OAIBatchStartViewerSessionRevocationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchStartViewerSessionRevocationResponse::OAIBatchStartViewerSessionRevocationResponse() {
    this->initializeModel();
}

OAIBatchStartViewerSessionRevocationResponse::~OAIBatchStartViewerSessionRevocationResponse() {}

void OAIBatchStartViewerSessionRevocationResponse::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchStartViewerSessionRevocationResponse::fromJson(QString jsonString) {
...
void OAIBatchStartViewerSessionRevocationResponse::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIBatchStartViewerSessionRevocationResponse::asJson() const {
...
QJsonObject OAIBatchStartViewerSessionRevocationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.isSet()) {
...
QList OAIBatchStartViewerSessionRevocationResponse::getErrors() const {
    return m_errors;
}
void OAIBatchStartViewerSessionRevocationResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchStartViewerSessionRevocationResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchStartViewerSessionRevocationResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchStartViewerSessionRevocationResponse::isSet() const {
...
bool OAIBatchStartViewerSessionRevocationResponse::isValid() const {
