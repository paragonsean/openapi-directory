...
OAIS3DestinationConfiguration::OAIS3DestinationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3DestinationConfiguration::OAIS3DestinationConfiguration() {
    this->initializeModel();
}

OAIS3DestinationConfiguration::~OAIS3DestinationConfiguration() {}

void OAIS3DestinationConfiguration::initializeModel() {

    m_bucket_name_isSet = false;
    m_bucket_name_isValid = false;
}

void OAIS3DestinationConfiguration::fromJson(QString jsonString) {
...
void OAIS3DestinationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIS3DestinationConfiguration::asJson() const {
...
QJsonObject OAIS3DestinationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIS3DestinationConfiguration::getBucketName() const {
    return m_bucket_name;
}
void OAIS3DestinationConfiguration::setBucketName(const QString &bucket_name) {
    m_bucket_name = bucket_name;
    m_bucket_name_isSet = true;
}

bool OAIS3DestinationConfiguration::is_bucket_name_Set() const{
    return m_bucket_name_isSet;
}

bool OAIS3DestinationConfiguration::is_bucket_name_Valid() const{
    return m_bucket_name_isValid;
}

bool OAIS3DestinationConfiguration::isSet() const {
...
bool OAIS3DestinationConfiguration::isValid() const {
