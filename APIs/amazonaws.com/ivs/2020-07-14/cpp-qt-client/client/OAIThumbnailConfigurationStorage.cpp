...
#include "OAIThumbnailConfigurationStorage.h"
...
OAIThumbnailConfigurationStorage::OAIThumbnailConfigurationStorage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThumbnailConfigurationStorage::OAIThumbnailConfigurationStorage() {
    this->initializeModel();
}

OAIThumbnailConfigurationStorage::~OAIThumbnailConfigurationStorage() {}

void OAIThumbnailConfigurationStorage::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIThumbnailConfigurationStorage::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIThumbnailConfigurationStorage::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SEQUENTIAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationStorage::SEQUENTIAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LATEST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationStorage::LATEST;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIThumbnailConfigurationStorage::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIThumbnailConfigurationStorage::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIThumbnailConfigurationStorage::SEQUENTIAL:
            val = "SEQUENTIAL";
            break;
        case eOAIThumbnailConfigurationStorage::LATEST:
            val = "LATEST";
            break;
        default:
            break;
...
QJsonValue OAIThumbnailConfigurationStorage::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIThumbnailConfigurationStorage::eOAIThumbnailConfigurationStorage OAIThumbnailConfigurationStorage::getValue() const {
    return m_value;
}

void OAIThumbnailConfigurationStorage::setValue(const OAIThumbnailConfigurationStorage::eOAIThumbnailConfigurationStorage& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIThumbnailConfigurationStorage::isSet() const {
    
    return m_value_isSet;
}

bool OAIThumbnailConfigurationStorage::isValid() const {
