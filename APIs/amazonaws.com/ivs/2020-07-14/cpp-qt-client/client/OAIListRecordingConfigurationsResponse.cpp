...
OAIListRecordingConfigurationsResponse::OAIListRecordingConfigurationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRecordingConfigurationsResponse::OAIListRecordingConfigurationsResponse() {
    this->initializeModel();
}

OAIListRecordingConfigurationsResponse::~OAIListRecordingConfigurationsResponse() {}

void OAIListRecordingConfigurationsResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_recording_configurations_isSet = false;
    m_recording_configurations_isValid = false;
}

void OAIListRecordingConfigurationsResponse::fromJson(QString jsonString) {
...
void OAIListRecordingConfigurationsResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_recording_configurations_isValid = ::OpenAPI::fromJsonValue(m_recording_configurations, json[QString("recordingConfigurations")]);
    m_recording_configurations_isSet = !json[QString("recordingConfigurations")].isNull() && m_recording_configurations_isValid;
}

QString OAIListRecordingConfigurationsResponse::asJson() const {
...
QJsonObject OAIListRecordingConfigurationsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_recording_configurations.isSet()) {
        obj.insert(QString("recordingConfigurations"), ::OpenAPI::toJsonValue(m_recording_configurations));
    }
    return obj;
}

QString OAIListRecordingConfigurationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListRecordingConfigurationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRecordingConfigurationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRecordingConfigurationsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListRecordingConfigurationsResponse::getRecordingConfigurations() const {
    return m_recording_configurations;
}
void OAIListRecordingConfigurationsResponse::setRecordingConfigurations(const QList &recording_configurations) {
    m_recording_configurations = recording_configurations;
    m_recording_configurations_isSet = true;
}

bool OAIListRecordingConfigurationsResponse::is_recording_configurations_Set() const{
    return m_recording_configurations_isSet;
}

bool OAIListRecordingConfigurationsResponse::is_recording_configurations_Valid() const{
    return m_recording_configurations_isValid;
}

bool OAIListRecordingConfigurationsResponse::isSet() const {
...
bool OAIListRecordingConfigurationsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_recording_configurations_isValid && true;
}
