...
OAIBatchGetStreamKey_request::OAIBatchGetStreamKey_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetStreamKey_request::OAIBatchGetStreamKey_request() {
    this->initializeModel();
}

OAIBatchGetStreamKey_request::~OAIBatchGetStreamKey_request() {}

void OAIBatchGetStreamKey_request::initializeModel() {

    m_arns_isSet = false;
    m_arns_isValid = false;
}

void OAIBatchGetStreamKey_request::fromJson(QString jsonString) {
...
void OAIBatchGetStreamKey_request::fromJsonObject(QJsonObject json) {

    m_arns_isValid = ::OpenAPI::fromJsonValue(m_arns, json[QString("arns")]);
    m_arns_isSet = !json[QString("arns")].isNull() && m_arns_isValid;
}

QString OAIBatchGetStreamKey_request::asJson() const {
...
QJsonObject OAIBatchGetStreamKey_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arns.size() > 0) {
...
QList<QString> OAIBatchGetStreamKey_request::getArns() const {
    return m_arns;
}
void OAIBatchGetStreamKey_request::setArns(const QList<QString> &arns) {
    m_arns = arns;
    m_arns_isSet = true;
}

bool OAIBatchGetStreamKey_request::is_arns_Set() const{
    return m_arns_isSet;
}

bool OAIBatchGetStreamKey_request::is_arns_Valid() const{
    return m_arns_isValid;
}

bool OAIBatchGetStreamKey_request::isSet() const {
...
bool OAIBatchGetStreamKey_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_arns_isValid && true;
}
