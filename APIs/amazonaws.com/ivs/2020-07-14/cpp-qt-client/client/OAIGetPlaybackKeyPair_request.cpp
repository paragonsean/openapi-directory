...
OAIGetPlaybackKeyPair_request::OAIGetPlaybackKeyPair_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPlaybackKeyPair_request::OAIGetPlaybackKeyPair_request() {
    this->initializeModel();
}

OAIGetPlaybackKeyPair_request::~OAIGetPlaybackKeyPair_request() {}

void OAIGetPlaybackKeyPair_request::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIGetPlaybackKeyPair_request::fromJson(QString jsonString) {
...
void OAIGetPlaybackKeyPair_request::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("arn")]);
    m_arn_isSet = !json[QString("arn")].isNull() && m_arn_isValid;
}

QString OAIGetPlaybackKeyPair_request::asJson() const {
...
QJsonObject OAIGetPlaybackKeyPair_request::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetPlaybackKeyPair_request::getArn() const {
    return m_arn;
}
void OAIGetPlaybackKeyPair_request::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetPlaybackKeyPair_request::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetPlaybackKeyPair_request::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIGetPlaybackKeyPair_request::isSet() const {
...
bool OAIGetPlaybackKeyPair_request::isValid() const {
