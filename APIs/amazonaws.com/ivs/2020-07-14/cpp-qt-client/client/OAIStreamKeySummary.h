...
/*
 * OAIStreamKeySummary.h
 *
 * Summary information about a stream key.
 */

#ifndef OAIStreamKeySummary_H
#define OAIStreamKeySummary_H
...
class OAIStreamKeySummary : public OAIObject {
public:
    OAIStreamKeySummary();
    OAIStreamKeySummary(QString json);
    ~OAIStreamKeySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamKeySummary)

#endif // OAIStreamKeySummary_H
