...
OAIBatchGetStreamKeyResponse::OAIBatchGetStreamKeyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetStreamKeyResponse::OAIBatchGetStreamKeyResponse() {
    this->initializeModel();
}

OAIBatchGetStreamKeyResponse::~OAIBatchGetStreamKeyResponse() {}

void OAIBatchGetStreamKeyResponse::initializeModel() {
...
void OAIBatchGetStreamKeyResponse::fromJson(QString jsonString) {
...
void OAIBatchGetStreamKeyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetStreamKeyResponse::asJson() const {
...
QJsonObject OAIBatchGetStreamKeyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.isSet()) {
...
QList OAIBatchGetStreamKeyResponse::getErrors() const {
    return m_errors;
}
void OAIBatchGetStreamKeyResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchGetStreamKeyResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchGetStreamKeyResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QList OAIBatchGetStreamKeyResponse::getStreamKeys() const {
    return m_stream_keys;
}
void OAIBatchGetStreamKeyResponse::setStreamKeys(const QList &stream_keys) {
    m_stream_keys = stream_keys;
    m_stream_keys_isSet = true;
}

bool OAIBatchGetStreamKeyResponse::is_stream_keys_Set() const{
    return m_stream_keys_isSet;
}

bool OAIBatchGetStreamKeyResponse::is_stream_keys_Valid() const{
    return m_stream_keys_isValid;
}

bool OAIBatchGetStreamKeyResponse::isSet() const {
...
bool OAIBatchGetStreamKeyResponse::isValid() const {
