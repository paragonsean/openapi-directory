...
OAICreateStreamKey_request::OAICreateStreamKey_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamKey_request::OAICreateStreamKey_request() {
    this->initializeModel();
}

OAICreateStreamKey_request::~OAICreateStreamKey_request() {}

void OAICreateStreamKey_request::initializeModel() {
...
void OAICreateStreamKey_request::fromJson(QString jsonString) {
...
void OAICreateStreamKey_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamKey_request::asJson() const {
...
QJsonObject OAICreateStreamKey_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateStreamKey_request::getChannelArn() const {
    return m_channel_arn;
}
void OAICreateStreamKey_request::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAICreateStreamKey_request::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAICreateStreamKey_request::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QMap<QString, QString> OAICreateStreamKey_request::getTags() const {
    return m_tags;
}
void OAICreateStreamKey_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateStreamKey_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateStreamKey_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateStreamKey_request::isSet() const {
...
bool OAICreateStreamKey_request::isValid() const {
