...
OAIListStreamSessionsResponse::OAIListStreamSessionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamSessionsResponse::OAIListStreamSessionsResponse() {
    this->initializeModel();
}

OAIListStreamSessionsResponse::~OAIListStreamSessionsResponse() {}

void OAIListStreamSessionsResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_stream_sessions_isSet = false;
    m_stream_sessions_isValid = false;
}

void OAIListStreamSessionsResponse::fromJson(QString jsonString) {
...
void OAIListStreamSessionsResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_stream_sessions_isValid = ::OpenAPI::fromJsonValue(m_stream_sessions, json[QString("streamSessions")]);
    m_stream_sessions_isSet = !json[QString("streamSessions")].isNull() && m_stream_sessions_isValid;
}

QString OAIListStreamSessionsResponse::asJson() const {
...
QJsonObject OAIListStreamSessionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_stream_sessions.isSet()) {
        obj.insert(QString("streamSessions"), ::OpenAPI::toJsonValue(m_stream_sessions));
    }
    return obj;
}

QString OAIListStreamSessionsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStreamSessionsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamSessionsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamSessionsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStreamSessionsResponse::getStreamSessions() const {
    return m_stream_sessions;
}
void OAIListStreamSessionsResponse::setStreamSessions(const QList &stream_sessions) {
    m_stream_sessions = stream_sessions;
    m_stream_sessions_isSet = true;
}

bool OAIListStreamSessionsResponse::is_stream_sessions_Set() const{
    return m_stream_sessions_isSet;
}

bool OAIListStreamSessionsResponse::is_stream_sessions_Valid() const{
    return m_stream_sessions_isValid;
}

bool OAIListStreamSessionsResponse::isSet() const {
...
bool OAIListStreamSessionsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_stream_sessions_isValid && true;
}
