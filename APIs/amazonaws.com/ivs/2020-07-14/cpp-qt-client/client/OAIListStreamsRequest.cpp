...
#include "OAIListStreamsRequest.h"
...
OAIListStreamsRequest::OAIListStreamsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamsRequest::OAIListStreamsRequest() {
    this->initializeModel();
}

OAIListStreamsRequest::~OAIListStreamsRequest() {}

void OAIListStreamsRequest::initializeModel() {
...
void OAIListStreamsRequest::fromJson(QString jsonString) {
...
void OAIListStreamsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamsRequest::asJson() const {
...
QJsonObject OAIListStreamsRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIListStreamsRequest_filterBy OAIListStreamsRequest::getFilterBy() const {
    return m_filter_by;
}
void OAIListStreamsRequest::setFilterBy(const OAIListStreamsRequest_filterBy &filter_by) {
    m_filter_by = filter_by;
    m_filter_by_isSet = true;
}

bool OAIListStreamsRequest::is_filter_by_Set() const{
    return m_filter_by_isSet;
}

bool OAIListStreamsRequest::is_filter_by_Valid() const{
    return m_filter_by_isValid;
}

qint32 OAIListStreamsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStreamsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListStreamsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStreamsRequest::isSet() const {
...
bool OAIListStreamsRequest::isValid() const {
