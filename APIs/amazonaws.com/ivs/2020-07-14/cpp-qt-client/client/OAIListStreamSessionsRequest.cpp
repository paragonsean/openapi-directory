...
#include "OAIListStreamSessionsRequest.h"
...
OAIListStreamSessionsRequest::OAIListStreamSessionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamSessionsRequest::OAIListStreamSessionsRequest() {
    this->initializeModel();
}

OAIListStreamSessionsRequest::~OAIListStreamSessionsRequest() {}

void OAIListStreamSessionsRequest::initializeModel() {
...
void OAIListStreamSessionsRequest::fromJson(QString jsonString) {
...
void OAIListStreamSessionsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamSessionsRequest::asJson() const {
...
QJsonObject OAIListStreamSessionsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStreamSessionsRequest::getChannelArn() const {
    return m_channel_arn;
}
void OAIListStreamSessionsRequest::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIListStreamSessionsRequest::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIListStreamSessionsRequest::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

qint32 OAIListStreamSessionsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamSessionsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamSessionsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamSessionsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListStreamSessionsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListStreamSessionsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamSessionsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamSessionsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListStreamSessionsRequest::isSet() const {
...
bool OAIListStreamSessionsRequest::isValid() const {
