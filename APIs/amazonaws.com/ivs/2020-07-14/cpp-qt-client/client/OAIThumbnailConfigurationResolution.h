...
/*
 * OAIThumbnailConfigurationResolution.h
 *
 * 
 */

#ifndef OAIThumbnailConfigurationResolution_H
#define OAIThumbnailConfigurationResolution_H
...
class OAIThumbnailConfigurationResolution : public OAIEnum {
public:
    OAIThumbnailConfigurationResolution();
    OAIThumbnailConfigurationResolution(QString json);
    ~OAIThumbnailConfigurationResolution() override;
    ...
    enum class eOAIThumbnailConfigurationResolution {
    ...
    OAIThumbnailConfigurationResolution::eOAIThumbnailConfigurationResolution getValue() const;
    void setValue(const OAIThumbnailConfigurationResolution::eOAIThumbnailConfigurationResolution& value);
...
private:
    ...
    eOAIThumbnailConfigurationResolution m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThumbnailConfigurationResolution)

#endif // OAIThumbnailConfigurationResolution_H
