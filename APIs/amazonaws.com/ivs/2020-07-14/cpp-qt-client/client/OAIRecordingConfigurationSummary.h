...
/*
 * OAIRecordingConfigurationSummary.h
 *
 * Summary information about a RecordingConfiguration.
 */

#ifndef OAIRecordingConfigurationSummary_H
#define OAIRecordingConfigurationSummary_H
...
class OAIRecordingConfigurationSummary : public OAIObject {
public:
    OAIRecordingConfigurationSummary();
    OAIRecordingConfigurationSummary(QString json);
    ~OAIRecordingConfigurationSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecordingConfigurationSummary)

#endif // OAIRecordingConfigurationSummary_H
