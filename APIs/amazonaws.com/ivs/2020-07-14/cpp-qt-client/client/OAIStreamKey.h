...
#ifndef OAIStreamKey_H
#define OAIStreamKey_H
...
class OAIStreamKey : public OAIObject {
public:
    OAIStreamKey();
    OAIStreamKey(QString json);
    ~OAIStreamKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamKey)

#endif // OAIStreamKey_H
