...
/*
 * OAIListStreamKeys_request.h
 *
 * 
 */

#ifndef OAIListStreamKeys_request_H
#define OAIListStreamKeys_request_H
...
class OAIListStreamKeys_request : public OAIObject {
public:
    OAIListStreamKeys_request();
    OAIListStreamKeys_request(QString json);
    ~OAIListStreamKeys_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamKeys_request)

#endif // OAIListStreamKeys_request_H
