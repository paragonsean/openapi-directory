...
/*
 * OAIListRecordingConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIListRecordingConfigurationsRequest_H
#define OAIListRecordingConfigurationsRequest_H
...
class OAIListRecordingConfigurationsRequest : public OAIObject {
public:
    OAIListRecordingConfigurationsRequest();
    OAIListRecordingConfigurationsRequest(QString json);
    ~OAIListRecordingConfigurationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRecordingConfigurationsRequest)

#endif // OAIListRecordingConfigurationsRequest_H
