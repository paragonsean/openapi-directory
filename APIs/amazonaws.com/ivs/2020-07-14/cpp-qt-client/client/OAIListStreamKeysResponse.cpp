...
OAIListStreamKeysResponse::OAIListStreamKeysResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamKeysResponse::OAIListStreamKeysResponse() {
    this->initializeModel();
}

OAIListStreamKeysResponse::~OAIListStreamKeysResponse() {}

void OAIListStreamKeysResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_stream_keys_isSet = false;
    m_stream_keys_isValid = false;
}

void OAIListStreamKeysResponse::fromJson(QString jsonString) {
...
void OAIListStreamKeysResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_stream_keys_isValid = ::OpenAPI::fromJsonValue(m_stream_keys, json[QString("streamKeys")]);
    m_stream_keys_isSet = !json[QString("streamKeys")].isNull() && m_stream_keys_isValid;
}

QString OAIListStreamKeysResponse::asJson() const {
...
QJsonObject OAIListStreamKeysResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_stream_keys.isSet()) {
        obj.insert(QString("streamKeys"), ::OpenAPI::toJsonValue(m_stream_keys));
    }
    return obj;
}

QString OAIListStreamKeysResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStreamKeysResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamKeysResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamKeysResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStreamKeysResponse::getStreamKeys() const {
    return m_stream_keys;
}
void OAIListStreamKeysResponse::setStreamKeys(const QList &stream_keys) {
    m_stream_keys = stream_keys;
    m_stream_keys_isSet = true;
}

bool OAIListStreamKeysResponse::is_stream_keys_Set() const{
    return m_stream_keys_isSet;
}

bool OAIListStreamKeysResponse::is_stream_keys_Valid() const{
    return m_stream_keys_isValid;
}

bool OAIListStreamKeysResponse::isSet() const {
...
bool OAIListStreamKeysResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_stream_keys_isValid && true;
}
