...
/*
 * OAIListChannels_request.h
 *
 * 
 */

#ifndef OAIListChannels_request_H
#define OAIListChannels_request_H
...
class OAIListChannels_request : public OAIObject {
public:
    OAIListChannels_request();
    OAIListChannels_request(QString json);
    ~OAIListChannels_request() override;
    ...
    QString getFilterByName() const;
    void setFilterByName(const QString &filter_by_name);
    bool is_filter_by_name_Set() const;
    bool is_filter_by_name_Valid() const;

    QString getFilterByRecordingConfigurationArn() const;
    void setFilterByRecordingConfigurationArn(const QString &filter_by_recording_configuration_arn);
    bool is_filter_by_recording_configuration_arn_Set() const;
    bool is_filter_by_recording_configuration_arn_Valid() const;
...
private:
    ...
    QString m_filter_by_name;
    bool m_filter_by_name_isSet;
    bool m_filter_by_name_isValid;

    QString m_filter_by_recording_configuration_arn;
    bool m_filter_by_recording_configuration_arn_isSet;
    bool m_filter_by_recording_configuration_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChannels_request)

#endif // OAIListChannels_request_H
