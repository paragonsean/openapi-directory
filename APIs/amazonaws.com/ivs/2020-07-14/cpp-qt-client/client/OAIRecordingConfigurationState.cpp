...
OAIRecordingConfigurationState::OAIRecordingConfigurationState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecordingConfigurationState::OAIRecordingConfigurationState() {
    this->initializeModel();
}

OAIRecordingConfigurationState::~OAIRecordingConfigurationState() {}

void OAIRecordingConfigurationState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRecordingConfigurationState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRecordingConfigurationState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CREATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecordingConfigurationState::CREATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CREATE_FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecordingConfigurationState::CREATE_FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecordingConfigurationState::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRecordingConfigurationState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRecordingConfigurationState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRecordingConfigurationState::CREATING:
            val = "CREATING";
            break;
        case eOAIRecordingConfigurationState::CREATE_FAILED:
            val = "CREATE_FAILED";
            break;
        case eOAIRecordingConfigurationState::ACTIVE:
            val = "ACTIVE";
            break;
        default:
            break;
...
QJsonValue OAIRecordingConfigurationState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRecordingConfigurationState::eOAIRecordingConfigurationState OAIRecordingConfigurationState::getValue() const {
    return m_value;
}

void OAIRecordingConfigurationState::setValue(const OAIRecordingConfigurationState::eOAIRecordingConfigurationState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRecordingConfigurationState::isSet() const {
    
    return m_value_isSet;
}

bool OAIRecordingConfigurationState::isValid() const {
