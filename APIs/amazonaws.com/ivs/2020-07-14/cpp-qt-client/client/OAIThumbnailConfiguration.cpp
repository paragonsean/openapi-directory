...
OAIRecordingMode OAIThumbnailConfiguration::getRecordingMode() const {
    return m_recording_mode;
}
void OAIThumbnailConfiguration::setRecordingMode(const OAIRecordingMode &recording_mode) {
    m_recording_mode = recording_mode;
    m_recording_mode_isSet = true;
}

bool OAIThumbnailConfiguration::is_recording_mode_Set() const{
    return m_recording_mode_isSet;
}

bool OAIThumbnailConfiguration::is_recording_mode_Valid() const{
    return m_recording_mode_isValid;
}

OAIThumbnailConfigurationResolution OAIThumbnailConfiguration::getResolution() const {
    return m_resolution;
}
void OAIThumbnailConfiguration::setResolution(const OAIThumbnailConfigurationResolution &resolution) {
    m_resolution = resolution;
    m_resolution_isSet = true;
}

bool OAIThumbnailConfiguration::is_resolution_Set() const{
    return m_resolution_isSet;
}

bool OAIThumbnailConfiguration::is_resolution_Valid() const{
    return m_resolution_isValid;
}

QList OAIThumbnailConfiguration::getStorage() const {
    return m_storage;
}
void OAIThumbnailConfiguration::setStorage(const QList &storage) {
    m_storage = storage;
    m_storage_isSet = true;
}

bool OAIThumbnailConfiguration::is_storage_Set() const{
    return m_storage_isSet;
}

bool OAIThumbnailConfiguration::is_storage_Valid() const{
    return m_storage_isValid;
}

qint32 OAIThumbnailConfiguration::getTargetIntervalSeconds() const {
    return m_target_interval_seconds;
}
void OAIThumbnailConfiguration::setTargetIntervalSeconds(const qint32 &target_interval_seconds) {
    m_target_interval_seconds = target_interval_seconds;
    m_target_interval_seconds_isSet = true;
}

bool OAIThumbnailConfiguration::is_target_interval_seconds_Set() const{
    return m_target_interval_seconds_isSet;
}

bool OAIThumbnailConfiguration::is_target_interval_seconds_Valid() const{
