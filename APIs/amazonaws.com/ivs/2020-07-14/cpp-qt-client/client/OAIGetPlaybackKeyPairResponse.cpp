...
OAIGetPlaybackKeyPairResponse::OAIGetPlaybackKeyPairResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPlaybackKeyPairResponse::OAIGetPlaybackKeyPairResponse() {
    this->initializeModel();
}

OAIGetPlaybackKeyPairResponse::~OAIGetPlaybackKeyPairResponse() {}

void OAIGetPlaybackKeyPairResponse::initializeModel() {

    m_key_pair_isSet = false;
    m_key_pair_isValid = false;
}

void OAIGetPlaybackKeyPairResponse::fromJson(QString jsonString) {
...
void OAIGetPlaybackKeyPairResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetPlaybackKeyPairResponse::asJson() const {
...
QJsonObject OAIGetPlaybackKeyPairResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_key_pair.isSet()) {
...
OAIGetPlaybackKeyPairResponse_keyPair OAIGetPlaybackKeyPairResponse::getKeyPair() const {
    return m_key_pair;
}
void OAIGetPlaybackKeyPairResponse::setKeyPair(const OAIGetPlaybackKeyPairResponse_keyPair &key_pair) {
    m_key_pair = key_pair;
    m_key_pair_isSet = true;
}

bool OAIGetPlaybackKeyPairResponse::is_key_pair_Set() const{
    return m_key_pair_isSet;
}

bool OAIGetPlaybackKeyPairResponse::is_key_pair_Valid() const{
    return m_key_pair_isValid;
}

bool OAIGetPlaybackKeyPairResponse::isSet() const {
...
bool OAIGetPlaybackKeyPairResponse::isValid() const {
