...
OAIThumbnailConfigurationResolution::OAIThumbnailConfigurationResolution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThumbnailConfigurationResolution::OAIThumbnailConfigurationResolution() {
    this->initializeModel();
}

OAIThumbnailConfigurationResolution::~OAIThumbnailConfigurationResolution() {}

void OAIThumbnailConfigurationResolution::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIThumbnailConfigurationResolution::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIThumbnailConfigurationResolution::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FULL_HD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationResolution::FULL_HD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationResolution::HD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationResolution::SD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOWEST_RESOLUTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIThumbnailConfigurationResolution::LOWEST_RESOLUTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIThumbnailConfigurationResolution::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIThumbnailConfigurationResolution::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIThumbnailConfigurationResolution::FULL_HD:
            val = "FULL_HD";
            break;
        case eOAIThumbnailConfigurationResolution::HD:
            val = "HD";
            break;
        case eOAIThumbnailConfigurationResolution::SD:
            val = "SD";
            break;
        case eOAIThumbnailConfigurationResolution::LOWEST_RESOLUTION:
...
QJsonValue OAIThumbnailConfigurationResolution::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIThumbnailConfigurationResolution::eOAIThumbnailConfigurationResolution OAIThumbnailConfigurationResolution::getValue() const {
    return m_value;
}

void OAIThumbnailConfigurationResolution::setValue(const OAIThumbnailConfigurationResolution::eOAIThumbnailConfigurationResolution& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIThumbnailConfigurationResolution::isSet() const {
    
    return m_value_isSet;
}

bool OAIThumbnailConfigurationResolution::isValid() const {
