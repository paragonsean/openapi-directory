...
/*
 * OAIGetStreamResponse_stream.h
 *
 * 
 */

#ifndef OAIGetStreamResponse_stream_H
#define OAIGetStreamResponse_stream_H
...
class OAIGetStreamResponse_stream : public OAIObject {
public:
    OAIGetStreamResponse_stream();
    OAIGetStreamResponse_stream(QString json);
    ~OAIGetStreamResponse_stream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStreamResponse_stream)

#endif // OAIGetStreamResponse_stream_H
