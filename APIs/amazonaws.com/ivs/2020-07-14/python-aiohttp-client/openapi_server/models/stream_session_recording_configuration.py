...
class StreamSessionRecordingConfiguration(Model):
    ...
    def __init__(self, arn: str=None, destination_configuration: RecordingConfigurationDestinationConfiguration=None, name: str=None, recording_reconnect_window_seconds: int=None, rendition_configuration: CreateRecordingConfigurationRequestRenditionConfiguration=None, state: RecordingConfigurationState=None, tags: Dict=None, thumbnail_configuration: CreateRecordingConfigurationRequestThumbnailConfiguration=None):
        """StreamSessionRecordingConfiguration - a model defined in OpenAPI

        :param arn: The arn of this StreamSessionRecordingConfiguration.
        :param destination_configuration: The destination_configuration of this StreamSessionRecordingConfiguration.
        :param name: The name of this StreamSessionRecordingConfiguration.
        :param recording_reconnect_window_seconds: The recording_reconnect_window_seconds of this StreamSessionRecordingConfiguration.
        :param rendition_configuration: The rendition_configuration of this StreamSessionRecordingConfiguration.
        :param state: The state of this StreamSessionRecordingConfiguration.
        :param tags: The tags of this StreamSessionRecordingConfiguration.
        :param thumbnail_configuration: The thumbnail_configuration of this StreamSessionRecordingConfiguration.
        """
        self.openapi_types = {
            'arn': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StreamSessionRecordingConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StreamSession_recordingConfiguration of this StreamSessionRecordingConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def arn(self):
        """Gets the arn of this StreamSessionRecordingConfiguration.


        :return: The arn of this StreamSessionRecordingConfiguration.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this StreamSessionRecordingConfiguration.
    ...
    def destination_configuration(self):
        """Gets the destination_configuration of this StreamSessionRecordingConfiguration.


        :return: The destination_configuration of this StreamSessionRecordingConfiguration.
    ...
    def destination_configuration(self, destination_configuration):
        """Sets the destination_configuration of this StreamSessionRecordingConfiguration.
    ...
    @property
    def name(self):
        """Gets the name of this StreamSessionRecordingConfiguration.


        :return: The name of this StreamSessionRecordingConfiguration.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StreamSessionRecordingConfiguration.
    ...
    def recording_reconnect_window_seconds(self):
        """Gets the recording_reconnect_window_seconds of this StreamSessionRecordingConfiguration.


        :return: The recording_reconnect_window_seconds of this StreamSessionRecordingConfiguration.
        :rtype: int
        """
    ...
    def recording_reconnect_window_seconds(self, recording_reconnect_window_seconds):
        """Sets the recording_reconnect_window_seconds of this StreamSessionRecordingConfiguration.
    ...
    def rendition_configuration(self):
        """Gets the rendition_configuration of this StreamSessionRecordingConfiguration.


        :return: The rendition_configuration of this StreamSessionRecordingConfiguration.
    ...
    def rendition_configuration(self, rendition_configuration):
        """Sets the rendition_configuration of this StreamSessionRecordingConfiguration.
    ...
    @property
    def state(self):
        """Gets the state of this StreamSessionRecordingConfiguration.


        :return: The state of this StreamSessionRecordingConfiguration.
    ...
    def state(self, state):
        """Sets the state of this StreamSessionRecordingConfiguration.
    ...
    @property
    def tags(self):
        """Gets the tags of this StreamSessionRecordingConfiguration.


        :return: The tags of this StreamSessionRecordingConfiguration.
        :rtype: Dict
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this StreamSessionRecordingConfiguration.
    ...
    def thumbnail_configuration(self):
        """Gets the thumbnail_configuration of this StreamSessionRecordingConfiguration.


        :return: The thumbnail_configuration of this StreamSessionRecordingConfiguration.
    ...
    def thumbnail_configuration(self, thumbnail_configuration):
        """Sets the thumbnail_configuration of this StreamSessionRecordingConfiguration.
