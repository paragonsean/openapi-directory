...
class GetChannelRequest(Model):
    ...
    def __init__(self, arn: str=None):
        ...
        :param arn: The arn of this GetChannelRequest.
        """
        self.openapi_types = {
            'arn': str
        }
    ...
    def from_dict(cls, dikt: dict) -> 'GetChannelRequest':
        ...
        :param dikt: A dict.
        :return: The GetChannel_request of this GetChannelRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def arn(self):
        """Gets the arn of this GetChannelRequest.

        ARN of the channel for which the configuration is to be retrieved.

        :return: The arn of this GetChannelRequest.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this GetChannelRequest.
