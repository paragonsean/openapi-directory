...
class DeleteChannelRequest(Model):
    ...
    def __init__(self, arn: str=None):
        ...
        :param arn: The arn of this DeleteChannelRequest.
        """
        self.openapi_types = {
            'arn': str
        }
    ...
    def from_dict(cls, dikt: dict) -> 'DeleteChannelRequest':
        ...
        :param dikt: A dict.
        :return: The DeleteChannel_request of this DeleteChannelRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def arn(self):
        """Gets the arn of this DeleteChannelRequest.

        ARN of the channel to be deleted.

        :return: The arn of this DeleteChannelRequest.
        :rtype: str
        """
        return self._arn
    ...
    @arn.setter
    def arn(self, arn):
        """Sets the arn of this DeleteChannelRequest.
