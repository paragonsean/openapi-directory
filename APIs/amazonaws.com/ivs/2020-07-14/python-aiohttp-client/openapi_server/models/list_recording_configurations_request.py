...
class ListRecordingConfigurationsRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        """ListRecordingConfigurationsRequest - a model defined in OpenAPI

        :param max_results: The max_results of this ListRecordingConfigurationsRequest.
        :param next_token: The next_token of this ListRecordingConfigurationsRequest.
        """
        self.openapi_types = {
            'max_results': int,
            'next_token': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListRecordingConfigurationsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListRecordingConfigurations_request of this ListRecordingConfigurationsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListRecordingConfigurationsRequest.

        Maximum number of recording configurations to return. Default: your service quota or 100, whichever is smaller. 

        :return: The max_results of this ListRecordingConfigurationsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListRecordingConfigurationsRequest.
    ...
    @property
    def next_token(self):
        """Gets the next_token of this ListRecordingConfigurationsRequest.

        The first recording configuration to retrieve. This is used for pagination; see the <code>nextToken</code> response field.

        :return: The next_token of this ListRecordingConfigurationsRequest.
        :rtype: str
        """
    ...
    def next_token(self, next_token):
        """Sets the next_token of this ListRecordingConfigurationsRequest.
