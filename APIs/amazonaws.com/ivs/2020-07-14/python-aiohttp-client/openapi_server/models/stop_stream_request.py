...
class StopStreamRequest(Model):
    ...
    def __init__(self, channel_arn: str=None):
        """StopStreamRequest - a model defined in OpenAPI

        :param channel_arn: The channel_arn of this StopStreamRequest.
        """
        self.openapi_types = {
            'channel_arn': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StopStreamRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StopStream_request of this StopStreamRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def channel_arn(self):
        """Gets the channel_arn of this StopStreamRequest.

        ARN of the channel for which the stream is to be stopped.

        :return: The channel_arn of this StopStreamRequest.
        :rtype: str
        """
    ...
    def channel_arn(self, channel_arn):
        """Sets the channel_arn of this StopStreamRequest.
