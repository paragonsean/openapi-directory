...
OAIGetClip_request Example::create(){
    OAIGetClip_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getClipSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getClipSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIGetClip_request oai_get_clip_request = create(); // OAIGetClip_request | 
      ...
      apiInstance.getClip(oai_get_clip_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
