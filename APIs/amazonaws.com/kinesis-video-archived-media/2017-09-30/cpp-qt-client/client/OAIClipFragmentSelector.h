...
#ifndef OAIClipFragmentSelector_H
#define OAIClipFragmentSelector_H
...
class OAIClipFragmentSelector : public OAIObject {
public:
    OAIClipFragmentSelector();
    OAIClipFragmentSelector(QString json);
    ~OAIClipFragmentSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClipFragmentSelector)

#endif // OAIClipFragmentSelector_H
