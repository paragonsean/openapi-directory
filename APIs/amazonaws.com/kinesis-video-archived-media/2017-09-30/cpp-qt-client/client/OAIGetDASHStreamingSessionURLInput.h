...
/*
 * OAIGetDASHStreamingSessionURLInput.h
 *
 * 
 */

#ifndef OAIGetDASHStreamingSessionURLInput_H
#define OAIGetDASHStreamingSessionURLInput_H
...
#include "OAIGetDASHStreamingSessionURLInput_DASHFragmentSelector.h"
#include <QString>
...
namespace OpenAPI {
class OAIGetDASHStreamingSessionURLInput_DASHFragmentSelector;

class OAIGetDASHStreamingSessionURLInput : public OAIObject {
public:
    OAIGetDASHStreamingSessionURLInput();
    OAIGetDASHStreamingSessionURLInput(QString json);
    ~OAIGetDASHStreamingSessionURLInput() override;
    ...
    OAIDASHPlaybackMode getPlaybackMode() const;
    void setPlaybackMode(const OAIDASHPlaybackMode &playback_mode);
    bool is_playback_mode_Set() const;
    bool is_playback_mode_Valid() const;

    OAIDASHDisplayFragmentTimestamp getDisplayFragmentTimestamp() const;
    void setDisplayFragmentTimestamp(const OAIDASHDisplayFragmentTimestamp &display_fragment_timestamp);
    bool is_display_fragment_timestamp_Set() const;
    bool is_display_fragment_timestamp_Valid() const;

    OAIDASHDisplayFragmentNumber getDisplayFragmentNumber() const;
    void setDisplayFragmentNumber(const OAIDASHDisplayFragmentNumber &display_fragment_number);
    bool is_display_fragment_number_Set() const;
    bool is_display_fragment_number_Valid() const;

    OAIGetDASHStreamingSessionURLInput_DASHFragmentSelector getDashFragmentSelector() const;
    void setDashFragmentSelector(const OAIGetDASHStreamingSessionURLInput_DASHFragmentSelector &dash_fragment_selector);
...
private:
    ...
    OAIDASHPlaybackMode m_playback_mode;
    bool m_playback_mode_isSet;
    bool m_playback_mode_isValid;

    OAIDASHDisplayFragmentTimestamp m_display_fragment_timestamp;
    bool m_display_fragment_timestamp_isSet;
    bool m_display_fragment_timestamp_isValid;

    OAIDASHDisplayFragmentNumber m_display_fragment_number;
    bool m_display_fragment_number_isSet;
    bool m_display_fragment_number_isValid;

    OAIGetDASHStreamingSessionURLInput_DASHFragmentSelector m_dash_fragment_selector;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDASHStreamingSessionURLInput)

#endif // OAIGetDASHStreamingSessionURLInput_H
