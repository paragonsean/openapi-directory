...
OAIGetImages_request::OAIGetImages_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImages_request::OAIGetImages_request() {
    this->initializeModel();
}

OAIGetImages_request::~OAIGetImages_request() {}

void OAIGetImages_request::initializeModel() {
...
void OAIGetImages_request::fromJson(QString jsonString) {
...
void OAIGetImages_request::fromJsonObject(QJsonObject json) {
...
QString OAIGetImages_request::asJson() const {
...
QJsonObject OAIGetImages_request::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_image_selector_type_isSet) {
...
QString OAIGetImages_request::getStreamName() const {
    return m_stream_name;
}
void OAIGetImages_request::setStreamName(const QString &stream_name) {
    m_stream_name = stream_name;
    m_stream_name_isSet = true;
}

bool OAIGetImages_request::is_stream_name_Set() const{
    return m_stream_name_isSet;
}

bool OAIGetImages_request::is_stream_name_Valid() const{
    return m_stream_name_isValid;
}

QString OAIGetImages_request::getStreamArn() const {
    return m_stream_arn;
}
void OAIGetImages_request::setStreamArn(const QString &stream_arn) {
    m_stream_arn = stream_arn;
    m_stream_arn_isSet = true;
}

bool OAIGetImages_request::is_stream_arn_Set() const{
    return m_stream_arn_isSet;
}

bool OAIGetImages_request::is_stream_arn_Valid() const{
    return m_stream_arn_isValid;
}

QString OAIGetImages_request::getImageSelectorType() const {
    return m_image_selector_type;
}
void OAIGetImages_request::setImageSelectorType(const QString &image_selector_type) {
    m_image_selector_type = image_selector_type;
    m_image_selector_type_isSet = true;
}

bool OAIGetImages_request::is_image_selector_type_Set() const{
    return m_image_selector_type_isSet;
}

bool OAIGetImages_request::is_image_selector_type_Valid() const{
    return m_image_selector_type_isValid;
}

QDateTime OAIGetImages_request::getStartTimestamp() const {
    return m_start_timestamp;
}
void OAIGetImages_request::setStartTimestamp(const QDateTime &start_timestamp) {
    m_start_timestamp = start_timestamp;
    m_start_timestamp_isSet = true;
}

bool OAIGetImages_request::is_start_timestamp_Set() const{
    return m_start_timestamp_isSet;
}

bool OAIGetImages_request::is_start_timestamp_Valid() const{
    return m_start_timestamp_isValid;
}

QDateTime OAIGetImages_request::getEndTimestamp() const {
    return m_end_timestamp;
}
void OAIGetImages_request::setEndTimestamp(const QDateTime &end_timestamp) {
    m_end_timestamp = end_timestamp;
    m_end_timestamp_isSet = true;
}

bool OAIGetImages_request::is_end_timestamp_Set() const{
    return m_end_timestamp_isSet;
}

bool OAIGetImages_request::is_end_timestamp_Valid() const{
    return m_end_timestamp_isValid;
}

qint32 OAIGetImages_request::getSamplingInterval() const {
    return m_sampling_interval;
}
void OAIGetImages_request::setSamplingInterval(const qint32 &sampling_interval) {
    m_sampling_interval = sampling_interval;
    m_sampling_interval_isSet = true;
}

bool OAIGetImages_request::is_sampling_interval_Set() const{
    return m_sampling_interval_isSet;
}

bool OAIGetImages_request::is_sampling_interval_Valid() const{
    return m_sampling_interval_isValid;
}

QString OAIGetImages_request::getFormat() const {
    return m_format;
}
void OAIGetImages_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGetImages_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGetImages_request::is_format_Valid() const{
    return m_format_isValid;
}

QMap<QString, QString> OAIGetImages_request::getFormatConfig() const {
    return m_format_config;
}
void OAIGetImages_request::setFormatConfig(const QMap<QString, QString> &format_config) {
    m_format_config = format_config;
    m_format_config_isSet = true;
}

bool OAIGetImages_request::is_format_config_Set() const{
    return m_format_config_isSet;
}

bool OAIGetImages_request::is_format_config_Valid() const{
    return m_format_config_isValid;
}

qint32 OAIGetImages_request::getWidthPixels() const {
    return m_width_pixels;
}
void OAIGetImages_request::setWidthPixels(const qint32 &width_pixels) {
    m_width_pixels = width_pixels;
    m_width_pixels_isSet = true;
}

bool OAIGetImages_request::is_width_pixels_Set() const{
    return m_width_pixels_isSet;
}

bool OAIGetImages_request::is_width_pixels_Valid() const{
    return m_width_pixels_isValid;
}

qint32 OAIGetImages_request::getHeightPixels() const {
    return m_height_pixels;
}
void OAIGetImages_request::setHeightPixels(const qint32 &height_pixels) {
    m_height_pixels = height_pixels;
    m_height_pixels_isSet = true;
}

bool OAIGetImages_request::is_height_pixels_Set() const{
    return m_height_pixels_isSet;
}

bool OAIGetImages_request::is_height_pixels_Valid() const{
    return m_height_pixels_isValid;
}

qint32 OAIGetImages_request::getMaxResults() const {
    return m_max_results;
}
void OAIGetImages_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetImages_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetImages_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetImages_request::getNextToken() const {
    return m_next_token;
}
void OAIGetImages_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetImages_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetImages_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetImages_request::isSet() const {
...
bool OAIGetImages_request::isValid() const {
