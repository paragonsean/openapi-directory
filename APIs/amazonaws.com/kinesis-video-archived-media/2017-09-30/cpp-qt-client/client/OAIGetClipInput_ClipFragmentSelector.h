...
/*
 * OAIGetClipInput_ClipFragmentSelector.h
 *
 * 
 */

#ifndef OAIGetClipInput_ClipFragmentSelector_H
#define OAIGetClipInput_ClipFragmentSelector_H
...
class OAIGetClipInput_ClipFragmentSelector : public OAIObject {
public:
    OAIGetClipInput_ClipFragmentSelector();
    OAIGetClipInput_ClipFragmentSelector(QString json);
    ~OAIGetClipInput_ClipFragmentSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClipInput_ClipFragmentSelector)

#endif // OAIGetClipInput_ClipFragmentSelector_H
