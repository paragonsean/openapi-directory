...
/*
 * OAIGetImages_request.h
 *
 * 
 */

#ifndef OAIGetImages_request_H
#define OAIGetImages_request_H
...
class OAIGetImages_request : public OAIObject {
public:
    OAIGetImages_request();
    OAIGetImages_request(QString json);
    ~OAIGetImages_request() override;
    ...
    QString getImageSelectorType() const;
    void setImageSelectorType(const QString &image_selector_type);
    ...
    QMap<QString, QString> getFormatConfig() const;
    void setFormatConfig(const QMap<QString, QString> &format_config);
...
private:
    ...
    QMap<QString, QString> m_format_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImages_request)

#endif // OAIGetImages_request_H
