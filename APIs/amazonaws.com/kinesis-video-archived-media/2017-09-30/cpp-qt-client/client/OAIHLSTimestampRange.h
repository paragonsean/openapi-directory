...
#ifndef OAIHLSTimestampRange_H
#define OAIHLSTimestampRange_H
...
class OAIHLSTimestampRange : public OAIObject {
public:
    OAIHLSTimestampRange();
    OAIHLSTimestampRange(QString json);
    ~OAIHLSTimestampRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHLSTimestampRange)

#endif // OAIHLSTimestampRange_H
