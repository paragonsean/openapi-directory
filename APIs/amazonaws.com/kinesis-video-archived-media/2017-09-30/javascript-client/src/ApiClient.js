...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://kinesisvideo.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://kinesisvideo.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-09-30/Javascript'
        };
    ...
    hostSettings() {
        return [
            ...
            },
            {
              ...
              'description': "The Kinesis Video Archived Media endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
