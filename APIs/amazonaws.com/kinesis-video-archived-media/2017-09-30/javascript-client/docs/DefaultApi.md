# AmazonKinesisVideoStreamsArchivedMedia.DefaultApi
...
> GetClipOutput getClip(getClipRequest, opts)
...
```javascript
import AmazonKinesisVideoStreamsArchivedMedia from 'amazon_kinesis_video_streams_archived_media';
let defaultClient = AmazonKinesisVideoStreamsArchivedMedia.ApiClient.instance;
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let getClipRequest = new AmazonKinesisVideoStreamsArchivedMedia.GetClipRequest(); // GetClipRequest | 
let opts = {
...
apiInstance.getClip(getClipRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetDASHStreamingSessionURLOutput getDASHStreamingSessionURL(getDASHStreamingSessionURLRequest, opts)
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let getDASHStreamingSessionURLRequest = new AmazonKinesisVideoStreamsArchivedMedia.GetDASHStreamingSessionURLRequest(); // GetDASHStreamingSessionURLRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.getDASHStreamingSessionURL(getDASHStreamingSessionURLRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetHLSStreamingSessionURLOutput getHLSStreamingSessionURL(getHLSStreamingSessionURLRequest, opts)
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let getHLSStreamingSessionURLRequest = new AmazonKinesisVideoStreamsArchivedMedia.GetHLSStreamingSessionURLRequest(); // GetHLSStreamingSessionURLRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.getHLSStreamingSessionURL(getHLSStreamingSessionURLRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetImagesOutput getImages(getImagesRequest, opts)
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let getImagesRequest = new AmazonKinesisVideoStreamsArchivedMedia.GetImagesRequest(); // GetImagesRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.getImages(getImagesRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetMediaForFragmentListOutput getMediaForFragmentList(getMediaForFragmentListRequest, opts)
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let getMediaForFragmentListRequest = new AmazonKinesisVideoStreamsArchivedMedia.GetMediaForFragmentListRequest(); // GetMediaForFragmentListRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.getMediaForFragmentList(getMediaForFragmentListRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListFragmentsOutput listFragments(listFragmentsRequest, opts)
...
let apiInstance = new AmazonKinesisVideoStreamsArchivedMedia.DefaultApi();
let listFragmentsRequest = new AmazonKinesisVideoStreamsArchivedMedia.ListFragmentsRequest(); // ListFragmentsRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.listFragments(listFragmentsRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
