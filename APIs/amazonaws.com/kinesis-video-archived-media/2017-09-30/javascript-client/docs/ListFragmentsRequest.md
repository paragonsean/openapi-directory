# AmazonKinesisVideoStreamsArchivedMedia.ListFragmentsRequest
...
**maxResults** | **Number** | The total number of fragments to return. If the total number of fragments available is more than the value specified in &lt;code&gt;max-results&lt;/code&gt;, then a &lt;a&gt;ListFragmentsOutput$NextToken&lt;/a&gt; is provided in the output that you can use to resume pagination. | [optional] 
