...
public class StatelessRuleGroupReference {
  ...
  public StatelessRuleGroupReference resourceArn(String resourceArn) {
  ...
  public StatelessRuleGroupReference priority(Integer priority) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessRuleGroupReference statelessRuleGroupReference = (StatelessRuleGroupReference) o;
    return Objects.equals(this.resourceArn, statelessRuleGroupReference.resourceArn) &&
        Objects.equals(this.priority, statelessRuleGroupReference.priority);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceArn, priority);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessRuleGroupReference {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessRuleGroupReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessRuleGroupReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessRuleGroupReference is not found in the empty JSON string", StatelessRuleGroupReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessRuleGroupReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessRuleGroupReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessRuleGroupReference.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessRuleGroupReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessRuleGroupReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessRuleGroupReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessRuleGroupReference.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessRuleGroupReference>() {
           @Override
           public void write(JsonWriter out, StatelessRuleGroupReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessRuleGroupReference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessRuleGroupReference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessRuleGroupReference
   * @throws IOException if the JSON string is invalid with respect to StatelessRuleGroupReference
   */
  public static StatelessRuleGroupReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessRuleGroupReference.class);
  }

  /**
   * Convert an instance of StatelessRuleGroupReference to an JSON string
   *
   * @return JSON string
   */
