...
import org.openapitools.client.model.OverrideAction;
...
public class StatefulRuleGroupReferenceOverride {
  public static final String SERIALIZED_NAME_ACTION = "Action";
  @SerializedName(SERIALIZED_NAME_ACTION)
  private OverrideAction action;

  public StatefulRuleGroupReferenceOverride() {
  }

  public StatefulRuleGroupReferenceOverride action(OverrideAction action) {
    this.action = action;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatefulRuleGroupReferenceOverride statefulRuleGroupReferenceOverride = (StatefulRuleGroupReferenceOverride) o;
    return Objects.equals(this.action, statefulRuleGroupReferenceOverride.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatefulRuleGroupReferenceOverride {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRuleGroupReferenceOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRuleGroupReferenceOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRuleGroupReferenceOverride is not found in the empty JSON string", StatefulRuleGroupReferenceOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRuleGroupReferenceOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRuleGroupReferenceOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Action`
      if (jsonObj.get("Action") != null && !jsonObj.get("Action").isJsonNull()) {
        OverrideAction.validateJsonElement(jsonObj.get("Action"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRuleGroupReferenceOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRuleGroupReferenceOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRuleGroupReferenceOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRuleGroupReferenceOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRuleGroupReferenceOverride>() {
           @Override
           public void write(JsonWriter out, StatefulRuleGroupReferenceOverride value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRuleGroupReferenceOverride read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRuleGroupReferenceOverride given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRuleGroupReferenceOverride
   * @throws IOException if the JSON string is invalid with respect to StatefulRuleGroupReferenceOverride
   */
  public static StatefulRuleGroupReferenceOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRuleGroupReferenceOverride.class);
  }

  /**
   * Convert an instance of StatefulRuleGroupReferenceOverride to an JSON string
   *
   * @return JSON string
   */
