...
public class RuleGroupReferenceSets {
  ...
  public RuleGroupReferenceSets() {
  }

  public RuleGroupReferenceSets ipSetReferences(Map ipSetReferences) {
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupReferenceSets ruleGroupReferenceSets = (RuleGroupReferenceSets) o;
    return Objects.equals(this.ipSetReferences, ruleGroupReferenceSets.ipSetReferences);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleGroupReferenceSets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupReferenceSets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupReferenceSets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupReferenceSets is not found in the empty JSON string", RuleGroupReferenceSets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupReferenceSets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupReferenceSets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupReferenceSets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupReferenceSets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupReferenceSets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupReferenceSets.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupReferenceSets>() {
           @Override
           public void write(JsonWriter out, RuleGroupReferenceSets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupReferenceSets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupReferenceSets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupReferenceSets
   * @throws IOException if the JSON string is invalid with respect to RuleGroupReferenceSets
   */
  public static RuleGroupReferenceSets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupReferenceSets.class);
  }

  /**
   * Convert an instance of RuleGroupReferenceSets to an JSON string
   *
   * @return JSON string
   */
