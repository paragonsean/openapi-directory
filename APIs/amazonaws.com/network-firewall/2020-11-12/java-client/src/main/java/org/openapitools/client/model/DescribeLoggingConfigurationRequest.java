...
public class DescribeLoggingConfigurationRequest {
  ...
  public DescribeLoggingConfigurationRequest firewallArn(String firewallArn) {
  ...
  public DescribeLoggingConfigurationRequest firewallName(String firewallName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeLoggingConfigurationRequest describeLoggingConfigurationRequest = (DescribeLoggingConfigurationRequest) o;
    return Objects.equals(this.firewallArn, describeLoggingConfigurationRequest.firewallArn) &&
        Objects.equals(this.firewallName, describeLoggingConfigurationRequest.firewallName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeLoggingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeLoggingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeLoggingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeLoggingConfigurationRequest is not found in the empty JSON string", DescribeLoggingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeLoggingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeLoggingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeLoggingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeLoggingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeLoggingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeLoggingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeLoggingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DescribeLoggingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeLoggingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeLoggingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeLoggingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeLoggingConfigurationRequest
   */
  public static DescribeLoggingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeLoggingConfigurationRequest.class);
  }

  /**
   * Convert an instance of DescribeLoggingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
