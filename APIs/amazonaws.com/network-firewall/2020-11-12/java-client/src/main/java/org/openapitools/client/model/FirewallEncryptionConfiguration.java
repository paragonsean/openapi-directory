...
public class FirewallEncryptionConfiguration {
  ...
  public FirewallEncryptionConfiguration() {
  }

  public FirewallEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public FirewallEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallEncryptionConfiguration firewallEncryptionConfiguration = (FirewallEncryptionConfiguration) o;
    return Objects.equals(this.keyId, firewallEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, firewallEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallEncryptionConfiguration is not found in the empty JSON string", FirewallEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, FirewallEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to FirewallEncryptionConfiguration
   */
  public static FirewallEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of FirewallEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
