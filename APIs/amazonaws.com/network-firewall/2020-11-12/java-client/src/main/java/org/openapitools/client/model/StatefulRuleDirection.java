...
/**
 * Gets or Sets StatefulRuleDirection
 */
@JsonAdapter(StatefulRuleDirection.Adapter.class)
public enum StatefulRuleDirection {
  ...
  StatefulRuleDirection(String value) {
    this.value = value;
  }
  ...
  public static StatefulRuleDirection fromValue(String value) {
    for (StatefulRuleDirection b : StatefulRuleDirection.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatefulRuleDirection> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatefulRuleDirection enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatefulRuleDirection read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatefulRuleDirection.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatefulRuleDirection.fromValue(value);
  }
}
