...
public class CreateFirewallPolicyRequestEncryptionConfiguration {
  ...
  public CreateFirewallPolicyRequestEncryptionConfiguration() {
  }

  public CreateFirewallPolicyRequestEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public CreateFirewallPolicyRequestEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallPolicyRequestEncryptionConfiguration createFirewallPolicyRequestEncryptionConfiguration = (CreateFirewallPolicyRequestEncryptionConfiguration) o;
    return Objects.equals(this.keyId, createFirewallPolicyRequestEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, createFirewallPolicyRequestEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallPolicyRequestEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallPolicyRequestEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallPolicyRequestEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallPolicyRequestEncryptionConfiguration is not found in the empty JSON string", CreateFirewallPolicyRequestEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallPolicyRequestEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallPolicyRequestEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallPolicyRequestEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallPolicyRequestEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallPolicyRequestEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallPolicyRequestEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallPolicyRequestEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallPolicyRequestEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateFirewallPolicyRequestEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallPolicyRequestEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallPolicyRequestEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallPolicyRequestEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallPolicyRequestEncryptionConfiguration
   */
  public static CreateFirewallPolicyRequestEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallPolicyRequestEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of CreateFirewallPolicyRequestEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
