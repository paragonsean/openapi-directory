...
/**
 * Gets or Sets GeneratedRulesType
 */
@JsonAdapter(GeneratedRulesType.Adapter.class)
public enum GeneratedRulesType {
  ...
  GeneratedRulesType(String value) {
    this.value = value;
  }
  ...
  public static GeneratedRulesType fromValue(String value) {
    for (GeneratedRulesType b : GeneratedRulesType.values()) {
  ...
  public static class Adapter extends TypeAdapter<GeneratedRulesType> {
    @Override
    public void write(final JsonWriter jsonWriter, final GeneratedRulesType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GeneratedRulesType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GeneratedRulesType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GeneratedRulesType.fromValue(value);
  }
}
