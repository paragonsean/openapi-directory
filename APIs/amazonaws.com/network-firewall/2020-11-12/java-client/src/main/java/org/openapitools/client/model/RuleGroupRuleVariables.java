...
public class RuleGroupRuleVariables {
  ...
  public RuleGroupRuleVariables ipSets(Map ipSets) {
    this.ipSets = ipSets;
    return this;
  }
  ...
  public RuleGroupRuleVariables portSets(Map portSets) {
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupRuleVariables ruleGroupRuleVariables = (RuleGroupRuleVariables) o;
    return Objects.equals(this.ipSets, ruleGroupRuleVariables.ipSets) &&
        Objects.equals(this.portSets, ruleGroupRuleVariables.portSets);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleGroupRuleVariables {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupRuleVariables
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupRuleVariables.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupRuleVariables is not found in the empty JSON string", RuleGroupRuleVariables.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupRuleVariables.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupRuleVariables` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupRuleVariables.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupRuleVariables' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupRuleVariables> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupRuleVariables.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupRuleVariables>() {
           @Override
           public void write(JsonWriter out, RuleGroupRuleVariables value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupRuleVariables read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupRuleVariables given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupRuleVariables
   * @throws IOException if the JSON string is invalid with respect to RuleGroupRuleVariables
   */
  public static RuleGroupRuleVariables fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupRuleVariables.class);
  }

  /**
   * Convert an instance of RuleGroupRuleVariables to an JSON string
   *
   * @return JSON string
   */
