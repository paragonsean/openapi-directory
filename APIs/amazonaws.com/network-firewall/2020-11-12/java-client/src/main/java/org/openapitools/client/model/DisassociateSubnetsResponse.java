...
public class DisassociateSubnetsResponse {
  ...
  public DisassociateSubnetsResponse firewallArn(String firewallArn) {
  ...
  public DisassociateSubnetsResponse firewallName(String firewallName) {
  ...
  public DisassociateSubnetsResponse subnetMappings(List subnetMappings) {
  ...
  public DisassociateSubnetsResponse updateToken(String updateToken) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateSubnetsResponse disassociateSubnetsResponse = (DisassociateSubnetsResponse) o;
    return Objects.equals(this.firewallArn, disassociateSubnetsResponse.firewallArn) &&
        Objects.equals(this.firewallName, disassociateSubnetsResponse.firewallName) &&
        Objects.equals(this.subnetMappings, disassociateSubnetsResponse.subnetMappings) &&
        Objects.equals(this.updateToken, disassociateSubnetsResponse.updateToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateSubnetsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateSubnetsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateSubnetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateSubnetsResponse is not found in the empty JSON string", DisassociateSubnetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateSubnetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateSubnetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateSubnetsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateSubnetsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateSubnetsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateSubnetsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateSubnetsResponse>() {
           @Override
           public void write(JsonWriter out, DisassociateSubnetsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateSubnetsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateSubnetsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateSubnetsResponse
   * @throws IOException if the JSON string is invalid with respect to DisassociateSubnetsResponse
   */
  public static DisassociateSubnetsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateSubnetsResponse.class);
  }

  /**
   * Convert an instance of DisassociateSubnetsResponse to an JSON string
   *
   * @return JSON string
   */
