...
import org.openapitools.client.model.PerObjectSyncStatus;
...
public class PerObjectStatus {
  ...
  private PerObjectSyncStatus syncStatus;
  ...
  public PerObjectStatus syncStatus(PerObjectSyncStatus syncStatus) {
  ...
  public PerObjectSyncStatus getSyncStatus() {
    return syncStatus;
  }

  public void setSyncStatus(PerObjectSyncStatus syncStatus) {
    this.syncStatus = syncStatus;
  }


  public PerObjectStatus updateToken(String updateToken) {
  ...
  public boolean equals(Object o) {
    ...
    PerObjectStatus perObjectStatus = (PerObjectStatus) o;
    return Objects.equals(this.syncStatus, perObjectStatus.syncStatus) &&
        Objects.equals(this.updateToken, perObjectStatus.updateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(syncStatus, updateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PerObjectStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PerObjectStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PerObjectStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PerObjectStatus is not found in the empty JSON string", PerObjectStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PerObjectStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PerObjectStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `SyncStatus`
      if (jsonObj.get("SyncStatus") != null && !jsonObj.get("SyncStatus").isJsonNull()) {
        PerObjectSyncStatus.validateJsonElement(jsonObj.get("SyncStatus"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PerObjectStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PerObjectStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PerObjectStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PerObjectStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<PerObjectStatus>() {
           @Override
           public void write(JsonWriter out, PerObjectStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PerObjectStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PerObjectStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PerObjectStatus
   * @throws IOException if the JSON string is invalid with respect to PerObjectStatus
   */
  public static PerObjectStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PerObjectStatus.class);
  }

  /**
   * Convert an instance of PerObjectStatus to an JSON string
   *
   * @return JSON string
   */
