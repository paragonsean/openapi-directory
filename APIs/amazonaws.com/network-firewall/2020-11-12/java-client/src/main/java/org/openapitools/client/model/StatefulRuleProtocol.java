...
/**
 * Gets or Sets StatefulRuleProtocol
 */
@JsonAdapter(StatefulRuleProtocol.Adapter.class)
public enum StatefulRuleProtocol {
  ...
  StatefulRuleProtocol(String value) {
    this.value = value;
  }
  ...
  public static StatefulRuleProtocol fromValue(String value) {
    for (StatefulRuleProtocol b : StatefulRuleProtocol.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatefulRuleProtocol> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatefulRuleProtocol enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatefulRuleProtocol read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatefulRuleProtocol.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatefulRuleProtocol.fromValue(value);
  }
}
