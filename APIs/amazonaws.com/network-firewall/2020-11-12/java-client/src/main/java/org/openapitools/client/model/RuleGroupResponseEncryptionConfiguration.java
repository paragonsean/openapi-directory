...
public class RuleGroupResponseEncryptionConfiguration {
  ...
  public RuleGroupResponseEncryptionConfiguration() {
  }

  public RuleGroupResponseEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public RuleGroupResponseEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupResponseEncryptionConfiguration ruleGroupResponseEncryptionConfiguration = (RuleGroupResponseEncryptionConfiguration) o;
    return Objects.equals(this.keyId, ruleGroupResponseEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, ruleGroupResponseEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleGroupResponseEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupResponseEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupResponseEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupResponseEncryptionConfiguration is not found in the empty JSON string", RuleGroupResponseEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupResponseEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupResponseEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RuleGroupResponseEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupResponseEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupResponseEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupResponseEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupResponseEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupResponseEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, RuleGroupResponseEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupResponseEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupResponseEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupResponseEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to RuleGroupResponseEncryptionConfiguration
   */
  public static RuleGroupResponseEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupResponseEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of RuleGroupResponseEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
