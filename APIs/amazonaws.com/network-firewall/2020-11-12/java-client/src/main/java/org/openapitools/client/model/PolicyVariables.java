...
public class PolicyVariables {
  ...
  public PolicyVariables() {
  }

  public PolicyVariables ruleVariables(Map ruleVariables) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyVariables policyVariables = (PolicyVariables) o;
    return Objects.equals(this.ruleVariables, policyVariables.ruleVariables);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyVariables {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyVariables
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyVariables.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyVariables is not found in the empty JSON string", PolicyVariables.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyVariables.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyVariables` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyVariables.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyVariables' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyVariables> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyVariables.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyVariables>() {
           @Override
           public void write(JsonWriter out, PolicyVariables value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyVariables read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyVariables given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyVariables
   * @throws IOException if the JSON string is invalid with respect to PolicyVariables
   */
  public static PolicyVariables fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyVariables.class);
  }

  /**
   * Convert an instance of PolicyVariables to an JSON string
   *
   * @return JSON string
   */
