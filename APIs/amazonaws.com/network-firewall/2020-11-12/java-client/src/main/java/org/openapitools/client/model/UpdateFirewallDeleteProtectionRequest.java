...
public class UpdateFirewallDeleteProtectionRequest {
  ...
  public UpdateFirewallDeleteProtectionRequest() {
  }

  public UpdateFirewallDeleteProtectionRequest updateToken(String updateToken) {
  ...
  public UpdateFirewallDeleteProtectionRequest firewallArn(String firewallArn) {
  ...
  public UpdateFirewallDeleteProtectionRequest firewallName(String firewallName) {
  ...
  public UpdateFirewallDeleteProtectionRequest deleteProtection(Boolean deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallDeleteProtectionRequest updateFirewallDeleteProtectionRequest = (UpdateFirewallDeleteProtectionRequest) o;
    return Objects.equals(this.updateToken, updateFirewallDeleteProtectionRequest.updateToken) &&
        Objects.equals(this.firewallArn, updateFirewallDeleteProtectionRequest.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallDeleteProtectionRequest.firewallName) &&
        Objects.equals(this.deleteProtection, updateFirewallDeleteProtectionRequest.deleteProtection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, deleteProtection);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallDeleteProtectionRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("DeleteProtection");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallDeleteProtectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallDeleteProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallDeleteProtectionRequest is not found in the empty JSON string", UpdateFirewallDeleteProtectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallDeleteProtectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallDeleteProtectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFirewallDeleteProtectionRequest.openapiRequiredFields) {
      ...
      // validate the required field `DeleteProtection`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallDeleteProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallDeleteProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallDeleteProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallDeleteProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallDeleteProtectionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallDeleteProtectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallDeleteProtectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallDeleteProtectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallDeleteProtectionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallDeleteProtectionRequest
   */
  public static UpdateFirewallDeleteProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallDeleteProtectionRequest.class);
  }

  /**
   * Convert an instance of UpdateFirewallDeleteProtectionRequest to an JSON string
   *
   * @return JSON string
   */
