...
public class CreateFirewallRequestEncryptionConfiguration {
  ...
  public CreateFirewallRequestEncryptionConfiguration() {
  }

  public CreateFirewallRequestEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public CreateFirewallRequestEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallRequestEncryptionConfiguration createFirewallRequestEncryptionConfiguration = (CreateFirewallRequestEncryptionConfiguration) o;
    return Objects.equals(this.keyId, createFirewallRequestEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, createFirewallRequestEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallRequestEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallRequestEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallRequestEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallRequestEncryptionConfiguration is not found in the empty JSON string", CreateFirewallRequestEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallRequestEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallRequestEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallRequestEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallRequestEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallRequestEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallRequestEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallRequestEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallRequestEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateFirewallRequestEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallRequestEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallRequestEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallRequestEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallRequestEncryptionConfiguration
   */
  public static CreateFirewallRequestEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallRequestEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of CreateFirewallRequestEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
