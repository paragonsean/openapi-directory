...
/**
 * Gets or Sets TCPFlag
 */
@JsonAdapter(TCPFlag.Adapter.class)
public enum TCPFlag {
  ...
  public static class Adapter extends TypeAdapter<TCPFlag> {
    @Override
    public void write(final JsonWriter jsonWriter, final TCPFlag enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TCPFlag read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TCPFlag.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TCPFlag.fromValue(value);
  }
}
