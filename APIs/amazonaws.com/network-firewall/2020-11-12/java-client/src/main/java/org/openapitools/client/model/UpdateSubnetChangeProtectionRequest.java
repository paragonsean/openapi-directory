...
public class UpdateSubnetChangeProtectionRequest {
  ...
  public UpdateSubnetChangeProtectionRequest() {
  }

  public UpdateSubnetChangeProtectionRequest updateToken(String updateToken) {
  ...
  public UpdateSubnetChangeProtectionRequest firewallArn(String firewallArn) {
  ...
  public UpdateSubnetChangeProtectionRequest firewallName(String firewallName) {
  ...
  public UpdateSubnetChangeProtectionRequest subnetChangeProtection(Boolean subnetChangeProtection) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSubnetChangeProtectionRequest updateSubnetChangeProtectionRequest = (UpdateSubnetChangeProtectionRequest) o;
    return Objects.equals(this.updateToken, updateSubnetChangeProtectionRequest.updateToken) &&
        Objects.equals(this.firewallArn, updateSubnetChangeProtectionRequest.firewallArn) &&
        Objects.equals(this.firewallName, updateSubnetChangeProtectionRequest.firewallName) &&
        Objects.equals(this.subnetChangeProtection, updateSubnetChangeProtectionRequest.subnetChangeProtection);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSubnetChangeProtectionRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("SubnetChangeProtection");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubnetChangeProtectionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubnetChangeProtectionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSubnetChangeProtectionRequest is not found in the empty JSON string", UpdateSubnetChangeProtectionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubnetChangeProtectionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubnetChangeProtectionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSubnetChangeProtectionRequest.openapiRequiredFields) {
      ...
      // validate the required field `SubnetChangeProtection`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubnetChangeProtectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubnetChangeProtectionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubnetChangeProtectionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubnetChangeProtectionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubnetChangeProtectionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSubnetChangeProtectionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubnetChangeProtectionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubnetChangeProtectionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubnetChangeProtectionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateSubnetChangeProtectionRequest
   */
  public static UpdateSubnetChangeProtectionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubnetChangeProtectionRequest.class);
  }

  /**
   * Convert an instance of UpdateSubnetChangeProtectionRequest to an JSON string
   *
   * @return JSON string
   */
