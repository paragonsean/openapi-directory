...
public class UpdateSubnetChangeProtectionResponse {
  ...
  public UpdateSubnetChangeProtectionResponse updateToken(String updateToken) {
  ...
  public UpdateSubnetChangeProtectionResponse firewallArn(String firewallArn) {
  ...
  public UpdateSubnetChangeProtectionResponse firewallName(String firewallName) {
  ...
  public UpdateSubnetChangeProtectionResponse subnetChangeProtection(Boolean subnetChangeProtection) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSubnetChangeProtectionResponse updateSubnetChangeProtectionResponse = (UpdateSubnetChangeProtectionResponse) o;
    return Objects.equals(this.updateToken, updateSubnetChangeProtectionResponse.updateToken) &&
        Objects.equals(this.firewallArn, updateSubnetChangeProtectionResponse.firewallArn) &&
        Objects.equals(this.firewallName, updateSubnetChangeProtectionResponse.firewallName) &&
        Objects.equals(this.subnetChangeProtection, updateSubnetChangeProtectionResponse.subnetChangeProtection);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, subnetChangeProtection);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSubnetChangeProtectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubnetChangeProtectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubnetChangeProtectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSubnetChangeProtectionResponse is not found in the empty JSON string", UpdateSubnetChangeProtectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubnetChangeProtectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSubnetChangeProtectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubnetChangeProtectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubnetChangeProtectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubnetChangeProtectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubnetChangeProtectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubnetChangeProtectionResponse>() {
           @Override
           public void write(JsonWriter out, UpdateSubnetChangeProtectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubnetChangeProtectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubnetChangeProtectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubnetChangeProtectionResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateSubnetChangeProtectionResponse
   */
  public static UpdateSubnetChangeProtectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubnetChangeProtectionResponse.class);
  }

  /**
   * Convert an instance of UpdateSubnetChangeProtectionResponse to an JSON string
   *
   * @return JSON string
   */
