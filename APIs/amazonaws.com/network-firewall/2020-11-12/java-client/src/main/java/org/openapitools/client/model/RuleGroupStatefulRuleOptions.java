...
public class RuleGroupStatefulRuleOptions {
  ...
  public RuleGroupStatefulRuleOptions() {
  }

  public RuleGroupStatefulRuleOptions ruleOrder(RuleOrder ruleOrder) {
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupStatefulRuleOptions ruleGroupStatefulRuleOptions = (RuleGroupStatefulRuleOptions) o;
    return Objects.equals(this.ruleOrder, ruleGroupStatefulRuleOptions.ruleOrder);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleOrder);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RuleGroupStatefulRuleOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupStatefulRuleOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupStatefulRuleOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupStatefulRuleOptions is not found in the empty JSON string", RuleGroupStatefulRuleOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupStatefulRuleOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupStatefulRuleOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupStatefulRuleOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupStatefulRuleOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupStatefulRuleOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupStatefulRuleOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupStatefulRuleOptions>() {
           @Override
           public void write(JsonWriter out, RuleGroupStatefulRuleOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupStatefulRuleOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupStatefulRuleOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupStatefulRuleOptions
   * @throws IOException if the JSON string is invalid with respect to RuleGroupStatefulRuleOptions
   */
  public static RuleGroupStatefulRuleOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupStatefulRuleOptions.class);
  }

  /**
   * Convert an instance of RuleGroupStatefulRuleOptions to an JSON string
   *
   * @return JSON string
   */
