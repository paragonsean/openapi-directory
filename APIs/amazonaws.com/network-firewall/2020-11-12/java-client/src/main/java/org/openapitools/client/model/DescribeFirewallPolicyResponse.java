...
import org.openapitools.client.model.CreateFirewallPolicyResponseFirewallPolicyResponse;
import org.openapitools.client.model.DescribeFirewallPolicyResponseFirewallPolicy;
...
public class DescribeFirewallPolicyResponse {
  ...
  public static final String SERIALIZED_NAME_FIREWALL_POLICY_RESPONSE = "FirewallPolicyResponse";
  @SerializedName(SERIALIZED_NAME_FIREWALL_POLICY_RESPONSE)
  private CreateFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse;

  public static final String SERIALIZED_NAME_FIREWALL_POLICY = "FirewallPolicy";
  @SerializedName(SERIALIZED_NAME_FIREWALL_POLICY)
  private DescribeFirewallPolicyResponseFirewallPolicy firewallPolicy;

  public DescribeFirewallPolicyResponse() {
  }

  public DescribeFirewallPolicyResponse updateToken(String updateToken) {
  ...
  public DescribeFirewallPolicyResponse firewallPolicyResponse(CreateFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
   ...
   */
  @javax.annotation.Nonnull
  public CreateFirewallPolicyResponseFirewallPolicyResponse getFirewallPolicyResponse() {
    return firewallPolicyResponse;
  }

  public void setFirewallPolicyResponse(CreateFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
    this.firewallPolicyResponse = firewallPolicyResponse;
  }


  public DescribeFirewallPolicyResponse firewallPolicy(DescribeFirewallPolicyResponseFirewallPolicy firewallPolicy) {
  ...
  public DescribeFirewallPolicyResponseFirewallPolicy getFirewallPolicy() {
    return firewallPolicy;
  }

  public void setFirewallPolicy(DescribeFirewallPolicyResponseFirewallPolicy firewallPolicy) {
    this.firewallPolicy = firewallPolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeFirewallPolicyResponse describeFirewallPolicyResponse = (DescribeFirewallPolicyResponse) o;
    return Objects.equals(this.updateToken, describeFirewallPolicyResponse.updateToken) &&
        Objects.equals(this.firewallPolicyResponse, describeFirewallPolicyResponse.firewallPolicyResponse) &&
        Objects.equals(this.firewallPolicy, describeFirewallPolicyResponse.firewallPolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallPolicyResponse, firewallPolicy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeFirewallPolicyResponse {\n");
    sb.append("    updateToken: ").append(toIndentedString(updateToken)).append("\n");
    sb.append("    firewallPolicyResponse: ").append(toIndentedString(firewallPolicyResponse)).append("\n");
  ...
  static {
    ...
    openapiFields.add("FirewallPolicyResponse");
    openapiFields.add("FirewallPolicy");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("UpdateToken");
    openapiRequiredFields.add("FirewallPolicyResponse");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeFirewallPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeFirewallPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeFirewallPolicyResponse is not found in the empty JSON string", DescribeFirewallPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeFirewallPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeFirewallPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeFirewallPolicyResponse.openapiRequiredFields) {
      ...
      // validate the required field `FirewallPolicyResponse`
      CreateFirewallPolicyResponseFirewallPolicyResponse.validateJsonElement(jsonObj.get("FirewallPolicyResponse"));
      // validate the optional field `FirewallPolicy`
      if (jsonObj.get("FirewallPolicy") != null && !jsonObj.get("FirewallPolicy").isJsonNull()) {
        DescribeFirewallPolicyResponseFirewallPolicy.validateJsonElement(jsonObj.get("FirewallPolicy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeFirewallPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeFirewallPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeFirewallPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeFirewallPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeFirewallPolicyResponse>() {
           @Override
           public void write(JsonWriter out, DescribeFirewallPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeFirewallPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeFirewallPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeFirewallPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeFirewallPolicyResponse
   */
  public static DescribeFirewallPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeFirewallPolicyResponse.class);
  }

  /**
   * Convert an instance of DescribeFirewallPolicyResponse to an JSON string
   *
   * @return JSON string
   */
