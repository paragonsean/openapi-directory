...
public class IPSetReference {
  ...
  public IPSetReference referenceArn(String referenceArn) {
  ...
  public boolean equals(Object o) {
    ...
    IPSetReference ipSetReference = (IPSetReference) o;
    return Objects.equals(this.referenceArn, ipSetReference.referenceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPSetReference {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPSetReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPSetReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPSetReference is not found in the empty JSON string", IPSetReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPSetReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPSetReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPSetReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPSetReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPSetReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPSetReference.class));

       return (TypeAdapter<T>) new TypeAdapter<IPSetReference>() {
           @Override
           public void write(JsonWriter out, IPSetReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPSetReference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPSetReference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPSetReference
   * @throws IOException if the JSON string is invalid with respect to IPSetReference
   */
  public static IPSetReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPSetReference.class);
  }

  /**
   * Convert an instance of IPSetReference to an JSON string
   *
   * @return JSON string
   */
