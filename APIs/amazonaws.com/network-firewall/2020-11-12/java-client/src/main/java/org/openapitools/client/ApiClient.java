...
public class ApiClient {
    ...
    private String basePath = "http://network-firewall.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-11-12/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://network-firewall.us-east-1.amazonaws.com
