...
public class DescribeFirewallRequest {
  ...
  public DescribeFirewallRequest() {
  }

  public DescribeFirewallRequest firewallName(String firewallName) {
  ...
  public DescribeFirewallRequest firewallArn(String firewallArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeFirewallRequest describeFirewallRequest = (DescribeFirewallRequest) o;
    return Objects.equals(this.firewallName, describeFirewallRequest.firewallName) &&
        Objects.equals(this.firewallArn, describeFirewallRequest.firewallArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeFirewallRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeFirewallRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeFirewallRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeFirewallRequest is not found in the empty JSON string", DescribeFirewallRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeFirewallRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeFirewallRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeFirewallRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeFirewallRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeFirewallRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeFirewallRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeFirewallRequest>() {
           @Override
           public void write(JsonWriter out, DescribeFirewallRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeFirewallRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeFirewallRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeFirewallRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeFirewallRequest
   */
  public static DescribeFirewallRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeFirewallRequest.class);
  }

  /**
   * Convert an instance of DescribeFirewallRequest to an JSON string
   *
   * @return JSON string
   */
