...
/**
 * Gets or Sets ConfigurationSyncState
 */
@JsonAdapter(ConfigurationSyncState.Adapter.class)
public enum ConfigurationSyncState {
  ...
  ConfigurationSyncState(String value) {
    this.value = value;
  }
  ...
  public static ConfigurationSyncState fromValue(String value) {
    for (ConfigurationSyncState b : ConfigurationSyncState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConfigurationSyncState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConfigurationSyncState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConfigurationSyncState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConfigurationSyncState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConfigurationSyncState.fromValue(value);
  }
}
