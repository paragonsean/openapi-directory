...
public class RulesSourceRulesSourceList {
  ...
  public RulesSourceRulesSourceList() {
  }

  public RulesSourceRulesSourceList targets(List targets) {
  ...
  public RulesSourceRulesSourceList targetTypes(List targetTypes) {
  ...
  public RulesSourceRulesSourceList generatedRulesType(GeneratedRulesType generatedRulesType) {
  ...
  public boolean equals(Object o) {
    ...
    RulesSourceRulesSourceList rulesSourceRulesSourceList = (RulesSourceRulesSourceList) o;
    return Objects.equals(this.targets, rulesSourceRulesSourceList.targets) &&
        Objects.equals(this.targetTypes, rulesSourceRulesSourceList.targetTypes) &&
        Objects.equals(this.generatedRulesType, rulesSourceRulesSourceList.generatedRulesType);
  }
  ...
  public String toString() {
    ...
    sb.append("class RulesSourceRulesSourceList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RulesSourceRulesSourceList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RulesSourceRulesSourceList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RulesSourceRulesSourceList is not found in the empty JSON string", RulesSourceRulesSourceList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RulesSourceRulesSourceList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RulesSourceRulesSourceList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RulesSourceRulesSourceList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RulesSourceRulesSourceList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RulesSourceRulesSourceList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RulesSourceRulesSourceList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RulesSourceRulesSourceList.class));

       return (TypeAdapter<T>) new TypeAdapter<RulesSourceRulesSourceList>() {
           @Override
           public void write(JsonWriter out, RulesSourceRulesSourceList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RulesSourceRulesSourceList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RulesSourceRulesSourceList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RulesSourceRulesSourceList
   * @throws IOException if the JSON string is invalid with respect to RulesSourceRulesSourceList
   */
  public static RulesSourceRulesSourceList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RulesSourceRulesSourceList.class);
  }

  /**
   * Convert an instance of RulesSourceRulesSourceList to an JSON string
   *
   * @return JSON string
   */
