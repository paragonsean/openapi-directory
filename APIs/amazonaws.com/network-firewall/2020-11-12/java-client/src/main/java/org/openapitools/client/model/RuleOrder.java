 ...
 */
@JsonAdapter(RuleOrder.Adapter.class)
public enum RuleOrder {
  ...
  public static RuleOrder fromValue(String value) {
    for (RuleOrder b : RuleOrder.values()) {
  ...
  public static class Adapter extends TypeAdapter<RuleOrder> {
    @Override
    public void write(final JsonWriter jsonWriter, final RuleOrder enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RuleOrder read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RuleOrder.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RuleOrder.fromValue(value);
  }
}
