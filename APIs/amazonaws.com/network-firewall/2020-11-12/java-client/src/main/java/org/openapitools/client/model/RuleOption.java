...
public class RuleOption {
  ...
  public RuleOption keyword(String keyword) {
  ...
  public RuleOption settings(List settings) {
  ...
  public boolean equals(Object o) {
    ...
    RuleOption ruleOption = (RuleOption) o;
    return Objects.equals(this.keyword, ruleOption.keyword) &&
        Objects.equals(this.settings, ruleOption.settings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleOption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleOption is not found in the empty JSON string", RuleOption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RuleOption.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleOption.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleOption>() {
           @Override
           public void write(JsonWriter out, RuleOption value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleOption read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleOption given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleOption
   * @throws IOException if the JSON string is invalid with respect to RuleOption
   */
  public static RuleOption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleOption.class);
  }

  /**
   * Convert an instance of RuleOption to an JSON string
   *
   * @return JSON string
   */
