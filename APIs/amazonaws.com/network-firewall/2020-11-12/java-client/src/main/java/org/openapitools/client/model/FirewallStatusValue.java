...
/**
 * Gets or Sets FirewallStatusValue
 */
@JsonAdapter(FirewallStatusValue.Adapter.class)
public enum FirewallStatusValue {
  ...
  FirewallStatusValue(String value) {
    this.value = value;
  }
  ...
  public static FirewallStatusValue fromValue(String value) {
    for (FirewallStatusValue b : FirewallStatusValue.values()) {
  ...
  public static class Adapter extends TypeAdapter<FirewallStatusValue> {
    @Override
    public void write(final JsonWriter jsonWriter, final FirewallStatusValue enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FirewallStatusValue read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FirewallStatusValue.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FirewallStatusValue.fromValue(value);
  }
}
