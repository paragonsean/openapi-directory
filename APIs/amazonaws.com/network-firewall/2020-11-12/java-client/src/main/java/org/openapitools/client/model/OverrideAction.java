...
/**
 * Gets or Sets OverrideAction
 */
@JsonAdapter(OverrideAction.Adapter.class)
public enum OverrideAction {
  ...
  public static OverrideAction fromValue(String value) {
    for (OverrideAction b : OverrideAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<OverrideAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final OverrideAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OverrideAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OverrideAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OverrideAction.fromValue(value);
  }
}
