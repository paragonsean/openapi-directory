...
public class DescribeRuleGroupRequest {
  ...
  public DescribeRuleGroupRequest ruleGroupName(String ruleGroupName) {
  ...
  public DescribeRuleGroupRequest ruleGroupArn(String ruleGroupArn) {
  ...
  public DescribeRuleGroupRequest type(RuleGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeRuleGroupRequest describeRuleGroupRequest = (DescribeRuleGroupRequest) o;
    return Objects.equals(this.ruleGroupName, describeRuleGroupRequest.ruleGroupName) &&
        Objects.equals(this.ruleGroupArn, describeRuleGroupRequest.ruleGroupArn) &&
        Objects.equals(this.type, describeRuleGroupRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleGroupName, ruleGroupArn, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeRuleGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRuleGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRuleGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRuleGroupRequest is not found in the empty JSON string", DescribeRuleGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRuleGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRuleGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRuleGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRuleGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRuleGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRuleGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRuleGroupRequest>() {
           @Override
           public void write(JsonWriter out, DescribeRuleGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRuleGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRuleGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRuleGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeRuleGroupRequest
   */
  public static DescribeRuleGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRuleGroupRequest.class);
  }

  /**
   * Convert an instance of DescribeRuleGroupRequest to an JSON string
   *
   * @return JSON string
   */
