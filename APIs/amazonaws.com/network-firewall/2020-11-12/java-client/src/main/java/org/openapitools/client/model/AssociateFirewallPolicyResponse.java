...
public class AssociateFirewallPolicyResponse {
  ...
  public AssociateFirewallPolicyResponse() {
  }

  public AssociateFirewallPolicyResponse firewallArn(String firewallArn) {
  ...
  public AssociateFirewallPolicyResponse firewallName(String firewallName) {
  ...
  public AssociateFirewallPolicyResponse firewallPolicyArn(String firewallPolicyArn) {
  ...
  public AssociateFirewallPolicyResponse updateToken(String updateToken) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFirewallPolicyResponse associateFirewallPolicyResponse = (AssociateFirewallPolicyResponse) o;
    return Objects.equals(this.firewallArn, associateFirewallPolicyResponse.firewallArn) &&
        Objects.equals(this.firewallName, associateFirewallPolicyResponse.firewallName) &&
        Objects.equals(this.firewallPolicyArn, associateFirewallPolicyResponse.firewallPolicyArn) &&
        Objects.equals(this.updateToken, associateFirewallPolicyResponse.updateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName, firewallPolicyArn, updateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateFirewallPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFirewallPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFirewallPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFirewallPolicyResponse is not found in the empty JSON string", AssociateFirewallPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFirewallPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFirewallPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFirewallPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFirewallPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFirewallPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFirewallPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFirewallPolicyResponse>() {
           @Override
           public void write(JsonWriter out, AssociateFirewallPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFirewallPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFirewallPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFirewallPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to AssociateFirewallPolicyResponse
   */
  public static AssociateFirewallPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFirewallPolicyResponse.class);
  }

  /**
   * Convert an instance of AssociateFirewallPolicyResponse to an JSON string
   *
   * @return JSON string
   */
