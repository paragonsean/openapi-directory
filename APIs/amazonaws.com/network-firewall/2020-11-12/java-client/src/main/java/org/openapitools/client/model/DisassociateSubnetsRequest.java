...
public class DisassociateSubnetsRequest {
  ...
  public DisassociateSubnetsRequest() {
  }

  public DisassociateSubnetsRequest updateToken(String updateToken) {
  ...
  public DisassociateSubnetsRequest firewallArn(String firewallArn) {
  ...
  public DisassociateSubnetsRequest firewallName(String firewallName) {
  ...
  public DisassociateSubnetsRequest subnetIds(List subnetIds) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateSubnetsRequest disassociateSubnetsRequest = (DisassociateSubnetsRequest) o;
    return Objects.equals(this.updateToken, disassociateSubnetsRequest.updateToken) &&
        Objects.equals(this.firewallArn, disassociateSubnetsRequest.firewallArn) &&
        Objects.equals(this.firewallName, disassociateSubnetsRequest.firewallName) &&
        Objects.equals(this.subnetIds, disassociateSubnetsRequest.subnetIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, subnetIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisassociateSubnetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateSubnetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateSubnetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateSubnetsRequest is not found in the empty JSON string", DisassociateSubnetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateSubnetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateSubnetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisassociateSubnetsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateSubnetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateSubnetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateSubnetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateSubnetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateSubnetsRequest>() {
           @Override
           public void write(JsonWriter out, DisassociateSubnetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateSubnetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateSubnetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateSubnetsRequest
   * @throws IOException if the JSON string is invalid with respect to DisassociateSubnetsRequest
   */
  public static DisassociateSubnetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateSubnetsRequest.class);
  }

  /**
   * Convert an instance of DisassociateSubnetsRequest to an JSON string
   *
   * @return JSON string
   */
