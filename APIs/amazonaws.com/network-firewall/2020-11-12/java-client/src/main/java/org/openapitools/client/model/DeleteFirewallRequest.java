...
public class DeleteFirewallRequest {
  ...
  public DeleteFirewallRequest firewallName(String firewallName) {
  ...
  public DeleteFirewallRequest firewallArn(String firewallArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firewallName, deleteFirewallRequest.firewallName) &&
        Objects.equals(this.firewallArn, deleteFirewallRequest.firewallArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFirewallRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFirewallRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFirewallRequest is not found in the empty JSON string", DeleteFirewallRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFirewallRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFirewallRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFirewallRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFirewallRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFirewallRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFirewallRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFirewallRequest>() {
           @Override
           public void write(JsonWriter out, DeleteFirewallRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFirewallRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFirewallRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFirewallRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteFirewallRequest
   */
  public static DeleteFirewallRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFirewallRequest.class);
  }

  /**
   * Convert an instance of DeleteFirewallRequest to an JSON string
   *
   * @return JSON string
   */
