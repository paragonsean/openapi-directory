...
/**
 * Gets or Sets RuleGroupType
 */
@JsonAdapter(RuleGroupType.Adapter.class)
public enum RuleGroupType {
  ...
  public static RuleGroupType fromValue(String value) {
    for (RuleGroupType b : RuleGroupType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RuleGroupType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RuleGroupType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RuleGroupType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RuleGroupType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RuleGroupType.fromValue(value);
  }
}
