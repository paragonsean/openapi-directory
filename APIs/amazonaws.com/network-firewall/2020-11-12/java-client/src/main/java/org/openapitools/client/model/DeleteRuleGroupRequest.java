...
public class DeleteRuleGroupRequest {
  ...
  public DeleteRuleGroupRequest ruleGroupName(String ruleGroupName) {
  ...
  public DeleteRuleGroupRequest ruleGroupArn(String ruleGroupArn) {
  ...
  public DeleteRuleGroupRequest type(RuleGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRuleGroupRequest deleteRuleGroupRequest = (DeleteRuleGroupRequest) o;
    return Objects.equals(this.ruleGroupName, deleteRuleGroupRequest.ruleGroupName) &&
        Objects.equals(this.ruleGroupArn, deleteRuleGroupRequest.ruleGroupArn) &&
        Objects.equals(this.type, deleteRuleGroupRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRuleGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRuleGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRuleGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRuleGroupRequest is not found in the empty JSON string", DeleteRuleGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRuleGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRuleGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRuleGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRuleGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRuleGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRuleGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRuleGroupRequest>() {
           @Override
           public void write(JsonWriter out, DeleteRuleGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRuleGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRuleGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRuleGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteRuleGroupRequest
   */
  public static DeleteRuleGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRuleGroupRequest.class);
  }

  /**
   * Convert an instance of DeleteRuleGroupRequest to an JSON string
   *
   * @return JSON string
   */
