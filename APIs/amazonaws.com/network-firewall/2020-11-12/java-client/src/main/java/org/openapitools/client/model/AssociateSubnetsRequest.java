...
public class AssociateSubnetsRequest {
  ...
  public AssociateSubnetsRequest() {
  }

  public AssociateSubnetsRequest updateToken(String updateToken) {
  ...
  public AssociateSubnetsRequest firewallArn(String firewallArn) {
  ...
  public AssociateSubnetsRequest firewallName(String firewallName) {
  ...
  public AssociateSubnetsRequest subnetMappings(List subnetMappings) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateSubnetsRequest associateSubnetsRequest = (AssociateSubnetsRequest) o;
    return Objects.equals(this.updateToken, associateSubnetsRequest.updateToken) &&
        Objects.equals(this.firewallArn, associateSubnetsRequest.firewallArn) &&
        Objects.equals(this.firewallName, associateSubnetsRequest.firewallName) &&
        Objects.equals(this.subnetMappings, associateSubnetsRequest.subnetMappings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, subnetMappings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateSubnetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateSubnetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateSubnetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateSubnetsRequest is not found in the empty JSON string", AssociateSubnetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateSubnetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateSubnetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateSubnetsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateSubnetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateSubnetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateSubnetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateSubnetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateSubnetsRequest>() {
           @Override
           public void write(JsonWriter out, AssociateSubnetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateSubnetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateSubnetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateSubnetsRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateSubnetsRequest
   */
  public static AssociateSubnetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateSubnetsRequest.class);
  }

  /**
   * Convert an instance of AssociateSubnetsRequest to an JSON string
   *
   * @return JSON string
   */
