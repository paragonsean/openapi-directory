...
public class ListFirewallPoliciesResponse {
  ...
  private List firewallPolicies;

  public ListFirewallPoliciesResponse() {
  }

  public ListFirewallPoliciesResponse nextToken(String nextToken) {
  ...
  public ListFirewallPoliciesResponse firewallPolicies(List firewallPolicies) {
   ...
   */
  @javax.annotation.Nullable
  public List getFirewallPolicies() {
    return firewallPolicies;
  }

  public void setFirewallPolicies(List firewallPolicies) {
    this.firewallPolicies = firewallPolicies;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListFirewallPoliciesResponse listFirewallPoliciesResponse = (ListFirewallPoliciesResponse) o;
    return Objects.equals(this.nextToken, listFirewallPoliciesResponse.nextToken) &&
        Objects.equals(this.firewallPolicies, listFirewallPoliciesResponse.firewallPolicies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, firewallPolicies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListFirewallPoliciesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFirewallPoliciesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFirewallPoliciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFirewallPoliciesResponse is not found in the empty JSON string", ListFirewallPoliciesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFirewallPoliciesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFirewallPoliciesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `FirewallPolicies`
      if (jsonObj.get("FirewallPolicies") != null && !jsonObj.get("FirewallPolicies").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("FirewallPolicies"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFirewallPoliciesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFirewallPoliciesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFirewallPoliciesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFirewallPoliciesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFirewallPoliciesResponse>() {
           @Override
           public void write(JsonWriter out, ListFirewallPoliciesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFirewallPoliciesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFirewallPoliciesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFirewallPoliciesResponse
   * @throws IOException if the JSON string is invalid with respect to ListFirewallPoliciesResponse
   */
  public static ListFirewallPoliciesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFirewallPoliciesResponse.class);
  }

  /**
   * Convert an instance of ListFirewallPoliciesResponse to an JSON string
   *
   * @return JSON string
   */
