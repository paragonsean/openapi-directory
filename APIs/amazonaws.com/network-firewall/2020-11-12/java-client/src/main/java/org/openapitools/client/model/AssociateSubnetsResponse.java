...
public class AssociateSubnetsResponse {
  ...
  public AssociateSubnetsResponse firewallArn(String firewallArn) {
  ...
  public AssociateSubnetsResponse firewallName(String firewallName) {
  ...
  public AssociateSubnetsResponse subnetMappings(List subnetMappings) {
  ...
  public AssociateSubnetsResponse updateToken(String updateToken) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateSubnetsResponse associateSubnetsResponse = (AssociateSubnetsResponse) o;
    return Objects.equals(this.firewallArn, associateSubnetsResponse.firewallArn) &&
        Objects.equals(this.firewallName, associateSubnetsResponse.firewallName) &&
        Objects.equals(this.subnetMappings, associateSubnetsResponse.subnetMappings) &&
        Objects.equals(this.updateToken, associateSubnetsResponse.updateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName, subnetMappings, updateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateSubnetsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateSubnetsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateSubnetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateSubnetsResponse is not found in the empty JSON string", AssociateSubnetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateSubnetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateSubnetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateSubnetsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateSubnetsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateSubnetsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateSubnetsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateSubnetsResponse>() {
           @Override
           public void write(JsonWriter out, AssociateSubnetsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateSubnetsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateSubnetsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateSubnetsResponse
   * @throws IOException if the JSON string is invalid with respect to AssociateSubnetsResponse
   */
  public static AssociateSubnetsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateSubnetsResponse.class);
  }

  /**
   * Convert an instance of AssociateSubnetsResponse to an JSON string
   *
   * @return JSON string
   */
