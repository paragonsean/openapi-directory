...
/**
 * Gets or Sets StreamExceptionPolicy
 */
@JsonAdapter(StreamExceptionPolicy.Adapter.class)
public enum StreamExceptionPolicy {
  ...
  StreamExceptionPolicy(String value) {
    this.value = value;
  }
  ...
  public static StreamExceptionPolicy fromValue(String value) {
    for (StreamExceptionPolicy b : StreamExceptionPolicy.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamExceptionPolicy> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamExceptionPolicy enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamExceptionPolicy read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamExceptionPolicy.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamExceptionPolicy.fromValue(value);
  }
}
