...
import org.openapitools.client.model.CreateRuleGroupResponseRuleGroupResponse;
...
public class DeleteRuleGroupResponse {
  public static final String SERIALIZED_NAME_RULE_GROUP_RESPONSE = "RuleGroupResponse";
  @SerializedName(SERIALIZED_NAME_RULE_GROUP_RESPONSE)
  private CreateRuleGroupResponseRuleGroupResponse ruleGroupResponse;

  public DeleteRuleGroupResponse() {
  }

  public DeleteRuleGroupResponse ruleGroupResponse(CreateRuleGroupResponseRuleGroupResponse ruleGroupResponse) {
  ...
  public CreateRuleGroupResponseRuleGroupResponse getRuleGroupResponse() {
    return ruleGroupResponse;
  }

  public void setRuleGroupResponse(CreateRuleGroupResponseRuleGroupResponse ruleGroupResponse) {
    this.ruleGroupResponse = ruleGroupResponse;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRuleGroupResponse deleteRuleGroupResponse = (DeleteRuleGroupResponse) o;
    return Objects.equals(this.ruleGroupResponse, deleteRuleGroupResponse.ruleGroupResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleGroupResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteRuleGroupResponse {\n");
    sb.append("    ruleGroupResponse: ").append(toIndentedString(ruleGroupResponse)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("RuleGroupResponse");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("RuleGroupResponse");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRuleGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRuleGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRuleGroupResponse is not found in the empty JSON string", DeleteRuleGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRuleGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRuleGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteRuleGroupResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `RuleGroupResponse`
      CreateRuleGroupResponseRuleGroupResponse.validateJsonElement(jsonObj.get("RuleGroupResponse"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRuleGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRuleGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRuleGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRuleGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRuleGroupResponse>() {
           @Override
           public void write(JsonWriter out, DeleteRuleGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRuleGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRuleGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRuleGroupResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteRuleGroupResponse
   */
  public static DeleteRuleGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRuleGroupResponse.class);
  }

  /**
   * Convert an instance of DeleteRuleGroupResponse to an JSON string
   *
   * @return JSON string
   */
