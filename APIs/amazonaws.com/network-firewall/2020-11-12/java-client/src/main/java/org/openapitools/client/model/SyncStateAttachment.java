...
public class SyncStateAttachment {
  ...
  public SyncStateAttachment() {
  }

  public SyncStateAttachment subnetId(String subnetId) {
  ...
  public SyncStateAttachment endpointId(String endpointId) {
  ...
  public SyncStateAttachment status(AttachmentStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SyncStateAttachment statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    SyncStateAttachment syncStateAttachment = (SyncStateAttachment) o;
    return Objects.equals(this.subnetId, syncStateAttachment.subnetId) &&
        Objects.equals(this.endpointId, syncStateAttachment.endpointId) &&
        Objects.equals(this.status, syncStateAttachment.status) &&
        Objects.equals(this.statusMessage, syncStateAttachment.statusMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subnetId, endpointId, status, statusMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyncStateAttachment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SyncStateAttachment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SyncStateAttachment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncStateAttachment is not found in the empty JSON string", SyncStateAttachment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SyncStateAttachment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SyncStateAttachment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncStateAttachment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncStateAttachment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncStateAttachment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncStateAttachment.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncStateAttachment>() {
           @Override
           public void write(JsonWriter out, SyncStateAttachment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SyncStateAttachment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SyncStateAttachment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SyncStateAttachment
   * @throws IOException if the JSON string is invalid with respect to SyncStateAttachment
   */
  public static SyncStateAttachment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncStateAttachment.class);
  }

  /**
   * Convert an instance of SyncStateAttachment to an JSON string
   *
   * @return JSON string
   */
