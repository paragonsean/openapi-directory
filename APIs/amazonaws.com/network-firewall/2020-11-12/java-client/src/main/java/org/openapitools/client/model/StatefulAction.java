...
/**
 * Gets or Sets StatefulAction
 */
@JsonAdapter(StatefulAction.Adapter.class)
public enum StatefulAction {
  ...
  public static StatefulAction fromValue(String value) {
    for (StatefulAction b : StatefulAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatefulAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatefulAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatefulAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatefulAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatefulAction.fromValue(value);
  }
}
