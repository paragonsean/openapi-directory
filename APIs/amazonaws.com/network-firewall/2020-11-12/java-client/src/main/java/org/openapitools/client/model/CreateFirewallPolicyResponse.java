...
public class CreateFirewallPolicyResponse {
  ...
  public CreateFirewallPolicyResponse updateToken(String updateToken) {
  ...
  public CreateFirewallPolicyResponse firewallPolicyResponse(CreateFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallPolicyResponse createFirewallPolicyResponse = (CreateFirewallPolicyResponse) o;
    return Objects.equals(this.updateToken, createFirewallPolicyResponse.updateToken) &&
        Objects.equals(this.firewallPolicyResponse, createFirewallPolicyResponse.firewallPolicyResponse);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallPolicyResponse is not found in the empty JSON string", CreateFirewallPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateFirewallPolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallPolicyResponse>() {
           @Override
           public void write(JsonWriter out, CreateFirewallPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallPolicyResponse
   */
  public static CreateFirewallPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallPolicyResponse.class);
  }

  /**
   * Convert an instance of CreateFirewallPolicyResponse to an JSON string
   *
   * @return JSON string
   */
