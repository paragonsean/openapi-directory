...
public class UpdateFirewallEncryptionConfigurationResponse {
  ...
  public UpdateFirewallEncryptionConfigurationResponse firewallArn(String firewallArn) {
  ...
  public UpdateFirewallEncryptionConfigurationResponse firewallName(String firewallName) {
  ...
  public UpdateFirewallEncryptionConfigurationResponse updateToken(String updateToken) {
  ...
  public UpdateFirewallEncryptionConfigurationResponse encryptionConfiguration(EncryptionConfiguration encryptionConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallEncryptionConfigurationResponse updateFirewallEncryptionConfigurationResponse = (UpdateFirewallEncryptionConfigurationResponse) o;
    return Objects.equals(this.firewallArn, updateFirewallEncryptionConfigurationResponse.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallEncryptionConfigurationResponse.firewallName) &&
        Objects.equals(this.updateToken, updateFirewallEncryptionConfigurationResponse.updateToken) &&
        Objects.equals(this.encryptionConfiguration, updateFirewallEncryptionConfigurationResponse.encryptionConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName, updateToken, encryptionConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallEncryptionConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallEncryptionConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallEncryptionConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallEncryptionConfigurationResponse is not found in the empty JSON string", UpdateFirewallEncryptionConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallEncryptionConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallEncryptionConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallEncryptionConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallEncryptionConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallEncryptionConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallEncryptionConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallEncryptionConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallEncryptionConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallEncryptionConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallEncryptionConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallEncryptionConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallEncryptionConfigurationResponse
   */
  public static UpdateFirewallEncryptionConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallEncryptionConfigurationResponse.class);
  }

  /**
   * Convert an instance of UpdateFirewallEncryptionConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
