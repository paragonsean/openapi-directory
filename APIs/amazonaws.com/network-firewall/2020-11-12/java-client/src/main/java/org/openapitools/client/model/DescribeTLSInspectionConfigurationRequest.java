...
public class DescribeTLSInspectionConfigurationRequest {
  ...
  public DescribeTLSInspectionConfigurationRequest tlSInspectionConfigurationArn(String tlSInspectionConfigurationArn) {
  ...
  public DescribeTLSInspectionConfigurationRequest tlSInspectionConfigurationName(String tlSInspectionConfigurationName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTLSInspectionConfigurationRequest describeTLSInspectionConfigurationRequest = (DescribeTLSInspectionConfigurationRequest) o;
    return Objects.equals(this.tlSInspectionConfigurationArn, describeTLSInspectionConfigurationRequest.tlSInspectionConfigurationArn) &&
        Objects.equals(this.tlSInspectionConfigurationName, describeTLSInspectionConfigurationRequest.tlSInspectionConfigurationName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTLSInspectionConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTLSInspectionConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTLSInspectionConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTLSInspectionConfigurationRequest is not found in the empty JSON string", DescribeTLSInspectionConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTLSInspectionConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTLSInspectionConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTLSInspectionConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTLSInspectionConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTLSInspectionConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTLSInspectionConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTLSInspectionConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DescribeTLSInspectionConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTLSInspectionConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTLSInspectionConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTLSInspectionConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeTLSInspectionConfigurationRequest
   */
  public static DescribeTLSInspectionConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTLSInspectionConfigurationRequest.class);
  }

  /**
   * Convert an instance of DescribeTLSInspectionConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
