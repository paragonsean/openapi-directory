...
public class UpdateFirewallPolicyResponse {
  ...
  public UpdateFirewallPolicyResponse() {
  }

  public UpdateFirewallPolicyResponse updateToken(String updateToken) {
  ...
  public UpdateFirewallPolicyResponse firewallPolicyResponse(CreateFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallPolicyResponse updateFirewallPolicyResponse = (UpdateFirewallPolicyResponse) o;
    return Objects.equals(this.updateToken, updateFirewallPolicyResponse.updateToken) &&
        Objects.equals(this.firewallPolicyResponse, updateFirewallPolicyResponse.firewallPolicyResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallPolicyResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallPolicyResponse is not found in the empty JSON string", UpdateFirewallPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateFirewallPolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallPolicyResponse>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallPolicyResponse
   */
  public static UpdateFirewallPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallPolicyResponse.class);
  }

  /**
   * Convert an instance of UpdateFirewallPolicyResponse to an JSON string
   *
   * @return JSON string
   */
