...
public class DescribeRuleGroupMetadataRequest {
  ...
  public DescribeRuleGroupMetadataRequest() {
  }

  public DescribeRuleGroupMetadataRequest ruleGroupName(String ruleGroupName) {
  ...
  public DescribeRuleGroupMetadataRequest ruleGroupArn(String ruleGroupArn) {
  ...
  public DescribeRuleGroupMetadataRequest type(RuleGroupType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeRuleGroupMetadataRequest describeRuleGroupMetadataRequest = (DescribeRuleGroupMetadataRequest) o;
    return Objects.equals(this.ruleGroupName, describeRuleGroupMetadataRequest.ruleGroupName) &&
        Objects.equals(this.ruleGroupArn, describeRuleGroupMetadataRequest.ruleGroupArn) &&
        Objects.equals(this.type, describeRuleGroupMetadataRequest.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeRuleGroupMetadataRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRuleGroupMetadataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRuleGroupMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRuleGroupMetadataRequest is not found in the empty JSON string", DescribeRuleGroupMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRuleGroupMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRuleGroupMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRuleGroupMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRuleGroupMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRuleGroupMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRuleGroupMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRuleGroupMetadataRequest>() {
           @Override
           public void write(JsonWriter out, DescribeRuleGroupMetadataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRuleGroupMetadataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRuleGroupMetadataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRuleGroupMetadataRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeRuleGroupMetadataRequest
   */
  public static DescribeRuleGroupMetadataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRuleGroupMetadataRequest.class);
  }

  /**
   * Convert an instance of DescribeRuleGroupMetadataRequest to an JSON string
   *
   * @return JSON string
   */
