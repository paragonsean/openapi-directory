...
public class FirewallPolicyMetadata {
  ...
  public FirewallPolicyMetadata() {
  }

  public FirewallPolicyMetadata name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FirewallPolicyMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallPolicyMetadata firewallPolicyMetadata = (FirewallPolicyMetadata) o;
    return Objects.equals(this.name, firewallPolicyMetadata.name) &&
        Objects.equals(this.arn, firewallPolicyMetadata.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallPolicyMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallPolicyMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallPolicyMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPolicyMetadata is not found in the empty JSON string", FirewallPolicyMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallPolicyMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallPolicyMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPolicyMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPolicyMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPolicyMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPolicyMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPolicyMetadata>() {
           @Override
           public void write(JsonWriter out, FirewallPolicyMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallPolicyMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallPolicyMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallPolicyMetadata
   * @throws IOException if the JSON string is invalid with respect to FirewallPolicyMetadata
   */
  public static FirewallPolicyMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPolicyMetadata.class);
  }

  /**
   * Convert an instance of FirewallPolicyMetadata to an JSON string
   *
   * @return JSON string
   */
