...
public class DeleteFirewallPolicyResponse {
  ...
  private DeleteFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse;

  public DeleteFirewallPolicyResponse() {
  }

  public DeleteFirewallPolicyResponse firewallPolicyResponse(DeleteFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
  ...
  public DeleteFirewallPolicyResponseFirewallPolicyResponse getFirewallPolicyResponse() {
    return firewallPolicyResponse;
  }

  public void setFirewallPolicyResponse(DeleteFirewallPolicyResponseFirewallPolicyResponse firewallPolicyResponse) {
    this.firewallPolicyResponse = firewallPolicyResponse;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteFirewallPolicyResponse deleteFirewallPolicyResponse = (DeleteFirewallPolicyResponse) o;
    return Objects.equals(this.firewallPolicyResponse, deleteFirewallPolicyResponse.firewallPolicyResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallPolicyResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteFirewallPolicyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFirewallPolicyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFirewallPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFirewallPolicyResponse is not found in the empty JSON string", DeleteFirewallPolicyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFirewallPolicyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFirewallPolicyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFirewallPolicyResponse.openapiRequiredFields) {
      ...
      DeleteFirewallPolicyResponseFirewallPolicyResponse.validateJsonElement(jsonObj.get("FirewallPolicyResponse"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFirewallPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFirewallPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFirewallPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFirewallPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFirewallPolicyResponse>() {
           @Override
           public void write(JsonWriter out, DeleteFirewallPolicyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFirewallPolicyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFirewallPolicyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFirewallPolicyResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteFirewallPolicyResponse
   */
  public static DeleteFirewallPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFirewallPolicyResponse.class);
  }

  /**
   * Convert an instance of DeleteFirewallPolicyResponse to an JSON string
   *
   * @return JSON string
   */
