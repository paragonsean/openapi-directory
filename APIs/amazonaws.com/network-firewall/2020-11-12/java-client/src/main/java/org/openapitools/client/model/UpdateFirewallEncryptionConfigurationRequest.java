...
public class UpdateFirewallEncryptionConfigurationRequest {
  ...
  public UpdateFirewallEncryptionConfigurationRequest updateToken(String updateToken) {
  ...
  public UpdateFirewallEncryptionConfigurationRequest firewallArn(String firewallArn) {
  ...
  public UpdateFirewallEncryptionConfigurationRequest firewallName(String firewallName) {
  ...
  public UpdateFirewallEncryptionConfigurationRequest encryptionConfiguration(EncryptionConfiguration encryptionConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallEncryptionConfigurationRequest updateFirewallEncryptionConfigurationRequest = (UpdateFirewallEncryptionConfigurationRequest) o;
    return Objects.equals(this.updateToken, updateFirewallEncryptionConfigurationRequest.updateToken) &&
        Objects.equals(this.firewallArn, updateFirewallEncryptionConfigurationRequest.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallEncryptionConfigurationRequest.firewallName) &&
        Objects.equals(this.encryptionConfiguration, updateFirewallEncryptionConfigurationRequest.encryptionConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, encryptionConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallEncryptionConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallEncryptionConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallEncryptionConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallEncryptionConfigurationRequest is not found in the empty JSON string", UpdateFirewallEncryptionConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallEncryptionConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallEncryptionConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallEncryptionConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallEncryptionConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallEncryptionConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallEncryptionConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallEncryptionConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallEncryptionConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallEncryptionConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallEncryptionConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallEncryptionConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallEncryptionConfigurationRequest
   */
  public static UpdateFirewallEncryptionConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallEncryptionConfigurationRequest.class);
  }

  /**
   * Convert an instance of UpdateFirewallEncryptionConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
