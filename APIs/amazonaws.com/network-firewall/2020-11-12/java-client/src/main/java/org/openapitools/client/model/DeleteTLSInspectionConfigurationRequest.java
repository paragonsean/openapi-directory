...
public class DeleteTLSInspectionConfigurationRequest {
  ...
  public DeleteTLSInspectionConfigurationRequest tlSInspectionConfigurationArn(String tlSInspectionConfigurationArn) {
  ...
  public DeleteTLSInspectionConfigurationRequest tlSInspectionConfigurationName(String tlSInspectionConfigurationName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTLSInspectionConfigurationRequest deleteTLSInspectionConfigurationRequest = (DeleteTLSInspectionConfigurationRequest) o;
    return Objects.equals(this.tlSInspectionConfigurationArn, deleteTLSInspectionConfigurationRequest.tlSInspectionConfigurationArn) &&
        Objects.equals(this.tlSInspectionConfigurationName, deleteTLSInspectionConfigurationRequest.tlSInspectionConfigurationName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tlSInspectionConfigurationArn, tlSInspectionConfigurationName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteTLSInspectionConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTLSInspectionConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTLSInspectionConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTLSInspectionConfigurationRequest is not found in the empty JSON string", DeleteTLSInspectionConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTLSInspectionConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTLSInspectionConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTLSInspectionConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTLSInspectionConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTLSInspectionConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTLSInspectionConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTLSInspectionConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, DeleteTLSInspectionConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTLSInspectionConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTLSInspectionConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTLSInspectionConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteTLSInspectionConfigurationRequest
   */
  public static DeleteTLSInspectionConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTLSInspectionConfigurationRequest.class);
  }

  /**
   * Convert an instance of DeleteTLSInspectionConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
