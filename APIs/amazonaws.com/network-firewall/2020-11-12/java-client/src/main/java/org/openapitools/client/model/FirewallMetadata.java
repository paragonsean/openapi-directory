...
public class FirewallMetadata {
  ...
  public FirewallMetadata firewallName(String firewallName) {
  ...
  public FirewallMetadata firewallArn(String firewallArn) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallMetadata firewallMetadata = (FirewallMetadata) o;
    return Objects.equals(this.firewallName, firewallMetadata.firewallName) &&
        Objects.equals(this.firewallArn, firewallMetadata.firewallArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallName, firewallArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallMetadata is not found in the empty JSON string", FirewallMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallMetadata>() {
           @Override
           public void write(JsonWriter out, FirewallMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallMetadata
   * @throws IOException if the JSON string is invalid with respect to FirewallMetadata
   */
  public static FirewallMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallMetadata.class);
  }

  /**
   * Convert an instance of FirewallMetadata to an JSON string
   *
   * @return JSON string
   */
