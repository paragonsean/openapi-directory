...
import org.openapitools.client.model.RuleDefinitionMatchAttributes;
...
public class StatelessRuleRuleDefinition {
  public static final String SERIALIZED_NAME_MATCH_ATTRIBUTES = "MatchAttributes";
  @SerializedName(SERIALIZED_NAME_MATCH_ATTRIBUTES)
  private RuleDefinitionMatchAttributes matchAttributes;

  public static final String SERIALIZED_NAME_ACTIONS = "Actions";
  @SerializedName(SERIALIZED_NAME_ACTIONS)
  private List actions;

  public StatelessRuleRuleDefinition() {
  }

  public StatelessRuleRuleDefinition matchAttributes(RuleDefinitionMatchAttributes matchAttributes) {
  ...
  public RuleDefinitionMatchAttributes getMatchAttributes() {
    return matchAttributes;
  }

  public void setMatchAttributes(RuleDefinitionMatchAttributes matchAttributes) {
    this.matchAttributes = matchAttributes;
  }


  public StatelessRuleRuleDefinition actions(List actions) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessRuleRuleDefinition statelessRuleRuleDefinition = (StatelessRuleRuleDefinition) o;
    return Objects.equals(this.matchAttributes, statelessRuleRuleDefinition.matchAttributes) &&
        Objects.equals(this.actions, statelessRuleRuleDefinition.actions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(matchAttributes, actions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessRuleRuleDefinition {\n");
    sb.append("    matchAttributes: ").append(toIndentedString(matchAttributes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("MatchAttributes");
    openapiFields.add("Actions");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("MatchAttributes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessRuleRuleDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessRuleRuleDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessRuleRuleDefinition is not found in the empty JSON string", StatelessRuleRuleDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessRuleRuleDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessRuleRuleDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessRuleRuleDefinition.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `MatchAttributes`
      RuleDefinitionMatchAttributes.validateJsonElement(jsonObj.get("MatchAttributes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessRuleRuleDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessRuleRuleDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessRuleRuleDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessRuleRuleDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessRuleRuleDefinition>() {
           @Override
           public void write(JsonWriter out, StatelessRuleRuleDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessRuleRuleDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessRuleRuleDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessRuleRuleDefinition
   * @throws IOException if the JSON string is invalid with respect to StatelessRuleRuleDefinition
   */
  public static StatelessRuleRuleDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessRuleRuleDefinition.class);
  }

  /**
   * Convert an instance of StatelessRuleRuleDefinition to an JSON string
   *
   * @return JSON string
   */
