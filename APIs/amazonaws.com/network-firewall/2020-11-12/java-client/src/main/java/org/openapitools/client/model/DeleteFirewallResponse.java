...
public class DeleteFirewallResponse {
  ...
  public DeleteFirewallResponse firewall(Firewall firewall) {
  ...
  public DeleteFirewallResponse firewallStatus(FirewallStatus firewallStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFirewallResponse deleteFirewallResponse = (DeleteFirewallResponse) o;
    return Objects.equals(this.firewall, deleteFirewallResponse.firewall) &&
        Objects.equals(this.firewallStatus, deleteFirewallResponse.firewallStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFirewallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFirewallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteFirewallResponse is not found in the empty JSON string", DeleteFirewallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFirewallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFirewallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("FirewallStatus") != null && !jsonObj.get("FirewallStatus").isJsonNull()) {
        FirewallStatus.validateJsonElement(jsonObj.get("FirewallStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFirewallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFirewallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFirewallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFirewallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFirewallResponse>() {
           @Override
           public void write(JsonWriter out, DeleteFirewallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFirewallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFirewallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFirewallResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteFirewallResponse
   */
  public static DeleteFirewallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFirewallResponse.class);
  }

  /**
   * Convert an instance of DeleteFirewallResponse to an JSON string
   *
   * @return JSON string
   */
