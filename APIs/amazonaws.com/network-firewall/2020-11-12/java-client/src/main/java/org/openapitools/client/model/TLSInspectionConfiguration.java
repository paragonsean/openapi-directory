...
public class TLSInspectionConfiguration {
  ...
  public TLSInspectionConfiguration serverCertificateConfigurations(List serverCertificateConfigurations) {
  ...
  public boolean equals(Object o) {
    ...
    TLSInspectionConfiguration tlSInspectionConfiguration = (TLSInspectionConfiguration) o;
    return Objects.equals(this.serverCertificateConfigurations, tlSInspectionConfiguration.serverCertificateConfigurations);
  }
  ...
  public String toString() {
    ...
    sb.append("class TLSInspectionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TLSInspectionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TLSInspectionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TLSInspectionConfiguration is not found in the empty JSON string", TLSInspectionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TLSInspectionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TLSInspectionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TLSInspectionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TLSInspectionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TLSInspectionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TLSInspectionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<TLSInspectionConfiguration>() {
           @Override
           public void write(JsonWriter out, TLSInspectionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TLSInspectionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TLSInspectionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TLSInspectionConfiguration
   * @throws IOException if the JSON string is invalid with respect to TLSInspectionConfiguration
   */
  public static TLSInspectionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TLSInspectionConfiguration.class);
  }

  /**
   * Convert an instance of TLSInspectionConfiguration to an JSON string
   *
   * @return JSON string
   */
