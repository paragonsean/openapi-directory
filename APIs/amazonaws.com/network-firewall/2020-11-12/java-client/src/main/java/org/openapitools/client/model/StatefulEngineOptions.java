...
public class StatefulEngineOptions {
  ...
  public StatefulEngineOptions ruleOrder(RuleOrder ruleOrder) {
  ...
  public StatefulEngineOptions streamExceptionPolicy(StreamExceptionPolicy streamExceptionPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    StatefulEngineOptions statefulEngineOptions = (StatefulEngineOptions) o;
    return Objects.equals(this.ruleOrder, statefulEngineOptions.ruleOrder) &&
        Objects.equals(this.streamExceptionPolicy, statefulEngineOptions.streamExceptionPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatefulEngineOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulEngineOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulEngineOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulEngineOptions is not found in the empty JSON string", StatefulEngineOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulEngineOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulEngineOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulEngineOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulEngineOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulEngineOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulEngineOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulEngineOptions>() {
           @Override
           public void write(JsonWriter out, StatefulEngineOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulEngineOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulEngineOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulEngineOptions
   * @throws IOException if the JSON string is invalid with respect to StatefulEngineOptions
   */
  public static StatefulEngineOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulEngineOptions.class);
  }

  /**
   * Convert an instance of StatefulEngineOptions to an JSON string
   *
   * @return JSON string
   */
