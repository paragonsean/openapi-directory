...
public class UpdateFirewallDescriptionRequest {
  ...
  public UpdateFirewallDescriptionRequest updateToken(String updateToken) {
  ...
  public UpdateFirewallDescriptionRequest firewallArn(String firewallArn) {
  ...
  public UpdateFirewallDescriptionRequest firewallName(String firewallName) {
  ...
  public UpdateFirewallDescriptionRequest description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallDescriptionRequest updateFirewallDescriptionRequest = (UpdateFirewallDescriptionRequest) o;
    return Objects.equals(this.updateToken, updateFirewallDescriptionRequest.updateToken) &&
        Objects.equals(this.firewallArn, updateFirewallDescriptionRequest.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallDescriptionRequest.firewallName) &&
        Objects.equals(this.description, updateFirewallDescriptionRequest.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallDescriptionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallDescriptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallDescriptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallDescriptionRequest is not found in the empty JSON string", UpdateFirewallDescriptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallDescriptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallDescriptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallDescriptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallDescriptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallDescriptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallDescriptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallDescriptionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallDescriptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallDescriptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallDescriptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallDescriptionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallDescriptionRequest
   */
  public static UpdateFirewallDescriptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallDescriptionRequest.class);
  }

  /**
   * Convert an instance of UpdateFirewallDescriptionRequest to an JSON string
   *
   * @return JSON string
   */
