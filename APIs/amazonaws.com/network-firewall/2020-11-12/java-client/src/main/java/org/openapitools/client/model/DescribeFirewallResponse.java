...
public class DescribeFirewallResponse {
  ...
  private CreateFirewallResponseFirewall firewall;

  public static final String SERIALIZED_NAME_FIREWALL_STATUS = "FirewallStatus";
  @SerializedName(SERIALIZED_NAME_FIREWALL_STATUS)
  private CreateFirewallResponseFirewallStatus firewallStatus;

  public DescribeFirewallResponse() {
  }

  public DescribeFirewallResponse updateToken(String updateToken) {
  ...
  public DescribeFirewallResponse firewall(CreateFirewallResponseFirewall firewall) {
   ...
   */
  @javax.annotation.Nullable
  public CreateFirewallResponseFirewall getFirewall() {
    return firewall;
  }

  public void setFirewall(CreateFirewallResponseFirewall firewall) {
    this.firewall = firewall;
  }


  public DescribeFirewallResponse firewallStatus(CreateFirewallResponseFirewallStatus firewallStatus) {
   ...
   */
  @javax.annotation.Nullable
  public CreateFirewallResponseFirewallStatus getFirewallStatus() {
    return firewallStatus;
  }

  public void setFirewallStatus(CreateFirewallResponseFirewallStatus firewallStatus) {
    this.firewallStatus = firewallStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeFirewallResponse describeFirewallResponse = (DescribeFirewallResponse) o;
    return Objects.equals(this.updateToken, describeFirewallResponse.updateToken) &&
        Objects.equals(this.firewall, describeFirewallResponse.firewall) &&
        Objects.equals(this.firewallStatus, describeFirewallResponse.firewallStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewall, firewallStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeFirewallResponse {\n");
  ...
  static {
    ...
    openapiFields.add("FirewallStatus");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeFirewallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeFirewallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeFirewallResponse is not found in the empty JSON string", DescribeFirewallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeFirewallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeFirewallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Firewall") != null && !jsonObj.get("Firewall").isJsonNull()) {
        CreateFirewallResponseFirewall.validateJsonElement(jsonObj.get("Firewall"));
      }
      // validate the optional field `FirewallStatus`
      if (jsonObj.get("FirewallStatus") != null && !jsonObj.get("FirewallStatus").isJsonNull()) {
        CreateFirewallResponseFirewallStatus.validateJsonElement(jsonObj.get("FirewallStatus"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeFirewallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeFirewallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeFirewallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeFirewallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeFirewallResponse>() {
           @Override
           public void write(JsonWriter out, DescribeFirewallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeFirewallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeFirewallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeFirewallResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeFirewallResponse
   */
  public static DescribeFirewallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeFirewallResponse.class);
  }

  /**
   * Convert an instance of DescribeFirewallResponse to an JSON string
   *
   * @return JSON string
   */
