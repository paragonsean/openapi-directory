...
public class StatefulRuleGroupReference {
  ...
  private StatefulRuleGroupReferenceOverride override;

  public StatefulRuleGroupReference() {
  }

  public StatefulRuleGroupReference resourceArn(String resourceArn) {
  ...
  public StatefulRuleGroupReference priority(Integer priority) {
  ...
  public StatefulRuleGroupReference override(StatefulRuleGroupReferenceOverride override) {
   ...
   */
  @javax.annotation.Nullable
  public StatefulRuleGroupReferenceOverride getOverride() {
    return override;
  }

  public void setOverride(StatefulRuleGroupReferenceOverride override) {
    this.override = override;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatefulRuleGroupReference statefulRuleGroupReference = (StatefulRuleGroupReference) o;
    return Objects.equals(this.resourceArn, statefulRuleGroupReference.resourceArn) &&
        Objects.equals(this.priority, statefulRuleGroupReference.priority) &&
        Objects.equals(this.override, statefulRuleGroupReference.override);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceArn, priority, override);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatefulRuleGroupReference {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRuleGroupReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRuleGroupReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRuleGroupReference is not found in the empty JSON string", StatefulRuleGroupReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRuleGroupReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRuleGroupReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatefulRuleGroupReference.openapiRequiredFields) {
      ...
      if (jsonObj.get("Override") != null && !jsonObj.get("Override").isJsonNull()) {
        StatefulRuleGroupReferenceOverride.validateJsonElement(jsonObj.get("Override"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRuleGroupReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRuleGroupReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRuleGroupReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRuleGroupReference.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRuleGroupReference>() {
           @Override
           public void write(JsonWriter out, StatefulRuleGroupReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRuleGroupReference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRuleGroupReference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRuleGroupReference
   * @throws IOException if the JSON string is invalid with respect to StatefulRuleGroupReference
   */
  public static StatefulRuleGroupReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRuleGroupReference.class);
  }

  /**
   * Convert an instance of StatefulRuleGroupReference to an JSON string
   *
   * @return JSON string
   */
