...
import org.openapitools.client.model.StatelessRuleRuleDefinition;
...
public class StatelessRule {
  ...
  private StatelessRuleRuleDefinition ruleDefinition;
  ...
  public StatelessRule ruleDefinition(StatelessRuleRuleDefinition ruleDefinition) {
  ...
  public StatelessRuleRuleDefinition getRuleDefinition() {
    return ruleDefinition;
  }

  public void setRuleDefinition(StatelessRuleRuleDefinition ruleDefinition) {
    this.ruleDefinition = ruleDefinition;
  }


  public StatelessRule priority(Integer priority) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessRule statelessRule = (StatelessRule) o;
    return Objects.equals(this.ruleDefinition, statelessRule.ruleDefinition) &&
        Objects.equals(this.priority, statelessRule.priority);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleDefinition, priority);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessRule is not found in the empty JSON string", StatelessRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessRule.openapiRequiredFields) {
      ...
      StatelessRuleRuleDefinition.validateJsonElement(jsonObj.get("RuleDefinition"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessRule.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessRule>() {
           @Override
           public void write(JsonWriter out, StatelessRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessRule
   * @throws IOException if the JSON string is invalid with respect to StatelessRule
   */
  public static StatelessRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessRule.class);
  }

  /**
   * Convert an instance of StatelessRule to an JSON string
   *
   * @return JSON string
   */
