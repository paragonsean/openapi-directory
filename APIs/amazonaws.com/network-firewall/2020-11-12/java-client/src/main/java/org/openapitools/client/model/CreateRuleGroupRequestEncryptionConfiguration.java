...
public class CreateRuleGroupRequestEncryptionConfiguration {
  ...
  public CreateRuleGroupRequestEncryptionConfiguration() {
  }

  public CreateRuleGroupRequestEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public CreateRuleGroupRequestEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRuleGroupRequestEncryptionConfiguration createRuleGroupRequestEncryptionConfiguration = (CreateRuleGroupRequestEncryptionConfiguration) o;
    return Objects.equals(this.keyId, createRuleGroupRequestEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, createRuleGroupRequestEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRuleGroupRequestEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRuleGroupRequestEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRuleGroupRequestEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRuleGroupRequestEncryptionConfiguration is not found in the empty JSON string", CreateRuleGroupRequestEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRuleGroupRequestEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRuleGroupRequestEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRuleGroupRequestEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRuleGroupRequestEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRuleGroupRequestEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRuleGroupRequestEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRuleGroupRequestEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRuleGroupRequestEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateRuleGroupRequestEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRuleGroupRequestEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRuleGroupRequestEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRuleGroupRequestEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateRuleGroupRequestEncryptionConfiguration
   */
  public static CreateRuleGroupRequestEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRuleGroupRequestEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of CreateRuleGroupRequestEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
