...
public class TlsCertificateData {
  ...
  public TlsCertificateData certificateArn(String certificateArn) {
  ...
  public TlsCertificateData certificateSerial(String certificateSerial) {
  ...
  public TlsCertificateData status(String status) {
    this.status = status;
    return this;
  }
  ...
  public TlsCertificateData statusMessage(String statusMessage) {
  ...
  public boolean equals(Object o) {
    ...
    TlsCertificateData tlsCertificateData = (TlsCertificateData) o;
    return Objects.equals(this.certificateArn, tlsCertificateData.certificateArn) &&
        Objects.equals(this.certificateSerial, tlsCertificateData.certificateSerial) &&
        Objects.equals(this.status, tlsCertificateData.status) &&
        Objects.equals(this.statusMessage, tlsCertificateData.statusMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificateArn, certificateSerial, status, statusMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TlsCertificateData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TlsCertificateData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TlsCertificateData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TlsCertificateData is not found in the empty JSON string", TlsCertificateData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TlsCertificateData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TlsCertificateData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `CertificateSerial`
      if (jsonObj.get("CertificateSerial") != null && !jsonObj.get("CertificateSerial").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TlsCertificateData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TlsCertificateData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TlsCertificateData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TlsCertificateData.class));

       return (TypeAdapter<T>) new TypeAdapter<TlsCertificateData>() {
           @Override
           public void write(JsonWriter out, TlsCertificateData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TlsCertificateData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TlsCertificateData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TlsCertificateData
   * @throws IOException if the JSON string is invalid with respect to TlsCertificateData
   */
  public static TlsCertificateData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TlsCertificateData.class);
  }

  /**
   * Convert an instance of TlsCertificateData to an JSON string
   *
   * @return JSON string
   */
