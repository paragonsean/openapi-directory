...
public class StatefulRuleHeader {
  ...
  public StatefulRuleHeader() {
  }

  public StatefulRuleHeader protocol(StatefulRuleProtocol protocol) {
  ...
  public StatefulRuleHeader source(String source) {
    this.source = source;
    return this;
  }
  ...
  public StatefulRuleHeader sourcePort(String sourcePort) {
  ...
  public StatefulRuleHeader direction(StatefulRuleDirection direction) {
  ...
  public StatefulRuleHeader destination(String destination) {
  ...
  public StatefulRuleHeader destinationPort(String destinationPort) {
  ...
  public boolean equals(Object o) {
    ...
    StatefulRuleHeader statefulRuleHeader = (StatefulRuleHeader) o;
    return Objects.equals(this.protocol, statefulRuleHeader.protocol) &&
        Objects.equals(this.source, statefulRuleHeader.source) &&
        Objects.equals(this.sourcePort, statefulRuleHeader.sourcePort) &&
        Objects.equals(this.direction, statefulRuleHeader.direction) &&
        Objects.equals(this.destination, statefulRuleHeader.destination) &&
        Objects.equals(this.destinationPort, statefulRuleHeader.destinationPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatefulRuleHeader {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRuleHeader
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRuleHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRuleHeader is not found in the empty JSON string", StatefulRuleHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRuleHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRuleHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatefulRuleHeader.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRuleHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRuleHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRuleHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRuleHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRuleHeader>() {
           @Override
           public void write(JsonWriter out, StatefulRuleHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRuleHeader read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRuleHeader given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRuleHeader
   * @throws IOException if the JSON string is invalid with respect to StatefulRuleHeader
   */
  public static StatefulRuleHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRuleHeader.class);
  }

  /**
   * Convert an instance of StatefulRuleHeader to an JSON string
   *
   * @return JSON string
   */
