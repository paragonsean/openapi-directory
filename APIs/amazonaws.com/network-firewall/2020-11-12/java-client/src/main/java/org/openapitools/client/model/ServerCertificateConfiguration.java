...
public class ServerCertificateConfiguration {
  ...
  public ServerCertificateConfiguration serverCertificates(List serverCertificates) {
  ...
  public ServerCertificateConfiguration scopes(List scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServerCertificateConfiguration serverCertificateConfiguration = (ServerCertificateConfiguration) o;
    return Objects.equals(this.serverCertificates, serverCertificateConfiguration.serverCertificates) &&
        Objects.equals(this.scopes, serverCertificateConfiguration.scopes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverCertificates, scopes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerCertificateConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerCertificateConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerCertificateConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerCertificateConfiguration is not found in the empty JSON string", ServerCertificateConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerCertificateConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerCertificateConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ServerCertificates") != null && !jsonObj.get("ServerCertificates").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ServerCertificates"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerCertificateConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerCertificateConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerCertificateConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerCertificateConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerCertificateConfiguration>() {
           @Override
           public void write(JsonWriter out, ServerCertificateConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerCertificateConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerCertificateConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerCertificateConfiguration
   * @throws IOException if the JSON string is invalid with respect to ServerCertificateConfiguration
   */
  public static ServerCertificateConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerCertificateConfiguration.class);
  }

  /**
   * Convert an instance of ServerCertificateConfiguration to an JSON string
   *
   * @return JSON string
   */
