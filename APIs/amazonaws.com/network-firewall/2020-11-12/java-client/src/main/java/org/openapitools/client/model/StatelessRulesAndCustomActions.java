...
public class StatelessRulesAndCustomActions {
  ...
  public StatelessRulesAndCustomActions statelessRules(List statelessRules) {
  ...
  public StatelessRulesAndCustomActions customActions(List customActions) {
  ...
  public boolean equals(Object o) {
    ...
    StatelessRulesAndCustomActions statelessRulesAndCustomActions = (StatelessRulesAndCustomActions) o;
    return Objects.equals(this.statelessRules, statelessRulesAndCustomActions.statelessRules) &&
        Objects.equals(this.customActions, statelessRulesAndCustomActions.customActions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statelessRules, customActions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatelessRulesAndCustomActions {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("StatelessRules");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatelessRulesAndCustomActions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatelessRulesAndCustomActions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatelessRulesAndCustomActions is not found in the empty JSON string", StatelessRulesAndCustomActions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatelessRulesAndCustomActions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatelessRulesAndCustomActions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatelessRulesAndCustomActions.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `StatelessRules`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatelessRulesAndCustomActions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatelessRulesAndCustomActions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatelessRulesAndCustomActions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatelessRulesAndCustomActions.class));

       return (TypeAdapter<T>) new TypeAdapter<StatelessRulesAndCustomActions>() {
           @Override
           public void write(JsonWriter out, StatelessRulesAndCustomActions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatelessRulesAndCustomActions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatelessRulesAndCustomActions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatelessRulesAndCustomActions
   * @throws IOException if the JSON string is invalid with respect to StatelessRulesAndCustomActions
   */
  public static StatelessRulesAndCustomActions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatelessRulesAndCustomActions.class);
  }

  /**
   * Convert an instance of StatelessRulesAndCustomActions to an JSON string
   *
   * @return JSON string
   */
