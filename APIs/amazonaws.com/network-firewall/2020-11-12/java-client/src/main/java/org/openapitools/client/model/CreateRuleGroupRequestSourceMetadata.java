...
public class CreateRuleGroupRequestSourceMetadata {
  ...
  public CreateRuleGroupRequestSourceMetadata() {
  }

  public CreateRuleGroupRequestSourceMetadata sourceArn(String sourceArn) {
  ...
  public CreateRuleGroupRequestSourceMetadata sourceUpdateToken(String sourceUpdateToken) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRuleGroupRequestSourceMetadata createRuleGroupRequestSourceMetadata = (CreateRuleGroupRequestSourceMetadata) o;
    return Objects.equals(this.sourceArn, createRuleGroupRequestSourceMetadata.sourceArn) &&
        Objects.equals(this.sourceUpdateToken, createRuleGroupRequestSourceMetadata.sourceUpdateToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRuleGroupRequestSourceMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRuleGroupRequestSourceMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRuleGroupRequestSourceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRuleGroupRequestSourceMetadata is not found in the empty JSON string", CreateRuleGroupRequestSourceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRuleGroupRequestSourceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRuleGroupRequestSourceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRuleGroupRequestSourceMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRuleGroupRequestSourceMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRuleGroupRequestSourceMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRuleGroupRequestSourceMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRuleGroupRequestSourceMetadata>() {
           @Override
           public void write(JsonWriter out, CreateRuleGroupRequestSourceMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRuleGroupRequestSourceMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRuleGroupRequestSourceMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRuleGroupRequestSourceMetadata
   * @throws IOException if the JSON string is invalid with respect to CreateRuleGroupRequestSourceMetadata
   */
  public static CreateRuleGroupRequestSourceMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRuleGroupRequestSourceMetadata.class);
  }

  /**
   * Convert an instance of CreateRuleGroupRequestSourceMetadata to an JSON string
   *
   * @return JSON string
   */
