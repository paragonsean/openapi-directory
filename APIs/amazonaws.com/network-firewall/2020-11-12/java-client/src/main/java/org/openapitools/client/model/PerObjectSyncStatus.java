...
/**
 * Gets or Sets PerObjectSyncStatus
 */
@JsonAdapter(PerObjectSyncStatus.Adapter.class)
public enum PerObjectSyncStatus {
  ...
  PerObjectSyncStatus(String value) {
    this.value = value;
  }
  ...
  public static PerObjectSyncStatus fromValue(String value) {
    for (PerObjectSyncStatus b : PerObjectSyncStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PerObjectSyncStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PerObjectSyncStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PerObjectSyncStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PerObjectSyncStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PerObjectSyncStatus.fromValue(value);
  }
}
