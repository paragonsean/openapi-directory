...
public class RuleGroupResponseSourceMetadata {
  public static final String SERIALIZED_NAME_SOURCE_ARN = "SourceArn";
  @SerializedName(SERIALIZED_NAME_SOURCE_ARN)
  private String sourceArn;

  public static final String SERIALIZED_NAME_SOURCE_UPDATE_TOKEN = "SourceUpdateToken";
  @SerializedName(SERIALIZED_NAME_SOURCE_UPDATE_TOKEN)
  private String sourceUpdateToken;

  public RuleGroupResponseSourceMetadata() {
  }

  public RuleGroupResponseSourceMetadata sourceArn(String sourceArn) {
  ...
  public RuleGroupResponseSourceMetadata sourceUpdateToken(String sourceUpdateToken) {
    this.sourceUpdateToken = sourceUpdateToken;
    return this;
  }

  /**
   * Get sourceUpdateToken
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupResponseSourceMetadata ruleGroupResponseSourceMetadata = (RuleGroupResponseSourceMetadata) o;
    return Objects.equals(this.sourceArn, ruleGroupResponseSourceMetadata.sourceArn) &&
        Objects.equals(this.sourceUpdateToken, ruleGroupResponseSourceMetadata.sourceUpdateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceArn, sourceUpdateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RuleGroupResponseSourceMetadata {\n");
    sb.append("    sourceArn: ").append(toIndentedString(sourceArn)).append("\n");
    sb.append("    sourceUpdateToken: ").append(toIndentedString(sourceUpdateToken)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("SourceUpdateToken");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupResponseSourceMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupResponseSourceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupResponseSourceMetadata is not found in the empty JSON string", RuleGroupResponseSourceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupResponseSourceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupResponseSourceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `SourceUpdateToken`
      if (jsonObj.get("SourceUpdateToken") != null && !jsonObj.get("SourceUpdateToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("SourceUpdateToken"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupResponseSourceMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupResponseSourceMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupResponseSourceMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupResponseSourceMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupResponseSourceMetadata>() {
           @Override
           public void write(JsonWriter out, RuleGroupResponseSourceMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupResponseSourceMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupResponseSourceMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupResponseSourceMetadata
   * @throws IOException if the JSON string is invalid with respect to RuleGroupResponseSourceMetadata
   */
  public static RuleGroupResponseSourceMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupResponseSourceMetadata.class);
  }

  /**
   * Convert an instance of RuleGroupResponseSourceMetadata to an JSON string
   *
   * @return JSON string
   */
