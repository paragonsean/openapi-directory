...
public class RuleVariables {
  ...
  private Map portSets;

  public RuleVariables() {
  }

  public RuleVariables ipSets(Map ipSets) {
    this.ipSets = ipSets;
    return this;
  }
  ...
  public Map getIpSets() {
    return ipSets;
  }

  public void setIpSets(Map ipSets) {
    this.ipSets = ipSets;
  }


  public RuleVariables portSets(Map portSets) {
   ...
   */
  @javax.annotation.Nullable
  public Map getPortSets() {
    return portSets;
  }

  public void setPortSets(Map portSets) {
    this.portSets = portSets;
  }
  ...
  public boolean equals(Object o) {
    ...
    RuleVariables ruleVariables = (RuleVariables) o;
    return Objects.equals(this.ipSets, ruleVariables.ipSets) &&
        Objects.equals(this.portSets, ruleVariables.portSets);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleVariables
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleVariables.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleVariables is not found in the empty JSON string", RuleVariables.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleVariables.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleVariables` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `IPSets`
      if (jsonObj.get("IPSets") != null && !jsonObj.get("IPSets").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("IPSets"));
      }
      // validate the optional field `PortSets`
      if (jsonObj.get("PortSets") != null && !jsonObj.get("PortSets").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("PortSets"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleVariables.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleVariables' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleVariables> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleVariables.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleVariables>() {
           @Override
           public void write(JsonWriter out, RuleVariables value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleVariables read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleVariables given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleVariables
   * @throws IOException if the JSON string is invalid with respect to RuleVariables
   */
  public static RuleVariables fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleVariables.class);
  }

  /**
   * Convert an instance of RuleVariables to an JSON string
   *
   * @return JSON string
   */
