...
public class MatchAttributes {
  ...
  public MatchAttributes sources(List sources) {
  ...
  public MatchAttributes destinations(List destinations) {
  ...
  public MatchAttributes sourcePorts(List sourcePorts) {
  ...
  public MatchAttributes destinationPorts(List destinationPorts) {
  ...
  public MatchAttributes protocols(List protocols) {
  ...
  public MatchAttributes tcPFlags(List tcPFlags) {
  ...
  public boolean equals(Object o) {
    ...
    MatchAttributes matchAttributes = (MatchAttributes) o;
    return Objects.equals(this.sources, matchAttributes.sources) &&
        Objects.equals(this.destinations, matchAttributes.destinations) &&
        Objects.equals(this.sourcePorts, matchAttributes.sourcePorts) &&
        Objects.equals(this.destinationPorts, matchAttributes.destinationPorts) &&
        Objects.equals(this.protocols, matchAttributes.protocols) &&
        Objects.equals(this.tcPFlags, matchAttributes.tcPFlags);
  }
  ...
  public String toString() {
    ...
    sb.append("class MatchAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MatchAttributes is not found in the empty JSON string", MatchAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MatchAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MatchAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MatchAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MatchAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<MatchAttributes>() {
           @Override
           public void write(JsonWriter out, MatchAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MatchAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MatchAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MatchAttributes
   * @throws IOException if the JSON string is invalid with respect to MatchAttributes
   */
  public static MatchAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MatchAttributes.class);
  }

  /**
   * Convert an instance of MatchAttributes to an JSON string
   *
   * @return JSON string
   */
