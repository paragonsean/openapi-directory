...
public class ListFirewallsRequest {
  ...
  public ListFirewallsRequest nextToken(String nextToken) {
  ...
  public ListFirewallsRequest vpcIds(List vpcIds) {
    this.vpcIds = vpcIds;
    return this;
  }
  ...
  public ListFirewallsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listFirewallsRequest.nextToken) &&
        Objects.equals(this.vpcIds, listFirewallsRequest.vpcIds) &&
        Objects.equals(this.maxResults, listFirewallsRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, vpcIds, maxResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFirewallsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFirewallsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFirewallsRequest is not found in the empty JSON string", ListFirewallsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFirewallsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFirewallsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFirewallsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFirewallsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFirewallsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFirewallsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFirewallsRequest>() {
           @Override
           public void write(JsonWriter out, ListFirewallsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFirewallsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFirewallsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFirewallsRequest
   * @throws IOException if the JSON string is invalid with respect to ListFirewallsRequest
   */
  public static ListFirewallsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFirewallsRequest.class);
  }

  /**
   * Convert an instance of ListFirewallsRequest to an JSON string
   *
   * @return JSON string
   */
