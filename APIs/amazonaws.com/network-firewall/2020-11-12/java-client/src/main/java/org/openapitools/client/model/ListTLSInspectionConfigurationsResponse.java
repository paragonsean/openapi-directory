...
public class ListTLSInspectionConfigurationsResponse {
  ...
  public static final String SERIALIZED_NAME_TL_S_INSPECTION_CONFIGURATIONS = "TLSInspectionConfigurations";
  @SerializedName(SERIALIZED_NAME_TL_S_INSPECTION_CONFIGURATIONS)
  private List tlSInspectionConfigurations;

  public ListTLSInspectionConfigurationsResponse() {
  }

  public ListTLSInspectionConfigurationsResponse nextToken(String nextToken) {
  ...
  public ListTLSInspectionConfigurationsResponse tlSInspectionConfigurations(List tlSInspectionConfigurations) {
    this.tlSInspectionConfigurations = tlSInspectionConfigurations;
    return this;
  }

  /**
   * Get tlSInspectionConfigurations
   * @return tlSInspectionConfigurations
   */
  @javax.annotation.Nullable
  public List getTlSInspectionConfigurations() {
    return tlSInspectionConfigurations;
  }

  public void setTlSInspectionConfigurations(List tlSInspectionConfigurations) {
    this.tlSInspectionConfigurations = tlSInspectionConfigurations;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListTLSInspectionConfigurationsResponse listTLSInspectionConfigurationsResponse = (ListTLSInspectionConfigurationsResponse) o;
    return Objects.equals(this.nextToken, listTLSInspectionConfigurationsResponse.nextToken) &&
        Objects.equals(this.tlSInspectionConfigurations, listTLSInspectionConfigurationsResponse.tlSInspectionConfigurations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, tlSInspectionConfigurations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListTLSInspectionConfigurationsResponse {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    tlSInspectionConfigurations: ").append(toIndentedString(tlSInspectionConfigurations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("TLSInspectionConfigurations");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTLSInspectionConfigurationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTLSInspectionConfigurationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTLSInspectionConfigurationsResponse is not found in the empty JSON string", ListTLSInspectionConfigurationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTLSInspectionConfigurationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTLSInspectionConfigurationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `TLSInspectionConfigurations`
      if (jsonObj.get("TLSInspectionConfigurations") != null && !jsonObj.get("TLSInspectionConfigurations").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("TLSInspectionConfigurations"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTLSInspectionConfigurationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTLSInspectionConfigurationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTLSInspectionConfigurationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTLSInspectionConfigurationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTLSInspectionConfigurationsResponse>() {
           @Override
           public void write(JsonWriter out, ListTLSInspectionConfigurationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTLSInspectionConfigurationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTLSInspectionConfigurationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTLSInspectionConfigurationsResponse
   * @throws IOException if the JSON string is invalid with respect to ListTLSInspectionConfigurationsResponse
   */
  public static ListTLSInspectionConfigurationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTLSInspectionConfigurationsResponse.class);
  }

  /**
   * Convert an instance of ListTLSInspectionConfigurationsResponse to an JSON string
   *
   * @return JSON string
   */
