...
public class ActionDefinitionPublishMetricAction {
  public static final String SERIALIZED_NAME_DIMENSIONS = "Dimensions";
  @SerializedName(SERIALIZED_NAME_DIMENSIONS)
  private List dimensions;

  public ActionDefinitionPublishMetricAction() {
  }

  public ActionDefinitionPublishMetricAction dimensions(List dimensions) {
  ...
  public boolean equals(Object o) {
    ...
    ActionDefinitionPublishMetricAction actionDefinitionPublishMetricAction = (ActionDefinitionPublishMetricAction) o;
    return Objects.equals(this.dimensions, actionDefinitionPublishMetricAction.dimensions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionDefinitionPublishMetricAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionDefinitionPublishMetricAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionDefinitionPublishMetricAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionDefinitionPublishMetricAction is not found in the empty JSON string", ActionDefinitionPublishMetricAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionDefinitionPublishMetricAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionDefinitionPublishMetricAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionDefinitionPublishMetricAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionDefinitionPublishMetricAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionDefinitionPublishMetricAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionDefinitionPublishMetricAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionDefinitionPublishMetricAction.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionDefinitionPublishMetricAction>() {
           @Override
           public void write(JsonWriter out, ActionDefinitionPublishMetricAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionDefinitionPublishMetricAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionDefinitionPublishMetricAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionDefinitionPublishMetricAction
   * @throws IOException if the JSON string is invalid with respect to ActionDefinitionPublishMetricAction
   */
  public static ActionDefinitionPublishMetricAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionDefinitionPublishMetricAction.class);
  }

  /**
   * Convert an instance of ActionDefinitionPublishMetricAction to an JSON string
   *
   * @return JSON string
   */
