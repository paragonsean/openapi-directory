...
public class UpdateFirewallPolicyChangeProtectionResponse {
  ...
  public UpdateFirewallPolicyChangeProtectionResponse updateToken(String updateToken) {
  ...
  public UpdateFirewallPolicyChangeProtectionResponse firewallArn(String firewallArn) {
  ...
  public UpdateFirewallPolicyChangeProtectionResponse firewallName(String firewallName) {
  ...
  public UpdateFirewallPolicyChangeProtectionResponse firewallPolicyChangeProtection(Boolean firewallPolicyChangeProtection) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallPolicyChangeProtectionResponse updateFirewallPolicyChangeProtectionResponse = (UpdateFirewallPolicyChangeProtectionResponse) o;
    return Objects.equals(this.updateToken, updateFirewallPolicyChangeProtectionResponse.updateToken) &&
        Objects.equals(this.firewallArn, updateFirewallPolicyChangeProtectionResponse.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallPolicyChangeProtectionResponse.firewallName) &&
        Objects.equals(this.firewallPolicyChangeProtection, updateFirewallPolicyChangeProtectionResponse.firewallPolicyChangeProtection);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateFirewallPolicyChangeProtectionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallPolicyChangeProtectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallPolicyChangeProtectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallPolicyChangeProtectionResponse is not found in the empty JSON string", UpdateFirewallPolicyChangeProtectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallPolicyChangeProtectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallPolicyChangeProtectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallPolicyChangeProtectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallPolicyChangeProtectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallPolicyChangeProtectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallPolicyChangeProtectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallPolicyChangeProtectionResponse>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallPolicyChangeProtectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallPolicyChangeProtectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallPolicyChangeProtectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallPolicyChangeProtectionResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallPolicyChangeProtectionResponse
   */
  public static UpdateFirewallPolicyChangeProtectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallPolicyChangeProtectionResponse.class);
  }

  /**
   * Convert an instance of UpdateFirewallPolicyChangeProtectionResponse to an JSON string
   *
   * @return JSON string
   */
