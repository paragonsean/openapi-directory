...
public class ListFirewallsResponse {
  ...
  public ListFirewallsResponse nextToken(String nextToken) {
  ...
  public ListFirewallsResponse firewalls(List firewalls) {
   ...
   */
  @javax.annotation.Nullable
  public List getFirewalls() {
    return firewalls;
  }

  public void setFirewalls(List firewalls) {
    this.firewalls = firewalls;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, listFirewallsResponse.nextToken) &&
        Objects.equals(this.firewalls, listFirewallsResponse.firewalls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, firewalls);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFirewallsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFirewallsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFirewallsResponse is not found in the empty JSON string", ListFirewallsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFirewallsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFirewallsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `Firewalls`
      if (jsonObj.get("Firewalls") != null && !jsonObj.get("Firewalls").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Firewalls"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFirewallsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFirewallsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFirewallsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFirewallsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFirewallsResponse>() {
           @Override
           public void write(JsonWriter out, ListFirewallsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFirewallsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFirewallsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFirewallsResponse
   * @throws IOException if the JSON string is invalid with respect to ListFirewallsResponse
   */
  public static ListFirewallsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFirewallsResponse.class);
  }

  /**
   * Convert an instance of ListFirewallsResponse to an JSON string
   *
   * @return JSON string
   */
