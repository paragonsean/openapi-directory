...
public class FirewallPolicyPolicyVariables {
  public static final String SERIALIZED_NAME_RULE_VARIABLES = "RuleVariables";
  @SerializedName(SERIALIZED_NAME_RULE_VARIABLES)
  private Map ruleVariables;

  public FirewallPolicyPolicyVariables() {
  }

  public FirewallPolicyPolicyVariables ruleVariables(Map ruleVariables) {
  ...
  public Map getRuleVariables() {
    return ruleVariables;
  }

  public void setRuleVariables(Map ruleVariables) {
    this.ruleVariables = ruleVariables;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallPolicyPolicyVariables firewallPolicyPolicyVariables = (FirewallPolicyPolicyVariables) o;
    return Objects.equals(this.ruleVariables, firewallPolicyPolicyVariables.ruleVariables);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleVariables);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallPolicyPolicyVariables {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallPolicyPolicyVariables
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallPolicyPolicyVariables.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPolicyPolicyVariables is not found in the empty JSON string", FirewallPolicyPolicyVariables.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallPolicyPolicyVariables.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallPolicyPolicyVariables` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `RuleVariables`
      if (jsonObj.get("RuleVariables") != null && !jsonObj.get("RuleVariables").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("RuleVariables"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPolicyPolicyVariables.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPolicyPolicyVariables' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPolicyPolicyVariables> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPolicyPolicyVariables.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPolicyPolicyVariables>() {
           @Override
           public void write(JsonWriter out, FirewallPolicyPolicyVariables value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallPolicyPolicyVariables read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallPolicyPolicyVariables given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallPolicyPolicyVariables
   * @throws IOException if the JSON string is invalid with respect to FirewallPolicyPolicyVariables
   */
  public static FirewallPolicyPolicyVariables fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPolicyPolicyVariables.class);
  }

  /**
   * Convert an instance of FirewallPolicyPolicyVariables to an JSON string
   *
   * @return JSON string
   */
