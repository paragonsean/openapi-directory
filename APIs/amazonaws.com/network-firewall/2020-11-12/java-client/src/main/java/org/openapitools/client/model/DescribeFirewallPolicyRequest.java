...
public class DescribeFirewallPolicyRequest {
  ...
  public DescribeFirewallPolicyRequest firewallPolicyName(String firewallPolicyName) {
  ...
  public DescribeFirewallPolicyRequest firewallPolicyArn(String firewallPolicyArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeFirewallPolicyRequest describeFirewallPolicyRequest = (DescribeFirewallPolicyRequest) o;
    return Objects.equals(this.firewallPolicyName, describeFirewallPolicyRequest.firewallPolicyName) &&
        Objects.equals(this.firewallPolicyArn, describeFirewallPolicyRequest.firewallPolicyArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeFirewallPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeFirewallPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeFirewallPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeFirewallPolicyRequest is not found in the empty JSON string", DescribeFirewallPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeFirewallPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeFirewallPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeFirewallPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeFirewallPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeFirewallPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeFirewallPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeFirewallPolicyRequest>() {
           @Override
           public void write(JsonWriter out, DescribeFirewallPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeFirewallPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeFirewallPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeFirewallPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeFirewallPolicyRequest
   */
  public static DescribeFirewallPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeFirewallPolicyRequest.class);
  }

  /**
   * Convert an instance of DescribeFirewallPolicyRequest to an JSON string
   *
   * @return JSON string
   */
