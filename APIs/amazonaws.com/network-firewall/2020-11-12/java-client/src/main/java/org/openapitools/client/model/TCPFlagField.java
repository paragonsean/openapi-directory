...
public class TCPFlagField {
  ...
  public TCPFlagField flags(List flags) {
    this.flags = flags;
    return this;
  }
  ...
  public TCPFlagField masks(List masks) {
    this.masks = masks;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TCPFlagField tcPFlagField = (TCPFlagField) o;
    return Objects.equals(this.flags, tcPFlagField.flags) &&
        Objects.equals(this.masks, tcPFlagField.masks);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TCPFlagField
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TCPFlagField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TCPFlagField is not found in the empty JSON string", TCPFlagField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TCPFlagField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TCPFlagField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TCPFlagField.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TCPFlagField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TCPFlagField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TCPFlagField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TCPFlagField.class));

       return (TypeAdapter<T>) new TypeAdapter<TCPFlagField>() {
           @Override
           public void write(JsonWriter out, TCPFlagField value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TCPFlagField read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TCPFlagField given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TCPFlagField
   * @throws IOException if the JSON string is invalid with respect to TCPFlagField
   */
  public static TCPFlagField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TCPFlagField.class);
  }

  /**
   * Convert an instance of TCPFlagField to an JSON string
   *
   * @return JSON string
   */
