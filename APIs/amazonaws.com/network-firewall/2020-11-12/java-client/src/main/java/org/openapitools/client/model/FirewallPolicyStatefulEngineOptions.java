...
import org.openapitools.client.model.RuleOrder;
import org.openapitools.client.model.StreamExceptionPolicy;
...
public class FirewallPolicyStatefulEngineOptions {
  ...
  public static final String SERIALIZED_NAME_STREAM_EXCEPTION_POLICY = "StreamExceptionPolicy";
  @SerializedName(SERIALIZED_NAME_STREAM_EXCEPTION_POLICY)
  private StreamExceptionPolicy streamExceptionPolicy;

  public FirewallPolicyStatefulEngineOptions() {
  }

  public FirewallPolicyStatefulEngineOptions ruleOrder(RuleOrder ruleOrder) {
  ...
  public RuleOrder getRuleOrder() {
    return ruleOrder;
  }

  public void setRuleOrder(RuleOrder ruleOrder) {
    this.ruleOrder = ruleOrder;
  }


  public FirewallPolicyStatefulEngineOptions streamExceptionPolicy(StreamExceptionPolicy streamExceptionPolicy) {
   ...
   */
  @javax.annotation.Nullable
  public StreamExceptionPolicy getStreamExceptionPolicy() {
    return streamExceptionPolicy;
  }

  public void setStreamExceptionPolicy(StreamExceptionPolicy streamExceptionPolicy) {
    this.streamExceptionPolicy = streamExceptionPolicy;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallPolicyStatefulEngineOptions firewallPolicyStatefulEngineOptions = (FirewallPolicyStatefulEngineOptions) o;
    return Objects.equals(this.ruleOrder, firewallPolicyStatefulEngineOptions.ruleOrder) &&
        Objects.equals(this.streamExceptionPolicy, firewallPolicyStatefulEngineOptions.streamExceptionPolicy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ruleOrder, streamExceptionPolicy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FirewallPolicyStatefulEngineOptions {\n");
    sb.append("    ruleOrder: ").append(toIndentedString(ruleOrder)).append("\n");
    sb.append("    streamExceptionPolicy: ").append(toIndentedString(streamExceptionPolicy)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("StreamExceptionPolicy");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallPolicyStatefulEngineOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallPolicyStatefulEngineOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPolicyStatefulEngineOptions is not found in the empty JSON string", FirewallPolicyStatefulEngineOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallPolicyStatefulEngineOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallPolicyStatefulEngineOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `RuleOrder`
      if (jsonObj.get("RuleOrder") != null && !jsonObj.get("RuleOrder").isJsonNull()) {
        RuleOrder.validateJsonElement(jsonObj.get("RuleOrder"));
      }
      // validate the optional field `StreamExceptionPolicy`
      if (jsonObj.get("StreamExceptionPolicy") != null && !jsonObj.get("StreamExceptionPolicy").isJsonNull()) {
        StreamExceptionPolicy.validateJsonElement(jsonObj.get("StreamExceptionPolicy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPolicyStatefulEngineOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPolicyStatefulEngineOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPolicyStatefulEngineOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPolicyStatefulEngineOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPolicyStatefulEngineOptions>() {
           @Override
           public void write(JsonWriter out, FirewallPolicyStatefulEngineOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallPolicyStatefulEngineOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallPolicyStatefulEngineOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallPolicyStatefulEngineOptions
   * @throws IOException if the JSON string is invalid with respect to FirewallPolicyStatefulEngineOptions
   */
  public static FirewallPolicyStatefulEngineOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPolicyStatefulEngineOptions.class);
  }

  /**
   * Convert an instance of FirewallPolicyStatefulEngineOptions to an JSON string
   *
   * @return JSON string
   */
