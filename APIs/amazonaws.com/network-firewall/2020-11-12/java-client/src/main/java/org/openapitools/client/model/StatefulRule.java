...
public class StatefulRule {
  ...
  private StatefulRuleHeader header;
  ...
  public StatefulRule action(StatefulAction action) {
    this.action = action;
    return this;
  }
  ...
  public void setAction(StatefulAction action) {
    this.action = action;
  }


  public StatefulRule header(StatefulRuleHeader header) {
    this.header = header;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public StatefulRuleHeader getHeader() {
    return header;
  }

  public void setHeader(StatefulRuleHeader header) {
    this.header = header;
  }


  public StatefulRule ruleOptions(List ruleOptions) {
  ...
  public boolean equals(Object o) {
    ...
    StatefulRule statefulRule = (StatefulRule) o;
    return Objects.equals(this.action, statefulRule.action) &&
        Objects.equals(this.header, statefulRule.header) &&
        Objects.equals(this.ruleOptions, statefulRule.ruleOptions);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("RuleOptions");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRule is not found in the empty JSON string", StatefulRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatefulRule.openapiRequiredFields) {
      ...
      StatefulAction.validateJsonElement(jsonObj.get("Action"));
      // validate the required field `Header`
      StatefulRuleHeader.validateJsonElement(jsonObj.get("Header"));
      // validate the required field `RuleOptions`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRule.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRule>() {
           @Override
           public void write(JsonWriter out, StatefulRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRule
   * @throws IOException if the JSON string is invalid with respect to StatefulRule
   */
  public static StatefulRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRule.class);
  }

  /**
   * Convert an instance of StatefulRule to an JSON string
   *
   * @return JSON string
   */
