...
public class RulesSourceStatelessRulesAndCustomActions {
  ...
  public RulesSourceStatelessRulesAndCustomActions() {
  }

  public RulesSourceStatelessRulesAndCustomActions statelessRules(List statelessRules) {
  ...
  public RulesSourceStatelessRulesAndCustomActions customActions(List customActions) {
  ...
  public boolean equals(Object o) {
    ...
    RulesSourceStatelessRulesAndCustomActions rulesSourceStatelessRulesAndCustomActions = (RulesSourceStatelessRulesAndCustomActions) o;
    return Objects.equals(this.statelessRules, rulesSourceStatelessRulesAndCustomActions.statelessRules) &&
        Objects.equals(this.customActions, rulesSourceStatelessRulesAndCustomActions.customActions);
  }
  ...
  public String toString() {
    ...
    sb.append("class RulesSourceStatelessRulesAndCustomActions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RulesSourceStatelessRulesAndCustomActions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RulesSourceStatelessRulesAndCustomActions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RulesSourceStatelessRulesAndCustomActions is not found in the empty JSON string", RulesSourceStatelessRulesAndCustomActions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RulesSourceStatelessRulesAndCustomActions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RulesSourceStatelessRulesAndCustomActions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RulesSourceStatelessRulesAndCustomActions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RulesSourceStatelessRulesAndCustomActions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RulesSourceStatelessRulesAndCustomActions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RulesSourceStatelessRulesAndCustomActions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RulesSourceStatelessRulesAndCustomActions.class));

       return (TypeAdapter<T>) new TypeAdapter<RulesSourceStatelessRulesAndCustomActions>() {
           @Override
           public void write(JsonWriter out, RulesSourceStatelessRulesAndCustomActions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RulesSourceStatelessRulesAndCustomActions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RulesSourceStatelessRulesAndCustomActions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RulesSourceStatelessRulesAndCustomActions
   * @throws IOException if the JSON string is invalid with respect to RulesSourceStatelessRulesAndCustomActions
   */
  public static RulesSourceStatelessRulesAndCustomActions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RulesSourceStatelessRulesAndCustomActions.class);
  }

  /**
   * Convert an instance of RulesSourceStatelessRulesAndCustomActions to an JSON string
   *
   * @return JSON string
   */
