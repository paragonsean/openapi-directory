...
public class StatefulRuleGroupOverride {
  ...
  public StatefulRuleGroupOverride action(OverrideAction action) {
    this.action = action;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatefulRuleGroupOverride statefulRuleGroupOverride = (StatefulRuleGroupOverride) o;
    return Objects.equals(this.action, statefulRuleGroupOverride.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatefulRuleGroupOverride {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRuleGroupOverride
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRuleGroupOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRuleGroupOverride is not found in the empty JSON string", StatefulRuleGroupOverride.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRuleGroupOverride.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRuleGroupOverride` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRuleGroupOverride.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRuleGroupOverride' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRuleGroupOverride> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRuleGroupOverride.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRuleGroupOverride>() {
           @Override
           public void write(JsonWriter out, StatefulRuleGroupOverride value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRuleGroupOverride read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRuleGroupOverride given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRuleGroupOverride
   * @throws IOException if the JSON string is invalid with respect to StatefulRuleGroupOverride
   */
  public static StatefulRuleGroupOverride fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRuleGroupOverride.class);
  }

  /**
   * Convert an instance of StatefulRuleGroupOverride to an JSON string
   *
   * @return JSON string
   */
