...
/**
 * Gets or Sets ResourceManagedStatus
 */
@JsonAdapter(ResourceManagedStatus.Adapter.class)
public enum ResourceManagedStatus {
  ...
  ResourceManagedStatus(String value) {
    this.value = value;
  }
  ...
  public static ResourceManagedStatus fromValue(String value) {
    for (ResourceManagedStatus b : ResourceManagedStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResourceManagedStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResourceManagedStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ResourceManagedStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ResourceManagedStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ResourceManagedStatus.fromValue(value);
  }
}
