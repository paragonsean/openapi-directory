...
public class UpdateFirewallDescriptionResponse {
  ...
  public UpdateFirewallDescriptionResponse firewallArn(String firewallArn) {
  ...
  public UpdateFirewallDescriptionResponse firewallName(String firewallName) {
  ...
  public UpdateFirewallDescriptionResponse description(String description) {
  ...
  public UpdateFirewallDescriptionResponse updateToken(String updateToken) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFirewallDescriptionResponse updateFirewallDescriptionResponse = (UpdateFirewallDescriptionResponse) o;
    return Objects.equals(this.firewallArn, updateFirewallDescriptionResponse.firewallArn) &&
        Objects.equals(this.firewallName, updateFirewallDescriptionResponse.firewallName) &&
        Objects.equals(this.description, updateFirewallDescriptionResponse.description) &&
        Objects.equals(this.updateToken, updateFirewallDescriptionResponse.updateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName, description, updateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateFirewallDescriptionResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFirewallDescriptionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFirewallDescriptionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFirewallDescriptionResponse is not found in the empty JSON string", UpdateFirewallDescriptionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateFirewallDescriptionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateFirewallDescriptionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFirewallDescriptionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFirewallDescriptionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFirewallDescriptionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFirewallDescriptionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFirewallDescriptionResponse>() {
           @Override
           public void write(JsonWriter out, UpdateFirewallDescriptionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateFirewallDescriptionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateFirewallDescriptionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateFirewallDescriptionResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateFirewallDescriptionResponse
   */
  public static UpdateFirewallDescriptionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateFirewallDescriptionResponse.class);
  }

  /**
   * Convert an instance of UpdateFirewallDescriptionResponse to an JSON string
   *
   * @return JSON string
   */
