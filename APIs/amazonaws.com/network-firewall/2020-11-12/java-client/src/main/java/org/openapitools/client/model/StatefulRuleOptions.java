...
public class StatefulRuleOptions {
  ...
  public StatefulRuleOptions ruleOrder(RuleOrder ruleOrder) {
  ...
  public boolean equals(Object o) {
    ...
    StatefulRuleOptions statefulRuleOptions = (StatefulRuleOptions) o;
    return Objects.equals(this.ruleOrder, statefulRuleOptions.ruleOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatefulRuleOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatefulRuleOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatefulRuleOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatefulRuleOptions is not found in the empty JSON string", StatefulRuleOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatefulRuleOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatefulRuleOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatefulRuleOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatefulRuleOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatefulRuleOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatefulRuleOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<StatefulRuleOptions>() {
           @Override
           public void write(JsonWriter out, StatefulRuleOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatefulRuleOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatefulRuleOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatefulRuleOptions
   * @throws IOException if the JSON string is invalid with respect to StatefulRuleOptions
   */
  public static StatefulRuleOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatefulRuleOptions.class);
  }

  /**
   * Convert an instance of StatefulRuleOptions to an JSON string
   *
   * @return JSON string
   */
