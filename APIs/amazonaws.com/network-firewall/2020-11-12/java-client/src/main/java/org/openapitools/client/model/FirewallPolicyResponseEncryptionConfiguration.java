...
public class FirewallPolicyResponseEncryptionConfiguration {
  ...
  public FirewallPolicyResponseEncryptionConfiguration() {
  }

  public FirewallPolicyResponseEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public FirewallPolicyResponseEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallPolicyResponseEncryptionConfiguration firewallPolicyResponseEncryptionConfiguration = (FirewallPolicyResponseEncryptionConfiguration) o;
    return Objects.equals(this.keyId, firewallPolicyResponseEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, firewallPolicyResponseEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallPolicyResponseEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallPolicyResponseEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallPolicyResponseEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallPolicyResponseEncryptionConfiguration is not found in the empty JSON string", FirewallPolicyResponseEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallPolicyResponseEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallPolicyResponseEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallPolicyResponseEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallPolicyResponseEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallPolicyResponseEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallPolicyResponseEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallPolicyResponseEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallPolicyResponseEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, FirewallPolicyResponseEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallPolicyResponseEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallPolicyResponseEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallPolicyResponseEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to FirewallPolicyResponseEncryptionConfiguration
   */
  public static FirewallPolicyResponseEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallPolicyResponseEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of FirewallPolicyResponseEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
