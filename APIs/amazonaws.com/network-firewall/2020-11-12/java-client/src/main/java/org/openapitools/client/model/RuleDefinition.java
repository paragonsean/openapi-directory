...
public class RuleDefinition {
  ...
  public RuleDefinition matchAttributes(RuleDefinitionMatchAttributes matchAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.matchAttributes, ruleDefinition.matchAttributes) &&
        Objects.equals(this.actions, ruleDefinition.actions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleDefinition is not found in the empty JSON string", RuleDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RuleDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleDefinition>() {
           @Override
           public void write(JsonWriter out, RuleDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleDefinition
   * @throws IOException if the JSON string is invalid with respect to RuleDefinition
   */
  public static RuleDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleDefinition.class);
  }

  /**
   * Convert an instance of RuleDefinition to an JSON string
   *
   * @return JSON string
   */
