...
public class UpdateTLSInspectionConfigurationRequestEncryptionConfiguration {
  ...
  public UpdateTLSInspectionConfigurationRequestEncryptionConfiguration() {
  }

  public UpdateTLSInspectionConfigurationRequestEncryptionConfiguration keyId(String keyId) {
    this.keyId = keyId;
    return this;
  }
  ...
  public UpdateTLSInspectionConfigurationRequestEncryptionConfiguration type(EncryptionType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateTLSInspectionConfigurationRequestEncryptionConfiguration updateTLSInspectionConfigurationRequestEncryptionConfiguration = (UpdateTLSInspectionConfigurationRequestEncryptionConfiguration) o;
    return Objects.equals(this.keyId, updateTLSInspectionConfigurationRequestEncryptionConfiguration.keyId) &&
        Objects.equals(this.type, updateTLSInspectionConfigurationRequestEncryptionConfiguration.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTLSInspectionConfigurationRequestEncryptionConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTLSInspectionConfigurationRequestEncryptionConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTLSInspectionConfigurationRequestEncryptionConfiguration is not found in the empty JSON string", UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTLSInspectionConfigurationRequestEncryptionConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTLSInspectionConfigurationRequestEncryptionConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTLSInspectionConfigurationRequestEncryptionConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTLSInspectionConfigurationRequestEncryptionConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateTLSInspectionConfigurationRequestEncryptionConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTLSInspectionConfigurationRequestEncryptionConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTLSInspectionConfigurationRequestEncryptionConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTLSInspectionConfigurationRequestEncryptionConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateTLSInspectionConfigurationRequestEncryptionConfiguration
   */
  public static UpdateTLSInspectionConfigurationRequestEncryptionConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTLSInspectionConfigurationRequestEncryptionConfiguration.class);
  }

  /**
   * Convert an instance of UpdateTLSInspectionConfigurationRequestEncryptionConfiguration to an JSON string
   *
   * @return JSON string
   */
