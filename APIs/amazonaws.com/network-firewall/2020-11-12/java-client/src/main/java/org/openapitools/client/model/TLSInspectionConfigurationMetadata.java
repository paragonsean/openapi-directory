...
public class TLSInspectionConfigurationMetadata {
  ...
  public TLSInspectionConfigurationMetadata name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TLSInspectionConfigurationMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TLSInspectionConfigurationMetadata tlSInspectionConfigurationMetadata = (TLSInspectionConfigurationMetadata) o;
    return Objects.equals(this.name, tlSInspectionConfigurationMetadata.name) &&
        Objects.equals(this.arn, tlSInspectionConfigurationMetadata.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class TLSInspectionConfigurationMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TLSInspectionConfigurationMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TLSInspectionConfigurationMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TLSInspectionConfigurationMetadata is not found in the empty JSON string", TLSInspectionConfigurationMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TLSInspectionConfigurationMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TLSInspectionConfigurationMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TLSInspectionConfigurationMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TLSInspectionConfigurationMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TLSInspectionConfigurationMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TLSInspectionConfigurationMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<TLSInspectionConfigurationMetadata>() {
           @Override
           public void write(JsonWriter out, TLSInspectionConfigurationMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TLSInspectionConfigurationMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TLSInspectionConfigurationMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TLSInspectionConfigurationMetadata
   * @throws IOException if the JSON string is invalid with respect to TLSInspectionConfigurationMetadata
   */
  public static TLSInspectionConfigurationMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TLSInspectionConfigurationMetadata.class);
  }

  /**
   * Convert an instance of TLSInspectionConfigurationMetadata to an JSON string
   *
   * @return JSON string
   */
