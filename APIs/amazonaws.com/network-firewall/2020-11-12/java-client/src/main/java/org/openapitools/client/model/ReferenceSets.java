...
public class ReferenceSets {
  ...
  public ReferenceSets ipSetReferences(Map ipSetReferences) {
  ...
  public boolean equals(Object o) {
    ...
    ReferenceSets referenceSets = (ReferenceSets) o;
    return Objects.equals(this.ipSetReferences, referenceSets.ipSetReferences);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipSetReferences);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReferenceSets {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReferenceSets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReferenceSets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReferenceSets is not found in the empty JSON string", ReferenceSets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReferenceSets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferenceSets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferenceSets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferenceSets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferenceSets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferenceSets.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferenceSets>() {
           @Override
           public void write(JsonWriter out, ReferenceSets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReferenceSets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReferenceSets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReferenceSets
   * @throws IOException if the JSON string is invalid with respect to ReferenceSets
   */
  public static ReferenceSets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReferenceSets.class);
  }

  /**
   * Convert an instance of ReferenceSets to an JSON string
   *
   * @return JSON string
   */
