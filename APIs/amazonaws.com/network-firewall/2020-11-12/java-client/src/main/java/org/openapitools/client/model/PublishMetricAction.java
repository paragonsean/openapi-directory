...
public class PublishMetricAction {
  ...
  public PublishMetricAction dimensions(List dimensions) {
  ...
  public boolean equals(Object o) {
    ...
    PublishMetricAction publishMetricAction = (PublishMetricAction) o;
    return Objects.equals(this.dimensions, publishMetricAction.dimensions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublishMetricAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublishMetricAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishMetricAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishMetricAction is not found in the empty JSON string", PublishMetricAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublishMetricAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublishMetricAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublishMetricAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublishMetricAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublishMetricAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublishMetricAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublishMetricAction.class));

       return (TypeAdapter<T>) new TypeAdapter<PublishMetricAction>() {
           @Override
           public void write(JsonWriter out, PublishMetricAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublishMetricAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublishMetricAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublishMetricAction
   * @throws IOException if the JSON string is invalid with respect to PublishMetricAction
   */
  public static PublishMetricAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublishMetricAction.class);
  }

  /**
   * Convert an instance of PublishMetricAction to an JSON string
   *
   * @return JSON string
   */
