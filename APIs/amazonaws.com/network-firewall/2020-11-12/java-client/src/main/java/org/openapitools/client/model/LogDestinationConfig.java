...
public class LogDestinationConfig {
  ...
  private Map logDestination;

  public LogDestinationConfig() {
  }

  public LogDestinationConfig logType(LogType logType) {
  ...
  public LogDestinationConfig logDestinationType(LogDestinationType logDestinationType) {
  ...
  public LogDestinationConfig logDestination(Map logDestination) {
   ...
   */
  @javax.annotation.Nonnull
  public Map getLogDestination() {
    return logDestination;
  }

  public void setLogDestination(Map logDestination) {
    this.logDestination = logDestination;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogDestinationConfig logDestinationConfig = (LogDestinationConfig) o;
    return Objects.equals(this.logType, logDestinationConfig.logType) &&
        Objects.equals(this.logDestinationType, logDestinationConfig.logDestinationType) &&
        Objects.equals(this.logDestination, logDestinationConfig.logDestination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logType, logDestinationType, logDestination);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LogDestinationConfig {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("LogDestinationType");
    openapiRequiredFields.add("LogDestination");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogDestinationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogDestinationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogDestinationConfig is not found in the empty JSON string", LogDestinationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogDestinationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogDestinationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogDestinationConfig.openapiRequiredFields) {
      ...
      // validate the required field `LogDestinationType`
      LogDestinationType.validateJsonElement(jsonObj.get("LogDestinationType"));
      // validate the required field `LogDestination`
      Map.validateJsonElement(jsonObj.get("LogDestination"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogDestinationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogDestinationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogDestinationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogDestinationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<LogDestinationConfig>() {
           @Override
           public void write(JsonWriter out, LogDestinationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogDestinationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogDestinationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogDestinationConfig
   * @throws IOException if the JSON string is invalid with respect to LogDestinationConfig
   */
  public static LogDestinationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogDestinationConfig.class);
  }

  /**
   * Convert an instance of LogDestinationConfig to an JSON string
   *
   * @return JSON string
   */
