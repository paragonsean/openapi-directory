...
public class ListFirewallPoliciesRequest {
  ...
  public ListFirewallPoliciesRequest nextToken(String nextToken) {
  ...
  public ListFirewallPoliciesRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListFirewallPoliciesRequest listFirewallPoliciesRequest = (ListFirewallPoliciesRequest) o;
    return Objects.equals(this.nextToken, listFirewallPoliciesRequest.nextToken) &&
        Objects.equals(this.maxResults, listFirewallPoliciesRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListFirewallPoliciesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFirewallPoliciesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFirewallPoliciesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFirewallPoliciesRequest is not found in the empty JSON string", ListFirewallPoliciesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFirewallPoliciesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFirewallPoliciesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFirewallPoliciesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFirewallPoliciesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFirewallPoliciesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFirewallPoliciesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFirewallPoliciesRequest>() {
           @Override
           public void write(JsonWriter out, ListFirewallPoliciesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFirewallPoliciesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListFirewallPoliciesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListFirewallPoliciesRequest
   * @throws IOException if the JSON string is invalid with respect to ListFirewallPoliciesRequest
   */
  public static ListFirewallPoliciesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListFirewallPoliciesRequest.class);
  }

  /**
   * Convert an instance of ListFirewallPoliciesRequest to an JSON string
   *
   * @return JSON string
   */
