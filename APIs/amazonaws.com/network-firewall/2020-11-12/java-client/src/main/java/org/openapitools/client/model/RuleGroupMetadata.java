...
public class RuleGroupMetadata {
  ...
  public RuleGroupMetadata name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RuleGroupMetadata arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupMetadata ruleGroupMetadata = (RuleGroupMetadata) o;
    return Objects.equals(this.name, ruleGroupMetadata.name) &&
        Objects.equals(this.arn, ruleGroupMetadata.arn);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleGroupMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupMetadata is not found in the empty JSON string", RuleGroupMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupMetadata>() {
           @Override
           public void write(JsonWriter out, RuleGroupMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupMetadata
   * @throws IOException if the JSON string is invalid with respect to RuleGroupMetadata
   */
  public static RuleGroupMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupMetadata.class);
  }

  /**
   * Convert an instance of RuleGroupMetadata to an JSON string
   *
   * @return JSON string
   */
