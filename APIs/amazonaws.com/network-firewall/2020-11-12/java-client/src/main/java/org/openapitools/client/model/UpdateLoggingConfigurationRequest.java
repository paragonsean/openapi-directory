...
import org.openapitools.client.model.UpdateLoggingConfigurationRequestLoggingConfiguration;
...
public class UpdateLoggingConfigurationRequest {
  ...
  private UpdateLoggingConfigurationRequestLoggingConfiguration loggingConfiguration;

  public UpdateLoggingConfigurationRequest() {
  }

  public UpdateLoggingConfigurationRequest firewallArn(String firewallArn) {
  ...
  public UpdateLoggingConfigurationRequest firewallName(String firewallName) {
  ...
  public UpdateLoggingConfigurationRequest loggingConfiguration(UpdateLoggingConfigurationRequestLoggingConfiguration loggingConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateLoggingConfigurationRequestLoggingConfiguration getLoggingConfiguration() {
    return loggingConfiguration;
  }

  public void setLoggingConfiguration(UpdateLoggingConfigurationRequestLoggingConfiguration loggingConfiguration) {
    this.loggingConfiguration = loggingConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateLoggingConfigurationRequest updateLoggingConfigurationRequest = (UpdateLoggingConfigurationRequest) o;
    return Objects.equals(this.firewallArn, updateLoggingConfigurationRequest.firewallArn) &&
        Objects.equals(this.firewallName, updateLoggingConfigurationRequest.firewallName) &&
        Objects.equals(this.loggingConfiguration, updateLoggingConfigurationRequest.loggingConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewallArn, firewallName, loggingConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateLoggingConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateLoggingConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLoggingConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateLoggingConfigurationRequest is not found in the empty JSON string", UpdateLoggingConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateLoggingConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateLoggingConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("LoggingConfiguration") != null && !jsonObj.get("LoggingConfiguration").isJsonNull()) {
        UpdateLoggingConfigurationRequestLoggingConfiguration.validateJsonElement(jsonObj.get("LoggingConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateLoggingConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateLoggingConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateLoggingConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateLoggingConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateLoggingConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateLoggingConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateLoggingConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateLoggingConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateLoggingConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateLoggingConfigurationRequest
   */
  public static UpdateLoggingConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateLoggingConfigurationRequest.class);
  }

  /**
   * Convert an instance of UpdateLoggingConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
