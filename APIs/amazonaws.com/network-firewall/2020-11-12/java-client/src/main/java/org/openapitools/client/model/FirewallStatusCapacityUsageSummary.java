...
public class FirewallStatusCapacityUsageSummary {
  ...
  public FirewallStatusCapacityUsageSummary() {
  }

  public FirewallStatusCapacityUsageSummary ciDRs(CapacityUsageSummaryCIDRs ciDRs) {
    this.ciDRs = ciDRs;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FirewallStatusCapacityUsageSummary firewallStatusCapacityUsageSummary = (FirewallStatusCapacityUsageSummary) o;
    return Objects.equals(this.ciDRs, firewallStatusCapacityUsageSummary.ciDRs);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallStatusCapacityUsageSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallStatusCapacityUsageSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallStatusCapacityUsageSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallStatusCapacityUsageSummary is not found in the empty JSON string", FirewallStatusCapacityUsageSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallStatusCapacityUsageSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallStatusCapacityUsageSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallStatusCapacityUsageSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallStatusCapacityUsageSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallStatusCapacityUsageSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallStatusCapacityUsageSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallStatusCapacityUsageSummary>() {
           @Override
           public void write(JsonWriter out, FirewallStatusCapacityUsageSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallStatusCapacityUsageSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallStatusCapacityUsageSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallStatusCapacityUsageSummary
   * @throws IOException if the JSON string is invalid with respect to FirewallStatusCapacityUsageSummary
   */
  public static FirewallStatusCapacityUsageSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallStatusCapacityUsageSummary.class);
  }

  /**
   * Convert an instance of FirewallStatusCapacityUsageSummary to an JSON string
   *
   * @return JSON string
   */
