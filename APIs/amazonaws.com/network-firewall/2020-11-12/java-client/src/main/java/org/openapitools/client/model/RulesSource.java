...
public class RulesSource {
  ...
  public RulesSource rulesString(String rulesString) {
  ...
  public RulesSource rulesSourceList(RulesSourceRulesSourceList rulesSourceList) {
  ...
  public RulesSource statefulRules(List statefulRules) {
  ...
  public RulesSource statelessRulesAndCustomActions(RulesSourceStatelessRulesAndCustomActions statelessRulesAndCustomActions) {
  ...
  public boolean equals(Object o) {
    ...
    RulesSource rulesSource = (RulesSource) o;
    return Objects.equals(this.rulesString, rulesSource.rulesString) &&
        Objects.equals(this.rulesSourceList, rulesSource.rulesSourceList) &&
        Objects.equals(this.statefulRules, rulesSource.statefulRules) &&
        Objects.equals(this.statelessRulesAndCustomActions, rulesSource.statelessRulesAndCustomActions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RulesSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RulesSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RulesSource is not found in the empty JSON string", RulesSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RulesSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RulesSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RulesSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RulesSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RulesSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RulesSource.class));

       return (TypeAdapter<T>) new TypeAdapter<RulesSource>() {
           @Override
           public void write(JsonWriter out, RulesSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RulesSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RulesSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RulesSource
   * @throws IOException if the JSON string is invalid with respect to RulesSource
   */
  public static RulesSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RulesSource.class);
  }

  /**
   * Convert an instance of RulesSource to an JSON string
   *
   * @return JSON string
   */
