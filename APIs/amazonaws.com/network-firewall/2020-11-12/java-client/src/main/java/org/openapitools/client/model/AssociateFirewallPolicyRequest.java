...
public class AssociateFirewallPolicyRequest {
  ...
  public AssociateFirewallPolicyRequest() {
  }

  public AssociateFirewallPolicyRequest updateToken(String updateToken) {
  ...
  public AssociateFirewallPolicyRequest firewallArn(String firewallArn) {
  ...
  public AssociateFirewallPolicyRequest firewallName(String firewallName) {
  ...
  public AssociateFirewallPolicyRequest firewallPolicyArn(String firewallPolicyArn) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateFirewallPolicyRequest associateFirewallPolicyRequest = (AssociateFirewallPolicyRequest) o;
    return Objects.equals(this.updateToken, associateFirewallPolicyRequest.updateToken) &&
        Objects.equals(this.firewallArn, associateFirewallPolicyRequest.firewallArn) &&
        Objects.equals(this.firewallName, associateFirewallPolicyRequest.firewallName) &&
        Objects.equals(this.firewallPolicyArn, associateFirewallPolicyRequest.firewallPolicyArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, firewallArn, firewallName, firewallPolicyArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociateFirewallPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateFirewallPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateFirewallPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateFirewallPolicyRequest is not found in the empty JSON string", AssociateFirewallPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateFirewallPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateFirewallPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssociateFirewallPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateFirewallPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateFirewallPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateFirewallPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateFirewallPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateFirewallPolicyRequest>() {
           @Override
           public void write(JsonWriter out, AssociateFirewallPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateFirewallPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateFirewallPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateFirewallPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to AssociateFirewallPolicyRequest
   */
  public static AssociateFirewallPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateFirewallPolicyRequest.class);
  }

  /**
   * Convert an instance of AssociateFirewallPolicyRequest to an JSON string
   *
   * @return JSON string
   */
