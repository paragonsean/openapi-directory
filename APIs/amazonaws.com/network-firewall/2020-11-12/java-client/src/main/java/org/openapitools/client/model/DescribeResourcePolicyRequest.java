...
public class DescribeResourcePolicyRequest {
  ...
  public DescribeResourcePolicyRequest() {
  }

  public DescribeResourcePolicyRequest resourceArn(String resourceArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeResourcePolicyRequest describeResourcePolicyRequest = (DescribeResourcePolicyRequest) o;
    return Objects.equals(this.resourceArn, describeResourcePolicyRequest.resourceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeResourcePolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeResourcePolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeResourcePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeResourcePolicyRequest is not found in the empty JSON string", DescribeResourcePolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeResourcePolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeResourcePolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeResourcePolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeResourcePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeResourcePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeResourcePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeResourcePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeResourcePolicyRequest>() {
           @Override
           public void write(JsonWriter out, DescribeResourcePolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeResourcePolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeResourcePolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeResourcePolicyRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeResourcePolicyRequest
   */
  public static DescribeResourcePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeResourcePolicyRequest.class);
  }

  /**
   * Convert an instance of DescribeResourcePolicyRequest to an JSON string
   *
   * @return JSON string
   */
