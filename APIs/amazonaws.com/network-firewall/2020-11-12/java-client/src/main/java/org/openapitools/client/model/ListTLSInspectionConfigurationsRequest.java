...
public class ListTLSInspectionConfigurationsRequest {
  ...
  public ListTLSInspectionConfigurationsRequest nextToken(String nextToken) {
  ...
  public ListTLSInspectionConfigurationsRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListTLSInspectionConfigurationsRequest listTLSInspectionConfigurationsRequest = (ListTLSInspectionConfigurationsRequest) o;
    return Objects.equals(this.nextToken, listTLSInspectionConfigurationsRequest.nextToken) &&
        Objects.equals(this.maxResults, listTLSInspectionConfigurationsRequest.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListTLSInspectionConfigurationsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTLSInspectionConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTLSInspectionConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListTLSInspectionConfigurationsRequest is not found in the empty JSON string", ListTLSInspectionConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTLSInspectionConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListTLSInspectionConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTLSInspectionConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTLSInspectionConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTLSInspectionConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTLSInspectionConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTLSInspectionConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, ListTLSInspectionConfigurationsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTLSInspectionConfigurationsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTLSInspectionConfigurationsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTLSInspectionConfigurationsRequest
   * @throws IOException if the JSON string is invalid with respect to ListTLSInspectionConfigurationsRequest
   */
  public static ListTLSInspectionConfigurationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTLSInspectionConfigurationsRequest.class);
  }

  /**
   * Convert an instance of ListTLSInspectionConfigurationsRequest to an JSON string
   *
   * @return JSON string
   */
