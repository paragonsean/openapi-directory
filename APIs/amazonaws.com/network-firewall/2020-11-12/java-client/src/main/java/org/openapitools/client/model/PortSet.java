...
public class PortSet {
  ...
  public PortSet definition(List definition) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.definition, portSet.definition);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PortSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PortSet is not found in the empty JSON string", PortSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PortSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PortSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortSet.class));

       return (TypeAdapter<T>) new TypeAdapter<PortSet>() {
           @Override
           public void write(JsonWriter out, PortSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PortSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PortSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PortSet
   * @throws IOException if the JSON string is invalid with respect to PortSet
   */
  public static PortSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortSet.class);
  }

  /**
   * Convert an instance of PortSet to an JSON string
   *
   * @return JSON string
   */
