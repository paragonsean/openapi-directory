...
import org.openapitools.client.model.ActionDefinitionPublishMetricAction;
...
public class CustomActionActionDefinition {
  public static final String SERIALIZED_NAME_PUBLISH_METRIC_ACTION = "PublishMetricAction";
  @SerializedName(SERIALIZED_NAME_PUBLISH_METRIC_ACTION)
  private ActionDefinitionPublishMetricAction publishMetricAction;

  public CustomActionActionDefinition() {
  }

  public CustomActionActionDefinition publishMetricAction(ActionDefinitionPublishMetricAction publishMetricAction) {
  ...
  public ActionDefinitionPublishMetricAction getPublishMetricAction() {
    return publishMetricAction;
  }

  public void setPublishMetricAction(ActionDefinitionPublishMetricAction publishMetricAction) {
    this.publishMetricAction = publishMetricAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomActionActionDefinition customActionActionDefinition = (CustomActionActionDefinition) o;
    return Objects.equals(this.publishMetricAction, customActionActionDefinition.publishMetricAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publishMetricAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomActionActionDefinition {\n");
    sb.append("    publishMetricAction: ").append(toIndentedString(publishMetricAction)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("PublishMetricAction");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomActionActionDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomActionActionDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomActionActionDefinition is not found in the empty JSON string", CustomActionActionDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomActionActionDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomActionActionDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `PublishMetricAction`
      if (jsonObj.get("PublishMetricAction") != null && !jsonObj.get("PublishMetricAction").isJsonNull()) {
        ActionDefinitionPublishMetricAction.validateJsonElement(jsonObj.get("PublishMetricAction"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomActionActionDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomActionActionDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomActionActionDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomActionActionDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomActionActionDefinition>() {
           @Override
           public void write(JsonWriter out, CustomActionActionDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomActionActionDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomActionActionDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomActionActionDefinition
   * @throws IOException if the JSON string is invalid with respect to CustomActionActionDefinition
   */
  public static CustomActionActionDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomActionActionDefinition.class);
  }

  /**
   * Convert an instance of CustomActionActionDefinition to an JSON string
   *
   * @return JSON string
   */
