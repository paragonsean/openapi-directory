...
public class IPSetMetadata {
  public static final String SERIALIZED_NAME_RESOLVED_C_I_D_R_COUNT = "ResolvedCIDRCount";
  @SerializedName(SERIALIZED_NAME_RESOLVED_C_I_D_R_COUNT)
  private Integer resolvedCIDRCount;

  public IPSetMetadata() {
  }

  public IPSetMetadata resolvedCIDRCount(Integer resolvedCIDRCount) {
  ...
  public Integer getResolvedCIDRCount() {
    return resolvedCIDRCount;
  }
  ...
  public boolean equals(Object o) {
    ...
    IPSetMetadata ipSetMetadata = (IPSetMetadata) o;
    return Objects.equals(this.resolvedCIDRCount, ipSetMetadata.resolvedCIDRCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resolvedCIDRCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IPSetMetadata {\n");
    sb.append("    resolvedCIDRCount: ").append(toIndentedString(resolvedCIDRCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ResolvedCIDRCount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IPSetMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPSetMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IPSetMetadata is not found in the empty JSON string", IPSetMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IPSetMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IPSetMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `ResolvedCIDRCount`
      if (jsonObj.get("ResolvedCIDRCount") != null && !jsonObj.get("ResolvedCIDRCount").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("ResolvedCIDRCount"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPSetMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPSetMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPSetMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPSetMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<IPSetMetadata>() {
           @Override
           public void write(JsonWriter out, IPSetMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IPSetMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IPSetMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IPSetMetadata
   * @throws IOException if the JSON string is invalid with respect to IPSetMetadata
   */
  public static IPSetMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPSetMetadata.class);
  }

  /**
   * Convert an instance of IPSetMetadata to an JSON string
   *
   * @return JSON string
   */
