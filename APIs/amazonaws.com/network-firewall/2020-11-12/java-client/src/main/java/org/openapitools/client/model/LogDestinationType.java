...
/**
 * Gets or Sets LogDestinationType
 */
@JsonAdapter(LogDestinationType.Adapter.class)
public enum LogDestinationType {
  ...
  LogDestinationType(String value) {
    this.value = value;
  }
  ...
  public static LogDestinationType fromValue(String value) {
    for (LogDestinationType b : LogDestinationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LogDestinationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LogDestinationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LogDestinationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LogDestinationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LogDestinationType.fromValue(value);
  }
}
