...
import org.openapitools.client.model.CapacityUsageSummaryCIDRs;
...
public class CapacityUsageSummary {
  public static final String SERIALIZED_NAME_CI_D_RS = "CIDRs";
  @SerializedName(SERIALIZED_NAME_CI_D_RS)
  private CapacityUsageSummaryCIDRs ciDRs;

  public CapacityUsageSummary() {
  }

  public CapacityUsageSummary ciDRs(CapacityUsageSummaryCIDRs ciDRs) {
    this.ciDRs = ciDRs;
    return this;
  }
  ...
  public CapacityUsageSummaryCIDRs getCiDRs() {
    return ciDRs;
  }

  public void setCiDRs(CapacityUsageSummaryCIDRs ciDRs) {
    this.ciDRs = ciDRs;
  }
  ...
  public boolean equals(Object o) {
    ...
    CapacityUsageSummary capacityUsageSummary = (CapacityUsageSummary) o;
    return Objects.equals(this.ciDRs, capacityUsageSummary.ciDRs);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapacityUsageSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CapacityUsageSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacityUsageSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CapacityUsageSummary is not found in the empty JSON string", CapacityUsageSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapacityUsageSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapacityUsageSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `CIDRs`
      if (jsonObj.get("CIDRs") != null && !jsonObj.get("CIDRs").isJsonNull()) {
        CapacityUsageSummaryCIDRs.validateJsonElement(jsonObj.get("CIDRs"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapacityUsageSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapacityUsageSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapacityUsageSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapacityUsageSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<CapacityUsageSummary>() {
           @Override
           public void write(JsonWriter out, CapacityUsageSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CapacityUsageSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CapacityUsageSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CapacityUsageSummary
   * @throws IOException if the JSON string is invalid with respect to CapacityUsageSummary
   */
  public static CapacityUsageSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CapacityUsageSummary.class);
  }

  /**
   * Convert an instance of CapacityUsageSummary to an JSON string
   *
   * @return JSON string
   */
