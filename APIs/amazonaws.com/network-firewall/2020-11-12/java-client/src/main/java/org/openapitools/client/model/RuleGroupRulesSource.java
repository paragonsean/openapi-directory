...
public class RuleGroupRulesSource {
  ...
  private RulesSourceRulesSourceList rulesSourceList;
  ...
  private RulesSourceStatelessRulesAndCustomActions statelessRulesAndCustomActions;

  public RuleGroupRulesSource() {
  }

  public RuleGroupRulesSource rulesString(String rulesString) {
  ...
  public RuleGroupRulesSource rulesSourceList(RulesSourceRulesSourceList rulesSourceList) {
   ...
   */
  @javax.annotation.Nullable
  public RulesSourceRulesSourceList getRulesSourceList() {
    return rulesSourceList;
  }

  public void setRulesSourceList(RulesSourceRulesSourceList rulesSourceList) {
    this.rulesSourceList = rulesSourceList;
  }


  public RuleGroupRulesSource statefulRules(List statefulRules) {
  ...
  public RuleGroupRulesSource statelessRulesAndCustomActions(RulesSourceStatelessRulesAndCustomActions statelessRulesAndCustomActions) {
   ...
   */
  @javax.annotation.Nullable
  public RulesSourceStatelessRulesAndCustomActions getStatelessRulesAndCustomActions() {
    return statelessRulesAndCustomActions;
  }

  public void setStatelessRulesAndCustomActions(RulesSourceStatelessRulesAndCustomActions statelessRulesAndCustomActions) {
    this.statelessRulesAndCustomActions = statelessRulesAndCustomActions;
  }
  ...
  public boolean equals(Object o) {
    ...
    RuleGroupRulesSource ruleGroupRulesSource = (RuleGroupRulesSource) o;
    return Objects.equals(this.rulesString, ruleGroupRulesSource.rulesString) &&
        Objects.equals(this.rulesSourceList, ruleGroupRulesSource.rulesSourceList) &&
        Objects.equals(this.statefulRules, ruleGroupRulesSource.statefulRules) &&
        Objects.equals(this.statelessRulesAndCustomActions, ruleGroupRulesSource.statelessRulesAndCustomActions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rulesString, rulesSourceList, statefulRules, statelessRulesAndCustomActions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RuleGroupRulesSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleGroupRulesSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleGroupRulesSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuleGroupRulesSource is not found in the empty JSON string", RuleGroupRulesSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleGroupRulesSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleGroupRulesSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("RulesSourceList") != null && !jsonObj.get("RulesSourceList").isJsonNull()) {
        RulesSourceRulesSourceList.validateJsonElement(jsonObj.get("RulesSourceList"));
      }
      ...
      if (jsonObj.get("StatelessRulesAndCustomActions") != null && !jsonObj.get("StatelessRulesAndCustomActions").isJsonNull()) {
        RulesSourceStatelessRulesAndCustomActions.validateJsonElement(jsonObj.get("StatelessRulesAndCustomActions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RuleGroupRulesSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RuleGroupRulesSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RuleGroupRulesSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RuleGroupRulesSource.class));

       return (TypeAdapter<T>) new TypeAdapter<RuleGroupRulesSource>() {
           @Override
           public void write(JsonWriter out, RuleGroupRulesSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RuleGroupRulesSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RuleGroupRulesSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RuleGroupRulesSource
   * @throws IOException if the JSON string is invalid with respect to RuleGroupRulesSource
   */
  public static RuleGroupRulesSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RuleGroupRulesSource.class);
  }

  /**
   * Convert an instance of RuleGroupRulesSource to an JSON string
   *
   * @return JSON string
   */
