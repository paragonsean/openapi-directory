...
public class ServerCertificateScope {
  ...
  public ServerCertificateScope sources(List sources) {
  ...
  public ServerCertificateScope destinations(List destinations) {
  ...
  public ServerCertificateScope sourcePorts(List sourcePorts) {
  ...
  public ServerCertificateScope destinationPorts(List destinationPorts) {
  ...
  public ServerCertificateScope protocols(List protocols) {
  ...
  public boolean equals(Object o) {
    ...
    ServerCertificateScope serverCertificateScope = (ServerCertificateScope) o;
    return Objects.equals(this.sources, serverCertificateScope.sources) &&
        Objects.equals(this.destinations, serverCertificateScope.destinations) &&
        Objects.equals(this.sourcePorts, serverCertificateScope.sourcePorts) &&
        Objects.equals(this.destinationPorts, serverCertificateScope.destinationPorts) &&
        Objects.equals(this.protocols, serverCertificateScope.protocols);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sources, destinations, sourcePorts, destinationPorts, protocols);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerCertificateScope {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerCertificateScope
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerCertificateScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerCertificateScope is not found in the empty JSON string", ServerCertificateScope.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerCertificateScope.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerCertificateScope` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerCertificateScope.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerCertificateScope' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerCertificateScope> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerCertificateScope.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerCertificateScope>() {
           @Override
           public void write(JsonWriter out, ServerCertificateScope value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerCertificateScope read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerCertificateScope given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerCertificateScope
   * @throws IOException if the JSON string is invalid with respect to ServerCertificateScope
   */
  public static ServerCertificateScope fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerCertificateScope.class);
  }

  /**
   * Convert an instance of ServerCertificateScope to an JSON string
   *
   * @return JSON string
   */
