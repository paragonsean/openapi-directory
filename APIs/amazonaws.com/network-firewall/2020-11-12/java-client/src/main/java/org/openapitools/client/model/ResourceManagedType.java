...
/**
 * Gets or Sets ResourceManagedType
 */
@JsonAdapter(ResourceManagedType.Adapter.class)
public enum ResourceManagedType {
  ...
  ResourceManagedType(String value) {
    this.value = value;
  }
  ...
  public static ResourceManagedType fromValue(String value) {
    for (ResourceManagedType b : ResourceManagedType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ResourceManagedType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ResourceManagedType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ResourceManagedType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ResourceManagedType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ResourceManagedType.fromValue(value);
  }
}
