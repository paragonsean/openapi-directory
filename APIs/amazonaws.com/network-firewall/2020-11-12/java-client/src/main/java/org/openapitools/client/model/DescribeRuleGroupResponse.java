...
import org.openapitools.client.model.DescribeRuleGroupResponseRuleGroup;
...
public class DescribeRuleGroupResponse {
  ...
  private DescribeRuleGroupResponseRuleGroup ruleGroup;
  ...
  public DescribeRuleGroupResponse updateToken(String updateToken) {
  ...
  public DescribeRuleGroupResponse ruleGroup(DescribeRuleGroupResponseRuleGroup ruleGroup) {
  ...
  public DescribeRuleGroupResponseRuleGroup getRuleGroup() {
    return ruleGroup;
  }

  public void setRuleGroup(DescribeRuleGroupResponseRuleGroup ruleGroup) {
    this.ruleGroup = ruleGroup;
  }


  public DescribeRuleGroupResponse ruleGroupResponse(CreateRuleGroupResponseRuleGroupResponse ruleGroupResponse) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeRuleGroupResponse describeRuleGroupResponse = (DescribeRuleGroupResponse) o;
    return Objects.equals(this.updateToken, describeRuleGroupResponse.updateToken) &&
        Objects.equals(this.ruleGroup, describeRuleGroupResponse.ruleGroup) &&
        Objects.equals(this.ruleGroupResponse, describeRuleGroupResponse.ruleGroupResponse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateToken, ruleGroup, ruleGroupResponse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeRuleGroupResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRuleGroupResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRuleGroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRuleGroupResponse is not found in the empty JSON string", DescribeRuleGroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRuleGroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRuleGroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeRuleGroupResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("RuleGroup") != null && !jsonObj.get("RuleGroup").isJsonNull()) {
        DescribeRuleGroupResponseRuleGroup.validateJsonElement(jsonObj.get("RuleGroup"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRuleGroupResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRuleGroupResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRuleGroupResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRuleGroupResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRuleGroupResponse>() {
           @Override
           public void write(JsonWriter out, DescribeRuleGroupResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRuleGroupResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRuleGroupResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRuleGroupResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeRuleGroupResponse
   */
  public static DescribeRuleGroupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRuleGroupResponse.class);
  }

  /**
   * Convert an instance of DescribeRuleGroupResponse to an JSON string
   *
   * @return JSON string
   */
