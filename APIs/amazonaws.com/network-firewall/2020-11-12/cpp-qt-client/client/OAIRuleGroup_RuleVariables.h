...
/*
 * OAIRuleGroup_RuleVariables.h
 *
 * 
 */

#ifndef OAIRuleGroup_RuleVariables_H
#define OAIRuleGroup_RuleVariables_H
...
class OAIRuleGroup_RuleVariables : public OAIObject {
public:
    OAIRuleGroup_RuleVariables();
    OAIRuleGroup_RuleVariables(QString json);
    ~OAIRuleGroup_RuleVariables() override;
    ...
    QMap getIpSets() const;
    void setIpSets(const QMap &ip_sets);
    bool is_ip_sets_Set() const;
    bool is_ip_sets_Valid() const;

    QMap getPortSets() const;
    void setPortSets(const QMap &port_sets);
    bool is_port_sets_Set() const;
    bool is_port_sets_Valid() const;
...
private:
    ...
    QMap m_port_sets;
    bool m_port_sets_isSet;
    bool m_port_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroup_RuleVariables)

#endif // OAIRuleGroup_RuleVariables_H
