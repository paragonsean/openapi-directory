...
OAIUpdateSubnetChangeProtectionResponse::OAIUpdateSubnetChangeProtectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubnetChangeProtectionResponse::OAIUpdateSubnetChangeProtectionResponse() {
    this->initializeModel();
}

OAIUpdateSubnetChangeProtectionResponse::~OAIUpdateSubnetChangeProtectionResponse() {}

void OAIUpdateSubnetChangeProtectionResponse::initializeModel() {
...
void OAIUpdateSubnetChangeProtectionResponse::fromJson(QString jsonString) {
...
void OAIUpdateSubnetChangeProtectionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSubnetChangeProtectionResponse::asJson() const {
...
QJsonObject OAIUpdateSubnetChangeProtectionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSubnetChangeProtectionResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateSubnetChangeProtectionResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateSubnetChangeProtectionResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateSubnetChangeProtectionResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateSubnetChangeProtectionResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateSubnetChangeProtectionResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

bool OAIUpdateSubnetChangeProtectionResponse::getSubnetChangeProtection() const {
    return m_subnet_change_protection;
}
void OAIUpdateSubnetChangeProtectionResponse::setSubnetChangeProtection(const bool &subnet_change_protection) {
    m_subnet_change_protection = subnet_change_protection;
    m_subnet_change_protection_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_subnet_change_protection_Set() const{
    return m_subnet_change_protection_isSet;
}

bool OAIUpdateSubnetChangeProtectionResponse::is_subnet_change_protection_Valid() const{
    return m_subnet_change_protection_isValid;
}

bool OAIUpdateSubnetChangeProtectionResponse::isSet() const {
...
bool OAIUpdateSubnetChangeProtectionResponse::isValid() const {
