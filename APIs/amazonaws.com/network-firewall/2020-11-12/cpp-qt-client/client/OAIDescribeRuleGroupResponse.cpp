...
OAIDescribeRuleGroupResponse::OAIDescribeRuleGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRuleGroupResponse::OAIDescribeRuleGroupResponse() {
    this->initializeModel();
}

OAIDescribeRuleGroupResponse::~OAIDescribeRuleGroupResponse() {}

void OAIDescribeRuleGroupResponse::initializeModel() {
...
void OAIDescribeRuleGroupResponse::fromJson(QString jsonString) {
...
void OAIDescribeRuleGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRuleGroupResponse::asJson() const {
...
QJsonObject OAIDescribeRuleGroupResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeRuleGroupResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIDescribeRuleGroupResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIDescribeRuleGroupResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIDescribeRuleGroupResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAIDescribeRuleGroupResponse_RuleGroup OAIDescribeRuleGroupResponse::getRuleGroup() const {
    return m_rule_group;
}
void OAIDescribeRuleGroupResponse::setRuleGroup(const OAIDescribeRuleGroupResponse_RuleGroup &rule_group) {
    m_rule_group = rule_group;
    m_rule_group_isSet = true;
}

bool OAIDescribeRuleGroupResponse::is_rule_group_Set() const{
    return m_rule_group_isSet;
}

bool OAIDescribeRuleGroupResponse::is_rule_group_Valid() const{
    return m_rule_group_isValid;
}

OAICreateRuleGroupResponse_RuleGroupResponse OAIDescribeRuleGroupResponse::getRuleGroupResponse() const {
    return m_rule_group_response;
}
void OAIDescribeRuleGroupResponse::setRuleGroupResponse(const OAICreateRuleGroupResponse_RuleGroupResponse &rule_group_response) {
    m_rule_group_response = rule_group_response;
    m_rule_group_response_isSet = true;
}

bool OAIDescribeRuleGroupResponse::is_rule_group_response_Set() const{
    return m_rule_group_response_isSet;
}

bool OAIDescribeRuleGroupResponse::is_rule_group_response_Valid() const{
    return m_rule_group_response_isValid;
}

bool OAIDescribeRuleGroupResponse::isSet() const {
...
bool OAIDescribeRuleGroupResponse::isValid() const {
