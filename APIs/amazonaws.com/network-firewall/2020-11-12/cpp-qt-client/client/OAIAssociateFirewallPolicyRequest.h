...
/*
 * OAIAssociateFirewallPolicyRequest.h
 *
 * 
 */

#ifndef OAIAssociateFirewallPolicyRequest_H
#define OAIAssociateFirewallPolicyRequest_H
...
class OAIAssociateFirewallPolicyRequest : public OAIObject {
public:
    OAIAssociateFirewallPolicyRequest();
    OAIAssociateFirewallPolicyRequest(QString json);
    ~OAIAssociateFirewallPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateFirewallPolicyRequest)

#endif // OAIAssociateFirewallPolicyRequest_H
