...
/*
 * OAIGeneratedRulesType.h
 *
 * 
 */

#ifndef OAIGeneratedRulesType_H
#define OAIGeneratedRulesType_H
...
class OAIGeneratedRulesType : public OAIEnum {
public:
    OAIGeneratedRulesType();
    OAIGeneratedRulesType(QString json);
    ~OAIGeneratedRulesType() override;
    ...
    enum class eOAIGeneratedRulesType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALLOWLIST, 
        DENYLIST
    };
    OAIGeneratedRulesType::eOAIGeneratedRulesType getValue() const;
    void setValue(const OAIGeneratedRulesType::eOAIGeneratedRulesType& value);
...
private:
    ...
    eOAIGeneratedRulesType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeneratedRulesType)

#endif // OAIGeneratedRulesType_H
