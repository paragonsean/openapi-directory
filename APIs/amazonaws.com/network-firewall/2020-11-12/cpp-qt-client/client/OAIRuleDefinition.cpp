...
OAIRuleDefinition::OAIRuleDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleDefinition::OAIRuleDefinition() {
    this->initializeModel();
}

OAIRuleDefinition::~OAIRuleDefinition() {}

void OAIRuleDefinition::initializeModel() {

    m_match_attributes_isSet = false;
    m_match_attributes_isValid = false;

    m_actions_isSet = false;
    m_actions_isValid = false;
}

void OAIRuleDefinition::fromJson(QString jsonString) {
...
void OAIRuleDefinition::fromJsonObject(QJsonObject json) {

    m_match_attributes_isValid = ::OpenAPI::fromJsonValue(m_match_attributes, json[QString("MatchAttributes")]);
    m_match_attributes_isSet = !json[QString("MatchAttributes")].isNull() && m_match_attributes_isValid;

    m_actions_isValid = ::OpenAPI::fromJsonValue(m_actions, json[QString("Actions")]);
    m_actions_isSet = !json[QString("Actions")].isNull() && m_actions_isValid;
}

QString OAIRuleDefinition::asJson() const {
...
QJsonObject OAIRuleDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_match_attributes.isSet()) {
        obj.insert(QString("MatchAttributes"), ::OpenAPI::toJsonValue(m_match_attributes));
    }
    if (m_actions.isSet()) {
...
OAIRuleDefinition_MatchAttributes OAIRuleDefinition::getMatchAttributes() const {
    return m_match_attributes;
}
void OAIRuleDefinition::setMatchAttributes(const OAIRuleDefinition_MatchAttributes &match_attributes) {
    m_match_attributes = match_attributes;
    m_match_attributes_isSet = true;
}

bool OAIRuleDefinition::is_match_attributes_Set() const{
    return m_match_attributes_isSet;
}

bool OAIRuleDefinition::is_match_attributes_Valid() const{
    return m_match_attributes_isValid;
}

QList OAIRuleDefinition::getActions() const {
    return m_actions;
}
void OAIRuleDefinition::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIRuleDefinition::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIRuleDefinition::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIRuleDefinition::isSet() const {
...
bool OAIRuleDefinition::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_match_attributes_isValid && m_actions_isValid && true;
}
