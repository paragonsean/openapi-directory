...
/*
 * OAIAssociateFirewallPolicyResponse.h
 *
 * 
 */

#ifndef OAIAssociateFirewallPolicyResponse_H
#define OAIAssociateFirewallPolicyResponse_H
...
class OAIAssociateFirewallPolicyResponse : public OAIObject {
public:
    OAIAssociateFirewallPolicyResponse();
    OAIAssociateFirewallPolicyResponse(QString json);
    ~OAIAssociateFirewallPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateFirewallPolicyResponse)

#endif // OAIAssociateFirewallPolicyResponse_H
