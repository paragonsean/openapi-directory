...
OAIDisassociateSubnetsRequest::OAIDisassociateSubnetsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateSubnetsRequest::OAIDisassociateSubnetsRequest() {
    this->initializeModel();
}

OAIDisassociateSubnetsRequest::~OAIDisassociateSubnetsRequest() {}

void OAIDisassociateSubnetsRequest::initializeModel() {
...
void OAIDisassociateSubnetsRequest::fromJson(QString jsonString) {
...
void OAIDisassociateSubnetsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateSubnetsRequest::asJson() const {
...
QJsonObject OAIDisassociateSubnetsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateSubnetsRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIDisassociateSubnetsRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIDisassociateSubnetsRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIDisassociateSubnetsRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIDisassociateSubnetsRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDisassociateSubnetsRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDisassociateSubnetsRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDisassociateSubnetsRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIDisassociateSubnetsRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIDisassociateSubnetsRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIDisassociateSubnetsRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIDisassociateSubnetsRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QList OAIDisassociateSubnetsRequest::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIDisassociateSubnetsRequest::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIDisassociateSubnetsRequest::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIDisassociateSubnetsRequest::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

bool OAIDisassociateSubnetsRequest::isSet() const {
...
bool OAIDisassociateSubnetsRequest::isValid() const {
