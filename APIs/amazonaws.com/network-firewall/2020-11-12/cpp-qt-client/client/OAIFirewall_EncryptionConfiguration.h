...
/*
 * OAIFirewall_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAIFirewall_EncryptionConfiguration_H
#define OAIFirewall_EncryptionConfiguration_H
...
class OAIFirewall_EncryptionConfiguration : public OAIObject {
public:
    OAIFirewall_EncryptionConfiguration();
    OAIFirewall_EncryptionConfiguration(QString json);
    ~OAIFirewall_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewall_EncryptionConfiguration)

#endif // OAIFirewall_EncryptionConfiguration_H
