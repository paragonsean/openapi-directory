...
#ifndef OAIFirewallPolicyMetadata_H
#define OAIFirewallPolicyMetadata_H
...
class OAIFirewallPolicyMetadata : public OAIObject {
public:
    OAIFirewallPolicyMetadata();
    OAIFirewallPolicyMetadata(QString json);
    ~OAIFirewallPolicyMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallPolicyMetadata)

#endif // OAIFirewallPolicyMetadata_H
