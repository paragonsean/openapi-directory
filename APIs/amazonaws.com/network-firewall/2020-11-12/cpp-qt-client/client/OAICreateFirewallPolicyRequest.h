...
/*
 * OAICreateFirewallPolicyRequest.h
 *
 * 
 */

#ifndef OAICreateFirewallPolicyRequest_H
#define OAICreateFirewallPolicyRequest_H

#include <QJsonObject>

#include "OAICreateFirewallPolicyRequest_EncryptionConfiguration.h"
#include "OAICreateFirewallPolicyRequest_FirewallPolicy.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateFirewallPolicyRequest_FirewallPolicy;
class OAICreateFirewallPolicyRequest_EncryptionConfiguration;

class OAICreateFirewallPolicyRequest : public OAIObject {
public:
    OAICreateFirewallPolicyRequest();
    OAICreateFirewallPolicyRequest(QString json);
    ~OAICreateFirewallPolicyRequest() override;
    ...
    OAICreateFirewallPolicyRequest_FirewallPolicy getFirewallPolicy() const;
    void setFirewallPolicy(const OAICreateFirewallPolicyRequest_FirewallPolicy &firewall_policy);
    ...
    OAICreateFirewallPolicyRequest_EncryptionConfiguration getEncryptionConfiguration() const;
    void setEncryptionConfiguration(const OAICreateFirewallPolicyRequest_EncryptionConfiguration &encryption_configuration);
...
private:
    ...
    OAICreateFirewallPolicyRequest_FirewallPolicy m_firewall_policy;
    ...
    OAICreateFirewallPolicyRequest_EncryptionConfiguration m_encryption_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallPolicyRequest)

#endif // OAICreateFirewallPolicyRequest_H
