...
OAIUpdateTLSInspectionConfigurationResponse::OAIUpdateTLSInspectionConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTLSInspectionConfigurationResponse::OAIUpdateTLSInspectionConfigurationResponse() {
    this->initializeModel();
}

OAIUpdateTLSInspectionConfigurationResponse::~OAIUpdateTLSInspectionConfigurationResponse() {}

void OAIUpdateTLSInspectionConfigurationResponse::initializeModel() {
...
void OAIUpdateTLSInspectionConfigurationResponse::fromJson(QString jsonString) {
...
void OAIUpdateTLSInspectionConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTLSInspectionConfigurationResponse::asJson() const {
...
QJsonObject OAIUpdateTLSInspectionConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateTLSInspectionConfigurationResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateTLSInspectionConfigurationResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateTLSInspectionConfigurationResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse OAIUpdateTLSInspectionConfigurationResponse::getTlsInspectionConfigurationResponse() const {
    return m_tls_inspection_configuration_response;
}
void OAIUpdateTLSInspectionConfigurationResponse::setTlsInspectionConfigurationResponse(const OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse &tls_inspection_configuration_response) {
...
bool OAIUpdateTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Set() const{
    return m_tls_inspection_configuration_response_isSet;
}

bool OAIUpdateTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Valid() const{
    return m_tls_inspection_configuration_response_isValid;
}

bool OAIUpdateTLSInspectionConfigurationResponse::isSet() const {
...
bool OAIUpdateTLSInspectionConfigurationResponse::isValid() const {
