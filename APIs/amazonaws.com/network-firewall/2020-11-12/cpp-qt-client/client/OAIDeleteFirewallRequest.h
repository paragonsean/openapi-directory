...
/*
 * OAIDeleteFirewallRequest.h
 *
 * 
 */

#ifndef OAIDeleteFirewallRequest_H
#define OAIDeleteFirewallRequest_H
...
class OAIDeleteFirewallRequest : public OAIObject {
public:
    OAIDeleteFirewallRequest();
    OAIDeleteFirewallRequest(QString json);
    ~OAIDeleteFirewallRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFirewallRequest)

#endif // OAIDeleteFirewallRequest_H
