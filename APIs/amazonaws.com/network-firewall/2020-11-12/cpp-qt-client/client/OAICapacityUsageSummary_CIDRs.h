...
/*
 * OAICapacityUsageSummary_CIDRs.h
 *
 * 
 */

#ifndef OAICapacityUsageSummary_CIDRs_H
#define OAICapacityUsageSummary_CIDRs_H
...
class OAICapacityUsageSummary_CIDRs : public OAIObject {
public:
    OAICapacityUsageSummary_CIDRs();
    OAICapacityUsageSummary_CIDRs(QString json);
    ~OAICapacityUsageSummary_CIDRs() override;
    ...
    qint32 getAvailableCidrCount() const;
    void setAvailableCidrCount(const qint32 &available_cidr_count);
    bool is_available_cidr_count_Set() const;
    bool is_available_cidr_count_Valid() const;

    qint32 getUtilizedCidrCount() const;
    void setUtilizedCidrCount(const qint32 &utilized_cidr_count);
    bool is_utilized_cidr_count_Set() const;
    bool is_utilized_cidr_count_Valid() const;

    QMap getIpSetReferences() const;
    void setIpSetReferences(const QMap &ip_set_references);
    bool is_ip_set_references_Set() const;
    bool is_ip_set_references_Valid() const;
...
private:
    ...
    qint32 m_available_cidr_count;
    bool m_available_cidr_count_isSet;
    bool m_available_cidr_count_isValid;

    qint32 m_utilized_cidr_count;
    bool m_utilized_cidr_count_isSet;
    bool m_utilized_cidr_count_isValid;

    QMap m_ip_set_references;
    bool m_ip_set_references_isSet;
    bool m_ip_set_references_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICapacityUsageSummary_CIDRs)

#endif // OAICapacityUsageSummary_CIDRs_H
