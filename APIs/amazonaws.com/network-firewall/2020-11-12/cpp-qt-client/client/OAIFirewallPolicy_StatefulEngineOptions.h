...
/*
 * OAIFirewallPolicy_StatefulEngineOptions.h
 *
 * 
 */

#ifndef OAIFirewallPolicy_StatefulEngineOptions_H
#define OAIFirewallPolicy_StatefulEngineOptions_H
...
class OAIFirewallPolicy_StatefulEngineOptions : public OAIObject {
public:
    OAIFirewallPolicy_StatefulEngineOptions();
    OAIFirewallPolicy_StatefulEngineOptions(QString json);
    ~OAIFirewallPolicy_StatefulEngineOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallPolicy_StatefulEngineOptions)

#endif // OAIFirewallPolicy_StatefulEngineOptions_H
