...
QList OAIIPSet::getDefinition() const {
    return m_definition;
}
void OAIIPSet::setDefinition(const QList &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIIPSet::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIIPSet::is_definition_Valid() const{
