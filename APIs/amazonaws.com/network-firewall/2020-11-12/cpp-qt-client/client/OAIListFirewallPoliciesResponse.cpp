...
OAIListFirewallPoliciesResponse::OAIListFirewallPoliciesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFirewallPoliciesResponse::OAIListFirewallPoliciesResponse() {
    this->initializeModel();
}

OAIListFirewallPoliciesResponse::~OAIListFirewallPoliciesResponse() {}

void OAIListFirewallPoliciesResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_firewall_policies_isSet = false;
    m_firewall_policies_isValid = false;
}

void OAIListFirewallPoliciesResponse::fromJson(QString jsonString) {
...
void OAIListFirewallPoliciesResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;

    m_firewall_policies_isValid = ::OpenAPI::fromJsonValue(m_firewall_policies, json[QString("FirewallPolicies")]);
    m_firewall_policies_isSet = !json[QString("FirewallPolicies")].isNull() && m_firewall_policies_isValid;
}

QString OAIListFirewallPoliciesResponse::asJson() const {
...
QJsonObject OAIListFirewallPoliciesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("NextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_firewall_policies.isSet()) {
        obj.insert(QString("FirewallPolicies"), ::OpenAPI::toJsonValue(m_firewall_policies));
    }
    return obj;
}

QString OAIListFirewallPoliciesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListFirewallPoliciesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFirewallPoliciesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFirewallPoliciesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListFirewallPoliciesResponse::getFirewallPolicies() const {
    return m_firewall_policies;
}
void OAIListFirewallPoliciesResponse::setFirewallPolicies(const QList &firewall_policies) {
    m_firewall_policies = firewall_policies;
    m_firewall_policies_isSet = true;
}

bool OAIListFirewallPoliciesResponse::is_firewall_policies_Set() const{
    return m_firewall_policies_isSet;
}

bool OAIListFirewallPoliciesResponse::is_firewall_policies_Valid() const{
    return m_firewall_policies_isValid;
}

bool OAIListFirewallPoliciesResponse::isSet() const {
...
bool OAIListFirewallPoliciesResponse::isValid() const {
