...
OAIRuleGroup_StatefulRuleOptions::OAIRuleGroup_StatefulRuleOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroup_StatefulRuleOptions::OAIRuleGroup_StatefulRuleOptions() {
    this->initializeModel();
}

OAIRuleGroup_StatefulRuleOptions::~OAIRuleGroup_StatefulRuleOptions() {}

void OAIRuleGroup_StatefulRuleOptions::initializeModel() {

    m_rule_order_isSet = false;
    m_rule_order_isValid = false;
}

void OAIRuleGroup_StatefulRuleOptions::fromJson(QString jsonString) {
...
void OAIRuleGroup_StatefulRuleOptions::fromJsonObject(QJsonObject json) {
...
QString OAIRuleGroup_StatefulRuleOptions::asJson() const {
...
QJsonObject OAIRuleGroup_StatefulRuleOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIRuleOrder OAIRuleGroup_StatefulRuleOptions::getRuleOrder() const {
    return m_rule_order;
}
void OAIRuleGroup_StatefulRuleOptions::setRuleOrder(const OAIRuleOrder &rule_order) {
    m_rule_order = rule_order;
    m_rule_order_isSet = true;
}

bool OAIRuleGroup_StatefulRuleOptions::is_rule_order_Set() const{
    return m_rule_order_isSet;
}

bool OAIRuleGroup_StatefulRuleOptions::is_rule_order_Valid() const{
    return m_rule_order_isValid;
}

bool OAIRuleGroup_StatefulRuleOptions::isSet() const {
...
bool OAIRuleGroup_StatefulRuleOptions::isValid() const {
