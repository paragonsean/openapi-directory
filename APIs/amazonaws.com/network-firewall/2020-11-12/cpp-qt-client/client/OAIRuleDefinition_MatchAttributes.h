...
/*
 * OAIRuleDefinition_MatchAttributes.h
 *
 * 
 */

#ifndef OAIRuleDefinition_MatchAttributes_H
#define OAIRuleDefinition_MatchAttributes_H
...
class OAIRuleDefinition_MatchAttributes : public OAIObject {
public:
    OAIRuleDefinition_MatchAttributes();
    OAIRuleDefinition_MatchAttributes(QString json);
    ~OAIRuleDefinition_MatchAttributes() override;
    ...
    QList getTcpFlags() const;
    void setTcpFlags(const QList &tcp_flags);
    bool is_tcp_flags_Set() const;
    bool is_tcp_flags_Valid() const;
...
private:
    ...
    QList m_tcp_flags;
    bool m_tcp_flags_isSet;
    bool m_tcp_flags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRuleDefinition_MatchAttributes)

#endif // OAIRuleDefinition_MatchAttributes_H
