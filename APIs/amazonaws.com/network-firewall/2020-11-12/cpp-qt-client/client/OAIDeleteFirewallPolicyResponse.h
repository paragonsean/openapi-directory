...
/*
 * OAIDeleteFirewallPolicyResponse.h
 *
 * 
 */

#ifndef OAIDeleteFirewallPolicyResponse_H
#define OAIDeleteFirewallPolicyResponse_H
...
namespace OpenAPI {
class OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse;

class OAIDeleteFirewallPolicyResponse : public OAIObject {
public:
    OAIDeleteFirewallPolicyResponse();
    OAIDeleteFirewallPolicyResponse(QString json);
    ~OAIDeleteFirewallPolicyResponse() override;
    ...
    OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse getFirewallPolicyResponse() const;
    void setFirewallPolicyResponse(const OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response);
...
private:
    ...
    OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse m_firewall_policy_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFirewallPolicyResponse)

#endif // OAIDeleteFirewallPolicyResponse_H
