...
OAIFirewallStatus_CapacityUsageSummary::OAIFirewallStatus_CapacityUsageSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallStatus_CapacityUsageSummary::OAIFirewallStatus_CapacityUsageSummary() {
    this->initializeModel();
}

OAIFirewallStatus_CapacityUsageSummary::~OAIFirewallStatus_CapacityUsageSummary() {}

void OAIFirewallStatus_CapacityUsageSummary::initializeModel() {

    m_cidrs_isSet = false;
    m_cidrs_isValid = false;
}

void OAIFirewallStatus_CapacityUsageSummary::fromJson(QString jsonString) {
...
void OAIFirewallStatus_CapacityUsageSummary::fromJsonObject(QJsonObject json) {

    m_cidrs_isValid = ::OpenAPI::fromJsonValue(m_cidrs, json[QString("CIDRs")]);
    m_cidrs_isSet = !json[QString("CIDRs")].isNull() && m_cidrs_isValid;
}

QString OAIFirewallStatus_CapacityUsageSummary::asJson() const {
...
QJsonObject OAIFirewallStatus_CapacityUsageSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_cidrs.isSet()) {
...
OAICapacityUsageSummary_CIDRs OAIFirewallStatus_CapacityUsageSummary::getCidrs() const {
    return m_cidrs;
}
void OAIFirewallStatus_CapacityUsageSummary::setCidrs(const OAICapacityUsageSummary_CIDRs &cidrs) {
    m_cidrs = cidrs;
    m_cidrs_isSet = true;
}

bool OAIFirewallStatus_CapacityUsageSummary::is_cidrs_Set() const{
    return m_cidrs_isSet;
}

bool OAIFirewallStatus_CapacityUsageSummary::is_cidrs_Valid() const{
    return m_cidrs_isValid;
}

bool OAIFirewallStatus_CapacityUsageSummary::isSet() const {
...
bool OAIFirewallStatus_CapacityUsageSummary::isValid() const {
