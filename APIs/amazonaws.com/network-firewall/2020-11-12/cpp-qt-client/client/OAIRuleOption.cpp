...
OAIRuleOption::OAIRuleOption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleOption::OAIRuleOption() {
    this->initializeModel();
}

OAIRuleOption::~OAIRuleOption() {}

void OAIRuleOption::initializeModel() {
...
void OAIRuleOption::fromJson(QString jsonString) {
...
void OAIRuleOption::fromJsonObject(QJsonObject json) {
...
QString OAIRuleOption::asJson() const {
...
QJsonObject OAIRuleOption::asJsonObject() const {
    QJsonObject obj;
    if (m_keyword_isSet) {
...
QString OAIRuleOption::getKeyword() const {
    return m_keyword;
}
void OAIRuleOption::setKeyword(const QString &keyword) {
    m_keyword = keyword;
    m_keyword_isSet = true;
}

bool OAIRuleOption::is_keyword_Set() const{
    return m_keyword_isSet;
}

bool OAIRuleOption::is_keyword_Valid() const{
    return m_keyword_isValid;
}

QList OAIRuleOption::getSettings() const {
    return m_settings;
}
void OAIRuleOption::setSettings(const QList &settings) {
    m_settings = settings;
    m_settings_isSet = true;
}

bool OAIRuleOption::is_settings_Set() const{
    return m_settings_isSet;
}

bool OAIRuleOption::is_settings_Valid() const{
    return m_settings_isValid;
}

bool OAIRuleOption::isSet() const {
...
bool OAIRuleOption::isValid() const {
