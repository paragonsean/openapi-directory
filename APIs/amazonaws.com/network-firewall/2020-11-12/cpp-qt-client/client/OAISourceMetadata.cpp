...
QString OAISourceMetadata::getSourceArn() const {
    return m_source_arn;
}
void OAISourceMetadata::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAISourceMetadata::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAISourceMetadata::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAISourceMetadata::getSourceUpdateToken() const {
    return m_source_update_token;
}
void OAISourceMetadata::setSourceUpdateToken(const QString &source_update_token) {
    m_source_update_token = source_update_token;
    m_source_update_token_isSet = true;
}

bool OAISourceMetadata::is_source_update_token_Set() const{
    return m_source_update_token_isSet;
}

bool OAISourceMetadata::is_source_update_token_Valid() const{
