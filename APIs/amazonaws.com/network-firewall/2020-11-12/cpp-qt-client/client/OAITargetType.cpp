...
void OAITargetType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("TLS_SNI", Qt::CaseInsensitive) == 0) {
        m_value = eOAITargetType::TLS_SNI;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HTTP_HOST", Qt::CaseInsensitive) == 0) {
        m_value = eOAITargetType::HTTP_HOST;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAITargetType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAITargetType::TLS_SNI:
            val = "TLS_SNI";
            break;
        case eOAITargetType::HTTP_HOST:
            val = "HTTP_HOST";
            break;
        default:
            break;
