...
#include "OAIResourceManagedStatus.h"
...
OAIResourceManagedStatus::OAIResourceManagedStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceManagedStatus::OAIResourceManagedStatus() {
    this->initializeModel();
}

OAIResourceManagedStatus::~OAIResourceManagedStatus() {}

void OAIResourceManagedStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIResourceManagedStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIResourceManagedStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("MANAGED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIResourceManagedStatus::MANAGED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACCOUNT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIResourceManagedStatus::ACCOUNT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIResourceManagedStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIResourceManagedStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIResourceManagedStatus::MANAGED:
            val = "MANAGED";
            break;
        case eOAIResourceManagedStatus::ACCOUNT:
            val = "ACCOUNT";
            break;
        default:
            break;
...
QJsonValue OAIResourceManagedStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIResourceManagedStatus::eOAIResourceManagedStatus OAIResourceManagedStatus::getValue() const {
    return m_value;
}

void OAIResourceManagedStatus::setValue(const OAIResourceManagedStatus::eOAIResourceManagedStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIResourceManagedStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIResourceManagedStatus::isValid() const {
