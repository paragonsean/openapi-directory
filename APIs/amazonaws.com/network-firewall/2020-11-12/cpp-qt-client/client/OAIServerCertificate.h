...
#ifndef OAIServerCertificate_H
#define OAIServerCertificate_H
...
class OAIServerCertificate : public OAIObject {
public:
    OAIServerCertificate();
    OAIServerCertificate(QString json);
    ~OAIServerCertificate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerCertificate)

#endif // OAIServerCertificate_H
