...
OAIDescribeTLSInspectionConfigurationRequest::OAIDescribeTLSInspectionConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTLSInspectionConfigurationRequest::OAIDescribeTLSInspectionConfigurationRequest() {
    this->initializeModel();
}

OAIDescribeTLSInspectionConfigurationRequest::~OAIDescribeTLSInspectionConfigurationRequest() {}

void OAIDescribeTLSInspectionConfigurationRequest::initializeModel() {
...
void OAIDescribeTLSInspectionConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDescribeTLSInspectionConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTLSInspectionConfigurationRequest::asJson() const {
...
QJsonObject OAIDescribeTLSInspectionConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeTLSInspectionConfigurationRequest::getTlsInspectionConfigurationArn() const {
    return m_tls_inspection_configuration_arn;
}
void OAIDescribeTLSInspectionConfigurationRequest::setTlsInspectionConfigurationArn(const QString &tls_inspection_configuration_arn) {
    m_tls_inspection_configuration_arn = tls_inspection_configuration_arn;
    m_tls_inspection_configuration_arn_isSet = true;
}

bool OAIDescribeTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Set() const{
    return m_tls_inspection_configuration_arn_isSet;
}

bool OAIDescribeTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Valid() const{
    return m_tls_inspection_configuration_arn_isValid;
}

QString OAIDescribeTLSInspectionConfigurationRequest::getTlsInspectionConfigurationName() const {
    return m_tls_inspection_configuration_name;
}
void OAIDescribeTLSInspectionConfigurationRequest::setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name) {
    m_tls_inspection_configuration_name = tls_inspection_configuration_name;
    m_tls_inspection_configuration_name_isSet = true;
}

bool OAIDescribeTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Set() const{
    return m_tls_inspection_configuration_name_isSet;
}

bool OAIDescribeTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Valid() const{
    return m_tls_inspection_configuration_name_isValid;
}

bool OAIDescribeTLSInspectionConfigurationRequest::isSet() const {
...
bool OAIDescribeTLSInspectionConfigurationRequest::isValid() const {
