...
OAIUpdateTLSInspectionConfigurationRequest::OAIUpdateTLSInspectionConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTLSInspectionConfigurationRequest::OAIUpdateTLSInspectionConfigurationRequest() {
    this->initializeModel();
}

OAIUpdateTLSInspectionConfigurationRequest::~OAIUpdateTLSInspectionConfigurationRequest() {}

void OAIUpdateTLSInspectionConfigurationRequest::initializeModel() {
    ...
    m_tls_inspection_configuration_isSet = false;
    m_tls_inspection_configuration_isValid = false;
...
void OAIUpdateTLSInspectionConfigurationRequest::fromJson(QString jsonString) {
...
void OAIUpdateTLSInspectionConfigurationRequest::fromJsonObject(QJsonObject json) {
    ...
    m_tls_inspection_configuration_isValid = ::OpenAPI::fromJsonValue(m_tls_inspection_configuration, json[QString("TLSInspectionConfiguration")]);
    m_tls_inspection_configuration_isSet = !json[QString("TLSInspectionConfiguration")].isNull() && m_tls_inspection_configuration_isValid;
...
QString OAIUpdateTLSInspectionConfigurationRequest::asJson() const {
...
QJsonObject OAIUpdateTLSInspectionConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_tls_inspection_configuration.isSet()) {
        obj.insert(QString("TLSInspectionConfiguration"), ::OpenAPI::toJsonValue(m_tls_inspection_configuration));
    }
...
QString OAIUpdateTLSInspectionConfigurationRequest::getTlsInspectionConfigurationArn() const {
    return m_tls_inspection_configuration_arn;
}
void OAIUpdateTLSInspectionConfigurationRequest::setTlsInspectionConfigurationArn(const QString &tls_inspection_configuration_arn) {
    m_tls_inspection_configuration_arn = tls_inspection_configuration_arn;
    m_tls_inspection_configuration_arn_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Set() const{
    return m_tls_inspection_configuration_arn_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Valid() const{
    return m_tls_inspection_configuration_arn_isValid;
}

QString OAIUpdateTLSInspectionConfigurationRequest::getTlsInspectionConfigurationName() const {
    return m_tls_inspection_configuration_name;
}
void OAIUpdateTLSInspectionConfigurationRequest::setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name) {
    m_tls_inspection_configuration_name = tls_inspection_configuration_name;
    m_tls_inspection_configuration_name_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Set() const{
    return m_tls_inspection_configuration_name_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Valid() const{
    return m_tls_inspection_configuration_name_isValid;
}

OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration OAIUpdateTLSInspectionConfigurationRequest::getTlsInspectionConfiguration() const {
    return m_tls_inspection_configuration;
}
void OAIUpdateTLSInspectionConfigurationRequest::setTlsInspectionConfiguration(const OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration &tls_inspection_configuration) {
    m_tls_inspection_configuration = tls_inspection_configuration;
    m_tls_inspection_configuration_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_Set() const{
    return m_tls_inspection_configuration_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_Valid() const{
    return m_tls_inspection_configuration_isValid;
}

QString OAIUpdateTLSInspectionConfigurationRequest::getDescription() const {
    return m_description;
}
void OAIUpdateTLSInspectionConfigurationRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_description_Valid() const{
    return m_description_isValid;
}

OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration OAIUpdateTLSInspectionConfigurationRequest::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIUpdateTLSInspectionConfigurationRequest::setEncryptionConfiguration(const OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

QString OAIUpdateTLSInspectionConfigurationRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateTLSInspectionConfigurationRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIUpdateTLSInspectionConfigurationRequest::isSet() const {
...
bool OAIUpdateTLSInspectionConfigurationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tls_inspection_configuration_isValid && m_update_token_isValid && true;
}
