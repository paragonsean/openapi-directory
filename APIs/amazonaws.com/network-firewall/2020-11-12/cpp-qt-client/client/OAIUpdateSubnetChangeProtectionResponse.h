...
/*
 * OAIUpdateSubnetChangeProtectionResponse.h
 *
 * 
 */

#ifndef OAIUpdateSubnetChangeProtectionResponse_H
#define OAIUpdateSubnetChangeProtectionResponse_H
...
class OAIUpdateSubnetChangeProtectionResponse : public OAIObject {
public:
    OAIUpdateSubnetChangeProtectionResponse();
    OAIUpdateSubnetChangeProtectionResponse(QString json);
    ~OAIUpdateSubnetChangeProtectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubnetChangeProtectionResponse)

#endif // OAIUpdateSubnetChangeProtectionResponse_H
