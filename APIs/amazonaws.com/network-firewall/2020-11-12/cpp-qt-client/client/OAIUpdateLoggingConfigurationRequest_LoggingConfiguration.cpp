...
#include "OAIUpdateLoggingConfigurationRequest_LoggingConfiguration.h"
...
OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::OAIUpdateLoggingConfigurationRequest_LoggingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::OAIUpdateLoggingConfigurationRequest_LoggingConfiguration() {
    this->initializeModel();
}

OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::~OAIUpdateLoggingConfigurationRequest_LoggingConfiguration() {}

void OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::initializeModel() {

    m_log_destination_configs_isSet = false;
    m_log_destination_configs_isValid = false;
}

void OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::asJson() const {
...
QJsonObject OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::getLogDestinationConfigs() const {
    return m_log_destination_configs;
}
void OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::setLogDestinationConfigs(const QList &log_destination_configs) {
    m_log_destination_configs = log_destination_configs;
    m_log_destination_configs_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::is_log_destination_configs_Set() const{
    return m_log_destination_configs_isSet;
}

bool OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::is_log_destination_configs_Valid() const{
    return m_log_destination_configs_isValid;
}

bool OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::isSet() const {
...
bool OAIUpdateLoggingConfigurationRequest_LoggingConfiguration::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_log_destination_configs_isValid && true;
}
