...
QString OAIListRuleGroupsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListRuleGroupsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRuleGroupsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRuleGroupsResponse::is_next_token_Valid() const{
