...
/*
 * OAIDescribeFirewallRequest.h
 *
 * 
 */

#ifndef OAIDescribeFirewallRequest_H
#define OAIDescribeFirewallRequest_H
...
class OAIDescribeFirewallRequest : public OAIObject {
public:
    OAIDescribeFirewallRequest();
    OAIDescribeFirewallRequest(QString json);
    ~OAIDescribeFirewallRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFirewallRequest)

#endif // OAIDescribeFirewallRequest_H
