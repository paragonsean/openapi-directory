...
/*
 * OAIDescribeLoggingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDescribeLoggingConfigurationRequest_H
#define OAIDescribeLoggingConfigurationRequest_H
...
class OAIDescribeLoggingConfigurationRequest : public OAIObject {
public:
    OAIDescribeLoggingConfigurationRequest();
    OAIDescribeLoggingConfigurationRequest(QString json);
    ~OAIDescribeLoggingConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLoggingConfigurationRequest)

#endif // OAIDescribeLoggingConfigurationRequest_H
