...
/*
 * OAIListFirewallPoliciesResponse.h
 *
 * 
 */

#ifndef OAIListFirewallPoliciesResponse_H
#define OAIListFirewallPoliciesResponse_H
...
class OAIListFirewallPoliciesResponse : public OAIObject {
public:
    OAIListFirewallPoliciesResponse();
    OAIListFirewallPoliciesResponse(QString json);
    ~OAIListFirewallPoliciesResponse() override;
    ...
    QList getFirewallPolicies() const;
    void setFirewallPolicies(const QList &firewall_policies);
    bool is_firewall_policies_Set() const;
    bool is_firewall_policies_Valid() const;
...
private:
    ...
    QList m_firewall_policies;
    bool m_firewall_policies_isSet;
    bool m_firewall_policies_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListFirewallPoliciesResponse)

#endif // OAIListFirewallPoliciesResponse_H
