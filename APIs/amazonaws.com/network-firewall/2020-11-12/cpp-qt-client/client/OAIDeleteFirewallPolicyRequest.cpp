...
OAIDeleteFirewallPolicyRequest::OAIDeleteFirewallPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFirewallPolicyRequest::OAIDeleteFirewallPolicyRequest() {
    this->initializeModel();
}

OAIDeleteFirewallPolicyRequest::~OAIDeleteFirewallPolicyRequest() {}

void OAIDeleteFirewallPolicyRequest::initializeModel() {
...
void OAIDeleteFirewallPolicyRequest::fromJson(QString jsonString) {
...
void OAIDeleteFirewallPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFirewallPolicyRequest::asJson() const {
...
QJsonObject OAIDeleteFirewallPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFirewallPolicyRequest::getFirewallPolicyName() const {
    return m_firewall_policy_name;
}
void OAIDeleteFirewallPolicyRequest::setFirewallPolicyName(const QString &firewall_policy_name) {
    m_firewall_policy_name = firewall_policy_name;
    m_firewall_policy_name_isSet = true;
}

bool OAIDeleteFirewallPolicyRequest::is_firewall_policy_name_Set() const{
    return m_firewall_policy_name_isSet;
}

bool OAIDeleteFirewallPolicyRequest::is_firewall_policy_name_Valid() const{
    return m_firewall_policy_name_isValid;
}

QString OAIDeleteFirewallPolicyRequest::getFirewallPolicyArn() const {
    return m_firewall_policy_arn;
}
void OAIDeleteFirewallPolicyRequest::setFirewallPolicyArn(const QString &firewall_policy_arn) {
    m_firewall_policy_arn = firewall_policy_arn;
    m_firewall_policy_arn_isSet = true;
}

bool OAIDeleteFirewallPolicyRequest::is_firewall_policy_arn_Set() const{
    return m_firewall_policy_arn_isSet;
}

bool OAIDeleteFirewallPolicyRequest::is_firewall_policy_arn_Valid() const{
    return m_firewall_policy_arn_isValid;
}

bool OAIDeleteFirewallPolicyRequest::isSet() const {
...
bool OAIDeleteFirewallPolicyRequest::isValid() const {
