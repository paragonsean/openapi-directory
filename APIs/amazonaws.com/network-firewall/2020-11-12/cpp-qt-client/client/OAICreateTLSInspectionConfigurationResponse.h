...
/*
 * OAICreateTLSInspectionConfigurationResponse.h
 *
 * 
 */

#ifndef OAICreateTLSInspectionConfigurationResponse_H
#define OAICreateTLSInspectionConfigurationResponse_H

#include <QJsonObject>

#include "OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse;

class OAICreateTLSInspectionConfigurationResponse : public OAIObject {
public:
    OAICreateTLSInspectionConfigurationResponse();
    OAICreateTLSInspectionConfigurationResponse(QString json);
    ~OAICreateTLSInspectionConfigurationResponse() override;
    ...
    OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse getTlsInspectionConfigurationResponse() const;
    void setTlsInspectionConfigurationResponse(const OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse &tls_inspection_configuration_response);
    bool is_tls_inspection_configuration_response_Set() const;
    bool is_tls_inspection_configuration_response_Valid() const;
...
private:
    ...
    OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse m_tls_inspection_configuration_response;
    bool m_tls_inspection_configuration_response_isSet;
    bool m_tls_inspection_configuration_response_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateTLSInspectionConfigurationResponse)

#endif // OAICreateTLSInspectionConfigurationResponse_H
