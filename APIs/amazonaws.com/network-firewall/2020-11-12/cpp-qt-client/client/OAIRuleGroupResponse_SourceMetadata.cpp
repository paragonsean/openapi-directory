...
OAIRuleGroupResponse_SourceMetadata::OAIRuleGroupResponse_SourceMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroupResponse_SourceMetadata::OAIRuleGroupResponse_SourceMetadata() {
    this->initializeModel();
}

OAIRuleGroupResponse_SourceMetadata::~OAIRuleGroupResponse_SourceMetadata() {}

void OAIRuleGroupResponse_SourceMetadata::initializeModel() {

    m_source_arn_isSet = false;
    m_source_arn_isValid = false;

    m_source_update_token_isSet = false;
    m_source_update_token_isValid = false;
}

void OAIRuleGroupResponse_SourceMetadata::fromJson(QString jsonString) {
...
void OAIRuleGroupResponse_SourceMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_source_update_token_isValid = ::OpenAPI::fromJsonValue(m_source_update_token, json[QString("SourceUpdateToken")]);
    m_source_update_token_isSet = !json[QString("SourceUpdateToken")].isNull() && m_source_update_token_isValid;
}

QString OAIRuleGroupResponse_SourceMetadata::asJson() const {
...
QJsonObject OAIRuleGroupResponse_SourceMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_source_arn_isSet) {
        obj.insert(QString("SourceArn"), ::OpenAPI::toJsonValue(m_source_arn));
    }
    if (m_source_update_token_isSet) {
        obj.insert(QString("SourceUpdateToken"), ::OpenAPI::toJsonValue(m_source_update_token));
    }
    return obj;
}

QString OAIRuleGroupResponse_SourceMetadata::getSourceArn() const {
    return m_source_arn;
}
void OAIRuleGroupResponse_SourceMetadata::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIRuleGroupResponse_SourceMetadata::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIRuleGroupResponse_SourceMetadata::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAIRuleGroupResponse_SourceMetadata::getSourceUpdateToken() const {
    return m_source_update_token;
}
void OAIRuleGroupResponse_SourceMetadata::setSourceUpdateToken(const QString &source_update_token) {
    m_source_update_token = source_update_token;
    m_source_update_token_isSet = true;
}

bool OAIRuleGroupResponse_SourceMetadata::is_source_update_token_Set() const{
    return m_source_update_token_isSet;
}

bool OAIRuleGroupResponse_SourceMetadata::is_source_update_token_Valid() const{
    return m_source_update_token_isValid;
}

bool OAIRuleGroupResponse_SourceMetadata::isSet() const {
...
bool OAIRuleGroupResponse_SourceMetadata::isValid() const {
