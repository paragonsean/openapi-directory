...
#ifndef OAISubnetMapping_H
#define OAISubnetMapping_H
...
class OAISubnetMapping : public OAIObject {
public:
    OAISubnetMapping();
    OAISubnetMapping(QString json);
    ~OAISubnetMapping() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubnetMapping)

#endif // OAISubnetMapping_H
