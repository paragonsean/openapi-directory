...
/*
 * OAIListFirewallPoliciesRequest.h
 *
 * 
 */

#ifndef OAIListFirewallPoliciesRequest_H
#define OAIListFirewallPoliciesRequest_H
...
class OAIListFirewallPoliciesRequest : public OAIObject {
public:
    OAIListFirewallPoliciesRequest();
    OAIListFirewallPoliciesRequest(QString json);
    ~OAIListFirewallPoliciesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFirewallPoliciesRequest)

#endif // OAIListFirewallPoliciesRequest_H
