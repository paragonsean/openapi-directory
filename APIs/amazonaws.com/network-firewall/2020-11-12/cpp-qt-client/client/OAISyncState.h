...
#ifndef OAISyncState_H
#define OAISyncState_H
...
namespace OpenAPI {
class OAISyncState_Attachment;

class OAISyncState : public OAIObject {
public:
    OAISyncState();
    OAISyncState(QString json);
    ~OAISyncState() override;
    ...
    OAISyncState_Attachment getAttachment() const;
    void setAttachment(const OAISyncState_Attachment &attachment);
...
private:
    ...
    OAISyncState_Attachment m_attachment;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyncState)

#endif // OAISyncState_H
