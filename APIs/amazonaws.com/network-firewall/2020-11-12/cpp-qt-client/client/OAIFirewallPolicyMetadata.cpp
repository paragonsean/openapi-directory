...
#include "OAIFirewallPolicyMetadata.h"
...
OAIFirewallPolicyMetadata::OAIFirewallPolicyMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallPolicyMetadata::OAIFirewallPolicyMetadata() {
    this->initializeModel();
}

OAIFirewallPolicyMetadata::~OAIFirewallPolicyMetadata() {}

void OAIFirewallPolicyMetadata::initializeModel() {
...
void OAIFirewallPolicyMetadata::fromJson(QString jsonString) {
...
void OAIFirewallPolicyMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallPolicyMetadata::asJson() const {
...
QJsonObject OAIFirewallPolicyMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIFirewallPolicyMetadata::getName() const {
    return m_name;
}
void OAIFirewallPolicyMetadata::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFirewallPolicyMetadata::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFirewallPolicyMetadata::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIFirewallPolicyMetadata::getArn() const {
    return m_arn;
}
void OAIFirewallPolicyMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIFirewallPolicyMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIFirewallPolicyMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIFirewallPolicyMetadata::isSet() const {
...
bool OAIFirewallPolicyMetadata::isValid() const {
