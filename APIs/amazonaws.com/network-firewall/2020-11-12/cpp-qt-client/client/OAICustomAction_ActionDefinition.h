...
/*
 * OAICustomAction_ActionDefinition.h
 *
 * 
 */

#ifndef OAICustomAction_ActionDefinition_H
#define OAICustomAction_ActionDefinition_H
...
namespace OpenAPI {
class OAIActionDefinition_PublishMetricAction;

class OAICustomAction_ActionDefinition : public OAIObject {
public:
    OAICustomAction_ActionDefinition();
    OAICustomAction_ActionDefinition(QString json);
    ~OAICustomAction_ActionDefinition() override;
    ...
    OAIActionDefinition_PublishMetricAction getPublishMetricAction() const;
    void setPublishMetricAction(const OAIActionDefinition_PublishMetricAction &publish_metric_action);
    bool is_publish_metric_action_Set() const;
    bool is_publish_metric_action_Valid() const;
...
private:
    ...
    OAIActionDefinition_PublishMetricAction m_publish_metric_action;
    bool m_publish_metric_action_isSet;
    bool m_publish_metric_action_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICustomAction_ActionDefinition)

#endif // OAICustomAction_ActionDefinition_H
