...
OAIListFirewallsResponse::OAIListFirewallsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFirewallsResponse::OAIListFirewallsResponse() {
    this->initializeModel();
}

OAIListFirewallsResponse::~OAIListFirewallsResponse() {}

void OAIListFirewallsResponse::initializeModel() {
...
void OAIListFirewallsResponse::fromJson(QString jsonString) {
...
void OAIListFirewallsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListFirewallsResponse::asJson() const {
...
QJsonObject OAIListFirewallsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("NextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_firewalls.isSet()) {
        obj.insert(QString("Firewalls"), ::OpenAPI::toJsonValue(m_firewalls));
    }
    return obj;
}

QString OAIListFirewallsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListFirewallsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFirewallsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFirewallsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListFirewallsResponse::getFirewalls() const {
    return m_firewalls;
}
void OAIListFirewallsResponse::setFirewalls(const QList &firewalls) {
    m_firewalls = firewalls;
    m_firewalls_isSet = true;
}

bool OAIListFirewallsResponse::is_firewalls_Set() const{
    return m_firewalls_isSet;
}

bool OAIListFirewallsResponse::is_firewalls_Valid() const{
    return m_firewalls_isValid;
}

bool OAIListFirewallsResponse::isSet() const {
...
bool OAIListFirewallsResponse::isValid() const {
