...
/*
 * OAICreateRuleGroupRequest_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAICreateRuleGroupRequest_EncryptionConfiguration_H
#define OAICreateRuleGroupRequest_EncryptionConfiguration_H
...
class OAICreateRuleGroupRequest_EncryptionConfiguration : public OAIObject {
public:
    OAICreateRuleGroupRequest_EncryptionConfiguration();
    OAICreateRuleGroupRequest_EncryptionConfiguration(QString json);
    ~OAICreateRuleGroupRequest_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleGroupRequest_EncryptionConfiguration)

#endif // OAICreateRuleGroupRequest_EncryptionConfiguration_H
