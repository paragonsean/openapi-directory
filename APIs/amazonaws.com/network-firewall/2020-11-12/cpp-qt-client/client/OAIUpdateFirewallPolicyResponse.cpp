...
OAIUpdateFirewallPolicyResponse::OAIUpdateFirewallPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallPolicyResponse::OAIUpdateFirewallPolicyResponse() {
    this->initializeModel();
}

OAIUpdateFirewallPolicyResponse::~OAIUpdateFirewallPolicyResponse() {}

void OAIUpdateFirewallPolicyResponse::initializeModel() {
...
void OAIUpdateFirewallPolicyResponse::fromJson(QString jsonString) {
...
void OAIUpdateFirewallPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallPolicyResponse::asJson() const {
...
QJsonObject OAIUpdateFirewallPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallPolicyResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallPolicyResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallPolicyResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallPolicyResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateFirewallPolicyResponse_FirewallPolicyResponse OAIUpdateFirewallPolicyResponse::getFirewallPolicyResponse() const {
    return m_firewall_policy_response;
}
void OAIUpdateFirewallPolicyResponse::setFirewallPolicyResponse(const OAICreateFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response) {
    m_firewall_policy_response = firewall_policy_response;
    m_firewall_policy_response_isSet = true;
}

bool OAIUpdateFirewallPolicyResponse::is_firewall_policy_response_Set() const{
    return m_firewall_policy_response_isSet;
}

bool OAIUpdateFirewallPolicyResponse::is_firewall_policy_response_Valid() const{
    return m_firewall_policy_response_isValid;
}

bool OAIUpdateFirewallPolicyResponse::isSet() const {
...
bool OAIUpdateFirewallPolicyResponse::isValid() const {
