...
/*
 * OAIDescribeRuleGroupRequest.h
 *
 * 
 */

#ifndef OAIDescribeRuleGroupRequest_H
#define OAIDescribeRuleGroupRequest_H
...
class OAIDescribeRuleGroupRequest : public OAIObject {
public:
    OAIDescribeRuleGroupRequest();
    OAIDescribeRuleGroupRequest(QString json);
    ~OAIDescribeRuleGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleGroupRequest)

#endif // OAIDescribeRuleGroupRequest_H
