...
OAIUpdateFirewallDeleteProtectionResponse::OAIUpdateFirewallDeleteProtectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallDeleteProtectionResponse::OAIUpdateFirewallDeleteProtectionResponse() {
    this->initializeModel();
}

OAIUpdateFirewallDeleteProtectionResponse::~OAIUpdateFirewallDeleteProtectionResponse() {}

void OAIUpdateFirewallDeleteProtectionResponse::initializeModel() {
...
void OAIUpdateFirewallDeleteProtectionResponse::fromJson(QString jsonString) {
...
void OAIUpdateFirewallDeleteProtectionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallDeleteProtectionResponse::asJson() const {
...
QJsonObject OAIUpdateFirewallDeleteProtectionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallDeleteProtectionResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallDeleteProtectionResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallDeleteProtectionResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallDeleteProtectionResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

bool OAIUpdateFirewallDeleteProtectionResponse::getDeleteProtection() const {
    return m_delete_protection;
}
void OAIUpdateFirewallDeleteProtectionResponse::setDeleteProtection(const bool &delete_protection) {
    m_delete_protection = delete_protection;
    m_delete_protection_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_delete_protection_Set() const{
    return m_delete_protection_isSet;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_delete_protection_Valid() const{
    return m_delete_protection_isValid;
}

QString OAIUpdateFirewallDeleteProtectionResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallDeleteProtectionResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallDeleteProtectionResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIUpdateFirewallDeleteProtectionResponse::isSet() const {
...
bool OAIUpdateFirewallDeleteProtectionResponse::isValid() const {
