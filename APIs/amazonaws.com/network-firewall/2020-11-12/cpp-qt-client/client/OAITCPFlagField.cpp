...
OAITCPFlagField::OAITCPFlagField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITCPFlagField::OAITCPFlagField() {
    this->initializeModel();
}

OAITCPFlagField::~OAITCPFlagField() {}

void OAITCPFlagField::initializeModel() {

    m_flags_isSet = false;
    m_flags_isValid = false;

    m_masks_isSet = false;
    m_masks_isValid = false;
}

void OAITCPFlagField::fromJson(QString jsonString) {
...
void OAITCPFlagField::fromJsonObject(QJsonObject json) {

    m_flags_isValid = ::OpenAPI::fromJsonValue(m_flags, json[QString("Flags")]);
    m_flags_isSet = !json[QString("Flags")].isNull() && m_flags_isValid;

    m_masks_isValid = ::OpenAPI::fromJsonValue(m_masks, json[QString("Masks")]);
    m_masks_isSet = !json[QString("Masks")].isNull() && m_masks_isValid;
}

QString OAITCPFlagField::asJson() const {
...
QJsonObject OAITCPFlagField::asJsonObject() const {
    QJsonObject obj;
    if (m_flags.isSet()) {
        obj.insert(QString("Flags"), ::OpenAPI::toJsonValue(m_flags));
    }
    if (m_masks.isSet()) {
        obj.insert(QString("Masks"), ::OpenAPI::toJsonValue(m_masks));
    }
    return obj;
}

QList OAITCPFlagField::getFlags() const {
    return m_flags;
}
void OAITCPFlagField::setFlags(const QList &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAITCPFlagField::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAITCPFlagField::is_flags_Valid() const{
    return m_flags_isValid;
}

QList OAITCPFlagField::getMasks() const {
    return m_masks;
}
void OAITCPFlagField::setMasks(const QList &masks) {
    m_masks = masks;
    m_masks_isSet = true;
}

bool OAITCPFlagField::is_masks_Set() const{
    return m_masks_isSet;
}

bool OAITCPFlagField::is_masks_Valid() const{
    return m_masks_isValid;
}

bool OAITCPFlagField::isSet() const {
...
bool OAITCPFlagField::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_flags_isValid && true;
}
