...
#ifndef OAIRuleGroupMetadata_H
#define OAIRuleGroupMetadata_H
...
class OAIRuleGroupMetadata : public OAIObject {
public:
    OAIRuleGroupMetadata();
    OAIRuleGroupMetadata(QString json);
    ~OAIRuleGroupMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupMetadata)

#endif // OAIRuleGroupMetadata_H
