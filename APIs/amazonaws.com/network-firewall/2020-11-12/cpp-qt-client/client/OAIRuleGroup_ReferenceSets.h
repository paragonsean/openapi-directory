...
/*
 * OAIRuleGroup_ReferenceSets.h
 *
 * 
 */

#ifndef OAIRuleGroup_ReferenceSets_H
#define OAIRuleGroup_ReferenceSets_H
...
class OAIRuleGroup_ReferenceSets : public OAIObject {
public:
    OAIRuleGroup_ReferenceSets();
    OAIRuleGroup_ReferenceSets(QString json);
    ~OAIRuleGroup_ReferenceSets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroup_ReferenceSets)

#endif // OAIRuleGroup_ReferenceSets_H
