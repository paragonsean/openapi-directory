...
OAIStatefulRuleProtocol OAIHeader::getProtocol() const {
    return m_protocol;
}
void OAIHeader::setProtocol(const OAIStatefulRuleProtocol &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIHeader::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIHeader::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIHeader::getSource() const {
    return m_source;
}
void OAIHeader::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIHeader::is_source_Set() const{
    return m_source_isSet;
}

bool OAIHeader::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIHeader::getSourcePort() const {
    return m_source_port;
}
void OAIHeader::setSourcePort(const QString &source_port) {
    m_source_port = source_port;
    m_source_port_isSet = true;
}

bool OAIHeader::is_source_port_Set() const{
    return m_source_port_isSet;
}

bool OAIHeader::is_source_port_Valid() const{
    return m_source_port_isValid;
}

OAIStatefulRuleDirection OAIHeader::getDirection() const {
    return m_direction;
}
void OAIHeader::setDirection(const OAIStatefulRuleDirection &direction) {
    m_direction = direction;
    m_direction_isSet = true;
}

bool OAIHeader::is_direction_Set() const{
    return m_direction_isSet;
}

bool OAIHeader::is_direction_Valid() const{
    return m_direction_isValid;
}

QString OAIHeader::getDestination() const {
    return m_destination;
}
void OAIHeader::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIHeader::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIHeader::is_destination_Valid() const{
    return m_destination_isValid;
}

QString OAIHeader::getDestinationPort() const {
    return m_destination_port;
}
void OAIHeader::setDestinationPort(const QString &destination_port) {
    m_destination_port = destination_port;
    m_destination_port_isSet = true;
}

bool OAIHeader::is_destination_port_Set() const{
    return m_destination_port_isSet;
}

bool OAIHeader::is_destination_port_Valid() const{
