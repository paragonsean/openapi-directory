...
/*
 * OAIUpdateFirewallPolicyRequest.h
 *
 * 
 */

#ifndef OAIUpdateFirewallPolicyRequest_H
#define OAIUpdateFirewallPolicyRequest_H
...
namespace OpenAPI {
class OAIUpdateFirewallPolicyRequest_FirewallPolicy;
class OAICreateFirewallPolicyRequest_EncryptionConfiguration;

class OAIUpdateFirewallPolicyRequest : public OAIObject {
public:
    OAIUpdateFirewallPolicyRequest();
    OAIUpdateFirewallPolicyRequest(QString json);
    ~OAIUpdateFirewallPolicyRequest() override;
    ...
    OAIUpdateFirewallPolicyRequest_FirewallPolicy getFirewallPolicy() const;
    void setFirewallPolicy(const OAIUpdateFirewallPolicyRequest_FirewallPolicy &firewall_policy);
...
private:
    ...
    OAIUpdateFirewallPolicyRequest_FirewallPolicy m_firewall_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallPolicyRequest)

#endif // OAIUpdateFirewallPolicyRequest_H
