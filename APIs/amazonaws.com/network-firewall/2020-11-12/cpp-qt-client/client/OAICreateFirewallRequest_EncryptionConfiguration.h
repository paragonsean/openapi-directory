...
/*
 * OAICreateFirewallRequest_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAICreateFirewallRequest_EncryptionConfiguration_H
#define OAICreateFirewallRequest_EncryptionConfiguration_H
...
class OAICreateFirewallRequest_EncryptionConfiguration : public OAIObject {
public:
    OAICreateFirewallRequest_EncryptionConfiguration();
    OAICreateFirewallRequest_EncryptionConfiguration(QString json);
    ~OAICreateFirewallRequest_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallRequest_EncryptionConfiguration)

#endif // OAICreateFirewallRequest_EncryptionConfiguration_H
