...
OAICreateTLSInspectionConfigurationRequest::OAICreateTLSInspectionConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTLSInspectionConfigurationRequest::OAICreateTLSInspectionConfigurationRequest() {
    this->initializeModel();
}

OAICreateTLSInspectionConfigurationRequest::~OAICreateTLSInspectionConfigurationRequest() {}

void OAICreateTLSInspectionConfigurationRequest::initializeModel() {
...
void OAICreateTLSInspectionConfigurationRequest::fromJson(QString jsonString) {
...
void OAICreateTLSInspectionConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateTLSInspectionConfigurationRequest::asJson() const {
...
QJsonObject OAICreateTLSInspectionConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateTLSInspectionConfigurationRequest::getTlsInspectionConfigurationName() const {
    return m_tls_inspection_configuration_name;
}
void OAICreateTLSInspectionConfigurationRequest::setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name) {
    m_tls_inspection_configuration_name = tls_inspection_configuration_name;
    m_tls_inspection_configuration_name_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Set() const{
    return m_tls_inspection_configuration_name_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Valid() const{
    return m_tls_inspection_configuration_name_isValid;
}

OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration OAICreateTLSInspectionConfigurationRequest::getTlsInspectionConfiguration() const {
    return m_tls_inspection_configuration;
}
void OAICreateTLSInspectionConfigurationRequest::setTlsInspectionConfiguration(const OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration &tls_inspection_configuration) {
    m_tls_inspection_configuration = tls_inspection_configuration;
    m_tls_inspection_configuration_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_Set() const{
    return m_tls_inspection_configuration_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tls_inspection_configuration_Valid() const{
    return m_tls_inspection_configuration_isValid;
}

QString OAICreateTLSInspectionConfigurationRequest::getDescription() const {
    return m_description;
}
void OAICreateTLSInspectionConfigurationRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest::is_description_Valid() const{
    return m_description_isValid;
}

QList OAICreateTLSInspectionConfigurationRequest::getTags() const {
    return m_tags;
}
void OAICreateTLSInspectionConfigurationRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIEncryptionConfiguration OAICreateTLSInspectionConfigurationRequest::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAICreateTLSInspectionConfigurationRequest::setEncryptionConfiguration(const OAIEncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

bool OAICreateTLSInspectionConfigurationRequest::isSet() const {
...
bool OAICreateTLSInspectionConfigurationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tls_inspection_configuration_name_isValid && m_tls_inspection_configuration_isValid && true;
}
