...
OAIUpdateSubnetChangeProtectionRequest::OAIUpdateSubnetChangeProtectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSubnetChangeProtectionRequest::OAIUpdateSubnetChangeProtectionRequest() {
    this->initializeModel();
}

OAIUpdateSubnetChangeProtectionRequest::~OAIUpdateSubnetChangeProtectionRequest() {}

void OAIUpdateSubnetChangeProtectionRequest::initializeModel() {
...
void OAIUpdateSubnetChangeProtectionRequest::fromJson(QString jsonString) {
...
void OAIUpdateSubnetChangeProtectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSubnetChangeProtectionRequest::asJson() const {
...
QJsonObject OAIUpdateSubnetChangeProtectionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSubnetChangeProtectionRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateSubnetChangeProtectionRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateSubnetChangeProtectionRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateSubnetChangeProtectionRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateSubnetChangeProtectionRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateSubnetChangeProtectionRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

bool OAIUpdateSubnetChangeProtectionRequest::getSubnetChangeProtection() const {
    return m_subnet_change_protection;
}
void OAIUpdateSubnetChangeProtectionRequest::setSubnetChangeProtection(const bool &subnet_change_protection) {
    m_subnet_change_protection = subnet_change_protection;
    m_subnet_change_protection_isSet = true;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_subnet_change_protection_Set() const{
    return m_subnet_change_protection_isSet;
}

bool OAIUpdateSubnetChangeProtectionRequest::is_subnet_change_protection_Valid() const{
    return m_subnet_change_protection_isValid;
}

bool OAIUpdateSubnetChangeProtectionRequest::isSet() const {
...
bool OAIUpdateSubnetChangeProtectionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_subnet_change_protection_isValid && true;
}
