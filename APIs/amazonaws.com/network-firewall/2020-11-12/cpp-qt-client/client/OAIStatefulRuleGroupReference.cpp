...
#include "OAIStatefulRuleGroupReference.h"
...
OAIStatefulRuleGroupReference::OAIStatefulRuleGroupReference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulRuleGroupReference::OAIStatefulRuleGroupReference() {
    this->initializeModel();
}

OAIStatefulRuleGroupReference::~OAIStatefulRuleGroupReference() {}

void OAIStatefulRuleGroupReference::initializeModel() {
...
void OAIStatefulRuleGroupReference::fromJson(QString jsonString) {
...
void OAIStatefulRuleGroupReference::fromJsonObject(QJsonObject json) {
...
QString OAIStatefulRuleGroupReference::asJson() const {
...
QJsonObject OAIStatefulRuleGroupReference::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStatefulRuleGroupReference::getResourceArn() const {
    return m_resource_arn;
}
void OAIStatefulRuleGroupReference::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIStatefulRuleGroupReference::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIStatefulRuleGroupReference::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

qint32 OAIStatefulRuleGroupReference::getPriority() const {
    return m_priority;
}
void OAIStatefulRuleGroupReference::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIStatefulRuleGroupReference::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIStatefulRuleGroupReference::is_priority_Valid() const{
    return m_priority_isValid;
}

OAIStatefulRuleGroupReference_Override OAIStatefulRuleGroupReference::getOverride() const {
    return m_override;
}
void OAIStatefulRuleGroupReference::setOverride(const OAIStatefulRuleGroupReference_Override &override) {
    m_override = override;
    m_override_isSet = true;
}

bool OAIStatefulRuleGroupReference::is_override_Set() const{
    return m_override_isSet;
}

bool OAIStatefulRuleGroupReference::is_override_Valid() const{
    return m_override_isValid;
}

bool OAIStatefulRuleGroupReference::isSet() const {
...
bool OAIStatefulRuleGroupReference::isValid() const {
