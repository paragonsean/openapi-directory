...
OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse() {
    this->initializeModel();
}

OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::~OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse() {}

void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::initializeModel() {
...
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::fromJson(QString jsonString) {
...
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::asJson() const {
...
QJsonObject OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getTlsInspectionConfigurationArn() const {
    return m_tls_inspection_configuration_arn;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setTlsInspectionConfigurationArn(const QString &tls_inspection_configuration_arn) {
    m_tls_inspection_configuration_arn = tls_inspection_configuration_arn;
    m_tls_inspection_configuration_arn_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_arn_Set() const{
    return m_tls_inspection_configuration_arn_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_arn_Valid() const{
    return m_tls_inspection_configuration_arn_isValid;
}

QString OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getTlsInspectionConfigurationName() const {
    return m_tls_inspection_configuration_name;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name) {
    m_tls_inspection_configuration_name = tls_inspection_configuration_name;
    m_tls_inspection_configuration_name_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_name_Set() const{
    return m_tls_inspection_configuration_name_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_name_Valid() const{
    return m_tls_inspection_configuration_name_isValid;
}

QString OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getTlsInspectionConfigurationId() const {
    return m_tls_inspection_configuration_id;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setTlsInspectionConfigurationId(const QString &tls_inspection_configuration_id) {
    m_tls_inspection_configuration_id = tls_inspection_configuration_id;
    m_tls_inspection_configuration_id_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_id_Set() const{
    return m_tls_inspection_configuration_id_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_id_Valid() const{
    return m_tls_inspection_configuration_id_isValid;
}

OAIResourceStatus OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getTlsInspectionConfigurationStatus() const {
    return m_tls_inspection_configuration_status;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setTlsInspectionConfigurationStatus(const OAIResourceStatus &tls_inspection_configuration_status) {
...
bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_status_Set() const{
    return m_tls_inspection_configuration_status_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tls_inspection_configuration_status_Valid() const{
    return m_tls_inspection_configuration_status_isValid;
}

QString OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getDescription() const {
    return m_description;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_description_Valid() const{
    return m_description_isValid;
}

QList OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getTags() const {
    return m_tags;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QDateTime OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

qint32 OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getNumberOfAssociations() const {
    return m_number_of_associations;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setNumberOfAssociations(const qint32 &number_of_associations) {
    m_number_of_associations = number_of_associations;
    m_number_of_associations_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_number_of_associations_Set() const{
    return m_number_of_associations_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_number_of_associations_Valid() const{
    return m_number_of_associations_isValid;
}

OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setEncryptionConfiguration(const OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

QList OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::getCertificates() const {
    return m_certificates;
}
void OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::setCertificates(const QList &certificates) {
    m_certificates = certificates;
    m_certificates_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_certificates_Set() const{
    return m_certificates_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::is_certificates_Valid() const{
    return m_certificates_isValid;
}

bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::isSet() const {
...
bool OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse::isValid() const {
