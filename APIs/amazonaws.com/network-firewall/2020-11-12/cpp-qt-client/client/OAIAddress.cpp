...
void OAIAddress::initializeModel() {
    ...
    m_address_definition_isSet = false;
    m_address_definition_isValid = false;
}
...
void OAIAddress::fromJsonObject(QJsonObject json) {
    ...
    m_address_definition_isValid = ::OpenAPI::fromJsonValue(m_address_definition, json[QString("AddressDefinition")]);
    m_address_definition_isSet = !json[QString("AddressDefinition")].isNull() && m_address_definition_isValid;
}
...
QJsonObject OAIAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_address_definition_isSet) {
        obj.insert(QString("AddressDefinition"), ::OpenAPI::toJsonValue(m_address_definition));
    }
    return obj;
}

QString OAIAddress::getAddressDefinition() const {
    return m_address_definition;
}
void OAIAddress::setAddressDefinition(const QString &address_definition) {
    m_address_definition = address_definition;
    m_address_definition_isSet = true;
}

bool OAIAddress::is_address_definition_Set() const{
    return m_address_definition_isSet;
}

bool OAIAddress::is_address_definition_Valid() const{
    return m_address_definition_isValid;
}
...
bool OAIAddress::isValid() const {
    ...
    return m_address_definition_isValid && true;
}
