...
OAIDescribeRuleGroupRequest::OAIDescribeRuleGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRuleGroupRequest::OAIDescribeRuleGroupRequest() {
    this->initializeModel();
}

OAIDescribeRuleGroupRequest::~OAIDescribeRuleGroupRequest() {}

void OAIDescribeRuleGroupRequest::initializeModel() {
...
void OAIDescribeRuleGroupRequest::fromJson(QString jsonString) {
...
void OAIDescribeRuleGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRuleGroupRequest::asJson() const {
...
QJsonObject OAIDescribeRuleGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeRuleGroupRequest::getRuleGroupName() const {
    return m_rule_group_name;
}
void OAIDescribeRuleGroupRequest::setRuleGroupName(const QString &rule_group_name) {
    m_rule_group_name = rule_group_name;
    m_rule_group_name_isSet = true;
}

bool OAIDescribeRuleGroupRequest::is_rule_group_name_Set() const{
    return m_rule_group_name_isSet;
}

bool OAIDescribeRuleGroupRequest::is_rule_group_name_Valid() const{
    return m_rule_group_name_isValid;
}

QString OAIDescribeRuleGroupRequest::getRuleGroupArn() const {
    return m_rule_group_arn;
}
void OAIDescribeRuleGroupRequest::setRuleGroupArn(const QString &rule_group_arn) {
    m_rule_group_arn = rule_group_arn;
    m_rule_group_arn_isSet = true;
}

bool OAIDescribeRuleGroupRequest::is_rule_group_arn_Set() const{
    return m_rule_group_arn_isSet;
}

bool OAIDescribeRuleGroupRequest::is_rule_group_arn_Valid() const{
    return m_rule_group_arn_isValid;
}

OAIRuleGroupType OAIDescribeRuleGroupRequest::getType() const {
    return m_type;
}
void OAIDescribeRuleGroupRequest::setType(const OAIRuleGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDescribeRuleGroupRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDescribeRuleGroupRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDescribeRuleGroupRequest::isSet() const {
...
bool OAIDescribeRuleGroupRequest::isValid() const {
