...
#include "OAIActionDefinition_PublishMetricAction.h"
...
OAIActionDefinition_PublishMetricAction::OAIActionDefinition_PublishMetricAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionDefinition_PublishMetricAction::OAIActionDefinition_PublishMetricAction() {
    this->initializeModel();
}

OAIActionDefinition_PublishMetricAction::~OAIActionDefinition_PublishMetricAction() {}

void OAIActionDefinition_PublishMetricAction::initializeModel() {

    m_dimensions_isSet = false;
    m_dimensions_isValid = false;
}

void OAIActionDefinition_PublishMetricAction::fromJson(QString jsonString) {
...
void OAIActionDefinition_PublishMetricAction::fromJsonObject(QJsonObject json) {

    m_dimensions_isValid = ::OpenAPI::fromJsonValue(m_dimensions, json[QString("Dimensions")]);
    m_dimensions_isSet = !json[QString("Dimensions")].isNull() && m_dimensions_isValid;
}

QString OAIActionDefinition_PublishMetricAction::asJson() const {
...
QJsonObject OAIActionDefinition_PublishMetricAction::asJsonObject() const {
    QJsonObject obj;
...
QList OAIActionDefinition_PublishMetricAction::getDimensions() const {
    return m_dimensions;
}
void OAIActionDefinition_PublishMetricAction::setDimensions(const QList &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIActionDefinition_PublishMetricAction::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIActionDefinition_PublishMetricAction::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

bool OAIActionDefinition_PublishMetricAction::isSet() const {
...
bool OAIActionDefinition_PublishMetricAction::isValid() const {
