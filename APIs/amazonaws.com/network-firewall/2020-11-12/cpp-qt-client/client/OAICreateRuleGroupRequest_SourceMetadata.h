...
/*
 * OAICreateRuleGroupRequest_SourceMetadata.h
 *
 * 
 */

#ifndef OAICreateRuleGroupRequest_SourceMetadata_H
#define OAICreateRuleGroupRequest_SourceMetadata_H
...
class OAICreateRuleGroupRequest_SourceMetadata : public OAIObject {
public:
    OAICreateRuleGroupRequest_SourceMetadata();
    OAICreateRuleGroupRequest_SourceMetadata(QString json);
    ~OAICreateRuleGroupRequest_SourceMetadata() override;
    ...
    QString getSourceUpdateToken() const;
    void setSourceUpdateToken(const QString &source_update_token);
    bool is_source_update_token_Set() const;
    bool is_source_update_token_Valid() const;
...
private:
    ...
    QString m_source_update_token;
    bool m_source_update_token_isSet;
    bool m_source_update_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleGroupRequest_SourceMetadata)

#endif // OAICreateRuleGroupRequest_SourceMetadata_H
