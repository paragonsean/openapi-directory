...
QString OAIDeleteRuleGroupRequest::getRuleGroupName() const {
    return m_rule_group_name;
}
void OAIDeleteRuleGroupRequest::setRuleGroupName(const QString &rule_group_name) {
    m_rule_group_name = rule_group_name;
    m_rule_group_name_isSet = true;
}

bool OAIDeleteRuleGroupRequest::is_rule_group_name_Set() const{
    return m_rule_group_name_isSet;
}

bool OAIDeleteRuleGroupRequest::is_rule_group_name_Valid() const{
    return m_rule_group_name_isValid;
}

QString OAIDeleteRuleGroupRequest::getRuleGroupArn() const {
    return m_rule_group_arn;
}
void OAIDeleteRuleGroupRequest::setRuleGroupArn(const QString &rule_group_arn) {
    m_rule_group_arn = rule_group_arn;
    m_rule_group_arn_isSet = true;
}

bool OAIDeleteRuleGroupRequest::is_rule_group_arn_Set() const{
    return m_rule_group_arn_isSet;
}

bool OAIDeleteRuleGroupRequest::is_rule_group_arn_Valid() const{
    return m_rule_group_arn_isValid;
}

OAIRuleGroupType OAIDeleteRuleGroupRequest::getType() const {
    return m_type;
}
void OAIDeleteRuleGroupRequest::setType(const OAIRuleGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDeleteRuleGroupRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDeleteRuleGroupRequest::is_type_Valid() const{
