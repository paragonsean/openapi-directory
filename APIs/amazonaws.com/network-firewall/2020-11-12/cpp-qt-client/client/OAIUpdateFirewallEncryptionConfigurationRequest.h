...
/*
 * OAIUpdateFirewallEncryptionConfigurationRequest.h
 *
 * 
 */

#ifndef OAIUpdateFirewallEncryptionConfigurationRequest_H
#define OAIUpdateFirewallEncryptionConfigurationRequest_H
...
class OAIUpdateFirewallEncryptionConfigurationRequest : public OAIObject {
public:
    OAIUpdateFirewallEncryptionConfigurationRequest();
    OAIUpdateFirewallEncryptionConfigurationRequest(QString json);
    ~OAIUpdateFirewallEncryptionConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallEncryptionConfigurationRequest)

#endif // OAIUpdateFirewallEncryptionConfigurationRequest_H
