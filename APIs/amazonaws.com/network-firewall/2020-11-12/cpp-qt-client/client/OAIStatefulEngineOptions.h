...
/*
 * OAIStatefulEngineOptions.h
 *
 * Configuration settings for the handling of the stateful rule groups in a firewall policy. 
 */

#ifndef OAIStatefulEngineOptions_H
#define OAIStatefulEngineOptions_H

#include <QJsonObject>

#include "OAIRuleOrder.h"
...
class OAIStatefulEngineOptions : public OAIObject {
public:
    OAIStatefulEngineOptions();
    OAIStatefulEngineOptions(QString json);
    ~OAIStatefulEngineOptions() override;
    ...
    OAIRuleOrder getRuleOrder() const;
    void setRuleOrder(const OAIRuleOrder &rule_order);
    bool is_rule_order_Set() const;
    bool is_rule_order_Valid() const;

    OAIStreamExceptionPolicy getStreamExceptionPolicy() const;
    void setStreamExceptionPolicy(const OAIStreamExceptionPolicy &stream_exception_policy);
    bool is_stream_exception_policy_Set() const;
    bool is_stream_exception_policy_Valid() const;
...
private:
    ...
    OAIRuleOrder m_rule_order;
    bool m_rule_order_isSet;
    bool m_rule_order_isValid;

    OAIStreamExceptionPolicy m_stream_exception_policy;
    bool m_stream_exception_policy_isSet;
    bool m_stream_exception_policy_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStatefulEngineOptions)

#endif // OAIStatefulEngineOptions_H
