...
OAIDeleteTLSInspectionConfigurationResponse::OAIDeleteTLSInspectionConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTLSInspectionConfigurationResponse::OAIDeleteTLSInspectionConfigurationResponse() {
    this->initializeModel();
}

OAIDeleteTLSInspectionConfigurationResponse::~OAIDeleteTLSInspectionConfigurationResponse() {}

void OAIDeleteTLSInspectionConfigurationResponse::initializeModel() {

    m_tls_inspection_configuration_response_isSet = false;
    m_tls_inspection_configuration_response_isValid = false;
}

void OAIDeleteTLSInspectionConfigurationResponse::fromJson(QString jsonString) {
...
void OAIDeleteTLSInspectionConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTLSInspectionConfigurationResponse::asJson() const {
...
QJsonObject OAIDeleteTLSInspectionConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse OAIDeleteTLSInspectionConfigurationResponse::getTlsInspectionConfigurationResponse() const {
    return m_tls_inspection_configuration_response;
}
void OAIDeleteTLSInspectionConfigurationResponse::setTlsInspectionConfigurationResponse(const OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse &tls_inspection_configuration_response) {
...
bool OAIDeleteTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Set() const{
    return m_tls_inspection_configuration_response_isSet;
}

bool OAIDeleteTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Valid() const{
    return m_tls_inspection_configuration_response_isValid;
}

bool OAIDeleteTLSInspectionConfigurationResponse::isSet() const {
...
bool OAIDeleteTLSInspectionConfigurationResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tls_inspection_configuration_response_isValid && true;
}
