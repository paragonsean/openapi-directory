...
/*
 * OAIDeleteTLSInspectionConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDeleteTLSInspectionConfigurationRequest_H
#define OAIDeleteTLSInspectionConfigurationRequest_H
...
class OAIDeleteTLSInspectionConfigurationRequest : public OAIObject {
public:
    OAIDeleteTLSInspectionConfigurationRequest();
    OAIDeleteTLSInspectionConfigurationRequest(QString json);
    ~OAIDeleteTLSInspectionConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTLSInspectionConfigurationRequest)

#endif // OAIDeleteTLSInspectionConfigurationRequest_H
