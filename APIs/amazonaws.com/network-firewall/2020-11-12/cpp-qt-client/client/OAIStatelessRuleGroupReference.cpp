...
#include "OAIStatelessRuleGroupReference.h"
...
OAIStatelessRuleGroupReference::OAIStatelessRuleGroupReference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatelessRuleGroupReference::OAIStatelessRuleGroupReference() {
    this->initializeModel();
}

OAIStatelessRuleGroupReference::~OAIStatelessRuleGroupReference() {}

void OAIStatelessRuleGroupReference::initializeModel() {
...
void OAIStatelessRuleGroupReference::fromJson(QString jsonString) {
...
void OAIStatelessRuleGroupReference::fromJsonObject(QJsonObject json) {
...
QString OAIStatelessRuleGroupReference::asJson() const {
...
QJsonObject OAIStatelessRuleGroupReference::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStatelessRuleGroupReference::getResourceArn() const {
    return m_resource_arn;
}
void OAIStatelessRuleGroupReference::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIStatelessRuleGroupReference::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIStatelessRuleGroupReference::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

qint32 OAIStatelessRuleGroupReference::getPriority() const {
    return m_priority;
}
void OAIStatelessRuleGroupReference::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIStatelessRuleGroupReference::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIStatelessRuleGroupReference::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIStatelessRuleGroupReference::isSet() const {
...
bool OAIStatelessRuleGroupReference::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_resource_arn_isValid && m_priority_isValid && true;
}
