...
OAIUpdateFirewallEncryptionConfigurationRequest::OAIUpdateFirewallEncryptionConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallEncryptionConfigurationRequest::OAIUpdateFirewallEncryptionConfigurationRequest() {
    this->initializeModel();
}

OAIUpdateFirewallEncryptionConfigurationRequest::~OAIUpdateFirewallEncryptionConfigurationRequest() {}

void OAIUpdateFirewallEncryptionConfigurationRequest::initializeModel() {
...
void OAIUpdateFirewallEncryptionConfigurationRequest::fromJson(QString jsonString) {
...
void OAIUpdateFirewallEncryptionConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallEncryptionConfigurationRequest::asJson() const {
...
QJsonObject OAIUpdateFirewallEncryptionConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallEncryptionConfigurationRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallEncryptionConfigurationRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateFirewallEncryptionConfigurationRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallEncryptionConfigurationRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallEncryptionConfigurationRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallEncryptionConfigurationRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

OAIEncryptionConfiguration OAIUpdateFirewallEncryptionConfigurationRequest::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIUpdateFirewallEncryptionConfigurationRequest::setEncryptionConfiguration(const OAIEncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

bool OAIUpdateFirewallEncryptionConfigurationRequest::isSet() const {
...
bool OAIUpdateFirewallEncryptionConfigurationRequest::isValid() const {
