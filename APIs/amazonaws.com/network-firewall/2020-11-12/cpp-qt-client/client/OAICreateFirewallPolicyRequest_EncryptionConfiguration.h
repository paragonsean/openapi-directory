...
/*
 * OAICreateFirewallPolicyRequest_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAICreateFirewallPolicyRequest_EncryptionConfiguration_H
#define OAICreateFirewallPolicyRequest_EncryptionConfiguration_H
...
class OAICreateFirewallPolicyRequest_EncryptionConfiguration : public OAIObject {
public:
    OAICreateFirewallPolicyRequest_EncryptionConfiguration();
    OAICreateFirewallPolicyRequest_EncryptionConfiguration(QString json);
    ~OAICreateFirewallPolicyRequest_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallPolicyRequest_EncryptionConfiguration)

#endif // OAICreateFirewallPolicyRequest_EncryptionConfiguration_H
