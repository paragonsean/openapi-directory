...
/*
 * OAIStatefulRuleGroupOverride.h
 *
 * The setting that allows the policy owner to change the behavior of the rule group within a policy. 
 */

#ifndef OAIStatefulRuleGroupOverride_H
#define OAIStatefulRuleGroupOverride_H
...
class OAIStatefulRuleGroupOverride : public OAIObject {
public:
    OAIStatefulRuleGroupOverride();
    OAIStatefulRuleGroupOverride(QString json);
    ~OAIStatefulRuleGroupOverride() override;
    ...
    OAIOverrideAction getAction() const;
    void setAction(const OAIOverrideAction &action);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleGroupOverride)

#endif // OAIStatefulRuleGroupOverride_H
