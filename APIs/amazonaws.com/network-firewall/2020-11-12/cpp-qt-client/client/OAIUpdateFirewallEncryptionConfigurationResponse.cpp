...
OAIUpdateFirewallEncryptionConfigurationResponse::OAIUpdateFirewallEncryptionConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallEncryptionConfigurationResponse::OAIUpdateFirewallEncryptionConfigurationResponse() {
    this->initializeModel();
}

OAIUpdateFirewallEncryptionConfigurationResponse::~OAIUpdateFirewallEncryptionConfigurationResponse() {}

void OAIUpdateFirewallEncryptionConfigurationResponse::initializeModel() {
...
void OAIUpdateFirewallEncryptionConfigurationResponse::fromJson(QString jsonString) {
...
void OAIUpdateFirewallEncryptionConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallEncryptionConfigurationResponse::asJson() const {
...
QJsonObject OAIUpdateFirewallEncryptionConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallEncryptionConfigurationResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallEncryptionConfigurationResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallEncryptionConfigurationResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallEncryptionConfigurationResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIUpdateFirewallEncryptionConfigurationResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallEncryptionConfigurationResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAIEncryptionConfiguration OAIUpdateFirewallEncryptionConfigurationResponse::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIUpdateFirewallEncryptionConfigurationResponse::setEncryptionConfiguration(const OAIEncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

bool OAIUpdateFirewallEncryptionConfigurationResponse::isSet() const {
...
bool OAIUpdateFirewallEncryptionConfigurationResponse::isValid() const {
