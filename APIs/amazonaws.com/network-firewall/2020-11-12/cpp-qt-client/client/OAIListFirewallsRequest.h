...
/*
 * OAIListFirewallsRequest.h
 *
 * 
 */

#ifndef OAIListFirewallsRequest_H
#define OAIListFirewallsRequest_H
...
class OAIListFirewallsRequest : public OAIObject {
public:
    OAIListFirewallsRequest();
    OAIListFirewallsRequest(QString json);
    ~OAIListFirewallsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFirewallsRequest)

#endif // OAIListFirewallsRequest_H
