...
/*
 * OAIStatefulRuleGroupReference.h
 *
 * Identifier for a single stateful rule group, used in a firewall policy to refer to a rule group. 
 */

#ifndef OAIStatefulRuleGroupReference_H
#define OAIStatefulRuleGroupReference_H
...
namespace OpenAPI {
class OAIStatefulRuleGroupReference_Override;

class OAIStatefulRuleGroupReference : public OAIObject {
public:
    OAIStatefulRuleGroupReference();
    OAIStatefulRuleGroupReference(QString json);
    ~OAIStatefulRuleGroupReference() override;
    ...
    OAIStatefulRuleGroupReference_Override getOverride() const;
    void setOverride(const OAIStatefulRuleGroupReference_Override &override);
...
private:
    ...
    OAIStatefulRuleGroupReference_Override m_override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleGroupReference)

#endif // OAIStatefulRuleGroupReference_H
