...
/*
 * OAIRulesSource_RulesSourceList.h
 *
 * 
 */

#ifndef OAIRulesSource_RulesSourceList_H
#define OAIRulesSource_RulesSourceList_H
...
class OAIRulesSource_RulesSourceList : public OAIObject {
public:
    OAIRulesSource_RulesSourceList();
    OAIRulesSource_RulesSourceList(QString json);
    ~OAIRulesSource_RulesSourceList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRulesSource_RulesSourceList)

#endif // OAIRulesSource_RulesSourceList_H
