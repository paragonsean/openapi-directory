...
/*
 * OAIFirewallPolicyResponse_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAIFirewallPolicyResponse_EncryptionConfiguration_H
#define OAIFirewallPolicyResponse_EncryptionConfiguration_H
...
class OAIFirewallPolicyResponse_EncryptionConfiguration : public OAIObject {
public:
    OAIFirewallPolicyResponse_EncryptionConfiguration();
    OAIFirewallPolicyResponse_EncryptionConfiguration(QString json);
    ~OAIFirewallPolicyResponse_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallPolicyResponse_EncryptionConfiguration)

#endif // OAIFirewallPolicyResponse_EncryptionConfiguration_H
