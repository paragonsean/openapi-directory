...
/*
 * OAIUpdateRuleGroupRequest.h
 *
 * 
 */

#ifndef OAIUpdateRuleGroupRequest_H
#define OAIUpdateRuleGroupRequest_H

#include <QJsonObject>

#include "OAICreateRuleGroupRequest_EncryptionConfiguration.h"
#include "OAICreateRuleGroupRequest_RuleGroup.h"
#include "OAICreateRuleGroupRequest_SourceMetadata.h"
...
namespace OpenAPI {
class OAICreateRuleGroupRequest_RuleGroup;
class OAICreateRuleGroupRequest_EncryptionConfiguration;
class OAICreateRuleGroupRequest_SourceMetadata;

class OAIUpdateRuleGroupRequest : public OAIObject {
public:
    OAIUpdateRuleGroupRequest();
    OAIUpdateRuleGroupRequest(QString json);
    ~OAIUpdateRuleGroupRequest() override;
    ...
    OAICreateRuleGroupRequest_RuleGroup getRuleGroup() const;
    void setRuleGroup(const OAICreateRuleGroupRequest_RuleGroup &rule_group);
    ...
    OAICreateRuleGroupRequest_EncryptionConfiguration getEncryptionConfiguration() const;
    void setEncryptionConfiguration(const OAICreateRuleGroupRequest_EncryptionConfiguration &encryption_configuration);
    bool is_encryption_configuration_Set() const;
    bool is_encryption_configuration_Valid() const;

    OAICreateRuleGroupRequest_SourceMetadata getSourceMetadata() const;
    void setSourceMetadata(const OAICreateRuleGroupRequest_SourceMetadata &source_metadata);
...
private:
    ...
    OAICreateRuleGroupRequest_RuleGroup m_rule_group;
    ...
    OAICreateRuleGroupRequest_EncryptionConfiguration m_encryption_configuration;
    bool m_encryption_configuration_isSet;
    bool m_encryption_configuration_isValid;

    OAICreateRuleGroupRequest_SourceMetadata m_source_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuleGroupRequest)

#endif // OAIUpdateRuleGroupRequest_H
