...
/*
 * OAIUpdateFirewallEncryptionConfigurationResponse.h
 *
 * 
 */

#ifndef OAIUpdateFirewallEncryptionConfigurationResponse_H
#define OAIUpdateFirewallEncryptionConfigurationResponse_H
...
class OAIUpdateFirewallEncryptionConfigurationResponse : public OAIObject {
public:
    OAIUpdateFirewallEncryptionConfigurationResponse();
    OAIUpdateFirewallEncryptionConfigurationResponse(QString json);
    ~OAIUpdateFirewallEncryptionConfigurationResponse() override;
    ...
    QString getFirewallArn() const;
    void setFirewallArn(const QString &firewall_arn);
    bool is_firewall_arn_Set() const;
    bool is_firewall_arn_Valid() const;
...
private:
    ...
    QString m_firewall_arn;
    bool m_firewall_arn_isSet;
    bool m_firewall_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallEncryptionConfigurationResponse)

#endif // OAIUpdateFirewallEncryptionConfigurationResponse_H
