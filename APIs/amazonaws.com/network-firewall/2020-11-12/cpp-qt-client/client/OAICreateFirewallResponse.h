...
/*
 * OAICreateFirewallResponse.h
 *
 * 
 */

#ifndef OAICreateFirewallResponse_H
#define OAICreateFirewallResponse_H
...
class OAICreateFirewallResponse : public OAIObject {
public:
    OAICreateFirewallResponse();
    OAICreateFirewallResponse(QString json);
    ~OAICreateFirewallResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallResponse)

#endif // OAICreateFirewallResponse_H
