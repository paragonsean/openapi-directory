...
#include "OAITLSInspectionConfiguration.h"
...
OAITLSInspectionConfiguration::OAITLSInspectionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITLSInspectionConfiguration::OAITLSInspectionConfiguration() {
    this->initializeModel();
}

OAITLSInspectionConfiguration::~OAITLSInspectionConfiguration() {}

void OAITLSInspectionConfiguration::initializeModel() {

    m_server_certificate_configurations_isSet = false;
    m_server_certificate_configurations_isValid = false;
}

void OAITLSInspectionConfiguration::fromJson(QString jsonString) {
...
void OAITLSInspectionConfiguration::fromJsonObject(QJsonObject json) {

    m_server_certificate_configurations_isValid = ::OpenAPI::fromJsonValue(m_server_certificate_configurations, json[QString("ServerCertificateConfigurations")]);
    m_server_certificate_configurations_isSet = !json[QString("ServerCertificateConfigurations")].isNull() && m_server_certificate_configurations_isValid;
}

QString OAITLSInspectionConfiguration::asJson() const {
...
QJsonObject OAITLSInspectionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_server_certificate_configurations.isSet()) {
        obj.insert(QString("ServerCertificateConfigurations"), ::OpenAPI::toJsonValue(m_server_certificate_configurations));
    }
    return obj;
}

QList OAITLSInspectionConfiguration::getServerCertificateConfigurations() const {
    return m_server_certificate_configurations;
}
void OAITLSInspectionConfiguration::setServerCertificateConfigurations(const QList &server_certificate_configurations) {
    m_server_certificate_configurations = server_certificate_configurations;
    m_server_certificate_configurations_isSet = true;
}

bool OAITLSInspectionConfiguration::is_server_certificate_configurations_Set() const{
    return m_server_certificate_configurations_isSet;
}

bool OAITLSInspectionConfiguration::is_server_certificate_configurations_Valid() const{
    return m_server_certificate_configurations_isValid;
}

bool OAITLSInspectionConfiguration::isSet() const {
...
bool OAITLSInspectionConfiguration::isValid() const {
