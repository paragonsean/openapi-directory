...
/*
 * OAIDeleteFirewallResponse.h
 *
 * 
 */

#ifndef OAIDeleteFirewallResponse_H
#define OAIDeleteFirewallResponse_H
...
namespace OpenAPI {
class OAIFirewall;
class OAIFirewallStatus;

class OAIDeleteFirewallResponse : public OAIObject {
public:
    OAIDeleteFirewallResponse();
    OAIDeleteFirewallResponse(QString json);
    ~OAIDeleteFirewallResponse() override;
    ...
    OAIFirewall getFirewall() const;
    void setFirewall(const OAIFirewall &firewall);
    bool is_firewall_Set() const;
    bool is_firewall_Valid() const;

    OAIFirewallStatus getFirewallStatus() const;
    void setFirewallStatus(const OAIFirewallStatus &firewall_status);
...
private:
    ...
    OAIFirewall m_firewall;
    bool m_firewall_isSet;
    bool m_firewall_isValid;

    OAIFirewallStatus m_firewall_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFirewallResponse)

#endif // OAIDeleteFirewallResponse_H
