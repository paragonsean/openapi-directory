...
OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration() {
    this->initializeModel();
}

OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::~OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration() {}

void OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::initializeModel() {

    m_server_certificate_configurations_isSet = false;
    m_server_certificate_configurations_isValid = false;
}

void OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::fromJson(QString jsonString) {
...
void OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::asJson() const {
...
QJsonObject OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::getServerCertificateConfigurations() const {
    return m_server_certificate_configurations;
}
void OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::setServerCertificateConfigurations(const QList &server_certificate_configurations) {
    m_server_certificate_configurations = server_certificate_configurations;
    m_server_certificate_configurations_isSet = true;
}

bool OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::is_server_certificate_configurations_Set() const{
    return m_server_certificate_configurations_isSet;
}

bool OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::is_server_certificate_configurations_Valid() const{
    return m_server_certificate_configurations_isValid;
}

bool OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::isSet() const {
...
bool OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration::isValid() const {
