...
OAIUpdateFirewallDescriptionRequest::OAIUpdateFirewallDescriptionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallDescriptionRequest::OAIUpdateFirewallDescriptionRequest() {
    this->initializeModel();
}

OAIUpdateFirewallDescriptionRequest::~OAIUpdateFirewallDescriptionRequest() {}

void OAIUpdateFirewallDescriptionRequest::initializeModel() {
...
void OAIUpdateFirewallDescriptionRequest::fromJson(QString jsonString) {
...
void OAIUpdateFirewallDescriptionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallDescriptionRequest::asJson() const {
...
QJsonObject OAIUpdateFirewallDescriptionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallDescriptionRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallDescriptionRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallDescriptionRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallDescriptionRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateFirewallDescriptionRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallDescriptionRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallDescriptionRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallDescriptionRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallDescriptionRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallDescriptionRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallDescriptionRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallDescriptionRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIUpdateFirewallDescriptionRequest::getDescription() const {
    return m_description;
}
void OAIUpdateFirewallDescriptionRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFirewallDescriptionRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFirewallDescriptionRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIUpdateFirewallDescriptionRequest::isSet() const {
...
bool OAIUpdateFirewallDescriptionRequest::isValid() const {
