...
/*
 * OAIUpdateFirewallDeleteProtectionRequest.h
 *
 * 
 */

#ifndef OAIUpdateFirewallDeleteProtectionRequest_H
#define OAIUpdateFirewallDeleteProtectionRequest_H
...
class OAIUpdateFirewallDeleteProtectionRequest : public OAIObject {
public:
    OAIUpdateFirewallDeleteProtectionRequest();
    OAIUpdateFirewallDeleteProtectionRequest(QString json);
    ~OAIUpdateFirewallDeleteProtectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallDeleteProtectionRequest)

#endif // OAIUpdateFirewallDeleteProtectionRequest_H
