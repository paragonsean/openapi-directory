...
#ifndef OAIStatelessRule_H
#define OAIStatelessRule_H

#include <QJsonObject>

#include "OAIStatelessRule_RuleDefinition.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStatelessRule_RuleDefinition;

class OAIStatelessRule : public OAIObject {
public:
    OAIStatelessRule();
    OAIStatelessRule(QString json);
    ~OAIStatelessRule() override;
    ...
    OAIStatelessRule_RuleDefinition getRuleDefinition() const;
    void setRuleDefinition(const OAIStatelessRule_RuleDefinition &rule_definition);
...
private:
    ...
    OAIStatelessRule_RuleDefinition m_rule_definition;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessRule)

#endif // OAIStatelessRule_H
