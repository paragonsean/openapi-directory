...
/*
 * OAIStatelessRule_RuleDefinition.h
 *
 * 
 */

#ifndef OAIStatelessRule_RuleDefinition_H
#define OAIStatelessRule_RuleDefinition_H

#include <QJsonObject>

#include "OAIRuleDefinition_MatchAttributes.h"
#include <QList>
...
namespace OpenAPI {
class OAIRuleDefinition_MatchAttributes;

class OAIStatelessRule_RuleDefinition : public OAIObject {
public:
    OAIStatelessRule_RuleDefinition();
    OAIStatelessRule_RuleDefinition(QString json);
    ~OAIStatelessRule_RuleDefinition() override;
    ...
    OAIRuleDefinition_MatchAttributes getMatchAttributes() const;
    void setMatchAttributes(const OAIRuleDefinition_MatchAttributes &match_attributes);
    bool is_match_attributes_Set() const;
    bool is_match_attributes_Valid() const;
...
private:
    ...
    OAIRuleDefinition_MatchAttributes m_match_attributes;
    bool m_match_attributes_isSet;
    bool m_match_attributes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessRule_RuleDefinition)

#endif // OAIStatelessRule_RuleDefinition_H
