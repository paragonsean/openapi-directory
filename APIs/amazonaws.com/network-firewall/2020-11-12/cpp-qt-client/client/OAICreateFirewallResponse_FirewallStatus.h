...
/*
 * OAICreateFirewallResponse_FirewallStatus.h
 *
 * 
 */

#ifndef OAICreateFirewallResponse_FirewallStatus_H
#define OAICreateFirewallResponse_FirewallStatus_H

#include <QJsonObject>

#include "OAIConfigurationSyncState.h"
#include "OAIFirewallStatusValue.h"
#include "OAIFirewallStatus_CapacityUsageSummary.h"
#include <QMap>
...
namespace OpenAPI {
class OAIFirewallStatus_CapacityUsageSummary;

class OAICreateFirewallResponse_FirewallStatus : public OAIObject {
public:
    OAICreateFirewallResponse_FirewallStatus();
    OAICreateFirewallResponse_FirewallStatus(QString json);
    ~OAICreateFirewallResponse_FirewallStatus() override;
    ...
    OAIFirewallStatusValue getStatus() const;
    void setStatus(const OAIFirewallStatusValue &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    OAIConfigurationSyncState getConfigurationSyncStateSummary() const;
    void setConfigurationSyncStateSummary(const OAIConfigurationSyncState &configuration_sync_state_summary);
    bool is_configuration_sync_state_summary_Set() const;
    bool is_configuration_sync_state_summary_Valid() const;

    QMap getSyncStates() const;
    void setSyncStates(const QMap &sync_states);
    bool is_sync_states_Set() const;
    bool is_sync_states_Valid() const;

    OAIFirewallStatus_CapacityUsageSummary getCapacityUsageSummary() const;
    void setCapacityUsageSummary(const OAIFirewallStatus_CapacityUsageSummary &capacity_usage_summary);
    bool is_capacity_usage_summary_Set() const;
    bool is_capacity_usage_summary_Valid() const;
...
private:
    ...
    OAIFirewallStatusValue m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIConfigurationSyncState m_configuration_sync_state_summary;
    bool m_configuration_sync_state_summary_isSet;
    bool m_configuration_sync_state_summary_isValid;

    QMap m_sync_states;
    bool m_sync_states_isSet;
    bool m_sync_states_isValid;

    OAIFirewallStatus_CapacityUsageSummary m_capacity_usage_summary;
    bool m_capacity_usage_summary_isSet;
    bool m_capacity_usage_summary_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallResponse_FirewallStatus)

#endif // OAICreateFirewallResponse_FirewallStatus_H
