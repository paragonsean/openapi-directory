...
OAIPolicyVariables::OAIPolicyVariables(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyVariables::OAIPolicyVariables() {
    this->initializeModel();
}

OAIPolicyVariables::~OAIPolicyVariables() {}

void OAIPolicyVariables::initializeModel() {

    m_rule_variables_isSet = false;
    m_rule_variables_isValid = false;
}

void OAIPolicyVariables::fromJson(QString jsonString) {
...
void OAIPolicyVariables::fromJsonObject(QJsonObject json) {

    m_rule_variables_isValid = ::OpenAPI::fromJsonValue(m_rule_variables, json[QString("RuleVariables")]);
    m_rule_variables_isSet = !json[QString("RuleVariables")].isNull() && m_rule_variables_isValid;
}

QString OAIPolicyVariables::asJson() const {
...
QJsonObject OAIPolicyVariables::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_variables.isSet()) {
        obj.insert(QString("RuleVariables"), ::OpenAPI::toJsonValue(m_rule_variables));
    }
    return obj;
}

QMap OAIPolicyVariables::getRuleVariables() const {
    return m_rule_variables;
}
void OAIPolicyVariables::setRuleVariables(const QMap &rule_variables) {
    m_rule_variables = rule_variables;
    m_rule_variables_isSet = true;
}

bool OAIPolicyVariables::is_rule_variables_Set() const{
    return m_rule_variables_isSet;
}

bool OAIPolicyVariables::is_rule_variables_Valid() const{
    return m_rule_variables_isValid;
}

bool OAIPolicyVariables::isSet() const {
...
bool OAIPolicyVariables::isValid() const {
