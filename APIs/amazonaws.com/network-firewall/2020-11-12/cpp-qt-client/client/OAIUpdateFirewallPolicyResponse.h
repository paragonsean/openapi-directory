...
/*
 * OAIUpdateFirewallPolicyResponse.h
 *
 * 
 */

#ifndef OAIUpdateFirewallPolicyResponse_H
#define OAIUpdateFirewallPolicyResponse_H

#include <QJsonObject>

#include "OAICreateFirewallPolicyResponse_FirewallPolicyResponse.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateFirewallPolicyResponse_FirewallPolicyResponse;

class OAIUpdateFirewallPolicyResponse : public OAIObject {
public:
    OAIUpdateFirewallPolicyResponse();
    OAIUpdateFirewallPolicyResponse(QString json);
    ~OAIUpdateFirewallPolicyResponse() override;
    ...
    OAICreateFirewallPolicyResponse_FirewallPolicyResponse getFirewallPolicyResponse() const;
    void setFirewallPolicyResponse(const OAICreateFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response);
    bool is_firewall_policy_response_Set() const;
    bool is_firewall_policy_response_Valid() const;
...
private:
    ...
    OAICreateFirewallPolicyResponse_FirewallPolicyResponse m_firewall_policy_response;
    bool m_firewall_policy_response_isSet;
    bool m_firewall_policy_response_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallPolicyResponse)

#endif // OAIUpdateFirewallPolicyResponse_H
