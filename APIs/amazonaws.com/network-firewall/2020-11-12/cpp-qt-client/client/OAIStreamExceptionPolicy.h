...
/*
 * OAIStreamExceptionPolicy.h
 *
 * 
 */

#ifndef OAIStreamExceptionPolicy_H
#define OAIStreamExceptionPolicy_H
...
class OAIStreamExceptionPolicy : public OAIEnum {
public:
    OAIStreamExceptionPolicy();
    OAIStreamExceptionPolicy(QString json);
    ~OAIStreamExceptionPolicy() override;
    ...
    enum class eOAIStreamExceptionPolicy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DROP, 
        CONTINUE, 
        REJECT
    };
    OAIStreamExceptionPolicy::eOAIStreamExceptionPolicy getValue() const;
    void setValue(const OAIStreamExceptionPolicy::eOAIStreamExceptionPolicy& value);
...
private:
    ...
    eOAIStreamExceptionPolicy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamExceptionPolicy)

#endif // OAIStreamExceptionPolicy_H
