...
#ifndef OAIReferenceSets_H
#define OAIReferenceSets_H
...
class OAIReferenceSets : public OAIObject {
public:
    OAIReferenceSets();
    OAIReferenceSets(QString json);
    ~OAIReferenceSets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceSets)

#endif // OAIReferenceSets_H
