...
/*
 * OAIRuleGroup_RulesSource.h
 *
 * 
 */

#ifndef OAIRuleGroup_RulesSource_H
#define OAIRuleGroup_RulesSource_H

#include <QJsonObject>

#include "OAIRulesSource_RulesSourceList.h"
...
namespace OpenAPI {
class OAIRulesSource_RulesSourceList;
class OAIRulesSource_StatelessRulesAndCustomActions;

class OAIRuleGroup_RulesSource : public OAIObject {
public:
    OAIRuleGroup_RulesSource();
    OAIRuleGroup_RulesSource(QString json);
    ~OAIRuleGroup_RulesSource() override;
    ...
    QString getRulesString() const;
    void setRulesString(const QString &rules_string);
    bool is_rules_string_Set() const;
    bool is_rules_string_Valid() const;

    OAIRulesSource_RulesSourceList getRulesSourceList() const;
    void setRulesSourceList(const OAIRulesSource_RulesSourceList &rules_source_list);
    bool is_rules_source_list_Set() const;
    bool is_rules_source_list_Valid() const;

    QList getStatefulRules() const;
    void setStatefulRules(const QList &stateful_rules);
    bool is_stateful_rules_Set() const;
    bool is_stateful_rules_Valid() const;

    OAIRulesSource_StatelessRulesAndCustomActions getStatelessRulesAndCustomActions() const;
    void setStatelessRulesAndCustomActions(const OAIRulesSource_StatelessRulesAndCustomActions &stateless_rules_and_custom_actions);
    bool is_stateless_rules_and_custom_actions_Set() const;
    bool is_stateless_rules_and_custom_actions_Valid() const;
...
private:
    ...
    QString m_rules_string;
    bool m_rules_string_isSet;
    bool m_rules_string_isValid;

    OAIRulesSource_RulesSourceList m_rules_source_list;
    bool m_rules_source_list_isSet;
    bool m_rules_source_list_isValid;

    QList m_stateful_rules;
    bool m_stateful_rules_isSet;
    bool m_stateful_rules_isValid;

    OAIRulesSource_StatelessRulesAndCustomActions m_stateless_rules_and_custom_actions;
    bool m_stateless_rules_and_custom_actions_isSet;
    bool m_stateless_rules_and_custom_actions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroup_RulesSource)

#endif // OAIRuleGroup_RulesSource_H
