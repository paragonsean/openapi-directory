...
#ifndef OAIOverrideAction_H
#define OAIOverrideAction_H
...
class OAIOverrideAction : public OAIEnum {
public:
    OAIOverrideAction();
    OAIOverrideAction(QString json);
    ~OAIOverrideAction() override;
    ...
    enum class eOAIOverrideAction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DROP_TO_ALERT
    };
    OAIOverrideAction::eOAIOverrideAction getValue() const;
    void setValue(const OAIOverrideAction::eOAIOverrideAction& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOverrideAction)

#endif // OAIOverrideAction_H
