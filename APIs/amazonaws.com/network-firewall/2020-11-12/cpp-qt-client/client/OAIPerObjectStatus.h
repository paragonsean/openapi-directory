...
#ifndef OAIPerObjectStatus_H
#define OAIPerObjectStatus_H
...
class OAIPerObjectStatus : public OAIObject {
public:
    OAIPerObjectStatus();
    OAIPerObjectStatus(QString json);
    ~OAIPerObjectStatus() override;
    ...
    OAIPerObjectSyncStatus getSyncStatus() const;
    void setSyncStatus(const OAIPerObjectSyncStatus &sync_status);
...
private:
    ...
    OAIPerObjectSyncStatus m_sync_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPerObjectStatus)

#endif // OAIPerObjectStatus_H
