...
#ifndef OAITCPFlagField_H
#define OAITCPFlagField_H
...
class OAITCPFlagField : public OAIObject {
public:
    OAITCPFlagField();
    OAITCPFlagField(QString json);
    ~OAITCPFlagField() override;
    ...
    QList getFlags() const;
    void setFlags(const QList &flags);
    bool is_flags_Set() const;
    bool is_flags_Valid() const;

    QList getMasks() const;
    void setMasks(const QList &masks);
    bool is_masks_Set() const;
    bool is_masks_Valid() const;
...
private:
    ...
    QList m_masks;
    bool m_masks_isSet;
    bool m_masks_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITCPFlagField)

#endif // OAITCPFlagField_H
