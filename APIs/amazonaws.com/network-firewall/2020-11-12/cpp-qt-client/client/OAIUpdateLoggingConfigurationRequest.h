...
namespace OpenAPI {
class OAIUpdateLoggingConfigurationRequest_LoggingConfiguration;
...
public:
    ...
    OAIUpdateLoggingConfigurationRequest_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIUpdateLoggingConfigurationRequest_LoggingConfiguration &logging_configuration);
...
private:
    ...
    OAIUpdateLoggingConfigurationRequest_LoggingConfiguration m_logging_configuration;
