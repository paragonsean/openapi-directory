...
#include "OAIFirewall_EncryptionConfiguration.h"
...
OAIFirewall_EncryptionConfiguration::OAIFirewall_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewall_EncryptionConfiguration::OAIFirewall_EncryptionConfiguration() {
    this->initializeModel();
}

OAIFirewall_EncryptionConfiguration::~OAIFirewall_EncryptionConfiguration() {}

void OAIFirewall_EncryptionConfiguration::initializeModel() {
...
void OAIFirewall_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAIFirewall_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFirewall_EncryptionConfiguration::asJson() const {
...
QJsonObject OAIFirewall_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIFirewall_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAIFirewall_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIFirewall_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIFirewall_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAIFirewall_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAIFirewall_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFirewall_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFirewall_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFirewall_EncryptionConfiguration::isSet() const {
...
bool OAIFirewall_EncryptionConfiguration::isValid() const {
