...
/*
 * OAIStatefulRuleProtocol.h
 *
 * 
 */

#ifndef OAIStatefulRuleProtocol_H
#define OAIStatefulRuleProtocol_H
...
class OAIStatefulRuleProtocol : public OAIEnum {
public:
    OAIStatefulRuleProtocol();
    OAIStatefulRuleProtocol(QString json);
    ~OAIStatefulRuleProtocol() override;
    ...
    enum class eOAIStatefulRuleProtocol {
    ...
    OAIStatefulRuleProtocol::eOAIStatefulRuleProtocol getValue() const;
    void setValue(const OAIStatefulRuleProtocol::eOAIStatefulRuleProtocol& value);
...
private:
    ...
    eOAIStatefulRuleProtocol m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleProtocol)

#endif // OAIStatefulRuleProtocol_H
