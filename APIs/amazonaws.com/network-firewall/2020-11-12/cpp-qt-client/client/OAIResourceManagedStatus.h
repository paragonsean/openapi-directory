...
/*
 * OAIResourceManagedStatus.h
 *
 * 
 */

#ifndef OAIResourceManagedStatus_H
#define OAIResourceManagedStatus_H
...
class OAIResourceManagedStatus : public OAIEnum {
public:
    OAIResourceManagedStatus();
    OAIResourceManagedStatus(QString json);
    ~OAIResourceManagedStatus() override;
    ...
    enum class eOAIResourceManagedStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        MANAGED, 
        ACCOUNT
    };
    OAIResourceManagedStatus::eOAIResourceManagedStatus getValue() const;
    void setValue(const OAIResourceManagedStatus::eOAIResourceManagedStatus& value);
...
private:
    ...
    eOAIResourceManagedStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceManagedStatus)

#endif // OAIResourceManagedStatus_H
