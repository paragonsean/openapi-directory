...
/*
 * OAIDescribeFirewallPolicyRequest.h
 *
 * 
 */

#ifndef OAIDescribeFirewallPolicyRequest_H
#define OAIDescribeFirewallPolicyRequest_H
...
class OAIDescribeFirewallPolicyRequest : public OAIObject {
public:
    OAIDescribeFirewallPolicyRequest();
    OAIDescribeFirewallPolicyRequest(QString json);
    ~OAIDescribeFirewallPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFirewallPolicyRequest)

#endif // OAIDescribeFirewallPolicyRequest_H
