...
/*
 * OAIListFirewallsResponse.h
 *
 * 
 */

#ifndef OAIListFirewallsResponse_H
#define OAIListFirewallsResponse_H
...
class OAIListFirewallsResponse : public OAIObject {
public:
    OAIListFirewallsResponse();
    OAIListFirewallsResponse(QString json);
    ~OAIListFirewallsResponse() override;
    ...
    QList getFirewalls() const;
    void setFirewalls(const QList &firewalls);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFirewallsResponse)

#endif // OAIListFirewallsResponse_H
