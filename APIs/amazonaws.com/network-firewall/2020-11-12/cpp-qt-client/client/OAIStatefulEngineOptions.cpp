...
#include "OAIStatefulEngineOptions.h"
...
OAIStatefulEngineOptions::OAIStatefulEngineOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulEngineOptions::OAIStatefulEngineOptions() {
    this->initializeModel();
}

OAIStatefulEngineOptions::~OAIStatefulEngineOptions() {}

void OAIStatefulEngineOptions::initializeModel() {

    m_rule_order_isSet = false;
    m_rule_order_isValid = false;

    m_stream_exception_policy_isSet = false;
    m_stream_exception_policy_isValid = false;
}

void OAIStatefulEngineOptions::fromJson(QString jsonString) {
...
void OAIStatefulEngineOptions::fromJsonObject(QJsonObject json) {
    ...
    m_stream_exception_policy_isValid = ::OpenAPI::fromJsonValue(m_stream_exception_policy, json[QString("StreamExceptionPolicy")]);
    m_stream_exception_policy_isSet = !json[QString("StreamExceptionPolicy")].isNull() && m_stream_exception_policy_isValid;
}

QString OAIStatefulEngineOptions::asJson() const {
...
QJsonObject OAIStatefulEngineOptions::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_order.isSet()) {
        obj.insert(QString("RuleOrder"), ::OpenAPI::toJsonValue(m_rule_order));
    }
    if (m_stream_exception_policy.isSet()) {
        obj.insert(QString("StreamExceptionPolicy"), ::OpenAPI::toJsonValue(m_stream_exception_policy));
    }
    return obj;
}

OAIRuleOrder OAIStatefulEngineOptions::getRuleOrder() const {
    return m_rule_order;
}
void OAIStatefulEngineOptions::setRuleOrder(const OAIRuleOrder &rule_order) {
    m_rule_order = rule_order;
    m_rule_order_isSet = true;
}

bool OAIStatefulEngineOptions::is_rule_order_Set() const{
    return m_rule_order_isSet;
}

bool OAIStatefulEngineOptions::is_rule_order_Valid() const{
    return m_rule_order_isValid;
}

OAIStreamExceptionPolicy OAIStatefulEngineOptions::getStreamExceptionPolicy() const {
    return m_stream_exception_policy;
}
void OAIStatefulEngineOptions::setStreamExceptionPolicy(const OAIStreamExceptionPolicy &stream_exception_policy) {
    m_stream_exception_policy = stream_exception_policy;
    m_stream_exception_policy_isSet = true;
}

bool OAIStatefulEngineOptions::is_stream_exception_policy_Set() const{
    return m_stream_exception_policy_isSet;
}

bool OAIStatefulEngineOptions::is_stream_exception_policy_Valid() const{
    return m_stream_exception_policy_isValid;
}

bool OAIStatefulEngineOptions::isSet() const {
...
bool OAIStatefulEngineOptions::isValid() const {
