...
/*
 * OAIUpdateFirewallPolicyChangeProtectionRequest.h
 *
 * 
 */

#ifndef OAIUpdateFirewallPolicyChangeProtectionRequest_H
#define OAIUpdateFirewallPolicyChangeProtectionRequest_H
...
class OAIUpdateFirewallPolicyChangeProtectionRequest : public OAIObject {
public:
    OAIUpdateFirewallPolicyChangeProtectionRequest();
    OAIUpdateFirewallPolicyChangeProtectionRequest(QString json);
    ~OAIUpdateFirewallPolicyChangeProtectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallPolicyChangeProtectionRequest)

#endif // OAIUpdateFirewallPolicyChangeProtectionRequest_H
