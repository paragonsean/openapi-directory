...
#ifndef OAICIDRSummary_H
#define OAICIDRSummary_H
...
class OAICIDRSummary : public OAIObject {
public:
    OAICIDRSummary();
    OAICIDRSummary(QString json);
    ~OAICIDRSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICIDRSummary)

#endif // OAICIDRSummary_H
