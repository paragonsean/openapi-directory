...
/*
 * OAICreateTLSInspectionConfigurationRequest.h
 *
 * 
 */

#ifndef OAICreateTLSInspectionConfigurationRequest_H
#define OAICreateTLSInspectionConfigurationRequest_H

#include <QJsonObject>

#include "OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration.h"
...
namespace OpenAPI {
class OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration;
class OAIEncryptionConfiguration;

class OAICreateTLSInspectionConfigurationRequest : public OAIObject {
public:
    OAICreateTLSInspectionConfigurationRequest();
    OAICreateTLSInspectionConfigurationRequest(QString json);
    ~OAICreateTLSInspectionConfigurationRequest() override;
    ...
    QString getTlsInspectionConfigurationName() const;
    void setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name);
    bool is_tls_inspection_configuration_name_Set() const;
    bool is_tls_inspection_configuration_name_Valid() const;

    OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration getTlsInspectionConfiguration() const;
    void setTlsInspectionConfiguration(const OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration &tls_inspection_configuration);
    bool is_tls_inspection_configuration_Set() const;
    bool is_tls_inspection_configuration_Valid() const;
...
private:
    ...
    QString m_tls_inspection_configuration_name;
    bool m_tls_inspection_configuration_name_isSet;
    bool m_tls_inspection_configuration_name_isValid;

    OAICreateTLSInspectionConfigurationRequest_TLSInspectionConfiguration m_tls_inspection_configuration;
    bool m_tls_inspection_configuration_isSet;
    bool m_tls_inspection_configuration_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTLSInspectionConfigurationRequest)

#endif // OAICreateTLSInspectionConfigurationRequest_H
