...
#ifndef OAIRulesSourceList_H
#define OAIRulesSourceList_H
...
class OAIRulesSourceList : public OAIObject {
public:
    OAIRulesSourceList();
    OAIRulesSourceList(QString json);
    ~OAIRulesSourceList() override;
    ...
    QList getTargetTypes() const;
    void setTargetTypes(const QList &target_types);
    bool is_target_types_Set() const;
    bool is_target_types_Valid() const;

    OAIGeneratedRulesType getGeneratedRulesType() const;
    void setGeneratedRulesType(const OAIGeneratedRulesType &generated_rules_type);
    bool is_generated_rules_type_Set() const;
    bool is_generated_rules_type_Valid() const;
...
private:
    ...
    QList m_target_types;
    bool m_target_types_isSet;
    bool m_target_types_isValid;

    OAIGeneratedRulesType m_generated_rules_type;
    bool m_generated_rules_type_isSet;
    bool m_generated_rules_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRulesSourceList)

#endif // OAIRulesSourceList_H
