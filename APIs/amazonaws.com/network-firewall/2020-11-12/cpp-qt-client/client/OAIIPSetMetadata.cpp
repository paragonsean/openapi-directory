...
OAIIPSetMetadata::OAIIPSetMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPSetMetadata::OAIIPSetMetadata() {
    this->initializeModel();
}

OAIIPSetMetadata::~OAIIPSetMetadata() {}

void OAIIPSetMetadata::initializeModel() {

    m_resolved_cidr_count_isSet = false;
    m_resolved_cidr_count_isValid = false;
}

void OAIIPSetMetadata::fromJson(QString jsonString) {
...
void OAIIPSetMetadata::fromJsonObject(QJsonObject json) {

    m_resolved_cidr_count_isValid = ::OpenAPI::fromJsonValue(m_resolved_cidr_count, json[QString("ResolvedCIDRCount")]);
    m_resolved_cidr_count_isSet = !json[QString("ResolvedCIDRCount")].isNull() && m_resolved_cidr_count_isValid;
}

QString OAIIPSetMetadata::asJson() const {
...
QJsonObject OAIIPSetMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_resolved_cidr_count_isSet) {
        obj.insert(QString("ResolvedCIDRCount"), ::OpenAPI::toJsonValue(m_resolved_cidr_count));
    }
    return obj;
}

qint32 OAIIPSetMetadata::getResolvedCidrCount() const {
    return m_resolved_cidr_count;
}
void OAIIPSetMetadata::setResolvedCidrCount(const qint32 &resolved_cidr_count) {
    m_resolved_cidr_count = resolved_cidr_count;
    m_resolved_cidr_count_isSet = true;
}

bool OAIIPSetMetadata::is_resolved_cidr_count_Set() const{
    return m_resolved_cidr_count_isSet;
}

bool OAIIPSetMetadata::is_resolved_cidr_count_Valid() const{
    return m_resolved_cidr_count_isValid;
}

bool OAIIPSetMetadata::isSet() const {
...
bool OAIIPSetMetadata::isValid() const {
