...
OAIUpdateFirewallPolicyRequest::OAIUpdateFirewallPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallPolicyRequest::OAIUpdateFirewallPolicyRequest() {
    this->initializeModel();
}

OAIUpdateFirewallPolicyRequest::~OAIUpdateFirewallPolicyRequest() {}

void OAIUpdateFirewallPolicyRequest::initializeModel() {
...
void OAIUpdateFirewallPolicyRequest::fromJson(QString jsonString) {
...
void OAIUpdateFirewallPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallPolicyRequest::asJson() const {
...
QJsonObject OAIUpdateFirewallPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallPolicyRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallPolicyRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateFirewallPolicyRequest::getFirewallPolicyArn() const {
    return m_firewall_policy_arn;
}
void OAIUpdateFirewallPolicyRequest::setFirewallPolicyArn(const QString &firewall_policy_arn) {
    m_firewall_policy_arn = firewall_policy_arn;
    m_firewall_policy_arn_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_arn_Set() const{
    return m_firewall_policy_arn_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_arn_Valid() const{
    return m_firewall_policy_arn_isValid;
}

QString OAIUpdateFirewallPolicyRequest::getFirewallPolicyName() const {
    return m_firewall_policy_name;
}
void OAIUpdateFirewallPolicyRequest::setFirewallPolicyName(const QString &firewall_policy_name) {
    m_firewall_policy_name = firewall_policy_name;
    m_firewall_policy_name_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_name_Set() const{
    return m_firewall_policy_name_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_name_Valid() const{
    return m_firewall_policy_name_isValid;
}

OAIUpdateFirewallPolicyRequest_FirewallPolicy OAIUpdateFirewallPolicyRequest::getFirewallPolicy() const {
    return m_firewall_policy;
}
void OAIUpdateFirewallPolicyRequest::setFirewallPolicy(const OAIUpdateFirewallPolicyRequest_FirewallPolicy &firewall_policy) {
    m_firewall_policy = firewall_policy;
    m_firewall_policy_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_Set() const{
    return m_firewall_policy_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_firewall_policy_Valid() const{
    return m_firewall_policy_isValid;
}

QString OAIUpdateFirewallPolicyRequest::getDescription() const {
    return m_description;
}
void OAIUpdateFirewallPolicyRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIUpdateFirewallPolicyRequest::getDryRun() const {
    return m_dry_run;
}
void OAIUpdateFirewallPolicyRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

OAICreateFirewallPolicyRequest_EncryptionConfiguration OAIUpdateFirewallPolicyRequest::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIUpdateFirewallPolicyRequest::setEncryptionConfiguration(const OAICreateFirewallPolicyRequest_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIUpdateFirewallPolicyRequest::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIUpdateFirewallPolicyRequest::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

bool OAIUpdateFirewallPolicyRequest::isSet() const {
...
bool OAIUpdateFirewallPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_update_token_isValid && m_firewall_policy_isValid && true;
}
