...
/*
 * OAIAttachmentStatus.h
 *
 * 
 */

#ifndef OAIAttachmentStatus_H
#define OAIAttachmentStatus_H
...
class OAIAttachmentStatus : public OAIEnum {
public:
    OAIAttachmentStatus();
    OAIAttachmentStatus(QString json);
    ~OAIAttachmentStatus() override;
    ...
    enum class eOAIAttachmentStatus {
    ...
    OAIAttachmentStatus::eOAIAttachmentStatus getValue() const;
    void setValue(const OAIAttachmentStatus::eOAIAttachmentStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentStatus)

#endif // OAIAttachmentStatus_H
