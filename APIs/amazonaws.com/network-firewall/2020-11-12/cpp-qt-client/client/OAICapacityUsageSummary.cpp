...
#include "OAICapacityUsageSummary.h"
...
OAICapacityUsageSummary::OAICapacityUsageSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICapacityUsageSummary::OAICapacityUsageSummary() {
    this->initializeModel();
}

OAICapacityUsageSummary::~OAICapacityUsageSummary() {}

void OAICapacityUsageSummary::initializeModel() {

    m_cidrs_isSet = false;
    m_cidrs_isValid = false;
}

void OAICapacityUsageSummary::fromJson(QString jsonString) {
...
QJsonObject OAICapacityUsageSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_cidrs.isSet()) {
...
OAICapacityUsageSummary_CIDRs OAICapacityUsageSummary::getCidrs() const {
    return m_cidrs;
}
void OAICapacityUsageSummary::setCidrs(const OAICapacityUsageSummary_CIDRs &cidrs) {
    m_cidrs = cidrs;
    m_cidrs_isSet = true;
}

bool OAICapacityUsageSummary::is_cidrs_Set() const{
    return m_cidrs_isSet;
}

bool OAICapacityUsageSummary::is_cidrs_Valid() const{
    return m_cidrs_isValid;
}

bool OAICapacityUsageSummary::isSet() const {
...
bool OAICapacityUsageSummary::isValid() const {
