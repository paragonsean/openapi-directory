...
void OAIEncryptionType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("CUSTOMER_KMS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionType::CUSTOMER_KMS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AWS_OWNED_KMS_KEY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEncryptionType::AWS_OWNED_KMS_KEY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEncryptionType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEncryptionType::CUSTOMER_KMS:
            val = "CUSTOMER_KMS";
            break;
        case eOAIEncryptionType::AWS_OWNED_KMS_KEY:
