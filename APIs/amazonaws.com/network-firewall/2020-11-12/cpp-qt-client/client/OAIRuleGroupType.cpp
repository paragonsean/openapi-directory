...
OAIRuleGroupType::OAIRuleGroupType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroupType::OAIRuleGroupType() {
    this->initializeModel();
}

OAIRuleGroupType::~OAIRuleGroupType() {}

void OAIRuleGroupType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRuleGroupType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRuleGroupType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("STATELESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRuleGroupType::STATELESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STATEFUL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRuleGroupType::STATEFUL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRuleGroupType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRuleGroupType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRuleGroupType::STATELESS:
            val = "STATELESS";
            break;
        case eOAIRuleGroupType::STATEFUL:
            val = "STATEFUL";
            break;
        default:
            break;
...
QJsonValue OAIRuleGroupType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRuleGroupType::eOAIRuleGroupType OAIRuleGroupType::getValue() const {
    return m_value;
}

void OAIRuleGroupType::setValue(const OAIRuleGroupType::eOAIRuleGroupType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRuleGroupType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRuleGroupType::isValid() const {
