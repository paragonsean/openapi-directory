...
#include "OAITLSInspectionConfigurationMetadata.h"
...
OAITLSInspectionConfigurationMetadata::OAITLSInspectionConfigurationMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITLSInspectionConfigurationMetadata::OAITLSInspectionConfigurationMetadata() {
    this->initializeModel();
}

OAITLSInspectionConfigurationMetadata::~OAITLSInspectionConfigurationMetadata() {}

void OAITLSInspectionConfigurationMetadata::initializeModel() {
...
void OAITLSInspectionConfigurationMetadata::fromJson(QString jsonString) {
...
void OAITLSInspectionConfigurationMetadata::fromJsonObject(QJsonObject json) {
...
QString OAITLSInspectionConfigurationMetadata::asJson() const {
...
QJsonObject OAITLSInspectionConfigurationMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAITLSInspectionConfigurationMetadata::getName() const {
    return m_name;
}
void OAITLSInspectionConfigurationMetadata::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITLSInspectionConfigurationMetadata::is_name_Set() const{
    return m_name_isSet;
}

bool OAITLSInspectionConfigurationMetadata::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITLSInspectionConfigurationMetadata::getArn() const {
    return m_arn;
}
void OAITLSInspectionConfigurationMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAITLSInspectionConfigurationMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAITLSInspectionConfigurationMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAITLSInspectionConfigurationMetadata::isSet() const {
...
bool OAITLSInspectionConfigurationMetadata::isValid() const {
