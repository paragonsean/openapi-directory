...
OAIStatelessRule_RuleDefinition::OAIStatelessRule_RuleDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatelessRule_RuleDefinition::OAIStatelessRule_RuleDefinition() {
    this->initializeModel();
}

OAIStatelessRule_RuleDefinition::~OAIStatelessRule_RuleDefinition() {}

void OAIStatelessRule_RuleDefinition::initializeModel() {
...
void OAIStatelessRule_RuleDefinition::fromJson(QString jsonString) {
...
void OAIStatelessRule_RuleDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIStatelessRule_RuleDefinition::asJson() const {
...
QJsonObject OAIStatelessRule_RuleDefinition::asJsonObject() const {
    QJsonObject obj;
...
OAIRuleDefinition_MatchAttributes OAIStatelessRule_RuleDefinition::getMatchAttributes() const {
    return m_match_attributes;
}
void OAIStatelessRule_RuleDefinition::setMatchAttributes(const OAIRuleDefinition_MatchAttributes &match_attributes) {
    m_match_attributes = match_attributes;
    m_match_attributes_isSet = true;
}

bool OAIStatelessRule_RuleDefinition::is_match_attributes_Set() const{
    return m_match_attributes_isSet;
}

bool OAIStatelessRule_RuleDefinition::is_match_attributes_Valid() const{
    return m_match_attributes_isValid;
}

QList OAIStatelessRule_RuleDefinition::getActions() const {
    return m_actions;
}
void OAIStatelessRule_RuleDefinition::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIStatelessRule_RuleDefinition::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIStatelessRule_RuleDefinition::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIStatelessRule_RuleDefinition::isSet() const {
...
bool OAIStatelessRule_RuleDefinition::isValid() const {
