...
/*
 * OAIDescribeFirewallPolicyResponse.h
 *
 * 
 */

#ifndef OAIDescribeFirewallPolicyResponse_H
#define OAIDescribeFirewallPolicyResponse_H
...
class OAIDescribeFirewallPolicyResponse_FirewallPolicy;

class OAIDescribeFirewallPolicyResponse : public OAIObject {
public:
    OAIDescribeFirewallPolicyResponse();
    OAIDescribeFirewallPolicyResponse(QString json);
    ~OAIDescribeFirewallPolicyResponse() override;
    ...
    OAIDescribeFirewallPolicyResponse_FirewallPolicy getFirewallPolicy() const;
    void setFirewallPolicy(const OAIDescribeFirewallPolicyResponse_FirewallPolicy &firewall_policy);
...
private:
    ...
    OAIDescribeFirewallPolicyResponse_FirewallPolicy m_firewall_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFirewallPolicyResponse)

#endif // OAIDescribeFirewallPolicyResponse_H
