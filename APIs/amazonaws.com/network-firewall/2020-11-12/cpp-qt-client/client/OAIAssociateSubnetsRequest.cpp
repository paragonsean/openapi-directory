...
OAIAssociateSubnetsRequest::OAIAssociateSubnetsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateSubnetsRequest::OAIAssociateSubnetsRequest() {
    this->initializeModel();
}

OAIAssociateSubnetsRequest::~OAIAssociateSubnetsRequest() {}

void OAIAssociateSubnetsRequest::initializeModel() {
...
void OAIAssociateSubnetsRequest::fromJson(QString jsonString) {
...
void OAIAssociateSubnetsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateSubnetsRequest::asJson() const {
...
QJsonObject OAIAssociateSubnetsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateSubnetsRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIAssociateSubnetsRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIAssociateSubnetsRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIAssociateSubnetsRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIAssociateSubnetsRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIAssociateSubnetsRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIAssociateSubnetsRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIAssociateSubnetsRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIAssociateSubnetsRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIAssociateSubnetsRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIAssociateSubnetsRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIAssociateSubnetsRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QList OAIAssociateSubnetsRequest::getSubnetMappings() const {
    return m_subnet_mappings;
}
void OAIAssociateSubnetsRequest::setSubnetMappings(const QList &subnet_mappings) {
    m_subnet_mappings = subnet_mappings;
    m_subnet_mappings_isSet = true;
}

bool OAIAssociateSubnetsRequest::is_subnet_mappings_Set() const{
    return m_subnet_mappings_isSet;
}

bool OAIAssociateSubnetsRequest::is_subnet_mappings_Valid() const{
    return m_subnet_mappings_isValid;
}

bool OAIAssociateSubnetsRequest::isSet() const {
...
bool OAIAssociateSubnetsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_subnet_mappings_isValid && true;
}
