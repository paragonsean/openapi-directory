...
#include "OAIPublishMetricAction.h"
...
OAIPublishMetricAction::OAIPublishMetricAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishMetricAction::OAIPublishMetricAction() {
    this->initializeModel();
}

OAIPublishMetricAction::~OAIPublishMetricAction() {}

void OAIPublishMetricAction::initializeModel() {

    m_dimensions_isSet = false;
    m_dimensions_isValid = false;
}

void OAIPublishMetricAction::fromJson(QString jsonString) {
...
void OAIPublishMetricAction::fromJsonObject(QJsonObject json) {

    m_dimensions_isValid = ::OpenAPI::fromJsonValue(m_dimensions, json[QString("Dimensions")]);
    m_dimensions_isSet = !json[QString("Dimensions")].isNull() && m_dimensions_isValid;
}

QString OAIPublishMetricAction::asJson() const {
...
QJsonObject OAIPublishMetricAction::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPublishMetricAction::getDimensions() const {
    return m_dimensions;
}
void OAIPublishMetricAction::setDimensions(const QList &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIPublishMetricAction::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIPublishMetricAction::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

bool OAIPublishMetricAction::isSet() const {
...
bool OAIPublishMetricAction::isValid() const {
