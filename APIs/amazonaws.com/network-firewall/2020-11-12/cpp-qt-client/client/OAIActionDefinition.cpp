...
OAIActionDefinition::OAIActionDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionDefinition::OAIActionDefinition() {
    this->initializeModel();
}

OAIActionDefinition::~OAIActionDefinition() {}

void OAIActionDefinition::initializeModel() {

    m_publish_metric_action_isSet = false;
    m_publish_metric_action_isValid = false;
}

void OAIActionDefinition::fromJson(QString jsonString) {
...
void OAIActionDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIActionDefinition::asJson() const {
...
QJsonObject OAIActionDefinition::asJsonObject() const {
    QJsonObject obj;
...
OAIActionDefinition_PublishMetricAction OAIActionDefinition::getPublishMetricAction() const {
    return m_publish_metric_action;
}
void OAIActionDefinition::setPublishMetricAction(const OAIActionDefinition_PublishMetricAction &publish_metric_action) {
    m_publish_metric_action = publish_metric_action;
    m_publish_metric_action_isSet = true;
}

bool OAIActionDefinition::is_publish_metric_action_Set() const{
    return m_publish_metric_action_isSet;
}

bool OAIActionDefinition::is_publish_metric_action_Valid() const{
    return m_publish_metric_action_isValid;
}

bool OAIActionDefinition::isSet() const {
...
bool OAIActionDefinition::isValid() const {
