...
OAIStatelessRule::OAIStatelessRule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatelessRule::OAIStatelessRule() {
    this->initializeModel();
}

OAIStatelessRule::~OAIStatelessRule() {}

void OAIStatelessRule::initializeModel() {
...
void OAIStatelessRule::fromJson(QString jsonString) {
...
void OAIStatelessRule::fromJsonObject(QJsonObject json) {
...
QString OAIStatelessRule::asJson() const {
...
QJsonObject OAIStatelessRule::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_definition.isSet()) {
...
OAIStatelessRule_RuleDefinition OAIStatelessRule::getRuleDefinition() const {
    return m_rule_definition;
}
void OAIStatelessRule::setRuleDefinition(const OAIStatelessRule_RuleDefinition &rule_definition) {
    m_rule_definition = rule_definition;
    m_rule_definition_isSet = true;
}

bool OAIStatelessRule::is_rule_definition_Set() const{
    return m_rule_definition_isSet;
}

bool OAIStatelessRule::is_rule_definition_Valid() const{
    return m_rule_definition_isValid;
}

qint32 OAIStatelessRule::getPriority() const {
    return m_priority;
}
void OAIStatelessRule::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIStatelessRule::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIStatelessRule::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIStatelessRule::isSet() const {
...
bool OAIStatelessRule::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_rule_definition_isValid && m_priority_isValid && true;
}
