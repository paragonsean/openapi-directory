...
OAIAssociateFirewallPolicyResponse::OAIAssociateFirewallPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateFirewallPolicyResponse::OAIAssociateFirewallPolicyResponse() {
    this->initializeModel();
}

OAIAssociateFirewallPolicyResponse::~OAIAssociateFirewallPolicyResponse() {}

void OAIAssociateFirewallPolicyResponse::initializeModel() {
...
void OAIAssociateFirewallPolicyResponse::fromJson(QString jsonString) {
...
void OAIAssociateFirewallPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateFirewallPolicyResponse::asJson() const {
...
QJsonObject OAIAssociateFirewallPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateFirewallPolicyResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIAssociateFirewallPolicyResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIAssociateFirewallPolicyResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIAssociateFirewallPolicyResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIAssociateFirewallPolicyResponse::getFirewallPolicyArn() const {
    return m_firewall_policy_arn;
}
void OAIAssociateFirewallPolicyResponse::setFirewallPolicyArn(const QString &firewall_policy_arn) {
    m_firewall_policy_arn = firewall_policy_arn;
    m_firewall_policy_arn_isSet = true;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_policy_arn_Set() const{
    return m_firewall_policy_arn_isSet;
}

bool OAIAssociateFirewallPolicyResponse::is_firewall_policy_arn_Valid() const{
    return m_firewall_policy_arn_isValid;
}

QString OAIAssociateFirewallPolicyResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIAssociateFirewallPolicyResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIAssociateFirewallPolicyResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIAssociateFirewallPolicyResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIAssociateFirewallPolicyResponse::isSet() const {
...
bool OAIAssociateFirewallPolicyResponse::isValid() const {
