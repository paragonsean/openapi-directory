...
OAIFirewallPolicy_PolicyVariables::OAIFirewallPolicy_PolicyVariables(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallPolicy_PolicyVariables::OAIFirewallPolicy_PolicyVariables() {
    this->initializeModel();
}

OAIFirewallPolicy_PolicyVariables::~OAIFirewallPolicy_PolicyVariables() {}

void OAIFirewallPolicy_PolicyVariables::initializeModel() {

    m_rule_variables_isSet = false;
    m_rule_variables_isValid = false;
}

void OAIFirewallPolicy_PolicyVariables::fromJson(QString jsonString) {
...
void OAIFirewallPolicy_PolicyVariables::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallPolicy_PolicyVariables::asJson() const {
...
QJsonObject OAIFirewallPolicy_PolicyVariables::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIFirewallPolicy_PolicyVariables::getRuleVariables() const {
    return m_rule_variables;
}
void OAIFirewallPolicy_PolicyVariables::setRuleVariables(const QMap &rule_variables) {
    m_rule_variables = rule_variables;
    m_rule_variables_isSet = true;
}

bool OAIFirewallPolicy_PolicyVariables::is_rule_variables_Set() const{
    return m_rule_variables_isSet;
}

bool OAIFirewallPolicy_PolicyVariables::is_rule_variables_Valid() const{
    return m_rule_variables_isValid;
}

bool OAIFirewallPolicy_PolicyVariables::isSet() const {
...
bool OAIFirewallPolicy_PolicyVariables::isValid() const {
