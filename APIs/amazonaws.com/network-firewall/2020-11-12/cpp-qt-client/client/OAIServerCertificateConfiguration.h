...
/*
 * OAIServerCertificateConfiguration.h
 *
...
#ifndef OAIServerCertificateConfiguration_H
#define OAIServerCertificateConfiguration_H
...
class OAIServerCertificateConfiguration : public OAIObject {
public:
    OAIServerCertificateConfiguration();
    OAIServerCertificateConfiguration(QString json);
    ~OAIServerCertificateConfiguration() override;
    ...
    QList getServerCertificates() const;
    void setServerCertificates(const QList &server_certificates);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerCertificateConfiguration)

#endif // OAIServerCertificateConfiguration_H
