...
/*
 * OAIFirewallStatus_CapacityUsageSummary.h
 *
 * 
 */

#ifndef OAIFirewallStatus_CapacityUsageSummary_H
#define OAIFirewallStatus_CapacityUsageSummary_H
...
class OAIFirewallStatus_CapacityUsageSummary : public OAIObject {
public:
    OAIFirewallStatus_CapacityUsageSummary();
    OAIFirewallStatus_CapacityUsageSummary(QString json);
    ~OAIFirewallStatus_CapacityUsageSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallStatus_CapacityUsageSummary)

#endif // OAIFirewallStatus_CapacityUsageSummary_H
