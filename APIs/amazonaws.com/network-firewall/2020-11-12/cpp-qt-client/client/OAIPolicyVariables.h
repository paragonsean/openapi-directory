...
/*
 * OAIPolicyVariables.h
 *
 * Contains variables that you can use to override default Suricata settings in your firewall policy.
 */

#ifndef OAIPolicyVariables_H
#define OAIPolicyVariables_H
...
class OAIPolicyVariables : public OAIObject {
public:
    OAIPolicyVariables();
    OAIPolicyVariables(QString json);
    ~OAIPolicyVariables() override;
    ...
    QMap getRuleVariables() const;
    void setRuleVariables(const QMap &rule_variables);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyVariables)

#endif // OAIPolicyVariables_H
