...
OAIFirewallPolicy_StatefulEngineOptions::OAIFirewallPolicy_StatefulEngineOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallPolicy_StatefulEngineOptions::OAIFirewallPolicy_StatefulEngineOptions() {
    this->initializeModel();
}

OAIFirewallPolicy_StatefulEngineOptions::~OAIFirewallPolicy_StatefulEngineOptions() {}

void OAIFirewallPolicy_StatefulEngineOptions::initializeModel() {
...
void OAIFirewallPolicy_StatefulEngineOptions::fromJson(QString jsonString) {
...
void OAIFirewallPolicy_StatefulEngineOptions::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallPolicy_StatefulEngineOptions::asJson() const {
...
QJsonObject OAIFirewallPolicy_StatefulEngineOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIRuleOrder OAIFirewallPolicy_StatefulEngineOptions::getRuleOrder() const {
    return m_rule_order;
}
void OAIFirewallPolicy_StatefulEngineOptions::setRuleOrder(const OAIRuleOrder &rule_order) {
    m_rule_order = rule_order;
    m_rule_order_isSet = true;
}

bool OAIFirewallPolicy_StatefulEngineOptions::is_rule_order_Set() const{
    return m_rule_order_isSet;
}

bool OAIFirewallPolicy_StatefulEngineOptions::is_rule_order_Valid() const{
    return m_rule_order_isValid;
}

OAIStreamExceptionPolicy OAIFirewallPolicy_StatefulEngineOptions::getStreamExceptionPolicy() const {
    return m_stream_exception_policy;
}
void OAIFirewallPolicy_StatefulEngineOptions::setStreamExceptionPolicy(const OAIStreamExceptionPolicy &stream_exception_policy) {
    m_stream_exception_policy = stream_exception_policy;
    m_stream_exception_policy_isSet = true;
}

bool OAIFirewallPolicy_StatefulEngineOptions::is_stream_exception_policy_Set() const{
    return m_stream_exception_policy_isSet;
}

bool OAIFirewallPolicy_StatefulEngineOptions::is_stream_exception_policy_Valid() const{
    return m_stream_exception_policy_isValid;
}

bool OAIFirewallPolicy_StatefulEngineOptions::isSet() const {
...
bool OAIFirewallPolicy_StatefulEngineOptions::isValid() const {
