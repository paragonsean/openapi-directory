...
/*
 * OAIDescribeRuleGroupMetadataResponse.h
 *
 * 
 */

#ifndef OAIDescribeRuleGroupMetadataResponse_H
#define OAIDescribeRuleGroupMetadataResponse_H

#include <QJsonObject>

#include "OAIRuleGroupType.h"
#include "OAIStatefulRuleOptions.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIStatefulRuleOptions;

class OAIDescribeRuleGroupMetadataResponse : public OAIObject {
public:
    OAIDescribeRuleGroupMetadataResponse();
    OAIDescribeRuleGroupMetadataResponse(QString json);
    ~OAIDescribeRuleGroupMetadataResponse() override;
    ...
    OAIStatefulRuleOptions getStatefulRuleOptions() const;
    void setStatefulRuleOptions(const OAIStatefulRuleOptions &stateful_rule_options);
...
private:
    ...
    OAIStatefulRuleOptions m_stateful_rule_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleGroupMetadataResponse)

#endif // OAIDescribeRuleGroupMetadataResponse_H
