...
/*
 * OAICapacityUsageSummary.h
 *
 * The capacity usage summary of the resources used by the &lt;a&gt;ReferenceSets&lt;/a&gt; in a firewall.
 */

#ifndef OAICapacityUsageSummary_H
#define OAICapacityUsageSummary_H
...
namespace OpenAPI {
class OAICapacityUsageSummary_CIDRs;

class OAICapacityUsageSummary : public OAIObject {
public:
    OAICapacityUsageSummary();
    OAICapacityUsageSummary(QString json);
    ~OAICapacityUsageSummary() override;
    ...
    OAICapacityUsageSummary_CIDRs getCidrs() const;
    void setCidrs(const OAICapacityUsageSummary_CIDRs &cidrs);
...
private:
    ...
    OAICapacityUsageSummary_CIDRs m_cidrs;
    bool m_cidrs_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICapacityUsageSummary)

#endif // OAICapacityUsageSummary_H
