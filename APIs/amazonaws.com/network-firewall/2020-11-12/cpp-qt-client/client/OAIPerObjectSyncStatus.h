...
/*
 * OAIPerObjectSyncStatus.h
 *
 * 
 */

#ifndef OAIPerObjectSyncStatus_H
#define OAIPerObjectSyncStatus_H
...
class OAIPerObjectSyncStatus : public OAIEnum {
public:
    OAIPerObjectSyncStatus();
    OAIPerObjectSyncStatus(QString json);
    ~OAIPerObjectSyncStatus() override;
    ...
    enum class eOAIPerObjectSyncStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING, 
        IN_SYNC, 
        CAPACITY_CONSTRAINED
    };
    OAIPerObjectSyncStatus::eOAIPerObjectSyncStatus getValue() const;
    void setValue(const OAIPerObjectSyncStatus::eOAIPerObjectSyncStatus& value);
...
private:
    ...
    eOAIPerObjectSyncStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPerObjectSyncStatus)

#endif // OAIPerObjectSyncStatus_H
