...
#include "OAIRuleGroup_RuleVariables.h"
...
OAIRuleGroup_RuleVariables::OAIRuleGroup_RuleVariables(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroup_RuleVariables::OAIRuleGroup_RuleVariables() {
    this->initializeModel();
}

OAIRuleGroup_RuleVariables::~OAIRuleGroup_RuleVariables() {}

void OAIRuleGroup_RuleVariables::initializeModel() {

    m_ip_sets_isSet = false;
    m_ip_sets_isValid = false;

    m_port_sets_isSet = false;
    m_port_sets_isValid = false;
}

void OAIRuleGroup_RuleVariables::fromJson(QString jsonString) {
...
void OAIRuleGroup_RuleVariables::fromJsonObject(QJsonObject json) {
    ...
    m_port_sets_isValid = ::OpenAPI::fromJsonValue(m_port_sets, json[QString("PortSets")]);
    m_port_sets_isSet = !json[QString("PortSets")].isNull() && m_port_sets_isValid;
}

QString OAIRuleGroup_RuleVariables::asJson() const {
...
QJsonObject OAIRuleGroup_RuleVariables::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_sets.isSet()) {
        obj.insert(QString("IPSets"), ::OpenAPI::toJsonValue(m_ip_sets));
    }
    if (m_port_sets.isSet()) {
        obj.insert(QString("PortSets"), ::OpenAPI::toJsonValue(m_port_sets));
    }
    return obj;
}

QMap OAIRuleGroup_RuleVariables::getIpSets() const {
    return m_ip_sets;
}
void OAIRuleGroup_RuleVariables::setIpSets(const QMap &ip_sets) {
    m_ip_sets = ip_sets;
    m_ip_sets_isSet = true;
}

bool OAIRuleGroup_RuleVariables::is_ip_sets_Set() const{
    return m_ip_sets_isSet;
}

bool OAIRuleGroup_RuleVariables::is_ip_sets_Valid() const{
    return m_ip_sets_isValid;
}

QMap OAIRuleGroup_RuleVariables::getPortSets() const {
    return m_port_sets;
}
void OAIRuleGroup_RuleVariables::setPortSets(const QMap &port_sets) {
    m_port_sets = port_sets;
    m_port_sets_isSet = true;
}

bool OAIRuleGroup_RuleVariables::is_port_sets_Set() const{
    return m_port_sets_isSet;
}

bool OAIRuleGroup_RuleVariables::is_port_sets_Valid() const{
    return m_port_sets_isValid;
}

bool OAIRuleGroup_RuleVariables::isSet() const {
...
bool OAIRuleGroup_RuleVariables::isValid() const {
