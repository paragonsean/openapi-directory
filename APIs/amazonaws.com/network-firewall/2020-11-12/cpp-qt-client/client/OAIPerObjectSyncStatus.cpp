...
#include "OAIPerObjectSyncStatus.h"
...
OAIPerObjectSyncStatus::OAIPerObjectSyncStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPerObjectSyncStatus::OAIPerObjectSyncStatus() {
    this->initializeModel();
}

OAIPerObjectSyncStatus::~OAIPerObjectSyncStatus() {}

void OAIPerObjectSyncStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPerObjectSyncStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPerObjectSyncStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPerObjectSyncStatus::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_SYNC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPerObjectSyncStatus::IN_SYNC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CAPACITY_CONSTRAINED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPerObjectSyncStatus::CAPACITY_CONSTRAINED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPerObjectSyncStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPerObjectSyncStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPerObjectSyncStatus::PENDING:
            val = "PENDING";
            break;
        case eOAIPerObjectSyncStatus::IN_SYNC:
            val = "IN_SYNC";
            break;
        case eOAIPerObjectSyncStatus::CAPACITY_CONSTRAINED:
            val = "CAPACITY_CONSTRAINED";
            break;
        default:
            break;
    }
...
QJsonValue OAIPerObjectSyncStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPerObjectSyncStatus::eOAIPerObjectSyncStatus OAIPerObjectSyncStatus::getValue() const {
    return m_value;
}

void OAIPerObjectSyncStatus::setValue(const OAIPerObjectSyncStatus::eOAIPerObjectSyncStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPerObjectSyncStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIPerObjectSyncStatus::isValid() const {
