...
/*
 * OAIDescribeFirewallPolicyResponse_FirewallPolicy.h
 *
 * 
 */

#ifndef OAIDescribeFirewallPolicyResponse_FirewallPolicy_H
#define OAIDescribeFirewallPolicyResponse_FirewallPolicy_H
...
class OAIDescribeFirewallPolicyResponse_FirewallPolicy : public OAIObject {
public:
    OAIDescribeFirewallPolicyResponse_FirewallPolicy();
    OAIDescribeFirewallPolicyResponse_FirewallPolicy(QString json);
    ~OAIDescribeFirewallPolicyResponse_FirewallPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFirewallPolicyResponse_FirewallPolicy)

#endif // OAIDescribeFirewallPolicyResponse_FirewallPolicy_H
