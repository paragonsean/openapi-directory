...
/*
 * OAISyncState_Attachment.h
 *
 * 
 */

#ifndef OAISyncState_Attachment_H
#define OAISyncState_Attachment_H
...
class OAISyncState_Attachment : public OAIObject {
public:
    OAISyncState_Attachment();
    OAISyncState_Attachment(QString json);
    ~OAISyncState_Attachment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyncState_Attachment)

#endif // OAISyncState_Attachment_H
