...
OAICustomAction::OAICustomAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomAction::OAICustomAction() {
    this->initializeModel();
}

OAICustomAction::~OAICustomAction() {}

void OAICustomAction::initializeModel() {

    m_action_name_isSet = false;
    m_action_name_isValid = false;

    m_action_definition_isSet = false;
    m_action_definition_isValid = false;
}

void OAICustomAction::fromJson(QString jsonString) {
...
void OAICustomAction::fromJsonObject(QJsonObject json) {
    ...
    m_action_definition_isValid = ::OpenAPI::fromJsonValue(m_action_definition, json[QString("ActionDefinition")]);
    m_action_definition_isSet = !json[QString("ActionDefinition")].isNull() && m_action_definition_isValid;
}

QString OAICustomAction::asJson() const {
...
QJsonObject OAICustomAction::asJsonObject() const {
    QJsonObject obj;
    if (m_action_name_isSet) {
        obj.insert(QString("ActionName"), ::OpenAPI::toJsonValue(m_action_name));
    }
    if (m_action_definition.isSet()) {
        obj.insert(QString("ActionDefinition"), ::OpenAPI::toJsonValue(m_action_definition));
    }
    return obj;
}

QString OAICustomAction::getActionName() const {
    return m_action_name;
}
void OAICustomAction::setActionName(const QString &action_name) {
    m_action_name = action_name;
    m_action_name_isSet = true;
}

bool OAICustomAction::is_action_name_Set() const{
    return m_action_name_isSet;
}

bool OAICustomAction::is_action_name_Valid() const{
    return m_action_name_isValid;
}

OAICustomAction_ActionDefinition OAICustomAction::getActionDefinition() const {
    return m_action_definition;
}
void OAICustomAction::setActionDefinition(const OAICustomAction_ActionDefinition &action_definition) {
    m_action_definition = action_definition;
    m_action_definition_isSet = true;
}

bool OAICustomAction::is_action_definition_Set() const{
    return m_action_definition_isSet;
}

bool OAICustomAction::is_action_definition_Valid() const{
    return m_action_definition_isValid;
}

bool OAICustomAction::isSet() const {
...
bool OAICustomAction::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_name_isValid && m_action_definition_isValid && true;
}
