...
#ifndef OAIStatefulAction_H
#define OAIStatefulAction_H
...
class OAIStatefulAction : public OAIEnum {
public:
    OAIStatefulAction();
    OAIStatefulAction(QString json);
    ~OAIStatefulAction() override;
    ...
    OAIStatefulAction::eOAIStatefulAction getValue() const;
    void setValue(const OAIStatefulAction::eOAIStatefulAction& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulAction)

#endif // OAIStatefulAction_H
