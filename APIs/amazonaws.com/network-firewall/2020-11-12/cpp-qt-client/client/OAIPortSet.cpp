...
OAIPortSet::OAIPortSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPortSet::OAIPortSet() {
    this->initializeModel();
}

OAIPortSet::~OAIPortSet() {}

void OAIPortSet::initializeModel() {

    m_definition_isSet = false;
    m_definition_isValid = false;
}

void OAIPortSet::fromJson(QString jsonString) {
...
void OAIPortSet::fromJsonObject(QJsonObject json) {

    m_definition_isValid = ::OpenAPI::fromJsonValue(m_definition, json[QString("Definition")]);
    m_definition_isSet = !json[QString("Definition")].isNull() && m_definition_isValid;
}

QString OAIPortSet::asJson() const {
...
QJsonObject OAIPortSet::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPortSet::getDefinition() const {
    return m_definition;
}
void OAIPortSet::setDefinition(const QList &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIPortSet::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIPortSet::is_definition_Valid() const{
    return m_definition_isValid;
}

bool OAIPortSet::isSet() const {
