...
void OAIIPAddressType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("DUALSTACK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIPAddressType::DUALSTACK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IPV4", Qt::CaseInsensitive) == 0) {
...
QString OAIIPAddressType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIIPAddressType::DUALSTACK:
            val = "DUALSTACK";
            break;
