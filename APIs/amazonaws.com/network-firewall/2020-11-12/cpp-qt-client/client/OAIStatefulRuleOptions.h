...
/*
 * OAIStatefulRuleOptions.h
 *
 * Additional options governing how Network Firewall handles the rule group. You can only use these for stateful rule groups.
 */

#ifndef OAIStatefulRuleOptions_H
#define OAIStatefulRuleOptions_H
...
class OAIStatefulRuleOptions : public OAIObject {
public:
    OAIStatefulRuleOptions();
    OAIStatefulRuleOptions(QString json);
    ~OAIStatefulRuleOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleOptions)

#endif // OAIStatefulRuleOptions_H
