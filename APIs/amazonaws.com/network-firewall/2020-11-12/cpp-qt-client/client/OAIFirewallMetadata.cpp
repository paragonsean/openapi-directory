...
OAIFirewallMetadata::OAIFirewallMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallMetadata::OAIFirewallMetadata() {
    this->initializeModel();
}

OAIFirewallMetadata::~OAIFirewallMetadata() {}

void OAIFirewallMetadata::initializeModel() {
...
void OAIFirewallMetadata::fromJson(QString jsonString) {
...
void OAIFirewallMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallMetadata::asJson() const {
...
QJsonObject OAIFirewallMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFirewallMetadata::getFirewallName() const {
    return m_firewall_name;
}
void OAIFirewallMetadata::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIFirewallMetadata::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIFirewallMetadata::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIFirewallMetadata::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIFirewallMetadata::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIFirewallMetadata::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIFirewallMetadata::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

bool OAIFirewallMetadata::isSet() const {
...
bool OAIFirewallMetadata::isValid() const {
