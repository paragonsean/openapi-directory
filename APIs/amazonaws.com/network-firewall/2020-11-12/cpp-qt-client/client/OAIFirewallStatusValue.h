...
/*
 * OAIFirewallStatusValue.h
 *
 * 
 */

#ifndef OAIFirewallStatusValue_H
#define OAIFirewallStatusValue_H
...
class OAIFirewallStatusValue : public OAIEnum {
public:
    OAIFirewallStatusValue();
    OAIFirewallStatusValue(QString json);
    ~OAIFirewallStatusValue() override;
    ...
    enum class eOAIFirewallStatusValue {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PROVISIONING, 
        DELETING, 
        READY
    };
    OAIFirewallStatusValue::eOAIFirewallStatusValue getValue() const;
    void setValue(const OAIFirewallStatusValue::eOAIFirewallStatusValue& value);
...
private:
    ...
    eOAIFirewallStatusValue m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallStatusValue)

#endif // OAIFirewallStatusValue_H
