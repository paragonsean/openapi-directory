...
OAIListFirewallsRequest::OAIListFirewallsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFirewallsRequest::OAIListFirewallsRequest() {
    this->initializeModel();
}

OAIListFirewallsRequest::~OAIListFirewallsRequest() {}

void OAIListFirewallsRequest::initializeModel() {
...
void OAIListFirewallsRequest::fromJson(QString jsonString) {
...
void OAIListFirewallsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListFirewallsRequest::asJson() const {
...
QJsonObject OAIListFirewallsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListFirewallsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListFirewallsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFirewallsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFirewallsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListFirewallsRequest::getVpcIds() const {
    return m_vpc_ids;
}
void OAIListFirewallsRequest::setVpcIds(const QList &vpc_ids) {
    m_vpc_ids = vpc_ids;
    m_vpc_ids_isSet = true;
}

bool OAIListFirewallsRequest::is_vpc_ids_Set() const{
    return m_vpc_ids_isSet;
}

bool OAIListFirewallsRequest::is_vpc_ids_Valid() const{
    return m_vpc_ids_isValid;
}

qint32 OAIListFirewallsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListFirewallsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListFirewallsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListFirewallsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListFirewallsRequest::isSet() const {
...
bool OAIListFirewallsRequest::isValid() const {
