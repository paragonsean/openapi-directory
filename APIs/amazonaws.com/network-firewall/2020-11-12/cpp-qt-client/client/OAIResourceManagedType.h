...
/*
 * OAIResourceManagedType.h
 *
 * 
 */

#ifndef OAIResourceManagedType_H
#define OAIResourceManagedType_H
...
class OAIResourceManagedType : public OAIEnum {
public:
    OAIResourceManagedType();
    OAIResourceManagedType(QString json);
    ~OAIResourceManagedType() override;
    ...
    enum class eOAIResourceManagedType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        THREAT_SIGNATURES, 
        DOMAIN_LISTS
    };
    OAIResourceManagedType::eOAIResourceManagedType getValue() const;
    void setValue(const OAIResourceManagedType::eOAIResourceManagedType& value);
...
private:
    ...
    eOAIResourceManagedType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceManagedType)

#endif // OAIResourceManagedType_H
