...
QString OAIUpdateLoggingConfigurationResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateLoggingConfigurationResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateLoggingConfigurationResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateLoggingConfigurationResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

OAILoggingConfiguration OAIUpdateLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIUpdateLoggingConfigurationResponse::setLoggingConfiguration(const OAILoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIUpdateLoggingConfigurationResponse::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIUpdateLoggingConfigurationResponse::is_logging_configuration_Valid() const{
