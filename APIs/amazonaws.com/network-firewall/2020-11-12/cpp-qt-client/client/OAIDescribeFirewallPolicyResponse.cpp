...
OAIDescribeFirewallPolicyResponse::OAIDescribeFirewallPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFirewallPolicyResponse::OAIDescribeFirewallPolicyResponse() {
    this->initializeModel();
}

OAIDescribeFirewallPolicyResponse::~OAIDescribeFirewallPolicyResponse() {}

void OAIDescribeFirewallPolicyResponse::initializeModel() {

    m_update_token_isSet = false;
    m_update_token_isValid = false;

    m_firewall_policy_response_isSet = false;
    m_firewall_policy_response_isValid = false;

    m_firewall_policy_isSet = false;
    m_firewall_policy_isValid = false;
}

void OAIDescribeFirewallPolicyResponse::fromJson(QString jsonString) {
...
void OAIDescribeFirewallPolicyResponse::fromJsonObject(QJsonObject json) {
    ...
    m_firewall_policy_response_isValid = ::OpenAPI::fromJsonValue(m_firewall_policy_response, json[QString("FirewallPolicyResponse")]);
    m_firewall_policy_response_isSet = !json[QString("FirewallPolicyResponse")].isNull() && m_firewall_policy_response_isValid;
...
QString OAIDescribeFirewallPolicyResponse::asJson() const {
...
QJsonObject OAIDescribeFirewallPolicyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_update_token_isSet) {
        obj.insert(QString("UpdateToken"), ::OpenAPI::toJsonValue(m_update_token));
    }
    if (m_firewall_policy_response.isSet()) {
        obj.insert(QString("FirewallPolicyResponse"), ::OpenAPI::toJsonValue(m_firewall_policy_response));
    }
...
QString OAIDescribeFirewallPolicyResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIDescribeFirewallPolicyResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIDescribeFirewallPolicyResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIDescribeFirewallPolicyResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateFirewallPolicyResponse_FirewallPolicyResponse OAIDescribeFirewallPolicyResponse::getFirewallPolicyResponse() const {
    return m_firewall_policy_response;
}
void OAIDescribeFirewallPolicyResponse::setFirewallPolicyResponse(const OAICreateFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response) {
    m_firewall_policy_response = firewall_policy_response;
    m_firewall_policy_response_isSet = true;
}

bool OAIDescribeFirewallPolicyResponse::is_firewall_policy_response_Set() const{
    return m_firewall_policy_response_isSet;
}

bool OAIDescribeFirewallPolicyResponse::is_firewall_policy_response_Valid() const{
    return m_firewall_policy_response_isValid;
}

OAIDescribeFirewallPolicyResponse_FirewallPolicy OAIDescribeFirewallPolicyResponse::getFirewallPolicy() const {
    return m_firewall_policy;
}
void OAIDescribeFirewallPolicyResponse::setFirewallPolicy(const OAIDescribeFirewallPolicyResponse_FirewallPolicy &firewall_policy) {
    m_firewall_policy = firewall_policy;
    m_firewall_policy_isSet = true;
}

bool OAIDescribeFirewallPolicyResponse::is_firewall_policy_Set() const{
    return m_firewall_policy_isSet;
}

bool OAIDescribeFirewallPolicyResponse::is_firewall_policy_Valid() const{
    return m_firewall_policy_isValid;
}

bool OAIDescribeFirewallPolicyResponse::isSet() const {
...
bool OAIDescribeFirewallPolicyResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_update_token_isValid && m_firewall_policy_response_isValid && true;
}
