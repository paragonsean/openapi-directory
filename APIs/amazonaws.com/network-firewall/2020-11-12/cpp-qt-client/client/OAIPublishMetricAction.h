...
/*
 * OAIPublishMetricAction.h
 *
 * Stateless inspection criteria that publishes the specified metrics to Amazon CloudWatch for the matching packet. This setting defines a CloudWatch dimension value to be published.
 */

#ifndef OAIPublishMetricAction_H
#define OAIPublishMetricAction_H
...
class OAIPublishMetricAction : public OAIObject {
public:
    OAIPublishMetricAction();
    OAIPublishMetricAction(QString json);
    ~OAIPublishMetricAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishMetricAction)

#endif // OAIPublishMetricAction_H
