...
#include "OAIRuleGroupMetadata.h"
...
OAIRuleGroupMetadata::OAIRuleGroupMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroupMetadata::OAIRuleGroupMetadata() {
    this->initializeModel();
}

OAIRuleGroupMetadata::~OAIRuleGroupMetadata() {}

void OAIRuleGroupMetadata::initializeModel() {
...
void OAIRuleGroupMetadata::fromJson(QString jsonString) {
...
void OAIRuleGroupMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIRuleGroupMetadata::asJson() const {
...
QJsonObject OAIRuleGroupMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIRuleGroupMetadata::getName() const {
    return m_name;
}
void OAIRuleGroupMetadata::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRuleGroupMetadata::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRuleGroupMetadata::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRuleGroupMetadata::getArn() const {
    return m_arn;
}
void OAIRuleGroupMetadata::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRuleGroupMetadata::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRuleGroupMetadata::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIRuleGroupMetadata::isSet() const {
...
bool OAIRuleGroupMetadata::isValid() const {
