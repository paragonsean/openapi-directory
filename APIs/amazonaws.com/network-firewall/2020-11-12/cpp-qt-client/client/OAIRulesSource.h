...
#ifndef OAIRulesSource_H
#define OAIRulesSource_H
...
class OAIRulesSource : public OAIObject {
public:
    OAIRulesSource();
    OAIRulesSource(QString json);
    ~OAIRulesSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRulesSource)

#endif // OAIRulesSource_H
