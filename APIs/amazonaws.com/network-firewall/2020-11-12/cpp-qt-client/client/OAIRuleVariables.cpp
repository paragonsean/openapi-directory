...
OAIRuleVariables::OAIRuleVariables(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleVariables::OAIRuleVariables() {
    this->initializeModel();
}

OAIRuleVariables::~OAIRuleVariables() {}

void OAIRuleVariables::initializeModel() {
...
void OAIRuleVariables::fromJson(QString jsonString) {
...
void OAIRuleVariables::fromJsonObject(QJsonObject json) {
...
QString OAIRuleVariables::asJson() const {
...
QJsonObject OAIRuleVariables::asJsonObject() const {
    QJsonObject obj;
    if (m_ip_sets.isSet()) {
...
QMap OAIRuleVariables::getIpSets() const {
    return m_ip_sets;
}
void OAIRuleVariables::setIpSets(const QMap &ip_sets) {
    m_ip_sets = ip_sets;
    m_ip_sets_isSet = true;
}

bool OAIRuleVariables::is_ip_sets_Set() const{
    return m_ip_sets_isSet;
}

bool OAIRuleVariables::is_ip_sets_Valid() const{
    return m_ip_sets_isValid;
}

QMap OAIRuleVariables::getPortSets() const {
    return m_port_sets;
}
void OAIRuleVariables::setPortSets(const QMap &port_sets) {
    m_port_sets = port_sets;
    m_port_sets_isSet = true;
}

bool OAIRuleVariables::is_port_sets_Set() const{
    return m_port_sets_isSet;
}

bool OAIRuleVariables::is_port_sets_Valid() const{
    return m_port_sets_isValid;
}

bool OAIRuleVariables::isSet() const {
...
bool OAIRuleVariables::isValid() const {
