...
/*
 * OAIAssociateSubnetsRequest.h
 *
 * 
 */

#ifndef OAIAssociateSubnetsRequest_H
#define OAIAssociateSubnetsRequest_H
...
class OAIAssociateSubnetsRequest : public OAIObject {
public:
    OAIAssociateSubnetsRequest();
    OAIAssociateSubnetsRequest(QString json);
    ~OAIAssociateSubnetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateSubnetsRequest)

#endif // OAIAssociateSubnetsRequest_H
