...
#ifndef OAIIPSetMetadata_H
#define OAIIPSetMetadata_H
...
class OAIIPSetMetadata : public OAIObject {
public:
    OAIIPSetMetadata();
    OAIIPSetMetadata(QString json);
    ~OAIIPSetMetadata() override;
    ...
    qint32 getResolvedCidrCount() const;
    void setResolvedCidrCount(const qint32 &resolved_cidr_count);
    bool is_resolved_cidr_count_Set() const;
    bool is_resolved_cidr_count_Valid() const;
...
private:
    ...
    qint32 m_resolved_cidr_count;
    bool m_resolved_cidr_count_isSet;
    bool m_resolved_cidr_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIIPSetMetadata)

#endif // OAIIPSetMetadata_H
