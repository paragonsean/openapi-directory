...
QString OAICreateRuleGroupRequest::getRuleGroupName() const {
    return m_rule_group_name;
}
void OAICreateRuleGroupRequest::setRuleGroupName(const QString &rule_group_name) {
    m_rule_group_name = rule_group_name;
    m_rule_group_name_isSet = true;
}

bool OAICreateRuleGroupRequest::is_rule_group_name_Set() const{
    return m_rule_group_name_isSet;
}

bool OAICreateRuleGroupRequest::is_rule_group_name_Valid() const{
    return m_rule_group_name_isValid;
}

OAICreateRuleGroupRequest_RuleGroup OAICreateRuleGroupRequest::getRuleGroup() const {
    return m_rule_group;
}
void OAICreateRuleGroupRequest::setRuleGroup(const OAICreateRuleGroupRequest_RuleGroup &rule_group) {
    m_rule_group = rule_group;
    m_rule_group_isSet = true;
}

bool OAICreateRuleGroupRequest::is_rule_group_Set() const{
    return m_rule_group_isSet;
}

bool OAICreateRuleGroupRequest::is_rule_group_Valid() const{
    return m_rule_group_isValid;
}

QString OAICreateRuleGroupRequest::getRules() const {
    return m_rules;
}
void OAICreateRuleGroupRequest::setRules(const QString &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}

bool OAICreateRuleGroupRequest::is_rules_Set() const{
    return m_rules_isSet;
}

bool OAICreateRuleGroupRequest::is_rules_Valid() const{
    return m_rules_isValid;
}

OAIRuleGroupType OAICreateRuleGroupRequest::getType() const {
    return m_type;
}
void OAICreateRuleGroupRequest::setType(const OAIRuleGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateRuleGroupRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateRuleGroupRequest::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICreateRuleGroupRequest::getDescription() const {
    return m_description;
}
void OAICreateRuleGroupRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateRuleGroupRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateRuleGroupRequest::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAICreateRuleGroupRequest::getCapacity() const {
    return m_capacity;
}
void OAICreateRuleGroupRequest::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAICreateRuleGroupRequest::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAICreateRuleGroupRequest::is_capacity_Valid() const{
...
bool OAICreateRuleGroupRequest::getDryRun() const {
    return m_dry_run;
}
void OAICreateRuleGroupRequest::setDryRun(const bool &dry_run) {
    m_dry_run = dry_run;
    m_dry_run_isSet = true;
}

bool OAICreateRuleGroupRequest::is_dry_run_Set() const{
    return m_dry_run_isSet;
}

bool OAICreateRuleGroupRequest::is_dry_run_Valid() const{
    return m_dry_run_isValid;
}

OAICreateRuleGroupRequest_EncryptionConfiguration OAICreateRuleGroupRequest::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAICreateRuleGroupRequest::setEncryptionConfiguration(const OAICreateRuleGroupRequest_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAICreateRuleGroupRequest::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAICreateRuleGroupRequest::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAICreateRuleGroupRequest_SourceMetadata OAICreateRuleGroupRequest::getSourceMetadata() const {
    return m_source_metadata;
}
void OAICreateRuleGroupRequest::setSourceMetadata(const OAICreateRuleGroupRequest_SourceMetadata &source_metadata) {
    m_source_metadata = source_metadata;
    m_source_metadata_isSet = true;
}

bool OAICreateRuleGroupRequest::is_source_metadata_Set() const{
    return m_source_metadata_isSet;
}

bool OAICreateRuleGroupRequest::is_source_metadata_Valid() const{
...
bool OAICreateRuleGroupRequest::isValid() const {
    ...
    return m_rule_group_name_isValid && m_type_isValid && m_capacity_isValid && true;
}
