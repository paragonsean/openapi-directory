...
void OAIAttachmentStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("CREATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::CREATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SCALING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::SCALING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("READY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttachmentStatus::READY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAttachmentStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAttachmentStatus::CREATING:
            val = "CREATING";
            break;
        case eOAIAttachmentStatus::DELETING:
            val = "DELETING";
            break;
        case eOAIAttachmentStatus::FAILED:
            val = "FAILED";
            break;
        case eOAIAttachmentStatus::ERROR:
            val = "ERROR";
            break;
        case eOAIAttachmentStatus::SCALING:
            val = "SCALING";
            break;
        case eOAIAttachmentStatus::READY:
            val = "READY";
            break;
        default:
            break;
