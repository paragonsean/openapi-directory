...
#ifndef OAIRuleVariables_H
#define OAIRuleVariables_H
...
class OAIRuleVariables : public OAIObject {
public:
    OAIRuleVariables();
    OAIRuleVariables(QString json);
    ~OAIRuleVariables() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleVariables)

#endif // OAIRuleVariables_H
