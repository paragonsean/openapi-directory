...
OAICreateFirewallPolicyResponse::OAICreateFirewallPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallPolicyResponse::OAICreateFirewallPolicyResponse() {
    this->initializeModel();
}

OAICreateFirewallPolicyResponse::~OAICreateFirewallPolicyResponse() {}

void OAICreateFirewallPolicyResponse::initializeModel() {
...
void OAICreateFirewallPolicyResponse::fromJson(QString jsonString) {
...
void OAICreateFirewallPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallPolicyResponse::asJson() const {
...
QJsonObject OAICreateFirewallPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateFirewallPolicyResponse::getUpdateToken() const {
    return m_update_token;
}
void OAICreateFirewallPolicyResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAICreateFirewallPolicyResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAICreateFirewallPolicyResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateFirewallPolicyResponse_FirewallPolicyResponse OAICreateFirewallPolicyResponse::getFirewallPolicyResponse() const {
    return m_firewall_policy_response;
}
void OAICreateFirewallPolicyResponse::setFirewallPolicyResponse(const OAICreateFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response) {
    m_firewall_policy_response = firewall_policy_response;
    m_firewall_policy_response_isSet = true;
}

bool OAICreateFirewallPolicyResponse::is_firewall_policy_response_Set() const{
    return m_firewall_policy_response_isSet;
}

bool OAICreateFirewallPolicyResponse::is_firewall_policy_response_Valid() const{
    return m_firewall_policy_response_isValid;
}

bool OAICreateFirewallPolicyResponse::isSet() const {
...
bool OAICreateFirewallPolicyResponse::isValid() const {
