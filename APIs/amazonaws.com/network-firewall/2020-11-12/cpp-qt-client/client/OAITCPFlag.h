...
class OAITCPFlag : public OAIEnum {
public:
    OAITCPFlag();
    OAITCPFlag(QString json);
    ~OAITCPFlag() override;
    ...
    OAITCPFlag::eOAITCPFlag getValue() const;
    void setValue(const OAITCPFlag::eOAITCPFlag& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITCPFlag)
