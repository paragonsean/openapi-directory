...
#ifndef OAIIPSetReference_H
#define OAIIPSetReference_H
...
class OAIIPSetReference : public OAIObject {
public:
    OAIIPSetReference();
    OAIIPSetReference(QString json);
    ~OAIIPSetReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIPSetReference)

#endif // OAIIPSetReference_H
