...
/*
 * OAIRuleGroupResponse_SourceMetadata.h
 *
 * 
 */

#ifndef OAIRuleGroupResponse_SourceMetadata_H
#define OAIRuleGroupResponse_SourceMetadata_H
...
class OAIRuleGroupResponse_SourceMetadata : public OAIObject {
public:
    OAIRuleGroupResponse_SourceMetadata();
    OAIRuleGroupResponse_SourceMetadata(QString json);
    ~OAIRuleGroupResponse_SourceMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupResponse_SourceMetadata)

#endif // OAIRuleGroupResponse_SourceMetadata_H
