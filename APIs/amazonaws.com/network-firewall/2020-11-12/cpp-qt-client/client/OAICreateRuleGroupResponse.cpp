...
QString OAICreateRuleGroupResponse::getUpdateToken() const {
    return m_update_token;
}
void OAICreateRuleGroupResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAICreateRuleGroupResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAICreateRuleGroupResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateRuleGroupResponse_RuleGroupResponse OAICreateRuleGroupResponse::getRuleGroupResponse() const {
    return m_rule_group_response;
}
void OAICreateRuleGroupResponse::setRuleGroupResponse(const OAICreateRuleGroupResponse_RuleGroupResponse &rule_group_response) {
    m_rule_group_response = rule_group_response;
    m_rule_group_response_isSet = true;
}

bool OAICreateRuleGroupResponse::is_rule_group_response_Set() const{
    return m_rule_group_response_isSet;
}

bool OAICreateRuleGroupResponse::is_rule_group_response_Valid() const{
