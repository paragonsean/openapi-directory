...
OAIRuleGroupResponse_EncryptionConfiguration::OAIRuleGroupResponse_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroupResponse_EncryptionConfiguration::OAIRuleGroupResponse_EncryptionConfiguration() {
    this->initializeModel();
}

OAIRuleGroupResponse_EncryptionConfiguration::~OAIRuleGroupResponse_EncryptionConfiguration() {}

void OAIRuleGroupResponse_EncryptionConfiguration::initializeModel() {
...
void OAIRuleGroupResponse_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAIRuleGroupResponse_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRuleGroupResponse_EncryptionConfiguration::asJson() const {
...
QJsonObject OAIRuleGroupResponse_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIRuleGroupResponse_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAIRuleGroupResponse_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIRuleGroupResponse_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIRuleGroupResponse_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAIRuleGroupResponse_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAIRuleGroupResponse_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRuleGroupResponse_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRuleGroupResponse_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIRuleGroupResponse_EncryptionConfiguration::isSet() const {
...
bool OAIRuleGroupResponse_EncryptionConfiguration::isValid() const {
