...
OAIPerObjectStatus::OAIPerObjectStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPerObjectStatus::OAIPerObjectStatus() {
    this->initializeModel();
}

OAIPerObjectStatus::~OAIPerObjectStatus() {}

void OAIPerObjectStatus::initializeModel() {
...
void OAIPerObjectStatus::fromJson(QString jsonString) {
...
void OAIPerObjectStatus::fromJsonObject(QJsonObject json) {
...
QString OAIPerObjectStatus::asJson() const {
...
QJsonObject OAIPerObjectStatus::asJsonObject() const {
    QJsonObject obj;
...
OAIPerObjectSyncStatus OAIPerObjectStatus::getSyncStatus() const {
    return m_sync_status;
}
void OAIPerObjectStatus::setSyncStatus(const OAIPerObjectSyncStatus &sync_status) {
    m_sync_status = sync_status;
    m_sync_status_isSet = true;
}

bool OAIPerObjectStatus::is_sync_status_Set() const{
    return m_sync_status_isSet;
}

bool OAIPerObjectStatus::is_sync_status_Valid() const{
    return m_sync_status_isValid;
}

QString OAIPerObjectStatus::getUpdateToken() const {
    return m_update_token;
}
void OAIPerObjectStatus::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIPerObjectStatus::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIPerObjectStatus::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIPerObjectStatus::isSet() const {
...
bool OAIPerObjectStatus::isValid() const {
