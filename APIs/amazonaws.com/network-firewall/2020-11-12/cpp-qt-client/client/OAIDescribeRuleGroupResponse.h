...
/*
 * OAIDescribeRuleGroupResponse.h
 *
 * 
 */

#ifndef OAIDescribeRuleGroupResponse_H
#define OAIDescribeRuleGroupResponse_H
...
namespace OpenAPI {
class OAIDescribeRuleGroupResponse_RuleGroup;
class OAICreateRuleGroupResponse_RuleGroupResponse;

class OAIDescribeRuleGroupResponse : public OAIObject {
public:
    OAIDescribeRuleGroupResponse();
    OAIDescribeRuleGroupResponse(QString json);
    ~OAIDescribeRuleGroupResponse() override;
    ...
    OAIDescribeRuleGroupResponse_RuleGroup getRuleGroup() const;
    void setRuleGroup(const OAIDescribeRuleGroupResponse_RuleGroup &rule_group);
    bool is_rule_group_Set() const;
    bool is_rule_group_Valid() const;

    OAICreateRuleGroupResponse_RuleGroupResponse getRuleGroupResponse() const;
    void setRuleGroupResponse(const OAICreateRuleGroupResponse_RuleGroupResponse &rule_group_response);
    bool is_rule_group_response_Set() const;
    bool is_rule_group_response_Valid() const;
...
private:
    ...
    OAIDescribeRuleGroupResponse_RuleGroup m_rule_group;
    bool m_rule_group_isSet;
    bool m_rule_group_isValid;

    OAICreateRuleGroupResponse_RuleGroupResponse m_rule_group_response;
    bool m_rule_group_response_isSet;
    bool m_rule_group_response_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleGroupResponse)

#endif // OAIDescribeRuleGroupResponse_H
