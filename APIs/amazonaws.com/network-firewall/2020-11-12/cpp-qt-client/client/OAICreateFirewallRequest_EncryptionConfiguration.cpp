...
OAICreateFirewallRequest_EncryptionConfiguration::OAICreateFirewallRequest_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallRequest_EncryptionConfiguration::OAICreateFirewallRequest_EncryptionConfiguration() {
    this->initializeModel();
}

OAICreateFirewallRequest_EncryptionConfiguration::~OAICreateFirewallRequest_EncryptionConfiguration() {}

void OAICreateFirewallRequest_EncryptionConfiguration::initializeModel() {
...
void OAICreateFirewallRequest_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAICreateFirewallRequest_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallRequest_EncryptionConfiguration::asJson() const {
...
QJsonObject OAICreateFirewallRequest_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAICreateFirewallRequest_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAICreateFirewallRequest_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAICreateFirewallRequest_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAICreateFirewallRequest_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAICreateFirewallRequest_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAICreateFirewallRequest_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateFirewallRequest_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateFirewallRequest_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateFirewallRequest_EncryptionConfiguration::isSet() const {
...
bool OAICreateFirewallRequest_EncryptionConfiguration::isValid() const {
