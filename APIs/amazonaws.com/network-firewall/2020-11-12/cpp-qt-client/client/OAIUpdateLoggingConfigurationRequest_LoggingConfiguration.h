...
/*
 * OAIUpdateLoggingConfigurationRequest_LoggingConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateLoggingConfigurationRequest_LoggingConfiguration_H
#define OAIUpdateLoggingConfigurationRequest_LoggingConfiguration_H
...
class OAIUpdateLoggingConfigurationRequest_LoggingConfiguration : public OAIObject {
public:
    OAIUpdateLoggingConfigurationRequest_LoggingConfiguration();
    OAIUpdateLoggingConfigurationRequest_LoggingConfiguration(QString json);
    ~OAIUpdateLoggingConfigurationRequest_LoggingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLoggingConfigurationRequest_LoggingConfiguration)

#endif // OAIUpdateLoggingConfigurationRequest_LoggingConfiguration_H
