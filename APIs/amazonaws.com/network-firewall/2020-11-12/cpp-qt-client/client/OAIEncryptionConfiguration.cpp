...
QString OAIEncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAIEncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIEncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIEncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAIEncryptionConfiguration::getType() const {
    return m_type;
}
void OAIEncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEncryptionConfiguration::is_type_Valid() const{
