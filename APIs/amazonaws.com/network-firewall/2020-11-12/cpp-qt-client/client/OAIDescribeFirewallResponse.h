...
/*
 * OAIDescribeFirewallResponse.h
 *
 * 
 */

#ifndef OAIDescribeFirewallResponse_H
#define OAIDescribeFirewallResponse_H

#include <QJsonObject>

#include "OAICreateFirewallResponse_Firewall.h"
#include "OAICreateFirewallResponse_FirewallStatus.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateFirewallResponse_Firewall;
class OAICreateFirewallResponse_FirewallStatus;

class OAIDescribeFirewallResponse : public OAIObject {
public:
    OAIDescribeFirewallResponse();
    OAIDescribeFirewallResponse(QString json);
    ~OAIDescribeFirewallResponse() override;
    ...
    OAICreateFirewallResponse_Firewall getFirewall() const;
    void setFirewall(const OAICreateFirewallResponse_Firewall &firewall);
    bool is_firewall_Set() const;
    bool is_firewall_Valid() const;

    OAICreateFirewallResponse_FirewallStatus getFirewallStatus() const;
    void setFirewallStatus(const OAICreateFirewallResponse_FirewallStatus &firewall_status);
    bool is_firewall_status_Set() const;
    bool is_firewall_status_Valid() const;
...
private:
    ...
    OAICreateFirewallResponse_Firewall m_firewall;
    bool m_firewall_isSet;
    bool m_firewall_isValid;

    OAICreateFirewallResponse_FirewallStatus m_firewall_status;
    bool m_firewall_status_isSet;
    bool m_firewall_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFirewallResponse)

#endif // OAIDescribeFirewallResponse_H
