...
class OAIActionDefinition : public OAIObject {
public:
    OAIActionDefinition();
    OAIActionDefinition(QString json);
    ~OAIActionDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionDefinition)

#endif // OAIActionDefinition_H
