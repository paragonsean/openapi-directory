...
OAICIDRSummary::OAICIDRSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICIDRSummary::OAICIDRSummary() {
    this->initializeModel();
}

OAICIDRSummary::~OAICIDRSummary() {}

void OAICIDRSummary::initializeModel() {
...
void OAICIDRSummary::fromJson(QString jsonString) {
...
void OAICIDRSummary::fromJsonObject(QJsonObject json) {
...
QString OAICIDRSummary::asJson() const {
...
QJsonObject OAICIDRSummary::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAICIDRSummary::getAvailableCidrCount() const {
    return m_available_cidr_count;
}
void OAICIDRSummary::setAvailableCidrCount(const qint32 &available_cidr_count) {
    m_available_cidr_count = available_cidr_count;
    m_available_cidr_count_isSet = true;
}

bool OAICIDRSummary::is_available_cidr_count_Set() const{
    return m_available_cidr_count_isSet;
}

bool OAICIDRSummary::is_available_cidr_count_Valid() const{
    return m_available_cidr_count_isValid;
}

qint32 OAICIDRSummary::getUtilizedCidrCount() const {
    return m_utilized_cidr_count;
}
void OAICIDRSummary::setUtilizedCidrCount(const qint32 &utilized_cidr_count) {
    m_utilized_cidr_count = utilized_cidr_count;
    m_utilized_cidr_count_isSet = true;
}

bool OAICIDRSummary::is_utilized_cidr_count_Set() const{
    return m_utilized_cidr_count_isSet;
}

bool OAICIDRSummary::is_utilized_cidr_count_Valid() const{
    return m_utilized_cidr_count_isValid;
}

QMap OAICIDRSummary::getIpSetReferences() const {
    return m_ip_set_references;
}
void OAICIDRSummary::setIpSetReferences(const QMap &ip_set_references) {
    m_ip_set_references = ip_set_references;
    m_ip_set_references_isSet = true;
}

bool OAICIDRSummary::is_ip_set_references_Set() const{
    return m_ip_set_references_isSet;
}

bool OAICIDRSummary::is_ip_set_references_Valid() const{
    return m_ip_set_references_isValid;
}

bool OAICIDRSummary::isSet() const {
...
bool OAICIDRSummary::isValid() const {
