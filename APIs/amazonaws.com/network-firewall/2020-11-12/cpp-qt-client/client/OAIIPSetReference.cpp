...
OAIIPSetReference::OAIIPSetReference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIPSetReference::OAIIPSetReference() {
    this->initializeModel();
}

OAIIPSetReference::~OAIIPSetReference() {}

void OAIIPSetReference::initializeModel() {

    m_reference_arn_isSet = false;
    m_reference_arn_isValid = false;
}

void OAIIPSetReference::fromJson(QString jsonString) {
...
void OAIIPSetReference::fromJsonObject(QJsonObject json) {
...
QString OAIIPSetReference::asJson() const {
...
QJsonObject OAIIPSetReference::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIPSetReference::getReferenceArn() const {
    return m_reference_arn;
}
void OAIIPSetReference::setReferenceArn(const QString &reference_arn) {
    m_reference_arn = reference_arn;
    m_reference_arn_isSet = true;
}

bool OAIIPSetReference::is_reference_arn_Set() const{
    return m_reference_arn_isSet;
}

bool OAIIPSetReference::is_reference_arn_Valid() const{
    return m_reference_arn_isValid;
}

bool OAIIPSetReference::isSet() const {
...
bool OAIIPSetReference::isValid() const {
