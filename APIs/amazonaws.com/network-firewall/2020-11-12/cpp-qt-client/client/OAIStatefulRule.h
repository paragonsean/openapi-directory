...
#ifndef OAIStatefulRule_H
#define OAIStatefulRule_H

#include <QJsonObject>

#include "OAIStatefulAction.h"
...
namespace OpenAPI {
class OAIStatefulRule_Header;

class OAIStatefulRule : public OAIObject {
public:
    OAIStatefulRule();
    OAIStatefulRule(QString json);
    ~OAIStatefulRule() override;
    ...
    OAIStatefulAction getAction() const;
    void setAction(const OAIStatefulAction &action);
    bool is_action_Set() const;
    bool is_action_Valid() const;

    OAIStatefulRule_Header getHeader() const;
    void setHeader(const OAIStatefulRule_Header &header);
    bool is_header_Set() const;
    bool is_header_Valid() const;

    QList getRuleOptions() const;
    void setRuleOptions(const QList &rule_options);
    bool is_rule_options_Set() const;
    bool is_rule_options_Valid() const;
...
private:
    ...
    OAIStatefulAction m_action;
    bool m_action_isSet;
    bool m_action_isValid;

    OAIStatefulRule_Header m_header;
    bool m_header_isSet;
    bool m_header_isValid;

    QList m_rule_options;
    bool m_rule_options_isSet;
    bool m_rule_options_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRule)

#endif // OAIStatefulRule_H
