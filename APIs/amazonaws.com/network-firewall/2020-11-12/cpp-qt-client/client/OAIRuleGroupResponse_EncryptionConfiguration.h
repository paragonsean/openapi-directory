...
/*
 * OAIRuleGroupResponse_EncryptionConfiguration.h
 *
 * 
 */

#ifndef OAIRuleGroupResponse_EncryptionConfiguration_H
#define OAIRuleGroupResponse_EncryptionConfiguration_H
...
class OAIRuleGroupResponse_EncryptionConfiguration : public OAIObject {
public:
    OAIRuleGroupResponse_EncryptionConfiguration();
    OAIRuleGroupResponse_EncryptionConfiguration(QString json);
    ~OAIRuleGroupResponse_EncryptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupResponse_EncryptionConfiguration)

#endif // OAIRuleGroupResponse_EncryptionConfiguration_H
