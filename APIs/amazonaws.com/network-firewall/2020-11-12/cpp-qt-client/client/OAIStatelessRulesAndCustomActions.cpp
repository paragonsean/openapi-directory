...
#include "OAIStatelessRulesAndCustomActions.h"
...
OAIStatelessRulesAndCustomActions::OAIStatelessRulesAndCustomActions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatelessRulesAndCustomActions::OAIStatelessRulesAndCustomActions() {
    this->initializeModel();
}

OAIStatelessRulesAndCustomActions::~OAIStatelessRulesAndCustomActions() {}

void OAIStatelessRulesAndCustomActions::initializeModel() {
...
void OAIStatelessRulesAndCustomActions::fromJson(QString jsonString) {
...
void OAIStatelessRulesAndCustomActions::fromJsonObject(QJsonObject json) {
...
QString OAIStatelessRulesAndCustomActions::asJson() const {
...
QJsonObject OAIStatelessRulesAndCustomActions::asJsonObject() const {
    QJsonObject obj;
...
QList OAIStatelessRulesAndCustomActions::getStatelessRules() const {
    return m_stateless_rules;
}
void OAIStatelessRulesAndCustomActions::setStatelessRules(const QList &stateless_rules) {
    m_stateless_rules = stateless_rules;
    m_stateless_rules_isSet = true;
}

bool OAIStatelessRulesAndCustomActions::is_stateless_rules_Set() const{
    return m_stateless_rules_isSet;
}

bool OAIStatelessRulesAndCustomActions::is_stateless_rules_Valid() const{
    return m_stateless_rules_isValid;
}

QList OAIStatelessRulesAndCustomActions::getCustomActions() const {
    return m_custom_actions;
}
void OAIStatelessRulesAndCustomActions::setCustomActions(const QList &custom_actions) {
    m_custom_actions = custom_actions;
    m_custom_actions_isSet = true;
}

bool OAIStatelessRulesAndCustomActions::is_custom_actions_Set() const{
    return m_custom_actions_isSet;
}

bool OAIStatelessRulesAndCustomActions::is_custom_actions_Valid() const{
    return m_custom_actions_isValid;
}

bool OAIStatelessRulesAndCustomActions::isSet() const {
...
bool OAIStatelessRulesAndCustomActions::isValid() const {
