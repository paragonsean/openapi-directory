...
OAIDeleteTLSInspectionConfigurationRequest::OAIDeleteTLSInspectionConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTLSInspectionConfigurationRequest::OAIDeleteTLSInspectionConfigurationRequest() {
    this->initializeModel();
}

OAIDeleteTLSInspectionConfigurationRequest::~OAIDeleteTLSInspectionConfigurationRequest() {}

void OAIDeleteTLSInspectionConfigurationRequest::initializeModel() {
...
void OAIDeleteTLSInspectionConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDeleteTLSInspectionConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTLSInspectionConfigurationRequest::asJson() const {
...
QJsonObject OAIDeleteTLSInspectionConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteTLSInspectionConfigurationRequest::getTlsInspectionConfigurationArn() const {
    return m_tls_inspection_configuration_arn;
}
void OAIDeleteTLSInspectionConfigurationRequest::setTlsInspectionConfigurationArn(const QString &tls_inspection_configuration_arn) {
    m_tls_inspection_configuration_arn = tls_inspection_configuration_arn;
    m_tls_inspection_configuration_arn_isSet = true;
}

bool OAIDeleteTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Set() const{
    return m_tls_inspection_configuration_arn_isSet;
}

bool OAIDeleteTLSInspectionConfigurationRequest::is_tls_inspection_configuration_arn_Valid() const{
    return m_tls_inspection_configuration_arn_isValid;
}

QString OAIDeleteTLSInspectionConfigurationRequest::getTlsInspectionConfigurationName() const {
    return m_tls_inspection_configuration_name;
}
void OAIDeleteTLSInspectionConfigurationRequest::setTlsInspectionConfigurationName(const QString &tls_inspection_configuration_name) {
    m_tls_inspection_configuration_name = tls_inspection_configuration_name;
    m_tls_inspection_configuration_name_isSet = true;
}

bool OAIDeleteTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Set() const{
    return m_tls_inspection_configuration_name_isSet;
}

bool OAIDeleteTLSInspectionConfigurationRequest::is_tls_inspection_configuration_name_Valid() const{
    return m_tls_inspection_configuration_name_isValid;
}

bool OAIDeleteTLSInspectionConfigurationRequest::isSet() const {
...
bool OAIDeleteTLSInspectionConfigurationRequest::isValid() const {
