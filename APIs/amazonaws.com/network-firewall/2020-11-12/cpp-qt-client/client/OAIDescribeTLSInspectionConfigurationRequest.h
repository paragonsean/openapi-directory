...
/*
 * OAIDescribeTLSInspectionConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDescribeTLSInspectionConfigurationRequest_H
#define OAIDescribeTLSInspectionConfigurationRequest_H
...
class OAIDescribeTLSInspectionConfigurationRequest : public OAIObject {
public:
    OAIDescribeTLSInspectionConfigurationRequest();
    OAIDescribeTLSInspectionConfigurationRequest(QString json);
    ~OAIDescribeTLSInspectionConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTLSInspectionConfigurationRequest)

#endif // OAIDescribeTLSInspectionConfigurationRequest_H
