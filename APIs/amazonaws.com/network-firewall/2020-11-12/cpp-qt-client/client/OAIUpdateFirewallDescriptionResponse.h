...
/*
 * OAIUpdateFirewallDescriptionResponse.h
 *
 * 
 */

#ifndef OAIUpdateFirewallDescriptionResponse_H
#define OAIUpdateFirewallDescriptionResponse_H
...
class OAIUpdateFirewallDescriptionResponse : public OAIObject {
public:
    OAIUpdateFirewallDescriptionResponse();
    OAIUpdateFirewallDescriptionResponse(QString json);
    ~OAIUpdateFirewallDescriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallDescriptionResponse)

#endif // OAIUpdateFirewallDescriptionResponse_H
