...
#ifndef OAIRuleGroupResponse_H
#define OAIRuleGroupResponse_H
...
class OAIRuleGroupResponse : public OAIObject {
public:
    OAIRuleGroupResponse();
    OAIRuleGroupResponse(QString json);
    ~OAIRuleGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupResponse)

#endif // OAIRuleGroupResponse_H
