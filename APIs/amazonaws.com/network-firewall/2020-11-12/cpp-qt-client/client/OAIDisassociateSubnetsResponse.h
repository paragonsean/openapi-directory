...
/*
 * OAIDisassociateSubnetsResponse.h
 *
 * 
 */

#ifndef OAIDisassociateSubnetsResponse_H
#define OAIDisassociateSubnetsResponse_H
...
class OAIDisassociateSubnetsResponse : public OAIObject {
public:
    OAIDisassociateSubnetsResponse();
    OAIDisassociateSubnetsResponse(QString json);
    ~OAIDisassociateSubnetsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateSubnetsResponse)

#endif // OAIDisassociateSubnetsResponse_H
