...
OAIOverrideAction::OAIOverrideAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOverrideAction::OAIOverrideAction() {
    this->initializeModel();
}

OAIOverrideAction::~OAIOverrideAction() {}

void OAIOverrideAction::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOverrideAction::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOverrideAction::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DROP_TO_ALERT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOverrideAction::DROP_TO_ALERT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOverrideAction::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOverrideAction::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOverrideAction::DROP_TO_ALERT:
            val = "DROP_TO_ALERT";
            break;
        default:
            break;
...
QJsonValue OAIOverrideAction::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOverrideAction::eOAIOverrideAction OAIOverrideAction::getValue() const {
    return m_value;
}

void OAIOverrideAction::setValue(const OAIOverrideAction::eOAIOverrideAction& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOverrideAction::isSet() const {
    
    return m_value_isSet;
}

bool OAIOverrideAction::isValid() const {
