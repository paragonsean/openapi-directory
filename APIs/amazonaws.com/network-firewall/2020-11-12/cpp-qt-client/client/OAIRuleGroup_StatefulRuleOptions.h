...
/*
 * OAIRuleGroup_StatefulRuleOptions.h
 *
 * 
 */

#ifndef OAIRuleGroup_StatefulRuleOptions_H
#define OAIRuleGroup_StatefulRuleOptions_H
...
class OAIRuleGroup_StatefulRuleOptions : public OAIObject {
public:
    OAIRuleGroup_StatefulRuleOptions();
    OAIRuleGroup_StatefulRuleOptions(QString json);
    ~OAIRuleGroup_StatefulRuleOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroup_StatefulRuleOptions)

#endif // OAIRuleGroup_StatefulRuleOptions_H
