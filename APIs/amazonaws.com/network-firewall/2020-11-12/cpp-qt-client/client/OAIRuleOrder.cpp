...
OAIRuleOrder::OAIRuleOrder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleOrder::OAIRuleOrder() {
    this->initializeModel();
}

OAIRuleOrder::~OAIRuleOrder() {}

void OAIRuleOrder::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRuleOrder::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRuleOrder::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DEFAULT_ACTION_ORDER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRuleOrder::DEFAULT_ACTION_ORDER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STRICT_ORDER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRuleOrder::STRICT_ORDER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRuleOrder::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRuleOrder::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRuleOrder::DEFAULT_ACTION_ORDER:
            val = "DEFAULT_ACTION_ORDER";
            break;
        case eOAIRuleOrder::STRICT_ORDER:
            val = "STRICT_ORDER";
            break;
        default:
            break;
...
QJsonValue OAIRuleOrder::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRuleOrder::eOAIRuleOrder OAIRuleOrder::getValue() const {
    return m_value;
}

void OAIRuleOrder::setValue(const OAIRuleOrder::eOAIRuleOrder& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRuleOrder::isSet() const {
    
    return m_value_isSet;
}

bool OAIRuleOrder::isValid() const {
