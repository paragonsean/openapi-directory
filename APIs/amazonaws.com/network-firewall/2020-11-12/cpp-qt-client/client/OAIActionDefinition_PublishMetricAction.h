...
/*
 * OAIActionDefinition_PublishMetricAction.h
 *
 * 
 */

#ifndef OAIActionDefinition_PublishMetricAction_H
#define OAIActionDefinition_PublishMetricAction_H
...
class OAIActionDefinition_PublishMetricAction : public OAIObject {
public:
    OAIActionDefinition_PublishMetricAction();
    OAIActionDefinition_PublishMetricAction(QString json);
    ~OAIActionDefinition_PublishMetricAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionDefinition_PublishMetricAction)

#endif // OAIActionDefinition_PublishMetricAction_H
