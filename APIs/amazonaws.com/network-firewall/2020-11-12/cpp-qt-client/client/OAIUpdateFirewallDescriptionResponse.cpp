...
OAIUpdateFirewallDescriptionResponse::OAIUpdateFirewallDescriptionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallDescriptionResponse::OAIUpdateFirewallDescriptionResponse() {
    this->initializeModel();
}

OAIUpdateFirewallDescriptionResponse::~OAIUpdateFirewallDescriptionResponse() {}

void OAIUpdateFirewallDescriptionResponse::initializeModel() {
...
void OAIUpdateFirewallDescriptionResponse::fromJson(QString jsonString) {
...
void OAIUpdateFirewallDescriptionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallDescriptionResponse::asJson() const {
...
QJsonObject OAIUpdateFirewallDescriptionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallDescriptionResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallDescriptionResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallDescriptionResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallDescriptionResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallDescriptionResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallDescriptionResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallDescriptionResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallDescriptionResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIUpdateFirewallDescriptionResponse::getDescription() const {
    return m_description;
}
void OAIUpdateFirewallDescriptionResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFirewallDescriptionResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFirewallDescriptionResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateFirewallDescriptionResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallDescriptionResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallDescriptionResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallDescriptionResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIUpdateFirewallDescriptionResponse::isSet() const {
...
bool OAIUpdateFirewallDescriptionResponse::isValid() const {
