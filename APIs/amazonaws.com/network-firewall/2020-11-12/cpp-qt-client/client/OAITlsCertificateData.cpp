...
#include "OAITlsCertificateData.h"
...
OAITlsCertificateData::OAITlsCertificateData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITlsCertificateData::OAITlsCertificateData() {
    this->initializeModel();
}

OAITlsCertificateData::~OAITlsCertificateData() {}

void OAITlsCertificateData::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;

    m_certificate_serial_isSet = false;
    m_certificate_serial_isValid = false;
...
void OAITlsCertificateData::fromJson(QString jsonString) {
...
void OAITlsCertificateData::fromJsonObject(QJsonObject json) {
    ...
    m_certificate_serial_isValid = ::OpenAPI::fromJsonValue(m_certificate_serial, json[QString("CertificateSerial")]);
    m_certificate_serial_isSet = !json[QString("CertificateSerial")].isNull() && m_certificate_serial_isValid;
...
QString OAITlsCertificateData::asJson() const {
...
QJsonObject OAITlsCertificateData::asJsonObject() const {
    QJsonObject obj;
    if (m_certificate_arn_isSet) {
        obj.insert(QString("CertificateArn"), ::OpenAPI::toJsonValue(m_certificate_arn));
    }
    if (m_certificate_serial_isSet) {
        obj.insert(QString("CertificateSerial"), ::OpenAPI::toJsonValue(m_certificate_serial));
    }
    if (m_status_isSet) {
...
QString OAITlsCertificateData::getCertificateArn() const {
    return m_certificate_arn;
}
void OAITlsCertificateData::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAITlsCertificateData::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAITlsCertificateData::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

QString OAITlsCertificateData::getCertificateSerial() const {
    return m_certificate_serial;
}
void OAITlsCertificateData::setCertificateSerial(const QString &certificate_serial) {
    m_certificate_serial = certificate_serial;
    m_certificate_serial_isSet = true;
}

bool OAITlsCertificateData::is_certificate_serial_Set() const{
    return m_certificate_serial_isSet;
}

bool OAITlsCertificateData::is_certificate_serial_Valid() const{
    return m_certificate_serial_isValid;
}

QString OAITlsCertificateData::getStatus() const {
    return m_status;
}
void OAITlsCertificateData::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAITlsCertificateData::is_status_Set() const{
    return m_status_isSet;
}

bool OAITlsCertificateData::is_status_Valid() const{
    return m_status_isValid;
}

QString OAITlsCertificateData::getStatusMessage() const {
    return m_status_message;
}
void OAITlsCertificateData::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAITlsCertificateData::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAITlsCertificateData::is_status_message_Valid() const{
    return m_status_message_isValid;
}

bool OAITlsCertificateData::isSet() const {
...
bool OAITlsCertificateData::isValid() const {
