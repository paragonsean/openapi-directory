...
OAICreateRuleGroupResponse_RuleGroupResponse OAIDeleteRuleGroupResponse::getRuleGroupResponse() const {
    return m_rule_group_response;
}
void OAIDeleteRuleGroupResponse::setRuleGroupResponse(const OAICreateRuleGroupResponse_RuleGroupResponse &rule_group_response) {
    m_rule_group_response = rule_group_response;
    m_rule_group_response_isSet = true;
}

bool OAIDeleteRuleGroupResponse::is_rule_group_response_Set() const{
    return m_rule_group_response_isSet;
}

bool OAIDeleteRuleGroupResponse::is_rule_group_response_Valid() const{
...
bool OAIDeleteRuleGroupResponse::isValid() const {
    ...
    return m_rule_group_response_isValid && true;
}
