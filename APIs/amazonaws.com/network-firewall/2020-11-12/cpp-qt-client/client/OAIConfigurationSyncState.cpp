...
OAIConfigurationSyncState::OAIConfigurationSyncState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfigurationSyncState::OAIConfigurationSyncState() {
    this->initializeModel();
}

OAIConfigurationSyncState::~OAIConfigurationSyncState() {}

void OAIConfigurationSyncState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIConfigurationSyncState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIConfigurationSyncState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PENDING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationSyncState::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IN_SYNC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationSyncState::IN_SYNC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CAPACITY_CONSTRAINED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIConfigurationSyncState::CAPACITY_CONSTRAINED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIConfigurationSyncState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIConfigurationSyncState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIConfigurationSyncState::PENDING:
            val = "PENDING";
            break;
        case eOAIConfigurationSyncState::IN_SYNC:
            val = "IN_SYNC";
            break;
        case eOAIConfigurationSyncState::CAPACITY_CONSTRAINED:
...
QJsonValue OAIConfigurationSyncState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIConfigurationSyncState::eOAIConfigurationSyncState OAIConfigurationSyncState::getValue() const {
    return m_value;
}

void OAIConfigurationSyncState::setValue(const OAIConfigurationSyncState::eOAIConfigurationSyncState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIConfigurationSyncState::isSet() const {
    
    return m_value_isSet;
}

bool OAIConfigurationSyncState::isValid() const {
