...
OAICreateTLSInspectionConfigurationResponse::OAICreateTLSInspectionConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTLSInspectionConfigurationResponse::OAICreateTLSInspectionConfigurationResponse() {
    this->initializeModel();
}

OAICreateTLSInspectionConfigurationResponse::~OAICreateTLSInspectionConfigurationResponse() {}

void OAICreateTLSInspectionConfigurationResponse::initializeModel() {
...
void OAICreateTLSInspectionConfigurationResponse::fromJson(QString jsonString) {
...
void OAICreateTLSInspectionConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateTLSInspectionConfigurationResponse::asJson() const {
...
QJsonObject OAICreateTLSInspectionConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateTLSInspectionConfigurationResponse::getUpdateToken() const {
    return m_update_token;
}
void OAICreateTLSInspectionConfigurationResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAICreateTLSInspectionConfigurationResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse OAICreateTLSInspectionConfigurationResponse::getTlsInspectionConfigurationResponse() const {
    return m_tls_inspection_configuration_response;
}
void OAICreateTLSInspectionConfigurationResponse::setTlsInspectionConfigurationResponse(const OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse &tls_inspection_configuration_response) {
...
bool OAICreateTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Set() const{
    return m_tls_inspection_configuration_response_isSet;
}

bool OAICreateTLSInspectionConfigurationResponse::is_tls_inspection_configuration_response_Valid() const{
    return m_tls_inspection_configuration_response_isValid;
}

bool OAICreateTLSInspectionConfigurationResponse::isSet() const {
...
bool OAICreateTLSInspectionConfigurationResponse::isValid() const {
