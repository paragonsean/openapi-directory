...
OAIDescribeFirewallRequest::OAIDescribeFirewallRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFirewallRequest::OAIDescribeFirewallRequest() {
    this->initializeModel();
}

OAIDescribeFirewallRequest::~OAIDescribeFirewallRequest() {}

void OAIDescribeFirewallRequest::initializeModel() {
...
void OAIDescribeFirewallRequest::fromJson(QString jsonString) {
...
void OAIDescribeFirewallRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFirewallRequest::asJson() const {
...
QJsonObject OAIDescribeFirewallRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeFirewallRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIDescribeFirewallRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIDescribeFirewallRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIDescribeFirewallRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIDescribeFirewallRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDescribeFirewallRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDescribeFirewallRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDescribeFirewallRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

bool OAIDescribeFirewallRequest::isSet() const {
...
bool OAIDescribeFirewallRequest::isValid() const {
