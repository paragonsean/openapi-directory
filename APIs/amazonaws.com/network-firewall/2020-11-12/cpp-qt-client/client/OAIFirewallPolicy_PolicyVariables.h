...
/*
 * OAIFirewallPolicy_PolicyVariables.h
 *
 * 
 */

#ifndef OAIFirewallPolicy_PolicyVariables_H
#define OAIFirewallPolicy_PolicyVariables_H
...
class OAIFirewallPolicy_PolicyVariables : public OAIObject {
public:
    OAIFirewallPolicy_PolicyVariables();
    OAIFirewallPolicy_PolicyVariables(QString json);
    ~OAIFirewallPolicy_PolicyVariables() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallPolicy_PolicyVariables)

#endif // OAIFirewallPolicy_PolicyVariables_H
