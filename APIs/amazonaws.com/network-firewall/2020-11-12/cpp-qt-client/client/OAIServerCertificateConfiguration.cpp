...
#include "OAIServerCertificateConfiguration.h"
...
OAIServerCertificateConfiguration::OAIServerCertificateConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerCertificateConfiguration::OAIServerCertificateConfiguration() {
    this->initializeModel();
}

OAIServerCertificateConfiguration::~OAIServerCertificateConfiguration() {}

void OAIServerCertificateConfiguration::initializeModel() {
...
void OAIServerCertificateConfiguration::fromJson(QString jsonString) {
...
void OAIServerCertificateConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIServerCertificateConfiguration::asJson() const {
...
QJsonObject OAIServerCertificateConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_server_certificates.isSet()) {
...
QList OAIServerCertificateConfiguration::getServerCertificates() const {
    return m_server_certificates;
}
void OAIServerCertificateConfiguration::setServerCertificates(const QList &server_certificates) {
    m_server_certificates = server_certificates;
    m_server_certificates_isSet = true;
}

bool OAIServerCertificateConfiguration::is_server_certificates_Set() const{
    return m_server_certificates_isSet;
}

bool OAIServerCertificateConfiguration::is_server_certificates_Valid() const{
    return m_server_certificates_isValid;
}

QList OAIServerCertificateConfiguration::getScopes() const {
    return m_scopes;
}
void OAIServerCertificateConfiguration::setScopes(const QList &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIServerCertificateConfiguration::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIServerCertificateConfiguration::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAIServerCertificateConfiguration::isSet() const {
...
bool OAIServerCertificateConfiguration::isValid() const {
