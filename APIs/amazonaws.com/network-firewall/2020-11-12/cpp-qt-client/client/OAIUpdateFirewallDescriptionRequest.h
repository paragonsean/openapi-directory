...
/*
 * OAIUpdateFirewallDescriptionRequest.h
 *
 * 
 */

#ifndef OAIUpdateFirewallDescriptionRequest_H
#define OAIUpdateFirewallDescriptionRequest_H
...
class OAIUpdateFirewallDescriptionRequest : public OAIObject {
public:
    OAIUpdateFirewallDescriptionRequest();
    OAIUpdateFirewallDescriptionRequest(QString json);
    ~OAIUpdateFirewallDescriptionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallDescriptionRequest)

#endif // OAIUpdateFirewallDescriptionRequest_H
