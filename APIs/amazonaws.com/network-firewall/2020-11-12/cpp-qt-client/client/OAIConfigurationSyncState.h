...
/*
 * OAIConfigurationSyncState.h
 *
 * 
 */

#ifndef OAIConfigurationSyncState_H
#define OAIConfigurationSyncState_H
...
class OAIConfigurationSyncState : public OAIEnum {
public:
    OAIConfigurationSyncState();
    OAIConfigurationSyncState(QString json);
    ~OAIConfigurationSyncState() override;
    ...
    enum class eOAIConfigurationSyncState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PENDING, 
        IN_SYNC, 
        CAPACITY_CONSTRAINED
    };
    OAIConfigurationSyncState::eOAIConfigurationSyncState getValue() const;
    void setValue(const OAIConfigurationSyncState::eOAIConfigurationSyncState& value);
...
private:
    ...
    eOAIConfigurationSyncState m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationSyncState)

#endif // OAIConfigurationSyncState_H
