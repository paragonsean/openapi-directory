...
#ifndef OAIRuleOrder_H
#define OAIRuleOrder_H
...
class OAIRuleOrder : public OAIEnum {
public:
    OAIRuleOrder();
    OAIRuleOrder(QString json);
    ~OAIRuleOrder() override;
    ...
    enum class eOAIRuleOrder {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DEFAULT_ACTION_ORDER, 
        STRICT_ORDER
    };
    OAIRuleOrder::eOAIRuleOrder getValue() const;
    void setValue(const OAIRuleOrder::eOAIRuleOrder& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleOrder)

#endif // OAIRuleOrder_H
