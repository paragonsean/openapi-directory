...
/*
 * OAIDescribeRuleGroupResponse_RuleGroup.h
 *
 * 
 */

#ifndef OAIDescribeRuleGroupResponse_RuleGroup_H
#define OAIDescribeRuleGroupResponse_RuleGroup_H
...
#include "OAIRuleGroup_StatefulRuleOptions.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIRuleGroup_RuleVariables;
class OAIRuleGroup_ReferenceSets;
class OAIRuleGroup_RulesSource;
class OAIRuleGroup_StatefulRuleOptions;

class OAIDescribeRuleGroupResponse_RuleGroup : public OAIObject {
public:
    OAIDescribeRuleGroupResponse_RuleGroup();
    OAIDescribeRuleGroupResponse_RuleGroup(QString json);
    ~OAIDescribeRuleGroupResponse_RuleGroup() override;
    ...
    OAIRuleGroup_RuleVariables getRuleVariables() const;
    void setRuleVariables(const OAIRuleGroup_RuleVariables &rule_variables);
    bool is_rule_variables_Set() const;
    bool is_rule_variables_Valid() const;

    OAIRuleGroup_ReferenceSets getReferenceSets() const;
    void setReferenceSets(const OAIRuleGroup_ReferenceSets &reference_sets);
    bool is_reference_sets_Set() const;
    bool is_reference_sets_Valid() const;

    OAIRuleGroup_RulesSource getRulesSource() const;
    void setRulesSource(const OAIRuleGroup_RulesSource &rules_source);
    bool is_rules_source_Set() const;
    bool is_rules_source_Valid() const;

    OAIRuleGroup_StatefulRuleOptions getStatefulRuleOptions() const;
    void setStatefulRuleOptions(const OAIRuleGroup_StatefulRuleOptions &stateful_rule_options);
    bool is_stateful_rule_options_Set() const;
    bool is_stateful_rule_options_Valid() const;
...
private:
    ...
    OAIRuleGroup_RuleVariables m_rule_variables;
    bool m_rule_variables_isSet;
    bool m_rule_variables_isValid;

    OAIRuleGroup_ReferenceSets m_reference_sets;
    bool m_reference_sets_isSet;
    bool m_reference_sets_isValid;

    OAIRuleGroup_RulesSource m_rules_source;
    bool m_rules_source_isSet;
    bool m_rules_source_isValid;

    OAIRuleGroup_StatefulRuleOptions m_stateful_rule_options;
    bool m_stateful_rule_options_isSet;
    bool m_stateful_rule_options_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleGroupResponse_RuleGroup)

#endif // OAIDescribeRuleGroupResponse_RuleGroup_H
