...
#include "OAIServerCertificate.h"
...
OAIServerCertificate::OAIServerCertificate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerCertificate::OAIServerCertificate() {
    this->initializeModel();
}

OAIServerCertificate::~OAIServerCertificate() {}

void OAIServerCertificate::initializeModel() {

    m_resource_arn_isSet = false;
    m_resource_arn_isValid = false;
}

void OAIServerCertificate::fromJson(QString jsonString) {
...
void OAIServerCertificate::fromJsonObject(QJsonObject json) {

    m_resource_arn_isValid = ::OpenAPI::fromJsonValue(m_resource_arn, json[QString("ResourceArn")]);
    m_resource_arn_isSet = !json[QString("ResourceArn")].isNull() && m_resource_arn_isValid;
}

QString OAIServerCertificate::asJson() const {
...
QJsonObject OAIServerCertificate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIServerCertificate::getResourceArn() const {
    return m_resource_arn;
}
void OAIServerCertificate::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIServerCertificate::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIServerCertificate::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

bool OAIServerCertificate::isSet() const {
...
bool OAIServerCertificate::isValid() const {
