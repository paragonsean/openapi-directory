...
OAIIPAddressType OAISubnetMapping::getIpAddressType() const {
    return m_ip_address_type;
}
void OAISubnetMapping::setIpAddressType(const OAIIPAddressType &ip_address_type) {
    m_ip_address_type = ip_address_type;
    m_ip_address_type_isSet = true;
}

bool OAISubnetMapping::is_ip_address_type_Set() const{
    return m_ip_address_type_isSet;
}

bool OAISubnetMapping::is_ip_address_type_Valid() const{
