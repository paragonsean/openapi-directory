...
OAIDescribeLoggingConfigurationRequest::OAIDescribeLoggingConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeLoggingConfigurationRequest::OAIDescribeLoggingConfigurationRequest() {
    this->initializeModel();
}

OAIDescribeLoggingConfigurationRequest::~OAIDescribeLoggingConfigurationRequest() {}

void OAIDescribeLoggingConfigurationRequest::initializeModel() {
...
void OAIDescribeLoggingConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDescribeLoggingConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeLoggingConfigurationRequest::asJson() const {
...
QJsonObject OAIDescribeLoggingConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeLoggingConfigurationRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDescribeLoggingConfigurationRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDescribeLoggingConfigurationRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDescribeLoggingConfigurationRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIDescribeLoggingConfigurationRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIDescribeLoggingConfigurationRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIDescribeLoggingConfigurationRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIDescribeLoggingConfigurationRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

bool OAIDescribeLoggingConfigurationRequest::isSet() const {
...
bool OAIDescribeLoggingConfigurationRequest::isValid() const {
