...
#include "OAIStatefulRuleGroupReference_Override.h"
...
OAIStatefulRuleGroupReference_Override::OAIStatefulRuleGroupReference_Override(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulRuleGroupReference_Override::OAIStatefulRuleGroupReference_Override() {
    this->initializeModel();
}

OAIStatefulRuleGroupReference_Override::~OAIStatefulRuleGroupReference_Override() {}

void OAIStatefulRuleGroupReference_Override::initializeModel() {

    m_action_isSet = false;
    m_action_isValid = false;
}

void OAIStatefulRuleGroupReference_Override::fromJson(QString jsonString) {
...
void OAIStatefulRuleGroupReference_Override::fromJsonObject(QJsonObject json) {

    m_action_isValid = ::OpenAPI::fromJsonValue(m_action, json[QString("Action")]);
    m_action_isSet = !json[QString("Action")].isNull() && m_action_isValid;
}

QString OAIStatefulRuleGroupReference_Override::asJson() const {
...
QJsonObject OAIStatefulRuleGroupReference_Override::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIOverrideAction OAIStatefulRuleGroupReference_Override::getAction() const {
    return m_action;
}
void OAIStatefulRuleGroupReference_Override::setAction(const OAIOverrideAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIStatefulRuleGroupReference_Override::is_action_Set() const{
    return m_action_isSet;
}

bool OAIStatefulRuleGroupReference_Override::is_action_Valid() const{
    return m_action_isValid;
}

bool OAIStatefulRuleGroupReference_Override::isSet() const {
...
bool OAIStatefulRuleGroupReference_Override::isValid() const {
