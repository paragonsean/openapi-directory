...
/*
 * OAIMatchAttributes.h
 *
 * Criteria for Network Firewall to use to inspect an individual packet in stateless rule inspection. Each match attributes set can include one or more items such as IP address, CIDR range, port number, protocol, and TCP flags. 
 */

#ifndef OAIMatchAttributes_H
#define OAIMatchAttributes_H
...
class OAIMatchAttributes : public OAIObject {
public:
    OAIMatchAttributes();
    OAIMatchAttributes(QString json);
    ~OAIMatchAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMatchAttributes)

#endif // OAIMatchAttributes_H
