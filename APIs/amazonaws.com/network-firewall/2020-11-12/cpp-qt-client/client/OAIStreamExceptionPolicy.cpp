...
#include "OAIStreamExceptionPolicy.h"
...
OAIStreamExceptionPolicy::OAIStreamExceptionPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamExceptionPolicy::OAIStreamExceptionPolicy() {
    this->initializeModel();
}

OAIStreamExceptionPolicy::~OAIStreamExceptionPolicy() {}

void OAIStreamExceptionPolicy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStreamExceptionPolicy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStreamExceptionPolicy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("DROP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamExceptionPolicy::DROP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONTINUE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamExceptionPolicy::CONTINUE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REJECT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamExceptionPolicy::REJECT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStreamExceptionPolicy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStreamExceptionPolicy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStreamExceptionPolicy::DROP:
            val = "DROP";
            break;
        case eOAIStreamExceptionPolicy::CONTINUE:
            val = "CONTINUE";
            break;
        case eOAIStreamExceptionPolicy::REJECT:
            val = "REJECT";
            break;
        default:
            break;
...
QJsonValue OAIStreamExceptionPolicy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStreamExceptionPolicy::eOAIStreamExceptionPolicy OAIStreamExceptionPolicy::getValue() const {
    return m_value;
}

void OAIStreamExceptionPolicy::setValue(const OAIStreamExceptionPolicy::eOAIStreamExceptionPolicy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStreamExceptionPolicy::isSet() const {
    
    return m_value_isSet;
}

bool OAIStreamExceptionPolicy::isValid() const {
