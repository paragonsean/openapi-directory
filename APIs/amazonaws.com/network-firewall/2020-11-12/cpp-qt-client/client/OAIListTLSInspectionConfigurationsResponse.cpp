...
OAIListTLSInspectionConfigurationsResponse::OAIListTLSInspectionConfigurationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListTLSInspectionConfigurationsResponse::OAIListTLSInspectionConfigurationsResponse() {
    this->initializeModel();
}

OAIListTLSInspectionConfigurationsResponse::~OAIListTLSInspectionConfigurationsResponse() {}

void OAIListTLSInspectionConfigurationsResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_tls_inspection_configurations_isSet = false;
    m_tls_inspection_configurations_isValid = false;
}

void OAIListTLSInspectionConfigurationsResponse::fromJson(QString jsonString) {
...
void OAIListTLSInspectionConfigurationsResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;

    m_tls_inspection_configurations_isValid = ::OpenAPI::fromJsonValue(m_tls_inspection_configurations, json[QString("TLSInspectionConfigurations")]);
    m_tls_inspection_configurations_isSet = !json[QString("TLSInspectionConfigurations")].isNull() && m_tls_inspection_configurations_isValid;
}

QString OAIListTLSInspectionConfigurationsResponse::asJson() const {
...
QJsonObject OAIListTLSInspectionConfigurationsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("NextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_tls_inspection_configurations.isSet()) {
        obj.insert(QString("TLSInspectionConfigurations"), ::OpenAPI::toJsonValue(m_tls_inspection_configurations));
    }
    return obj;
}

QString OAIListTLSInspectionConfigurationsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListTLSInspectionConfigurationsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListTLSInspectionConfigurationsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListTLSInspectionConfigurationsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListTLSInspectionConfigurationsResponse::getTlsInspectionConfigurations() const {
    return m_tls_inspection_configurations;
}
void OAIListTLSInspectionConfigurationsResponse::setTlsInspectionConfigurations(const QList &tls_inspection_configurations) {
    m_tls_inspection_configurations = tls_inspection_configurations;
    m_tls_inspection_configurations_isSet = true;
}

bool OAIListTLSInspectionConfigurationsResponse::is_tls_inspection_configurations_Set() const{
    return m_tls_inspection_configurations_isSet;
}

bool OAIListTLSInspectionConfigurationsResponse::is_tls_inspection_configurations_Valid() const{
    return m_tls_inspection_configurations_isValid;
}

bool OAIListTLSInspectionConfigurationsResponse::isSet() const {
...
bool OAIListTLSInspectionConfigurationsResponse::isValid() const {
