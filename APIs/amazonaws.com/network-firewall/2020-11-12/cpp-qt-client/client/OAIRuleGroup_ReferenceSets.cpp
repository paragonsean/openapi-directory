...
#include "OAIRuleGroup_ReferenceSets.h"
...
OAIRuleGroup_ReferenceSets::OAIRuleGroup_ReferenceSets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleGroup_ReferenceSets::OAIRuleGroup_ReferenceSets() {
    this->initializeModel();
}

OAIRuleGroup_ReferenceSets::~OAIRuleGroup_ReferenceSets() {}

void OAIRuleGroup_ReferenceSets::initializeModel() {

    m_ip_set_references_isSet = false;
    m_ip_set_references_isValid = false;
}

void OAIRuleGroup_ReferenceSets::fromJson(QString jsonString) {
...
void OAIRuleGroup_ReferenceSets::fromJsonObject(QJsonObject json) {
...
QString OAIRuleGroup_ReferenceSets::asJson() const {
...
QJsonObject OAIRuleGroup_ReferenceSets::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIRuleGroup_ReferenceSets::getIpSetReferences() const {
    return m_ip_set_references;
}
void OAIRuleGroup_ReferenceSets::setIpSetReferences(const QMap &ip_set_references) {
    m_ip_set_references = ip_set_references;
    m_ip_set_references_isSet = true;
}

bool OAIRuleGroup_ReferenceSets::is_ip_set_references_Set() const{
    return m_ip_set_references_isSet;
}

bool OAIRuleGroup_ReferenceSets::is_ip_set_references_Valid() const{
    return m_ip_set_references_isValid;
}

bool OAIRuleGroup_ReferenceSets::isSet() const {
...
bool OAIRuleGroup_ReferenceSets::isValid() const {
