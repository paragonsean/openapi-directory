...
#ifndef OAIRuleDefinition_H
#define OAIRuleDefinition_H
...
class OAIRuleDefinition : public OAIObject {
public:
    OAIRuleDefinition();
    OAIRuleDefinition(QString json);
    ~OAIRuleDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleDefinition)

#endif // OAIRuleDefinition_H
