...
OAICreateRuleGroupRequest_EncryptionConfiguration::OAICreateRuleGroupRequest_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRuleGroupRequest_EncryptionConfiguration::OAICreateRuleGroupRequest_EncryptionConfiguration() {
    this->initializeModel();
}

OAICreateRuleGroupRequest_EncryptionConfiguration::~OAICreateRuleGroupRequest_EncryptionConfiguration() {}

void OAICreateRuleGroupRequest_EncryptionConfiguration::initializeModel() {
...
void OAICreateRuleGroupRequest_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAICreateRuleGroupRequest_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateRuleGroupRequest_EncryptionConfiguration::asJson() const {
...
QJsonObject OAICreateRuleGroupRequest_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAICreateRuleGroupRequest_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAICreateRuleGroupRequest_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAICreateRuleGroupRequest_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAICreateRuleGroupRequest_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAICreateRuleGroupRequest_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAICreateRuleGroupRequest_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateRuleGroupRequest_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateRuleGroupRequest_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateRuleGroupRequest_EncryptionConfiguration::isSet() const {
...
bool OAICreateRuleGroupRequest_EncryptionConfiguration::isValid() const {
