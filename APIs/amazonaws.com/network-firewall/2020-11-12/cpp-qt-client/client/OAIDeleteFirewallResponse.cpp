...
OAIDeleteFirewallResponse::OAIDeleteFirewallResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFirewallResponse::OAIDeleteFirewallResponse() {
    this->initializeModel();
}

OAIDeleteFirewallResponse::~OAIDeleteFirewallResponse() {}

void OAIDeleteFirewallResponse::initializeModel() {

    m_firewall_isSet = false;
    m_firewall_isValid = false;

    m_firewall_status_isSet = false;
    m_firewall_status_isValid = false;
}

void OAIDeleteFirewallResponse::fromJson(QString jsonString) {
...
void OAIDeleteFirewallResponse::fromJsonObject(QJsonObject json) {
    ...
    m_firewall_status_isValid = ::OpenAPI::fromJsonValue(m_firewall_status, json[QString("FirewallStatus")]);
    m_firewall_status_isSet = !json[QString("FirewallStatus")].isNull() && m_firewall_status_isValid;
}

QString OAIDeleteFirewallResponse::asJson() const {
...
QJsonObject OAIDeleteFirewallResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_firewall.isSet()) {
        obj.insert(QString("Firewall"), ::OpenAPI::toJsonValue(m_firewall));
    }
    if (m_firewall_status.isSet()) {
        obj.insert(QString("FirewallStatus"), ::OpenAPI::toJsonValue(m_firewall_status));
    }
    return obj;
}

OAIFirewall OAIDeleteFirewallResponse::getFirewall() const {
    return m_firewall;
}
void OAIDeleteFirewallResponse::setFirewall(const OAIFirewall &firewall) {
    m_firewall = firewall;
    m_firewall_isSet = true;
}

bool OAIDeleteFirewallResponse::is_firewall_Set() const{
    return m_firewall_isSet;
}

bool OAIDeleteFirewallResponse::is_firewall_Valid() const{
    return m_firewall_isValid;
}

OAIFirewallStatus OAIDeleteFirewallResponse::getFirewallStatus() const {
    return m_firewall_status;
}
void OAIDeleteFirewallResponse::setFirewallStatus(const OAIFirewallStatus &firewall_status) {
    m_firewall_status = firewall_status;
    m_firewall_status_isSet = true;
}

bool OAIDeleteFirewallResponse::is_firewall_status_Set() const{
    return m_firewall_status_isSet;
}

bool OAIDeleteFirewallResponse::is_firewall_status_Valid() const{
    return m_firewall_status_isValid;
}

bool OAIDeleteFirewallResponse::isSet() const {
...
bool OAIDeleteFirewallResponse::isValid() const {
