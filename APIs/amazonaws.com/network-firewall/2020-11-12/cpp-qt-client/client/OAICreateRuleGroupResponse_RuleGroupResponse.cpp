...
#include "OAICreateRuleGroupResponse_RuleGroupResponse.h"
...
OAICreateRuleGroupResponse_RuleGroupResponse::OAICreateRuleGroupResponse_RuleGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRuleGroupResponse_RuleGroupResponse::OAICreateRuleGroupResponse_RuleGroupResponse() {
    this->initializeModel();
}

OAICreateRuleGroupResponse_RuleGroupResponse::~OAICreateRuleGroupResponse_RuleGroupResponse() {}

void OAICreateRuleGroupResponse_RuleGroupResponse::initializeModel() {
...
void OAICreateRuleGroupResponse_RuleGroupResponse::fromJson(QString jsonString) {
...
void OAICreateRuleGroupResponse_RuleGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateRuleGroupResponse_RuleGroupResponse::asJson() const {
...
QJsonObject OAICreateRuleGroupResponse_RuleGroupResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRuleGroupResponse_RuleGroupResponse::getRuleGroupArn() const {
    return m_rule_group_arn;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setRuleGroupArn(const QString &rule_group_arn) {
    m_rule_group_arn = rule_group_arn;
    m_rule_group_arn_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_arn_Set() const{
    return m_rule_group_arn_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_arn_Valid() const{
    return m_rule_group_arn_isValid;
}

QString OAICreateRuleGroupResponse_RuleGroupResponse::getRuleGroupName() const {
    return m_rule_group_name;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setRuleGroupName(const QString &rule_group_name) {
    m_rule_group_name = rule_group_name;
    m_rule_group_name_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_name_Set() const{
    return m_rule_group_name_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_name_Valid() const{
    return m_rule_group_name_isValid;
}

QString OAICreateRuleGroupResponse_RuleGroupResponse::getRuleGroupId() const {
    return m_rule_group_id;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setRuleGroupId(const QString &rule_group_id) {
    m_rule_group_id = rule_group_id;
    m_rule_group_id_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_id_Set() const{
    return m_rule_group_id_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_id_Valid() const{
    return m_rule_group_id_isValid;
}

QString OAICreateRuleGroupResponse_RuleGroupResponse::getDescription() const {
    return m_description;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_description_Valid() const{
    return m_description_isValid;
}

OAIRuleGroupType OAICreateRuleGroupResponse_RuleGroupResponse::getType() const {
    return m_type;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setType(const OAIRuleGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAICreateRuleGroupResponse_RuleGroupResponse::getCapacity() const {
    return m_capacity;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setCapacity(const qint32 &capacity) {
    m_capacity = capacity;
    m_capacity_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_capacity_Set() const{
    return m_capacity_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_capacity_Valid() const{
    return m_capacity_isValid;
}

OAIResourceStatus OAICreateRuleGroupResponse_RuleGroupResponse::getRuleGroupStatus() const {
    return m_rule_group_status;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setRuleGroupStatus(const OAIResourceStatus &rule_group_status) {
    m_rule_group_status = rule_group_status;
    m_rule_group_status_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_status_Set() const{
    return m_rule_group_status_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_rule_group_status_Valid() const{
    return m_rule_group_status_isValid;
}

QList OAICreateRuleGroupResponse_RuleGroupResponse::getTags() const {
    return m_tags;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

qint32 OAICreateRuleGroupResponse_RuleGroupResponse::getConsumedCapacity() const {
    return m_consumed_capacity;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setConsumedCapacity(const qint32 &consumed_capacity) {
    m_consumed_capacity = consumed_capacity;
    m_consumed_capacity_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_consumed_capacity_Set() const{
    return m_consumed_capacity_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_consumed_capacity_Valid() const{
    return m_consumed_capacity_isValid;
}

qint32 OAICreateRuleGroupResponse_RuleGroupResponse::getNumberOfAssociations() const {
    return m_number_of_associations;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setNumberOfAssociations(const qint32 &number_of_associations) {
    m_number_of_associations = number_of_associations;
    m_number_of_associations_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_number_of_associations_Set() const{
    return m_number_of_associations_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_number_of_associations_Valid() const{
    return m_number_of_associations_isValid;
}

OAIRuleGroupResponse_EncryptionConfiguration OAICreateRuleGroupResponse_RuleGroupResponse::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setEncryptionConfiguration(const OAIRuleGroupResponse_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIRuleGroupResponse_SourceMetadata OAICreateRuleGroupResponse_RuleGroupResponse::getSourceMetadata() const {
    return m_source_metadata;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setSourceMetadata(const OAIRuleGroupResponse_SourceMetadata &source_metadata) {
    m_source_metadata = source_metadata;
    m_source_metadata_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_source_metadata_Set() const{
    return m_source_metadata_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_source_metadata_Valid() const{
    return m_source_metadata_isValid;
}

QString OAICreateRuleGroupResponse_RuleGroupResponse::getSnsTopic() const {
    return m_sns_topic;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

QDateTime OAICreateRuleGroupResponse_RuleGroupResponse::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAICreateRuleGroupResponse_RuleGroupResponse::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

bool OAICreateRuleGroupResponse_RuleGroupResponse::isSet() const {
...
bool OAICreateRuleGroupResponse_RuleGroupResponse::isValid() const {
