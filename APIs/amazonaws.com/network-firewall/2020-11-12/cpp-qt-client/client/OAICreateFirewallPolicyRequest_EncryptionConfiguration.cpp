...
#include "OAICreateFirewallPolicyRequest_EncryptionConfiguration.h"
...
OAICreateFirewallPolicyRequest_EncryptionConfiguration::OAICreateFirewallPolicyRequest_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFirewallPolicyRequest_EncryptionConfiguration::OAICreateFirewallPolicyRequest_EncryptionConfiguration() {
    this->initializeModel();
}

OAICreateFirewallPolicyRequest_EncryptionConfiguration::~OAICreateFirewallPolicyRequest_EncryptionConfiguration() {}

void OAICreateFirewallPolicyRequest_EncryptionConfiguration::initializeModel() {
...
void OAICreateFirewallPolicyRequest_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAICreateFirewallPolicyRequest_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateFirewallPolicyRequest_EncryptionConfiguration::asJson() const {
...
QJsonObject OAICreateFirewallPolicyRequest_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAICreateFirewallPolicyRequest_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAICreateFirewallPolicyRequest_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAICreateFirewallPolicyRequest_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAICreateFirewallPolicyRequest_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::isSet() const {
...
bool OAICreateFirewallPolicyRequest_EncryptionConfiguration::isValid() const {
