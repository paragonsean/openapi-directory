...
/*
 * OAIDescribeRuleGroupMetadataRequest.h
 *
 * 
 */

#ifndef OAIDescribeRuleGroupMetadataRequest_H
#define OAIDescribeRuleGroupMetadataRequest_H
...
class OAIDescribeRuleGroupMetadataRequest : public OAIObject {
public:
    OAIDescribeRuleGroupMetadataRequest();
    OAIDescribeRuleGroupMetadataRequest(QString json);
    ~OAIDescribeRuleGroupMetadataRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRuleGroupMetadataRequest)

#endif // OAIDescribeRuleGroupMetadataRequest_H
