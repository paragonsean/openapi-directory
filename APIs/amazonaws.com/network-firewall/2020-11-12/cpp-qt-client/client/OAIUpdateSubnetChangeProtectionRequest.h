...
/*
 * OAIUpdateSubnetChangeProtectionRequest.h
 *
 * 
 */

#ifndef OAIUpdateSubnetChangeProtectionRequest_H
#define OAIUpdateSubnetChangeProtectionRequest_H
...
class OAIUpdateSubnetChangeProtectionRequest : public OAIObject {
public:
    OAIUpdateSubnetChangeProtectionRequest();
    OAIUpdateSubnetChangeProtectionRequest(QString json);
    ~OAIUpdateSubnetChangeProtectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSubnetChangeProtectionRequest)

#endif // OAIUpdateSubnetChangeProtectionRequest_H
