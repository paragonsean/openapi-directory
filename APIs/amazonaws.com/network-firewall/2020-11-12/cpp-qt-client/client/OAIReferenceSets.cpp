...
OAIReferenceSets::OAIReferenceSets(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReferenceSets::OAIReferenceSets() {
    this->initializeModel();
}

OAIReferenceSets::~OAIReferenceSets() {}

void OAIReferenceSets::initializeModel() {

    m_ip_set_references_isSet = false;
    m_ip_set_references_isValid = false;
}

void OAIReferenceSets::fromJson(QString jsonString) {
...
void OAIReferenceSets::fromJsonObject(QJsonObject json) {
...
QString OAIReferenceSets::asJson() const {
...
QJsonObject OAIReferenceSets::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIReferenceSets::getIpSetReferences() const {
    return m_ip_set_references;
}
void OAIReferenceSets::setIpSetReferences(const QMap &ip_set_references) {
    m_ip_set_references = ip_set_references;
    m_ip_set_references_isSet = true;
}

bool OAIReferenceSets::is_ip_set_references_Set() const{
    return m_ip_set_references_isSet;
}

bool OAIReferenceSets::is_ip_set_references_Valid() const{
    return m_ip_set_references_isValid;
}

bool OAIReferenceSets::isSet() const {
...
bool OAIReferenceSets::isValid() const {
