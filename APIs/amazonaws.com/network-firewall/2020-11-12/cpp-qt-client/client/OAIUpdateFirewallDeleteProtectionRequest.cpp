...
OAIUpdateFirewallDeleteProtectionRequest::OAIUpdateFirewallDeleteProtectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFirewallDeleteProtectionRequest::OAIUpdateFirewallDeleteProtectionRequest() {
    this->initializeModel();
}

OAIUpdateFirewallDeleteProtectionRequest::~OAIUpdateFirewallDeleteProtectionRequest() {}

void OAIUpdateFirewallDeleteProtectionRequest::initializeModel() {
...
void OAIUpdateFirewallDeleteProtectionRequest::fromJson(QString jsonString) {
...
void OAIUpdateFirewallDeleteProtectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFirewallDeleteProtectionRequest::asJson() const {
...
QJsonObject OAIUpdateFirewallDeleteProtectionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFirewallDeleteProtectionRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateFirewallDeleteProtectionRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIUpdateFirewallDeleteProtectionRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateFirewallDeleteProtectionRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateFirewallDeleteProtectionRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateFirewallDeleteProtectionRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

bool OAIUpdateFirewallDeleteProtectionRequest::getDeleteProtection() const {
    return m_delete_protection;
}
void OAIUpdateFirewallDeleteProtectionRequest::setDeleteProtection(const bool &delete_protection) {
    m_delete_protection = delete_protection;
    m_delete_protection_isSet = true;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_delete_protection_Set() const{
    return m_delete_protection_isSet;
}

bool OAIUpdateFirewallDeleteProtectionRequest::is_delete_protection_Valid() const{
    return m_delete_protection_isValid;
}

bool OAIUpdateFirewallDeleteProtectionRequest::isSet() const {
...
bool OAIUpdateFirewallDeleteProtectionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_delete_protection_isValid && true;
}
