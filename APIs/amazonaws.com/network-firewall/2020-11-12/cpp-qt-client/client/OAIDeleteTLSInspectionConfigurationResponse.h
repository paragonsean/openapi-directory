...
/*
 * OAIDeleteTLSInspectionConfigurationResponse.h
 *
 * 
 */

#ifndef OAIDeleteTLSInspectionConfigurationResponse_H
#define OAIDeleteTLSInspectionConfigurationResponse_H
...
class OAIDeleteTLSInspectionConfigurationResponse : public OAIObject {
public:
    OAIDeleteTLSInspectionConfigurationResponse();
    OAIDeleteTLSInspectionConfigurationResponse(QString json);
    ~OAIDeleteTLSInspectionConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTLSInspectionConfigurationResponse)

#endif // OAIDeleteTLSInspectionConfigurationResponse_H
