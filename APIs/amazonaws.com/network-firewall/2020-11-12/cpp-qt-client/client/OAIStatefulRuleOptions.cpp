...
OAIStatefulRuleOptions::OAIStatefulRuleOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulRuleOptions::OAIStatefulRuleOptions() {
    this->initializeModel();
}

OAIStatefulRuleOptions::~OAIStatefulRuleOptions() {}

void OAIStatefulRuleOptions::initializeModel() {

    m_rule_order_isSet = false;
    m_rule_order_isValid = false;
}

void OAIStatefulRuleOptions::fromJson(QString jsonString) {
...
void OAIStatefulRuleOptions::fromJsonObject(QJsonObject json) {
...
QString OAIStatefulRuleOptions::asJson() const {
...
QJsonObject OAIStatefulRuleOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIRuleOrder OAIStatefulRuleOptions::getRuleOrder() const {
    return m_rule_order;
}
void OAIStatefulRuleOptions::setRuleOrder(const OAIRuleOrder &rule_order) {
    m_rule_order = rule_order;
    m_rule_order_isSet = true;
}

bool OAIStatefulRuleOptions::is_rule_order_Set() const{
    return m_rule_order_isSet;
}

bool OAIStatefulRuleOptions::is_rule_order_Valid() const{
    return m_rule_order_isValid;
}

bool OAIStatefulRuleOptions::isSet() const {
...
bool OAIStatefulRuleOptions::isValid() const {
