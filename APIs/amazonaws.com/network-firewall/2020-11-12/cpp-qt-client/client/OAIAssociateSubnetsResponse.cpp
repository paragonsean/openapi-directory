...
OAIAssociateSubnetsResponse::OAIAssociateSubnetsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateSubnetsResponse::OAIAssociateSubnetsResponse() {
    this->initializeModel();
}

OAIAssociateSubnetsResponse::~OAIAssociateSubnetsResponse() {}

void OAIAssociateSubnetsResponse::initializeModel() {
...
void OAIAssociateSubnetsResponse::fromJson(QString jsonString) {
...
void OAIAssociateSubnetsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateSubnetsResponse::asJson() const {
...
QJsonObject OAIAssociateSubnetsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateSubnetsResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIAssociateSubnetsResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIAssociateSubnetsResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIAssociateSubnetsResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIAssociateSubnetsResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIAssociateSubnetsResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIAssociateSubnetsResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIAssociateSubnetsResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QList OAIAssociateSubnetsResponse::getSubnetMappings() const {
    return m_subnet_mappings;
}
void OAIAssociateSubnetsResponse::setSubnetMappings(const QList &subnet_mappings) {
    m_subnet_mappings = subnet_mappings;
    m_subnet_mappings_isSet = true;
}

bool OAIAssociateSubnetsResponse::is_subnet_mappings_Set() const{
    return m_subnet_mappings_isSet;
}

bool OAIAssociateSubnetsResponse::is_subnet_mappings_Valid() const{
    return m_subnet_mappings_isValid;
}

QString OAIAssociateSubnetsResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIAssociateSubnetsResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIAssociateSubnetsResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIAssociateSubnetsResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIAssociateSubnetsResponse::isSet() const {
...
bool OAIAssociateSubnetsResponse::isValid() const {
