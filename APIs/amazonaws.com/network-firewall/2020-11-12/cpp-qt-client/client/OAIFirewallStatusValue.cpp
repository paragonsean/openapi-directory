...
OAIFirewallStatusValue::OAIFirewallStatusValue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallStatusValue::OAIFirewallStatusValue() {
    this->initializeModel();
}

OAIFirewallStatusValue::~OAIFirewallStatusValue() {}

void OAIFirewallStatusValue::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFirewallStatusValue::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFirewallStatusValue::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PROVISIONING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFirewallStatusValue::PROVISIONING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFirewallStatusValue::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("READY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFirewallStatusValue::READY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFirewallStatusValue::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFirewallStatusValue::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFirewallStatusValue::PROVISIONING:
            val = "PROVISIONING";
            break;
        case eOAIFirewallStatusValue::DELETING:
            val = "DELETING";
            break;
        case eOAIFirewallStatusValue::READY:
            val = "READY";
            break;
        default:
            break;
...
QJsonValue OAIFirewallStatusValue::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFirewallStatusValue::eOAIFirewallStatusValue OAIFirewallStatusValue::getValue() const {
    return m_value;
}

void OAIFirewallStatusValue::setValue(const OAIFirewallStatusValue::eOAIFirewallStatusValue& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFirewallStatusValue::isSet() const {
    
    return m_value_isSet;
}

bool OAIFirewallStatusValue::isValid() const {
