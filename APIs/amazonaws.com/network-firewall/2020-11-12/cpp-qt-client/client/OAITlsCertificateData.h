...
/*
 * OAITlsCertificateData.h
 *
 * Contains metadata about an Certificate Manager certificate.
 */

#ifndef OAITlsCertificateData_H
#define OAITlsCertificateData_H
...
class OAITlsCertificateData : public OAIObject {
public:
    OAITlsCertificateData();
    OAITlsCertificateData(QString json);
    ~OAITlsCertificateData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITlsCertificateData)

#endif // OAITlsCertificateData_H
