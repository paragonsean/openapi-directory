...
#include "OAIGeneratedRulesType.h"
...
OAIGeneratedRulesType::OAIGeneratedRulesType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeneratedRulesType::OAIGeneratedRulesType() {
    this->initializeModel();
}

OAIGeneratedRulesType::~OAIGeneratedRulesType() {}

void OAIGeneratedRulesType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGeneratedRulesType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGeneratedRulesType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOWLIST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGeneratedRulesType::ALLOWLIST;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DENYLIST", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGeneratedRulesType::DENYLIST;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGeneratedRulesType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGeneratedRulesType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGeneratedRulesType::ALLOWLIST:
            val = "ALLOWLIST";
            break;
        case eOAIGeneratedRulesType::DENYLIST:
            val = "DENYLIST";
            break;
        default:
            break;
...
QJsonValue OAIGeneratedRulesType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGeneratedRulesType::eOAIGeneratedRulesType OAIGeneratedRulesType::getValue() const {
    return m_value;
}

void OAIGeneratedRulesType::setValue(const OAIGeneratedRulesType::eOAIGeneratedRulesType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGeneratedRulesType::isSet() const {
    
    return m_value_isSet;
}

bool OAIGeneratedRulesType::isValid() const {
