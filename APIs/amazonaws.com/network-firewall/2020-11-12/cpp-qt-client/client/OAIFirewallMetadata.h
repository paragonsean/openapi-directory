...
#ifndef OAIFirewallMetadata_H
#define OAIFirewallMetadata_H
...
class OAIFirewallMetadata : public OAIObject {
public:
    OAIFirewallMetadata();
    OAIFirewallMetadata(QString json);
    ~OAIFirewallMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallMetadata)

#endif // OAIFirewallMetadata_H
