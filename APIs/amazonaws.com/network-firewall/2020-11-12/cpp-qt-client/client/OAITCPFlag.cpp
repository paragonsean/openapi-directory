...
OAITCPFlag::OAITCPFlag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITCPFlag::OAITCPFlag() {
    this->initializeModel();
}

OAITCPFlag::~OAITCPFlag() {}

void OAITCPFlag::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITCPFlag::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITCPFlag::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FIN", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::FIN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SYN", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::SYN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RST", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::RST;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PSH", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::PSH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACK", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::ACK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("URG", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::URG;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ECE", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::ECE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CWR", Qt::CaseInsensitive) == 0) {
        m_value = eOAITCPFlag::CWR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITCPFlag::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITCPFlag::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITCPFlag::FIN:
            val = "FIN";
            break;
        case eOAITCPFlag::SYN:
            val = "SYN";
            break;
        case eOAITCPFlag::RST:
            val = "RST";
            break;
        case eOAITCPFlag::PSH:
            val = "PSH";
            break;
        case eOAITCPFlag::ACK:
            val = "ACK";
            break;
        case eOAITCPFlag::URG:
            val = "URG";
            break;
        case eOAITCPFlag::ECE:
            val = "ECE";
            break;
        case eOAITCPFlag::CWR:
            val = "CWR";
            break;
        default:
            break;
...
QJsonValue OAITCPFlag::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITCPFlag::eOAITCPFlag OAITCPFlag::getValue() const {
    return m_value;
}

void OAITCPFlag::setValue(const OAITCPFlag::eOAITCPFlag& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITCPFlag::isSet() const {
    
    return m_value_isSet;
}

bool OAITCPFlag::isValid() const {
