...
#include "OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration.h"
...
OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration() {
    this->initializeModel();
}

OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::~OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration() {}

void OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::initializeModel() {
...
void OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::asJson() const {
...
QJsonObject OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::isSet() const {
...
bool OAIUpdateTLSInspectionConfigurationRequest_EncryptionConfiguration::isValid() const {
