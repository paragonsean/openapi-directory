...
OAIDeleteFirewallRequest::OAIDeleteFirewallRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFirewallRequest::OAIDeleteFirewallRequest() {
    this->initializeModel();
}

OAIDeleteFirewallRequest::~OAIDeleteFirewallRequest() {}

void OAIDeleteFirewallRequest::initializeModel() {
...
void OAIDeleteFirewallRequest::fromJson(QString jsonString) {
...
void OAIDeleteFirewallRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFirewallRequest::asJson() const {
...
QJsonObject OAIDeleteFirewallRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFirewallRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIDeleteFirewallRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIDeleteFirewallRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIDeleteFirewallRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIDeleteFirewallRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDeleteFirewallRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDeleteFirewallRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDeleteFirewallRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

bool OAIDeleteFirewallRequest::isSet() const {
...
bool OAIDeleteFirewallRequest::isValid() const {
