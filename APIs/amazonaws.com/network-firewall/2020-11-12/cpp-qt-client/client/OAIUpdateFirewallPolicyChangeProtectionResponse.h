...
/*
 * OAIUpdateFirewallPolicyChangeProtectionResponse.h
 *
 * 
 */

#ifndef OAIUpdateFirewallPolicyChangeProtectionResponse_H
#define OAIUpdateFirewallPolicyChangeProtectionResponse_H
...
class OAIUpdateFirewallPolicyChangeProtectionResponse : public OAIObject {
public:
    OAIUpdateFirewallPolicyChangeProtectionResponse();
    OAIUpdateFirewallPolicyChangeProtectionResponse(QString json);
    ~OAIUpdateFirewallPolicyChangeProtectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFirewallPolicyChangeProtectionResponse)

#endif // OAIUpdateFirewallPolicyChangeProtectionResponse_H
