...
OAIDescribeFirewallPolicyRequest::OAIDescribeFirewallPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFirewallPolicyRequest::OAIDescribeFirewallPolicyRequest() {
    this->initializeModel();
}

OAIDescribeFirewallPolicyRequest::~OAIDescribeFirewallPolicyRequest() {}

void OAIDescribeFirewallPolicyRequest::initializeModel() {
...
void OAIDescribeFirewallPolicyRequest::fromJson(QString jsonString) {
...
void OAIDescribeFirewallPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFirewallPolicyRequest::asJson() const {
...
QJsonObject OAIDescribeFirewallPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeFirewallPolicyRequest::getFirewallPolicyName() const {
    return m_firewall_policy_name;
}
void OAIDescribeFirewallPolicyRequest::setFirewallPolicyName(const QString &firewall_policy_name) {
    m_firewall_policy_name = firewall_policy_name;
    m_firewall_policy_name_isSet = true;
}

bool OAIDescribeFirewallPolicyRequest::is_firewall_policy_name_Set() const{
    return m_firewall_policy_name_isSet;
}

bool OAIDescribeFirewallPolicyRequest::is_firewall_policy_name_Valid() const{
    return m_firewall_policy_name_isValid;
}

QString OAIDescribeFirewallPolicyRequest::getFirewallPolicyArn() const {
    return m_firewall_policy_arn;
}
void OAIDescribeFirewallPolicyRequest::setFirewallPolicyArn(const QString &firewall_policy_arn) {
    m_firewall_policy_arn = firewall_policy_arn;
    m_firewall_policy_arn_isSet = true;
}

bool OAIDescribeFirewallPolicyRequest::is_firewall_policy_arn_Set() const{
    return m_firewall_policy_arn_isSet;
}

bool OAIDescribeFirewallPolicyRequest::is_firewall_policy_arn_Valid() const{
    return m_firewall_policy_arn_isValid;
}

bool OAIDescribeFirewallPolicyRequest::isSet() const {
...
bool OAIDescribeFirewallPolicyRequest::isValid() const {
