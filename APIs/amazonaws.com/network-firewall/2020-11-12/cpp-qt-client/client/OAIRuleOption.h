...
#ifndef OAIRuleOption_H
#define OAIRuleOption_H
...
class OAIRuleOption : public OAIObject {
public:
    OAIRuleOption();
    OAIRuleOption(QString json);
    ~OAIRuleOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleOption)

#endif // OAIRuleOption_H
