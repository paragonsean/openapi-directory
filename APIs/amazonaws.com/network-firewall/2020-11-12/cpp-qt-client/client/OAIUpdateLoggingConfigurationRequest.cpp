...
QString OAIUpdateLoggingConfigurationRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIUpdateLoggingConfigurationRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIUpdateLoggingConfigurationRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIUpdateLoggingConfigurationRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

OAIUpdateLoggingConfigurationRequest_LoggingConfiguration OAIUpdateLoggingConfigurationRequest::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIUpdateLoggingConfigurationRequest::setLoggingConfiguration(const OAIUpdateLoggingConfigurationRequest_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIUpdateLoggingConfigurationRequest::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIUpdateLoggingConfigurationRequest::is_logging_configuration_Valid() const{
