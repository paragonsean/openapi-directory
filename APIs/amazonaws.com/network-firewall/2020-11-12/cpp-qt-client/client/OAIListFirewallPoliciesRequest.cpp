...
OAIListFirewallPoliciesRequest::OAIListFirewallPoliciesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListFirewallPoliciesRequest::OAIListFirewallPoliciesRequest() {
    this->initializeModel();
}

OAIListFirewallPoliciesRequest::~OAIListFirewallPoliciesRequest() {}

void OAIListFirewallPoliciesRequest::initializeModel() {
...
void OAIListFirewallPoliciesRequest::fromJson(QString jsonString) {
...
void OAIListFirewallPoliciesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListFirewallPoliciesRequest::asJson() const {
...
QJsonObject OAIListFirewallPoliciesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListFirewallPoliciesRequest::getNextToken() const {
    return m_next_token;
}
void OAIListFirewallPoliciesRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListFirewallPoliciesRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListFirewallPoliciesRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListFirewallPoliciesRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListFirewallPoliciesRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListFirewallPoliciesRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListFirewallPoliciesRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListFirewallPoliciesRequest::isSet() const {
...
bool OAIListFirewallPoliciesRequest::isValid() const {
