...
/*
 * OAIDeleteFirewallPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteFirewallPolicyRequest_H
#define OAIDeleteFirewallPolicyRequest_H
...
class OAIDeleteFirewallPolicyRequest : public OAIObject {
public:
    OAIDeleteFirewallPolicyRequest();
    OAIDeleteFirewallPolicyRequest(QString json);
    ~OAIDeleteFirewallPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFirewallPolicyRequest)

#endif // OAIDeleteFirewallPolicyRequest_H
