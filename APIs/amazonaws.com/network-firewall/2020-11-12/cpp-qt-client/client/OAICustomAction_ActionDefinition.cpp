...
OAICustomAction_ActionDefinition::OAICustomAction_ActionDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomAction_ActionDefinition::OAICustomAction_ActionDefinition() {
    this->initializeModel();
}

OAICustomAction_ActionDefinition::~OAICustomAction_ActionDefinition() {}

void OAICustomAction_ActionDefinition::initializeModel() {

    m_publish_metric_action_isSet = false;
    m_publish_metric_action_isValid = false;
}

void OAICustomAction_ActionDefinition::fromJson(QString jsonString) {
...
void OAICustomAction_ActionDefinition::fromJsonObject(QJsonObject json) {

    m_publish_metric_action_isValid = ::OpenAPI::fromJsonValue(m_publish_metric_action, json[QString("PublishMetricAction")]);
    m_publish_metric_action_isSet = !json[QString("PublishMetricAction")].isNull() && m_publish_metric_action_isValid;
}

QString OAICustomAction_ActionDefinition::asJson() const {
...
QJsonObject OAICustomAction_ActionDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_publish_metric_action.isSet()) {
        obj.insert(QString("PublishMetricAction"), ::OpenAPI::toJsonValue(m_publish_metric_action));
    }
    return obj;
}

OAIActionDefinition_PublishMetricAction OAICustomAction_ActionDefinition::getPublishMetricAction() const {
    return m_publish_metric_action;
}
void OAICustomAction_ActionDefinition::setPublishMetricAction(const OAIActionDefinition_PublishMetricAction &publish_metric_action) {
    m_publish_metric_action = publish_metric_action;
    m_publish_metric_action_isSet = true;
}

bool OAICustomAction_ActionDefinition::is_publish_metric_action_Set() const{
    return m_publish_metric_action_isSet;
}

bool OAICustomAction_ActionDefinition::is_publish_metric_action_Valid() const{
    return m_publish_metric_action_isValid;
}

bool OAICustomAction_ActionDefinition::isSet() const {
...
bool OAICustomAction_ActionDefinition::isValid() const {
