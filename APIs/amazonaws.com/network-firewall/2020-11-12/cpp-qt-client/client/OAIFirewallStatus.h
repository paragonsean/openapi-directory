...
#ifndef OAIFirewallStatus_H
#define OAIFirewallStatus_H
...
class OAIFirewallStatus : public OAIObject {
public:
    OAIFirewallStatus();
    OAIFirewallStatus(QString json);
    ~OAIFirewallStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallStatus)

#endif // OAIFirewallStatus_H
