...
#include "OAIStatefulRuleGroupOverride.h"
...
OAIStatefulRuleGroupOverride::OAIStatefulRuleGroupOverride(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulRuleGroupOverride::OAIStatefulRuleGroupOverride() {
    this->initializeModel();
}

OAIStatefulRuleGroupOverride::~OAIStatefulRuleGroupOverride() {}

void OAIStatefulRuleGroupOverride::initializeModel() {

    m_action_isSet = false;
    m_action_isValid = false;
}

void OAIStatefulRuleGroupOverride::fromJson(QString jsonString) {
...
void OAIStatefulRuleGroupOverride::fromJsonObject(QJsonObject json) {

    m_action_isValid = ::OpenAPI::fromJsonValue(m_action, json[QString("Action")]);
    m_action_isSet = !json[QString("Action")].isNull() && m_action_isValid;
}

QString OAIStatefulRuleGroupOverride::asJson() const {
...
QJsonObject OAIStatefulRuleGroupOverride::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAIOverrideAction OAIStatefulRuleGroupOverride::getAction() const {
    return m_action;
}
void OAIStatefulRuleGroupOverride::setAction(const OAIOverrideAction &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIStatefulRuleGroupOverride::is_action_Set() const{
    return m_action_isSet;
}

bool OAIStatefulRuleGroupOverride::is_action_Valid() const{
    return m_action_isValid;
}

bool OAIStatefulRuleGroupOverride::isSet() const {
...
bool OAIStatefulRuleGroupOverride::isValid() const {
