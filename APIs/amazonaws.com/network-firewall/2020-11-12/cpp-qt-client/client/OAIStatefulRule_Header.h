...
/*
 * OAIStatefulRule_Header.h
 *
 * 
 */

#ifndef OAIStatefulRule_Header_H
#define OAIStatefulRule_Header_H
...
class OAIStatefulRule_Header : public OAIObject {
public:
    OAIStatefulRule_Header();
    OAIStatefulRule_Header(QString json);
    ~OAIStatefulRule_Header() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRule_Header)

#endif // OAIStatefulRule_Header_H
