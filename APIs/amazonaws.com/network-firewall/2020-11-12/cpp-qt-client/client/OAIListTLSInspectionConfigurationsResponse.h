...
/*
 * OAIListTLSInspectionConfigurationsResponse.h
 *
 * 
 */

#ifndef OAIListTLSInspectionConfigurationsResponse_H
#define OAIListTLSInspectionConfigurationsResponse_H
...
class OAIListTLSInspectionConfigurationsResponse : public OAIObject {
public:
    OAIListTLSInspectionConfigurationsResponse();
    OAIListTLSInspectionConfigurationsResponse(QString json);
    ~OAIListTLSInspectionConfigurationsResponse() override;
    ...
    QList getTlsInspectionConfigurations() const;
    void setTlsInspectionConfigurations(const QList &tls_inspection_configurations);
    bool is_tls_inspection_configurations_Set() const;
    bool is_tls_inspection_configurations_Valid() const;
...
private:
    ...
    QList m_tls_inspection_configurations;
    bool m_tls_inspection_configurations_isSet;
    bool m_tls_inspection_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListTLSInspectionConfigurationsResponse)

#endif // OAIListTLSInspectionConfigurationsResponse_H
