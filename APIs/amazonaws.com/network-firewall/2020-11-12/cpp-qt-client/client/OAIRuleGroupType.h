...
#ifndef OAIRuleGroupType_H
#define OAIRuleGroupType_H
...
class OAIRuleGroupType : public OAIEnum {
public:
    OAIRuleGroupType();
    OAIRuleGroupType(QString json);
    ~OAIRuleGroupType() override;
    ...
    enum class eOAIRuleGroupType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        STATELESS, 
        STATEFUL
    };
    OAIRuleGroupType::eOAIRuleGroupType getValue() const;
    void setValue(const OAIRuleGroupType::eOAIRuleGroupType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupType)

#endif // OAIRuleGroupType_H
