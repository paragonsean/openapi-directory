...
/*
 * OAICreateFirewallPolicyRequest_FirewallPolicy.h
 *
 * 
 */

#ifndef OAICreateFirewallPolicyRequest_FirewallPolicy_H
#define OAICreateFirewallPolicyRequest_FirewallPolicy_H
...
class OAICreateFirewallPolicyRequest_FirewallPolicy : public OAIObject {
public:
    OAICreateFirewallPolicyRequest_FirewallPolicy();
    OAICreateFirewallPolicyRequest_FirewallPolicy(QString json);
    ~OAICreateFirewallPolicyRequest_FirewallPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallPolicyRequest_FirewallPolicy)

#endif // OAICreateFirewallPolicyRequest_FirewallPolicy_H
