...
QString OAIDescribeLoggingConfigurationResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDescribeLoggingConfigurationResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDescribeLoggingConfigurationResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDescribeLoggingConfigurationResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

OAILoggingConfiguration OAIDescribeLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIDescribeLoggingConfigurationResponse::setLoggingConfiguration(const OAILoggingConfiguration &logging_configuration) {
