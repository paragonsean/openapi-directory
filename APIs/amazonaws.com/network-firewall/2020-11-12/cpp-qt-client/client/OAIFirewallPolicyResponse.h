...
#ifndef OAIFirewallPolicyResponse_H
#define OAIFirewallPolicyResponse_H

#include <QJsonObject>

#include "OAIFirewallPolicyResponse_EncryptionConfiguration.h"
...
namespace OpenAPI {
class OAIFirewallPolicyResponse_EncryptionConfiguration;

class OAIFirewallPolicyResponse : public OAIObject {
public:
    OAIFirewallPolicyResponse();
    OAIFirewallPolicyResponse(QString json);
    ~OAIFirewallPolicyResponse() override;
    ...
    QString getFirewallPolicyName() const;
    void setFirewallPolicyName(const QString &firewall_policy_name);
    bool is_firewall_policy_name_Set() const;
    bool is_firewall_policy_name_Valid() const;
    ...
    QString getFirewallPolicyId() const;
    void setFirewallPolicyId(const QString &firewall_policy_id);
    bool is_firewall_policy_id_Set() const;
    bool is_firewall_policy_id_Valid() const;
    ...
    OAIResourceStatus getFirewallPolicyStatus() const;
    void setFirewallPolicyStatus(const OAIResourceStatus &firewall_policy_status);
    bool is_firewall_policy_status_Set() const;
    bool is_firewall_policy_status_Valid() const;
    ...
    qint32 getConsumedStatelessRuleCapacity() const;
    void setConsumedStatelessRuleCapacity(const qint32 &consumed_stateless_rule_capacity);
    bool is_consumed_stateless_rule_capacity_Set() const;
    bool is_consumed_stateless_rule_capacity_Valid() const;

    qint32 getConsumedStatefulRuleCapacity() const;
    void setConsumedStatefulRuleCapacity(const qint32 &consumed_stateful_rule_capacity);
    bool is_consumed_stateful_rule_capacity_Set() const;
    bool is_consumed_stateful_rule_capacity_Valid() const;
    ...
    OAIFirewallPolicyResponse_EncryptionConfiguration getEncryptionConfiguration() const;
    void setEncryptionConfiguration(const OAIFirewallPolicyResponse_EncryptionConfiguration &encryption_configuration);
...
private:
    ...
    QString m_firewall_policy_name;
    bool m_firewall_policy_name_isSet;
    bool m_firewall_policy_name_isValid;

    QString m_firewall_policy_arn;
    bool m_firewall_policy_arn_isSet;
    bool m_firewall_policy_arn_isValid;

    QString m_firewall_policy_id;
    bool m_firewall_policy_id_isSet;
    bool m_firewall_policy_id_isValid;

    QString m_description;
    bool m_description_isSet;
    bool m_description_isValid;

    OAIResourceStatus m_firewall_policy_status;
    bool m_firewall_policy_status_isSet;
    bool m_firewall_policy_status_isValid;

    QList m_tags;
    bool m_tags_isSet;
    bool m_tags_isValid;

    qint32 m_consumed_stateless_rule_capacity;
    bool m_consumed_stateless_rule_capacity_isSet;
    bool m_consumed_stateless_rule_capacity_isValid;

    qint32 m_consumed_stateful_rule_capacity;
    bool m_consumed_stateful_rule_capacity_isSet;
    bool m_consumed_stateful_rule_capacity_isValid;

    qint32 m_number_of_associations;
    bool m_number_of_associations_isSet;
    bool m_number_of_associations_isValid;

    OAIFirewallPolicyResponse_EncryptionConfiguration m_encryption_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirewallPolicyResponse)

#endif // OAIFirewallPolicyResponse_H
