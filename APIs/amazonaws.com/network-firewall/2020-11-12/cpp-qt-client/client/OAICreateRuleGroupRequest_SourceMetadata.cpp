...
OAICreateRuleGroupRequest_SourceMetadata::OAICreateRuleGroupRequest_SourceMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRuleGroupRequest_SourceMetadata::OAICreateRuleGroupRequest_SourceMetadata() {
    this->initializeModel();
}

OAICreateRuleGroupRequest_SourceMetadata::~OAICreateRuleGroupRequest_SourceMetadata() {}

void OAICreateRuleGroupRequest_SourceMetadata::initializeModel() {
...
void OAICreateRuleGroupRequest_SourceMetadata::fromJson(QString jsonString) {
...
void OAICreateRuleGroupRequest_SourceMetadata::fromJsonObject(QJsonObject json) {
...
QString OAICreateRuleGroupRequest_SourceMetadata::asJson() const {
...
QJsonObject OAICreateRuleGroupRequest_SourceMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRuleGroupRequest_SourceMetadata::getSourceArn() const {
    return m_source_arn;
}
void OAICreateRuleGroupRequest_SourceMetadata::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAICreateRuleGroupRequest_SourceMetadata::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAICreateRuleGroupRequest_SourceMetadata::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAICreateRuleGroupRequest_SourceMetadata::getSourceUpdateToken() const {
    return m_source_update_token;
}
void OAICreateRuleGroupRequest_SourceMetadata::setSourceUpdateToken(const QString &source_update_token) {
    m_source_update_token = source_update_token;
    m_source_update_token_isSet = true;
}

bool OAICreateRuleGroupRequest_SourceMetadata::is_source_update_token_Set() const{
    return m_source_update_token_isSet;
}

bool OAICreateRuleGroupRequest_SourceMetadata::is_source_update_token_Valid() const{
    return m_source_update_token_isValid;
}

bool OAICreateRuleGroupRequest_SourceMetadata::isSet() const {
...
bool OAICreateRuleGroupRequest_SourceMetadata::isValid() const {
