...
OAIFirewallPolicyResponse_EncryptionConfiguration::OAIFirewallPolicyResponse_EncryptionConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFirewallPolicyResponse_EncryptionConfiguration::OAIFirewallPolicyResponse_EncryptionConfiguration() {
    this->initializeModel();
}

OAIFirewallPolicyResponse_EncryptionConfiguration::~OAIFirewallPolicyResponse_EncryptionConfiguration() {}

void OAIFirewallPolicyResponse_EncryptionConfiguration::initializeModel() {
...
void OAIFirewallPolicyResponse_EncryptionConfiguration::fromJson(QString jsonString) {
...
void OAIFirewallPolicyResponse_EncryptionConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFirewallPolicyResponse_EncryptionConfiguration::asJson() const {
...
QJsonObject OAIFirewallPolicyResponse_EncryptionConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_key_id_isSet) {
...
QString OAIFirewallPolicyResponse_EncryptionConfiguration::getKeyId() const {
    return m_key_id;
}
void OAIFirewallPolicyResponse_EncryptionConfiguration::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIFirewallPolicyResponse_EncryptionConfiguration::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIFirewallPolicyResponse_EncryptionConfiguration::is_key_id_Valid() const{
    return m_key_id_isValid;
}

OAIEncryptionType OAIFirewallPolicyResponse_EncryptionConfiguration::getType() const {
    return m_type;
}
void OAIFirewallPolicyResponse_EncryptionConfiguration::setType(const OAIEncryptionType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFirewallPolicyResponse_EncryptionConfiguration::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFirewallPolicyResponse_EncryptionConfiguration::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFirewallPolicyResponse_EncryptionConfiguration::isSet() const {
...
bool OAIFirewallPolicyResponse_EncryptionConfiguration::isValid() const {
