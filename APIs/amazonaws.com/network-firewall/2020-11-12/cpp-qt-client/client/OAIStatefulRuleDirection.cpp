...
OAIStatefulRuleDirection::OAIStatefulRuleDirection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulRuleDirection::OAIStatefulRuleDirection() {
    this->initializeModel();
}

OAIStatefulRuleDirection::~OAIStatefulRuleDirection() {}

void OAIStatefulRuleDirection::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStatefulRuleDirection::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStatefulRuleDirection::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FORWARD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulRuleDirection::FORWARD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ANY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulRuleDirection::ANY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStatefulRuleDirection::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStatefulRuleDirection::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStatefulRuleDirection::FORWARD:
            val = "FORWARD";
            break;
        case eOAIStatefulRuleDirection::ANY:
            val = "ANY";
            break;
        default:
            break;
...
QJsonValue OAIStatefulRuleDirection::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStatefulRuleDirection::eOAIStatefulRuleDirection OAIStatefulRuleDirection::getValue() const {
    return m_value;
}

void OAIStatefulRuleDirection::setValue(const OAIStatefulRuleDirection::eOAIStatefulRuleDirection& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStatefulRuleDirection::isSet() const {
    
    return m_value_isSet;
}

bool OAIStatefulRuleDirection::isValid() const {
