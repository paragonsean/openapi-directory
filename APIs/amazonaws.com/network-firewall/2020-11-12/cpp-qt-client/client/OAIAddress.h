...
public:
    ...
    QString getAddressDefinition() const;
    void setAddressDefinition(const QString &address_definition);
    bool is_address_definition_Set() const;
    bool is_address_definition_Valid() const;
...
private:
    ...
    QString m_address_definition;
    bool m_address_definition_isSet;
    bool m_address_definition_isValid;
};
