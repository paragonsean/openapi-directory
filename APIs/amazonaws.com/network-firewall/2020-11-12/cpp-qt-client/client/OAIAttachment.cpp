...
QString OAIAttachment::getSubnetId() const {
    return m_subnet_id;
}
void OAIAttachment::setSubnetId(const QString &subnet_id) {
    m_subnet_id = subnet_id;
    m_subnet_id_isSet = true;
}

bool OAIAttachment::is_subnet_id_Set() const{
    return m_subnet_id_isSet;
}

bool OAIAttachment::is_subnet_id_Valid() const{
    return m_subnet_id_isValid;
}

QString OAIAttachment::getEndpointId() const {
    return m_endpoint_id;
}
void OAIAttachment::setEndpointId(const QString &endpoint_id) {
    m_endpoint_id = endpoint_id;
    m_endpoint_id_isSet = true;
}

bool OAIAttachment::is_endpoint_id_Set() const{
    return m_endpoint_id_isSet;
}

bool OAIAttachment::is_endpoint_id_Valid() const{
    return m_endpoint_id_isValid;
}

OAIAttachmentStatus OAIAttachment::getStatus() const {
    return m_status;
}
void OAIAttachment::setStatus(const OAIAttachmentStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QString OAIAttachment::getStatusMessage() const {
    return m_status_message;
}
void OAIAttachment::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIAttachment::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIAttachment::is_status_message_Valid() const{
