...
OAIDescribeRuleGroupMetadataRequest::OAIDescribeRuleGroupMetadataRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRuleGroupMetadataRequest::OAIDescribeRuleGroupMetadataRequest() {
    this->initializeModel();
}

OAIDescribeRuleGroupMetadataRequest::~OAIDescribeRuleGroupMetadataRequest() {}

void OAIDescribeRuleGroupMetadataRequest::initializeModel() {
...
void OAIDescribeRuleGroupMetadataRequest::fromJson(QString jsonString) {
...
void OAIDescribeRuleGroupMetadataRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRuleGroupMetadataRequest::asJson() const {
...
QJsonObject OAIDescribeRuleGroupMetadataRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeRuleGroupMetadataRequest::getRuleGroupName() const {
    return m_rule_group_name;
}
void OAIDescribeRuleGroupMetadataRequest::setRuleGroupName(const QString &rule_group_name) {
    m_rule_group_name = rule_group_name;
    m_rule_group_name_isSet = true;
}

bool OAIDescribeRuleGroupMetadataRequest::is_rule_group_name_Set() const{
    return m_rule_group_name_isSet;
}

bool OAIDescribeRuleGroupMetadataRequest::is_rule_group_name_Valid() const{
    return m_rule_group_name_isValid;
}

QString OAIDescribeRuleGroupMetadataRequest::getRuleGroupArn() const {
    return m_rule_group_arn;
}
void OAIDescribeRuleGroupMetadataRequest::setRuleGroupArn(const QString &rule_group_arn) {
    m_rule_group_arn = rule_group_arn;
    m_rule_group_arn_isSet = true;
}

bool OAIDescribeRuleGroupMetadataRequest::is_rule_group_arn_Set() const{
    return m_rule_group_arn_isSet;
}

bool OAIDescribeRuleGroupMetadataRequest::is_rule_group_arn_Valid() const{
    return m_rule_group_arn_isValid;
}

OAIRuleGroupType OAIDescribeRuleGroupMetadataRequest::getType() const {
    return m_type;
}
void OAIDescribeRuleGroupMetadataRequest::setType(const OAIRuleGroupType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDescribeRuleGroupMetadataRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDescribeRuleGroupMetadataRequest::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDescribeRuleGroupMetadataRequest::isSet() const {
...
bool OAIDescribeRuleGroupMetadataRequest::isValid() const {
