...
OAIRuleDefinition_MatchAttributes::OAIRuleDefinition_MatchAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRuleDefinition_MatchAttributes::OAIRuleDefinition_MatchAttributes() {
    this->initializeModel();
}

OAIRuleDefinition_MatchAttributes::~OAIRuleDefinition_MatchAttributes() {}

void OAIRuleDefinition_MatchAttributes::initializeModel() {
...
void OAIRuleDefinition_MatchAttributes::fromJson(QString jsonString) {
...
void OAIRuleDefinition_MatchAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIRuleDefinition_MatchAttributes::asJson() const {
...
QJsonObject OAIRuleDefinition_MatchAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_sources.isSet()) {
...
QList OAIRuleDefinition_MatchAttributes::getSources() const {
    return m_sources;
}
void OAIRuleDefinition_MatchAttributes::setSources(const QList &sources) {
    m_sources = sources;
    m_sources_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_sources_Set() const{
    return m_sources_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_sources_Valid() const{
    return m_sources_isValid;
}

QList OAIRuleDefinition_MatchAttributes::getDestinations() const {
    return m_destinations;
}
void OAIRuleDefinition_MatchAttributes::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList OAIRuleDefinition_MatchAttributes::getSourcePorts() const {
    return m_source_ports;
}
void OAIRuleDefinition_MatchAttributes::setSourcePorts(const QList &source_ports) {
    m_source_ports = source_ports;
    m_source_ports_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_source_ports_Set() const{
    return m_source_ports_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_source_ports_Valid() const{
    return m_source_ports_isValid;
}

QList OAIRuleDefinition_MatchAttributes::getDestinationPorts() const {
    return m_destination_ports;
}
void OAIRuleDefinition_MatchAttributes::setDestinationPorts(const QList &destination_ports) {
    m_destination_ports = destination_ports;
    m_destination_ports_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_destination_ports_Set() const{
    return m_destination_ports_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_destination_ports_Valid() const{
    return m_destination_ports_isValid;
}

QList OAIRuleDefinition_MatchAttributes::getProtocols() const {
    return m_protocols;
}
void OAIRuleDefinition_MatchAttributes::setProtocols(const QList &protocols) {
    m_protocols = protocols;
    m_protocols_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_protocols_Set() const{
    return m_protocols_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_protocols_Valid() const{
    return m_protocols_isValid;
}

QList OAIRuleDefinition_MatchAttributes::getTcpFlags() const {
    return m_tcp_flags;
}
void OAIRuleDefinition_MatchAttributes::setTcpFlags(const QList &tcp_flags) {
    m_tcp_flags = tcp_flags;
    m_tcp_flags_isSet = true;
}

bool OAIRuleDefinition_MatchAttributes::is_tcp_flags_Set() const{
    return m_tcp_flags_isSet;
}

bool OAIRuleDefinition_MatchAttributes::is_tcp_flags_Valid() const{
    return m_tcp_flags_isValid;
}

bool OAIRuleDefinition_MatchAttributes::isSet() const {
...
bool OAIRuleDefinition_MatchAttributes::isValid() const {
