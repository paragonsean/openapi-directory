...
/*
 * OAIStatefulRuleGroupReference_Override.h
 *
 * 
 */

#ifndef OAIStatefulRuleGroupReference_Override_H
#define OAIStatefulRuleGroupReference_Override_H
...
class OAIStatefulRuleGroupReference_Override : public OAIObject {
public:
    OAIStatefulRuleGroupReference_Override();
    OAIStatefulRuleGroupReference_Override(QString json);
    ~OAIStatefulRuleGroupReference_Override() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleGroupReference_Override)

#endif // OAIStatefulRuleGroupReference_Override_H
