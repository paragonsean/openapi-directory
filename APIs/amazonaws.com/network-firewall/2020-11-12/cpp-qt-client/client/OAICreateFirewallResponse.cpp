...
OAICreateFirewallResponse_Firewall OAICreateFirewallResponse::getFirewall() const {
    return m_firewall;
}
void OAICreateFirewallResponse::setFirewall(const OAICreateFirewallResponse_Firewall &firewall) {
    m_firewall = firewall;
...
OAICreateFirewallResponse_FirewallStatus OAICreateFirewallResponse::getFirewallStatus() const {
    return m_firewall_status;
}
void OAICreateFirewallResponse::setFirewallStatus(const OAICreateFirewallResponse_FirewallStatus &firewall_status) {
    m_firewall_status = firewall_status;
    m_firewall_status_isSet = true;
}

bool OAICreateFirewallResponse::is_firewall_status_Set() const{
    return m_firewall_status_isSet;
}

bool OAICreateFirewallResponse::is_firewall_status_Valid() const{
