...
void OAILogDestinationType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("CloudWatchLogs", Qt::CaseInsensitive) == 0) {
        m_value = eOAILogDestinationType::CLOUDWATCHLOGS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("KinesisDataFirehose", Qt::CaseInsensitive) == 0) {
        m_value = eOAILogDestinationType::KINESISDATAFIREHOSE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAILogDestinationType::asJson() const {
    ...
    switch (m_value){
        case eOAILogDestinationType::S3:
            val = "S3";
            break;
        case eOAILogDestinationType::CLOUDWATCHLOGS:
            val = "CloudWatchLogs";
            break;
        case eOAILogDestinationType::KINESISDATAFIREHOSE:
            val = "KinesisDataFirehose";
            break;
        default:
            break;
    }
