...
/*
 * OAIStatelessRuleGroupReference.h
 *
 * Identifier for a single stateless rule group, used in a firewall policy to refer to the rule group. 
 */

#ifndef OAIStatelessRuleGroupReference_H
#define OAIStatelessRuleGroupReference_H
...
class OAIStatelessRuleGroupReference : public OAIObject {
public:
    OAIStatelessRuleGroupReference();
    OAIStatelessRuleGroupReference(QString json);
    ~OAIStatelessRuleGroupReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessRuleGroupReference)

#endif // OAIStatelessRuleGroupReference_H
