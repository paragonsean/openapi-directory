...
OAIDeleteFirewallPolicyResponse::OAIDeleteFirewallPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFirewallPolicyResponse::OAIDeleteFirewallPolicyResponse() {
    this->initializeModel();
}

OAIDeleteFirewallPolicyResponse::~OAIDeleteFirewallPolicyResponse() {}

void OAIDeleteFirewallPolicyResponse::initializeModel() {

    m_firewall_policy_response_isSet = false;
    m_firewall_policy_response_isValid = false;
}

void OAIDeleteFirewallPolicyResponse::fromJson(QString jsonString) {
...
void OAIDeleteFirewallPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFirewallPolicyResponse::asJson() const {
...
QJsonObject OAIDeleteFirewallPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse OAIDeleteFirewallPolicyResponse::getFirewallPolicyResponse() const {
    return m_firewall_policy_response;
}
void OAIDeleteFirewallPolicyResponse::setFirewallPolicyResponse(const OAIDeleteFirewallPolicyResponse_FirewallPolicyResponse &firewall_policy_response) {
    m_firewall_policy_response = firewall_policy_response;
    m_firewall_policy_response_isSet = true;
}

bool OAIDeleteFirewallPolicyResponse::is_firewall_policy_response_Set() const{
    return m_firewall_policy_response_isSet;
}

bool OAIDeleteFirewallPolicyResponse::is_firewall_policy_response_Valid() const{
    return m_firewall_policy_response_isValid;
}

bool OAIDeleteFirewallPolicyResponse::isSet() const {
...
bool OAIDeleteFirewallPolicyResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_firewall_policy_response_isValid && true;
}
