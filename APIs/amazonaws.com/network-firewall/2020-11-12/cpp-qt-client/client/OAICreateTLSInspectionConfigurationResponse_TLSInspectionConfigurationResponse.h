...
/*
 * OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse.h
 *
 * 
 */

#ifndef OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse_H
#define OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse_H
...
class OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse : public OAIObject {
public:
    OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse();
    OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse(QString json);
    ~OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse() override;
    ...
    QString getTlsInspectionConfigurationId() const;
    void setTlsInspectionConfigurationId(const QString &tls_inspection_configuration_id);
    bool is_tls_inspection_configuration_id_Set() const;
    bool is_tls_inspection_configuration_id_Valid() const;

    OAIResourceStatus getTlsInspectionConfigurationStatus() const;
    void setTlsInspectionConfigurationStatus(const OAIResourceStatus &tls_inspection_configuration_status);
    bool is_tls_inspection_configuration_status_Set() const;
    bool is_tls_inspection_configuration_status_Valid() const;
...
private:
    ...
    QString m_tls_inspection_configuration_id;
    bool m_tls_inspection_configuration_id_isSet;
    bool m_tls_inspection_configuration_id_isValid;

    OAIResourceStatus m_tls_inspection_configuration_status;
    bool m_tls_inspection_configuration_status_isSet;
    bool m_tls_inspection_configuration_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse)

#endif // OAICreateTLSInspectionConfigurationResponse_TLSInspectionConfigurationResponse_H
