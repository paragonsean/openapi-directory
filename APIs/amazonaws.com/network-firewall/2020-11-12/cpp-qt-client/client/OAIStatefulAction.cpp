...
OAIStatefulAction::OAIStatefulAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatefulAction::OAIStatefulAction() {
    this->initializeModel();
}

OAIStatefulAction::~OAIStatefulAction() {}

void OAIStatefulAction::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStatefulAction::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStatefulAction::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PASS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulAction::PASS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DROP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulAction::DROP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALERT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulAction::ALERT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REJECT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStatefulAction::REJECT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStatefulAction::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStatefulAction::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStatefulAction::PASS:
            val = "PASS";
            break;
        case eOAIStatefulAction::DROP:
            val = "DROP";
            break;
        case eOAIStatefulAction::ALERT:
            val = "ALERT";
            break;
        case eOAIStatefulAction::REJECT:
            val = "REJECT";
            break;
        default:
            break;
...
QJsonValue OAIStatefulAction::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStatefulAction::eOAIStatefulAction OAIStatefulAction::getValue() const {
    return m_value;
}

void OAIStatefulAction::setValue(const OAIStatefulAction::eOAIStatefulAction& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStatefulAction::isSet() const {
    
    return m_value_isSet;
}

bool OAIStatefulAction::isValid() const {
