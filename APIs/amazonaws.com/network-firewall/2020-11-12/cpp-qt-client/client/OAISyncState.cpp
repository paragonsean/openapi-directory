...
OAISyncState::OAISyncState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISyncState::OAISyncState() {
    this->initializeModel();
}

OAISyncState::~OAISyncState() {}

void OAISyncState::initializeModel() {
...
void OAISyncState::fromJson(QString jsonString) {
...
void OAISyncState::fromJsonObject(QJsonObject json) {
...
QString OAISyncState::asJson() const {
...
QJsonObject OAISyncState::asJsonObject() const {
    QJsonObject obj;
...
OAISyncState_Attachment OAISyncState::getAttachment() const {
    return m_attachment;
}
void OAISyncState::setAttachment(const OAISyncState_Attachment &attachment) {
    m_attachment = attachment;
    m_attachment_isSet = true;
}

bool OAISyncState::is_attachment_Set() const{
    return m_attachment_isSet;
}

bool OAISyncState::is_attachment_Valid() const{
    return m_attachment_isValid;
}

QMap OAISyncState::getConfig() const {
    return m_config;
}
void OAISyncState::setConfig(const QMap &config) {
    m_config = config;
    m_config_isSet = true;
}

bool OAISyncState::is_config_Set() const{
    return m_config_isSet;
}

bool OAISyncState::is_config_Valid() const{
    return m_config_isValid;
}

bool OAISyncState::isSet() const {
...
bool OAISyncState::isValid() const {
