...
/*
 * OAIUpdateRuleGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateRuleGroupResponse_H
#define OAIUpdateRuleGroupResponse_H
...
class OAIUpdateRuleGroupResponse : public OAIObject {
public:
    OAIUpdateRuleGroupResponse();
    OAIUpdateRuleGroupResponse(QString json);
    ~OAIUpdateRuleGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRuleGroupResponse)

#endif // OAIUpdateRuleGroupResponse_H
