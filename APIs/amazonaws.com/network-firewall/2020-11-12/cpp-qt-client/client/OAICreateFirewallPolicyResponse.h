...
/*
 * OAICreateFirewallPolicyResponse.h
 *
 * 
 */

#ifndef OAICreateFirewallPolicyResponse_H
#define OAICreateFirewallPolicyResponse_H
...
class OAICreateFirewallPolicyResponse : public OAIObject {
public:
    OAICreateFirewallPolicyResponse();
    OAICreateFirewallPolicyResponse(QString json);
    ~OAICreateFirewallPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFirewallPolicyResponse)

#endif // OAICreateFirewallPolicyResponse_H
