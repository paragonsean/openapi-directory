...
OAIUpdateRuleGroupResponse::OAIUpdateRuleGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRuleGroupResponse::OAIUpdateRuleGroupResponse() {
    this->initializeModel();
}

OAIUpdateRuleGroupResponse::~OAIUpdateRuleGroupResponse() {}

void OAIUpdateRuleGroupResponse::initializeModel() {

    m_update_token_isSet = false;
    m_update_token_isValid = false;

    m_rule_group_response_isSet = false;
    m_rule_group_response_isValid = false;
}

void OAIUpdateRuleGroupResponse::fromJson(QString jsonString) {
...
void OAIUpdateRuleGroupResponse::fromJsonObject(QJsonObject json) {
    ...
    m_rule_group_response_isValid = ::OpenAPI::fromJsonValue(m_rule_group_response, json[QString("RuleGroupResponse")]);
    m_rule_group_response_isSet = !json[QString("RuleGroupResponse")].isNull() && m_rule_group_response_isValid;
}

QString OAIUpdateRuleGroupResponse::asJson() const {
...
QJsonObject OAIUpdateRuleGroupResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_update_token_isSet) {
        obj.insert(QString("UpdateToken"), ::OpenAPI::toJsonValue(m_update_token));
    }
    if (m_rule_group_response.isSet()) {
        obj.insert(QString("RuleGroupResponse"), ::OpenAPI::toJsonValue(m_rule_group_response));
    }
    return obj;
}

QString OAIUpdateRuleGroupResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIUpdateRuleGroupResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIUpdateRuleGroupResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIUpdateRuleGroupResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateRuleGroupResponse_RuleGroupResponse OAIUpdateRuleGroupResponse::getRuleGroupResponse() const {
    return m_rule_group_response;
}
void OAIUpdateRuleGroupResponse::setRuleGroupResponse(const OAICreateRuleGroupResponse_RuleGroupResponse &rule_group_response) {
    m_rule_group_response = rule_group_response;
    m_rule_group_response_isSet = true;
}

bool OAIUpdateRuleGroupResponse::is_rule_group_response_Set() const{
    return m_rule_group_response_isSet;
}

bool OAIUpdateRuleGroupResponse::is_rule_group_response_Valid() const{
    return m_rule_group_response_isValid;
}

bool OAIUpdateRuleGroupResponse::isSet() const {
...
bool OAIUpdateRuleGroupResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_update_token_isValid && m_rule_group_response_isValid && true;
}
