...
/*
 * OAIDisassociateSubnetsRequest.h
 *
 * 
 */

#ifndef OAIDisassociateSubnetsRequest_H
#define OAIDisassociateSubnetsRequest_H
...
class OAIDisassociateSubnetsRequest : public OAIObject {
public:
    OAIDisassociateSubnetsRequest();
    OAIDisassociateSubnetsRequest(QString json);
    ~OAIDisassociateSubnetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateSubnetsRequest)

#endif // OAIDisassociateSubnetsRequest_H
