...
OAIAssociateFirewallPolicyRequest::OAIAssociateFirewallPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateFirewallPolicyRequest::OAIAssociateFirewallPolicyRequest() {
    this->initializeModel();
}

OAIAssociateFirewallPolicyRequest::~OAIAssociateFirewallPolicyRequest() {}

void OAIAssociateFirewallPolicyRequest::initializeModel() {
...
void OAIAssociateFirewallPolicyRequest::fromJson(QString jsonString) {
...
void OAIAssociateFirewallPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateFirewallPolicyRequest::asJson() const {
...
QJsonObject OAIAssociateFirewallPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateFirewallPolicyRequest::getUpdateToken() const {
    return m_update_token;
}
void OAIAssociateFirewallPolicyRequest::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIAssociateFirewallPolicyRequest::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIAssociateFirewallPolicyRequest::is_update_token_Valid() const{
    return m_update_token_isValid;
}

QString OAIAssociateFirewallPolicyRequest::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIAssociateFirewallPolicyRequest::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIAssociateFirewallPolicyRequest::getFirewallName() const {
    return m_firewall_name;
}
void OAIAssociateFirewallPolicyRequest::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QString OAIAssociateFirewallPolicyRequest::getFirewallPolicyArn() const {
    return m_firewall_policy_arn;
}
void OAIAssociateFirewallPolicyRequest::setFirewallPolicyArn(const QString &firewall_policy_arn) {
    m_firewall_policy_arn = firewall_policy_arn;
    m_firewall_policy_arn_isSet = true;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_policy_arn_Set() const{
    return m_firewall_policy_arn_isSet;
}

bool OAIAssociateFirewallPolicyRequest::is_firewall_policy_arn_Valid() const{
    return m_firewall_policy_arn_isValid;
}

bool OAIAssociateFirewallPolicyRequest::isSet() const {
...
bool OAIAssociateFirewallPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_firewall_policy_arn_isValid && true;
}
