...
/*
 * OAIStatefulRuleDirection.h
 *
 * 
 */

#ifndef OAIStatefulRuleDirection_H
#define OAIStatefulRuleDirection_H
...
class OAIStatefulRuleDirection : public OAIEnum {
public:
    OAIStatefulRuleDirection();
    OAIStatefulRuleDirection(QString json);
    ~OAIStatefulRuleDirection() override;
    ...
    enum class eOAIStatefulRuleDirection {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FORWARD, 
        ANY
    };
    OAIStatefulRuleDirection::eOAIStatefulRuleDirection getValue() const;
    void setValue(const OAIStatefulRuleDirection::eOAIStatefulRuleDirection& value);
...
private:
    ...
    eOAIStatefulRuleDirection m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatefulRuleDirection)

#endif // OAIStatefulRuleDirection_H
