...
/*
 * OAIStatelessRulesAndCustomActions.h
 *
 * Stateless inspection criteria. Each stateless rule group uses exactly one of these data types to define its stateless rules. 
 */

#ifndef OAIStatelessRulesAndCustomActions_H
#define OAIStatelessRulesAndCustomActions_H
...
class OAIStatelessRulesAndCustomActions : public OAIObject {
public:
    OAIStatelessRulesAndCustomActions();
    OAIStatelessRulesAndCustomActions(QString json);
    ~OAIStatelessRulesAndCustomActions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatelessRulesAndCustomActions)

#endif // OAIStatelessRulesAndCustomActions_H
