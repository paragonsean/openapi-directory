...
OAIDisassociateSubnetsResponse::OAIDisassociateSubnetsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateSubnetsResponse::OAIDisassociateSubnetsResponse() {
    this->initializeModel();
}

OAIDisassociateSubnetsResponse::~OAIDisassociateSubnetsResponse() {}

void OAIDisassociateSubnetsResponse::initializeModel() {
...
void OAIDisassociateSubnetsResponse::fromJson(QString jsonString) {
...
void OAIDisassociateSubnetsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateSubnetsResponse::asJson() const {
...
QJsonObject OAIDisassociateSubnetsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDisassociateSubnetsResponse::getFirewallArn() const {
    return m_firewall_arn;
}
void OAIDisassociateSubnetsResponse::setFirewallArn(const QString &firewall_arn) {
    m_firewall_arn = firewall_arn;
    m_firewall_arn_isSet = true;
}

bool OAIDisassociateSubnetsResponse::is_firewall_arn_Set() const{
    return m_firewall_arn_isSet;
}

bool OAIDisassociateSubnetsResponse::is_firewall_arn_Valid() const{
    return m_firewall_arn_isValid;
}

QString OAIDisassociateSubnetsResponse::getFirewallName() const {
    return m_firewall_name;
}
void OAIDisassociateSubnetsResponse::setFirewallName(const QString &firewall_name) {
    m_firewall_name = firewall_name;
    m_firewall_name_isSet = true;
}

bool OAIDisassociateSubnetsResponse::is_firewall_name_Set() const{
    return m_firewall_name_isSet;
}

bool OAIDisassociateSubnetsResponse::is_firewall_name_Valid() const{
    return m_firewall_name_isValid;
}

QList OAIDisassociateSubnetsResponse::getSubnetMappings() const {
    return m_subnet_mappings;
}
void OAIDisassociateSubnetsResponse::setSubnetMappings(const QList &subnet_mappings) {
    m_subnet_mappings = subnet_mappings;
    m_subnet_mappings_isSet = true;
}

bool OAIDisassociateSubnetsResponse::is_subnet_mappings_Set() const{
    return m_subnet_mappings_isSet;
}

bool OAIDisassociateSubnetsResponse::is_subnet_mappings_Valid() const{
    return m_subnet_mappings_isValid;
}

QString OAIDisassociateSubnetsResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIDisassociateSubnetsResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIDisassociateSubnetsResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIDisassociateSubnetsResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

bool OAIDisassociateSubnetsResponse::isSet() const {
...
bool OAIDisassociateSubnetsResponse::isValid() const {
