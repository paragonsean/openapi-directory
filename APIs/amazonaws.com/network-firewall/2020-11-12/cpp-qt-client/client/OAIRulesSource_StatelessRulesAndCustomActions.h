...
/*
 * OAIRulesSource_StatelessRulesAndCustomActions.h
 *
 * 
 */

#ifndef OAIRulesSource_StatelessRulesAndCustomActions_H
#define OAIRulesSource_StatelessRulesAndCustomActions_H
...
class OAIRulesSource_StatelessRulesAndCustomActions : public OAIObject {
public:
    OAIRulesSource_StatelessRulesAndCustomActions();
    OAIRulesSource_StatelessRulesAndCustomActions(QString json);
    ~OAIRulesSource_StatelessRulesAndCustomActions() override;
    ...
    QList getStatelessRules() const;
    void setStatelessRules(const QList &stateless_rules);
    bool is_stateless_rules_Set() const;
    bool is_stateless_rules_Valid() const;

    QList getCustomActions() const;
    void setCustomActions(const QList &custom_actions);
...
private:
    ...
    QList m_stateless_rules;
    bool m_stateless_rules_isSet;
    bool m_stateless_rules_isValid;

    QList m_custom_actions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRulesSource_StatelessRulesAndCustomActions)

#endif // OAIRulesSource_StatelessRulesAndCustomActions_H
