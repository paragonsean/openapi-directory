...
OAIDescribeFirewallResponse::OAIDescribeFirewallResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeFirewallResponse::OAIDescribeFirewallResponse() {
    this->initializeModel();
}

OAIDescribeFirewallResponse::~OAIDescribeFirewallResponse() {}

void OAIDescribeFirewallResponse::initializeModel() {
...
void OAIDescribeFirewallResponse::fromJson(QString jsonString) {
...
void OAIDescribeFirewallResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeFirewallResponse::asJson() const {
...
QJsonObject OAIDescribeFirewallResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeFirewallResponse::getUpdateToken() const {
    return m_update_token;
}
void OAIDescribeFirewallResponse::setUpdateToken(const QString &update_token) {
    m_update_token = update_token;
    m_update_token_isSet = true;
}

bool OAIDescribeFirewallResponse::is_update_token_Set() const{
    return m_update_token_isSet;
}

bool OAIDescribeFirewallResponse::is_update_token_Valid() const{
    return m_update_token_isValid;
}

OAICreateFirewallResponse_Firewall OAIDescribeFirewallResponse::getFirewall() const {
    return m_firewall;
}
void OAIDescribeFirewallResponse::setFirewall(const OAICreateFirewallResponse_Firewall &firewall) {
    m_firewall = firewall;
    m_firewall_isSet = true;
}

bool OAIDescribeFirewallResponse::is_firewall_Set() const{
    return m_firewall_isSet;
}

bool OAIDescribeFirewallResponse::is_firewall_Valid() const{
    return m_firewall_isValid;
}

OAICreateFirewallResponse_FirewallStatus OAIDescribeFirewallResponse::getFirewallStatus() const {
    return m_firewall_status;
}
void OAIDescribeFirewallResponse::setFirewallStatus(const OAICreateFirewallResponse_FirewallStatus &firewall_status) {
    m_firewall_status = firewall_status;
    m_firewall_status_isSet = true;
}

bool OAIDescribeFirewallResponse::is_firewall_status_Set() const{
    return m_firewall_status_isSet;
}

bool OAIDescribeFirewallResponse::is_firewall_status_Valid() const{
    return m_firewall_status_isValid;
}

bool OAIDescribeFirewallResponse::isSet() const {
...
bool OAIDescribeFirewallResponse::isValid() const {
