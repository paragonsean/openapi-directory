...
class DescribeRuleGroupResponseRuleGroup(Model):
    ...
    def __init__(self, rule_variables: RuleGroupRuleVariables=None, reference_sets: RuleGroupReferenceSets=None, rules_source: RuleGroupRulesSource=None, stateful_rule_options: RuleGroupStatefulRuleOptions=None):
        """DescribeRuleGroupResponseRuleGroup - a model defined in OpenAPI

        :param rule_variables: The rule_variables of this DescribeRuleGroupResponseRuleGroup.
        :param reference_sets: The reference_sets of this DescribeRuleGroupResponseRuleGroup.
        :param rules_source: The rules_source of this DescribeRuleGroupResponseRuleGroup.
        :param stateful_rule_options: The stateful_rule_options of this DescribeRuleGroupResponseRuleGroup.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeRuleGroupResponseRuleGroup':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeRuleGroupResponse_RuleGroup of this DescribeRuleGroupResponseRuleGroup.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def rule_variables(self):
        """Gets the rule_variables of this DescribeRuleGroupResponseRuleGroup.


        :return: The rule_variables of this DescribeRuleGroupResponseRuleGroup.
    ...
    def rule_variables(self, rule_variables):
        """Sets the rule_variables of this DescribeRuleGroupResponseRuleGroup.
    ...
    def reference_sets(self):
        """Gets the reference_sets of this DescribeRuleGroupResponseRuleGroup.


        :return: The reference_sets of this DescribeRuleGroupResponseRuleGroup.
    ...
    def reference_sets(self, reference_sets):
        """Sets the reference_sets of this DescribeRuleGroupResponseRuleGroup.
    ...
    def rules_source(self):
        """Gets the rules_source of this DescribeRuleGroupResponseRuleGroup.


        :return: The rules_source of this DescribeRuleGroupResponseRuleGroup.
    ...
    def rules_source(self, rules_source):
        """Sets the rules_source of this DescribeRuleGroupResponseRuleGroup.
    ...
    def stateful_rule_options(self):
        """Gets the stateful_rule_options of this DescribeRuleGroupResponseRuleGroup.


        :return: The stateful_rule_options of this DescribeRuleGroupResponseRuleGroup.
    ...
    def stateful_rule_options(self, stateful_rule_options):
        """Sets the stateful_rule_options of this DescribeRuleGroupResponseRuleGroup.
