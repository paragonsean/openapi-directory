...
class DeleteRuleGroupRequest(Model):
    ...
    def __init__(self, rule_group_name: str=None, rule_group_arn: str=None, type: RuleGroupType=None):
        ...
        :param rule_group_name: The rule_group_name of this DeleteRuleGroupRequest.
        :param rule_group_arn: The rule_group_arn of this DeleteRuleGroupRequest.
        :param type: The type of this DeleteRuleGroupRequest.
        """
        self.openapi_types = {
            'rule_group_name': str,
            'rule_group_arn': str,
    ...
    def rule_group_name(self):
        """Gets the rule_group_name of this DeleteRuleGroupRequest.


        :return: The rule_group_name of this DeleteRuleGroupRequest.
        :rtype: str
        """
    ...
    def rule_group_name(self, rule_group_name):
        """Sets the rule_group_name of this DeleteRuleGroupRequest.
    ...
    def rule_group_arn(self):
        """Gets the rule_group_arn of this DeleteRuleGroupRequest.


        :return: The rule_group_arn of this DeleteRuleGroupRequest.
        :rtype: str
        """
    ...
    def rule_group_arn(self, rule_group_arn):
        """Sets the rule_group_arn of this DeleteRuleGroupRequest.
    ...
    @property
    def type(self):
        """Gets the type of this DeleteRuleGroupRequest.


        :return: The type of this DeleteRuleGroupRequest.
        :rtype: RuleGroupType
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DeleteRuleGroupRequest.
