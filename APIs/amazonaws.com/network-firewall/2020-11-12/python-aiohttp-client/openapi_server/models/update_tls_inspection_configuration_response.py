...
class UpdateTLSInspectionConfigurationResponse(Model):
    ...
    def __init__(self, update_token: str=None, tls_inspection_configuration_response: CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse=None):
        """UpdateTLSInspectionConfigurationResponse - a model defined in OpenAPI

        :param update_token: The update_token of this UpdateTLSInspectionConfigurationResponse.
        :param tls_inspection_configuration_response: The tls_inspection_configuration_response of this UpdateTLSInspectionConfigurationResponse.
        """
        self.openapi_types = {
            'update_token': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateTLSInspectionConfigurationResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateTLSInspectionConfigurationResponse of this UpdateTLSInspectionConfigurationResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def update_token(self):
        """Gets the update_token of this UpdateTLSInspectionConfigurationResponse.


        :return: The update_token of this UpdateTLSInspectionConfigurationResponse.
        :rtype: str
        """
    ...
    def update_token(self, update_token):
        """Sets the update_token of this UpdateTLSInspectionConfigurationResponse.
    ...
    def tls_inspection_configuration_response(self):
        """Gets the tls_inspection_configuration_response of this UpdateTLSInspectionConfigurationResponse.


        :return: The tls_inspection_configuration_response of this UpdateTLSInspectionConfigurationResponse.
    ...
    def tls_inspection_configuration_response(self, tls_inspection_configuration_response):
        """Sets the tls_inspection_configuration_response of this UpdateTLSInspectionConfigurationResponse.
