...
class FirewallStatus(Model):
    ...
    def __init__(self, status: FirewallStatusValue=None, configuration_sync_state_summary: ConfigurationSyncState=None, sync_states: Dict=None, capacity_usage_summary: FirewallStatusCapacityUsageSummary=None):
        """FirewallStatus - a model defined in OpenAPI

        :param status: The status of this FirewallStatus.
        :param configuration_sync_state_summary: The configuration_sync_state_summary of this FirewallStatus.
        :param sync_states: The sync_states of this FirewallStatus.
        :param capacity_usage_summary: The capacity_usage_summary of this FirewallStatus.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FirewallStatus':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FirewallStatus of this FirewallStatus.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def status(self):
        """Gets the status of this FirewallStatus.


        :return: The status of this FirewallStatus.
    ...
    def status(self, status):
        """Sets the status of this FirewallStatus.
    ...
    def configuration_sync_state_summary(self):
        """Gets the configuration_sync_state_summary of this FirewallStatus.


        :return: The configuration_sync_state_summary of this FirewallStatus.
    ...
    def configuration_sync_state_summary(self, configuration_sync_state_summary):
        """Sets the configuration_sync_state_summary of this FirewallStatus.
    ...
    def sync_states(self):
        """Gets the sync_states of this FirewallStatus.


        :return: The sync_states of this FirewallStatus.
        :rtype: Dict
        """
    ...
    def sync_states(self, sync_states):
        """Sets the sync_states of this FirewallStatus.
    ...
    def capacity_usage_summary(self):
        """Gets the capacity_usage_summary of this FirewallStatus.


        :return: The capacity_usage_summary of this FirewallStatus.
    ...
    def capacity_usage_summary(self, capacity_usage_summary):
        """Sets the capacity_usage_summary of this FirewallStatus.
