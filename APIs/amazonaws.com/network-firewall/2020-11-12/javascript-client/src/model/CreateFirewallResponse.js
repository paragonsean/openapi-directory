...
/**
 * The CreateFirewallResponse model module.
 * @module model/CreateFirewallResponse
 * @version 2020-11-12
 */
class CreateFirewallResponse {
    /**
     * Constructs a new <code>CreateFirewallResponse</code>.
     * @alias module:model/CreateFirewallResponse
     */
    constructor() { 
        
        CreateFirewallResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallResponse} obj Optional instance to populate.
     * @return {module:model/CreateFirewallResponse} The populated <code>CreateFirewallResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallResponse</code>.
     */
 ...
 */
CreateFirewallResponse.prototype['Firewall'] = undefined;

/**
 * @member {module:model/CreateFirewallResponseFirewallStatus} FirewallStatus
 */
CreateFirewallResponse.prototype['FirewallStatus'] = undefined;
...
export default CreateFirewallResponse;
