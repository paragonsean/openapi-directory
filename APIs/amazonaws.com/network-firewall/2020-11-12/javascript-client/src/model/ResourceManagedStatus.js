...
* @readonly
*/
export default class ResourceManagedStatus {
    ...
    /**
    * Returns a <code>ResourceManagedStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceManagedStatus} The enum <code>ResourceManagedStatus</code> value.
    */
