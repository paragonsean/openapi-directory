...
/**
 * The TLSInspectionConfiguration model module.
 * @module model/TLSInspectionConfiguration
 * @version 2020-11-12
 */
class TLSInspectionConfiguration {
    /**
     * Constructs a new <code>TLSInspectionConfiguration</code>.
     ...
     * @alias module:model/TLSInspectionConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TLSInspectionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TLSInspectionConfiguration} obj Optional instance to populate.
     * @return {module:model/TLSInspectionConfiguration} The populated <code>TLSInspectionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TLSInspectionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>TLSInspectionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TLSInspectionConfiguration</code>.
     */
...
export default TLSInspectionConfiguration;
