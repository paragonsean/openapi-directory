...
import CreateRuleGroupResponseRuleGroupResponse from './CreateRuleGroupResponseRuleGroupResponse';
import DescribeRuleGroupResponseRuleGroup from './DescribeRuleGroupResponseRuleGroup';

/**
 * The DescribeRuleGroupResponse model module.
 * @module model/DescribeRuleGroupResponse
 * @version 2020-11-12
 */
class DescribeRuleGroupResponse {
    /**
     * Constructs a new <code>DescribeRuleGroupResponse</code>.
     * @alias module:model/DescribeRuleGroupResponse
     * @param updateToken {String} 
     * @param ruleGroupResponse {module:model/CreateRuleGroupResponseRuleGroupResponse} 
     */
    constructor(updateToken, ruleGroupResponse) { 
        
        DescribeRuleGroupResponse.initialize(this, updateToken, ruleGroupResponse);
    }
     ...
     */
    static initialize(obj, updateToken, ruleGroupResponse) { 
        obj['UpdateToken'] = updateToken;
        obj['RuleGroupResponse'] = ruleGroupResponse;
    }

    /**
     * Constructs a <code>DescribeRuleGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuleGroupResponse} obj Optional instance to populate.
     * @return {module:model/DescribeRuleGroupResponse} The populated <code>DescribeRuleGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuleGroupResponse();
            ...
            if (data.hasOwnProperty('RuleGroup')) {
                obj['RuleGroup'] = DescribeRuleGroupResponseRuleGroup.constructFromObject(data['RuleGroup']);
            }
            if (data.hasOwnProperty('RuleGroupResponse')) {
                obj['RuleGroupResponse'] = CreateRuleGroupResponseRuleGroupResponse.constructFromObject(data['RuleGroupResponse']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuleGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuleGroupResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeRuleGroupResponse.RequiredProperties) {
        ...
        if (data['RuleGroup']) { // data not null
          DescribeRuleGroupResponseRuleGroup.validateJSON(data['RuleGroup']);
        }
        // validate the optional field `RuleGroupResponse`
        if (data['RuleGroupResponse']) { // data not null
          CreateRuleGroupResponseRuleGroupResponse.validateJSON(data['RuleGroupResponse']);
        }
...
DescribeRuleGroupResponse.RequiredProperties = ["UpdateToken", "RuleGroupResponse"];

/**
 * @member {String} UpdateToken
 */
DescribeRuleGroupResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/DescribeRuleGroupResponseRuleGroup} RuleGroup
 */
DescribeRuleGroupResponse.prototype['RuleGroup'] = undefined;

/**
 * @member {module:model/CreateRuleGroupResponseRuleGroupResponse} RuleGroupResponse
 */
DescribeRuleGroupResponse.prototype['RuleGroupResponse'] = undefined;
...
export default DescribeRuleGroupResponse;
