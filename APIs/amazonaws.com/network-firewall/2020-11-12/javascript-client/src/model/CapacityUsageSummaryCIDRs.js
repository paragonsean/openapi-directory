...
/**
 * The CapacityUsageSummaryCIDRs model module.
 * @module model/CapacityUsageSummaryCIDRs
 * @version 2020-11-12
 */
class CapacityUsageSummaryCIDRs {
    /**
     * Constructs a new <code>CapacityUsageSummaryCIDRs</code>.
     * @alias module:model/CapacityUsageSummaryCIDRs
     * @implements module:model/CIDRSummary
     */
    constructor() { 
        CIDRSummary.initialize(this);
        CapacityUsageSummaryCIDRs.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CapacityUsageSummaryCIDRs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CapacityUsageSummaryCIDRs} obj Optional instance to populate.
     * @return {module:model/CapacityUsageSummaryCIDRs} The populated <code>CapacityUsageSummaryCIDRs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CapacityUsageSummaryCIDRs();
            CIDRSummary.constructFromObject(data, obj);

            if (data.hasOwnProperty('AvailableCIDRCount')) {
                obj['AvailableCIDRCount'] = ApiClient.convertToType(data['AvailableCIDRCount'], 'Number');
            }
            if (data.hasOwnProperty('UtilizedCIDRCount')) {
                obj['UtilizedCIDRCount'] = ApiClient.convertToType(data['UtilizedCIDRCount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CapacityUsageSummaryCIDRs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CapacityUsageSummaryCIDRs</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AvailableCIDRCount`
        if (data['AvailableCIDRCount']) { // data not null
          Number.validateJSON(data['AvailableCIDRCount']);
        }
        // validate the optional field `UtilizedCIDRCount`
        if (data['UtilizedCIDRCount']) { // data not null
          Number.validateJSON(data['UtilizedCIDRCount']);
        }
...
/**
 * @member {Number} AvailableCIDRCount
 */
CapacityUsageSummaryCIDRs.prototype['AvailableCIDRCount'] = undefined;

/**
 * @member {Number} UtilizedCIDRCount
 */
CapacityUsageSummaryCIDRs.prototype['UtilizedCIDRCount'] = undefined;

/**
 * @member {Object} IPSetReferences
 */
CapacityUsageSummaryCIDRs.prototype['IPSetReferences'] = undefined;


// Implement CIDRSummary interface:
/**
 * @member {Number} AvailableCIDRCount
 */
CIDRSummary.prototype['AvailableCIDRCount'] = undefined;
/**
 * @member {Number} UtilizedCIDRCount
 */
CIDRSummary.prototype['UtilizedCIDRCount'] = undefined;
/**
 * @member {Object} IPSetReferences
 */
CIDRSummary.prototype['IPSetReferences'] = undefined;




export default CapacityUsageSummaryCIDRs;
