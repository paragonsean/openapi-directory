...
import CreateFirewallPolicyRequestFirewallPolicy from './CreateFirewallPolicyRequestFirewallPolicy';

/**
 * The CreateFirewallPolicyRequest model module.
 * @module model/CreateFirewallPolicyRequest
 * @version 2020-11-12
 */
class CreateFirewallPolicyRequest {
    /**
     * Constructs a new <code>CreateFirewallPolicyRequest</code>.
     * @alias module:model/CreateFirewallPolicyRequest
     * @param firewallPolicyName {String} 
     * @param firewallPolicy {module:model/CreateFirewallPolicyRequestFirewallPolicy} 
     */
    constructor(firewallPolicyName, firewallPolicy) { 
        
        CreateFirewallPolicyRequest.initialize(this, firewallPolicyName, firewallPolicy);
    }
     ...
     */
    static initialize(obj, firewallPolicyName, firewallPolicy) { 
        obj['FirewallPolicyName'] = firewallPolicyName;
        obj['FirewallPolicy'] = firewallPolicy;
    }

    /**
     * Constructs a <code>CreateFirewallPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallPolicyRequest} obj Optional instance to populate.
     * @return {module:model/CreateFirewallPolicyRequest} The populated <code>CreateFirewallPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallPolicyRequest();
            ...
            if (data.hasOwnProperty('FirewallPolicy')) {
                obj['FirewallPolicy'] = CreateFirewallPolicyRequestFirewallPolicy.constructFromObject(data['FirewallPolicy']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallPolicyRequest.RequiredProperties) {
        ...
        if (data['FirewallPolicy']) { // data not null
          CreateFirewallPolicyRequestFirewallPolicy.validateJSON(data['FirewallPolicy']);
        }
...
CreateFirewallPolicyRequest.RequiredProperties = ["FirewallPolicyName", "FirewallPolicy"];

/**
 * @member {String} FirewallPolicyName
 */
CreateFirewallPolicyRequest.prototype['FirewallPolicyName'] = undefined;

/**
 * @member {module:model/CreateFirewallPolicyRequestFirewallPolicy} FirewallPolicy
 */
CreateFirewallPolicyRequest.prototype['FirewallPolicy'] = undefined;

/**
 * @member {String} Description
 */
CreateFirewallPolicyRequest.prototype['Description'] = undefined;

/**
 * @member {Array} Tags
 */
CreateFirewallPolicyRequest.prototype['Tags'] = undefined;

/**
 * @member {Boolean} DryRun
 */
CreateFirewallPolicyRequest.prototype['DryRun'] = undefined;

/**
 * @member {module:model/CreateFirewallPolicyRequestEncryptionConfiguration} EncryptionConfiguration
 */
CreateFirewallPolicyRequest.prototype['EncryptionConfiguration'] = undefined;
...
export default CreateFirewallPolicyRequest;
