...
/**
 * The UpdateFirewallDeleteProtectionRequest model module.
 * @module model/UpdateFirewallDeleteProtectionRequest
 * @version 2020-11-12
 */
class UpdateFirewallDeleteProtectionRequest {
    /**
     * Constructs a new <code>UpdateFirewallDeleteProtectionRequest</code>.
     * @alias module:model/UpdateFirewallDeleteProtectionRequest
     * @param deleteProtection {Boolean} 
     */
    constructor(deleteProtection) { 
        
        UpdateFirewallDeleteProtectionRequest.initialize(this, deleteProtection);
    }
     ...
     */
    static initialize(obj, deleteProtection) { 
        obj['DeleteProtection'] = deleteProtection;
    }

    /**
     * Constructs a <code>UpdateFirewallDeleteProtectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallDeleteProtectionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallDeleteProtectionRequest} The populated <code>UpdateFirewallDeleteProtectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallDeleteProtectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallDeleteProtectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallDeleteProtectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFirewallDeleteProtectionRequest.RequiredProperties) {
...
UpdateFirewallDeleteProtectionRequest.RequiredProperties = ["DeleteProtection"];

/**
 * @member {String} UpdateToken
 */
UpdateFirewallDeleteProtectionRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateFirewallDeleteProtectionRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallDeleteProtectionRequest.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} DeleteProtection
 */
UpdateFirewallDeleteProtectionRequest.prototype['DeleteProtection'] = undefined;
...
export default UpdateFirewallDeleteProtectionRequest;
