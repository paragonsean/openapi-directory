...
/**
 * The PublishMetricAction model module.
 * @module model/PublishMetricAction
 * @version 2020-11-12
 */
class PublishMetricAction {
    /**
     * Constructs a new <code>PublishMetricAction</code>.
     * Stateless inspection criteria that publishes the specified metrics to Amazon CloudWatch for the matching packet. This setting defines a CloudWatch dimension value to be published.
     * @alias module:model/PublishMetricAction
     * @param dimensions {Array} 
     */
    constructor(dimensions) { 
        
        PublishMetricAction.initialize(this, dimensions);
    }
    ...
    /**
     * Constructs a <code>PublishMetricAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishMetricAction} obj Optional instance to populate.
     * @return {module:model/PublishMetricAction} The populated <code>PublishMetricAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishMetricAction();
    ...
    /**
     * Validates the JSON data with respect to <code>PublishMetricAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishMetricAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublishMetricAction.RequiredProperties) {
...
PublishMetricAction.RequiredProperties = ["Dimensions"];

/**
 * @member {Array} Dimensions
 */
PublishMetricAction.prototype['Dimensions'] = undefined;
...
export default PublishMetricAction;
