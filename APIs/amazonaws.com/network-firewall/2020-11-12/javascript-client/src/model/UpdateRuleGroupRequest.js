...
/**
 * The UpdateRuleGroupRequest model module.
 * @module model/UpdateRuleGroupRequest
 * @version 2020-11-12
 */
class UpdateRuleGroupRequest {
    /**
     * Constructs a new <code>UpdateRuleGroupRequest</code>.
     * @alias module:model/UpdateRuleGroupRequest
     * @param updateToken {String} 
     */
    constructor(updateToken) { 
        
        UpdateRuleGroupRequest.initialize(this, updateToken);
    }
    ...
    /**
     * Constructs a <code>UpdateRuleGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRuleGroupRequest} obj Optional instance to populate.
     * @return {module:model/UpdateRuleGroupRequest} The populated <code>UpdateRuleGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRuleGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRuleGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRuleGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRuleGroupRequest.RequiredProperties) {
...
UpdateRuleGroupRequest.RequiredProperties = ["UpdateToken"];

/**
 * @member {String} UpdateToken
 */
UpdateRuleGroupRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} RuleGroupArn
 */
UpdateRuleGroupRequest.prototype['RuleGroupArn'] = undefined;

/**
 * @member {String} RuleGroupName
 */
UpdateRuleGroupRequest.prototype['RuleGroupName'] = undefined;

/**
 * @member {module:model/CreateRuleGroupRequestRuleGroup} RuleGroup
 */
UpdateRuleGroupRequest.prototype['RuleGroup'] = undefined;

/**
 * @member {String} Rules
 */
UpdateRuleGroupRequest.prototype['Rules'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
UpdateRuleGroupRequest.prototype['Type'] = undefined;

/**
 * @member {String} Description
 */
UpdateRuleGroupRequest.prototype['Description'] = undefined;

/**
 * @member {Boolean} DryRun
 */
UpdateRuleGroupRequest.prototype['DryRun'] = undefined;

/**
 * @member {module:model/CreateRuleGroupRequestEncryptionConfiguration} EncryptionConfiguration
 */
UpdateRuleGroupRequest.prototype['EncryptionConfiguration'] = undefined;

/**
 * @member {module:model/CreateRuleGroupRequestSourceMetadata} SourceMetadata
 */
UpdateRuleGroupRequest.prototype['SourceMetadata'] = undefined;
...
export default UpdateRuleGroupRequest;
