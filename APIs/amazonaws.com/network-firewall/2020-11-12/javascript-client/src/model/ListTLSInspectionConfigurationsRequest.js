...
/**
 * The ListTLSInspectionConfigurationsRequest model module.
 * @module model/ListTLSInspectionConfigurationsRequest
 * @version 2020-11-12
 */
class ListTLSInspectionConfigurationsRequest {
    /**
     * Constructs a new <code>ListTLSInspectionConfigurationsRequest</code>.
     * @alias module:model/ListTLSInspectionConfigurationsRequest
     */
    constructor() { 
        
        ListTLSInspectionConfigurationsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTLSInspectionConfigurationsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTLSInspectionConfigurationsRequest} obj Optional instance to populate.
     * @return {module:model/ListTLSInspectionConfigurationsRequest} The populated <code>ListTLSInspectionConfigurationsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTLSInspectionConfigurationsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListTLSInspectionConfigurationsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTLSInspectionConfigurationsRequest</code>.
     */
 ...
 */
ListTLSInspectionConfigurationsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListTLSInspectionConfigurationsRequest.prototype['MaxResults'] = undefined;
...
export default ListTLSInspectionConfigurationsRequest;
