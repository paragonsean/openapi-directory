...
/**
 * The StatefulRuleOptions model module.
 * @module model/StatefulRuleOptions
 * @version 2020-11-12
 */
class StatefulRuleOptions {
    /**
     * Constructs a new <code>StatefulRuleOptions</code>.
     * Additional options governing how Network Firewall handles the rule group. You can only use these for stateful rule groups.
     * @alias module:model/StatefulRuleOptions
     */
    constructor() { 
        
        StatefulRuleOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatefulRuleOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulRuleOptions} obj Optional instance to populate.
     * @return {module:model/StatefulRuleOptions} The populated <code>StatefulRuleOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulRuleOptions();

            if (data.hasOwnProperty('RuleOrder')) {
                obj['RuleOrder'] = ApiClient.convertToType(data['RuleOrder'], RuleOrder);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulRuleOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulRuleOptions</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RuleOrder`
        if (data['RuleOrder']) { // data not null
          RuleOrder.validateJSON(data['RuleOrder']);
        }
...
/**
 * @member {module:model/RuleOrder} RuleOrder
 */
StatefulRuleOptions.prototype['RuleOrder'] = undefined;
...
export default StatefulRuleOptions;
