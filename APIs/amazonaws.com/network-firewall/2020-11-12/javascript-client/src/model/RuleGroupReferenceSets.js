...
/**
 * The RuleGroupReferenceSets model module.
 * @module model/RuleGroupReferenceSets
 * @version 2020-11-12
 */
class RuleGroupReferenceSets {
    /**
     * Constructs a new <code>RuleGroupReferenceSets</code>.
     * @alias module:model/RuleGroupReferenceSets
     * @implements module:model/ReferenceSets
     */
    constructor() { 
        ReferenceSets.initialize(this);
        RuleGroupReferenceSets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupReferenceSets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupReferenceSets} obj Optional instance to populate.
     * @return {module:model/RuleGroupReferenceSets} The populated <code>RuleGroupReferenceSets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupReferenceSets();
            ReferenceSets.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupReferenceSets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupReferenceSets</code>.
     */
 ...
 */
RuleGroupReferenceSets.prototype['IPSetReferences'] = undefined;


// Implement ReferenceSets interface:
/**
 * @member {Object} IPSetReferences
 */
...
export default RuleGroupReferenceSets;
