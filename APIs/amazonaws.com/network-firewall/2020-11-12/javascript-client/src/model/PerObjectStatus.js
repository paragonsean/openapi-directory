...
import PerObjectSyncStatus from './PerObjectSyncStatus';

/**
 * The PerObjectStatus model module.
 * @module model/PerObjectStatus
 * @version 2020-11-12
 */
class PerObjectStatus {
    /**
     * Constructs a new <code>PerObjectStatus</code>.
     ...
     * @alias module:model/PerObjectStatus
     */
    constructor() { 
        
        PerObjectStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PerObjectStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PerObjectStatus} obj Optional instance to populate.
     * @return {module:model/PerObjectStatus} The populated <code>PerObjectStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PerObjectStatus();

            if (data.hasOwnProperty('SyncStatus')) {
                obj['SyncStatus'] = ApiClient.convertToType(data['SyncStatus'], PerObjectSyncStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PerObjectStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PerObjectStatus</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SyncStatus`
        if (data['SyncStatus']) { // data not null
          PerObjectSyncStatus.validateJSON(data['SyncStatus']);
        }
...
/**
 * @member {module:model/PerObjectSyncStatus} SyncStatus
 */
PerObjectStatus.prototype['SyncStatus'] = undefined;

/**
 * @member {String} UpdateToken
 */
PerObjectStatus.prototype['UpdateToken'] = undefined;
...
export default PerObjectStatus;
