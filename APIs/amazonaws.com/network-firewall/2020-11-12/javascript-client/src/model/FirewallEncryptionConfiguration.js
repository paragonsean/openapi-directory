...
/**
 * The FirewallEncryptionConfiguration model module.
 * @module model/FirewallEncryptionConfiguration
 * @version 2020-11-12
 */
class FirewallEncryptionConfiguration {
    /**
     * Constructs a new <code>FirewallEncryptionConfiguration</code>.
     * @alias module:model/FirewallEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        FirewallEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>FirewallEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/FirewallEncryptionConfiguration} The populated <code>FirewallEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallEncryptionConfiguration.RequiredProperties) {
...
FirewallEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
FirewallEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
FirewallEncryptionConfiguration.prototype['Type'] = undefined;
...
export default FirewallEncryptionConfiguration;
