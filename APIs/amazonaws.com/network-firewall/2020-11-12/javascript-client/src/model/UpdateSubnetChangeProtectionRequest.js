...
/**
 * The UpdateSubnetChangeProtectionRequest model module.
 * @module model/UpdateSubnetChangeProtectionRequest
 * @version 2020-11-12
 */
class UpdateSubnetChangeProtectionRequest {
    /**
     * Constructs a new <code>UpdateSubnetChangeProtectionRequest</code>.
     * @alias module:model/UpdateSubnetChangeProtectionRequest
     * @param subnetChangeProtection {Boolean} 
     */
    constructor(subnetChangeProtection) { 
        
        UpdateSubnetChangeProtectionRequest.initialize(this, subnetChangeProtection);
    }
     ...
     */
    static initialize(obj, subnetChangeProtection) { 
        obj['SubnetChangeProtection'] = subnetChangeProtection;
    }

    /**
     * Constructs a <code>UpdateSubnetChangeProtectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSubnetChangeProtectionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateSubnetChangeProtectionRequest} The populated <code>UpdateSubnetChangeProtectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSubnetChangeProtectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubnetChangeProtectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubnetChangeProtectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSubnetChangeProtectionRequest.RequiredProperties) {
...
UpdateSubnetChangeProtectionRequest.RequiredProperties = ["SubnetChangeProtection"];

/**
 * @member {String} UpdateToken
 */
UpdateSubnetChangeProtectionRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateSubnetChangeProtectionRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateSubnetChangeProtectionRequest.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} SubnetChangeProtection
 */
UpdateSubnetChangeProtectionRequest.prototype['SubnetChangeProtection'] = undefined;
...
export default UpdateSubnetChangeProtectionRequest;
