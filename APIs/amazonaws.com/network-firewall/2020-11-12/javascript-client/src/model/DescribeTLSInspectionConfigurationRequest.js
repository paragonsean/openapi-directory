...
/**
 * The DescribeTLSInspectionConfigurationRequest model module.
 * @module model/DescribeTLSInspectionConfigurationRequest
 * @version 2020-11-12
 */
class DescribeTLSInspectionConfigurationRequest {
    /**
     * Constructs a new <code>DescribeTLSInspectionConfigurationRequest</code>.
     * @alias module:model/DescribeTLSInspectionConfigurationRequest
     */
    constructor() { 
        
        DescribeTLSInspectionConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeTLSInspectionConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeTLSInspectionConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeTLSInspectionConfigurationRequest} The populated <code>DescribeTLSInspectionConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeTLSInspectionConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeTLSInspectionConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeTLSInspectionConfigurationRequest</code>.
     */
 ...
 */
DescribeTLSInspectionConfigurationRequest.prototype['TLSInspectionConfigurationArn'] = undefined;

/**
 * @member {String} TLSInspectionConfigurationName
 */
DescribeTLSInspectionConfigurationRequest.prototype['TLSInspectionConfigurationName'] = undefined;
...
export default DescribeTLSInspectionConfigurationRequest;
