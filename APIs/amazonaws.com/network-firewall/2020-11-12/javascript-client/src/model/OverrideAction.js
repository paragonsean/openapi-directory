...
* @readonly
*/
export default class OverrideAction {
    ...
    /**
    * Returns a <code>OverrideAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OverrideAction} The enum <code>OverrideAction</code> value.
    */
