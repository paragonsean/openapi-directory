...
/**
 * The RuleGroupStatefulRuleOptions model module.
 * @module model/RuleGroupStatefulRuleOptions
 * @version 2020-11-12
 */
class RuleGroupStatefulRuleOptions {
    /**
     * Constructs a new <code>RuleGroupStatefulRuleOptions</code>.
     * @alias module:model/RuleGroupStatefulRuleOptions
     * @implements module:model/StatefulRuleOptions
     */
    constructor() { 
        StatefulRuleOptions.initialize(this);
        RuleGroupStatefulRuleOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupStatefulRuleOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupStatefulRuleOptions} obj Optional instance to populate.
     * @return {module:model/RuleGroupStatefulRuleOptions} The populated <code>RuleGroupStatefulRuleOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupStatefulRuleOptions();
            StatefulRuleOptions.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupStatefulRuleOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupStatefulRuleOptions</code>.
     */
 ...
 */
RuleGroupStatefulRuleOptions.prototype['RuleOrder'] = undefined;


// Implement StatefulRuleOptions interface:
/**
 * @member {module:model/RuleOrder} RuleOrder
 */
...
export default RuleGroupStatefulRuleOptions;
