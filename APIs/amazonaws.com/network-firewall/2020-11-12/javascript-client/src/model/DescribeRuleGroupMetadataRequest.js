...
/**
 * The DescribeRuleGroupMetadataRequest model module.
 * @module model/DescribeRuleGroupMetadataRequest
 * @version 2020-11-12
 */
class DescribeRuleGroupMetadataRequest {
    /**
     * Constructs a new <code>DescribeRuleGroupMetadataRequest</code>.
     * @alias module:model/DescribeRuleGroupMetadataRequest
     */
    constructor() { 
        
        DescribeRuleGroupMetadataRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRuleGroupMetadataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuleGroupMetadataRequest} obj Optional instance to populate.
     * @return {module:model/DescribeRuleGroupMetadataRequest} The populated <code>DescribeRuleGroupMetadataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuleGroupMetadataRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuleGroupMetadataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuleGroupMetadataRequest</code>.
     */
 ...
 */
DescribeRuleGroupMetadataRequest.prototype['RuleGroupName'] = undefined;

/**
 * @member {String} RuleGroupArn
 */
DescribeRuleGroupMetadataRequest.prototype['RuleGroupArn'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
DescribeRuleGroupMetadataRequest.prototype['Type'] = undefined;
...
export default DescribeRuleGroupMetadataRequest;
