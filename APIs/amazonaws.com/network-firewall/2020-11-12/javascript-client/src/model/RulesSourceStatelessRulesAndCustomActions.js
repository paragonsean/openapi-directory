...
/**
 * The RulesSourceStatelessRulesAndCustomActions model module.
 * @module model/RulesSourceStatelessRulesAndCustomActions
 * @version 2020-11-12
 */
class RulesSourceStatelessRulesAndCustomActions {
    /**
     * Constructs a new <code>RulesSourceStatelessRulesAndCustomActions</code>.
     * @alias module:model/RulesSourceStatelessRulesAndCustomActions
     * @implements module:model/StatelessRulesAndCustomActions
     * @param statelessRules {Array} 
     */
    constructor(statelessRules) { 
        StatelessRulesAndCustomActions.initialize(this, statelessRules);
        RulesSourceStatelessRulesAndCustomActions.initialize(this, statelessRules);
    }
     ...
     */
    static initialize(obj, statelessRules) { 
        obj['StatelessRules'] = statelessRules;
    }

    /**
     * Constructs a <code>RulesSourceStatelessRulesAndCustomActions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RulesSourceStatelessRulesAndCustomActions} obj Optional instance to populate.
     * @return {module:model/RulesSourceStatelessRulesAndCustomActions} The populated <code>RulesSourceStatelessRulesAndCustomActions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RulesSourceStatelessRulesAndCustomActions();
            StatelessRulesAndCustomActions.constructFromObject(data, obj);

            if (data.hasOwnProperty('StatelessRules')) {
                obj['StatelessRules'] = ApiClient.convertToType(data['StatelessRules'], Array);
            }
            if (data.hasOwnProperty('CustomActions')) {
                obj['CustomActions'] = ApiClient.convertToType(data['CustomActions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RulesSourceStatelessRulesAndCustomActions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RulesSourceStatelessRulesAndCustomActions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RulesSourceStatelessRulesAndCustomActions.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `StatelessRules`
        if (data['StatelessRules']) { // data not null
          Array.validateJSON(data['StatelessRules']);
        }
        // validate the optional field `CustomActions`
        if (data['CustomActions']) { // data not null
          Array.validateJSON(data['CustomActions']);
        }
...
RulesSourceStatelessRulesAndCustomActions.RequiredProperties = ["StatelessRules"];

/**
 * @member {Array} StatelessRules
 */
RulesSourceStatelessRulesAndCustomActions.prototype['StatelessRules'] = undefined;

/**
 * @member {Array} CustomActions
 */
RulesSourceStatelessRulesAndCustomActions.prototype['CustomActions'] = undefined;


// Implement StatelessRulesAndCustomActions interface:
/**
 * @member {Array} StatelessRules
 */
StatelessRulesAndCustomActions.prototype['StatelessRules'] = undefined;
/**
 * @member {Array} CustomActions
 */
StatelessRulesAndCustomActions.prototype['CustomActions'] = undefined;




export default RulesSourceStatelessRulesAndCustomActions;
