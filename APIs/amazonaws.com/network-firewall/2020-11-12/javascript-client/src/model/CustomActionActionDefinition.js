...
import ActionDefinitionPublishMetricAction from './ActionDefinitionPublishMetricAction';

/**
 * The CustomActionActionDefinition model module.
 * @module model/CustomActionActionDefinition
 * @version 2020-11-12
 */
class CustomActionActionDefinition {
    /**
     * Constructs a new <code>CustomActionActionDefinition</code>.
     * @alias module:model/CustomActionActionDefinition
     * @implements module:model/ActionDefinition
     */
    constructor() { 
        ActionDefinition.initialize(this);
        CustomActionActionDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomActionActionDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomActionActionDefinition} obj Optional instance to populate.
     * @return {module:model/CustomActionActionDefinition} The populated <code>CustomActionActionDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomActionActionDefinition();
            ActionDefinition.constructFromObject(data, obj);

            if (data.hasOwnProperty('PublishMetricAction')) {
                obj['PublishMetricAction'] = ActionDefinitionPublishMetricAction.constructFromObject(data['PublishMetricAction']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomActionActionDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomActionActionDefinition</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PublishMetricAction`
        if (data['PublishMetricAction']) { // data not null
          ActionDefinitionPublishMetricAction.validateJSON(data['PublishMetricAction']);
        }
...
/**
 * @member {module:model/ActionDefinitionPublishMetricAction} PublishMetricAction
 */
CustomActionActionDefinition.prototype['PublishMetricAction'] = undefined;
 ...
 * @member {module:model/ActionDefinitionPublishMetricAction} PublishMetricAction
 */
ActionDefinition.prototype['PublishMetricAction'] = undefined;




export default CustomActionActionDefinition;
