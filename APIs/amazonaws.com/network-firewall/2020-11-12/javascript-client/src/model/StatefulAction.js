...
* @readonly
*/
export default class StatefulAction {
    ...
    /**
    * Returns a <code>StatefulAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StatefulAction} The enum <code>StatefulAction</code> value.
    */
