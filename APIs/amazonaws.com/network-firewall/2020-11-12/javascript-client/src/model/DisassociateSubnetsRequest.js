...
/**
 * The DisassociateSubnetsRequest model module.
 * @module model/DisassociateSubnetsRequest
 * @version 2020-11-12
 */
class DisassociateSubnetsRequest {
    /**
     * Constructs a new <code>DisassociateSubnetsRequest</code>.
     * @alias module:model/DisassociateSubnetsRequest
     * @param subnetIds {Array} 
     */
    constructor(subnetIds) { 
        
        DisassociateSubnetsRequest.initialize(this, subnetIds);
    }
    ...
    /**
     * Constructs a <code>DisassociateSubnetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateSubnetsRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateSubnetsRequest} The populated <code>DisassociateSubnetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateSubnetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateSubnetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateSubnetsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateSubnetsRequest.RequiredProperties) {
...
DisassociateSubnetsRequest.RequiredProperties = ["SubnetIds"];

/**
 * @member {String} UpdateToken
 */
DisassociateSubnetsRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
DisassociateSubnetsRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
DisassociateSubnetsRequest.prototype['FirewallName'] = undefined;

/**
 * @member {Array} SubnetIds
 */
DisassociateSubnetsRequest.prototype['SubnetIds'] = undefined;
...
export default DisassociateSubnetsRequest;
