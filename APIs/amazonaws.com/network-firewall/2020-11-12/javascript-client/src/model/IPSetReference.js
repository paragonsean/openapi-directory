...
/**
 * The IPSetReference model module.
 * @module model/IPSetReference
 * @version 2020-11-12
 */
class IPSetReference {
    /**
     * Constructs a new <code>IPSetReference</code>.
     ...
     * @alias module:model/IPSetReference
     */
    constructor() { 
        
        IPSetReference.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPSetReference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IPSetReference} obj Optional instance to populate.
     * @return {module:model/IPSetReference} The populated <code>IPSetReference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPSetReference();
    ...
    /**
     * Validates the JSON data with respect to <code>IPSetReference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPSetReference</code>.
     */
 ...
 */
IPSetReference.prototype['ReferenceArn'] = undefined;
