...
/**
 * The UpdateFirewallEncryptionConfigurationResponse model module.
 * @module model/UpdateFirewallEncryptionConfigurationResponse
 * @version 2020-11-12
 */
class UpdateFirewallEncryptionConfigurationResponse {
    /**
     * Constructs a new <code>UpdateFirewallEncryptionConfigurationResponse</code>.
     * @alias module:model/UpdateFirewallEncryptionConfigurationResponse
     */
    constructor() { 
        
        UpdateFirewallEncryptionConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallEncryptionConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallEncryptionConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallEncryptionConfigurationResponse} The populated <code>UpdateFirewallEncryptionConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallEncryptionConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallEncryptionConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallEncryptionConfigurationResponse</code>.
     */
 ...
 */
UpdateFirewallEncryptionConfigurationResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallEncryptionConfigurationResponse.prototype['FirewallName'] = undefined;

/**
 * @member {String} UpdateToken
 */
UpdateFirewallEncryptionConfigurationResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/EncryptionConfiguration} EncryptionConfiguration
 */
UpdateFirewallEncryptionConfigurationResponse.prototype['EncryptionConfiguration'] = undefined;
...
export default UpdateFirewallEncryptionConfigurationResponse;
