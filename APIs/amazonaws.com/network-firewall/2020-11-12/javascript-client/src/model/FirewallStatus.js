...
/**
 * The FirewallStatus model module.
 * @module model/FirewallStatus
 * @version 2020-11-12
 */
class FirewallStatus {
    /**
     * Constructs a new <code>FirewallStatus</code>.
     ...
     * @alias module:model/FirewallStatus
    ...
    /**
     * Constructs a <code>FirewallStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallStatus} obj Optional instance to populate.
     * @return {module:model/FirewallStatus} The populated <code>FirewallStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallStatus.RequiredProperties) {
...
FirewallStatus.RequiredProperties = ["Status", "ConfigurationSyncStateSummary"];
