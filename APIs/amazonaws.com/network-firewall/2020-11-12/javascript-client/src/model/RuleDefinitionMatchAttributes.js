...
/**
 * The RuleDefinitionMatchAttributes model module.
 * @module model/RuleDefinitionMatchAttributes
 * @version 2020-11-12
 */
class RuleDefinitionMatchAttributes {
    /**
     * Constructs a new <code>RuleDefinitionMatchAttributes</code>.
     * @alias module:model/RuleDefinitionMatchAttributes
     * @implements module:model/MatchAttributes
     */
    constructor() { 
        MatchAttributes.initialize(this);
        RuleDefinitionMatchAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleDefinitionMatchAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleDefinitionMatchAttributes} obj Optional instance to populate.
     * @return {module:model/RuleDefinitionMatchAttributes} The populated <code>RuleDefinitionMatchAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleDefinitionMatchAttributes();
            MatchAttributes.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RuleDefinitionMatchAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleDefinitionMatchAttributes</code>.
     */
 ...
 */
RuleDefinitionMatchAttributes.prototype['Sources'] = undefined;

/**
 * @member {Array} Destinations
 */
RuleDefinitionMatchAttributes.prototype['Destinations'] = undefined;

/**
 * @member {Array} SourcePorts
 */
RuleDefinitionMatchAttributes.prototype['SourcePorts'] = undefined;

/**
 * @member {Array} DestinationPorts
 */
RuleDefinitionMatchAttributes.prototype['DestinationPorts'] = undefined;

/**
 * @member {Array} Protocols
 */
RuleDefinitionMatchAttributes.prototype['Protocols'] = undefined;

/**
 * @member {Array} TCPFlags
 */
RuleDefinitionMatchAttributes.prototype['TCPFlags'] = undefined;


// Implement MatchAttributes interface:
/**
 * @member {Array} Sources
 */
...
export default RuleDefinitionMatchAttributes;
