...
* @readonly
*/
export default class StreamExceptionPolicy {
    ...
    /**
    * Returns a <code>StreamExceptionPolicy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StreamExceptionPolicy} The enum <code>StreamExceptionPolicy</code> value.
    */
