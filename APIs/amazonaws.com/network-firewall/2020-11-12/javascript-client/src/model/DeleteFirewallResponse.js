...
/**
 * The DeleteFirewallResponse model module.
 * @module model/DeleteFirewallResponse
 * @version 2020-11-12
 */
class DeleteFirewallResponse {
    /**
     * Constructs a new <code>DeleteFirewallResponse</code>.
     * @alias module:model/DeleteFirewallResponse
     */
    constructor() { 
        
        DeleteFirewallResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFirewallResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFirewallResponse} obj Optional instance to populate.
     * @return {module:model/DeleteFirewallResponse} The populated <code>DeleteFirewallResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFirewallResponse();
            ...
            if (data.hasOwnProperty('FirewallStatus')) {
                obj['FirewallStatus'] = FirewallStatus.constructFromObject(data['FirewallStatus']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFirewallResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFirewallResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['FirewallStatus']) { // data not null
          FirewallStatus.validateJSON(data['FirewallStatus']);
        }
 ...
 */
DeleteFirewallResponse.prototype['Firewall'] = undefined;

/**
 * @member {module:model/FirewallStatus} FirewallStatus
 */
DeleteFirewallResponse.prototype['FirewallStatus'] = undefined;
...
export default DeleteFirewallResponse;
