...
import CreateFirewallPolicyResponseFirewallPolicyResponse from './CreateFirewallPolicyResponseFirewallPolicyResponse';

/**
 * The UpdateFirewallPolicyResponse model module.
 * @module model/UpdateFirewallPolicyResponse
 * @version 2020-11-12
 */
class UpdateFirewallPolicyResponse {
    /**
     * Constructs a new <code>UpdateFirewallPolicyResponse</code>.
     * @alias module:model/UpdateFirewallPolicyResponse
     * @param updateToken {String} 
     * @param firewallPolicyResponse {module:model/CreateFirewallPolicyResponseFirewallPolicyResponse} 
     */
    constructor(updateToken, firewallPolicyResponse) { 
        
        UpdateFirewallPolicyResponse.initialize(this, updateToken, firewallPolicyResponse);
    }
     ...
     */
    static initialize(obj, updateToken, firewallPolicyResponse) { 
        obj['UpdateToken'] = updateToken;
        obj['FirewallPolicyResponse'] = firewallPolicyResponse;
    }

    /**
     * Constructs a <code>UpdateFirewallPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallPolicyResponse} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallPolicyResponse} The populated <code>UpdateFirewallPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallPolicyResponse();
            ...
            if (data.hasOwnProperty('FirewallPolicyResponse')) {
                obj['FirewallPolicyResponse'] = CreateFirewallPolicyResponseFirewallPolicyResponse.constructFromObject(data['FirewallPolicyResponse']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallPolicyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFirewallPolicyResponse.RequiredProperties) {
        ...
        if (data['FirewallPolicyResponse']) { // data not null
          CreateFirewallPolicyResponseFirewallPolicyResponse.validateJSON(data['FirewallPolicyResponse']);
        }
...
UpdateFirewallPolicyResponse.RequiredProperties = ["UpdateToken", "FirewallPolicyResponse"];

/**
 * @member {String} UpdateToken
 */
UpdateFirewallPolicyResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/CreateFirewallPolicyResponseFirewallPolicyResponse} FirewallPolicyResponse
 */
UpdateFirewallPolicyResponse.prototype['FirewallPolicyResponse'] = undefined;
...
export default UpdateFirewallPolicyResponse;
