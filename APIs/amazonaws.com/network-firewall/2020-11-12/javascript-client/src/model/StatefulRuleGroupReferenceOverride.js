...
/**
 * The StatefulRuleGroupReferenceOverride model module.
 * @module model/StatefulRuleGroupReferenceOverride
 * @version 2020-11-12
 */
class StatefulRuleGroupReferenceOverride {
    /**
     * Constructs a new <code>StatefulRuleGroupReferenceOverride</code>.
     * @alias module:model/StatefulRuleGroupReferenceOverride
     * @implements module:model/StatefulRuleGroupOverride
     */
    constructor() { 
        StatefulRuleGroupOverride.initialize(this);
        StatefulRuleGroupReferenceOverride.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatefulRuleGroupReferenceOverride</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulRuleGroupReferenceOverride} obj Optional instance to populate.
     * @return {module:model/StatefulRuleGroupReferenceOverride} The populated <code>StatefulRuleGroupReferenceOverride</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulRuleGroupReferenceOverride();
            StatefulRuleGroupOverride.constructFromObject(data, obj);

            if (data.hasOwnProperty('Action')) {
                obj['Action'] = ApiClient.convertToType(data['Action'], OverrideAction);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulRuleGroupReferenceOverride</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulRuleGroupReferenceOverride</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Action`
        if (data['Action']) { // data not null
          OverrideAction.validateJSON(data['Action']);
        }
...
/**
 * @member {module:model/OverrideAction} Action
 */
StatefulRuleGroupReferenceOverride.prototype['Action'] = undefined;


// Implement StatefulRuleGroupOverride interface:
/**
 * @member {module:model/OverrideAction} Action
 */
StatefulRuleGroupOverride.prototype['Action'] = undefined;




export default StatefulRuleGroupReferenceOverride;
