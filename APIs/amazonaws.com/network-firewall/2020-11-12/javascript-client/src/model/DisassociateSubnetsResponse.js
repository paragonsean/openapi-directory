...
/**
 * The DisassociateSubnetsResponse model module.
 * @module model/DisassociateSubnetsResponse
 * @version 2020-11-12
 */
class DisassociateSubnetsResponse {
    /**
     * Constructs a new <code>DisassociateSubnetsResponse</code>.
     * @alias module:model/DisassociateSubnetsResponse
     */
    constructor() { 
        
        DisassociateSubnetsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateSubnetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateSubnetsResponse} obj Optional instance to populate.
     * @return {module:model/DisassociateSubnetsResponse} The populated <code>DisassociateSubnetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateSubnetsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateSubnetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateSubnetsResponse</code>.
     */
 ...
 */
DisassociateSubnetsResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
DisassociateSubnetsResponse.prototype['FirewallName'] = undefined;

/**
 * @member {Array} SubnetMappings
 */
DisassociateSubnetsResponse.prototype['SubnetMappings'] = undefined;

/**
 * @member {String} UpdateToken
 */
DisassociateSubnetsResponse.prototype['UpdateToken'] = undefined;
...
export default DisassociateSubnetsResponse;
