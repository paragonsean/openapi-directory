...
/**
 * The StatelessRuleGroupReference model module.
 * @module model/StatelessRuleGroupReference
 * @version 2020-11-12
 */
class StatelessRuleGroupReference {
    /**
     * Constructs a new <code>StatelessRuleGroupReference</code>.
     * Identifier for a single stateless rule group, used in a firewall policy to refer to the rule group. 
     * @alias module:model/StatelessRuleGroupReference
     * @param resourceArn {String} 
     * @param priority {Number} 
     */
    constructor(resourceArn, priority) { 
        
        StatelessRuleGroupReference.initialize(this, resourceArn, priority);
    }
     ...
     */
    static initialize(obj, resourceArn, priority) { 
        obj['ResourceArn'] = resourceArn;
        obj['Priority'] = priority;
    }

    /**
     * Constructs a <code>StatelessRuleGroupReference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessRuleGroupReference} obj Optional instance to populate.
     * @return {module:model/StatelessRuleGroupReference} The populated <code>StatelessRuleGroupReference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessRuleGroupReference();
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessRuleGroupReference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessRuleGroupReference</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessRuleGroupReference.RequiredProperties) {
...
StatelessRuleGroupReference.RequiredProperties = ["ResourceArn", "Priority"];

/**
 * @member {String} ResourceArn
 */
StatelessRuleGroupReference.prototype['ResourceArn'] = undefined;

/**
 * @member {Number} Priority
 */
StatelessRuleGroupReference.prototype['Priority'] = undefined;
...
export default StatelessRuleGroupReference;
