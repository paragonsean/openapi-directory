...
/**
 * The UpdateTLSInspectionConfigurationResponse model module.
 * @module model/UpdateTLSInspectionConfigurationResponse
 * @version 2020-11-12
 */
class UpdateTLSInspectionConfigurationResponse {
    /**
     * Constructs a new <code>UpdateTLSInspectionConfigurationResponse</code>.
     * @alias module:model/UpdateTLSInspectionConfigurationResponse
    ...
    constructor(updateToken, tLSInspectionConfigurationResponse) { 
        ...
        UpdateTLSInspectionConfigurationResponse.initialize(this, updateToken, tLSInspectionConfigurationResponse);
    }
    ...
    /**
     * Constructs a <code>UpdateTLSInspectionConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateTLSInspectionConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/UpdateTLSInspectionConfigurationResponse} The populated <code>UpdateTLSInspectionConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateTLSInspectionConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateTLSInspectionConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateTLSInspectionConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateTLSInspectionConfigurationResponse.RequiredProperties) {
...
UpdateTLSInspectionConfigurationResponse.RequiredProperties = ["UpdateToken", "TLSInspectionConfigurationResponse"];

/**
 * @member {String} UpdateToken
 */
UpdateTLSInspectionConfigurationResponse.prototype['UpdateToken'] = undefined;
 ...
 */
UpdateTLSInspectionConfigurationResponse.prototype['TLSInspectionConfigurationResponse'] = undefined;
...
export default UpdateTLSInspectionConfigurationResponse;
