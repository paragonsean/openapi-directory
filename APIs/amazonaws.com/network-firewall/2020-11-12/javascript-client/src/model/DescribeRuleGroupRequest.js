...
/**
 * The DescribeRuleGroupRequest model module.
 * @module model/DescribeRuleGroupRequest
 * @version 2020-11-12
 */
class DescribeRuleGroupRequest {
    /**
     * Constructs a new <code>DescribeRuleGroupRequest</code>.
     * @alias module:model/DescribeRuleGroupRequest
     */
    constructor() { 
        
        DescribeRuleGroupRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRuleGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuleGroupRequest} obj Optional instance to populate.
     * @return {module:model/DescribeRuleGroupRequest} The populated <code>DescribeRuleGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuleGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuleGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuleGroupRequest</code>.
     */
 ...
 */
DescribeRuleGroupRequest.prototype['RuleGroupName'] = undefined;

/**
 * @member {String} RuleGroupArn
 */
DescribeRuleGroupRequest.prototype['RuleGroupArn'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
DescribeRuleGroupRequest.prototype['Type'] = undefined;
...
export default DescribeRuleGroupRequest;
