...
class TlsCertificateData {
    ...
    /**
     * Validates the JSON data with respect to <code>TlsCertificateData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TlsCertificateData</code>.
     */
 ...
 */
TlsCertificateData.prototype['CertificateArn'] = undefined;

/**
 * @member {String} CertificateSerial
 */
TlsCertificateData.prototype['CertificateSerial'] = undefined;

/**
 * @member {String} Status
 */
TlsCertificateData.prototype['Status'] = undefined;

/**
 * @member {String} StatusMessage
 */
TlsCertificateData.prototype['StatusMessage'] = undefined;
