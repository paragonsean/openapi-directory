...
/**
 * The DescribeFirewallPolicyRequest model module.
 * @module model/DescribeFirewallPolicyRequest
 * @version 2020-11-12
 */
class DescribeFirewallPolicyRequest {
    /**
     * Constructs a new <code>DescribeFirewallPolicyRequest</code>.
     * @alias module:model/DescribeFirewallPolicyRequest
     */
    constructor() { 
        
        DescribeFirewallPolicyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFirewallPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFirewallPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DescribeFirewallPolicyRequest} The populated <code>DescribeFirewallPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFirewallPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFirewallPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFirewallPolicyRequest</code>.
     */
 ...
 */
DescribeFirewallPolicyRequest.prototype['FirewallPolicyName'] = undefined;

/**
 * @member {String} FirewallPolicyArn
 */
DescribeFirewallPolicyRequest.prototype['FirewallPolicyArn'] = undefined;
...
export default DescribeFirewallPolicyRequest;
