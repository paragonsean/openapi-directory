...
/**
 * The DescribeRuleGroupMetadataResponse model module.
 * @module model/DescribeRuleGroupMetadataResponse
 * @version 2020-11-12
 */
class DescribeRuleGroupMetadataResponse {
    /**
     * Constructs a new <code>DescribeRuleGroupMetadataResponse</code>.
     * @alias module:model/DescribeRuleGroupMetadataResponse
     * @param ruleGroupArn {String} 
     * @param ruleGroupName {String} 
     */
    constructor(ruleGroupArn, ruleGroupName) { 
        
        DescribeRuleGroupMetadataResponse.initialize(this, ruleGroupArn, ruleGroupName);
    }
     ...
     */
    static initialize(obj, ruleGroupArn, ruleGroupName) { 
        obj['RuleGroupArn'] = ruleGroupArn;
        obj['RuleGroupName'] = ruleGroupName;
    }

    /**
     * Constructs a <code>DescribeRuleGroupMetadataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRuleGroupMetadataResponse} obj Optional instance to populate.
     * @return {module:model/DescribeRuleGroupMetadataResponse} The populated <code>DescribeRuleGroupMetadataResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRuleGroupMetadataResponse();
            ...
            if (data.hasOwnProperty('StatefulRuleOptions')) {
                obj['StatefulRuleOptions'] = StatefulRuleOptions.constructFromObject(data['StatefulRuleOptions']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRuleGroupMetadataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRuleGroupMetadataResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeRuleGroupMetadataResponse.RequiredProperties) {
        ...
        if (data['StatefulRuleOptions']) { // data not null
          StatefulRuleOptions.validateJSON(data['StatefulRuleOptions']);
        }
...
DescribeRuleGroupMetadataResponse.RequiredProperties = ["RuleGroupArn", "RuleGroupName"];

/**
 * @member {String} RuleGroupArn
 */
DescribeRuleGroupMetadataResponse.prototype['RuleGroupArn'] = undefined;

/**
 * @member {String} RuleGroupName
 */
DescribeRuleGroupMetadataResponse.prototype['RuleGroupName'] = undefined;

/**
 * @member {String} Description
 */
DescribeRuleGroupMetadataResponse.prototype['Description'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
DescribeRuleGroupMetadataResponse.prototype['Type'] = undefined;

/**
 * @member {Number} Capacity
 */
DescribeRuleGroupMetadataResponse.prototype['Capacity'] = undefined;

/**
 * @member {module:model/StatefulRuleOptions} StatefulRuleOptions
 */
DescribeRuleGroupMetadataResponse.prototype['StatefulRuleOptions'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
DescribeRuleGroupMetadataResponse.prototype['LastModifiedTime'] = undefined;
...
export default DescribeRuleGroupMetadataResponse;
