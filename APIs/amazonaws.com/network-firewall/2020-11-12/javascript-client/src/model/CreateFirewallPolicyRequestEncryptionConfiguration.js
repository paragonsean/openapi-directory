...
/**
 * The CreateFirewallPolicyRequestEncryptionConfiguration model module.
 * @module model/CreateFirewallPolicyRequestEncryptionConfiguration
 * @version 2020-11-12
 */
class CreateFirewallPolicyRequestEncryptionConfiguration {
    /**
     * Constructs a new <code>CreateFirewallPolicyRequestEncryptionConfiguration</code>.
     * @alias module:model/CreateFirewallPolicyRequestEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        CreateFirewallPolicyRequestEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallPolicyRequestEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallPolicyRequestEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFirewallPolicyRequestEncryptionConfiguration} The populated <code>CreateFirewallPolicyRequestEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallPolicyRequestEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallPolicyRequestEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallPolicyRequestEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallPolicyRequestEncryptionConfiguration.RequiredProperties) {
...
CreateFirewallPolicyRequestEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
CreateFirewallPolicyRequestEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
CreateFirewallPolicyRequestEncryptionConfiguration.prototype['Type'] = undefined;
...
export default CreateFirewallPolicyRequestEncryptionConfiguration;
