...
/**
 * The FirewallMetadata model module.
 * @module model/FirewallMetadata
 * @version 2020-11-12
 */
class FirewallMetadata {
    /**
     * Constructs a new <code>FirewallMetadata</code>.
     ...
     * @alias module:model/FirewallMetadata
     */
    constructor() { 
        
        FirewallMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallMetadata} obj Optional instance to populate.
     * @return {module:model/FirewallMetadata} The populated <code>FirewallMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallMetadata();

            if (data.hasOwnProperty('FirewallName')) {
                obj['FirewallName'] = ApiClient.convertToType(data['FirewallName'], 'String');
            }
            if (data.hasOwnProperty('FirewallArn')) {
                obj['FirewallArn'] = ApiClient.convertToType(data['FirewallArn'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['FirewallArn']) { // data not null
          String.validateJSON(data['FirewallArn']);
        }
 ...
 */
FirewallMetadata.prototype['FirewallName'] = undefined;

/**
 * @member {String} FirewallArn
 */
FirewallMetadata.prototype['FirewallArn'] = undefined;
...
export default FirewallMetadata;
