...
/**
 * The DeleteFirewallPolicyRequest model module.
 * @module model/DeleteFirewallPolicyRequest
 * @version 2020-11-12
 */
class DeleteFirewallPolicyRequest {
    /**
     * Constructs a new <code>DeleteFirewallPolicyRequest</code>.
     * @alias module:model/DeleteFirewallPolicyRequest
     */
    constructor() { 
        
        DeleteFirewallPolicyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFirewallPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFirewallPolicyRequest} obj Optional instance to populate.
     * @return {module:model/DeleteFirewallPolicyRequest} The populated <code>DeleteFirewallPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFirewallPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFirewallPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFirewallPolicyRequest</code>.
     */
 ...
 */
DeleteFirewallPolicyRequest.prototype['FirewallPolicyName'] = undefined;

/**
 * @member {String} FirewallPolicyArn
 */
DeleteFirewallPolicyRequest.prototype['FirewallPolicyArn'] = undefined;
...
export default DeleteFirewallPolicyRequest;
