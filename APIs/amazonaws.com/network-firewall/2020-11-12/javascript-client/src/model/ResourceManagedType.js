...
* @readonly
*/
export default class ResourceManagedType {
    
        /**
         * value: "AWS_MANAGED_THREAT_SIGNATURES"
         * @const
         */
        "THREAT_SIGNATURES" = "AWS_MANAGED_THREAT_SIGNATURES";
         ...
         * @const
         */
        "DOMAIN_LISTS" = "AWS_MANAGED_DOMAIN_LISTS";

    

    /**
    * Returns a <code>ResourceManagedType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ResourceManagedType} The enum <code>ResourceManagedType</code> value.
    */
