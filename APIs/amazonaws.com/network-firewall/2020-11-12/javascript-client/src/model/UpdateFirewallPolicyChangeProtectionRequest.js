...
/**
 * The UpdateFirewallPolicyChangeProtectionRequest model module.
 * @module model/UpdateFirewallPolicyChangeProtectionRequest
 * @version 2020-11-12
 */
class UpdateFirewallPolicyChangeProtectionRequest {
    /**
     * Constructs a new <code>UpdateFirewallPolicyChangeProtectionRequest</code>.
     * @alias module:model/UpdateFirewallPolicyChangeProtectionRequest
     * @param firewallPolicyChangeProtection {Boolean} 
     */
    constructor(firewallPolicyChangeProtection) { 
        
        UpdateFirewallPolicyChangeProtectionRequest.initialize(this, firewallPolicyChangeProtection);
    }
     ...
     */
    static initialize(obj, firewallPolicyChangeProtection) { 
        obj['FirewallPolicyChangeProtection'] = firewallPolicyChangeProtection;
    }

    /**
     * Constructs a <code>UpdateFirewallPolicyChangeProtectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallPolicyChangeProtectionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallPolicyChangeProtectionRequest} The populated <code>UpdateFirewallPolicyChangeProtectionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallPolicyChangeProtectionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallPolicyChangeProtectionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallPolicyChangeProtectionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateFirewallPolicyChangeProtectionRequest.RequiredProperties) {
...
UpdateFirewallPolicyChangeProtectionRequest.RequiredProperties = ["FirewallPolicyChangeProtection"];

/**
 * @member {String} UpdateToken
 */
UpdateFirewallPolicyChangeProtectionRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateFirewallPolicyChangeProtectionRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallPolicyChangeProtectionRequest.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} FirewallPolicyChangeProtection
 */
UpdateFirewallPolicyChangeProtectionRequest.prototype['FirewallPolicyChangeProtection'] = undefined;
...
export default UpdateFirewallPolicyChangeProtectionRequest;
