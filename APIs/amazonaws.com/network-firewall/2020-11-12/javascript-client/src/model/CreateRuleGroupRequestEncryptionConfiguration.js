...
/**
 * The CreateRuleGroupRequestEncryptionConfiguration model module.
 * @module model/CreateRuleGroupRequestEncryptionConfiguration
 * @version 2020-11-12
 */
class CreateRuleGroupRequestEncryptionConfiguration {
    /**
     * Constructs a new <code>CreateRuleGroupRequestEncryptionConfiguration</code>.
     * @alias module:model/CreateRuleGroupRequestEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        CreateRuleGroupRequestEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CreateRuleGroupRequestEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRuleGroupRequestEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateRuleGroupRequestEncryptionConfiguration} The populated <code>CreateRuleGroupRequestEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRuleGroupRequestEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRuleGroupRequestEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRuleGroupRequestEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRuleGroupRequestEncryptionConfiguration.RequiredProperties) {
...
CreateRuleGroupRequestEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
CreateRuleGroupRequestEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
CreateRuleGroupRequestEncryptionConfiguration.prototype['Type'] = undefined;
...
export default CreateRuleGroupRequestEncryptionConfiguration;
