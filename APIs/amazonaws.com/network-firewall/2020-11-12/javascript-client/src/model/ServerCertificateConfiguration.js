...
/**
 * The ServerCertificateConfiguration model module.
 * @module model/ServerCertificateConfiguration
 * @version 2020-11-12
 */
class ServerCertificateConfiguration {
    /**
     * Constructs a new <code>ServerCertificateConfiguration</code>.
     ...
     * @alias module:model/ServerCertificateConfiguration
     */
    constructor() { 
        
        ServerCertificateConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerCertificateConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerCertificateConfiguration} obj Optional instance to populate.
     * @return {module:model/ServerCertificateConfiguration} The populated <code>ServerCertificateConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerCertificateConfiguration();

            if (data.hasOwnProperty('ServerCertificates')) {
                obj['ServerCertificates'] = ApiClient.convertToType(data['ServerCertificates'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ServerCertificateConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerCertificateConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ServerCertificates`
        if (data['ServerCertificates']) { // data not null
          Array.validateJSON(data['ServerCertificates']);
        }
 ...
 */
ServerCertificateConfiguration.prototype['ServerCertificates'] = undefined;

/**
 * @member {Array} Scopes
 */
ServerCertificateConfiguration.prototype['Scopes'] = undefined;
...
export default ServerCertificateConfiguration;
