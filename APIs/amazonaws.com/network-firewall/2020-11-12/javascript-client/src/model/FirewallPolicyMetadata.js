...
/**
 * The FirewallPolicyMetadata model module.
 * @module model/FirewallPolicyMetadata
 * @version 2020-11-12
 */
class FirewallPolicyMetadata {
    /**
     * Constructs a new <code>FirewallPolicyMetadata</code>.
     ...
     * @alias module:model/FirewallPolicyMetadata
     */
    constructor() { 
        
        FirewallPolicyMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallPolicyMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallPolicyMetadata} obj Optional instance to populate.
     * @return {module:model/FirewallPolicyMetadata} The populated <code>FirewallPolicyMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallPolicyMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallPolicyMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallPolicyMetadata</code>.
     */
 ...
 * @member {String} Name
 */
FirewallPolicyMetadata.prototype['Name'] = undefined;

/**
 * @member {String} Arn
 */
FirewallPolicyMetadata.prototype['Arn'] = undefined;
...
export default FirewallPolicyMetadata;
