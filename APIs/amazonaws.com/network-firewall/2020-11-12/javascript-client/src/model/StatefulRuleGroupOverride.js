...
/**
 * The StatefulRuleGroupOverride model module.
 * @module model/StatefulRuleGroupOverride
 * @version 2020-11-12
 */
class StatefulRuleGroupOverride {
    /**
     * Constructs a new <code>StatefulRuleGroupOverride</code>.
     * The setting that allows the policy owner to change the behavior of the rule group within a policy. 
     * @alias module:model/StatefulRuleGroupOverride
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StatefulRuleGroupOverride</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulRuleGroupOverride} obj Optional instance to populate.
     * @return {module:model/StatefulRuleGroupOverride} The populated <code>StatefulRuleGroupOverride</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulRuleGroupOverride();
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulRuleGroupOverride</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulRuleGroupOverride</code>.
     */
...
export default StatefulRuleGroupOverride;
