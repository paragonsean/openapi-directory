...
/**
 * The RuleGroupResponseSourceMetadata model module.
 * @module model/RuleGroupResponseSourceMetadata
 * @version 2020-11-12
 */
class RuleGroupResponseSourceMetadata {
    /**
     * Constructs a new <code>RuleGroupResponseSourceMetadata</code>.
     * @alias module:model/RuleGroupResponseSourceMetadata
     * @implements module:model/SourceMetadata
     */
    constructor() { 
        SourceMetadata.initialize(this);
        RuleGroupResponseSourceMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupResponseSourceMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupResponseSourceMetadata} obj Optional instance to populate.
     * @return {module:model/RuleGroupResponseSourceMetadata} The populated <code>RuleGroupResponseSourceMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupResponseSourceMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupResponseSourceMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupResponseSourceMetadata</code>.
     */
 ...
 */
RuleGroupResponseSourceMetadata.prototype['SourceArn'] = undefined;

/**
 * @member {String} SourceUpdateToken
 */
RuleGroupResponseSourceMetadata.prototype['SourceUpdateToken'] = undefined;
...
export default RuleGroupResponseSourceMetadata;
