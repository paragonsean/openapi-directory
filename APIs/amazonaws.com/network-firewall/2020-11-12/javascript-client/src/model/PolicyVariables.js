...
/**
 * The PolicyVariables model module.
 * @module model/PolicyVariables
 * @version 2020-11-12
 */
class PolicyVariables {
    /**
     * Constructs a new <code>PolicyVariables</code>.
     * Contains variables that you can use to override default Suricata settings in your firewall policy.
     * @alias module:model/PolicyVariables
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PolicyVariables</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyVariables} obj Optional instance to populate.
     * @return {module:model/PolicyVariables} The populated <code>PolicyVariables</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyVariables();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyVariables</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyVariables</code>.
     */
