...
* @readonly
*/
export default class FirewallStatusValue {
    ...
    /**
    * Returns a <code>FirewallStatusValue</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FirewallStatusValue} The enum <code>FirewallStatusValue</code> value.
    */
