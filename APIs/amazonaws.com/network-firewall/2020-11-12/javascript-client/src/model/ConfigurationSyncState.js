...
* @readonly
*/
export default class ConfigurationSyncState {
    ...
    /**
    * Returns a <code>ConfigurationSyncState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConfigurationSyncState} The enum <code>ConfigurationSyncState</code> value.
    */
