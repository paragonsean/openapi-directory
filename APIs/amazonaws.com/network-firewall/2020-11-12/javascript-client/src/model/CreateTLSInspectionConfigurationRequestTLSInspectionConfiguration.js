...
import TLSInspectionConfiguration from './TLSInspectionConfiguration';

/**
 * The CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration model module.
 * @module model/CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration
 * @version 2020-11-12
 */
class CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration {
    /**
     * Constructs a new <code>CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration</code>.
     * @alias module:model/CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration
     * @implements module:model/TLSInspectionConfiguration
     */
    constructor() { 
        TLSInspectionConfiguration.initialize(this);
        CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration} The populated <code>CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration();
            TLSInspectionConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('ServerCertificateConfigurations')) {
                obj['ServerCertificateConfigurations'] = ApiClient.convertToType(data['ServerCertificateConfigurations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ServerCertificateConfigurations`
        if (data['ServerCertificateConfigurations']) { // data not null
          Array.validateJSON(data['ServerCertificateConfigurations']);
        }
...
/**
 * @member {Array} ServerCertificateConfigurations
 */
CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration.prototype['ServerCertificateConfigurations'] = undefined;


// Implement TLSInspectionConfiguration interface:
/**
 * @member {Array} ServerCertificateConfigurations
 */
TLSInspectionConfiguration.prototype['ServerCertificateConfigurations'] = undefined;




export default CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration;
