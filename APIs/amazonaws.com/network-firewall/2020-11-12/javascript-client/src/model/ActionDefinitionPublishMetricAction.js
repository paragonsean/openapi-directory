...
/**
 * The ActionDefinitionPublishMetricAction model module.
 * @module model/ActionDefinitionPublishMetricAction
 * @version 2020-11-12
 */
class ActionDefinitionPublishMetricAction {
    /**
     * Constructs a new <code>ActionDefinitionPublishMetricAction</code>.
     * @alias module:model/ActionDefinitionPublishMetricAction
     * @implements module:model/PublishMetricAction
     * @param dimensions {Array} 
     */
    constructor(dimensions) { 
        PublishMetricAction.initialize(this, dimensions);
        ActionDefinitionPublishMetricAction.initialize(this, dimensions);
    }
    ...
    /**
     * Constructs a <code>ActionDefinitionPublishMetricAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionDefinitionPublishMetricAction} obj Optional instance to populate.
     * @return {module:model/ActionDefinitionPublishMetricAction} The populated <code>ActionDefinitionPublishMetricAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionDefinitionPublishMetricAction();
            PublishMetricAction.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ActionDefinitionPublishMetricAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionDefinitionPublishMetricAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionDefinitionPublishMetricAction.RequiredProperties) {
...
ActionDefinitionPublishMetricAction.RequiredProperties = ["Dimensions"];

/**
 * @member {Array} Dimensions
 */
ActionDefinitionPublishMetricAction.prototype['Dimensions'] = undefined;


// Implement PublishMetricAction interface:
/**
 * @member {Array} Dimensions
 */
...
export default ActionDefinitionPublishMetricAction;
