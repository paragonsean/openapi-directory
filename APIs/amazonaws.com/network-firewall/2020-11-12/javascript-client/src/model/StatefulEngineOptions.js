...
import StreamExceptionPolicy from './StreamExceptionPolicy';

/**
 * The StatefulEngineOptions model module.
 * @module model/StatefulEngineOptions
 * @version 2020-11-12
 */
class StatefulEngineOptions {
    /**
     * Constructs a new <code>StatefulEngineOptions</code>.
     * Configuration settings for the handling of the stateful rule groups in a firewall policy. 
     * @alias module:model/StatefulEngineOptions
     */
    constructor() { 
        
        StatefulEngineOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatefulEngineOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulEngineOptions} obj Optional instance to populate.
     * @return {module:model/StatefulEngineOptions} The populated <code>StatefulEngineOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulEngineOptions();

            if (data.hasOwnProperty('RuleOrder')) {
                obj['RuleOrder'] = ApiClient.convertToType(data['RuleOrder'], RuleOrder);
            }
            if (data.hasOwnProperty('StreamExceptionPolicy')) {
                obj['StreamExceptionPolicy'] = ApiClient.convertToType(data['StreamExceptionPolicy'], StreamExceptionPolicy);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulEngineOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulEngineOptions</code>.
     */
    static validateJSON(data) {
        ...
        if (data['StreamExceptionPolicy']) { // data not null
          StreamExceptionPolicy.validateJSON(data['StreamExceptionPolicy']);
        }
 ...
 */
StatefulEngineOptions.prototype['RuleOrder'] = undefined;

/**
 * @member {module:model/StreamExceptionPolicy} StreamExceptionPolicy
 */
StatefulEngineOptions.prototype['StreamExceptionPolicy'] = undefined;
...
export default StatefulEngineOptions;
