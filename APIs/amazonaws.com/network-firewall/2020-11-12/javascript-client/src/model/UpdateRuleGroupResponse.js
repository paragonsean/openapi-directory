...
/**
 * The UpdateRuleGroupResponse model module.
 * @module model/UpdateRuleGroupResponse
 * @version 2020-11-12
 */
class UpdateRuleGroupResponse {
    /**
     * Constructs a new <code>UpdateRuleGroupResponse</code>.
     * @alias module:model/UpdateRuleGroupResponse
    ...
    constructor(updateToken, ruleGroupResponse) { 
        ...
        UpdateRuleGroupResponse.initialize(this, updateToken, ruleGroupResponse);
    }
    ...
    /**
     * Constructs a <code>UpdateRuleGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRuleGroupResponse} obj Optional instance to populate.
     * @return {module:model/UpdateRuleGroupResponse} The populated <code>UpdateRuleGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRuleGroupResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRuleGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRuleGroupResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateRuleGroupResponse.RequiredProperties) {
...
UpdateRuleGroupResponse.RequiredProperties = ["UpdateToken", "RuleGroupResponse"];

/**
 * @member {String} UpdateToken
 */
UpdateRuleGroupResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/CreateRuleGroupResponseRuleGroupResponse} RuleGroupResponse
 */
UpdateRuleGroupResponse.prototype['RuleGroupResponse'] = undefined;
...
export default UpdateRuleGroupResponse;
