...
/**
 * The CapacityUsageSummary model module.
 * @module model/CapacityUsageSummary
 * @version 2020-11-12
 */
class CapacityUsageSummary {
    /**
     * Constructs a new <code>CapacityUsageSummary</code>.
     * The capacity usage summary of the resources used by the &lt;a&gt;ReferenceSets&lt;/a&gt; in a firewall.
     * @alias module:model/CapacityUsageSummary
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CapacityUsageSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CapacityUsageSummary} obj Optional instance to populate.
     * @return {module:model/CapacityUsageSummary} The populated <code>CapacityUsageSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CapacityUsageSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>CapacityUsageSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CapacityUsageSummary</code>.
     */
...
export default CapacityUsageSummary;
