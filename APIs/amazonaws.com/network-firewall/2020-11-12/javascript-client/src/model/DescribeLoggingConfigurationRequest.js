...
/**
 * The DescribeLoggingConfigurationRequest model module.
 * @module model/DescribeLoggingConfigurationRequest
 * @version 2020-11-12
 */
class DescribeLoggingConfigurationRequest {
    /**
     * Constructs a new <code>DescribeLoggingConfigurationRequest</code>.
     * @alias module:model/DescribeLoggingConfigurationRequest
     */
    constructor() { 
        
        DescribeLoggingConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeLoggingConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeLoggingConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeLoggingConfigurationRequest} The populated <code>DescribeLoggingConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeLoggingConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeLoggingConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeLoggingConfigurationRequest</code>.
     */
 ...
 */
DescribeLoggingConfigurationRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
DescribeLoggingConfigurationRequest.prototype['FirewallName'] = undefined;
...
export default DescribeLoggingConfigurationRequest;
