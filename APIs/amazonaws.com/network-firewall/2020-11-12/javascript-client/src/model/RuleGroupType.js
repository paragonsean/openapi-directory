...
* @readonly
*/
export default class RuleGroupType {
    ...
    /**
    * Returns a <code>RuleGroupType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RuleGroupType} The enum <code>RuleGroupType</code> value.
    */
