...
* @readonly
*/
export default class PerObjectSyncStatus {
    ...
    /**
    * Returns a <code>PerObjectSyncStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PerObjectSyncStatus} The enum <code>PerObjectSyncStatus</code> value.
    */
