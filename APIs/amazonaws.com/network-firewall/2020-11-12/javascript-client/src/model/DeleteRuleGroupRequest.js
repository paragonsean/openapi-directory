...
/**
 * The DeleteRuleGroupRequest model module.
 * @module model/DeleteRuleGroupRequest
 * @version 2020-11-12
 */
class DeleteRuleGroupRequest {
    /**
     * Constructs a new <code>DeleteRuleGroupRequest</code>.
     * @alias module:model/DeleteRuleGroupRequest
     */
    constructor() { 
        
        DeleteRuleGroupRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRuleGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRuleGroupRequest} obj Optional instance to populate.
     * @return {module:model/DeleteRuleGroupRequest} The populated <code>DeleteRuleGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRuleGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRuleGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRuleGroupRequest</code>.
     */
 ...
 */
DeleteRuleGroupRequest.prototype['RuleGroupName'] = undefined;

/**
 * @member {String} RuleGroupArn
 */
DeleteRuleGroupRequest.prototype['RuleGroupArn'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
DeleteRuleGroupRequest.prototype['Type'] = undefined;
...
export default DeleteRuleGroupRequest;
