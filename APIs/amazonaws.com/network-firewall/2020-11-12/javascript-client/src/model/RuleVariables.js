...
/**
 * The RuleVariables model module.
 * @module model/RuleVariables
 * @version 2020-11-12
 */
class RuleVariables {
    /**
     * Constructs a new <code>RuleVariables</code>.
     * Settings that are available for use in the rules in the &lt;a&gt;RuleGroup&lt;/a&gt; where this is defined. 
     * @alias module:model/RuleVariables
     */
    constructor() { 
        
        RuleVariables.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleVariables</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleVariables} obj Optional instance to populate.
     * @return {module:model/RuleVariables} The populated <code>RuleVariables</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleVariables();

            if (data.hasOwnProperty('IPSets')) {
                obj['IPSets'] = ApiClient.convertToType(data['IPSets'], Object);
            }
            if (data.hasOwnProperty('PortSets')) {
                obj['PortSets'] = ApiClient.convertToType(data['PortSets'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RuleVariables</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleVariables</code>.
     */
    static validateJSON(data) {
        // validate the optional field `IPSets`
        if (data['IPSets']) { // data not null
          Object.validateJSON(data['IPSets']);
        }
        // validate the optional field `PortSets`
        if (data['PortSets']) { // data not null
          Object.validateJSON(data['PortSets']);
        }
...
/**
 * @member {Object} IPSets
 */
RuleVariables.prototype['IPSets'] = undefined;

/**
 * @member {Object} PortSets
 */
RuleVariables.prototype['PortSets'] = undefined;
