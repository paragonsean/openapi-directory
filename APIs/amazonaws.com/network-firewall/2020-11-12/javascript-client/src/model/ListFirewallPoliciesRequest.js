...
/**
 * The ListFirewallPoliciesRequest model module.
 * @module model/ListFirewallPoliciesRequest
 * @version 2020-11-12
 */
class ListFirewallPoliciesRequest {
    /**
     * Constructs a new <code>ListFirewallPoliciesRequest</code>.
     * @alias module:model/ListFirewallPoliciesRequest
     */
    constructor() { 
        
        ListFirewallPoliciesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFirewallPoliciesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFirewallPoliciesRequest} obj Optional instance to populate.
     * @return {module:model/ListFirewallPoliciesRequest} The populated <code>ListFirewallPoliciesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFirewallPoliciesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFirewallPoliciesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFirewallPoliciesRequest</code>.
     */
 ...
 */
ListFirewallPoliciesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListFirewallPoliciesRequest.prototype['MaxResults'] = undefined;
...
export default ListFirewallPoliciesRequest;
