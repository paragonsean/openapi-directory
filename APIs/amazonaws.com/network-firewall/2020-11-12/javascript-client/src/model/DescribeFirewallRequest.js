...
/**
 * The DescribeFirewallRequest model module.
 * @module model/DescribeFirewallRequest
 * @version 2020-11-12
 */
class DescribeFirewallRequest {
    /**
     * Constructs a new <code>DescribeFirewallRequest</code>.
     * @alias module:model/DescribeFirewallRequest
     */
    constructor() { 
        
        DescribeFirewallRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFirewallRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFirewallRequest} obj Optional instance to populate.
     * @return {module:model/DescribeFirewallRequest} The populated <code>DescribeFirewallRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFirewallRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFirewallRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFirewallRequest</code>.
     */
 ...
 */
DescribeFirewallRequest.prototype['FirewallName'] = undefined;

/**
 * @member {String} FirewallArn
 */
DescribeFirewallRequest.prototype['FirewallArn'] = undefined;
...
export default DescribeFirewallRequest;
