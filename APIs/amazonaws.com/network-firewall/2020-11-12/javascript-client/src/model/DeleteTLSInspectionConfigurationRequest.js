...
/**
 * The DeleteTLSInspectionConfigurationRequest model module.
 * @module model/DeleteTLSInspectionConfigurationRequest
 * @version 2020-11-12
 */
class DeleteTLSInspectionConfigurationRequest {
    /**
     * Constructs a new <code>DeleteTLSInspectionConfigurationRequest</code>.
     * @alias module:model/DeleteTLSInspectionConfigurationRequest
     */
    constructor() { 
        
        DeleteTLSInspectionConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteTLSInspectionConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTLSInspectionConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DeleteTLSInspectionConfigurationRequest} The populated <code>DeleteTLSInspectionConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTLSInspectionConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTLSInspectionConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTLSInspectionConfigurationRequest</code>.
     */
 ...
 */
DeleteTLSInspectionConfigurationRequest.prototype['TLSInspectionConfigurationArn'] = undefined;

/**
 * @member {String} TLSInspectionConfigurationName
 */
DeleteTLSInspectionConfigurationRequest.prototype['TLSInspectionConfigurationName'] = undefined;
...
export default DeleteTLSInspectionConfigurationRequest;
