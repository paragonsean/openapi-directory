...
import DeleteFirewallPolicyResponseFirewallPolicyResponse from './DeleteFirewallPolicyResponseFirewallPolicyResponse';

/**
 * The DeleteFirewallPolicyResponse model module.
 * @module model/DeleteFirewallPolicyResponse
 * @version 2020-11-12
 */
class DeleteFirewallPolicyResponse {
    /**
     * Constructs a new <code>DeleteFirewallPolicyResponse</code>.
     * @alias module:model/DeleteFirewallPolicyResponse
     * @param firewallPolicyResponse {module:model/DeleteFirewallPolicyResponseFirewallPolicyResponse} 
     */
    constructor(firewallPolicyResponse) { 
        
        DeleteFirewallPolicyResponse.initialize(this, firewallPolicyResponse);
    }
     ...
     */
    static initialize(obj, firewallPolicyResponse) { 
        obj['FirewallPolicyResponse'] = firewallPolicyResponse;
    }

    /**
     * Constructs a <code>DeleteFirewallPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFirewallPolicyResponse} obj Optional instance to populate.
     * @return {module:model/DeleteFirewallPolicyResponse} The populated <code>DeleteFirewallPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFirewallPolicyResponse();

            if (data.hasOwnProperty('FirewallPolicyResponse')) {
                obj['FirewallPolicyResponse'] = DeleteFirewallPolicyResponseFirewallPolicyResponse.constructFromObject(data['FirewallPolicyResponse']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFirewallPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFirewallPolicyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteFirewallPolicyResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `FirewallPolicyResponse`
        if (data['FirewallPolicyResponse']) { // data not null
          DeleteFirewallPolicyResponseFirewallPolicyResponse.validateJSON(data['FirewallPolicyResponse']);
        }
...
DeleteFirewallPolicyResponse.RequiredProperties = ["FirewallPolicyResponse"];

/**
 * @member {module:model/DeleteFirewallPolicyResponseFirewallPolicyResponse} FirewallPolicyResponse
 */
DeleteFirewallPolicyResponse.prototype['FirewallPolicyResponse'] = undefined;
...
export default DeleteFirewallPolicyResponse;
