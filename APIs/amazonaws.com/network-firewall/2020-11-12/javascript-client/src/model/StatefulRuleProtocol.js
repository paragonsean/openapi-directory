...
* @readonly
*/
export default class StatefulRuleProtocol {
    ...
    /**
    * Returns a <code>StatefulRuleProtocol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StatefulRuleProtocol} The enum <code>StatefulRuleProtocol</code> value.
    */
