...
* @readonly
*/
export default class StatefulRuleDirection {
    ...
    /**
    * Returns a <code>StatefulRuleDirection</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StatefulRuleDirection} The enum <code>StatefulRuleDirection</code> value.
    */
