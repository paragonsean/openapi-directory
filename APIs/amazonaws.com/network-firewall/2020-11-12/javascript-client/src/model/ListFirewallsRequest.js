...
/**
 * The ListFirewallsRequest model module.
 * @module model/ListFirewallsRequest
 * @version 2020-11-12
 */
class ListFirewallsRequest {
    /**
     * Constructs a new <code>ListFirewallsRequest</code>.
     * @alias module:model/ListFirewallsRequest
     */
    constructor() { 
        
        ListFirewallsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFirewallsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFirewallsRequest} obj Optional instance to populate.
     * @return {module:model/ListFirewallsRequest} The populated <code>ListFirewallsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFirewallsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListFirewallsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFirewallsRequest</code>.
     */
 ...
 */
ListFirewallsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Array} VpcIds
 */
ListFirewallsRequest.prototype['VpcIds'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListFirewallsRequest.prototype['MaxResults'] = undefined;
...
export default ListFirewallsRequest;
