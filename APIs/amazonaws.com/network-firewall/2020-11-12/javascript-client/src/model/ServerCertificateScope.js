...
/**
 * The ServerCertificateScope model module.
 * @module model/ServerCertificateScope
 * @version 2020-11-12
 */
class ServerCertificateScope {
    /**
     * Constructs a new <code>ServerCertificateScope</code>.
     * Settings that define the Secure Sockets Layer/Transport Layer Security (SSL/TLS) traffic that Network Firewall should decrypt for inspection by the stateful rule engine.
     * @alias module:model/ServerCertificateScope
     */
    constructor() { 
        
        ServerCertificateScope.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerCertificateScope</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerCertificateScope} obj Optional instance to populate.
     * @return {module:model/ServerCertificateScope} The populated <code>ServerCertificateScope</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerCertificateScope();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerCertificateScope</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerCertificateScope</code>.
     */
 ...
 */
ServerCertificateScope.prototype['Sources'] = undefined;

/**
 * @member {Array} Destinations
 */
ServerCertificateScope.prototype['Destinations'] = undefined;

/**
 * @member {Array} SourcePorts
 */
ServerCertificateScope.prototype['SourcePorts'] = undefined;

/**
 * @member {Array} DestinationPorts
 */
ServerCertificateScope.prototype['DestinationPorts'] = undefined;

/**
 * @member {Array} Protocols
 */
ServerCertificateScope.prototype['Protocols'] = undefined;
...
export default ServerCertificateScope;
