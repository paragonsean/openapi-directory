...
/**
 * The PortSet model module.
 * @module model/PortSet
 * @version 2020-11-12
 */
class PortSet {
    /**
     * Constructs a new <code>PortSet</code>.
     * A set of port ranges for use in the rules in a rule group. 
     * @alias module:model/PortSet
     */
    constructor() { 
        
        PortSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PortSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PortSet} obj Optional instance to populate.
     * @return {module:model/PortSet} The populated <code>PortSet</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PortSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PortSet</code>.
     */
 ...
 */
PortSet.prototype['Definition'] = undefined;
