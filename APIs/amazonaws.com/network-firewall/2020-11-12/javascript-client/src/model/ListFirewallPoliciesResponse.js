...
/**
 * The ListFirewallPoliciesResponse model module.
 * @module model/ListFirewallPoliciesResponse
 * @version 2020-11-12
 */
class ListFirewallPoliciesResponse {
    /**
     * Constructs a new <code>ListFirewallPoliciesResponse</code>.
     * @alias module:model/ListFirewallPoliciesResponse
     */
    constructor() { 
        
        ListFirewallPoliciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFirewallPoliciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFirewallPoliciesResponse} obj Optional instance to populate.
     * @return {module:model/ListFirewallPoliciesResponse} The populated <code>ListFirewallPoliciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFirewallPoliciesResponse();

            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('FirewallPolicies')) {
                obj['FirewallPolicies'] = ApiClient.convertToType(data['FirewallPolicies'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListFirewallPoliciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFirewallPoliciesResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['FirewallPolicies']) { // data not null
          Array.validateJSON(data['FirewallPolicies']);
        }
 ...
 */
ListFirewallPoliciesResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} FirewallPolicies
 */
ListFirewallPoliciesResponse.prototype['FirewallPolicies'] = undefined;
...
export default ListFirewallPoliciesResponse;
