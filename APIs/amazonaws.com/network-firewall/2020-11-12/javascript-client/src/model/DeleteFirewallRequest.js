...
/**
 * The DeleteFirewallRequest model module.
 * @module model/DeleteFirewallRequest
 * @version 2020-11-12
 */
class DeleteFirewallRequest {
    /**
     * Constructs a new <code>DeleteFirewallRequest</code>.
     * @alias module:model/DeleteFirewallRequest
     */
    constructor() { 
        
        DeleteFirewallRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteFirewallRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteFirewallRequest} obj Optional instance to populate.
     * @return {module:model/DeleteFirewallRequest} The populated <code>DeleteFirewallRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFirewallRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFirewallRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFirewallRequest</code>.
     */
 ...
 */
DeleteFirewallRequest.prototype['FirewallName'] = undefined;

/**
 * @member {String} FirewallArn
 */
DeleteFirewallRequest.prototype['FirewallArn'] = undefined;
...
export default DeleteFirewallRequest;
