...
* @readonly
*/
export default class RuleOrder {
    ...
    /**
    * Returns a <code>RuleOrder</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RuleOrder} The enum <code>RuleOrder</code> value.
    */
