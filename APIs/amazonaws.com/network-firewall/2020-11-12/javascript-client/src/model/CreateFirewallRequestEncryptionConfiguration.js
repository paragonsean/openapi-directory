...
/**
 * The CreateFirewallRequestEncryptionConfiguration model module.
 * @module model/CreateFirewallRequestEncryptionConfiguration
 * @version 2020-11-12
 */
class CreateFirewallRequestEncryptionConfiguration {
    /**
     * Constructs a new <code>CreateFirewallRequestEncryptionConfiguration</code>.
     * @alias module:model/CreateFirewallRequestEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        CreateFirewallRequestEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallRequestEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallRequestEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateFirewallRequestEncryptionConfiguration} The populated <code>CreateFirewallRequestEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallRequestEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallRequestEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallRequestEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallRequestEncryptionConfiguration.RequiredProperties) {
...
CreateFirewallRequestEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
CreateFirewallRequestEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
CreateFirewallRequestEncryptionConfiguration.prototype['Type'] = undefined;
...
export default CreateFirewallRequestEncryptionConfiguration;
