...
import StatefulAction from './StatefulAction';
import StatefulRuleHeader from './StatefulRuleHeader';

/**
 * The StatefulRule model module.
 * @module model/StatefulRule
 * @version 2020-11-12
 */
class StatefulRule {
    /**
     * Constructs a new <code>StatefulRule</code>.
     ...
     * @alias module:model/StatefulRule
     * @param action {module:model/StatefulAction} 
     * @param header {module:model/StatefulRuleHeader} 
     * @param ruleOptions {Array} 
     */
    constructor(action, header, ruleOptions) { 
        
        StatefulRule.initialize(this, action, header, ruleOptions);
    }
     ...
     */
    static initialize(obj, action, header, ruleOptions) { 
        obj['Action'] = action;
        obj['Header'] = header;
        obj['RuleOptions'] = ruleOptions;
    }

    /**
     * Constructs a <code>StatefulRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulRule} obj Optional instance to populate.
     * @return {module:model/StatefulRule} The populated <code>StatefulRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulRule();

            if (data.hasOwnProperty('Action')) {
                obj['Action'] = ApiClient.convertToType(data['Action'], StatefulAction);
            }
            if (data.hasOwnProperty('Header')) {
                obj['Header'] = StatefulRuleHeader.constructFromObject(data['Header']);
            }
            if (data.hasOwnProperty('RuleOptions')) {
                obj['RuleOptions'] = ApiClient.convertToType(data['RuleOptions'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatefulRule.RequiredProperties) {
        ...
        if (data['Action']) { // data not null
          StatefulAction.validateJSON(data['Action']);
        }
        // validate the optional field `Header`
        if (data['Header']) { // data not null
          StatefulRuleHeader.validateJSON(data['Header']);
        }
        // validate the optional field `RuleOptions`
        if (data['RuleOptions']) { // data not null
          Array.validateJSON(data['RuleOptions']);
        }
...
StatefulRule.RequiredProperties = ["Action", "Header", "RuleOptions"];

/**
 * @member {module:model/StatefulAction} Action
 */
StatefulRule.prototype['Action'] = undefined;

/**
 * @member {module:model/StatefulRuleHeader} Header
 */
StatefulRule.prototype['Header'] = undefined;

/**
 * @member {Array} RuleOptions
 */
StatefulRule.prototype['RuleOptions'] = undefined;
