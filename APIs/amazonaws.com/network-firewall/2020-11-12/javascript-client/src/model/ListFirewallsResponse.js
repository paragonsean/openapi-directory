...
/**
 * The ListFirewallsResponse model module.
 * @module model/ListFirewallsResponse
 * @version 2020-11-12
 */
class ListFirewallsResponse {
    /**
     * Constructs a new <code>ListFirewallsResponse</code>.
     * @alias module:model/ListFirewallsResponse
     */
    constructor() { 
        
        ListFirewallsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFirewallsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFirewallsResponse} obj Optional instance to populate.
     * @return {module:model/ListFirewallsResponse} The populated <code>ListFirewallsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFirewallsResponse();

            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('Firewalls')) {
                obj['Firewalls'] = ApiClient.convertToType(data['Firewalls'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListFirewallsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFirewallsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Firewalls']) { // data not null
          Array.validateJSON(data['Firewalls']);
        }
 ...
 */
ListFirewallsResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} Firewalls
 */
ListFirewallsResponse.prototype['Firewalls'] = undefined;
...
export default ListFirewallsResponse;
