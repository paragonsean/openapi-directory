...
/**
 * The RulesSourceRulesSourceList model module.
 * @module model/RulesSourceRulesSourceList
 * @version 2020-11-12
 */
class RulesSourceRulesSourceList {
    /**
     * Constructs a new <code>RulesSourceRulesSourceList</code>.
     * @alias module:model/RulesSourceRulesSourceList
     * @implements module:model/RulesSourceList
     * @param targets {Array} 
    ...
    constructor(targets, targetTypes, generatedRulesType) { 
        ...
        RulesSourceRulesSourceList.initialize(this, targets, targetTypes, generatedRulesType);
    }
    ...
    /**
     * Constructs a <code>RulesSourceRulesSourceList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RulesSourceRulesSourceList} obj Optional instance to populate.
     * @return {module:model/RulesSourceRulesSourceList} The populated <code>RulesSourceRulesSourceList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RulesSourceRulesSourceList();
            RulesSourceList.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RulesSourceRulesSourceList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RulesSourceRulesSourceList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RulesSourceRulesSourceList.RequiredProperties) {
...
RulesSourceRulesSourceList.RequiredProperties = ["Targets", "TargetTypes", "GeneratedRulesType"];

/**
 * @member {Array} Targets
 */
RulesSourceRulesSourceList.prototype['Targets'] = undefined;

/**
 * @member {Array} TargetTypes
 */
RulesSourceRulesSourceList.prototype['TargetTypes'] = undefined;

/**
 * @member {module:model/GeneratedRulesType} GeneratedRulesType
 */
RulesSourceRulesSourceList.prototype['GeneratedRulesType'] = undefined;


// Implement RulesSourceList interface:
/**
 * @member {Array} Targets
 */
...
export default RulesSourceRulesSourceList;
