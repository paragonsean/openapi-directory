...
/**
 * The AssociateSubnetsRequest model module.
 * @module model/AssociateSubnetsRequest
 * @version 2020-11-12
 */
class AssociateSubnetsRequest {
    /**
     * Constructs a new <code>AssociateSubnetsRequest</code>.
     * @alias module:model/AssociateSubnetsRequest
     * @param subnetMappings {Array} 
     */
    constructor(subnetMappings) { 
        
        AssociateSubnetsRequest.initialize(this, subnetMappings);
    }
     ...
     */
    static initialize(obj, subnetMappings) { 
        obj['SubnetMappings'] = subnetMappings;
    }

    /**
     * Constructs a <code>AssociateSubnetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateSubnetsRequest} obj Optional instance to populate.
     * @return {module:model/AssociateSubnetsRequest} The populated <code>AssociateSubnetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateSubnetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateSubnetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateSubnetsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateSubnetsRequest.RequiredProperties) {
...
AssociateSubnetsRequest.RequiredProperties = ["SubnetMappings"];

/**
 * @member {String} UpdateToken
 */
AssociateSubnetsRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
AssociateSubnetsRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
AssociateSubnetsRequest.prototype['FirewallName'] = undefined;

/**
 * @member {Array} SubnetMappings
 */
AssociateSubnetsRequest.prototype['SubnetMappings'] = undefined;
...
export default AssociateSubnetsRequest;
