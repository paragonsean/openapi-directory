...
import ResourceManagedStatus from './ResourceManagedStatus';
import ResourceManagedType from './ResourceManagedType';
import RuleGroupType from './RuleGroupType';

/**
 * The ListRuleGroupsRequest model module.
 * @module model/ListRuleGroupsRequest
 * @version 2020-11-12
 */
class ListRuleGroupsRequest {
    /**
     * Constructs a new <code>ListRuleGroupsRequest</code>.
     * @alias module:model/ListRuleGroupsRequest
     */
    constructor() { 
        
        ListRuleGroupsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRuleGroupsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRuleGroupsRequest} obj Optional instance to populate.
     * @return {module:model/ListRuleGroupsRequest} The populated <code>ListRuleGroupsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRuleGroupsRequest();
            ...
            if (data.hasOwnProperty('Scope')) {
                obj['Scope'] = ApiClient.convertToType(data['Scope'], ResourceManagedStatus);
            }
            if (data.hasOwnProperty('ManagedType')) {
                obj['ManagedType'] = ApiClient.convertToType(data['ManagedType'], ResourceManagedType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRuleGroupsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRuleGroupsRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Scope']) { // data not null
          ResourceManagedStatus.validateJSON(data['Scope']);
        }
        // validate the optional field `ManagedType`
        if (data['ManagedType']) { // data not null
          ResourceManagedType.validateJSON(data['ManagedType']);
        }
 ...
 */
ListRuleGroupsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListRuleGroupsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {module:model/ResourceManagedStatus} Scope
 */
ListRuleGroupsRequest.prototype['Scope'] = undefined;

/**
 * @member {module:model/ResourceManagedType} ManagedType
 */
ListRuleGroupsRequest.prototype['ManagedType'] = undefined;

/**
 * @member {module:model/RuleGroupType} Type
 */
ListRuleGroupsRequest.prototype['Type'] = undefined;
...
export default ListRuleGroupsRequest;
