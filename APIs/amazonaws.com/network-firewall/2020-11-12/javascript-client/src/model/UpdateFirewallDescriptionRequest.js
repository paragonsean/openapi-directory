...
/**
 * The UpdateFirewallDescriptionRequest model module.
 * @module model/UpdateFirewallDescriptionRequest
 * @version 2020-11-12
 */
class UpdateFirewallDescriptionRequest {
    /**
     * Constructs a new <code>UpdateFirewallDescriptionRequest</code>.
     * @alias module:model/UpdateFirewallDescriptionRequest
     */
    constructor() { 
        
        UpdateFirewallDescriptionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallDescriptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallDescriptionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallDescriptionRequest} The populated <code>UpdateFirewallDescriptionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallDescriptionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallDescriptionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallDescriptionRequest</code>.
     */
 ...
 */
UpdateFirewallDescriptionRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateFirewallDescriptionRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallDescriptionRequest.prototype['FirewallName'] = undefined;

/**
 * @member {String} Description
 */
UpdateFirewallDescriptionRequest.prototype['Description'] = undefined;
...
export default UpdateFirewallDescriptionRequest;
