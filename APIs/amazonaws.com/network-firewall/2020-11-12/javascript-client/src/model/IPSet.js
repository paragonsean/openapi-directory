...
class IPSet {
    ...
    constructor(definition) { 
        ...
        IPSet.initialize(this, definition);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Definition')) {
                obj['Definition'] = ApiClient.convertToType(data['Definition'], Array);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Definition']) { // data not null
          Array.validateJSON(data['Definition']);
        }
...
IPSet.RequiredProperties = ["Definition"];

/**
 * @member {Array} Definition
 */
IPSet.prototype['Definition'] = undefined;
