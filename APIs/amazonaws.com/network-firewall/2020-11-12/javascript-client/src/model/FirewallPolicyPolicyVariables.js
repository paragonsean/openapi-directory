...
/**
 * The FirewallPolicyPolicyVariables model module.
 * @module model/FirewallPolicyPolicyVariables
 * @version 2020-11-12
 */
class FirewallPolicyPolicyVariables {
    /**
     * Constructs a new <code>FirewallPolicyPolicyVariables</code>.
     * @alias module:model/FirewallPolicyPolicyVariables
     * @implements module:model/PolicyVariables
     */
    constructor() { 
        PolicyVariables.initialize(this);
        FirewallPolicyPolicyVariables.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallPolicyPolicyVariables</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallPolicyPolicyVariables} obj Optional instance to populate.
     * @return {module:model/FirewallPolicyPolicyVariables} The populated <code>FirewallPolicyPolicyVariables</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallPolicyPolicyVariables();
            PolicyVariables.constructFromObject(data, obj);

            if (data.hasOwnProperty('RuleVariables')) {
                obj['RuleVariables'] = ApiClient.convertToType(data['RuleVariables'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallPolicyPolicyVariables</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallPolicyPolicyVariables</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RuleVariables`
        if (data['RuleVariables']) { // data not null
          Object.validateJSON(data['RuleVariables']);
        }
...
/**
 * @member {Object} RuleVariables
 */
FirewallPolicyPolicyVariables.prototype['RuleVariables'] = undefined;


// Implement PolicyVariables interface:
/**
 * @member {Object} RuleVariables
 */
PolicyVariables.prototype['RuleVariables'] = undefined;




export default FirewallPolicyPolicyVariables;
