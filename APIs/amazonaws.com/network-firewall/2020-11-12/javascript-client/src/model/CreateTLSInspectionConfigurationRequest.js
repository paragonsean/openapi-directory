...
/**
 * The CreateTLSInspectionConfigurationRequest model module.
 * @module model/CreateTLSInspectionConfigurationRequest
 * @version 2020-11-12
 */
class CreateTLSInspectionConfigurationRequest {
    /**
     * Constructs a new <code>CreateTLSInspectionConfigurationRequest</code>.
     * @alias module:model/CreateTLSInspectionConfigurationRequest
     ...
     */
    constructor(tLSInspectionConfigurationName, tLSInspectionConfiguration) { 
        
        CreateTLSInspectionConfigurationRequest.initialize(this, tLSInspectionConfigurationName, tLSInspectionConfiguration);
    }
     ...
     */
    static initialize(obj, tLSInspectionConfigurationName, tLSInspectionConfiguration) { 
    ...
    /**
     * Constructs a <code>CreateTLSInspectionConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTLSInspectionConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/CreateTLSInspectionConfigurationRequest} The populated <code>CreateTLSInspectionConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTLSInspectionConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTLSInspectionConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTLSInspectionConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTLSInspectionConfigurationRequest.RequiredProperties) {
...
CreateTLSInspectionConfigurationRequest.RequiredProperties = ["TLSInspectionConfigurationName", "TLSInspectionConfiguration"];

/**
 * @member {String} TLSInspectionConfigurationName
 */
CreateTLSInspectionConfigurationRequest.prototype['TLSInspectionConfigurationName'] = undefined;

/**
 * @member {module:model/CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration} TLSInspectionConfiguration
 */
CreateTLSInspectionConfigurationRequest.prototype['TLSInspectionConfiguration'] = undefined;

/**
 * @member {String} Description
 */
CreateTLSInspectionConfigurationRequest.prototype['Description'] = undefined;

/**
 * @member {Array} Tags
 */
CreateTLSInspectionConfigurationRequest.prototype['Tags'] = undefined;

/**
 * @member {module:model/EncryptionConfiguration} EncryptionConfiguration
 */
CreateTLSInspectionConfigurationRequest.prototype['EncryptionConfiguration'] = undefined;
...
export default CreateTLSInspectionConfigurationRequest;
