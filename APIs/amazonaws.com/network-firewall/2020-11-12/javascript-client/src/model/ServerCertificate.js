...
/**
 * The ServerCertificate model module.
 * @module model/ServerCertificate
 * @version 2020-11-12
 */
class ServerCertificate {
    /**
     * Constructs a new <code>ServerCertificate</code>.
     ...
     * @alias module:model/ServerCertificate
     */
    constructor() { 
        
        ServerCertificate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ServerCertificate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServerCertificate} obj Optional instance to populate.
     * @return {module:model/ServerCertificate} The populated <code>ServerCertificate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServerCertificate();
    ...
    /**
     * Validates the JSON data with respect to <code>ServerCertificate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServerCertificate</code>.
     */
 ...
 */
ServerCertificate.prototype['ResourceArn'] = undefined;
