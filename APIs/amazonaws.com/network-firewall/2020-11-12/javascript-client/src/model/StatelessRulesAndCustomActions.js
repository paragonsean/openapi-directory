...
/**
 * The StatelessRulesAndCustomActions model module.
 * @module model/StatelessRulesAndCustomActions
 * @version 2020-11-12
 */
class StatelessRulesAndCustomActions {
    /**
     * Constructs a new <code>StatelessRulesAndCustomActions</code>.
     * Stateless inspection criteria. Each stateless rule group uses exactly one of these data types to define its stateless rules. 
     * @alias module:model/StatelessRulesAndCustomActions
    ...
    /**
     * Constructs a <code>StatelessRulesAndCustomActions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessRulesAndCustomActions} obj Optional instance to populate.
     * @return {module:model/StatelessRulesAndCustomActions} The populated <code>StatelessRulesAndCustomActions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessRulesAndCustomActions();
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessRulesAndCustomActions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessRulesAndCustomActions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessRulesAndCustomActions.RequiredProperties) {
...
StatelessRulesAndCustomActions.RequiredProperties = ["StatelessRules"];
...
export default StatelessRulesAndCustomActions;
