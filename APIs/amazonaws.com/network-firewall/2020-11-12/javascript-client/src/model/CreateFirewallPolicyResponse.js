...
/**
 * The CreateFirewallPolicyResponse model module.
 * @module model/CreateFirewallPolicyResponse
 * @version 2020-11-12
 */
class CreateFirewallPolicyResponse {
    /**
     * Constructs a new <code>CreateFirewallPolicyResponse</code>.
     * @alias module:model/CreateFirewallPolicyResponse
    ...
    constructor(updateToken, firewallPolicyResponse) { 
        ...
        CreateFirewallPolicyResponse.initialize(this, updateToken, firewallPolicyResponse);
    }
    ...
    /**
     * Constructs a <code>CreateFirewallPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFirewallPolicyResponse} obj Optional instance to populate.
     * @return {module:model/CreateFirewallPolicyResponse} The populated <code>CreateFirewallPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFirewallPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFirewallPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFirewallPolicyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFirewallPolicyResponse.RequiredProperties) {
...
CreateFirewallPolicyResponse.RequiredProperties = ["UpdateToken", "FirewallPolicyResponse"];

/**
 * @member {String} UpdateToken
 */
CreateFirewallPolicyResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/CreateFirewallPolicyResponseFirewallPolicyResponse} FirewallPolicyResponse
 */
CreateFirewallPolicyResponse.prototype['FirewallPolicyResponse'] = undefined;
...
export default CreateFirewallPolicyResponse;
