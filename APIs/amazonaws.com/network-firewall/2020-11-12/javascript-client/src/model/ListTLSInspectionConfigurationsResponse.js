...
/**
 * The ListTLSInspectionConfigurationsResponse model module.
 * @module model/ListTLSInspectionConfigurationsResponse
 * @version 2020-11-12
 */
class ListTLSInspectionConfigurationsResponse {
    /**
     * Constructs a new <code>ListTLSInspectionConfigurationsResponse</code>.
     * @alias module:model/ListTLSInspectionConfigurationsResponse
     */
    constructor() { 
        
        ListTLSInspectionConfigurationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListTLSInspectionConfigurationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTLSInspectionConfigurationsResponse} obj Optional instance to populate.
     * @return {module:model/ListTLSInspectionConfigurationsResponse} The populated <code>ListTLSInspectionConfigurationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListTLSInspectionConfigurationsResponse();

            if (data.hasOwnProperty('NextToken')) {
                obj['NextToken'] = ApiClient.convertToType(data['NextToken'], 'String');
            }
            if (data.hasOwnProperty('TLSInspectionConfigurations')) {
                obj['TLSInspectionConfigurations'] = ApiClient.convertToType(data['TLSInspectionConfigurations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTLSInspectionConfigurationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTLSInspectionConfigurationsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['TLSInspectionConfigurations']) { // data not null
          Array.validateJSON(data['TLSInspectionConfigurations']);
        }
 ...
 */
ListTLSInspectionConfigurationsResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} TLSInspectionConfigurations
 */
ListTLSInspectionConfigurationsResponse.prototype['TLSInspectionConfigurations'] = undefined;
...
export default ListTLSInspectionConfigurationsResponse;
