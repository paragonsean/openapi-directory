...
/**
 * The UpdateFirewallDeleteProtectionResponse model module.
 * @module model/UpdateFirewallDeleteProtectionResponse
 * @version 2020-11-12
 */
class UpdateFirewallDeleteProtectionResponse {
    /**
     * Constructs a new <code>UpdateFirewallDeleteProtectionResponse</code>.
     * @alias module:model/UpdateFirewallDeleteProtectionResponse
     */
    constructor() { 
        
        UpdateFirewallDeleteProtectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallDeleteProtectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallDeleteProtectionResponse} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallDeleteProtectionResponse} The populated <code>UpdateFirewallDeleteProtectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallDeleteProtectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallDeleteProtectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallDeleteProtectionResponse</code>.
     */
 ...
 */
UpdateFirewallDeleteProtectionResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallDeleteProtectionResponse.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} DeleteProtection
 */
UpdateFirewallDeleteProtectionResponse.prototype['DeleteProtection'] = undefined;

/**
 * @member {String} UpdateToken
 */
UpdateFirewallDeleteProtectionResponse.prototype['UpdateToken'] = undefined;
...
export default UpdateFirewallDeleteProtectionResponse;
