...
/**
 * The UpdateFirewallEncryptionConfigurationRequest model module.
 * @module model/UpdateFirewallEncryptionConfigurationRequest
 * @version 2020-11-12
 */
class UpdateFirewallEncryptionConfigurationRequest {
    /**
     * Constructs a new <code>UpdateFirewallEncryptionConfigurationRequest</code>.
     * @alias module:model/UpdateFirewallEncryptionConfigurationRequest
     */
    constructor() { 
        
        UpdateFirewallEncryptionConfigurationRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallEncryptionConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallEncryptionConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallEncryptionConfigurationRequest} The populated <code>UpdateFirewallEncryptionConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallEncryptionConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallEncryptionConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallEncryptionConfigurationRequest</code>.
     */
 ...
 */
UpdateFirewallEncryptionConfigurationRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateFirewallEncryptionConfigurationRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallEncryptionConfigurationRequest.prototype['FirewallName'] = undefined;

/**
 * @member {module:model/EncryptionConfiguration} EncryptionConfiguration
 */
UpdateFirewallEncryptionConfigurationRequest.prototype['EncryptionConfiguration'] = undefined;
...
export default UpdateFirewallEncryptionConfigurationRequest;
