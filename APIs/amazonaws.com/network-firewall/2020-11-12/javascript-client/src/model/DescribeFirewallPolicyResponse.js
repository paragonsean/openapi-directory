...
import DescribeFirewallPolicyResponseFirewallPolicy from './DescribeFirewallPolicyResponseFirewallPolicy';

/**
 * The DescribeFirewallPolicyResponse model module.
 * @module model/DescribeFirewallPolicyResponse
 * @version 2020-11-12
 */
class DescribeFirewallPolicyResponse {
    /**
     * Constructs a new <code>DescribeFirewallPolicyResponse</code>.
     * @alias module:model/DescribeFirewallPolicyResponse
    ...
    constructor(updateToken, firewallPolicyResponse) { 
        ...
        DescribeFirewallPolicyResponse.initialize(this, updateToken, firewallPolicyResponse);
    }
    ...
    /**
     * Constructs a <code>DescribeFirewallPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFirewallPolicyResponse} obj Optional instance to populate.
     * @return {module:model/DescribeFirewallPolicyResponse} The populated <code>DescribeFirewallPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFirewallPolicyResponse();
            ...
            if (data.hasOwnProperty('FirewallPolicy')) {
                obj['FirewallPolicy'] = DescribeFirewallPolicyResponseFirewallPolicy.constructFromObject(data['FirewallPolicy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFirewallPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFirewallPolicyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeFirewallPolicyResponse.RequiredProperties) {
        ...
        if (data['FirewallPolicy']) { // data not null
          DescribeFirewallPolicyResponseFirewallPolicy.validateJSON(data['FirewallPolicy']);
        }
...
DescribeFirewallPolicyResponse.RequiredProperties = ["UpdateToken", "FirewallPolicyResponse"];

/**
 * @member {String} UpdateToken
 */
DescribeFirewallPolicyResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/CreateFirewallPolicyResponseFirewallPolicyResponse} FirewallPolicyResponse
 */
DescribeFirewallPolicyResponse.prototype['FirewallPolicyResponse'] = undefined;

/**
 * @member {module:model/DescribeFirewallPolicyResponseFirewallPolicy} FirewallPolicy
 */
DescribeFirewallPolicyResponse.prototype['FirewallPolicy'] = undefined;
...
export default DescribeFirewallPolicyResponse;
