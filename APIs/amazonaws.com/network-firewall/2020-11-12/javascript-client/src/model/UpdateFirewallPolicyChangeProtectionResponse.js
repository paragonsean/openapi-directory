...
/**
 * The UpdateFirewallPolicyChangeProtectionResponse model module.
 * @module model/UpdateFirewallPolicyChangeProtectionResponse
 * @version 2020-11-12
 */
class UpdateFirewallPolicyChangeProtectionResponse {
    /**
     * Constructs a new <code>UpdateFirewallPolicyChangeProtectionResponse</code>.
     * @alias module:model/UpdateFirewallPolicyChangeProtectionResponse
     */
    constructor() { 
        
        UpdateFirewallPolicyChangeProtectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallPolicyChangeProtectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallPolicyChangeProtectionResponse} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallPolicyChangeProtectionResponse} The populated <code>UpdateFirewallPolicyChangeProtectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallPolicyChangeProtectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallPolicyChangeProtectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallPolicyChangeProtectionResponse</code>.
     */
 ...
 */
UpdateFirewallPolicyChangeProtectionResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateFirewallPolicyChangeProtectionResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallPolicyChangeProtectionResponse.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} FirewallPolicyChangeProtection
 */
UpdateFirewallPolicyChangeProtectionResponse.prototype['FirewallPolicyChangeProtection'] = undefined;
...
export default UpdateFirewallPolicyChangeProtectionResponse;
