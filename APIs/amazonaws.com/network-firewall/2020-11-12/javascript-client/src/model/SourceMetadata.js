...
class SourceMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('SourceUpdateToken')) {
                obj['SourceUpdateToken'] = ApiClient.convertToType(data['SourceUpdateToken'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['SourceUpdateToken']) { // data not null
          String.validateJSON(data['SourceUpdateToken']);
        }
 ...
 */
SourceMetadata.prototype['SourceArn'] = undefined;

/**
 * @member {String} SourceUpdateToken
 */
SourceMetadata.prototype['SourceUpdateToken'] = undefined;
