...
/**
 * The RuleGroupMetadata model module.
 * @module model/RuleGroupMetadata
 * @version 2020-11-12
 */
class RuleGroupMetadata {
    /**
     * Constructs a new <code>RuleGroupMetadata</code>.
     ...
     * @alias module:model/RuleGroupMetadata
     */
    constructor() { 
        
        RuleGroupMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupMetadata} obj Optional instance to populate.
     * @return {module:model/RuleGroupMetadata} The populated <code>RuleGroupMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupMetadata</code>.
     */
 ...
 * @member {String} Name
 */
RuleGroupMetadata.prototype['Name'] = undefined;

/**
 * @member {String} Arn
 */
RuleGroupMetadata.prototype['Arn'] = undefined;
...
export default RuleGroupMetadata;
