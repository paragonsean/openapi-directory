...
/**
 * The AssociateSubnetsResponse model module.
 * @module model/AssociateSubnetsResponse
 * @version 2020-11-12
 */
class AssociateSubnetsResponse {
    /**
     * Constructs a new <code>AssociateSubnetsResponse</code>.
     * @alias module:model/AssociateSubnetsResponse
     */
    constructor() { 
        
        AssociateSubnetsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateSubnetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateSubnetsResponse} obj Optional instance to populate.
     * @return {module:model/AssociateSubnetsResponse} The populated <code>AssociateSubnetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateSubnetsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateSubnetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateSubnetsResponse</code>.
     */
 ...
 */
AssociateSubnetsResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
AssociateSubnetsResponse.prototype['FirewallName'] = undefined;

/**
 * @member {Array} SubnetMappings
 */
AssociateSubnetsResponse.prototype['SubnetMappings'] = undefined;

/**
 * @member {String} UpdateToken
 */
AssociateSubnetsResponse.prototype['UpdateToken'] = undefined;
...
export default AssociateSubnetsResponse;
