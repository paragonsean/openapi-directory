...
/**
 * The UpdateSubnetChangeProtectionResponse model module.
 * @module model/UpdateSubnetChangeProtectionResponse
 * @version 2020-11-12
 */
class UpdateSubnetChangeProtectionResponse {
    /**
     * Constructs a new <code>UpdateSubnetChangeProtectionResponse</code>.
     * @alias module:model/UpdateSubnetChangeProtectionResponse
     */
    constructor() { 
        
        UpdateSubnetChangeProtectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSubnetChangeProtectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSubnetChangeProtectionResponse} obj Optional instance to populate.
     * @return {module:model/UpdateSubnetChangeProtectionResponse} The populated <code>UpdateSubnetChangeProtectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSubnetChangeProtectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSubnetChangeProtectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSubnetChangeProtectionResponse</code>.
     */
 ...
 */
UpdateSubnetChangeProtectionResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
UpdateSubnetChangeProtectionResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateSubnetChangeProtectionResponse.prototype['FirewallName'] = undefined;

/**
 * @member {Boolean} SubnetChangeProtection
 */
UpdateSubnetChangeProtectionResponse.prototype['SubnetChangeProtection'] = undefined;
...
export default UpdateSubnetChangeProtectionResponse;
