...
/**
 * The CreateTLSInspectionConfigurationResponse model module.
 * @module model/CreateTLSInspectionConfigurationResponse
 * @version 2020-11-12
 */
class CreateTLSInspectionConfigurationResponse {
    /**
     * Constructs a new <code>CreateTLSInspectionConfigurationResponse</code>.
     * @alias module:model/CreateTLSInspectionConfigurationResponse
    ...
    constructor(updateToken, tLSInspectionConfigurationResponse) { 
        ...
        CreateTLSInspectionConfigurationResponse.initialize(this, updateToken, tLSInspectionConfigurationResponse);
    }
    ...
    /**
     * Constructs a <code>CreateTLSInspectionConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateTLSInspectionConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/CreateTLSInspectionConfigurationResponse} The populated <code>CreateTLSInspectionConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTLSInspectionConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateTLSInspectionConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateTLSInspectionConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateTLSInspectionConfigurationResponse.RequiredProperties) {
...
CreateTLSInspectionConfigurationResponse.RequiredProperties = ["UpdateToken", "TLSInspectionConfigurationResponse"];

/**
 * @member {String} UpdateToken
 */
CreateTLSInspectionConfigurationResponse.prototype['UpdateToken'] = undefined;
 ...
 */
CreateTLSInspectionConfigurationResponse.prototype['TLSInspectionConfigurationResponse'] = undefined;
...
export default CreateTLSInspectionConfigurationResponse;
