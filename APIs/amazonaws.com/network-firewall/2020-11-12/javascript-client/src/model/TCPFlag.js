...
export default class TCPFlag {
    ...
    /**
    * Returns a <code>TCPFlag</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TCPFlag} The enum <code>TCPFlag</code> value.
    */
