...
import CreateFirewallResponseFirewall from './CreateFirewallResponseFirewall';
import CreateFirewallResponseFirewallStatus from './CreateFirewallResponseFirewallStatus';

/**
 * The DescribeFirewallResponse model module.
 * @module model/DescribeFirewallResponse
 * @version 2020-11-12
 */
class DescribeFirewallResponse {
    /**
     * Constructs a new <code>DescribeFirewallResponse</code>.
     * @alias module:model/DescribeFirewallResponse
     */
    constructor() { 
        
        DescribeFirewallResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeFirewallResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeFirewallResponse} obj Optional instance to populate.
     * @return {module:model/DescribeFirewallResponse} The populated <code>DescribeFirewallResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeFirewallResponse();
            ...
            if (data.hasOwnProperty('Firewall')) {
                obj['Firewall'] = CreateFirewallResponseFirewall.constructFromObject(data['Firewall']);
            }
            if (data.hasOwnProperty('FirewallStatus')) {
                obj['FirewallStatus'] = CreateFirewallResponseFirewallStatus.constructFromObject(data['FirewallStatus']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFirewallResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFirewallResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Firewall']) { // data not null
          CreateFirewallResponseFirewall.validateJSON(data['Firewall']);
        }
        // validate the optional field `FirewallStatus`
        if (data['FirewallStatus']) { // data not null
          CreateFirewallResponseFirewallStatus.validateJSON(data['FirewallStatus']);
        }
 ...
 */
DescribeFirewallResponse.prototype['UpdateToken'] = undefined;

/**
 * @member {module:model/CreateFirewallResponseFirewall} Firewall
 */
DescribeFirewallResponse.prototype['Firewall'] = undefined;

/**
 * @member {module:model/CreateFirewallResponseFirewallStatus} FirewallStatus
 */
DescribeFirewallResponse.prototype['FirewallStatus'] = undefined;
...
export default DescribeFirewallResponse;
