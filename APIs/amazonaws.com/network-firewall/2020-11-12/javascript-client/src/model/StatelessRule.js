...
import StatelessRuleRuleDefinition from './StatelessRuleRuleDefinition';

/**
 * The StatelessRule model module.
 * @module model/StatelessRule
 * @version 2020-11-12
 */
class StatelessRule {
    /**
     * Constructs a new <code>StatelessRule</code>.
     * A single stateless rule. This is used in &lt;a&gt;StatelessRulesAndCustomActions&lt;/a&gt;.
     * @alias module:model/StatelessRule
     * @param ruleDefinition {module:model/StatelessRuleRuleDefinition} 
     * @param priority {Number} 
     */
    constructor(ruleDefinition, priority) { 
        
        StatelessRule.initialize(this, ruleDefinition, priority);
    }
     ...
     */
    static initialize(obj, ruleDefinition, priority) { 
        obj['RuleDefinition'] = ruleDefinition;
        obj['Priority'] = priority;
    }

    /**
     * Constructs a <code>StatelessRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatelessRule} obj Optional instance to populate.
     * @return {module:model/StatelessRule} The populated <code>StatelessRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatelessRule();

            if (data.hasOwnProperty('RuleDefinition')) {
                obj['RuleDefinition'] = StatelessRuleRuleDefinition.constructFromObject(data['RuleDefinition']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StatelessRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatelessRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatelessRule.RequiredProperties) {
        ...
        if (data['RuleDefinition']) { // data not null
          StatelessRuleRuleDefinition.validateJSON(data['RuleDefinition']);
        }
...
StatelessRule.RequiredProperties = ["RuleDefinition", "Priority"];

/**
 * @member {module:model/StatelessRuleRuleDefinition} RuleDefinition
 */
StatelessRule.prototype['RuleDefinition'] = undefined;

/**
 * @member {Number} Priority
 */
StatelessRule.prototype['Priority'] = undefined;
