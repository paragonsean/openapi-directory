...
/**
 * The ReferenceSets model module.
 * @module model/ReferenceSets
 * @version 2020-11-12
 */
class ReferenceSets {
    /**
     * Constructs a new <code>ReferenceSets</code>.
     * Contains a set of IP set references.
     * @alias module:model/ReferenceSets
     */
    constructor() { 
        
        ReferenceSets.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReferenceSets</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReferenceSets} obj Optional instance to populate.
     * @return {module:model/ReferenceSets} The populated <code>ReferenceSets</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReferenceSets();

            if (data.hasOwnProperty('IPSetReferences')) {
                obj['IPSetReferences'] = ApiClient.convertToType(data['IPSetReferences'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReferenceSets</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReferenceSets</code>.
     */
    static validateJSON(data) {
        // validate the optional field `IPSetReferences`
        if (data['IPSetReferences']) { // data not null
          Object.validateJSON(data['IPSetReferences']);
        }
...
/**
 * @member {Object} IPSetReferences
 */
ReferenceSets.prototype['IPSetReferences'] = undefined;
