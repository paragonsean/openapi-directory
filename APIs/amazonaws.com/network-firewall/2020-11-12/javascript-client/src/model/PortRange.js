...
class PortRange {
    ...
    constructor(fromPort, toPort) { 
        ...
        PortRange.initialize(this, fromPort, toPort);
    }
     ...
     */
    static initialize(obj, fromPort, toPort) { 
...
PortRange.RequiredProperties = ["FromPort", "ToPort"];

/**
 * @member {Number} FromPort
 */
PortRange.prototype['FromPort'] = undefined;

/**
 * @member {Number} ToPort
 */
PortRange.prototype['ToPort'] = undefined;
