...
/**
 * The FirewallPolicyResponseEncryptionConfiguration model module.
 * @module model/FirewallPolicyResponseEncryptionConfiguration
 * @version 2020-11-12
 */
class FirewallPolicyResponseEncryptionConfiguration {
    /**
     * Constructs a new <code>FirewallPolicyResponseEncryptionConfiguration</code>.
     * @alias module:model/FirewallPolicyResponseEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        FirewallPolicyResponseEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>FirewallPolicyResponseEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallPolicyResponseEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/FirewallPolicyResponseEncryptionConfiguration} The populated <code>FirewallPolicyResponseEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallPolicyResponseEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallPolicyResponseEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallPolicyResponseEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FirewallPolicyResponseEncryptionConfiguration.RequiredProperties) {
...
FirewallPolicyResponseEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
FirewallPolicyResponseEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
FirewallPolicyResponseEncryptionConfiguration.prototype['Type'] = undefined;
...
export default FirewallPolicyResponseEncryptionConfiguration;
