...
/**
 * The RuleGroupRuleVariables model module.
 * @module model/RuleGroupRuleVariables
 * @version 2020-11-12
 */
class RuleGroupRuleVariables {
    /**
     * Constructs a new <code>RuleGroupRuleVariables</code>.
     * @alias module:model/RuleGroupRuleVariables
     * @implements module:model/RuleVariables
     */
    constructor() { 
        RuleVariables.initialize(this);
        RuleGroupRuleVariables.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupRuleVariables</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupRuleVariables} obj Optional instance to populate.
     * @return {module:model/RuleGroupRuleVariables} The populated <code>RuleGroupRuleVariables</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupRuleVariables();
            RuleVariables.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupRuleVariables</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupRuleVariables</code>.
     */
 ...
 */
RuleGroupRuleVariables.prototype['IPSets'] = undefined;

/**
 * @member {Object} PortSets
 */
RuleGroupRuleVariables.prototype['PortSets'] = undefined;


// Implement RuleVariables interface:
/**
 * @member {Object} IPSets
 */
...
export default RuleGroupRuleVariables;
