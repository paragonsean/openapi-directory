...
/**
 * The UpdateFirewallDescriptionResponse model module.
 * @module model/UpdateFirewallDescriptionResponse
 * @version 2020-11-12
 */
class UpdateFirewallDescriptionResponse {
    /**
     * Constructs a new <code>UpdateFirewallDescriptionResponse</code>.
     * @alias module:model/UpdateFirewallDescriptionResponse
     */
    constructor() { 
        
        UpdateFirewallDescriptionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateFirewallDescriptionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateFirewallDescriptionResponse} obj Optional instance to populate.
     * @return {module:model/UpdateFirewallDescriptionResponse} The populated <code>UpdateFirewallDescriptionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateFirewallDescriptionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateFirewallDescriptionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateFirewallDescriptionResponse</code>.
     */
 ...
 */
UpdateFirewallDescriptionResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
UpdateFirewallDescriptionResponse.prototype['FirewallName'] = undefined;

/**
 * @member {String} Description
 */
UpdateFirewallDescriptionResponse.prototype['Description'] = undefined;

/**
 * @member {String} UpdateToken
 */
UpdateFirewallDescriptionResponse.prototype['UpdateToken'] = undefined;
...
export default UpdateFirewallDescriptionResponse;
