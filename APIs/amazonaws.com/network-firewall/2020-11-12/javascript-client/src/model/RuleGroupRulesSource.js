...
import RulesSourceRulesSourceList from './RulesSourceRulesSourceList';
import RulesSourceStatelessRulesAndCustomActions from './RulesSourceStatelessRulesAndCustomActions';

/**
 * The RuleGroupRulesSource model module.
 * @module model/RuleGroupRulesSource
 * @version 2020-11-12
 */
class RuleGroupRulesSource {
    /**
     * Constructs a new <code>RuleGroupRulesSource</code>.
     * @alias module:model/RuleGroupRulesSource
     * @implements module:model/RulesSource
     */
    constructor() { 
        RulesSource.initialize(this);
        RuleGroupRulesSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RuleGroupRulesSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupRulesSource} obj Optional instance to populate.
     * @return {module:model/RuleGroupRulesSource} The populated <code>RuleGroupRulesSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupRulesSource();
            RulesSource.constructFromObject(data, obj);

            if (data.hasOwnProperty('RulesString')) {
                obj['RulesString'] = ApiClient.convertToType(data['RulesString'], 'String');
            }
            if (data.hasOwnProperty('RulesSourceList')) {
                obj['RulesSourceList'] = RulesSourceRulesSourceList.constructFromObject(data['RulesSourceList']);
            }
            if (data.hasOwnProperty('StatefulRules')) {
                obj['StatefulRules'] = ApiClient.convertToType(data['StatefulRules'], Array);
            }
            if (data.hasOwnProperty('StatelessRulesAndCustomActions')) {
                obj['StatelessRulesAndCustomActions'] = RulesSourceStatelessRulesAndCustomActions.constructFromObject(data['StatelessRulesAndCustomActions']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupRulesSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupRulesSource</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RulesString`
        if (data['RulesString']) { // data not null
          String.validateJSON(data['RulesString']);
        }
        // validate the optional field `RulesSourceList`
        if (data['RulesSourceList']) { // data not null
          RulesSourceRulesSourceList.validateJSON(data['RulesSourceList']);
        }
        // validate the optional field `StatefulRules`
        if (data['StatefulRules']) { // data not null
          Array.validateJSON(data['StatefulRules']);
        }
        // validate the optional field `StatelessRulesAndCustomActions`
        if (data['StatelessRulesAndCustomActions']) { // data not null
          RulesSourceStatelessRulesAndCustomActions.validateJSON(data['StatelessRulesAndCustomActions']);
        }
...
/**
 * @member {String} RulesString
 */
RuleGroupRulesSource.prototype['RulesString'] = undefined;

/**
 * @member {module:model/RulesSourceRulesSourceList} RulesSourceList
 */
RuleGroupRulesSource.prototype['RulesSourceList'] = undefined;

/**
 * @member {Array} StatefulRules
 */
RuleGroupRulesSource.prototype['StatefulRules'] = undefined;

/**
 * @member {module:model/RulesSourceStatelessRulesAndCustomActions} StatelessRulesAndCustomActions
 */
RuleGroupRulesSource.prototype['StatelessRulesAndCustomActions'] = undefined;


// Implement RulesSource interface:
/**
 * @member {String} RulesString
 */
RulesSource.prototype['RulesString'] = undefined;
/**
 * @member {module:model/RulesSourceRulesSourceList} RulesSourceList
 */
RulesSource.prototype['RulesSourceList'] = undefined;
/**
 * @member {Array} StatefulRules
 */
RulesSource.prototype['StatefulRules'] = undefined;
/**
 * @member {module:model/RulesSourceStatelessRulesAndCustomActions} StatelessRulesAndCustomActions
 */
RulesSource.prototype['StatelessRulesAndCustomActions'] = undefined;




export default RuleGroupRulesSource;
