...
/**
 * The IPSetMetadata model module.
 * @module model/IPSetMetadata
 * @version 2020-11-12
 */
class IPSetMetadata {
    /**
     * Constructs a new <code>IPSetMetadata</code>.
     * General information about the IP set.
     * @alias module:model/IPSetMetadata
     */
    constructor() { 
        
        IPSetMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IPSetMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IPSetMetadata} obj Optional instance to populate.
     * @return {module:model/IPSetMetadata} The populated <code>IPSetMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IPSetMetadata();

            if (data.hasOwnProperty('ResolvedCIDRCount')) {
                obj['ResolvedCIDRCount'] = ApiClient.convertToType(data['ResolvedCIDRCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IPSetMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IPSetMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ResolvedCIDRCount`
        if (data['ResolvedCIDRCount']) { // data not null
          Number.validateJSON(data['ResolvedCIDRCount']);
        }
...
/**
 * @member {Number} ResolvedCIDRCount
 */
IPSetMetadata.prototype['ResolvedCIDRCount'] = undefined;
