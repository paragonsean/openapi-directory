...
/**
 * The AssociateFirewallPolicyResponse model module.
 * @module model/AssociateFirewallPolicyResponse
 * @version 2020-11-12
 */
class AssociateFirewallPolicyResponse {
    /**
     * Constructs a new <code>AssociateFirewallPolicyResponse</code>.
     * @alias module:model/AssociateFirewallPolicyResponse
     */
    constructor() { 
        
        AssociateFirewallPolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateFirewallPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateFirewallPolicyResponse} obj Optional instance to populate.
     * @return {module:model/AssociateFirewallPolicyResponse} The populated <code>AssociateFirewallPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateFirewallPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateFirewallPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateFirewallPolicyResponse</code>.
     */
 ...
 */
AssociateFirewallPolicyResponse.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
AssociateFirewallPolicyResponse.prototype['FirewallName'] = undefined;

/**
 * @member {String} FirewallPolicyArn
 */
AssociateFirewallPolicyResponse.prototype['FirewallPolicyArn'] = undefined;

/**
 * @member {String} UpdateToken
 */
AssociateFirewallPolicyResponse.prototype['UpdateToken'] = undefined;
...
export default AssociateFirewallPolicyResponse;
