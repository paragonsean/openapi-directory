...
import StatefulRuleGroupReferenceOverride from './StatefulRuleGroupReferenceOverride';

/**
 * The StatefulRuleGroupReference model module.
 * @module model/StatefulRuleGroupReference
 * @version 2020-11-12
 */
class StatefulRuleGroupReference {
    /**
     * Constructs a new <code>StatefulRuleGroupReference</code>.
     * Identifier for a single stateful rule group, used in a firewall policy to refer to a rule group. 
     * @alias module:model/StatefulRuleGroupReference
     * @param resourceArn {String} 
     */
    constructor(resourceArn) { 
        
        StatefulRuleGroupReference.initialize(this, resourceArn);
    }
    ...
    /**
     * Constructs a <code>StatefulRuleGroupReference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatefulRuleGroupReference} obj Optional instance to populate.
     * @return {module:model/StatefulRuleGroupReference} The populated <code>StatefulRuleGroupReference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatefulRuleGroupReference();
            ...
            if (data.hasOwnProperty('Override')) {
                obj['Override'] = StatefulRuleGroupReferenceOverride.constructFromObject(data['Override']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatefulRuleGroupReference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatefulRuleGroupReference</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatefulRuleGroupReference.RequiredProperties) {
        ...
        if (data['Override']) { // data not null
          StatefulRuleGroupReferenceOverride.validateJSON(data['Override']);
        }
...
StatefulRuleGroupReference.RequiredProperties = ["ResourceArn"];

/**
 * @member {String} ResourceArn
 */
StatefulRuleGroupReference.prototype['ResourceArn'] = undefined;

/**
 * @member {Number} Priority
 */
StatefulRuleGroupReference.prototype['Priority'] = undefined;

/**
 * @member {module:model/StatefulRuleGroupReferenceOverride} Override
 */
StatefulRuleGroupReference.prototype['Override'] = undefined;
...
export default StatefulRuleGroupReference;
