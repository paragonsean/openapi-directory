...
/**
 * The CIDRSummary model module.
 * @module model/CIDRSummary
 * @version 2020-11-12
 */
class CIDRSummary {
    /**
     * Constructs a new <code>CIDRSummary</code>.
     ...
     * @alias module:model/CIDRSummary
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CIDRSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CIDRSummary} obj Optional instance to populate.
     * @return {module:model/CIDRSummary} The populated <code>CIDRSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CIDRSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>CIDRSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CIDRSummary</code>.
     */
