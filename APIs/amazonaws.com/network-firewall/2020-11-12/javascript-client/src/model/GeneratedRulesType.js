...
* @readonly
*/
export default class GeneratedRulesType {
    ...
    /**
    * Returns a <code>GeneratedRulesType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GeneratedRulesType} The enum <code>GeneratedRulesType</code> value.
    */
