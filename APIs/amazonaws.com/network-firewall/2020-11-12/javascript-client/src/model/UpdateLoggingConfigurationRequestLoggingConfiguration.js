...
/**
 * The UpdateLoggingConfigurationRequestLoggingConfiguration model module.
 * @module model/UpdateLoggingConfigurationRequestLoggingConfiguration
 * @version 2020-11-12
 */
class UpdateLoggingConfigurationRequestLoggingConfiguration {
    /**
     * Constructs a new <code>UpdateLoggingConfigurationRequestLoggingConfiguration</code>.
     * @alias module:model/UpdateLoggingConfigurationRequestLoggingConfiguration
     * @implements module:model/LoggingConfiguration
     * @param logDestinationConfigs {Array} 
     */
    constructor(logDestinationConfigs) { 
        LoggingConfiguration.initialize(this, logDestinationConfigs);
        UpdateLoggingConfigurationRequestLoggingConfiguration.initialize(this, logDestinationConfigs);
    }
     ...
     */
    static initialize(obj, logDestinationConfigs) { 
        obj['LogDestinationConfigs'] = logDestinationConfigs;
    }

    /**
     * Constructs a <code>UpdateLoggingConfigurationRequestLoggingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateLoggingConfigurationRequestLoggingConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateLoggingConfigurationRequestLoggingConfiguration} The populated <code>UpdateLoggingConfigurationRequestLoggingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateLoggingConfigurationRequestLoggingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateLoggingConfigurationRequestLoggingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateLoggingConfigurationRequestLoggingConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateLoggingConfigurationRequestLoggingConfiguration.RequiredProperties) {
...
UpdateLoggingConfigurationRequestLoggingConfiguration.RequiredProperties = ["LogDestinationConfigs"];

/**
 * @member {Array} LogDestinationConfigs
 */
UpdateLoggingConfigurationRequestLoggingConfiguration.prototype['LogDestinationConfigs'] = undefined;
...
export default UpdateLoggingConfigurationRequestLoggingConfiguration;
