...
/**
 * The RuleOption model module.
 * @module model/RuleOption
 * @version 2020-11-12
 */
class RuleOption {
    /**
     * Constructs a new <code>RuleOption</code>.
     * Additional settings for a stateful rule. This is part of the &lt;a&gt;StatefulRule&lt;/a&gt; configuration.
     * @alias module:model/RuleOption
     * @param keyword {String} 
     */
    constructor(keyword) { 
        
        RuleOption.initialize(this, keyword);
    }
    ...
    /**
     * Constructs a <code>RuleOption</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleOption} obj Optional instance to populate.
     * @return {module:model/RuleOption} The populated <code>RuleOption</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleOption();
    ...
    /**
     * Validates the JSON data with respect to <code>RuleOption</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleOption</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RuleOption.RequiredProperties) {
...
RuleOption.RequiredProperties = ["Keyword"];

/**
 * @member {String} Keyword
 */
RuleOption.prototype['Keyword'] = undefined;

/**
 * @member {Array} Settings
 */
RuleOption.prototype['Settings'] = undefined;
