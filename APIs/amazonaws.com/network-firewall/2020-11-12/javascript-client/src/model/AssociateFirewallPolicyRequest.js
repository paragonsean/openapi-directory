...
/**
 * The AssociateFirewallPolicyRequest model module.
 * @module model/AssociateFirewallPolicyRequest
 * @version 2020-11-12
 */
class AssociateFirewallPolicyRequest {
    /**
     * Constructs a new <code>AssociateFirewallPolicyRequest</code>.
     * @alias module:model/AssociateFirewallPolicyRequest
     * @param firewallPolicyArn {String} 
     */
    constructor(firewallPolicyArn) { 
        
        AssociateFirewallPolicyRequest.initialize(this, firewallPolicyArn);
    }
     ...
     */
    static initialize(obj, firewallPolicyArn) { 
        obj['FirewallPolicyArn'] = firewallPolicyArn;
    }

    /**
     * Constructs a <code>AssociateFirewallPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateFirewallPolicyRequest} obj Optional instance to populate.
     * @return {module:model/AssociateFirewallPolicyRequest} The populated <code>AssociateFirewallPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateFirewallPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateFirewallPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateFirewallPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssociateFirewallPolicyRequest.RequiredProperties) {
...
AssociateFirewallPolicyRequest.RequiredProperties = ["FirewallPolicyArn"];

/**
 * @member {String} UpdateToken
 */
AssociateFirewallPolicyRequest.prototype['UpdateToken'] = undefined;

/**
 * @member {String} FirewallArn
 */
AssociateFirewallPolicyRequest.prototype['FirewallArn'] = undefined;

/**
 * @member {String} FirewallName
 */
AssociateFirewallPolicyRequest.prototype['FirewallName'] = undefined;

/**
 * @member {String} FirewallPolicyArn
 */
AssociateFirewallPolicyRequest.prototype['FirewallPolicyArn'] = undefined;
...
export default AssociateFirewallPolicyRequest;
