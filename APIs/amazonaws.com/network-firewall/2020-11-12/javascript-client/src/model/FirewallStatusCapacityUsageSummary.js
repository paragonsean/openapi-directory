...
import CapacityUsageSummaryCIDRs from './CapacityUsageSummaryCIDRs';

/**
 * The FirewallStatusCapacityUsageSummary model module.
 * @module model/FirewallStatusCapacityUsageSummary
 * @version 2020-11-12
 */
class FirewallStatusCapacityUsageSummary {
    /**
     * Constructs a new <code>FirewallStatusCapacityUsageSummary</code>.
     * @alias module:model/FirewallStatusCapacityUsageSummary
     * @implements module:model/CapacityUsageSummary
     */
    constructor() { 
        CapacityUsageSummary.initialize(this);
        FirewallStatusCapacityUsageSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FirewallStatusCapacityUsageSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FirewallStatusCapacityUsageSummary} obj Optional instance to populate.
     * @return {module:model/FirewallStatusCapacityUsageSummary} The populated <code>FirewallStatusCapacityUsageSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FirewallStatusCapacityUsageSummary();
            CapacityUsageSummary.constructFromObject(data, obj);

            if (data.hasOwnProperty('CIDRs')) {
                obj['CIDRs'] = CapacityUsageSummaryCIDRs.constructFromObject(data['CIDRs']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FirewallStatusCapacityUsageSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FirewallStatusCapacityUsageSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CIDRs`
        if (data['CIDRs']) { // data not null
          CapacityUsageSummaryCIDRs.validateJSON(data['CIDRs']);
        }
...
/**
 * @member {module:model/CapacityUsageSummaryCIDRs} CIDRs
 */
FirewallStatusCapacityUsageSummary.prototype['CIDRs'] = undefined;


// Implement CapacityUsageSummary interface:
/**
 * @member {module:model/CapacityUsageSummaryCIDRs} CIDRs
 */
CapacityUsageSummary.prototype['CIDRs'] = undefined;




export default FirewallStatusCapacityUsageSummary;
