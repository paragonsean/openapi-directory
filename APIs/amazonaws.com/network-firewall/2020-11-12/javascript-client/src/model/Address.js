...
class Address {
     ...
     * @param addressDefinition {String} 
     */
    constructor(addressDefinition) { 
        
        Address.initialize(this, addressDefinition);
    }
     ...
     */
    static initialize(obj, addressDefinition) { 
        obj['AddressDefinition'] = addressDefinition;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AddressDefinition')) {
                obj['AddressDefinition'] = ApiClient.convertToType(data['AddressDefinition'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['AddressDefinition']) { // data not null
          String.validateJSON(data['AddressDefinition']);
        }
...
Address.RequiredProperties = ["AddressDefinition"];

/**
 * @member {String} AddressDefinition
 */
Address.prototype['AddressDefinition'] = undefined;
