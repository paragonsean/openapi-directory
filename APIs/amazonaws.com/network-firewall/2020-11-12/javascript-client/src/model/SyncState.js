...
import SyncStateAttachment from './SyncStateAttachment';

/**
 * The SyncState model module.
 * @module model/SyncState
 * @version 2020-11-12
 */
class SyncState {
    /**
     * Constructs a new <code>SyncState</code>.
     ...
     * @alias module:model/SyncState
     */
    constructor() { 
        
        SyncState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyncState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncState} obj Optional instance to populate.
     * @return {module:model/SyncState} The populated <code>SyncState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncState();

            if (data.hasOwnProperty('Attachment')) {
                obj['Attachment'] = SyncStateAttachment.constructFromObject(data['Attachment']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SyncState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncState</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Attachment`
        if (data['Attachment']) { // data not null
          SyncStateAttachment.validateJSON(data['Attachment']);
        }
...
/**
 * @member {module:model/SyncStateAttachment} Attachment
 */
SyncState.prototype['Attachment'] = undefined;

/**
 * @member {Object} Config
 */
SyncState.prototype['Config'] = undefined;
