...
/**
 * The TLSInspectionConfigurationMetadata model module.
 * @module model/TLSInspectionConfigurationMetadata
 * @version 2020-11-12
 */
class TLSInspectionConfigurationMetadata {
    /**
     * Constructs a new <code>TLSInspectionConfigurationMetadata</code>.
     ...
     * @alias module:model/TLSInspectionConfigurationMetadata
     */
    constructor() { 
        
        TLSInspectionConfigurationMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TLSInspectionConfigurationMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TLSInspectionConfigurationMetadata} obj Optional instance to populate.
     * @return {module:model/TLSInspectionConfigurationMetadata} The populated <code>TLSInspectionConfigurationMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TLSInspectionConfigurationMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>TLSInspectionConfigurationMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TLSInspectionConfigurationMetadata</code>.
     */
 ...
 * @member {String} Name
 */
TLSInspectionConfigurationMetadata.prototype['Name'] = undefined;

/**
 * @member {String} Arn
 */
TLSInspectionConfigurationMetadata.prototype['Arn'] = undefined;
...
export default TLSInspectionConfigurationMetadata;
