...
/**
 * The TCPFlagField model module.
 * @module model/TCPFlagField
 * @version 2020-11-12
 */
class TCPFlagField {
    /**
     * Constructs a new <code>TCPFlagField</code>.
     * TCP flags and masks to inspect packets for, used in stateless rules &lt;a&gt;MatchAttributes&lt;/a&gt; settings.
     * @alias module:model/TCPFlagField
     * @param flags {Array} 
     */
    constructor(flags) { 
        
        TCPFlagField.initialize(this, flags);
    }
    ...
    /**
     * Constructs a <code>TCPFlagField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TCPFlagField} obj Optional instance to populate.
     * @return {module:model/TCPFlagField} The populated <code>TCPFlagField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TCPFlagField();

            if (data.hasOwnProperty('Flags')) {
                obj['Flags'] = ApiClient.convertToType(data['Flags'], Array);
            }
            if (data.hasOwnProperty('Masks')) {
                obj['Masks'] = ApiClient.convertToType(data['Masks'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TCPFlagField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TCPFlagField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TCPFlagField.RequiredProperties) {
        ...
        if (data['Flags']) { // data not null
          Array.validateJSON(data['Flags']);
        }
        // validate the optional field `Masks`
        if (data['Masks']) { // data not null
          Array.validateJSON(data['Masks']);
        }
...
TCPFlagField.RequiredProperties = ["Flags"];

/**
 * @member {Array} Flags
 */
TCPFlagField.prototype['Flags'] = undefined;

/**
 * @member {Array} Masks
 */
TCPFlagField.prototype['Masks'] = undefined;
