...
/**
 * The DeleteTLSInspectionConfigurationResponse model module.
 * @module model/DeleteTLSInspectionConfigurationResponse
 * @version 2020-11-12
 */
class DeleteTLSInspectionConfigurationResponse {
    /**
     * Constructs a new <code>DeleteTLSInspectionConfigurationResponse</code>.
     * @alias module:model/DeleteTLSInspectionConfigurationResponse
     ...
     */
    constructor(tLSInspectionConfigurationResponse) { 
        
        DeleteTLSInspectionConfigurationResponse.initialize(this, tLSInspectionConfigurationResponse);
    }
     ...
     */
    static initialize(obj, tLSInspectionConfigurationResponse) { 
        obj['TLSInspectionConfigurationResponse'] = tLSInspectionConfigurationResponse;
    }

    /**
     * Constructs a <code>DeleteTLSInspectionConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteTLSInspectionConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/DeleteTLSInspectionConfigurationResponse} The populated <code>DeleteTLSInspectionConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteTLSInspectionConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteTLSInspectionConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteTLSInspectionConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteTLSInspectionConfigurationResponse.RequiredProperties) {
...
DeleteTLSInspectionConfigurationResponse.RequiredProperties = ["TLSInspectionConfigurationResponse"];
 ...
 */
DeleteTLSInspectionConfigurationResponse.prototype['TLSInspectionConfigurationResponse'] = undefined;
...
export default DeleteTLSInspectionConfigurationResponse;
