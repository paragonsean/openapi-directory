...
/**
 * The CreateRuleGroupRequestSourceMetadata model module.
 * @module model/CreateRuleGroupRequestSourceMetadata
 * @version 2020-11-12
 */
class CreateRuleGroupRequestSourceMetadata {
    /**
     * Constructs a new <code>CreateRuleGroupRequestSourceMetadata</code>.
     * @alias module:model/CreateRuleGroupRequestSourceMetadata
     * @implements module:model/SourceMetadata
     */
    constructor() { 
        SourceMetadata.initialize(this);
        CreateRuleGroupRequestSourceMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRuleGroupRequestSourceMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRuleGroupRequestSourceMetadata} obj Optional instance to populate.
     * @return {module:model/CreateRuleGroupRequestSourceMetadata} The populated <code>CreateRuleGroupRequestSourceMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRuleGroupRequestSourceMetadata();
            SourceMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRuleGroupRequestSourceMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRuleGroupRequestSourceMetadata</code>.
     */
 ...
 */
CreateRuleGroupRequestSourceMetadata.prototype['SourceArn'] = undefined;

/**
 * @member {String} SourceUpdateToken
 */
CreateRuleGroupRequestSourceMetadata.prototype['SourceUpdateToken'] = undefined;


// Implement SourceMetadata interface:
/**
 * @member {String} SourceArn
 */
...
export default CreateRuleGroupRequestSourceMetadata;
