...
/**
 * The RuleGroupResponseEncryptionConfiguration model module.
 * @module model/RuleGroupResponseEncryptionConfiguration
 * @version 2020-11-12
 */
class RuleGroupResponseEncryptionConfiguration {
    /**
     * Constructs a new <code>RuleGroupResponseEncryptionConfiguration</code>.
     * @alias module:model/RuleGroupResponseEncryptionConfiguration
    ...
    constructor(type) { 
        ...
        RuleGroupResponseEncryptionConfiguration.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>RuleGroupResponseEncryptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RuleGroupResponseEncryptionConfiguration} obj Optional instance to populate.
     * @return {module:model/RuleGroupResponseEncryptionConfiguration} The populated <code>RuleGroupResponseEncryptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleGroupResponseEncryptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RuleGroupResponseEncryptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleGroupResponseEncryptionConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RuleGroupResponseEncryptionConfiguration.RequiredProperties) {
...
RuleGroupResponseEncryptionConfiguration.RequiredProperties = ["Type"];

/**
 * @member {String} KeyId
 */
RuleGroupResponseEncryptionConfiguration.prototype['KeyId'] = undefined;

/**
 * @member {module:model/EncryptionType} Type
 */
RuleGroupResponseEncryptionConfiguration.prototype['Type'] = undefined;
...
export default RuleGroupResponseEncryptionConfiguration;
