...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
  });
  ...
  describe('DeleteFirewallPolicyResponseFirewallPolicyResponse', function() {
    it('should create an instance of DeleteFirewallPolicyResponseFirewallPolicyResponse', function() {
      // uncomment below and update the code to test DeleteFirewallPolicyResponseFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse);
    });
    ...
    it('should have the property firewallPolicyId (base name: "FirewallPolicyId")', function() {
      // uncomment below and update the code to test the property firewallPolicyId
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property firewallPolicyStatus (base name: "FirewallPolicyStatus")', function() {
      // uncomment below and update the code to test the property firewallPolicyStatus
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property consumedStatelessRuleCapacity (base name: "ConsumedStatelessRuleCapacity")', function() {
      // uncomment below and update the code to test the property consumedStatelessRuleCapacity
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be();
    });

    it('should have the property consumedStatefulRuleCapacity (base name: "ConsumedStatefulRuleCapacity")', function() {
      // uncomment below and update the code to test the property consumedStatefulRuleCapacity
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be();
    });
