...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallPolicyResponseFirewallPolicyResponse();
  });
  ...
  describe('CreateFirewallPolicyResponseFirewallPolicyResponse', function() {
    it('should create an instance of CreateFirewallPolicyResponseFirewallPolicyResponse', function() {
      // uncomment below and update the code to test CreateFirewallPolicyResponseFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyResponseFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallPolicyResponseFirewallPolicyResponse);
    });
