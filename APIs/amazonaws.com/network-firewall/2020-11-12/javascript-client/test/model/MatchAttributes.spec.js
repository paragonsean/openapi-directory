...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.MatchAttributes();
  });
  ...
  describe('MatchAttributes', function() {
    it('should create an instance of MatchAttributes', function() {
      // uncomment below and update the code to test MatchAttributes
      //var instance = new AwsNetworkFirewall.MatchAttributes();
      //expect(instance).to.be.a(AwsNetworkFirewall.MatchAttributes);
    });
