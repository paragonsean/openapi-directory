...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.SyncStateAttachment();
  });
  ...
  describe('SyncStateAttachment', function() {
    it('should create an instance of SyncStateAttachment', function() {
      // uncomment below and update the code to test SyncStateAttachment
      //var instance = new AwsNetworkFirewall.SyncStateAttachment();
      //expect(instance).to.be.a(AwsNetworkFirewall.SyncStateAttachment);
    });
