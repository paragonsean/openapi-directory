...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RulesSourceList();
  });
  ...
  describe('RulesSourceList', function() {
    it('should create an instance of RulesSourceList', function() {
      // uncomment below and update the code to test RulesSourceList
      //var instance = new AwsNetworkFirewall.RulesSourceList();
      //expect(instance).to.be.a(AwsNetworkFirewall.RulesSourceList);
    });
