...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRuleGroupReferenceOverride();
  });
  ...
  describe('StatefulRuleGroupReferenceOverride', function() {
    it('should create an instance of StatefulRuleGroupReferenceOverride', function() {
      // uncomment below and update the code to test StatefulRuleGroupReferenceOverride
      //var instance = new AwsNetworkFirewall.StatefulRuleGroupReferenceOverride();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleGroupReferenceOverride);
    });
