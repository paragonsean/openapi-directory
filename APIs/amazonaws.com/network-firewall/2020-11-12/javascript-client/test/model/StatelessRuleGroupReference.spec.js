...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatelessRuleGroupReference();
  });
  ...
  describe('StatelessRuleGroupReference', function() {
    it('should create an instance of StatelessRuleGroupReference', function() {
      // uncomment below and update the code to test StatelessRuleGroupReference
      //var instance = new AwsNetworkFirewall.StatelessRuleGroupReference();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatelessRuleGroupReference);
    });
