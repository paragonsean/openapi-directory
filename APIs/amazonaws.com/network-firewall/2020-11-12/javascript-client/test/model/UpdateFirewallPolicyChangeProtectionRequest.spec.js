...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionRequest();
  });
  ...
  describe('UpdateFirewallPolicyChangeProtectionRequest', function() {
    it('should create an instance of UpdateFirewallPolicyChangeProtectionRequest', function() {
      // uncomment below and update the code to test UpdateFirewallPolicyChangeProtectionRequest
      //var instance = new AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionRequest);
    });
