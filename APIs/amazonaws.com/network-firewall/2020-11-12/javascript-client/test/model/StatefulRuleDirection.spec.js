...
(function(root, factory) {
  ...
  describe('StatefulRuleDirection', function() {
    it('should create an instance of StatefulRuleDirection', function() {
      // uncomment below and update the code to test StatefulRuleDirection
      //var instance = new AwsNetworkFirewall.StatefulRuleDirection();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleDirection);
    });
