...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ActionDefinitionPublishMetricAction();
  });
  ...
  describe('ActionDefinitionPublishMetricAction', function() {
    it('should create an instance of ActionDefinitionPublishMetricAction', function() {
      // uncomment below and update the code to test ActionDefinitionPublishMetricAction
      //var instance = new AwsNetworkFirewall.ActionDefinitionPublishMetricAction();
      //expect(instance).to.be.a(AwsNetworkFirewall.ActionDefinitionPublishMetricAction);
    });
