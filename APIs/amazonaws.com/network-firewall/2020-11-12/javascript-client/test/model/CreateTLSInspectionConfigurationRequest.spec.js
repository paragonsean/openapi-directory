...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationRequest();
  });
  ...
  describe('CreateTLSInspectionConfigurationRequest', function() {
    it('should create an instance of CreateTLSInspectionConfigurationRequest', function() {
      // uncomment below and update the code to test CreateTLSInspectionConfigurationRequest
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateTLSInspectionConfigurationRequest);
    });
