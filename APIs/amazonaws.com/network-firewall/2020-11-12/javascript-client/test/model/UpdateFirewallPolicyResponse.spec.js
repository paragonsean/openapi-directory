...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallPolicyResponse();
  });
  ...
  describe('UpdateFirewallPolicyResponse', function() {
    it('should create an instance of UpdateFirewallPolicyResponse', function() {
      // uncomment below and update the code to test UpdateFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.UpdateFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallPolicyResponse);
    });
