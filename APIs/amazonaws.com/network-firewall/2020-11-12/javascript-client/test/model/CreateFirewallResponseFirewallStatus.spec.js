...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallResponseFirewallStatus();
  });
  ...
  describe('CreateFirewallResponseFirewallStatus', function() {
    it('should create an instance of CreateFirewallResponseFirewallStatus', function() {
      // uncomment below and update the code to test CreateFirewallResponseFirewallStatus
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewallStatus();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallResponseFirewallStatus);
    });
    ...
    it('should have the property configurationSyncStateSummary (base name: "ConfigurationSyncStateSummary")', function() {
      // uncomment below and update the code to test the property configurationSyncStateSummary
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewallStatus();
      //expect(instance).to.be();
    });

    it('should have the property syncStates (base name: "SyncStates")', function() {
      // uncomment below and update the code to test the property syncStates
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewallStatus();
      //expect(instance).to.be();
    });

    it('should have the property capacityUsageSummary (base name: "CapacityUsageSummary")', function() {
      // uncomment below and update the code to test the property capacityUsageSummary
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewallStatus();
      //expect(instance).to.be();
    });
