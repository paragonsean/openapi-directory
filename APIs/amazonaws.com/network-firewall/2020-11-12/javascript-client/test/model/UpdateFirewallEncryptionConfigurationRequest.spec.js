...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationRequest();
  });
  ...
  describe('UpdateFirewallEncryptionConfigurationRequest', function() {
    it('should create an instance of UpdateFirewallEncryptionConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateFirewallEncryptionConfigurationRequest
      //var instance = new AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationRequest);
    });
