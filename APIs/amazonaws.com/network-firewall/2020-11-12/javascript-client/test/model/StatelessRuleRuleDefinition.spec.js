...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatelessRuleRuleDefinition();
  });
  ...
  describe('StatelessRuleRuleDefinition', function() {
    it('should create an instance of StatelessRuleRuleDefinition', function() {
      // uncomment below and update the code to test StatelessRuleRuleDefinition
      //var instance = new AwsNetworkFirewall.StatelessRuleRuleDefinition();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatelessRuleRuleDefinition);
    });

    it('should have the property matchAttributes (base name: "MatchAttributes")', function() {
      // uncomment below and update the code to test the property matchAttributes
      //var instance = new AwsNetworkFirewall.StatelessRuleRuleDefinition();
