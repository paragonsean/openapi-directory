...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatelessRulesAndCustomActions();
  });
  ...
  describe('StatelessRulesAndCustomActions', function() {
    it('should create an instance of StatelessRulesAndCustomActions', function() {
      // uncomment below and update the code to test StatelessRulesAndCustomActions
      //var instance = new AwsNetworkFirewall.StatelessRulesAndCustomActions();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatelessRulesAndCustomActions);
    });
