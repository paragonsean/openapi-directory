...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupResponse();
  });
  ...
  describe('RuleGroupResponse', function() {
    it('should create an instance of RuleGroupResponse', function() {
      // uncomment below and update the code to test RuleGroupResponse
      //var instance = new AwsNetworkFirewall.RuleGroupResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupResponse);
    });
