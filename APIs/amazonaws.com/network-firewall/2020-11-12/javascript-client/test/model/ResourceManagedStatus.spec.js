...
(function(root, factory) {
  ...
  describe('ResourceManagedStatus', function() {
    it('should create an instance of ResourceManagedStatus', function() {
      // uncomment below and update the code to test ResourceManagedStatus
      //var instance = new AwsNetworkFirewall.ResourceManagedStatus();
      //expect(instance).to.be.a(AwsNetworkFirewall.ResourceManagedStatus);
    });
