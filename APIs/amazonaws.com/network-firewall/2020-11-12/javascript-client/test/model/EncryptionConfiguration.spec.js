...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.EncryptionConfiguration();
  });
  ...
  describe('EncryptionConfiguration', function() {
    it('should create an instance of EncryptionConfiguration', function() {
      ...
      //var instance = new AwsNetworkFirewall.EncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.EncryptionConfiguration);
    });
