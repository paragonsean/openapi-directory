...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponse();
  });
  ...
  describe('DeleteFirewallPolicyResponse', function() {
    it('should create an instance of DeleteFirewallPolicyResponse', function() {
      // uncomment below and update the code to test DeleteFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteFirewallPolicyResponse);
    });
