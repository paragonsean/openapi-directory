...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListTLSInspectionConfigurationsRequest();
  });
  ...
  describe('ListTLSInspectionConfigurationsRequest', function() {
    it('should create an instance of ListTLSInspectionConfigurationsRequest', function() {
      // uncomment below and update the code to test ListTLSInspectionConfigurationsRequest
      //var instance = new AwsNetworkFirewall.ListTLSInspectionConfigurationsRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListTLSInspectionConfigurationsRequest);
    });
