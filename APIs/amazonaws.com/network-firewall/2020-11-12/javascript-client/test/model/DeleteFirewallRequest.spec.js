...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteFirewallRequest();
  });
  ...
  describe('DeleteFirewallRequest', function() {
    it('should create an instance of DeleteFirewallRequest', function() {
      // uncomment below and update the code to test DeleteFirewallRequest
      //var instance = new AwsNetworkFirewall.DeleteFirewallRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteFirewallRequest);
    });
