...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TLSInspectionConfiguration();
  });
  ...
  describe('TLSInspectionConfiguration', function() {
    it('should create an instance of TLSInspectionConfiguration', function() {
      // uncomment below and update the code to test TLSInspectionConfiguration
      //var instance = new AwsNetworkFirewall.TLSInspectionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.TLSInspectionConfiguration);
    });
