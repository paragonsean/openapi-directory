...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
  });
  ...
  describe('CreateFirewallPolicyRequestFirewallPolicy', function() {
    it('should create an instance of CreateFirewallPolicyRequestFirewallPolicy', function() {
      // uncomment below and update the code to test CreateFirewallPolicyRequestFirewallPolicy
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy);
    });

    it('should have the property statelessRuleGroupReferences (base name: "StatelessRuleGroupReferences")', function() {
      // uncomment below and update the code to test the property statelessRuleGroupReferences
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statelessDefaultActions (base name: "StatelessDefaultActions")', function() {
      // uncomment below and update the code to test the property statelessDefaultActions
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statelessFragmentDefaultActions (base name: "StatelessFragmentDefaultActions")', function() {
      // uncomment below and update the code to test the property statelessFragmentDefaultActions
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statelessCustomActions (base name: "StatelessCustomActions")', function() {
      // uncomment below and update the code to test the property statelessCustomActions
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statefulRuleGroupReferences (base name: "StatefulRuleGroupReferences")', function() {
      // uncomment below and update the code to test the property statefulRuleGroupReferences
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statefulDefaultActions (base name: "StatefulDefaultActions")', function() {
      // uncomment below and update the code to test the property statefulDefaultActions
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property statefulEngineOptions (base name: "StatefulEngineOptions")', function() {
      // uncomment below and update the code to test the property statefulEngineOptions
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property tLSInspectionConfigurationArn (base name: "TLSInspectionConfigurationArn")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurationArn
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });

    it('should have the property policyVariables (base name: "PolicyVariables")', function() {
      // uncomment below and update the code to test the property policyVariables
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestFirewallPolicy();
      //expect(instance).to.be();
    });
