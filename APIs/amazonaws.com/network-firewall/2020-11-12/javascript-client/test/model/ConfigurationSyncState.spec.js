...
(function(root, factory) {
  ...
  describe('ConfigurationSyncState', function() {
    it('should create an instance of ConfigurationSyncState', function() {
      // uncomment below and update the code to test ConfigurationSyncState
      //var instance = new AwsNetworkFirewall.ConfigurationSyncState();
      //expect(instance).to.be.a(AwsNetworkFirewall.ConfigurationSyncState);
    });
