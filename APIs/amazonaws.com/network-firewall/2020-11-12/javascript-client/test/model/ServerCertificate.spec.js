...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ServerCertificate();
  });
  ...
  describe('ServerCertificate', function() {
    it('should create an instance of ServerCertificate', function() {
      // uncomment below and update the code to test ServerCertificate
      //var instance = new AwsNetworkFirewall.ServerCertificate();
      //expect(instance).to.be.a(AwsNetworkFirewall.ServerCertificate);
    });
