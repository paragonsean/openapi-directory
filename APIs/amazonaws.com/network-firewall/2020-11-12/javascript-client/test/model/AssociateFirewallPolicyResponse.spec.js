...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.AssociateFirewallPolicyResponse();
  });
  ...
  describe('AssociateFirewallPolicyResponse', function() {
    it('should create an instance of AssociateFirewallPolicyResponse', function() {
      // uncomment below and update the code to test AssociateFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.AssociateFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.AssociateFirewallPolicyResponse);
    });
