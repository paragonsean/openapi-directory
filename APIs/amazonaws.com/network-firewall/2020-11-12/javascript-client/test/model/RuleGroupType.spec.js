...
(function(root, factory) {
  ...
  describe('RuleGroupType', function() {
    it('should create an instance of RuleGroupType', function() {
      // uncomment below and update the code to test RuleGroupType
      //var instance = new AwsNetworkFirewall.RuleGroupType();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupType);
    });
