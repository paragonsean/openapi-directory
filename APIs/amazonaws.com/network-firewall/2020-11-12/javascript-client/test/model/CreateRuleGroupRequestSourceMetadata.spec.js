...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateRuleGroupRequestSourceMetadata();
  });
  ...
  describe('CreateRuleGroupRequestSourceMetadata', function() {
    it('should create an instance of CreateRuleGroupRequestSourceMetadata', function() {
      // uncomment below and update the code to test CreateRuleGroupRequestSourceMetadata
      //var instance = new AwsNetworkFirewall.CreateRuleGroupRequestSourceMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateRuleGroupRequestSourceMetadata);
    });
