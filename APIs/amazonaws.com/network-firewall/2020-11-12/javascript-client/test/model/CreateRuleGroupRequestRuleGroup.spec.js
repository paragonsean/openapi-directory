...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateRuleGroupRequestRuleGroup();
  });
  ...
  describe('CreateRuleGroupRequestRuleGroup', function() {
    it('should create an instance of CreateRuleGroupRequestRuleGroup', function() {
      // uncomment below and update the code to test CreateRuleGroupRequestRuleGroup
      //var instance = new AwsNetworkFirewall.CreateRuleGroupRequestRuleGroup();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateRuleGroupRequestRuleGroup);
    });
