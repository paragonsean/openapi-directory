...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TlsCertificateData();
  });
  ...
  describe('TlsCertificateData', function() {
    it('should create an instance of TlsCertificateData', function() {
      // uncomment below and update the code to test TlsCertificateData
      //var instance = new AwsNetworkFirewall.TlsCertificateData();
      //expect(instance).to.be.a(AwsNetworkFirewall.TlsCertificateData);
    });
