...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.SyncState();
  });
  ...
  describe('SyncState', function() {
    it('should create an instance of SyncState', function() {
      // uncomment below and update the code to test SyncState
      //var instance = new AwsNetworkFirewall.SyncState();
      //expect(instance).to.be.a(AwsNetworkFirewall.SyncState);
    });
