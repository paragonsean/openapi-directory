...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallPolicyPolicyVariables();
  });
  ...
  describe('FirewallPolicyPolicyVariables', function() {
    it('should create an instance of FirewallPolicyPolicyVariables', function() {
      // uncomment below and update the code to test FirewallPolicyPolicyVariables
      //var instance = new AwsNetworkFirewall.FirewallPolicyPolicyVariables();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallPolicyPolicyVariables);
    });
