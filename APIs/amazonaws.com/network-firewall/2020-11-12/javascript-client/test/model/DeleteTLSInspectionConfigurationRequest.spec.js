...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteTLSInspectionConfigurationRequest();
  });
  ...
  describe('DeleteTLSInspectionConfigurationRequest', function() {
    it('should create an instance of DeleteTLSInspectionConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteTLSInspectionConfigurationRequest
      //var instance = new AwsNetworkFirewall.DeleteTLSInspectionConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteTLSInspectionConfigurationRequest);
    });
