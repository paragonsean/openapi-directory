...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RulesSourceStatelessRulesAndCustomActions();
  });
  ...
  describe('RulesSourceStatelessRulesAndCustomActions', function() {
    it('should create an instance of RulesSourceStatelessRulesAndCustomActions', function() {
      // uncomment below and update the code to test RulesSourceStatelessRulesAndCustomActions
      //var instance = new AwsNetworkFirewall.RulesSourceStatelessRulesAndCustomActions();
      //expect(instance).to.be.a(AwsNetworkFirewall.RulesSourceStatelessRulesAndCustomActions);
    });

    it('should have the property statelessRules (base name: "StatelessRules")', function() {
      // uncomment below and update the code to test the property statelessRules
      //var instance = new AwsNetworkFirewall.RulesSourceStatelessRulesAndCustomActions();
