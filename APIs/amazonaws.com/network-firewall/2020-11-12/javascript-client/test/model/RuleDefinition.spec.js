...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleDefinition();
  });
  ...
  describe('RuleDefinition', function() {
    it('should create an instance of RuleDefinition', function() {
      ...
      //var instance = new AwsNetworkFirewall.RuleDefinition();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleDefinition);
    });
