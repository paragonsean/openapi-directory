...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ServerCertificateScope();
  });
  ...
  describe('ServerCertificateScope', function() {
    it('should create an instance of ServerCertificateScope', function() {
      // uncomment below and update the code to test ServerCertificateScope
      //var instance = new AwsNetworkFirewall.ServerCertificateScope();
      //expect(instance).to.be.a(AwsNetworkFirewall.ServerCertificateScope);
    });
