...
(function(root, factory) {
  ...
  describe('GeneratedRulesType', function() {
    it('should create an instance of GeneratedRulesType', function() {
      // uncomment below and update the code to test GeneratedRulesType
      //var instance = new AwsNetworkFirewall.GeneratedRulesType();
      //expect(instance).to.be.a(AwsNetworkFirewall.GeneratedRulesType);
    });
