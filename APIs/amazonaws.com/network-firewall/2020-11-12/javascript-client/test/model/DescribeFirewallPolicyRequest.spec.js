...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeFirewallPolicyRequest();
  });
  ...
  describe('DescribeFirewallPolicyRequest', function() {
    it('should create an instance of DescribeFirewallPolicyRequest', function() {
      // uncomment below and update the code to test DescribeFirewallPolicyRequest
      //var instance = new AwsNetworkFirewall.DescribeFirewallPolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeFirewallPolicyRequest);
    });
