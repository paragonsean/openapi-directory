...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeResourcePolicyRequest();
  });
  ...
  describe('DescribeResourcePolicyRequest', function() {
    it('should create an instance of DescribeResourcePolicyRequest', function() {
      // uncomment below and update the code to test DescribeResourcePolicyRequest
      //var instance = new AwsNetworkFirewall.DescribeResourcePolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeResourcePolicyRequest);
    });
