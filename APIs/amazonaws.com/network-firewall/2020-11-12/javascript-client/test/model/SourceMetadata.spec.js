...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.SourceMetadata();
  });
  ...
  describe('SourceMetadata', function() {
    it('should create an instance of SourceMetadata', function() {
      ...
      //var instance = new AwsNetworkFirewall.SourceMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.SourceMetadata);
    });
    ...
    it('should have the property sourceUpdateToken (base name: "SourceUpdateToken")', function() {
      // uncomment below and update the code to test the property sourceUpdateToken
      //var instance = new AwsNetworkFirewall.SourceMetadata();
      //expect(instance).to.be();
    });
