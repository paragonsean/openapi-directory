...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.LoggingConfiguration();
  });
  ...
  describe('LoggingConfiguration', function() {
    it('should create an instance of LoggingConfiguration', function() {
      ...
      //var instance = new AwsNetworkFirewall.LoggingConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.LoggingConfiguration);
    });
