...
(function(root, factory) {
  ...
  describe('StreamExceptionPolicy', function() {
    it('should create an instance of StreamExceptionPolicy', function() {
      // uncomment below and update the code to test StreamExceptionPolicy
      //var instance = new AwsNetworkFirewall.StreamExceptionPolicy();
      //expect(instance).to.be.a(AwsNetworkFirewall.StreamExceptionPolicy);
    });
