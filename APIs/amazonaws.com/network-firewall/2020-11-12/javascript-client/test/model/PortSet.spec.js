...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.PortSet();
  });
  ...
  describe('PortSet', function() {
    it('should create an instance of PortSet', function() {
      // uncomment below and update the code to test PortSet
      //var instance = new AwsNetworkFirewall.PortSet();
      //expect(instance).to.be.a(AwsNetworkFirewall.PortSet);
    });
