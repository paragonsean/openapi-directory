...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroup();
  });
  ...
  describe('RuleGroup', function() {
    it('should create an instance of RuleGroup', function() {
      // uncomment below and update the code to test RuleGroup
      //var instance = new AwsNetworkFirewall.RuleGroup();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroup);
    });

    it('should have the property ruleVariables (base name: "RuleVariables")', function() {
      // uncomment below and update the code to test the property ruleVariables
      //var instance = new AwsNetworkFirewall.RuleGroup();
      //expect(instance).to.be();
    });

    it('should have the property referenceSets (base name: "ReferenceSets")', function() {
      // uncomment below and update the code to test the property referenceSets
      //var instance = new AwsNetworkFirewall.RuleGroup();
      //expect(instance).to.be();
    });

    it('should have the property rulesSource (base name: "RulesSource")', function() {
      // uncomment below and update the code to test the property rulesSource
      //var instance = new AwsNetworkFirewall.RuleGroup();
      //expect(instance).to.be();
    });
