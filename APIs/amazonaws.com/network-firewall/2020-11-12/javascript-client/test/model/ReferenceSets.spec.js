...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ReferenceSets();
  });
  ...
  describe('ReferenceSets', function() {
    it('should create an instance of ReferenceSets', function() {
      // uncomment below and update the code to test ReferenceSets
      //var instance = new AwsNetworkFirewall.ReferenceSets();
      //expect(instance).to.be.a(AwsNetworkFirewall.ReferenceSets);
    });
