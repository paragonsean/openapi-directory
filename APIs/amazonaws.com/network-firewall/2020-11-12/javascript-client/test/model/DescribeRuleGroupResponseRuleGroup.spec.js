...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeRuleGroupResponseRuleGroup();
  });
  ...
  describe('DescribeRuleGroupResponseRuleGroup', function() {
    it('should create an instance of DescribeRuleGroupResponseRuleGroup', function() {
      // uncomment below and update the code to test DescribeRuleGroupResponseRuleGroup
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupResponseRuleGroup();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeRuleGroupResponseRuleGroup);
    });
