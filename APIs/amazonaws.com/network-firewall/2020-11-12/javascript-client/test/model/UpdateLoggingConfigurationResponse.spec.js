...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateLoggingConfigurationResponse();
  });
  ...
  describe('UpdateLoggingConfigurationResponse', function() {
    it('should create an instance of UpdateLoggingConfigurationResponse', function() {
      ...
      //var instance = new AwsNetworkFirewall.UpdateLoggingConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateLoggingConfigurationResponse);
    });
