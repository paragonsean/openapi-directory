...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListRuleGroupsRequest();
  });
  ...
  describe('ListRuleGroupsRequest', function() {
    it('should create an instance of ListRuleGroupsRequest', function() {
      // uncomment below and update the code to test ListRuleGroupsRequest
      //var instance = new AwsNetworkFirewall.ListRuleGroupsRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListRuleGroupsRequest);
    });
    ...
    it('should have the property managedType (base name: "ManagedType")', function() {
      // uncomment below and update the code to test the property managedType
      //var instance = new AwsNetworkFirewall.ListRuleGroupsRequest();
      //expect(instance).to.be();
    });
