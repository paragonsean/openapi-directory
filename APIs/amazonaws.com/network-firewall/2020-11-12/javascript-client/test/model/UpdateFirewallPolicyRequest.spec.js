...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallPolicyRequest();
  });
  ...
  describe('UpdateFirewallPolicyRequest', function() {
    it('should create an instance of UpdateFirewallPolicyRequest', function() {
      // uncomment below and update the code to test UpdateFirewallPolicyRequest
      //var instance = new AwsNetworkFirewall.UpdateFirewallPolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallPolicyRequest);
    });
