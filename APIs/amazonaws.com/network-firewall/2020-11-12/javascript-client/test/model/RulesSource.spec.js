...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RulesSource();
  });
  ...
  describe('RulesSource', function() {
    it('should create an instance of RulesSource', function() {
      // uncomment below and update the code to test RulesSource
      //var instance = new AwsNetworkFirewall.RulesSource();
      //expect(instance).to.be.a(AwsNetworkFirewall.RulesSource);
    });

    it('should have the property rulesString (base name: "RulesString")', function() {
      // uncomment below and update the code to test the property rulesString
      //var instance = new AwsNetworkFirewall.RulesSource();
      //expect(instance).to.be();
    });

    it('should have the property rulesSourceList (base name: "RulesSourceList")', function() {
      // uncomment below and update the code to test the property rulesSourceList
      //var instance = new AwsNetworkFirewall.RulesSource();
      //expect(instance).to.be();
    });

    it('should have the property statefulRules (base name: "StatefulRules")', function() {
      // uncomment below and update the code to test the property statefulRules
      //var instance = new AwsNetworkFirewall.RulesSource();
      //expect(instance).to.be();
    });

    it('should have the property statelessRulesAndCustomActions (base name: "StatelessRulesAndCustomActions")', function() {
      // uncomment below and update the code to test the property statelessRulesAndCustomActions
      //var instance = new AwsNetworkFirewall.RulesSource();
      //expect(instance).to.be();
    });
