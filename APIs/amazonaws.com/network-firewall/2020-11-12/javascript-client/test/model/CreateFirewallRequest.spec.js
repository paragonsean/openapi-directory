...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallRequest();
  });
  ...
  describe('CreateFirewallRequest', function() {
    it('should create an instance of CreateFirewallRequest', function() {
      // uncomment below and update the code to test CreateFirewallRequest
      //var instance = new AwsNetworkFirewall.CreateFirewallRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallRequest);
    });
