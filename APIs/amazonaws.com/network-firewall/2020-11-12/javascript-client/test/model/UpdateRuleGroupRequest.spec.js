...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateRuleGroupRequest();
  });
  ...
  describe('UpdateRuleGroupRequest', function() {
    it('should create an instance of UpdateRuleGroupRequest', function() {
      // uncomment below and update the code to test UpdateRuleGroupRequest
      //var instance = new AwsNetworkFirewall.UpdateRuleGroupRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateRuleGroupRequest);
    });
