...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteRuleGroupRequest();
  });
  ...
  describe('DeleteRuleGroupRequest', function() {
    it('should create an instance of DeleteRuleGroupRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.DeleteRuleGroupRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteRuleGroupRequest);
    });
