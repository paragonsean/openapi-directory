...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRuleOptions();
  });
  ...
  describe('StatefulRuleOptions', function() {
    it('should create an instance of StatefulRuleOptions', function() {
      // uncomment below and update the code to test StatefulRuleOptions
      //var instance = new AwsNetworkFirewall.StatefulRuleOptions();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleOptions);
    });
