...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatelessRule();
  });
  ...
  describe('StatelessRule', function() {
    it('should create an instance of StatelessRule', function() {
      // uncomment below and update the code to test StatelessRule
      //var instance = new AwsNetworkFirewall.StatelessRule();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatelessRule);
    });

    it('should have the property ruleDefinition (base name: "RuleDefinition")', function() {
      // uncomment below and update the code to test the property ruleDefinition
      //var instance = new AwsNetworkFirewall.StatelessRule();
