...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RulesSourceRulesSourceList();
  });
  ...
  describe('RulesSourceRulesSourceList', function() {
    it('should create an instance of RulesSourceRulesSourceList', function() {
      // uncomment below and update the code to test RulesSourceRulesSourceList
      //var instance = new AwsNetworkFirewall.RulesSourceRulesSourceList();
      //expect(instance).to.be.a(AwsNetworkFirewall.RulesSourceRulesSourceList);
    });
    ...
    it('should have the property generatedRulesType (base name: "GeneratedRulesType")', function() {
      // uncomment below and update the code to test the property generatedRulesType
      //var instance = new AwsNetworkFirewall.RulesSourceRulesSourceList();
      //expect(instance).to.be();
    });
