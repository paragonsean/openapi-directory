...
(function(root, factory) {
  ...
  describe('PerObjectSyncStatus', function() {
    it('should create an instance of PerObjectSyncStatus', function() {
      // uncomment below and update the code to test PerObjectSyncStatus
      //var instance = new AwsNetworkFirewall.PerObjectSyncStatus();
      //expect(instance).to.be.a(AwsNetworkFirewall.PerObjectSyncStatus);
    });
