...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallPolicyResponse();
  });
  ...
  describe('CreateFirewallPolicyResponse', function() {
    it('should create an instance of CreateFirewallPolicyResponse', function() {
      // uncomment below and update the code to test CreateFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallPolicyResponse);
    });
