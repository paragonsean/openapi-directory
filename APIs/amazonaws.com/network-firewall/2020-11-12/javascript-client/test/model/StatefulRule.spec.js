...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRule();
  });
  ...
  describe('StatefulRule', function() {
    it('should create an instance of StatefulRule', function() {
      // uncomment below and update the code to test StatefulRule
      //var instance = new AwsNetworkFirewall.StatefulRule();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRule);
    });
    ...
    it('should have the property ruleOptions (base name: "RuleOptions")', function() {
      // uncomment below and update the code to test the property ruleOptions
      //var instance = new AwsNetworkFirewall.StatefulRule();
      //expect(instance).to.be();
    });
