...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.AssociateSubnetsRequest();
  });
  ...
  describe('AssociateSubnetsRequest', function() {
    it('should create an instance of AssociateSubnetsRequest', function() {
      // uncomment below and update the code to test AssociateSubnetsRequest
      //var instance = new AwsNetworkFirewall.AssociateSubnetsRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.AssociateSubnetsRequest);
    });
