...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateLoggingConfigurationRequest();
  });
  ...
  describe('UpdateLoggingConfigurationRequest', function() {
    it('should create an instance of UpdateLoggingConfigurationRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.UpdateLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateLoggingConfigurationRequest);
    });
