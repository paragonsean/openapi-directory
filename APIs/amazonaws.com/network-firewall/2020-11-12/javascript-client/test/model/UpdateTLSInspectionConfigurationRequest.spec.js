...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequest();
  });
  ...
  describe('UpdateTLSInspectionConfigurationRequest', function() {
    it('should create an instance of UpdateTLSInspectionConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateTLSInspectionConfigurationRequest
      //var instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequest);
    });
