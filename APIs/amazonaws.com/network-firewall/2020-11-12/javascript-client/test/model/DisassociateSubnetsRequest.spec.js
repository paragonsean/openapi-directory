...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DisassociateSubnetsRequest();
  });
  ...
  describe('DisassociateSubnetsRequest', function() {
    it('should create an instance of DisassociateSubnetsRequest', function() {
      // uncomment below and update the code to test DisassociateSubnetsRequest
      //var instance = new AwsNetworkFirewall.DisassociateSubnetsRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DisassociateSubnetsRequest);
    });
