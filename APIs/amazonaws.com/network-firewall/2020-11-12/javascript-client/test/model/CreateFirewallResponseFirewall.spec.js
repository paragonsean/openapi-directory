...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
  });
  ...
  describe('CreateFirewallResponseFirewall', function() {
    it('should create an instance of CreateFirewallResponseFirewall', function() {
      // uncomment below and update the code to test CreateFirewallResponseFirewall
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallResponseFirewall);
    });
    ...
    it('should have the property firewallArn (base name: "FirewallArn")', function() {
      // uncomment below and update the code to test the property firewallArn
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });

    it('should have the property firewallPolicyArn (base name: "FirewallPolicyArn")', function() {
      // uncomment below and update the code to test the property firewallPolicyArn
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });
    ...
    it('should have the property deleteProtection (base name: "DeleteProtection")', function() {
      // uncomment below and update the code to test the property deleteProtection
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });

    it('should have the property subnetChangeProtection (base name: "SubnetChangeProtection")', function() {
      // uncomment below and update the code to test the property subnetChangeProtection
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });

    it('should have the property firewallPolicyChangeProtection (base name: "FirewallPolicyChangeProtection")', function() {
      // uncomment below and update the code to test the property firewallPolicyChangeProtection
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });
    ...
    it('should have the property firewallId (base name: "FirewallId")', function() {
      // uncomment below and update the code to test the property firewallId
      //var instance = new AwsNetworkFirewall.CreateFirewallResponseFirewall();
      //expect(instance).to.be();
    });
