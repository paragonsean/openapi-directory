...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionResponse();
  });
  ...
  describe('UpdateFirewallPolicyChangeProtectionResponse', function() {
    it('should create an instance of UpdateFirewallPolicyChangeProtectionResponse', function() {
      // uncomment below and update the code to test UpdateFirewallPolicyChangeProtectionResponse
      //var instance = new AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallPolicyChangeProtectionResponse);
    });
