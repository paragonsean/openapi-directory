...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallPolicyRequest();
  });
  ...
  describe('CreateFirewallPolicyRequest', function() {
    it('should create an instance of CreateFirewallPolicyRequest', function() {
      // uncomment below and update the code to test CreateFirewallPolicyRequest
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallPolicyRequest);
    });

    it('should have the property firewallPolicyName (base name: "FirewallPolicyName")', function() {
      // uncomment below and update the code to test the property firewallPolicyName
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequest();
