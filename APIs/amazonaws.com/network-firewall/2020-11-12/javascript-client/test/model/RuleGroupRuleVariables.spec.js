...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupRuleVariables();
  });
  ...
  describe('RuleGroupRuleVariables', function() {
    it('should create an instance of RuleGroupRuleVariables', function() {
      // uncomment below and update the code to test RuleGroupRuleVariables
      //var instance = new AwsNetworkFirewall.RuleGroupRuleVariables();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupRuleVariables);
    });
    ...
    it('should have the property portSets (base name: "PortSets")', function() {
      // uncomment below and update the code to test the property portSets
      //var instance = new AwsNetworkFirewall.RuleGroupRuleVariables();
      //expect(instance).to.be();
    });
