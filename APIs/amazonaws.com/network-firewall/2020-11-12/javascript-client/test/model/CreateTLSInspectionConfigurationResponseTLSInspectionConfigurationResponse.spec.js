...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
  });
  ...
  describe('CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse', function() {
    it('should create an instance of CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse);
    });
    ...
    it('should have the property tLSInspectionConfigurationName (base name: "TLSInspectionConfigurationName")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurationName
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });

    it('should have the property tLSInspectionConfigurationId (base name: "TLSInspectionConfigurationId")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurationId
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });

    it('should have the property tLSInspectionConfigurationStatus (base name: "TLSInspectionConfigurationStatus")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurationStatus
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfAssociations (base name: "NumberOfAssociations")', function() {
      // uncomment below and update the code to test the property numberOfAssociations
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponseTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });
