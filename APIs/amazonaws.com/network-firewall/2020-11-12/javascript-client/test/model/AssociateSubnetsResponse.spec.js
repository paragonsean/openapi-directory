...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.AssociateSubnetsResponse();
  });
  ...
  describe('AssociateSubnetsResponse', function() {
    it('should create an instance of AssociateSubnetsResponse', function() {
      // uncomment below and update the code to test AssociateSubnetsResponse
      //var instance = new AwsNetworkFirewall.AssociateSubnetsResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.AssociateSubnetsResponse);
    });
