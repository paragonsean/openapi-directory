...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.PolicyVariables();
  });
  ...
  describe('PolicyVariables', function() {
    it('should create an instance of PolicyVariables', function() {
      // uncomment below and update the code to test PolicyVariables
      //var instance = new AwsNetworkFirewall.PolicyVariables();
      //expect(instance).to.be.a(AwsNetworkFirewall.PolicyVariables);
    });
