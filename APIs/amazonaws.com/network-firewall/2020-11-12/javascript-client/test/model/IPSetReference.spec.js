...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.IPSetReference();
  });
  ...
  describe('IPSetReference', function() {
    it('should create an instance of IPSetReference', function() {
      // uncomment below and update the code to test IPSetReference
      //var instance = new AwsNetworkFirewall.IPSetReference();
      //expect(instance).to.be.a(AwsNetworkFirewall.IPSetReference);
    });
