...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeFirewallResponse();
  });
  ...
  describe('DescribeFirewallResponse', function() {
    it('should create an instance of DescribeFirewallResponse', function() {
      // uncomment below and update the code to test DescribeFirewallResponse
      //var instance = new AwsNetworkFirewall.DescribeFirewallResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeFirewallResponse);
    });
