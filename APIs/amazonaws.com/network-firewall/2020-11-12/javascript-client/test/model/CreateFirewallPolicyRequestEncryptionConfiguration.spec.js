...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestEncryptionConfiguration();
  });
  ...
  describe('CreateFirewallPolicyRequestEncryptionConfiguration', function() {
    it('should create an instance of CreateFirewallPolicyRequestEncryptionConfiguration', function() {
      // uncomment below and update the code to test CreateFirewallPolicyRequestEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.CreateFirewallPolicyRequestEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallPolicyRequestEncryptionConfiguration);
    });
