...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallRequestEncryptionConfiguration();
  });
  ...
  describe('CreateFirewallRequestEncryptionConfiguration', function() {
    it('should create an instance of CreateFirewallRequestEncryptionConfiguration', function() {
      // uncomment below and update the code to test CreateFirewallRequestEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.CreateFirewallRequestEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallRequestEncryptionConfiguration);
    });
