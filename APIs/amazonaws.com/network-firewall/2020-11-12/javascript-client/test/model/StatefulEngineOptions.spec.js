...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulEngineOptions();
  });
  ...
  describe('StatefulEngineOptions', function() {
    it('should create an instance of StatefulEngineOptions', function() {
      // uncomment below and update the code to test StatefulEngineOptions
      //var instance = new AwsNetworkFirewall.StatefulEngineOptions();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulEngineOptions);
    });
    ...
    it('should have the property streamExceptionPolicy (base name: "StreamExceptionPolicy")', function() {
      // uncomment below and update the code to test the property streamExceptionPolicy
      //var instance = new AwsNetworkFirewall.StatefulEngineOptions();
      //expect(instance).to.be();
    });
