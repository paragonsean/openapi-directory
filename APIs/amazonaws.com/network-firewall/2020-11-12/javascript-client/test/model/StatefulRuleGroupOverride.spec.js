...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRuleGroupOverride();
  });
  ...
  describe('StatefulRuleGroupOverride', function() {
    it('should create an instance of StatefulRuleGroupOverride', function() {
      // uncomment below and update the code to test StatefulRuleGroupOverride
      //var instance = new AwsNetworkFirewall.StatefulRuleGroupOverride();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleGroupOverride);
    });
