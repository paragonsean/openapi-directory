...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TLSInspectionConfigurationMetadata();
  });
  ...
  describe('TLSInspectionConfigurationMetadata', function() {
    it('should create an instance of TLSInspectionConfigurationMetadata', function() {
      // uncomment below and update the code to test TLSInspectionConfigurationMetadata
      //var instance = new AwsNetworkFirewall.TLSInspectionConfigurationMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.TLSInspectionConfigurationMetadata);
    });
