...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.PutResourcePolicyRequest();
  });
  ...
  describe('PutResourcePolicyRequest', function() {
    it('should create an instance of PutResourcePolicyRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.PutResourcePolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.PutResourcePolicyRequest);
    });
