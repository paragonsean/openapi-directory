...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupResponseEncryptionConfiguration();
  });
  ...
  describe('RuleGroupResponseEncryptionConfiguration', function() {
    it('should create an instance of RuleGroupResponseEncryptionConfiguration', function() {
      // uncomment below and update the code to test RuleGroupResponseEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.RuleGroupResponseEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupResponseEncryptionConfiguration);
    });
