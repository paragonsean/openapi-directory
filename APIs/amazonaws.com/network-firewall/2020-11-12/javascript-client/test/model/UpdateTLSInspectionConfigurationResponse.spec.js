...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationResponse();
  });
  ...
  describe('UpdateTLSInspectionConfigurationResponse', function() {
    it('should create an instance of UpdateTLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test UpdateTLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateTLSInspectionConfigurationResponse);
    });
