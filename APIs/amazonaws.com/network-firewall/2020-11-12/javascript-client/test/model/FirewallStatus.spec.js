...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallStatus();
  });
  ...
  describe('FirewallStatus', function() {
    it('should create an instance of FirewallStatus', function() {
      // uncomment below and update the code to test FirewallStatus
      //var instance = new AwsNetworkFirewall.FirewallStatus();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallStatus);
    });
