...
(function(root, factory) {
  ...
  describe('StatefulAction', function() {
    it('should create an instance of StatefulAction', function() {
      // uncomment below and update the code to test StatefulAction
      //var instance = new AwsNetworkFirewall.StatefulAction();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulAction);
    });
