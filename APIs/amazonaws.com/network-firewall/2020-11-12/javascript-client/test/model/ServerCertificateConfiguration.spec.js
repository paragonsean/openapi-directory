...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ServerCertificateConfiguration();
  });
  ...
  describe('ServerCertificateConfiguration', function() {
    it('should create an instance of ServerCertificateConfiguration', function() {
      // uncomment below and update the code to test ServerCertificateConfiguration
      //var instance = new AwsNetworkFirewall.ServerCertificateConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.ServerCertificateConfiguration);
    });
