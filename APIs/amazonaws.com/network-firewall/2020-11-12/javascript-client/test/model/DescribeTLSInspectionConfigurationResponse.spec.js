...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationResponse();
  });
  ...
  describe('DescribeTLSInspectionConfigurationResponse', function() {
    it('should create an instance of DescribeTLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test DescribeTLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeTLSInspectionConfigurationResponse);
    });
    ...
    it('should have the property tLSInspectionConfiguration (base name: "TLSInspectionConfiguration")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfiguration
      //var instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });

    it('should have the property tLSInspectionConfigurationResponse (base name: "TLSInspectionConfigurationResponse")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationResponse();
      //expect(instance).to.be();
    });
