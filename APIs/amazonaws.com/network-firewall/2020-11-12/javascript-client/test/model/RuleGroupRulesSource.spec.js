...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupRulesSource();
  });
  ...
  describe('RuleGroupRulesSource', function() {
    it('should create an instance of RuleGroupRulesSource', function() {
      // uncomment below and update the code to test RuleGroupRulesSource
      //var instance = new AwsNetworkFirewall.RuleGroupRulesSource();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupRulesSource);
    });
