...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallPolicyResponseEncryptionConfiguration();
  });
  ...
  describe('FirewallPolicyResponseEncryptionConfiguration', function() {
    it('should create an instance of FirewallPolicyResponseEncryptionConfiguration', function() {
      // uncomment below and update the code to test FirewallPolicyResponseEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.FirewallPolicyResponseEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallPolicyResponseEncryptionConfiguration);
    });
