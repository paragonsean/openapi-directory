...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataRequest();
  });
  ...
  describe('DescribeRuleGroupMetadataRequest', function() {
    it('should create an instance of DescribeRuleGroupMetadataRequest', function() {
      // uncomment below and update the code to test DescribeRuleGroupMetadataRequest
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeRuleGroupMetadataRequest);
    });
