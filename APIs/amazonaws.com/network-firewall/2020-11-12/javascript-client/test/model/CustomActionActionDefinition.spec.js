...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CustomActionActionDefinition();
  });
  ...
  describe('CustomActionActionDefinition', function() {
    it('should create an instance of CustomActionActionDefinition', function() {
      // uncomment below and update the code to test CustomActionActionDefinition
      //var instance = new AwsNetworkFirewall.CustomActionActionDefinition();
      //expect(instance).to.be.a(AwsNetworkFirewall.CustomActionActionDefinition);
    });

    it('should have the property publishMetricAction (base name: "PublishMetricAction")', function() {
      // uncomment below and update the code to test the property publishMetricAction
      //var instance = new AwsNetworkFirewall.CustomActionActionDefinition();
