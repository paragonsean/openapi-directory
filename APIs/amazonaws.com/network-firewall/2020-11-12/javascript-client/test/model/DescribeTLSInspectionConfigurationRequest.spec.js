...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationRequest();
  });
  ...
  describe('DescribeTLSInspectionConfigurationRequest', function() {
    it('should create an instance of DescribeTLSInspectionConfigurationRequest', function() {
      // uncomment below and update the code to test DescribeTLSInspectionConfigurationRequest
      //var instance = new AwsNetworkFirewall.DescribeTLSInspectionConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeTLSInspectionConfigurationRequest);
    });
