...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateFirewallResponse();
  });
  ...
  describe('CreateFirewallResponse', function() {
    it('should create an instance of CreateFirewallResponse', function() {
      // uncomment below and update the code to test CreateFirewallResponse
      //var instance = new AwsNetworkFirewall.CreateFirewallResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateFirewallResponse);
    });
