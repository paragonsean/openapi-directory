...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeLoggingConfigurationResponse();
  });
  ...
  describe('DescribeLoggingConfigurationResponse', function() {
    it('should create an instance of DescribeLoggingConfigurationResponse', function() {
      ...
      //var instance = new AwsNetworkFirewall.DescribeLoggingConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeLoggingConfigurationResponse);
    });
