...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.AssociateFirewallPolicyRequest();
  });
  ...
  describe('AssociateFirewallPolicyRequest', function() {
    it('should create an instance of AssociateFirewallPolicyRequest', function() {
      // uncomment below and update the code to test AssociateFirewallPolicyRequest
      //var instance = new AwsNetworkFirewall.AssociateFirewallPolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.AssociateFirewallPolicyRequest);
    });
