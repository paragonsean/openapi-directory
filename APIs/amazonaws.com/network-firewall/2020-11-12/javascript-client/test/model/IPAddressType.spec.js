...
(function(root, factory) {
  ...
  describe('IPAddressType', function() {
    it('should create an instance of IPAddressType', function() {
      // uncomment below and update the code to test IPAddressType
      //var instance = new AwsNetworkFirewall.IPAddressType();
      //expect(instance).to.be.a(AwsNetworkFirewall.IPAddressType);
    });
