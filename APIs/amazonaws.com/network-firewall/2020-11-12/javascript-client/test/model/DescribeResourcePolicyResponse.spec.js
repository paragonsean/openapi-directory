...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeResourcePolicyResponse();
  });
  ...
  describe('DescribeResourcePolicyResponse', function() {
    it('should create an instance of DescribeResourcePolicyResponse', function() {
      ...
      //var instance = new AwsNetworkFirewall.DescribeResourcePolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeResourcePolicyResponse);
    });
