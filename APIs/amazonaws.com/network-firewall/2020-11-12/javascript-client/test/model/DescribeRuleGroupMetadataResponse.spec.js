...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataResponse();
  });
  ...
  describe('DescribeRuleGroupMetadataResponse', function() {
    it('should create an instance of DescribeRuleGroupMetadataResponse', function() {
      // uncomment below and update the code to test DescribeRuleGroupMetadataResponse
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeRuleGroupMetadataResponse);
    });

    it('should have the property ruleGroupArn (base name: "RuleGroupArn")', function() {
      // uncomment below and update the code to test the property ruleGroupArn
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataResponse();
    ...
    it('should have the property statefulRuleOptions (base name: "StatefulRuleOptions")', function() {
      // uncomment below and update the code to test the property statefulRuleOptions
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupMetadataResponse();
      //expect(instance).to.be();
    });
