...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallEncryptionConfiguration();
  });
  ...
  describe('FirewallEncryptionConfiguration', function() {
    it('should create an instance of FirewallEncryptionConfiguration', function() {
      // uncomment below and update the code to test FirewallEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.FirewallEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallEncryptionConfiguration);
    });
