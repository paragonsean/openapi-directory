...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateSubnetChangeProtectionRequest();
  });
  ...
  describe('UpdateSubnetChangeProtectionRequest', function() {
    it('should create an instance of UpdateSubnetChangeProtectionRequest', function() {
      // uncomment below and update the code to test UpdateSubnetChangeProtectionRequest
      //var instance = new AwsNetworkFirewall.UpdateSubnetChangeProtectionRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateSubnetChangeProtectionRequest);
    });
