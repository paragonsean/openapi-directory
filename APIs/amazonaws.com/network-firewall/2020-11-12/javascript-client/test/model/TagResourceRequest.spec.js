...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.TagResourceRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.TagResourceRequest);
    });
