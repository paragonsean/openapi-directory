...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallPolicyMetadata();
  });
  ...
  describe('FirewallPolicyMetadata', function() {
    it('should create an instance of FirewallPolicyMetadata', function() {
      // uncomment below and update the code to test FirewallPolicyMetadata
      //var instance = new AwsNetworkFirewall.FirewallPolicyMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallPolicyMetadata);
    });
