...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeRuleGroupResponse();
  });
  ...
  describe('DescribeRuleGroupResponse', function() {
    it('should create an instance of DescribeRuleGroupResponse', function() {
      // uncomment below and update the code to test DescribeRuleGroupResponse
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeRuleGroupResponse);
    });
