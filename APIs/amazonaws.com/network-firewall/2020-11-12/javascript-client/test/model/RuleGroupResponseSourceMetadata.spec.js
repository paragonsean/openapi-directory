...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupResponseSourceMetadata();
  });
  ...
  describe('RuleGroupResponseSourceMetadata', function() {
    it('should create an instance of RuleGroupResponseSourceMetadata', function() {
      // uncomment below and update the code to test RuleGroupResponseSourceMetadata
      //var instance = new AwsNetworkFirewall.RuleGroupResponseSourceMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupResponseSourceMetadata);
    });
