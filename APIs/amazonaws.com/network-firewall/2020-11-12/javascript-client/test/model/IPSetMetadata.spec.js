...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.IPSetMetadata();
  });
  ...
  describe('IPSetMetadata', function() {
    it('should create an instance of IPSetMetadata', function() {
      // uncomment below and update the code to test IPSetMetadata
      //var instance = new AwsNetworkFirewall.IPSetMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.IPSetMetadata);
    });

    it('should have the property resolvedCIDRCount (base name: "ResolvedCIDRCount")', function() {
      // uncomment below and update the code to test the property resolvedCIDRCount
      //var instance = new AwsNetworkFirewall.IPSetMetadata();
