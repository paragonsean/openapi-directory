...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeFirewallPolicyResponseFirewallPolicy();
  });
  ...
  describe('DescribeFirewallPolicyResponseFirewallPolicy', function() {
    it('should create an instance of DescribeFirewallPolicyResponseFirewallPolicy', function() {
      // uncomment below and update the code to test DescribeFirewallPolicyResponseFirewallPolicy
      //var instance = new AwsNetworkFirewall.DescribeFirewallPolicyResponseFirewallPolicy();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeFirewallPolicyResponseFirewallPolicy);
    });
