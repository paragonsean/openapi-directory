...
(function(root, factory) {
  ...
  describe('OverrideAction', function() {
    it('should create an instance of OverrideAction', function() {
      // uncomment below and update the code to test OverrideAction
      //var instance = new AwsNetworkFirewall.OverrideAction();
      //expect(instance).to.be.a(AwsNetworkFirewall.OverrideAction);
    });
