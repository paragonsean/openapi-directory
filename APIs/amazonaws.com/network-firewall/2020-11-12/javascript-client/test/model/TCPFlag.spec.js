...
(function(root, factory) {
  ...
  describe('TCPFlag', function() {
    it('should create an instance of TCPFlag', function() {
      // uncomment below and update the code to test TCPFlag
      //var instance = new AwsNetworkFirewall.TCPFlag();
      //expect(instance).to.be.a(AwsNetworkFirewall.TCPFlag);
    });
