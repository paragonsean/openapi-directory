...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateRuleGroupRequest();
  });
  ...
  describe('CreateRuleGroupRequest', function() {
    it('should create an instance of CreateRuleGroupRequest', function() {
      // uncomment below and update the code to test CreateRuleGroupRequest
      //var instance = new AwsNetworkFirewall.CreateRuleGroupRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateRuleGroupRequest);
    });
