...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteTLSInspectionConfigurationResponse();
  });
  ...
  describe('DeleteTLSInspectionConfigurationResponse', function() {
    it('should create an instance of DeleteTLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test DeleteTLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.DeleteTLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteTLSInspectionConfigurationResponse);
    });
