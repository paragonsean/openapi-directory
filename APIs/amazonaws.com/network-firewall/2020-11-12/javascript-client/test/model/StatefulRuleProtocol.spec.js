...
(function(root, factory) {
  ...
  describe('StatefulRuleProtocol', function() {
    it('should create an instance of StatefulRuleProtocol', function() {
      // uncomment below and update the code to test StatefulRuleProtocol
      //var instance = new AwsNetworkFirewall.StatefulRuleProtocol();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleProtocol);
    });
