...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListTLSInspectionConfigurationsResponse();
  });
  ...
  describe('ListTLSInspectionConfigurationsResponse', function() {
    it('should create an instance of ListTLSInspectionConfigurationsResponse', function() {
      // uncomment below and update the code to test ListTLSInspectionConfigurationsResponse
      //var instance = new AwsNetworkFirewall.ListTLSInspectionConfigurationsResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListTLSInspectionConfigurationsResponse);
    });
    ...
    it('should have the property tLSInspectionConfigurations (base name: "TLSInspectionConfigurations")', function() {
      // uncomment below and update the code to test the property tLSInspectionConfigurations
      //var instance = new AwsNetworkFirewall.ListTLSInspectionConfigurationsResponse();
      //expect(instance).to.be();
    });
