...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.SubnetMapping();
  });
  ...
  describe('SubnetMapping', function() {
    it('should create an instance of SubnetMapping', function() {
      ...
      //var instance = new AwsNetworkFirewall.SubnetMapping();
      //expect(instance).to.be.a(AwsNetworkFirewall.SubnetMapping);
    });
