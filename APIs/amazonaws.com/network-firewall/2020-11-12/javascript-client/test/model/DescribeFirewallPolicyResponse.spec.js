...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeFirewallPolicyResponse();
  });
  ...
  describe('DescribeFirewallPolicyResponse', function() {
    it('should create an instance of DescribeFirewallPolicyResponse', function() {
      // uncomment below and update the code to test DescribeFirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.DescribeFirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeFirewallPolicyResponse);
    });
    ...
    it('should have the property firewallPolicyResponse (base name: "FirewallPolicyResponse")', function() {
      // uncomment below and update the code to test the property firewallPolicyResponse
      //var instance = new AwsNetworkFirewall.DescribeFirewallPolicyResponse();
      //expect(instance).to.be();
    });
