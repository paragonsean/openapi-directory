...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.PerObjectStatus();
  });
  ...
  describe('PerObjectStatus', function() {
    it('should create an instance of PerObjectStatus', function() {
      // uncomment below and update the code to test PerObjectStatus
      //var instance = new AwsNetworkFirewall.PerObjectStatus();
      //expect(instance).to.be.a(AwsNetworkFirewall.PerObjectStatus);
    });
