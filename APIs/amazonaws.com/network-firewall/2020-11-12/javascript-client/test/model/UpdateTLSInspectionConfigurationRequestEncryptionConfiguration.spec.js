...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequestEncryptionConfiguration();
  });
  ...
  describe('UpdateTLSInspectionConfigurationRequestEncryptionConfiguration', function() {
    it('should create an instance of UpdateTLSInspectionConfigurationRequestEncryptionConfiguration', function() {
      // uncomment below and update the code to test UpdateTLSInspectionConfigurationRequestEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequestEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateTLSInspectionConfigurationRequestEncryptionConfiguration);
    });
