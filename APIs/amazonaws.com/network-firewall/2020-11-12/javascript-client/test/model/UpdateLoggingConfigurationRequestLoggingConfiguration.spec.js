...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateLoggingConfigurationRequestLoggingConfiguration();
  });
  ...
  describe('UpdateLoggingConfigurationRequestLoggingConfiguration', function() {
    it('should create an instance of UpdateLoggingConfigurationRequestLoggingConfiguration', function() {
      // uncomment below and update the code to test UpdateLoggingConfigurationRequestLoggingConfiguration
      //var instance = new AwsNetworkFirewall.UpdateLoggingConfigurationRequestLoggingConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateLoggingConfigurationRequestLoggingConfiguration);
    });
