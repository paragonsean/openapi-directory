...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ActionDefinition();
  });
  ...
  describe('ActionDefinition', function() {
    it('should create an instance of ActionDefinition', function() {
      ...
      //var instance = new AwsNetworkFirewall.ActionDefinition();
      //expect(instance).to.be.a(AwsNetworkFirewall.ActionDefinition);
    });
