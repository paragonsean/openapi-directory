...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRuleGroupReference();
  });
  ...
  describe('StatefulRuleGroupReference', function() {
    it('should create an instance of StatefulRuleGroupReference', function() {
      // uncomment below and update the code to test StatefulRuleGroupReference
      //var instance = new AwsNetworkFirewall.StatefulRuleGroupReference();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleGroupReference);
    });
