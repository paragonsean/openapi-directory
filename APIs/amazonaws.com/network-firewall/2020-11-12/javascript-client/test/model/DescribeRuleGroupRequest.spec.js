...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeRuleGroupRequest();
  });
  ...
  describe('DescribeRuleGroupRequest', function() {
    it('should create an instance of DescribeRuleGroupRequest', function() {
      // uncomment below and update the code to test DescribeRuleGroupRequest
      //var instance = new AwsNetworkFirewall.DescribeRuleGroupRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeRuleGroupRequest);
    });
