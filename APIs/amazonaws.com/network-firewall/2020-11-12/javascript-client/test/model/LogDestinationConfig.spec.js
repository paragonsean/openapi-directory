...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.LogDestinationConfig();
  });
  ...
  describe('LogDestinationConfig', function() {
    it('should create an instance of LogDestinationConfig', function() {
      // uncomment below and update the code to test LogDestinationConfig
      //var instance = new AwsNetworkFirewall.LogDestinationConfig();
      //expect(instance).to.be.a(AwsNetworkFirewall.LogDestinationConfig);
    });
