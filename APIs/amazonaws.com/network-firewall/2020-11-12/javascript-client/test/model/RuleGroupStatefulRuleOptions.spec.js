...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupStatefulRuleOptions();
  });
  ...
  describe('RuleGroupStatefulRuleOptions', function() {
    it('should create an instance of RuleGroupStatefulRuleOptions', function() {
      // uncomment below and update the code to test RuleGroupStatefulRuleOptions
      //var instance = new AwsNetworkFirewall.RuleGroupStatefulRuleOptions();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupStatefulRuleOptions);
    });
