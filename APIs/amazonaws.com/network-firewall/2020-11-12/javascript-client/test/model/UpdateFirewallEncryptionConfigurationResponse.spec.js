...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationResponse();
  });
  ...
  describe('UpdateFirewallEncryptionConfigurationResponse', function() {
    it('should create an instance of UpdateFirewallEncryptionConfigurationResponse', function() {
      // uncomment below and update the code to test UpdateFirewallEncryptionConfigurationResponse
      //var instance = new AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallEncryptionConfigurationResponse);
    });
