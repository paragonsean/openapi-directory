...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteFirewallPolicyRequest();
  });
  ...
  describe('DeleteFirewallPolicyRequest', function() {
    it('should create an instance of DeleteFirewallPolicyRequest', function() {
      // uncomment below and update the code to test DeleteFirewallPolicyRequest
      //var instance = new AwsNetworkFirewall.DeleteFirewallPolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteFirewallPolicyRequest);
    });
