...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallDeleteProtectionRequest();
  });
  ...
  describe('UpdateFirewallDeleteProtectionRequest', function() {
    it('should create an instance of UpdateFirewallDeleteProtectionRequest', function() {
      // uncomment below and update the code to test UpdateFirewallDeleteProtectionRequest
      //var instance = new AwsNetworkFirewall.UpdateFirewallDeleteProtectionRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallDeleteProtectionRequest);
    });
