...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallPolicyResponse();
  });
  ...
  describe('FirewallPolicyResponse', function() {
    it('should create an instance of FirewallPolicyResponse', function() {
      // uncomment below and update the code to test FirewallPolicyResponse
      //var instance = new AwsNetworkFirewall.FirewallPolicyResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallPolicyResponse);
    });
