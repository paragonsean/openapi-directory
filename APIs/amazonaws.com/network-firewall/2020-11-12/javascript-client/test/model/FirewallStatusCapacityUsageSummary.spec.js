...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallStatusCapacityUsageSummary();
  });
  ...
  describe('FirewallStatusCapacityUsageSummary', function() {
    it('should create an instance of FirewallStatusCapacityUsageSummary', function() {
      // uncomment below and update the code to test FirewallStatusCapacityUsageSummary
      //var instance = new AwsNetworkFirewall.FirewallStatusCapacityUsageSummary();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallStatusCapacityUsageSummary);
    });
