...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListFirewallPoliciesRequest();
  });
  ...
  describe('ListFirewallPoliciesRequest', function() {
    it('should create an instance of ListFirewallPoliciesRequest', function() {
      // uncomment below and update the code to test ListFirewallPoliciesRequest
      //var instance = new AwsNetworkFirewall.ListFirewallPoliciesRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListFirewallPoliciesRequest);
    });
