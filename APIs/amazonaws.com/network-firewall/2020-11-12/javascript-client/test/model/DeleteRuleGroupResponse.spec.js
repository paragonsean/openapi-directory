...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteRuleGroupResponse();
  });
  ...
  describe('DeleteRuleGroupResponse', function() {
    it('should create an instance of DeleteRuleGroupResponse', function() {
      // uncomment below and update the code to test DeleteRuleGroupResponse
      //var instance = new AwsNetworkFirewall.DeleteRuleGroupResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteRuleGroupResponse);
    });

    it('should have the property ruleGroupResponse (base name: "RuleGroupResponse")', function() {
      // uncomment below and update the code to test the property ruleGroupResponse
      //var instance = new AwsNetworkFirewall.DeleteRuleGroupResponse();
