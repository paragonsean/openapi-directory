...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListTagsForResourceRequest);
    });
