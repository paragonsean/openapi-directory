...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CapacityUsageSummary();
  });
  ...
  describe('CapacityUsageSummary', function() {
    it('should create an instance of CapacityUsageSummary', function() {
      // uncomment below and update the code to test CapacityUsageSummary
      //var instance = new AwsNetworkFirewall.CapacityUsageSummary();
      //expect(instance).to.be.a(AwsNetworkFirewall.CapacityUsageSummary);
    });
