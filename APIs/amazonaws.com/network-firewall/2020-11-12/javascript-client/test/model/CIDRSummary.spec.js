...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CIDRSummary();
  });
  ...
  describe('CIDRSummary', function() {
    it('should create an instance of CIDRSummary', function() {
      // uncomment below and update the code to test CIDRSummary
      //var instance = new AwsNetworkFirewall.CIDRSummary();
      //expect(instance).to.be.a(AwsNetworkFirewall.CIDRSummary);
    });
