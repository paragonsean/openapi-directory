...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponse();
  });
  ...
  describe('CreateTLSInspectionConfigurationResponse', function() {
    it('should create an instance of CreateTLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test CreateTLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateTLSInspectionConfigurationResponse);
    });
