...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListFirewallsResponse();
  });
  ...
  describe('ListFirewallsResponse', function() {
    it('should create an instance of ListFirewallsResponse', function() {
      // uncomment below and update the code to test ListFirewallsResponse
      //var instance = new AwsNetworkFirewall.ListFirewallsResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListFirewallsResponse);
    });
