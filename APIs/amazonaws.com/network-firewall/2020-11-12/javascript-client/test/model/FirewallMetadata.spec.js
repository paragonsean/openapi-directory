...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallMetadata();
  });
  ...
  describe('FirewallMetadata', function() {
    it('should create an instance of FirewallMetadata', function() {
      // uncomment below and update the code to test FirewallMetadata
      //var instance = new AwsNetworkFirewall.FirewallMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallMetadata);
    });
