...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleVariables();
  });
  ...
  describe('RuleVariables', function() {
    it('should create an instance of RuleVariables', function() {
      // uncomment below and update the code to test RuleVariables
      //var instance = new AwsNetworkFirewall.RuleVariables();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleVariables);
    });
