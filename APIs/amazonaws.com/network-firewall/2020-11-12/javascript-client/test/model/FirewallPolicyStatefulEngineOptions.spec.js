...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.FirewallPolicyStatefulEngineOptions();
  });
  ...
  describe('FirewallPolicyStatefulEngineOptions', function() {
    it('should create an instance of FirewallPolicyStatefulEngineOptions', function() {
      // uncomment below and update the code to test FirewallPolicyStatefulEngineOptions
      //var instance = new AwsNetworkFirewall.FirewallPolicyStatefulEngineOptions();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallPolicyStatefulEngineOptions);
    });
