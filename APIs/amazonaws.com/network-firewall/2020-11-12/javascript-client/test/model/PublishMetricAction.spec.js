...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.PublishMetricAction();
  });
  ...
  describe('PublishMetricAction', function() {
    it('should create an instance of PublishMetricAction', function() {
      // uncomment below and update the code to test PublishMetricAction
      //var instance = new AwsNetworkFirewall.PublishMetricAction();
      //expect(instance).to.be.a(AwsNetworkFirewall.PublishMetricAction);
    });
