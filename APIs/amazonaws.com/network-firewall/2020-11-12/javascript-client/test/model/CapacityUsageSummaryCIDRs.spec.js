...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CapacityUsageSummaryCIDRs();
  });
  ...
  describe('CapacityUsageSummaryCIDRs', function() {
    it('should create an instance of CapacityUsageSummaryCIDRs', function() {
      // uncomment below and update the code to test CapacityUsageSummaryCIDRs
      //var instance = new AwsNetworkFirewall.CapacityUsageSummaryCIDRs();
      //expect(instance).to.be.a(AwsNetworkFirewall.CapacityUsageSummaryCIDRs);
    });

    it('should have the property availableCIDRCount (base name: "AvailableCIDRCount")', function() {
      // uncomment below and update the code to test the property availableCIDRCount
      //var instance = new AwsNetworkFirewall.CapacityUsageSummaryCIDRs();
      //expect(instance).to.be();
    });

    it('should have the property utilizedCIDRCount (base name: "UtilizedCIDRCount")', function() {
      // uncomment below and update the code to test the property utilizedCIDRCount
      //var instance = new AwsNetworkFirewall.CapacityUsageSummaryCIDRs();
      //expect(instance).to.be();
    });
