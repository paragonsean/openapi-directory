...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.StatefulRuleHeader();
  });
  ...
  describe('StatefulRuleHeader', function() {
    it('should create an instance of StatefulRuleHeader', function() {
      // uncomment below and update the code to test StatefulRuleHeader
      //var instance = new AwsNetworkFirewall.StatefulRuleHeader();
      //expect(instance).to.be.a(AwsNetworkFirewall.StatefulRuleHeader);
    });
