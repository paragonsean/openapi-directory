...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupReferenceSets();
  });
  ...
  describe('RuleGroupReferenceSets', function() {
    it('should create an instance of RuleGroupReferenceSets', function() {
      // uncomment below and update the code to test RuleGroupReferenceSets
      //var instance = new AwsNetworkFirewall.RuleGroupReferenceSets();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupReferenceSets);
    });

    it('should have the property iPSetReferences (base name: "IPSetReferences")', function() {
      // uncomment below and update the code to test the property iPSetReferences
      //var instance = new AwsNetworkFirewall.RuleGroupReferenceSets();
