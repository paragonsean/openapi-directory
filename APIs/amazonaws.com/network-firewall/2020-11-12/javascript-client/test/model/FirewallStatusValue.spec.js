...
(function(root, factory) {
  ...
  describe('FirewallStatusValue', function() {
    it('should create an instance of FirewallStatusValue', function() {
      // uncomment below and update the code to test FirewallStatusValue
      //var instance = new AwsNetworkFirewall.FirewallStatusValue();
      //expect(instance).to.be.a(AwsNetworkFirewall.FirewallStatusValue);
    });
