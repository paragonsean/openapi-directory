...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteFirewallResponse();
  });
  ...
  describe('DeleteFirewallResponse', function() {
    it('should create an instance of DeleteFirewallResponse', function() {
      // uncomment below and update the code to test DeleteFirewallResponse
      //var instance = new AwsNetworkFirewall.DeleteFirewallResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteFirewallResponse);
    });
    ...
    it('should have the property firewallStatus (base name: "FirewallStatus")', function() {
      // uncomment below and update the code to test the property firewallStatus
      //var instance = new AwsNetworkFirewall.DeleteFirewallResponse();
      //expect(instance).to.be();
    });
