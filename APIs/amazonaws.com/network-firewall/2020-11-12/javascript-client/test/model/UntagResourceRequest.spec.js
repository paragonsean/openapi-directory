...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.UntagResourceRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UntagResourceRequest);
    });
