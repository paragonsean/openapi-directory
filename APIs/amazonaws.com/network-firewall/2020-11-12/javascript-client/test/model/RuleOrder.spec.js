...
(function(root, factory) {
  ...
  describe('RuleOrder', function() {
    it('should create an instance of RuleOrder', function() {
      // uncomment below and update the code to test RuleOrder
      //var instance = new AwsNetworkFirewall.RuleOrder();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleOrder);
    });
