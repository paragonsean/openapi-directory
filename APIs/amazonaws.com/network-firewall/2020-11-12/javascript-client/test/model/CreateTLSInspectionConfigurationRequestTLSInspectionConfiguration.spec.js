...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration();
  });
  ...
  describe('CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration', function() {
    it('should create an instance of CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration', function() {
      // uncomment below and update the code to test CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration);
    });

    it('should have the property serverCertificateConfigurations (base name: "ServerCertificateConfigurations")', function() {
      // uncomment below and update the code to test the property serverCertificateConfigurations
      //var instance = new AwsNetworkFirewall.CreateTLSInspectionConfigurationRequestTLSInspectionConfiguration();
