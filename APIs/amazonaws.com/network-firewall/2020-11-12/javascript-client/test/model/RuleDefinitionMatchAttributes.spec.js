...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleDefinitionMatchAttributes();
  });
  ...
  describe('RuleDefinitionMatchAttributes', function() {
    it('should create an instance of RuleDefinitionMatchAttributes', function() {
      // uncomment below and update the code to test RuleDefinitionMatchAttributes
      //var instance = new AwsNetworkFirewall.RuleDefinitionMatchAttributes();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleDefinitionMatchAttributes);
    });
    ...
    it('should have the property tCPFlags (base name: "TCPFlags")', function() {
      // uncomment below and update the code to test the property tCPFlags
      //var instance = new AwsNetworkFirewall.RuleDefinitionMatchAttributes();
      //expect(instance).to.be();
    });
