...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TLSInspectionConfigurationResponse();
  });
  ...
  describe('TLSInspectionConfigurationResponse', function() {
    it('should create an instance of TLSInspectionConfigurationResponse', function() {
      // uncomment below and update the code to test TLSInspectionConfigurationResponse
      //var instance = new AwsNetworkFirewall.TLSInspectionConfigurationResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.TLSInspectionConfigurationResponse);
    });
