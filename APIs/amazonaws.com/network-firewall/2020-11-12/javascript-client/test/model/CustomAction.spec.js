...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CustomAction();
  });
  ...
  describe('CustomAction', function() {
    it('should create an instance of CustomAction', function() {
      // uncomment below and update the code to test CustomAction
      //var instance = new AwsNetworkFirewall.CustomAction();
      //expect(instance).to.be.a(AwsNetworkFirewall.CustomAction);
    });
    ...
    it('should have the property actionDefinition (base name: "ActionDefinition")', function() {
      // uncomment below and update the code to test the property actionDefinition
      //var instance = new AwsNetworkFirewall.CustomAction();
      //expect(instance).to.be();
    });
