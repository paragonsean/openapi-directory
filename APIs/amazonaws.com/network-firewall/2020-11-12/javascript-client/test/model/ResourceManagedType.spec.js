...
(function(root, factory) {
  ...
  describe('ResourceManagedType', function() {
    it('should create an instance of ResourceManagedType', function() {
      // uncomment below and update the code to test ResourceManagedType
      //var instance = new AwsNetworkFirewall.ResourceManagedType();
      //expect(instance).to.be.a(AwsNetworkFirewall.ResourceManagedType);
    });
