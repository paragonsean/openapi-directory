...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateSubnetChangeProtectionResponse();
  });
  ...
  describe('UpdateSubnetChangeProtectionResponse', function() {
    it('should create an instance of UpdateSubnetChangeProtectionResponse', function() {
      // uncomment below and update the code to test UpdateSubnetChangeProtectionResponse
      //var instance = new AwsNetworkFirewall.UpdateSubnetChangeProtectionResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateSubnetChangeProtectionResponse);
    });
