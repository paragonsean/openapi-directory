...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListFirewallsRequest();
  });
  ...
  describe('ListFirewallsRequest', function() {
    it('should create an instance of ListFirewallsRequest', function() {
      // uncomment below and update the code to test ListFirewallsRequest
      //var instance = new AwsNetworkFirewall.ListFirewallsRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListFirewallsRequest);
    });
