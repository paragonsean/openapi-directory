...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeLoggingConfigurationRequest();
  });
  ...
  describe('DescribeLoggingConfigurationRequest', function() {
    it('should create an instance of DescribeLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test DescribeLoggingConfigurationRequest
      //var instance = new AwsNetworkFirewall.DescribeLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeLoggingConfigurationRequest);
    });
