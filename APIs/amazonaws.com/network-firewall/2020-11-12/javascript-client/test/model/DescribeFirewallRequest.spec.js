...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DescribeFirewallRequest();
  });
  ...
  describe('DescribeFirewallRequest', function() {
    it('should create an instance of DescribeFirewallRequest', function() {
      // uncomment below and update the code to test DescribeFirewallRequest
      //var instance = new AwsNetworkFirewall.DescribeFirewallRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DescribeFirewallRequest);
    });
