...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleGroupMetadata();
  });
  ...
  describe('RuleGroupMetadata', function() {
    it('should create an instance of RuleGroupMetadata', function() {
      // uncomment below and update the code to test RuleGroupMetadata
      //var instance = new AwsNetworkFirewall.RuleGroupMetadata();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleGroupMetadata);
    });
