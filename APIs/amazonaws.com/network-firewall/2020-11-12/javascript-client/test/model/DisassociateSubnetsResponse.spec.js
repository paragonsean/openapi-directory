...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DisassociateSubnetsResponse();
  });
  ...
  describe('DisassociateSubnetsResponse', function() {
    it('should create an instance of DisassociateSubnetsResponse', function() {
      // uncomment below and update the code to test DisassociateSubnetsResponse
      //var instance = new AwsNetworkFirewall.DisassociateSubnetsResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.DisassociateSubnetsResponse);
    });
