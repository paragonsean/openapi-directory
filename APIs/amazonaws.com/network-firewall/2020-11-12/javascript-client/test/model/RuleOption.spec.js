...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.RuleOption();
  });
  ...
  describe('RuleOption', function() {
    it('should create an instance of RuleOption', function() {
      // uncomment below and update the code to test RuleOption
      //var instance = new AwsNetworkFirewall.RuleOption();
      //expect(instance).to.be.a(AwsNetworkFirewall.RuleOption);
    });
