...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallDescriptionRequest();
  });
  ...
  describe('UpdateFirewallDescriptionRequest', function() {
    it('should create an instance of UpdateFirewallDescriptionRequest', function() {
      // uncomment below and update the code to test UpdateFirewallDescriptionRequest
      //var instance = new AwsNetworkFirewall.UpdateFirewallDescriptionRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallDescriptionRequest);
    });
