...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsNetworkFirewall.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListTagsForResourceResponse);
    });
