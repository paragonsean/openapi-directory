...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListFirewallPoliciesResponse();
  });
  ...
  describe('ListFirewallPoliciesResponse', function() {
    it('should create an instance of ListFirewallPoliciesResponse', function() {
      // uncomment below and update the code to test ListFirewallPoliciesResponse
      //var instance = new AwsNetworkFirewall.ListFirewallPoliciesResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListFirewallPoliciesResponse);
    });
    ...
    it('should have the property firewallPolicies (base name: "FirewallPolicies")', function() {
      // uncomment below and update the code to test the property firewallPolicies
      //var instance = new AwsNetworkFirewall.ListFirewallPoliciesResponse();
      //expect(instance).to.be();
    });
