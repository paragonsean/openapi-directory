...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.CreateRuleGroupRequestEncryptionConfiguration();
  });
  ...
  describe('CreateRuleGroupRequestEncryptionConfiguration', function() {
    it('should create an instance of CreateRuleGroupRequestEncryptionConfiguration', function() {
      // uncomment below and update the code to test CreateRuleGroupRequestEncryptionConfiguration
      //var instance = new AwsNetworkFirewall.CreateRuleGroupRequestEncryptionConfiguration();
      //expect(instance).to.be.a(AwsNetworkFirewall.CreateRuleGroupRequestEncryptionConfiguration);
    });
