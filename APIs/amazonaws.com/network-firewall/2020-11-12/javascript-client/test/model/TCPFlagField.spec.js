...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.TCPFlagField();
  });
  ...
  describe('TCPFlagField', function() {
    it('should create an instance of TCPFlagField', function() {
      // uncomment below and update the code to test TCPFlagField
      //var instance = new AwsNetworkFirewall.TCPFlagField();
      //expect(instance).to.be.a(AwsNetworkFirewall.TCPFlagField);
    });
