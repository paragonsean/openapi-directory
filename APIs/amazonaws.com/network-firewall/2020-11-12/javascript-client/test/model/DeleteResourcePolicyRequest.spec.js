...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.DeleteResourcePolicyRequest();
  });
  ...
  describe('DeleteResourcePolicyRequest', function() {
    it('should create an instance of DeleteResourcePolicyRequest', function() {
      ...
      //var instance = new AwsNetworkFirewall.DeleteResourcePolicyRequest();
      //expect(instance).to.be.a(AwsNetworkFirewall.DeleteResourcePolicyRequest);
    });
