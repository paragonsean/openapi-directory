...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.ListRuleGroupsResponse();
  });
  ...
  describe('ListRuleGroupsResponse', function() {
    it('should create an instance of ListRuleGroupsResponse', function() {
      // uncomment below and update the code to test ListRuleGroupsResponse
      //var instance = new AwsNetworkFirewall.ListRuleGroupsResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.ListRuleGroupsResponse);
    });
