...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsNetworkFirewall.UpdateFirewallDescriptionResponse();
  });
  ...
  describe('UpdateFirewallDescriptionResponse', function() {
    it('should create an instance of UpdateFirewallDescriptionResponse', function() {
      // uncomment below and update the code to test UpdateFirewallDescriptionResponse
      //var instance = new AwsNetworkFirewall.UpdateFirewallDescriptionResponse();
      //expect(instance).to.be.a(AwsNetworkFirewall.UpdateFirewallDescriptionResponse);
    });
