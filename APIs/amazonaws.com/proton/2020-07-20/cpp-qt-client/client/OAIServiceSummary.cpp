...
QDateTime OAIServiceSummary::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIServiceSummary::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIServiceSummary::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIServiceSummary::is_last_modified_at_Valid() const{
...
QString OAIServiceSummary::getStatusMessage() const {
    return m_status_message;
}
void OAIServiceSummary::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIServiceSummary::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIServiceSummary::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QString OAIServiceSummary::getTemplateName() const {
    return m_template_name;
}
void OAIServiceSummary::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServiceSummary::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServiceSummary::is_template_name_Valid() const{
...
bool OAIServiceSummary::isValid() const {
    ...
    return m_arn_isValid && m_created_at_isValid && m_last_modified_at_isValid && m_name_isValid && m_status_isValid && m_template_name_isValid && true;
}
