...
QString OAIOutput::getKey() const {
    return m_key;
}
void OAIOutput::setKey(const QString &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIOutput::is_key_Set() const{
    return m_key_isSet;
}

bool OAIOutput::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIOutput::getValueString() const {
    return m_value_string;
}
void OAIOutput::setValueString(const QString &value_string) {
    m_value_string = value_string;
    m_value_string_isSet = true;
}

bool OAIOutput::is_value_string_Set() const{
    return m_value_string_isSet;
}

bool OAIOutput::is_value_string_Valid() const{
