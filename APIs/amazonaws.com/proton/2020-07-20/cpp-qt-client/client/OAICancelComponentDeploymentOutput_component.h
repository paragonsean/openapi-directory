...
/*
 * OAICancelComponentDeploymentOutput_component.h
 *
 * 
 */

#ifndef OAICancelComponentDeploymentOutput_component_H
#define OAICancelComponentDeploymentOutput_component_H
...
class OAICancelComponentDeploymentOutput_component : public OAIObject {
public:
    OAICancelComponentDeploymentOutput_component();
    OAICancelComponentDeploymentOutput_component(QString json);
    ~OAICancelComponentDeploymentOutput_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelComponentDeploymentOutput_component)

#endif // OAICancelComponentDeploymentOutput_component_H
