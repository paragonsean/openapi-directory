...
/*
 * OAICancelServicePipelineDeploymentOutput_pipeline.h
 *
 * 
 */

#ifndef OAICancelServicePipelineDeploymentOutput_pipeline_H
#define OAICancelServicePipelineDeploymentOutput_pipeline_H
...
class OAICancelServicePipelineDeploymentOutput_pipeline : public OAIObject {
public:
    OAICancelServicePipelineDeploymentOutput_pipeline();
    OAICancelServicePipelineDeploymentOutput_pipeline(QString json);
    ~OAICancelServicePipelineDeploymentOutput_pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelServicePipelineDeploymentOutput_pipeline)

#endif // OAICancelServicePipelineDeploymentOutput_pipeline_H
