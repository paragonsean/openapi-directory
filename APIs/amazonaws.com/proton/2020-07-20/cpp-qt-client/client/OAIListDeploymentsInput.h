...
/*
 * OAIListDeploymentsInput.h
 *
 * 
 */

#ifndef OAIListDeploymentsInput_H
#define OAIListDeploymentsInput_H
...
class OAIListDeploymentsInput : public OAIObject {
public:
    OAIListDeploymentsInput();
    OAIListDeploymentsInput(QString json);
    ~OAIListDeploymentsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeploymentsInput)

#endif // OAIListDeploymentsInput_H
