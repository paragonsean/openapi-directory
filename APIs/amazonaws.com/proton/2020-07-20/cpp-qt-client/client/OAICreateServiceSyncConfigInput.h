...
/*
 * OAICreateServiceSyncConfigInput.h
 *
 * 
 */

#ifndef OAICreateServiceSyncConfigInput_H
#define OAICreateServiceSyncConfigInput_H
...
class OAICreateServiceSyncConfigInput : public OAIObject {
public:
    OAICreateServiceSyncConfigInput();
    OAICreateServiceSyncConfigInput(QString json);
    ~OAICreateServiceSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceSyncConfigInput)

#endif // OAICreateServiceSyncConfigInput_H
