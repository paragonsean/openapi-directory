...
QString OAIRepository::getArn() const {
    return m_arn;
}
void OAIRepository::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRepository::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRepository::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIRepository::getConnectionArn() const {
    return m_connection_arn;
}
void OAIRepository::setConnectionArn(const QString &connection_arn) {
    m_connection_arn = connection_arn;
    m_connection_arn_isSet = true;
}

bool OAIRepository::is_connection_arn_Set() const{
    return m_connection_arn_isSet;
}

bool OAIRepository::is_connection_arn_Valid() const{
    return m_connection_arn_isValid;
}

QString OAIRepository::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIRepository::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIRepository::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIRepository::is_encryption_key_Valid() const{
...
OAIRepositoryProvider OAIRepository::getProvider() const {
    return m_provider;
}
void OAIRepository::setProvider(const OAIRepositoryProvider &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIRepository::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIRepository::is_provider_Valid() const{
