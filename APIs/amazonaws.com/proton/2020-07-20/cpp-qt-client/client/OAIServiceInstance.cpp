...
QString OAIServiceInstance::getArn() const {
    return m_arn;
}
void OAIServiceInstance::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIServiceInstance::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIServiceInstance::is_arn_Valid() const{
...
OAIDeploymentStatus OAIServiceInstance::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIServiceInstance::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIServiceInstance::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIServiceInstance::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIServiceInstance::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIServiceInstance::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIServiceInstance::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIServiceInstance::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIServiceInstance::getEnvironmentName() const {
    return m_environment_name;
}
void OAIServiceInstance::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIServiceInstance::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIServiceInstance::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIServiceInstance::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIServiceInstance::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIServiceInstance::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIServiceInstance::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAIServiceInstance::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAIServiceInstance::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAIServiceInstance::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAIServiceInstance::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAIServiceInstance::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIServiceInstance::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIServiceInstance::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIServiceInstance::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIServiceInstance::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIServiceInstance::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIServiceInstance::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIServiceInstance::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIServiceInstance::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIServiceInstance::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIServiceInstance::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIServiceInstance::is_last_succeeded_deployment_id_Valid() const{
...
QString OAIServiceInstance::getSpec() const {
    return m_spec;
}
void OAIServiceInstance::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIServiceInstance::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIServiceInstance::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIServiceInstance::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIServiceInstance::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIServiceInstance::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIServiceInstance::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIServiceInstance::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIServiceInstance::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIServiceInstance::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIServiceInstance::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIServiceInstance::getTemplateName() const {
    return m_template_name;
}
void OAIServiceInstance::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServiceInstance::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServiceInstance::is_template_name_Valid() const{
