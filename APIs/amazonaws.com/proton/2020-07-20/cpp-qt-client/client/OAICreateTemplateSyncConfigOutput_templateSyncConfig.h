...
/*
 * OAICreateTemplateSyncConfigOutput_templateSyncConfig.h
 *
 * 
 */

#ifndef OAICreateTemplateSyncConfigOutput_templateSyncConfig_H
#define OAICreateTemplateSyncConfigOutput_templateSyncConfig_H
...
class OAICreateTemplateSyncConfigOutput_templateSyncConfig : public OAIObject {
public:
    OAICreateTemplateSyncConfigOutput_templateSyncConfig();
    OAICreateTemplateSyncConfigOutput_templateSyncConfig(QString json);
    ~OAICreateTemplateSyncConfigOutput_templateSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTemplateSyncConfigOutput_templateSyncConfig)

#endif // OAICreateTemplateSyncConfigOutput_templateSyncConfig_H
