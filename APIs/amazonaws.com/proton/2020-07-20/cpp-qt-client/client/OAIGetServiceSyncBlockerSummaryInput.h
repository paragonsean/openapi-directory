...
/*
 * OAIGetServiceSyncBlockerSummaryInput.h
 *
 * 
 */

#ifndef OAIGetServiceSyncBlockerSummaryInput_H
#define OAIGetServiceSyncBlockerSummaryInput_H
...
class OAIGetServiceSyncBlockerSummaryInput : public OAIObject {
public:
    OAIGetServiceSyncBlockerSummaryInput();
    OAIGetServiceSyncBlockerSummaryInput(QString json);
    ~OAIGetServiceSyncBlockerSummaryInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceSyncBlockerSummaryInput)

#endif // OAIGetServiceSyncBlockerSummaryInput_H
