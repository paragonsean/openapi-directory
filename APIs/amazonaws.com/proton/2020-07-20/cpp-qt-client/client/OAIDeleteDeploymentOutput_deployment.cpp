...
#include "OAIDeleteDeploymentOutput_deployment.h"
...
OAIDeleteDeploymentOutput_deployment::OAIDeleteDeploymentOutput_deployment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDeploymentOutput_deployment::OAIDeleteDeploymentOutput_deployment() {
    this->initializeModel();
}

OAIDeleteDeploymentOutput_deployment::~OAIDeleteDeploymentOutput_deployment() {}

void OAIDeleteDeploymentOutput_deployment::initializeModel() {
    ...
    m_target_state_isSet = false;
    m_target_state_isValid = false;
}

void OAIDeleteDeploymentOutput_deployment::fromJson(QString jsonString) {
...
void OAIDeleteDeploymentOutput_deployment::fromJsonObject(QJsonObject json) {
    ...
    m_target_state_isValid = ::OpenAPI::fromJsonValue(m_target_state, json[QString("targetState")]);
    m_target_state_isSet = !json[QString("targetState")].isNull() && m_target_state_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::asJson() const {
...
QJsonObject OAIDeleteDeploymentOutput_deployment::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
    ...
    if (m_target_state.isSet()) {
        obj.insert(QString("targetState"), ::OpenAPI::toJsonValue(m_target_state));
    }
    return obj;
}

QString OAIDeleteDeploymentOutput_deployment::getArn() const {
    return m_arn;
}
void OAIDeleteDeploymentOutput_deployment::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIDeleteDeploymentOutput_deployment::getCompletedAt() const {
    return m_completed_at;
}
void OAIDeleteDeploymentOutput_deployment::setCompletedAt(const QDateTime &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_completed_at_Valid() const{
    return m_completed_at_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getComponentName() const {
    return m_component_name;
}
void OAIDeleteDeploymentOutput_deployment::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QDateTime OAIDeleteDeploymentOutput_deployment::getCreatedAt() const {
    return m_created_at;
}
void OAIDeleteDeploymentOutput_deployment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIDeleteDeploymentOutput_deployment::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIDeleteDeploymentOutput_deployment::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIDeleteDeploymentOutput_deployment::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getEnvironmentName() const {
    return m_environment_name;
}
void OAIDeleteDeploymentOutput_deployment::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getId() const {
    return m_id;
}
void OAIDeleteDeploymentOutput_deployment::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_id_Valid() const{
    return m_id_isValid;
}

OAIDeployment_initialState OAIDeleteDeploymentOutput_deployment::getInitialState() const {
    return m_initial_state;
}
void OAIDeleteDeploymentOutput_deployment::setInitialState(const OAIDeployment_initialState &initial_state) {
    m_initial_state = initial_state;
    m_initial_state_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_initial_state_Set() const{
    return m_initial_state_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_initial_state_Valid() const{
    return m_initial_state_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIDeleteDeploymentOutput_deployment::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIDeleteDeploymentOutput_deployment::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIDeleteDeploymentOutput_deployment::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIDeleteDeploymentOutput_deployment::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIDeleteDeploymentOutput_deployment::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getServiceName() const {
    return m_service_name;
}
void OAIDeleteDeploymentOutput_deployment::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIDeleteDeploymentOutput_deployment::getTargetArn() const {
    return m_target_arn;
}
void OAIDeleteDeploymentOutput_deployment::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QDateTime OAIDeleteDeploymentOutput_deployment::getTargetResourceCreatedAt() const {
    return m_target_resource_created_at;
}
void OAIDeleteDeploymentOutput_deployment::setTargetResourceCreatedAt(const QDateTime &target_resource_created_at) {
    m_target_resource_created_at = target_resource_created_at;
    m_target_resource_created_at_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_resource_created_at_Set() const{
    return m_target_resource_created_at_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_resource_created_at_Valid() const{
    return m_target_resource_created_at_isValid;
}

OAIDeploymentTargetResourceType OAIDeleteDeploymentOutput_deployment::getTargetResourceType() const {
    return m_target_resource_type;
}
void OAIDeleteDeploymentOutput_deployment::setTargetResourceType(const OAIDeploymentTargetResourceType &target_resource_type) {
    m_target_resource_type = target_resource_type;
    m_target_resource_type_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_resource_type_Set() const{
    return m_target_resource_type_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_resource_type_Valid() const{
    return m_target_resource_type_isValid;
}

OAIDeployment_targetState OAIDeleteDeploymentOutput_deployment::getTargetState() const {
    return m_target_state;
}
void OAIDeleteDeploymentOutput_deployment::setTargetState(const OAIDeployment_targetState &target_state) {
    m_target_state = target_state;
    m_target_state_isSet = true;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_state_Set() const{
    return m_target_state_isSet;
}

bool OAIDeleteDeploymentOutput_deployment::is_target_state_Valid() const{
    return m_target_state_isValid;
}

bool OAIDeleteDeploymentOutput_deployment::isSet() const {
...
bool OAIDeleteDeploymentOutput_deployment::isValid() const {
