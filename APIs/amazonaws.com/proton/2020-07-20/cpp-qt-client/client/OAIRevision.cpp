...
QString OAIRevision::getBranch() const {
    return m_branch;
}
void OAIRevision::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAIRevision::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAIRevision::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAIRevision::getDirectory() const {
    return m_directory;
}
void OAIRevision::setDirectory(const QString &directory) {
    m_directory = directory;
    m_directory_isSet = true;
}

bool OAIRevision::is_directory_Set() const{
    return m_directory_isSet;
}

bool OAIRevision::is_directory_Valid() const{
    return m_directory_isValid;
}

QString OAIRevision::getRepositoryName() const {
    return m_repository_name;
}
void OAIRevision::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIRevision::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIRevision::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

OAIRepositoryProvider OAIRevision::getRepositoryProvider() const {
    return m_repository_provider;
}
void OAIRevision::setRepositoryProvider(const OAIRepositoryProvider &repository_provider) {
    m_repository_provider = repository_provider;
    m_repository_provider_isSet = true;
}

bool OAIRevision::is_repository_provider_Set() const{
    return m_repository_provider_isSet;
}

bool OAIRevision::is_repository_provider_Valid() const{
    return m_repository_provider_isValid;
}

QString OAIRevision::getSha() const {
    return m_sha;
}
void OAIRevision::setSha(const QString &sha) {
    m_sha = sha;
    m_sha_isSet = true;
}

bool OAIRevision::is_sha_Set() const{
    return m_sha_isSet;
}

bool OAIRevision::is_sha_Valid() const{
