...
QDateTime OAIComponentSummary::getCreatedAt() const {
    return m_created_at;
}
void OAIComponentSummary::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIComponentSummary::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIComponentSummary::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIComponentSummary::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIComponentSummary::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIComponentSummary::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIComponentSummary::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIComponentSummary::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIComponentSummary::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIComponentSummary::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIComponentSummary::is_deployment_status_message_Valid() const{
...
QString OAIComponentSummary::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIComponentSummary::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIComponentSummary::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIComponentSummary::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIComponentSummary::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIComponentSummary::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIComponentSummary::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIComponentSummary::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIComponentSummary::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIComponentSummary::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIComponentSummary::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIComponentSummary::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QDateTime OAIComponentSummary::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIComponentSummary::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIComponentSummary::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIComponentSummary::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIComponentSummary::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIComponentSummary::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIComponentSummary::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIComponentSummary::is_last_succeeded_deployment_id_Valid() const{
...
QString OAIComponentSummary::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIComponentSummary::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIComponentSummary::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIComponentSummary::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIComponentSummary::getServiceName() const {
    return m_service_name;
}
void OAIComponentSummary::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIComponentSummary::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIComponentSummary::is_service_name_Valid() const{
