...
/*
 * OAICreateServiceSyncConfigOutput_serviceSyncConfig.h
 *
 * 
 */

#ifndef OAICreateServiceSyncConfigOutput_serviceSyncConfig_H
#define OAICreateServiceSyncConfigOutput_serviceSyncConfig_H
...
class OAICreateServiceSyncConfigOutput_serviceSyncConfig : public OAIObject {
public:
    OAICreateServiceSyncConfigOutput_serviceSyncConfig();
    OAICreateServiceSyncConfigOutput_serviceSyncConfig(QString json);
    ~OAICreateServiceSyncConfigOutput_serviceSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceSyncConfigOutput_serviceSyncConfig)

#endif // OAICreateServiceSyncConfigOutput_serviceSyncConfig_H
