...
/*
 * OAIListComponentOutputsInput.h
 *
 * 
 */

#ifndef OAIListComponentOutputsInput_H
#define OAIListComponentOutputsInput_H
...
class OAIListComponentOutputsInput : public OAIObject {
public:
    OAIListComponentOutputsInput();
    OAIListComponentOutputsInput(QString json);
    ~OAIListComponentOutputsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListComponentOutputsInput)

#endif // OAIListComponentOutputsInput_H
