...
/*
 * OAIListServiceInstanceOutputsInput.h
 *
 * 
 */

#ifndef OAIListServiceInstanceOutputsInput_H
#define OAIListServiceInstanceOutputsInput_H
...
class OAIListServiceInstanceOutputsInput : public OAIObject {
public:
    OAIListServiceInstanceOutputsInput();
    OAIListServiceInstanceOutputsInput(QString json);
    ~OAIListServiceInstanceOutputsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListServiceInstanceOutputsInput)

#endif // OAIListServiceInstanceOutputsInput_H
