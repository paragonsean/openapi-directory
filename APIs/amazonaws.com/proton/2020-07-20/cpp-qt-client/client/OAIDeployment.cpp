...
QString OAIDeployment::getArn() const {
    return m_arn;
}
void OAIDeployment::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeployment::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeployment::is_arn_Valid() const{
...
QString OAIDeployment::getComponentName() const {
    return m_component_name;
}
void OAIDeployment::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIDeployment::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIDeployment::is_component_name_Valid() const{
...
QString OAIDeployment::getEnvironmentName() const {
    return m_environment_name;
}
void OAIDeployment::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIDeployment::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIDeployment::is_environment_name_Valid() const{
...
OAIDeployment_initialState OAIDeployment::getInitialState() const {
    return m_initial_state;
}
void OAIDeployment::setInitialState(const OAIDeployment_initialState &initial_state) {
    m_initial_state = initial_state;
    m_initial_state_isSet = true;
}

bool OAIDeployment::is_initial_state_Set() const{
    return m_initial_state_isSet;
}

bool OAIDeployment::is_initial_state_Valid() const{
    return m_initial_state_isValid;
}

QString OAIDeployment::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIDeployment::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIDeployment::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIDeployment::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIDeployment::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIDeployment::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIDeployment::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIDeployment::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIDeployment::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIDeployment::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIDeployment::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIDeployment::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIDeployment::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIDeployment::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIDeployment::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIDeployment::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIDeployment::getServiceName() const {
    return m_service_name;
}
void OAIDeployment::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIDeployment::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIDeployment::is_service_name_Valid() const{
...
QDateTime OAIDeployment::getTargetResourceCreatedAt() const {
    return m_target_resource_created_at;
}
void OAIDeployment::setTargetResourceCreatedAt(const QDateTime &target_resource_created_at) {
    m_target_resource_created_at = target_resource_created_at;
    m_target_resource_created_at_isSet = true;
}

bool OAIDeployment::is_target_resource_created_at_Set() const{
    return m_target_resource_created_at_isSet;
}

bool OAIDeployment::is_target_resource_created_at_Valid() const{
    return m_target_resource_created_at_isValid;
}

OAIDeploymentTargetResourceType OAIDeployment::getTargetResourceType() const {
    return m_target_resource_type;
}
void OAIDeployment::setTargetResourceType(const OAIDeploymentTargetResourceType &target_resource_type) {
    m_target_resource_type = target_resource_type;
    m_target_resource_type_isSet = true;
}

bool OAIDeployment::is_target_resource_type_Set() const{
    return m_target_resource_type_isSet;
}

bool OAIDeployment::is_target_resource_type_Valid() const{
    return m_target_resource_type_isValid;
}

OAIDeployment_targetState OAIDeployment::getTargetState() const {
    return m_target_state;
}
void OAIDeployment::setTargetState(const OAIDeployment_targetState &target_state) {
    m_target_state = target_state;
    m_target_state_isSet = true;
}

bool OAIDeployment::is_target_state_Set() const{
    return m_target_state_isSet;
}

bool OAIDeployment::is_target_state_Valid() const{
