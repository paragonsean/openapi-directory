...
QString OAIGetComponentInput::getName() const {
    return m_name;
}
void OAIGetComponentInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetComponentInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetComponentInput::is_name_Valid() const{
