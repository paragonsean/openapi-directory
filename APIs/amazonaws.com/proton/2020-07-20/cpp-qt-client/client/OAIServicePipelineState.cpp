...
#include "OAIServicePipelineState.h"
...
OAIServicePipelineState::OAIServicePipelineState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServicePipelineState::OAIServicePipelineState() {
    this->initializeModel();
}

OAIServicePipelineState::~OAIServicePipelineState() {}

void OAIServicePipelineState::initializeModel() {
...
void OAIServicePipelineState::fromJson(QString jsonString) {
...
void OAIServicePipelineState::fromJsonObject(QJsonObject json) {
...
QString OAIServicePipelineState::asJson() const {
...
QJsonObject OAIServicePipelineState::asJsonObject() const {
    QJsonObject obj;
    if (m_spec_isSet) {
...
QString OAIServicePipelineState::getSpec() const {
    return m_spec;
}
void OAIServicePipelineState::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIServicePipelineState::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIServicePipelineState::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIServicePipelineState::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIServicePipelineState::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIServicePipelineState::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIServicePipelineState::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIServicePipelineState::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIServicePipelineState::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIServicePipelineState::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIServicePipelineState::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIServicePipelineState::getTemplateName() const {
    return m_template_name;
}
void OAIServicePipelineState::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServicePipelineState::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServicePipelineState::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIServicePipelineState::isSet() const {
...
bool OAIServicePipelineState::isValid() const {
