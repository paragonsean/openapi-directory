...
/*
 * OAIService_pipeline.h
 *
 * 
 */

#ifndef OAIService_pipeline_H
#define OAIService_pipeline_H
...
class OAIService_pipeline : public OAIObject {
public:
    OAIService_pipeline();
    OAIService_pipeline(QString json);
    ~OAIService_pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIService_pipeline)

#endif // OAIService_pipeline_H
