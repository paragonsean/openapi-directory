...
/*
 * OAIUpdateComponentOutput_component.h
 *
 * 
 */

#ifndef OAIUpdateComponentOutput_component_H
#define OAIUpdateComponentOutput_component_H
...
class OAIUpdateComponentOutput_component : public OAIObject {
public:
    OAIUpdateComponentOutput_component();
    OAIUpdateComponentOutput_component(QString json);
    ~OAIUpdateComponentOutput_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateComponentOutput_component)

#endif // OAIUpdateComponentOutput_component_H
