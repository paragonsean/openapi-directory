...
/*
 * OAITemplateSyncConfig.h
 *
 * The detail data for a template sync configuration.
 */

#ifndef OAITemplateSyncConfig_H
#define OAITemplateSyncConfig_H
...
class OAITemplateSyncConfig : public OAIObject {
public:
    OAITemplateSyncConfig();
    OAITemplateSyncConfig(QString json);
    ~OAITemplateSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateSyncConfig)

#endif // OAITemplateSyncConfig_H
