...
/*
 * OAICreateRepositoryOutput_repository.h
 *
 * 
 */

#ifndef OAICreateRepositoryOutput_repository_H
#define OAICreateRepositoryOutput_repository_H
...
class OAICreateRepositoryOutput_repository : public OAIObject {
public:
    OAICreateRepositoryOutput_repository();
    OAICreateRepositoryOutput_repository(QString json);
    ~OAICreateRepositoryOutput_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryOutput_repository)

#endif // OAICreateRepositoryOutput_repository_H
