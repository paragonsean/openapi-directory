...
#include "OAIDeleteEnvironmentOutput_environment.h"
...
OAIDeleteEnvironmentOutput_environment::OAIDeleteEnvironmentOutput_environment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteEnvironmentOutput_environment::OAIDeleteEnvironmentOutput_environment() {
    this->initializeModel();
}

OAIDeleteEnvironmentOutput_environment::~OAIDeleteEnvironmentOutput_environment() {}

void OAIDeleteEnvironmentOutput_environment::initializeModel() {
...
void OAIDeleteEnvironmentOutput_environment::fromJson(QString jsonString) {
...
void OAIDeleteEnvironmentOutput_environment::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteEnvironmentOutput_environment::asJson() const {
...
QJsonObject OAIDeleteEnvironmentOutput_environment::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteEnvironmentOutput_environment::getArn() const {
    return m_arn;
}
void OAIDeleteEnvironmentOutput_environment::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getCodebuildRoleArn() const {
    return m_codebuild_role_arn;
}
void OAIDeleteEnvironmentOutput_environment::setCodebuildRoleArn(const QString &codebuild_role_arn) {
    m_codebuild_role_arn = codebuild_role_arn;
    m_codebuild_role_arn_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_codebuild_role_arn_Set() const{
    return m_codebuild_role_arn_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_codebuild_role_arn_Valid() const{
    return m_codebuild_role_arn_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getComponentRoleArn() const {
    return m_component_role_arn;
}
void OAIDeleteEnvironmentOutput_environment::setComponentRoleArn(const QString &component_role_arn) {
    m_component_role_arn = component_role_arn;
    m_component_role_arn_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_component_role_arn_Set() const{
    return m_component_role_arn_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_component_role_arn_Valid() const{
    return m_component_role_arn_isValid;
}

QDateTime OAIDeleteEnvironmentOutput_environment::getCreatedAt() const {
    return m_created_at;
}
void OAIDeleteEnvironmentOutput_environment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIDeleteEnvironmentOutput_environment::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIDeleteEnvironmentOutput_environment::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIDeleteEnvironmentOutput_environment::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getDescription() const {
    return m_description;
}
void OAIDeleteEnvironmentOutput_environment::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getEnvironmentAccountConnectionId() const {
    return m_environment_account_connection_id;
}
void OAIDeleteEnvironmentOutput_environment::setEnvironmentAccountConnectionId(const QString &environment_account_connection_id) {
    m_environment_account_connection_id = environment_account_connection_id;
    m_environment_account_connection_id_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_environment_account_connection_id_Set() const{
    return m_environment_account_connection_id_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_environment_account_connection_id_Valid() const{
    return m_environment_account_connection_id_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getEnvironmentAccountId() const {
    return m_environment_account_id;
}
void OAIDeleteEnvironmentOutput_environment::setEnvironmentAccountId(const QString &environment_account_id) {
    m_environment_account_id = environment_account_id;
    m_environment_account_id_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_environment_account_id_Set() const{
    return m_environment_account_id_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_environment_account_id_Valid() const{
    return m_environment_account_id_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIDeleteEnvironmentOutput_environment::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIDeleteEnvironmentOutput_environment::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIDeleteEnvironmentOutput_environment::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIDeleteEnvironmentOutput_environment::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIDeleteEnvironmentOutput_environment::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIDeleteEnvironmentOutput_environment::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getName() const {
    return m_name;
}
void OAIDeleteEnvironmentOutput_environment::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getProtonServiceRoleArn() const {
    return m_proton_service_role_arn;
}
void OAIDeleteEnvironmentOutput_environment::setProtonServiceRoleArn(const QString &proton_service_role_arn) {
    m_proton_service_role_arn = proton_service_role_arn;
    m_proton_service_role_arn_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_proton_service_role_arn_Set() const{
    return m_proton_service_role_arn_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_proton_service_role_arn_Valid() const{
    return m_proton_service_role_arn_isValid;
}

OAIProvisioning OAIDeleteEnvironmentOutput_environment::getProvisioning() const {
    return m_provisioning;
}
void OAIDeleteEnvironmentOutput_environment::setProvisioning(const OAIProvisioning &provisioning) {
    m_provisioning = provisioning;
    m_provisioning_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_provisioning_Set() const{
    return m_provisioning_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_provisioning_Valid() const{
    return m_provisioning_isValid;
}

OAIEnvironment_provisioningRepository OAIDeleteEnvironmentOutput_environment::getProvisioningRepository() const {
    return m_provisioning_repository;
}
void OAIDeleteEnvironmentOutput_environment::setProvisioningRepository(const OAIEnvironment_provisioningRepository &provisioning_repository) {
    m_provisioning_repository = provisioning_repository;
    m_provisioning_repository_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_provisioning_repository_Set() const{
    return m_provisioning_repository_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_provisioning_repository_Valid() const{
    return m_provisioning_repository_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getSpec() const {
    return m_spec;
}
void OAIDeleteEnvironmentOutput_environment::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIDeleteEnvironmentOutput_environment::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIDeleteEnvironmentOutput_environment::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIDeleteEnvironmentOutput_environment::getTemplateName() const {
    return m_template_name;
}
void OAIDeleteEnvironmentOutput_environment::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIDeleteEnvironmentOutput_environment::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIDeleteEnvironmentOutput_environment::isSet() const {
...
bool OAIDeleteEnvironmentOutput_environment::isValid() const {
