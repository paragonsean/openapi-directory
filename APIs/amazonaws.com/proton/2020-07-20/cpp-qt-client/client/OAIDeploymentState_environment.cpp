...
OAIDeploymentState_environment::OAIDeploymentState_environment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeploymentState_environment::OAIDeploymentState_environment() {
    this->initializeModel();
}

OAIDeploymentState_environment::~OAIDeploymentState_environment() {}

void OAIDeploymentState_environment::initializeModel() {
...
void OAIDeploymentState_environment::fromJson(QString jsonString) {
...
void OAIDeploymentState_environment::fromJsonObject(QJsonObject json) {
...
QString OAIDeploymentState_environment::asJson() const {
...
QJsonObject OAIDeploymentState_environment::asJsonObject() const {
    QJsonObject obj;
    if (m_spec_isSet) {
...
QString OAIDeploymentState_environment::getSpec() const {
    return m_spec;
}
void OAIDeploymentState_environment::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIDeploymentState_environment::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIDeploymentState_environment::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIDeploymentState_environment::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIDeploymentState_environment::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIDeploymentState_environment::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIDeploymentState_environment::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIDeploymentState_environment::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIDeploymentState_environment::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIDeploymentState_environment::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIDeploymentState_environment::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIDeploymentState_environment::getTemplateName() const {
    return m_template_name;
}
void OAIDeploymentState_environment::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIDeploymentState_environment::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIDeploymentState_environment::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIDeploymentState_environment::isSet() const {
...
bool OAIDeploymentState_environment::isValid() const {
