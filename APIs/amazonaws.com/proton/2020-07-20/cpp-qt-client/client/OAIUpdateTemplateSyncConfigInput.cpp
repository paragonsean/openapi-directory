...
OAIUpdateTemplateSyncConfigInput::OAIUpdateTemplateSyncConfigInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTemplateSyncConfigInput::OAIUpdateTemplateSyncConfigInput() {
    this->initializeModel();
}

OAIUpdateTemplateSyncConfigInput::~OAIUpdateTemplateSyncConfigInput() {}

void OAIUpdateTemplateSyncConfigInput::initializeModel() {
...
void OAIUpdateTemplateSyncConfigInput::fromJson(QString jsonString) {
...
void OAIUpdateTemplateSyncConfigInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTemplateSyncConfigInput::asJson() const {
...
QJsonObject OAIUpdateTemplateSyncConfigInput::asJsonObject() const {
    QJsonObject obj;
    if (m_branch_isSet) {
...
QString OAIUpdateTemplateSyncConfigInput::getBranch() const {
    return m_branch;
}
void OAIUpdateTemplateSyncConfigInput::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAIUpdateTemplateSyncConfigInput::getRepositoryName() const {
    return m_repository_name;
}
void OAIUpdateTemplateSyncConfigInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

OAIRepositoryProvider OAIUpdateTemplateSyncConfigInput::getRepositoryProvider() const {
    return m_repository_provider;
}
void OAIUpdateTemplateSyncConfigInput::setRepositoryProvider(const OAIRepositoryProvider &repository_provider) {
    m_repository_provider = repository_provider;
    m_repository_provider_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_repository_provider_Set() const{
    return m_repository_provider_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_repository_provider_Valid() const{
    return m_repository_provider_isValid;
}

QString OAIUpdateTemplateSyncConfigInput::getSubdirectory() const {
    return m_subdirectory;
}
void OAIUpdateTemplateSyncConfigInput::setSubdirectory(const QString &subdirectory) {
    m_subdirectory = subdirectory;
    m_subdirectory_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_subdirectory_Set() const{
    return m_subdirectory_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_subdirectory_Valid() const{
    return m_subdirectory_isValid;
}

QString OAIUpdateTemplateSyncConfigInput::getTemplateName() const {
    return m_template_name;
}
void OAIUpdateTemplateSyncConfigInput::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_template_name_Valid() const{
    return m_template_name_isValid;
}

OAITemplateType OAIUpdateTemplateSyncConfigInput::getTemplateType() const {
    return m_template_type;
}
void OAIUpdateTemplateSyncConfigInput::setTemplateType(const OAITemplateType &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAIUpdateTemplateSyncConfigInput::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAIUpdateTemplateSyncConfigInput::is_template_type_Valid() const{
    return m_template_type_isValid;
}

bool OAIUpdateTemplateSyncConfigInput::isSet() const {
...
bool OAIUpdateTemplateSyncConfigInput::isValid() const {
