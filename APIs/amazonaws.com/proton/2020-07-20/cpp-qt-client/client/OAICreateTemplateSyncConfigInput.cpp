...
OAICreateTemplateSyncConfigInput::OAICreateTemplateSyncConfigInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTemplateSyncConfigInput::OAICreateTemplateSyncConfigInput() {
    this->initializeModel();
}

OAICreateTemplateSyncConfigInput::~OAICreateTemplateSyncConfigInput() {}

void OAICreateTemplateSyncConfigInput::initializeModel() {
...
void OAICreateTemplateSyncConfigInput::fromJson(QString jsonString) {
...
void OAICreateTemplateSyncConfigInput::fromJsonObject(QJsonObject json) {
...
QString OAICreateTemplateSyncConfigInput::asJson() const {
...
QJsonObject OAICreateTemplateSyncConfigInput::asJsonObject() const {
    QJsonObject obj;
    if (m_branch_isSet) {
...
QString OAICreateTemplateSyncConfigInput::getBranch() const {
    return m_branch;
}
void OAICreateTemplateSyncConfigInput::setBranch(const QString &branch) {
    m_branch = branch;
    m_branch_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_branch_Set() const{
    return m_branch_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_branch_Valid() const{
    return m_branch_isValid;
}

QString OAICreateTemplateSyncConfigInput::getRepositoryName() const {
    return m_repository_name;
}
void OAICreateTemplateSyncConfigInput::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

OAIRepositoryProvider OAICreateTemplateSyncConfigInput::getRepositoryProvider() const {
    return m_repository_provider;
}
void OAICreateTemplateSyncConfigInput::setRepositoryProvider(const OAIRepositoryProvider &repository_provider) {
    m_repository_provider = repository_provider;
    m_repository_provider_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_repository_provider_Set() const{
    return m_repository_provider_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_repository_provider_Valid() const{
    return m_repository_provider_isValid;
}

QString OAICreateTemplateSyncConfigInput::getSubdirectory() const {
    return m_subdirectory;
}
void OAICreateTemplateSyncConfigInput::setSubdirectory(const QString &subdirectory) {
    m_subdirectory = subdirectory;
    m_subdirectory_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_subdirectory_Set() const{
    return m_subdirectory_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_subdirectory_Valid() const{
    return m_subdirectory_isValid;
}

QString OAICreateTemplateSyncConfigInput::getTemplateName() const {
    return m_template_name;
}
void OAICreateTemplateSyncConfigInput::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_template_name_Valid() const{
    return m_template_name_isValid;
}

OAITemplateType OAICreateTemplateSyncConfigInput::getTemplateType() const {
    return m_template_type;
}
void OAICreateTemplateSyncConfigInput::setTemplateType(const OAITemplateType &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAICreateTemplateSyncConfigInput::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAICreateTemplateSyncConfigInput::is_template_type_Valid() const{
    return m_template_type_isValid;
}

bool OAICreateTemplateSyncConfigInput::isSet() const {
...
bool OAICreateTemplateSyncConfigInput::isValid() const {
