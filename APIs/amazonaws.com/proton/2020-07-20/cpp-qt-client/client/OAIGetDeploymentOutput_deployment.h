...
/*
 * OAIGetDeploymentOutput_deployment.h
 *
 * 
 */

#ifndef OAIGetDeploymentOutput_deployment_H
#define OAIGetDeploymentOutput_deployment_H
...
namespace OpenAPI {
class OAIDeployment_initialState;
class OAIDeployment_targetState;

class OAIGetDeploymentOutput_deployment : public OAIObject {
public:
    OAIGetDeploymentOutput_deployment();
    OAIGetDeploymentOutput_deployment(QString json);
    ~OAIGetDeploymentOutput_deployment() override;
    ...
    OAIDeployment_initialState getInitialState() const;
    void setInitialState(const OAIDeployment_initialState &initial_state);
    ...
    QDateTime getTargetResourceCreatedAt() const;
    void setTargetResourceCreatedAt(const QDateTime &target_resource_created_at);
    bool is_target_resource_created_at_Set() const;
    bool is_target_resource_created_at_Valid() const;

    OAIDeploymentTargetResourceType getTargetResourceType() const;
    void setTargetResourceType(const OAIDeploymentTargetResourceType &target_resource_type);
    bool is_target_resource_type_Set() const;
    bool is_target_resource_type_Valid() const;

    OAIDeployment_targetState getTargetState() const;
    void setTargetState(const OAIDeployment_targetState &target_state);
    bool is_target_state_Set() const;
    bool is_target_state_Valid() const;
...
private:
    ...
    OAIDeployment_initialState m_initial_state;
    ...
    QDateTime m_target_resource_created_at;
    bool m_target_resource_created_at_isSet;
    bool m_target_resource_created_at_isValid;

    OAIDeploymentTargetResourceType m_target_resource_type;
    bool m_target_resource_type_isSet;
    bool m_target_resource_type_isValid;

    OAIDeployment_targetState m_target_state;
    bool m_target_state_isSet;
    bool m_target_state_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDeploymentOutput_deployment)

#endif // OAIGetDeploymentOutput_deployment_H
