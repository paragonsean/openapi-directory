...
#include "OAIGetDeploymentOutput_deployment.h"
...
OAIGetDeploymentOutput_deployment::OAIGetDeploymentOutput_deployment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDeploymentOutput_deployment::OAIGetDeploymentOutput_deployment() {
    this->initializeModel();
}

OAIGetDeploymentOutput_deployment::~OAIGetDeploymentOutput_deployment() {}

void OAIGetDeploymentOutput_deployment::initializeModel() {
...
void OAIGetDeploymentOutput_deployment::fromJson(QString jsonString) {
...
void OAIGetDeploymentOutput_deployment::fromJsonObject(QJsonObject json) {
...
QString OAIGetDeploymentOutput_deployment::asJson() const {
...
QJsonObject OAIGetDeploymentOutput_deployment::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetDeploymentOutput_deployment::getArn() const {
    return m_arn;
}
void OAIGetDeploymentOutput_deployment::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIGetDeploymentOutput_deployment::getCompletedAt() const {
    return m_completed_at;
}
void OAIGetDeploymentOutput_deployment::setCompletedAt(const QDateTime &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_completed_at_Valid() const{
    return m_completed_at_isValid;
}

QString OAIGetDeploymentOutput_deployment::getComponentName() const {
    return m_component_name;
}
void OAIGetDeploymentOutput_deployment::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QDateTime OAIGetDeploymentOutput_deployment::getCreatedAt() const {
    return m_created_at;
}
void OAIGetDeploymentOutput_deployment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIGetDeploymentOutput_deployment::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIGetDeploymentOutput_deployment::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIGetDeploymentOutput_deployment::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIGetDeploymentOutput_deployment::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIGetDeploymentOutput_deployment::getEnvironmentName() const {
    return m_environment_name;
}
void OAIGetDeploymentOutput_deployment::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIGetDeploymentOutput_deployment::getId() const {
    return m_id;
}
void OAIGetDeploymentOutput_deployment::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_id_Valid() const{
    return m_id_isValid;
}

OAIDeployment_initialState OAIGetDeploymentOutput_deployment::getInitialState() const {
    return m_initial_state;
}
void OAIGetDeploymentOutput_deployment::setInitialState(const OAIDeployment_initialState &initial_state) {
    m_initial_state = initial_state;
    m_initial_state_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_initial_state_Set() const{
    return m_initial_state_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_initial_state_Valid() const{
    return m_initial_state_isValid;
}

QString OAIGetDeploymentOutput_deployment::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIGetDeploymentOutput_deployment::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIGetDeploymentOutput_deployment::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIGetDeploymentOutput_deployment::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIGetDeploymentOutput_deployment::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIGetDeploymentOutput_deployment::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIGetDeploymentOutput_deployment::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIGetDeploymentOutput_deployment::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIGetDeploymentOutput_deployment::getServiceName() const {
    return m_service_name;
}
void OAIGetDeploymentOutput_deployment::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIGetDeploymentOutput_deployment::getTargetArn() const {
    return m_target_arn;
}
void OAIGetDeploymentOutput_deployment::setTargetArn(const QString &target_arn) {
    m_target_arn = target_arn;
    m_target_arn_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_target_arn_Set() const{
    return m_target_arn_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_target_arn_Valid() const{
    return m_target_arn_isValid;
}

QDateTime OAIGetDeploymentOutput_deployment::getTargetResourceCreatedAt() const {
    return m_target_resource_created_at;
}
void OAIGetDeploymentOutput_deployment::setTargetResourceCreatedAt(const QDateTime &target_resource_created_at) {
    m_target_resource_created_at = target_resource_created_at;
    m_target_resource_created_at_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_target_resource_created_at_Set() const{
    return m_target_resource_created_at_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_target_resource_created_at_Valid() const{
    return m_target_resource_created_at_isValid;
}

OAIDeploymentTargetResourceType OAIGetDeploymentOutput_deployment::getTargetResourceType() const {
    return m_target_resource_type;
}
void OAIGetDeploymentOutput_deployment::setTargetResourceType(const OAIDeploymentTargetResourceType &target_resource_type) {
    m_target_resource_type = target_resource_type;
    m_target_resource_type_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_target_resource_type_Set() const{
    return m_target_resource_type_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_target_resource_type_Valid() const{
    return m_target_resource_type_isValid;
}

OAIDeployment_targetState OAIGetDeploymentOutput_deployment::getTargetState() const {
    return m_target_state;
}
void OAIGetDeploymentOutput_deployment::setTargetState(const OAIDeployment_targetState &target_state) {
    m_target_state = target_state;
    m_target_state_isSet = true;
}

bool OAIGetDeploymentOutput_deployment::is_target_state_Set() const{
    return m_target_state_isSet;
}

bool OAIGetDeploymentOutput_deployment::is_target_state_Valid() const{
    return m_target_state_isValid;
}

bool OAIGetDeploymentOutput_deployment::isSet() const {
...
bool OAIGetDeploymentOutput_deployment::isValid() const {
