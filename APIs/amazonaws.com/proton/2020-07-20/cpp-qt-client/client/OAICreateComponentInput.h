...
/*
 * OAICreateComponentInput.h
 *
 * 
 */

#ifndef OAICreateComponentInput_H
#define OAICreateComponentInput_H
...
class OAICreateComponentInput : public OAIObject {
public:
    OAICreateComponentInput();
    OAICreateComponentInput(QString json);
    ~OAICreateComponentInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateComponentInput)

#endif // OAICreateComponentInput_H
