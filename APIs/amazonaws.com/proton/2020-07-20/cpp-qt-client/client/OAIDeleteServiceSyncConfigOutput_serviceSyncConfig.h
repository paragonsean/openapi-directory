...
/*
 * OAIDeleteServiceSyncConfigOutput_serviceSyncConfig.h
 *
 * 
 */

#ifndef OAIDeleteServiceSyncConfigOutput_serviceSyncConfig_H
#define OAIDeleteServiceSyncConfigOutput_serviceSyncConfig_H
...
class OAIDeleteServiceSyncConfigOutput_serviceSyncConfig : public OAIObject {
public:
    OAIDeleteServiceSyncConfigOutput_serviceSyncConfig();
    OAIDeleteServiceSyncConfigOutput_serviceSyncConfig(QString json);
    ~OAIDeleteServiceSyncConfigOutput_serviceSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteServiceSyncConfigOutput_serviceSyncConfig)

#endif // OAIDeleteServiceSyncConfigOutput_serviceSyncConfig_H
