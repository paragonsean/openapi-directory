...
/*
 * OAIUpdateComponentInput.h
 *
 * 
 */

#ifndef OAIUpdateComponentInput_H
#define OAIUpdateComponentInput_H

#include <QJsonObject>

#include "OAIComponentDeploymentUpdateType.h"
#include <QString>
...
class OAIUpdateComponentInput : public OAIObject {
public:
    OAIUpdateComponentInput();
    OAIUpdateComponentInput(QString json);
    ~OAIUpdateComponentInput() override;
    ...
    OAIComponentDeploymentUpdateType getDeploymentType() const;
    void setDeploymentType(const OAIComponentDeploymentUpdateType &deployment_type);
...
private:
    ...
    OAIComponentDeploymentUpdateType m_deployment_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateComponentInput)

#endif // OAIUpdateComponentInput_H
