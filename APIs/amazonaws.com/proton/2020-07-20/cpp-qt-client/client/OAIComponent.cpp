...
OAIDeploymentStatus OAIComponent::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIComponent::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIComponent::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIComponent::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIComponent::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIComponent::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIComponent::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIComponent::is_deployment_status_message_Valid() const{
...
QString OAIComponent::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIComponent::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIComponent::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIComponent::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAIComponent::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAIComponent::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAIComponent::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAIComponent::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAIComponent::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIComponent::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIComponent::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIComponent::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIComponent::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIComponent::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIComponent::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIComponent::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QDateTime OAIComponent::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIComponent::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIComponent::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIComponent::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIComponent::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIComponent::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIComponent::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIComponent::is_last_succeeded_deployment_id_Valid() const{
...
QString OAIComponent::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIComponent::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIComponent::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIComponent::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIComponent::getServiceName() const {
    return m_service_name;
}
void OAIComponent::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIComponent::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIComponent::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIComponent::getServiceSpec() const {
    return m_service_spec;
}
void OAIComponent::setServiceSpec(const QString &service_spec) {
    m_service_spec = service_spec;
    m_service_spec_isSet = true;
}

bool OAIComponent::is_service_spec_Set() const{
    return m_service_spec_isSet;
}

bool OAIComponent::is_service_spec_Valid() const{
