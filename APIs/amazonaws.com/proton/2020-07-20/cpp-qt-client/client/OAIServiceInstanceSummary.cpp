...
#include "OAIServiceInstanceSummary.h"
...
OAIServiceInstanceSummary::OAIServiceInstanceSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceInstanceSummary::OAIServiceInstanceSummary() {
    this->initializeModel();
}

OAIServiceInstanceSummary::~OAIServiceInstanceSummary() {}

void OAIServiceInstanceSummary::initializeModel() {
...
void OAIServiceInstanceSummary::fromJson(QString jsonString) {
...
void OAIServiceInstanceSummary::fromJsonObject(QJsonObject json) {
...
QString OAIServiceInstanceSummary::asJson() const {
...
QJsonObject OAIServiceInstanceSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIServiceInstanceSummary::getArn() const {
    return m_arn;
}
void OAIServiceInstanceSummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIServiceInstanceSummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIServiceInstanceSummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIServiceInstanceSummary::getCreatedAt() const {
    return m_created_at;
}
void OAIServiceInstanceSummary::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIServiceInstanceSummary::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIServiceInstanceSummary::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIServiceInstanceSummary::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIServiceInstanceSummary::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIServiceInstanceSummary::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIServiceInstanceSummary::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIServiceInstanceSummary::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIServiceInstanceSummary::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIServiceInstanceSummary::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIServiceInstanceSummary::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIServiceInstanceSummary::getEnvironmentName() const {
    return m_environment_name;
}
void OAIServiceInstanceSummary::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIServiceInstanceSummary::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIServiceInstanceSummary::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIServiceInstanceSummary::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIServiceInstanceSummary::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIServiceInstanceSummary::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIServiceInstanceSummary::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIServiceInstanceSummary::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIServiceInstanceSummary::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIServiceInstanceSummary::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIServiceInstanceSummary::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIServiceInstanceSummary::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIServiceInstanceSummary::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIServiceInstanceSummary::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIServiceInstanceSummary::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIServiceInstanceSummary::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIServiceInstanceSummary::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIServiceInstanceSummary::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIServiceInstanceSummary::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIServiceInstanceSummary::getName() const {
    return m_name;
}
void OAIServiceInstanceSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIServiceInstanceSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIServiceInstanceSummary::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIServiceInstanceSummary::getServiceName() const {
    return m_service_name;
}
void OAIServiceInstanceSummary::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIServiceInstanceSummary::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIServiceInstanceSummary::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIServiceInstanceSummary::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIServiceInstanceSummary::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIServiceInstanceSummary::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIServiceInstanceSummary::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIServiceInstanceSummary::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIServiceInstanceSummary::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIServiceInstanceSummary::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIServiceInstanceSummary::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIServiceInstanceSummary::getTemplateName() const {
    return m_template_name;
}
void OAIServiceInstanceSummary::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServiceInstanceSummary::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServiceInstanceSummary::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIServiceInstanceSummary::isSet() const {
...
bool OAIServiceInstanceSummary::isValid() const {
