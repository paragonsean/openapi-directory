...
/*
 * OAIGetTemplateSyncConfigInput.h
 *
 * 
 */

#ifndef OAIGetTemplateSyncConfigInput_H
#define OAIGetTemplateSyncConfigInput_H
...
class OAIGetTemplateSyncConfigInput : public OAIObject {
public:
    OAIGetTemplateSyncConfigInput();
    OAIGetTemplateSyncConfigInput(QString json);
    ~OAIGetTemplateSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTemplateSyncConfigInput)

#endif // OAIGetTemplateSyncConfigInput_H
