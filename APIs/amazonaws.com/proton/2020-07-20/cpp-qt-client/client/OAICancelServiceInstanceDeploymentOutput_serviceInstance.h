...
/*
 * OAICancelServiceInstanceDeploymentOutput_serviceInstance.h
 *
 * 
 */

#ifndef OAICancelServiceInstanceDeploymentOutput_serviceInstance_H
#define OAICancelServiceInstanceDeploymentOutput_serviceInstance_H
...
class OAICancelServiceInstanceDeploymentOutput_serviceInstance : public OAIObject {
public:
    OAICancelServiceInstanceDeploymentOutput_serviceInstance();
    OAICancelServiceInstanceDeploymentOutput_serviceInstance(QString json);
    ~OAICancelServiceInstanceDeploymentOutput_serviceInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelServiceInstanceDeploymentOutput_serviceInstance)

#endif // OAICancelServiceInstanceDeploymentOutput_serviceInstance_H
