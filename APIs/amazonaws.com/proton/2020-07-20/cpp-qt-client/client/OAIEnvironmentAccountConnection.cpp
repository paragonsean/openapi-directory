...
#include "OAIEnvironmentAccountConnection.h"
...
OAIEnvironmentAccountConnection::OAIEnvironmentAccountConnection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnvironmentAccountConnection::OAIEnvironmentAccountConnection() {
    this->initializeModel();
}

OAIEnvironmentAccountConnection::~OAIEnvironmentAccountConnection() {}

void OAIEnvironmentAccountConnection::initializeModel() {
...
void OAIEnvironmentAccountConnection::fromJson(QString jsonString) {
...
void OAIEnvironmentAccountConnection::fromJsonObject(QJsonObject json) {
...
QString OAIEnvironmentAccountConnection::asJson() const {
...
QJsonObject OAIEnvironmentAccountConnection::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIEnvironmentAccountConnection::getArn() const {
    return m_arn;
}
void OAIEnvironmentAccountConnection::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIEnvironmentAccountConnection::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIEnvironmentAccountConnection::getCodebuildRoleArn() const {
    return m_codebuild_role_arn;
}
void OAIEnvironmentAccountConnection::setCodebuildRoleArn(const QString &codebuild_role_arn) {
    m_codebuild_role_arn = codebuild_role_arn;
    m_codebuild_role_arn_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_codebuild_role_arn_Set() const{
    return m_codebuild_role_arn_isSet;
}

bool OAIEnvironmentAccountConnection::is_codebuild_role_arn_Valid() const{
    return m_codebuild_role_arn_isValid;
}

QString OAIEnvironmentAccountConnection::getComponentRoleArn() const {
    return m_component_role_arn;
}
void OAIEnvironmentAccountConnection::setComponentRoleArn(const QString &component_role_arn) {
    m_component_role_arn = component_role_arn;
    m_component_role_arn_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_component_role_arn_Set() const{
    return m_component_role_arn_isSet;
}

bool OAIEnvironmentAccountConnection::is_component_role_arn_Valid() const{
    return m_component_role_arn_isValid;
}

QString OAIEnvironmentAccountConnection::getEnvironmentAccountId() const {
    return m_environment_account_id;
}
void OAIEnvironmentAccountConnection::setEnvironmentAccountId(const QString &environment_account_id) {
    m_environment_account_id = environment_account_id;
    m_environment_account_id_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_environment_account_id_Set() const{
    return m_environment_account_id_isSet;
}

bool OAIEnvironmentAccountConnection::is_environment_account_id_Valid() const{
    return m_environment_account_id_isValid;
}

QString OAIEnvironmentAccountConnection::getEnvironmentName() const {
    return m_environment_name;
}
void OAIEnvironmentAccountConnection::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIEnvironmentAccountConnection::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIEnvironmentAccountConnection::getId() const {
    return m_id;
}
void OAIEnvironmentAccountConnection::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEnvironmentAccountConnection::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIEnvironmentAccountConnection::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIEnvironmentAccountConnection::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIEnvironmentAccountConnection::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIEnvironmentAccountConnection::getManagementAccountId() const {
    return m_management_account_id;
}
void OAIEnvironmentAccountConnection::setManagementAccountId(const QString &management_account_id) {
    m_management_account_id = management_account_id;
    m_management_account_id_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_management_account_id_Set() const{
    return m_management_account_id_isSet;
}

bool OAIEnvironmentAccountConnection::is_management_account_id_Valid() const{
    return m_management_account_id_isValid;
}

QDateTime OAIEnvironmentAccountConnection::getRequestedAt() const {
    return m_requested_at;
}
void OAIEnvironmentAccountConnection::setRequestedAt(const QDateTime &requested_at) {
    m_requested_at = requested_at;
    m_requested_at_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_requested_at_Set() const{
    return m_requested_at_isSet;
}

bool OAIEnvironmentAccountConnection::is_requested_at_Valid() const{
    return m_requested_at_isValid;
}

QString OAIEnvironmentAccountConnection::getRoleArn() const {
    return m_role_arn;
}
void OAIEnvironmentAccountConnection::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIEnvironmentAccountConnection::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

OAIEnvironmentAccountConnectionStatus OAIEnvironmentAccountConnection::getStatus() const {
    return m_status;
}
void OAIEnvironmentAccountConnection::setStatus(const OAIEnvironmentAccountConnectionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEnvironmentAccountConnection::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEnvironmentAccountConnection::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIEnvironmentAccountConnection::isSet() const {
...
bool OAIEnvironmentAccountConnection::isValid() const {
