...
/*
 * OAIServiceInstanceSummary.h
 *
 * Summary data of an Proton service instance resource.
 */

#ifndef OAIServiceInstanceSummary_H
#define OAIServiceInstanceSummary_H
...
class OAIServiceInstanceSummary : public OAIObject {
public:
    OAIServiceInstanceSummary();
    OAIServiceInstanceSummary(QString json);
    ~OAIServiceInstanceSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceInstanceSummary)

#endif // OAIServiceInstanceSummary_H
