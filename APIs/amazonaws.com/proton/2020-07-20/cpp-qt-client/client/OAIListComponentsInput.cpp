...
QString OAIListComponentsInput::getEnvironmentName() const {
    return m_environment_name;
}
void OAIListComponentsInput::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIListComponentsInput::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIListComponentsInput::is_environment_name_Valid() const{
...
QString OAIListComponentsInput::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIListComponentsInput::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIListComponentsInput::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIListComponentsInput::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIListComponentsInput::getServiceName() const {
    return m_service_name;
}
void OAIListComponentsInput::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIListComponentsInput::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIListComponentsInput::is_service_name_Valid() const{
