...
/*
 * OAIUpdateServicePipelineOutput_pipeline.h
 *
 * 
 */

#ifndef OAIUpdateServicePipelineOutput_pipeline_H
#define OAIUpdateServicePipelineOutput_pipeline_H
...
class OAIUpdateServicePipelineOutput_pipeline : public OAIObject {
public:
    OAIUpdateServicePipelineOutput_pipeline();
    OAIUpdateServicePipelineOutput_pipeline(QString json);
    ~OAIUpdateServicePipelineOutput_pipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServicePipelineOutput_pipeline)

#endif // OAIUpdateServicePipelineOutput_pipeline_H
