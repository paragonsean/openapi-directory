...
/*
 * OAIGetServiceInstanceOutput_serviceInstance.h
 *
 * 
 */

#ifndef OAIGetServiceInstanceOutput_serviceInstance_H
#define OAIGetServiceInstanceOutput_serviceInstance_H
...
class OAIGetServiceInstanceOutput_serviceInstance : public OAIObject {
public:
    OAIGetServiceInstanceOutput_serviceInstance();
    OAIGetServiceInstanceOutput_serviceInstance(QString json);
    ~OAIGetServiceInstanceOutput_serviceInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceInstanceOutput_serviceInstance)

#endif // OAIGetServiceInstanceOutput_serviceInstance_H
