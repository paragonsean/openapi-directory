...
/*
 * OAIGetRepositorySyncStatusInput.h
 *
 * 
 */

#ifndef OAIGetRepositorySyncStatusInput_H
#define OAIGetRepositorySyncStatusInput_H
...
class OAIGetRepositorySyncStatusInput : public OAIObject {
public:
    OAIGetRepositorySyncStatusInput();
    OAIGetRepositorySyncStatusInput(QString json);
    ~OAIGetRepositorySyncStatusInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositorySyncStatusInput)

#endif // OAIGetRepositorySyncStatusInput_H
