...
/*
 * OAIGetTemplateSyncStatusOutput_desiredState.h
 *
 * 
 */

#ifndef OAIGetTemplateSyncStatusOutput_desiredState_H
#define OAIGetTemplateSyncStatusOutput_desiredState_H
...
class OAIGetTemplateSyncStatusOutput_desiredState : public OAIObject {
public:
    OAIGetTemplateSyncStatusOutput_desiredState();
    OAIGetTemplateSyncStatusOutput_desiredState(QString json);
    ~OAIGetTemplateSyncStatusOutput_desiredState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTemplateSyncStatusOutput_desiredState)

#endif // OAIGetTemplateSyncStatusOutput_desiredState_H
