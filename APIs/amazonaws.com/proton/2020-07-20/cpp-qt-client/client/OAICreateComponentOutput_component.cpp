...
OAICreateComponentOutput_component::OAICreateComponentOutput_component(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateComponentOutput_component::OAICreateComponentOutput_component() {
    this->initializeModel();
}

OAICreateComponentOutput_component::~OAICreateComponentOutput_component() {}

void OAICreateComponentOutput_component::initializeModel() {
...
void OAICreateComponentOutput_component::fromJson(QString jsonString) {
...
void OAICreateComponentOutput_component::fromJsonObject(QJsonObject json) {
...
QString OAICreateComponentOutput_component::asJson() const {
...
QJsonObject OAICreateComponentOutput_component::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateComponentOutput_component::getArn() const {
    return m_arn;
}
void OAICreateComponentOutput_component::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateComponentOutput_component::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateComponentOutput_component::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAICreateComponentOutput_component::getCreatedAt() const {
    return m_created_at;
}
void OAICreateComponentOutput_component::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreateComponentOutput_component::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreateComponentOutput_component::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAICreateComponentOutput_component::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAICreateComponentOutput_component::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAICreateComponentOutput_component::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAICreateComponentOutput_component::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAICreateComponentOutput_component::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAICreateComponentOutput_component::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAICreateComponentOutput_component::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAICreateComponentOutput_component::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAICreateComponentOutput_component::getDescription() const {
    return m_description;
}
void OAICreateComponentOutput_component::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateComponentOutput_component::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateComponentOutput_component::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateComponentOutput_component::getEnvironmentName() const {
    return m_environment_name;
}
void OAICreateComponentOutput_component::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAICreateComponentOutput_component::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAICreateComponentOutput_component::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAICreateComponentOutput_component::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAICreateComponentOutput_component::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAICreateComponentOutput_component::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAICreateComponentOutput_component::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAICreateComponentOutput_component::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAICreateComponentOutput_component::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAICreateComponentOutput_component::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAICreateComponentOutput_component::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAICreateComponentOutput_component::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAICreateComponentOutput_component::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAICreateComponentOutput_component::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAICreateComponentOutput_component::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QDateTime OAICreateComponentOutput_component::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAICreateComponentOutput_component::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAICreateComponentOutput_component::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAICreateComponentOutput_component::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAICreateComponentOutput_component::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAICreateComponentOutput_component::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAICreateComponentOutput_component::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAICreateComponentOutput_component::getName() const {
    return m_name;
}
void OAICreateComponentOutput_component::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateComponentOutput_component::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateComponentOutput_component::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateComponentOutput_component::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAICreateComponentOutput_component::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAICreateComponentOutput_component::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAICreateComponentOutput_component::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAICreateComponentOutput_component::getServiceName() const {
    return m_service_name;
}
void OAICreateComponentOutput_component::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAICreateComponentOutput_component::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAICreateComponentOutput_component::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAICreateComponentOutput_component::getServiceSpec() const {
    return m_service_spec;
}
void OAICreateComponentOutput_component::setServiceSpec(const QString &service_spec) {
    m_service_spec = service_spec;
    m_service_spec_isSet = true;
}

bool OAICreateComponentOutput_component::is_service_spec_Set() const{
    return m_service_spec_isSet;
}

bool OAICreateComponentOutput_component::is_service_spec_Valid() const{
    return m_service_spec_isValid;
}

bool OAICreateComponentOutput_component::isSet() const {
...
bool OAICreateComponentOutput_component::isValid() const {
