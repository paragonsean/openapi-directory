...
/*
 * OAIListEnvironmentOutputsInput.h
 *
 * 
 */

#ifndef OAIListEnvironmentOutputsInput_H
#define OAIListEnvironmentOutputsInput_H
...
class OAIListEnvironmentOutputsInput : public OAIObject {
public:
    OAIListEnvironmentOutputsInput();
    OAIListEnvironmentOutputsInput(QString json);
    ~OAIListEnvironmentOutputsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnvironmentOutputsInput)

#endif // OAIListEnvironmentOutputsInput_H
