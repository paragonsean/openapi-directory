...
/*
 * OAIDeleteServiceOutput_service.h
 *
 * 
 */

#ifndef OAIDeleteServiceOutput_service_H
#define OAIDeleteServiceOutput_service_H
...
class OAIDeleteServiceOutput_service : public OAIObject {
public:
    OAIDeleteServiceOutput_service();
    OAIDeleteServiceOutput_service(QString json);
    ~OAIDeleteServiceOutput_service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteServiceOutput_service)

#endif // OAIDeleteServiceOutput_service_H
