...
#include "OAIServiceTemplateVersion.h"
...
OAIServiceTemplateVersion::OAIServiceTemplateVersion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServiceTemplateVersion::OAIServiceTemplateVersion() {
    this->initializeModel();
}

OAIServiceTemplateVersion::~OAIServiceTemplateVersion() {}

void OAIServiceTemplateVersion::initializeModel() {
...
void OAIServiceTemplateVersion::fromJson(QString jsonString) {
...
void OAIServiceTemplateVersion::fromJsonObject(QJsonObject json) {
...
QString OAIServiceTemplateVersion::asJson() const {
...
QJsonObject OAIServiceTemplateVersion::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIServiceTemplateVersion::getArn() const {
    return m_arn;
}
void OAIServiceTemplateVersion::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIServiceTemplateVersion::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIServiceTemplateVersion::is_arn_Valid() const{
    return m_arn_isValid;
}

QList OAIServiceTemplateVersion::getCompatibleEnvironmentTemplates() const {
    return m_compatible_environment_templates;
}
void OAIServiceTemplateVersion::setCompatibleEnvironmentTemplates(const QList &compatible_environment_templates) {
    m_compatible_environment_templates = compatible_environment_templates;
    m_compatible_environment_templates_isSet = true;
}

bool OAIServiceTemplateVersion::is_compatible_environment_templates_Set() const{
    return m_compatible_environment_templates_isSet;
}

bool OAIServiceTemplateVersion::is_compatible_environment_templates_Valid() const{
    return m_compatible_environment_templates_isValid;
}

QDateTime OAIServiceTemplateVersion::getCreatedAt() const {
    return m_created_at;
}
void OAIServiceTemplateVersion::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIServiceTemplateVersion::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIServiceTemplateVersion::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIServiceTemplateVersion::getDescription() const {
    return m_description;
}
void OAIServiceTemplateVersion::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIServiceTemplateVersion::is_description_Set() const{
    return m_description_isSet;
}

bool OAIServiceTemplateVersion::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIServiceTemplateVersion::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIServiceTemplateVersion::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIServiceTemplateVersion::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIServiceTemplateVersion::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIServiceTemplateVersion::getMajorVersion() const {
    return m_major_version;
}
void OAIServiceTemplateVersion::setMajorVersion(const QString &major_version) {
    m_major_version = major_version;
    m_major_version_isSet = true;
}

bool OAIServiceTemplateVersion::is_major_version_Set() const{
    return m_major_version_isSet;
}

bool OAIServiceTemplateVersion::is_major_version_Valid() const{
    return m_major_version_isValid;
}

QString OAIServiceTemplateVersion::getMinorVersion() const {
    return m_minor_version;
}
void OAIServiceTemplateVersion::setMinorVersion(const QString &minor_version) {
    m_minor_version = minor_version;
    m_minor_version_isSet = true;
}

bool OAIServiceTemplateVersion::is_minor_version_Set() const{
    return m_minor_version_isSet;
}

bool OAIServiceTemplateVersion::is_minor_version_Valid() const{
    return m_minor_version_isValid;
}

QString OAIServiceTemplateVersion::getRecommendedMinorVersion() const {
    return m_recommended_minor_version;
}
void OAIServiceTemplateVersion::setRecommendedMinorVersion(const QString &recommended_minor_version) {
    m_recommended_minor_version = recommended_minor_version;
    m_recommended_minor_version_isSet = true;
}

bool OAIServiceTemplateVersion::is_recommended_minor_version_Set() const{
    return m_recommended_minor_version_isSet;
}

bool OAIServiceTemplateVersion::is_recommended_minor_version_Valid() const{
    return m_recommended_minor_version_isValid;
}

QString OAIServiceTemplateVersion::getSchema() const {
    return m_schema;
}
void OAIServiceTemplateVersion::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAIServiceTemplateVersion::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAIServiceTemplateVersion::is_schema_Valid() const{
    return m_schema_isValid;
}

OAITemplateVersionStatus OAIServiceTemplateVersion::getStatus() const {
    return m_status;
}
void OAIServiceTemplateVersion::setStatus(const OAITemplateVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIServiceTemplateVersion::is_status_Set() const{
    return m_status_isSet;
}

bool OAIServiceTemplateVersion::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIServiceTemplateVersion::getStatusMessage() const {
    return m_status_message;
}
void OAIServiceTemplateVersion::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIServiceTemplateVersion::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIServiceTemplateVersion::is_status_message_Valid() const{
    return m_status_message_isValid;
}

QList OAIServiceTemplateVersion::getSupportedComponentSources() const {
    return m_supported_component_sources;
}
void OAIServiceTemplateVersion::setSupportedComponentSources(const QList &supported_component_sources) {
    m_supported_component_sources = supported_component_sources;
    m_supported_component_sources_isSet = true;
}

bool OAIServiceTemplateVersion::is_supported_component_sources_Set() const{
    return m_supported_component_sources_isSet;
}

bool OAIServiceTemplateVersion::is_supported_component_sources_Valid() const{
    return m_supported_component_sources_isValid;
}

QString OAIServiceTemplateVersion::getTemplateName() const {
    return m_template_name;
}
void OAIServiceTemplateVersion::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServiceTemplateVersion::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServiceTemplateVersion::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIServiceTemplateVersion::isSet() const {
...
bool OAIServiceTemplateVersion::isValid() const {
