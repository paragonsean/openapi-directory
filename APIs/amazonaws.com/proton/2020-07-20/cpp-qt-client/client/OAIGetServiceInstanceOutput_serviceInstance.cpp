...
#include "OAIGetServiceInstanceOutput_serviceInstance.h"
...
OAIGetServiceInstanceOutput_serviceInstance::OAIGetServiceInstanceOutput_serviceInstance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetServiceInstanceOutput_serviceInstance::OAIGetServiceInstanceOutput_serviceInstance() {
    this->initializeModel();
}

OAIGetServiceInstanceOutput_serviceInstance::~OAIGetServiceInstanceOutput_serviceInstance() {}

void OAIGetServiceInstanceOutput_serviceInstance::initializeModel() {
...
void OAIGetServiceInstanceOutput_serviceInstance::fromJson(QString jsonString) {
...
void OAIGetServiceInstanceOutput_serviceInstance::fromJsonObject(QJsonObject json) {
...
QString OAIGetServiceInstanceOutput_serviceInstance::asJson() const {
...
QJsonObject OAIGetServiceInstanceOutput_serviceInstance::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIGetServiceInstanceOutput_serviceInstance::getArn() const {
    return m_arn;
}
void OAIGetServiceInstanceOutput_serviceInstance::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIGetServiceInstanceOutput_serviceInstance::getCreatedAt() const {
    return m_created_at;
}
void OAIGetServiceInstanceOutput_serviceInstance::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIGetServiceInstanceOutput_serviceInstance::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIGetServiceInstanceOutput_serviceInstance::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIGetServiceInstanceOutput_serviceInstance::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getEnvironmentName() const {
    return m_environment_name;
}
void OAIGetServiceInstanceOutput_serviceInstance::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIGetServiceInstanceOutput_serviceInstance::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAIGetServiceInstanceOutput_serviceInstance::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAIGetServiceInstanceOutput_serviceInstance::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIGetServiceInstanceOutput_serviceInstance::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIGetServiceInstanceOutput_serviceInstance::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIGetServiceInstanceOutput_serviceInstance::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIGetServiceInstanceOutput_serviceInstance::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getName() const {
    return m_name;
}
void OAIGetServiceInstanceOutput_serviceInstance::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getServiceName() const {
    return m_service_name;
}
void OAIGetServiceInstanceOutput_serviceInstance::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getSpec() const {
    return m_spec;
}
void OAIGetServiceInstanceOutput_serviceInstance::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIGetServiceInstanceOutput_serviceInstance::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIGetServiceInstanceOutput_serviceInstance::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIGetServiceInstanceOutput_serviceInstance::getTemplateName() const {
    return m_template_name;
}
void OAIGetServiceInstanceOutput_serviceInstance::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIGetServiceInstanceOutput_serviceInstance::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIGetServiceInstanceOutput_serviceInstance::isSet() const {
...
bool OAIGetServiceInstanceOutput_serviceInstance::isValid() const {
