...
OAIServicePipeline::OAIServicePipeline(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServicePipeline::OAIServicePipeline() {
    this->initializeModel();
}

OAIServicePipeline::~OAIServicePipeline() {}

void OAIServicePipeline::initializeModel() {
...
void OAIServicePipeline::fromJson(QString jsonString) {
...
void OAIServicePipeline::fromJsonObject(QJsonObject json) {
...
QString OAIServicePipeline::asJson() const {
...
QJsonObject OAIServicePipeline::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIServicePipeline::getArn() const {
    return m_arn;
}
void OAIServicePipeline::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIServicePipeline::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIServicePipeline::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIServicePipeline::getCreatedAt() const {
    return m_created_at;
}
void OAIServicePipeline::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIServicePipeline::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIServicePipeline::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIServicePipeline::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIServicePipeline::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIServicePipeline::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIServicePipeline::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIServicePipeline::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIServicePipeline::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIServicePipeline::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIServicePipeline::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIServicePipeline::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIServicePipeline::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIServicePipeline::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIServicePipeline::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIServicePipeline::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIServicePipeline::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIServicePipeline::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIServicePipeline::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIServicePipeline::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIServicePipeline::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIServicePipeline::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIServicePipeline::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIServicePipeline::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIServicePipeline::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIServicePipeline::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIServicePipeline::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIServicePipeline::getSpec() const {
    return m_spec;
}
void OAIServicePipeline::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIServicePipeline::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIServicePipeline::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIServicePipeline::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIServicePipeline::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIServicePipeline::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIServicePipeline::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIServicePipeline::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIServicePipeline::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIServicePipeline::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIServicePipeline::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIServicePipeline::getTemplateName() const {
    return m_template_name;
}
void OAIServicePipeline::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIServicePipeline::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIServicePipeline::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAIServicePipeline::isSet() const {
...
bool OAIServicePipeline::isValid() const {
