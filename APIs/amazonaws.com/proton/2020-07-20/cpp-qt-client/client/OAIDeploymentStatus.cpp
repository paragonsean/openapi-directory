...
QString OAIDeploymentStatus::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIDeploymentStatus::SUCCEEDED:
            val = "SUCCEEDED";
            break;
        case eOAIDeploymentStatus::DELETE_IN_PROGRESS:
            val = "DELETE_IN_PROGRESS";
            break;
        case eOAIDeploymentStatus::DELETE_FAILED:
            val = "DELETE_FAILED";
            break;
        case eOAIDeploymentStatus::DELETE_COMPLETE:
            val = "DELETE_COMPLETE";
            break;
        case eOAIDeploymentStatus::CANCELLING:
            val = "CANCELLING";
            break;
        case eOAIDeploymentStatus::CANCELLED:
            val = "CANCELLED";
            break;
        default:
            break;
