...
/*
 * OAIGetServiceInstanceSyncStatusOutput_desiredState.h
 *
 * 
 */

#ifndef OAIGetServiceInstanceSyncStatusOutput_desiredState_H
#define OAIGetServiceInstanceSyncStatusOutput_desiredState_H
...
class OAIGetServiceInstanceSyncStatusOutput_desiredState : public OAIObject {
public:
    OAIGetServiceInstanceSyncStatusOutput_desiredState();
    OAIGetServiceInstanceSyncStatusOutput_desiredState(QString json);
    ~OAIGetServiceInstanceSyncStatusOutput_desiredState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceInstanceSyncStatusOutput_desiredState)

#endif // OAIGetServiceInstanceSyncStatusOutput_desiredState_H
