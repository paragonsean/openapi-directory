...
/*
 * OAIGetResourcesSummaryOutput_counts.h
 *
 * 
 */

#ifndef OAIGetResourcesSummaryOutput_counts_H
#define OAIGetResourcesSummaryOutput_counts_H
...
class OAIGetResourcesSummaryOutput_counts : public OAIObject {
public:
    OAIGetResourcesSummaryOutput_counts();
    OAIGetResourcesSummaryOutput_counts(QString json);
    ~OAIGetResourcesSummaryOutput_counts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourcesSummaryOutput_counts)

#endif // OAIGetResourcesSummaryOutput_counts_H
