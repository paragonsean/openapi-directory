...
/*
 * OAIGetDeploymentInput.h
 *
 * 
 */

#ifndef OAIGetDeploymentInput_H
#define OAIGetDeploymentInput_H
...
class OAIGetDeploymentInput : public OAIObject {
public:
    OAIGetDeploymentInput();
    OAIGetDeploymentInput(QString json);
    ~OAIGetDeploymentInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDeploymentInput)

#endif // OAIGetDeploymentInput_H
