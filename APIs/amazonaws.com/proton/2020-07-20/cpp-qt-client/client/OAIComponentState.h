...
#ifndef OAIComponentState_H
#define OAIComponentState_H
...
class OAIComponentState : public OAIObject {
public:
    OAIComponentState();
    OAIComponentState(QString json);
    ~OAIComponentState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentState)

#endif // OAIComponentState_H
