...
/*
 * OAIDeploymentState_component.h
 *
 * 
 */

#ifndef OAIDeploymentState_component_H
#define OAIDeploymentState_component_H
...
class OAIDeploymentState_component : public OAIObject {
public:
    OAIDeploymentState_component();
    OAIDeploymentState_component(QString json);
    ~OAIDeploymentState_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentState_component)

#endif // OAIDeploymentState_component_H
