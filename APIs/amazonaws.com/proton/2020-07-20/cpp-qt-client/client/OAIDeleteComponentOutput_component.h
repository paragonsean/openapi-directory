...
/*
 * OAIDeleteComponentOutput_component.h
 *
 * 
 */

#ifndef OAIDeleteComponentOutput_component_H
#define OAIDeleteComponentOutput_component_H
...
class OAIDeleteComponentOutput_component : public OAIObject {
public:
    OAIDeleteComponentOutput_component();
    OAIDeleteComponentOutput_component(QString json);
    ~OAIDeleteComponentOutput_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteComponentOutput_component)

#endif // OAIDeleteComponentOutput_component_H
