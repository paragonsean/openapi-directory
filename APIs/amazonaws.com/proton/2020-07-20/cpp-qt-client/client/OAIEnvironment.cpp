...
QString OAIEnvironment::getCodebuildRoleArn() const {
    return m_codebuild_role_arn;
}
void OAIEnvironment::setCodebuildRoleArn(const QString &codebuild_role_arn) {
    m_codebuild_role_arn = codebuild_role_arn;
    m_codebuild_role_arn_isSet = true;
}

bool OAIEnvironment::is_codebuild_role_arn_Set() const{
    return m_codebuild_role_arn_isSet;
}

bool OAIEnvironment::is_codebuild_role_arn_Valid() const{
    return m_codebuild_role_arn_isValid;
}

QString OAIEnvironment::getComponentRoleArn() const {
    return m_component_role_arn;
}
void OAIEnvironment::setComponentRoleArn(const QString &component_role_arn) {
    m_component_role_arn = component_role_arn;
    m_component_role_arn_isSet = true;
}

bool OAIEnvironment::is_component_role_arn_Set() const{
    return m_component_role_arn_isSet;
}

bool OAIEnvironment::is_component_role_arn_Valid() const{
...
OAIDeploymentStatus OAIEnvironment::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIEnvironment::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIEnvironment::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIEnvironment::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIEnvironment::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIEnvironment::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIEnvironment::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIEnvironment::is_deployment_status_message_Valid() const{
...
QString OAIEnvironment::getEnvironmentAccountConnectionId() const {
    return m_environment_account_connection_id;
}
void OAIEnvironment::setEnvironmentAccountConnectionId(const QString &environment_account_connection_id) {
    m_environment_account_connection_id = environment_account_connection_id;
    m_environment_account_connection_id_isSet = true;
}

bool OAIEnvironment::is_environment_account_connection_id_Set() const{
    return m_environment_account_connection_id_isSet;
}

bool OAIEnvironment::is_environment_account_connection_id_Valid() const{
    return m_environment_account_connection_id_isValid;
}

QString OAIEnvironment::getEnvironmentAccountId() const {
    return m_environment_account_id;
}
void OAIEnvironment::setEnvironmentAccountId(const QString &environment_account_id) {
    m_environment_account_id = environment_account_id;
    m_environment_account_id_isSet = true;
}

bool OAIEnvironment::is_environment_account_id_Set() const{
    return m_environment_account_id_isSet;
}

bool OAIEnvironment::is_environment_account_id_Valid() const{
    return m_environment_account_id_isValid;
}

QString OAIEnvironment::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIEnvironment::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIEnvironment::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIEnvironment::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAIEnvironment::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIEnvironment::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIEnvironment::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIEnvironment::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIEnvironment::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIEnvironment::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIEnvironment::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIEnvironment::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAIEnvironment::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIEnvironment::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIEnvironment::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIEnvironment::is_last_succeeded_deployment_id_Valid() const{
...
QString OAIEnvironment::getProtonServiceRoleArn() const {
    return m_proton_service_role_arn;
}
void OAIEnvironment::setProtonServiceRoleArn(const QString &proton_service_role_arn) {
    m_proton_service_role_arn = proton_service_role_arn;
    m_proton_service_role_arn_isSet = true;
}

bool OAIEnvironment::is_proton_service_role_arn_Set() const{
    return m_proton_service_role_arn_isSet;
}

bool OAIEnvironment::is_proton_service_role_arn_Valid() const{
    return m_proton_service_role_arn_isValid;
}

OAIProvisioning OAIEnvironment::getProvisioning() const {
    return m_provisioning;
}
void OAIEnvironment::setProvisioning(const OAIProvisioning &provisioning) {
    m_provisioning = provisioning;
    m_provisioning_isSet = true;
}

bool OAIEnvironment::is_provisioning_Set() const{
    return m_provisioning_isSet;
}

bool OAIEnvironment::is_provisioning_Valid() const{
    return m_provisioning_isValid;
}

OAIEnvironment_provisioningRepository OAIEnvironment::getProvisioningRepository() const {
    return m_provisioning_repository;
}
void OAIEnvironment::setProvisioningRepository(const OAIEnvironment_provisioningRepository &provisioning_repository) {
    m_provisioning_repository = provisioning_repository;
    m_provisioning_repository_isSet = true;
}

bool OAIEnvironment::is_provisioning_repository_Set() const{
    return m_provisioning_repository_isSet;
}

bool OAIEnvironment::is_provisioning_repository_Valid() const{
    return m_provisioning_repository_isValid;
}

QString OAIEnvironment::getSpec() const {
    return m_spec;
}
void OAIEnvironment::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIEnvironment::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIEnvironment::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIEnvironment::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIEnvironment::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIEnvironment::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIEnvironment::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIEnvironment::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIEnvironment::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIEnvironment::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIEnvironment::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIEnvironment::getTemplateName() const {
    return m_template_name;
}
void OAIEnvironment::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIEnvironment::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIEnvironment::is_template_name_Valid() const{
