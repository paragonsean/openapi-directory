...
/*
 * OAICreateComponentOutput_component.h
 *
 * 
 */

#ifndef OAICreateComponentOutput_component_H
#define OAICreateComponentOutput_component_H
...
class OAICreateComponentOutput_component : public OAIObject {
public:
    OAICreateComponentOutput_component();
    OAICreateComponentOutput_component(QString json);
    ~OAICreateComponentOutput_component() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateComponentOutput_component)

#endif // OAICreateComponentOutput_component_H
