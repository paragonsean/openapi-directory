...
/*
 * OAIDeleteRepositoryOutput_repository.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryOutput_repository_H
#define OAIDeleteRepositoryOutput_repository_H
...
class OAIDeleteRepositoryOutput_repository : public OAIObject {
public:
    OAIDeleteRepositoryOutput_repository();
    OAIDeleteRepositoryOutput_repository(QString json);
    ~OAIDeleteRepositoryOutput_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryOutput_repository)

#endif // OAIDeleteRepositoryOutput_repository_H
