...
OAIComponentState::OAIComponentState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComponentState::OAIComponentState() {
    this->initializeModel();
}

OAIComponentState::~OAIComponentState() {}

void OAIComponentState::initializeModel() {
...
void OAIComponentState::fromJson(QString jsonString) {
...
void OAIComponentState::fromJsonObject(QJsonObject json) {
...
QString OAIComponentState::asJson() const {
...
QJsonObject OAIComponentState::asJsonObject() const {
    QJsonObject obj;
...
QString OAIComponentState::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIComponentState::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIComponentState::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIComponentState::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIComponentState::getServiceName() const {
    return m_service_name;
}
void OAIComponentState::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIComponentState::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIComponentState::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIComponentState::getServiceSpec() const {
    return m_service_spec;
}
void OAIComponentState::setServiceSpec(const QString &service_spec) {
    m_service_spec = service_spec;
    m_service_spec_isSet = true;
}

bool OAIComponentState::is_service_spec_Set() const{
    return m_service_spec_isSet;
}

bool OAIComponentState::is_service_spec_Valid() const{
    return m_service_spec_isValid;
}

QString OAIComponentState::getTemplateFile() const {
    return m_template_file;
}
void OAIComponentState::setTemplateFile(const QString &template_file) {
    m_template_file = template_file;
    m_template_file_isSet = true;
}

bool OAIComponentState::is_template_file_Set() const{
    return m_template_file_isSet;
}

bool OAIComponentState::is_template_file_Valid() const{
    return m_template_file_isValid;
}

bool OAIComponentState::isSet() const {
...
bool OAIComponentState::isValid() const {
