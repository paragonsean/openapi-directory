...
/*
 * OAIResourceSyncAttempt_initialRevision.h
 *
 * 
 */

#ifndef OAIResourceSyncAttempt_initialRevision_H
#define OAIResourceSyncAttempt_initialRevision_H
...
class OAIResourceSyncAttempt_initialRevision : public OAIObject {
public:
    OAIResourceSyncAttempt_initialRevision();
    OAIResourceSyncAttempt_initialRevision(QString json);
    ~OAIResourceSyncAttempt_initialRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceSyncAttempt_initialRevision)

#endif // OAIResourceSyncAttempt_initialRevision_H
