...
/*
 * OAIListServiceInstancesInput.h
 *
 * 
 */

#ifndef OAIListServiceInstancesInput_H
#define OAIListServiceInstancesInput_H
...
class OAIListServiceInstancesInput : public OAIObject {
public:
    OAIListServiceInstancesInput();
    OAIListServiceInstancesInput(QString json);
    ~OAIListServiceInstancesInput() override;
    ...
    OAIListServiceInstancesSortBy getSortBy() const;
    void setSortBy(const OAIListServiceInstancesSortBy &sort_by);
...
private:
    ...
    OAIListServiceInstancesSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListServiceInstancesInput)

#endif // OAIListServiceInstancesInput_H
