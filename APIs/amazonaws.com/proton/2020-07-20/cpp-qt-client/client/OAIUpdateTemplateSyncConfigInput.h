...
/*
 * OAIUpdateTemplateSyncConfigInput.h
 *
 * 
 */

#ifndef OAIUpdateTemplateSyncConfigInput_H
#define OAIUpdateTemplateSyncConfigInput_H
...
class OAIUpdateTemplateSyncConfigInput : public OAIObject {
public:
    OAIUpdateTemplateSyncConfigInput();
    OAIUpdateTemplateSyncConfigInput(QString json);
    ~OAIUpdateTemplateSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTemplateSyncConfigInput)

#endif // OAIUpdateTemplateSyncConfigInput_H
