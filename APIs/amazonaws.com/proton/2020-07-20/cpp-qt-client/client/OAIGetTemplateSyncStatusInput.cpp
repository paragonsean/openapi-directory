...
OAIGetTemplateSyncStatusInput::OAIGetTemplateSyncStatusInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTemplateSyncStatusInput::OAIGetTemplateSyncStatusInput() {
    this->initializeModel();
}

OAIGetTemplateSyncStatusInput::~OAIGetTemplateSyncStatusInput() {}

void OAIGetTemplateSyncStatusInput::initializeModel() {
...
void OAIGetTemplateSyncStatusInput::fromJson(QString jsonString) {
...
void OAIGetTemplateSyncStatusInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetTemplateSyncStatusInput::asJson() const {
...
QJsonObject OAIGetTemplateSyncStatusInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetTemplateSyncStatusInput::getTemplateName() const {
    return m_template_name;
}
void OAIGetTemplateSyncStatusInput::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIGetTemplateSyncStatusInput::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIGetTemplateSyncStatusInput::is_template_name_Valid() const{
    return m_template_name_isValid;
}

OAITemplateType OAIGetTemplateSyncStatusInput::getTemplateType() const {
    return m_template_type;
}
void OAIGetTemplateSyncStatusInput::setTemplateType(const OAITemplateType &template_type) {
    m_template_type = template_type;
    m_template_type_isSet = true;
}

bool OAIGetTemplateSyncStatusInput::is_template_type_Set() const{
    return m_template_type_isSet;
}

bool OAIGetTemplateSyncStatusInput::is_template_type_Valid() const{
    return m_template_type_isValid;
}

QString OAIGetTemplateSyncStatusInput::getTemplateVersion() const {
    return m_template_version;
}
void OAIGetTemplateSyncStatusInput::setTemplateVersion(const QString &template_version) {
    m_template_version = template_version;
    m_template_version_isSet = true;
}

bool OAIGetTemplateSyncStatusInput::is_template_version_Set() const{
    return m_template_version_isSet;
}

bool OAIGetTemplateSyncStatusInput::is_template_version_Valid() const{
    return m_template_version_isValid;
}

bool OAIGetTemplateSyncStatusInput::isSet() const {
...
bool OAIGetTemplateSyncStatusInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_template_name_isValid && m_template_type_isValid && m_template_version_isValid && true;
}
