...
/*
 * OAIResourceSyncAttempt_targetRevision.h
 *
 * 
 */

#ifndef OAIResourceSyncAttempt_targetRevision_H
#define OAIResourceSyncAttempt_targetRevision_H
...
class OAIResourceSyncAttempt_targetRevision : public OAIObject {
public:
    OAIResourceSyncAttempt_targetRevision();
    OAIResourceSyncAttempt_targetRevision(QString json);
    ~OAIResourceSyncAttempt_targetRevision() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceSyncAttempt_targetRevision)

#endif // OAIResourceSyncAttempt_targetRevision_H
