...
QString OAIService::getArn() const {
    return m_arn;
}
void OAIService::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIService::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIService::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIService::getBranchName() const {
    return m_branch_name;
}
void OAIService::setBranchName(const QString &branch_name) {
    m_branch_name = branch_name;
    m_branch_name_isSet = true;
}

bool OAIService::is_branch_name_Set() const{
    return m_branch_name_isSet;
}

bool OAIService::is_branch_name_Valid() const{
    return m_branch_name_isValid;
}

QDateTime OAIService::getCreatedAt() const {
    return m_created_at;
}
void OAIService::setCreatedAt(const QDateTime &created_at) {
...
QDateTime OAIService::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIService::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIService::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIService::is_last_modified_at_Valid() const{
...
OAIService_pipeline OAIService::getPipeline() const {
    return m_pipeline;
}
void OAIService::setPipeline(const OAIService_pipeline &pipeline) {
    m_pipeline = pipeline;
    m_pipeline_isSet = true;
}

bool OAIService::is_pipeline_Set() const{
    return m_pipeline_isSet;
}

bool OAIService::is_pipeline_Valid() const{
    return m_pipeline_isValid;
}

QString OAIService::getRepositoryConnectionArn() const {
    return m_repository_connection_arn;
}
void OAIService::setRepositoryConnectionArn(const QString &repository_connection_arn) {
    m_repository_connection_arn = repository_connection_arn;
    m_repository_connection_arn_isSet = true;
}

bool OAIService::is_repository_connection_arn_Set() const{
    return m_repository_connection_arn_isSet;
}

bool OAIService::is_repository_connection_arn_Valid() const{
    return m_repository_connection_arn_isValid;
}

QString OAIService::getRepositoryId() const {
    return m_repository_id;
}
void OAIService::setRepositoryId(const QString &repository_id) {
    m_repository_id = repository_id;
    m_repository_id_isSet = true;
}

bool OAIService::is_repository_id_Set() const{
    return m_repository_id_isSet;
}

bool OAIService::is_repository_id_Valid() const{
    return m_repository_id_isValid;
}

QString OAIService::getSpec() const {
    return m_spec;
}
void OAIService::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}
...
QString OAIService::getTemplateName() const {
    return m_template_name;
}
void OAIService::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIService::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIService::is_template_name_Valid() const{
