...
OAIDeleteComponentOutput_component::OAIDeleteComponentOutput_component(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteComponentOutput_component::OAIDeleteComponentOutput_component() {
    this->initializeModel();
}

OAIDeleteComponentOutput_component::~OAIDeleteComponentOutput_component() {}

void OAIDeleteComponentOutput_component::initializeModel() {
...
void OAIDeleteComponentOutput_component::fromJson(QString jsonString) {
...
void OAIDeleteComponentOutput_component::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteComponentOutput_component::asJson() const {
...
QJsonObject OAIDeleteComponentOutput_component::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIDeleteComponentOutput_component::getArn() const {
    return m_arn;
}
void OAIDeleteComponentOutput_component::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteComponentOutput_component::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIDeleteComponentOutput_component::getCreatedAt() const {
    return m_created_at;
}
void OAIDeleteComponentOutput_component::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDeleteComponentOutput_component::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAIDeleteComponentOutput_component::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAIDeleteComponentOutput_component::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAIDeleteComponentOutput_component::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAIDeleteComponentOutput_component::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIDeleteComponentOutput_component::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIDeleteComponentOutput_component::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIDeleteComponentOutput_component::getDescription() const {
    return m_description;
}
void OAIDeleteComponentOutput_component::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDeleteComponentOutput_component::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDeleteComponentOutput_component::getEnvironmentName() const {
    return m_environment_name;
}
void OAIDeleteComponentOutput_component::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAIDeleteComponentOutput_component::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAIDeleteComponentOutput_component::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAIDeleteComponentOutput_component::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAIDeleteComponentOutput_component::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAIDeleteComponentOutput_component::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAIDeleteComponentOutput_component::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAIDeleteComponentOutput_component::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAIDeleteComponentOutput_component::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAIDeleteComponentOutput_component::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QDateTime OAIDeleteComponentOutput_component::getLastModifiedAt() const {
    return m_last_modified_at;
}
void OAIDeleteComponentOutput_component::setLastModifiedAt(const QDateTime &last_modified_at) {
    m_last_modified_at = last_modified_at;
    m_last_modified_at_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_modified_at_Set() const{
    return m_last_modified_at_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_modified_at_Valid() const{
    return m_last_modified_at_isValid;
}

QString OAIDeleteComponentOutput_component::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAIDeleteComponentOutput_component::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAIDeleteComponentOutput_component::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAIDeleteComponentOutput_component::getName() const {
    return m_name;
}
void OAIDeleteComponentOutput_component::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteComponentOutput_component::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteComponentOutput_component::getServiceInstanceName() const {
    return m_service_instance_name;
}
void OAIDeleteComponentOutput_component::setServiceInstanceName(const QString &service_instance_name) {
    m_service_instance_name = service_instance_name;
    m_service_instance_name_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_service_instance_name_Set() const{
    return m_service_instance_name_isSet;
}

bool OAIDeleteComponentOutput_component::is_service_instance_name_Valid() const{
    return m_service_instance_name_isValid;
}

QString OAIDeleteComponentOutput_component::getServiceName() const {
    return m_service_name;
}
void OAIDeleteComponentOutput_component::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIDeleteComponentOutput_component::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIDeleteComponentOutput_component::getServiceSpec() const {
    return m_service_spec;
}
void OAIDeleteComponentOutput_component::setServiceSpec(const QString &service_spec) {
    m_service_spec = service_spec;
    m_service_spec_isSet = true;
}

bool OAIDeleteComponentOutput_component::is_service_spec_Set() const{
    return m_service_spec_isSet;
}

bool OAIDeleteComponentOutput_component::is_service_spec_Valid() const{
    return m_service_spec_isValid;
}

bool OAIDeleteComponentOutput_component::isSet() const {
...
bool OAIDeleteComponentOutput_component::isValid() const {
