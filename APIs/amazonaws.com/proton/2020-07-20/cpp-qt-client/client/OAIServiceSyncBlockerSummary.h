...
/*
 * OAIServiceSyncBlockerSummary.h
 *
...
#ifndef OAIServiceSyncBlockerSummary_H
#define OAIServiceSyncBlockerSummary_H
...
class OAIServiceSyncBlockerSummary : public OAIObject {
public:
    OAIServiceSyncBlockerSummary();
    OAIServiceSyncBlockerSummary(QString json);
    ~OAIServiceSyncBlockerSummary() override;
    ...
    QList getLatestBlockers() const;
    void setLatestBlockers(const QList &latest_blockers);
    bool is_latest_blockers_Set() const;
    bool is_latest_blockers_Valid() const;
...
private:
    ...
    QList m_latest_blockers;
    bool m_latest_blockers_isSet;
    bool m_latest_blockers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceSyncBlockerSummary)

#endif // OAIServiceSyncBlockerSummary_H
