...
/*
 * OAIServicePipeline.h
 *
 * Detailed data of an Proton service instance pipeline resource.
 */

#ifndef OAIServicePipeline_H
#define OAIServicePipeline_H
...
class OAIServicePipeline : public OAIObject {
public:
    OAIServicePipeline();
    OAIServicePipeline(QString json);
    ~OAIServicePipeline() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServicePipeline)

#endif // OAIServicePipeline_H
