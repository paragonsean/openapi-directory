...
/*
 * OAICreateServiceOutput_service.h
 *
 * 
 */

#ifndef OAICreateServiceOutput_service_H
#define OAICreateServiceOutput_service_H
...
class OAICreateServiceOutput_service : public OAIObject {
public:
    OAICreateServiceOutput_service();
    OAICreateServiceOutput_service(QString json);
    ~OAICreateServiceOutput_service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceOutput_service)

#endif // OAICreateServiceOutput_service_H
