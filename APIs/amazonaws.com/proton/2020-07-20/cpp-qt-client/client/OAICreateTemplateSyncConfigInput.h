...
/*
 * OAICreateTemplateSyncConfigInput.h
 *
 * 
 */

#ifndef OAICreateTemplateSyncConfigInput_H
#define OAICreateTemplateSyncConfigInput_H
...
class OAICreateTemplateSyncConfigInput : public OAIObject {
public:
    OAICreateTemplateSyncConfigInput();
    OAICreateTemplateSyncConfigInput(QString json);
    ~OAICreateTemplateSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTemplateSyncConfigInput)

#endif // OAICreateTemplateSyncConfigInput_H
