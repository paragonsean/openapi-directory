...
/*
 * OAIDeleteDeploymentOutput_deployment.h
 *
 * 
 */

#ifndef OAIDeleteDeploymentOutput_deployment_H
#define OAIDeleteDeploymentOutput_deployment_H
...
class OAIDeleteDeploymentOutput_deployment : public OAIObject {
public:
    OAIDeleteDeploymentOutput_deployment();
    OAIDeleteDeploymentOutput_deployment(QString json);
    ~OAIDeleteDeploymentOutput_deployment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDeploymentOutput_deployment)

#endif // OAIDeleteDeploymentOutput_deployment_H
