...
OAICancelServicePipelineDeploymentOutput_pipeline::OAICancelServicePipelineDeploymentOutput_pipeline(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelServicePipelineDeploymentOutput_pipeline::OAICancelServicePipelineDeploymentOutput_pipeline() {
    this->initializeModel();
}

OAICancelServicePipelineDeploymentOutput_pipeline::~OAICancelServicePipelineDeploymentOutput_pipeline() {}

void OAICancelServicePipelineDeploymentOutput_pipeline::initializeModel() {
...
void OAICancelServicePipelineDeploymentOutput_pipeline::fromJson(QString jsonString) {
...
void OAICancelServicePipelineDeploymentOutput_pipeline::fromJsonObject(QJsonObject json) {
...
QString OAICancelServicePipelineDeploymentOutput_pipeline::asJson() const {
...
QJsonObject OAICancelServicePipelineDeploymentOutput_pipeline::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICancelServicePipelineDeploymentOutput_pipeline::getArn() const {
    return m_arn;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAICancelServicePipelineDeploymentOutput_pipeline::getCreatedAt() const {
    return m_created_at;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAICancelServicePipelineDeploymentOutput_pipeline::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QDateTime OAICancelServicePipelineDeploymentOutput_pipeline::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAICancelServicePipelineDeploymentOutput_pipeline::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getSpec() const {
    return m_spec;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAICancelServicePipelineDeploymentOutput_pipeline::getTemplateName() const {
    return m_template_name;
}
void OAICancelServicePipelineDeploymentOutput_pipeline::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAICancelServicePipelineDeploymentOutput_pipeline::isSet() const {
...
bool OAICancelServicePipelineDeploymentOutput_pipeline::isValid() const {
