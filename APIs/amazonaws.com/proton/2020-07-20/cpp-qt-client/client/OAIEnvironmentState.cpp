...
void OAIEnvironmentState::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIEnvironmentState::asJsonObject() const {
    QJsonObject obj;
    if (m_spec_isSet) {
...
QString OAIEnvironmentState::getSpec() const {
    return m_spec;
}
void OAIEnvironmentState::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIEnvironmentState::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIEnvironmentState::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAIEnvironmentState::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAIEnvironmentState::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAIEnvironmentState::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAIEnvironmentState::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAIEnvironmentState::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAIEnvironmentState::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAIEnvironmentState::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAIEnvironmentState::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAIEnvironmentState::getTemplateName() const {
    return m_template_name;
}
void OAIEnvironmentState::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAIEnvironmentState::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAIEnvironmentState::is_template_name_Valid() const{
