...
/*
 * OAIGetServiceInstanceSyncStatusInput.h
 *
 * 
 */

#ifndef OAIGetServiceInstanceSyncStatusInput_H
#define OAIGetServiceInstanceSyncStatusInput_H
...
class OAIGetServiceInstanceSyncStatusInput : public OAIObject {
public:
    OAIGetServiceInstanceSyncStatusInput();
    OAIGetServiceInstanceSyncStatusInput(QString json);
    ~OAIGetServiceInstanceSyncStatusInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceInstanceSyncStatusInput)

#endif // OAIGetServiceInstanceSyncStatusInput_H
