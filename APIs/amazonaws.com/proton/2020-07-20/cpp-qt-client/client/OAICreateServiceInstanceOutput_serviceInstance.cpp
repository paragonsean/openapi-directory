...
#include "OAICreateServiceInstanceOutput_serviceInstance.h"
...
OAICreateServiceInstanceOutput_serviceInstance::OAICreateServiceInstanceOutput_serviceInstance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateServiceInstanceOutput_serviceInstance::OAICreateServiceInstanceOutput_serviceInstance() {
    this->initializeModel();
}

OAICreateServiceInstanceOutput_serviceInstance::~OAICreateServiceInstanceOutput_serviceInstance() {}

void OAICreateServiceInstanceOutput_serviceInstance::initializeModel() {
...
void OAICreateServiceInstanceOutput_serviceInstance::fromJson(QString jsonString) {
...
void OAICreateServiceInstanceOutput_serviceInstance::fromJsonObject(QJsonObject json) {
...
QString OAICreateServiceInstanceOutput_serviceInstance::asJson() const {
...
QJsonObject OAICreateServiceInstanceOutput_serviceInstance::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateServiceInstanceOutput_serviceInstance::getArn() const {
    return m_arn;
}
void OAICreateServiceInstanceOutput_serviceInstance::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAICreateServiceInstanceOutput_serviceInstance::getCreatedAt() const {
    return m_created_at;
}
void OAICreateServiceInstanceOutput_serviceInstance::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDeploymentStatus OAICreateServiceInstanceOutput_serviceInstance::getDeploymentStatus() const {
    return m_deployment_status;
}
void OAICreateServiceInstanceOutput_serviceInstance::setDeploymentStatus(const OAIDeploymentStatus &deployment_status) {
    m_deployment_status = deployment_status;
    m_deployment_status_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_deployment_status_Set() const{
    return m_deployment_status_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_deployment_status_Valid() const{
    return m_deployment_status_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAICreateServiceInstanceOutput_serviceInstance::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getEnvironmentName() const {
    return m_environment_name;
}
void OAICreateServiceInstanceOutput_serviceInstance::setEnvironmentName(const QString &environment_name) {
    m_environment_name = environment_name;
    m_environment_name_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_environment_name_Set() const{
    return m_environment_name_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_environment_name_Valid() const{
    return m_environment_name_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getLastAttemptedDeploymentId() const {
    return m_last_attempted_deployment_id;
}
void OAICreateServiceInstanceOutput_serviceInstance::setLastAttemptedDeploymentId(const QString &last_attempted_deployment_id) {
    m_last_attempted_deployment_id = last_attempted_deployment_id;
    m_last_attempted_deployment_id_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_attempted_deployment_id_Set() const{
    return m_last_attempted_deployment_id_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_attempted_deployment_id_Valid() const{
    return m_last_attempted_deployment_id_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getLastClientRequestToken() const {
    return m_last_client_request_token;
}
void OAICreateServiceInstanceOutput_serviceInstance::setLastClientRequestToken(const QString &last_client_request_token) {
    m_last_client_request_token = last_client_request_token;
    m_last_client_request_token_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_client_request_token_Set() const{
    return m_last_client_request_token_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_client_request_token_Valid() const{
    return m_last_client_request_token_isValid;
}

QDateTime OAICreateServiceInstanceOutput_serviceInstance::getLastDeploymentAttemptedAt() const {
    return m_last_deployment_attempted_at;
}
void OAICreateServiceInstanceOutput_serviceInstance::setLastDeploymentAttemptedAt(const QDateTime &last_deployment_attempted_at) {
    m_last_deployment_attempted_at = last_deployment_attempted_at;
    m_last_deployment_attempted_at_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_deployment_attempted_at_Set() const{
    return m_last_deployment_attempted_at_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_deployment_attempted_at_Valid() const{
    return m_last_deployment_attempted_at_isValid;
}

QDateTime OAICreateServiceInstanceOutput_serviceInstance::getLastDeploymentSucceededAt() const {
    return m_last_deployment_succeeded_at;
}
void OAICreateServiceInstanceOutput_serviceInstance::setLastDeploymentSucceededAt(const QDateTime &last_deployment_succeeded_at) {
    m_last_deployment_succeeded_at = last_deployment_succeeded_at;
    m_last_deployment_succeeded_at_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_deployment_succeeded_at_Set() const{
    return m_last_deployment_succeeded_at_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_deployment_succeeded_at_Valid() const{
    return m_last_deployment_succeeded_at_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getLastSucceededDeploymentId() const {
    return m_last_succeeded_deployment_id;
}
void OAICreateServiceInstanceOutput_serviceInstance::setLastSucceededDeploymentId(const QString &last_succeeded_deployment_id) {
    m_last_succeeded_deployment_id = last_succeeded_deployment_id;
    m_last_succeeded_deployment_id_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_succeeded_deployment_id_Set() const{
    return m_last_succeeded_deployment_id_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_last_succeeded_deployment_id_Valid() const{
    return m_last_succeeded_deployment_id_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getName() const {
    return m_name;
}
void OAICreateServiceInstanceOutput_serviceInstance::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getServiceName() const {
    return m_service_name;
}
void OAICreateServiceInstanceOutput_serviceInstance::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getSpec() const {
    return m_spec;
}
void OAICreateServiceInstanceOutput_serviceInstance::setSpec(const QString &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_spec_Valid() const{
    return m_spec_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getTemplateMajorVersion() const {
    return m_template_major_version;
}
void OAICreateServiceInstanceOutput_serviceInstance::setTemplateMajorVersion(const QString &template_major_version) {
    m_template_major_version = template_major_version;
    m_template_major_version_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_major_version_Set() const{
    return m_template_major_version_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_major_version_Valid() const{
    return m_template_major_version_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getTemplateMinorVersion() const {
    return m_template_minor_version;
}
void OAICreateServiceInstanceOutput_serviceInstance::setTemplateMinorVersion(const QString &template_minor_version) {
    m_template_minor_version = template_minor_version;
    m_template_minor_version_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_minor_version_Set() const{
    return m_template_minor_version_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_minor_version_Valid() const{
    return m_template_minor_version_isValid;
}

QString OAICreateServiceInstanceOutput_serviceInstance::getTemplateName() const {
    return m_template_name;
}
void OAICreateServiceInstanceOutput_serviceInstance::setTemplateName(const QString &template_name) {
    m_template_name = template_name;
    m_template_name_isSet = true;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_name_Set() const{
    return m_template_name_isSet;
}

bool OAICreateServiceInstanceOutput_serviceInstance::is_template_name_Valid() const{
    return m_template_name_isValid;
}

bool OAICreateServiceInstanceOutput_serviceInstance::isSet() const {
...
bool OAICreateServiceInstanceOutput_serviceInstance::isValid() const {
