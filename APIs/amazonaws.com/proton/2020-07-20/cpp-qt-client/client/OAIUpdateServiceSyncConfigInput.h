...
/*
 * OAIUpdateServiceSyncConfigInput.h
 *
 * 
 */

#ifndef OAIUpdateServiceSyncConfigInput_H
#define OAIUpdateServiceSyncConfigInput_H
...
class OAIUpdateServiceSyncConfigInput : public OAIObject {
public:
    OAIUpdateServiceSyncConfigInput();
    OAIUpdateServiceSyncConfigInput(QString json);
    ~OAIUpdateServiceSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServiceSyncConfigInput)

#endif // OAIUpdateServiceSyncConfigInput_H
