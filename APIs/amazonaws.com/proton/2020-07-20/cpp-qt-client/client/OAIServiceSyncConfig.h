...
/*
 * OAIServiceSyncConfig.h
 *
 * Detailed data of the service sync configuration.
 */

#ifndef OAIServiceSyncConfig_H
#define OAIServiceSyncConfig_H
...
class OAIServiceSyncConfig : public OAIObject {
public:
    OAIServiceSyncConfig();
    OAIServiceSyncConfig(QString json);
    ~OAIServiceSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceSyncConfig)

#endif // OAIServiceSyncConfig_H
