...
/*
 * OAIGetServiceSyncConfigOutput_serviceSyncConfig.h
 *
 * 
 */

#ifndef OAIGetServiceSyncConfigOutput_serviceSyncConfig_H
#define OAIGetServiceSyncConfigOutput_serviceSyncConfig_H
...
class OAIGetServiceSyncConfigOutput_serviceSyncConfig : public OAIObject {
public:
    OAIGetServiceSyncConfigOutput_serviceSyncConfig();
    OAIGetServiceSyncConfigOutput_serviceSyncConfig(QString json);
    ~OAIGetServiceSyncConfigOutput_serviceSyncConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceSyncConfigOutput_serviceSyncConfig)

#endif // OAIGetServiceSyncConfigOutput_serviceSyncConfig_H
