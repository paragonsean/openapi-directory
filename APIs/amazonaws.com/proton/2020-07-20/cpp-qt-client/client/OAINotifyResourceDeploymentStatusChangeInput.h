...
/*
 * OAINotifyResourceDeploymentStatusChangeInput.h
 *
 * 
 */

#ifndef OAINotifyResourceDeploymentStatusChangeInput_H
#define OAINotifyResourceDeploymentStatusChangeInput_H
...
class OAINotifyResourceDeploymentStatusChangeInput : public OAIObject {
public:
    OAINotifyResourceDeploymentStatusChangeInput();
    OAINotifyResourceDeploymentStatusChangeInput(QString json);
    ~OAINotifyResourceDeploymentStatusChangeInput() override;
    ...
    OAIResourceDeploymentStatus getStatus() const;
    void setStatus(const OAIResourceDeploymentStatus &status);
...
private:
    ...
    OAIResourceDeploymentStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyResourceDeploymentStatusChangeInput)

#endif // OAINotifyResourceDeploymentStatusChangeInput_H
