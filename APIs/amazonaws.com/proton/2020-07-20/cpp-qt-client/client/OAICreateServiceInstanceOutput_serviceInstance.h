...
/*
 * OAICreateServiceInstanceOutput_serviceInstance.h
 *
 * 
 */

#ifndef OAICreateServiceInstanceOutput_serviceInstance_H
#define OAICreateServiceInstanceOutput_serviceInstance_H
...
class OAICreateServiceInstanceOutput_serviceInstance : public OAIObject {
public:
    OAICreateServiceInstanceOutput_serviceInstance();
    OAICreateServiceInstanceOutput_serviceInstance(QString json);
    ~OAICreateServiceInstanceOutput_serviceInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceInstanceOutput_serviceInstance)

#endif // OAICreateServiceInstanceOutput_serviceInstance_H
