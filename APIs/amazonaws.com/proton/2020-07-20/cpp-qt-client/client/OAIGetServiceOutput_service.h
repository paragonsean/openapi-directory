...
/*
 * OAIGetServiceOutput_service.h
 *
 * 
 */

#ifndef OAIGetServiceOutput_service_H
#define OAIGetServiceOutput_service_H

#include <QJsonObject>

#include "OAIServiceStatus.h"
#include "OAIService_pipeline.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIService_pipeline;

class OAIGetServiceOutput_service : public OAIObject {
public:
    OAIGetServiceOutput_service();
    OAIGetServiceOutput_service(QString json);
    ~OAIGetServiceOutput_service() override;
    ...
    OAIService_pipeline getPipeline() const;
    void setPipeline(const OAIService_pipeline &pipeline);
    bool is_pipeline_Set() const;
    bool is_pipeline_Valid() const;

    QString getRepositoryConnectionArn() const;
    void setRepositoryConnectionArn(const QString &repository_connection_arn);
    bool is_repository_connection_arn_Set() const;
    bool is_repository_connection_arn_Valid() const;
...
private:
    ...
    OAIService_pipeline m_pipeline;
    bool m_pipeline_isSet;
    bool m_pipeline_isValid;

    QString m_repository_connection_arn;
    bool m_repository_connection_arn_isSet;
    bool m_repository_connection_arn_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetServiceOutput_service)

#endif // OAIGetServiceOutput_service_H
