...
/*
 * OAIDeleteTemplateSyncConfigInput.h
 *
 * 
 */

#ifndef OAIDeleteTemplateSyncConfigInput_H
#define OAIDeleteTemplateSyncConfigInput_H
...
class OAIDeleteTemplateSyncConfigInput : public OAIObject {
public:
    OAIDeleteTemplateSyncConfigInput();
    OAIDeleteTemplateSyncConfigInput(QString json);
    ~OAIDeleteTemplateSyncConfigInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTemplateSyncConfigInput)

#endif // OAIDeleteTemplateSyncConfigInput_H
