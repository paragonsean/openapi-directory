...
public class CancelEnvironmentDeploymentOutputEnvironment {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment() {
  }

  public CancelEnvironmentDeploymentOutputEnvironment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CancelEnvironmentDeploymentOutputEnvironment codebuildRoleArn(String codebuildRoleArn) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment componentRoleArn(String componentRoleArn) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment createdAt(OffsetDateTime createdAt) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment description(String description) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment environmentAccountId(String environmentAccountId) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CancelEnvironmentDeploymentOutputEnvironment protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment provisioning(Provisioning provisioning) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment provisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public CancelEnvironmentDeploymentOutputEnvironment templateMajorVersion(String templateMajorVersion) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment templateMinorVersion(String templateMinorVersion) {
  ...
  public CancelEnvironmentDeploymentOutputEnvironment templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    CancelEnvironmentDeploymentOutputEnvironment cancelEnvironmentDeploymentOutputEnvironment = (CancelEnvironmentDeploymentOutputEnvironment) o;
    return Objects.equals(this.arn, cancelEnvironmentDeploymentOutputEnvironment.arn) &&
        Objects.equals(this.codebuildRoleArn, cancelEnvironmentDeploymentOutputEnvironment.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, cancelEnvironmentDeploymentOutputEnvironment.componentRoleArn) &&
        Objects.equals(this.createdAt, cancelEnvironmentDeploymentOutputEnvironment.createdAt) &&
        Objects.equals(this.deploymentStatus, cancelEnvironmentDeploymentOutputEnvironment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, cancelEnvironmentDeploymentOutputEnvironment.deploymentStatusMessage) &&
        Objects.equals(this.description, cancelEnvironmentDeploymentOutputEnvironment.description) &&
        Objects.equals(this.environmentAccountConnectionId, cancelEnvironmentDeploymentOutputEnvironment.environmentAccountConnectionId) &&
        Objects.equals(this.environmentAccountId, cancelEnvironmentDeploymentOutputEnvironment.environmentAccountId) &&
        Objects.equals(this.lastAttemptedDeploymentId, cancelEnvironmentDeploymentOutputEnvironment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, cancelEnvironmentDeploymentOutputEnvironment.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, cancelEnvironmentDeploymentOutputEnvironment.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, cancelEnvironmentDeploymentOutputEnvironment.lastSucceededDeploymentId) &&
        Objects.equals(this.name, cancelEnvironmentDeploymentOutputEnvironment.name) &&
        Objects.equals(this.protonServiceRoleArn, cancelEnvironmentDeploymentOutputEnvironment.protonServiceRoleArn) &&
        Objects.equals(this.provisioning, cancelEnvironmentDeploymentOutputEnvironment.provisioning) &&
        Objects.equals(this.provisioningRepository, cancelEnvironmentDeploymentOutputEnvironment.provisioningRepository) &&
        Objects.equals(this.spec, cancelEnvironmentDeploymentOutputEnvironment.spec) &&
        Objects.equals(this.templateMajorVersion, cancelEnvironmentDeploymentOutputEnvironment.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, cancelEnvironmentDeploymentOutputEnvironment.templateMinorVersion) &&
        Objects.equals(this.templateName, cancelEnvironmentDeploymentOutputEnvironment.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelEnvironmentDeploymentOutputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelEnvironmentDeploymentOutputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelEnvironmentDeploymentOutputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelEnvironmentDeploymentOutputEnvironment is not found in the empty JSON string", CancelEnvironmentDeploymentOutputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelEnvironmentDeploymentOutputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelEnvironmentDeploymentOutputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelEnvironmentDeploymentOutputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelEnvironmentDeploymentOutputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelEnvironmentDeploymentOutputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelEnvironmentDeploymentOutputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelEnvironmentDeploymentOutputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelEnvironmentDeploymentOutputEnvironment>() {
           @Override
           public void write(JsonWriter out, CancelEnvironmentDeploymentOutputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelEnvironmentDeploymentOutputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelEnvironmentDeploymentOutputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelEnvironmentDeploymentOutputEnvironment
   * @throws IOException if the JSON string is invalid with respect to CancelEnvironmentDeploymentOutputEnvironment
   */
  public static CancelEnvironmentDeploymentOutputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelEnvironmentDeploymentOutputEnvironment.class);
  }

  /**
   * Convert an instance of CancelEnvironmentDeploymentOutputEnvironment to an JSON string
   *
   * @return JSON string
   */
