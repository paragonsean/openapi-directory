...
public class CancelServiceInstanceDeploymentOutputServiceInstance {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance() {
  }

  public CancelServiceInstanceDeploymentOutputServiceInstance arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance createdAt(OffsetDateTime createdAt) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance environmentName(String environmentName) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance lastClientRequestToken(String lastClientRequestToken) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance serviceName(String serviceName) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance templateMajorVersion(String templateMajorVersion) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance templateMinorVersion(String templateMinorVersion) {
  ...
  public CancelServiceInstanceDeploymentOutputServiceInstance templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    CancelServiceInstanceDeploymentOutputServiceInstance cancelServiceInstanceDeploymentOutputServiceInstance = (CancelServiceInstanceDeploymentOutputServiceInstance) o;
    return Objects.equals(this.arn, cancelServiceInstanceDeploymentOutputServiceInstance.arn) &&
        Objects.equals(this.createdAt, cancelServiceInstanceDeploymentOutputServiceInstance.createdAt) &&
        Objects.equals(this.deploymentStatus, cancelServiceInstanceDeploymentOutputServiceInstance.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, cancelServiceInstanceDeploymentOutputServiceInstance.deploymentStatusMessage) &&
        Objects.equals(this.environmentName, cancelServiceInstanceDeploymentOutputServiceInstance.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, cancelServiceInstanceDeploymentOutputServiceInstance.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, cancelServiceInstanceDeploymentOutputServiceInstance.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, cancelServiceInstanceDeploymentOutputServiceInstance.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, cancelServiceInstanceDeploymentOutputServiceInstance.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, cancelServiceInstanceDeploymentOutputServiceInstance.lastSucceededDeploymentId) &&
        Objects.equals(this.name, cancelServiceInstanceDeploymentOutputServiceInstance.name) &&
        Objects.equals(this.serviceName, cancelServiceInstanceDeploymentOutputServiceInstance.serviceName) &&
        Objects.equals(this.spec, cancelServiceInstanceDeploymentOutputServiceInstance.spec) &&
        Objects.equals(this.templateMajorVersion, cancelServiceInstanceDeploymentOutputServiceInstance.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, cancelServiceInstanceDeploymentOutputServiceInstance.templateMinorVersion) &&
        Objects.equals(this.templateName, cancelServiceInstanceDeploymentOutputServiceInstance.templateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, createdAt, deploymentStatus, deploymentStatusMessage, environmentName, lastAttemptedDeploymentId, lastClientRequestToken, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, lastSucceededDeploymentId, name, serviceName, spec, templateMajorVersion, templateMinorVersion, templateName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelServiceInstanceDeploymentOutputServiceInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelServiceInstanceDeploymentOutputServiceInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelServiceInstanceDeploymentOutputServiceInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelServiceInstanceDeploymentOutputServiceInstance is not found in the empty JSON string", CancelServiceInstanceDeploymentOutputServiceInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelServiceInstanceDeploymentOutputServiceInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelServiceInstanceDeploymentOutputServiceInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelServiceInstanceDeploymentOutputServiceInstance.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelServiceInstanceDeploymentOutputServiceInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelServiceInstanceDeploymentOutputServiceInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelServiceInstanceDeploymentOutputServiceInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelServiceInstanceDeploymentOutputServiceInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelServiceInstanceDeploymentOutputServiceInstance>() {
           @Override
           public void write(JsonWriter out, CancelServiceInstanceDeploymentOutputServiceInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelServiceInstanceDeploymentOutputServiceInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelServiceInstanceDeploymentOutputServiceInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelServiceInstanceDeploymentOutputServiceInstance
   * @throws IOException if the JSON string is invalid with respect to CancelServiceInstanceDeploymentOutputServiceInstance
   */
  public static CancelServiceInstanceDeploymentOutputServiceInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelServiceInstanceDeploymentOutputServiceInstance.class);
  }

  /**
   * Convert an instance of CancelServiceInstanceDeploymentOutputServiceInstance to an JSON string
   *
   * @return JSON string
   */
