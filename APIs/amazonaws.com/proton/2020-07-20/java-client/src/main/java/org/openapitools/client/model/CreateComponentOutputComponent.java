...
public class CreateComponentOutputComponent {
  ...
  public CreateComponentOutputComponent() {
  }

  public CreateComponentOutputComponent arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateComponentOutputComponent createdAt(OffsetDateTime createdAt) {
  ...
  public CreateComponentOutputComponent deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CreateComponentOutputComponent deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CreateComponentOutputComponent description(String description) {
  ...
  public CreateComponentOutputComponent environmentName(String environmentName) {
  ...
  public CreateComponentOutputComponent lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CreateComponentOutputComponent lastClientRequestToken(String lastClientRequestToken) {
  ...
  public CreateComponentOutputComponent lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CreateComponentOutputComponent lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CreateComponentOutputComponent lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public CreateComponentOutputComponent lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CreateComponentOutputComponent name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateComponentOutputComponent serviceInstanceName(String serviceInstanceName) {
  ...
  public CreateComponentOutputComponent serviceName(String serviceName) {
  ...
  public CreateComponentOutputComponent serviceSpec(String serviceSpec) {
  ...
  public boolean equals(Object o) {
    ...
    CreateComponentOutputComponent createComponentOutputComponent = (CreateComponentOutputComponent) o;
    return Objects.equals(this.arn, createComponentOutputComponent.arn) &&
        Objects.equals(this.createdAt, createComponentOutputComponent.createdAt) &&
        Objects.equals(this.deploymentStatus, createComponentOutputComponent.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, createComponentOutputComponent.deploymentStatusMessage) &&
        Objects.equals(this.description, createComponentOutputComponent.description) &&
        Objects.equals(this.environmentName, createComponentOutputComponent.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, createComponentOutputComponent.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, createComponentOutputComponent.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, createComponentOutputComponent.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, createComponentOutputComponent.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastModifiedAt, createComponentOutputComponent.lastModifiedAt) &&
        Objects.equals(this.lastSucceededDeploymentId, createComponentOutputComponent.lastSucceededDeploymentId) &&
        Objects.equals(this.name, createComponentOutputComponent.name) &&
        Objects.equals(this.serviceInstanceName, createComponentOutputComponent.serviceInstanceName) &&
        Objects.equals(this.serviceName, createComponentOutputComponent.serviceName) &&
        Objects.equals(this.serviceSpec, createComponentOutputComponent.serviceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateComponentOutputComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateComponentOutputComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateComponentOutputComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateComponentOutputComponent is not found in the empty JSON string", CreateComponentOutputComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateComponentOutputComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateComponentOutputComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateComponentOutputComponent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateComponentOutputComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateComponentOutputComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateComponentOutputComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateComponentOutputComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateComponentOutputComponent>() {
           @Override
           public void write(JsonWriter out, CreateComponentOutputComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateComponentOutputComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateComponentOutputComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateComponentOutputComponent
   * @throws IOException if the JSON string is invalid with respect to CreateComponentOutputComponent
   */
  public static CreateComponentOutputComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateComponentOutputComponent.class);
  }

  /**
   * Convert an instance of CreateComponentOutputComponent to an JSON string
   *
   * @return JSON string
   */
