...
public class ServiceInstanceSummary {
  ...
  public ServiceInstanceSummary() {
  }

  public ServiceInstanceSummary arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ServiceInstanceSummary createdAt(OffsetDateTime createdAt) {
  ...
  public ServiceInstanceSummary deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public ServiceInstanceSummary deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public ServiceInstanceSummary environmentName(String environmentName) {
  ...
  public ServiceInstanceSummary lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public ServiceInstanceSummary lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public ServiceInstanceSummary lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public ServiceInstanceSummary lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public ServiceInstanceSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceInstanceSummary serviceName(String serviceName) {
  ...
  public ServiceInstanceSummary templateMajorVersion(String templateMajorVersion) {
  ...
  public ServiceInstanceSummary templateMinorVersion(String templateMinorVersion) {
  ...
  public ServiceInstanceSummary templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceInstanceSummary serviceInstanceSummary = (ServiceInstanceSummary) o;
    return Objects.equals(this.arn, serviceInstanceSummary.arn) &&
        Objects.equals(this.createdAt, serviceInstanceSummary.createdAt) &&
        Objects.equals(this.deploymentStatus, serviceInstanceSummary.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, serviceInstanceSummary.deploymentStatusMessage) &&
        Objects.equals(this.environmentName, serviceInstanceSummary.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, serviceInstanceSummary.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, serviceInstanceSummary.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, serviceInstanceSummary.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, serviceInstanceSummary.lastSucceededDeploymentId) &&
        Objects.equals(this.name, serviceInstanceSummary.name) &&
        Objects.equals(this.serviceName, serviceInstanceSummary.serviceName) &&
        Objects.equals(this.templateMajorVersion, serviceInstanceSummary.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, serviceInstanceSummary.templateMinorVersion) &&
        Objects.equals(this.templateName, serviceInstanceSummary.templateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, createdAt, deploymentStatus, deploymentStatusMessage, environmentName, lastAttemptedDeploymentId, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, lastSucceededDeploymentId, name, serviceName, templateMajorVersion, templateMinorVersion, templateName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceInstanceSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceInstanceSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceInstanceSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceInstanceSummary is not found in the empty JSON string", ServiceInstanceSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceInstanceSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceInstanceSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServiceInstanceSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceInstanceSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceInstanceSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceInstanceSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceInstanceSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceInstanceSummary>() {
           @Override
           public void write(JsonWriter out, ServiceInstanceSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceInstanceSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceInstanceSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceInstanceSummary
   * @throws IOException if the JSON string is invalid with respect to ServiceInstanceSummary
   */
  public static ServiceInstanceSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceInstanceSummary.class);
  }

  /**
   * Convert an instance of ServiceInstanceSummary to an JSON string
   *
   * @return JSON string
   */
