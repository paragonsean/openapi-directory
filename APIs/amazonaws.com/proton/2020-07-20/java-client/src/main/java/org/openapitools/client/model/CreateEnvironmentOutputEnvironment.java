...
public class CreateEnvironmentOutputEnvironment {
  ...
  public CreateEnvironmentOutputEnvironment() {
  }

  public CreateEnvironmentOutputEnvironment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateEnvironmentOutputEnvironment codebuildRoleArn(String codebuildRoleArn) {
  ...
  public CreateEnvironmentOutputEnvironment componentRoleArn(String componentRoleArn) {
  ...
  public CreateEnvironmentOutputEnvironment createdAt(OffsetDateTime createdAt) {
  ...
  public CreateEnvironmentOutputEnvironment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CreateEnvironmentOutputEnvironment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CreateEnvironmentOutputEnvironment description(String description) {
  ...
  public CreateEnvironmentOutputEnvironment environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public CreateEnvironmentOutputEnvironment environmentAccountId(String environmentAccountId) {
  ...
  public CreateEnvironmentOutputEnvironment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CreateEnvironmentOutputEnvironment lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CreateEnvironmentOutputEnvironment lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CreateEnvironmentOutputEnvironment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CreateEnvironmentOutputEnvironment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateEnvironmentOutputEnvironment protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public CreateEnvironmentOutputEnvironment provisioning(Provisioning provisioning) {
  ...
  public CreateEnvironmentOutputEnvironment provisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
  ...
  public CreateEnvironmentOutputEnvironment spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public CreateEnvironmentOutputEnvironment templateMajorVersion(String templateMajorVersion) {
  ...
  public CreateEnvironmentOutputEnvironment templateMinorVersion(String templateMinorVersion) {
  ...
  public CreateEnvironmentOutputEnvironment templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEnvironmentOutputEnvironment createEnvironmentOutputEnvironment = (CreateEnvironmentOutputEnvironment) o;
    return Objects.equals(this.arn, createEnvironmentOutputEnvironment.arn) &&
        Objects.equals(this.codebuildRoleArn, createEnvironmentOutputEnvironment.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, createEnvironmentOutputEnvironment.componentRoleArn) &&
        Objects.equals(this.createdAt, createEnvironmentOutputEnvironment.createdAt) &&
        Objects.equals(this.deploymentStatus, createEnvironmentOutputEnvironment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, createEnvironmentOutputEnvironment.deploymentStatusMessage) &&
        Objects.equals(this.description, createEnvironmentOutputEnvironment.description) &&
        Objects.equals(this.environmentAccountConnectionId, createEnvironmentOutputEnvironment.environmentAccountConnectionId) &&
        Objects.equals(this.environmentAccountId, createEnvironmentOutputEnvironment.environmentAccountId) &&
        Objects.equals(this.lastAttemptedDeploymentId, createEnvironmentOutputEnvironment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, createEnvironmentOutputEnvironment.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, createEnvironmentOutputEnvironment.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, createEnvironmentOutputEnvironment.lastSucceededDeploymentId) &&
        Objects.equals(this.name, createEnvironmentOutputEnvironment.name) &&
        Objects.equals(this.protonServiceRoleArn, createEnvironmentOutputEnvironment.protonServiceRoleArn) &&
        Objects.equals(this.provisioning, createEnvironmentOutputEnvironment.provisioning) &&
        Objects.equals(this.provisioningRepository, createEnvironmentOutputEnvironment.provisioningRepository) &&
        Objects.equals(this.spec, createEnvironmentOutputEnvironment.spec) &&
        Objects.equals(this.templateMajorVersion, createEnvironmentOutputEnvironment.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, createEnvironmentOutputEnvironment.templateMinorVersion) &&
        Objects.equals(this.templateName, createEnvironmentOutputEnvironment.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEnvironmentOutputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEnvironmentOutputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEnvironmentOutputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEnvironmentOutputEnvironment is not found in the empty JSON string", CreateEnvironmentOutputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEnvironmentOutputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEnvironmentOutputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateEnvironmentOutputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEnvironmentOutputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEnvironmentOutputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEnvironmentOutputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEnvironmentOutputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEnvironmentOutputEnvironment>() {
           @Override
           public void write(JsonWriter out, CreateEnvironmentOutputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEnvironmentOutputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEnvironmentOutputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEnvironmentOutputEnvironment
   * @throws IOException if the JSON string is invalid with respect to CreateEnvironmentOutputEnvironment
   */
  public static CreateEnvironmentOutputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEnvironmentOutputEnvironment.class);
  }

  /**
   * Convert an instance of CreateEnvironmentOutputEnvironment to an JSON string
   *
   * @return JSON string
   */
