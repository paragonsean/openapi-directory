...
public class GetDeploymentOutputDeployment {
  ...
  public GetDeploymentOutputDeployment() {
  }

  public GetDeploymentOutputDeployment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetDeploymentOutputDeployment completedAt(OffsetDateTime completedAt) {
  ...
  public GetDeploymentOutputDeployment componentName(String componentName) {
  ...
  public GetDeploymentOutputDeployment createdAt(OffsetDateTime createdAt) {
  ...
  public GetDeploymentOutputDeployment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public GetDeploymentOutputDeployment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public GetDeploymentOutputDeployment environmentName(String environmentName) {
  ...
  public GetDeploymentOutputDeployment id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetDeploymentOutputDeployment initialState(DeploymentInitialState initialState) {
  ...
  public GetDeploymentOutputDeployment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public GetDeploymentOutputDeployment lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public GetDeploymentOutputDeployment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public GetDeploymentOutputDeployment serviceInstanceName(String serviceInstanceName) {
  ...
  public GetDeploymentOutputDeployment serviceName(String serviceName) {
  ...
  public GetDeploymentOutputDeployment targetArn(String targetArn) {
  ...
  public GetDeploymentOutputDeployment targetResourceCreatedAt(OffsetDateTime targetResourceCreatedAt) {
  ...
  public GetDeploymentOutputDeployment targetResourceType(DeploymentTargetResourceType targetResourceType) {
  ...
  public GetDeploymentOutputDeployment targetState(DeploymentTargetState targetState) {
  ...
  public boolean equals(Object o) {
    ...
    GetDeploymentOutputDeployment getDeploymentOutputDeployment = (GetDeploymentOutputDeployment) o;
    return Objects.equals(this.arn, getDeploymentOutputDeployment.arn) &&
        Objects.equals(this.completedAt, getDeploymentOutputDeployment.completedAt) &&
        Objects.equals(this.componentName, getDeploymentOutputDeployment.componentName) &&
        Objects.equals(this.createdAt, getDeploymentOutputDeployment.createdAt) &&
        Objects.equals(this.deploymentStatus, getDeploymentOutputDeployment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, getDeploymentOutputDeployment.deploymentStatusMessage) &&
        Objects.equals(this.environmentName, getDeploymentOutputDeployment.environmentName) &&
        Objects.equals(this.id, getDeploymentOutputDeployment.id) &&
        Objects.equals(this.initialState, getDeploymentOutputDeployment.initialState) &&
        Objects.equals(this.lastAttemptedDeploymentId, getDeploymentOutputDeployment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastModifiedAt, getDeploymentOutputDeployment.lastModifiedAt) &&
        Objects.equals(this.lastSucceededDeploymentId, getDeploymentOutputDeployment.lastSucceededDeploymentId) &&
        Objects.equals(this.serviceInstanceName, getDeploymentOutputDeployment.serviceInstanceName) &&
        Objects.equals(this.serviceName, getDeploymentOutputDeployment.serviceName) &&
        Objects.equals(this.targetArn, getDeploymentOutputDeployment.targetArn) &&
        Objects.equals(this.targetResourceCreatedAt, getDeploymentOutputDeployment.targetResourceCreatedAt) &&
        Objects.equals(this.targetResourceType, getDeploymentOutputDeployment.targetResourceType) &&
        Objects.equals(this.targetState, getDeploymentOutputDeployment.targetState);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDeploymentOutputDeployment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDeploymentOutputDeployment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDeploymentOutputDeployment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDeploymentOutputDeployment is not found in the empty JSON string", GetDeploymentOutputDeployment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDeploymentOutputDeployment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDeploymentOutputDeployment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDeploymentOutputDeployment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDeploymentOutputDeployment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDeploymentOutputDeployment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDeploymentOutputDeployment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDeploymentOutputDeployment.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDeploymentOutputDeployment>() {
           @Override
           public void write(JsonWriter out, GetDeploymentOutputDeployment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDeploymentOutputDeployment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDeploymentOutputDeployment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDeploymentOutputDeployment
   * @throws IOException if the JSON string is invalid with respect to GetDeploymentOutputDeployment
   */
  public static GetDeploymentOutputDeployment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDeploymentOutputDeployment.class);
  }

  /**
   * Convert an instance of GetDeploymentOutputDeployment to an JSON string
   *
   * @return JSON string
   */
