...
public class Output {
  ...
  public Output valueString(String valueString) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, output.key) &&
        Objects.equals(this.valueString, output.valueString);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, valueString);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `valueString`
      if (jsonObj.get("valueString") != null && !jsonObj.get("valueString").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("valueString"));
      }
  }
