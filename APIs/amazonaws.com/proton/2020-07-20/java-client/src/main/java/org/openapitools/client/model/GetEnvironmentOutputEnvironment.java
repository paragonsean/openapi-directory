...
public class GetEnvironmentOutputEnvironment {
  ...
  public GetEnvironmentOutputEnvironment() {
  }

  public GetEnvironmentOutputEnvironment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetEnvironmentOutputEnvironment codebuildRoleArn(String codebuildRoleArn) {
  ...
  public GetEnvironmentOutputEnvironment componentRoleArn(String componentRoleArn) {
  ...
  public GetEnvironmentOutputEnvironment createdAt(OffsetDateTime createdAt) {
  ...
  public GetEnvironmentOutputEnvironment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public GetEnvironmentOutputEnvironment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public GetEnvironmentOutputEnvironment description(String description) {
  ...
  public GetEnvironmentOutputEnvironment environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public GetEnvironmentOutputEnvironment environmentAccountId(String environmentAccountId) {
  ...
  public GetEnvironmentOutputEnvironment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public GetEnvironmentOutputEnvironment lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public GetEnvironmentOutputEnvironment lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public GetEnvironmentOutputEnvironment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public GetEnvironmentOutputEnvironment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetEnvironmentOutputEnvironment protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public GetEnvironmentOutputEnvironment provisioning(Provisioning provisioning) {
  ...
  public GetEnvironmentOutputEnvironment provisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
  ...
  public GetEnvironmentOutputEnvironment spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public GetEnvironmentOutputEnvironment templateMajorVersion(String templateMajorVersion) {
  ...
  public GetEnvironmentOutputEnvironment templateMinorVersion(String templateMinorVersion) {
  ...
  public GetEnvironmentOutputEnvironment templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    GetEnvironmentOutputEnvironment getEnvironmentOutputEnvironment = (GetEnvironmentOutputEnvironment) o;
    return Objects.equals(this.arn, getEnvironmentOutputEnvironment.arn) &&
        Objects.equals(this.codebuildRoleArn, getEnvironmentOutputEnvironment.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, getEnvironmentOutputEnvironment.componentRoleArn) &&
        Objects.equals(this.createdAt, getEnvironmentOutputEnvironment.createdAt) &&
        Objects.equals(this.deploymentStatus, getEnvironmentOutputEnvironment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, getEnvironmentOutputEnvironment.deploymentStatusMessage) &&
        Objects.equals(this.description, getEnvironmentOutputEnvironment.description) &&
        Objects.equals(this.environmentAccountConnectionId, getEnvironmentOutputEnvironment.environmentAccountConnectionId) &&
        Objects.equals(this.environmentAccountId, getEnvironmentOutputEnvironment.environmentAccountId) &&
        Objects.equals(this.lastAttemptedDeploymentId, getEnvironmentOutputEnvironment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, getEnvironmentOutputEnvironment.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, getEnvironmentOutputEnvironment.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, getEnvironmentOutputEnvironment.lastSucceededDeploymentId) &&
        Objects.equals(this.name, getEnvironmentOutputEnvironment.name) &&
        Objects.equals(this.protonServiceRoleArn, getEnvironmentOutputEnvironment.protonServiceRoleArn) &&
        Objects.equals(this.provisioning, getEnvironmentOutputEnvironment.provisioning) &&
        Objects.equals(this.provisioningRepository, getEnvironmentOutputEnvironment.provisioningRepository) &&
        Objects.equals(this.spec, getEnvironmentOutputEnvironment.spec) &&
        Objects.equals(this.templateMajorVersion, getEnvironmentOutputEnvironment.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, getEnvironmentOutputEnvironment.templateMinorVersion) &&
        Objects.equals(this.templateName, getEnvironmentOutputEnvironment.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEnvironmentOutputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEnvironmentOutputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEnvironmentOutputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEnvironmentOutputEnvironment is not found in the empty JSON string", GetEnvironmentOutputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEnvironmentOutputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEnvironmentOutputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEnvironmentOutputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEnvironmentOutputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEnvironmentOutputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEnvironmentOutputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEnvironmentOutputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEnvironmentOutputEnvironment>() {
           @Override
           public void write(JsonWriter out, GetEnvironmentOutputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEnvironmentOutputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEnvironmentOutputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEnvironmentOutputEnvironment
   * @throws IOException if the JSON string is invalid with respect to GetEnvironmentOutputEnvironment
   */
  public static GetEnvironmentOutputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEnvironmentOutputEnvironment.class);
  }

  /**
   * Convert an instance of GetEnvironmentOutputEnvironment to an JSON string
   *
   * @return JSON string
   */
