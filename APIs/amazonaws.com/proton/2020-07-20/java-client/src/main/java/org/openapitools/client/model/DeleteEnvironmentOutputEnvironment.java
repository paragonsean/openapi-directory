...
public class DeleteEnvironmentOutputEnvironment {
  ...
  public DeleteEnvironmentOutputEnvironment() {
  }

  public DeleteEnvironmentOutputEnvironment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteEnvironmentOutputEnvironment codebuildRoleArn(String codebuildRoleArn) {
  ...
  public DeleteEnvironmentOutputEnvironment componentRoleArn(String componentRoleArn) {
  ...
  public DeleteEnvironmentOutputEnvironment createdAt(OffsetDateTime createdAt) {
  ...
  public DeleteEnvironmentOutputEnvironment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public DeleteEnvironmentOutputEnvironment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public DeleteEnvironmentOutputEnvironment description(String description) {
  ...
  public DeleteEnvironmentOutputEnvironment environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public DeleteEnvironmentOutputEnvironment environmentAccountId(String environmentAccountId) {
  ...
  public DeleteEnvironmentOutputEnvironment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public DeleteEnvironmentOutputEnvironment lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public DeleteEnvironmentOutputEnvironment lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public DeleteEnvironmentOutputEnvironment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public DeleteEnvironmentOutputEnvironment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteEnvironmentOutputEnvironment protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public DeleteEnvironmentOutputEnvironment provisioning(Provisioning provisioning) {
  ...
  public DeleteEnvironmentOutputEnvironment provisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
  ...
  public DeleteEnvironmentOutputEnvironment spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public DeleteEnvironmentOutputEnvironment templateMajorVersion(String templateMajorVersion) {
  ...
  public DeleteEnvironmentOutputEnvironment templateMinorVersion(String templateMinorVersion) {
  ...
  public DeleteEnvironmentOutputEnvironment templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteEnvironmentOutputEnvironment deleteEnvironmentOutputEnvironment = (DeleteEnvironmentOutputEnvironment) o;
    return Objects.equals(this.arn, deleteEnvironmentOutputEnvironment.arn) &&
        Objects.equals(this.codebuildRoleArn, deleteEnvironmentOutputEnvironment.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, deleteEnvironmentOutputEnvironment.componentRoleArn) &&
        Objects.equals(this.createdAt, deleteEnvironmentOutputEnvironment.createdAt) &&
        Objects.equals(this.deploymentStatus, deleteEnvironmentOutputEnvironment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, deleteEnvironmentOutputEnvironment.deploymentStatusMessage) &&
        Objects.equals(this.description, deleteEnvironmentOutputEnvironment.description) &&
        Objects.equals(this.environmentAccountConnectionId, deleteEnvironmentOutputEnvironment.environmentAccountConnectionId) &&
        Objects.equals(this.environmentAccountId, deleteEnvironmentOutputEnvironment.environmentAccountId) &&
        Objects.equals(this.lastAttemptedDeploymentId, deleteEnvironmentOutputEnvironment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, deleteEnvironmentOutputEnvironment.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, deleteEnvironmentOutputEnvironment.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, deleteEnvironmentOutputEnvironment.lastSucceededDeploymentId) &&
        Objects.equals(this.name, deleteEnvironmentOutputEnvironment.name) &&
        Objects.equals(this.protonServiceRoleArn, deleteEnvironmentOutputEnvironment.protonServiceRoleArn) &&
        Objects.equals(this.provisioning, deleteEnvironmentOutputEnvironment.provisioning) &&
        Objects.equals(this.provisioningRepository, deleteEnvironmentOutputEnvironment.provisioningRepository) &&
        Objects.equals(this.spec, deleteEnvironmentOutputEnvironment.spec) &&
        Objects.equals(this.templateMajorVersion, deleteEnvironmentOutputEnvironment.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, deleteEnvironmentOutputEnvironment.templateMinorVersion) &&
        Objects.equals(this.templateName, deleteEnvironmentOutputEnvironment.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteEnvironmentOutputEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteEnvironmentOutputEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteEnvironmentOutputEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteEnvironmentOutputEnvironment is not found in the empty JSON string", DeleteEnvironmentOutputEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteEnvironmentOutputEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteEnvironmentOutputEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteEnvironmentOutputEnvironment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteEnvironmentOutputEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteEnvironmentOutputEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteEnvironmentOutputEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteEnvironmentOutputEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteEnvironmentOutputEnvironment>() {
           @Override
           public void write(JsonWriter out, DeleteEnvironmentOutputEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteEnvironmentOutputEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteEnvironmentOutputEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteEnvironmentOutputEnvironment
   * @throws IOException if the JSON string is invalid with respect to DeleteEnvironmentOutputEnvironment
   */
  public static DeleteEnvironmentOutputEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteEnvironmentOutputEnvironment.class);
  }

  /**
   * Convert an instance of DeleteEnvironmentOutputEnvironment to an JSON string
   *
   * @return JSON string
   */
