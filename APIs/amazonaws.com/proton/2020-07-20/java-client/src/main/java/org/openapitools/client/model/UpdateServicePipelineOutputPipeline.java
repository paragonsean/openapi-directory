...
public class UpdateServicePipelineOutputPipeline {
  ...
  public UpdateServicePipelineOutputPipeline() {
  }

  public UpdateServicePipelineOutputPipeline arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateServicePipelineOutputPipeline createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateServicePipelineOutputPipeline deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public UpdateServicePipelineOutputPipeline deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public UpdateServicePipelineOutputPipeline lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public UpdateServicePipelineOutputPipeline lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public UpdateServicePipelineOutputPipeline lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public UpdateServicePipelineOutputPipeline lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public UpdateServicePipelineOutputPipeline spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public UpdateServicePipelineOutputPipeline templateMajorVersion(String templateMajorVersion) {
  ...
  public UpdateServicePipelineOutputPipeline templateMinorVersion(String templateMinorVersion) {
  ...
  public UpdateServicePipelineOutputPipeline templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateServicePipelineOutputPipeline updateServicePipelineOutputPipeline = (UpdateServicePipelineOutputPipeline) o;
    return Objects.equals(this.arn, updateServicePipelineOutputPipeline.arn) &&
        Objects.equals(this.createdAt, updateServicePipelineOutputPipeline.createdAt) &&
        Objects.equals(this.deploymentStatus, updateServicePipelineOutputPipeline.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, updateServicePipelineOutputPipeline.deploymentStatusMessage) &&
        Objects.equals(this.lastAttemptedDeploymentId, updateServicePipelineOutputPipeline.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, updateServicePipelineOutputPipeline.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, updateServicePipelineOutputPipeline.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, updateServicePipelineOutputPipeline.lastSucceededDeploymentId) &&
        Objects.equals(this.spec, updateServicePipelineOutputPipeline.spec) &&
        Objects.equals(this.templateMajorVersion, updateServicePipelineOutputPipeline.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, updateServicePipelineOutputPipeline.templateMinorVersion) &&
        Objects.equals(this.templateName, updateServicePipelineOutputPipeline.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateServicePipelineOutputPipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateServicePipelineOutputPipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateServicePipelineOutputPipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateServicePipelineOutputPipeline is not found in the empty JSON string", UpdateServicePipelineOutputPipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateServicePipelineOutputPipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateServicePipelineOutputPipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateServicePipelineOutputPipeline.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateServicePipelineOutputPipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateServicePipelineOutputPipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateServicePipelineOutputPipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateServicePipelineOutputPipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateServicePipelineOutputPipeline>() {
           @Override
           public void write(JsonWriter out, UpdateServicePipelineOutputPipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateServicePipelineOutputPipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateServicePipelineOutputPipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateServicePipelineOutputPipeline
   * @throws IOException if the JSON string is invalid with respect to UpdateServicePipelineOutputPipeline
   */
  public static UpdateServicePipelineOutputPipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateServicePipelineOutputPipeline.class);
  }

  /**
   * Convert an instance of UpdateServicePipelineOutputPipeline to an JSON string
   *
   * @return JSON string
   */
