...
public class SyncBlocker {
  ...
  public SyncBlocker contexts(List contexts) {
  ...
  public SyncBlocker createdAt(OffsetDateTime createdAt) {
  ...
  public SyncBlocker createdReason(String createdReason) {
  ...
  public SyncBlocker id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SyncBlocker resolvedAt(OffsetDateTime resolvedAt) {
  ...
  public SyncBlocker resolvedReason(String resolvedReason) {
  ...
  public SyncBlocker status(BlockerStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SyncBlocker type(BlockerType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SyncBlocker syncBlocker = (SyncBlocker) o;
    return Objects.equals(this.contexts, syncBlocker.contexts) &&
        Objects.equals(this.createdAt, syncBlocker.createdAt) &&
        Objects.equals(this.createdReason, syncBlocker.createdReason) &&
        Objects.equals(this.id, syncBlocker.id) &&
        Objects.equals(this.resolvedAt, syncBlocker.resolvedAt) &&
        Objects.equals(this.resolvedReason, syncBlocker.resolvedReason) &&
        Objects.equals(this.status, syncBlocker.status) &&
        Objects.equals(this.type, syncBlocker.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SyncBlocker
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SyncBlocker.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncBlocker is not found in the empty JSON string", SyncBlocker.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SyncBlocker.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SyncBlocker` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncBlocker.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncBlocker.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncBlocker' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncBlocker> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncBlocker.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncBlocker>() {
           @Override
           public void write(JsonWriter out, SyncBlocker value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SyncBlocker read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SyncBlocker given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SyncBlocker
   * @throws IOException if the JSON string is invalid with respect to SyncBlocker
   */
  public static SyncBlocker fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncBlocker.class);
  }

  /**
   * Convert an instance of SyncBlocker to an JSON string
   *
   * @return JSON string
   */
