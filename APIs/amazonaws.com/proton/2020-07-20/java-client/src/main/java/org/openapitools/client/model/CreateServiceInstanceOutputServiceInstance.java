...
public class CreateServiceInstanceOutputServiceInstance {
  ...
  public CreateServiceInstanceOutputServiceInstance() {
  }

  public CreateServiceInstanceOutputServiceInstance arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateServiceInstanceOutputServiceInstance createdAt(OffsetDateTime createdAt) {
  ...
  public CreateServiceInstanceOutputServiceInstance deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CreateServiceInstanceOutputServiceInstance deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CreateServiceInstanceOutputServiceInstance environmentName(String environmentName) {
  ...
  public CreateServiceInstanceOutputServiceInstance lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CreateServiceInstanceOutputServiceInstance lastClientRequestToken(String lastClientRequestToken) {
  ...
  public CreateServiceInstanceOutputServiceInstance lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CreateServiceInstanceOutputServiceInstance lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CreateServiceInstanceOutputServiceInstance lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CreateServiceInstanceOutputServiceInstance name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateServiceInstanceOutputServiceInstance serviceName(String serviceName) {
  ...
  public CreateServiceInstanceOutputServiceInstance spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public CreateServiceInstanceOutputServiceInstance templateMajorVersion(String templateMajorVersion) {
  ...
  public CreateServiceInstanceOutputServiceInstance templateMinorVersion(String templateMinorVersion) {
  ...
  public CreateServiceInstanceOutputServiceInstance templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateServiceInstanceOutputServiceInstance createServiceInstanceOutputServiceInstance = (CreateServiceInstanceOutputServiceInstance) o;
    return Objects.equals(this.arn, createServiceInstanceOutputServiceInstance.arn) &&
        Objects.equals(this.createdAt, createServiceInstanceOutputServiceInstance.createdAt) &&
        Objects.equals(this.deploymentStatus, createServiceInstanceOutputServiceInstance.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, createServiceInstanceOutputServiceInstance.deploymentStatusMessage) &&
        Objects.equals(this.environmentName, createServiceInstanceOutputServiceInstance.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, createServiceInstanceOutputServiceInstance.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, createServiceInstanceOutputServiceInstance.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, createServiceInstanceOutputServiceInstance.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, createServiceInstanceOutputServiceInstance.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, createServiceInstanceOutputServiceInstance.lastSucceededDeploymentId) &&
        Objects.equals(this.name, createServiceInstanceOutputServiceInstance.name) &&
        Objects.equals(this.serviceName, createServiceInstanceOutputServiceInstance.serviceName) &&
        Objects.equals(this.spec, createServiceInstanceOutputServiceInstance.spec) &&
        Objects.equals(this.templateMajorVersion, createServiceInstanceOutputServiceInstance.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, createServiceInstanceOutputServiceInstance.templateMinorVersion) &&
        Objects.equals(this.templateName, createServiceInstanceOutputServiceInstance.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateServiceInstanceOutputServiceInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServiceInstanceOutputServiceInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServiceInstanceOutputServiceInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServiceInstanceOutputServiceInstance is not found in the empty JSON string", CreateServiceInstanceOutputServiceInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServiceInstanceOutputServiceInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServiceInstanceOutputServiceInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateServiceInstanceOutputServiceInstance.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServiceInstanceOutputServiceInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServiceInstanceOutputServiceInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServiceInstanceOutputServiceInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServiceInstanceOutputServiceInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServiceInstanceOutputServiceInstance>() {
           @Override
           public void write(JsonWriter out, CreateServiceInstanceOutputServiceInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServiceInstanceOutputServiceInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServiceInstanceOutputServiceInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServiceInstanceOutputServiceInstance
   * @throws IOException if the JSON string is invalid with respect to CreateServiceInstanceOutputServiceInstance
   */
  public static CreateServiceInstanceOutputServiceInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServiceInstanceOutputServiceInstance.class);
  }

  /**
   * Convert an instance of CreateServiceInstanceOutputServiceInstance to an JSON string
   *
   * @return JSON string
   */
