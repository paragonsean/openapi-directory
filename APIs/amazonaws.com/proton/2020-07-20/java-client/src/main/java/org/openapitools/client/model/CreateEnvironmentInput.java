...
import org.openapitools.client.model.CreateEnvironmentInputProvisioningRepository;
...
public class CreateEnvironmentInput {
  ...
  private CreateEnvironmentInputProvisioningRepository provisioningRepository;
  ...
  public CreateEnvironmentInput codebuildRoleArn(String codebuildRoleArn) {
  ...
  public CreateEnvironmentInput componentRoleArn(String componentRoleArn) {
  ...
  public CreateEnvironmentInput description(String description) {
  ...
  public CreateEnvironmentInput environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public CreateEnvironmentInput name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateEnvironmentInput protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public CreateEnvironmentInput provisioningRepository(CreateEnvironmentInputProvisioningRepository provisioningRepository) {
   ...
   */
  @javax.annotation.Nullable
  public CreateEnvironmentInputProvisioningRepository getProvisioningRepository() {
    return provisioningRepository;
  }

  public void setProvisioningRepository(CreateEnvironmentInputProvisioningRepository provisioningRepository) {
    this.provisioningRepository = provisioningRepository;
  }


  public CreateEnvironmentInput spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public CreateEnvironmentInput tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateEnvironmentInput templateMajorVersion(String templateMajorVersion) {
  ...
  public CreateEnvironmentInput templateMinorVersion(String templateMinorVersion) {
  ...
  public CreateEnvironmentInput templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codebuildRoleArn, createEnvironmentInput.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, createEnvironmentInput.componentRoleArn) &&
        Objects.equals(this.description, createEnvironmentInput.description) &&
        Objects.equals(this.environmentAccountConnectionId, createEnvironmentInput.environmentAccountConnectionId) &&
        Objects.equals(this.name, createEnvironmentInput.name) &&
        Objects.equals(this.protonServiceRoleArn, createEnvironmentInput.protonServiceRoleArn) &&
        Objects.equals(this.provisioningRepository, createEnvironmentInput.provisioningRepository) &&
        Objects.equals(this.spec, createEnvironmentInput.spec) &&
        Objects.equals(this.tags, createEnvironmentInput.tags) &&
        Objects.equals(this.templateMajorVersion, createEnvironmentInput.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, createEnvironmentInput.templateMinorVersion) &&
        Objects.equals(this.templateName, createEnvironmentInput.templateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codebuildRoleArn, componentRoleArn, description, environmentAccountConnectionId, name, protonServiceRoleArn, provisioningRepository, spec, tags, templateMajorVersion, templateMinorVersion, templateName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("provisioningRepository") != null && !jsonObj.get("provisioningRepository").isJsonNull()) {
        CreateEnvironmentInputProvisioningRepository.validateJsonElement(jsonObj.get("provisioningRepository"));
      }
