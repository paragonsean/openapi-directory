...
public class CancelComponentDeploymentOutputComponent {
  ...
  public CancelComponentDeploymentOutputComponent() {
  }

  public CancelComponentDeploymentOutputComponent arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CancelComponentDeploymentOutputComponent createdAt(OffsetDateTime createdAt) {
  ...
  public CancelComponentDeploymentOutputComponent deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public CancelComponentDeploymentOutputComponent deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public CancelComponentDeploymentOutputComponent description(String description) {
  ...
  public CancelComponentDeploymentOutputComponent environmentName(String environmentName) {
  ...
  public CancelComponentDeploymentOutputComponent lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public CancelComponentDeploymentOutputComponent lastClientRequestToken(String lastClientRequestToken) {
  ...
  public CancelComponentDeploymentOutputComponent lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public CancelComponentDeploymentOutputComponent lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public CancelComponentDeploymentOutputComponent lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public CancelComponentDeploymentOutputComponent lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public CancelComponentDeploymentOutputComponent name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CancelComponentDeploymentOutputComponent serviceInstanceName(String serviceInstanceName) {
  ...
  public CancelComponentDeploymentOutputComponent serviceName(String serviceName) {
  ...
  public CancelComponentDeploymentOutputComponent serviceSpec(String serviceSpec) {
  ...
  public boolean equals(Object o) {
    ...
    CancelComponentDeploymentOutputComponent cancelComponentDeploymentOutputComponent = (CancelComponentDeploymentOutputComponent) o;
    return Objects.equals(this.arn, cancelComponentDeploymentOutputComponent.arn) &&
        Objects.equals(this.createdAt, cancelComponentDeploymentOutputComponent.createdAt) &&
        Objects.equals(this.deploymentStatus, cancelComponentDeploymentOutputComponent.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, cancelComponentDeploymentOutputComponent.deploymentStatusMessage) &&
        Objects.equals(this.description, cancelComponentDeploymentOutputComponent.description) &&
        Objects.equals(this.environmentName, cancelComponentDeploymentOutputComponent.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, cancelComponentDeploymentOutputComponent.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, cancelComponentDeploymentOutputComponent.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, cancelComponentDeploymentOutputComponent.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, cancelComponentDeploymentOutputComponent.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastModifiedAt, cancelComponentDeploymentOutputComponent.lastModifiedAt) &&
        Objects.equals(this.lastSucceededDeploymentId, cancelComponentDeploymentOutputComponent.lastSucceededDeploymentId) &&
        Objects.equals(this.name, cancelComponentDeploymentOutputComponent.name) &&
        Objects.equals(this.serviceInstanceName, cancelComponentDeploymentOutputComponent.serviceInstanceName) &&
        Objects.equals(this.serviceName, cancelComponentDeploymentOutputComponent.serviceName) &&
        Objects.equals(this.serviceSpec, cancelComponentDeploymentOutputComponent.serviceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelComponentDeploymentOutputComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelComponentDeploymentOutputComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelComponentDeploymentOutputComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelComponentDeploymentOutputComponent is not found in the empty JSON string", CancelComponentDeploymentOutputComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelComponentDeploymentOutputComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelComponentDeploymentOutputComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CancelComponentDeploymentOutputComponent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelComponentDeploymentOutputComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelComponentDeploymentOutputComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelComponentDeploymentOutputComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelComponentDeploymentOutputComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelComponentDeploymentOutputComponent>() {
           @Override
           public void write(JsonWriter out, CancelComponentDeploymentOutputComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelComponentDeploymentOutputComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelComponentDeploymentOutputComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelComponentDeploymentOutputComponent
   * @throws IOException if the JSON string is invalid with respect to CancelComponentDeploymentOutputComponent
   */
  public static CancelComponentDeploymentOutputComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelComponentDeploymentOutputComponent.class);
  }

  /**
   * Convert an instance of CancelComponentDeploymentOutputComponent to an JSON string
   *
   * @return JSON string
   */
