...
public class DeleteComponentOutputComponent {
  ...
  public DeleteComponentOutputComponent() {
  }

  public DeleteComponentOutputComponent arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteComponentOutputComponent createdAt(OffsetDateTime createdAt) {
  ...
  public DeleteComponentOutputComponent deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public DeleteComponentOutputComponent deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public DeleteComponentOutputComponent description(String description) {
  ...
  public DeleteComponentOutputComponent environmentName(String environmentName) {
  ...
  public DeleteComponentOutputComponent lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public DeleteComponentOutputComponent lastClientRequestToken(String lastClientRequestToken) {
  ...
  public DeleteComponentOutputComponent lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public DeleteComponentOutputComponent lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public DeleteComponentOutputComponent lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public DeleteComponentOutputComponent lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public DeleteComponentOutputComponent name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteComponentOutputComponent serviceInstanceName(String serviceInstanceName) {
  ...
  public DeleteComponentOutputComponent serviceName(String serviceName) {
  ...
  public DeleteComponentOutputComponent serviceSpec(String serviceSpec) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteComponentOutputComponent deleteComponentOutputComponent = (DeleteComponentOutputComponent) o;
    return Objects.equals(this.arn, deleteComponentOutputComponent.arn) &&
        Objects.equals(this.createdAt, deleteComponentOutputComponent.createdAt) &&
        Objects.equals(this.deploymentStatus, deleteComponentOutputComponent.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, deleteComponentOutputComponent.deploymentStatusMessage) &&
        Objects.equals(this.description, deleteComponentOutputComponent.description) &&
        Objects.equals(this.environmentName, deleteComponentOutputComponent.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, deleteComponentOutputComponent.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, deleteComponentOutputComponent.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, deleteComponentOutputComponent.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, deleteComponentOutputComponent.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastModifiedAt, deleteComponentOutputComponent.lastModifiedAt) &&
        Objects.equals(this.lastSucceededDeploymentId, deleteComponentOutputComponent.lastSucceededDeploymentId) &&
        Objects.equals(this.name, deleteComponentOutputComponent.name) &&
        Objects.equals(this.serviceInstanceName, deleteComponentOutputComponent.serviceInstanceName) &&
        Objects.equals(this.serviceName, deleteComponentOutputComponent.serviceName) &&
        Objects.equals(this.serviceSpec, deleteComponentOutputComponent.serviceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteComponentOutputComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteComponentOutputComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteComponentOutputComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteComponentOutputComponent is not found in the empty JSON string", DeleteComponentOutputComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteComponentOutputComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteComponentOutputComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteComponentOutputComponent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteComponentOutputComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteComponentOutputComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteComponentOutputComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteComponentOutputComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteComponentOutputComponent>() {
           @Override
           public void write(JsonWriter out, DeleteComponentOutputComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteComponentOutputComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteComponentOutputComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteComponentOutputComponent
   * @throws IOException if the JSON string is invalid with respect to DeleteComponentOutputComponent
   */
  public static DeleteComponentOutputComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteComponentOutputComponent.class);
  }

  /**
   * Convert an instance of DeleteComponentOutputComponent to an JSON string
   *
   * @return JSON string
   */
