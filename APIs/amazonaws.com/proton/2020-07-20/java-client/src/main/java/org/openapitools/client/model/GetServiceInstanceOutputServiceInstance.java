...
public class GetServiceInstanceOutputServiceInstance {
  ...
  public GetServiceInstanceOutputServiceInstance() {
  }

  public GetServiceInstanceOutputServiceInstance arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetServiceInstanceOutputServiceInstance createdAt(OffsetDateTime createdAt) {
  ...
  public GetServiceInstanceOutputServiceInstance deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public GetServiceInstanceOutputServiceInstance deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public GetServiceInstanceOutputServiceInstance environmentName(String environmentName) {
  ...
  public GetServiceInstanceOutputServiceInstance lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public GetServiceInstanceOutputServiceInstance lastClientRequestToken(String lastClientRequestToken) {
  ...
  public GetServiceInstanceOutputServiceInstance lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public GetServiceInstanceOutputServiceInstance lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public GetServiceInstanceOutputServiceInstance lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public GetServiceInstanceOutputServiceInstance name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetServiceInstanceOutputServiceInstance serviceName(String serviceName) {
  ...
  public GetServiceInstanceOutputServiceInstance spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public GetServiceInstanceOutputServiceInstance templateMajorVersion(String templateMajorVersion) {
  ...
  public GetServiceInstanceOutputServiceInstance templateMinorVersion(String templateMinorVersion) {
  ...
  public GetServiceInstanceOutputServiceInstance templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    GetServiceInstanceOutputServiceInstance getServiceInstanceOutputServiceInstance = (GetServiceInstanceOutputServiceInstance) o;
    return Objects.equals(this.arn, getServiceInstanceOutputServiceInstance.arn) &&
        Objects.equals(this.createdAt, getServiceInstanceOutputServiceInstance.createdAt) &&
        Objects.equals(this.deploymentStatus, getServiceInstanceOutputServiceInstance.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, getServiceInstanceOutputServiceInstance.deploymentStatusMessage) &&
        Objects.equals(this.environmentName, getServiceInstanceOutputServiceInstance.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, getServiceInstanceOutputServiceInstance.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, getServiceInstanceOutputServiceInstance.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, getServiceInstanceOutputServiceInstance.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, getServiceInstanceOutputServiceInstance.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, getServiceInstanceOutputServiceInstance.lastSucceededDeploymentId) &&
        Objects.equals(this.name, getServiceInstanceOutputServiceInstance.name) &&
        Objects.equals(this.serviceName, getServiceInstanceOutputServiceInstance.serviceName) &&
        Objects.equals(this.spec, getServiceInstanceOutputServiceInstance.spec) &&
        Objects.equals(this.templateMajorVersion, getServiceInstanceOutputServiceInstance.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, getServiceInstanceOutputServiceInstance.templateMinorVersion) &&
        Objects.equals(this.templateName, getServiceInstanceOutputServiceInstance.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetServiceInstanceOutputServiceInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetServiceInstanceOutputServiceInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetServiceInstanceOutputServiceInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetServiceInstanceOutputServiceInstance is not found in the empty JSON string", GetServiceInstanceOutputServiceInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetServiceInstanceOutputServiceInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetServiceInstanceOutputServiceInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetServiceInstanceOutputServiceInstance.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetServiceInstanceOutputServiceInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetServiceInstanceOutputServiceInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetServiceInstanceOutputServiceInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetServiceInstanceOutputServiceInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<GetServiceInstanceOutputServiceInstance>() {
           @Override
           public void write(JsonWriter out, GetServiceInstanceOutputServiceInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetServiceInstanceOutputServiceInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetServiceInstanceOutputServiceInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetServiceInstanceOutputServiceInstance
   * @throws IOException if the JSON string is invalid with respect to GetServiceInstanceOutputServiceInstance
   */
  public static GetServiceInstanceOutputServiceInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetServiceInstanceOutputServiceInstance.class);
  }

  /**
   * Convert an instance of GetServiceInstanceOutputServiceInstance to an JSON string
   *
   * @return JSON string
   */
