...
public class ServicePipeline {
  ...
  public ServicePipeline arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ServicePipeline createdAt(OffsetDateTime createdAt) {
  ...
  public ServicePipeline deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public ServicePipeline deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public ServicePipeline lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public ServicePipeline lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public ServicePipeline lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public ServicePipeline lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public ServicePipeline spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public ServicePipeline templateMajorVersion(String templateMajorVersion) {
  ...
  public ServicePipeline templateMinorVersion(String templateMinorVersion) {
  ...
  public ServicePipeline templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    ServicePipeline servicePipeline = (ServicePipeline) o;
    return Objects.equals(this.arn, servicePipeline.arn) &&
        Objects.equals(this.createdAt, servicePipeline.createdAt) &&
        Objects.equals(this.deploymentStatus, servicePipeline.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, servicePipeline.deploymentStatusMessage) &&
        Objects.equals(this.lastAttemptedDeploymentId, servicePipeline.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, servicePipeline.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, servicePipeline.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, servicePipeline.lastSucceededDeploymentId) &&
        Objects.equals(this.spec, servicePipeline.spec) &&
        Objects.equals(this.templateMajorVersion, servicePipeline.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, servicePipeline.templateMinorVersion) &&
        Objects.equals(this.templateName, servicePipeline.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServicePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServicePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServicePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServicePipeline is not found in the empty JSON string", ServicePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServicePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServicePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServicePipeline.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServicePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServicePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServicePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServicePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<ServicePipeline>() {
           @Override
           public void write(JsonWriter out, ServicePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServicePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServicePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServicePipeline
   * @throws IOException if the JSON string is invalid with respect to ServicePipeline
   */
  public static ServicePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServicePipeline.class);
  }

  /**
   * Convert an instance of ServicePipeline to an JSON string
   *
   * @return JSON string
   */
