...
public class UpdateComponentOutputComponent {
  ...
  public UpdateComponentOutputComponent() {
  }

  public UpdateComponentOutputComponent arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateComponentOutputComponent createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateComponentOutputComponent deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public UpdateComponentOutputComponent deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public UpdateComponentOutputComponent description(String description) {
  ...
  public UpdateComponentOutputComponent environmentName(String environmentName) {
  ...
  public UpdateComponentOutputComponent lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public UpdateComponentOutputComponent lastClientRequestToken(String lastClientRequestToken) {
  ...
  public UpdateComponentOutputComponent lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public UpdateComponentOutputComponent lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public UpdateComponentOutputComponent lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public UpdateComponentOutputComponent lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public UpdateComponentOutputComponent name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateComponentOutputComponent serviceInstanceName(String serviceInstanceName) {
  ...
  public UpdateComponentOutputComponent serviceName(String serviceName) {
  ...
  public UpdateComponentOutputComponent serviceSpec(String serviceSpec) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateComponentOutputComponent updateComponentOutputComponent = (UpdateComponentOutputComponent) o;
    return Objects.equals(this.arn, updateComponentOutputComponent.arn) &&
        Objects.equals(this.createdAt, updateComponentOutputComponent.createdAt) &&
        Objects.equals(this.deploymentStatus, updateComponentOutputComponent.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, updateComponentOutputComponent.deploymentStatusMessage) &&
        Objects.equals(this.description, updateComponentOutputComponent.description) &&
        Objects.equals(this.environmentName, updateComponentOutputComponent.environmentName) &&
        Objects.equals(this.lastAttemptedDeploymentId, updateComponentOutputComponent.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastClientRequestToken, updateComponentOutputComponent.lastClientRequestToken) &&
        Objects.equals(this.lastDeploymentAttemptedAt, updateComponentOutputComponent.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, updateComponentOutputComponent.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastModifiedAt, updateComponentOutputComponent.lastModifiedAt) &&
        Objects.equals(this.lastSucceededDeploymentId, updateComponentOutputComponent.lastSucceededDeploymentId) &&
        Objects.equals(this.name, updateComponentOutputComponent.name) &&
        Objects.equals(this.serviceInstanceName, updateComponentOutputComponent.serviceInstanceName) &&
        Objects.equals(this.serviceName, updateComponentOutputComponent.serviceName) &&
        Objects.equals(this.serviceSpec, updateComponentOutputComponent.serviceSpec);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateComponentOutputComponent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateComponentOutputComponent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateComponentOutputComponent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateComponentOutputComponent is not found in the empty JSON string", UpdateComponentOutputComponent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateComponentOutputComponent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateComponentOutputComponent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateComponentOutputComponent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateComponentOutputComponent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateComponentOutputComponent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateComponentOutputComponent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateComponentOutputComponent.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateComponentOutputComponent>() {
           @Override
           public void write(JsonWriter out, UpdateComponentOutputComponent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateComponentOutputComponent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateComponentOutputComponent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateComponentOutputComponent
   * @throws IOException if the JSON string is invalid with respect to UpdateComponentOutputComponent
   */
  public static UpdateComponentOutputComponent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateComponentOutputComponent.class);
  }

  /**
   * Convert an instance of UpdateComponentOutputComponent to an JSON string
   *
   * @return JSON string
   */
