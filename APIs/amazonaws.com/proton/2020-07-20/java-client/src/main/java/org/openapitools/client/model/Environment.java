...
import org.openapitools.client.model.EnvironmentProvisioningRepository;
...
public class Environment {
  ...
  private EnvironmentProvisioningRepository provisioningRepository;
  ...
  public Environment codebuildRoleArn(String codebuildRoleArn) {
  ...
  public Environment componentRoleArn(String componentRoleArn) {
  ...
  public Environment deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public Environment deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public Environment environmentAccountConnectionId(String environmentAccountConnectionId) {
  ...
  public Environment environmentAccountId(String environmentAccountId) {
  ...
  public Environment lastAttemptedDeploymentId(String lastAttemptedDeploymentId) {
  ...
  public Environment lastDeploymentAttemptedAt(OffsetDateTime lastDeploymentAttemptedAt) {
  ...
  public Environment lastDeploymentSucceededAt(OffsetDateTime lastDeploymentSucceededAt) {
  ...
  public Environment lastSucceededDeploymentId(String lastSucceededDeploymentId) {
  ...
  public Environment protonServiceRoleArn(String protonServiceRoleArn) {
  ...
  public Environment provisioning(Provisioning provisioning) {
  ...
  public Environment provisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
   ...
   */
  @javax.annotation.Nullable
  public EnvironmentProvisioningRepository getProvisioningRepository() {
    return provisioningRepository;
  }

  public void setProvisioningRepository(EnvironmentProvisioningRepository provisioningRepository) {
    this.provisioningRepository = provisioningRepository;
  }


  public Environment spec(String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public Environment templateMajorVersion(String templateMajorVersion) {
  ...
  public Environment templateMinorVersion(String templateMinorVersion) {
  ...
  public Environment templateName(String templateName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arn, environment.arn) &&
        Objects.equals(this.codebuildRoleArn, environment.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, environment.componentRoleArn) &&
        Objects.equals(this.createdAt, environment.createdAt) &&
        Objects.equals(this.deploymentStatus, environment.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, environment.deploymentStatusMessage) &&
        Objects.equals(this.description, environment.description) &&
        Objects.equals(this.environmentAccountConnectionId, environment.environmentAccountConnectionId) &&
        Objects.equals(this.environmentAccountId, environment.environmentAccountId) &&
        Objects.equals(this.lastAttemptedDeploymentId, environment.lastAttemptedDeploymentId) &&
        Objects.equals(this.lastDeploymentAttemptedAt, environment.lastDeploymentAttemptedAt) &&
        Objects.equals(this.lastDeploymentSucceededAt, environment.lastDeploymentSucceededAt) &&
        Objects.equals(this.lastSucceededDeploymentId, environment.lastSucceededDeploymentId) &&
        Objects.equals(this.name, environment.name) &&
        Objects.equals(this.protonServiceRoleArn, environment.protonServiceRoleArn) &&
        Objects.equals(this.provisioning, environment.provisioning) &&
        Objects.equals(this.provisioningRepository, environment.provisioningRepository) &&
        Objects.equals(this.spec, environment.spec) &&
        Objects.equals(this.templateMajorVersion, environment.templateMajorVersion) &&
        Objects.equals(this.templateMinorVersion, environment.templateMinorVersion) &&
        Objects.equals(this.templateName, environment.templateName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arn, codebuildRoleArn, componentRoleArn, createdAt, deploymentStatus, deploymentStatusMessage, description, environmentAccountConnectionId, environmentAccountId, lastAttemptedDeploymentId, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, lastSucceededDeploymentId, name, protonServiceRoleArn, provisioning, provisioningRepository, spec, templateMajorVersion, templateMinorVersion, templateName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("provisioningRepository") != null && !jsonObj.get("provisioningRepository").isJsonNull()) {
        EnvironmentProvisioningRepository.validateJsonElement(jsonObj.get("provisioningRepository"));
      }
