...
public class EnvironmentAccountConnection {
  ...
  public EnvironmentAccountConnection() {
  }

  public EnvironmentAccountConnection arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public EnvironmentAccountConnection codebuildRoleArn(String codebuildRoleArn) {
  ...
  public EnvironmentAccountConnection componentRoleArn(String componentRoleArn) {
  ...
  public EnvironmentAccountConnection environmentAccountId(String environmentAccountId) {
  ...
  public EnvironmentAccountConnection environmentName(String environmentName) {
  ...
  public EnvironmentAccountConnection id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EnvironmentAccountConnection lastModifiedAt(OffsetDateTime lastModifiedAt) {
  ...
  public EnvironmentAccountConnection managementAccountId(String managementAccountId) {
  ...
  public EnvironmentAccountConnection requestedAt(OffsetDateTime requestedAt) {
  ...
  public EnvironmentAccountConnection roleArn(String roleArn) {
  ...
  public EnvironmentAccountConnection status(EnvironmentAccountConnectionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnvironmentAccountConnection environmentAccountConnection = (EnvironmentAccountConnection) o;
    return Objects.equals(this.arn, environmentAccountConnection.arn) &&
        Objects.equals(this.codebuildRoleArn, environmentAccountConnection.codebuildRoleArn) &&
        Objects.equals(this.componentRoleArn, environmentAccountConnection.componentRoleArn) &&
        Objects.equals(this.environmentAccountId, environmentAccountConnection.environmentAccountId) &&
        Objects.equals(this.environmentName, environmentAccountConnection.environmentName) &&
        Objects.equals(this.id, environmentAccountConnection.id) &&
        Objects.equals(this.lastModifiedAt, environmentAccountConnection.lastModifiedAt) &&
        Objects.equals(this.managementAccountId, environmentAccountConnection.managementAccountId) &&
        Objects.equals(this.requestedAt, environmentAccountConnection.requestedAt) &&
        Objects.equals(this.roleArn, environmentAccountConnection.roleArn) &&
        Objects.equals(this.status, environmentAccountConnection.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvironmentAccountConnection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnvironmentAccountConnection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentAccountConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnvironmentAccountConnection is not found in the empty JSON string", EnvironmentAccountConnection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnvironmentAccountConnection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvironmentAccountConnection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnvironmentAccountConnection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnvironmentAccountConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnvironmentAccountConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnvironmentAccountConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnvironmentAccountConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<EnvironmentAccountConnection>() {
           @Override
           public void write(JsonWriter out, EnvironmentAccountConnection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnvironmentAccountConnection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnvironmentAccountConnection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnvironmentAccountConnection
   * @throws IOException if the JSON string is invalid with respect to EnvironmentAccountConnection
   */
  public static EnvironmentAccountConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnvironmentAccountConnection.class);
  }

  /**
   * Convert an instance of EnvironmentAccountConnection to an JSON string
   *
   * @return JSON string
   */
