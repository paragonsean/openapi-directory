...
/**
 * The UpdateServicePipelineOutputPipeline model module.
 * @module model/UpdateServicePipelineOutputPipeline
 * @version 2020-07-20
 */
class UpdateServicePipelineOutputPipeline {
    /**
     * Constructs a new <code>UpdateServicePipelineOutputPipeline</code>.
     * @alias module:model/UpdateServicePipelineOutputPipeline
    ...
    constructor(arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, templateMajorVersion, templateMinorVersion, templateName) { 
        ...
        UpdateServicePipelineOutputPipeline.initialize(this, arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, templateMajorVersion, templateMinorVersion, templateName);
    }
    ...
    /**
     * Constructs a <code>UpdateServicePipelineOutputPipeline</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateServicePipelineOutputPipeline} obj Optional instance to populate.
     * @return {module:model/UpdateServicePipelineOutputPipeline} The populated <code>UpdateServicePipelineOutputPipeline</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateServicePipelineOutputPipeline();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateServicePipelineOutputPipeline</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateServicePipelineOutputPipeline</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateServicePipelineOutputPipeline.RequiredProperties) {
...
UpdateServicePipelineOutputPipeline.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "templateMajorVersion", "templateMinorVersion", "templateName"];

/**
 * @member {String} arn
 */
UpdateServicePipelineOutputPipeline.prototype['arn'] = undefined;

/**
 * @member {Date} createdAt
 */
UpdateServicePipelineOutputPipeline.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
UpdateServicePipelineOutputPipeline.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
UpdateServicePipelineOutputPipeline.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
UpdateServicePipelineOutputPipeline.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastDeploymentAttemptedAt
 */
UpdateServicePipelineOutputPipeline.prototype['lastDeploymentAttemptedAt'] = undefined;

/**
 * @member {Date} lastDeploymentSucceededAt
 */
UpdateServicePipelineOutputPipeline.prototype['lastDeploymentSucceededAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
UpdateServicePipelineOutputPipeline.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} spec
 */
UpdateServicePipelineOutputPipeline.prototype['spec'] = undefined;

/**
 * @member {String} templateMajorVersion
 */
UpdateServicePipelineOutputPipeline.prototype['templateMajorVersion'] = undefined;

/**
 * @member {String} templateMinorVersion
 */
UpdateServicePipelineOutputPipeline.prototype['templateMinorVersion'] = undefined;

/**
 * @member {String} templateName
 */
UpdateServicePipelineOutputPipeline.prototype['templateName'] = undefined;
...
export default UpdateServicePipelineOutputPipeline;
