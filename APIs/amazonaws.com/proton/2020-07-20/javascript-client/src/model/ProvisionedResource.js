...
import ProvisionedResourceEngine from './ProvisionedResourceEngine';
...
class ProvisionedResource {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('provisioningEngine')) {
                obj['provisioningEngine'] = ApiClient.convertToType(data['provisioningEngine'], ProvisionedResourceEngine);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `provisioningEngine`
        if (data['provisioningEngine']) { // data not null
          ProvisionedResourceEngine.validateJSON(data['provisioningEngine']);
        }
 ...
 */
ProvisionedResource.prototype['identifier'] = undefined;

/**
 * @member {String} name
 */
ProvisionedResource.prototype['name'] = undefined;

/**
 * @member {module:model/ProvisionedResourceEngine} provisioningEngine
 */
ProvisionedResource.prototype['provisioningEngine'] = undefined;
