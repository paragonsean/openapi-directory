...
/**
 * The ListDeploymentsInput model module.
 * @module model/ListDeploymentsInput
 * @version 2020-07-20
 */
class ListDeploymentsInput {
    /**
     * Constructs a new <code>ListDeploymentsInput</code>.
     * @alias module:model/ListDeploymentsInput
     */
    constructor() { 
        
        ListDeploymentsInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDeploymentsInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDeploymentsInput} obj Optional instance to populate.
     * @return {module:model/ListDeploymentsInput} The populated <code>ListDeploymentsInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDeploymentsInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDeploymentsInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDeploymentsInput</code>.
     */
 ...
 */
ListDeploymentsInput.prototype['componentName'] = undefined;

/**
 * @member {String} environmentName
 */
ListDeploymentsInput.prototype['environmentName'] = undefined;

/**
 * @member {Number} maxResults
 */
ListDeploymentsInput.prototype['maxResults'] = undefined;

/**
 * @member {String} nextToken
 */
ListDeploymentsInput.prototype['nextToken'] = undefined;

/**
 * @member {String} serviceInstanceName
 */
ListDeploymentsInput.prototype['serviceInstanceName'] = undefined;

/**
 * @member {String} serviceName
 */
ListDeploymentsInput.prototype['serviceName'] = undefined;
...
export default ListDeploymentsInput;
