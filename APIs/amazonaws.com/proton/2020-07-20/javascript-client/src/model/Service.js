...
class Service {
     ...
     */
    constructor(arn, createdAt, lastModifiedAt, name, spec, status, templateName) { 
        
        Service.initialize(this, arn, createdAt, lastModifiedAt, name, spec, status, templateName);
    }
     ...
     */
    static initialize(obj, arn, createdAt, lastModifiedAt, name, spec, status, templateName) { 
        obj['arn'] = arn;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pipeline')) {
                obj['pipeline'] = ServicePipeline.constructFromObject(data['pipeline']);
            }
            if (data.hasOwnProperty('repositoryConnectionArn')) {
                obj['repositoryConnectionArn'] = ApiClient.convertToType(data['repositoryConnectionArn'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['pipeline']) { // data not null
          ServicePipeline.validateJSON(data['pipeline']);
        }
        // validate the optional field `repositoryConnectionArn`
        if (data['repositoryConnectionArn']) { // data not null
          String.validateJSON(data['repositoryConnectionArn']);
        }
...
Service.RequiredProperties = ["arn", "createdAt", "lastModifiedAt", "name", "spec", "status", "templateName"];
 ...
 */
Service.prototype['branchName'] = undefined;
 ...
 */
Service.prototype['lastModifiedAt'] = undefined;
...
/**
 * @member {module:model/ServicePipeline} pipeline
 */
Service.prototype['pipeline'] = undefined;

/**
 * @member {String} repositoryConnectionArn
 */
Service.prototype['repositoryConnectionArn'] = undefined;

/**
 * @member {String} repositoryId
 */
Service.prototype['repositoryId'] = undefined;
 ...
 */
Service.prototype['statusMessage'] = undefined;

/**
 * @member {String} templateName
 */
Service.prototype['templateName'] = undefined;
