...
/**
 * The DeleteDeploymentOutputDeployment model module.
 * @module model/DeleteDeploymentOutputDeployment
 * @version 2020-07-20
 */
class DeleteDeploymentOutputDeployment {
    /**
     * Constructs a new <code>DeleteDeploymentOutputDeployment</code>.
     * @alias module:model/DeleteDeploymentOutputDeployment
    ...
    constructor(arn, createdAt, deploymentStatus, environmentName, id, lastModifiedAt, targetArn, targetResourceCreatedAt, targetResourceType) { 
        ...
        DeleteDeploymentOutputDeployment.initialize(this, arn, createdAt, deploymentStatus, environmentName, id, lastModifiedAt, targetArn, targetResourceCreatedAt, targetResourceType);
    }
    ...
    /**
     * Constructs a <code>DeleteDeploymentOutputDeployment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDeploymentOutputDeployment} obj Optional instance to populate.
     * @return {module:model/DeleteDeploymentOutputDeployment} The populated <code>DeleteDeploymentOutputDeployment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDeploymentOutputDeployment();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDeploymentOutputDeployment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDeploymentOutputDeployment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteDeploymentOutputDeployment.RequiredProperties) {
...
DeleteDeploymentOutputDeployment.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "environmentName", "id", "lastModifiedAt", "targetArn", "targetResourceCreatedAt", "targetResourceType"];

/**
 * @member {String} arn
 */
DeleteDeploymentOutputDeployment.prototype['arn'] = undefined;

/**
 * @member {Date} completedAt
 */
DeleteDeploymentOutputDeployment.prototype['completedAt'] = undefined;

/**
 * @member {String} componentName
 */
DeleteDeploymentOutputDeployment.prototype['componentName'] = undefined;

/**
 * @member {Date} createdAt
 */
DeleteDeploymentOutputDeployment.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
DeleteDeploymentOutputDeployment.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
DeleteDeploymentOutputDeployment.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} environmentName
 */
DeleteDeploymentOutputDeployment.prototype['environmentName'] = undefined;

/**
 * @member {String} id
 */
DeleteDeploymentOutputDeployment.prototype['id'] = undefined;

/**
 * @member {module:model/DeploymentInitialState} initialState
 */
DeleteDeploymentOutputDeployment.prototype['initialState'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
DeleteDeploymentOutputDeployment.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastModifiedAt
 */
DeleteDeploymentOutputDeployment.prototype['lastModifiedAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
DeleteDeploymentOutputDeployment.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} serviceInstanceName
 */
DeleteDeploymentOutputDeployment.prototype['serviceInstanceName'] = undefined;

/**
 * @member {String} serviceName
 */
DeleteDeploymentOutputDeployment.prototype['serviceName'] = undefined;

/**
 * @member {String} targetArn
 */
DeleteDeploymentOutputDeployment.prototype['targetArn'] = undefined;

/**
 * @member {Date} targetResourceCreatedAt
 */
DeleteDeploymentOutputDeployment.prototype['targetResourceCreatedAt'] = undefined;

/**
 * @member {module:model/DeploymentTargetResourceType} targetResourceType
 */
DeleteDeploymentOutputDeployment.prototype['targetResourceType'] = undefined;

/**
 * @member {module:model/DeploymentTargetState} targetState
 */
DeleteDeploymentOutputDeployment.prototype['targetState'] = undefined;
...
export default DeleteDeploymentOutputDeployment;
