...
/**
 * The ServicePipeline model module.
 * @module model/ServicePipeline
 * @version 2020-07-20
 */
class ServicePipeline {
    /**
     * Constructs a new <code>ServicePipeline</code>.
     * @alias module:model/ServicePipeline
    ...
    /**
     * Constructs a <code>ServicePipeline</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServicePipeline} obj Optional instance to populate.
     * @return {module:model/ServicePipeline} The populated <code>ServicePipeline</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServicePipeline();
    ...
    /**
     * Validates the JSON data with respect to <code>ServicePipeline</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServicePipeline</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServicePipeline.RequiredProperties) {
...
ServicePipeline.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "templateMajorVersion", "templateMinorVersion", "templateName"];
