...
/**
 * The CancelEnvironmentDeploymentOutputEnvironment model module.
 * @module model/CancelEnvironmentDeploymentOutputEnvironment
 * @version 2020-07-20
 */
class CancelEnvironmentDeploymentOutputEnvironment {
    /**
     * Constructs a new <code>CancelEnvironmentDeploymentOutputEnvironment</code>.
     * @alias module:model/CancelEnvironmentDeploymentOutputEnvironment
    ...
    constructor(arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName) { 
        ...
        CancelEnvironmentDeploymentOutputEnvironment.initialize(this, arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName);
    }
    ...
    /**
     * Constructs a <code>CancelEnvironmentDeploymentOutputEnvironment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelEnvironmentDeploymentOutputEnvironment} obj Optional instance to populate.
     * @return {module:model/CancelEnvironmentDeploymentOutputEnvironment} The populated <code>CancelEnvironmentDeploymentOutputEnvironment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelEnvironmentDeploymentOutputEnvironment();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelEnvironmentDeploymentOutputEnvironment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelEnvironmentDeploymentOutputEnvironment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelEnvironmentDeploymentOutputEnvironment.RequiredProperties) {
...
CancelEnvironmentDeploymentOutputEnvironment.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "name", "templateMajorVersion", "templateMinorVersion", "templateName"];

/**
 * @member {String} arn
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['arn'] = undefined;

/**
 * @member {String} codebuildRoleArn
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['codebuildRoleArn'] = undefined;

/**
 * @member {String} componentRoleArn
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['componentRoleArn'] = undefined;

/**
 * @member {Date} createdAt
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} description
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['description'] = undefined;

/**
 * @member {String} environmentAccountConnectionId
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['environmentAccountConnectionId'] = undefined;

/**
 * @member {String} environmentAccountId
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['environmentAccountId'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastDeploymentAttemptedAt
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['lastDeploymentAttemptedAt'] = undefined;

/**
 * @member {Date} lastDeploymentSucceededAt
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['lastDeploymentSucceededAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} name
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['name'] = undefined;

/**
 * @member {String} protonServiceRoleArn
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['protonServiceRoleArn'] = undefined;

/**
 * @member {module:model/Provisioning} provisioning
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['provisioning'] = undefined;

/**
 * @member {module:model/EnvironmentProvisioningRepository} provisioningRepository
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['provisioningRepository'] = undefined;

/**
 * @member {String} spec
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['spec'] = undefined;

/**
 * @member {String} templateMajorVersion
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['templateMajorVersion'] = undefined;

/**
 * @member {String} templateMinorVersion
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['templateMinorVersion'] = undefined;

/**
 * @member {String} templateName
 */
CancelEnvironmentDeploymentOutputEnvironment.prototype['templateName'] = undefined;
...
export default CancelEnvironmentDeploymentOutputEnvironment;
