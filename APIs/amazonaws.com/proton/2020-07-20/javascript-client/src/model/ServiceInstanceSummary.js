...
/**
 * The ServiceInstanceSummary model module.
 * @module model/ServiceInstanceSummary
 * @version 2020-07-20
 */
class ServiceInstanceSummary {
    /**
     * Constructs a new <code>ServiceInstanceSummary</code>.
     * Summary data of an Proton service instance resource.
     * @alias module:model/ServiceInstanceSummary
     * @param arn {String} 
    ...
    constructor(arn, createdAt, deploymentStatus, environmentName, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, serviceName, templateMajorVersion, templateMinorVersion, templateName) { 
        ...
        ServiceInstanceSummary.initialize(this, arn, createdAt, deploymentStatus, environmentName, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, serviceName, templateMajorVersion, templateMinorVersion, templateName);
    }
    ...
    /**
     * Constructs a <code>ServiceInstanceSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ServiceInstanceSummary} obj Optional instance to populate.
     * @return {module:model/ServiceInstanceSummary} The populated <code>ServiceInstanceSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ServiceInstanceSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceInstanceSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceInstanceSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ServiceInstanceSummary.RequiredProperties) {
...
ServiceInstanceSummary.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "environmentName", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "name", "serviceName", "templateMajorVersion", "templateMinorVersion", "templateName"];

/**
 * @member {String} arn
 */
ServiceInstanceSummary.prototype['arn'] = undefined;

/**
 * @member {Date} createdAt
 */
ServiceInstanceSummary.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
ServiceInstanceSummary.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
ServiceInstanceSummary.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} environmentName
 */
ServiceInstanceSummary.prototype['environmentName'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
ServiceInstanceSummary.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastDeploymentAttemptedAt
 */
ServiceInstanceSummary.prototype['lastDeploymentAttemptedAt'] = undefined;

/**
 * @member {Date} lastDeploymentSucceededAt
 */
ServiceInstanceSummary.prototype['lastDeploymentSucceededAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
ServiceInstanceSummary.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} name
 */
ServiceInstanceSummary.prototype['name'] = undefined;

/**
 * @member {String} serviceName
 */
ServiceInstanceSummary.prototype['serviceName'] = undefined;

/**
 * @member {String} templateMajorVersion
 */
ServiceInstanceSummary.prototype['templateMajorVersion'] = undefined;

/**
 * @member {String} templateMinorVersion
 */
ServiceInstanceSummary.prototype['templateMinorVersion'] = undefined;

/**
 * @member {String} templateName
 */
ServiceInstanceSummary.prototype['templateName'] = undefined;
...
export default ServiceInstanceSummary;
