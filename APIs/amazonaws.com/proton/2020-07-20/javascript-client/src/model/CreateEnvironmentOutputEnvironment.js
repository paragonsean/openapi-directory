...
/**
 * The CreateEnvironmentOutputEnvironment model module.
 * @module model/CreateEnvironmentOutputEnvironment
 * @version 2020-07-20
 */
class CreateEnvironmentOutputEnvironment {
    /**
     * Constructs a new <code>CreateEnvironmentOutputEnvironment</code>.
     * @alias module:model/CreateEnvironmentOutputEnvironment
    ...
    constructor(arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName) { 
        ...
        CreateEnvironmentOutputEnvironment.initialize(this, arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName);
    }
    ...
    /**
     * Constructs a <code>CreateEnvironmentOutputEnvironment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateEnvironmentOutputEnvironment} obj Optional instance to populate.
     * @return {module:model/CreateEnvironmentOutputEnvironment} The populated <code>CreateEnvironmentOutputEnvironment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEnvironmentOutputEnvironment();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEnvironmentOutputEnvironment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEnvironmentOutputEnvironment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateEnvironmentOutputEnvironment.RequiredProperties) {
...
CreateEnvironmentOutputEnvironment.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "name", "templateMajorVersion", "templateMinorVersion", "templateName"];

/**
 * @member {String} arn
 */
CreateEnvironmentOutputEnvironment.prototype['arn'] = undefined;

/**
 * @member {String} codebuildRoleArn
 */
CreateEnvironmentOutputEnvironment.prototype['codebuildRoleArn'] = undefined;

/**
 * @member {String} componentRoleArn
 */
CreateEnvironmentOutputEnvironment.prototype['componentRoleArn'] = undefined;

/**
 * @member {Date} createdAt
 */
CreateEnvironmentOutputEnvironment.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
CreateEnvironmentOutputEnvironment.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
CreateEnvironmentOutputEnvironment.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} description
 */
CreateEnvironmentOutputEnvironment.prototype['description'] = undefined;

/**
 * @member {String} environmentAccountConnectionId
 */
CreateEnvironmentOutputEnvironment.prototype['environmentAccountConnectionId'] = undefined;

/**
 * @member {String} environmentAccountId
 */
CreateEnvironmentOutputEnvironment.prototype['environmentAccountId'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
CreateEnvironmentOutputEnvironment.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastDeploymentAttemptedAt
 */
CreateEnvironmentOutputEnvironment.prototype['lastDeploymentAttemptedAt'] = undefined;

/**
 * @member {Date} lastDeploymentSucceededAt
 */
CreateEnvironmentOutputEnvironment.prototype['lastDeploymentSucceededAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
CreateEnvironmentOutputEnvironment.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} name
 */
CreateEnvironmentOutputEnvironment.prototype['name'] = undefined;

/**
 * @member {String} protonServiceRoleArn
 */
CreateEnvironmentOutputEnvironment.prototype['protonServiceRoleArn'] = undefined;

/**
 * @member {module:model/Provisioning} provisioning
 */
CreateEnvironmentOutputEnvironment.prototype['provisioning'] = undefined;

/**
 * @member {module:model/EnvironmentProvisioningRepository} provisioningRepository
 */
CreateEnvironmentOutputEnvironment.prototype['provisioningRepository'] = undefined;

/**
 * @member {String} spec
 */
CreateEnvironmentOutputEnvironment.prototype['spec'] = undefined;

/**
 * @member {String} templateMajorVersion
 */
CreateEnvironmentOutputEnvironment.prototype['templateMajorVersion'] = undefined;

/**
 * @member {String} templateMinorVersion
 */
CreateEnvironmentOutputEnvironment.prototype['templateMinorVersion'] = undefined;

/**
 * @member {String} templateName
 */
CreateEnvironmentOutputEnvironment.prototype['templateName'] = undefined;
...
export default CreateEnvironmentOutputEnvironment;
