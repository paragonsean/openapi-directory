...
/**
 * The EnvironmentTemplate model module.
 * @module model/EnvironmentTemplate
 * @version 2020-07-20
 */
class EnvironmentTemplate {
    /**
     * Constructs a new <code>EnvironmentTemplate</code>.
     * The environment template data.
     * @alias module:model/EnvironmentTemplate
     * @param arn {String} 
    ...
    /**
     * Constructs a <code>EnvironmentTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnvironmentTemplate} obj Optional instance to populate.
     * @return {module:model/EnvironmentTemplate} The populated <code>EnvironmentTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnvironmentTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentTemplate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnvironmentTemplate.RequiredProperties) {
...
EnvironmentTemplate.RequiredProperties = ["arn", "createdAt", "lastModifiedAt", "name"];
