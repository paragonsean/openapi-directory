...
/**
 * The DeleteEnvironmentOutputEnvironment model module.
 * @module model/DeleteEnvironmentOutputEnvironment
 * @version 2020-07-20
 */
class DeleteEnvironmentOutputEnvironment {
    /**
     * Constructs a new <code>DeleteEnvironmentOutputEnvironment</code>.
     * @alias module:model/DeleteEnvironmentOutputEnvironment
    ...
    constructor(arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName) { 
        ...
        DeleteEnvironmentOutputEnvironment.initialize(this, arn, createdAt, deploymentStatus, lastDeploymentAttemptedAt, lastDeploymentSucceededAt, name, templateMajorVersion, templateMinorVersion, templateName);
    }
    ...
    /**
     * Constructs a <code>DeleteEnvironmentOutputEnvironment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteEnvironmentOutputEnvironment} obj Optional instance to populate.
     * @return {module:model/DeleteEnvironmentOutputEnvironment} The populated <code>DeleteEnvironmentOutputEnvironment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteEnvironmentOutputEnvironment();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteEnvironmentOutputEnvironment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteEnvironmentOutputEnvironment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteEnvironmentOutputEnvironment.RequiredProperties) {
...
DeleteEnvironmentOutputEnvironment.RequiredProperties = ["arn", "createdAt", "deploymentStatus", "lastDeploymentAttemptedAt", "lastDeploymentSucceededAt", "name", "templateMajorVersion", "templateMinorVersion", "templateName"];

/**
 * @member {String} arn
 */
DeleteEnvironmentOutputEnvironment.prototype['arn'] = undefined;

/**
 * @member {String} codebuildRoleArn
 */
DeleteEnvironmentOutputEnvironment.prototype['codebuildRoleArn'] = undefined;

/**
 * @member {String} componentRoleArn
 */
DeleteEnvironmentOutputEnvironment.prototype['componentRoleArn'] = undefined;

/**
 * @member {Date} createdAt
 */
DeleteEnvironmentOutputEnvironment.prototype['createdAt'] = undefined;

/**
 * @member {module:model/DeploymentStatus} deploymentStatus
 */
DeleteEnvironmentOutputEnvironment.prototype['deploymentStatus'] = undefined;

/**
 * @member {String} deploymentStatusMessage
 */
DeleteEnvironmentOutputEnvironment.prototype['deploymentStatusMessage'] = undefined;

/**
 * @member {String} description
 */
DeleteEnvironmentOutputEnvironment.prototype['description'] = undefined;

/**
 * @member {String} environmentAccountConnectionId
 */
DeleteEnvironmentOutputEnvironment.prototype['environmentAccountConnectionId'] = undefined;

/**
 * @member {String} environmentAccountId
 */
DeleteEnvironmentOutputEnvironment.prototype['environmentAccountId'] = undefined;

/**
 * @member {String} lastAttemptedDeploymentId
 */
DeleteEnvironmentOutputEnvironment.prototype['lastAttemptedDeploymentId'] = undefined;

/**
 * @member {Date} lastDeploymentAttemptedAt
 */
DeleteEnvironmentOutputEnvironment.prototype['lastDeploymentAttemptedAt'] = undefined;

/**
 * @member {Date} lastDeploymentSucceededAt
 */
DeleteEnvironmentOutputEnvironment.prototype['lastDeploymentSucceededAt'] = undefined;

/**
 * @member {String} lastSucceededDeploymentId
 */
DeleteEnvironmentOutputEnvironment.prototype['lastSucceededDeploymentId'] = undefined;

/**
 * @member {String} name
 */
DeleteEnvironmentOutputEnvironment.prototype['name'] = undefined;

/**
 * @member {String} protonServiceRoleArn
 */
DeleteEnvironmentOutputEnvironment.prototype['protonServiceRoleArn'] = undefined;

/**
 * @member {module:model/Provisioning} provisioning
 */
DeleteEnvironmentOutputEnvironment.prototype['provisioning'] = undefined;

/**
 * @member {module:model/EnvironmentProvisioningRepository} provisioningRepository
 */
DeleteEnvironmentOutputEnvironment.prototype['provisioningRepository'] = undefined;

/**
 * @member {String} spec
 */
DeleteEnvironmentOutputEnvironment.prototype['spec'] = undefined;

/**
 * @member {String} templateMajorVersion
 */
DeleteEnvironmentOutputEnvironment.prototype['templateMajorVersion'] = undefined;

/**
 * @member {String} templateMinorVersion
 */
DeleteEnvironmentOutputEnvironment.prototype['templateMinorVersion'] = undefined;

/**
 * @member {String} templateName
 */
DeleteEnvironmentOutputEnvironment.prototype['templateName'] = undefined;
...
export default DeleteEnvironmentOutputEnvironment;
