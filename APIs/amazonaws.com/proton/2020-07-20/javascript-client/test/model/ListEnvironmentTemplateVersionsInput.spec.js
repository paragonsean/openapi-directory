...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListEnvironmentTemplateVersionsInput();
  });
  ...
  describe('ListEnvironmentTemplateVersionsInput', function() {
    it('should create an instance of ListEnvironmentTemplateVersionsInput', function() {
      // uncomment below and update the code to test ListEnvironmentTemplateVersionsInput
      //var instance = new AwsProton.ListEnvironmentTemplateVersionsInput();
      //expect(instance).to.be.a(AwsProton.ListEnvironmentTemplateVersionsInput);
    });
