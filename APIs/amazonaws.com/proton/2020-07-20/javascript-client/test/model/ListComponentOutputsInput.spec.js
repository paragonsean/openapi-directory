...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListComponentOutputsInput();
  });
  ...
  describe('ListComponentOutputsInput', function() {
    it('should create an instance of ListComponentOutputsInput', function() {
      // uncomment below and update the code to test ListComponentOutputsInput
      //var instance = new AwsProton.ListComponentOutputsInput();
      //expect(instance).to.be.a(AwsProton.ListComponentOutputsInput);
    });
