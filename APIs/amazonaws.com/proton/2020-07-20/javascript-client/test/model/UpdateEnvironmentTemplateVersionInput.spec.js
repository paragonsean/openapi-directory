...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.UpdateEnvironmentTemplateVersionInput();
  });
  ...
  describe('UpdateEnvironmentTemplateVersionInput', function() {
    it('should create an instance of UpdateEnvironmentTemplateVersionInput', function() {
      // uncomment below and update the code to test UpdateEnvironmentTemplateVersionInput
      //var instance = new AwsProton.UpdateEnvironmentTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.UpdateEnvironmentTemplateVersionInput);
    });
