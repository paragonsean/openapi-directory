...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetRepositorySyncStatusInput();
  });
  ...
  describe('GetRepositorySyncStatusInput', function() {
    it('should create an instance of GetRepositorySyncStatusInput', function() {
      // uncomment below and update the code to test GetRepositorySyncStatusInput
      //var instance = new AwsProton.GetRepositorySyncStatusInput();
      //expect(instance).to.be.a(AwsProton.GetRepositorySyncStatusInput);
    });
