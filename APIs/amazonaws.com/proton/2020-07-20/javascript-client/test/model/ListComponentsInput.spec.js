...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListComponentsInput();
  });
  ...
  describe('ListComponentsInput', function() {
    it('should create an instance of ListComponentsInput', function() {
      // uncomment below and update the code to test ListComponentsInput
      //var instance = new AwsProton.ListComponentsInput();
      //expect(instance).to.be.a(AwsProton.ListComponentsInput);
    });
