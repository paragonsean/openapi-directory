...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.UpdateComponentInput();
  });
  ...
  describe('UpdateComponentInput', function() {
    it('should create an instance of UpdateComponentInput', function() {
      // uncomment below and update the code to test UpdateComponentInput
      //var instance = new AwsProton.UpdateComponentInput();
      //expect(instance).to.be.a(AwsProton.UpdateComponentInput);
    });
