...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
  });
  ...
  describe('UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
    it('should create an instance of UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
      // uncomment below and update the code to test UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion
      //var instance = new AwsProton.UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
      //expect(instance).to.be.a(AwsProton.UpdateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion);
    });
