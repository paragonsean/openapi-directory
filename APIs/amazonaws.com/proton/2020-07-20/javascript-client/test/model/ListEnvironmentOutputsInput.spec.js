...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListEnvironmentOutputsInput();
  });
  ...
  describe('ListEnvironmentOutputsInput', function() {
    it('should create an instance of ListEnvironmentOutputsInput', function() {
      // uncomment below and update the code to test ListEnvironmentOutputsInput
      //var instance = new AwsProton.ListEnvironmentOutputsInput();
      //expect(instance).to.be.a(AwsProton.ListEnvironmentOutputsInput);
    });
