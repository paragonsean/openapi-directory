...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ServiceTemplateVersionSummary();
  });
  ...
  describe('ServiceTemplateVersionSummary', function() {
    it('should create an instance of ServiceTemplateVersionSummary', function() {
      // uncomment below and update the code to test ServiceTemplateVersionSummary
      //var instance = new AwsProton.ServiceTemplateVersionSummary();
      //expect(instance).to.be.a(AwsProton.ServiceTemplateVersionSummary);
    });
