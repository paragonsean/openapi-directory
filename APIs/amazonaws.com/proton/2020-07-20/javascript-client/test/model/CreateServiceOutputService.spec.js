...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateServiceOutputService();
  });
  ...
  describe('CreateServiceOutputService', function() {
    it('should create an instance of CreateServiceOutputService', function() {
      // uncomment below and update the code to test CreateServiceOutputService
      //var instance = new AwsProton.CreateServiceOutputService();
      //expect(instance).to.be.a(AwsProton.CreateServiceOutputService);
    });
