...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateTemplateSyncConfigInput();
  });
  ...
  describe('CreateTemplateSyncConfigInput', function() {
    it('should create an instance of CreateTemplateSyncConfigInput', function() {
      // uncomment below and update the code to test CreateTemplateSyncConfigInput
      //var instance = new AwsProton.CreateTemplateSyncConfigInput();
      //expect(instance).to.be.a(AwsProton.CreateTemplateSyncConfigInput);
    });
