...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetDeploymentInput();
  });
  ...
  describe('GetDeploymentInput', function() {
    it('should create an instance of GetDeploymentInput', function() {
      // uncomment below and update the code to test GetDeploymentInput
      //var instance = new AwsProton.GetDeploymentInput();
      //expect(instance).to.be.a(AwsProton.GetDeploymentInput);
    });
