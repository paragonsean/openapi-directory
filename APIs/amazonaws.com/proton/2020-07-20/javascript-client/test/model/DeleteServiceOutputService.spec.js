...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.DeleteServiceOutputService();
  });
  ...
  describe('DeleteServiceOutputService', function() {
    it('should create an instance of DeleteServiceOutputService', function() {
      // uncomment below and update the code to test DeleteServiceOutputService
      //var instance = new AwsProton.DeleteServiceOutputService();
      //expect(instance).to.be.a(AwsProton.DeleteServiceOutputService);
    });
