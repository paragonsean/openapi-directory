...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateComponentInput();
  });
  ...
  describe('CreateComponentInput', function() {
    it('should create an instance of CreateComponentInput', function() {
      // uncomment below and update the code to test CreateComponentInput
      //var instance = new AwsProton.CreateComponentInput();
      //expect(instance).to.be.a(AwsProton.CreateComponentInput);
    });
    ...
    it('should have the property templateFile (base name: "templateFile")', function() {
