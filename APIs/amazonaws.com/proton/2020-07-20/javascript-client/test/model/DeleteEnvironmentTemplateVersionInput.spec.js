...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.DeleteEnvironmentTemplateVersionInput();
  });
  ...
  describe('DeleteEnvironmentTemplateVersionInput', function() {
    it('should create an instance of DeleteEnvironmentTemplateVersionInput', function() {
      // uncomment below and update the code to test DeleteEnvironmentTemplateVersionInput
      //var instance = new AwsProton.DeleteEnvironmentTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.DeleteEnvironmentTemplateVersionInput);
    });
