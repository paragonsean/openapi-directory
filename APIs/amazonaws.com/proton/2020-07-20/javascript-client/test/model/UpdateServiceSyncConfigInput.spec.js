...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.UpdateServiceSyncConfigInput();
  });
  ...
  describe('UpdateServiceSyncConfigInput', function() {
    it('should create an instance of UpdateServiceSyncConfigInput', function() {
      // uncomment below and update the code to test UpdateServiceSyncConfigInput
      //var instance = new AwsProton.UpdateServiceSyncConfigInput();
      //expect(instance).to.be.a(AwsProton.UpdateServiceSyncConfigInput);
    });
