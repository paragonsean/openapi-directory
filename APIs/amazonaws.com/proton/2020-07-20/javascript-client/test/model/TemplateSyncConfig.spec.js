...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.TemplateSyncConfig();
  });
  ...
  describe('TemplateSyncConfig', function() {
    it('should create an instance of TemplateSyncConfig', function() {
      // uncomment below and update the code to test TemplateSyncConfig
      //var instance = new AwsProton.TemplateSyncConfig();
      //expect(instance).to.be.a(AwsProton.TemplateSyncConfig);
    });
