...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListDeploymentsOutput();
  });
  ...
  describe('ListDeploymentsOutput', function() {
    it('should create an instance of ListDeploymentsOutput', function() {
      // uncomment below and update the code to test ListDeploymentsOutput
      //var instance = new AwsProton.ListDeploymentsOutput();
      //expect(instance).to.be.a(AwsProton.ListDeploymentsOutput);
    });
