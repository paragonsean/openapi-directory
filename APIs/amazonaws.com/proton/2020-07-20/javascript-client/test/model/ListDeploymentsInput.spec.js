...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListDeploymentsInput();
  });
  ...
  describe('ListDeploymentsInput', function() {
    it('should create an instance of ListDeploymentsInput', function() {
      // uncomment below and update the code to test ListDeploymentsInput
      //var instance = new AwsProton.ListDeploymentsInput();
      //expect(instance).to.be.a(AwsProton.ListDeploymentsInput);
    });
