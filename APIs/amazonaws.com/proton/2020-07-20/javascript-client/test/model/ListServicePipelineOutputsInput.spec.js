...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListServicePipelineOutputsInput();
  });
  ...
  describe('ListServicePipelineOutputsInput', function() {
    it('should create an instance of ListServicePipelineOutputsInput', function() {
      // uncomment below and update the code to test ListServicePipelineOutputsInput
      //var instance = new AwsProton.ListServicePipelineOutputsInput();
      //expect(instance).to.be.a(AwsProton.ListServicePipelineOutputsInput);
    });
