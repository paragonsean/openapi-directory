...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetTemplateSyncConfigInput();
  });
  ...
  describe('GetTemplateSyncConfigInput', function() {
    it('should create an instance of GetTemplateSyncConfigInput', function() {
      // uncomment below and update the code to test GetTemplateSyncConfigInput
      //var instance = new AwsProton.GetTemplateSyncConfigInput();
      //expect(instance).to.be.a(AwsProton.GetTemplateSyncConfigInput);
    });
