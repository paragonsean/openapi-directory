...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateEnvironmentTemplateVersionInput();
  });
  ...
  describe('CreateEnvironmentTemplateVersionInput', function() {
    it('should create an instance of CreateEnvironmentTemplateVersionInput', function() {
      // uncomment below and update the code to test CreateEnvironmentTemplateVersionInput
      //var instance = new AwsProton.CreateEnvironmentTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.CreateEnvironmentTemplateVersionInput);
    });
