...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.EnvironmentTemplateFilter();
  });
  ...
  describe('EnvironmentTemplateFilter', function() {
    it('should create an instance of EnvironmentTemplateFilter', function() {
      // uncomment below and update the code to test EnvironmentTemplateFilter
      //var instance = new AwsProton.EnvironmentTemplateFilter();
      //expect(instance).to.be.a(AwsProton.EnvironmentTemplateFilter);
    });
