...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ServiceSyncConfig();
  });
  ...
  describe('ServiceSyncConfig', function() {
    it('should create an instance of ServiceSyncConfig', function() {
      // uncomment below and update the code to test ServiceSyncConfig
      //var instance = new AwsProton.ServiceSyncConfig();
      //expect(instance).to.be.a(AwsProton.ServiceSyncConfig);
    });
