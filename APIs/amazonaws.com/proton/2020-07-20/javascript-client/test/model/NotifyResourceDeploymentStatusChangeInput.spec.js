...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.NotifyResourceDeploymentStatusChangeInput();
  });
  ...
  describe('NotifyResourceDeploymentStatusChangeInput', function() {
    it('should create an instance of NotifyResourceDeploymentStatusChangeInput', function() {
      // uncomment below and update the code to test NotifyResourceDeploymentStatusChangeInput
      //var instance = new AwsProton.NotifyResourceDeploymentStatusChangeInput();
      //expect(instance).to.be.a(AwsProton.NotifyResourceDeploymentStatusChangeInput);
    });
