...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
  });
  ...
  describe('DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
    it('should create an instance of DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
      // uncomment below and update the code to test DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion
      //var instance = new AwsProton.DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
      //expect(instance).to.be.a(AwsProton.DeleteEnvironmentTemplateVersionOutputEnvironmentTemplateVersion);
    });
