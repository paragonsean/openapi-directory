...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateTemplateSyncConfigOutputTemplateSyncConfig();
  });
  ...
  describe('CreateTemplateSyncConfigOutputTemplateSyncConfig', function() {
    it('should create an instance of CreateTemplateSyncConfigOutputTemplateSyncConfig', function() {
      // uncomment below and update the code to test CreateTemplateSyncConfigOutputTemplateSyncConfig
      //var instance = new AwsProton.CreateTemplateSyncConfigOutputTemplateSyncConfig();
      //expect(instance).to.be.a(AwsProton.CreateTemplateSyncConfigOutputTemplateSyncConfig);
    });
