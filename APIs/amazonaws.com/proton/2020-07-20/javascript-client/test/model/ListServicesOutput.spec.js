...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListServicesOutput();
  });
  ...
  describe('ListServicesOutput', function() {
    it('should create an instance of ListServicesOutput', function() {
      // uncomment below and update the code to test ListServicesOutput
      //var instance = new AwsProton.ListServicesOutput();
      //expect(instance).to.be.a(AwsProton.ListServicesOutput);
    });
