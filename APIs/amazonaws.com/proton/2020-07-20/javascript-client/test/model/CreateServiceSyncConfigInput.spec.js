...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateServiceSyncConfigInput();
  });
  ...
  describe('CreateServiceSyncConfigInput', function() {
    it('should create an instance of CreateServiceSyncConfigInput', function() {
      // uncomment below and update the code to test CreateServiceSyncConfigInput
      //var instance = new AwsProton.CreateServiceSyncConfigInput();
      //expect(instance).to.be.a(AwsProton.CreateServiceSyncConfigInput);
    });
