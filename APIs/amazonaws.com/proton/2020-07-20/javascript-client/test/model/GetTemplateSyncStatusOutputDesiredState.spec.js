...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetTemplateSyncStatusOutputDesiredState();
  });
  ...
  describe('GetTemplateSyncStatusOutputDesiredState', function() {
    it('should create an instance of GetTemplateSyncStatusOutputDesiredState', function() {
      // uncomment below and update the code to test GetTemplateSyncStatusOutputDesiredState
      //var instance = new AwsProton.GetTemplateSyncStatusOutputDesiredState();
      //expect(instance).to.be.a(AwsProton.GetTemplateSyncStatusOutputDesiredState);
    });
