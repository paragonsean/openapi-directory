...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetServiceOutputService();
  });
  ...
  describe('GetServiceOutputService', function() {
    it('should create an instance of GetServiceOutputService', function() {
      // uncomment below and update the code to test GetServiceOutputService
      //var instance = new AwsProton.GetServiceOutputService();
      //expect(instance).to.be.a(AwsProton.GetServiceOutputService);
    });
    ...
    it('should have the property repositoryConnectionArn (base name: "repositoryConnectionArn")', function() {
      // uncomment below and update the code to test the property repositoryConnectionArn
      //var instance = new AwsProton.GetServiceOutputService();
      //expect(instance).to.be();
    });
