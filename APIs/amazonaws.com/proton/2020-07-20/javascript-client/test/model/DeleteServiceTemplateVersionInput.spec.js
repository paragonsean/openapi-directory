...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.DeleteServiceTemplateVersionInput();
  });
  ...
  describe('DeleteServiceTemplateVersionInput', function() {
    it('should create an instance of DeleteServiceTemplateVersionInput', function() {
      // uncomment below and update the code to test DeleteServiceTemplateVersionInput
      //var instance = new AwsProton.DeleteServiceTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.DeleteServiceTemplateVersionInput);
    });
