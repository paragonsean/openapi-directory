...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
  });
  ...
  describe('CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
    it('should create an instance of CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
      // uncomment below and update the code to test CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion
      //var instance = new AwsProton.CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
      //expect(instance).to.be.a(AwsProton.CreateEnvironmentTemplateVersionOutputEnvironmentTemplateVersion);
    });
