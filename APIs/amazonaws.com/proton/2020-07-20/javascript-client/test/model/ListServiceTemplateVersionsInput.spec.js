...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListServiceTemplateVersionsInput();
  });
  ...
  describe('ListServiceTemplateVersionsInput', function() {
    it('should create an instance of ListServiceTemplateVersionsInput', function() {
      // uncomment below and update the code to test ListServiceTemplateVersionsInput
      //var instance = new AwsProton.ListServiceTemplateVersionsInput();
      //expect(instance).to.be.a(AwsProton.ListServiceTemplateVersionsInput);
    });
