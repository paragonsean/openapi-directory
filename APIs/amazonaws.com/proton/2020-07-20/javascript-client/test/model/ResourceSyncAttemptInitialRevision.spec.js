...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ResourceSyncAttemptInitialRevision();
  });
  ...
  describe('ResourceSyncAttemptInitialRevision', function() {
    it('should create an instance of ResourceSyncAttemptInitialRevision', function() {
      // uncomment below and update the code to test ResourceSyncAttemptInitialRevision
      //var instance = new AwsProton.ResourceSyncAttemptInitialRevision();
      //expect(instance).to.be.a(AwsProton.ResourceSyncAttemptInitialRevision);
    });
