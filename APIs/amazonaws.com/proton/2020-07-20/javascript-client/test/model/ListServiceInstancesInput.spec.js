...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListServiceInstancesInput();
  });
  ...
  describe('ListServiceInstancesInput', function() {
    it('should create an instance of ListServiceInstancesInput', function() {
      // uncomment below and update the code to test ListServiceInstancesInput
      //var instance = new AwsProton.ListServiceInstancesInput();
      //expect(instance).to.be.a(AwsProton.ListServiceInstancesInput);
    });
