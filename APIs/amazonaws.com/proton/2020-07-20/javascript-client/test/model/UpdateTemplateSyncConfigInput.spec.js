...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.UpdateTemplateSyncConfigInput();
  });
  ...
  describe('UpdateTemplateSyncConfigInput', function() {
    it('should create an instance of UpdateTemplateSyncConfigInput', function() {
      // uncomment below and update the code to test UpdateTemplateSyncConfigInput
      //var instance = new AwsProton.UpdateTemplateSyncConfigInput();
      //expect(instance).to.be.a(AwsProton.UpdateTemplateSyncConfigInput);
    });
