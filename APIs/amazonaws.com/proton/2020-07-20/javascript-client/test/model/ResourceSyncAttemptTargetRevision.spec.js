...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ResourceSyncAttemptTargetRevision();
  });
  ...
  describe('ResourceSyncAttemptTargetRevision', function() {
    it('should create an instance of ResourceSyncAttemptTargetRevision', function() {
      // uncomment below and update the code to test ResourceSyncAttemptTargetRevision
      //var instance = new AwsProton.ResourceSyncAttemptTargetRevision();
      //expect(instance).to.be.a(AwsProton.ResourceSyncAttemptTargetRevision);
    });
