...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetTemplateSyncStatusInput();
  });
  ...
  describe('GetTemplateSyncStatusInput', function() {
    it('should create an instance of GetTemplateSyncStatusInput', function() {
      // uncomment below and update the code to test GetTemplateSyncStatusInput
      //var instance = new AwsProton.GetTemplateSyncStatusInput();
      //expect(instance).to.be.a(AwsProton.GetTemplateSyncStatusInput);
    });
