...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetServiceTemplateVersionInput();
  });
  ...
  describe('GetServiceTemplateVersionInput', function() {
    it('should create an instance of GetServiceTemplateVersionInput', function() {
      // uncomment below and update the code to test GetServiceTemplateVersionInput
      //var instance = new AwsProton.GetServiceTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.GetServiceTemplateVersionInput);
    });
