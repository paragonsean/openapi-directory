...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.EnvironmentTemplateVersion();
  });
  ...
  describe('EnvironmentTemplateVersion', function() {
    it('should create an instance of EnvironmentTemplateVersion', function() {
      // uncomment below and update the code to test EnvironmentTemplateVersion
      //var instance = new AwsProton.EnvironmentTemplateVersion();
      //expect(instance).to.be.a(AwsProton.EnvironmentTemplateVersion);
    });
