...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetServiceInstanceSyncStatusOutputDesiredState();
  });
  ...
  describe('GetServiceInstanceSyncStatusOutputDesiredState', function() {
    it('should create an instance of GetServiceInstanceSyncStatusOutputDesiredState', function() {
      // uncomment below and update the code to test GetServiceInstanceSyncStatusOutputDesiredState
      //var instance = new AwsProton.GetServiceInstanceSyncStatusOutputDesiredState();
      //expect(instance).to.be.a(AwsProton.GetServiceInstanceSyncStatusOutputDesiredState);
    });
