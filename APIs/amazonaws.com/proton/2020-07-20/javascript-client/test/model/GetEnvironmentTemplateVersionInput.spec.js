...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetEnvironmentTemplateVersionInput();
  });
  ...
  describe('GetEnvironmentTemplateVersionInput', function() {
    it('should create an instance of GetEnvironmentTemplateVersionInput', function() {
      // uncomment below and update the code to test GetEnvironmentTemplateVersionInput
      //var instance = new AwsProton.GetEnvironmentTemplateVersionInput();
      //expect(instance).to.be.a(AwsProton.GetEnvironmentTemplateVersionInput);
    });
