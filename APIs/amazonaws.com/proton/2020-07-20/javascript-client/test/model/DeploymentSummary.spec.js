...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.DeploymentSummary();
  });
  ...
  describe('DeploymentSummary', function() {
    it('should create an instance of DeploymentSummary', function() {
      ...
      //var instance = new AwsProton.DeploymentSummary();
      //expect(instance).to.be.a(AwsProton.DeploymentSummary);
    });
    ...
    it('should have the property targetResourceCreatedAt (base name: "targetResourceCreatedAt")', function() {
      // uncomment below and update the code to test the property targetResourceCreatedAt
      //var instance = new AwsProton.DeploymentSummary();
      //expect(instance).to.be();
    });
