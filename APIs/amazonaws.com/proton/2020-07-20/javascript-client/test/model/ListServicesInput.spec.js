...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListServicesInput();
  });
  ...
  describe('ListServicesInput', function() {
    it('should create an instance of ListServicesInput', function() {
      // uncomment below and update the code to test ListServicesInput
      //var instance = new AwsProton.ListServicesInput();
      //expect(instance).to.be.a(AwsProton.ListServicesInput);
    });
