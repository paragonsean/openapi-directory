...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListEnvironmentAccountConnectionsInput();
  });
  ...
  describe('ListEnvironmentAccountConnectionsInput', function() {
    it('should create an instance of ListEnvironmentAccountConnectionsInput', function() {
      // uncomment below and update the code to test ListEnvironmentAccountConnectionsInput
      //var instance = new AwsProton.ListEnvironmentAccountConnectionsInput();
      //expect(instance).to.be.a(AwsProton.ListEnvironmentAccountConnectionsInput);
    });
