...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.EnvironmentTemplateVersionSummary();
  });
  ...
  describe('EnvironmentTemplateVersionSummary', function() {
    it('should create an instance of EnvironmentTemplateVersionSummary', function() {
      // uncomment below and update the code to test EnvironmentTemplateVersionSummary
      //var instance = new AwsProton.EnvironmentTemplateVersionSummary();
      //expect(instance).to.be.a(AwsProton.EnvironmentTemplateVersionSummary);
    });
