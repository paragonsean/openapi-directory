...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.ListComponentsOutput();
  });
  ...
  describe('ListComponentsOutput', function() {
    it('should create an instance of ListComponentsOutput', function() {
      // uncomment below and update the code to test ListComponentsOutput
      //var instance = new AwsProton.ListComponentsOutput();
      //expect(instance).to.be.a(AwsProton.ListComponentsOutput);
    });
