...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsProton.GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
  });
  ...
  describe('GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
    it('should create an instance of GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion', function() {
      // uncomment below and update the code to test GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion
      //var instance = new AwsProton.GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion();
      //expect(instance).to.be.a(AwsProton.GetEnvironmentTemplateVersionOutputEnvironmentTemplateVersion);
    });
