...
/*
 * OAIFilterControl_TextArea.h
 *
 * 
 */

#ifndef OAIFilterControl_TextArea_H
#define OAIFilterControl_TextArea_H
...
class OAIFilterControl_TextArea : public OAIObject {
public:
    OAIFilterControl_TextArea();
    OAIFilterControl_TextArea(QString json);
    ~OAIFilterControl_TextArea() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterControl_TextArea)

#endif // OAIFilterControl_TextArea_H
