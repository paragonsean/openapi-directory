...
/*
 * OAIComputation_GrowthRate.h
 *
 * 
 */

#ifndef OAIComputation_GrowthRate_H
#define OAIComputation_GrowthRate_H
...
class OAIComputation_GrowthRate : public OAIObject {
public:
    OAIComputation_GrowthRate();
    OAIComputation_GrowthRate(QString json);
    ~OAIComputation_GrowthRate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_GrowthRate)

#endif // OAIComputation_GrowthRate_H
