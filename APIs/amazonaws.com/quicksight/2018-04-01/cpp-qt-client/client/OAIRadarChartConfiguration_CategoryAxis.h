...
/*
 * OAIRadarChartConfiguration_CategoryAxis.h
 *
 * 
 */

#ifndef OAIRadarChartConfiguration_CategoryAxis_H
#define OAIRadarChartConfiguration_CategoryAxis_H
...
class OAIRadarChartConfiguration_CategoryAxis : public OAIObject {
public:
    OAIRadarChartConfiguration_CategoryAxis();
    OAIRadarChartConfiguration_CategoryAxis(QString json);
    ~OAIRadarChartConfiguration_CategoryAxis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRadarChartConfiguration_CategoryAxis)

#endif // OAIRadarChartConfiguration_CategoryAxis_H
