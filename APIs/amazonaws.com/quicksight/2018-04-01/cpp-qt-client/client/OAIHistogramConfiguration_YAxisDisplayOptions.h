...
/*
 * OAIHistogramConfiguration_YAxisDisplayOptions.h
 *
 * 
 */

#ifndef OAIHistogramConfiguration_YAxisDisplayOptions_H
#define OAIHistogramConfiguration_YAxisDisplayOptions_H
...
class OAIHistogramConfiguration_YAxisDisplayOptions : public OAIObject {
public:
    OAIHistogramConfiguration_YAxisDisplayOptions();
    OAIHistogramConfiguration_YAxisDisplayOptions(QString json);
    ~OAIHistogramConfiguration_YAxisDisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramConfiguration_YAxisDisplayOptions)

#endif // OAIHistogramConfiguration_YAxisDisplayOptions_H
