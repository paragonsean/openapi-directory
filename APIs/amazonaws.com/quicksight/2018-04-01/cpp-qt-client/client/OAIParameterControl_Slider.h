...
/*
 * OAIParameterControl_Slider.h
 *
 * 
 */

#ifndef OAIParameterControl_Slider_H
#define OAIParameterControl_Slider_H
...
class OAIParameterControl_Slider : public OAIObject {
public:
    OAIParameterControl_Slider();
    OAIParameterControl_Slider(QString json);
    ~OAIParameterControl_Slider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterControl_Slider)

#endif // OAIParameterControl_Slider_H
