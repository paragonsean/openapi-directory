...
/*
 * OAIAnalysisDefaults_DefaultNewSheetConfiguration.h
 *
 * 
 */

#ifndef OAIAnalysisDefaults_DefaultNewSheetConfiguration_H
#define OAIAnalysisDefaults_DefaultNewSheetConfiguration_H
...
class OAIAnalysisDefaults_DefaultNewSheetConfiguration : public OAIObject {
public:
    OAIAnalysisDefaults_DefaultNewSheetConfiguration();
    OAIAnalysisDefaults_DefaultNewSheetConfiguration(QString json);
    ~OAIAnalysisDefaults_DefaultNewSheetConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalysisDefaults_DefaultNewSheetConfiguration)

#endif // OAIAnalysisDefaults_DefaultNewSheetConfiguration_H
