...
/*
 * OAINumericSeparatorConfiguration.h
 *
 * The options that determine the numeric separator configuration.
 */

#ifndef OAINumericSeparatorConfiguration_H
#define OAINumericSeparatorConfiguration_H
...
class OAINumericSeparatorConfiguration : public OAIObject {
public:
    OAINumericSeparatorConfiguration();
    OAINumericSeparatorConfiguration(QString json);
    ~OAINumericSeparatorConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumericSeparatorConfiguration)

#endif // OAINumericSeparatorConfiguration_H
