...
OAIBarChartConfiguration_ValueAxis::OAIBarChartConfiguration_ValueAxis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBarChartConfiguration_ValueAxis::OAIBarChartConfiguration_ValueAxis() {
    this->initializeModel();
}

OAIBarChartConfiguration_ValueAxis::~OAIBarChartConfiguration_ValueAxis() {}

void OAIBarChartConfiguration_ValueAxis::initializeModel() {
...
void OAIBarChartConfiguration_ValueAxis::fromJson(QString jsonString) {
...
void OAIBarChartConfiguration_ValueAxis::fromJsonObject(QJsonObject json) {
...
QString OAIBarChartConfiguration_ValueAxis::asJson() const {
...
QJsonObject OAIBarChartConfiguration_ValueAxis::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIBarChartConfiguration_ValueAxis::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIBarChartConfiguration_ValueAxis::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIBarChartConfiguration_ValueAxis::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIBarChartConfiguration_ValueAxis::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIBarChartConfiguration_ValueAxis::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIBarChartConfiguration_ValueAxis::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIBarChartConfiguration_ValueAxis::getDataOptions() const {
    return m_data_options;
}
void OAIBarChartConfiguration_ValueAxis::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIBarChartConfiguration_ValueAxis::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIBarChartConfiguration_ValueAxis::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIBarChartConfiguration_ValueAxis::getAxisOffset() const {
    return m_axis_offset;
}
void OAIBarChartConfiguration_ValueAxis::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIBarChartConfiguration_ValueAxis::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIBarChartConfiguration_ValueAxis::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIBarChartConfiguration_ValueAxis::isSet() const {
...
bool OAIBarChartConfiguration_ValueAxis::isValid() const {
