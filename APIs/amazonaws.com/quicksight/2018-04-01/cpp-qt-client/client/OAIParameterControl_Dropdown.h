...
/*
 * OAIParameterControl_Dropdown.h
 *
 * 
 */

#ifndef OAIParameterControl_Dropdown_H
#define OAIParameterControl_Dropdown_H
...
class OAIParameterControl_Dropdown : public OAIObject {
public:
    OAIParameterControl_Dropdown();
    OAIParameterControl_Dropdown(QString json);
    ~OAIParameterControl_Dropdown() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterControl_Dropdown)

#endif // OAIParameterControl_Dropdown_H
