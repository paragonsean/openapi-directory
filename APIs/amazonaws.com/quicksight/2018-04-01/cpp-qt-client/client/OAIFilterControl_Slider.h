...
/*
 * OAIFilterControl_Slider.h
 *
 * 
 */

#ifndef OAIFilterControl_Slider_H
#define OAIFilterControl_Slider_H
...
class OAIFilterControl_Slider : public OAIObject {
public:
    OAIFilterControl_Slider();
    OAIFilterControl_Slider(QString json);
    ~OAIFilterControl_Slider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterControl_Slider)

#endif // OAIFilterControl_Slider_H
