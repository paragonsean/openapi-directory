...
/*
 * OAICreateAnalysisRequest_Definition.h
 *
 * 
 */

#ifndef OAICreateAnalysisRequest_Definition_H
#define OAICreateAnalysisRequest_Definition_H
...
class OAICreateAnalysisRequest_Definition : public OAIObject {
public:
    OAICreateAnalysisRequest_Definition();
    OAICreateAnalysisRequest_Definition(QString json);
    ~OAICreateAnalysisRequest_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAnalysisRequest_Definition)

#endif // OAICreateAnalysisRequest_Definition_H
