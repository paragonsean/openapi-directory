...
/*
 * OAICalculatedField.h
 *
 * The calculated field of an analysis.
 */

#ifndef OAICalculatedField_H
#define OAICalculatedField_H
...
class OAICalculatedField : public OAIObject {
public:
    OAICalculatedField();
    OAICalculatedField(QString json);
    ~OAICalculatedField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalculatedField)

#endif // OAICalculatedField_H
