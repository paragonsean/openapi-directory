...
/*
 * OAIRadarChartConfiguration.h
 *
 * The configuration of a &lt;code&gt;RadarChartVisual&lt;/code&gt;.
 */

#ifndef OAIRadarChartConfiguration_H
#define OAIRadarChartConfiguration_H
...
class OAIRadarChartConfiguration : public OAIObject {
public:
    OAIRadarChartConfiguration();
    OAIRadarChartConfiguration(QString json);
    ~OAIRadarChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRadarChartConfiguration)

#endif // OAIRadarChartConfiguration_H
