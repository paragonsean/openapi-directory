...
/*
 * OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule.h
 *
 * 
 */

#ifndef OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule_H
#define OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule_H
...
class OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule : public OAIObject {
public:
    OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule();
    OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule(QString json);
    ~OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule)

#endif // OAIDescribeTopicRefreshScheduleResponse_RefreshSchedule_H
