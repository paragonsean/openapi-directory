...
/*
 * OAICreateTemplateRequest_SourceEntity.h
 *
 * 
 */

#ifndef OAICreateTemplateRequest_SourceEntity_H
#define OAICreateTemplateRequest_SourceEntity_H
...
class OAICreateTemplateRequest_SourceEntity : public OAIObject {
public:
    OAICreateTemplateRequest_SourceEntity();
    OAICreateTemplateRequest_SourceEntity(QString json);
    ~OAICreateTemplateRequest_SourceEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTemplateRequest_SourceEntity)

#endif // OAICreateTemplateRequest_SourceEntity_H
