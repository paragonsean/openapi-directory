...
OAIScatterPlotConfiguration_YAxisDisplayOptions::OAIScatterPlotConfiguration_YAxisDisplayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScatterPlotConfiguration_YAxisDisplayOptions::OAIScatterPlotConfiguration_YAxisDisplayOptions() {
    this->initializeModel();
}

OAIScatterPlotConfiguration_YAxisDisplayOptions::~OAIScatterPlotConfiguration_YAxisDisplayOptions() {}

void OAIScatterPlotConfiguration_YAxisDisplayOptions::initializeModel() {
...
void OAIScatterPlotConfiguration_YAxisDisplayOptions::fromJson(QString jsonString) {
...
void OAIScatterPlotConfiguration_YAxisDisplayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIScatterPlotConfiguration_YAxisDisplayOptions::asJson() const {
...
QJsonObject OAIScatterPlotConfiguration_YAxisDisplayOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIScatterPlotConfiguration_YAxisDisplayOptions::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIScatterPlotConfiguration_YAxisDisplayOptions::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIScatterPlotConfiguration_YAxisDisplayOptions::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIScatterPlotConfiguration_YAxisDisplayOptions::getDataOptions() const {
    return m_data_options;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIScatterPlotConfiguration_YAxisDisplayOptions::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIScatterPlotConfiguration_YAxisDisplayOptions::getAxisOffset() const {
    return m_axis_offset;
}
void OAIScatterPlotConfiguration_YAxisDisplayOptions::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIScatterPlotConfiguration_YAxisDisplayOptions::isSet() const {
...
bool OAIScatterPlotConfiguration_YAxisDisplayOptions::isValid() const {
