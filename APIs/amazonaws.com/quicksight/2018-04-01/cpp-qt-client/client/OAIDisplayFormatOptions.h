...
/*
 * OAIDisplayFormatOptions.h
 *
 * A structure that represents additional options for display formatting.
 */

#ifndef OAIDisplayFormatOptions_H
#define OAIDisplayFormatOptions_H
...
class OAIDisplayFormatOptions : public OAIObject {
public:
    OAIDisplayFormatOptions();
    OAIDisplayFormatOptions(QString json);
    ~OAIDisplayFormatOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisplayFormatOptions)

#endif // OAIDisplayFormatOptions_H
