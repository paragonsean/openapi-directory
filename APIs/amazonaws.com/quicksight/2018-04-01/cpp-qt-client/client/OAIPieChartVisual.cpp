...
OAIPieChartVisual::OAIPieChartVisual(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPieChartVisual::OAIPieChartVisual() {
    this->initializeModel();
}

OAIPieChartVisual::~OAIPieChartVisual() {}

void OAIPieChartVisual::initializeModel() {
...
void OAIPieChartVisual::fromJson(QString jsonString) {
...
void OAIPieChartVisual::fromJsonObject(QJsonObject json) {
...
QString OAIPieChartVisual::asJson() const {
...
QJsonObject OAIPieChartVisual::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPieChartVisual::getVisualId() const {
    return m_visual_id;
}
void OAIPieChartVisual::setVisualId(const QString &visual_id) {
    m_visual_id = visual_id;
    m_visual_id_isSet = true;
}

bool OAIPieChartVisual::is_visual_id_Set() const{
    return m_visual_id_isSet;
}

bool OAIPieChartVisual::is_visual_id_Valid() const{
    return m_visual_id_isValid;
}

OAIBarChartVisual_Title OAIPieChartVisual::getTitle() const {
    return m_title;
}
void OAIPieChartVisual::setTitle(const OAIBarChartVisual_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIPieChartVisual::is_title_Set() const{
    return m_title_isSet;
}

bool OAIPieChartVisual::is_title_Valid() const{
    return m_title_isValid;
}

OAIBarChartVisual_Subtitle OAIPieChartVisual::getSubtitle() const {
    return m_subtitle;
}
void OAIPieChartVisual::setSubtitle(const OAIBarChartVisual_Subtitle &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAIPieChartVisual::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAIPieChartVisual::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

OAIPieChartVisual_ChartConfiguration OAIPieChartVisual::getChartConfiguration() const {
    return m_chart_configuration;
}
void OAIPieChartVisual::setChartConfiguration(const OAIPieChartVisual_ChartConfiguration &chart_configuration) {
    m_chart_configuration = chart_configuration;
    m_chart_configuration_isSet = true;
}

bool OAIPieChartVisual::is_chart_configuration_Set() const{
    return m_chart_configuration_isSet;
}

bool OAIPieChartVisual::is_chart_configuration_Valid() const{
    return m_chart_configuration_isValid;
}

QList OAIPieChartVisual::getActions() const {
    return m_actions;
}
void OAIPieChartVisual::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIPieChartVisual::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIPieChartVisual::is_actions_Valid() const{
    return m_actions_isValid;
}

QList OAIPieChartVisual::getColumnHierarchies() const {
    return m_column_hierarchies;
}
void OAIPieChartVisual::setColumnHierarchies(const QList &column_hierarchies) {
    m_column_hierarchies = column_hierarchies;
    m_column_hierarchies_isSet = true;
}

bool OAIPieChartVisual::is_column_hierarchies_Set() const{
    return m_column_hierarchies_isSet;
}

bool OAIPieChartVisual::is_column_hierarchies_Valid() const{
    return m_column_hierarchies_isValid;
}

bool OAIPieChartVisual::isSet() const {
...
bool OAIPieChartVisual::isValid() const {
