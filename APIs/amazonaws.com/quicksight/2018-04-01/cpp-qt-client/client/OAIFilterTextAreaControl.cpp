...
#include "OAIFilterTextAreaControl.h"
...
OAIFilterTextAreaControl::OAIFilterTextAreaControl(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilterTextAreaControl::OAIFilterTextAreaControl() {
    this->initializeModel();
}

OAIFilterTextAreaControl::~OAIFilterTextAreaControl() {}

void OAIFilterTextAreaControl::initializeModel() {
...
void OAIFilterTextAreaControl::fromJson(QString jsonString) {
...
void OAIFilterTextAreaControl::fromJsonObject(QJsonObject json) {
...
QString OAIFilterTextAreaControl::asJson() const {
...
QJsonObject OAIFilterTextAreaControl::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFilterTextAreaControl::getFilterControlId() const {
    return m_filter_control_id;
}
void OAIFilterTextAreaControl::setFilterControlId(const QString &filter_control_id) {
    m_filter_control_id = filter_control_id;
    m_filter_control_id_isSet = true;
}

bool OAIFilterTextAreaControl::is_filter_control_id_Set() const{
    return m_filter_control_id_isSet;
}

bool OAIFilterTextAreaControl::is_filter_control_id_Valid() const{
    return m_filter_control_id_isValid;
}

QString OAIFilterTextAreaControl::getTitle() const {
    return m_title;
}
void OAIFilterTextAreaControl::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIFilterTextAreaControl::is_title_Set() const{
    return m_title_isSet;
}

bool OAIFilterTextAreaControl::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIFilterTextAreaControl::getSourceFilterId() const {
    return m_source_filter_id;
}
void OAIFilterTextAreaControl::setSourceFilterId(const QString &source_filter_id) {
    m_source_filter_id = source_filter_id;
    m_source_filter_id_isSet = true;
}

bool OAIFilterTextAreaControl::is_source_filter_id_Set() const{
    return m_source_filter_id_isSet;
}

bool OAIFilterTextAreaControl::is_source_filter_id_Valid() const{
    return m_source_filter_id_isValid;
}

QString OAIFilterTextAreaControl::getDelimiter() const {
    return m_delimiter;
}
void OAIFilterTextAreaControl::setDelimiter(const QString &delimiter) {
    m_delimiter = delimiter;
    m_delimiter_isSet = true;
}

bool OAIFilterTextAreaControl::is_delimiter_Set() const{
    return m_delimiter_isSet;
}

bool OAIFilterTextAreaControl::is_delimiter_Valid() const{
    return m_delimiter_isValid;
}

OAIFilterTextAreaControl_DisplayOptions OAIFilterTextAreaControl::getDisplayOptions() const {
    return m_display_options;
}
void OAIFilterTextAreaControl::setDisplayOptions(const OAIFilterTextAreaControl_DisplayOptions &display_options) {
    m_display_options = display_options;
    m_display_options_isSet = true;
}

bool OAIFilterTextAreaControl::is_display_options_Set() const{
    return m_display_options_isSet;
}

bool OAIFilterTextAreaControl::is_display_options_Valid() const{
    return m_display_options_isValid;
}

bool OAIFilterTextAreaControl::isSet() const {
...
bool OAIFilterTextAreaControl::isValid() const {
