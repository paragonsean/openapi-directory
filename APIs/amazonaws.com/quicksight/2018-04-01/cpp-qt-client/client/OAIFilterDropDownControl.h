...
/*
 * OAIFilterDropDownControl.h
 *
 * A control to display a dropdown list with buttons that are used to select a single value.
 */

#ifndef OAIFilterDropDownControl_H
#define OAIFilterDropDownControl_H
...
class OAIFilterDropDownControl : public OAIObject {
public:
    OAIFilterDropDownControl();
    OAIFilterDropDownControl(QString json);
    ~OAIFilterDropDownControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterDropDownControl)

#endif // OAIFilterDropDownControl_H
