...
#include "OAIComboChartSortConfiguration.h"
...
OAIComboChartSortConfiguration::OAIComboChartSortConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComboChartSortConfiguration::OAIComboChartSortConfiguration() {
    this->initializeModel();
}

OAIComboChartSortConfiguration::~OAIComboChartSortConfiguration() {}

void OAIComboChartSortConfiguration::initializeModel() {
...
void OAIComboChartSortConfiguration::fromJson(QString jsonString) {
...
void OAIComboChartSortConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIComboChartSortConfiguration::asJson() const {
...
QJsonObject OAIComboChartSortConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIComboChartSortConfiguration::getCategorySort() const {
    return m_category_sort;
}
void OAIComboChartSortConfiguration::setCategorySort(const QList &category_sort) {
    m_category_sort = category_sort;
    m_category_sort_isSet = true;
}

bool OAIComboChartSortConfiguration::is_category_sort_Set() const{
    return m_category_sort_isSet;
}

bool OAIComboChartSortConfiguration::is_category_sort_Valid() const{
    return m_category_sort_isValid;
}

OAIComboChartSortConfiguration_CategoryItemsLimit OAIComboChartSortConfiguration::getCategoryItemsLimit() const {
    return m_category_items_limit;
}
void OAIComboChartSortConfiguration::setCategoryItemsLimit(const OAIComboChartSortConfiguration_CategoryItemsLimit &category_items_limit) {
    m_category_items_limit = category_items_limit;
    m_category_items_limit_isSet = true;
}

bool OAIComboChartSortConfiguration::is_category_items_limit_Set() const{
    return m_category_items_limit_isSet;
}

bool OAIComboChartSortConfiguration::is_category_items_limit_Valid() const{
    return m_category_items_limit_isValid;
}

QList OAIComboChartSortConfiguration::getColorSort() const {
    return m_color_sort;
}
void OAIComboChartSortConfiguration::setColorSort(const QList &color_sort) {
    m_color_sort = color_sort;
    m_color_sort_isSet = true;
}

bool OAIComboChartSortConfiguration::is_color_sort_Set() const{
    return m_color_sort_isSet;
}

bool OAIComboChartSortConfiguration::is_color_sort_Valid() const{
    return m_color_sort_isValid;
}

OAIComboChartSortConfiguration_ColorItemsLimit OAIComboChartSortConfiguration::getColorItemsLimit() const {
    return m_color_items_limit;
}
void OAIComboChartSortConfiguration::setColorItemsLimit(const OAIComboChartSortConfiguration_ColorItemsLimit &color_items_limit) {
    m_color_items_limit = color_items_limit;
    m_color_items_limit_isSet = true;
}

bool OAIComboChartSortConfiguration::is_color_items_limit_Set() const{
    return m_color_items_limit_isSet;
}

bool OAIComboChartSortConfiguration::is_color_items_limit_Valid() const{
    return m_color_items_limit_isValid;
}

bool OAIComboChartSortConfiguration::isSet() const {
...
bool OAIComboChartSortConfiguration::isValid() const {
