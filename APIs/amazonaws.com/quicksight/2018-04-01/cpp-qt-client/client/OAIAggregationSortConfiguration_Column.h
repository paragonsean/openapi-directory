...
/*
 * OAIAggregationSortConfiguration_Column.h
 *
 * 
 */

#ifndef OAIAggregationSortConfiguration_Column_H
#define OAIAggregationSortConfiguration_Column_H
...
class OAIAggregationSortConfiguration_Column : public OAIObject {
public:
    OAIAggregationSortConfiguration_Column();
    OAIAggregationSortConfiguration_Column(QString json);
    ~OAIAggregationSortConfiguration_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregationSortConfiguration_Column)

#endif // OAIAggregationSortConfiguration_Column_H
