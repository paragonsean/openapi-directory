...
#include "OAICurrencyDisplayFormatConfiguration.h"
...
OAICurrencyDisplayFormatConfiguration::OAICurrencyDisplayFormatConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyDisplayFormatConfiguration::OAICurrencyDisplayFormatConfiguration() {
    this->initializeModel();
}

OAICurrencyDisplayFormatConfiguration::~OAICurrencyDisplayFormatConfiguration() {}

void OAICurrencyDisplayFormatConfiguration::initializeModel() {
...
void OAICurrencyDisplayFormatConfiguration::fromJson(QString jsonString) {
...
void OAICurrencyDisplayFormatConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyDisplayFormatConfiguration::asJson() const {
...
QJsonObject OAICurrencyDisplayFormatConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_prefix_isSet) {
...
QString OAICurrencyDisplayFormatConfiguration::getPrefix() const {
    return m_prefix;
}
void OAICurrencyDisplayFormatConfiguration::setPrefix(const QString &prefix) {
    m_prefix = prefix;
    m_prefix_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_prefix_Set() const{
    return m_prefix_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_prefix_Valid() const{
    return m_prefix_isValid;
}

QString OAICurrencyDisplayFormatConfiguration::getSuffix() const {
    return m_suffix;
}
void OAICurrencyDisplayFormatConfiguration::setSuffix(const QString &suffix) {
    m_suffix = suffix;
    m_suffix_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_suffix_Set() const{
    return m_suffix_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_suffix_Valid() const{
    return m_suffix_isValid;
}

OAINumberDisplayFormatConfiguration_SeparatorConfiguration OAICurrencyDisplayFormatConfiguration::getSeparatorConfiguration() const {
    return m_separator_configuration;
}
void OAICurrencyDisplayFormatConfiguration::setSeparatorConfiguration(const OAINumberDisplayFormatConfiguration_SeparatorConfiguration &separator_configuration) {
    m_separator_configuration = separator_configuration;
    m_separator_configuration_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_separator_configuration_Set() const{
    return m_separator_configuration_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_separator_configuration_Valid() const{
    return m_separator_configuration_isValid;
}

QString OAICurrencyDisplayFormatConfiguration::getSymbol() const {
    return m_symbol;
}
void OAICurrencyDisplayFormatConfiguration::setSymbol(const QString &symbol) {
    m_symbol = symbol;
    m_symbol_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_symbol_Set() const{
    return m_symbol_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_symbol_Valid() const{
    return m_symbol_isValid;
}

OAINumberDisplayFormatConfiguration_DecimalPlacesConfiguration OAICurrencyDisplayFormatConfiguration::getDecimalPlacesConfiguration() const {
    return m_decimal_places_configuration;
}
void OAICurrencyDisplayFormatConfiguration::setDecimalPlacesConfiguration(const OAINumberDisplayFormatConfiguration_DecimalPlacesConfiguration &decimal_places_configuration) {
    m_decimal_places_configuration = decimal_places_configuration;
    m_decimal_places_configuration_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_decimal_places_configuration_Set() const{
    return m_decimal_places_configuration_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_decimal_places_configuration_Valid() const{
    return m_decimal_places_configuration_isValid;
}

OAINumberScale OAICurrencyDisplayFormatConfiguration::getNumberScale() const {
    return m_number_scale;
}
void OAICurrencyDisplayFormatConfiguration::setNumberScale(const OAINumberScale &number_scale) {
    m_number_scale = number_scale;
    m_number_scale_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_number_scale_Set() const{
    return m_number_scale_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_number_scale_Valid() const{
    return m_number_scale_isValid;
}

OAINumberDisplayFormatConfiguration_NegativeValueConfiguration OAICurrencyDisplayFormatConfiguration::getNegativeValueConfiguration() const {
    return m_negative_value_configuration;
}
void OAICurrencyDisplayFormatConfiguration::setNegativeValueConfiguration(const OAINumberDisplayFormatConfiguration_NegativeValueConfiguration &negative_value_configuration) {
    m_negative_value_configuration = negative_value_configuration;
    m_negative_value_configuration_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_negative_value_configuration_Set() const{
    return m_negative_value_configuration_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_negative_value_configuration_Valid() const{
    return m_negative_value_configuration_isValid;
}

OAIStringFormatConfiguration_NullValueFormatConfiguration OAICurrencyDisplayFormatConfiguration::getNullValueFormatConfiguration() const {
    return m_null_value_format_configuration;
}
void OAICurrencyDisplayFormatConfiguration::setNullValueFormatConfiguration(const OAIStringFormatConfiguration_NullValueFormatConfiguration &null_value_format_configuration) {
    m_null_value_format_configuration = null_value_format_configuration;
    m_null_value_format_configuration_isSet = true;
}

bool OAICurrencyDisplayFormatConfiguration::is_null_value_format_configuration_Set() const{
    return m_null_value_format_configuration_isSet;
}

bool OAICurrencyDisplayFormatConfiguration::is_null_value_format_configuration_Valid() const{
    return m_null_value_format_configuration_isValid;
}

bool OAICurrencyDisplayFormatConfiguration::isSet() const {
...
bool OAICurrencyDisplayFormatConfiguration::isValid() const {
