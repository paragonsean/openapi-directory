...
#include "OAITopicRefreshSchedule.h"
...
OAITopicRefreshSchedule::OAITopicRefreshSchedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITopicRefreshSchedule::OAITopicRefreshSchedule() {
    this->initializeModel();
}

OAITopicRefreshSchedule::~OAITopicRefreshSchedule() {}

void OAITopicRefreshSchedule::initializeModel() {
...
void OAITopicRefreshSchedule::fromJson(QString jsonString) {
...
void OAITopicRefreshSchedule::fromJsonObject(QJsonObject json) {
...
QString OAITopicRefreshSchedule::asJson() const {
...
QJsonObject OAITopicRefreshSchedule::asJsonObject() const {
    QJsonObject obj;
...
bool OAITopicRefreshSchedule::getIsEnabled() const {
    return m_is_enabled;
}
void OAITopicRefreshSchedule::setIsEnabled(const bool &is_enabled) {
    m_is_enabled = is_enabled;
    m_is_enabled_isSet = true;
}

bool OAITopicRefreshSchedule::is_is_enabled_Set() const{
    return m_is_enabled_isSet;
}

bool OAITopicRefreshSchedule::is_is_enabled_Valid() const{
    return m_is_enabled_isValid;
}

bool OAITopicRefreshSchedule::getBasedOnSpiceSchedule() const {
    return m_based_on_spice_schedule;
}
void OAITopicRefreshSchedule::setBasedOnSpiceSchedule(const bool &based_on_spice_schedule) {
    m_based_on_spice_schedule = based_on_spice_schedule;
    m_based_on_spice_schedule_isSet = true;
}

bool OAITopicRefreshSchedule::is_based_on_spice_schedule_Set() const{
    return m_based_on_spice_schedule_isSet;
}

bool OAITopicRefreshSchedule::is_based_on_spice_schedule_Valid() const{
    return m_based_on_spice_schedule_isValid;
}

QDateTime OAITopicRefreshSchedule::getStartingAt() const {
    return m_starting_at;
}
void OAITopicRefreshSchedule::setStartingAt(const QDateTime &starting_at) {
    m_starting_at = starting_at;
    m_starting_at_isSet = true;
}

bool OAITopicRefreshSchedule::is_starting_at_Set() const{
    return m_starting_at_isSet;
}

bool OAITopicRefreshSchedule::is_starting_at_Valid() const{
    return m_starting_at_isValid;
}

QString OAITopicRefreshSchedule::getTimezone() const {
    return m_timezone;
}
void OAITopicRefreshSchedule::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAITopicRefreshSchedule::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAITopicRefreshSchedule::is_timezone_Valid() const{
    return m_timezone_isValid;
}

QString OAITopicRefreshSchedule::getRepeatAt() const {
    return m_repeat_at;
}
void OAITopicRefreshSchedule::setRepeatAt(const QString &repeat_at) {
    m_repeat_at = repeat_at;
    m_repeat_at_isSet = true;
}

bool OAITopicRefreshSchedule::is_repeat_at_Set() const{
    return m_repeat_at_isSet;
}

bool OAITopicRefreshSchedule::is_repeat_at_Valid() const{
    return m_repeat_at_isValid;
}

OAITopicScheduleType OAITopicRefreshSchedule::getTopicScheduleType() const {
    return m_topic_schedule_type;
}
void OAITopicRefreshSchedule::setTopicScheduleType(const OAITopicScheduleType &topic_schedule_type) {
    m_topic_schedule_type = topic_schedule_type;
    m_topic_schedule_type_isSet = true;
}

bool OAITopicRefreshSchedule::is_topic_schedule_type_Set() const{
    return m_topic_schedule_type_isSet;
}

bool OAITopicRefreshSchedule::is_topic_schedule_type_Valid() const{
    return m_topic_schedule_type_isValid;
}

bool OAITopicRefreshSchedule::isSet() const {
...
bool OAITopicRefreshSchedule::isValid() const {
