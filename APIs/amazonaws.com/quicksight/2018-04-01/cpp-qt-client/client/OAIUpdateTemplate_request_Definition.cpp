...
OAIUpdateTemplate_request_Definition::OAIUpdateTemplate_request_Definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTemplate_request_Definition::OAIUpdateTemplate_request_Definition() {
    this->initializeModel();
}

OAIUpdateTemplate_request_Definition::~OAIUpdateTemplate_request_Definition() {}

void OAIUpdateTemplate_request_Definition::initializeModel() {
...
void OAIUpdateTemplate_request_Definition::fromJson(QString jsonString) {
...
void OAIUpdateTemplate_request_Definition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTemplate_request_Definition::asJson() const {
...
QJsonObject OAIUpdateTemplate_request_Definition::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateTemplate_request_Definition::getDataSetConfigurations() const {
    return m_data_set_configurations;
}
void OAIUpdateTemplate_request_Definition::setDataSetConfigurations(const QList &data_set_configurations) {
    m_data_set_configurations = data_set_configurations;
    m_data_set_configurations_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_data_set_configurations_Set() const{
    return m_data_set_configurations_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_data_set_configurations_Valid() const{
    return m_data_set_configurations_isValid;
}

QList OAIUpdateTemplate_request_Definition::getSheets() const {
    return m_sheets;
}
void OAIUpdateTemplate_request_Definition::setSheets(const QList &sheets) {
    m_sheets = sheets;
    m_sheets_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_sheets_Set() const{
    return m_sheets_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_sheets_Valid() const{
    return m_sheets_isValid;
}

QList OAIUpdateTemplate_request_Definition::getCalculatedFields() const {
    return m_calculated_fields;
}
void OAIUpdateTemplate_request_Definition::setCalculatedFields(const QList &calculated_fields) {
    m_calculated_fields = calculated_fields;
    m_calculated_fields_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_calculated_fields_Set() const{
    return m_calculated_fields_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_calculated_fields_Valid() const{
    return m_calculated_fields_isValid;
}

QList OAIUpdateTemplate_request_Definition::getParameterDeclarations() const {
    return m_parameter_declarations;
}
void OAIUpdateTemplate_request_Definition::setParameterDeclarations(const QList &parameter_declarations) {
    m_parameter_declarations = parameter_declarations;
    m_parameter_declarations_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_parameter_declarations_Set() const{
    return m_parameter_declarations_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_parameter_declarations_Valid() const{
    return m_parameter_declarations_isValid;
}

QList OAIUpdateTemplate_request_Definition::getFilterGroups() const {
    return m_filter_groups;
}
void OAIUpdateTemplate_request_Definition::setFilterGroups(const QList &filter_groups) {
    m_filter_groups = filter_groups;
    m_filter_groups_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_filter_groups_Set() const{
    return m_filter_groups_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_filter_groups_Valid() const{
    return m_filter_groups_isValid;
}

QList OAIUpdateTemplate_request_Definition::getColumnConfigurations() const {
    return m_column_configurations;
}
void OAIUpdateTemplate_request_Definition::setColumnConfigurations(const QList &column_configurations) {
    m_column_configurations = column_configurations;
    m_column_configurations_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_column_configurations_Set() const{
    return m_column_configurations_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_column_configurations_Valid() const{
    return m_column_configurations_isValid;
}

OAIAnalysisDefaults OAIUpdateTemplate_request_Definition::getAnalysisDefaults() const {
    return m_analysis_defaults;
}
void OAIUpdateTemplate_request_Definition::setAnalysisDefaults(const OAIAnalysisDefaults &analysis_defaults) {
    m_analysis_defaults = analysis_defaults;
    m_analysis_defaults_isSet = true;
}

bool OAIUpdateTemplate_request_Definition::is_analysis_defaults_Set() const{
    return m_analysis_defaults_isSet;
}

bool OAIUpdateTemplate_request_Definition::is_analysis_defaults_Valid() const{
    return m_analysis_defaults_isValid;
}

bool OAIUpdateTemplate_request_Definition::isSet() const {
...
bool OAIUpdateTemplate_request_Definition::isValid() const {
