...
/*
 * OAITopicRefreshSchedule.h
 *
 * A structure that represents a topic refresh schedule.
 */

#ifndef OAITopicRefreshSchedule_H
#define OAITopicRefreshSchedule_H
...
class OAITopicRefreshSchedule : public OAIObject {
public:
    OAITopicRefreshSchedule();
    OAITopicRefreshSchedule(QString json);
    ~OAITopicRefreshSchedule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITopicRefreshSchedule)

#endif // OAITopicRefreshSchedule_H
