...
/*
 * OAILabelOptions_FontConfiguration.h
 *
 * 
 */

#ifndef OAILabelOptions_FontConfiguration_H
#define OAILabelOptions_FontConfiguration_H
...
class OAILabelOptions_FontConfiguration : public OAIObject {
public:
    OAILabelOptions_FontConfiguration();
    OAILabelOptions_FontConfiguration(QString json);
    ~OAILabelOptions_FontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelOptions_FontConfiguration)

#endif // OAILabelOptions_FontConfiguration_H
