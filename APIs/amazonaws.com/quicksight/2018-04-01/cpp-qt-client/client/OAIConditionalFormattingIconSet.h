...
/*
 * OAIConditionalFormattingIconSet.h
 *
 * Formatting configuration for icon set.
 */

#ifndef OAIConditionalFormattingIconSet_H
#define OAIConditionalFormattingIconSet_H
...
class OAIConditionalFormattingIconSet : public OAIObject {
public:
    OAIConditionalFormattingIconSet();
    OAIConditionalFormattingIconSet(QString json);
    ~OAIConditionalFormattingIconSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionalFormattingIconSet)

#endif // OAIConditionalFormattingIconSet_H
