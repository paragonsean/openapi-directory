...
/*
 * OAIScatterPlotVisual_ChartConfiguration.h
 *
 * 
 */

#ifndef OAIScatterPlotVisual_ChartConfiguration_H
#define OAIScatterPlotVisual_ChartConfiguration_H
...
class OAIScatterPlotVisual_ChartConfiguration : public OAIObject {
public:
    OAIScatterPlotVisual_ChartConfiguration();
    OAIScatterPlotVisual_ChartConfiguration(QString json);
    ~OAIScatterPlotVisual_ChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScatterPlotVisual_ChartConfiguration)

#endif // OAIScatterPlotVisual_ChartConfiguration_H
