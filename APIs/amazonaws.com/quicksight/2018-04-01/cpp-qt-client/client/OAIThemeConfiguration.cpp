...
#include "OAIThemeConfiguration.h"
...
OAIThemeConfiguration::OAIThemeConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIThemeConfiguration::OAIThemeConfiguration() {
    this->initializeModel();
}

OAIThemeConfiguration::~OAIThemeConfiguration() {}

void OAIThemeConfiguration::initializeModel() {
...
void OAIThemeConfiguration::fromJson(QString jsonString) {
...
void OAIThemeConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIThemeConfiguration::asJson() const {
...
QJsonObject OAIThemeConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateTheme_request_Configuration_DataColorPalette OAIThemeConfiguration::getDataColorPalette() const {
    return m_data_color_palette;
}
void OAIThemeConfiguration::setDataColorPalette(const OAIUpdateTheme_request_Configuration_DataColorPalette &data_color_palette) {
    m_data_color_palette = data_color_palette;
    m_data_color_palette_isSet = true;
}

bool OAIThemeConfiguration::is_data_color_palette_Set() const{
    return m_data_color_palette_isSet;
}

bool OAIThemeConfiguration::is_data_color_palette_Valid() const{
    return m_data_color_palette_isValid;
}

OAIUpdateTheme_request_Configuration_UIColorPalette OAIThemeConfiguration::getUiColorPalette() const {
    return m_ui_color_palette;
}
void OAIThemeConfiguration::setUiColorPalette(const OAIUpdateTheme_request_Configuration_UIColorPalette &ui_color_palette) {
    m_ui_color_palette = ui_color_palette;
    m_ui_color_palette_isSet = true;
}

bool OAIThemeConfiguration::is_ui_color_palette_Set() const{
    return m_ui_color_palette_isSet;
}

bool OAIThemeConfiguration::is_ui_color_palette_Valid() const{
    return m_ui_color_palette_isValid;
}

OAIUpdateTheme_request_Configuration_Sheet OAIThemeConfiguration::getSheet() const {
    return m_sheet;
}
void OAIThemeConfiguration::setSheet(const OAIUpdateTheme_request_Configuration_Sheet &sheet) {
    m_sheet = sheet;
    m_sheet_isSet = true;
}

bool OAIThemeConfiguration::is_sheet_Set() const{
    return m_sheet_isSet;
}

bool OAIThemeConfiguration::is_sheet_Valid() const{
    return m_sheet_isValid;
}

OAITypography OAIThemeConfiguration::getTypography() const {
    return m_typography;
}
void OAIThemeConfiguration::setTypography(const OAITypography &typography) {
    m_typography = typography;
    m_typography_isSet = true;
}

bool OAIThemeConfiguration::is_typography_Set() const{
    return m_typography_isSet;
}

bool OAIThemeConfiguration::is_typography_Valid() const{
    return m_typography_isValid;
}

bool OAIThemeConfiguration::isSet() const {
...
bool OAIThemeConfiguration::isValid() const {
