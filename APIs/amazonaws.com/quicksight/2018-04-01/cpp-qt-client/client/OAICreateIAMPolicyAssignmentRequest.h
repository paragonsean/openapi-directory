...
/*
 * OAICreateIAMPolicyAssignmentRequest.h
 *
 * 
 */

#ifndef OAICreateIAMPolicyAssignmentRequest_H
#define OAICreateIAMPolicyAssignmentRequest_H
...
class OAICreateIAMPolicyAssignmentRequest : public OAIObject {
public:
    OAICreateIAMPolicyAssignmentRequest();
    OAICreateIAMPolicyAssignmentRequest(QString json);
    ~OAICreateIAMPolicyAssignmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIAMPolicyAssignmentRequest)

#endif // OAICreateIAMPolicyAssignmentRequest_H
