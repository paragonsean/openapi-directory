...
/*
 * OAIAxisLabelOptions_FontConfiguration.h
 *
 * 
 */

#ifndef OAIAxisLabelOptions_FontConfiguration_H
#define OAIAxisLabelOptions_FontConfiguration_H
...
class OAIAxisLabelOptions_FontConfiguration : public OAIObject {
public:
    OAIAxisLabelOptions_FontConfiguration();
    OAIAxisLabelOptions_FontConfiguration(QString json);
    ~OAIAxisLabelOptions_FontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAxisLabelOptions_FontConfiguration)

#endif // OAIAxisLabelOptions_FontConfiguration_H
