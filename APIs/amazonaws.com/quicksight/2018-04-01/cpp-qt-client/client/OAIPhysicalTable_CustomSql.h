...
/*
 * OAIPhysicalTable_CustomSql.h
 *
 * 
 */

#ifndef OAIPhysicalTable_CustomSql_H
#define OAIPhysicalTable_CustomSql_H
...
class OAIPhysicalTable_CustomSql : public OAIObject {
public:
    OAIPhysicalTable_CustomSql();
    OAIPhysicalTable_CustomSql(QString json);
    ~OAIPhysicalTable_CustomSql() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhysicalTable_CustomSql)

#endif // OAIPhysicalTable_CustomSql_H
