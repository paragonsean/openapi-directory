...
OAITableOptions_HeaderStyle::OAITableOptions_HeaderStyle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITableOptions_HeaderStyle::OAITableOptions_HeaderStyle() {
    this->initializeModel();
}

OAITableOptions_HeaderStyle::~OAITableOptions_HeaderStyle() {}

void OAITableOptions_HeaderStyle::initializeModel() {
...
void OAITableOptions_HeaderStyle::fromJson(QString jsonString) {
...
void OAITableOptions_HeaderStyle::fromJsonObject(QJsonObject json) {
...
QString OAITableOptions_HeaderStyle::asJson() const {
...
QJsonObject OAITableOptions_HeaderStyle::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAITableOptions_HeaderStyle::getVisibility() const {
    return m_visibility;
}
void OAITableOptions_HeaderStyle::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAITableOptions_HeaderStyle::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAITableCellStyle_FontConfiguration OAITableOptions_HeaderStyle::getFontConfiguration() const {
    return m_font_configuration;
}
void OAITableOptions_HeaderStyle::setFontConfiguration(const OAITableCellStyle_FontConfiguration &font_configuration) {
    m_font_configuration = font_configuration;
    m_font_configuration_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_font_configuration_Set() const{
    return m_font_configuration_isSet;
}

bool OAITableOptions_HeaderStyle::is_font_configuration_Valid() const{
    return m_font_configuration_isValid;
}

OAITextWrap OAITableOptions_HeaderStyle::getTextWrap() const {
    return m_text_wrap;
}
void OAITableOptions_HeaderStyle::setTextWrap(const OAITextWrap &text_wrap) {
    m_text_wrap = text_wrap;
    m_text_wrap_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_text_wrap_Set() const{
    return m_text_wrap_isSet;
}

bool OAITableOptions_HeaderStyle::is_text_wrap_Valid() const{
    return m_text_wrap_isValid;
}

OAIHorizontalTextAlignment OAITableOptions_HeaderStyle::getHorizontalTextAlignment() const {
    return m_horizontal_text_alignment;
}
void OAITableOptions_HeaderStyle::setHorizontalTextAlignment(const OAIHorizontalTextAlignment &horizontal_text_alignment) {
    m_horizontal_text_alignment = horizontal_text_alignment;
    m_horizontal_text_alignment_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_horizontal_text_alignment_Set() const{
    return m_horizontal_text_alignment_isSet;
}

bool OAITableOptions_HeaderStyle::is_horizontal_text_alignment_Valid() const{
    return m_horizontal_text_alignment_isValid;
}

OAIVerticalTextAlignment OAITableOptions_HeaderStyle::getVerticalTextAlignment() const {
    return m_vertical_text_alignment;
}
void OAITableOptions_HeaderStyle::setVerticalTextAlignment(const OAIVerticalTextAlignment &vertical_text_alignment) {
    m_vertical_text_alignment = vertical_text_alignment;
    m_vertical_text_alignment_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_vertical_text_alignment_Set() const{
    return m_vertical_text_alignment_isSet;
}

bool OAITableOptions_HeaderStyle::is_vertical_text_alignment_Valid() const{
    return m_vertical_text_alignment_isValid;
}

QString OAITableOptions_HeaderStyle::getBackgroundColor() const {
    return m_background_color;
}
void OAITableOptions_HeaderStyle::setBackgroundColor(const QString &background_color) {
    m_background_color = background_color;
    m_background_color_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_background_color_Set() const{
    return m_background_color_isSet;
}

bool OAITableOptions_HeaderStyle::is_background_color_Valid() const{
    return m_background_color_isValid;
}

qint32 OAITableOptions_HeaderStyle::getHeight() const {
    return m_height;
}
void OAITableOptions_HeaderStyle::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_height_Set() const{
    return m_height_isSet;
}

bool OAITableOptions_HeaderStyle::is_height_Valid() const{
    return m_height_isValid;
}

OAITableCellStyle_Border OAITableOptions_HeaderStyle::getBorder() const {
    return m_border;
}
void OAITableOptions_HeaderStyle::setBorder(const OAITableCellStyle_Border &border) {
    m_border = border;
    m_border_isSet = true;
}

bool OAITableOptions_HeaderStyle::is_border_Set() const{
    return m_border_isSet;
}

bool OAITableOptions_HeaderStyle::is_border_Valid() const{
    return m_border_isValid;
}

bool OAITableOptions_HeaderStyle::isSet() const {
...
bool OAITableOptions_HeaderStyle::isValid() const {
