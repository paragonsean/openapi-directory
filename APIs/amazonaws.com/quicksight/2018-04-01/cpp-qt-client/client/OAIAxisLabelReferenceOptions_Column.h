...
/*
 * OAIAxisLabelReferenceOptions_Column.h
 *
 * 
 */

#ifndef OAIAxisLabelReferenceOptions_Column_H
#define OAIAxisLabelReferenceOptions_Column_H
...
class OAIAxisLabelReferenceOptions_Column : public OAIObject {
public:
    OAIAxisLabelReferenceOptions_Column();
    OAIAxisLabelReferenceOptions_Column(QString json);
    ~OAIAxisLabelReferenceOptions_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAxisLabelReferenceOptions_Column)

#endif // OAIAxisLabelReferenceOptions_Column_H
