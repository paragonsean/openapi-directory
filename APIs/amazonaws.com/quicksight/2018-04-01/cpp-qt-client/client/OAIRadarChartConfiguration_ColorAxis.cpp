...
OAIRadarChartConfiguration_ColorAxis::OAIRadarChartConfiguration_ColorAxis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRadarChartConfiguration_ColorAxis::OAIRadarChartConfiguration_ColorAxis() {
    this->initializeModel();
}

OAIRadarChartConfiguration_ColorAxis::~OAIRadarChartConfiguration_ColorAxis() {}

void OAIRadarChartConfiguration_ColorAxis::initializeModel() {
...
void OAIRadarChartConfiguration_ColorAxis::fromJson(QString jsonString) {
...
void OAIRadarChartConfiguration_ColorAxis::fromJsonObject(QJsonObject json) {
...
QString OAIRadarChartConfiguration_ColorAxis::asJson() const {
...
QJsonObject OAIRadarChartConfiguration_ColorAxis::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIRadarChartConfiguration_ColorAxis::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIRadarChartConfiguration_ColorAxis::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIRadarChartConfiguration_ColorAxis::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIRadarChartConfiguration_ColorAxis::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIRadarChartConfiguration_ColorAxis::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIRadarChartConfiguration_ColorAxis::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIRadarChartConfiguration_ColorAxis::getDataOptions() const {
    return m_data_options;
}
void OAIRadarChartConfiguration_ColorAxis::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIRadarChartConfiguration_ColorAxis::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIRadarChartConfiguration_ColorAxis::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIRadarChartConfiguration_ColorAxis::getAxisOffset() const {
    return m_axis_offset;
}
void OAIRadarChartConfiguration_ColorAxis::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIRadarChartConfiguration_ColorAxis::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIRadarChartConfiguration_ColorAxis::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIRadarChartConfiguration_ColorAxis::isSet() const {
...
bool OAIRadarChartConfiguration_ColorAxis::isValid() const {
