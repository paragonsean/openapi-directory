...
#ifndef OAIUIColorPalette_H
#define OAIUIColorPalette_H
...
class OAIUIColorPalette : public OAIObject {
public:
    OAIUIColorPalette();
    OAIUIColorPalette(QString json);
    ~OAIUIColorPalette() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUIColorPalette)

#endif // OAIUIColorPalette_H
