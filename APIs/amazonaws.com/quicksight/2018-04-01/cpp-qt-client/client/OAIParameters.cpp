...
QList OAIParameters::getStringParameters() const {
    return m_string_parameters;
}
void OAIParameters::setStringParameters(const QList &string_parameters) {
    m_string_parameters = string_parameters;
    m_string_parameters_isSet = true;
}

bool OAIParameters::is_string_parameters_Set() const{
    return m_string_parameters_isSet;
}

bool OAIParameters::is_string_parameters_Valid() const{
    return m_string_parameters_isValid;
}

QList OAIParameters::getIntegerParameters() const {
    return m_integer_parameters;
}
void OAIParameters::setIntegerParameters(const QList &integer_parameters) {
    m_integer_parameters = integer_parameters;
    m_integer_parameters_isSet = true;
}

bool OAIParameters::is_integer_parameters_Set() const{
    return m_integer_parameters_isSet;
}

bool OAIParameters::is_integer_parameters_Valid() const{
    return m_integer_parameters_isValid;
}

QList OAIParameters::getDecimalParameters() const {
    return m_decimal_parameters;
}
void OAIParameters::setDecimalParameters(const QList &decimal_parameters) {
    m_decimal_parameters = decimal_parameters;
    m_decimal_parameters_isSet = true;
}

bool OAIParameters::is_decimal_parameters_Set() const{
    return m_decimal_parameters_isSet;
}

bool OAIParameters::is_decimal_parameters_Valid() const{
    return m_decimal_parameters_isValid;
}

QList OAIParameters::getDateTimeParameters() const {
    return m_date_time_parameters;
}
void OAIParameters::setDateTimeParameters(const QList &date_time_parameters) {
    m_date_time_parameters = date_time_parameters;
    m_date_time_parameters_isSet = true;
}

bool OAIParameters::is_date_time_parameters_Set() const{
    return m_date_time_parameters_isSet;
}

bool OAIParameters::is_date_time_parameters_Valid() const{
