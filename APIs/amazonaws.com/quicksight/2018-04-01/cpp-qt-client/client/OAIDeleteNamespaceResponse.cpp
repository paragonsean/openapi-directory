...
QString OAIDeleteNamespaceResponse::getRequestId() const {
    return m_request_id;
}
void OAIDeleteNamespaceResponse::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIDeleteNamespaceResponse::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIDeleteNamespaceResponse::is_request_id_Valid() const{
    return m_request_id_isValid;
}

qint32 OAIDeleteNamespaceResponse::getStatus() const {
    return m_status;
}
void OAIDeleteNamespaceResponse::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteNamespaceResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteNamespaceResponse::is_status_Valid() const{
