...
OAIBarChartConfiguration_DataLabels::OAIBarChartConfiguration_DataLabels(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBarChartConfiguration_DataLabels::OAIBarChartConfiguration_DataLabels() {
    this->initializeModel();
}

OAIBarChartConfiguration_DataLabels::~OAIBarChartConfiguration_DataLabels() {}

void OAIBarChartConfiguration_DataLabels::initializeModel() {
...
void OAIBarChartConfiguration_DataLabels::fromJson(QString jsonString) {
...
void OAIBarChartConfiguration_DataLabels::fromJsonObject(QJsonObject json) {
...
QString OAIBarChartConfiguration_DataLabels::asJson() const {
...
QJsonObject OAIBarChartConfiguration_DataLabels::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAIBarChartConfiguration_DataLabels::getVisibility() const {
    return m_visibility;
}
void OAIBarChartConfiguration_DataLabels::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAIVisibility OAIBarChartConfiguration_DataLabels::getCategoryLabelVisibility() const {
    return m_category_label_visibility;
}
void OAIBarChartConfiguration_DataLabels::setCategoryLabelVisibility(const OAIVisibility &category_label_visibility) {
    m_category_label_visibility = category_label_visibility;
    m_category_label_visibility_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_category_label_visibility_Set() const{
    return m_category_label_visibility_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_category_label_visibility_Valid() const{
    return m_category_label_visibility_isValid;
}

OAIVisibility OAIBarChartConfiguration_DataLabels::getMeasureLabelVisibility() const {
    return m_measure_label_visibility;
}
void OAIBarChartConfiguration_DataLabels::setMeasureLabelVisibility(const OAIVisibility &measure_label_visibility) {
    m_measure_label_visibility = measure_label_visibility;
    m_measure_label_visibility_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_measure_label_visibility_Set() const{
    return m_measure_label_visibility_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_measure_label_visibility_Valid() const{
    return m_measure_label_visibility_isValid;
}

QList OAIBarChartConfiguration_DataLabels::getDataLabelTypes() const {
    return m_data_label_types;
}
void OAIBarChartConfiguration_DataLabels::setDataLabelTypes(const QList &data_label_types) {
    m_data_label_types = data_label_types;
    m_data_label_types_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_data_label_types_Set() const{
    return m_data_label_types_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_data_label_types_Valid() const{
    return m_data_label_types_isValid;
}

OAIDataLabelPosition OAIBarChartConfiguration_DataLabels::getPosition() const {
    return m_position;
}
void OAIBarChartConfiguration_DataLabels::setPosition(const OAIDataLabelPosition &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_position_Set() const{
    return m_position_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_position_Valid() const{
    return m_position_isValid;
}

OAIDataLabelContent OAIBarChartConfiguration_DataLabels::getLabelContent() const {
    return m_label_content;
}
void OAIBarChartConfiguration_DataLabels::setLabelContent(const OAIDataLabelContent &label_content) {
    m_label_content = label_content;
    m_label_content_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_label_content_Set() const{
    return m_label_content_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_label_content_Valid() const{
    return m_label_content_isValid;
}

OAIDataLabelOptions_LabelFontConfiguration OAIBarChartConfiguration_DataLabels::getLabelFontConfiguration() const {
    return m_label_font_configuration;
}
void OAIBarChartConfiguration_DataLabels::setLabelFontConfiguration(const OAIDataLabelOptions_LabelFontConfiguration &label_font_configuration) {
    m_label_font_configuration = label_font_configuration;
    m_label_font_configuration_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_label_font_configuration_Set() const{
    return m_label_font_configuration_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_label_font_configuration_Valid() const{
    return m_label_font_configuration_isValid;
}

QString OAIBarChartConfiguration_DataLabels::getLabelColor() const {
    return m_label_color;
}
void OAIBarChartConfiguration_DataLabels::setLabelColor(const QString &label_color) {
    m_label_color = label_color;
    m_label_color_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_label_color_Set() const{
    return m_label_color_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_label_color_Valid() const{
    return m_label_color_isValid;
}

OAIDataLabelOverlap OAIBarChartConfiguration_DataLabels::getOverlap() const {
    return m_overlap;
}
void OAIBarChartConfiguration_DataLabels::setOverlap(const OAIDataLabelOverlap &overlap) {
    m_overlap = overlap;
    m_overlap_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_overlap_Set() const{
    return m_overlap_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_overlap_Valid() const{
    return m_overlap_isValid;
}

OAIVisibility OAIBarChartConfiguration_DataLabels::getTotalsVisibility() const {
    return m_totals_visibility;
}
void OAIBarChartConfiguration_DataLabels::setTotalsVisibility(const OAIVisibility &totals_visibility) {
    m_totals_visibility = totals_visibility;
    m_totals_visibility_isSet = true;
}

bool OAIBarChartConfiguration_DataLabels::is_totals_visibility_Set() const{
    return m_totals_visibility_isSet;
}

bool OAIBarChartConfiguration_DataLabels::is_totals_visibility_Valid() const{
    return m_totals_visibility_isValid;
}

bool OAIBarChartConfiguration_DataLabels::isSet() const {
...
bool OAIBarChartConfiguration_DataLabels::isValid() const {
