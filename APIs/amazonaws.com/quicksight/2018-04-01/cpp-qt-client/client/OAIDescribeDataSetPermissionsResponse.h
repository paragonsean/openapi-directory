...
/*
 * OAIDescribeDataSetPermissionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeDataSetPermissionsResponse_H
#define OAIDescribeDataSetPermissionsResponse_H
...
class OAIDescribeDataSetPermissionsResponse : public OAIObject {
public:
    OAIDescribeDataSetPermissionsResponse();
    OAIDescribeDataSetPermissionsResponse(QString json);
    ~OAIDescribeDataSetPermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataSetPermissionsResponse)

#endif // OAIDescribeDataSetPermissionsResponse_H
