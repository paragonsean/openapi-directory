...
/*
 * OAIDataSet_RowLevelPermissionDataSet.h
 *
 * 
 */

#ifndef OAIDataSet_RowLevelPermissionDataSet_H
#define OAIDataSet_RowLevelPermissionDataSet_H
...
class OAIDataSet_RowLevelPermissionDataSet : public OAIObject {
public:
    OAIDataSet_RowLevelPermissionDataSet();
    OAIDataSet_RowLevelPermissionDataSet(QString json);
    ~OAIDataSet_RowLevelPermissionDataSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSet_RowLevelPermissionDataSet)

#endif // OAIDataSet_RowLevelPermissionDataSet_H
