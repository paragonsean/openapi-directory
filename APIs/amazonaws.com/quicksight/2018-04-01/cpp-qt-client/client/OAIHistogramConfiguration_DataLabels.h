...
/*
 * OAIHistogramConfiguration_DataLabels.h
 *
 * 
 */

#ifndef OAIHistogramConfiguration_DataLabels_H
#define OAIHistogramConfiguration_DataLabels_H
...
class OAIHistogramConfiguration_DataLabels : public OAIObject {
public:
    OAIHistogramConfiguration_DataLabels();
    OAIHistogramConfiguration_DataLabels(QString json);
    ~OAIHistogramConfiguration_DataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramConfiguration_DataLabels)

#endif // OAIHistogramConfiguration_DataLabels_H
