...
/*
 * OAIGaugeChartVisual_ChartConfiguration.h
 *
 * 
 */

#ifndef OAIGaugeChartVisual_ChartConfiguration_H
#define OAIGaugeChartVisual_ChartConfiguration_H
...
class OAIGaugeChartVisual_ChartConfiguration : public OAIObject {
public:
    OAIGaugeChartVisual_ChartConfiguration();
    OAIGaugeChartVisual_ChartConfiguration(QString json);
    ~OAIGaugeChartVisual_ChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartVisual_ChartConfiguration)

#endif // OAIGaugeChartVisual_ChartConfiguration_H
