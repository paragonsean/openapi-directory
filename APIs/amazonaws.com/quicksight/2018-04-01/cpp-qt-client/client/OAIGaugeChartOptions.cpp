...
#include "OAIGaugeChartOptions.h"
...
OAIGaugeChartOptions::OAIGaugeChartOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGaugeChartOptions::OAIGaugeChartOptions() {
    this->initializeModel();
}

OAIGaugeChartOptions::~OAIGaugeChartOptions() {}

void OAIGaugeChartOptions::initializeModel() {
...
void OAIGaugeChartOptions::fromJson(QString jsonString) {
...
void OAIGaugeChartOptions::fromJsonObject(QJsonObject json) {
...
QString OAIGaugeChartOptions::asJson() const {
...
QJsonObject OAIGaugeChartOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIPrimaryValueDisplayType OAIGaugeChartOptions::getPrimaryValueDisplayType() const {
    return m_primary_value_display_type;
}
void OAIGaugeChartOptions::setPrimaryValueDisplayType(const OAIPrimaryValueDisplayType &primary_value_display_type) {
    m_primary_value_display_type = primary_value_display_type;
    m_primary_value_display_type_isSet = true;
}

bool OAIGaugeChartOptions::is_primary_value_display_type_Set() const{
    return m_primary_value_display_type_isSet;
}

bool OAIGaugeChartOptions::is_primary_value_display_type_Valid() const{
    return m_primary_value_display_type_isValid;
}

OAIGaugeChartOptions_Comparison OAIGaugeChartOptions::getComparison() const {
    return m_comparison;
}
void OAIGaugeChartOptions::setComparison(const OAIGaugeChartOptions_Comparison &comparison) {
    m_comparison = comparison;
    m_comparison_isSet = true;
}

bool OAIGaugeChartOptions::is_comparison_Set() const{
    return m_comparison_isSet;
}

bool OAIGaugeChartOptions::is_comparison_Valid() const{
    return m_comparison_isValid;
}

OAIGaugeChartOptions_ArcAxis OAIGaugeChartOptions::getArcAxis() const {
    return m_arc_axis;
}
void OAIGaugeChartOptions::setArcAxis(const OAIGaugeChartOptions_ArcAxis &arc_axis) {
    m_arc_axis = arc_axis;
    m_arc_axis_isSet = true;
}

bool OAIGaugeChartOptions::is_arc_axis_Set() const{
    return m_arc_axis_isSet;
}

bool OAIGaugeChartOptions::is_arc_axis_Valid() const{
    return m_arc_axis_isValid;
}

OAIGaugeChartOptions_Arc OAIGaugeChartOptions::getArc() const {
    return m_arc;
}
void OAIGaugeChartOptions::setArc(const OAIGaugeChartOptions_Arc &arc) {
    m_arc = arc;
    m_arc_isSet = true;
}

bool OAIGaugeChartOptions::is_arc_Set() const{
    return m_arc_isSet;
}

bool OAIGaugeChartOptions::is_arc_Valid() const{
    return m_arc_isValid;
}

OAIGaugeChartOptions_PrimaryValueFontConfiguration OAIGaugeChartOptions::getPrimaryValueFontConfiguration() const {
    return m_primary_value_font_configuration;
}
void OAIGaugeChartOptions::setPrimaryValueFontConfiguration(const OAIGaugeChartOptions_PrimaryValueFontConfiguration &primary_value_font_configuration) {
    m_primary_value_font_configuration = primary_value_font_configuration;
    m_primary_value_font_configuration_isSet = true;
}

bool OAIGaugeChartOptions::is_primary_value_font_configuration_Set() const{
    return m_primary_value_font_configuration_isSet;
}

bool OAIGaugeChartOptions::is_primary_value_font_configuration_Valid() const{
    return m_primary_value_font_configuration_isValid;
}

bool OAIGaugeChartOptions::isSet() const {
...
bool OAIGaugeChartOptions::isValid() const {
