...
/*
 * OAIIncrementalRefresh_LookbackWindow.h
 *
 * 
 */

#ifndef OAIIncrementalRefresh_LookbackWindow_H
#define OAIIncrementalRefresh_LookbackWindow_H
...
class OAIIncrementalRefresh_LookbackWindow : public OAIObject {
public:
    OAIIncrementalRefresh_LookbackWindow();
    OAIIncrementalRefresh_LookbackWindow(QString json);
    ~OAIIncrementalRefresh_LookbackWindow() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIncrementalRefresh_LookbackWindow)

#endif // OAIIncrementalRefresh_LookbackWindow_H
