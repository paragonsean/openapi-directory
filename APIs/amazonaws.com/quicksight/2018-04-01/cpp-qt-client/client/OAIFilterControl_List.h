...
/*
 * OAIFilterControl_List.h
 *
 * 
 */

#ifndef OAIFilterControl_List_H
#define OAIFilterControl_List_H
...
class OAIFilterControl_List : public OAIObject {
public:
    OAIFilterControl_List();
    OAIFilterControl_List(QString json);
    ~OAIFilterControl_List() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterControl_List)

#endif // OAIFilterControl_List_H
