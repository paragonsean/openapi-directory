...
#include "OAIPivotTableOptions.h"
...
OAIPivotTableOptions::OAIPivotTableOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPivotTableOptions::OAIPivotTableOptions() {
    this->initializeModel();
}

OAIPivotTableOptions::~OAIPivotTableOptions() {}

void OAIPivotTableOptions::initializeModel() {
...
void OAIPivotTableOptions::fromJson(QString jsonString) {
...
void OAIPivotTableOptions::fromJsonObject(QJsonObject json) {
...
QString OAIPivotTableOptions::asJson() const {
...
QJsonObject OAIPivotTableOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIPivotTableMetricPlacement OAIPivotTableOptions::getMetricPlacement() const {
    return m_metric_placement;
}
void OAIPivotTableOptions::setMetricPlacement(const OAIPivotTableMetricPlacement &metric_placement) {
    m_metric_placement = metric_placement;
    m_metric_placement_isSet = true;
}

bool OAIPivotTableOptions::is_metric_placement_Set() const{
    return m_metric_placement_isSet;
}

bool OAIPivotTableOptions::is_metric_placement_Valid() const{
    return m_metric_placement_isValid;
}

OAIVisibility OAIPivotTableOptions::getSingleMetricVisibility() const {
    return m_single_metric_visibility;
}
void OAIPivotTableOptions::setSingleMetricVisibility(const OAIVisibility &single_metric_visibility) {
    m_single_metric_visibility = single_metric_visibility;
    m_single_metric_visibility_isSet = true;
}

bool OAIPivotTableOptions::is_single_metric_visibility_Set() const{
    return m_single_metric_visibility_isSet;
}

bool OAIPivotTableOptions::is_single_metric_visibility_Valid() const{
    return m_single_metric_visibility_isValid;
}

OAIVisibility OAIPivotTableOptions::getColumnNamesVisibility() const {
    return m_column_names_visibility;
}
void OAIPivotTableOptions::setColumnNamesVisibility(const OAIVisibility &column_names_visibility) {
    m_column_names_visibility = column_names_visibility;
    m_column_names_visibility_isSet = true;
}

bool OAIPivotTableOptions::is_column_names_visibility_Set() const{
    return m_column_names_visibility_isSet;
}

bool OAIPivotTableOptions::is_column_names_visibility_Valid() const{
    return m_column_names_visibility_isValid;
}

OAIVisibility OAIPivotTableOptions::getToggleButtonsVisibility() const {
    return m_toggle_buttons_visibility;
}
void OAIPivotTableOptions::setToggleButtonsVisibility(const OAIVisibility &toggle_buttons_visibility) {
    m_toggle_buttons_visibility = toggle_buttons_visibility;
    m_toggle_buttons_visibility_isSet = true;
}

bool OAIPivotTableOptions::is_toggle_buttons_visibility_Set() const{
    return m_toggle_buttons_visibility_isSet;
}

bool OAIPivotTableOptions::is_toggle_buttons_visibility_Valid() const{
    return m_toggle_buttons_visibility_isValid;
}

OAIPivotTableOptions_ColumnHeaderStyle OAIPivotTableOptions::getColumnHeaderStyle() const {
    return m_column_header_style;
}
void OAIPivotTableOptions::setColumnHeaderStyle(const OAIPivotTableOptions_ColumnHeaderStyle &column_header_style) {
    m_column_header_style = column_header_style;
    m_column_header_style_isSet = true;
}

bool OAIPivotTableOptions::is_column_header_style_Set() const{
    return m_column_header_style_isSet;
}

bool OAIPivotTableOptions::is_column_header_style_Valid() const{
    return m_column_header_style_isValid;
}

OAIPivotTableOptions_RowHeaderStyle OAIPivotTableOptions::getRowHeaderStyle() const {
    return m_row_header_style;
}
void OAIPivotTableOptions::setRowHeaderStyle(const OAIPivotTableOptions_RowHeaderStyle &row_header_style) {
    m_row_header_style = row_header_style;
    m_row_header_style_isSet = true;
}

bool OAIPivotTableOptions::is_row_header_style_Set() const{
    return m_row_header_style_isSet;
}

bool OAIPivotTableOptions::is_row_header_style_Valid() const{
    return m_row_header_style_isValid;
}

OAIPivotTableOptions_CellStyle OAIPivotTableOptions::getCellStyle() const {
    return m_cell_style;
}
void OAIPivotTableOptions::setCellStyle(const OAIPivotTableOptions_CellStyle &cell_style) {
    m_cell_style = cell_style;
    m_cell_style_isSet = true;
}

bool OAIPivotTableOptions::is_cell_style_Set() const{
    return m_cell_style_isSet;
}

bool OAIPivotTableOptions::is_cell_style_Valid() const{
    return m_cell_style_isValid;
}

OAIPivotTableOptions_RowFieldNamesStyle OAIPivotTableOptions::getRowFieldNamesStyle() const {
    return m_row_field_names_style;
}
void OAIPivotTableOptions::setRowFieldNamesStyle(const OAIPivotTableOptions_RowFieldNamesStyle &row_field_names_style) {
    m_row_field_names_style = row_field_names_style;
    m_row_field_names_style_isSet = true;
}

bool OAIPivotTableOptions::is_row_field_names_style_Set() const{
    return m_row_field_names_style_isSet;
}

bool OAIPivotTableOptions::is_row_field_names_style_Valid() const{
    return m_row_field_names_style_isValid;
}

OAIPivotTableOptions_RowAlternateColorOptions OAIPivotTableOptions::getRowAlternateColorOptions() const {
    return m_row_alternate_color_options;
}
void OAIPivotTableOptions::setRowAlternateColorOptions(const OAIPivotTableOptions_RowAlternateColorOptions &row_alternate_color_options) {
    m_row_alternate_color_options = row_alternate_color_options;
    m_row_alternate_color_options_isSet = true;
}

bool OAIPivotTableOptions::is_row_alternate_color_options_Set() const{
    return m_row_alternate_color_options_isSet;
}

bool OAIPivotTableOptions::is_row_alternate_color_options_Valid() const{
    return m_row_alternate_color_options_isValid;
}

OAIVisibility OAIPivotTableOptions::getCollapsedRowDimensionsVisibility() const {
    return m_collapsed_row_dimensions_visibility;
}
void OAIPivotTableOptions::setCollapsedRowDimensionsVisibility(const OAIVisibility &collapsed_row_dimensions_visibility) {
...
bool OAIPivotTableOptions::is_collapsed_row_dimensions_visibility_Set() const{
    return m_collapsed_row_dimensions_visibility_isSet;
}

bool OAIPivotTableOptions::is_collapsed_row_dimensions_visibility_Valid() const{
    return m_collapsed_row_dimensions_visibility_isValid;
}

bool OAIPivotTableOptions::isSet() const {
...
bool OAIPivotTableOptions::isValid() const {
