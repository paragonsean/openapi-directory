...
/*
 * OAIFilter_TopBottomFilter.h
 *
 * 
 */

#ifndef OAIFilter_TopBottomFilter_H
#define OAIFilter_TopBottomFilter_H
...
class OAIFilter_TopBottomFilter : public OAIObject {
public:
    OAIFilter_TopBottomFilter();
    OAIFilter_TopBottomFilter(QString json);
    ~OAIFilter_TopBottomFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilter_TopBottomFilter)

#endif // OAIFilter_TopBottomFilter_H
