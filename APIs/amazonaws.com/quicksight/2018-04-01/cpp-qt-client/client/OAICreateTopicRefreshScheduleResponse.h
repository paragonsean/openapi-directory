...
/*
 * OAICreateTopicRefreshScheduleResponse.h
 *
 * 
 */

#ifndef OAICreateTopicRefreshScheduleResponse_H
#define OAICreateTopicRefreshScheduleResponse_H
...
class OAICreateTopicRefreshScheduleResponse : public OAIObject {
public:
    OAICreateTopicRefreshScheduleResponse();
    OAICreateTopicRefreshScheduleResponse(QString json);
    ~OAICreateTopicRefreshScheduleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTopicRefreshScheduleResponse)

#endif // OAICreateTopicRefreshScheduleResponse_H
