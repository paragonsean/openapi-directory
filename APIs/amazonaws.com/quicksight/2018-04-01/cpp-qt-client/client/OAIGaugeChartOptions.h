...
/*
 * OAIGaugeChartOptions.h
 *
 * The options that determine the presentation of the &lt;code&gt;GaugeChartVisual&lt;/code&gt;.
 */

#ifndef OAIGaugeChartOptions_H
#define OAIGaugeChartOptions_H
...
class OAIGaugeChartOptions : public OAIObject {
public:
    OAIGaugeChartOptions();
    OAIGaugeChartOptions(QString json);
    ~OAIGaugeChartOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartOptions)

#endif // OAIGaugeChartOptions_H
