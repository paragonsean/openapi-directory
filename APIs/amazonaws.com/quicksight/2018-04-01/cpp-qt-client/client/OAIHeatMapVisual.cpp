...
OAIHeatMapVisual::OAIHeatMapVisual(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHeatMapVisual::OAIHeatMapVisual() {
    this->initializeModel();
}

OAIHeatMapVisual::~OAIHeatMapVisual() {}

void OAIHeatMapVisual::initializeModel() {
...
void OAIHeatMapVisual::fromJson(QString jsonString) {
...
void OAIHeatMapVisual::fromJsonObject(QJsonObject json) {
...
QString OAIHeatMapVisual::asJson() const {
...
QJsonObject OAIHeatMapVisual::asJsonObject() const {
    QJsonObject obj;
...
QString OAIHeatMapVisual::getVisualId() const {
    return m_visual_id;
}
void OAIHeatMapVisual::setVisualId(const QString &visual_id) {
    m_visual_id = visual_id;
    m_visual_id_isSet = true;
}

bool OAIHeatMapVisual::is_visual_id_Set() const{
    return m_visual_id_isSet;
}

bool OAIHeatMapVisual::is_visual_id_Valid() const{
    return m_visual_id_isValid;
}

OAIBarChartVisual_Title OAIHeatMapVisual::getTitle() const {
    return m_title;
}
void OAIHeatMapVisual::setTitle(const OAIBarChartVisual_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIHeatMapVisual::is_title_Set() const{
    return m_title_isSet;
}

bool OAIHeatMapVisual::is_title_Valid() const{
    return m_title_isValid;
}

OAIBarChartVisual_Subtitle OAIHeatMapVisual::getSubtitle() const {
    return m_subtitle;
}
void OAIHeatMapVisual::setSubtitle(const OAIBarChartVisual_Subtitle &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAIHeatMapVisual::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAIHeatMapVisual::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

OAIHeatMapVisual_ChartConfiguration OAIHeatMapVisual::getChartConfiguration() const {
    return m_chart_configuration;
}
void OAIHeatMapVisual::setChartConfiguration(const OAIHeatMapVisual_ChartConfiguration &chart_configuration) {
    m_chart_configuration = chart_configuration;
    m_chart_configuration_isSet = true;
}

bool OAIHeatMapVisual::is_chart_configuration_Set() const{
    return m_chart_configuration_isSet;
}

bool OAIHeatMapVisual::is_chart_configuration_Valid() const{
    return m_chart_configuration_isValid;
}

QList OAIHeatMapVisual::getColumnHierarchies() const {
    return m_column_hierarchies;
}
void OAIHeatMapVisual::setColumnHierarchies(const QList &column_hierarchies) {
    m_column_hierarchies = column_hierarchies;
    m_column_hierarchies_isSet = true;
}

bool OAIHeatMapVisual::is_column_hierarchies_Set() const{
    return m_column_hierarchies_isSet;
}

bool OAIHeatMapVisual::is_column_hierarchies_Valid() const{
    return m_column_hierarchies_isValid;
}

QList OAIHeatMapVisual::getActions() const {
    return m_actions;
}
void OAIHeatMapVisual::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIHeatMapVisual::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIHeatMapVisual::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIHeatMapVisual::isSet() const {
...
bool OAIHeatMapVisual::isValid() const {
