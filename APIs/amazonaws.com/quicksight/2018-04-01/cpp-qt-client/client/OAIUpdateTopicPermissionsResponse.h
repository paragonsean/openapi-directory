...
/*
 * OAIUpdateTopicPermissionsResponse.h
 *
 * 
 */

#ifndef OAIUpdateTopicPermissionsResponse_H
#define OAIUpdateTopicPermissionsResponse_H
...
class OAIUpdateTopicPermissionsResponse : public OAIObject {
public:
    OAIUpdateTopicPermissionsResponse();
    OAIUpdateTopicPermissionsResponse(QString json);
    ~OAIUpdateTopicPermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTopicPermissionsResponse)

#endif // OAIUpdateTopicPermissionsResponse_H
