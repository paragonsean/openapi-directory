...
#include "OAIPredefinedHierarchy.h"
...
OAIPredefinedHierarchy::OAIPredefinedHierarchy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPredefinedHierarchy::OAIPredefinedHierarchy() {
    this->initializeModel();
}

OAIPredefinedHierarchy::~OAIPredefinedHierarchy() {}

void OAIPredefinedHierarchy::initializeModel() {
...
void OAIPredefinedHierarchy::fromJson(QString jsonString) {
...
void OAIPredefinedHierarchy::fromJsonObject(QJsonObject json) {
...
QString OAIPredefinedHierarchy::asJson() const {
...
QJsonObject OAIPredefinedHierarchy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPredefinedHierarchy::getHierarchyId() const {
    return m_hierarchy_id;
}
void OAIPredefinedHierarchy::setHierarchyId(const QString &hierarchy_id) {
    m_hierarchy_id = hierarchy_id;
    m_hierarchy_id_isSet = true;
}

bool OAIPredefinedHierarchy::is_hierarchy_id_Set() const{
    return m_hierarchy_id_isSet;
}

bool OAIPredefinedHierarchy::is_hierarchy_id_Valid() const{
    return m_hierarchy_id_isValid;
}

QList OAIPredefinedHierarchy::getColumns() const {
    return m_columns;
}
void OAIPredefinedHierarchy::setColumns(const QList &columns) {
    m_columns = columns;
    m_columns_isSet = true;
}

bool OAIPredefinedHierarchy::is_columns_Set() const{
    return m_columns_isSet;
}

bool OAIPredefinedHierarchy::is_columns_Valid() const{
    return m_columns_isValid;
}

QList OAIPredefinedHierarchy::getDrillDownFilters() const {
    return m_drill_down_filters;
}
void OAIPredefinedHierarchy::setDrillDownFilters(const QList &drill_down_filters) {
    m_drill_down_filters = drill_down_filters;
    m_drill_down_filters_isSet = true;
}

bool OAIPredefinedHierarchy::is_drill_down_filters_Set() const{
    return m_drill_down_filters_isSet;
}

bool OAIPredefinedHierarchy::is_drill_down_filters_Valid() const{
    return m_drill_down_filters_isValid;
}

bool OAIPredefinedHierarchy::isSet() const {
...
bool OAIPredefinedHierarchy::isValid() const {
