...
/*
 * OAITableOptions_HeaderStyle.h
 *
 * 
 */

#ifndef OAITableOptions_HeaderStyle_H
#define OAITableOptions_HeaderStyle_H
...
class OAITableOptions_HeaderStyle : public OAIObject {
public:
    OAITableOptions_HeaderStyle();
    OAITableOptions_HeaderStyle(QString json);
    ~OAITableOptions_HeaderStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableOptions_HeaderStyle)

#endif // OAITableOptions_HeaderStyle_H
