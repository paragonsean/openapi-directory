...
#include "OAIRadarChartSortConfiguration.h"
...
OAIRadarChartSortConfiguration::OAIRadarChartSortConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRadarChartSortConfiguration::OAIRadarChartSortConfiguration() {
    this->initializeModel();
}

OAIRadarChartSortConfiguration::~OAIRadarChartSortConfiguration() {}

void OAIRadarChartSortConfiguration::initializeModel() {
...
void OAIRadarChartSortConfiguration::fromJson(QString jsonString) {
...
void OAIRadarChartSortConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRadarChartSortConfiguration::asJson() const {
...
QJsonObject OAIRadarChartSortConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRadarChartSortConfiguration::getCategorySort() const {
    return m_category_sort;
}
void OAIRadarChartSortConfiguration::setCategorySort(const QList &category_sort) {
    m_category_sort = category_sort;
    m_category_sort_isSet = true;
}

bool OAIRadarChartSortConfiguration::is_category_sort_Set() const{
    return m_category_sort_isSet;
}

bool OAIRadarChartSortConfiguration::is_category_sort_Valid() const{
    return m_category_sort_isValid;
}

OAIRadarChartSortConfiguration_CategoryItemsLimit OAIRadarChartSortConfiguration::getCategoryItemsLimit() const {
    return m_category_items_limit;
}
void OAIRadarChartSortConfiguration::setCategoryItemsLimit(const OAIRadarChartSortConfiguration_CategoryItemsLimit &category_items_limit) {
    m_category_items_limit = category_items_limit;
    m_category_items_limit_isSet = true;
}

bool OAIRadarChartSortConfiguration::is_category_items_limit_Set() const{
    return m_category_items_limit_isSet;
}

bool OAIRadarChartSortConfiguration::is_category_items_limit_Valid() const{
    return m_category_items_limit_isValid;
}

QList OAIRadarChartSortConfiguration::getColorSort() const {
    return m_color_sort;
}
void OAIRadarChartSortConfiguration::setColorSort(const QList &color_sort) {
    m_color_sort = color_sort;
    m_color_sort_isSet = true;
}

bool OAIRadarChartSortConfiguration::is_color_sort_Set() const{
    return m_color_sort_isSet;
}

bool OAIRadarChartSortConfiguration::is_color_sort_Valid() const{
    return m_color_sort_isValid;
}

OAIRadarChartSortConfiguration_ColorItemsLimit OAIRadarChartSortConfiguration::getColorItemsLimit() const {
    return m_color_items_limit;
}
void OAIRadarChartSortConfiguration::setColorItemsLimit(const OAIRadarChartSortConfiguration_ColorItemsLimit &color_items_limit) {
    m_color_items_limit = color_items_limit;
    m_color_items_limit_isSet = true;
}

bool OAIRadarChartSortConfiguration::is_color_items_limit_Set() const{
    return m_color_items_limit_isSet;
}

bool OAIRadarChartSortConfiguration::is_color_items_limit_Valid() const{
    return m_color_items_limit_isValid;
}

bool OAIRadarChartSortConfiguration::isSet() const {
...
bool OAIRadarChartSortConfiguration::isValid() const {
