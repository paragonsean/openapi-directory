...
OAIBarChartConfiguration_CategoryAxis::OAIBarChartConfiguration_CategoryAxis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBarChartConfiguration_CategoryAxis::OAIBarChartConfiguration_CategoryAxis() {
    this->initializeModel();
}

OAIBarChartConfiguration_CategoryAxis::~OAIBarChartConfiguration_CategoryAxis() {}

void OAIBarChartConfiguration_CategoryAxis::initializeModel() {
...
void OAIBarChartConfiguration_CategoryAxis::fromJson(QString jsonString) {
...
void OAIBarChartConfiguration_CategoryAxis::fromJsonObject(QJsonObject json) {
...
QString OAIBarChartConfiguration_CategoryAxis::asJson() const {
...
QJsonObject OAIBarChartConfiguration_CategoryAxis::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIBarChartConfiguration_CategoryAxis::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIBarChartConfiguration_CategoryAxis::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIBarChartConfiguration_CategoryAxis::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIBarChartConfiguration_CategoryAxis::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIBarChartConfiguration_CategoryAxis::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIBarChartConfiguration_CategoryAxis::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIBarChartConfiguration_CategoryAxis::getDataOptions() const {
    return m_data_options;
}
void OAIBarChartConfiguration_CategoryAxis::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIBarChartConfiguration_CategoryAxis::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIBarChartConfiguration_CategoryAxis::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIBarChartConfiguration_CategoryAxis::getAxisOffset() const {
    return m_axis_offset;
}
void OAIBarChartConfiguration_CategoryAxis::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIBarChartConfiguration_CategoryAxis::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIBarChartConfiguration_CategoryAxis::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIBarChartConfiguration_CategoryAxis::isSet() const {
...
bool OAIBarChartConfiguration_CategoryAxis::isValid() const {
