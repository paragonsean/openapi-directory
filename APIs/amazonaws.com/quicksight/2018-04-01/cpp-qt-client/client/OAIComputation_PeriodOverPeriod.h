...
/*
 * OAIComputation_PeriodOverPeriod.h
 *
 * 
 */

#ifndef OAIComputation_PeriodOverPeriod_H
#define OAIComputation_PeriodOverPeriod_H
...
class OAIComputation_PeriodOverPeriod : public OAIObject {
public:
    OAIComputation_PeriodOverPeriod();
    OAIComputation_PeriodOverPeriod(QString json);
    ~OAIComputation_PeriodOverPeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_PeriodOverPeriod)

#endif // OAIComputation_PeriodOverPeriod_H
