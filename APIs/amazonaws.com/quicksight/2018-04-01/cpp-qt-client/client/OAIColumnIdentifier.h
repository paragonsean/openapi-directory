...
/*
 * OAIColumnIdentifier.h
 *
 * A column of a data set.
 */

#ifndef OAIColumnIdentifier_H
#define OAIColumnIdentifier_H
...
class OAIColumnIdentifier : public OAIObject {
public:
    OAIColumnIdentifier();
    OAIColumnIdentifier(QString json);
    ~OAIColumnIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnIdentifier)

#endif // OAIColumnIdentifier_H
