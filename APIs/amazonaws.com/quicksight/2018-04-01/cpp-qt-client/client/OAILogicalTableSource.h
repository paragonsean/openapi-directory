...
/*
 * OAILogicalTableSource.h
 *
 * Information about the source of a logical table. This is a variant type structure. For this structure to be valid, only one of the attributes can be non-null.
 */

#ifndef OAILogicalTableSource_H
#define OAILogicalTableSource_H
...
class OAILogicalTableSource : public OAIObject {
public:
    OAILogicalTableSource();
    OAILogicalTableSource(QString json);
    ~OAILogicalTableSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogicalTableSource)

#endif // OAILogicalTableSource_H
