...
/*
 * OAIGaugeChartConfiguration_TooltipOptions.h
 *
 * 
 */

#ifndef OAIGaugeChartConfiguration_TooltipOptions_H
#define OAIGaugeChartConfiguration_TooltipOptions_H
...
class OAIGaugeChartConfiguration_TooltipOptions : public OAIObject {
public:
    OAIGaugeChartConfiguration_TooltipOptions();
    OAIGaugeChartConfiguration_TooltipOptions(QString json);
    ~OAIGaugeChartConfiguration_TooltipOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartConfiguration_TooltipOptions)

#endif // OAIGaugeChartConfiguration_TooltipOptions_H
