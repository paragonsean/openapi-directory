...
/*
 * OAINumericalDimensionField_Column.h
 *
 * 
 */

#ifndef OAINumericalDimensionField_Column_H
#define OAINumericalDimensionField_Column_H
...
class OAINumericalDimensionField_Column : public OAIObject {
public:
    OAINumericalDimensionField_Column();
    OAINumericalDimensionField_Column(QString json);
    ~OAINumericalDimensionField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumericalDimensionField_Column)

#endif // OAINumericalDimensionField_Column_H
