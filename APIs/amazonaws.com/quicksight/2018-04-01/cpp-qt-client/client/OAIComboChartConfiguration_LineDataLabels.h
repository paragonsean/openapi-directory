...
/*
 * OAIComboChartConfiguration_LineDataLabels.h
 *
 * 
 */

#ifndef OAIComboChartConfiguration_LineDataLabels_H
#define OAIComboChartConfiguration_LineDataLabels_H
...
class OAIComboChartConfiguration_LineDataLabels : public OAIObject {
public:
    OAIComboChartConfiguration_LineDataLabels();
    OAIComboChartConfiguration_LineDataLabels(QString json);
    ~OAIComboChartConfiguration_LineDataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComboChartConfiguration_LineDataLabels)

#endif // OAIComboChartConfiguration_LineDataLabels_H
