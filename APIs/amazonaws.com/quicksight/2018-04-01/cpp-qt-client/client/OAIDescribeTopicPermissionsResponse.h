...
/*
 * OAIDescribeTopicPermissionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeTopicPermissionsResponse_H
#define OAIDescribeTopicPermissionsResponse_H
...
class OAIDescribeTopicPermissionsResponse : public OAIObject {
public:
    OAIDescribeTopicPermissionsResponse();
    OAIDescribeTopicPermissionsResponse(QString json);
    ~OAIDescribeTopicPermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTopicPermissionsResponse)

#endif // OAIDescribeTopicPermissionsResponse_H
