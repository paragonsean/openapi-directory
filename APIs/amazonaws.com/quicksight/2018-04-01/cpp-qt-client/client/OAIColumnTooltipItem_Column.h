...
/*
 * OAIColumnTooltipItem_Column.h
 *
 * 
 */

#ifndef OAIColumnTooltipItem_Column_H
#define OAIColumnTooltipItem_Column_H
...
class OAIColumnTooltipItem_Column : public OAIObject {
public:
    OAIColumnTooltipItem_Column();
    OAIColumnTooltipItem_Column(QString json);
    ~OAIColumnTooltipItem_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnTooltipItem_Column)

#endif // OAIColumnTooltipItem_Column_H
