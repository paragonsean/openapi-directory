...
/*
 * OAIAnalysisSummary.h
 *
 * The summary metadata that describes an analysis.
 */

#ifndef OAIAnalysisSummary_H
#define OAIAnalysisSummary_H
...
class OAIAnalysisSummary : public OAIObject {
public:
    OAIAnalysisSummary();
    OAIAnalysisSummary(QString json);
    ~OAIAnalysisSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalysisSummary)

#endif // OAIAnalysisSummary_H
