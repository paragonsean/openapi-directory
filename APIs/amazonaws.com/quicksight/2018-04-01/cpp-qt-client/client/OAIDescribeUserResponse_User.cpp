...
QString OAIDescribeUserResponse_User::getEmail() const {
    return m_email;
}
void OAIDescribeUserResponse_User::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIDescribeUserResponse_User::is_email_Set() const{
    return m_email_isSet;
}

bool OAIDescribeUserResponse_User::is_email_Valid() const{
    return m_email_isValid;
}

OAIUserRole OAIDescribeUserResponse_User::getRole() const {
    return m_role;
}
void OAIDescribeUserResponse_User::setRole(const OAIUserRole &role) {
    m_role = role;
    m_role_isSet = true;
}
...
OAIIdentityType OAIDescribeUserResponse_User::getIdentityType() const {
    return m_identity_type;
}
void OAIDescribeUserResponse_User::setIdentityType(const OAIIdentityType &identity_type) {
    m_identity_type = identity_type;
    m_identity_type_isSet = true;
}

bool OAIDescribeUserResponse_User::is_identity_type_Set() const{
    return m_identity_type_isSet;
}

bool OAIDescribeUserResponse_User::is_identity_type_Valid() const{
    return m_identity_type_isValid;
}

bool OAIDescribeUserResponse_User::getActive() const {
    return m_active;
}
void OAIDescribeUserResponse_User::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIDescribeUserResponse_User::is_active_Set() const{
    return m_active_isSet;
}

bool OAIDescribeUserResponse_User::is_active_Valid() const{
    return m_active_isValid;
}

QString OAIDescribeUserResponse_User::getPrincipalId() const {
    return m_principal_id;
}
void OAIDescribeUserResponse_User::setPrincipalId(const QString &principal_id) {
    m_principal_id = principal_id;
    m_principal_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_principal_id_Set() const{
    return m_principal_id_isSet;
}

bool OAIDescribeUserResponse_User::is_principal_id_Valid() const{
    return m_principal_id_isValid;
}

QString OAIDescribeUserResponse_User::getCustomPermissionsName() const {
    return m_custom_permissions_name;
}
void OAIDescribeUserResponse_User::setCustomPermissionsName(const QString &custom_permissions_name) {
    m_custom_permissions_name = custom_permissions_name;
    m_custom_permissions_name_isSet = true;
}

bool OAIDescribeUserResponse_User::is_custom_permissions_name_Set() const{
    return m_custom_permissions_name_isSet;
}

bool OAIDescribeUserResponse_User::is_custom_permissions_name_Valid() const{
    return m_custom_permissions_name_isValid;
}

QString OAIDescribeUserResponse_User::getExternalLoginFederationProviderType() const {
    return m_external_login_federation_provider_type;
}
void OAIDescribeUserResponse_User::setExternalLoginFederationProviderType(const QString &external_login_federation_provider_type) {
...
bool OAIDescribeUserResponse_User::is_external_login_federation_provider_type_Set() const{
    return m_external_login_federation_provider_type_isSet;
}

bool OAIDescribeUserResponse_User::is_external_login_federation_provider_type_Valid() const{
    return m_external_login_federation_provider_type_isValid;
}

QString OAIDescribeUserResponse_User::getExternalLoginFederationProviderUrl() const {
    return m_external_login_federation_provider_url;
}
void OAIDescribeUserResponse_User::setExternalLoginFederationProviderUrl(const QString &external_login_federation_provider_url) {
...
bool OAIDescribeUserResponse_User::is_external_login_federation_provider_url_Set() const{
    return m_external_login_federation_provider_url_isSet;
}

bool OAIDescribeUserResponse_User::is_external_login_federation_provider_url_Valid() const{
    return m_external_login_federation_provider_url_isValid;
}

QString OAIDescribeUserResponse_User::getExternalLoginId() const {
    return m_external_login_id;
}
void OAIDescribeUserResponse_User::setExternalLoginId(const QString &external_login_id) {
    m_external_login_id = external_login_id;
    m_external_login_id_isSet = true;
}

bool OAIDescribeUserResponse_User::is_external_login_id_Set() const{
    return m_external_login_id_isSet;
}

bool OAIDescribeUserResponse_User::is_external_login_id_Valid() const{
