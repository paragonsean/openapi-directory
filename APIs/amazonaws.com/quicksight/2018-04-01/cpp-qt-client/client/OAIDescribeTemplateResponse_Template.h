...
/*
 * OAIDescribeTemplateResponse_Template.h
 *
 * 
 */

#ifndef OAIDescribeTemplateResponse_Template_H
#define OAIDescribeTemplateResponse_Template_H
...
class OAIDescribeTemplateResponse_Template : public OAIObject {
public:
    OAIDescribeTemplateResponse_Template();
    OAIDescribeTemplateResponse_Template(QString json);
    ~OAIDescribeTemplateResponse_Template() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTemplateResponse_Template)

#endif // OAIDescribeTemplateResponse_Template_H
