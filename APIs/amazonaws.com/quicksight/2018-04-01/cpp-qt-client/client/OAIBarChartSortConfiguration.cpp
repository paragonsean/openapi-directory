...
#include "OAIBarChartSortConfiguration.h"
...
OAIBarChartSortConfiguration::OAIBarChartSortConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBarChartSortConfiguration::OAIBarChartSortConfiguration() {
    this->initializeModel();
}

OAIBarChartSortConfiguration::~OAIBarChartSortConfiguration() {}

void OAIBarChartSortConfiguration::initializeModel() {
...
void OAIBarChartSortConfiguration::fromJson(QString jsonString) {
...
void OAIBarChartSortConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIBarChartSortConfiguration::asJson() const {
...
QJsonObject OAIBarChartSortConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBarChartSortConfiguration::getCategorySort() const {
    return m_category_sort;
}
void OAIBarChartSortConfiguration::setCategorySort(const QList &category_sort) {
    m_category_sort = category_sort;
    m_category_sort_isSet = true;
}

bool OAIBarChartSortConfiguration::is_category_sort_Set() const{
    return m_category_sort_isSet;
}

bool OAIBarChartSortConfiguration::is_category_sort_Valid() const{
    return m_category_sort_isValid;
}

OAIBarChartSortConfiguration_CategoryItemsLimit OAIBarChartSortConfiguration::getCategoryItemsLimit() const {
    return m_category_items_limit;
}
void OAIBarChartSortConfiguration::setCategoryItemsLimit(const OAIBarChartSortConfiguration_CategoryItemsLimit &category_items_limit) {
    m_category_items_limit = category_items_limit;
    m_category_items_limit_isSet = true;
}

bool OAIBarChartSortConfiguration::is_category_items_limit_Set() const{
    return m_category_items_limit_isSet;
}

bool OAIBarChartSortConfiguration::is_category_items_limit_Valid() const{
    return m_category_items_limit_isValid;
}

QList OAIBarChartSortConfiguration::getColorSort() const {
    return m_color_sort;
}
void OAIBarChartSortConfiguration::setColorSort(const QList &color_sort) {
    m_color_sort = color_sort;
    m_color_sort_isSet = true;
}

bool OAIBarChartSortConfiguration::is_color_sort_Set() const{
    return m_color_sort_isSet;
}

bool OAIBarChartSortConfiguration::is_color_sort_Valid() const{
    return m_color_sort_isValid;
}

OAIBarChartSortConfiguration_ColorItemsLimit OAIBarChartSortConfiguration::getColorItemsLimit() const {
    return m_color_items_limit;
}
void OAIBarChartSortConfiguration::setColorItemsLimit(const OAIBarChartSortConfiguration_ColorItemsLimit &color_items_limit) {
    m_color_items_limit = color_items_limit;
    m_color_items_limit_isSet = true;
}

bool OAIBarChartSortConfiguration::is_color_items_limit_Set() const{
    return m_color_items_limit_isSet;
}

bool OAIBarChartSortConfiguration::is_color_items_limit_Valid() const{
    return m_color_items_limit_isValid;
}

QList OAIBarChartSortConfiguration::getSmallMultiplesSort() const {
    return m_small_multiples_sort;
}
void OAIBarChartSortConfiguration::setSmallMultiplesSort(const QList &small_multiples_sort) {
    m_small_multiples_sort = small_multiples_sort;
    m_small_multiples_sort_isSet = true;
}

bool OAIBarChartSortConfiguration::is_small_multiples_sort_Set() const{
    return m_small_multiples_sort_isSet;
}

bool OAIBarChartSortConfiguration::is_small_multiples_sort_Valid() const{
    return m_small_multiples_sort_isValid;
}

OAIBarChartSortConfiguration_SmallMultiplesLimitConfiguration OAIBarChartSortConfiguration::getSmallMultiplesLimitConfiguration() const {
    return m_small_multiples_limit_configuration;
}
void OAIBarChartSortConfiguration::setSmallMultiplesLimitConfiguration(const OAIBarChartSortConfiguration_SmallMultiplesLimitConfiguration &small_multiples_limit_configuration) {
...
bool OAIBarChartSortConfiguration::is_small_multiples_limit_configuration_Set() const{
    return m_small_multiples_limit_configuration_isSet;
}

bool OAIBarChartSortConfiguration::is_small_multiples_limit_configuration_Valid() const{
    return m_small_multiples_limit_configuration_isValid;
}

bool OAIBarChartSortConfiguration::isSet() const {
...
bool OAIBarChartSortConfiguration::isValid() const {
