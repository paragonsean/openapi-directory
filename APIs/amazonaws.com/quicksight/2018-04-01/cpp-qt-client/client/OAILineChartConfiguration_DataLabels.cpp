...
OAILineChartConfiguration_DataLabels::OAILineChartConfiguration_DataLabels(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineChartConfiguration_DataLabels::OAILineChartConfiguration_DataLabels() {
    this->initializeModel();
}

OAILineChartConfiguration_DataLabels::~OAILineChartConfiguration_DataLabels() {}

void OAILineChartConfiguration_DataLabels::initializeModel() {
...
void OAILineChartConfiguration_DataLabels::fromJson(QString jsonString) {
...
void OAILineChartConfiguration_DataLabels::fromJsonObject(QJsonObject json) {
...
QString OAILineChartConfiguration_DataLabels::asJson() const {
...
QJsonObject OAILineChartConfiguration_DataLabels::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAILineChartConfiguration_DataLabels::getVisibility() const {
    return m_visibility;
}
void OAILineChartConfiguration_DataLabels::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAIVisibility OAILineChartConfiguration_DataLabels::getCategoryLabelVisibility() const {
    return m_category_label_visibility;
}
void OAILineChartConfiguration_DataLabels::setCategoryLabelVisibility(const OAIVisibility &category_label_visibility) {
    m_category_label_visibility = category_label_visibility;
    m_category_label_visibility_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_category_label_visibility_Set() const{
    return m_category_label_visibility_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_category_label_visibility_Valid() const{
    return m_category_label_visibility_isValid;
}

OAIVisibility OAILineChartConfiguration_DataLabels::getMeasureLabelVisibility() const {
    return m_measure_label_visibility;
}
void OAILineChartConfiguration_DataLabels::setMeasureLabelVisibility(const OAIVisibility &measure_label_visibility) {
    m_measure_label_visibility = measure_label_visibility;
    m_measure_label_visibility_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_measure_label_visibility_Set() const{
    return m_measure_label_visibility_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_measure_label_visibility_Valid() const{
    return m_measure_label_visibility_isValid;
}

QList OAILineChartConfiguration_DataLabels::getDataLabelTypes() const {
    return m_data_label_types;
}
void OAILineChartConfiguration_DataLabels::setDataLabelTypes(const QList &data_label_types) {
    m_data_label_types = data_label_types;
    m_data_label_types_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_data_label_types_Set() const{
    return m_data_label_types_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_data_label_types_Valid() const{
    return m_data_label_types_isValid;
}

OAIDataLabelPosition OAILineChartConfiguration_DataLabels::getPosition() const {
    return m_position;
}
void OAILineChartConfiguration_DataLabels::setPosition(const OAIDataLabelPosition &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_position_Set() const{
    return m_position_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_position_Valid() const{
    return m_position_isValid;
}

OAIDataLabelContent OAILineChartConfiguration_DataLabels::getLabelContent() const {
    return m_label_content;
}
void OAILineChartConfiguration_DataLabels::setLabelContent(const OAIDataLabelContent &label_content) {
    m_label_content = label_content;
    m_label_content_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_label_content_Set() const{
    return m_label_content_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_label_content_Valid() const{
    return m_label_content_isValid;
}

OAIDataLabelOptions_LabelFontConfiguration OAILineChartConfiguration_DataLabels::getLabelFontConfiguration() const {
    return m_label_font_configuration;
}
void OAILineChartConfiguration_DataLabels::setLabelFontConfiguration(const OAIDataLabelOptions_LabelFontConfiguration &label_font_configuration) {
    m_label_font_configuration = label_font_configuration;
    m_label_font_configuration_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_label_font_configuration_Set() const{
    return m_label_font_configuration_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_label_font_configuration_Valid() const{
    return m_label_font_configuration_isValid;
}

QString OAILineChartConfiguration_DataLabels::getLabelColor() const {
    return m_label_color;
}
void OAILineChartConfiguration_DataLabels::setLabelColor(const QString &label_color) {
    m_label_color = label_color;
    m_label_color_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_label_color_Set() const{
    return m_label_color_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_label_color_Valid() const{
    return m_label_color_isValid;
}

OAIDataLabelOverlap OAILineChartConfiguration_DataLabels::getOverlap() const {
    return m_overlap;
}
void OAILineChartConfiguration_DataLabels::setOverlap(const OAIDataLabelOverlap &overlap) {
    m_overlap = overlap;
    m_overlap_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_overlap_Set() const{
    return m_overlap_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_overlap_Valid() const{
    return m_overlap_isValid;
}

OAIVisibility OAILineChartConfiguration_DataLabels::getTotalsVisibility() const {
    return m_totals_visibility;
}
void OAILineChartConfiguration_DataLabels::setTotalsVisibility(const OAIVisibility &totals_visibility) {
    m_totals_visibility = totals_visibility;
    m_totals_visibility_isSet = true;
}

bool OAILineChartConfiguration_DataLabels::is_totals_visibility_Set() const{
    return m_totals_visibility_isSet;
}

bool OAILineChartConfiguration_DataLabels::is_totals_visibility_Valid() const{
    return m_totals_visibility_isValid;
}

bool OAILineChartConfiguration_DataLabels::isSet() const {
...
bool OAILineChartConfiguration_DataLabels::isValid() const {
