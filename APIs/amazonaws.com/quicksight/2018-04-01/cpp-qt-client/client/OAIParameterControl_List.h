...
/*
 * OAIParameterControl_List.h
 *
 * 
 */

#ifndef OAIParameterControl_List_H
#define OAIParameterControl_List_H
...
class OAIParameterControl_List : public OAIObject {
public:
    OAIParameterControl_List();
    OAIParameterControl_List(QString json);
    ~OAIParameterControl_List() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterControl_List)

#endif // OAIParameterControl_List_H
