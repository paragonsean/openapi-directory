...
/*
 * OAIFilterTextFieldControl.h
 *
 * A control to display a text box that is used to enter a single entry.
 */

#ifndef OAIFilterTextFieldControl_H
#define OAIFilterTextFieldControl_H
...
class OAIFilterTextFieldControl : public OAIObject {
public:
    OAIFilterTextFieldControl();
    OAIFilterTextFieldControl(QString json);
    ~OAIFilterTextFieldControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterTextFieldControl)

#endif // OAIFilterTextFieldControl_H
