...
QString OAILookbackWindow::getColumnName() const {
    return m_column_name;
}
void OAILookbackWindow::setColumnName(const QString &column_name) {
    m_column_name = column_name;
    m_column_name_isSet = true;
}

bool OAILookbackWindow::is_column_name_Set() const{
    return m_column_name_isSet;
}

bool OAILookbackWindow::is_column_name_Valid() const{
    return m_column_name_isValid;
}

qint32 OAILookbackWindow::getSize() const {
    return m_size;
}
void OAILookbackWindow::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAILookbackWindow::is_size_Set() const{
    return m_size_isSet;
}

bool OAILookbackWindow::is_size_Valid() const{
    return m_size_isValid;
}

OAILookbackWindowSizeUnit OAILookbackWindow::getSizeUnit() const {
    return m_size_unit;
}
void OAILookbackWindow::setSizeUnit(const OAILookbackWindowSizeUnit &size_unit) {
    m_size_unit = size_unit;
    m_size_unit_isSet = true;
}

bool OAILookbackWindow::is_size_unit_Set() const{
    return m_size_unit_isSet;
}

bool OAILookbackWindow::is_size_unit_Valid() const{
