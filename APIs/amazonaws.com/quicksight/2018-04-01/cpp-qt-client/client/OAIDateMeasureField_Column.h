...
/*
 * OAIDateMeasureField_Column.h
 *
 * 
 */

#ifndef OAIDateMeasureField_Column_H
#define OAIDateMeasureField_Column_H
...
class OAIDateMeasureField_Column : public OAIObject {
public:
    OAIDateMeasureField_Column();
    OAIDateMeasureField_Column(QString json);
    ~OAIDateMeasureField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateMeasureField_Column)

#endif // OAIDateMeasureField_Column_H
