...
/*
 * OAILayoutConfiguration_SectionBasedLayout.h
 *
 * 
 */

#ifndef OAILayoutConfiguration_SectionBasedLayout_H
#define OAILayoutConfiguration_SectionBasedLayout_H
...
class OAILayoutConfiguration_SectionBasedLayout : public OAIObject {
public:
    OAILayoutConfiguration_SectionBasedLayout();
    OAILayoutConfiguration_SectionBasedLayout(QString json);
    ~OAILayoutConfiguration_SectionBasedLayout() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILayoutConfiguration_SectionBasedLayout)

#endif // OAILayoutConfiguration_SectionBasedLayout_H
