...
/*
 * OAIGaugeChartConfiguration_DataLabels.h
 *
 * 
 */

#ifndef OAIGaugeChartConfiguration_DataLabels_H
#define OAIGaugeChartConfiguration_DataLabels_H
...
class OAIGaugeChartConfiguration_DataLabels : public OAIObject {
public:
    OAIGaugeChartConfiguration_DataLabels();
    OAIGaugeChartConfiguration_DataLabels(QString json);
    ~OAIGaugeChartConfiguration_DataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartConfiguration_DataLabels)

#endif // OAIGaugeChartConfiguration_DataLabels_H
