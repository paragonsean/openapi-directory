...
/*
 * OAIUpdateTheme_request_Configuration.h
 *
 * The theme configuration. This configuration contains all of the display properties for a theme.
 */

#ifndef OAIUpdateTheme_request_Configuration_H
#define OAIUpdateTheme_request_Configuration_H
...
class OAIUpdateTheme_request_Configuration : public OAIObject {
public:
    OAIUpdateTheme_request_Configuration();
    OAIUpdateTheme_request_Configuration(QString json);
    ~OAIUpdateTheme_request_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTheme_request_Configuration)

#endif // OAIUpdateTheme_request_Configuration_H
