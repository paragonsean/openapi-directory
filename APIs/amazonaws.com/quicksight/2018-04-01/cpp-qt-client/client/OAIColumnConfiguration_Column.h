...
/*
 * OAIColumnConfiguration_Column.h
 *
 * 
 */

#ifndef OAIColumnConfiguration_Column_H
#define OAIColumnConfiguration_Column_H
...
class OAIColumnConfiguration_Column : public OAIObject {
public:
    OAIColumnConfiguration_Column();
    OAIColumnConfiguration_Column(QString json);
    ~OAIColumnConfiguration_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnConfiguration_Column)

#endif // OAIColumnConfiguration_Column_H
