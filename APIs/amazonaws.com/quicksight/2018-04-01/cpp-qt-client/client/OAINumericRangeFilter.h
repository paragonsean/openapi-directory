...
/*
 * OAINumericRangeFilter.h
 *
 * A &lt;code&gt;NumericRangeFilter&lt;/code&gt; filters values that are within the value range.
 */

#ifndef OAINumericRangeFilter_H
#define OAINumericRangeFilter_H
...
class OAINumericRangeFilter : public OAIObject {
public:
    OAINumericRangeFilter();
    OAINumericRangeFilter(QString json);
    ~OAINumericRangeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumericRangeFilter)

#endif // OAINumericRangeFilter_H
