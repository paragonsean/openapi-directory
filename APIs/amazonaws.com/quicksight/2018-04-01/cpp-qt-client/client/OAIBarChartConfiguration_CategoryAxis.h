...
/*
 * OAIBarChartConfiguration_CategoryAxis.h
 *
 * 
 */

#ifndef OAIBarChartConfiguration_CategoryAxis_H
#define OAIBarChartConfiguration_CategoryAxis_H
...
class OAIBarChartConfiguration_CategoryAxis : public OAIObject {
public:
    OAIBarChartConfiguration_CategoryAxis();
    OAIBarChartConfiguration_CategoryAxis(QString json);
    ~OAIBarChartConfiguration_CategoryAxis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBarChartConfiguration_CategoryAxis)

#endif // OAIBarChartConfiguration_CategoryAxis_H
