...
/*
 * OAICategoryDrillDownFilter_Column.h
 *
 * 
 */

#ifndef OAICategoryDrillDownFilter_Column_H
#define OAICategoryDrillDownFilter_Column_H
...
class OAICategoryDrillDownFilter_Column : public OAIObject {
public:
    OAICategoryDrillDownFilter_Column();
    OAICategoryDrillDownFilter_Column(QString json);
    ~OAICategoryDrillDownFilter_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryDrillDownFilter_Column)

#endif // OAICategoryDrillDownFilter_Column_H
