...
/*
 * OAIFieldBasedTooltip.h
 *
 * The setup for the detailed tooltip.
 */

#ifndef OAIFieldBasedTooltip_H
#define OAIFieldBasedTooltip_H
...
class OAIFieldBasedTooltip : public OAIObject {
public:
    OAIFieldBasedTooltip();
    OAIFieldBasedTooltip(QString json);
    ~OAIFieldBasedTooltip() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldBasedTooltip)

#endif // OAIFieldBasedTooltip_H
