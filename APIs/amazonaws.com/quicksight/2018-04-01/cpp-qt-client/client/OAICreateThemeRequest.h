...
/*
 * OAICreateThemeRequest.h
 *
 * 
 */

#ifndef OAICreateThemeRequest_H
#define OAICreateThemeRequest_H
...
class OAICreateThemeRequest : public OAIObject {
public:
    OAICreateThemeRequest();
    OAICreateThemeRequest(QString json);
    ~OAICreateThemeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateThemeRequest)

#endif // OAICreateThemeRequest_H
