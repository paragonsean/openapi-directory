...
/*
 * OAIFilledMapConfiguration.h
 *
 * The configuration for a &lt;code&gt;FilledMapVisual&lt;/code&gt;.
 */

#ifndef OAIFilledMapConfiguration_H
#define OAIFilledMapConfiguration_H
...
class OAIFilledMapConfiguration : public OAIObject {
public:
    OAIFilledMapConfiguration();
    OAIFilledMapConfiguration(QString json);
    ~OAIFilledMapConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilledMapConfiguration)

#endif // OAIFilledMapConfiguration_H
