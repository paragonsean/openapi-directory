...
/*
 * OAIVisual_EmptyVisual.h
 *
 * 
 */

#ifndef OAIVisual_EmptyVisual_H
#define OAIVisual_EmptyVisual_H
...
class OAIVisual_EmptyVisual : public OAIObject {
public:
    OAIVisual_EmptyVisual();
    OAIVisual_EmptyVisual(QString json);
    ~OAIVisual_EmptyVisual() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVisual_EmptyVisual)

#endif // OAIVisual_EmptyVisual_H
