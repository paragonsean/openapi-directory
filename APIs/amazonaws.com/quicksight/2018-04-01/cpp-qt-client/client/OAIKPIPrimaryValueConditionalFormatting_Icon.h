...
/*
 * OAIKPIPrimaryValueConditionalFormatting_Icon.h
 *
 * 
 */

#ifndef OAIKPIPrimaryValueConditionalFormatting_Icon_H
#define OAIKPIPrimaryValueConditionalFormatting_Icon_H
...
class OAIKPIPrimaryValueConditionalFormatting_Icon : public OAIObject {
public:
    OAIKPIPrimaryValueConditionalFormatting_Icon();
    OAIKPIPrimaryValueConditionalFormatting_Icon(QString json);
    ~OAIKPIPrimaryValueConditionalFormatting_Icon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKPIPrimaryValueConditionalFormatting_Icon)

#endif // OAIKPIPrimaryValueConditionalFormatting_Icon_H
