...
/*
 * OAIComputation_PeriodToDate.h
 *
 * 
 */

#ifndef OAIComputation_PeriodToDate_H
#define OAIComputation_PeriodToDate_H
...
class OAIComputation_PeriodToDate : public OAIObject {
public:
    OAIComputation_PeriodToDate();
    OAIComputation_PeriodToDate(QString json);
    ~OAIComputation_PeriodToDate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_PeriodToDate)

#endif // OAIComputation_PeriodToDate_H
