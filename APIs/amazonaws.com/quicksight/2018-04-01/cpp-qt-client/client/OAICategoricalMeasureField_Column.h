...
/*
 * OAICategoricalMeasureField_Column.h
 *
 * 
 */

#ifndef OAICategoricalMeasureField_Column_H
#define OAICategoricalMeasureField_Column_H
...
class OAICategoricalMeasureField_Column : public OAIObject {
public:
    OAICategoricalMeasureField_Column();
    OAICategoricalMeasureField_Column(QString json);
    ~OAICategoricalMeasureField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoricalMeasureField_Column)

#endif // OAICategoricalMeasureField_Column_H
