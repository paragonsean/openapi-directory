...
/*
 * OAIRelativeDatesFilter.h
 *
 * A &lt;code&gt;RelativeDatesFilter&lt;/code&gt; filters relative dates values.
 */

#ifndef OAIRelativeDatesFilter_H
#define OAIRelativeDatesFilter_H
...
class OAIRelativeDatesFilter : public OAIObject {
public:
    OAIRelativeDatesFilter();
    OAIRelativeDatesFilter(QString json);
    ~OAIRelativeDatesFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelativeDatesFilter)

#endif // OAIRelativeDatesFilter_H
