...
OAIScatterPlotConfiguration_XAxisDisplayOptions::OAIScatterPlotConfiguration_XAxisDisplayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScatterPlotConfiguration_XAxisDisplayOptions::OAIScatterPlotConfiguration_XAxisDisplayOptions() {
    this->initializeModel();
}

OAIScatterPlotConfiguration_XAxisDisplayOptions::~OAIScatterPlotConfiguration_XAxisDisplayOptions() {}

void OAIScatterPlotConfiguration_XAxisDisplayOptions::initializeModel() {
...
void OAIScatterPlotConfiguration_XAxisDisplayOptions::fromJson(QString jsonString) {
...
void OAIScatterPlotConfiguration_XAxisDisplayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIScatterPlotConfiguration_XAxisDisplayOptions::asJson() const {
...
QJsonObject OAIScatterPlotConfiguration_XAxisDisplayOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIScatterPlotConfiguration_XAxisDisplayOptions::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIScatterPlotConfiguration_XAxisDisplayOptions::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIScatterPlotConfiguration_XAxisDisplayOptions::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIScatterPlotConfiguration_XAxisDisplayOptions::getDataOptions() const {
    return m_data_options;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIScatterPlotConfiguration_XAxisDisplayOptions::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIScatterPlotConfiguration_XAxisDisplayOptions::getAxisOffset() const {
    return m_axis_offset;
}
void OAIScatterPlotConfiguration_XAxisDisplayOptions::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIScatterPlotConfiguration_XAxisDisplayOptions::isSet() const {
...
bool OAIScatterPlotConfiguration_XAxisDisplayOptions::isValid() const {
