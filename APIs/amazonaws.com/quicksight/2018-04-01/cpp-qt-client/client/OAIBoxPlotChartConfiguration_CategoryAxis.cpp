...
OAIBoxPlotChartConfiguration_CategoryAxis::OAIBoxPlotChartConfiguration_CategoryAxis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoxPlotChartConfiguration_CategoryAxis::OAIBoxPlotChartConfiguration_CategoryAxis() {
    this->initializeModel();
}

OAIBoxPlotChartConfiguration_CategoryAxis::~OAIBoxPlotChartConfiguration_CategoryAxis() {}

void OAIBoxPlotChartConfiguration_CategoryAxis::initializeModel() {
...
void OAIBoxPlotChartConfiguration_CategoryAxis::fromJson(QString jsonString) {
...
void OAIBoxPlotChartConfiguration_CategoryAxis::fromJsonObject(QJsonObject json) {
...
QString OAIBoxPlotChartConfiguration_CategoryAxis::asJson() const {
...
QJsonObject OAIBoxPlotChartConfiguration_CategoryAxis::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIBoxPlotChartConfiguration_CategoryAxis::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIBoxPlotChartConfiguration_CategoryAxis::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIBoxPlotChartConfiguration_CategoryAxis::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIBoxPlotChartConfiguration_CategoryAxis::getDataOptions() const {
    return m_data_options;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIBoxPlotChartConfiguration_CategoryAxis::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIBoxPlotChartConfiguration_CategoryAxis::getAxisOffset() const {
    return m_axis_offset;
}
void OAIBoxPlotChartConfiguration_CategoryAxis::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIBoxPlotChartConfiguration_CategoryAxis::isSet() const {
...
bool OAIBoxPlotChartConfiguration_CategoryAxis::isValid() const {
