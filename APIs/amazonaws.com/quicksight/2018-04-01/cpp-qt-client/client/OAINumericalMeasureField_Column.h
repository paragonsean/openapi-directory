...
/*
 * OAINumericalMeasureField_Column.h
 *
 * 
 */

#ifndef OAINumericalMeasureField_Column_H
#define OAINumericalMeasureField_Column_H
...
class OAINumericalMeasureField_Column : public OAIObject {
public:
    OAINumericalMeasureField_Column();
    OAINumericalMeasureField_Column(QString json);
    ~OAINumericalMeasureField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumericalMeasureField_Column)

#endif // OAINumericalMeasureField_Column_H
