...
/*
 * OAIDataLabelOptions.h
 *
 * The options that determine the presentation of the data labels.
 */

#ifndef OAIDataLabelOptions_H
#define OAIDataLabelOptions_H
...
class OAIDataLabelOptions : public OAIObject {
public:
    OAIDataLabelOptions();
    OAIDataLabelOptions(QString json);
    ~OAIDataLabelOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLabelOptions)

#endif // OAIDataLabelOptions_H
