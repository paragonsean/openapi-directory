...
/*
 * OAIHistogramConfiguration_BinOptions.h
 *
 * 
 */

#ifndef OAIHistogramConfiguration_BinOptions_H
#define OAIHistogramConfiguration_BinOptions_H
...
class OAIHistogramConfiguration_BinOptions : public OAIObject {
public:
    OAIHistogramConfiguration_BinOptions();
    OAIHistogramConfiguration_BinOptions(QString json);
    ~OAIHistogramConfiguration_BinOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramConfiguration_BinOptions)

#endif // OAIHistogramConfiguration_BinOptions_H
