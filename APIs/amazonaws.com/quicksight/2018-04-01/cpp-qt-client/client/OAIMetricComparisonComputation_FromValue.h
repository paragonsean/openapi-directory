...
/*
 * OAIMetricComparisonComputation_FromValue.h
 *
 * 
 */

#ifndef OAIMetricComparisonComputation_FromValue_H
#define OAIMetricComparisonComputation_FromValue_H
...
class OAIMetricComparisonComputation_FromValue : public OAIObject {
public:
    OAIMetricComparisonComputation_FromValue();
    OAIMetricComparisonComputation_FromValue(QString json);
    ~OAIMetricComparisonComputation_FromValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricComparisonComputation_FromValue)

#endif // OAIMetricComparisonComputation_FromValue_H
