...
/*
 * OAITableCellConditionalFormatting.h
 *
 * The cell conditional formatting option for a table.
 */

#ifndef OAITableCellConditionalFormatting_H
#define OAITableCellConditionalFormatting_H
...
class OAITableCellConditionalFormatting : public OAIObject {
public:
    OAITableCellConditionalFormatting();
    OAITableCellConditionalFormatting(QString json);
    ~OAITableCellConditionalFormatting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableCellConditionalFormatting)

#endif // OAITableCellConditionalFormatting_H
