...
/*
 * OAIJoinInstruction.h
 *
 * The instructions associated with a join. 
 */

#ifndef OAIJoinInstruction_H
#define OAIJoinInstruction_H
...
class OAIJoinInstruction : public OAIObject {
public:
    OAIJoinInstruction();
    OAIJoinInstruction(QString json);
    ~OAIJoinInstruction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJoinInstruction)

#endif // OAIJoinInstruction_H
