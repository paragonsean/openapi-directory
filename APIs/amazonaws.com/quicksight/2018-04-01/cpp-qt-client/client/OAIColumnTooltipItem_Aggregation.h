...
/*
 * OAIColumnTooltipItem_Aggregation.h
 *
 * 
 */

#ifndef OAIColumnTooltipItem_Aggregation_H
#define OAIColumnTooltipItem_Aggregation_H
...
class OAIColumnTooltipItem_Aggregation : public OAIObject {
public:
    OAIColumnTooltipItem_Aggregation();
    OAIColumnTooltipItem_Aggregation(QString json);
    ~OAIColumnTooltipItem_Aggregation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnTooltipItem_Aggregation)

#endif // OAIColumnTooltipItem_Aggregation_H
