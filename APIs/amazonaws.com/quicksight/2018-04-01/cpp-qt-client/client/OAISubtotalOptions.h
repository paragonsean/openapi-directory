...
/*
 * OAISubtotalOptions.h
 *
 * The subtotal options.
 */

#ifndef OAISubtotalOptions_H
#define OAISubtotalOptions_H
...
class OAISubtotalOptions : public OAIObject {
public:
    OAISubtotalOptions();
    OAISubtotalOptions(QString json);
    ~OAISubtotalOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubtotalOptions)

#endif // OAISubtotalOptions_H
