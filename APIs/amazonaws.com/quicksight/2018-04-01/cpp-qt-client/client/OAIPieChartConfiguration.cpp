...
#include "OAIPieChartConfiguration.h"
...
OAIPieChartConfiguration::OAIPieChartConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPieChartConfiguration::OAIPieChartConfiguration() {
    this->initializeModel();
}

OAIPieChartConfiguration::~OAIPieChartConfiguration() {}

void OAIPieChartConfiguration::initializeModel() {
...
void OAIPieChartConfiguration::fromJson(QString jsonString) {
...
void OAIPieChartConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPieChartConfiguration::asJson() const {
...
QJsonObject OAIPieChartConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIPieChartConfiguration_FieldWells OAIPieChartConfiguration::getFieldWells() const {
    return m_field_wells;
}
void OAIPieChartConfiguration::setFieldWells(const OAIPieChartConfiguration_FieldWells &field_wells) {
    m_field_wells = field_wells;
    m_field_wells_isSet = true;
}

bool OAIPieChartConfiguration::is_field_wells_Set() const{
    return m_field_wells_isSet;
}

bool OAIPieChartConfiguration::is_field_wells_Valid() const{
    return m_field_wells_isValid;
}

OAIPieChartConfiguration_SortConfiguration OAIPieChartConfiguration::getSortConfiguration() const {
    return m_sort_configuration;
}
void OAIPieChartConfiguration::setSortConfiguration(const OAIPieChartConfiguration_SortConfiguration &sort_configuration) {
    m_sort_configuration = sort_configuration;
    m_sort_configuration_isSet = true;
}

bool OAIPieChartConfiguration::is_sort_configuration_Set() const{
    return m_sort_configuration_isSet;
}

bool OAIPieChartConfiguration::is_sort_configuration_Valid() const{
    return m_sort_configuration_isValid;
}

OAIPieChartConfiguration_DonutOptions OAIPieChartConfiguration::getDonutOptions() const {
    return m_donut_options;
}
void OAIPieChartConfiguration::setDonutOptions(const OAIPieChartConfiguration_DonutOptions &donut_options) {
    m_donut_options = donut_options;
    m_donut_options_isSet = true;
}

bool OAIPieChartConfiguration::is_donut_options_Set() const{
    return m_donut_options_isSet;
}

bool OAIPieChartConfiguration::is_donut_options_Valid() const{
    return m_donut_options_isValid;
}

OAIBarChartConfiguration_SmallMultiplesOptions OAIPieChartConfiguration::getSmallMultiplesOptions() const {
    return m_small_multiples_options;
}
void OAIPieChartConfiguration::setSmallMultiplesOptions(const OAIBarChartConfiguration_SmallMultiplesOptions &small_multiples_options) {
    m_small_multiples_options = small_multiples_options;
    m_small_multiples_options_isSet = true;
}

bool OAIPieChartConfiguration::is_small_multiples_options_Set() const{
    return m_small_multiples_options_isSet;
}

bool OAIPieChartConfiguration::is_small_multiples_options_Valid() const{
    return m_small_multiples_options_isValid;
}

OAIPieChartConfiguration_CategoryLabelOptions OAIPieChartConfiguration::getCategoryLabelOptions() const {
    return m_category_label_options;
}
void OAIPieChartConfiguration::setCategoryLabelOptions(const OAIPieChartConfiguration_CategoryLabelOptions &category_label_options) {
    m_category_label_options = category_label_options;
    m_category_label_options_isSet = true;
}

bool OAIPieChartConfiguration::is_category_label_options_Set() const{
    return m_category_label_options_isSet;
}

bool OAIPieChartConfiguration::is_category_label_options_Valid() const{
    return m_category_label_options_isValid;
}

OAIPieChartConfiguration_ValueLabelOptions OAIPieChartConfiguration::getValueLabelOptions() const {
    return m_value_label_options;
}
void OAIPieChartConfiguration::setValueLabelOptions(const OAIPieChartConfiguration_ValueLabelOptions &value_label_options) {
    m_value_label_options = value_label_options;
    m_value_label_options_isSet = true;
}

bool OAIPieChartConfiguration::is_value_label_options_Set() const{
    return m_value_label_options_isSet;
}

bool OAIPieChartConfiguration::is_value_label_options_Valid() const{
    return m_value_label_options_isValid;
}

OAIBarChartConfiguration_Legend OAIPieChartConfiguration::getLegend() const {
    return m_legend;
}
void OAIPieChartConfiguration::setLegend(const OAIBarChartConfiguration_Legend &legend) {
    m_legend = legend;
    m_legend_isSet = true;
}

bool OAIPieChartConfiguration::is_legend_Set() const{
    return m_legend_isSet;
}

bool OAIPieChartConfiguration::is_legend_Valid() const{
    return m_legend_isValid;
}

OAIBarChartConfiguration_DataLabels OAIPieChartConfiguration::getDataLabels() const {
    return m_data_labels;
}
void OAIPieChartConfiguration::setDataLabels(const OAIBarChartConfiguration_DataLabels &data_labels) {
    m_data_labels = data_labels;
    m_data_labels_isSet = true;
}

bool OAIPieChartConfiguration::is_data_labels_Set() const{
    return m_data_labels_isSet;
}

bool OAIPieChartConfiguration::is_data_labels_Valid() const{
    return m_data_labels_isValid;
}

OAIBarChartConfiguration_Tooltip OAIPieChartConfiguration::getTooltip() const {
    return m_tooltip;
}
void OAIPieChartConfiguration::setTooltip(const OAIBarChartConfiguration_Tooltip &tooltip) {
    m_tooltip = tooltip;
    m_tooltip_isSet = true;
}

bool OAIPieChartConfiguration::is_tooltip_Set() const{
    return m_tooltip_isSet;
}

bool OAIPieChartConfiguration::is_tooltip_Valid() const{
    return m_tooltip_isValid;
}

OAIBarChartConfiguration_VisualPalette OAIPieChartConfiguration::getVisualPalette() const {
    return m_visual_palette;
}
void OAIPieChartConfiguration::setVisualPalette(const OAIBarChartConfiguration_VisualPalette &visual_palette) {
    m_visual_palette = visual_palette;
    m_visual_palette_isSet = true;
}

bool OAIPieChartConfiguration::is_visual_palette_Set() const{
    return m_visual_palette_isSet;
}

bool OAIPieChartConfiguration::is_visual_palette_Valid() const{
    return m_visual_palette_isValid;
}

QList OAIPieChartConfiguration::getContributionAnalysisDefaults() const {
    return m_contribution_analysis_defaults;
}
void OAIPieChartConfiguration::setContributionAnalysisDefaults(const QList &contribution_analysis_defaults) {
    m_contribution_analysis_defaults = contribution_analysis_defaults;
    m_contribution_analysis_defaults_isSet = true;
}

bool OAIPieChartConfiguration::is_contribution_analysis_defaults_Set() const{
    return m_contribution_analysis_defaults_isSet;
}

bool OAIPieChartConfiguration::is_contribution_analysis_defaults_Valid() const{
    return m_contribution_analysis_defaults_isValid;
}

bool OAIPieChartConfiguration::isSet() const {
...
bool OAIPieChartConfiguration::isValid() const {
