...
/*
 * OAIUpdateTemplateRequest_SourceEntity.h
 *
 * 
 */

#ifndef OAIUpdateTemplateRequest_SourceEntity_H
#define OAIUpdateTemplateRequest_SourceEntity_H
...
class OAIUpdateTemplateRequest_SourceEntity : public OAIObject {
public:
    OAIUpdateTemplateRequest_SourceEntity();
    OAIUpdateTemplateRequest_SourceEntity(QString json);
    ~OAIUpdateTemplateRequest_SourceEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTemplateRequest_SourceEntity)

#endif // OAIUpdateTemplateRequest_SourceEntity_H
