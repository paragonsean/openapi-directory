...
OAIMetricComparisonComputation_TargetValue::OAIMetricComparisonComputation_TargetValue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetricComparisonComputation_TargetValue::OAIMetricComparisonComputation_TargetValue() {
    this->initializeModel();
}

OAIMetricComparisonComputation_TargetValue::~OAIMetricComparisonComputation_TargetValue() {}

void OAIMetricComparisonComputation_TargetValue::initializeModel() {
...
void OAIMetricComparisonComputation_TargetValue::fromJson(QString jsonString) {
...
void OAIMetricComparisonComputation_TargetValue::fromJsonObject(QJsonObject json) {
...
QString OAIMetricComparisonComputation_TargetValue::asJson() const {
...
QJsonObject OAIMetricComparisonComputation_TargetValue::asJsonObject() const {
    QJsonObject obj;
...
OAIMeasureField_NumericalMeasureField OAIMetricComparisonComputation_TargetValue::getNumericalMeasureField() const {
    return m_numerical_measure_field;
}
void OAIMetricComparisonComputation_TargetValue::setNumericalMeasureField(const OAIMeasureField_NumericalMeasureField &numerical_measure_field) {
    m_numerical_measure_field = numerical_measure_field;
    m_numerical_measure_field_isSet = true;
}

bool OAIMetricComparisonComputation_TargetValue::is_numerical_measure_field_Set() const{
    return m_numerical_measure_field_isSet;
}

bool OAIMetricComparisonComputation_TargetValue::is_numerical_measure_field_Valid() const{
    return m_numerical_measure_field_isValid;
}

OAIMeasureField_CategoricalMeasureField OAIMetricComparisonComputation_TargetValue::getCategoricalMeasureField() const {
    return m_categorical_measure_field;
}
void OAIMetricComparisonComputation_TargetValue::setCategoricalMeasureField(const OAIMeasureField_CategoricalMeasureField &categorical_measure_field) {
    m_categorical_measure_field = categorical_measure_field;
    m_categorical_measure_field_isSet = true;
}

bool OAIMetricComparisonComputation_TargetValue::is_categorical_measure_field_Set() const{
    return m_categorical_measure_field_isSet;
}

bool OAIMetricComparisonComputation_TargetValue::is_categorical_measure_field_Valid() const{
    return m_categorical_measure_field_isValid;
}

OAIMeasureField_DateMeasureField OAIMetricComparisonComputation_TargetValue::getDateMeasureField() const {
    return m_date_measure_field;
}
void OAIMetricComparisonComputation_TargetValue::setDateMeasureField(const OAIMeasureField_DateMeasureField &date_measure_field) {
    m_date_measure_field = date_measure_field;
    m_date_measure_field_isSet = true;
}

bool OAIMetricComparisonComputation_TargetValue::is_date_measure_field_Set() const{
    return m_date_measure_field_isSet;
}

bool OAIMetricComparisonComputation_TargetValue::is_date_measure_field_Valid() const{
    return m_date_measure_field_isValid;
}

OAIMeasureField_CalculatedMeasureField OAIMetricComparisonComputation_TargetValue::getCalculatedMeasureField() const {
    return m_calculated_measure_field;
}
void OAIMetricComparisonComputation_TargetValue::setCalculatedMeasureField(const OAIMeasureField_CalculatedMeasureField &calculated_measure_field) {
    m_calculated_measure_field = calculated_measure_field;
    m_calculated_measure_field_isSet = true;
}

bool OAIMetricComparisonComputation_TargetValue::is_calculated_measure_field_Set() const{
    return m_calculated_measure_field_isSet;
}

bool OAIMetricComparisonComputation_TargetValue::is_calculated_measure_field_Valid() const{
    return m_calculated_measure_field_isValid;
}

bool OAIMetricComparisonComputation_TargetValue::isSet() const {
...
bool OAIMetricComparisonComputation_TargetValue::isValid() const {
