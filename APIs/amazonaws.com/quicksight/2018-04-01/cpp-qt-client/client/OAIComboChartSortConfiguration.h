...
/*
 * OAIComboChartSortConfiguration.h
 *
 * The sort configuration of a &lt;code&gt;ComboChartVisual&lt;/code&gt;.
 */

#ifndef OAIComboChartSortConfiguration_H
#define OAIComboChartSortConfiguration_H
...
class OAIComboChartSortConfiguration : public OAIObject {
public:
    OAIComboChartSortConfiguration();
    OAIComboChartSortConfiguration(QString json);
    ~OAIComboChartSortConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComboChartSortConfiguration)

#endif // OAIComboChartSortConfiguration_H
