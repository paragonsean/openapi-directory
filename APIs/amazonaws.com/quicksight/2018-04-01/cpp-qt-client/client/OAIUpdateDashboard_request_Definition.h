...
/*
 * OAIUpdateDashboard_request_Definition.h
 *
 * The contents of a dashboard.
 */

#ifndef OAIUpdateDashboard_request_Definition_H
#define OAIUpdateDashboard_request_Definition_H
...
class OAIUpdateDashboard_request_Definition : public OAIObject {
public:
    OAIUpdateDashboard_request_Definition();
    OAIUpdateDashboard_request_Definition(QString json);
    ~OAIUpdateDashboard_request_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDashboard_request_Definition)

#endif // OAIUpdateDashboard_request_Definition_H
