...
/*
 * OAITableConfiguration.h
 *
 * The configuration for a &lt;code&gt;TableVisual&lt;/code&gt;.
 */

#ifndef OAITableConfiguration_H
#define OAITableConfiguration_H
...
class OAITableConfiguration : public OAIObject {
public:
    OAITableConfiguration();
    OAITableConfiguration(QString json);
    ~OAITableConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableConfiguration)

#endif // OAITableConfiguration_H
