...
/*
 * OAIPivotTableOptions_CellStyle.h
 *
 * 
 */

#ifndef OAIPivotTableOptions_CellStyle_H
#define OAIPivotTableOptions_CellStyle_H
...
class OAIPivotTableOptions_CellStyle : public OAIObject {
public:
    OAIPivotTableOptions_CellStyle();
    OAIPivotTableOptions_CellStyle(QString json);
    ~OAIPivotTableOptions_CellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableOptions_CellStyle)

#endif // OAIPivotTableOptions_CellStyle_H
