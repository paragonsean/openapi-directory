...
/*
 * OAIAssetBundleImportJobVPCConnectionOverrideParameters.h
 *
 * The override parameters for a single VPC connection that is imported.
 */

#ifndef OAIAssetBundleImportJobVPCConnectionOverrideParameters_H
#define OAIAssetBundleImportJobVPCConnectionOverrideParameters_H
...
class OAIAssetBundleImportJobVPCConnectionOverrideParameters : public OAIObject {
public:
    OAIAssetBundleImportJobVPCConnectionOverrideParameters();
    OAIAssetBundleImportJobVPCConnectionOverrideParameters(QString json);
    ~OAIAssetBundleImportJobVPCConnectionOverrideParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetBundleImportJobVPCConnectionOverrideParameters)

#endif // OAIAssetBundleImportJobVPCConnectionOverrideParameters_H
