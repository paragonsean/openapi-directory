...
/*
 * OAIConditionalFormattingCustomIconCondition.h
 *
 * Determines the custom condition for an icon set.
 */

#ifndef OAIConditionalFormattingCustomIconCondition_H
#define OAIConditionalFormattingCustomIconCondition_H
...
class OAIConditionalFormattingCustomIconCondition : public OAIObject {
public:
    OAIConditionalFormattingCustomIconCondition();
    OAIConditionalFormattingCustomIconCondition(QString json);
    ~OAIConditionalFormattingCustomIconCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionalFormattingCustomIconCondition)

#endif // OAIConditionalFormattingCustomIconCondition_H
