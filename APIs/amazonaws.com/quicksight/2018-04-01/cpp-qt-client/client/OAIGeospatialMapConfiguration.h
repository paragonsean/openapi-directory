...
/*
 * OAIGeospatialMapConfiguration.h
 *
 * The configuration of a &lt;code&gt;GeospatialMapVisual&lt;/code&gt;.
 */

#ifndef OAIGeospatialMapConfiguration_H
#define OAIGeospatialMapConfiguration_H
...
class OAIGeospatialMapConfiguration : public OAIObject {
public:
    OAIGeospatialMapConfiguration();
    OAIGeospatialMapConfiguration(QString json);
    ~OAIGeospatialMapConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeospatialMapConfiguration)

#endif // OAIGeospatialMapConfiguration_H
