...
/*
 * OAIUpdateDataSourcePermissionsResponse.h
 *
 * 
 */

#ifndef OAIUpdateDataSourcePermissionsResponse_H
#define OAIUpdateDataSourcePermissionsResponse_H
...
class OAIUpdateDataSourcePermissionsResponse : public OAIObject {
public:
    OAIUpdateDataSourcePermissionsResponse();
    OAIUpdateDataSourcePermissionsResponse(QString json);
    ~OAIUpdateDataSourcePermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDataSourcePermissionsResponse)

#endif // OAIUpdateDataSourcePermissionsResponse_H
