...
/*
 * OAICategoricalDimensionField_Column.h
 *
 * 
 */

#ifndef OAICategoricalDimensionField_Column_H
#define OAICategoricalDimensionField_Column_H
...
class OAICategoricalDimensionField_Column : public OAIObject {
public:
    OAICategoricalDimensionField_Column();
    OAICategoricalDimensionField_Column(QString json);
    ~OAICategoricalDimensionField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoricalDimensionField_Column)

#endif // OAICategoricalDimensionField_Column_H
