...
#include "OAITreeMapConfiguration.h"
...
OAITreeMapConfiguration::OAITreeMapConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITreeMapConfiguration::OAITreeMapConfiguration() {
    this->initializeModel();
}

OAITreeMapConfiguration::~OAITreeMapConfiguration() {}

void OAITreeMapConfiguration::initializeModel() {
...
void OAITreeMapConfiguration::fromJson(QString jsonString) {
...
void OAITreeMapConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAITreeMapConfiguration::asJson() const {
...
QJsonObject OAITreeMapConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAITreeMapConfiguration_FieldWells OAITreeMapConfiguration::getFieldWells() const {
    return m_field_wells;
}
void OAITreeMapConfiguration::setFieldWells(const OAITreeMapConfiguration_FieldWells &field_wells) {
    m_field_wells = field_wells;
    m_field_wells_isSet = true;
}

bool OAITreeMapConfiguration::is_field_wells_Set() const{
    return m_field_wells_isSet;
}

bool OAITreeMapConfiguration::is_field_wells_Valid() const{
    return m_field_wells_isValid;
}

OAITreeMapConfiguration_SortConfiguration OAITreeMapConfiguration::getSortConfiguration() const {
    return m_sort_configuration;
}
void OAITreeMapConfiguration::setSortConfiguration(const OAITreeMapConfiguration_SortConfiguration &sort_configuration) {
    m_sort_configuration = sort_configuration;
    m_sort_configuration_isSet = true;
}

bool OAITreeMapConfiguration::is_sort_configuration_Set() const{
    return m_sort_configuration_isSet;
}

bool OAITreeMapConfiguration::is_sort_configuration_Valid() const{
    return m_sort_configuration_isValid;
}

OAITreeMapConfiguration_GroupLabelOptions OAITreeMapConfiguration::getGroupLabelOptions() const {
    return m_group_label_options;
}
void OAITreeMapConfiguration::setGroupLabelOptions(const OAITreeMapConfiguration_GroupLabelOptions &group_label_options) {
    m_group_label_options = group_label_options;
    m_group_label_options_isSet = true;
}

bool OAITreeMapConfiguration::is_group_label_options_Set() const{
    return m_group_label_options_isSet;
}

bool OAITreeMapConfiguration::is_group_label_options_Valid() const{
    return m_group_label_options_isValid;
}

OAITreeMapConfiguration_SizeLabelOptions OAITreeMapConfiguration::getSizeLabelOptions() const {
    return m_size_label_options;
}
void OAITreeMapConfiguration::setSizeLabelOptions(const OAITreeMapConfiguration_SizeLabelOptions &size_label_options) {
    m_size_label_options = size_label_options;
    m_size_label_options_isSet = true;
}

bool OAITreeMapConfiguration::is_size_label_options_Set() const{
    return m_size_label_options_isSet;
}

bool OAITreeMapConfiguration::is_size_label_options_Valid() const{
    return m_size_label_options_isValid;
}

OAITreeMapConfiguration_ColorLabelOptions OAITreeMapConfiguration::getColorLabelOptions() const {
    return m_color_label_options;
}
void OAITreeMapConfiguration::setColorLabelOptions(const OAITreeMapConfiguration_ColorLabelOptions &color_label_options) {
    m_color_label_options = color_label_options;
    m_color_label_options_isSet = true;
}

bool OAITreeMapConfiguration::is_color_label_options_Set() const{
    return m_color_label_options_isSet;
}

bool OAITreeMapConfiguration::is_color_label_options_Valid() const{
    return m_color_label_options_isValid;
}

OAITreeMapConfiguration_ColorScale OAITreeMapConfiguration::getColorScale() const {
    return m_color_scale;
}
void OAITreeMapConfiguration::setColorScale(const OAITreeMapConfiguration_ColorScale &color_scale) {
    m_color_scale = color_scale;
    m_color_scale_isSet = true;
}

bool OAITreeMapConfiguration::is_color_scale_Set() const{
    return m_color_scale_isSet;
}

bool OAITreeMapConfiguration::is_color_scale_Valid() const{
    return m_color_scale_isValid;
}

OAIBarChartConfiguration_Legend OAITreeMapConfiguration::getLegend() const {
    return m_legend;
}
void OAITreeMapConfiguration::setLegend(const OAIBarChartConfiguration_Legend &legend) {
    m_legend = legend;
    m_legend_isSet = true;
}

bool OAITreeMapConfiguration::is_legend_Set() const{
    return m_legend_isSet;
}

bool OAITreeMapConfiguration::is_legend_Valid() const{
    return m_legend_isValid;
}

OAIBarChartConfiguration_DataLabels OAITreeMapConfiguration::getDataLabels() const {
    return m_data_labels;
}
void OAITreeMapConfiguration::setDataLabels(const OAIBarChartConfiguration_DataLabels &data_labels) {
    m_data_labels = data_labels;
    m_data_labels_isSet = true;
}

bool OAITreeMapConfiguration::is_data_labels_Set() const{
    return m_data_labels_isSet;
}

bool OAITreeMapConfiguration::is_data_labels_Valid() const{
    return m_data_labels_isValid;
}

OAIBarChartConfiguration_Tooltip OAITreeMapConfiguration::getTooltip() const {
    return m_tooltip;
}
void OAITreeMapConfiguration::setTooltip(const OAIBarChartConfiguration_Tooltip &tooltip) {
    m_tooltip = tooltip;
    m_tooltip_isSet = true;
}

bool OAITreeMapConfiguration::is_tooltip_Set() const{
    return m_tooltip_isSet;
}

bool OAITreeMapConfiguration::is_tooltip_Valid() const{
    return m_tooltip_isValid;
}

bool OAITreeMapConfiguration::isSet() const {
...
bool OAITreeMapConfiguration::isValid() const {
