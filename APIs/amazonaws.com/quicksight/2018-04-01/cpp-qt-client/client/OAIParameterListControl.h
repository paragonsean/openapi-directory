...
/*
 * OAIParameterListControl.h
 *
 * A control to display a list with buttons or boxes that are used to select either a single value or multiple values.
 */

#ifndef OAIParameterListControl_H
#define OAIParameterListControl_H
...
class OAIParameterListControl : public OAIObject {
public:
    OAIParameterListControl();
    OAIParameterListControl(QString json);
    ~OAIParameterListControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterListControl)

#endif // OAIParameterListControl_H
