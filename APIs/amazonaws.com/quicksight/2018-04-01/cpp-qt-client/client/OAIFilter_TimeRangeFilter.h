...
/*
 * OAIFilter_TimeRangeFilter.h
 *
 * 
 */

#ifndef OAIFilter_TimeRangeFilter_H
#define OAIFilter_TimeRangeFilter_H
...
class OAIFilter_TimeRangeFilter : public OAIObject {
public:
    OAIFilter_TimeRangeFilter();
    OAIFilter_TimeRangeFilter(QString json);
    ~OAIFilter_TimeRangeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilter_TimeRangeFilter)

#endif // OAIFilter_TimeRangeFilter_H
