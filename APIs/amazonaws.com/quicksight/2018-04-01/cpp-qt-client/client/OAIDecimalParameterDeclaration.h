...
/*
 * OAIDecimalParameterDeclaration.h
 *
 * A parameter declaration for the &lt;code&gt;Decimal&lt;/code&gt; data type.
 */

#ifndef OAIDecimalParameterDeclaration_H
#define OAIDecimalParameterDeclaration_H
...
class OAIDecimalParameterDeclaration : public OAIObject {
public:
    OAIDecimalParameterDeclaration();
    OAIDecimalParameterDeclaration(QString json);
    ~OAIDecimalParameterDeclaration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDecimalParameterDeclaration)

#endif // OAIDecimalParameterDeclaration_H
