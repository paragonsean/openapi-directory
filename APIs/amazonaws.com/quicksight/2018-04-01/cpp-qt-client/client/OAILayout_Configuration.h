...
/*
 * OAILayout_Configuration.h
 *
 * 
 */

#ifndef OAILayout_Configuration_H
#define OAILayout_Configuration_H
...
class OAILayout_Configuration : public OAIObject {
public:
    OAILayout_Configuration();
    OAILayout_Configuration(QString json);
    ~OAILayout_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILayout_Configuration)

#endif // OAILayout_Configuration_H
