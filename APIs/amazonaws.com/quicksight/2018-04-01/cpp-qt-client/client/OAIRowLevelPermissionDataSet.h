...
/*
 * OAIRowLevelPermissionDataSet.h
 *
...
#ifndef OAIRowLevelPermissionDataSet_H
#define OAIRowLevelPermissionDataSet_H
...
class OAIRowLevelPermissionDataSet : public OAIObject {
public:
    OAIRowLevelPermissionDataSet();
    OAIRowLevelPermissionDataSet(QString json);
    ~OAIRowLevelPermissionDataSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRowLevelPermissionDataSet)

#endif // OAIRowLevelPermissionDataSet_H
