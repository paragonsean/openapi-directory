...
/*
 * OAIComputation_Forecast.h
 *
 * 
 */

#ifndef OAIComputation_Forecast_H
#define OAIComputation_Forecast_H
...
class OAIComputation_Forecast : public OAIObject {
public:
    OAIComputation_Forecast();
    OAIComputation_Forecast(QString json);
    ~OAIComputation_Forecast() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_Forecast)

#endif // OAIComputation_Forecast_H
