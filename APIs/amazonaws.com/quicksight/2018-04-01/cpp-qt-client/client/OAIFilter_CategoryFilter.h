...
/*
 * OAIFilter_CategoryFilter.h
 *
 * 
 */

#ifndef OAIFilter_CategoryFilter_H
#define OAIFilter_CategoryFilter_H
...
class OAIFilter_CategoryFilter : public OAIObject {
public:
    OAIFilter_CategoryFilter();
    OAIFilter_CategoryFilter(QString json);
    ~OAIFilter_CategoryFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilter_CategoryFilter)

#endif // OAIFilter_CategoryFilter_H
