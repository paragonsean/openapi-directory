...
/*
 * OAIBarChartConfiguration_DataLabels.h
 *
 * 
 */

#ifndef OAIBarChartConfiguration_DataLabels_H
#define OAIBarChartConfiguration_DataLabels_H
...
class OAIBarChartConfiguration_DataLabels : public OAIObject {
public:
    OAIBarChartConfiguration_DataLabels();
    OAIBarChartConfiguration_DataLabels(QString json);
    ~OAIBarChartConfiguration_DataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBarChartConfiguration_DataLabels)

#endif // OAIBarChartConfiguration_DataLabels_H
