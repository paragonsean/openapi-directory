...
OAIVisual_KPIVisual::OAIVisual_KPIVisual(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVisual_KPIVisual::OAIVisual_KPIVisual() {
    this->initializeModel();
}

OAIVisual_KPIVisual::~OAIVisual_KPIVisual() {}

void OAIVisual_KPIVisual::initializeModel() {
...
void OAIVisual_KPIVisual::fromJson(QString jsonString) {
...
void OAIVisual_KPIVisual::fromJsonObject(QJsonObject json) {
...
QString OAIVisual_KPIVisual::asJson() const {
...
QJsonObject OAIVisual_KPIVisual::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVisual_KPIVisual::getVisualId() const {
    return m_visual_id;
}
void OAIVisual_KPIVisual::setVisualId(const QString &visual_id) {
    m_visual_id = visual_id;
    m_visual_id_isSet = true;
}

bool OAIVisual_KPIVisual::is_visual_id_Set() const{
    return m_visual_id_isSet;
}

bool OAIVisual_KPIVisual::is_visual_id_Valid() const{
    return m_visual_id_isValid;
}

OAIBarChartVisual_Title OAIVisual_KPIVisual::getTitle() const {
    return m_title;
}
void OAIVisual_KPIVisual::setTitle(const OAIBarChartVisual_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIVisual_KPIVisual::is_title_Set() const{
    return m_title_isSet;
}

bool OAIVisual_KPIVisual::is_title_Valid() const{
    return m_title_isValid;
}

OAIBarChartVisual_Subtitle OAIVisual_KPIVisual::getSubtitle() const {
    return m_subtitle;
}
void OAIVisual_KPIVisual::setSubtitle(const OAIBarChartVisual_Subtitle &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAIVisual_KPIVisual::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAIVisual_KPIVisual::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

OAIKPIVisual_ChartConfiguration OAIVisual_KPIVisual::getChartConfiguration() const {
    return m_chart_configuration;
}
void OAIVisual_KPIVisual::setChartConfiguration(const OAIKPIVisual_ChartConfiguration &chart_configuration) {
    m_chart_configuration = chart_configuration;
    m_chart_configuration_isSet = true;
}

bool OAIVisual_KPIVisual::is_chart_configuration_Set() const{
    return m_chart_configuration_isSet;
}

bool OAIVisual_KPIVisual::is_chart_configuration_Valid() const{
    return m_chart_configuration_isValid;
}

OAIKPIVisual_ConditionalFormatting OAIVisual_KPIVisual::getConditionalFormatting() const {
    return m_conditional_formatting;
}
void OAIVisual_KPIVisual::setConditionalFormatting(const OAIKPIVisual_ConditionalFormatting &conditional_formatting) {
    m_conditional_formatting = conditional_formatting;
    m_conditional_formatting_isSet = true;
}

bool OAIVisual_KPIVisual::is_conditional_formatting_Set() const{
    return m_conditional_formatting_isSet;
}

bool OAIVisual_KPIVisual::is_conditional_formatting_Valid() const{
    return m_conditional_formatting_isValid;
}

QList OAIVisual_KPIVisual::getActions() const {
    return m_actions;
}
void OAIVisual_KPIVisual::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIVisual_KPIVisual::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIVisual_KPIVisual::is_actions_Valid() const{
    return m_actions_isValid;
}

QList OAIVisual_KPIVisual::getColumnHierarchies() const {
    return m_column_hierarchies;
}
void OAIVisual_KPIVisual::setColumnHierarchies(const QList &column_hierarchies) {
    m_column_hierarchies = column_hierarchies;
    m_column_hierarchies_isSet = true;
}

bool OAIVisual_KPIVisual::is_column_hierarchies_Set() const{
    return m_column_hierarchies_isSet;
}

bool OAIVisual_KPIVisual::is_column_hierarchies_Valid() const{
    return m_column_hierarchies_isValid;
}

bool OAIVisual_KPIVisual::isSet() const {
...
bool OAIVisual_KPIVisual::isValid() const {
