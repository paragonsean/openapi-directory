...
/*
 * OAITableOptions_CellStyle.h
 *
 * 
 */

#ifndef OAITableOptions_CellStyle_H
#define OAITableOptions_CellStyle_H
...
class OAITableOptions_CellStyle : public OAIObject {
public:
    OAITableOptions_CellStyle();
    OAITableOptions_CellStyle(QString json);
    ~OAITableOptions_CellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableOptions_CellStyle)

#endif // OAITableOptions_CellStyle_H
