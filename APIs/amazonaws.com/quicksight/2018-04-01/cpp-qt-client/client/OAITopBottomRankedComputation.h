...
/*
 * OAITopBottomRankedComputation.h
 *
 * The top ranked and bottom ranked computation configuration.
 */

#ifndef OAITopBottomRankedComputation_H
#define OAITopBottomRankedComputation_H
...
class OAITopBottomRankedComputation : public OAIObject {
public:
    OAITopBottomRankedComputation();
    OAITopBottomRankedComputation(QString json);
    ~OAITopBottomRankedComputation() override;
    ...
    qint32 getResultSize() const;
    void setResultSize(const qint32 &result_size);
...
Q_DECLARE_METATYPE(OpenAPI::OAITopBottomRankedComputation)

#endif // OAITopBottomRankedComputation_H
