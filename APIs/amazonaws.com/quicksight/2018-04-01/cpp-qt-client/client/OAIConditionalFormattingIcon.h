...
/*
 * OAIConditionalFormattingIcon.h
 *
 * The formatting configuration for the icon.
 */

#ifndef OAIConditionalFormattingIcon_H
#define OAIConditionalFormattingIcon_H
...
class OAIConditionalFormattingIcon : public OAIObject {
public:
    OAIConditionalFormattingIcon();
    OAIConditionalFormattingIcon(QString json);
    ~OAIConditionalFormattingIcon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionalFormattingIcon)

#endif // OAIConditionalFormattingIcon_H
