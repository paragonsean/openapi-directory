...
/*
 * OAIPivotTotalOptions_TotalCellStyle.h
 *
 * 
 */

#ifndef OAIPivotTotalOptions_TotalCellStyle_H
#define OAIPivotTotalOptions_TotalCellStyle_H
...
class OAIPivotTotalOptions_TotalCellStyle : public OAIObject {
public:
    OAIPivotTotalOptions_TotalCellStyle();
    OAIPivotTotalOptions_TotalCellStyle(QString json);
    ~OAIPivotTotalOptions_TotalCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTotalOptions_TotalCellStyle)

#endif // OAIPivotTotalOptions_TotalCellStyle_H
