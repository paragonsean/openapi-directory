...
/*
 * OAIUpdateTopicRefreshScheduleResponse.h
 *
 * 
 */

#ifndef OAIUpdateTopicRefreshScheduleResponse_H
#define OAIUpdateTopicRefreshScheduleResponse_H
...
class OAIUpdateTopicRefreshScheduleResponse : public OAIObject {
public:
    OAIUpdateTopicRefreshScheduleResponse();
    OAIUpdateTopicRefreshScheduleResponse(QString json);
    ~OAIUpdateTopicRefreshScheduleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTopicRefreshScheduleResponse)

#endif // OAIUpdateTopicRefreshScheduleResponse_H
