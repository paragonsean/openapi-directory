...
/*
 * OAIUpdateVPCConnectionResponse.h
 *
 * 
 */

#ifndef OAIUpdateVPCConnectionResponse_H
#define OAIUpdateVPCConnectionResponse_H
...
class OAIUpdateVPCConnectionResponse : public OAIObject {
public:
    OAIUpdateVPCConnectionResponse();
    OAIUpdateVPCConnectionResponse(QString json);
    ~OAIUpdateVPCConnectionResponse() override;
    ...
    OAIVPCConnectionResourceStatus getUpdateStatus() const;
    void setUpdateStatus(const OAIVPCConnectionResourceStatus &update_status);
...
private:
    ...
    OAIVPCConnectionResourceStatus m_update_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVPCConnectionResponse)

#endif // OAIUpdateVPCConnectionResponse_H
