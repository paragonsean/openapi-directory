...
/*
 * OAICreateTemplateRequest_Definition.h
 *
 * 
 */

#ifndef OAICreateTemplateRequest_Definition_H
#define OAICreateTemplateRequest_Definition_H
...
class OAICreateTemplateRequest_Definition : public OAIObject {
public:
    OAICreateTemplateRequest_Definition();
    OAICreateTemplateRequest_Definition(QString json);
    ~OAICreateTemplateRequest_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTemplateRequest_Definition)

#endif // OAICreateTemplateRequest_Definition_H
