...
/*
 * OAIGlobalTableBorderOptions_SideSpecificBorder.h
 *
 * 
 */

#ifndef OAIGlobalTableBorderOptions_SideSpecificBorder_H
#define OAIGlobalTableBorderOptions_SideSpecificBorder_H
...
class OAIGlobalTableBorderOptions_SideSpecificBorder : public OAIObject {
public:
    OAIGlobalTableBorderOptions_SideSpecificBorder();
    OAIGlobalTableBorderOptions_SideSpecificBorder(QString json);
    ~OAIGlobalTableBorderOptions_SideSpecificBorder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalTableBorderOptions_SideSpecificBorder)

#endif // OAIGlobalTableBorderOptions_SideSpecificBorder_H
