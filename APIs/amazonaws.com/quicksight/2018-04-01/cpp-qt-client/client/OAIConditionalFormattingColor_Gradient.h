...
/*
 * OAIConditionalFormattingColor_Gradient.h
 *
 * 
 */

#ifndef OAIConditionalFormattingColor_Gradient_H
#define OAIConditionalFormattingColor_Gradient_H
...
class OAIConditionalFormattingColor_Gradient : public OAIObject {
public:
    OAIConditionalFormattingColor_Gradient();
    OAIConditionalFormattingColor_Gradient(QString json);
    ~OAIConditionalFormattingColor_Gradient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionalFormattingColor_Gradient)

#endif // OAIConditionalFormattingColor_Gradient_H
