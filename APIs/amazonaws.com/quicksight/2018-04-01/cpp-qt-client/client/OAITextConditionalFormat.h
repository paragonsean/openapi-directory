...
/*
 * OAITextConditionalFormat.h
 *
 * The conditional formatting for the text.
 */

#ifndef OAITextConditionalFormat_H
#define OAITextConditionalFormat_H
...
class OAITextConditionalFormat : public OAIObject {
public:
    OAITextConditionalFormat();
    OAITextConditionalFormat(QString json);
    ~OAITextConditionalFormat() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextConditionalFormat)

#endif // OAITextConditionalFormat_H
