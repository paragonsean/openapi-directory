...
OAIUpdateDashboard_request_Definition::OAIUpdateDashboard_request_Definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDashboard_request_Definition::OAIUpdateDashboard_request_Definition() {
    this->initializeModel();
}

OAIUpdateDashboard_request_Definition::~OAIUpdateDashboard_request_Definition() {}

void OAIUpdateDashboard_request_Definition::initializeModel() {
...
void OAIUpdateDashboard_request_Definition::fromJson(QString jsonString) {
...
void OAIUpdateDashboard_request_Definition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDashboard_request_Definition::asJson() const {
...
QJsonObject OAIUpdateDashboard_request_Definition::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateDashboard_request_Definition::getDataSetIdentifierDeclarations() const {
    return m_data_set_identifier_declarations;
}
void OAIUpdateDashboard_request_Definition::setDataSetIdentifierDeclarations(const QList &data_set_identifier_declarations) {
    m_data_set_identifier_declarations = data_set_identifier_declarations;
    m_data_set_identifier_declarations_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_data_set_identifier_declarations_Set() const{
    return m_data_set_identifier_declarations_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_data_set_identifier_declarations_Valid() const{
    return m_data_set_identifier_declarations_isValid;
}

QList OAIUpdateDashboard_request_Definition::getSheets() const {
    return m_sheets;
}
void OAIUpdateDashboard_request_Definition::setSheets(const QList &sheets) {
    m_sheets = sheets;
    m_sheets_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_sheets_Set() const{
    return m_sheets_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_sheets_Valid() const{
    return m_sheets_isValid;
}

QList OAIUpdateDashboard_request_Definition::getCalculatedFields() const {
    return m_calculated_fields;
}
void OAIUpdateDashboard_request_Definition::setCalculatedFields(const QList &calculated_fields) {
    m_calculated_fields = calculated_fields;
    m_calculated_fields_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_calculated_fields_Set() const{
    return m_calculated_fields_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_calculated_fields_Valid() const{
    return m_calculated_fields_isValid;
}

QList OAIUpdateDashboard_request_Definition::getParameterDeclarations() const {
    return m_parameter_declarations;
}
void OAIUpdateDashboard_request_Definition::setParameterDeclarations(const QList &parameter_declarations) {
    m_parameter_declarations = parameter_declarations;
    m_parameter_declarations_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_parameter_declarations_Set() const{
    return m_parameter_declarations_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_parameter_declarations_Valid() const{
    return m_parameter_declarations_isValid;
}

QList OAIUpdateDashboard_request_Definition::getFilterGroups() const {
    return m_filter_groups;
}
void OAIUpdateDashboard_request_Definition::setFilterGroups(const QList &filter_groups) {
    m_filter_groups = filter_groups;
    m_filter_groups_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_filter_groups_Set() const{
    return m_filter_groups_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_filter_groups_Valid() const{
    return m_filter_groups_isValid;
}

QList OAIUpdateDashboard_request_Definition::getColumnConfigurations() const {
    return m_column_configurations;
}
void OAIUpdateDashboard_request_Definition::setColumnConfigurations(const QList &column_configurations) {
    m_column_configurations = column_configurations;
    m_column_configurations_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_column_configurations_Set() const{
    return m_column_configurations_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_column_configurations_Valid() const{
    return m_column_configurations_isValid;
}

OAIAnalysisDefaults OAIUpdateDashboard_request_Definition::getAnalysisDefaults() const {
    return m_analysis_defaults;
}
void OAIUpdateDashboard_request_Definition::setAnalysisDefaults(const OAIAnalysisDefaults &analysis_defaults) {
    m_analysis_defaults = analysis_defaults;
    m_analysis_defaults_isSet = true;
}

bool OAIUpdateDashboard_request_Definition::is_analysis_defaults_Set() const{
    return m_analysis_defaults_isSet;
}

bool OAIUpdateDashboard_request_Definition::is_analysis_defaults_Valid() const{
    return m_analysis_defaults_isValid;
}

bool OAIUpdateDashboard_request_Definition::isSet() const {
...
bool OAIUpdateDashboard_request_Definition::isValid() const {
