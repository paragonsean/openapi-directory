...
/*
 * OAIDataPathLabelType.h
 *
 * The option that specifies individual data values for labels.
 */

#ifndef OAIDataPathLabelType_H
#define OAIDataPathLabelType_H
...
class OAIDataPathLabelType : public OAIObject {
public:
    OAIDataPathLabelType();
    OAIDataPathLabelType(QString json);
    ~OAIDataPathLabelType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataPathLabelType)

#endif // OAIDataPathLabelType_H
