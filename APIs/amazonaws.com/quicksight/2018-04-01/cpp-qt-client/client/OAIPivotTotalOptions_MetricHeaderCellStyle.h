...
/*
 * OAIPivotTotalOptions_MetricHeaderCellStyle.h
 *
 * 
 */

#ifndef OAIPivotTotalOptions_MetricHeaderCellStyle_H
#define OAIPivotTotalOptions_MetricHeaderCellStyle_H
...
class OAIPivotTotalOptions_MetricHeaderCellStyle : public OAIObject {
public:
    OAIPivotTotalOptions_MetricHeaderCellStyle();
    OAIPivotTotalOptions_MetricHeaderCellStyle(QString json);
    ~OAIPivotTotalOptions_MetricHeaderCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTotalOptions_MetricHeaderCellStyle)

#endif // OAIPivotTotalOptions_MetricHeaderCellStyle_H
