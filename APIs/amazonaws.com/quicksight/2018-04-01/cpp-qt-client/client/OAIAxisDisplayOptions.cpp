...
#include "OAIAxisDisplayOptions.h"
...
OAIAxisDisplayOptions::OAIAxisDisplayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAxisDisplayOptions::OAIAxisDisplayOptions() {
    this->initializeModel();
}

OAIAxisDisplayOptions::~OAIAxisDisplayOptions() {}

void OAIAxisDisplayOptions::initializeModel() {
...
void OAIAxisDisplayOptions::fromJson(QString jsonString) {
...
void OAIAxisDisplayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIAxisDisplayOptions::asJson() const {
...
QJsonObject OAIAxisDisplayOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIAxisDisplayOptions::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIAxisDisplayOptions::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIAxisDisplayOptions::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIAxisDisplayOptions::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIAxisDisplayOptions::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIAxisDisplayOptions::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIAxisDisplayOptions::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIAxisDisplayOptions::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIAxisDisplayOptions::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIAxisDisplayOptions::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIAxisDisplayOptions::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIAxisDisplayOptions::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIAxisDisplayOptions::getDataOptions() const {
    return m_data_options;
}
void OAIAxisDisplayOptions::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIAxisDisplayOptions::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIAxisDisplayOptions::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIAxisDisplayOptions::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIAxisDisplayOptions::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIAxisDisplayOptions::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIAxisDisplayOptions::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIAxisDisplayOptions::getAxisOffset() const {
    return m_axis_offset;
}
void OAIAxisDisplayOptions::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIAxisDisplayOptions::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIAxisDisplayOptions::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIAxisDisplayOptions::isSet() const {
...
bool OAIAxisDisplayOptions::isValid() const {
