...
OAIComboChartConfiguration_CategoryAxis::OAIComboChartConfiguration_CategoryAxis(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComboChartConfiguration_CategoryAxis::OAIComboChartConfiguration_CategoryAxis() {
    this->initializeModel();
}

OAIComboChartConfiguration_CategoryAxis::~OAIComboChartConfiguration_CategoryAxis() {}

void OAIComboChartConfiguration_CategoryAxis::initializeModel() {
...
void OAIComboChartConfiguration_CategoryAxis::fromJson(QString jsonString) {
...
void OAIComboChartConfiguration_CategoryAxis::fromJsonObject(QJsonObject json) {
...
QString OAIComboChartConfiguration_CategoryAxis::asJson() const {
...
QJsonObject OAIComboChartConfiguration_CategoryAxis::asJsonObject() const {
    QJsonObject obj;
...
OAIAxisDisplayOptions_TickLabelOptions OAIComboChartConfiguration_CategoryAxis::getTickLabelOptions() const {
    return m_tick_label_options;
}
void OAIComboChartConfiguration_CategoryAxis::setTickLabelOptions(const OAIAxisDisplayOptions_TickLabelOptions &tick_label_options) {
    m_tick_label_options = tick_label_options;
    m_tick_label_options_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_tick_label_options_Set() const{
    return m_tick_label_options_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_tick_label_options_Valid() const{
    return m_tick_label_options_isValid;
}

OAIVisibility OAIComboChartConfiguration_CategoryAxis::getAxisLineVisibility() const {
    return m_axis_line_visibility;
}
void OAIComboChartConfiguration_CategoryAxis::setAxisLineVisibility(const OAIVisibility &axis_line_visibility) {
    m_axis_line_visibility = axis_line_visibility;
    m_axis_line_visibility_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_axis_line_visibility_Set() const{
    return m_axis_line_visibility_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_axis_line_visibility_Valid() const{
    return m_axis_line_visibility_isValid;
}

OAIVisibility OAIComboChartConfiguration_CategoryAxis::getGridLineVisibility() const {
    return m_grid_line_visibility;
}
void OAIComboChartConfiguration_CategoryAxis::setGridLineVisibility(const OAIVisibility &grid_line_visibility) {
    m_grid_line_visibility = grid_line_visibility;
    m_grid_line_visibility_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_grid_line_visibility_Set() const{
    return m_grid_line_visibility_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_grid_line_visibility_Valid() const{
    return m_grid_line_visibility_isValid;
}

OAIAxisDisplayOptions_DataOptions OAIComboChartConfiguration_CategoryAxis::getDataOptions() const {
    return m_data_options;
}
void OAIComboChartConfiguration_CategoryAxis::setDataOptions(const OAIAxisDisplayOptions_DataOptions &data_options) {
    m_data_options = data_options;
    m_data_options_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_data_options_Set() const{
    return m_data_options_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_data_options_Valid() const{
    return m_data_options_isValid;
}

OAIAxisDisplayOptions_ScrollbarOptions OAIComboChartConfiguration_CategoryAxis::getScrollbarOptions() const {
    return m_scrollbar_options;
}
void OAIComboChartConfiguration_CategoryAxis::setScrollbarOptions(const OAIAxisDisplayOptions_ScrollbarOptions &scrollbar_options) {
    m_scrollbar_options = scrollbar_options;
    m_scrollbar_options_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_scrollbar_options_Set() const{
    return m_scrollbar_options_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_scrollbar_options_Valid() const{
    return m_scrollbar_options_isValid;
}

QString OAIComboChartConfiguration_CategoryAxis::getAxisOffset() const {
    return m_axis_offset;
}
void OAIComboChartConfiguration_CategoryAxis::setAxisOffset(const QString &axis_offset) {
    m_axis_offset = axis_offset;
    m_axis_offset_isSet = true;
}

bool OAIComboChartConfiguration_CategoryAxis::is_axis_offset_Set() const{
    return m_axis_offset_isSet;
}

bool OAIComboChartConfiguration_CategoryAxis::is_axis_offset_Valid() const{
    return m_axis_offset_isValid;
}

bool OAIComboChartConfiguration_CategoryAxis::isSet() const {
...
bool OAIComboChartConfiguration_CategoryAxis::isValid() const {
