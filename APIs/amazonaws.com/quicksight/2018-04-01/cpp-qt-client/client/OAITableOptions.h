...
#ifndef OAITableOptions_H
#define OAITableOptions_H
...
class OAITableOptions : public OAIObject {
public:
    OAITableOptions();
    OAITableOptions(QString json);
    ~OAITableOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableOptions)

#endif // OAITableOptions_H
