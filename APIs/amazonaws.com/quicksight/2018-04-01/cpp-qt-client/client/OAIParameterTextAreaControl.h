...
/*
 * OAIParameterTextAreaControl.h
 *
 * A control to display a text box that is used to enter multiple entries.
 */

#ifndef OAIParameterTextAreaControl_H
#define OAIParameterTextAreaControl_H
...
class OAIParameterTextAreaControl : public OAIObject {
public:
    OAIParameterTextAreaControl();
    OAIParameterTextAreaControl(QString json);
    ~OAIParameterTextAreaControl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterTextAreaControl)

#endif // OAIParameterTextAreaControl_H
