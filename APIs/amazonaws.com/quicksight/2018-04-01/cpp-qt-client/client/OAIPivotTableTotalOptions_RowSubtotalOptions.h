...
/*
 * OAIPivotTableTotalOptions_RowSubtotalOptions.h
 *
 * 
 */

#ifndef OAIPivotTableTotalOptions_RowSubtotalOptions_H
#define OAIPivotTableTotalOptions_RowSubtotalOptions_H
...
class OAIPivotTableTotalOptions_RowSubtotalOptions : public OAIObject {
public:
    OAIPivotTableTotalOptions_RowSubtotalOptions();
    OAIPivotTableTotalOptions_RowSubtotalOptions(QString json);
    ~OAIPivotTableTotalOptions_RowSubtotalOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableTotalOptions_RowSubtotalOptions)

#endif // OAIPivotTableTotalOptions_RowSubtotalOptions_H
