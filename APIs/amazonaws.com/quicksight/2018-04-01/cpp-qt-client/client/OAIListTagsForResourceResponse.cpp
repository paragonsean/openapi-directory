...
QString OAIListTagsForResourceResponse::getRequestId() const {
    return m_request_id;
}
void OAIListTagsForResourceResponse::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIListTagsForResourceResponse::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIListTagsForResourceResponse::is_request_id_Valid() const{
    return m_request_id_isValid;
}

qint32 OAIListTagsForResourceResponse::getStatus() const {
    return m_status;
}
void OAIListTagsForResourceResponse::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIListTagsForResourceResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIListTagsForResourceResponse::is_status_Valid() const{
