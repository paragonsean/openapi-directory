...
#ifndef OAIUploadSettings_H
#define OAIUploadSettings_H
...
class OAIUploadSettings : public OAIObject {
public:
    OAIUploadSettings();
    OAIUploadSettings(QString json);
    ~OAIUploadSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadSettings)

#endif // OAIUploadSettings_H
