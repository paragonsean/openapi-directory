...
/*
 * OAIDynamicDefaultValue_UserNameColumn.h
 *
 * 
 */

#ifndef OAIDynamicDefaultValue_UserNameColumn_H
#define OAIDynamicDefaultValue_UserNameColumn_H
...
class OAIDynamicDefaultValue_UserNameColumn : public OAIObject {
public:
    OAIDynamicDefaultValue_UserNameColumn();
    OAIDynamicDefaultValue_UserNameColumn(QString json);
    ~OAIDynamicDefaultValue_UserNameColumn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDynamicDefaultValue_UserNameColumn)

#endif // OAIDynamicDefaultValue_UserNameColumn_H
