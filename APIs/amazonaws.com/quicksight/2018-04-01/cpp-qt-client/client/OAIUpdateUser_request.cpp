...
QString OAIUpdateUser_request::getRole() const {
    return m_role;
}
void OAIUpdateUser_request::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIUpdateUser_request::is_role_Set() const{
    return m_role_isSet;
}

bool OAIUpdateUser_request::is_role_Valid() const{
    return m_role_isValid;
}

QString OAIUpdateUser_request::getCustomPermissionsName() const {
    return m_custom_permissions_name;
}
void OAIUpdateUser_request::setCustomPermissionsName(const QString &custom_permissions_name) {
    m_custom_permissions_name = custom_permissions_name;
    m_custom_permissions_name_isSet = true;
}

bool OAIUpdateUser_request::is_custom_permissions_name_Set() const{
    return m_custom_permissions_name_isSet;
}

bool OAIUpdateUser_request::is_custom_permissions_name_Valid() const{
    return m_custom_permissions_name_isValid;
}

bool OAIUpdateUser_request::isUnapplyCustomPermissions() const {
    return m_unapply_custom_permissions;
}
void OAIUpdateUser_request::setUnapplyCustomPermissions(const bool &unapply_custom_permissions) {
    m_unapply_custom_permissions = unapply_custom_permissions;
    m_unapply_custom_permissions_isSet = true;
}

bool OAIUpdateUser_request::is_unapply_custom_permissions_Set() const{
    return m_unapply_custom_permissions_isSet;
}

bool OAIUpdateUser_request::is_unapply_custom_permissions_Valid() const{
    return m_unapply_custom_permissions_isValid;
}

QString OAIUpdateUser_request::getExternalLoginFederationProviderType() const {
    return m_external_login_federation_provider_type;
}
void OAIUpdateUser_request::setExternalLoginFederationProviderType(const QString &external_login_federation_provider_type) {
...
bool OAIUpdateUser_request::is_external_login_federation_provider_type_Set() const{
    return m_external_login_federation_provider_type_isSet;
}

bool OAIUpdateUser_request::is_external_login_federation_provider_type_Valid() const{
    return m_external_login_federation_provider_type_isValid;
}

QString OAIUpdateUser_request::getCustomFederationProviderUrl() const {
    return m_custom_federation_provider_url;
}
void OAIUpdateUser_request::setCustomFederationProviderUrl(const QString &custom_federation_provider_url) {
    m_custom_federation_provider_url = custom_federation_provider_url;
    m_custom_federation_provider_url_isSet = true;
}

bool OAIUpdateUser_request::is_custom_federation_provider_url_Set() const{
    return m_custom_federation_provider_url_isSet;
}

bool OAIUpdateUser_request::is_custom_federation_provider_url_Valid() const{
    return m_custom_federation_provider_url_isValid;
}

QString OAIUpdateUser_request::getExternalLoginId() const {
    return m_external_login_id;
}
void OAIUpdateUser_request::setExternalLoginId(const QString &external_login_id) {
    m_external_login_id = external_login_id;
    m_external_login_id_isSet = true;
}

bool OAIUpdateUser_request::is_external_login_id_Set() const{
    return m_external_login_id_isSet;
}

bool OAIUpdateUser_request::is_external_login_id_Valid() const{
