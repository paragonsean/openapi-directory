...
/*
 * OAIGaugeChartPrimaryValueConditionalFormatting.h
 *
 * The conditional formatting for the primary value of a &lt;code&gt;GaugeChartVisual&lt;/code&gt;.
 */

#ifndef OAIGaugeChartPrimaryValueConditionalFormatting_H
#define OAIGaugeChartPrimaryValueConditionalFormatting_H
...
class OAIGaugeChartPrimaryValueConditionalFormatting : public OAIObject {
public:
    OAIGaugeChartPrimaryValueConditionalFormatting();
    OAIGaugeChartPrimaryValueConditionalFormatting(QString json);
    ~OAIGaugeChartPrimaryValueConditionalFormatting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartPrimaryValueConditionalFormatting)

#endif // OAIGaugeChartPrimaryValueConditionalFormatting_H
