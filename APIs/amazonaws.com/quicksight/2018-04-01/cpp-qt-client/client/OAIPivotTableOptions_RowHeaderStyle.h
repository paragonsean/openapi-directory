...
/*
 * OAIPivotTableOptions_RowHeaderStyle.h
 *
 * 
 */

#ifndef OAIPivotTableOptions_RowHeaderStyle_H
#define OAIPivotTableOptions_RowHeaderStyle_H
...
class OAIPivotTableOptions_RowHeaderStyle : public OAIObject {
public:
    OAIPivotTableOptions_RowHeaderStyle();
    OAIPivotTableOptions_RowHeaderStyle(QString json);
    ~OAIPivotTableOptions_RowHeaderStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableOptions_RowHeaderStyle)

#endif // OAIPivotTableOptions_RowHeaderStyle_H
