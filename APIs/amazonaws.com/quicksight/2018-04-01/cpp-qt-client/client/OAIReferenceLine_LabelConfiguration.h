...
/*
 * OAIReferenceLine_LabelConfiguration.h
 *
 * 
 */

#ifndef OAIReferenceLine_LabelConfiguration_H
#define OAIReferenceLine_LabelConfiguration_H
...
class OAIReferenceLine_LabelConfiguration : public OAIObject {
public:
    OAIReferenceLine_LabelConfiguration();
    OAIReferenceLine_LabelConfiguration(QString json);
    ~OAIReferenceLine_LabelConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceLine_LabelConfiguration)

#endif // OAIReferenceLine_LabelConfiguration_H
