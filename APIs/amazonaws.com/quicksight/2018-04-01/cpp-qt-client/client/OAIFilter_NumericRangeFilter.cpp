...
OAIFilter_NumericRangeFilter::OAIFilter_NumericRangeFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilter_NumericRangeFilter::OAIFilter_NumericRangeFilter() {
    this->initializeModel();
}

OAIFilter_NumericRangeFilter::~OAIFilter_NumericRangeFilter() {}

void OAIFilter_NumericRangeFilter::initializeModel() {
...
void OAIFilter_NumericRangeFilter::fromJson(QString jsonString) {
...
void OAIFilter_NumericRangeFilter::fromJsonObject(QJsonObject json) {
...
QString OAIFilter_NumericRangeFilter::asJson() const {
...
QJsonObject OAIFilter_NumericRangeFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFilter_NumericRangeFilter::getFilterId() const {
    return m_filter_id;
}
void OAIFilter_NumericRangeFilter::setFilterId(const QString &filter_id) {
    m_filter_id = filter_id;
    m_filter_id_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_filter_id_Set() const{
    return m_filter_id_isSet;
}

bool OAIFilter_NumericRangeFilter::is_filter_id_Valid() const{
    return m_filter_id_isValid;
}

OAICategoryDrillDownFilter_Column OAIFilter_NumericRangeFilter::getColumn() const {
    return m_column;
}
void OAIFilter_NumericRangeFilter::setColumn(const OAICategoryDrillDownFilter_Column &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_column_Set() const{
    return m_column_isSet;
}

bool OAIFilter_NumericRangeFilter::is_column_Valid() const{
    return m_column_isValid;
}

bool OAIFilter_NumericRangeFilter::getIncludeMinimum() const {
    return m_include_minimum;
}
void OAIFilter_NumericRangeFilter::setIncludeMinimum(const bool &include_minimum) {
    m_include_minimum = include_minimum;
    m_include_minimum_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_include_minimum_Set() const{
    return m_include_minimum_isSet;
}

bool OAIFilter_NumericRangeFilter::is_include_minimum_Valid() const{
    return m_include_minimum_isValid;
}

bool OAIFilter_NumericRangeFilter::getIncludeMaximum() const {
    return m_include_maximum;
}
void OAIFilter_NumericRangeFilter::setIncludeMaximum(const bool &include_maximum) {
    m_include_maximum = include_maximum;
    m_include_maximum_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_include_maximum_Set() const{
    return m_include_maximum_isSet;
}

bool OAIFilter_NumericRangeFilter::is_include_maximum_Valid() const{
    return m_include_maximum_isValid;
}

OAINumericRangeFilter_RangeMinimum OAIFilter_NumericRangeFilter::getRangeMinimum() const {
    return m_range_minimum;
}
void OAIFilter_NumericRangeFilter::setRangeMinimum(const OAINumericRangeFilter_RangeMinimum &range_minimum) {
    m_range_minimum = range_minimum;
    m_range_minimum_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_range_minimum_Set() const{
    return m_range_minimum_isSet;
}

bool OAIFilter_NumericRangeFilter::is_range_minimum_Valid() const{
    return m_range_minimum_isValid;
}

OAINumericRangeFilter_RangeMaximum OAIFilter_NumericRangeFilter::getRangeMaximum() const {
    return m_range_maximum;
}
void OAIFilter_NumericRangeFilter::setRangeMaximum(const OAINumericRangeFilter_RangeMaximum &range_maximum) {
    m_range_maximum = range_maximum;
    m_range_maximum_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_range_maximum_Set() const{
    return m_range_maximum_isSet;
}

bool OAIFilter_NumericRangeFilter::is_range_maximum_Valid() const{
    return m_range_maximum_isValid;
}

OAINumericFilterSelectAllOptions OAIFilter_NumericRangeFilter::getSelectAllOptions() const {
    return m_select_all_options;
}
void OAIFilter_NumericRangeFilter::setSelectAllOptions(const OAINumericFilterSelectAllOptions &select_all_options) {
    m_select_all_options = select_all_options;
    m_select_all_options_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_select_all_options_Set() const{
    return m_select_all_options_isSet;
}

bool OAIFilter_NumericRangeFilter::is_select_all_options_Valid() const{
    return m_select_all_options_isValid;
}

OAINumericRangeFilter_AggregationFunction OAIFilter_NumericRangeFilter::getAggregationFunction() const {
    return m_aggregation_function;
}
void OAIFilter_NumericRangeFilter::setAggregationFunction(const OAINumericRangeFilter_AggregationFunction &aggregation_function) {
    m_aggregation_function = aggregation_function;
    m_aggregation_function_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_aggregation_function_Set() const{
    return m_aggregation_function_isSet;
}

bool OAIFilter_NumericRangeFilter::is_aggregation_function_Valid() const{
    return m_aggregation_function_isValid;
}

OAIFilterNullOption OAIFilter_NumericRangeFilter::getNullOption() const {
    return m_null_option;
}
void OAIFilter_NumericRangeFilter::setNullOption(const OAIFilterNullOption &null_option) {
    m_null_option = null_option;
    m_null_option_isSet = true;
}

bool OAIFilter_NumericRangeFilter::is_null_option_Set() const{
    return m_null_option_isSet;
}

bool OAIFilter_NumericRangeFilter::is_null_option_Valid() const{
    return m_null_option_isValid;
}

bool OAIFilter_NumericRangeFilter::isSet() const {
...
bool OAIFilter_NumericRangeFilter::isValid() const {
