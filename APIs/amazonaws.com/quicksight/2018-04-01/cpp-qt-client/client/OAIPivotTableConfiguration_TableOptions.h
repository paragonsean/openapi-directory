...
/*
 * OAIPivotTableConfiguration_TableOptions.h
 *
 * 
 */

#ifndef OAIPivotTableConfiguration_TableOptions_H
#define OAIPivotTableConfiguration_TableOptions_H
...
class OAIPivotTableConfiguration_TableOptions : public OAIObject {
public:
    OAIPivotTableConfiguration_TableOptions();
    OAIPivotTableConfiguration_TableOptions(QString json);
    ~OAIPivotTableConfiguration_TableOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableConfiguration_TableOptions)

#endif // OAIPivotTableConfiguration_TableOptions_H
