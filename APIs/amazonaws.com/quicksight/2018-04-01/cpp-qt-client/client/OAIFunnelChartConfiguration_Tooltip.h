...
/*
 * OAIFunnelChartConfiguration_Tooltip.h
 *
 * 
 */

#ifndef OAIFunnelChartConfiguration_Tooltip_H
#define OAIFunnelChartConfiguration_Tooltip_H
...
class OAIFunnelChartConfiguration_Tooltip : public OAIObject {
public:
    OAIFunnelChartConfiguration_Tooltip();
    OAIFunnelChartConfiguration_Tooltip(QString json);
    ~OAIFunnelChartConfiguration_Tooltip() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFunnelChartConfiguration_Tooltip)

#endif // OAIFunnelChartConfiguration_Tooltip_H
