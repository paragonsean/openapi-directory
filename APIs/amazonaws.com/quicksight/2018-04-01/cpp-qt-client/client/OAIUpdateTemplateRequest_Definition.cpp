...
OAIUpdateTemplateRequest_Definition::OAIUpdateTemplateRequest_Definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTemplateRequest_Definition::OAIUpdateTemplateRequest_Definition() {
    this->initializeModel();
}

OAIUpdateTemplateRequest_Definition::~OAIUpdateTemplateRequest_Definition() {}

void OAIUpdateTemplateRequest_Definition::initializeModel() {
...
void OAIUpdateTemplateRequest_Definition::fromJson(QString jsonString) {
...
void OAIUpdateTemplateRequest_Definition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTemplateRequest_Definition::asJson() const {
...
QJsonObject OAIUpdateTemplateRequest_Definition::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateTemplateRequest_Definition::getDataSetConfigurations() const {
    return m_data_set_configurations;
}
void OAIUpdateTemplateRequest_Definition::setDataSetConfigurations(const QList &data_set_configurations) {
    m_data_set_configurations = data_set_configurations;
    m_data_set_configurations_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_data_set_configurations_Set() const{
    return m_data_set_configurations_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_data_set_configurations_Valid() const{
    return m_data_set_configurations_isValid;
}

QList OAIUpdateTemplateRequest_Definition::getSheets() const {
    return m_sheets;
}
void OAIUpdateTemplateRequest_Definition::setSheets(const QList &sheets) {
    m_sheets = sheets;
    m_sheets_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_sheets_Set() const{
    return m_sheets_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_sheets_Valid() const{
    return m_sheets_isValid;
}

QList OAIUpdateTemplateRequest_Definition::getCalculatedFields() const {
    return m_calculated_fields;
}
void OAIUpdateTemplateRequest_Definition::setCalculatedFields(const QList &calculated_fields) {
    m_calculated_fields = calculated_fields;
    m_calculated_fields_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_calculated_fields_Set() const{
    return m_calculated_fields_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_calculated_fields_Valid() const{
    return m_calculated_fields_isValid;
}

QList OAIUpdateTemplateRequest_Definition::getParameterDeclarations() const {
    return m_parameter_declarations;
}
void OAIUpdateTemplateRequest_Definition::setParameterDeclarations(const QList &parameter_declarations) {
    m_parameter_declarations = parameter_declarations;
    m_parameter_declarations_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_parameter_declarations_Set() const{
    return m_parameter_declarations_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_parameter_declarations_Valid() const{
    return m_parameter_declarations_isValid;
}

QList OAIUpdateTemplateRequest_Definition::getFilterGroups() const {
    return m_filter_groups;
}
void OAIUpdateTemplateRequest_Definition::setFilterGroups(const QList &filter_groups) {
    m_filter_groups = filter_groups;
    m_filter_groups_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_filter_groups_Set() const{
    return m_filter_groups_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_filter_groups_Valid() const{
    return m_filter_groups_isValid;
}

QList OAIUpdateTemplateRequest_Definition::getColumnConfigurations() const {
    return m_column_configurations;
}
void OAIUpdateTemplateRequest_Definition::setColumnConfigurations(const QList &column_configurations) {
    m_column_configurations = column_configurations;
    m_column_configurations_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_column_configurations_Set() const{
    return m_column_configurations_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_column_configurations_Valid() const{
    return m_column_configurations_isValid;
}

OAIAnalysisDefaults OAIUpdateTemplateRequest_Definition::getAnalysisDefaults() const {
    return m_analysis_defaults;
}
void OAIUpdateTemplateRequest_Definition::setAnalysisDefaults(const OAIAnalysisDefaults &analysis_defaults) {
    m_analysis_defaults = analysis_defaults;
    m_analysis_defaults_isSet = true;
}

bool OAIUpdateTemplateRequest_Definition::is_analysis_defaults_Set() const{
    return m_analysis_defaults_isSet;
}

bool OAIUpdateTemplateRequest_Definition::is_analysis_defaults_Valid() const{
    return m_analysis_defaults_isValid;
}

bool OAIUpdateTemplateRequest_Definition::isSet() const {
...
bool OAIUpdateTemplateRequest_Definition::isValid() const {
