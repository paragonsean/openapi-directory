...
/*
 * OAISemanticEntityType.h
 *
 * A structure that represents a semantic entity type.
 */

#ifndef OAISemanticEntityType_H
#define OAISemanticEntityType_H
...
class OAISemanticEntityType : public OAIObject {
public:
    OAISemanticEntityType();
    OAISemanticEntityType(QString json);
    ~OAISemanticEntityType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISemanticEntityType)

#endif // OAISemanticEntityType_H
