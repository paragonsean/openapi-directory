...
/*
 * OAIFilter_TimeEqualityFilter.h
 *
 * 
 */

#ifndef OAIFilter_TimeEqualityFilter_H
#define OAIFilter_TimeEqualityFilter_H
...
class OAIFilter_TimeEqualityFilter : public OAIObject {
public:
    OAIFilter_TimeEqualityFilter();
    OAIFilter_TimeEqualityFilter(QString json);
    ~OAIFilter_TimeEqualityFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilter_TimeEqualityFilter)

#endif // OAIFilter_TimeEqualityFilter_H
