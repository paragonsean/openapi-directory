...
/*
 * OAIDataLabelOptions_LabelFontConfiguration.h
 *
 * 
 */

#ifndef OAIDataLabelOptions_LabelFontConfiguration_H
#define OAIDataLabelOptions_LabelFontConfiguration_H
...
class OAIDataLabelOptions_LabelFontConfiguration : public OAIObject {
public:
    OAIDataLabelOptions_LabelFontConfiguration();
    OAIDataLabelOptions_LabelFontConfiguration(QString json);
    ~OAIDataLabelOptions_LabelFontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLabelOptions_LabelFontConfiguration)

#endif // OAIDataLabelOptions_LabelFontConfiguration_H
