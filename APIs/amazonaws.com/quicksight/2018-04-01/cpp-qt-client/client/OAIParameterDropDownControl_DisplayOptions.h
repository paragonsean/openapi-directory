...
/*
 * OAIParameterDropDownControl_DisplayOptions.h
 *
 * 
 */

#ifndef OAIParameterDropDownControl_DisplayOptions_H
#define OAIParameterDropDownControl_DisplayOptions_H
...
class OAIParameterDropDownControl_DisplayOptions : public OAIObject {
public:
    OAIParameterDropDownControl_DisplayOptions();
    OAIParameterDropDownControl_DisplayOptions(QString json);
    ~OAIParameterDropDownControl_DisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterDropDownControl_DisplayOptions)

#endif // OAIParameterDropDownControl_DisplayOptions_H
