...
OAIPivotTableTotalOptions_RowTotalOptions::OAIPivotTableTotalOptions_RowTotalOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPivotTableTotalOptions_RowTotalOptions::OAIPivotTableTotalOptions_RowTotalOptions() {
    this->initializeModel();
}

OAIPivotTableTotalOptions_RowTotalOptions::~OAIPivotTableTotalOptions_RowTotalOptions() {}

void OAIPivotTableTotalOptions_RowTotalOptions::initializeModel() {
...
void OAIPivotTableTotalOptions_RowTotalOptions::fromJson(QString jsonString) {
...
void OAIPivotTableTotalOptions_RowTotalOptions::fromJsonObject(QJsonObject json) {
...
QString OAIPivotTableTotalOptions_RowTotalOptions::asJson() const {
...
QJsonObject OAIPivotTableTotalOptions_RowTotalOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAIPivotTableTotalOptions_RowTotalOptions::getTotalsVisibility() const {
    return m_totals_visibility;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setTotalsVisibility(const OAIVisibility &totals_visibility) {
    m_totals_visibility = totals_visibility;
    m_totals_visibility_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_totals_visibility_Set() const{
    return m_totals_visibility_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_totals_visibility_Valid() const{
    return m_totals_visibility_isValid;
}

OAITableTotalsPlacement OAIPivotTableTotalOptions_RowTotalOptions::getPlacement() const {
    return m_placement;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setPlacement(const OAITableTotalsPlacement &placement) {
    m_placement = placement;
    m_placement_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_placement_Set() const{
    return m_placement_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_placement_Valid() const{
    return m_placement_isValid;
}

OAITableTotalsScrollStatus OAIPivotTableTotalOptions_RowTotalOptions::getScrollStatus() const {
    return m_scroll_status;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setScrollStatus(const OAITableTotalsScrollStatus &scroll_status) {
    m_scroll_status = scroll_status;
    m_scroll_status_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_scroll_status_Set() const{
    return m_scroll_status_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_scroll_status_Valid() const{
    return m_scroll_status_isValid;
}

QString OAIPivotTableTotalOptions_RowTotalOptions::getCustomLabel() const {
    return m_custom_label;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setCustomLabel(const QString &custom_label) {
    m_custom_label = custom_label;
    m_custom_label_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_custom_label_Set() const{
    return m_custom_label_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_custom_label_Valid() const{
    return m_custom_label_isValid;
}

OAIPivotTotalOptions_TotalCellStyle OAIPivotTableTotalOptions_RowTotalOptions::getTotalCellStyle() const {
    return m_total_cell_style;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setTotalCellStyle(const OAIPivotTotalOptions_TotalCellStyle &total_cell_style) {
    m_total_cell_style = total_cell_style;
    m_total_cell_style_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_total_cell_style_Set() const{
    return m_total_cell_style_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_total_cell_style_Valid() const{
    return m_total_cell_style_isValid;
}

OAIPivotTotalOptions_ValueCellStyle OAIPivotTableTotalOptions_RowTotalOptions::getValueCellStyle() const {
    return m_value_cell_style;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setValueCellStyle(const OAIPivotTotalOptions_ValueCellStyle &value_cell_style) {
    m_value_cell_style = value_cell_style;
    m_value_cell_style_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_value_cell_style_Set() const{
    return m_value_cell_style_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_value_cell_style_Valid() const{
    return m_value_cell_style_isValid;
}

OAIPivotTotalOptions_MetricHeaderCellStyle OAIPivotTableTotalOptions_RowTotalOptions::getMetricHeaderCellStyle() const {
    return m_metric_header_cell_style;
}
void OAIPivotTableTotalOptions_RowTotalOptions::setMetricHeaderCellStyle(const OAIPivotTotalOptions_MetricHeaderCellStyle &metric_header_cell_style) {
    m_metric_header_cell_style = metric_header_cell_style;
    m_metric_header_cell_style_isSet = true;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_metric_header_cell_style_Set() const{
    return m_metric_header_cell_style_isSet;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::is_metric_header_cell_style_Valid() const{
    return m_metric_header_cell_style_isValid;
}

bool OAIPivotTableTotalOptions_RowTotalOptions::isSet() const {
...
bool OAIPivotTableTotalOptions_RowTotalOptions::isValid() const {
