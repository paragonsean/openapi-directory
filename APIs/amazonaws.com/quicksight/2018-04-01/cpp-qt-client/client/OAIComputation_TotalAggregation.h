...
/*
 * OAIComputation_TotalAggregation.h
 *
 * 
 */

#ifndef OAIComputation_TotalAggregation_H
#define OAIComputation_TotalAggregation_H
...
class OAIComputation_TotalAggregation : public OAIObject {
public:
    OAIComputation_TotalAggregation();
    OAIComputation_TotalAggregation(QString json);
    ~OAIComputation_TotalAggregation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_TotalAggregation)

#endif // OAIComputation_TotalAggregation_H
