...
/*
 * OAIFontConfiguration.h
 *
 * Configures the display properties of the given text.
 */

#ifndef OAIFontConfiguration_H
#define OAIFontConfiguration_H
...
class OAIFontConfiguration : public OAIObject {
public:
    OAIFontConfiguration();
    OAIFontConfiguration(QString json);
    ~OAIFontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFontConfiguration)

#endif // OAIFontConfiguration_H
