...
#include "OAILineChartMarkerStyleSettings.h"
...
OAILineChartMarkerStyleSettings::OAILineChartMarkerStyleSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineChartMarkerStyleSettings::OAILineChartMarkerStyleSettings() {
    this->initializeModel();
}

OAILineChartMarkerStyleSettings::~OAILineChartMarkerStyleSettings() {}

void OAILineChartMarkerStyleSettings::initializeModel() {
...
void OAILineChartMarkerStyleSettings::fromJson(QString jsonString) {
...
void OAILineChartMarkerStyleSettings::fromJsonObject(QJsonObject json) {
...
QString OAILineChartMarkerStyleSettings::asJson() const {
...
QJsonObject OAILineChartMarkerStyleSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAILineChartMarkerStyleSettings::getMarkerVisibility() const {
    return m_marker_visibility;
}
void OAILineChartMarkerStyleSettings::setMarkerVisibility(const OAIVisibility &marker_visibility) {
    m_marker_visibility = marker_visibility;
    m_marker_visibility_isSet = true;
}

bool OAILineChartMarkerStyleSettings::is_marker_visibility_Set() const{
    return m_marker_visibility_isSet;
}

bool OAILineChartMarkerStyleSettings::is_marker_visibility_Valid() const{
    return m_marker_visibility_isValid;
}

OAILineChartMarkerShape OAILineChartMarkerStyleSettings::getMarkerShape() const {
    return m_marker_shape;
}
void OAILineChartMarkerStyleSettings::setMarkerShape(const OAILineChartMarkerShape &marker_shape) {
    m_marker_shape = marker_shape;
    m_marker_shape_isSet = true;
}

bool OAILineChartMarkerStyleSettings::is_marker_shape_Set() const{
    return m_marker_shape_isSet;
}

bool OAILineChartMarkerStyleSettings::is_marker_shape_Valid() const{
    return m_marker_shape_isValid;
}

QString OAILineChartMarkerStyleSettings::getMarkerSize() const {
    return m_marker_size;
}
void OAILineChartMarkerStyleSettings::setMarkerSize(const QString &marker_size) {
    m_marker_size = marker_size;
    m_marker_size_isSet = true;
}

bool OAILineChartMarkerStyleSettings::is_marker_size_Set() const{
    return m_marker_size_isSet;
}

bool OAILineChartMarkerStyleSettings::is_marker_size_Valid() const{
    return m_marker_size_isValid;
}

QString OAILineChartMarkerStyleSettings::getMarkerColor() const {
    return m_marker_color;
}
void OAILineChartMarkerStyleSettings::setMarkerColor(const QString &marker_color) {
    m_marker_color = marker_color;
    m_marker_color_isSet = true;
}

bool OAILineChartMarkerStyleSettings::is_marker_color_Set() const{
    return m_marker_color_isSet;
}

bool OAILineChartMarkerStyleSettings::is_marker_color_Valid() const{
    return m_marker_color_isValid;
}

bool OAILineChartMarkerStyleSettings::isSet() const {
...
bool OAILineChartMarkerStyleSettings::isValid() const {
