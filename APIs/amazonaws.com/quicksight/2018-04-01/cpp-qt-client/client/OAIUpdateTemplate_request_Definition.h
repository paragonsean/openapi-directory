...
/*
 * OAIUpdateTemplate_request_Definition.h
 *
 * The detailed definition of a template.
 */

#ifndef OAIUpdateTemplate_request_Definition_H
#define OAIUpdateTemplate_request_Definition_H
...
class OAIUpdateTemplate_request_Definition : public OAIObject {
public:
    OAIUpdateTemplate_request_Definition();
    OAIUpdateTemplate_request_Definition(QString json);
    ~OAIUpdateTemplate_request_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTemplate_request_Definition)

#endif // OAIUpdateTemplate_request_Definition_H
