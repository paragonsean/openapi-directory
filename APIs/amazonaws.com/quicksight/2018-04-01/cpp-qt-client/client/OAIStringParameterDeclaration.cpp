...
#include "OAIStringParameterDeclaration.h"
...
OAIStringParameterDeclaration::OAIStringParameterDeclaration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStringParameterDeclaration::OAIStringParameterDeclaration() {
    this->initializeModel();
}

OAIStringParameterDeclaration::~OAIStringParameterDeclaration() {}

void OAIStringParameterDeclaration::initializeModel() {
...
void OAIStringParameterDeclaration::fromJson(QString jsonString) {
...
void OAIStringParameterDeclaration::fromJsonObject(QJsonObject json) {
...
QString OAIStringParameterDeclaration::asJson() const {
...
QJsonObject OAIStringParameterDeclaration::asJsonObject() const {
    QJsonObject obj;
...
OAIParameterValueType OAIStringParameterDeclaration::getParameterValueType() const {
    return m_parameter_value_type;
}
void OAIStringParameterDeclaration::setParameterValueType(const OAIParameterValueType &parameter_value_type) {
    m_parameter_value_type = parameter_value_type;
    m_parameter_value_type_isSet = true;
}

bool OAIStringParameterDeclaration::is_parameter_value_type_Set() const{
    return m_parameter_value_type_isSet;
}

bool OAIStringParameterDeclaration::is_parameter_value_type_Valid() const{
    return m_parameter_value_type_isValid;
}

QString OAIStringParameterDeclaration::getName() const {
    return m_name;
}
void OAIStringParameterDeclaration::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStringParameterDeclaration::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStringParameterDeclaration::is_name_Valid() const{
    return m_name_isValid;
}

OAIStringParameterDeclaration_DefaultValues OAIStringParameterDeclaration::getDefaultValues() const {
    return m_default_values;
}
void OAIStringParameterDeclaration::setDefaultValues(const OAIStringParameterDeclaration_DefaultValues &default_values) {
    m_default_values = default_values;
    m_default_values_isSet = true;
}

bool OAIStringParameterDeclaration::is_default_values_Set() const{
    return m_default_values_isSet;
}

bool OAIStringParameterDeclaration::is_default_values_Valid() const{
    return m_default_values_isValid;
}

OAIStringParameterDeclaration_ValueWhenUnset OAIStringParameterDeclaration::getValueWhenUnset() const {
    return m_value_when_unset;
}
void OAIStringParameterDeclaration::setValueWhenUnset(const OAIStringParameterDeclaration_ValueWhenUnset &value_when_unset) {
    m_value_when_unset = value_when_unset;
    m_value_when_unset_isSet = true;
}

bool OAIStringParameterDeclaration::is_value_when_unset_Set() const{
    return m_value_when_unset_isSet;
}

bool OAIStringParameterDeclaration::is_value_when_unset_Valid() const{
    return m_value_when_unset_isValid;
}

QList<OAIMappedDataSetParameter> OAIStringParameterDeclaration::getMappedDataSetParameters() const {
    return m_mapped_data_set_parameters;
}
void OAIStringParameterDeclaration::setMappedDataSetParameters(const QList<OAIMappedDataSetParameter> &mapped_data_set_parameters) {
    m_mapped_data_set_parameters = mapped_data_set_parameters;
    m_mapped_data_set_parameters_isSet = true;
}

bool OAIStringParameterDeclaration::is_mapped_data_set_parameters_Set() const{
    return m_mapped_data_set_parameters_isSet;
}

bool OAIStringParameterDeclaration::is_mapped_data_set_parameters_Valid() const{
    return m_mapped_data_set_parameters_isValid;
}

bool OAIStringParameterDeclaration::isSet() const {
...
bool OAIStringParameterDeclaration::isValid() const {
