...
public:
    ...
    OAIVPCConnectionResourceStatus getCreationStatus() const;
    void setCreationStatus(const OAIVPCConnectionResourceStatus &creation_status);
...
private:
    ...
    OAIVPCConnectionResourceStatus m_creation_status;
