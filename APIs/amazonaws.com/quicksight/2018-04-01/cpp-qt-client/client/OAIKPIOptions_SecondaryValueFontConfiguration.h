...
/*
 * OAIKPIOptions_SecondaryValueFontConfiguration.h
 *
 * 
 */

#ifndef OAIKPIOptions_SecondaryValueFontConfiguration_H
#define OAIKPIOptions_SecondaryValueFontConfiguration_H
...
class OAIKPIOptions_SecondaryValueFontConfiguration : public OAIObject {
public:
    OAIKPIOptions_SecondaryValueFontConfiguration();
    OAIKPIOptions_SecondaryValueFontConfiguration(QString json);
    ~OAIKPIOptions_SecondaryValueFontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKPIOptions_SecondaryValueFontConfiguration)

#endif // OAIKPIOptions_SecondaryValueFontConfiguration_H
