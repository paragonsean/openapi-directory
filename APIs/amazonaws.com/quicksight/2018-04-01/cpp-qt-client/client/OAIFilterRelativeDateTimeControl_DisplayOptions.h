...
/*
 * OAIFilterRelativeDateTimeControl_DisplayOptions.h
 *
 * 
 */

#ifndef OAIFilterRelativeDateTimeControl_DisplayOptions_H
#define OAIFilterRelativeDateTimeControl_DisplayOptions_H
...
class OAIFilterRelativeDateTimeControl_DisplayOptions : public OAIObject {
public:
    OAIFilterRelativeDateTimeControl_DisplayOptions();
    OAIFilterRelativeDateTimeControl_DisplayOptions(QString json);
    ~OAIFilterRelativeDateTimeControl_DisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterRelativeDateTimeControl_DisplayOptions)

#endif // OAIFilterRelativeDateTimeControl_DisplayOptions_H
