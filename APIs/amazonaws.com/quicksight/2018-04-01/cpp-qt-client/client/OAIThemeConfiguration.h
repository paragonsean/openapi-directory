...
/*
 * OAIThemeConfiguration.h
 *
 * The theme configuration. This configuration contains all of the display properties for a theme.
 */

#ifndef OAIThemeConfiguration_H
#define OAIThemeConfiguration_H
...
class OAIThemeConfiguration : public OAIObject {
public:
    OAIThemeConfiguration();
    OAIThemeConfiguration(QString json);
    ~OAIThemeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThemeConfiguration)

#endif // OAIThemeConfiguration_H
