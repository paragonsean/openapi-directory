...
/*
 * OAIDescribeVPCConnectionResponse_VPCConnection.h
 *
 * 
 */

#ifndef OAIDescribeVPCConnectionResponse_VPCConnection_H
#define OAIDescribeVPCConnectionResponse_VPCConnection_H
...
class OAIDescribeVPCConnectionResponse_VPCConnection : public OAIObject {
public:
    OAIDescribeVPCConnectionResponse_VPCConnection();
    OAIDescribeVPCConnectionResponse_VPCConnection(QString json);
    ~OAIDescribeVPCConnectionResponse_VPCConnection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVPCConnectionResponse_VPCConnection)

#endif // OAIDescribeVPCConnectionResponse_VPCConnection_H
