...
OAISmallMultiplesOptions_PanelConfiguration::OAISmallMultiplesOptions_PanelConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISmallMultiplesOptions_PanelConfiguration::OAISmallMultiplesOptions_PanelConfiguration() {
    this->initializeModel();
}

OAISmallMultiplesOptions_PanelConfiguration::~OAISmallMultiplesOptions_PanelConfiguration() {}

void OAISmallMultiplesOptions_PanelConfiguration::initializeModel() {
...
void OAISmallMultiplesOptions_PanelConfiguration::fromJson(QString jsonString) {
...
void OAISmallMultiplesOptions_PanelConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAISmallMultiplesOptions_PanelConfiguration::asJson() const {
...
QJsonObject OAISmallMultiplesOptions_PanelConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_title.isSet()) {
...
OAIPanelConfiguration_Title OAISmallMultiplesOptions_PanelConfiguration::getTitle() const {
    return m_title;
}
void OAISmallMultiplesOptions_PanelConfiguration::setTitle(const OAIPanelConfiguration_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_title_Set() const{
    return m_title_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_title_Valid() const{
    return m_title_isValid;
}

OAIVisibility OAISmallMultiplesOptions_PanelConfiguration::getBorderVisibility() const {
    return m_border_visibility;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBorderVisibility(const OAIVisibility &border_visibility) {
    m_border_visibility = border_visibility;
    m_border_visibility_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_visibility_Set() const{
    return m_border_visibility_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_visibility_Valid() const{
    return m_border_visibility_isValid;
}

QString OAISmallMultiplesOptions_PanelConfiguration::getBorderThickness() const {
    return m_border_thickness;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBorderThickness(const QString &border_thickness) {
    m_border_thickness = border_thickness;
    m_border_thickness_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_thickness_Set() const{
    return m_border_thickness_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_thickness_Valid() const{
    return m_border_thickness_isValid;
}

OAIPanelBorderStyle OAISmallMultiplesOptions_PanelConfiguration::getBorderStyle() const {
    return m_border_style;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBorderStyle(const OAIPanelBorderStyle &border_style) {
    m_border_style = border_style;
    m_border_style_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_style_Set() const{
    return m_border_style_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_style_Valid() const{
    return m_border_style_isValid;
}

QString OAISmallMultiplesOptions_PanelConfiguration::getBorderColor() const {
    return m_border_color;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBorderColor(const QString &border_color) {
    m_border_color = border_color;
    m_border_color_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_color_Set() const{
    return m_border_color_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_border_color_Valid() const{
    return m_border_color_isValid;
}

OAIVisibility OAISmallMultiplesOptions_PanelConfiguration::getGutterVisibility() const {
    return m_gutter_visibility;
}
void OAISmallMultiplesOptions_PanelConfiguration::setGutterVisibility(const OAIVisibility &gutter_visibility) {
    m_gutter_visibility = gutter_visibility;
    m_gutter_visibility_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_gutter_visibility_Set() const{
    return m_gutter_visibility_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_gutter_visibility_Valid() const{
    return m_gutter_visibility_isValid;
}

QString OAISmallMultiplesOptions_PanelConfiguration::getGutterSpacing() const {
    return m_gutter_spacing;
}
void OAISmallMultiplesOptions_PanelConfiguration::setGutterSpacing(const QString &gutter_spacing) {
    m_gutter_spacing = gutter_spacing;
    m_gutter_spacing_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_gutter_spacing_Set() const{
    return m_gutter_spacing_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_gutter_spacing_Valid() const{
    return m_gutter_spacing_isValid;
}

OAIVisibility OAISmallMultiplesOptions_PanelConfiguration::getBackgroundVisibility() const {
    return m_background_visibility;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBackgroundVisibility(const OAIVisibility &background_visibility) {
    m_background_visibility = background_visibility;
    m_background_visibility_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_background_visibility_Set() const{
    return m_background_visibility_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_background_visibility_Valid() const{
    return m_background_visibility_isValid;
}

QString OAISmallMultiplesOptions_PanelConfiguration::getBackgroundColor() const {
    return m_background_color;
}
void OAISmallMultiplesOptions_PanelConfiguration::setBackgroundColor(const QString &background_color) {
    m_background_color = background_color;
    m_background_color_isSet = true;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_background_color_Set() const{
    return m_background_color_isSet;
}

bool OAISmallMultiplesOptions_PanelConfiguration::is_background_color_Valid() const{
    return m_background_color_isValid;
}

bool OAISmallMultiplesOptions_PanelConfiguration::isSet() const {
...
bool OAISmallMultiplesOptions_PanelConfiguration::isValid() const {
