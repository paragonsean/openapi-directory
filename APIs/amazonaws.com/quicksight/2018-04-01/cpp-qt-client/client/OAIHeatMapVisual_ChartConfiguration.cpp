...
OAIHeatMapVisual_ChartConfiguration::OAIHeatMapVisual_ChartConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHeatMapVisual_ChartConfiguration::OAIHeatMapVisual_ChartConfiguration() {
    this->initializeModel();
}

OAIHeatMapVisual_ChartConfiguration::~OAIHeatMapVisual_ChartConfiguration() {}

void OAIHeatMapVisual_ChartConfiguration::initializeModel() {
...
void OAIHeatMapVisual_ChartConfiguration::fromJson(QString jsonString) {
...
void OAIHeatMapVisual_ChartConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIHeatMapVisual_ChartConfiguration::asJson() const {
...
QJsonObject OAIHeatMapVisual_ChartConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIHeatMapConfiguration_FieldWells OAIHeatMapVisual_ChartConfiguration::getFieldWells() const {
    return m_field_wells;
}
void OAIHeatMapVisual_ChartConfiguration::setFieldWells(const OAIHeatMapConfiguration_FieldWells &field_wells) {
    m_field_wells = field_wells;
    m_field_wells_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_field_wells_Set() const{
    return m_field_wells_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_field_wells_Valid() const{
    return m_field_wells_isValid;
}

OAIHeatMapConfiguration_SortConfiguration OAIHeatMapVisual_ChartConfiguration::getSortConfiguration() const {
    return m_sort_configuration;
}
void OAIHeatMapVisual_ChartConfiguration::setSortConfiguration(const OAIHeatMapConfiguration_SortConfiguration &sort_configuration) {
    m_sort_configuration = sort_configuration;
    m_sort_configuration_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_sort_configuration_Set() const{
    return m_sort_configuration_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_sort_configuration_Valid() const{
    return m_sort_configuration_isValid;
}

OAIHeatMapConfiguration_RowLabelOptions OAIHeatMapVisual_ChartConfiguration::getRowLabelOptions() const {
    return m_row_label_options;
}
void OAIHeatMapVisual_ChartConfiguration::setRowLabelOptions(const OAIHeatMapConfiguration_RowLabelOptions &row_label_options) {
    m_row_label_options = row_label_options;
    m_row_label_options_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_row_label_options_Set() const{
    return m_row_label_options_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_row_label_options_Valid() const{
    return m_row_label_options_isValid;
}

OAIHeatMapConfiguration_ColumnLabelOptions OAIHeatMapVisual_ChartConfiguration::getColumnLabelOptions() const {
    return m_column_label_options;
}
void OAIHeatMapVisual_ChartConfiguration::setColumnLabelOptions(const OAIHeatMapConfiguration_ColumnLabelOptions &column_label_options) {
    m_column_label_options = column_label_options;
    m_column_label_options_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_column_label_options_Set() const{
    return m_column_label_options_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_column_label_options_Valid() const{
    return m_column_label_options_isValid;
}

OAIHeatMapConfiguration_ColorScale OAIHeatMapVisual_ChartConfiguration::getColorScale() const {
    return m_color_scale;
}
void OAIHeatMapVisual_ChartConfiguration::setColorScale(const OAIHeatMapConfiguration_ColorScale &color_scale) {
    m_color_scale = color_scale;
    m_color_scale_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_color_scale_Set() const{
    return m_color_scale_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_color_scale_Valid() const{
    return m_color_scale_isValid;
}

OAIBarChartConfiguration_Legend OAIHeatMapVisual_ChartConfiguration::getLegend() const {
    return m_legend;
}
void OAIHeatMapVisual_ChartConfiguration::setLegend(const OAIBarChartConfiguration_Legend &legend) {
    m_legend = legend;
    m_legend_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_legend_Set() const{
    return m_legend_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_legend_Valid() const{
    return m_legend_isValid;
}

OAIBarChartConfiguration_DataLabels OAIHeatMapVisual_ChartConfiguration::getDataLabels() const {
    return m_data_labels;
}
void OAIHeatMapVisual_ChartConfiguration::setDataLabels(const OAIBarChartConfiguration_DataLabels &data_labels) {
    m_data_labels = data_labels;
    m_data_labels_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_data_labels_Set() const{
    return m_data_labels_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_data_labels_Valid() const{
    return m_data_labels_isValid;
}

OAIBarChartConfiguration_Tooltip OAIHeatMapVisual_ChartConfiguration::getTooltip() const {
    return m_tooltip;
}
void OAIHeatMapVisual_ChartConfiguration::setTooltip(const OAIBarChartConfiguration_Tooltip &tooltip) {
    m_tooltip = tooltip;
    m_tooltip_isSet = true;
}

bool OAIHeatMapVisual_ChartConfiguration::is_tooltip_Set() const{
    return m_tooltip_isSet;
}

bool OAIHeatMapVisual_ChartConfiguration::is_tooltip_Valid() const{
    return m_tooltip_isValid;
}

bool OAIHeatMapVisual_ChartConfiguration::isSet() const {
...
bool OAIHeatMapVisual_ChartConfiguration::isValid() const {
