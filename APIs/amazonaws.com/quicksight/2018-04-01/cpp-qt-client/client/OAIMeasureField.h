...
#ifndef OAIMeasureField_H
#define OAIMeasureField_H
...
class OAIMeasureField : public OAIObject {
public:
    OAIMeasureField();
    OAIMeasureField(QString json);
    ~OAIMeasureField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeasureField)

#endif // OAIMeasureField_H
