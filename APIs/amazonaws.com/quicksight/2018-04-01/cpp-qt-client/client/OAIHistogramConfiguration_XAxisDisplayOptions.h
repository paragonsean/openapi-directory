...
/*
 * OAIHistogramConfiguration_XAxisDisplayOptions.h
 *
 * 
 */

#ifndef OAIHistogramConfiguration_XAxisDisplayOptions_H
#define OAIHistogramConfiguration_XAxisDisplayOptions_H
...
class OAIHistogramConfiguration_XAxisDisplayOptions : public OAIObject {
public:
    OAIHistogramConfiguration_XAxisDisplayOptions();
    OAIHistogramConfiguration_XAxisDisplayOptions(QString json);
    ~OAIHistogramConfiguration_XAxisDisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramConfiguration_XAxisDisplayOptions)

#endif // OAIHistogramConfiguration_XAxisDisplayOptions_H
