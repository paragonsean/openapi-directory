...
/*
 * OAITemplate_Version.h
 *
 * 
 */

#ifndef OAITemplate_Version_H
#define OAITemplate_Version_H
...
class OAITemplate_Version : public OAIObject {
public:
    OAITemplate_Version();
    OAITemplate_Version(QString json);
    ~OAITemplate_Version() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplate_Version)

#endif // OAITemplate_Version_H
