...
/*
 * OAIComputation_TopBottomMovers.h
 *
 * 
 */

#ifndef OAIComputation_TopBottomMovers_H
#define OAIComputation_TopBottomMovers_H
...
class OAIComputation_TopBottomMovers : public OAIObject {
public:
    OAIComputation_TopBottomMovers();
    OAIComputation_TopBottomMovers(QString json);
    ~OAIComputation_TopBottomMovers() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_TopBottomMovers)

#endif // OAIComputation_TopBottomMovers_H
