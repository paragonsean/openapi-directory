...
/*
 * OAITotalOptions_TotalCellStyle.h
 *
 * 
 */

#ifndef OAITotalOptions_TotalCellStyle_H
#define OAITotalOptions_TotalCellStyle_H
...
class OAITotalOptions_TotalCellStyle : public OAIObject {
public:
    OAITotalOptions_TotalCellStyle();
    OAITotalOptions_TotalCellStyle(QString json);
    ~OAITotalOptions_TotalCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalOptions_TotalCellStyle)

#endif // OAITotalOptions_TotalCellStyle_H
