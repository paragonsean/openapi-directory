...
/*
 * OAINamespaceInfoV2.h
 *
 * The error type.
 */

#ifndef OAINamespaceInfoV2_H
#define OAINamespaceInfoV2_H
...
class OAINamespaceInfoV2 : public OAIObject {
public:
    OAINamespaceInfoV2();
    OAINamespaceInfoV2(QString json);
    ~OAINamespaceInfoV2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINamespaceInfoV2)

#endif // OAINamespaceInfoV2_H
