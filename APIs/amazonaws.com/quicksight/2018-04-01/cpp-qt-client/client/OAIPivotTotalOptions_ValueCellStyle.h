...
/*
 * OAIPivotTotalOptions_ValueCellStyle.h
 *
 * 
 */

#ifndef OAIPivotTotalOptions_ValueCellStyle_H
#define OAIPivotTotalOptions_ValueCellStyle_H
...
class OAIPivotTotalOptions_ValueCellStyle : public OAIObject {
public:
    OAIPivotTotalOptions_ValueCellStyle();
    OAIPivotTotalOptions_ValueCellStyle(QString json);
    ~OAIPivotTotalOptions_ValueCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTotalOptions_ValueCellStyle)

#endif // OAIPivotTotalOptions_ValueCellStyle_H
