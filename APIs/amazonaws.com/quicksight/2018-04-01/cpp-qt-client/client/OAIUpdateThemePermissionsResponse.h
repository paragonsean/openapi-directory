...
/*
 * OAIUpdateThemePermissionsResponse.h
 *
 * 
 */

#ifndef OAIUpdateThemePermissionsResponse_H
#define OAIUpdateThemePermissionsResponse_H
...
class OAIUpdateThemePermissionsResponse : public OAIObject {
public:
    OAIUpdateThemePermissionsResponse();
    OAIUpdateThemePermissionsResponse(QString json);
    ~OAIUpdateThemePermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateThemePermissionsResponse)

#endif // OAIUpdateThemePermissionsResponse_H
