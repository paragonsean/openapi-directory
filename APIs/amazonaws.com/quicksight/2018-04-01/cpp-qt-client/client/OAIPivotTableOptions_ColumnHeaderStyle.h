...
/*
 * OAIPivotTableOptions_ColumnHeaderStyle.h
 *
 * 
 */

#ifndef OAIPivotTableOptions_ColumnHeaderStyle_H
#define OAIPivotTableOptions_ColumnHeaderStyle_H
...
class OAIPivotTableOptions_ColumnHeaderStyle : public OAIObject {
public:
    OAIPivotTableOptions_ColumnHeaderStyle();
    OAIPivotTableOptions_ColumnHeaderStyle(QString json);
    ~OAIPivotTableOptions_ColumnHeaderStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableOptions_ColumnHeaderStyle)

#endif // OAIPivotTableOptions_ColumnHeaderStyle_H
