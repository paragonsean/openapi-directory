...
OAIParameterControl_Dropdown::OAIParameterControl_Dropdown(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParameterControl_Dropdown::OAIParameterControl_Dropdown() {
    this->initializeModel();
}

OAIParameterControl_Dropdown::~OAIParameterControl_Dropdown() {}

void OAIParameterControl_Dropdown::initializeModel() {
...
void OAIParameterControl_Dropdown::fromJson(QString jsonString) {
...
void OAIParameterControl_Dropdown::fromJsonObject(QJsonObject json) {
...
QString OAIParameterControl_Dropdown::asJson() const {
...
QJsonObject OAIParameterControl_Dropdown::asJsonObject() const {
    QJsonObject obj;
...
QString OAIParameterControl_Dropdown::getParameterControlId() const {
    return m_parameter_control_id;
}
void OAIParameterControl_Dropdown::setParameterControlId(const QString &parameter_control_id) {
    m_parameter_control_id = parameter_control_id;
    m_parameter_control_id_isSet = true;
}

bool OAIParameterControl_Dropdown::is_parameter_control_id_Set() const{
    return m_parameter_control_id_isSet;
}

bool OAIParameterControl_Dropdown::is_parameter_control_id_Valid() const{
    return m_parameter_control_id_isValid;
}

QString OAIParameterControl_Dropdown::getTitle() const {
    return m_title;
}
void OAIParameterControl_Dropdown::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIParameterControl_Dropdown::is_title_Set() const{
    return m_title_isSet;
}

bool OAIParameterControl_Dropdown::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIParameterControl_Dropdown::getSourceParameterName() const {
    return m_source_parameter_name;
}
void OAIParameterControl_Dropdown::setSourceParameterName(const QString &source_parameter_name) {
    m_source_parameter_name = source_parameter_name;
    m_source_parameter_name_isSet = true;
}

bool OAIParameterControl_Dropdown::is_source_parameter_name_Set() const{
    return m_source_parameter_name_isSet;
}

bool OAIParameterControl_Dropdown::is_source_parameter_name_Valid() const{
    return m_source_parameter_name_isValid;
}

OAIParameterDropDownControl_DisplayOptions OAIParameterControl_Dropdown::getDisplayOptions() const {
    return m_display_options;
}
void OAIParameterControl_Dropdown::setDisplayOptions(const OAIParameterDropDownControl_DisplayOptions &display_options) {
    m_display_options = display_options;
    m_display_options_isSet = true;
}

bool OAIParameterControl_Dropdown::is_display_options_Set() const{
    return m_display_options_isSet;
}

bool OAIParameterControl_Dropdown::is_display_options_Valid() const{
    return m_display_options_isValid;
}

OAISheetControlListType OAIParameterControl_Dropdown::getType() const {
    return m_type;
}
void OAIParameterControl_Dropdown::setType(const OAISheetControlListType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIParameterControl_Dropdown::is_type_Set() const{
    return m_type_isSet;
}

bool OAIParameterControl_Dropdown::is_type_Valid() const{
    return m_type_isValid;
}

OAIParameterListControl_SelectableValues OAIParameterControl_Dropdown::getSelectableValues() const {
    return m_selectable_values;
}
void OAIParameterControl_Dropdown::setSelectableValues(const OAIParameterListControl_SelectableValues &selectable_values) {
    m_selectable_values = selectable_values;
    m_selectable_values_isSet = true;
}

bool OAIParameterControl_Dropdown::is_selectable_values_Set() const{
    return m_selectable_values_isSet;
}

bool OAIParameterControl_Dropdown::is_selectable_values_Valid() const{
    return m_selectable_values_isValid;
}

OAIFilterListControl_CascadingControlConfiguration OAIParameterControl_Dropdown::getCascadingControlConfiguration() const {
    return m_cascading_control_configuration;
}
void OAIParameterControl_Dropdown::setCascadingControlConfiguration(const OAIFilterListControl_CascadingControlConfiguration &cascading_control_configuration) {
    m_cascading_control_configuration = cascading_control_configuration;
    m_cascading_control_configuration_isSet = true;
}

bool OAIParameterControl_Dropdown::is_cascading_control_configuration_Set() const{
    return m_cascading_control_configuration_isSet;
}

bool OAIParameterControl_Dropdown::is_cascading_control_configuration_Valid() const{
    return m_cascading_control_configuration_isValid;
}

bool OAIParameterControl_Dropdown::isSet() const {
...
bool OAIParameterControl_Dropdown::isValid() const {
