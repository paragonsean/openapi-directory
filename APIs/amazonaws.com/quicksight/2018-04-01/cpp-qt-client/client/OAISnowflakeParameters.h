...
/*
 * OAISnowflakeParameters.h
 *
 * The parameters for Snowflake.
 */

#ifndef OAISnowflakeParameters_H
#define OAISnowflakeParameters_H
...
class OAISnowflakeParameters : public OAIObject {
public:
    OAISnowflakeParameters();
    OAISnowflakeParameters(QString json);
    ~OAISnowflakeParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnowflakeParameters)

#endif // OAISnowflakeParameters_H
