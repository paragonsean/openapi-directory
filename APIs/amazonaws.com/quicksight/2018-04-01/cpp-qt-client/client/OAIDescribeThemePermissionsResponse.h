...
/*
 * OAIDescribeThemePermissionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeThemePermissionsResponse_H
#define OAIDescribeThemePermissionsResponse_H
...
class OAIDescribeThemePermissionsResponse : public OAIObject {
public:
    OAIDescribeThemePermissionsResponse();
    OAIDescribeThemePermissionsResponse(QString json);
    ~OAIDescribeThemePermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeThemePermissionsResponse)

#endif // OAIDescribeThemePermissionsResponse_H
