...
/*
 * OAIUpdateVPCConnection_request.h
 *
 * 
 */

#ifndef OAIUpdateVPCConnection_request_H
#define OAIUpdateVPCConnection_request_H
...
class OAIUpdateVPCConnection_request : public OAIObject {
public:
    OAIUpdateVPCConnection_request();
    OAIUpdateVPCConnection_request(QString json);
    ~OAIUpdateVPCConnection_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVPCConnection_request)

#endif // OAIUpdateVPCConnection_request_H
