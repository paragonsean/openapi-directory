...
/*
 * OAITopicRelativeDateFilter.h
 *
 * A structure that represents a relative date filter.
 */

#ifndef OAITopicRelativeDateFilter_H
#define OAITopicRelativeDateFilter_H
...
class OAITopicRelativeDateFilter : public OAIObject {
public:
    OAITopicRelativeDateFilter();
    OAITopicRelativeDateFilter(QString json);
    ~OAITopicRelativeDateFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITopicRelativeDateFilter)

#endif // OAITopicRelativeDateFilter_H
