...
/*
 * OAIPivotTableTotalOptions.h
 *
 * The total options for a pivot table visual.
 */

#ifndef OAIPivotTableTotalOptions_H
#define OAIPivotTableTotalOptions_H
...
class OAIPivotTableTotalOptions : public OAIObject {
public:
    OAIPivotTableTotalOptions();
    OAIPivotTableTotalOptions(QString json);
    ~OAIPivotTableTotalOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPivotTableTotalOptions)

#endif // OAIPivotTableTotalOptions_H
