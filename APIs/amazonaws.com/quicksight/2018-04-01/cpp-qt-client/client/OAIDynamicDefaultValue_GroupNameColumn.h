...
/*
 * OAIDynamicDefaultValue_GroupNameColumn.h
 *
 * 
 */

#ifndef OAIDynamicDefaultValue_GroupNameColumn_H
#define OAIDynamicDefaultValue_GroupNameColumn_H
...
class OAIDynamicDefaultValue_GroupNameColumn : public OAIObject {
public:
    OAIDynamicDefaultValue_GroupNameColumn();
    OAIDynamicDefaultValue_GroupNameColumn(QString json);
    ~OAIDynamicDefaultValue_GroupNameColumn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDynamicDefaultValue_GroupNameColumn)

#endif // OAIDynamicDefaultValue_GroupNameColumn_H
