...
/*
 * OAIHeatMapVisual_ChartConfiguration.h
 *
 * 
 */

#ifndef OAIHeatMapVisual_ChartConfiguration_H
#define OAIHeatMapVisual_ChartConfiguration_H
...
class OAIHeatMapVisual_ChartConfiguration : public OAIObject {
public:
    OAIHeatMapVisual_ChartConfiguration();
    OAIHeatMapVisual_ChartConfiguration(QString json);
    ~OAIHeatMapVisual_ChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeatMapVisual_ChartConfiguration)

#endif // OAIHeatMapVisual_ChartConfiguration_H
