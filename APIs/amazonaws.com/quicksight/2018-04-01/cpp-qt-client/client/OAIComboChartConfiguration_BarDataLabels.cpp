...
OAIComboChartConfiguration_BarDataLabels::OAIComboChartConfiguration_BarDataLabels(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComboChartConfiguration_BarDataLabels::OAIComboChartConfiguration_BarDataLabels() {
    this->initializeModel();
}

OAIComboChartConfiguration_BarDataLabels::~OAIComboChartConfiguration_BarDataLabels() {}

void OAIComboChartConfiguration_BarDataLabels::initializeModel() {
...
void OAIComboChartConfiguration_BarDataLabels::fromJson(QString jsonString) {
...
void OAIComboChartConfiguration_BarDataLabels::fromJsonObject(QJsonObject json) {
...
QString OAIComboChartConfiguration_BarDataLabels::asJson() const {
...
QJsonObject OAIComboChartConfiguration_BarDataLabels::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAIComboChartConfiguration_BarDataLabels::getVisibility() const {
    return m_visibility;
}
void OAIComboChartConfiguration_BarDataLabels::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAIVisibility OAIComboChartConfiguration_BarDataLabels::getCategoryLabelVisibility() const {
    return m_category_label_visibility;
}
void OAIComboChartConfiguration_BarDataLabels::setCategoryLabelVisibility(const OAIVisibility &category_label_visibility) {
    m_category_label_visibility = category_label_visibility;
    m_category_label_visibility_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_category_label_visibility_Set() const{
    return m_category_label_visibility_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_category_label_visibility_Valid() const{
    return m_category_label_visibility_isValid;
}

OAIVisibility OAIComboChartConfiguration_BarDataLabels::getMeasureLabelVisibility() const {
    return m_measure_label_visibility;
}
void OAIComboChartConfiguration_BarDataLabels::setMeasureLabelVisibility(const OAIVisibility &measure_label_visibility) {
    m_measure_label_visibility = measure_label_visibility;
    m_measure_label_visibility_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_measure_label_visibility_Set() const{
    return m_measure_label_visibility_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_measure_label_visibility_Valid() const{
    return m_measure_label_visibility_isValid;
}

QList OAIComboChartConfiguration_BarDataLabels::getDataLabelTypes() const {
    return m_data_label_types;
}
void OAIComboChartConfiguration_BarDataLabels::setDataLabelTypes(const QList &data_label_types) {
    m_data_label_types = data_label_types;
    m_data_label_types_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_data_label_types_Set() const{
    return m_data_label_types_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_data_label_types_Valid() const{
    return m_data_label_types_isValid;
}

OAIDataLabelPosition OAIComboChartConfiguration_BarDataLabels::getPosition() const {
    return m_position;
}
void OAIComboChartConfiguration_BarDataLabels::setPosition(const OAIDataLabelPosition &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_position_Set() const{
    return m_position_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_position_Valid() const{
    return m_position_isValid;
}

OAIDataLabelContent OAIComboChartConfiguration_BarDataLabels::getLabelContent() const {
    return m_label_content;
}
void OAIComboChartConfiguration_BarDataLabels::setLabelContent(const OAIDataLabelContent &label_content) {
    m_label_content = label_content;
    m_label_content_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_content_Set() const{
    return m_label_content_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_content_Valid() const{
    return m_label_content_isValid;
}

OAIDataLabelOptions_LabelFontConfiguration OAIComboChartConfiguration_BarDataLabels::getLabelFontConfiguration() const {
    return m_label_font_configuration;
}
void OAIComboChartConfiguration_BarDataLabels::setLabelFontConfiguration(const OAIDataLabelOptions_LabelFontConfiguration &label_font_configuration) {
    m_label_font_configuration = label_font_configuration;
    m_label_font_configuration_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_font_configuration_Set() const{
    return m_label_font_configuration_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_font_configuration_Valid() const{
    return m_label_font_configuration_isValid;
}

QString OAIComboChartConfiguration_BarDataLabels::getLabelColor() const {
    return m_label_color;
}
void OAIComboChartConfiguration_BarDataLabels::setLabelColor(const QString &label_color) {
    m_label_color = label_color;
    m_label_color_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_color_Set() const{
    return m_label_color_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_label_color_Valid() const{
    return m_label_color_isValid;
}

OAIDataLabelOverlap OAIComboChartConfiguration_BarDataLabels::getOverlap() const {
    return m_overlap;
}
void OAIComboChartConfiguration_BarDataLabels::setOverlap(const OAIDataLabelOverlap &overlap) {
    m_overlap = overlap;
    m_overlap_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_overlap_Set() const{
    return m_overlap_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_overlap_Valid() const{
    return m_overlap_isValid;
}

OAIVisibility OAIComboChartConfiguration_BarDataLabels::getTotalsVisibility() const {
    return m_totals_visibility;
}
void OAIComboChartConfiguration_BarDataLabels::setTotalsVisibility(const OAIVisibility &totals_visibility) {
    m_totals_visibility = totals_visibility;
    m_totals_visibility_isSet = true;
}

bool OAIComboChartConfiguration_BarDataLabels::is_totals_visibility_Set() const{
    return m_totals_visibility_isSet;
}

bool OAIComboChartConfiguration_BarDataLabels::is_totals_visibility_Valid() const{
    return m_totals_visibility_isValid;
}

bool OAIComboChartConfiguration_BarDataLabels::isSet() const {
...
bool OAIComboChartConfiguration_BarDataLabels::isValid() const {
