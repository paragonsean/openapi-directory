...
/*
 * OAIParameterControl_DateTimePicker.h
 *
 * 
 */

#ifndef OAIParameterControl_DateTimePicker_H
#define OAIParameterControl_DateTimePicker_H
...
class OAIParameterControl_DateTimePicker : public OAIObject {
public:
    OAIParameterControl_DateTimePicker();
    OAIParameterControl_DateTimePicker(QString json);
    ~OAIParameterControl_DateTimePicker() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterControl_DateTimePicker)

#endif // OAIParameterControl_DateTimePicker_H
