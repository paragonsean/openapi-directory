...
/*
 * OAIPeriodToDateComputation.h
 *
 * The period to date computation configuration.
 */

#ifndef OAIPeriodToDateComputation_H
#define OAIPeriodToDateComputation_H
...
class OAIPeriodToDateComputation : public OAIObject {
public:
    OAIPeriodToDateComputation();
    OAIPeriodToDateComputation(QString json);
    ~OAIPeriodToDateComputation() override;
    ...
    OAITimeGranularity getPeriodTimeGranularity() const;
    void setPeriodTimeGranularity(const OAITimeGranularity &period_time_granularity);
    bool is_period_time_granularity_Set() const;
    bool is_period_time_granularity_Valid() const;
...
private:
    ...
    OAITimeGranularity m_period_time_granularity;
    bool m_period_time_granularity_isSet;
    bool m_period_time_granularity_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPeriodToDateComputation)

#endif // OAIPeriodToDateComputation_H
