...
/*
 * OAISubtotalOptions_MetricHeaderCellStyle.h
 *
 * 
 */

#ifndef OAISubtotalOptions_MetricHeaderCellStyle_H
#define OAISubtotalOptions_MetricHeaderCellStyle_H
...
class OAISubtotalOptions_MetricHeaderCellStyle : public OAIObject {
public:
    OAISubtotalOptions_MetricHeaderCellStyle();
    OAISubtotalOptions_MetricHeaderCellStyle(QString json);
    ~OAISubtotalOptions_MetricHeaderCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubtotalOptions_MetricHeaderCellStyle)

#endif // OAISubtotalOptions_MetricHeaderCellStyle_H
