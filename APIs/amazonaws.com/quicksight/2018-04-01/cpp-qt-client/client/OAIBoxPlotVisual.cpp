...
OAIBoxPlotVisual::OAIBoxPlotVisual(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBoxPlotVisual::OAIBoxPlotVisual() {
    this->initializeModel();
}

OAIBoxPlotVisual::~OAIBoxPlotVisual() {}

void OAIBoxPlotVisual::initializeModel() {
...
void OAIBoxPlotVisual::fromJson(QString jsonString) {
...
void OAIBoxPlotVisual::fromJsonObject(QJsonObject json) {
...
QString OAIBoxPlotVisual::asJson() const {
...
QJsonObject OAIBoxPlotVisual::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBoxPlotVisual::getVisualId() const {
    return m_visual_id;
}
void OAIBoxPlotVisual::setVisualId(const QString &visual_id) {
    m_visual_id = visual_id;
    m_visual_id_isSet = true;
}

bool OAIBoxPlotVisual::is_visual_id_Set() const{
    return m_visual_id_isSet;
}

bool OAIBoxPlotVisual::is_visual_id_Valid() const{
    return m_visual_id_isValid;
}

OAIBarChartVisual_Title OAIBoxPlotVisual::getTitle() const {
    return m_title;
}
void OAIBoxPlotVisual::setTitle(const OAIBarChartVisual_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIBoxPlotVisual::is_title_Set() const{
    return m_title_isSet;
}

bool OAIBoxPlotVisual::is_title_Valid() const{
    return m_title_isValid;
}

OAIBarChartVisual_Subtitle OAIBoxPlotVisual::getSubtitle() const {
    return m_subtitle;
}
void OAIBoxPlotVisual::setSubtitle(const OAIBarChartVisual_Subtitle &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAIBoxPlotVisual::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAIBoxPlotVisual::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

OAIBoxPlotVisual_ChartConfiguration OAIBoxPlotVisual::getChartConfiguration() const {
    return m_chart_configuration;
}
void OAIBoxPlotVisual::setChartConfiguration(const OAIBoxPlotVisual_ChartConfiguration &chart_configuration) {
    m_chart_configuration = chart_configuration;
    m_chart_configuration_isSet = true;
}

bool OAIBoxPlotVisual::is_chart_configuration_Set() const{
    return m_chart_configuration_isSet;
}

bool OAIBoxPlotVisual::is_chart_configuration_Valid() const{
    return m_chart_configuration_isValid;
}

QList OAIBoxPlotVisual::getActions() const {
    return m_actions;
}
void OAIBoxPlotVisual::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIBoxPlotVisual::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIBoxPlotVisual::is_actions_Valid() const{
    return m_actions_isValid;
}

QList OAIBoxPlotVisual::getColumnHierarchies() const {
    return m_column_hierarchies;
}
void OAIBoxPlotVisual::setColumnHierarchies(const QList &column_hierarchies) {
    m_column_hierarchies = column_hierarchies;
    m_column_hierarchies_isSet = true;
}

bool OAIBoxPlotVisual::is_column_hierarchies_Set() const{
    return m_column_hierarchies_isSet;
}

bool OAIBoxPlotVisual::is_column_hierarchies_Valid() const{
    return m_column_hierarchies_isValid;
}

bool OAIBoxPlotVisual::isSet() const {
...
bool OAIBoxPlotVisual::isValid() const {
