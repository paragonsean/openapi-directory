...
OAIRefreshSchedule::OAIRefreshSchedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRefreshSchedule::OAIRefreshSchedule() {
    this->initializeModel();
}

OAIRefreshSchedule::~OAIRefreshSchedule() {}

void OAIRefreshSchedule::initializeModel() {
...
void OAIRefreshSchedule::fromJson(QString jsonString) {
...
void OAIRefreshSchedule::fromJsonObject(QJsonObject json) {
...
QString OAIRefreshSchedule::asJson() const {
...
QJsonObject OAIRefreshSchedule::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRefreshSchedule::getScheduleId() const {
    return m_schedule_id;
}
void OAIRefreshSchedule::setScheduleId(const QString &schedule_id) {
    m_schedule_id = schedule_id;
    m_schedule_id_isSet = true;
}

bool OAIRefreshSchedule::is_schedule_id_Set() const{
    return m_schedule_id_isSet;
}

bool OAIRefreshSchedule::is_schedule_id_Valid() const{
    return m_schedule_id_isValid;
}

OAIUpdateRefreshSchedule_request_Schedule_ScheduleFrequency OAIRefreshSchedule::getScheduleFrequency() const {
    return m_schedule_frequency;
}
void OAIRefreshSchedule::setScheduleFrequency(const OAIUpdateRefreshSchedule_request_Schedule_ScheduleFrequency &schedule_frequency) {
    m_schedule_frequency = schedule_frequency;
    m_schedule_frequency_isSet = true;
}

bool OAIRefreshSchedule::is_schedule_frequency_Set() const{
    return m_schedule_frequency_isSet;
}

bool OAIRefreshSchedule::is_schedule_frequency_Valid() const{
    return m_schedule_frequency_isValid;
}

QDateTime OAIRefreshSchedule::getStartAfterDateTime() const {
    return m_start_after_date_time;
}
void OAIRefreshSchedule::setStartAfterDateTime(const QDateTime &start_after_date_time) {
    m_start_after_date_time = start_after_date_time;
    m_start_after_date_time_isSet = true;
}

bool OAIRefreshSchedule::is_start_after_date_time_Set() const{
    return m_start_after_date_time_isSet;
}

bool OAIRefreshSchedule::is_start_after_date_time_Valid() const{
    return m_start_after_date_time_isValid;
}

OAIIngestionType OAIRefreshSchedule::getRefreshType() const {
    return m_refresh_type;
}
void OAIRefreshSchedule::setRefreshType(const OAIIngestionType &refresh_type) {
    m_refresh_type = refresh_type;
    m_refresh_type_isSet = true;
}

bool OAIRefreshSchedule::is_refresh_type_Set() const{
    return m_refresh_type_isSet;
}

bool OAIRefreshSchedule::is_refresh_type_Valid() const{
    return m_refresh_type_isValid;
}

QString OAIRefreshSchedule::getArn() const {
    return m_arn;
}
void OAIRefreshSchedule::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRefreshSchedule::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRefreshSchedule::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIRefreshSchedule::isSet() const {
...
bool OAIRefreshSchedule::isValid() const {
