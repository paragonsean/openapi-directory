...
/*
 * OAICreateIngestionResponse.h
 *
 * 
 */

#ifndef OAICreateIngestionResponse_H
#define OAICreateIngestionResponse_H
...
class OAICreateIngestionResponse : public OAIObject {
public:
    OAICreateIngestionResponse();
    OAICreateIngestionResponse(QString json);
    ~OAICreateIngestionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIngestionResponse)

#endif // OAICreateIngestionResponse_H
