...
/*
 * OAIAggregationSortConfiguration_AggregationFunction.h
 *
 * 
 */

#ifndef OAIAggregationSortConfiguration_AggregationFunction_H
#define OAIAggregationSortConfiguration_AggregationFunction_H
...
class OAIAggregationSortConfiguration_AggregationFunction : public OAIObject {
public:
    OAIAggregationSortConfiguration_AggregationFunction();
    OAIAggregationSortConfiguration_AggregationFunction(QString json);
    ~OAIAggregationSortConfiguration_AggregationFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAggregationSortConfiguration_AggregationFunction)

#endif // OAIAggregationSortConfiguration_AggregationFunction_H
