...
/*
 * OAITopicFilter_CategoryFilter.h
 *
 * 
 */

#ifndef OAITopicFilter_CategoryFilter_H
#define OAITopicFilter_CategoryFilter_H
...
class OAITopicFilter_CategoryFilter : public OAIObject {
public:
    OAITopicFilter_CategoryFilter();
    OAITopicFilter_CategoryFilter(QString json);
    ~OAITopicFilter_CategoryFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITopicFilter_CategoryFilter)

#endif // OAITopicFilter_CategoryFilter_H
