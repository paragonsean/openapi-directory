...
/*
 * OAIFilterSliderControl_DisplayOptions.h
 *
 * 
 */

#ifndef OAIFilterSliderControl_DisplayOptions_H
#define OAIFilterSliderControl_DisplayOptions_H
...
class OAIFilterSliderControl_DisplayOptions : public OAIObject {
public:
    OAIFilterSliderControl_DisplayOptions();
    OAIFilterSliderControl_DisplayOptions(QString json);
    ~OAIFilterSliderControl_DisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterSliderControl_DisplayOptions)

#endif // OAIFilterSliderControl_DisplayOptions_H
