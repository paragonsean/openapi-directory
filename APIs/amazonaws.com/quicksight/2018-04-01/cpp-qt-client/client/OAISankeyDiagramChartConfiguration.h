...
/*
 * OAISankeyDiagramChartConfiguration.h
 *
 * The configuration of a sankey diagram.
 */

#ifndef OAISankeyDiagramChartConfiguration_H
#define OAISankeyDiagramChartConfiguration_H
...
class OAISankeyDiagramChartConfiguration : public OAIObject {
public:
    OAISankeyDiagramChartConfiguration();
    OAISankeyDiagramChartConfiguration(QString json);
    ~OAISankeyDiagramChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISankeyDiagramChartConfiguration)

#endif // OAISankeyDiagramChartConfiguration_H
