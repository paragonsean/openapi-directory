...
/*
 * OAIDeleteTopicRefreshScheduleResponse.h
 *
 * 
 */

#ifndef OAIDeleteTopicRefreshScheduleResponse_H
#define OAIDeleteTopicRefreshScheduleResponse_H
...
class OAIDeleteTopicRefreshScheduleResponse : public OAIObject {
public:
    OAIDeleteTopicRefreshScheduleResponse();
    OAIDeleteTopicRefreshScheduleResponse(QString json);
    ~OAIDeleteTopicRefreshScheduleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTopicRefreshScheduleResponse)

#endif // OAIDeleteTopicRefreshScheduleResponse_H
