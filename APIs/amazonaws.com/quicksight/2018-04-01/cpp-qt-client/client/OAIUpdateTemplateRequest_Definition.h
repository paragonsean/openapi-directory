...
/*
 * OAIUpdateTemplateRequest_Definition.h
 *
 * 
 */

#ifndef OAIUpdateTemplateRequest_Definition_H
#define OAIUpdateTemplateRequest_Definition_H
...
class OAIUpdateTemplateRequest_Definition : public OAIObject {
public:
    OAIUpdateTemplateRequest_Definition();
    OAIUpdateTemplateRequest_Definition(QString json);
    ~OAIUpdateTemplateRequest_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTemplateRequest_Definition)

#endif // OAIUpdateTemplateRequest_Definition_H
