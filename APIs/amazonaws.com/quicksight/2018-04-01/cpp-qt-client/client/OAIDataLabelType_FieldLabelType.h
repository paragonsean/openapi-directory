...
/*
 * OAIDataLabelType_FieldLabelType.h
 *
 * 
 */

#ifndef OAIDataLabelType_FieldLabelType_H
#define OAIDataLabelType_FieldLabelType_H
...
class OAIDataLabelType_FieldLabelType : public OAIObject {
public:
    OAIDataLabelType_FieldLabelType();
    OAIDataLabelType_FieldLabelType(QString json);
    ~OAIDataLabelType_FieldLabelType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataLabelType_FieldLabelType)

#endif // OAIDataLabelType_FieldLabelType_H
