...
/*
 * OAILineChartConfiguration_DataLabels.h
 *
 * 
 */

#ifndef OAILineChartConfiguration_DataLabels_H
#define OAILineChartConfiguration_DataLabels_H
...
class OAILineChartConfiguration_DataLabels : public OAIObject {
public:
    OAILineChartConfiguration_DataLabels();
    OAILineChartConfiguration_DataLabels(QString json);
    ~OAILineChartConfiguration_DataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILineChartConfiguration_DataLabels)

#endif // OAILineChartConfiguration_DataLabels_H
