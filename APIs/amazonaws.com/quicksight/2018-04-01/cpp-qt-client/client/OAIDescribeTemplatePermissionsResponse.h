...
/*
 * OAIDescribeTemplatePermissionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeTemplatePermissionsResponse_H
#define OAIDescribeTemplatePermissionsResponse_H
...
class OAIDescribeTemplatePermissionsResponse : public OAIObject {
public:
    OAIDescribeTemplatePermissionsResponse();
    OAIDescribeTemplatePermissionsResponse(QString json);
    ~OAIDescribeTemplatePermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTemplatePermissionsResponse)

#endif // OAIDescribeTemplatePermissionsResponse_H
