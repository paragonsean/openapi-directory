...
/*
 * OAIGaugeChartOptions_PrimaryValueFontConfiguration.h
 *
 * 
 */

#ifndef OAIGaugeChartOptions_PrimaryValueFontConfiguration_H
#define OAIGaugeChartOptions_PrimaryValueFontConfiguration_H
...
class OAIGaugeChartOptions_PrimaryValueFontConfiguration : public OAIObject {
public:
    OAIGaugeChartOptions_PrimaryValueFontConfiguration();
    OAIGaugeChartOptions_PrimaryValueFontConfiguration(QString json);
    ~OAIGaugeChartOptions_PrimaryValueFontConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGaugeChartOptions_PrimaryValueFontConfiguration)

#endif // OAIGaugeChartOptions_PrimaryValueFontConfiguration_H
