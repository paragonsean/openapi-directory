...
#include "OAIPivotTableConfiguration.h"
...
OAIPivotTableConfiguration::OAIPivotTableConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPivotTableConfiguration::OAIPivotTableConfiguration() {
    this->initializeModel();
}

OAIPivotTableConfiguration::~OAIPivotTableConfiguration() {}

void OAIPivotTableConfiguration::initializeModel() {
...
void OAIPivotTableConfiguration::fromJson(QString jsonString) {
...
void OAIPivotTableConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPivotTableConfiguration::asJson() const {
...
QJsonObject OAIPivotTableConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIPivotTableConfiguration_FieldWells OAIPivotTableConfiguration::getFieldWells() const {
    return m_field_wells;
}
void OAIPivotTableConfiguration::setFieldWells(const OAIPivotTableConfiguration_FieldWells &field_wells) {
    m_field_wells = field_wells;
    m_field_wells_isSet = true;
}

bool OAIPivotTableConfiguration::is_field_wells_Set() const{
    return m_field_wells_isSet;
}

bool OAIPivotTableConfiguration::is_field_wells_Valid() const{
    return m_field_wells_isValid;
}

OAIPivotTableConfiguration_SortConfiguration OAIPivotTableConfiguration::getSortConfiguration() const {
    return m_sort_configuration;
}
void OAIPivotTableConfiguration::setSortConfiguration(const OAIPivotTableConfiguration_SortConfiguration &sort_configuration) {
    m_sort_configuration = sort_configuration;
    m_sort_configuration_isSet = true;
}

bool OAIPivotTableConfiguration::is_sort_configuration_Set() const{
    return m_sort_configuration_isSet;
}

bool OAIPivotTableConfiguration::is_sort_configuration_Valid() const{
    return m_sort_configuration_isValid;
}

OAIPivotTableConfiguration_TableOptions OAIPivotTableConfiguration::getTableOptions() const {
    return m_table_options;
}
void OAIPivotTableConfiguration::setTableOptions(const OAIPivotTableConfiguration_TableOptions &table_options) {
    m_table_options = table_options;
    m_table_options_isSet = true;
}

bool OAIPivotTableConfiguration::is_table_options_Set() const{
    return m_table_options_isSet;
}

bool OAIPivotTableConfiguration::is_table_options_Valid() const{
    return m_table_options_isValid;
}

OAIPivotTableConfiguration_TotalOptions OAIPivotTableConfiguration::getTotalOptions() const {
    return m_total_options;
}
void OAIPivotTableConfiguration::setTotalOptions(const OAIPivotTableConfiguration_TotalOptions &total_options) {
    m_total_options = total_options;
    m_total_options_isSet = true;
}

bool OAIPivotTableConfiguration::is_total_options_Set() const{
    return m_total_options_isSet;
}

bool OAIPivotTableConfiguration::is_total_options_Valid() const{
    return m_total_options_isValid;
}

OAIPivotTableConfiguration_FieldOptions OAIPivotTableConfiguration::getFieldOptions() const {
    return m_field_options;
}
void OAIPivotTableConfiguration::setFieldOptions(const OAIPivotTableConfiguration_FieldOptions &field_options) {
    m_field_options = field_options;
    m_field_options_isSet = true;
}

bool OAIPivotTableConfiguration::is_field_options_Set() const{
    return m_field_options_isSet;
}

bool OAIPivotTableConfiguration::is_field_options_Valid() const{
    return m_field_options_isValid;
}

OAIPivotTableConfiguration_PaginatedReportOptions OAIPivotTableConfiguration::getPaginatedReportOptions() const {
    return m_paginated_report_options;
}
void OAIPivotTableConfiguration::setPaginatedReportOptions(const OAIPivotTableConfiguration_PaginatedReportOptions &paginated_report_options) {
    m_paginated_report_options = paginated_report_options;
    m_paginated_report_options_isSet = true;
}

bool OAIPivotTableConfiguration::is_paginated_report_options_Set() const{
    return m_paginated_report_options_isSet;
}

bool OAIPivotTableConfiguration::is_paginated_report_options_Valid() const{
    return m_paginated_report_options_isValid;
}

bool OAIPivotTableConfiguration::isSet() const {
...
bool OAIPivotTableConfiguration::isValid() const {
