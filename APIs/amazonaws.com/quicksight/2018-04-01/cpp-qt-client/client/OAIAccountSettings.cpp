...
QString OAIAccountSettings::getAccountName() const {
    return m_account_name;
}
void OAIAccountSettings::setAccountName(const QString &account_name) {
    m_account_name = account_name;
    m_account_name_isSet = true;
}

bool OAIAccountSettings::is_account_name_Set() const{
    return m_account_name_isSet;
}

bool OAIAccountSettings::is_account_name_Valid() const{
    return m_account_name_isValid;
}

OAIEdition OAIAccountSettings::getEdition() const {
    return m_edition;
}
void OAIAccountSettings::setEdition(const OAIEdition &edition) {
    m_edition = edition;
    m_edition_isSet = true;
}

bool OAIAccountSettings::is_edition_Set() const{
    return m_edition_isSet;
}

bool OAIAccountSettings::is_edition_Valid() const{
    return m_edition_isValid;
}

QString OAIAccountSettings::getDefaultNamespace() const {
    return m_default_namespace;
}
void OAIAccountSettings::setDefaultNamespace(const QString &default_namespace) {
    m_default_namespace = default_namespace;
    m_default_namespace_isSet = true;
}

bool OAIAccountSettings::is_default_namespace_Set() const{
    return m_default_namespace_isSet;
}

bool OAIAccountSettings::is_default_namespace_Valid() const{
    return m_default_namespace_isValid;
}

QString OAIAccountSettings::getNotificationEmail() const {
    return m_notification_email;
}
void OAIAccountSettings::setNotificationEmail(const QString &notification_email) {
    m_notification_email = notification_email;
    m_notification_email_isSet = true;
}

bool OAIAccountSettings::is_notification_email_Set() const{
    return m_notification_email_isSet;
}

bool OAIAccountSettings::is_notification_email_Valid() const{
    return m_notification_email_isValid;
}

bool OAIAccountSettings::getPublicSharingEnabled() const {
    return m_public_sharing_enabled;
}
void OAIAccountSettings::setPublicSharingEnabled(const bool &public_sharing_enabled) {
    m_public_sharing_enabled = public_sharing_enabled;
    m_public_sharing_enabled_isSet = true;
}

bool OAIAccountSettings::is_public_sharing_enabled_Set() const{
    return m_public_sharing_enabled_isSet;
}

bool OAIAccountSettings::is_public_sharing_enabled_Valid() const{
    return m_public_sharing_enabled_isValid;
}

bool OAIAccountSettings::getTerminationProtectionEnabled() const {
    return m_termination_protection_enabled;
}
void OAIAccountSettings::setTerminationProtectionEnabled(const bool &termination_protection_enabled) {
    m_termination_protection_enabled = termination_protection_enabled;
    m_termination_protection_enabled_isSet = true;
}

bool OAIAccountSettings::is_termination_protection_enabled_Set() const{
    return m_termination_protection_enabled_isSet;
}

bool OAIAccountSettings::is_termination_protection_enabled_Valid() const{
