...
#ifndef OAITooltipOptions_H
#define OAITooltipOptions_H
...
class OAITooltipOptions : public OAIObject {
public:
    OAITooltipOptions();
    OAITooltipOptions(QString json);
    ~OAITooltipOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITooltipOptions)

#endif // OAITooltipOptions_H
