...
/*
 * OAIDescribeAnalysisResponse_Analysis.h
 *
 * 
 */

#ifndef OAIDescribeAnalysisResponse_Analysis_H
#define OAIDescribeAnalysisResponse_Analysis_H
...
class OAIDescribeAnalysisResponse_Analysis : public OAIObject {
public:
    OAIDescribeAnalysisResponse_Analysis();
    OAIDescribeAnalysisResponse_Analysis(QString json);
    ~OAIDescribeAnalysisResponse_Analysis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAnalysisResponse_Analysis)

#endif // OAIDescribeAnalysisResponse_Analysis_H
