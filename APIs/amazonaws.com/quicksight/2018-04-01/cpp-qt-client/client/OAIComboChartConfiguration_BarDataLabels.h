...
/*
 * OAIComboChartConfiguration_BarDataLabels.h
 *
 * 
 */

#ifndef OAIComboChartConfiguration_BarDataLabels_H
#define OAIComboChartConfiguration_BarDataLabels_H
...
class OAIComboChartConfiguration_BarDataLabels : public OAIObject {
public:
    OAIComboChartConfiguration_BarDataLabels();
    OAIComboChartConfiguration_BarDataLabels(QString json);
    ~OAIComboChartConfiguration_BarDataLabels() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComboChartConfiguration_BarDataLabels)

#endif // OAIComboChartConfiguration_BarDataLabels_H
