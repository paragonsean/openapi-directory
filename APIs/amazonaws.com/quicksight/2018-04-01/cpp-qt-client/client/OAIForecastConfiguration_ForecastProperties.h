...
/*
 * OAIForecastConfiguration_ForecastProperties.h
 *
 * 
 */

#ifndef OAIForecastConfiguration_ForecastProperties_H
#define OAIForecastConfiguration_ForecastProperties_H
...
class OAIForecastConfiguration_ForecastProperties : public OAIObject {
public:
    OAIForecastConfiguration_ForecastProperties();
    OAIForecastConfiguration_ForecastProperties(QString json);
    ~OAIForecastConfiguration_ForecastProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForecastConfiguration_ForecastProperties)

#endif // OAIForecastConfiguration_ForecastProperties_H
