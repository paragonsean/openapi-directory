...
/*
 * OAILineChartConfiguration_Tooltip.h
 *
 * 
 */

#ifndef OAILineChartConfiguration_Tooltip_H
#define OAILineChartConfiguration_Tooltip_H
...
class OAILineChartConfiguration_Tooltip : public OAIObject {
public:
    OAILineChartConfiguration_Tooltip();
    OAILineChartConfiguration_Tooltip(QString json);
    ~OAILineChartConfiguration_Tooltip() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILineChartConfiguration_Tooltip)

#endif // OAILineChartConfiguration_Tooltip_H
