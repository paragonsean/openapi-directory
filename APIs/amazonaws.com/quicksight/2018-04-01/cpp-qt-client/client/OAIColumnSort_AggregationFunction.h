...
/*
 * OAIColumnSort_AggregationFunction.h
 *
 * 
 */

#ifndef OAIColumnSort_AggregationFunction_H
#define OAIColumnSort_AggregationFunction_H
...
class OAIColumnSort_AggregationFunction : public OAIObject {
public:
    OAIColumnSort_AggregationFunction();
    OAIColumnSort_AggregationFunction(QString json);
    ~OAIColumnSort_AggregationFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnSort_AggregationFunction)

#endif // OAIColumnSort_AggregationFunction_H
