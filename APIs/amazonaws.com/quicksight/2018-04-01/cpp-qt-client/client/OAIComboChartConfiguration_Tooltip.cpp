...
OAIComboChartConfiguration_Tooltip::OAIComboChartConfiguration_Tooltip(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComboChartConfiguration_Tooltip::OAIComboChartConfiguration_Tooltip() {
    this->initializeModel();
}

OAIComboChartConfiguration_Tooltip::~OAIComboChartConfiguration_Tooltip() {}

void OAIComboChartConfiguration_Tooltip::initializeModel() {
...
void OAIComboChartConfiguration_Tooltip::fromJson(QString jsonString) {
...
void OAIComboChartConfiguration_Tooltip::fromJsonObject(QJsonObject json) {
...
QString OAIComboChartConfiguration_Tooltip::asJson() const {
...
QJsonObject OAIComboChartConfiguration_Tooltip::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAIComboChartConfiguration_Tooltip::getTooltipVisibility() const {
    return m_tooltip_visibility;
}
void OAIComboChartConfiguration_Tooltip::setTooltipVisibility(const OAIVisibility &tooltip_visibility) {
    m_tooltip_visibility = tooltip_visibility;
    m_tooltip_visibility_isSet = true;
}

bool OAIComboChartConfiguration_Tooltip::is_tooltip_visibility_Set() const{
    return m_tooltip_visibility_isSet;
}

bool OAIComboChartConfiguration_Tooltip::is_tooltip_visibility_Valid() const{
    return m_tooltip_visibility_isValid;
}

OAISelectedTooltipType OAIComboChartConfiguration_Tooltip::getSelectedTooltipType() const {
    return m_selected_tooltip_type;
}
void OAIComboChartConfiguration_Tooltip::setSelectedTooltipType(const OAISelectedTooltipType &selected_tooltip_type) {
    m_selected_tooltip_type = selected_tooltip_type;
    m_selected_tooltip_type_isSet = true;
}

bool OAIComboChartConfiguration_Tooltip::is_selected_tooltip_type_Set() const{
    return m_selected_tooltip_type_isSet;
}

bool OAIComboChartConfiguration_Tooltip::is_selected_tooltip_type_Valid() const{
    return m_selected_tooltip_type_isValid;
}

OAITooltipOptions_FieldBasedTooltip OAIComboChartConfiguration_Tooltip::getFieldBasedTooltip() const {
    return m_field_based_tooltip;
}
void OAIComboChartConfiguration_Tooltip::setFieldBasedTooltip(const OAITooltipOptions_FieldBasedTooltip &field_based_tooltip) {
    m_field_based_tooltip = field_based_tooltip;
    m_field_based_tooltip_isSet = true;
}

bool OAIComboChartConfiguration_Tooltip::is_field_based_tooltip_Set() const{
    return m_field_based_tooltip_isSet;
}

bool OAIComboChartConfiguration_Tooltip::is_field_based_tooltip_Valid() const{
    return m_field_based_tooltip_isValid;
}

bool OAIComboChartConfiguration_Tooltip::isSet() const {
...
bool OAIComboChartConfiguration_Tooltip::isValid() const {
