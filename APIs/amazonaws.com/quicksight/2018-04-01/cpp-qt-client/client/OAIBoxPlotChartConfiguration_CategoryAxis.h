...
/*
 * OAIBoxPlotChartConfiguration_CategoryAxis.h
 *
 * 
 */

#ifndef OAIBoxPlotChartConfiguration_CategoryAxis_H
#define OAIBoxPlotChartConfiguration_CategoryAxis_H
...
class OAIBoxPlotChartConfiguration_CategoryAxis : public OAIObject {
public:
    OAIBoxPlotChartConfiguration_CategoryAxis();
    OAIBoxPlotChartConfiguration_CategoryAxis(QString json);
    ~OAIBoxPlotChartConfiguration_CategoryAxis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBoxPlotChartConfiguration_CategoryAxis)

#endif // OAIBoxPlotChartConfiguration_CategoryAxis_H
