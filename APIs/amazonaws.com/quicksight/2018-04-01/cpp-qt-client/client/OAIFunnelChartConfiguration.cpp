...
#include "OAIFunnelChartConfiguration.h"
...
OAIFunnelChartConfiguration::OAIFunnelChartConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFunnelChartConfiguration::OAIFunnelChartConfiguration() {
    this->initializeModel();
}

OAIFunnelChartConfiguration::~OAIFunnelChartConfiguration() {}

void OAIFunnelChartConfiguration::initializeModel() {
...
void OAIFunnelChartConfiguration::fromJson(QString jsonString) {
...
void OAIFunnelChartConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIFunnelChartConfiguration::asJson() const {
...
QJsonObject OAIFunnelChartConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIFunnelChartConfiguration_FieldWells OAIFunnelChartConfiguration::getFieldWells() const {
    return m_field_wells;
}
void OAIFunnelChartConfiguration::setFieldWells(const OAIFunnelChartConfiguration_FieldWells &field_wells) {
    m_field_wells = field_wells;
    m_field_wells_isSet = true;
}

bool OAIFunnelChartConfiguration::is_field_wells_Set() const{
    return m_field_wells_isSet;
}

bool OAIFunnelChartConfiguration::is_field_wells_Valid() const{
    return m_field_wells_isValid;
}

OAIFunnelChartConfiguration_SortConfiguration OAIFunnelChartConfiguration::getSortConfiguration() const {
    return m_sort_configuration;
}
void OAIFunnelChartConfiguration::setSortConfiguration(const OAIFunnelChartConfiguration_SortConfiguration &sort_configuration) {
    m_sort_configuration = sort_configuration;
    m_sort_configuration_isSet = true;
}

bool OAIFunnelChartConfiguration::is_sort_configuration_Set() const{
    return m_sort_configuration_isSet;
}

bool OAIFunnelChartConfiguration::is_sort_configuration_Valid() const{
    return m_sort_configuration_isValid;
}

OAIFunnelChartConfiguration_CategoryLabelOptions OAIFunnelChartConfiguration::getCategoryLabelOptions() const {
    return m_category_label_options;
}
void OAIFunnelChartConfiguration::setCategoryLabelOptions(const OAIFunnelChartConfiguration_CategoryLabelOptions &category_label_options) {
    m_category_label_options = category_label_options;
    m_category_label_options_isSet = true;
}

bool OAIFunnelChartConfiguration::is_category_label_options_Set() const{
    return m_category_label_options_isSet;
}

bool OAIFunnelChartConfiguration::is_category_label_options_Valid() const{
    return m_category_label_options_isValid;
}

OAIFunnelChartConfiguration_ValueLabelOptions OAIFunnelChartConfiguration::getValueLabelOptions() const {
    return m_value_label_options;
}
void OAIFunnelChartConfiguration::setValueLabelOptions(const OAIFunnelChartConfiguration_ValueLabelOptions &value_label_options) {
    m_value_label_options = value_label_options;
    m_value_label_options_isSet = true;
}

bool OAIFunnelChartConfiguration::is_value_label_options_Set() const{
    return m_value_label_options_isSet;
}

bool OAIFunnelChartConfiguration::is_value_label_options_Valid() const{
    return m_value_label_options_isValid;
}

OAIFunnelChartConfiguration_Tooltip OAIFunnelChartConfiguration::getTooltip() const {
    return m_tooltip;
}
void OAIFunnelChartConfiguration::setTooltip(const OAIFunnelChartConfiguration_Tooltip &tooltip) {
    m_tooltip = tooltip;
    m_tooltip_isSet = true;
}

bool OAIFunnelChartConfiguration::is_tooltip_Set() const{
    return m_tooltip_isSet;
}

bool OAIFunnelChartConfiguration::is_tooltip_Valid() const{
    return m_tooltip_isValid;
}

OAIFunnelChartConfiguration_DataLabelOptions OAIFunnelChartConfiguration::getDataLabelOptions() const {
    return m_data_label_options;
}
void OAIFunnelChartConfiguration::setDataLabelOptions(const OAIFunnelChartConfiguration_DataLabelOptions &data_label_options) {
    m_data_label_options = data_label_options;
    m_data_label_options_isSet = true;
}

bool OAIFunnelChartConfiguration::is_data_label_options_Set() const{
    return m_data_label_options_isSet;
}

bool OAIFunnelChartConfiguration::is_data_label_options_Valid() const{
    return m_data_label_options_isValid;
}

OAIFunnelChartConfiguration_VisualPalette OAIFunnelChartConfiguration::getVisualPalette() const {
    return m_visual_palette;
}
void OAIFunnelChartConfiguration::setVisualPalette(const OAIFunnelChartConfiguration_VisualPalette &visual_palette) {
    m_visual_palette = visual_palette;
    m_visual_palette_isSet = true;
}

bool OAIFunnelChartConfiguration::is_visual_palette_Set() const{
    return m_visual_palette_isSet;
}

bool OAIFunnelChartConfiguration::is_visual_palette_Valid() const{
    return m_visual_palette_isValid;
}

bool OAIFunnelChartConfiguration::isSet() const {
...
bool OAIFunnelChartConfiguration::isValid() const {
