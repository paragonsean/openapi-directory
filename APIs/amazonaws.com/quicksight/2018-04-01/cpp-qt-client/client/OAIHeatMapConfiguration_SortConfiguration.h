...
/*
 * OAIHeatMapConfiguration_SortConfiguration.h
 *
 * 
 */

#ifndef OAIHeatMapConfiguration_SortConfiguration_H
#define OAIHeatMapConfiguration_SortConfiguration_H
...
class OAIHeatMapConfiguration_SortConfiguration : public OAIObject {
public:
    OAIHeatMapConfiguration_SortConfiguration();
    OAIHeatMapConfiguration_SortConfiguration(QString json);
    ~OAIHeatMapConfiguration_SortConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeatMapConfiguration_SortConfiguration)

#endif // OAIHeatMapConfiguration_SortConfiguration_H
