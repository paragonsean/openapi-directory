...
/*
 * OAIFieldSeriesItem.h
 *
 * The field series item configuration of a line chart.
 */

#ifndef OAIFieldSeriesItem_H
#define OAIFieldSeriesItem_H
...
class OAIFieldSeriesItem : public OAIObject {
public:
    OAIFieldSeriesItem();
    OAIFieldSeriesItem(QString json);
    ~OAIFieldSeriesItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldSeriesItem)

#endif // OAIFieldSeriesItem_H
