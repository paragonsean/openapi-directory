...
/*
 * OAIWordCloudVisual_ChartConfiguration.h
 *
 * 
 */

#ifndef OAIWordCloudVisual_ChartConfiguration_H
#define OAIWordCloudVisual_ChartConfiguration_H
...
class OAIWordCloudVisual_ChartConfiguration : public OAIObject {
public:
    OAIWordCloudVisual_ChartConfiguration();
    OAIWordCloudVisual_ChartConfiguration(QString json);
    ~OAIWordCloudVisual_ChartConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWordCloudVisual_ChartConfiguration)

#endif // OAIWordCloudVisual_ChartConfiguration_H
