...
/*
 * OAITextFieldControlDisplayOptions.h
 *
 * The display options of a control.
 */

#ifndef OAITextFieldControlDisplayOptions_H
#define OAITextFieldControlDisplayOptions_H
...
class OAITextFieldControlDisplayOptions : public OAIObject {
public:
    OAITextFieldControlDisplayOptions();
    OAITextFieldControlDisplayOptions(QString json);
    ~OAITextFieldControlDisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextFieldControlDisplayOptions)

#endif // OAITextFieldControlDisplayOptions_H
