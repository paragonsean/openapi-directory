...
OAIVisibility OAITableCellStyle::getVisibility() const {
    return m_visibility;
}
void OAITableCellStyle::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAITableCellStyle::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAITableCellStyle::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAITableCellStyle_FontConfiguration OAITableCellStyle::getFontConfiguration() const {
    return m_font_configuration;
}
void OAITableCellStyle::setFontConfiguration(const OAITableCellStyle_FontConfiguration &font_configuration) {
    m_font_configuration = font_configuration;
    m_font_configuration_isSet = true;
}

bool OAITableCellStyle::is_font_configuration_Set() const{
    return m_font_configuration_isSet;
}

bool OAITableCellStyle::is_font_configuration_Valid() const{
    return m_font_configuration_isValid;
}

OAITextWrap OAITableCellStyle::getTextWrap() const {
    return m_text_wrap;
}
void OAITableCellStyle::setTextWrap(const OAITextWrap &text_wrap) {
    m_text_wrap = text_wrap;
    m_text_wrap_isSet = true;
}

bool OAITableCellStyle::is_text_wrap_Set() const{
    return m_text_wrap_isSet;
}

bool OAITableCellStyle::is_text_wrap_Valid() const{
    return m_text_wrap_isValid;
}

OAIHorizontalTextAlignment OAITableCellStyle::getHorizontalTextAlignment() const {
    return m_horizontal_text_alignment;
}
void OAITableCellStyle::setHorizontalTextAlignment(const OAIHorizontalTextAlignment &horizontal_text_alignment) {
    m_horizontal_text_alignment = horizontal_text_alignment;
    m_horizontal_text_alignment_isSet = true;
}

bool OAITableCellStyle::is_horizontal_text_alignment_Set() const{
    return m_horizontal_text_alignment_isSet;
}

bool OAITableCellStyle::is_horizontal_text_alignment_Valid() const{
    return m_horizontal_text_alignment_isValid;
}

OAIVerticalTextAlignment OAITableCellStyle::getVerticalTextAlignment() const {
    return m_vertical_text_alignment;
}
void OAITableCellStyle::setVerticalTextAlignment(const OAIVerticalTextAlignment &vertical_text_alignment) {
    m_vertical_text_alignment = vertical_text_alignment;
    m_vertical_text_alignment_isSet = true;
}

bool OAITableCellStyle::is_vertical_text_alignment_Set() const{
    return m_vertical_text_alignment_isSet;
}

bool OAITableCellStyle::is_vertical_text_alignment_Valid() const{
    return m_vertical_text_alignment_isValid;
}

QString OAITableCellStyle::getBackgroundColor() const {
    return m_background_color;
}
void OAITableCellStyle::setBackgroundColor(const QString &background_color) {
...
qint32 OAITableCellStyle::getHeight() const {
    return m_height;
}
void OAITableCellStyle::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAITableCellStyle::is_height_Set() const{
    return m_height_isSet;
}

bool OAITableCellStyle::is_height_Valid() const{
    return m_height_isValid;
}

OAITableCellStyle_Border OAITableCellStyle::getBorder() const {
    return m_border;
}
void OAITableCellStyle::setBorder(const OAITableCellStyle_Border &border) {
    m_border = border;
    m_border_isSet = true;
}

bool OAITableCellStyle::is_border_Set() const{
    return m_border_isSet;
}

bool OAITableCellStyle::is_border_Valid() const{
