...
/*
 * OAIFilterTextAreaControl_DisplayOptions.h
 *
 * 
 */

#ifndef OAIFilterTextAreaControl_DisplayOptions_H
#define OAIFilterTextAreaControl_DisplayOptions_H
...
class OAIFilterTextAreaControl_DisplayOptions : public OAIObject {
public:
    OAIFilterTextAreaControl_DisplayOptions();
    OAIFilterTextAreaControl_DisplayOptions(QString json);
    ~OAIFilterTextAreaControl_DisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterTextAreaControl_DisplayOptions)

#endif // OAIFilterTextAreaControl_DisplayOptions_H
