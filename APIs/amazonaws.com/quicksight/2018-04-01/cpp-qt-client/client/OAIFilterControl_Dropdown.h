...
/*
 * OAIFilterControl_Dropdown.h
 *
 * 
 */

#ifndef OAIFilterControl_Dropdown_H
#define OAIFilterControl_Dropdown_H
...
namespace OpenAPI {
class OAIFilterDropDownControl_DisplayOptions;
class OAIFilterListControl_SelectableValues;
class OAIFilterListControl_CascadingControlConfiguration;

class OAIFilterControl_Dropdown : public OAIObject {
public:
    OAIFilterControl_Dropdown();
    OAIFilterControl_Dropdown(QString json);
    ~OAIFilterControl_Dropdown() override;
    ...
    OAIFilterDropDownControl_DisplayOptions getDisplayOptions() const;
    void setDisplayOptions(const OAIFilterDropDownControl_DisplayOptions &display_options);
...
private:
    ...
    OAIFilterDropDownControl_DisplayOptions m_display_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterControl_Dropdown)

#endif // OAIFilterControl_Dropdown_H
