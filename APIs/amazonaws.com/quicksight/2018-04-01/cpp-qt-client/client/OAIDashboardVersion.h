...
/*
 * OAIDashboardVersion.h
 *
 * Dashboard version.
 */

#ifndef OAIDashboardVersion_H
#define OAIDashboardVersion_H
...
class OAIDashboardVersion : public OAIObject {
public:
    OAIDashboardVersion();
    OAIDashboardVersion(QString json);
    ~OAIDashboardVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDashboardVersion)

#endif // OAIDashboardVersion_H
