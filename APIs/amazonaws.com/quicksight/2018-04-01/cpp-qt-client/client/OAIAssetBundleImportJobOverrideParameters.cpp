...
#include "OAIAssetBundleImportJobOverrideParameters.h"
...
OAIAssetBundleImportJobOverrideParameters::OAIAssetBundleImportJobOverrideParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssetBundleImportJobOverrideParameters::OAIAssetBundleImportJobOverrideParameters() {
    this->initializeModel();
}

OAIAssetBundleImportJobOverrideParameters::~OAIAssetBundleImportJobOverrideParameters() {}

void OAIAssetBundleImportJobOverrideParameters::initializeModel() {
...
void OAIAssetBundleImportJobOverrideParameters::fromJson(QString jsonString) {
...
void OAIAssetBundleImportJobOverrideParameters::fromJsonObject(QJsonObject json) {
...
QString OAIAssetBundleImportJobOverrideParameters::asJson() const {
...
QJsonObject OAIAssetBundleImportJobOverrideParameters::asJsonObject() const {
    QJsonObject obj;
...
OAIStartAssetBundleImportJob_request_OverrideParameters_ResourceIdOverrideConfiguration OAIAssetBundleImportJobOverrideParameters::getResourceIdOverrideConfiguration() const {
    return m_resource_id_override_configuration;
}
void OAIAssetBundleImportJobOverrideParameters::setResourceIdOverrideConfiguration(const OAIStartAssetBundleImportJob_request_OverrideParameters_ResourceIdOverrideConfiguration &resource_id_override_configuration) {
    m_resource_id_override_configuration = resource_id_override_configuration;
    m_resource_id_override_configuration_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_resource_id_override_configuration_Set() const{
    return m_resource_id_override_configuration_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_resource_id_override_configuration_Valid() const{
    return m_resource_id_override_configuration_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getVpcConnections() const {
    return m_vpc_connections;
}
void OAIAssetBundleImportJobOverrideParameters::setVpcConnections(const QList &vpc_connections) {
    m_vpc_connections = vpc_connections;
    m_vpc_connections_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_vpc_connections_Set() const{
    return m_vpc_connections_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_vpc_connections_Valid() const{
    return m_vpc_connections_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getRefreshSchedules() const {
    return m_refresh_schedules;
}
void OAIAssetBundleImportJobOverrideParameters::setRefreshSchedules(const QList &refresh_schedules) {
    m_refresh_schedules = refresh_schedules;
    m_refresh_schedules_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_refresh_schedules_Set() const{
    return m_refresh_schedules_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_refresh_schedules_Valid() const{
    return m_refresh_schedules_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getDataSources() const {
    return m_data_sources;
}
void OAIAssetBundleImportJobOverrideParameters::setDataSources(const QList &data_sources) {
    m_data_sources = data_sources;
    m_data_sources_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_data_sources_Set() const{
    return m_data_sources_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_data_sources_Valid() const{
    return m_data_sources_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getDataSets() const {
    return m_data_sets;
}
void OAIAssetBundleImportJobOverrideParameters::setDataSets(const QList &data_sets) {
    m_data_sets = data_sets;
    m_data_sets_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_data_sets_Set() const{
    return m_data_sets_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_data_sets_Valid() const{
    return m_data_sets_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getThemes() const {
    return m_themes;
}
void OAIAssetBundleImportJobOverrideParameters::setThemes(const QList &themes) {
    m_themes = themes;
    m_themes_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_themes_Set() const{
    return m_themes_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_themes_Valid() const{
    return m_themes_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getAnalyses() const {
    return m_analyses;
}
void OAIAssetBundleImportJobOverrideParameters::setAnalyses(const QList &analyses) {
    m_analyses = analyses;
    m_analyses_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_analyses_Set() const{
    return m_analyses_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_analyses_Valid() const{
    return m_analyses_isValid;
}

QList OAIAssetBundleImportJobOverrideParameters::getDashboards() const {
    return m_dashboards;
}
void OAIAssetBundleImportJobOverrideParameters::setDashboards(const QList &dashboards) {
    m_dashboards = dashboards;
    m_dashboards_isSet = true;
}

bool OAIAssetBundleImportJobOverrideParameters::is_dashboards_Set() const{
    return m_dashboards_isSet;
}

bool OAIAssetBundleImportJobOverrideParameters::is_dashboards_Valid() const{
    return m_dashboards_isValid;
}

bool OAIAssetBundleImportJobOverrideParameters::isSet() const {
...
bool OAIAssetBundleImportJobOverrideParameters::isValid() const {
