...
OAIDataLabelOptions::OAIDataLabelOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataLabelOptions::OAIDataLabelOptions() {
    this->initializeModel();
}

OAIDataLabelOptions::~OAIDataLabelOptions() {}

void OAIDataLabelOptions::initializeModel() {
...
void OAIDataLabelOptions::fromJson(QString jsonString) {
...
void OAIDataLabelOptions::fromJsonObject(QJsonObject json) {
...
QString OAIDataLabelOptions::asJson() const {
...
QJsonObject OAIDataLabelOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIVisibility OAIDataLabelOptions::getVisibility() const {
    return m_visibility;
}
void OAIDataLabelOptions::setVisibility(const OAIVisibility &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAIDataLabelOptions::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAIDataLabelOptions::is_visibility_Valid() const{
    return m_visibility_isValid;
}

OAIVisibility OAIDataLabelOptions::getCategoryLabelVisibility() const {
    return m_category_label_visibility;
}
void OAIDataLabelOptions::setCategoryLabelVisibility(const OAIVisibility &category_label_visibility) {
    m_category_label_visibility = category_label_visibility;
    m_category_label_visibility_isSet = true;
}

bool OAIDataLabelOptions::is_category_label_visibility_Set() const{
    return m_category_label_visibility_isSet;
}

bool OAIDataLabelOptions::is_category_label_visibility_Valid() const{
    return m_category_label_visibility_isValid;
}

OAIVisibility OAIDataLabelOptions::getMeasureLabelVisibility() const {
    return m_measure_label_visibility;
}
void OAIDataLabelOptions::setMeasureLabelVisibility(const OAIVisibility &measure_label_visibility) {
    m_measure_label_visibility = measure_label_visibility;
    m_measure_label_visibility_isSet = true;
}

bool OAIDataLabelOptions::is_measure_label_visibility_Set() const{
    return m_measure_label_visibility_isSet;
}

bool OAIDataLabelOptions::is_measure_label_visibility_Valid() const{
    return m_measure_label_visibility_isValid;
}

QList OAIDataLabelOptions::getDataLabelTypes() const {
    return m_data_label_types;
}
void OAIDataLabelOptions::setDataLabelTypes(const QList &data_label_types) {
    m_data_label_types = data_label_types;
    m_data_label_types_isSet = true;
}

bool OAIDataLabelOptions::is_data_label_types_Set() const{
    return m_data_label_types_isSet;
}

bool OAIDataLabelOptions::is_data_label_types_Valid() const{
    return m_data_label_types_isValid;
}

OAIDataLabelPosition OAIDataLabelOptions::getPosition() const {
    return m_position;
}
void OAIDataLabelOptions::setPosition(const OAIDataLabelPosition &position) {
    m_position = position;
    m_position_isSet = true;
}

bool OAIDataLabelOptions::is_position_Set() const{
    return m_position_isSet;
}

bool OAIDataLabelOptions::is_position_Valid() const{
    return m_position_isValid;
}

OAIDataLabelContent OAIDataLabelOptions::getLabelContent() const {
    return m_label_content;
}
void OAIDataLabelOptions::setLabelContent(const OAIDataLabelContent &label_content) {
    m_label_content = label_content;
    m_label_content_isSet = true;
}

bool OAIDataLabelOptions::is_label_content_Set() const{
    return m_label_content_isSet;
}

bool OAIDataLabelOptions::is_label_content_Valid() const{
    return m_label_content_isValid;
}

OAIDataLabelOptions_LabelFontConfiguration OAIDataLabelOptions::getLabelFontConfiguration() const {
    return m_label_font_configuration;
}
void OAIDataLabelOptions::setLabelFontConfiguration(const OAIDataLabelOptions_LabelFontConfiguration &label_font_configuration) {
    m_label_font_configuration = label_font_configuration;
    m_label_font_configuration_isSet = true;
}

bool OAIDataLabelOptions::is_label_font_configuration_Set() const{
    return m_label_font_configuration_isSet;
}

bool OAIDataLabelOptions::is_label_font_configuration_Valid() const{
    return m_label_font_configuration_isValid;
}

QString OAIDataLabelOptions::getLabelColor() const {
    return m_label_color;
}
void OAIDataLabelOptions::setLabelColor(const QString &label_color) {
    m_label_color = label_color;
    m_label_color_isSet = true;
}

bool OAIDataLabelOptions::is_label_color_Set() const{
    return m_label_color_isSet;
}

bool OAIDataLabelOptions::is_label_color_Valid() const{
    return m_label_color_isValid;
}

OAIDataLabelOverlap OAIDataLabelOptions::getOverlap() const {
    return m_overlap;
}
void OAIDataLabelOptions::setOverlap(const OAIDataLabelOverlap &overlap) {
    m_overlap = overlap;
    m_overlap_isSet = true;
}

bool OAIDataLabelOptions::is_overlap_Set() const{
    return m_overlap_isSet;
}

bool OAIDataLabelOptions::is_overlap_Valid() const{
    return m_overlap_isValid;
}

OAIVisibility OAIDataLabelOptions::getTotalsVisibility() const {
    return m_totals_visibility;
}
void OAIDataLabelOptions::setTotalsVisibility(const OAIVisibility &totals_visibility) {
    m_totals_visibility = totals_visibility;
    m_totals_visibility_isSet = true;
}

bool OAIDataLabelOptions::is_totals_visibility_Set() const{
    return m_totals_visibility_isSet;
}

bool OAIDataLabelOptions::is_totals_visibility_Valid() const{
    return m_totals_visibility_isValid;
}

bool OAIDataLabelOptions::isSet() const {
...
bool OAIDataLabelOptions::isValid() const {
