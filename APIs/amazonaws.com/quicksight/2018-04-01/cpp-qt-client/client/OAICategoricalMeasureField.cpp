...
#include "OAICategoricalMeasureField.h"
...
OAICategoricalMeasureField::OAICategoricalMeasureField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICategoricalMeasureField::OAICategoricalMeasureField() {
    this->initializeModel();
}

OAICategoricalMeasureField::~OAICategoricalMeasureField() {}

void OAICategoricalMeasureField::initializeModel() {
...
void OAICategoricalMeasureField::fromJson(QString jsonString) {
...
void OAICategoricalMeasureField::fromJsonObject(QJsonObject json) {
...
QString OAICategoricalMeasureField::asJson() const {
...
QJsonObject OAICategoricalMeasureField::asJsonObject() const {
    QJsonObject obj;
    if (m_field_id_isSet) {
...
QString OAICategoricalMeasureField::getFieldId() const {
    return m_field_id;
}
void OAICategoricalMeasureField::setFieldId(const QString &field_id) {
    m_field_id = field_id;
    m_field_id_isSet = true;
}

bool OAICategoricalMeasureField::is_field_id_Set() const{
    return m_field_id_isSet;
}

bool OAICategoricalMeasureField::is_field_id_Valid() const{
    return m_field_id_isValid;
}

OAICategoricalMeasureField_Column OAICategoricalMeasureField::getColumn() const {
    return m_column;
}
void OAICategoricalMeasureField::setColumn(const OAICategoricalMeasureField_Column &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAICategoricalMeasureField::is_column_Set() const{
    return m_column_isSet;
}

bool OAICategoricalMeasureField::is_column_Valid() const{
    return m_column_isValid;
}

OAICategoricalAggregationFunction OAICategoricalMeasureField::getAggregationFunction() const {
    return m_aggregation_function;
}
void OAICategoricalMeasureField::setAggregationFunction(const OAICategoricalAggregationFunction &aggregation_function) {
    m_aggregation_function = aggregation_function;
    m_aggregation_function_isSet = true;
}

bool OAICategoricalMeasureField::is_aggregation_function_Set() const{
    return m_aggregation_function_isSet;
}

bool OAICategoricalMeasureField::is_aggregation_function_Valid() const{
    return m_aggregation_function_isValid;
}

OAICategoricalDimensionField_FormatConfiguration OAICategoricalMeasureField::getFormatConfiguration() const {
    return m_format_configuration;
}
void OAICategoricalMeasureField::setFormatConfiguration(const OAICategoricalDimensionField_FormatConfiguration &format_configuration) {
    m_format_configuration = format_configuration;
    m_format_configuration_isSet = true;
}

bool OAICategoricalMeasureField::is_format_configuration_Set() const{
    return m_format_configuration_isSet;
}

bool OAICategoricalMeasureField::is_format_configuration_Valid() const{
    return m_format_configuration_isValid;
}

bool OAICategoricalMeasureField::isSet() const {
...
bool OAICategoricalMeasureField::isValid() const {
