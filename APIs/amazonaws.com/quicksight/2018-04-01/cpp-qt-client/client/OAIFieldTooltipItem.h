...
/*
 * OAIFieldTooltipItem.h
 *
 * The tooltip item for the fields.
 */

#ifndef OAIFieldTooltipItem_H
#define OAIFieldTooltipItem_H
...
class OAIFieldTooltipItem : public OAIObject {
public:
    OAIFieldTooltipItem();
    OAIFieldTooltipItem(QString json);
    ~OAIFieldTooltipItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldTooltipItem)

#endif // OAIFieldTooltipItem_H
