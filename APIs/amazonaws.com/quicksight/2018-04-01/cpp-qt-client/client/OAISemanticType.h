...
#ifndef OAISemanticType_H
#define OAISemanticType_H
...
class OAISemanticType : public OAIObject {
public:
    OAISemanticType();
    OAISemanticType(QString json);
    ~OAISemanticType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISemanticType)

#endif // OAISemanticType_H
