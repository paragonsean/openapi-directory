...
/*
 * OAIStringParameterDeclaration.h
 *
 * A parameter declaration for the &lt;code&gt;String&lt;/code&gt; data type.
 */

#ifndef OAIStringParameterDeclaration_H
#define OAIStringParameterDeclaration_H
...
class OAIStringParameterDeclaration : public OAIObject {
public:
    OAIStringParameterDeclaration();
    OAIStringParameterDeclaration(QString json);
    ~OAIStringParameterDeclaration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStringParameterDeclaration)

#endif // OAIStringParameterDeclaration_H
