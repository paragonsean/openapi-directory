...
/*
 * OAIUnaggregatedField_Column.h
 *
 * 
 */

#ifndef OAIUnaggregatedField_Column_H
#define OAIUnaggregatedField_Column_H
...
class OAIUnaggregatedField_Column : public OAIObject {
public:
    OAIUnaggregatedField_Column();
    OAIUnaggregatedField_Column(QString json);
    ~OAIUnaggregatedField_Column() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnaggregatedField_Column)

#endif // OAIUnaggregatedField_Column_H
