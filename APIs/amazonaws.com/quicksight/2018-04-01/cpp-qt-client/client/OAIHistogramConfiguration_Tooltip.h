...
/*
 * OAIHistogramConfiguration_Tooltip.h
 *
 * 
 */

#ifndef OAIHistogramConfiguration_Tooltip_H
#define OAIHistogramConfiguration_Tooltip_H
...
class OAIHistogramConfiguration_Tooltip : public OAIObject {
public:
    OAIHistogramConfiguration_Tooltip();
    OAIHistogramConfiguration_Tooltip(QString json);
    ~OAIHistogramConfiguration_Tooltip() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramConfiguration_Tooltip)

#endif // OAIHistogramConfiguration_Tooltip_H
