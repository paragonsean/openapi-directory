...
/*
 * OAICreateDashboardRequest_Definition.h
 *
 * 
 */

#ifndef OAICreateDashboardRequest_Definition_H
#define OAICreateDashboardRequest_Definition_H
...
class OAICreateDashboardRequest_Definition : public OAIObject {
public:
    OAICreateDashboardRequest_Definition();
    OAICreateDashboardRequest_Definition(QString json);
    ~OAICreateDashboardRequest_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDashboardRequest_Definition)

#endif // OAICreateDashboardRequest_Definition_H
