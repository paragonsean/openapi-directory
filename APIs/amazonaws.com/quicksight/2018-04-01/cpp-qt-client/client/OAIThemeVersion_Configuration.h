...
/*
 * OAIThemeVersion_Configuration.h
 *
 * 
 */

#ifndef OAIThemeVersion_Configuration_H
#define OAIThemeVersion_Configuration_H
...
class OAIThemeVersion_Configuration : public OAIObject {
public:
    OAIThemeVersion_Configuration();
    OAIThemeVersion_Configuration(QString json);
    ~OAIThemeVersion_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIThemeVersion_Configuration)

#endif // OAIThemeVersion_Configuration_H
