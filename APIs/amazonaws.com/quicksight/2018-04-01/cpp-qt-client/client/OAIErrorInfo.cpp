...
OAIIngestionErrorType OAIErrorInfo::getType() const {
    return m_type;
}
void OAIErrorInfo::setType(const OAIIngestionErrorType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIErrorInfo::is_type_Set() const{
    return m_type_isSet;
}

bool OAIErrorInfo::is_type_Valid() const{
