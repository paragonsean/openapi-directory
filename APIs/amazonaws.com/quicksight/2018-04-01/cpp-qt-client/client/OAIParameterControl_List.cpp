...
OAIParameterControl_List::OAIParameterControl_List(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParameterControl_List::OAIParameterControl_List() {
    this->initializeModel();
}

OAIParameterControl_List::~OAIParameterControl_List() {}

void OAIParameterControl_List::initializeModel() {
...
void OAIParameterControl_List::fromJson(QString jsonString) {
...
void OAIParameterControl_List::fromJsonObject(QJsonObject json) {
...
QString OAIParameterControl_List::asJson() const {
...
QJsonObject OAIParameterControl_List::asJsonObject() const {
    QJsonObject obj;
...
QString OAIParameterControl_List::getParameterControlId() const {
    return m_parameter_control_id;
}
void OAIParameterControl_List::setParameterControlId(const QString &parameter_control_id) {
    m_parameter_control_id = parameter_control_id;
    m_parameter_control_id_isSet = true;
}

bool OAIParameterControl_List::is_parameter_control_id_Set() const{
    return m_parameter_control_id_isSet;
}

bool OAIParameterControl_List::is_parameter_control_id_Valid() const{
    return m_parameter_control_id_isValid;
}

QString OAIParameterControl_List::getTitle() const {
    return m_title;
}
void OAIParameterControl_List::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIParameterControl_List::is_title_Set() const{
    return m_title_isSet;
}

bool OAIParameterControl_List::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIParameterControl_List::getSourceParameterName() const {
    return m_source_parameter_name;
}
void OAIParameterControl_List::setSourceParameterName(const QString &source_parameter_name) {
    m_source_parameter_name = source_parameter_name;
    m_source_parameter_name_isSet = true;
}

bool OAIParameterControl_List::is_source_parameter_name_Set() const{
    return m_source_parameter_name_isSet;
}

bool OAIParameterControl_List::is_source_parameter_name_Valid() const{
    return m_source_parameter_name_isValid;
}

OAIFilterListControl_DisplayOptions OAIParameterControl_List::getDisplayOptions() const {
    return m_display_options;
}
void OAIParameterControl_List::setDisplayOptions(const OAIFilterListControl_DisplayOptions &display_options) {
    m_display_options = display_options;
    m_display_options_isSet = true;
}

bool OAIParameterControl_List::is_display_options_Set() const{
    return m_display_options_isSet;
}

bool OAIParameterControl_List::is_display_options_Valid() const{
    return m_display_options_isValid;
}

OAISheetControlListType OAIParameterControl_List::getType() const {
    return m_type;
}
void OAIParameterControl_List::setType(const OAISheetControlListType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIParameterControl_List::is_type_Set() const{
    return m_type_isSet;
}

bool OAIParameterControl_List::is_type_Valid() const{
    return m_type_isValid;
}

OAIParameterListControl_SelectableValues OAIParameterControl_List::getSelectableValues() const {
    return m_selectable_values;
}
void OAIParameterControl_List::setSelectableValues(const OAIParameterListControl_SelectableValues &selectable_values) {
    m_selectable_values = selectable_values;
    m_selectable_values_isSet = true;
}

bool OAIParameterControl_List::is_selectable_values_Set() const{
    return m_selectable_values_isSet;
}

bool OAIParameterControl_List::is_selectable_values_Valid() const{
    return m_selectable_values_isValid;
}

OAIFilterListControl_CascadingControlConfiguration OAIParameterControl_List::getCascadingControlConfiguration() const {
    return m_cascading_control_configuration;
}
void OAIParameterControl_List::setCascadingControlConfiguration(const OAIFilterListControl_CascadingControlConfiguration &cascading_control_configuration) {
    m_cascading_control_configuration = cascading_control_configuration;
    m_cascading_control_configuration_isSet = true;
}

bool OAIParameterControl_List::is_cascading_control_configuration_Set() const{
    return m_cascading_control_configuration_isSet;
}

bool OAIParameterControl_List::is_cascading_control_configuration_Valid() const{
    return m_cascading_control_configuration_isValid;
}

bool OAIParameterControl_List::isSet() const {
...
bool OAIParameterControl_List::isValid() const {
