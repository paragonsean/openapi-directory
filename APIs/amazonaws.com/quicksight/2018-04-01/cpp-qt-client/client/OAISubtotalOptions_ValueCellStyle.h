...
/*
 * OAISubtotalOptions_ValueCellStyle.h
 *
 * 
 */

#ifndef OAISubtotalOptions_ValueCellStyle_H
#define OAISubtotalOptions_ValueCellStyle_H
...
class OAISubtotalOptions_ValueCellStyle : public OAIObject {
public:
    OAISubtotalOptions_ValueCellStyle();
    OAISubtotalOptions_ValueCellStyle(QString json);
    ~OAISubtotalOptions_ValueCellStyle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubtotalOptions_ValueCellStyle)

#endif // OAISubtotalOptions_ValueCellStyle_H
