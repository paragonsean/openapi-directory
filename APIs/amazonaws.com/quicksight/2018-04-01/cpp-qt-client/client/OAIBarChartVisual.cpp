...
OAIBarChartVisual::OAIBarChartVisual(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBarChartVisual::OAIBarChartVisual() {
    this->initializeModel();
}

OAIBarChartVisual::~OAIBarChartVisual() {}

void OAIBarChartVisual::initializeModel() {
...
void OAIBarChartVisual::fromJson(QString jsonString) {
...
void OAIBarChartVisual::fromJsonObject(QJsonObject json) {
...
QString OAIBarChartVisual::asJson() const {
...
QJsonObject OAIBarChartVisual::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBarChartVisual::getVisualId() const {
    return m_visual_id;
}
void OAIBarChartVisual::setVisualId(const QString &visual_id) {
    m_visual_id = visual_id;
    m_visual_id_isSet = true;
}

bool OAIBarChartVisual::is_visual_id_Set() const{
    return m_visual_id_isSet;
}

bool OAIBarChartVisual::is_visual_id_Valid() const{
    return m_visual_id_isValid;
}

OAIBarChartVisual_Title OAIBarChartVisual::getTitle() const {
    return m_title;
}
void OAIBarChartVisual::setTitle(const OAIBarChartVisual_Title &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIBarChartVisual::is_title_Set() const{
    return m_title_isSet;
}

bool OAIBarChartVisual::is_title_Valid() const{
    return m_title_isValid;
}

OAIBarChartVisual_Subtitle OAIBarChartVisual::getSubtitle() const {
    return m_subtitle;
}
void OAIBarChartVisual::setSubtitle(const OAIBarChartVisual_Subtitle &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAIBarChartVisual::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAIBarChartVisual::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

OAIBarChartVisual_ChartConfiguration OAIBarChartVisual::getChartConfiguration() const {
    return m_chart_configuration;
}
void OAIBarChartVisual::setChartConfiguration(const OAIBarChartVisual_ChartConfiguration &chart_configuration) {
    m_chart_configuration = chart_configuration;
    m_chart_configuration_isSet = true;
}

bool OAIBarChartVisual::is_chart_configuration_Set() const{
    return m_chart_configuration_isSet;
}

bool OAIBarChartVisual::is_chart_configuration_Valid() const{
    return m_chart_configuration_isValid;
}

QList OAIBarChartVisual::getActions() const {
    return m_actions;
}
void OAIBarChartVisual::setActions(const QList &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIBarChartVisual::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIBarChartVisual::is_actions_Valid() const{
    return m_actions_isValid;
}

QList OAIBarChartVisual::getColumnHierarchies() const {
    return m_column_hierarchies;
}
void OAIBarChartVisual::setColumnHierarchies(const QList &column_hierarchies) {
    m_column_hierarchies = column_hierarchies;
    m_column_hierarchies_isSet = true;
}

bool OAIBarChartVisual::is_column_hierarchies_Set() const{
    return m_column_hierarchies_isSet;
}

bool OAIBarChartVisual::is_column_hierarchies_Valid() const{
    return m_column_hierarchies_isValid;
}

bool OAIBarChartVisual::isSet() const {
...
bool OAIBarChartVisual::isValid() const {
