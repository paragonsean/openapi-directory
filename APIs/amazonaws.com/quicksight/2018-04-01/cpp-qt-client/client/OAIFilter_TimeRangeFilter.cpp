...
OAIFilter_TimeRangeFilter::OAIFilter_TimeRangeFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilter_TimeRangeFilter::OAIFilter_TimeRangeFilter() {
    this->initializeModel();
}

OAIFilter_TimeRangeFilter::~OAIFilter_TimeRangeFilter() {}

void OAIFilter_TimeRangeFilter::initializeModel() {
...
void OAIFilter_TimeRangeFilter::fromJson(QString jsonString) {
...
void OAIFilter_TimeRangeFilter::fromJsonObject(QJsonObject json) {
...
QString OAIFilter_TimeRangeFilter::asJson() const {
...
QJsonObject OAIFilter_TimeRangeFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFilter_TimeRangeFilter::getFilterId() const {
    return m_filter_id;
}
void OAIFilter_TimeRangeFilter::setFilterId(const QString &filter_id) {
    m_filter_id = filter_id;
    m_filter_id_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_filter_id_Set() const{
    return m_filter_id_isSet;
}

bool OAIFilter_TimeRangeFilter::is_filter_id_Valid() const{
    return m_filter_id_isValid;
}

OAICategoryDrillDownFilter_Column OAIFilter_TimeRangeFilter::getColumn() const {
    return m_column;
}
void OAIFilter_TimeRangeFilter::setColumn(const OAICategoryDrillDownFilter_Column &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_column_Set() const{
    return m_column_isSet;
}

bool OAIFilter_TimeRangeFilter::is_column_Valid() const{
    return m_column_isValid;
}

bool OAIFilter_TimeRangeFilter::getIncludeMinimum() const {
    return m_include_minimum;
}
void OAIFilter_TimeRangeFilter::setIncludeMinimum(const bool &include_minimum) {
    m_include_minimum = include_minimum;
    m_include_minimum_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_include_minimum_Set() const{
    return m_include_minimum_isSet;
}

bool OAIFilter_TimeRangeFilter::is_include_minimum_Valid() const{
    return m_include_minimum_isValid;
}

bool OAIFilter_TimeRangeFilter::getIncludeMaximum() const {
    return m_include_maximum;
}
void OAIFilter_TimeRangeFilter::setIncludeMaximum(const bool &include_maximum) {
    m_include_maximum = include_maximum;
    m_include_maximum_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_include_maximum_Set() const{
    return m_include_maximum_isSet;
}

bool OAIFilter_TimeRangeFilter::is_include_maximum_Valid() const{
    return m_include_maximum_isValid;
}

OAITimeRangeFilter_RangeMinimumValue OAIFilter_TimeRangeFilter::getRangeMinimumValue() const {
    return m_range_minimum_value;
}
void OAIFilter_TimeRangeFilter::setRangeMinimumValue(const OAITimeRangeFilter_RangeMinimumValue &range_minimum_value) {
    m_range_minimum_value = range_minimum_value;
    m_range_minimum_value_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_range_minimum_value_Set() const{
    return m_range_minimum_value_isSet;
}

bool OAIFilter_TimeRangeFilter::is_range_minimum_value_Valid() const{
    return m_range_minimum_value_isValid;
}

OAITimeRangeFilter_RangeMaximumValue OAIFilter_TimeRangeFilter::getRangeMaximumValue() const {
    return m_range_maximum_value;
}
void OAIFilter_TimeRangeFilter::setRangeMaximumValue(const OAITimeRangeFilter_RangeMaximumValue &range_maximum_value) {
    m_range_maximum_value = range_maximum_value;
    m_range_maximum_value_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_range_maximum_value_Set() const{
    return m_range_maximum_value_isSet;
}

bool OAIFilter_TimeRangeFilter::is_range_maximum_value_Valid() const{
    return m_range_maximum_value_isValid;
}

OAIFilterNullOption OAIFilter_TimeRangeFilter::getNullOption() const {
    return m_null_option;
}
void OAIFilter_TimeRangeFilter::setNullOption(const OAIFilterNullOption &null_option) {
    m_null_option = null_option;
    m_null_option_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_null_option_Set() const{
    return m_null_option_isSet;
}

bool OAIFilter_TimeRangeFilter::is_null_option_Valid() const{
    return m_null_option_isValid;
}

OAITimeRangeFilter_ExcludePeriodConfiguration OAIFilter_TimeRangeFilter::getExcludePeriodConfiguration() const {
    return m_exclude_period_configuration;
}
void OAIFilter_TimeRangeFilter::setExcludePeriodConfiguration(const OAITimeRangeFilter_ExcludePeriodConfiguration &exclude_period_configuration) {
    m_exclude_period_configuration = exclude_period_configuration;
    m_exclude_period_configuration_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_exclude_period_configuration_Set() const{
    return m_exclude_period_configuration_isSet;
}

bool OAIFilter_TimeRangeFilter::is_exclude_period_configuration_Valid() const{
    return m_exclude_period_configuration_isValid;
}

OAITimeGranularity OAIFilter_TimeRangeFilter::getTimeGranularity() const {
    return m_time_granularity;
}
void OAIFilter_TimeRangeFilter::setTimeGranularity(const OAITimeGranularity &time_granularity) {
    m_time_granularity = time_granularity;
    m_time_granularity_isSet = true;
}

bool OAIFilter_TimeRangeFilter::is_time_granularity_Set() const{
    return m_time_granularity_isSet;
}

bool OAIFilter_TimeRangeFilter::is_time_granularity_Valid() const{
    return m_time_granularity_isValid;
}

bool OAIFilter_TimeRangeFilter::isSet() const {
...
bool OAIFilter_TimeRangeFilter::isValid() const {
