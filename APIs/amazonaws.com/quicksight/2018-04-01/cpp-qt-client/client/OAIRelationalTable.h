...
/*
 * OAIRelationalTable.h
 *
 * A physical table type for relational data sources.
 */

#ifndef OAIRelationalTable_H
#define OAIRelationalTable_H
...
class OAIRelationalTable : public OAIObject {
public:
    OAIRelationalTable();
    OAIRelationalTable(QString json);
    ~OAIRelationalTable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRelationalTable)

#endif // OAIRelationalTable_H
