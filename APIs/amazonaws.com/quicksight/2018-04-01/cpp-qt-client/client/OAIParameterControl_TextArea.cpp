...
OAIParameterControl_TextArea::OAIParameterControl_TextArea(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIParameterControl_TextArea::OAIParameterControl_TextArea() {
    this->initializeModel();
}

OAIParameterControl_TextArea::~OAIParameterControl_TextArea() {}

void OAIParameterControl_TextArea::initializeModel() {
...
void OAIParameterControl_TextArea::fromJson(QString jsonString) {
...
void OAIParameterControl_TextArea::fromJsonObject(QJsonObject json) {
...
QString OAIParameterControl_TextArea::asJson() const {
...
QJsonObject OAIParameterControl_TextArea::asJsonObject() const {
    QJsonObject obj;
...
QString OAIParameterControl_TextArea::getParameterControlId() const {
    return m_parameter_control_id;
}
void OAIParameterControl_TextArea::setParameterControlId(const QString &parameter_control_id) {
    m_parameter_control_id = parameter_control_id;
    m_parameter_control_id_isSet = true;
}

bool OAIParameterControl_TextArea::is_parameter_control_id_Set() const{
    return m_parameter_control_id_isSet;
}

bool OAIParameterControl_TextArea::is_parameter_control_id_Valid() const{
    return m_parameter_control_id_isValid;
}

QString OAIParameterControl_TextArea::getTitle() const {
    return m_title;
}
void OAIParameterControl_TextArea::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIParameterControl_TextArea::is_title_Set() const{
    return m_title_isSet;
}

bool OAIParameterControl_TextArea::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIParameterControl_TextArea::getSourceParameterName() const {
    return m_source_parameter_name;
}
void OAIParameterControl_TextArea::setSourceParameterName(const QString &source_parameter_name) {
    m_source_parameter_name = source_parameter_name;
    m_source_parameter_name_isSet = true;
}

bool OAIParameterControl_TextArea::is_source_parameter_name_Set() const{
    return m_source_parameter_name_isSet;
}

bool OAIParameterControl_TextArea::is_source_parameter_name_Valid() const{
    return m_source_parameter_name_isValid;
}

QString OAIParameterControl_TextArea::getDelimiter() const {
    return m_delimiter;
}
void OAIParameterControl_TextArea::setDelimiter(const QString &delimiter) {
    m_delimiter = delimiter;
    m_delimiter_isSet = true;
}

bool OAIParameterControl_TextArea::is_delimiter_Set() const{
    return m_delimiter_isSet;
}

bool OAIParameterControl_TextArea::is_delimiter_Valid() const{
    return m_delimiter_isValid;
}

OAIFilterTextAreaControl_DisplayOptions OAIParameterControl_TextArea::getDisplayOptions() const {
    return m_display_options;
}
void OAIParameterControl_TextArea::setDisplayOptions(const OAIFilterTextAreaControl_DisplayOptions &display_options) {
    m_display_options = display_options;
    m_display_options_isSet = true;
}

bool OAIParameterControl_TextArea::is_display_options_Set() const{
    return m_display_options_isSet;
}

bool OAIParameterControl_TextArea::is_display_options_Valid() const{
    return m_display_options_isValid;
}

bool OAIParameterControl_TextArea::isSet() const {
...
bool OAIParameterControl_TextArea::isValid() const {
