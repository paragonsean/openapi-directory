...
/*
 * OAIComboChartConfiguration_CategoryAxis.h
 *
 * 
 */

#ifndef OAIComboChartConfiguration_CategoryAxis_H
#define OAIComboChartConfiguration_CategoryAxis_H
...
class OAIComboChartConfiguration_CategoryAxis : public OAIObject {
public:
    OAIComboChartConfiguration_CategoryAxis();
    OAIComboChartConfiguration_CategoryAxis(QString json);
    ~OAIComboChartConfiguration_CategoryAxis() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComboChartConfiguration_CategoryAxis)

#endif // OAIComboChartConfiguration_CategoryAxis_H
