...
/*
 * OAIComputation_MaximumMinimum.h
 *
 * 
 */

#ifndef OAIComputation_MaximumMinimum_H
#define OAIComputation_MaximumMinimum_H

#include <QJsonObject>

#include "OAIMaximumMinimumComputationType.h"
...
class OAIComputation_MaximumMinimum : public OAIObject {
public:
    OAIComputation_MaximumMinimum();
    OAIComputation_MaximumMinimum(QString json);
    ~OAIComputation_MaximumMinimum() override;
    ...
    OAIMaximumMinimumComputationType getType() const;
    void setType(const OAIMaximumMinimumComputationType &type);
...
private:
    ...
    OAIMaximumMinimumComputationType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIComputation_MaximumMinimum)

#endif // OAIComputation_MaximumMinimum_H
