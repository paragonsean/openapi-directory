...
/*
 * OAICreateNamespaceResponse.h
 *
 * 
 */

#ifndef OAICreateNamespaceResponse_H
#define OAICreateNamespaceResponse_H
...
class OAICreateNamespaceResponse : public OAIObject {
public:
    OAICreateNamespaceResponse();
    OAICreateNamespaceResponse(QString json);
    ~OAICreateNamespaceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNamespaceResponse)

#endif // OAICreateNamespaceResponse_H
