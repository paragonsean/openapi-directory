...
/*
 * OAIFilterDateTimePickerControl_DisplayOptions.h
 *
 * 
 */

#ifndef OAIFilterDateTimePickerControl_DisplayOptions_H
#define OAIFilterDateTimePickerControl_DisplayOptions_H
...
class OAIFilterDateTimePickerControl_DisplayOptions : public OAIObject {
public:
    OAIFilterDateTimePickerControl_DisplayOptions();
    OAIFilterDateTimePickerControl_DisplayOptions(QString json);
    ~OAIFilterDateTimePickerControl_DisplayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFilterDateTimePickerControl_DisplayOptions)

#endif // OAIFilterDateTimePickerControl_DisplayOptions_H
