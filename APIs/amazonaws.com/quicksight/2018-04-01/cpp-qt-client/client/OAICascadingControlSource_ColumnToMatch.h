...
/*
 * OAICascadingControlSource_ColumnToMatch.h
 *
 * 
 */

#ifndef OAICascadingControlSource_ColumnToMatch_H
#define OAICascadingControlSource_ColumnToMatch_H
...
class OAICascadingControlSource_ColumnToMatch : public OAIObject {
public:
    OAICascadingControlSource_ColumnToMatch();
    OAICascadingControlSource_ColumnToMatch(QString json);
    ~OAICascadingControlSource_ColumnToMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICascadingControlSource_ColumnToMatch)

#endif // OAICascadingControlSource_ColumnToMatch_H
