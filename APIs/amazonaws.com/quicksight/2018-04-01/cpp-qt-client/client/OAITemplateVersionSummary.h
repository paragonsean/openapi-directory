...
/*
 * OAITemplateVersionSummary.h
 *
 * The template version.
 */

#ifndef OAITemplateVersionSummary_H
#define OAITemplateVersionSummary_H
...
class OAITemplateVersionSummary : public OAIObject {
public:
    OAITemplateVersionSummary();
    OAITemplateVersionSummary(QString json);
    ~OAITemplateVersionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateVersionSummary)

#endif // OAITemplateVersionSummary_H
