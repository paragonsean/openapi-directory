...
OAIFilterControl_Dropdown::OAIFilterControl_Dropdown(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilterControl_Dropdown::OAIFilterControl_Dropdown() {
    this->initializeModel();
}

OAIFilterControl_Dropdown::~OAIFilterControl_Dropdown() {}

void OAIFilterControl_Dropdown::initializeModel() {
...
void OAIFilterControl_Dropdown::fromJson(QString jsonString) {
...
void OAIFilterControl_Dropdown::fromJsonObject(QJsonObject json) {
...
QString OAIFilterControl_Dropdown::asJson() const {
...
QJsonObject OAIFilterControl_Dropdown::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFilterControl_Dropdown::getFilterControlId() const {
    return m_filter_control_id;
}
void OAIFilterControl_Dropdown::setFilterControlId(const QString &filter_control_id) {
    m_filter_control_id = filter_control_id;
    m_filter_control_id_isSet = true;
}

bool OAIFilterControl_Dropdown::is_filter_control_id_Set() const{
    return m_filter_control_id_isSet;
}

bool OAIFilterControl_Dropdown::is_filter_control_id_Valid() const{
    return m_filter_control_id_isValid;
}

QString OAIFilterControl_Dropdown::getTitle() const {
    return m_title;
}
void OAIFilterControl_Dropdown::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIFilterControl_Dropdown::is_title_Set() const{
    return m_title_isSet;
}

bool OAIFilterControl_Dropdown::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIFilterControl_Dropdown::getSourceFilterId() const {
    return m_source_filter_id;
}
void OAIFilterControl_Dropdown::setSourceFilterId(const QString &source_filter_id) {
    m_source_filter_id = source_filter_id;
    m_source_filter_id_isSet = true;
}

bool OAIFilterControl_Dropdown::is_source_filter_id_Set() const{
    return m_source_filter_id_isSet;
}

bool OAIFilterControl_Dropdown::is_source_filter_id_Valid() const{
    return m_source_filter_id_isValid;
}

OAIFilterDropDownControl_DisplayOptions OAIFilterControl_Dropdown::getDisplayOptions() const {
    return m_display_options;
}
void OAIFilterControl_Dropdown::setDisplayOptions(const OAIFilterDropDownControl_DisplayOptions &display_options) {
    m_display_options = display_options;
    m_display_options_isSet = true;
}

bool OAIFilterControl_Dropdown::is_display_options_Set() const{
    return m_display_options_isSet;
}

bool OAIFilterControl_Dropdown::is_display_options_Valid() const{
    return m_display_options_isValid;
}

OAISheetControlListType OAIFilterControl_Dropdown::getType() const {
    return m_type;
}
void OAIFilterControl_Dropdown::setType(const OAISheetControlListType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFilterControl_Dropdown::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFilterControl_Dropdown::is_type_Valid() const{
    return m_type_isValid;
}

OAIFilterListControl_SelectableValues OAIFilterControl_Dropdown::getSelectableValues() const {
    return m_selectable_values;
}
void OAIFilterControl_Dropdown::setSelectableValues(const OAIFilterListControl_SelectableValues &selectable_values) {
    m_selectable_values = selectable_values;
    m_selectable_values_isSet = true;
}

bool OAIFilterControl_Dropdown::is_selectable_values_Set() const{
    return m_selectable_values_isSet;
}

bool OAIFilterControl_Dropdown::is_selectable_values_Valid() const{
    return m_selectable_values_isValid;
}

OAIFilterListControl_CascadingControlConfiguration OAIFilterControl_Dropdown::getCascadingControlConfiguration() const {
    return m_cascading_control_configuration;
}
void OAIFilterControl_Dropdown::setCascadingControlConfiguration(const OAIFilterListControl_CascadingControlConfiguration &cascading_control_configuration) {
    m_cascading_control_configuration = cascading_control_configuration;
    m_cascading_control_configuration_isSet = true;
}

bool OAIFilterControl_Dropdown::is_cascading_control_configuration_Set() const{
    return m_cascading_control_configuration_isSet;
}

bool OAIFilterControl_Dropdown::is_cascading_control_configuration_Valid() const{
    return m_cascading_control_configuration_isValid;
}

bool OAIFilterControl_Dropdown::isSet() const {
...
bool OAIFilterControl_Dropdown::isValid() const {
