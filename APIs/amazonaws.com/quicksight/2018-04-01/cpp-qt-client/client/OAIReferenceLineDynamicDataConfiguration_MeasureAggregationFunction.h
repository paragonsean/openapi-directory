...
/*
 * OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction.h
 *
 * 
 */

#ifndef OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction_H
#define OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction_H
...
class OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction : public OAIObject {
public:
    OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction();
    OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction(QString json);
    ~OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction)

#endif // OAIReferenceLineDynamicDataConfiguration_MeasureAggregationFunction_H
