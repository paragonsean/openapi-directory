...
/*
 * OAIUpdateAnalysis_request_Definition.h
 *
 * The definition of an analysis.
 */

#ifndef OAIUpdateAnalysis_request_Definition_H
#define OAIUpdateAnalysis_request_Definition_H
...
class OAIUpdateAnalysis_request_Definition : public OAIObject {
public:
    OAIUpdateAnalysis_request_Definition();
    OAIUpdateAnalysis_request_Definition(QString json);
    ~OAIUpdateAnalysis_request_Definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAnalysis_request_Definition)

#endif // OAIUpdateAnalysis_request_Definition_H
