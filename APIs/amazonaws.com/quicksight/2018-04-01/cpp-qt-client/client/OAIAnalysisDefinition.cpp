...
QList OAIAnalysisDefinition::getDataSetIdentifierDeclarations() const {
    return m_data_set_identifier_declarations;
}
void OAIAnalysisDefinition::setDataSetIdentifierDeclarations(const QList &data_set_identifier_declarations) {
    m_data_set_identifier_declarations = data_set_identifier_declarations;
    m_data_set_identifier_declarations_isSet = true;
}

bool OAIAnalysisDefinition::is_data_set_identifier_declarations_Set() const{
    return m_data_set_identifier_declarations_isSet;
}

bool OAIAnalysisDefinition::is_data_set_identifier_declarations_Valid() const{
    return m_data_set_identifier_declarations_isValid;
}

QList OAIAnalysisDefinition::getSheets() const {
    return m_sheets;
}
void OAIAnalysisDefinition::setSheets(const QList &sheets) {
    m_sheets = sheets;
    m_sheets_isSet = true;
}

bool OAIAnalysisDefinition::is_sheets_Set() const{
    return m_sheets_isSet;
}

bool OAIAnalysisDefinition::is_sheets_Valid() const{
    return m_sheets_isValid;
}

QList OAIAnalysisDefinition::getCalculatedFields() const {
    return m_calculated_fields;
}
void OAIAnalysisDefinition::setCalculatedFields(const QList &calculated_fields) {
    m_calculated_fields = calculated_fields;
    m_calculated_fields_isSet = true;
}

bool OAIAnalysisDefinition::is_calculated_fields_Set() const{
    return m_calculated_fields_isSet;
}

bool OAIAnalysisDefinition::is_calculated_fields_Valid() const{
    return m_calculated_fields_isValid;
}

QList OAIAnalysisDefinition::getParameterDeclarations() const {
    return m_parameter_declarations;
}
void OAIAnalysisDefinition::setParameterDeclarations(const QList &parameter_declarations) {
    m_parameter_declarations = parameter_declarations;
    m_parameter_declarations_isSet = true;
}

bool OAIAnalysisDefinition::is_parameter_declarations_Set() const{
    return m_parameter_declarations_isSet;
}

bool OAIAnalysisDefinition::is_parameter_declarations_Valid() const{
    return m_parameter_declarations_isValid;
}

QList OAIAnalysisDefinition::getFilterGroups() const {
    return m_filter_groups;
}
void OAIAnalysisDefinition::setFilterGroups(const QList &filter_groups) {
    m_filter_groups = filter_groups;
    m_filter_groups_isSet = true;
}

bool OAIAnalysisDefinition::is_filter_groups_Set() const{
    return m_filter_groups_isSet;
}

bool OAIAnalysisDefinition::is_filter_groups_Valid() const{
    return m_filter_groups_isValid;
}

QList OAIAnalysisDefinition::getColumnConfigurations() const {
    return m_column_configurations;
}
void OAIAnalysisDefinition::setColumnConfigurations(const QList &column_configurations) {
    m_column_configurations = column_configurations;
    m_column_configurations_isSet = true;
}

bool OAIAnalysisDefinition::is_column_configurations_Set() const{
    return m_column_configurations_isSet;
}

bool OAIAnalysisDefinition::is_column_configurations_Valid() const{
    return m_column_configurations_isValid;
}

OAIAnalysisDefaults OAIAnalysisDefinition::getAnalysisDefaults() const {
    return m_analysis_defaults;
}
void OAIAnalysisDefinition::setAnalysisDefaults(const OAIAnalysisDefaults &analysis_defaults) {
    m_analysis_defaults = analysis_defaults;
    m_analysis_defaults_isSet = true;
}

bool OAIAnalysisDefinition::is_analysis_defaults_Set() const{
    return m_analysis_defaults_isSet;
}

bool OAIAnalysisDefinition::is_analysis_defaults_Valid() const{
