...
/*
 * OAIDescribeDataSourcePermissionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeDataSourcePermissionsResponse_H
#define OAIDescribeDataSourcePermissionsResponse_H
...
class OAIDescribeDataSourcePermissionsResponse : public OAIObject {
public:
    OAIDescribeDataSourcePermissionsResponse();
    OAIDescribeDataSourcePermissionsResponse(QString json);
    ~OAIDescribeDataSourcePermissionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataSourcePermissionsResponse)

#endif // OAIDescribeDataSourcePermissionsResponse_H
