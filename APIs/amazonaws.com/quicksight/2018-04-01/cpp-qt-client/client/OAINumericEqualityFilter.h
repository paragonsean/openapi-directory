...
/*
 * OAINumericEqualityFilter.h
 *
 * A &lt;code&gt;NumericEqualityFilter&lt;/code&gt; filters values that are equal to the specified value.
 */

#ifndef OAINumericEqualityFilter_H
#define OAINumericEqualityFilter_H
...
class OAINumericEqualityFilter : public OAIObject {
public:
    OAINumericEqualityFilter();
    OAINumericEqualityFilter(QString json);
    ~OAINumericEqualityFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumericEqualityFilter)

#endif // OAINumericEqualityFilter_H
