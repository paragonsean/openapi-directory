...
/*
 * OAILineChartMarkerStyleSettings.h
 *
 * Marker styles options for a line series in &lt;code&gt;LineChartVisual&lt;/code&gt;.
 */

#ifndef OAILineChartMarkerStyleSettings_H
#define OAILineChartMarkerStyleSettings_H
...
class OAILineChartMarkerStyleSettings : public OAIObject {
public:
    OAILineChartMarkerStyleSettings();
    OAILineChartMarkerStyleSettings(QString json);
    ~OAILineChartMarkerStyleSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILineChartMarkerStyleSettings)

#endif // OAILineChartMarkerStyleSettings_H
