...
/*
 * OAIDescribeIngestionResponse_Ingestion.h
 *
 * 
 */

#ifndef OAIDescribeIngestionResponse_Ingestion_H
#define OAIDescribeIngestionResponse_Ingestion_H
...
class OAIDescribeIngestionResponse_Ingestion : public OAIObject {
public:
    OAIDescribeIngestionResponse_Ingestion();
    OAIDescribeIngestionResponse_Ingestion(QString json);
    ~OAIDescribeIngestionResponse_Ingestion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeIngestionResponse_Ingestion)

#endif // OAIDescribeIngestionResponse_Ingestion_H
