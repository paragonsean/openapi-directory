...
#ifndef OAIBundleDetails_H
#define OAIBundleDetails_H
...
class OAIBundleDetails : public OAIObject {
public:
    OAIBundleDetails();
    OAIBundleDetails(QString json);
    ~OAIBundleDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBundleDetails)

#endif // OAIBundleDetails_H
