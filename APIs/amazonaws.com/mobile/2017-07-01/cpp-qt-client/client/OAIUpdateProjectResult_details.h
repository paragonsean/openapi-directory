...
/*
 * OAIUpdateProjectResult_details.h
 *
 * 
 */

#ifndef OAIUpdateProjectResult_details_H
#define OAIUpdateProjectResult_details_H
...
class OAIUpdateProjectResult_details : public OAIObject {
public:
    OAIUpdateProjectResult_details();
    OAIUpdateProjectResult_details(QString json);
    ~OAIUpdateProjectResult_details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProjectResult_details)

#endif // OAIUpdateProjectResult_details_H
