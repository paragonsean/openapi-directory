...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMobile.ListProjectsResult();
  });
  ...
  describe('ListProjectsResult', function() {
    it('should create an instance of ListProjectsResult', function() {
      // uncomment below and update the code to test ListProjectsResult
      //var instance = new AwsMobile.ListProjectsResult();
      //expect(instance).to.be.a(AwsMobile.ListProjectsResult);
    });
