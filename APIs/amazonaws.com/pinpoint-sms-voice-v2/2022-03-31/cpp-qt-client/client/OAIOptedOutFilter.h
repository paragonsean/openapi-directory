...
#ifndef OAIOptedOutFilter_H
#define OAIOptedOutFilter_H
...
class OAIOptedOutFilter : public OAIObject {
public:
    OAIOptedOutFilter();
    OAIOptedOutFilter(QString json);
    ~OAIOptedOutFilter() override;
    ...
    OAIOptedOutFilterName getName() const;
    void setName(const OAIOptedOutFilterName &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptedOutFilter)

#endif // OAIOptedOutFilter_H
