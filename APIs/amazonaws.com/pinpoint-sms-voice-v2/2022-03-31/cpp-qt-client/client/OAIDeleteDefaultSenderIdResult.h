...
/*
 * OAIDeleteDefaultSenderIdResult.h
 *
 * 
 */

#ifndef OAIDeleteDefaultSenderIdResult_H
#define OAIDeleteDefaultSenderIdResult_H
...
class OAIDeleteDefaultSenderIdResult : public OAIObject {
public:
    OAIDeleteDefaultSenderIdResult();
    OAIDeleteDefaultSenderIdResult(QString json);
    ~OAIDeleteDefaultSenderIdResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDefaultSenderIdResult)

#endif // OAIDeleteDefaultSenderIdResult_H
