...
OAIDeleteOptOutListRequest::OAIDeleteOptOutListRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteOptOutListRequest::OAIDeleteOptOutListRequest() {
    this->initializeModel();
}

OAIDeleteOptOutListRequest::~OAIDeleteOptOutListRequest() {}

void OAIDeleteOptOutListRequest::initializeModel() {

    m_opt_out_list_name_isSet = false;
    m_opt_out_list_name_isValid = false;
}

void OAIDeleteOptOutListRequest::fromJson(QString jsonString) {
...
void OAIDeleteOptOutListRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteOptOutListRequest::asJson() const {
...
QJsonObject OAIDeleteOptOutListRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteOptOutListRequest::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIDeleteOptOutListRequest::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIDeleteOptOutListRequest::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIDeleteOptOutListRequest::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

bool OAIDeleteOptOutListRequest::isSet() const {
...
bool OAIDeleteOptOutListRequest::isValid() const {
