...
/*
 * OAIPutKeywordResult.h
 *
 * 
 */

#ifndef OAIPutKeywordResult_H
#define OAIPutKeywordResult_H
...
class OAIPutKeywordResult : public OAIObject {
public:
    OAIPutKeywordResult();
    OAIPutKeywordResult(QString json);
    ~OAIPutKeywordResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutKeywordResult)

#endif // OAIPutKeywordResult_H
