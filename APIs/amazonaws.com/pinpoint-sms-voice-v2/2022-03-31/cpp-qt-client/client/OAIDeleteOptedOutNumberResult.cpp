...
OAIDeleteOptedOutNumberResult::OAIDeleteOptedOutNumberResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteOptedOutNumberResult::OAIDeleteOptedOutNumberResult() {
    this->initializeModel();
}

OAIDeleteOptedOutNumberResult::~OAIDeleteOptedOutNumberResult() {}

void OAIDeleteOptedOutNumberResult::initializeModel() {
...
void OAIDeleteOptedOutNumberResult::fromJson(QString jsonString) {
...
void OAIDeleteOptedOutNumberResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteOptedOutNumberResult::asJson() const {
...
QJsonObject OAIDeleteOptedOutNumberResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteOptedOutNumberResult::getOptOutListArn() const {
    return m_opt_out_list_arn;
}
void OAIDeleteOptedOutNumberResult::setOptOutListArn(const QString &opt_out_list_arn) {
    m_opt_out_list_arn = opt_out_list_arn;
    m_opt_out_list_arn_isSet = true;
}

bool OAIDeleteOptedOutNumberResult::is_opt_out_list_arn_Set() const{
    return m_opt_out_list_arn_isSet;
}

bool OAIDeleteOptedOutNumberResult::is_opt_out_list_arn_Valid() const{
    return m_opt_out_list_arn_isValid;
}

QString OAIDeleteOptedOutNumberResult::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIDeleteOptedOutNumberResult::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIDeleteOptedOutNumberResult::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIDeleteOptedOutNumberResult::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

QString OAIDeleteOptedOutNumberResult::getOptedOutNumber() const {
    return m_opted_out_number;
}
void OAIDeleteOptedOutNumberResult::setOptedOutNumber(const QString &opted_out_number) {
    m_opted_out_number = opted_out_number;
    m_opted_out_number_isSet = true;
}

bool OAIDeleteOptedOutNumberResult::is_opted_out_number_Set() const{
    return m_opted_out_number_isSet;
}

bool OAIDeleteOptedOutNumberResult::is_opted_out_number_Valid() const{
    return m_opted_out_number_isValid;
}

QDateTime OAIDeleteOptedOutNumberResult::getOptedOutTimestamp() const {
    return m_opted_out_timestamp;
}
void OAIDeleteOptedOutNumberResult::setOptedOutTimestamp(const QDateTime &opted_out_timestamp) {
    m_opted_out_timestamp = opted_out_timestamp;
    m_opted_out_timestamp_isSet = true;
}

bool OAIDeleteOptedOutNumberResult::is_opted_out_timestamp_Set() const{
    return m_opted_out_timestamp_isSet;
}

bool OAIDeleteOptedOutNumberResult::is_opted_out_timestamp_Valid() const{
    return m_opted_out_timestamp_isValid;
}

bool OAIDeleteOptedOutNumberResult::getEndUserOptedOut() const {
    return m_end_user_opted_out;
}
void OAIDeleteOptedOutNumberResult::setEndUserOptedOut(const bool &end_user_opted_out) {
    m_end_user_opted_out = end_user_opted_out;
    m_end_user_opted_out_isSet = true;
}

bool OAIDeleteOptedOutNumberResult::is_end_user_opted_out_Set() const{
    return m_end_user_opted_out_isSet;
}

bool OAIDeleteOptedOutNumberResult::is_end_user_opted_out_Valid() const{
    return m_end_user_opted_out_isValid;
}

bool OAIDeleteOptedOutNumberResult::isSet() const {
...
bool OAIDeleteOptedOutNumberResult::isValid() const {
