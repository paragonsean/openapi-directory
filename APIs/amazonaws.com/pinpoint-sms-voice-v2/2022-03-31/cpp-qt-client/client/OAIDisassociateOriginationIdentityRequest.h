...
/*
 * OAIDisassociateOriginationIdentityRequest.h
 *
 * 
 */

#ifndef OAIDisassociateOriginationIdentityRequest_H
#define OAIDisassociateOriginationIdentityRequest_H
...
class OAIDisassociateOriginationIdentityRequest : public OAIObject {
public:
    OAIDisassociateOriginationIdentityRequest();
    OAIDisassociateOriginationIdentityRequest(QString json);
    ~OAIDisassociateOriginationIdentityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateOriginationIdentityRequest)

#endif // OAIDisassociateOriginationIdentityRequest_H
