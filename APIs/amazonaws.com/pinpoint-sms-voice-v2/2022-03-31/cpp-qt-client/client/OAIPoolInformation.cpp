...
QString OAIPoolInformation::getPoolArn() const {
    return m_pool_arn;
}
void OAIPoolInformation::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAIPoolInformation::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAIPoolInformation::is_pool_arn_Valid() const{
...
OAIPoolStatus OAIPoolInformation::getStatus() const {
    return m_status;
}
void OAIPoolInformation::setStatus(const OAIPoolStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPoolInformation::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPoolInformation::is_status_Valid() const{
    return m_status_isValid;
}

OAIMessageType OAIPoolInformation::getMessageType() const {
    return m_message_type;
}
void OAIPoolInformation::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIPoolInformation::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIPoolInformation::is_message_type_Valid() const{
    return m_message_type_isValid;
}

bool OAIPoolInformation::getTwoWayEnabled() const {
    return m_two_way_enabled;
}
void OAIPoolInformation::setTwoWayEnabled(const bool &two_way_enabled) {
    m_two_way_enabled = two_way_enabled;
    m_two_way_enabled_isSet = true;
}

bool OAIPoolInformation::is_two_way_enabled_Set() const{
    return m_two_way_enabled_isSet;
}

bool OAIPoolInformation::is_two_way_enabled_Valid() const{
    return m_two_way_enabled_isValid;
}

QString OAIPoolInformation::getTwoWayChannelArn() const {
    return m_two_way_channel_arn;
}
void OAIPoolInformation::setTwoWayChannelArn(const QString &two_way_channel_arn) {
    m_two_way_channel_arn = two_way_channel_arn;
    m_two_way_channel_arn_isSet = true;
}

bool OAIPoolInformation::is_two_way_channel_arn_Set() const{
    return m_two_way_channel_arn_isSet;
}

bool OAIPoolInformation::is_two_way_channel_arn_Valid() const{
    return m_two_way_channel_arn_isValid;
}

bool OAIPoolInformation::getSelfManagedOptOutsEnabled() const {
    return m_self_managed_opt_outs_enabled;
}
void OAIPoolInformation::setSelfManagedOptOutsEnabled(const bool &self_managed_opt_outs_enabled) {
    m_self_managed_opt_outs_enabled = self_managed_opt_outs_enabled;
    m_self_managed_opt_outs_enabled_isSet = true;
}

bool OAIPoolInformation::is_self_managed_opt_outs_enabled_Set() const{
    return m_self_managed_opt_outs_enabled_isSet;
}

bool OAIPoolInformation::is_self_managed_opt_outs_enabled_Valid() const{
    return m_self_managed_opt_outs_enabled_isValid;
}

QString OAIPoolInformation::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIPoolInformation::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIPoolInformation::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIPoolInformation::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

bool OAIPoolInformation::getSharedRoutesEnabled() const {
    return m_shared_routes_enabled;
}
void OAIPoolInformation::setSharedRoutesEnabled(const bool &shared_routes_enabled) {
    m_shared_routes_enabled = shared_routes_enabled;
    m_shared_routes_enabled_isSet = true;
}

bool OAIPoolInformation::is_shared_routes_enabled_Set() const{
    return m_shared_routes_enabled_isSet;
}

bool OAIPoolInformation::is_shared_routes_enabled_Valid() const{
    return m_shared_routes_enabled_isValid;
}

bool OAIPoolInformation::getDeletionProtectionEnabled() const {
    return m_deletion_protection_enabled;
}
void OAIPoolInformation::setDeletionProtectionEnabled(const bool &deletion_protection_enabled) {
    m_deletion_protection_enabled = deletion_protection_enabled;
    m_deletion_protection_enabled_isSet = true;
}

bool OAIPoolInformation::is_deletion_protection_enabled_Set() const{
    return m_deletion_protection_enabled_isSet;
}

bool OAIPoolInformation::is_deletion_protection_enabled_Valid() const{
    return m_deletion_protection_enabled_isValid;
}

QDateTime OAIPoolInformation::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIPoolInformation::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIPoolInformation::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIPoolInformation::is_created_timestamp_Valid() const{
...
bool OAIPoolInformation::isValid() const {
    ...
    return m_pool_arn_isValid && m_pool_id_isValid && m_status_isValid && m_message_type_isValid && m_two_way_enabled_isValid && m_self_managed_opt_outs_enabled_isValid && m_opt_out_list_name_isValid && m_shared_routes_enabled_isValid && m_deletion_protection_enabled_isValid && m_created_timestamp_isValid && true;
}
