...
#ifndef OAINumberType_H
#define OAINumberType_H
...
class OAINumberType : public OAIEnum {
public:
    OAINumberType();
    OAINumberType(QString json);
    ~OAINumberType() override;
    ...
    OAINumberType::eOAINumberType getValue() const;
    void setValue(const OAINumberType::eOAINumberType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberType)

#endif // OAINumberType_H
