...
OAIDeleteConfigurationSetResult::OAIDeleteConfigurationSetResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteConfigurationSetResult::OAIDeleteConfigurationSetResult() {
    this->initializeModel();
}

OAIDeleteConfigurationSetResult::~OAIDeleteConfigurationSetResult() {}

void OAIDeleteConfigurationSetResult::initializeModel() {
...
void OAIDeleteConfigurationSetResult::fromJson(QString jsonString) {
...
void OAIDeleteConfigurationSetResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteConfigurationSetResult::asJson() const {
...
QJsonObject OAIDeleteConfigurationSetResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteConfigurationSetResult::getConfigurationSetArn() const {
    return m_configuration_set_arn;
}
void OAIDeleteConfigurationSetResult::setConfigurationSetArn(const QString &configuration_set_arn) {
    m_configuration_set_arn = configuration_set_arn;
    m_configuration_set_arn_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_configuration_set_arn_Set() const{
    return m_configuration_set_arn_isSet;
}

bool OAIDeleteConfigurationSetResult::is_configuration_set_arn_Valid() const{
    return m_configuration_set_arn_isValid;
}

QString OAIDeleteConfigurationSetResult::getConfigurationSetName() const {
    return m_configuration_set_name;
}
void OAIDeleteConfigurationSetResult::setConfigurationSetName(const QString &configuration_set_name) {
    m_configuration_set_name = configuration_set_name;
    m_configuration_set_name_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_configuration_set_name_Set() const{
    return m_configuration_set_name_isSet;
}

bool OAIDeleteConfigurationSetResult::is_configuration_set_name_Valid() const{
    return m_configuration_set_name_isValid;
}

QList OAIDeleteConfigurationSetResult::getEventDestinations() const {
    return m_event_destinations;
}
void OAIDeleteConfigurationSetResult::setEventDestinations(const QList &event_destinations) {
    m_event_destinations = event_destinations;
    m_event_destinations_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_event_destinations_Set() const{
    return m_event_destinations_isSet;
}

bool OAIDeleteConfigurationSetResult::is_event_destinations_Valid() const{
    return m_event_destinations_isValid;
}

OAIMessageType OAIDeleteConfigurationSetResult::getDefaultMessageType() const {
    return m_default_message_type;
}
void OAIDeleteConfigurationSetResult::setDefaultMessageType(const OAIMessageType &default_message_type) {
    m_default_message_type = default_message_type;
    m_default_message_type_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_default_message_type_Set() const{
    return m_default_message_type_isSet;
}

bool OAIDeleteConfigurationSetResult::is_default_message_type_Valid() const{
    return m_default_message_type_isValid;
}

QString OAIDeleteConfigurationSetResult::getDefaultSenderId() const {
    return m_default_sender_id;
}
void OAIDeleteConfigurationSetResult::setDefaultSenderId(const QString &default_sender_id) {
    m_default_sender_id = default_sender_id;
    m_default_sender_id_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_default_sender_id_Set() const{
    return m_default_sender_id_isSet;
}

bool OAIDeleteConfigurationSetResult::is_default_sender_id_Valid() const{
    return m_default_sender_id_isValid;
}

QDateTime OAIDeleteConfigurationSetResult::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIDeleteConfigurationSetResult::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIDeleteConfigurationSetResult::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIDeleteConfigurationSetResult::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

bool OAIDeleteConfigurationSetResult::isSet() const {
...
bool OAIDeleteConfigurationSetResult::isValid() const {
