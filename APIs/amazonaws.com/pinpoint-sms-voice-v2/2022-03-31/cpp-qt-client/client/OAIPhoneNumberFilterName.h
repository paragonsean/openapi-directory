...
/*
 * OAIPhoneNumberFilterName.h
 *
 * 
 */

#ifndef OAIPhoneNumberFilterName_H
#define OAIPhoneNumberFilterName_H
...
class OAIPhoneNumberFilterName : public OAIEnum {
public:
    OAIPhoneNumberFilterName();
    OAIPhoneNumberFilterName(QString json);
    ~OAIPhoneNumberFilterName() override;
    ...
    enum class eOAIPhoneNumberFilterName {
    ...
    OAIPhoneNumberFilterName::eOAIPhoneNumberFilterName getValue() const;
    void setValue(const OAIPhoneNumberFilterName::eOAIPhoneNumberFilterName& value);
...
private:
    ...
    eOAIPhoneNumberFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberFilterName)

#endif // OAIPhoneNumberFilterName_H
