...
#ifndef OAIKeywordFilter_H
#define OAIKeywordFilter_H
...
class OAIKeywordFilter : public OAIObject {
public:
    OAIKeywordFilter();
    OAIKeywordFilter(QString json);
    ~OAIKeywordFilter() override;
    ...
    OAIKeywordFilterName getName() const;
    void setName(const OAIKeywordFilterName &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordFilter)

#endif // OAIKeywordFilter_H
