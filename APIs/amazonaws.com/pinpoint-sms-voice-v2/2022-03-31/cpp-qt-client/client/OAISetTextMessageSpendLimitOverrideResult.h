...
/*
 * OAISetTextMessageSpendLimitOverrideResult.h
 *
 * 
 */

#ifndef OAISetTextMessageSpendLimitOverrideResult_H
#define OAISetTextMessageSpendLimitOverrideResult_H
...
class OAISetTextMessageSpendLimitOverrideResult : public OAIObject {
public:
    OAISetTextMessageSpendLimitOverrideResult();
    OAISetTextMessageSpendLimitOverrideResult(QString json);
    ~OAISetTextMessageSpendLimitOverrideResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetTextMessageSpendLimitOverrideResult)

#endif // OAISetTextMessageSpendLimitOverrideResult_H
