...
/*
 * OAISetVoiceMessageSpendLimitOverrideRequest.h
 *
 * 
 */

#ifndef OAISetVoiceMessageSpendLimitOverrideRequest_H
#define OAISetVoiceMessageSpendLimitOverrideRequest_H
...
class OAISetVoiceMessageSpendLimitOverrideRequest : public OAIObject {
public:
    OAISetVoiceMessageSpendLimitOverrideRequest();
    OAISetVoiceMessageSpendLimitOverrideRequest(QString json);
    ~OAISetVoiceMessageSpendLimitOverrideRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVoiceMessageSpendLimitOverrideRequest)

#endif // OAISetVoiceMessageSpendLimitOverrideRequest_H
