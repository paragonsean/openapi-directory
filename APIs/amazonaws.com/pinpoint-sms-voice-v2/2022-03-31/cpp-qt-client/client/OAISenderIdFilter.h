...
#ifndef OAISenderIdFilter_H
#define OAISenderIdFilter_H
...
class OAISenderIdFilter : public OAIObject {
public:
    OAISenderIdFilter();
    OAISenderIdFilter(QString json);
    ~OAISenderIdFilter() override;
    ...
    OAISenderIdFilterName getName() const;
    void setName(const OAISenderIdFilterName &name);
...
Q_DECLARE_METATYPE(OpenAPI::OAISenderIdFilter)

#endif // OAISenderIdFilter_H
