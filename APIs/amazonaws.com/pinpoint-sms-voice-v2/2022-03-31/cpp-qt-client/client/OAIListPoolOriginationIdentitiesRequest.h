...
/*
 * OAIListPoolOriginationIdentitiesRequest.h
 *
 * 
 */

#ifndef OAIListPoolOriginationIdentitiesRequest_H
#define OAIListPoolOriginationIdentitiesRequest_H
...
class OAIListPoolOriginationIdentitiesRequest : public OAIObject {
public:
    OAIListPoolOriginationIdentitiesRequest();
    OAIListPoolOriginationIdentitiesRequest(QString json);
    ~OAIListPoolOriginationIdentitiesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoolOriginationIdentitiesRequest)

#endif // OAIListPoolOriginationIdentitiesRequest_H
