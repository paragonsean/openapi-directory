...
/*
 * OAIDeleteEventDestinationResult_EventDestination.h
 *
 * 
 */

#ifndef OAIDeleteEventDestinationResult_EventDestination_H
#define OAIDeleteEventDestinationResult_EventDestination_H
...
class OAIDeleteEventDestinationResult_EventDestination : public OAIObject {
public:
    OAIDeleteEventDestinationResult_EventDestination();
    OAIDeleteEventDestinationResult_EventDestination(QString json);
    ~OAIDeleteEventDestinationResult_EventDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventDestinationResult_EventDestination)

#endif // OAIDeleteEventDestinationResult_EventDestination_H
