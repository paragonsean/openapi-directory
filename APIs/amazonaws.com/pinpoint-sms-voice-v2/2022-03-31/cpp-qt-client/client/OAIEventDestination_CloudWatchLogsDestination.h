...
/*
 * OAIEventDestination_CloudWatchLogsDestination.h
 *
 * 
 */

#ifndef OAIEventDestination_CloudWatchLogsDestination_H
#define OAIEventDestination_CloudWatchLogsDestination_H
...
class OAIEventDestination_CloudWatchLogsDestination : public OAIObject {
public:
    OAIEventDestination_CloudWatchLogsDestination();
    OAIEventDestination_CloudWatchLogsDestination(QString json);
    ~OAIEventDestination_CloudWatchLogsDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventDestination_CloudWatchLogsDestination)

#endif // OAIEventDestination_CloudWatchLogsDestination_H
