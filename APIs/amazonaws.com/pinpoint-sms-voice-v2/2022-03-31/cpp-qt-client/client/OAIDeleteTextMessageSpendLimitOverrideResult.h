...
/*
 * OAIDeleteTextMessageSpendLimitOverrideResult.h
 *
 * 
 */

#ifndef OAIDeleteTextMessageSpendLimitOverrideResult_H
#define OAIDeleteTextMessageSpendLimitOverrideResult_H
...
class OAIDeleteTextMessageSpendLimitOverrideResult : public OAIObject {
public:
    OAIDeleteTextMessageSpendLimitOverrideResult();
    OAIDeleteTextMessageSpendLimitOverrideResult(QString json);
    ~OAIDeleteTextMessageSpendLimitOverrideResult() override;
    ...
    qint32 getMonthlyLimit() const;
    void setMonthlyLimit(const qint32 &monthly_limit);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTextMessageSpendLimitOverrideResult)

#endif // OAIDeleteTextMessageSpendLimitOverrideResult_H
