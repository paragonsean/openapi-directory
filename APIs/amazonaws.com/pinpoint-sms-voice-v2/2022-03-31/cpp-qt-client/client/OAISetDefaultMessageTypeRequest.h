...
/*
 * OAISetDefaultMessageTypeRequest.h
 *
 * 
 */

#ifndef OAISetDefaultMessageTypeRequest_H
#define OAISetDefaultMessageTypeRequest_H
...
class OAISetDefaultMessageTypeRequest : public OAIObject {
public:
    OAISetDefaultMessageTypeRequest();
    OAISetDefaultMessageTypeRequest(QString json);
    ~OAISetDefaultMessageTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDefaultMessageTypeRequest)

#endif // OAISetDefaultMessageTypeRequest_H
