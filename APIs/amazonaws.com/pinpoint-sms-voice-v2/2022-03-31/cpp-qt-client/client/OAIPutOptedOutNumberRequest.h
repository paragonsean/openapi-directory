...
/*
 * OAIPutOptedOutNumberRequest.h
 *
 * 
 */

#ifndef OAIPutOptedOutNumberRequest_H
#define OAIPutOptedOutNumberRequest_H
...
class OAIPutOptedOutNumberRequest : public OAIObject {
public:
    OAIPutOptedOutNumberRequest();
    OAIPutOptedOutNumberRequest(QString json);
    ~OAIPutOptedOutNumberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutOptedOutNumberRequest)

#endif // OAIPutOptedOutNumberRequest_H
