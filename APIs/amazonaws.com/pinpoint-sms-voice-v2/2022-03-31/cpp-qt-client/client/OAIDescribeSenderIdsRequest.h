...
/*
 * OAIDescribeSenderIdsRequest.h
 *
 * 
 */

#ifndef OAIDescribeSenderIdsRequest_H
#define OAIDescribeSenderIdsRequest_H
...
class OAIDescribeSenderIdsRequest : public OAIObject {
public:
    OAIDescribeSenderIdsRequest();
    OAIDescribeSenderIdsRequest(QString json);
    ~OAIDescribeSenderIdsRequest() override;
    ...
    QList getSenderIds() const;
    void setSenderIds(const QList &sender_ids);
    bool is_sender_ids_Set() const;
    bool is_sender_ids_Valid() const;
...
private:
    ...
    QList m_sender_ids;
    bool m_sender_ids_isSet;
    bool m_sender_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSenderIdsRequest)

#endif // OAIDescribeSenderIdsRequest_H
