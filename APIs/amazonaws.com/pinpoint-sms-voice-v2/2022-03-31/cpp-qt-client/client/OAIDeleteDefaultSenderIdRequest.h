...
/*
 * OAIDeleteDefaultSenderIdRequest.h
 *
 * 
 */

#ifndef OAIDeleteDefaultSenderIdRequest_H
#define OAIDeleteDefaultSenderIdRequest_H
...
class OAIDeleteDefaultSenderIdRequest : public OAIObject {
public:
    OAIDeleteDefaultSenderIdRequest();
    OAIDeleteDefaultSenderIdRequest(QString json);
    ~OAIDeleteDefaultSenderIdRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDefaultSenderIdRequest)

#endif // OAIDeleteDefaultSenderIdRequest_H
