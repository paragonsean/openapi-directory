...
OAIUpdateEventDestinationRequest_SnsDestination::OAIUpdateEventDestinationRequest_SnsDestination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateEventDestinationRequest_SnsDestination::OAIUpdateEventDestinationRequest_SnsDestination() {
    this->initializeModel();
}

OAIUpdateEventDestinationRequest_SnsDestination::~OAIUpdateEventDestinationRequest_SnsDestination() {}

void OAIUpdateEventDestinationRequest_SnsDestination::initializeModel() {

    m_topic_arn_isSet = false;
    m_topic_arn_isValid = false;
}

void OAIUpdateEventDestinationRequest_SnsDestination::fromJson(QString jsonString) {
...
void OAIUpdateEventDestinationRequest_SnsDestination::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateEventDestinationRequest_SnsDestination::asJson() const {
...
QJsonObject OAIUpdateEventDestinationRequest_SnsDestination::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateEventDestinationRequest_SnsDestination::getTopicArn() const {
    return m_topic_arn;
}
void OAIUpdateEventDestinationRequest_SnsDestination::setTopicArn(const QString &topic_arn) {
    m_topic_arn = topic_arn;
    m_topic_arn_isSet = true;
}

bool OAIUpdateEventDestinationRequest_SnsDestination::is_topic_arn_Set() const{
    return m_topic_arn_isSet;
}

bool OAIUpdateEventDestinationRequest_SnsDestination::is_topic_arn_Valid() const{
    return m_topic_arn_isValid;
}

bool OAIUpdateEventDestinationRequest_SnsDestination::isSet() const {
...
bool OAIUpdateEventDestinationRequest_SnsDestination::isValid() const {
