...
/*
 * OAIDeleteEventDestinationRequest.h
 *
 * 
 */

#ifndef OAIDeleteEventDestinationRequest_H
#define OAIDeleteEventDestinationRequest_H
...
class OAIDeleteEventDestinationRequest : public OAIObject {
public:
    OAIDeleteEventDestinationRequest();
    OAIDeleteEventDestinationRequest(QString json);
    ~OAIDeleteEventDestinationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventDestinationRequest)

#endif // OAIDeleteEventDestinationRequest_H
