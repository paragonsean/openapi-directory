...
/*
 * OAIDeleteKeywordResult.h
 *
 * 
 */

#ifndef OAIDeleteKeywordResult_H
#define OAIDeleteKeywordResult_H

#include <QJsonObject>

#include "OAIKeywordAction.h"
#include <QString>
...
class OAIDeleteKeywordResult : public OAIObject {
public:
    OAIDeleteKeywordResult();
    OAIDeleteKeywordResult(QString json);
    ~OAIDeleteKeywordResult() override;
    ...
    QString getOriginationIdentityArn() const;
    void setOriginationIdentityArn(const QString &origination_identity_arn);
    bool is_origination_identity_arn_Set() const;
    bool is_origination_identity_arn_Valid() const;
    ...
    QString getKeywordMessage() const;
    void setKeywordMessage(const QString &keyword_message);
    bool is_keyword_message_Set() const;
    bool is_keyword_message_Valid() const;

    OAIKeywordAction getKeywordAction() const;
    void setKeywordAction(const OAIKeywordAction &keyword_action);
    bool is_keyword_action_Set() const;
    bool is_keyword_action_Valid() const;
...
private:
    ...
    QString m_origination_identity_arn;
    bool m_origination_identity_arn_isSet;
    bool m_origination_identity_arn_isValid;
    ...
    QString m_keyword_message;
    bool m_keyword_message_isSet;
    bool m_keyword_message_isValid;

    OAIKeywordAction m_keyword_action;
    bool m_keyword_action_isSet;
    bool m_keyword_action_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteKeywordResult)

#endif // OAIDeleteKeywordResult_H
