...
/*
 * OAIAccountLimitName.h
 *
 * 
 */

#ifndef OAIAccountLimitName_H
#define OAIAccountLimitName_H
...
class OAIAccountLimitName : public OAIEnum {
public:
    OAIAccountLimitName();
    OAIAccountLimitName(QString json);
    ~OAIAccountLimitName() override;
    ...
    enum class eOAIAccountLimitName {
    ...
    OAIAccountLimitName::eOAIAccountLimitName getValue() const;
    void setValue(const OAIAccountLimitName::eOAIAccountLimitName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountLimitName)

#endif // OAIAccountLimitName_H
