...
/*
 * OAIDescribeOptOutListsRequest.h
 *
 * 
 */

#ifndef OAIDescribeOptOutListsRequest_H
#define OAIDescribeOptOutListsRequest_H
...
class OAIDescribeOptOutListsRequest : public OAIObject {
public:
    OAIDescribeOptOutListsRequest();
    OAIDescribeOptOutListsRequest(QString json);
    ~OAIDescribeOptOutListsRequest() override;
    ...
    QList getOptOutListNames() const;
    void setOptOutListNames(const QList &opt_out_list_names);
    bool is_opt_out_list_names_Set() const;
    bool is_opt_out_list_names_Valid() const;
...
private:
    ...
    QList m_opt_out_list_names;
    bool m_opt_out_list_names_isSet;
    bool m_opt_out_list_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOptOutListsRequest)

#endif // OAIDescribeOptOutListsRequest_H
