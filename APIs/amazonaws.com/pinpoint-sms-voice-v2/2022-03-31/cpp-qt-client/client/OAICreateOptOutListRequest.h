...
/*
 * OAICreateOptOutListRequest.h
 *
 * 
 */

#ifndef OAICreateOptOutListRequest_H
#define OAICreateOptOutListRequest_H
...
class OAICreateOptOutListRequest : public OAIObject {
public:
    OAICreateOptOutListRequest();
    OAICreateOptOutListRequest(QString json);
    ~OAICreateOptOutListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOptOutListRequest)

#endif // OAICreateOptOutListRequest_H
