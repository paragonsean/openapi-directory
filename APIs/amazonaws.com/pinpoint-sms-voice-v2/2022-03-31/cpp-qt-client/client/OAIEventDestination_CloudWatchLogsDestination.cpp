...
OAIEventDestination_CloudWatchLogsDestination::OAIEventDestination_CloudWatchLogsDestination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventDestination_CloudWatchLogsDestination::OAIEventDestination_CloudWatchLogsDestination() {
    this->initializeModel();
}

OAIEventDestination_CloudWatchLogsDestination::~OAIEventDestination_CloudWatchLogsDestination() {}

void OAIEventDestination_CloudWatchLogsDestination::initializeModel() {
...
void OAIEventDestination_CloudWatchLogsDestination::fromJson(QString jsonString) {
...
void OAIEventDestination_CloudWatchLogsDestination::fromJsonObject(QJsonObject json) {
...
QString OAIEventDestination_CloudWatchLogsDestination::asJson() const {
...
QJsonObject OAIEventDestination_CloudWatchLogsDestination::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEventDestination_CloudWatchLogsDestination::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAIEventDestination_CloudWatchLogsDestination::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAIEventDestination_CloudWatchLogsDestination::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAIEventDestination_CloudWatchLogsDestination::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

QString OAIEventDestination_CloudWatchLogsDestination::getLogGroupArn() const {
    return m_log_group_arn;
}
void OAIEventDestination_CloudWatchLogsDestination::setLogGroupArn(const QString &log_group_arn) {
    m_log_group_arn = log_group_arn;
    m_log_group_arn_isSet = true;
}

bool OAIEventDestination_CloudWatchLogsDestination::is_log_group_arn_Set() const{
    return m_log_group_arn_isSet;
}

bool OAIEventDestination_CloudWatchLogsDestination::is_log_group_arn_Valid() const{
    return m_log_group_arn_isValid;
}

bool OAIEventDestination_CloudWatchLogsDestination::isSet() const {
...
bool OAIEventDestination_CloudWatchLogsDestination::isValid() const {
