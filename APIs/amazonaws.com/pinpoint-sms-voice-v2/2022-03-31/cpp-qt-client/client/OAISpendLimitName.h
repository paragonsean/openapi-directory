...
#ifndef OAISpendLimitName_H
#define OAISpendLimitName_H
...
class OAISpendLimitName : public OAIEnum {
public:
    OAISpendLimitName();
    OAISpendLimitName(QString json);
    ~OAISpendLimitName() override;
    ...
    enum class eOAISpendLimitName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TEXT_MESSAGE_MONTHLY_SPEND_LIMIT, 
        VOICE_MESSAGE_MONTHLY_SPEND_LIMIT
    };
    OAISpendLimitName::eOAISpendLimitName getValue() const;
    void setValue(const OAISpendLimitName::eOAISpendLimitName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAISpendLimitName)

#endif // OAISpendLimitName_H
