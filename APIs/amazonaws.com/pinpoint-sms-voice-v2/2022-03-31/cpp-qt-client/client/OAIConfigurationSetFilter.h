...
/*
 * OAIConfigurationSetFilter.h
 *
 * The information for configuration sets that meet a specified criteria.
 */

#ifndef OAIConfigurationSetFilter_H
#define OAIConfigurationSetFilter_H
...
class OAIConfigurationSetFilter : public OAIObject {
public:
    OAIConfigurationSetFilter();
    OAIConfigurationSetFilter(QString json);
    ~OAIConfigurationSetFilter() override;
    ...
    OAIConfigurationSetFilterName getName() const;
    void setName(const OAIConfigurationSetFilterName &name);
...
private:
    ...
    OAIConfigurationSetFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationSetFilter)

#endif // OAIConfigurationSetFilter_H
