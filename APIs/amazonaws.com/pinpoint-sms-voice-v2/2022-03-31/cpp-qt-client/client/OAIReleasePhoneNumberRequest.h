...
/*
 * OAIReleasePhoneNumberRequest.h
 *
 * 
 */

#ifndef OAIReleasePhoneNumberRequest_H
#define OAIReleasePhoneNumberRequest_H
...
class OAIReleasePhoneNumberRequest : public OAIObject {
public:
    OAIReleasePhoneNumberRequest();
    OAIReleasePhoneNumberRequest(QString json);
    ~OAIReleasePhoneNumberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReleasePhoneNumberRequest)

#endif // OAIReleasePhoneNumberRequest_H
