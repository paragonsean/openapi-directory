...
/*
 * OAISetTextMessageSpendLimitOverrideRequest.h
 *
 * 
 */

#ifndef OAISetTextMessageSpendLimitOverrideRequest_H
#define OAISetTextMessageSpendLimitOverrideRequest_H
...
class OAISetTextMessageSpendLimitOverrideRequest : public OAIObject {
public:
    OAISetTextMessageSpendLimitOverrideRequest();
    OAISetTextMessageSpendLimitOverrideRequest(QString json);
    ~OAISetTextMessageSpendLimitOverrideRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetTextMessageSpendLimitOverrideRequest)

#endif // OAISetTextMessageSpendLimitOverrideRequest_H
