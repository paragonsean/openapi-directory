...
/*
 * OAIAssociateOriginationIdentityResult.h
 *
 * 
 */

#ifndef OAIAssociateOriginationIdentityResult_H
#define OAIAssociateOriginationIdentityResult_H
...
class OAIAssociateOriginationIdentityResult : public OAIObject {
public:
    OAIAssociateOriginationIdentityResult();
    OAIAssociateOriginationIdentityResult(QString json);
    ~OAIAssociateOriginationIdentityResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateOriginationIdentityResult)

#endif // OAIAssociateOriginationIdentityResult_H
