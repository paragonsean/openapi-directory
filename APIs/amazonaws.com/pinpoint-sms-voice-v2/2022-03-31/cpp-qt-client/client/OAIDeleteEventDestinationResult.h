...
/*
 * OAIDeleteEventDestinationResult.h
 *
 * 
 */

#ifndef OAIDeleteEventDestinationResult_H
#define OAIDeleteEventDestinationResult_H
...
namespace OpenAPI {
class OAIDeleteEventDestinationResult_EventDestination;

class OAIDeleteEventDestinationResult : public OAIObject {
public:
    OAIDeleteEventDestinationResult();
    OAIDeleteEventDestinationResult(QString json);
    ~OAIDeleteEventDestinationResult() override;
    ...
    OAIDeleteEventDestinationResult_EventDestination getEventDestination() const;
    void setEventDestination(const OAIDeleteEventDestinationResult_EventDestination &event_destination);
...
private:
    ...
    OAIDeleteEventDestinationResult_EventDestination m_event_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEventDestinationResult)

#endif // OAIDeleteEventDestinationResult_H
