...
/*
 * OAICreateConfigurationSetResult.h
 *
 * 
 */

#ifndef OAICreateConfigurationSetResult_H
#define OAICreateConfigurationSetResult_H
...
class OAICreateConfigurationSetResult : public OAIObject {
public:
    OAICreateConfigurationSetResult();
    OAICreateConfigurationSetResult(QString json);
    ~OAICreateConfigurationSetResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConfigurationSetResult)

#endif // OAICreateConfigurationSetResult_H
