...
/*
 * OAICreateEventDestinationRequest_SnsDestination.h
 *
 * 
 */

#ifndef OAICreateEventDestinationRequest_SnsDestination_H
#define OAICreateEventDestinationRequest_SnsDestination_H
...
class OAICreateEventDestinationRequest_SnsDestination : public OAIObject {
public:
    OAICreateEventDestinationRequest_SnsDestination();
    OAICreateEventDestinationRequest_SnsDestination(QString json);
    ~OAICreateEventDestinationRequest_SnsDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDestinationRequest_SnsDestination)

#endif // OAICreateEventDestinationRequest_SnsDestination_H
