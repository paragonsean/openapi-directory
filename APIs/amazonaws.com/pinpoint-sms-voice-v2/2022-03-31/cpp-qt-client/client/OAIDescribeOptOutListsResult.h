...
/*
 * OAIDescribeOptOutListsResult.h
 *
 * 
 */

#ifndef OAIDescribeOptOutListsResult_H
#define OAIDescribeOptOutListsResult_H
...
class OAIDescribeOptOutListsResult : public OAIObject {
public:
    OAIDescribeOptOutListsResult();
    OAIDescribeOptOutListsResult(QString json);
    ~OAIDescribeOptOutListsResult() override;
    ...
    QList getOptOutLists() const;
    void setOptOutLists(const QList &opt_out_lists);
    bool is_opt_out_lists_Set() const;
    bool is_opt_out_lists_Valid() const;
...
private:
    ...
    QList m_opt_out_lists;
    bool m_opt_out_lists_isSet;
    bool m_opt_out_lists_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOptOutListsResult)

#endif // OAIDescribeOptOutListsResult_H
