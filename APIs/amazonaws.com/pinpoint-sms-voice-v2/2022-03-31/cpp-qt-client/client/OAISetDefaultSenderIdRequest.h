...
/*
 * OAISetDefaultSenderIdRequest.h
 *
 * 
 */

#ifndef OAISetDefaultSenderIdRequest_H
#define OAISetDefaultSenderIdRequest_H
...
class OAISetDefaultSenderIdRequest : public OAIObject {
public:
    OAISetDefaultSenderIdRequest();
    OAISetDefaultSenderIdRequest(QString json);
    ~OAISetDefaultSenderIdRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDefaultSenderIdRequest)

#endif // OAISetDefaultSenderIdRequest_H
