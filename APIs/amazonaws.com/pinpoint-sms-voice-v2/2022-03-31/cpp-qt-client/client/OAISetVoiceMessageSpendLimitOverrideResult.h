...
/*
 * OAISetVoiceMessageSpendLimitOverrideResult.h
 *
 * 
 */

#ifndef OAISetVoiceMessageSpendLimitOverrideResult_H
#define OAISetVoiceMessageSpendLimitOverrideResult_H
...
class OAISetVoiceMessageSpendLimitOverrideResult : public OAIObject {
public:
    OAISetVoiceMessageSpendLimitOverrideResult();
    OAISetVoiceMessageSpendLimitOverrideResult(QString json);
    ~OAISetVoiceMessageSpendLimitOverrideResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetVoiceMessageSpendLimitOverrideResult)

#endif // OAISetVoiceMessageSpendLimitOverrideResult_H
