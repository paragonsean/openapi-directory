...
/*
 * OAIDeleteVoiceMessageSpendLimitOverrideResult.h
 *
 * 
 */

#ifndef OAIDeleteVoiceMessageSpendLimitOverrideResult_H
#define OAIDeleteVoiceMessageSpendLimitOverrideResult_H
...
class OAIDeleteVoiceMessageSpendLimitOverrideResult : public OAIObject {
public:
    OAIDeleteVoiceMessageSpendLimitOverrideResult();
    OAIDeleteVoiceMessageSpendLimitOverrideResult(QString json);
    ~OAIDeleteVoiceMessageSpendLimitOverrideResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVoiceMessageSpendLimitOverrideResult)

#endif // OAIDeleteVoiceMessageSpendLimitOverrideResult_H
