...
/*
 * OAIDeleteDefaultMessageTypeRequest.h
 *
 * 
 */

#ifndef OAIDeleteDefaultMessageTypeRequest_H
#define OAIDeleteDefaultMessageTypeRequest_H
...
class OAIDeleteDefaultMessageTypeRequest : public OAIObject {
public:
    OAIDeleteDefaultMessageTypeRequest();
    OAIDeleteDefaultMessageTypeRequest(QString json);
    ~OAIDeleteDefaultMessageTypeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDefaultMessageTypeRequest)

#endif // OAIDeleteDefaultMessageTypeRequest_H
