...
/*
 * OAICreateEventDestinationResult_EventDestination.h
 *
 * 
 */

#ifndef OAICreateEventDestinationResult_EventDestination_H
#define OAICreateEventDestinationResult_EventDestination_H
...
class OAICreateEventDestinationResult_EventDestination : public OAIObject {
public:
    OAICreateEventDestinationResult_EventDestination();
    OAICreateEventDestinationResult_EventDestination(QString json);
    ~OAICreateEventDestinationResult_EventDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDestinationResult_EventDestination)

#endif // OAICreateEventDestinationResult_EventDestination_H
