...
OAISetVoiceMessageSpendLimitOverrideRequest::OAISetVoiceMessageSpendLimitOverrideRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetVoiceMessageSpendLimitOverrideRequest::OAISetVoiceMessageSpendLimitOverrideRequest() {
    this->initializeModel();
}

OAISetVoiceMessageSpendLimitOverrideRequest::~OAISetVoiceMessageSpendLimitOverrideRequest() {}

void OAISetVoiceMessageSpendLimitOverrideRequest::initializeModel() {

    m_monthly_limit_isSet = false;
    m_monthly_limit_isValid = false;
}

void OAISetVoiceMessageSpendLimitOverrideRequest::fromJson(QString jsonString) {
...
void OAISetVoiceMessageSpendLimitOverrideRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetVoiceMessageSpendLimitOverrideRequest::asJson() const {
...
QJsonObject OAISetVoiceMessageSpendLimitOverrideRequest::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAISetVoiceMessageSpendLimitOverrideRequest::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAISetVoiceMessageSpendLimitOverrideRequest::setMonthlyLimit(const qint32 &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAISetVoiceMessageSpendLimitOverrideRequest::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAISetVoiceMessageSpendLimitOverrideRequest::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

bool OAISetVoiceMessageSpendLimitOverrideRequest::isSet() const {
...
bool OAISetVoiceMessageSpendLimitOverrideRequest::isValid() const {
