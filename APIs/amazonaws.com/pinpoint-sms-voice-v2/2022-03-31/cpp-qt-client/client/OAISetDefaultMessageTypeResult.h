...
/*
 * OAISetDefaultMessageTypeResult.h
 *
 * 
 */

#ifndef OAISetDefaultMessageTypeResult_H
#define OAISetDefaultMessageTypeResult_H
...
class OAISetDefaultMessageTypeResult : public OAIObject {
public:
    OAISetDefaultMessageTypeResult();
    OAISetDefaultMessageTypeResult(QString json);
    ~OAISetDefaultMessageTypeResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDefaultMessageTypeResult)

#endif // OAISetDefaultMessageTypeResult_H
