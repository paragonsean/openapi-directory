...
/*
 * OAIVoiceMessageBodyTextType.h
 *
 * 
 */

#ifndef OAIVoiceMessageBodyTextType_H
#define OAIVoiceMessageBodyTextType_H
...
class OAIVoiceMessageBodyTextType : public OAIEnum {
public:
    OAIVoiceMessageBodyTextType();
    OAIVoiceMessageBodyTextType(QString json);
    ~OAIVoiceMessageBodyTextType() override;
    ...
    enum class eOAIVoiceMessageBodyTextType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TEXT, 
        SSML
    };
    OAIVoiceMessageBodyTextType::eOAIVoiceMessageBodyTextType getValue() const;
    void setValue(const OAIVoiceMessageBodyTextType::eOAIVoiceMessageBodyTextType& value);
...
private:
    ...
    eOAIVoiceMessageBodyTextType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceMessageBodyTextType)

#endif // OAIVoiceMessageBodyTextType_H
