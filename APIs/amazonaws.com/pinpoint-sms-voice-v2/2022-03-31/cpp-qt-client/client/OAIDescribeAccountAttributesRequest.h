...
/*
 * OAIDescribeAccountAttributesRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccountAttributesRequest_H
#define OAIDescribeAccountAttributesRequest_H
...
class OAIDescribeAccountAttributesRequest : public OAIObject {
public:
    OAIDescribeAccountAttributesRequest();
    OAIDescribeAccountAttributesRequest(QString json);
    ~OAIDescribeAccountAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountAttributesRequest)

#endif // OAIDescribeAccountAttributesRequest_H
