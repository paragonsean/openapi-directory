...
OAICreateEventDestinationRequest_KinesisFirehoseDestination::OAICreateEventDestinationRequest_KinesisFirehoseDestination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEventDestinationRequest_KinesisFirehoseDestination::OAICreateEventDestinationRequest_KinesisFirehoseDestination() {
    this->initializeModel();
}

OAICreateEventDestinationRequest_KinesisFirehoseDestination::~OAICreateEventDestinationRequest_KinesisFirehoseDestination() {}

void OAICreateEventDestinationRequest_KinesisFirehoseDestination::initializeModel() {
...
void OAICreateEventDestinationRequest_KinesisFirehoseDestination::fromJson(QString jsonString) {
...
void OAICreateEventDestinationRequest_KinesisFirehoseDestination::fromJsonObject(QJsonObject json) {
...
QString OAICreateEventDestinationRequest_KinesisFirehoseDestination::asJson() const {
...
QJsonObject OAICreateEventDestinationRequest_KinesisFirehoseDestination::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateEventDestinationRequest_KinesisFirehoseDestination::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAICreateEventDestinationRequest_KinesisFirehoseDestination::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

QString OAICreateEventDestinationRequest_KinesisFirehoseDestination::getDeliveryStreamArn() const {
    return m_delivery_stream_arn;
}
void OAICreateEventDestinationRequest_KinesisFirehoseDestination::setDeliveryStreamArn(const QString &delivery_stream_arn) {
    m_delivery_stream_arn = delivery_stream_arn;
    m_delivery_stream_arn_isSet = true;
}

bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::is_delivery_stream_arn_Set() const{
    return m_delivery_stream_arn_isSet;
}

bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::is_delivery_stream_arn_Valid() const{
    return m_delivery_stream_arn_isValid;
}

bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::isSet() const {
...
bool OAICreateEventDestinationRequest_KinesisFirehoseDestination::isValid() const {
