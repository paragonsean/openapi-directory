...
/*
 * OAIDeleteDefaultMessageTypeResult.h
 *
 * 
 */

#ifndef OAIDeleteDefaultMessageTypeResult_H
#define OAIDeleteDefaultMessageTypeResult_H
...
class OAIDeleteDefaultMessageTypeResult : public OAIObject {
public:
    OAIDeleteDefaultMessageTypeResult();
    OAIDeleteDefaultMessageTypeResult(QString json);
    ~OAIDeleteDefaultMessageTypeResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDefaultMessageTypeResult)

#endif // OAIDeleteDefaultMessageTypeResult_H
