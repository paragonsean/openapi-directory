...
/*
 * OAIDescribeAccountLimitsRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccountLimitsRequest_H
#define OAIDescribeAccountLimitsRequest_H
...
class OAIDescribeAccountLimitsRequest : public OAIObject {
public:
    OAIDescribeAccountLimitsRequest();
    OAIDescribeAccountLimitsRequest(QString json);
    ~OAIDescribeAccountLimitsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountLimitsRequest)

#endif // OAIDescribeAccountLimitsRequest_H
