...
/*
 * OAISendTextMessageResult.h
 *
 * 
 */

#ifndef OAISendTextMessageResult_H
#define OAISendTextMessageResult_H
...
class OAISendTextMessageResult : public OAIObject {
public:
    OAISendTextMessageResult();
    OAISendTextMessageResult(QString json);
    ~OAISendTextMessageResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendTextMessageResult)

#endif // OAISendTextMessageResult_H
