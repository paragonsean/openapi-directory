...
/*
 * OAISenderIdFilterName.h
 *
 * 
 */

#ifndef OAISenderIdFilterName_H
#define OAISenderIdFilterName_H
...
class OAISenderIdFilterName : public OAIEnum {
public:
    OAISenderIdFilterName();
    OAISenderIdFilterName(QString json);
    ~OAISenderIdFilterName() override;
    ...
    enum class eOAISenderIdFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SENDER_ID, 
        ISO_COUNTRY_CODE, 
        MESSAGE_TYPE
    };
    OAISenderIdFilterName::eOAISenderIdFilterName getValue() const;
    void setValue(const OAISenderIdFilterName::eOAISenderIdFilterName& value);
...
private:
    ...
    eOAISenderIdFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISenderIdFilterName)

#endif // OAISenderIdFilterName_H
