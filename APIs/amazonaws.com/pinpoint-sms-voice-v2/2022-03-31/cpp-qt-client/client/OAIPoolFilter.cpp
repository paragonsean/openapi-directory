...
OAIPoolFilter::OAIPoolFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPoolFilter::OAIPoolFilter() {
    this->initializeModel();
}

OAIPoolFilter::~OAIPoolFilter() {}

void OAIPoolFilter::initializeModel() {
...
void OAIPoolFilter::fromJson(QString jsonString) {
...
void OAIPoolFilter::fromJsonObject(QJsonObject json) {
...
QString OAIPoolFilter::asJson() const {
...
QJsonObject OAIPoolFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIPoolFilterName OAIPoolFilter::getName() const {
    return m_name;
}
void OAIPoolFilter::setName(const OAIPoolFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPoolFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPoolFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIPoolFilter::getValues() const {
    return m_values;
}
void OAIPoolFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIPoolFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIPoolFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIPoolFilter::isSet() const {
...
bool OAIPoolFilter::isValid() const {
