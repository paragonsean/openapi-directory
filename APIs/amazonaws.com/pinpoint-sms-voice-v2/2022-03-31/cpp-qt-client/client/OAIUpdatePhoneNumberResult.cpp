...
OAIUpdatePhoneNumberResult::OAIUpdatePhoneNumberResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhoneNumberResult::OAIUpdatePhoneNumberResult() {
    this->initializeModel();
}

OAIUpdatePhoneNumberResult::~OAIUpdatePhoneNumberResult() {}

void OAIUpdatePhoneNumberResult::initializeModel() {
...
void OAIUpdatePhoneNumberResult::fromJson(QString jsonString) {
...
void OAIUpdatePhoneNumberResult::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePhoneNumberResult::asJson() const {
...
QJsonObject OAIUpdatePhoneNumberResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePhoneNumberResult::getPhoneNumberArn() const {
    return m_phone_number_arn;
}
void OAIUpdatePhoneNumberResult::setPhoneNumberArn(const QString &phone_number_arn) {
    m_phone_number_arn = phone_number_arn;
    m_phone_number_arn_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_arn_Set() const{
    return m_phone_number_arn_isSet;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_arn_Valid() const{
    return m_phone_number_arn_isValid;
}

QString OAIUpdatePhoneNumberResult::getPhoneNumberId() const {
    return m_phone_number_id;
}
void OAIUpdatePhoneNumberResult::setPhoneNumberId(const QString &phone_number_id) {
    m_phone_number_id = phone_number_id;
    m_phone_number_id_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_id_Set() const{
    return m_phone_number_id_isSet;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_id_Valid() const{
    return m_phone_number_id_isValid;
}

QString OAIUpdatePhoneNumberResult::getPhoneNumber() const {
    return m_phone_number;
}
void OAIUpdatePhoneNumberResult::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIUpdatePhoneNumberResult::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

OAINumberStatus OAIUpdatePhoneNumberResult::getStatus() const {
    return m_status;
}
void OAIUpdatePhoneNumberResult::setStatus(const OAINumberStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdatePhoneNumberResult::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIUpdatePhoneNumberResult::getIsoCountryCode() const {
    return m_iso_country_code;
}
void OAIUpdatePhoneNumberResult::setIsoCountryCode(const QString &iso_country_code) {
    m_iso_country_code = iso_country_code;
    m_iso_country_code_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_iso_country_code_Set() const{
    return m_iso_country_code_isSet;
}

bool OAIUpdatePhoneNumberResult::is_iso_country_code_Valid() const{
    return m_iso_country_code_isValid;
}

OAIMessageType OAIUpdatePhoneNumberResult::getMessageType() const {
    return m_message_type;
}
void OAIUpdatePhoneNumberResult::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIUpdatePhoneNumberResult::is_message_type_Valid() const{
    return m_message_type_isValid;
}

QList OAIUpdatePhoneNumberResult::getNumberCapabilities() const {
    return m_number_capabilities;
}
void OAIUpdatePhoneNumberResult::setNumberCapabilities(const QList &number_capabilities) {
    m_number_capabilities = number_capabilities;
    m_number_capabilities_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_number_capabilities_Set() const{
    return m_number_capabilities_isSet;
}

bool OAIUpdatePhoneNumberResult::is_number_capabilities_Valid() const{
    return m_number_capabilities_isValid;
}

OAINumberType OAIUpdatePhoneNumberResult::getNumberType() const {
    return m_number_type;
}
void OAIUpdatePhoneNumberResult::setNumberType(const OAINumberType &number_type) {
    m_number_type = number_type;
    m_number_type_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_number_type_Set() const{
    return m_number_type_isSet;
}

bool OAIUpdatePhoneNumberResult::is_number_type_Valid() const{
    return m_number_type_isValid;
}

QString OAIUpdatePhoneNumberResult::getMonthlyLeasingPrice() const {
    return m_monthly_leasing_price;
}
void OAIUpdatePhoneNumberResult::setMonthlyLeasingPrice(const QString &monthly_leasing_price) {
    m_monthly_leasing_price = monthly_leasing_price;
    m_monthly_leasing_price_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_monthly_leasing_price_Set() const{
    return m_monthly_leasing_price_isSet;
}

bool OAIUpdatePhoneNumberResult::is_monthly_leasing_price_Valid() const{
    return m_monthly_leasing_price_isValid;
}

bool OAIUpdatePhoneNumberResult::getTwoWayEnabled() const {
    return m_two_way_enabled;
}
void OAIUpdatePhoneNumberResult::setTwoWayEnabled(const bool &two_way_enabled) {
    m_two_way_enabled = two_way_enabled;
    m_two_way_enabled_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_two_way_enabled_Set() const{
    return m_two_way_enabled_isSet;
}

bool OAIUpdatePhoneNumberResult::is_two_way_enabled_Valid() const{
    return m_two_way_enabled_isValid;
}

QString OAIUpdatePhoneNumberResult::getTwoWayChannelArn() const {
    return m_two_way_channel_arn;
}
void OAIUpdatePhoneNumberResult::setTwoWayChannelArn(const QString &two_way_channel_arn) {
    m_two_way_channel_arn = two_way_channel_arn;
    m_two_way_channel_arn_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_two_way_channel_arn_Set() const{
    return m_two_way_channel_arn_isSet;
}

bool OAIUpdatePhoneNumberResult::is_two_way_channel_arn_Valid() const{
    return m_two_way_channel_arn_isValid;
}

bool OAIUpdatePhoneNumberResult::getSelfManagedOptOutsEnabled() const {
    return m_self_managed_opt_outs_enabled;
}
void OAIUpdatePhoneNumberResult::setSelfManagedOptOutsEnabled(const bool &self_managed_opt_outs_enabled) {
    m_self_managed_opt_outs_enabled = self_managed_opt_outs_enabled;
    m_self_managed_opt_outs_enabled_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_self_managed_opt_outs_enabled_Set() const{
    return m_self_managed_opt_outs_enabled_isSet;
}

bool OAIUpdatePhoneNumberResult::is_self_managed_opt_outs_enabled_Valid() const{
    return m_self_managed_opt_outs_enabled_isValid;
}

QString OAIUpdatePhoneNumberResult::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIUpdatePhoneNumberResult::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIUpdatePhoneNumberResult::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

bool OAIUpdatePhoneNumberResult::getDeletionProtectionEnabled() const {
    return m_deletion_protection_enabled;
}
void OAIUpdatePhoneNumberResult::setDeletionProtectionEnabled(const bool &deletion_protection_enabled) {
    m_deletion_protection_enabled = deletion_protection_enabled;
    m_deletion_protection_enabled_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_deletion_protection_enabled_Set() const{
    return m_deletion_protection_enabled_isSet;
}

bool OAIUpdatePhoneNumberResult::is_deletion_protection_enabled_Valid() const{
    return m_deletion_protection_enabled_isValid;
}

QDateTime OAIUpdatePhoneNumberResult::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIUpdatePhoneNumberResult::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIUpdatePhoneNumberResult::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIUpdatePhoneNumberResult::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

bool OAIUpdatePhoneNumberResult::isSet() const {
...
bool OAIUpdatePhoneNumberResult::isValid() const {
