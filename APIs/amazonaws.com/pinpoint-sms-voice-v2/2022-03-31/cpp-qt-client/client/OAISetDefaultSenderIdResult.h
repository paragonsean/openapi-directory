...
/*
 * OAISetDefaultSenderIdResult.h
 *
 * 
 */

#ifndef OAISetDefaultSenderIdResult_H
#define OAISetDefaultSenderIdResult_H
...
class OAISetDefaultSenderIdResult : public OAIObject {
public:
    OAISetDefaultSenderIdResult();
    OAISetDefaultSenderIdResult(QString json);
    ~OAISetDefaultSenderIdResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetDefaultSenderIdResult)

#endif // OAISetDefaultSenderIdResult_H
