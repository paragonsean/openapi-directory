...
QString OAIPhoneNumberInformation::getPhoneNumberArn() const {
    return m_phone_number_arn;
}
void OAIPhoneNumberInformation::setPhoneNumberArn(const QString &phone_number_arn) {
    m_phone_number_arn = phone_number_arn;
    m_phone_number_arn_isSet = true;
}

bool OAIPhoneNumberInformation::is_phone_number_arn_Set() const{
    return m_phone_number_arn_isSet;
}

bool OAIPhoneNumberInformation::is_phone_number_arn_Valid() const{
    return m_phone_number_arn_isValid;
}

QString OAIPhoneNumberInformation::getPhoneNumberId() const {
    return m_phone_number_id;
}
void OAIPhoneNumberInformation::setPhoneNumberId(const QString &phone_number_id) {
    m_phone_number_id = phone_number_id;
    m_phone_number_id_isSet = true;
}

bool OAIPhoneNumberInformation::is_phone_number_id_Set() const{
    return m_phone_number_id_isSet;
}

bool OAIPhoneNumberInformation::is_phone_number_id_Valid() const{
...
OAINumberStatus OAIPhoneNumberInformation::getStatus() const {
    return m_status;
}
void OAIPhoneNumberInformation::setStatus(const OAINumberStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QString OAIPhoneNumberInformation::getIsoCountryCode() const {
    return m_iso_country_code;
}
void OAIPhoneNumberInformation::setIsoCountryCode(const QString &iso_country_code) {
    m_iso_country_code = iso_country_code;
    m_iso_country_code_isSet = true;
}

bool OAIPhoneNumberInformation::is_iso_country_code_Set() const{
    return m_iso_country_code_isSet;
}

bool OAIPhoneNumberInformation::is_iso_country_code_Valid() const{
    return m_iso_country_code_isValid;
}

OAIMessageType OAIPhoneNumberInformation::getMessageType() const {
    return m_message_type;
}
void OAIPhoneNumberInformation::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIPhoneNumberInformation::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIPhoneNumberInformation::is_message_type_Valid() const{
...
OAINumberType OAIPhoneNumberInformation::getNumberType() const {
    return m_number_type;
}
void OAIPhoneNumberInformation::setNumberType(const OAINumberType &number_type) {
    m_number_type = number_type;
    m_number_type_isSet = true;
}

bool OAIPhoneNumberInformation::is_number_type_Set() const{
    return m_number_type_isSet;
}

bool OAIPhoneNumberInformation::is_number_type_Valid() const{
    return m_number_type_isValid;
}

QString OAIPhoneNumberInformation::getMonthlyLeasingPrice() const {
    return m_monthly_leasing_price;
}
void OAIPhoneNumberInformation::setMonthlyLeasingPrice(const QString &monthly_leasing_price) {
    m_monthly_leasing_price = monthly_leasing_price;
    m_monthly_leasing_price_isSet = true;
}

bool OAIPhoneNumberInformation::is_monthly_leasing_price_Set() const{
    return m_monthly_leasing_price_isSet;
}

bool OAIPhoneNumberInformation::is_monthly_leasing_price_Valid() const{
    return m_monthly_leasing_price_isValid;
}

bool OAIPhoneNumberInformation::getTwoWayEnabled() const {
    return m_two_way_enabled;
}
void OAIPhoneNumberInformation::setTwoWayEnabled(const bool &two_way_enabled) {
    m_two_way_enabled = two_way_enabled;
    m_two_way_enabled_isSet = true;
}

bool OAIPhoneNumberInformation::is_two_way_enabled_Set() const{
    return m_two_way_enabled_isSet;
}

bool OAIPhoneNumberInformation::is_two_way_enabled_Valid() const{
    return m_two_way_enabled_isValid;
}

QString OAIPhoneNumberInformation::getTwoWayChannelArn() const {
    return m_two_way_channel_arn;
}
void OAIPhoneNumberInformation::setTwoWayChannelArn(const QString &two_way_channel_arn) {
    m_two_way_channel_arn = two_way_channel_arn;
    m_two_way_channel_arn_isSet = true;
}

bool OAIPhoneNumberInformation::is_two_way_channel_arn_Set() const{
    return m_two_way_channel_arn_isSet;
}

bool OAIPhoneNumberInformation::is_two_way_channel_arn_Valid() const{
    return m_two_way_channel_arn_isValid;
}

bool OAIPhoneNumberInformation::getSelfManagedOptOutsEnabled() const {
    return m_self_managed_opt_outs_enabled;
}
void OAIPhoneNumberInformation::setSelfManagedOptOutsEnabled(const bool &self_managed_opt_outs_enabled) {
    m_self_managed_opt_outs_enabled = self_managed_opt_outs_enabled;
    m_self_managed_opt_outs_enabled_isSet = true;
}

bool OAIPhoneNumberInformation::is_self_managed_opt_outs_enabled_Set() const{
    return m_self_managed_opt_outs_enabled_isSet;
}

bool OAIPhoneNumberInformation::is_self_managed_opt_outs_enabled_Valid() const{
    return m_self_managed_opt_outs_enabled_isValid;
}

QString OAIPhoneNumberInformation::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIPhoneNumberInformation::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIPhoneNumberInformation::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIPhoneNumberInformation::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

bool OAIPhoneNumberInformation::getDeletionProtectionEnabled() const {
    return m_deletion_protection_enabled;
}
void OAIPhoneNumberInformation::setDeletionProtectionEnabled(const bool &deletion_protection_enabled) {
    m_deletion_protection_enabled = deletion_protection_enabled;
    m_deletion_protection_enabled_isSet = true;
}

bool OAIPhoneNumberInformation::is_deletion_protection_enabled_Set() const{
    return m_deletion_protection_enabled_isSet;
}

bool OAIPhoneNumberInformation::is_deletion_protection_enabled_Valid() const{
    return m_deletion_protection_enabled_isValid;
}

QString OAIPhoneNumberInformation::getPoolId() const {
    return m_pool_id;
}
void OAIPhoneNumberInformation::setPoolId(const QString &pool_id) {
    m_pool_id = pool_id;
    m_pool_id_isSet = true;
}

bool OAIPhoneNumberInformation::is_pool_id_Set() const{
    return m_pool_id_isSet;
}

bool OAIPhoneNumberInformation::is_pool_id_Valid() const{
    return m_pool_id_isValid;
}

QDateTime OAIPhoneNumberInformation::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIPhoneNumberInformation::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIPhoneNumberInformation::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIPhoneNumberInformation::is_created_timestamp_Valid() const{
...
bool OAIPhoneNumberInformation::isValid() const {
    ...
    return m_phone_number_arn_isValid && m_phone_number_isValid && m_status_isValid && m_iso_country_code_isValid && m_message_type_isValid && m_number_capabilities_isValid && m_number_type_isValid && m_monthly_leasing_price_isValid && m_two_way_enabled_isValid && m_self_managed_opt_outs_enabled_isValid && m_opt_out_list_name_isValid && m_deletion_protection_enabled_isValid && m_created_timestamp_isValid && true;
}
