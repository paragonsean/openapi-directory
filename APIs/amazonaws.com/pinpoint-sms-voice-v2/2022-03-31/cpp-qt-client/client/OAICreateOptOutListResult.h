...
/*
 * OAICreateOptOutListResult.h
 *
 * 
 */

#ifndef OAICreateOptOutListResult_H
#define OAICreateOptOutListResult_H
...
class OAICreateOptOutListResult : public OAIObject {
public:
    OAICreateOptOutListResult();
    OAICreateOptOutListResult(QString json);
    ~OAICreateOptOutListResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOptOutListResult)

#endif // OAICreateOptOutListResult_H
