...
#ifndef OAIKeywordAction_H
#define OAIKeywordAction_H
...
class OAIKeywordAction : public OAIEnum {
public:
    OAIKeywordAction();
    OAIKeywordAction(QString json);
    ~OAIKeywordAction() override;
    ...
    enum class eOAIKeywordAction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AUTOMATIC_RESPONSE, 
        OPT_OUT, 
        OPT_IN
    };
    OAIKeywordAction::eOAIKeywordAction getValue() const;
    void setValue(const OAIKeywordAction::eOAIKeywordAction& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordAction)

#endif // OAIKeywordAction_H
