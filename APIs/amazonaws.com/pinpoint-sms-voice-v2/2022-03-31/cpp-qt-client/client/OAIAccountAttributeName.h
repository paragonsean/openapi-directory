...
/*
 * OAIAccountAttributeName.h
 *
 * 
 */

#ifndef OAIAccountAttributeName_H
#define OAIAccountAttributeName_H
...
class OAIAccountAttributeName : public OAIEnum {
public:
    OAIAccountAttributeName();
    OAIAccountAttributeName(QString json);
    ~OAIAccountAttributeName() override;
    ...
    enum class eOAIAccountAttributeName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACCOUNT_TIER
    };
    OAIAccountAttributeName::eOAIAccountAttributeName getValue() const;
    void setValue(const OAIAccountAttributeName::eOAIAccountAttributeName& value);
...
private:
    ...
    eOAIAccountAttributeName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountAttributeName)

#endif // OAIAccountAttributeName_H
