...
/*
 * OAIDeleteConfigurationSetResult.h
 *
 * 
 */

#ifndef OAIDeleteConfigurationSetResult_H
#define OAIDeleteConfigurationSetResult_H
...
class OAIDeleteConfigurationSetResult : public OAIObject {
public:
    OAIDeleteConfigurationSetResult();
    OAIDeleteConfigurationSetResult(QString json);
    ~OAIDeleteConfigurationSetResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteConfigurationSetResult)

#endif // OAIDeleteConfigurationSetResult_H
