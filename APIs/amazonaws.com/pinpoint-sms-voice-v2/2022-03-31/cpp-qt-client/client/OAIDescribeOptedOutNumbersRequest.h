...
/*
 * OAIDescribeOptedOutNumbersRequest.h
 *
 * 
 */

#ifndef OAIDescribeOptedOutNumbersRequest_H
#define OAIDescribeOptedOutNumbersRequest_H
...
class OAIDescribeOptedOutNumbersRequest : public OAIObject {
public:
    OAIDescribeOptedOutNumbersRequest();
    OAIDescribeOptedOutNumbersRequest(QString json);
    ~OAIDescribeOptedOutNumbersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOptedOutNumbersRequest)

#endif // OAIDescribeOptedOutNumbersRequest_H
