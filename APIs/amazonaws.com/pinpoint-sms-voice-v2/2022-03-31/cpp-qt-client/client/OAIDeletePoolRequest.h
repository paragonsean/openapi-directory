...
/*
 * OAIDeletePoolRequest.h
 *
 * 
 */

#ifndef OAIDeletePoolRequest_H
#define OAIDeletePoolRequest_H
...
class OAIDeletePoolRequest : public OAIObject {
public:
    OAIDeletePoolRequest();
    OAIDeletePoolRequest(QString json);
    ~OAIDeletePoolRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePoolRequest)

#endif // OAIDeletePoolRequest_H
