...
/*
 * OAIPhoneNumberFilter.h
 *
 * The information for a phone number that meets a specified criteria.
 */

#ifndef OAIPhoneNumberFilter_H
#define OAIPhoneNumberFilter_H
...
class OAIPhoneNumberFilter : public OAIObject {
public:
    OAIPhoneNumberFilter();
    OAIPhoneNumberFilter(QString json);
    ~OAIPhoneNumberFilter() override;
    ...
    OAIPhoneNumberFilterName getName() const;
    void setName(const OAIPhoneNumberFilterName &name);
...
private:
    ...
    OAIPhoneNumberFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberFilter)

#endif // OAIPhoneNumberFilter_H
