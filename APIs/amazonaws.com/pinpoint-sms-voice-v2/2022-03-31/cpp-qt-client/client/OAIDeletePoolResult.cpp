...
OAIDeletePoolResult::OAIDeletePoolResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePoolResult::OAIDeletePoolResult() {
    this->initializeModel();
}

OAIDeletePoolResult::~OAIDeletePoolResult() {}

void OAIDeletePoolResult::initializeModel() {
...
void OAIDeletePoolResult::fromJson(QString jsonString) {
...
void OAIDeletePoolResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePoolResult::asJson() const {
...
QJsonObject OAIDeletePoolResult::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arn_isSet) {
...
QString OAIDeletePoolResult::getPoolArn() const {
    return m_pool_arn;
}
void OAIDeletePoolResult::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAIDeletePoolResult::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAIDeletePoolResult::is_pool_arn_Valid() const{
    return m_pool_arn_isValid;
}

QString OAIDeletePoolResult::getPoolId() const {
    return m_pool_id;
}
void OAIDeletePoolResult::setPoolId(const QString &pool_id) {
    m_pool_id = pool_id;
    m_pool_id_isSet = true;
}

bool OAIDeletePoolResult::is_pool_id_Set() const{
    return m_pool_id_isSet;
}

bool OAIDeletePoolResult::is_pool_id_Valid() const{
    return m_pool_id_isValid;
}

OAIPoolStatus OAIDeletePoolResult::getStatus() const {
    return m_status;
}
void OAIDeletePoolResult::setStatus(const OAIPoolStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeletePoolResult::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeletePoolResult::is_status_Valid() const{
    return m_status_isValid;
}

OAIMessageType OAIDeletePoolResult::getMessageType() const {
    return m_message_type;
}
void OAIDeletePoolResult::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIDeletePoolResult::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIDeletePoolResult::is_message_type_Valid() const{
    return m_message_type_isValid;
}

bool OAIDeletePoolResult::getTwoWayEnabled() const {
    return m_two_way_enabled;
}
void OAIDeletePoolResult::setTwoWayEnabled(const bool &two_way_enabled) {
    m_two_way_enabled = two_way_enabled;
    m_two_way_enabled_isSet = true;
}

bool OAIDeletePoolResult::is_two_way_enabled_Set() const{
    return m_two_way_enabled_isSet;
}

bool OAIDeletePoolResult::is_two_way_enabled_Valid() const{
    return m_two_way_enabled_isValid;
}

QString OAIDeletePoolResult::getTwoWayChannelArn() const {
    return m_two_way_channel_arn;
}
void OAIDeletePoolResult::setTwoWayChannelArn(const QString &two_way_channel_arn) {
    m_two_way_channel_arn = two_way_channel_arn;
    m_two_way_channel_arn_isSet = true;
}

bool OAIDeletePoolResult::is_two_way_channel_arn_Set() const{
    return m_two_way_channel_arn_isSet;
}

bool OAIDeletePoolResult::is_two_way_channel_arn_Valid() const{
    return m_two_way_channel_arn_isValid;
}

bool OAIDeletePoolResult::getSelfManagedOptOutsEnabled() const {
    return m_self_managed_opt_outs_enabled;
}
void OAIDeletePoolResult::setSelfManagedOptOutsEnabled(const bool &self_managed_opt_outs_enabled) {
    m_self_managed_opt_outs_enabled = self_managed_opt_outs_enabled;
    m_self_managed_opt_outs_enabled_isSet = true;
}

bool OAIDeletePoolResult::is_self_managed_opt_outs_enabled_Set() const{
    return m_self_managed_opt_outs_enabled_isSet;
}

bool OAIDeletePoolResult::is_self_managed_opt_outs_enabled_Valid() const{
    return m_self_managed_opt_outs_enabled_isValid;
}

QString OAIDeletePoolResult::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIDeletePoolResult::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIDeletePoolResult::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIDeletePoolResult::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

bool OAIDeletePoolResult::getSharedRoutesEnabled() const {
    return m_shared_routes_enabled;
}
void OAIDeletePoolResult::setSharedRoutesEnabled(const bool &shared_routes_enabled) {
    m_shared_routes_enabled = shared_routes_enabled;
    m_shared_routes_enabled_isSet = true;
}

bool OAIDeletePoolResult::is_shared_routes_enabled_Set() const{
    return m_shared_routes_enabled_isSet;
}

bool OAIDeletePoolResult::is_shared_routes_enabled_Valid() const{
    return m_shared_routes_enabled_isValid;
}

QDateTime OAIDeletePoolResult::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIDeletePoolResult::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIDeletePoolResult::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIDeletePoolResult::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

bool OAIDeletePoolResult::isSet() const {
...
bool OAIDeletePoolResult::isValid() const {
