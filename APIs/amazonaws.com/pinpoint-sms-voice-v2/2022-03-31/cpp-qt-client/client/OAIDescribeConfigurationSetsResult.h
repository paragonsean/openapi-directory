...
/*
 * OAIDescribeConfigurationSetsResult.h
 *
 * 
 */

#ifndef OAIDescribeConfigurationSetsResult_H
#define OAIDescribeConfigurationSetsResult_H
...
class OAIDescribeConfigurationSetsResult : public OAIObject {
public:
    OAIDescribeConfigurationSetsResult();
    OAIDescribeConfigurationSetsResult(QString json);
    ~OAIDescribeConfigurationSetsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeConfigurationSetsResult)

#endif // OAIDescribeConfigurationSetsResult_H
