...
/*
 * OAIDescribePoolsResult.h
 *
 * 
 */

#ifndef OAIDescribePoolsResult_H
#define OAIDescribePoolsResult_H
...
class OAIDescribePoolsResult : public OAIObject {
public:
    OAIDescribePoolsResult();
    OAIDescribePoolsResult(QString json);
    ~OAIDescribePoolsResult() override;
    ...
    QList getPools() const;
    void setPools(const QList &pools);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePoolsResult)

#endif // OAIDescribePoolsResult_H
