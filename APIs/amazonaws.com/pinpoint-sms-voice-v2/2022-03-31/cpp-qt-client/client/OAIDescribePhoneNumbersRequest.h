...
/*
 * OAIDescribePhoneNumbersRequest.h
 *
 * 
 */

#ifndef OAIDescribePhoneNumbersRequest_H
#define OAIDescribePhoneNumbersRequest_H
...
class OAIDescribePhoneNumbersRequest : public OAIObject {
public:
    OAIDescribePhoneNumbersRequest();
    OAIDescribePhoneNumbersRequest(QString json);
    ~OAIDescribePhoneNumbersRequest() override;
    ...
    QList getPhoneNumberIds() const;
    void setPhoneNumberIds(const QList &phone_number_ids);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePhoneNumbersRequest)

#endif // OAIDescribePhoneNumbersRequest_H
