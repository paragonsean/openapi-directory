...
/*
 * OAIDisassociateOriginationIdentityResult.h
 *
 * 
 */

#ifndef OAIDisassociateOriginationIdentityResult_H
#define OAIDisassociateOriginationIdentityResult_H
...
class OAIDisassociateOriginationIdentityResult : public OAIObject {
public:
    OAIDisassociateOriginationIdentityResult();
    OAIDisassociateOriginationIdentityResult(QString json);
    ~OAIDisassociateOriginationIdentityResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateOriginationIdentityResult)

#endif // OAIDisassociateOriginationIdentityResult_H
