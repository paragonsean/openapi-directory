...
OAICreateEventDestinationResult::OAICreateEventDestinationResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEventDestinationResult::OAICreateEventDestinationResult() {
    this->initializeModel();
}

OAICreateEventDestinationResult::~OAICreateEventDestinationResult() {}

void OAICreateEventDestinationResult::initializeModel() {
...
void OAICreateEventDestinationResult::fromJson(QString jsonString) {
...
void OAICreateEventDestinationResult::fromJsonObject(QJsonObject json) {
...
QString OAICreateEventDestinationResult::asJson() const {
...
QJsonObject OAICreateEventDestinationResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateEventDestinationResult::getConfigurationSetArn() const {
    return m_configuration_set_arn;
}
void OAICreateEventDestinationResult::setConfigurationSetArn(const QString &configuration_set_arn) {
    m_configuration_set_arn = configuration_set_arn;
    m_configuration_set_arn_isSet = true;
}

bool OAICreateEventDestinationResult::is_configuration_set_arn_Set() const{
    return m_configuration_set_arn_isSet;
}

bool OAICreateEventDestinationResult::is_configuration_set_arn_Valid() const{
    return m_configuration_set_arn_isValid;
}

QString OAICreateEventDestinationResult::getConfigurationSetName() const {
    return m_configuration_set_name;
}
void OAICreateEventDestinationResult::setConfigurationSetName(const QString &configuration_set_name) {
    m_configuration_set_name = configuration_set_name;
    m_configuration_set_name_isSet = true;
}

bool OAICreateEventDestinationResult::is_configuration_set_name_Set() const{
    return m_configuration_set_name_isSet;
}

bool OAICreateEventDestinationResult::is_configuration_set_name_Valid() const{
    return m_configuration_set_name_isValid;
}

OAICreateEventDestinationResult_EventDestination OAICreateEventDestinationResult::getEventDestination() const {
    return m_event_destination;
}
void OAICreateEventDestinationResult::setEventDestination(const OAICreateEventDestinationResult_EventDestination &event_destination) {
    m_event_destination = event_destination;
    m_event_destination_isSet = true;
}

bool OAICreateEventDestinationResult::is_event_destination_Set() const{
    return m_event_destination_isSet;
}

bool OAICreateEventDestinationResult::is_event_destination_Valid() const{
    return m_event_destination_isValid;
}

bool OAICreateEventDestinationResult::isSet() const {
...
bool OAICreateEventDestinationResult::isValid() const {
