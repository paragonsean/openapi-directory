...
OAISendTextMessageResult::OAISendTextMessageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendTextMessageResult::OAISendTextMessageResult() {
    this->initializeModel();
}

OAISendTextMessageResult::~OAISendTextMessageResult() {}

void OAISendTextMessageResult::initializeModel() {

    m_message_id_isSet = false;
    m_message_id_isValid = false;
}

void OAISendTextMessageResult::fromJson(QString jsonString) {
...
void OAISendTextMessageResult::fromJsonObject(QJsonObject json) {
...
QString OAISendTextMessageResult::asJson() const {
...
QJsonObject OAISendTextMessageResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAISendTextMessageResult::getMessageId() const {
    return m_message_id;
}
void OAISendTextMessageResult::setMessageId(const QString &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAISendTextMessageResult::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAISendTextMessageResult::is_message_id_Valid() const{
    return m_message_id_isValid;
}

bool OAISendTextMessageResult::isSet() const {
...
bool OAISendTextMessageResult::isValid() const {
