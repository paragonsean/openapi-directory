...
/*
 * OAIPoolOriginationIdentitiesFilterName.h
 *
 * 
 */

#ifndef OAIPoolOriginationIdentitiesFilterName_H
#define OAIPoolOriginationIdentitiesFilterName_H
...
class OAIPoolOriginationIdentitiesFilterName : public OAIEnum {
public:
    OAIPoolOriginationIdentitiesFilterName();
    OAIPoolOriginationIdentitiesFilterName(QString json);
    ~OAIPoolOriginationIdentitiesFilterName() override;
    ...
    enum class eOAIPoolOriginationIdentitiesFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ISO_COUNTRY_CODE, 
        NUMBER_CAPABILITY
    };
    OAIPoolOriginationIdentitiesFilterName::eOAIPoolOriginationIdentitiesFilterName getValue() const;
    void setValue(const OAIPoolOriginationIdentitiesFilterName::eOAIPoolOriginationIdentitiesFilterName& value);
...
private:
    ...
    eOAIPoolOriginationIdentitiesFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoolOriginationIdentitiesFilterName)

#endif // OAIPoolOriginationIdentitiesFilterName_H
