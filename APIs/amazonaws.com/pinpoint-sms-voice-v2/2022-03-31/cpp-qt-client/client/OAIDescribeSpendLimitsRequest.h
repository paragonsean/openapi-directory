...
/*
 * OAIDescribeSpendLimitsRequest.h
 *
 * 
 */

#ifndef OAIDescribeSpendLimitsRequest_H
#define OAIDescribeSpendLimitsRequest_H
...
class OAIDescribeSpendLimitsRequest : public OAIObject {
public:
    OAIDescribeSpendLimitsRequest();
    OAIDescribeSpendLimitsRequest(QString json);
    ~OAIDescribeSpendLimitsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSpendLimitsRequest)

#endif // OAIDescribeSpendLimitsRequest_H
