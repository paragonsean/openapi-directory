...
OAIDeleteTextMessageSpendLimitOverrideResult::OAIDeleteTextMessageSpendLimitOverrideResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTextMessageSpendLimitOverrideResult::OAIDeleteTextMessageSpendLimitOverrideResult() {
    this->initializeModel();
}

OAIDeleteTextMessageSpendLimitOverrideResult::~OAIDeleteTextMessageSpendLimitOverrideResult() {}

void OAIDeleteTextMessageSpendLimitOverrideResult::initializeModel() {

    m_monthly_limit_isSet = false;
    m_monthly_limit_isValid = false;
}

void OAIDeleteTextMessageSpendLimitOverrideResult::fromJson(QString jsonString) {
...
void OAIDeleteTextMessageSpendLimitOverrideResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTextMessageSpendLimitOverrideResult::asJson() const {
...
QJsonObject OAIDeleteTextMessageSpendLimitOverrideResult::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDeleteTextMessageSpendLimitOverrideResult::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIDeleteTextMessageSpendLimitOverrideResult::setMonthlyLimit(const qint32 &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIDeleteTextMessageSpendLimitOverrideResult::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIDeleteTextMessageSpendLimitOverrideResult::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

bool OAIDeleteTextMessageSpendLimitOverrideResult::isSet() const {
...
bool OAIDeleteTextMessageSpendLimitOverrideResult::isValid() const {
