...
/*
 * OAIUpdateEventDestinationRequest.h
 *
 * 
 */

#ifndef OAIUpdateEventDestinationRequest_H
#define OAIUpdateEventDestinationRequest_H
...
#include "OAIUpdateEventDestinationRequest_SnsDestination.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpdateEventDestinationRequest_CloudWatchLogsDestination;
class OAIUpdateEventDestinationRequest_KinesisFirehoseDestination;
class OAIUpdateEventDestinationRequest_SnsDestination;

class OAIUpdateEventDestinationRequest : public OAIObject {
public:
    OAIUpdateEventDestinationRequest();
    OAIUpdateEventDestinationRequest(QString json);
    ~OAIUpdateEventDestinationRequest() override;
    ...
    OAIUpdateEventDestinationRequest_CloudWatchLogsDestination getCloudWatchLogsDestination() const;
    void setCloudWatchLogsDestination(const OAIUpdateEventDestinationRequest_CloudWatchLogsDestination &cloud_watch_logs_destination);
    bool is_cloud_watch_logs_destination_Set() const;
    bool is_cloud_watch_logs_destination_Valid() const;

    OAIUpdateEventDestinationRequest_KinesisFirehoseDestination getKinesisFirehoseDestination() const;
    void setKinesisFirehoseDestination(const OAIUpdateEventDestinationRequest_KinesisFirehoseDestination &kinesis_firehose_destination);
    bool is_kinesis_firehose_destination_Set() const;
    bool is_kinesis_firehose_destination_Valid() const;

    OAIUpdateEventDestinationRequest_SnsDestination getSnsDestination() const;
    void setSnsDestination(const OAIUpdateEventDestinationRequest_SnsDestination &sns_destination);
...
private:
    ...
    OAIUpdateEventDestinationRequest_CloudWatchLogsDestination m_cloud_watch_logs_destination;
    bool m_cloud_watch_logs_destination_isSet;
    bool m_cloud_watch_logs_destination_isValid;

    OAIUpdateEventDestinationRequest_KinesisFirehoseDestination m_kinesis_firehose_destination;
    bool m_kinesis_firehose_destination_isSet;
    bool m_kinesis_firehose_destination_isValid;

    OAIUpdateEventDestinationRequest_SnsDestination m_sns_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventDestinationRequest)

#endif // OAIUpdateEventDestinationRequest_H
