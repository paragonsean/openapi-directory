...
/*
 * OAIOptedOutFilterName.h
 *
 * 
 */

#ifndef OAIOptedOutFilterName_H
#define OAIOptedOutFilterName_H
...
class OAIOptedOutFilterName : public OAIEnum {
public:
    OAIOptedOutFilterName();
    OAIOptedOutFilterName(QString json);
    ~OAIOptedOutFilterName() override;
    ...
    enum class eOAIOptedOutFilterName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        END_USER_OPTED_OUT
    };
    OAIOptedOutFilterName::eOAIOptedOutFilterName getValue() const;
    void setValue(const OAIOptedOutFilterName::eOAIOptedOutFilterName& value);
...
private:
    ...
    eOAIOptedOutFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptedOutFilterName)

#endif // OAIOptedOutFilterName_H
