...
OAIDescribePoolsResult::OAIDescribePoolsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePoolsResult::OAIDescribePoolsResult() {
    this->initializeModel();
}

OAIDescribePoolsResult::~OAIDescribePoolsResult() {}

void OAIDescribePoolsResult::initializeModel() {
...
void OAIDescribePoolsResult::fromJson(QString jsonString) {
...
void OAIDescribePoolsResult::fromJsonObject(QJsonObject json) {
...
QString OAIDescribePoolsResult::asJson() const {
...
QJsonObject OAIDescribePoolsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_pools.isSet()) {
...
QList OAIDescribePoolsResult::getPools() const {
    return m_pools;
}
void OAIDescribePoolsResult::setPools(const QList &pools) {
    m_pools = pools;
    m_pools_isSet = true;
}

bool OAIDescribePoolsResult::is_pools_Set() const{
    return m_pools_isSet;
}

bool OAIDescribePoolsResult::is_pools_Valid() const{
    return m_pools_isValid;
}

QString OAIDescribePoolsResult::getNextToken() const {
    return m_next_token;
}
void OAIDescribePoolsResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribePoolsResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribePoolsResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribePoolsResult::isSet() const {
...
bool OAIDescribePoolsResult::isValid() const {
