...
/*
 * OAISendVoiceMessageResult.h
 *
 * 
 */

#ifndef OAISendVoiceMessageResult_H
#define OAISendVoiceMessageResult_H
...
class OAISendVoiceMessageResult : public OAIObject {
public:
    OAISendVoiceMessageResult();
    OAISendVoiceMessageResult(QString json);
    ~OAISendVoiceMessageResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendVoiceMessageResult)

#endif // OAISendVoiceMessageResult_H
