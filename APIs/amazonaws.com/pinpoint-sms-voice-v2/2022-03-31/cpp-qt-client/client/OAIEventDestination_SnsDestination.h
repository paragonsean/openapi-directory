...
/*
 * OAIEventDestination_SnsDestination.h
 *
 * 
 */

#ifndef OAIEventDestination_SnsDestination_H
#define OAIEventDestination_SnsDestination_H
...
class OAIEventDestination_SnsDestination : public OAIObject {
public:
    OAIEventDestination_SnsDestination();
    OAIEventDestination_SnsDestination(QString json);
    ~OAIEventDestination_SnsDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventDestination_SnsDestination)

#endif // OAIEventDestination_SnsDestination_H
