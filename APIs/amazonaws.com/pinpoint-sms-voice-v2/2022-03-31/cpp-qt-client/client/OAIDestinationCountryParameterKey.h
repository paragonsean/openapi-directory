...
/*
 * OAIDestinationCountryParameterKey.h
 *
 * 
 */

#ifndef OAIDestinationCountryParameterKey_H
#define OAIDestinationCountryParameterKey_H
...
class OAIDestinationCountryParameterKey : public OAIEnum {
public:
    OAIDestinationCountryParameterKey();
    OAIDestinationCountryParameterKey(QString json);
    ~OAIDestinationCountryParameterKey() override;
    ...
    enum class eOAIDestinationCountryParameterKey {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TEMPLATE_ID, 
        ENTITY_ID
    };
    OAIDestinationCountryParameterKey::eOAIDestinationCountryParameterKey getValue() const;
    void setValue(const OAIDestinationCountryParameterKey::eOAIDestinationCountryParameterKey& value);
...
private:
    ...
    eOAIDestinationCountryParameterKey m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDestinationCountryParameterKey)

#endif // OAIDestinationCountryParameterKey_H
