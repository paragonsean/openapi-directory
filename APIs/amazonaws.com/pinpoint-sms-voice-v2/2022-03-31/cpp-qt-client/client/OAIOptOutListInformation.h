...
/*
 * OAIOptOutListInformation.h
 *
 * The information for all OptOutList in an Amazon Web Services account.
 */

#ifndef OAIOptOutListInformation_H
#define OAIOptOutListInformation_H
...
class OAIOptOutListInformation : public OAIObject {
public:
    OAIOptOutListInformation();
    OAIOptOutListInformation(QString json);
    ~OAIOptOutListInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOptOutListInformation)

#endif // OAIOptOutListInformation_H
