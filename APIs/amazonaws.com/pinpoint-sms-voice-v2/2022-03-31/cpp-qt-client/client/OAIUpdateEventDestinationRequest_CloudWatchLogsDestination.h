...
/*
 * OAIUpdateEventDestinationRequest_CloudWatchLogsDestination.h
 *
 * 
 */

#ifndef OAIUpdateEventDestinationRequest_CloudWatchLogsDestination_H
#define OAIUpdateEventDestinationRequest_CloudWatchLogsDestination_H
...
class OAIUpdateEventDestinationRequest_CloudWatchLogsDestination : public OAIObject {
public:
    OAIUpdateEventDestinationRequest_CloudWatchLogsDestination();
    OAIUpdateEventDestinationRequest_CloudWatchLogsDestination(QString json);
    ~OAIUpdateEventDestinationRequest_CloudWatchLogsDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventDestinationRequest_CloudWatchLogsDestination)

#endif // OAIUpdateEventDestinationRequest_CloudWatchLogsDestination_H
