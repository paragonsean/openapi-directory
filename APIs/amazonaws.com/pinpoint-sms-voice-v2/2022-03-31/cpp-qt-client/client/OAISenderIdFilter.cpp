...
OAISenderIdFilter::OAISenderIdFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISenderIdFilter::OAISenderIdFilter() {
    this->initializeModel();
}

OAISenderIdFilter::~OAISenderIdFilter() {}

void OAISenderIdFilter::initializeModel() {
...
void OAISenderIdFilter::fromJson(QString jsonString) {
...
void OAISenderIdFilter::fromJsonObject(QJsonObject json) {
...
QString OAISenderIdFilter::asJson() const {
...
QJsonObject OAISenderIdFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAISenderIdFilterName OAISenderIdFilter::getName() const {
    return m_name;
}
void OAISenderIdFilter::setName(const OAISenderIdFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISenderIdFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAISenderIdFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAISenderIdFilter::getValues() const {
    return m_values;
}
void OAISenderIdFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAISenderIdFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAISenderIdFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAISenderIdFilter::isSet() const {
...
bool OAISenderIdFilter::isValid() const {
