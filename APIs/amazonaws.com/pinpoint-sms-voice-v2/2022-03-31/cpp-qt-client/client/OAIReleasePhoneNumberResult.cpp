...
OAIReleasePhoneNumberResult::OAIReleasePhoneNumberResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReleasePhoneNumberResult::OAIReleasePhoneNumberResult() {
    this->initializeModel();
}

OAIReleasePhoneNumberResult::~OAIReleasePhoneNumberResult() {}

void OAIReleasePhoneNumberResult::initializeModel() {
...
void OAIReleasePhoneNumberResult::fromJson(QString jsonString) {
...
void OAIReleasePhoneNumberResult::fromJsonObject(QJsonObject json) {
...
QString OAIReleasePhoneNumberResult::asJson() const {
...
QJsonObject OAIReleasePhoneNumberResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReleasePhoneNumberResult::getPhoneNumberArn() const {
    return m_phone_number_arn;
}
void OAIReleasePhoneNumberResult::setPhoneNumberArn(const QString &phone_number_arn) {
    m_phone_number_arn = phone_number_arn;
    m_phone_number_arn_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_phone_number_arn_Set() const{
    return m_phone_number_arn_isSet;
}

bool OAIReleasePhoneNumberResult::is_phone_number_arn_Valid() const{
    return m_phone_number_arn_isValid;
}

QString OAIReleasePhoneNumberResult::getPhoneNumberId() const {
    return m_phone_number_id;
}
void OAIReleasePhoneNumberResult::setPhoneNumberId(const QString &phone_number_id) {
    m_phone_number_id = phone_number_id;
    m_phone_number_id_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_phone_number_id_Set() const{
    return m_phone_number_id_isSet;
}

bool OAIReleasePhoneNumberResult::is_phone_number_id_Valid() const{
    return m_phone_number_id_isValid;
}

QString OAIReleasePhoneNumberResult::getPhoneNumber() const {
    return m_phone_number;
}
void OAIReleasePhoneNumberResult::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIReleasePhoneNumberResult::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

OAINumberStatus OAIReleasePhoneNumberResult::getStatus() const {
    return m_status;
}
void OAIReleasePhoneNumberResult::setStatus(const OAINumberStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_status_Set() const{
    return m_status_isSet;
}

bool OAIReleasePhoneNumberResult::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIReleasePhoneNumberResult::getIsoCountryCode() const {
    return m_iso_country_code;
}
void OAIReleasePhoneNumberResult::setIsoCountryCode(const QString &iso_country_code) {
    m_iso_country_code = iso_country_code;
    m_iso_country_code_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_iso_country_code_Set() const{
    return m_iso_country_code_isSet;
}

bool OAIReleasePhoneNumberResult::is_iso_country_code_Valid() const{
    return m_iso_country_code_isValid;
}

OAIMessageType OAIReleasePhoneNumberResult::getMessageType() const {
    return m_message_type;
}
void OAIReleasePhoneNumberResult::setMessageType(const OAIMessageType &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIReleasePhoneNumberResult::is_message_type_Valid() const{
    return m_message_type_isValid;
}

QList OAIReleasePhoneNumberResult::getNumberCapabilities() const {
    return m_number_capabilities;
}
void OAIReleasePhoneNumberResult::setNumberCapabilities(const QList &number_capabilities) {
    m_number_capabilities = number_capabilities;
    m_number_capabilities_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_number_capabilities_Set() const{
    return m_number_capabilities_isSet;
}

bool OAIReleasePhoneNumberResult::is_number_capabilities_Valid() const{
    return m_number_capabilities_isValid;
}

OAINumberType OAIReleasePhoneNumberResult::getNumberType() const {
    return m_number_type;
}
void OAIReleasePhoneNumberResult::setNumberType(const OAINumberType &number_type) {
    m_number_type = number_type;
    m_number_type_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_number_type_Set() const{
    return m_number_type_isSet;
}

bool OAIReleasePhoneNumberResult::is_number_type_Valid() const{
    return m_number_type_isValid;
}

QString OAIReleasePhoneNumberResult::getMonthlyLeasingPrice() const {
    return m_monthly_leasing_price;
}
void OAIReleasePhoneNumberResult::setMonthlyLeasingPrice(const QString &monthly_leasing_price) {
    m_monthly_leasing_price = monthly_leasing_price;
    m_monthly_leasing_price_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_monthly_leasing_price_Set() const{
    return m_monthly_leasing_price_isSet;
}

bool OAIReleasePhoneNumberResult::is_monthly_leasing_price_Valid() const{
    return m_monthly_leasing_price_isValid;
}

bool OAIReleasePhoneNumberResult::getTwoWayEnabled() const {
    return m_two_way_enabled;
}
void OAIReleasePhoneNumberResult::setTwoWayEnabled(const bool &two_way_enabled) {
    m_two_way_enabled = two_way_enabled;
    m_two_way_enabled_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_two_way_enabled_Set() const{
    return m_two_way_enabled_isSet;
}

bool OAIReleasePhoneNumberResult::is_two_way_enabled_Valid() const{
    return m_two_way_enabled_isValid;
}

QString OAIReleasePhoneNumberResult::getTwoWayChannelArn() const {
    return m_two_way_channel_arn;
}
void OAIReleasePhoneNumberResult::setTwoWayChannelArn(const QString &two_way_channel_arn) {
    m_two_way_channel_arn = two_way_channel_arn;
    m_two_way_channel_arn_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_two_way_channel_arn_Set() const{
    return m_two_way_channel_arn_isSet;
}

bool OAIReleasePhoneNumberResult::is_two_way_channel_arn_Valid() const{
    return m_two_way_channel_arn_isValid;
}

bool OAIReleasePhoneNumberResult::getSelfManagedOptOutsEnabled() const {
    return m_self_managed_opt_outs_enabled;
}
void OAIReleasePhoneNumberResult::setSelfManagedOptOutsEnabled(const bool &self_managed_opt_outs_enabled) {
    m_self_managed_opt_outs_enabled = self_managed_opt_outs_enabled;
    m_self_managed_opt_outs_enabled_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_self_managed_opt_outs_enabled_Set() const{
    return m_self_managed_opt_outs_enabled_isSet;
}

bool OAIReleasePhoneNumberResult::is_self_managed_opt_outs_enabled_Valid() const{
    return m_self_managed_opt_outs_enabled_isValid;
}

QString OAIReleasePhoneNumberResult::getOptOutListName() const {
    return m_opt_out_list_name;
}
void OAIReleasePhoneNumberResult::setOptOutListName(const QString &opt_out_list_name) {
    m_opt_out_list_name = opt_out_list_name;
    m_opt_out_list_name_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_opt_out_list_name_Set() const{
    return m_opt_out_list_name_isSet;
}

bool OAIReleasePhoneNumberResult::is_opt_out_list_name_Valid() const{
    return m_opt_out_list_name_isValid;
}

QDateTime OAIReleasePhoneNumberResult::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIReleasePhoneNumberResult::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIReleasePhoneNumberResult::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIReleasePhoneNumberResult::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

bool OAIReleasePhoneNumberResult::isSet() const {
...
bool OAIReleasePhoneNumberResult::isValid() const {
