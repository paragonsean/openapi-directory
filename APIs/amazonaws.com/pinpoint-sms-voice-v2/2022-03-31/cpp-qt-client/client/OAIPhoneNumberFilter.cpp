...
#include "OAIPhoneNumberFilter.h"
...
OAIPhoneNumberFilter::OAIPhoneNumberFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPhoneNumberFilter::OAIPhoneNumberFilter() {
    this->initializeModel();
}

OAIPhoneNumberFilter::~OAIPhoneNumberFilter() {}

void OAIPhoneNumberFilter::initializeModel() {
...
void OAIPhoneNumberFilter::fromJson(QString jsonString) {
...
void OAIPhoneNumberFilter::fromJsonObject(QJsonObject json) {
...
QString OAIPhoneNumberFilter::asJson() const {
...
QJsonObject OAIPhoneNumberFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIPhoneNumberFilterName OAIPhoneNumberFilter::getName() const {
    return m_name;
}
void OAIPhoneNumberFilter::setName(const OAIPhoneNumberFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPhoneNumberFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPhoneNumberFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIPhoneNumberFilter::getValues() const {
    return m_values;
}
void OAIPhoneNumberFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIPhoneNumberFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIPhoneNumberFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIPhoneNumberFilter::isSet() const {
...
bool OAIPhoneNumberFilter::isValid() const {
