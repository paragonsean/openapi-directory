...
OAIAssociateOriginationIdentityResult::OAIAssociateOriginationIdentityResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateOriginationIdentityResult::OAIAssociateOriginationIdentityResult() {
    this->initializeModel();
}

OAIAssociateOriginationIdentityResult::~OAIAssociateOriginationIdentityResult() {}

void OAIAssociateOriginationIdentityResult::initializeModel() {
...
void OAIAssociateOriginationIdentityResult::fromJson(QString jsonString) {
...
void OAIAssociateOriginationIdentityResult::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateOriginationIdentityResult::asJson() const {
...
QJsonObject OAIAssociateOriginationIdentityResult::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_arn_isSet) {
...
QString OAIAssociateOriginationIdentityResult::getPoolArn() const {
    return m_pool_arn;
}
void OAIAssociateOriginationIdentityResult::setPoolArn(const QString &pool_arn) {
    m_pool_arn = pool_arn;
    m_pool_arn_isSet = true;
}

bool OAIAssociateOriginationIdentityResult::is_pool_arn_Set() const{
    return m_pool_arn_isSet;
}

bool OAIAssociateOriginationIdentityResult::is_pool_arn_Valid() const{
    return m_pool_arn_isValid;
}

QString OAIAssociateOriginationIdentityResult::getPoolId() const {
    return m_pool_id;
}
void OAIAssociateOriginationIdentityResult::setPoolId(const QString &pool_id) {
    m_pool_id = pool_id;
    m_pool_id_isSet = true;
}

bool OAIAssociateOriginationIdentityResult::is_pool_id_Set() const{
    return m_pool_id_isSet;
}

bool OAIAssociateOriginationIdentityResult::is_pool_id_Valid() const{
    return m_pool_id_isValid;
}

QString OAIAssociateOriginationIdentityResult::getOriginationIdentityArn() const {
    return m_origination_identity_arn;
}
void OAIAssociateOriginationIdentityResult::setOriginationIdentityArn(const QString &origination_identity_arn) {
    m_origination_identity_arn = origination_identity_arn;
    m_origination_identity_arn_isSet = true;
}

bool OAIAssociateOriginationIdentityResult::is_origination_identity_arn_Set() const{
    return m_origination_identity_arn_isSet;
}

bool OAIAssociateOriginationIdentityResult::is_origination_identity_arn_Valid() const{
    return m_origination_identity_arn_isValid;
}

QString OAIAssociateOriginationIdentityResult::getOriginationIdentity() const {
    return m_origination_identity;
}
void OAIAssociateOriginationIdentityResult::setOriginationIdentity(const QString &origination_identity) {
    m_origination_identity = origination_identity;
    m_origination_identity_isSet = true;
}

bool OAIAssociateOriginationIdentityResult::is_origination_identity_Set() const{
    return m_origination_identity_isSet;
}

bool OAIAssociateOriginationIdentityResult::is_origination_identity_Valid() const{
    return m_origination_identity_isValid;
}

QString OAIAssociateOriginationIdentityResult::getIsoCountryCode() const {
    return m_iso_country_code;
}
void OAIAssociateOriginationIdentityResult::setIsoCountryCode(const QString &iso_country_code) {
    m_iso_country_code = iso_country_code;
    m_iso_country_code_isSet = true;
}

bool OAIAssociateOriginationIdentityResult::is_iso_country_code_Set() const{
    return m_iso_country_code_isSet;
}

bool OAIAssociateOriginationIdentityResult::is_iso_country_code_Valid() const{
    return m_iso_country_code_isValid;
}

bool OAIAssociateOriginationIdentityResult::isSet() const {
...
bool OAIAssociateOriginationIdentityResult::isValid() const {
