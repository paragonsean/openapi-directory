...
/*
 * OAIDescribePhoneNumbersResult.h
 *
 * 
 */

#ifndef OAIDescribePhoneNumbersResult_H
#define OAIDescribePhoneNumbersResult_H
...
class OAIDescribePhoneNumbersResult : public OAIObject {
public:
    OAIDescribePhoneNumbersResult();
    OAIDescribePhoneNumbersResult(QString json);
    ~OAIDescribePhoneNumbersResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePhoneNumbersResult)

#endif // OAIDescribePhoneNumbersResult_H
