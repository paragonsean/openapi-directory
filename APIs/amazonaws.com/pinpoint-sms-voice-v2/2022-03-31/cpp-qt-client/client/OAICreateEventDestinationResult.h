...
/*
 * OAICreateEventDestinationResult.h
 *
 * 
 */

#ifndef OAICreateEventDestinationResult_H
#define OAICreateEventDestinationResult_H

#include <QJsonObject>

#include "OAICreateEventDestinationResult_EventDestination.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateEventDestinationResult_EventDestination;

class OAICreateEventDestinationResult : public OAIObject {
public:
    OAICreateEventDestinationResult();
    OAICreateEventDestinationResult(QString json);
    ~OAICreateEventDestinationResult() override;
    ...
    OAICreateEventDestinationResult_EventDestination getEventDestination() const;
    void setEventDestination(const OAICreateEventDestinationResult_EventDestination &event_destination);
...
private:
    ...
    OAICreateEventDestinationResult_EventDestination m_event_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDestinationResult)

#endif // OAICreateEventDestinationResult_H
