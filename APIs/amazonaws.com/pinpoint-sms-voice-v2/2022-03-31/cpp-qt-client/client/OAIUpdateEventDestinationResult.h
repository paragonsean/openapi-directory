...
/*
 * OAIUpdateEventDestinationResult.h
 *
 * 
 */

#ifndef OAIUpdateEventDestinationResult_H
#define OAIUpdateEventDestinationResult_H
...
namespace OpenAPI {
class OAIUpdateEventDestinationResult_EventDestination;

class OAIUpdateEventDestinationResult : public OAIObject {
public:
    OAIUpdateEventDestinationResult();
    OAIUpdateEventDestinationResult(QString json);
    ~OAIUpdateEventDestinationResult() override;
    ...
    OAIUpdateEventDestinationResult_EventDestination getEventDestination() const;
    void setEventDestination(const OAIUpdateEventDestinationResult_EventDestination &event_destination);
...
private:
    ...
    OAIUpdateEventDestinationResult_EventDestination m_event_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventDestinationResult)

#endif // OAIUpdateEventDestinationResult_H
