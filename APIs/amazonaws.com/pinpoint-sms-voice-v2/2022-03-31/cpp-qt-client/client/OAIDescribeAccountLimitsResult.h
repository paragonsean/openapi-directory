...
/*
 * OAIDescribeAccountLimitsResult.h
 *
 * 
 */

#ifndef OAIDescribeAccountLimitsResult_H
#define OAIDescribeAccountLimitsResult_H
...
class OAIDescribeAccountLimitsResult : public OAIObject {
public:
    OAIDescribeAccountLimitsResult();
    OAIDescribeAccountLimitsResult(QString json);
    ~OAIDescribeAccountLimitsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountLimitsResult)

#endif // OAIDescribeAccountLimitsResult_H
