...
#ifndef OAINumberStatus_H
#define OAINumberStatus_H
...
class OAINumberStatus : public OAIEnum {
public:
    OAINumberStatus();
    OAINumberStatus(QString json);
    ~OAINumberStatus() override;
    ...
    OAINumberStatus::eOAINumberStatus getValue() const;
    void setValue(const OAINumberStatus::eOAINumberStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberStatus)

#endif // OAINumberStatus_H
