...
/*
 * OAICreateEventDestinationRequest_KinesisFirehoseDestination.h
 *
 * 
 */

#ifndef OAICreateEventDestinationRequest_KinesisFirehoseDestination_H
#define OAICreateEventDestinationRequest_KinesisFirehoseDestination_H
...
class OAICreateEventDestinationRequest_KinesisFirehoseDestination : public OAIObject {
public:
    OAICreateEventDestinationRequest_KinesisFirehoseDestination();
    OAICreateEventDestinationRequest_KinesisFirehoseDestination(QString json);
    ~OAICreateEventDestinationRequest_KinesisFirehoseDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDestinationRequest_KinesisFirehoseDestination)

#endif // OAICreateEventDestinationRequest_KinesisFirehoseDestination_H
