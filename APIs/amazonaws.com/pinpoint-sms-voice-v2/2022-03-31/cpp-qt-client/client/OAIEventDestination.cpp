...
QString OAIEventDestination::getEventDestinationName() const {
    return m_event_destination_name;
}
void OAIEventDestination::setEventDestinationName(const QString &event_destination_name) {
    m_event_destination_name = event_destination_name;
    m_event_destination_name_isSet = true;
}

bool OAIEventDestination::is_event_destination_name_Set() const{
    return m_event_destination_name_isSet;
}

bool OAIEventDestination::is_event_destination_name_Valid() const{
...
OAIEventDestination_CloudWatchLogsDestination OAIEventDestination::getCloudWatchLogsDestination() const {
    return m_cloud_watch_logs_destination;
}
void OAIEventDestination::setCloudWatchLogsDestination(const OAIEventDestination_CloudWatchLogsDestination &cloud_watch_logs_destination) {
...
OAICreateEventDestinationRequest_KinesisFirehoseDestination OAIEventDestination::getKinesisFirehoseDestination() const {
    return m_kinesis_firehose_destination;
}
void OAIEventDestination::setKinesisFirehoseDestination(const OAICreateEventDestinationRequest_KinesisFirehoseDestination &kinesis_firehose_destination) {
...
OAIEventDestination_SnsDestination OAIEventDestination::getSnsDestination() const {
    return m_sns_destination;
}
void OAIEventDestination::setSnsDestination(const OAIEventDestination_SnsDestination &sns_destination) {
