...
/*
 * OAIDeleteOptOutListRequest.h
 *
 * 
 */

#ifndef OAIDeleteOptOutListRequest_H
#define OAIDeleteOptOutListRequest_H
...
class OAIDeleteOptOutListRequest : public OAIObject {
public:
    OAIDeleteOptOutListRequest();
    OAIDeleteOptOutListRequest(QString json);
    ~OAIDeleteOptOutListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOptOutListRequest)

#endif // OAIDeleteOptOutListRequest_H
