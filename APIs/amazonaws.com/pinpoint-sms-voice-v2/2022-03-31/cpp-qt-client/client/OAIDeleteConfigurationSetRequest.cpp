...
OAIDeleteConfigurationSetRequest::OAIDeleteConfigurationSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteConfigurationSetRequest::OAIDeleteConfigurationSetRequest() {
    this->initializeModel();
}

OAIDeleteConfigurationSetRequest::~OAIDeleteConfigurationSetRequest() {}

void OAIDeleteConfigurationSetRequest::initializeModel() {

    m_configuration_set_name_isSet = false;
    m_configuration_set_name_isValid = false;
}

void OAIDeleteConfigurationSetRequest::fromJson(QString jsonString) {
...
void OAIDeleteConfigurationSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteConfigurationSetRequest::asJson() const {
...
QJsonObject OAIDeleteConfigurationSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteConfigurationSetRequest::getConfigurationSetName() const {
    return m_configuration_set_name;
}
void OAIDeleteConfigurationSetRequest::setConfigurationSetName(const QString &configuration_set_name) {
    m_configuration_set_name = configuration_set_name;
    m_configuration_set_name_isSet = true;
}

bool OAIDeleteConfigurationSetRequest::is_configuration_set_name_Set() const{
    return m_configuration_set_name_isSet;
}

bool OAIDeleteConfigurationSetRequest::is_configuration_set_name_Valid() const{
    return m_configuration_set_name_isValid;
}

bool OAIDeleteConfigurationSetRequest::isSet() const {
...
bool OAIDeleteConfigurationSetRequest::isValid() const {
