...
OAIAssociateOriginationIdentityRequest::OAIAssociateOriginationIdentityRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateOriginationIdentityRequest::OAIAssociateOriginationIdentityRequest() {
    this->initializeModel();
}

OAIAssociateOriginationIdentityRequest::~OAIAssociateOriginationIdentityRequest() {}

void OAIAssociateOriginationIdentityRequest::initializeModel() {
...
void OAIAssociateOriginationIdentityRequest::fromJson(QString jsonString) {
...
void OAIAssociateOriginationIdentityRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateOriginationIdentityRequest::asJson() const {
...
QJsonObject OAIAssociateOriginationIdentityRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_pool_id_isSet) {
...
QString OAIAssociateOriginationIdentityRequest::getPoolId() const {
    return m_pool_id;
}
void OAIAssociateOriginationIdentityRequest::setPoolId(const QString &pool_id) {
    m_pool_id = pool_id;
    m_pool_id_isSet = true;
}

bool OAIAssociateOriginationIdentityRequest::is_pool_id_Set() const{
    return m_pool_id_isSet;
}

bool OAIAssociateOriginationIdentityRequest::is_pool_id_Valid() const{
    return m_pool_id_isValid;
}

QString OAIAssociateOriginationIdentityRequest::getOriginationIdentity() const {
    return m_origination_identity;
}
void OAIAssociateOriginationIdentityRequest::setOriginationIdentity(const QString &origination_identity) {
    m_origination_identity = origination_identity;
    m_origination_identity_isSet = true;
}

bool OAIAssociateOriginationIdentityRequest::is_origination_identity_Set() const{
    return m_origination_identity_isSet;
}

bool OAIAssociateOriginationIdentityRequest::is_origination_identity_Valid() const{
    return m_origination_identity_isValid;
}

QString OAIAssociateOriginationIdentityRequest::getIsoCountryCode() const {
    return m_iso_country_code;
}
void OAIAssociateOriginationIdentityRequest::setIsoCountryCode(const QString &iso_country_code) {
    m_iso_country_code = iso_country_code;
    m_iso_country_code_isSet = true;
}

bool OAIAssociateOriginationIdentityRequest::is_iso_country_code_Set() const{
    return m_iso_country_code_isSet;
}

bool OAIAssociateOriginationIdentityRequest::is_iso_country_code_Valid() const{
    return m_iso_country_code_isValid;
}

QString OAIAssociateOriginationIdentityRequest::getClientToken() const {
    return m_client_token;
}
void OAIAssociateOriginationIdentityRequest::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIAssociateOriginationIdentityRequest::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIAssociateOriginationIdentityRequest::is_client_token_Valid() const{
    return m_client_token_isValid;
}

bool OAIAssociateOriginationIdentityRequest::isSet() const {
...
bool OAIAssociateOriginationIdentityRequest::isValid() const {
