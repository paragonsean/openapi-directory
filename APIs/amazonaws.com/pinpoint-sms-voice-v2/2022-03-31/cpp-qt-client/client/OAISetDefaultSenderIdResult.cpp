...
OAISetDefaultSenderIdResult::OAISetDefaultSenderIdResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetDefaultSenderIdResult::OAISetDefaultSenderIdResult() {
    this->initializeModel();
}

OAISetDefaultSenderIdResult::~OAISetDefaultSenderIdResult() {}

void OAISetDefaultSenderIdResult::initializeModel() {
...
void OAISetDefaultSenderIdResult::fromJson(QString jsonString) {
...
void OAISetDefaultSenderIdResult::fromJsonObject(QJsonObject json) {
...
QString OAISetDefaultSenderIdResult::asJson() const {
...
QJsonObject OAISetDefaultSenderIdResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetDefaultSenderIdResult::getConfigurationSetArn() const {
    return m_configuration_set_arn;
}
void OAISetDefaultSenderIdResult::setConfigurationSetArn(const QString &configuration_set_arn) {
    m_configuration_set_arn = configuration_set_arn;
    m_configuration_set_arn_isSet = true;
}

bool OAISetDefaultSenderIdResult::is_configuration_set_arn_Set() const{
    return m_configuration_set_arn_isSet;
}

bool OAISetDefaultSenderIdResult::is_configuration_set_arn_Valid() const{
    return m_configuration_set_arn_isValid;
}

QString OAISetDefaultSenderIdResult::getConfigurationSetName() const {
    return m_configuration_set_name;
}
void OAISetDefaultSenderIdResult::setConfigurationSetName(const QString &configuration_set_name) {
    m_configuration_set_name = configuration_set_name;
    m_configuration_set_name_isSet = true;
}

bool OAISetDefaultSenderIdResult::is_configuration_set_name_Set() const{
    return m_configuration_set_name_isSet;
}

bool OAISetDefaultSenderIdResult::is_configuration_set_name_Valid() const{
    return m_configuration_set_name_isValid;
}

QString OAISetDefaultSenderIdResult::getSenderId() const {
    return m_sender_id;
}
void OAISetDefaultSenderIdResult::setSenderId(const QString &sender_id) {
    m_sender_id = sender_id;
    m_sender_id_isSet = true;
}

bool OAISetDefaultSenderIdResult::is_sender_id_Set() const{
    return m_sender_id_isSet;
}

bool OAISetDefaultSenderIdResult::is_sender_id_Valid() const{
    return m_sender_id_isValid;
}

bool OAISetDefaultSenderIdResult::isSet() const {
...
bool OAISetDefaultSenderIdResult::isValid() const {
