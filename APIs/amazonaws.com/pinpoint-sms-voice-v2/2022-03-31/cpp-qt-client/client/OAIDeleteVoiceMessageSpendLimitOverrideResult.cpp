...
OAIDeleteVoiceMessageSpendLimitOverrideResult::OAIDeleteVoiceMessageSpendLimitOverrideResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVoiceMessageSpendLimitOverrideResult::OAIDeleteVoiceMessageSpendLimitOverrideResult() {
    this->initializeModel();
}

OAIDeleteVoiceMessageSpendLimitOverrideResult::~OAIDeleteVoiceMessageSpendLimitOverrideResult() {}

void OAIDeleteVoiceMessageSpendLimitOverrideResult::initializeModel() {

    m_monthly_limit_isSet = false;
    m_monthly_limit_isValid = false;
}

void OAIDeleteVoiceMessageSpendLimitOverrideResult::fromJson(QString jsonString) {
...
void OAIDeleteVoiceMessageSpendLimitOverrideResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVoiceMessageSpendLimitOverrideResult::asJson() const {
...
QJsonObject OAIDeleteVoiceMessageSpendLimitOverrideResult::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDeleteVoiceMessageSpendLimitOverrideResult::getMonthlyLimit() const {
    return m_monthly_limit;
}
void OAIDeleteVoiceMessageSpendLimitOverrideResult::setMonthlyLimit(const qint32 &monthly_limit) {
    m_monthly_limit = monthly_limit;
    m_monthly_limit_isSet = true;
}

bool OAIDeleteVoiceMessageSpendLimitOverrideResult::is_monthly_limit_Set() const{
    return m_monthly_limit_isSet;
}

bool OAIDeleteVoiceMessageSpendLimitOverrideResult::is_monthly_limit_Valid() const{
    return m_monthly_limit_isValid;
}

bool OAIDeleteVoiceMessageSpendLimitOverrideResult::isSet() const {
...
bool OAIDeleteVoiceMessageSpendLimitOverrideResult::isValid() const {
