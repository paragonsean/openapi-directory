...
OAIOptedOutFilter::OAIOptedOutFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOptedOutFilter::OAIOptedOutFilter() {
    this->initializeModel();
}

OAIOptedOutFilter::~OAIOptedOutFilter() {}

void OAIOptedOutFilter::initializeModel() {
...
void OAIOptedOutFilter::fromJson(QString jsonString) {
...
void OAIOptedOutFilter::fromJsonObject(QJsonObject json) {
...
QString OAIOptedOutFilter::asJson() const {
...
QJsonObject OAIOptedOutFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
...
OAIOptedOutFilterName OAIOptedOutFilter::getName() const {
    return m_name;
}
void OAIOptedOutFilter::setName(const OAIOptedOutFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIOptedOutFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIOptedOutFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIOptedOutFilter::getValues() const {
    return m_values;
}
void OAIOptedOutFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIOptedOutFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIOptedOutFilter::is_values_Valid() const{
    return m_values_isValid;
}

bool OAIOptedOutFilter::isSet() const {
...
bool OAIOptedOutFilter::isValid() const {
