...
/*
 * OAIPutKeywordRequest.h
 *
 * 
 */

#ifndef OAIPutKeywordRequest_H
#define OAIPutKeywordRequest_H
...
class OAIPutKeywordRequest : public OAIObject {
public:
    OAIPutKeywordRequest();
    OAIPutKeywordRequest(QString json);
    ~OAIPutKeywordRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutKeywordRequest)

#endif // OAIPutKeywordRequest_H
