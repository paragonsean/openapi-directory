...
/*
 * OAIDeleteConfigurationSetRequest.h
 *
 * 
 */

#ifndef OAIDeleteConfigurationSetRequest_H
#define OAIDeleteConfigurationSetRequest_H
...
class OAIDeleteConfigurationSetRequest : public OAIObject {
public:
    OAIDeleteConfigurationSetRequest();
    OAIDeleteConfigurationSetRequest(QString json);
    ~OAIDeleteConfigurationSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteConfigurationSetRequest)

#endif // OAIDeleteConfigurationSetRequest_H
