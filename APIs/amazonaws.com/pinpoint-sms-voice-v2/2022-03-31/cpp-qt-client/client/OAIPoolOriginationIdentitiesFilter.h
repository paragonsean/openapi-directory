...
/*
 * OAIPoolOriginationIdentitiesFilter.h
 *
 * Information about origination identities associated with a pool that meets a specified criteria.
 */

#ifndef OAIPoolOriginationIdentitiesFilter_H
#define OAIPoolOriginationIdentitiesFilter_H
...
class OAIPoolOriginationIdentitiesFilter : public OAIObject {
public:
    OAIPoolOriginationIdentitiesFilter();
    OAIPoolOriginationIdentitiesFilter(QString json);
    ~OAIPoolOriginationIdentitiesFilter() override;
    ...
    OAIPoolOriginationIdentitiesFilterName getName() const;
    void setName(const OAIPoolOriginationIdentitiesFilterName &name);
...
private:
    ...
    OAIPoolOriginationIdentitiesFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoolOriginationIdentitiesFilter)

#endif // OAIPoolOriginationIdentitiesFilter_H
