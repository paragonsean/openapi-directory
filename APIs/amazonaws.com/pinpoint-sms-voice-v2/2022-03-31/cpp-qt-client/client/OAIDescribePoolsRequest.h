...
/*
 * OAIDescribePoolsRequest.h
 *
 * 
 */

#ifndef OAIDescribePoolsRequest_H
#define OAIDescribePoolsRequest_H
...
class OAIDescribePoolsRequest : public OAIObject {
public:
    OAIDescribePoolsRequest();
    OAIDescribePoolsRequest(QString json);
    ~OAIDescribePoolsRequest() override;
    ...
    QList getPoolIds() const;
    void setPoolIds(const QList &pool_ids);
    bool is_pool_ids_Set() const;
    bool is_pool_ids_Valid() const;
...
private:
    ...
    QList m_pool_ids;
    bool m_pool_ids_isSet;
    bool m_pool_ids_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePoolsRequest)

#endif // OAIDescribePoolsRequest_H
