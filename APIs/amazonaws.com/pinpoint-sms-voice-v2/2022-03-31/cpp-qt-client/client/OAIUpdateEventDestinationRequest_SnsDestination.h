...
/*
 * OAIUpdateEventDestinationRequest_SnsDestination.h
 *
 * 
 */

#ifndef OAIUpdateEventDestinationRequest_SnsDestination_H
#define OAIUpdateEventDestinationRequest_SnsDestination_H
...
class OAIUpdateEventDestinationRequest_SnsDestination : public OAIObject {
public:
    OAIUpdateEventDestinationRequest_SnsDestination();
    OAIUpdateEventDestinationRequest_SnsDestination(QString json);
    ~OAIUpdateEventDestinationRequest_SnsDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventDestinationRequest_SnsDestination)

#endif // OAIUpdateEventDestinationRequest_SnsDestination_H
