...
/*
 * OAIDescribeSenderIdsResult.h
 *
 * 
 */

#ifndef OAIDescribeSenderIdsResult_H
#define OAIDescribeSenderIdsResult_H
...
class OAIDescribeSenderIdsResult : public OAIObject {
public:
    OAIDescribeSenderIdsResult();
    OAIDescribeSenderIdsResult(QString json);
    ~OAIDescribeSenderIdsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSenderIdsResult)

#endif // OAIDescribeSenderIdsResult_H
