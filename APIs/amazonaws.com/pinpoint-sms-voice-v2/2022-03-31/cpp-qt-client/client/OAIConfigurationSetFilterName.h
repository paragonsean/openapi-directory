...
/*
 * OAIConfigurationSetFilterName.h
 *
 * 
 */

#ifndef OAIConfigurationSetFilterName_H
#define OAIConfigurationSetFilterName_H
...
class OAIConfigurationSetFilterName : public OAIEnum {
public:
    OAIConfigurationSetFilterName();
    OAIConfigurationSetFilterName(QString json);
    ~OAIConfigurationSetFilterName() override;
    ...
    enum class eOAIConfigurationSetFilterName {
    ...
    OAIConfigurationSetFilterName::eOAIConfigurationSetFilterName getValue() const;
    void setValue(const OAIConfigurationSetFilterName::eOAIConfigurationSetFilterName& value);
...
private:
    ...
    eOAIConfigurationSetFilterName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfigurationSetFilterName)

#endif // OAIConfigurationSetFilterName_H
