...
/*
 * OAIRequestableNumberType.h
 *
 * 
 */

#ifndef OAIRequestableNumberType_H
#define OAIRequestableNumberType_H
...
class OAIRequestableNumberType : public OAIEnum {
public:
    OAIRequestableNumberType();
    OAIRequestableNumberType(QString json);
    ~OAIRequestableNumberType() override;
    ...
    enum class eOAIRequestableNumberType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LONG_CODE, 
        TOLL_FREE, 
        TEN_DLC
    };
    OAIRequestableNumberType::eOAIRequestableNumberType getValue() const;
    void setValue(const OAIRequestableNumberType::eOAIRequestableNumberType& value);
...
private:
    ...
    eOAIRequestableNumberType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestableNumberType)

#endif // OAIRequestableNumberType_H
