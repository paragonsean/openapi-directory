...
/*
 * OAIDescribeKeywordsResult.h
 *
 * 
 */

#ifndef OAIDescribeKeywordsResult_H
#define OAIDescribeKeywordsResult_H
...
class OAIDescribeKeywordsResult : public OAIObject {
public:
    OAIDescribeKeywordsResult();
    OAIDescribeKeywordsResult(QString json);
    ~OAIDescribeKeywordsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeKeywordsResult)

#endif // OAIDescribeKeywordsResult_H
