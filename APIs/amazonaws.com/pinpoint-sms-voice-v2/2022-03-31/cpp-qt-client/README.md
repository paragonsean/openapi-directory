...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIAssociateOriginationIdentityRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIAssociateOriginationIdentityRequest Example::create(){
    OAIAssociateOriginationIdentityRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateOriginationIdentitySignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateOriginationIdentitySignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAssociateOriginationIdentityRequest oai_associate_origination_identity_request = create(); // OAIAssociateOriginationIdentityRequest | 
      ...
      apiInstance.associateOriginationIdentity(x_amz_targetoai_associate_origination_identity_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
