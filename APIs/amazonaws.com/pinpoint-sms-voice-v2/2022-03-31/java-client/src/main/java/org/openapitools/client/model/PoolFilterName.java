...
/**
 * Gets or Sets PoolFilterName
 */
@JsonAdapter(PoolFilterName.Adapter.class)
public enum PoolFilterName {
  ...
  public static PoolFilterName fromValue(String value) {
    for (PoolFilterName b : PoolFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<PoolFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final PoolFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PoolFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PoolFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PoolFilterName.fromValue(value);
  }
}
