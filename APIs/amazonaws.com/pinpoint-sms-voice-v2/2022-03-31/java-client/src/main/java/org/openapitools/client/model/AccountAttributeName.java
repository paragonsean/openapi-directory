...
/**
 * Gets or Sets AccountAttributeName
 */
@JsonAdapter(AccountAttributeName.Adapter.class)
public enum AccountAttributeName {
  ...
  AccountAttributeName(String value) {
    this.value = value;
  }
  ...
  public static AccountAttributeName fromValue(String value) {
    for (AccountAttributeName b : AccountAttributeName.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccountAttributeName> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountAttributeName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountAttributeName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountAttributeName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccountAttributeName.fromValue(value);
  }
}
