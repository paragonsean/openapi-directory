...
/**
 * Gets or Sets KeywordAction
 */
@JsonAdapter(KeywordAction.Adapter.class)
public enum KeywordAction {
  ...
  public static KeywordAction fromValue(String value) {
    for (KeywordAction b : KeywordAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<KeywordAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final KeywordAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public KeywordAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return KeywordAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    KeywordAction.fromValue(value);
  }
}
