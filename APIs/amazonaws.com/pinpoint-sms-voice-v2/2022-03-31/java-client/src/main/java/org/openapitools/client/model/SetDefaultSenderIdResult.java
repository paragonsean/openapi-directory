...
public class SetDefaultSenderIdResult {
  ...
  public SetDefaultSenderIdResult configurationSetArn(String configurationSetArn) {
  ...
  public SetDefaultSenderIdResult configurationSetName(String configurationSetName) {
  ...
  public SetDefaultSenderIdResult senderId(String senderId) {
  ...
  public boolean equals(Object o) {
    ...
    SetDefaultSenderIdResult setDefaultSenderIdResult = (SetDefaultSenderIdResult) o;
    return Objects.equals(this.configurationSetArn, setDefaultSenderIdResult.configurationSetArn) &&
        Objects.equals(this.configurationSetName, setDefaultSenderIdResult.configurationSetName) &&
        Objects.equals(this.senderId, setDefaultSenderIdResult.senderId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetDefaultSenderIdResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetDefaultSenderIdResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetDefaultSenderIdResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetDefaultSenderIdResult is not found in the empty JSON string", SetDefaultSenderIdResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetDefaultSenderIdResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetDefaultSenderIdResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetDefaultSenderIdResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetDefaultSenderIdResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetDefaultSenderIdResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetDefaultSenderIdResult.class));

       return (TypeAdapter<T>) new TypeAdapter<SetDefaultSenderIdResult>() {
           @Override
           public void write(JsonWriter out, SetDefaultSenderIdResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetDefaultSenderIdResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetDefaultSenderIdResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetDefaultSenderIdResult
   * @throws IOException if the JSON string is invalid with respect to SetDefaultSenderIdResult
   */
  public static SetDefaultSenderIdResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetDefaultSenderIdResult.class);
  }

  /**
   * Convert an instance of SetDefaultSenderIdResult to an JSON string
   *
   * @return JSON string
   */
