...
/**
 * Gets or Sets OptedOutFilterName
 */
@JsonAdapter(OptedOutFilterName.Adapter.class)
public enum OptedOutFilterName {
  ...
  OptedOutFilterName(String value) {
    this.value = value;
  }
  ...
  public static OptedOutFilterName fromValue(String value) {
    for (OptedOutFilterName b : OptedOutFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<OptedOutFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final OptedOutFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OptedOutFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OptedOutFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OptedOutFilterName.fromValue(value);
  }
}
