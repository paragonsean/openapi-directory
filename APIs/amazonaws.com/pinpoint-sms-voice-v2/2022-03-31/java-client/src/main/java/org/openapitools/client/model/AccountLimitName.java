...
/**
 * Gets or Sets AccountLimitName
 */
@JsonAdapter(AccountLimitName.Adapter.class)
public enum AccountLimitName {
  ...
  public static AccountLimitName fromValue(String value) {
    for (AccountLimitName b : AccountLimitName.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccountLimitName> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountLimitName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountLimitName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountLimitName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccountLimitName.fromValue(value);
  }
}
