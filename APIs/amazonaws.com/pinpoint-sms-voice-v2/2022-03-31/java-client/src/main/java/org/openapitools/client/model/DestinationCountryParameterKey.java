...
/**
 * Gets or Sets DestinationCountryParameterKey
 */
@JsonAdapter(DestinationCountryParameterKey.Adapter.class)
public enum DestinationCountryParameterKey {
  ...
  DestinationCountryParameterKey(String value) {
    this.value = value;
  }
  ...
  public static DestinationCountryParameterKey fromValue(String value) {
    for (DestinationCountryParameterKey b : DestinationCountryParameterKey.values()) {
  ...
  public static class Adapter extends TypeAdapter<DestinationCountryParameterKey> {
    @Override
    public void write(final JsonWriter jsonWriter, final DestinationCountryParameterKey enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DestinationCountryParameterKey read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DestinationCountryParameterKey.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DestinationCountryParameterKey.fromValue(value);
  }
}
