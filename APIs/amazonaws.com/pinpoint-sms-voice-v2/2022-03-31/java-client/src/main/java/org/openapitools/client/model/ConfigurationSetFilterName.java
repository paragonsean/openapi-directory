...
/**
 * Gets or Sets ConfigurationSetFilterName
 */
@JsonAdapter(ConfigurationSetFilterName.Adapter.class)
public enum ConfigurationSetFilterName {
  ...
  ConfigurationSetFilterName(String value) {
    this.value = value;
  }
  ...
  public static ConfigurationSetFilterName fromValue(String value) {
    for (ConfigurationSetFilterName b : ConfigurationSetFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<ConfigurationSetFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final ConfigurationSetFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ConfigurationSetFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ConfigurationSetFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ConfigurationSetFilterName.fromValue(value);
  }
}
