...
public class ApiClient {
    ...
    private String basePath = "http://sms-voice.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2022-03-31/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sms-voice.us-east-1.amazonaws.com
