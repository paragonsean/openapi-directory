...
public class DeleteDefaultSenderIdResult {
  ...
  public DeleteDefaultSenderIdResult configurationSetArn(String configurationSetArn) {
  ...
  public DeleteDefaultSenderIdResult configurationSetName(String configurationSetName) {
  ...
  public DeleteDefaultSenderIdResult senderId(String senderId) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteDefaultSenderIdResult deleteDefaultSenderIdResult = (DeleteDefaultSenderIdResult) o;
    return Objects.equals(this.configurationSetArn, deleteDefaultSenderIdResult.configurationSetArn) &&
        Objects.equals(this.configurationSetName, deleteDefaultSenderIdResult.configurationSetName) &&
        Objects.equals(this.senderId, deleteDefaultSenderIdResult.senderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationSetArn, configurationSetName, senderId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteDefaultSenderIdResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDefaultSenderIdResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDefaultSenderIdResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDefaultSenderIdResult is not found in the empty JSON string", DeleteDefaultSenderIdResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDefaultSenderIdResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDefaultSenderIdResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDefaultSenderIdResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDefaultSenderIdResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDefaultSenderIdResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDefaultSenderIdResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDefaultSenderIdResult>() {
           @Override
           public void write(JsonWriter out, DeleteDefaultSenderIdResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDefaultSenderIdResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDefaultSenderIdResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDefaultSenderIdResult
   * @throws IOException if the JSON string is invalid with respect to DeleteDefaultSenderIdResult
   */
  public static DeleteDefaultSenderIdResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDefaultSenderIdResult.class);
  }

  /**
   * Convert an instance of DeleteDefaultSenderIdResult to an JSON string
   *
   * @return JSON string
   */
