...
/**
 * Gets or Sets SpendLimitName
 */
@JsonAdapter(SpendLimitName.Adapter.class)
public enum SpendLimitName {
  ...
  public static SpendLimitName fromValue(String value) {
    for (SpendLimitName b : SpendLimitName.values()) {
  ...
  public static class Adapter extends TypeAdapter<SpendLimitName> {
    @Override
    public void write(final JsonWriter jsonWriter, final SpendLimitName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SpendLimitName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SpendLimitName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SpendLimitName.fromValue(value);
  }
}
