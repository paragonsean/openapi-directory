...
/**
 * Gets or Sets SenderIdFilterName
 */
@JsonAdapter(SenderIdFilterName.Adapter.class)
public enum SenderIdFilterName {
  ...
  SenderIdFilterName(String value) {
    this.value = value;
  }
  ...
  public static SenderIdFilterName fromValue(String value) {
    for (SenderIdFilterName b : SenderIdFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<SenderIdFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final SenderIdFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SenderIdFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SenderIdFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SenderIdFilterName.fromValue(value);
  }
}
