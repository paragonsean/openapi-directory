...
/**
 * Gets or Sets VoiceMessageBodyTextType
 */
@JsonAdapter(VoiceMessageBodyTextType.Adapter.class)
public enum VoiceMessageBodyTextType {
  ...
  VoiceMessageBodyTextType(String value) {
    this.value = value;
  }
  ...
  public static VoiceMessageBodyTextType fromValue(String value) {
    for (VoiceMessageBodyTextType b : VoiceMessageBodyTextType.values()) {
  ...
  public static class Adapter extends TypeAdapter<VoiceMessageBodyTextType> {
    @Override
    public void write(final JsonWriter jsonWriter, final VoiceMessageBodyTextType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VoiceMessageBodyTextType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VoiceMessageBodyTextType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VoiceMessageBodyTextType.fromValue(value);
  }
}
