...
public class DeletePoolResult {
  ...
  public DeletePoolResult poolArn(String poolArn) {
  ...
  public DeletePoolResult poolId(String poolId) {
    this.poolId = poolId;
    return this;
  }
  ...
  public DeletePoolResult status(PoolStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeletePoolResult messageType(MessageType messageType) {
  ...
  public DeletePoolResult twoWayEnabled(Boolean twoWayEnabled) {
  ...
  public DeletePoolResult twoWayChannelArn(String twoWayChannelArn) {
  ...
  public DeletePoolResult selfManagedOptOutsEnabled(Boolean selfManagedOptOutsEnabled) {
  ...
  public DeletePoolResult optOutListName(String optOutListName) {
  ...
  public DeletePoolResult sharedRoutesEnabled(Boolean sharedRoutesEnabled) {
  ...
  public DeletePoolResult createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePoolResult deletePoolResult = (DeletePoolResult) o;
    return Objects.equals(this.poolArn, deletePoolResult.poolArn) &&
        Objects.equals(this.poolId, deletePoolResult.poolId) &&
        Objects.equals(this.status, deletePoolResult.status) &&
        Objects.equals(this.messageType, deletePoolResult.messageType) &&
        Objects.equals(this.twoWayEnabled, deletePoolResult.twoWayEnabled) &&
        Objects.equals(this.twoWayChannelArn, deletePoolResult.twoWayChannelArn) &&
        Objects.equals(this.selfManagedOptOutsEnabled, deletePoolResult.selfManagedOptOutsEnabled) &&
        Objects.equals(this.optOutListName, deletePoolResult.optOutListName) &&
        Objects.equals(this.sharedRoutesEnabled, deletePoolResult.sharedRoutesEnabled) &&
        Objects.equals(this.createdTimestamp, deletePoolResult.createdTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolArn, poolId, status, messageType, twoWayEnabled, twoWayChannelArn, selfManagedOptOutsEnabled, optOutListName, sharedRoutesEnabled, createdTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePoolResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePoolResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePoolResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePoolResult is not found in the empty JSON string", DeletePoolResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePoolResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePoolResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePoolResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePoolResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePoolResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePoolResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePoolResult>() {
           @Override
           public void write(JsonWriter out, DeletePoolResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePoolResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePoolResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePoolResult
   * @throws IOException if the JSON string is invalid with respect to DeletePoolResult
   */
  public static DeletePoolResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePoolResult.class);
  }

  /**
   * Convert an instance of DeletePoolResult to an JSON string
   *
   * @return JSON string
   */
