...
public class DeleteOptedOutNumberResult {
  ...
  public DeleteOptedOutNumberResult optOutListArn(String optOutListArn) {
  ...
  public DeleteOptedOutNumberResult optOutListName(String optOutListName) {
  ...
  public DeleteOptedOutNumberResult optedOutNumber(String optedOutNumber) {
  ...
  public DeleteOptedOutNumberResult optedOutTimestamp(OffsetDateTime optedOutTimestamp) {
  ...
  public DeleteOptedOutNumberResult endUserOptedOut(Boolean endUserOptedOut) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteOptedOutNumberResult deleteOptedOutNumberResult = (DeleteOptedOutNumberResult) o;
    return Objects.equals(this.optOutListArn, deleteOptedOutNumberResult.optOutListArn) &&
        Objects.equals(this.optOutListName, deleteOptedOutNumberResult.optOutListName) &&
        Objects.equals(this.optedOutNumber, deleteOptedOutNumberResult.optedOutNumber) &&
        Objects.equals(this.optedOutTimestamp, deleteOptedOutNumberResult.optedOutTimestamp) &&
        Objects.equals(this.endUserOptedOut, deleteOptedOutNumberResult.endUserOptedOut);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteOptedOutNumberResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteOptedOutNumberResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteOptedOutNumberResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteOptedOutNumberResult is not found in the empty JSON string", DeleteOptedOutNumberResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteOptedOutNumberResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteOptedOutNumberResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteOptedOutNumberResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteOptedOutNumberResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteOptedOutNumberResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteOptedOutNumberResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteOptedOutNumberResult>() {
           @Override
           public void write(JsonWriter out, DeleteOptedOutNumberResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteOptedOutNumberResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteOptedOutNumberResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteOptedOutNumberResult
   * @throws IOException if the JSON string is invalid with respect to DeleteOptedOutNumberResult
   */
  public static DeleteOptedOutNumberResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteOptedOutNumberResult.class);
  }

  /**
   * Convert an instance of DeleteOptedOutNumberResult to an JSON string
   *
   * @return JSON string
   */
