...
/**
 * Gets or Sets PhoneNumberFilterName
 */
@JsonAdapter(PhoneNumberFilterName.Adapter.class)
public enum PhoneNumberFilterName {
  ...
  PhoneNumberFilterName(String value) {
    this.value = value;
  }
  ...
  public static PhoneNumberFilterName fromValue(String value) {
    for (PhoneNumberFilterName b : PhoneNumberFilterName.values()) {
  ...
  public static class Adapter extends TypeAdapter<PhoneNumberFilterName> {
    @Override
    public void write(final JsonWriter jsonWriter, final PhoneNumberFilterName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PhoneNumberFilterName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PhoneNumberFilterName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PhoneNumberFilterName.fromValue(value);
  }
}
