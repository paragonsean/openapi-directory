...
public class CreatePoolResult {
  ...
  public CreatePoolResult poolArn(String poolArn) {
  ...
  public CreatePoolResult poolId(String poolId) {
    this.poolId = poolId;
    return this;
  }
  ...
  public CreatePoolResult status(PoolStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreatePoolResult messageType(MessageType messageType) {
  ...
  public CreatePoolResult twoWayEnabled(Boolean twoWayEnabled) {
  ...
  public CreatePoolResult twoWayChannelArn(String twoWayChannelArn) {
  ...
  public CreatePoolResult selfManagedOptOutsEnabled(Boolean selfManagedOptOutsEnabled) {
  ...
  public CreatePoolResult optOutListName(String optOutListName) {
  ...
  public CreatePoolResult sharedRoutesEnabled(Boolean sharedRoutesEnabled) {
  ...
  public CreatePoolResult deletionProtectionEnabled(Boolean deletionProtectionEnabled) {
  ...
  public CreatePoolResult tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreatePoolResult createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePoolResult createPoolResult = (CreatePoolResult) o;
    return Objects.equals(this.poolArn, createPoolResult.poolArn) &&
        Objects.equals(this.poolId, createPoolResult.poolId) &&
        Objects.equals(this.status, createPoolResult.status) &&
        Objects.equals(this.messageType, createPoolResult.messageType) &&
        Objects.equals(this.twoWayEnabled, createPoolResult.twoWayEnabled) &&
        Objects.equals(this.twoWayChannelArn, createPoolResult.twoWayChannelArn) &&
        Objects.equals(this.selfManagedOptOutsEnabled, createPoolResult.selfManagedOptOutsEnabled) &&
        Objects.equals(this.optOutListName, createPoolResult.optOutListName) &&
        Objects.equals(this.sharedRoutesEnabled, createPoolResult.sharedRoutesEnabled) &&
        Objects.equals(this.deletionProtectionEnabled, createPoolResult.deletionProtectionEnabled) &&
        Objects.equals(this.tags, createPoolResult.tags) &&
        Objects.equals(this.createdTimestamp, createPoolResult.createdTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(poolArn, poolId, status, messageType, twoWayEnabled, twoWayChannelArn, selfManagedOptOutsEnabled, optOutListName, sharedRoutesEnabled, deletionProtectionEnabled, tags, createdTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePoolResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePoolResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePoolResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePoolResult is not found in the empty JSON string", CreatePoolResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePoolResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePoolResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePoolResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePoolResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePoolResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePoolResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePoolResult>() {
           @Override
           public void write(JsonWriter out, CreatePoolResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePoolResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePoolResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePoolResult
   * @throws IOException if the JSON string is invalid with respect to CreatePoolResult
   */
  public static CreatePoolResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePoolResult.class);
  }

  /**
   * Convert an instance of CreatePoolResult to an JSON string
   *
   * @return JSON string
   */
