...
/**
 * Gets or Sets RequestableNumberType
 */
@JsonAdapter(RequestableNumberType.Adapter.class)
public enum RequestableNumberType {
  ...
  RequestableNumberType(String value) {
    this.value = value;
  }
  ...
  public static RequestableNumberType fromValue(String value) {
    for (RequestableNumberType b : RequestableNumberType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RequestableNumberType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RequestableNumberType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RequestableNumberType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RequestableNumberType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RequestableNumberType.fromValue(value);
  }
}
