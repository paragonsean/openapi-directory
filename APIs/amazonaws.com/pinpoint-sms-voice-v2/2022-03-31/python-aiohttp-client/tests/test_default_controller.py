...
async def test_associate_origination_identity(client):
    """Test case for associate_origination_identity

    
    """
    body = {"PoolId":"","OriginationIdentity":"","ClientToken":"","IsoCountryCode":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.AssociateOriginationIdentity',
        headers=headers,
        json=body,
        )
...
async def test_create_configuration_set(client):
    ...
    """
    body = {"ConfigurationSetName":"","ClientToken":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.CreateConfigurationSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_event_destination(client):
    """Test case for create_event_destination

    
    """
    body = {"EventDestinationName":"","SnsDestination":{"TopicArn":""},"ConfigurationSetName":"","MatchingEventTypes":"","ClientToken":"","CloudWatchLogsDestination":{"IamRoleArn":"","LogGroupArn":""},"KinesisFirehoseDestination":{"DeliveryStreamArn":"","IamRoleArn":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.CreateEventDestination',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_opt_out_list(client):
    """Test case for create_opt_out_list

    
    """
    body = {"OptOutListName":"","ClientToken":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.CreateOptOutList',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_pool(client):
    """Test case for create_pool

    
    """
    body = {"OriginationIdentity":"","ClientToken":"","DeletionProtectionEnabled":"","IsoCountryCode":"","MessageType":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.CreatePool',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_configuration_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteConfigurationSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_default_message_type(client):
    """Test case for delete_default_message_type
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteDefaultMessageType',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_default_sender_id(client):
    """Test case for delete_default_sender_id
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteDefaultSenderId',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_event_destination(client):
    """Test case for delete_event_destination

    
    """
    body = {"EventDestinationName":"","ConfigurationSetName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteEventDestination',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_keyword(client):
    ...
    """
    body = {"Keyword":"","OriginationIdentity":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteKeyword',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_opt_out_list(client):
    """Test case for delete_opt_out_list
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteOptOutList',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_opted_out_number(client):
    """Test case for delete_opted_out_number

    
    """
    body = {"OptOutListName":"","OptedOutNumber":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteOptedOutNumber',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_pool(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeletePool',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_text_message_spend_limit_override(client):
    """Test case for delete_text_message_spend_limit_override
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteTextMessageSpendLimitOverride',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_voice_message_spend_limit_override(client):
    """Test case for delete_voice_message_spend_limit_override
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DeleteVoiceMessageSpendLimitOverride',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_account_attributes(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeAccountAttributes',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_account_limits(client):
    """Test case for describe_account_limits
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeAccountLimits',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_configuration_sets(client):
    """Test case for describe_configuration_sets

    
    """
    body = {"Filters":"","NextToken":"","MaxResults":"","ConfigurationSetNames":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeConfigurationSets',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_keywords(client):
    """Test case for describe_keywords

    
    """
    body = {"Filters":"","Keywords":"","NextToken":"","MaxResults":"","OriginationIdentity":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeKeywords',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_opt_out_lists(client):
    """Test case for describe_opt_out_lists

    
    """
    body = {"OptOutListNames":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeOptOutLists',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_opted_out_numbers(client):
    """Test case for describe_opted_out_numbers

    
    """
    body = {"OptOutListName":"","Filters":"","OptedOutNumbers":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeOptedOutNumbers',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_phone_numbers(client):
    """Test case for describe_phone_numbers

    
    """
    body = {"Filters":"","NextToken":"","MaxResults":"","PhoneNumberIds":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribePhoneNumbers',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_pools(client):
    """Test case for describe_pools

    
    """
    body = {"Filters":"","NextToken":"","PoolIds":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribePools',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_sender_ids(client):
    """Test case for describe_sender_ids

    
    """
    body = {"Filters":"","NextToken":"","MaxResults":"","SenderIds":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeSenderIds',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_describe_spend_limits(client):
    """Test case for describe_spend_limits
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DescribeSpendLimits',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_disassociate_origination_identity(client):
    """Test case for disassociate_origination_identity
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.DisassociateOriginationIdentity',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_pool_origination_identities(client):
    """Test case for list_pool_origination_identities

    
    """
    body = {"Filters":"","PoolId":"","NextToken":"","MaxResults":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.ListPoolOriginationIdentities',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_keyword(client):
    """Test case for put_keyword

    
    """
    body = {"KeywordMessage":"","Keyword":"","KeywordAction":"","OriginationIdentity":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.PutKeyword',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_opted_out_number(client):
    """Test case for put_opted_out_number
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.PutOptedOutNumber',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_release_phone_number(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.ReleasePhoneNumber',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_request_phone_number(client):
    """Test case for request_phone_number

    
    """
    body = {"OptOutListName":"","NumberType":"","PoolId":"","NumberCapabilities":"","RegistrationId":"","ClientToken":"","DeletionProtectionEnabled":"","IsoCountryCode":"","MessageType":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.RequestPhoneNumber',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_send_text_message(client):
    """Test case for send_text_message

    
    """
    body = {"Context":"","TimeToLive":"","Keyword":"","DryRun":"","ConfigurationSetName":"","DestinationCountryParameters":"","OriginationIdentity":"","DestinationPhoneNumber":"","MaxPrice":"","MessageType":"","MessageBody":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SendTextMessage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_send_voice_message(client):
    ...
    """
    body = {"Context":"","TimeToLive":"","DryRun":"","ConfigurationSetName":"","VoiceId":"","MaxPricePerMinute":"","OriginationIdentity":"","MessageBodyTextType":"","DestinationPhoneNumber":"","MessageBody":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SendVoiceMessage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_default_message_type(client):
    """Test case for set_default_message_type

    
    """
    body = {"ConfigurationSetName":"","MessageType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SetDefaultMessageType',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_default_sender_id(client):
    """Test case for set_default_sender_id

    
    """
    body = {"ConfigurationSetName":"","SenderId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SetDefaultSenderId',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_text_message_spend_limit_override(client):
    """Test case for set_text_message_spend_limit_override
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SetTextMessageSpendLimitOverride',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_set_voice_message_spend_limit_override(client):
    """Test case for set_voice_message_spend_limit_override
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.SetVoiceMessageSpendLimitOverride',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_event_destination(client):
    """Test case for update_event_destination

    
    """
    body = {"EventDestinationName":"","SnsDestination":{"TopicArn":""},"ConfigurationSetName":"","Enabled":"","MatchingEventTypes":"","CloudWatchLogsDestination":{"IamRoleArn":"","LogGroupArn":""},"KinesisFirehoseDestination":{"DeliveryStreamArn":"","IamRoleArn":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.UpdateEventDestination',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_phone_number(client):
    ...
    """
    body = {"OptOutListName":"","SelfManagedOptOutsEnabled":"","TwoWayEnabled":"","PhoneNumberId":"","TwoWayChannelArn":"","DeletionProtectionEnabled":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.UpdatePhoneNumber',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_pool(client):
    """Test case for update_pool

    
    """
    body = {"OptOutListName":"","SelfManagedOptOutsEnabled":"","SharedRoutesEnabled":"","PoolId":"","TwoWayEnabled":"","TwoWayChannelArn":"","DeletionProtectionEnabled":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=PinpointSMSVoiceV2.UpdatePool',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
