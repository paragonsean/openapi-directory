...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.OptedOutNumberInformation();
  });
  ...
  describe('OptedOutNumberInformation', function() {
    it('should create an instance of OptedOutNumberInformation', function() {
      // uncomment below and update the code to test OptedOutNumberInformation
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutNumberInformation();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.OptedOutNumberInformation);
    });

    it('should have the property optedOutNumber (base name: "OptedOutNumber")', function() {
      // uncomment below and update the code to test the property optedOutNumber
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutNumberInformation();
      //expect(instance).to.be();
    });

    it('should have the property optedOutTimestamp (base name: "OptedOutTimestamp")', function() {
      // uncomment below and update the code to test the property optedOutTimestamp
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutNumberInformation();
      //expect(instance).to.be();
    });

    it('should have the property endUserOptedOut (base name: "EndUserOptedOut")', function() {
      // uncomment below and update the code to test the property endUserOptedOut
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutNumberInformation();
      //expect(instance).to.be();
    });
