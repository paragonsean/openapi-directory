...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
  });
  ...
  describe('ConfigurationSetInformation', function() {
    it('should create an instance of ConfigurationSetInformation', function() {
      // uncomment below and update the code to test ConfigurationSetInformation
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ConfigurationSetInformation);
    });

    it('should have the property configurationSetArn (base name: "ConfigurationSetArn")', function() {
      // uncomment below and update the code to test the property configurationSetArn
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
    ...
    it('should have the property eventDestinations (base name: "EventDestinations")', function() {
      // uncomment below and update the code to test the property eventDestinations
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
      //expect(instance).to.be();
    });

    it('should have the property defaultMessageType (base name: "DefaultMessageType")', function() {
      // uncomment below and update the code to test the property defaultMessageType
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
      //expect(instance).to.be();
    });

    it('should have the property defaultSenderId (base name: "DefaultSenderId")', function() {
      // uncomment below and update the code to test the property defaultSenderId
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetInformation();
      //expect(instance).to.be();
    });
