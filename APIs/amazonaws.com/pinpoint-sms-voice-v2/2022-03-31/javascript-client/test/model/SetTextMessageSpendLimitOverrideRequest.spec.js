...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideRequest();
  });
  ...
  describe('SetTextMessageSpendLimitOverrideRequest', function() {
    it('should create an instance of SetTextMessageSpendLimitOverrideRequest', function() {
      // uncomment below and update the code to test SetTextMessageSpendLimitOverrideRequest
      //var instance = new AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideRequest);
    });
