...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteConfigurationSetRequest();
  });
  ...
  describe('DeleteConfigurationSetRequest', function() {
    it('should create an instance of DeleteConfigurationSetRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteConfigurationSetRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteConfigurationSetRequest);
    });
