...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetDefaultSenderIdRequest();
  });
  ...
  describe('SetDefaultSenderIdRequest', function() {
    it('should create an instance of SetDefaultSenderIdRequest', function() {
      // uncomment below and update the code to test SetDefaultSenderIdRequest
      //var instance = new AmazonPinpointSmsVoiceV2.SetDefaultSenderIdRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetDefaultSenderIdRequest);
    });
