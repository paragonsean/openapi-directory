...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateOptOutListRequest();
  });
  ...
  describe('CreateOptOutListRequest', function() {
    it('should create an instance of CreateOptOutListRequest', function() {
      // uncomment below and update the code to test CreateOptOutListRequest
      //var instance = new AmazonPinpointSmsVoiceV2.CreateOptOutListRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateOptOutListRequest);
    });
