...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UntagResourceRequest);
    });
