...
(function(root, factory) {
  ...
  describe('KeywordAction', function() {
    it('should create an instance of KeywordAction', function() {
      // uncomment below and update the code to test KeywordAction
      //var instance = new AmazonPinpointSmsVoiceV2.KeywordAction();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.KeywordAction);
    });
