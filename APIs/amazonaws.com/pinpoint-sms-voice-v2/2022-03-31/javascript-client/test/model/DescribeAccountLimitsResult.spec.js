...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeAccountLimitsResult();
  });
  ...
  describe('DescribeAccountLimitsResult', function() {
    it('should create an instance of DescribeAccountLimitsResult', function() {
      // uncomment below and update the code to test DescribeAccountLimitsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeAccountLimitsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeAccountLimitsResult);
    });
