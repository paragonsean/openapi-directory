...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityRequest();
  });
  ...
  describe('DisassociateOriginationIdentityRequest', function() {
    it('should create an instance of DisassociateOriginationIdentityRequest', function() {
      // uncomment below and update the code to test DisassociateOriginationIdentityRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityRequest);
    });
