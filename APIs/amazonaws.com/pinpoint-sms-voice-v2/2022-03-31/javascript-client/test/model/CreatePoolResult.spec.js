...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreatePoolResult();
  });
  ...
  describe('CreatePoolResult', function() {
    it('should create an instance of CreatePoolResult', function() {
      // uncomment below and update the code to test CreatePoolResult
      //var instance = new AmazonPinpointSmsVoiceV2.CreatePoolResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreatePoolResult);
    });
