...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestSnsDestination();
  });
  ...
  describe('CreateEventDestinationRequestSnsDestination', function() {
    it('should create an instance of CreateEventDestinationRequestSnsDestination', function() {
      // uncomment below and update the code to test CreateEventDestinationRequestSnsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestSnsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestSnsDestination);
    });
