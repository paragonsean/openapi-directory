...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetDefaultSenderIdResult();
  });
  ...
  describe('SetDefaultSenderIdResult', function() {
    it('should create an instance of SetDefaultSenderIdResult', function() {
      // uncomment below and update the code to test SetDefaultSenderIdResult
      //var instance = new AmazonPinpointSmsVoiceV2.SetDefaultSenderIdResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetDefaultSenderIdResult);
    });
