...
(function(root, factory) {
  ...
  describe('DestinationCountryParameterKey', function() {
    it('should create an instance of DestinationCountryParameterKey', function() {
      // uncomment below and update the code to test DestinationCountryParameterKey
      //var instance = new AmazonPinpointSmsVoiceV2.DestinationCountryParameterKey();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DestinationCountryParameterKey);
    });
