...
(function(root, factory) {
  ...
  describe('VoiceId', function() {
    it('should create an instance of VoiceId', function() {
      // uncomment below and update the code to test VoiceId
      //var instance = new AmazonPinpointSmsVoiceV2.VoiceId();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.VoiceId);
    });
