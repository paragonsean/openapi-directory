...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribePhoneNumbersResult();
  });
  ...
  describe('DescribePhoneNumbersResult', function() {
    it('should create an instance of DescribePhoneNumbersResult', function() {
      // uncomment below and update the code to test DescribePhoneNumbersResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribePhoneNumbersResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribePhoneNumbersResult);
    });
