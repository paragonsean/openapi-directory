...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CloudWatchLogsDestination();
  });
  ...
  describe('CloudWatchLogsDestination', function() {
    it('should create an instance of CloudWatchLogsDestination', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.CloudWatchLogsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CloudWatchLogsDestination);
    });
