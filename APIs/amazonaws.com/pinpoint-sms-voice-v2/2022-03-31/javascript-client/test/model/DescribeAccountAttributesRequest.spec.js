...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeAccountAttributesRequest();
  });
  ...
  describe('DescribeAccountAttributesRequest', function() {
    it('should create an instance of DescribeAccountAttributesRequest', function() {
      // uncomment below and update the code to test DescribeAccountAttributesRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeAccountAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeAccountAttributesRequest);
    });
