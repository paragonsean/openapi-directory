...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsRequest();
  });
  ...
  describe('DescribeConfigurationSetsRequest', function() {
    it('should create an instance of DescribeConfigurationSetsRequest', function() {
      // uncomment below and update the code to test DescribeConfigurationSetsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsRequest);
    });

    it('should have the property configurationSetNames (base name: "ConfigurationSetNames")', function() {
      // uncomment below and update the code to test the property configurationSetNames
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsRequest();
