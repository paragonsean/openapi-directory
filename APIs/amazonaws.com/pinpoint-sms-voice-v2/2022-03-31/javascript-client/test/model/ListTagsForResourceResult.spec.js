...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ListTagsForResourceResult();
  });
  ...
  describe('ListTagsForResourceResult', function() {
    it('should create an instance of ListTagsForResourceResult', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.ListTagsForResourceResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ListTagsForResourceResult);
    });
