...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SenderIdFilter();
  });
  ...
  describe('SenderIdFilter', function() {
    it('should create an instance of SenderIdFilter', function() {
      // uncomment below and update the code to test SenderIdFilter
      //var instance = new AmazonPinpointSmsVoiceV2.SenderIdFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SenderIdFilter);
    });
