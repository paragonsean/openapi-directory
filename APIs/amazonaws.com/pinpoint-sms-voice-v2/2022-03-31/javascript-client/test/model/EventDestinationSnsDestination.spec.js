...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.EventDestinationSnsDestination();
  });
  ...
  describe('EventDestinationSnsDestination', function() {
    it('should create an instance of EventDestinationSnsDestination', function() {
      // uncomment below and update the code to test EventDestinationSnsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.EventDestinationSnsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.EventDestinationSnsDestination);
    });
