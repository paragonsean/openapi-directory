...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestCloudWatchLogsDestination();
  });
  ...
  describe('CreateEventDestinationRequestCloudWatchLogsDestination', function() {
    it('should create an instance of CreateEventDestinationRequestCloudWatchLogsDestination', function() {
      // uncomment below and update the code to test CreateEventDestinationRequestCloudWatchLogsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestCloudWatchLogsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestCloudWatchLogsDestination);
    });
