...
(function(root, factory) {
  ...
  describe('PhoneNumberFilterName', function() {
    it('should create an instance of PhoneNumberFilterName', function() {
      // uncomment below and update the code to test PhoneNumberFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.PhoneNumberFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PhoneNumberFilterName);
    });
