...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteVoiceMessageSpendLimitOverrideResult();
  });
  ...
  describe('DeleteVoiceMessageSpendLimitOverrideResult', function() {
    it('should create an instance of DeleteVoiceMessageSpendLimitOverrideResult', function() {
      // uncomment below and update the code to test DeleteVoiceMessageSpendLimitOverrideResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteVoiceMessageSpendLimitOverrideResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteVoiceMessageSpendLimitOverrideResult);
    });
