...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteOptedOutNumberRequest();
  });
  ...
  describe('DeleteOptedOutNumberRequest', function() {
    it('should create an instance of DeleteOptedOutNumberRequest', function() {
      // uncomment below and update the code to test DeleteOptedOutNumberRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteOptedOutNumberRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteOptedOutNumberRequest);
    });
