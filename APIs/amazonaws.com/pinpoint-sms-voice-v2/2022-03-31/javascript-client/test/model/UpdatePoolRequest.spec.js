...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdatePoolRequest();
  });
  ...
  describe('UpdatePoolRequest', function() {
    it('should create an instance of UpdatePoolRequest', function() {
      // uncomment below and update the code to test UpdatePoolRequest
      //var instance = new AmazonPinpointSmsVoiceV2.UpdatePoolRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdatePoolRequest);
    });
    ...
    it('should have the property sharedRoutesEnabled (base name: "SharedRoutesEnabled")', function() {
      // uncomment below and update the code to test the property sharedRoutesEnabled
      //var instance = new AmazonPinpointSmsVoiceV2.UpdatePoolRequest();
      //expect(instance).to.be();
    });
