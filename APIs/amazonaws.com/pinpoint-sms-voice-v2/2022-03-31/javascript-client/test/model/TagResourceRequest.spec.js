...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.TagResourceRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.TagResourceRequest);
    });
