...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesResult();
  });
  ...
  describe('ListPoolOriginationIdentitiesResult', function() {
    it('should create an instance of ListPoolOriginationIdentitiesResult', function() {
      // uncomment below and update the code to test ListPoolOriginationIdentitiesResult
      //var instance = new AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesResult);
    });
    ...
    it('should have the property originationIdentities (base name: "OriginationIdentities")', function() {
      // uncomment below and update the code to test the property originationIdentities
      //var instance = new AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesResult();
      //expect(instance).to.be();
    });
