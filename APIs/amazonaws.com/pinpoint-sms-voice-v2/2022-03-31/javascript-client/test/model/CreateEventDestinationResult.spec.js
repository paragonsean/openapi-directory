...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationResult();
  });
  ...
  describe('CreateEventDestinationResult', function() {
    it('should create an instance of CreateEventDestinationResult', function() {
      // uncomment below and update the code to test CreateEventDestinationResult
      //var instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateEventDestinationResult);
    });
