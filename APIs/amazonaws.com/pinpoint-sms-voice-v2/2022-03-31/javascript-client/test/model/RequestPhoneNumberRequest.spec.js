...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.RequestPhoneNumberRequest();
  });
  ...
  describe('RequestPhoneNumberRequest', function() {
    it('should create an instance of RequestPhoneNumberRequest', function() {
      // uncomment below and update the code to test RequestPhoneNumberRequest
      //var instance = new AmazonPinpointSmsVoiceV2.RequestPhoneNumberRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.RequestPhoneNumberRequest);
    });
