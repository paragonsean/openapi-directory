...
(function(root, factory) {
  ...
  describe('AccountAttributeName', function() {
    it('should create an instance of AccountAttributeName', function() {
      // uncomment below and update the code to test AccountAttributeName
      //var instance = new AmazonPinpointSmsVoiceV2.AccountAttributeName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AccountAttributeName);
    });
