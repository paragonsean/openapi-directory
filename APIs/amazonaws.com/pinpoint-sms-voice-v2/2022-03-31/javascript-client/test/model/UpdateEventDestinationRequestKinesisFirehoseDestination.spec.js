...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestKinesisFirehoseDestination();
  });
  ...
  describe('UpdateEventDestinationRequestKinesisFirehoseDestination', function() {
    it('should create an instance of UpdateEventDestinationRequestKinesisFirehoseDestination', function() {
      // uncomment below and update the code to test UpdateEventDestinationRequestKinesisFirehoseDestination
      //var instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestKinesisFirehoseDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestKinesisFirehoseDestination);
    });
