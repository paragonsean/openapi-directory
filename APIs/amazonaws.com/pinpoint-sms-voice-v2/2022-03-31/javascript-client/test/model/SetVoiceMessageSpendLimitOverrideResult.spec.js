...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideResult();
  });
  ...
  describe('SetVoiceMessageSpendLimitOverrideResult', function() {
    it('should create an instance of SetVoiceMessageSpendLimitOverrideResult', function() {
      // uncomment below and update the code to test SetVoiceMessageSpendLimitOverrideResult
      //var instance = new AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideResult);
    });
