...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ReleasePhoneNumberRequest();
  });
  ...
  describe('ReleasePhoneNumberRequest', function() {
    it('should create an instance of ReleasePhoneNumberRequest', function() {
      // uncomment below and update the code to test ReleasePhoneNumberRequest
      //var instance = new AmazonPinpointSmsVoiceV2.ReleasePhoneNumberRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ReleasePhoneNumberRequest);
    });
