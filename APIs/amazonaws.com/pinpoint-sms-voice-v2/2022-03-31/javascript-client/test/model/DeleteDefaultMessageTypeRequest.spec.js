...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeRequest();
  });
  ...
  describe('DeleteDefaultMessageTypeRequest', function() {
    it('should create an instance of DeleteDefaultMessageTypeRequest', function() {
      // uncomment below and update the code to test DeleteDefaultMessageTypeRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeRequest);
    });
