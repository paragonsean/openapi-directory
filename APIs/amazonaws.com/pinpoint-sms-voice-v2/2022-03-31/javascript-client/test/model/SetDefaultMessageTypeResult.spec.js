...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeResult();
  });
  ...
  describe('SetDefaultMessageTypeResult', function() {
    it('should create an instance of SetDefaultMessageTypeResult', function() {
      // uncomment below and update the code to test SetDefaultMessageTypeResult
      //var instance = new AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeResult);
    });
