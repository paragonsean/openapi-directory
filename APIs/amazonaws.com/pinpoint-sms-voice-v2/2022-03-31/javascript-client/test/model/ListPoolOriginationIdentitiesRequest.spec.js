...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesRequest();
  });
  ...
  describe('ListPoolOriginationIdentitiesRequest', function() {
    it('should create an instance of ListPoolOriginationIdentitiesRequest', function() {
      // uncomment below and update the code to test ListPoolOriginationIdentitiesRequest
      //var instance = new AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ListPoolOriginationIdentitiesRequest);
    });
