...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.AccountLimit();
  });
  ...
  describe('AccountLimit', function() {
    it('should create an instance of AccountLimit', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.AccountLimit();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AccountLimit);
    });
