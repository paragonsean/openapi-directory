...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.KinesisFirehoseDestination();
  });
  ...
  describe('KinesisFirehoseDestination', function() {
    it('should create an instance of KinesisFirehoseDestination', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.KinesisFirehoseDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.KinesisFirehoseDestination);
    });
