...
(function(root, factory) {
  ...
  describe('NumberStatus', function() {
    it('should create an instance of NumberStatus', function() {
      // uncomment below and update the code to test NumberStatus
      //var instance = new AmazonPinpointSmsVoiceV2.NumberStatus();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.NumberStatus);
    });
