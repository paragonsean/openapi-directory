...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.OptedOutFilter();
  });
  ...
  describe('OptedOutFilter', function() {
    it('should create an instance of OptedOutFilter', function() {
      // uncomment below and update the code to test OptedOutFilter
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.OptedOutFilter);
    });
