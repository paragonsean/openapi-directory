...
(function(root, factory) {
  ...
  describe('PoolFilterName', function() {
    it('should create an instance of PoolFilterName', function() {
      // uncomment below and update the code to test PoolFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.PoolFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PoolFilterName);
    });
