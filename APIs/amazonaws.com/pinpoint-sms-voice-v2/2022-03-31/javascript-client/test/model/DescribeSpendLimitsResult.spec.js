...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeSpendLimitsResult();
  });
  ...
  describe('DescribeSpendLimitsResult', function() {
    it('should create an instance of DescribeSpendLimitsResult', function() {
      // uncomment below and update the code to test DescribeSpendLimitsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeSpendLimitsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeSpendLimitsResult);
    });

    it('should have the property spendLimits (base name: "SpendLimits")', function() {
      // uncomment below and update the code to test the property spendLimits
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeSpendLimitsResult();
