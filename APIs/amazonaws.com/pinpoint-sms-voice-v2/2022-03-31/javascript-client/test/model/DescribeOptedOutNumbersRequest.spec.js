...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersRequest();
  });
  ...
  describe('DescribeOptedOutNumbersRequest', function() {
    it('should create an instance of DescribeOptedOutNumbersRequest', function() {
      // uncomment below and update the code to test DescribeOptedOutNumbersRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersRequest);
    });
