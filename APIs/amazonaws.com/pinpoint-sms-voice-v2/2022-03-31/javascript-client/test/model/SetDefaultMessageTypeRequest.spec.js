...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeRequest();
  });
  ...
  describe('SetDefaultMessageTypeRequest', function() {
    it('should create an instance of SetDefaultMessageTypeRequest', function() {
      // uncomment below and update the code to test SetDefaultMessageTypeRequest
      //var instance = new AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetDefaultMessageTypeRequest);
    });
