...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PhoneNumberFilter();
  });
  ...
  describe('PhoneNumberFilter', function() {
    it('should create an instance of PhoneNumberFilter', function() {
      // uncomment below and update the code to test PhoneNumberFilter
      //var instance = new AmazonPinpointSmsVoiceV2.PhoneNumberFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PhoneNumberFilter);
    });
