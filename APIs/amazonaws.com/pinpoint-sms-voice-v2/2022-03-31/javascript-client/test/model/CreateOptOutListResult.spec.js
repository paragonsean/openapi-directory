...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateOptOutListResult();
  });
  ...
  describe('CreateOptOutListResult', function() {
    it('should create an instance of CreateOptOutListResult', function() {
      // uncomment below and update the code to test CreateOptOutListResult
      //var instance = new AmazonPinpointSmsVoiceV2.CreateOptOutListResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateOptOutListResult);
    });
