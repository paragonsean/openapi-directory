...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdatePoolResult();
  });
  ...
  describe('UpdatePoolResult', function() {
    it('should create an instance of UpdatePoolResult', function() {
      // uncomment below and update the code to test UpdatePoolResult
      //var instance = new AmazonPinpointSmsVoiceV2.UpdatePoolResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdatePoolResult);
    });
