...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SenderIdAndCountry();
  });
  ...
  describe('SenderIdAndCountry', function() {
    it('should create an instance of SenderIdAndCountry', function() {
      // uncomment below and update the code to test SenderIdAndCountry
      //var instance = new AmazonPinpointSmsVoiceV2.SenderIdAndCountry();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SenderIdAndCountry);
    });
