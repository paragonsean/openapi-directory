...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PoolFilter();
  });
  ...
  describe('PoolFilter', function() {
    it('should create an instance of PoolFilter', function() {
      // uncomment below and update the code to test PoolFilter
      //var instance = new AmazonPinpointSmsVoiceV2.PoolFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PoolFilter);
    });
