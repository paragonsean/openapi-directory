...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribePoolsRequest();
  });
  ...
  describe('DescribePoolsRequest', function() {
    it('should create an instance of DescribePoolsRequest', function() {
      // uncomment below and update the code to test DescribePoolsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribePoolsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribePoolsRequest);
    });

    it('should have the property poolIds (base name: "PoolIds")', function() {
      // uncomment below and update the code to test the property poolIds
      //var instance = new AmazonPinpointSmsVoiceV2.DescribePoolsRequest();
