...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribePoolsResult();
  });
  ...
  describe('DescribePoolsResult', function() {
    it('should create an instance of DescribePoolsResult', function() {
      // uncomment below and update the code to test DescribePoolsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribePoolsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribePoolsResult);
    });
