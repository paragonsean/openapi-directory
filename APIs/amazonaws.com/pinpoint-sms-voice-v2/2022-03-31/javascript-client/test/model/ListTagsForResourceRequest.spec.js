...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ListTagsForResourceRequest);
    });
