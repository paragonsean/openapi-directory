...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteEventDestinationRequest();
  });
  ...
  describe('DeleteEventDestinationRequest', function() {
    it('should create an instance of DeleteEventDestinationRequest', function() {
      // uncomment below and update the code to test DeleteEventDestinationRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteEventDestinationRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteEventDestinationRequest);
    });
