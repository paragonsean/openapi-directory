...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeSenderIdsRequest();
  });
  ...
  describe('DescribeSenderIdsRequest', function() {
    it('should create an instance of DescribeSenderIdsRequest', function() {
      // uncomment below and update the code to test DescribeSenderIdsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeSenderIdsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeSenderIdsRequest);
    });
