...
(function(root, factory) {
  ...
  describe('KeywordFilterName', function() {
    it('should create an instance of KeywordFilterName', function() {
      // uncomment below and update the code to test KeywordFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.KeywordFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.KeywordFilterName);
    });
