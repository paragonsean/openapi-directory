...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateConfigurationSetRequest();
  });
  ...
  describe('CreateConfigurationSetRequest', function() {
    it('should create an instance of CreateConfigurationSetRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.CreateConfigurationSetRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateConfigurationSetRequest);
    });
