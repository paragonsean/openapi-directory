...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeAccountAttributesResult();
  });
  ...
  describe('DescribeAccountAttributesResult', function() {
    it('should create an instance of DescribeAccountAttributesResult', function() {
      // uncomment below and update the code to test DescribeAccountAttributesResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeAccountAttributesResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeAccountAttributesResult);
    });

    it('should have the property accountAttributes (base name: "AccountAttributes")', function() {
      // uncomment below and update the code to test the property accountAttributes
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeAccountAttributesResult();
