...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.KeywordFilter();
  });
  ...
  describe('KeywordFilter', function() {
    it('should create an instance of KeywordFilter', function() {
      // uncomment below and update the code to test KeywordFilter
      //var instance = new AmazonPinpointSmsVoiceV2.KeywordFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.KeywordFilter);
    });
