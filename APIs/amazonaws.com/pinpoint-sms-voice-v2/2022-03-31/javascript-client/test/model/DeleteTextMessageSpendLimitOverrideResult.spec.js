...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteTextMessageSpendLimitOverrideResult();
  });
  ...
  describe('DeleteTextMessageSpendLimitOverrideResult', function() {
    it('should create an instance of DeleteTextMessageSpendLimitOverrideResult', function() {
      // uncomment below and update the code to test DeleteTextMessageSpendLimitOverrideResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteTextMessageSpendLimitOverrideResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteTextMessageSpendLimitOverrideResult);
    });
