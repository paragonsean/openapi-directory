...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeKeywordsRequest();
  });
  ...
  describe('DescribeKeywordsRequest', function() {
    it('should create an instance of DescribeKeywordsRequest', function() {
      // uncomment below and update the code to test DescribeKeywordsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeKeywordsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeKeywordsRequest);
    });
