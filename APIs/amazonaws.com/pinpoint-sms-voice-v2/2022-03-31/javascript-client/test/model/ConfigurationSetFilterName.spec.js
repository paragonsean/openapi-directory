...
(function(root, factory) {
  ...
  describe('ConfigurationSetFilterName', function() {
    it('should create an instance of ConfigurationSetFilterName', function() {
      // uncomment below and update the code to test ConfigurationSetFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ConfigurationSetFilterName);
    });
