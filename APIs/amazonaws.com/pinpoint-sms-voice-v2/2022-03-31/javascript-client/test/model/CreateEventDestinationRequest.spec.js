...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequest();
  });
  ...
  describe('CreateEventDestinationRequest', function() {
    it('should create an instance of CreateEventDestinationRequest', function() {
      // uncomment below and update the code to test CreateEventDestinationRequest
      //var instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateEventDestinationRequest);
    });
