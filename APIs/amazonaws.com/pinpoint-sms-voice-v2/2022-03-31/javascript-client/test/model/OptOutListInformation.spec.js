...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.OptOutListInformation();
  });
  ...
  describe('OptOutListInformation', function() {
    it('should create an instance of OptOutListInformation', function() {
      // uncomment below and update the code to test OptOutListInformation
      //var instance = new AmazonPinpointSmsVoiceV2.OptOutListInformation();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.OptOutListInformation);
    });
