...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteEventDestinationResult();
  });
  ...
  describe('DeleteEventDestinationResult', function() {
    it('should create an instance of DeleteEventDestinationResult', function() {
      // uncomment below and update the code to test DeleteEventDestinationResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteEventDestinationResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteEventDestinationResult);
    });
