...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsRequest();
  });
  ...
  describe('DescribeOptOutListsRequest', function() {
    it('should create an instance of DescribeOptOutListsRequest', function() {
      // uncomment below and update the code to test DescribeOptOutListsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeOptOutListsRequest);
    });

    it('should have the property optOutListNames (base name: "OptOutListNames")', function() {
      // uncomment below and update the code to test the property optOutListNames
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsRequest();
