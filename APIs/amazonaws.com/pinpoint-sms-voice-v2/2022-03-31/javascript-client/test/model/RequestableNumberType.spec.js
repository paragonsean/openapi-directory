...
(function(root, factory) {
  ...
  describe('RequestableNumberType', function() {
    it('should create an instance of RequestableNumberType', function() {
      // uncomment below and update the code to test RequestableNumberType
      //var instance = new AmazonPinpointSmsVoiceV2.RequestableNumberType();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.RequestableNumberType);
    });
