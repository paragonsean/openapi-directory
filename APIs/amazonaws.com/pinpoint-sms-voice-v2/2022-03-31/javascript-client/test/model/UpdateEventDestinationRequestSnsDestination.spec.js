...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestSnsDestination();
  });
  ...
  describe('UpdateEventDestinationRequestSnsDestination', function() {
    it('should create an instance of UpdateEventDestinationRequestSnsDestination', function() {
      // uncomment below and update the code to test UpdateEventDestinationRequestSnsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestSnsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestSnsDestination);
    });
