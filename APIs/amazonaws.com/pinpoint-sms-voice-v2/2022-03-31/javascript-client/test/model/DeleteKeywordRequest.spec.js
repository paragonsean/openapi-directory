...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteKeywordRequest();
  });
  ...
  describe('DeleteKeywordRequest', function() {
    it('should create an instance of DeleteKeywordRequest', function() {
      // uncomment below and update the code to test DeleteKeywordRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteKeywordRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteKeywordRequest);
    });
