...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PutKeywordResult();
  });
  ...
  describe('PutKeywordResult', function() {
    it('should create an instance of PutKeywordResult', function() {
      // uncomment below and update the code to test PutKeywordResult
      //var instance = new AmazonPinpointSmsVoiceV2.PutKeywordResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PutKeywordResult);
    });
