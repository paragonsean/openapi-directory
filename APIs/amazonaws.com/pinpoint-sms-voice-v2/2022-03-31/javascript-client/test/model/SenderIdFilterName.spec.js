...
(function(root, factory) {
  ...
  describe('SenderIdFilterName', function() {
    it('should create an instance of SenderIdFilterName', function() {
      // uncomment below and update the code to test SenderIdFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.SenderIdFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SenderIdFilterName);
    });
