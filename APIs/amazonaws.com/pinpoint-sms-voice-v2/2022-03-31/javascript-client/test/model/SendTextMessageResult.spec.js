...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SendTextMessageResult();
  });
  ...
  describe('SendTextMessageResult', function() {
    it('should create an instance of SendTextMessageResult', function() {
      // uncomment below and update the code to test SendTextMessageResult
      //var instance = new AmazonPinpointSmsVoiceV2.SendTextMessageResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SendTextMessageResult);
    });
