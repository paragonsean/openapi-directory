...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestCloudWatchLogsDestination();
  });
  ...
  describe('UpdateEventDestinationRequestCloudWatchLogsDestination', function() {
    it('should create an instance of UpdateEventDestinationRequestCloudWatchLogsDestination', function() {
      // uncomment below and update the code to test UpdateEventDestinationRequestCloudWatchLogsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestCloudWatchLogsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdateEventDestinationRequestCloudWatchLogsDestination);
    });
