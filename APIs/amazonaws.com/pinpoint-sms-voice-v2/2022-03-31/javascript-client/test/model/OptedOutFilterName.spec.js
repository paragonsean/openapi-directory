...
(function(root, factory) {
  ...
  describe('OptedOutFilterName', function() {
    it('should create an instance of OptedOutFilterName', function() {
      // uncomment below and update the code to test OptedOutFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.OptedOutFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.OptedOutFilterName);
    });
