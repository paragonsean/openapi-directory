...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.AccountAttribute();
  });
  ...
  describe('AccountAttribute', function() {
    it('should create an instance of AccountAttribute', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.AccountAttribute();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AccountAttribute);
    });
