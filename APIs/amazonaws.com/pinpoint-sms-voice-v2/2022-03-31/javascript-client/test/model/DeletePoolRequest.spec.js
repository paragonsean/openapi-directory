...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeletePoolRequest();
  });
  ...
  describe('DeletePoolRequest', function() {
    it('should create an instance of DeletePoolRequest', function() {
      // uncomment below and update the code to test DeletePoolRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeletePoolRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeletePoolRequest);
    });
