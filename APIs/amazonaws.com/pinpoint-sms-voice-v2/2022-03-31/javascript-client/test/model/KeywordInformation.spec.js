...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.KeywordInformation();
  });
  ...
  describe('KeywordInformation', function() {
    it('should create an instance of KeywordInformation', function() {
      // uncomment below and update the code to test KeywordInformation
      //var instance = new AmazonPinpointSmsVoiceV2.KeywordInformation();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.KeywordInformation);
    });
