...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideResult();
  });
  ...
  describe('SetTextMessageSpendLimitOverrideResult', function() {
    it('should create an instance of SetTextMessageSpendLimitOverrideResult', function() {
      // uncomment below and update the code to test SetTextMessageSpendLimitOverrideResult
      //var instance = new AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetTextMessageSpendLimitOverrideResult);
    });
