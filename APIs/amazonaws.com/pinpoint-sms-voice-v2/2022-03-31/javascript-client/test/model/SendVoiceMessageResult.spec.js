...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageResult();
  });
  ...
  describe('SendVoiceMessageResult', function() {
    it('should create an instance of SendVoiceMessageResult', function() {
      // uncomment below and update the code to test SendVoiceMessageResult
      //var instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SendVoiceMessageResult);
    });
