...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityRequest();
  });
  ...
  describe('AssociateOriginationIdentityRequest', function() {
    it('should create an instance of AssociateOriginationIdentityRequest', function() {
      // uncomment below and update the code to test AssociateOriginationIdentityRequest
      //var instance = new AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityRequest);
    });
