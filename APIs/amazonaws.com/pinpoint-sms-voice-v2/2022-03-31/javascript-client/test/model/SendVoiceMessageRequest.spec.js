...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageRequest();
  });
  ...
  describe('SendVoiceMessageRequest', function() {
    it('should create an instance of SendVoiceMessageRequest', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SendVoiceMessageRequest);
    });
    ...
    it('should have the property messageBodyTextType (base name: "MessageBodyTextType")', function() {
      // uncomment below and update the code to test the property messageBodyTextType
      //var instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxPricePerMinute (base name: "MaxPricePerMinute")', function() {
      // uncomment below and update the code to test the property maxPricePerMinute
      //var instance = new AmazonPinpointSmsVoiceV2.SendVoiceMessageRequest();
      //expect(instance).to.be();
    });
