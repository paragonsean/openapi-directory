...
(function(root, factory) {
  ...
  describe('SpendLimitName', function() {
    it('should create an instance of SpendLimitName', function() {
      // uncomment below and update the code to test SpendLimitName
      //var instance = new AmazonPinpointSmsVoiceV2.SpendLimitName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SpendLimitName);
    });
