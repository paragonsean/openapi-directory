...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.EventDestinationCloudWatchLogsDestination();
  });
  ...
  describe('EventDestinationCloudWatchLogsDestination', function() {
    it('should create an instance of EventDestinationCloudWatchLogsDestination', function() {
      // uncomment below and update the code to test EventDestinationCloudWatchLogsDestination
      //var instance = new AmazonPinpointSmsVoiceV2.EventDestinationCloudWatchLogsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.EventDestinationCloudWatchLogsDestination);
    });
