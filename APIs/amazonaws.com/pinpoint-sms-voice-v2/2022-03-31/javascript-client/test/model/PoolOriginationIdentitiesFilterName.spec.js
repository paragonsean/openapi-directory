...
(function(root, factory) {
  ...
  describe('PoolOriginationIdentitiesFilterName', function() {
    it('should create an instance of PoolOriginationIdentitiesFilterName', function() {
      // uncomment below and update the code to test PoolOriginationIdentitiesFilterName
      //var instance = new AmazonPinpointSmsVoiceV2.PoolOriginationIdentitiesFilterName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PoolOriginationIdentitiesFilterName);
    });
