...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityResult();
  });
  ...
  describe('AssociateOriginationIdentityResult', function() {
    it('should create an instance of AssociateOriginationIdentityResult', function() {
      // uncomment below and update the code to test AssociateOriginationIdentityResult
      //var instance = new AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AssociateOriginationIdentityResult);
    });
