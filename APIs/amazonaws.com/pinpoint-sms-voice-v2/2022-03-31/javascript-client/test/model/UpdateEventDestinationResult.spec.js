...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationResult();
  });
  ...
  describe('UpdateEventDestinationResult', function() {
    it('should create an instance of UpdateEventDestinationResult', function() {
      // uncomment below and update the code to test UpdateEventDestinationResult
      //var instance = new AmazonPinpointSmsVoiceV2.UpdateEventDestinationResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdateEventDestinationResult);
    });
