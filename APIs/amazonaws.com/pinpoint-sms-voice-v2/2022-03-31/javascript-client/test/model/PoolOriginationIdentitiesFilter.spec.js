...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PoolOriginationIdentitiesFilter();
  });
  ...
  describe('PoolOriginationIdentitiesFilter', function() {
    it('should create an instance of PoolOriginationIdentitiesFilter', function() {
      // uncomment below and update the code to test PoolOriginationIdentitiesFilter
      //var instance = new AmazonPinpointSmsVoiceV2.PoolOriginationIdentitiesFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PoolOriginationIdentitiesFilter);
    });
