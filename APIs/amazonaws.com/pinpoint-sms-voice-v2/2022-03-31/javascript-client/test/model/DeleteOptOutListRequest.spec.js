...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteOptOutListRequest();
  });
  ...
  describe('DeleteOptOutListRequest', function() {
    it('should create an instance of DeleteOptOutListRequest', function() {
      // uncomment below and update the code to test DeleteOptOutListRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteOptOutListRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteOptOutListRequest);
    });
