...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeSpendLimitsRequest();
  });
  ...
  describe('DescribeSpendLimitsRequest', function() {
    it('should create an instance of DescribeSpendLimitsRequest', function() {
      // uncomment below and update the code to test DescribeSpendLimitsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeSpendLimitsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeSpendLimitsRequest);
    });
