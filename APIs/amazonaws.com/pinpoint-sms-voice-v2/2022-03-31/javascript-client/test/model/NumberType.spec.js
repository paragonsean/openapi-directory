...
(function(root, factory) {
  ...
  describe('NumberType', function() {
    it('should create an instance of NumberType', function() {
      // uncomment below and update the code to test NumberType
      //var instance = new AmazonPinpointSmsVoiceV2.NumberType();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.NumberType);
    });
