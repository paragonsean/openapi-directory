...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreatePoolRequest();
  });
  ...
  describe('CreatePoolRequest', function() {
    it('should create an instance of CreatePoolRequest', function() {
      // uncomment below and update the code to test CreatePoolRequest
      //var instance = new AmazonPinpointSmsVoiceV2.CreatePoolRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreatePoolRequest);
    });
