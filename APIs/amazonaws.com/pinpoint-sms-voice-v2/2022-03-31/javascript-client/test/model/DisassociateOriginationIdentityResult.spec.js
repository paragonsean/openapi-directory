...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityResult();
  });
  ...
  describe('DisassociateOriginationIdentityResult', function() {
    it('should create an instance of DisassociateOriginationIdentityResult', function() {
      // uncomment below and update the code to test DisassociateOriginationIdentityResult
      //var instance = new AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityResult);
    });

    it('should have the property poolArn (base name: "PoolArn")', function() {
      // uncomment below and update the code to test the property poolArn
      //var instance = new AmazonPinpointSmsVoiceV2.DisassociateOriginationIdentityResult();
