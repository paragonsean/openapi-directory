...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetFilter();
  });
  ...
  describe('ConfigurationSetFilter', function() {
    it('should create an instance of ConfigurationSetFilter', function() {
      // uncomment below and update the code to test ConfigurationSetFilter
      //var instance = new AmazonPinpointSmsVoiceV2.ConfigurationSetFilter();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.ConfigurationSetFilter);
    });
