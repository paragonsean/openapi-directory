...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersResult();
  });
  ...
  describe('DescribeOptedOutNumbersResult', function() {
    it('should create an instance of DescribeOptedOutNumbersResult', function() {
      // uncomment below and update the code to test DescribeOptedOutNumbersResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersResult);
    });
    ...
    it('should have the property optedOutNumbers (base name: "OptedOutNumbers")', function() {
      // uncomment below and update the code to test the property optedOutNumbers
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptedOutNumbersResult();
      //expect(instance).to.be();
    });
