...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteConfigurationSetResult();
  });
  ...
  describe('DeleteConfigurationSetResult', function() {
    it('should create an instance of DeleteConfigurationSetResult', function() {
      // uncomment below and update the code to test DeleteConfigurationSetResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteConfigurationSetResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteConfigurationSetResult);
    });
