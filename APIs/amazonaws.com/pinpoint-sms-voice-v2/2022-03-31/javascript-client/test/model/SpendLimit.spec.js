...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SpendLimit();
  });
  ...
  describe('SpendLimit', function() {
    it('should create an instance of SpendLimit', function() {
      // uncomment below and update the code to test SpendLimit
      //var instance = new AmazonPinpointSmsVoiceV2.SpendLimit();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SpendLimit);
    });
    ...
    it('should have the property enforcedLimit (base name: "EnforcedLimit")', function() {
      // uncomment below and update the code to test the property enforcedLimit
      //var instance = new AmazonPinpointSmsVoiceV2.SpendLimit();
      //expect(instance).to.be();
    });
