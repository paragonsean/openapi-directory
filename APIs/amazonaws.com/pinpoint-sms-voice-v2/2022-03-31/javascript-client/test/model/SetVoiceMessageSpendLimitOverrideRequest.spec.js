...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideRequest();
  });
  ...
  describe('SetVoiceMessageSpendLimitOverrideRequest', function() {
    it('should create an instance of SetVoiceMessageSpendLimitOverrideRequest', function() {
      // uncomment below and update the code to test SetVoiceMessageSpendLimitOverrideRequest
      //var instance = new AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SetVoiceMessageSpendLimitOverrideRequest);
    });
