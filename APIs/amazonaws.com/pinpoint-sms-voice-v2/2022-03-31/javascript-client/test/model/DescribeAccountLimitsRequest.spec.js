...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeAccountLimitsRequest();
  });
  ...
  describe('DescribeAccountLimitsRequest', function() {
    it('should create an instance of DescribeAccountLimitsRequest', function() {
      // uncomment below and update the code to test DescribeAccountLimitsRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeAccountLimitsRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeAccountLimitsRequest);
    });
