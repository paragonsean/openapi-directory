...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsResult();
  });
  ...
  describe('DescribeOptOutListsResult', function() {
    it('should create an instance of DescribeOptOutListsResult', function() {
      // uncomment below and update the code to test DescribeOptOutListsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeOptOutListsResult);
    });

    it('should have the property optOutLists (base name: "OptOutLists")', function() {
      // uncomment below and update the code to test the property optOutLists
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeOptOutListsResult();
