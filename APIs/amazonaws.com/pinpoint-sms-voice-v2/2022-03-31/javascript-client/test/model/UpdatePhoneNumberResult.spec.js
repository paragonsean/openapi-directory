...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.UpdatePhoneNumberResult();
  });
  ...
  describe('UpdatePhoneNumberResult', function() {
    it('should create an instance of UpdatePhoneNumberResult', function() {
      // uncomment below and update the code to test UpdatePhoneNumberResult
      //var instance = new AmazonPinpointSmsVoiceV2.UpdatePhoneNumberResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.UpdatePhoneNumberResult);
    });
