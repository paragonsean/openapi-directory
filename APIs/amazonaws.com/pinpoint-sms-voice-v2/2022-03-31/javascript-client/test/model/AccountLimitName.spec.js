...
(function(root, factory) {
  ...
  describe('AccountLimitName', function() {
    it('should create an instance of AccountLimitName', function() {
      // uncomment below and update the code to test AccountLimitName
      //var instance = new AmazonPinpointSmsVoiceV2.AccountLimitName();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.AccountLimitName);
    });
