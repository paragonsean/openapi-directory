...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsResult();
  });
  ...
  describe('DescribeConfigurationSetsResult', function() {
    it('should create an instance of DescribeConfigurationSetsResult', function() {
      // uncomment below and update the code to test DescribeConfigurationSetsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeConfigurationSetsResult);
    });
