...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PutKeywordRequest();
  });
  ...
  describe('PutKeywordRequest', function() {
    it('should create an instance of PutKeywordRequest', function() {
      // uncomment below and update the code to test PutKeywordRequest
      //var instance = new AmazonPinpointSmsVoiceV2.PutKeywordRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PutKeywordRequest);
    });
