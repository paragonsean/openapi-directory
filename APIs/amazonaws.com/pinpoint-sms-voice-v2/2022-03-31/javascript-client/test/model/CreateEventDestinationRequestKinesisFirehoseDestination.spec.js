...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestKinesisFirehoseDestination();
  });
  ...
  describe('CreateEventDestinationRequestKinesisFirehoseDestination', function() {
    it('should create an instance of CreateEventDestinationRequestKinesisFirehoseDestination', function() {
      // uncomment below and update the code to test CreateEventDestinationRequestKinesisFirehoseDestination
      //var instance = new AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestKinesisFirehoseDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateEventDestinationRequestKinesisFirehoseDestination);
    });
