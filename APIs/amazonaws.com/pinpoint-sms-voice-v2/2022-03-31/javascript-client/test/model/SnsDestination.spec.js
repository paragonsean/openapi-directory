...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.SnsDestination();
  });
  ...
  describe('SnsDestination', function() {
    it('should create an instance of SnsDestination', function() {
      ...
      //var instance = new AmazonPinpointSmsVoiceV2.SnsDestination();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.SnsDestination);
    });
