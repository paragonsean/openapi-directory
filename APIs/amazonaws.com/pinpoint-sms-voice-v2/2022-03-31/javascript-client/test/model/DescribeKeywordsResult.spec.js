...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeKeywordsResult();
  });
  ...
  describe('DescribeKeywordsResult', function() {
    it('should create an instance of DescribeKeywordsResult', function() {
      // uncomment below and update the code to test DescribeKeywordsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeKeywordsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeKeywordsResult);
    });
