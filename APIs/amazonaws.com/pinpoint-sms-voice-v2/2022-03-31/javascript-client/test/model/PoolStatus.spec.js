...
(function(root, factory) {
  ...
  describe('PoolStatus', function() {
    it('should create an instance of PoolStatus', function() {
      // uncomment below and update the code to test PoolStatus
      //var instance = new AmazonPinpointSmsVoiceV2.PoolStatus();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PoolStatus);
    });
