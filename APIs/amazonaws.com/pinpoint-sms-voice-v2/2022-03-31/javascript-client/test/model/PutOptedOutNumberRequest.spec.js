...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.PutOptedOutNumberRequest();
  });
  ...
  describe('PutOptedOutNumberRequest', function() {
    it('should create an instance of PutOptedOutNumberRequest', function() {
      // uncomment below and update the code to test PutOptedOutNumberRequest
      //var instance = new AmazonPinpointSmsVoiceV2.PutOptedOutNumberRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.PutOptedOutNumberRequest);
    });
