...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribeSenderIdsResult();
  });
  ...
  describe('DescribeSenderIdsResult', function() {
    it('should create an instance of DescribeSenderIdsResult', function() {
      // uncomment below and update the code to test DescribeSenderIdsResult
      //var instance = new AmazonPinpointSmsVoiceV2.DescribeSenderIdsResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribeSenderIdsResult);
    });
