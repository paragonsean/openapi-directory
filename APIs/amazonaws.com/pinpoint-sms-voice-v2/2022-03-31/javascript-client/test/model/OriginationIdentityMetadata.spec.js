...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.OriginationIdentityMetadata();
  });
  ...
  describe('OriginationIdentityMetadata', function() {
    it('should create an instance of OriginationIdentityMetadata', function() {
      // uncomment below and update the code to test OriginationIdentityMetadata
      //var instance = new AmazonPinpointSmsVoiceV2.OriginationIdentityMetadata();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.OriginationIdentityMetadata);
    });
