...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdResult();
  });
  ...
  describe('DeleteDefaultSenderIdResult', function() {
    it('should create an instance of DeleteDefaultSenderIdResult', function() {
      // uncomment below and update the code to test DeleteDefaultSenderIdResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdResult);
    });
