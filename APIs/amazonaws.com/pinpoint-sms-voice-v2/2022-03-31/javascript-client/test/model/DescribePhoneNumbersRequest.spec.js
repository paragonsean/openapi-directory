...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DescribePhoneNumbersRequest();
  });
  ...
  describe('DescribePhoneNumbersRequest', function() {
    it('should create an instance of DescribePhoneNumbersRequest', function() {
      // uncomment below and update the code to test DescribePhoneNumbersRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DescribePhoneNumbersRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DescribePhoneNumbersRequest);
    });
