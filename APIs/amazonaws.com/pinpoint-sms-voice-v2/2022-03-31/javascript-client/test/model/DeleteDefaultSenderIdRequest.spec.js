...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdRequest();
  });
  ...
  describe('DeleteDefaultSenderIdRequest', function() {
    it('should create an instance of DeleteDefaultSenderIdRequest', function() {
      // uncomment below and update the code to test DeleteDefaultSenderIdRequest
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdRequest();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteDefaultSenderIdRequest);
    });
