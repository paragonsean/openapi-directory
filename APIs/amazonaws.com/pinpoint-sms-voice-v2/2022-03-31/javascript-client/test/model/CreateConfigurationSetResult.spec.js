...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.CreateConfigurationSetResult();
  });
  ...
  describe('CreateConfigurationSetResult', function() {
    it('should create an instance of CreateConfigurationSetResult', function() {
      // uncomment below and update the code to test CreateConfigurationSetResult
      //var instance = new AmazonPinpointSmsVoiceV2.CreateConfigurationSetResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.CreateConfigurationSetResult);
    });
