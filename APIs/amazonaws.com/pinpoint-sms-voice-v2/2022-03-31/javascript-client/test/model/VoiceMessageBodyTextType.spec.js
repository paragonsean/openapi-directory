...
(function(root, factory) {
  ...
  describe('VoiceMessageBodyTextType', function() {
    it('should create an instance of VoiceMessageBodyTextType', function() {
      // uncomment below and update the code to test VoiceMessageBodyTextType
      //var instance = new AmazonPinpointSmsVoiceV2.VoiceMessageBodyTextType();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.VoiceMessageBodyTextType);
    });
