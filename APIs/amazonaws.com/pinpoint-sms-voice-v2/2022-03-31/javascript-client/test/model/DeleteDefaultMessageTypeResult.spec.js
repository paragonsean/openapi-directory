...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeResult();
  });
  ...
  describe('DeleteDefaultMessageTypeResult', function() {
    it('should create an instance of DeleteDefaultMessageTypeResult', function() {
      // uncomment below and update the code to test DeleteDefaultMessageTypeResult
      //var instance = new AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeResult();
      //expect(instance).to.be.a(AmazonPinpointSmsVoiceV2.DeleteDefaultMessageTypeResult);
    });
