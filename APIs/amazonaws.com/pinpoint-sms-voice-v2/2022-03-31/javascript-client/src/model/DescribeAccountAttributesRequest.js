...
class DescribeAccountAttributesRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountAttributesRequest</code>.
     */
 ...
 */
DescribeAccountAttributesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeAccountAttributesRequest.prototype['MaxResults'] = undefined;
