...
* @readonly
*/
export default class NumberStatus {
    ...
    /**
    * Returns a <code>NumberStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NumberStatus} The enum <code>NumberStatus</code> value.
    */
