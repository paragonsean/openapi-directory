...
/**
 * The SendVoiceMessageResult model module.
 * @module model/SendVoiceMessageResult
 * @version 2022-03-31
 */
class SendVoiceMessageResult {
    /**
     * Constructs a new <code>SendVoiceMessageResult</code>.
     * @alias module:model/SendVoiceMessageResult
     */
    constructor() { 
        
        SendVoiceMessageResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendVoiceMessageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendVoiceMessageResult} obj Optional instance to populate.
     * @return {module:model/SendVoiceMessageResult} The populated <code>SendVoiceMessageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendVoiceMessageResult();
    ...
    /**
     * Validates the JSON data with respect to <code>SendVoiceMessageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendVoiceMessageResult</code>.
     */
 ...
 */
SendVoiceMessageResult.prototype['MessageId'] = undefined;
...
export default SendVoiceMessageResult;
