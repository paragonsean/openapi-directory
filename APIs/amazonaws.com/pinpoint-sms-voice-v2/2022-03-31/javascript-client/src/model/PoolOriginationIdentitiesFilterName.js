...
* @readonly
*/
export default class PoolOriginationIdentitiesFilterName {
    ...
    /**
    * Returns a <code>PoolOriginationIdentitiesFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PoolOriginationIdentitiesFilterName} The enum <code>PoolOriginationIdentitiesFilterName</code> value.
    */
