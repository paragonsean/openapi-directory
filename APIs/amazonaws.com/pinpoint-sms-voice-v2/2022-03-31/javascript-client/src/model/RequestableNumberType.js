...
* @readonly
*/
export default class RequestableNumberType {
    ...
    /**
    * Returns a <code>RequestableNumberType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RequestableNumberType} The enum <code>RequestableNumberType</code> value.
    */
