...
/**
 * The SetDefaultSenderIdRequest model module.
 * @module model/SetDefaultSenderIdRequest
 * @version 2022-03-31
 */
class SetDefaultSenderIdRequest {
    /**
     * Constructs a new <code>SetDefaultSenderIdRequest</code>.
     * @alias module:model/SetDefaultSenderIdRequest
     * @param configurationSetName {String} 
     * @param senderId {String} 
     */
    constructor(configurationSetName, senderId) { 
        
        SetDefaultSenderIdRequest.initialize(this, configurationSetName, senderId);
    }
     ...
     */
    static initialize(obj, configurationSetName, senderId) { 
        obj['ConfigurationSetName'] = configurationSetName;
        obj['SenderId'] = senderId;
    }

    /**
     * Constructs a <code>SetDefaultSenderIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDefaultSenderIdRequest} obj Optional instance to populate.
     * @return {module:model/SetDefaultSenderIdRequest} The populated <code>SetDefaultSenderIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDefaultSenderIdRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SetDefaultSenderIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDefaultSenderIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetDefaultSenderIdRequest.RequiredProperties) {
...
SetDefaultSenderIdRequest.RequiredProperties = ["ConfigurationSetName", "SenderId"];

/**
 * @member {String} ConfigurationSetName
 */
SetDefaultSenderIdRequest.prototype['ConfigurationSetName'] = undefined;

/**
 * @member {String} SenderId
 */
SetDefaultSenderIdRequest.prototype['SenderId'] = undefined;
...
export default SetDefaultSenderIdRequest;
