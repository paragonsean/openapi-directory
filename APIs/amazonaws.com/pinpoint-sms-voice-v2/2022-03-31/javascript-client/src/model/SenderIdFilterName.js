...
* @readonly
*/
export default class SenderIdFilterName {
    ...
    /**
    * Returns a <code>SenderIdFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SenderIdFilterName} The enum <code>SenderIdFilterName</code> value.
    */
