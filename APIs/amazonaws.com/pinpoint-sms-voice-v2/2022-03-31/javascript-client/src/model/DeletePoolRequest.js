...
/**
 * The DeletePoolRequest model module.
 * @module model/DeletePoolRequest
 * @version 2022-03-31
 */
class DeletePoolRequest {
    /**
     * Constructs a new <code>DeletePoolRequest</code>.
     * @alias module:model/DeletePoolRequest
     * @param poolId {String} 
     */
    constructor(poolId) { 
        
        DeletePoolRequest.initialize(this, poolId);
    }
    ...
    /**
     * Constructs a <code>DeletePoolRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePoolRequest} obj Optional instance to populate.
     * @return {module:model/DeletePoolRequest} The populated <code>DeletePoolRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePoolRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePoolRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePoolRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePoolRequest.RequiredProperties) {
...
DeletePoolRequest.RequiredProperties = ["PoolId"];

/**
 * @member {String} PoolId
 */
DeletePoolRequest.prototype['PoolId'] = undefined;
...
export default DeletePoolRequest;
