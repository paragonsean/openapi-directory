...
/**
 * The DescribeSpendLimitsRequest model module.
 * @module model/DescribeSpendLimitsRequest
 * @version 2022-03-31
 */
class DescribeSpendLimitsRequest {
    /**
     * Constructs a new <code>DescribeSpendLimitsRequest</code>.
     * @alias module:model/DescribeSpendLimitsRequest
     */
    constructor() { 
        
        DescribeSpendLimitsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSpendLimitsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSpendLimitsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeSpendLimitsRequest} The populated <code>DescribeSpendLimitsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSpendLimitsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSpendLimitsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSpendLimitsRequest</code>.
     */
 ...
 */
DescribeSpendLimitsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeSpendLimitsRequest.prototype['MaxResults'] = undefined;
...
export default DescribeSpendLimitsRequest;
