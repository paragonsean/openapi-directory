...
* @readonly
*/
export default class OptedOutFilterName {
    
        /**
         * value: "end-user-opted-out"
         * @const
         */
        "end-user-opted-out" = "end-user-opted-out";

    

    /**
    * Returns a <code>OptedOutFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OptedOutFilterName} The enum <code>OptedOutFilterName</code> value.
    */
