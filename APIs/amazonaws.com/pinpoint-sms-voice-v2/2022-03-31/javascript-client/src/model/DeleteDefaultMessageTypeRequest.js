...
/**
 * The DeleteDefaultMessageTypeRequest model module.
 * @module model/DeleteDefaultMessageTypeRequest
 * @version 2022-03-31
 */
class DeleteDefaultMessageTypeRequest {
    /**
     * Constructs a new <code>DeleteDefaultMessageTypeRequest</code>.
     * @alias module:model/DeleteDefaultMessageTypeRequest
     * @param configurationSetName {String} 
     */
    constructor(configurationSetName) { 
        
        DeleteDefaultMessageTypeRequest.initialize(this, configurationSetName);
    }
    ...
    /**
     * Constructs a <code>DeleteDefaultMessageTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDefaultMessageTypeRequest} obj Optional instance to populate.
     * @return {module:model/DeleteDefaultMessageTypeRequest} The populated <code>DeleteDefaultMessageTypeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDefaultMessageTypeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDefaultMessageTypeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDefaultMessageTypeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteDefaultMessageTypeRequest.RequiredProperties) {
...
DeleteDefaultMessageTypeRequest.RequiredProperties = ["ConfigurationSetName"];

/**
 * @member {String} ConfigurationSetName
 */
DeleteDefaultMessageTypeRequest.prototype['ConfigurationSetName'] = undefined;
...
export default DeleteDefaultMessageTypeRequest;
