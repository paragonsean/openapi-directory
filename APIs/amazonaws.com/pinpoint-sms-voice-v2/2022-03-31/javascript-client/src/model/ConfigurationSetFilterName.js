...
* @readonly
*/
export default class ConfigurationSetFilterName {
    
        /**
         * value: "event-destination-name"
         * @const
         */
        "event-destination-name" = "event-destination-name";

    
        /**
         * value: "matching-event-types"
         * @const
         */
        "matching-event-types" = "matching-event-types";

    
        /**
         * value: "default-message-type"
         * @const
         */
    ...
    /**
    * Returns a <code>ConfigurationSetFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConfigurationSetFilterName} The enum <code>ConfigurationSetFilterName</code> value.
    */
