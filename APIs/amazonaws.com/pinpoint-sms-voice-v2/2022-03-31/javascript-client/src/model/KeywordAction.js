...
* @readonly
*/
export default class KeywordAction {
    
        /**
         * value: "AUTOMATIC_RESPONSE"
         * @const
         */
    ...
    /**
    * Returns a <code>KeywordAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeywordAction} The enum <code>KeywordAction</code> value.
    */
