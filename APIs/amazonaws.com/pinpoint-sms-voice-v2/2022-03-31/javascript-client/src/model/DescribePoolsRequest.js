...
/**
 * The DescribePoolsRequest model module.
 * @module model/DescribePoolsRequest
 * @version 2022-03-31
 */
class DescribePoolsRequest {
    /**
     * Constructs a new <code>DescribePoolsRequest</code>.
     * @alias module:model/DescribePoolsRequest
     */
    constructor() { 
        
        DescribePoolsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePoolsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePoolsRequest} obj Optional instance to populate.
     * @return {module:model/DescribePoolsRequest} The populated <code>DescribePoolsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePoolsRequest();

            if (data.hasOwnProperty('PoolIds')) {
                obj['PoolIds'] = ApiClient.convertToType(data['PoolIds'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePoolsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePoolsRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PoolIds`
        if (data['PoolIds']) { // data not null
          Array.validateJSON(data['PoolIds']);
        }
...
/**
 * @member {Array} PoolIds
 */
DescribePoolsRequest.prototype['PoolIds'] = undefined;

/**
 * @member {Array} Filters
 */
DescribePoolsRequest.prototype['Filters'] = undefined;

/**
 * @member {String} NextToken
 */
DescribePoolsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribePoolsRequest.prototype['MaxResults'] = undefined;
...
export default DescribePoolsRequest;
