...
* @readonly
*/
export default class SpendLimitName {
    
        /**
         * value: "TEXT_MESSAGE_MONTHLY_SPEND_LIMIT"
         * @const
         */
        ...
        /**
         * value: "VOICE_MESSAGE_MONTHLY_SPEND_LIMIT"
         * @const
         */
    ...
    /**
    * Returns a <code>SpendLimitName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SpendLimitName} The enum <code>SpendLimitName</code> value.
    */
