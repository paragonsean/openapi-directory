...
/**
 * The DeleteDefaultSenderIdResult model module.
 * @module model/DeleteDefaultSenderIdResult
 * @version 2022-03-31
 */
class DeleteDefaultSenderIdResult {
    /**
     * Constructs a new <code>DeleteDefaultSenderIdResult</code>.
     * @alias module:model/DeleteDefaultSenderIdResult
     */
    constructor() { 
        
        DeleteDefaultSenderIdResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteDefaultSenderIdResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDefaultSenderIdResult} obj Optional instance to populate.
     * @return {module:model/DeleteDefaultSenderIdResult} The populated <code>DeleteDefaultSenderIdResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDefaultSenderIdResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDefaultSenderIdResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDefaultSenderIdResult</code>.
     */
 ...
 */
DeleteDefaultSenderIdResult.prototype['ConfigurationSetArn'] = undefined;

/**
 * @member {String} ConfigurationSetName
 */
DeleteDefaultSenderIdResult.prototype['ConfigurationSetName'] = undefined;

/**
 * @member {String} SenderId
 */
DeleteDefaultSenderIdResult.prototype['SenderId'] = undefined;
...
export default DeleteDefaultSenderIdResult;
