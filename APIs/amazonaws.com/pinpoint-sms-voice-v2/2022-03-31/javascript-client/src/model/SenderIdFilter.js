...
import SenderIdFilterName from './SenderIdFilterName';

/**
 * The SenderIdFilter model module.
 * @module model/SenderIdFilter
 * @version 2022-03-31
 */
class SenderIdFilter {
    /**
     * Constructs a new <code>SenderIdFilter</code>.
     * The information for a sender ID that meets a specified criteria.
     * @alias module:model/SenderIdFilter
     * @param name {module:model/SenderIdFilterName} 
     * @param values {Array} 
     */
    constructor(name, values) { 
        
        SenderIdFilter.initialize(this, name, values);
    }
    ...
    /**
     * Constructs a <code>SenderIdFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SenderIdFilter} obj Optional instance to populate.
     * @return {module:model/SenderIdFilter} The populated <code>SenderIdFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SenderIdFilter();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], SenderIdFilterName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SenderIdFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SenderIdFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SenderIdFilter.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          SenderIdFilterName.validateJSON(data['Name']);
        }
...
SenderIdFilter.RequiredProperties = ["Name", "Values"];

/**
 * @member {module:model/SenderIdFilterName} Name
 */
SenderIdFilter.prototype['Name'] = undefined;

/**
 * @member {Array} Values
 */
SenderIdFilter.prototype['Values'] = undefined;
