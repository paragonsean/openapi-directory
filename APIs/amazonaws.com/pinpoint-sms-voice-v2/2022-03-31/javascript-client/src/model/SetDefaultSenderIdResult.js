...
/**
 * The SetDefaultSenderIdResult model module.
 * @module model/SetDefaultSenderIdResult
 * @version 2022-03-31
 */
class SetDefaultSenderIdResult {
    /**
     * Constructs a new <code>SetDefaultSenderIdResult</code>.
     * @alias module:model/SetDefaultSenderIdResult
     */
    constructor() { 
        
        SetDefaultSenderIdResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetDefaultSenderIdResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetDefaultSenderIdResult} obj Optional instance to populate.
     * @return {module:model/SetDefaultSenderIdResult} The populated <code>SetDefaultSenderIdResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetDefaultSenderIdResult();
    ...
    /**
     * Validates the JSON data with respect to <code>SetDefaultSenderIdResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetDefaultSenderIdResult</code>.
     */
 ...
 */
SetDefaultSenderIdResult.prototype['ConfigurationSetArn'] = undefined;

/**
 * @member {String} ConfigurationSetName
 */
SetDefaultSenderIdResult.prototype['ConfigurationSetName'] = undefined;

/**
 * @member {String} SenderId
 */
SetDefaultSenderIdResult.prototype['SenderId'] = undefined;
...
export default SetDefaultSenderIdResult;
