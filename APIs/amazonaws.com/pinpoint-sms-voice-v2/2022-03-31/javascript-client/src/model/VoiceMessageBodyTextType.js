...
* @readonly
*/
export default class VoiceMessageBodyTextType {
    ...
    /**
    * Returns a <code>VoiceMessageBodyTextType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VoiceMessageBodyTextType} The enum <code>VoiceMessageBodyTextType</code> value.
    */
