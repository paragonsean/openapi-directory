...
* @readonly
*/
export default class AccountAttributeName {
    ...
    /**
    * Returns a <code>AccountAttributeName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccountAttributeName} The enum <code>AccountAttributeName</code> value.
    */
