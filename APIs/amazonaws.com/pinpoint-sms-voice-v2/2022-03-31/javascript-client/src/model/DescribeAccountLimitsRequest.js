...
/**
 * The DescribeAccountLimitsRequest model module.
 * @module model/DescribeAccountLimitsRequest
 * @version 2022-03-31
 */
class DescribeAccountLimitsRequest {
    /**
     * Constructs a new <code>DescribeAccountLimitsRequest</code>.
     * @alias module:model/DescribeAccountLimitsRequest
     */
    constructor() { 
        
        DescribeAccountLimitsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAccountLimitsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAccountLimitsRequest} obj Optional instance to populate.
     * @return {module:model/DescribeAccountLimitsRequest} The populated <code>DescribeAccountLimitsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAccountLimitsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAccountLimitsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAccountLimitsRequest</code>.
     */
 ...
 */
DescribeAccountLimitsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
DescribeAccountLimitsRequest.prototype['MaxResults'] = undefined;
...
export default DescribeAccountLimitsRequest;
