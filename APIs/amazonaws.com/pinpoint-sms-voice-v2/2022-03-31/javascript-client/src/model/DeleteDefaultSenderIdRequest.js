...
/**
 * The DeleteDefaultSenderIdRequest model module.
 * @module model/DeleteDefaultSenderIdRequest
 * @version 2022-03-31
 */
class DeleteDefaultSenderIdRequest {
    /**
     * Constructs a new <code>DeleteDefaultSenderIdRequest</code>.
     * @alias module:model/DeleteDefaultSenderIdRequest
     * @param configurationSetName {String} 
     */
    constructor(configurationSetName) { 
        
        DeleteDefaultSenderIdRequest.initialize(this, configurationSetName);
    }
    ...
    /**
     * Constructs a <code>DeleteDefaultSenderIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDefaultSenderIdRequest} obj Optional instance to populate.
     * @return {module:model/DeleteDefaultSenderIdRequest} The populated <code>DeleteDefaultSenderIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDefaultSenderIdRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDefaultSenderIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDefaultSenderIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteDefaultSenderIdRequest.RequiredProperties) {
...
DeleteDefaultSenderIdRequest.RequiredProperties = ["ConfigurationSetName"];

/**
 * @member {String} ConfigurationSetName
 */
DeleteDefaultSenderIdRequest.prototype['ConfigurationSetName'] = undefined;
...
export default DeleteDefaultSenderIdRequest;
