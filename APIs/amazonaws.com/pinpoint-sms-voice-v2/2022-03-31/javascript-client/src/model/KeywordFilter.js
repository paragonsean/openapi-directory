...
import KeywordFilterName from './KeywordFilterName';

/**
 * The KeywordFilter model module.
 * @module model/KeywordFilter
 * @version 2022-03-31
 */
class KeywordFilter {
    /**
     * Constructs a new <code>KeywordFilter</code>.
     * The information for keywords that meet a specified criteria.
     * @alias module:model/KeywordFilter
     * @param name {module:model/KeywordFilterName} 
     * @param values {Array} 
     */
    constructor(name, values) { 
        
        KeywordFilter.initialize(this, name, values);
    }
    ...
    /**
     * Constructs a <code>KeywordFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeywordFilter} obj Optional instance to populate.
     * @return {module:model/KeywordFilter} The populated <code>KeywordFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeywordFilter();

            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], KeywordFilterName);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>KeywordFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeywordFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KeywordFilter.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          KeywordFilterName.validateJSON(data['Name']);
        }
...
KeywordFilter.RequiredProperties = ["Name", "Values"];

/**
 * @member {module:model/KeywordFilterName} Name
 */
KeywordFilter.prototype['Name'] = undefined;

/**
 * @member {Array} Values
 */
KeywordFilter.prototype['Values'] = undefined;
