...
* @readonly
*/
export default class DestinationCountryParameterKey {
    
        /**
         * value: "IN_TEMPLATE_ID"
         * @const
         */
    ...
    /**
    * Returns a <code>DestinationCountryParameterKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DestinationCountryParameterKey} The enum <code>DestinationCountryParameterKey</code> value.
    */
