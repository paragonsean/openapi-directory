...
* @readonly
*/
export default class PoolStatus {
    ...
    /**
    * Returns a <code>PoolStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PoolStatus} The enum <code>PoolStatus</code> value.
    */
