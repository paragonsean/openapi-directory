...
/**
 * The DescribePoolsResult model module.
 * @module model/DescribePoolsResult
 * @version 2022-03-31
 */
class DescribePoolsResult {
    /**
     * Constructs a new <code>DescribePoolsResult</code>.
     * @alias module:model/DescribePoolsResult
     */
    constructor() { 
        
        DescribePoolsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePoolsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePoolsResult} obj Optional instance to populate.
     * @return {module:model/DescribePoolsResult} The populated <code>DescribePoolsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePoolsResult();

            if (data.hasOwnProperty('Pools')) {
                obj['Pools'] = ApiClient.convertToType(data['Pools'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePoolsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePoolsResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Pools`
        if (data['Pools']) { // data not null
          Array.validateJSON(data['Pools']);
        }
 ...
 * @member {Array} Pools
 */
DescribePoolsResult.prototype['Pools'] = undefined;

/**
 * @member {String} NextToken
 */
DescribePoolsResult.prototype['NextToken'] = undefined;
...
export default DescribePoolsResult;
