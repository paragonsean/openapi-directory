...
* @readonly
*/
export default class KeywordFilterName {
    ...
    /**
    * Returns a <code>KeywordFilterName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/KeywordFilterName} The enum <code>KeywordFilterName</code> value.
    */
