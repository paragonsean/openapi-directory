...
public class ApiClient {
    ...
    private String basePath = "http://catalog.marketplace.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-09-17/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://catalog.marketplace.us-east-1.amazonaws.com
