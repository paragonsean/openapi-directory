...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.ListEntitiesRequest();
  });
  ...
  describe('ListEntitiesRequest', function() {
    it('should create an instance of ListEntitiesRequest', function() {
      // uncomment below and update the code to test ListEntitiesRequest
      //var instance = new AwsMarketplaceCatalogService.ListEntitiesRequest();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ListEntitiesRequest);
    });
