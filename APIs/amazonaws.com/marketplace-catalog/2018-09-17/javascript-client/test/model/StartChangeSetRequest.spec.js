...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.StartChangeSetRequest();
  });
  ...
  describe('StartChangeSetRequest', function() {
    it('should create an instance of StartChangeSetRequest', function() {
      // uncomment below and update the code to test StartChangeSetRequest
      //var instance = new AwsMarketplaceCatalogService.StartChangeSetRequest();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.StartChangeSetRequest);
    });
    ...
    it('should have the property changeSetTags (base name: "ChangeSetTags")', function() {
      // uncomment below and update the code to test the property changeSetTags
      //var instance = new AwsMarketplaceCatalogService.StartChangeSetRequest();
      //expect(instance).to.be();
    });
