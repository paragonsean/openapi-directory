...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AwsMarketplaceCatalogService.Tag();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.Tag);
    });
