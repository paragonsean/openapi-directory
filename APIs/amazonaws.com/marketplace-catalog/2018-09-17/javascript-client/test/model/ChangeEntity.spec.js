...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.ChangeEntity();
  });
  ...
  describe('ChangeEntity', function() {
    it('should create an instance of ChangeEntity', function() {
      // uncomment below and update the code to test ChangeEntity
      //var instance = new AwsMarketplaceCatalogService.ChangeEntity();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ChangeEntity);
    });
