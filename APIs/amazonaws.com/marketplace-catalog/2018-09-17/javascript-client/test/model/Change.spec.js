...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.Change();
  });
  ...
  describe('Change', function() {
    it('should create an instance of Change', function() {
      ...
      //var instance = new AwsMarketplaceCatalogService.Change();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.Change);
    });
    ...
    it('should have the property entityTags (base name: "EntityTags")', function() {
