...
(function(root, factory) {
  ...
  describe('ChangeStatus', function() {
    it('should create an instance of ChangeStatus', function() {
      // uncomment below and update the code to test ChangeStatus
      //var instance = new AwsMarketplaceCatalogService.ChangeStatus();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ChangeStatus);
    });
