...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.ListChangeSetsRequestSort();
  });
  ...
  describe('ListChangeSetsRequestSort', function() {
    it('should create an instance of ListChangeSetsRequestSort', function() {
      // uncomment below and update the code to test ListChangeSetsRequestSort
      //var instance = new AwsMarketplaceCatalogService.ListChangeSetsRequestSort();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ListChangeSetsRequestSort);
    });
