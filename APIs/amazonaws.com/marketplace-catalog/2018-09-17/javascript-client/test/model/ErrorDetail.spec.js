...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.ErrorDetail();
  });
  ...
  describe('ErrorDetail', function() {
    it('should create an instance of ErrorDetail', function() {
      ...
      //var instance = new AwsMarketplaceCatalogService.ErrorDetail();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ErrorDetail);
    });
