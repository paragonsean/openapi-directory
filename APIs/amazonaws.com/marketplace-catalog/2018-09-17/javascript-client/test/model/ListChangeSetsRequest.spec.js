...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.ListChangeSetsRequest();
  });
  ...
  describe('ListChangeSetsRequest', function() {
    it('should create an instance of ListChangeSetsRequest', function() {
      // uncomment below and update the code to test ListChangeSetsRequest
      //var instance = new AwsMarketplaceCatalogService.ListChangeSetsRequest();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.ListChangeSetsRequest);
    });
