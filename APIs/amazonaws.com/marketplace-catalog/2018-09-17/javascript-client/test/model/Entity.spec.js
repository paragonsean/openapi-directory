...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.Entity();
  });
  ...
  describe('Entity', function() {
    it('should create an instance of Entity', function() {
      ...
      //var instance = new AwsMarketplaceCatalogService.Entity();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.Entity);
    });
