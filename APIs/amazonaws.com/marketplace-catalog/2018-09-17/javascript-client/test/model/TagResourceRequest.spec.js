...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceCatalogService.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsMarketplaceCatalogService.TagResourceRequest();
      //expect(instance).to.be.a(AwsMarketplaceCatalogService.TagResourceRequest);
    });
