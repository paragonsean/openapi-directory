...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://catalog.marketplace.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://catalog.marketplace.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-09-17/Javascript'
        };
