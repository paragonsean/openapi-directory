...
/*
 * OAIListChangeSetsRequest_Sort.h
 *
 * 
 */

#ifndef OAIListChangeSetsRequest_Sort_H
#define OAIListChangeSetsRequest_Sort_H
...
class OAIListChangeSetsRequest_Sort : public OAIObject {
public:
    OAIListChangeSetsRequest_Sort();
    OAIListChangeSetsRequest_Sort(QString json);
    ~OAIListChangeSetsRequest_Sort() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChangeSetsRequest_Sort)

#endif // OAIListChangeSetsRequest_Sort_H
