...
/*
 * OAIStartChangeSetRequest.h
 *
 * 
 */

#ifndef OAIStartChangeSetRequest_H
#define OAIStartChangeSetRequest_H
...
class OAIStartChangeSetRequest : public OAIObject {
public:
    OAIStartChangeSetRequest();
    OAIStartChangeSetRequest(QString json);
    ~OAIStartChangeSetRequest() override;
    ...
    QList getChangeSetTags() const;
    void setChangeSetTags(const QList &change_set_tags);
    bool is_change_set_tags_Set() const;
    bool is_change_set_tags_Valid() const;
...
private:
    ...
    QList m_change_set_tags;
    bool m_change_set_tags_isSet;
    bool m_change_set_tags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartChangeSetRequest)

#endif // OAIStartChangeSetRequest_H
