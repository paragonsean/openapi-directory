...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::cancelChangeSetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::cancelChangeSetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString catalog = create(); // QString | Required. The catalog related to the request. Fixed value: <code>AWSMarketplace</code>.
      ...
      QString change_set_id = create(); // QString | Required. The unique identifier of the <code>StartChangeSet</code> request that you want to cancel.
      ...
      apiInstance.cancelChangeSet(catalogchange_set_idx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
