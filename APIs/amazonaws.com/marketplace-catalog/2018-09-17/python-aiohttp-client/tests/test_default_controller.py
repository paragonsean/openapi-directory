...
async def test_cancel_change_set(client):
    """Test case for cancel_change_set

    
    """
    params = [('catalog', 'catalog_example'),
                    ('changeSetId', 'change_set_id_example')]
    headers = { 
...
async def test_describe_change_set(client):
    """Test case for describe_change_set
...
async def test_describe_entity(client):
    """Test case for describe_entity
...
async def test_list_change_sets(client):
    """Test case for list_change_sets

    
    """
    body = {"NextToken":"","MaxResults":"","Sort":{"SortBy":"","SortOrder":""},"FilterList":"","Catalog":""}
...
async def test_list_entities(client):
    ...
    """
    body = {"EntityType":"","OwnershipType":"SELF","NextToken":"","MaxResults":"","Sort":{"SortBy":"","SortOrder":""},"FilterList":"","Catalog":""}
    params = [('MaxResults', 'max_results_example'),
                    ('NextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_start_change_set(client):
    """Test case for start_change_set

    
    """
    body = {"ClientRequestToken":"","ChangeSetName":"","ChangeSet":"","Catalog":"","ChangeSetTags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
