...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonConnectCampaignService.ListCampaignsRequest();
  });
  ...
  describe('ListCampaignsRequest', function() {
    it('should create an instance of ListCampaignsRequest', function() {
      // uncomment below and update the code to test ListCampaignsRequest
      //var instance = new AmazonConnectCampaignService.ListCampaignsRequest();
      //expect(instance).to.be.a(AmazonConnectCampaignService.ListCampaignsRequest);
    });
