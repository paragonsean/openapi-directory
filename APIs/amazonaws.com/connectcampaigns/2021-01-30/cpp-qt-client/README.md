...
class Example : public QObject {
    Q_OBJECT
    OAICreateCampaign_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateCampaign_request Example::create(){
    OAICreateCampaign_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createCampaignSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createCampaignSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateCampaign_request oai_create_campaign_request = create(); // OAICreateCampaign_request | 
      ...
      apiInstance.createCampaign(oai_create_campaign_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
