...
public class CreateCampaignRequestOutboundCallConfig {
  ...
  public CreateCampaignRequestOutboundCallConfig() {
  }

  public CreateCampaignRequestOutboundCallConfig answerMachineDetectionConfig(AnswerMachineDetectionConfig answerMachineDetectionConfig) {
  ...
  public CreateCampaignRequestOutboundCallConfig connectContactFlowId(String connectContactFlowId) {
  ...
  public CreateCampaignRequestOutboundCallConfig connectQueueId(String connectQueueId) {
  ...
  public CreateCampaignRequestOutboundCallConfig connectSourcePhoneNumber(String connectSourcePhoneNumber) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCampaignRequestOutboundCallConfig createCampaignRequestOutboundCallConfig = (CreateCampaignRequestOutboundCallConfig) o;
    return Objects.equals(this.answerMachineDetectionConfig, createCampaignRequestOutboundCallConfig.answerMachineDetectionConfig) &&
        Objects.equals(this.connectContactFlowId, createCampaignRequestOutboundCallConfig.connectContactFlowId) &&
        Objects.equals(this.connectQueueId, createCampaignRequestOutboundCallConfig.connectQueueId) &&
        Objects.equals(this.connectSourcePhoneNumber, createCampaignRequestOutboundCallConfig.connectSourcePhoneNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCampaignRequestOutboundCallConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCampaignRequestOutboundCallConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCampaignRequestOutboundCallConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCampaignRequestOutboundCallConfig is not found in the empty JSON string", CreateCampaignRequestOutboundCallConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCampaignRequestOutboundCallConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCampaignRequestOutboundCallConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("connectQueueId") != null && !jsonObj.get("connectQueueId").isJsonNull()) && !jsonObj.get("connectQueueId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCampaignRequestOutboundCallConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCampaignRequestOutboundCallConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCampaignRequestOutboundCallConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCampaignRequestOutboundCallConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCampaignRequestOutboundCallConfig>() {
           @Override
           public void write(JsonWriter out, CreateCampaignRequestOutboundCallConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCampaignRequestOutboundCallConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCampaignRequestOutboundCallConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCampaignRequestOutboundCallConfig
   * @throws IOException if the JSON string is invalid with respect to CreateCampaignRequestOutboundCallConfig
   */
  public static CreateCampaignRequestOutboundCallConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCampaignRequestOutboundCallConfig.class);
  }

  /**
   * Convert an instance of CreateCampaignRequestOutboundCallConfig to an JSON string
   *
   * @return JSON string
   */
