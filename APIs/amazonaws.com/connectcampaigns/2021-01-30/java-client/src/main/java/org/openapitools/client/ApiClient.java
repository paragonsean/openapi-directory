...
public class ApiClient {
    ...
    private String basePath = "http://connect-campaigns.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-01-30/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://connect-campaigns.us-east-1.amazonaws.com
