...
class CreateCampaignRequestOutboundCallConfig(Model):
    ...
    def __init__(self, answer_machine_detection_config: AnswerMachineDetectionConfig=None, connect_contact_flow_id: str=None, connect_queue_id: str=None, connect_source_phone_number: str=None):
        """CreateCampaignRequestOutboundCallConfig - a model defined in OpenAPI

        :param answer_machine_detection_config: The answer_machine_detection_config of this CreateCampaignRequestOutboundCallConfig.
        :param connect_contact_flow_id: The connect_contact_flow_id of this CreateCampaignRequestOutboundCallConfig.
        :param connect_queue_id: The connect_queue_id of this CreateCampaignRequestOutboundCallConfig.
        :param connect_source_phone_number: The connect_source_phone_number of this CreateCampaignRequestOutboundCallConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateCampaignRequestOutboundCallConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateCampaign_request_outboundCallConfig of this CreateCampaignRequestOutboundCallConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def answer_machine_detection_config(self):
        """Gets the answer_machine_detection_config of this CreateCampaignRequestOutboundCallConfig.


        :return: The answer_machine_detection_config of this CreateCampaignRequestOutboundCallConfig.
    ...
    def answer_machine_detection_config(self, answer_machine_detection_config):
        """Sets the answer_machine_detection_config of this CreateCampaignRequestOutboundCallConfig.
    ...
    def connect_contact_flow_id(self):
        """Gets the connect_contact_flow_id of this CreateCampaignRequestOutboundCallConfig.

        The identifier of the contact flow for the outbound call.

        :return: The connect_contact_flow_id of this CreateCampaignRequestOutboundCallConfig.
        :rtype: str
        """
    ...
    def connect_contact_flow_id(self, connect_contact_flow_id):
        """Sets the connect_contact_flow_id of this CreateCampaignRequestOutboundCallConfig.
    ...
    def connect_queue_id(self):
        """Gets the connect_queue_id of this CreateCampaignRequestOutboundCallConfig.

        The queue for the call. If you specify a queue, the phone displayed for caller ID is the phone number specified in the queue. If you do not specify a queue, the queue defined in the contact flow is used. If you do not specify a queue, you must specify a source phone number.

        :return: The connect_queue_id of this CreateCampaignRequestOutboundCallConfig.
        :rtype: str
        """
    ...
    def connect_queue_id(self, connect_queue_id):
        """Sets the connect_queue_id of this CreateCampaignRequestOutboundCallConfig.
    ...
    def connect_source_phone_number(self):
        """Gets the connect_source_phone_number of this CreateCampaignRequestOutboundCallConfig.

        The phone number associated with the Amazon Connect instance, in E.164 format. If you do not specify a source phone number, you must specify a queue.

        :return: The connect_source_phone_number of this CreateCampaignRequestOutboundCallConfig.
        :rtype: str
        """
    ...
    def connect_source_phone_number(self, connect_source_phone_number):
        """Sets the connect_source_phone_number of this CreateCampaignRequestOutboundCallConfig.
