...
/*
 * OAIListManagedPoliciesInPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIListManagedPoliciesInPermissionSetRequest_H
#define OAIListManagedPoliciesInPermissionSetRequest_H
...
class OAIListManagedPoliciesInPermissionSetRequest : public OAIObject {
public:
    OAIListManagedPoliciesInPermissionSetRequest();
    OAIListManagedPoliciesInPermissionSetRequest(QString json);
    ~OAIListManagedPoliciesInPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListManagedPoliciesInPermissionSetRequest)

#endif // OAIListManagedPoliciesInPermissionSetRequest_H
