...
/*
 * OAIListAccountAssignmentsResponse.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentsResponse_H
#define OAIListAccountAssignmentsResponse_H
...
class OAIListAccountAssignmentsResponse : public OAIObject {
public:
    OAIListAccountAssignmentsResponse();
    OAIListAccountAssignmentsResponse(QString json);
    ~OAIListAccountAssignmentsResponse() override;
    ...
    QList getAccountAssignments() const;
    void setAccountAssignments(const QList &account_assignments);
    bool is_account_assignments_Set() const;
    bool is_account_assignments_Valid() const;
...
private:
    ...
    QList m_account_assignments;
    bool m_account_assignments_isSet;
    bool m_account_assignments_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentsResponse)

#endif // OAIListAccountAssignmentsResponse_H
