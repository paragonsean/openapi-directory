...
/*
 * OAIAccountAssignmentOperationStatus.h
 *
 * The status of the creation or deletion operation of an assignment that a principal needs to access an account.
 */

#ifndef OAIAccountAssignmentOperationStatus_H
#define OAIAccountAssignmentOperationStatus_H
...
class OAIAccountAssignmentOperationStatus : public OAIObject {
public:
    OAIAccountAssignmentOperationStatus();
    OAIAccountAssignmentOperationStatus(QString json);
    ~OAIAccountAssignmentOperationStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountAssignmentOperationStatus)

#endif // OAIAccountAssignmentOperationStatus_H
