...
#ifndef OAIStatusValues_H
#define OAIStatusValues_H
...
class OAIStatusValues : public OAIEnum {
public:
    OAIStatusValues();
    OAIStatusValues(QString json);
    ~OAIStatusValues() override;
    ...
    enum class eOAIStatusValues {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IN_PROGRESS, 
        FAILED, 
        SUCCEEDED
    };
    OAIStatusValues::eOAIStatusValues getValue() const;
    void setValue(const OAIStatusValues::eOAIStatusValues& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusValues)

#endif // OAIStatusValues_H
