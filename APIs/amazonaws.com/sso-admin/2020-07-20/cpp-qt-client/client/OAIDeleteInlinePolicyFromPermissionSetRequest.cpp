...
OAIDeleteInlinePolicyFromPermissionSetRequest::OAIDeleteInlinePolicyFromPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteInlinePolicyFromPermissionSetRequest::OAIDeleteInlinePolicyFromPermissionSetRequest() {
    this->initializeModel();
}

OAIDeleteInlinePolicyFromPermissionSetRequest::~OAIDeleteInlinePolicyFromPermissionSetRequest() {}

void OAIDeleteInlinePolicyFromPermissionSetRequest::initializeModel() {
...
void OAIDeleteInlinePolicyFromPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIDeleteInlinePolicyFromPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteInlinePolicyFromPermissionSetRequest::asJson() const {
...
QJsonObject OAIDeleteInlinePolicyFromPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteInlinePolicyFromPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIDeleteInlinePolicyFromPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIDeleteInlinePolicyFromPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIDeleteInlinePolicyFromPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIDeleteInlinePolicyFromPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIDeleteInlinePolicyFromPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIDeleteInlinePolicyFromPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIDeleteInlinePolicyFromPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

bool OAIDeleteInlinePolicyFromPermissionSetRequest::isSet() const {
...
bool OAIDeleteInlinePolicyFromPermissionSetRequest::isValid() const {
