...
/*
 * OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference.h
 *
 * 
 */

#ifndef OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference_H
#define OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference_H
...
class OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference : public OAIObject {
public:
    OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference();
    OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference(QString json);
    ~OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference)

#endif // OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_CustomerManagedPolicyReference_H
