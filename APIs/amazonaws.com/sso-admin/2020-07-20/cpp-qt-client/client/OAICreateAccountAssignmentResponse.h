...
/*
 * OAICreateAccountAssignmentResponse.h
 *
 * 
 */

#ifndef OAICreateAccountAssignmentResponse_H
#define OAICreateAccountAssignmentResponse_H
...
class OAICreateAccountAssignmentResponse : public OAIObject {
public:
    OAICreateAccountAssignmentResponse();
    OAICreateAccountAssignmentResponse(QString json);
    ~OAICreateAccountAssignmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccountAssignmentResponse)

#endif // OAICreateAccountAssignmentResponse_H
