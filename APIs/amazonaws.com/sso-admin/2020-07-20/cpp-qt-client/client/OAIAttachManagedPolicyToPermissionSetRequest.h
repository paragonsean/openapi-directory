...
/*
 * OAIAttachManagedPolicyToPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIAttachManagedPolicyToPermissionSetRequest_H
#define OAIAttachManagedPolicyToPermissionSetRequest_H
...
class OAIAttachManagedPolicyToPermissionSetRequest : public OAIObject {
public:
    OAIAttachManagedPolicyToPermissionSetRequest();
    OAIAttachManagedPolicyToPermissionSetRequest(QString json);
    ~OAIAttachManagedPolicyToPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachManagedPolicyToPermissionSetRequest)

#endif // OAIAttachManagedPolicyToPermissionSetRequest_H
