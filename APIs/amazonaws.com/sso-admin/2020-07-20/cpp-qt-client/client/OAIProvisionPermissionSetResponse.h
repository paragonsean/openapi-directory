...
/*
 * OAIProvisionPermissionSetResponse.h
 *
 * 
 */

#ifndef OAIProvisionPermissionSetResponse_H
#define OAIProvisionPermissionSetResponse_H
...
class OAIProvisionPermissionSetResponse : public OAIObject {
public:
    OAIProvisionPermissionSetResponse();
    OAIProvisionPermissionSetResponse(QString json);
    ~OAIProvisionPermissionSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionPermissionSetResponse)

#endif // OAIProvisionPermissionSetResponse_H
