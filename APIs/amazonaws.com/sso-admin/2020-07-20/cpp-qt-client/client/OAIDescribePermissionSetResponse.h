...
/*
 * OAIDescribePermissionSetResponse.h
 *
 * 
 */

#ifndef OAIDescribePermissionSetResponse_H
#define OAIDescribePermissionSetResponse_H
...
namespace OpenAPI {
class OAIDescribePermissionSetResponse_PermissionSet;

class OAIDescribePermissionSetResponse : public OAIObject {
public:
    OAIDescribePermissionSetResponse();
    OAIDescribePermissionSetResponse(QString json);
    ~OAIDescribePermissionSetResponse() override;
    ...
    OAIDescribePermissionSetResponse_PermissionSet getPermissionSet() const;
    void setPermissionSet(const OAIDescribePermissionSetResponse_PermissionSet &permission_set);
...
private:
    ...
    OAIDescribePermissionSetResponse_PermissionSet m_permission_set;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePermissionSetResponse)

#endif // OAIDescribePermissionSetResponse_H
