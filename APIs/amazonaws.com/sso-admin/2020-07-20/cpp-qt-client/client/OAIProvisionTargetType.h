...
/*
 * OAIProvisionTargetType.h
 *
 * 
 */

#ifndef OAIProvisionTargetType_H
#define OAIProvisionTargetType_H
...
class OAIProvisionTargetType : public OAIEnum {
public:
    OAIProvisionTargetType();
    OAIProvisionTargetType(QString json);
    ~OAIProvisionTargetType() override;
    ...
    enum class eOAIProvisionTargetType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS_ACCOUNT, 
        ALL_PROVISIONED_ACCOUNTS
    };
    OAIProvisionTargetType::eOAIProvisionTargetType getValue() const;
    void setValue(const OAIProvisionTargetType::eOAIProvisionTargetType& value);
...
private:
    ...
    eOAIProvisionTargetType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionTargetType)

#endif // OAIProvisionTargetType_H
