...
OAIGetPermissionsBoundaryForPermissionSetRequest::OAIGetPermissionsBoundaryForPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPermissionsBoundaryForPermissionSetRequest::OAIGetPermissionsBoundaryForPermissionSetRequest() {
    this->initializeModel();
}

OAIGetPermissionsBoundaryForPermissionSetRequest::~OAIGetPermissionsBoundaryForPermissionSetRequest() {}

void OAIGetPermissionsBoundaryForPermissionSetRequest::initializeModel() {
...
void OAIGetPermissionsBoundaryForPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIGetPermissionsBoundaryForPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetPermissionsBoundaryForPermissionSetRequest::asJson() const {
...
QJsonObject OAIGetPermissionsBoundaryForPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPermissionsBoundaryForPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIGetPermissionsBoundaryForPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIGetPermissionsBoundaryForPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIGetPermissionsBoundaryForPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIGetPermissionsBoundaryForPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIGetPermissionsBoundaryForPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIGetPermissionsBoundaryForPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIGetPermissionsBoundaryForPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

bool OAIGetPermissionsBoundaryForPermissionSetRequest::isSet() const {
...
bool OAIGetPermissionsBoundaryForPermissionSetRequest::isValid() const {
