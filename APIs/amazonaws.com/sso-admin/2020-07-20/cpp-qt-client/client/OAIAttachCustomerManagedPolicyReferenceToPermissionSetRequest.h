...
/*
 * OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_H
#define OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_H
...
class OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest : public OAIObject {
public:
    OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest();
    OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest(QString json);
    ~OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest)

#endif // OAIAttachCustomerManagedPolicyReferenceToPermissionSetRequest_H
