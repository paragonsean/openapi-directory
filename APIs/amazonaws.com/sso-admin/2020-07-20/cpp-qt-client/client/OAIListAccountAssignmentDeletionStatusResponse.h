...
/*
 * OAIListAccountAssignmentDeletionStatusResponse.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentDeletionStatusResponse_H
#define OAIListAccountAssignmentDeletionStatusResponse_H
...
class OAIListAccountAssignmentDeletionStatusResponse : public OAIObject {
public:
    OAIListAccountAssignmentDeletionStatusResponse();
    OAIListAccountAssignmentDeletionStatusResponse(QString json);
    ~OAIListAccountAssignmentDeletionStatusResponse() override;
    ...
    QList getAccountAssignmentsDeletionStatus() const;
    void setAccountAssignmentsDeletionStatus(const QList &account_assignments_deletion_status);
    bool is_account_assignments_deletion_status_Set() const;
    bool is_account_assignments_deletion_status_Valid() const;
...
private:
    ...
    QList m_account_assignments_deletion_status;
    bool m_account_assignments_deletion_status_isSet;
    bool m_account_assignments_deletion_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentDeletionStatusResponse)

#endif // OAIListAccountAssignmentDeletionStatusResponse_H
