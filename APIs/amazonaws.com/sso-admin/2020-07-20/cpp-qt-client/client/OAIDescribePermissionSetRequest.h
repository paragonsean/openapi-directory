...
/*
 * OAIDescribePermissionSetRequest.h
 *
 * 
 */

#ifndef OAIDescribePermissionSetRequest_H
#define OAIDescribePermissionSetRequest_H
...
class OAIDescribePermissionSetRequest : public OAIObject {
public:
    OAIDescribePermissionSetRequest();
    OAIDescribePermissionSetRequest(QString json);
    ~OAIDescribePermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePermissionSetRequest)

#endif // OAIDescribePermissionSetRequest_H
