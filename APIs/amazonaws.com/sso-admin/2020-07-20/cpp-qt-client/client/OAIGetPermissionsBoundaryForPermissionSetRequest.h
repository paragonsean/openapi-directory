...
/*
 * OAIGetPermissionsBoundaryForPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIGetPermissionsBoundaryForPermissionSetRequest_H
#define OAIGetPermissionsBoundaryForPermissionSetRequest_H
...
class OAIGetPermissionsBoundaryForPermissionSetRequest : public OAIObject {
public:
    OAIGetPermissionsBoundaryForPermissionSetRequest();
    OAIGetPermissionsBoundaryForPermissionSetRequest(QString json);
    ~OAIGetPermissionsBoundaryForPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermissionsBoundaryForPermissionSetRequest)

#endif // OAIGetPermissionsBoundaryForPermissionSetRequest_H
