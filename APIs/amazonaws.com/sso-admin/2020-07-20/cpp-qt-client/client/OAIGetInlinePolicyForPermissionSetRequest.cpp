...
OAIGetInlinePolicyForPermissionSetRequest::OAIGetInlinePolicyForPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetInlinePolicyForPermissionSetRequest::OAIGetInlinePolicyForPermissionSetRequest() {
    this->initializeModel();
}

OAIGetInlinePolicyForPermissionSetRequest::~OAIGetInlinePolicyForPermissionSetRequest() {}

void OAIGetInlinePolicyForPermissionSetRequest::initializeModel() {
...
void OAIGetInlinePolicyForPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIGetInlinePolicyForPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetInlinePolicyForPermissionSetRequest::asJson() const {
...
QJsonObject OAIGetInlinePolicyForPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetInlinePolicyForPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIGetInlinePolicyForPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIGetInlinePolicyForPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIGetInlinePolicyForPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIGetInlinePolicyForPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIGetInlinePolicyForPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIGetInlinePolicyForPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIGetInlinePolicyForPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

bool OAIGetInlinePolicyForPermissionSetRequest::isSet() const {
...
bool OAIGetInlinePolicyForPermissionSetRequest::isValid() const {
