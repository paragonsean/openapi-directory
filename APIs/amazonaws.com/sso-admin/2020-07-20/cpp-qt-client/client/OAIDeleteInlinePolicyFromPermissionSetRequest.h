...
/*
 * OAIDeleteInlinePolicyFromPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIDeleteInlinePolicyFromPermissionSetRequest_H
#define OAIDeleteInlinePolicyFromPermissionSetRequest_H
...
class OAIDeleteInlinePolicyFromPermissionSetRequest : public OAIObject {
public:
    OAIDeleteInlinePolicyFromPermissionSetRequest();
    OAIDeleteInlinePolicyFromPermissionSetRequest(QString json);
    ~OAIDeleteInlinePolicyFromPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteInlinePolicyFromPermissionSetRequest)

#endif // OAIDeleteInlinePolicyFromPermissionSetRequest_H
