...
#ifndef OAIAccessControlAttribute_H
#define OAIAccessControlAttribute_H
...
namespace OpenAPI {
class OAIAccessControlAttribute_Value;

class OAIAccessControlAttribute : public OAIObject {
public:
    OAIAccessControlAttribute();
    OAIAccessControlAttribute(QString json);
    ~OAIAccessControlAttribute() override;
    ...
    OAIAccessControlAttribute_Value getValue() const;
    void setValue(const OAIAccessControlAttribute_Value &value);
...
private:
    ...
    OAIAccessControlAttribute_Value m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessControlAttribute)

#endif // OAIAccessControlAttribute_H
