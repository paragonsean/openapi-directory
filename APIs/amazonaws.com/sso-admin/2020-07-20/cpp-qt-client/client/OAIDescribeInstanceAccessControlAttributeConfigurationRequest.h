...
/*
 * OAIDescribeInstanceAccessControlAttributeConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDescribeInstanceAccessControlAttributeConfigurationRequest_H
#define OAIDescribeInstanceAccessControlAttributeConfigurationRequest_H
...
class OAIDescribeInstanceAccessControlAttributeConfigurationRequest : public OAIObject {
public:
    OAIDescribeInstanceAccessControlAttributeConfigurationRequest();
    OAIDescribeInstanceAccessControlAttributeConfigurationRequest(QString json);
    ~OAIDescribeInstanceAccessControlAttributeConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeInstanceAccessControlAttributeConfigurationRequest)

#endif // OAIDescribeInstanceAccessControlAttributeConfigurationRequest_H
