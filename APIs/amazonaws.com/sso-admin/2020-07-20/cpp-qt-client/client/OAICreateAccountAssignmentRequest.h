...
/*
 * OAICreateAccountAssignmentRequest.h
 *
 * 
 */

#ifndef OAICreateAccountAssignmentRequest_H
#define OAICreateAccountAssignmentRequest_H
...
class OAICreateAccountAssignmentRequest : public OAIObject {
public:
    OAICreateAccountAssignmentRequest();
    OAICreateAccountAssignmentRequest(QString json);
    ~OAICreateAccountAssignmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccountAssignmentRequest)

#endif // OAICreateAccountAssignmentRequest_H
