...
/*
 * OAIListAccountAssignmentsRequest.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentsRequest_H
#define OAIListAccountAssignmentsRequest_H
...
class OAIListAccountAssignmentsRequest : public OAIObject {
public:
    OAIListAccountAssignmentsRequest();
    OAIListAccountAssignmentsRequest(QString json);
    ~OAIListAccountAssignmentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentsRequest)

#endif // OAIListAccountAssignmentsRequest_H
