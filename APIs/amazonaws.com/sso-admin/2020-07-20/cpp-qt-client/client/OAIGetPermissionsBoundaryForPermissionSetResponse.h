...
/*
 * OAIGetPermissionsBoundaryForPermissionSetResponse.h
 *
 * 
 */

#ifndef OAIGetPermissionsBoundaryForPermissionSetResponse_H
#define OAIGetPermissionsBoundaryForPermissionSetResponse_H

#include <QJsonObject>

#include "OAIGetPermissionsBoundaryForPermissionSetResponse_PermissionsBoundary.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetPermissionsBoundaryForPermissionSetResponse_PermissionsBoundary;

class OAIGetPermissionsBoundaryForPermissionSetResponse : public OAIObject {
public:
    OAIGetPermissionsBoundaryForPermissionSetResponse();
    OAIGetPermissionsBoundaryForPermissionSetResponse(QString json);
    ~OAIGetPermissionsBoundaryForPermissionSetResponse() override;
    ...
    OAIGetPermissionsBoundaryForPermissionSetResponse_PermissionsBoundary getPermissionsBoundary() const;
    void setPermissionsBoundary(const OAIGetPermissionsBoundaryForPermissionSetResponse_PermissionsBoundary &permissions_boundary);
...
private:
    ...
    OAIGetPermissionsBoundaryForPermissionSetResponse_PermissionsBoundary m_permissions_boundary;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermissionsBoundaryForPermissionSetResponse)

#endif // OAIGetPermissionsBoundaryForPermissionSetResponse_H
