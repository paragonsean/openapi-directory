...
/*
 * OAIListAccountAssignmentDeletionStatusRequest.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentDeletionStatusRequest_H
#define OAIListAccountAssignmentDeletionStatusRequest_H
...
class OAIListAccountAssignmentDeletionStatusRequest : public OAIObject {
public:
    OAIListAccountAssignmentDeletionStatusRequest();
    OAIListAccountAssignmentDeletionStatusRequest(QString json);
    ~OAIListAccountAssignmentDeletionStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentDeletionStatusRequest)

#endif // OAIListAccountAssignmentDeletionStatusRequest_H
