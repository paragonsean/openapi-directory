...
/*
 * OAIAccessControlAttributeValue.h
 *
...
#ifndef OAIAccessControlAttributeValue_H
#define OAIAccessControlAttributeValue_H
...
class OAIAccessControlAttributeValue : public OAIObject {
public:
    OAIAccessControlAttributeValue();
    OAIAccessControlAttributeValue(QString json);
    ~OAIAccessControlAttributeValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessControlAttributeValue)

#endif // OAIAccessControlAttributeValue_H
