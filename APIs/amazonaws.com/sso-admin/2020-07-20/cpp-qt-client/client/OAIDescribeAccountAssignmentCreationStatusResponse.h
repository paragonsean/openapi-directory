...
/*
 * OAIDescribeAccountAssignmentCreationStatusResponse.h
 *
 * 
 */

#ifndef OAIDescribeAccountAssignmentCreationStatusResponse_H
#define OAIDescribeAccountAssignmentCreationStatusResponse_H
...
namespace OpenAPI {
class OAICreateAccountAssignmentResponse_AccountAssignmentCreationStatus;

class OAIDescribeAccountAssignmentCreationStatusResponse : public OAIObject {
public:
    OAIDescribeAccountAssignmentCreationStatusResponse();
    OAIDescribeAccountAssignmentCreationStatusResponse(QString json);
    ~OAIDescribeAccountAssignmentCreationStatusResponse() override;
    ...
    OAICreateAccountAssignmentResponse_AccountAssignmentCreationStatus getAccountAssignmentCreationStatus() const;
    void setAccountAssignmentCreationStatus(const OAICreateAccountAssignmentResponse_AccountAssignmentCreationStatus &account_assignment_creation_status);
    bool is_account_assignment_creation_status_Set() const;
    bool is_account_assignment_creation_status_Valid() const;
...
private:
    ...
    OAICreateAccountAssignmentResponse_AccountAssignmentCreationStatus m_account_assignment_creation_status;
    bool m_account_assignment_creation_status_isSet;
    bool m_account_assignment_creation_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountAssignmentCreationStatusResponse)

#endif // OAIDescribeAccountAssignmentCreationStatusResponse_H
