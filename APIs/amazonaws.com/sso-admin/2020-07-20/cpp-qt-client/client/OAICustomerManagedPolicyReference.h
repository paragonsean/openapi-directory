...
/*
 * OAICustomerManagedPolicyReference.h
 *
 * Specifies the name and path of a customer managed policy. You must have an IAM policy that matches the name and path in each AWS account where you want to deploy your permission set.
 */

#ifndef OAICustomerManagedPolicyReference_H
#define OAICustomerManagedPolicyReference_H
...
class OAICustomerManagedPolicyReference : public OAIObject {
public:
    OAICustomerManagedPolicyReference();
    OAICustomerManagedPolicyReference(QString json);
    ~OAICustomerManagedPolicyReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerManagedPolicyReference)

#endif // OAICustomerManagedPolicyReference_H
