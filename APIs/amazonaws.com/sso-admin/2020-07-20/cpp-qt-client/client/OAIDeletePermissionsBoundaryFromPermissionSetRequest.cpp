...
OAIDeletePermissionsBoundaryFromPermissionSetRequest::OAIDeletePermissionsBoundaryFromPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePermissionsBoundaryFromPermissionSetRequest::OAIDeletePermissionsBoundaryFromPermissionSetRequest() {
    this->initializeModel();
}

OAIDeletePermissionsBoundaryFromPermissionSetRequest::~OAIDeletePermissionsBoundaryFromPermissionSetRequest() {}

void OAIDeletePermissionsBoundaryFromPermissionSetRequest::initializeModel() {
...
void OAIDeletePermissionsBoundaryFromPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIDeletePermissionsBoundaryFromPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePermissionsBoundaryFromPermissionSetRequest::asJson() const {
...
QJsonObject OAIDeletePermissionsBoundaryFromPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePermissionsBoundaryFromPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIDeletePermissionsBoundaryFromPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIDeletePermissionsBoundaryFromPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIDeletePermissionsBoundaryFromPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::isSet() const {
...
bool OAIDeletePermissionsBoundaryFromPermissionSetRequest::isValid() const {
