...
/*
 * OAIListAccountAssignmentCreationStatusRequest.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentCreationStatusRequest_H
#define OAIListAccountAssignmentCreationStatusRequest_H

#include <QJsonObject>

#include "OAIListAccountAssignmentCreationStatusRequest_Filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIListAccountAssignmentCreationStatusRequest_Filter;

class OAIListAccountAssignmentCreationStatusRequest : public OAIObject {
public:
    OAIListAccountAssignmentCreationStatusRequest();
    OAIListAccountAssignmentCreationStatusRequest(QString json);
    ~OAIListAccountAssignmentCreationStatusRequest() override;
    ...
    OAIListAccountAssignmentCreationStatusRequest_Filter getFilter() const;
    void setFilter(const OAIListAccountAssignmentCreationStatusRequest_Filter &filter);
...
private:
    ...
    OAIListAccountAssignmentCreationStatusRequest_Filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentCreationStatusRequest)

#endif // OAIListAccountAssignmentCreationStatusRequest_H
