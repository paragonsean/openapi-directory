...
/*
 * OAIDetachManagedPolicyFromPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIDetachManagedPolicyFromPermissionSetRequest_H
#define OAIDetachManagedPolicyFromPermissionSetRequest_H
...
class OAIDetachManagedPolicyFromPermissionSetRequest : public OAIObject {
public:
    OAIDetachManagedPolicyFromPermissionSetRequest();
    OAIDetachManagedPolicyFromPermissionSetRequest(QString json);
    ~OAIDetachManagedPolicyFromPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachManagedPolicyFromPermissionSetRequest)

#endif // OAIDetachManagedPolicyFromPermissionSetRequest_H
