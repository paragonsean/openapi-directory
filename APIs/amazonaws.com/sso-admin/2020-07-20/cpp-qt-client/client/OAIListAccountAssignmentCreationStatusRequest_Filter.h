...
/*
 * OAIListAccountAssignmentCreationStatusRequest_Filter.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentCreationStatusRequest_Filter_H
#define OAIListAccountAssignmentCreationStatusRequest_Filter_H
...
class OAIListAccountAssignmentCreationStatusRequest_Filter : public OAIObject {
public:
    OAIListAccountAssignmentCreationStatusRequest_Filter();
    OAIListAccountAssignmentCreationStatusRequest_Filter(QString json);
    ~OAIListAccountAssignmentCreationStatusRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentCreationStatusRequest_Filter)

#endif // OAIListAccountAssignmentCreationStatusRequest_Filter_H
