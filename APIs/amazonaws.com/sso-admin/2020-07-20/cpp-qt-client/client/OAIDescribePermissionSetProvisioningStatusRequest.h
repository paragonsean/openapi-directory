...
/*
 * OAIDescribePermissionSetProvisioningStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribePermissionSetProvisioningStatusRequest_H
#define OAIDescribePermissionSetProvisioningStatusRequest_H
...
class OAIDescribePermissionSetProvisioningStatusRequest : public OAIObject {
public:
    OAIDescribePermissionSetProvisioningStatusRequest();
    OAIDescribePermissionSetProvisioningStatusRequest(QString json);
    ~OAIDescribePermissionSetProvisioningStatusRequest() override;
    ...
    QString getProvisionPermissionSetRequestId() const;
    void setProvisionPermissionSetRequestId(const QString &provision_permission_set_request_id);
    bool is_provision_permission_set_request_id_Set() const;
    bool is_provision_permission_set_request_id_Valid() const;
...
private:
    ...
    QString m_provision_permission_set_request_id;
    bool m_provision_permission_set_request_id_isSet;
    bool m_provision_permission_set_request_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribePermissionSetProvisioningStatusRequest)

#endif // OAIDescribePermissionSetProvisioningStatusRequest_H
