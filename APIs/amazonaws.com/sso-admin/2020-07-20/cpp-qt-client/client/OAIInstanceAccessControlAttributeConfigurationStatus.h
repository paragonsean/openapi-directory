...
/*
 * OAIInstanceAccessControlAttributeConfigurationStatus.h
 *
 * 
 */

#ifndef OAIInstanceAccessControlAttributeConfigurationStatus_H
#define OAIInstanceAccessControlAttributeConfigurationStatus_H
...
class OAIInstanceAccessControlAttributeConfigurationStatus : public OAIEnum {
public:
    OAIInstanceAccessControlAttributeConfigurationStatus();
    OAIInstanceAccessControlAttributeConfigurationStatus(QString json);
    ~OAIInstanceAccessControlAttributeConfigurationStatus() override;
    ...
    enum class eOAIInstanceAccessControlAttributeConfigurationStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLED, 
        CREATION_IN_PROGRESS, 
        CREATION_FAILED
    };
    OAIInstanceAccessControlAttributeConfigurationStatus::eOAIInstanceAccessControlAttributeConfigurationStatus getValue() const;
    void setValue(const OAIInstanceAccessControlAttributeConfigurationStatus::eOAIInstanceAccessControlAttributeConfigurationStatus& value);
...
private:
    ...
    eOAIInstanceAccessControlAttributeConfigurationStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceAccessControlAttributeConfigurationStatus)

#endif // OAIInstanceAccessControlAttributeConfigurationStatus_H
