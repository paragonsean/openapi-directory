...
/*
 * OAIListPermissionSetProvisioningStatusResponse.h
 *
 * 
 */

#ifndef OAIListPermissionSetProvisioningStatusResponse_H
#define OAIListPermissionSetProvisioningStatusResponse_H
...
class OAIListPermissionSetProvisioningStatusResponse : public OAIObject {
public:
    OAIListPermissionSetProvisioningStatusResponse();
    OAIListPermissionSetProvisioningStatusResponse(QString json);
    ~OAIListPermissionSetProvisioningStatusResponse() override;
    ...
    QList getPermissionSetsProvisioningStatus() const;
    void setPermissionSetsProvisioningStatus(const QList &permission_sets_provisioning_status);
    bool is_permission_sets_provisioning_status_Set() const;
    bool is_permission_sets_provisioning_status_Valid() const;
...
private:
    ...
    QList m_permission_sets_provisioning_status;
    bool m_permission_sets_provisioning_status_isSet;
    bool m_permission_sets_provisioning_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPermissionSetProvisioningStatusResponse)

#endif // OAIListPermissionSetProvisioningStatusResponse_H
