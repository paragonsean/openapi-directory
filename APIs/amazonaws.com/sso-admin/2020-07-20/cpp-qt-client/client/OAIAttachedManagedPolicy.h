...
/*
 * OAIAttachedManagedPolicy.h
 *
 * A structure that stores the details of the AWS managed policy.
 */

#ifndef OAIAttachedManagedPolicy_H
#define OAIAttachedManagedPolicy_H
...
class OAIAttachedManagedPolicy : public OAIObject {
public:
    OAIAttachedManagedPolicy();
    OAIAttachedManagedPolicy(QString json);
    ~OAIAttachedManagedPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachedManagedPolicy)

#endif // OAIAttachedManagedPolicy_H
