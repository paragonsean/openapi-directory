...
/*
 * OAIDeleteAccountAssignmentRequest.h
 *
 * 
 */

#ifndef OAIDeleteAccountAssignmentRequest_H
#define OAIDeleteAccountAssignmentRequest_H
...
class OAIDeleteAccountAssignmentRequest : public OAIObject {
public:
    OAIDeleteAccountAssignmentRequest();
    OAIDeleteAccountAssignmentRequest(QString json);
    ~OAIDeleteAccountAssignmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAccountAssignmentRequest)

#endif // OAIDeleteAccountAssignmentRequest_H
