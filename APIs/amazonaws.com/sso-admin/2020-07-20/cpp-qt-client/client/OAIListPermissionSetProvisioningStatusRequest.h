...
/*
 * OAIListPermissionSetProvisioningStatusRequest.h
 *
 * 
 */

#ifndef OAIListPermissionSetProvisioningStatusRequest_H
#define OAIListPermissionSetProvisioningStatusRequest_H
...
class OAIListPermissionSetProvisioningStatusRequest : public OAIObject {
public:
    OAIListPermissionSetProvisioningStatusRequest();
    OAIListPermissionSetProvisioningStatusRequest(QString json);
    ~OAIListPermissionSetProvisioningStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPermissionSetProvisioningStatusRequest)

#endif // OAIListPermissionSetProvisioningStatusRequest_H
