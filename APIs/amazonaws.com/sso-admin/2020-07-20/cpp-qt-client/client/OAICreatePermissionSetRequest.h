...
/*
 * OAICreatePermissionSetRequest.h
 *
 * 
 */

#ifndef OAICreatePermissionSetRequest_H
#define OAICreatePermissionSetRequest_H
...
class OAICreatePermissionSetRequest : public OAIObject {
public:
    OAICreatePermissionSetRequest();
    OAICreatePermissionSetRequest(QString json);
    ~OAICreatePermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePermissionSetRequest)

#endif // OAICreatePermissionSetRequest_H
