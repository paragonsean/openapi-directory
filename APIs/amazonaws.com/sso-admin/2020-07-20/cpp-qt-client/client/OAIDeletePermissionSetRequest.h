...
/*
 * OAIDeletePermissionSetRequest.h
 *
 * 
 */

#ifndef OAIDeletePermissionSetRequest_H
#define OAIDeletePermissionSetRequest_H
...
class OAIDeletePermissionSetRequest : public OAIObject {
public:
    OAIDeletePermissionSetRequest();
    OAIDeletePermissionSetRequest(QString json);
    ~OAIDeletePermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePermissionSetRequest)

#endif // OAIDeletePermissionSetRequest_H
