...
/*
 * OAIProvisionPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIProvisionPermissionSetRequest_H
#define OAIProvisionPermissionSetRequest_H
...
class OAIProvisionPermissionSetRequest : public OAIObject {
public:
    OAIProvisionPermissionSetRequest();
    OAIProvisionPermissionSetRequest(QString json);
    ~OAIProvisionPermissionSetRequest() override;
    ...
    OAIProvisionTargetType getTargetType() const;
    void setTargetType(const OAIProvisionTargetType &target_type);
...
private:
    ...
    OAIProvisionTargetType m_target_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionPermissionSetRequest)

#endif // OAIProvisionPermissionSetRequest_H
