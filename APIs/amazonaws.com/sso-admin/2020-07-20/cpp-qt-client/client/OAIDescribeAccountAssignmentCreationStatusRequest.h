...
/*
 * OAIDescribeAccountAssignmentCreationStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribeAccountAssignmentCreationStatusRequest_H
#define OAIDescribeAccountAssignmentCreationStatusRequest_H
...
class OAIDescribeAccountAssignmentCreationStatusRequest : public OAIObject {
public:
    OAIDescribeAccountAssignmentCreationStatusRequest();
    OAIDescribeAccountAssignmentCreationStatusRequest(QString json);
    ~OAIDescribeAccountAssignmentCreationStatusRequest() override;
    ...
    QString getAccountAssignmentCreationRequestId() const;
    void setAccountAssignmentCreationRequestId(const QString &account_assignment_creation_request_id);
    bool is_account_assignment_creation_request_id_Set() const;
    bool is_account_assignment_creation_request_id_Valid() const;
...
private:
    ...
    QString m_account_assignment_creation_request_id;
    bool m_account_assignment_creation_request_id_isSet;
    bool m_account_assignment_creation_request_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountAssignmentCreationStatusRequest)

#endif // OAIDescribeAccountAssignmentCreationStatusRequest_H
