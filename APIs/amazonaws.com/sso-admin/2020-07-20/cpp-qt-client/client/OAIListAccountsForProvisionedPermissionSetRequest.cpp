...
OAIListAccountsForProvisionedPermissionSetRequest::OAIListAccountsForProvisionedPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountsForProvisionedPermissionSetRequest::OAIListAccountsForProvisionedPermissionSetRequest() {
    this->initializeModel();
}

OAIListAccountsForProvisionedPermissionSetRequest::~OAIListAccountsForProvisionedPermissionSetRequest() {}

void OAIListAccountsForProvisionedPermissionSetRequest::initializeModel() {
...
void OAIListAccountsForProvisionedPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIListAccountsForProvisionedPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListAccountsForProvisionedPermissionSetRequest::asJson() const {
...
QJsonObject OAIListAccountsForProvisionedPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListAccountsForProvisionedPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIListAccountsForProvisionedPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIListAccountsForProvisionedPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIListAccountsForProvisionedPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

OAIProvisioningStatus OAIListAccountsForProvisionedPermissionSetRequest::getProvisioningStatus() const {
    return m_provisioning_status;
}
void OAIListAccountsForProvisionedPermissionSetRequest::setProvisioningStatus(const OAIProvisioningStatus &provisioning_status) {
    m_provisioning_status = provisioning_status;
    m_provisioning_status_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_provisioning_status_Set() const{
    return m_provisioning_status_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_provisioning_status_Valid() const{
    return m_provisioning_status_isValid;
}

qint32 OAIListAccountsForProvisionedPermissionSetRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListAccountsForProvisionedPermissionSetRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListAccountsForProvisionedPermissionSetRequest::getNextToken() const {
    return m_next_token;
}
void OAIListAccountsForProvisionedPermissionSetRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAccountsForProvisionedPermissionSetRequest::isSet() const {
...
bool OAIListAccountsForProvisionedPermissionSetRequest::isValid() const {
