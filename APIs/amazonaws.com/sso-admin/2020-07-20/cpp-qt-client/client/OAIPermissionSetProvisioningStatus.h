...
/*
 * OAIPermissionSetProvisioningStatus.h
 *
 * A structure that is used to provide the status of the provisioning operation for a specified permission set.
 */

#ifndef OAIPermissionSetProvisioningStatus_H
#define OAIPermissionSetProvisioningStatus_H
...
class OAIPermissionSetProvisioningStatus : public OAIObject {
public:
    OAIPermissionSetProvisioningStatus();
    OAIPermissionSetProvisioningStatus(QString json);
    ~OAIPermissionSetProvisioningStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPermissionSetProvisioningStatus)

#endif // OAIPermissionSetProvisioningStatus_H
