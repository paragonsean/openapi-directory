...
/*
 * OAIListPermissionSetsRequest.h
 *
 * 
 */

#ifndef OAIListPermissionSetsRequest_H
#define OAIListPermissionSetsRequest_H
...
class OAIListPermissionSetsRequest : public OAIObject {
public:
    OAIListPermissionSetsRequest();
    OAIListPermissionSetsRequest(QString json);
    ~OAIListPermissionSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPermissionSetsRequest)

#endif // OAIListPermissionSetsRequest_H
