...
/*
 * OAIPutPermissionsBoundaryToPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIPutPermissionsBoundaryToPermissionSetRequest_H
#define OAIPutPermissionsBoundaryToPermissionSetRequest_H
...
namespace OpenAPI {
class OAIPutPermissionsBoundaryToPermissionSetRequest_PermissionsBoundary;

class OAIPutPermissionsBoundaryToPermissionSetRequest : public OAIObject {
public:
    OAIPutPermissionsBoundaryToPermissionSetRequest();
    OAIPutPermissionsBoundaryToPermissionSetRequest(QString json);
    ~OAIPutPermissionsBoundaryToPermissionSetRequest() override;
    ...
    OAIPutPermissionsBoundaryToPermissionSetRequest_PermissionsBoundary getPermissionsBoundary() const;
    void setPermissionsBoundary(const OAIPutPermissionsBoundaryToPermissionSetRequest_PermissionsBoundary &permissions_boundary);
    bool is_permissions_boundary_Set() const;
    bool is_permissions_boundary_Valid() const;
...
private:
    ...
    OAIPutPermissionsBoundaryToPermissionSetRequest_PermissionsBoundary m_permissions_boundary;
    bool m_permissions_boundary_isSet;
    bool m_permissions_boundary_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutPermissionsBoundaryToPermissionSetRequest)

#endif // OAIPutPermissionsBoundaryToPermissionSetRequest_H
