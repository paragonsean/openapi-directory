...
#include "OAIAccessControlAttributeValue.h"
...
OAIAccessControlAttributeValue::OAIAccessControlAttributeValue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccessControlAttributeValue::OAIAccessControlAttributeValue() {
    this->initializeModel();
}

OAIAccessControlAttributeValue::~OAIAccessControlAttributeValue() {}

void OAIAccessControlAttributeValue::initializeModel() {

    m_source_isSet = false;
    m_source_isValid = false;
}

void OAIAccessControlAttributeValue::fromJson(QString jsonString) {
...
void OAIAccessControlAttributeValue::fromJsonObject(QJsonObject json) {

    m_source_isValid = ::OpenAPI::fromJsonValue(m_source, json[QString("Source")]);
    m_source_isSet = !json[QString("Source")].isNull() && m_source_isValid;
}

QString OAIAccessControlAttributeValue::asJson() const {
...
QJsonObject OAIAccessControlAttributeValue::asJsonObject() const {
    QJsonObject obj;
    if (m_source.isSet()) {
...
QList OAIAccessControlAttributeValue::getSource() const {
    return m_source;
}
void OAIAccessControlAttributeValue::setSource(const QList &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIAccessControlAttributeValue::is_source_Set() const{
    return m_source_isSet;
}

bool OAIAccessControlAttributeValue::is_source_Valid() const{
    return m_source_isValid;
}

bool OAIAccessControlAttributeValue::isSet() const {
...
bool OAIAccessControlAttributeValue::isValid() const {
