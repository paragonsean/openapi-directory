...
#include "OAIOperationStatusFilter.h"
...
OAIOperationStatusFilter::OAIOperationStatusFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOperationStatusFilter::OAIOperationStatusFilter() {
    this->initializeModel();
}

OAIOperationStatusFilter::~OAIOperationStatusFilter() {}

void OAIOperationStatusFilter::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIOperationStatusFilter::fromJson(QString jsonString) {
...
void OAIOperationStatusFilter::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIOperationStatusFilter::asJson() const {
...
QJsonObject OAIOperationStatusFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIStatusValues OAIOperationStatusFilter::getStatus() const {
    return m_status;
}
void OAIOperationStatusFilter::setStatus(const OAIStatusValues &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOperationStatusFilter::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOperationStatusFilter::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIOperationStatusFilter::isSet() const {
...
bool OAIOperationStatusFilter::isValid() const {
