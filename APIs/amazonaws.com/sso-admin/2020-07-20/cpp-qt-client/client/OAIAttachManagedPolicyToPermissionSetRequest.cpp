...
OAIAttachManagedPolicyToPermissionSetRequest::OAIAttachManagedPolicyToPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttachManagedPolicyToPermissionSetRequest::OAIAttachManagedPolicyToPermissionSetRequest() {
    this->initializeModel();
}

OAIAttachManagedPolicyToPermissionSetRequest::~OAIAttachManagedPolicyToPermissionSetRequest() {}

void OAIAttachManagedPolicyToPermissionSetRequest::initializeModel() {
...
void OAIAttachManagedPolicyToPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIAttachManagedPolicyToPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAttachManagedPolicyToPermissionSetRequest::asJson() const {
...
QJsonObject OAIAttachManagedPolicyToPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttachManagedPolicyToPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIAttachManagedPolicyToPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIAttachManagedPolicyToPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIAttachManagedPolicyToPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

QString OAIAttachManagedPolicyToPermissionSetRequest::getManagedPolicyArn() const {
    return m_managed_policy_arn;
}
void OAIAttachManagedPolicyToPermissionSetRequest::setManagedPolicyArn(const QString &managed_policy_arn) {
    m_managed_policy_arn = managed_policy_arn;
    m_managed_policy_arn_isSet = true;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_managed_policy_arn_Set() const{
    return m_managed_policy_arn_isSet;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::is_managed_policy_arn_Valid() const{
    return m_managed_policy_arn_isValid;
}

bool OAIAttachManagedPolicyToPermissionSetRequest::isSet() const {
...
bool OAIAttachManagedPolicyToPermissionSetRequest::isValid() const {
