...
/*
 * OAIInstanceAccessControlAttributeConfiguration.h
 *
 * Specifies the attributes to add to your attribute-based access control (ABAC) configuration.
 */

#ifndef OAIInstanceAccessControlAttributeConfiguration_H
#define OAIInstanceAccessControlAttributeConfiguration_H
...
class OAIInstanceAccessControlAttributeConfiguration : public OAIObject {
public:
    OAIInstanceAccessControlAttributeConfiguration();
    OAIInstanceAccessControlAttributeConfiguration(QString json);
    ~OAIInstanceAccessControlAttributeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceAccessControlAttributeConfiguration)

#endif // OAIInstanceAccessControlAttributeConfiguration_H
