...
OAIDeletePermissionSetRequest::OAIDeletePermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePermissionSetRequest::OAIDeletePermissionSetRequest() {
    this->initializeModel();
}

OAIDeletePermissionSetRequest::~OAIDeletePermissionSetRequest() {}

void OAIDeletePermissionSetRequest::initializeModel() {
...
void OAIDeletePermissionSetRequest::fromJson(QString jsonString) {
...
void OAIDeletePermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePermissionSetRequest::asJson() const {
...
QJsonObject OAIDeletePermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIDeletePermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIDeletePermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIDeletePermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIDeletePermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIDeletePermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIDeletePermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIDeletePermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

bool OAIDeletePermissionSetRequest::isSet() const {
...
bool OAIDeletePermissionSetRequest::isValid() const {
