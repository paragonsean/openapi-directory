...
OAIListAccountsForProvisionedPermissionSetResponse::OAIListAccountsForProvisionedPermissionSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountsForProvisionedPermissionSetResponse::OAIListAccountsForProvisionedPermissionSetResponse() {
    this->initializeModel();
}

OAIListAccountsForProvisionedPermissionSetResponse::~OAIListAccountsForProvisionedPermissionSetResponse() {}

void OAIListAccountsForProvisionedPermissionSetResponse::initializeModel() {
...
void OAIListAccountsForProvisionedPermissionSetResponse::fromJson(QString jsonString) {
...
void OAIListAccountsForProvisionedPermissionSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListAccountsForProvisionedPermissionSetResponse::asJson() const {
...
QJsonObject OAIListAccountsForProvisionedPermissionSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListAccountsForProvisionedPermissionSetResponse::getAccountIds() const {
    return m_account_ids;
}
void OAIListAccountsForProvisionedPermissionSetResponse::setAccountIds(const QList &account_ids) {
    m_account_ids = account_ids;
    m_account_ids_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetResponse::is_account_ids_Set() const{
    return m_account_ids_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetResponse::is_account_ids_Valid() const{
    return m_account_ids_isValid;
}

QString OAIListAccountsForProvisionedPermissionSetResponse::getNextToken() const {
    return m_next_token;
}
void OAIListAccountsForProvisionedPermissionSetResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAccountsForProvisionedPermissionSetResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAccountsForProvisionedPermissionSetResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAccountsForProvisionedPermissionSetResponse::isSet() const {
...
bool OAIListAccountsForProvisionedPermissionSetResponse::isValid() const {
