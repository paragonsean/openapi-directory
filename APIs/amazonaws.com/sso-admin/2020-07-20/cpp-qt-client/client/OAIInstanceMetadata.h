...
/*
 * OAIInstanceMetadata.h
 *
 * Provides information about the IAM Identity Center instance.
 */

#ifndef OAIInstanceMetadata_H
#define OAIInstanceMetadata_H
...
class OAIInstanceMetadata : public OAIObject {
public:
    OAIInstanceMetadata();
    OAIInstanceMetadata(QString json);
    ~OAIInstanceMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceMetadata)

#endif // OAIInstanceMetadata_H
