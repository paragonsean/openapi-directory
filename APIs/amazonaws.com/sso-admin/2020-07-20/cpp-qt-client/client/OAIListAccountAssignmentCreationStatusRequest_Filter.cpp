...
OAIListAccountAssignmentCreationStatusRequest_Filter::OAIListAccountAssignmentCreationStatusRequest_Filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAccountAssignmentCreationStatusRequest_Filter::OAIListAccountAssignmentCreationStatusRequest_Filter() {
    this->initializeModel();
}

OAIListAccountAssignmentCreationStatusRequest_Filter::~OAIListAccountAssignmentCreationStatusRequest_Filter() {}

void OAIListAccountAssignmentCreationStatusRequest_Filter::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIListAccountAssignmentCreationStatusRequest_Filter::fromJson(QString jsonString) {
...
void OAIListAccountAssignmentCreationStatusRequest_Filter::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIListAccountAssignmentCreationStatusRequest_Filter::asJson() const {
...
QJsonObject OAIListAccountAssignmentCreationStatusRequest_Filter::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIStatusValues OAIListAccountAssignmentCreationStatusRequest_Filter::getStatus() const {
    return m_status;
}
void OAIListAccountAssignmentCreationStatusRequest_Filter::setStatus(const OAIStatusValues &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIListAccountAssignmentCreationStatusRequest_Filter::is_status_Set() const{
    return m_status_isSet;
}

bool OAIListAccountAssignmentCreationStatusRequest_Filter::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIListAccountAssignmentCreationStatusRequest_Filter::isSet() const {
...
bool OAIListAccountAssignmentCreationStatusRequest_Filter::isValid() const {
