...
/*
 * OAIGetInlinePolicyForPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIGetInlinePolicyForPermissionSetRequest_H
#define OAIGetInlinePolicyForPermissionSetRequest_H
...
class OAIGetInlinePolicyForPermissionSetRequest : public OAIObject {
public:
    OAIGetInlinePolicyForPermissionSetRequest();
    OAIGetInlinePolicyForPermissionSetRequest(QString json);
    ~OAIGetInlinePolicyForPermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInlinePolicyForPermissionSetRequest)

#endif // OAIGetInlinePolicyForPermissionSetRequest_H
