...
OAIListPermissionSetsRequest::OAIListPermissionSetsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPermissionSetsRequest::OAIListPermissionSetsRequest() {
    this->initializeModel();
}

OAIListPermissionSetsRequest::~OAIListPermissionSetsRequest() {}

void OAIListPermissionSetsRequest::initializeModel() {
...
void OAIListPermissionSetsRequest::fromJson(QString jsonString) {
...
void OAIListPermissionSetsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListPermissionSetsRequest::asJson() const {
...
QJsonObject OAIListPermissionSetsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPermissionSetsRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIListPermissionSetsRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIListPermissionSetsRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIListPermissionSetsRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIListPermissionSetsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListPermissionSetsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPermissionSetsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPermissionSetsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPermissionSetsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListPermissionSetsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPermissionSetsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPermissionSetsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListPermissionSetsRequest::isSet() const {
...
bool OAIListPermissionSetsRequest::isValid() const {
