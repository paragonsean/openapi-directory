...
/*
 * OAIAccountAssignmentOperationStatusMetadata.h
 *
 * Provides information about the &lt;a&gt;AccountAssignment&lt;/a&gt; creation request.
 */

#ifndef OAIAccountAssignmentOperationStatusMetadata_H
#define OAIAccountAssignmentOperationStatusMetadata_H
...
class OAIAccountAssignmentOperationStatusMetadata : public OAIObject {
public:
    OAIAccountAssignmentOperationStatusMetadata();
    OAIAccountAssignmentOperationStatusMetadata(QString json);
    ~OAIAccountAssignmentOperationStatusMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountAssignmentOperationStatusMetadata)

#endif // OAIAccountAssignmentOperationStatusMetadata_H
