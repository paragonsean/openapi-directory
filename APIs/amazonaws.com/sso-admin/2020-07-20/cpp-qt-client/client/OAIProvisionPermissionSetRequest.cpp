...
OAIProvisionPermissionSetRequest::OAIProvisionPermissionSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisionPermissionSetRequest::OAIProvisionPermissionSetRequest() {
    this->initializeModel();
}

OAIProvisionPermissionSetRequest::~OAIProvisionPermissionSetRequest() {}

void OAIProvisionPermissionSetRequest::initializeModel() {
...
void OAIProvisionPermissionSetRequest::fromJson(QString jsonString) {
...
void OAIProvisionPermissionSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIProvisionPermissionSetRequest::asJson() const {
...
QJsonObject OAIProvisionPermissionSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIProvisionPermissionSetRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIProvisionPermissionSetRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIProvisionPermissionSetRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIProvisionPermissionSetRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

QString OAIProvisionPermissionSetRequest::getPermissionSetArn() const {
    return m_permission_set_arn;
}
void OAIProvisionPermissionSetRequest::setPermissionSetArn(const QString &permission_set_arn) {
    m_permission_set_arn = permission_set_arn;
    m_permission_set_arn_isSet = true;
}

bool OAIProvisionPermissionSetRequest::is_permission_set_arn_Set() const{
    return m_permission_set_arn_isSet;
}

bool OAIProvisionPermissionSetRequest::is_permission_set_arn_Valid() const{
    return m_permission_set_arn_isValid;
}

QString OAIProvisionPermissionSetRequest::getTargetId() const {
    return m_target_id;
}
void OAIProvisionPermissionSetRequest::setTargetId(const QString &target_id) {
    m_target_id = target_id;
    m_target_id_isSet = true;
}

bool OAIProvisionPermissionSetRequest::is_target_id_Set() const{
    return m_target_id_isSet;
}

bool OAIProvisionPermissionSetRequest::is_target_id_Valid() const{
    return m_target_id_isValid;
}

OAIProvisionTargetType OAIProvisionPermissionSetRequest::getTargetType() const {
    return m_target_type;
}
void OAIProvisionPermissionSetRequest::setTargetType(const OAIProvisionTargetType &target_type) {
    m_target_type = target_type;
    m_target_type_isSet = true;
}

bool OAIProvisionPermissionSetRequest::is_target_type_Set() const{
    return m_target_type_isSet;
}

bool OAIProvisionPermissionSetRequest::is_target_type_Valid() const{
    return m_target_type_isValid;
}

bool OAIProvisionPermissionSetRequest::isSet() const {
...
bool OAIProvisionPermissionSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_instance_arn_isValid && m_permission_set_arn_isValid && m_target_type_isValid && true;
}
