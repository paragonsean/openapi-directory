...
/*
 * OAIListPermissionSetsResponse.h
 *
 * 
 */

#ifndef OAIListPermissionSetsResponse_H
#define OAIListPermissionSetsResponse_H
...
class OAIListPermissionSetsResponse : public OAIObject {
public:
    OAIListPermissionSetsResponse();
    OAIListPermissionSetsResponse(QString json);
    ~OAIListPermissionSetsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPermissionSetsResponse)

#endif // OAIListPermissionSetsResponse_H
