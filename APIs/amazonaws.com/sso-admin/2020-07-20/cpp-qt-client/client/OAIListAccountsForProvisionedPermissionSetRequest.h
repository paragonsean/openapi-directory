...
/*
 * OAIListAccountsForProvisionedPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIListAccountsForProvisionedPermissionSetRequest_H
#define OAIListAccountsForProvisionedPermissionSetRequest_H
...
class OAIListAccountsForProvisionedPermissionSetRequest : public OAIObject {
public:
    OAIListAccountsForProvisionedPermissionSetRequest();
    OAIListAccountsForProvisionedPermissionSetRequest(QString json);
    ~OAIListAccountsForProvisionedPermissionSetRequest() override;
    ...
    OAIProvisioningStatus getProvisioningStatus() const;
    void setProvisioningStatus(const OAIProvisioningStatus &provisioning_status);
...
private:
    ...
    OAIProvisioningStatus m_provisioning_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountsForProvisionedPermissionSetRequest)

#endif // OAIListAccountsForProvisionedPermissionSetRequest_H
