...
/*
 * OAICreatePermissionSetResponse.h
 *
 * 
 */

#ifndef OAICreatePermissionSetResponse_H
#define OAICreatePermissionSetResponse_H

#include <QJsonObject>

#include "OAICreatePermissionSetResponse_PermissionSet.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreatePermissionSetResponse_PermissionSet;

class OAICreatePermissionSetResponse : public OAIObject {
public:
    OAICreatePermissionSetResponse();
    OAICreatePermissionSetResponse(QString json);
    ~OAICreatePermissionSetResponse() override;
    ...
    OAICreatePermissionSetResponse_PermissionSet getPermissionSet() const;
    void setPermissionSet(const OAICreatePermissionSetResponse_PermissionSet &permission_set);
...
private:
    ...
    OAICreatePermissionSetResponse_PermissionSet m_permission_set;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePermissionSetResponse)

#endif // OAICreatePermissionSetResponse_H
