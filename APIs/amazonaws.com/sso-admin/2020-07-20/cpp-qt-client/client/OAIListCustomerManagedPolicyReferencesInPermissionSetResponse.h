...
/*
 * OAIListCustomerManagedPolicyReferencesInPermissionSetResponse.h
 *
 * 
 */

#ifndef OAIListCustomerManagedPolicyReferencesInPermissionSetResponse_H
#define OAIListCustomerManagedPolicyReferencesInPermissionSetResponse_H
...
class OAIListCustomerManagedPolicyReferencesInPermissionSetResponse : public OAIObject {
public:
    OAIListCustomerManagedPolicyReferencesInPermissionSetResponse();
    OAIListCustomerManagedPolicyReferencesInPermissionSetResponse(QString json);
    ~OAIListCustomerManagedPolicyReferencesInPermissionSetResponse() override;
    ...
    QList getCustomerManagedPolicyReferences() const;
    void setCustomerManagedPolicyReferences(const QList &customer_managed_policy_references);
    bool is_customer_managed_policy_references_Set() const;
    bool is_customer_managed_policy_references_Valid() const;
...
private:
    ...
    QList m_customer_managed_policy_references;
    bool m_customer_managed_policy_references_isSet;
    bool m_customer_managed_policy_references_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListCustomerManagedPolicyReferencesInPermissionSetResponse)

#endif // OAIListCustomerManagedPolicyReferencesInPermissionSetResponse_H
