...
OAIDescribeInstanceAccessControlAttributeConfigurationRequest::OAIDescribeInstanceAccessControlAttributeConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeInstanceAccessControlAttributeConfigurationRequest::OAIDescribeInstanceAccessControlAttributeConfigurationRequest() {
    this->initializeModel();
}

OAIDescribeInstanceAccessControlAttributeConfigurationRequest::~OAIDescribeInstanceAccessControlAttributeConfigurationRequest() {}

void OAIDescribeInstanceAccessControlAttributeConfigurationRequest::initializeModel() {

    m_instance_arn_isSet = false;
    m_instance_arn_isValid = false;
}

void OAIDescribeInstanceAccessControlAttributeConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDescribeInstanceAccessControlAttributeConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeInstanceAccessControlAttributeConfigurationRequest::asJson() const {
...
QJsonObject OAIDescribeInstanceAccessControlAttributeConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeInstanceAccessControlAttributeConfigurationRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIDescribeInstanceAccessControlAttributeConfigurationRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIDescribeInstanceAccessControlAttributeConfigurationRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIDescribeInstanceAccessControlAttributeConfigurationRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

bool OAIDescribeInstanceAccessControlAttributeConfigurationRequest::isSet() const {
...
bool OAIDescribeInstanceAccessControlAttributeConfigurationRequest::isValid() const {
