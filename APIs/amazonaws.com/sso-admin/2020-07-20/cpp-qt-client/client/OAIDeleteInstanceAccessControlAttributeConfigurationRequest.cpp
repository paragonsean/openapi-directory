...
OAIDeleteInstanceAccessControlAttributeConfigurationRequest::OAIDeleteInstanceAccessControlAttributeConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteInstanceAccessControlAttributeConfigurationRequest::OAIDeleteInstanceAccessControlAttributeConfigurationRequest() {
    this->initializeModel();
}

OAIDeleteInstanceAccessControlAttributeConfigurationRequest::~OAIDeleteInstanceAccessControlAttributeConfigurationRequest() {}

void OAIDeleteInstanceAccessControlAttributeConfigurationRequest::initializeModel() {

    m_instance_arn_isSet = false;
    m_instance_arn_isValid = false;
}

void OAIDeleteInstanceAccessControlAttributeConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDeleteInstanceAccessControlAttributeConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteInstanceAccessControlAttributeConfigurationRequest::asJson() const {
...
QJsonObject OAIDeleteInstanceAccessControlAttributeConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteInstanceAccessControlAttributeConfigurationRequest::getInstanceArn() const {
    return m_instance_arn;
}
void OAIDeleteInstanceAccessControlAttributeConfigurationRequest::setInstanceArn(const QString &instance_arn) {
    m_instance_arn = instance_arn;
    m_instance_arn_isSet = true;
}

bool OAIDeleteInstanceAccessControlAttributeConfigurationRequest::is_instance_arn_Set() const{
    return m_instance_arn_isSet;
}

bool OAIDeleteInstanceAccessControlAttributeConfigurationRequest::is_instance_arn_Valid() const{
    return m_instance_arn_isValid;
}

bool OAIDeleteInstanceAccessControlAttributeConfigurationRequest::isSet() const {
...
bool OAIDeleteInstanceAccessControlAttributeConfigurationRequest::isValid() const {
