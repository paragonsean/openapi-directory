...
/*
 * OAIDescribeAccountAssignmentDeletionStatusResponse.h
 *
 * 
 */

#ifndef OAIDescribeAccountAssignmentDeletionStatusResponse_H
#define OAIDescribeAccountAssignmentDeletionStatusResponse_H
...
class OAIDescribeAccountAssignmentDeletionStatusResponse : public OAIObject {
public:
    OAIDescribeAccountAssignmentDeletionStatusResponse();
    OAIDescribeAccountAssignmentDeletionStatusResponse(QString json);
    ~OAIDescribeAccountAssignmentDeletionStatusResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAccountAssignmentDeletionStatusResponse)

#endif // OAIDescribeAccountAssignmentDeletionStatusResponse_H
