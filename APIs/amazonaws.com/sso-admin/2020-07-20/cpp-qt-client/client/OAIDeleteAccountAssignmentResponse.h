...
/*
 * OAIDeleteAccountAssignmentResponse.h
 *
 * 
 */

#ifndef OAIDeleteAccountAssignmentResponse_H
#define OAIDeleteAccountAssignmentResponse_H
...
namespace OpenAPI {
class OAIDeleteAccountAssignmentResponse_AccountAssignmentDeletionStatus;

class OAIDeleteAccountAssignmentResponse : public OAIObject {
public:
    OAIDeleteAccountAssignmentResponse();
    OAIDeleteAccountAssignmentResponse(QString json);
    ~OAIDeleteAccountAssignmentResponse() override;
    ...
    OAIDeleteAccountAssignmentResponse_AccountAssignmentDeletionStatus getAccountAssignmentDeletionStatus() const;
    void setAccountAssignmentDeletionStatus(const OAIDeleteAccountAssignmentResponse_AccountAssignmentDeletionStatus &account_assignment_deletion_status);
    bool is_account_assignment_deletion_status_Set() const;
    bool is_account_assignment_deletion_status_Valid() const;
...
private:
    ...
    OAIDeleteAccountAssignmentResponse_AccountAssignmentDeletionStatus m_account_assignment_deletion_status;
    bool m_account_assignment_deletion_status_isSet;
    bool m_account_assignment_deletion_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAccountAssignmentResponse)

#endif // OAIDeleteAccountAssignmentResponse_H
