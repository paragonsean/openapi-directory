...
/*
 * OAIAccessControlAttribute_Value.h
 *
 * 
 */

#ifndef OAIAccessControlAttribute_Value_H
#define OAIAccessControlAttribute_Value_H
...
class OAIAccessControlAttribute_Value : public OAIObject {
public:
    OAIAccessControlAttribute_Value();
    OAIAccessControlAttribute_Value(QString json);
    ~OAIAccessControlAttribute_Value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessControlAttribute_Value)

#endif // OAIAccessControlAttribute_Value_H
