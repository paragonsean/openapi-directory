...
/*
 * OAIUpdatePermissionSetRequest.h
 *
 * 
 */

#ifndef OAIUpdatePermissionSetRequest_H
#define OAIUpdatePermissionSetRequest_H
...
class OAIUpdatePermissionSetRequest : public OAIObject {
public:
    OAIUpdatePermissionSetRequest();
    OAIUpdatePermissionSetRequest(QString json);
    ~OAIUpdatePermissionSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePermissionSetRequest)

#endif // OAIUpdatePermissionSetRequest_H
