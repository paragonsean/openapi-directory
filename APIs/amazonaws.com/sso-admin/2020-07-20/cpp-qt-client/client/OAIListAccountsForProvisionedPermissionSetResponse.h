...
/*
 * OAIListAccountsForProvisionedPermissionSetResponse.h
 *
 * 
 */

#ifndef OAIListAccountsForProvisionedPermissionSetResponse_H
#define OAIListAccountsForProvisionedPermissionSetResponse_H
...
class OAIListAccountsForProvisionedPermissionSetResponse : public OAIObject {
public:
    OAIListAccountsForProvisionedPermissionSetResponse();
    OAIListAccountsForProvisionedPermissionSetResponse(QString json);
    ~OAIListAccountsForProvisionedPermissionSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountsForProvisionedPermissionSetResponse)

#endif // OAIListAccountsForProvisionedPermissionSetResponse_H
