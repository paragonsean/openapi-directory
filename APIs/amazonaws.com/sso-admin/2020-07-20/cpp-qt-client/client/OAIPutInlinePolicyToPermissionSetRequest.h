...
/*
 * OAIPutInlinePolicyToPermissionSetRequest.h
 *
 * 
 */

#ifndef OAIPutInlinePolicyToPermissionSetRequest_H
#define OAIPutInlinePolicyToPermissionSetRequest_H
...
class OAIPutInlinePolicyToPermissionSetRequest : public OAIObject {
public:
    OAIPutInlinePolicyToPermissionSetRequest();
    OAIPutInlinePolicyToPermissionSetRequest(QString json);
    ~OAIPutInlinePolicyToPermissionSetRequest() override;
    ...
    QString getInlinePolicy() const;
    void setInlinePolicy(const QString &inline_policy);
    bool is_inline_policy_Set() const;
    bool is_inline_policy_Valid() const;
...
private:
    ...
    QString m_inline_policy;
    bool m_inline_policy_isSet;
    bool m_inline_policy_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutInlinePolicyToPermissionSetRequest)

#endif // OAIPutInlinePolicyToPermissionSetRequest_H
