...
/*
 * OAICreatePermissionSetResponse_PermissionSet.h
 *
 * 
 */

#ifndef OAICreatePermissionSetResponse_PermissionSet_H
#define OAICreatePermissionSetResponse_PermissionSet_H
...
class OAICreatePermissionSetResponse_PermissionSet : public OAIObject {
public:
    OAICreatePermissionSetResponse_PermissionSet();
    OAICreatePermissionSetResponse_PermissionSet(QString json);
    ~OAICreatePermissionSetResponse_PermissionSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePermissionSetResponse_PermissionSet)

#endif // OAICreatePermissionSetResponse_PermissionSet_H
