...
/*
 * OAIListAccountAssignmentCreationStatusResponse.h
 *
 * 
 */

#ifndef OAIListAccountAssignmentCreationStatusResponse_H
#define OAIListAccountAssignmentCreationStatusResponse_H
...
class OAIListAccountAssignmentCreationStatusResponse : public OAIObject {
public:
    OAIListAccountAssignmentCreationStatusResponse();
    OAIListAccountAssignmentCreationStatusResponse(QString json);
    ~OAIListAccountAssignmentCreationStatusResponse() override;
    ...
    QList getAccountAssignmentsCreationStatus() const;
    void setAccountAssignmentsCreationStatus(const QList &account_assignments_creation_status);
    bool is_account_assignments_creation_status_Set() const;
    bool is_account_assignments_creation_status_Valid() const;
...
private:
    ...
    QList m_account_assignments_creation_status;
    bool m_account_assignments_creation_status_isSet;
    bool m_account_assignments_creation_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAccountAssignmentCreationStatusResponse)

#endif // OAIListAccountAssignmentCreationStatusResponse_H
