...
#ifndef OAITargetType_H
#define OAITargetType_H
...
class OAITargetType : public OAIEnum {
public:
    OAITargetType();
    OAITargetType(QString json);
    ~OAITargetType() override;
    ...
    enum class eOAITargetType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS_ACCOUNT
    };
    OAITargetType::eOAITargetType getValue() const;
    void setValue(const OAITargetType::eOAITargetType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetType)

#endif // OAITargetType_H
