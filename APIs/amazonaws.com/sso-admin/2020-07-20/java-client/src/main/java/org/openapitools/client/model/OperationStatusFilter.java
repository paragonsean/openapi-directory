...
public class OperationStatusFilter {
  ...
  public OperationStatusFilter status(StatusValues status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OperationStatusFilter operationStatusFilter = (OperationStatusFilter) o;
    return Objects.equals(this.status, operationStatusFilter.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OperationStatusFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OperationStatusFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OperationStatusFilter is not found in the empty JSON string", OperationStatusFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OperationStatusFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OperationStatusFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OperationStatusFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OperationStatusFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OperationStatusFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OperationStatusFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<OperationStatusFilter>() {
           @Override
           public void write(JsonWriter out, OperationStatusFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OperationStatusFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OperationStatusFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OperationStatusFilter
   * @throws IOException if the JSON string is invalid with respect to OperationStatusFilter
   */
  public static OperationStatusFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OperationStatusFilter.class);
  }

  /**
   * Convert an instance of OperationStatusFilter to an JSON string
   *
   * @return JSON string
   */
