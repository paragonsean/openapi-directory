 ...
 */
@JsonAdapter(StatusValues.Adapter.class)
public enum StatusValues {
  ...
  public static StatusValues fromValue(String value) {
    for (StatusValues b : StatusValues.values()) {
  ...
  public static class Adapter extends TypeAdapter<StatusValues> {
    @Override
    public void write(final JsonWriter jsonWriter, final StatusValues enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StatusValues read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StatusValues.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StatusValues.fromValue(value);
  }
}
