...
public class DeleteAccountAssignmentRequest {
  ...
  public DeleteAccountAssignmentRequest() {
  }

  public DeleteAccountAssignmentRequest instanceArn(String instanceArn) {
  ...
  public DeleteAccountAssignmentRequest targetType(TargetType targetType) {
  ...
  public DeleteAccountAssignmentRequest permissionSetArn(String permissionSetArn) {
  ...
  public DeleteAccountAssignmentRequest principalType(PrincipalType principalType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instanceArn, deleteAccountAssignmentRequest.instanceArn) &&
        Objects.equals(this.targetId, deleteAccountAssignmentRequest.targetId) &&
        Objects.equals(this.targetType, deleteAccountAssignmentRequest.targetType) &&
        Objects.equals(this.permissionSetArn, deleteAccountAssignmentRequest.permissionSetArn) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccountAssignmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccountAssignmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccountAssignmentRequest is not found in the empty JSON string", DeleteAccountAssignmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccountAssignmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccountAssignmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAccountAssignmentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccountAssignmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccountAssignmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccountAssignmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccountAssignmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccountAssignmentRequest>() {
           @Override
           public void write(JsonWriter out, DeleteAccountAssignmentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccountAssignmentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccountAssignmentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccountAssignmentRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteAccountAssignmentRequest
   */
  public static DeleteAccountAssignmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccountAssignmentRequest.class);
  }

  /**
   * Convert an instance of DeleteAccountAssignmentRequest to an JSON string
   *
   * @return JSON string
   */
