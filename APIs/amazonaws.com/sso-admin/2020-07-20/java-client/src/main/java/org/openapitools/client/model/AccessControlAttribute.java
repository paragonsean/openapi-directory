...
public class AccessControlAttribute {
  ...
  public AccessControlAttribute key(String key) {
    this.key = key;
    return this;
  }
  ...
  public AccessControlAttribute value(AccessControlAttributeValue value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccessControlAttribute accessControlAttribute = (AccessControlAttribute) o;
    return Objects.equals(this.key, accessControlAttribute.key) &&
        Objects.equals(this.value, accessControlAttribute.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessControlAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessControlAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessControlAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessControlAttribute is not found in the empty JSON string", AccessControlAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessControlAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessControlAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessControlAttribute.openapiRequiredFields) {
      ...
      AccessControlAttributeValue.validateJsonElement(jsonObj.get("Value"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessControlAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessControlAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessControlAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessControlAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessControlAttribute>() {
           @Override
           public void write(JsonWriter out, AccessControlAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessControlAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessControlAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessControlAttribute
   * @throws IOException if the JSON string is invalid with respect to AccessControlAttribute
   */
  public static AccessControlAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessControlAttribute.class);
  }

  /**
   * Convert an instance of AccessControlAttribute to an JSON string
   *
   * @return JSON string
   */
