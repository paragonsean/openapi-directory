...
public class AccountAssignmentOperationStatus {
  ...
  public AccountAssignmentOperationStatus status(StatusValues status) {
    this.status = status;
    return this;
  }
  ...
  public AccountAssignmentOperationStatus requestId(String requestId) {
  ...
  public AccountAssignmentOperationStatus failureReason(String failureReason) {
  ...
  public AccountAssignmentOperationStatus targetId(String targetId) {
  ...
  public AccountAssignmentOperationStatus targetType(TargetType targetType) {
  ...
  public AccountAssignmentOperationStatus permissionSetArn(String permissionSetArn) {
  ...
  public AccountAssignmentOperationStatus principalType(PrincipalType principalType) {
  ...
  public AccountAssignmentOperationStatus principalId(String principalId) {
  ...
  public AccountAssignmentOperationStatus createdDate(OffsetDateTime createdDate) {
  ...
  public boolean equals(Object o) {
    ...
    AccountAssignmentOperationStatus accountAssignmentOperationStatus = (AccountAssignmentOperationStatus) o;
    return Objects.equals(this.status, accountAssignmentOperationStatus.status) &&
        Objects.equals(this.requestId, accountAssignmentOperationStatus.requestId) &&
        Objects.equals(this.failureReason, accountAssignmentOperationStatus.failureReason) &&
        Objects.equals(this.targetId, accountAssignmentOperationStatus.targetId) &&
        Objects.equals(this.targetType, accountAssignmentOperationStatus.targetType) &&
        Objects.equals(this.permissionSetArn, accountAssignmentOperationStatus.permissionSetArn) &&
        Objects.equals(this.principalType, accountAssignmentOperationStatus.principalType) &&
        Objects.equals(this.principalId, accountAssignmentOperationStatus.principalId) &&
        Objects.equals(this.createdDate, accountAssignmentOperationStatus.createdDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountAssignmentOperationStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountAssignmentOperationStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountAssignmentOperationStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountAssignmentOperationStatus is not found in the empty JSON string", AccountAssignmentOperationStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountAssignmentOperationStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountAssignmentOperationStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountAssignmentOperationStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountAssignmentOperationStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountAssignmentOperationStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountAssignmentOperationStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountAssignmentOperationStatus>() {
           @Override
           public void write(JsonWriter out, AccountAssignmentOperationStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountAssignmentOperationStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountAssignmentOperationStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountAssignmentOperationStatus
   * @throws IOException if the JSON string is invalid with respect to AccountAssignmentOperationStatus
   */
  public static AccountAssignmentOperationStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountAssignmentOperationStatus.class);
  }

  /**
   * Convert an instance of AccountAssignmentOperationStatus to an JSON string
   *
   * @return JSON string
   */
