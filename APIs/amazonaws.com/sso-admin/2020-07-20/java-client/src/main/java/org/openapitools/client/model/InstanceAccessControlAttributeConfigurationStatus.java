...
/**
 * Gets or Sets InstanceAccessControlAttributeConfigurationStatus
 */
@JsonAdapter(InstanceAccessControlAttributeConfigurationStatus.Adapter.class)
public enum InstanceAccessControlAttributeConfigurationStatus {
  ...
  InstanceAccessControlAttributeConfigurationStatus(String value) {
    this.value = value;
  }
  ...
  public static InstanceAccessControlAttributeConfigurationStatus fromValue(String value) {
    for (InstanceAccessControlAttributeConfigurationStatus b : InstanceAccessControlAttributeConfigurationStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<InstanceAccessControlAttributeConfigurationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final InstanceAccessControlAttributeConfigurationStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public InstanceAccessControlAttributeConfigurationStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return InstanceAccessControlAttributeConfigurationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    InstanceAccessControlAttributeConfigurationStatus.fromValue(value);
  }
}
