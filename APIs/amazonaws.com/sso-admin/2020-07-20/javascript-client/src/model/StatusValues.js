...
* @readonly
*/
export default class StatusValues {
    ...
    /**
    * Returns a <code>StatusValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StatusValues} The enum <code>StatusValues</code> value.
    */
