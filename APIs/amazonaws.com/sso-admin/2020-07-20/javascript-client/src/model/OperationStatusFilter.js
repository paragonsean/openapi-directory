...
/**
 * The OperationStatusFilter model module.
 * @module model/OperationStatusFilter
 * @version 2020-07-20
 */
class OperationStatusFilter {
    /**
     * Constructs a new <code>OperationStatusFilter</code>.
     * Filters he operation status list based on the passed attribute value.
     * @alias module:model/OperationStatusFilter
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>OperationStatusFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OperationStatusFilter} obj Optional instance to populate.
     * @return {module:model/OperationStatusFilter} The populated <code>OperationStatusFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationStatusFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>OperationStatusFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OperationStatusFilter</code>.
     */
...
export default OperationStatusFilter;
