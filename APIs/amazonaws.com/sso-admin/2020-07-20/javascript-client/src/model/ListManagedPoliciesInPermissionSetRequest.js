...
/**
 * The ListManagedPoliciesInPermissionSetRequest model module.
 * @module model/ListManagedPoliciesInPermissionSetRequest
 * @version 2020-07-20
 */
class ListManagedPoliciesInPermissionSetRequest {
    /**
     * Constructs a new <code>ListManagedPoliciesInPermissionSetRequest</code>.
     * @alias module:model/ListManagedPoliciesInPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        ListManagedPoliciesInPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>ListManagedPoliciesInPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListManagedPoliciesInPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/ListManagedPoliciesInPermissionSetRequest} The populated <code>ListManagedPoliciesInPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListManagedPoliciesInPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListManagedPoliciesInPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListManagedPoliciesInPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListManagedPoliciesInPermissionSetRequest.RequiredProperties) {
...
ListManagedPoliciesInPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
ListManagedPoliciesInPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
ListManagedPoliciesInPermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListManagedPoliciesInPermissionSetRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListManagedPoliciesInPermissionSetRequest.prototype['NextToken'] = undefined;
...
export default ListManagedPoliciesInPermissionSetRequest;
