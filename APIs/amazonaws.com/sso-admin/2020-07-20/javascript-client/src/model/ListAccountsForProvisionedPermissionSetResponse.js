...
/**
 * The ListAccountsForProvisionedPermissionSetResponse model module.
 * @module model/ListAccountsForProvisionedPermissionSetResponse
 * @version 2020-07-20
 */
class ListAccountsForProvisionedPermissionSetResponse {
    /**
     * Constructs a new <code>ListAccountsForProvisionedPermissionSetResponse</code>.
     * @alias module:model/ListAccountsForProvisionedPermissionSetResponse
     */
    constructor() { 
        
        ListAccountsForProvisionedPermissionSetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAccountsForProvisionedPermissionSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountsForProvisionedPermissionSetResponse} obj Optional instance to populate.
     * @return {module:model/ListAccountsForProvisionedPermissionSetResponse} The populated <code>ListAccountsForProvisionedPermissionSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountsForProvisionedPermissionSetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountsForProvisionedPermissionSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountsForProvisionedPermissionSetResponse</code>.
     */
 ...
 */
ListAccountsForProvisionedPermissionSetResponse.prototype['AccountIds'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountsForProvisionedPermissionSetResponse.prototype['NextToken'] = undefined;
...
export default ListAccountsForProvisionedPermissionSetResponse;
