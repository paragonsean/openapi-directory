...
/**
 * The ListPermissionSetsRequest model module.
 * @module model/ListPermissionSetsRequest
 * @version 2020-07-20
 */
class ListPermissionSetsRequest {
    /**
     * Constructs a new <code>ListPermissionSetsRequest</code>.
     * @alias module:model/ListPermissionSetsRequest
     * @param instanceArn {String} 
     */
    constructor(instanceArn) { 
        
        ListPermissionSetsRequest.initialize(this, instanceArn);
    }
    ...
    /**
     * Constructs a <code>ListPermissionSetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPermissionSetsRequest} obj Optional instance to populate.
     * @return {module:model/ListPermissionSetsRequest} The populated <code>ListPermissionSetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPermissionSetsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPermissionSetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPermissionSetsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPermissionSetsRequest.RequiredProperties) {
...
ListPermissionSetsRequest.RequiredProperties = ["InstanceArn"];

/**
 * @member {String} InstanceArn
 */
ListPermissionSetsRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} NextToken
 */
ListPermissionSetsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListPermissionSetsRequest.prototype['MaxResults'] = undefined;
...
export default ListPermissionSetsRequest;
