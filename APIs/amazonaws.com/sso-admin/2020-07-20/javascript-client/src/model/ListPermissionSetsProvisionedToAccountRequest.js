...
/**
 * The ListPermissionSetsProvisionedToAccountRequest model module.
 * @module model/ListPermissionSetsProvisionedToAccountRequest
 * @version 2020-07-20
 */
class ListPermissionSetsProvisionedToAccountRequest {
    /**
     * Constructs a new <code>ListPermissionSetsProvisionedToAccountRequest</code>.
     * @alias module:model/ListPermissionSetsProvisionedToAccountRequest
     * @param instanceArn {String} 
     * @param accountId {String} 
     */
    constructor(instanceArn, accountId) { 
        
        ListPermissionSetsProvisionedToAccountRequest.initialize(this, instanceArn, accountId);
    }
     ...
     */
    static initialize(obj, instanceArn, accountId) { 
        obj['InstanceArn'] = instanceArn;
        obj['AccountId'] = accountId;
    }

    /**
     * Constructs a <code>ListPermissionSetsProvisionedToAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPermissionSetsProvisionedToAccountRequest} obj Optional instance to populate.
     * @return {module:model/ListPermissionSetsProvisionedToAccountRequest} The populated <code>ListPermissionSetsProvisionedToAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPermissionSetsProvisionedToAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPermissionSetsProvisionedToAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPermissionSetsProvisionedToAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPermissionSetsProvisionedToAccountRequest.RequiredProperties) {
...
ListPermissionSetsProvisionedToAccountRequest.RequiredProperties = ["InstanceArn", "AccountId"];

/**
 * @member {String} InstanceArn
 */
ListPermissionSetsProvisionedToAccountRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} AccountId
 */
ListPermissionSetsProvisionedToAccountRequest.prototype['AccountId'] = undefined;

/**
 * @member {module:model/ProvisioningStatus} ProvisioningStatus
 */
ListPermissionSetsProvisionedToAccountRequest.prototype['ProvisioningStatus'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListPermissionSetsProvisionedToAccountRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListPermissionSetsProvisionedToAccountRequest.prototype['NextToken'] = undefined;
...
export default ListPermissionSetsProvisionedToAccountRequest;
