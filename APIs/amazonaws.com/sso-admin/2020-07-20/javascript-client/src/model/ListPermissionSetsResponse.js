...
/**
 * The ListPermissionSetsResponse model module.
 * @module model/ListPermissionSetsResponse
 * @version 2020-07-20
 */
class ListPermissionSetsResponse {
    /**
     * Constructs a new <code>ListPermissionSetsResponse</code>.
     * @alias module:model/ListPermissionSetsResponse
     */
    constructor() { 
        
        ListPermissionSetsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPermissionSetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPermissionSetsResponse} obj Optional instance to populate.
     * @return {module:model/ListPermissionSetsResponse} The populated <code>ListPermissionSetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPermissionSetsResponse();

            if (data.hasOwnProperty('PermissionSets')) {
                obj['PermissionSets'] = ApiClient.convertToType(data['PermissionSets'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPermissionSetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPermissionSetsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PermissionSets`
        if (data['PermissionSets']) { // data not null
          Array.validateJSON(data['PermissionSets']);
        }
...
/**
 * @member {Array} PermissionSets
 */
ListPermissionSetsResponse.prototype['PermissionSets'] = undefined;

/**
 * @member {String} NextToken
 */
ListPermissionSetsResponse.prototype['NextToken'] = undefined;
...
export default ListPermissionSetsResponse;
