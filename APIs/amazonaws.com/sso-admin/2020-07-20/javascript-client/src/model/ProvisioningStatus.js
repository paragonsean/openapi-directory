...
* @readonly
*/
export default class ProvisioningStatus {
    
        /**
         * value: "LATEST_PERMISSION_SET_PROVISIONED"
         * @const
         */
        "PROVISIONED" = "LATEST_PERMISSION_SET_PROVISIONED";
         ...
         * @const
         */
        "NOT_PROVISIONED" = "LATEST_PERMISSION_SET_NOT_PROVISIONED";

    

    /**
    * Returns a <code>ProvisioningStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProvisioningStatus} The enum <code>ProvisioningStatus</code> value.
    */
