...
/**
 * The UpdatePermissionSetRequest model module.
 * @module model/UpdatePermissionSetRequest
 * @version 2020-07-20
 */
class UpdatePermissionSetRequest {
    /**
     * Constructs a new <code>UpdatePermissionSetRequest</code>.
     * @alias module:model/UpdatePermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        UpdatePermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>UpdatePermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePermissionSetRequest} The populated <code>UpdatePermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePermissionSetRequest.RequiredProperties) {
...
UpdatePermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
UpdatePermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
UpdatePermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {String} Description
 */
UpdatePermissionSetRequest.prototype['Description'] = undefined;

/**
 * @member {String} SessionDuration
 */
UpdatePermissionSetRequest.prototype['SessionDuration'] = undefined;

/**
 * @member {String} RelayState
 */
UpdatePermissionSetRequest.prototype['RelayState'] = undefined;
...
export default UpdatePermissionSetRequest;
