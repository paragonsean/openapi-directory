...
/**
 * The GetPermissionsBoundaryForPermissionSetRequest model module.
 * @module model/GetPermissionsBoundaryForPermissionSetRequest
 * @version 2020-07-20
 */
class GetPermissionsBoundaryForPermissionSetRequest {
    /**
     * Constructs a new <code>GetPermissionsBoundaryForPermissionSetRequest</code>.
     * @alias module:model/GetPermissionsBoundaryForPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        GetPermissionsBoundaryForPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>GetPermissionsBoundaryForPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPermissionsBoundaryForPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/GetPermissionsBoundaryForPermissionSetRequest} The populated <code>GetPermissionsBoundaryForPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPermissionsBoundaryForPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPermissionsBoundaryForPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPermissionsBoundaryForPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPermissionsBoundaryForPermissionSetRequest.RequiredProperties) {
...
GetPermissionsBoundaryForPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
GetPermissionsBoundaryForPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
GetPermissionsBoundaryForPermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default GetPermissionsBoundaryForPermissionSetRequest;
