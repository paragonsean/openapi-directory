...
/**
 * The DeleteInstanceAccessControlAttributeConfigurationRequest model module.
 * @module model/DeleteInstanceAccessControlAttributeConfigurationRequest
 * @version 2020-07-20
 */
class DeleteInstanceAccessControlAttributeConfigurationRequest {
    /**
     * Constructs a new <code>DeleteInstanceAccessControlAttributeConfigurationRequest</code>.
     * @alias module:model/DeleteInstanceAccessControlAttributeConfigurationRequest
     * @param instanceArn {String} 
     */
    constructor(instanceArn) { 
        
        DeleteInstanceAccessControlAttributeConfigurationRequest.initialize(this, instanceArn);
    }
    ...
    /**
     * Constructs a <code>DeleteInstanceAccessControlAttributeConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteInstanceAccessControlAttributeConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DeleteInstanceAccessControlAttributeConfigurationRequest} The populated <code>DeleteInstanceAccessControlAttributeConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteInstanceAccessControlAttributeConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteInstanceAccessControlAttributeConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteInstanceAccessControlAttributeConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteInstanceAccessControlAttributeConfigurationRequest.RequiredProperties) {
...
DeleteInstanceAccessControlAttributeConfigurationRequest.RequiredProperties = ["InstanceArn"];

/**
 * @member {String} InstanceArn
 */
DeleteInstanceAccessControlAttributeConfigurationRequest.prototype['InstanceArn'] = undefined;
...
export default DeleteInstanceAccessControlAttributeConfigurationRequest;
