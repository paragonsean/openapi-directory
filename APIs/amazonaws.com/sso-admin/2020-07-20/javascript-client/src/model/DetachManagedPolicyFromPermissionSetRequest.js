...
/**
 * The DetachManagedPolicyFromPermissionSetRequest model module.
 * @module model/DetachManagedPolicyFromPermissionSetRequest
 * @version 2020-07-20
 */
class DetachManagedPolicyFromPermissionSetRequest {
    /**
     * Constructs a new <code>DetachManagedPolicyFromPermissionSetRequest</code>.
     * @alias module:model/DetachManagedPolicyFromPermissionSetRequest
    ...
    constructor(instanceArn, permissionSetArn, managedPolicyArn) { 
        ...
        DetachManagedPolicyFromPermissionSetRequest.initialize(this, instanceArn, permissionSetArn, managedPolicyArn);
    }
    ...
    /**
     * Constructs a <code>DetachManagedPolicyFromPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetachManagedPolicyFromPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/DetachManagedPolicyFromPermissionSetRequest} The populated <code>DetachManagedPolicyFromPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetachManagedPolicyFromPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DetachManagedPolicyFromPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetachManagedPolicyFromPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DetachManagedPolicyFromPermissionSetRequest.RequiredProperties) {
...
DetachManagedPolicyFromPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn", "ManagedPolicyArn"];

/**
 * @member {String} InstanceArn
 */
DetachManagedPolicyFromPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DetachManagedPolicyFromPermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {String} ManagedPolicyArn
 */
DetachManagedPolicyFromPermissionSetRequest.prototype['ManagedPolicyArn'] = undefined;
...
export default DetachManagedPolicyFromPermissionSetRequest;
