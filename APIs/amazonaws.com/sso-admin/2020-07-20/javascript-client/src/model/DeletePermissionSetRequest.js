...
/**
 * The DeletePermissionSetRequest model module.
 * @module model/DeletePermissionSetRequest
 * @version 2020-07-20
 */
class DeletePermissionSetRequest {
    /**
     * Constructs a new <code>DeletePermissionSetRequest</code>.
     * @alias module:model/DeletePermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        DeletePermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>DeletePermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/DeletePermissionSetRequest} The populated <code>DeletePermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePermissionSetRequest.RequiredProperties) {
...
DeletePermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
DeletePermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DeletePermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default DeletePermissionSetRequest;
