...
/**
 * The GetInlinePolicyForPermissionSetRequest model module.
 * @module model/GetInlinePolicyForPermissionSetRequest
 * @version 2020-07-20
 */
class GetInlinePolicyForPermissionSetRequest {
    /**
     * Constructs a new <code>GetInlinePolicyForPermissionSetRequest</code>.
     * @alias module:model/GetInlinePolicyForPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        GetInlinePolicyForPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>GetInlinePolicyForPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInlinePolicyForPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/GetInlinePolicyForPermissionSetRequest} The populated <code>GetInlinePolicyForPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInlinePolicyForPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetInlinePolicyForPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInlinePolicyForPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetInlinePolicyForPermissionSetRequest.RequiredProperties) {
...
GetInlinePolicyForPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
GetInlinePolicyForPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
GetInlinePolicyForPermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default GetInlinePolicyForPermissionSetRequest;
