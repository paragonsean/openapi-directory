...
/**
 * The ListAccountAssignmentsResponse model module.
 * @module model/ListAccountAssignmentsResponse
 * @version 2020-07-20
 */
class ListAccountAssignmentsResponse {
    /**
     * Constructs a new <code>ListAccountAssignmentsResponse</code>.
     * @alias module:model/ListAccountAssignmentsResponse
     */
    constructor() { 
        
        ListAccountAssignmentsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAccountAssignmentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountAssignmentsResponse} obj Optional instance to populate.
     * @return {module:model/ListAccountAssignmentsResponse} The populated <code>ListAccountAssignmentsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountAssignmentsResponse();

            if (data.hasOwnProperty('AccountAssignments')) {
                obj['AccountAssignments'] = ApiClient.convertToType(data['AccountAssignments'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountAssignmentsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountAssignmentsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AccountAssignments`
        if (data['AccountAssignments']) { // data not null
          Array.validateJSON(data['AccountAssignments']);
        }
...
/**
 * @member {Array} AccountAssignments
 */
ListAccountAssignmentsResponse.prototype['AccountAssignments'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountAssignmentsResponse.prototype['NextToken'] = undefined;
...
export default ListAccountAssignmentsResponse;
