...
/**
 * The CreatePermissionSetRequest model module.
 * @module model/CreatePermissionSetRequest
 * @version 2020-07-20
 */
class CreatePermissionSetRequest {
    /**
     * Constructs a new <code>CreatePermissionSetRequest</code>.
     * @alias module:model/CreatePermissionSetRequest
     * @param name {String} 
     * @param instanceArn {String} 
     */
    constructor(name, instanceArn) { 
        
        CreatePermissionSetRequest.initialize(this, name, instanceArn);
    }
     ...
     */
    static initialize(obj, name, instanceArn) { 
        obj['Name'] = name;
        obj['InstanceArn'] = instanceArn;
    }

    /**
     * Constructs a <code>CreatePermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/CreatePermissionSetRequest} The populated <code>CreatePermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePermissionSetRequest.RequiredProperties) {
...
CreatePermissionSetRequest.RequiredProperties = ["Name", "InstanceArn"];

/**
 * @member {String} Name
 */
CreatePermissionSetRequest.prototype['Name'] = undefined;

/**
 * @member {String} Description
 */
CreatePermissionSetRequest.prototype['Description'] = undefined;

/**
 * @member {String} InstanceArn
 */
CreatePermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} SessionDuration
 */
CreatePermissionSetRequest.prototype['SessionDuration'] = undefined;

/**
 * @member {String} RelayState
 */
CreatePermissionSetRequest.prototype['RelayState'] = undefined;

/**
 * @member {Array} Tags
 */
CreatePermissionSetRequest.prototype['Tags'] = undefined;
...
export default CreatePermissionSetRequest;
