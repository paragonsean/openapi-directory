...
/**
 * The ListCustomerManagedPolicyReferencesInPermissionSetRequest model module.
 * @module model/ListCustomerManagedPolicyReferencesInPermissionSetRequest
 * @version 2020-07-20
 */
class ListCustomerManagedPolicyReferencesInPermissionSetRequest {
    /**
     * Constructs a new <code>ListCustomerManagedPolicyReferencesInPermissionSetRequest</code>.
     * @alias module:model/ListCustomerManagedPolicyReferencesInPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        ListCustomerManagedPolicyReferencesInPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>ListCustomerManagedPolicyReferencesInPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListCustomerManagedPolicyReferencesInPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/ListCustomerManagedPolicyReferencesInPermissionSetRequest} The populated <code>ListCustomerManagedPolicyReferencesInPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListCustomerManagedPolicyReferencesInPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListCustomerManagedPolicyReferencesInPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCustomerManagedPolicyReferencesInPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListCustomerManagedPolicyReferencesInPermissionSetRequest.RequiredProperties) {
...
ListCustomerManagedPolicyReferencesInPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
ListCustomerManagedPolicyReferencesInPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
ListCustomerManagedPolicyReferencesInPermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListCustomerManagedPolicyReferencesInPermissionSetRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListCustomerManagedPolicyReferencesInPermissionSetRequest.prototype['NextToken'] = undefined;
...
export default ListCustomerManagedPolicyReferencesInPermissionSetRequest;
