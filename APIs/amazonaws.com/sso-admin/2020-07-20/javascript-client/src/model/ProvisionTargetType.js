...
* @readonly
*/
export default class ProvisionTargetType {
    ...
    /**
    * Returns a <code>ProvisionTargetType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProvisionTargetType} The enum <code>ProvisionTargetType</code> value.
    */
