...
/**
 * The DeleteInlinePolicyFromPermissionSetRequest model module.
 * @module model/DeleteInlinePolicyFromPermissionSetRequest
 * @version 2020-07-20
 */
class DeleteInlinePolicyFromPermissionSetRequest {
    /**
     * Constructs a new <code>DeleteInlinePolicyFromPermissionSetRequest</code>.
     * @alias module:model/DeleteInlinePolicyFromPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        DeleteInlinePolicyFromPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>DeleteInlinePolicyFromPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteInlinePolicyFromPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/DeleteInlinePolicyFromPermissionSetRequest} The populated <code>DeleteInlinePolicyFromPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteInlinePolicyFromPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteInlinePolicyFromPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteInlinePolicyFromPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteInlinePolicyFromPermissionSetRequest.RequiredProperties) {
...
DeleteInlinePolicyFromPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
DeleteInlinePolicyFromPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DeleteInlinePolicyFromPermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default DeleteInlinePolicyFromPermissionSetRequest;
