...
/**
 * The PutInlinePolicyToPermissionSetRequest model module.
 * @module model/PutInlinePolicyToPermissionSetRequest
 * @version 2020-07-20
 */
class PutInlinePolicyToPermissionSetRequest {
    /**
     * Constructs a new <code>PutInlinePolicyToPermissionSetRequest</code>.
     * @alias module:model/PutInlinePolicyToPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     * @param inlinePolicy {String} 
     */
    constructor(instanceArn, permissionSetArn, inlinePolicy) { 
        
        PutInlinePolicyToPermissionSetRequest.initialize(this, instanceArn, permissionSetArn, inlinePolicy);
    }
     ...
     */
    static initialize(obj, instanceArn, permissionSetArn, inlinePolicy) { 
        obj['InstanceArn'] = instanceArn;
        obj['PermissionSetArn'] = permissionSetArn;
        obj['InlinePolicy'] = inlinePolicy;
    }

    /**
     * Constructs a <code>PutInlinePolicyToPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutInlinePolicyToPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/PutInlinePolicyToPermissionSetRequest} The populated <code>PutInlinePolicyToPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutInlinePolicyToPermissionSetRequest();
            ...
            if (data.hasOwnProperty('InlinePolicy')) {
                obj['InlinePolicy'] = ApiClient.convertToType(data['InlinePolicy'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutInlinePolicyToPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutInlinePolicyToPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutInlinePolicyToPermissionSetRequest.RequiredProperties) {
        ...
        if (data['InlinePolicy']) { // data not null
          String.validateJSON(data['InlinePolicy']);
        }
...
PutInlinePolicyToPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn", "InlinePolicy"];

/**
 * @member {String} InstanceArn
 */
PutInlinePolicyToPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
PutInlinePolicyToPermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {String} InlinePolicy
 */
PutInlinePolicyToPermissionSetRequest.prototype['InlinePolicy'] = undefined;
...
export default PutInlinePolicyToPermissionSetRequest;
