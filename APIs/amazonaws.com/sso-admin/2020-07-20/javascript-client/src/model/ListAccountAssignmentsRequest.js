...
/**
 * The ListAccountAssignmentsRequest model module.
 * @module model/ListAccountAssignmentsRequest
 * @version 2020-07-20
 */
class ListAccountAssignmentsRequest {
    /**
     * Constructs a new <code>ListAccountAssignmentsRequest</code>.
     * @alias module:model/ListAccountAssignmentsRequest
     * @param instanceArn {String} 
     * @param accountId {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, accountId, permissionSetArn) { 
        
        ListAccountAssignmentsRequest.initialize(this, instanceArn, accountId, permissionSetArn);
    }
     ...
     */
    static initialize(obj, instanceArn, accountId, permissionSetArn) { 
    ...
    /**
     * Constructs a <code>ListAccountAssignmentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountAssignmentsRequest} obj Optional instance to populate.
     * @return {module:model/ListAccountAssignmentsRequest} The populated <code>ListAccountAssignmentsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountAssignmentsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountAssignmentsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountAssignmentsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAccountAssignmentsRequest.RequiredProperties) {
...
ListAccountAssignmentsRequest.RequiredProperties = ["InstanceArn", "AccountId", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
ListAccountAssignmentsRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} AccountId
 */
ListAccountAssignmentsRequest.prototype['AccountId'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
ListAccountAssignmentsRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAccountAssignmentsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountAssignmentsRequest.prototype['NextToken'] = undefined;
...
export default ListAccountAssignmentsRequest;
