...
import CreatePermissionSetResponsePermissionSet from './CreatePermissionSetResponsePermissionSet';

/**
 * The CreatePermissionSetResponse model module.
 * @module model/CreatePermissionSetResponse
 * @version 2020-07-20
 */
class CreatePermissionSetResponse {
    /**
     * Constructs a new <code>CreatePermissionSetResponse</code>.
     * @alias module:model/CreatePermissionSetResponse
     */
    constructor() { 
        
        CreatePermissionSetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePermissionSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePermissionSetResponse} obj Optional instance to populate.
     * @return {module:model/CreatePermissionSetResponse} The populated <code>CreatePermissionSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePermissionSetResponse();

            if (data.hasOwnProperty('PermissionSet')) {
                obj['PermissionSet'] = CreatePermissionSetResponsePermissionSet.constructFromObject(data['PermissionSet']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePermissionSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePermissionSetResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PermissionSet`
        if (data['PermissionSet']) { // data not null
          CreatePermissionSetResponsePermissionSet.validateJSON(data['PermissionSet']);
        }
...
/**
 * @member {module:model/CreatePermissionSetResponsePermissionSet} PermissionSet
 */
CreatePermissionSetResponse.prototype['PermissionSet'] = undefined;
...
export default CreatePermissionSetResponse;
