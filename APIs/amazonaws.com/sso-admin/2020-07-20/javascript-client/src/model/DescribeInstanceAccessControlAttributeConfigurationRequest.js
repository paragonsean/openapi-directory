...
/**
 * The DescribeInstanceAccessControlAttributeConfigurationRequest model module.
 * @module model/DescribeInstanceAccessControlAttributeConfigurationRequest
 * @version 2020-07-20
 */
class DescribeInstanceAccessControlAttributeConfigurationRequest {
    /**
     * Constructs a new <code>DescribeInstanceAccessControlAttributeConfigurationRequest</code>.
     * @alias module:model/DescribeInstanceAccessControlAttributeConfigurationRequest
     * @param instanceArn {String} 
     */
    constructor(instanceArn) { 
        
        DescribeInstanceAccessControlAttributeConfigurationRequest.initialize(this, instanceArn);
    }
    ...
    /**
     * Constructs a <code>DescribeInstanceAccessControlAttributeConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeInstanceAccessControlAttributeConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeInstanceAccessControlAttributeConfigurationRequest} The populated <code>DescribeInstanceAccessControlAttributeConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeInstanceAccessControlAttributeConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeInstanceAccessControlAttributeConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeInstanceAccessControlAttributeConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeInstanceAccessControlAttributeConfigurationRequest.RequiredProperties) {
...
DescribeInstanceAccessControlAttributeConfigurationRequest.RequiredProperties = ["InstanceArn"];

/**
 * @member {String} InstanceArn
 */
DescribeInstanceAccessControlAttributeConfigurationRequest.prototype['InstanceArn'] = undefined;
...
export default DescribeInstanceAccessControlAttributeConfigurationRequest;
