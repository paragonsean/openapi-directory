...
/**
 * The ListAccountsForProvisionedPermissionSetRequest model module.
 * @module model/ListAccountsForProvisionedPermissionSetRequest
 * @version 2020-07-20
 */
class ListAccountsForProvisionedPermissionSetRequest {
    /**
     * Constructs a new <code>ListAccountsForProvisionedPermissionSetRequest</code>.
     * @alias module:model/ListAccountsForProvisionedPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        ListAccountsForProvisionedPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
     ...
     */
    static initialize(obj, instanceArn, permissionSetArn) { 
        obj['InstanceArn'] = instanceArn;
        obj['PermissionSetArn'] = permissionSetArn;
    }

    /**
     * Constructs a <code>ListAccountsForProvisionedPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAccountsForProvisionedPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/ListAccountsForProvisionedPermissionSetRequest} The populated <code>ListAccountsForProvisionedPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAccountsForProvisionedPermissionSetRequest();
            ...
            if (data.hasOwnProperty('ProvisioningStatus')) {
                obj['ProvisioningStatus'] = ApiClient.convertToType(data['ProvisioningStatus'], ProvisioningStatus);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAccountsForProvisionedPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAccountsForProvisionedPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAccountsForProvisionedPermissionSetRequest.RequiredProperties) {
        ...
        if (data['ProvisioningStatus']) { // data not null
          ProvisioningStatus.validateJSON(data['ProvisioningStatus']);
        }
...
ListAccountsForProvisionedPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
ListAccountsForProvisionedPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
ListAccountsForProvisionedPermissionSetRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {module:model/ProvisioningStatus} ProvisioningStatus
 */
ListAccountsForProvisionedPermissionSetRequest.prototype['ProvisioningStatus'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListAccountsForProvisionedPermissionSetRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListAccountsForProvisionedPermissionSetRequest.prototype['NextToken'] = undefined;
...
export default ListAccountsForProvisionedPermissionSetRequest;
