...
/**
 * The DescribePermissionSetRequest model module.
 * @module model/DescribePermissionSetRequest
 * @version 2020-07-20
 */
class DescribePermissionSetRequest {
    /**
     * Constructs a new <code>DescribePermissionSetRequest</code>.
     * @alias module:model/DescribePermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        DescribePermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>DescribePermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/DescribePermissionSetRequest} The populated <code>DescribePermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePermissionSetRequest.RequiredProperties) {
...
DescribePermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
DescribePermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DescribePermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default DescribePermissionSetRequest;
