...
/**
 * The AccessControlAttributeValue model module.
 * @module model/AccessControlAttributeValue
 * @version 2020-07-20
 */
class AccessControlAttributeValue {
    /**
     * Constructs a new <code>AccessControlAttributeValue</code>.
     * @alias module:model/AccessControlAttributeValue
     * @implements module:model/AccessControlAttributeValue
     * @param source {Array} 
     */
    constructor(source) { 
        AccessControlAttributeValue.initialize(this, source);
        AccessControlAttributeValue.initialize(this, source);
    }
    ...
    /**
     * Constructs a <code>AccessControlAttributeValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessControlAttributeValue} obj Optional instance to populate.
     * @return {module:model/AccessControlAttributeValue} The populated <code>AccessControlAttributeValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessControlAttributeValue();
            AccessControlAttributeValue.constructFromObject(data, obj);

            if (data.hasOwnProperty('Source')) {
                obj['Source'] = ApiClient.convertToType(data['Source'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccessControlAttributeValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessControlAttributeValue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccessControlAttributeValue.RequiredProperties) {
        ...
        if (data['Source']) { // data not null
          Array.validateJSON(data['Source']);
        }
...
AccessControlAttributeValue.RequiredProperties = ["Source"];

/**
 * @member {Array} Source
 */
AccessControlAttributeValue.prototype['Source'] = undefined;


// Implement AccessControlAttributeValue interface:
/**
 * @member {Array} Source
 */
AccessControlAttributeValue.prototype['Source'] = undefined;
...
export default AccessControlAttributeValue;
