...
import DescribePermissionSetResponsePermissionSet from './DescribePermissionSetResponsePermissionSet';

/**
 * The DescribePermissionSetResponse model module.
 * @module model/DescribePermissionSetResponse
 * @version 2020-07-20
 */
class DescribePermissionSetResponse {
    /**
     * Constructs a new <code>DescribePermissionSetResponse</code>.
     * @alias module:model/DescribePermissionSetResponse
     */
    constructor() { 
        
        DescribePermissionSetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePermissionSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePermissionSetResponse} obj Optional instance to populate.
     * @return {module:model/DescribePermissionSetResponse} The populated <code>DescribePermissionSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePermissionSetResponse();

            if (data.hasOwnProperty('PermissionSet')) {
                obj['PermissionSet'] = DescribePermissionSetResponsePermissionSet.constructFromObject(data['PermissionSet']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePermissionSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePermissionSetResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PermissionSet`
        if (data['PermissionSet']) { // data not null
          DescribePermissionSetResponsePermissionSet.validateJSON(data['PermissionSet']);
        }
...
/**
 * @member {module:model/DescribePermissionSetResponsePermissionSet} PermissionSet
 */
DescribePermissionSetResponse.prototype['PermissionSet'] = undefined;
...
export default DescribePermissionSetResponse;
