...
/**
 * The ListManagedPoliciesInPermissionSetResponse model module.
 * @module model/ListManagedPoliciesInPermissionSetResponse
 * @version 2020-07-20
 */
class ListManagedPoliciesInPermissionSetResponse {
    /**
     * Constructs a new <code>ListManagedPoliciesInPermissionSetResponse</code>.
     * @alias module:model/ListManagedPoliciesInPermissionSetResponse
     */
    constructor() { 
        
        ListManagedPoliciesInPermissionSetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListManagedPoliciesInPermissionSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListManagedPoliciesInPermissionSetResponse} obj Optional instance to populate.
     * @return {module:model/ListManagedPoliciesInPermissionSetResponse} The populated <code>ListManagedPoliciesInPermissionSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListManagedPoliciesInPermissionSetResponse();

            if (data.hasOwnProperty('AttachedManagedPolicies')) {
                obj['AttachedManagedPolicies'] = ApiClient.convertToType(data['AttachedManagedPolicies'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListManagedPoliciesInPermissionSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListManagedPoliciesInPermissionSetResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AttachedManagedPolicies`
        if (data['AttachedManagedPolicies']) { // data not null
          Array.validateJSON(data['AttachedManagedPolicies']);
        }
...
/**
 * @member {Array} AttachedManagedPolicies
 */
ListManagedPoliciesInPermissionSetResponse.prototype['AttachedManagedPolicies'] = undefined;

/**
 * @member {String} NextToken
 */
ListManagedPoliciesInPermissionSetResponse.prototype['NextToken'] = undefined;
...
export default ListManagedPoliciesInPermissionSetResponse;
