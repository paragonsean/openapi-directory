...
/**
 * The DeleteAccountAssignmentRequest model module.
 * @module model/DeleteAccountAssignmentRequest
 * @version 2020-07-20
 */
class DeleteAccountAssignmentRequest {
    /**
     * Constructs a new <code>DeleteAccountAssignmentRequest</code>.
     * @alias module:model/DeleteAccountAssignmentRequest
    ...
    constructor(instanceArn, targetId, targetType, permissionSetArn, principalType, principalId) { 
        ...
        DeleteAccountAssignmentRequest.initialize(this, instanceArn, targetId, targetType, permissionSetArn, principalType, principalId);
    }
    ...
    /**
     * Constructs a <code>DeleteAccountAssignmentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAccountAssignmentRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAccountAssignmentRequest} The populated <code>DeleteAccountAssignmentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAccountAssignmentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAccountAssignmentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAccountAssignmentRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAccountAssignmentRequest.RequiredProperties) {
...
DeleteAccountAssignmentRequest.RequiredProperties = ["InstanceArn", "TargetId", "TargetType", "PermissionSetArn", "PrincipalType", "PrincipalId"];

/**
 * @member {String} InstanceArn
 */
DeleteAccountAssignmentRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} TargetId
 */
DeleteAccountAssignmentRequest.prototype['TargetId'] = undefined;

/**
 * @member {module:model/TargetType} TargetType
 */
DeleteAccountAssignmentRequest.prototype['TargetType'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DeleteAccountAssignmentRequest.prototype['PermissionSetArn'] = undefined;

/**
 * @member {module:model/PrincipalType} PrincipalType
 */
DeleteAccountAssignmentRequest.prototype['PrincipalType'] = undefined;

/**
 * @member {String} PrincipalId
 */
DeleteAccountAssignmentRequest.prototype['PrincipalId'] = undefined;
...
export default DeleteAccountAssignmentRequest;
