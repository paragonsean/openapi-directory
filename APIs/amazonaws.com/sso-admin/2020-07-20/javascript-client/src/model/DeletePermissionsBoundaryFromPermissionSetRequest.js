...
/**
 * The DeletePermissionsBoundaryFromPermissionSetRequest model module.
 * @module model/DeletePermissionsBoundaryFromPermissionSetRequest
 * @version 2020-07-20
 */
class DeletePermissionsBoundaryFromPermissionSetRequest {
    /**
     * Constructs a new <code>DeletePermissionsBoundaryFromPermissionSetRequest</code>.
     * @alias module:model/DeletePermissionsBoundaryFromPermissionSetRequest
     * @param instanceArn {String} 
     * @param permissionSetArn {String} 
     */
    constructor(instanceArn, permissionSetArn) { 
        
        DeletePermissionsBoundaryFromPermissionSetRequest.initialize(this, instanceArn, permissionSetArn);
    }
    ...
    /**
     * Constructs a <code>DeletePermissionsBoundaryFromPermissionSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePermissionsBoundaryFromPermissionSetRequest} obj Optional instance to populate.
     * @return {module:model/DeletePermissionsBoundaryFromPermissionSetRequest} The populated <code>DeletePermissionsBoundaryFromPermissionSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePermissionsBoundaryFromPermissionSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePermissionsBoundaryFromPermissionSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePermissionsBoundaryFromPermissionSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePermissionsBoundaryFromPermissionSetRequest.RequiredProperties) {
...
DeletePermissionsBoundaryFromPermissionSetRequest.RequiredProperties = ["InstanceArn", "PermissionSetArn"];

/**
 * @member {String} InstanceArn
 */
DeletePermissionsBoundaryFromPermissionSetRequest.prototype['InstanceArn'] = undefined;

/**
 * @member {String} PermissionSetArn
 */
DeletePermissionsBoundaryFromPermissionSetRequest.prototype['PermissionSetArn'] = undefined;
...
export default DeletePermissionsBoundaryFromPermissionSetRequest;
