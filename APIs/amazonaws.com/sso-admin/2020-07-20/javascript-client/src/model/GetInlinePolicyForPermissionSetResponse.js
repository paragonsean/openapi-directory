...
/**
 * The GetInlinePolicyForPermissionSetResponse model module.
 * @module model/GetInlinePolicyForPermissionSetResponse
 * @version 2020-07-20
 */
class GetInlinePolicyForPermissionSetResponse {
    /**
     * Constructs a new <code>GetInlinePolicyForPermissionSetResponse</code>.
     * @alias module:model/GetInlinePolicyForPermissionSetResponse
     */
    constructor() { 
        
        GetInlinePolicyForPermissionSetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInlinePolicyForPermissionSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInlinePolicyForPermissionSetResponse} obj Optional instance to populate.
     * @return {module:model/GetInlinePolicyForPermissionSetResponse} The populated <code>GetInlinePolicyForPermissionSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInlinePolicyForPermissionSetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetInlinePolicyForPermissionSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInlinePolicyForPermissionSetResponse</code>.
     */
 ...
 */
GetInlinePolicyForPermissionSetResponse.prototype['InlinePolicy'] = undefined;
...
export default GetInlinePolicyForPermissionSetResponse;
