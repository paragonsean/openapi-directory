...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusResponse();
  });
  ...
  describe('ListAccountAssignmentDeletionStatusResponse', function() {
    it('should create an instance of ListAccountAssignmentDeletionStatusResponse', function() {
      // uncomment below and update the code to test ListAccountAssignmentDeletionStatusResponse
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusResponse);
    });

    it('should have the property accountAssignmentsDeletionStatus (base name: "AccountAssignmentsDeletionStatus")', function() {
      // uncomment below and update the code to test the property accountAssignmentsDeletionStatus
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusResponse();
