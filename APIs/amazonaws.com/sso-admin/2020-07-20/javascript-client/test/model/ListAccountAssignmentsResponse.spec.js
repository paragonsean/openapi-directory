...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentsResponse();
  });
  ...
  describe('ListAccountAssignmentsResponse', function() {
    it('should create an instance of ListAccountAssignmentsResponse', function() {
      // uncomment below and update the code to test ListAccountAssignmentsResponse
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentsResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentsResponse);
    });

    it('should have the property accountAssignments (base name: "AccountAssignments")', function() {
      // uncomment below and update the code to test the property accountAssignments
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentsResponse();
