...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AttachedManagedPolicy();
  });
  ...
  describe('AttachedManagedPolicy', function() {
    it('should create an instance of AttachedManagedPolicy', function() {
      // uncomment below and update the code to test AttachedManagedPolicy
      //var instance = new AwsSingleSignOnAdmin.AttachedManagedPolicy();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AttachedManagedPolicy);
    });
