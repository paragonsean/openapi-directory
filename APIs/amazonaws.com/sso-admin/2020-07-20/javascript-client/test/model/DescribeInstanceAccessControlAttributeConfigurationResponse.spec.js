...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponse();
  });
  ...
  describe('DescribeInstanceAccessControlAttributeConfigurationResponse', function() {
    it('should create an instance of DescribeInstanceAccessControlAttributeConfigurationResponse', function() {
      // uncomment below and update the code to test DescribeInstanceAccessControlAttributeConfigurationResponse
      //var instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponse);
    });
