...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentRequest();
  });
  ...
  describe('DeleteAccountAssignmentRequest', function() {
    it('should create an instance of DeleteAccountAssignmentRequest', function() {
      // uncomment below and update the code to test DeleteAccountAssignmentRequest
      //var instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeleteAccountAssignmentRequest);
    });
