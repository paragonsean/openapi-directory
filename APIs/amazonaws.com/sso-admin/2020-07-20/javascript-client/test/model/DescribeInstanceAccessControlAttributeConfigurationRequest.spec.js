...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationRequest();
  });
  ...
  describe('DescribeInstanceAccessControlAttributeConfigurationRequest', function() {
    it('should create an instance of DescribeInstanceAccessControlAttributeConfigurationRequest', function() {
      // uncomment below and update the code to test DescribeInstanceAccessControlAttributeConfigurationRequest
      //var instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationRequest);
    });
