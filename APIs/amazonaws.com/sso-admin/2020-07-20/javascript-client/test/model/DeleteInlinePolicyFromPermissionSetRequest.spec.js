...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeleteInlinePolicyFromPermissionSetRequest();
  });
  ...
  describe('DeleteInlinePolicyFromPermissionSetRequest', function() {
    it('should create an instance of DeleteInlinePolicyFromPermissionSetRequest', function() {
      // uncomment below and update the code to test DeleteInlinePolicyFromPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DeleteInlinePolicyFromPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeleteInlinePolicyFromPermissionSetRequest);
    });
