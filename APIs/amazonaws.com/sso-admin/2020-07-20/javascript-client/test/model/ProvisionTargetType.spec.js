...
(function(root, factory) {
  ...
  describe('ProvisionTargetType', function() {
    it('should create an instance of ProvisionTargetType', function() {
      // uncomment below and update the code to test ProvisionTargetType
      //var instance = new AwsSingleSignOnAdmin.ProvisionTargetType();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ProvisionTargetType);
    });
