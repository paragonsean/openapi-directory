...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.OperationStatusFilter();
  });
  ...
  describe('OperationStatusFilter', function() {
    it('should create an instance of OperationStatusFilter', function() {
      // uncomment below and update the code to test OperationStatusFilter
      //var instance = new AwsSingleSignOnAdmin.OperationStatusFilter();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.OperationStatusFilter);
    });
