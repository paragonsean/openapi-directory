...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus();
  });
  ...
  describe('DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus', function() {
    it('should create an instance of DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus', function() {
      // uncomment below and update the code to test DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponsePermissionSetProvisioningStatus);
    });
