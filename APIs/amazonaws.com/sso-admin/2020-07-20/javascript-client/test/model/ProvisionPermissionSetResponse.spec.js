...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ProvisionPermissionSetResponse();
  });
  ...
  describe('ProvisionPermissionSetResponse', function() {
    it('should create an instance of ProvisionPermissionSetResponse', function() {
      // uncomment below and update the code to test ProvisionPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.ProvisionPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ProvisionPermissionSetResponse);
    });

    it('should have the property permissionSetProvisioningStatus (base name: "PermissionSetProvisioningStatus")', function() {
      // uncomment below and update the code to test the property permissionSetProvisioningStatus
      //var instance = new AwsSingleSignOnAdmin.ProvisionPermissionSetResponse();
