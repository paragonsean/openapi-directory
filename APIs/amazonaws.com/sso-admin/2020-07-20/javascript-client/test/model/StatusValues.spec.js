...
(function(root, factory) {
  ...
  describe('StatusValues', function() {
    it('should create an instance of StatusValues', function() {
      // uncomment below and update the code to test StatusValues
      //var instance = new AwsSingleSignOnAdmin.StatusValues();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.StatusValues);
    });
