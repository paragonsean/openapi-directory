...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetRequest();
  });
  ...
  describe('ListAccountsForProvisionedPermissionSetRequest', function() {
    it('should create an instance of ListAccountsForProvisionedPermissionSetRequest', function() {
      // uncomment below and update the code to test ListAccountsForProvisionedPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetRequest);
    });
