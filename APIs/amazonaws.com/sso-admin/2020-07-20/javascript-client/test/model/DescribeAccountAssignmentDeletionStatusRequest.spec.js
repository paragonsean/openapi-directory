...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusRequest();
  });
  ...
  describe('DescribeAccountAssignmentDeletionStatusRequest', function() {
    it('should create an instance of DescribeAccountAssignmentDeletionStatusRequest', function() {
      // uncomment below and update the code to test DescribeAccountAssignmentDeletionStatusRequest
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusRequest);
    });
    ...
    it('should have the property accountAssignmentDeletionRequestId (base name: "AccountAssignmentDeletionRequestId")', function() {
      // uncomment below and update the code to test the property accountAssignmentDeletionRequestId
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusRequest();
      //expect(instance).to.be();
    });
