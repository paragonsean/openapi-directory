...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetRequest();
  });
  ...
  describe('GetInlinePolicyForPermissionSetRequest', function() {
    it('should create an instance of GetInlinePolicyForPermissionSetRequest', function() {
      // uncomment below and update the code to test GetInlinePolicyForPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetRequest);
    });
