...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AccountAssignmentOperationStatus();
  });
  ...
  describe('AccountAssignmentOperationStatus', function() {
    it('should create an instance of AccountAssignmentOperationStatus', function() {
      // uncomment below and update the code to test AccountAssignmentOperationStatus
      //var instance = new AwsSingleSignOnAdmin.AccountAssignmentOperationStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AccountAssignmentOperationStatus);
    });
