...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequest();
  });
  ...
  describe('PutPermissionsBoundaryToPermissionSetRequest', function() {
    it('should create an instance of PutPermissionsBoundaryToPermissionSetRequest', function() {
      // uncomment below and update the code to test PutPermissionsBoundaryToPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequest);
    });
    ...
    it('should have the property permissionsBoundary (base name: "PermissionsBoundary")', function() {
      // uncomment below and update the code to test the property permissionsBoundary
      //var instance = new AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequest();
      //expect(instance).to.be();
    });
