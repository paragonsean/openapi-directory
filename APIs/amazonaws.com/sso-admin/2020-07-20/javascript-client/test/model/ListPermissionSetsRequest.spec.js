...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetsRequest();
  });
  ...
  describe('ListPermissionSetsRequest', function() {
    it('should create an instance of ListPermissionSetsRequest', function() {
      // uncomment below and update the code to test ListPermissionSetsRequest
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetsRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetsRequest);
    });
