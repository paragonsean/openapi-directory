...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PermissionSetProvisioningStatus();
  });
  ...
  describe('PermissionSetProvisioningStatus', function() {
    it('should create an instance of PermissionSetProvisioningStatus', function() {
      // uncomment below and update the code to test PermissionSetProvisioningStatus
      //var instance = new AwsSingleSignOnAdmin.PermissionSetProvisioningStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PermissionSetProvisioningStatus);
    });
