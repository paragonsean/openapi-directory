...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetRequest();
  });
  ...
  describe('ListManagedPoliciesInPermissionSetRequest', function() {
    it('should create an instance of ListManagedPoliciesInPermissionSetRequest', function() {
      // uncomment below and update the code to test ListManagedPoliciesInPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetRequest);
    });
