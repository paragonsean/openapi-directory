...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CustomerManagedPolicyReference();
  });
  ...
  describe('CustomerManagedPolicyReference', function() {
    it('should create an instance of CustomerManagedPolicyReference', function() {
      // uncomment below and update the code to test CustomerManagedPolicyReference
      //var instance = new AwsSingleSignOnAdmin.CustomerManagedPolicyReference();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CustomerManagedPolicyReference);
    });
