...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AttachManagedPolicyToPermissionSetRequest();
  });
  ...
  describe('AttachManagedPolicyToPermissionSetRequest', function() {
    it('should create an instance of AttachManagedPolicyToPermissionSetRequest', function() {
      // uncomment below and update the code to test AttachManagedPolicyToPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.AttachManagedPolicyToPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AttachManagedPolicyToPermissionSetRequest);
    });
    ...
    it('should have the property managedPolicyArn (base name: "ManagedPolicyArn")', function() {
      // uncomment below and update the code to test the property managedPolicyArn
      //var instance = new AwsSingleSignOnAdmin.AttachManagedPolicyToPermissionSetRequest();
      //expect(instance).to.be();
    });
