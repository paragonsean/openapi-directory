...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsSingleSignOnAdmin.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListTagsForResourceResponse);
    });
