...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusRequest();
  });
  ...
  describe('ListAccountAssignmentDeletionStatusRequest', function() {
    it('should create an instance of ListAccountAssignmentDeletionStatusRequest', function() {
      // uncomment below and update the code to test ListAccountAssignmentDeletionStatusRequest
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentDeletionStatusRequest);
    });
