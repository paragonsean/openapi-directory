...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeletePermissionSetRequest();
  });
  ...
  describe('DeletePermissionSetRequest', function() {
    it('should create an instance of DeletePermissionSetRequest', function() {
      // uncomment below and update the code to test DeletePermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DeletePermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeletePermissionSetRequest);
    });
