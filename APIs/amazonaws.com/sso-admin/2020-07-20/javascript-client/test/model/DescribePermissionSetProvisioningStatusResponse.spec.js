...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponse();
  });
  ...
  describe('DescribePermissionSetProvisioningStatusResponse', function() {
    it('should create an instance of DescribePermissionSetProvisioningStatusResponse', function() {
      // uncomment below and update the code to test DescribePermissionSetProvisioningStatusResponse
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusResponse);
    });
