...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequest();
  });
  ...
  describe('ListAccountAssignmentCreationStatusRequest', function() {
    it('should create an instance of ListAccountAssignmentCreationStatusRequest', function() {
      // uncomment below and update the code to test ListAccountAssignmentCreationStatusRequest
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequest);
    });
