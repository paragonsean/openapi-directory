...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusResponse();
  });
  ...
  describe('DescribeAccountAssignmentDeletionStatusResponse', function() {
    it('should create an instance of DescribeAccountAssignmentDeletionStatusResponse', function() {
      // uncomment below and update the code to test DescribeAccountAssignmentDeletionStatusResponse
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusResponse);
    });

    it('should have the property accountAssignmentDeletionStatus (base name: "AccountAssignmentDeletionStatus")', function() {
      // uncomment below and update the code to test the property accountAssignmentDeletionStatus
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentDeletionStatusResponse();
