...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreateAccountAssignmentResponse();
  });
  ...
  describe('CreateAccountAssignmentResponse', function() {
    it('should create an instance of CreateAccountAssignmentResponse', function() {
      // uncomment below and update the code to test CreateAccountAssignmentResponse
      //var instance = new AwsSingleSignOnAdmin.CreateAccountAssignmentResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreateAccountAssignmentResponse);
    });

    it('should have the property accountAssignmentCreationStatus (base name: "AccountAssignmentCreationStatus")', function() {
      // uncomment below and update the code to test the property accountAssignmentCreationStatus
      //var instance = new AwsSingleSignOnAdmin.CreateAccountAssignmentResponse();
