...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PermissionSetProvisioningStatusMetadata();
  });
  ...
  describe('PermissionSetProvisioningStatusMetadata', function() {
    it('should create an instance of PermissionSetProvisioningStatusMetadata', function() {
      // uncomment below and update the code to test PermissionSetProvisioningStatusMetadata
      //var instance = new AwsSingleSignOnAdmin.PermissionSetProvisioningStatusMetadata();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PermissionSetProvisioningStatusMetadata);
    });
