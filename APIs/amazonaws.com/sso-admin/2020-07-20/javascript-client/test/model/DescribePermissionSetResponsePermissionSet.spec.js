...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetResponsePermissionSet();
  });
  ...
  describe('DescribePermissionSetResponsePermissionSet', function() {
    it('should create an instance of DescribePermissionSetResponsePermissionSet', function() {
      // uncomment below and update the code to test DescribePermissionSetResponsePermissionSet
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetResponsePermissionSet();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetResponsePermissionSet);
    });
