...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AccountAssignmentOperationStatusMetadata();
  });
  ...
  describe('AccountAssignmentOperationStatusMetadata', function() {
    it('should create an instance of AccountAssignmentOperationStatusMetadata', function() {
      // uncomment below and update the code to test AccountAssignmentOperationStatusMetadata
      //var instance = new AwsSingleSignOnAdmin.AccountAssignmentOperationStatusMetadata();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AccountAssignmentOperationStatusMetadata);
    });
