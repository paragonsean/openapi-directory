...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetResponse();
  });
  ...
  describe('ListCustomerManagedPolicyReferencesInPermissionSetResponse', function() {
    it('should create an instance of ListCustomerManagedPolicyReferencesInPermissionSetResponse', function() {
      // uncomment below and update the code to test ListCustomerManagedPolicyReferencesInPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetResponse);
    });

    it('should have the property customerManagedPolicyReferences (base name: "CustomerManagedPolicyReferences")', function() {
      // uncomment below and update the code to test the property customerManagedPolicyReferences
      //var instance = new AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetResponse();
