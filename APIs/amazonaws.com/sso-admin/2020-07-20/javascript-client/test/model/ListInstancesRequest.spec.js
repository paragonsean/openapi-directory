...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListInstancesRequest();
  });
  ...
  describe('ListInstancesRequest', function() {
    it('should create an instance of ListInstancesRequest', function() {
      ...
      //var instance = new AwsSingleSignOnAdmin.ListInstancesRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListInstancesRequest);
    });
