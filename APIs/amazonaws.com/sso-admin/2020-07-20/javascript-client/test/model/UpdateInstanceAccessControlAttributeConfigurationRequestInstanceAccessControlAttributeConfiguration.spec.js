...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration();
  });
  ...
  describe('UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration', function() {
    it('should create an instance of UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration', function() {
      // uncomment below and update the code to test UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration
      //var instance = new AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration);
    });
