...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary();
  });
  ...
  describe('PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary', function() {
    it('should create an instance of PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary', function() {
      // uncomment below and update the code to test PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary
      //var instance = new AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PutPermissionsBoundaryToPermissionSetRequestPermissionsBoundary);
    });
