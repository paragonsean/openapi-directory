...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListInstancesResponse();
  });
  ...
  describe('ListInstancesResponse', function() {
    it('should create an instance of ListInstancesResponse', function() {
      ...
      //var instance = new AwsSingleSignOnAdmin.ListInstancesResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListInstancesResponse);
    });
