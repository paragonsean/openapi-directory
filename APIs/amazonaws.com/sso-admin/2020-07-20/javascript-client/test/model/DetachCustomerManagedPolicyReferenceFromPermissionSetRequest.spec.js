...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest();
  });
  ...
  describe('DetachCustomerManagedPolicyReferenceFromPermissionSetRequest', function() {
    it('should create an instance of DetachCustomerManagedPolicyReferenceFromPermissionSetRequest', function() {
      // uncomment below and update the code to test DetachCustomerManagedPolicyReferenceFromPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DetachCustomerManagedPolicyReferenceFromPermissionSetRequest);
    });
