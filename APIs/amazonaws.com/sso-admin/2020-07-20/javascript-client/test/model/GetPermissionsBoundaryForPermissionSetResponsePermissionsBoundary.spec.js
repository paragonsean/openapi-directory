...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary();
  });
  ...
  describe('GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary', function() {
    it('should create an instance of GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary', function() {
      // uncomment below and update the code to test GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary
      //var instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponsePermissionsBoundary);
    });
