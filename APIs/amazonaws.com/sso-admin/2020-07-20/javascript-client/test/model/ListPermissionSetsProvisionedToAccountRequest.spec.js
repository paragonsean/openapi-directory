...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountRequest();
  });
  ...
  describe('ListPermissionSetsProvisionedToAccountRequest', function() {
    it('should create an instance of ListPermissionSetsProvisionedToAccountRequest', function() {
      // uncomment below and update the code to test ListPermissionSetsProvisionedToAccountRequest
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountRequest);
    });
