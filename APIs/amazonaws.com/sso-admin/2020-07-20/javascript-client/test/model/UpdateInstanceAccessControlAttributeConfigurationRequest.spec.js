...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequest();
  });
  ...
  describe('UpdateInstanceAccessControlAttributeConfigurationRequest', function() {
    it('should create an instance of UpdateInstanceAccessControlAttributeConfigurationRequest', function() {
      // uncomment below and update the code to test UpdateInstanceAccessControlAttributeConfigurationRequest
      //var instance = new AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequest);
    });
    ...
    it('should have the property instanceAccessControlAttributeConfiguration (base name: "InstanceAccessControlAttributeConfiguration")', function() {
      // uncomment below and update the code to test the property instanceAccessControlAttributeConfiguration
      //var instance = new AwsSingleSignOnAdmin.UpdateInstanceAccessControlAttributeConfigurationRequest();
      //expect(instance).to.be();
    });
