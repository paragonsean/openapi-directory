...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.InstanceMetadata();
  });
  ...
  describe('InstanceMetadata', function() {
    it('should create an instance of InstanceMetadata', function() {
      // uncomment below and update the code to test InstanceMetadata
      //var instance = new AwsSingleSignOnAdmin.InstanceMetadata();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.InstanceMetadata);
    });
