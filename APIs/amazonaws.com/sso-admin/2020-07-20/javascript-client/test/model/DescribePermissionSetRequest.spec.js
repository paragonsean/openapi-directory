...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetRequest();
  });
  ...
  describe('DescribePermissionSetRequest', function() {
    it('should create an instance of DescribePermissionSetRequest', function() {
      // uncomment below and update the code to test DescribePermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetRequest);
    });
