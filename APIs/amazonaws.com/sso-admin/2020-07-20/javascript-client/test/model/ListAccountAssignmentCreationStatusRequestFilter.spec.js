...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequestFilter();
  });
  ...
  describe('ListAccountAssignmentCreationStatusRequestFilter', function() {
    it('should create an instance of ListAccountAssignmentCreationStatusRequestFilter', function() {
      // uncomment below and update the code to test ListAccountAssignmentCreationStatusRequestFilter
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequestFilter();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusRequestFilter);
    });
