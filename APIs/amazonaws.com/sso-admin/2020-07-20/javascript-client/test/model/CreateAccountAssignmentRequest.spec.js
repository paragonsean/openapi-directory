...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreateAccountAssignmentRequest();
  });
  ...
  describe('CreateAccountAssignmentRequest', function() {
    it('should create an instance of CreateAccountAssignmentRequest', function() {
      // uncomment below and update the code to test CreateAccountAssignmentRequest
      //var instance = new AwsSingleSignOnAdmin.CreateAccountAssignmentRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreateAccountAssignmentRequest);
    });
