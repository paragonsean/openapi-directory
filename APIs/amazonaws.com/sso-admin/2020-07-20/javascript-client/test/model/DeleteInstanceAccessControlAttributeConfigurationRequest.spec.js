...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeleteInstanceAccessControlAttributeConfigurationRequest();
  });
  ...
  describe('DeleteInstanceAccessControlAttributeConfigurationRequest', function() {
    it('should create an instance of DeleteInstanceAccessControlAttributeConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteInstanceAccessControlAttributeConfigurationRequest
      //var instance = new AwsSingleSignOnAdmin.DeleteInstanceAccessControlAttributeConfigurationRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeleteInstanceAccessControlAttributeConfigurationRequest);
    });
