...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetResponse();
  });
  ...
  describe('ListAccountsForProvisionedPermissionSetResponse', function() {
    it('should create an instance of ListAccountsForProvisionedPermissionSetResponse', function() {
      // uncomment below and update the code to test ListAccountsForProvisionedPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountsForProvisionedPermissionSetResponse);
    });
