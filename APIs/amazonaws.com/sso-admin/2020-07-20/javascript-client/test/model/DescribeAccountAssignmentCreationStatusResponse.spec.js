...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusResponse();
  });
  ...
  describe('DescribeAccountAssignmentCreationStatusResponse', function() {
    it('should create an instance of DescribeAccountAssignmentCreationStatusResponse', function() {
      // uncomment below and update the code to test DescribeAccountAssignmentCreationStatusResponse
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusResponse);
    });
