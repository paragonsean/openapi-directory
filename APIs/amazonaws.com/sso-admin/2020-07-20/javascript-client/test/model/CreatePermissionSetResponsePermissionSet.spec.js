...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreatePermissionSetResponsePermissionSet();
  });
  ...
  describe('CreatePermissionSetResponsePermissionSet', function() {
    it('should create an instance of CreatePermissionSetResponsePermissionSet', function() {
      // uncomment below and update the code to test CreatePermissionSetResponsePermissionSet
      //var instance = new AwsSingleSignOnAdmin.CreatePermissionSetResponsePermissionSet();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreatePermissionSetResponsePermissionSet);
    });
