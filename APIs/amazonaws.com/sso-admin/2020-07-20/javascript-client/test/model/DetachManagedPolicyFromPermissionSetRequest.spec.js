...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DetachManagedPolicyFromPermissionSetRequest();
  });
  ...
  describe('DetachManagedPolicyFromPermissionSetRequest', function() {
    it('should create an instance of DetachManagedPolicyFromPermissionSetRequest', function() {
      // uncomment below and update the code to test DetachManagedPolicyFromPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DetachManagedPolicyFromPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DetachManagedPolicyFromPermissionSetRequest);
    });
