...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetResponse();
  });
  ...
  describe('GetInlinePolicyForPermissionSetResponse', function() {
    it('should create an instance of GetInlinePolicyForPermissionSetResponse', function() {
      // uncomment below and update the code to test GetInlinePolicyForPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.GetInlinePolicyForPermissionSetResponse);
    });
