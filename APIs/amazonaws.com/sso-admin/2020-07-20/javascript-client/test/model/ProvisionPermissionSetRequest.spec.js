...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ProvisionPermissionSetRequest();
  });
  ...
  describe('ProvisionPermissionSetRequest', function() {
    it('should create an instance of ProvisionPermissionSetRequest', function() {
      // uncomment below and update the code to test ProvisionPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.ProvisionPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ProvisionPermissionSetRequest);
    });
