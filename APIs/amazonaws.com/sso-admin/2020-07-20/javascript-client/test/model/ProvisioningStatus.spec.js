...
(function(root, factory) {
  ...
  describe('ProvisioningStatus', function() {
    it('should create an instance of ProvisioningStatus', function() {
      // uncomment below and update the code to test ProvisioningStatus
      //var instance = new AwsSingleSignOnAdmin.ProvisioningStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ProvisioningStatus);
    });
