...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AccessControlAttributeValue();
  });
  ...
  describe('AccessControlAttributeValue', function() {
    it('should create an instance of AccessControlAttributeValue', function() {
      // uncomment below and update the code to test AccessControlAttributeValue
      //var instance = new AwsSingleSignOnAdmin.AccessControlAttributeValue();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AccessControlAttributeValue);
    });
