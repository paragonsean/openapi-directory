...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration();
  });
  ...
  describe('DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration', function() {
    it('should create an instance of DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration', function() {
      // uncomment below and update the code to test DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration
      //var instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration);
    });

    it('should have the property accessControlAttributes (base name: "AccessControlAttributes")', function() {
      // uncomment below and update the code to test the property accessControlAttributes
      //var instance = new AwsSingleSignOnAdmin.DescribeInstanceAccessControlAttributeConfigurationResponseInstanceAccessControlAttributeConfiguration();
