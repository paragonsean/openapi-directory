...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusResponse();
  });
  ...
  describe('ListPermissionSetProvisioningStatusResponse', function() {
    it('should create an instance of ListPermissionSetProvisioningStatusResponse', function() {
      // uncomment below and update the code to test ListPermissionSetProvisioningStatusResponse
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusResponse);
    });

    it('should have the property permissionSetsProvisioningStatus (base name: "PermissionSetsProvisioningStatus")', function() {
      // uncomment below and update the code to test the property permissionSetsProvisioningStatus
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusResponse();
