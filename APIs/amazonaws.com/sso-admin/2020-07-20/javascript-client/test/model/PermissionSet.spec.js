...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PermissionSet();
  });
  ...
  describe('PermissionSet', function() {
    it('should create an instance of PermissionSet', function() {
      // uncomment below and update the code to test PermissionSet
      //var instance = new AwsSingleSignOnAdmin.PermissionSet();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PermissionSet);
    });
