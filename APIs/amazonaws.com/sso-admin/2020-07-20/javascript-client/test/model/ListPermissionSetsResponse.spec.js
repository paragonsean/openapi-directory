...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetsResponse();
  });
  ...
  describe('ListPermissionSetsResponse', function() {
    it('should create an instance of ListPermissionSetsResponse', function() {
      // uncomment below and update the code to test ListPermissionSetsResponse
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetsResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetsResponse);
    });
