...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetResponse();
  });
  ...
  describe('DescribePermissionSetResponse', function() {
    it('should create an instance of DescribePermissionSetResponse', function() {
      // uncomment below and update the code to test DescribePermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetResponse);
    });
