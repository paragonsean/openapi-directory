...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeletePermissionsBoundaryFromPermissionSetRequest();
  });
  ...
  describe('DeletePermissionsBoundaryFromPermissionSetRequest', function() {
    it('should create an instance of DeletePermissionsBoundaryFromPermissionSetRequest', function() {
      // uncomment below and update the code to test DeletePermissionsBoundaryFromPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.DeletePermissionsBoundaryFromPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeletePermissionsBoundaryFromPermissionSetRequest);
    });
