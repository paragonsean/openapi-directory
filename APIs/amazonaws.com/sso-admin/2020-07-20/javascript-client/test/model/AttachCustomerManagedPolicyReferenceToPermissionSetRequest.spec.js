...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequest();
  });
  ...
  describe('AttachCustomerManagedPolicyReferenceToPermissionSetRequest', function() {
    it('should create an instance of AttachCustomerManagedPolicyReferenceToPermissionSetRequest', function() {
      // uncomment below and update the code to test AttachCustomerManagedPolicyReferenceToPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequest);
    });
    ...
    it('should have the property customerManagedPolicyReference (base name: "CustomerManagedPolicyReference")', function() {
      // uncomment below and update the code to test the property customerManagedPolicyReference
      //var instance = new AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequest();
      //expect(instance).to.be();
    });
