...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.InstanceAccessControlAttributeConfiguration();
  });
  ...
  describe('InstanceAccessControlAttributeConfiguration', function() {
    it('should create an instance of InstanceAccessControlAttributeConfiguration', function() {
      // uncomment below and update the code to test InstanceAccessControlAttributeConfiguration
      //var instance = new AwsSingleSignOnAdmin.InstanceAccessControlAttributeConfiguration();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.InstanceAccessControlAttributeConfiguration);
    });
