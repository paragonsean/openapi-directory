...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PutInlinePolicyToPermissionSetRequest();
  });
  ...
  describe('PutInlinePolicyToPermissionSetRequest', function() {
    it('should create an instance of PutInlinePolicyToPermissionSetRequest', function() {
      // uncomment below and update the code to test PutInlinePolicyToPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.PutInlinePolicyToPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PutInlinePolicyToPermissionSetRequest);
    });
    ...
    it('should have the property inlinePolicy (base name: "InlinePolicy")', function() {
      // uncomment below and update the code to test the property inlinePolicy
      //var instance = new AwsSingleSignOnAdmin.PutInlinePolicyToPermissionSetRequest();
      //expect(instance).to.be();
    });
