...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.PermissionsBoundary();
  });
  ...
  describe('PermissionsBoundary', function() {
    it('should create an instance of PermissionsBoundary', function() {
      // uncomment below and update the code to test PermissionsBoundary
      //var instance = new AwsSingleSignOnAdmin.PermissionsBoundary();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.PermissionsBoundary);
    });
