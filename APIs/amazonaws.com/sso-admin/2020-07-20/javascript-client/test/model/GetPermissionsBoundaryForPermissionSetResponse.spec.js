...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponse();
  });
  ...
  describe('GetPermissionsBoundaryForPermissionSetResponse', function() {
    it('should create an instance of GetPermissionsBoundaryForPermissionSetResponse', function() {
      // uncomment below and update the code to test GetPermissionsBoundaryForPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetResponse);
    });
