...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusRequest();
  });
  ...
  describe('DescribeAccountAssignmentCreationStatusRequest', function() {
    it('should create an instance of DescribeAccountAssignmentCreationStatusRequest', function() {
      // uncomment below and update the code to test DescribeAccountAssignmentCreationStatusRequest
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusRequest);
    });
    ...
    it('should have the property accountAssignmentCreationRequestId (base name: "AccountAssignmentCreationRequestId")', function() {
      // uncomment below and update the code to test the property accountAssignmentCreationRequestId
      //var instance = new AwsSingleSignOnAdmin.DescribeAccountAssignmentCreationStatusRequest();
      //expect(instance).to.be();
    });
