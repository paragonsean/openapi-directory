...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration();
  });
  ...
  describe('CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration', function() {
    it('should create an instance of CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration', function() {
      // uncomment below and update the code to test CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration
      //var instance = new AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequestInstanceAccessControlAttributeConfiguration);
    });
