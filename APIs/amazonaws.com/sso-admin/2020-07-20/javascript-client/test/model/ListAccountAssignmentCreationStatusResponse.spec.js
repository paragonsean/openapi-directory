...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusResponse();
  });
  ...
  describe('ListAccountAssignmentCreationStatusResponse', function() {
    it('should create an instance of ListAccountAssignmentCreationStatusResponse', function() {
      // uncomment below and update the code to test ListAccountAssignmentCreationStatusResponse
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusResponse);
    });

    it('should have the property accountAssignmentsCreationStatus (base name: "AccountAssignmentsCreationStatus")', function() {
      // uncomment below and update the code to test the property accountAssignmentsCreationStatus
      //var instance = new AwsSingleSignOnAdmin.ListAccountAssignmentCreationStatusResponse();
