...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetRequest();
  });
  ...
  describe('ListCustomerManagedPolicyReferencesInPermissionSetRequest', function() {
    it('should create an instance of ListCustomerManagedPolicyReferencesInPermissionSetRequest', function() {
      // uncomment below and update the code to test ListCustomerManagedPolicyReferencesInPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListCustomerManagedPolicyReferencesInPermissionSetRequest);
    });
