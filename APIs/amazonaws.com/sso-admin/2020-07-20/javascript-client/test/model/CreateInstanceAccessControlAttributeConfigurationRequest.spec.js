...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequest();
  });
  ...
  describe('CreateInstanceAccessControlAttributeConfigurationRequest', function() {
    it('should create an instance of CreateInstanceAccessControlAttributeConfigurationRequest', function() {
      // uncomment below and update the code to test CreateInstanceAccessControlAttributeConfigurationRequest
      //var instance = new AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreateInstanceAccessControlAttributeConfigurationRequest);
    });
