...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsSingleSignOnAdmin.TagResourceRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.TagResourceRequest);
    });
