...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountResponse();
  });
  ...
  describe('ListPermissionSetsProvisionedToAccountResponse', function() {
    it('should create an instance of ListPermissionSetsProvisionedToAccountResponse', function() {
      // uncomment below and update the code to test ListPermissionSetsProvisionedToAccountResponse
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetsProvisionedToAccountResponse);
    });
