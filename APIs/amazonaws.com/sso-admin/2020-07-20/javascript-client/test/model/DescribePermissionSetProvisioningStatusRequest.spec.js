...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusRequest();
  });
  ...
  describe('DescribePermissionSetProvisioningStatusRequest', function() {
    it('should create an instance of DescribePermissionSetProvisioningStatusRequest', function() {
      // uncomment below and update the code to test DescribePermissionSetProvisioningStatusRequest
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusRequest);
    });
    ...
    it('should have the property provisionPermissionSetRequestId (base name: "ProvisionPermissionSetRequestId")', function() {
      // uncomment below and update the code to test the property provisionPermissionSetRequestId
      //var instance = new AwsSingleSignOnAdmin.DescribePermissionSetProvisioningStatusRequest();
      //expect(instance).to.be();
    });
