...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference();
  });
  ...
  describe('AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference', function() {
    it('should create an instance of AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference', function() {
      // uncomment below and update the code to test AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference
      //var instance = new AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AttachCustomerManagedPolicyReferenceToPermissionSetRequestCustomerManagedPolicyReference);
    });
