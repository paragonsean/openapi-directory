...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusRequest();
  });
  ...
  describe('ListPermissionSetProvisioningStatusRequest', function() {
    it('should create an instance of ListPermissionSetProvisioningStatusRequest', function() {
      // uncomment below and update the code to test ListPermissionSetProvisioningStatusRequest
      //var instance = new AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListPermissionSetProvisioningStatusRequest);
    });
