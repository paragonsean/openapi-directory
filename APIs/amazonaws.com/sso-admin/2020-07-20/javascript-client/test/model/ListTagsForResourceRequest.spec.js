...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsSingleSignOnAdmin.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListTagsForResourceRequest);
    });
