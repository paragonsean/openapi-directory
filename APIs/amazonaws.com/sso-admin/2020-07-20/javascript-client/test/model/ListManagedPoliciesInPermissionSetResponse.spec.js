...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetResponse();
  });
  ...
  describe('ListManagedPoliciesInPermissionSetResponse', function() {
    it('should create an instance of ListManagedPoliciesInPermissionSetResponse', function() {
      // uncomment below and update the code to test ListManagedPoliciesInPermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetResponse);
    });

    it('should have the property attachedManagedPolicies (base name: "AttachedManagedPolicies")', function() {
      // uncomment below and update the code to test the property attachedManagedPolicies
      //var instance = new AwsSingleSignOnAdmin.ListManagedPoliciesInPermissionSetResponse();
