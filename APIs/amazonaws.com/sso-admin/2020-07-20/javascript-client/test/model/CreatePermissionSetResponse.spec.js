...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreatePermissionSetResponse();
  });
  ...
  describe('CreatePermissionSetResponse', function() {
    it('should create an instance of CreatePermissionSetResponse', function() {
      // uncomment below and update the code to test CreatePermissionSetResponse
      //var instance = new AwsSingleSignOnAdmin.CreatePermissionSetResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreatePermissionSetResponse);
    });

    it('should have the property permissionSet (base name: "PermissionSet")', function() {
