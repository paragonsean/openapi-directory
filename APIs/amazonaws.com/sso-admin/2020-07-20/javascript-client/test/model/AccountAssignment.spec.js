...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AccountAssignment();
  });
  ...
  describe('AccountAssignment', function() {
    it('should create an instance of AccountAssignment', function() {
      // uncomment below and update the code to test AccountAssignment
      //var instance = new AwsSingleSignOnAdmin.AccountAssignment();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AccountAssignment);
    });
