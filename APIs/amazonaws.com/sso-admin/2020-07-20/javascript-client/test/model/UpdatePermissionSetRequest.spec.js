...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.UpdatePermissionSetRequest();
  });
  ...
  describe('UpdatePermissionSetRequest', function() {
    it('should create an instance of UpdatePermissionSetRequest', function() {
      // uncomment below and update the code to test UpdatePermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.UpdatePermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.UpdatePermissionSetRequest);
    });
    ...
    it('should have the property sessionDuration (base name: "SessionDuration")', function() {
      // uncomment below and update the code to test the property sessionDuration
      //var instance = new AwsSingleSignOnAdmin.UpdatePermissionSetRequest();
      //expect(instance).to.be();
    });

    it('should have the property relayState (base name: "RelayState")', function() {
      // uncomment below and update the code to test the property relayState
      //var instance = new AwsSingleSignOnAdmin.UpdatePermissionSetRequest();
      //expect(instance).to.be();
    });
