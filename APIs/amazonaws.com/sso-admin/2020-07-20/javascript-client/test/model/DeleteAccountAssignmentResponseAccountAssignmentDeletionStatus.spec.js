...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus();
  });
  ...
  describe('DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus', function() {
    it('should create an instance of DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus', function() {
      // uncomment below and update the code to test DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus
      //var instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeleteAccountAssignmentResponseAccountAssignmentDeletionStatus);
    });
