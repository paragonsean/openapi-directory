...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentResponse();
  });
  ...
  describe('DeleteAccountAssignmentResponse', function() {
    it('should create an instance of DeleteAccountAssignmentResponse', function() {
      // uncomment below and update the code to test DeleteAccountAssignmentResponse
      //var instance = new AwsSingleSignOnAdmin.DeleteAccountAssignmentResponse();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.DeleteAccountAssignmentResponse);
    });
