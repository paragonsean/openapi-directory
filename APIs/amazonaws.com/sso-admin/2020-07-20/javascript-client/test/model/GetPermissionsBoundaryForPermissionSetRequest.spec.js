...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetRequest();
  });
  ...
  describe('GetPermissionsBoundaryForPermissionSetRequest', function() {
    it('should create an instance of GetPermissionsBoundaryForPermissionSetRequest', function() {
      // uncomment below and update the code to test GetPermissionsBoundaryForPermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.GetPermissionsBoundaryForPermissionSetRequest);
    });
