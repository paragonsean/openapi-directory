...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.CreatePermissionSetRequest();
  });
  ...
  describe('CreatePermissionSetRequest', function() {
    it('should create an instance of CreatePermissionSetRequest', function() {
      // uncomment below and update the code to test CreatePermissionSetRequest
      //var instance = new AwsSingleSignOnAdmin.CreatePermissionSetRequest();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.CreatePermissionSetRequest);
    });
