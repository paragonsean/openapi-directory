...
(function(root, factory) {
  ...
  describe('InstanceAccessControlAttributeConfigurationStatus', function() {
    it('should create an instance of InstanceAccessControlAttributeConfigurationStatus', function() {
      // uncomment below and update the code to test InstanceAccessControlAttributeConfigurationStatus
      //var instance = new AwsSingleSignOnAdmin.InstanceAccessControlAttributeConfigurationStatus();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.InstanceAccessControlAttributeConfigurationStatus);
    });
