...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSingleSignOnAdmin.AccessControlAttribute();
  });
  ...
  describe('AccessControlAttribute', function() {
    it('should create an instance of AccessControlAttribute', function() {
      // uncomment below and update the code to test AccessControlAttribute
      //var instance = new AwsSingleSignOnAdmin.AccessControlAttribute();
      //expect(instance).to.be.a(AwsSingleSignOnAdmin.AccessControlAttribute);
    });
