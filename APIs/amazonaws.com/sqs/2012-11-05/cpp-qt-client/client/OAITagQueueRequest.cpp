...
OAITagQueueRequest::OAITagQueueRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagQueueRequest::OAITagQueueRequest() {
    this->initializeModel();
}

OAITagQueueRequest::~OAITagQueueRequest() {}

void OAITagQueueRequest::initializeModel() {
...
void OAITagQueueRequest::fromJson(QString jsonString) {
...
void OAITagQueueRequest::fromJsonObject(QJsonObject json) {
...
QString OAITagQueueRequest::asJson() const {
...
QJsonObject OAITagQueueRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAITagQueueRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAITagQueueRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAITagQueueRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAITagQueueRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QMap OAITagQueueRequest::getTags() const {
    return m_tags;
}
void OAITagQueueRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagQueueRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagQueueRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagQueueRequest::isSet() const {
...
bool OAITagQueueRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_queue_url_isValid && m_tags_isValid && true;
}
