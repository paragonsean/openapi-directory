...
/*
 * OAIStartMessageMoveTaskResult.h
 *
 * 
 */

#ifndef OAIStartMessageMoveTaskResult_H
#define OAIStartMessageMoveTaskResult_H
...
class OAIStartMessageMoveTaskResult : public OAIObject {
public:
    OAIStartMessageMoveTaskResult();
    OAIStartMessageMoveTaskResult(QString json);
    ~OAIStartMessageMoveTaskResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMessageMoveTaskResult)

#endif // OAIStartMessageMoveTaskResult_H
