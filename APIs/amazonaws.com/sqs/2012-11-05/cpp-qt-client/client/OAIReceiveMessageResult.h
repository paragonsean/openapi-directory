...
/*
 * OAIReceiveMessageResult.h
 *
 * A list of received messages.
 */

#ifndef OAIReceiveMessageResult_H
#define OAIReceiveMessageResult_H
...
class OAIReceiveMessageResult : public OAIObject {
public:
    OAIReceiveMessageResult();
    OAIReceiveMessageResult(QString json);
    ~OAIReceiveMessageResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceiveMessageResult)

#endif // OAIReceiveMessageResult_H
