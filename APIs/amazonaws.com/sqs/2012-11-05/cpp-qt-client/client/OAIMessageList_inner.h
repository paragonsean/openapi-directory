...
/*
 * OAIMessageList_inner.h
 *
 * 
 */

#ifndef OAIMessageList_inner_H
#define OAIMessageList_inner_H
...
class OAIMessageList_inner : public OAIObject {
public:
    OAIMessageList_inner();
    OAIMessageList_inner(QString json);
    ~OAIMessageList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageList_inner)

#endif // OAIMessageList_inner_H
