...
OAIListQueueTagsRequest::OAIListQueueTagsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListQueueTagsRequest::OAIListQueueTagsRequest() {
    this->initializeModel();
}

OAIListQueueTagsRequest::~OAIListQueueTagsRequest() {}

void OAIListQueueTagsRequest::initializeModel() {

    m_queue_url_isSet = false;
    m_queue_url_isValid = false;
}

void OAIListQueueTagsRequest::fromJson(QString jsonString) {
...
void OAIListQueueTagsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListQueueTagsRequest::asJson() const {
...
QJsonObject OAIListQueueTagsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListQueueTagsRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIListQueueTagsRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIListQueueTagsRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIListQueueTagsRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

bool OAIListQueueTagsRequest::isSet() const {
...
bool OAIListQueueTagsRequest::isValid() const {
