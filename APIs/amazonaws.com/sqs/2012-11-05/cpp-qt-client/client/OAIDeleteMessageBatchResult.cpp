...
OAIDeleteMessageBatchResult::OAIDeleteMessageBatchResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMessageBatchResult::OAIDeleteMessageBatchResult() {
    this->initializeModel();
}

OAIDeleteMessageBatchResult::~OAIDeleteMessageBatchResult() {}

void OAIDeleteMessageBatchResult::initializeModel() {
...
void OAIDeleteMessageBatchResult::fromJson(QString jsonString) {
...
void OAIDeleteMessageBatchResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMessageBatchResult::asJson() const {
...
QJsonObject OAIDeleteMessageBatchResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDeleteMessageBatchResult::getSuccessful() const {
    return m_successful;
}
void OAIDeleteMessageBatchResult::setSuccessful(const QList &successful) {
    m_successful = successful;
    m_successful_isSet = true;
}

bool OAIDeleteMessageBatchResult::is_successful_Set() const{
    return m_successful_isSet;
}

bool OAIDeleteMessageBatchResult::is_successful_Valid() const{
    return m_successful_isValid;
}

QList OAIDeleteMessageBatchResult::getFailed() const {
    return m_failed;
}
void OAIDeleteMessageBatchResult::setFailed(const QList &failed) {
    m_failed = failed;
    m_failed_isSet = true;
}

bool OAIDeleteMessageBatchResult::is_failed_Set() const{
    return m_failed_isSet;
}

bool OAIDeleteMessageBatchResult::is_failed_Valid() const{
    return m_failed_isValid;
}

bool OAIDeleteMessageBatchResult::isSet() const {
...
bool OAIDeleteMessageBatchResult::isValid() const {
