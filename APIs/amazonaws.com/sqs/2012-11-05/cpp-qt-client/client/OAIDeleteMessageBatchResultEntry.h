...
/*
 * OAIDeleteMessageBatchResultEntry.h
 *
 * Encloses the &lt;code&gt;Id&lt;/code&gt; of an entry in &lt;code&gt; &lt;a&gt;DeleteMessageBatch&lt;/a&gt;.&lt;/code&gt; 
 */

#ifndef OAIDeleteMessageBatchResultEntry_H
#define OAIDeleteMessageBatchResultEntry_H
...
class OAIDeleteMessageBatchResultEntry : public OAIObject {
public:
    OAIDeleteMessageBatchResultEntry();
    OAIDeleteMessageBatchResultEntry(QString json);
    ~OAIDeleteMessageBatchResultEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMessageBatchResultEntry)

#endif // OAIDeleteMessageBatchResultEntry_H
