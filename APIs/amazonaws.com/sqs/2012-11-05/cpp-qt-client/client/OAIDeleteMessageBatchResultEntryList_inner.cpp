...
#include "OAIDeleteMessageBatchResultEntryList_inner.h"
...
OAIDeleteMessageBatchResultEntryList_inner::OAIDeleteMessageBatchResultEntryList_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMessageBatchResultEntryList_inner::OAIDeleteMessageBatchResultEntryList_inner() {
    this->initializeModel();
}

OAIDeleteMessageBatchResultEntryList_inner::~OAIDeleteMessageBatchResultEntryList_inner() {}

void OAIDeleteMessageBatchResultEntryList_inner::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIDeleteMessageBatchResultEntryList_inner::fromJson(QString jsonString) {
...
void OAIDeleteMessageBatchResultEntryList_inner::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIDeleteMessageBatchResultEntryList_inner::asJson() const {
...
QJsonObject OAIDeleteMessageBatchResultEntryList_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDeleteMessageBatchResultEntryList_inner::getId() const {
    return m_id;
}
void OAIDeleteMessageBatchResultEntryList_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteMessageBatchResultEntryList_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteMessageBatchResultEntryList_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDeleteMessageBatchResultEntryList_inner::isSet() const {
...
bool OAIDeleteMessageBatchResultEntryList_inner::isValid() const {
