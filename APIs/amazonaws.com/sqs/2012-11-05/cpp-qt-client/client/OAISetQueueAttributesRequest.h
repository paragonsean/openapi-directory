...
/*
 * OAISetQueueAttributesRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAISetQueueAttributesRequest_H
#define OAISetQueueAttributesRequest_H
...
class OAISetQueueAttributesRequest : public OAIObject {
public:
    OAISetQueueAttributesRequest();
    OAISetQueueAttributesRequest(QString json);
    ~OAISetQueueAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetQueueAttributesRequest)

#endif // OAISetQueueAttributesRequest_H
