...
/*
 * OAIUntagQueueRequest.h
 *
 * 
 */

#ifndef OAIUntagQueueRequest_H
#define OAIUntagQueueRequest_H
...
class OAIUntagQueueRequest : public OAIObject {
public:
    OAIUntagQueueRequest();
    OAIUntagQueueRequest(QString json);
    ~OAIUntagQueueRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagQueueRequest)

#endif // OAIUntagQueueRequest_H
