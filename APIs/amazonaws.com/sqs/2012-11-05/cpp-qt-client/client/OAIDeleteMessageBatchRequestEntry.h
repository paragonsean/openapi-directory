...
/*
 * OAIDeleteMessageBatchRequestEntry.h
 *
 * Encloses a receipt handle and an identifier for it.
 */

#ifndef OAIDeleteMessageBatchRequestEntry_H
#define OAIDeleteMessageBatchRequestEntry_H
...
class OAIDeleteMessageBatchRequestEntry : public OAIObject {
public:
    OAIDeleteMessageBatchRequestEntry();
    OAIDeleteMessageBatchRequestEntry(QString json);
    ~OAIDeleteMessageBatchRequestEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMessageBatchRequestEntry)

#endif // OAIDeleteMessageBatchRequestEntry_H
