...
/*
 * OAIGetQueueAttributesResult.h
 *
 * A list of returned queue attributes.
 */

#ifndef OAIGetQueueAttributesResult_H
#define OAIGetQueueAttributesResult_H
...
class OAIGetQueueAttributesResult : public OAIObject {
public:
    OAIGetQueueAttributesResult();
    OAIGetQueueAttributesResult(QString json);
    ~OAIGetQueueAttributesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetQueueAttributesResult)

#endif // OAIGetQueueAttributesResult_H
