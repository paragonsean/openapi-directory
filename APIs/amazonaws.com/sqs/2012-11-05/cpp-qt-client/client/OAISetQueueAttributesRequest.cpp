...
OAISetQueueAttributesRequest::OAISetQueueAttributesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetQueueAttributesRequest::OAISetQueueAttributesRequest() {
    this->initializeModel();
}

OAISetQueueAttributesRequest::~OAISetQueueAttributesRequest() {}

void OAISetQueueAttributesRequest::initializeModel() {
...
void OAISetQueueAttributesRequest::fromJson(QString jsonString) {
...
void OAISetQueueAttributesRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetQueueAttributesRequest::asJson() const {
...
QJsonObject OAISetQueueAttributesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetQueueAttributesRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAISetQueueAttributesRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAISetQueueAttributesRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAISetQueueAttributesRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QMap OAISetQueueAttributesRequest::getAttributes() const {
    return m_attributes;
}
void OAISetQueueAttributesRequest::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAISetQueueAttributesRequest::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAISetQueueAttributesRequest::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAISetQueueAttributesRequest::isSet() const {
...
bool OAISetQueueAttributesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_queue_url_isValid && m_attributes_isValid && true;
}
