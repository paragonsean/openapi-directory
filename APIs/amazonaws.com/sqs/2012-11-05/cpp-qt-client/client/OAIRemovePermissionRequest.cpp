...
QString OAIRemovePermissionRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIRemovePermissionRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIRemovePermissionRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIRemovePermissionRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QString OAIRemovePermissionRequest::getLabel() const {
    return m_label;
}
void OAIRemovePermissionRequest::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIRemovePermissionRequest::is_label_Set() const{
    return m_label_isSet;
}

bool OAIRemovePermissionRequest::is_label_Valid() const{
...
bool OAIRemovePermissionRequest::isValid() const {
    ...
    return m_queue_url_isValid && m_label_isValid && true;
}
