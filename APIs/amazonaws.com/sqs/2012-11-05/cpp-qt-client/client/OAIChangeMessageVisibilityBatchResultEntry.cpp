...
#include "OAIChangeMessageVisibilityBatchResultEntry.h"
...
OAIChangeMessageVisibilityBatchResultEntry::OAIChangeMessageVisibilityBatchResultEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeMessageVisibilityBatchResultEntry::OAIChangeMessageVisibilityBatchResultEntry() {
    this->initializeModel();
}

OAIChangeMessageVisibilityBatchResultEntry::~OAIChangeMessageVisibilityBatchResultEntry() {}

void OAIChangeMessageVisibilityBatchResultEntry::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIChangeMessageVisibilityBatchResultEntry::fromJson(QString jsonString) {
...
void OAIChangeMessageVisibilityBatchResultEntry::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIChangeMessageVisibilityBatchResultEntry::asJson() const {
...
QJsonObject OAIChangeMessageVisibilityBatchResultEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIChangeMessageVisibilityBatchResultEntry::getId() const {
    return m_id;
}
void OAIChangeMessageVisibilityBatchResultEntry::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChangeMessageVisibilityBatchResultEntry::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChangeMessageVisibilityBatchResultEntry::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIChangeMessageVisibilityBatchResultEntry::isSet() const {
...
bool OAIChangeMessageVisibilityBatchResultEntry::isValid() const {
