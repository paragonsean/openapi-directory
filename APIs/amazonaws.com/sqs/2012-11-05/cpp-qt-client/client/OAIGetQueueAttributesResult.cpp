...
OAIGetQueueAttributesResult::OAIGetQueueAttributesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetQueueAttributesResult::OAIGetQueueAttributesResult() {
    this->initializeModel();
}

OAIGetQueueAttributesResult::~OAIGetQueueAttributesResult() {}

void OAIGetQueueAttributesResult::initializeModel() {

    m_attributes_isSet = false;
    m_attributes_isValid = false;
}

void OAIGetQueueAttributesResult::fromJson(QString jsonString) {
...
void OAIGetQueueAttributesResult::fromJsonObject(QJsonObject json) {

    m_attributes_isValid = ::OpenAPI::fromJsonValue(m_attributes, json[QString("Attributes")]);
    m_attributes_isSet = !json[QString("Attributes")].isNull() && m_attributes_isValid;
}

QString OAIGetQueueAttributesResult::asJson() const {
...
QJsonObject OAIGetQueueAttributesResult::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIGetQueueAttributesResult::getAttributes() const {
    return m_attributes;
}
void OAIGetQueueAttributesResult::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIGetQueueAttributesResult::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIGetQueueAttributesResult::is_attributes_Valid() const{
    return m_attributes_isValid;
}

bool OAIGetQueueAttributesResult::isSet() const {
...
bool OAIGetQueueAttributesResult::isValid() const {
