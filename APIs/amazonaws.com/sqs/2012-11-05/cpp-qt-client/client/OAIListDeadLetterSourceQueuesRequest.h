...
/*
 * OAIListDeadLetterSourceQueuesRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIListDeadLetterSourceQueuesRequest_H
#define OAIListDeadLetterSourceQueuesRequest_H
...
class OAIListDeadLetterSourceQueuesRequest : public OAIObject {
public:
    OAIListDeadLetterSourceQueuesRequest();
    OAIListDeadLetterSourceQueuesRequest(QString json);
    ~OAIListDeadLetterSourceQueuesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeadLetterSourceQueuesRequest)

#endif // OAIListDeadLetterSourceQueuesRequest_H
