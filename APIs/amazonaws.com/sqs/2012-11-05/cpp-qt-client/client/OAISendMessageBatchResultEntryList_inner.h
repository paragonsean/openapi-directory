...
/*
 * OAISendMessageBatchResultEntryList_inner.h
 *
 * 
 */

#ifndef OAISendMessageBatchResultEntryList_inner_H
#define OAISendMessageBatchResultEntryList_inner_H
...
class OAISendMessageBatchResultEntryList_inner : public OAIObject {
public:
    OAISendMessageBatchResultEntryList_inner();
    OAISendMessageBatchResultEntryList_inner(QString json);
    ~OAISendMessageBatchResultEntryList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessageBatchResultEntryList_inner)

#endif // OAISendMessageBatchResultEntryList_inner_H
