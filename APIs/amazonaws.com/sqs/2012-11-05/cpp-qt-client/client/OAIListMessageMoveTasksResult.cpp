...
OAIListMessageMoveTasksResult::OAIListMessageMoveTasksResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListMessageMoveTasksResult::OAIListMessageMoveTasksResult() {
    this->initializeModel();
}

OAIListMessageMoveTasksResult::~OAIListMessageMoveTasksResult() {}

void OAIListMessageMoveTasksResult::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAIListMessageMoveTasksResult::fromJson(QString jsonString) {
...
void OAIListMessageMoveTasksResult::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("Results")]);
    m_results_isSet = !json[QString("Results")].isNull() && m_results_isValid;
}

QString OAIListMessageMoveTasksResult::asJson() const {
...
QJsonObject OAIListMessageMoveTasksResult::asJsonObject() const {
    QJsonObject obj;
    if (m_results.isSet()) {
...
QList OAIListMessageMoveTasksResult::getResults() const {
    return m_results;
}
void OAIListMessageMoveTasksResult::setResults(const QList &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIListMessageMoveTasksResult::is_results_Set() const{
    return m_results_isSet;
}

bool OAIListMessageMoveTasksResult::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIListMessageMoveTasksResult::isSet() const {
...
bool OAIListMessageMoveTasksResult::isValid() const {
