...
#ifndef OAIDeleteMessageBatchResult_H
#define OAIDeleteMessageBatchResult_H
...
class OAIDeleteMessageBatchResult : public OAIObject {
public:
    OAIDeleteMessageBatchResult();
    OAIDeleteMessageBatchResult(QString json);
    ~OAIDeleteMessageBatchResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMessageBatchResult)

#endif // OAIDeleteMessageBatchResult_H
