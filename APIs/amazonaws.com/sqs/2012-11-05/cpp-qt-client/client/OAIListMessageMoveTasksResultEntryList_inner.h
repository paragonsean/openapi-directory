...
/*
 * OAIListMessageMoveTasksResultEntryList_inner.h
 *
 * 
 */

#ifndef OAIListMessageMoveTasksResultEntryList_inner_H
#define OAIListMessageMoveTasksResultEntryList_inner_H
...
class OAIListMessageMoveTasksResultEntryList_inner : public OAIObject {
public:
    OAIListMessageMoveTasksResultEntryList_inner();
    OAIListMessageMoveTasksResultEntryList_inner(QString json);
    ~OAIListMessageMoveTasksResultEntryList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMessageMoveTasksResultEntryList_inner)

#endif // OAIListMessageMoveTasksResultEntryList_inner_H
