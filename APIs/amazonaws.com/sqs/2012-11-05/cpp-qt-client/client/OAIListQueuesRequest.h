...
/*
 * OAIListQueuesRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIListQueuesRequest_H
#define OAIListQueuesRequest_H
...
class OAIListQueuesRequest : public OAIObject {
public:
    OAIListQueuesRequest();
    OAIListQueuesRequest(QString json);
    ~OAIListQueuesRequest() override;
    ...
    QString getQueueNamePrefix() const;
    void setQueueNamePrefix(const QString &queue_name_prefix);
    bool is_queue_name_prefix_Set() const;
    bool is_queue_name_prefix_Valid() const;
...
private:
    ...
    QString m_queue_name_prefix;
    bool m_queue_name_prefix_isSet;
    bool m_queue_name_prefix_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListQueuesRequest)

#endif // OAIListQueuesRequest_H
