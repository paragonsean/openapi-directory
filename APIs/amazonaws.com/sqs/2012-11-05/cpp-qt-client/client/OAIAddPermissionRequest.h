...
/*
 * OAIAddPermissionRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIAddPermissionRequest_H
#define OAIAddPermissionRequest_H
...
class OAIAddPermissionRequest : public OAIObject {
public:
    OAIAddPermissionRequest();
    OAIAddPermissionRequest(QString json);
    ~OAIAddPermissionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddPermissionRequest)

#endif // OAIAddPermissionRequest_H
