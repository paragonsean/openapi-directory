...
OAISendMessageResult::OAISendMessageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessageResult::OAISendMessageResult() {
    this->initializeModel();
}

OAISendMessageResult::~OAISendMessageResult() {}

void OAISendMessageResult::initializeModel() {
...
void OAISendMessageResult::fromJson(QString jsonString) {
...
void OAISendMessageResult::fromJsonObject(QJsonObject json) {
...
QString OAISendMessageResult::asJson() const {
...
QJsonObject OAISendMessageResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAISendMessageResult::getMd5OfMessageBody() const {
    return m_md5_of_message_body;
}
void OAISendMessageResult::setMd5OfMessageBody(const QString &md5_of_message_body) {
    m_md5_of_message_body = md5_of_message_body;
    m_md5_of_message_body_isSet = true;
}

bool OAISendMessageResult::is_md5_of_message_body_Set() const{
    return m_md5_of_message_body_isSet;
}

bool OAISendMessageResult::is_md5_of_message_body_Valid() const{
    return m_md5_of_message_body_isValid;
}

QString OAISendMessageResult::getMd5OfMessageAttributes() const {
    return m_md5_of_message_attributes;
}
void OAISendMessageResult::setMd5OfMessageAttributes(const QString &md5_of_message_attributes) {
    m_md5_of_message_attributes = md5_of_message_attributes;
    m_md5_of_message_attributes_isSet = true;
}

bool OAISendMessageResult::is_md5_of_message_attributes_Set() const{
    return m_md5_of_message_attributes_isSet;
}

bool OAISendMessageResult::is_md5_of_message_attributes_Valid() const{
    return m_md5_of_message_attributes_isValid;
}

QString OAISendMessageResult::getMd5OfMessageSystemAttributes() const {
    return m_md5_of_message_system_attributes;
}
void OAISendMessageResult::setMd5OfMessageSystemAttributes(const QString &md5_of_message_system_attributes) {
    m_md5_of_message_system_attributes = md5_of_message_system_attributes;
    m_md5_of_message_system_attributes_isSet = true;
}

bool OAISendMessageResult::is_md5_of_message_system_attributes_Set() const{
    return m_md5_of_message_system_attributes_isSet;
}

bool OAISendMessageResult::is_md5_of_message_system_attributes_Valid() const{
    return m_md5_of_message_system_attributes_isValid;
}

QString OAISendMessageResult::getMessageId() const {
    return m_message_id;
}
void OAISendMessageResult::setMessageId(const QString &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAISendMessageResult::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAISendMessageResult::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAISendMessageResult::getSequenceNumber() const {
    return m_sequence_number;
}
void OAISendMessageResult::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAISendMessageResult::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAISendMessageResult::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

bool OAISendMessageResult::isSet() const {
...
bool OAISendMessageResult::isValid() const {
