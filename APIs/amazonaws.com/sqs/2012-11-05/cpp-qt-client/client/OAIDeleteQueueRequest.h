...
/*
 * OAIDeleteQueueRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDeleteQueueRequest_H
#define OAIDeleteQueueRequest_H
...
class OAIDeleteQueueRequest : public OAIObject {
public:
    OAIDeleteQueueRequest();
    OAIDeleteQueueRequest(QString json);
    ~OAIDeleteQueueRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteQueueRequest)

#endif // OAIDeleteQueueRequest_H
