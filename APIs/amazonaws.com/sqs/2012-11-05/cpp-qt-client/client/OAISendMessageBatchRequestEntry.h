...
/*
 * OAISendMessageBatchRequestEntry.h
 *
 * Contains the details of a single Amazon SQS message along with an &lt;code&gt;Id&lt;/code&gt;.
 */

#ifndef OAISendMessageBatchRequestEntry_H
#define OAISendMessageBatchRequestEntry_H
...
class OAISendMessageBatchRequestEntry : public OAIObject {
public:
    OAISendMessageBatchRequestEntry();
    OAISendMessageBatchRequestEntry(QString json);
    ~OAISendMessageBatchRequestEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessageBatchRequestEntry)

#endif // OAISendMessageBatchRequestEntry_H
