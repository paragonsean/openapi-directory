...
#ifndef OAISendMessageBatchResult_H
#define OAISendMessageBatchResult_H
...
class OAISendMessageBatchResult : public OAIObject {
public:
    OAISendMessageBatchResult();
    OAISendMessageBatchResult(QString json);
    ~OAISendMessageBatchResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessageBatchResult)

#endif // OAISendMessageBatchResult_H
