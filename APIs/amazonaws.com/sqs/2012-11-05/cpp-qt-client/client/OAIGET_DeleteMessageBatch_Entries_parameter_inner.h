...
/*
 * OAIGET_DeleteMessageBatch_Entries_parameter_inner.h
 *
 * 
 */

#ifndef OAIGET_DeleteMessageBatch_Entries_parameter_inner_H
#define OAIGET_DeleteMessageBatch_Entries_parameter_inner_H
...
class OAIGET_DeleteMessageBatch_Entries_parameter_inner : public OAIObject {
public:
    OAIGET_DeleteMessageBatch_Entries_parameter_inner();
    OAIGET_DeleteMessageBatch_Entries_parameter_inner(QString json);
    ~OAIGET_DeleteMessageBatch_Entries_parameter_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET_DeleteMessageBatch_Entries_parameter_inner)

#endif // OAIGET_DeleteMessageBatch_Entries_parameter_inner_H
