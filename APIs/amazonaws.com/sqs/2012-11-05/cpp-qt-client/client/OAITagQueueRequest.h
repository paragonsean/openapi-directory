...
/*
 * OAITagQueueRequest.h
 *
 * 
 */

#ifndef OAITagQueueRequest_H
#define OAITagQueueRequest_H
...
class OAITagQueueRequest : public OAIObject {
public:
    OAITagQueueRequest();
    OAITagQueueRequest(QString json);
    ~OAITagQueueRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagQueueRequest)

#endif // OAITagQueueRequest_H
