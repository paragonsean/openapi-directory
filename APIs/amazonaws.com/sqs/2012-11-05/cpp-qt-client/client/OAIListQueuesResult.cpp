...
OAIListQueuesResult::OAIListQueuesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListQueuesResult::OAIListQueuesResult() {
    this->initializeModel();
}

OAIListQueuesResult::~OAIListQueuesResult() {}

void OAIListQueuesResult::initializeModel() {
...
void OAIListQueuesResult::fromJson(QString jsonString) {
...
void OAIListQueuesResult::fromJsonObject(QJsonObject json) {
...
QString OAIListQueuesResult::asJson() const {
...
QJsonObject OAIListQueuesResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListQueuesResult::getQueueUrls() const {
    return m_queue_urls;
}
void OAIListQueuesResult::setQueueUrls(const QList &queue_urls) {
    m_queue_urls = queue_urls;
    m_queue_urls_isSet = true;
}

bool OAIListQueuesResult::is_queue_urls_Set() const{
    return m_queue_urls_isSet;
}

bool OAIListQueuesResult::is_queue_urls_Valid() const{
    return m_queue_urls_isValid;
}

QString OAIListQueuesResult::getNextToken() const {
    return m_next_token;
}
void OAIListQueuesResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListQueuesResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListQueuesResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListQueuesResult::isSet() const {
...
bool OAIListQueuesResult::isValid() const {
