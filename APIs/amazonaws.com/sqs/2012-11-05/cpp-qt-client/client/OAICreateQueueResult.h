...
/*
 * OAICreateQueueResult.h
 *
 * Returns the &lt;code&gt;QueueUrl&lt;/code&gt; attribute of the created queue.
 */

#ifndef OAICreateQueueResult_H
#define OAICreateQueueResult_H
...
class OAICreateQueueResult : public OAIObject {
public:
    OAICreateQueueResult();
    OAICreateQueueResult(QString json);
    ~OAICreateQueueResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateQueueResult)

#endif // OAICreateQueueResult_H
