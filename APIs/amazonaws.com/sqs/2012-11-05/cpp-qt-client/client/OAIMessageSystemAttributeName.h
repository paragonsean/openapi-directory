...
/*
 * OAIMessageSystemAttributeName.h
 *
 * 
 */

#ifndef OAIMessageSystemAttributeName_H
#define OAIMessageSystemAttributeName_H
...
class OAIMessageSystemAttributeName : public OAIEnum {
public:
    OAIMessageSystemAttributeName();
    OAIMessageSystemAttributeName(QString json);
    ~OAIMessageSystemAttributeName() override;
    ...
    enum class eOAIMessageSystemAttributeName {
    ...
    OAIMessageSystemAttributeName::eOAIMessageSystemAttributeName getValue() const;
    void setValue(const OAIMessageSystemAttributeName::eOAIMessageSystemAttributeName& value);
...
private:
    ...
    eOAIMessageSystemAttributeName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageSystemAttributeName)

#endif // OAIMessageSystemAttributeName_H
