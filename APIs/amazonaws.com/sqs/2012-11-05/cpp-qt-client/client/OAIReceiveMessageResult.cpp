...
OAIReceiveMessageResult::OAIReceiveMessageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReceiveMessageResult::OAIReceiveMessageResult() {
    this->initializeModel();
}

OAIReceiveMessageResult::~OAIReceiveMessageResult() {}

void OAIReceiveMessageResult::initializeModel() {

    m_messages_isSet = false;
    m_messages_isValid = false;
}

void OAIReceiveMessageResult::fromJson(QString jsonString) {
...
void OAIReceiveMessageResult::fromJsonObject(QJsonObject json) {
...
QString OAIReceiveMessageResult::asJson() const {
...
QJsonObject OAIReceiveMessageResult::asJsonObject() const {
    QJsonObject obj;
    if (m_messages.isSet()) {
...
QList OAIReceiveMessageResult::getMessages() const {
    return m_messages;
}
void OAIReceiveMessageResult::setMessages(const QList &messages) {
    m_messages = messages;
    m_messages_isSet = true;
}

bool OAIReceiveMessageResult::is_messages_Set() const{
    return m_messages_isSet;
}

bool OAIReceiveMessageResult::is_messages_Valid() const{
    return m_messages_isValid;
}

bool OAIReceiveMessageResult::isSet() const {
...
bool OAIReceiveMessageResult::isValid() const {
