...
/*
 * OAIListQueuesResult.h
 *
 * A list of your queues.
 */

#ifndef OAIListQueuesResult_H
#define OAIListQueuesResult_H
...
class OAIListQueuesResult : public OAIObject {
public:
    OAIListQueuesResult();
    OAIListQueuesResult(QString json);
    ~OAIListQueuesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListQueuesResult)

#endif // OAIListQueuesResult_H
