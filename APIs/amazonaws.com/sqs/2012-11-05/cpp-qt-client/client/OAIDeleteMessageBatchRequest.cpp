...
OAIDeleteMessageBatchRequest::OAIDeleteMessageBatchRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMessageBatchRequest::OAIDeleteMessageBatchRequest() {
    this->initializeModel();
}

OAIDeleteMessageBatchRequest::~OAIDeleteMessageBatchRequest() {}

void OAIDeleteMessageBatchRequest::initializeModel() {
...
void OAIDeleteMessageBatchRequest::fromJson(QString jsonString) {
...
void OAIDeleteMessageBatchRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteMessageBatchRequest::asJson() const {
...
QJsonObject OAIDeleteMessageBatchRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteMessageBatchRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIDeleteMessageBatchRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIDeleteMessageBatchRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIDeleteMessageBatchRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QList OAIDeleteMessageBatchRequest::getEntries() const {
    return m_entries;
}
void OAIDeleteMessageBatchRequest::setEntries(const QList &entries) {
    m_entries = entries;
    m_entries_isSet = true;
}

bool OAIDeleteMessageBatchRequest::is_entries_Set() const{
    return m_entries_isSet;
}

bool OAIDeleteMessageBatchRequest::is_entries_Valid() const{
    return m_entries_isValid;
}

bool OAIDeleteMessageBatchRequest::isSet() const {
...
bool OAIDeleteMessageBatchRequest::isValid() const {
