...
#include "OAIDeleteMessageBatchResultEntry.h"
...
OAIDeleteMessageBatchResultEntry::OAIDeleteMessageBatchResultEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteMessageBatchResultEntry::OAIDeleteMessageBatchResultEntry() {
    this->initializeModel();
}

OAIDeleteMessageBatchResultEntry::~OAIDeleteMessageBatchResultEntry() {}

void OAIDeleteMessageBatchResultEntry::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIDeleteMessageBatchResultEntry::fromJson(QString jsonString) {
...
void OAIDeleteMessageBatchResultEntry::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("Id")]);
    m_id_isSet = !json[QString("Id")].isNull() && m_id_isValid;
}

QString OAIDeleteMessageBatchResultEntry::asJson() const {
...
QJsonObject OAIDeleteMessageBatchResultEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDeleteMessageBatchResultEntry::getId() const {
    return m_id;
}
void OAIDeleteMessageBatchResultEntry::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDeleteMessageBatchResultEntry::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDeleteMessageBatchResultEntry::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDeleteMessageBatchResultEntry::isSet() const {
...
bool OAIDeleteMessageBatchResultEntry::isValid() const {
