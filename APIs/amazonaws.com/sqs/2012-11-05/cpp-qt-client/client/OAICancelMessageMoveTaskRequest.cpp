...
OAICancelMessageMoveTaskRequest::OAICancelMessageMoveTaskRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICancelMessageMoveTaskRequest::OAICancelMessageMoveTaskRequest() {
    this->initializeModel();
}

OAICancelMessageMoveTaskRequest::~OAICancelMessageMoveTaskRequest() {}

void OAICancelMessageMoveTaskRequest::initializeModel() {

    m_task_handle_isSet = false;
    m_task_handle_isValid = false;
}

void OAICancelMessageMoveTaskRequest::fromJson(QString jsonString) {
...
void OAICancelMessageMoveTaskRequest::fromJsonObject(QJsonObject json) {
...
QString OAICancelMessageMoveTaskRequest::asJson() const {
...
QJsonObject OAICancelMessageMoveTaskRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICancelMessageMoveTaskRequest::getTaskHandle() const {
    return m_task_handle;
}
void OAICancelMessageMoveTaskRequest::setTaskHandle(const QString &task_handle) {
    m_task_handle = task_handle;
    m_task_handle_isSet = true;
}

bool OAICancelMessageMoveTaskRequest::is_task_handle_Set() const{
    return m_task_handle_isSet;
}

bool OAICancelMessageMoveTaskRequest::is_task_handle_Valid() const{
    return m_task_handle_isValid;
}

bool OAICancelMessageMoveTaskRequest::isSet() const {
...
bool OAICancelMessageMoveTaskRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_task_handle_isValid && true;
}
