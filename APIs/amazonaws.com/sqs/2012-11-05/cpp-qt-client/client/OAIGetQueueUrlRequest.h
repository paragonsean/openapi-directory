...
/*
 * OAIGetQueueUrlRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIGetQueueUrlRequest_H
#define OAIGetQueueUrlRequest_H
...
class OAIGetQueueUrlRequest : public OAIObject {
public:
    OAIGetQueueUrlRequest();
    OAIGetQueueUrlRequest(QString json);
    ~OAIGetQueueUrlRequest() override;
    ...
    QString getQueueOwnerAwsAccountId() const;
    void setQueueOwnerAwsAccountId(const QString &queue_owner_aws_account_id);
    bool is_queue_owner_aws_account_id_Set() const;
    bool is_queue_owner_aws_account_id_Valid() const;
...
private:
    ...
    QString m_queue_owner_aws_account_id;
    bool m_queue_owner_aws_account_id_isSet;
    bool m_queue_owner_aws_account_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetQueueUrlRequest)

#endif // OAIGetQueueUrlRequest_H
