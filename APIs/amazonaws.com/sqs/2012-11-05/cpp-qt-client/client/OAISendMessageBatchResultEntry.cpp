...
#include "OAISendMessageBatchResultEntry.h"
...
OAISendMessageBatchResultEntry::OAISendMessageBatchResultEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessageBatchResultEntry::OAISendMessageBatchResultEntry() {
    this->initializeModel();
}

OAISendMessageBatchResultEntry::~OAISendMessageBatchResultEntry() {}

void OAISendMessageBatchResultEntry::initializeModel() {
...
void OAISendMessageBatchResultEntry::fromJson(QString jsonString) {
...
void OAISendMessageBatchResultEntry::fromJsonObject(QJsonObject json) {
...
QString OAISendMessageBatchResultEntry::asJson() const {
...
QJsonObject OAISendMessageBatchResultEntry::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAISendMessageBatchResultEntry::getId() const {
    return m_id;
}
void OAISendMessageBatchResultEntry::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_id_Set() const{
    return m_id_isSet;
}

bool OAISendMessageBatchResultEntry::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISendMessageBatchResultEntry::getMessageId() const {
    return m_message_id;
}
void OAISendMessageBatchResultEntry::setMessageId(const QString &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAISendMessageBatchResultEntry::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAISendMessageBatchResultEntry::getMd5OfMessageBody() const {
    return m_md5_of_message_body;
}
void OAISendMessageBatchResultEntry::setMd5OfMessageBody(const QString &md5_of_message_body) {
    m_md5_of_message_body = md5_of_message_body;
    m_md5_of_message_body_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_body_Set() const{
    return m_md5_of_message_body_isSet;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_body_Valid() const{
    return m_md5_of_message_body_isValid;
}

QString OAISendMessageBatchResultEntry::getMd5OfMessageAttributes() const {
    return m_md5_of_message_attributes;
}
void OAISendMessageBatchResultEntry::setMd5OfMessageAttributes(const QString &md5_of_message_attributes) {
    m_md5_of_message_attributes = md5_of_message_attributes;
    m_md5_of_message_attributes_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_attributes_Set() const{
    return m_md5_of_message_attributes_isSet;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_attributes_Valid() const{
    return m_md5_of_message_attributes_isValid;
}

QString OAISendMessageBatchResultEntry::getMd5OfMessageSystemAttributes() const {
    return m_md5_of_message_system_attributes;
}
void OAISendMessageBatchResultEntry::setMd5OfMessageSystemAttributes(const QString &md5_of_message_system_attributes) {
    m_md5_of_message_system_attributes = md5_of_message_system_attributes;
    m_md5_of_message_system_attributes_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_system_attributes_Set() const{
    return m_md5_of_message_system_attributes_isSet;
}

bool OAISendMessageBatchResultEntry::is_md5_of_message_system_attributes_Valid() const{
    return m_md5_of_message_system_attributes_isValid;
}

QString OAISendMessageBatchResultEntry::getSequenceNumber() const {
    return m_sequence_number;
}
void OAISendMessageBatchResultEntry::setSequenceNumber(const QString &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAISendMessageBatchResultEntry::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAISendMessageBatchResultEntry::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

bool OAISendMessageBatchResultEntry::isSet() const {
...
bool OAISendMessageBatchResultEntry::isValid() const {
