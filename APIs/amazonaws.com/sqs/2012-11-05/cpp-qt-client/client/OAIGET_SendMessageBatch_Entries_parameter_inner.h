...
/*
 * OAIGET_SendMessageBatch_Entries_parameter_inner.h
 *
 * 
 */

#ifndef OAIGET_SendMessageBatch_Entries_parameter_inner_H
#define OAIGET_SendMessageBatch_Entries_parameter_inner_H
...
class OAIGET_SendMessageBatch_Entries_parameter_inner : public OAIObject {
public:
    OAIGET_SendMessageBatch_Entries_parameter_inner();
    OAIGET_SendMessageBatch_Entries_parameter_inner(QString json);
    ~OAIGET_SendMessageBatch_Entries_parameter_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET_SendMessageBatch_Entries_parameter_inner)

#endif // OAIGET_SendMessageBatch_Entries_parameter_inner_H
