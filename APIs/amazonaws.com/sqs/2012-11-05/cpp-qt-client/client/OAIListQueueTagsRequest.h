...
/*
 * OAIListQueueTagsRequest.h
 *
 * 
 */

#ifndef OAIListQueueTagsRequest_H
#define OAIListQueueTagsRequest_H
...
class OAIListQueueTagsRequest : public OAIObject {
public:
    OAIListQueueTagsRequest();
    OAIListQueueTagsRequest(QString json);
    ~OAIListQueueTagsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListQueueTagsRequest)

#endif // OAIListQueueTagsRequest_H
