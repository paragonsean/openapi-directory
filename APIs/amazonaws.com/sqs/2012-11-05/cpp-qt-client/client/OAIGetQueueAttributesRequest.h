...
/*
 * OAIGetQueueAttributesRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIGetQueueAttributesRequest_H
#define OAIGetQueueAttributesRequest_H
...
class OAIGetQueueAttributesRequest : public OAIObject {
public:
    OAIGetQueueAttributesRequest();
    OAIGetQueueAttributesRequest(QString json);
    ~OAIGetQueueAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetQueueAttributesRequest)

#endif // OAIGetQueueAttributesRequest_H
