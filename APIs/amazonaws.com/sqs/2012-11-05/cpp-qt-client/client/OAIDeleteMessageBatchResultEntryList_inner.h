...
/*
 * OAIDeleteMessageBatchResultEntryList_inner.h
 *
 * 
 */

#ifndef OAIDeleteMessageBatchResultEntryList_inner_H
#define OAIDeleteMessageBatchResultEntryList_inner_H
...
class OAIDeleteMessageBatchResultEntryList_inner : public OAIObject {
public:
    OAIDeleteMessageBatchResultEntryList_inner();
    OAIDeleteMessageBatchResultEntryList_inner(QString json);
    ~OAIDeleteMessageBatchResultEntryList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMessageBatchResultEntryList_inner)

#endif // OAIDeleteMessageBatchResultEntryList_inner_H
