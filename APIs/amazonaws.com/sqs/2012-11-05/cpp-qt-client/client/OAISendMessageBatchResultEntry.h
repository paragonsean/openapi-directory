...
/*
 * OAISendMessageBatchResultEntry.h
 *
 * Encloses a &lt;code&gt;MessageId&lt;/code&gt; for a successfully-enqueued message in a &lt;code&gt; &lt;a&gt;SendMessageBatch&lt;/a&gt;.&lt;/code&gt; 
 */

#ifndef OAISendMessageBatchResultEntry_H
#define OAISendMessageBatchResultEntry_H
...
class OAISendMessageBatchResultEntry : public OAIObject {
public:
    OAISendMessageBatchResultEntry();
    OAISendMessageBatchResultEntry(QString json);
    ~OAISendMessageBatchResultEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessageBatchResultEntry)

#endif // OAISendMessageBatchResultEntry_H
