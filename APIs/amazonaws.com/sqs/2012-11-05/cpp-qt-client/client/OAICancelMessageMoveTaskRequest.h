...
/*
 * OAICancelMessageMoveTaskRequest.h
 *
 * 
 */

#ifndef OAICancelMessageMoveTaskRequest_H
#define OAICancelMessageMoveTaskRequest_H
...
class OAICancelMessageMoveTaskRequest : public OAIObject {
public:
    OAICancelMessageMoveTaskRequest();
    OAICancelMessageMoveTaskRequest(QString json);
    ~OAICancelMessageMoveTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelMessageMoveTaskRequest)

#endif // OAICancelMessageMoveTaskRequest_H
