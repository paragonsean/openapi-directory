...
OAICreateQueueResult::OAICreateQueueResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateQueueResult::OAICreateQueueResult() {
    this->initializeModel();
}

OAICreateQueueResult::~OAICreateQueueResult() {}

void OAICreateQueueResult::initializeModel() {

    m_queue_url_isSet = false;
    m_queue_url_isValid = false;
}

void OAICreateQueueResult::fromJson(QString jsonString) {
...
void OAICreateQueueResult::fromJsonObject(QJsonObject json) {
...
QString OAICreateQueueResult::asJson() const {
...
QJsonObject OAICreateQueueResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateQueueResult::getQueueUrl() const {
    return m_queue_url;
}
void OAICreateQueueResult::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAICreateQueueResult::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAICreateQueueResult::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

bool OAICreateQueueResult::isSet() const {
...
bool OAICreateQueueResult::isValid() const {
