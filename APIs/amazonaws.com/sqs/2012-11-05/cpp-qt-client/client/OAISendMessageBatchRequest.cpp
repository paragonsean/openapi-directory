...
OAISendMessageBatchRequest::OAISendMessageBatchRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessageBatchRequest::OAISendMessageBatchRequest() {
    this->initializeModel();
}

OAISendMessageBatchRequest::~OAISendMessageBatchRequest() {}

void OAISendMessageBatchRequest::initializeModel() {
...
void OAISendMessageBatchRequest::fromJson(QString jsonString) {
...
void OAISendMessageBatchRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendMessageBatchRequest::asJson() const {
...
QJsonObject OAISendMessageBatchRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISendMessageBatchRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAISendMessageBatchRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAISendMessageBatchRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAISendMessageBatchRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QList OAISendMessageBatchRequest::getEntries() const {
    return m_entries;
}
void OAISendMessageBatchRequest::setEntries(const QList &entries) {
    m_entries = entries;
    m_entries_isSet = true;
}

bool OAISendMessageBatchRequest::is_entries_Set() const{
    return m_entries_isSet;
}

bool OAISendMessageBatchRequest::is_entries_Valid() const{
    return m_entries_isValid;
}

bool OAISendMessageBatchRequest::isSet() const {
...
bool OAISendMessageBatchRequest::isValid() const {
