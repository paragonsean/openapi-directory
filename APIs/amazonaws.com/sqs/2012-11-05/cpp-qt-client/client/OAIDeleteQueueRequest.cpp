...
OAIDeleteQueueRequest::OAIDeleteQueueRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteQueueRequest::OAIDeleteQueueRequest() {
    this->initializeModel();
}

OAIDeleteQueueRequest::~OAIDeleteQueueRequest() {}

void OAIDeleteQueueRequest::initializeModel() {

    m_queue_url_isSet = false;
    m_queue_url_isValid = false;
}

void OAIDeleteQueueRequest::fromJson(QString jsonString) {
...
void OAIDeleteQueueRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteQueueRequest::asJson() const {
...
QJsonObject OAIDeleteQueueRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteQueueRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIDeleteQueueRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIDeleteQueueRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIDeleteQueueRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

bool OAIDeleteQueueRequest::isSet() const {
...
bool OAIDeleteQueueRequest::isValid() const {
