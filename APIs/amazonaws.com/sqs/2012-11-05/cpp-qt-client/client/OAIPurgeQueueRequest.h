...
/*
 * OAIPurgeQueueRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIPurgeQueueRequest_H
#define OAIPurgeQueueRequest_H
...
class OAIPurgeQueueRequest : public OAIObject {
public:
    OAIPurgeQueueRequest();
    OAIPurgeQueueRequest(QString json);
    ~OAIPurgeQueueRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurgeQueueRequest)

#endif // OAIPurgeQueueRequest_H
