...
OAIPurgeQueueRequest::OAIPurgeQueueRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPurgeQueueRequest::OAIPurgeQueueRequest() {
    this->initializeModel();
}

OAIPurgeQueueRequest::~OAIPurgeQueueRequest() {}

void OAIPurgeQueueRequest::initializeModel() {

    m_queue_url_isSet = false;
    m_queue_url_isValid = false;
}

void OAIPurgeQueueRequest::fromJson(QString jsonString) {
...
void OAIPurgeQueueRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPurgeQueueRequest::asJson() const {
...
QJsonObject OAIPurgeQueueRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPurgeQueueRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIPurgeQueueRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIPurgeQueueRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIPurgeQueueRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

bool OAIPurgeQueueRequest::isSet() const {
...
bool OAIPurgeQueueRequest::isValid() const {
