...
QString OAISendMessageRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAISendMessageRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAISendMessageRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAISendMessageRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QString OAISendMessageRequest::getMessageBody() const {
    return m_message_body;
}
void OAISendMessageRequest::setMessageBody(const QString &message_body) {
    m_message_body = message_body;
    m_message_body_isSet = true;
}

bool OAISendMessageRequest::is_message_body_Set() const{
    return m_message_body_isSet;
}

bool OAISendMessageRequest::is_message_body_Valid() const{
    return m_message_body_isValid;
}

qint32 OAISendMessageRequest::getDelaySeconds() const {
    return m_delay_seconds;
}
void OAISendMessageRequest::setDelaySeconds(const qint32 &delay_seconds) {
    m_delay_seconds = delay_seconds;
    m_delay_seconds_isSet = true;
}

bool OAISendMessageRequest::is_delay_seconds_Set() const{
    return m_delay_seconds_isSet;
}

bool OAISendMessageRequest::is_delay_seconds_Valid() const{
    return m_delay_seconds_isValid;
}

QMap OAISendMessageRequest::getMessageAttributes() const {
    return m_message_attributes;
}
void OAISendMessageRequest::setMessageAttributes(const QMap &message_attributes) {
    m_message_attributes = message_attributes;
    m_message_attributes_isSet = true;
}

bool OAISendMessageRequest::is_message_attributes_Set() const{
    return m_message_attributes_isSet;
}

bool OAISendMessageRequest::is_message_attributes_Valid() const{
    return m_message_attributes_isValid;
}

QMap OAISendMessageRequest::getMessageSystemAttributes() const {
    return m_message_system_attributes;
}
void OAISendMessageRequest::setMessageSystemAttributes(const QMap &message_system_attributes) {
    m_message_system_attributes = message_system_attributes;
    m_message_system_attributes_isSet = true;
}

bool OAISendMessageRequest::is_message_system_attributes_Set() const{
    return m_message_system_attributes_isSet;
}

bool OAISendMessageRequest::is_message_system_attributes_Valid() const{
    return m_message_system_attributes_isValid;
}

QString OAISendMessageRequest::getMessageDeduplicationId() const {
    return m_message_deduplication_id;
}
void OAISendMessageRequest::setMessageDeduplicationId(const QString &message_deduplication_id) {
    m_message_deduplication_id = message_deduplication_id;
    m_message_deduplication_id_isSet = true;
}

bool OAISendMessageRequest::is_message_deduplication_id_Set() const{
    return m_message_deduplication_id_isSet;
}

bool OAISendMessageRequest::is_message_deduplication_id_Valid() const{
    return m_message_deduplication_id_isValid;
}

QString OAISendMessageRequest::getMessageGroupId() const {
    return m_message_group_id;
}
void OAISendMessageRequest::setMessageGroupId(const QString &message_group_id) {
    m_message_group_id = message_group_id;
    m_message_group_id_isSet = true;
}

bool OAISendMessageRequest::is_message_group_id_Set() const{
    return m_message_group_id_isSet;
}

bool OAISendMessageRequest::is_message_group_id_Valid() const{
...
bool OAISendMessageRequest::isValid() const {
    ...
    return m_queue_url_isValid && m_message_body_isValid && true;
}
