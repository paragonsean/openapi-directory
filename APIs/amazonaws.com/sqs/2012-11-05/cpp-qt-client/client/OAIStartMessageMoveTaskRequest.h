...
/*
 * OAIStartMessageMoveTaskRequest.h
 *
 * 
 */

#ifndef OAIStartMessageMoveTaskRequest_H
#define OAIStartMessageMoveTaskRequest_H
...
class OAIStartMessageMoveTaskRequest : public OAIObject {
public:
    OAIStartMessageMoveTaskRequest();
    OAIStartMessageMoveTaskRequest(QString json);
    ~OAIStartMessageMoveTaskRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMessageMoveTaskRequest)

#endif // OAIStartMessageMoveTaskRequest_H
