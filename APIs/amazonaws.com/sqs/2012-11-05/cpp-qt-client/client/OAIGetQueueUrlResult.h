...
#ifndef OAIGetQueueUrlResult_H
#define OAIGetQueueUrlResult_H
...
class OAIGetQueueUrlResult : public OAIObject {
public:
    OAIGetQueueUrlResult();
    OAIGetQueueUrlResult(QString json);
    ~OAIGetQueueUrlResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetQueueUrlResult)

#endif // OAIGetQueueUrlResult_H
