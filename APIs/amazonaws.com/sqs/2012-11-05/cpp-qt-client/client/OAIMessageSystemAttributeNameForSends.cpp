...
#include "OAIMessageSystemAttributeNameForSends.h"
...
OAIMessageSystemAttributeNameForSends::OAIMessageSystemAttributeNameForSends(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessageSystemAttributeNameForSends::OAIMessageSystemAttributeNameForSends() {
    this->initializeModel();
}

OAIMessageSystemAttributeNameForSends::~OAIMessageSystemAttributeNameForSends() {}

void OAIMessageSystemAttributeNameForSends::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMessageSystemAttributeNameForSends::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMessageSystemAttributeNameForSends::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AWSTraceHeader", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMessageSystemAttributeNameForSends::AWSTRACEHEADER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMessageSystemAttributeNameForSends::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMessageSystemAttributeNameForSends::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMessageSystemAttributeNameForSends::AWSTRACEHEADER:
            val = "AWSTraceHeader";
            break;
        default:
            break;
...
QJsonValue OAIMessageSystemAttributeNameForSends::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMessageSystemAttributeNameForSends::eOAIMessageSystemAttributeNameForSends OAIMessageSystemAttributeNameForSends::getValue() const {
    return m_value;
}

void OAIMessageSystemAttributeNameForSends::setValue(const OAIMessageSystemAttributeNameForSends::eOAIMessageSystemAttributeNameForSends& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMessageSystemAttributeNameForSends::isSet() const {
    
    return m_value_isSet;
}

bool OAIMessageSystemAttributeNameForSends::isValid() const {
