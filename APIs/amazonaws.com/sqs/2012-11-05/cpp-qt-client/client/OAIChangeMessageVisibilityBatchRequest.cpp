...
OAIChangeMessageVisibilityBatchRequest::OAIChangeMessageVisibilityBatchRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChangeMessageVisibilityBatchRequest::OAIChangeMessageVisibilityBatchRequest() {
    this->initializeModel();
}

OAIChangeMessageVisibilityBatchRequest::~OAIChangeMessageVisibilityBatchRequest() {}

void OAIChangeMessageVisibilityBatchRequest::initializeModel() {
...
void OAIChangeMessageVisibilityBatchRequest::fromJson(QString jsonString) {
...
void OAIChangeMessageVisibilityBatchRequest::fromJsonObject(QJsonObject json) {
...
QString OAIChangeMessageVisibilityBatchRequest::asJson() const {
...
QJsonObject OAIChangeMessageVisibilityBatchRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIChangeMessageVisibilityBatchRequest::getQueueUrl() const {
    return m_queue_url;
}
void OAIChangeMessageVisibilityBatchRequest::setQueueUrl(const QString &queue_url) {
    m_queue_url = queue_url;
    m_queue_url_isSet = true;
}

bool OAIChangeMessageVisibilityBatchRequest::is_queue_url_Set() const{
    return m_queue_url_isSet;
}

bool OAIChangeMessageVisibilityBatchRequest::is_queue_url_Valid() const{
    return m_queue_url_isValid;
}

QList OAIChangeMessageVisibilityBatchRequest::getEntries() const {
    return m_entries;
}
void OAIChangeMessageVisibilityBatchRequest::setEntries(const QList &entries) {
    m_entries = entries;
    m_entries_isSet = true;
}

bool OAIChangeMessageVisibilityBatchRequest::is_entries_Set() const{
    return m_entries_isSet;
}

bool OAIChangeMessageVisibilityBatchRequest::is_entries_Valid() const{
    return m_entries_isValid;
}

bool OAIChangeMessageVisibilityBatchRequest::isSet() const {
...
bool OAIChangeMessageVisibilityBatchRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_queue_url_isValid && m_entries_isValid && true;
}
