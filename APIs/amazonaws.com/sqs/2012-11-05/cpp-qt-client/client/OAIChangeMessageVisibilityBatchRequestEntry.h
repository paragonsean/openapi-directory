...
/*
 * OAIChangeMessageVisibilityBatchRequestEntry.h
 *
 * Encloses a receipt handle and an entry ID for each message in &lt;code&gt; &lt;a&gt;ChangeMessageVisibilityBatch&lt;/a&gt;.&lt;/code&gt; 
 */

#ifndef OAIChangeMessageVisibilityBatchRequestEntry_H
#define OAIChangeMessageVisibilityBatchRequestEntry_H
...
class OAIChangeMessageVisibilityBatchRequestEntry : public OAIObject {
public:
    OAIChangeMessageVisibilityBatchRequestEntry();
    OAIChangeMessageVisibilityBatchRequestEntry(QString json);
    ~OAIChangeMessageVisibilityBatchRequestEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeMessageVisibilityBatchRequestEntry)

#endif // OAIChangeMessageVisibilityBatchRequestEntry_H
