...
/*
 * OAIListQueueTagsResult.h
 *
 * 
 */

#ifndef OAIListQueueTagsResult_H
#define OAIListQueueTagsResult_H
...
class OAIListQueueTagsResult : public OAIObject {
public:
    OAIListQueueTagsResult();
    OAIListQueueTagsResult(QString json);
    ~OAIListQueueTagsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListQueueTagsResult)

#endif // OAIListQueueTagsResult_H
