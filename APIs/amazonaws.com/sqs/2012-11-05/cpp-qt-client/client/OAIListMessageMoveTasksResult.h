...
/*
 * OAIListMessageMoveTasksResult.h
 *
 * 
 */

#ifndef OAIListMessageMoveTasksResult_H
#define OAIListMessageMoveTasksResult_H
...
class OAIListMessageMoveTasksResult : public OAIObject {
public:
    OAIListMessageMoveTasksResult();
    OAIListMessageMoveTasksResult(QString json);
    ~OAIListMessageMoveTasksResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMessageMoveTasksResult)

#endif // OAIListMessageMoveTasksResult_H
