...
OAIListQueueTagsResult::OAIListQueueTagsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListQueueTagsResult::OAIListQueueTagsResult() {
    this->initializeModel();
}

OAIListQueueTagsResult::~OAIListQueueTagsResult() {}

void OAIListQueueTagsResult::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAIListQueueTagsResult::fromJson(QString jsonString) {
...
void OAIListQueueTagsResult::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAIListQueueTagsResult::asJson() const {
...
QJsonObject OAIListQueueTagsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QMap OAIListQueueTagsResult::getTags() const {
    return m_tags;
}
void OAIListQueueTagsResult::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIListQueueTagsResult::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIListQueueTagsResult::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIListQueueTagsResult::isSet() const {
...
bool OAIListQueueTagsResult::isValid() const {
