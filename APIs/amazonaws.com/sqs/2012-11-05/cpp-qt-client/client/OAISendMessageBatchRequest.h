...
/*
 * OAISendMessageBatchRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAISendMessageBatchRequest_H
#define OAISendMessageBatchRequest_H
...
class OAISendMessageBatchRequest : public OAIObject {
public:
    OAISendMessageBatchRequest();
    OAISendMessageBatchRequest(QString json);
    ~OAISendMessageBatchRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessageBatchRequest)

#endif // OAISendMessageBatchRequest_H
