...
/*
 * OAIChangeMessageVisibilityRequest.h
 *
 * 
 */

#ifndef OAIChangeMessageVisibilityRequest_H
#define OAIChangeMessageVisibilityRequest_H
...
class OAIChangeMessageVisibilityRequest : public OAIObject {
public:
    OAIChangeMessageVisibilityRequest();
    OAIChangeMessageVisibilityRequest(QString json);
    ~OAIChangeMessageVisibilityRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeMessageVisibilityRequest)

#endif // OAIChangeMessageVisibilityRequest_H
