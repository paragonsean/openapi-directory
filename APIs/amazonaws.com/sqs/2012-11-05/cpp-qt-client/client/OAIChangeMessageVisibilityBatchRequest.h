...
/*
 * OAIChangeMessageVisibilityBatchRequest.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIChangeMessageVisibilityBatchRequest_H
#define OAIChangeMessageVisibilityBatchRequest_H
...
class OAIChangeMessageVisibilityBatchRequest : public OAIObject {
public:
    OAIChangeMessageVisibilityBatchRequest();
    OAIChangeMessageVisibilityBatchRequest(QString json);
    ~OAIChangeMessageVisibilityBatchRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChangeMessageVisibilityBatchRequest)

#endif // OAIChangeMessageVisibilityBatchRequest_H
