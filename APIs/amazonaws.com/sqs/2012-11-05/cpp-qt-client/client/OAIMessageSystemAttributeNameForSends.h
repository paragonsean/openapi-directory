...
/*
 * OAIMessageSystemAttributeNameForSends.h
 *
 * 
 */

#ifndef OAIMessageSystemAttributeNameForSends_H
#define OAIMessageSystemAttributeNameForSends_H
...
class OAIMessageSystemAttributeNameForSends : public OAIEnum {
public:
    OAIMessageSystemAttributeNameForSends();
    OAIMessageSystemAttributeNameForSends(QString json);
    ~OAIMessageSystemAttributeNameForSends() override;
    ...
    enum class eOAIMessageSystemAttributeNameForSends {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWSTRACEHEADER
    };
    OAIMessageSystemAttributeNameForSends::eOAIMessageSystemAttributeNameForSends getValue() const;
    void setValue(const OAIMessageSystemAttributeNameForSends::eOAIMessageSystemAttributeNameForSends& value);
...
private:
    ...
    eOAIMessageSystemAttributeNameForSends m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageSystemAttributeNameForSends)

#endif // OAIMessageSystemAttributeNameForSends_H
