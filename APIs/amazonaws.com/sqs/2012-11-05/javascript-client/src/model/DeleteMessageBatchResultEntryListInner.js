...
/**
 * The DeleteMessageBatchResultEntryListInner model module.
 * @module model/DeleteMessageBatchResultEntryListInner
 * @version 2012-11-05
 */
class DeleteMessageBatchResultEntryListInner {
    /**
     * Constructs a new <code>DeleteMessageBatchResultEntryListInner</code>.
     * @alias module:model/DeleteMessageBatchResultEntryListInner
     * @implements module:model/DeleteMessageBatchResultEntry
     * @param id {String} 
     */
    constructor(id) { 
        DeleteMessageBatchResultEntry.initialize(this, id);
        DeleteMessageBatchResultEntryListInner.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>DeleteMessageBatchResultEntryListInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMessageBatchResultEntryListInner} obj Optional instance to populate.
     * @return {module:model/DeleteMessageBatchResultEntryListInner} The populated <code>DeleteMessageBatchResultEntryListInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMessageBatchResultEntryListInner();
            DeleteMessageBatchResultEntry.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMessageBatchResultEntryListInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMessageBatchResultEntryListInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteMessageBatchResultEntryListInner.RequiredProperties) {
...
DeleteMessageBatchResultEntryListInner.RequiredProperties = ["Id"];

/**
 * @member {String} Id
 */
DeleteMessageBatchResultEntryListInner.prototype['Id'] = undefined;


// Implement DeleteMessageBatchResultEntry interface:
/**
 * @member {String} Id
 */
...
export default DeleteMessageBatchResultEntryListInner;
