...
/**
 * The TagQueueRequest model module.
 * @module model/TagQueueRequest
 * @version 2012-11-05
 */
class TagQueueRequest {
    /**
     * Constructs a new <code>TagQueueRequest</code>.
     * @alias module:model/TagQueueRequest
     * @param queueUrl {String} 
     * @param tags {Object} 
     */
    constructor(queueUrl, tags) { 
        
        TagQueueRequest.initialize(this, queueUrl, tags);
    }
     ...
     */
    static initialize(obj, queueUrl, tags) { 
        obj['QueueUrl'] = queueUrl;
        obj['Tags'] = tags;
    }

    /**
     * Constructs a <code>TagQueueRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagQueueRequest} obj Optional instance to populate.
     * @return {module:model/TagQueueRequest} The populated <code>TagQueueRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagQueueRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagQueueRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagQueueRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagQueueRequest.RequiredProperties) {
...
TagQueueRequest.RequiredProperties = ["QueueUrl", "Tags"];

/**
 * @member {String} QueueUrl
 */
TagQueueRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Object} Tags
 */
TagQueueRequest.prototype['Tags'] = undefined;
...
export default TagQueueRequest;
