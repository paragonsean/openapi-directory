...
class RemovePermissionRequest {
     ...
     * @param label {String} 
     */
    constructor(queueUrl, label) { 
        
        RemovePermissionRequest.initialize(this, queueUrl, label);
    }
     ...
     */
    static initialize(obj, queueUrl, label) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of RemovePermissionRequest.RequiredProperties) {
...
RemovePermissionRequest.RequiredProperties = ["QueueUrl", "Label"];

/**
 * @member {String} QueueUrl
 */
RemovePermissionRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {String} Label
 */
RemovePermissionRequest.prototype['Label'] = undefined;
