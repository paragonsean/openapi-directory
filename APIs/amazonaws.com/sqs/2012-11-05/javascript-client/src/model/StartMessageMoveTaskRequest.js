...
/**
 * The StartMessageMoveTaskRequest model module.
 * @module model/StartMessageMoveTaskRequest
 * @version 2012-11-05
 */
class StartMessageMoveTaskRequest {
    /**
     * Constructs a new <code>StartMessageMoveTaskRequest</code>.
     * @alias module:model/StartMessageMoveTaskRequest
     * @param sourceArn {String} 
     */
    constructor(sourceArn) { 
        
        StartMessageMoveTaskRequest.initialize(this, sourceArn);
    }
    ...
    /**
     * Constructs a <code>StartMessageMoveTaskRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMessageMoveTaskRequest} obj Optional instance to populate.
     * @return {module:model/StartMessageMoveTaskRequest} The populated <code>StartMessageMoveTaskRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMessageMoveTaskRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMessageMoveTaskRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMessageMoveTaskRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartMessageMoveTaskRequest.RequiredProperties) {
...
StartMessageMoveTaskRequest.RequiredProperties = ["SourceArn"];

/**
 * @member {String} SourceArn
 */
StartMessageMoveTaskRequest.prototype['SourceArn'] = undefined;

/**
 * @member {String} DestinationArn
 */
StartMessageMoveTaskRequest.prototype['DestinationArn'] = undefined;

/**
 * @member {Number} MaxNumberOfMessagesPerSecond
 */
StartMessageMoveTaskRequest.prototype['MaxNumberOfMessagesPerSecond'] = undefined;
...
export default StartMessageMoveTaskRequest;
