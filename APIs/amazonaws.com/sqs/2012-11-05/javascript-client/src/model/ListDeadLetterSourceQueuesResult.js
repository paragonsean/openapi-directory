...
/**
 * The ListDeadLetterSourceQueuesResult model module.
 * @module model/ListDeadLetterSourceQueuesResult
 * @version 2012-11-05
 */
class ListDeadLetterSourceQueuesResult {
    /**
     * Constructs a new <code>ListDeadLetterSourceQueuesResult</code>.
     * A list of your dead letter source queues.
     * @alias module:model/ListDeadLetterSourceQueuesResult
     * @param queueUrls {Array} 
     */
    constructor(queueUrls) { 
        
        ListDeadLetterSourceQueuesResult.initialize(this, queueUrls);
    }
     ...
     */
    static initialize(obj, queueUrls) { 
        obj['queueUrls'] = queueUrls;
    }

    /**
     * Constructs a <code>ListDeadLetterSourceQueuesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDeadLetterSourceQueuesResult} obj Optional instance to populate.
     * @return {module:model/ListDeadLetterSourceQueuesResult} The populated <code>ListDeadLetterSourceQueuesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDeadLetterSourceQueuesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDeadLetterSourceQueuesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDeadLetterSourceQueuesResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDeadLetterSourceQueuesResult.RequiredProperties) {
...
ListDeadLetterSourceQueuesResult.RequiredProperties = ["queueUrls"];

/**
 * @member {Array} queueUrls
 */
ListDeadLetterSourceQueuesResult.prototype['queueUrls'] = undefined;

/**
 * @member {String} NextToken
 */
ListDeadLetterSourceQueuesResult.prototype['NextToken'] = undefined;
...
export default ListDeadLetterSourceQueuesResult;
