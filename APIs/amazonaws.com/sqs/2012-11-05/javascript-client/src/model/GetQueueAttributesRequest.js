...
/**
 * The GetQueueAttributesRequest model module.
 * @module model/GetQueueAttributesRequest
 * @version 2012-11-05
 */
class GetQueueAttributesRequest {
    /**
     * Constructs a new <code>GetQueueAttributesRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/GetQueueAttributesRequest
     * @param queueUrl {String} 
     */
    constructor(queueUrl) { 
        
        GetQueueAttributesRequest.initialize(this, queueUrl);
    }
    ...
    /**
     * Constructs a <code>GetQueueAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetQueueAttributesRequest} obj Optional instance to populate.
     * @return {module:model/GetQueueAttributesRequest} The populated <code>GetQueueAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetQueueAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetQueueAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetQueueAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetQueueAttributesRequest.RequiredProperties) {
...
GetQueueAttributesRequest.RequiredProperties = ["QueueUrl"];

/**
 * @member {String} QueueUrl
 */
GetQueueAttributesRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Array} AttributeNames
 */
GetQueueAttributesRequest.prototype['AttributeNames'] = undefined;
...
export default GetQueueAttributesRequest;
