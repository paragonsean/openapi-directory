...
/**
 * The ListQueueTagsResult model module.
 * @module model/ListQueueTagsResult
 * @version 2012-11-05
 */
class ListQueueTagsResult {
    /**
     * Constructs a new <code>ListQueueTagsResult</code>.
     * @alias module:model/ListQueueTagsResult
     */
    constructor() { 
        
        ListQueueTagsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListQueueTagsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListQueueTagsResult} obj Optional instance to populate.
     * @return {module:model/ListQueueTagsResult} The populated <code>ListQueueTagsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListQueueTagsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListQueueTagsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListQueueTagsResult</code>.
     */
 ...
 * @member {Object} Tags
 */
ListQueueTagsResult.prototype['Tags'] = undefined;
...
export default ListQueueTagsResult;
