...
/**
 * The CancelMessageMoveTaskRequest model module.
 * @module model/CancelMessageMoveTaskRequest
 * @version 2012-11-05
 */
class CancelMessageMoveTaskRequest {
    /**
     * Constructs a new <code>CancelMessageMoveTaskRequest</code>.
     * @alias module:model/CancelMessageMoveTaskRequest
     * @param taskHandle {String} 
     */
    constructor(taskHandle) { 
        
        CancelMessageMoveTaskRequest.initialize(this, taskHandle);
    }
     ...
     */
    static initialize(obj, taskHandle) { 
        obj['TaskHandle'] = taskHandle;
    }

    /**
     * Constructs a <code>CancelMessageMoveTaskRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelMessageMoveTaskRequest} obj Optional instance to populate.
     * @return {module:model/CancelMessageMoveTaskRequest} The populated <code>CancelMessageMoveTaskRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelMessageMoveTaskRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelMessageMoveTaskRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelMessageMoveTaskRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CancelMessageMoveTaskRequest.RequiredProperties) {
...
CancelMessageMoveTaskRequest.RequiredProperties = ["TaskHandle"];

/**
 * @member {String} TaskHandle
 */
CancelMessageMoveTaskRequest.prototype['TaskHandle'] = undefined;
...
export default CancelMessageMoveTaskRequest;
