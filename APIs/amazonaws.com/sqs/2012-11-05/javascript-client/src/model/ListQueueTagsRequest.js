...
/**
 * The ListQueueTagsRequest model module.
 * @module model/ListQueueTagsRequest
 * @version 2012-11-05
 */
class ListQueueTagsRequest {
    /**
     * Constructs a new <code>ListQueueTagsRequest</code>.
     * @alias module:model/ListQueueTagsRequest
     * @param queueUrl {String} 
     */
    constructor(queueUrl) { 
        
        ListQueueTagsRequest.initialize(this, queueUrl);
    }
    ...
    /**
     * Constructs a <code>ListQueueTagsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListQueueTagsRequest} obj Optional instance to populate.
     * @return {module:model/ListQueueTagsRequest} The populated <code>ListQueueTagsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListQueueTagsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListQueueTagsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListQueueTagsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListQueueTagsRequest.RequiredProperties) {
...
ListQueueTagsRequest.RequiredProperties = ["QueueUrl"];

/**
 * @member {String} QueueUrl
 */
ListQueueTagsRequest.prototype['QueueUrl'] = undefined;
...
export default ListQueueTagsRequest;
