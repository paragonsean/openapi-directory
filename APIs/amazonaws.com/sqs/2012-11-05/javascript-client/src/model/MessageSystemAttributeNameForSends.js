...
* @readonly
*/
export default class MessageSystemAttributeNameForSends {
    ...
    /**
    * Returns a <code>MessageSystemAttributeNameForSends</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MessageSystemAttributeNameForSends} The enum <code>MessageSystemAttributeNameForSends</code> value.
    */
