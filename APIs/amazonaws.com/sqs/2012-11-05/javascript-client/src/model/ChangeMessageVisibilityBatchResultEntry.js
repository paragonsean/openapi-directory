...
/**
 * The ChangeMessageVisibilityBatchResultEntry model module.
 * @module model/ChangeMessageVisibilityBatchResultEntry
 * @version 2012-11-05
 */
class ChangeMessageVisibilityBatchResultEntry {
    /**
     * Constructs a new <code>ChangeMessageVisibilityBatchResultEntry</code>.
     * Encloses the &lt;code&gt;Id&lt;/code&gt; of an entry in &lt;code&gt; &lt;a&gt;ChangeMessageVisibilityBatch&lt;/a&gt;.&lt;/code&gt; 
     * @alias module:model/ChangeMessageVisibilityBatchResultEntry
     * @param id {String} 
     */
    constructor(id) { 
        
        ChangeMessageVisibilityBatchResultEntry.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>ChangeMessageVisibilityBatchResultEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeMessageVisibilityBatchResultEntry} obj Optional instance to populate.
     * @return {module:model/ChangeMessageVisibilityBatchResultEntry} The populated <code>ChangeMessageVisibilityBatchResultEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeMessageVisibilityBatchResultEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeMessageVisibilityBatchResultEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeMessageVisibilityBatchResultEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeMessageVisibilityBatchResultEntry.RequiredProperties) {
...
ChangeMessageVisibilityBatchResultEntry.RequiredProperties = ["Id"];

/**
 * @member {String} Id
 */
ChangeMessageVisibilityBatchResultEntry.prototype['Id'] = undefined;
...
export default ChangeMessageVisibilityBatchResultEntry;
