...
/**
 * The ChangeMessageVisibilityBatchRequest model module.
 * @module model/ChangeMessageVisibilityBatchRequest
 * @version 2012-11-05
 */
class ChangeMessageVisibilityBatchRequest {
    /**
     * Constructs a new <code>ChangeMessageVisibilityBatchRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/ChangeMessageVisibilityBatchRequest
     * @param queueUrl {String} 
     * @param entries {Array} 
     */
    constructor(queueUrl, entries) { 
        
        ChangeMessageVisibilityBatchRequest.initialize(this, queueUrl, entries);
    }
    ...
    /**
     * Constructs a <code>ChangeMessageVisibilityBatchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeMessageVisibilityBatchRequest} obj Optional instance to populate.
     * @return {module:model/ChangeMessageVisibilityBatchRequest} The populated <code>ChangeMessageVisibilityBatchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeMessageVisibilityBatchRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeMessageVisibilityBatchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeMessageVisibilityBatchRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeMessageVisibilityBatchRequest.RequiredProperties) {
...
ChangeMessageVisibilityBatchRequest.RequiredProperties = ["QueueUrl", "Entries"];

/**
 * @member {String} QueueUrl
 */
ChangeMessageVisibilityBatchRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Array} Entries
 */
ChangeMessageVisibilityBatchRequest.prototype['Entries'] = undefined;
...
export default ChangeMessageVisibilityBatchRequest;
