...
/**
 * The DeleteMessageBatchRequest model module.
 * @module model/DeleteMessageBatchRequest
 * @version 2012-11-05
 */
class DeleteMessageBatchRequest {
    /**
     * Constructs a new <code>DeleteMessageBatchRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/DeleteMessageBatchRequest
     * @param queueUrl {String} 
     * @param entries {Array} 
     */
    constructor(queueUrl, entries) { 
        
        DeleteMessageBatchRequest.initialize(this, queueUrl, entries);
    }
     ...
     */
    static initialize(obj, queueUrl, entries) { 
        obj['QueueUrl'] = queueUrl;
        obj['Entries'] = entries;
    }

    /**
     * Constructs a <code>DeleteMessageBatchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteMessageBatchRequest} obj Optional instance to populate.
     * @return {module:model/DeleteMessageBatchRequest} The populated <code>DeleteMessageBatchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteMessageBatchRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteMessageBatchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteMessageBatchRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteMessageBatchRequest.RequiredProperties) {
...
DeleteMessageBatchRequest.RequiredProperties = ["QueueUrl", "Entries"];

/**
 * @member {String} QueueUrl
 */
DeleteMessageBatchRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Array} Entries
 */
DeleteMessageBatchRequest.prototype['Entries'] = undefined;
...
export default DeleteMessageBatchRequest;
