...
* @readonly
*/
export default class MessageSystemAttributeName {
        ...
        /**
         * value: "DeadLetterQueueSourceArn"
         * @const
         */
    ...
    /**
    * Returns a <code>MessageSystemAttributeName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MessageSystemAttributeName} The enum <code>MessageSystemAttributeName</code> value.
    */
