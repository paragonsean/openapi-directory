...
/**
 * The SendMessageBatchRequest model module.
 * @module model/SendMessageBatchRequest
 * @version 2012-11-05
 */
class SendMessageBatchRequest {
    /**
     * Constructs a new <code>SendMessageBatchRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/SendMessageBatchRequest
     * @param queueUrl {String} 
     * @param entries {Array} 
     */
    constructor(queueUrl, entries) { 
        
        SendMessageBatchRequest.initialize(this, queueUrl, entries);
    }
    ...
    /**
     * Constructs a <code>SendMessageBatchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessageBatchRequest} obj Optional instance to populate.
     * @return {module:model/SendMessageBatchRequest} The populated <code>SendMessageBatchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessageBatchRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessageBatchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessageBatchRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SendMessageBatchRequest.RequiredProperties) {
...
SendMessageBatchRequest.RequiredProperties = ["QueueUrl", "Entries"];

/**
 * @member {String} QueueUrl
 */
SendMessageBatchRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Array} Entries
 */
SendMessageBatchRequest.prototype['Entries'] = undefined;
...
export default SendMessageBatchRequest;
