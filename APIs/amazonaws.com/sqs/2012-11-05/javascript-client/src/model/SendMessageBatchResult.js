...
/**
 * The SendMessageBatchResult model module.
 * @module model/SendMessageBatchResult
 * @version 2012-11-05
 */
class SendMessageBatchResult {
    /**
     * Constructs a new <code>SendMessageBatchResult</code>.
     ...
     * @alias module:model/SendMessageBatchResult
     * @param successful {Array} 
     * @param failed {Array} 
     */
    constructor(successful, failed) { 
        
        SendMessageBatchResult.initialize(this, successful, failed);
    }
    ...
    /**
     * Constructs a <code>SendMessageBatchResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessageBatchResult} obj Optional instance to populate.
     * @return {module:model/SendMessageBatchResult} The populated <code>SendMessageBatchResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessageBatchResult();
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessageBatchResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessageBatchResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SendMessageBatchResult.RequiredProperties) {
...
SendMessageBatchResult.RequiredProperties = ["Successful", "Failed"];

/**
 * @member {Array} Successful
 */
SendMessageBatchResult.prototype['Successful'] = undefined;

/**
 * @member {Array} Failed
 */
SendMessageBatchResult.prototype['Failed'] = undefined;
...
export default SendMessageBatchResult;
