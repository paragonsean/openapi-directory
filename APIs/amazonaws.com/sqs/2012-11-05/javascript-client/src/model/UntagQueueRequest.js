...
/**
 * The UntagQueueRequest model module.
 * @module model/UntagQueueRequest
 * @version 2012-11-05
 */
class UntagQueueRequest {
    /**
     * Constructs a new <code>UntagQueueRequest</code>.
     * @alias module:model/UntagQueueRequest
     * @param queueUrl {String} 
     * @param tagKeys {Array} 
     */
    constructor(queueUrl, tagKeys) { 
        
        UntagQueueRequest.initialize(this, queueUrl, tagKeys);
    }
     ...
     */
    static initialize(obj, queueUrl, tagKeys) { 
        obj['QueueUrl'] = queueUrl;
        obj['TagKeys'] = tagKeys;
    }

    /**
     * Constructs a <code>UntagQueueRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagQueueRequest} obj Optional instance to populate.
     * @return {module:model/UntagQueueRequest} The populated <code>UntagQueueRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagQueueRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagQueueRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagQueueRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagQueueRequest.RequiredProperties) {
...
UntagQueueRequest.RequiredProperties = ["QueueUrl", "TagKeys"];

/**
 * @member {String} QueueUrl
 */
UntagQueueRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {Array} TagKeys
 */
UntagQueueRequest.prototype['TagKeys'] = undefined;
...
export default UntagQueueRequest;
