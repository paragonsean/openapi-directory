...
/**
 * The GetQueueUrlResult model module.
 * @module model/GetQueueUrlResult
 * @version 2012-11-05
 */
class GetQueueUrlResult {
    /**
     * Constructs a new <code>GetQueueUrlResult</code>.
     ...
     * @alias module:model/GetQueueUrlResult
     */
    constructor() { 
        
        GetQueueUrlResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetQueueUrlResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetQueueUrlResult} obj Optional instance to populate.
     * @return {module:model/GetQueueUrlResult} The populated <code>GetQueueUrlResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetQueueUrlResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetQueueUrlResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetQueueUrlResult</code>.
     */
 ...
 */
GetQueueUrlResult.prototype['QueueUrl'] = undefined;
...
export default GetQueueUrlResult;
