...
/**
 * The CreateQueueResult model module.
 * @module model/CreateQueueResult
 * @version 2012-11-05
 */
class CreateQueueResult {
    /**
     * Constructs a new <code>CreateQueueResult</code>.
     * Returns the &lt;code&gt;QueueUrl&lt;/code&gt; attribute of the created queue.
     * @alias module:model/CreateQueueResult
     */
    constructor() { 
        
        CreateQueueResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateQueueResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateQueueResult} obj Optional instance to populate.
     * @return {module:model/CreateQueueResult} The populated <code>CreateQueueResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateQueueResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateQueueResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateQueueResult</code>.
     */
 ...
 */
CreateQueueResult.prototype['QueueUrl'] = undefined;
...
export default CreateQueueResult;
