...
/**
 * The ListDeadLetterSourceQueuesRequest model module.
 * @module model/ListDeadLetterSourceQueuesRequest
 * @version 2012-11-05
 */
class ListDeadLetterSourceQueuesRequest {
    /**
     * Constructs a new <code>ListDeadLetterSourceQueuesRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/ListDeadLetterSourceQueuesRequest
     * @param queueUrl {String} 
     */
    constructor(queueUrl) { 
        
        ListDeadLetterSourceQueuesRequest.initialize(this, queueUrl);
    }
    ...
    /**
     * Constructs a <code>ListDeadLetterSourceQueuesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDeadLetterSourceQueuesRequest} obj Optional instance to populate.
     * @return {module:model/ListDeadLetterSourceQueuesRequest} The populated <code>ListDeadLetterSourceQueuesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDeadLetterSourceQueuesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDeadLetterSourceQueuesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDeadLetterSourceQueuesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDeadLetterSourceQueuesRequest.RequiredProperties) {
...
ListDeadLetterSourceQueuesRequest.RequiredProperties = ["QueueUrl"];

/**
 * @member {String} QueueUrl
 */
ListDeadLetterSourceQueuesRequest.prototype['QueueUrl'] = undefined;

/**
 * @member {String} NextToken
 */
ListDeadLetterSourceQueuesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListDeadLetterSourceQueuesRequest.prototype['MaxResults'] = undefined;
...
export default ListDeadLetterSourceQueuesRequest;
