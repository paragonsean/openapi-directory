...
/**
 * The GetQueueAttributesResult model module.
 * @module model/GetQueueAttributesResult
 * @version 2012-11-05
 */
class GetQueueAttributesResult {
    /**
     * Constructs a new <code>GetQueueAttributesResult</code>.
     * A list of returned queue attributes.
     * @alias module:model/GetQueueAttributesResult
     */
    constructor() { 
        
        GetQueueAttributesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetQueueAttributesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetQueueAttributesResult} obj Optional instance to populate.
     * @return {module:model/GetQueueAttributesResult} The populated <code>GetQueueAttributesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetQueueAttributesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetQueueAttributesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetQueueAttributesResult</code>.
     */
 ...
 */
GetQueueAttributesResult.prototype['Attributes'] = undefined;
...
export default GetQueueAttributesResult;
