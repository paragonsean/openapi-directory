...
/**
 * The ReceiveMessageResult model module.
 * @module model/ReceiveMessageResult
 * @version 2012-11-05
 */
class ReceiveMessageResult {
    /**
     * Constructs a new <code>ReceiveMessageResult</code>.
     * A list of received messages.
     * @alias module:model/ReceiveMessageResult
     */
    constructor() { 
        
        ReceiveMessageResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReceiveMessageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReceiveMessageResult} obj Optional instance to populate.
     * @return {module:model/ReceiveMessageResult} The populated <code>ReceiveMessageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReceiveMessageResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ReceiveMessageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReceiveMessageResult</code>.
     */
 ...
 */
ReceiveMessageResult.prototype['Messages'] = undefined;
...
export default ReceiveMessageResult;
