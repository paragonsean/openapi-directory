...
/**
 * The ListMessageMoveTasksResult model module.
 * @module model/ListMessageMoveTasksResult
 * @version 2012-11-05
 */
class ListMessageMoveTasksResult {
    /**
     * Constructs a new <code>ListMessageMoveTasksResult</code>.
     * @alias module:model/ListMessageMoveTasksResult
     */
    constructor() { 
        
        ListMessageMoveTasksResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListMessageMoveTasksResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListMessageMoveTasksResult} obj Optional instance to populate.
     * @return {module:model/ListMessageMoveTasksResult} The populated <code>ListMessageMoveTasksResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListMessageMoveTasksResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListMessageMoveTasksResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListMessageMoveTasksResult</code>.
     */
 ...
 */
ListMessageMoveTasksResult.prototype['Results'] = undefined;
...
export default ListMessageMoveTasksResult;
