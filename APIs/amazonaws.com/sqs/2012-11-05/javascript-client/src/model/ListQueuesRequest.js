...
/**
 * The ListQueuesRequest model module.
 * @module model/ListQueuesRequest
 * @version 2012-11-05
 */
class ListQueuesRequest {
    /**
     * Constructs a new <code>ListQueuesRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/ListQueuesRequest
     */
    constructor() { 
        
        ListQueuesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListQueuesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListQueuesRequest} obj Optional instance to populate.
     * @return {module:model/ListQueuesRequest} The populated <code>ListQueuesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListQueuesRequest();

            if (data.hasOwnProperty('QueueNamePrefix')) {
                obj['QueueNamePrefix'] = ApiClient.convertToType(data['QueueNamePrefix'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListQueuesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListQueuesRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `QueueNamePrefix`
        if (data['QueueNamePrefix']) { // data not null
          String.validateJSON(data['QueueNamePrefix']);
        }
...
/**
 * @member {String} QueueNamePrefix
 */
ListQueuesRequest.prototype['QueueNamePrefix'] = undefined;

/**
 * @member {String} NextToken
 */
ListQueuesRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListQueuesRequest.prototype['MaxResults'] = undefined;
...
export default ListQueuesRequest;
