...
/**
 * The GetQueueUrlRequest model module.
 * @module model/GetQueueUrlRequest
 * @version 2012-11-05
 */
class GetQueueUrlRequest {
    /**
     * Constructs a new <code>GetQueueUrlRequest</code>.
     * &lt;p/&gt;
     * @alias module:model/GetQueueUrlRequest
     * @param queueName {String} 
     */
    constructor(queueName) { 
        
        GetQueueUrlRequest.initialize(this, queueName);
    }
    ...
    /**
     * Constructs a <code>GetQueueUrlRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetQueueUrlRequest} obj Optional instance to populate.
     * @return {module:model/GetQueueUrlRequest} The populated <code>GetQueueUrlRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetQueueUrlRequest();

            if (data.hasOwnProperty('QueueName')) {
                obj['QueueName'] = ApiClient.convertToType(data['QueueName'], 'String');
            }
            if (data.hasOwnProperty('QueueOwnerAWSAccountId')) {
                obj['QueueOwnerAWSAccountId'] = ApiClient.convertToType(data['QueueOwnerAWSAccountId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetQueueUrlRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetQueueUrlRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetQueueUrlRequest.RequiredProperties) {
        ...
        if (data['QueueOwnerAWSAccountId']) { // data not null
          String.validateJSON(data['QueueOwnerAWSAccountId']);
        }
...
GetQueueUrlRequest.RequiredProperties = ["QueueName"];

/**
 * @member {String} QueueName
 */
GetQueueUrlRequest.prototype['QueueName'] = undefined;

/**
 * @member {String} QueueOwnerAWSAccountId
 */
GetQueueUrlRequest.prototype['QueueOwnerAWSAccountId'] = undefined;
...
export default GetQueueUrlRequest;
