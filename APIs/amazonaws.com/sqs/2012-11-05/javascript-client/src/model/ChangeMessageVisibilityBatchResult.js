...
/**
 * The ChangeMessageVisibilityBatchResult model module.
 * @module model/ChangeMessageVisibilityBatchResult
 * @version 2012-11-05
 */
class ChangeMessageVisibilityBatchResult {
    /**
     * Constructs a new <code>ChangeMessageVisibilityBatchResult</code>.
     ...
     * @alias module:model/ChangeMessageVisibilityBatchResult
     * @param successful {Array} 
     * @param failed {Array} 
     */
    constructor(successful, failed) { 
        
        ChangeMessageVisibilityBatchResult.initialize(this, successful, failed);
    }
    ...
    /**
     * Constructs a <code>ChangeMessageVisibilityBatchResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangeMessageVisibilityBatchResult} obj Optional instance to populate.
     * @return {module:model/ChangeMessageVisibilityBatchResult} The populated <code>ChangeMessageVisibilityBatchResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangeMessageVisibilityBatchResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ChangeMessageVisibilityBatchResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangeMessageVisibilityBatchResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChangeMessageVisibilityBatchResult.RequiredProperties) {
...
ChangeMessageVisibilityBatchResult.RequiredProperties = ["Successful", "Failed"];

/**
 * @member {Array} Successful
 */
ChangeMessageVisibilityBatchResult.prototype['Successful'] = undefined;

/**
 * @member {Array} Failed
 */
ChangeMessageVisibilityBatchResult.prototype['Failed'] = undefined;
...
export default ChangeMessageVisibilityBatchResult;
