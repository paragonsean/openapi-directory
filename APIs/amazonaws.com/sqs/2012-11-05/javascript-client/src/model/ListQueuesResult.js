...
/**
 * The ListQueuesResult model module.
 * @module model/ListQueuesResult
 * @version 2012-11-05
 */
class ListQueuesResult {
    /**
     * Constructs a new <code>ListQueuesResult</code>.
     * A list of your queues.
     * @alias module:model/ListQueuesResult
     */
    constructor() { 
        
        ListQueuesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListQueuesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListQueuesResult} obj Optional instance to populate.
     * @return {module:model/ListQueuesResult} The populated <code>ListQueuesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListQueuesResult();

            if (data.hasOwnProperty('QueueUrls')) {
                obj['QueueUrls'] = ApiClient.convertToType(data['QueueUrls'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListQueuesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListQueuesResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `QueueUrls`
        if (data['QueueUrls']) { // data not null
          Array.validateJSON(data['QueueUrls']);
        }
...
/**
 * @member {Array} QueueUrls
 */
ListQueuesResult.prototype['QueueUrls'] = undefined;

/**
 * @member {String} NextToken
 */
ListQueuesResult.prototype['NextToken'] = undefined;
...
export default ListQueuesResult;
