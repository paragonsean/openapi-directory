...
/**
 * The CancelMessageMoveTaskResult model module.
 * @module model/CancelMessageMoveTaskResult
 * @version 2012-11-05
 */
class CancelMessageMoveTaskResult {
    /**
     * Constructs a new <code>CancelMessageMoveTaskResult</code>.
     * @alias module:model/CancelMessageMoveTaskResult
     */
    constructor() { 
        
        CancelMessageMoveTaskResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CancelMessageMoveTaskResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CancelMessageMoveTaskResult} obj Optional instance to populate.
     * @return {module:model/CancelMessageMoveTaskResult} The populated <code>CancelMessageMoveTaskResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CancelMessageMoveTaskResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CancelMessageMoveTaskResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CancelMessageMoveTaskResult</code>.
     */
 ...
 */
CancelMessageMoveTaskResult.prototype['ApproximateNumberOfMessagesMoved'] = undefined;
...
export default CancelMessageMoveTaskResult;
