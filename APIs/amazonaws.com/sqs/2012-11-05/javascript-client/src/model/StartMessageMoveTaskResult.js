...
/**
 * The StartMessageMoveTaskResult model module.
 * @module model/StartMessageMoveTaskResult
 * @version 2012-11-05
 */
class StartMessageMoveTaskResult {
    /**
     * Constructs a new <code>StartMessageMoveTaskResult</code>.
     * @alias module:model/StartMessageMoveTaskResult
     */
    constructor() { 
        
        StartMessageMoveTaskResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartMessageMoveTaskResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartMessageMoveTaskResult} obj Optional instance to populate.
     * @return {module:model/StartMessageMoveTaskResult} The populated <code>StartMessageMoveTaskResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartMessageMoveTaskResult();
    ...
    /**
     * Validates the JSON data with respect to <code>StartMessageMoveTaskResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartMessageMoveTaskResult</code>.
     */
 ...
 */
StartMessageMoveTaskResult.prototype['TaskHandle'] = undefined;
...
export default StartMessageMoveTaskResult;
