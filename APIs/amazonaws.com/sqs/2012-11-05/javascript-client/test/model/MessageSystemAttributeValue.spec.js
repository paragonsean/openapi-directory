...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.MessageSystemAttributeValue();
  });
  ...
  describe('MessageSystemAttributeValue', function() {
    it('should create an instance of MessageSystemAttributeValue', function() {
      // uncomment below and update the code to test MessageSystemAttributeValue
      //var instance = new AmazonSimpleQueueService.MessageSystemAttributeValue();
      //expect(instance).to.be.a(AmazonSimpleQueueService.MessageSystemAttributeValue);
    });
