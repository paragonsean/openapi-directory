...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GetQueueAttributesResult();
  });
  ...
  describe('GetQueueAttributesResult', function() {
    it('should create an instance of GetQueueAttributesResult', function() {
      // uncomment below and update the code to test GetQueueAttributesResult
      //var instance = new AmazonSimpleQueueService.GetQueueAttributesResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GetQueueAttributesResult);
    });
