...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequestEntry();
  });
  ...
  describe('ChangeMessageVisibilityBatchRequestEntry', function() {
    it('should create an instance of ChangeMessageVisibilityBatchRequestEntry', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityBatchRequestEntry
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequestEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequestEntry);
    });
