...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntry();
  });
  ...
  describe('ChangeMessageVisibilityBatchResultEntry', function() {
    it('should create an instance of ChangeMessageVisibilityBatchResultEntry', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityBatchResultEntry
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntry);
    });
