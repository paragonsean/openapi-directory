...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListMessageMoveTasksResult();
  });
  ...
  describe('ListMessageMoveTasksResult', function() {
    it('should create an instance of ListMessageMoveTasksResult', function() {
      // uncomment below and update the code to test ListMessageMoveTasksResult
      //var instance = new AmazonSimpleQueueService.ListMessageMoveTasksResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListMessageMoveTasksResult);
    });
