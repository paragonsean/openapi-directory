...
(function(root, factory) {
  ...
  describe('QueueAttributeName', function() {
    it('should create an instance of QueueAttributeName', function() {
      // uncomment below and update the code to test QueueAttributeName
      //var instance = new AmazonSimpleQueueService.QueueAttributeName();
      //expect(instance).to.be.a(AmazonSimpleQueueService.QueueAttributeName);
    });
