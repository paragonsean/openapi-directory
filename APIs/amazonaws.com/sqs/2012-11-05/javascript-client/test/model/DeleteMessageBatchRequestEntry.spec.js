...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteMessageBatchRequestEntry();
  });
  ...
  describe('DeleteMessageBatchRequestEntry', function() {
    it('should create an instance of DeleteMessageBatchRequestEntry', function() {
      // uncomment below and update the code to test DeleteMessageBatchRequestEntry
      //var instance = new AmazonSimpleQueueService.DeleteMessageBatchRequestEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteMessageBatchRequestEntry);
    });
