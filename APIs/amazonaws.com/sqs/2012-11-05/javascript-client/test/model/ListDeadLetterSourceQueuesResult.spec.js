...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListDeadLetterSourceQueuesResult();
  });
  ...
  describe('ListDeadLetterSourceQueuesResult', function() {
    it('should create an instance of ListDeadLetterSourceQueuesResult', function() {
      // uncomment below and update the code to test ListDeadLetterSourceQueuesResult
      //var instance = new AmazonSimpleQueueService.ListDeadLetterSourceQueuesResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListDeadLetterSourceQueuesResult);
    });

    it('should have the property queueUrls (base name: "queueUrls")', function() {
      // uncomment below and update the code to test the property queueUrls
      //var instance = new AmazonSimpleQueueService.ListDeadLetterSourceQueuesResult();
