...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteMessageRequest();
  });
  ...
  describe('DeleteMessageRequest', function() {
    it('should create an instance of DeleteMessageRequest', function() {
      // uncomment below and update the code to test DeleteMessageRequest
      //var instance = new AmazonSimpleQueueService.DeleteMessageRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteMessageRequest);
    });
