...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.StartMessageMoveTaskResult();
  });
  ...
  describe('StartMessageMoveTaskResult', function() {
    it('should create an instance of StartMessageMoveTaskResult', function() {
      // uncomment below and update the code to test StartMessageMoveTaskResult
      //var instance = new AmazonSimpleQueueService.StartMessageMoveTaskResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.StartMessageMoveTaskResult);
    });
