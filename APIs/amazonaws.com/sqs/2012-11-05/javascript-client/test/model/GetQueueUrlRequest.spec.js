...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GetQueueUrlRequest();
  });
  ...
  describe('GetQueueUrlRequest', function() {
    it('should create an instance of GetQueueUrlRequest', function() {
      // uncomment below and update the code to test GetQueueUrlRequest
      //var instance = new AmazonSimpleQueueService.GetQueueUrlRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GetQueueUrlRequest);
    });
    ...
    it('should have the property queueOwnerAWSAccountId (base name: "QueueOwnerAWSAccountId")', function() {
      // uncomment below and update the code to test the property queueOwnerAWSAccountId
      //var instance = new AmazonSimpleQueueService.GetQueueUrlRequest();
      //expect(instance).to.be();
    });
