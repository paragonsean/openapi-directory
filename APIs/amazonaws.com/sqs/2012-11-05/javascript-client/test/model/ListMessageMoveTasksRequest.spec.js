...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListMessageMoveTasksRequest();
  });
  ...
  describe('ListMessageMoveTasksRequest', function() {
    it('should create an instance of ListMessageMoveTasksRequest', function() {
      // uncomment below and update the code to test ListMessageMoveTasksRequest
      //var instance = new AmazonSimpleQueueService.ListMessageMoveTasksRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListMessageMoveTasksRequest);
    });
