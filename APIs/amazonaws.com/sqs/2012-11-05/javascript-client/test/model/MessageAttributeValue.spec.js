...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.MessageAttributeValue();
  });
  ...
  describe('MessageAttributeValue', function() {
    it('should create an instance of MessageAttributeValue', function() {
      ...
      //var instance = new AmazonSimpleQueueService.MessageAttributeValue();
      //expect(instance).to.be.a(AmazonSimpleQueueService.MessageAttributeValue);
    });
    ...
    it('should have the property stringListValues (base name: "StringListValues")', function() {
      // uncomment below and update the code to test the property stringListValues
      //var instance = new AmazonSimpleQueueService.MessageAttributeValue();
      //expect(instance).to.be();
    });

    it('should have the property binaryListValues (base name: "BinaryListValues")', function() {
      // uncomment below and update the code to test the property binaryListValues
      //var instance = new AmazonSimpleQueueService.MessageAttributeValue();
      //expect(instance).to.be();
    });
