...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.CreateQueueResult();
  });
  ...
  describe('CreateQueueResult', function() {
    it('should create an instance of CreateQueueResult', function() {
      // uncomment below and update the code to test CreateQueueResult
      //var instance = new AmazonSimpleQueueService.CreateQueueResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.CreateQueueResult);
    });
