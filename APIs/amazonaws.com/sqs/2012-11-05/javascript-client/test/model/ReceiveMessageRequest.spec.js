...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
  });
  ...
  describe('ReceiveMessageRequest', function() {
    it('should create an instance of ReceiveMessageRequest', function() {
      // uncomment below and update the code to test ReceiveMessageRequest
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ReceiveMessageRequest);
    });
    ...
    it('should have the property messageAttributeNames (base name: "MessageAttributeNames")', function() {
      // uncomment below and update the code to test the property messageAttributeNames
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be();
    });

    it('should have the property maxNumberOfMessages (base name: "MaxNumberOfMessages")', function() {
      // uncomment below and update the code to test the property maxNumberOfMessages
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be();
    });

    it('should have the property visibilityTimeout (base name: "VisibilityTimeout")', function() {
      // uncomment below and update the code to test the property visibilityTimeout
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be();
    });

    it('should have the property waitTimeSeconds (base name: "WaitTimeSeconds")', function() {
      // uncomment below and update the code to test the property waitTimeSeconds
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be();
    });

    it('should have the property receiveRequestAttemptId (base name: "ReceiveRequestAttemptId")', function() {
      // uncomment below and update the code to test the property receiveRequestAttemptId
      //var instance = new AmazonSimpleQueueService.ReceiveMessageRequest();
      //expect(instance).to.be();
    });
