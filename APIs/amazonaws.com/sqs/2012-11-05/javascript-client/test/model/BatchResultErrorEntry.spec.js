...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.BatchResultErrorEntry();
  });
  ...
  describe('BatchResultErrorEntry', function() {
    it('should create an instance of BatchResultErrorEntry', function() {
      // uncomment below and update the code to test BatchResultErrorEntry
      //var instance = new AmazonSimpleQueueService.BatchResultErrorEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.BatchResultErrorEntry);
    });
    ...
    it('should have the property senderFault (base name: "SenderFault")', function() {
      // uncomment below and update the code to test the property senderFault
      //var instance = new AmazonSimpleQueueService.BatchResultErrorEntry();
      //expect(instance).to.be();
    });
