...
(function(root, factory) {
  ...
  describe('MessageSystemAttributeNameForSends', function() {
    it('should create an instance of MessageSystemAttributeNameForSends', function() {
      // uncomment below and update the code to test MessageSystemAttributeNameForSends
      //var instance = new AmazonSimpleQueueService.MessageSystemAttributeNameForSends();
      //expect(instance).to.be.a(AmazonSimpleQueueService.MessageSystemAttributeNameForSends);
    });
