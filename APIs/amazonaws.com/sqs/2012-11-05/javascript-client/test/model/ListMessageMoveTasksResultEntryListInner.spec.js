...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListMessageMoveTasksResultEntryListInner();
  });
  ...
  describe('ListMessageMoveTasksResultEntryListInner', function() {
    it('should create an instance of ListMessageMoveTasksResultEntryListInner', function() {
      // uncomment below and update the code to test ListMessageMoveTasksResultEntryListInner
      //var instance = new AmazonSimpleQueueService.ListMessageMoveTasksResultEntryListInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListMessageMoveTasksResultEntryListInner);
    });
