...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GETSendMessageBatchEntriesParameterInner();
  });
  ...
  describe('GETSendMessageBatchEntriesParameterInner', function() {
    it('should create an instance of GETSendMessageBatchEntriesParameterInner', function() {
      // uncomment below and update the code to test GETSendMessageBatchEntriesParameterInner
      //var instance = new AmazonSimpleQueueService.GETSendMessageBatchEntriesParameterInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GETSendMessageBatchEntriesParameterInner);
    });
