...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.AddPermissionRequest();
  });
  ...
  describe('AddPermissionRequest', function() {
    it('should create an instance of AddPermissionRequest', function() {
      // uncomment below and update the code to test AddPermissionRequest
      //var instance = new AmazonSimpleQueueService.AddPermissionRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.AddPermissionRequest);
    });
    ...
    it('should have the property aWSAccountIds (base name: "AWSAccountIds")', function() {
      // uncomment below and update the code to test the property aWSAccountIds
      //var instance = new AmazonSimpleQueueService.AddPermissionRequest();
      //expect(instance).to.be();
    });
