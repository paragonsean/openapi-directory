...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListQueueTagsRequest();
  });
  ...
  describe('ListQueueTagsRequest', function() {
    it('should create an instance of ListQueueTagsRequest', function() {
      // uncomment below and update the code to test ListQueueTagsRequest
      //var instance = new AmazonSimpleQueueService.ListQueueTagsRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListQueueTagsRequest);
    });
