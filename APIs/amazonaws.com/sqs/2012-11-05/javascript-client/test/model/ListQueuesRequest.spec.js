...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListQueuesRequest();
  });
  ...
  describe('ListQueuesRequest', function() {
    it('should create an instance of ListQueuesRequest', function() {
      // uncomment below and update the code to test ListQueuesRequest
      //var instance = new AmazonSimpleQueueService.ListQueuesRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListQueuesRequest);
    });

    it('should have the property queueNamePrefix (base name: "QueueNamePrefix")', function() {
      // uncomment below and update the code to test the property queueNamePrefix
      //var instance = new AmazonSimpleQueueService.ListQueuesRequest();
