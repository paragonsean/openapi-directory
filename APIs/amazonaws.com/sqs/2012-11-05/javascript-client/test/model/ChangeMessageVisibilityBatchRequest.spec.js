...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequest();
  });
  ...
  describe('ChangeMessageVisibilityBatchRequest', function() {
    it('should create an instance of ChangeMessageVisibilityBatchRequest', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityBatchRequest
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityBatchRequest);
    });
