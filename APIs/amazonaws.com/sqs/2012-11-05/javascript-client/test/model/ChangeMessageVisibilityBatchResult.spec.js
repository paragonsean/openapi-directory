...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResult();
  });
  ...
  describe('ChangeMessageVisibilityBatchResult', function() {
    it('should create an instance of ChangeMessageVisibilityBatchResult', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityBatchResult
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityBatchResult);
    });
