...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GETDeleteMessageBatchEntriesParameterInner();
  });
  ...
  describe('GETDeleteMessageBatchEntriesParameterInner', function() {
    it('should create an instance of GETDeleteMessageBatchEntriesParameterInner', function() {
      // uncomment below and update the code to test GETDeleteMessageBatchEntriesParameterInner
      //var instance = new AmazonSimpleQueueService.GETDeleteMessageBatchEntriesParameterInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GETDeleteMessageBatchEntriesParameterInner);
    });
