...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteQueueRequest();
  });
  ...
  describe('DeleteQueueRequest', function() {
    it('should create an instance of DeleteQueueRequest', function() {
      // uncomment below and update the code to test DeleteQueueRequest
      //var instance = new AmazonSimpleQueueService.DeleteQueueRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteQueueRequest);
    });
