...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.MessageListInner();
  });
  ...
  describe('MessageListInner', function() {
    it('should create an instance of MessageListInner', function() {
      // uncomment below and update the code to test MessageListInner
      //var instance = new AmazonSimpleQueueService.MessageListInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.MessageListInner);
    });
    ...
    it('should have the property mD5OfBody (base name: "MD5OfBody")', function() {
      // uncomment below and update the code to test the property mD5OfBody
      //var instance = new AmazonSimpleQueueService.MessageListInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mD5OfMessageAttributes (base name: "MD5OfMessageAttributes")', function() {
      // uncomment below and update the code to test the property mD5OfMessageAttributes
      //var instance = new AmazonSimpleQueueService.MessageListInner();
      //expect(instance).to.be();
    });
