...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new AmazonSimpleQueueService.SendMessageRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageRequest);
    });
