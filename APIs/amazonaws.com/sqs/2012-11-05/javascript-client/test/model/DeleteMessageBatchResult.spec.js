...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteMessageBatchResult();
  });
  ...
  describe('DeleteMessageBatchResult', function() {
    it('should create an instance of DeleteMessageBatchResult', function() {
      // uncomment below and update the code to test DeleteMessageBatchResult
      //var instance = new AmazonSimpleQueueService.DeleteMessageBatchResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteMessageBatchResult);
    });
