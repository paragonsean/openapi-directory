...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ReceiveMessageResult();
  });
  ...
  describe('ReceiveMessageResult', function() {
    it('should create an instance of ReceiveMessageResult', function() {
      // uncomment below and update the code to test ReceiveMessageResult
      //var instance = new AmazonSimpleQueueService.ReceiveMessageResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ReceiveMessageResult);
    });
