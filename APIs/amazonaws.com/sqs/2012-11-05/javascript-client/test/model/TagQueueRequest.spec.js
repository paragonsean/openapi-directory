...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.TagQueueRequest();
  });
  ...
  describe('TagQueueRequest', function() {
    it('should create an instance of TagQueueRequest', function() {
      // uncomment below and update the code to test TagQueueRequest
      //var instance = new AmazonSimpleQueueService.TagQueueRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.TagQueueRequest);
    });
