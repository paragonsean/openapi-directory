...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.BatchResultErrorEntryListInner();
  });
  ...
  describe('BatchResultErrorEntryListInner', function() {
    it('should create an instance of BatchResultErrorEntryListInner', function() {
      // uncomment below and update the code to test BatchResultErrorEntryListInner
      //var instance = new AmazonSimpleQueueService.BatchResultErrorEntryListInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.BatchResultErrorEntryListInner);
    });
