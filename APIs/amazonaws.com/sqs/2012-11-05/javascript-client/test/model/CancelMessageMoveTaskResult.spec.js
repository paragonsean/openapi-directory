...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.CancelMessageMoveTaskResult();
  });
  ...
  describe('CancelMessageMoveTaskResult', function() {
    it('should create an instance of CancelMessageMoveTaskResult', function() {
      // uncomment below and update the code to test CancelMessageMoveTaskResult
      //var instance = new AmazonSimpleQueueService.CancelMessageMoveTaskResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.CancelMessageMoveTaskResult);
    });

    it('should have the property approximateNumberOfMessagesMoved (base name: "ApproximateNumberOfMessagesMoved")', function() {
      // uncomment below and update the code to test the property approximateNumberOfMessagesMoved
      //var instance = new AmazonSimpleQueueService.CancelMessageMoveTaskResult();
