...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageBatchResult();
  });
  ...
  describe('SendMessageBatchResult', function() {
    it('should create an instance of SendMessageBatchResult', function() {
      // uncomment below and update the code to test SendMessageBatchResult
      //var instance = new AmazonSimpleQueueService.SendMessageBatchResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageBatchResult);
    });
