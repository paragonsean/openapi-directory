...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SetQueueAttributesRequest();
  });
  ...
  describe('SetQueueAttributesRequest', function() {
    it('should create an instance of SetQueueAttributesRequest', function() {
      // uncomment below and update the code to test SetQueueAttributesRequest
      //var instance = new AmazonSimpleQueueService.SetQueueAttributesRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SetQueueAttributesRequest);
    });
