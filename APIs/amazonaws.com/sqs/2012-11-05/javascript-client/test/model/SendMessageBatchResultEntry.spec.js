...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageBatchResultEntry();
  });
  ...
  describe('SendMessageBatchResultEntry', function() {
    it('should create an instance of SendMessageBatchResultEntry', function() {
      // uncomment below and update the code to test SendMessageBatchResultEntry
      //var instance = new AmazonSimpleQueueService.SendMessageBatchResultEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageBatchResultEntry);
    });
