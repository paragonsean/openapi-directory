...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageBatchRequestEntry();
  });
  ...
  describe('SendMessageBatchRequestEntry', function() {
    it('should create an instance of SendMessageBatchRequestEntry', function() {
      // uncomment below and update the code to test SendMessageBatchRequestEntry
      //var instance = new AmazonSimpleQueueService.SendMessageBatchRequestEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageBatchRequestEntry);
    });
    ...
    it('should have the property delaySeconds (base name: "DelaySeconds")', function() {
      // uncomment below and update the code to test the property delaySeconds
      //var instance = new AmazonSimpleQueueService.SendMessageBatchRequestEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property messageSystemAttributes (base name: "MessageSystemAttributes")', function() {
      // uncomment below and update the code to test the property messageSystemAttributes
      //var instance = new AmazonSimpleQueueService.SendMessageBatchRequestEntry();
      //expect(instance).to.be();
    });
