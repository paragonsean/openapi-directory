...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.StartMessageMoveTaskRequest();
  });
  ...
  describe('StartMessageMoveTaskRequest', function() {
    it('should create an instance of StartMessageMoveTaskRequest', function() {
      // uncomment below and update the code to test StartMessageMoveTaskRequest
      //var instance = new AmazonSimpleQueueService.StartMessageMoveTaskRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.StartMessageMoveTaskRequest);
    });
    ...
    it('should have the property maxNumberOfMessagesPerSecond (base name: "MaxNumberOfMessagesPerSecond")', function() {
      // uncomment below and update the code to test the property maxNumberOfMessagesPerSecond
      //var instance = new AmazonSimpleQueueService.StartMessageMoveTaskRequest();
      //expect(instance).to.be();
    });
