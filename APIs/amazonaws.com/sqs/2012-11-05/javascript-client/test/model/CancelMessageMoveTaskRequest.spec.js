...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.CancelMessageMoveTaskRequest();
  });
  ...
  describe('CancelMessageMoveTaskRequest', function() {
    it('should create an instance of CancelMessageMoveTaskRequest', function() {
      // uncomment below and update the code to test CancelMessageMoveTaskRequest
      //var instance = new AmazonSimpleQueueService.CancelMessageMoveTaskRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.CancelMessageMoveTaskRequest);
    });
