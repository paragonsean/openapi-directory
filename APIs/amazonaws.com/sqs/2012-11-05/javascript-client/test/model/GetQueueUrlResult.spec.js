...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GetQueueUrlResult();
  });
  ...
  describe('GetQueueUrlResult', function() {
    it('should create an instance of GetQueueUrlResult', function() {
      // uncomment below and update the code to test GetQueueUrlResult
      //var instance = new AmazonSimpleQueueService.GetQueueUrlResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GetQueueUrlResult);
    });
