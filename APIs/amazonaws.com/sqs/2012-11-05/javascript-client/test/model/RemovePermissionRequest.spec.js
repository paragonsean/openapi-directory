...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.RemovePermissionRequest();
  });
  ...
  describe('RemovePermissionRequest', function() {
    it('should create an instance of RemovePermissionRequest', function() {
      // uncomment below and update the code to test RemovePermissionRequest
      //var instance = new AmazonSimpleQueueService.RemovePermissionRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.RemovePermissionRequest);
    });
