...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageBatchRequest();
  });
  ...
  describe('SendMessageBatchRequest', function() {
    it('should create an instance of SendMessageBatchRequest', function() {
      // uncomment below and update the code to test SendMessageBatchRequest
      //var instance = new AmazonSimpleQueueService.SendMessageBatchRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageBatchRequest);
    });
