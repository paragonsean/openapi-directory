...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteMessageBatchRequest();
  });
  ...
  describe('DeleteMessageBatchRequest', function() {
    it('should create an instance of DeleteMessageBatchRequest', function() {
      // uncomment below and update the code to test DeleteMessageBatchRequest
      //var instance = new AmazonSimpleQueueService.DeleteMessageBatchRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteMessageBatchRequest);
    });
