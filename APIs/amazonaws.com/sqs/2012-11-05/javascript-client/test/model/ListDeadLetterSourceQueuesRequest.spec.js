...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListDeadLetterSourceQueuesRequest();
  });
  ...
  describe('ListDeadLetterSourceQueuesRequest', function() {
    it('should create an instance of ListDeadLetterSourceQueuesRequest', function() {
      // uncomment below and update the code to test ListDeadLetterSourceQueuesRequest
      //var instance = new AmazonSimpleQueueService.ListDeadLetterSourceQueuesRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListDeadLetterSourceQueuesRequest);
    });
