...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.PurgeQueueRequest();
  });
  ...
  describe('PurgeQueueRequest', function() {
    it('should create an instance of PurgeQueueRequest', function() {
      // uncomment below and update the code to test PurgeQueueRequest
      //var instance = new AmazonSimpleQueueService.PurgeQueueRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.PurgeQueueRequest);
    });
