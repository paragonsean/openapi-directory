...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.DeleteMessageBatchResultEntry();
  });
  ...
  describe('DeleteMessageBatchResultEntry', function() {
    it('should create an instance of DeleteMessageBatchResultEntry', function() {
      // uncomment below and update the code to test DeleteMessageBatchResultEntry
      //var instance = new AmazonSimpleQueueService.DeleteMessageBatchResultEntry();
      //expect(instance).to.be.a(AmazonSimpleQueueService.DeleteMessageBatchResultEntry);
    });
