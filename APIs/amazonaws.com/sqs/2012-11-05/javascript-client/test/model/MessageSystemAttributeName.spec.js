...
(function(root, factory) {
  ...
  describe('MessageSystemAttributeName', function() {
    it('should create an instance of MessageSystemAttributeName', function() {
      // uncomment below and update the code to test MessageSystemAttributeName
      //var instance = new AmazonSimpleQueueService.MessageSystemAttributeName();
      //expect(instance).to.be.a(AmazonSimpleQueueService.MessageSystemAttributeName);
    });
