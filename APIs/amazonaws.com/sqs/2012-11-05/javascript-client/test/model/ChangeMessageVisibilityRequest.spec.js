...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityRequest();
  });
  ...
  describe('ChangeMessageVisibilityRequest', function() {
    it('should create an instance of ChangeMessageVisibilityRequest', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityRequest
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityRequest);
    });
