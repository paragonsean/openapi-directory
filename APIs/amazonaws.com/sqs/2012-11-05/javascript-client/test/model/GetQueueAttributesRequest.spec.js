...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GetQueueAttributesRequest();
  });
  ...
  describe('GetQueueAttributesRequest', function() {
    it('should create an instance of GetQueueAttributesRequest', function() {
      // uncomment below and update the code to test GetQueueAttributesRequest
      //var instance = new AmazonSimpleQueueService.GetQueueAttributesRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GetQueueAttributesRequest);
    });
