...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.UntagQueueRequest();
  });
  ...
  describe('UntagQueueRequest', function() {
    it('should create an instance of UntagQueueRequest', function() {
      // uncomment below and update the code to test UntagQueueRequest
      //var instance = new AmazonSimpleQueueService.UntagQueueRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.UntagQueueRequest);
    });
