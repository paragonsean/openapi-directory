...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListQueuesResult();
  });
  ...
  describe('ListQueuesResult', function() {
    it('should create an instance of ListQueuesResult', function() {
      // uncomment below and update the code to test ListQueuesResult
      //var instance = new AmazonSimpleQueueService.ListQueuesResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListQueuesResult);
    });
