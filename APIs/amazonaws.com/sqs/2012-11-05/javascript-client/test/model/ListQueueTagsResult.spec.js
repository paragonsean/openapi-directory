...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ListQueueTagsResult();
  });
  ...
  describe('ListQueueTagsResult', function() {
    it('should create an instance of ListQueueTagsResult', function() {
      // uncomment below and update the code to test ListQueueTagsResult
      //var instance = new AmazonSimpleQueueService.ListQueueTagsResult();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ListQueueTagsResult);
    });
