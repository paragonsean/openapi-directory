...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.SendMessageBatchResultEntryListInner();
  });
  ...
  describe('SendMessageBatchResultEntryListInner', function() {
    it('should create an instance of SendMessageBatchResultEntryListInner', function() {
      // uncomment below and update the code to test SendMessageBatchResultEntryListInner
      //var instance = new AmazonSimpleQueueService.SendMessageBatchResultEntryListInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.SendMessageBatchResultEntryListInner);
    });
    ...
    it('should have the property mD5OfMessageBody (base name: "MD5OfMessageBody")', function() {
      // uncomment below and update the code to test the property mD5OfMessageBody
      //var instance = new AmazonSimpleQueueService.SendMessageBatchResultEntryListInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mD5OfMessageSystemAttributes (base name: "MD5OfMessageSystemAttributes")', function() {
      // uncomment below and update the code to test the property mD5OfMessageSystemAttributes
      //var instance = new AmazonSimpleQueueService.SendMessageBatchResultEntryListInner();
      //expect(instance).to.be();
    });
