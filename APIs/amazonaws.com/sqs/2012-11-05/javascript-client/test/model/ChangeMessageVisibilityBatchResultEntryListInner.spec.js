...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntryListInner();
  });
  ...
  describe('ChangeMessageVisibilityBatchResultEntryListInner', function() {
    it('should create an instance of ChangeMessageVisibilityBatchResultEntryListInner', function() {
      // uncomment below and update the code to test ChangeMessageVisibilityBatchResultEntryListInner
      //var instance = new AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntryListInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.ChangeMessageVisibilityBatchResultEntryListInner);
    });
