...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.CreateQueueRequest();
  });
  ...
  describe('CreateQueueRequest', function() {
    it('should create an instance of CreateQueueRequest', function() {
      ...
      //var instance = new AmazonSimpleQueueService.CreateQueueRequest();
      //expect(instance).to.be.a(AmazonSimpleQueueService.CreateQueueRequest);
    });
