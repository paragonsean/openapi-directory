...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonSimpleQueueService.GETChangeMessageVisibilityBatchEntriesParameterInner();
  });
  ...
  describe('GETChangeMessageVisibilityBatchEntriesParameterInner', function() {
    it('should create an instance of GETChangeMessageVisibilityBatchEntriesParameterInner', function() {
      // uncomment below and update the code to test GETChangeMessageVisibilityBatchEntriesParameterInner
      //var instance = new AmazonSimpleQueueService.GETChangeMessageVisibilityBatchEntriesParameterInner();
      //expect(instance).to.be.a(AmazonSimpleQueueService.GETChangeMessageVisibilityBatchEntriesParameterInner);
    });
    ...
    it('should have the property receiptHandle (base name: "ReceiptHandle")', function() {
      // uncomment below and update the code to test the property receiptHandle
      //var instance = new AmazonSimpleQueueService.GETChangeMessageVisibilityBatchEntriesParameterInner();
      //expect(instance).to.be();
    });
