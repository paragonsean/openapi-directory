...
public class ListMessageMoveTasksRequest {
  ...
  public ListMessageMoveTasksRequest() {
  }

  public ListMessageMoveTasksRequest sourceArn(String sourceArn) {
  ...
  public ListMessageMoveTasksRequest maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListMessageMoveTasksRequest listMessageMoveTasksRequest = (ListMessageMoveTasksRequest) o;
    return Objects.equals(this.sourceArn, listMessageMoveTasksRequest.sourceArn) &&
        Objects.equals(this.maxResults, listMessageMoveTasksRequest.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceArn, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListMessageMoveTasksRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListMessageMoveTasksRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListMessageMoveTasksRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMessageMoveTasksRequest is not found in the empty JSON string", ListMessageMoveTasksRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListMessageMoveTasksRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListMessageMoveTasksRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListMessageMoveTasksRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMessageMoveTasksRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMessageMoveTasksRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMessageMoveTasksRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMessageMoveTasksRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMessageMoveTasksRequest>() {
           @Override
           public void write(JsonWriter out, ListMessageMoveTasksRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListMessageMoveTasksRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListMessageMoveTasksRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListMessageMoveTasksRequest
   * @throws IOException if the JSON string is invalid with respect to ListMessageMoveTasksRequest
   */
  public static ListMessageMoveTasksRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMessageMoveTasksRequest.class);
  }

  /**
   * Convert an instance of ListMessageMoveTasksRequest to an JSON string
   *
   * @return JSON string
   */
