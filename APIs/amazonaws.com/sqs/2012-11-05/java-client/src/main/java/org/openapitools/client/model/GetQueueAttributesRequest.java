...
public class GetQueueAttributesRequest {
  ...
  public GetQueueAttributesRequest queueUrl(String queueUrl) {
  ...
  public GetQueueAttributesRequest attributeNames(List attributeNames) {
  ...
  public boolean equals(Object o) {
    ...
    GetQueueAttributesRequest getQueueAttributesRequest = (GetQueueAttributesRequest) o;
    return Objects.equals(this.queueUrl, getQueueAttributesRequest.queueUrl) &&
        Objects.equals(this.attributeNames, getQueueAttributesRequest.attributeNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queueUrl, attributeNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetQueueAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetQueueAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetQueueAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetQueueAttributesRequest is not found in the empty JSON string", GetQueueAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetQueueAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetQueueAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetQueueAttributesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetQueueAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetQueueAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetQueueAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetQueueAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetQueueAttributesRequest>() {
           @Override
           public void write(JsonWriter out, GetQueueAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetQueueAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetQueueAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetQueueAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to GetQueueAttributesRequest
   */
  public static GetQueueAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetQueueAttributesRequest.class);
  }

  /**
   * Convert an instance of GetQueueAttributesRequest to an JSON string
   *
   * @return JSON string
   */
