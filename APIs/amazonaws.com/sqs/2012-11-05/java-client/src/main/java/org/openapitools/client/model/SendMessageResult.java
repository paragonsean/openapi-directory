...
public class SendMessageResult {
  ...
  public SendMessageResult md5OfMessageBody(String md5OfMessageBody) {
  ...
  public SendMessageResult md5OfMessageAttributes(String md5OfMessageAttributes) {
  ...
  public SendMessageResult md5OfMessageSystemAttributes(String md5OfMessageSystemAttributes) {
  ...
  public SendMessageResult sequenceNumber(String sequenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.md5OfMessageBody, sendMessageResult.md5OfMessageBody) &&
        Objects.equals(this.md5OfMessageAttributes, sendMessageResult.md5OfMessageAttributes) &&
        Objects.equals(this.md5OfMessageSystemAttributes, sendMessageResult.md5OfMessageSystemAttributes) &&
        Objects.equals(this.messageId, sendMessageResult.messageId) &&
        Objects.equals(this.sequenceNumber, sendMessageResult.sequenceNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(md5OfMessageBody, md5OfMessageAttributes, md5OfMessageSystemAttributes, messageId, sequenceNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessageResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessageResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessageResult is not found in the empty JSON string", SendMessageResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessageResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessageResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `MD5OfMessageBody`
      if (jsonObj.get("MD5OfMessageBody") != null && !jsonObj.get("MD5OfMessageBody").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessageResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessageResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessageResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessageResult.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessageResult>() {
           @Override
           public void write(JsonWriter out, SendMessageResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessageResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessageResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessageResult
   * @throws IOException if the JSON string is invalid with respect to SendMessageResult
   */
  public static SendMessageResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessageResult.class);
  }

  /**
   * Convert an instance of SendMessageResult to an JSON string
   *
   * @return JSON string
   */
