...
public class ListQueueTagsResult {
  ...
  public ListQueueTagsResult tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListQueueTagsResult listQueueTagsResult = (ListQueueTagsResult) o;
    return Objects.equals(this.tags, listQueueTagsResult.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListQueueTagsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListQueueTagsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListQueueTagsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListQueueTagsResult is not found in the empty JSON string", ListQueueTagsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListQueueTagsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListQueueTagsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListQueueTagsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListQueueTagsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListQueueTagsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListQueueTagsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListQueueTagsResult>() {
           @Override
           public void write(JsonWriter out, ListQueueTagsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListQueueTagsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListQueueTagsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListQueueTagsResult
   * @throws IOException if the JSON string is invalid with respect to ListQueueTagsResult
   */
  public static ListQueueTagsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListQueueTagsResult.class);
  }

  /**
   * Convert an instance of ListQueueTagsResult to an JSON string
   *
   * @return JSON string
   */
