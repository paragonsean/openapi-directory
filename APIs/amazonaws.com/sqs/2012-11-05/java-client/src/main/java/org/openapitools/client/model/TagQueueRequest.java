...
public class TagQueueRequest {
  ...
  public TagQueueRequest queueUrl(String queueUrl) {
  ...
  public TagQueueRequest tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TagQueueRequest tagQueueRequest = (TagQueueRequest) o;
    return Objects.equals(this.queueUrl, tagQueueRequest.queueUrl) &&
        Objects.equals(this.tags, tagQueueRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queueUrl, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TagQueueRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TagQueueRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagQueueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagQueueRequest is not found in the empty JSON string", TagQueueRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TagQueueRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagQueueRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TagQueueRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagQueueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagQueueRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagQueueRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagQueueRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TagQueueRequest>() {
           @Override
           public void write(JsonWriter out, TagQueueRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TagQueueRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TagQueueRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TagQueueRequest
   * @throws IOException if the JSON string is invalid with respect to TagQueueRequest
   */
  public static TagQueueRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagQueueRequest.class);
  }

  /**
   * Convert an instance of TagQueueRequest to an JSON string
   *
   * @return JSON string
   */
