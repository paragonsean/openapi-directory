...
public class GETSendMessageBatchEntriesParameterInner {
  ...
  public GETSendMessageBatchEntriesParameterInner() {
  }

  public GETSendMessageBatchEntriesParameterInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GETSendMessageBatchEntriesParameterInner messageBody(String messageBody) {
  ...
  public GETSendMessageBatchEntriesParameterInner delaySeconds(Integer delaySeconds) {
  ...
  public GETSendMessageBatchEntriesParameterInner messageAttributes(Map messageAttributes) {
  ...
  public GETSendMessageBatchEntriesParameterInner messageSystemAttributes(Map messageSystemAttributes) {
  ...
  public GETSendMessageBatchEntriesParameterInner messageDeduplicationId(String messageDeduplicationId) {
  ...
  public GETSendMessageBatchEntriesParameterInner messageGroupId(String messageGroupId) {
  ...
  public boolean equals(Object o) {
    ...
    GETSendMessageBatchEntriesParameterInner geTSendMessageBatchEntriesParameterInner = (GETSendMessageBatchEntriesParameterInner) o;
    return Objects.equals(this.id, geTSendMessageBatchEntriesParameterInner.id) &&
        Objects.equals(this.messageBody, geTSendMessageBatchEntriesParameterInner.messageBody) &&
        Objects.equals(this.delaySeconds, geTSendMessageBatchEntriesParameterInner.delaySeconds) &&
        Objects.equals(this.messageAttributes, geTSendMessageBatchEntriesParameterInner.messageAttributes) &&
        Objects.equals(this.messageSystemAttributes, geTSendMessageBatchEntriesParameterInner.messageSystemAttributes) &&
        Objects.equals(this.messageDeduplicationId, geTSendMessageBatchEntriesParameterInner.messageDeduplicationId) &&
        Objects.equals(this.messageGroupId, geTSendMessageBatchEntriesParameterInner.messageGroupId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETSendMessageBatchEntriesParameterInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GETSendMessageBatchEntriesParameterInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GETSendMessageBatchEntriesParameterInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETSendMessageBatchEntriesParameterInner is not found in the empty JSON string", GETSendMessageBatchEntriesParameterInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GETSendMessageBatchEntriesParameterInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GETSendMessageBatchEntriesParameterInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GETSendMessageBatchEntriesParameterInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETSendMessageBatchEntriesParameterInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETSendMessageBatchEntriesParameterInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETSendMessageBatchEntriesParameterInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETSendMessageBatchEntriesParameterInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GETSendMessageBatchEntriesParameterInner>() {
           @Override
           public void write(JsonWriter out, GETSendMessageBatchEntriesParameterInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GETSendMessageBatchEntriesParameterInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GETSendMessageBatchEntriesParameterInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GETSendMessageBatchEntriesParameterInner
   * @throws IOException if the JSON string is invalid with respect to GETSendMessageBatchEntriesParameterInner
   */
  public static GETSendMessageBatchEntriesParameterInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETSendMessageBatchEntriesParameterInner.class);
  }

  /**
   * Convert an instance of GETSendMessageBatchEntriesParameterInner to an JSON string
   *
   * @return JSON string
   */
