...
public class ReceiveMessageResult {
  ...
  public ReceiveMessageResult messages(List messages) {
  ...
  public boolean equals(Object o) {
    ...
    ReceiveMessageResult receiveMessageResult = (ReceiveMessageResult) o;
    return Objects.equals(this.messages, receiveMessageResult.messages);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReceiveMessageResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReceiveMessageResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReceiveMessageResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiveMessageResult is not found in the empty JSON string", ReceiveMessageResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReceiveMessageResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReceiveMessageResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceiveMessageResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceiveMessageResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceiveMessageResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceiveMessageResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceiveMessageResult>() {
           @Override
           public void write(JsonWriter out, ReceiveMessageResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReceiveMessageResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReceiveMessageResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReceiveMessageResult
   * @throws IOException if the JSON string is invalid with respect to ReceiveMessageResult
   */
  public static ReceiveMessageResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceiveMessageResult.class);
  }

  /**
   * Convert an instance of ReceiveMessageResult to an JSON string
   *
   * @return JSON string
   */
