...
public class ListQueueTagsRequest {
  ...
  public ListQueueTagsRequest queueUrl(String queueUrl) {
  ...
  public boolean equals(Object o) {
    ...
    ListQueueTagsRequest listQueueTagsRequest = (ListQueueTagsRequest) o;
    return Objects.equals(this.queueUrl, listQueueTagsRequest.queueUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListQueueTagsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListQueueTagsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListQueueTagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListQueueTagsRequest is not found in the empty JSON string", ListQueueTagsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListQueueTagsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListQueueTagsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListQueueTagsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListQueueTagsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListQueueTagsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListQueueTagsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListQueueTagsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListQueueTagsRequest>() {
           @Override
           public void write(JsonWriter out, ListQueueTagsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListQueueTagsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListQueueTagsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListQueueTagsRequest
   * @throws IOException if the JSON string is invalid with respect to ListQueueTagsRequest
   */
  public static ListQueueTagsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListQueueTagsRequest.class);
  }

  /**
   * Convert an instance of ListQueueTagsRequest to an JSON string
   *
   * @return JSON string
   */
