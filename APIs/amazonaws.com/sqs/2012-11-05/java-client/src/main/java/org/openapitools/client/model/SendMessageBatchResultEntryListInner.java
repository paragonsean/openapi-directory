...
public class SendMessageBatchResultEntryListInner {
  ...
  public SendMessageBatchResultEntryListInner() {
  }

  public SendMessageBatchResultEntryListInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SendMessageBatchResultEntryListInner messageId(String messageId) {
  ...
  public SendMessageBatchResultEntryListInner md5OfMessageBody(String md5OfMessageBody) {
  ...
  public SendMessageBatchResultEntryListInner md5OfMessageAttributes(String md5OfMessageAttributes) {
  ...
  public SendMessageBatchResultEntryListInner md5OfMessageSystemAttributes(String md5OfMessageSystemAttributes) {
  ...
  public SendMessageBatchResultEntryListInner sequenceNumber(String sequenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    SendMessageBatchResultEntryListInner sendMessageBatchResultEntryListInner = (SendMessageBatchResultEntryListInner) o;
    return Objects.equals(this.id, sendMessageBatchResultEntryListInner.id) &&
        Objects.equals(this.messageId, sendMessageBatchResultEntryListInner.messageId) &&
        Objects.equals(this.md5OfMessageBody, sendMessageBatchResultEntryListInner.md5OfMessageBody) &&
        Objects.equals(this.md5OfMessageAttributes, sendMessageBatchResultEntryListInner.md5OfMessageAttributes) &&
        Objects.equals(this.md5OfMessageSystemAttributes, sendMessageBatchResultEntryListInner.md5OfMessageSystemAttributes) &&
        Objects.equals(this.sequenceNumber, sendMessageBatchResultEntryListInner.sequenceNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMessageBatchResultEntryListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessageBatchResultEntryListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessageBatchResultEntryListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessageBatchResultEntryListInner is not found in the empty JSON string", SendMessageBatchResultEntryListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessageBatchResultEntryListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessageBatchResultEntryListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SendMessageBatchResultEntryListInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessageBatchResultEntryListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessageBatchResultEntryListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessageBatchResultEntryListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessageBatchResultEntryListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessageBatchResultEntryListInner>() {
           @Override
           public void write(JsonWriter out, SendMessageBatchResultEntryListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessageBatchResultEntryListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessageBatchResultEntryListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessageBatchResultEntryListInner
   * @throws IOException if the JSON string is invalid with respect to SendMessageBatchResultEntryListInner
   */
  public static SendMessageBatchResultEntryListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessageBatchResultEntryListInner.class);
  }

  /**
   * Convert an instance of SendMessageBatchResultEntryListInner to an JSON string
   *
   * @return JSON string
   */
