...
public class PurgeQueueRequest {
  ...
  public PurgeQueueRequest queueUrl(String queueUrl) {
  ...
  public boolean equals(Object o) {
    ...
    PurgeQueueRequest purgeQueueRequest = (PurgeQueueRequest) o;
    return Objects.equals(this.queueUrl, purgeQueueRequest.queueUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurgeQueueRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PurgeQueueRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PurgeQueueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PurgeQueueRequest is not found in the empty JSON string", PurgeQueueRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PurgeQueueRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PurgeQueueRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PurgeQueueRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PurgeQueueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PurgeQueueRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PurgeQueueRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PurgeQueueRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PurgeQueueRequest>() {
           @Override
           public void write(JsonWriter out, PurgeQueueRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PurgeQueueRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PurgeQueueRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PurgeQueueRequest
   * @throws IOException if the JSON string is invalid with respect to PurgeQueueRequest
   */
  public static PurgeQueueRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PurgeQueueRequest.class);
  }

  /**
   * Convert an instance of PurgeQueueRequest to an JSON string
   *
   * @return JSON string
   */
