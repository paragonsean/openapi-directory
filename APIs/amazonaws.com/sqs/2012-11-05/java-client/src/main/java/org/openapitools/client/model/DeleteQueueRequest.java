...
public class DeleteQueueRequest {
  ...
  public DeleteQueueRequest queueUrl(String queueUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.queueUrl, deleteQueueRequest.queueUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteQueueRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteQueueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteQueueRequest is not found in the empty JSON string", DeleteQueueRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteQueueRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteQueueRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteQueueRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteQueueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteQueueRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteQueueRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteQueueRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteQueueRequest>() {
           @Override
           public void write(JsonWriter out, DeleteQueueRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteQueueRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteQueueRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteQueueRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteQueueRequest
   */
  public static DeleteQueueRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteQueueRequest.class);
  }

  /**
   * Convert an instance of DeleteQueueRequest to an JSON string
   *
   * @return JSON string
   */
