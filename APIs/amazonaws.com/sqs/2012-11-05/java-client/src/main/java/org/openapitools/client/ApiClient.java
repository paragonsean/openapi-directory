...
public class ApiClient {
    ...
    private String basePath = "http://sqs.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2012-11-05/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://sqs.us-east-1.amazonaws.com
