...
public class GetQueueUrlResult {
  ...
  public GetQueueUrlResult queueUrl(String queueUrl) {
  ...
  public boolean equals(Object o) {
    ...
    GetQueueUrlResult getQueueUrlResult = (GetQueueUrlResult) o;
    return Objects.equals(this.queueUrl, getQueueUrlResult.queueUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetQueueUrlResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetQueueUrlResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetQueueUrlResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetQueueUrlResult is not found in the empty JSON string", GetQueueUrlResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetQueueUrlResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetQueueUrlResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetQueueUrlResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetQueueUrlResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetQueueUrlResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetQueueUrlResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetQueueUrlResult>() {
           @Override
           public void write(JsonWriter out, GetQueueUrlResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetQueueUrlResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetQueueUrlResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetQueueUrlResult
   * @throws IOException if the JSON string is invalid with respect to GetQueueUrlResult
   */
  public static GetQueueUrlResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetQueueUrlResult.class);
  }

  /**
   * Convert an instance of GetQueueUrlResult to an JSON string
   *
   * @return JSON string
   */
