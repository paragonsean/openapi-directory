...
public class SendMessageBatchResult {
  ...
  public SendMessageBatchResult successful(List successful) {
  ...
  public SendMessageBatchResult failed(List failed) {
    this.failed = failed;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendMessageBatchResult sendMessageBatchResult = (SendMessageBatchResult) o;
    return Objects.equals(this.successful, sendMessageBatchResult.successful) &&
        Objects.equals(this.failed, sendMessageBatchResult.failed);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMessageBatchResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessageBatchResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessageBatchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessageBatchResult is not found in the empty JSON string", SendMessageBatchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessageBatchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessageBatchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SendMessageBatchResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessageBatchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessageBatchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessageBatchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessageBatchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessageBatchResult>() {
           @Override
           public void write(JsonWriter out, SendMessageBatchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessageBatchResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessageBatchResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessageBatchResult
   * @throws IOException if the JSON string is invalid with respect to SendMessageBatchResult
   */
  public static SendMessageBatchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessageBatchResult.class);
  }

  /**
   * Convert an instance of SendMessageBatchResult to an JSON string
   *
   * @return JSON string
   */
