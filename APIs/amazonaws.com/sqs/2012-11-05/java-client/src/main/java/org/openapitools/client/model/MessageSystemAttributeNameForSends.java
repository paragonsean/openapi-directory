...
/**
 * Gets or Sets MessageSystemAttributeNameForSends
 */
@JsonAdapter(MessageSystemAttributeNameForSends.Adapter.class)
public enum MessageSystemAttributeNameForSends {
  ...
  MessageSystemAttributeNameForSends(String value) {
    this.value = value;
  }
  ...
  public static MessageSystemAttributeNameForSends fromValue(String value) {
    for (MessageSystemAttributeNameForSends b : MessageSystemAttributeNameForSends.values()) {
  ...
  public static class Adapter extends TypeAdapter<MessageSystemAttributeNameForSends> {
    @Override
    public void write(final JsonWriter jsonWriter, final MessageSystemAttributeNameForSends enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MessageSystemAttributeNameForSends read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MessageSystemAttributeNameForSends.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MessageSystemAttributeNameForSends.fromValue(value);
  }
}
