...
public class ChangeMessageVisibilityBatchResult {
  ...
  public ChangeMessageVisibilityBatchResult successful(List successful) {
  ...
  public ChangeMessageVisibilityBatchResult failed(List failed) {
    this.failed = failed;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ChangeMessageVisibilityBatchResult changeMessageVisibilityBatchResult = (ChangeMessageVisibilityBatchResult) o;
    return Objects.equals(this.successful, changeMessageVisibilityBatchResult.successful) &&
        Objects.equals(this.failed, changeMessageVisibilityBatchResult.failed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeMessageVisibilityBatchResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeMessageVisibilityBatchResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeMessageVisibilityBatchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeMessageVisibilityBatchResult is not found in the empty JSON string", ChangeMessageVisibilityBatchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeMessageVisibilityBatchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeMessageVisibilityBatchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChangeMessageVisibilityBatchResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeMessageVisibilityBatchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeMessageVisibilityBatchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeMessageVisibilityBatchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeMessageVisibilityBatchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeMessageVisibilityBatchResult>() {
           @Override
           public void write(JsonWriter out, ChangeMessageVisibilityBatchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeMessageVisibilityBatchResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeMessageVisibilityBatchResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeMessageVisibilityBatchResult
   * @throws IOException if the JSON string is invalid with respect to ChangeMessageVisibilityBatchResult
   */
  public static ChangeMessageVisibilityBatchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeMessageVisibilityBatchResult.class);
  }

  /**
   * Convert an instance of ChangeMessageVisibilityBatchResult to an JSON string
   *
   * @return JSON string
   */
