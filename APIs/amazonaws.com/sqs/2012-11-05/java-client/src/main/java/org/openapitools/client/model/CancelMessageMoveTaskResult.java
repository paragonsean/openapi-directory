...
public class CancelMessageMoveTaskResult {
  ...
  public CancelMessageMoveTaskResult() {
  }

  public CancelMessageMoveTaskResult approximateNumberOfMessagesMoved(Integer approximateNumberOfMessagesMoved) {
  ...
  public boolean equals(Object o) {
    ...
    CancelMessageMoveTaskResult cancelMessageMoveTaskResult = (CancelMessageMoveTaskResult) o;
    return Objects.equals(this.approximateNumberOfMessagesMoved, cancelMessageMoveTaskResult.approximateNumberOfMessagesMoved);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approximateNumberOfMessagesMoved);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelMessageMoveTaskResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelMessageMoveTaskResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelMessageMoveTaskResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelMessageMoveTaskResult is not found in the empty JSON string", CancelMessageMoveTaskResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelMessageMoveTaskResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelMessageMoveTaskResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelMessageMoveTaskResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelMessageMoveTaskResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelMessageMoveTaskResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelMessageMoveTaskResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelMessageMoveTaskResult>() {
           @Override
           public void write(JsonWriter out, CancelMessageMoveTaskResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelMessageMoveTaskResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelMessageMoveTaskResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelMessageMoveTaskResult
   * @throws IOException if the JSON string is invalid with respect to CancelMessageMoveTaskResult
   */
  public static CancelMessageMoveTaskResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelMessageMoveTaskResult.class);
  }

  /**
   * Convert an instance of CancelMessageMoveTaskResult to an JSON string
   *
   * @return JSON string
   */
