...
/**
 * Model tests for SendMessageResult
 */
public class SendMessageResultTest {
    private final SendMessageResult model = new SendMessageResult();
