...
async def g_et_add_permission(request: web.Request, label, aws_account_ids, actions, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_add_permission
    ...
    :type actions: List[]
    :param account_number: The AWS account number
...
async def g_et_cancel_message_move_task(request: web.Request, task_handle, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_cancel_message_move_task
    ...
    :param task_handle: An identifier associated with a message movement task.
...
async def g_et_change_message_visibility(request: web.Request, receipt_handle, visibility_timeout, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_change_message_visibility
    ...
    :param receipt_handle: The receipt handle associated with the message, whose visibility timeout is changed. This parameter is returned by the &lt;code&gt; &lt;a&gt;ReceiveMessage&lt;/a&gt; &lt;/code&gt; action.
    :type receipt_handle: str
    :param visibility_timeout: The new value for the message&#39;s visibility timeout (in seconds). Values range: &lt;code&gt;0&lt;/code&gt; to &lt;code&gt;43200&lt;/code&gt;. Maximum: 12 hours.
...
async def g_et_change_message_visibility_batch(request: web.Request, entries, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_change_message_visibility_batch
    ...
    :param entries: Lists the receipt handles of the messages for which the visibility timeout must be changed.
    :type entries: list | bytes
    :param account_number: The AWS account number
    :type account_number: int
    :param queue_name: The name of the queue
    :type queue_name: str
    ...
    """
    entries = [GETChangeMessageVisibilityBatchEntriesParameterInner.from_dict(d) for d in entries]
    return web.Response(status=200)


async def g_et_create_queue(request: web.Request, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, attribute=None, tag=None) -> web.Response:
    """g_et_create_queue
...
async def g_et_delete_message(request: web.Request, receipt_handle, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_delete_message
...
async def g_et_delete_message_batch(request: web.Request, entries, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_delete_message_batch
    ...
    :param entries: Lists the receipt handles for the messages to be deleted.
    :type entries: list | bytes
    :param account_number: The AWS account number
    :type account_number: int
    :param queue_name: The name of the queue
    ...
    """
    entries = [GETDeleteMessageBatchEntriesParameterInner.from_dict(d) for d in entries]
    return web.Response(status=200)


async def g_et_delete_queue(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_delete_queue
...
async def g_et_get_queue_attributes(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, attribute_names=None) -> web.Response:
    """g_et_get_queue_attributes
...
async def g_et_get_queue_url(request: web.Request, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, queue_owner_aws_account_id=None) -> web.Response:
    ...
    :param queue_name: &lt;p&gt;The name of the queue whose URL must be fetched. Maximum 80 characters. Valid values: alphanumeric characters, hyphens (&lt;code&gt;-&lt;/code&gt;), and underscores (&lt;code&gt;_&lt;/code&gt;).&lt;/p&gt; &lt;p&gt;Queue URLs and names are case-sensitive.&lt;/p&gt;
    :type queue_name: str
    :param action: 
    :type action: str
    :param version: 
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param queue_owner_aws_account_id: The Amazon Web Services account ID of the account that created the queue.
...
async def g_et_list_dead_letter_source_queues(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, next_token=None, max_results=None) -> web.Response:
    """g_et_list_dead_letter_source_queues
    ...
    :type next_token: str
    :param max_results: Maximum number of results to include in the response. Value range is 1 to 1000. You must set &lt;code&gt;MaxResults&lt;/code&gt; to receive a value for &lt;code&gt;NextToken&lt;/code&gt; in the response.
...
async def g_et_list_message_move_tasks(request: web.Request, source_arn, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, max_results=None) -> web.Response:
    """g_et_list_message_move_tasks
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param max_results: The maximum number of results to include in the response. The default is 1, which provides the most recent message movement task. The upper limit is 10.
    :type max_results: int
...
async def g_et_list_queue_tags(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_list_queue_tags
...
async def g_et_list_queues(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, queue_name_prefix=None, next_token=None, max_results=None) -> web.Response:
    """g_et_list_queues
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param queue_name_prefix: &lt;p&gt;A string to use for filtering the list results. Only those queues whose name begins with the specified string are returned.&lt;/p&gt; &lt;p&gt;Queue URLs and names are case-sensitive.&lt;/p&gt;
...
async def g_et_purge_queue(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_purge_queue
...
async def g_et_receive_message(request: web.Request, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, attribute_names=None, message_attribute_names=None, max_number_of_messages=None, visibility_timeout=None, wait_time_seconds=None, receive_request_attempt_id=None) -> web.Response:
    """g_et_receive_message
...
async def g_et_remove_permission(request: web.Request, label, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    ...
    :param label: The identification of the permission to remove. This is the label added using the &lt;code&gt; &lt;a&gt;AddPermission&lt;/a&gt; &lt;/code&gt; action.
    :type label: str
    :param account_number: The AWS account number
    :type account_number: int
    :param queue_name: The name of the queue
...
async def g_et_send_message(request: web.Request, message_body, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, delay_seconds=None, message_attribute=None, message_system_attribute=None, message_deduplication_id=None, message_group_id=None) -> web.Response:
    """g_et_send_message
    ...
    :param message_body: &lt;p&gt;The message to send. The minimum size is one character. The maximum size is 256 KiB.&lt;/p&gt; &lt;important&gt; &lt;p&gt;A message can include only XML, JSON, and unformatted text. The following Unicode characters are allowed:&lt;/p&gt; &lt;p&gt; &lt;code&gt;#x9&lt;/code&gt; | &lt;code&gt;#xA&lt;/code&gt; | &lt;code&gt;#xD&lt;/code&gt; | &lt;code&gt;#x20&lt;/code&gt; to &lt;code&gt;#xD7FF&lt;/code&gt; | &lt;code&gt;#xE000&lt;/code&gt; to &lt;code&gt;#xFFFD&lt;/code&gt; | &lt;code&gt;#x10000&lt;/code&gt; to &lt;code&gt;#x10FFFF&lt;/code&gt; &lt;/p&gt; &lt;p&gt;Any characters not included in this list will be rejected. For more information, see the &lt;a href&#x3D;\&quot;http://www.w3.org/TR/REC-xml/#charsets\&quot;&gt;W3C specification for characters&lt;/a&gt;.&lt;/p&gt; &lt;/important&gt;
    ...
    """
    message_attribute = {k: MessageAttributeValue.from_dict(v) for k, v in message_attribute}
    message_system_attribute = {k: MessageSystemAttributeValue.from_dict(v) for k, v in message_system_attribute}
    return web.Response(status=200)


async def g_et_send_message_batch(request: web.Request, entries, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_send_message_batch
    ...
    :param entries: A list of &lt;code&gt; &lt;a&gt;SendMessageBatchRequestEntry&lt;/a&gt; &lt;/code&gt; items.
    :type entries: list | bytes
    :param account_number: The AWS account number
    :type account_number: int
    :param queue_name: The name of the queue
    ...
    """
    entries = [GETSendMessageBatchEntriesParameterInner.from_dict(d) for d in entries]
    return web.Response(status=200)


async def g_et_set_queue_attributes(request: web.Request, attribute, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_set_queue_attributes
...
async def g_et_start_message_move_task(request: web.Request, source_arn, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, destination_arn=None, max_number_of_messages_per_second=None) -> web.Response:
    """g_et_start_message_move_task
    ...
    :param source_arn: The ARN of the queue that contains the messages to be moved to another queue. Currently, only ARNs of dead-letter queues (DLQs) whose sources are other Amazon SQS queues are accepted. DLQs whose sources are non-SQS queues, such as Lambda or Amazon SNS topics, are not currently supported.
    :type source_arn: str
    :param action: 
    :type action: str
    :param version: 
    ...
    :param x_amz_signed_headers: 
    :type x_amz_signed_headers: str
    :param destination_arn: The ARN of the queue that receives the moved messages. You can use this field to specify the destination queue where you would like to redrive messages. If this field is left blank, the messages will be redriven back to their respective original source queues.
    :type destination_arn: str
    :param max_number_of_messages_per_second: The number of messages to be moved per second (the message movement rate). You can use this field to define a fixed message movement rate. The maximum value for messages per second is 500. If this field is left blank, the system will optimize the rate based on the queue message backlog size, which may vary throughout the duration of the message movement task.
...
async def g_et_tag_queue(request: web.Request, tags, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_tag_queue
...
async def g_et_untag_queue(request: web.Request, tag_keys, account_number, queue_name, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None) -> web.Response:
    """g_et_untag_queue
...
async def p_ost_add_permission(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    ...
    """
    body = AddPermissionRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_cancel_message_move_task(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_cancel_message_move_task
    ...
    """
    body = CancelMessageMoveTaskRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_change_message_visibility(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_change_message_visibility
    ...
    """
    body = ChangeMessageVisibilityRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_change_message_visibility_batch(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_change_message_visibility_batch
    ...
    """
    body = ChangeMessageVisibilityBatchRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_create_queue(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_create_queue
...
async def p_ost_delete_message(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_delete_message
...
async def p_ost_delete_message_batch(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_delete_message_batch
    ...
    """
    body = DeleteMessageBatchRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_delete_queue(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_delete_queue
    ...
    """
    body = DeleteQueueRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_get_queue_attributes(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_get_queue_attributes
    ...
    """
    body = GetQueueAttributesRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_get_queue_url(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_get_queue_url
    ...
    """
    body = GetQueueUrlRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_list_dead_letter_source_queues(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, max_results=None, next_token=None, body=None) -> web.Response:
    """p_ost_list_dead_letter_source_queues
    ...
    """
    body = ListDeadLetterSourceQueuesRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_list_message_move_tasks(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_list_message_move_tasks
    ...
    """
    body = ListMessageMoveTasksRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_list_queue_tags(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_list_queue_tags
    ...
    """
    body = ListQueueTagsRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_list_queues(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, max_results=None, next_token=None, body=None) -> web.Response:
    """p_ost_list_queues
    ...
    """
    body = ListQueuesRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_purge_queue(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_purge_queue
    ...
    """
    body = PurgeQueueRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_receive_message(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_receive_message
    ...
    """
    body = ReceiveMessageRequest.from_dict(body)
    return web.Response(status=200)
...
async def p_ost_send_message(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_send_message
...
async def p_ost_send_message_batch(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_send_message_batch
    ...
    """
    body = SendMessageBatchRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_set_queue_attributes(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_set_queue_attributes
    ...
    """
    body = SetQueueAttributesRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_start_message_move_task(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_start_message_move_task
    ...
    """
    body = StartMessageMoveTaskRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_tag_queue(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_tag_queue
    ...
    """
    body = TagQueueRequest.from_dict(body)
    return web.Response(status=200)


async def p_ost_untag_queue(request: web.Request, action, version, x_amz_content_sha256=None, x_amz_date=None, x_amz_algorithm=None, x_amz_credential=None, x_amz_security_token=None, x_amz_signature=None, x_amz_signed_headers=None, body=None) -> web.Response:
    """p_ost_untag_queue
    ...
    """
    body = UntagQueueRequest.from_dict(body)
    return web.Response(status=200)
