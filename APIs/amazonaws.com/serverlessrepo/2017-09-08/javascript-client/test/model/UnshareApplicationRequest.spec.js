...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.UnshareApplicationRequest();
  });
  ...
  describe('UnshareApplicationRequest', function() {
    it('should create an instance of UnshareApplicationRequest', function() {
      // uncomment below and update the code to test UnshareApplicationRequest
      //var instance = new AwsServerlessApplicationRepository.UnshareApplicationRequest();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.UnshareApplicationRequest);
    });
