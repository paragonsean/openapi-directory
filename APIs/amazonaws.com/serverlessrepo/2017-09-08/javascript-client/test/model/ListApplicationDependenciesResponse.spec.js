...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ListApplicationDependenciesResponse();
  });
  ...
  describe('ListApplicationDependenciesResponse', function() {
    it('should create an instance of ListApplicationDependenciesResponse', function() {
      // uncomment below and update the code to test ListApplicationDependenciesResponse
      //var instance = new AwsServerlessApplicationRepository.ListApplicationDependenciesResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ListApplicationDependenciesResponse);
    });
