...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ParameterValue();
  });
  ...
  describe('ParameterValue', function() {
    it('should create an instance of ParameterValue', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.ParameterValue();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ParameterValue);
    });
