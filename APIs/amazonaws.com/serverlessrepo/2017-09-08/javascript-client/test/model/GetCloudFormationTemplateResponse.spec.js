...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.GetCloudFormationTemplateResponse();
  });
  ...
  describe('GetCloudFormationTemplateResponse', function() {
    it('should create an instance of GetCloudFormationTemplateResponse', function() {
      // uncomment below and update the code to test GetCloudFormationTemplateResponse
      //var instance = new AwsServerlessApplicationRepository.GetCloudFormationTemplateResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.GetCloudFormationTemplateResponse);
    });
