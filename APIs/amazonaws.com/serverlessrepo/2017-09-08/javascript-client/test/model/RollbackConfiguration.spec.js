...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.RollbackConfiguration();
  });
  ...
  describe('RollbackConfiguration', function() {
    it('should create an instance of RollbackConfiguration', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.RollbackConfiguration();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.RollbackConfiguration);
    });
