...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ListApplicationsResponse();
  });
  ...
  describe('ListApplicationsResponse', function() {
    it('should create an instance of ListApplicationsResponse', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.ListApplicationsResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ListApplicationsResponse);
    });
