...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ApplicationDependencySummary();
  });
  ...
  describe('ApplicationDependencySummary', function() {
    it('should create an instance of ApplicationDependencySummary', function() {
      // uncomment below and update the code to test ApplicationDependencySummary
      //var instance = new AwsServerlessApplicationRepository.ApplicationDependencySummary();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ApplicationDependencySummary);
    });
