...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateCloudFormationChangeSetResponse();
  });
  ...
  describe('CreateCloudFormationChangeSetResponse', function() {
    it('should create an instance of CreateCloudFormationChangeSetResponse', function() {
      // uncomment below and update the code to test CreateCloudFormationChangeSetResponse
      //var instance = new AwsServerlessApplicationRepository.CreateCloudFormationChangeSetResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateCloudFormationChangeSetResponse);
    });
