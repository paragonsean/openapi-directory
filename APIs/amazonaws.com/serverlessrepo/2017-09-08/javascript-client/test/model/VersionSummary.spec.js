...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.VersionSummary();
  });
  ...
  describe('VersionSummary', function() {
    it('should create an instance of VersionSummary', function() {
      // uncomment below and update the code to test VersionSummary
      //var instance = new AwsServerlessApplicationRepository.VersionSummary();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.VersionSummary);
    });
