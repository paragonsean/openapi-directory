...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateCloudFormationChangeSetRequestRollbackConfiguration();
  });
  ...
  describe('CreateCloudFormationChangeSetRequestRollbackConfiguration', function() {
    it('should create an instance of CreateCloudFormationChangeSetRequestRollbackConfiguration', function() {
      // uncomment below and update the code to test CreateCloudFormationChangeSetRequestRollbackConfiguration
      //var instance = new AwsServerlessApplicationRepository.CreateCloudFormationChangeSetRequestRollbackConfiguration();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateCloudFormationChangeSetRequestRollbackConfiguration);
    });
