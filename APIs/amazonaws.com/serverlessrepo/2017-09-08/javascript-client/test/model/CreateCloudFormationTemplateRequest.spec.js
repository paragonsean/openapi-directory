...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateCloudFormationTemplateRequest();
  });
  ...
  describe('CreateCloudFormationTemplateRequest', function() {
    it('should create an instance of CreateCloudFormationTemplateRequest', function() {
      // uncomment below and update the code to test CreateCloudFormationTemplateRequest
      //var instance = new AwsServerlessApplicationRepository.CreateCloudFormationTemplateRequest();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateCloudFormationTemplateRequest);
    });
