...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.PutApplicationPolicyResponse();
  });
  ...
  describe('PutApplicationPolicyResponse', function() {
    it('should create an instance of PutApplicationPolicyResponse', function() {
      // uncomment below and update the code to test PutApplicationPolicyResponse
      //var instance = new AwsServerlessApplicationRepository.PutApplicationPolicyResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.PutApplicationPolicyResponse);
    });
