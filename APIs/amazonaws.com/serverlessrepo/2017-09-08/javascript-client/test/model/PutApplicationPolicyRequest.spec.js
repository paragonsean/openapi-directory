...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.PutApplicationPolicyRequest();
  });
  ...
  describe('PutApplicationPolicyRequest', function() {
    it('should create an instance of PutApplicationPolicyRequest', function() {
      // uncomment below and update the code to test PutApplicationPolicyRequest
      //var instance = new AwsServerlessApplicationRepository.PutApplicationPolicyRequest();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.PutApplicationPolicyRequest);
    });
