...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ListApplicationVersionsResponse();
  });
  ...
  describe('ListApplicationVersionsResponse', function() {
    it('should create an instance of ListApplicationVersionsResponse', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.ListApplicationVersionsResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ListApplicationVersionsResponse);
    });
