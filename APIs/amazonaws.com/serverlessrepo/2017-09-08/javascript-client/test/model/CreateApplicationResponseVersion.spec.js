...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateApplicationResponseVersion();
  });
  ...
  describe('CreateApplicationResponseVersion', function() {
    it('should create an instance of CreateApplicationResponseVersion', function() {
      // uncomment below and update the code to test CreateApplicationResponseVersion
      //var instance = new AwsServerlessApplicationRepository.CreateApplicationResponseVersion();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateApplicationResponseVersion);
    });
    ...
    it('should have the property resourcesSupported (base name: "ResourcesSupported")', function() {
      // uncomment below and update the code to test the property resourcesSupported
      //var instance = new AwsServerlessApplicationRepository.CreateApplicationResponseVersion();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sourceCodeArchiveUrl (base name: "SourceCodeArchiveUrl")', function() {
      // uncomment below and update the code to test the property sourceCodeArchiveUrl
      //var instance = new AwsServerlessApplicationRepository.CreateApplicationResponseVersion();
      //expect(instance).to.be();
    });

    it('should have the property sourceCodeUrl (base name: "SourceCodeUrl")', function() {
      // uncomment below and update the code to test the property sourceCodeUrl
      //var instance = new AwsServerlessApplicationRepository.CreateApplicationResponseVersion();
      //expect(instance).to.be();
    });
