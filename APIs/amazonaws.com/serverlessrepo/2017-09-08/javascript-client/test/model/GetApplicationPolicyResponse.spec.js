...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.GetApplicationPolicyResponse();
  });
  ...
  describe('GetApplicationPolicyResponse', function() {
    it('should create an instance of GetApplicationPolicyResponse', function() {
      // uncomment below and update the code to test GetApplicationPolicyResponse
      //var instance = new AwsServerlessApplicationRepository.GetApplicationPolicyResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.GetApplicationPolicyResponse);
    });
