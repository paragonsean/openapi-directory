...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.Tag();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.Tag);
    });
