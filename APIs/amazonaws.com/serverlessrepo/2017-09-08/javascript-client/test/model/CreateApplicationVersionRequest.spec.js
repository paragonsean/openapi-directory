...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateApplicationVersionRequest();
  });
  ...
  describe('CreateApplicationVersionRequest', function() {
    it('should create an instance of CreateApplicationVersionRequest', function() {
      // uncomment below and update the code to test CreateApplicationVersionRequest
      //var instance = new AwsServerlessApplicationRepository.CreateApplicationVersionRequest();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateApplicationVersionRequest);
    });
