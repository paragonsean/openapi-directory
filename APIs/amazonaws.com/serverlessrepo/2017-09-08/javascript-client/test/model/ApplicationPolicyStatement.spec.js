...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.ApplicationPolicyStatement();
  });
  ...
  describe('ApplicationPolicyStatement', function() {
    it('should create an instance of ApplicationPolicyStatement', function() {
      // uncomment below and update the code to test ApplicationPolicyStatement
      //var instance = new AwsServerlessApplicationRepository.ApplicationPolicyStatement();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.ApplicationPolicyStatement);
    });
    ...
    it('should have the property principalOrgIDs (base name: "PrincipalOrgIDs")', function() {
      // uncomment below and update the code to test the property principalOrgIDs
      //var instance = new AwsServerlessApplicationRepository.ApplicationPolicyStatement();
      //expect(instance).to.be();
    });
