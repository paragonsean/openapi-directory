...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.RollbackTrigger();
  });
  ...
  describe('RollbackTrigger', function() {
    it('should create an instance of RollbackTrigger', function() {
      ...
      //var instance = new AwsServerlessApplicationRepository.RollbackTrigger();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.RollbackTrigger);
    });
