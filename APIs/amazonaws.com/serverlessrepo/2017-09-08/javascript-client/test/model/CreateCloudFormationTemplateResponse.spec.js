...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsServerlessApplicationRepository.CreateCloudFormationTemplateResponse();
  });
  ...
  describe('CreateCloudFormationTemplateResponse', function() {
    it('should create an instance of CreateCloudFormationTemplateResponse', function() {
      // uncomment below and update the code to test CreateCloudFormationTemplateResponse
      //var instance = new AwsServerlessApplicationRepository.CreateCloudFormationTemplateResponse();
      //expect(instance).to.be.a(AwsServerlessApplicationRepository.CreateCloudFormationTemplateResponse);
    });
