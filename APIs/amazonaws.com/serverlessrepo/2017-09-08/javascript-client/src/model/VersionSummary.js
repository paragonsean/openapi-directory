...
/**
 * The VersionSummary model module.
 * @module model/VersionSummary
 * @version 2017-09-08
 */
class VersionSummary {
    /**
     * Constructs a new <code>VersionSummary</code>.
     * An application version summary.
     * @alias module:model/VersionSummary
     * @param applicationId {String} 
     * @param creationTime {String} 
     * @param semanticVersion {String} 
     */
    constructor(applicationId, creationTime, semanticVersion) { 
        
        VersionSummary.initialize(this, applicationId, creationTime, semanticVersion);
    }
     ...
     */
    static initialize(obj, applicationId, creationTime, semanticVersion) { 
    ...
    /**
     * Constructs a <code>VersionSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VersionSummary} obj Optional instance to populate.
     * @return {module:model/VersionSummary} The populated <code>VersionSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VersionSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>VersionSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VersionSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VersionSummary.RequiredProperties) {
...
VersionSummary.RequiredProperties = ["ApplicationId", "CreationTime", "SemanticVersion"];

/**
 * @member {String} ApplicationId
 */
VersionSummary.prototype['ApplicationId'] = undefined;

/**
 * @member {String} CreationTime
 */
VersionSummary.prototype['CreationTime'] = undefined;

/**
 * @member {String} SemanticVersion
 */
VersionSummary.prototype['SemanticVersion'] = undefined;

/**
 * @member {String} SourceCodeUrl
 */
VersionSummary.prototype['SourceCodeUrl'] = undefined;
