...
/**
 * The GetApplicationPolicyResponse model module.
 * @module model/GetApplicationPolicyResponse
 * @version 2017-09-08
 */
class GetApplicationPolicyResponse {
    /**
     * Constructs a new <code>GetApplicationPolicyResponse</code>.
     * @alias module:model/GetApplicationPolicyResponse
     */
    constructor() { 
        
        GetApplicationPolicyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetApplicationPolicyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetApplicationPolicyResponse} obj Optional instance to populate.
     * @return {module:model/GetApplicationPolicyResponse} The populated <code>GetApplicationPolicyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetApplicationPolicyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetApplicationPolicyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetApplicationPolicyResponse</code>.
     */
 ...
 */
GetApplicationPolicyResponse.prototype['Statements'] = undefined;
...
export default GetApplicationPolicyResponse;
