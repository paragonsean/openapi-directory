...
/**
 * The ListApplicationDependenciesResponse model module.
 * @module model/ListApplicationDependenciesResponse
 * @version 2017-09-08
 */
class ListApplicationDependenciesResponse {
    /**
     * Constructs a new <code>ListApplicationDependenciesResponse</code>.
     * @alias module:model/ListApplicationDependenciesResponse
     */
    constructor() { 
        
        ListApplicationDependenciesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListApplicationDependenciesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListApplicationDependenciesResponse} obj Optional instance to populate.
     * @return {module:model/ListApplicationDependenciesResponse} The populated <code>ListApplicationDependenciesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListApplicationDependenciesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListApplicationDependenciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListApplicationDependenciesResponse</code>.
     */
 ...
 */
ListApplicationDependenciesResponse.prototype['Dependencies'] = undefined;

/**
 * @member {String} NextToken
 */
ListApplicationDependenciesResponse.prototype['NextToken'] = undefined;
...
export default ListApplicationDependenciesResponse;
