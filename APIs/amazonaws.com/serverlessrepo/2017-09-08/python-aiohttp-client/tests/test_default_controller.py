...
async def test_create_application(client):
    ...
    """
    body = {"SourceCodeArchiveUrl":"","SourceCodeUrl":"","Description":"","SpdxLicenseId":"","ReadmeBody":"","LicenseBody":"","Labels":"","TemplateBody":"","LicenseUrl":"","Name":"","SemanticVersion":"","TemplateUrl":"","ReadmeUrl":"","HomePageUrl":"","Author":""}
    headers = { 
...
async def test_create_application_version(client):
    """Test case for create_application_version

    
    """
    body = {"SourceCodeArchiveUrl":"","TemplateUrl":"","SourceCodeUrl":"","TemplateBody":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PUT',
        path='/applications/{application_id}/versions/{semantic_version}'.format(application_id='application_id_example', semantic_version='semantic_version_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_cloud_formation_change_set(client):
    """Test case for create_cloud_formation_change_set

    
    """
    body = {"ResourceTypes":"","RollbackConfiguration":{"RollbackTriggers":"","MonitoringTimeInMinutes":""},"Description":"","Capabilities":"","ParameterOverrides":"","NotificationArns":"","ChangeSetName":"","ClientToken":"","StackName":"","Tags":"","TemplateId":"","SemanticVersion":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/applications/{application_id}/changesets'.format(application_id='application_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_cloud_formation_template(client):
    """Test case for create_cloud_formation_template
    ...
    response = await client.request(
        method='POST',
        path='/applications/{application_id}/templates'.format(application_id='application_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_application(client):
    ...
    """
    params = [('semanticVersion', 'semantic_version_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_get_application_policy(client):
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application_id}/policy'.format(application_id='application_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_cloud_formation_template(client):
    """Test case for get_cloud_formation_template
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application_id}/templates/{template_id}'.format(application_id='application_id_example', template_id='template_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_application_dependencies(client):
    """Test case for list_application_dependencies

    
    """
    params = [('maxItems', 56),
                    ('nextToken', 'next_token_example'),
                    ('semanticVersion', 'semantic_version_example'),
    ...
    response = await client.request(
        method='GET',
        path='/applications/{application_id}/dependencies'.format(application_id='application_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_application_policy(client):
    """Test case for put_application_policy
...
async def test_unshare_application(client):
    """Test case for unshare_application
    ...
    response = await client.request(
        method='POST',
        path='/applications/{application_id}/unshare'.format(application_id='application_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_application(client):
    ...
    """
    body = {"Description":"","ReadmeUrl":"","HomePageUrl":"","ReadmeBody":"","Author":"","Labels":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
