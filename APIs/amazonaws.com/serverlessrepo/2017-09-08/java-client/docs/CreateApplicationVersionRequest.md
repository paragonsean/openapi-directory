...
|**templateBody** | **String** | The raw packaged AWS SAM template of your application. |  [optional] |
|**templateUrl** | **String** | A link to the packaged AWS SAM template of your application. |  [optional] |
