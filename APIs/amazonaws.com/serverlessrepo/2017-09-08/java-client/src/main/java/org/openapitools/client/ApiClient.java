...
public class ApiClient {
    ...
    private String basePath = "http://serverlessrepo.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://serverlessrepo.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://serverlessrepo.{region}.amazonaws.com",
      "The AWSServerlessApplicationRepository multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://serverlessrepo.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://serverlessrepo.{region}.amazonaws.com.cn",
      "The AWSServerlessApplicationRepository endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-09-08/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://serverlessrepo.us-east-1.amazonaws.com
