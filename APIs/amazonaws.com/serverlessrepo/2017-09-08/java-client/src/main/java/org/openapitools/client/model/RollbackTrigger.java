...
public class RollbackTrigger {
  ...
  public RollbackTrigger arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RollbackTrigger type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RollbackTrigger rollbackTrigger = (RollbackTrigger) o;
    return Objects.equals(this.arn, rollbackTrigger.arn) &&
        Objects.equals(this.type, rollbackTrigger.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class RollbackTrigger {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RollbackTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RollbackTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RollbackTrigger is not found in the empty JSON string", RollbackTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RollbackTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RollbackTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RollbackTrigger.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RollbackTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RollbackTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RollbackTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RollbackTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<RollbackTrigger>() {
           @Override
           public void write(JsonWriter out, RollbackTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RollbackTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RollbackTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RollbackTrigger
   * @throws IOException if the JSON string is invalid with respect to RollbackTrigger
   */
  public static RollbackTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RollbackTrigger.class);
  }

  /**
   * Convert an instance of RollbackTrigger to an JSON string
   *
   * @return JSON string
   */
