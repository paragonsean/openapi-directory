...
/*
 * OAICreateApplicationVersionResponse.h
 *
 * 
 */

#ifndef OAICreateApplicationVersionResponse_H
#define OAICreateApplicationVersionResponse_H
...
class OAICreateApplicationVersionResponse : public OAIObject {
public:
    OAICreateApplicationVersionResponse();
    OAICreateApplicationVersionResponse(QString json);
    ~OAICreateApplicationVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationVersionResponse)

#endif // OAICreateApplicationVersionResponse_H
