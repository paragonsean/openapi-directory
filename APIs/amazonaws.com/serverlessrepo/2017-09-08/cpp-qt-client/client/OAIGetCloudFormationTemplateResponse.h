...
/*
 * OAIGetCloudFormationTemplateResponse.h
 *
 * 
 */

#ifndef OAIGetCloudFormationTemplateResponse_H
#define OAIGetCloudFormationTemplateResponse_H
...
class OAIGetCloudFormationTemplateResponse : public OAIObject {
public:
    OAIGetCloudFormationTemplateResponse();
    OAIGetCloudFormationTemplateResponse(QString json);
    ~OAIGetCloudFormationTemplateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCloudFormationTemplateResponse)

#endif // OAIGetCloudFormationTemplateResponse_H
