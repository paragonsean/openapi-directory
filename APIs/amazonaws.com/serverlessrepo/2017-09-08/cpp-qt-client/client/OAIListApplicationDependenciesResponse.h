...
/*
 * OAIListApplicationDependenciesResponse.h
 *
 * 
 */

#ifndef OAIListApplicationDependenciesResponse_H
#define OAIListApplicationDependenciesResponse_H
...
class OAIListApplicationDependenciesResponse : public OAIObject {
public:
    OAIListApplicationDependenciesResponse();
    OAIListApplicationDependenciesResponse(QString json);
    ~OAIListApplicationDependenciesResponse() override;
    ...
    QList getDependencies() const;
    void setDependencies(const QList &dependencies);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListApplicationDependenciesResponse)

#endif // OAIListApplicationDependenciesResponse_H
