...
#include "OAIPutApplicationPolicyRequest.h"
...
OAIPutApplicationPolicyRequest::OAIPutApplicationPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutApplicationPolicyRequest::OAIPutApplicationPolicyRequest() {
    this->initializeModel();
}

OAIPutApplicationPolicyRequest::~OAIPutApplicationPolicyRequest() {}

void OAIPutApplicationPolicyRequest::initializeModel() {

    m_statements_isSet = false;
    m_statements_isValid = false;
}

void OAIPutApplicationPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutApplicationPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutApplicationPolicyRequest::asJson() const {
...
QJsonObject OAIPutApplicationPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPutApplicationPolicyRequest::getStatements() const {
    return m_statements;
}
void OAIPutApplicationPolicyRequest::setStatements(const QList &statements) {
    m_statements = statements;
    m_statements_isSet = true;
}

bool OAIPutApplicationPolicyRequest::is_statements_Set() const{
    return m_statements_isSet;
}

bool OAIPutApplicationPolicyRequest::is_statements_Valid() const{
    return m_statements_isValid;
}

bool OAIPutApplicationPolicyRequest::isSet() const {
...
bool OAIPutApplicationPolicyRequest::isValid() const {
