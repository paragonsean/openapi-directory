...
/*
 * OAIPutApplicationPolicyResponse.h
 *
 * 
 */

#ifndef OAIPutApplicationPolicyResponse_H
#define OAIPutApplicationPolicyResponse_H
...
class OAIPutApplicationPolicyResponse : public OAIObject {
public:
    OAIPutApplicationPolicyResponse();
    OAIPutApplicationPolicyResponse(QString json);
    ~OAIPutApplicationPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutApplicationPolicyResponse)

#endif // OAIPutApplicationPolicyResponse_H
