...
/*
 * OAIUnshareApplicationRequest.h
 *
 * 
 */

#ifndef OAIUnshareApplicationRequest_H
#define OAIUnshareApplicationRequest_H
...
class OAIUnshareApplicationRequest : public OAIObject {
public:
    OAIUnshareApplicationRequest();
    OAIUnshareApplicationRequest(QString json);
    ~OAIUnshareApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnshareApplicationRequest)

#endif // OAIUnshareApplicationRequest_H
