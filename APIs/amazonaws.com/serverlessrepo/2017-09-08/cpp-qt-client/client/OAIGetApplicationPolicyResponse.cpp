...
OAIGetApplicationPolicyResponse::OAIGetApplicationPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetApplicationPolicyResponse::OAIGetApplicationPolicyResponse() {
    this->initializeModel();
}

OAIGetApplicationPolicyResponse::~OAIGetApplicationPolicyResponse() {}

void OAIGetApplicationPolicyResponse::initializeModel() {

    m_statements_isSet = false;
    m_statements_isValid = false;
}

void OAIGetApplicationPolicyResponse::fromJson(QString jsonString) {
...
void OAIGetApplicationPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetApplicationPolicyResponse::asJson() const {
...
QJsonObject OAIGetApplicationPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIGetApplicationPolicyResponse::getStatements() const {
    return m_statements;
}
void OAIGetApplicationPolicyResponse::setStatements(const QList &statements) {
    m_statements = statements;
    m_statements_isSet = true;
}

bool OAIGetApplicationPolicyResponse::is_statements_Set() const{
    return m_statements_isSet;
}

bool OAIGetApplicationPolicyResponse::is_statements_Valid() const{
    return m_statements_isValid;
}

bool OAIGetApplicationPolicyResponse::isSet() const {
...
bool OAIGetApplicationPolicyResponse::isValid() const {
