...
/*
 * OAICreateCloudFormationTemplateRequest.h
 *
 * 
 */

#ifndef OAICreateCloudFormationTemplateRequest_H
#define OAICreateCloudFormationTemplateRequest_H
...
class OAICreateCloudFormationTemplateRequest : public OAIObject {
public:
    OAICreateCloudFormationTemplateRequest();
    OAICreateCloudFormationTemplateRequest(QString json);
    ~OAICreateCloudFormationTemplateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCloudFormationTemplateRequest)

#endif // OAICreateCloudFormationTemplateRequest_H
