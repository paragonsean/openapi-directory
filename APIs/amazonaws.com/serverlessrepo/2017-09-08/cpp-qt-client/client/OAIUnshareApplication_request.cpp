...
OAIUnshareApplication_request::OAIUnshareApplication_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnshareApplication_request::OAIUnshareApplication_request() {
    this->initializeModel();
}

OAIUnshareApplication_request::~OAIUnshareApplication_request() {}

void OAIUnshareApplication_request::initializeModel() {

    m_organization_id_isSet = false;
    m_organization_id_isValid = false;
}

void OAIUnshareApplication_request::fromJson(QString jsonString) {
...
void OAIUnshareApplication_request::fromJsonObject(QJsonObject json) {
...
QString OAIUnshareApplication_request::asJson() const {
...
QJsonObject OAIUnshareApplication_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUnshareApplication_request::getOrganizationId() const {
    return m_organization_id;
}
void OAIUnshareApplication_request::setOrganizationId(const QString &organization_id) {
    m_organization_id = organization_id;
    m_organization_id_isSet = true;
}

bool OAIUnshareApplication_request::is_organization_id_Set() const{
    return m_organization_id_isSet;
}

bool OAIUnshareApplication_request::is_organization_id_Valid() const{
    return m_organization_id_isValid;
}

bool OAIUnshareApplication_request::isSet() const {
...
bool OAIUnshareApplication_request::isValid() const {
