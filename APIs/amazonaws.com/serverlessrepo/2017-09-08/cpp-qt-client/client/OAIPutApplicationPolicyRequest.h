...
/*
 * OAIPutApplicationPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutApplicationPolicyRequest_H
#define OAIPutApplicationPolicyRequest_H
...
class OAIPutApplicationPolicyRequest : public OAIObject {
public:
    OAIPutApplicationPolicyRequest();
    OAIPutApplicationPolicyRequest(QString json);
    ~OAIPutApplicationPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutApplicationPolicyRequest)

#endif // OAIPutApplicationPolicyRequest_H
