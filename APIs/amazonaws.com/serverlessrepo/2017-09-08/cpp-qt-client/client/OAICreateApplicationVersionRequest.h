...
/*
 * OAICreateApplicationVersionRequest.h
 *
 * 
 */

#ifndef OAICreateApplicationVersionRequest_H
#define OAICreateApplicationVersionRequest_H
...
class OAICreateApplicationVersionRequest : public OAIObject {
public:
    OAICreateApplicationVersionRequest();
    OAICreateApplicationVersionRequest(QString json);
    ~OAICreateApplicationVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicationVersionRequest)

#endif // OAICreateApplicationVersionRequest_H
