...
/*
 * OAICreateCloudFormationTemplate_request.h
 *
 * 
 */

#ifndef OAICreateCloudFormationTemplate_request_H
#define OAICreateCloudFormationTemplate_request_H
...
class OAICreateCloudFormationTemplate_request : public OAIObject {
public:
    OAICreateCloudFormationTemplate_request();
    OAICreateCloudFormationTemplate_request(QString json);
    ~OAICreateCloudFormationTemplate_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCloudFormationTemplate_request)

#endif // OAICreateCloudFormationTemplate_request_H
