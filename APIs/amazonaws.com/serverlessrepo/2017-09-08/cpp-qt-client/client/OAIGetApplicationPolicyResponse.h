...
/*
 * OAIGetApplicationPolicyResponse.h
 *
 * 
 */

#ifndef OAIGetApplicationPolicyResponse_H
#define OAIGetApplicationPolicyResponse_H
...
class OAIGetApplicationPolicyResponse : public OAIObject {
public:
    OAIGetApplicationPolicyResponse();
    OAIGetApplicationPolicyResponse(QString json);
    ~OAIGetApplicationPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicationPolicyResponse)

#endif // OAIGetApplicationPolicyResponse_H
