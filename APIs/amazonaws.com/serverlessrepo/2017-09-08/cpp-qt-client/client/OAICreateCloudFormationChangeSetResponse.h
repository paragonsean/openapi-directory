...
/*
 * OAICreateCloudFormationChangeSetResponse.h
 *
 * 
 */

#ifndef OAICreateCloudFormationChangeSetResponse_H
#define OAICreateCloudFormationChangeSetResponse_H
...
class OAICreateCloudFormationChangeSetResponse : public OAIObject {
public:
    OAICreateCloudFormationChangeSetResponse();
    OAICreateCloudFormationChangeSetResponse(QString json);
    ~OAICreateCloudFormationChangeSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCloudFormationChangeSetResponse)

#endif // OAICreateCloudFormationChangeSetResponse_H
