...
QString OAIParameterValue::getName() const {
    return m_name;
}
void OAIParameterValue::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIParameterValue::is_name_Set() const{
    return m_name_isSet;
}

bool OAIParameterValue::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIParameterValue::getValue() const {
    return m_value;
}
void OAIParameterValue::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}
