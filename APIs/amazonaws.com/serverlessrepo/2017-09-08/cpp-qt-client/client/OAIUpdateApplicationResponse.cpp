...
QString OAIUpdateApplicationResponse::getApplicationId() const {
    return m_application_id;
}
void OAIUpdateApplicationResponse::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIUpdateApplicationResponse::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIUpdateApplicationResponse::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QString OAIUpdateApplicationResponse::getAuthor() const {
    return m_author;
}
void OAIUpdateApplicationResponse::setAuthor(const QString &author) {
    m_author = author;
    m_author_isSet = true;
}

bool OAIUpdateApplicationResponse::is_author_Set() const{
    return m_author_isSet;
}

bool OAIUpdateApplicationResponse::is_author_Valid() const{
    return m_author_isValid;
}

QString OAIUpdateApplicationResponse::getCreationTime() const {
    return m_creation_time;
}
void OAIUpdateApplicationResponse::setCreationTime(const QString &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIUpdateApplicationResponse::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIUpdateApplicationResponse::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAIUpdateApplicationResponse::getDescription() const {
    return m_description;
}
void OAIUpdateApplicationResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateApplicationResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateApplicationResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateApplicationResponse::getHomePageUrl() const {
    return m_home_page_url;
}
void OAIUpdateApplicationResponse::setHomePageUrl(const QString &home_page_url) {
    m_home_page_url = home_page_url;
    m_home_page_url_isSet = true;
}

bool OAIUpdateApplicationResponse::is_home_page_url_Set() const{
    return m_home_page_url_isSet;
}

bool OAIUpdateApplicationResponse::is_home_page_url_Valid() const{
    return m_home_page_url_isValid;
}

bool OAIUpdateApplicationResponse::getIsVerifiedAuthor() const {
    return m_is_verified_author;
}
void OAIUpdateApplicationResponse::setIsVerifiedAuthor(const bool &is_verified_author) {
    m_is_verified_author = is_verified_author;
    m_is_verified_author_isSet = true;
}

bool OAIUpdateApplicationResponse::is_is_verified_author_Set() const{
    return m_is_verified_author_isSet;
}

bool OAIUpdateApplicationResponse::is_is_verified_author_Valid() const{
    return m_is_verified_author_isValid;
}

QList OAIUpdateApplicationResponse::getLabels() const {
    return m_labels;
}
void OAIUpdateApplicationResponse::setLabels(const QList &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIUpdateApplicationResponse::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIUpdateApplicationResponse::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIUpdateApplicationResponse::getLicenseUrl() const {
    return m_license_url;
}
void OAIUpdateApplicationResponse::setLicenseUrl(const QString &license_url) {
    m_license_url = license_url;
    m_license_url_isSet = true;
}

bool OAIUpdateApplicationResponse::is_license_url_Set() const{
    return m_license_url_isSet;
}

bool OAIUpdateApplicationResponse::is_license_url_Valid() const{
    return m_license_url_isValid;
}

QString OAIUpdateApplicationResponse::getName() const {
    return m_name;
}
void OAIUpdateApplicationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateApplicationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateApplicationResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateApplicationResponse::getReadmeUrl() const {
    return m_readme_url;
}
void OAIUpdateApplicationResponse::setReadmeUrl(const QString &readme_url) {
    m_readme_url = readme_url;
    m_readme_url_isSet = true;
}

bool OAIUpdateApplicationResponse::is_readme_url_Set() const{
    return m_readme_url_isSet;
}

bool OAIUpdateApplicationResponse::is_readme_url_Valid() const{
    return m_readme_url_isValid;
}

QString OAIUpdateApplicationResponse::getSpdxLicenseId() const {
    return m_spdx_license_id;
}
void OAIUpdateApplicationResponse::setSpdxLicenseId(const QString &spdx_license_id) {
    m_spdx_license_id = spdx_license_id;
    m_spdx_license_id_isSet = true;
}

bool OAIUpdateApplicationResponse::is_spdx_license_id_Set() const{
    return m_spdx_license_id_isSet;
}

bool OAIUpdateApplicationResponse::is_spdx_license_id_Valid() const{
    return m_spdx_license_id_isValid;
}

QString OAIUpdateApplicationResponse::getVerifiedAuthorUrl() const {
    return m_verified_author_url;
}
void OAIUpdateApplicationResponse::setVerifiedAuthorUrl(const QString &verified_author_url) {
    m_verified_author_url = verified_author_url;
    m_verified_author_url_isSet = true;
}

bool OAIUpdateApplicationResponse::is_verified_author_url_Set() const{
    return m_verified_author_url_isSet;
}

bool OAIUpdateApplicationResponse::is_verified_author_url_Valid() const{
    return m_verified_author_url_isValid;
}

OAICreateApplicationResponse_Version OAIUpdateApplicationResponse::getVersion() const {
    return m_version;
}
void OAIUpdateApplicationResponse::setVersion(const OAICreateApplicationResponse_Version &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIUpdateApplicationResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAIUpdateApplicationResponse::is_version_Valid() const{
