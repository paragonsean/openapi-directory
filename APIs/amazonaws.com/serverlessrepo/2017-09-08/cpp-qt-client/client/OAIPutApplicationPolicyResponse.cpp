...
OAIPutApplicationPolicyResponse::OAIPutApplicationPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutApplicationPolicyResponse::OAIPutApplicationPolicyResponse() {
    this->initializeModel();
}

OAIPutApplicationPolicyResponse::~OAIPutApplicationPolicyResponse() {}

void OAIPutApplicationPolicyResponse::initializeModel() {

    m_statements_isSet = false;
    m_statements_isValid = false;
}

void OAIPutApplicationPolicyResponse::fromJson(QString jsonString) {
...
void OAIPutApplicationPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutApplicationPolicyResponse::asJson() const {
...
QJsonObject OAIPutApplicationPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPutApplicationPolicyResponse::getStatements() const {
    return m_statements;
}
void OAIPutApplicationPolicyResponse::setStatements(const QList &statements) {
    m_statements = statements;
    m_statements_isSet = true;
}

bool OAIPutApplicationPolicyResponse::is_statements_Set() const{
    return m_statements_isSet;
}

bool OAIPutApplicationPolicyResponse::is_statements_Valid() const{
    return m_statements_isValid;
}

bool OAIPutApplicationPolicyResponse::isSet() const {
...
bool OAIPutApplicationPolicyResponse::isValid() const {
