...
/*
 * OAICreateCloudFormationTemplateResponse.h
 *
 * 
 */

#ifndef OAICreateCloudFormationTemplateResponse_H
#define OAICreateCloudFormationTemplateResponse_H
...
class OAICreateCloudFormationTemplateResponse : public OAIObject {
public:
    OAICreateCloudFormationTemplateResponse();
    OAICreateCloudFormationTemplateResponse(QString json);
    ~OAICreateCloudFormationTemplateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCloudFormationTemplateResponse)

#endif // OAICreateCloudFormationTemplateResponse_H
