...
namespace OpenAPI {
class OAICreateApplicationResponse_Version;
...
public:
    ...
    void setIsVerifiedAuthor(const bool &is_verified_author);
    bool is_is_verified_author_Set() const;
    bool is_is_verified_author_Valid() const;
    ...
    QString getVerifiedAuthorUrl() const;
    void setVerifiedAuthorUrl(const QString &verified_author_url);
    bool is_verified_author_url_Set() const;
    bool is_verified_author_url_Valid() const;

    OAICreateApplicationResponse_Version getVersion() const;
    void setVersion(const OAICreateApplicationResponse_Version &version);
...
private:
    ...
    bool m_is_verified_author;
    bool m_is_verified_author_isSet;
    bool m_is_verified_author_isValid;
    ...
    QString m_verified_author_url;
    bool m_verified_author_url_isSet;
    bool m_verified_author_url_isValid;

    OAICreateApplicationResponse_Version m_version;
