...
/*
 * OAICreateCloudFormationChangeSetRequest.h
 *
 * 
 */

#ifndef OAICreateCloudFormationChangeSetRequest_H
#define OAICreateCloudFormationChangeSetRequest_H
...
namespace OpenAPI {
class OAICreateCloudFormationChangeSetRequest_RollbackConfiguration;

class OAICreateCloudFormationChangeSetRequest : public OAIObject {
public:
    OAICreateCloudFormationChangeSetRequest();
    OAICreateCloudFormationChangeSetRequest(QString json);
    ~OAICreateCloudFormationChangeSetRequest() override;
    ...
    OAICreateCloudFormationChangeSetRequest_RollbackConfiguration getRollbackConfiguration() const;
    void setRollbackConfiguration(const OAICreateCloudFormationChangeSetRequest_RollbackConfiguration &rollback_configuration);
...
private:
    ...
    OAICreateCloudFormationChangeSetRequest_RollbackConfiguration m_rollback_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCloudFormationChangeSetRequest)

#endif // OAICreateCloudFormationChangeSetRequest_H
