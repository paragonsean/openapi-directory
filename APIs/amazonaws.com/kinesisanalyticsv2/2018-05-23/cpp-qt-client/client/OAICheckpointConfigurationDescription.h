...
/*
 * OAICheckpointConfigurationDescription.h
 *
 * Describes checkpointing parameters for a Flink-based Kinesis Data Analytics application.
 */

#ifndef OAICheckpointConfigurationDescription_H
#define OAICheckpointConfigurationDescription_H
...
class OAICheckpointConfigurationDescription : public OAIObject {
public:
    OAICheckpointConfigurationDescription();
    OAICheckpointConfigurationDescription(QString json);
    ~OAICheckpointConfigurationDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckpointConfigurationDescription)

#endif // OAICheckpointConfigurationDescription_H
