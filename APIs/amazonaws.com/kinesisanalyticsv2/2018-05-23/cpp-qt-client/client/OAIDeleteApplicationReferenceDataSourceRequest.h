...
/*
 * OAIDeleteApplicationReferenceDataSourceRequest.h
 *
 * 
 */

#ifndef OAIDeleteApplicationReferenceDataSourceRequest_H
#define OAIDeleteApplicationReferenceDataSourceRequest_H
...
class OAIDeleteApplicationReferenceDataSourceRequest : public OAIObject {
public:
    OAIDeleteApplicationReferenceDataSourceRequest();
    OAIDeleteApplicationReferenceDataSourceRequest(QString json);
    ~OAIDeleteApplicationReferenceDataSourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicationReferenceDataSourceRequest)

#endif // OAIDeleteApplicationReferenceDataSourceRequest_H
