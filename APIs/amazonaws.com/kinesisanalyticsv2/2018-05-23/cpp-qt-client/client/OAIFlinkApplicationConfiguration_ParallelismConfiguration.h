...
/*
 * OAIFlinkApplicationConfiguration_ParallelismConfiguration.h
 *
 * 
 */

#ifndef OAIFlinkApplicationConfiguration_ParallelismConfiguration_H
#define OAIFlinkApplicationConfiguration_ParallelismConfiguration_H
...
class OAIFlinkApplicationConfiguration_ParallelismConfiguration : public OAIObject {
public:
    OAIFlinkApplicationConfiguration_ParallelismConfiguration();
    OAIFlinkApplicationConfiguration_ParallelismConfiguration(QString json);
    ~OAIFlinkApplicationConfiguration_ParallelismConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlinkApplicationConfiguration_ParallelismConfiguration)

#endif // OAIFlinkApplicationConfiguration_ParallelismConfiguration_H
