...
/*
 * OAIAddApplicationOutputResponse.h
 *
 * 
 */

#ifndef OAIAddApplicationOutputResponse_H
#define OAIAddApplicationOutputResponse_H
...
class OAIAddApplicationOutputResponse : public OAIObject {
public:
    OAIAddApplicationOutputResponse();
    OAIAddApplicationOutputResponse(QString json);
    ~OAIAddApplicationOutputResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddApplicationOutputResponse)

#endif // OAIAddApplicationOutputResponse_H
