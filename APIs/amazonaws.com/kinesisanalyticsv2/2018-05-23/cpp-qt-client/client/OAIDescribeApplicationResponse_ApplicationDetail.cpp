...
OAIRuntimeEnvironment OAIDescribeApplicationResponse_ApplicationDetail::getRuntimeEnvironment() const {
    return m_runtime_environment;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setRuntimeEnvironment(const OAIRuntimeEnvironment &runtime_environment) {
    m_runtime_environment = runtime_environment;
    m_runtime_environment_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_runtime_environment_Set() const{
    return m_runtime_environment_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_runtime_environment_Valid() const{
    return m_runtime_environment_isValid;
}

QString OAIDescribeApplicationResponse_ApplicationDetail::getServiceExecutionRole() const {
    return m_service_execution_role;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setServiceExecutionRole(const QString &service_execution_role) {
    m_service_execution_role = service_execution_role;
    m_service_execution_role_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_service_execution_role_Set() const{
    return m_service_execution_role_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_service_execution_role_Valid() const{
...
OAIApplicationDetail_ApplicationConfigurationDescription OAIDescribeApplicationResponse_ApplicationDetail::getApplicationConfigurationDescription() const {
    return m_application_configuration_description;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationConfigurationDescription(const OAIApplicationDetail_ApplicationConfigurationDescription &application_configuration_description) {
...
bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_configuration_description_Set() const{
    return m_application_configuration_description_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_configuration_description_Valid() const{
...
OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription OAIDescribeApplicationResponse_ApplicationDetail::getApplicationMaintenanceConfigurationDescription() const {
    return m_application_maintenance_configuration_description;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationMaintenanceConfigurationDescription(const OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription &application_maintenance_configuration_description) {
...
bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_maintenance_configuration_description_Set() const{
    return m_application_maintenance_configuration_description_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_maintenance_configuration_description_Valid() const{
    return m_application_maintenance_configuration_description_isValid;
}

qint32 OAIDescribeApplicationResponse_ApplicationDetail::getApplicationVersionUpdatedFrom() const {
    return m_application_version_updated_from;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationVersionUpdatedFrom(const qint32 &application_version_updated_from) {
    m_application_version_updated_from = application_version_updated_from;
    m_application_version_updated_from_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_updated_from_Set() const{
    return m_application_version_updated_from_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_updated_from_Valid() const{
    return m_application_version_updated_from_isValid;
}

qint32 OAIDescribeApplicationResponse_ApplicationDetail::getApplicationVersionRolledBackFrom() const {
    return m_application_version_rolled_back_from;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationVersionRolledBackFrom(const qint32 &application_version_rolled_back_from) {
...
bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_rolled_back_from_Set() const{
    return m_application_version_rolled_back_from_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_rolled_back_from_Valid() const{
    return m_application_version_rolled_back_from_isValid;
}

QString OAIDescribeApplicationResponse_ApplicationDetail::getConditionalToken() const {
    return m_conditional_token;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setConditionalToken(const QString &conditional_token) {
    m_conditional_token = conditional_token;
    m_conditional_token_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_conditional_token_Set() const{
    return m_conditional_token_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_conditional_token_Valid() const{
    return m_conditional_token_isValid;
}

qint32 OAIDescribeApplicationResponse_ApplicationDetail::getApplicationVersionRolledBackTo() const {
    return m_application_version_rolled_back_to;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationVersionRolledBackTo(const qint32 &application_version_rolled_back_to) {
    m_application_version_rolled_back_to = application_version_rolled_back_to;
    m_application_version_rolled_back_to_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_rolled_back_to_Set() const{
    return m_application_version_rolled_back_to_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_version_rolled_back_to_Valid() const{
    return m_application_version_rolled_back_to_isValid;
}

OAIApplicationMode OAIDescribeApplicationResponse_ApplicationDetail::getApplicationMode() const {
    return m_application_mode;
}
void OAIDescribeApplicationResponse_ApplicationDetail::setApplicationMode(const OAIApplicationMode &application_mode) {
    m_application_mode = application_mode;
    m_application_mode_isSet = true;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_mode_Set() const{
    return m_application_mode_isSet;
}

bool OAIDescribeApplicationResponse_ApplicationDetail::is_application_mode_Valid() const{
