...
OAIDeleteApplicationOutputRequest::OAIDeleteApplicationOutputRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteApplicationOutputRequest::OAIDeleteApplicationOutputRequest() {
    this->initializeModel();
}

OAIDeleteApplicationOutputRequest::~OAIDeleteApplicationOutputRequest() {}

void OAIDeleteApplicationOutputRequest::initializeModel() {
...
void OAIDeleteApplicationOutputRequest::fromJson(QString jsonString) {
...
void OAIDeleteApplicationOutputRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteApplicationOutputRequest::asJson() const {
...
QJsonObject OAIDeleteApplicationOutputRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteApplicationOutputRequest::getApplicationName() const {
    return m_application_name;
}
void OAIDeleteApplicationOutputRequest::setApplicationName(const QString &application_name) {
    m_application_name = application_name;
    m_application_name_isSet = true;
}

bool OAIDeleteApplicationOutputRequest::is_application_name_Set() const{
    return m_application_name_isSet;
}

bool OAIDeleteApplicationOutputRequest::is_application_name_Valid() const{
    return m_application_name_isValid;
}

qint32 OAIDeleteApplicationOutputRequest::getCurrentApplicationVersionId() const {
    return m_current_application_version_id;
}
void OAIDeleteApplicationOutputRequest::setCurrentApplicationVersionId(const qint32 &current_application_version_id) {
    m_current_application_version_id = current_application_version_id;
    m_current_application_version_id_isSet = true;
}

bool OAIDeleteApplicationOutputRequest::is_current_application_version_id_Set() const{
    return m_current_application_version_id_isSet;
}

bool OAIDeleteApplicationOutputRequest::is_current_application_version_id_Valid() const{
    return m_current_application_version_id_isValid;
}

QString OAIDeleteApplicationOutputRequest::getOutputId() const {
    return m_output_id;
}
void OAIDeleteApplicationOutputRequest::setOutputId(const QString &output_id) {
    m_output_id = output_id;
    m_output_id_isSet = true;
}

bool OAIDeleteApplicationOutputRequest::is_output_id_Set() const{
    return m_output_id_isSet;
}

bool OAIDeleteApplicationOutputRequest::is_output_id_Valid() const{
    return m_output_id_isValid;
}

bool OAIDeleteApplicationOutputRequest::isSet() const {
...
bool OAIDeleteApplicationOutputRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_application_name_isValid && m_current_application_version_id_isValid && m_output_id_isValid && true;
}
