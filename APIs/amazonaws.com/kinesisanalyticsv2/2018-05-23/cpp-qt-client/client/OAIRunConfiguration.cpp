...
OAIRunConfiguration_FlinkRunConfiguration OAIRunConfiguration::getFlinkRunConfiguration() const {
    return m_flink_run_configuration;
}
void OAIRunConfiguration::setFlinkRunConfiguration(const OAIRunConfiguration_FlinkRunConfiguration &flink_run_configuration) {
    m_flink_run_configuration = flink_run_configuration;
    m_flink_run_configuration_isSet = true;
}

bool OAIRunConfiguration::is_flink_run_configuration_Set() const{
    return m_flink_run_configuration_isSet;
}

bool OAIRunConfiguration::is_flink_run_configuration_Valid() const{
    return m_flink_run_configuration_isValid;
}

QList OAIRunConfiguration::getSqlRunConfigurations() const {
    return m_sql_run_configurations;
}
void OAIRunConfiguration::setSqlRunConfigurations(const QList &sql_run_configurations) {
    m_sql_run_configurations = sql_run_configurations;
    m_sql_run_configurations_isSet = true;
}

bool OAIRunConfiguration::is_sql_run_configurations_Set() const{
    return m_sql_run_configurations_isSet;
}

bool OAIRunConfiguration::is_sql_run_configurations_Valid() const{
    return m_sql_run_configurations_isValid;
}

OAIRunConfigurationDescription_ApplicationRestoreConfigurationDescription OAIRunConfiguration::getApplicationRestoreConfiguration() const {
    return m_application_restore_configuration;
}
void OAIRunConfiguration::setApplicationRestoreConfiguration(const OAIRunConfigurationDescription_ApplicationRestoreConfigurationDescription &application_restore_configuration) {
    m_application_restore_configuration = application_restore_configuration;
    m_application_restore_configuration_isSet = true;
}

bool OAIRunConfiguration::is_application_restore_configuration_Set() const{
    return m_application_restore_configuration_isSet;
}

bool OAIRunConfiguration::is_application_restore_configuration_Valid() const{
