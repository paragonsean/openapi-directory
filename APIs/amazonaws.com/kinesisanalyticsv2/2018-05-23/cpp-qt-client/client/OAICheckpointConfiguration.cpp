...
#include "OAICheckpointConfiguration.h"
...
OAICheckpointConfiguration::OAICheckpointConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICheckpointConfiguration::OAICheckpointConfiguration() {
    this->initializeModel();
}

OAICheckpointConfiguration::~OAICheckpointConfiguration() {}

void OAICheckpointConfiguration::initializeModel() {
...
void OAICheckpointConfiguration::fromJson(QString jsonString) {
...
void OAICheckpointConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICheckpointConfiguration::asJson() const {
...
QJsonObject OAICheckpointConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIConfigurationType OAICheckpointConfiguration::getConfigurationType() const {
    return m_configuration_type;
}
void OAICheckpointConfiguration::setConfigurationType(const OAIConfigurationType &configuration_type) {
    m_configuration_type = configuration_type;
    m_configuration_type_isSet = true;
}

bool OAICheckpointConfiguration::is_configuration_type_Set() const{
    return m_configuration_type_isSet;
}

bool OAICheckpointConfiguration::is_configuration_type_Valid() const{
    return m_configuration_type_isValid;
}

bool OAICheckpointConfiguration::getCheckpointingEnabled() const {
    return m_checkpointing_enabled;
}
void OAICheckpointConfiguration::setCheckpointingEnabled(const bool &checkpointing_enabled) {
    m_checkpointing_enabled = checkpointing_enabled;
    m_checkpointing_enabled_isSet = true;
}

bool OAICheckpointConfiguration::is_checkpointing_enabled_Set() const{
    return m_checkpointing_enabled_isSet;
}

bool OAICheckpointConfiguration::is_checkpointing_enabled_Valid() const{
    return m_checkpointing_enabled_isValid;
}

qint32 OAICheckpointConfiguration::getCheckpointInterval() const {
    return m_checkpoint_interval;
}
void OAICheckpointConfiguration::setCheckpointInterval(const qint32 &checkpoint_interval) {
    m_checkpoint_interval = checkpoint_interval;
    m_checkpoint_interval_isSet = true;
}

bool OAICheckpointConfiguration::is_checkpoint_interval_Set() const{
    return m_checkpoint_interval_isSet;
}

bool OAICheckpointConfiguration::is_checkpoint_interval_Valid() const{
    return m_checkpoint_interval_isValid;
}

qint32 OAICheckpointConfiguration::getMinPauseBetweenCheckpoints() const {
    return m_min_pause_between_checkpoints;
}
void OAICheckpointConfiguration::setMinPauseBetweenCheckpoints(const qint32 &min_pause_between_checkpoints) {
    m_min_pause_between_checkpoints = min_pause_between_checkpoints;
    m_min_pause_between_checkpoints_isSet = true;
}

bool OAICheckpointConfiguration::is_min_pause_between_checkpoints_Set() const{
    return m_min_pause_between_checkpoints_isSet;
}

bool OAICheckpointConfiguration::is_min_pause_between_checkpoints_Valid() const{
    return m_min_pause_between_checkpoints_isValid;
}

bool OAICheckpointConfiguration::isSet() const {
...
bool OAICheckpointConfiguration::isValid() const {
