...
#include "OAICreateApplicationResponse_ApplicationDetail.h"
...
OAICreateApplicationResponse_ApplicationDetail::OAICreateApplicationResponse_ApplicationDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApplicationResponse_ApplicationDetail::OAICreateApplicationResponse_ApplicationDetail() {
    this->initializeModel();
}

OAICreateApplicationResponse_ApplicationDetail::~OAICreateApplicationResponse_ApplicationDetail() {}

void OAICreateApplicationResponse_ApplicationDetail::initializeModel() {
...
void OAICreateApplicationResponse_ApplicationDetail::fromJson(QString jsonString) {
...
void OAICreateApplicationResponse_ApplicationDetail::fromJsonObject(QJsonObject json) {
...
QString OAICreateApplicationResponse_ApplicationDetail::asJson() const {
...
QJsonObject OAICreateApplicationResponse_ApplicationDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApplicationResponse_ApplicationDetail::getApplicationArn() const {
    return m_application_arn;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationArn(const QString &application_arn) {
    m_application_arn = application_arn;
    m_application_arn_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_arn_Set() const{
    return m_application_arn_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_arn_Valid() const{
    return m_application_arn_isValid;
}

QString OAICreateApplicationResponse_ApplicationDetail::getApplicationDescription() const {
    return m_application_description;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationDescription(const QString &application_description) {
    m_application_description = application_description;
    m_application_description_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_description_Set() const{
    return m_application_description_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_description_Valid() const{
    return m_application_description_isValid;
}

QString OAICreateApplicationResponse_ApplicationDetail::getApplicationName() const {
    return m_application_name;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationName(const QString &application_name) {
    m_application_name = application_name;
    m_application_name_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_name_Set() const{
    return m_application_name_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_name_Valid() const{
    return m_application_name_isValid;
}

OAIRuntimeEnvironment OAICreateApplicationResponse_ApplicationDetail::getRuntimeEnvironment() const {
    return m_runtime_environment;
}
void OAICreateApplicationResponse_ApplicationDetail::setRuntimeEnvironment(const OAIRuntimeEnvironment &runtime_environment) {
    m_runtime_environment = runtime_environment;
    m_runtime_environment_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_runtime_environment_Set() const{
    return m_runtime_environment_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_runtime_environment_Valid() const{
    return m_runtime_environment_isValid;
}

QString OAICreateApplicationResponse_ApplicationDetail::getServiceExecutionRole() const {
    return m_service_execution_role;
}
void OAICreateApplicationResponse_ApplicationDetail::setServiceExecutionRole(const QString &service_execution_role) {
    m_service_execution_role = service_execution_role;
    m_service_execution_role_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_service_execution_role_Set() const{
    return m_service_execution_role_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_service_execution_role_Valid() const{
    return m_service_execution_role_isValid;
}

OAIApplicationStatus OAICreateApplicationResponse_ApplicationDetail::getApplicationStatus() const {
    return m_application_status;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationStatus(const OAIApplicationStatus &application_status) {
    m_application_status = application_status;
    m_application_status_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_status_Set() const{
    return m_application_status_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_status_Valid() const{
    return m_application_status_isValid;
}

qint32 OAICreateApplicationResponse_ApplicationDetail::getApplicationVersionId() const {
    return m_application_version_id;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationVersionId(const qint32 &application_version_id) {
    m_application_version_id = application_version_id;
    m_application_version_id_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_id_Set() const{
    return m_application_version_id_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_id_Valid() const{
    return m_application_version_id_isValid;
}

QDateTime OAICreateApplicationResponse_ApplicationDetail::getCreateTimestamp() const {
    return m_create_timestamp;
}
void OAICreateApplicationResponse_ApplicationDetail::setCreateTimestamp(const QDateTime &create_timestamp) {
    m_create_timestamp = create_timestamp;
    m_create_timestamp_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_create_timestamp_Set() const{
    return m_create_timestamp_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_create_timestamp_Valid() const{
    return m_create_timestamp_isValid;
}

QDateTime OAICreateApplicationResponse_ApplicationDetail::getLastUpdateTimestamp() const {
    return m_last_update_timestamp;
}
void OAICreateApplicationResponse_ApplicationDetail::setLastUpdateTimestamp(const QDateTime &last_update_timestamp) {
    m_last_update_timestamp = last_update_timestamp;
    m_last_update_timestamp_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_last_update_timestamp_Set() const{
    return m_last_update_timestamp_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_last_update_timestamp_Valid() const{
    return m_last_update_timestamp_isValid;
}

OAIApplicationDetail_ApplicationConfigurationDescription OAICreateApplicationResponse_ApplicationDetail::getApplicationConfigurationDescription() const {
    return m_application_configuration_description;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationConfigurationDescription(const OAIApplicationDetail_ApplicationConfigurationDescription &application_configuration_description) {
...
bool OAICreateApplicationResponse_ApplicationDetail::is_application_configuration_description_Set() const{
    return m_application_configuration_description_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_configuration_description_Valid() const{
    return m_application_configuration_description_isValid;
}

QList OAICreateApplicationResponse_ApplicationDetail::getCloudWatchLoggingOptionDescriptions() const {
    return m_cloud_watch_logging_option_descriptions;
}
void OAICreateApplicationResponse_ApplicationDetail::setCloudWatchLoggingOptionDescriptions(const QList &cloud_watch_logging_option_descriptions) {
...
bool OAICreateApplicationResponse_ApplicationDetail::is_cloud_watch_logging_option_descriptions_Set() const{
    return m_cloud_watch_logging_option_descriptions_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_cloud_watch_logging_option_descriptions_Valid() const{
    return m_cloud_watch_logging_option_descriptions_isValid;
}

OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription OAICreateApplicationResponse_ApplicationDetail::getApplicationMaintenanceConfigurationDescription() const {
    return m_application_maintenance_configuration_description;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationMaintenanceConfigurationDescription(const OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription &application_maintenance_configuration_description) {
...
bool OAICreateApplicationResponse_ApplicationDetail::is_application_maintenance_configuration_description_Set() const{
    return m_application_maintenance_configuration_description_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_maintenance_configuration_description_Valid() const{
    return m_application_maintenance_configuration_description_isValid;
}

qint32 OAICreateApplicationResponse_ApplicationDetail::getApplicationVersionUpdatedFrom() const {
    return m_application_version_updated_from;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationVersionUpdatedFrom(const qint32 &application_version_updated_from) {
    m_application_version_updated_from = application_version_updated_from;
    m_application_version_updated_from_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_updated_from_Set() const{
    return m_application_version_updated_from_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_updated_from_Valid() const{
    return m_application_version_updated_from_isValid;
}

qint32 OAICreateApplicationResponse_ApplicationDetail::getApplicationVersionRolledBackFrom() const {
    return m_application_version_rolled_back_from;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationVersionRolledBackFrom(const qint32 &application_version_rolled_back_from) {
...
bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_rolled_back_from_Set() const{
    return m_application_version_rolled_back_from_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_rolled_back_from_Valid() const{
    return m_application_version_rolled_back_from_isValid;
}

QString OAICreateApplicationResponse_ApplicationDetail::getConditionalToken() const {
    return m_conditional_token;
}
void OAICreateApplicationResponse_ApplicationDetail::setConditionalToken(const QString &conditional_token) {
    m_conditional_token = conditional_token;
    m_conditional_token_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_conditional_token_Set() const{
    return m_conditional_token_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_conditional_token_Valid() const{
    return m_conditional_token_isValid;
}

qint32 OAICreateApplicationResponse_ApplicationDetail::getApplicationVersionRolledBackTo() const {
    return m_application_version_rolled_back_to;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationVersionRolledBackTo(const qint32 &application_version_rolled_back_to) {
    m_application_version_rolled_back_to = application_version_rolled_back_to;
    m_application_version_rolled_back_to_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_rolled_back_to_Set() const{
    return m_application_version_rolled_back_to_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_version_rolled_back_to_Valid() const{
    return m_application_version_rolled_back_to_isValid;
}

OAIApplicationMode OAICreateApplicationResponse_ApplicationDetail::getApplicationMode() const {
    return m_application_mode;
}
void OAICreateApplicationResponse_ApplicationDetail::setApplicationMode(const OAIApplicationMode &application_mode) {
    m_application_mode = application_mode;
    m_application_mode_isSet = true;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_mode_Set() const{
    return m_application_mode_isSet;
}

bool OAICreateApplicationResponse_ApplicationDetail::is_application_mode_Valid() const{
    return m_application_mode_isValid;
}

bool OAICreateApplicationResponse_ApplicationDetail::isSet() const {
...
bool OAICreateApplicationResponse_ApplicationDetail::isValid() const {
