...
/*
 * OAIS3ContentBaseLocation.h
 *
 * The S3 bucket that holds the application information.
 */

#ifndef OAIS3ContentBaseLocation_H
#define OAIS3ContentBaseLocation_H
...
class OAIS3ContentBaseLocation : public OAIObject {
public:
    OAIS3ContentBaseLocation();
    OAIS3ContentBaseLocation(QString json);
    ~OAIS3ContentBaseLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3ContentBaseLocation)

#endif // OAIS3ContentBaseLocation_H
