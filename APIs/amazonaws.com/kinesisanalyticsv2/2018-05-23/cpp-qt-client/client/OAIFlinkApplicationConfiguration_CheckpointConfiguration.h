...
/*
 * OAIFlinkApplicationConfiguration_CheckpointConfiguration.h
 *
 * 
 */

#ifndef OAIFlinkApplicationConfiguration_CheckpointConfiguration_H
#define OAIFlinkApplicationConfiguration_CheckpointConfiguration_H
...
class OAIFlinkApplicationConfiguration_CheckpointConfiguration : public OAIObject {
public:
    OAIFlinkApplicationConfiguration_CheckpointConfiguration();
    OAIFlinkApplicationConfiguration_CheckpointConfiguration(QString json);
    ~OAIFlinkApplicationConfiguration_CheckpointConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlinkApplicationConfiguration_CheckpointConfiguration)

#endif // OAIFlinkApplicationConfiguration_CheckpointConfiguration_H
