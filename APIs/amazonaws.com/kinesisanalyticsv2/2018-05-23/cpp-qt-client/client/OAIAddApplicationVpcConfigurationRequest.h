...
/*
 * OAIAddApplicationVpcConfigurationRequest.h
 *
 * 
 */

#ifndef OAIAddApplicationVpcConfigurationRequest_H
#define OAIAddApplicationVpcConfigurationRequest_H
...
namespace OpenAPI {
class OAIAddApplicationVpcConfigurationRequest_VpcConfiguration;

class OAIAddApplicationVpcConfigurationRequest : public OAIObject {
public:
    OAIAddApplicationVpcConfigurationRequest();
    OAIAddApplicationVpcConfigurationRequest(QString json);
    ~OAIAddApplicationVpcConfigurationRequest() override;
    ...
    OAIAddApplicationVpcConfigurationRequest_VpcConfiguration getVpcConfiguration() const;
    void setVpcConfiguration(const OAIAddApplicationVpcConfigurationRequest_VpcConfiguration &vpc_configuration);
...
private:
    ...
    OAIAddApplicationVpcConfigurationRequest_VpcConfiguration m_vpc_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddApplicationVpcConfigurationRequest)

#endif // OAIAddApplicationVpcConfigurationRequest_H
