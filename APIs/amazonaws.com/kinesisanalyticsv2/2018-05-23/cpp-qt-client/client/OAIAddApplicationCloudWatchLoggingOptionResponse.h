...
/*
 * OAIAddApplicationCloudWatchLoggingOptionResponse.h
 *
 * 
 */

#ifndef OAIAddApplicationCloudWatchLoggingOptionResponse_H
#define OAIAddApplicationCloudWatchLoggingOptionResponse_H
...
class OAIAddApplicationCloudWatchLoggingOptionResponse : public OAIObject {
public:
    OAIAddApplicationCloudWatchLoggingOptionResponse();
    OAIAddApplicationCloudWatchLoggingOptionResponse(QString json);
    ~OAIAddApplicationCloudWatchLoggingOptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddApplicationCloudWatchLoggingOptionResponse)

#endif // OAIAddApplicationCloudWatchLoggingOptionResponse_H
