...
/*
 * OAIDescribeApplicationResponse_ApplicationDetail.h
 *
 * 
 */

#ifndef OAIDescribeApplicationResponse_ApplicationDetail_H
#define OAIDescribeApplicationResponse_ApplicationDetail_H
...
class OAIDescribeApplicationResponse_ApplicationDetail : public OAIObject {
public:
    OAIDescribeApplicationResponse_ApplicationDetail();
    OAIDescribeApplicationResponse_ApplicationDetail(QString json);
    ~OAIDescribeApplicationResponse_ApplicationDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeApplicationResponse_ApplicationDetail)

#endif // OAIDescribeApplicationResponse_ApplicationDetail_H
