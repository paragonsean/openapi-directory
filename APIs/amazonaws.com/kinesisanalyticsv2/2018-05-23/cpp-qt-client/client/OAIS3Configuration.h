...
#ifndef OAIS3Configuration_H
#define OAIS3Configuration_H
...
class OAIS3Configuration : public OAIObject {
public:
    OAIS3Configuration();
    OAIS3Configuration(QString json);
    ~OAIS3Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3Configuration)

#endif // OAIS3Configuration_H
