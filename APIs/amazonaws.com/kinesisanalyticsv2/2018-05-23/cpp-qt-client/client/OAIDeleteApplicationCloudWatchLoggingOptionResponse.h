...
/*
 * OAIDeleteApplicationCloudWatchLoggingOptionResponse.h
 *
 * 
 */

#ifndef OAIDeleteApplicationCloudWatchLoggingOptionResponse_H
#define OAIDeleteApplicationCloudWatchLoggingOptionResponse_H
...
class OAIDeleteApplicationCloudWatchLoggingOptionResponse : public OAIObject {
public:
    OAIDeleteApplicationCloudWatchLoggingOptionResponse();
    OAIDeleteApplicationCloudWatchLoggingOptionResponse(QString json);
    ~OAIDeleteApplicationCloudWatchLoggingOptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicationCloudWatchLoggingOptionResponse)

#endif // OAIDeleteApplicationCloudWatchLoggingOptionResponse_H
