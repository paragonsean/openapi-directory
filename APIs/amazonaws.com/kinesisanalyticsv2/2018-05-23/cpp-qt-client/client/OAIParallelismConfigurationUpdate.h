...
/*
 * OAIParallelismConfigurationUpdate.h
 *
 * Describes updates to parameters for how an application executes multiple tasks simultaneously.
 */

#ifndef OAIParallelismConfigurationUpdate_H
#define OAIParallelismConfigurationUpdate_H
...
class OAIParallelismConfigurationUpdate : public OAIObject {
public:
    OAIParallelismConfigurationUpdate();
    OAIParallelismConfigurationUpdate(QString json);
    ~OAIParallelismConfigurationUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParallelismConfigurationUpdate)

#endif // OAIParallelismConfigurationUpdate_H
