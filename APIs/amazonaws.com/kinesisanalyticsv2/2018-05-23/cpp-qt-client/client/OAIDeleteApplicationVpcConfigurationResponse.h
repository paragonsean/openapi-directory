...
/*
 * OAIDeleteApplicationVpcConfigurationResponse.h
 *
 * 
 */

#ifndef OAIDeleteApplicationVpcConfigurationResponse_H
#define OAIDeleteApplicationVpcConfigurationResponse_H
...
class OAIDeleteApplicationVpcConfigurationResponse : public OAIObject {
public:
    OAIDeleteApplicationVpcConfigurationResponse();
    OAIDeleteApplicationVpcConfigurationResponse(QString json);
    ~OAIDeleteApplicationVpcConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicationVpcConfigurationResponse)

#endif // OAIDeleteApplicationVpcConfigurationResponse_H
