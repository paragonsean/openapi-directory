...
OAIRuntimeEnvironment OAIApplicationDetail::getRuntimeEnvironment() const {
    return m_runtime_environment;
}
void OAIApplicationDetail::setRuntimeEnvironment(const OAIRuntimeEnvironment &runtime_environment) {
    m_runtime_environment = runtime_environment;
    m_runtime_environment_isSet = true;
}

bool OAIApplicationDetail::is_runtime_environment_Set() const{
    return m_runtime_environment_isSet;
}

bool OAIApplicationDetail::is_runtime_environment_Valid() const{
    return m_runtime_environment_isValid;
}

QString OAIApplicationDetail::getServiceExecutionRole() const {
    return m_service_execution_role;
}
void OAIApplicationDetail::setServiceExecutionRole(const QString &service_execution_role) {
    m_service_execution_role = service_execution_role;
    m_service_execution_role_isSet = true;
}

bool OAIApplicationDetail::is_service_execution_role_Set() const{
    return m_service_execution_role_isSet;
}

bool OAIApplicationDetail::is_service_execution_role_Valid() const{
...
OAIApplicationDetail_ApplicationConfigurationDescription OAIApplicationDetail::getApplicationConfigurationDescription() const {
    return m_application_configuration_description;
}
void OAIApplicationDetail::setApplicationConfigurationDescription(const OAIApplicationDetail_ApplicationConfigurationDescription &application_configuration_description) {
...
bool OAIApplicationDetail::is_application_configuration_description_Set() const{
    return m_application_configuration_description_isSet;
}

bool OAIApplicationDetail::is_application_configuration_description_Valid() const{
...
OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription OAIApplicationDetail::getApplicationMaintenanceConfigurationDescription() const {
    return m_application_maintenance_configuration_description;
}
void OAIApplicationDetail::setApplicationMaintenanceConfigurationDescription(const OAIApplicationDetail_ApplicationMaintenanceConfigurationDescription &application_maintenance_configuration_description) {
...
bool OAIApplicationDetail::is_application_maintenance_configuration_description_Set() const{
    return m_application_maintenance_configuration_description_isSet;
}

bool OAIApplicationDetail::is_application_maintenance_configuration_description_Valid() const{
    return m_application_maintenance_configuration_description_isValid;
}

qint32 OAIApplicationDetail::getApplicationVersionUpdatedFrom() const {
    return m_application_version_updated_from;
}
void OAIApplicationDetail::setApplicationVersionUpdatedFrom(const qint32 &application_version_updated_from) {
    m_application_version_updated_from = application_version_updated_from;
    m_application_version_updated_from_isSet = true;
}

bool OAIApplicationDetail::is_application_version_updated_from_Set() const{
    return m_application_version_updated_from_isSet;
}

bool OAIApplicationDetail::is_application_version_updated_from_Valid() const{
    return m_application_version_updated_from_isValid;
}

qint32 OAIApplicationDetail::getApplicationVersionRolledBackFrom() const {
    return m_application_version_rolled_back_from;
}
void OAIApplicationDetail::setApplicationVersionRolledBackFrom(const qint32 &application_version_rolled_back_from) {
...
bool OAIApplicationDetail::is_application_version_rolled_back_from_Set() const{
    return m_application_version_rolled_back_from_isSet;
}

bool OAIApplicationDetail::is_application_version_rolled_back_from_Valid() const{
    return m_application_version_rolled_back_from_isValid;
}

QString OAIApplicationDetail::getConditionalToken() const {
    return m_conditional_token;
}
void OAIApplicationDetail::setConditionalToken(const QString &conditional_token) {
    m_conditional_token = conditional_token;
    m_conditional_token_isSet = true;
}

bool OAIApplicationDetail::is_conditional_token_Set() const{
    return m_conditional_token_isSet;
}

bool OAIApplicationDetail::is_conditional_token_Valid() const{
    return m_conditional_token_isValid;
}

qint32 OAIApplicationDetail::getApplicationVersionRolledBackTo() const {
    return m_application_version_rolled_back_to;
}
void OAIApplicationDetail::setApplicationVersionRolledBackTo(const qint32 &application_version_rolled_back_to) {
    m_application_version_rolled_back_to = application_version_rolled_back_to;
    m_application_version_rolled_back_to_isSet = true;
}

bool OAIApplicationDetail::is_application_version_rolled_back_to_Set() const{
    return m_application_version_rolled_back_to_isSet;
}

bool OAIApplicationDetail::is_application_version_rolled_back_to_Valid() const{
    return m_application_version_rolled_back_to_isValid;
}

OAIApplicationMode OAIApplicationDetail::getApplicationMode() const {
    return m_application_mode;
}
void OAIApplicationDetail::setApplicationMode(const OAIApplicationMode &application_mode) {
    m_application_mode = application_mode;
    m_application_mode_isSet = true;
}

bool OAIApplicationDetail::is_application_mode_Set() const{
    return m_application_mode_isSet;
}

bool OAIApplicationDetail::is_application_mode_Valid() const{
