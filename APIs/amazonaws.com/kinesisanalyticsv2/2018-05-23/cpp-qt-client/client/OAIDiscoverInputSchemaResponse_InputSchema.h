...
/*
 * OAIDiscoverInputSchemaResponse_InputSchema.h
 *
 * 
 */

#ifndef OAIDiscoverInputSchemaResponse_InputSchema_H
#define OAIDiscoverInputSchemaResponse_InputSchema_H
...
class OAIDiscoverInputSchemaResponse_InputSchema : public OAIObject {
public:
    OAIDiscoverInputSchemaResponse_InputSchema();
    OAIDiscoverInputSchemaResponse_InputSchema(QString json);
    ~OAIDiscoverInputSchemaResponse_InputSchema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscoverInputSchemaResponse_InputSchema)

#endif // OAIDiscoverInputSchemaResponse_InputSchema_H
