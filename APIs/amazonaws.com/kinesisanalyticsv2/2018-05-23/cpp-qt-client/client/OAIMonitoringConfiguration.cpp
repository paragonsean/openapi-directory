...
OAIConfigurationType OAIMonitoringConfiguration::getConfigurationType() const {
    return m_configuration_type;
}
void OAIMonitoringConfiguration::setConfigurationType(const OAIConfigurationType &configuration_type) {
    m_configuration_type = configuration_type;
    m_configuration_type_isSet = true;
}

bool OAIMonitoringConfiguration::is_configuration_type_Set() const{
    return m_configuration_type_isSet;
}

bool OAIMonitoringConfiguration::is_configuration_type_Valid() const{
    return m_configuration_type_isValid;
}

OAIMetricsLevel OAIMonitoringConfiguration::getMetricsLevel() const {
    return m_metrics_level;
}
void OAIMonitoringConfiguration::setMetricsLevel(const OAIMetricsLevel &metrics_level) {
    m_metrics_level = metrics_level;
    m_metrics_level_isSet = true;
}

bool OAIMonitoringConfiguration::is_metrics_level_Set() const{
    return m_metrics_level_isSet;
}

bool OAIMonitoringConfiguration::is_metrics_level_Valid() const{
    return m_metrics_level_isValid;
}

OAILogLevel OAIMonitoringConfiguration::getLogLevel() const {
    return m_log_level;
}
void OAIMonitoringConfiguration::setLogLevel(const OAILogLevel &log_level) {
    m_log_level = log_level;
    m_log_level_isSet = true;
}

bool OAIMonitoringConfiguration::is_log_level_Set() const{
    return m_log_level_isSet;
}

bool OAIMonitoringConfiguration::is_log_level_Valid() const{
