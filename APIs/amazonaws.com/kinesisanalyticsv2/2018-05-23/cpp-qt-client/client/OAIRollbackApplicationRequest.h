...
/*
 * OAIRollbackApplicationRequest.h
 *
 * 
 */

#ifndef OAIRollbackApplicationRequest_H
#define OAIRollbackApplicationRequest_H
...
class OAIRollbackApplicationRequest : public OAIObject {
public:
    OAIRollbackApplicationRequest();
    OAIRollbackApplicationRequest(QString json);
    ~OAIRollbackApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollbackApplicationRequest)

#endif // OAIRollbackApplicationRequest_H
