...
/*
 * OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate.h
 *
 * 
 */

#ifndef OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate_H
#define OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate_H
...
class OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate : public OAIObject {
public:
    OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate();
    OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate(QString json);
    ~OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate)

#endif // OAIFlinkApplicationConfigurationUpdate_CheckpointConfigurationUpdate_H
