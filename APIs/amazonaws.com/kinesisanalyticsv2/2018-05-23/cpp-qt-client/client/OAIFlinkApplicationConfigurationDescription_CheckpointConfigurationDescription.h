...
/*
 * OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription.h
 *
 * 
 */

#ifndef OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription_H
#define OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription_H
...
class OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription : public OAIObject {
public:
    OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription();
    OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription(QString json);
    ~OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription)

#endif // OAIFlinkApplicationConfigurationDescription_CheckpointConfigurationDescription_H
