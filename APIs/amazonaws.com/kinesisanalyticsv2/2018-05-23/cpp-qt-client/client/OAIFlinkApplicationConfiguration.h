...
/*
 * OAIFlinkApplicationConfiguration.h
 *
 * Describes configuration parameters for a Flink-based Kinesis Data Analytics application or a Studio notebook.
 */

#ifndef OAIFlinkApplicationConfiguration_H
#define OAIFlinkApplicationConfiguration_H
...
class OAIFlinkApplicationConfiguration : public OAIObject {
public:
    OAIFlinkApplicationConfiguration();
    OAIFlinkApplicationConfiguration(QString json);
    ~OAIFlinkApplicationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlinkApplicationConfiguration)

#endif // OAIFlinkApplicationConfiguration_H
