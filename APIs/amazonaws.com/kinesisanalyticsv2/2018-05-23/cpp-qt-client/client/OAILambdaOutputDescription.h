...
#ifndef OAILambdaOutputDescription_H
#define OAILambdaOutputDescription_H
...
class OAILambdaOutputDescription : public OAIObject {
public:
    OAILambdaOutputDescription();
    OAILambdaOutputDescription(QString json);
    ~OAILambdaOutputDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaOutputDescription)

#endif // OAILambdaOutputDescription_H
