...
#ifndef OAIKinesisFirehoseOutput_H
#define OAIKinesisFirehoseOutput_H
...
class OAIKinesisFirehoseOutput : public OAIObject {
public:
    OAIKinesisFirehoseOutput();
    OAIKinesisFirehoseOutput(QString json);
    ~OAIKinesisFirehoseOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisFirehoseOutput)

#endif // OAIKinesisFirehoseOutput_H
