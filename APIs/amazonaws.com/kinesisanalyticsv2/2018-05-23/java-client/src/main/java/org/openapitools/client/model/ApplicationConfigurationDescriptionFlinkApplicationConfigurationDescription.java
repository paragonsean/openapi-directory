...
public class ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription {
  ...
  public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription() {
  }

  public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription checkpointConfigurationDescription(FlinkApplicationConfigurationDescriptionCheckpointConfigurationDescription checkpointConfigurationDescription) {
  ...
  public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription monitoringConfigurationDescription(FlinkApplicationConfigurationDescriptionMonitoringConfigurationDescription monitoringConfigurationDescription) {
  ...
  public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription parallelismConfigurationDescription(FlinkApplicationConfigurationDescriptionParallelismConfigurationDescription parallelismConfigurationDescription) {
  ...
  public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription jobPlanDescription(String jobPlanDescription) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription applicationConfigurationDescriptionFlinkApplicationConfigurationDescription = (ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription) o;
    return Objects.equals(this.checkpointConfigurationDescription, applicationConfigurationDescriptionFlinkApplicationConfigurationDescription.checkpointConfigurationDescription) &&
        Objects.equals(this.monitoringConfigurationDescription, applicationConfigurationDescriptionFlinkApplicationConfigurationDescription.monitoringConfigurationDescription) &&
        Objects.equals(this.parallelismConfigurationDescription, applicationConfigurationDescriptionFlinkApplicationConfigurationDescription.parallelismConfigurationDescription) &&
        Objects.equals(this.jobPlanDescription, applicationConfigurationDescriptionFlinkApplicationConfigurationDescription.jobPlanDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription is not found in the empty JSON string", ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription>() {
           @Override
           public void write(JsonWriter out, ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription
   * @throws IOException if the JSON string is invalid with respect to ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription
   */
  public static ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription.class);
  }

  /**
   * Convert an instance of ApplicationConfigurationDescriptionFlinkApplicationConfigurationDescription to an JSON string
   *
   * @return JSON string
   */
