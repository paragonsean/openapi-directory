...
public class FlinkApplicationConfiguration {
  ...
  public FlinkApplicationConfiguration checkpointConfiguration(FlinkApplicationConfigurationCheckpointConfiguration checkpointConfiguration) {
  ...
  public FlinkApplicationConfiguration monitoringConfiguration(FlinkApplicationConfigurationMonitoringConfiguration monitoringConfiguration) {
  ...
  public FlinkApplicationConfiguration parallelismConfiguration(FlinkApplicationConfigurationParallelismConfiguration parallelismConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    FlinkApplicationConfiguration flinkApplicationConfiguration = (FlinkApplicationConfiguration) o;
    return Objects.equals(this.checkpointConfiguration, flinkApplicationConfiguration.checkpointConfiguration) &&
        Objects.equals(this.monitoringConfiguration, flinkApplicationConfiguration.monitoringConfiguration) &&
        Objects.equals(this.parallelismConfiguration, flinkApplicationConfiguration.parallelismConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class FlinkApplicationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlinkApplicationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlinkApplicationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlinkApplicationConfiguration is not found in the empty JSON string", FlinkApplicationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlinkApplicationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlinkApplicationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlinkApplicationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlinkApplicationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlinkApplicationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlinkApplicationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<FlinkApplicationConfiguration>() {
           @Override
           public void write(JsonWriter out, FlinkApplicationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FlinkApplicationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FlinkApplicationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlinkApplicationConfiguration
   * @throws IOException if the JSON string is invalid with respect to FlinkApplicationConfiguration
   */
  public static FlinkApplicationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlinkApplicationConfiguration.class);
  }

  /**
   * Convert an instance of FlinkApplicationConfiguration to an JSON string
   *
   * @return JSON string
   */
