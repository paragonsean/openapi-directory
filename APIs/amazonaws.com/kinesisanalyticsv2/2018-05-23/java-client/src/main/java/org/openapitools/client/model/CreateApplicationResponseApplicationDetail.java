...
public class CreateApplicationResponseApplicationDetail {
  ...
  public CreateApplicationResponseApplicationDetail() {
  }

  public CreateApplicationResponseApplicationDetail applicationARN(String applicationARN) {
  ...
  public CreateApplicationResponseApplicationDetail applicationDescription(String applicationDescription) {
  ...
  public CreateApplicationResponseApplicationDetail applicationName(String applicationName) {
  ...
  public CreateApplicationResponseApplicationDetail runtimeEnvironment(RuntimeEnvironment runtimeEnvironment) {
  ...
  public CreateApplicationResponseApplicationDetail serviceExecutionRole(String serviceExecutionRole) {
  ...
  public CreateApplicationResponseApplicationDetail applicationStatus(ApplicationStatus applicationStatus) {
  ...
  public CreateApplicationResponseApplicationDetail applicationVersionId(Integer applicationVersionId) {
  ...
  public CreateApplicationResponseApplicationDetail createTimestamp(OffsetDateTime createTimestamp) {
  ...
  public CreateApplicationResponseApplicationDetail lastUpdateTimestamp(OffsetDateTime lastUpdateTimestamp) {
  ...
  public CreateApplicationResponseApplicationDetail applicationConfigurationDescription(ApplicationDetailApplicationConfigurationDescription applicationConfigurationDescription) {
  ...
  public CreateApplicationResponseApplicationDetail cloudWatchLoggingOptionDescriptions(List cloudWatchLoggingOptionDescriptions) {
  ...
  public CreateApplicationResponseApplicationDetail applicationMaintenanceConfigurationDescription(ApplicationDetailApplicationMaintenanceConfigurationDescription applicationMaintenanceConfigurationDescription) {
  ...
  public CreateApplicationResponseApplicationDetail applicationVersionUpdatedFrom(Integer applicationVersionUpdatedFrom) {
  ...
  public CreateApplicationResponseApplicationDetail applicationVersionRolledBackFrom(Integer applicationVersionRolledBackFrom) {
  ...
  public CreateApplicationResponseApplicationDetail conditionalToken(String conditionalToken) {
  ...
  public CreateApplicationResponseApplicationDetail applicationVersionRolledBackTo(Integer applicationVersionRolledBackTo) {
  ...
  public CreateApplicationResponseApplicationDetail applicationMode(ApplicationMode applicationMode) {
  ...
  public boolean equals(Object o) {
    ...
    CreateApplicationResponseApplicationDetail createApplicationResponseApplicationDetail = (CreateApplicationResponseApplicationDetail) o;
    return Objects.equals(this.applicationARN, createApplicationResponseApplicationDetail.applicationARN) &&
        Objects.equals(this.applicationDescription, createApplicationResponseApplicationDetail.applicationDescription) &&
        Objects.equals(this.applicationName, createApplicationResponseApplicationDetail.applicationName) &&
        Objects.equals(this.runtimeEnvironment, createApplicationResponseApplicationDetail.runtimeEnvironment) &&
        Objects.equals(this.serviceExecutionRole, createApplicationResponseApplicationDetail.serviceExecutionRole) &&
        Objects.equals(this.applicationStatus, createApplicationResponseApplicationDetail.applicationStatus) &&
        Objects.equals(this.applicationVersionId, createApplicationResponseApplicationDetail.applicationVersionId) &&
        Objects.equals(this.createTimestamp, createApplicationResponseApplicationDetail.createTimestamp) &&
        Objects.equals(this.lastUpdateTimestamp, createApplicationResponseApplicationDetail.lastUpdateTimestamp) &&
        Objects.equals(this.applicationConfigurationDescription, createApplicationResponseApplicationDetail.applicationConfigurationDescription) &&
        Objects.equals(this.cloudWatchLoggingOptionDescriptions, createApplicationResponseApplicationDetail.cloudWatchLoggingOptionDescriptions) &&
        Objects.equals(this.applicationMaintenanceConfigurationDescription, createApplicationResponseApplicationDetail.applicationMaintenanceConfigurationDescription) &&
        Objects.equals(this.applicationVersionUpdatedFrom, createApplicationResponseApplicationDetail.applicationVersionUpdatedFrom) &&
        Objects.equals(this.applicationVersionRolledBackFrom, createApplicationResponseApplicationDetail.applicationVersionRolledBackFrom) &&
        Objects.equals(this.conditionalToken, createApplicationResponseApplicationDetail.conditionalToken) &&
        Objects.equals(this.applicationVersionRolledBackTo, createApplicationResponseApplicationDetail.applicationVersionRolledBackTo) &&
        Objects.equals(this.applicationMode, createApplicationResponseApplicationDetail.applicationMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateApplicationResponseApplicationDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApplicationResponseApplicationDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApplicationResponseApplicationDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApplicationResponseApplicationDetail is not found in the empty JSON string", CreateApplicationResponseApplicationDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApplicationResponseApplicationDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApplicationResponseApplicationDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateApplicationResponseApplicationDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApplicationResponseApplicationDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApplicationResponseApplicationDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApplicationResponseApplicationDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApplicationResponseApplicationDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApplicationResponseApplicationDetail>() {
           @Override
           public void write(JsonWriter out, CreateApplicationResponseApplicationDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApplicationResponseApplicationDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApplicationResponseApplicationDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApplicationResponseApplicationDetail
   * @throws IOException if the JSON string is invalid with respect to CreateApplicationResponseApplicationDetail
   */
  public static CreateApplicationResponseApplicationDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApplicationResponseApplicationDetail.class);
  }

  /**
   * Convert an instance of CreateApplicationResponseApplicationDetail to an JSON string
   *
   * @return JSON string
   */
