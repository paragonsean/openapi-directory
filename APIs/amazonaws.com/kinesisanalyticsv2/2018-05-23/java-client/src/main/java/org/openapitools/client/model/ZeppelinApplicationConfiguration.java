...
public class ZeppelinApplicationConfiguration {
  ...
  public ZeppelinApplicationConfiguration monitoringConfiguration(ZeppelinApplicationConfigurationMonitoringConfiguration monitoringConfiguration) {
  ...
  public ZeppelinApplicationConfiguration catalogConfiguration(ZeppelinApplicationConfigurationCatalogConfiguration catalogConfiguration) {
  ...
  public ZeppelinApplicationConfiguration deployAsApplicationConfiguration(ZeppelinApplicationConfigurationDeployAsApplicationConfiguration deployAsApplicationConfiguration) {
  ...
  public ZeppelinApplicationConfiguration customArtifactsConfiguration(List customArtifactsConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    ZeppelinApplicationConfiguration zeppelinApplicationConfiguration = (ZeppelinApplicationConfiguration) o;
    return Objects.equals(this.monitoringConfiguration, zeppelinApplicationConfiguration.monitoringConfiguration) &&
        Objects.equals(this.catalogConfiguration, zeppelinApplicationConfiguration.catalogConfiguration) &&
        Objects.equals(this.deployAsApplicationConfiguration, zeppelinApplicationConfiguration.deployAsApplicationConfiguration) &&
        Objects.equals(this.customArtifactsConfiguration, zeppelinApplicationConfiguration.customArtifactsConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZeppelinApplicationConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ZeppelinApplicationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZeppelinApplicationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZeppelinApplicationConfiguration is not found in the empty JSON string", ZeppelinApplicationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZeppelinApplicationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZeppelinApplicationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZeppelinApplicationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZeppelinApplicationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZeppelinApplicationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZeppelinApplicationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ZeppelinApplicationConfiguration>() {
           @Override
           public void write(JsonWriter out, ZeppelinApplicationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZeppelinApplicationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ZeppelinApplicationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ZeppelinApplicationConfiguration
   * @throws IOException if the JSON string is invalid with respect to ZeppelinApplicationConfiguration
   */
  public static ZeppelinApplicationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZeppelinApplicationConfiguration.class);
  }

  /**
   * Convert an instance of ZeppelinApplicationConfiguration to an JSON string
   *
   * @return JSON string
   */
