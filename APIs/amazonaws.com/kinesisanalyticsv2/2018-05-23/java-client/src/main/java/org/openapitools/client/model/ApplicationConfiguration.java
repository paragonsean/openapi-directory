...
public class ApplicationConfiguration {
  ...
  public ApplicationConfiguration sqlApplicationConfiguration(ApplicationConfigurationSqlApplicationConfiguration sqlApplicationConfiguration) {
  ...
  public ApplicationConfiguration flinkApplicationConfiguration(ApplicationConfigurationFlinkApplicationConfiguration flinkApplicationConfiguration) {
  ...
  public ApplicationConfiguration environmentProperties(ApplicationConfigurationEnvironmentProperties environmentProperties) {
  ...
  public ApplicationConfiguration applicationCodeConfiguration(ApplicationConfigurationApplicationCodeConfiguration applicationCodeConfiguration) {
  ...
  public ApplicationConfiguration applicationSnapshotConfiguration(ApplicationConfigurationApplicationSnapshotConfiguration applicationSnapshotConfiguration) {
  ...
  public ApplicationConfiguration vpcConfigurations(List vpcConfigurations) {
  ...
  public ApplicationConfiguration zeppelinApplicationConfiguration(ApplicationConfigurationZeppelinApplicationConfiguration zeppelinApplicationConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sqlApplicationConfiguration, applicationConfiguration.sqlApplicationConfiguration) &&
        Objects.equals(this.flinkApplicationConfiguration, applicationConfiguration.flinkApplicationConfiguration) &&
        Objects.equals(this.environmentProperties, applicationConfiguration.environmentProperties) &&
        Objects.equals(this.applicationCodeConfiguration, applicationConfiguration.applicationCodeConfiguration) &&
        Objects.equals(this.applicationSnapshotConfiguration, applicationConfiguration.applicationSnapshotConfiguration) &&
        Objects.equals(this.vpcConfigurations, applicationConfiguration.vpcConfigurations) &&
        Objects.equals(this.zeppelinApplicationConfiguration, applicationConfiguration.zeppelinApplicationConfiguration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationConfiguration is not found in the empty JSON string", ApplicationConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationConfiguration>() {
           @Override
           public void write(JsonWriter out, ApplicationConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationConfiguration
   * @throws IOException if the JSON string is invalid with respect to ApplicationConfiguration
   */
  public static ApplicationConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationConfiguration.class);
  }

  /**
   * Convert an instance of ApplicationConfiguration to an JSON string
   *
   * @return JSON string
   */
