...
public class UpdateApplicationResponseApplicationDetail {
  ...
  public UpdateApplicationResponseApplicationDetail() {
  }

  public UpdateApplicationResponseApplicationDetail applicationARN(String applicationARN) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationDescription(String applicationDescription) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationName(String applicationName) {
  ...
  public UpdateApplicationResponseApplicationDetail runtimeEnvironment(RuntimeEnvironment runtimeEnvironment) {
  ...
  public UpdateApplicationResponseApplicationDetail serviceExecutionRole(String serviceExecutionRole) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationStatus(ApplicationStatus applicationStatus) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationVersionId(Integer applicationVersionId) {
  ...
  public UpdateApplicationResponseApplicationDetail createTimestamp(OffsetDateTime createTimestamp) {
  ...
  public UpdateApplicationResponseApplicationDetail lastUpdateTimestamp(OffsetDateTime lastUpdateTimestamp) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationConfigurationDescription(ApplicationDetailApplicationConfigurationDescription applicationConfigurationDescription) {
  ...
  public UpdateApplicationResponseApplicationDetail cloudWatchLoggingOptionDescriptions(List cloudWatchLoggingOptionDescriptions) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationMaintenanceConfigurationDescription(ApplicationDetailApplicationMaintenanceConfigurationDescription applicationMaintenanceConfigurationDescription) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationVersionUpdatedFrom(Integer applicationVersionUpdatedFrom) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationVersionRolledBackFrom(Integer applicationVersionRolledBackFrom) {
  ...
  public UpdateApplicationResponseApplicationDetail conditionalToken(String conditionalToken) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationVersionRolledBackTo(Integer applicationVersionRolledBackTo) {
  ...
  public UpdateApplicationResponseApplicationDetail applicationMode(ApplicationMode applicationMode) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApplicationResponseApplicationDetail updateApplicationResponseApplicationDetail = (UpdateApplicationResponseApplicationDetail) o;
    return Objects.equals(this.applicationARN, updateApplicationResponseApplicationDetail.applicationARN) &&
        Objects.equals(this.applicationDescription, updateApplicationResponseApplicationDetail.applicationDescription) &&
        Objects.equals(this.applicationName, updateApplicationResponseApplicationDetail.applicationName) &&
        Objects.equals(this.runtimeEnvironment, updateApplicationResponseApplicationDetail.runtimeEnvironment) &&
        Objects.equals(this.serviceExecutionRole, updateApplicationResponseApplicationDetail.serviceExecutionRole) &&
        Objects.equals(this.applicationStatus, updateApplicationResponseApplicationDetail.applicationStatus) &&
        Objects.equals(this.applicationVersionId, updateApplicationResponseApplicationDetail.applicationVersionId) &&
        Objects.equals(this.createTimestamp, updateApplicationResponseApplicationDetail.createTimestamp) &&
        Objects.equals(this.lastUpdateTimestamp, updateApplicationResponseApplicationDetail.lastUpdateTimestamp) &&
        Objects.equals(this.applicationConfigurationDescription, updateApplicationResponseApplicationDetail.applicationConfigurationDescription) &&
        Objects.equals(this.cloudWatchLoggingOptionDescriptions, updateApplicationResponseApplicationDetail.cloudWatchLoggingOptionDescriptions) &&
        Objects.equals(this.applicationMaintenanceConfigurationDescription, updateApplicationResponseApplicationDetail.applicationMaintenanceConfigurationDescription) &&
        Objects.equals(this.applicationVersionUpdatedFrom, updateApplicationResponseApplicationDetail.applicationVersionUpdatedFrom) &&
        Objects.equals(this.applicationVersionRolledBackFrom, updateApplicationResponseApplicationDetail.applicationVersionRolledBackFrom) &&
        Objects.equals(this.conditionalToken, updateApplicationResponseApplicationDetail.conditionalToken) &&
        Objects.equals(this.applicationVersionRolledBackTo, updateApplicationResponseApplicationDetail.applicationVersionRolledBackTo) &&
        Objects.equals(this.applicationMode, updateApplicationResponseApplicationDetail.applicationMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateApplicationResponseApplicationDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApplicationResponseApplicationDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApplicationResponseApplicationDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApplicationResponseApplicationDetail is not found in the empty JSON string", UpdateApplicationResponseApplicationDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApplicationResponseApplicationDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApplicationResponseApplicationDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateApplicationResponseApplicationDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApplicationResponseApplicationDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApplicationResponseApplicationDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApplicationResponseApplicationDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApplicationResponseApplicationDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApplicationResponseApplicationDetail>() {
           @Override
           public void write(JsonWriter out, UpdateApplicationResponseApplicationDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApplicationResponseApplicationDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApplicationResponseApplicationDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApplicationResponseApplicationDetail
   * @throws IOException if the JSON string is invalid with respect to UpdateApplicationResponseApplicationDetail
   */
  public static UpdateApplicationResponseApplicationDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApplicationResponseApplicationDetail.class);
  }

  /**
   * Convert an instance of UpdateApplicationResponseApplicationDetail to an JSON string
   *
   * @return JSON string
   */
