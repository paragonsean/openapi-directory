...
public class ZeppelinApplicationConfigurationUpdate {
  ...
  public ZeppelinApplicationConfigurationUpdate monitoringConfigurationUpdate(ZeppelinApplicationConfigurationUpdateMonitoringConfigurationUpdate monitoringConfigurationUpdate) {
  ...
  public ZeppelinApplicationConfigurationUpdate catalogConfigurationUpdate(ZeppelinApplicationConfigurationUpdateCatalogConfigurationUpdate catalogConfigurationUpdate) {
  ...
  public ZeppelinApplicationConfigurationUpdate deployAsApplicationConfigurationUpdate(DeployAsApplicationConfigurationUpdate deployAsApplicationConfigurationUpdate) {
  ...
  public ZeppelinApplicationConfigurationUpdate customArtifactsConfigurationUpdate(List customArtifactsConfigurationUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    ZeppelinApplicationConfigurationUpdate zeppelinApplicationConfigurationUpdate = (ZeppelinApplicationConfigurationUpdate) o;
    return Objects.equals(this.monitoringConfigurationUpdate, zeppelinApplicationConfigurationUpdate.monitoringConfigurationUpdate) &&
        Objects.equals(this.catalogConfigurationUpdate, zeppelinApplicationConfigurationUpdate.catalogConfigurationUpdate) &&
        Objects.equals(this.deployAsApplicationConfigurationUpdate, zeppelinApplicationConfigurationUpdate.deployAsApplicationConfigurationUpdate) &&
        Objects.equals(this.customArtifactsConfigurationUpdate, zeppelinApplicationConfigurationUpdate.customArtifactsConfigurationUpdate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZeppelinApplicationConfigurationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ZeppelinApplicationConfigurationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZeppelinApplicationConfigurationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZeppelinApplicationConfigurationUpdate is not found in the empty JSON string", ZeppelinApplicationConfigurationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZeppelinApplicationConfigurationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZeppelinApplicationConfigurationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZeppelinApplicationConfigurationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZeppelinApplicationConfigurationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZeppelinApplicationConfigurationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZeppelinApplicationConfigurationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ZeppelinApplicationConfigurationUpdate>() {
           @Override
           public void write(JsonWriter out, ZeppelinApplicationConfigurationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZeppelinApplicationConfigurationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ZeppelinApplicationConfigurationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ZeppelinApplicationConfigurationUpdate
   * @throws IOException if the JSON string is invalid with respect to ZeppelinApplicationConfigurationUpdate
   */
  public static ZeppelinApplicationConfigurationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZeppelinApplicationConfigurationUpdate.class);
  }

  /**
   * Convert an instance of ZeppelinApplicationConfigurationUpdate to an JSON string
   *
   * @return JSON string
   */
