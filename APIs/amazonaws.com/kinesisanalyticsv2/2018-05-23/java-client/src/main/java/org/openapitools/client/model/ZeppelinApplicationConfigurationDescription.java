...
public class ZeppelinApplicationConfigurationDescription {
  ...
  public ZeppelinApplicationConfigurationDescription monitoringConfigurationDescription(ZeppelinApplicationConfigurationDescriptionMonitoringConfigurationDescription monitoringConfigurationDescription) {
  ...
  public ZeppelinApplicationConfigurationDescription catalogConfigurationDescription(ZeppelinApplicationConfigurationDescriptionCatalogConfigurationDescription catalogConfigurationDescription) {
  ...
  public ZeppelinApplicationConfigurationDescription deployAsApplicationConfigurationDescription(ZeppelinApplicationConfigurationDescriptionDeployAsApplicationConfigurationDescription deployAsApplicationConfigurationDescription) {
  ...
  public ZeppelinApplicationConfigurationDescription customArtifactsConfigurationDescription(List customArtifactsConfigurationDescription) {
  ...
  public boolean equals(Object o) {
    ...
    ZeppelinApplicationConfigurationDescription zeppelinApplicationConfigurationDescription = (ZeppelinApplicationConfigurationDescription) o;
    return Objects.equals(this.monitoringConfigurationDescription, zeppelinApplicationConfigurationDescription.monitoringConfigurationDescription) &&
        Objects.equals(this.catalogConfigurationDescription, zeppelinApplicationConfigurationDescription.catalogConfigurationDescription) &&
        Objects.equals(this.deployAsApplicationConfigurationDescription, zeppelinApplicationConfigurationDescription.deployAsApplicationConfigurationDescription) &&
        Objects.equals(this.customArtifactsConfigurationDescription, zeppelinApplicationConfigurationDescription.customArtifactsConfigurationDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZeppelinApplicationConfigurationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ZeppelinApplicationConfigurationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZeppelinApplicationConfigurationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZeppelinApplicationConfigurationDescription is not found in the empty JSON string", ZeppelinApplicationConfigurationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZeppelinApplicationConfigurationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZeppelinApplicationConfigurationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ZeppelinApplicationConfigurationDescription.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZeppelinApplicationConfigurationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZeppelinApplicationConfigurationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZeppelinApplicationConfigurationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZeppelinApplicationConfigurationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<ZeppelinApplicationConfigurationDescription>() {
           @Override
           public void write(JsonWriter out, ZeppelinApplicationConfigurationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZeppelinApplicationConfigurationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ZeppelinApplicationConfigurationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ZeppelinApplicationConfigurationDescription
   * @throws IOException if the JSON string is invalid with respect to ZeppelinApplicationConfigurationDescription
   */
  public static ZeppelinApplicationConfigurationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZeppelinApplicationConfigurationDescription.class);
  }

  /**
   * Convert an instance of ZeppelinApplicationConfigurationDescription to an JSON string
   *
   * @return JSON string
   */
