...
public class CodeContentUpdate {
  ...
  public CodeContentUpdate textContentUpdate(String textContentUpdate) {
  ...
  public CodeContentUpdate zipFileContentUpdate(String zipFileContentUpdate) {
  ...
  public CodeContentUpdate s3ContentLocationUpdate(CodeContentUpdateS3ContentLocationUpdate s3ContentLocationUpdate) {
  ...
  public boolean equals(Object o) {
    ...
    CodeContentUpdate codeContentUpdate = (CodeContentUpdate) o;
    return Objects.equals(this.textContentUpdate, codeContentUpdate.textContentUpdate) &&
        Objects.equals(this.zipFileContentUpdate, codeContentUpdate.zipFileContentUpdate) &&
        Objects.equals(this.s3ContentLocationUpdate, codeContentUpdate.s3ContentLocationUpdate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CodeContentUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeContentUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeContentUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeContentUpdate is not found in the empty JSON string", CodeContentUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeContentUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeContentUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeContentUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeContentUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CodeContentUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CodeContentUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<CodeContentUpdate>() {
           @Override
           public void write(JsonWriter out, CodeContentUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CodeContentUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CodeContentUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CodeContentUpdate
   * @throws IOException if the JSON string is invalid with respect to CodeContentUpdate
   */
  public static CodeContentUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CodeContentUpdate.class);
  }

  /**
   * Convert an instance of CodeContentUpdate to an JSON string
   *
   * @return JSON string
   */
