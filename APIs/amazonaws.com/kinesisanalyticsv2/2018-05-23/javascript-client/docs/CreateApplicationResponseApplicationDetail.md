# AmazonKinesisAnalytics.CreateApplicationResponseApplicationDetail
...
**serviceExecutionRole** | **String** |  | [optional] 
**applicationStatus** | [**ApplicationStatus**](ApplicationStatus.md) |  | 
**applicationVersionId** | **Number** |  | 
**createTimestamp** | **Date** |  | [optional] 
**lastUpdateTimestamp** | **Date** |  | [optional] 
...
**cloudWatchLoggingOptionDescriptions** | **Array** |  | [optional] 
...
**applicationVersionUpdatedFrom** | **Number** |  | [optional] 
**applicationVersionRolledBackFrom** | **Number** |  | [optional] 
**conditionalToken** | **String** |  | [optional] 
**applicationVersionRolledBackTo** | **Number** |  | [optional] 
