...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.DeleteApplicationRequest();
  });
  ...
  describe('DeleteApplicationRequest', function() {
    it('should create an instance of DeleteApplicationRequest', function() {
      // uncomment below and update the code to test DeleteApplicationRequest
      //var instance = new AmazonKinesisAnalytics.DeleteApplicationRequest();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.DeleteApplicationRequest);
    });
