...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.UpdateApplicationRequestApplicationConfigurationUpdate();
  });
  ...
  describe('UpdateApplicationRequestApplicationConfigurationUpdate', function() {
    it('should create an instance of UpdateApplicationRequestApplicationConfigurationUpdate', function() {
      // uncomment below and update the code to test UpdateApplicationRequestApplicationConfigurationUpdate
      //var instance = new AmazonKinesisAnalytics.UpdateApplicationRequestApplicationConfigurationUpdate();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.UpdateApplicationRequestApplicationConfigurationUpdate);
    });
