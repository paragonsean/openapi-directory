...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonKinesisAnalytics.SqlRunConfiguration();
  });
  ...
  describe('SqlRunConfiguration', function() {
    it('should create an instance of SqlRunConfiguration', function() {
      // uncomment below and update the code to test SqlRunConfiguration
      //var instance = new AmazonKinesisAnalytics.SqlRunConfiguration();
      //expect(instance).to.be.a(AmazonKinesisAnalytics.SqlRunConfiguration);
    });
