...
class DescribeApplicationRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('IncludeAdditionalDetails')) {
                obj['IncludeAdditionalDetails'] = ApiClient.convertToType(data['IncludeAdditionalDetails'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['IncludeAdditionalDetails']) { // data not null
          Boolean.validateJSON(data['IncludeAdditionalDetails']);
        }
...
/**
 * @member {Boolean} IncludeAdditionalDetails
 */
DescribeApplicationRequest.prototype['IncludeAdditionalDetails'] = undefined;
