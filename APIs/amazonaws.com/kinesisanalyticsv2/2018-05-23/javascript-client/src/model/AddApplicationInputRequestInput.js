...
/**
 * The AddApplicationInputRequestInput model module.
 * @module model/AddApplicationInputRequestInput
 * @version 2018-05-23
 */
class AddApplicationInputRequestInput {
    /**
     * Constructs a new <code>AddApplicationInputRequestInput</code>.
     * @alias module:model/AddApplicationInputRequestInput
    ...
    constructor(namePrefix, inputSchema) { 
        ...
        AddApplicationInputRequestInput.initialize(this, namePrefix, inputSchema);
    }
    ...
    /**
     * Constructs a <code>AddApplicationInputRequestInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddApplicationInputRequestInput} obj Optional instance to populate.
     * @return {module:model/AddApplicationInputRequestInput} The populated <code>AddApplicationInputRequestInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddApplicationInputRequestInput();
    ...
    /**
     * Validates the JSON data with respect to <code>AddApplicationInputRequestInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddApplicationInputRequestInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddApplicationInputRequestInput.RequiredProperties) {
...
AddApplicationInputRequestInput.RequiredProperties = ["NamePrefix", "InputSchema"];

/**
 * @member {String} NamePrefix
 */
AddApplicationInputRequestInput.prototype['NamePrefix'] = undefined;

/**
 * @member {module:model/InputInputProcessingConfiguration} InputProcessingConfiguration
 */
AddApplicationInputRequestInput.prototype['InputProcessingConfiguration'] = undefined;

/**
 * @member {module:model/InputKinesisStreamsInput} KinesisStreamsInput
 */
AddApplicationInputRequestInput.prototype['KinesisStreamsInput'] = undefined;

/**
 * @member {module:model/InputKinesisFirehoseInput} KinesisFirehoseInput
 */
AddApplicationInputRequestInput.prototype['KinesisFirehoseInput'] = undefined;

/**
 * @member {module:model/InputInputParallelism} InputParallelism
 */
AddApplicationInputRequestInput.prototype['InputParallelism'] = undefined;

/**
 * @member {module:model/InputInputSchema} InputSchema
 */
AddApplicationInputRequestInput.prototype['InputSchema'] = undefined;
...
export default AddApplicationInputRequestInput;
