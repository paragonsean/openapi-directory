...
/*
 * OAICreateDeliverabilityTestReport_request_Content_Template.h
 *
 * 
 */

#ifndef OAICreateDeliverabilityTestReport_request_Content_Template_H
#define OAICreateDeliverabilityTestReport_request_Content_Template_H
...
class OAICreateDeliverabilityTestReport_request_Content_Template : public OAIObject {
public:
    OAICreateDeliverabilityTestReport_request_Content_Template();
    OAICreateDeliverabilityTestReport_request_Content_Template(QString json);
    ~OAICreateDeliverabilityTestReport_request_Content_Template() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDeliverabilityTestReport_request_Content_Template)

#endif // OAICreateDeliverabilityTestReport_request_Content_Template_H
