...
#ifndef OAIDedicatedIp_H
#define OAIDedicatedIp_H
...
class OAIDedicatedIp : public OAIObject {
public:
    OAIDedicatedIp();
    OAIDedicatedIp(QString json);
    ~OAIDedicatedIp() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDedicatedIp)

#endif // OAIDedicatedIp_H
