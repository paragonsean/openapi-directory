...
OAIGetConfigurationSetResponse_TrackingOptions OAICreateConfigurationSetRequest::getTrackingOptions() const {
    return m_tracking_options;
}
void OAICreateConfigurationSetRequest::setTrackingOptions(const OAIGetConfigurationSetResponse_TrackingOptions &tracking_options) {
    m_tracking_options = tracking_options;
    m_tracking_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_tracking_options_Set() const{
    return m_tracking_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_tracking_options_Valid() const{
    return m_tracking_options_isValid;
}

OAIGetConfigurationSetResponse_DeliveryOptions OAICreateConfigurationSetRequest::getDeliveryOptions() const {
    return m_delivery_options;
}
void OAICreateConfigurationSetRequest::setDeliveryOptions(const OAIGetConfigurationSetResponse_DeliveryOptions &delivery_options) {
    m_delivery_options = delivery_options;
    m_delivery_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_delivery_options_Set() const{
    return m_delivery_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_delivery_options_Valid() const{
    return m_delivery_options_isValid;
}

OAIGetConfigurationSetResponse_ReputationOptions OAICreateConfigurationSetRequest::getReputationOptions() const {
    return m_reputation_options;
}
void OAICreateConfigurationSetRequest::setReputationOptions(const OAIGetConfigurationSetResponse_ReputationOptions &reputation_options) {
    m_reputation_options = reputation_options;
    m_reputation_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_reputation_options_Set() const{
    return m_reputation_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_reputation_options_Valid() const{
    return m_reputation_options_isValid;
}

OAIGetConfigurationSetResponse_SendingOptions OAICreateConfigurationSetRequest::getSendingOptions() const {
    return m_sending_options;
}
void OAICreateConfigurationSetRequest::setSendingOptions(const OAIGetConfigurationSetResponse_SendingOptions &sending_options) {
    m_sending_options = sending_options;
    m_sending_options_isSet = true;
}

bool OAICreateConfigurationSetRequest::is_sending_options_Set() const{
    return m_sending_options_isSet;
}

bool OAICreateConfigurationSetRequest::is_sending_options_Valid() const{
