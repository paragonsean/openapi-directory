...
OAIPutAccountSendingAttributes_request::OAIPutAccountSendingAttributes_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutAccountSendingAttributes_request::OAIPutAccountSendingAttributes_request() {
    this->initializeModel();
}

OAIPutAccountSendingAttributes_request::~OAIPutAccountSendingAttributes_request() {}

void OAIPutAccountSendingAttributes_request::initializeModel() {

    m_sending_enabled_isSet = false;
    m_sending_enabled_isValid = false;
}

void OAIPutAccountSendingAttributes_request::fromJson(QString jsonString) {
...
void OAIPutAccountSendingAttributes_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutAccountSendingAttributes_request::asJson() const {
...
QJsonObject OAIPutAccountSendingAttributes_request::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPutAccountSendingAttributes_request::isSendingEnabled() const {
    return m_sending_enabled;
}
void OAIPutAccountSendingAttributes_request::setSendingEnabled(const bool &sending_enabled) {
    m_sending_enabled = sending_enabled;
    m_sending_enabled_isSet = true;
}

bool OAIPutAccountSendingAttributes_request::is_sending_enabled_Set() const{
    return m_sending_enabled_isSet;
}

bool OAIPutAccountSendingAttributes_request::is_sending_enabled_Valid() const{
    return m_sending_enabled_isValid;
}

bool OAIPutAccountSendingAttributes_request::isSet() const {
...
bool OAIPutAccountSendingAttributes_request::isValid() const {
