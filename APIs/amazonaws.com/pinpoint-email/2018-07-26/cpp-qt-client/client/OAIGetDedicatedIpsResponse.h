...
/*
 * OAIGetDedicatedIpsResponse.h
 *
 * Information about the dedicated IP addresses that are associated with your Amazon Pinpoint account.
 */

#ifndef OAIGetDedicatedIpsResponse_H
#define OAIGetDedicatedIpsResponse_H
...
class OAIGetDedicatedIpsResponse : public OAIObject {
public:
    OAIGetDedicatedIpsResponse();
    OAIGetDedicatedIpsResponse(QString json);
    ~OAIGetDedicatedIpsResponse() override;
    ...
    QList getDedicatedIps() const;
    void setDedicatedIps(const QList &dedicated_ips);
    bool is_dedicated_ips_Set() const;
    bool is_dedicated_ips_Valid() const;
...
private:
    ...
    QList m_dedicated_ips;
    bool m_dedicated_ips_isSet;
    bool m_dedicated_ips_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDedicatedIpsResponse)

#endif // OAIGetDedicatedIpsResponse_H
