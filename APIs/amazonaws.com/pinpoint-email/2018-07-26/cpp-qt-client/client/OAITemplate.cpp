...
QString OAITemplate::getTemplateArn() const {
    return m_template_arn;
}
void OAITemplate::setTemplateArn(const QString &template_arn) {
    m_template_arn = template_arn;
    m_template_arn_isSet = true;
}

bool OAITemplate::is_template_arn_Set() const{
    return m_template_arn_isSet;
}

bool OAITemplate::is_template_arn_Valid() const{
    return m_template_arn_isValid;
}

QString OAITemplate::getTemplateData() const {
    return m_template_data;
}
void OAITemplate::setTemplateData(const QString &template_data) {
    m_template_data = template_data;
    m_template_data_isSet = true;
}

bool OAITemplate::is_template_data_Set() const{
    return m_template_data_isSet;
}

bool OAITemplate::is_template_data_Valid() const{
