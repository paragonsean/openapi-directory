...
/*
 * OAICreateEmailIdentity_request.h
 *
 * 
 */

#ifndef OAICreateEmailIdentity_request_H
#define OAICreateEmailIdentity_request_H
...
class OAICreateEmailIdentity_request : public OAIObject {
public:
    OAICreateEmailIdentity_request();
    OAICreateEmailIdentity_request(QString json);
    ~OAICreateEmailIdentity_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEmailIdentity_request)

#endif // OAICreateEmailIdentity_request_H
