...
/*
 * OAIDeliverabilityTestReport.h
 *
 * An object that contains metadata related to a predictive inbox placement test.
 */

#ifndef OAIDeliverabilityTestReport_H
#define OAIDeliverabilityTestReport_H
...
class OAIDeliverabilityTestReport : public OAIObject {
public:
    OAIDeliverabilityTestReport();
    OAIDeliverabilityTestReport(QString json);
    ~OAIDeliverabilityTestReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliverabilityTestReport)

#endif // OAIDeliverabilityTestReport_H
