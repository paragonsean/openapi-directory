...
/*
 * OAIListEmailIdentitiesResponse.h
 *
...
#ifndef OAIListEmailIdentitiesResponse_H
#define OAIListEmailIdentitiesResponse_H
...
class OAIListEmailIdentitiesResponse : public OAIObject {
public:
    OAIListEmailIdentitiesResponse();
    OAIListEmailIdentitiesResponse(QString json);
    ~OAIListEmailIdentitiesResponse() override;
    ...
    QList getEmailIdentities() const;
    void setEmailIdentities(const QList &email_identities);
    bool is_email_identities_Set() const;
    bool is_email_identities_Valid() const;
...
private:
    ...
    QList m_email_identities;
    bool m_email_identities_isSet;
    bool m_email_identities_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEmailIdentitiesResponse)

#endif // OAIListEmailIdentitiesResponse_H
