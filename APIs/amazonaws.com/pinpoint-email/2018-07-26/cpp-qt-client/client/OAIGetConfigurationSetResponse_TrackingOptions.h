...
/*
 * OAIGetConfigurationSetResponse_TrackingOptions.h
 *
 * 
 */

#ifndef OAIGetConfigurationSetResponse_TrackingOptions_H
#define OAIGetConfigurationSetResponse_TrackingOptions_H
...
class OAIGetConfigurationSetResponse_TrackingOptions : public OAIObject {
public:
    OAIGetConfigurationSetResponse_TrackingOptions();
    OAIGetConfigurationSetResponse_TrackingOptions(QString json);
    ~OAIGetConfigurationSetResponse_TrackingOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetConfigurationSetResponse_TrackingOptions)

#endif // OAIGetConfigurationSetResponse_TrackingOptions_H
