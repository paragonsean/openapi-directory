...
/*
 * OAIPutEmailIdentityDkimAttributes_request.h
 *
 * 
 */

#ifndef OAIPutEmailIdentityDkimAttributes_request_H
#define OAIPutEmailIdentityDkimAttributes_request_H
...
class OAIPutEmailIdentityDkimAttributes_request : public OAIObject {
public:
    OAIPutEmailIdentityDkimAttributes_request();
    OAIPutEmailIdentityDkimAttributes_request(QString json);
    ~OAIPutEmailIdentityDkimAttributes_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutEmailIdentityDkimAttributes_request)

#endif // OAIPutEmailIdentityDkimAttributes_request_H
