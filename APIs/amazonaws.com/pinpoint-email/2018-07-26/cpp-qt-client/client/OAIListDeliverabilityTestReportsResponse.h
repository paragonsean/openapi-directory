...
/*
 * OAIListDeliverabilityTestReportsResponse.h
 *
 * A list of the predictive inbox placement test reports that are available for your account, regardless of whether or not those tests are complete.
 */

#ifndef OAIListDeliverabilityTestReportsResponse_H
#define OAIListDeliverabilityTestReportsResponse_H
...
class OAIListDeliverabilityTestReportsResponse : public OAIObject {
public:
    OAIListDeliverabilityTestReportsResponse();
    OAIListDeliverabilityTestReportsResponse(QString json);
    ~OAIListDeliverabilityTestReportsResponse() override;
    ...
    QList getDeliverabilityTestReports() const;
    void setDeliverabilityTestReports(const QList &deliverability_test_reports);
    bool is_deliverability_test_reports_Set() const;
    bool is_deliverability_test_reports_Valid() const;
...
private:
    ...
    QList m_deliverability_test_reports;
    bool m_deliverability_test_reports_isSet;
    bool m_deliverability_test_reports_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDeliverabilityTestReportsResponse)

#endif // OAIListDeliverabilityTestReportsResponse_H
