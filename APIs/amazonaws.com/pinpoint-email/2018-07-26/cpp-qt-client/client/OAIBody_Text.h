...
#ifndef OAIBody_Text_H
#define OAIBody_Text_H
...
class OAIBody_Text : public OAIObject {
public:
    OAIBody_Text();
    OAIBody_Text(QString json);
    ~OAIBody_Text() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBody_Text)

#endif // OAIBody_Text_H
