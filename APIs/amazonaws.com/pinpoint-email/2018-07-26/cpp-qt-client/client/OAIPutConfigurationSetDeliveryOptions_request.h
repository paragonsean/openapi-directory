...
/*
 * OAIPutConfigurationSetDeliveryOptions_request.h
 *
 * 
 */

#ifndef OAIPutConfigurationSetDeliveryOptions_request_H
#define OAIPutConfigurationSetDeliveryOptions_request_H
...
class OAIPutConfigurationSetDeliveryOptions_request : public OAIObject {
public:
    OAIPutConfigurationSetDeliveryOptions_request();
    OAIPutConfigurationSetDeliveryOptions_request(QString json);
    ~OAIPutConfigurationSetDeliveryOptions_request() override;
    ...
    QString getTlsPolicy() const;
    void setTlsPolicy(const QString &tls_policy);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutConfigurationSetDeliveryOptions_request)

#endif // OAIPutConfigurationSetDeliveryOptions_request_H
