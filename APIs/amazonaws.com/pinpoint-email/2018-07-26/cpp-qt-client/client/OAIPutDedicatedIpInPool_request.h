...
/*
 * OAIPutDedicatedIpInPool_request.h
 *
 * 
 */

#ifndef OAIPutDedicatedIpInPool_request_H
#define OAIPutDedicatedIpInPool_request_H
...
class OAIPutDedicatedIpInPool_request : public OAIObject {
public:
    OAIPutDedicatedIpInPool_request();
    OAIPutDedicatedIpInPool_request(QString json);
    ~OAIPutDedicatedIpInPool_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDedicatedIpInPool_request)

#endif // OAIPutDedicatedIpInPool_request_H
