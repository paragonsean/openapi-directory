...
/*
 * OAIPutDedicatedIpInPoolRequest.h
 *
 * A request to move a dedicated IP address to a dedicated IP pool.
 */

#ifndef OAIPutDedicatedIpInPoolRequest_H
#define OAIPutDedicatedIpInPoolRequest_H
...
class OAIPutDedicatedIpInPoolRequest : public OAIObject {
public:
    OAIPutDedicatedIpInPoolRequest();
    OAIPutDedicatedIpInPoolRequest(QString json);
    ~OAIPutDedicatedIpInPoolRequest() override;
    ...
    QString getDestinationPoolName() const;
    void setDestinationPoolName(const QString &destination_pool_name);
    bool is_destination_pool_name_Set() const;
    bool is_destination_pool_name_Valid() const;
...
private:
    ...
    QString m_destination_pool_name;
    bool m_destination_pool_name_isSet;
    bool m_destination_pool_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutDedicatedIpInPoolRequest)

#endif // OAIPutDedicatedIpInPoolRequest_H
