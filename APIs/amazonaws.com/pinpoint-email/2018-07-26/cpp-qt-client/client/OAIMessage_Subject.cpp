...
OAIMessage_Subject::OAIMessage_Subject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessage_Subject::OAIMessage_Subject() {
    this->initializeModel();
}

OAIMessage_Subject::~OAIMessage_Subject() {}

void OAIMessage_Subject::initializeModel() {
...
void OAIMessage_Subject::fromJson(QString jsonString) {
...
void OAIMessage_Subject::fromJsonObject(QJsonObject json) {
...
QString OAIMessage_Subject::asJson() const {
...
QJsonObject OAIMessage_Subject::asJsonObject() const {
    QJsonObject obj;
    if (m_data_isSet) {
...
QString OAIMessage_Subject::getData() const {
    return m_data;
}
void OAIMessage_Subject::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMessage_Subject::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMessage_Subject::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIMessage_Subject::getCharset() const {
    return m_charset;
}
void OAIMessage_Subject::setCharset(const QString &charset) {
    m_charset = charset;
    m_charset_isSet = true;
}

bool OAIMessage_Subject::is_charset_Set() const{
    return m_charset_isSet;
}

bool OAIMessage_Subject::is_charset_Valid() const{
    return m_charset_isValid;
}

bool OAIMessage_Subject::isSet() const {
...
bool OAIMessage_Subject::isValid() const {
