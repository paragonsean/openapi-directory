...
/*
 * OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination.h
 *
 * 
 */

#ifndef OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination_H
#define OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination_H
...
class OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination : public OAIObject {
public:
    OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination();
    OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination(QString json);
    ~OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination)

#endif // OAICreateConfigurationSetEventDestination_request_EventDestination_CloudWatchDestination_H
