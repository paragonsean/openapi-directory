...
/*
 * OAICreateDeliverabilityTestReport_request_Content_Raw.h
 *
 * 
 */

#ifndef OAICreateDeliverabilityTestReport_request_Content_Raw_H
#define OAICreateDeliverabilityTestReport_request_Content_Raw_H
...
class OAICreateDeliverabilityTestReport_request_Content_Raw : public OAIObject {
public:
    OAICreateDeliverabilityTestReport_request_Content_Raw();
    OAICreateDeliverabilityTestReport_request_Content_Raw(QString json);
    ~OAICreateDeliverabilityTestReport_request_Content_Raw() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDeliverabilityTestReport_request_Content_Raw)

#endif // OAICreateDeliverabilityTestReport_request_Content_Raw_H
