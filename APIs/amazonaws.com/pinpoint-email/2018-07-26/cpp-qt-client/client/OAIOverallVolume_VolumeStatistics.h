...
/*
 * OAIOverallVolume_VolumeStatistics.h
 *
 * 
 */

#ifndef OAIOverallVolume_VolumeStatistics_H
#define OAIOverallVolume_VolumeStatistics_H
...
class OAIOverallVolume_VolumeStatistics : public OAIObject {
public:
    OAIOverallVolume_VolumeStatistics();
    OAIOverallVolume_VolumeStatistics(QString json);
    ~OAIOverallVolume_VolumeStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOverallVolume_VolumeStatistics)

#endif // OAIOverallVolume_VolumeStatistics_H
