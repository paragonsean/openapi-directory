...
/*
 * OAIDeliverabilityDashboardAccountStatus.h
 *
...
#ifndef OAIDeliverabilityDashboardAccountStatus_H
#define OAIDeliverabilityDashboardAccountStatus_H
...
class OAIDeliverabilityDashboardAccountStatus : public OAIEnum {
public:
    OAIDeliverabilityDashboardAccountStatus();
    OAIDeliverabilityDashboardAccountStatus(QString json);
    ~OAIDeliverabilityDashboardAccountStatus() override;
    ...
    enum class eOAIDeliverabilityDashboardAccountStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        PENDING_EXPIRATION, 
        DISABLED
    };
    OAIDeliverabilityDashboardAccountStatus::eOAIDeliverabilityDashboardAccountStatus getValue() const;
    void setValue(const OAIDeliverabilityDashboardAccountStatus::eOAIDeliverabilityDashboardAccountStatus& value);
...
private:
    ...
    eOAIDeliverabilityDashboardAccountStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliverabilityDashboardAccountStatus)

#endif // OAIDeliverabilityDashboardAccountStatus_H
