...
/*
 * OAIPutConfigurationSetSendingOptionsRequest.h
 *
 * A request to enable or disable the ability of Amazon Pinpoint to send emails that use a specific configuration set.
 */

#ifndef OAIPutConfigurationSetSendingOptionsRequest_H
#define OAIPutConfigurationSetSendingOptionsRequest_H
...
class OAIPutConfigurationSetSendingOptionsRequest : public OAIObject {
public:
    OAIPutConfigurationSetSendingOptionsRequest();
    OAIPutConfigurationSetSendingOptionsRequest(QString json);
    ~OAIPutConfigurationSetSendingOptionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutConfigurationSetSendingOptionsRequest)

#endif // OAIPutConfigurationSetSendingOptionsRequest_H
