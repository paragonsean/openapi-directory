...
/*
 * OAIPutConfigurationSetTrackingOptions_request.h
 *
 * 
 */

#ifndef OAIPutConfigurationSetTrackingOptions_request_H
#define OAIPutConfigurationSetTrackingOptions_request_H
...
class OAIPutConfigurationSetTrackingOptions_request : public OAIObject {
public:
    OAIPutConfigurationSetTrackingOptions_request();
    OAIPutConfigurationSetTrackingOptions_request(QString json);
    ~OAIPutConfigurationSetTrackingOptions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutConfigurationSetTrackingOptions_request)

#endif // OAIPutConfigurationSetTrackingOptions_request_H
