...
class MailFromAttributes(Model):
    ...
    def __init__(self, mail_from_domain: str=None, mail_from_domain_status: MailFromDomainStatus=None, behavior_on_mx_failure: BehaviorOnMxFailure=None):
        """MailFromAttributes - a model defined in OpenAPI

        :param mail_from_domain: The mail_from_domain of this MailFromAttributes.
        :param mail_from_domain_status: The mail_from_domain_status of this MailFromAttributes.
        :param behavior_on_mx_failure: The behavior_on_mx_failure of this MailFromAttributes.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MailFromAttributes':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MailFromAttributes of this MailFromAttributes.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def mail_from_domain(self):
        """Gets the mail_from_domain of this MailFromAttributes.


        :return: The mail_from_domain of this MailFromAttributes.
        :rtype: str
        """
    ...
    def mail_from_domain(self, mail_from_domain):
        """Sets the mail_from_domain of this MailFromAttributes.
    ...
    def mail_from_domain_status(self):
        """Gets the mail_from_domain_status of this MailFromAttributes.


        :return: The mail_from_domain_status of this MailFromAttributes.
    ...
    def mail_from_domain_status(self, mail_from_domain_status):
        """Sets the mail_from_domain_status of this MailFromAttributes.
    ...
    def behavior_on_mx_failure(self):
        """Gets the behavior_on_mx_failure of this MailFromAttributes.


        :return: The behavior_on_mx_failure of this MailFromAttributes.
    ...
    def behavior_on_mx_failure(self, behavior_on_mx_failure):
        """Sets the behavior_on_mx_failure of this MailFromAttributes.
