...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination();
  });
  ...
  describe('CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination', function() {
    it('should create an instance of CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination', function() {
      // uncomment below and update the code to test CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationSnsDestination);
    });
