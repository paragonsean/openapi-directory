...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetConfigurationSetResponseTrackingOptions();
  });
  ...
  describe('GetConfigurationSetResponseTrackingOptions', function() {
    it('should create an instance of GetConfigurationSetResponseTrackingOptions', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetConfigurationSetResponseTrackingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetConfigurationSetResponseTrackingOptions);
    });
