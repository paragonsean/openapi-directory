...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseDeliverabilityTestReport();
  });
  ...
  describe('GetDeliverabilityTestReportResponseDeliverabilityTestReport', function() {
    it('should create an instance of GetDeliverabilityTestReportResponseDeliverabilityTestReport', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseDeliverabilityTestReport();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDeliverabilityTestReportResponseDeliverabilityTestReport);
    });
