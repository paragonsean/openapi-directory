...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PlacementStatistics();
  });
  ...
  describe('PlacementStatistics', function() {
    it('should create an instance of PlacementStatistics', function() {
      // uncomment below and update the code to test PlacementStatistics
      //var instance = new AmazonPinpointEmailService.PlacementStatistics();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PlacementStatistics);
    });
