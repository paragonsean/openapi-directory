...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateEmailIdentityRequest();
  });
  ...
  describe('CreateEmailIdentityRequest', function() {
    it('should create an instance of CreateEmailIdentityRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.CreateEmailIdentityRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateEmailIdentityRequest);
    });
