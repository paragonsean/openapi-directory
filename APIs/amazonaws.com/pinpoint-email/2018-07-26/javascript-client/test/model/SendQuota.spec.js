...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.SendQuota();
  });
  ...
  describe('SendQuota', function() {
    it('should create an instance of SendQuota', function() {
      ...
      //var instance = new AmazonPinpointEmailService.SendQuota();
      //expect(instance).to.be.a(AmazonPinpointEmailService.SendQuota);
    });
