...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutAccountSendingAttributesRequest();
  });
  ...
  describe('PutAccountSendingAttributesRequest', function() {
    it('should create an instance of PutAccountSendingAttributesRequest', function() {
      // uncomment below and update the code to test PutAccountSendingAttributesRequest
      //var instance = new AmazonPinpointEmailService.PutAccountSendingAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutAccountSendingAttributesRequest);
    });
