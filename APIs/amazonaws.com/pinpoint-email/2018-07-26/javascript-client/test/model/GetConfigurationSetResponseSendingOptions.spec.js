...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetConfigurationSetResponseSendingOptions();
  });
  ...
  describe('GetConfigurationSetResponseSendingOptions', function() {
    it('should create an instance of GetConfigurationSetResponseSendingOptions', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetConfigurationSetResponseSendingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetConfigurationSetResponseSendingOptions);
    });
