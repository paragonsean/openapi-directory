...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.RawMessage();
  });
  ...
  describe('RawMessage', function() {
    it('should create an instance of RawMessage', function() {
      ...
      //var instance = new AmazonPinpointEmailService.RawMessage();
      //expect(instance).to.be.a(AmazonPinpointEmailService.RawMessage);
    });
