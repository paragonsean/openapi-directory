...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.Destination();
  });
  ...
  describe('Destination', function() {
    it('should create an instance of Destination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.Destination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.Destination);
    });
