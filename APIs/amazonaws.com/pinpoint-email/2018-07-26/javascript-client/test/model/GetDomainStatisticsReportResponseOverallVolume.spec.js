...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponseOverallVolume();
  });
  ...
  describe('GetDomainStatisticsReportResponseOverallVolume', function() {
    it('should create an instance of GetDomainStatisticsReportResponseOverallVolume', function() {
      // uncomment below and update the code to test GetDomainStatisticsReportResponseOverallVolume
      //var instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponseOverallVolume();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDomainStatisticsReportResponseOverallVolume);
    });
