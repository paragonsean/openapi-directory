...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.UpdateConfigurationSetEventDestinationRequest();
  });
  ...
  describe('UpdateConfigurationSetEventDestinationRequest', function() {
    it('should create an instance of UpdateConfigurationSetEventDestinationRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.UpdateConfigurationSetEventDestinationRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.UpdateConfigurationSetEventDestinationRequest);
    });
