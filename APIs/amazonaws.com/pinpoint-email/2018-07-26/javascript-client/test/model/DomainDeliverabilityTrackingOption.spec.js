...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.DomainDeliverabilityTrackingOption();
  });
  ...
  describe('DomainDeliverabilityTrackingOption', function() {
    it('should create an instance of DomainDeliverabilityTrackingOption', function() {
      ...
      //var instance = new AmazonPinpointEmailService.DomainDeliverabilityTrackingOption();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DomainDeliverabilityTrackingOption);
    });
