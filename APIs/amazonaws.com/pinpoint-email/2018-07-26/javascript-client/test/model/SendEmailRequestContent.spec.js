...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.SendEmailRequestContent();
  });
  ...
  describe('SendEmailRequestContent', function() {
    it('should create an instance of SendEmailRequestContent', function() {
      // uncomment below and update the code to test SendEmailRequestContent
      //var instance = new AmazonPinpointEmailService.SendEmailRequestContent();
      //expect(instance).to.be.a(AmazonPinpointEmailService.SendEmailRequestContent);
    });
