...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.ListEmailIdentitiesResponse();
  });
  ...
  describe('ListEmailIdentitiesResponse', function() {
    it('should create an instance of ListEmailIdentitiesResponse', function() {
      // uncomment below and update the code to test ListEmailIdentitiesResponse
      //var instance = new AmazonPinpointEmailService.ListEmailIdentitiesResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.ListEmailIdentitiesResponse);
    });

    it('should have the property emailIdentities (base name: "EmailIdentities")', function() {
      // uncomment below and update the code to test the property emailIdentities
      //var instance = new AmazonPinpointEmailService.ListEmailIdentitiesResponse();
