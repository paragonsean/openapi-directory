...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.VolumeStatistics();
  });
  ...
  describe('VolumeStatistics', function() {
    it('should create an instance of VolumeStatistics', function() {
      // uncomment below and update the code to test VolumeStatistics
      //var instance = new AmazonPinpointEmailService.VolumeStatistics();
      //expect(instance).to.be.a(AmazonPinpointEmailService.VolumeStatistics);
    });
