...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.BodyText();
  });
  ...
  describe('BodyText', function() {
    it('should create an instance of BodyText', function() {
      ...
      //var instance = new AmazonPinpointEmailService.BodyText();
      //expect(instance).to.be.a(AmazonPinpointEmailService.BodyText);
    });
