...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.MessageTag();
  });
  ...
  describe('MessageTag', function() {
    it('should create an instance of MessageTag', function() {
      ...
      //var instance = new AmazonPinpointEmailService.MessageTag();
      //expect(instance).to.be.a(AmazonPinpointEmailService.MessageTag);
    });
