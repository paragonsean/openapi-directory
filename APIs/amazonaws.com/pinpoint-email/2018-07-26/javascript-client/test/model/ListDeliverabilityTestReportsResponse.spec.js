...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.ListDeliverabilityTestReportsResponse();
  });
  ...
  describe('ListDeliverabilityTestReportsResponse', function() {
    it('should create an instance of ListDeliverabilityTestReportsResponse', function() {
      // uncomment below and update the code to test ListDeliverabilityTestReportsResponse
      //var instance = new AmazonPinpointEmailService.ListDeliverabilityTestReportsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.ListDeliverabilityTestReportsResponse);
    });

    it('should have the property deliverabilityTestReports (base name: "DeliverabilityTestReports")', function() {
      // uncomment below and update the code to test the property deliverabilityTestReports
      //var instance = new AmazonPinpointEmailService.ListDeliverabilityTestReportsResponse();
