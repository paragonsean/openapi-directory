...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDedicatedIpResponse();
  });
  ...
  describe('GetDedicatedIpResponse', function() {
    it('should create an instance of GetDedicatedIpResponse', function() {
      // uncomment below and update the code to test GetDedicatedIpResponse
      //var instance = new AmazonPinpointEmailService.GetDedicatedIpResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDedicatedIpResponse);
    });

    it('should have the property dedicatedIp (base name: "DedicatedIp")', function() {
      // uncomment below and update the code to test the property dedicatedIp
      //var instance = new AmazonPinpointEmailService.GetDedicatedIpResponse();
