...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponse();
  });
  ...
  describe('GetDomainStatisticsReportResponse', function() {
    it('should create an instance of GetDomainStatisticsReportResponse', function() {
      // uncomment below and update the code to test GetDomainStatisticsReportResponse
      //var instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDomainStatisticsReportResponse);
    });

    it('should have the property overallVolume (base name: "OverallVolume")', function() {
      // uncomment below and update the code to test the property overallVolume
      //var instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponse();
      //expect(instance).to.be();
    });

    it('should have the property dailyVolumes (base name: "DailyVolumes")', function() {
      // uncomment below and update the code to test the property dailyVolumes
      //var instance = new AmazonPinpointEmailService.GetDomainStatisticsReportResponse();
      //expect(instance).to.be();
    });
