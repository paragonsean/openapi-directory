...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.IspPlacement();
  });
  ...
  describe('IspPlacement', function() {
    it('should create an instance of IspPlacement', function() {
      ...
      //var instance = new AmazonPinpointEmailService.IspPlacement();
      //expect(instance).to.be.a(AmazonPinpointEmailService.IspPlacement);
    });
