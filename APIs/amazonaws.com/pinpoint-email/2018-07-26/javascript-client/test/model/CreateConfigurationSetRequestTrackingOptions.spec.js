...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetRequestTrackingOptions();
  });
  ...
  describe('CreateConfigurationSetRequestTrackingOptions', function() {
    it('should create an instance of CreateConfigurationSetRequestTrackingOptions', function() {
      // uncomment below and update the code to test CreateConfigurationSetRequestTrackingOptions
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetRequestTrackingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetRequestTrackingOptions);
    });
