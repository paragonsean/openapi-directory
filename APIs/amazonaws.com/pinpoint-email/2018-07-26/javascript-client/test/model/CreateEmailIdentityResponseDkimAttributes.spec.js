...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateEmailIdentityResponseDkimAttributes();
  });
  ...
  describe('CreateEmailIdentityResponseDkimAttributes', function() {
    it('should create an instance of CreateEmailIdentityResponseDkimAttributes', function() {
      // uncomment below and update the code to test CreateEmailIdentityResponseDkimAttributes
      //var instance = new AmazonPinpointEmailService.CreateEmailIdentityResponseDkimAttributes();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateEmailIdentityResponseDkimAttributes);
    });

    it('should have the property signingEnabled (base name: "SigningEnabled")', function() {
      // uncomment below and update the code to test the property signingEnabled
      //var instance = new AmazonPinpointEmailService.CreateEmailIdentityResponseDkimAttributes();
