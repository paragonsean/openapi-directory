...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetBlacklistReportsResponse();
  });
  ...
  describe('GetBlacklistReportsResponse', function() {
    it('should create an instance of GetBlacklistReportsResponse', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetBlacklistReportsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetBlacklistReportsResponse);
    });
