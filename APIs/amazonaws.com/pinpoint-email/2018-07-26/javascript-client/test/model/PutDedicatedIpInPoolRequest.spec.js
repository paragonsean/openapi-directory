...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutDedicatedIpInPoolRequest();
  });
  ...
  describe('PutDedicatedIpInPoolRequest', function() {
    it('should create an instance of PutDedicatedIpInPoolRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutDedicatedIpInPoolRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutDedicatedIpInPoolRequest);
    });
