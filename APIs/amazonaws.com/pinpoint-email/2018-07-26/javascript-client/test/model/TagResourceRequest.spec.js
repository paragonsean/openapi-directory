...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.TagResourceRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.TagResourceRequest);
    });
