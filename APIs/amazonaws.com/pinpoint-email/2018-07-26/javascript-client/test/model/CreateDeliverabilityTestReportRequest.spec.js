...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportRequest();
  });
  ...
  describe('CreateDeliverabilityTestReportRequest', function() {
    it('should create an instance of CreateDeliverabilityTestReportRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateDeliverabilityTestReportRequest);
    });
