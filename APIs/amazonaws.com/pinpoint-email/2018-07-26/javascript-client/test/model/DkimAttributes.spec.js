...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.DkimAttributes();
  });
  ...
  describe('DkimAttributes', function() {
    it('should create an instance of DkimAttributes', function() {
      ...
      //var instance = new AmazonPinpointEmailService.DkimAttributes();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DkimAttributes);
    });
