...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutDedicatedIpWarmupAttributesRequest();
  });
  ...
  describe('PutDedicatedIpWarmupAttributesRequest', function() {
    it('should create an instance of PutDedicatedIpWarmupAttributesRequest', function() {
      // uncomment below and update the code to test PutDedicatedIpWarmupAttributesRequest
      //var instance = new AmazonPinpointEmailService.PutDedicatedIpWarmupAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutDedicatedIpWarmupAttributesRequest);
    });
