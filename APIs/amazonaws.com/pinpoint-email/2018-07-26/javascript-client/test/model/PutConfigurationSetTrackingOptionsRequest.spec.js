...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutConfigurationSetTrackingOptionsRequest();
  });
  ...
  describe('PutConfigurationSetTrackingOptionsRequest', function() {
    it('should create an instance of PutConfigurationSetTrackingOptionsRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutConfigurationSetTrackingOptionsRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutConfigurationSetTrackingOptionsRequest);
    });
