...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes();
  });
  ...
  describe('GetEmailIdentityResponseMailFromAttributes', function() {
    it('should create an instance of GetEmailIdentityResponseMailFromAttributes', function() {
      // uncomment below and update the code to test GetEmailIdentityResponseMailFromAttributes
      //var instance = new AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes);
    });

    it('should have the property mailFromDomain (base name: "MailFromDomain")', function() {
      // uncomment below and update the code to test the property mailFromDomain
      //var instance = new AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes();
      //expect(instance).to.be();
    });

    it('should have the property mailFromDomainStatus (base name: "MailFromDomainStatus")', function() {
      // uncomment below and update the code to test the property mailFromDomainStatus
      //var instance = new AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes();
      //expect(instance).to.be();
    });

    it('should have the property behaviorOnMxFailure (base name: "BehaviorOnMxFailure")', function() {
      // uncomment below and update the code to test the property behaviorOnMxFailure
      //var instance = new AmazonPinpointEmailService.GetEmailIdentityResponseMailFromAttributes();
      //expect(instance).to.be();
    });
