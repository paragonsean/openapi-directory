...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AmazonPinpointEmailService.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.ListTagsForResourceResponse);
    });
