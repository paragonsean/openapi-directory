...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.SendEmailRequestDestination();
  });
  ...
  describe('SendEmailRequestDestination', function() {
    it('should create an instance of SendEmailRequestDestination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.SendEmailRequestDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.SendEmailRequestDestination);
    });
