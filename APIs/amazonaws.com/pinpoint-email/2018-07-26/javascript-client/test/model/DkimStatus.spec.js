...
(function(root, factory) {
  ...
  describe('DkimStatus', function() {
    it('should create an instance of DkimStatus', function() {
      // uncomment below and update the code to test DkimStatus
      //var instance = new AmazonPinpointEmailService.DkimStatus();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DkimStatus);
    });
