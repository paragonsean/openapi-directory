...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.EmailContent();
  });
  ...
  describe('EmailContent', function() {
    it('should create an instance of EmailContent', function() {
      ...
      //var instance = new AmazonPinpointEmailService.EmailContent();
      //expect(instance).to.be.a(AmazonPinpointEmailService.EmailContent);
    });
