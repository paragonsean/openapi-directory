...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportRequestContentRaw();
  });
  ...
  describe('CreateDeliverabilityTestReportRequestContentRaw', function() {
    it('should create an instance of CreateDeliverabilityTestReportRequestContentRaw', function() {
      // uncomment below and update the code to test CreateDeliverabilityTestReportRequestContentRaw
      //var instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportRequestContentRaw();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateDeliverabilityTestReportRequestContentRaw);
    });
