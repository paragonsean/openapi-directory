...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.IdentityInfo();
  });
  ...
  describe('IdentityInfo', function() {
    it('should create an instance of IdentityInfo', function() {
      ...
      //var instance = new AmazonPinpointEmailService.IdentityInfo();
      //expect(instance).to.be.a(AmazonPinpointEmailService.IdentityInfo);
    });
