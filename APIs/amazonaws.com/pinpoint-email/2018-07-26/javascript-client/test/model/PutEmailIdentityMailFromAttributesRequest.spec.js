...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutEmailIdentityMailFromAttributesRequest();
  });
  ...
  describe('PutEmailIdentityMailFromAttributesRequest', function() {
    it('should create an instance of PutEmailIdentityMailFromAttributesRequest', function() {
      // uncomment below and update the code to test PutEmailIdentityMailFromAttributesRequest
      //var instance = new AmazonPinpointEmailService.PutEmailIdentityMailFromAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutEmailIdentityMailFromAttributesRequest);
    });
