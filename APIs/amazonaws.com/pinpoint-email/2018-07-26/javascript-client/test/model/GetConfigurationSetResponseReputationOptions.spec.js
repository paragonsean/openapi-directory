...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetConfigurationSetResponseReputationOptions();
  });
  ...
  describe('GetConfigurationSetResponseReputationOptions', function() {
    it('should create an instance of GetConfigurationSetResponseReputationOptions', function() {
      // uncomment below and update the code to test GetConfigurationSetResponseReputationOptions
      //var instance = new AmazonPinpointEmailService.GetConfigurationSetResponseReputationOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetConfigurationSetResponseReputationOptions);
    });
