...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutEmailIdentityDkimAttributesRequest();
  });
  ...
  describe('PutEmailIdentityDkimAttributesRequest', function() {
    it('should create an instance of PutEmailIdentityDkimAttributesRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutEmailIdentityDkimAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutEmailIdentityDkimAttributesRequest);
    });
