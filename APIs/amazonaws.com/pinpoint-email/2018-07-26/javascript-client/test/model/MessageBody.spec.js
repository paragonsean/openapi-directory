...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.MessageBody();
  });
  ...
  describe('MessageBody', function() {
    it('should create an instance of MessageBody', function() {
      // uncomment below and update the code to test MessageBody
      //var instance = new AmazonPinpointEmailService.MessageBody();
      //expect(instance).to.be.a(AmazonPinpointEmailService.MessageBody);
    });
