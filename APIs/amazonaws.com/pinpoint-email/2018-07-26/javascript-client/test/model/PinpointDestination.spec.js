...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PinpointDestination();
  });
  ...
  describe('PinpointDestination', function() {
    it('should create an instance of PinpointDestination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PinpointDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PinpointDestination);
    });
