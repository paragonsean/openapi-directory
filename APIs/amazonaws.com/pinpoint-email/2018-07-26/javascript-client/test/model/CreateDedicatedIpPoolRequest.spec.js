...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateDedicatedIpPoolRequest();
  });
  ...
  describe('CreateDedicatedIpPoolRequest', function() {
    it('should create an instance of CreateDedicatedIpPoolRequest', function() {
      // uncomment below and update the code to test CreateDedicatedIpPoolRequest
      //var instance = new AmazonPinpointEmailService.CreateDedicatedIpPoolRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateDedicatedIpPoolRequest);
    });
