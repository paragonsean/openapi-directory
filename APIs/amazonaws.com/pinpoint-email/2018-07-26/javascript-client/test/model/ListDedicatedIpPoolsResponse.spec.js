...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.ListDedicatedIpPoolsResponse();
  });
  ...
  describe('ListDedicatedIpPoolsResponse', function() {
    it('should create an instance of ListDedicatedIpPoolsResponse', function() {
      // uncomment below and update the code to test ListDedicatedIpPoolsResponse
      //var instance = new AmazonPinpointEmailService.ListDedicatedIpPoolsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.ListDedicatedIpPoolsResponse);
    });

    it('should have the property dedicatedIpPools (base name: "DedicatedIpPools")', function() {
      // uncomment below and update the code to test the property dedicatedIpPools
      //var instance = new AmazonPinpointEmailService.ListDedicatedIpPoolsResponse();
