...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutAccountDedicatedIpWarmupAttributesRequest();
  });
  ...
  describe('PutAccountDedicatedIpWarmupAttributesRequest', function() {
    it('should create an instance of PutAccountDedicatedIpWarmupAttributesRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutAccountDedicatedIpWarmupAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutAccountDedicatedIpWarmupAttributesRequest);
    });
