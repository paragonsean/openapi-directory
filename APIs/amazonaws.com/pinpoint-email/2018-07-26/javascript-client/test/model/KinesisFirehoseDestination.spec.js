...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.KinesisFirehoseDestination();
  });
  ...
  describe('KinesisFirehoseDestination', function() {
    it('should create an instance of KinesisFirehoseDestination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.KinesisFirehoseDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.KinesisFirehoseDestination);
    });
