...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new AmazonPinpointEmailService.Message();
      //expect(instance).to.be.a(AmazonPinpointEmailService.Message);
    });
