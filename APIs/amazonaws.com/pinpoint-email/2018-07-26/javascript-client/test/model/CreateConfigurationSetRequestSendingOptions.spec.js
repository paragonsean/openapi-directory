...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetRequestSendingOptions();
  });
  ...
  describe('CreateConfigurationSetRequestSendingOptions', function() {
    it('should create an instance of CreateConfigurationSetRequestSendingOptions', function() {
      ...
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetRequestSendingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetRequestSendingOptions);
    });
