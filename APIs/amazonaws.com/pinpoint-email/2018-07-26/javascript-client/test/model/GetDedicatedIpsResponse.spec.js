...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDedicatedIpsResponse();
  });
  ...
  describe('GetDedicatedIpsResponse', function() {
    it('should create an instance of GetDedicatedIpsResponse', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetDedicatedIpsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDedicatedIpsResponse);
    });
