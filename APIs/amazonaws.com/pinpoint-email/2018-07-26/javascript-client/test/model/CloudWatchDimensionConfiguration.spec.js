...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CloudWatchDimensionConfiguration();
  });
  ...
  describe('CloudWatchDimensionConfiguration', function() {
    it('should create an instance of CloudWatchDimensionConfiguration', function() {
      // uncomment below and update the code to test CloudWatchDimensionConfiguration
      //var instance = new AmazonPinpointEmailService.CloudWatchDimensionConfiguration();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CloudWatchDimensionConfiguration);
    });
    ...
    it('should have the property dimensionValueSource (base name: "DimensionValueSource")', function() {
      // uncomment below and update the code to test the property dimensionValueSource
      //var instance = new AmazonPinpointEmailService.CloudWatchDimensionConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property defaultDimensionValue (base name: "DefaultDimensionValue")', function() {
      // uncomment below and update the code to test the property defaultDimensionValue
      //var instance = new AmazonPinpointEmailService.CloudWatchDimensionConfiguration();
      //expect(instance).to.be();
    });
