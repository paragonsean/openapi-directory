...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination();
  });
  ...
  describe('CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination', function() {
    it('should create an instance of CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination', function() {
      // uncomment below and update the code to test CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationCloudWatchDestination);
    });
