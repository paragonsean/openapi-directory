...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportResponse();
  });
  ...
  describe('CreateDeliverabilityTestReportResponse', function() {
    it('should create an instance of CreateDeliverabilityTestReportResponse', function() {
      // uncomment below and update the code to test CreateDeliverabilityTestReportResponse
      //var instance = new AmazonPinpointEmailService.CreateDeliverabilityTestReportResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateDeliverabilityTestReportResponse);
    });
