...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CloudWatchDestination();
  });
  ...
  describe('CloudWatchDestination', function() {
    it('should create an instance of CloudWatchDestination', function() {
      // uncomment below and update the code to test CloudWatchDestination
      //var instance = new AmazonPinpointEmailService.CloudWatchDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CloudWatchDestination);
    });
