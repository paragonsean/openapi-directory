...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDedicatedIpResponseDedicatedIp();
  });
  ...
  describe('GetDedicatedIpResponseDedicatedIp', function() {
    it('should create an instance of GetDedicatedIpResponseDedicatedIp', function() {
      ...
      //var instance = new AmazonPinpointEmailService.GetDedicatedIpResponseDedicatedIp();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDedicatedIpResponseDedicatedIp);
    });
