...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.BodyHtml();
  });
  ...
  describe('BodyHtml', function() {
    it('should create an instance of BodyHtml', function() {
      ...
      //var instance = new AmazonPinpointEmailService.BodyHtml();
      //expect(instance).to.be.a(AmazonPinpointEmailService.BodyHtml);
    });
