...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutConfigurationSetReputationOptionsRequest();
  });
  ...
  describe('PutConfigurationSetReputationOptionsRequest', function() {
    it('should create an instance of PutConfigurationSetReputationOptionsRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutConfigurationSetReputationOptionsRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutConfigurationSetReputationOptionsRequest);
    });
