...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationKinesisFirehoseDestination();
  });
  ...
  describe('CreateConfigurationSetEventDestinationRequestEventDestinationKinesisFirehoseDestination', function() {
    it('should create an instance of CreateConfigurationSetEventDestinationRequestEventDestinationKinesisFirehoseDestination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationKinesisFirehoseDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationKinesisFirehoseDestination);
    });
