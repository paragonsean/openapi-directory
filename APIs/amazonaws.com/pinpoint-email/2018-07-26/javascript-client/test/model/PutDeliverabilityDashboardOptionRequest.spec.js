...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutDeliverabilityDashboardOptionRequest();
  });
  ...
  describe('PutDeliverabilityDashboardOptionRequest', function() {
    it('should create an instance of PutDeliverabilityDashboardOptionRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutDeliverabilityDashboardOptionRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutDeliverabilityDashboardOptionRequest);
    });
