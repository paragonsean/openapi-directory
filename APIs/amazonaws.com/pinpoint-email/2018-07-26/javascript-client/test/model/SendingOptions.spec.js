...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.SendingOptions();
  });
  ...
  describe('SendingOptions', function() {
    it('should create an instance of SendingOptions', function() {
      ...
      //var instance = new AmazonPinpointEmailService.SendingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.SendingOptions);
    });
