...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.SendEmailResponse();
  });
  ...
  describe('SendEmailResponse', function() {
    it('should create an instance of SendEmailResponse', function() {
      ...
      //var instance = new AmazonPinpointEmailService.SendEmailResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.SendEmailResponse);
    });
