...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination();
  });
  ...
  describe('CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination', function() {
    it('should create an instance of CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination', function() {
      // uncomment below and update the code to test CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestinationPinpointDestination);
    });
