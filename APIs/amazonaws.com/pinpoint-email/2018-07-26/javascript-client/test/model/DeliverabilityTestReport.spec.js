...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.DeliverabilityTestReport();
  });
  ...
  describe('DeliverabilityTestReport', function() {
    it('should create an instance of DeliverabilityTestReport', function() {
      ...
      //var instance = new AmazonPinpointEmailService.DeliverabilityTestReport();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DeliverabilityTestReport);
    });
