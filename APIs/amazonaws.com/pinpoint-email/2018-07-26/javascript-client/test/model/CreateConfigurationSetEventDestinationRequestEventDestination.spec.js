...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestination();
  });
  ...
  describe('CreateConfigurationSetEventDestinationRequestEventDestination', function() {
    it('should create an instance of CreateConfigurationSetEventDestinationRequestEventDestination', function() {
      ...
      //var instance = new AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestination();
      //expect(instance).to.be.a(AmazonPinpointEmailService.CreateConfigurationSetEventDestinationRequestEventDestination);
    });
