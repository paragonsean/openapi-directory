...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutConfigurationSetSendingOptionsRequest();
  });
  ...
  describe('PutConfigurationSetSendingOptionsRequest', function() {
    it('should create an instance of PutConfigurationSetSendingOptionsRequest', function() {
      // uncomment below and update the code to test PutConfigurationSetSendingOptionsRequest
      //var instance = new AmazonPinpointEmailService.PutConfigurationSetSendingOptionsRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutConfigurationSetSendingOptionsRequest);
    });
