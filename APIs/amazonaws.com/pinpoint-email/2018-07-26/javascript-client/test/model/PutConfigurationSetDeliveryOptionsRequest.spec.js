...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutConfigurationSetDeliveryOptionsRequest();
  });
  ...
  describe('PutConfigurationSetDeliveryOptionsRequest', function() {
    it('should create an instance of PutConfigurationSetDeliveryOptionsRequest', function() {
      // uncomment below and update the code to test PutConfigurationSetDeliveryOptionsRequest
      //var instance = new AmazonPinpointEmailService.PutConfigurationSetDeliveryOptionsRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutConfigurationSetDeliveryOptionsRequest);
    });
