...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.MessageSubject();
  });
  ...
  describe('MessageSubject', function() {
    it('should create an instance of MessageSubject', function() {
      ...
      //var instance = new AmazonPinpointEmailService.MessageSubject();
      //expect(instance).to.be.a(AmazonPinpointEmailService.MessageSubject);
    });
