...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.Template();
  });
  ...
  describe('Template', function() {
    it('should create an instance of Template', function() {
      ...
      //var instance = new AmazonPinpointEmailService.Template();
      //expect(instance).to.be.a(AmazonPinpointEmailService.Template);
    });
