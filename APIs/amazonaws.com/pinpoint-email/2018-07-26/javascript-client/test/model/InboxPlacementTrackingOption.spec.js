...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.InboxPlacementTrackingOption();
  });
  ...
  describe('InboxPlacementTrackingOption', function() {
    it('should create an instance of InboxPlacementTrackingOption', function() {
      // uncomment below and update the code to test InboxPlacementTrackingOption
      //var instance = new AmazonPinpointEmailService.InboxPlacementTrackingOption();
      //expect(instance).to.be.a(AmazonPinpointEmailService.InboxPlacementTrackingOption);
    });
