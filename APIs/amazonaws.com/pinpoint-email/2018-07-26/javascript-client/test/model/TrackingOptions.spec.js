...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.TrackingOptions();
  });
  ...
  describe('TrackingOptions', function() {
    it('should create an instance of TrackingOptions', function() {
      ...
      //var instance = new AmazonPinpointEmailService.TrackingOptions();
      //expect(instance).to.be.a(AmazonPinpointEmailService.TrackingOptions);
    });
