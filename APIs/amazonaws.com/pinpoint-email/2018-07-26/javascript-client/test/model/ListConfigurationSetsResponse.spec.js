...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.ListConfigurationSetsResponse();
  });
  ...
  describe('ListConfigurationSetsResponse', function() {
    it('should create an instance of ListConfigurationSetsResponse', function() {
      ...
      //var instance = new AmazonPinpointEmailService.ListConfigurationSetsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.ListConfigurationSetsResponse);
    });
