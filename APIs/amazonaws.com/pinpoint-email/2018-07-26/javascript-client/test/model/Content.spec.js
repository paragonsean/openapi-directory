...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.Content();
  });
  ...
  describe('Content', function() {
    it('should create an instance of Content', function() {
      ...
      //var instance = new AmazonPinpointEmailService.Content();
      //expect(instance).to.be.a(AmazonPinpointEmailService.Content);
    });
