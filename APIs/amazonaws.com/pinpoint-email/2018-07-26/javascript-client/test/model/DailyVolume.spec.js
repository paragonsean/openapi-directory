...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.DailyVolume();
  });
  ...
  describe('DailyVolume', function() {
    it('should create an instance of DailyVolume', function() {
      ...
      //var instance = new AmazonPinpointEmailService.DailyVolume();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DailyVolume);
    });
