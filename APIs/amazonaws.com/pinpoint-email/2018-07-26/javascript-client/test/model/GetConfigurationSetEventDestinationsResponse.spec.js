...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetConfigurationSetEventDestinationsResponse();
  });
  ...
  describe('GetConfigurationSetEventDestinationsResponse', function() {
    it('should create an instance of GetConfigurationSetEventDestinationsResponse', function() {
      // uncomment below and update the code to test GetConfigurationSetEventDestinationsResponse
      //var instance = new AmazonPinpointEmailService.GetConfigurationSetEventDestinationsResponse();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetConfigurationSetEventDestinationsResponse);
    });
