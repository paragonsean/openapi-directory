...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
  });
  ...
  describe('GetDeliverabilityTestReportResponseOverallPlacement', function() {
    it('should create an instance of GetDeliverabilityTestReportResponseOverallPlacement', function() {
      // uncomment below and update the code to test GetDeliverabilityTestReportResponseOverallPlacement
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be.a(AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement);
    });

    it('should have the property inboxPercentage (base name: "InboxPercentage")', function() {
      // uncomment below and update the code to test the property inboxPercentage
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be();
    });

    it('should have the property spamPercentage (base name: "SpamPercentage")', function() {
      // uncomment below and update the code to test the property spamPercentage
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be();
    });

    it('should have the property missingPercentage (base name: "MissingPercentage")', function() {
      // uncomment below and update the code to test the property missingPercentage
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be();
    });

    it('should have the property spfPercentage (base name: "SpfPercentage")', function() {
      // uncomment below and update the code to test the property spfPercentage
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be();
    });

    it('should have the property dkimPercentage (base name: "DkimPercentage")', function() {
      // uncomment below and update the code to test the property dkimPercentage
      //var instance = new AmazonPinpointEmailService.GetDeliverabilityTestReportResponseOverallPlacement();
      //expect(instance).to.be();
    });
