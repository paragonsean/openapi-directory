...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.DomainDeliverabilityTrackingOptionInboxPlacementTrackingOption();
  });
  ...
  describe('DomainDeliverabilityTrackingOptionInboxPlacementTrackingOption', function() {
    it('should create an instance of DomainDeliverabilityTrackingOptionInboxPlacementTrackingOption', function() {
      ...
      //var instance = new AmazonPinpointEmailService.DomainDeliverabilityTrackingOptionInboxPlacementTrackingOption();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DomainDeliverabilityTrackingOptionInboxPlacementTrackingOption);
    });
