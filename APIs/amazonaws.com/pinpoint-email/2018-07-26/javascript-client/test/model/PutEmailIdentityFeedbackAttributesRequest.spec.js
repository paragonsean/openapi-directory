...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.PutEmailIdentityFeedbackAttributesRequest();
  });
  ...
  describe('PutEmailIdentityFeedbackAttributesRequest', function() {
    it('should create an instance of PutEmailIdentityFeedbackAttributesRequest', function() {
      ...
      //var instance = new AmazonPinpointEmailService.PutEmailIdentityFeedbackAttributesRequest();
      //expect(instance).to.be.a(AmazonPinpointEmailService.PutEmailIdentityFeedbackAttributesRequest);
    });
