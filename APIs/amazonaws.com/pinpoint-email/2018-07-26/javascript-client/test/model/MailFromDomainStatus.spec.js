...
(function(root, factory) {
  ...
  describe('MailFromDomainStatus', function() {
    it('should create an instance of MailFromDomainStatus', function() {
      // uncomment below and update the code to test MailFromDomainStatus
      //var instance = new AmazonPinpointEmailService.MailFromDomainStatus();
      //expect(instance).to.be.a(AmazonPinpointEmailService.MailFromDomainStatus);
    });
