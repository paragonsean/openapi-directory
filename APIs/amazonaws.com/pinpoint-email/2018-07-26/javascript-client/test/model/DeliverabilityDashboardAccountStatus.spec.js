...
(function(root, factory) {
  ...
  describe('DeliverabilityDashboardAccountStatus', function() {
    it('should create an instance of DeliverabilityDashboardAccountStatus', function() {
      // uncomment below and update the code to test DeliverabilityDashboardAccountStatus
      //var instance = new AmazonPinpointEmailService.DeliverabilityDashboardAccountStatus();
      //expect(instance).to.be.a(AmazonPinpointEmailService.DeliverabilityDashboardAccountStatus);
    });
