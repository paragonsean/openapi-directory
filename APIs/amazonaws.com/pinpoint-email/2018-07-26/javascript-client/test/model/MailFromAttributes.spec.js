...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPinpointEmailService.MailFromAttributes();
  });
  ...
  describe('MailFromAttributes', function() {
    it('should create an instance of MailFromAttributes', function() {
      // uncomment below and update the code to test MailFromAttributes
      //var instance = new AmazonPinpointEmailService.MailFromAttributes();
      //expect(instance).to.be.a(AmazonPinpointEmailService.MailFromAttributes);
    });
