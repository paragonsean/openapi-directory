...
/**
 * The PutConfigurationSetReputationOptionsRequest model module.
 * @module model/PutConfigurationSetReputationOptionsRequest
 * @version 2018-07-26
 */
class PutConfigurationSetReputationOptionsRequest {
    /**
     * Constructs a new <code>PutConfigurationSetReputationOptionsRequest</code>.
     * @alias module:model/PutConfigurationSetReputationOptionsRequest
     */
    constructor() { 
        
        PutConfigurationSetReputationOptionsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutConfigurationSetReputationOptionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutConfigurationSetReputationOptionsRequest} obj Optional instance to populate.
     * @return {module:model/PutConfigurationSetReputationOptionsRequest} The populated <code>PutConfigurationSetReputationOptionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutConfigurationSetReputationOptionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutConfigurationSetReputationOptionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutConfigurationSetReputationOptionsRequest</code>.
     */
 ...
 */
PutConfigurationSetReputationOptionsRequest.prototype['ReputationMetricsEnabled'] = undefined;
...
export default PutConfigurationSetReputationOptionsRequest;
