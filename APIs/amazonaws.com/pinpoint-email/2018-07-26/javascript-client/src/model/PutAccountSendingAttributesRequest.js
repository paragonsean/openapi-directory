...
/**
 * The PutAccountSendingAttributesRequest model module.
 * @module model/PutAccountSendingAttributesRequest
 * @version 2018-07-26
 */
class PutAccountSendingAttributesRequest {
    /**
     * Constructs a new <code>PutAccountSendingAttributesRequest</code>.
     * @alias module:model/PutAccountSendingAttributesRequest
     */
    constructor() { 
        
        PutAccountSendingAttributesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutAccountSendingAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutAccountSendingAttributesRequest} obj Optional instance to populate.
     * @return {module:model/PutAccountSendingAttributesRequest} The populated <code>PutAccountSendingAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutAccountSendingAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutAccountSendingAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutAccountSendingAttributesRequest</code>.
     */
 ...
 */
PutAccountSendingAttributesRequest.prototype['SendingEnabled'] = undefined;
...
export default PutAccountSendingAttributesRequest;
