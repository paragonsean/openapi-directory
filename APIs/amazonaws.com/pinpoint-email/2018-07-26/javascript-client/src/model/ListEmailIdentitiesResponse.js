...
/**
 * The ListEmailIdentitiesResponse model module.
 * @module model/ListEmailIdentitiesResponse
 * @version 2018-07-26
 */
class ListEmailIdentitiesResponse {
    /**
     * Constructs a new <code>ListEmailIdentitiesResponse</code>.
     ...
     * @alias module:model/ListEmailIdentitiesResponse
     */
    constructor() { 
        
        ListEmailIdentitiesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListEmailIdentitiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListEmailIdentitiesResponse} obj Optional instance to populate.
     * @return {module:model/ListEmailIdentitiesResponse} The populated <code>ListEmailIdentitiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListEmailIdentitiesResponse();

            if (data.hasOwnProperty('EmailIdentities')) {
                obj['EmailIdentities'] = ApiClient.convertToType(data['EmailIdentities'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListEmailIdentitiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListEmailIdentitiesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EmailIdentities`
        if (data['EmailIdentities']) { // data not null
          Array.validateJSON(data['EmailIdentities']);
        }
...
/**
 * @member {Array} EmailIdentities
 */
ListEmailIdentitiesResponse.prototype['EmailIdentities'] = undefined;

/**
 * @member {String} NextToken
 */
ListEmailIdentitiesResponse.prototype['NextToken'] = undefined;
...
export default ListEmailIdentitiesResponse;
