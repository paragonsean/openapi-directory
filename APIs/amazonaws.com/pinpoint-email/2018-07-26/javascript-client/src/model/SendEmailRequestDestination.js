...
/**
 * The SendEmailRequestDestination model module.
 * @module model/SendEmailRequestDestination
 * @version 2018-07-26
 */
class SendEmailRequestDestination {
    /**
     * Constructs a new <code>SendEmailRequestDestination</code>.
     * @alias module:model/SendEmailRequestDestination
     * @implements module:model/Destination
     */
    constructor() { 
        Destination.initialize(this);
        SendEmailRequestDestination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendEmailRequestDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendEmailRequestDestination} obj Optional instance to populate.
     * @return {module:model/SendEmailRequestDestination} The populated <code>SendEmailRequestDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendEmailRequestDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>SendEmailRequestDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendEmailRequestDestination</code>.
     */
 ...
 */
SendEmailRequestDestination.prototype['ToAddresses'] = undefined;

/**
 * @member {Array} CcAddresses
 */
SendEmailRequestDestination.prototype['CcAddresses'] = undefined;

/**
 * @member {Array} BccAddresses
 */
SendEmailRequestDestination.prototype['BccAddresses'] = undefined;
...
export default SendEmailRequestDestination;
