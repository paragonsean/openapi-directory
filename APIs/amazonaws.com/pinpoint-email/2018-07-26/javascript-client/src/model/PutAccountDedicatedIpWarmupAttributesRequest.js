...
/**
 * The PutAccountDedicatedIpWarmupAttributesRequest model module.
 * @module model/PutAccountDedicatedIpWarmupAttributesRequest
 * @version 2018-07-26
 */
class PutAccountDedicatedIpWarmupAttributesRequest {
    /**
     * Constructs a new <code>PutAccountDedicatedIpWarmupAttributesRequest</code>.
     * @alias module:model/PutAccountDedicatedIpWarmupAttributesRequest
     */
    constructor() { 
        
        PutAccountDedicatedIpWarmupAttributesRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutAccountDedicatedIpWarmupAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutAccountDedicatedIpWarmupAttributesRequest} obj Optional instance to populate.
     * @return {module:model/PutAccountDedicatedIpWarmupAttributesRequest} The populated <code>PutAccountDedicatedIpWarmupAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutAccountDedicatedIpWarmupAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutAccountDedicatedIpWarmupAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutAccountDedicatedIpWarmupAttributesRequest</code>.
     */
 ...
 */
PutAccountDedicatedIpWarmupAttributesRequest.prototype['AutoWarmupEnabled'] = undefined;
...
export default PutAccountDedicatedIpWarmupAttributesRequest;
