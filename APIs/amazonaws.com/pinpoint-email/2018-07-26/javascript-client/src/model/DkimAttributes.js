...
/**
 * The DkimAttributes model module.
 * @module model/DkimAttributes
 * @version 2018-07-26
 */
class DkimAttributes {
    /**
     * Constructs a new <code>DkimAttributes</code>.
     * An object that contains information about the DKIM configuration for an email identity.
     * @alias module:model/DkimAttributes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DkimAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DkimAttributes} obj Optional instance to populate.
     * @return {module:model/DkimAttributes} The populated <code>DkimAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DkimAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>DkimAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DkimAttributes</code>.
     */
