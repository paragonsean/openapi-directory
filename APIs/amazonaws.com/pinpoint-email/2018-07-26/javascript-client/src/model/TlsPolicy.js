...
* @readonly
*/
export default class TlsPolicy {
    ...
    /**
    * Returns a <code>TlsPolicy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TlsPolicy} The enum <code>TlsPolicy</code> value.
    */
