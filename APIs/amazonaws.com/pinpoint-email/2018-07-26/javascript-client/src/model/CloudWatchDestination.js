...
/**
 * The CloudWatchDestination model module.
 * @module model/CloudWatchDestination
 * @version 2018-07-26
 */
class CloudWatchDestination {
    /**
     * Constructs a new <code>CloudWatchDestination</code>.
     * An object that defines an Amazon CloudWatch destination for email events. You can use Amazon CloudWatch to monitor and gain insights on your email sending metrics.
     * @alias module:model/CloudWatchDestination
    ...
    /**
     * Constructs a <code>CloudWatchDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudWatchDestination} obj Optional instance to populate.
     * @return {module:model/CloudWatchDestination} The populated <code>CloudWatchDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudWatchDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudWatchDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudWatchDestination</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CloudWatchDestination.RequiredProperties) {
...
CloudWatchDestination.RequiredProperties = ["DimensionConfigurations"];
...
export default CloudWatchDestination;
