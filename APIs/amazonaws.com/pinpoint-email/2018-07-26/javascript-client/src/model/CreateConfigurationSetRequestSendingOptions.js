...
/**
 * The CreateConfigurationSetRequestSendingOptions model module.
 * @module model/CreateConfigurationSetRequestSendingOptions
 * @version 2018-07-26
 */
class CreateConfigurationSetRequestSendingOptions {
    /**
     * Constructs a new <code>CreateConfigurationSetRequestSendingOptions</code>.
     * Used to enable or disable email sending for messages that use this configuration set in the current AWS Region.
     * @alias module:model/CreateConfigurationSetRequestSendingOptions
     */
    constructor() { 
        
        CreateConfigurationSetRequestSendingOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateConfigurationSetRequestSendingOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateConfigurationSetRequestSendingOptions} obj Optional instance to populate.
     * @return {module:model/CreateConfigurationSetRequestSendingOptions} The populated <code>CreateConfigurationSetRequestSendingOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateConfigurationSetRequestSendingOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateConfigurationSetRequestSendingOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateConfigurationSetRequestSendingOptions</code>.
     */
 ...
 */
CreateConfigurationSetRequestSendingOptions.prototype['SendingEnabled'] = undefined;
...
export default CreateConfigurationSetRequestSendingOptions;
