...
* @readonly
*/
export default class DeliverabilityDashboardAccountStatus {
    ...
    /**
    * Returns a <code>DeliverabilityDashboardAccountStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeliverabilityDashboardAccountStatus} The enum <code>DeliverabilityDashboardAccountStatus</code> value.
    */
