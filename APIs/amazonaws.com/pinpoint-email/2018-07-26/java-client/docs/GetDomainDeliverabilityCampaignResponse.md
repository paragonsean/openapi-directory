...
|------------ | ------------- | ------------- | -------------|
|**domainDeliverabilityCampaign** | [**GetDomainDeliverabilityCampaignResponseDomainDeliverabilityCampaign**](GetDomainDeliverabilityCampaignResponseDomainDeliverabilityCampaign.md) |  |  |
