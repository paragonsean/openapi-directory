...
public class SendingOptions {
  ...
  public SendingOptions sendingEnabled(Boolean sendingEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sendingEnabled, sendingOptions.sendingEnabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendingOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendingOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendingOptions is not found in the empty JSON string", SendingOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendingOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendingOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendingOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendingOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendingOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendingOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<SendingOptions>() {
           @Override
           public void write(JsonWriter out, SendingOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendingOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendingOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendingOptions
   * @throws IOException if the JSON string is invalid with respect to SendingOptions
   */
  public static SendingOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendingOptions.class);
  }

  /**
   * Convert an instance of SendingOptions to an JSON string
   *
   * @return JSON string
   */
