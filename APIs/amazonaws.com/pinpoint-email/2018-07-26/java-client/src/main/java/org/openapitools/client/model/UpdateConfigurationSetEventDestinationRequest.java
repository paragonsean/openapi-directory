...
public class UpdateConfigurationSetEventDestinationRequest {
  ...
  public UpdateConfigurationSetEventDestinationRequest eventDestination(CreateConfigurationSetEventDestinationRequestEventDestination eventDestination) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateConfigurationSetEventDestinationRequest updateConfigurationSetEventDestinationRequest = (UpdateConfigurationSetEventDestinationRequest) o;
    return Objects.equals(this.eventDestination, updateConfigurationSetEventDestinationRequest.eventDestination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventDestination);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateConfigurationSetEventDestinationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateConfigurationSetEventDestinationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConfigurationSetEventDestinationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateConfigurationSetEventDestinationRequest is not found in the empty JSON string", UpdateConfigurationSetEventDestinationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConfigurationSetEventDestinationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateConfigurationSetEventDestinationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateConfigurationSetEventDestinationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateConfigurationSetEventDestinationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateConfigurationSetEventDestinationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateConfigurationSetEventDestinationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateConfigurationSetEventDestinationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateConfigurationSetEventDestinationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateConfigurationSetEventDestinationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateConfigurationSetEventDestinationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateConfigurationSetEventDestinationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateConfigurationSetEventDestinationRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateConfigurationSetEventDestinationRequest
   */
  public static UpdateConfigurationSetEventDestinationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateConfigurationSetEventDestinationRequest.class);
  }

  /**
   * Convert an instance of UpdateConfigurationSetEventDestinationRequest to an JSON string
   *
   * @return JSON string
   */
