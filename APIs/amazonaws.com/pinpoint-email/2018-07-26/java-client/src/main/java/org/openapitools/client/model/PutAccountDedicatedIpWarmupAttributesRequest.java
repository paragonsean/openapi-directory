...
public class PutAccountDedicatedIpWarmupAttributesRequest {
  ...
  public PutAccountDedicatedIpWarmupAttributesRequest autoWarmupEnabled(Boolean autoWarmupEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    PutAccountDedicatedIpWarmupAttributesRequest putAccountDedicatedIpWarmupAttributesRequest = (PutAccountDedicatedIpWarmupAttributesRequest) o;
    return Objects.equals(this.autoWarmupEnabled, putAccountDedicatedIpWarmupAttributesRequest.autoWarmupEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutAccountDedicatedIpWarmupAttributesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutAccountDedicatedIpWarmupAttributesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutAccountDedicatedIpWarmupAttributesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutAccountDedicatedIpWarmupAttributesRequest is not found in the empty JSON string", PutAccountDedicatedIpWarmupAttributesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutAccountDedicatedIpWarmupAttributesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutAccountDedicatedIpWarmupAttributesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutAccountDedicatedIpWarmupAttributesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutAccountDedicatedIpWarmupAttributesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutAccountDedicatedIpWarmupAttributesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutAccountDedicatedIpWarmupAttributesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutAccountDedicatedIpWarmupAttributesRequest>() {
           @Override
           public void write(JsonWriter out, PutAccountDedicatedIpWarmupAttributesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutAccountDedicatedIpWarmupAttributesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutAccountDedicatedIpWarmupAttributesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutAccountDedicatedIpWarmupAttributesRequest
   * @throws IOException if the JSON string is invalid with respect to PutAccountDedicatedIpWarmupAttributesRequest
   */
  public static PutAccountDedicatedIpWarmupAttributesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutAccountDedicatedIpWarmupAttributesRequest.class);
  }

  /**
   * Convert an instance of PutAccountDedicatedIpWarmupAttributesRequest to an JSON string
   *
   * @return JSON string
   */
