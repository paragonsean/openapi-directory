...
public class MessageSubject {
  ...
  public MessageSubject data(String data) {
    this.data = data;
    return this;
  }
  ...
  public MessageSubject charset(String charset) {
  ...
  public boolean equals(Object o) {
    ...
    MessageSubject messageSubject = (MessageSubject) o;
    return Objects.equals(this.data, messageSubject.data) &&
        Objects.equals(this.charset, messageSubject.charset);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageSubject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageSubject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageSubject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageSubject is not found in the empty JSON string", MessageSubject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageSubject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageSubject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessageSubject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageSubject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageSubject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageSubject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageSubject.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageSubject>() {
           @Override
           public void write(JsonWriter out, MessageSubject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageSubject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageSubject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageSubject
   * @throws IOException if the JSON string is invalid with respect to MessageSubject
   */
  public static MessageSubject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageSubject.class);
  }

  /**
   * Convert an instance of MessageSubject to an JSON string
   *
   * @return JSON string
   */
