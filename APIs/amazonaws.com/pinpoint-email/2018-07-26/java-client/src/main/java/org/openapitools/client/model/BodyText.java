...
public class BodyText {
  ...
  public BodyText data(String data) {
    this.data = data;
    return this;
  }
  ...
  public BodyText charset(String charset) {
  ...
  public boolean equals(Object o) {
    ...
    BodyText bodyText = (BodyText) o;
    return Objects.equals(this.data, bodyText.data) &&
        Objects.equals(this.charset, bodyText.charset);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BodyText
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BodyText.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BodyText is not found in the empty JSON string", BodyText.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BodyText.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BodyText` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BodyText.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BodyText.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BodyText' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BodyText> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BodyText.class));

       return (TypeAdapter<T>) new TypeAdapter<BodyText>() {
           @Override
           public void write(JsonWriter out, BodyText value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BodyText read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BodyText given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BodyText
   * @throws IOException if the JSON string is invalid with respect to BodyText
   */
  public static BodyText fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BodyText.class);
  }

  /**
   * Convert an instance of BodyText to an JSON string
   *
   * @return JSON string
   */
