...
public class ApiClient {
    ...
    private String basePath = "http://email.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-07-26/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://email.us-east-1.amazonaws.com
