...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaStore.ListContainersInput();
  });
  ...
  describe('ListContainersInput', function() {
    it('should create an instance of ListContainersInput', function() {
      // uncomment below and update the code to test ListContainersInput
      //var instance = new AwsElementalMediaStore.ListContainersInput();
      //expect(instance).to.be.a(AwsElementalMediaStore.ListContainersInput);
    });
