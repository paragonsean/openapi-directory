...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaStore.Container();
  });
  ...
  describe('Container', function() {
    it('should create an instance of Container', function() {
      ...
      //var instance = new AwsElementalMediaStore.Container();
      //expect(instance).to.be.a(AwsElementalMediaStore.Container);
    });
