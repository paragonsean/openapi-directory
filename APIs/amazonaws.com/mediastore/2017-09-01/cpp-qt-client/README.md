...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateContainerInput create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateContainerInput Example::create(){
    OAICreateContainerInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createContainerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createContainerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateContainerInput oai_create_container_input = create(); // OAICreateContainerInput | 
      ...
      apiInstance.createContainer(x_amz_targetoai_create_container_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
