...
/*
 * OAIDescribeContainerOutput_Container.h
 *
 * 
 */

#ifndef OAIDescribeContainerOutput_Container_H
#define OAIDescribeContainerOutput_Container_H
...
class OAIDescribeContainerOutput_Container : public OAIObject {
public:
    OAIDescribeContainerOutput_Container();
    OAIDescribeContainerOutput_Container(QString json);
    ~OAIDescribeContainerOutput_Container() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeContainerOutput_Container)

#endif // OAIDescribeContainerOutput_Container_H
