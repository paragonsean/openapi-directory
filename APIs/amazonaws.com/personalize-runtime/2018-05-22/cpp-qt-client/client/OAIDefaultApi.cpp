...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://personalize-runtime.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://personalize-runtime.{region}.amazonaws.com"),
    "The Amazon Personalize Runtime multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://personalize-runtime.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://personalize-runtime.{region}.amazonaws.com.cn"),
    "The Amazon Personalize Runtime endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
    
    _serverConfigs.insert("getPersonalizedRanking", defaultConf);
    _serverIndices.insert("getPersonalizedRanking", 0);
...
void OAIDefaultApi::getPersonalizedRanking(const OAIGetPersonalizedRanking_request &oai_get_personalized_ranking_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
...

    {
        ...
        QByteArray output = oai_get_personalized_ranking_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getPersonalizedRankingCallback);
...
void OAIDefaultApi::getPersonalizedRankingCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetPersonalizedRankingResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getPersonalizedRankingSignal(output);
        Q_EMIT getPersonalizedRankingSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getPersonalizedRankingSignalE(output, error_type, error_str);
        Q_EMIT getPersonalizedRankingSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getPersonalizedRankingSignalError(output, error_type, error_str);
        Q_EMIT getPersonalizedRankingSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::getRecommendations(const OAIGetRecommendations_request &oai_get_recommendations_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
...

    {
        ...
        QByteArray output = oai_get_recommendations_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    if (x_amz_content_sha256.hasValue())
    {
