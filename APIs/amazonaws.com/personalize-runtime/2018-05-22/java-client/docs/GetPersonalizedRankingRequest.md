...
|**inputList** | **List&lt;String&gt;** | A list of items (by &lt;code&gt;itemId&lt;/code&gt;) to rank. If an item was not included in the training dataset, the item is appended to the end of the reranked list. The maximum is 500. |  |
