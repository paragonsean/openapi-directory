...
public class GetTransactionOutputTransaction {
  ...
  public GetTransactionOutputTransaction() {
  }

  public GetTransactionOutputTransaction network(QueryNetwork network) {
  ...
  public GetTransactionOutputTransaction blockHash(String blockHash) {
  ...
  public GetTransactionOutputTransaction transactionHash(String transactionHash) {
  ...
  public GetTransactionOutputTransaction blockNumber(String blockNumber) {
  ...
  public GetTransactionOutputTransaction transactionTimestamp(OffsetDateTime transactionTimestamp) {
  ...
  public GetTransactionOutputTransaction transactionIndex(Integer transactionIndex) {
  ...
  public GetTransactionOutputTransaction numberOfTransactions(Integer numberOfTransactions) {
  ...
  public GetTransactionOutputTransaction status(QueryTransactionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetTransactionOutputTransaction to(String to) {
    this.to = to;
    return this;
  }
  ...
  public GetTransactionOutputTransaction from(String from) {
    this.from = from;
    return this;
  }
  ...
  public GetTransactionOutputTransaction contractAddress(String contractAddress) {
  ...
  public GetTransactionOutputTransaction gasUsed(String gasUsed) {
  ...
  public GetTransactionOutputTransaction cumulativeGasUsed(String cumulativeGasUsed) {
  ...
  public GetTransactionOutputTransaction effectiveGasPrice(String effectiveGasPrice) {
  ...
  public GetTransactionOutputTransaction signatureV(Integer signatureV) {
  ...
  public GetTransactionOutputTransaction signatureR(String signatureR) {
  ...
  public GetTransactionOutputTransaction signatureS(String signatureS) {
  ...
  public GetTransactionOutputTransaction transactionFee(String transactionFee) {
  ...
  public GetTransactionOutputTransaction transactionId(String transactionId) {
  ...
  public boolean equals(Object o) {
    ...
    GetTransactionOutputTransaction getTransactionOutputTransaction = (GetTransactionOutputTransaction) o;
    return Objects.equals(this.network, getTransactionOutputTransaction.network) &&
        Objects.equals(this.blockHash, getTransactionOutputTransaction.blockHash) &&
        Objects.equals(this.transactionHash, getTransactionOutputTransaction.transactionHash) &&
        Objects.equals(this.blockNumber, getTransactionOutputTransaction.blockNumber) &&
        Objects.equals(this.transactionTimestamp, getTransactionOutputTransaction.transactionTimestamp) &&
        Objects.equals(this.transactionIndex, getTransactionOutputTransaction.transactionIndex) &&
        Objects.equals(this.numberOfTransactions, getTransactionOutputTransaction.numberOfTransactions) &&
        Objects.equals(this.status, getTransactionOutputTransaction.status) &&
        Objects.equals(this.to, getTransactionOutputTransaction.to) &&
        Objects.equals(this.from, getTransactionOutputTransaction.from) &&
        Objects.equals(this.contractAddress, getTransactionOutputTransaction.contractAddress) &&
        Objects.equals(this.gasUsed, getTransactionOutputTransaction.gasUsed) &&
        Objects.equals(this.cumulativeGasUsed, getTransactionOutputTransaction.cumulativeGasUsed) &&
        Objects.equals(this.effectiveGasPrice, getTransactionOutputTransaction.effectiveGasPrice) &&
        Objects.equals(this.signatureV, getTransactionOutputTransaction.signatureV) &&
        Objects.equals(this.signatureR, getTransactionOutputTransaction.signatureR) &&
        Objects.equals(this.signatureS, getTransactionOutputTransaction.signatureS) &&
        Objects.equals(this.transactionFee, getTransactionOutputTransaction.transactionFee) &&
        Objects.equals(this.transactionId, getTransactionOutputTransaction.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTransactionOutputTransaction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTransactionOutputTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTransactionOutputTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTransactionOutputTransaction is not found in the empty JSON string", GetTransactionOutputTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTransactionOutputTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTransactionOutputTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTransactionOutputTransaction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTransactionOutputTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTransactionOutputTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTransactionOutputTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTransactionOutputTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTransactionOutputTransaction>() {
           @Override
           public void write(JsonWriter out, GetTransactionOutputTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTransactionOutputTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTransactionOutputTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTransactionOutputTransaction
   * @throws IOException if the JSON string is invalid with respect to GetTransactionOutputTransaction
   */
  public static GetTransactionOutputTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionOutputTransaction.class);
  }

  /**
   * Convert an instance of GetTransactionOutputTransaction to an JSON string
   *
   * @return JSON string
   */
