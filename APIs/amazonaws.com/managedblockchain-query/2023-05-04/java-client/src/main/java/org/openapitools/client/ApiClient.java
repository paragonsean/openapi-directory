...
public class ApiClient {
    ...
    private String basePath = "http://managedblockchain-query.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://managedblockchain-query.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://managedblockchain-query.{region}.amazonaws.com",
      "The Amazon Managed Blockchain Query multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://managedblockchain-query.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://managedblockchain-query.{region}.amazonaws.com.cn",
      "The Amazon Managed Blockchain Query endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2023-05-04/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://managedblockchain-query.us-east-1.amazonaws.com
