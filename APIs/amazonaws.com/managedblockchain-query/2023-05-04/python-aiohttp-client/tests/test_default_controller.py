...
async def test_batch_get_token_balance(client):
    """Test case for batch_get_token_balance

    
    """
    body = openapi_server.BatchGetTokenBalanceRequest()
    headers = { 
...
async def test_get_token_balance(client):
    ...
    """
    body = openapi_server.GetTokenBalanceRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_transaction(client):
    ...
    """
    body = openapi_server.GetTransactionRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_token_balances(client):
    """Test case for list_token_balances

    
    """
    body = openapi_server.ListTokenBalancesRequest()
...
async def test_list_transaction_events(client):
    """Test case for list_transaction_events

    
    """
    body = openapi_server.ListTransactionEventsRequest()
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_transactions(client):
    ...
    """
    body = openapi_server.ListTransactionsRequest()
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
