...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://managedblockchain-query.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://managedblockchain-query.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2023-05-04/Javascript'
        };
