...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceInputItem();
  });
  ...
  describe('BatchGetTokenBalanceInputItem', function() {
    it('should create an instance of BatchGetTokenBalanceInputItem', function() {
      // uncomment below and update the code to test BatchGetTokenBalanceInputItem
      //var instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceInputItem();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.BatchGetTokenBalanceInputItem);
    });
