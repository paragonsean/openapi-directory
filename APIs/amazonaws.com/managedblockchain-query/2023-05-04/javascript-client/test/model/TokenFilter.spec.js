...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.TokenFilter();
  });
  ...
  describe('TokenFilter', function() {
    it('should create an instance of TokenFilter', function() {
      // uncomment below and update the code to test TokenFilter
      //var instance = new AmazonManagedBlockchainQuery.TokenFilter();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.TokenFilter);
    });
