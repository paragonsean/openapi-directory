...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.ListTransactionsSort();
  });
  ...
  describe('ListTransactionsSort', function() {
    it('should create an instance of ListTransactionsSort', function() {
      // uncomment below and update the code to test ListTransactionsSort
      //var instance = new AmazonManagedBlockchainQuery.ListTransactionsSort();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.ListTransactionsSort);
    });
