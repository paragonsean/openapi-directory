...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.ListTransactionsOutput();
  });
  ...
  describe('ListTransactionsOutput', function() {
    it('should create an instance of ListTransactionsOutput', function() {
      // uncomment below and update the code to test ListTransactionsOutput
      //var instance = new AmazonManagedBlockchainQuery.ListTransactionsOutput();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.ListTransactionsOutput);
    });
