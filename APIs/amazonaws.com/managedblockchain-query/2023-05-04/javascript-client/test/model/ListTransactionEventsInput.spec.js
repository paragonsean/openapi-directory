...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.ListTransactionEventsInput();
  });
  ...
  describe('ListTransactionEventsInput', function() {
    it('should create an instance of ListTransactionEventsInput', function() {
      // uncomment below and update the code to test ListTransactionEventsInput
      //var instance = new AmazonManagedBlockchainQuery.ListTransactionEventsInput();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.ListTransactionEventsInput);
    });
