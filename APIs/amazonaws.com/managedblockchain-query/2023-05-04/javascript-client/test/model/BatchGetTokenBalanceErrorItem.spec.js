...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceErrorItem();
  });
  ...
  describe('BatchGetTokenBalanceErrorItem', function() {
    it('should create an instance of BatchGetTokenBalanceErrorItem', function() {
      // uncomment below and update the code to test BatchGetTokenBalanceErrorItem
      //var instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceErrorItem();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.BatchGetTokenBalanceErrorItem);
    });
