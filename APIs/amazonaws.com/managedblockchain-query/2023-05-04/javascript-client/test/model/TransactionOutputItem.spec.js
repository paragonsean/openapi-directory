...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.TransactionOutputItem();
  });
  ...
  describe('TransactionOutputItem', function() {
    it('should create an instance of TransactionOutputItem', function() {
      // uncomment below and update the code to test TransactionOutputItem
      //var instance = new AmazonManagedBlockchainQuery.TransactionOutputItem();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.TransactionOutputItem);
    });
