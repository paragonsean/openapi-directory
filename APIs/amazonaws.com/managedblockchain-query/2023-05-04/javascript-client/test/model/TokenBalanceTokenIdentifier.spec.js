...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.TokenBalanceTokenIdentifier();
  });
  ...
  describe('TokenBalanceTokenIdentifier', function() {
    it('should create an instance of TokenBalanceTokenIdentifier', function() {
      // uncomment below and update the code to test TokenBalanceTokenIdentifier
      //var instance = new AmazonManagedBlockchainQuery.TokenBalanceTokenIdentifier();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.TokenBalanceTokenIdentifier);
    });
