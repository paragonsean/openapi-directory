...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.ListTransactionsInputSort();
  });
  ...
  describe('ListTransactionsInputSort', function() {
    it('should create an instance of ListTransactionsInputSort', function() {
      // uncomment below and update the code to test ListTransactionsInputSort
      //var instance = new AmazonManagedBlockchainQuery.ListTransactionsInputSort();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.ListTransactionsInputSort);
    });
