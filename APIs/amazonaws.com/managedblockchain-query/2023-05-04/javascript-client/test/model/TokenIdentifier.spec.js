...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.TokenIdentifier();
  });
  ...
  describe('TokenIdentifier', function() {
    it('should create an instance of TokenIdentifier', function() {
      // uncomment below and update the code to test TokenIdentifier
      //var instance = new AmazonManagedBlockchainQuery.TokenIdentifier();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.TokenIdentifier);
    });
