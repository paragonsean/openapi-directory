...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.TokenBalance();
  });
  ...
  describe('TokenBalance', function() {
    it('should create an instance of TokenBalance', function() {
      ...
      //var instance = new AmazonManagedBlockchainQuery.TokenBalance();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.TokenBalance);
    });
