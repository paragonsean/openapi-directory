...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.GetTokenBalanceOutput();
  });
  ...
  describe('GetTokenBalanceOutput', function() {
    it('should create an instance of GetTokenBalanceOutput', function() {
      // uncomment below and update the code to test GetTokenBalanceOutput
      //var instance = new AmazonManagedBlockchainQuery.GetTokenBalanceOutput();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.GetTokenBalanceOutput);
    });
