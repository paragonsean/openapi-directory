...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.GetTransactionRequest();
  });
  ...
  describe('GetTransactionRequest', function() {
    it('should create an instance of GetTransactionRequest', function() {
      // uncomment below and update the code to test GetTransactionRequest
      //var instance = new AmazonManagedBlockchainQuery.GetTransactionRequest();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.GetTransactionRequest);
    });
