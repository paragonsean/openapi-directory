...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.ListTransactionEventsRequest();
  });
  ...
  describe('ListTransactionEventsRequest', function() {
    it('should create an instance of ListTransactionEventsRequest', function() {
      // uncomment below and update the code to test ListTransactionEventsRequest
      //var instance = new AmazonManagedBlockchainQuery.ListTransactionEventsRequest();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.ListTransactionEventsRequest);
    });
