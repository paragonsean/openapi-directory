...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceOutputItem();
  });
  ...
  describe('BatchGetTokenBalanceOutputItem', function() {
    it('should create an instance of BatchGetTokenBalanceOutputItem', function() {
      // uncomment below and update the code to test BatchGetTokenBalanceOutputItem
      //var instance = new AmazonManagedBlockchainQuery.BatchGetTokenBalanceOutputItem();
      //expect(instance).to.be.a(AmazonManagedBlockchainQuery.BatchGetTokenBalanceOutputItem);
    });
