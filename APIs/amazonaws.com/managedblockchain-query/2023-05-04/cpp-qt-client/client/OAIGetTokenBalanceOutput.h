...
/*
 * OAIGetTokenBalanceOutput.h
 *
 * 
 */

#ifndef OAIGetTokenBalanceOutput_H
#define OAIGetTokenBalanceOutput_H
...
class OAIGetTokenBalanceOutput : public OAIObject {
public:
    OAIGetTokenBalanceOutput();
    OAIGetTokenBalanceOutput(QString json);
    ~OAIGetTokenBalanceOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTokenBalanceOutput)

#endif // OAIGetTokenBalanceOutput_H
