...
#ifndef OAITokenIdentifier_H
#define OAITokenIdentifier_H
...
class OAITokenIdentifier : public OAIObject {
public:
    OAITokenIdentifier();
    OAITokenIdentifier(QString json);
    ~OAITokenIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenIdentifier)

#endif // OAITokenIdentifier_H
