...
/*
 * OAIBatchGetTokenBalanceErrorItem.h
 *
 * Error generated from a failed &lt;code&gt;BatchGetTokenBalance&lt;/code&gt; request.
 */

#ifndef OAIBatchGetTokenBalanceErrorItem_H
#define OAIBatchGetTokenBalanceErrorItem_H
...
class OAIBatchGetTokenBalanceErrorItem : public OAIObject {
public:
    OAIBatchGetTokenBalanceErrorItem();
    OAIBatchGetTokenBalanceErrorItem(QString json);
    ~OAIBatchGetTokenBalanceErrorItem() override;
    ...
    OAIErrorType getErrorType() const;
    void setErrorType(const OAIErrorType &error_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchGetTokenBalanceErrorItem)

#endif // OAIBatchGetTokenBalanceErrorItem_H
