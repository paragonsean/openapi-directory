...
OAIBatchGetTokenBalanceInputItem::OAIBatchGetTokenBalanceInputItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchGetTokenBalanceInputItem::OAIBatchGetTokenBalanceInputItem() {
    this->initializeModel();
}

OAIBatchGetTokenBalanceInputItem::~OAIBatchGetTokenBalanceInputItem() {}

void OAIBatchGetTokenBalanceInputItem::initializeModel() {
...
void OAIBatchGetTokenBalanceInputItem::fromJson(QString jsonString) {
...
void OAIBatchGetTokenBalanceInputItem::fromJsonObject(QJsonObject json) {
...
QString OAIBatchGetTokenBalanceInputItem::asJson() const {
...
QJsonObject OAIBatchGetTokenBalanceInputItem::asJsonObject() const {
    QJsonObject obj;
...
OAITokenIdentifier OAIBatchGetTokenBalanceInputItem::getTokenIdentifier() const {
    return m_token_identifier;
}
void OAIBatchGetTokenBalanceInputItem::setTokenIdentifier(const OAITokenIdentifier &token_identifier) {
    m_token_identifier = token_identifier;
    m_token_identifier_isSet = true;
}

bool OAIBatchGetTokenBalanceInputItem::is_token_identifier_Set() const{
    return m_token_identifier_isSet;
}

bool OAIBatchGetTokenBalanceInputItem::is_token_identifier_Valid() const{
    return m_token_identifier_isValid;
}

OAIOwnerIdentifier OAIBatchGetTokenBalanceInputItem::getOwnerIdentifier() const {
    return m_owner_identifier;
}
void OAIBatchGetTokenBalanceInputItem::setOwnerIdentifier(const OAIOwnerIdentifier &owner_identifier) {
    m_owner_identifier = owner_identifier;
    m_owner_identifier_isSet = true;
}

bool OAIBatchGetTokenBalanceInputItem::is_owner_identifier_Set() const{
    return m_owner_identifier_isSet;
}

bool OAIBatchGetTokenBalanceInputItem::is_owner_identifier_Valid() const{
    return m_owner_identifier_isValid;
}

OAIBlockchainInstant OAIBatchGetTokenBalanceInputItem::getAtBlockchainInstant() const {
    return m_at_blockchain_instant;
}
void OAIBatchGetTokenBalanceInputItem::setAtBlockchainInstant(const OAIBlockchainInstant &at_blockchain_instant) {
    m_at_blockchain_instant = at_blockchain_instant;
    m_at_blockchain_instant_isSet = true;
}

bool OAIBatchGetTokenBalanceInputItem::is_at_blockchain_instant_Set() const{
    return m_at_blockchain_instant_isSet;
}

bool OAIBatchGetTokenBalanceInputItem::is_at_blockchain_instant_Valid() const{
    return m_at_blockchain_instant_isValid;
}

bool OAIBatchGetTokenBalanceInputItem::isSet() const {
...
bool OAIBatchGetTokenBalanceInputItem::isValid() const {
