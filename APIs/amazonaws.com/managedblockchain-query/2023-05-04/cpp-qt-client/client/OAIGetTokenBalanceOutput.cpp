...
OAIGetTokenBalanceOutput::OAIGetTokenBalanceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTokenBalanceOutput::OAIGetTokenBalanceOutput() {
    this->initializeModel();
}

OAIGetTokenBalanceOutput::~OAIGetTokenBalanceOutput() {}

void OAIGetTokenBalanceOutput::initializeModel() {
...
void OAIGetTokenBalanceOutput::fromJson(QString jsonString) {
...
void OAIGetTokenBalanceOutput::fromJsonObject(QJsonObject json) {
...
QString OAIGetTokenBalanceOutput::asJson() const {
...
QJsonObject OAIGetTokenBalanceOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIOwnerIdentifier OAIGetTokenBalanceOutput::getOwnerIdentifier() const {
    return m_owner_identifier;
}
void OAIGetTokenBalanceOutput::setOwnerIdentifier(const OAIOwnerIdentifier &owner_identifier) {
    m_owner_identifier = owner_identifier;
    m_owner_identifier_isSet = true;
}

bool OAIGetTokenBalanceOutput::is_owner_identifier_Set() const{
    return m_owner_identifier_isSet;
}

bool OAIGetTokenBalanceOutput::is_owner_identifier_Valid() const{
    return m_owner_identifier_isValid;
}

OAITokenIdentifier OAIGetTokenBalanceOutput::getTokenIdentifier() const {
    return m_token_identifier;
}
void OAIGetTokenBalanceOutput::setTokenIdentifier(const OAITokenIdentifier &token_identifier) {
    m_token_identifier = token_identifier;
    m_token_identifier_isSet = true;
}

bool OAIGetTokenBalanceOutput::is_token_identifier_Set() const{
    return m_token_identifier_isSet;
}

bool OAIGetTokenBalanceOutput::is_token_identifier_Valid() const{
    return m_token_identifier_isValid;
}

QString OAIGetTokenBalanceOutput::getBalance() const {
    return m_balance;
}
void OAIGetTokenBalanceOutput::setBalance(const QString &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIGetTokenBalanceOutput::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIGetTokenBalanceOutput::is_balance_Valid() const{
    return m_balance_isValid;
}

OAIBlockchainInstant OAIGetTokenBalanceOutput::getAtBlockchainInstant() const {
    return m_at_blockchain_instant;
}
void OAIGetTokenBalanceOutput::setAtBlockchainInstant(const OAIBlockchainInstant &at_blockchain_instant) {
    m_at_blockchain_instant = at_blockchain_instant;
    m_at_blockchain_instant_isSet = true;
}

bool OAIGetTokenBalanceOutput::is_at_blockchain_instant_Set() const{
    return m_at_blockchain_instant_isSet;
}

bool OAIGetTokenBalanceOutput::is_at_blockchain_instant_Valid() const{
    return m_at_blockchain_instant_isValid;
}

OAIBlockchainInstant OAIGetTokenBalanceOutput::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIGetTokenBalanceOutput::setLastUpdatedTime(const OAIBlockchainInstant &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIGetTokenBalanceOutput::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIGetTokenBalanceOutput::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

bool OAIGetTokenBalanceOutput::isSet() const {
...
bool OAIGetTokenBalanceOutput::isValid() const {
