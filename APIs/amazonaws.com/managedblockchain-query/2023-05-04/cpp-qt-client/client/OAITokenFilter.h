...
#ifndef OAITokenFilter_H
#define OAITokenFilter_H
...
class OAITokenFilter : public OAIObject {
public:
    OAITokenFilter();
    OAITokenFilter(QString json);
    ~OAITokenFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenFilter)

#endif // OAITokenFilter_H
