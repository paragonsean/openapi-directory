...
/*
 * OAITokenBalance_tokenIdentifier.h
 *
 * 
 */

#ifndef OAITokenBalance_tokenIdentifier_H
#define OAITokenBalance_tokenIdentifier_H
...
class OAITokenBalance_tokenIdentifier : public OAIObject {
public:
    OAITokenBalance_tokenIdentifier();
    OAITokenBalance_tokenIdentifier(QString json);
    ~OAITokenBalance_tokenIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenBalance_tokenIdentifier)

#endif // OAITokenBalance_tokenIdentifier_H
