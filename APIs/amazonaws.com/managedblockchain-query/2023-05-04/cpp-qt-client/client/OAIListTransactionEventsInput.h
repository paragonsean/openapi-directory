...
/*
 * OAIListTransactionEventsInput.h
 *
 * 
 */

#ifndef OAIListTransactionEventsInput_H
#define OAIListTransactionEventsInput_H
...
class OAIListTransactionEventsInput : public OAIObject {
public:
    OAIListTransactionEventsInput();
    OAIListTransactionEventsInput(QString json);
    ~OAIListTransactionEventsInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTransactionEventsInput)

#endif // OAIListTransactionEventsInput_H
