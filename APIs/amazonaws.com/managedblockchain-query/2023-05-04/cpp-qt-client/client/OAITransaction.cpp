...
OAIQueryNetwork OAITransaction::getNetwork() const {
    return m_network;
}
void OAITransaction::setNetwork(const OAIQueryNetwork &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAITransaction::is_network_Set() const{
    return m_network_isSet;
}

bool OAITransaction::is_network_Valid() const{
    return m_network_isValid;
}

QString OAITransaction::getBlockHash() const {
    return m_block_hash;
}
void OAITransaction::setBlockHash(const QString &block_hash) {
    m_block_hash = block_hash;
    m_block_hash_isSet = true;
}

bool OAITransaction::is_block_hash_Set() const{
    return m_block_hash_isSet;
}

bool OAITransaction::is_block_hash_Valid() const{
    return m_block_hash_isValid;
}

QString OAITransaction::getTransactionHash() const {
    return m_transaction_hash;
}
void OAITransaction::setTransactionHash(const QString &transaction_hash) {
    m_transaction_hash = transaction_hash;
    m_transaction_hash_isSet = true;
}

bool OAITransaction::is_transaction_hash_Set() const{
    return m_transaction_hash_isSet;
}

bool OAITransaction::is_transaction_hash_Valid() const{
...
QDateTime OAITransaction::getTransactionTimestamp() const {
    return m_transaction_timestamp;
}
void OAITransaction::setTransactionTimestamp(const QDateTime &transaction_timestamp) {
    m_transaction_timestamp = transaction_timestamp;
    m_transaction_timestamp_isSet = true;
}

bool OAITransaction::is_transaction_timestamp_Set() const{
    return m_transaction_timestamp_isSet;
}

bool OAITransaction::is_transaction_timestamp_Valid() const{
    return m_transaction_timestamp_isValid;
}

qint32 OAITransaction::getTransactionIndex() const {
    return m_transaction_index;
}
void OAITransaction::setTransactionIndex(const qint32 &transaction_index) {
    m_transaction_index = transaction_index;
    m_transaction_index_isSet = true;
}

bool OAITransaction::is_transaction_index_Set() const{
    return m_transaction_index_isSet;
}

bool OAITransaction::is_transaction_index_Valid() const{
    return m_transaction_index_isValid;
}

qint32 OAITransaction::getNumberOfTransactions() const {
    return m_number_of_transactions;
}
void OAITransaction::setNumberOfTransactions(const qint32 &number_of_transactions) {
    m_number_of_transactions = number_of_transactions;
    m_number_of_transactions_isSet = true;
}

bool OAITransaction::is_number_of_transactions_Set() const{
    return m_number_of_transactions_isSet;
}

bool OAITransaction::is_number_of_transactions_Valid() const{
    return m_number_of_transactions_isValid;
}

OAIQueryTransactionStatus OAITransaction::getStatus() const {
    return m_status;
}
void OAITransaction::setStatus(const OAIQueryTransactionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QString OAITransaction::getGasUsed() const {
    return m_gas_used;
}
void OAITransaction::setGasUsed(const QString &gas_used) {
    m_gas_used = gas_used;
    m_gas_used_isSet = true;
}

bool OAITransaction::is_gas_used_Set() const{
    return m_gas_used_isSet;
}

bool OAITransaction::is_gas_used_Valid() const{
    return m_gas_used_isValid;
}

QString OAITransaction::getCumulativeGasUsed() const {
    return m_cumulative_gas_used;
}
void OAITransaction::setCumulativeGasUsed(const QString &cumulative_gas_used) {
    m_cumulative_gas_used = cumulative_gas_used;
    m_cumulative_gas_used_isSet = true;
}

bool OAITransaction::is_cumulative_gas_used_Set() const{
    return m_cumulative_gas_used_isSet;
}

bool OAITransaction::is_cumulative_gas_used_Valid() const{
    return m_cumulative_gas_used_isValid;
}

QString OAITransaction::getEffectiveGasPrice() const {
    return m_effective_gas_price;
}
void OAITransaction::setEffectiveGasPrice(const QString &effective_gas_price) {
    m_effective_gas_price = effective_gas_price;
    m_effective_gas_price_isSet = true;
}

bool OAITransaction::is_effective_gas_price_Set() const{
    return m_effective_gas_price_isSet;
}

bool OAITransaction::is_effective_gas_price_Valid() const{
    return m_effective_gas_price_isValid;
}

qint32 OAITransaction::getSignatureV() const {
    return m_signature_v;
}
void OAITransaction::setSignatureV(const qint32 &signature_v) {
    m_signature_v = signature_v;
    m_signature_v_isSet = true;
}

bool OAITransaction::is_signature_v_Set() const{
    return m_signature_v_isSet;
}

bool OAITransaction::is_signature_v_Valid() const{
    return m_signature_v_isValid;
}

QString OAITransaction::getSignatureR() const {
    return m_signature_r;
}
void OAITransaction::setSignatureR(const QString &signature_r) {
    m_signature_r = signature_r;
    m_signature_r_isSet = true;
}

bool OAITransaction::is_signature_r_Set() const{
    return m_signature_r_isSet;
}

bool OAITransaction::is_signature_r_Valid() const{
    return m_signature_r_isValid;
}

QString OAITransaction::getSignatureS() const {
    return m_signature_s;
}
void OAITransaction::setSignatureS(const QString &signature_s) {
    m_signature_s = signature_s;
    m_signature_s_isSet = true;
}

bool OAITransaction::is_signature_s_Set() const{
    return m_signature_s_isSet;
}

bool OAITransaction::is_signature_s_Valid() const{
    return m_signature_s_isValid;
}

QString OAITransaction::getTransactionFee() const {
    return m_transaction_fee;
}
void OAITransaction::setTransactionFee(const QString &transaction_fee) {
    m_transaction_fee = transaction_fee;
    m_transaction_fee_isSet = true;
}

bool OAITransaction::is_transaction_fee_Set() const{
    return m_transaction_fee_isSet;
}

bool OAITransaction::is_transaction_fee_Valid() const{
