...
public class DescribeProgramResponse {
  ...
  public DescribeProgramResponse() {
  }

  public DescribeProgramResponse adBreaks(List adBreaks) {
  ...
  public DescribeProgramResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeProgramResponse channelName(String channelName) {
  ...
  public DescribeProgramResponse clipRange(CreateProgramResponseClipRange clipRange) {
  ...
  public DescribeProgramResponse creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeProgramResponse durationMillis(Integer durationMillis) {
  ...
  public DescribeProgramResponse liveSourceName(String liveSourceName) {
  ...
  public DescribeProgramResponse programName(String programName) {
  ...
  public DescribeProgramResponse scheduledStartTime(OffsetDateTime scheduledStartTime) {
  ...
  public DescribeProgramResponse sourceLocationName(String sourceLocationName) {
  ...
  public DescribeProgramResponse vodSourceName(String vodSourceName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeProgramResponse describeProgramResponse = (DescribeProgramResponse) o;
    return Objects.equals(this.adBreaks, describeProgramResponse.adBreaks) &&
        Objects.equals(this.arn, describeProgramResponse.arn) &&
        Objects.equals(this.channelName, describeProgramResponse.channelName) &&
        Objects.equals(this.clipRange, describeProgramResponse.clipRange) &&
        Objects.equals(this.creationTime, describeProgramResponse.creationTime) &&
        Objects.equals(this.durationMillis, describeProgramResponse.durationMillis) &&
        Objects.equals(this.liveSourceName, describeProgramResponse.liveSourceName) &&
        Objects.equals(this.programName, describeProgramResponse.programName) &&
        Objects.equals(this.scheduledStartTime, describeProgramResponse.scheduledStartTime) &&
        Objects.equals(this.sourceLocationName, describeProgramResponse.sourceLocationName) &&
        Objects.equals(this.vodSourceName, describeProgramResponse.vodSourceName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeProgramResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeProgramResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeProgramResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeProgramResponse is not found in the empty JSON string", DescribeProgramResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeProgramResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeProgramResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeProgramResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeProgramResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeProgramResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeProgramResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeProgramResponse>() {
           @Override
           public void write(JsonWriter out, DescribeProgramResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeProgramResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeProgramResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeProgramResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeProgramResponse
   */
  public static DescribeProgramResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeProgramResponse.class);
  }

  /**
   * Convert an instance of DescribeProgramResponse to an JSON string
   *
   * @return JSON string
   */
