...
public class ApiClient {
    ...
    private String basePath = "http://api.mediatailor.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "http://api.mediatailor.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://api.mediatailor.{region}.amazonaws.com.cn",
      "The MediaTailor endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-04-23/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.mediatailor.us-east-1.amazonaws.com
