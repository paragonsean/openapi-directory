...
public class CreateSourceLocationRequest {
  ...
  public CreateSourceLocationRequest() {
  }

  public CreateSourceLocationRequest accessConfiguration(UpdateSourceLocationRequestAccessConfiguration accessConfiguration) {
  ...
  public CreateSourceLocationRequest defaultSegmentDeliveryConfiguration(UpdateSourceLocationRequestDefaultSegmentDeliveryConfiguration defaultSegmentDeliveryConfiguration) {
  ...
  public CreateSourceLocationRequest httpConfiguration(UpdateSourceLocationRequestHttpConfiguration httpConfiguration) {
  ...
  public CreateSourceLocationRequest segmentDeliveryConfigurations(List<SegmentDeliveryConfiguration> segmentDeliveryConfigurations) {
    this.segmentDeliveryConfigurations = segmentDeliveryConfigurations;
    return this;
  }

  public CreateSourceLocationRequest addSegmentDeliveryConfigurationsItem(SegmentDeliveryConfiguration segmentDeliveryConfigurationsItem) {
  ...
  public CreateSourceLocationRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateSourceLocationRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSourceLocationRequest createSourceLocationRequest = (CreateSourceLocationRequest) o;
    return Objects.equals(this.accessConfiguration, createSourceLocationRequest.accessConfiguration) &&
        Objects.equals(this.defaultSegmentDeliveryConfiguration, createSourceLocationRequest.defaultSegmentDeliveryConfiguration) &&
        Objects.equals(this.httpConfiguration, createSourceLocationRequest.httpConfiguration) &&
        Objects.equals(this.segmentDeliveryConfigurations, createSourceLocationRequest.segmentDeliveryConfigurations) &&
        Objects.equals(this.tags, createSourceLocationRequest.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessConfiguration, defaultSegmentDeliveryConfiguration, httpConfiguration, segmentDeliveryConfigurations, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateSourceLocationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSourceLocationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSourceLocationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSourceLocationRequest is not found in the empty JSON string", CreateSourceLocationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSourceLocationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSourceLocationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSourceLocationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSourceLocationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSourceLocationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSourceLocationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSourceLocationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSourceLocationRequest>() {
           @Override
           public void write(JsonWriter out, CreateSourceLocationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSourceLocationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSourceLocationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSourceLocationRequest
   * @throws IOException if the JSON string is invalid with respect to CreateSourceLocationRequest
   */
  public static CreateSourceLocationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSourceLocationRequest.class);
  }

  /**
   * Convert an instance of CreateSourceLocationRequest to an JSON string
   *
   * @return JSON string
   */
