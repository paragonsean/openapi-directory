...
public class CreateProgramResponse {
  ...
  public CreateProgramResponse adBreaks(List adBreaks) {
  ...
  public CreateProgramResponse arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateProgramResponse channelName(String channelName) {
  ...
  public CreateProgramResponse clipRange(CreateProgramResponseClipRange clipRange) {
  ...
  public CreateProgramResponse creationTime(OffsetDateTime creationTime) {
  ...
  public CreateProgramResponse durationMillis(Integer durationMillis) {
  ...
  public CreateProgramResponse liveSourceName(String liveSourceName) {
  ...
  public CreateProgramResponse programName(String programName) {
  ...
  public CreateProgramResponse scheduledStartTime(OffsetDateTime scheduledStartTime) {
  ...
  public CreateProgramResponse sourceLocationName(String sourceLocationName) {
  ...
  public CreateProgramResponse vodSourceName(String vodSourceName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adBreaks, createProgramResponse.adBreaks) &&
        Objects.equals(this.arn, createProgramResponse.arn) &&
        Objects.equals(this.channelName, createProgramResponse.channelName) &&
        Objects.equals(this.clipRange, createProgramResponse.clipRange) &&
        Objects.equals(this.creationTime, createProgramResponse.creationTime) &&
        Objects.equals(this.durationMillis, createProgramResponse.durationMillis) &&
        Objects.equals(this.liveSourceName, createProgramResponse.liveSourceName) &&
        Objects.equals(this.programName, createProgramResponse.programName) &&
        Objects.equals(this.scheduledStartTime, createProgramResponse.scheduledStartTime) &&
        Objects.equals(this.sourceLocationName, createProgramResponse.sourceLocationName) &&
        Objects.equals(this.vodSourceName, createProgramResponse.vodSourceName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProgramResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProgramResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProgramResponse is not found in the empty JSON string", CreateProgramResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProgramResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProgramResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProgramResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProgramResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProgramResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProgramResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProgramResponse>() {
           @Override
           public void write(JsonWriter out, CreateProgramResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProgramResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProgramResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProgramResponse
   * @throws IOException if the JSON string is invalid with respect to CreateProgramResponse
   */
  public static CreateProgramResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProgramResponse.class);
  }

  /**
   * Convert an instance of CreateProgramResponse to an JSON string
   *
   * @return JSON string
   */
