...
public class PlaybackConfiguration {
  ...
  private PlaybackConfigurationDashConfiguration dashConfiguration;
  ...
  public PlaybackConfiguration adDecisionServerUrl(String adDecisionServerUrl) {
  ...
  public PlaybackConfiguration availSuppression(GetPlaybackConfigurationResponseAvailSuppression availSuppression) {
  ...
  public PlaybackConfiguration bumper(GetPlaybackConfigurationResponseBumper bumper) {
    this.bumper = bumper;
    return this;
  }
  ...
  public PlaybackConfiguration cdnConfiguration(GetPlaybackConfigurationResponseCdnConfiguration cdnConfiguration) {
  ...
  public PlaybackConfiguration configurationAliases(Map configurationAliases) {
  ...
  public PlaybackConfiguration dashConfiguration(PlaybackConfigurationDashConfiguration dashConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public PlaybackConfigurationDashConfiguration getDashConfiguration() {
    return dashConfiguration;
  }

  public void setDashConfiguration(PlaybackConfigurationDashConfiguration dashConfiguration) {
    this.dashConfiguration = dashConfiguration;
  }


  public PlaybackConfiguration hlsConfiguration(GetPlaybackConfigurationResponseHlsConfiguration hlsConfiguration) {
  ...
  public PlaybackConfiguration livePreRollConfiguration(GetPlaybackConfigurationResponseLivePreRollConfiguration livePreRollConfiguration) {
  ...
  public PlaybackConfiguration logConfiguration(GetPlaybackConfigurationResponseLogConfiguration logConfiguration) {
  ...
  public PlaybackConfiguration manifestProcessingRules(GetPlaybackConfigurationResponseManifestProcessingRules manifestProcessingRules) {
  ...
  public PlaybackConfiguration name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PlaybackConfiguration personalizationThresholdSeconds(Integer personalizationThresholdSeconds) {
  ...
  public PlaybackConfiguration playbackConfigurationArn(String playbackConfigurationArn) {
  ...
  public PlaybackConfiguration playbackEndpointPrefix(String playbackEndpointPrefix) {
  ...
  public PlaybackConfiguration sessionInitializationEndpointPrefix(String sessionInitializationEndpointPrefix) {
  ...
  public PlaybackConfiguration slateAdUrl(String slateAdUrl) {
  ...
  public PlaybackConfiguration tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public PlaybackConfiguration transcodeProfileName(String transcodeProfileName) {
  ...
  public PlaybackConfiguration videoContentSourceUrl(String videoContentSourceUrl) {
  ...
  public boolean equals(Object o) {
    ...
    PlaybackConfiguration playbackConfiguration = (PlaybackConfiguration) o;
    return Objects.equals(this.adDecisionServerUrl, playbackConfiguration.adDecisionServerUrl) &&
        Objects.equals(this.availSuppression, playbackConfiguration.availSuppression) &&
        Objects.equals(this.bumper, playbackConfiguration.bumper) &&
        Objects.equals(this.cdnConfiguration, playbackConfiguration.cdnConfiguration) &&
        Objects.equals(this.configurationAliases, playbackConfiguration.configurationAliases) &&
        Objects.equals(this.dashConfiguration, playbackConfiguration.dashConfiguration) &&
        Objects.equals(this.hlsConfiguration, playbackConfiguration.hlsConfiguration) &&
        Objects.equals(this.livePreRollConfiguration, playbackConfiguration.livePreRollConfiguration) &&
        Objects.equals(this.logConfiguration, playbackConfiguration.logConfiguration) &&
        Objects.equals(this.manifestProcessingRules, playbackConfiguration.manifestProcessingRules) &&
        Objects.equals(this.name, playbackConfiguration.name) &&
        Objects.equals(this.personalizationThresholdSeconds, playbackConfiguration.personalizationThresholdSeconds) &&
        Objects.equals(this.playbackConfigurationArn, playbackConfiguration.playbackConfigurationArn) &&
        Objects.equals(this.playbackEndpointPrefix, playbackConfiguration.playbackEndpointPrefix) &&
        Objects.equals(this.sessionInitializationEndpointPrefix, playbackConfiguration.sessionInitializationEndpointPrefix) &&
        Objects.equals(this.slateAdUrl, playbackConfiguration.slateAdUrl) &&
        Objects.equals(this.tags, playbackConfiguration.tags) &&
        Objects.equals(this.transcodeProfileName, playbackConfiguration.transcodeProfileName) &&
        Objects.equals(this.videoContentSourceUrl, playbackConfiguration.videoContentSourceUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlaybackConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaybackConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaybackConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaybackConfiguration is not found in the empty JSON string", PlaybackConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaybackConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaybackConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("DashConfiguration") != null && !jsonObj.get("DashConfiguration").isJsonNull()) {
        PlaybackConfigurationDashConfiguration.validateJsonElement(jsonObj.get("DashConfiguration"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaybackConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaybackConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaybackConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaybackConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaybackConfiguration>() {
           @Override
           public void write(JsonWriter out, PlaybackConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaybackConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaybackConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaybackConfiguration
   * @throws IOException if the JSON string is invalid with respect to PlaybackConfiguration
   */
  public static PlaybackConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaybackConfiguration.class);
  }

  /**
   * Convert an instance of PlaybackConfiguration to an JSON string
   *
   * @return JSON string
   */
