...
public class GetPlaybackConfigurationResponse {
  ...
  public GetPlaybackConfigurationResponse() {
  }

  public GetPlaybackConfigurationResponse adDecisionServerUrl(String adDecisionServerUrl) {
  ...
  public GetPlaybackConfigurationResponse availSuppression(GetPlaybackConfigurationResponseAvailSuppression availSuppression) {
  ...
  public GetPlaybackConfigurationResponse bumper(GetPlaybackConfigurationResponseBumper bumper) {
    this.bumper = bumper;
    return this;
  }
  ...
  public GetPlaybackConfigurationResponse cdnConfiguration(GetPlaybackConfigurationResponseCdnConfiguration cdnConfiguration) {
  ...
  public GetPlaybackConfigurationResponse configurationAliases(Map configurationAliases) {
  ...
  public GetPlaybackConfigurationResponse dashConfiguration(GetPlaybackConfigurationResponseDashConfiguration dashConfiguration) {
  ...
  public GetPlaybackConfigurationResponse hlsConfiguration(GetPlaybackConfigurationResponseHlsConfiguration hlsConfiguration) {
  ...
  public GetPlaybackConfigurationResponse livePreRollConfiguration(GetPlaybackConfigurationResponseLivePreRollConfiguration livePreRollConfiguration) {
  ...
  public GetPlaybackConfigurationResponse logConfiguration(GetPlaybackConfigurationResponseLogConfiguration logConfiguration) {
  ...
  public GetPlaybackConfigurationResponse manifestProcessingRules(GetPlaybackConfigurationResponseManifestProcessingRules manifestProcessingRules) {
  ...
  public GetPlaybackConfigurationResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetPlaybackConfigurationResponse personalizationThresholdSeconds(Integer personalizationThresholdSeconds) {
  ...
  public GetPlaybackConfigurationResponse playbackConfigurationArn(String playbackConfigurationArn) {
  ...
  public GetPlaybackConfigurationResponse playbackEndpointPrefix(String playbackEndpointPrefix) {
  ...
  public GetPlaybackConfigurationResponse sessionInitializationEndpointPrefix(String sessionInitializationEndpointPrefix) {
  ...
  public GetPlaybackConfigurationResponse slateAdUrl(String slateAdUrl) {
  ...
  public GetPlaybackConfigurationResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetPlaybackConfigurationResponse transcodeProfileName(String transcodeProfileName) {
  ...
  public GetPlaybackConfigurationResponse videoContentSourceUrl(String videoContentSourceUrl) {
  ...
  public boolean equals(Object o) {
    ...
    GetPlaybackConfigurationResponse getPlaybackConfigurationResponse = (GetPlaybackConfigurationResponse) o;
    return Objects.equals(this.adDecisionServerUrl, getPlaybackConfigurationResponse.adDecisionServerUrl) &&
        Objects.equals(this.availSuppression, getPlaybackConfigurationResponse.availSuppression) &&
        Objects.equals(this.bumper, getPlaybackConfigurationResponse.bumper) &&
        Objects.equals(this.cdnConfiguration, getPlaybackConfigurationResponse.cdnConfiguration) &&
        Objects.equals(this.configurationAliases, getPlaybackConfigurationResponse.configurationAliases) &&
        Objects.equals(this.dashConfiguration, getPlaybackConfigurationResponse.dashConfiguration) &&
        Objects.equals(this.hlsConfiguration, getPlaybackConfigurationResponse.hlsConfiguration) &&
        Objects.equals(this.livePreRollConfiguration, getPlaybackConfigurationResponse.livePreRollConfiguration) &&
        Objects.equals(this.logConfiguration, getPlaybackConfigurationResponse.logConfiguration) &&
        Objects.equals(this.manifestProcessingRules, getPlaybackConfigurationResponse.manifestProcessingRules) &&
        Objects.equals(this.name, getPlaybackConfigurationResponse.name) &&
        Objects.equals(this.personalizationThresholdSeconds, getPlaybackConfigurationResponse.personalizationThresholdSeconds) &&
        Objects.equals(this.playbackConfigurationArn, getPlaybackConfigurationResponse.playbackConfigurationArn) &&
        Objects.equals(this.playbackEndpointPrefix, getPlaybackConfigurationResponse.playbackEndpointPrefix) &&
        Objects.equals(this.sessionInitializationEndpointPrefix, getPlaybackConfigurationResponse.sessionInitializationEndpointPrefix) &&
        Objects.equals(this.slateAdUrl, getPlaybackConfigurationResponse.slateAdUrl) &&
        Objects.equals(this.tags, getPlaybackConfigurationResponse.tags) &&
        Objects.equals(this.transcodeProfileName, getPlaybackConfigurationResponse.transcodeProfileName) &&
        Objects.equals(this.videoContentSourceUrl, getPlaybackConfigurationResponse.videoContentSourceUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPlaybackConfigurationResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPlaybackConfigurationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPlaybackConfigurationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPlaybackConfigurationResponse is not found in the empty JSON string", GetPlaybackConfigurationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPlaybackConfigurationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPlaybackConfigurationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPlaybackConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPlaybackConfigurationResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPlaybackConfigurationResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPlaybackConfigurationResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPlaybackConfigurationResponse>() {
           @Override
           public void write(JsonWriter out, GetPlaybackConfigurationResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPlaybackConfigurationResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPlaybackConfigurationResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPlaybackConfigurationResponse
   * @throws IOException if the JSON string is invalid with respect to GetPlaybackConfigurationResponse
   */
  public static GetPlaybackConfigurationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPlaybackConfigurationResponse.class);
  }

  /**
   * Convert an instance of GetPlaybackConfigurationResponse to an JSON string
   *
   * @return JSON string
   */
