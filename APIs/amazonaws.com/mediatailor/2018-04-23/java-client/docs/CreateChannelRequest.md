...
|**outputs** | [**List&lt;RequestOutputItem&gt;**](RequestOutputItem.md) | An object that represents an object in the CreateChannel request. |  |
...
|**tags** | **Map&lt;String, String&gt;** | The tags to assign to the channel. Tags are key-value pairs that you can associate with Amazon resources to help with organization, access control, and cost tracking. For more information, see &lt;a href&#x3D;\&quot;https://docs.aws.amazon.com/mediatailor/latest/ug/tagging.html\&quot;&gt;Tagging AWS Elemental MediaTailor Resources&lt;/a&gt;. |  [optional] |
|**tier** | [**TierEnum**](#TierEnum) | The tier of the channel. |  [optional] |
