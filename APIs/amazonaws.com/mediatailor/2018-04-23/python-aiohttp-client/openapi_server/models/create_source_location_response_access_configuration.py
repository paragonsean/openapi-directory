...
class CreateSourceLocationResponseAccessConfiguration(Model):
    ...
    def __init__(self, access_type: AccessType=None, secrets_manager_access_token_configuration: UpdateSourceLocationRequestAccessConfigurationSecretsManagerAccessTokenConfiguration=None):
        """CreateSourceLocationResponseAccessConfiguration - a model defined in OpenAPI

        :param access_type: The access_type of this CreateSourceLocationResponseAccessConfiguration.
        :param secrets_manager_access_token_configuration: The secrets_manager_access_token_configuration of this CreateSourceLocationResponseAccessConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateSourceLocationResponseAccessConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateSourceLocationResponse_AccessConfiguration of this CreateSourceLocationResponseAccessConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def access_type(self):
        """Gets the access_type of this CreateSourceLocationResponseAccessConfiguration.


        :return: The access_type of this CreateSourceLocationResponseAccessConfiguration.
        :rtype: AccessType
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this CreateSourceLocationResponseAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self):
        """Gets the secrets_manager_access_token_configuration of this CreateSourceLocationResponseAccessConfiguration.


        :return: The secrets_manager_access_token_configuration of this CreateSourceLocationResponseAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self, secrets_manager_access_token_configuration):
        """Sets the secrets_manager_access_token_configuration of this CreateSourceLocationResponseAccessConfiguration.
