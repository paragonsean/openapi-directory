...
class UpdateSourceLocationRequestAccessConfiguration(Model):
    ...
    def __init__(self, access_type: AccessType=None, secrets_manager_access_token_configuration: UpdateSourceLocationRequestAccessConfigurationSecretsManagerAccessTokenConfiguration=None):
        """UpdateSourceLocationRequestAccessConfiguration - a model defined in OpenAPI

        :param access_type: The access_type of this UpdateSourceLocationRequestAccessConfiguration.
        :param secrets_manager_access_token_configuration: The secrets_manager_access_token_configuration of this UpdateSourceLocationRequestAccessConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSourceLocationRequestAccessConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSourceLocation_request_AccessConfiguration of this UpdateSourceLocationRequestAccessConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def access_type(self):
        """Gets the access_type of this UpdateSourceLocationRequestAccessConfiguration.


        :return: The access_type of this UpdateSourceLocationRequestAccessConfiguration.
        :rtype: AccessType
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this UpdateSourceLocationRequestAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self):
        """Gets the secrets_manager_access_token_configuration of this UpdateSourceLocationRequestAccessConfiguration.


        :return: The secrets_manager_access_token_configuration of this UpdateSourceLocationRequestAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self, secrets_manager_access_token_configuration):
        """Sets the secrets_manager_access_token_configuration of this UpdateSourceLocationRequestAccessConfiguration.
