...
class DescribeSourceLocationResponseAccessConfiguration(Model):
    ...
    def __init__(self, access_type: AccessType=None, secrets_manager_access_token_configuration: UpdateSourceLocationRequestAccessConfigurationSecretsManagerAccessTokenConfiguration=None):
        """DescribeSourceLocationResponseAccessConfiguration - a model defined in OpenAPI

        :param access_type: The access_type of this DescribeSourceLocationResponseAccessConfiguration.
        :param secrets_manager_access_token_configuration: The secrets_manager_access_token_configuration of this DescribeSourceLocationResponseAccessConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeSourceLocationResponseAccessConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeSourceLocationResponse_AccessConfiguration of this DescribeSourceLocationResponseAccessConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def access_type(self):
        """Gets the access_type of this DescribeSourceLocationResponseAccessConfiguration.


        :return: The access_type of this DescribeSourceLocationResponseAccessConfiguration.
        :rtype: AccessType
        """
    ...
    def access_type(self, access_type):
        """Sets the access_type of this DescribeSourceLocationResponseAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self):
        """Gets the secrets_manager_access_token_configuration of this DescribeSourceLocationResponseAccessConfiguration.


        :return: The secrets_manager_access_token_configuration of this DescribeSourceLocationResponseAccessConfiguration.
    ...
    def secrets_manager_access_token_configuration(self, secrets_manager_access_token_configuration):
        """Sets the secrets_manager_access_token_configuration of this DescribeSourceLocationResponseAccessConfiguration.
