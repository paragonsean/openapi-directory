...
/*
 * OAIAccessConfiguration.h
 *
 * Access configuration parameters.
 */

#ifndef OAIAccessConfiguration_H
#define OAIAccessConfiguration_H
...
class OAIAccessConfiguration : public OAIObject {
public:
    OAIAccessConfiguration();
    OAIAccessConfiguration(QString json);
    ~OAIAccessConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessConfiguration)

#endif // OAIAccessConfiguration_H
