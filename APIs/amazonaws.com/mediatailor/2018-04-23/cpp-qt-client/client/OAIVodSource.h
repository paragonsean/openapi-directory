...
#ifndef OAIVodSource_H
#define OAIVodSource_H
...
class OAIVodSource : public OAIObject {
public:
    OAIVodSource();
    OAIVodSource(QString json);
    ~OAIVodSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVodSource)

#endif // OAIVodSource_H
