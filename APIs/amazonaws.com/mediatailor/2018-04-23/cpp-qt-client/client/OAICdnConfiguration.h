...
/*
 * OAICdnConfiguration.h
 *
 * The configuration for using a content delivery network (CDN), like Amazon CloudFront, for content and ad segment management.
 */

#ifndef OAICdnConfiguration_H
#define OAICdnConfiguration_H
...
class OAICdnConfiguration : public OAIObject {
public:
    OAICdnConfiguration();
    OAICdnConfiguration(QString json);
    ~OAICdnConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICdnConfiguration)

#endif // OAICdnConfiguration_H
