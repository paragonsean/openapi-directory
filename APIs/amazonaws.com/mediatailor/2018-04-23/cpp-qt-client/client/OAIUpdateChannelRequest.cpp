...
OAIUpdateChannelResponse_FillerSlate OAIUpdateChannelRequest::getFillerSlate() const {
    return m_filler_slate;
}
void OAIUpdateChannelRequest::setFillerSlate(const OAIUpdateChannelResponse_FillerSlate &filler_slate) {
    m_filler_slate = filler_slate;
    m_filler_slate_isSet = true;
}

bool OAIUpdateChannelRequest::is_filler_slate_Set() const{
    return m_filler_slate_isSet;
}

bool OAIUpdateChannelRequest::is_filler_slate_Valid() const{
    return m_filler_slate_isValid;
}

QList OAIUpdateChannelRequest::getOutputs() const {
    return m_outputs;
}
void OAIUpdateChannelRequest::setOutputs(const QList &outputs) {
    m_outputs = outputs;
    m_outputs_isSet = true;
}

bool OAIUpdateChannelRequest::is_outputs_Set() const{
    return m_outputs_isSet;
}

bool OAIUpdateChannelRequest::is_outputs_Valid() const{
