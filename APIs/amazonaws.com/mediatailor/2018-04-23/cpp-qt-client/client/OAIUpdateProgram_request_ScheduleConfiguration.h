...
/*
 * OAIUpdateProgram_request_ScheduleConfiguration.h
 *
 * Schedule configuration parameters.
 */

#ifndef OAIUpdateProgram_request_ScheduleConfiguration_H
#define OAIUpdateProgram_request_ScheduleConfiguration_H
...
class OAIUpdateProgram_request_ScheduleConfiguration : public OAIObject {
public:
    OAIUpdateProgram_request_ScheduleConfiguration();
    OAIUpdateProgram_request_ScheduleConfiguration(QString json);
    ~OAIUpdateProgram_request_ScheduleConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProgram_request_ScheduleConfiguration)

#endif // OAIUpdateProgram_request_ScheduleConfiguration_H
