...
/*
 * OAIDescribeSourceLocationResponse.h
 *
 * 
 */

#ifndef OAIDescribeSourceLocationResponse_H
#define OAIDescribeSourceLocationResponse_H
...
#include "OAIDescribeSourceLocationResponse_HttpConfiguration.h"
#include <QDateTime>
#include <QList>
#include <QMap>
#include <QString>
...
class OAIDescribeSourceLocationResponse_DefaultSegmentDeliveryConfiguration;
class OAIDescribeSourceLocationResponse_HttpConfiguration;

class OAIDescribeSourceLocationResponse : public OAIObject {
public:
    OAIDescribeSourceLocationResponse();
    OAIDescribeSourceLocationResponse(QString json);
    ~OAIDescribeSourceLocationResponse() override;
    ...
    OAIDescribeSourceLocationResponse_DefaultSegmentDeliveryConfiguration getDefaultSegmentDeliveryConfiguration() const;
    void setDefaultSegmentDeliveryConfiguration(const OAIDescribeSourceLocationResponse_DefaultSegmentDeliveryConfiguration &default_segment_delivery_configuration);
    bool is_default_segment_delivery_configuration_Set() const;
    bool is_default_segment_delivery_configuration_Valid() const;

    OAIDescribeSourceLocationResponse_HttpConfiguration getHttpConfiguration() const;
    void setHttpConfiguration(const OAIDescribeSourceLocationResponse_HttpConfiguration &http_configuration);
...
private:
    ...
    OAIDescribeSourceLocationResponse_DefaultSegmentDeliveryConfiguration m_default_segment_delivery_configuration;
    bool m_default_segment_delivery_configuration_isSet;
    bool m_default_segment_delivery_configuration_isValid;

    OAIDescribeSourceLocationResponse_HttpConfiguration m_http_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSourceLocationResponse)

#endif // OAIDescribeSourceLocationResponse_H
