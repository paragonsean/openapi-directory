...
OAIUpdateProgram_request_ScheduleConfiguration_ClipRange OAIScheduleConfiguration::getClipRange() const {
    return m_clip_range;
}
void OAIScheduleConfiguration::setClipRange(const OAIUpdateProgram_request_ScheduleConfiguration_ClipRange &clip_range) {
    m_clip_range = clip_range;
    m_clip_range_isSet = true;
}

bool OAIScheduleConfiguration::is_clip_range_Set() const{
    return m_clip_range_isSet;
}

bool OAIScheduleConfiguration::is_clip_range_Valid() const{
    return m_clip_range_isValid;
}

OAICreateProgram_request_ScheduleConfiguration_Transition OAIScheduleConfiguration::getTransition() const {
    return m_transition;
}
void OAIScheduleConfiguration::setTransition(const OAICreateProgram_request_ScheduleConfiguration_Transition &transition) {
    m_transition = transition;
    m_transition_isSet = true;
}

bool OAIScheduleConfiguration::is_transition_Set() const{
    return m_transition_isSet;
}

bool OAIScheduleConfiguration::is_transition_Valid() const{
