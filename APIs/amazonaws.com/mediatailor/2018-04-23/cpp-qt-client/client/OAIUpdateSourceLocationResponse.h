...
/*
 * OAIUpdateSourceLocationResponse.h
 *
 * 
 */

#ifndef OAIUpdateSourceLocationResponse_H
#define OAIUpdateSourceLocationResponse_H
...
class OAIUpdateSourceLocationResponse : public OAIObject {
public:
    OAIUpdateSourceLocationResponse();
    OAIUpdateSourceLocationResponse(QString json);
    ~OAIUpdateSourceLocationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSourceLocationResponse)

#endif // OAIUpdateSourceLocationResponse_H
