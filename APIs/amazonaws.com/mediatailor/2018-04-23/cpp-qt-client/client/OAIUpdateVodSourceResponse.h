...
/*
 * OAIUpdateVodSourceResponse.h
 *
 * 
 */

#ifndef OAIUpdateVodSourceResponse_H
#define OAIUpdateVodSourceResponse_H
...
class OAIUpdateVodSourceResponse : public OAIObject {
public:
    OAIUpdateVodSourceResponse();
    OAIUpdateVodSourceResponse(QString json);
    ~OAIUpdateVodSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVodSourceResponse)

#endif // OAIUpdateVodSourceResponse_H
