...
/*
 * OAIUpdateLiveSourceResponse.h
 *
 * 
 */

#ifndef OAIUpdateLiveSourceResponse_H
#define OAIUpdateLiveSourceResponse_H
...
class OAIUpdateLiveSourceResponse : public OAIObject {
public:
    OAIUpdateLiveSourceResponse();
    OAIUpdateLiveSourceResponse(QString json);
    ~OAIUpdateLiveSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLiveSourceResponse)

#endif // OAIUpdateLiveSourceResponse_H
