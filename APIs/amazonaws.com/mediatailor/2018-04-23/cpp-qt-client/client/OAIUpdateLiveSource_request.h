...
/*
 * OAIUpdateLiveSource_request.h
 *
 * 
 */

#ifndef OAIUpdateLiveSource_request_H
#define OAIUpdateLiveSource_request_H
...
class OAIUpdateLiveSource_request : public OAIObject {
public:
    OAIUpdateLiveSource_request();
    OAIUpdateLiveSource_request(QString json);
    ~OAIUpdateLiveSource_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLiveSource_request)

#endif // OAIUpdateLiveSource_request_H
