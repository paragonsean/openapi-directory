...
/*
 * OAICreateProgramResponse.h
 *
 * 
 */

#ifndef OAICreateProgramResponse_H
#define OAICreateProgramResponse_H
...
class OAICreateProgramResponse : public OAIObject {
public:
    OAICreateProgramResponse();
    OAICreateProgramResponse(QString json);
    ~OAICreateProgramResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProgramResponse)

#endif // OAICreateProgramResponse_H
