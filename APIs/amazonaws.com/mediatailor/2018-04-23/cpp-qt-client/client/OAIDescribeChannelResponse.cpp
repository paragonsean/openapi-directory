...
QString OAIDescribeChannelResponse::getChannelName() const {
    return m_channel_name;
}
void OAIDescribeChannelResponse::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAIDescribeChannelResponse::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAIDescribeChannelResponse::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

OAIChannelState OAIDescribeChannelResponse::getChannelState() const {
    return m_channel_state;
}
void OAIDescribeChannelResponse::setChannelState(const OAIChannelState &channel_state) {
    m_channel_state = channel_state;
    m_channel_state_isSet = true;
}

bool OAIDescribeChannelResponse::is_channel_state_Set() const{
    return m_channel_state_isSet;
}

bool OAIDescribeChannelResponse::is_channel_state_Valid() const{
    return m_channel_state_isValid;
}

QDateTime OAIDescribeChannelResponse::getCreationTime() const {
    return m_creation_time;
}
void OAIDescribeChannelResponse::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIDescribeChannelResponse::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIDescribeChannelResponse::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAICreateChannelResponse_FillerSlate OAIDescribeChannelResponse::getFillerSlate() const {
    return m_filler_slate;
}
void OAIDescribeChannelResponse::setFillerSlate(const OAICreateChannelResponse_FillerSlate &filler_slate) {
    m_filler_slate = filler_slate;
    m_filler_slate_isSet = true;
}

bool OAIDescribeChannelResponse::is_filler_slate_Set() const{
    return m_filler_slate_isSet;
}

bool OAIDescribeChannelResponse::is_filler_slate_Valid() const{
    return m_filler_slate_isValid;
}

QDateTime OAIDescribeChannelResponse::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAIDescribeChannelResponse::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAIDescribeChannelResponse::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAIDescribeChannelResponse::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

OAIDescribeChannelResponse_LogConfiguration OAIDescribeChannelResponse::getLogConfiguration() const {
    return m_log_configuration;
}
void OAIDescribeChannelResponse::setLogConfiguration(const OAIDescribeChannelResponse_LogConfiguration &log_configuration) {
    m_log_configuration = log_configuration;
    m_log_configuration_isSet = true;
}

bool OAIDescribeChannelResponse::is_log_configuration_Set() const{
    return m_log_configuration_isSet;
}

bool OAIDescribeChannelResponse::is_log_configuration_Valid() const{
    return m_log_configuration_isValid;
}

QList OAIDescribeChannelResponse::getOutputs() const {
    return m_outputs;
}
void OAIDescribeChannelResponse::setOutputs(const QList &outputs) {
    m_outputs = outputs;
    m_outputs_isSet = true;
}

bool OAIDescribeChannelResponse::is_outputs_Set() const{
    return m_outputs_isSet;
}

bool OAIDescribeChannelResponse::is_outputs_Valid() const{
    return m_outputs_isValid;
}

QString OAIDescribeChannelResponse::getPlaybackMode() const {
    return m_playback_mode;
}
void OAIDescribeChannelResponse::setPlaybackMode(const QString &playback_mode) {
    m_playback_mode = playback_mode;
    m_playback_mode_isSet = true;
}

bool OAIDescribeChannelResponse::is_playback_mode_Set() const{
    return m_playback_mode_isSet;
}

bool OAIDescribeChannelResponse::is_playback_mode_Valid() const{
...
QString OAIDescribeChannelResponse::getTier() const {
    return m_tier;
}
void OAIDescribeChannelResponse::setTier(const QString &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIDescribeChannelResponse::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIDescribeChannelResponse::is_tier_Valid() const{
...
bool OAIDescribeChannelResponse::isValid() const {
    ...
    return m_log_configuration_isValid && true;
}
