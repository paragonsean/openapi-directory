...
#ifndef OAILiveSource_H
#define OAILiveSource_H
...
class OAILiveSource : public OAIObject {
public:
    OAILiveSource();
    OAILiveSource(QString json);
    ~OAILiveSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILiveSource)

#endif // OAILiveSource_H
