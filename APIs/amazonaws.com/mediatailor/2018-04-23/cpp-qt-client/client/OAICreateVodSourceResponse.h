...
/*
 * OAICreateVodSourceResponse.h
 *
 * 
 */

#ifndef OAICreateVodSourceResponse_H
#define OAICreateVodSourceResponse_H
...
class OAICreateVodSourceResponse : public OAIObject {
public:
    OAICreateVodSourceResponse();
    OAICreateVodSourceResponse(QString json);
    ~OAICreateVodSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVodSourceResponse)

#endif // OAICreateVodSourceResponse_H
