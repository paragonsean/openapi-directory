...
/*
 * OAIUpdateProgramScheduleConfiguration.h
 *
 * Schedule configuration parameters.
 */

#ifndef OAIUpdateProgramScheduleConfiguration_H
#define OAIUpdateProgramScheduleConfiguration_H
...
class OAIUpdateProgramScheduleConfiguration : public OAIObject {
public:
    OAIUpdateProgramScheduleConfiguration();
    OAIUpdateProgramScheduleConfiguration(QString json);
    ~OAIUpdateProgramScheduleConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProgramScheduleConfiguration)

#endif // OAIUpdateProgramScheduleConfiguration_H
