...
/*
 * OAICreateLiveSourceResponse.h
 *
 * 
 */

#ifndef OAICreateLiveSourceResponse_H
#define OAICreateLiveSourceResponse_H
...
class OAICreateLiveSourceResponse : public OAIObject {
public:
    OAICreateLiveSourceResponse();
    OAICreateLiveSourceResponse(QString json);
    ~OAICreateLiveSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLiveSourceResponse)

#endif // OAICreateLiveSourceResponse_H
