...
/*
 * OAICreateSourceLocation_request.h
 *
 * 
 */

#ifndef OAICreateSourceLocation_request_H
#define OAICreateSourceLocation_request_H
...
class OAICreateSourceLocation_request : public OAIObject {
public:
    OAICreateSourceLocation_request();
    OAICreateSourceLocation_request(QString json);
    ~OAICreateSourceLocation_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSourceLocation_request)

#endif // OAICreateSourceLocation_request_H
