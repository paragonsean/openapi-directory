...
QList OAIListChannelsResponse::getItems() const {
    return m_items;
}
void OAIListChannelsResponse::setItems(const QList &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListChannelsResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListChannelsResponse::is_items_Valid() const{
