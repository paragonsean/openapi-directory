...
QString OAIHttpConfiguration::getBaseUrl() const {
    return m_base_url;
}
void OAIHttpConfiguration::setBaseUrl(const QString &base_url) {
    m_base_url = base_url;
    m_base_url_isSet = true;
}

bool OAIHttpConfiguration::is_base_url_Set() const{
    return m_base_url_isSet;
}

bool OAIHttpConfiguration::is_base_url_Valid() const{
