...
/*
 * OAICreateSourceLocationResponse.h
 *
 * 
 */

#ifndef OAICreateSourceLocationResponse_H
#define OAICreateSourceLocationResponse_H
...
class OAICreateSourceLocationResponse : public OAIObject {
public:
    OAICreateSourceLocationResponse();
    OAICreateSourceLocationResponse(QString json);
    ~OAICreateSourceLocationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSourceLocationResponse)

#endif // OAICreateSourceLocationResponse_H
