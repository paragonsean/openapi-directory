...
/*
 * OAIAdBreak_SpliceInsertMessage.h
 *
 * 
 */

#ifndef OAIAdBreak_SpliceInsertMessage_H
#define OAIAdBreak_SpliceInsertMessage_H
...
class OAIAdBreak_SpliceInsertMessage : public OAIObject {
public:
    OAIAdBreak_SpliceInsertMessage();
    OAIAdBreak_SpliceInsertMessage(QString json);
    ~OAIAdBreak_SpliceInsertMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdBreak_SpliceInsertMessage)

#endif // OAIAdBreak_SpliceInsertMessage_H
