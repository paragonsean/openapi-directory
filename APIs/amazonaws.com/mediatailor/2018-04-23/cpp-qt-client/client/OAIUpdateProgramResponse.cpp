...
OAIUpdateProgramResponse::OAIUpdateProgramResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateProgramResponse::OAIUpdateProgramResponse() {
    this->initializeModel();
}

OAIUpdateProgramResponse::~OAIUpdateProgramResponse() {}

void OAIUpdateProgramResponse::initializeModel() {
...
void OAIUpdateProgramResponse::fromJson(QString jsonString) {
...
void OAIUpdateProgramResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateProgramResponse::asJson() const {
...
QJsonObject OAIUpdateProgramResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateProgramResponse::getAdBreaks() const {
    return m_ad_breaks;
}
void OAIUpdateProgramResponse::setAdBreaks(const QList &ad_breaks) {
    m_ad_breaks = ad_breaks;
    m_ad_breaks_isSet = true;
}

bool OAIUpdateProgramResponse::is_ad_breaks_Set() const{
    return m_ad_breaks_isSet;
}

bool OAIUpdateProgramResponse::is_ad_breaks_Valid() const{
    return m_ad_breaks_isValid;
}

QString OAIUpdateProgramResponse::getArn() const {
    return m_arn;
}
void OAIUpdateProgramResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIUpdateProgramResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIUpdateProgramResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIUpdateProgramResponse::getChannelName() const {
    return m_channel_name;
}
void OAIUpdateProgramResponse::setChannelName(const QString &channel_name) {
    m_channel_name = channel_name;
    m_channel_name_isSet = true;
}

bool OAIUpdateProgramResponse::is_channel_name_Set() const{
    return m_channel_name_isSet;
}

bool OAIUpdateProgramResponse::is_channel_name_Valid() const{
    return m_channel_name_isValid;
}

OAICreateProgramResponse_ClipRange OAIUpdateProgramResponse::getClipRange() const {
    return m_clip_range;
}
void OAIUpdateProgramResponse::setClipRange(const OAICreateProgramResponse_ClipRange &clip_range) {
    m_clip_range = clip_range;
    m_clip_range_isSet = true;
}

bool OAIUpdateProgramResponse::is_clip_range_Set() const{
    return m_clip_range_isSet;
}

bool OAIUpdateProgramResponse::is_clip_range_Valid() const{
    return m_clip_range_isValid;
}

QDateTime OAIUpdateProgramResponse::getCreationTime() const {
    return m_creation_time;
}
void OAIUpdateProgramResponse::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIUpdateProgramResponse::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIUpdateProgramResponse::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

qint32 OAIUpdateProgramResponse::getDurationMillis() const {
    return m_duration_millis;
}
void OAIUpdateProgramResponse::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAIUpdateProgramResponse::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAIUpdateProgramResponse::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

QString OAIUpdateProgramResponse::getLiveSourceName() const {
    return m_live_source_name;
}
void OAIUpdateProgramResponse::setLiveSourceName(const QString &live_source_name) {
    m_live_source_name = live_source_name;
    m_live_source_name_isSet = true;
}

bool OAIUpdateProgramResponse::is_live_source_name_Set() const{
    return m_live_source_name_isSet;
}

bool OAIUpdateProgramResponse::is_live_source_name_Valid() const{
    return m_live_source_name_isValid;
}

QString OAIUpdateProgramResponse::getProgramName() const {
    return m_program_name;
}
void OAIUpdateProgramResponse::setProgramName(const QString &program_name) {
    m_program_name = program_name;
    m_program_name_isSet = true;
}

bool OAIUpdateProgramResponse::is_program_name_Set() const{
    return m_program_name_isSet;
}

bool OAIUpdateProgramResponse::is_program_name_Valid() const{
    return m_program_name_isValid;
}

QDateTime OAIUpdateProgramResponse::getScheduledStartTime() const {
    return m_scheduled_start_time;
}
void OAIUpdateProgramResponse::setScheduledStartTime(const QDateTime &scheduled_start_time) {
    m_scheduled_start_time = scheduled_start_time;
    m_scheduled_start_time_isSet = true;
}

bool OAIUpdateProgramResponse::is_scheduled_start_time_Set() const{
    return m_scheduled_start_time_isSet;
}

bool OAIUpdateProgramResponse::is_scheduled_start_time_Valid() const{
    return m_scheduled_start_time_isValid;
}

QString OAIUpdateProgramResponse::getSourceLocationName() const {
    return m_source_location_name;
}
void OAIUpdateProgramResponse::setSourceLocationName(const QString &source_location_name) {
    m_source_location_name = source_location_name;
    m_source_location_name_isSet = true;
}

bool OAIUpdateProgramResponse::is_source_location_name_Set() const{
    return m_source_location_name_isSet;
}

bool OAIUpdateProgramResponse::is_source_location_name_Valid() const{
    return m_source_location_name_isValid;
}

QString OAIUpdateProgramResponse::getVodSourceName() const {
    return m_vod_source_name;
}
void OAIUpdateProgramResponse::setVodSourceName(const QString &vod_source_name) {
    m_vod_source_name = vod_source_name;
    m_vod_source_name_isSet = true;
}

bool OAIUpdateProgramResponse::is_vod_source_name_Set() const{
    return m_vod_source_name_isSet;
}

bool OAIUpdateProgramResponse::is_vod_source_name_Valid() const{
    return m_vod_source_name_isValid;
}

bool OAIUpdateProgramResponse::isSet() const {
...
bool OAIUpdateProgramResponse::isValid() const {
