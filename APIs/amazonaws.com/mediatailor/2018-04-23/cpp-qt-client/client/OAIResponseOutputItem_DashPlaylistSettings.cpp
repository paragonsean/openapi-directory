...
OAIResponseOutputItem_DashPlaylistSettings::OAIResponseOutputItem_DashPlaylistSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResponseOutputItem_DashPlaylistSettings::OAIResponseOutputItem_DashPlaylistSettings() {
    this->initializeModel();
}

OAIResponseOutputItem_DashPlaylistSettings::~OAIResponseOutputItem_DashPlaylistSettings() {}

void OAIResponseOutputItem_DashPlaylistSettings::initializeModel() {
...
void OAIResponseOutputItem_DashPlaylistSettings::fromJson(QString jsonString) {
...
void OAIResponseOutputItem_DashPlaylistSettings::fromJsonObject(QJsonObject json) {
...
QString OAIResponseOutputItem_DashPlaylistSettings::asJson() const {
...
QJsonObject OAIResponseOutputItem_DashPlaylistSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIResponseOutputItem_DashPlaylistSettings::getManifestWindowSeconds() const {
    return m_manifest_window_seconds;
}
void OAIResponseOutputItem_DashPlaylistSettings::setManifestWindowSeconds(const qint32 &manifest_window_seconds) {
    m_manifest_window_seconds = manifest_window_seconds;
    m_manifest_window_seconds_isSet = true;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_manifest_window_seconds_Set() const{
    return m_manifest_window_seconds_isSet;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_manifest_window_seconds_Valid() const{
    return m_manifest_window_seconds_isValid;
}

qint32 OAIResponseOutputItem_DashPlaylistSettings::getMinBufferTimeSeconds() const {
    return m_min_buffer_time_seconds;
}
void OAIResponseOutputItem_DashPlaylistSettings::setMinBufferTimeSeconds(const qint32 &min_buffer_time_seconds) {
    m_min_buffer_time_seconds = min_buffer_time_seconds;
    m_min_buffer_time_seconds_isSet = true;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_min_buffer_time_seconds_Set() const{
    return m_min_buffer_time_seconds_isSet;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_min_buffer_time_seconds_Valid() const{
    return m_min_buffer_time_seconds_isValid;
}

qint32 OAIResponseOutputItem_DashPlaylistSettings::getMinUpdatePeriodSeconds() const {
    return m_min_update_period_seconds;
}
void OAIResponseOutputItem_DashPlaylistSettings::setMinUpdatePeriodSeconds(const qint32 &min_update_period_seconds) {
    m_min_update_period_seconds = min_update_period_seconds;
    m_min_update_period_seconds_isSet = true;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_min_update_period_seconds_Set() const{
    return m_min_update_period_seconds_isSet;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_min_update_period_seconds_Valid() const{
    return m_min_update_period_seconds_isValid;
}

qint32 OAIResponseOutputItem_DashPlaylistSettings::getSuggestedPresentationDelaySeconds() const {
    return m_suggested_presentation_delay_seconds;
}
void OAIResponseOutputItem_DashPlaylistSettings::setSuggestedPresentationDelaySeconds(const qint32 &suggested_presentation_delay_seconds) {
...
bool OAIResponseOutputItem_DashPlaylistSettings::is_suggested_presentation_delay_seconds_Set() const{
    return m_suggested_presentation_delay_seconds_isSet;
}

bool OAIResponseOutputItem_DashPlaylistSettings::is_suggested_presentation_delay_seconds_Valid() const{
    return m_suggested_presentation_delay_seconds_isValid;
}

bool OAIResponseOutputItem_DashPlaylistSettings::isSet() const {
...
bool OAIResponseOutputItem_DashPlaylistSettings::isValid() const {
