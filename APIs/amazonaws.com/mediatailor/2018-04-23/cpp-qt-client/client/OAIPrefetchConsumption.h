...
#ifndef OAIPrefetchConsumption_H
#define OAIPrefetchConsumption_H
...
class OAIPrefetchConsumption : public OAIObject {
public:
    OAIPrefetchConsumption();
    OAIPrefetchConsumption(QString json);
    ~OAIPrefetchConsumption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrefetchConsumption)

#endif // OAIPrefetchConsumption_H
