...
#ifndef OAIAdBreak_Slate_H
#define OAIAdBreak_Slate_H
...
class OAIAdBreak_Slate : public OAIObject {
public:
    OAIAdBreak_Slate();
    OAIAdBreak_Slate(QString json);
    ~OAIAdBreak_Slate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdBreak_Slate)

#endif // OAIAdBreak_Slate_H
