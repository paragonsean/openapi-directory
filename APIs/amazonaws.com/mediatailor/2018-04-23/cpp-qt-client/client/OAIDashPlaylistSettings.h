...
/*
 * OAIDashPlaylistSettings.h
 *
 * Dash manifest configuration parameters.
 */

#ifndef OAIDashPlaylistSettings_H
#define OAIDashPlaylistSettings_H
...
class OAIDashPlaylistSettings : public OAIObject {
public:
    OAIDashPlaylistSettings();
    OAIDashPlaylistSettings(QString json);
    ~OAIDashPlaylistSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDashPlaylistSettings)

#endif // OAIDashPlaylistSettings_H
