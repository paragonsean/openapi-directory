...
/*
 * OAIRequestOutputItem_DashPlaylistSettings.h
 *
 * 
 */

#ifndef OAIRequestOutputItem_DashPlaylistSettings_H
#define OAIRequestOutputItem_DashPlaylistSettings_H
...
class OAIRequestOutputItem_DashPlaylistSettings : public OAIObject {
public:
    OAIRequestOutputItem_DashPlaylistSettings();
    OAIRequestOutputItem_DashPlaylistSettings(QString json);
    ~OAIRequestOutputItem_DashPlaylistSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestOutputItem_DashPlaylistSettings)

#endif // OAIRequestOutputItem_DashPlaylistSettings_H
