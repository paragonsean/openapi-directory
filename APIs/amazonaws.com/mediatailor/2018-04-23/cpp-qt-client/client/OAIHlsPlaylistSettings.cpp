...
#include "OAIHlsPlaylistSettings.h"
...
OAIHlsPlaylistSettings::OAIHlsPlaylistSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHlsPlaylistSettings::OAIHlsPlaylistSettings() {
    this->initializeModel();
}

OAIHlsPlaylistSettings::~OAIHlsPlaylistSettings() {}

void OAIHlsPlaylistSettings::initializeModel() {
...
void OAIHlsPlaylistSettings::fromJson(QString jsonString) {
...
void OAIHlsPlaylistSettings::fromJsonObject(QJsonObject json) {
...
QString OAIHlsPlaylistSettings::asJson() const {
...
QJsonObject OAIHlsPlaylistSettings::asJsonObject() const {
    QJsonObject obj;
...
QList OAIHlsPlaylistSettings::getAdMarkupType() const {
    return m_ad_markup_type;
}
void OAIHlsPlaylistSettings::setAdMarkupType(const QList &ad_markup_type) {
    m_ad_markup_type = ad_markup_type;
    m_ad_markup_type_isSet = true;
}

bool OAIHlsPlaylistSettings::is_ad_markup_type_Set() const{
    return m_ad_markup_type_isSet;
}

bool OAIHlsPlaylistSettings::is_ad_markup_type_Valid() const{
    return m_ad_markup_type_isValid;
}

qint32 OAIHlsPlaylistSettings::getManifestWindowSeconds() const {
    return m_manifest_window_seconds;
}
void OAIHlsPlaylistSettings::setManifestWindowSeconds(const qint32 &manifest_window_seconds) {
    m_manifest_window_seconds = manifest_window_seconds;
    m_manifest_window_seconds_isSet = true;
}

bool OAIHlsPlaylistSettings::is_manifest_window_seconds_Set() const{
    return m_manifest_window_seconds_isSet;
}

bool OAIHlsPlaylistSettings::is_manifest_window_seconds_Valid() const{
    return m_manifest_window_seconds_isValid;
}

bool OAIHlsPlaylistSettings::isSet() const {
...
bool OAIHlsPlaylistSettings::isValid() const {
