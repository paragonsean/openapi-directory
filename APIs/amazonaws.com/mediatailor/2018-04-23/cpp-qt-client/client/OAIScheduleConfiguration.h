...
class OAIScheduleConfiguration : public OAIObject {
public:
    OAIScheduleConfiguration();
    OAIScheduleConfiguration(QString json);
    ~OAIScheduleConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleConfiguration)

#endif // OAIScheduleConfiguration_H
