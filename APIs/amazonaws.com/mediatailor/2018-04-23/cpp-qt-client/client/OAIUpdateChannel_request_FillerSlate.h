...
/*
 * OAIUpdateChannel_request_FillerSlate.h
 *
 * Slate VOD source configuration.
 */

#ifndef OAIUpdateChannel_request_FillerSlate_H
#define OAIUpdateChannel_request_FillerSlate_H
...
class OAIUpdateChannel_request_FillerSlate : public OAIObject {
public:
    OAIUpdateChannel_request_FillerSlate();
    OAIUpdateChannel_request_FillerSlate(QString json);
    ~OAIUpdateChannel_request_FillerSlate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannel_request_FillerSlate)

#endif // OAIUpdateChannel_request_FillerSlate_H
