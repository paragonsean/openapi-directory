...
/*
 * OAICreateProgram_request.h
 *
 * 
 */

#ifndef OAICreateProgram_request_H
#define OAICreateProgram_request_H
...
namespace OpenAPI {
class OAIAdBreak;
class OAICreateProgram_request_ScheduleConfiguration;

class OAICreateProgram_request : public OAIObject {
public:
    OAICreateProgram_request();
    OAICreateProgram_request(QString json);
    ~OAICreateProgram_request() override;
    ...
    OAICreateProgram_request_ScheduleConfiguration getScheduleConfiguration() const;
    void setScheduleConfiguration(const OAICreateProgram_request_ScheduleConfiguration &schedule_configuration);
...
private:
    ...
    OAICreateProgram_request_ScheduleConfiguration m_schedule_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProgram_request)

#endif // OAICreateProgram_request_H
