...
OAIDescribeSourceLocationResponse_AccessConfiguration OAISourceLocation::getAccessConfiguration() const {
    return m_access_configuration;
}
void OAISourceLocation::setAccessConfiguration(const OAIDescribeSourceLocationResponse_AccessConfiguration &access_configuration) {
    m_access_configuration = access_configuration;
    m_access_configuration_isSet = true;
}

bool OAISourceLocation::is_access_configuration_Set() const{
    return m_access_configuration_isSet;
}

bool OAISourceLocation::is_access_configuration_Valid() const{
    return m_access_configuration_isValid;
}

QString OAISourceLocation::getArn() const {
    return m_arn;
}
void OAISourceLocation::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAISourceLocation::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAISourceLocation::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAISourceLocation::getCreationTime() const {
    return m_creation_time;
}
void OAISourceLocation::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAISourceLocation::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAISourceLocation::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAISourceLocation_DefaultSegmentDeliveryConfiguration OAISourceLocation::getDefaultSegmentDeliveryConfiguration() const {
    return m_default_segment_delivery_configuration;
}
void OAISourceLocation::setDefaultSegmentDeliveryConfiguration(const OAISourceLocation_DefaultSegmentDeliveryConfiguration &default_segment_delivery_configuration) {
...
bool OAISourceLocation::is_default_segment_delivery_configuration_Set() const{
    return m_default_segment_delivery_configuration_isSet;
}

bool OAISourceLocation::is_default_segment_delivery_configuration_Valid() const{
    return m_default_segment_delivery_configuration_isValid;
}

OAIUpdateSourceLocationResponse_HttpConfiguration OAISourceLocation::getHttpConfiguration() const {
    return m_http_configuration;
}
void OAISourceLocation::setHttpConfiguration(const OAIUpdateSourceLocationResponse_HttpConfiguration &http_configuration) {
    m_http_configuration = http_configuration;
    m_http_configuration_isSet = true;
}

bool OAISourceLocation::is_http_configuration_Set() const{
    return m_http_configuration_isSet;
}

bool OAISourceLocation::is_http_configuration_Valid() const{
    return m_http_configuration_isValid;
}

QDateTime OAISourceLocation::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAISourceLocation::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAISourceLocation::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAISourceLocation::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

QList OAISourceLocation::getSegmentDeliveryConfigurations() const {
    return m_segment_delivery_configurations;
}
void OAISourceLocation::setSegmentDeliveryConfigurations(const QList &segment_delivery_configurations) {
    m_segment_delivery_configurations = segment_delivery_configurations;
    m_segment_delivery_configurations_isSet = true;
}

bool OAISourceLocation::is_segment_delivery_configurations_Set() const{
    return m_segment_delivery_configurations_isSet;
}

bool OAISourceLocation::is_segment_delivery_configurations_Valid() const{
    return m_segment_delivery_configurations_isValid;
}

QString OAISourceLocation::getSourceLocationName() const {
    return m_source_location_name;
}
void OAISourceLocation::setSourceLocationName(const QString &source_location_name) {
    m_source_location_name = source_location_name;
    m_source_location_name_isSet = true;
}

bool OAISourceLocation::is_source_location_name_Set() const{
    return m_source_location_name_isSet;
}

bool OAISourceLocation::is_source_location_name_Valid() const{
    return m_source_location_name_isValid;
}

QMap OAISourceLocation::getTags() const {
    return m_tags;
}
void OAISourceLocation::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISourceLocation::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISourceLocation::is_tags_Valid() const{
...
bool OAISourceLocation::isValid() const {
    ...
    return m_arn_isValid && m_http_configuration_isValid && m_source_location_name_isValid && true;
}
