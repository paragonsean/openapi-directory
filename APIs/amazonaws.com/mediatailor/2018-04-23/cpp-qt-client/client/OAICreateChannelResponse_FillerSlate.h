...
/*
 * OAICreateChannelResponse_FillerSlate.h
 *
 * 
 */

#ifndef OAICreateChannelResponse_FillerSlate_H
#define OAICreateChannelResponse_FillerSlate_H
...
class OAICreateChannelResponse_FillerSlate : public OAIObject {
public:
    OAICreateChannelResponse_FillerSlate();
    OAICreateChannelResponse_FillerSlate(QString json);
    ~OAICreateChannelResponse_FillerSlate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelResponse_FillerSlate)

#endif // OAICreateChannelResponse_FillerSlate_H
