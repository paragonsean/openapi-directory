...
/*
 * OAIDescribeProgramResponse.h
 *
 * 
 */

#ifndef OAIDescribeProgramResponse_H
#define OAIDescribeProgramResponse_H
...
class OAIDescribeProgramResponse : public OAIObject {
public:
    OAIDescribeProgramResponse();
    OAIDescribeProgramResponse(QString json);
    ~OAIDescribeProgramResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProgramResponse)

#endif // OAIDescribeProgramResponse_H
