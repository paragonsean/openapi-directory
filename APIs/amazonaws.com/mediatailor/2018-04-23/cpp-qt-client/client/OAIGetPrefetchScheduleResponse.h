...
/*
 * OAIGetPrefetchScheduleResponse.h
 *
 * 
 */

#ifndef OAIGetPrefetchScheduleResponse_H
#define OAIGetPrefetchScheduleResponse_H
...
class OAIGetPrefetchScheduleResponse : public OAIObject {
public:
    OAIGetPrefetchScheduleResponse();
    OAIGetPrefetchScheduleResponse(QString json);
    ~OAIGetPrefetchScheduleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPrefetchScheduleResponse)

#endif // OAIGetPrefetchScheduleResponse_H
