...
/**
 * The CreateLiveSourceRequest model module.
 * @module model/CreateLiveSourceRequest
 * @version 2018-04-23
 */
class CreateLiveSourceRequest {
    /**
     * Constructs a new <code>CreateLiveSourceRequest</code>.
     * @alias module:model/CreateLiveSourceRequest
    ...
    constructor(httpPackageConfigurations) { 
        ...
        CreateLiveSourceRequest.initialize(this, httpPackageConfigurations);
    }
    ...
    /**
     * Constructs a <code>CreateLiveSourceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLiveSourceRequest} obj Optional instance to populate.
     * @return {module:model/CreateLiveSourceRequest} The populated <code>CreateLiveSourceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLiveSourceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLiveSourceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLiveSourceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLiveSourceRequest.RequiredProperties) {
...
CreateLiveSourceRequest.RequiredProperties = ["HttpPackageConfigurations"];
 ...
 */
CreateLiveSourceRequest.prototype['HttpPackageConfigurations'] = undefined;
 ...
 */
CreateLiveSourceRequest.prototype['tags'] = undefined;
...
export default CreateLiveSourceRequest;
