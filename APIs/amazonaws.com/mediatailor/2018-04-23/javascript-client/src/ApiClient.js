...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.mediatailor.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.mediatailor.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-04-23/Javascript'
        };
