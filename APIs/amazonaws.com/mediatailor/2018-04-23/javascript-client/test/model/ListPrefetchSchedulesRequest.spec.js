...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaTailor.ListPrefetchSchedulesRequest();
  });
  ...
  describe('ListPrefetchSchedulesRequest', function() {
    it('should create an instance of ListPrefetchSchedulesRequest', function() {
      // uncomment below and update the code to test ListPrefetchSchedulesRequest
      //var instance = new AwsMediaTailor.ListPrefetchSchedulesRequest();
      //expect(instance).to.be.a(AwsMediaTailor.ListPrefetchSchedulesRequest);
    });
