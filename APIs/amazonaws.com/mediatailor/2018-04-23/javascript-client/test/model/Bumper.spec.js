...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaTailor.Bumper();
  });
  ...
  describe('Bumper', function() {
    it('should create an instance of Bumper', function() {
      // uncomment below and update the code to test Bumper
      //var instance = new AwsMediaTailor.Bumper();
      //expect(instance).to.be.a(AwsMediaTailor.Bumper);
    });
