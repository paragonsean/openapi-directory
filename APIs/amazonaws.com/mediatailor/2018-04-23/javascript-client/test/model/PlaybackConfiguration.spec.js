...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaTailor.PlaybackConfiguration();
  });
  ...
  describe('PlaybackConfiguration', function() {
    it('should create an instance of PlaybackConfiguration', function() {
      // uncomment below and update the code to test PlaybackConfiguration
      //var instance = new AwsMediaTailor.PlaybackConfiguration();
      //expect(instance).to.be.a(AwsMediaTailor.PlaybackConfiguration);
    });
