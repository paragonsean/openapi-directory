...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMediaTailor.CreateChannelResponse();
  });
  ...
  describe('CreateChannelResponse', function() {
    it('should create an instance of CreateChannelResponse', function() {
      // uncomment below and update the code to test CreateChannelResponse
      //var instance = new AwsMediaTailor.CreateChannelResponse();
      //expect(instance).to.be.a(AwsMediaTailor.CreateChannelResponse);
    });
