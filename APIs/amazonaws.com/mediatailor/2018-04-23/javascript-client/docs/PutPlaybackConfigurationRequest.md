# AwsMediaTailor.PutPlaybackConfigurationRequest
...
**configurationAliases** | **{String: Object}** | The predefined aliases for dynamic variables. | [optional] 
...
**tags** | **{String: String}** | The tags to assign to the playback configuration. Tags are key-value pairs that you can associate with Amazon resources to help with organization, access control, and cost tracking. For more information, see &lt;a href&#x3D;\&quot;https://docs.aws.amazon.com/mediatailor/latest/ug/tagging.html\&quot;&gt;Tagging AWS Elemental MediaTailor Resources&lt;/a&gt;. | [optional] 
