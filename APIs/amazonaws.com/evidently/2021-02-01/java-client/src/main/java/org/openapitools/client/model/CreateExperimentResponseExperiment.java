...
public class CreateExperimentResponseExperiment {
  ...
  public CreateExperimentResponseExperiment() {
  }

  public CreateExperimentResponseExperiment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateExperimentResponseExperiment createdTime(OffsetDateTime createdTime) {
  ...
  public CreateExperimentResponseExperiment description(String description) {
  ...
  public CreateExperimentResponseExperiment execution(ExperimentExecution execution) {
  ...
  public CreateExperimentResponseExperiment lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public CreateExperimentResponseExperiment metricGoals(List metricGoals) {
  ...
  public CreateExperimentResponseExperiment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateExperimentResponseExperiment onlineAbDefinition(ExperimentOnlineAbDefinition onlineAbDefinition) {
  ...
  public CreateExperimentResponseExperiment project(String project) {
  ...
  public CreateExperimentResponseExperiment randomizationSalt(String randomizationSalt) {
  ...
  public CreateExperimentResponseExperiment samplingRate(Integer samplingRate) {
  ...
  public CreateExperimentResponseExperiment schedule(ExperimentSchedule schedule) {
  ...
  public CreateExperimentResponseExperiment segment(String segment) {
  ...
  public CreateExperimentResponseExperiment status(ExperimentStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateExperimentResponseExperiment statusReason(String statusReason) {
  ...
  public CreateExperimentResponseExperiment tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateExperimentResponseExperiment treatments(List treatments) {
  ...
  public CreateExperimentResponseExperiment type(ExperimentType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateExperimentResponseExperiment createExperimentResponseExperiment = (CreateExperimentResponseExperiment) o;
    return Objects.equals(this.arn, createExperimentResponseExperiment.arn) &&
        Objects.equals(this.createdTime, createExperimentResponseExperiment.createdTime) &&
        Objects.equals(this.description, createExperimentResponseExperiment.description) &&
        Objects.equals(this.execution, createExperimentResponseExperiment.execution) &&
        Objects.equals(this.lastUpdatedTime, createExperimentResponseExperiment.lastUpdatedTime) &&
        Objects.equals(this.metricGoals, createExperimentResponseExperiment.metricGoals) &&
        Objects.equals(this.name, createExperimentResponseExperiment.name) &&
        Objects.equals(this.onlineAbDefinition, createExperimentResponseExperiment.onlineAbDefinition) &&
        Objects.equals(this.project, createExperimentResponseExperiment.project) &&
        Objects.equals(this.randomizationSalt, createExperimentResponseExperiment.randomizationSalt) &&
        Objects.equals(this.samplingRate, createExperimentResponseExperiment.samplingRate) &&
        Objects.equals(this.schedule, createExperimentResponseExperiment.schedule) &&
        Objects.equals(this.segment, createExperimentResponseExperiment.segment) &&
        Objects.equals(this.status, createExperimentResponseExperiment.status) &&
        Objects.equals(this.statusReason, createExperimentResponseExperiment.statusReason) &&
        Objects.equals(this.tags, createExperimentResponseExperiment.tags) &&
        Objects.equals(this.treatments, createExperimentResponseExperiment.treatments) &&
        Objects.equals(this.type, createExperimentResponseExperiment.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateExperimentResponseExperiment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateExperimentResponseExperiment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateExperimentResponseExperiment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateExperimentResponseExperiment is not found in the empty JSON string", CreateExperimentResponseExperiment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateExperimentResponseExperiment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateExperimentResponseExperiment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateExperimentResponseExperiment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateExperimentResponseExperiment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateExperimentResponseExperiment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateExperimentResponseExperiment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateExperimentResponseExperiment.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateExperimentResponseExperiment>() {
           @Override
           public void write(JsonWriter out, CreateExperimentResponseExperiment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateExperimentResponseExperiment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateExperimentResponseExperiment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateExperimentResponseExperiment
   * @throws IOException if the JSON string is invalid with respect to CreateExperimentResponseExperiment
   */
  public static CreateExperimentResponseExperiment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateExperimentResponseExperiment.class);
  }

  /**
   * Convert an instance of CreateExperimentResponseExperiment to an JSON string
   *
   * @return JSON string
   */
