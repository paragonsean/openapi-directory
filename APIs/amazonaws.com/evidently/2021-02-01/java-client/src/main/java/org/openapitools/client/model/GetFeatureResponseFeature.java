...
public class GetFeatureResponseFeature {
  ...
  public GetFeatureResponseFeature() {
  }

  public GetFeatureResponseFeature arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetFeatureResponseFeature createdTime(OffsetDateTime createdTime) {
  ...
  public GetFeatureResponseFeature defaultVariation(String defaultVariation) {
  ...
  public GetFeatureResponseFeature description(String description) {
  ...
  public GetFeatureResponseFeature entityOverrides(Map entityOverrides) {
  ...
  public GetFeatureResponseFeature evaluationRules(List evaluationRules) {
  ...
  public GetFeatureResponseFeature evaluationStrategy(FeatureEvaluationStrategy evaluationStrategy) {
  ...
  public GetFeatureResponseFeature lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public GetFeatureResponseFeature name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetFeatureResponseFeature project(String project) {
  ...
  public GetFeatureResponseFeature status(FeatureStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetFeatureResponseFeature tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetFeatureResponseFeature valueType(VariationValueType valueType) {
  ...
  public GetFeatureResponseFeature variations(List variations) {
  ...
  public boolean equals(Object o) {
    ...
    GetFeatureResponseFeature getFeatureResponseFeature = (GetFeatureResponseFeature) o;
    return Objects.equals(this.arn, getFeatureResponseFeature.arn) &&
        Objects.equals(this.createdTime, getFeatureResponseFeature.createdTime) &&
        Objects.equals(this.defaultVariation, getFeatureResponseFeature.defaultVariation) &&
        Objects.equals(this.description, getFeatureResponseFeature.description) &&
        Objects.equals(this.entityOverrides, getFeatureResponseFeature.entityOverrides) &&
        Objects.equals(this.evaluationRules, getFeatureResponseFeature.evaluationRules) &&
        Objects.equals(this.evaluationStrategy, getFeatureResponseFeature.evaluationStrategy) &&
        Objects.equals(this.lastUpdatedTime, getFeatureResponseFeature.lastUpdatedTime) &&
        Objects.equals(this.name, getFeatureResponseFeature.name) &&
        Objects.equals(this.project, getFeatureResponseFeature.project) &&
        Objects.equals(this.status, getFeatureResponseFeature.status) &&
        Objects.equals(this.tags, getFeatureResponseFeature.tags) &&
        Objects.equals(this.valueType, getFeatureResponseFeature.valueType) &&
        Objects.equals(this.variations, getFeatureResponseFeature.variations);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFeatureResponseFeature {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFeatureResponseFeature
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFeatureResponseFeature.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFeatureResponseFeature is not found in the empty JSON string", GetFeatureResponseFeature.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFeatureResponseFeature.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFeatureResponseFeature` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFeatureResponseFeature.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFeatureResponseFeature.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFeatureResponseFeature' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFeatureResponseFeature> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFeatureResponseFeature.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFeatureResponseFeature>() {
           @Override
           public void write(JsonWriter out, GetFeatureResponseFeature value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFeatureResponseFeature read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFeatureResponseFeature given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFeatureResponseFeature
   * @throws IOException if the JSON string is invalid with respect to GetFeatureResponseFeature
   */
  public static GetFeatureResponseFeature fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFeatureResponseFeature.class);
  }

  /**
   * Convert an instance of GetFeatureResponseFeature to an JSON string
   *
   * @return JSON string
   */
