...
public class UpdateExperimentResponseExperiment {
  ...
  public UpdateExperimentResponseExperiment() {
  }

  public UpdateExperimentResponseExperiment arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateExperimentResponseExperiment createdTime(OffsetDateTime createdTime) {
  ...
  public UpdateExperimentResponseExperiment description(String description) {
  ...
  public UpdateExperimentResponseExperiment execution(ExperimentExecution execution) {
  ...
  public UpdateExperimentResponseExperiment lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public UpdateExperimentResponseExperiment metricGoals(List metricGoals) {
  ...
  public UpdateExperimentResponseExperiment name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateExperimentResponseExperiment onlineAbDefinition(ExperimentOnlineAbDefinition onlineAbDefinition) {
  ...
  public UpdateExperimentResponseExperiment project(String project) {
  ...
  public UpdateExperimentResponseExperiment randomizationSalt(String randomizationSalt) {
  ...
  public UpdateExperimentResponseExperiment samplingRate(Integer samplingRate) {
  ...
  public UpdateExperimentResponseExperiment schedule(ExperimentSchedule schedule) {
  ...
  public UpdateExperimentResponseExperiment segment(String segment) {
  ...
  public UpdateExperimentResponseExperiment status(ExperimentStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateExperimentResponseExperiment statusReason(String statusReason) {
  ...
  public UpdateExperimentResponseExperiment tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateExperimentResponseExperiment treatments(List treatments) {
  ...
  public UpdateExperimentResponseExperiment type(ExperimentType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateExperimentResponseExperiment updateExperimentResponseExperiment = (UpdateExperimentResponseExperiment) o;
    return Objects.equals(this.arn, updateExperimentResponseExperiment.arn) &&
        Objects.equals(this.createdTime, updateExperimentResponseExperiment.createdTime) &&
        Objects.equals(this.description, updateExperimentResponseExperiment.description) &&
        Objects.equals(this.execution, updateExperimentResponseExperiment.execution) &&
        Objects.equals(this.lastUpdatedTime, updateExperimentResponseExperiment.lastUpdatedTime) &&
        Objects.equals(this.metricGoals, updateExperimentResponseExperiment.metricGoals) &&
        Objects.equals(this.name, updateExperimentResponseExperiment.name) &&
        Objects.equals(this.onlineAbDefinition, updateExperimentResponseExperiment.onlineAbDefinition) &&
        Objects.equals(this.project, updateExperimentResponseExperiment.project) &&
        Objects.equals(this.randomizationSalt, updateExperimentResponseExperiment.randomizationSalt) &&
        Objects.equals(this.samplingRate, updateExperimentResponseExperiment.samplingRate) &&
        Objects.equals(this.schedule, updateExperimentResponseExperiment.schedule) &&
        Objects.equals(this.segment, updateExperimentResponseExperiment.segment) &&
        Objects.equals(this.status, updateExperimentResponseExperiment.status) &&
        Objects.equals(this.statusReason, updateExperimentResponseExperiment.statusReason) &&
        Objects.equals(this.tags, updateExperimentResponseExperiment.tags) &&
        Objects.equals(this.treatments, updateExperimentResponseExperiment.treatments) &&
        Objects.equals(this.type, updateExperimentResponseExperiment.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateExperimentResponseExperiment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateExperimentResponseExperiment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateExperimentResponseExperiment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateExperimentResponseExperiment is not found in the empty JSON string", UpdateExperimentResponseExperiment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateExperimentResponseExperiment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateExperimentResponseExperiment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateExperimentResponseExperiment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateExperimentResponseExperiment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateExperimentResponseExperiment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateExperimentResponseExperiment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateExperimentResponseExperiment.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateExperimentResponseExperiment>() {
           @Override
           public void write(JsonWriter out, UpdateExperimentResponseExperiment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateExperimentResponseExperiment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateExperimentResponseExperiment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateExperimentResponseExperiment
   * @throws IOException if the JSON string is invalid with respect to UpdateExperimentResponseExperiment
   */
  public static UpdateExperimentResponseExperiment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateExperimentResponseExperiment.class);
  }

  /**
   * Convert an instance of UpdateExperimentResponseExperiment to an JSON string
   *
   * @return JSON string
   */
