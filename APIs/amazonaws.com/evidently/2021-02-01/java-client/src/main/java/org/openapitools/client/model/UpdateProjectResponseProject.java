...
public class UpdateProjectResponseProject {
  ...
  public UpdateProjectResponseProject() {
  }

  public UpdateProjectResponseProject activeExperimentCount(Integer activeExperimentCount) {
  ...
  public UpdateProjectResponseProject activeLaunchCount(Integer activeLaunchCount) {
  ...
  public UpdateProjectResponseProject appConfigResource(ProjectAppConfigResource appConfigResource) {
  ...
  public UpdateProjectResponseProject arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateProjectResponseProject createdTime(OffsetDateTime createdTime) {
  ...
  public UpdateProjectResponseProject dataDelivery(ProjectDataDelivery dataDelivery) {
  ...
  public UpdateProjectResponseProject description(String description) {
  ...
  public UpdateProjectResponseProject experimentCount(Integer experimentCount) {
  ...
  public UpdateProjectResponseProject featureCount(Integer featureCount) {
  ...
  public UpdateProjectResponseProject lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public UpdateProjectResponseProject launchCount(Integer launchCount) {
  ...
  public UpdateProjectResponseProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateProjectResponseProject status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateProjectResponseProject tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateProjectResponseProject updateProjectResponseProject = (UpdateProjectResponseProject) o;
    return Objects.equals(this.activeExperimentCount, updateProjectResponseProject.activeExperimentCount) &&
        Objects.equals(this.activeLaunchCount, updateProjectResponseProject.activeLaunchCount) &&
        Objects.equals(this.appConfigResource, updateProjectResponseProject.appConfigResource) &&
        Objects.equals(this.arn, updateProjectResponseProject.arn) &&
        Objects.equals(this.createdTime, updateProjectResponseProject.createdTime) &&
        Objects.equals(this.dataDelivery, updateProjectResponseProject.dataDelivery) &&
        Objects.equals(this.description, updateProjectResponseProject.description) &&
        Objects.equals(this.experimentCount, updateProjectResponseProject.experimentCount) &&
        Objects.equals(this.featureCount, updateProjectResponseProject.featureCount) &&
        Objects.equals(this.lastUpdatedTime, updateProjectResponseProject.lastUpdatedTime) &&
        Objects.equals(this.launchCount, updateProjectResponseProject.launchCount) &&
        Objects.equals(this.name, updateProjectResponseProject.name) &&
        Objects.equals(this.status, updateProjectResponseProject.status) &&
        Objects.equals(this.tags, updateProjectResponseProject.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProjectResponseProject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProjectResponseProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProjectResponseProject is not found in the empty JSON string", UpdateProjectResponseProject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProjectResponseProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProjectResponseProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateProjectResponseProject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProjectResponseProject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProjectResponseProject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProjectResponseProject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProjectResponseProject.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProjectResponseProject>() {
           @Override
           public void write(JsonWriter out, UpdateProjectResponseProject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProjectResponseProject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProjectResponseProject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProjectResponseProject
   * @throws IOException if the JSON string is invalid with respect to UpdateProjectResponseProject
   */
  public static UpdateProjectResponseProject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProjectResponseProject.class);
  }

  /**
   * Convert an instance of UpdateProjectResponseProject to an JSON string
   *
   * @return JSON string
   */
