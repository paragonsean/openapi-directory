...
public class CreateProjectResponseProject {
  ...
  public CreateProjectResponseProject() {
  }

  public CreateProjectResponseProject activeExperimentCount(Integer activeExperimentCount) {
  ...
  public CreateProjectResponseProject activeLaunchCount(Integer activeLaunchCount) {
  ...
  public CreateProjectResponseProject appConfigResource(ProjectAppConfigResource appConfigResource) {
  ...
  public CreateProjectResponseProject arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateProjectResponseProject createdTime(OffsetDateTime createdTime) {
  ...
  public CreateProjectResponseProject dataDelivery(ProjectDataDelivery dataDelivery) {
  ...
  public CreateProjectResponseProject description(String description) {
  ...
  public CreateProjectResponseProject experimentCount(Integer experimentCount) {
  ...
  public CreateProjectResponseProject featureCount(Integer featureCount) {
  ...
  public CreateProjectResponseProject lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public CreateProjectResponseProject launchCount(Integer launchCount) {
  ...
  public CreateProjectResponseProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateProjectResponseProject status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateProjectResponseProject tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectResponseProject createProjectResponseProject = (CreateProjectResponseProject) o;
    return Objects.equals(this.activeExperimentCount, createProjectResponseProject.activeExperimentCount) &&
        Objects.equals(this.activeLaunchCount, createProjectResponseProject.activeLaunchCount) &&
        Objects.equals(this.appConfigResource, createProjectResponseProject.appConfigResource) &&
        Objects.equals(this.arn, createProjectResponseProject.arn) &&
        Objects.equals(this.createdTime, createProjectResponseProject.createdTime) &&
        Objects.equals(this.dataDelivery, createProjectResponseProject.dataDelivery) &&
        Objects.equals(this.description, createProjectResponseProject.description) &&
        Objects.equals(this.experimentCount, createProjectResponseProject.experimentCount) &&
        Objects.equals(this.featureCount, createProjectResponseProject.featureCount) &&
        Objects.equals(this.lastUpdatedTime, createProjectResponseProject.lastUpdatedTime) &&
        Objects.equals(this.launchCount, createProjectResponseProject.launchCount) &&
        Objects.equals(this.name, createProjectResponseProject.name) &&
        Objects.equals(this.status, createProjectResponseProject.status) &&
        Objects.equals(this.tags, createProjectResponseProject.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateProjectResponseProject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProjectResponseProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProjectResponseProject is not found in the empty JSON string", CreateProjectResponseProject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProjectResponseProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProjectResponseProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateProjectResponseProject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateProjectResponseProject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateProjectResponseProject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateProjectResponseProject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateProjectResponseProject.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateProjectResponseProject>() {
           @Override
           public void write(JsonWriter out, CreateProjectResponseProject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateProjectResponseProject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateProjectResponseProject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateProjectResponseProject
   * @throws IOException if the JSON string is invalid with respect to CreateProjectResponseProject
   */
  public static CreateProjectResponseProject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateProjectResponseProject.class);
  }

  /**
   * Convert an instance of CreateProjectResponseProject to an JSON string
   *
   * @return JSON string
   */
