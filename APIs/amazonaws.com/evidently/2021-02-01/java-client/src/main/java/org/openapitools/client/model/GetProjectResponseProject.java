...
public class GetProjectResponseProject {
  ...
  public GetProjectResponseProject() {
  }

  public GetProjectResponseProject activeExperimentCount(Integer activeExperimentCount) {
  ...
  public GetProjectResponseProject activeLaunchCount(Integer activeLaunchCount) {
  ...
  public GetProjectResponseProject appConfigResource(ProjectAppConfigResource appConfigResource) {
  ...
  public GetProjectResponseProject arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetProjectResponseProject createdTime(OffsetDateTime createdTime) {
  ...
  public GetProjectResponseProject dataDelivery(ProjectDataDelivery dataDelivery) {
  ...
  public GetProjectResponseProject description(String description) {
  ...
  public GetProjectResponseProject experimentCount(Integer experimentCount) {
  ...
  public GetProjectResponseProject featureCount(Integer featureCount) {
  ...
  public GetProjectResponseProject lastUpdatedTime(OffsetDateTime lastUpdatedTime) {
  ...
  public GetProjectResponseProject launchCount(Integer launchCount) {
  ...
  public GetProjectResponseProject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetProjectResponseProject status(ProjectStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetProjectResponseProject tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProjectResponseProject getProjectResponseProject = (GetProjectResponseProject) o;
    return Objects.equals(this.activeExperimentCount, getProjectResponseProject.activeExperimentCount) &&
        Objects.equals(this.activeLaunchCount, getProjectResponseProject.activeLaunchCount) &&
        Objects.equals(this.appConfigResource, getProjectResponseProject.appConfigResource) &&
        Objects.equals(this.arn, getProjectResponseProject.arn) &&
        Objects.equals(this.createdTime, getProjectResponseProject.createdTime) &&
        Objects.equals(this.dataDelivery, getProjectResponseProject.dataDelivery) &&
        Objects.equals(this.description, getProjectResponseProject.description) &&
        Objects.equals(this.experimentCount, getProjectResponseProject.experimentCount) &&
        Objects.equals(this.featureCount, getProjectResponseProject.featureCount) &&
        Objects.equals(this.lastUpdatedTime, getProjectResponseProject.lastUpdatedTime) &&
        Objects.equals(this.launchCount, getProjectResponseProject.launchCount) &&
        Objects.equals(this.name, getProjectResponseProject.name) &&
        Objects.equals(this.status, getProjectResponseProject.status) &&
        Objects.equals(this.tags, getProjectResponseProject.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectResponseProject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProjectResponseProject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProjectResponseProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProjectResponseProject is not found in the empty JSON string", GetProjectResponseProject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectResponseProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectResponseProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProjectResponseProject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProjectResponseProject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProjectResponseProject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProjectResponseProject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProjectResponseProject.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProjectResponseProject>() {
           @Override
           public void write(JsonWriter out, GetProjectResponseProject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProjectResponseProject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProjectResponseProject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProjectResponseProject
   * @throws IOException if the JSON string is invalid with respect to GetProjectResponseProject
   */
  public static GetProjectResponseProject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProjectResponseProject.class);
  }

  /**
   * Convert an instance of GetProjectResponseProject to an JSON string
   *
   * @return JSON string
   */
