...
|**groups** | [**List&lt;LaunchGroupConfig&gt;**](LaunchGroupConfig.md) | An array of structures that contains the feature and variations that are to be used for the launch. |  |
