...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.ProjectAppConfigResource();
  });
  ...
  describe('ProjectAppConfigResource', function() {
    it('should create an instance of ProjectAppConfigResource', function() {
      // uncomment below and update the code to test ProjectAppConfigResource
      //var instance = new AmazonCloudWatchEvidently.ProjectAppConfigResource();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.ProjectAppConfigResource);
    });
