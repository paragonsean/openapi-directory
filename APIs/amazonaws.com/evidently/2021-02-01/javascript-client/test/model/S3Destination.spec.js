...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.S3Destination();
  });
  ...
  describe('S3Destination', function() {
    it('should create an instance of S3Destination', function() {
      ...
      //var instance = new AmazonCloudWatchEvidently.S3Destination();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.S3Destination);
    });
