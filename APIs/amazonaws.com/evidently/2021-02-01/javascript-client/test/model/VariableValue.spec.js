...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.VariableValue();
  });
  ...
  describe('VariableValue', function() {
    it('should create an instance of VariableValue', function() {
      // uncomment below and update the code to test VariableValue
      //var instance = new AmazonCloudWatchEvidently.VariableValue();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.VariableValue);
    });
