...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.FeatureSummary();
  });
  ...
  describe('FeatureSummary', function() {
    it('should create an instance of FeatureSummary', function() {
      // uncomment below and update the code to test FeatureSummary
      //var instance = new AmazonCloudWatchEvidently.FeatureSummary();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.FeatureSummary);
    });
