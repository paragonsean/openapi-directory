...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.LaunchGroupConfig();
  });
  ...
  describe('LaunchGroupConfig', function() {
    it('should create an instance of LaunchGroupConfig', function() {
      // uncomment below and update the code to test LaunchGroupConfig
      //var instance = new AmazonCloudWatchEvidently.LaunchGroupConfig();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.LaunchGroupConfig);
    });
