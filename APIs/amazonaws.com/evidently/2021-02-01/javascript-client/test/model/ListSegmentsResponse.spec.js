...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.ListSegmentsResponse();
  });
  ...
  describe('ListSegmentsResponse', function() {
    it('should create an instance of ListSegmentsResponse', function() {
      // uncomment below and update the code to test ListSegmentsResponse
      //var instance = new AmazonCloudWatchEvidently.ListSegmentsResponse();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.ListSegmentsResponse);
    });
