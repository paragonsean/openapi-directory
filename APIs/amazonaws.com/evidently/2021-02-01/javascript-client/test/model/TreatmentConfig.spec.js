...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.TreatmentConfig();
  });
  ...
  describe('TreatmentConfig', function() {
    it('should create an instance of TreatmentConfig', function() {
      // uncomment below and update the code to test TreatmentConfig
      //var instance = new AmazonCloudWatchEvidently.TreatmentConfig();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.TreatmentConfig);
    });
