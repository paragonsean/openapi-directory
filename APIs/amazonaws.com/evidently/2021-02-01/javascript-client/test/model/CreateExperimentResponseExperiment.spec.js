...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.CreateExperimentResponseExperiment();
  });
  ...
  describe('CreateExperimentResponseExperiment', function() {
    it('should create an instance of CreateExperimentResponseExperiment', function() {
      // uncomment below and update the code to test CreateExperimentResponseExperiment
      //var instance = new AmazonCloudWatchEvidently.CreateExperimentResponseExperiment();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.CreateExperimentResponseExperiment);
    });
    ...
    it('should have the property onlineAbDefinition (base name: "onlineAbDefinition")', function() {
      // uncomment below and update the code to test the property onlineAbDefinition
      //var instance = new AmazonCloudWatchEvidently.CreateExperimentResponseExperiment();
      //expect(instance).to.be();
    });
