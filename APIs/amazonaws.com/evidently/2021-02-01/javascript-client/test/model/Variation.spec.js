...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.Variation();
  });
  ...
  describe('Variation', function() {
    it('should create an instance of Variation', function() {
      ...
      //var instance = new AmazonCloudWatchEvidently.Variation();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.Variation);
    });
