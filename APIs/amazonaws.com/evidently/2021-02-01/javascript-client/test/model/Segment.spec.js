...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.Segment();
  });
  ...
  describe('Segment', function() {
    it('should create an instance of Segment', function() {
      ...
      //var instance = new AmazonCloudWatchEvidently.Segment();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.Segment);
    });
