...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudWatchEvidently.VariationConfigValue();
  });
  ...
  describe('VariationConfigValue', function() {
    it('should create an instance of VariationConfigValue', function() {
      // uncomment below and update the code to test VariationConfigValue
      //var instance = new AmazonCloudWatchEvidently.VariationConfigValue();
      //expect(instance).to.be.a(AmazonCloudWatchEvidently.VariationConfigValue);
    });
