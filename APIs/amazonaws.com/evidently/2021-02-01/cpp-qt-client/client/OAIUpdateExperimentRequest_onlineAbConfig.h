...
/*
 * OAIUpdateExperimentRequest_onlineAbConfig.h
 *
 * 
 */

#ifndef OAIUpdateExperimentRequest_onlineAbConfig_H
#define OAIUpdateExperimentRequest_onlineAbConfig_H
...
class OAIUpdateExperimentRequest_onlineAbConfig : public OAIObject {
public:
    OAIUpdateExperimentRequest_onlineAbConfig();
    OAIUpdateExperimentRequest_onlineAbConfig(QString json);
    ~OAIUpdateExperimentRequest_onlineAbConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentRequest_onlineAbConfig)

#endif // OAIUpdateExperimentRequest_onlineAbConfig_H
