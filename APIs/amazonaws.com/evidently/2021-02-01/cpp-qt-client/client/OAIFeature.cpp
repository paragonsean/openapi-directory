...
QString OAIFeature::getArn() const {
    return m_arn;
}
void OAIFeature::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIFeature::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIFeature::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIFeature::getCreatedTime() const {
    return m_created_time;
}
void OAIFeature::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIFeature::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIFeature::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIFeature::getDefaultVariation() const {
    return m_default_variation;
}
void OAIFeature::setDefaultVariation(const QString &default_variation) {
    m_default_variation = default_variation;
    m_default_variation_isSet = true;
}

bool OAIFeature::is_default_variation_Set() const{
    return m_default_variation_isSet;
}

bool OAIFeature::is_default_variation_Valid() const{
...
QMap OAIFeature::getEntityOverrides() const {
    return m_entity_overrides;
}
void OAIFeature::setEntityOverrides(const QMap &entity_overrides) {
    m_entity_overrides = entity_overrides;
    m_entity_overrides_isSet = true;
}

bool OAIFeature::is_entity_overrides_Set() const{
    return m_entity_overrides_isSet;
}

bool OAIFeature::is_entity_overrides_Valid() const{
    return m_entity_overrides_isValid;
}

QList OAIFeature::getEvaluationRules() const {
    return m_evaluation_rules;
}
void OAIFeature::setEvaluationRules(const QList &evaluation_rules) {
    m_evaluation_rules = evaluation_rules;
    m_evaluation_rules_isSet = true;
}

bool OAIFeature::is_evaluation_rules_Set() const{
    return m_evaluation_rules_isSet;
}

bool OAIFeature::is_evaluation_rules_Valid() const{
    return m_evaluation_rules_isValid;
}

OAIFeatureEvaluationStrategy OAIFeature::getEvaluationStrategy() const {
    return m_evaluation_strategy;
}
void OAIFeature::setEvaluationStrategy(const OAIFeatureEvaluationStrategy &evaluation_strategy) {
    m_evaluation_strategy = evaluation_strategy;
    m_evaluation_strategy_isSet = true;
}

bool OAIFeature::is_evaluation_strategy_Set() const{
    return m_evaluation_strategy_isSet;
}

bool OAIFeature::is_evaluation_strategy_Valid() const{
    return m_evaluation_strategy_isValid;
}

QDateTime OAIFeature::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIFeature::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIFeature::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIFeature::is_last_updated_time_Valid() const{
...
QString OAIFeature::getProject() const {
    return m_project;
}
void OAIFeature::setProject(const QString &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAIFeature::is_project_Set() const{
    return m_project_isSet;
}

bool OAIFeature::is_project_Valid() const{
    return m_project_isValid;
}

OAIFeatureStatus OAIFeature::getStatus() const {
    return m_status;
}
void OAIFeature::setStatus(const OAIFeatureStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QMap OAIFeature::getTags() const {
    return m_tags;
}
void OAIFeature::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
OAIVariationValueType OAIFeature::getValueType() const {
    return m_value_type;
}
void OAIFeature::setValueType(const OAIVariationValueType &value_type) {
    m_value_type = value_type;
    m_value_type_isSet = true;
}

bool OAIFeature::is_value_type_Set() const{
    return m_value_type_isSet;
}

bool OAIFeature::is_value_type_Valid() const{
    return m_value_type_isValid;
}

QList OAIFeature::getVariations() const {
    return m_variations;
}
void OAIFeature::setVariations(const QList &variations) {
    m_variations = variations;
    m_variations_isSet = true;
}

bool OAIFeature::is_variations_Set() const{
    return m_variations_isSet;
}

bool OAIFeature::is_variations_Valid() const{
