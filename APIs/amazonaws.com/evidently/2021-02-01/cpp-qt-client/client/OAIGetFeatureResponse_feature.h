...
/*
 * OAIGetFeatureResponse_feature.h
 *
 * 
 */

#ifndef OAIGetFeatureResponse_feature_H
#define OAIGetFeatureResponse_feature_H
...
class OAIGetFeatureResponse_feature : public OAIObject {
public:
    OAIGetFeatureResponse_feature();
    OAIGetFeatureResponse_feature(QString json);
    ~OAIGetFeatureResponse_feature() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFeatureResponse_feature)

#endif // OAIGetFeatureResponse_feature_H
