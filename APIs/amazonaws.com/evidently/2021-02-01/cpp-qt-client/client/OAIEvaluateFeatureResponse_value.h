...
/*
 * OAIEvaluateFeatureResponse_value.h
 *
 * 
 */

#ifndef OAIEvaluateFeatureResponse_value_H
#define OAIEvaluateFeatureResponse_value_H
...
class OAIEvaluateFeatureResponse_value : public OAIObject {
public:
    OAIEvaluateFeatureResponse_value();
    OAIEvaluateFeatureResponse_value(QString json);
    ~OAIEvaluateFeatureResponse_value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateFeatureResponse_value)

#endif // OAIEvaluateFeatureResponse_value_H
