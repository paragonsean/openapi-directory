...
QString OAIExperiment::getArn() const {
    return m_arn;
}
void OAIExperiment::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIExperiment::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIExperiment::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIExperiment::getCreatedTime() const {
    return m_created_time;
}
void OAIExperiment::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIExperiment::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIExperiment::is_created_time_Valid() const{
...
OAIExperiment_execution OAIExperiment::getExecution() const {
    return m_execution;
}
void OAIExperiment::setExecution(const OAIExperiment_execution &execution) {
    m_execution = execution;
    m_execution_isSet = true;
}

bool OAIExperiment::is_execution_Set() const{
    return m_execution_isSet;
}

bool OAIExperiment::is_execution_Valid() const{
    return m_execution_isValid;
}

QDateTime OAIExperiment::getLastUpdatedTime() const {
    return m_last_updated_time;
}
void OAIExperiment::setLastUpdatedTime(const QDateTime &last_updated_time) {
    m_last_updated_time = last_updated_time;
    m_last_updated_time_isSet = true;
}

bool OAIExperiment::is_last_updated_time_Set() const{
    return m_last_updated_time_isSet;
}

bool OAIExperiment::is_last_updated_time_Valid() const{
    return m_last_updated_time_isValid;
}

QList OAIExperiment::getMetricGoals() const {
    return m_metric_goals;
}
void OAIExperiment::setMetricGoals(const QList &metric_goals) {
    m_metric_goals = metric_goals;
    m_metric_goals_isSet = true;
}

bool OAIExperiment::is_metric_goals_Set() const{
    return m_metric_goals_isSet;
}

bool OAIExperiment::is_metric_goals_Valid() const{
    return m_metric_goals_isValid;
}

QString OAIExperiment::getName() const {
    return m_name;
}
void OAIExperiment::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIExperiment::is_name_Set() const{
    return m_name_isSet;
}

bool OAIExperiment::is_name_Valid() const{
    return m_name_isValid;
}

OAIExperiment_onlineAbDefinition OAIExperiment::getOnlineAbDefinition() const {
    return m_online_ab_definition;
}
void OAIExperiment::setOnlineAbDefinition(const OAIExperiment_onlineAbDefinition &online_ab_definition) {
    m_online_ab_definition = online_ab_definition;
    m_online_ab_definition_isSet = true;
}

bool OAIExperiment::is_online_ab_definition_Set() const{
    return m_online_ab_definition_isSet;
}

bool OAIExperiment::is_online_ab_definition_Valid() const{
    return m_online_ab_definition_isValid;
}

QString OAIExperiment::getProject() const {
    return m_project;
}
void OAIExperiment::setProject(const QString &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAIExperiment::is_project_Set() const{
    return m_project_isSet;
}

bool OAIExperiment::is_project_Valid() const{
    return m_project_isValid;
}

QString OAIExperiment::getRandomizationSalt() const {
    return m_randomization_salt;
}
void OAIExperiment::setRandomizationSalt(const QString &randomization_salt) {
    m_randomization_salt = randomization_salt;
    m_randomization_salt_isSet = true;
}

bool OAIExperiment::is_randomization_salt_Set() const{
    return m_randomization_salt_isSet;
}

bool OAIExperiment::is_randomization_salt_Valid() const{
    return m_randomization_salt_isValid;
}

qint32 OAIExperiment::getSamplingRate() const {
    return m_sampling_rate;
}
void OAIExperiment::setSamplingRate(const qint32 &sampling_rate) {
    m_sampling_rate = sampling_rate;
    m_sampling_rate_isSet = true;
}

bool OAIExperiment::is_sampling_rate_Set() const{
    return m_sampling_rate_isSet;
}

bool OAIExperiment::is_sampling_rate_Valid() const{
    return m_sampling_rate_isValid;
}

OAIExperiment_schedule OAIExperiment::getSchedule() const {
    return m_schedule;
}
void OAIExperiment::setSchedule(const OAIExperiment_schedule &schedule) {
    m_schedule = schedule;
    m_schedule_isSet = true;
}

bool OAIExperiment::is_schedule_Set() const{
    return m_schedule_isSet;
}

bool OAIExperiment::is_schedule_Valid() const{
    return m_schedule_isValid;
}

QString OAIExperiment::getSegment() const {
    return m_segment;
}
void OAIExperiment::setSegment(const QString &segment) {
    m_segment = segment;
    m_segment_isSet = true;
}

bool OAIExperiment::is_segment_Set() const{
    return m_segment_isSet;
}

bool OAIExperiment::is_segment_Valid() const{
    return m_segment_isValid;
}

OAIExperimentStatus OAIExperiment::getStatus() const {
    return m_status;
}
void OAIExperiment::setStatus(const OAIExperimentStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIExperiment::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExperiment::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIExperiment::getStatusReason() const {
    return m_status_reason;
}
void OAIExperiment::setStatusReason(const QString &status_reason) {
    m_status_reason = status_reason;
    m_status_reason_isSet = true;
}

bool OAIExperiment::is_status_reason_Set() const{
    return m_status_reason_isSet;
}

bool OAIExperiment::is_status_reason_Valid() const{
...
QList OAIExperiment::getTreatments() const {
    return m_treatments;
}
void OAIExperiment::setTreatments(const QList &treatments) {
    m_treatments = treatments;
    m_treatments_isSet = true;
}

bool OAIExperiment::is_treatments_Set() const{
    return m_treatments_isSet;
}

bool OAIExperiment::is_treatments_Valid() const{
    return m_treatments_isValid;
}

OAIExperimentType OAIExperiment::getType() const {
    return m_type;
}
void OAIExperiment::setType(const OAIExperimentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExperiment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExperiment::is_type_Valid() const{
