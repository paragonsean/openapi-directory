...
/*
 * OAICreateFeature_request.h
 *
 * 
 */

#ifndef OAICreateFeature_request_H
#define OAICreateFeature_request_H
...
class OAICreateFeature_request : public OAIObject {
public:
    OAICreateFeature_request();
    OAICreateFeature_request(QString json);
    ~OAICreateFeature_request() override;
    ...
    QList<OAIVariationConfig> getVariations() const;
    void setVariations(const QList<OAIVariationConfig> &variations);
...
private:
    ...
    QList<OAIVariationConfig> m_variations;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFeature_request)

#endif // OAICreateFeature_request_H
