...
/*
 * OAIUpdateLaunchRequest.h
 *
 * 
 */

#ifndef OAIUpdateLaunchRequest_H
#define OAIUpdateLaunchRequest_H
...
class OAIUpdateLaunchRequest : public OAIObject {
public:
    OAIUpdateLaunchRequest();
    OAIUpdateLaunchRequest(QString json);
    ~OAIUpdateLaunchRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLaunchRequest)

#endif // OAIUpdateLaunchRequest_H
