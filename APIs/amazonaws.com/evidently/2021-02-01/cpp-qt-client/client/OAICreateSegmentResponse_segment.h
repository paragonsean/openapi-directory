...
/*
 * OAICreateSegmentResponse_segment.h
 *
 * 
 */

#ifndef OAICreateSegmentResponse_segment_H
#define OAICreateSegmentResponse_segment_H
...
class OAICreateSegmentResponse_segment : public OAIObject {
public:
    OAICreateSegmentResponse_segment();
    OAICreateSegmentResponse_segment(QString json);
    ~OAICreateSegmentResponse_segment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSegmentResponse_segment)

#endif // OAICreateSegmentResponse_segment_H
