...
/*
 * OAICreateFeatureResponse_feature.h
 *
 * 
 */

#ifndef OAICreateFeatureResponse_feature_H
#define OAICreateFeatureResponse_feature_H
...
class OAICreateFeatureResponse_feature : public OAIObject {
public:
    OAICreateFeatureResponse_feature();
    OAICreateFeatureResponse_feature(QString json);
    ~OAICreateFeatureResponse_feature() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFeatureResponse_feature)

#endif // OAICreateFeatureResponse_feature_H
