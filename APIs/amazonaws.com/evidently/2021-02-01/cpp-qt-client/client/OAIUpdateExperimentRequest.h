...
/*
 * OAIUpdateExperimentRequest.h
 *
 * 
 */

#ifndef OAIUpdateExperimentRequest_H
#define OAIUpdateExperimentRequest_H
...
namespace OpenAPI {
class OAIUpdateExperimentRequest_onlineAbConfig;

class OAIUpdateExperimentRequest : public OAIObject {
public:
    OAIUpdateExperimentRequest();
    OAIUpdateExperimentRequest(QString json);
    ~OAIUpdateExperimentRequest() override;
    ...
    OAIUpdateExperimentRequest_onlineAbConfig getOnlineAbConfig() const;
    void setOnlineAbConfig(const OAIUpdateExperimentRequest_onlineAbConfig &online_ab_config);
    ...
    void setRemoveSegment(const bool &remove_segment);
    bool is_remove_segment_Set() const;
    bool is_remove_segment_Valid() const;
...
private:
    ...
    OAIUpdateExperimentRequest_onlineAbConfig m_online_ab_config;
    ...
    bool m_remove_segment;
    bool m_remove_segment_isSet;
    bool m_remove_segment_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentRequest)

#endif // OAIUpdateExperimentRequest_H
