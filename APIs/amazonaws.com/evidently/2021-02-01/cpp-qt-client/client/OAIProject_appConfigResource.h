...
/*
 * OAIProject_appConfigResource.h
 *
 * 
 */

#ifndef OAIProject_appConfigResource_H
#define OAIProject_appConfigResource_H
...
class OAIProject_appConfigResource : public OAIObject {
public:
    OAIProject_appConfigResource();
    OAIProject_appConfigResource(QString json);
    ~OAIProject_appConfigResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProject_appConfigResource)

#endif // OAIProject_appConfigResource_H
