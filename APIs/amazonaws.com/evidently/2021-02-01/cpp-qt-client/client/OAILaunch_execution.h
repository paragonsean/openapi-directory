...
/*
 * OAILaunch_execution.h
 *
 * 
 */

#ifndef OAILaunch_execution_H
#define OAILaunch_execution_H
...
class OAILaunch_execution : public OAIObject {
public:
    OAILaunch_execution();
    OAILaunch_execution(QString json);
    ~OAILaunch_execution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunch_execution)

#endif // OAILaunch_execution_H
