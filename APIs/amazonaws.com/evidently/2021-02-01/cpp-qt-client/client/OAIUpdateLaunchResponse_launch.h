...
/*
 * OAIUpdateLaunchResponse_launch.h
 *
 * 
 */

#ifndef OAIUpdateLaunchResponse_launch_H
#define OAIUpdateLaunchResponse_launch_H
...
class OAIUpdateLaunchResponse_launch : public OAIObject {
public:
    OAIUpdateLaunchResponse_launch();
    OAIUpdateLaunchResponse_launch(QString json);
    ~OAIUpdateLaunchResponse_launch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLaunchResponse_launch)

#endif // OAIUpdateLaunchResponse_launch_H
