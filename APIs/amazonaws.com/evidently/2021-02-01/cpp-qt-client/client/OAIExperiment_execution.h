...
/*
 * OAIExperiment_execution.h
 *
 * 
 */

#ifndef OAIExperiment_execution_H
#define OAIExperiment_execution_H
...
class OAIExperiment_execution : public OAIObject {
public:
    OAIExperiment_execution();
    OAIExperiment_execution(QString json);
    ~OAIExperiment_execution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperiment_execution)

#endif // OAIExperiment_execution_H
