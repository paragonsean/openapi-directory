...
/*
 * OAIMetricDefinitionConfig.h
 *
 * This structure defines a metric that you want to use to evaluate the variations during a launch or experiment.
 */

#ifndef OAIMetricDefinitionConfig_H
#define OAIMetricDefinitionConfig_H
...
class OAIMetricDefinitionConfig : public OAIObject {
public:
    OAIMetricDefinitionConfig();
    OAIMetricDefinitionConfig(QString json);
    ~OAIMetricDefinitionConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricDefinitionConfig)

#endif // OAIMetricDefinitionConfig_H
