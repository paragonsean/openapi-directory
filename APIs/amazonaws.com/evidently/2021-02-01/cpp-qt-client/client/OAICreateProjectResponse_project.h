...
/*
 * OAICreateProjectResponse_project.h
 *
 * 
 */

#ifndef OAICreateProjectResponse_project_H
#define OAICreateProjectResponse_project_H
...
class OAICreateProjectResponse_project : public OAIObject {
public:
    OAICreateProjectResponse_project();
    OAICreateProjectResponse_project(QString json);
    ~OAICreateProjectResponse_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectResponse_project)

#endif // OAICreateProjectResponse_project_H
