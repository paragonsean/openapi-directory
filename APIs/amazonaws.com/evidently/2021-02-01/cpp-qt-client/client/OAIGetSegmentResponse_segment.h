...
/*
 * OAIGetSegmentResponse_segment.h
 *
 * 
 */

#ifndef OAIGetSegmentResponse_segment_H
#define OAIGetSegmentResponse_segment_H
...
class OAIGetSegmentResponse_segment : public OAIObject {
public:
    OAIGetSegmentResponse_segment();
    OAIGetSegmentResponse_segment(QString json);
    ~OAIGetSegmentResponse_segment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSegmentResponse_segment)

#endif // OAIGetSegmentResponse_segment_H
