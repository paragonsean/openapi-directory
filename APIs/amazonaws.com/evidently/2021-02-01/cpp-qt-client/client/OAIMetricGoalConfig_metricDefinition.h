...
/*
 * OAIMetricGoalConfig_metricDefinition.h
 *
 * 
 */

#ifndef OAIMetricGoalConfig_metricDefinition_H
#define OAIMetricGoalConfig_metricDefinition_H
...
class OAIMetricGoalConfig_metricDefinition : public OAIObject {
public:
    OAIMetricGoalConfig_metricDefinition();
    OAIMetricGoalConfig_metricDefinition(QString json);
    ~OAIMetricGoalConfig_metricDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricGoalConfig_metricDefinition)

#endif // OAIMetricGoalConfig_metricDefinition_H
