...
#ifndef OAILaunchGroup_H
#define OAILaunchGroup_H
...
class OAILaunchGroup : public OAIObject {
public:
    OAILaunchGroup();
    OAILaunchGroup(QString json);
    ~OAILaunchGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchGroup)

#endif // OAILaunchGroup_H
