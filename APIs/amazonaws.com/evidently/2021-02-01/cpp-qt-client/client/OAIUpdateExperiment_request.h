...
/*
 * OAIUpdateExperiment_request.h
 *
 * 
 */

#ifndef OAIUpdateExperiment_request_H
#define OAIUpdateExperiment_request_H
...
class OAIUpdateExperiment_request : public OAIObject {
public:
    OAIUpdateExperiment_request();
    OAIUpdateExperiment_request(QString json);
    ~OAIUpdateExperiment_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperiment_request)

#endif // OAIUpdateExperiment_request_H
