...
OAIVariationConfig_value::OAIVariationConfig_value(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVariationConfig_value::OAIVariationConfig_value() {
    this->initializeModel();
}

OAIVariationConfig_value::~OAIVariationConfig_value() {}

void OAIVariationConfig_value::initializeModel() {
...
void OAIVariationConfig_value::fromJson(QString jsonString) {
...
void OAIVariationConfig_value::fromJsonObject(QJsonObject json) {
...
QString OAIVariationConfig_value::asJson() const {
...
QJsonObject OAIVariationConfig_value::asJsonObject() const {
    QJsonObject obj;
...
bool OAIVariationConfig_value::getBoolValue() const {
    return m_bool_value;
}
void OAIVariationConfig_value::setBoolValue(const bool &bool_value) {
    m_bool_value = bool_value;
    m_bool_value_isSet = true;
}

bool OAIVariationConfig_value::is_bool_value_Set() const{
    return m_bool_value_isSet;
}

bool OAIVariationConfig_value::is_bool_value_Valid() const{
    return m_bool_value_isValid;
}

double OAIVariationConfig_value::getDoubleValue() const {
    return m_double_value;
}
void OAIVariationConfig_value::setDoubleValue(const double &double_value) {
    m_double_value = double_value;
    m_double_value_isSet = true;
}

bool OAIVariationConfig_value::is_double_value_Set() const{
    return m_double_value_isSet;
}

bool OAIVariationConfig_value::is_double_value_Valid() const{
    return m_double_value_isValid;
}

qint32 OAIVariationConfig_value::getLongValue() const {
    return m_long_value;
}
void OAIVariationConfig_value::setLongValue(const qint32 &long_value) {
    m_long_value = long_value;
    m_long_value_isSet = true;
}

bool OAIVariationConfig_value::is_long_value_Set() const{
    return m_long_value_isSet;
}

bool OAIVariationConfig_value::is_long_value_Valid() const{
    return m_long_value_isValid;
}

QString OAIVariationConfig_value::getStringValue() const {
    return m_string_value;
}
void OAIVariationConfig_value::setStringValue(const QString &string_value) {
    m_string_value = string_value;
    m_string_value_isSet = true;
}

bool OAIVariationConfig_value::is_string_value_Set() const{
    return m_string_value_isSet;
}

bool OAIVariationConfig_value::is_string_value_Valid() const{
    return m_string_value_isValid;
}

bool OAIVariationConfig_value::isSet() const {
...
bool OAIVariationConfig_value::isValid() const {
