...
/*
 * OAIVariationConfig_value.h
 *
 * 
 */

#ifndef OAIVariationConfig_value_H
#define OAIVariationConfig_value_H
...
class OAIVariationConfig_value : public OAIObject {
public:
    OAIVariationConfig_value();
    OAIVariationConfig_value(QString json);
    ~OAIVariationConfig_value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariationConfig_value)

#endif // OAIVariationConfig_value_H
