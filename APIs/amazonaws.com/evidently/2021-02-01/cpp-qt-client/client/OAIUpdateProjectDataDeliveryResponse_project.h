...
/*
 * OAIUpdateProjectDataDeliveryResponse_project.h
 *
 * 
 */

#ifndef OAIUpdateProjectDataDeliveryResponse_project_H
#define OAIUpdateProjectDataDeliveryResponse_project_H
...
class OAIUpdateProjectDataDeliveryResponse_project : public OAIObject {
public:
    OAIUpdateProjectDataDeliveryResponse_project();
    OAIUpdateProjectDataDeliveryResponse_project(QString json);
    ~OAIUpdateProjectDataDeliveryResponse_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProjectDataDeliveryResponse_project)

#endif // OAIUpdateProjectDataDeliveryResponse_project_H
