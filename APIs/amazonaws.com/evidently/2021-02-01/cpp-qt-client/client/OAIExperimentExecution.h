...
/*
 * OAIExperimentExecution.h
 *
 * This structure contains the date and time that the experiment started and ended.
 */

#ifndef OAIExperimentExecution_H
#define OAIExperimentExecution_H
...
class OAIExperimentExecution : public OAIObject {
public:
    OAIExperimentExecution();
    OAIExperimentExecution(QString json);
    ~OAIExperimentExecution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentExecution)

#endif // OAIExperimentExecution_H
