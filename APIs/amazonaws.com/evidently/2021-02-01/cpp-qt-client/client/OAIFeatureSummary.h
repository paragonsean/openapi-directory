...
#ifndef OAIFeatureSummary_H
#define OAIFeatureSummary_H
...
class OAIFeatureSummary : public OAIObject {
public:
    OAIFeatureSummary();
    OAIFeatureSummary(QString json);
    ~OAIFeatureSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeatureSummary)

#endif // OAIFeatureSummary_H
