...
#ifndef OAIScheduledSplit_H
#define OAIScheduledSplit_H
...
class OAIScheduledSplit : public OAIObject {
public:
    OAIScheduledSplit();
    OAIScheduledSplit(QString json);
    ~OAIScheduledSplit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduledSplit)

#endif // OAIScheduledSplit_H
