...
/*
 * OAIEvaluateFeatureRequest.h
 *
 * 
 */

#ifndef OAIEvaluateFeatureRequest_H
#define OAIEvaluateFeatureRequest_H
...
class OAIEvaluateFeatureRequest : public OAIObject {
public:
    OAIEvaluateFeatureRequest();
    OAIEvaluateFeatureRequest(QString json);
    ~OAIEvaluateFeatureRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluateFeatureRequest)

#endif // OAIEvaluateFeatureRequest_H
