...
/*
 * OAIMetricMonitor_metricDefinition.h
 *
 * 
 */

#ifndef OAIMetricMonitor_metricDefinition_H
#define OAIMetricMonitor_metricDefinition_H
...
class OAIMetricMonitor_metricDefinition : public OAIObject {
public:
    OAIMetricMonitor_metricDefinition();
    OAIMetricMonitor_metricDefinition(QString json);
    ~OAIMetricMonitor_metricDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricMonitor_metricDefinition)

#endif // OAIMetricMonitor_metricDefinition_H
