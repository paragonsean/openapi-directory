...
/*
 * OAIUpdateProjectResponse_project.h
 *
 * 
 */

#ifndef OAIUpdateProjectResponse_project_H
#define OAIUpdateProjectResponse_project_H
...
class OAIUpdateProjectResponse_project : public OAIObject {
public:
    OAIUpdateProjectResponse_project();
    OAIUpdateProjectResponse_project(QString json);
    ~OAIUpdateProjectResponse_project() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProjectResponse_project)

#endif // OAIUpdateProjectResponse_project_H
