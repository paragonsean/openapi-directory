...
/*
 * OAIUpdateExperimentResponse_experiment.h
 *
 * 
 */

#ifndef OAIUpdateExperimentResponse_experiment_H
#define OAIUpdateExperimentResponse_experiment_H
...
class OAIUpdateExperimentResponse_experiment : public OAIObject {
public:
    OAIUpdateExperimentResponse_experiment();
    OAIUpdateExperimentResponse_experiment(QString json);
    ~OAIUpdateExperimentResponse_experiment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentResponse_experiment)

#endif // OAIUpdateExperimentResponse_experiment_H
