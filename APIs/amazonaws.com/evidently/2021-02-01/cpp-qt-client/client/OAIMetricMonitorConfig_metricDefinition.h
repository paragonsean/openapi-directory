...
/*
 * OAIMetricMonitorConfig_metricDefinition.h
 *
 * 
 */

#ifndef OAIMetricMonitorConfig_metricDefinition_H
#define OAIMetricMonitorConfig_metricDefinition_H
...
class OAIMetricMonitorConfig_metricDefinition : public OAIObject {
public:
    OAIMetricMonitorConfig_metricDefinition();
    OAIMetricMonitorConfig_metricDefinition(QString json);
    ~OAIMetricMonitorConfig_metricDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetricMonitorConfig_metricDefinition)

#endif // OAIMetricMonitorConfig_metricDefinition_H
