...
/*
 * OAIGetLaunchResponse_launch.h
 *
 * 
 */

#ifndef OAIGetLaunchResponse_launch_H
#define OAIGetLaunchResponse_launch_H
...
class OAIGetLaunchResponse_launch : public OAIObject {
public:
    OAIGetLaunchResponse_launch();
    OAIGetLaunchResponse_launch(QString json);
    ~OAIGetLaunchResponse_launch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLaunchResponse_launch)

#endif // OAIGetLaunchResponse_launch_H
