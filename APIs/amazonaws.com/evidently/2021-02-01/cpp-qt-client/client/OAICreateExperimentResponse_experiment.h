...
/*
 * OAICreateExperimentResponse_experiment.h
 *
 * 
 */

#ifndef OAICreateExperimentResponse_experiment_H
#define OAICreateExperimentResponse_experiment_H
...
class OAICreateExperimentResponse_experiment : public OAIObject {
public:
    OAICreateExperimentResponse_experiment();
    OAICreateExperimentResponse_experiment(QString json);
    ~OAICreateExperimentResponse_experiment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExperimentResponse_experiment)

#endif // OAICreateExperimentResponse_experiment_H
