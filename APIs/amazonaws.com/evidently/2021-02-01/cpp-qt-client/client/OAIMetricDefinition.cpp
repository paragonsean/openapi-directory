...
QString OAIMetricDefinition::getEntityIdKey() const {
    return m_entity_id_key;
}
void OAIMetricDefinition::setEntityIdKey(const QString &entity_id_key) {
    m_entity_id_key = entity_id_key;
    m_entity_id_key_isSet = true;
}

bool OAIMetricDefinition::is_entity_id_key_Set() const{
    return m_entity_id_key_isSet;
}

bool OAIMetricDefinition::is_entity_id_key_Valid() const{
