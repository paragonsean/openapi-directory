...
#include "OAICreateExperimentRequest_onlineAbConfig.h"
#include <QList>
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAICreateExperimentRequest_onlineAbConfig;
...
public:
    ...
    OAICreateExperimentRequest_onlineAbConfig getOnlineAbConfig() const;
    void setOnlineAbConfig(const OAICreateExperimentRequest_onlineAbConfig &online_ab_config);
...
private:
    ...
    OAICreateExperimentRequest_onlineAbConfig m_online_ab_config;
