...
/*
 * OAILaunchGroupConfig.h
 *
 * A structure that defines one launch group in a launch. A launch group is a variation of the feature that you are including in the launch.
 */

#ifndef OAILaunchGroupConfig_H
#define OAILaunchGroupConfig_H
...
class OAILaunchGroupConfig : public OAIObject {
public:
    OAILaunchGroupConfig();
    OAILaunchGroupConfig(QString json);
    ~OAILaunchGroupConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchGroupConfig)

#endif // OAILaunchGroupConfig_H
