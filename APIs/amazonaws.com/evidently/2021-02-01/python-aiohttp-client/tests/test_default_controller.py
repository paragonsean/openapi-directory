...
async def test_batch_evaluate_feature(client):
    """Test case for batch_evaluate_feature
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/evaluations'.format(project='project_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_experiment(client):
    ...
    """
    body = {"segment":"","name":"","samplingRate":"","description":"","metricGoals":"","onlineAbConfig":{"controlTreatmentName":"","treatmentWeights":""},"treatments":"","randomizationSalt":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/experiments'.format(project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_feature(client):
    ...
    """
    body = {"defaultVariation":"","evaluationStrategy":"","variations":"","name":"","description":"","entityOverrides":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/features'.format(project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_launch(client):
    """Test case for create_launch

    
    """
    body = {"metricMonitors":"","name":"","description":"","groups":"","scheduledSplitsConfig":{"steps":""},"randomizationSalt":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/launches'.format(project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_project(client):
    ...
    """
    body = {"name":"","description":"","appConfigResource":{"environmentId":"","applicationId":""},"dataDelivery":{"s3Destination":{"bucket":"","prefix":""},"cloudWatchLogs":{"logGroup":""}},"tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_segment(client):
    ...
    """
    body = {"name":"","pattern":"","description":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_experiment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/{project}/experiments/{experiment}'.format(experiment='experiment_example', project='project_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_feature(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/{project}/features/{feature}'.format(feature='feature_example', project='project_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_launch(client):
    """Test case for delete_launch
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/{project}/launches/{launch}'.format(launch='launch_example', project='project_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_project(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/{project}'.format(project='project_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_segment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/segments/{segment}'.format(segment='segment_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_evaluate_feature(client):
    """Test case for evaluate_feature

    
    """
    body = {"evaluationContext":"","entityId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/evaluations/{feature}'.format(feature='feature_example', project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_experiment_results(client):
    ...
    """
    body = {"metricNames":"","reportNames":"","resultStats":"","period":"","baseStat":"","startTime":"","endTime":"","treatmentNames":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/experiments/{experiment}/results'.format(experiment='experiment_example', project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_segment_references(client):
    """Test case for list_segment_references
    ...
    response = await client.request(
        method='GET',
        path='/segments/{segment}/references#type'.format(segment='segment_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_project_events(client):
    """Test case for put_project_events
    ...
    response = await client.request(
        method='POST',
        path='/events/projects/{project}'.format(project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_experiment(client):
    """Test case for start_experiment

    
    """
    body = {"analysisCompleteTime":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/experiments/{experiment}/start'.format(experiment='experiment_example', project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_launch(client):
    """Test case for start_launch
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/launches/{launch}/start'.format(launch='launch_example', project='project_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_experiment(client):
    """Test case for stop_experiment

    
    """
    body = {"desiredState":"","reason":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/experiments/{experiment}/cancel'.format(experiment='experiment_example', project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_stop_launch(client):
    """Test case for stop_launch
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project}/launches/{launch}/cancel'.format(launch='launch_example', project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_test_segment_pattern(client):
    """Test case for test_segment_pattern

    
    """
    body = {"payload":"","pattern":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_experiment(client):
    ...
    """
    body = {"segment":"","samplingRate":"","description":"","removeSegment":"","metricGoals":"","onlineAbConfig":{"controlTreatmentName":"","treatmentWeights":""},"treatments":"","randomizationSalt":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_feature(client):
    ...
    """
    body = {"defaultVariation":"","addOrUpdateVariations":"","evaluationStrategy":"","description":"","entityOverrides":"","removeVariations":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_launch(client):
    """Test case for update_launch

    
    """
    body = {"metricMonitors":"","description":"","groups":"","scheduledSplitsConfig":{"steps":""},"randomizationSalt":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_project(client):
    ...
    """
    body = {"description":"","appConfigResource":{"environmentId":"","applicationId":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_project_data_delivery(client):
    """Test case for update_project_data_delivery

    
    """
    body = {"s3Destination":{"bucket":"","prefix":""},"cloudWatchLogs":{"logGroup":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='PATCH',
        path='/projects/{project}/data-delivery'.format(project='project_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
