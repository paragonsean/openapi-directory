...
class CreateSnapshotRequest(Model):
    ...
    def __init__(self, description: str=None):
        ...
        :param description: The description of this CreateSnapshotRequest.
        """
        self.openapi_types = {
            'description': str
        }
    ...
    def description(self):
        """Gets the description of this CreateSnapshotRequest.

        The description of the snapshot.

        :return: The description of this CreateSnapshotRequest.
        :rtype: str
        """
