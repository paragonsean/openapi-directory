...
async def test_create_game(client):
    ...
    """
    body = {"Description":"","GameName":"","ClientToken":"","Tags":""}
    headers = { 
...
async def test_create_snapshot(client):
    ...
    response = await client.request(
        method='POST',
        path='/game/{game_name}/snapshot'.format(game_name='game_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_stage(client):
    ...
    """
    body = {"Role":"","Description":"","StageName":"","ClientToken":"","Tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/game/{game_name}/stage'.format(game_name='game_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_game(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/game/{game_name}'.format(game_name='game_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_stage(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/game/{game_name}/stage/{stage_name}'.format(game_name='game_name_example', stage_name='stage_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disconnect_player(client):
    """Test case for disconnect_player
    ...
    response = await client.request(
        method='POST',
        path='/runtime/game/{game_name}/stage/{stage_name}/player/{player_id}/disconnect'.format(game_name='game_name_example', player_id='player_id_example', stage_name='stage_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_export_snapshot(client):
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/snapshot/{snapshot_id}/export'.format(game_name='game_name_example', snapshot_id='snapshot_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_extension(client):
    ...
    response = await client.request(
        method='GET',
        path='/extension/{namespace}/{name}'.format(name='name_example', namespace='namespace_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_extension_version(client):
    """Test case for get_extension_version
    ...
    response = await client.request(
        method='GET',
        path='/extension/{namespace}/{name}/version/{extension_version}'.format(extension_version='extension_version_example', name='name_example', namespace='namespace_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_game_configuration(client):
    """Test case for get_game_configuration

    
    """
    params = [('Sections', ['sections_example'])]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/configuration'.format(game_name='game_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_generated_code_job(client):
    """Test case for get_generated_code_job
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/snapshot/{snapshot_id}/generated-sdk-code-job/{job_id}'.format(game_name='game_name_example', job_id='job_id_example', snapshot_id='snapshot_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_player_connection_status(client):
    """Test case for get_player_connection_status
    ...
    response = await client.request(
        method='GET',
        path='/runtime/game/{game_name}/stage/{stage_name}/player/{player_id}/connection'.format(game_name='game_name_example', player_id='player_id_example', stage_name='stage_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_snapshot(client):
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/snapshot/{snapshot_id}'.format(game_name='game_name_example', snapshot_id='snapshot_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_stage_deployment(client):
    """Test case for get_stage_deployment
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/stage/{stage_name}/deployment'.format(game_name='game_name_example', stage_name='stage_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_import_game_configuration(client):
    """Test case for import_game_configuration

    
    """
    body = {"ImportSource":{"File":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_extension_versions(client):
    """Test case for list_extension_versions
    ...
    response = await client.request(
        method='GET',
        path='/extension/{namespace}/{name}/version'.format(name='name_example', namespace='namespace_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_generated_code_jobs(client):
    """Test case for list_generated_code_jobs
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/snapshot/{snapshot_id}/generated-sdk-code-jobs'.format(game_name='game_name_example', snapshot_id='snapshot_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_stage_deployments(client):
    """Test case for list_stage_deployments
    ...
    response = await client.request(
        method='GET',
        path='/game/{game_name}/stage/{stage_name}/deployments'.format(game_name='game_name_example', stage_name='stage_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_generated_code_job(client):
    """Test case for start_generated_code_job

    
    """
    body = {"Generator":{"Language":"","TargetPlatform":"","GameSdkVersion":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/game/{game_name}/snapshot/{snapshot_id}/generated-sdk-code-job'.format(game_name='game_name_example', snapshot_id='snapshot_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_start_stage_deployment(client):
    """Test case for start_stage_deployment

    
    """
    body = {"SnapshotId":"","ClientToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_game_configuration(client):
    """Test case for update_game_configuration
