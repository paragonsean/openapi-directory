...
/*
 * OAIExtensionVersionDetails.h
 *
 * Details about the extension version.
 */

#ifndef OAIExtensionVersionDetails_H
#define OAIExtensionVersionDetails_H
...
class OAIExtensionVersionDetails : public OAIObject {
public:
    OAIExtensionVersionDetails();
    OAIExtensionVersionDetails(QString json);
    ~OAIExtensionVersionDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtensionVersionDetails)

#endif // OAIExtensionVersionDetails_H
