...
/*
 * OAICreateGameResult_Game.h
 *
 * 
 */

#ifndef OAICreateGameResult_Game_H
#define OAICreateGameResult_Game_H
...
class OAICreateGameResult_Game : public OAIObject {
public:
    OAICreateGameResult_Game();
    OAICreateGameResult_Game(QString json);
    ~OAICreateGameResult_Game() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateGameResult_Game)

#endif // OAICreateGameResult_Game_H
