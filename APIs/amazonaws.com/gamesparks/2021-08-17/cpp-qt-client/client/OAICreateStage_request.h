...
/*
 * OAICreateStage_request.h
 *
 * 
 */

#ifndef OAICreateStage_request_H
#define OAICreateStage_request_H
...
class OAICreateStage_request : public OAIObject {
public:
    OAICreateStage_request();
    OAICreateStage_request(QString json);
    ~OAICreateStage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStage_request)

#endif // OAICreateStage_request_H
