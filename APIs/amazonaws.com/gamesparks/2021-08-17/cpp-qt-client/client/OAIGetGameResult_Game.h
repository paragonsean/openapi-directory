...
/*
 * OAIGetGameResult_Game.h
 *
 * 
 */

#ifndef OAIGetGameResult_Game_H
#define OAIGetGameResult_Game_H
...
class OAIGetGameResult_Game : public OAIObject {
public:
    OAIGetGameResult_Game();
    OAIGetGameResult_Game(QString json);
    ~OAIGetGameResult_Game() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGameResult_Game)

#endif // OAIGetGameResult_Game_H
