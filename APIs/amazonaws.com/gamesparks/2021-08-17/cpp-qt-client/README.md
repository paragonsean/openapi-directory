...
OAICreateGame_request Example::create(){
    OAICreateGame_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createGameSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createGameSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateGame_request oai_create_game_request = create(); // OAICreateGame_request | 
      ...
      apiInstance.createGame(oai_create_game_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
