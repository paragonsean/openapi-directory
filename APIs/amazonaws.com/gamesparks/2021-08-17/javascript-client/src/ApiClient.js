...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://gamesparks.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://gamesparks.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-08-17/Javascript'
        };
