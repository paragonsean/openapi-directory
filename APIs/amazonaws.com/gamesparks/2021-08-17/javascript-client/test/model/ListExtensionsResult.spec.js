...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.ListExtensionsResult();
  });
  ...
  describe('ListExtensionsResult', function() {
    it('should create an instance of ListExtensionsResult', function() {
      // uncomment below and update the code to test ListExtensionsResult
      //var instance = new GameSparks.ListExtensionsResult();
      //expect(instance).to.be.a(GameSparks.ListExtensionsResult);
    });
