...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.StartStageDeploymentRequest();
  });
  ...
  describe('StartStageDeploymentRequest', function() {
    it('should create an instance of StartStageDeploymentRequest', function() {
      // uncomment below and update the code to test StartStageDeploymentRequest
      //var instance = new GameSparks.StartStageDeploymentRequest();
      //expect(instance).to.be.a(GameSparks.StartStageDeploymentRequest);
    });
