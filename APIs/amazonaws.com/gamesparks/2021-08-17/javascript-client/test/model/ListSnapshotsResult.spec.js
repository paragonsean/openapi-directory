...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.ListSnapshotsResult();
  });
  ...
  describe('ListSnapshotsResult', function() {
    it('should create an instance of ListSnapshotsResult', function() {
      // uncomment below and update the code to test ListSnapshotsResult
      //var instance = new GameSparks.ListSnapshotsResult();
      //expect(instance).to.be.a(GameSparks.ListSnapshotsResult);
    });
