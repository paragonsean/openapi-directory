...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.GetStageResult();
  });
  ...
  describe('GetStageResult', function() {
    it('should create an instance of GetStageResult', function() {
      // uncomment below and update the code to test GetStageResult
      //var instance = new GameSparks.GetStageResult();
      //expect(instance).to.be.a(GameSparks.GetStageResult);
    });
