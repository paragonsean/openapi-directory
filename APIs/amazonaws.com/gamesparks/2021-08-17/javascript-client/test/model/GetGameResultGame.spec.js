...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.GetGameResultGame();
  });
  ...
  describe('GetGameResultGame', function() {
    it('should create an instance of GetGameResultGame', function() {
      // uncomment below and update the code to test GetGameResultGame
      //var instance = new GameSparks.GetGameResultGame();
      //expect(instance).to.be.a(GameSparks.GetGameResultGame);
    });
