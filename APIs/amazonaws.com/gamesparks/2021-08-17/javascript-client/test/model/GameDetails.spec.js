...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.GameDetails();
  });
  ...
  describe('GameDetails', function() {
    it('should create an instance of GameDetails', function() {
      // uncomment below and update the code to test GameDetails
      //var instance = new GameSparks.GameDetails();
      //expect(instance).to.be.a(GameSparks.GameDetails);
    });
