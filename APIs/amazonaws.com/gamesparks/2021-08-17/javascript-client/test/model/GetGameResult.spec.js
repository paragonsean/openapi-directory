...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameSparks.GetGameResult();
  });
  ...
  describe('GetGameResult', function() {
    it('should create an instance of GetGameResult', function() {
      // uncomment below and update the code to test GetGameResult
      //var instance = new GameSparks.GetGameResult();
      //expect(instance).to.be.a(GameSparks.GetGameResult);
    });
