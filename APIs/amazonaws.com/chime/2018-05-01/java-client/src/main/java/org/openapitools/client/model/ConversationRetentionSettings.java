...
public class ConversationRetentionSettings {
  ...
  public ConversationRetentionSettings() {
  }

  public ConversationRetentionSettings retentionDays(Integer retentionDays) {
  ...
  public boolean equals(Object o) {
    ...
    ConversationRetentionSettings conversationRetentionSettings = (ConversationRetentionSettings) o;
    return Objects.equals(this.retentionDays, conversationRetentionSettings.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationRetentionSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConversationRetentionSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversationRetentionSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationRetentionSettings is not found in the empty JSON string", ConversationRetentionSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversationRetentionSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationRetentionSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversationRetentionSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversationRetentionSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConversationRetentionSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConversationRetentionSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ConversationRetentionSettings>() {
           @Override
           public void write(JsonWriter out, ConversationRetentionSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConversationRetentionSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConversationRetentionSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConversationRetentionSettings
   * @throws IOException if the JSON string is invalid with respect to ConversationRetentionSettings
   */
  public static ConversationRetentionSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConversationRetentionSettings.class);
  }

  /**
   * Convert an instance of ConversationRetentionSettings to an JSON string
   *
   * @return JSON string
   */
