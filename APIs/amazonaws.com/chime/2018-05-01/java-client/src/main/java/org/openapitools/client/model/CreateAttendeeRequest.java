...
public class CreateAttendeeRequest {
  ...
  public CreateAttendeeRequest externalUserId(String externalUserId) {
  ...
  public CreateAttendeeRequest tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public CreateAttendeeRequest addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAttendeeRequest createAttendeeRequest = (CreateAttendeeRequest) o;
    return Objects.equals(this.externalUserId, createAttendeeRequest.externalUserId) &&
        Objects.equals(this.tags, createAttendeeRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAttendeeRequest {\n");
    sb.append("    externalUserId: ").append("*").append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAttendeeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAttendeeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAttendeeRequest is not found in the empty JSON string", CreateAttendeeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAttendeeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAttendeeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAttendeeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAttendeeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAttendeeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAttendeeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAttendeeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAttendeeRequest>() {
           @Override
           public void write(JsonWriter out, CreateAttendeeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAttendeeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAttendeeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAttendeeRequest
   * @throws IOException if the JSON string is invalid with respect to CreateAttendeeRequest
   */
  public static CreateAttendeeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAttendeeRequest.class);
  }

  /**
   * Convert an instance of CreateAttendeeRequest to an JSON string
   *
   * @return JSON string
   */
