 ...
 */
@JsonAdapter(MemberType.Adapter.class)
public enum MemberType {
  ...
  public static class Adapter extends TypeAdapter<MemberType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MemberType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MemberType read(final JsonReader jsonReader) throws IOException {
