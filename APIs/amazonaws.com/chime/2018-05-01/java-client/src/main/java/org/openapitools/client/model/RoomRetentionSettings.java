...
public class RoomRetentionSettings {
  ...
  public RoomRetentionSettings() {
  }

  public RoomRetentionSettings retentionDays(Integer retentionDays) {
  ...
  public boolean equals(Object o) {
    ...
    RoomRetentionSettings roomRetentionSettings = (RoomRetentionSettings) o;
    return Objects.equals(this.retentionDays, roomRetentionSettings.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomRetentionSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoomRetentionSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoomRetentionSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoomRetentionSettings is not found in the empty JSON string", RoomRetentionSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoomRetentionSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoomRetentionSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoomRetentionSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoomRetentionSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoomRetentionSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoomRetentionSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<RoomRetentionSettings>() {
           @Override
           public void write(JsonWriter out, RoomRetentionSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoomRetentionSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoomRetentionSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoomRetentionSettings
   * @throws IOException if the JSON string is invalid with respect to RoomRetentionSettings
   */
  public static RoomRetentionSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoomRetentionSettings.class);
  }

  /**
   * Convert an instance of RoomRetentionSettings to an JSON string
   *
   * @return JSON string
   */
