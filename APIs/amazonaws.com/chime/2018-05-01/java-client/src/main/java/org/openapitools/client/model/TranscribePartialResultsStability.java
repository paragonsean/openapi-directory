...
/**
 * Gets or Sets TranscribePartialResultsStability
 */
@JsonAdapter(TranscribePartialResultsStability.Adapter.class)
public enum TranscribePartialResultsStability {
  ...
  TranscribePartialResultsStability(String value) {
    this.value = value;
  }
  ...
  public static TranscribePartialResultsStability fromValue(String value) {
    for (TranscribePartialResultsStability b : TranscribePartialResultsStability.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribePartialResultsStability> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribePartialResultsStability enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribePartialResultsStability read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribePartialResultsStability.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribePartialResultsStability.fromValue(value);
  }
}
