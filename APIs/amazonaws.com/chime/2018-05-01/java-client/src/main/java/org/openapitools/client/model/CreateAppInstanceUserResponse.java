...
public class CreateAppInstanceUserResponse {
  ...
  public CreateAppInstanceUserResponse() {
  }

  public CreateAppInstanceUserResponse appInstanceUserArn(String appInstanceUserArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAppInstanceUserResponse createAppInstanceUserResponse = (CreateAppInstanceUserResponse) o;
    return Objects.equals(this.appInstanceUserArn, createAppInstanceUserResponse.appInstanceUserArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAppInstanceUserResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAppInstanceUserResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAppInstanceUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAppInstanceUserResponse is not found in the empty JSON string", CreateAppInstanceUserResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAppInstanceUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAppInstanceUserResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAppInstanceUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAppInstanceUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAppInstanceUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAppInstanceUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAppInstanceUserResponse>() {
           @Override
           public void write(JsonWriter out, CreateAppInstanceUserResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAppInstanceUserResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAppInstanceUserResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAppInstanceUserResponse
   * @throws IOException if the JSON string is invalid with respect to CreateAppInstanceUserResponse
   */
  public static CreateAppInstanceUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAppInstanceUserResponse.class);
  }

  /**
   * Convert an instance of CreateAppInstanceUserResponse to an JSON string
   *
   * @return JSON string
   */
