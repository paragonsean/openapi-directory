...
/**
 * Gets or Sets TranscribeContentRedactionType
 */
@JsonAdapter(TranscribeContentRedactionType.Adapter.class)
public enum TranscribeContentRedactionType {
  ...
  TranscribeContentRedactionType(String value) {
    this.value = value;
  }
  ...
  public static TranscribeContentRedactionType fromValue(String value) {
    for (TranscribeContentRedactionType b : TranscribeContentRedactionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeContentRedactionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeContentRedactionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeContentRedactionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeContentRedactionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeContentRedactionType.fromValue(value);
  }
}
