...
/**
 * Gets or Sets ProxySessionStatus
 */
@JsonAdapter(ProxySessionStatus.Adapter.class)
public enum ProxySessionStatus {
  ...
  ProxySessionStatus(String value) {
    this.value = value;
  }
  ...
  public static ProxySessionStatus fromValue(String value) {
    for (ProxySessionStatus b : ProxySessionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ProxySessionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProxySessionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProxySessionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProxySessionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProxySessionStatus.fromValue(value);
  }
}
