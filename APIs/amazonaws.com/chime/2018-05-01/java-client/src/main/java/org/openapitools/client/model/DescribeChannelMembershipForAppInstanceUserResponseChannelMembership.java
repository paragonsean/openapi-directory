...
public class DescribeChannelMembershipForAppInstanceUserResponseChannelMembership {
  ...
  public DescribeChannelMembershipForAppInstanceUserResponseChannelMembership() {
  }

  public DescribeChannelMembershipForAppInstanceUserResponseChannelMembership channelSummary(ChannelMembershipForAppInstanceUserSummaryChannelSummary channelSummary) {
  ...
  public DescribeChannelMembershipForAppInstanceUserResponseChannelMembership appInstanceUserMembershipSummary(ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary appInstanceUserMembershipSummary) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeChannelMembershipForAppInstanceUserResponseChannelMembership describeChannelMembershipForAppInstanceUserResponseChannelMembership = (DescribeChannelMembershipForAppInstanceUserResponseChannelMembership) o;
    return Objects.equals(this.channelSummary, describeChannelMembershipForAppInstanceUserResponseChannelMembership.channelSummary) &&
        Objects.equals(this.appInstanceUserMembershipSummary, describeChannelMembershipForAppInstanceUserResponseChannelMembership.appInstanceUserMembershipSummary);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeChannelMembershipForAppInstanceUserResponseChannelMembership {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeChannelMembershipForAppInstanceUserResponseChannelMembership
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeChannelMembershipForAppInstanceUserResponseChannelMembership is not found in the empty JSON string", DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeChannelMembershipForAppInstanceUserResponseChannelMembership` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeChannelMembershipForAppInstanceUserResponseChannelMembership' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeChannelMembershipForAppInstanceUserResponseChannelMembership> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeChannelMembershipForAppInstanceUserResponseChannelMembership>() {
           @Override
           public void write(JsonWriter out, DescribeChannelMembershipForAppInstanceUserResponseChannelMembership value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeChannelMembershipForAppInstanceUserResponseChannelMembership read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeChannelMembershipForAppInstanceUserResponseChannelMembership given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeChannelMembershipForAppInstanceUserResponseChannelMembership
   * @throws IOException if the JSON string is invalid with respect to DescribeChannelMembershipForAppInstanceUserResponseChannelMembership
   */
  public static DescribeChannelMembershipForAppInstanceUserResponseChannelMembership fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeChannelMembershipForAppInstanceUserResponseChannelMembership.class);
  }

  /**
   * Convert an instance of DescribeChannelMembershipForAppInstanceUserResponseChannelMembership to an JSON string
   *
   * @return JSON string
   */
