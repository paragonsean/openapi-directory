...
public class UpdateUserRequestItem {
  ...
  public UpdateUserRequestItem userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UpdateUserRequestItem licenseType(License licenseType) {
  ...
  public UpdateUserRequestItem userType(UserType userType) {
  ...
  public UpdateUserRequestItem alexaForBusinessMetadata(UpdateUserRequestItemAlexaForBusinessMetadata alexaForBusinessMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserRequestItem updateUserRequestItem = (UpdateUserRequestItem) o;
    return Objects.equals(this.userId, updateUserRequestItem.userId) &&
        Objects.equals(this.licenseType, updateUserRequestItem.licenseType) &&
        Objects.equals(this.userType, updateUserRequestItem.userType) &&
        Objects.equals(this.alexaForBusinessMetadata, updateUserRequestItem.alexaForBusinessMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userId, licenseType, userType, alexaForBusinessMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateUserRequestItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserRequestItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserRequestItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserRequestItem is not found in the empty JSON string", UpdateUserRequestItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserRequestItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserRequestItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateUserRequestItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserRequestItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserRequestItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserRequestItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserRequestItem.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserRequestItem>() {
           @Override
           public void write(JsonWriter out, UpdateUserRequestItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserRequestItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserRequestItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserRequestItem
   * @throws IOException if the JSON string is invalid with respect to UpdateUserRequestItem
   */
  public static UpdateUserRequestItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserRequestItem.class);
  }

  /**
   * Convert an instance of UpdateUserRequestItem to an JSON string
   *
   * @return JSON string
   */
