...
public class EngineTranscribeSettings {
  ...
  public EngineTranscribeSettings() {
  }

  public EngineTranscribeSettings languageCode(TranscribeLanguageCode languageCode) {
  ...
  public EngineTranscribeSettings vocabularyFilterMethod(TranscribeVocabularyFilterMethod vocabularyFilterMethod) {
  ...
  public EngineTranscribeSettings vocabularyFilterName(String vocabularyFilterName) {
  ...
  public EngineTranscribeSettings vocabularyName(String vocabularyName) {
  ...
  public EngineTranscribeSettings region(TranscribeRegion region) {
    this.region = region;
    return this;
  }
  ...
  public EngineTranscribeSettings enablePartialResultsStabilization(Boolean enablePartialResultsStabilization) {
  ...
  public EngineTranscribeSettings partialResultsStability(TranscribePartialResultsStability partialResultsStability) {
  ...
  public EngineTranscribeSettings contentIdentificationType(TranscribeContentIdentificationType contentIdentificationType) {
  ...
  public EngineTranscribeSettings contentRedactionType(TranscribeContentRedactionType contentRedactionType) {
  ...
  public EngineTranscribeSettings piiEntityTypes(String piiEntityTypes) {
  ...
  public EngineTranscribeSettings languageModelName(String languageModelName) {
  ...
  public EngineTranscribeSettings identifyLanguage(Boolean identifyLanguage) {
  ...
  public EngineTranscribeSettings languageOptions(String languageOptions) {
  ...
  public EngineTranscribeSettings preferredLanguage(TranscribeLanguageCode preferredLanguage) {
  ...
  public EngineTranscribeSettings vocabularyNames(String vocabularyNames) {
  ...
  public EngineTranscribeSettings vocabularyFilterNames(String vocabularyFilterNames) {
  ...
  public boolean equals(Object o) {
    ...
    EngineTranscribeSettings engineTranscribeSettings = (EngineTranscribeSettings) o;
    return Objects.equals(this.languageCode, engineTranscribeSettings.languageCode) &&
        Objects.equals(this.vocabularyFilterMethod, engineTranscribeSettings.vocabularyFilterMethod) &&
        Objects.equals(this.vocabularyFilterName, engineTranscribeSettings.vocabularyFilterName) &&
        Objects.equals(this.vocabularyName, engineTranscribeSettings.vocabularyName) &&
        Objects.equals(this.region, engineTranscribeSettings.region) &&
        Objects.equals(this.enablePartialResultsStabilization, engineTranscribeSettings.enablePartialResultsStabilization) &&
        Objects.equals(this.partialResultsStability, engineTranscribeSettings.partialResultsStability) &&
        Objects.equals(this.contentIdentificationType, engineTranscribeSettings.contentIdentificationType) &&
        Objects.equals(this.contentRedactionType, engineTranscribeSettings.contentRedactionType) &&
        Objects.equals(this.piiEntityTypes, engineTranscribeSettings.piiEntityTypes) &&
        Objects.equals(this.languageModelName, engineTranscribeSettings.languageModelName) &&
        Objects.equals(this.identifyLanguage, engineTranscribeSettings.identifyLanguage) &&
        Objects.equals(this.languageOptions, engineTranscribeSettings.languageOptions) &&
        Objects.equals(this.preferredLanguage, engineTranscribeSettings.preferredLanguage) &&
        Objects.equals(this.vocabularyNames, engineTranscribeSettings.vocabularyNames) &&
        Objects.equals(this.vocabularyFilterNames, engineTranscribeSettings.vocabularyFilterNames);
  }
  ...
  public String toString() {
    ...
    sb.append("class EngineTranscribeSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EngineTranscribeSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EngineTranscribeSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EngineTranscribeSettings is not found in the empty JSON string", EngineTranscribeSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EngineTranscribeSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EngineTranscribeSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EngineTranscribeSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EngineTranscribeSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EngineTranscribeSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EngineTranscribeSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<EngineTranscribeSettings>() {
           @Override
           public void write(JsonWriter out, EngineTranscribeSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EngineTranscribeSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EngineTranscribeSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EngineTranscribeSettings
   * @throws IOException if the JSON string is invalid with respect to EngineTranscribeSettings
   */
  public static EngineTranscribeSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EngineTranscribeSettings.class);
  }

  /**
   * Convert an instance of EngineTranscribeSettings to an JSON string
   *
   * @return JSON string
   */
