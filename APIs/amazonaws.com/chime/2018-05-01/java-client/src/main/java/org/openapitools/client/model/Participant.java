...
public class Participant {
  ...
  public static final String SERIALIZED_NAME_PROXY_PHONE_NUMBER = "ProxyPhoneNumber";
  @SerializedName(SERIALIZED_NAME_PROXY_PHONE_NUMBER)
  ...
  public Participant proxyPhoneNumber(String proxyPhoneNumber) {
    this.proxyPhoneNumber = proxyPhoneNumber;
    return this;
  }

  /**
   * Get proxyPhoneNumber
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.phoneNumber, participant.phoneNumber) &&
        Objects.equals(this.proxyPhoneNumber, participant.proxyPhoneNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(phoneNumber, proxyPhoneNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("    proxyPhoneNumber: ").append(toIndentedString(proxyPhoneNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ProxyPhoneNumber");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("ProxyPhoneNumber") != null && !jsonObj.get("ProxyPhoneNumber").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ProxyPhoneNumber"));
      }
  }
