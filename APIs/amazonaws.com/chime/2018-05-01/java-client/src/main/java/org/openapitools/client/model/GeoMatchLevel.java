...
/**
 * Gets or Sets GeoMatchLevel
 */
@JsonAdapter(GeoMatchLevel.Adapter.class)
public enum GeoMatchLevel {
  ...
  public static GeoMatchLevel fromValue(String value) {
    for (GeoMatchLevel b : GeoMatchLevel.values()) {
  ...
  public static class Adapter extends TypeAdapter<GeoMatchLevel> {
    @Override
    public void write(final JsonWriter jsonWriter, final GeoMatchLevel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GeoMatchLevel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GeoMatchLevel.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    GeoMatchLevel.fromValue(value);
  }
}
