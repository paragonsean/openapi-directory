...
public class SigninDelegateGroup {
  ...
  public SigninDelegateGroup() {
  }

  public SigninDelegateGroup groupName(String groupName) {
  ...
  public boolean equals(Object o) {
    ...
    SigninDelegateGroup signinDelegateGroup = (SigninDelegateGroup) o;
    return Objects.equals(this.groupName, signinDelegateGroup.groupName);
  }
  ...
  public String toString() {
    ...
    sb.append("class SigninDelegateGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SigninDelegateGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SigninDelegateGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SigninDelegateGroup is not found in the empty JSON string", SigninDelegateGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SigninDelegateGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SigninDelegateGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SigninDelegateGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SigninDelegateGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SigninDelegateGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SigninDelegateGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<SigninDelegateGroup>() {
           @Override
           public void write(JsonWriter out, SigninDelegateGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SigninDelegateGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SigninDelegateGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SigninDelegateGroup
   * @throws IOException if the JSON string is invalid with respect to SigninDelegateGroup
   */
  public static SigninDelegateGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SigninDelegateGroup.class);
  }

  /**
   * Convert an instance of SigninDelegateGroup to an JSON string
   *
   * @return JSON string
   */
