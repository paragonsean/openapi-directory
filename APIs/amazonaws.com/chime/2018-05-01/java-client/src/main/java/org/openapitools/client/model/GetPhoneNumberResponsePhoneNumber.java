...
public class GetPhoneNumberResponsePhoneNumber {
  ...
  public GetPhoneNumberResponsePhoneNumber() {
  }

  public GetPhoneNumberResponsePhoneNumber phoneNumberId(String phoneNumberId) {
  ...
  public GetPhoneNumberResponsePhoneNumber e164PhoneNumber(String e164PhoneNumber) {
  ...
  public GetPhoneNumberResponsePhoneNumber country(String country) {
  ...
  public GetPhoneNumberResponsePhoneNumber type(PhoneNumberType type) {
    this.type = type;
    return this;
  }
  ...
  public GetPhoneNumberResponsePhoneNumber productType(PhoneNumberProductType productType) {
  ...
  public GetPhoneNumberResponsePhoneNumber status(PhoneNumberStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetPhoneNumberResponsePhoneNumber capabilities(PhoneNumberCapabilities capabilities) {
  ...
  public GetPhoneNumberResponsePhoneNumber associations(List associations) {
  ...
  public GetPhoneNumberResponsePhoneNumber callingName(String callingName) {
  ...
  public GetPhoneNumberResponsePhoneNumber callingNameStatus(CallingNameStatus callingNameStatus) {
  ...
  public GetPhoneNumberResponsePhoneNumber createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetPhoneNumberResponsePhoneNumber updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public GetPhoneNumberResponsePhoneNumber deletionTimestamp(OffsetDateTime deletionTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    GetPhoneNumberResponsePhoneNumber getPhoneNumberResponsePhoneNumber = (GetPhoneNumberResponsePhoneNumber) o;
    return Objects.equals(this.phoneNumberId, getPhoneNumberResponsePhoneNumber.phoneNumberId) &&
        Objects.equals(this.e164PhoneNumber, getPhoneNumberResponsePhoneNumber.e164PhoneNumber) &&
        Objects.equals(this.country, getPhoneNumberResponsePhoneNumber.country) &&
        Objects.equals(this.type, getPhoneNumberResponsePhoneNumber.type) &&
        Objects.equals(this.productType, getPhoneNumberResponsePhoneNumber.productType) &&
        Objects.equals(this.status, getPhoneNumberResponsePhoneNumber.status) &&
        Objects.equals(this.capabilities, getPhoneNumberResponsePhoneNumber.capabilities) &&
        Objects.equals(this.associations, getPhoneNumberResponsePhoneNumber.associations) &&
        Objects.equals(this.callingName, getPhoneNumberResponsePhoneNumber.callingName) &&
        Objects.equals(this.callingNameStatus, getPhoneNumberResponsePhoneNumber.callingNameStatus) &&
        Objects.equals(this.createdTimestamp, getPhoneNumberResponsePhoneNumber.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, getPhoneNumberResponsePhoneNumber.updatedTimestamp) &&
        Objects.equals(this.deletionTimestamp, getPhoneNumberResponsePhoneNumber.deletionTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPhoneNumberResponsePhoneNumber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPhoneNumberResponsePhoneNumber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPhoneNumberResponsePhoneNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPhoneNumberResponsePhoneNumber is not found in the empty JSON string", GetPhoneNumberResponsePhoneNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPhoneNumberResponsePhoneNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPhoneNumberResponsePhoneNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPhoneNumberResponsePhoneNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPhoneNumberResponsePhoneNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPhoneNumberResponsePhoneNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPhoneNumberResponsePhoneNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPhoneNumberResponsePhoneNumber>() {
           @Override
           public void write(JsonWriter out, GetPhoneNumberResponsePhoneNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPhoneNumberResponsePhoneNumber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPhoneNumberResponsePhoneNumber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPhoneNumberResponsePhoneNumber
   * @throws IOException if the JSON string is invalid with respect to GetPhoneNumberResponsePhoneNumber
   */
  public static GetPhoneNumberResponsePhoneNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPhoneNumberResponsePhoneNumber.class);
  }

  /**
   * Convert an instance of GetPhoneNumberResponsePhoneNumber to an JSON string
   *
   * @return JSON string
   */
