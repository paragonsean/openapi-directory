...
/**
 * Gets or Sets TranscribeMedicalType
 */
@JsonAdapter(TranscribeMedicalType.Adapter.class)
public enum TranscribeMedicalType {
  ...
  TranscribeMedicalType(String value) {
    this.value = value;
  }
  ...
  public static TranscribeMedicalType fromValue(String value) {
    for (TranscribeMedicalType b : TranscribeMedicalType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeMedicalType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeMedicalType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeMedicalType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeMedicalType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeMedicalType.fromValue(value);
  }
}
