...
public class SipMediaApplicationCall {
  ...
  public SipMediaApplicationCall() {
  }

  public SipMediaApplicationCall transactionId(String transactionId) {
  ...
  public boolean equals(Object o) {
    ...
    SipMediaApplicationCall sipMediaApplicationCall = (SipMediaApplicationCall) o;
    return Objects.equals(this.transactionId, sipMediaApplicationCall.transactionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SipMediaApplicationCall {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SipMediaApplicationCall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SipMediaApplicationCall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SipMediaApplicationCall is not found in the empty JSON string", SipMediaApplicationCall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SipMediaApplicationCall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SipMediaApplicationCall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SipMediaApplicationCall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SipMediaApplicationCall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SipMediaApplicationCall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SipMediaApplicationCall.class));

       return (TypeAdapter<T>) new TypeAdapter<SipMediaApplicationCall>() {
           @Override
           public void write(JsonWriter out, SipMediaApplicationCall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SipMediaApplicationCall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SipMediaApplicationCall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SipMediaApplicationCall
   * @throws IOException if the JSON string is invalid with respect to SipMediaApplicationCall
   */
  public static SipMediaApplicationCall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SipMediaApplicationCall.class);
  }

  /**
   * Convert an instance of SipMediaApplicationCall to an JSON string
   *
   * @return JSON string
   */
