...
/**
 * Gets or Sets TranscribeMedicalLanguageCode
 */
@JsonAdapter(TranscribeMedicalLanguageCode.Adapter.class)
public enum TranscribeMedicalLanguageCode {
  ...
  TranscribeMedicalLanguageCode(String value) {
    this.value = value;
  }
  ...
  public static TranscribeMedicalLanguageCode fromValue(String value) {
    for (TranscribeMedicalLanguageCode b : TranscribeMedicalLanguageCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeMedicalLanguageCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeMedicalLanguageCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeMedicalLanguageCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeMedicalLanguageCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeMedicalLanguageCode.fromValue(value);
  }
}
