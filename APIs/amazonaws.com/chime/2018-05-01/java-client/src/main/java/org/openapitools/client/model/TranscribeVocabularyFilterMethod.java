...
/**
 * Gets or Sets TranscribeVocabularyFilterMethod
 */
@JsonAdapter(TranscribeVocabularyFilterMethod.Adapter.class)
public enum TranscribeVocabularyFilterMethod {
  ...
  TranscribeVocabularyFilterMethod(String value) {
    this.value = value;
  }
  ...
  public static TranscribeVocabularyFilterMethod fromValue(String value) {
    for (TranscribeVocabularyFilterMethod b : TranscribeVocabularyFilterMethod.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeVocabularyFilterMethod> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeVocabularyFilterMethod enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeVocabularyFilterMethod read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeVocabularyFilterMethod.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeVocabularyFilterMethod.fromValue(value);
  }
}
