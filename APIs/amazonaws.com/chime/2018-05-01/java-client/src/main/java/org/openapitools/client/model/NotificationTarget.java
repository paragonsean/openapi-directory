...
/**
 * Gets or Sets NotificationTarget
 */
@JsonAdapter(NotificationTarget.Adapter.class)
public enum NotificationTarget {
  ...
  public static NotificationTarget fromValue(String value) {
    for (NotificationTarget b : NotificationTarget.values()) {
  ...
  public static class Adapter extends TypeAdapter<NotificationTarget> {
    @Override
    public void write(final JsonWriter jsonWriter, final NotificationTarget enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NotificationTarget read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NotificationTarget.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NotificationTarget.fromValue(value);
  }
}
