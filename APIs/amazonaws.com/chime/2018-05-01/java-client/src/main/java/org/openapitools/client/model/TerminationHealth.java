...
public class TerminationHealth {
  ...
  public TerminationHealth() {
  }

  public TerminationHealth timestamp(OffsetDateTime timestamp) {
  ...
  public TerminationHealth source(String source) {
    this.source = source;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TerminationHealth terminationHealth = (TerminationHealth) o;
    return Objects.equals(this.timestamp, terminationHealth.timestamp) &&
        Objects.equals(this.source, terminationHealth.source);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timestamp, source);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TerminationHealth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TerminationHealth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TerminationHealth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TerminationHealth is not found in the empty JSON string", TerminationHealth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TerminationHealth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TerminationHealth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TerminationHealth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TerminationHealth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TerminationHealth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TerminationHealth.class));

       return (TypeAdapter<T>) new TypeAdapter<TerminationHealth>() {
           @Override
           public void write(JsonWriter out, TerminationHealth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TerminationHealth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TerminationHealth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TerminationHealth
   * @throws IOException if the JSON string is invalid with respect to TerminationHealth
   */
  public static TerminationHealth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TerminationHealth.class);
  }

  /**
   * Convert an instance of TerminationHealth to an JSON string
   *
   * @return JSON string
   */
