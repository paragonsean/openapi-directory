...
/**
 * Gets or Sets TranscribeLanguageCode
 */
@JsonAdapter(TranscribeLanguageCode.Adapter.class)
public enum TranscribeLanguageCode {
  ...
  TranscribeLanguageCode(String value) {
    this.value = value;
  }
  ...
  public static TranscribeLanguageCode fromValue(String value) {
    for (TranscribeLanguageCode b : TranscribeLanguageCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeLanguageCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeLanguageCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeLanguageCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeLanguageCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeLanguageCode.fromValue(value);
  }
}
