...
public class OrderedPhoneNumber {
  ...
  private OrderedPhoneNumberStatus status;

  public OrderedPhoneNumber() {
  }

  public OrderedPhoneNumber e164PhoneNumber(String e164PhoneNumber) {
  ...
  public OrderedPhoneNumber status(OrderedPhoneNumberStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OrderedPhoneNumberStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderedPhoneNumber orderedPhoneNumber = (OrderedPhoneNumber) o;
    return Objects.equals(this.e164PhoneNumber, orderedPhoneNumber.e164PhoneNumber) &&
        Objects.equals(this.status, orderedPhoneNumber.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(e164PhoneNumber, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderedPhoneNumber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderedPhoneNumber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderedPhoneNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderedPhoneNumber is not found in the empty JSON string", OrderedPhoneNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderedPhoneNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderedPhoneNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        OrderedPhoneNumberStatus.validateJsonElement(jsonObj.get("Status"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderedPhoneNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderedPhoneNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderedPhoneNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderedPhoneNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderedPhoneNumber>() {
           @Override
           public void write(JsonWriter out, OrderedPhoneNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderedPhoneNumber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderedPhoneNumber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderedPhoneNumber
   * @throws IOException if the JSON string is invalid with respect to OrderedPhoneNumber
   */
  public static OrderedPhoneNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderedPhoneNumber.class);
  }

  /**
   * Convert an instance of OrderedPhoneNumber to an JSON string
   *
   * @return JSON string
   */
