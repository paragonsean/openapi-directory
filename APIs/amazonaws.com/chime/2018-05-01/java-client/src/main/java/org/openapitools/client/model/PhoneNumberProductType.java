...
/**
 * Gets or Sets PhoneNumberProductType
 */
@JsonAdapter(PhoneNumberProductType.Adapter.class)
public enum PhoneNumberProductType {
  ...
  PhoneNumberProductType(String value) {
    this.value = value;
  }
  ...
  public static PhoneNumberProductType fromValue(String value) {
    for (PhoneNumberProductType b : PhoneNumberProductType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PhoneNumberProductType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PhoneNumberProductType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PhoneNumberProductType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PhoneNumberProductType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PhoneNumberProductType.fromValue(value);
  }
}
