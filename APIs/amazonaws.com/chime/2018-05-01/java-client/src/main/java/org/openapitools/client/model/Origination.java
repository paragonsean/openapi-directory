...
public class Origination {
  ...
  public Origination routes(List routes) {
    this.routes = routes;
    return this;
  }
  ...
  public Origination disabled(Boolean disabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.routes, origination.routes) &&
        Objects.equals(this.disabled, origination.disabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Origination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Origination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Origination is not found in the empty JSON string", Origination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Origination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Origination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Origination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Origination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Origination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Origination.class));

       return (TypeAdapter<T>) new TypeAdapter<Origination>() {
           @Override
           public void write(JsonWriter out, Origination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Origination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Origination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Origination
   * @throws IOException if the JSON string is invalid with respect to Origination
   */
  public static Origination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Origination.class);
  }

  /**
   * Convert an instance of Origination to an JSON string
   *
   * @return JSON string
   */
