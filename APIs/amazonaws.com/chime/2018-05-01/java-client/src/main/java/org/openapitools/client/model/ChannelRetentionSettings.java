...
public class ChannelRetentionSettings {
  ...
  public ChannelRetentionSettings() {
  }

  public ChannelRetentionSettings retentionDays(Integer retentionDays) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelRetentionSettings channelRetentionSettings = (ChannelRetentionSettings) o;
    return Objects.equals(this.retentionDays, channelRetentionSettings.retentionDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelRetentionSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelRetentionSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelRetentionSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelRetentionSettings is not found in the empty JSON string", ChannelRetentionSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelRetentionSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelRetentionSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelRetentionSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelRetentionSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelRetentionSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelRetentionSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelRetentionSettings>() {
           @Override
           public void write(JsonWriter out, ChannelRetentionSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelRetentionSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelRetentionSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelRetentionSettings
   * @throws IOException if the JSON string is invalid with respect to ChannelRetentionSettings
   */
  public static ChannelRetentionSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelRetentionSettings.class);
  }

  /**
   * Convert an instance of ChannelRetentionSettings to an JSON string
   *
   * @return JSON string
   */
