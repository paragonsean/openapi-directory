...
/**
 * Gets or Sets TranscribeMedicalSpecialty
 */
@JsonAdapter(TranscribeMedicalSpecialty.Adapter.class)
public enum TranscribeMedicalSpecialty {
  ...
  TranscribeMedicalSpecialty(String value) {
    this.value = value;
  }
  ...
  public static TranscribeMedicalSpecialty fromValue(String value) {
    for (TranscribeMedicalSpecialty b : TranscribeMedicalSpecialty.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeMedicalSpecialty> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeMedicalSpecialty enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeMedicalSpecialty read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeMedicalSpecialty.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeMedicalSpecialty.fromValue(value);
  }
}
