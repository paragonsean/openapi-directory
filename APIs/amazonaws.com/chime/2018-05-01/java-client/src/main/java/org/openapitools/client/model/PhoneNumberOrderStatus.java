...
/**
 * Gets or Sets PhoneNumberOrderStatus
 */
@JsonAdapter(PhoneNumberOrderStatus.Adapter.class)
public enum PhoneNumberOrderStatus {
  ...
  PhoneNumberOrderStatus(String value) {
    this.value = value;
  }
  ...
  public static PhoneNumberOrderStatus fromValue(String value) {
    for (PhoneNumberOrderStatus b : PhoneNumberOrderStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PhoneNumberOrderStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PhoneNumberOrderStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PhoneNumberOrderStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PhoneNumberOrderStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PhoneNumberOrderStatus.fromValue(value);
  }
}
