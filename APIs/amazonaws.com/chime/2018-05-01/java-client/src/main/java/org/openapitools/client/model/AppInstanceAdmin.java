...
public class AppInstanceAdmin {
  ...
  private AppInstanceAdminAdmin admin;
  ...
  public AppInstanceAdmin() {
  }

  public AppInstanceAdmin admin(AppInstanceAdminAdmin admin) {
    this.admin = admin;
    return this;
  }
  ...
  public AppInstanceAdminAdmin getAdmin() {
    return admin;
  }

  public void setAdmin(AppInstanceAdminAdmin admin) {
    this.admin = admin;
  }


  public AppInstanceAdmin appInstanceArn(String appInstanceArn) {
  ...
  public AppInstanceAdmin createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AppInstanceAdmin appInstanceAdmin = (AppInstanceAdmin) o;
    return Objects.equals(this.admin, appInstanceAdmin.admin) &&
        Objects.equals(this.appInstanceArn, appInstanceAdmin.appInstanceArn) &&
        Objects.equals(this.createdTimestamp, appInstanceAdmin.createdTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(admin, appInstanceArn, createdTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppInstanceAdmin {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppInstanceAdmin
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppInstanceAdmin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppInstanceAdmin is not found in the empty JSON string", AppInstanceAdmin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppInstanceAdmin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppInstanceAdmin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Admin`
      if (jsonObj.get("Admin") != null && !jsonObj.get("Admin").isJsonNull()) {
        AppInstanceAdminAdmin.validateJsonElement(jsonObj.get("Admin"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppInstanceAdmin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppInstanceAdmin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppInstanceAdmin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppInstanceAdmin.class));

       return (TypeAdapter<T>) new TypeAdapter<AppInstanceAdmin>() {
           @Override
           public void write(JsonWriter out, AppInstanceAdmin value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppInstanceAdmin read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppInstanceAdmin given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppInstanceAdmin
   * @throws IOException if the JSON string is invalid with respect to AppInstanceAdmin
   */
  public static AppInstanceAdmin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppInstanceAdmin.class);
  }

  /**
   * Convert an instance of AppInstanceAdmin to an JSON string
   *
   * @return JSON string
   */
