...
public class UntagMeetingRequest {
  ...
  public UntagMeetingRequest() {
  }

  public UntagMeetingRequest tagKeys(List<String> tagKeys) {
    this.tagKeys = tagKeys;
    return this;
  }

  public UntagMeetingRequest addTagKeysItem(String tagKeysItem) {
  ...
  public boolean equals(Object o) {
    ...
    UntagMeetingRequest untagMeetingRequest = (UntagMeetingRequest) o;
    return Objects.equals(this.tagKeys, untagMeetingRequest.tagKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class UntagMeetingRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UntagMeetingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UntagMeetingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UntagMeetingRequest is not found in the empty JSON string", UntagMeetingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UntagMeetingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UntagMeetingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UntagMeetingRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UntagMeetingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UntagMeetingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UntagMeetingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UntagMeetingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UntagMeetingRequest>() {
           @Override
           public void write(JsonWriter out, UntagMeetingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UntagMeetingRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UntagMeetingRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UntagMeetingRequest
   * @throws IOException if the JSON string is invalid with respect to UntagMeetingRequest
   */
  public static UntagMeetingRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UntagMeetingRequest.class);
  }

  /**
   * Convert an instance of UntagMeetingRequest to an JSON string
   *
   * @return JSON string
   */
