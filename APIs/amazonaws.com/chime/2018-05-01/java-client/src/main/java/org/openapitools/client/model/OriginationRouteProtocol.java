...
/**
 * Gets or Sets OriginationRouteProtocol
 */
@JsonAdapter(OriginationRouteProtocol.Adapter.class)
public enum OriginationRouteProtocol {
  ...
  OriginationRouteProtocol(String value) {
    this.value = value;
  }
  ...
  public static OriginationRouteProtocol fromValue(String value) {
    for (OriginationRouteProtocol b : OriginationRouteProtocol.values()) {
  ...
  public static class Adapter extends TypeAdapter<OriginationRouteProtocol> {
    @Override
    public void write(final JsonWriter jsonWriter, final OriginationRouteProtocol enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OriginationRouteProtocol read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OriginationRouteProtocol.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OriginationRouteProtocol.fromValue(value);
  }
}
