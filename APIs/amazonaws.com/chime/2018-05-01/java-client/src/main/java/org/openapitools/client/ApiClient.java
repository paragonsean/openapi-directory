...
public class ApiClient {
    ...
    private String basePath = "http://service.chime.aws.amazon.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://service.chime.aws.amazon.com",
      "The general Amazon Chime multi-region endpoint",
    ...
    new ServerConfiguration(
      "http://chime.{region}.amazonaws.com.cn",
      "The Amazon Chime endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
    ...
    new ServerConfiguration(
      "https://chime.{region}.amazonaws.com.cn",
      "The Amazon Chime endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://service.chime.aws.amazon.com
