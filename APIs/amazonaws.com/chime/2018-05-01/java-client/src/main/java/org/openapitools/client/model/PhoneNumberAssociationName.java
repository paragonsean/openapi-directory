...
/**
 * Gets or Sets PhoneNumberAssociationName
 */
@JsonAdapter(PhoneNumberAssociationName.Adapter.class)
public enum PhoneNumberAssociationName {
  ...
  PhoneNumberAssociationName(String value) {
    this.value = value;
  }
  ...
  public static PhoneNumberAssociationName fromValue(String value) {
    for (PhoneNumberAssociationName b : PhoneNumberAssociationName.values()) {
  ...
  public static class Adapter extends TypeAdapter<PhoneNumberAssociationName> {
    @Override
    public void write(final JsonWriter jsonWriter, final PhoneNumberAssociationName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PhoneNumberAssociationName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PhoneNumberAssociationName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PhoneNumberAssociationName.fromValue(value);
  }
}
