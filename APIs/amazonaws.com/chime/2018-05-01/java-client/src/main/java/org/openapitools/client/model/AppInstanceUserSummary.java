...
public class AppInstanceUserSummary {
  ...
  public AppInstanceUserSummary() {
  }

  public AppInstanceUserSummary appInstanceUserArn(String appInstanceUserArn) {
  ...
  public AppInstanceUserSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppInstanceUserSummary metadata(String metadata) {
  ...
  public boolean equals(Object o) {
    ...
    AppInstanceUserSummary appInstanceUserSummary = (AppInstanceUserSummary) o;
    return Objects.equals(this.appInstanceUserArn, appInstanceUserSummary.appInstanceUserArn) &&
        Objects.equals(this.name, appInstanceUserSummary.name) &&
        Objects.equals(this.metadata, appInstanceUserSummary.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appInstanceUserArn, name, metadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppInstanceUserSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppInstanceUserSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppInstanceUserSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppInstanceUserSummary is not found in the empty JSON string", AppInstanceUserSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppInstanceUserSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppInstanceUserSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppInstanceUserSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppInstanceUserSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppInstanceUserSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppInstanceUserSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<AppInstanceUserSummary>() {
           @Override
           public void write(JsonWriter out, AppInstanceUserSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppInstanceUserSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppInstanceUserSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppInstanceUserSummary
   * @throws IOException if the JSON string is invalid with respect to AppInstanceUserSummary
   */
  public static AppInstanceUserSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppInstanceUserSummary.class);
  }

  /**
   * Convert an instance of AppInstanceUserSummary to an JSON string
   *
   * @return JSON string
   */
