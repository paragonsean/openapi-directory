...
public class UpdatePhoneNumberResponsePhoneNumber {
  ...
  public UpdatePhoneNumberResponsePhoneNumber() {
  }

  public UpdatePhoneNumberResponsePhoneNumber phoneNumberId(String phoneNumberId) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber e164PhoneNumber(String e164PhoneNumber) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber country(String country) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber type(PhoneNumberType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdatePhoneNumberResponsePhoneNumber productType(PhoneNumberProductType productType) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber status(PhoneNumberStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdatePhoneNumberResponsePhoneNumber capabilities(PhoneNumberCapabilities capabilities) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber associations(List associations) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber callingName(String callingName) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber callingNameStatus(CallingNameStatus callingNameStatus) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public UpdatePhoneNumberResponsePhoneNumber deletionTimestamp(OffsetDateTime deletionTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePhoneNumberResponsePhoneNumber updatePhoneNumberResponsePhoneNumber = (UpdatePhoneNumberResponsePhoneNumber) o;
    return Objects.equals(this.phoneNumberId, updatePhoneNumberResponsePhoneNumber.phoneNumberId) &&
        Objects.equals(this.e164PhoneNumber, updatePhoneNumberResponsePhoneNumber.e164PhoneNumber) &&
        Objects.equals(this.country, updatePhoneNumberResponsePhoneNumber.country) &&
        Objects.equals(this.type, updatePhoneNumberResponsePhoneNumber.type) &&
        Objects.equals(this.productType, updatePhoneNumberResponsePhoneNumber.productType) &&
        Objects.equals(this.status, updatePhoneNumberResponsePhoneNumber.status) &&
        Objects.equals(this.capabilities, updatePhoneNumberResponsePhoneNumber.capabilities) &&
        Objects.equals(this.associations, updatePhoneNumberResponsePhoneNumber.associations) &&
        Objects.equals(this.callingName, updatePhoneNumberResponsePhoneNumber.callingName) &&
        Objects.equals(this.callingNameStatus, updatePhoneNumberResponsePhoneNumber.callingNameStatus) &&
        Objects.equals(this.createdTimestamp, updatePhoneNumberResponsePhoneNumber.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, updatePhoneNumberResponsePhoneNumber.updatedTimestamp) &&
        Objects.equals(this.deletionTimestamp, updatePhoneNumberResponsePhoneNumber.deletionTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePhoneNumberResponsePhoneNumber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePhoneNumberResponsePhoneNumber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePhoneNumberResponsePhoneNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePhoneNumberResponsePhoneNumber is not found in the empty JSON string", UpdatePhoneNumberResponsePhoneNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePhoneNumberResponsePhoneNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePhoneNumberResponsePhoneNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePhoneNumberResponsePhoneNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePhoneNumberResponsePhoneNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePhoneNumberResponsePhoneNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePhoneNumberResponsePhoneNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePhoneNumberResponsePhoneNumber>() {
           @Override
           public void write(JsonWriter out, UpdatePhoneNumberResponsePhoneNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePhoneNumberResponsePhoneNumber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePhoneNumberResponsePhoneNumber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePhoneNumberResponsePhoneNumber
   * @throws IOException if the JSON string is invalid with respect to UpdatePhoneNumberResponsePhoneNumber
   */
  public static UpdatePhoneNumberResponsePhoneNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePhoneNumberResponsePhoneNumber.class);
  }

  /**
   * Convert an instance of UpdatePhoneNumberResponsePhoneNumber to an JSON string
   *
   * @return JSON string
   */
