...
public class UpdatePhoneNumberRequestItem {
  ...
  public UpdatePhoneNumberRequestItem() {
  }

  public UpdatePhoneNumberRequestItem phoneNumberId(String phoneNumberId) {
  ...
  public UpdatePhoneNumberRequestItem productType(PhoneNumberProductType productType) {
  ...
  public UpdatePhoneNumberRequestItem callingName(String callingName) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePhoneNumberRequestItem updatePhoneNumberRequestItem = (UpdatePhoneNumberRequestItem) o;
    return Objects.equals(this.phoneNumberId, updatePhoneNumberRequestItem.phoneNumberId) &&
        Objects.equals(this.productType, updatePhoneNumberRequestItem.productType) &&
        Objects.equals(this.callingName, updatePhoneNumberRequestItem.callingName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(phoneNumberId, productType, callingName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePhoneNumberRequestItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePhoneNumberRequestItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePhoneNumberRequestItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePhoneNumberRequestItem is not found in the empty JSON string", UpdatePhoneNumberRequestItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePhoneNumberRequestItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePhoneNumberRequestItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePhoneNumberRequestItem.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `PhoneNumberId`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePhoneNumberRequestItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePhoneNumberRequestItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePhoneNumberRequestItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePhoneNumberRequestItem.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePhoneNumberRequestItem>() {
           @Override
           public void write(JsonWriter out, UpdatePhoneNumberRequestItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePhoneNumberRequestItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePhoneNumberRequestItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePhoneNumberRequestItem
   * @throws IOException if the JSON string is invalid with respect to UpdatePhoneNumberRequestItem
   */
  public static UpdatePhoneNumberRequestItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePhoneNumberRequestItem.class);
  }

  /**
   * Convert an instance of UpdatePhoneNumberRequestItem to an JSON string
   *
   * @return JSON string
   */
