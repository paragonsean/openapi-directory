...
public class GetChannelMessageResponseChannelMessage {
  ...
  public GetChannelMessageResponseChannelMessage() {
  }

  public GetChannelMessageResponseChannelMessage channelArn(String channelArn) {
  ...
  public GetChannelMessageResponseChannelMessage messageId(String messageId) {
  ...
  public GetChannelMessageResponseChannelMessage content(String content) {
  ...
  public GetChannelMessageResponseChannelMessage metadata(String metadata) {
  ...
  public GetChannelMessageResponseChannelMessage type(ChannelMessageType type) {
    this.type = type;
    return this;
  }
  ...
  public GetChannelMessageResponseChannelMessage createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetChannelMessageResponseChannelMessage lastEditedTimestamp(OffsetDateTime lastEditedTimestamp) {
  ...
  public GetChannelMessageResponseChannelMessage lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public GetChannelMessageResponseChannelMessage sender(ChannelMessageSender sender) {
    this.sender = sender;
    return this;
  }
  ...
  public GetChannelMessageResponseChannelMessage redacted(Boolean redacted) {
  ...
  public GetChannelMessageResponseChannelMessage persistence(ChannelMessagePersistenceType persistence) {
  ...
  public boolean equals(Object o) {
    ...
    GetChannelMessageResponseChannelMessage getChannelMessageResponseChannelMessage = (GetChannelMessageResponseChannelMessage) o;
    return Objects.equals(this.channelArn, getChannelMessageResponseChannelMessage.channelArn) &&
        Objects.equals(this.messageId, getChannelMessageResponseChannelMessage.messageId) &&
        Objects.equals(this.content, getChannelMessageResponseChannelMessage.content) &&
        Objects.equals(this.metadata, getChannelMessageResponseChannelMessage.metadata) &&
        Objects.equals(this.type, getChannelMessageResponseChannelMessage.type) &&
        Objects.equals(this.createdTimestamp, getChannelMessageResponseChannelMessage.createdTimestamp) &&
        Objects.equals(this.lastEditedTimestamp, getChannelMessageResponseChannelMessage.lastEditedTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, getChannelMessageResponseChannelMessage.lastUpdatedTimestamp) &&
        Objects.equals(this.sender, getChannelMessageResponseChannelMessage.sender) &&
        Objects.equals(this.redacted, getChannelMessageResponseChannelMessage.redacted) &&
        Objects.equals(this.persistence, getChannelMessageResponseChannelMessage.persistence);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetChannelMessageResponseChannelMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetChannelMessageResponseChannelMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetChannelMessageResponseChannelMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetChannelMessageResponseChannelMessage is not found in the empty JSON string", GetChannelMessageResponseChannelMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetChannelMessageResponseChannelMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetChannelMessageResponseChannelMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetChannelMessageResponseChannelMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetChannelMessageResponseChannelMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetChannelMessageResponseChannelMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetChannelMessageResponseChannelMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<GetChannelMessageResponseChannelMessage>() {
           @Override
           public void write(JsonWriter out, GetChannelMessageResponseChannelMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetChannelMessageResponseChannelMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetChannelMessageResponseChannelMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetChannelMessageResponseChannelMessage
   * @throws IOException if the JSON string is invalid with respect to GetChannelMessageResponseChannelMessage
   */
  public static GetChannelMessageResponseChannelMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetChannelMessageResponseChannelMessage.class);
  }

  /**
   * Convert an instance of GetChannelMessageResponseChannelMessage to an JSON string
   *
   * @return JSON string
   */
