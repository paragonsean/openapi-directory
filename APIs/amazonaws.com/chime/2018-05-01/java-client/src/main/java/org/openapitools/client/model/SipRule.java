...
public class SipRule {
  ...
  public SipRule sipRuleId(String sipRuleId) {
  ...
  public SipRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SipRule disabled(Boolean disabled) {
  ...
  public SipRule triggerType(SipRuleTriggerType triggerType) {
  ...
  public SipRule triggerValue(String triggerValue) {
  ...
  public SipRule targetApplications(List targetApplications) {
  ...
  public SipRule createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public SipRule updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    SipRule sipRule = (SipRule) o;
    return Objects.equals(this.sipRuleId, sipRule.sipRuleId) &&
        Objects.equals(this.name, sipRule.name) &&
        Objects.equals(this.disabled, sipRule.disabled) &&
        Objects.equals(this.triggerType, sipRule.triggerType) &&
        Objects.equals(this.triggerValue, sipRule.triggerValue) &&
        Objects.equals(this.targetApplications, sipRule.targetApplications) &&
        Objects.equals(this.createdTimestamp, sipRule.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, sipRule.updatedTimestamp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SipRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SipRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SipRule is not found in the empty JSON string", SipRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SipRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SipRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SipRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SipRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SipRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SipRule.class));

       return (TypeAdapter<T>) new TypeAdapter<SipRule>() {
           @Override
           public void write(JsonWriter out, SipRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SipRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SipRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SipRule
   * @throws IOException if the JSON string is invalid with respect to SipRule
   */
  public static SipRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SipRule.class);
  }

  /**
   * Convert an instance of SipRule to an JSON string
   *
   * @return JSON string
   */
