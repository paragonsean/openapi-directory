...
public class UpdateProxySessionRequest {
  ...
  public UpdateProxySessionRequest() {
  }

  public UpdateProxySessionRequest capabilities(List<Capability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public UpdateProxySessionRequest addCapabilitiesItem(Capability capabilitiesItem) {
  ...
  public UpdateProxySessionRequest expiryMinutes(Integer expiryMinutes) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProxySessionRequest updateProxySessionRequest = (UpdateProxySessionRequest) o;
    return Objects.equals(this.capabilities, updateProxySessionRequest.capabilities) &&
        Objects.equals(this.expiryMinutes, updateProxySessionRequest.expiryMinutes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capabilities, expiryMinutes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateProxySessionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProxySessionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProxySessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProxySessionRequest is not found in the empty JSON string", UpdateProxySessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProxySessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProxySessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateProxySessionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProxySessionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProxySessionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProxySessionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProxySessionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProxySessionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateProxySessionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProxySessionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProxySessionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProxySessionRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateProxySessionRequest
   */
  public static UpdateProxySessionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProxySessionRequest.class);
  }

  /**
   * Convert an instance of UpdateProxySessionRequest to an JSON string
   *
   * @return JSON string
   */
