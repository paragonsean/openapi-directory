...
public class UpdateBotResponseBot {
  ...
  public UpdateBotResponseBot() {
  }

  public UpdateBotResponseBot botId(String botId) {
    this.botId = botId;
    return this;
  }
  ...
  public UpdateBotResponseBot userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UpdateBotResponseBot displayName(String displayName) {
  ...
  public UpdateBotResponseBot botType(BotType botType) {
  ...
  public UpdateBotResponseBot disabled(Boolean disabled) {
  ...
  public UpdateBotResponseBot createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public UpdateBotResponseBot updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public UpdateBotResponseBot botEmail(String botEmail) {
  ...
  public UpdateBotResponseBot securityToken(String securityToken) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBotResponseBot updateBotResponseBot = (UpdateBotResponseBot) o;
    return Objects.equals(this.botId, updateBotResponseBot.botId) &&
        Objects.equals(this.userId, updateBotResponseBot.userId) &&
        Objects.equals(this.displayName, updateBotResponseBot.displayName) &&
        Objects.equals(this.botType, updateBotResponseBot.botType) &&
        Objects.equals(this.disabled, updateBotResponseBot.disabled) &&
        Objects.equals(this.createdTimestamp, updateBotResponseBot.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, updateBotResponseBot.updatedTimestamp) &&
        Objects.equals(this.botEmail, updateBotResponseBot.botEmail) &&
        Objects.equals(this.securityToken, updateBotResponseBot.securityToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBotResponseBot {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBotResponseBot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBotResponseBot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBotResponseBot is not found in the empty JSON string", UpdateBotResponseBot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBotResponseBot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBotResponseBot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBotResponseBot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBotResponseBot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBotResponseBot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBotResponseBot.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBotResponseBot>() {
           @Override
           public void write(JsonWriter out, UpdateBotResponseBot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBotResponseBot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBotResponseBot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBotResponseBot
   * @throws IOException if the JSON string is invalid with respect to UpdateBotResponseBot
   */
  public static UpdateBotResponseBot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBotResponseBot.class);
  }

  /**
   * Convert an instance of UpdateBotResponseBot to an JSON string
   *
   * @return JSON string
   */
