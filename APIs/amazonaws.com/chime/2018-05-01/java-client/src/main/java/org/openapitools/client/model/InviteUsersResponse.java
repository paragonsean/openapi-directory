...
public class InviteUsersResponse {
  ...
  public InviteUsersResponse invites(List invites) {
  ...
  public boolean equals(Object o) {
    ...
    InviteUsersResponse inviteUsersResponse = (InviteUsersResponse) o;
    return Objects.equals(this.invites, inviteUsersResponse.invites);
  }
  ...
  public String toString() {
    ...
    sb.append("class InviteUsersResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InviteUsersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InviteUsersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InviteUsersResponse is not found in the empty JSON string", InviteUsersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InviteUsersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InviteUsersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Invites`
      if (jsonObj.get("Invites") != null && !jsonObj.get("Invites").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Invites"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InviteUsersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InviteUsersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InviteUsersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InviteUsersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InviteUsersResponse>() {
           @Override
           public void write(JsonWriter out, InviteUsersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InviteUsersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InviteUsersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InviteUsersResponse
   * @throws IOException if the JSON string is invalid with respect to InviteUsersResponse
   */
  public static InviteUsersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InviteUsersResponse.class);
  }

  /**
   * Convert an instance of InviteUsersResponse to an JSON string
   *
   * @return JSON string
   */
