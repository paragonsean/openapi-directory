...
/**
 * Gets or Sets TranscribeRegion
 */
@JsonAdapter(TranscribeRegion.Adapter.class)
public enum TranscribeRegion {
  ...
  public static TranscribeRegion fromValue(String value) {
    for (TranscribeRegion b : TranscribeRegion.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeRegion> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeRegion enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeRegion read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeRegion.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeRegion.fromValue(value);
  }
}
