...
import org.openapitools.client.model.UpdateGlobalSettingsRequestBusinessCalling;
import org.openapitools.client.model.UpdateGlobalSettingsRequestVoiceConnector;
...
public class UpdateGlobalSettingsRequest {
  public static final String SERIALIZED_NAME_BUSINESS_CALLING = "BusinessCalling";
  @SerializedName(SERIALIZED_NAME_BUSINESS_CALLING)
  private UpdateGlobalSettingsRequestBusinessCalling businessCalling;

  public static final String SERIALIZED_NAME_VOICE_CONNECTOR = "VoiceConnector";
  @SerializedName(SERIALIZED_NAME_VOICE_CONNECTOR)
  private UpdateGlobalSettingsRequestVoiceConnector voiceConnector;

  public UpdateGlobalSettingsRequest() {
  }

  public UpdateGlobalSettingsRequest businessCalling(UpdateGlobalSettingsRequestBusinessCalling businessCalling) {
  ...
  public UpdateGlobalSettingsRequestBusinessCalling getBusinessCalling() {
    return businessCalling;
  }

  public void setBusinessCalling(UpdateGlobalSettingsRequestBusinessCalling businessCalling) {
    this.businessCalling = businessCalling;
  }


  public UpdateGlobalSettingsRequest voiceConnector(UpdateGlobalSettingsRequestVoiceConnector voiceConnector) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateGlobalSettingsRequestVoiceConnector getVoiceConnector() {
    return voiceConnector;
  }

  public void setVoiceConnector(UpdateGlobalSettingsRequestVoiceConnector voiceConnector) {
    this.voiceConnector = voiceConnector;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.businessCalling, updateGlobalSettingsRequest.businessCalling) &&
        Objects.equals(this.voiceConnector, updateGlobalSettingsRequest.voiceConnector);
  }

  @Override
  public int hashCode() {
    return Objects.hash(businessCalling, voiceConnector);
  }
  ...
  public String toString() {
    ...
    sb.append("    businessCalling: ").append(toIndentedString(businessCalling)).append("\n");
    sb.append("    voiceConnector: ").append(toIndentedString(voiceConnector)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("BusinessCalling");
    openapiFields.add("VoiceConnector");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("BusinessCalling") != null && !jsonObj.get("BusinessCalling").isJsonNull()) {
        UpdateGlobalSettingsRequestBusinessCalling.validateJsonElement(jsonObj.get("BusinessCalling"));
      }
      // validate the optional field `VoiceConnector`
      if (jsonObj.get("VoiceConnector") != null && !jsonObj.get("VoiceConnector").isJsonNull()) {
        UpdateGlobalSettingsRequestVoiceConnector.validateJsonElement(jsonObj.get("VoiceConnector"));
      }
  }
