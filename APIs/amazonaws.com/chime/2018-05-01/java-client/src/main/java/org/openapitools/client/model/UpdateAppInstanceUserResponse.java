...
public class UpdateAppInstanceUserResponse {
  ...
  public UpdateAppInstanceUserResponse() {
  }

  public UpdateAppInstanceUserResponse appInstanceUserArn(String appInstanceUserArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateAppInstanceUserResponse updateAppInstanceUserResponse = (UpdateAppInstanceUserResponse) o;
    return Objects.equals(this.appInstanceUserArn, updateAppInstanceUserResponse.appInstanceUserArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAppInstanceUserResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAppInstanceUserResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAppInstanceUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAppInstanceUserResponse is not found in the empty JSON string", UpdateAppInstanceUserResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAppInstanceUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAppInstanceUserResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAppInstanceUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAppInstanceUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAppInstanceUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAppInstanceUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAppInstanceUserResponse>() {
           @Override
           public void write(JsonWriter out, UpdateAppInstanceUserResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAppInstanceUserResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAppInstanceUserResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAppInstanceUserResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateAppInstanceUserResponse
   */
  public static UpdateAppInstanceUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAppInstanceUserResponse.class);
  }

  /**
   * Convert an instance of UpdateAppInstanceUserResponse to an JSON string
   *
   * @return JSON string
   */
