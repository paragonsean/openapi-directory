...
/**
 * Gets or Sets AppInstanceDataType
 */
@JsonAdapter(AppInstanceDataType.Adapter.class)
public enum AppInstanceDataType {
  ...
  AppInstanceDataType(String value) {
    this.value = value;
  }
  ...
  public static AppInstanceDataType fromValue(String value) {
    for (AppInstanceDataType b : AppInstanceDataType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AppInstanceDataType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AppInstanceDataType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AppInstanceDataType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AppInstanceDataType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AppInstanceDataType.fromValue(value);
  }
}
