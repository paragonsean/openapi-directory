...
public class UntagAttendeeRequest {
  ...
  public UntagAttendeeRequest() {
  }

  public UntagAttendeeRequest tagKeys(List<String> tagKeys) {
    this.tagKeys = tagKeys;
    return this;
  }

  public UntagAttendeeRequest addTagKeysItem(String tagKeysItem) {
  ...
  public boolean equals(Object o) {
    ...
    UntagAttendeeRequest untagAttendeeRequest = (UntagAttendeeRequest) o;
    return Objects.equals(this.tagKeys, untagAttendeeRequest.tagKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class UntagAttendeeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UntagAttendeeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UntagAttendeeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UntagAttendeeRequest is not found in the empty JSON string", UntagAttendeeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UntagAttendeeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UntagAttendeeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UntagAttendeeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UntagAttendeeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UntagAttendeeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UntagAttendeeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UntagAttendeeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UntagAttendeeRequest>() {
           @Override
           public void write(JsonWriter out, UntagAttendeeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UntagAttendeeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UntagAttendeeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UntagAttendeeRequest
   * @throws IOException if the JSON string is invalid with respect to UntagAttendeeRequest
   */
  public static UntagAttendeeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UntagAttendeeRequest.class);
  }

  /**
   * Convert an instance of UntagAttendeeRequest to an JSON string
   *
   * @return JSON string
   */
