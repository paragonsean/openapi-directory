...
public class UpdateAccountRequest {
   ...
   */
  @JsonAdapter(DefaultLicenseEnum.Adapter.class)
  public enum DefaultLicenseEnum {
    BASIC("Basic"),
    ...
    DefaultLicenseEnum(String value) {
      this.value = value;
    }
    ...
    public static DefaultLicenseEnum fromValue(String value) {
      for (DefaultLicenseEnum b : DefaultLicenseEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DefaultLicenseEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DefaultLicenseEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DefaultLicenseEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return DefaultLicenseEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      DefaultLicenseEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_DEFAULT_LICENSE = "DefaultLicense";
  @SerializedName(SERIALIZED_NAME_DEFAULT_LICENSE)
  private DefaultLicenseEnum defaultLicense;
  ...
  public UpdateAccountRequest defaultLicense(DefaultLicenseEnum defaultLicense) {
   ...
   */
  @javax.annotation.Nullable
  public DefaultLicenseEnum getDefaultLicense() {
    return defaultLicense;
  }

  public void setDefaultLicense(DefaultLicenseEnum defaultLicense) {
    this.defaultLicense = defaultLicense;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateAccountRequest.name) &&
        Objects.equals(this.defaultLicense, updateAccountRequest.defaultLicense);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, defaultLicense);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("DefaultLicense") != null && !jsonObj.get("DefaultLicense").isJsonNull()) && !jsonObj.get("DefaultLicense").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `DefaultLicense` to be a primitive type in the JSON string but got `%s`", jsonObj.get("DefaultLicense").toString()));
      }
      // validate the optional field `DefaultLicense`
      if (jsonObj.get("DefaultLicense") != null && !jsonObj.get("DefaultLicense").isJsonNull()) {
        DefaultLicenseEnum.validateJsonElement(jsonObj.get("DefaultLicense"));
      }
  }
