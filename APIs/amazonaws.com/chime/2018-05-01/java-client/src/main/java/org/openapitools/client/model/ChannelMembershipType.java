...
/**
 * Gets or Sets ChannelMembershipType
 */
@JsonAdapter(ChannelMembershipType.Adapter.class)
public enum ChannelMembershipType {
  ...
  ChannelMembershipType(String value) {
    this.value = value;
  }
  ...
  public static ChannelMembershipType fromValue(String value) {
    for (ChannelMembershipType b : ChannelMembershipType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChannelMembershipType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelMembershipType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChannelMembershipType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChannelMembershipType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChannelMembershipType.fromValue(value);
  }
}
