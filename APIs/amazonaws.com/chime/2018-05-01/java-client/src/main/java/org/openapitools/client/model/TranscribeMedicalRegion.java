...
/**
 * Gets or Sets TranscribeMedicalRegion
 */
@JsonAdapter(TranscribeMedicalRegion.Adapter.class)
public enum TranscribeMedicalRegion {
  ...
  TranscribeMedicalRegion(String value) {
    this.value = value;
  }
  ...
  public static TranscribeMedicalRegion fromValue(String value) {
    for (TranscribeMedicalRegion b : TranscribeMedicalRegion.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeMedicalRegion> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeMedicalRegion enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeMedicalRegion read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeMedicalRegion.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeMedicalRegion.fromValue(value);
  }
}
