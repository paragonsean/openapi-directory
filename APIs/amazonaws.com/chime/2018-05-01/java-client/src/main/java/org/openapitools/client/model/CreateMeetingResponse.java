...
import org.openapitools.client.model.CreateMeetingResponseMeeting;
...
public class CreateMeetingResponse {
  ...
  private CreateMeetingResponseMeeting meeting;

  public CreateMeetingResponse() {
  }

  public CreateMeetingResponse meeting(CreateMeetingResponseMeeting meeting) {
  ...
  public CreateMeetingResponseMeeting getMeeting() {
    return meeting;
  }

  public void setMeeting(CreateMeetingResponseMeeting meeting) {
    this.meeting = meeting;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meeting, createMeetingResponse.meeting);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMeetingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMeetingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateMeetingResponse is not found in the empty JSON string", CreateMeetingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMeetingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMeetingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Meeting`
      if (jsonObj.get("Meeting") != null && !jsonObj.get("Meeting").isJsonNull()) {
        CreateMeetingResponseMeeting.validateJsonElement(jsonObj.get("Meeting"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateMeetingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateMeetingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateMeetingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateMeetingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateMeetingResponse>() {
           @Override
           public void write(JsonWriter out, CreateMeetingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateMeetingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateMeetingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateMeetingResponse
   * @throws IOException if the JSON string is invalid with respect to CreateMeetingResponse
   */
  public static CreateMeetingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateMeetingResponse.class);
  }

  /**
   * Convert an instance of CreateMeetingResponse to an JSON string
   *
   * @return JSON string
   */
