...
/**
 * Gets or Sets CallingNameStatus
 */
@JsonAdapter(CallingNameStatus.Adapter.class)
public enum CallingNameStatus {
  ...
  CallingNameStatus(String value) {
    this.value = value;
  }
  ...
  public static CallingNameStatus fromValue(String value) {
    for (CallingNameStatus b : CallingNameStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<CallingNameStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CallingNameStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CallingNameStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CallingNameStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CallingNameStatus.fromValue(value);
  }
}
