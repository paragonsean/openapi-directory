 ...
 */
@JsonAdapter(ChannelMode.Adapter.class)
public enum ChannelMode {
  ...
  public static ChannelMode fromValue(String value) {
    for (ChannelMode b : ChannelMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChannelMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChannelMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChannelMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChannelMode.fromValue(value);
  }
}
