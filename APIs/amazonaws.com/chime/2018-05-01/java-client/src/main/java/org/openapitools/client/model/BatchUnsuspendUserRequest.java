...
public class BatchUnsuspendUserRequest {
  ...
  public BatchUnsuspendUserRequest() {
  }

  public BatchUnsuspendUserRequest userIdList(List<String> userIdList) {
    this.userIdList = userIdList;
    return this;
  }

  public BatchUnsuspendUserRequest addUserIdListItem(String userIdListItem) {
  ...
  public boolean equals(Object o) {
    ...
    BatchUnsuspendUserRequest batchUnsuspendUserRequest = (BatchUnsuspendUserRequest) o;
    return Objects.equals(this.userIdList, batchUnsuspendUserRequest.userIdList);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchUnsuspendUserRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchUnsuspendUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchUnsuspendUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchUnsuspendUserRequest is not found in the empty JSON string", BatchUnsuspendUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchUnsuspendUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchUnsuspendUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchUnsuspendUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchUnsuspendUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchUnsuspendUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchUnsuspendUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchUnsuspendUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchUnsuspendUserRequest>() {
           @Override
           public void write(JsonWriter out, BatchUnsuspendUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchUnsuspendUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchUnsuspendUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchUnsuspendUserRequest
   * @throws IOException if the JSON string is invalid with respect to BatchUnsuspendUserRequest
   */
  public static BatchUnsuspendUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchUnsuspendUserRequest.class);
  }

  /**
   * Convert an instance of BatchUnsuspendUserRequest to an JSON string
   *
   * @return JSON string
   */
