 ...
 */
@JsonAdapter(License.Adapter.class)
public enum License {
  ...
  public static class Adapter extends TypeAdapter<License> {
    @Override
    public void write(final JsonWriter jsonWriter, final License enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public License read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return License.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    License.fromValue(value);
  }
}
