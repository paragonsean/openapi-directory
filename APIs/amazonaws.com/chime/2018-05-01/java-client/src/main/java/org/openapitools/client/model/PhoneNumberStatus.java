 ...
 */
@JsonAdapter(PhoneNumberStatus.Adapter.class)
public enum PhoneNumberStatus {
  ...
  public static PhoneNumberStatus fromValue(String value) {
    for (PhoneNumberStatus b : PhoneNumberStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<PhoneNumberStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final PhoneNumberStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PhoneNumberStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PhoneNumberStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PhoneNumberStatus.fromValue(value);
  }
}
