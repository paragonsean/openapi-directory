...
public class ListMeetingsResponse {
  ...
  public ListMeetingsResponse meetings(List meetings) {
  ...
  public ListMeetingsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListMeetingsResponse listMeetingsResponse = (ListMeetingsResponse) o;
    return Objects.equals(this.meetings, listMeetingsResponse.meetings) &&
        Objects.equals(this.nextToken, listMeetingsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meetings, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListMeetingsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListMeetingsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListMeetingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMeetingsResponse is not found in the empty JSON string", ListMeetingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListMeetingsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListMeetingsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Meetings`
      if (jsonObj.get("Meetings") != null && !jsonObj.get("Meetings").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Meetings"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMeetingsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMeetingsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMeetingsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMeetingsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMeetingsResponse>() {
           @Override
           public void write(JsonWriter out, ListMeetingsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListMeetingsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListMeetingsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListMeetingsResponse
   * @throws IOException if the JSON string is invalid with respect to ListMeetingsResponse
   */
  public static ListMeetingsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMeetingsResponse.class);
  }

  /**
   * Convert an instance of ListMeetingsResponse to an JSON string
   *
   * @return JSON string
   */
