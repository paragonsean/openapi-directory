...
public class GetUserResponseUser {
  ...
  public GetUserResponseUser accountId(String accountId) {
  ...
  public GetUserResponseUser primaryEmail(String primaryEmail) {
  ...
  public GetUserResponseUser primaryProvisionedNumber(String primaryProvisionedNumber) {
  ...
  public GetUserResponseUser displayName(String displayName) {
  ...
  public GetUserResponseUser licenseType(License licenseType) {
  ...
  public GetUserResponseUser userType(UserType userType) {
  ...
  public GetUserResponseUser userRegistrationStatus(RegistrationStatus userRegistrationStatus) {
  ...
  public GetUserResponseUser userInvitationStatus(InviteStatus userInvitationStatus) {
  ...
  public GetUserResponseUser registeredOn(OffsetDateTime registeredOn) {
  ...
  public GetUserResponseUser invitedOn(OffsetDateTime invitedOn) {
  ...
  public GetUserResponseUser alexaForBusinessMetadata(UpdateUserRequestItemAlexaForBusinessMetadata alexaForBusinessMetadata) {
  ...
  public GetUserResponseUser personalPIN(String personalPIN) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userId, getUserResponseUser.userId) &&
        Objects.equals(this.accountId, getUserResponseUser.accountId) &&
        Objects.equals(this.primaryEmail, getUserResponseUser.primaryEmail) &&
        Objects.equals(this.primaryProvisionedNumber, getUserResponseUser.primaryProvisionedNumber) &&
        Objects.equals(this.displayName, getUserResponseUser.displayName) &&
        Objects.equals(this.licenseType, getUserResponseUser.licenseType) &&
        Objects.equals(this.userType, getUserResponseUser.userType) &&
        Objects.equals(this.userRegistrationStatus, getUserResponseUser.userRegistrationStatus) &&
        Objects.equals(this.userInvitationStatus, getUserResponseUser.userInvitationStatus) &&
        Objects.equals(this.registeredOn, getUserResponseUser.registeredOn) &&
        Objects.equals(this.invitedOn, getUserResponseUser.invitedOn) &&
        Objects.equals(this.alexaForBusinessMetadata, getUserResponseUser.alexaForBusinessMetadata) &&
        Objects.equals(this.personalPIN, getUserResponseUser.personalPIN);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserResponseUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserResponseUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserResponseUser is not found in the empty JSON string", GetUserResponseUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserResponseUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserResponseUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUserResponseUser.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserResponseUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserResponseUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserResponseUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserResponseUser.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserResponseUser>() {
           @Override
           public void write(JsonWriter out, GetUserResponseUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserResponseUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserResponseUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserResponseUser
   * @throws IOException if the JSON string is invalid with respect to GetUserResponseUser
   */
  public static GetUserResponseUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserResponseUser.class);
  }

  /**
   * Convert an instance of GetUserResponseUser to an JSON string
   *
   * @return JSON string
   */
