...
public class Proxy {
  public static final String SERIALIZED_NAME_DEFAULT_SESSION_EXPIRY_MINUTES = "DefaultSessionExpiryMinutes";
  @SerializedName(SERIALIZED_NAME_DEFAULT_SESSION_EXPIRY_MINUTES)
  ...
  public static final String SERIALIZED_NAME_FALL_BACK_PHONE_NUMBER = "FallBackPhoneNumber";
  @SerializedName(SERIALIZED_NAME_FALL_BACK_PHONE_NUMBER)
  private String fallBackPhoneNumber;

  public static final String SERIALIZED_NAME_PHONE_NUMBER_COUNTRIES = "PhoneNumberCountries";
  @SerializedName(SERIALIZED_NAME_PHONE_NUMBER_COUNTRIES)
  private List phoneNumberCountries;

  public Proxy() {
  }

  public Proxy defaultSessionExpiryMinutes(Integer defaultSessionExpiryMinutes) {
    this.defaultSessionExpiryMinutes = defaultSessionExpiryMinutes;
    return this;
  }

  /**
   * Get defaultSessionExpiryMinutes
  ...
  public Proxy disabled(Boolean disabled) {
  ...
  public Proxy fallBackPhoneNumber(String fallBackPhoneNumber) {
    this.fallBackPhoneNumber = fallBackPhoneNumber;
    return this;
  }

  /**
   * Get fallBackPhoneNumber
  ...
  public Proxy phoneNumberCountries(List phoneNumberCountries) {
    this.phoneNumberCountries = phoneNumberCountries;
    return this;
  }

  /**
   * Get phoneNumberCountries
   * @return phoneNumberCountries
   */
  @javax.annotation.Nullable
  public List getPhoneNumberCountries() {
    return phoneNumberCountries;
  }

  public void setPhoneNumberCountries(List phoneNumberCountries) {
    this.phoneNumberCountries = phoneNumberCountries;
  }
  ...
  public boolean equals(Object o) {
    ...
    Proxy proxy = (Proxy) o;
    return Objects.equals(this.defaultSessionExpiryMinutes, proxy.defaultSessionExpiryMinutes) &&
        Objects.equals(this.disabled, proxy.disabled) &&
        Objects.equals(this.fallBackPhoneNumber, proxy.fallBackPhoneNumber) &&
        Objects.equals(this.phoneNumberCountries, proxy.phoneNumberCountries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultSessionExpiryMinutes, disabled, fallBackPhoneNumber, phoneNumberCountries);
  }
  ...
  public String toString() {
    ...
    sb.append("    defaultSessionExpiryMinutes: ").append(toIndentedString(defaultSessionExpiryMinutes)).append("\n");
    sb.append("    disabled: ").append(toIndentedString(disabled)).append("\n");
    sb.append("    fallBackPhoneNumber: ").append(toIndentedString(fallBackPhoneNumber)).append("\n");
    sb.append("    phoneNumberCountries: ").append(toIndentedString(phoneNumberCountries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DefaultSessionExpiryMinutes");
    openapiFields.add("Disabled");
    openapiFields.add("FallBackPhoneNumber");
    openapiFields.add("PhoneNumberCountries");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("DefaultSessionExpiryMinutes") != null && !jsonObj.get("DefaultSessionExpiryMinutes").isJsonNull()) {
        Integer.validateJsonElement(jsonObj.get("DefaultSessionExpiryMinutes"));
      }
      ...
      if (jsonObj.get("FallBackPhoneNumber") != null && !jsonObj.get("FallBackPhoneNumber").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("FallBackPhoneNumber"));
      }
      // validate the optional field `PhoneNumberCountries`
      if (jsonObj.get("PhoneNumberCountries") != null && !jsonObj.get("PhoneNumberCountries").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("PhoneNumberCountries"));
      }
  }
