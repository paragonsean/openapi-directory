...
public class UpdateSipRuleRequest {
  ...
  public UpdateSipRuleRequest() {
  }

  public UpdateSipRuleRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateSipRuleRequest disabled(Boolean disabled) {
  ...
  public UpdateSipRuleRequest targetApplications(List<SipRuleTargetApplication> targetApplications) {
    this.targetApplications = targetApplications;
    return this;
  }

  public UpdateSipRuleRequest addTargetApplicationsItem(SipRuleTargetApplication targetApplicationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSipRuleRequest updateSipRuleRequest = (UpdateSipRuleRequest) o;
    return Objects.equals(this.name, updateSipRuleRequest.name) &&
        Objects.equals(this.disabled, updateSipRuleRequest.disabled) &&
        Objects.equals(this.targetApplications, updateSipRuleRequest.targetApplications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, disabled, targetApplications);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateSipRuleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSipRuleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSipRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSipRuleRequest is not found in the empty JSON string", UpdateSipRuleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSipRuleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSipRuleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSipRuleRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("TargetApplications") != null && !jsonObj.get("TargetApplications").isJsonNull()) {
        ...
        if (jsonArraytargetApplications != null) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSipRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSipRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSipRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSipRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSipRuleRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSipRuleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSipRuleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSipRuleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSipRuleRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateSipRuleRequest
   */
  public static UpdateSipRuleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSipRuleRequest.class);
  }

  /**
   * Convert an instance of UpdateSipRuleRequest to an JSON string
   *
   * @return JSON string
   */
