...
/**
 * Gets or Sets SipRuleTriggerType
 */
@JsonAdapter(SipRuleTriggerType.Adapter.class)
public enum SipRuleTriggerType {
  ...
  SipRuleTriggerType(String value) {
    this.value = value;
  }
  ...
  public static SipRuleTriggerType fromValue(String value) {
    for (SipRuleTriggerType b : SipRuleTriggerType.values()) {
  ...
  public static class Adapter extends TypeAdapter<SipRuleTriggerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SipRuleTriggerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SipRuleTriggerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SipRuleTriggerType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SipRuleTriggerType.fromValue(value);
  }
}
