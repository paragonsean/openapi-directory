...
public class MediaCapturePipeline {
  ...
  public MediaCapturePipeline mediaPipelineId(String mediaPipelineId) {
  ...
  public MediaCapturePipeline sourceType(MediaPipelineSourceType sourceType) {
  ...
  public MediaCapturePipeline sourceArn(String sourceArn) {
  ...
  public MediaCapturePipeline status(MediaPipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public MediaCapturePipeline sinkType(MediaPipelineSinkType sinkType) {
  ...
  public MediaCapturePipeline sinkArn(String sinkArn) {
  ...
  public MediaCapturePipeline createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public MediaCapturePipeline updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public MediaCapturePipeline chimeSdkMeetingConfiguration(CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration chimeSdkMeetingConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    MediaCapturePipeline mediaCapturePipeline = (MediaCapturePipeline) o;
    return Objects.equals(this.mediaPipelineId, mediaCapturePipeline.mediaPipelineId) &&
        Objects.equals(this.sourceType, mediaCapturePipeline.sourceType) &&
        Objects.equals(this.sourceArn, mediaCapturePipeline.sourceArn) &&
        Objects.equals(this.status, mediaCapturePipeline.status) &&
        Objects.equals(this.sinkType, mediaCapturePipeline.sinkType) &&
        Objects.equals(this.sinkArn, mediaCapturePipeline.sinkArn) &&
        Objects.equals(this.createdTimestamp, mediaCapturePipeline.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, mediaCapturePipeline.updatedTimestamp) &&
        Objects.equals(this.chimeSdkMeetingConfiguration, mediaCapturePipeline.chimeSdkMeetingConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaCapturePipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaCapturePipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaCapturePipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaCapturePipeline is not found in the empty JSON string", MediaCapturePipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaCapturePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaCapturePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaCapturePipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaCapturePipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaCapturePipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaCapturePipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaCapturePipeline>() {
           @Override
           public void write(JsonWriter out, MediaCapturePipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaCapturePipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaCapturePipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaCapturePipeline
   * @throws IOException if the JSON string is invalid with respect to MediaCapturePipeline
   */
  public static MediaCapturePipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaCapturePipeline.class);
  }

  /**
   * Convert an instance of MediaCapturePipeline to an JSON string
   *
   * @return JSON string
   */
