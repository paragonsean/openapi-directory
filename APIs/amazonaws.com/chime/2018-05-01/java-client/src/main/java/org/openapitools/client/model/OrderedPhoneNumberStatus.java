...
/**
 * Gets or Sets OrderedPhoneNumberStatus
 */
@JsonAdapter(OrderedPhoneNumberStatus.Adapter.class)
public enum OrderedPhoneNumberStatus {
  ...
  OrderedPhoneNumberStatus(String value) {
    this.value = value;
  }
  ...
  public static OrderedPhoneNumberStatus fromValue(String value) {
    for (OrderedPhoneNumberStatus b : OrderedPhoneNumberStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<OrderedPhoneNumberStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderedPhoneNumberStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OrderedPhoneNumberStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OrderedPhoneNumberStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OrderedPhoneNumberStatus.fromValue(value);
  }
}
