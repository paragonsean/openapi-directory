...
import org.openapitools.client.model.EmailStatus;
...
public class Invite {
  ...
  public Invite inviteId(String inviteId) {
  ...
  public Invite emailAddress(String emailAddress) {
  ...
  public Invite emailStatus(EmailStatus emailStatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inviteId, invite.inviteId) &&
        Objects.equals(this.status, invite.status) &&
        Objects.equals(this.emailAddress, invite.emailAddress) &&
        Objects.equals(this.emailStatus, invite.emailStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inviteId, status, emailAddress, emailStatus);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Invite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Invite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `InviteId`
      if (jsonObj.get("InviteId") != null && !jsonObj.get("InviteId").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("InviteId"));
      }
      ...
      // validate the optional field `EmailStatus`
      if (jsonObj.get("EmailStatus") != null && !jsonObj.get("EmailStatus").isJsonNull()) {
        EmailStatus.validateJsonElement(jsonObj.get("EmailStatus"));
      }
  }
