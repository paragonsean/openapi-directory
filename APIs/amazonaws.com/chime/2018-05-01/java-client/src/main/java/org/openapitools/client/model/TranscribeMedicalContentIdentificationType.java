...
/**
 * Gets or Sets TranscribeMedicalContentIdentificationType
 */
@JsonAdapter(TranscribeMedicalContentIdentificationType.Adapter.class)
public enum TranscribeMedicalContentIdentificationType {
  ...
  TranscribeMedicalContentIdentificationType(String value) {
    this.value = value;
  }
  ...
  public static TranscribeMedicalContentIdentificationType fromValue(String value) {
    for (TranscribeMedicalContentIdentificationType b : TranscribeMedicalContentIdentificationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeMedicalContentIdentificationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeMedicalContentIdentificationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeMedicalContentIdentificationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeMedicalContentIdentificationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeMedicalContentIdentificationType.fromValue(value);
  }
}
