...
public class ListRoomsResponse {
  ...
  public ListRoomsResponse rooms(List rooms) {
    this.rooms = rooms;
    return this;
  }
  ...
  public ListRoomsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rooms, listRoomsResponse.rooms) &&
        Objects.equals(this.nextToken, listRoomsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rooms, nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRoomsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRoomsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRoomsResponse is not found in the empty JSON string", ListRoomsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRoomsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRoomsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `Rooms`
      if (jsonObj.get("Rooms") != null && !jsonObj.get("Rooms").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("Rooms"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRoomsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRoomsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRoomsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRoomsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRoomsResponse>() {
           @Override
           public void write(JsonWriter out, ListRoomsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRoomsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRoomsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRoomsResponse
   * @throws IOException if the JSON string is invalid with respect to ListRoomsResponse
   */
  public static ListRoomsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRoomsResponse.class);
  }

  /**
   * Convert an instance of ListRoomsResponse to an JSON string
   *
   * @return JSON string
   */
