...
/**
 * Gets or Sets TranscribeContentIdentificationType
 */
@JsonAdapter(TranscribeContentIdentificationType.Adapter.class)
public enum TranscribeContentIdentificationType {
  ...
  TranscribeContentIdentificationType(String value) {
    this.value = value;
  }
  ...
  public static TranscribeContentIdentificationType fromValue(String value) {
    for (TranscribeContentIdentificationType b : TranscribeContentIdentificationType.values()) {
  ...
  public static class Adapter extends TypeAdapter<TranscribeContentIdentificationType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TranscribeContentIdentificationType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TranscribeContentIdentificationType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TranscribeContentIdentificationType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TranscribeContentIdentificationType.fromValue(value);
  }
}
