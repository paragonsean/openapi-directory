...
/**
 * Gets or Sets VoiceConnectorAwsRegion
 */
@JsonAdapter(VoiceConnectorAwsRegion.Adapter.class)
public enum VoiceConnectorAwsRegion {
  ...
  VoiceConnectorAwsRegion(String value) {
    this.value = value;
  }
  ...
  public static VoiceConnectorAwsRegion fromValue(String value) {
    for (VoiceConnectorAwsRegion b : VoiceConnectorAwsRegion.values()) {
  ...
  public static class Adapter extends TypeAdapter<VoiceConnectorAwsRegion> {
    @Override
    public void write(final JsonWriter jsonWriter, final VoiceConnectorAwsRegion enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VoiceConnectorAwsRegion read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VoiceConnectorAwsRegion.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VoiceConnectorAwsRegion.fromValue(value);
  }
}
