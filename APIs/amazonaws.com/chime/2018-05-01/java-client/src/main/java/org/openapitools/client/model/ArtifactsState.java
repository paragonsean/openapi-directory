...
/**
 * Gets or Sets ArtifactsState
 */
@JsonAdapter(ArtifactsState.Adapter.class)
public enum ArtifactsState {
  ...
  public static ArtifactsState fromValue(String value) {
    for (ArtifactsState b : ArtifactsState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ArtifactsState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ArtifactsState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ArtifactsState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ArtifactsState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ArtifactsState.fromValue(value);
  }
}
