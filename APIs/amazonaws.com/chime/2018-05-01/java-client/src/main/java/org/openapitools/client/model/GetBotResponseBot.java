...
public class GetBotResponseBot {
  ...
  public static final String SERIALIZED_NAME_BOT_EMAIL = "BotEmail";
  ...
  public GetBotResponseBot() {
  }

  public GetBotResponseBot botId(String botId) {
    this.botId = botId;
    return this;
  }
  ...
  public GetBotResponseBot userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public GetBotResponseBot displayName(String displayName) {
  ...
  public GetBotResponseBot botType(BotType botType) {
  ...
  public GetBotResponseBot disabled(Boolean disabled) {
  ...
  public GetBotResponseBot createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetBotResponseBot updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public GetBotResponseBot botEmail(String botEmail) {
  ...
  public GetBotResponseBot securityToken(String securityToken) {
  ...
  public boolean equals(Object o) {
    ...
    GetBotResponseBot getBotResponseBot = (GetBotResponseBot) o;
    return Objects.equals(this.botId, getBotResponseBot.botId) &&
        Objects.equals(this.userId, getBotResponseBot.userId) &&
        Objects.equals(this.displayName, getBotResponseBot.displayName) &&
        Objects.equals(this.botType, getBotResponseBot.botType) &&
        Objects.equals(this.disabled, getBotResponseBot.disabled) &&
        Objects.equals(this.createdTimestamp, getBotResponseBot.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, getBotResponseBot.updatedTimestamp) &&
        Objects.equals(this.botEmail, getBotResponseBot.botEmail) &&
        Objects.equals(this.securityToken, getBotResponseBot.securityToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(botId, userId, displayName, botType, disabled, createdTimestamp, updatedTimestamp, botEmail, securityToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetBotResponseBot {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBotResponseBot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBotResponseBot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBotResponseBot is not found in the empty JSON string", GetBotResponseBot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBotResponseBot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBotResponseBot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("BotEmail") != null && !jsonObj.get("BotEmail").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("BotEmail"));
      }
      // validate the optional field `SecurityToken`
      if (jsonObj.get("SecurityToken") != null && !jsonObj.get("SecurityToken").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("SecurityToken"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBotResponseBot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBotResponseBot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBotResponseBot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBotResponseBot.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBotResponseBot>() {
           @Override
           public void write(JsonWriter out, GetBotResponseBot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBotResponseBot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBotResponseBot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBotResponseBot
   * @throws IOException if the JSON string is invalid with respect to GetBotResponseBot
   */
  public static GetBotResponseBot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBotResponseBot.class);
  }

  /**
   * Convert an instance of GetBotResponseBot to an JSON string
   *
   * @return JSON string
   */
