...
import org.openapitools.client.model.GetUserResponseUser;
...
public class GetUserResponse {
  ...
  private GetUserResponseUser user;

  public GetUserResponse() {
  }

  public GetUserResponse user(GetUserResponseUser user) {
    this.user = user;
    return this;
  }
  ...
  public void setUser(GetUserResponseUser user) {
    this.user = user;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("User") != null && !jsonObj.get("User").isJsonNull()) {
        GetUserResponseUser.validateJsonElement(jsonObj.get("User"));
      }
  }
