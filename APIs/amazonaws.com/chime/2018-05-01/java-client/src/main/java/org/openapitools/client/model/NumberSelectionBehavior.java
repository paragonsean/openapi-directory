...
/**
 * Gets or Sets NumberSelectionBehavior
 */
@JsonAdapter(NumberSelectionBehavior.Adapter.class)
public enum NumberSelectionBehavior {
  ...
  NumberSelectionBehavior(String value) {
    this.value = value;
  }
  ...
  public static NumberSelectionBehavior fromValue(String value) {
    for (NumberSelectionBehavior b : NumberSelectionBehavior.values()) {
  ...
  public static class Adapter extends TypeAdapter<NumberSelectionBehavior> {
    @Override
    public void write(final JsonWriter jsonWriter, final NumberSelectionBehavior enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public NumberSelectionBehavior read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return NumberSelectionBehavior.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    NumberSelectionBehavior.fromValue(value);
  }
}
