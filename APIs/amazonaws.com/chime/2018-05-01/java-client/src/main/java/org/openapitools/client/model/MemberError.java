...
public class MemberError {
  ...
  public MemberError memberId(String memberId) {
  ...
  public MemberError errorCode(ErrorCode errorCode) {
  ...
  public MemberError errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.memberId, memberError.memberId) &&
        Objects.equals(this.errorCode, memberError.errorCode) &&
        Objects.equals(this.errorMessage, memberError.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memberId, errorCode, errorMessage);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MemberError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MemberError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberError is not found in the empty JSON string", MemberError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MemberError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MemberError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberError.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberError>() {
           @Override
           public void write(JsonWriter out, MemberError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MemberError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MemberError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MemberError
   * @throws IOException if the JSON string is invalid with respect to MemberError
   */
  public static MemberError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberError.class);
  }

  /**
   * Convert an instance of MemberError to an JSON string
   *
   * @return JSON string
   */
