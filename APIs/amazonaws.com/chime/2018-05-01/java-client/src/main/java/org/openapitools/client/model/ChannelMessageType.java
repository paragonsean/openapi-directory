...
/**
 * Gets or Sets ChannelMessageType
 */
@JsonAdapter(ChannelMessageType.Adapter.class)
public enum ChannelMessageType {
  ...
  ChannelMessageType(String value) {
    this.value = value;
  }
  ...
  public static ChannelMessageType fromValue(String value) {
    for (ChannelMessageType b : ChannelMessageType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChannelMessageType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChannelMessageType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChannelMessageType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChannelMessageType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChannelMessageType.fromValue(value);
  }
}
