...
/**
 * Gets or Sets RoomMembershipRole
 */
@JsonAdapter(RoomMembershipRole.Adapter.class)
public enum RoomMembershipRole {
  ...
  RoomMembershipRole(String value) {
    this.value = value;
  }
  ...
  public static RoomMembershipRole fromValue(String value) {
    for (RoomMembershipRole b : RoomMembershipRole.values()) {
  ...
  public static class Adapter extends TypeAdapter<RoomMembershipRole> {
    @Override
    public void write(final JsonWriter jsonWriter, final RoomMembershipRole enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RoomMembershipRole read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RoomMembershipRole.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RoomMembershipRole.fromValue(value);
  }
}
