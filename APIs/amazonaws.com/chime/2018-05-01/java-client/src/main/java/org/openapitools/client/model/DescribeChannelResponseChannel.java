...
public class DescribeChannelResponseChannel {
  ...
  public DescribeChannelResponseChannel() {
  }

  public DescribeChannelResponseChannel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeChannelResponseChannel channelArn(String channelArn) {
  ...
  public DescribeChannelResponseChannel mode(ChannelMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public DescribeChannelResponseChannel privacy(ChannelPrivacy privacy) {
  ...
  public DescribeChannelResponseChannel metadata(String metadata) {
  ...
  public DescribeChannelResponseChannel createdBy(ChannelCreatedBy createdBy) {
  ...
  public DescribeChannelResponseChannel createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public DescribeChannelResponseChannel lastMessageTimestamp(OffsetDateTime lastMessageTimestamp) {
  ...
  public DescribeChannelResponseChannel lastUpdatedTimestamp(OffsetDateTime lastUpdatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeChannelResponseChannel describeChannelResponseChannel = (DescribeChannelResponseChannel) o;
    return Objects.equals(this.name, describeChannelResponseChannel.name) &&
        Objects.equals(this.channelArn, describeChannelResponseChannel.channelArn) &&
        Objects.equals(this.mode, describeChannelResponseChannel.mode) &&
        Objects.equals(this.privacy, describeChannelResponseChannel.privacy) &&
        Objects.equals(this.metadata, describeChannelResponseChannel.metadata) &&
        Objects.equals(this.createdBy, describeChannelResponseChannel.createdBy) &&
        Objects.equals(this.createdTimestamp, describeChannelResponseChannel.createdTimestamp) &&
        Objects.equals(this.lastMessageTimestamp, describeChannelResponseChannel.lastMessageTimestamp) &&
        Objects.equals(this.lastUpdatedTimestamp, describeChannelResponseChannel.lastUpdatedTimestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeChannelResponseChannel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeChannelResponseChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeChannelResponseChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeChannelResponseChannel is not found in the empty JSON string", DescribeChannelResponseChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeChannelResponseChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeChannelResponseChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeChannelResponseChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeChannelResponseChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeChannelResponseChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeChannelResponseChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeChannelResponseChannel>() {
           @Override
           public void write(JsonWriter out, DescribeChannelResponseChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeChannelResponseChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeChannelResponseChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeChannelResponseChannel
   * @throws IOException if the JSON string is invalid with respect to DescribeChannelResponseChannel
   */
  public static DescribeChannelResponseChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeChannelResponseChannel.class);
  }

  /**
   * Convert an instance of DescribeChannelResponseChannel to an JSON string
   *
   * @return JSON string
   */
