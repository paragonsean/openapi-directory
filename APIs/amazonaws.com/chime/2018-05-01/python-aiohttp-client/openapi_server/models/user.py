...
class User(Model):
    ...
    def __init__(self, user_id: str=None, account_id: str=None, primary_email: str=None, primary_provisioned_number: str=None, display_name: str=None, license_type: License=None, user_type: UserType=None, user_registration_status: RegistrationStatus=None, user_invitation_status: InviteStatus=None, registered_on: datetime=None, invited_on: datetime=None, alexa_for_business_metadata: UpdateUserRequestItemAlexaForBusinessMetadata=None, personal_pin: str=None):
        ...
        :param primary_provisioned_number: The primary_provisioned_number of this User.
        :param display_name: The display_name of this User.
        :param license_type: The license_type of this User.
        :param user_type: The user_type of this User.
        :param user_registration_status: The user_registration_status of this User.
        :param user_invitation_status: The user_invitation_status of this User.
        :param registered_on: The registered_on of this User.
        :param invited_on: The invited_on of this User.
        :param alexa_for_business_metadata: The alexa_for_business_metadata of this User.
        :param personal_pin: The personal_pin of this User.
        """
        self.openapi_types = {
            'user_id': str,
            'account_id': str,
    ...
    def primary_provisioned_number(self):
        """Gets the primary_provisioned_number of this User.


        :return: The primary_provisioned_number of this User.
        :rtype: str
        """
    ...
    def primary_provisioned_number(self, primary_provisioned_number):
        """Sets the primary_provisioned_number of this User.
    ...
    def license_type(self):
        """Gets the license_type of this User.


        :return: The license_type of this User.
        :rtype: License
        """
    ...
    def user_registration_status(self):
        """Gets the user_registration_status of this User.


        :return: The user_registration_status of this User.
    ...
    def user_registration_status(self, user_registration_status):
        """Sets the user_registration_status of this User.
    ...
    def user_invitation_status(self):
        """Gets the user_invitation_status of this User.


        :return: The user_invitation_status of this User.
        :rtype: InviteStatus
        """
    ...
    def user_invitation_status(self, user_invitation_status):
        """Sets the user_invitation_status of this User.
    ...
    @property
    def invited_on(self):
        """Gets the invited_on of this User.


        :return: The invited_on of this User.
        :rtype: datetime
        """
    ...
    def invited_on(self, invited_on):
        """Sets the invited_on of this User.
    ...
    def alexa_for_business_metadata(self):
        """Gets the alexa_for_business_metadata of this User.


        :return: The alexa_for_business_metadata of this User.
    ...
    def alexa_for_business_metadata(self, alexa_for_business_metadata):
        """Sets the alexa_for_business_metadata of this User.
    ...
    def personal_pin(self):
        """Gets the personal_pin of this User.


        :return: The personal_pin of this User.
        :rtype: str
        """
    ...
    def personal_pin(self, personal_pin):
        """Sets the personal_pin of this User.
