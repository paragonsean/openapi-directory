...
class TranscriptionConfiguration(Model):
    ...
    def __init__(self, engine_transcribe_settings: StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings=None, engine_transcribe_medical_settings: StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings=None):
        """TranscriptionConfiguration - a model defined in OpenAPI

        :param engine_transcribe_settings: The engine_transcribe_settings of this TranscriptionConfiguration.
        :param engine_transcribe_medical_settings: The engine_transcribe_medical_settings of this TranscriptionConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TranscriptionConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TranscriptionConfiguration of this TranscriptionConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def engine_transcribe_settings(self):
        """Gets the engine_transcribe_settings of this TranscriptionConfiguration.


        :return: The engine_transcribe_settings of this TranscriptionConfiguration.
    ...
    def engine_transcribe_settings(self, engine_transcribe_settings):
        """Sets the engine_transcribe_settings of this TranscriptionConfiguration.
    ...
    def engine_transcribe_medical_settings(self):
        """Gets the engine_transcribe_medical_settings of this TranscriptionConfiguration.


        :return: The engine_transcribe_medical_settings of this TranscriptionConfiguration.
    ...
    def engine_transcribe_medical_settings(self, engine_transcribe_medical_settings):
        """Sets the engine_transcribe_medical_settings of this TranscriptionConfiguration.
