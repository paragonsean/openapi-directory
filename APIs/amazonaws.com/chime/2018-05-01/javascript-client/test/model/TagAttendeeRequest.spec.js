...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.TagAttendeeRequest();
  });
  ...
  describe('TagAttendeeRequest', function() {
    it('should create an instance of TagAttendeeRequest', function() {
      // uncomment below and update the code to test TagAttendeeRequest
      //var instance = new AmazonChime.TagAttendeeRequest();
      //expect(instance).to.be.a(AmazonChime.TagAttendeeRequest);
    });
