...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListProxySessionsResponse();
  });
  ...
  describe('ListProxySessionsResponse', function() {
    it('should create an instance of ListProxySessionsResponse', function() {
      // uncomment below and update the code to test ListProxySessionsResponse
      //var instance = new AmazonChime.ListProxySessionsResponse();
      //expect(instance).to.be.a(AmazonChime.ListProxySessionsResponse);
    });

    it('should have the property proxySessions (base name: "ProxySessions")', function() {
      // uncomment below and update the code to test the property proxySessions
      //var instance = new AmazonChime.ListProxySessionsResponse();
