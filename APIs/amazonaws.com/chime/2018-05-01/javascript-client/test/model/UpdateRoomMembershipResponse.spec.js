...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateRoomMembershipResponse();
  });
  ...
  describe('UpdateRoomMembershipResponse', function() {
    it('should create an instance of UpdateRoomMembershipResponse', function() {
      // uncomment below and update the code to test UpdateRoomMembershipResponse
      //var instance = new AmazonChime.UpdateRoomMembershipResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateRoomMembershipResponse);
    });
