...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instance = new AmazonChime.Address();
      //expect(instance).to.be.a(AmazonChime.Address);
    });
    ...
    it('should have the property postDirectional (base name: "postDirectional")', function() {
      // uncomment below and update the code to test the property postDirectional
      //var instance = new AmazonChime.Address();
      //expect(instance).to.be();
    });
    ...
    it('should have the property postalCodePlus4 (base name: "postalCodePlus4")', function() {
      // uncomment below and update the code to test the property postalCodePlus4
      //var instance = new AmazonChime.Address();
      //expect(instance).to.be();
    });
