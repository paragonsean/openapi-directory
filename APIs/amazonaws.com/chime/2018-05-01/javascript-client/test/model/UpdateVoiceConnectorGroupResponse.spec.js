...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateVoiceConnectorGroupResponse();
  });
  ...
  describe('UpdateVoiceConnectorGroupResponse', function() {
    it('should create an instance of UpdateVoiceConnectorGroupResponse', function() {
      // uncomment below and update the code to test UpdateVoiceConnectorGroupResponse
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateVoiceConnectorGroupResponse);
    });

    it('should have the property voiceConnectorGroup (base name: "VoiceConnectorGroup")', function() {
      // uncomment below and update the code to test the property voiceConnectorGroup
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupResponse();
