...
(function(root, factory) {
  ...
  describe('PhoneNumberOrderStatus', function() {
    it('should create an instance of PhoneNumberOrderStatus', function() {
      // uncomment below and update the code to test PhoneNumberOrderStatus
      //var instance = new AmazonChime.PhoneNumberOrderStatus();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberOrderStatus);
    });
