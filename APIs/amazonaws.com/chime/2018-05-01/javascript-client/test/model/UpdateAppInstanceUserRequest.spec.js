...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateAppInstanceUserRequest();
  });
  ...
  describe('UpdateAppInstanceUserRequest', function() {
    it('should create an instance of UpdateAppInstanceUserRequest', function() {
      // uncomment below and update the code to test UpdateAppInstanceUserRequest
      //var instance = new AmazonChime.UpdateAppInstanceUserRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateAppInstanceUserRequest);
    });
