...
(function(root, factory) {
  ...
  describe('ContentMuxType', function() {
    it('should create an instance of ContentMuxType', function() {
      // uncomment below and update the code to test ContentMuxType
      //var instance = new AmazonChime.ContentMuxType();
      //expect(instance).to.be.a(AmazonChime.ContentMuxType);
    });
