...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetGlobalSettingsResponseBusinessCalling();
  });
  ...
  describe('GetGlobalSettingsResponseBusinessCalling', function() {
    it('should create an instance of GetGlobalSettingsResponseBusinessCalling', function() {
      // uncomment below and update the code to test GetGlobalSettingsResponseBusinessCalling
      //var instance = new AmazonChime.GetGlobalSettingsResponseBusinessCalling();
      //expect(instance).to.be.a(AmazonChime.GetGlobalSettingsResponseBusinessCalling);
    });
