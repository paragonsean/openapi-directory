...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DeleteVoiceConnectorTerminationCredentialsRequest();
  });
  ...
  describe('DeleteVoiceConnectorTerminationCredentialsRequest', function() {
    it('should create an instance of DeleteVoiceConnectorTerminationCredentialsRequest', function() {
      // uncomment below and update the code to test DeleteVoiceConnectorTerminationCredentialsRequest
      //var instance = new AmazonChime.DeleteVoiceConnectorTerminationCredentialsRequest();
      //expect(instance).to.be.a(AmazonChime.DeleteVoiceConnectorTerminationCredentialsRequest);
    });
