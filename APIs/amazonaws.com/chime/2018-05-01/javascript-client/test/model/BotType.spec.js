...
(function(root, factory) {
  ...
  describe('BotType', function() {
    it('should create an instance of BotType', function() {
      // uncomment below and update the code to test BotType
      //var instance = new AmazonChime.BotType();
      //expect(instance).to.be.a(AmazonChime.BotType);
    });
