...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeAppInstanceAdminResponseAppInstanceAdmin();
  });
  ...
  describe('DescribeAppInstanceAdminResponseAppInstanceAdmin', function() {
    it('should create an instance of DescribeAppInstanceAdminResponseAppInstanceAdmin', function() {
      // uncomment below and update the code to test DescribeAppInstanceAdminResponseAppInstanceAdmin
      //var instance = new AmazonChime.DescribeAppInstanceAdminResponseAppInstanceAdmin();
      //expect(instance).to.be.a(AmazonChime.DescribeAppInstanceAdminResponseAppInstanceAdmin);
    });
