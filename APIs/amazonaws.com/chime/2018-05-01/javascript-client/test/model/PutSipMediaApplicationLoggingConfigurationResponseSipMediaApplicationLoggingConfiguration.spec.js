...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration();
  });
  ...
  describe('PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration', function() {
    it('should create an instance of PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration', function() {
      // uncomment below and update the code to test PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration
      //var instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration);
    });

    it('should have the property enableSipMediaApplicationMessageLogs (base name: "EnableSipMediaApplicationMessageLogs")', function() {
      // uncomment below and update the code to test the property enableSipMediaApplicationMessageLogs
      //var instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationResponseSipMediaApplicationLoggingConfiguration();
