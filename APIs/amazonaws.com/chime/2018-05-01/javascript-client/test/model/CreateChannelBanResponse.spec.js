...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateChannelBanResponse();
  });
  ...
  describe('CreateChannelBanResponse', function() {
    it('should create an instance of CreateChannelBanResponse', function() {
      // uncomment below and update the code to test CreateChannelBanResponse
      //var instance = new AmazonChime.CreateChannelBanResponse();
      //expect(instance).to.be.a(AmazonChime.CreateChannelBanResponse);
    });
