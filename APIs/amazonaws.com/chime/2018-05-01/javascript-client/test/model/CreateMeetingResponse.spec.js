...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingResponse();
  });
  ...
  describe('CreateMeetingResponse', function() {
    it('should create an instance of CreateMeetingResponse', function() {
      // uncomment below and update the code to test CreateMeetingResponse
      //var instance = new AmazonChime.CreateMeetingResponse();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingResponse);
    });
