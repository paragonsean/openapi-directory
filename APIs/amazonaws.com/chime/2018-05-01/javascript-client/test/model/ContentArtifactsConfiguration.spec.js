...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ContentArtifactsConfiguration();
  });
  ...
  describe('ContentArtifactsConfiguration', function() {
    it('should create an instance of ContentArtifactsConfiguration', function() {
      // uncomment below and update the code to test ContentArtifactsConfiguration
      //var instance = new AmazonChime.ContentArtifactsConfiguration();
      //expect(instance).to.be.a(AmazonChime.ContentArtifactsConfiguration);
    });
