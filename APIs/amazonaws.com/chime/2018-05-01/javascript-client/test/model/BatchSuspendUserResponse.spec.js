...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchSuspendUserResponse();
  });
  ...
  describe('BatchSuspendUserResponse', function() {
    it('should create an instance of BatchSuspendUserResponse', function() {
      // uncomment below and update the code to test BatchSuspendUserResponse
      //var instance = new AmazonChime.BatchSuspendUserResponse();
      //expect(instance).to.be.a(AmazonChime.BatchSuspendUserResponse);
    });
