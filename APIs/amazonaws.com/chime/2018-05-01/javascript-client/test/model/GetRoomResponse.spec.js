...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetRoomResponse();
  });
  ...
  describe('GetRoomResponse', function() {
    it('should create an instance of GetRoomResponse', function() {
      // uncomment below and update the code to test GetRoomResponse
      //var instance = new AmazonChime.GetRoomResponse();
      //expect(instance).to.be.a(AmazonChime.GetRoomResponse);
    });
