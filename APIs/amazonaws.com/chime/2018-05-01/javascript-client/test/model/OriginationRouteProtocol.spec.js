...
(function(root, factory) {
  ...
  describe('OriginationRouteProtocol', function() {
    it('should create an instance of OriginationRouteProtocol', function() {
      // uncomment below and update the code to test OriginationRouteProtocol
      //var instance = new AmazonChime.OriginationRouteProtocol();
      //expect(instance).to.be.a(AmazonChime.OriginationRouteProtocol);
    });
