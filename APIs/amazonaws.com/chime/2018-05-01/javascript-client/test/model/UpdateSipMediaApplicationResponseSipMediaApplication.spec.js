...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationResponseSipMediaApplication();
  });
  ...
  describe('UpdateSipMediaApplicationResponseSipMediaApplication', function() {
    it('should create an instance of UpdateSipMediaApplicationResponseSipMediaApplication', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationResponseSipMediaApplication
      //var instance = new AmazonChime.UpdateSipMediaApplicationResponseSipMediaApplication();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationResponseSipMediaApplication);
    });

    it('should have the property sipMediaApplicationId (base name: "SipMediaApplicationId")', function() {
      // uncomment below and update the code to test the property sipMediaApplicationId
      //var instance = new AmazonChime.UpdateSipMediaApplicationResponseSipMediaApplication();
