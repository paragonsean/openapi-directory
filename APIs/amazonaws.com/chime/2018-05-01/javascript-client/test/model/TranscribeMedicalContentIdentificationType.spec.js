...
(function(root, factory) {
  ...
  describe('TranscribeMedicalContentIdentificationType', function() {
    it('should create an instance of TranscribeMedicalContentIdentificationType', function() {
      // uncomment below and update the code to test TranscribeMedicalContentIdentificationType
      //var instance = new AmazonChime.TranscribeMedicalContentIdentificationType();
      //expect(instance).to.be.a(AmazonChime.TranscribeMedicalContentIdentificationType);
    });
