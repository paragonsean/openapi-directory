...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorTerminationCredentialsRequest();
  });
  ...
  describe('PutVoiceConnectorTerminationCredentialsRequest', function() {
    it('should create an instance of PutVoiceConnectorTerminationCredentialsRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorTerminationCredentialsRequest
      //var instance = new AmazonChime.PutVoiceConnectorTerminationCredentialsRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorTerminationCredentialsRequest);
    });
