...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateChannelBanRequest();
  });
  ...
  describe('CreateChannelBanRequest', function() {
    it('should create an instance of CreateChannelBanRequest', function() {
      // uncomment below and update the code to test CreateChannelBanRequest
      //var instance = new AmazonChime.CreateChannelBanRequest();
      //expect(instance).to.be.a(AmazonChime.CreateChannelBanRequest);
    });
