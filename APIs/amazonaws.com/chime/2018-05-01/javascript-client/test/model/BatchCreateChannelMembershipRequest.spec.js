...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateChannelMembershipRequest();
  });
  ...
  describe('BatchCreateChannelMembershipRequest', function() {
    it('should create an instance of BatchCreateChannelMembershipRequest', function() {
      // uncomment below and update the code to test BatchCreateChannelMembershipRequest
      //var instance = new AmazonChime.BatchCreateChannelMembershipRequest();
      //expect(instance).to.be.a(AmazonChime.BatchCreateChannelMembershipRequest);
    });
