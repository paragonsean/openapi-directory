...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelBanSummary();
  });
  ...
  describe('ChannelBanSummary', function() {
    it('should create an instance of ChannelBanSummary', function() {
      // uncomment below and update the code to test ChannelBanSummary
      //var instance = new AmazonChime.ChannelBanSummary();
      //expect(instance).to.be.a(AmazonChime.ChannelBanSummary);
    });
