...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAccountSettingsResponse();
  });
  ...
  describe('GetAccountSettingsResponse', function() {
    it('should create an instance of GetAccountSettingsResponse', function() {
      // uncomment below and update the code to test GetAccountSettingsResponse
      //var instance = new AmazonChime.GetAccountSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.GetAccountSettingsResponse);
    });

    it('should have the property accountSettings (base name: "AccountSettings")', function() {
      // uncomment below and update the code to test the property accountSettings
      //var instance = new AmazonChime.GetAccountSettingsResponse();
