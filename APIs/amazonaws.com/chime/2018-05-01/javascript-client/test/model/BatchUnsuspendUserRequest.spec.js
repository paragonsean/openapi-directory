...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUnsuspendUserRequest();
  });
  ...
  describe('BatchUnsuspendUserRequest', function() {
    it('should create an instance of BatchUnsuspendUserRequest', function() {
      // uncomment below and update the code to test BatchUnsuspendUserRequest
      //var instance = new AmazonChime.BatchUnsuspendUserRequest();
      //expect(instance).to.be.a(AmazonChime.BatchUnsuspendUserRequest);
    });

    it('should have the property userIdList (base name: "UserIdList")', function() {
      // uncomment below and update the code to test the property userIdList
      //var instance = new AmazonChime.BatchUnsuspendUserRequest();
