...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetProxySessionResponse();
  });
  ...
  describe('GetProxySessionResponse', function() {
    it('should create an instance of GetProxySessionResponse', function() {
      // uncomment below and update the code to test GetProxySessionResponse
      //var instance = new AmazonChime.GetProxySessionResponse();
      //expect(instance).to.be.a(AmazonChime.GetProxySessionResponse);
    });
