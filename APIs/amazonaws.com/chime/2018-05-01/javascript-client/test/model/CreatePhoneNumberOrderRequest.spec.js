...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreatePhoneNumberOrderRequest();
  });
  ...
  describe('CreatePhoneNumberOrderRequest', function() {
    it('should create an instance of CreatePhoneNumberOrderRequest', function() {
      // uncomment below and update the code to test CreatePhoneNumberOrderRequest
      //var instance = new AmazonChime.CreatePhoneNumberOrderRequest();
      //expect(instance).to.be.a(AmazonChime.CreatePhoneNumberOrderRequest);
    });
