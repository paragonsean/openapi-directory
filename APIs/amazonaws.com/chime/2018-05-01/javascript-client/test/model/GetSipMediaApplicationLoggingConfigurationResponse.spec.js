...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetSipMediaApplicationLoggingConfigurationResponse();
  });
  ...
  describe('GetSipMediaApplicationLoggingConfigurationResponse', function() {
    it('should create an instance of GetSipMediaApplicationLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test GetSipMediaApplicationLoggingConfigurationResponse
      //var instance = new AmazonChime.GetSipMediaApplicationLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.GetSipMediaApplicationLoggingConfigurationResponse);
    });

    it('should have the property sipMediaApplicationLoggingConfiguration (base name: "SipMediaApplicationLoggingConfiguration")', function() {
      // uncomment below and update the code to test the property sipMediaApplicationLoggingConfiguration
      //var instance = new AmazonChime.GetSipMediaApplicationLoggingConfigurationResponse();
