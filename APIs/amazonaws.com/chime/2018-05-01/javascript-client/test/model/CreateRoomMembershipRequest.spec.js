...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateRoomMembershipRequest();
  });
  ...
  describe('CreateRoomMembershipRequest', function() {
    it('should create an instance of CreateRoomMembershipRequest', function() {
      // uncomment below and update the code to test CreateRoomMembershipRequest
      //var instance = new AmazonChime.CreateRoomMembershipRequest();
      //expect(instance).to.be.a(AmazonChime.CreateRoomMembershipRequest);
    });
