...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.InviteUsersRequest();
  });
  ...
  describe('InviteUsersRequest', function() {
    it('should create an instance of InviteUsersRequest', function() {
      // uncomment below and update the code to test InviteUsersRequest
      //var instance = new AmazonChime.InviteUsersRequest();
      //expect(instance).to.be.a(AmazonChime.InviteUsersRequest);
    });

    it('should have the property userEmailList (base name: "UserEmailList")', function() {
      // uncomment below and update the code to test the property userEmailList
      //var instance = new AmazonChime.InviteUsersRequest();
