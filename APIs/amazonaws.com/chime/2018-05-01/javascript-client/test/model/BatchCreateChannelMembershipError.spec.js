...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateChannelMembershipError();
  });
  ...
  describe('BatchCreateChannelMembershipError', function() {
    it('should create an instance of BatchCreateChannelMembershipError', function() {
      // uncomment below and update the code to test BatchCreateChannelMembershipError
      //var instance = new AmazonChime.BatchCreateChannelMembershipError();
      //expect(instance).to.be.a(AmazonChime.BatchCreateChannelMembershipError);
    });

    it('should have the property memberArn (base name: "MemberArn")', function() {
      // uncomment below and update the code to test the property memberArn
      //var instance = new AmazonChime.BatchCreateChannelMembershipError();
