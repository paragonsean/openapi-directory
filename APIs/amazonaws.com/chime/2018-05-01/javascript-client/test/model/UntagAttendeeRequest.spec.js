...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UntagAttendeeRequest();
  });
  ...
  describe('UntagAttendeeRequest', function() {
    it('should create an instance of UntagAttendeeRequest', function() {
      // uncomment below and update the code to test UntagAttendeeRequest
      //var instance = new AmazonChime.UntagAttendeeRequest();
      //expect(instance).to.be.a(AmazonChime.UntagAttendeeRequest);
    });
