...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetUserSettingsResponseUserSettings();
  });
  ...
  describe('GetUserSettingsResponseUserSettings', function() {
    it('should create an instance of GetUserSettingsResponseUserSettings', function() {
      // uncomment below and update the code to test GetUserSettingsResponseUserSettings
      //var instance = new AmazonChime.GetUserSettingsResponseUserSettings();
      //expect(instance).to.be.a(AmazonChime.GetUserSettingsResponseUserSettings);
    });
