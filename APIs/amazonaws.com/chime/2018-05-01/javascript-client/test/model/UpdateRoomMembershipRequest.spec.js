...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateRoomMembershipRequest();
  });
  ...
  describe('UpdateRoomMembershipRequest', function() {
    it('should create an instance of UpdateRoomMembershipRequest', function() {
      // uncomment below and update the code to test UpdateRoomMembershipRequest
      //var instance = new AmazonChime.UpdateRoomMembershipRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateRoomMembershipRequest);
    });
