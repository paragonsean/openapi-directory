...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipRuleResponseSipRule();
  });
  ...
  describe('CreateSipRuleResponseSipRule', function() {
    it('should create an instance of CreateSipRuleResponseSipRule', function() {
      // uncomment below and update the code to test CreateSipRuleResponseSipRule
      //var instance = new AmazonChime.CreateSipRuleResponseSipRule();
      //expect(instance).to.be.a(AmazonChime.CreateSipRuleResponseSipRule);
    });
