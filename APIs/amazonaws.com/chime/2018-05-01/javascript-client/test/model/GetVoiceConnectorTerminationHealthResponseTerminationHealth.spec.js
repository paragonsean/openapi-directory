...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorTerminationHealthResponseTerminationHealth();
  });
  ...
  describe('GetVoiceConnectorTerminationHealthResponseTerminationHealth', function() {
    it('should create an instance of GetVoiceConnectorTerminationHealthResponseTerminationHealth', function() {
      // uncomment below and update the code to test GetVoiceConnectorTerminationHealthResponseTerminationHealth
      //var instance = new AmazonChime.GetVoiceConnectorTerminationHealthResponseTerminationHealth();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorTerminationHealthResponseTerminationHealth);
    });
