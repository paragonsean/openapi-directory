...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationResponseSipMediaApplication();
  });
  ...
  describe('CreateSipMediaApplicationResponseSipMediaApplication', function() {
    it('should create an instance of CreateSipMediaApplicationResponseSipMediaApplication', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationResponseSipMediaApplication
      //var instance = new AmazonChime.CreateSipMediaApplicationResponseSipMediaApplication();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationResponseSipMediaApplication);
    });
