...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.OriginationRoute();
  });
  ...
  describe('OriginationRoute', function() {
    it('should create an instance of OriginationRoute', function() {
      // uncomment below and update the code to test OriginationRoute
      //var instance = new AmazonChime.OriginationRoute();
      //expect(instance).to.be.a(AmazonChime.OriginationRoute);
    });
