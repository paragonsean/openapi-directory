...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateChannelMembershipResponse();
  });
  ...
  describe('BatchCreateChannelMembershipResponse', function() {
    it('should create an instance of BatchCreateChannelMembershipResponse', function() {
      // uncomment below and update the code to test BatchCreateChannelMembershipResponse
      //var instance = new AmazonChime.BatchCreateChannelMembershipResponse();
      //expect(instance).to.be.a(AmazonChime.BatchCreateChannelMembershipResponse);
    });

    it('should have the property batchChannelMemberships (base name: "BatchChannelMemberships")', function() {
      // uncomment below and update the code to test the property batchChannelMemberships
      //var instance = new AmazonChime.BatchCreateChannelMembershipResponse();
