...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetPhoneNumberResponsePhoneNumber();
  });
  ...
  describe('GetPhoneNumberResponsePhoneNumber', function() {
    it('should create an instance of GetPhoneNumberResponsePhoneNumber', function() {
      // uncomment below and update the code to test GetPhoneNumberResponsePhoneNumber
      //var instance = new AmazonChime.GetPhoneNumberResponsePhoneNumber();
      //expect(instance).to.be.a(AmazonChime.GetPhoneNumberResponsePhoneNumber);
    });
