...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAttendeeResponseAttendee();
  });
  ...
  describe('GetAttendeeResponseAttendee', function() {
    it('should create an instance of GetAttendeeResponseAttendee', function() {
      // uncomment below and update the code to test GetAttendeeResponseAttendee
      //var instance = new AmazonChime.GetAttendeeResponseAttendee();
      //expect(instance).to.be.a(AmazonChime.GetAttendeeResponseAttendee);
    });
