...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RestorePhoneNumberResponse();
  });
  ...
  describe('RestorePhoneNumberResponse', function() {
    it('should create an instance of RestorePhoneNumberResponse', function() {
      // uncomment below and update the code to test RestorePhoneNumberResponse
      //var instance = new AmazonChime.RestorePhoneNumberResponse();
      //expect(instance).to.be.a(AmazonChime.RestorePhoneNumberResponse);
    });
