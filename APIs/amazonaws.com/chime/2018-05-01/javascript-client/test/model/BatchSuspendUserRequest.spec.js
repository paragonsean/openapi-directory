...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchSuspendUserRequest();
  });
  ...
  describe('BatchSuspendUserRequest', function() {
    it('should create an instance of BatchSuspendUserRequest', function() {
      // uncomment below and update the code to test BatchSuspendUserRequest
      //var instance = new AmazonChime.BatchSuspendUserRequest();
      //expect(instance).to.be.a(AmazonChime.BatchSuspendUserRequest);
    });
