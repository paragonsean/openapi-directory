...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateVoiceConnectorRequest();
  });
  ...
  describe('CreateVoiceConnectorRequest', function() {
    it('should create an instance of CreateVoiceConnectorRequest', function() {
      // uncomment below and update the code to test CreateVoiceConnectorRequest
      //var instance = new AmazonChime.CreateVoiceConnectorRequest();
      //expect(instance).to.be.a(AmazonChime.CreateVoiceConnectorRequest);
    });
