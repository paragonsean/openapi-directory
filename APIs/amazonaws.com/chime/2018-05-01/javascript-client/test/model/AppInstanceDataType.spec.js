...
(function(root, factory) {
  ...
  describe('AppInstanceDataType', function() {
    it('should create an instance of AppInstanceDataType', function() {
      // uncomment below and update the code to test AppInstanceDataType
      //var instance = new AmazonChime.AppInstanceDataType();
      //expect(instance).to.be.a(AmazonChime.AppInstanceDataType);
    });
