...
(function(root, factory) {
  ...
  describe('TranscribeLanguageCode', function() {
    it('should create an instance of TranscribeLanguageCode', function() {
      // uncomment below and update the code to test TranscribeLanguageCode
      //var instance = new AmazonChime.TranscribeLanguageCode();
      //expect(instance).to.be.a(AmazonChime.TranscribeLanguageCode);
    });
