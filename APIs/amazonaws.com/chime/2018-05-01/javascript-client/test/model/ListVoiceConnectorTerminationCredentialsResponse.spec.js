...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListVoiceConnectorTerminationCredentialsResponse();
  });
  ...
  describe('ListVoiceConnectorTerminationCredentialsResponse', function() {
    it('should create an instance of ListVoiceConnectorTerminationCredentialsResponse', function() {
      // uncomment below and update the code to test ListVoiceConnectorTerminationCredentialsResponse
      //var instance = new AmazonChime.ListVoiceConnectorTerminationCredentialsResponse();
      //expect(instance).to.be.a(AmazonChime.ListVoiceConnectorTerminationCredentialsResponse);
    });
