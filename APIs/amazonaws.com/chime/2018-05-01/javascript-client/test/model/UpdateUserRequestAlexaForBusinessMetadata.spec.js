...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserRequestAlexaForBusinessMetadata();
  });
  ...
  describe('UpdateUserRequestAlexaForBusinessMetadata', function() {
    it('should create an instance of UpdateUserRequestAlexaForBusinessMetadata', function() {
      // uncomment below and update the code to test UpdateUserRequestAlexaForBusinessMetadata
      //var instance = new AmazonChime.UpdateUserRequestAlexaForBusinessMetadata();
      //expect(instance).to.be.a(AmazonChime.UpdateUserRequestAlexaForBusinessMetadata);
    });

    it('should have the property isAlexaForBusinessEnabled (base name: "IsAlexaForBusinessEnabled")', function() {
      // uncomment below and update the code to test the property isAlexaForBusinessEnabled
      //var instance = new AmazonChime.UpdateUserRequestAlexaForBusinessMetadata();
      //expect(instance).to.be();
    });

    it('should have the property alexaForBusinessRoomArn (base name: "AlexaForBusinessRoomArn")', function() {
      // uncomment below and update the code to test the property alexaForBusinessRoomArn
      //var instance = new AmazonChime.UpdateUserRequestAlexaForBusinessMetadata();
      //expect(instance).to.be();
    });
