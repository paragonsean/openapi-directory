...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorProxyResponse();
  });
  ...
  describe('PutVoiceConnectorProxyResponse', function() {
    it('should create an instance of PutVoiceConnectorProxyResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorProxyResponse
      //var instance = new AmazonChime.PutVoiceConnectorProxyResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorProxyResponse);
    });
