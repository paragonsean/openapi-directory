...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorOriginationRequest();
  });
  ...
  describe('PutVoiceConnectorOriginationRequest', function() {
    it('should create an instance of PutVoiceConnectorOriginationRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorOriginationRequest
      //var instance = new AmazonChime.PutVoiceConnectorOriginationRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorOriginationRequest);
    });
