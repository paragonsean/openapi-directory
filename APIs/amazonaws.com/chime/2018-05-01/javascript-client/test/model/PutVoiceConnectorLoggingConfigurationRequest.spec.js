...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationRequest();
  });
  ...
  describe('PutVoiceConnectorLoggingConfigurationRequest', function() {
    it('should create an instance of PutVoiceConnectorLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorLoggingConfigurationRequest
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorLoggingConfigurationRequest);
    });
