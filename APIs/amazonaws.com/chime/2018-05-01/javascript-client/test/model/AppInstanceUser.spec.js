...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceUser();
  });
  ...
  describe('AppInstanceUser', function() {
    it('should create an instance of AppInstanceUser', function() {
      // uncomment below and update the code to test AppInstanceUser
      //var instance = new AmazonChime.AppInstanceUser();
      //expect(instance).to.be.a(AmazonChime.AppInstanceUser);
    });
