...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponse();
  });
  ...
  describe('PutVoiceConnectorLoggingConfigurationResponse', function() {
    it('should create an instance of PutVoiceConnectorLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorLoggingConfigurationResponse
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorLoggingConfigurationResponse);
    });
