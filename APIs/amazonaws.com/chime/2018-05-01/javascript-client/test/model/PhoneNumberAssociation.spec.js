...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PhoneNumberAssociation();
  });
  ...
  describe('PhoneNumberAssociation', function() {
    it('should create an instance of PhoneNumberAssociation', function() {
      // uncomment below and update the code to test PhoneNumberAssociation
      //var instance = new AmazonChime.PhoneNumberAssociation();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberAssociation);
    });
    ...
    it('should have the property associatedTimestamp (base name: "AssociatedTimestamp")', function() {
      // uncomment below and update the code to test the property associatedTimestamp
      //var instance = new AmazonChime.PhoneNumberAssociation();
      //expect(instance).to.be();
    });
