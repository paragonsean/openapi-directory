...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.TagMeetingRequest();
  });
  ...
  describe('TagMeetingRequest', function() {
    it('should create an instance of TagMeetingRequest', function() {
      // uncomment below and update the code to test TagMeetingRequest
      //var instance = new AmazonChime.TagMeetingRequest();
      //expect(instance).to.be.a(AmazonChime.TagMeetingRequest);
    });
