...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ResetPersonalPINResponseUser();
  });
  ...
  describe('ResetPersonalPINResponseUser', function() {
    it('should create an instance of ResetPersonalPINResponseUser', function() {
      // uncomment below and update the code to test ResetPersonalPINResponseUser
      //var instance = new AmazonChime.ResetPersonalPINResponseUser();
      //expect(instance).to.be.a(AmazonChime.ResetPersonalPINResponseUser);
    });
