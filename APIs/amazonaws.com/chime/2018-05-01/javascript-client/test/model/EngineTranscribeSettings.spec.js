...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.EngineTranscribeSettings();
  });
  ...
  describe('EngineTranscribeSettings', function() {
    it('should create an instance of EngineTranscribeSettings', function() {
      // uncomment below and update the code to test EngineTranscribeSettings
      //var instance = new AmazonChime.EngineTranscribeSettings();
      //expect(instance).to.be.a(AmazonChime.EngineTranscribeSettings);
    });
