...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetEventsConfigurationResponse();
  });
  ...
  describe('GetEventsConfigurationResponse', function() {
    it('should create an instance of GetEventsConfigurationResponse', function() {
      // uncomment below and update the code to test GetEventsConfigurationResponse
      //var instance = new AmazonChime.GetEventsConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.GetEventsConfigurationResponse);
    });

    it('should have the property eventsConfiguration (base name: "EventsConfiguration")', function() {
      // uncomment below and update the code to test the property eventsConfiguration
      //var instance = new AmazonChime.GetEventsConfigurationResponse();
