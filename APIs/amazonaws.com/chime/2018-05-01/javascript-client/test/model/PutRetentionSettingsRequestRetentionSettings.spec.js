...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettings();
  });
  ...
  describe('PutRetentionSettingsRequestRetentionSettings', function() {
    it('should create an instance of PutRetentionSettingsRequestRetentionSettings', function() {
      // uncomment below and update the code to test PutRetentionSettingsRequestRetentionSettings
      //var instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.PutRetentionSettingsRequestRetentionSettings);
    });
