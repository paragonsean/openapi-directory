...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.EmergencyCallingConfiguration();
  });
  ...
  describe('EmergencyCallingConfiguration', function() {
    it('should create an instance of EmergencyCallingConfiguration', function() {
      // uncomment below and update the code to test EmergencyCallingConfiguration
      //var instance = new AmazonChime.EmergencyCallingConfiguration();
      //expect(instance).to.be.a(AmazonChime.EmergencyCallingConfiguration);
    });
