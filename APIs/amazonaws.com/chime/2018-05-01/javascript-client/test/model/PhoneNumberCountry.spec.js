...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PhoneNumberCountry();
  });
  ...
  describe('PhoneNumberCountry', function() {
    it('should create an instance of PhoneNumberCountry', function() {
      // uncomment below and update the code to test PhoneNumberCountry
      //var instance = new AmazonChime.PhoneNumberCountry();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberCountry);
    });
    ...
    it('should have the property supportedPhoneNumberTypes (base name: "SupportedPhoneNumberTypes")', function() {
      // uncomment below and update the code to test the property supportedPhoneNumberTypes
      //var instance = new AmazonChime.PhoneNumberCountry();
      //expect(instance).to.be();
    });
