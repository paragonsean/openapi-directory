...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationRequest();
  });
  ...
  describe('CreateSipMediaApplicationRequest', function() {
    it('should create an instance of CreateSipMediaApplicationRequest', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationRequest
      //var instance = new AmazonChime.CreateSipMediaApplicationRequest();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationRequest);
    });
