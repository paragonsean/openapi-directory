...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAttendeeRequestItem();
  });
  ...
  describe('CreateAttendeeRequestItem', function() {
    it('should create an instance of CreateAttendeeRequestItem', function() {
      // uncomment below and update the code to test CreateAttendeeRequestItem
      //var instance = new AmazonChime.CreateAttendeeRequestItem();
      //expect(instance).to.be.a(AmazonChime.CreateAttendeeRequestItem);
    });
