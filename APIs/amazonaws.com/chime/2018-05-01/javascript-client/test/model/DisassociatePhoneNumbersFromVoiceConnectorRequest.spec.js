...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorRequest();
  });
  ...
  describe('DisassociatePhoneNumbersFromVoiceConnectorRequest', function() {
    it('should create an instance of DisassociatePhoneNumbersFromVoiceConnectorRequest', function() {
      // uncomment below and update the code to test DisassociatePhoneNumbersFromVoiceConnectorRequest
      //var instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorRequest();
      //expect(instance).to.be.a(AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorRequest);
    });
