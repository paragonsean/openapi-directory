...
(function(root, factory) {
  ...
  describe('TranscribeMedicalRegion', function() {
    it('should create an instance of TranscribeMedicalRegion', function() {
      // uncomment below and update the code to test TranscribeMedicalRegion
      //var instance = new AmazonChime.TranscribeMedicalRegion();
      //expect(instance).to.be.a(AmazonChime.TranscribeMedicalRegion);
    });
