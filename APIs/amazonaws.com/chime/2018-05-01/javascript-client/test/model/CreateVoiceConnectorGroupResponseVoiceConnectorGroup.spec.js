...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateVoiceConnectorGroupResponseVoiceConnectorGroup();
  });
  ...
  describe('CreateVoiceConnectorGroupResponseVoiceConnectorGroup', function() {
    it('should create an instance of CreateVoiceConnectorGroupResponseVoiceConnectorGroup', function() {
      // uncomment below and update the code to test CreateVoiceConnectorGroupResponseVoiceConnectorGroup
      //var instance = new AmazonChime.CreateVoiceConnectorGroupResponseVoiceConnectorGroup();
      //expect(instance).to.be.a(AmazonChime.CreateVoiceConnectorGroupResponseVoiceConnectorGroup);
    });
