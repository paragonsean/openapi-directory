...
(function(root, factory) {
  ...
  describe('ProxySessionStatus', function() {
    it('should create an instance of ProxySessionStatus', function() {
      // uncomment below and update the code to test ProxySessionStatus
      //var instance = new AmazonChime.ProxySessionStatus();
      //expect(instance).to.be.a(AmazonChime.ProxySessionStatus);
    });
