...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationCallResponse();
  });
  ...
  describe('CreateSipMediaApplicationCallResponse', function() {
    it('should create an instance of CreateSipMediaApplicationCallResponse', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationCallResponse
      //var instance = new AmazonChime.CreateSipMediaApplicationCallResponse();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationCallResponse);
    });

    it('should have the property sipMediaApplicationCall (base name: "SipMediaApplicationCall")', function() {
      // uncomment below and update the code to test the property sipMediaApplicationCall
      //var instance = new AmazonChime.CreateSipMediaApplicationCallResponse();
