...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration();
  });
  ...
  describe('PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration', function() {
    it('should create an instance of PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration', function() {
      // uncomment below and update the code to test PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorLoggingConfigurationRequestLoggingConfiguration);
    });
