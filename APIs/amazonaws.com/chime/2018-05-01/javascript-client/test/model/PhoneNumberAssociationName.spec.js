...
(function(root, factory) {
  ...
  describe('PhoneNumberAssociationName', function() {
    it('should create an instance of PhoneNumberAssociationName', function() {
      // uncomment below and update the code to test PhoneNumberAssociationName
      //var instance = new AmazonChime.PhoneNumberAssociationName();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberAssociationName);
    });
