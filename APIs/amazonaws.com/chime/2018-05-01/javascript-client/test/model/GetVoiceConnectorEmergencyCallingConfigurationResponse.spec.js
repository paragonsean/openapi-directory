...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponse();
  });
  ...
  describe('GetVoiceConnectorEmergencyCallingConfigurationResponse', function() {
    it('should create an instance of GetVoiceConnectorEmergencyCallingConfigurationResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorEmergencyCallingConfigurationResponse
      //var instance = new AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponse);
    });
