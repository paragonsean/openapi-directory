...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeAppInstanceUserResponseAppInstanceUser();
  });
  ...
  describe('DescribeAppInstanceUserResponseAppInstanceUser', function() {
    it('should create an instance of DescribeAppInstanceUserResponseAppInstanceUser', function() {
      // uncomment below and update the code to test DescribeAppInstanceUserResponseAppInstanceUser
      //var instance = new AmazonChime.DescribeAppInstanceUserResponseAppInstanceUser();
      //expect(instance).to.be.a(AmazonChime.DescribeAppInstanceUserResponseAppInstanceUser);
    });
