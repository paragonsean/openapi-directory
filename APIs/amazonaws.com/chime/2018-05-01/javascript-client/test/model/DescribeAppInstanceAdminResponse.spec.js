...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeAppInstanceAdminResponse();
  });
  ...
  describe('DescribeAppInstanceAdminResponse', function() {
    it('should create an instance of DescribeAppInstanceAdminResponse', function() {
      // uncomment below and update the code to test DescribeAppInstanceAdminResponse
      //var instance = new AmazonChime.DescribeAppInstanceAdminResponse();
      //expect(instance).to.be.a(AmazonChime.DescribeAppInstanceAdminResponse);
    });

    it('should have the property appInstanceAdmin (base name: "AppInstanceAdmin")', function() {
      // uncomment below and update the code to test the property appInstanceAdmin
      //var instance = new AmazonChime.DescribeAppInstanceAdminResponse();
