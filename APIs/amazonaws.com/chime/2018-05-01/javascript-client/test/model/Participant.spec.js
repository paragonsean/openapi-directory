...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.Participant();
  });
  ...
  describe('Participant', function() {
    it('should create an instance of Participant', function() {
      ...
      //var instance = new AmazonChime.Participant();
      //expect(instance).to.be.a(AmazonChime.Participant);
    });
    ...
    it('should have the property proxyPhoneNumber (base name: "ProxyPhoneNumber")', function() {
      // uncomment below and update the code to test the property proxyPhoneNumber
      //var instance = new AmazonChime.Participant();
      //expect(instance).to.be();
    });
