...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipRuleResponse();
  });
  ...
  describe('UpdateSipRuleResponse', function() {
    it('should create an instance of UpdateSipRuleResponse', function() {
      // uncomment below and update the code to test UpdateSipRuleResponse
      //var instance = new AmazonChime.UpdateSipRuleResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateSipRuleResponse);
    });

    it('should have the property sipRule (base name: "SipRule")', function() {
      // uncomment below and update the code to test the property sipRule
      //var instance = new AmazonChime.UpdateSipRuleResponse();
