...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequest();
  });
  ...
  describe('PutVoiceConnectorEmergencyCallingConfigurationRequest', function() {
    it('should create an instance of PutVoiceConnectorEmergencyCallingConfigurationRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorEmergencyCallingConfigurationRequest
      //var instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequest);
    });
