...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelBanMember();
  });
  ...
  describe('ChannelBanMember', function() {
    it('should create an instance of ChannelBanMember', function() {
      // uncomment below and update the code to test ChannelBanMember
      //var instance = new AmazonChime.ChannelBanMember();
      //expect(instance).to.be.a(AmazonChime.ChannelBanMember);
    });
