...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAttendeeResponseAttendee();
  });
  ...
  describe('CreateAttendeeResponseAttendee', function() {
    it('should create an instance of CreateAttendeeResponseAttendee', function() {
      // uncomment below and update the code to test CreateAttendeeResponseAttendee
      //var instance = new AmazonChime.CreateAttendeeResponseAttendee();
      //expect(instance).to.be.a(AmazonChime.CreateAttendeeResponseAttendee);
    });
    ...
    it('should have the property attendeeId (base name: "AttendeeId")', function() {
      // uncomment below and update the code to test the property attendeeId
      //var instance = new AmazonChime.CreateAttendeeResponseAttendee();
      //expect(instance).to.be();
    });
