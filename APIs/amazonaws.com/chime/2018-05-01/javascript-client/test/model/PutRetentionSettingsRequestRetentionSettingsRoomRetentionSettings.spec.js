...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings();
  });
  ...
  describe('PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings', function() {
    it('should create an instance of PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings', function() {
      // uncomment below and update the code to test PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings
      //var instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.PutRetentionSettingsRequestRetentionSettingsRoomRetentionSettings);
    });
