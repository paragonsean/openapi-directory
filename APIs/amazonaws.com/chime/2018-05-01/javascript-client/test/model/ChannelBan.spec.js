...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelBan();
  });
  ...
  describe('ChannelBan', function() {
    it('should create an instance of ChannelBan', function() {
      // uncomment below and update the code to test ChannelBan
      //var instance = new AmazonChime.ChannelBan();
      //expect(instance).to.be.a(AmazonChime.ChannelBan);
    });
