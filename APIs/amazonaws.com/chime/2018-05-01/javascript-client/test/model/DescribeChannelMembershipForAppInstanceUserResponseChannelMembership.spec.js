...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelMembershipForAppInstanceUserResponseChannelMembership();
  });
  ...
  describe('DescribeChannelMembershipForAppInstanceUserResponseChannelMembership', function() {
    it('should create an instance of DescribeChannelMembershipForAppInstanceUserResponseChannelMembership', function() {
      ...
      //var instance = new AmazonChime.DescribeChannelMembershipForAppInstanceUserResponseChannelMembership();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelMembershipForAppInstanceUserResponseChannelMembership);
    });
