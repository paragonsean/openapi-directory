...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateChannelBanResponseMember();
  });
  ...
  describe('CreateChannelBanResponseMember', function() {
    it('should create an instance of CreateChannelBanResponseMember', function() {
      // uncomment below and update the code to test CreateChannelBanResponseMember
      //var instance = new AmazonChime.CreateChannelBanResponseMember();
      //expect(instance).to.be.a(AmazonChime.CreateChannelBanResponseMember);
    });
