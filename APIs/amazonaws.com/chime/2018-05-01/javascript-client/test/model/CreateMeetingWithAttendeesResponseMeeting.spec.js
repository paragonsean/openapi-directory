...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingWithAttendeesResponseMeeting();
  });
  ...
  describe('CreateMeetingWithAttendeesResponseMeeting', function() {
    it('should create an instance of CreateMeetingWithAttendeesResponseMeeting', function() {
      // uncomment below and update the code to test CreateMeetingWithAttendeesResponseMeeting
      //var instance = new AmazonChime.CreateMeetingWithAttendeesResponseMeeting();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingWithAttendeesResponseMeeting);
    });
    ...
    it('should have the property mediaPlacement (base name: "MediaPlacement")', function() {
      // uncomment below and update the code to test the property mediaPlacement
      //var instance = new AmazonChime.CreateMeetingWithAttendeesResponseMeeting();
      //expect(instance).to.be();
    });
