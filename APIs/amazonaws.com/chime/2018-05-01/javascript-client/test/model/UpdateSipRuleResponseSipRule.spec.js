...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipRuleResponseSipRule();
  });
  ...
  describe('UpdateSipRuleResponseSipRule', function() {
    it('should create an instance of UpdateSipRuleResponseSipRule', function() {
      // uncomment below and update the code to test UpdateSipRuleResponseSipRule
      //var instance = new AmazonChime.UpdateSipRuleResponseSipRule();
      //expect(instance).to.be.a(AmazonChime.UpdateSipRuleResponseSipRule);
    });
