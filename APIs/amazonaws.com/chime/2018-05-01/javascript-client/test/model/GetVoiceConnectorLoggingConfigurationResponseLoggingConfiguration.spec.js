...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
  });
  ...
  describe('GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration', function() {
    it('should create an instance of GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration', function() {
      // uncomment below and update the code to test GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration
      //var instance = new AmazonChime.GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorLoggingConfigurationResponseLoggingConfiguration);
    });
