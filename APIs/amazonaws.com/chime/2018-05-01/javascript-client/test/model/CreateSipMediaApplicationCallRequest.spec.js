...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationCallRequest();
  });
  ...
  describe('CreateSipMediaApplicationCallRequest', function() {
    it('should create an instance of CreateSipMediaApplicationCallRequest', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationCallRequest
      //var instance = new AmazonChime.CreateSipMediaApplicationCallRequest();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationCallRequest);
    });
    ...
    it('should have the property sipHeaders (base name: "SipHeaders")', function() {
      // uncomment below and update the code to test the property sipHeaders
      //var instance = new AmazonChime.CreateSipMediaApplicationCallRequest();
      //expect(instance).to.be();
    });
