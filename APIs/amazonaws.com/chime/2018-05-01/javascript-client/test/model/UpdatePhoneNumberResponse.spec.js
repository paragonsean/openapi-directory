...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdatePhoneNumberResponse();
  });
  ...
  describe('UpdatePhoneNumberResponse', function() {
    it('should create an instance of UpdatePhoneNumberResponse', function() {
      // uncomment below and update the code to test UpdatePhoneNumberResponse
      //var instance = new AmazonChime.UpdatePhoneNumberResponse();
      //expect(instance).to.be.a(AmazonChime.UpdatePhoneNumberResponse);
    });
