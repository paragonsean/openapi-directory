...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateVoiceConnectorGroupRequest();
  });
  ...
  describe('UpdateVoiceConnectorGroupRequest', function() {
    it('should create an instance of UpdateVoiceConnectorGroupRequest', function() {
      // uncomment below and update the code to test UpdateVoiceConnectorGroupRequest
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateVoiceConnectorGroupRequest);
    });
    ...
    it('should have the property voiceConnectorItems (base name: "VoiceConnectorItems")', function() {
      // uncomment below and update the code to test the property voiceConnectorItems
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupRequest();
      //expect(instance).to.be();
    });
