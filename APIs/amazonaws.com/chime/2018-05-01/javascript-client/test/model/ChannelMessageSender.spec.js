...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMessageSender();
  });
  ...
  describe('ChannelMessageSender', function() {
    it('should create an instance of ChannelMessageSender', function() {
      // uncomment below and update the code to test ChannelMessageSender
      //var instance = new AmazonChime.ChannelMessageSender();
      //expect(instance).to.be.a(AmazonChime.ChannelMessageSender);
    });
