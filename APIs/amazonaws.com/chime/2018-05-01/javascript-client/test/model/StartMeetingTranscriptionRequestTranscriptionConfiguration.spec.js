...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfiguration();
  });
  ...
  describe('StartMeetingTranscriptionRequestTranscriptionConfiguration', function() {
    it('should create an instance of StartMeetingTranscriptionRequestTranscriptionConfiguration', function() {
      // uncomment below and update the code to test StartMeetingTranscriptionRequestTranscriptionConfiguration
      //var instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfiguration();
      //expect(instance).to.be.a(AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfiguration);
    });
