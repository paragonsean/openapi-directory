...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListSipRulesResponse();
  });
  ...
  describe('ListSipRulesResponse', function() {
    it('should create an instance of ListSipRulesResponse', function() {
      // uncomment below and update the code to test ListSipRulesResponse
      //var instance = new AmazonChime.ListSipRulesResponse();
      //expect(instance).to.be.a(AmazonChime.ListSipRulesResponse);
    });

    it('should have the property sipRules (base name: "SipRules")', function() {
      // uncomment below and update the code to test the property sipRules
      //var instance = new AmazonChime.ListSipRulesResponse();
