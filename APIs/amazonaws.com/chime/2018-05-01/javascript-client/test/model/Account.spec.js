...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new AmazonChime.Account();
      //expect(instance).to.be.a(AmazonChime.Account);
    });
    ...
    it('should have the property defaultLicense (base name: "DefaultLicense")', function() {
      // uncomment below and update the code to test the property defaultLicense
      //var instance = new AmazonChime.Account();
      //expect(instance).to.be();
    });

    it('should have the property supportedLicenses (base name: "SupportedLicenses")', function() {
      // uncomment below and update the code to test the property supportedLicenses
      //var instance = new AmazonChime.Account();
      //expect(instance).to.be();
    });
    ...
    it('should have the property signinDelegateGroups (base name: "SigninDelegateGroups")', function() {
      // uncomment below and update the code to test the property signinDelegateGroups
      //var instance = new AmazonChime.Account();
      //expect(instance).to.be();
    });
