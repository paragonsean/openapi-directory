...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetPhoneNumberSettingsResponse();
  });
  ...
  describe('GetPhoneNumberSettingsResponse', function() {
    it('should create an instance of GetPhoneNumberSettingsResponse', function() {
      // uncomment below and update the code to test GetPhoneNumberSettingsResponse
      //var instance = new AmazonChime.GetPhoneNumberSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.GetPhoneNumberSettingsResponse);
    });
    ...
    it('should have the property callingNameUpdatedTimestamp (base name: "CallingNameUpdatedTimestamp")', function() {
      // uncomment below and update the code to test the property callingNameUpdatedTimestamp
      //var instance = new AmazonChime.GetPhoneNumberSettingsResponse();
      //expect(instance).to.be();
    });
