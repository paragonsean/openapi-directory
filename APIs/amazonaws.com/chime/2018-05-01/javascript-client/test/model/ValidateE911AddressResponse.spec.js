...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ValidateE911AddressResponse();
  });
  ...
  describe('ValidateE911AddressResponse', function() {
    it('should create an instance of ValidateE911AddressResponse', function() {
      // uncomment below and update the code to test ValidateE911AddressResponse
      //var instance = new AmazonChime.ValidateE911AddressResponse();
      //expect(instance).to.be.a(AmazonChime.ValidateE911AddressResponse);
    });
    ...
    it('should have the property addressExternalId (base name: "AddressExternalId")', function() {
      // uncomment below and update the code to test the property addressExternalId
      //var instance = new AmazonChime.ValidateE911AddressResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property candidateAddressList (base name: "CandidateAddressList")', function() {
      // uncomment below and update the code to test the property candidateAddressList
      //var instance = new AmazonChime.ValidateE911AddressResponse();
      //expect(instance).to.be();
    });
