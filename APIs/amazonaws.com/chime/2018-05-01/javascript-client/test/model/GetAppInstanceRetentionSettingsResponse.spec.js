...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAppInstanceRetentionSettingsResponse();
  });
  ...
  describe('GetAppInstanceRetentionSettingsResponse', function() {
    it('should create an instance of GetAppInstanceRetentionSettingsResponse', function() {
      // uncomment below and update the code to test GetAppInstanceRetentionSettingsResponse
      //var instance = new AmazonChime.GetAppInstanceRetentionSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.GetAppInstanceRetentionSettingsResponse);
    });
