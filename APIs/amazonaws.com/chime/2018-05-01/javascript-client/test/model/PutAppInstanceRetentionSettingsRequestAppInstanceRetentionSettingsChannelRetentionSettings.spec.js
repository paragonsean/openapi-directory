...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutAppInstanceRetentionSettingsRequestAppInstanceRetentionSettingsChannelRetentionSettings();
  });
  ...
  describe('PutAppInstanceRetentionSettingsRequestAppInstanceRetentionSettingsChannelRetentionSettings', function() {
    it('should create an instance of PutAppInstanceRetentionSettingsRequestAppInstanceRetentionSettingsChannelRetentionSettings', function() {
      ...
      //var instance = new AmazonChime.PutAppInstanceRetentionSettingsRequestAppInstanceRetentionSettingsChannelRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.PutAppInstanceRetentionSettingsRequestAppInstanceRetentionSettingsChannelRetentionSettings);
    });
