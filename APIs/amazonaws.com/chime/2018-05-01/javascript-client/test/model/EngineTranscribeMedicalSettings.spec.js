...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.EngineTranscribeMedicalSettings();
  });
  ...
  describe('EngineTranscribeMedicalSettings', function() {
    it('should create an instance of EngineTranscribeMedicalSettings', function() {
      // uncomment below and update the code to test EngineTranscribeMedicalSettings
      //var instance = new AmazonChime.EngineTranscribeMedicalSettings();
      //expect(instance).to.be.a(AmazonChime.EngineTranscribeMedicalSettings);
    });
