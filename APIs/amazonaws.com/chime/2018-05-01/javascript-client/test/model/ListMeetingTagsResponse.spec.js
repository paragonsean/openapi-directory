...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListMeetingTagsResponse();
  });
  ...
  describe('ListMeetingTagsResponse', function() {
    it('should create an instance of ListMeetingTagsResponse', function() {
      // uncomment below and update the code to test ListMeetingTagsResponse
      //var instance = new AmazonChime.ListMeetingTagsResponse();
      //expect(instance).to.be.a(AmazonChime.ListMeetingTagsResponse);
    });
