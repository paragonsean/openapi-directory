...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationCallResponse();
  });
  ...
  describe('UpdateSipMediaApplicationCallResponse', function() {
    it('should create an instance of UpdateSipMediaApplicationCallResponse', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationCallResponse
      //var instance = new AmazonChime.UpdateSipMediaApplicationCallResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationCallResponse);
    });
