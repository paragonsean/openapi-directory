...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateBotResponseBot();
  });
  ...
  describe('CreateBotResponseBot', function() {
    it('should create an instance of CreateBotResponseBot', function() {
      ...
      //var instance = new AmazonChime.CreateBotResponseBot();
      //expect(instance).to.be.a(AmazonChime.CreateBotResponseBot);
    });
