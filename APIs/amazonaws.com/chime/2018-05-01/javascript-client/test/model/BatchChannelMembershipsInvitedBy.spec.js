...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchChannelMembershipsInvitedBy();
  });
  ...
  describe('BatchChannelMembershipsInvitedBy', function() {
    it('should create an instance of BatchChannelMembershipsInvitedBy', function() {
      // uncomment below and update the code to test BatchChannelMembershipsInvitedBy
      //var instance = new AmazonChime.BatchChannelMembershipsInvitedBy();
      //expect(instance).to.be.a(AmazonChime.BatchChannelMembershipsInvitedBy);
    });
