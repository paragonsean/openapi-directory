...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingDialOutRequest();
  });
  ...
  describe('CreateMeetingDialOutRequest', function() {
    it('should create an instance of CreateMeetingDialOutRequest', function() {
      // uncomment below and update the code to test CreateMeetingDialOutRequest
      //var instance = new AmazonChime.CreateMeetingDialOutRequest();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingDialOutRequest);
    });
    ...
    it('should have the property joinToken (base name: "JoinToken")', function() {
      // uncomment below and update the code to test the property joinToken
      //var instance = new AmazonChime.CreateMeetingDialOutRequest();
      //expect(instance).to.be();
    });
