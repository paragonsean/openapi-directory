...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAppInstanceAdminRequest();
  });
  ...
  describe('CreateAppInstanceAdminRequest', function() {
    it('should create an instance of CreateAppInstanceAdminRequest', function() {
      // uncomment below and update the code to test CreateAppInstanceAdminRequest
      //var instance = new AmazonChime.CreateAppInstanceAdminRequest();
      //expect(instance).to.be.a(AmazonChime.CreateAppInstanceAdminRequest);
    });

    it('should have the property appInstanceAdminArn (base name: "AppInstanceAdminArn")', function() {
      // uncomment below and update the code to test the property appInstanceAdminArn
      //var instance = new AmazonChime.CreateAppInstanceAdminRequest();
