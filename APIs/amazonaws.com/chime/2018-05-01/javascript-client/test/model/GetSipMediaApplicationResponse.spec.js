...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetSipMediaApplicationResponse();
  });
  ...
  describe('GetSipMediaApplicationResponse', function() {
    it('should create an instance of GetSipMediaApplicationResponse', function() {
      // uncomment below and update the code to test GetSipMediaApplicationResponse
      //var instance = new AmazonChime.GetSipMediaApplicationResponse();
      //expect(instance).to.be.a(AmazonChime.GetSipMediaApplicationResponse);
    });

    it('should have the property sipMediaApplication (base name: "SipMediaApplication")', function() {
      // uncomment below and update the code to test the property sipMediaApplication
      //var instance = new AmazonChime.GetSipMediaApplicationResponse();
