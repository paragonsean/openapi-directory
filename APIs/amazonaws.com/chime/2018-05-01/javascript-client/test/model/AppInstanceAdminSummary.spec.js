...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceAdminSummary();
  });
  ...
  describe('AppInstanceAdminSummary', function() {
    it('should create an instance of AppInstanceAdminSummary', function() {
      // uncomment below and update the code to test AppInstanceAdminSummary
      //var instance = new AmazonChime.AppInstanceAdminSummary();
      //expect(instance).to.be.a(AmazonChime.AppInstanceAdminSummary);
    });
