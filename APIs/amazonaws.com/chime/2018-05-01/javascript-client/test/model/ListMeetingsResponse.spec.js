...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListMeetingsResponse();
  });
  ...
  describe('ListMeetingsResponse', function() {
    it('should create an instance of ListMeetingsResponse', function() {
      // uncomment below and update the code to test ListMeetingsResponse
      //var instance = new AmazonChime.ListMeetingsResponse();
      //expect(instance).to.be.a(AmazonChime.ListMeetingsResponse);
    });
