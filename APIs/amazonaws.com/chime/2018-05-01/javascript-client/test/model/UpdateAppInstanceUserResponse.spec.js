...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateAppInstanceUserResponse();
  });
  ...
  describe('UpdateAppInstanceUserResponse', function() {
    it('should create an instance of UpdateAppInstanceUserResponse', function() {
      // uncomment below and update the code to test UpdateAppInstanceUserResponse
      //var instance = new AmazonChime.UpdateAppInstanceUserResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateAppInstanceUserResponse);
    });
