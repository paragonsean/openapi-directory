...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.MediaPlacement();
  });
  ...
  describe('MediaPlacement', function() {
    it('should create an instance of MediaPlacement', function() {
      // uncomment below and update the code to test MediaPlacement
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be.a(AmazonChime.MediaPlacement);
    });

    it('should have the property audioHostUrl (base name: "AudioHostUrl")', function() {
      // uncomment below and update the code to test the property audioHostUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property audioFallbackUrl (base name: "AudioFallbackUrl")', function() {
      // uncomment below and update the code to test the property audioFallbackUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property screenDataUrl (base name: "ScreenDataUrl")', function() {
      // uncomment below and update the code to test the property screenDataUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property screenSharingUrl (base name: "ScreenSharingUrl")', function() {
      // uncomment below and update the code to test the property screenSharingUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property screenViewingUrl (base name: "ScreenViewingUrl")', function() {
      // uncomment below and update the code to test the property screenViewingUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property signalingUrl (base name: "SignalingUrl")', function() {
      // uncomment below and update the code to test the property signalingUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property turnControlUrl (base name: "TurnControlUrl")', function() {
      // uncomment below and update the code to test the property turnControlUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });

    it('should have the property eventIngestionUrl (base name: "EventIngestionUrl")', function() {
      // uncomment below and update the code to test the property eventIngestionUrl
      //var instance = new AmazonChime.MediaPlacement();
      //expect(instance).to.be();
    });
