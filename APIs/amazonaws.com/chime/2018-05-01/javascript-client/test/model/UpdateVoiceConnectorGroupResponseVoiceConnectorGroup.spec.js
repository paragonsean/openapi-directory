...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateVoiceConnectorGroupResponseVoiceConnectorGroup();
  });
  ...
  describe('UpdateVoiceConnectorGroupResponseVoiceConnectorGroup', function() {
    it('should create an instance of UpdateVoiceConnectorGroupResponseVoiceConnectorGroup', function() {
      // uncomment below and update the code to test UpdateVoiceConnectorGroupResponseVoiceConnectorGroup
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupResponseVoiceConnectorGroup();
      //expect(instance).to.be.a(AmazonChime.UpdateVoiceConnectorGroupResponseVoiceConnectorGroup);
    });

    it('should have the property voiceConnectorGroupId (base name: "VoiceConnectorGroupId")', function() {
      // uncomment below and update the code to test the property voiceConnectorGroupId
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupResponseVoiceConnectorGroup();
    ...
    it('should have the property voiceConnectorGroupArn (base name: "VoiceConnectorGroupArn")', function() {
      // uncomment below and update the code to test the property voiceConnectorGroupArn
      //var instance = new AmazonChime.UpdateVoiceConnectorGroupResponseVoiceConnectorGroup();
      //expect(instance).to.be();
    });
