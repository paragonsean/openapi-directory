...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAccountSettingsResponseAccountSettings();
  });
  ...
  describe('GetAccountSettingsResponseAccountSettings', function() {
    it('should create an instance of GetAccountSettingsResponseAccountSettings', function() {
      // uncomment below and update the code to test GetAccountSettingsResponseAccountSettings
      //var instance = new AmazonChime.GetAccountSettingsResponseAccountSettings();
      //expect(instance).to.be.a(AmazonChime.GetAccountSettingsResponseAccountSettings);
    });
