...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateChannelReadMarkerResponse();
  });
  ...
  describe('UpdateChannelReadMarkerResponse', function() {
    it('should create an instance of UpdateChannelReadMarkerResponse', function() {
      // uncomment below and update the code to test UpdateChannelReadMarkerResponse
      //var instance = new AmazonChime.UpdateChannelReadMarkerResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateChannelReadMarkerResponse);
    });
