...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AlexaForBusinessMetadata();
  });
  ...
  describe('AlexaForBusinessMetadata', function() {
    it('should create an instance of AlexaForBusinessMetadata', function() {
      // uncomment below and update the code to test AlexaForBusinessMetadata
      //var instance = new AmazonChime.AlexaForBusinessMetadata();
      //expect(instance).to.be.a(AmazonChime.AlexaForBusinessMetadata);
    });
