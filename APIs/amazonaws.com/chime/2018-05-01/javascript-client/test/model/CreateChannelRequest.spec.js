...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateChannelRequest();
  });
  ...
  describe('CreateChannelRequest', function() {
    it('should create an instance of CreateChannelRequest', function() {
      ...
      //var instance = new AmazonChime.CreateChannelRequest();
      //expect(instance).to.be.a(AmazonChime.CreateChannelRequest);
    });
