...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAccountResponseAccount();
  });
  ...
  describe('CreateAccountResponseAccount', function() {
    it('should create an instance of CreateAccountResponseAccount', function() {
      // uncomment below and update the code to test CreateAccountResponseAccount
      //var instance = new AmazonChime.CreateAccountResponseAccount();
      //expect(instance).to.be.a(AmazonChime.CreateAccountResponseAccount);
    });
