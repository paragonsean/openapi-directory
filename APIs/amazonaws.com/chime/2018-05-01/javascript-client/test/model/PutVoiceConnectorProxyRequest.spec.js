...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorProxyRequest();
  });
  ...
  describe('PutVoiceConnectorProxyRequest', function() {
    it('should create an instance of PutVoiceConnectorProxyRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorProxyRequest
      //var instance = new AmazonChime.PutVoiceConnectorProxyRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorProxyRequest);
    });

    it('should have the property defaultSessionExpiryMinutes (base name: "DefaultSessionExpiryMinutes")', function() {
      // uncomment below and update the code to test the property defaultSessionExpiryMinutes
      //var instance = new AmazonChime.PutVoiceConnectorProxyRequest();
      //expect(instance).to.be();
    });

    it('should have the property phoneNumberPoolCountries (base name: "PhoneNumberPoolCountries")', function() {
      // uncomment below and update the code to test the property phoneNumberPoolCountries
      //var instance = new AmazonChime.PutVoiceConnectorProxyRequest();
      //expect(instance).to.be();
    });

    it('should have the property fallBackPhoneNumber (base name: "FallBackPhoneNumber")', function() {
      // uncomment below and update the code to test the property fallBackPhoneNumber
      //var instance = new AmazonChime.PutVoiceConnectorProxyRequest();
      //expect(instance).to.be();
    });
