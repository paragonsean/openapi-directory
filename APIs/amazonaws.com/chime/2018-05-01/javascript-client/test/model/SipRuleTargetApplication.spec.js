...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipRuleTargetApplication();
  });
  ...
  describe('SipRuleTargetApplication', function() {
    it('should create an instance of SipRuleTargetApplication', function() {
      // uncomment below and update the code to test SipRuleTargetApplication
      //var instance = new AmazonChime.SipRuleTargetApplication();
      //expect(instance).to.be.a(AmazonChime.SipRuleTargetApplication);
    });
