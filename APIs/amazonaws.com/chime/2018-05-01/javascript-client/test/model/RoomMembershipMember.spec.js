...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RoomMembershipMember();
  });
  ...
  describe('RoomMembershipMember', function() {
    it('should create an instance of RoomMembershipMember', function() {
      // uncomment below and update the code to test RoomMembershipMember
      //var instance = new AmazonChime.RoomMembershipMember();
      //expect(instance).to.be.a(AmazonChime.RoomMembershipMember);
    });
