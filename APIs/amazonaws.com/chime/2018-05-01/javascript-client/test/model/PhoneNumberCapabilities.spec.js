...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PhoneNumberCapabilities();
  });
  ...
  describe('PhoneNumberCapabilities', function() {
    it('should create an instance of PhoneNumberCapabilities', function() {
      // uncomment below and update the code to test PhoneNumberCapabilities
      //var instance = new AmazonChime.PhoneNumberCapabilities();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberCapabilities);
    });
    ...
    it('should have the property inboundSMS (base name: "InboundSMS")', function() {
      // uncomment below and update the code to test the property inboundSMS
      //var instance = new AmazonChime.PhoneNumberCapabilities();
      //expect(instance).to.be();
    });

    it('should have the property outboundSMS (base name: "OutboundSMS")', function() {
      // uncomment below and update the code to test the property outboundSMS
      //var instance = new AmazonChime.PhoneNumberCapabilities();
      //expect(instance).to.be();
    });

    it('should have the property inboundMMS (base name: "InboundMMS")', function() {
      // uncomment below and update the code to test the property inboundMMS
      //var instance = new AmazonChime.PhoneNumberCapabilities();
      //expect(instance).to.be();
    });

    it('should have the property outboundMMS (base name: "OutboundMMS")', function() {
      // uncomment below and update the code to test the property outboundMMS
      //var instance = new AmazonChime.PhoneNumberCapabilities();
      //expect(instance).to.be();
    });
