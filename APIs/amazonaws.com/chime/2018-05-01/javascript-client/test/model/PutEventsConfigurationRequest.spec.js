...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutEventsConfigurationRequest();
  });
  ...
  describe('PutEventsConfigurationRequest', function() {
    it('should create an instance of PutEventsConfigurationRequest', function() {
      // uncomment below and update the code to test PutEventsConfigurationRequest
      //var instance = new AmazonChime.PutEventsConfigurationRequest();
      //expect(instance).to.be.a(AmazonChime.PutEventsConfigurationRequest);
    });
