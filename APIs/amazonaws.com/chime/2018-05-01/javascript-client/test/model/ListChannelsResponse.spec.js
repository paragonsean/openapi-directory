...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new AmazonChime.ListChannelsResponse();
      //expect(instance).to.be.a(AmazonChime.ListChannelsResponse);
    });
