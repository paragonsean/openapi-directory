...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetBotResponseBot();
  });
  ...
  describe('GetBotResponseBot', function() {
    it('should create an instance of GetBotResponseBot', function() {
      // uncomment below and update the code to test GetBotResponseBot
      //var instance = new AmazonChime.GetBotResponseBot();
      //expect(instance).to.be.a(AmazonChime.GetBotResponseBot);
    });
