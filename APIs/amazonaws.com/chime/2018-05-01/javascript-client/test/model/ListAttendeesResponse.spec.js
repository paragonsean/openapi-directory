...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListAttendeesResponse();
  });
  ...
  describe('ListAttendeesResponse', function() {
    it('should create an instance of ListAttendeesResponse', function() {
      // uncomment below and update the code to test ListAttendeesResponse
      //var instance = new AmazonChime.ListAttendeesResponse();
      //expect(instance).to.be.a(AmazonChime.ListAttendeesResponse);
    });
