...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateUserResponseUser();
  });
  ...
  describe('CreateUserResponseUser', function() {
    it('should create an instance of CreateUserResponseUser', function() {
      // uncomment below and update the code to test CreateUserResponseUser
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be.a(AmazonChime.CreateUserResponseUser);
    });
    ...
    it('should have the property primaryProvisionedNumber (base name: "PrimaryProvisionedNumber")', function() {
      // uncomment below and update the code to test the property primaryProvisionedNumber
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });
    ...
    it('should have the property userRegistrationStatus (base name: "UserRegistrationStatus")', function() {
      // uncomment below and update the code to test the property userRegistrationStatus
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });

    it('should have the property userInvitationStatus (base name: "UserInvitationStatus")', function() {
      // uncomment below and update the code to test the property userInvitationStatus
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });

    it('should have the property registeredOn (base name: "RegisteredOn")', function() {
      // uncomment below and update the code to test the property registeredOn
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });

    it('should have the property invitedOn (base name: "InvitedOn")', function() {
      // uncomment below and update the code to test the property invitedOn
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });

    it('should have the property alexaForBusinessMetadata (base name: "AlexaForBusinessMetadata")', function() {
      // uncomment below and update the code to test the property alexaForBusinessMetadata
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });

    it('should have the property personalPIN (base name: "PersonalPIN")', function() {
      // uncomment below and update the code to test the property personalPIN
      //var instance = new AmazonChime.CreateUserResponseUser();
      //expect(instance).to.be();
    });
