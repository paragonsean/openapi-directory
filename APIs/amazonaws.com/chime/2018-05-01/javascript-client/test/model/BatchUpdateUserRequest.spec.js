...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUpdateUserRequest();
  });
  ...
  describe('BatchUpdateUserRequest', function() {
    it('should create an instance of BatchUpdateUserRequest', function() {
      // uncomment below and update the code to test BatchUpdateUserRequest
      //var instance = new AmazonChime.BatchUpdateUserRequest();
      //expect(instance).to.be.a(AmazonChime.BatchUpdateUserRequest);
    });

    it('should have the property updateUserRequestItems (base name: "UpdateUserRequestItems")', function() {
      // uncomment below and update the code to test the property updateUserRequestItems
      //var instance = new AmazonChime.BatchUpdateUserRequest();
