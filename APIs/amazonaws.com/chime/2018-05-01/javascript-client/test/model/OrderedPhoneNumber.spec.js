...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.OrderedPhoneNumber();
  });
  ...
  describe('OrderedPhoneNumber', function() {
    it('should create an instance of OrderedPhoneNumber', function() {
      // uncomment below and update the code to test OrderedPhoneNumber
      //var instance = new AmazonChime.OrderedPhoneNumber();
      //expect(instance).to.be.a(AmazonChime.OrderedPhoneNumber);
    });
