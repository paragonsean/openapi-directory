...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationResponse();
  });
  ...
  describe('PutVoiceConnectorEmergencyCallingConfigurationResponse', function() {
    it('should create an instance of PutVoiceConnectorEmergencyCallingConfigurationResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorEmergencyCallingConfigurationResponse
      //var instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationResponse);
    });

    it('should have the property emergencyCallingConfiguration (base name: "EmergencyCallingConfiguration")', function() {
      // uncomment below and update the code to test the property emergencyCallingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationResponse();
