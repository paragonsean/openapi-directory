...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingDialOutResponse();
  });
  ...
  describe('CreateMeetingDialOutResponse', function() {
    it('should create an instance of CreateMeetingDialOutResponse', function() {
      // uncomment below and update the code to test CreateMeetingDialOutResponse
      //var instance = new AmazonChime.CreateMeetingDialOutResponse();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingDialOutResponse);
    });
