...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings();
  });
  ...
  describe('PutAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings', function() {
    it('should create an instance of PutAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings', function() {
      ...
      //var instance = new AmazonChime.PutAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.PutAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings);
    });
