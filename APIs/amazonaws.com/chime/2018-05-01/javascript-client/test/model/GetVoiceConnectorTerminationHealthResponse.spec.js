...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorTerminationHealthResponse();
  });
  ...
  describe('GetVoiceConnectorTerminationHealthResponse', function() {
    it('should create an instance of GetVoiceConnectorTerminationHealthResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorTerminationHealthResponse
      //var instance = new AmazonChime.GetVoiceConnectorTerminationHealthResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorTerminationHealthResponse);
    });

    it('should have the property terminationHealth (base name: "TerminationHealth")', function() {
      // uncomment below and update the code to test the property terminationHealth
      //var instance = new AmazonChime.GetVoiceConnectorTerminationHealthResponse();
