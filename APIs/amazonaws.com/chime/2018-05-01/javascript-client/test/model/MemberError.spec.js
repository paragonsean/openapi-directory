...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.MemberError();
  });
  ...
  describe('MemberError', function() {
    it('should create an instance of MemberError', function() {
      // uncomment below and update the code to test MemberError
      //var instance = new AmazonChime.MemberError();
      //expect(instance).to.be.a(AmazonChime.MemberError);
    });
