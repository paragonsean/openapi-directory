...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorTerminationResponse();
  });
  ...
  describe('GetVoiceConnectorTerminationResponse', function() {
    it('should create an instance of GetVoiceConnectorTerminationResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorTerminationResponse
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorTerminationResponse);
    });
