...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateAccountResponseAccount();
  });
  ...
  describe('UpdateAccountResponseAccount', function() {
    it('should create an instance of UpdateAccountResponseAccount', function() {
      // uncomment below and update the code to test UpdateAccountResponseAccount
      //var instance = new AmazonChime.UpdateAccountResponseAccount();
      //expect(instance).to.be.a(AmazonChime.UpdateAccountResponseAccount);
    });
