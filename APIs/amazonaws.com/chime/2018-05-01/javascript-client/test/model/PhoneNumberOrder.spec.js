...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PhoneNumberOrder();
  });
  ...
  describe('PhoneNumberOrder', function() {
    it('should create an instance of PhoneNumberOrder', function() {
      // uncomment below and update the code to test PhoneNumberOrder
      //var instance = new AmazonChime.PhoneNumberOrder();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberOrder);
    });
