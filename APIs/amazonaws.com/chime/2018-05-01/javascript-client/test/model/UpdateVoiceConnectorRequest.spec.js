...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateVoiceConnectorRequest();
  });
  ...
  describe('UpdateVoiceConnectorRequest', function() {
    it('should create an instance of UpdateVoiceConnectorRequest', function() {
      // uncomment below and update the code to test UpdateVoiceConnectorRequest
      //var instance = new AmazonChime.UpdateVoiceConnectorRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateVoiceConnectorRequest);
    });
