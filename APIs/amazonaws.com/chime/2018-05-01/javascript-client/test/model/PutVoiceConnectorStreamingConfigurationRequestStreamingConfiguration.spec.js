...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration();
  });
  ...
  describe('PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration', function() {
    it('should create an instance of PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration', function() {
      // uncomment below and update the code to test PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorStreamingConfigurationRequestStreamingConfiguration);
    });
