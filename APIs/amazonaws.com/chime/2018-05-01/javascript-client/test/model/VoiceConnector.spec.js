...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.VoiceConnector();
  });
  ...
  describe('VoiceConnector', function() {
    it('should create an instance of VoiceConnector', function() {
      // uncomment below and update the code to test VoiceConnector
      //var instance = new AmazonChime.VoiceConnector();
      //expect(instance).to.be.a(AmazonChime.VoiceConnector);
    });
    ...
    it('should have the property outboundHostName (base name: "OutboundHostName")', function() {
      // uncomment below and update the code to test the property outboundHostName
      //var instance = new AmazonChime.VoiceConnector();
      //expect(instance).to.be();
    });

    it('should have the property requireEncryption (base name: "RequireEncryption")', function() {
      // uncomment below and update the code to test the property requireEncryption
      //var instance = new AmazonChime.VoiceConnector();
      //expect(instance).to.be();
    });
    ...
    it('should have the property voiceConnectorArn (base name: "VoiceConnectorArn")', function() {
      // uncomment below and update the code to test the property voiceConnectorArn
      //var instance = new AmazonChime.VoiceConnector();
      //expect(instance).to.be();
    });
