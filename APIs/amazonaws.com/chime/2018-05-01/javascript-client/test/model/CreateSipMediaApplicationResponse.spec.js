...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationResponse();
  });
  ...
  describe('CreateSipMediaApplicationResponse', function() {
    it('should create an instance of CreateSipMediaApplicationResponse', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationResponse
      //var instance = new AmazonChime.CreateSipMediaApplicationResponse();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationResponse);
    });
