...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListPhoneNumberOrdersResponse();
  });
  ...
  describe('ListPhoneNumberOrdersResponse', function() {
    it('should create an instance of ListPhoneNumberOrdersResponse', function() {
      // uncomment below and update the code to test ListPhoneNumberOrdersResponse
      //var instance = new AmazonChime.ListPhoneNumberOrdersResponse();
      //expect(instance).to.be.a(AmazonChime.ListPhoneNumberOrdersResponse);
    });

    it('should have the property phoneNumberOrders (base name: "PhoneNumberOrders")', function() {
      // uncomment below and update the code to test the property phoneNumberOrders
      //var instance = new AmazonChime.ListPhoneNumberOrdersResponse();
