...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SendChannelMessageResponse();
  });
  ...
  describe('SendChannelMessageResponse', function() {
    it('should create an instance of SendChannelMessageResponse', function() {
      // uncomment below and update the code to test SendChannelMessageResponse
      //var instance = new AmazonChime.SendChannelMessageResponse();
      //expect(instance).to.be.a(AmazonChime.SendChannelMessageResponse);
    });
