...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorStreamingConfigurationResponse();
  });
  ...
  describe('GetVoiceConnectorStreamingConfigurationResponse', function() {
    it('should create an instance of GetVoiceConnectorStreamingConfigurationResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorStreamingConfigurationResponse
      //var instance = new AmazonChime.GetVoiceConnectorStreamingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorStreamingConfigurationResponse);
    });
