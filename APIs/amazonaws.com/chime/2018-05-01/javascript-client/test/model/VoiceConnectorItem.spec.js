...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.VoiceConnectorItem();
  });
  ...
  describe('VoiceConnectorItem', function() {
    it('should create an instance of VoiceConnectorItem', function() {
      // uncomment below and update the code to test VoiceConnectorItem
      //var instance = new AmazonChime.VoiceConnectorItem();
      //expect(instance).to.be.a(AmazonChime.VoiceConnectorItem);
    });
