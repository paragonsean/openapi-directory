...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutEventsConfigurationResponse();
  });
  ...
  describe('PutEventsConfigurationResponse', function() {
    it('should create an instance of PutEventsConfigurationResponse', function() {
      // uncomment below and update the code to test PutEventsConfigurationResponse
      //var instance = new AmazonChime.PutEventsConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.PutEventsConfigurationResponse);
    });
