...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RedactChannelMessageResponse();
  });
  ...
  describe('RedactChannelMessageResponse', function() {
    it('should create an instance of RedactChannelMessageResponse', function() {
      // uncomment below and update the code to test RedactChannelMessageResponse
      //var instance = new AmazonChime.RedactChannelMessageResponse();
      //expect(instance).to.be.a(AmazonChime.RedactChannelMessageResponse);
    });
