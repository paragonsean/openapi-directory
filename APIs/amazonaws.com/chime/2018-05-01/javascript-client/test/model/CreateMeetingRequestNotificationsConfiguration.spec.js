...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingRequestNotificationsConfiguration();
  });
  ...
  describe('CreateMeetingRequestNotificationsConfiguration', function() {
    it('should create an instance of CreateMeetingRequestNotificationsConfiguration', function() {
      // uncomment below and update the code to test CreateMeetingRequestNotificationsConfiguration
      //var instance = new AmazonChime.CreateMeetingRequestNotificationsConfiguration();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingRequestNotificationsConfiguration);
    });
