...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetRetentionSettingsResponse();
  });
  ...
  describe('GetRetentionSettingsResponse', function() {
    it('should create an instance of GetRetentionSettingsResponse', function() {
      // uncomment below and update the code to test GetRetentionSettingsResponse
      //var instance = new AmazonChime.GetRetentionSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.GetRetentionSettingsResponse);
    });

    it('should have the property retentionSettings (base name: "RetentionSettings")', function() {
      // uncomment below and update the code to test the property retentionSettings
      //var instance = new AmazonChime.GetRetentionSettingsResponse();
