...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration();
  });
  ...
  describe('GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration', function() {
    it('should create an instance of GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration', function() {
      // uncomment below and update the code to test GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration
      //var instance = new AmazonChime.GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorStreamingConfigurationResponseStreamingConfiguration);
    });
