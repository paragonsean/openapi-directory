...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAttendeeResponse();
  });
  ...
  describe('GetAttendeeResponse', function() {
    it('should create an instance of GetAttendeeResponse', function() {
      // uncomment below and update the code to test GetAttendeeResponse
      //var instance = new AmazonChime.GetAttendeeResponse();
      //expect(instance).to.be.a(AmazonChime.GetAttendeeResponse);
    });
