...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PhoneNumberError();
  });
  ...
  describe('PhoneNumberError', function() {
    it('should create an instance of PhoneNumberError', function() {
      // uncomment below and update the code to test PhoneNumberError
      //var instance = new AmazonChime.PhoneNumberError();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberError);
    });
