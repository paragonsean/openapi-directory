...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings();
  });
  ...
  describe('StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings', function() {
    it('should create an instance of StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings', function() {
      // uncomment below and update the code to test StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings
      //var instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings();
      //expect(instance).to.be.a(AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeSettings);
    });
