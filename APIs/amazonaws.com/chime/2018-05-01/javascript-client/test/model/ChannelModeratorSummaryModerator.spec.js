...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelModeratorSummaryModerator();
  });
  ...
  describe('ChannelModeratorSummaryModerator', function() {
    it('should create an instance of ChannelModeratorSummaryModerator', function() {
      // uncomment below and update the code to test ChannelModeratorSummaryModerator
      //var instance = new AmazonChime.ChannelModeratorSummaryModerator();
      //expect(instance).to.be.a(AmazonChime.ChannelModeratorSummaryModerator);
    });
