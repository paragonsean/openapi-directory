...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociateSigninDelegateGroupsWithAccountRequest();
  });
  ...
  describe('AssociateSigninDelegateGroupsWithAccountRequest', function() {
    it('should create an instance of AssociateSigninDelegateGroupsWithAccountRequest', function() {
      // uncomment below and update the code to test AssociateSigninDelegateGroupsWithAccountRequest
      //var instance = new AmazonChime.AssociateSigninDelegateGroupsWithAccountRequest();
      //expect(instance).to.be.a(AmazonChime.AssociateSigninDelegateGroupsWithAccountRequest);
    });
