...
(function(root, factory) {
  ...
  describe('TranscribeContentRedactionType', function() {
    it('should create an instance of TranscribeContentRedactionType', function() {
      // uncomment below and update the code to test TranscribeContentRedactionType
      //var instance = new AmazonChime.TranscribeContentRedactionType();
      //expect(instance).to.be.a(AmazonChime.TranscribeContentRedactionType);
    });
