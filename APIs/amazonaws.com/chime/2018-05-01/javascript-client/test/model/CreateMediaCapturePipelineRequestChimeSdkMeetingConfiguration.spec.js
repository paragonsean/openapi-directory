...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration();
  });
  ...
  describe('CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration', function() {
    it('should create an instance of CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration', function() {
      // uncomment below and update the code to test CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration
      //var instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration();
      //expect(instance).to.be.a(AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration);
    });
    ...
    it('should have the property artifactsConfiguration (base name: "ArtifactsConfiguration")', function() {
      // uncomment below and update the code to test the property artifactsConfiguration
      //var instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfiguration();
      //expect(instance).to.be();
    });
