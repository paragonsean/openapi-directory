...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.InviteUsersResponse();
  });
  ...
  describe('InviteUsersResponse', function() {
    it('should create an instance of InviteUsersResponse', function() {
      // uncomment below and update the code to test InviteUsersResponse
      //var instance = new AmazonChime.InviteUsersResponse();
      //expect(instance).to.be.a(AmazonChime.InviteUsersResponse);
    });
