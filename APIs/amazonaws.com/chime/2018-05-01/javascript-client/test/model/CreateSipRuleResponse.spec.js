...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipRuleResponse();
  });
  ...
  describe('CreateSipRuleResponse', function() {
    it('should create an instance of CreateSipRuleResponse', function() {
      // uncomment below and update the code to test CreateSipRuleResponse
      //var instance = new AmazonChime.CreateSipRuleResponse();
      //expect(instance).to.be.a(AmazonChime.CreateSipRuleResponse);
    });
