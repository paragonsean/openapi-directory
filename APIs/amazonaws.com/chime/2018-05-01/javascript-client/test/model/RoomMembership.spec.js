...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RoomMembership();
  });
  ...
  describe('RoomMembership', function() {
    it('should create an instance of RoomMembership', function() {
      // uncomment below and update the code to test RoomMembership
      //var instance = new AmazonChime.RoomMembership();
      //expect(instance).to.be.a(AmazonChime.RoomMembership);
    });
