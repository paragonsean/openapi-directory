...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdatePhoneNumberResponsePhoneNumber();
  });
  ...
  describe('UpdatePhoneNumberResponsePhoneNumber', function() {
    it('should create an instance of UpdatePhoneNumberResponsePhoneNumber', function() {
      // uncomment below and update the code to test UpdatePhoneNumberResponsePhoneNumber
      //var instance = new AmazonChime.UpdatePhoneNumberResponsePhoneNumber();
      //expect(instance).to.be.a(AmazonChime.UpdatePhoneNumberResponsePhoneNumber);
    });
    ...
    it('should have the property callingName (base name: "CallingName")', function() {
      // uncomment below and update the code to test the property callingName
      //var instance = new AmazonChime.UpdatePhoneNumberResponsePhoneNumber();
      //expect(instance).to.be();
    });

    it('should have the property callingNameStatus (base name: "CallingNameStatus")', function() {
      // uncomment below and update the code to test the property callingNameStatus
      //var instance = new AmazonChime.UpdatePhoneNumberResponsePhoneNumber();
      //expect(instance).to.be();
    });
