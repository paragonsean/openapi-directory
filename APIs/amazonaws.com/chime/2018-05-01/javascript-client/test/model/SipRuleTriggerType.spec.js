...
(function(root, factory) {
  ...
  describe('SipRuleTriggerType', function() {
    it('should create an instance of SipRuleTriggerType', function() {
      // uncomment below and update the code to test SipRuleTriggerType
      //var instance = new AmazonChime.SipRuleTriggerType();
      //expect(instance).to.be.a(AmazonChime.SipRuleTriggerType);
    });
