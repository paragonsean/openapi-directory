...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutRetentionSettingsRequest();
  });
  ...
  describe('PutRetentionSettingsRequest', function() {
    it('should create an instance of PutRetentionSettingsRequest', function() {
      // uncomment below and update the code to test PutRetentionSettingsRequest
      //var instance = new AmazonChime.PutRetentionSettingsRequest();
      //expect(instance).to.be.a(AmazonChime.PutRetentionSettingsRequest);
    });
