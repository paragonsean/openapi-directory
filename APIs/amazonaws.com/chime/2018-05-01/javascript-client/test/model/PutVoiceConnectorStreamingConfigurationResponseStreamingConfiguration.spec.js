...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration();
  });
  ...
  describe('PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration', function() {
    it('should create an instance of PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration', function() {
      // uncomment below and update the code to test PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration);
    });
    ...
    it('should have the property streamingNotificationTargets (base name: "StreamingNotificationTargets")', function() {
      // uncomment below and update the code to test the property streamingNotificationTargets
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponseStreamingConfiguration();
      //expect(instance).to.be();
    });
