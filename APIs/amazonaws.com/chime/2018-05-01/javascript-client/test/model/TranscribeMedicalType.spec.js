...
(function(root, factory) {
  ...
  describe('TranscribeMedicalType', function() {
    it('should create an instance of TranscribeMedicalType', function() {
      // uncomment below and update the code to test TranscribeMedicalType
      //var instance = new AmazonChime.TranscribeMedicalType();
      //expect(instance).to.be.a(AmazonChime.TranscribeMedicalType);
    });
