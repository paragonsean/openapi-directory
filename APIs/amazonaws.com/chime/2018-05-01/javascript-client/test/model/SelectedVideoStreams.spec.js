...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SelectedVideoStreams();
  });
  ...
  describe('SelectedVideoStreams', function() {
    it('should create an instance of SelectedVideoStreams', function() {
      // uncomment below and update the code to test SelectedVideoStreams
      //var instance = new AmazonChime.SelectedVideoStreams();
      //expect(instance).to.be.a(AmazonChime.SelectedVideoStreams);
    });
