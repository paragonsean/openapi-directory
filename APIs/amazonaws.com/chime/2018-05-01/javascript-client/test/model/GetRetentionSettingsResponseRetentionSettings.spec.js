...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetRetentionSettingsResponseRetentionSettings();
  });
  ...
  describe('GetRetentionSettingsResponseRetentionSettings', function() {
    it('should create an instance of GetRetentionSettingsResponseRetentionSettings', function() {
      // uncomment below and update the code to test GetRetentionSettingsResponseRetentionSettings
      //var instance = new AmazonChime.GetRetentionSettingsResponseRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.GetRetentionSettingsResponseRetentionSettings);
    });

    it('should have the property roomRetentionSettings (base name: "RoomRetentionSettings")', function() {
      // uncomment below and update the code to test the property roomRetentionSettings
      //var instance = new AmazonChime.GetRetentionSettingsResponseRetentionSettings();
      //expect(instance).to.be();
    });

    it('should have the property conversationRetentionSettings (base name: "ConversationRetentionSettings")', function() {
      // uncomment below and update the code to test the property conversationRetentionSettings
      //var instance = new AmazonChime.GetRetentionSettingsResponseRetentionSettings();
      //expect(instance).to.be();
    });
