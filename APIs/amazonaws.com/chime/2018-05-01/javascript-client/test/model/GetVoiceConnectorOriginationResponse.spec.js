...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorOriginationResponse();
  });
  ...
  describe('GetVoiceConnectorOriginationResponse', function() {
    it('should create an instance of GetVoiceConnectorOriginationResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorOriginationResponse
      //var instance = new AmazonChime.GetVoiceConnectorOriginationResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorOriginationResponse);
    });
