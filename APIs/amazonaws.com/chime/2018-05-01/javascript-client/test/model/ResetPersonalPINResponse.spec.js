...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ResetPersonalPINResponse();
  });
  ...
  describe('ResetPersonalPINResponse', function() {
    it('should create an instance of ResetPersonalPINResponse', function() {
      // uncomment below and update the code to test ResetPersonalPINResponse
      //var instance = new AmazonChime.ResetPersonalPINResponse();
      //expect(instance).to.be.a(AmazonChime.ResetPersonalPINResponse);
    });
