...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.Termination();
  });
  ...
  describe('Termination', function() {
    it('should create an instance of Termination', function() {
      // uncomment below and update the code to test Termination
      //var instance = new AmazonChime.Termination();
      //expect(instance).to.be.a(AmazonChime.Termination);
    });
