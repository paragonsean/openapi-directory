...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BusinessCallingSettings();
  });
  ...
  describe('BusinessCallingSettings', function() {
    it('should create an instance of BusinessCallingSettings', function() {
      // uncomment below and update the code to test BusinessCallingSettings
      //var instance = new AmazonChime.BusinessCallingSettings();
      //expect(instance).to.be.a(AmazonChime.BusinessCallingSettings);
    });
