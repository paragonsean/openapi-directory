...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonChime.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonChime.UntagResourceRequest);
    });
