...
(function(root, factory) {
  ...
  describe('RoomMembershipRole', function() {
    it('should create an instance of RoomMembershipRole', function() {
      // uncomment below and update the code to test RoomMembershipRole
      //var instance = new AmazonChime.RoomMembershipRole();
      //expect(instance).to.be.a(AmazonChime.RoomMembershipRole);
    });
