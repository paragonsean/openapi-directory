...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreatePhoneNumberOrderResponsePhoneNumberOrder();
  });
  ...
  describe('CreatePhoneNumberOrderResponsePhoneNumberOrder', function() {
    it('should create an instance of CreatePhoneNumberOrderResponsePhoneNumberOrder', function() {
      // uncomment below and update the code to test CreatePhoneNumberOrderResponsePhoneNumberOrder
      //var instance = new AmazonChime.CreatePhoneNumberOrderResponsePhoneNumberOrder();
      //expect(instance).to.be.a(AmazonChime.CreatePhoneNumberOrderResponsePhoneNumberOrder);
    });

    it('should have the property phoneNumberOrderId (base name: "PhoneNumberOrderId")', function() {
      // uncomment below and update the code to test the property phoneNumberOrderId
      //var instance = new AmazonChime.CreatePhoneNumberOrderResponsePhoneNumberOrder();
    ...
    it('should have the property orderedPhoneNumbers (base name: "OrderedPhoneNumbers")', function() {
      // uncomment below and update the code to test the property orderedPhoneNumbers
      //var instance = new AmazonChime.CreatePhoneNumberOrderResponsePhoneNumberOrder();
      //expect(instance).to.be();
    });
