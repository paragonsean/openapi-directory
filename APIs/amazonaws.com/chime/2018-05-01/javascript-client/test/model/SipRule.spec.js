...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipRule();
  });
  ...
  describe('SipRule', function() {
    it('should create an instance of SipRule', function() {
      // uncomment below and update the code to test SipRule
      //var instance = new AmazonChime.SipRule();
      //expect(instance).to.be.a(AmazonChime.SipRule);
    });

    it('should have the property sipRuleId (base name: "SipRuleId")', function() {
      // uncomment below and update the code to test the property sipRuleId
      //var instance = new AmazonChime.SipRule();
    ...
    it('should have the property targetApplications (base name: "TargetApplications")', function() {
      // uncomment below and update the code to test the property targetApplications
      //var instance = new AmazonChime.SipRule();
      //expect(instance).to.be();
    });
