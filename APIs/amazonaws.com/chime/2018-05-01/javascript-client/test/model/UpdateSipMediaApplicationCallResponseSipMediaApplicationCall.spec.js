...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationCallResponseSipMediaApplicationCall();
  });
  ...
  describe('UpdateSipMediaApplicationCallResponseSipMediaApplicationCall', function() {
    it('should create an instance of UpdateSipMediaApplicationCallResponseSipMediaApplicationCall', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationCallResponseSipMediaApplicationCall
      //var instance = new AmazonChime.UpdateSipMediaApplicationCallResponseSipMediaApplicationCall();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationCallResponseSipMediaApplicationCall);
    });
