...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelModeratedByAppInstanceUserSummary();
  });
  ...
  describe('ChannelModeratedByAppInstanceUserSummary', function() {
    it('should create an instance of ChannelModeratedByAppInstanceUserSummary', function() {
      // uncomment below and update the code to test ChannelModeratedByAppInstanceUserSummary
      //var instance = new AmazonChime.ChannelModeratedByAppInstanceUserSummary();
      //expect(instance).to.be.a(AmazonChime.ChannelModeratedByAppInstanceUserSummary);
    });
