...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipMediaApplicationCallResponseSipMediaApplicationCall();
  });
  ...
  describe('CreateSipMediaApplicationCallResponseSipMediaApplicationCall', function() {
    it('should create an instance of CreateSipMediaApplicationCallResponseSipMediaApplicationCall', function() {
      // uncomment below and update the code to test CreateSipMediaApplicationCallResponseSipMediaApplicationCall
      //var instance = new AmazonChime.CreateSipMediaApplicationCallResponseSipMediaApplicationCall();
      //expect(instance).to.be.a(AmazonChime.CreateSipMediaApplicationCallResponseSipMediaApplicationCall);
    });
