...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings();
  });
  ...
  describe('GetAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings', function() {
    it('should create an instance of GetAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings', function() {
      ...
      //var instance = new AmazonChime.GetAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.GetAppInstanceRetentionSettingsResponseAppInstanceRetentionSettings);
    });
