...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorOriginationResponseOrigination();
  });
  ...
  describe('GetVoiceConnectorOriginationResponseOrigination', function() {
    it('should create an instance of GetVoiceConnectorOriginationResponseOrigination', function() {
      // uncomment below and update the code to test GetVoiceConnectorOriginationResponseOrigination
      //var instance = new AmazonChime.GetVoiceConnectorOriginationResponseOrigination();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorOriginationResponseOrigination);
    });
