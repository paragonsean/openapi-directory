...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserRequestItemAlexaForBusinessMetadata();
  });
  ...
  describe('UpdateUserRequestItemAlexaForBusinessMetadata', function() {
    it('should create an instance of UpdateUserRequestItemAlexaForBusinessMetadata', function() {
      // uncomment below and update the code to test UpdateUserRequestItemAlexaForBusinessMetadata
      //var instance = new AmazonChime.UpdateUserRequestItemAlexaForBusinessMetadata();
      //expect(instance).to.be.a(AmazonChime.UpdateUserRequestItemAlexaForBusinessMetadata);
    });
