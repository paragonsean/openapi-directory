...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateVoiceConnectorGroupRequest();
  });
  ...
  describe('CreateVoiceConnectorGroupRequest', function() {
    it('should create an instance of CreateVoiceConnectorGroupRequest', function() {
      // uncomment below and update the code to test CreateVoiceConnectorGroupRequest
      //var instance = new AmazonChime.CreateVoiceConnectorGroupRequest();
      //expect(instance).to.be.a(AmazonChime.CreateVoiceConnectorGroupRequest);
    });
