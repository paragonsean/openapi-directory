...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GeoMatchParams();
  });
  ...
  describe('GeoMatchParams', function() {
    it('should create an instance of GeoMatchParams', function() {
      // uncomment below and update the code to test GeoMatchParams
      //var instance = new AmazonChime.GeoMatchParams();
      //expect(instance).to.be.a(AmazonChime.GeoMatchParams);
    });
