...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupResponse();
  });
  ...
  describe('AssociatePhoneNumbersWithVoiceConnectorGroupResponse', function() {
    it('should create an instance of AssociatePhoneNumbersWithVoiceConnectorGroupResponse', function() {
      // uncomment below and update the code to test AssociatePhoneNumbersWithVoiceConnectorGroupResponse
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupResponse();
      //expect(instance).to.be.a(AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupResponse);
    });
