...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetAppInstanceStreamingConfigurationsResponse();
  });
  ...
  describe('GetAppInstanceStreamingConfigurationsResponse', function() {
    it('should create an instance of GetAppInstanceStreamingConfigurationsResponse', function() {
      // uncomment below and update the code to test GetAppInstanceStreamingConfigurationsResponse
      //var instance = new AmazonChime.GetAppInstanceStreamingConfigurationsResponse();
      //expect(instance).to.be.a(AmazonChime.GetAppInstanceStreamingConfigurationsResponse);
    });
