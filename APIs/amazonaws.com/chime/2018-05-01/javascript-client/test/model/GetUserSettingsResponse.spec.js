...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetUserSettingsResponse();
  });
  ...
  describe('GetUserSettingsResponse', function() {
    it('should create an instance of GetUserSettingsResponse', function() {
      // uncomment below and update the code to test GetUserSettingsResponse
      //var instance = new AmazonChime.GetUserSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.GetUserSettingsResponse);
    });
