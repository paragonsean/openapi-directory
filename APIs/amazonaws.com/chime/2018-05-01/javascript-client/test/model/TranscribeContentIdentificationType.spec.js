...
(function(root, factory) {
  ...
  describe('TranscribeContentIdentificationType', function() {
    it('should create an instance of TranscribeContentIdentificationType', function() {
      // uncomment below and update the code to test TranscribeContentIdentificationType
      //var instance = new AmazonChime.TranscribeContentIdentificationType();
      //expect(instance).to.be.a(AmazonChime.TranscribeContentIdentificationType);
    });
