...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceStreamingConfiguration();
  });
  ...
  describe('AppInstanceStreamingConfiguration', function() {
    it('should create an instance of AppInstanceStreamingConfiguration', function() {
      // uncomment below and update the code to test AppInstanceStreamingConfiguration
      //var instance = new AmazonChime.AppInstanceStreamingConfiguration();
      //expect(instance).to.be.a(AmazonChime.AppInstanceStreamingConfiguration);
    });

    it('should have the property appInstanceDataType (base name: "AppInstanceDataType")', function() {
      // uncomment below and update the code to test the property appInstanceDataType
      //var instance = new AmazonChime.AppInstanceStreamingConfiguration();
