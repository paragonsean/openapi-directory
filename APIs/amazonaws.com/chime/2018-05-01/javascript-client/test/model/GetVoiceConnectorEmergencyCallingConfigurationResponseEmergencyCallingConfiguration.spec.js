...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration();
  });
  ...
  describe('GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration', function() {
    it('should create an instance of GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration', function() {
      // uncomment below and update the code to test GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration
      //var instance = new AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorEmergencyCallingConfigurationResponseEmergencyCallingConfiguration);
    });
