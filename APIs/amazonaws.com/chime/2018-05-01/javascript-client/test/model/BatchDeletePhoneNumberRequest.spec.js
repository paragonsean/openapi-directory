...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchDeletePhoneNumberRequest();
  });
  ...
  describe('BatchDeletePhoneNumberRequest', function() {
    it('should create an instance of BatchDeletePhoneNumberRequest', function() {
      // uncomment below and update the code to test BatchDeletePhoneNumberRequest
      //var instance = new AmazonChime.BatchDeletePhoneNumberRequest();
      //expect(instance).to.be.a(AmazonChime.BatchDeletePhoneNumberRequest);
    });

    it('should have the property phoneNumberIds (base name: "PhoneNumberIds")', function() {
      // uncomment below and update the code to test the property phoneNumberIds
      //var instance = new AmazonChime.BatchDeletePhoneNumberRequest();
