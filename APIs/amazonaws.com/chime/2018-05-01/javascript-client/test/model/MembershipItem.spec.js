...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.MembershipItem();
  });
  ...
  describe('MembershipItem', function() {
    it('should create an instance of MembershipItem', function() {
      // uncomment below and update the code to test MembershipItem
      //var instance = new AmazonChime.MembershipItem();
      //expect(instance).to.be.a(AmazonChime.MembershipItem);
    });
