...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateVoiceConnectorResponse();
  });
  ...
  describe('CreateVoiceConnectorResponse', function() {
    it('should create an instance of CreateVoiceConnectorResponse', function() {
      // uncomment below and update the code to test CreateVoiceConnectorResponse
      //var instance = new AmazonChime.CreateVoiceConnectorResponse();
      //expect(instance).to.be.a(AmazonChime.CreateVoiceConnectorResponse);
    });

    it('should have the property voiceConnector (base name: "VoiceConnector")', function() {
      // uncomment below and update the code to test the property voiceConnector
      //var instance = new AmazonChime.CreateVoiceConnectorResponse();
