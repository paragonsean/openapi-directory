...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelMembershipForAppInstanceUserResponse();
  });
  ...
  describe('DescribeChannelMembershipForAppInstanceUserResponse', function() {
    it('should create an instance of DescribeChannelMembershipForAppInstanceUserResponse', function() {
      // uncomment below and update the code to test DescribeChannelMembershipForAppInstanceUserResponse
      //var instance = new AmazonChime.DescribeChannelMembershipForAppInstanceUserResponse();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelMembershipForAppInstanceUserResponse);
    });

    it('should have the property channelMembership (base name: "ChannelMembership")', function() {
      // uncomment below and update the code to test the property channelMembership
      //var instance = new AmazonChime.DescribeChannelMembershipForAppInstanceUserResponse();
