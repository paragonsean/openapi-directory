...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutAppInstanceStreamingConfigurationsResponse();
  });
  ...
  describe('PutAppInstanceStreamingConfigurationsResponse', function() {
    it('should create an instance of PutAppInstanceStreamingConfigurationsResponse', function() {
      // uncomment below and update the code to test PutAppInstanceStreamingConfigurationsResponse
      //var instance = new AmazonChime.PutAppInstanceStreamingConfigurationsResponse();
      //expect(instance).to.be.a(AmazonChime.PutAppInstanceStreamingConfigurationsResponse);
    });

    it('should have the property appInstanceStreamingConfigurations (base name: "AppInstanceStreamingConfigurations")', function() {
      // uncomment below and update the code to test the property appInstanceStreamingConfigurations
      //var instance = new AmazonChime.PutAppInstanceStreamingConfigurationsResponse();
