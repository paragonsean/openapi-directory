...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorProxyResponse();
  });
  ...
  describe('GetVoiceConnectorProxyResponse', function() {
    it('should create an instance of GetVoiceConnectorProxyResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorProxyResponse
      //var instance = new AmazonChime.GetVoiceConnectorProxyResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorProxyResponse);
    });
