...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListSupportedPhoneNumberCountriesResponse();
  });
  ...
  describe('ListSupportedPhoneNumberCountriesResponse', function() {
    it('should create an instance of ListSupportedPhoneNumberCountriesResponse', function() {
      // uncomment below and update the code to test ListSupportedPhoneNumberCountriesResponse
      //var instance = new AmazonChime.ListSupportedPhoneNumberCountriesResponse();
      //expect(instance).to.be.a(AmazonChime.ListSupportedPhoneNumberCountriesResponse);
    });

    it('should have the property phoneNumberCountries (base name: "PhoneNumberCountries")', function() {
      // uncomment below and update the code to test the property phoneNumberCountries
      //var instance = new AmazonChime.ListSupportedPhoneNumberCountriesResponse();
