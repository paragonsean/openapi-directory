...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RoomRetentionSettings();
  });
  ...
  describe('RoomRetentionSettings', function() {
    it('should create an instance of RoomRetentionSettings', function() {
      // uncomment below and update the code to test RoomRetentionSettings
      //var instance = new AmazonChime.RoomRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.RoomRetentionSettings);
    });
