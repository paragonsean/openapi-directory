...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipRuleRequest();
  });
  ...
  describe('UpdateSipRuleRequest', function() {
    it('should create an instance of UpdateSipRuleRequest', function() {
      // uncomment below and update the code to test UpdateSipRuleRequest
      //var instance = new AmazonChime.UpdateSipRuleRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateSipRuleRequest);
    });
