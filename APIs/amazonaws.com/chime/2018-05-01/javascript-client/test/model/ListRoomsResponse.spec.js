...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListRoomsResponse();
  });
  ...
  describe('ListRoomsResponse', function() {
    it('should create an instance of ListRoomsResponse', function() {
      // uncomment below and update the code to test ListRoomsResponse
      //var instance = new AmazonChime.ListRoomsResponse();
      //expect(instance).to.be.a(AmazonChime.ListRoomsResponse);
    });
