...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorRequest();
  });
  ...
  describe('AssociatePhoneNumbersWithVoiceConnectorRequest', function() {
    it('should create an instance of AssociatePhoneNumbersWithVoiceConnectorRequest', function() {
      // uncomment below and update the code to test AssociatePhoneNumbersWithVoiceConnectorRequest
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorRequest();
      //expect(instance).to.be.a(AmazonChime.AssociatePhoneNumbersWithVoiceConnectorRequest);
    });
