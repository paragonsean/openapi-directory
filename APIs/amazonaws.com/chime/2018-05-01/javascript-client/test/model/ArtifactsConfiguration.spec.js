...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ArtifactsConfiguration();
  });
  ...
  describe('ArtifactsConfiguration', function() {
    it('should create an instance of ArtifactsConfiguration', function() {
      ...
      //var instance = new AmazonChime.ArtifactsConfiguration();
      //expect(instance).to.be.a(AmazonChime.ArtifactsConfiguration);
    });
