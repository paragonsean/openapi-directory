...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateBotResponseBot();
  });
  ...
  describe('UpdateBotResponseBot', function() {
    it('should create an instance of UpdateBotResponseBot', function() {
      // uncomment below and update the code to test UpdateBotResponseBot
      //var instance = new AmazonChime.UpdateBotResponseBot();
      //expect(instance).to.be.a(AmazonChime.UpdateBotResponseBot);
    });
