...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateGlobalSettingsRequestVoiceConnector();
  });
  ...
  describe('UpdateGlobalSettingsRequestVoiceConnector', function() {
    it('should create an instance of UpdateGlobalSettingsRequestVoiceConnector', function() {
      // uncomment below and update the code to test UpdateGlobalSettingsRequestVoiceConnector
      //var instance = new AmazonChime.UpdateGlobalSettingsRequestVoiceConnector();
      //expect(instance).to.be.a(AmazonChime.UpdateGlobalSettingsRequestVoiceConnector);
    });
