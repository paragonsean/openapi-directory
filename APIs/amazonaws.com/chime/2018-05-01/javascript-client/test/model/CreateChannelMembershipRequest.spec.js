...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateChannelMembershipRequest();
  });
  ...
  describe('CreateChannelMembershipRequest', function() {
    it('should create an instance of CreateChannelMembershipRequest', function() {
      // uncomment below and update the code to test CreateChannelMembershipRequest
      //var instance = new AmazonChime.CreateChannelMembershipRequest();
      //expect(instance).to.be.a(AmazonChime.CreateChannelMembershipRequest);
    });
