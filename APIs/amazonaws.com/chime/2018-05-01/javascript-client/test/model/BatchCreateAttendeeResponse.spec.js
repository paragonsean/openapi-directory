...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateAttendeeResponse();
  });
  ...
  describe('BatchCreateAttendeeResponse', function() {
    it('should create an instance of BatchCreateAttendeeResponse', function() {
      // uncomment below and update the code to test BatchCreateAttendeeResponse
      //var instance = new AmazonChime.BatchCreateAttendeeResponse();
      //expect(instance).to.be.a(AmazonChime.BatchCreateAttendeeResponse);
    });
