...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListRoomMembershipsResponse();
  });
  ...
  describe('ListRoomMembershipsResponse', function() {
    it('should create an instance of ListRoomMembershipsResponse', function() {
      // uncomment below and update the code to test ListRoomMembershipsResponse
      //var instance = new AmazonChime.ListRoomMembershipsResponse();
      //expect(instance).to.be.a(AmazonChime.ListRoomMembershipsResponse);
    });

    it('should have the property roomMemberships (base name: "RoomMemberships")', function() {
      // uncomment below and update the code to test the property roomMemberships
      //var instance = new AmazonChime.ListRoomMembershipsResponse();
