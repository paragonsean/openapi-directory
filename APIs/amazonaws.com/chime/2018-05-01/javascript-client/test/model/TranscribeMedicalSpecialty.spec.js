...
(function(root, factory) {
  ...
  describe('TranscribeMedicalSpecialty', function() {
    it('should create an instance of TranscribeMedicalSpecialty', function() {
      // uncomment below and update the code to test TranscribeMedicalSpecialty
      //var instance = new AmazonChime.TranscribeMedicalSpecialty();
      //expect(instance).to.be.a(AmazonChime.TranscribeMedicalSpecialty);
    });
