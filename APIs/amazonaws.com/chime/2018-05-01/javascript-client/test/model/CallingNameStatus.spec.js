...
(function(root, factory) {
  ...
  describe('CallingNameStatus', function() {
    it('should create an instance of CallingNameStatus', function() {
      // uncomment below and update the code to test CallingNameStatus
      //var instance = new AmazonChime.CallingNameStatus();
      //expect(instance).to.be.a(AmazonChime.CallingNameStatus);
    });
