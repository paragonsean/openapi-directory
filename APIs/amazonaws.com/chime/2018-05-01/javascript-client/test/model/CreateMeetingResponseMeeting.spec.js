...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingResponseMeeting();
  });
  ...
  describe('CreateMeetingResponseMeeting', function() {
    it('should create an instance of CreateMeetingResponseMeeting', function() {
      // uncomment below and update the code to test CreateMeetingResponseMeeting
      //var instance = new AmazonChime.CreateMeetingResponseMeeting();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingResponseMeeting);
    });
