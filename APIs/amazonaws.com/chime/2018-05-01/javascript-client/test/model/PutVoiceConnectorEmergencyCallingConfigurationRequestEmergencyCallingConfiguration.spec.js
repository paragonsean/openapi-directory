...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration();
  });
  ...
  describe('PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration', function() {
    it('should create an instance of PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration', function() {
      // uncomment below and update the code to test PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorEmergencyCallingConfigurationRequestEmergencyCallingConfiguration);
    });
