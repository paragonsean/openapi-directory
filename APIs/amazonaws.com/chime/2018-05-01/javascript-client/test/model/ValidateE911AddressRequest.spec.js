...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ValidateE911AddressRequest();
  });
  ...
  describe('ValidateE911AddressRequest', function() {
    it('should create an instance of ValidateE911AddressRequest', function() {
      // uncomment below and update the code to test ValidateE911AddressRequest
      //var instance = new AmazonChime.ValidateE911AddressRequest();
      //expect(instance).to.be.a(AmazonChime.ValidateE911AddressRequest);
    });
    ...
    it('should have the property streetInfo (base name: "StreetInfo")', function() {
      // uncomment below and update the code to test the property streetInfo
      //var instance = new AmazonChime.ValidateE911AddressRequest();
      //expect(instance).to.be();
    });
