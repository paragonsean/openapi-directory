...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.EventsConfiguration();
  });
  ...
  describe('EventsConfiguration', function() {
    it('should create an instance of EventsConfiguration', function() {
      // uncomment below and update the code to test EventsConfiguration
      //var instance = new AmazonChime.EventsConfiguration();
      //expect(instance).to.be.a(AmazonChime.EventsConfiguration);
    });
