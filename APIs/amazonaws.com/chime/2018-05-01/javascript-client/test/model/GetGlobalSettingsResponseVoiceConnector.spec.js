...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetGlobalSettingsResponseVoiceConnector();
  });
  ...
  describe('GetGlobalSettingsResponseVoiceConnector', function() {
    it('should create an instance of GetGlobalSettingsResponseVoiceConnector', function() {
      // uncomment below and update the code to test GetGlobalSettingsResponseVoiceConnector
      //var instance = new AmazonChime.GetGlobalSettingsResponseVoiceConnector();
      //expect(instance).to.be.a(AmazonChime.GetGlobalSettingsResponseVoiceConnector);
    });
