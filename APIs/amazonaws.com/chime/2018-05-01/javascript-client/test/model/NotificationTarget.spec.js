...
(function(root, factory) {
  ...
  describe('NotificationTarget', function() {
    it('should create an instance of NotificationTarget', function() {
      // uncomment below and update the code to test NotificationTarget
      //var instance = new AmazonChime.NotificationTarget();
      //expect(instance).to.be.a(AmazonChime.NotificationTarget);
    });
