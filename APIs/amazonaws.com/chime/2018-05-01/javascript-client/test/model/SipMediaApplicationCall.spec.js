...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipMediaApplicationCall();
  });
  ...
  describe('SipMediaApplicationCall', function() {
    it('should create an instance of SipMediaApplicationCall', function() {
      // uncomment below and update the code to test SipMediaApplicationCall
      //var instance = new AmazonChime.SipMediaApplicationCall();
      //expect(instance).to.be.a(AmazonChime.SipMediaApplicationCall);
    });
