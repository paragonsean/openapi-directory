...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.Invite();
  });
  ...
  describe('Invite', function() {
    it('should create an instance of Invite', function() {
      ...
      //var instance = new AmazonChime.Invite();
      //expect(instance).to.be.a(AmazonChime.Invite);
    });

    it('should have the property inviteId (base name: "InviteId")', function() {
    ...
    it('should have the property emailStatus (base name: "EmailStatus")', function() {
