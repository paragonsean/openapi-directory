...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListVoiceConnectorsResponse();
  });
  ...
  describe('ListVoiceConnectorsResponse', function() {
    it('should create an instance of ListVoiceConnectorsResponse', function() {
      // uncomment below and update the code to test ListVoiceConnectorsResponse
      //var instance = new AmazonChime.ListVoiceConnectorsResponse();
      //expect(instance).to.be.a(AmazonChime.ListVoiceConnectorsResponse);
    });

    it('should have the property voiceConnectors (base name: "VoiceConnectors")', function() {
      // uncomment below and update the code to test the property voiceConnectors
      //var instance = new AmazonChime.ListVoiceConnectorsResponse();
