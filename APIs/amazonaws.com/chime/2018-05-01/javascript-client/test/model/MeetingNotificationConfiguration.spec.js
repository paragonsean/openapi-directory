...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.MeetingNotificationConfiguration();
  });
  ...
  describe('MeetingNotificationConfiguration', function() {
    it('should create an instance of MeetingNotificationConfiguration', function() {
      // uncomment below and update the code to test MeetingNotificationConfiguration
      //var instance = new AmazonChime.MeetingNotificationConfiguration();
      //expect(instance).to.be.a(AmazonChime.MeetingNotificationConfiguration);
    });
