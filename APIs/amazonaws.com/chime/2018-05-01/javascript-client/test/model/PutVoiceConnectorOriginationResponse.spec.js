...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorOriginationResponse();
  });
  ...
  describe('PutVoiceConnectorOriginationResponse', function() {
    it('should create an instance of PutVoiceConnectorOriginationResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorOriginationResponse
      //var instance = new AmazonChime.PutVoiceConnectorOriginationResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorOriginationResponse);
    });
