...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutAppInstanceRetentionSettingsRequest();
  });
  ...
  describe('PutAppInstanceRetentionSettingsRequest', function() {
    it('should create an instance of PutAppInstanceRetentionSettingsRequest', function() {
      // uncomment below and update the code to test PutAppInstanceRetentionSettingsRequest
      //var instance = new AmazonChime.PutAppInstanceRetentionSettingsRequest();
      //expect(instance).to.be.a(AmazonChime.PutAppInstanceRetentionSettingsRequest);
    });
