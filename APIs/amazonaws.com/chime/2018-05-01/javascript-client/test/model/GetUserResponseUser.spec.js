...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetUserResponseUser();
  });
  ...
  describe('GetUserResponseUser', function() {
    it('should create an instance of GetUserResponseUser', function() {
      // uncomment below and update the code to test GetUserResponseUser
      //var instance = new AmazonChime.GetUserResponseUser();
      //expect(instance).to.be.a(AmazonChime.GetUserResponseUser);
    });
