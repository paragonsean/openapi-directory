...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorTerminationRequest();
  });
  ...
  describe('PutVoiceConnectorTerminationRequest', function() {
    it('should create an instance of PutVoiceConnectorTerminationRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorTerminationRequest
      //var instance = new AmazonChime.PutVoiceConnectorTerminationRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorTerminationRequest);
    });
