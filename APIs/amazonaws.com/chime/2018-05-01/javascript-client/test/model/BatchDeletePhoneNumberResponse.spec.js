...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchDeletePhoneNumberResponse();
  });
  ...
  describe('BatchDeletePhoneNumberResponse', function() {
    it('should create an instance of BatchDeletePhoneNumberResponse', function() {
      // uncomment below and update the code to test BatchDeletePhoneNumberResponse
      //var instance = new AmazonChime.BatchDeletePhoneNumberResponse();
      //expect(instance).to.be.a(AmazonChime.BatchDeletePhoneNumberResponse);
    });
