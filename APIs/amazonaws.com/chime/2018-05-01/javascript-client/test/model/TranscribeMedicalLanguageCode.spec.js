...
(function(root, factory) {
  ...
  describe('TranscribeMedicalLanguageCode', function() {
    it('should create an instance of TranscribeMedicalLanguageCode', function() {
      // uncomment below and update the code to test TranscribeMedicalLanguageCode
      //var instance = new AmazonChime.TranscribeMedicalLanguageCode();
      //expect(instance).to.be.a(AmazonChime.TranscribeMedicalLanguageCode);
    });
