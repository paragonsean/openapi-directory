...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAttendeeRequest();
  });
  ...
  describe('CreateAttendeeRequest', function() {
    it('should create an instance of CreateAttendeeRequest', function() {
      // uncomment below and update the code to test CreateAttendeeRequest
      //var instance = new AmazonChime.CreateAttendeeRequest();
      //expect(instance).to.be.a(AmazonChime.CreateAttendeeRequest);
    });

    it('should have the property externalUserId (base name: "ExternalUserId")', function() {
