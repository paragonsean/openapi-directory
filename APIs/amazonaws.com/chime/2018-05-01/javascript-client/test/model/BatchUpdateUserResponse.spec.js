...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUpdateUserResponse();
  });
  ...
  describe('BatchUpdateUserResponse', function() {
    it('should create an instance of BatchUpdateUserResponse', function() {
      // uncomment below and update the code to test BatchUpdateUserResponse
      //var instance = new AmazonChime.BatchUpdateUserResponse();
      //expect(instance).to.be.a(AmazonChime.BatchUpdateUserResponse);
    });
