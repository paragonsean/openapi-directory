...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMessageSummary();
  });
  ...
  describe('ChannelMessageSummary', function() {
    it('should create an instance of ChannelMessageSummary', function() {
      ...
      //var instance = new AmazonChime.ChannelMessageSummary();
      //expect(instance).to.be.a(AmazonChime.ChannelMessageSummary);
    });
