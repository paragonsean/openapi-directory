...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorOriginationRequestOrigination();
  });
  ...
  describe('PutVoiceConnectorOriginationRequestOrigination', function() {
    it('should create an instance of PutVoiceConnectorOriginationRequestOrigination', function() {
      // uncomment below and update the code to test PutVoiceConnectorOriginationRequestOrigination
      //var instance = new AmazonChime.PutVoiceConnectorOriginationRequestOrigination();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorOriginationRequestOrigination);
    });
