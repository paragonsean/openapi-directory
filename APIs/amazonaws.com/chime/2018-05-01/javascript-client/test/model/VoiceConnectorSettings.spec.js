...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.VoiceConnectorSettings();
  });
  ...
  describe('VoiceConnectorSettings', function() {
    it('should create an instance of VoiceConnectorSettings', function() {
      // uncomment below and update the code to test VoiceConnectorSettings
      //var instance = new AmazonChime.VoiceConnectorSettings();
      //expect(instance).to.be.a(AmazonChime.VoiceConnectorSettings);
    });
