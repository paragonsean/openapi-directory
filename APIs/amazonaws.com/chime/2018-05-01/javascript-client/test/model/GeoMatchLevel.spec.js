...
(function(root, factory) {
  ...
  describe('GeoMatchLevel', function() {
    it('should create an instance of GeoMatchLevel', function() {
      // uncomment below and update the code to test GeoMatchLevel
      //var instance = new AmazonChime.GeoMatchLevel();
      //expect(instance).to.be.a(AmazonChime.GeoMatchLevel);
    });
