...
(function(root, factory) {
  ...
  describe('TranscribePartialResultsStability', function() {
    it('should create an instance of TranscribePartialResultsStability', function() {
      // uncomment below and update the code to test TranscribePartialResultsStability
      //var instance = new AmazonChime.TranscribePartialResultsStability();
      //expect(instance).to.be.a(AmazonChime.TranscribePartialResultsStability);
    });
