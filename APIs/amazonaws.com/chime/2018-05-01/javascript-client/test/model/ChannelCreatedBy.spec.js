...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelCreatedBy();
  });
  ...
  describe('ChannelCreatedBy', function() {
    it('should create an instance of ChannelCreatedBy', function() {
      // uncomment below and update the code to test ChannelCreatedBy
      //var instance = new AmazonChime.ChannelCreatedBy();
      //expect(instance).to.be.a(AmazonChime.ChannelCreatedBy);
    });
