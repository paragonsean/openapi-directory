...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreatePhoneNumberOrderResponse();
  });
  ...
  describe('CreatePhoneNumberOrderResponse', function() {
    it('should create an instance of CreatePhoneNumberOrderResponse', function() {
      // uncomment below and update the code to test CreatePhoneNumberOrderResponse
      //var instance = new AmazonChime.CreatePhoneNumberOrderResponse();
      //expect(instance).to.be.a(AmazonChime.CreatePhoneNumberOrderResponse);
    });

    it('should have the property phoneNumberOrder (base name: "PhoneNumberOrder")', function() {
      // uncomment below and update the code to test the property phoneNumberOrder
      //var instance = new AmazonChime.CreatePhoneNumberOrderResponse();
