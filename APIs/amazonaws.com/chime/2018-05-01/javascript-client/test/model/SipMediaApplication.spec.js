...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipMediaApplication();
  });
  ...
  describe('SipMediaApplication', function() {
    it('should create an instance of SipMediaApplication', function() {
      // uncomment below and update the code to test SipMediaApplication
      //var instance = new AmazonChime.SipMediaApplication();
      //expect(instance).to.be.a(AmazonChime.SipMediaApplication);
    });
