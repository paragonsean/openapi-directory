...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateGlobalSettingsRequestBusinessCalling();
  });
  ...
  describe('UpdateGlobalSettingsRequestBusinessCalling', function() {
    it('should create an instance of UpdateGlobalSettingsRequestBusinessCalling', function() {
      // uncomment below and update the code to test UpdateGlobalSettingsRequestBusinessCalling
      //var instance = new AmazonChime.UpdateGlobalSettingsRequestBusinessCalling();
      //expect(instance).to.be.a(AmazonChime.UpdateGlobalSettingsRequestBusinessCalling);
    });

    it('should have the property cdrBucket (base name: "CdrBucket")', function() {
      // uncomment below and update the code to test the property cdrBucket
      //var instance = new AmazonChime.UpdateGlobalSettingsRequestBusinessCalling();
