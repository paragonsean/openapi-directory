...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUnsuspendUserResponse();
  });
  ...
  describe('BatchUnsuspendUserResponse', function() {
    it('should create an instance of BatchUnsuspendUserResponse', function() {
      // uncomment below and update the code to test BatchUnsuspendUserResponse
      //var instance = new AmazonChime.BatchUnsuspendUserResponse();
      //expect(instance).to.be.a(AmazonChime.BatchUnsuspendUserResponse);
    });

    it('should have the property userErrors (base name: "UserErrors")', function() {
      // uncomment below and update the code to test the property userErrors
      //var instance = new AmazonChime.BatchUnsuspendUserResponse();
