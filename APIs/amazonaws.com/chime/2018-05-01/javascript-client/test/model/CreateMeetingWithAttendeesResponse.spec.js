...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingWithAttendeesResponse();
  });
  ...
  describe('CreateMeetingWithAttendeesResponse', function() {
    it('should create an instance of CreateMeetingWithAttendeesResponse', function() {
      // uncomment below and update the code to test CreateMeetingWithAttendeesResponse
      //var instance = new AmazonChime.CreateMeetingWithAttendeesResponse();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingWithAttendeesResponse);
    });
