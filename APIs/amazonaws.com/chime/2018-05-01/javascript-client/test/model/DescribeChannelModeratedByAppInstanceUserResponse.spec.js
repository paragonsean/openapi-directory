...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelModeratedByAppInstanceUserResponse();
  });
  ...
  describe('DescribeChannelModeratedByAppInstanceUserResponse', function() {
    it('should create an instance of DescribeChannelModeratedByAppInstanceUserResponse', function() {
      ...
      //var instance = new AmazonChime.DescribeChannelModeratedByAppInstanceUserResponse();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelModeratedByAppInstanceUserResponse);
    });
