...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration();
  });
  ...
  describe('PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration', function() {
    it('should create an instance of PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration', function() {
      // uncomment below and update the code to test PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration
      //var instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutSipMediaApplicationLoggingConfigurationRequestSipMediaApplicationLoggingConfiguration);
    });
