...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetSipRuleResponseSipRule();
  });
  ...
  describe('GetSipRuleResponseSipRule', function() {
    it('should create an instance of GetSipRuleResponseSipRule', function() {
      // uncomment below and update the code to test GetSipRuleResponseSipRule
      //var instance = new AmazonChime.GetSipRuleResponseSipRule();
      //expect(instance).to.be.a(AmazonChime.GetSipRuleResponseSipRule);
    });
