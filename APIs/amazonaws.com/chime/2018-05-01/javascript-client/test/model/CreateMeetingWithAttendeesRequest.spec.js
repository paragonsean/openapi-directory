...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingWithAttendeesRequest();
  });
  ...
  describe('CreateMeetingWithAttendeesRequest', function() {
    it('should create an instance of CreateMeetingWithAttendeesRequest', function() {
      // uncomment below and update the code to test CreateMeetingWithAttendeesRequest
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequest();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingWithAttendeesRequest);
    });
    ...
    it('should have the property externalMeetingId (base name: "ExternalMeetingId")', function() {
      // uncomment below and update the code to test the property externalMeetingId
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequest();
      //expect(instance).to.be();
    });

    it('should have the property meetingHostId (base name: "MeetingHostId")', function() {
      // uncomment below and update the code to test the property meetingHostId
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequest();
      //expect(instance).to.be();
    });

    it('should have the property mediaRegion (base name: "MediaRegion")', function() {
    ...
    it('should have the property notificationsConfiguration (base name: "NotificationsConfiguration")', function() {
      // uncomment below and update the code to test the property notificationsConfiguration
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequest();
      //expect(instance).to.be();
    });
