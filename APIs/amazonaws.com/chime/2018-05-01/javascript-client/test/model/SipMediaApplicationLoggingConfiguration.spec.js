...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipMediaApplicationLoggingConfiguration();
  });
  ...
  describe('SipMediaApplicationLoggingConfiguration', function() {
    it('should create an instance of SipMediaApplicationLoggingConfiguration', function() {
      // uncomment below and update the code to test SipMediaApplicationLoggingConfiguration
      //var instance = new AmazonChime.SipMediaApplicationLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.SipMediaApplicationLoggingConfiguration);
    });
