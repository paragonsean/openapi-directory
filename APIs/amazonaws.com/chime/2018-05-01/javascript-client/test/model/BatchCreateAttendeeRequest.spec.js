...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateAttendeeRequest();
  });
  ...
  describe('BatchCreateAttendeeRequest', function() {
    it('should create an instance of BatchCreateAttendeeRequest', function() {
      // uncomment below and update the code to test BatchCreateAttendeeRequest
      //var instance = new AmazonChime.BatchCreateAttendeeRequest();
      //expect(instance).to.be.a(AmazonChime.BatchCreateAttendeeRequest);
    });
