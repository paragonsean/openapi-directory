...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateSipRuleRequest();
  });
  ...
  describe('CreateSipRuleRequest', function() {
    it('should create an instance of CreateSipRuleRequest', function() {
      // uncomment below and update the code to test CreateSipRuleRequest
      //var instance = new AmazonChime.CreateSipRuleRequest();
      //expect(instance).to.be.a(AmazonChime.CreateSipRuleRequest);
    });
