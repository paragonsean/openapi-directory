...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAttendeeResponse();
  });
  ...
  describe('CreateAttendeeResponse', function() {
    it('should create an instance of CreateAttendeeResponse', function() {
      // uncomment below and update the code to test CreateAttendeeResponse
      //var instance = new AmazonChime.CreateAttendeeResponse();
      //expect(instance).to.be.a(AmazonChime.CreateAttendeeResponse);
    });
