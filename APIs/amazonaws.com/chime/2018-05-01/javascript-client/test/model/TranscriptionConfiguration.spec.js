...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.TranscriptionConfiguration();
  });
  ...
  describe('TranscriptionConfiguration', function() {
    it('should create an instance of TranscriptionConfiguration', function() {
      // uncomment below and update the code to test TranscriptionConfiguration
      //var instance = new AmazonChime.TranscriptionConfiguration();
      //expect(instance).to.be.a(AmazonChime.TranscriptionConfiguration);
    });

    it('should have the property engineTranscribeSettings (base name: "EngineTranscribeSettings")', function() {
      // uncomment below and update the code to test the property engineTranscribeSettings
      //var instance = new AmazonChime.TranscriptionConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property engineTranscribeMedicalSettings (base name: "EngineTranscribeMedicalSettings")', function() {
      // uncomment below and update the code to test the property engineTranscribeMedicalSettings
      //var instance = new AmazonChime.TranscriptionConfiguration();
      //expect(instance).to.be();
    });
