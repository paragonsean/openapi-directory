...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StreamingNotificationTarget();
  });
  ...
  describe('StreamingNotificationTarget', function() {
    it('should create an instance of StreamingNotificationTarget', function() {
      // uncomment below and update the code to test StreamingNotificationTarget
      //var instance = new AmazonChime.StreamingNotificationTarget();
      //expect(instance).to.be.a(AmazonChime.StreamingNotificationTarget);
    });
