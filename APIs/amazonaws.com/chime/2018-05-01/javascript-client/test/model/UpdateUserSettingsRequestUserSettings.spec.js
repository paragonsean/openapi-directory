...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserSettingsRequestUserSettings();
  });
  ...
  describe('UpdateUserSettingsRequestUserSettings', function() {
    it('should create an instance of UpdateUserSettingsRequestUserSettings', function() {
      // uncomment below and update the code to test UpdateUserSettingsRequestUserSettings
      //var instance = new AmazonChime.UpdateUserSettingsRequestUserSettings();
      //expect(instance).to.be.a(AmazonChime.UpdateUserSettingsRequestUserSettings);
    });

    it('should have the property telephony (base name: "Telephony")', function() {
      // uncomment below and update the code to test the property telephony
      //var instance = new AmazonChime.UpdateUserSettingsRequestUserSettings();
