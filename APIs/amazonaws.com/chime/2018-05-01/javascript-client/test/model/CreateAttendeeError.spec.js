...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAttendeeError();
  });
  ...
  describe('CreateAttendeeError', function() {
    it('should create an instance of CreateAttendeeError', function() {
      // uncomment below and update the code to test CreateAttendeeError
      //var instance = new AmazonChime.CreateAttendeeError();
      //expect(instance).to.be.a(AmazonChime.CreateAttendeeError);
    });
