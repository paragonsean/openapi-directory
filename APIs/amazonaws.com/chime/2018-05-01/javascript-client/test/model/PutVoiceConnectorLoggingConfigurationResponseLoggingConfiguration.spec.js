...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
  });
  ...
  describe('PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration', function() {
    it('should create an instance of PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration', function() {
      // uncomment below and update the code to test PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration);
    });

    it('should have the property enableSIPLogs (base name: "EnableSIPLogs")', function() {
      // uncomment below and update the code to test the property enableSIPLogs
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property enableMediaMetricLogs (base name: "EnableMediaMetricLogs")', function() {
      // uncomment below and update the code to test the property enableMediaMetricLogs
      //var instance = new AmazonChime.PutVoiceConnectorLoggingConfigurationResponseLoggingConfiguration();
      //expect(instance).to.be();
    });
