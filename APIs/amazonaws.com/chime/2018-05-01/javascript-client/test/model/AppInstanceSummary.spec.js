...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceSummary();
  });
  ...
  describe('AppInstanceSummary', function() {
    it('should create an instance of AppInstanceSummary', function() {
      // uncomment below and update the code to test AppInstanceSummary
      //var instance = new AmazonChime.AppInstanceSummary();
      //expect(instance).to.be.a(AmazonChime.AppInstanceSummary);
    });
