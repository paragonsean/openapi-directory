...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.TerminationHealth();
  });
  ...
  describe('TerminationHealth', function() {
    it('should create an instance of TerminationHealth', function() {
      // uncomment below and update the code to test TerminationHealth
      //var instance = new AmazonChime.TerminationHealth();
      //expect(instance).to.be.a(AmazonChime.TerminationHealth);
    });
