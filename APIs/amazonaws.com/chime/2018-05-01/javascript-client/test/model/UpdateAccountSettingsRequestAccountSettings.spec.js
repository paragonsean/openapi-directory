...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateAccountSettingsRequestAccountSettings();
  });
  ...
  describe('UpdateAccountSettingsRequestAccountSettings', function() {
    it('should create an instance of UpdateAccountSettingsRequestAccountSettings', function() {
      // uncomment below and update the code to test UpdateAccountSettingsRequestAccountSettings
      //var instance = new AmazonChime.UpdateAccountSettingsRequestAccountSettings();
      //expect(instance).to.be.a(AmazonChime.UpdateAccountSettingsRequestAccountSettings);
    });

    it('should have the property disableRemoteControl (base name: "DisableRemoteControl")', function() {
      // uncomment below and update the code to test the property disableRemoteControl
      //var instance = new AmazonChime.UpdateAccountSettingsRequestAccountSettings();
      //expect(instance).to.be();
    });

    it('should have the property enableDialOut (base name: "EnableDialOut")', function() {
      // uncomment below and update the code to test the property enableDialOut
      //var instance = new AmazonChime.UpdateAccountSettingsRequestAccountSettings();
      //expect(instance).to.be();
    });
