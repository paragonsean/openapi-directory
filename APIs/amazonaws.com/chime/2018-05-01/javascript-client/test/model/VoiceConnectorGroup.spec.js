...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.VoiceConnectorGroup();
  });
  ...
  describe('VoiceConnectorGroup', function() {
    it('should create an instance of VoiceConnectorGroup', function() {
      // uncomment below and update the code to test VoiceConnectorGroup
      //var instance = new AmazonChime.VoiceConnectorGroup();
      //expect(instance).to.be.a(AmazonChime.VoiceConnectorGroup);
    });
