...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ValidateE911AddressResponseAddress();
  });
  ...
  describe('ValidateE911AddressResponseAddress', function() {
    it('should create an instance of ValidateE911AddressResponseAddress', function() {
      // uncomment below and update the code to test ValidateE911AddressResponseAddress
      //var instance = new AmazonChime.ValidateE911AddressResponseAddress();
      //expect(instance).to.be.a(AmazonChime.ValidateE911AddressResponseAddress);
    });
