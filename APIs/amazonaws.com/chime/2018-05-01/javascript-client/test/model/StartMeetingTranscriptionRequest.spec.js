...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StartMeetingTranscriptionRequest();
  });
  ...
  describe('StartMeetingTranscriptionRequest', function() {
    it('should create an instance of StartMeetingTranscriptionRequest', function() {
      // uncomment below and update the code to test StartMeetingTranscriptionRequest
      //var instance = new AmazonChime.StartMeetingTranscriptionRequest();
      //expect(instance).to.be.a(AmazonChime.StartMeetingTranscriptionRequest);
    });

    it('should have the property transcriptionConfiguration (base name: "TranscriptionConfiguration")', function() {
      // uncomment below and update the code to test the property transcriptionConfiguration
      //var instance = new AmazonChime.StartMeetingTranscriptionRequest();
