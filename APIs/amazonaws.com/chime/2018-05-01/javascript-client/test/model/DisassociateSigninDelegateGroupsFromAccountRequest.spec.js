...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DisassociateSigninDelegateGroupsFromAccountRequest();
  });
  ...
  describe('DisassociateSigninDelegateGroupsFromAccountRequest', function() {
    it('should create an instance of DisassociateSigninDelegateGroupsFromAccountRequest', function() {
      // uncomment below and update the code to test DisassociateSigninDelegateGroupsFromAccountRequest
      //var instance = new AmazonChime.DisassociateSigninDelegateGroupsFromAccountRequest();
      //expect(instance).to.be.a(AmazonChime.DisassociateSigninDelegateGroupsFromAccountRequest);
    });
