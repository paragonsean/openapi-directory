...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationRequest();
  });
  ...
  describe('PutVoiceConnectorStreamingConfigurationRequest', function() {
    it('should create an instance of PutVoiceConnectorStreamingConfigurationRequest', function() {
      // uncomment below and update the code to test PutVoiceConnectorStreamingConfigurationRequest
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationRequest();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorStreamingConfigurationRequest);
    });
