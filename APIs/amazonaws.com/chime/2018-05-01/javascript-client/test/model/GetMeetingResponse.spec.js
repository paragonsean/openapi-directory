...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetMeetingResponse();
  });
  ...
  describe('GetMeetingResponse', function() {
    it('should create an instance of GetMeetingResponse', function() {
      // uncomment below and update the code to test GetMeetingResponse
      //var instance = new AmazonChime.GetMeetingResponse();
      //expect(instance).to.be.a(AmazonChime.GetMeetingResponse);
    });
