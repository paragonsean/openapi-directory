...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutEventsConfigurationResponseEventsConfiguration();
  });
  ...
  describe('PutEventsConfigurationResponseEventsConfiguration', function() {
    it('should create an instance of PutEventsConfigurationResponseEventsConfiguration', function() {
      // uncomment below and update the code to test PutEventsConfigurationResponseEventsConfiguration
      //var instance = new AmazonChime.PutEventsConfigurationResponseEventsConfiguration();
      //expect(instance).to.be.a(AmazonChime.PutEventsConfigurationResponseEventsConfiguration);
    });
