...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetMeetingResponseMeeting();
  });
  ...
  describe('GetMeetingResponseMeeting', function() {
    it('should create an instance of GetMeetingResponseMeeting', function() {
      // uncomment below and update the code to test GetMeetingResponseMeeting
      //var instance = new AmazonChime.GetMeetingResponseMeeting();
      //expect(instance).to.be.a(AmazonChime.GetMeetingResponseMeeting);
    });
