...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration();
  });
  ...
  describe('CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration', function() {
    it('should create an instance of CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration', function() {
      // uncomment below and update the code to test CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration
      //var instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration();
      //expect(instance).to.be.a(AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationArtifactsConfiguration);
    });
