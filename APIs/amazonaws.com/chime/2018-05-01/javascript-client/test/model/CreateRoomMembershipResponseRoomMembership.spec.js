...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateRoomMembershipResponseRoomMembership();
  });
  ...
  describe('CreateRoomMembershipResponseRoomMembership', function() {
    it('should create an instance of CreateRoomMembershipResponseRoomMembership', function() {
      // uncomment below and update the code to test CreateRoomMembershipResponseRoomMembership
      //var instance = new AmazonChime.CreateRoomMembershipResponseRoomMembership();
      //expect(instance).to.be.a(AmazonChime.CreateRoomMembershipResponseRoomMembership);
    });
