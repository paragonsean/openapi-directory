...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateRoomMembershipResponse();
  });
  ...
  describe('CreateRoomMembershipResponse', function() {
    it('should create an instance of CreateRoomMembershipResponse', function() {
      // uncomment below and update the code to test CreateRoomMembershipResponse
      //var instance = new AmazonChime.CreateRoomMembershipResponse();
      //expect(instance).to.be.a(AmazonChime.CreateRoomMembershipResponse);
    });

    it('should have the property roomMembership (base name: "RoomMembership")', function() {
      // uncomment below and update the code to test the property roomMembership
      //var instance = new AmazonChime.CreateRoomMembershipResponse();
