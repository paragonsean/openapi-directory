...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserRequestItem();
  });
  ...
  describe('UpdateUserRequestItem', function() {
    it('should create an instance of UpdateUserRequestItem', function() {
      // uncomment below and update the code to test UpdateUserRequestItem
      //var instance = new AmazonChime.UpdateUserRequestItem();
      //expect(instance).to.be.a(AmazonChime.UpdateUserRequestItem);
    });
