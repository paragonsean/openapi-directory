...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdatePhoneNumberRequestItem();
  });
  ...
  describe('UpdatePhoneNumberRequestItem', function() {
    it('should create an instance of UpdatePhoneNumberRequestItem', function() {
      // uncomment below and update the code to test UpdatePhoneNumberRequestItem
      //var instance = new AmazonChime.UpdatePhoneNumberRequestItem();
      //expect(instance).to.be.a(AmazonChime.UpdatePhoneNumberRequestItem);
    });
