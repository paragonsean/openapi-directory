...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.TelephonySettings();
  });
  ...
  describe('TelephonySettings', function() {
    it('should create an instance of TelephonySettings', function() {
      // uncomment below and update the code to test TelephonySettings
      //var instance = new AmazonChime.TelephonySettings();
      //expect(instance).to.be.a(AmazonChime.TelephonySettings);
    });
