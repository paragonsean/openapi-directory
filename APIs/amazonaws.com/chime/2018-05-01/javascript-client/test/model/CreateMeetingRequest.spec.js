...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingRequest();
  });
  ...
  describe('CreateMeetingRequest', function() {
    it('should create an instance of CreateMeetingRequest', function() {
      // uncomment below and update the code to test CreateMeetingRequest
      //var instance = new AmazonChime.CreateMeetingRequest();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingRequest);
    });
