...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorOriginationResponseOrigination();
  });
  ...
  describe('PutVoiceConnectorOriginationResponseOrigination', function() {
    it('should create an instance of PutVoiceConnectorOriginationResponseOrigination', function() {
      // uncomment below and update the code to test PutVoiceConnectorOriginationResponseOrigination
      //var instance = new AmazonChime.PutVoiceConnectorOriginationResponseOrigination();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorOriginationResponseOrigination);
    });
