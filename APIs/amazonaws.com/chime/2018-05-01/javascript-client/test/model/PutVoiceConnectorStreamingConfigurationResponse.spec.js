...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponse();
  });
  ...
  describe('PutVoiceConnectorStreamingConfigurationResponse', function() {
    it('should create an instance of PutVoiceConnectorStreamingConfigurationResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorStreamingConfigurationResponse
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorStreamingConfigurationResponse);
    });

    it('should have the property streamingConfiguration (base name: "StreamingConfiguration")', function() {
      // uncomment below and update the code to test the property streamingConfiguration
      //var instance = new AmazonChime.PutVoiceConnectorStreamingConfigurationResponse();
