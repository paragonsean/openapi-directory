...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceAdminAdmin();
  });
  ...
  describe('AppInstanceAdminAdmin', function() {
    it('should create an instance of AppInstanceAdminAdmin', function() {
      ...
      //var instance = new AmazonChime.AppInstanceAdminAdmin();
      //expect(instance).to.be.a(AmazonChime.AppInstanceAdminAdmin);
    });
