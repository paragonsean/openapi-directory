...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMembership();
  });
  ...
  describe('ChannelMembership', function() {
    it('should create an instance of ChannelMembership', function() {
      // uncomment below and update the code to test ChannelMembership
      //var instance = new AmazonChime.ChannelMembership();
      //expect(instance).to.be.a(AmazonChime.ChannelMembership);
    });
