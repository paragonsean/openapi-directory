...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateRoomMembershipRequest();
  });
  ...
  describe('BatchCreateRoomMembershipRequest', function() {
    it('should create an instance of BatchCreateRoomMembershipRequest', function() {
      // uncomment below and update the code to test BatchCreateRoomMembershipRequest
      //var instance = new AmazonChime.BatchCreateRoomMembershipRequest();
      //expect(instance).to.be.a(AmazonChime.BatchCreateRoomMembershipRequest);
    });

    it('should have the property membershipItemList (base name: "MembershipItemList")', function() {
      // uncomment below and update the code to test the property membershipItemList
      //var instance = new AmazonChime.BatchCreateRoomMembershipRequest();
