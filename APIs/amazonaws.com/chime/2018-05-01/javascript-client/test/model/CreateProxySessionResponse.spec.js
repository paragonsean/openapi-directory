...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateProxySessionResponse();
  });
  ...
  describe('CreateProxySessionResponse', function() {
    it('should create an instance of CreateProxySessionResponse', function() {
      // uncomment below and update the code to test CreateProxySessionResponse
      //var instance = new AmazonChime.CreateProxySessionResponse();
      //expect(instance).to.be.a(AmazonChime.CreateProxySessionResponse);
    });

    it('should have the property proxySession (base name: "ProxySession")', function() {
      // uncomment below and update the code to test the property proxySession
      //var instance = new AmazonChime.CreateProxySessionResponse();
