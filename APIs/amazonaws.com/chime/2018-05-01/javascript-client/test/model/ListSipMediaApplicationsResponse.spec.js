...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListSipMediaApplicationsResponse();
  });
  ...
  describe('ListSipMediaApplicationsResponse', function() {
    it('should create an instance of ListSipMediaApplicationsResponse', function() {
      // uncomment below and update the code to test ListSipMediaApplicationsResponse
      //var instance = new AmazonChime.ListSipMediaApplicationsResponse();
      //expect(instance).to.be.a(AmazonChime.ListSipMediaApplicationsResponse);
    });

    it('should have the property sipMediaApplications (base name: "SipMediaApplications")', function() {
      // uncomment below and update the code to test the property sipMediaApplications
      //var instance = new AmazonChime.ListSipMediaApplicationsResponse();
