...
(function(root, factory) {
  ...
  describe('PhoneNumberProductType', function() {
    it('should create an instance of PhoneNumberProductType', function() {
      // uncomment below and update the code to test PhoneNumberProductType
      //var instance = new AmazonChime.PhoneNumberProductType();
      //expect(instance).to.be.a(AmazonChime.PhoneNumberProductType);
    });
