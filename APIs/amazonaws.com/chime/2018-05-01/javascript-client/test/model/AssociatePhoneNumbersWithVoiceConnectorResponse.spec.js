...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorResponse();
  });
  ...
  describe('AssociatePhoneNumbersWithVoiceConnectorResponse', function() {
    it('should create an instance of AssociatePhoneNumbersWithVoiceConnectorResponse', function() {
      // uncomment below and update the code to test AssociatePhoneNumbersWithVoiceConnectorResponse
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorResponse();
      //expect(instance).to.be.a(AmazonChime.AssociatePhoneNumbersWithVoiceConnectorResponse);
    });

    it('should have the property phoneNumberErrors (base name: "PhoneNumberErrors")', function() {
      // uncomment below and update the code to test the property phoneNumberErrors
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorResponse();
