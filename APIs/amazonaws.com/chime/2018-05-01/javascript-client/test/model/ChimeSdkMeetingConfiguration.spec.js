...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChimeSdkMeetingConfiguration();
  });
  ...
  describe('ChimeSdkMeetingConfiguration', function() {
    it('should create an instance of ChimeSdkMeetingConfiguration', function() {
      // uncomment below and update the code to test ChimeSdkMeetingConfiguration
      //var instance = new AmazonChime.ChimeSdkMeetingConfiguration();
      //expect(instance).to.be.a(AmazonChime.ChimeSdkMeetingConfiguration);
    });
