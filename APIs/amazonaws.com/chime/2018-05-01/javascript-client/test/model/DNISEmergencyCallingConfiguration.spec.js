...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DNISEmergencyCallingConfiguration();
  });
  ...
  describe('DNISEmergencyCallingConfiguration', function() {
    it('should create an instance of DNISEmergencyCallingConfiguration', function() {
      // uncomment below and update the code to test DNISEmergencyCallingConfiguration
      //var instance = new AmazonChime.DNISEmergencyCallingConfiguration();
      //expect(instance).to.be.a(AmazonChime.DNISEmergencyCallingConfiguration);
    });

    it('should have the property emergencyPhoneNumber (base name: "EmergencyPhoneNumber")', function() {
      // uncomment below and update the code to test the property emergencyPhoneNumber
      //var instance = new AmazonChime.DNISEmergencyCallingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property testPhoneNumber (base name: "TestPhoneNumber")', function() {
      // uncomment below and update the code to test the property testPhoneNumber
      //var instance = new AmazonChime.DNISEmergencyCallingConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property callingCountry (base name: "CallingCountry")', function() {
      // uncomment below and update the code to test the property callingCountry
      //var instance = new AmazonChime.DNISEmergencyCallingConfiguration();
      //expect(instance).to.be();
    });
