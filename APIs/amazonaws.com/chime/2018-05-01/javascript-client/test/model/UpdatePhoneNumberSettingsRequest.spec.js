...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdatePhoneNumberSettingsRequest();
  });
  ...
  describe('UpdatePhoneNumberSettingsRequest', function() {
    it('should create an instance of UpdatePhoneNumberSettingsRequest', function() {
      // uncomment below and update the code to test UpdatePhoneNumberSettingsRequest
      //var instance = new AmazonChime.UpdatePhoneNumberSettingsRequest();
      //expect(instance).to.be.a(AmazonChime.UpdatePhoneNumberSettingsRequest);
    });
