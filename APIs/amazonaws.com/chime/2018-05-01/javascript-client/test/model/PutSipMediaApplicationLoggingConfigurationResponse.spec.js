...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationResponse();
  });
  ...
  describe('PutSipMediaApplicationLoggingConfigurationResponse', function() {
    it('should create an instance of PutSipMediaApplicationLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test PutSipMediaApplicationLoggingConfigurationResponse
      //var instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.PutSipMediaApplicationLoggingConfigurationResponse);
    });
