...
(function(root, factory) {
  ...
  describe('VoiceConnectorAwsRegion', function() {
    it('should create an instance of VoiceConnectorAwsRegion', function() {
      // uncomment below and update the code to test VoiceConnectorAwsRegion
      //var instance = new AmazonChime.VoiceConnectorAwsRegion();
      //expect(instance).to.be.a(AmazonChime.VoiceConnectorAwsRegion);
    });
