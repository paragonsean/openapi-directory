...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListChannelsModeratedByAppInstanceUserResponse();
  });
  ...
  describe('ListChannelsModeratedByAppInstanceUserResponse', function() {
    it('should create an instance of ListChannelsModeratedByAppInstanceUserResponse', function() {
      ...
      //var instance = new AmazonChime.ListChannelsModeratedByAppInstanceUserResponse();
      //expect(instance).to.be.a(AmazonChime.ListChannelsModeratedByAppInstanceUserResponse);
    });
