...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListPhoneNumbersResponse();
  });
  ...
  describe('ListPhoneNumbersResponse', function() {
    it('should create an instance of ListPhoneNumbersResponse', function() {
      // uncomment below and update the code to test ListPhoneNumbersResponse
      //var instance = new AmazonChime.ListPhoneNumbersResponse();
      //expect(instance).to.be.a(AmazonChime.ListPhoneNumbersResponse);
    });
