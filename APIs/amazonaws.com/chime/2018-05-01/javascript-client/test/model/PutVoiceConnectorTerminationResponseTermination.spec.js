...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorTerminationResponseTermination();
  });
  ...
  describe('PutVoiceConnectorTerminationResponseTermination', function() {
    it('should create an instance of PutVoiceConnectorTerminationResponseTermination', function() {
      // uncomment below and update the code to test PutVoiceConnectorTerminationResponseTermination
      //var instance = new AmazonChime.PutVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorTerminationResponseTermination);
    });
