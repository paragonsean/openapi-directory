...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ConversationRetentionSettings();
  });
  ...
  describe('ConversationRetentionSettings', function() {
    it('should create an instance of ConversationRetentionSettings', function() {
      // uncomment below and update the code to test ConversationRetentionSettings
      //var instance = new AmazonChime.ConversationRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.ConversationRetentionSettings);
    });
