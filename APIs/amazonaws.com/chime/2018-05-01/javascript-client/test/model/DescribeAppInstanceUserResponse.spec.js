...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeAppInstanceUserResponse();
  });
  ...
  describe('DescribeAppInstanceUserResponse', function() {
    it('should create an instance of DescribeAppInstanceUserResponse', function() {
      // uncomment below and update the code to test DescribeAppInstanceUserResponse
      //var instance = new AmazonChime.DescribeAppInstanceUserResponse();
      //expect(instance).to.be.a(AmazonChime.DescribeAppInstanceUserResponse);
    });

    it('should have the property appInstanceUser (base name: "AppInstanceUser")', function() {
      // uncomment below and update the code to test the property appInstanceUser
      //var instance = new AmazonChime.DescribeAppInstanceUserResponse();
