...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateAccountRequest();
  });
  ...
  describe('UpdateAccountRequest', function() {
    it('should create an instance of UpdateAccountRequest', function() {
      ...
      //var instance = new AmazonChime.UpdateAccountRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateAccountRequest);
    });
