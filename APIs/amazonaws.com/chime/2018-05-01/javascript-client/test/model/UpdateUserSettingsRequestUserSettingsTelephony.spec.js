...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserSettingsRequestUserSettingsTelephony();
  });
  ...
  describe('UpdateUserSettingsRequestUserSettingsTelephony', function() {
    it('should create an instance of UpdateUserSettingsRequestUserSettingsTelephony', function() {
      // uncomment below and update the code to test UpdateUserSettingsRequestUserSettingsTelephony
      //var instance = new AmazonChime.UpdateUserSettingsRequestUserSettingsTelephony();
      //expect(instance).to.be.a(AmazonChime.UpdateUserSettingsRequestUserSettingsTelephony);
    });

    it('should have the property inboundCalling (base name: "InboundCalling")', function() {
      // uncomment below and update the code to test the property inboundCalling
      //var instance = new AmazonChime.UpdateUserSettingsRequestUserSettingsTelephony();
      //expect(instance).to.be();
    });

    it('should have the property outboundCalling (base name: "OutboundCalling")', function() {
      // uncomment below and update the code to test the property outboundCalling
      //var instance = new AmazonChime.UpdateUserSettingsRequestUserSettingsTelephony();
      //expect(instance).to.be();
    });
