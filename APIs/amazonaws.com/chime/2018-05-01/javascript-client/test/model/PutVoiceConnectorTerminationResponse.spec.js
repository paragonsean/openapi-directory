...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorTerminationResponse();
  });
  ...
  describe('PutVoiceConnectorTerminationResponse', function() {
    it('should create an instance of PutVoiceConnectorTerminationResponse', function() {
      // uncomment below and update the code to test PutVoiceConnectorTerminationResponse
      //var instance = new AmazonChime.PutVoiceConnectorTerminationResponse();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorTerminationResponse);
    });
