...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AppInstanceRetentionSettings();
  });
  ...
  describe('AppInstanceRetentionSettings', function() {
    it('should create an instance of AppInstanceRetentionSettings', function() {
      // uncomment below and update the code to test AppInstanceRetentionSettings
      //var instance = new AmazonChime.AppInstanceRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.AppInstanceRetentionSettings);
    });
