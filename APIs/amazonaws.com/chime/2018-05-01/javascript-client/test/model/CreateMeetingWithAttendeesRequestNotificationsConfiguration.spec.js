...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMeetingWithAttendeesRequestNotificationsConfiguration();
  });
  ...
  describe('CreateMeetingWithAttendeesRequestNotificationsConfiguration', function() {
    it('should create an instance of CreateMeetingWithAttendeesRequestNotificationsConfiguration', function() {
      // uncomment below and update the code to test CreateMeetingWithAttendeesRequestNotificationsConfiguration
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequestNotificationsConfiguration();
      //expect(instance).to.be.a(AmazonChime.CreateMeetingWithAttendeesRequestNotificationsConfiguration);
    });
    ...
    it('should have the property sqsQueueArn (base name: "SqsQueueArn")', function() {
      // uncomment below and update the code to test the property sqsQueueArn
      //var instance = new AmazonChime.CreateMeetingWithAttendeesRequestNotificationsConfiguration();
      //expect(instance).to.be();
    });
