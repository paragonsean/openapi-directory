...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RegenerateSecurityTokenResponse();
  });
  ...
  describe('RegenerateSecurityTokenResponse', function() {
    it('should create an instance of RegenerateSecurityTokenResponse', function() {
      // uncomment below and update the code to test RegenerateSecurityTokenResponse
      //var instance = new AmazonChime.RegenerateSecurityTokenResponse();
      //expect(instance).to.be.a(AmazonChime.RegenerateSecurityTokenResponse);
    });
