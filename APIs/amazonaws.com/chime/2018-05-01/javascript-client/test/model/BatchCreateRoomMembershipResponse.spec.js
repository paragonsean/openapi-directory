...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchCreateRoomMembershipResponse();
  });
  ...
  describe('BatchCreateRoomMembershipResponse', function() {
    it('should create an instance of BatchCreateRoomMembershipResponse', function() {
      // uncomment below and update the code to test BatchCreateRoomMembershipResponse
      //var instance = new AmazonChime.BatchCreateRoomMembershipResponse();
      //expect(instance).to.be.a(AmazonChime.BatchCreateRoomMembershipResponse);
    });
