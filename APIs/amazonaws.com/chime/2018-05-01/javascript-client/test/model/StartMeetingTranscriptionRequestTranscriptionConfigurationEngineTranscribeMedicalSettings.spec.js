...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings();
  });
  ...
  describe('StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings', function() {
    it('should create an instance of StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings', function() {
      // uncomment below and update the code to test StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings
      //var instance = new AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings();
      //expect(instance).to.be.a(AmazonChime.StartMeetingTranscriptionRequestTranscriptionConfigurationEngineTranscribeMedicalSettings);
    });
