...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelModeratorResponseChannelModerator();
  });
  ...
  describe('DescribeChannelModeratorResponseChannelModerator', function() {
    it('should create an instance of DescribeChannelModeratorResponseChannelModerator', function() {
      // uncomment below and update the code to test DescribeChannelModeratorResponseChannelModerator
      //var instance = new AmazonChime.DescribeChannelModeratorResponseChannelModerator();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelModeratorResponseChannelModerator);
    });
