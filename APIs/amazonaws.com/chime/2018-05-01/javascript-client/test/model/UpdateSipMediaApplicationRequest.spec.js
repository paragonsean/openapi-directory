...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationRequest();
  });
  ...
  describe('UpdateSipMediaApplicationRequest', function() {
    it('should create an instance of UpdateSipMediaApplicationRequest', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationRequest
      //var instance = new AmazonChime.UpdateSipMediaApplicationRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationRequest);
    });
