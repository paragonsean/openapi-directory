...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse();
  });
  ...
  describe('DisassociatePhoneNumbersFromVoiceConnectorGroupResponse', function() {
    it('should create an instance of DisassociatePhoneNumbersFromVoiceConnectorGroupResponse', function() {
      // uncomment below and update the code to test DisassociatePhoneNumbersFromVoiceConnectorGroupResponse
      //var instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse();
      //expect(instance).to.be.a(AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse);
    });
