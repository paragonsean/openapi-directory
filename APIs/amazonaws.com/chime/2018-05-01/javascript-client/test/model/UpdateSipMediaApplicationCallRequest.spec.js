...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationCallRequest();
  });
  ...
  describe('UpdateSipMediaApplicationCallRequest', function() {
    it('should create an instance of UpdateSipMediaApplicationCallRequest', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationCallRequest
      //var instance = new AmazonChime.UpdateSipMediaApplicationCallRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationCallRequest);
    });
