...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeAppInstanceResponseAppInstance();
  });
  ...
  describe('DescribeAppInstanceResponseAppInstance', function() {
    it('should create an instance of DescribeAppInstanceResponseAppInstance', function() {
      ...
      //var instance = new AmazonChime.DescribeAppInstanceResponseAppInstance();
      //expect(instance).to.be.a(AmazonChime.DescribeAppInstanceResponseAppInstance);
    });
