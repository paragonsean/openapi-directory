...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutRetentionSettingsResponse();
  });
  ...
  describe('PutRetentionSettingsResponse', function() {
    it('should create an instance of PutRetentionSettingsResponse', function() {
      // uncomment below and update the code to test PutRetentionSettingsResponse
      //var instance = new AmazonChime.PutRetentionSettingsResponse();
      //expect(instance).to.be.a(AmazonChime.PutRetentionSettingsResponse);
    });
