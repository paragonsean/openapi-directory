...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateVoiceConnectorResponse();
  });
  ...
  describe('UpdateVoiceConnectorResponse', function() {
    it('should create an instance of UpdateVoiceConnectorResponse', function() {
      // uncomment below and update the code to test UpdateVoiceConnectorResponse
      //var instance = new AmazonChime.UpdateVoiceConnectorResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateVoiceConnectorResponse);
    });
