...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateVoiceConnectorGroupResponse();
  });
  ...
  describe('CreateVoiceConnectorGroupResponse', function() {
    it('should create an instance of CreateVoiceConnectorGroupResponse', function() {
      // uncomment below and update the code to test CreateVoiceConnectorGroupResponse
      //var instance = new AmazonChime.CreateVoiceConnectorGroupResponse();
      //expect(instance).to.be.a(AmazonChime.CreateVoiceConnectorGroupResponse);
    });
