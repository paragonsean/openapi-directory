...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration();
  });
  ...
  describe('CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration', function() {
    it('should create an instance of CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration', function() {
      // uncomment below and update the code to test CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration
      //var instance = new AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration();
      //expect(instance).to.be.a(AmazonChime.CreateMediaCapturePipelineRequestChimeSdkMeetingConfigurationSourceConfiguration);
    });
