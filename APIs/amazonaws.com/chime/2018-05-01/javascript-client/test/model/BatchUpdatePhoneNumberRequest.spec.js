...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUpdatePhoneNumberRequest();
  });
  ...
  describe('BatchUpdatePhoneNumberRequest', function() {
    it('should create an instance of BatchUpdatePhoneNumberRequest', function() {
      // uncomment below and update the code to test BatchUpdatePhoneNumberRequest
      //var instance = new AmazonChime.BatchUpdatePhoneNumberRequest();
      //expect(instance).to.be.a(AmazonChime.BatchUpdatePhoneNumberRequest);
    });

    it('should have the property updatePhoneNumberRequestItems (base name: "UpdatePhoneNumberRequestItems")', function() {
      // uncomment below and update the code to test the property updatePhoneNumberRequestItems
      //var instance = new AmazonChime.BatchUpdatePhoneNumberRequest();
