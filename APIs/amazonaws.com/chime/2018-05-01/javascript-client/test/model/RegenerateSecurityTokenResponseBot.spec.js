...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.RegenerateSecurityTokenResponseBot();
  });
  ...
  describe('RegenerateSecurityTokenResponseBot', function() {
    it('should create an instance of RegenerateSecurityTokenResponseBot', function() {
      // uncomment below and update the code to test RegenerateSecurityTokenResponseBot
      //var instance = new AmazonChime.RegenerateSecurityTokenResponseBot();
      //expect(instance).to.be.a(AmazonChime.RegenerateSecurityTokenResponseBot);
    });
