...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateAppInstanceResponse();
  });
  ...
  describe('CreateAppInstanceResponse', function() {
    it('should create an instance of CreateAppInstanceResponse', function() {
      // uncomment below and update the code to test CreateAppInstanceResponse
      //var instance = new AmazonChime.CreateAppInstanceResponse();
      //expect(instance).to.be.a(AmazonChime.CreateAppInstanceResponse);
    });
