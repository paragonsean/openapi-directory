...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetPhoneNumberOrderResponse();
  });
  ...
  describe('GetPhoneNumberOrderResponse', function() {
    it('should create an instance of GetPhoneNumberOrderResponse', function() {
      // uncomment below and update the code to test GetPhoneNumberOrderResponse
      //var instance = new AmazonChime.GetPhoneNumberOrderResponse();
      //expect(instance).to.be.a(AmazonChime.GetPhoneNumberOrderResponse);
    });
