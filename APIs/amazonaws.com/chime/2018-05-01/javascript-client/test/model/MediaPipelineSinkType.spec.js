...
(function(root, factory) {
  ...
  describe('MediaPipelineSinkType', function() {
    it('should create an instance of MediaPipelineSinkType', function() {
      // uncomment below and update the code to test MediaPipelineSinkType
      //var instance = new AmazonChime.MediaPipelineSinkType();
      //expect(instance).to.be.a(AmazonChime.MediaPipelineSinkType);
    });
