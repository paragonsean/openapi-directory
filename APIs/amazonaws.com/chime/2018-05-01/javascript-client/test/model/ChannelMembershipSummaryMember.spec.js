...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMembershipSummaryMember();
  });
  ...
  describe('ChannelMembershipSummaryMember', function() {
    it('should create an instance of ChannelMembershipSummaryMember', function() {
      // uncomment below and update the code to test ChannelMembershipSummaryMember
      //var instance = new AmazonChime.ChannelMembershipSummaryMember();
      //expect(instance).to.be.a(AmazonChime.ChannelMembershipSummaryMember);
    });
