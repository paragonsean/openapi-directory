...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
  });
  ...
  describe('GetVoiceConnectorTerminationResponseTermination', function() {
    it('should create an instance of GetVoiceConnectorTerminationResponseTermination', function() {
      // uncomment below and update the code to test GetVoiceConnectorTerminationResponseTermination
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorTerminationResponseTermination);
    });

    it('should have the property cpsLimit (base name: "CpsLimit")', function() {
      // uncomment below and update the code to test the property cpsLimit
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be();
    });

    it('should have the property defaultPhoneNumber (base name: "DefaultPhoneNumber")', function() {
      // uncomment below and update the code to test the property defaultPhoneNumber
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be();
    });

    it('should have the property callingRegions (base name: "CallingRegions")', function() {
      // uncomment below and update the code to test the property callingRegions
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be();
    });

    it('should have the property cidrAllowedList (base name: "CidrAllowedList")', function() {
      // uncomment below and update the code to test the property cidrAllowedList
      //var instance = new AmazonChime.GetVoiceConnectorTerminationResponseTermination();
      //expect(instance).to.be();
    });
