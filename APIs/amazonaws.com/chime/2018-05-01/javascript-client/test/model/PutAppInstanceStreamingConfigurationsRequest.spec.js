...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutAppInstanceStreamingConfigurationsRequest();
  });
  ...
  describe('PutAppInstanceStreamingConfigurationsRequest', function() {
    it('should create an instance of PutAppInstanceStreamingConfigurationsRequest', function() {
      // uncomment below and update the code to test PutAppInstanceStreamingConfigurationsRequest
      //var instance = new AmazonChime.PutAppInstanceStreamingConfigurationsRequest();
      //expect(instance).to.be.a(AmazonChime.PutAppInstanceStreamingConfigurationsRequest);
    });
