...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
  });
  ...
  describe('AssociatePhoneNumbersWithVoiceConnectorGroupRequest', function() {
    it('should create an instance of AssociatePhoneNumbersWithVoiceConnectorGroupRequest', function() {
      // uncomment below and update the code to test AssociatePhoneNumbersWithVoiceConnectorGroupRequest
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
      //expect(instance).to.be.a(AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupRequest);
    });

    it('should have the property e164PhoneNumbers (base name: "E164PhoneNumbers")', function() {
      // uncomment below and update the code to test the property e164PhoneNumbers
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
      //expect(instance).to.be();
    });

    it('should have the property forceAssociate (base name: "ForceAssociate")', function() {
      // uncomment below and update the code to test the property forceAssociate
      //var instance = new AmazonChime.AssociatePhoneNumbersWithVoiceConnectorGroupRequest();
      //expect(instance).to.be();
    });
