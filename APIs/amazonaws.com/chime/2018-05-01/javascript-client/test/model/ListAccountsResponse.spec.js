...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListAccountsResponse();
  });
  ...
  describe('ListAccountsResponse', function() {
    it('should create an instance of ListAccountsResponse', function() {
      ...
      //var instance = new AmazonChime.ListAccountsResponse();
      //expect(instance).to.be.a(AmazonChime.ListAccountsResponse);
    });
