...
(function(root, factory) {
  ...
  describe('TranscribeRegion', function() {
    it('should create an instance of TranscribeRegion', function() {
      // uncomment below and update the code to test TranscribeRegion
      //var instance = new AmazonChime.TranscribeRegion();
      //expect(instance).to.be.a(AmazonChime.TranscribeRegion);
    });
