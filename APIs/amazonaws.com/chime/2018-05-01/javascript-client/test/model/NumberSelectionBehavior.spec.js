...
(function(root, factory) {
  ...
  describe('NumberSelectionBehavior', function() {
    it('should create an instance of NumberSelectionBehavior', function() {
      // uncomment below and update the code to test NumberSelectionBehavior
      //var instance = new AmazonChime.NumberSelectionBehavior();
      //expect(instance).to.be.a(AmazonChime.NumberSelectionBehavior);
    });
