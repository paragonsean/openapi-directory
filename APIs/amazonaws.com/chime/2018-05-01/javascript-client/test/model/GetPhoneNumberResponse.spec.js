...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetPhoneNumberResponse();
  });
  ...
  describe('GetPhoneNumberResponse', function() {
    it('should create an instance of GetPhoneNumberResponse', function() {
      // uncomment below and update the code to test GetPhoneNumberResponse
      //var instance = new AmazonChime.GetPhoneNumberResponse();
      //expect(instance).to.be.a(AmazonChime.GetPhoneNumberResponse);
    });
