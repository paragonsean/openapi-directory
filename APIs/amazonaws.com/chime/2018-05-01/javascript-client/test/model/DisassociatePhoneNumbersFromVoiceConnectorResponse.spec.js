...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorResponse();
  });
  ...
  describe('DisassociatePhoneNumbersFromVoiceConnectorResponse', function() {
    it('should create an instance of DisassociatePhoneNumbersFromVoiceConnectorResponse', function() {
      // uncomment below and update the code to test DisassociatePhoneNumbersFromVoiceConnectorResponse
      //var instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorResponse();
      //expect(instance).to.be.a(AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorResponse);
    });
