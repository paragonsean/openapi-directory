...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.StreamingConfiguration();
  });
  ...
  describe('StreamingConfiguration', function() {
    it('should create an instance of StreamingConfiguration', function() {
      // uncomment below and update the code to test StreamingConfiguration
      //var instance = new AmazonChime.StreamingConfiguration();
      //expect(instance).to.be.a(AmazonChime.StreamingConfiguration);
    });
