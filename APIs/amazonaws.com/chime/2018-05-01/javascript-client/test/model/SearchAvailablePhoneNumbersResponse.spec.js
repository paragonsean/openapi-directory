...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SearchAvailablePhoneNumbersResponse();
  });
  ...
  describe('SearchAvailablePhoneNumbersResponse', function() {
    it('should create an instance of SearchAvailablePhoneNumbersResponse', function() {
      // uncomment below and update the code to test SearchAvailablePhoneNumbersResponse
      //var instance = new AmazonChime.SearchAvailablePhoneNumbersResponse();
      //expect(instance).to.be.a(AmazonChime.SearchAvailablePhoneNumbersResponse);
    });
