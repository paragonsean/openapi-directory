...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorLoggingConfigurationResponse();
  });
  ...
  describe('GetVoiceConnectorLoggingConfigurationResponse', function() {
    it('should create an instance of GetVoiceConnectorLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorLoggingConfigurationResponse
      //var instance = new AmazonChime.GetVoiceConnectorLoggingConfigurationResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorLoggingConfigurationResponse);
    });
