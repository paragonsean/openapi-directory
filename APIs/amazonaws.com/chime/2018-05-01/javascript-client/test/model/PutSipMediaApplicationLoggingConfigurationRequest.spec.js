...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationRequest();
  });
  ...
  describe('PutSipMediaApplicationLoggingConfigurationRequest', function() {
    it('should create an instance of PutSipMediaApplicationLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test PutSipMediaApplicationLoggingConfigurationRequest
      //var instance = new AmazonChime.PutSipMediaApplicationLoggingConfigurationRequest();
      //expect(instance).to.be.a(AmazonChime.PutSipMediaApplicationLoggingConfigurationRequest);
    });
