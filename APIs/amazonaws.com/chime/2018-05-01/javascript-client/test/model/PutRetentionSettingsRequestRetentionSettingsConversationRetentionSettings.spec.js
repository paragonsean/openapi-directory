...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings();
  });
  ...
  describe('PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings', function() {
    it('should create an instance of PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings', function() {
      // uncomment below and update the code to test PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings
      //var instance = new AmazonChime.PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.PutRetentionSettingsRequestRetentionSettingsConversationRetentionSettings);
    });
