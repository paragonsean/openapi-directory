...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SipMediaApplicationEndpoint();
  });
  ...
  describe('SipMediaApplicationEndpoint', function() {
    it('should create an instance of SipMediaApplicationEndpoint', function() {
      // uncomment below and update the code to test SipMediaApplicationEndpoint
      //var instance = new AmazonChime.SipMediaApplicationEndpoint();
      //expect(instance).to.be.a(AmazonChime.SipMediaApplicationEndpoint);
    });
