...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.MessagingSessionEndpoint();
  });
  ...
  describe('MessagingSessionEndpoint', function() {
    it('should create an instance of MessagingSessionEndpoint', function() {
      // uncomment below and update the code to test MessagingSessionEndpoint
      //var instance = new AmazonChime.MessagingSessionEndpoint();
      //expect(instance).to.be.a(AmazonChime.MessagingSessionEndpoint);
    });
