...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary();
  });
  ...
  describe('ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary', function() {
    it('should create an instance of ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary', function() {
      ...
      //var instance = new AmazonChime.ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary();
      //expect(instance).to.be.a(AmazonChime.ChannelMembershipForAppInstanceUserSummaryAppInstanceUserMembershipSummary);
    });
