...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelModeratorResponse();
  });
  ...
  describe('DescribeChannelModeratorResponse', function() {
    it('should create an instance of DescribeChannelModeratorResponse', function() {
      // uncomment below and update the code to test DescribeChannelModeratorResponse
      //var instance = new AmazonChime.DescribeChannelModeratorResponse();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelModeratorResponse);
    });
