...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetMessagingSessionEndpointResponseEndpoint();
  });
  ...
  describe('GetMessagingSessionEndpointResponseEndpoint', function() {
    it('should create an instance of GetMessagingSessionEndpointResponseEndpoint', function() {
      ...
      //var instance = new AmazonChime.GetMessagingSessionEndpointResponseEndpoint();
      //expect(instance).to.be.a(AmazonChime.GetMessagingSessionEndpointResponseEndpoint);
    });
