...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateUserSettingsRequest();
  });
  ...
  describe('UpdateUserSettingsRequest', function() {
    it('should create an instance of UpdateUserSettingsRequest', function() {
      // uncomment below and update the code to test UpdateUserSettingsRequest
      //var instance = new AmazonChime.UpdateUserSettingsRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateUserSettingsRequest);
    });
