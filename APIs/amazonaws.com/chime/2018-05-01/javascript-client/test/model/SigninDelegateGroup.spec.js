...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.SigninDelegateGroup();
  });
  ...
  describe('SigninDelegateGroup', function() {
    it('should create an instance of SigninDelegateGroup', function() {
      // uncomment below and update the code to test SigninDelegateGroup
      //var instance = new AmazonChime.SigninDelegateGroup();
      //expect(instance).to.be.a(AmazonChime.SigninDelegateGroup);
    });
