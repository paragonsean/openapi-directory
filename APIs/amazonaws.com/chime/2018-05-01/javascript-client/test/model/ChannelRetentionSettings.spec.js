...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelRetentionSettings();
  });
  ...
  describe('ChannelRetentionSettings', function() {
    it('should create an instance of ChannelRetentionSettings', function() {
      // uncomment below and update the code to test ChannelRetentionSettings
      //var instance = new AmazonChime.ChannelRetentionSettings();
      //expect(instance).to.be.a(AmazonChime.ChannelRetentionSettings);
    });
