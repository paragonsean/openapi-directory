...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorProxyResponseProxy();
  });
  ...
  describe('GetVoiceConnectorProxyResponseProxy', function() {
    it('should create an instance of GetVoiceConnectorProxyResponseProxy', function() {
      // uncomment below and update the code to test GetVoiceConnectorProxyResponseProxy
      //var instance = new AmazonChime.GetVoiceConnectorProxyResponseProxy();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorProxyResponseProxy);
    });
