...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListAttendeeTagsResponse();
  });
  ...
  describe('ListAttendeeTagsResponse', function() {
    it('should create an instance of ListAttendeeTagsResponse', function() {
      // uncomment below and update the code to test ListAttendeeTagsResponse
      //var instance = new AmazonChime.ListAttendeeTagsResponse();
      //expect(instance).to.be.a(AmazonChime.ListAttendeeTagsResponse);
    });
