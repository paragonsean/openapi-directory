...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateChannelRequest();
  });
  ...
  describe('UpdateChannelRequest', function() {
    it('should create an instance of UpdateChannelRequest', function() {
      ...
      //var instance = new AmazonChime.UpdateChannelRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateChannelRequest);
    });
