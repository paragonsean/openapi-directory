...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CandidateAddress();
  });
  ...
  describe('CandidateAddress', function() {
    it('should create an instance of CandidateAddress', function() {
      // uncomment below and update the code to test CandidateAddress
      //var instance = new AmazonChime.CandidateAddress();
      //expect(instance).to.be.a(AmazonChime.CandidateAddress);
    });
