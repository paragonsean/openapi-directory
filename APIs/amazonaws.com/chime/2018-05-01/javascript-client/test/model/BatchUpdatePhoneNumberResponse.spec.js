...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.BatchUpdatePhoneNumberResponse();
  });
  ...
  describe('BatchUpdatePhoneNumberResponse', function() {
    it('should create an instance of BatchUpdatePhoneNumberResponse', function() {
      // uncomment below and update the code to test BatchUpdatePhoneNumberResponse
      //var instance = new AmazonChime.BatchUpdatePhoneNumberResponse();
      //expect(instance).to.be.a(AmazonChime.BatchUpdatePhoneNumberResponse);
    });
