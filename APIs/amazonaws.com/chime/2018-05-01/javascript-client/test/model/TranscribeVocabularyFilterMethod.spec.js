...
(function(root, factory) {
  ...
  describe('TranscribeVocabularyFilterMethod', function() {
    it('should create an instance of TranscribeVocabularyFilterMethod', function() {
      // uncomment below and update the code to test TranscribeVocabularyFilterMethod
      //var instance = new AmazonChime.TranscribeVocabularyFilterMethod();
      //expect(instance).to.be.a(AmazonChime.TranscribeVocabularyFilterMethod);
    });
