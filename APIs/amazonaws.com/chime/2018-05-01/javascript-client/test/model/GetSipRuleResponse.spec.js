...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetSipRuleResponse();
  });
  ...
  describe('GetSipRuleResponse', function() {
    it('should create an instance of GetSipRuleResponse', function() {
      // uncomment below and update the code to test GetSipRuleResponse
      //var instance = new AmazonChime.GetSipRuleResponse();
      //expect(instance).to.be.a(AmazonChime.GetSipRuleResponse);
    });
