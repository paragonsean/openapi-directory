...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DescribeChannelModeratedByAppInstanceUserResponseChannel();
  });
  ...
  describe('DescribeChannelModeratedByAppInstanceUserResponseChannel', function() {
    it('should create an instance of DescribeChannelModeratedByAppInstanceUserResponseChannel', function() {
      // uncomment below and update the code to test DescribeChannelModeratedByAppInstanceUserResponseChannel
      //var instance = new AmazonChime.DescribeChannelModeratedByAppInstanceUserResponseChannel();
      //expect(instance).to.be.a(AmazonChime.DescribeChannelModeratedByAppInstanceUserResponseChannel);
    });
