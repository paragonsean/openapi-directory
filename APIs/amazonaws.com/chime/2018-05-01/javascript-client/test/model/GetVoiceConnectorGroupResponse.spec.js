...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorGroupResponse();
  });
  ...
  describe('GetVoiceConnectorGroupResponse', function() {
    it('should create an instance of GetVoiceConnectorGroupResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorGroupResponse
      //var instance = new AmazonChime.GetVoiceConnectorGroupResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorGroupResponse);
    });
