...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMembershipMember();
  });
  ...
  describe('ChannelMembershipMember', function() {
    it('should create an instance of ChannelMembershipMember', function() {
      // uncomment below and update the code to test ChannelMembershipMember
      //var instance = new AmazonChime.ChannelMembershipMember();
      //expect(instance).to.be.a(AmazonChime.ChannelMembershipMember);
    });
