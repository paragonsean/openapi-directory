...
(function(root, factory) {
  ...
  describe('OrderedPhoneNumberStatus', function() {
    it('should create an instance of OrderedPhoneNumberStatus', function() {
      // uncomment below and update the code to test OrderedPhoneNumberStatus
      //var instance = new AmazonChime.OrderedPhoneNumberStatus();
      //expect(instance).to.be.a(AmazonChime.OrderedPhoneNumberStatus);
    });
