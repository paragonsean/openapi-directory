...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateProxySessionRequest();
  });
  ...
  describe('UpdateProxySessionRequest', function() {
    it('should create an instance of UpdateProxySessionRequest', function() {
      // uncomment below and update the code to test UpdateProxySessionRequest
      //var instance = new AmazonChime.UpdateProxySessionRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateProxySessionRequest);
    });
