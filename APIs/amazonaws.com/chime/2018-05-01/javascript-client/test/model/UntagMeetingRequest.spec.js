...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UntagMeetingRequest();
  });
  ...
  describe('UntagMeetingRequest', function() {
    it('should create an instance of UntagMeetingRequest', function() {
      // uncomment below and update the code to test UntagMeetingRequest
      //var instance = new AmazonChime.UntagMeetingRequest();
      //expect(instance).to.be.a(AmazonChime.UntagMeetingRequest);
    });
