...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.PutVoiceConnectorTerminationRequestTermination();
  });
  ...
  describe('PutVoiceConnectorTerminationRequestTermination', function() {
    it('should create an instance of PutVoiceConnectorTerminationRequestTermination', function() {
      // uncomment below and update the code to test PutVoiceConnectorTerminationRequestTermination
      //var instance = new AmazonChime.PutVoiceConnectorTerminationRequestTermination();
      //expect(instance).to.be.a(AmazonChime.PutVoiceConnectorTerminationRequestTermination);
    });
