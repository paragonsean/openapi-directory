...
(function(root, factory) {
  ...
  describe('Bot', function() {
    it('should create an instance of Bot', function() {
      // uncomment below and update the code to test Bot
      //var instance = new AmazonChime.Bot();
      //expect(instance).to.be.a(AmazonChime.Bot);
    });
    ...
    it('should have the property botEmail (base name: "BotEmail")', function() {
