...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateSipMediaApplicationResponse();
  });
  ...
  describe('UpdateSipMediaApplicationResponse', function() {
    it('should create an instance of UpdateSipMediaApplicationResponse', function() {
      // uncomment below and update the code to test UpdateSipMediaApplicationResponse
      //var instance = new AmazonChime.UpdateSipMediaApplicationResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateSipMediaApplicationResponse);
    });
