...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetVoiceConnectorResponse();
  });
  ...
  describe('GetVoiceConnectorResponse', function() {
    it('should create an instance of GetVoiceConnectorResponse', function() {
      // uncomment below and update the code to test GetVoiceConnectorResponse
      //var instance = new AmazonChime.GetVoiceConnectorResponse();
      //expect(instance).to.be.a(AmazonChime.GetVoiceConnectorResponse);
    });
