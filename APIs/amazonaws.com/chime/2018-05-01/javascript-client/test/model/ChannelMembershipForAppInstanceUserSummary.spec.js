...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ChannelMembershipForAppInstanceUserSummary();
  });
  ...
  describe('ChannelMembershipForAppInstanceUserSummary', function() {
    it('should create an instance of ChannelMembershipForAppInstanceUserSummary', function() {
      // uncomment below and update the code to test ChannelMembershipForAppInstanceUserSummary
      //var instance = new AmazonChime.ChannelMembershipForAppInstanceUserSummary();
      //expect(instance).to.be.a(AmazonChime.ChannelMembershipForAppInstanceUserSummary);
    });
