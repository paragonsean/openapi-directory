...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.AssociatePhoneNumberWithUserRequest();
  });
  ...
  describe('AssociatePhoneNumberWithUserRequest', function() {
    it('should create an instance of AssociatePhoneNumberWithUserRequest', function() {
      // uncomment below and update the code to test AssociatePhoneNumberWithUserRequest
      //var instance = new AmazonChime.AssociatePhoneNumberWithUserRequest();
      //expect(instance).to.be.a(AmazonChime.AssociatePhoneNumberWithUserRequest);
    });

    it('should have the property e164PhoneNumber (base name: "E164PhoneNumber")', function() {
      // uncomment below and update the code to test the property e164PhoneNumber
      //var instance = new AmazonChime.AssociatePhoneNumberWithUserRequest();
