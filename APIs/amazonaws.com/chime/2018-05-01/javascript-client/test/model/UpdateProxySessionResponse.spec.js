...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateProxySessionResponse();
  });
  ...
  describe('UpdateProxySessionResponse', function() {
    it('should create an instance of UpdateProxySessionResponse', function() {
      // uncomment below and update the code to test UpdateProxySessionResponse
      //var instance = new AmazonChime.UpdateProxySessionResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateProxySessionResponse);
    });
