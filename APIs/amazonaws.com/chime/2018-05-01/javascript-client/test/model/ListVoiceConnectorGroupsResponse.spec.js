...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.ListVoiceConnectorGroupsResponse();
  });
  ...
  describe('ListVoiceConnectorGroupsResponse', function() {
    it('should create an instance of ListVoiceConnectorGroupsResponse', function() {
      // uncomment below and update the code to test ListVoiceConnectorGroupsResponse
      //var instance = new AmazonChime.ListVoiceConnectorGroupsResponse();
      //expect(instance).to.be.a(AmazonChime.ListVoiceConnectorGroupsResponse);
    });

    it('should have the property voiceConnectorGroups (base name: "VoiceConnectorGroups")', function() {
      // uncomment below and update the code to test the property voiceConnectorGroups
      //var instance = new AmazonChime.ListVoiceConnectorGroupsResponse();
