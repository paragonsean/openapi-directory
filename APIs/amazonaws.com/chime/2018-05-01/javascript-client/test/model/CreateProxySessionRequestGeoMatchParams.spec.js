...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateProxySessionRequestGeoMatchParams();
  });
  ...
  describe('CreateProxySessionRequestGeoMatchParams', function() {
    it('should create an instance of CreateProxySessionRequestGeoMatchParams', function() {
      // uncomment below and update the code to test CreateProxySessionRequestGeoMatchParams
      //var instance = new AmazonChime.CreateProxySessionRequestGeoMatchParams();
      //expect(instance).to.be.a(AmazonChime.CreateProxySessionRequestGeoMatchParams);
    });
