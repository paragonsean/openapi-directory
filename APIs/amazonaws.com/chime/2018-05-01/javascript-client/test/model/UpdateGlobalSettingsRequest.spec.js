...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateGlobalSettingsRequest();
  });
  ...
  describe('UpdateGlobalSettingsRequest', function() {
    it('should create an instance of UpdateGlobalSettingsRequest', function() {
      ...
      //var instance = new AmazonChime.UpdateGlobalSettingsRequest();
      //expect(instance).to.be.a(AmazonChime.UpdateGlobalSettingsRequest);
    });

    it('should have the property businessCalling (base name: "BusinessCalling")', function() {
      // uncomment below and update the code to test the property businessCalling
      //var instance = new AmazonChime.UpdateGlobalSettingsRequest();
