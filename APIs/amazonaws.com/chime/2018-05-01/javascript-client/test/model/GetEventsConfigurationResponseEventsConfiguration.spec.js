...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.GetEventsConfigurationResponseEventsConfiguration();
  });
  ...
  describe('GetEventsConfigurationResponseEventsConfiguration', function() {
    it('should create an instance of GetEventsConfigurationResponseEventsConfiguration', function() {
      // uncomment below and update the code to test GetEventsConfigurationResponseEventsConfiguration
      //var instance = new AmazonChime.GetEventsConfigurationResponseEventsConfiguration();
      //expect(instance).to.be.a(AmazonChime.GetEventsConfigurationResponseEventsConfiguration);
    });
    ...
    it('should have the property outboundEventsHTTPSEndpoint (base name: "OutboundEventsHTTPSEndpoint")', function() {
      // uncomment below and update the code to test the property outboundEventsHTTPSEndpoint
      //var instance = new AmazonChime.GetEventsConfigurationResponseEventsConfiguration();
      //expect(instance).to.be();
    });
