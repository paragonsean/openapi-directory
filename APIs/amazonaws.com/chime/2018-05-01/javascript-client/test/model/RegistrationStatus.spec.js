...
(function(root, factory) {
  ...
  describe('RegistrationStatus', function() {
    it('should create an instance of RegistrationStatus', function() {
      // uncomment below and update the code to test RegistrationStatus
      //var instance = new AmazonChime.RegistrationStatus();
      //expect(instance).to.be.a(AmazonChime.RegistrationStatus);
    });
