...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateRoomResponseRoom();
  });
  ...
  describe('CreateRoomResponseRoom', function() {
    it('should create an instance of CreateRoomResponseRoom', function() {
      // uncomment below and update the code to test CreateRoomResponseRoom
      //var instance = new AmazonChime.CreateRoomResponseRoom();
      //expect(instance).to.be.a(AmazonChime.CreateRoomResponseRoom);
    });
