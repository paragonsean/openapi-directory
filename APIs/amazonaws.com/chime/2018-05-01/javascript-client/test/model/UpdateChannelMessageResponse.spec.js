...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.UpdateChannelMessageResponse();
  });
  ...
  describe('UpdateChannelMessageResponse', function() {
    it('should create an instance of UpdateChannelMessageResponse', function() {
      // uncomment below and update the code to test UpdateChannelMessageResponse
      //var instance = new AmazonChime.UpdateChannelMessageResponse();
      //expect(instance).to.be.a(AmazonChime.UpdateChannelMessageResponse);
    });
