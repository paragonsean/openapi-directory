...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.CreateProxySessionRequest();
  });
  ...
  describe('CreateProxySessionRequest', function() {
    it('should create an instance of CreateProxySessionRequest', function() {
      // uncomment below and update the code to test CreateProxySessionRequest
      //var instance = new AmazonChime.CreateProxySessionRequest();
      //expect(instance).to.be.a(AmazonChime.CreateProxySessionRequest);
    });

    it('should have the property participantPhoneNumbers (base name: "ParticipantPhoneNumbers")', function() {
      // uncomment below and update the code to test the property participantPhoneNumbers
      //var instance = new AmazonChime.CreateProxySessionRequest();
