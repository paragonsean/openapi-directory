...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest();
  });
  ...
  describe('DisassociatePhoneNumbersFromVoiceConnectorGroupRequest', function() {
    it('should create an instance of DisassociatePhoneNumbersFromVoiceConnectorGroupRequest', function() {
      // uncomment below and update the code to test DisassociatePhoneNumbersFromVoiceConnectorGroupRequest
      //var instance = new AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest();
      //expect(instance).to.be.a(AmazonChime.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest);
    });
