...
/**
 * The CreateRoomMembershipResponse model module.
 * @module model/CreateRoomMembershipResponse
 * @version 2018-05-01
 */
class CreateRoomMembershipResponse {
    /**
     * Constructs a new <code>CreateRoomMembershipResponse</code>.
     * @alias module:model/CreateRoomMembershipResponse
     */
    constructor() { 
        
        CreateRoomMembershipResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRoomMembershipResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomMembershipResponse} obj Optional instance to populate.
     * @return {module:model/CreateRoomMembershipResponse} The populated <code>CreateRoomMembershipResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomMembershipResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomMembershipResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomMembershipResponse</code>.
     */
 ...
 */
CreateRoomMembershipResponse.prototype['RoomMembership'] = undefined;
...
export default CreateRoomMembershipResponse;
