...
/**
 * The BatchCreateAttendeeRequest model module.
 * @module model/BatchCreateAttendeeRequest
 * @version 2018-05-01
 */
class BatchCreateAttendeeRequest {
    /**
     * Constructs a new <code>BatchCreateAttendeeRequest</code>.
     * @alias module:model/BatchCreateAttendeeRequest
     * @param attendees {Array.<module:model/CreateAttendeeRequestItem>} The request containing the attendees to create.
     */
    constructor(attendees) { 
        
        BatchCreateAttendeeRequest.initialize(this, attendees);
    }
     ...
     */
    static initialize(obj, attendees) { 
        obj['Attendees'] = attendees;
    }

    /**
     * Constructs a <code>BatchCreateAttendeeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchCreateAttendeeRequest} obj Optional instance to populate.
     * @return {module:model/BatchCreateAttendeeRequest} The populated <code>BatchCreateAttendeeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchCreateAttendeeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchCreateAttendeeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchCreateAttendeeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchCreateAttendeeRequest.RequiredProperties) {
...
BatchCreateAttendeeRequest.RequiredProperties = ["Attendees"];

/**
 * The request containing the attendees to create.
 * @member {Array.<module:model/CreateAttendeeRequestItem>} Attendees
 */
BatchCreateAttendeeRequest.prototype['Attendees'] = undefined;
...
export default BatchCreateAttendeeRequest;
