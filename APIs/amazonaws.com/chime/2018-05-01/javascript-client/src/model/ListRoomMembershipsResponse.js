...
/**
 * The ListRoomMembershipsResponse model module.
 * @module model/ListRoomMembershipsResponse
 * @version 2018-05-01
 */
class ListRoomMembershipsResponse {
    /**
     * Constructs a new <code>ListRoomMembershipsResponse</code>.
     * @alias module:model/ListRoomMembershipsResponse
     */
    constructor() { 
        
        ListRoomMembershipsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRoomMembershipsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRoomMembershipsResponse} obj Optional instance to populate.
     * @return {module:model/ListRoomMembershipsResponse} The populated <code>ListRoomMembershipsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRoomMembershipsResponse();

            if (data.hasOwnProperty('RoomMemberships')) {
                obj['RoomMemberships'] = ApiClient.convertToType(data['RoomMemberships'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRoomMembershipsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRoomMembershipsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RoomMemberships`
        if (data['RoomMemberships']) { // data not null
          Array.validateJSON(data['RoomMemberships']);
        }
...
/**
 * @member {Array} RoomMemberships
 */
ListRoomMembershipsResponse.prototype['RoomMemberships'] = undefined;

/**
 * @member {String} NextToken
 */
ListRoomMembershipsResponse.prototype['NextToken'] = undefined;
...
export default ListRoomMembershipsResponse;
