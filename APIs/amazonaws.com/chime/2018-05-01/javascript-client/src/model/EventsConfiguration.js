...
/**
 * The EventsConfiguration model module.
 * @module model/EventsConfiguration
 * @version 2018-05-01
 */
class EventsConfiguration {
    /**
     * Constructs a new <code>EventsConfiguration</code>.
     * The configuration that allows a bot to receive outgoing events. Can be either an HTTPS endpoint or a Lambda function ARN.
     * @alias module:model/EventsConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EventsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsConfiguration} obj Optional instance to populate.
     * @return {module:model/EventsConfiguration} The populated <code>EventsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsConfiguration</code>.
     */
