...
/**
 * The PutVoiceConnectorProxyResponse model module.
 * @module model/PutVoiceConnectorProxyResponse
 * @version 2018-05-01
 */
class PutVoiceConnectorProxyResponse {
    /**
     * Constructs a new <code>PutVoiceConnectorProxyResponse</code>.
     * @alias module:model/PutVoiceConnectorProxyResponse
     */
    constructor() { 
        
        PutVoiceConnectorProxyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorProxyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorProxyResponse} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorProxyResponse} The populated <code>PutVoiceConnectorProxyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorProxyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorProxyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorProxyResponse</code>.
     */
 ...
 */
PutVoiceConnectorProxyResponse.prototype['Proxy'] = undefined;
...
export default PutVoiceConnectorProxyResponse;
