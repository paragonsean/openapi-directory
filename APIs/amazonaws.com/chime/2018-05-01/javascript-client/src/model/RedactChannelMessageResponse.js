...
/**
 * The RedactChannelMessageResponse model module.
 * @module model/RedactChannelMessageResponse
 * @version 2018-05-01
 */
class RedactChannelMessageResponse {
    /**
     * Constructs a new <code>RedactChannelMessageResponse</code>.
     * @alias module:model/RedactChannelMessageResponse
     */
    constructor() { 
        
        RedactChannelMessageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RedactChannelMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RedactChannelMessageResponse} obj Optional instance to populate.
     * @return {module:model/RedactChannelMessageResponse} The populated <code>RedactChannelMessageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RedactChannelMessageResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>RedactChannelMessageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RedactChannelMessageResponse</code>.
     */
 ...
 */
RedactChannelMessageResponse.prototype['ChannelArn'] = undefined;

/**
 * @member {String} MessageId
 */
RedactChannelMessageResponse.prototype['MessageId'] = undefined;
...
export default RedactChannelMessageResponse;
