...
* @readonly
*/
export default class TranscribeVocabularyFilterMethod {
    ...
    /**
    * Returns a <code>TranscribeVocabularyFilterMethod</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeVocabularyFilterMethod} The enum <code>TranscribeVocabularyFilterMethod</code> value.
    */
