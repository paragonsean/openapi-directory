...
/**
 * The RoomRetentionSettings model module.
 * @module model/RoomRetentionSettings
 * @version 2018-05-01
 */
class RoomRetentionSettings {
    /**
     * Constructs a new <code>RoomRetentionSettings</code>.
     * The retention settings that determine how long to retain chat-room messages for an Amazon Chime Enterprise account.
     * @alias module:model/RoomRetentionSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RoomRetentionSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoomRetentionSettings} obj Optional instance to populate.
     * @return {module:model/RoomRetentionSettings} The populated <code>RoomRetentionSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoomRetentionSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>RoomRetentionSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoomRetentionSettings</code>.
     */
...
export default RoomRetentionSettings;
