...
class UpdateAccountRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DefaultLicense')) {
                obj['DefaultLicense'] = ApiClient.convertToType(data['DefaultLicense'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['DefaultLicense'] && !(typeof data['DefaultLicense'] === 'string' || data['DefaultLicense'] instanceof String)) {
            throw new Error("Expected the field `DefaultLicense` to be a primitive type in the JSON string but got " + data['DefaultLicense']);
        }
 ...
 * @member {module:model/UpdateAccountRequest.DefaultLicenseEnum} DefaultLicense
 */
UpdateAccountRequest.prototype['DefaultLicense'] = undefined;
...
/**
 * Allowed values for the <code>DefaultLicense</code> property.
 * @enum {String}
 * @readonly
 */
UpdateAccountRequest['DefaultLicenseEnum'] = {
