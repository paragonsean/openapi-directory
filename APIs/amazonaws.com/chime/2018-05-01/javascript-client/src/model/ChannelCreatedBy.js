...
/**
 * The ChannelCreatedBy model module.
 * @module model/ChannelCreatedBy
 * @version 2018-05-01
 */
class ChannelCreatedBy {
    /**
     * Constructs a new <code>ChannelCreatedBy</code>.
     * @alias module:model/ChannelCreatedBy
     * @implements module:model/Identity
     */
    constructor() { 
        Identity.initialize(this);
        ChannelCreatedBy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChannelCreatedBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelCreatedBy} obj Optional instance to populate.
     * @return {module:model/ChannelCreatedBy} The populated <code>ChannelCreatedBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelCreatedBy();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelCreatedBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelCreatedBy</code>.
     */
 ...
 * @member {String} Arn
 */
ChannelCreatedBy.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
ChannelCreatedBy.prototype['Name'] = undefined;
...
export default ChannelCreatedBy;
