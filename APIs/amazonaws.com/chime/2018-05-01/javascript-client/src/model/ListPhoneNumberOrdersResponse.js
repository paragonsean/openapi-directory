...
/**
 * The ListPhoneNumberOrdersResponse model module.
 * @module model/ListPhoneNumberOrdersResponse
 * @version 2018-05-01
 */
class ListPhoneNumberOrdersResponse {
    /**
     * Constructs a new <code>ListPhoneNumberOrdersResponse</code>.
     * @alias module:model/ListPhoneNumberOrdersResponse
     */
    constructor() { 
        
        ListPhoneNumberOrdersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPhoneNumberOrdersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPhoneNumberOrdersResponse} obj Optional instance to populate.
     * @return {module:model/ListPhoneNumberOrdersResponse} The populated <code>ListPhoneNumberOrdersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPhoneNumberOrdersResponse();

            if (data.hasOwnProperty('PhoneNumberOrders')) {
                obj['PhoneNumberOrders'] = ApiClient.convertToType(data['PhoneNumberOrders'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPhoneNumberOrdersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPhoneNumberOrdersResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PhoneNumberOrders`
        if (data['PhoneNumberOrders']) { // data not null
          Array.validateJSON(data['PhoneNumberOrders']);
        }
...
/**
 * @member {Array} PhoneNumberOrders
 */
ListPhoneNumberOrdersResponse.prototype['PhoneNumberOrders'] = undefined;

/**
 * @member {String} NextToken
 */
ListPhoneNumberOrdersResponse.prototype['NextToken'] = undefined;
...
export default ListPhoneNumberOrdersResponse;
