...
import PutVoiceConnectorOriginationResponseOrigination from './PutVoiceConnectorOriginationResponseOrigination';

/**
 * The PutVoiceConnectorOriginationResponse model module.
 * @module model/PutVoiceConnectorOriginationResponse
 * @version 2018-05-01
 */
class PutVoiceConnectorOriginationResponse {
    /**
     * Constructs a new <code>PutVoiceConnectorOriginationResponse</code>.
     * @alias module:model/PutVoiceConnectorOriginationResponse
     */
    constructor() { 
        
        PutVoiceConnectorOriginationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorOriginationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorOriginationResponse} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorOriginationResponse} The populated <code>PutVoiceConnectorOriginationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorOriginationResponse();

            if (data.hasOwnProperty('Origination')) {
                obj['Origination'] = PutVoiceConnectorOriginationResponseOrigination.constructFromObject(data['Origination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorOriginationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorOriginationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Origination`
        if (data['Origination']) { // data not null
          PutVoiceConnectorOriginationResponseOrigination.validateJSON(data['Origination']);
        }
...
/**
 * @member {module:model/PutVoiceConnectorOriginationResponseOrigination} Origination
 */
PutVoiceConnectorOriginationResponse.prototype['Origination'] = undefined;
...
export default PutVoiceConnectorOriginationResponse;
