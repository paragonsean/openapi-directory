...
/**
 * The BatchUpdatePhoneNumberResponse model module.
 * @module model/BatchUpdatePhoneNumberResponse
 * @version 2018-05-01
 */
class BatchUpdatePhoneNumberResponse {
    /**
     * Constructs a new <code>BatchUpdatePhoneNumberResponse</code>.
     * @alias module:model/BatchUpdatePhoneNumberResponse
     */
    constructor() { 
        
        BatchUpdatePhoneNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchUpdatePhoneNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchUpdatePhoneNumberResponse} obj Optional instance to populate.
     * @return {module:model/BatchUpdatePhoneNumberResponse} The populated <code>BatchUpdatePhoneNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchUpdatePhoneNumberResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchUpdatePhoneNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchUpdatePhoneNumberResponse</code>.
     */
 ...
 */
BatchUpdatePhoneNumberResponse.prototype['PhoneNumberErrors'] = undefined;
...
export default BatchUpdatePhoneNumberResponse;
