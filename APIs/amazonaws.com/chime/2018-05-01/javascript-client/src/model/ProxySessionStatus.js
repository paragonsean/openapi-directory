...
* @readonly
*/
export default class ProxySessionStatus {
    ...
    /**
    * Returns a <code>ProxySessionStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProxySessionStatus} The enum <code>ProxySessionStatus</code> value.
    */
