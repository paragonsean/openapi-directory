...
/**
 * The CreateMeetingDialOutResponse model module.
 * @module model/CreateMeetingDialOutResponse
 * @version 2018-05-01
 */
class CreateMeetingDialOutResponse {
    /**
     * Constructs a new <code>CreateMeetingDialOutResponse</code>.
     * @alias module:model/CreateMeetingDialOutResponse
     */
    constructor() { 
        
        CreateMeetingDialOutResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMeetingDialOutResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMeetingDialOutResponse} obj Optional instance to populate.
     * @return {module:model/CreateMeetingDialOutResponse} The populated <code>CreateMeetingDialOutResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMeetingDialOutResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMeetingDialOutResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMeetingDialOutResponse</code>.
     */
 ...
 */
CreateMeetingDialOutResponse.prototype['TransactionId'] = undefined;
...
export default CreateMeetingDialOutResponse;
