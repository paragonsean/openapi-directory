...
import UpdateAccountResponseAccount from './UpdateAccountResponseAccount';
...
class UpdateAccountResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Account')) {
                obj['Account'] = UpdateAccountResponseAccount.constructFromObject(data['Account']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Account']) { // data not null
          UpdateAccountResponseAccount.validateJSON(data['Account']);
        }
...
/**
 * @member {module:model/UpdateAccountResponseAccount} Account
 */
UpdateAccountResponse.prototype['Account'] = undefined;
