...
/**
 * The PutVoiceConnectorTerminationCredentialsRequest model module.
 * @module model/PutVoiceConnectorTerminationCredentialsRequest
 * @version 2018-05-01
 */
class PutVoiceConnectorTerminationCredentialsRequest {
    /**
     * Constructs a new <code>PutVoiceConnectorTerminationCredentialsRequest</code>.
     * @alias module:model/PutVoiceConnectorTerminationCredentialsRequest
     */
    constructor() { 
        
        PutVoiceConnectorTerminationCredentialsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorTerminationCredentialsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorTerminationCredentialsRequest} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorTerminationCredentialsRequest} The populated <code>PutVoiceConnectorTerminationCredentialsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorTerminationCredentialsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorTerminationCredentialsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorTerminationCredentialsRequest</code>.
     */
 ...
 */
PutVoiceConnectorTerminationCredentialsRequest.prototype['Credentials'] = undefined;
...
export default PutVoiceConnectorTerminationCredentialsRequest;
