...
/**
 * The TerminationHealth model module.
 * @module model/TerminationHealth
 * @version 2018-05-01
 */
class TerminationHealth {
    /**
     * Constructs a new <code>TerminationHealth</code>.
     ...
     * @alias module:model/TerminationHealth
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TerminationHealth</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TerminationHealth} obj Optional instance to populate.
     * @return {module:model/TerminationHealth} The populated <code>TerminationHealth</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TerminationHealth();
    ...
    /**
     * Validates the JSON data with respect to <code>TerminationHealth</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TerminationHealth</code>.
     */
...
export default TerminationHealth;
