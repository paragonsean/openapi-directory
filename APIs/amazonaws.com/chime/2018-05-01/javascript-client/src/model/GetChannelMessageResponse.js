...
import GetChannelMessageResponseChannelMessage from './GetChannelMessageResponseChannelMessage';

/**
 * The GetChannelMessageResponse model module.
 * @module model/GetChannelMessageResponse
 * @version 2018-05-01
 */
class GetChannelMessageResponse {
    /**
     * Constructs a new <code>GetChannelMessageResponse</code>.
     * @alias module:model/GetChannelMessageResponse
     */
    constructor() { 
        
        GetChannelMessageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetChannelMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetChannelMessageResponse} obj Optional instance to populate.
     * @return {module:model/GetChannelMessageResponse} The populated <code>GetChannelMessageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetChannelMessageResponse();

            if (data.hasOwnProperty('ChannelMessage')) {
                obj['ChannelMessage'] = GetChannelMessageResponseChannelMessage.constructFromObject(data['ChannelMessage']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetChannelMessageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetChannelMessageResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ChannelMessage`
        if (data['ChannelMessage']) { // data not null
          GetChannelMessageResponseChannelMessage.validateJSON(data['ChannelMessage']);
        }
...
/**
 * @member {module:model/GetChannelMessageResponseChannelMessage} ChannelMessage
 */
GetChannelMessageResponse.prototype['ChannelMessage'] = undefined;
...
export default GetChannelMessageResponse;
