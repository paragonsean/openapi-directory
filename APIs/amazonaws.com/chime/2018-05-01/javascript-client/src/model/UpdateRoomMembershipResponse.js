...
import CreateRoomMembershipResponseRoomMembership from './CreateRoomMembershipResponseRoomMembership';

/**
 * The UpdateRoomMembershipResponse model module.
 * @module model/UpdateRoomMembershipResponse
 * @version 2018-05-01
 */
class UpdateRoomMembershipResponse {
    /**
     * Constructs a new <code>UpdateRoomMembershipResponse</code>.
     * @alias module:model/UpdateRoomMembershipResponse
     */
    constructor() { 
        
        UpdateRoomMembershipResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRoomMembershipResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRoomMembershipResponse} obj Optional instance to populate.
     * @return {module:model/UpdateRoomMembershipResponse} The populated <code>UpdateRoomMembershipResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRoomMembershipResponse();

            if (data.hasOwnProperty('RoomMembership')) {
                obj['RoomMembership'] = CreateRoomMembershipResponseRoomMembership.constructFromObject(data['RoomMembership']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRoomMembershipResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRoomMembershipResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RoomMembership`
        if (data['RoomMembership']) { // data not null
          CreateRoomMembershipResponseRoomMembership.validateJSON(data['RoomMembership']);
        }
...
/**
 * @member {module:model/CreateRoomMembershipResponseRoomMembership} RoomMembership
 */
UpdateRoomMembershipResponse.prototype['RoomMembership'] = undefined;
...
export default UpdateRoomMembershipResponse;
