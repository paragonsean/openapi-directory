...
/**
 * The UpdateGlobalSettingsRequestVoiceConnector model module.
 * @module model/UpdateGlobalSettingsRequestVoiceConnector
 * @version 2018-05-01
 */
class UpdateGlobalSettingsRequestVoiceConnector {
    /**
     * Constructs a new <code>UpdateGlobalSettingsRequestVoiceConnector</code>.
     * The Amazon Chime Voice Connector settings. Includes any Amazon S3 buckets designated for storing call detail records.
     * @alias module:model/UpdateGlobalSettingsRequestVoiceConnector
     */
    constructor() { 
        
        UpdateGlobalSettingsRequestVoiceConnector.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGlobalSettingsRequestVoiceConnector</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGlobalSettingsRequestVoiceConnector} obj Optional instance to populate.
     * @return {module:model/UpdateGlobalSettingsRequestVoiceConnector} The populated <code>UpdateGlobalSettingsRequestVoiceConnector</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGlobalSettingsRequestVoiceConnector();

            if (data.hasOwnProperty('CdrBucket')) {
                obj['CdrBucket'] = ApiClient.convertToType(data['CdrBucket'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGlobalSettingsRequestVoiceConnector</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGlobalSettingsRequestVoiceConnector</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CdrBucket`
        if (data['CdrBucket']) { // data not null
          String.validateJSON(data['CdrBucket']);
        }
...
/**
 * @member {String} CdrBucket
 */
UpdateGlobalSettingsRequestVoiceConnector.prototype['CdrBucket'] = undefined;
...
export default UpdateGlobalSettingsRequestVoiceConnector;
