...
import CreateSipRuleResponseSipRule from './CreateSipRuleResponseSipRule';

/**
 * The CreateSipRuleResponse model module.
 * @module model/CreateSipRuleResponse
 * @version 2018-05-01
 */
class CreateSipRuleResponse {
    /**
     * Constructs a new <code>CreateSipRuleResponse</code>.
     * @alias module:model/CreateSipRuleResponse
     */
    constructor() { 
        
        CreateSipRuleResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateSipRuleResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSipRuleResponse} obj Optional instance to populate.
     * @return {module:model/CreateSipRuleResponse} The populated <code>CreateSipRuleResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSipRuleResponse();

            if (data.hasOwnProperty('SipRule')) {
                obj['SipRule'] = CreateSipRuleResponseSipRule.constructFromObject(data['SipRule']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSipRuleResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSipRuleResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipRule`
        if (data['SipRule']) { // data not null
          CreateSipRuleResponseSipRule.validateJSON(data['SipRule']);
        }
...
/**
 * @member {module:model/CreateSipRuleResponseSipRule} SipRule
 */
CreateSipRuleResponse.prototype['SipRule'] = undefined;
...
export default CreateSipRuleResponse;
