...
/**
 * The ConversationRetentionSettings model module.
 * @module model/ConversationRetentionSettings
 * @version 2018-05-01
 */
class ConversationRetentionSettings {
    /**
     * Constructs a new <code>ConversationRetentionSettings</code>.
     * The retention settings that determine how long to retain conversation messages for an Amazon Chime Enterprise account.
     * @alias module:model/ConversationRetentionSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ConversationRetentionSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationRetentionSettings} obj Optional instance to populate.
     * @return {module:model/ConversationRetentionSettings} The populated <code>ConversationRetentionSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationRetentionSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationRetentionSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationRetentionSettings</code>.
     */
...
export default ConversationRetentionSettings;
