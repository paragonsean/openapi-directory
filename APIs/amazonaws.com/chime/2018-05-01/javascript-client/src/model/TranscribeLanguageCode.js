...
* @readonly
*/
export default class TranscribeLanguageCode {
    ...
    /**
    * Returns a <code>TranscribeLanguageCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeLanguageCode} The enum <code>TranscribeLanguageCode</code> value.
    */
