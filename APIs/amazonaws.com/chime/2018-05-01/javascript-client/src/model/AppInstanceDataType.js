...
* @readonly
*/
export default class AppInstanceDataType {
    ...
    /**
    * Returns a <code>AppInstanceDataType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AppInstanceDataType} The enum <code>AppInstanceDataType</code> value.
    */
