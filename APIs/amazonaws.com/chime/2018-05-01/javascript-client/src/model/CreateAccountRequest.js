...
class CreateAccountRequest {
     ...
     * @param name {String} The name of the Amazon Chime account.
     */
    constructor(name) { 
        
        CreateAccountRequest.initialize(this, name);
    }
...
CreateAccountRequest.RequiredProperties = ["Name"];

/**
 * The name of the Amazon Chime account.
 * @member {String} Name
 */
CreateAccountRequest.prototype['Name'] = undefined;
