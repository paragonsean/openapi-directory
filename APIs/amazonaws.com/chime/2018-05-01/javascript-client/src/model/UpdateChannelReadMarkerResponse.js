...
/**
 * The UpdateChannelReadMarkerResponse model module.
 * @module model/UpdateChannelReadMarkerResponse
 * @version 2018-05-01
 */
class UpdateChannelReadMarkerResponse {
    /**
     * Constructs a new <code>UpdateChannelReadMarkerResponse</code>.
     * @alias module:model/UpdateChannelReadMarkerResponse
     */
    constructor() { 
        
        UpdateChannelReadMarkerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateChannelReadMarkerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateChannelReadMarkerResponse} obj Optional instance to populate.
     * @return {module:model/UpdateChannelReadMarkerResponse} The populated <code>UpdateChannelReadMarkerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateChannelReadMarkerResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateChannelReadMarkerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateChannelReadMarkerResponse</code>.
     */
 ...
 */
UpdateChannelReadMarkerResponse.prototype['ChannelArn'] = undefined;
...
export default UpdateChannelReadMarkerResponse;
