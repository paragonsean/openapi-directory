...
/**
 * The GetPhoneNumberResponse model module.
 * @module model/GetPhoneNumberResponse
 * @version 2018-05-01
 */
class GetPhoneNumberResponse {
    /**
     * Constructs a new <code>GetPhoneNumberResponse</code>.
     * @alias module:model/GetPhoneNumberResponse
     */
    constructor() { 
        
        GetPhoneNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPhoneNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPhoneNumberResponse} obj Optional instance to populate.
     * @return {module:model/GetPhoneNumberResponse} The populated <code>GetPhoneNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPhoneNumberResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPhoneNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPhoneNumberResponse</code>.
     */
 ...
 */
GetPhoneNumberResponse.prototype['PhoneNumber'] = undefined;
...
export default GetPhoneNumberResponse;
