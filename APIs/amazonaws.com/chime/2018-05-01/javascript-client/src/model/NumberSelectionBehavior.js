...
* @readonly
*/
export default class NumberSelectionBehavior {
    ...
    /**
    * Returns a <code>NumberSelectionBehavior</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NumberSelectionBehavior} The enum <code>NumberSelectionBehavior</code> value.
    */
