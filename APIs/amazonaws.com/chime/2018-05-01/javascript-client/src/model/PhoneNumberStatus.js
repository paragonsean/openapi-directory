...
* @readonly
*/
export default class PhoneNumberStatus {
    ...
    /**
    * Returns a <code>PhoneNumberStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PhoneNumberStatus} The enum <code>PhoneNumberStatus</code> value.
    */
