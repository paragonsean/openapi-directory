...
/**
 * The BatchUnsuspendUserRequest model module.
 * @module model/BatchUnsuspendUserRequest
 * @version 2018-05-01
 */
class BatchUnsuspendUserRequest {
    /**
     * Constructs a new <code>BatchUnsuspendUserRequest</code>.
     * @alias module:model/BatchUnsuspendUserRequest
     * @param userIdList {Array.<String>} The request containing the user IDs to unsuspend.
     */
    constructor(userIdList) { 
        
        BatchUnsuspendUserRequest.initialize(this, userIdList);
    }
    ...
    /**
     * Constructs a <code>BatchUnsuspendUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchUnsuspendUserRequest} obj Optional instance to populate.
     * @return {module:model/BatchUnsuspendUserRequest} The populated <code>BatchUnsuspendUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchUnsuspendUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchUnsuspendUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchUnsuspendUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchUnsuspendUserRequest.RequiredProperties) {
...
BatchUnsuspendUserRequest.RequiredProperties = ["UserIdList"];

/**
 * The request containing the user IDs to unsuspend.
 * @member {Array.<String>} UserIdList
 */
BatchUnsuspendUserRequest.prototype['UserIdList'] = undefined;
...
export default BatchUnsuspendUserRequest;
