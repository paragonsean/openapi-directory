...
/**
 * The DeleteVoiceConnectorTerminationCredentialsRequest model module.
 * @module model/DeleteVoiceConnectorTerminationCredentialsRequest
 * @version 2018-05-01
 */
class DeleteVoiceConnectorTerminationCredentialsRequest {
    /**
     * Constructs a new <code>DeleteVoiceConnectorTerminationCredentialsRequest</code>.
     * @alias module:model/DeleteVoiceConnectorTerminationCredentialsRequest
     * @param usernames {Array.<String>} The RFC2617 compliant username associated with the SIP credentials, in US-ASCII format.
     */
    constructor(usernames) { 
        
        DeleteVoiceConnectorTerminationCredentialsRequest.initialize(this, usernames);
    }
     ...
     */
    static initialize(obj, usernames) { 
        obj['Usernames'] = usernames;
    }

    /**
     * Constructs a <code>DeleteVoiceConnectorTerminationCredentialsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteVoiceConnectorTerminationCredentialsRequest} obj Optional instance to populate.
     * @return {module:model/DeleteVoiceConnectorTerminationCredentialsRequest} The populated <code>DeleteVoiceConnectorTerminationCredentialsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteVoiceConnectorTerminationCredentialsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteVoiceConnectorTerminationCredentialsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteVoiceConnectorTerminationCredentialsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteVoiceConnectorTerminationCredentialsRequest.RequiredProperties) {
...
DeleteVoiceConnectorTerminationCredentialsRequest.RequiredProperties = ["Usernames"];

/**
 * The RFC2617 compliant username associated with the SIP credentials, in US-ASCII format.
 * @member {Array.<String>} Usernames
 */
DeleteVoiceConnectorTerminationCredentialsRequest.prototype['Usernames'] = undefined;
...
export default DeleteVoiceConnectorTerminationCredentialsRequest;
