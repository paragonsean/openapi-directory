...
* @readonly
*/
export default class TranscribeContentIdentificationType {
    ...
    /**
    * Returns a <code>TranscribeContentIdentificationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeContentIdentificationType} The enum <code>TranscribeContentIdentificationType</code> value.
    */
