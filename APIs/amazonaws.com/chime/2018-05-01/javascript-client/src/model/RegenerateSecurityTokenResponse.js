...
import RegenerateSecurityTokenResponseBot from './RegenerateSecurityTokenResponseBot';

/**
 * The RegenerateSecurityTokenResponse model module.
 * @module model/RegenerateSecurityTokenResponse
 * @version 2018-05-01
 */
class RegenerateSecurityTokenResponse {
    /**
     * Constructs a new <code>RegenerateSecurityTokenResponse</code>.
     * @alias module:model/RegenerateSecurityTokenResponse
     */
    constructor() { 
        
        RegenerateSecurityTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegenerateSecurityTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegenerateSecurityTokenResponse} obj Optional instance to populate.
     * @return {module:model/RegenerateSecurityTokenResponse} The populated <code>RegenerateSecurityTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegenerateSecurityTokenResponse();

            if (data.hasOwnProperty('Bot')) {
                obj['Bot'] = RegenerateSecurityTokenResponseBot.constructFromObject(data['Bot']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RegenerateSecurityTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegenerateSecurityTokenResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Bot`
        if (data['Bot']) { // data not null
          RegenerateSecurityTokenResponseBot.validateJSON(data['Bot']);
        }
...
/**
 * @member {module:model/RegenerateSecurityTokenResponseBot} Bot
 */
RegenerateSecurityTokenResponse.prototype['Bot'] = undefined;
...
export default RegenerateSecurityTokenResponse;
