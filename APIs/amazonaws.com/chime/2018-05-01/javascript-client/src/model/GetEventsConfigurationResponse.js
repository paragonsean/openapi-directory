...
import GetEventsConfigurationResponseEventsConfiguration from './GetEventsConfigurationResponseEventsConfiguration';

/**
 * The GetEventsConfigurationResponse model module.
 * @module model/GetEventsConfigurationResponse
 * @version 2018-05-01
 */
class GetEventsConfigurationResponse {
    /**
     * Constructs a new <code>GetEventsConfigurationResponse</code>.
     * @alias module:model/GetEventsConfigurationResponse
     */
    constructor() { 
        
        GetEventsConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetEventsConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEventsConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/GetEventsConfigurationResponse} The populated <code>GetEventsConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEventsConfigurationResponse();

            if (data.hasOwnProperty('EventsConfiguration')) {
                obj['EventsConfiguration'] = GetEventsConfigurationResponseEventsConfiguration.constructFromObject(data['EventsConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEventsConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEventsConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EventsConfiguration`
        if (data['EventsConfiguration']) { // data not null
          GetEventsConfigurationResponseEventsConfiguration.validateJSON(data['EventsConfiguration']);
        }
...
/**
 * @member {module:model/GetEventsConfigurationResponseEventsConfiguration} EventsConfiguration
 */
GetEventsConfigurationResponse.prototype['EventsConfiguration'] = undefined;
...
export default GetEventsConfigurationResponse;
