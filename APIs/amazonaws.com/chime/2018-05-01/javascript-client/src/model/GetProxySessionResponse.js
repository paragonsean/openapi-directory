...
/**
 * The GetProxySessionResponse model module.
 * @module model/GetProxySessionResponse
 * @version 2018-05-01
 */
class GetProxySessionResponse {
    /**
     * Constructs a new <code>GetProxySessionResponse</code>.
     * @alias module:model/GetProxySessionResponse
     */
    constructor() { 
        
        GetProxySessionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetProxySessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetProxySessionResponse} obj Optional instance to populate.
     * @return {module:model/GetProxySessionResponse} The populated <code>GetProxySessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProxySessionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetProxySessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProxySessionResponse</code>.
     */
 ...
 */
GetProxySessionResponse.prototype['ProxySession'] = undefined;
...
export default GetProxySessionResponse;
