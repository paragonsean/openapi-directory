...
* @readonly
*/
export default class TranscribePartialResultsStability {
    ...
    /**
    * Returns a <code>TranscribePartialResultsStability</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribePartialResultsStability} The enum <code>TranscribePartialResultsStability</code> value.
    */
