...
import CreateVoiceConnectorResponseVoiceConnector from './CreateVoiceConnectorResponseVoiceConnector';

/**
 * The GetVoiceConnectorResponse model module.
 * @module model/GetVoiceConnectorResponse
 * @version 2018-05-01
 */
class GetVoiceConnectorResponse {
    /**
     * Constructs a new <code>GetVoiceConnectorResponse</code>.
     * @alias module:model/GetVoiceConnectorResponse
     */
    constructor() { 
        
        GetVoiceConnectorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVoiceConnectorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVoiceConnectorResponse} obj Optional instance to populate.
     * @return {module:model/GetVoiceConnectorResponse} The populated <code>GetVoiceConnectorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVoiceConnectorResponse();

            if (data.hasOwnProperty('VoiceConnector')) {
                obj['VoiceConnector'] = CreateVoiceConnectorResponseVoiceConnector.constructFromObject(data['VoiceConnector']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVoiceConnectorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVoiceConnectorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VoiceConnector`
        if (data['VoiceConnector']) { // data not null
          CreateVoiceConnectorResponseVoiceConnector.validateJSON(data['VoiceConnector']);
        }
...
/**
 * @member {module:model/CreateVoiceConnectorResponseVoiceConnector} VoiceConnector
 */
GetVoiceConnectorResponse.prototype['VoiceConnector'] = undefined;
...
export default GetVoiceConnectorResponse;
