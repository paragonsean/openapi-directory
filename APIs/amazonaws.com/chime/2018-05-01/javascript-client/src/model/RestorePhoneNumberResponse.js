...
import GetPhoneNumberResponsePhoneNumber from './GetPhoneNumberResponsePhoneNumber';

/**
 * The RestorePhoneNumberResponse model module.
 * @module model/RestorePhoneNumberResponse
 * @version 2018-05-01
 */
class RestorePhoneNumberResponse {
    /**
     * Constructs a new <code>RestorePhoneNumberResponse</code>.
     * @alias module:model/RestorePhoneNumberResponse
     */
    constructor() { 
        
        RestorePhoneNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RestorePhoneNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RestorePhoneNumberResponse} obj Optional instance to populate.
     * @return {module:model/RestorePhoneNumberResponse} The populated <code>RestorePhoneNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestorePhoneNumberResponse();

            if (data.hasOwnProperty('PhoneNumber')) {
                obj['PhoneNumber'] = GetPhoneNumberResponsePhoneNumber.constructFromObject(data['PhoneNumber']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RestorePhoneNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RestorePhoneNumberResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PhoneNumber`
        if (data['PhoneNumber']) { // data not null
          GetPhoneNumberResponsePhoneNumber.validateJSON(data['PhoneNumber']);
        }
...
/**
 * @member {module:model/GetPhoneNumberResponsePhoneNumber} PhoneNumber
 */
RestorePhoneNumberResponse.prototype['PhoneNumber'] = undefined;
...
export default RestorePhoneNumberResponse;
