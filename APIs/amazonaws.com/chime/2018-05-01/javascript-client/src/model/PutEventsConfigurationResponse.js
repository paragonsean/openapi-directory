...
import PutEventsConfigurationResponseEventsConfiguration from './PutEventsConfigurationResponseEventsConfiguration';

/**
 * The PutEventsConfigurationResponse model module.
 * @module model/PutEventsConfigurationResponse
 * @version 2018-05-01
 */
class PutEventsConfigurationResponse {
    /**
     * Constructs a new <code>PutEventsConfigurationResponse</code>.
     * @alias module:model/PutEventsConfigurationResponse
     */
    constructor() { 
        
        PutEventsConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutEventsConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutEventsConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/PutEventsConfigurationResponse} The populated <code>PutEventsConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutEventsConfigurationResponse();

            if (data.hasOwnProperty('EventsConfiguration')) {
                obj['EventsConfiguration'] = PutEventsConfigurationResponseEventsConfiguration.constructFromObject(data['EventsConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutEventsConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutEventsConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EventsConfiguration`
        if (data['EventsConfiguration']) { // data not null
          PutEventsConfigurationResponseEventsConfiguration.validateJSON(data['EventsConfiguration']);
        }
...
/**
 * @member {module:model/PutEventsConfigurationResponseEventsConfiguration} EventsConfiguration
 */
PutEventsConfigurationResponse.prototype['EventsConfiguration'] = undefined;
...
export default PutEventsConfigurationResponse;
