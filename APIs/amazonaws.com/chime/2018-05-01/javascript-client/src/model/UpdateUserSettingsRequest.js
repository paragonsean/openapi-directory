...
import UpdateUserSettingsRequestUserSettings from './UpdateUserSettingsRequestUserSettings';

/**
 * The UpdateUserSettingsRequest model module.
 * @module model/UpdateUserSettingsRequest
 * @version 2018-05-01
 */
class UpdateUserSettingsRequest {
    /**
     * Constructs a new <code>UpdateUserSettingsRequest</code>.
     * @alias module:model/UpdateUserSettingsRequest
     * @param userSettings {module:model/UpdateUserSettingsRequestUserSettings} 
     */
    constructor(userSettings) { 
        
        UpdateUserSettingsRequest.initialize(this, userSettings);
    }
     ...
     */
    static initialize(obj, userSettings) { 
        obj['UserSettings'] = userSettings;
    }

    /**
     * Constructs a <code>UpdateUserSettingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserSettingsRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserSettingsRequest} The populated <code>UpdateUserSettingsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserSettingsRequest();

            if (data.hasOwnProperty('UserSettings')) {
                obj['UserSettings'] = UpdateUserSettingsRequestUserSettings.constructFromObject(data['UserSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserSettingsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserSettingsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateUserSettingsRequest.RequiredProperties) {
        ...
        if (data['UserSettings']) { // data not null
          UpdateUserSettingsRequestUserSettings.validateJSON(data['UserSettings']);
        }
...
UpdateUserSettingsRequest.RequiredProperties = ["UserSettings"];

/**
 * @member {module:model/UpdateUserSettingsRequestUserSettings} UserSettings
 */
UpdateUserSettingsRequest.prototype['UserSettings'] = undefined;
...
export default UpdateUserSettingsRequest;
