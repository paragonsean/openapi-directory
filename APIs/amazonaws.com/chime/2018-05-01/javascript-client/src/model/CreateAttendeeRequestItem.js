...
/**
 * The CreateAttendeeRequestItem model module.
 * @module model/CreateAttendeeRequestItem
 * @version 2018-05-01
 */
class CreateAttendeeRequestItem {
    /**
     * Constructs a new <code>CreateAttendeeRequestItem</code>.
     * The Amazon Chime SDK attendee fields to create, used with the BatchCreateAttendee action.
     * @alias module:model/CreateAttendeeRequestItem
     * @param externalUserId {String} 
     */
    constructor(externalUserId) { 
        
        CreateAttendeeRequestItem.initialize(this, externalUserId);
    }
    ...
    /**
     * Constructs a <code>CreateAttendeeRequestItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAttendeeRequestItem} obj Optional instance to populate.
     * @return {module:model/CreateAttendeeRequestItem} The populated <code>CreateAttendeeRequestItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAttendeeRequestItem();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAttendeeRequestItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAttendeeRequestItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateAttendeeRequestItem.RequiredProperties) {
...
CreateAttendeeRequestItem.RequiredProperties = ["ExternalUserId"];

/**
 * @member {String} ExternalUserId
 */
CreateAttendeeRequestItem.prototype['ExternalUserId'] = undefined;

/**
 * @member {Array} Tags
 */
CreateAttendeeRequestItem.prototype['Tags'] = undefined;
...
export default CreateAttendeeRequestItem;
