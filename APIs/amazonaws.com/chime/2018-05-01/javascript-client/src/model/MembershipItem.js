...
/**
 * The MembershipItem model module.
 * @module model/MembershipItem
 * @version 2018-05-01
 */
class MembershipItem {
    /**
     * Constructs a new <code>MembershipItem</code>.
     * Membership details, such as member ID and member role.
     * @alias module:model/MembershipItem
     */
    constructor() { 
        
        MembershipItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MembershipItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MembershipItem} obj Optional instance to populate.
     * @return {module:model/MembershipItem} The populated <code>MembershipItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MembershipItem();
    ...
    /**
     * Validates the JSON data with respect to <code>MembershipItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MembershipItem</code>.
     */
 ...
 */
MembershipItem.prototype['MemberId'] = undefined;

/**
 * @member {module:model/RoomMembershipRole} Role
 */
MembershipItem.prototype['Role'] = undefined;
