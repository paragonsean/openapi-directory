...
import GetVoiceConnectorProxyResponseProxy from './GetVoiceConnectorProxyResponseProxy';

/**
 * The GetVoiceConnectorProxyResponse model module.
 * @module model/GetVoiceConnectorProxyResponse
 * @version 2018-05-01
 */
class GetVoiceConnectorProxyResponse {
    /**
     * Constructs a new <code>GetVoiceConnectorProxyResponse</code>.
     * @alias module:model/GetVoiceConnectorProxyResponse
     */
    constructor() { 
        
        GetVoiceConnectorProxyResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVoiceConnectorProxyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVoiceConnectorProxyResponse} obj Optional instance to populate.
     * @return {module:model/GetVoiceConnectorProxyResponse} The populated <code>GetVoiceConnectorProxyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVoiceConnectorProxyResponse();

            if (data.hasOwnProperty('Proxy')) {
                obj['Proxy'] = GetVoiceConnectorProxyResponseProxy.constructFromObject(data['Proxy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVoiceConnectorProxyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVoiceConnectorProxyResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Proxy`
        if (data['Proxy']) { // data not null
          GetVoiceConnectorProxyResponseProxy.validateJSON(data['Proxy']);
        }
...
/**
 * @member {module:model/GetVoiceConnectorProxyResponseProxy} Proxy
 */
GetVoiceConnectorProxyResponse.prototype['Proxy'] = undefined;
...
export default GetVoiceConnectorProxyResponse;
