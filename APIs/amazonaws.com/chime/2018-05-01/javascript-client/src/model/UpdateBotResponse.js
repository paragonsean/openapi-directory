...
import UpdateBotResponseBot from './UpdateBotResponseBot';
...
class UpdateBotResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Bot')) {
                obj['Bot'] = UpdateBotResponseBot.constructFromObject(data['Bot']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Bot']) { // data not null
          UpdateBotResponseBot.validateJSON(data['Bot']);
        }
...
/**
 * @member {module:model/UpdateBotResponseBot} Bot
 */
UpdateBotResponse.prototype['Bot'] = undefined;
