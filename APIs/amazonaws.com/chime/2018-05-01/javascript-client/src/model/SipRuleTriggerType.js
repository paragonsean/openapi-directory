...
* @readonly
*/
export default class SipRuleTriggerType {
    ...
    /**
    * Returns a <code>SipRuleTriggerType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SipRuleTriggerType} The enum <code>SipRuleTriggerType</code> value.
    */
