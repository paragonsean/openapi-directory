...
import PutVoiceConnectorTerminationRequestTermination from './PutVoiceConnectorTerminationRequestTermination';

/**
 * The PutVoiceConnectorTerminationRequest model module.
 * @module model/PutVoiceConnectorTerminationRequest
 * @version 2018-05-01
 */
class PutVoiceConnectorTerminationRequest {
    /**
     * Constructs a new <code>PutVoiceConnectorTerminationRequest</code>.
     * @alias module:model/PutVoiceConnectorTerminationRequest
     * @param termination {module:model/PutVoiceConnectorTerminationRequestTermination} 
     */
    constructor(termination) { 
        
        PutVoiceConnectorTerminationRequest.initialize(this, termination);
    }
     ...
     */
    static initialize(obj, termination) { 
        obj['Termination'] = termination;
    }

    /**
     * Constructs a <code>PutVoiceConnectorTerminationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorTerminationRequest} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorTerminationRequest} The populated <code>PutVoiceConnectorTerminationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorTerminationRequest();

            if (data.hasOwnProperty('Termination')) {
                obj['Termination'] = PutVoiceConnectorTerminationRequestTermination.constructFromObject(data['Termination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorTerminationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorTerminationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutVoiceConnectorTerminationRequest.RequiredProperties) {
        ...
        if (data['Termination']) { // data not null
          PutVoiceConnectorTerminationRequestTermination.validateJSON(data['Termination']);
        }
...
PutVoiceConnectorTerminationRequest.RequiredProperties = ["Termination"];

/**
 * @member {module:model/PutVoiceConnectorTerminationRequestTermination} Termination
 */
PutVoiceConnectorTerminationRequest.prototype['Termination'] = undefined;
...
export default PutVoiceConnectorTerminationRequest;
