...
/**
 * The UpdateUserRequestItem model module.
 * @module model/UpdateUserRequestItem
 * @version 2018-05-01
 */
class UpdateUserRequestItem {
    /**
     * Constructs a new <code>UpdateUserRequestItem</code>.
     * The user ID and user fields to update, used with the &lt;a&gt;BatchUpdateUser&lt;/a&gt; action.
     * @alias module:model/UpdateUserRequestItem
     * @param userId {String} 
     */
    constructor(userId) { 
        
        UpdateUserRequestItem.initialize(this, userId);
    }
    ...
    /**
     * Constructs a <code>UpdateUserRequestItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserRequestItem} obj Optional instance to populate.
     * @return {module:model/UpdateUserRequestItem} The populated <code>UpdateUserRequestItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserRequestItem();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserRequestItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserRequestItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateUserRequestItem.RequiredProperties) {
...
UpdateUserRequestItem.RequiredProperties = ["UserId"];

/**
 * @member {String} UserId
 */
UpdateUserRequestItem.prototype['UserId'] = undefined;

/**
 * @member {module:model/License} LicenseType
 */
UpdateUserRequestItem.prototype['LicenseType'] = undefined;

/**
 * @member {module:model/UserType} UserType
 */
UpdateUserRequestItem.prototype['UserType'] = undefined;

/**
 * @member {module:model/UpdateUserRequestItemAlexaForBusinessMetadata} AlexaForBusinessMetadata
 */
UpdateUserRequestItem.prototype['AlexaForBusinessMetadata'] = undefined;
...
export default UpdateUserRequestItem;
