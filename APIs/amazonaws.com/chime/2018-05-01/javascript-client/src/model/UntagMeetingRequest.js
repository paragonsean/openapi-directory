...
/**
 * The UntagMeetingRequest model module.
 * @module model/UntagMeetingRequest
 * @version 2018-05-01
 */
class UntagMeetingRequest {
    /**
     * Constructs a new <code>UntagMeetingRequest</code>.
     * @alias module:model/UntagMeetingRequest
     * @param tagKeys {Array.<String>} The tag keys.
     */
    constructor(tagKeys) { 
        
        UntagMeetingRequest.initialize(this, tagKeys);
    }
    ...
    /**
     * Constructs a <code>UntagMeetingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagMeetingRequest} obj Optional instance to populate.
     * @return {module:model/UntagMeetingRequest} The populated <code>UntagMeetingRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagMeetingRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagMeetingRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagMeetingRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagMeetingRequest.RequiredProperties) {
...
UntagMeetingRequest.RequiredProperties = ["TagKeys"];

/**
 * The tag keys.
 * @member {Array.<String>} TagKeys
 */
UntagMeetingRequest.prototype['TagKeys'] = undefined;
...
export default UntagMeetingRequest;
