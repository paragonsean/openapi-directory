...
/**
 * The ListAttendeesResponse model module.
 * @module model/ListAttendeesResponse
 * @version 2018-05-01
 */
class ListAttendeesResponse {
    /**
     * Constructs a new <code>ListAttendeesResponse</code>.
     * @alias module:model/ListAttendeesResponse
     */
    constructor() { 
        
        ListAttendeesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAttendeesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAttendeesResponse} obj Optional instance to populate.
     * @return {module:model/ListAttendeesResponse} The populated <code>ListAttendeesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAttendeesResponse();

            if (data.hasOwnProperty('Attendees')) {
                obj['Attendees'] = ApiClient.convertToType(data['Attendees'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListAttendeesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAttendeesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Attendees`
        if (data['Attendees']) { // data not null
          Array.validateJSON(data['Attendees']);
        }
...
/**
 * @member {Array} Attendees
 */
ListAttendeesResponse.prototype['Attendees'] = undefined;

/**
 * @member {String} NextToken
 */
ListAttendeesResponse.prototype['NextToken'] = undefined;
...
export default ListAttendeesResponse;
