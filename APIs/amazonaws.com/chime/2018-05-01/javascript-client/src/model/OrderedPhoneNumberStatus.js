...
* @readonly
*/
export default class OrderedPhoneNumberStatus {
    ...
    /**
    * Returns a <code>OrderedPhoneNumberStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OrderedPhoneNumberStatus} The enum <code>OrderedPhoneNumberStatus</code> value.
    */
