...
import CreateProxySessionResponseProxySession from './CreateProxySessionResponseProxySession';

/**
 * The CreateProxySessionResponse model module.
 * @module model/CreateProxySessionResponse
 * @version 2018-05-01
 */
class CreateProxySessionResponse {
    /**
     * Constructs a new <code>CreateProxySessionResponse</code>.
     * @alias module:model/CreateProxySessionResponse
     */
    constructor() { 
        
        CreateProxySessionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateProxySessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProxySessionResponse} obj Optional instance to populate.
     * @return {module:model/CreateProxySessionResponse} The populated <code>CreateProxySessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProxySessionResponse();

            if (data.hasOwnProperty('ProxySession')) {
                obj['ProxySession'] = CreateProxySessionResponseProxySession.constructFromObject(data['ProxySession']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateProxySessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateProxySessionResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProxySession`
        if (data['ProxySession']) { // data not null
          CreateProxySessionResponseProxySession.validateJSON(data['ProxySession']);
        }
...
/**
 * @member {module:model/CreateProxySessionResponseProxySession} ProxySession
 */
CreateProxySessionResponse.prototype['ProxySession'] = undefined;
...
export default CreateProxySessionResponse;
