...
/**
 * The AssociatePhoneNumbersWithVoiceConnectorResponse model module.
 * @module model/AssociatePhoneNumbersWithVoiceConnectorResponse
 * @version 2018-05-01
 */
class AssociatePhoneNumbersWithVoiceConnectorResponse {
    /**
     * Constructs a new <code>AssociatePhoneNumbersWithVoiceConnectorResponse</code>.
     * @alias module:model/AssociatePhoneNumbersWithVoiceConnectorResponse
     */
    constructor() { 
        
        AssociatePhoneNumbersWithVoiceConnectorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociatePhoneNumbersWithVoiceConnectorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociatePhoneNumbersWithVoiceConnectorResponse} obj Optional instance to populate.
     * @return {module:model/AssociatePhoneNumbersWithVoiceConnectorResponse} The populated <code>AssociatePhoneNumbersWithVoiceConnectorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociatePhoneNumbersWithVoiceConnectorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociatePhoneNumbersWithVoiceConnectorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociatePhoneNumbersWithVoiceConnectorResponse</code>.
     */
 ...
 */
AssociatePhoneNumbersWithVoiceConnectorResponse.prototype['PhoneNumberErrors'] = undefined;
...
export default AssociatePhoneNumbersWithVoiceConnectorResponse;
