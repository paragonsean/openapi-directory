...
/**
 * The TagMeetingRequest model module.
 * @module model/TagMeetingRequest
 * @version 2018-05-01
 */
class TagMeetingRequest {
    /**
     * Constructs a new <code>TagMeetingRequest</code>.
     * @alias module:model/TagMeetingRequest
     * @param tags {Array.<module:model/Tag>} The tag key-value pairs.
     */
    constructor(tags) { 
        
        TagMeetingRequest.initialize(this, tags);
    }
    ...
    /**
     * Constructs a <code>TagMeetingRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagMeetingRequest} obj Optional instance to populate.
     * @return {module:model/TagMeetingRequest} The populated <code>TagMeetingRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagMeetingRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagMeetingRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagMeetingRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagMeetingRequest.RequiredProperties) {
...
TagMeetingRequest.RequiredProperties = ["Tags"];

/**
 * The tag key-value pairs.
 * @member {Array.<module:model/Tag>} Tags
 */
TagMeetingRequest.prototype['Tags'] = undefined;
...
export default TagMeetingRequest;
