...
import CreateMeetingResponseMeeting from './CreateMeetingResponseMeeting';

/**
 * The CreateMeetingResponse model module.
 * @module model/CreateMeetingResponse
 * @version 2018-05-01
 */
class CreateMeetingResponse {
    /**
     * Constructs a new <code>CreateMeetingResponse</code>.
     * @alias module:model/CreateMeetingResponse
     */
    constructor() { 
        
        CreateMeetingResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMeetingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMeetingResponse} obj Optional instance to populate.
     * @return {module:model/CreateMeetingResponse} The populated <code>CreateMeetingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMeetingResponse();

            if (data.hasOwnProperty('Meeting')) {
                obj['Meeting'] = CreateMeetingResponseMeeting.constructFromObject(data['Meeting']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMeetingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMeetingResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Meeting`
        if (data['Meeting']) { // data not null
          CreateMeetingResponseMeeting.validateJSON(data['Meeting']);
        }
...
/**
 * @member {module:model/CreateMeetingResponseMeeting} Meeting
 */
CreateMeetingResponse.prototype['Meeting'] = undefined;
