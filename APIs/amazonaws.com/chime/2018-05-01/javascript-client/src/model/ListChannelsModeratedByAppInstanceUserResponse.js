...
/**
 * The ListChannelsModeratedByAppInstanceUserResponse model module.
 * @module model/ListChannelsModeratedByAppInstanceUserResponse
 * @version 2018-05-01
 */
class ListChannelsModeratedByAppInstanceUserResponse {
    /**
     * Constructs a new <code>ListChannelsModeratedByAppInstanceUserResponse</code>.
     * @alias module:model/ListChannelsModeratedByAppInstanceUserResponse
     */
    constructor() { 
        
        ListChannelsModeratedByAppInstanceUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListChannelsModeratedByAppInstanceUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListChannelsModeratedByAppInstanceUserResponse} obj Optional instance to populate.
     * @return {module:model/ListChannelsModeratedByAppInstanceUserResponse} The populated <code>ListChannelsModeratedByAppInstanceUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListChannelsModeratedByAppInstanceUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListChannelsModeratedByAppInstanceUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListChannelsModeratedByAppInstanceUserResponse</code>.
     */
 ...
 */
ListChannelsModeratedByAppInstanceUserResponse.prototype['Channels'] = undefined;

/**
 * @member {String} NextToken
 */
ListChannelsModeratedByAppInstanceUserResponse.prototype['NextToken'] = undefined;
...
export default ListChannelsModeratedByAppInstanceUserResponse;
