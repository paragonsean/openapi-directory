...
/**
 * The BatchUnsuspendUserResponse model module.
 * @module model/BatchUnsuspendUserResponse
 * @version 2018-05-01
 */
class BatchUnsuspendUserResponse {
    /**
     * Constructs a new <code>BatchUnsuspendUserResponse</code>.
     * @alias module:model/BatchUnsuspendUserResponse
     */
    constructor() { 
        
        BatchUnsuspendUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchUnsuspendUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchUnsuspendUserResponse} obj Optional instance to populate.
     * @return {module:model/BatchUnsuspendUserResponse} The populated <code>BatchUnsuspendUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchUnsuspendUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchUnsuspendUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchUnsuspendUserResponse</code>.
     */
 ...
 */
BatchUnsuspendUserResponse.prototype['UserErrors'] = undefined;
...
export default BatchUnsuspendUserResponse;
