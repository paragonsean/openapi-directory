...
import ResetPersonalPINResponseUser from './ResetPersonalPINResponseUser';

/**
 * The ResetPersonalPINResponse model module.
 * @module model/ResetPersonalPINResponse
 * @version 2018-05-01
 */
class ResetPersonalPINResponse {
    /**
     * Constructs a new <code>ResetPersonalPINResponse</code>.
     * @alias module:model/ResetPersonalPINResponse
     */
    constructor() { 
        
        ResetPersonalPINResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResetPersonalPINResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResetPersonalPINResponse} obj Optional instance to populate.
     * @return {module:model/ResetPersonalPINResponse} The populated <code>ResetPersonalPINResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResetPersonalPINResponse();

            if (data.hasOwnProperty('User')) {
                obj['User'] = ResetPersonalPINResponseUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResetPersonalPINResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResetPersonalPINResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `User`
        if (data['User']) { // data not null
          ResetPersonalPINResponseUser.validateJSON(data['User']);
        }
...
/**
 * @member {module:model/ResetPersonalPINResponseUser} User
 */
ResetPersonalPINResponse.prototype['User'] = undefined;
...
export default ResetPersonalPINResponse;
