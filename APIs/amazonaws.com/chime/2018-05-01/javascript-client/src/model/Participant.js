...
class Participant {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ProxyPhoneNumber')) {
                obj['ProxyPhoneNumber'] = ApiClient.convertToType(data['ProxyPhoneNumber'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `ProxyPhoneNumber`
        if (data['ProxyPhoneNumber']) { // data not null
          String.validateJSON(data['ProxyPhoneNumber']);
        }
 ...
 */
Participant.prototype['PhoneNumber'] = undefined;

/**
 * @member {String} ProxyPhoneNumber
 */
Participant.prototype['ProxyPhoneNumber'] = undefined;
