...
* @readonly
*/
export default class PhoneNumberAssociationName {
    ...
    /**
    * Returns a <code>PhoneNumberAssociationName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PhoneNumberAssociationName} The enum <code>PhoneNumberAssociationName</code> value.
    */
