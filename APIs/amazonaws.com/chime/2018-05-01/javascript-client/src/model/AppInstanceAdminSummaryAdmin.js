...
/**
 * The AppInstanceAdminSummaryAdmin model module.
 * @module model/AppInstanceAdminSummaryAdmin
 * @version 2018-05-01
 */
class AppInstanceAdminSummaryAdmin {
    /**
     * Constructs a new <code>AppInstanceAdminSummaryAdmin</code>.
     * @alias module:model/AppInstanceAdminSummaryAdmin
     * @implements module:model/Identity
     */
    constructor() { 
        Identity.initialize(this);
        AppInstanceAdminSummaryAdmin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AppInstanceAdminSummaryAdmin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AppInstanceAdminSummaryAdmin} obj Optional instance to populate.
     * @return {module:model/AppInstanceAdminSummaryAdmin} The populated <code>AppInstanceAdminSummaryAdmin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AppInstanceAdminSummaryAdmin();
    ...
    /**
     * Validates the JSON data with respect to <code>AppInstanceAdminSummaryAdmin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AppInstanceAdminSummaryAdmin</code>.
     */
 ...
 * @member {String} Arn
 */
AppInstanceAdminSummaryAdmin.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
AppInstanceAdminSummaryAdmin.prototype['Name'] = undefined;
...
export default AppInstanceAdminSummaryAdmin;
