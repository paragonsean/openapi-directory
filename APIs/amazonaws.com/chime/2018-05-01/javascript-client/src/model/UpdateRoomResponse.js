...
import CreateRoomResponseRoom from './CreateRoomResponseRoom';

/**
 * The UpdateRoomResponse model module.
 * @module model/UpdateRoomResponse
 * @version 2018-05-01
 */
class UpdateRoomResponse {
    /**
     * Constructs a new <code>UpdateRoomResponse</code>.
     * @alias module:model/UpdateRoomResponse
     */
    constructor() { 
        
        UpdateRoomResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRoomResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRoomResponse} obj Optional instance to populate.
     * @return {module:model/UpdateRoomResponse} The populated <code>UpdateRoomResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRoomResponse();

            if (data.hasOwnProperty('Room')) {
                obj['Room'] = CreateRoomResponseRoom.constructFromObject(data['Room']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRoomResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRoomResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Room`
        if (data['Room']) { // data not null
          CreateRoomResponseRoom.validateJSON(data['Room']);
        }
...
/**
 * @member {module:model/CreateRoomResponseRoom} Room
 */
UpdateRoomResponse.prototype['Room'] = undefined;
...
export default UpdateRoomResponse;
