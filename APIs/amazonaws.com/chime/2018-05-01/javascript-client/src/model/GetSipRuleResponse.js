...
import GetSipRuleResponseSipRule from './GetSipRuleResponseSipRule';

/**
 * The GetSipRuleResponse model module.
 * @module model/GetSipRuleResponse
 * @version 2018-05-01
 */
class GetSipRuleResponse {
    /**
     * Constructs a new <code>GetSipRuleResponse</code>.
     * @alias module:model/GetSipRuleResponse
     */
    constructor() { 
        
        GetSipRuleResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSipRuleResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSipRuleResponse} obj Optional instance to populate.
     * @return {module:model/GetSipRuleResponse} The populated <code>GetSipRuleResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSipRuleResponse();

            if (data.hasOwnProperty('SipRule')) {
                obj['SipRule'] = GetSipRuleResponseSipRule.constructFromObject(data['SipRule']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetSipRuleResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSipRuleResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipRule`
        if (data['SipRule']) { // data not null
          GetSipRuleResponseSipRule.validateJSON(data['SipRule']);
        }
...
/**
 * @member {module:model/GetSipRuleResponseSipRule} SipRule
 */
GetSipRuleResponse.prototype['SipRule'] = undefined;
...
export default GetSipRuleResponse;
