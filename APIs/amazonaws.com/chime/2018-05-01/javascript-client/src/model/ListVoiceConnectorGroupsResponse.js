...
/**
 * The ListVoiceConnectorGroupsResponse model module.
 * @module model/ListVoiceConnectorGroupsResponse
 * @version 2018-05-01
 */
class ListVoiceConnectorGroupsResponse {
    /**
     * Constructs a new <code>ListVoiceConnectorGroupsResponse</code>.
     * @alias module:model/ListVoiceConnectorGroupsResponse
     */
    constructor() { 
        
        ListVoiceConnectorGroupsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVoiceConnectorGroupsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVoiceConnectorGroupsResponse} obj Optional instance to populate.
     * @return {module:model/ListVoiceConnectorGroupsResponse} The populated <code>ListVoiceConnectorGroupsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVoiceConnectorGroupsResponse();

            if (data.hasOwnProperty('VoiceConnectorGroups')) {
                obj['VoiceConnectorGroups'] = ApiClient.convertToType(data['VoiceConnectorGroups'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVoiceConnectorGroupsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVoiceConnectorGroupsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VoiceConnectorGroups`
        if (data['VoiceConnectorGroups']) { // data not null
          Array.validateJSON(data['VoiceConnectorGroups']);
        }
...
/**
 * @member {Array} VoiceConnectorGroups
 */
ListVoiceConnectorGroupsResponse.prototype['VoiceConnectorGroups'] = undefined;

/**
 * @member {String} NextToken
 */
ListVoiceConnectorGroupsResponse.prototype['NextToken'] = undefined;
...
export default ListVoiceConnectorGroupsResponse;
