...
/**
 * The CreatePhoneNumberOrderResponse model module.
 * @module model/CreatePhoneNumberOrderResponse
 * @version 2018-05-01
 */
class CreatePhoneNumberOrderResponse {
    /**
     * Constructs a new <code>CreatePhoneNumberOrderResponse</code>.
     * @alias module:model/CreatePhoneNumberOrderResponse
     */
    constructor() { 
        
        CreatePhoneNumberOrderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePhoneNumberOrderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePhoneNumberOrderResponse} obj Optional instance to populate.
     * @return {module:model/CreatePhoneNumberOrderResponse} The populated <code>CreatePhoneNumberOrderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePhoneNumberOrderResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePhoneNumberOrderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePhoneNumberOrderResponse</code>.
     */
 ...
 */
CreatePhoneNumberOrderResponse.prototype['PhoneNumberOrder'] = undefined;
...
export default CreatePhoneNumberOrderResponse;
