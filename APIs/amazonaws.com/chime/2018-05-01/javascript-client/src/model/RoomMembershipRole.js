...
* @readonly
*/
export default class RoomMembershipRole {
    ...
    /**
    * Returns a <code>RoomMembershipRole</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RoomMembershipRole} The enum <code>RoomMembershipRole</code> value.
    */
