...
/**
 * The SipRuleTargetApplication model module.
 * @module model/SipRuleTargetApplication
 * @version 2018-05-01
 */
class SipRuleTargetApplication {
    /**
     * Constructs a new <code>SipRuleTargetApplication</code>.
     * Target SIP media application and other details, such as priority and AWS Region, to be specified in the SIP rule. Only one SIP rule per AWS Region can be provided.
     * @alias module:model/SipRuleTargetApplication
     */
    constructor() { 
        
        SipRuleTargetApplication.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SipRuleTargetApplication</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SipRuleTargetApplication} obj Optional instance to populate.
     * @return {module:model/SipRuleTargetApplication} The populated <code>SipRuleTargetApplication</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SipRuleTargetApplication();
    ...
    /**
     * Validates the JSON data with respect to <code>SipRuleTargetApplication</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SipRuleTargetApplication</code>.
     */
 ...
 */
SipRuleTargetApplication.prototype['SipMediaApplicationId'] = undefined;

/**
 * @member {Number} Priority
 */
SipRuleTargetApplication.prototype['Priority'] = undefined;

/**
 * @member {String} AwsRegion
 */
SipRuleTargetApplication.prototype['AwsRegion'] = undefined;
...
export default SipRuleTargetApplication;
