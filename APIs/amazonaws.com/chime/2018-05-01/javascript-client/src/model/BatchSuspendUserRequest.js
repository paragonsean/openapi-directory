...
/**
 * The BatchSuspendUserRequest model module.
 * @module model/BatchSuspendUserRequest
 * @version 2018-05-01
 */
class BatchSuspendUserRequest {
    /**
     * Constructs a new <code>BatchSuspendUserRequest</code>.
     * @alias module:model/BatchSuspendUserRequest
     * @param userIdList {Array.<String>} The request containing the user IDs to suspend.
     */
    constructor(userIdList) { 
        
        BatchSuspendUserRequest.initialize(this, userIdList);
    }
     ...
     */
    static initialize(obj, userIdList) { 
        obj['UserIdList'] = userIdList;
    }

    /**
     * Constructs a <code>BatchSuspendUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchSuspendUserRequest} obj Optional instance to populate.
     * @return {module:model/BatchSuspendUserRequest} The populated <code>BatchSuspendUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchSuspendUserRequest();

            if (data.hasOwnProperty('UserIdList')) {
                obj['UserIdList'] = ApiClient.convertToType(data['UserIdList'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchSuspendUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchSuspendUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BatchSuspendUserRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['UserIdList'])) {
            throw new Error("Expected the field `UserIdList` to be an array in the JSON data but got " + data['UserIdList']);
        }
...
BatchSuspendUserRequest.RequiredProperties = ["UserIdList"];

/**
 * The request containing the user IDs to suspend.
 * @member {Array.<String>} UserIdList
 */
BatchSuspendUserRequest.prototype['UserIdList'] = undefined;
...
export default BatchSuspendUserRequest;
