...
* @readonly
*/
export default class ContentMuxType {
    ...
    /**
    * Returns a <code>ContentMuxType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ContentMuxType} The enum <code>ContentMuxType</code> value.
    */
