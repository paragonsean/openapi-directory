...
* @readonly
*/
export default class ChannelMode {
    ...
    /**
    * Returns a <code>ChannelMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChannelMode} The enum <code>ChannelMode</code> value.
    */
