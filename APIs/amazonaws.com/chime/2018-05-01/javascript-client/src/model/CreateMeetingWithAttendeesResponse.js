...
import CreateMeetingWithAttendeesResponseMeeting from './CreateMeetingWithAttendeesResponseMeeting';

/**
 * The CreateMeetingWithAttendeesResponse model module.
 * @module model/CreateMeetingWithAttendeesResponse
 * @version 2018-05-01
 */
class CreateMeetingWithAttendeesResponse {
    /**
     * Constructs a new <code>CreateMeetingWithAttendeesResponse</code>.
     * @alias module:model/CreateMeetingWithAttendeesResponse
     */
    constructor() { 
        
        CreateMeetingWithAttendeesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateMeetingWithAttendeesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateMeetingWithAttendeesResponse} obj Optional instance to populate.
     * @return {module:model/CreateMeetingWithAttendeesResponse} The populated <code>CreateMeetingWithAttendeesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateMeetingWithAttendeesResponse();

            if (data.hasOwnProperty('Meeting')) {
                obj['Meeting'] = CreateMeetingWithAttendeesResponseMeeting.constructFromObject(data['Meeting']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateMeetingWithAttendeesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateMeetingWithAttendeesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Meeting`
        if (data['Meeting']) { // data not null
          CreateMeetingWithAttendeesResponseMeeting.validateJSON(data['Meeting']);
        }
...
/**
 * @member {module:model/CreateMeetingWithAttendeesResponseMeeting} Meeting
 */
CreateMeetingWithAttendeesResponse.prototype['Meeting'] = undefined;

/**
 * @member {Array} Attendees
 */
CreateMeetingWithAttendeesResponse.prototype['Attendees'] = undefined;

/**
 * @member {Array} Errors
 */
CreateMeetingWithAttendeesResponse.prototype['Errors'] = undefined;
...
export default CreateMeetingWithAttendeesResponse;
