...
/**
 * The ListMeetingsResponse model module.
 * @module model/ListMeetingsResponse
 * @version 2018-05-01
 */
class ListMeetingsResponse {
    /**
     * Constructs a new <code>ListMeetingsResponse</code>.
     * @alias module:model/ListMeetingsResponse
     */
    constructor() { 
        
        ListMeetingsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListMeetingsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListMeetingsResponse} obj Optional instance to populate.
     * @return {module:model/ListMeetingsResponse} The populated <code>ListMeetingsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListMeetingsResponse();

            if (data.hasOwnProperty('Meetings')) {
                obj['Meetings'] = ApiClient.convertToType(data['Meetings'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListMeetingsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListMeetingsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Meetings`
        if (data['Meetings']) { // data not null
          Array.validateJSON(data['Meetings']);
        }
...
/**
 * @member {Array} Meetings
 */
ListMeetingsResponse.prototype['Meetings'] = undefined;

/**
 * @member {String} NextToken
 */
ListMeetingsResponse.prototype['NextToken'] = undefined;
...
export default ListMeetingsResponse;
