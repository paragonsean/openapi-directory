...
/**
 * The ListSipMediaApplicationsResponse model module.
 * @module model/ListSipMediaApplicationsResponse
 * @version 2018-05-01
 */
class ListSipMediaApplicationsResponse {
    /**
     * Constructs a new <code>ListSipMediaApplicationsResponse</code>.
     * @alias module:model/ListSipMediaApplicationsResponse
     */
    constructor() { 
        
        ListSipMediaApplicationsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSipMediaApplicationsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSipMediaApplicationsResponse} obj Optional instance to populate.
     * @return {module:model/ListSipMediaApplicationsResponse} The populated <code>ListSipMediaApplicationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSipMediaApplicationsResponse();

            if (data.hasOwnProperty('SipMediaApplications')) {
                obj['SipMediaApplications'] = ApiClient.convertToType(data['SipMediaApplications'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSipMediaApplicationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSipMediaApplicationsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipMediaApplications`
        if (data['SipMediaApplications']) { // data not null
          Array.validateJSON(data['SipMediaApplications']);
        }
...
/**
 * @member {Array} SipMediaApplications
 */
ListSipMediaApplicationsResponse.prototype['SipMediaApplications'] = undefined;

/**
 * @member {String} NextToken
 */
ListSipMediaApplicationsResponse.prototype['NextToken'] = undefined;
...
export default ListSipMediaApplicationsResponse;
