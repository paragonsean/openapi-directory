...
/**
 * The ListRoomsResponse model module.
 * @module model/ListRoomsResponse
 * @version 2018-05-01
 */
class ListRoomsResponse {
    /**
     * Constructs a new <code>ListRoomsResponse</code>.
     * @alias module:model/ListRoomsResponse
     */
    constructor() { 
        
        ListRoomsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRoomsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRoomsResponse} obj Optional instance to populate.
     * @return {module:model/ListRoomsResponse} The populated <code>ListRoomsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRoomsResponse();

            if (data.hasOwnProperty('Rooms')) {
                obj['Rooms'] = ApiClient.convertToType(data['Rooms'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListRoomsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRoomsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Rooms`
        if (data['Rooms']) { // data not null
          Array.validateJSON(data['Rooms']);
        }
 ...
 * @member {Array} Rooms
 */
ListRoomsResponse.prototype['Rooms'] = undefined;

/**
 * @member {String} NextToken
 */
ListRoomsResponse.prototype['NextToken'] = undefined;
...
export default ListRoomsResponse;
