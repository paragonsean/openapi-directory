...
* @readonly
*/
export default class TranscribeMedicalLanguageCode {
    ...
    /**
    * Returns a <code>TranscribeMedicalLanguageCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeMedicalLanguageCode} The enum <code>TranscribeMedicalLanguageCode</code> value.
    */
