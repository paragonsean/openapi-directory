...
* @readonly
*/
export default class TranscribeContentRedactionType {
    ...
    /**
    * Returns a <code>TranscribeContentRedactionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeContentRedactionType} The enum <code>TranscribeContentRedactionType</code> value.
    */
