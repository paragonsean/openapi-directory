...
/**
 * The UpdatePhoneNumberRequestItem model module.
 * @module model/UpdatePhoneNumberRequestItem
 * @version 2018-05-01
 */
class UpdatePhoneNumberRequestItem {
    /**
     * Constructs a new <code>UpdatePhoneNumberRequestItem</code>.
     ...
     * @alias module:model/UpdatePhoneNumberRequestItem
     * @param phoneNumberId {String} 
     */
    constructor(phoneNumberId) { 
        
        UpdatePhoneNumberRequestItem.initialize(this, phoneNumberId);
    }
    ...
    /**
     * Constructs a <code>UpdatePhoneNumberRequestItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePhoneNumberRequestItem} obj Optional instance to populate.
     * @return {module:model/UpdatePhoneNumberRequestItem} The populated <code>UpdatePhoneNumberRequestItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePhoneNumberRequestItem();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePhoneNumberRequestItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePhoneNumberRequestItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePhoneNumberRequestItem.RequiredProperties) {
...
UpdatePhoneNumberRequestItem.RequiredProperties = ["PhoneNumberId"];

/**
 * @member {String} PhoneNumberId
 */
UpdatePhoneNumberRequestItem.prototype['PhoneNumberId'] = undefined;

/**
 * @member {module:model/PhoneNumberProductType} ProductType
 */
UpdatePhoneNumberRequestItem.prototype['ProductType'] = undefined;

/**
 * @member {String} CallingName
 */
UpdatePhoneNumberRequestItem.prototype['CallingName'] = undefined;
...
export default UpdatePhoneNumberRequestItem;
