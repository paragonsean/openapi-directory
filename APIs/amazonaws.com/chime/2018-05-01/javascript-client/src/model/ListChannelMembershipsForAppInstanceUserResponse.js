...
/**
 * The ListChannelMembershipsForAppInstanceUserResponse model module.
 * @module model/ListChannelMembershipsForAppInstanceUserResponse
 * @version 2018-05-01
 */
class ListChannelMembershipsForAppInstanceUserResponse {
    /**
     * Constructs a new <code>ListChannelMembershipsForAppInstanceUserResponse</code>.
     * @alias module:model/ListChannelMembershipsForAppInstanceUserResponse
     */
    constructor() { 
        
        ListChannelMembershipsForAppInstanceUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListChannelMembershipsForAppInstanceUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListChannelMembershipsForAppInstanceUserResponse} obj Optional instance to populate.
     * @return {module:model/ListChannelMembershipsForAppInstanceUserResponse} The populated <code>ListChannelMembershipsForAppInstanceUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListChannelMembershipsForAppInstanceUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListChannelMembershipsForAppInstanceUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListChannelMembershipsForAppInstanceUserResponse</code>.
     */
 ...
 */
ListChannelMembershipsForAppInstanceUserResponse.prototype['ChannelMemberships'] = undefined;

/**
 * @member {String} NextToken
 */
ListChannelMembershipsForAppInstanceUserResponse.prototype['NextToken'] = undefined;
...
export default ListChannelMembershipsForAppInstanceUserResponse;
