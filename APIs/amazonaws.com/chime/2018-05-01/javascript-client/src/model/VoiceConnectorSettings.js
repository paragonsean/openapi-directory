...
/**
 * The VoiceConnectorSettings model module.
 * @module model/VoiceConnectorSettings
 * @version 2018-05-01
 */
class VoiceConnectorSettings {
    /**
     * Constructs a new <code>VoiceConnectorSettings</code>.
     * The Amazon Chime Voice Connector settings. Includes any Amazon S3 buckets designated for storing call detail records.
     * @alias module:model/VoiceConnectorSettings
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VoiceConnectorSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VoiceConnectorSettings} obj Optional instance to populate.
     * @return {module:model/VoiceConnectorSettings} The populated <code>VoiceConnectorSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoiceConnectorSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>VoiceConnectorSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoiceConnectorSettings</code>.
     */
...
export default VoiceConnectorSettings;
