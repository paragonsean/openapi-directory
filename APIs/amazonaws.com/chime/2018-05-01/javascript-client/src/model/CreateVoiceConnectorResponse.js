...
/**
 * The CreateVoiceConnectorResponse model module.
 * @module model/CreateVoiceConnectorResponse
 * @version 2018-05-01
 */
class CreateVoiceConnectorResponse {
    /**
     * Constructs a new <code>CreateVoiceConnectorResponse</code>.
     * @alias module:model/CreateVoiceConnectorResponse
     */
    constructor() { 
        
        CreateVoiceConnectorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateVoiceConnectorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateVoiceConnectorResponse} obj Optional instance to populate.
     * @return {module:model/CreateVoiceConnectorResponse} The populated <code>CreateVoiceConnectorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateVoiceConnectorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateVoiceConnectorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateVoiceConnectorResponse</code>.
     */
 ...
 */
CreateVoiceConnectorResponse.prototype['VoiceConnector'] = undefined;
...
export default CreateVoiceConnectorResponse;
