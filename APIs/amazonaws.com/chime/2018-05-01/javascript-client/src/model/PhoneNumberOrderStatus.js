...
* @readonly
*/
export default class PhoneNumberOrderStatus {
    ...
    /**
    * Returns a <code>PhoneNumberOrderStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PhoneNumberOrderStatus} The enum <code>PhoneNumberOrderStatus</code> value.
    */
