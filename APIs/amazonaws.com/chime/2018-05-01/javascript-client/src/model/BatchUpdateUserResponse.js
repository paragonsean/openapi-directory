...
/**
 * The BatchUpdateUserResponse model module.
 * @module model/BatchUpdateUserResponse
 * @version 2018-05-01
 */
class BatchUpdateUserResponse {
    /**
     * Constructs a new <code>BatchUpdateUserResponse</code>.
     * @alias module:model/BatchUpdateUserResponse
     */
    constructor() { 
        
        BatchUpdateUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchUpdateUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchUpdateUserResponse} obj Optional instance to populate.
     * @return {module:model/BatchUpdateUserResponse} The populated <code>BatchUpdateUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchUpdateUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchUpdateUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchUpdateUserResponse</code>.
     */
 ...
 */
BatchUpdateUserResponse.prototype['UserErrors'] = undefined;
...
export default BatchUpdateUserResponse;
