...
/**
 * The UpdateProxySessionRequest model module.
 * @module model/UpdateProxySessionRequest
 * @version 2018-05-01
 */
class UpdateProxySessionRequest {
    /**
     * Constructs a new <code>UpdateProxySessionRequest</code>.
     * @alias module:model/UpdateProxySessionRequest
     * @param capabilities {Array.<module:model/Capability>} The proxy session capabilities.
     */
    constructor(capabilities) { 
        
        UpdateProxySessionRequest.initialize(this, capabilities);
    }
    ...
    /**
     * Constructs a <code>UpdateProxySessionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateProxySessionRequest} obj Optional instance to populate.
     * @return {module:model/UpdateProxySessionRequest} The populated <code>UpdateProxySessionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateProxySessionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateProxySessionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateProxySessionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateProxySessionRequest.RequiredProperties) {
...
UpdateProxySessionRequest.RequiredProperties = ["Capabilities"];

/**
 * The proxy session capabilities.
 * @member {Array.<module:model/Capability>} Capabilities
 */
UpdateProxySessionRequest.prototype['Capabilities'] = undefined;

/**
 * The number of minutes allowed for the proxy session.
 * @member {Number} ExpiryMinutes
 */
UpdateProxySessionRequest.prototype['ExpiryMinutes'] = undefined;
...
export default UpdateProxySessionRequest;
