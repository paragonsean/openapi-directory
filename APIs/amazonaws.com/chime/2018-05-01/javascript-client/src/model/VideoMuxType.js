...
* @readonly
*/
export default class VideoMuxType {
    ...
    /**
    * Returns a <code>VideoMuxType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VideoMuxType} The enum <code>VideoMuxType</code> value.
    */
