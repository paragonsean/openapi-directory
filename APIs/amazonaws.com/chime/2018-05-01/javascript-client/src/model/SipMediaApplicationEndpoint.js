...
/**
 * The SipMediaApplicationEndpoint model module.
 * @module model/SipMediaApplicationEndpoint
 * @version 2018-05-01
 */
class SipMediaApplicationEndpoint {
    /**
     * Constructs a new <code>SipMediaApplicationEndpoint</code>.
     * The endpoint assigned to the SIP media application.
     * @alias module:model/SipMediaApplicationEndpoint
     */
    constructor() { 
        
        SipMediaApplicationEndpoint.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SipMediaApplicationEndpoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SipMediaApplicationEndpoint} obj Optional instance to populate.
     * @return {module:model/SipMediaApplicationEndpoint} The populated <code>SipMediaApplicationEndpoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SipMediaApplicationEndpoint();
    ...
    /**
     * Validates the JSON data with respect to <code>SipMediaApplicationEndpoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SipMediaApplicationEndpoint</code>.
     */
 ...
 */
SipMediaApplicationEndpoint.prototype['LambdaArn'] = undefined;
...
export default SipMediaApplicationEndpoint;
