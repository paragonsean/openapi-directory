...
/**
 * The SipMediaApplication model module.
 * @module model/SipMediaApplication
 * @version 2018-05-01
 */
class SipMediaApplication {
    /**
     * Constructs a new <code>SipMediaApplication</code>.
     * The details of the SIP media application, including name and endpoints. An AWS account can have multiple SIP media applications.
     * @alias module:model/SipMediaApplication
     */
    constructor() { 
        
        SipMediaApplication.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SipMediaApplication</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SipMediaApplication} obj Optional instance to populate.
     * @return {module:model/SipMediaApplication} The populated <code>SipMediaApplication</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SipMediaApplication();

            if (data.hasOwnProperty('SipMediaApplicationId')) {
                obj['SipMediaApplicationId'] = ApiClient.convertToType(data['SipMediaApplicationId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SipMediaApplication</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SipMediaApplication</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipMediaApplicationId`
        if (data['SipMediaApplicationId']) { // data not null
          String.validateJSON(data['SipMediaApplicationId']);
        }
...
/**
 * @member {String} SipMediaApplicationId
 */
SipMediaApplication.prototype['SipMediaApplicationId'] = undefined;

/**
 * @member {String} AwsRegion
 */
SipMediaApplication.prototype['AwsRegion'] = undefined;

/**
 * @member {String} Name
 */
SipMediaApplication.prototype['Name'] = undefined;

/**
 * @member {Array} Endpoints
 */
SipMediaApplication.prototype['Endpoints'] = undefined;

/**
 * @member {Date} CreatedTimestamp
 */
SipMediaApplication.prototype['CreatedTimestamp'] = undefined;

/**
 * @member {Date} UpdatedTimestamp
 */
SipMediaApplication.prototype['UpdatedTimestamp'] = undefined;
...
export default SipMediaApplication;
