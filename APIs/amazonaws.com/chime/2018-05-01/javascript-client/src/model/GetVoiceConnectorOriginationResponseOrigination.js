...
/**
 * The GetVoiceConnectorOriginationResponseOrigination model module.
 * @module model/GetVoiceConnectorOriginationResponseOrigination
 * @version 2018-05-01
 */
class GetVoiceConnectorOriginationResponseOrigination {
    /**
     * Constructs a new <code>GetVoiceConnectorOriginationResponseOrigination</code>.
     * @alias module:model/GetVoiceConnectorOriginationResponseOrigination
     * @implements module:model/Origination
     */
    constructor() { 
        Origination.initialize(this);
        GetVoiceConnectorOriginationResponseOrigination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVoiceConnectorOriginationResponseOrigination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVoiceConnectorOriginationResponseOrigination} obj Optional instance to populate.
     * @return {module:model/GetVoiceConnectorOriginationResponseOrigination} The populated <code>GetVoiceConnectorOriginationResponseOrigination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVoiceConnectorOriginationResponseOrigination();
    ...
    /**
     * Validates the JSON data with respect to <code>GetVoiceConnectorOriginationResponseOrigination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVoiceConnectorOriginationResponseOrigination</code>.
     */
 ...
 * @member {Array} Routes
 */
GetVoiceConnectorOriginationResponseOrigination.prototype['Routes'] = undefined;

/**
 * @member {Boolean} Disabled
 */
GetVoiceConnectorOriginationResponseOrigination.prototype['Disabled'] = undefined;
...
export default GetVoiceConnectorOriginationResponseOrigination;
