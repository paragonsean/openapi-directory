...
/**
 * The CreateRoomResponseRoom model module.
 * @module model/CreateRoomResponseRoom
 * @version 2018-05-01
 */
class CreateRoomResponseRoom {
    /**
     * Constructs a new <code>CreateRoomResponseRoom</code>.
     * @alias module:model/CreateRoomResponseRoom
     * @implements module:model/Room
     */
    constructor() { 
        Room.initialize(this);
        CreateRoomResponseRoom.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRoomResponseRoom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomResponseRoom} obj Optional instance to populate.
     * @return {module:model/CreateRoomResponseRoom} The populated <code>CreateRoomResponseRoom</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomResponseRoom();
            Room.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomResponseRoom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomResponseRoom</code>.
     */
 ...
 */
CreateRoomResponseRoom.prototype['RoomId'] = undefined;

/**
 * @member {String} Name
 */
CreateRoomResponseRoom.prototype['Name'] = undefined;

/**
 * @member {String} AccountId
 */
CreateRoomResponseRoom.prototype['AccountId'] = undefined;

/**
 * @member {String} CreatedBy
 */
CreateRoomResponseRoom.prototype['CreatedBy'] = undefined;

/**
 * @member {Date} CreatedTimestamp
 */
CreateRoomResponseRoom.prototype['CreatedTimestamp'] = undefined;

/**
 * @member {Date} UpdatedTimestamp
 */
CreateRoomResponseRoom.prototype['UpdatedTimestamp'] = undefined;
 ...
 * @member {String} AccountId
 */
Room.prototype['AccountId'] = undefined;
/**
 * @member {String} CreatedBy
 */
Room.prototype['CreatedBy'] = undefined;
/**
 * @member {Date} CreatedTimestamp
 */
Room.prototype['CreatedTimestamp'] = undefined;
/**
 * @member {Date} UpdatedTimestamp
 */
Room.prototype['UpdatedTimestamp'] = undefined;




export default CreateRoomResponseRoom;
