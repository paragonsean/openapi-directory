...
/**
 * The BusinessCallingSettings model module.
 * @module model/BusinessCallingSettings
 * @version 2018-05-01
 */
class BusinessCallingSettings {
    /**
     * Constructs a new <code>BusinessCallingSettings</code>.
     * The Amazon Chime Business Calling settings for the administrator&#39;s AWS account. Includes any Amazon S3 buckets designated for storing call detail records.
     * @alias module:model/BusinessCallingSettings
     */
    constructor() { 
        
        BusinessCallingSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BusinessCallingSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BusinessCallingSettings} obj Optional instance to populate.
     * @return {module:model/BusinessCallingSettings} The populated <code>BusinessCallingSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BusinessCallingSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>BusinessCallingSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BusinessCallingSettings</code>.
     */
 ...
 */
BusinessCallingSettings.prototype['CdrBucket'] = undefined;
...
export default BusinessCallingSettings;
