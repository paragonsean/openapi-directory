...
/**
 * The EmergencyCallingConfiguration model module.
 * @module model/EmergencyCallingConfiguration
 * @version 2018-05-01
 */
class EmergencyCallingConfiguration {
    /**
     * Constructs a new <code>EmergencyCallingConfiguration</code>.
     * The emergency calling configuration details associated with an Amazon Chime Voice Connector.
     * @alias module:model/EmergencyCallingConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EmergencyCallingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmergencyCallingConfiguration} obj Optional instance to populate.
     * @return {module:model/EmergencyCallingConfiguration} The populated <code>EmergencyCallingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmergencyCallingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>EmergencyCallingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmergencyCallingConfiguration</code>.
     */
...
export default EmergencyCallingConfiguration;
