...
/**
 * The RegenerateSecurityTokenResponseBot model module.
 * @module model/RegenerateSecurityTokenResponseBot
 * @version 2018-05-01
 */
class RegenerateSecurityTokenResponseBot {
    /**
     * Constructs a new <code>RegenerateSecurityTokenResponseBot</code>.
     * @alias module:model/RegenerateSecurityTokenResponseBot
     * @implements module:model/Bot
     */
    constructor() { 
        Bot.initialize(this);
        RegenerateSecurityTokenResponseBot.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegenerateSecurityTokenResponseBot</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegenerateSecurityTokenResponseBot} obj Optional instance to populate.
     * @return {module:model/RegenerateSecurityTokenResponseBot} The populated <code>RegenerateSecurityTokenResponseBot</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegenerateSecurityTokenResponseBot();
    ...
    /**
     * Validates the JSON data with respect to <code>RegenerateSecurityTokenResponseBot</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegenerateSecurityTokenResponseBot</code>.
     */
 ...
 * @member {String} BotId
 */
RegenerateSecurityTokenResponseBot.prototype['BotId'] = undefined;

/**
 * @member {String} UserId
 */
RegenerateSecurityTokenResponseBot.prototype['UserId'] = undefined;

/**
 * @member {String} DisplayName
 */
RegenerateSecurityTokenResponseBot.prototype['DisplayName'] = undefined;

/**
 * @member {module:model/BotType} BotType
 */
RegenerateSecurityTokenResponseBot.prototype['BotType'] = undefined;

/**
 * @member {Boolean} Disabled
 */
RegenerateSecurityTokenResponseBot.prototype['Disabled'] = undefined;

/**
 * @member {Date} CreatedTimestamp
 */
RegenerateSecurityTokenResponseBot.prototype['CreatedTimestamp'] = undefined;

/**
 * @member {Date} UpdatedTimestamp
 */
RegenerateSecurityTokenResponseBot.prototype['UpdatedTimestamp'] = undefined;

/**
 * @member {String} BotEmail
 */
RegenerateSecurityTokenResponseBot.prototype['BotEmail'] = undefined;

/**
 * @member {String} SecurityToken
 */
RegenerateSecurityTokenResponseBot.prototype['SecurityToken'] = undefined;
...
export default RegenerateSecurityTokenResponseBot;
