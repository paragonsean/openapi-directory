...
/**
 * The StreamingNotificationTarget model module.
 * @module model/StreamingNotificationTarget
 * @version 2018-05-01
 */
class StreamingNotificationTarget {
    /**
     * Constructs a new <code>StreamingNotificationTarget</code>.
     * The targeted recipient for a streaming configuration notification.
     * @alias module:model/StreamingNotificationTarget
     * @param notificationTarget {module:model/NotificationTarget} 
     */
    constructor(notificationTarget) { 
        
        StreamingNotificationTarget.initialize(this, notificationTarget);
    }
     ...
     */
    static initialize(obj, notificationTarget) { 
        obj['NotificationTarget'] = notificationTarget;
    }

    /**
     * Constructs a <code>StreamingNotificationTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamingNotificationTarget} obj Optional instance to populate.
     * @return {module:model/StreamingNotificationTarget} The populated <code>StreamingNotificationTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamingNotificationTarget();

            if (data.hasOwnProperty('NotificationTarget')) {
                obj['NotificationTarget'] = ApiClient.convertToType(data['NotificationTarget'], NotificationTarget);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StreamingNotificationTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamingNotificationTarget</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StreamingNotificationTarget.RequiredProperties) {
        ...
        if (data['NotificationTarget']) { // data not null
          NotificationTarget.validateJSON(data['NotificationTarget']);
        }
...
StreamingNotificationTarget.RequiredProperties = ["NotificationTarget"];

/**
 * @member {module:model/NotificationTarget} NotificationTarget
 */
StreamingNotificationTarget.prototype['NotificationTarget'] = undefined;
...
export default StreamingNotificationTarget;
