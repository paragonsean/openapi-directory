...
* @readonly
*/
export default class ArtifactsState {
    ...
    /**
    * Returns a <code>ArtifactsState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ArtifactsState} The enum <code>ArtifactsState</code> value.
    */
