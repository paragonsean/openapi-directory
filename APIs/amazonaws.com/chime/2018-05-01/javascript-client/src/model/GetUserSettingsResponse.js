...
import GetUserSettingsResponseUserSettings from './GetUserSettingsResponseUserSettings';

/**
 * The GetUserSettingsResponse model module.
 * @module model/GetUserSettingsResponse
 * @version 2018-05-01
 */
class GetUserSettingsResponse {
    /**
     * Constructs a new <code>GetUserSettingsResponse</code>.
     * @alias module:model/GetUserSettingsResponse
     */
    constructor() { 
        
        GetUserSettingsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserSettingsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserSettingsResponse} obj Optional instance to populate.
     * @return {module:model/GetUserSettingsResponse} The populated <code>GetUserSettingsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserSettingsResponse();

            if (data.hasOwnProperty('UserSettings')) {
                obj['UserSettings'] = GetUserSettingsResponseUserSettings.constructFromObject(data['UserSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserSettingsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserSettingsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserSettings`
        if (data['UserSettings']) { // data not null
          GetUserSettingsResponseUserSettings.validateJSON(data['UserSettings']);
        }
...
/**
 * @member {module:model/GetUserSettingsResponseUserSettings} UserSettings
 */
GetUserSettingsResponse.prototype['UserSettings'] = undefined;
...
export default GetUserSettingsResponse;
