...
/**
 * The BatchDeletePhoneNumberResponse model module.
 * @module model/BatchDeletePhoneNumberResponse
 * @version 2018-05-01
 */
class BatchDeletePhoneNumberResponse {
    /**
     * Constructs a new <code>BatchDeletePhoneNumberResponse</code>.
     * @alias module:model/BatchDeletePhoneNumberResponse
     */
    constructor() { 
        
        BatchDeletePhoneNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchDeletePhoneNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDeletePhoneNumberResponse} obj Optional instance to populate.
     * @return {module:model/BatchDeletePhoneNumberResponse} The populated <code>BatchDeletePhoneNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDeletePhoneNumberResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDeletePhoneNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDeletePhoneNumberResponse</code>.
     */
 ...
 */
BatchDeletePhoneNumberResponse.prototype['PhoneNumberErrors'] = undefined;
...
export default BatchDeletePhoneNumberResponse;
