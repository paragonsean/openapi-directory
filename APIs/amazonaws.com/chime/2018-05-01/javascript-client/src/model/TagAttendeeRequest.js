...
/**
 * The TagAttendeeRequest model module.
 * @module model/TagAttendeeRequest
 * @version 2018-05-01
 */
class TagAttendeeRequest {
    /**
     * Constructs a new <code>TagAttendeeRequest</code>.
     * @alias module:model/TagAttendeeRequest
     * @param tags {Array.<module:model/Tag>} The tag key-value pairs.
     */
    constructor(tags) { 
        
        TagAttendeeRequest.initialize(this, tags);
    }
    ...
    /**
     * Constructs a <code>TagAttendeeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagAttendeeRequest} obj Optional instance to populate.
     * @return {module:model/TagAttendeeRequest} The populated <code>TagAttendeeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagAttendeeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>TagAttendeeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagAttendeeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TagAttendeeRequest.RequiredProperties) {
...
TagAttendeeRequest.RequiredProperties = ["Tags"];

/**
 * The tag key-value pairs.
 * @member {Array.<module:model/Tag>} Tags
 */
TagAttendeeRequest.prototype['Tags'] = undefined;
...
export default TagAttendeeRequest;
