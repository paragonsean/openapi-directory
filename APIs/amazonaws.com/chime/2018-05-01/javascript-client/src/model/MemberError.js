...
/**
 * The MemberError model module.
 * @module model/MemberError
 * @version 2018-05-01
 */
class MemberError {
    /**
     * Constructs a new <code>MemberError</code>.
     * The list of errors returned when a member action results in an error.
     * @alias module:model/MemberError
     */
    constructor() { 
        
        MemberError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MemberError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MemberError} obj Optional instance to populate.
     * @return {module:model/MemberError} The populated <code>MemberError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberError();
    ...
    /**
     * Validates the JSON data with respect to <code>MemberError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberError</code>.
     */
 ...
 */
MemberError.prototype['MemberId'] = undefined;

/**
 * @member {module:model/ErrorCode} ErrorCode
 */
MemberError.prototype['ErrorCode'] = undefined;

/**
 * @member {String} ErrorMessage
 */
MemberError.prototype['ErrorMessage'] = undefined;
