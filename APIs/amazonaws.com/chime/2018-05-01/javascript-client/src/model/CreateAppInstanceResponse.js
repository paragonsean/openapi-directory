...
/**
 * The CreateAppInstanceResponse model module.
 * @module model/CreateAppInstanceResponse
 * @version 2018-05-01
 */
class CreateAppInstanceResponse {
    /**
     * Constructs a new <code>CreateAppInstanceResponse</code>.
     * @alias module:model/CreateAppInstanceResponse
     */
    constructor() { 
        
        CreateAppInstanceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAppInstanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAppInstanceResponse} obj Optional instance to populate.
     * @return {module:model/CreateAppInstanceResponse} The populated <code>CreateAppInstanceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAppInstanceResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAppInstanceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAppInstanceResponse</code>.
     */
 ...
 */
CreateAppInstanceResponse.prototype['AppInstanceArn'] = undefined;
...
export default CreateAppInstanceResponse;
