...
/**
 * The ListMeetingTagsResponse model module.
 * @module model/ListMeetingTagsResponse
 * @version 2018-05-01
 */
class ListMeetingTagsResponse {
    /**
     * Constructs a new <code>ListMeetingTagsResponse</code>.
     * @alias module:model/ListMeetingTagsResponse
     */
    constructor() { 
        
        ListMeetingTagsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListMeetingTagsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListMeetingTagsResponse} obj Optional instance to populate.
     * @return {module:model/ListMeetingTagsResponse} The populated <code>ListMeetingTagsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListMeetingTagsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListMeetingTagsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListMeetingTagsResponse</code>.
     */
 ...
 * @member {Array} Tags
 */
ListMeetingTagsResponse.prototype['Tags'] = undefined;
...
export default ListMeetingTagsResponse;
