...
/**
 * The ListVoiceConnectorsResponse model module.
 * @module model/ListVoiceConnectorsResponse
 * @version 2018-05-01
 */
class ListVoiceConnectorsResponse {
    /**
     * Constructs a new <code>ListVoiceConnectorsResponse</code>.
     * @alias module:model/ListVoiceConnectorsResponse
     */
    constructor() { 
        
        ListVoiceConnectorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVoiceConnectorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVoiceConnectorsResponse} obj Optional instance to populate.
     * @return {module:model/ListVoiceConnectorsResponse} The populated <code>ListVoiceConnectorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVoiceConnectorsResponse();

            if (data.hasOwnProperty('VoiceConnectors')) {
                obj['VoiceConnectors'] = ApiClient.convertToType(data['VoiceConnectors'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListVoiceConnectorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVoiceConnectorsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VoiceConnectors`
        if (data['VoiceConnectors']) { // data not null
          Array.validateJSON(data['VoiceConnectors']);
        }
...
/**
 * @member {Array} VoiceConnectors
 */
ListVoiceConnectorsResponse.prototype['VoiceConnectors'] = undefined;

/**
 * @member {String} NextToken
 */
ListVoiceConnectorsResponse.prototype['NextToken'] = undefined;
...
export default ListVoiceConnectorsResponse;
