...
/**
 * The MeetingNotificationConfiguration model module.
 * @module model/MeetingNotificationConfiguration
 * @version 2018-05-01
 */
class MeetingNotificationConfiguration {
    /**
     * Constructs a new <code>MeetingNotificationConfiguration</code>.
     ...
     * @alias module:model/MeetingNotificationConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MeetingNotificationConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeetingNotificationConfiguration} obj Optional instance to populate.
     * @return {module:model/MeetingNotificationConfiguration} The populated <code>MeetingNotificationConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeetingNotificationConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>MeetingNotificationConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeetingNotificationConfiguration</code>.
     */
...
export default MeetingNotificationConfiguration;
