...
/**
 * The UpdateProxySessionResponse model module.
 * @module model/UpdateProxySessionResponse
 * @version 2018-05-01
 */
class UpdateProxySessionResponse {
    /**
     * Constructs a new <code>UpdateProxySessionResponse</code>.
     * @alias module:model/UpdateProxySessionResponse
     */
    constructor() { 
        
        UpdateProxySessionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateProxySessionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateProxySessionResponse} obj Optional instance to populate.
     * @return {module:model/UpdateProxySessionResponse} The populated <code>UpdateProxySessionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateProxySessionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateProxySessionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateProxySessionResponse</code>.
     */
 ...
 */
UpdateProxySessionResponse.prototype['ProxySession'] = undefined;
...
export default UpdateProxySessionResponse;
