...
* @readonly
*/
export default class GeoMatchLevel {
    ...
    /**
    * Returns a <code>GeoMatchLevel</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GeoMatchLevel} The enum <code>GeoMatchLevel</code> value.
    */
