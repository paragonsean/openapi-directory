...
/**
 * The BatchCreateAttendeeResponse model module.
 * @module model/BatchCreateAttendeeResponse
 * @version 2018-05-01
 */
class BatchCreateAttendeeResponse {
    /**
     * Constructs a new <code>BatchCreateAttendeeResponse</code>.
     * @alias module:model/BatchCreateAttendeeResponse
     */
    constructor() { 
        
        BatchCreateAttendeeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchCreateAttendeeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchCreateAttendeeResponse} obj Optional instance to populate.
     * @return {module:model/BatchCreateAttendeeResponse} The populated <code>BatchCreateAttendeeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchCreateAttendeeResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchCreateAttendeeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchCreateAttendeeResponse</code>.
     */
 ...
 */
BatchCreateAttendeeResponse.prototype['Attendees'] = undefined;

/**
 * @member {Array} Errors
 */
BatchCreateAttendeeResponse.prototype['Errors'] = undefined;
...
export default BatchCreateAttendeeResponse;
