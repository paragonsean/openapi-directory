...
import GetBotResponseBot from './GetBotResponseBot';
...
class GetBotResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Bot')) {
                obj['Bot'] = GetBotResponseBot.constructFromObject(data['Bot']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Bot']) { // data not null
          GetBotResponseBot.validateJSON(data['Bot']);
        }
...
/**
 * @member {module:model/GetBotResponseBot} Bot
 */
GetBotResponse.prototype['Bot'] = undefined;
