...
import UpdateSipRuleResponseSipRule from './UpdateSipRuleResponseSipRule';

/**
 * The UpdateSipRuleResponse model module.
 * @module model/UpdateSipRuleResponse
 * @version 2018-05-01
 */
class UpdateSipRuleResponse {
    /**
     * Constructs a new <code>UpdateSipRuleResponse</code>.
     * @alias module:model/UpdateSipRuleResponse
     */
    constructor() { 
        
        UpdateSipRuleResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateSipRuleResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSipRuleResponse} obj Optional instance to populate.
     * @return {module:model/UpdateSipRuleResponse} The populated <code>UpdateSipRuleResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSipRuleResponse();

            if (data.hasOwnProperty('SipRule')) {
                obj['SipRule'] = UpdateSipRuleResponseSipRule.constructFromObject(data['SipRule']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSipRuleResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSipRuleResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipRule`
        if (data['SipRule']) { // data not null
          UpdateSipRuleResponseSipRule.validateJSON(data['SipRule']);
        }
...
/**
 * @member {module:model/UpdateSipRuleResponseSipRule} SipRule
 */
UpdateSipRuleResponse.prototype['SipRule'] = undefined;
...
export default UpdateSipRuleResponse;
