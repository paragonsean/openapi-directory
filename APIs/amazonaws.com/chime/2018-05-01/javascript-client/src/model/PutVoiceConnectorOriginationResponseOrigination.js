...
/**
 * The PutVoiceConnectorOriginationResponseOrigination model module.
 * @module model/PutVoiceConnectorOriginationResponseOrigination
 * @version 2018-05-01
 */
class PutVoiceConnectorOriginationResponseOrigination {
    /**
     * Constructs a new <code>PutVoiceConnectorOriginationResponseOrigination</code>.
     * @alias module:model/PutVoiceConnectorOriginationResponseOrigination
     * @implements module:model/Origination
     */
    constructor() { 
        Origination.initialize(this);
        PutVoiceConnectorOriginationResponseOrigination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorOriginationResponseOrigination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorOriginationResponseOrigination} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorOriginationResponseOrigination} The populated <code>PutVoiceConnectorOriginationResponseOrigination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorOriginationResponseOrigination();
            Origination.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorOriginationResponseOrigination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorOriginationResponseOrigination</code>.
     */
 ...
 * @member {Array} Routes
 */
PutVoiceConnectorOriginationResponseOrigination.prototype['Routes'] = undefined;

/**
 * @member {Boolean} Disabled
 */
PutVoiceConnectorOriginationResponseOrigination.prototype['Disabled'] = undefined;


// Implement Origination interface:
/**
 * @member {Array} Routes
 */
Origination.prototype['Routes'] = undefined;
/**
 * @member {Boolean} Disabled
 */
Origination.prototype['Disabled'] = undefined;




export default PutVoiceConnectorOriginationResponseOrigination;
