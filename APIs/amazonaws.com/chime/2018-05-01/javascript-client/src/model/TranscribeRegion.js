...
* @readonly
*/
export default class TranscribeRegion {
    ...
    /**
    * Returns a <code>TranscribeRegion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeRegion} The enum <code>TranscribeRegion</code> value.
    */
