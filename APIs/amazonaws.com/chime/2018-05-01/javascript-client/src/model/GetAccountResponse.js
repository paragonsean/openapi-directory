...
import CreateAccountResponseAccount from './CreateAccountResponseAccount';
...
class GetAccountResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Account')) {
                obj['Account'] = CreateAccountResponseAccount.constructFromObject(data['Account']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Account']) { // data not null
          CreateAccountResponseAccount.validateJSON(data['Account']);
        }
...
/**
 * @member {module:model/CreateAccountResponseAccount} Account
 */
GetAccountResponse.prototype['Account'] = undefined;
