...
/**
 * The CreateAttendeeError model module.
 * @module model/CreateAttendeeError
 * @version 2018-05-01
 */
class CreateAttendeeError {
    /**
     * Constructs a new <code>CreateAttendeeError</code>.
     * The list of errors returned when errors are encountered during the BatchCreateAttendee and CreateAttendee actions. This includes external user IDs, error codes, and error messages.
     * @alias module:model/CreateAttendeeError
     */
    constructor() { 
        
        CreateAttendeeError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAttendeeError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAttendeeError} obj Optional instance to populate.
     * @return {module:model/CreateAttendeeError} The populated <code>CreateAttendeeError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAttendeeError();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAttendeeError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAttendeeError</code>.
     */
 ...
 */
CreateAttendeeError.prototype['ExternalUserId'] = undefined;

/**
 * @member {String} ErrorCode
 */
CreateAttendeeError.prototype['ErrorCode'] = undefined;

/**
 * @member {String} ErrorMessage
 */
CreateAttendeeError.prototype['ErrorMessage'] = undefined;
...
export default CreateAttendeeError;
