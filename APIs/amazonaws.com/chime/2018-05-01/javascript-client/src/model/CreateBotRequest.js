...
class CreateBotRequest {
     ...
     * @param displayName {String} The bot display name.
     */
    constructor(displayName) { 
        
        CreateBotRequest.initialize(this, displayName);
    }
...
CreateBotRequest.RequiredProperties = ["DisplayName"];

/**
 * The bot display name.
 * @member {String} DisplayName
 */
CreateBotRequest.prototype['DisplayName'] = undefined;

/**
 * The domain of the Amazon Chime Enterprise account.
 * @member {String} Domain
 */
CreateBotRequest.prototype['Domain'] = undefined;
