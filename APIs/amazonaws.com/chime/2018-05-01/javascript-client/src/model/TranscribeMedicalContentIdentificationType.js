...
* @readonly
*/
export default class TranscribeMedicalContentIdentificationType {
    ...
    /**
    * Returns a <code>TranscribeMedicalContentIdentificationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeMedicalContentIdentificationType} The enum <code>TranscribeMedicalContentIdentificationType</code> value.
    */
