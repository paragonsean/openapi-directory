...
/**
 * The UntagAttendeeRequest model module.
 * @module model/UntagAttendeeRequest
 * @version 2018-05-01
 */
class UntagAttendeeRequest {
    /**
     * Constructs a new <code>UntagAttendeeRequest</code>.
     * @alias module:model/UntagAttendeeRequest
     * @param tagKeys {Array.<String>} The tag keys.
     */
    constructor(tagKeys) { 
        
        UntagAttendeeRequest.initialize(this, tagKeys);
    }
    ...
    /**
     * Constructs a <code>UntagAttendeeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UntagAttendeeRequest} obj Optional instance to populate.
     * @return {module:model/UntagAttendeeRequest} The populated <code>UntagAttendeeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UntagAttendeeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UntagAttendeeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UntagAttendeeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UntagAttendeeRequest.RequiredProperties) {
...
UntagAttendeeRequest.RequiredProperties = ["TagKeys"];

/**
 * The tag keys.
 * @member {Array.<String>} TagKeys
 */
UntagAttendeeRequest.prototype['TagKeys'] = undefined;
...
export default UntagAttendeeRequest;
