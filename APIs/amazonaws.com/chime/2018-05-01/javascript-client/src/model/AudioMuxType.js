...
* @readonly
*/
export default class AudioMuxType {
    ...
    /**
    * Returns a <code>AudioMuxType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AudioMuxType} The enum <code>AudioMuxType</code> value.
    */
