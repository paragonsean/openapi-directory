...
import GetAttendeeResponseAttendee from './GetAttendeeResponseAttendee';

/**
 * The GetAttendeeResponse model module.
 * @module model/GetAttendeeResponse
 * @version 2018-05-01
 */
class GetAttendeeResponse {
    /**
     * Constructs a new <code>GetAttendeeResponse</code>.
     * @alias module:model/GetAttendeeResponse
     */
    constructor() { 
        
        GetAttendeeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAttendeeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAttendeeResponse} obj Optional instance to populate.
     * @return {module:model/GetAttendeeResponse} The populated <code>GetAttendeeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAttendeeResponse();

            if (data.hasOwnProperty('Attendee')) {
                obj['Attendee'] = GetAttendeeResponseAttendee.constructFromObject(data['Attendee']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAttendeeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAttendeeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Attendee`
        if (data['Attendee']) { // data not null
          GetAttendeeResponseAttendee.validateJSON(data['Attendee']);
        }
...
/**
 * @member {module:model/GetAttendeeResponseAttendee} Attendee
 */
GetAttendeeResponse.prototype['Attendee'] = undefined;
...
export default GetAttendeeResponse;
