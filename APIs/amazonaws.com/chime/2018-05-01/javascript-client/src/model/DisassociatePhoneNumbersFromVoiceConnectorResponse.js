...
/**
 * The DisassociatePhoneNumbersFromVoiceConnectorResponse model module.
 * @module model/DisassociatePhoneNumbersFromVoiceConnectorResponse
 * @version 2018-05-01
 */
class DisassociatePhoneNumbersFromVoiceConnectorResponse {
    /**
     * Constructs a new <code>DisassociatePhoneNumbersFromVoiceConnectorResponse</code>.
     * @alias module:model/DisassociatePhoneNumbersFromVoiceConnectorResponse
     */
    constructor() { 
        
        DisassociatePhoneNumbersFromVoiceConnectorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociatePhoneNumbersFromVoiceConnectorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociatePhoneNumbersFromVoiceConnectorResponse} obj Optional instance to populate.
     * @return {module:model/DisassociatePhoneNumbersFromVoiceConnectorResponse} The populated <code>DisassociatePhoneNumbersFromVoiceConnectorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociatePhoneNumbersFromVoiceConnectorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociatePhoneNumbersFromVoiceConnectorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociatePhoneNumbersFromVoiceConnectorResponse</code>.
     */
 ...
 */
DisassociatePhoneNumbersFromVoiceConnectorResponse.prototype['PhoneNumberErrors'] = undefined;
...
export default DisassociatePhoneNumbersFromVoiceConnectorResponse;
