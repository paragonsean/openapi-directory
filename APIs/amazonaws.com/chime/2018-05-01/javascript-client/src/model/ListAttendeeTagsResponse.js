...
/**
 * The ListAttendeeTagsResponse model module.
 * @module model/ListAttendeeTagsResponse
 * @version 2018-05-01
 */
class ListAttendeeTagsResponse {
    /**
     * Constructs a new <code>ListAttendeeTagsResponse</code>.
     * @alias module:model/ListAttendeeTagsResponse
     */
    constructor() { 
        
        ListAttendeeTagsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListAttendeeTagsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAttendeeTagsResponse} obj Optional instance to populate.
     * @return {module:model/ListAttendeeTagsResponse} The populated <code>ListAttendeeTagsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAttendeeTagsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAttendeeTagsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAttendeeTagsResponse</code>.
     */
 ...
 * @member {Array} Tags
 */
ListAttendeeTagsResponse.prototype['Tags'] = undefined;
...
export default ListAttendeeTagsResponse;
