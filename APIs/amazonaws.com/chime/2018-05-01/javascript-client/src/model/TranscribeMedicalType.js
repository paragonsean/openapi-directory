...
* @readonly
*/
export default class TranscribeMedicalType {
    ...
    /**
    * Returns a <code>TranscribeMedicalType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeMedicalType} The enum <code>TranscribeMedicalType</code> value.
    */
