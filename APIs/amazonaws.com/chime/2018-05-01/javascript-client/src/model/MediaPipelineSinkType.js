...
* @readonly
*/
export default class MediaPipelineSinkType {
    ...
    /**
    * Returns a <code>MediaPipelineSinkType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MediaPipelineSinkType} The enum <code>MediaPipelineSinkType</code> value.
    */
