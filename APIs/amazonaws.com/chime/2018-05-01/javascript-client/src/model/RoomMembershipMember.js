...
/**
 * The RoomMembershipMember model module.
 * @module model/RoomMembershipMember
 * @version 2018-05-01
 */
class RoomMembershipMember {
    /**
     * Constructs a new <code>RoomMembershipMember</code>.
     * @alias module:model/RoomMembershipMember
     * @implements module:model/Member
     */
    constructor() { 
        Member.initialize(this);
        RoomMembershipMember.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RoomMembershipMember</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoomMembershipMember} obj Optional instance to populate.
     * @return {module:model/RoomMembershipMember} The populated <code>RoomMembershipMember</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoomMembershipMember();
            ...
            if (data.hasOwnProperty('MemberType')) {
                obj['MemberType'] = ApiClient.convertToType(data['MemberType'], MemberType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RoomMembershipMember</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoomMembershipMember</code>.
     */
    static validateJSON(data) {
        // validate the optional field `MemberId`
        if (data['MemberId']) { // data not null
          String.validateJSON(data['MemberId']);
        }
        // validate the optional field `MemberType`
        if (data['MemberType']) { // data not null
          MemberType.validateJSON(data['MemberType']);
        }
 ...
 */
RoomMembershipMember.prototype['MemberId'] = undefined;

/**
 * @member {module:model/MemberType} MemberType
 */
RoomMembershipMember.prototype['MemberType'] = undefined;

/**
 * @member {String} Email
 */
RoomMembershipMember.prototype['Email'] = undefined;

/**
 * @member {String} FullName
 */
RoomMembershipMember.prototype['FullName'] = undefined;

/**
 * @member {String} AccountId
 */
RoomMembershipMember.prototype['AccountId'] = undefined;
...
export default RoomMembershipMember;
