...
* @readonly
*/
export default class ChannelPrivacy {
    ...
    /**
    * Returns a <code>ChannelPrivacy</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChannelPrivacy} The enum <code>ChannelPrivacy</code> value.
    */
