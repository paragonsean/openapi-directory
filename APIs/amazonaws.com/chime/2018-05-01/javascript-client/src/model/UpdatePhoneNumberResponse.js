...
import UpdatePhoneNumberResponsePhoneNumber from './UpdatePhoneNumberResponsePhoneNumber';

/**
 * The UpdatePhoneNumberResponse model module.
 * @module model/UpdatePhoneNumberResponse
 * @version 2018-05-01
 */
class UpdatePhoneNumberResponse {
    /**
     * Constructs a new <code>UpdatePhoneNumberResponse</code>.
     * @alias module:model/UpdatePhoneNumberResponse
     */
    constructor() { 
        
        UpdatePhoneNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePhoneNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePhoneNumberResponse} obj Optional instance to populate.
     * @return {module:model/UpdatePhoneNumberResponse} The populated <code>UpdatePhoneNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePhoneNumberResponse();

            if (data.hasOwnProperty('PhoneNumber')) {
                obj['PhoneNumber'] = UpdatePhoneNumberResponsePhoneNumber.constructFromObject(data['PhoneNumber']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePhoneNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePhoneNumberResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PhoneNumber`
        if (data['PhoneNumber']) { // data not null
          UpdatePhoneNumberResponsePhoneNumber.validateJSON(data['PhoneNumber']);
        }
...
/**
 * @member {module:model/UpdatePhoneNumberResponsePhoneNumber} PhoneNumber
 */
UpdatePhoneNumberResponse.prototype['PhoneNumber'] = undefined;
...
export default UpdatePhoneNumberResponse;
