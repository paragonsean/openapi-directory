...
* @readonly
*/
export default class TranscribeMedicalRegion {
    ...
    /**
    * Returns a <code>TranscribeMedicalRegion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeMedicalRegion} The enum <code>TranscribeMedicalRegion</code> value.
    */
