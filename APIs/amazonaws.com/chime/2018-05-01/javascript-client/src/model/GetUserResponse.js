...
import GetUserResponseUser from './GetUserResponseUser';
...
class GetUserResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('User')) {
                obj['User'] = GetUserResponseUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['User']) { // data not null
          GetUserResponseUser.validateJSON(data['User']);
        }
...
/**
 * @member {module:model/GetUserResponseUser} User
 */
GetUserResponse.prototype['User'] = undefined;
