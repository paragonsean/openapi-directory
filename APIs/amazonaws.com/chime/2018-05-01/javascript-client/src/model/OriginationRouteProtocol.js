...
* @readonly
*/
export default class OriginationRouteProtocol {
    ...
    /**
    * Returns a <code>OriginationRouteProtocol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OriginationRouteProtocol} The enum <code>OriginationRouteProtocol</code> value.
    */
