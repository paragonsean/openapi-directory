...
/**
 * The DisassociateSigninDelegateGroupsFromAccountRequest model module.
 * @module model/DisassociateSigninDelegateGroupsFromAccountRequest
 * @version 2018-05-01
 */
class DisassociateSigninDelegateGroupsFromAccountRequest {
    /**
     * Constructs a new <code>DisassociateSigninDelegateGroupsFromAccountRequest</code>.
     * @alias module:model/DisassociateSigninDelegateGroupsFromAccountRequest
     * @param groupNames {Array.<String>} The sign-in delegate group names.
     */
    constructor(groupNames) { 
        
        DisassociateSigninDelegateGroupsFromAccountRequest.initialize(this, groupNames);
    }
     ...
     */
    static initialize(obj, groupNames) { 
        obj['GroupNames'] = groupNames;
    }

    /**
     * Constructs a <code>DisassociateSigninDelegateGroupsFromAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateSigninDelegateGroupsFromAccountRequest} obj Optional instance to populate.
     * @return {module:model/DisassociateSigninDelegateGroupsFromAccountRequest} The populated <code>DisassociateSigninDelegateGroupsFromAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateSigninDelegateGroupsFromAccountRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateSigninDelegateGroupsFromAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateSigninDelegateGroupsFromAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisassociateSigninDelegateGroupsFromAccountRequest.RequiredProperties) {
...
DisassociateSigninDelegateGroupsFromAccountRequest.RequiredProperties = ["GroupNames"];

/**
 * The sign-in delegate group names.
 * @member {Array.<String>} GroupNames
 */
DisassociateSigninDelegateGroupsFromAccountRequest.prototype['GroupNames'] = undefined;
...
export default DisassociateSigninDelegateGroupsFromAccountRequest;
