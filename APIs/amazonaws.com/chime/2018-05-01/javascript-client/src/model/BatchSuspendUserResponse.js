...
/**
 * The BatchSuspendUserResponse model module.
 * @module model/BatchSuspendUserResponse
 * @version 2018-05-01
 */
class BatchSuspendUserResponse {
    /**
     * Constructs a new <code>BatchSuspendUserResponse</code>.
     * @alias module:model/BatchSuspendUserResponse
     */
    constructor() { 
        
        BatchSuspendUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchSuspendUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchSuspendUserResponse} obj Optional instance to populate.
     * @return {module:model/BatchSuspendUserResponse} The populated <code>BatchSuspendUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchSuspendUserResponse();

            if (data.hasOwnProperty('UserErrors')) {
                obj['UserErrors'] = ApiClient.convertToType(data['UserErrors'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchSuspendUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchSuspendUserResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserErrors`
        if (data['UserErrors']) { // data not null
          Array.validateJSON(data['UserErrors']);
        }
...
/**
 * @member {Array} UserErrors
 */
BatchSuspendUserResponse.prototype['UserErrors'] = undefined;
...
export default BatchSuspendUserResponse;
