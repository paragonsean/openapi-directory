...
/**
 * The SipMediaApplicationCall model module.
 * @module model/SipMediaApplicationCall
 * @version 2018-05-01
 */
class SipMediaApplicationCall {
    /**
     * Constructs a new <code>SipMediaApplicationCall</code>.
     * A &lt;code&gt;Call&lt;/code&gt; instance for a SIP media application.
     * @alias module:model/SipMediaApplicationCall
     */
    constructor() { 
        
        SipMediaApplicationCall.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SipMediaApplicationCall</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SipMediaApplicationCall} obj Optional instance to populate.
     * @return {module:model/SipMediaApplicationCall} The populated <code>SipMediaApplicationCall</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SipMediaApplicationCall();
    ...
    /**
     * Validates the JSON data with respect to <code>SipMediaApplicationCall</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SipMediaApplicationCall</code>.
     */
 ...
 */
SipMediaApplicationCall.prototype['TransactionId'] = undefined;
...
export default SipMediaApplicationCall;
