...
* @readonly
*/
export default class ChannelMessagePersistenceType {
    ...
    /**
    * Returns a <code>ChannelMessagePersistenceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChannelMessagePersistenceType} The enum <code>ChannelMessagePersistenceType</code> value.
    */
