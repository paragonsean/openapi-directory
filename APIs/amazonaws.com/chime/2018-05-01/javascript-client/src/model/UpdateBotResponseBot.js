...
/**
 * The UpdateBotResponseBot model module.
 * @module model/UpdateBotResponseBot
 * @version 2018-05-01
 */
class UpdateBotResponseBot {
    /**
     * Constructs a new <code>UpdateBotResponseBot</code>.
     * @alias module:model/UpdateBotResponseBot
     * @implements module:model/Bot
     */
    constructor() { 
        Bot.initialize(this);
        UpdateBotResponseBot.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateBotResponseBot</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateBotResponseBot} obj Optional instance to populate.
     * @return {module:model/UpdateBotResponseBot} The populated <code>UpdateBotResponseBot</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateBotResponseBot();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateBotResponseBot</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateBotResponseBot</code>.
     */
 ...
 * @member {String} BotId
 */
UpdateBotResponseBot.prototype['BotId'] = undefined;

/**
 * @member {String} UserId
 */
UpdateBotResponseBot.prototype['UserId'] = undefined;

/**
 * @member {String} DisplayName
 */
UpdateBotResponseBot.prototype['DisplayName'] = undefined;

/**
 * @member {module:model/BotType} BotType
 */
UpdateBotResponseBot.prototype['BotType'] = undefined;

/**
 * @member {Boolean} Disabled
 */
UpdateBotResponseBot.prototype['Disabled'] = undefined;

/**
 * @member {Date} CreatedTimestamp
 */
UpdateBotResponseBot.prototype['CreatedTimestamp'] = undefined;

/**
 * @member {Date} UpdatedTimestamp
 */
UpdateBotResponseBot.prototype['UpdatedTimestamp'] = undefined;

/**
 * @member {String} BotEmail
 */
UpdateBotResponseBot.prototype['BotEmail'] = undefined;

/**
 * @member {String} SecurityToken
 */
UpdateBotResponseBot.prototype['SecurityToken'] = undefined;
...
export default UpdateBotResponseBot;
