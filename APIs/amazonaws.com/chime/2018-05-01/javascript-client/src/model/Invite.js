...
class Invite {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('InviteId')) {
                obj['InviteId'] = ApiClient.convertToType(data['InviteId'], 'String');
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], InviteStatus);
            }
            if (data.hasOwnProperty('EmailAddress')) {
                obj['EmailAddress'] = ApiClient.convertToType(data['EmailAddress'], 'String');
            }
            if (data.hasOwnProperty('EmailStatus')) {
                obj['EmailStatus'] = ApiClient.convertToType(data['EmailStatus'], EmailStatus);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['InviteId']) { // data not null
          String.validateJSON(data['InviteId']);
        }
        // validate the optional field `Status`
        if (data['Status']) { // data not null
          InviteStatus.validateJSON(data['Status']);
        }
        ...
        if (data['EmailStatus']) { // data not null
          EmailStatus.validateJSON(data['EmailStatus']);
        }
 ...
 */
Invite.prototype['InviteId'] = undefined;

/**
 * @member {module:model/InviteStatus} Status
 */
 ...
 */
Invite.prototype['EmailAddress'] = undefined;

/**
 * @member {module:model/EmailStatus} EmailStatus
 */
Invite.prototype['EmailStatus'] = undefined;
