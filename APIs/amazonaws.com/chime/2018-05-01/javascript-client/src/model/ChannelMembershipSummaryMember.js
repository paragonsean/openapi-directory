...
/**
 * The ChannelMembershipSummaryMember model module.
 * @module model/ChannelMembershipSummaryMember
 * @version 2018-05-01
 */
class ChannelMembershipSummaryMember {
    /**
     * Constructs a new <code>ChannelMembershipSummaryMember</code>.
     * @alias module:model/ChannelMembershipSummaryMember
     * @implements module:model/Identity
     */
    constructor() { 
        Identity.initialize(this);
        ChannelMembershipSummaryMember.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChannelMembershipSummaryMember</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelMembershipSummaryMember} obj Optional instance to populate.
     * @return {module:model/ChannelMembershipSummaryMember} The populated <code>ChannelMembershipSummaryMember</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelMembershipSummaryMember();
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelMembershipSummaryMember</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelMembershipSummaryMember</code>.
     */
 ...
 * @member {String} Arn
 */
ChannelMembershipSummaryMember.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
ChannelMembershipSummaryMember.prototype['Name'] = undefined;
...
export default ChannelMembershipSummaryMember;
