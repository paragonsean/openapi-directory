...
import OrderedPhoneNumberStatus from './OrderedPhoneNumberStatus';

/**
 * The OrderedPhoneNumber model module.
 * @module model/OrderedPhoneNumber
 * @version 2018-05-01
 */
class OrderedPhoneNumber {
    /**
     * Constructs a new <code>OrderedPhoneNumber</code>.
     * A phone number for which an order has been placed.
     * @alias module:model/OrderedPhoneNumber
     */
    constructor() { 
        
        OrderedPhoneNumber.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderedPhoneNumber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderedPhoneNumber} obj Optional instance to populate.
     * @return {module:model/OrderedPhoneNumber} The populated <code>OrderedPhoneNumber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderedPhoneNumber();

            if (data.hasOwnProperty('E164PhoneNumber')) {
                obj['E164PhoneNumber'] = ApiClient.convertToType(data['E164PhoneNumber'], 'String');
            }
            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], OrderedPhoneNumberStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderedPhoneNumber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderedPhoneNumber</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Status']) { // data not null
          OrderedPhoneNumberStatus.validateJSON(data['Status']);
        }
 ...
 */
OrderedPhoneNumber.prototype['E164PhoneNumber'] = undefined;

/**
 * @member {module:model/OrderedPhoneNumberStatus} Status
 */
OrderedPhoneNumber.prototype['Status'] = undefined;
...
export default OrderedPhoneNumber;
