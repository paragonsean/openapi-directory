...
import UpdateUserResponseUser from './UpdateUserResponseUser';
...
class UpdateUserResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('User')) {
                obj['User'] = UpdateUserResponseUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['User']) { // data not null
          UpdateUserResponseUser.validateJSON(data['User']);
        }
...
/**
 * @member {module:model/UpdateUserResponseUser} User
 */
UpdateUserResponse.prototype['User'] = undefined;
