...
/**
 * The GeoMatchParams model module.
 * @module model/GeoMatchParams
 * @version 2018-05-01
 */
class GeoMatchParams {
    /**
     * Constructs a new <code>GeoMatchParams</code>.
     * The country and area code for a proxy phone number in a proxy phone session.
     * @alias module:model/GeoMatchParams
     * @param country {String} 
     * @param areaCode {String} 
     */
    constructor(country, areaCode) { 
        
        GeoMatchParams.initialize(this, country, areaCode);
    }
     ...
     */
    static initialize(obj, country, areaCode) { 
        obj['Country'] = country;
        obj['AreaCode'] = areaCode;
    }

    /**
     * Constructs a <code>GeoMatchParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoMatchParams} obj Optional instance to populate.
     * @return {module:model/GeoMatchParams} The populated <code>GeoMatchParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoMatchParams();
    ...
    /**
     * Validates the JSON data with respect to <code>GeoMatchParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeoMatchParams</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GeoMatchParams.RequiredProperties) {
        ...
        // validate the optional field `AreaCode`
        if (data['AreaCode']) { // data not null
          String.validateJSON(data['AreaCode']);
        }
...
GeoMatchParams.RequiredProperties = ["Country", "AreaCode"];

/**
 * @member {String} Country
 */
GeoMatchParams.prototype['Country'] = undefined;

/**
 * @member {String} AreaCode
 */
GeoMatchParams.prototype['AreaCode'] = undefined;
