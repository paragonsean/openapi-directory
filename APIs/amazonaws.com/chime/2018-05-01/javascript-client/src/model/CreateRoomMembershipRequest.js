...
/**
 * The CreateRoomMembershipRequest model module.
 * @module model/CreateRoomMembershipRequest
 * @version 2018-05-01
 */
class CreateRoomMembershipRequest {
    /**
     * Constructs a new <code>CreateRoomMembershipRequest</code>.
     * @alias module:model/CreateRoomMembershipRequest
     * @param memberId {String} The Amazon Chime member ID (user ID or bot ID).
     */
    constructor(memberId) { 
        
        CreateRoomMembershipRequest.initialize(this, memberId);
    }
    ...
    /**
     * Constructs a <code>CreateRoomMembershipRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRoomMembershipRequest} obj Optional instance to populate.
     * @return {module:model/CreateRoomMembershipRequest} The populated <code>CreateRoomMembershipRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRoomMembershipRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRoomMembershipRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRoomMembershipRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateRoomMembershipRequest.RequiredProperties) {
...
CreateRoomMembershipRequest.RequiredProperties = ["MemberId"];

/**
 * The Amazon Chime member ID (user ID or bot ID).
 * @member {String} MemberId
 */
CreateRoomMembershipRequest.prototype['MemberId'] = undefined;

/**
 * The role of the member.
 * @member {module:model/CreateRoomMembershipRequest.RoleEnum} Role
 */
CreateRoomMembershipRequest.prototype['Role'] = undefined;
 ...
 * @readonly
 */
CreateRoomMembershipRequest['RoleEnum'] = {
...
export default CreateRoomMembershipRequest;
