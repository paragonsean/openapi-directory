...
/**
 * The UpdateGlobalSettingsRequestBusinessCalling model module.
 * @module model/UpdateGlobalSettingsRequestBusinessCalling
 * @version 2018-05-01
 */
class UpdateGlobalSettingsRequestBusinessCalling {
    /**
     * Constructs a new <code>UpdateGlobalSettingsRequestBusinessCalling</code>.
     * The Amazon Chime Business Calling settings for the administrator&#39;s AWS account. Includes any Amazon S3 buckets designated for storing call detail records.
     * @alias module:model/UpdateGlobalSettingsRequestBusinessCalling
     */
    constructor() { 
        
        UpdateGlobalSettingsRequestBusinessCalling.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGlobalSettingsRequestBusinessCalling</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGlobalSettingsRequestBusinessCalling} obj Optional instance to populate.
     * @return {module:model/UpdateGlobalSettingsRequestBusinessCalling} The populated <code>UpdateGlobalSettingsRequestBusinessCalling</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGlobalSettingsRequestBusinessCalling();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGlobalSettingsRequestBusinessCalling</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGlobalSettingsRequestBusinessCalling</code>.
     */
 ...
 */
UpdateGlobalSettingsRequestBusinessCalling.prototype['CdrBucket'] = undefined;
...
export default UpdateGlobalSettingsRequestBusinessCalling;
