...
import CreatePhoneNumberOrderResponsePhoneNumberOrder from './CreatePhoneNumberOrderResponsePhoneNumberOrder';

/**
 * The GetPhoneNumberOrderResponse model module.
 * @module model/GetPhoneNumberOrderResponse
 * @version 2018-05-01
 */
class GetPhoneNumberOrderResponse {
    /**
     * Constructs a new <code>GetPhoneNumberOrderResponse</code>.
     * @alias module:model/GetPhoneNumberOrderResponse
     */
    constructor() { 
        
        GetPhoneNumberOrderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPhoneNumberOrderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPhoneNumberOrderResponse} obj Optional instance to populate.
     * @return {module:model/GetPhoneNumberOrderResponse} The populated <code>GetPhoneNumberOrderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPhoneNumberOrderResponse();

            if (data.hasOwnProperty('PhoneNumberOrder')) {
                obj['PhoneNumberOrder'] = CreatePhoneNumberOrderResponsePhoneNumberOrder.constructFromObject(data['PhoneNumberOrder']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPhoneNumberOrderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPhoneNumberOrderResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PhoneNumberOrder`
        if (data['PhoneNumberOrder']) { // data not null
          CreatePhoneNumberOrderResponsePhoneNumberOrder.validateJSON(data['PhoneNumberOrder']);
        }
...
/**
 * @member {module:model/CreatePhoneNumberOrderResponsePhoneNumberOrder} PhoneNumberOrder
 */
GetPhoneNumberOrderResponse.prototype['PhoneNumberOrder'] = undefined;
...
export default GetPhoneNumberOrderResponse;
