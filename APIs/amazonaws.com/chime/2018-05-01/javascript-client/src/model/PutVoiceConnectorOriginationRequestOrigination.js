...
/**
 * The PutVoiceConnectorOriginationRequestOrigination model module.
 * @module model/PutVoiceConnectorOriginationRequestOrigination
 * @version 2018-05-01
 */
class PutVoiceConnectorOriginationRequestOrigination {
    /**
     * Constructs a new <code>PutVoiceConnectorOriginationRequestOrigination</code>.
     * @alias module:model/PutVoiceConnectorOriginationRequestOrigination
     * @implements module:model/Origination
     */
    constructor() { 
        Origination.initialize(this);
        PutVoiceConnectorOriginationRequestOrigination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorOriginationRequestOrigination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorOriginationRequestOrigination} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorOriginationRequestOrigination} The populated <code>PutVoiceConnectorOriginationRequestOrigination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorOriginationRequestOrigination();
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorOriginationRequestOrigination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorOriginationRequestOrigination</code>.
     */
 ...
 * @member {Array} Routes
 */
PutVoiceConnectorOriginationRequestOrigination.prototype['Routes'] = undefined;

/**
 * @member {Boolean} Disabled
 */
PutVoiceConnectorOriginationRequestOrigination.prototype['Disabled'] = undefined;
...
export default PutVoiceConnectorOriginationRequestOrigination;
