...
/**
 * The ListSipRulesResponse model module.
 * @module model/ListSipRulesResponse
 * @version 2018-05-01
 */
class ListSipRulesResponse {
    /**
     * Constructs a new <code>ListSipRulesResponse</code>.
     * @alias module:model/ListSipRulesResponse
     */
    constructor() { 
        
        ListSipRulesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSipRulesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSipRulesResponse} obj Optional instance to populate.
     * @return {module:model/ListSipRulesResponse} The populated <code>ListSipRulesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSipRulesResponse();

            if (data.hasOwnProperty('SipRules')) {
                obj['SipRules'] = ApiClient.convertToType(data['SipRules'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSipRulesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSipRulesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SipRules`
        if (data['SipRules']) { // data not null
          Array.validateJSON(data['SipRules']);
        }
...
/**
 * @member {Array} SipRules
 */
ListSipRulesResponse.prototype['SipRules'] = undefined;

/**
 * @member {String} NextToken
 */
ListSipRulesResponse.prototype['NextToken'] = undefined;
...
export default ListSipRulesResponse;
