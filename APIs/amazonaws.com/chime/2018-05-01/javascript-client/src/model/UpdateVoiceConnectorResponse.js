...
import UpdateVoiceConnectorResponseVoiceConnector from './UpdateVoiceConnectorResponseVoiceConnector';

/**
 * The UpdateVoiceConnectorResponse model module.
 * @module model/UpdateVoiceConnectorResponse
 * @version 2018-05-01
 */
class UpdateVoiceConnectorResponse {
    /**
     * Constructs a new <code>UpdateVoiceConnectorResponse</code>.
     * @alias module:model/UpdateVoiceConnectorResponse
     */
    constructor() { 
        
        UpdateVoiceConnectorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateVoiceConnectorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateVoiceConnectorResponse} obj Optional instance to populate.
     * @return {module:model/UpdateVoiceConnectorResponse} The populated <code>UpdateVoiceConnectorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateVoiceConnectorResponse();

            if (data.hasOwnProperty('VoiceConnector')) {
                obj['VoiceConnector'] = UpdateVoiceConnectorResponseVoiceConnector.constructFromObject(data['VoiceConnector']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateVoiceConnectorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateVoiceConnectorResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `VoiceConnector`
        if (data['VoiceConnector']) { // data not null
          UpdateVoiceConnectorResponseVoiceConnector.validateJSON(data['VoiceConnector']);
        }
...
/**
 * @member {module:model/UpdateVoiceConnectorResponseVoiceConnector} VoiceConnector
 */
UpdateVoiceConnectorResponse.prototype['VoiceConnector'] = undefined;
...
export default UpdateVoiceConnectorResponse;
