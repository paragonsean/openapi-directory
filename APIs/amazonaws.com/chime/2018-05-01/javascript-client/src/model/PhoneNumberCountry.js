...
/**
 * The PhoneNumberCountry model module.
 * @module model/PhoneNumberCountry
 * @version 2018-05-01
 */
class PhoneNumberCountry {
    /**
     * Constructs a new <code>PhoneNumberCountry</code>.
     * The phone number country.
     * @alias module:model/PhoneNumberCountry
     */
    constructor() { 
        
        PhoneNumberCountry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PhoneNumberCountry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PhoneNumberCountry} obj Optional instance to populate.
     * @return {module:model/PhoneNumberCountry} The populated <code>PhoneNumberCountry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneNumberCountry();

            if (data.hasOwnProperty('CountryCode')) {
                obj['CountryCode'] = ApiClient.convertToType(data['CountryCode'], 'String');
            }
            if (data.hasOwnProperty('SupportedPhoneNumberTypes')) {
                obj['SupportedPhoneNumberTypes'] = ApiClient.convertToType(data['SupportedPhoneNumberTypes'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneNumberCountry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneNumberCountry</code>.
     */
    static validateJSON(data) {
        ...
        if (data['SupportedPhoneNumberTypes']) { // data not null
          Array.validateJSON(data['SupportedPhoneNumberTypes']);
        }
 ...
 */
PhoneNumberCountry.prototype['CountryCode'] = undefined;

/**
 * @member {Array} SupportedPhoneNumberTypes
 */
PhoneNumberCountry.prototype['SupportedPhoneNumberTypes'] = undefined;
