...
/**
 * The ListVoiceConnectorTerminationCredentialsResponse model module.
 * @module model/ListVoiceConnectorTerminationCredentialsResponse
 * @version 2018-05-01
 */
class ListVoiceConnectorTerminationCredentialsResponse {
    /**
     * Constructs a new <code>ListVoiceConnectorTerminationCredentialsResponse</code>.
     * @alias module:model/ListVoiceConnectorTerminationCredentialsResponse
     */
    constructor() { 
        
        ListVoiceConnectorTerminationCredentialsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListVoiceConnectorTerminationCredentialsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListVoiceConnectorTerminationCredentialsResponse} obj Optional instance to populate.
     * @return {module:model/ListVoiceConnectorTerminationCredentialsResponse} The populated <code>ListVoiceConnectorTerminationCredentialsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListVoiceConnectorTerminationCredentialsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListVoiceConnectorTerminationCredentialsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListVoiceConnectorTerminationCredentialsResponse</code>.
     */
 ...
 */
ListVoiceConnectorTerminationCredentialsResponse.prototype['Usernames'] = undefined;
...
export default ListVoiceConnectorTerminationCredentialsResponse;
