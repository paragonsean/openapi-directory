...
* @readonly
*/
export default class VoiceConnectorAwsRegion {
    ...
    /**
    * Returns a <code>VoiceConnectorAwsRegion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VoiceConnectorAwsRegion} The enum <code>VoiceConnectorAwsRegion</code> value.
    */
