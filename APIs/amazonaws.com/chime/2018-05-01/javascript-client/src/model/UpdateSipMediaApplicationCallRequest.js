...
/**
 * The UpdateSipMediaApplicationCallRequest model module.
 * @module model/UpdateSipMediaApplicationCallRequest
 * @version 2018-05-01
 */
class UpdateSipMediaApplicationCallRequest {
    /**
     * Constructs a new <code>UpdateSipMediaApplicationCallRequest</code>.
     * @alias module:model/UpdateSipMediaApplicationCallRequest
     * @param _arguments {Object.<String, String>} Arguments made available to the Lambda function as part of the <code>CALL_UPDATE_REQUESTED</code> event. Can contain 0-20 key-value pairs.
     */
    constructor(_arguments) { 
        
        UpdateSipMediaApplicationCallRequest.initialize(this, _arguments);
    }
     ...
     */
    static initialize(obj, _arguments) { 
        obj['Arguments'] = _arguments;
    }

    /**
     * Constructs a <code>UpdateSipMediaApplicationCallRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSipMediaApplicationCallRequest} obj Optional instance to populate.
     * @return {module:model/UpdateSipMediaApplicationCallRequest} The populated <code>UpdateSipMediaApplicationCallRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSipMediaApplicationCallRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSipMediaApplicationCallRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSipMediaApplicationCallRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSipMediaApplicationCallRequest.RequiredProperties) {
...
UpdateSipMediaApplicationCallRequest.RequiredProperties = ["Arguments"];
 ...
 */
UpdateSipMediaApplicationCallRequest.prototype['Arguments'] = undefined;
...
export default UpdateSipMediaApplicationCallRequest;
