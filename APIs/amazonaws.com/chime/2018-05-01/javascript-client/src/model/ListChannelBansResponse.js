...
/**
 * The ListChannelBansResponse model module.
 * @module model/ListChannelBansResponse
 * @version 2018-05-01
 */
class ListChannelBansResponse {
    /**
     * Constructs a new <code>ListChannelBansResponse</code>.
     * @alias module:model/ListChannelBansResponse
     */
    constructor() { 
        
        ListChannelBansResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListChannelBansResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListChannelBansResponse} obj Optional instance to populate.
     * @return {module:model/ListChannelBansResponse} The populated <code>ListChannelBansResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListChannelBansResponse();
            ...
            if (data.hasOwnProperty('ChannelBans')) {
                obj['ChannelBans'] = ApiClient.convertToType(data['ChannelBans'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListChannelBansResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListChannelBansResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ChannelBans']) { // data not null
          Array.validateJSON(data['ChannelBans']);
        }
 ...
 */
ListChannelBansResponse.prototype['ChannelArn'] = undefined;

/**
 * @member {String} NextToken
 */
ListChannelBansResponse.prototype['NextToken'] = undefined;

/**
 * @member {Array} ChannelBans
 */
ListChannelBansResponse.prototype['ChannelBans'] = undefined;
...
export default ListChannelBansResponse;
