...
/**
 * The ListProxySessionsResponse model module.
 * @module model/ListProxySessionsResponse
 * @version 2018-05-01
 */
class ListProxySessionsResponse {
    /**
     * Constructs a new <code>ListProxySessionsResponse</code>.
     * @alias module:model/ListProxySessionsResponse
     */
    constructor() { 
        
        ListProxySessionsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListProxySessionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListProxySessionsResponse} obj Optional instance to populate.
     * @return {module:model/ListProxySessionsResponse} The populated <code>ListProxySessionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListProxySessionsResponse();

            if (data.hasOwnProperty('ProxySessions')) {
                obj['ProxySessions'] = ApiClient.convertToType(data['ProxySessions'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListProxySessionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListProxySessionsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ProxySessions`
        if (data['ProxySessions']) { // data not null
          Array.validateJSON(data['ProxySessions']);
        }
...
/**
 * @member {Array} ProxySessions
 */
ListProxySessionsResponse.prototype['ProxySessions'] = undefined;

/**
 * @member {String} NextToken
 */
ListProxySessionsResponse.prototype['NextToken'] = undefined;
...
export default ListProxySessionsResponse;
