...
/**
 * The UpdateRoomMembershipRequest model module.
 * @module model/UpdateRoomMembershipRequest
 * @version 2018-05-01
 */
class UpdateRoomMembershipRequest {
    /**
     * Constructs a new <code>UpdateRoomMembershipRequest</code>.
     * @alias module:model/UpdateRoomMembershipRequest
     */
    constructor() { 
        
        UpdateRoomMembershipRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRoomMembershipRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRoomMembershipRequest} obj Optional instance to populate.
     * @return {module:model/UpdateRoomMembershipRequest} The populated <code>UpdateRoomMembershipRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRoomMembershipRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRoomMembershipRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRoomMembershipRequest</code>.
     */
 ...
 * @member {module:model/UpdateRoomMembershipRequest.RoleEnum} Role
 */
UpdateRoomMembershipRequest.prototype['Role'] = undefined;
 ...
 * @readonly
 */
UpdateRoomMembershipRequest['RoleEnum'] = {
...
export default UpdateRoomMembershipRequest;
