...
* @readonly
*/
export default class PhoneNumberProductType {
    ...
    /**
    * Returns a <code>PhoneNumberProductType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PhoneNumberProductType} The enum <code>PhoneNumberProductType</code> value.
    */
