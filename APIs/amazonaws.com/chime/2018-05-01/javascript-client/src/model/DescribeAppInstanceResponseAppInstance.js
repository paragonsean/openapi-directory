...
/**
 * The DescribeAppInstanceResponseAppInstance model module.
 * @module model/DescribeAppInstanceResponseAppInstance
 * @version 2018-05-01
 */
class DescribeAppInstanceResponseAppInstance {
    /**
     * Constructs a new <code>DescribeAppInstanceResponseAppInstance</code>.
     * @alias module:model/DescribeAppInstanceResponseAppInstance
     * @implements module:model/AppInstance
     */
    constructor() { 
        AppInstance.initialize(this);
        DescribeAppInstanceResponseAppInstance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeAppInstanceResponseAppInstance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeAppInstanceResponseAppInstance} obj Optional instance to populate.
     * @return {module:model/DescribeAppInstanceResponseAppInstance} The populated <code>DescribeAppInstanceResponseAppInstance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeAppInstanceResponseAppInstance();
            AppInstance.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeAppInstanceResponseAppInstance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeAppInstanceResponseAppInstance</code>.
     */
 ...
 */
DescribeAppInstanceResponseAppInstance.prototype['AppInstanceArn'] = undefined;

/**
 * @member {String} Name
 */
DescribeAppInstanceResponseAppInstance.prototype['Name'] = undefined;

/**
 * @member {String} Metadata
 */
DescribeAppInstanceResponseAppInstance.prototype['Metadata'] = undefined;

/**
 * @member {Date} CreatedTimestamp
 */
DescribeAppInstanceResponseAppInstance.prototype['CreatedTimestamp'] = undefined;

/**
 * @member {Date} LastUpdatedTimestamp
 */
DescribeAppInstanceResponseAppInstance.prototype['LastUpdatedTimestamp'] = undefined;


// Implement AppInstance interface:
/**
 * @member {String} AppInstanceArn
 */
...
export default DescribeAppInstanceResponseAppInstance;
