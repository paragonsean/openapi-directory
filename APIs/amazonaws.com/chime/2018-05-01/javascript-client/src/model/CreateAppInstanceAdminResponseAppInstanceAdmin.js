...
/**
 * The CreateAppInstanceAdminResponseAppInstanceAdmin model module.
 * @module model/CreateAppInstanceAdminResponseAppInstanceAdmin
 * @version 2018-05-01
 */
class CreateAppInstanceAdminResponseAppInstanceAdmin {
    /**
     * Constructs a new <code>CreateAppInstanceAdminResponseAppInstanceAdmin</code>.
     * @alias module:model/CreateAppInstanceAdminResponseAppInstanceAdmin
     * @implements module:model/Identity
     */
    constructor() { 
        Identity.initialize(this);
        CreateAppInstanceAdminResponseAppInstanceAdmin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAppInstanceAdminResponseAppInstanceAdmin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAppInstanceAdminResponseAppInstanceAdmin} obj Optional instance to populate.
     * @return {module:model/CreateAppInstanceAdminResponseAppInstanceAdmin} The populated <code>CreateAppInstanceAdminResponseAppInstanceAdmin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAppInstanceAdminResponseAppInstanceAdmin();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAppInstanceAdminResponseAppInstanceAdmin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAppInstanceAdminResponseAppInstanceAdmin</code>.
     */
 ...
 * @member {String} Arn
 */
CreateAppInstanceAdminResponseAppInstanceAdmin.prototype['Arn'] = undefined;

/**
 * @member {String} Name
 */
CreateAppInstanceAdminResponseAppInstanceAdmin.prototype['Name'] = undefined;
...
export default CreateAppInstanceAdminResponseAppInstanceAdmin;
