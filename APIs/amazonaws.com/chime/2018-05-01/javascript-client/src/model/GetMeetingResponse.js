...
import GetMeetingResponseMeeting from './GetMeetingResponseMeeting';

/**
 * The GetMeetingResponse model module.
 * @module model/GetMeetingResponse
 * @version 2018-05-01
 */
class GetMeetingResponse {
    /**
     * Constructs a new <code>GetMeetingResponse</code>.
     * @alias module:model/GetMeetingResponse
     */
    constructor() { 
        
        GetMeetingResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetMeetingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetMeetingResponse} obj Optional instance to populate.
     * @return {module:model/GetMeetingResponse} The populated <code>GetMeetingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMeetingResponse();

            if (data.hasOwnProperty('Meeting')) {
                obj['Meeting'] = GetMeetingResponseMeeting.constructFromObject(data['Meeting']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetMeetingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMeetingResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Meeting`
        if (data['Meeting']) { // data not null
          GetMeetingResponseMeeting.validateJSON(data['Meeting']);
        }
...
/**
 * @member {module:model/GetMeetingResponseMeeting} Meeting
 */
GetMeetingResponse.prototype['Meeting'] = undefined;
...
export default GetMeetingResponse;
