...
/**
 * The SipMediaApplicationLoggingConfiguration model module.
 * @module model/SipMediaApplicationLoggingConfiguration
 * @version 2018-05-01
 */
class SipMediaApplicationLoggingConfiguration {
    /**
     * Constructs a new <code>SipMediaApplicationLoggingConfiguration</code>.
     * Logging configuration of the SIP media application.
     * @alias module:model/SipMediaApplicationLoggingConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SipMediaApplicationLoggingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SipMediaApplicationLoggingConfiguration} obj Optional instance to populate.
     * @return {module:model/SipMediaApplicationLoggingConfiguration} The populated <code>SipMediaApplicationLoggingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SipMediaApplicationLoggingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>SipMediaApplicationLoggingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SipMediaApplicationLoggingConfiguration</code>.
     */
...
export default SipMediaApplicationLoggingConfiguration;
