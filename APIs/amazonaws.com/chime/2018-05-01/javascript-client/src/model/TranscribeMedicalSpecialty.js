...
* @readonly
*/
export default class TranscribeMedicalSpecialty {
    ...
    /**
    * Returns a <code>TranscribeMedicalSpecialty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TranscribeMedicalSpecialty} The enum <code>TranscribeMedicalSpecialty</code> value.
    */
