...
export default class NotificationTarget {
    ...
    /**
    * Returns a <code>NotificationTarget</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/NotificationTarget} The enum <code>NotificationTarget</code> value.
    */
