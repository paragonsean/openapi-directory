...
* @readonly
*/
export default class CallingNameStatus {
    ...
    /**
    * Returns a <code>CallingNameStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CallingNameStatus} The enum <code>CallingNameStatus</code> value.
    */
