...
import GetVoiceConnectorTerminationResponseTermination from './GetVoiceConnectorTerminationResponseTermination';

/**
 * The GetVoiceConnectorTerminationResponse model module.
 * @module model/GetVoiceConnectorTerminationResponse
 * @version 2018-05-01
 */
class GetVoiceConnectorTerminationResponse {
    /**
     * Constructs a new <code>GetVoiceConnectorTerminationResponse</code>.
     * @alias module:model/GetVoiceConnectorTerminationResponse
     */
    constructor() { 
        
        GetVoiceConnectorTerminationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVoiceConnectorTerminationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVoiceConnectorTerminationResponse} obj Optional instance to populate.
     * @return {module:model/GetVoiceConnectorTerminationResponse} The populated <code>GetVoiceConnectorTerminationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVoiceConnectorTerminationResponse();

            if (data.hasOwnProperty('Termination')) {
                obj['Termination'] = GetVoiceConnectorTerminationResponseTermination.constructFromObject(data['Termination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVoiceConnectorTerminationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVoiceConnectorTerminationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Termination`
        if (data['Termination']) { // data not null
          GetVoiceConnectorTerminationResponseTermination.validateJSON(data['Termination']);
        }
...
/**
 * @member {module:model/GetVoiceConnectorTerminationResponseTermination} Termination
 */
GetVoiceConnectorTerminationResponse.prototype['Termination'] = undefined;
...
export default GetVoiceConnectorTerminationResponse;
