...
import CreateAttendeeResponseAttendee from './CreateAttendeeResponseAttendee';

/**
 * The CreateAttendeeResponse model module.
 * @module model/CreateAttendeeResponse
 * @version 2018-05-01
 */
class CreateAttendeeResponse {
    /**
     * Constructs a new <code>CreateAttendeeResponse</code>.
     * @alias module:model/CreateAttendeeResponse
     */
    constructor() { 
        
        CreateAttendeeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAttendeeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAttendeeResponse} obj Optional instance to populate.
     * @return {module:model/CreateAttendeeResponse} The populated <code>CreateAttendeeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAttendeeResponse();

            if (data.hasOwnProperty('Attendee')) {
                obj['Attendee'] = CreateAttendeeResponseAttendee.constructFromObject(data['Attendee']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAttendeeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAttendeeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Attendee`
        if (data['Attendee']) { // data not null
          CreateAttendeeResponseAttendee.validateJSON(data['Attendee']);
        }
...
/**
 * @member {module:model/CreateAttendeeResponseAttendee} Attendee
 */
CreateAttendeeResponse.prototype['Attendee'] = undefined;
...
export default CreateAttendeeResponse;
