...
/**
 * The CreateAppInstanceUserResponse model module.
 * @module model/CreateAppInstanceUserResponse
 * @version 2018-05-01
 */
class CreateAppInstanceUserResponse {
    /**
     * Constructs a new <code>CreateAppInstanceUserResponse</code>.
     * @alias module:model/CreateAppInstanceUserResponse
     */
    constructor() { 
        
        CreateAppInstanceUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAppInstanceUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAppInstanceUserResponse} obj Optional instance to populate.
     * @return {module:model/CreateAppInstanceUserResponse} The populated <code>CreateAppInstanceUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAppInstanceUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAppInstanceUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAppInstanceUserResponse</code>.
     */
 ...
 */
CreateAppInstanceUserResponse.prototype['AppInstanceUserArn'] = undefined;
...
export default CreateAppInstanceUserResponse;
