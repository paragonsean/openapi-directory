...
import GetVoiceConnectorOriginationResponseOrigination from './GetVoiceConnectorOriginationResponseOrigination';

/**
 * The GetVoiceConnectorOriginationResponse model module.
 * @module model/GetVoiceConnectorOriginationResponse
 * @version 2018-05-01
 */
class GetVoiceConnectorOriginationResponse {
    /**
     * Constructs a new <code>GetVoiceConnectorOriginationResponse</code>.
     * @alias module:model/GetVoiceConnectorOriginationResponse
     */
    constructor() { 
        
        GetVoiceConnectorOriginationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetVoiceConnectorOriginationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetVoiceConnectorOriginationResponse} obj Optional instance to populate.
     * @return {module:model/GetVoiceConnectorOriginationResponse} The populated <code>GetVoiceConnectorOriginationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetVoiceConnectorOriginationResponse();

            if (data.hasOwnProperty('Origination')) {
                obj['Origination'] = GetVoiceConnectorOriginationResponseOrigination.constructFromObject(data['Origination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetVoiceConnectorOriginationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetVoiceConnectorOriginationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Origination`
        if (data['Origination']) { // data not null
          GetVoiceConnectorOriginationResponseOrigination.validateJSON(data['Origination']);
        }
...
/**
 * @member {module:model/GetVoiceConnectorOriginationResponseOrigination} Origination
 */
GetVoiceConnectorOriginationResponse.prototype['Origination'] = undefined;
...
export default GetVoiceConnectorOriginationResponse;
