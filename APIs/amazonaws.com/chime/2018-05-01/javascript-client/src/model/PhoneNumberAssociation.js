...
import PhoneNumberAssociationName from './PhoneNumberAssociationName';

/**
 * The PhoneNumberAssociation model module.
 * @module model/PhoneNumberAssociation
 * @version 2018-05-01
 */
class PhoneNumberAssociation {
    /**
     * Constructs a new <code>PhoneNumberAssociation</code>.
     * The phone number associations, such as Amazon Chime account ID, Amazon Chime user ID, Amazon Chime Voice Connector ID, or Amazon Chime Voice Connector group ID.
     * @alias module:model/PhoneNumberAssociation
     */
    constructor() { 
        
        PhoneNumberAssociation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PhoneNumberAssociation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PhoneNumberAssociation} obj Optional instance to populate.
     * @return {module:model/PhoneNumberAssociation} The populated <code>PhoneNumberAssociation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneNumberAssociation();

            if (data.hasOwnProperty('Value')) {
                obj['Value'] = ApiClient.convertToType(data['Value'], 'String');
            }
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], PhoneNumberAssociationName);
            }
            if (data.hasOwnProperty('AssociatedTimestamp')) {
                obj['AssociatedTimestamp'] = ApiClient.convertToType(data['AssociatedTimestamp'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneNumberAssociation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneNumberAssociation</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Name']) { // data not null
          PhoneNumberAssociationName.validateJSON(data['Name']);
        }
        // validate the optional field `AssociatedTimestamp`
        if (data['AssociatedTimestamp']) { // data not null
          Date.validateJSON(data['AssociatedTimestamp']);
        }
 ...
 * @member {String} Value
 */
PhoneNumberAssociation.prototype['Value'] = undefined;

/**
 * @member {module:model/PhoneNumberAssociationName} Name
 */
PhoneNumberAssociation.prototype['Name'] = undefined;

/**
 * @member {Date} AssociatedTimestamp
 */
PhoneNumberAssociation.prototype['AssociatedTimestamp'] = undefined;
...
export default PhoneNumberAssociation;
