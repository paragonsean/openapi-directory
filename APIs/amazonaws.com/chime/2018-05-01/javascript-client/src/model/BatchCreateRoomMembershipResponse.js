...
/**
 * The BatchCreateRoomMembershipResponse model module.
 * @module model/BatchCreateRoomMembershipResponse
 * @version 2018-05-01
 */
class BatchCreateRoomMembershipResponse {
    /**
     * Constructs a new <code>BatchCreateRoomMembershipResponse</code>.
     * @alias module:model/BatchCreateRoomMembershipResponse
     */
    constructor() { 
        
        BatchCreateRoomMembershipResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchCreateRoomMembershipResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchCreateRoomMembershipResponse} obj Optional instance to populate.
     * @return {module:model/BatchCreateRoomMembershipResponse} The populated <code>BatchCreateRoomMembershipResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchCreateRoomMembershipResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchCreateRoomMembershipResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchCreateRoomMembershipResponse</code>.
     */
 ...
 * @member {Array} Errors
 */
BatchCreateRoomMembershipResponse.prototype['Errors'] = undefined;
...
export default BatchCreateRoomMembershipResponse;
