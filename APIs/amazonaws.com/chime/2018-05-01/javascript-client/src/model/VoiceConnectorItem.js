...
/**
 * The VoiceConnectorItem model module.
 * @module model/VoiceConnectorItem
 * @version 2018-05-01
 */
class VoiceConnectorItem {
    /**
     * Constructs a new <code>VoiceConnectorItem</code>.
     ...
     * @alias module:model/VoiceConnectorItem
     * @param voiceConnectorId {String} 
     * @param priority {Number} 
     */
    constructor(voiceConnectorId, priority) { 
        
        VoiceConnectorItem.initialize(this, voiceConnectorId, priority);
    }
     ...
     */
    static initialize(obj, voiceConnectorId, priority) { 
        obj['VoiceConnectorId'] = voiceConnectorId;
        obj['Priority'] = priority;
    }

    /**
     * Constructs a <code>VoiceConnectorItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VoiceConnectorItem} obj Optional instance to populate.
     * @return {module:model/VoiceConnectorItem} The populated <code>VoiceConnectorItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoiceConnectorItem();
    ...
    /**
     * Validates the JSON data with respect to <code>VoiceConnectorItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoiceConnectorItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VoiceConnectorItem.RequiredProperties) {
...
VoiceConnectorItem.RequiredProperties = ["VoiceConnectorId", "Priority"];

/**
 * @member {String} VoiceConnectorId
 */
VoiceConnectorItem.prototype['VoiceConnectorId'] = undefined;

/**
 * @member {Number} Priority
 */
VoiceConnectorItem.prototype['Priority'] = undefined;
...
export default VoiceConnectorItem;
