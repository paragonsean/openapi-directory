...
/**
 * The ListSupportedPhoneNumberCountriesResponse model module.
 * @module model/ListSupportedPhoneNumberCountriesResponse
 * @version 2018-05-01
 */
class ListSupportedPhoneNumberCountriesResponse {
    /**
     * Constructs a new <code>ListSupportedPhoneNumberCountriesResponse</code>.
     * @alias module:model/ListSupportedPhoneNumberCountriesResponse
     */
    constructor() { 
        
        ListSupportedPhoneNumberCountriesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSupportedPhoneNumberCountriesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSupportedPhoneNumberCountriesResponse} obj Optional instance to populate.
     * @return {module:model/ListSupportedPhoneNumberCountriesResponse} The populated <code>ListSupportedPhoneNumberCountriesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSupportedPhoneNumberCountriesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSupportedPhoneNumberCountriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSupportedPhoneNumberCountriesResponse</code>.
     */
 ...
 */
ListSupportedPhoneNumberCountriesResponse.prototype['PhoneNumberCountries'] = undefined;
...
export default ListSupportedPhoneNumberCountriesResponse;
