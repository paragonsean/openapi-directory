...
/**
 * The InviteUsersResponse model module.
 * @module model/InviteUsersResponse
 * @version 2018-05-01
 */
class InviteUsersResponse {
    /**
     * Constructs a new <code>InviteUsersResponse</code>.
     * @alias module:model/InviteUsersResponse
     */
    constructor() { 
        
        InviteUsersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InviteUsersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InviteUsersResponse} obj Optional instance to populate.
     * @return {module:model/InviteUsersResponse} The populated <code>InviteUsersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InviteUsersResponse();

            if (data.hasOwnProperty('Invites')) {
                obj['Invites'] = ApiClient.convertToType(data['Invites'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InviteUsersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InviteUsersResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Invites`
        if (data['Invites']) { // data not null
          Array.validateJSON(data['Invites']);
        }
...
/**
 * @member {Array} Invites
 */
InviteUsersResponse.prototype['Invites'] = undefined;
...
export default InviteUsersResponse;
