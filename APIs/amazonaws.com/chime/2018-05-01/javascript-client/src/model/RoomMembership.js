...
/**
 * The RoomMembership model module.
 * @module model/RoomMembership
 * @version 2018-05-01
 */
class RoomMembership {
    /**
     * Constructs a new <code>RoomMembership</code>.
     * The room membership details.
     * @alias module:model/RoomMembership
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RoomMembership</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoomMembership} obj Optional instance to populate.
     * @return {module:model/RoomMembership} The populated <code>RoomMembership</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoomMembership();
    ...
    /**
     * Validates the JSON data with respect to <code>RoomMembership</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoomMembership</code>.
     */
