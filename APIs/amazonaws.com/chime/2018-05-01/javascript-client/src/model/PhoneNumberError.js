...
/**
 * The PhoneNumberError model module.
 * @module model/PhoneNumberError
 * @version 2018-05-01
 */
class PhoneNumberError {
    /**
     * Constructs a new <code>PhoneNumberError</code>.
     * If the phone number action fails for one or more of the phone numbers in the request, a list of the phone numbers is returned, along with error codes and error messages.
     * @alias module:model/PhoneNumberError
     */
    constructor() { 
        
        PhoneNumberError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PhoneNumberError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PhoneNumberError} obj Optional instance to populate.
     * @return {module:model/PhoneNumberError} The populated <code>PhoneNumberError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PhoneNumberError();
    ...
    /**
     * Validates the JSON data with respect to <code>PhoneNumberError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PhoneNumberError</code>.
     */
 ...
 */
PhoneNumberError.prototype['PhoneNumberId'] = undefined;

/**
 * @member {module:model/ErrorCode} ErrorCode
 */
PhoneNumberError.prototype['ErrorCode'] = undefined;

/**
 * @member {String} ErrorMessage
 */
PhoneNumberError.prototype['ErrorMessage'] = undefined;
