...
class Origination {
     ...
     * @alias module:model/Origination
     */
    constructor() { 
     ...
     * @param {module:model/Origination} obj Optional instance to populate.
     * @return {module:model/Origination} The populated <code>Origination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Origination();
    ...
    /**
     * Validates the JSON data with respect to <code>Origination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Origination</code>.
     */
