...
/**
 * The SendChannelMessageResponse model module.
 * @module model/SendChannelMessageResponse
 * @version 2018-05-01
 */
class SendChannelMessageResponse {
    /**
     * Constructs a new <code>SendChannelMessageResponse</code>.
     * @alias module:model/SendChannelMessageResponse
     */
    constructor() { 
        
        SendChannelMessageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendChannelMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendChannelMessageResponse} obj Optional instance to populate.
     * @return {module:model/SendChannelMessageResponse} The populated <code>SendChannelMessageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendChannelMessageResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SendChannelMessageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendChannelMessageResponse</code>.
     */
 ...
 */
SendChannelMessageResponse.prototype['ChannelArn'] = undefined;

/**
 * @member {String} MessageId
 */
SendChannelMessageResponse.prototype['MessageId'] = undefined;
...
export default SendChannelMessageResponse;
