...
class UpdatePhoneNumberRequest {
    ...
    constructor() { 
        ...
        UpdatePhoneNumberRequest.initialize(this);
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['CallingName'] && !(typeof data['CallingName'] === 'string' || data['CallingName'] instanceof String)) {
            throw new Error("Expected the field `CallingName` to be a primitive type in the JSON string but got " + data['CallingName']);
        }
...
/**
 * The product type.
 * @member {module:model/UpdatePhoneNumberRequest.ProductTypeEnum} ProductType
 */
UpdatePhoneNumberRequest.prototype['ProductType'] = undefined;

/**
 * The outbound calling name associated with the phone number.
 * @member {String} CallingName
 */
UpdatePhoneNumberRequest.prototype['CallingName'] = undefined;
 ...
 * @readonly
 */
UpdatePhoneNumberRequest['ProductTypeEnum'] = {
