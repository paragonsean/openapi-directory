...
/**
 * The SigninDelegateGroup model module.
 * @module model/SigninDelegateGroup
 * @version 2018-05-01
 */
class SigninDelegateGroup {
    /**
     * Constructs a new <code>SigninDelegateGroup</code>.
     * An Active Directory (AD) group whose members are granted permission to act as delegates.
     * @alias module:model/SigninDelegateGroup
     */
    constructor() { 
        
        SigninDelegateGroup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SigninDelegateGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SigninDelegateGroup} obj Optional instance to populate.
     * @return {module:model/SigninDelegateGroup} The populated <code>SigninDelegateGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SigninDelegateGroup();
    ...
    /**
     * Validates the JSON data with respect to <code>SigninDelegateGroup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SigninDelegateGroup</code>.
     */
 ...
 */
SigninDelegateGroup.prototype['GroupName'] = undefined;
...
export default SigninDelegateGroup;
