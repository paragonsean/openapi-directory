...
import PutVoiceConnectorTerminationResponseTermination from './PutVoiceConnectorTerminationResponseTermination';

/**
 * The PutVoiceConnectorTerminationResponse model module.
 * @module model/PutVoiceConnectorTerminationResponse
 * @version 2018-05-01
 */
class PutVoiceConnectorTerminationResponse {
    /**
     * Constructs a new <code>PutVoiceConnectorTerminationResponse</code>.
     * @alias module:model/PutVoiceConnectorTerminationResponse
     */
    constructor() { 
        
        PutVoiceConnectorTerminationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutVoiceConnectorTerminationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutVoiceConnectorTerminationResponse} obj Optional instance to populate.
     * @return {module:model/PutVoiceConnectorTerminationResponse} The populated <code>PutVoiceConnectorTerminationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutVoiceConnectorTerminationResponse();

            if (data.hasOwnProperty('Termination')) {
                obj['Termination'] = PutVoiceConnectorTerminationResponseTermination.constructFromObject(data['Termination']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutVoiceConnectorTerminationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutVoiceConnectorTerminationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Termination`
        if (data['Termination']) { // data not null
          PutVoiceConnectorTerminationResponseTermination.validateJSON(data['Termination']);
        }
...
/**
 * @member {module:model/PutVoiceConnectorTerminationResponseTermination} Termination
 */
PutVoiceConnectorTerminationResponse.prototype['Termination'] = undefined;
...
export default PutVoiceConnectorTerminationResponse;
