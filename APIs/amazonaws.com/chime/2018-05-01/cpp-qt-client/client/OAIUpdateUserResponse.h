...
namespace OpenAPI {
class OAIUpdateUserResponse_User;
...
public:
    ...
    OAIUpdateUserResponse_User getUser() const;
    void setUser(const OAIUpdateUserResponse_User &user);
...
private:
    ...
    OAIUpdateUserResponse_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
