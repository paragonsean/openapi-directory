...
#include "OAIPutVoiceConnectorOriginationRequest.h"
...
OAIPutVoiceConnectorOriginationRequest::OAIPutVoiceConnectorOriginationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorOriginationRequest::OAIPutVoiceConnectorOriginationRequest() {
    this->initializeModel();
}

OAIPutVoiceConnectorOriginationRequest::~OAIPutVoiceConnectorOriginationRequest() {}

void OAIPutVoiceConnectorOriginationRequest::initializeModel() {

    m_origination_isSet = false;
    m_origination_isValid = false;
}

void OAIPutVoiceConnectorOriginationRequest::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorOriginationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorOriginationRequest::asJson() const {
...
QJsonObject OAIPutVoiceConnectorOriginationRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorOriginationRequest_Origination OAIPutVoiceConnectorOriginationRequest::getOrigination() const {
    return m_origination;
}
void OAIPutVoiceConnectorOriginationRequest::setOrigination(const OAIPutVoiceConnectorOriginationRequest_Origination &origination) {
    m_origination = origination;
    m_origination_isSet = true;
}

bool OAIPutVoiceConnectorOriginationRequest::is_origination_Set() const{
    return m_origination_isSet;
}

bool OAIPutVoiceConnectorOriginationRequest::is_origination_Valid() const{
    return m_origination_isValid;
}

bool OAIPutVoiceConnectorOriginationRequest::isSet() const {
...
bool OAIPutVoiceConnectorOriginationRequest::isValid() const {
