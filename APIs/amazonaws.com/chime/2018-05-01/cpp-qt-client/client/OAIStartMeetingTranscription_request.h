...
/*
 * OAIStartMeetingTranscription_request.h
 *
 * 
 */

#ifndef OAIStartMeetingTranscription_request_H
#define OAIStartMeetingTranscription_request_H
...
namespace OpenAPI {
class OAIStartMeetingTranscription_request_TranscriptionConfiguration;

class OAIStartMeetingTranscription_request : public OAIObject {
public:
    OAIStartMeetingTranscription_request();
    OAIStartMeetingTranscription_request(QString json);
    ~OAIStartMeetingTranscription_request() override;
    ...
    OAIStartMeetingTranscription_request_TranscriptionConfiguration getTranscriptionConfiguration() const;
    void setTranscriptionConfiguration(const OAIStartMeetingTranscription_request_TranscriptionConfiguration &transcription_configuration);
...
private:
    ...
    OAIStartMeetingTranscription_request_TranscriptionConfiguration m_transcription_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartMeetingTranscription_request)

#endif // OAIStartMeetingTranscription_request_H
