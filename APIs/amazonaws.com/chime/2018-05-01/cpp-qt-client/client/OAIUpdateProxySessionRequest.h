...
/*
 * OAIUpdateProxySessionRequest.h
 *
 * 
 */

#ifndef OAIUpdateProxySessionRequest_H
#define OAIUpdateProxySessionRequest_H
...
class OAIUpdateProxySessionRequest : public OAIObject {
public:
    OAIUpdateProxySessionRequest();
    OAIUpdateProxySessionRequest(QString json);
    ~OAIUpdateProxySessionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProxySessionRequest)

#endif // OAIUpdateProxySessionRequest_H
