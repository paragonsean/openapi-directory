...
/*
 * OAIUpdateAppInstanceUserResponse.h
 *
 * 
 */

#ifndef OAIUpdateAppInstanceUserResponse_H
#define OAIUpdateAppInstanceUserResponse_H
...
class OAIUpdateAppInstanceUserResponse : public OAIObject {
public:
    OAIUpdateAppInstanceUserResponse();
    OAIUpdateAppInstanceUserResponse(QString json);
    ~OAIUpdateAppInstanceUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppInstanceUserResponse)

#endif // OAIUpdateAppInstanceUserResponse_H
