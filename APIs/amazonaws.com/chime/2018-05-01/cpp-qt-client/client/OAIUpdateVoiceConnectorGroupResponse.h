...
/*
 * OAIUpdateVoiceConnectorGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnectorGroupResponse_H
#define OAIUpdateVoiceConnectorGroupResponse_H

#include <QJsonObject>

#include "OAIUpdateVoiceConnectorGroupResponse_VoiceConnectorGroup.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateVoiceConnectorGroupResponse_VoiceConnectorGroup;

class OAIUpdateVoiceConnectorGroupResponse : public OAIObject {
public:
    OAIUpdateVoiceConnectorGroupResponse();
    OAIUpdateVoiceConnectorGroupResponse(QString json);
    ~OAIUpdateVoiceConnectorGroupResponse() override;
    ...
    OAIUpdateVoiceConnectorGroupResponse_VoiceConnectorGroup getVoiceConnectorGroup() const;
    void setVoiceConnectorGroup(const OAIUpdateVoiceConnectorGroupResponse_VoiceConnectorGroup &voice_connector_group);
    bool is_voice_connector_group_Set() const;
    bool is_voice_connector_group_Valid() const;
...
private:
    ...
    OAIUpdateVoiceConnectorGroupResponse_VoiceConnectorGroup m_voice_connector_group;
    bool m_voice_connector_group_isSet;
    bool m_voice_connector_group_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnectorGroupResponse)

#endif // OAIUpdateVoiceConnectorGroupResponse_H
