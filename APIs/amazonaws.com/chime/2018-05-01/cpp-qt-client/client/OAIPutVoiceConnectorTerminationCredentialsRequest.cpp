...
#include "OAIPutVoiceConnectorTerminationCredentialsRequest.h"
...
OAIPutVoiceConnectorTerminationCredentialsRequest::OAIPutVoiceConnectorTerminationCredentialsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorTerminationCredentialsRequest::OAIPutVoiceConnectorTerminationCredentialsRequest() {
    this->initializeModel();
}

OAIPutVoiceConnectorTerminationCredentialsRequest::~OAIPutVoiceConnectorTerminationCredentialsRequest() {}

void OAIPutVoiceConnectorTerminationCredentialsRequest::initializeModel() {

    m_credentials_isSet = false;
    m_credentials_isValid = false;
}

void OAIPutVoiceConnectorTerminationCredentialsRequest::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorTerminationCredentialsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorTerminationCredentialsRequest::asJson() const {
...
QJsonObject OAIPutVoiceConnectorTerminationCredentialsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPutVoiceConnectorTerminationCredentialsRequest::getCredentials() const {
    return m_credentials;
}
void OAIPutVoiceConnectorTerminationCredentialsRequest::setCredentials(const QList &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPutVoiceConnectorTerminationCredentialsRequest::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPutVoiceConnectorTerminationCredentialsRequest::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPutVoiceConnectorTerminationCredentialsRequest::isSet() const {
...
bool OAIPutVoiceConnectorTerminationCredentialsRequest::isValid() const {
