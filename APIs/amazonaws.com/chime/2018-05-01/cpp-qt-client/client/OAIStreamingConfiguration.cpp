...
qint32 OAIStreamingConfiguration::getDataRetentionInHours() const {
    return m_data_retention_in_hours;
}
void OAIStreamingConfiguration::setDataRetentionInHours(const qint32 &data_retention_in_hours) {
    m_data_retention_in_hours = data_retention_in_hours;
    m_data_retention_in_hours_isSet = true;
}

bool OAIStreamingConfiguration::is_data_retention_in_hours_Set() const{
    return m_data_retention_in_hours_isSet;
}

bool OAIStreamingConfiguration::is_data_retention_in_hours_Valid() const{
    return m_data_retention_in_hours_isValid;
}

bool OAIStreamingConfiguration::getDisabled() const {
    return m_disabled;
}
void OAIStreamingConfiguration::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIStreamingConfiguration::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIStreamingConfiguration::is_disabled_Valid() const{
    return m_disabled_isValid;
}

QList OAIStreamingConfiguration::getStreamingNotificationTargets() const {
    return m_streaming_notification_targets;
}
void OAIStreamingConfiguration::setStreamingNotificationTargets(const QList &streaming_notification_targets) {
    m_streaming_notification_targets = streaming_notification_targets;
    m_streaming_notification_targets_isSet = true;
}

bool OAIStreamingConfiguration::is_streaming_notification_targets_Set() const{
    return m_streaming_notification_targets_isSet;
}

bool OAIStreamingConfiguration::is_streaming_notification_targets_Valid() const{
...
bool OAIStreamingConfiguration::isValid() const {
    ...
    return m_data_retention_in_hours_isValid && true;
}
