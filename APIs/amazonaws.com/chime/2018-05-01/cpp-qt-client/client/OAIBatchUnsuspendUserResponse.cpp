...
OAIBatchUnsuspendUserResponse::OAIBatchUnsuspendUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUnsuspendUserResponse::OAIBatchUnsuspendUserResponse() {
    this->initializeModel();
}

OAIBatchUnsuspendUserResponse::~OAIBatchUnsuspendUserResponse() {}

void OAIBatchUnsuspendUserResponse::initializeModel() {

    m_user_errors_isSet = false;
    m_user_errors_isValid = false;
}

void OAIBatchUnsuspendUserResponse::fromJson(QString jsonString) {
...
void OAIBatchUnsuspendUserResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUnsuspendUserResponse::asJson() const {
...
QJsonObject OAIBatchUnsuspendUserResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchUnsuspendUserResponse::getUserErrors() const {
    return m_user_errors;
}
void OAIBatchUnsuspendUserResponse::setUserErrors(const QList &user_errors) {
    m_user_errors = user_errors;
    m_user_errors_isSet = true;
}

bool OAIBatchUnsuspendUserResponse::is_user_errors_Set() const{
    return m_user_errors_isSet;
}

bool OAIBatchUnsuspendUserResponse::is_user_errors_Valid() const{
    return m_user_errors_isValid;
}

bool OAIBatchUnsuspendUserResponse::isSet() const {
...
bool OAIBatchUnsuspendUserResponse::isValid() const {
