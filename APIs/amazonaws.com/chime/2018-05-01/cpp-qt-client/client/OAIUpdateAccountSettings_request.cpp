...
OAIUpdateAccountSettings_request_AccountSettings OAIUpdateAccountSettings_request::getAccountSettings() const {
    return m_account_settings;
}
void OAIUpdateAccountSettings_request::setAccountSettings(const OAIUpdateAccountSettings_request_AccountSettings &account_settings) {
    m_account_settings = account_settings;
    m_account_settings_isSet = true;
}

bool OAIUpdateAccountSettings_request::is_account_settings_Set() const{
    return m_account_settings_isSet;
}

bool OAIUpdateAccountSettings_request::is_account_settings_Valid() const{
