...
OAINumberSelectionBehavior::OAINumberSelectionBehavior(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINumberSelectionBehavior::OAINumberSelectionBehavior() {
    this->initializeModel();
}

OAINumberSelectionBehavior::~OAINumberSelectionBehavior() {}

void OAINumberSelectionBehavior::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAINumberSelectionBehavior::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAINumberSelectionBehavior::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PreferSticky", Qt::CaseInsensitive) == 0) {
        m_value = eOAINumberSelectionBehavior::PREFERSTICKY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AvoidSticky", Qt::CaseInsensitive) == 0) {
        m_value = eOAINumberSelectionBehavior::AVOIDSTICKY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAINumberSelectionBehavior::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAINumberSelectionBehavior::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAINumberSelectionBehavior::PREFERSTICKY:
            val = "PreferSticky";
            break;
        case eOAINumberSelectionBehavior::AVOIDSTICKY:
            val = "AvoidSticky";
            break;
        default:
            break;
...
QJsonValue OAINumberSelectionBehavior::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAINumberSelectionBehavior::eOAINumberSelectionBehavior OAINumberSelectionBehavior::getValue() const {
    return m_value;
}

void OAINumberSelectionBehavior::setValue(const OAINumberSelectionBehavior::eOAINumberSelectionBehavior& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAINumberSelectionBehavior::isSet() const {
    
    return m_value_isSet;
}

bool OAINumberSelectionBehavior::isValid() const {
