...
/*
 * OAIRedactChannelMessageResponse.h
 *
 * 
 */

#ifndef OAIRedactChannelMessageResponse_H
#define OAIRedactChannelMessageResponse_H
...
class OAIRedactChannelMessageResponse : public OAIObject {
public:
    OAIRedactChannelMessageResponse();
    OAIRedactChannelMessageResponse(QString json);
    ~OAIRedactChannelMessageResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedactChannelMessageResponse)

#endif // OAIRedactChannelMessageResponse_H
