...
OAIUpdateUserSettings_request_UserSettings_Telephony OAIUserSettings::getTelephony() const {
    return m_telephony;
}
void OAIUserSettings::setTelephony(const OAIUpdateUserSettings_request_UserSettings_Telephony &telephony) {
    m_telephony = telephony;
    m_telephony_isSet = true;
}

bool OAIUserSettings::is_telephony_Set() const{
    return m_telephony_isSet;
}

bool OAIUserSettings::is_telephony_Valid() const{
