...
namespace OpenAPI {
class OAIMeeting_MediaPlacement;
...
public:
    ...
    OAIMeeting_MediaPlacement getMediaPlacement() const;
    void setMediaPlacement(const OAIMeeting_MediaPlacement &media_placement);
    bool is_media_placement_Set() const;
    bool is_media_placement_Valid() const;
...
private:
    ...
    OAIMeeting_MediaPlacement m_media_placement;
    bool m_media_placement_isSet;
    bool m_media_placement_isValid;
