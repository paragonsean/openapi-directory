...
/*
 * OAICreatePhoneNumberOrderResponse.h
 *
 * 
 */

#ifndef OAICreatePhoneNumberOrderResponse_H
#define OAICreatePhoneNumberOrderResponse_H
...
class OAICreatePhoneNumberOrderResponse : public OAIObject {
public:
    OAICreatePhoneNumberOrderResponse();
    OAICreatePhoneNumberOrderResponse(QString json);
    ~OAICreatePhoneNumberOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePhoneNumberOrderResponse)

#endif // OAICreatePhoneNumberOrderResponse_H
