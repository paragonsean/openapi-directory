...
/*
 * OAIPutVoiceConnectorLoggingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorLoggingConfigurationResponse_H
#define OAIPutVoiceConnectorLoggingConfigurationResponse_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration;

class OAIPutVoiceConnectorLoggingConfigurationResponse : public OAIObject {
public:
    OAIPutVoiceConnectorLoggingConfigurationResponse();
    OAIPutVoiceConnectorLoggingConfigurationResponse(QString json);
    ~OAIPutVoiceConnectorLoggingConfigurationResponse() override;
    ...
    OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration &logging_configuration);
...
private:
    ...
    OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration m_logging_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorLoggingConfigurationResponse)

#endif // OAIPutVoiceConnectorLoggingConfigurationResponse_H
