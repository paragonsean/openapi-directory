...
#include "OAIStreamingNotificationTarget.h"
...
OAIStreamingNotificationTarget::OAIStreamingNotificationTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamingNotificationTarget::OAIStreamingNotificationTarget() {
    this->initializeModel();
}

OAIStreamingNotificationTarget::~OAIStreamingNotificationTarget() {}

void OAIStreamingNotificationTarget::initializeModel() {

    m_notification_target_isSet = false;
    m_notification_target_isValid = false;
}

void OAIStreamingNotificationTarget::fromJson(QString jsonString) {
...
void OAIStreamingNotificationTarget::fromJsonObject(QJsonObject json) {
...
QString OAIStreamingNotificationTarget::asJson() const {
...
QJsonObject OAIStreamingNotificationTarget::asJsonObject() const {
    QJsonObject obj;
    if (m_notification_target.isSet()) {
        obj.insert(QString("NotificationTarget"), ::OpenAPI::toJsonValue(m_notification_target));
    }
    return obj;
}

OAINotificationTarget OAIStreamingNotificationTarget::getNotificationTarget() const {
    return m_notification_target;
}
void OAIStreamingNotificationTarget::setNotificationTarget(const OAINotificationTarget &notification_target) {
    m_notification_target = notification_target;
    m_notification_target_isSet = true;
}

bool OAIStreamingNotificationTarget::is_notification_target_Set() const{
    return m_notification_target_isSet;
}

bool OAIStreamingNotificationTarget::is_notification_target_Valid() const{
    return m_notification_target_isValid;
}

bool OAIStreamingNotificationTarget::isSet() const {
...
bool OAIStreamingNotificationTarget::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_notification_target_isValid && true;
}
