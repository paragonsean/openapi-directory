...
OAIRestorePhoneNumberResponse::OAIRestorePhoneNumberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestorePhoneNumberResponse::OAIRestorePhoneNumberResponse() {
    this->initializeModel();
}

OAIRestorePhoneNumberResponse::~OAIRestorePhoneNumberResponse() {}

void OAIRestorePhoneNumberResponse::initializeModel() {

    m_phone_number_isSet = false;
    m_phone_number_isValid = false;
}

void OAIRestorePhoneNumberResponse::fromJson(QString jsonString) {
...
void OAIRestorePhoneNumberResponse::fromJsonObject(QJsonObject json) {

    m_phone_number_isValid = ::OpenAPI::fromJsonValue(m_phone_number, json[QString("PhoneNumber")]);
    m_phone_number_isSet = !json[QString("PhoneNumber")].isNull() && m_phone_number_isValid;
}

QString OAIRestorePhoneNumberResponse::asJson() const {
...
QJsonObject OAIRestorePhoneNumberResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetPhoneNumberResponse_PhoneNumber OAIRestorePhoneNumberResponse::getPhoneNumber() const {
    return m_phone_number;
}
void OAIRestorePhoneNumberResponse::setPhoneNumber(const OAIGetPhoneNumberResponse_PhoneNumber &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIRestorePhoneNumberResponse::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIRestorePhoneNumberResponse::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

bool OAIRestorePhoneNumberResponse::isSet() const {
...
bool OAIRestorePhoneNumberResponse::isValid() const {
