...
/*
 * OAIPutVoiceConnectorStreamingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorStreamingConfigurationResponse_H
#define OAIPutVoiceConnectorStreamingConfigurationResponse_H

#include <QJsonObject>

#include "OAIPutVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration;

class OAIPutVoiceConnectorStreamingConfigurationResponse : public OAIObject {
public:
    OAIPutVoiceConnectorStreamingConfigurationResponse();
    OAIPutVoiceConnectorStreamingConfigurationResponse(QString json);
    ~OAIPutVoiceConnectorStreamingConfigurationResponse() override;
    ...
    OAIPutVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration getStreamingConfiguration() const;
    void setStreamingConfiguration(const OAIPutVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration &streaming_configuration);
    bool is_streaming_configuration_Set() const;
    bool is_streaming_configuration_Valid() const;
...
private:
    ...
    OAIPutVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration m_streaming_configuration;
    bool m_streaming_configuration_isSet;
    bool m_streaming_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorStreamingConfigurationResponse)

#endif // OAIPutVoiceConnectorStreamingConfigurationResponse_H
