...
/*
 * OAIGetPhoneNumberOrderResponse.h
 *
 * 
 */

#ifndef OAIGetPhoneNumberOrderResponse_H
#define OAIGetPhoneNumberOrderResponse_H
...
namespace OpenAPI {
class OAICreatePhoneNumberOrderResponse_PhoneNumberOrder;

class OAIGetPhoneNumberOrderResponse : public OAIObject {
public:
    OAIGetPhoneNumberOrderResponse();
    OAIGetPhoneNumberOrderResponse(QString json);
    ~OAIGetPhoneNumberOrderResponse() override;
    ...
    OAICreatePhoneNumberOrderResponse_PhoneNumberOrder getPhoneNumberOrder() const;
    void setPhoneNumberOrder(const OAICreatePhoneNumberOrderResponse_PhoneNumberOrder &phone_number_order);
    bool is_phone_number_order_Set() const;
    bool is_phone_number_order_Valid() const;
...
private:
    ...
    OAICreatePhoneNumberOrderResponse_PhoneNumberOrder m_phone_number_order;
    bool m_phone_number_order_isSet;
    bool m_phone_number_order_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetPhoneNumberOrderResponse)

#endif // OAIGetPhoneNumberOrderResponse_H
