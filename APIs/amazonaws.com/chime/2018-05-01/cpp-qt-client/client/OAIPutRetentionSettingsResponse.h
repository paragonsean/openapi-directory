...
/*
 * OAIPutRetentionSettingsResponse.h
 *
 * 
 */

#ifndef OAIPutRetentionSettingsResponse_H
#define OAIPutRetentionSettingsResponse_H
...
class OAIPutRetentionSettingsResponse : public OAIObject {
public:
    OAIPutRetentionSettingsResponse();
    OAIPutRetentionSettingsResponse(QString json);
    ~OAIPutRetentionSettingsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRetentionSettingsResponse)

#endif // OAIPutRetentionSettingsResponse_H
