...
OAIAssociatePhoneNumberWithUser_request::OAIAssociatePhoneNumberWithUser_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociatePhoneNumberWithUser_request::OAIAssociatePhoneNumberWithUser_request() {
    this->initializeModel();
}

OAIAssociatePhoneNumberWithUser_request::~OAIAssociatePhoneNumberWithUser_request() {}

void OAIAssociatePhoneNumberWithUser_request::initializeModel() {

    m_e164_phone_number_isSet = false;
    m_e164_phone_number_isValid = false;
}

void OAIAssociatePhoneNumberWithUser_request::fromJson(QString jsonString) {
...
void OAIAssociatePhoneNumberWithUser_request::fromJsonObject(QJsonObject json) {
...
QString OAIAssociatePhoneNumberWithUser_request::asJson() const {
...
QJsonObject OAIAssociatePhoneNumberWithUser_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociatePhoneNumberWithUser_request::getE164PhoneNumber() const {
    return m_e164_phone_number;
}
void OAIAssociatePhoneNumberWithUser_request::setE164PhoneNumber(const QString &e164_phone_number) {
    m_e164_phone_number = e164_phone_number;
    m_e164_phone_number_isSet = true;
}

bool OAIAssociatePhoneNumberWithUser_request::is_e164_phone_number_Set() const{
    return m_e164_phone_number_isSet;
}

bool OAIAssociatePhoneNumberWithUser_request::is_e164_phone_number_Valid() const{
    return m_e164_phone_number_isValid;
}

bool OAIAssociatePhoneNumberWithUser_request::isSet() const {
...
bool OAIAssociatePhoneNumberWithUser_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_e164_phone_number_isValid && true;
}
