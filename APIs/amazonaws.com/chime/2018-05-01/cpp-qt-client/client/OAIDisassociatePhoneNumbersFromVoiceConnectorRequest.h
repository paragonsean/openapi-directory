...
/*
 * OAIDisassociatePhoneNumbersFromVoiceConnectorRequest.h
 *
 * 
 */

#ifndef OAIDisassociatePhoneNumbersFromVoiceConnectorRequest_H
#define OAIDisassociatePhoneNumbersFromVoiceConnectorRequest_H
...
class OAIDisassociatePhoneNumbersFromVoiceConnectorRequest : public OAIObject {
public:
    OAIDisassociatePhoneNumbersFromVoiceConnectorRequest();
    OAIDisassociatePhoneNumbersFromVoiceConnectorRequest(QString json);
    ~OAIDisassociatePhoneNumbersFromVoiceConnectorRequest() override;
    ...
    QList getE164PhoneNumbers() const;
    void setE164PhoneNumbers(const QList &e164_phone_numbers);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociatePhoneNumbersFromVoiceConnectorRequest)

#endif // OAIDisassociatePhoneNumbersFromVoiceConnectorRequest_H
