...
OAITranscribeMedicalContentIdentificationType::OAITranscribeMedicalContentIdentificationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeMedicalContentIdentificationType::OAITranscribeMedicalContentIdentificationType() {
    this->initializeModel();
}

OAITranscribeMedicalContentIdentificationType::~OAITranscribeMedicalContentIdentificationType() {}

void OAITranscribeMedicalContentIdentificationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeMedicalContentIdentificationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeMedicalContentIdentificationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PHI", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalContentIdentificationType::PHI;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeMedicalContentIdentificationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeMedicalContentIdentificationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeMedicalContentIdentificationType::PHI:
            val = "PHI";
            break;
        default:
            break;
...
QJsonValue OAITranscribeMedicalContentIdentificationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeMedicalContentIdentificationType::eOAITranscribeMedicalContentIdentificationType OAITranscribeMedicalContentIdentificationType::getValue() const {
    return m_value;
}

void OAITranscribeMedicalContentIdentificationType::setValue(const OAITranscribeMedicalContentIdentificationType::eOAITranscribeMedicalContentIdentificationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeMedicalContentIdentificationType::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeMedicalContentIdentificationType::isValid() const {
