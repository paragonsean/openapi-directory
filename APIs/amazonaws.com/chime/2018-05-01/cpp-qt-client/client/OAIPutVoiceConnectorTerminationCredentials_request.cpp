...
OAIPutVoiceConnectorTerminationCredentials_request::OAIPutVoiceConnectorTerminationCredentials_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorTerminationCredentials_request::OAIPutVoiceConnectorTerminationCredentials_request() {
    this->initializeModel();
}

OAIPutVoiceConnectorTerminationCredentials_request::~OAIPutVoiceConnectorTerminationCredentials_request() {}

void OAIPutVoiceConnectorTerminationCredentials_request::initializeModel() {

    m_credentials_isSet = false;
    m_credentials_isValid = false;
}

void OAIPutVoiceConnectorTerminationCredentials_request::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorTerminationCredentials_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorTerminationCredentials_request::asJson() const {
...
QJsonObject OAIPutVoiceConnectorTerminationCredentials_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICredential> OAIPutVoiceConnectorTerminationCredentials_request::getCredentials() const {
    return m_credentials;
}
void OAIPutVoiceConnectorTerminationCredentials_request::setCredentials(const QList<OAICredential> &credentials) {
    m_credentials = credentials;
    m_credentials_isSet = true;
}

bool OAIPutVoiceConnectorTerminationCredentials_request::is_credentials_Set() const{
    return m_credentials_isSet;
}

bool OAIPutVoiceConnectorTerminationCredentials_request::is_credentials_Valid() const{
    return m_credentials_isValid;
}

bool OAIPutVoiceConnectorTerminationCredentials_request::isSet() const {
...
bool OAIPutVoiceConnectorTerminationCredentials_request::isValid() const {
