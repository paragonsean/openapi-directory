...
/*
 * OAIBatchUnsuspendUser_request.h
 *
 * 
 */

#ifndef OAIBatchUnsuspendUser_request_H
#define OAIBatchUnsuspendUser_request_H
...
class OAIBatchUnsuspendUser_request : public OAIObject {
public:
    OAIBatchUnsuspendUser_request();
    OAIBatchUnsuspendUser_request(QString json);
    ~OAIBatchUnsuspendUser_request() override;
    ...
    QList<QString> getUserIdList() const;
    void setUserIdList(const QList<QString> &user_id_list);
    bool is_user_id_list_Set() const;
    bool is_user_id_list_Valid() const;
...
private:
    ...
    QList<QString> m_user_id_list;
    bool m_user_id_list_isSet;
    bool m_user_id_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchUnsuspendUser_request)

#endif // OAIBatchUnsuspendUser_request_H
