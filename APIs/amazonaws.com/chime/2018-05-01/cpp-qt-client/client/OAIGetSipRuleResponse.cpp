...
OAIGetSipRuleResponse::OAIGetSipRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSipRuleResponse::OAIGetSipRuleResponse() {
    this->initializeModel();
}

OAIGetSipRuleResponse::~OAIGetSipRuleResponse() {}

void OAIGetSipRuleResponse::initializeModel() {

    m_sip_rule_isSet = false;
    m_sip_rule_isValid = false;
}

void OAIGetSipRuleResponse::fromJson(QString jsonString) {
...
void OAIGetSipRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetSipRuleResponse::asJson() const {
...
QJsonObject OAIGetSipRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_sip_rule.isSet()) {
...
OAIGetSipRuleResponse_SipRule OAIGetSipRuleResponse::getSipRule() const {
    return m_sip_rule;
}
void OAIGetSipRuleResponse::setSipRule(const OAIGetSipRuleResponse_SipRule &sip_rule) {
    m_sip_rule = sip_rule;
    m_sip_rule_isSet = true;
}

bool OAIGetSipRuleResponse::is_sip_rule_Set() const{
    return m_sip_rule_isSet;
}

bool OAIGetSipRuleResponse::is_sip_rule_Valid() const{
    return m_sip_rule_isValid;
}

bool OAIGetSipRuleResponse::isSet() const {
...
bool OAIGetSipRuleResponse::isValid() const {
