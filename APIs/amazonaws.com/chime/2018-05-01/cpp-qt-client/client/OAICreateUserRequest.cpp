...
OAIUserType OAICreateUserRequest::getUserType() const {
    return m_user_type;
}
void OAICreateUserRequest::setUserType(const OAIUserType &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAICreateUserRequest::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAICreateUserRequest::is_user_type_Valid() const{
