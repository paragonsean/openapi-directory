...
OAIOrderedPhoneNumberStatus::OAIOrderedPhoneNumberStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderedPhoneNumberStatus::OAIOrderedPhoneNumberStatus() {
    this->initializeModel();
}

OAIOrderedPhoneNumberStatus::~OAIOrderedPhoneNumberStatus() {}

void OAIOrderedPhoneNumberStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOrderedPhoneNumberStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOrderedPhoneNumberStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Processing", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderedPhoneNumberStatus::PROCESSING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Acquired", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderedPhoneNumberStatus::ACQUIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOrderedPhoneNumberStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOrderedPhoneNumberStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOrderedPhoneNumberStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOrderedPhoneNumberStatus::PROCESSING:
            val = "Processing";
            break;
        case eOAIOrderedPhoneNumberStatus::ACQUIRED:
            val = "Acquired";
            break;
        case eOAIOrderedPhoneNumberStatus::FAILED:
            val = "Failed";
            break;
        default:
            break;
...
QJsonValue OAIOrderedPhoneNumberStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrderedPhoneNumberStatus::eOAIOrderedPhoneNumberStatus OAIOrderedPhoneNumberStatus::getValue() const {
    return m_value;
}

void OAIOrderedPhoneNumberStatus::setValue(const OAIOrderedPhoneNumberStatus::eOAIOrderedPhoneNumberStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOrderedPhoneNumberStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIOrderedPhoneNumberStatus::isValid() const {
