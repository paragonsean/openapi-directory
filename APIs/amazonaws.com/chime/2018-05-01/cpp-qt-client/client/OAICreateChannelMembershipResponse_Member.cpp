...
OAICreateChannelMembershipResponse_Member::OAICreateChannelMembershipResponse_Member(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChannelMembershipResponse_Member::OAICreateChannelMembershipResponse_Member() {
    this->initializeModel();
}

OAICreateChannelMembershipResponse_Member::~OAICreateChannelMembershipResponse_Member() {}

void OAICreateChannelMembershipResponse_Member::initializeModel() {
...
void OAICreateChannelMembershipResponse_Member::fromJson(QString jsonString) {
...
void OAICreateChannelMembershipResponse_Member::fromJsonObject(QJsonObject json) {
...
QString OAICreateChannelMembershipResponse_Member::asJson() const {
...
QJsonObject OAICreateChannelMembershipResponse_Member::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateChannelMembershipResponse_Member::getArn() const {
    return m_arn;
}
void OAICreateChannelMembershipResponse_Member::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateChannelMembershipResponse_Member::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateChannelMembershipResponse_Member::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAICreateChannelMembershipResponse_Member::getName() const {
    return m_name;
}
void OAICreateChannelMembershipResponse_Member::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateChannelMembershipResponse_Member::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateChannelMembershipResponse_Member::is_name_Valid() const{
    return m_name_isValid;
}

bool OAICreateChannelMembershipResponse_Member::isSet() const {
...
bool OAICreateChannelMembershipResponse_Member::isValid() const {
