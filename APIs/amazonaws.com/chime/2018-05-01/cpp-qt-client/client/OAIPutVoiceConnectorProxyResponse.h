...
/*
 * OAIPutVoiceConnectorProxyResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorProxyResponse_H
#define OAIPutVoiceConnectorProxyResponse_H
...
namespace OpenAPI {
class OAIGetVoiceConnectorProxyResponse_Proxy;

class OAIPutVoiceConnectorProxyResponse : public OAIObject {
public:
    OAIPutVoiceConnectorProxyResponse();
    OAIPutVoiceConnectorProxyResponse(QString json);
    ~OAIPutVoiceConnectorProxyResponse() override;
    ...
    OAIGetVoiceConnectorProxyResponse_Proxy getProxy() const;
    void setProxy(const OAIGetVoiceConnectorProxyResponse_Proxy &proxy);
...
private:
    ...
    OAIGetVoiceConnectorProxyResponse_Proxy m_proxy;
    bool m_proxy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorProxyResponse)

#endif // OAIPutVoiceConnectorProxyResponse_H
