...
/*
 * OAICreateAppInstanceAdminResponse_AppInstanceAdmin.h
 *
 * 
 */

#ifndef OAICreateAppInstanceAdminResponse_AppInstanceAdmin_H
#define OAICreateAppInstanceAdminResponse_AppInstanceAdmin_H
...
class OAICreateAppInstanceAdminResponse_AppInstanceAdmin : public OAIObject {
public:
    OAICreateAppInstanceAdminResponse_AppInstanceAdmin();
    OAICreateAppInstanceAdminResponse_AppInstanceAdmin(QString json);
    ~OAICreateAppInstanceAdminResponse_AppInstanceAdmin() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppInstanceAdminResponse_AppInstanceAdmin)

#endif // OAICreateAppInstanceAdminResponse_AppInstanceAdmin_H
