...
OAIGetVoiceConnectorResponse::OAIGetVoiceConnectorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorResponse::OAIGetVoiceConnectorResponse() {
    this->initializeModel();
}

OAIGetVoiceConnectorResponse::~OAIGetVoiceConnectorResponse() {}

void OAIGetVoiceConnectorResponse::initializeModel() {

    m_voice_connector_isSet = false;
    m_voice_connector_isValid = false;
}

void OAIGetVoiceConnectorResponse::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetVoiceConnectorResponse::asJson() const {
...
QJsonObject OAIGetVoiceConnectorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateVoiceConnectorResponse_VoiceConnector OAIGetVoiceConnectorResponse::getVoiceConnector() const {
    return m_voice_connector;
}
void OAIGetVoiceConnectorResponse::setVoiceConnector(const OAICreateVoiceConnectorResponse_VoiceConnector &voice_connector) {
    m_voice_connector = voice_connector;
    m_voice_connector_isSet = true;
}

bool OAIGetVoiceConnectorResponse::is_voice_connector_Set() const{
    return m_voice_connector_isSet;
}

bool OAIGetVoiceConnectorResponse::is_voice_connector_Valid() const{
    return m_voice_connector_isValid;
}

bool OAIGetVoiceConnectorResponse::isSet() const {
...
bool OAIGetVoiceConnectorResponse::isValid() const {
