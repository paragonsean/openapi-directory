...
/*
 * OAIAssociatePhoneNumbersWithVoiceConnector_request.h
 *
 * 
 */

#ifndef OAIAssociatePhoneNumbersWithVoiceConnector_request_H
#define OAIAssociatePhoneNumbersWithVoiceConnector_request_H
...
class OAIAssociatePhoneNumbersWithVoiceConnector_request : public OAIObject {
public:
    OAIAssociatePhoneNumbersWithVoiceConnector_request();
    OAIAssociatePhoneNumbersWithVoiceConnector_request(QString json);
    ~OAIAssociatePhoneNumbersWithVoiceConnector_request() override;
    ...
    QList<QString> getE164PhoneNumbers() const;
    void setE164PhoneNumbers(const QList<QString> &e164_phone_numbers);
    bool is_e164_phone_numbers_Set() const;
    bool is_e164_phone_numbers_Valid() const;

    bool isForceAssociate() const;
    void setForceAssociate(const bool &force_associate);
    bool is_force_associate_Set() const;
    bool is_force_associate_Valid() const;
...
private:
    ...
    QList<QString> m_e164_phone_numbers;
    bool m_e164_phone_numbers_isSet;
    bool m_e164_phone_numbers_isValid;

    bool m_force_associate;
    bool m_force_associate_isSet;
    bool m_force_associate_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAssociatePhoneNumbersWithVoiceConnector_request)

#endif // OAIAssociatePhoneNumbersWithVoiceConnector_request_H
