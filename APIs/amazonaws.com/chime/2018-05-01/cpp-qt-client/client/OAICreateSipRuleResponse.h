...
/*
 * OAICreateSipRuleResponse.h
 *
 * 
 */

#ifndef OAICreateSipRuleResponse_H
#define OAICreateSipRuleResponse_H
...
namespace OpenAPI {
class OAICreateSipRuleResponse_SipRule;

class OAICreateSipRuleResponse : public OAIObject {
public:
    OAICreateSipRuleResponse();
    OAICreateSipRuleResponse(QString json);
    ~OAICreateSipRuleResponse() override;
    ...
    OAICreateSipRuleResponse_SipRule getSipRule() const;
    void setSipRule(const OAICreateSipRuleResponse_SipRule &sip_rule);
...
private:
    ...
    OAICreateSipRuleResponse_SipRule m_sip_rule;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipRuleResponse)

#endif // OAICreateSipRuleResponse_H
