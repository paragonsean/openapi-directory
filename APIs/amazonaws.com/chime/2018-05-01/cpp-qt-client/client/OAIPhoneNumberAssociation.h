...
/*
 * OAIPhoneNumberAssociation.h
 *
 * The phone number associations, such as Amazon Chime account ID, Amazon Chime user ID, Amazon Chime Voice Connector ID, or Amazon Chime Voice Connector group ID.
 */

#ifndef OAIPhoneNumberAssociation_H
#define OAIPhoneNumberAssociation_H

#include <QJsonObject>

#include "OAIPhoneNumberAssociationName.h"
#include <QDateTime>
#include <QString>
...
class OAIPhoneNumberAssociation : public OAIObject {
public:
    OAIPhoneNumberAssociation();
    OAIPhoneNumberAssociation(QString json);
    ~OAIPhoneNumberAssociation() override;
    ...
    OAIPhoneNumberAssociationName getName() const;
    void setName(const OAIPhoneNumberAssociationName &name);
    bool is_name_Set() const;
    bool is_name_Valid() const;

    QDateTime getAssociatedTimestamp() const;
    void setAssociatedTimestamp(const QDateTime &associated_timestamp);
    bool is_associated_timestamp_Set() const;
    bool is_associated_timestamp_Valid() const;
...
private:
    ...
    OAIPhoneNumberAssociationName m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QDateTime m_associated_timestamp;
    bool m_associated_timestamp_isSet;
    bool m_associated_timestamp_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberAssociation)

#endif // OAIPhoneNumberAssociation_H
