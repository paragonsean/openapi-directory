...
/*
 * OAIPutVoiceConnectorTerminationRequest.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorTerminationRequest_H
#define OAIPutVoiceConnectorTerminationRequest_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorTerminationRequest_Termination;

class OAIPutVoiceConnectorTerminationRequest : public OAIObject {
public:
    OAIPutVoiceConnectorTerminationRequest();
    OAIPutVoiceConnectorTerminationRequest(QString json);
    ~OAIPutVoiceConnectorTerminationRequest() override;
    ...
    OAIPutVoiceConnectorTerminationRequest_Termination getTermination() const;
    void setTermination(const OAIPutVoiceConnectorTerminationRequest_Termination &termination);
...
private:
    ...
    OAIPutVoiceConnectorTerminationRequest_Termination m_termination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorTerminationRequest)

#endif // OAIPutVoiceConnectorTerminationRequest_H
