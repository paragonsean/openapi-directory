...
/*
 * OAICreateMeetingDialOutRequest.h
 *
 * 
 */

#ifndef OAICreateMeetingDialOutRequest_H
#define OAICreateMeetingDialOutRequest_H
...
class OAICreateMeetingDialOutRequest : public OAIObject {
public:
    OAICreateMeetingDialOutRequest();
    OAICreateMeetingDialOutRequest(QString json);
    ~OAICreateMeetingDialOutRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingDialOutRequest)

#endif // OAICreateMeetingDialOutRequest_H
