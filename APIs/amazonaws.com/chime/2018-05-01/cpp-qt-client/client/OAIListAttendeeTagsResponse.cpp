...
OAIListAttendeeTagsResponse::OAIListAttendeeTagsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAttendeeTagsResponse::OAIListAttendeeTagsResponse() {
    this->initializeModel();
}

OAIListAttendeeTagsResponse::~OAIListAttendeeTagsResponse() {}

void OAIListAttendeeTagsResponse::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAIListAttendeeTagsResponse::fromJson(QString jsonString) {
...
void OAIListAttendeeTagsResponse::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAIListAttendeeTagsResponse::asJson() const {
...
QJsonObject OAIListAttendeeTagsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QList OAIListAttendeeTagsResponse::getTags() const {
    return m_tags;
}
void OAIListAttendeeTagsResponse::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIListAttendeeTagsResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIListAttendeeTagsResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIListAttendeeTagsResponse::isSet() const {
...
bool OAIListAttendeeTagsResponse::isValid() const {
