...
/*
 * OAICreateProxySessionRequest.h
 *
 * 
 */

#ifndef OAICreateProxySessionRequest_H
#define OAICreateProxySessionRequest_H
...
class OAICreateProxySessionRequest : public OAIObject {
public:
    OAICreateProxySessionRequest();
    OAICreateProxySessionRequest(QString json);
    ~OAICreateProxySessionRequest() override;
    ...
    QList getParticipantPhoneNumbers() const;
    void setParticipantPhoneNumbers(const QList &participant_phone_numbers);
    bool is_participant_phone_numbers_Set() const;
    bool is_participant_phone_numbers_Valid() const;
...
private:
    ...
    QList m_participant_phone_numbers;
    bool m_participant_phone_numbers_isSet;
    bool m_participant_phone_numbers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySessionRequest)

#endif // OAICreateProxySessionRequest_H
