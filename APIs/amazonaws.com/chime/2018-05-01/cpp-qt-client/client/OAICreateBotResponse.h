...
/*
 * OAICreateBotResponse.h
 *
 * 
 */

#ifndef OAICreateBotResponse_H
#define OAICreateBotResponse_H
...
namespace OpenAPI {
class OAICreateBotResponse_Bot;

class OAICreateBotResponse : public OAIObject {
public:
    OAICreateBotResponse();
    OAICreateBotResponse(QString json);
    ~OAICreateBotResponse() override;
    ...
    OAICreateBotResponse_Bot getBot() const;
    void setBot(const OAICreateBotResponse_Bot &bot);
...
private:
    ...
    OAICreateBotResponse_Bot m_bot;
    bool m_bot_isSet;
    bool m_bot_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBotResponse)

#endif // OAICreateBotResponse_H
