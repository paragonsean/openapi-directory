...
/*
 * OAIAppInstanceStreamingConfiguration.h
 *
 * The details of the streaming configuration of an &lt;code&gt;AppInstance&lt;/code&gt;.
 */

#ifndef OAIAppInstanceStreamingConfiguration_H
#define OAIAppInstanceStreamingConfiguration_H
...
class OAIAppInstanceStreamingConfiguration : public OAIObject {
public:
    OAIAppInstanceStreamingConfiguration();
    OAIAppInstanceStreamingConfiguration(QString json);
    ~OAIAppInstanceStreamingConfiguration() override;
    ...
    OAIAppInstanceDataType getAppInstanceDataType() const;
    void setAppInstanceDataType(const OAIAppInstanceDataType &app_instance_data_type);
    bool is_app_instance_data_type_Set() const;
    bool is_app_instance_data_type_Valid() const;
...
private:
    ...
    OAIAppInstanceDataType m_app_instance_data_type;
    bool m_app_instance_data_type_isSet;
    bool m_app_instance_data_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceStreamingConfiguration)

#endif // OAIAppInstanceStreamingConfiguration_H
