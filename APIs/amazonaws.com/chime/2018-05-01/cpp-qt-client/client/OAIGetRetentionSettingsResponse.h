...
/*
 * OAIGetRetentionSettingsResponse.h
 *
 * 
 */

#ifndef OAIGetRetentionSettingsResponse_H
#define OAIGetRetentionSettingsResponse_H
...
namespace OpenAPI {
class OAIGetRetentionSettingsResponse_RetentionSettings;

class OAIGetRetentionSettingsResponse : public OAIObject {
public:
    OAIGetRetentionSettingsResponse();
    OAIGetRetentionSettingsResponse(QString json);
    ~OAIGetRetentionSettingsResponse() override;
    ...
    OAIGetRetentionSettingsResponse_RetentionSettings getRetentionSettings() const;
    void setRetentionSettings(const OAIGetRetentionSettingsResponse_RetentionSettings &retention_settings);
    bool is_retention_settings_Set() const;
    bool is_retention_settings_Valid() const;
...
private:
    ...
    OAIGetRetentionSettingsResponse_RetentionSettings m_retention_settings;
    bool m_retention_settings_isSet;
    bool m_retention_settings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRetentionSettingsResponse)

#endif // OAIGetRetentionSettingsResponse_H
