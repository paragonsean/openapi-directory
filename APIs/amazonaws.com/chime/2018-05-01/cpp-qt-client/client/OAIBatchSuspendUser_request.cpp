...
OAIBatchSuspendUser_request::OAIBatchSuspendUser_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchSuspendUser_request::OAIBatchSuspendUser_request() {
    this->initializeModel();
}

OAIBatchSuspendUser_request::~OAIBatchSuspendUser_request() {}

void OAIBatchSuspendUser_request::initializeModel() {

    m_user_id_list_isSet = false;
    m_user_id_list_isValid = false;
}

void OAIBatchSuspendUser_request::fromJson(QString jsonString) {
...
void OAIBatchSuspendUser_request::fromJsonObject(QJsonObject json) {
...
QString OAIBatchSuspendUser_request::asJson() const {
...
QJsonObject OAIBatchSuspendUser_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIBatchSuspendUser_request::getUserIdList() const {
    return m_user_id_list;
}
void OAIBatchSuspendUser_request::setUserIdList(const QList<QString> &user_id_list) {
    m_user_id_list = user_id_list;
    m_user_id_list_isSet = true;
}

bool OAIBatchSuspendUser_request::is_user_id_list_Set() const{
    return m_user_id_list_isSet;
}

bool OAIBatchSuspendUser_request::is_user_id_list_Valid() const{
    return m_user_id_list_isValid;
}

bool OAIBatchSuspendUser_request::isSet() const {
...
bool OAIBatchSuspendUser_request::isValid() const {
