...
OAIVoiceConnectorAwsRegion::OAIVoiceConnectorAwsRegion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVoiceConnectorAwsRegion::OAIVoiceConnectorAwsRegion() {
    this->initializeModel();
}

OAIVoiceConnectorAwsRegion::~OAIVoiceConnectorAwsRegion() {}

void OAIVoiceConnectorAwsRegion::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIVoiceConnectorAwsRegion::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIVoiceConnectorAwsRegion::fromJson(QString jsonString) {
    
    if ( jsonString.compare("us-east-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVoiceConnectorAwsRegion::EAST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("us-west-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVoiceConnectorAwsRegion::WEST_2;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIVoiceConnectorAwsRegion::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIVoiceConnectorAwsRegion::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIVoiceConnectorAwsRegion::EAST_1:
            val = "us-east-1";
            break;
        case eOAIVoiceConnectorAwsRegion::WEST_2:
            val = "us-west-2";
            break;
        default:
            break;
...
QJsonValue OAIVoiceConnectorAwsRegion::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIVoiceConnectorAwsRegion::eOAIVoiceConnectorAwsRegion OAIVoiceConnectorAwsRegion::getValue() const {
    return m_value;
}

void OAIVoiceConnectorAwsRegion::setValue(const OAIVoiceConnectorAwsRegion::eOAIVoiceConnectorAwsRegion& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIVoiceConnectorAwsRegion::isSet() const {
    
    return m_value_isSet;
}

bool OAIVoiceConnectorAwsRegion::isValid() const {
