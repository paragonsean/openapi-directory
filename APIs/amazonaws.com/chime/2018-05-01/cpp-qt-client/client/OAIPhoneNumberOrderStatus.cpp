...
#include "OAIPhoneNumberOrderStatus.h"
...
OAIPhoneNumberOrderStatus::OAIPhoneNumberOrderStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPhoneNumberOrderStatus::OAIPhoneNumberOrderStatus() {
    this->initializeModel();
}

OAIPhoneNumberOrderStatus::~OAIPhoneNumberOrderStatus() {}

void OAIPhoneNumberOrderStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPhoneNumberOrderStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPhoneNumberOrderStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Processing", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberOrderStatus::PROCESSING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Successful", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberOrderStatus::SUCCESSFUL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberOrderStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Partial", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberOrderStatus::PARTIAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPhoneNumberOrderStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPhoneNumberOrderStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPhoneNumberOrderStatus::PROCESSING:
            val = "Processing";
            break;
        case eOAIPhoneNumberOrderStatus::SUCCESSFUL:
            val = "Successful";
            break;
        case eOAIPhoneNumberOrderStatus::FAILED:
            val = "Failed";
            break;
        case eOAIPhoneNumberOrderStatus::PARTIAL:
            val = "Partial";
            break;
        default:
            break;
...
QJsonValue OAIPhoneNumberOrderStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPhoneNumberOrderStatus::eOAIPhoneNumberOrderStatus OAIPhoneNumberOrderStatus::getValue() const {
    return m_value;
}

void OAIPhoneNumberOrderStatus::setValue(const OAIPhoneNumberOrderStatus::eOAIPhoneNumberOrderStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPhoneNumberOrderStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIPhoneNumberOrderStatus::isValid() const {
