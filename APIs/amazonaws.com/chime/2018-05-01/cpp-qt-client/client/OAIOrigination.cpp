...
void OAIOrigination::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIOrigination::asJsonObject() const {
    QJsonObject obj;
    if (m_routes.isSet()) {
...
QList OAIOrigination::getRoutes() const {
    return m_routes;
}
void OAIOrigination::setRoutes(const QList &routes) {
    m_routes = routes;
    m_routes_isSet = true;
}

bool OAIOrigination::is_routes_Set() const{
    return m_routes_isSet;
}

bool OAIOrigination::is_routes_Valid() const{
    return m_routes_isValid;
}

bool OAIOrigination::getDisabled() const {
    return m_disabled;
}
void OAIOrigination::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIOrigination::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIOrigination::is_disabled_Valid() const{
