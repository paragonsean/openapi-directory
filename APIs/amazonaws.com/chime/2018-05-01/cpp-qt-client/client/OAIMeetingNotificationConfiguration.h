...
/*
 * OAIMeetingNotificationConfiguration.h
 *
...
#ifndef OAIMeetingNotificationConfiguration_H
#define OAIMeetingNotificationConfiguration_H
...
class OAIMeetingNotificationConfiguration : public OAIObject {
public:
    OAIMeetingNotificationConfiguration();
    OAIMeetingNotificationConfiguration(QString json);
    ~OAIMeetingNotificationConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMeetingNotificationConfiguration)

#endif // OAIMeetingNotificationConfiguration_H
