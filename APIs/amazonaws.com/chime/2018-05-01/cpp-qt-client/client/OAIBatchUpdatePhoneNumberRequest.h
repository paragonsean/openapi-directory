...
/*
 * OAIBatchUpdatePhoneNumberRequest.h
 *
 * 
 */

#ifndef OAIBatchUpdatePhoneNumberRequest_H
#define OAIBatchUpdatePhoneNumberRequest_H
...
class OAIBatchUpdatePhoneNumberRequest : public OAIObject {
public:
    OAIBatchUpdatePhoneNumberRequest();
    OAIBatchUpdatePhoneNumberRequest(QString json);
    ~OAIBatchUpdatePhoneNumberRequest() override;
    ...
    QList getUpdatePhoneNumberRequestItems() const;
    void setUpdatePhoneNumberRequestItems(const QList &update_phone_number_request_items);
...
private:
    ...
    QList m_update_phone_number_request_items;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdatePhoneNumberRequest)

#endif // OAIBatchUpdatePhoneNumberRequest_H
