...
#ifndef OAIEmailStatus_H
#define OAIEmailStatus_H
...
class OAIEmailStatus : public OAIEnum {
public:
    OAIEmailStatus();
    OAIEmailStatus(QString json);
    ~OAIEmailStatus() override;
    ...
    enum class eOAIEmailStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NOTSENT, 
        SENT, 
        FAILED
    };
    OAIEmailStatus::eOAIEmailStatus getValue() const;
    void setValue(const OAIEmailStatus::eOAIEmailStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailStatus)

#endif // OAIEmailStatus_H
