...
/*
 * OAIListSupportedPhoneNumberCountriesResponse.h
 *
 * 
 */

#ifndef OAIListSupportedPhoneNumberCountriesResponse_H
#define OAIListSupportedPhoneNumberCountriesResponse_H
...
class OAIListSupportedPhoneNumberCountriesResponse : public OAIObject {
public:
    OAIListSupportedPhoneNumberCountriesResponse();
    OAIListSupportedPhoneNumberCountriesResponse(QString json);
    ~OAIListSupportedPhoneNumberCountriesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSupportedPhoneNumberCountriesResponse)

#endif // OAIListSupportedPhoneNumberCountriesResponse_H
