...
#include "OAIUpdateProxySessionRequest.h"
...
OAIUpdateProxySessionRequest::OAIUpdateProxySessionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateProxySessionRequest::OAIUpdateProxySessionRequest() {
    this->initializeModel();
}

OAIUpdateProxySessionRequest::~OAIUpdateProxySessionRequest() {}

void OAIUpdateProxySessionRequest::initializeModel() {
...
void OAIUpdateProxySessionRequest::fromJson(QString jsonString) {
...
void OAIUpdateProxySessionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateProxySessionRequest::asJson() const {
...
QJsonObject OAIUpdateProxySessionRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateProxySessionRequest::getCapabilities() const {
    return m_capabilities;
}
void OAIUpdateProxySessionRequest::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIUpdateProxySessionRequest::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIUpdateProxySessionRequest::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

qint32 OAIUpdateProxySessionRequest::getExpiryMinutes() const {
    return m_expiry_minutes;
}
void OAIUpdateProxySessionRequest::setExpiryMinutes(const qint32 &expiry_minutes) {
    m_expiry_minutes = expiry_minutes;
    m_expiry_minutes_isSet = true;
}

bool OAIUpdateProxySessionRequest::is_expiry_minutes_Set() const{
    return m_expiry_minutes_isSet;
}

bool OAIUpdateProxySessionRequest::is_expiry_minutes_Valid() const{
    return m_expiry_minutes_isValid;
}

bool OAIUpdateProxySessionRequest::isSet() const {
...
bool OAIUpdateProxySessionRequest::isValid() const {
