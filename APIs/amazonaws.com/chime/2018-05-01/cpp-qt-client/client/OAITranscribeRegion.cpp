...
OAITranscribeRegion::OAITranscribeRegion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeRegion::OAITranscribeRegion() {
    this->initializeModel();
}

OAITranscribeRegion::~OAITranscribeRegion() {}

void OAITranscribeRegion::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeRegion::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeRegion::fromJson(QString jsonString) {
    
    if ( jsonString.compare("us-east-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::US_EAST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("us-east-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::US_EAST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("us-west-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::US_WEST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ap-northeast-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::AP_NORTHEAST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ap-southeast-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::AP_SOUTHEAST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ap-northeast-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::AP_NORTHEAST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ca-central-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::CA_CENTRAL_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("eu-central-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::EU_CENTRAL_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("eu-west-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::EU_WEST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("eu-west-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::EU_WEST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("sa-east-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::SA_EAST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("auto", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeRegion::AUTO;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeRegion::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeRegion::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeRegion::US_EAST_2:
            val = "us-east-2";
            break;
        case eOAITranscribeRegion::US_EAST_1:
            val = "us-east-1";
            break;
        case eOAITranscribeRegion::US_WEST_2:
            val = "us-west-2";
            break;
        case eOAITranscribeRegion::AP_NORTHEAST_2:
            val = "ap-northeast-2";
            break;
        case eOAITranscribeRegion::AP_SOUTHEAST_2:
            val = "ap-southeast-2";
            break;
        case eOAITranscribeRegion::AP_NORTHEAST_1:
            val = "ap-northeast-1";
            break;
        case eOAITranscribeRegion::CA_CENTRAL_1:
            val = "ca-central-1";
            break;
        case eOAITranscribeRegion::EU_CENTRAL_1:
            val = "eu-central-1";
            break;
        case eOAITranscribeRegion::EU_WEST_1:
            val = "eu-west-1";
            break;
        case eOAITranscribeRegion::EU_WEST_2:
            val = "eu-west-2";
            break;
        case eOAITranscribeRegion::SA_EAST_1:
            val = "sa-east-1";
            break;
        case eOAITranscribeRegion::AUTO:
            val = "auto";
            break;
        default:
            break;
...
QJsonValue OAITranscribeRegion::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeRegion::eOAITranscribeRegion OAITranscribeRegion::getValue() const {
    return m_value;
}

void OAITranscribeRegion::setValue(const OAITranscribeRegion::eOAITranscribeRegion& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeRegion::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeRegion::isValid() const {
