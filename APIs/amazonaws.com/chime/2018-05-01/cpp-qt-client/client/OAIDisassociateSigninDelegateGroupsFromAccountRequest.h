...
/*
 * OAIDisassociateSigninDelegateGroupsFromAccountRequest.h
 *
 * 
 */

#ifndef OAIDisassociateSigninDelegateGroupsFromAccountRequest_H
#define OAIDisassociateSigninDelegateGroupsFromAccountRequest_H
...
class OAIDisassociateSigninDelegateGroupsFromAccountRequest : public OAIObject {
public:
    OAIDisassociateSigninDelegateGroupsFromAccountRequest();
    OAIDisassociateSigninDelegateGroupsFromAccountRequest(QString json);
    ~OAIDisassociateSigninDelegateGroupsFromAccountRequest() override;
    ...
    QList getGroupNames() const;
    void setGroupNames(const QList &group_names);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateSigninDelegateGroupsFromAccountRequest)

#endif // OAIDisassociateSigninDelegateGroupsFromAccountRequest_H
