...
OAIGetVoiceConnectorOriginationResponse_Origination::OAIGetVoiceConnectorOriginationResponse_Origination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorOriginationResponse_Origination::OAIGetVoiceConnectorOriginationResponse_Origination() {
    this->initializeModel();
}

OAIGetVoiceConnectorOriginationResponse_Origination::~OAIGetVoiceConnectorOriginationResponse_Origination() {}

void OAIGetVoiceConnectorOriginationResponse_Origination::initializeModel() {
...
void OAIGetVoiceConnectorOriginationResponse_Origination::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorOriginationResponse_Origination::fromJsonObject(QJsonObject json) {
...
QString OAIGetVoiceConnectorOriginationResponse_Origination::asJson() const {
...
QJsonObject OAIGetVoiceConnectorOriginationResponse_Origination::asJsonObject() const {
    QJsonObject obj;
    if (m_routes.isSet()) {
...
QList OAIGetVoiceConnectorOriginationResponse_Origination::getRoutes() const {
    return m_routes;
}
void OAIGetVoiceConnectorOriginationResponse_Origination::setRoutes(const QList &routes) {
    m_routes = routes;
    m_routes_isSet = true;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::is_routes_Set() const{
    return m_routes_isSet;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::is_routes_Valid() const{
    return m_routes_isValid;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::getDisabled() const {
    return m_disabled;
}
void OAIGetVoiceConnectorOriginationResponse_Origination::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::is_disabled_Valid() const{
    return m_disabled_isValid;
}

bool OAIGetVoiceConnectorOriginationResponse_Origination::isSet() const {
...
bool OAIGetVoiceConnectorOriginationResponse_Origination::isValid() const {
