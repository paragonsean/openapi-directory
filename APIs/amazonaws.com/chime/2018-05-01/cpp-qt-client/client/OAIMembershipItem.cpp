...
OAIMembershipItem::OAIMembershipItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMembershipItem::OAIMembershipItem() {
    this->initializeModel();
}

OAIMembershipItem::~OAIMembershipItem() {}

void OAIMembershipItem::initializeModel() {
...
void OAIMembershipItem::fromJson(QString jsonString) {
...
void OAIMembershipItem::fromJsonObject(QJsonObject json) {
...
QString OAIMembershipItem::asJson() const {
...
QJsonObject OAIMembershipItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMembershipItem::getMemberId() const {
    return m_member_id;
}
void OAIMembershipItem::setMemberId(const QString &member_id) {
    m_member_id = member_id;
    m_member_id_isSet = true;
}

bool OAIMembershipItem::is_member_id_Set() const{
    return m_member_id_isSet;
}

bool OAIMembershipItem::is_member_id_Valid() const{
    return m_member_id_isValid;
}

OAIRoomMembershipRole OAIMembershipItem::getRole() const {
    return m_role;
}
void OAIMembershipItem::setRole(const OAIRoomMembershipRole &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIMembershipItem::is_role_Set() const{
    return m_role_isSet;
}

bool OAIMembershipItem::is_role_Valid() const{
    return m_role_isValid;
}

bool OAIMembershipItem::isSet() const {
...
bool OAIMembershipItem::isValid() const {
