...
namespace OpenAPI {
class OAIUpdateAccountSettings_request_AccountSettings;
...
public:
    ...
    OAIUpdateAccountSettings_request_AccountSettings getAccountSettings() const;
    void setAccountSettings(const OAIUpdateAccountSettings_request_AccountSettings &account_settings);
...
private:
    ...
    OAIUpdateAccountSettings_request_AccountSettings m_account_settings;
