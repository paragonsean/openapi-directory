...
/*
 * OAIGetVoiceConnectorTerminationResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorTerminationResponse_H
#define OAIGetVoiceConnectorTerminationResponse_H
...
namespace OpenAPI {
class OAIGetVoiceConnectorTerminationResponse_Termination;

class OAIGetVoiceConnectorTerminationResponse : public OAIObject {
public:
    OAIGetVoiceConnectorTerminationResponse();
    OAIGetVoiceConnectorTerminationResponse(QString json);
    ~OAIGetVoiceConnectorTerminationResponse() override;
    ...
    OAIGetVoiceConnectorTerminationResponse_Termination getTermination() const;
    void setTermination(const OAIGetVoiceConnectorTerminationResponse_Termination &termination);
...
private:
    ...
    OAIGetVoiceConnectorTerminationResponse_Termination m_termination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorTerminationResponse)

#endif // OAIGetVoiceConnectorTerminationResponse_H
