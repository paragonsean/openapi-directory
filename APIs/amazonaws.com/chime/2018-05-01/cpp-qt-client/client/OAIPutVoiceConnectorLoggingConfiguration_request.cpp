...
OAIPutVoiceConnectorLoggingConfiguration_request::OAIPutVoiceConnectorLoggingConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorLoggingConfiguration_request::OAIPutVoiceConnectorLoggingConfiguration_request() {
    this->initializeModel();
}

OAIPutVoiceConnectorLoggingConfiguration_request::~OAIPutVoiceConnectorLoggingConfiguration_request() {}

void OAIPutVoiceConnectorLoggingConfiguration_request::initializeModel() {

    m_logging_configuration_isSet = false;
    m_logging_configuration_isValid = false;
}

void OAIPutVoiceConnectorLoggingConfiguration_request::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorLoggingConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorLoggingConfiguration_request::asJson() const {
...
QJsonObject OAIPutVoiceConnectorLoggingConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration OAIPutVoiceConnectorLoggingConfiguration_request::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIPutVoiceConnectorLoggingConfiguration_request::setLoggingConfiguration(const OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIPutVoiceConnectorLoggingConfiguration_request::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIPutVoiceConnectorLoggingConfiguration_request::is_logging_configuration_Valid() const{
    return m_logging_configuration_isValid;
}

bool OAIPutVoiceConnectorLoggingConfiguration_request::isSet() const {
...
bool OAIPutVoiceConnectorLoggingConfiguration_request::isValid() const {
