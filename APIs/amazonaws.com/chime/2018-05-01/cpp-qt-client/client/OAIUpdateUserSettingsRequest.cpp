...
#include "OAIUpdateUserSettingsRequest.h"
...
OAIUpdateUserSettingsRequest::OAIUpdateUserSettingsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserSettingsRequest::OAIUpdateUserSettingsRequest() {
    this->initializeModel();
}

OAIUpdateUserSettingsRequest::~OAIUpdateUserSettingsRequest() {}

void OAIUpdateUserSettingsRequest::initializeModel() {

    m_user_settings_isSet = false;
    m_user_settings_isValid = false;
}

void OAIUpdateUserSettingsRequest::fromJson(QString jsonString) {
...
void OAIUpdateUserSettingsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserSettingsRequest::asJson() const {
...
QJsonObject OAIUpdateUserSettingsRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateUserSettingsRequest_UserSettings OAIUpdateUserSettingsRequest::getUserSettings() const {
    return m_user_settings;
}
void OAIUpdateUserSettingsRequest::setUserSettings(const OAIUpdateUserSettingsRequest_UserSettings &user_settings) {
    m_user_settings = user_settings;
    m_user_settings_isSet = true;
}

bool OAIUpdateUserSettingsRequest::is_user_settings_Set() const{
    return m_user_settings_isSet;
}

bool OAIUpdateUserSettingsRequest::is_user_settings_Valid() const{
    return m_user_settings_isValid;
}

bool OAIUpdateUserSettingsRequest::isSet() const {
...
bool OAIUpdateUserSettingsRequest::isValid() const {
