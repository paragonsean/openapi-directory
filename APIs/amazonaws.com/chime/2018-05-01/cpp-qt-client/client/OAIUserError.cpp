...
QString OAIUserError::getUserId() const {
    return m_user_id;
}
void OAIUserError::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUserError::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUserError::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAIErrorCode OAIUserError::getErrorCode() const {
    return m_error_code;
}
void OAIUserError::setErrorCode(const OAIErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIUserError::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIUserError::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIUserError::getErrorMessage() const {
    return m_error_message;
}
void OAIUserError::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIUserError::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIUserError::is_error_message_Valid() const{
