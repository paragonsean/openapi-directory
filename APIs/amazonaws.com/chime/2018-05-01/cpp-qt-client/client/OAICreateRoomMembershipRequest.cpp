...
#include "OAICreateRoomMembershipRequest.h"
...
OAICreateRoomMembershipRequest::OAICreateRoomMembershipRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoomMembershipRequest::OAICreateRoomMembershipRequest() {
    this->initializeModel();
}

OAICreateRoomMembershipRequest::~OAICreateRoomMembershipRequest() {}

void OAICreateRoomMembershipRequest::initializeModel() {
...
void OAICreateRoomMembershipRequest::fromJson(QString jsonString) {
...
void OAICreateRoomMembershipRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoomMembershipRequest::asJson() const {
...
QJsonObject OAICreateRoomMembershipRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRoomMembershipRequest::getMemberId() const {
    return m_member_id;
}
void OAICreateRoomMembershipRequest::setMemberId(const QString &member_id) {
    m_member_id = member_id;
    m_member_id_isSet = true;
}

bool OAICreateRoomMembershipRequest::is_member_id_Set() const{
    return m_member_id_isSet;
}

bool OAICreateRoomMembershipRequest::is_member_id_Valid() const{
    return m_member_id_isValid;
}

OAIRoomMembershipRole OAICreateRoomMembershipRequest::getRole() const {
    return m_role;
}
void OAICreateRoomMembershipRequest::setRole(const OAIRoomMembershipRole &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAICreateRoomMembershipRequest::is_role_Set() const{
    return m_role_isSet;
}

bool OAICreateRoomMembershipRequest::is_role_Valid() const{
    return m_role_isValid;
}

bool OAICreateRoomMembershipRequest::isSet() const {
...
bool OAICreateRoomMembershipRequest::isValid() const {
