...
/*
 * OAIBatchCreateRoomMembershipResponse.h
 *
 * 
 */

#ifndef OAIBatchCreateRoomMembershipResponse_H
#define OAIBatchCreateRoomMembershipResponse_H
...
class OAIBatchCreateRoomMembershipResponse : public OAIObject {
public:
    OAIBatchCreateRoomMembershipResponse();
    OAIBatchCreateRoomMembershipResponse(QString json);
    ~OAIBatchCreateRoomMembershipResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateRoomMembershipResponse)

#endif // OAIBatchCreateRoomMembershipResponse_H
