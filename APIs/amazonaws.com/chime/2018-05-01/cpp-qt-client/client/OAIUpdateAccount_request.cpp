...
OAIUpdateAccount_request::OAIUpdateAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAccount_request::OAIUpdateAccount_request() {
    this->initializeModel();
}

OAIUpdateAccount_request::~OAIUpdateAccount_request() {}

void OAIUpdateAccount_request::initializeModel() {
...
void OAIUpdateAccount_request::fromJson(QString jsonString) {
...
void OAIUpdateAccount_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAccount_request::asJson() const {
...
QJsonObject OAIUpdateAccount_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("Name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_default_license_isSet) {
        obj.insert(QString("DefaultLicense"), ::OpenAPI::toJsonValue(m_default_license));
    }
    return obj;
}

QString OAIUpdateAccount_request::getName() const {
    return m_name;
}
void OAIUpdateAccount_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAccount_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAccount_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateAccount_request::getDefaultLicense() const {
    return m_default_license;
}
void OAIUpdateAccount_request::setDefaultLicense(const QString &default_license) {
    m_default_license = default_license;
    m_default_license_isSet = true;
}

bool OAIUpdateAccount_request::is_default_license_Set() const{
    return m_default_license_isSet;
}

bool OAIUpdateAccount_request::is_default_license_Valid() const{
    return m_default_license_isValid;
}

bool OAIUpdateAccount_request::isSet() const {
...
bool OAIUpdateAccount_request::isValid() const {
