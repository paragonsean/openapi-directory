...
/*
 * OAIBatchSuspendUser_request.h
 *
 * 
 */

#ifndef OAIBatchSuspendUser_request_H
#define OAIBatchSuspendUser_request_H
...
class OAIBatchSuspendUser_request : public OAIObject {
public:
    OAIBatchSuspendUser_request();
    OAIBatchSuspendUser_request(QString json);
    ~OAIBatchSuspendUser_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchSuspendUser_request)

#endif // OAIBatchSuspendUser_request_H
