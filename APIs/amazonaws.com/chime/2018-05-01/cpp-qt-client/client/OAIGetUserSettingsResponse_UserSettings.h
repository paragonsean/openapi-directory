...
/*
 * OAIGetUserSettingsResponse_UserSettings.h
 *
 * 
 */

#ifndef OAIGetUserSettingsResponse_UserSettings_H
#define OAIGetUserSettingsResponse_UserSettings_H
...
namespace OpenAPI {
class OAIUpdateUserSettings_request_UserSettings_Telephony;

class OAIGetUserSettingsResponse_UserSettings : public OAIObject {
public:
    OAIGetUserSettingsResponse_UserSettings();
    OAIGetUserSettingsResponse_UserSettings(QString json);
    ~OAIGetUserSettingsResponse_UserSettings() override;
    ...
    OAIUpdateUserSettings_request_UserSettings_Telephony getTelephony() const;
    void setTelephony(const OAIUpdateUserSettings_request_UserSettings_Telephony &telephony);
    bool is_telephony_Set() const;
    bool is_telephony_Valid() const;
...
private:
    ...
    OAIUpdateUserSettings_request_UserSettings_Telephony m_telephony;
    bool m_telephony_isSet;
    bool m_telephony_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetUserSettingsResponse_UserSettings)

#endif // OAIGetUserSettingsResponse_UserSettings_H
