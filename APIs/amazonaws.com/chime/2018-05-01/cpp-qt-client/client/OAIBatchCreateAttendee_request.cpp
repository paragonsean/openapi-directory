...
OAIBatchCreateAttendee_request::OAIBatchCreateAttendee_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchCreateAttendee_request::OAIBatchCreateAttendee_request() {
    this->initializeModel();
}

OAIBatchCreateAttendee_request::~OAIBatchCreateAttendee_request() {}

void OAIBatchCreateAttendee_request::initializeModel() {

    m_attendees_isSet = false;
    m_attendees_isValid = false;
}

void OAIBatchCreateAttendee_request::fromJson(QString jsonString) {
...
void OAIBatchCreateAttendee_request::fromJsonObject(QJsonObject json) {
...
QString OAIBatchCreateAttendee_request::asJson() const {
...
QJsonObject OAIBatchCreateAttendee_request::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICreateAttendeeRequestItem> OAIBatchCreateAttendee_request::getAttendees() const {
    return m_attendees;
}
void OAIBatchCreateAttendee_request::setAttendees(const QList<OAICreateAttendeeRequestItem> &attendees) {
    m_attendees = attendees;
    m_attendees_isSet = true;
}

bool OAIBatchCreateAttendee_request::is_attendees_Set() const{
    return m_attendees_isSet;
}

bool OAIBatchCreateAttendee_request::is_attendees_Valid() const{
    return m_attendees_isValid;
}

bool OAIBatchCreateAttendee_request::isSet() const {
...
bool OAIBatchCreateAttendee_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_attendees_isValid && true;
}
