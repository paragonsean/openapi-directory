...
/*
 * OAIBatchCreateRoomMembership_request.h
 *
 * 
 */

#ifndef OAIBatchCreateRoomMembership_request_H
#define OAIBatchCreateRoomMembership_request_H
...
namespace OpenAPI {
class OAIMembershipItem;

class OAIBatchCreateRoomMembership_request : public OAIObject {
public:
    OAIBatchCreateRoomMembership_request();
    OAIBatchCreateRoomMembership_request(QString json);
    ~OAIBatchCreateRoomMembership_request() override;
    ...
    QList<OAIMembershipItem> getMembershipItemList() const;
    void setMembershipItemList(const QList<OAIMembershipItem> &membership_item_list);
    bool is_membership_item_list_Set() const;
    bool is_membership_item_list_Valid() const;
...
private:
    ...
    QList<OAIMembershipItem> m_membership_item_list;
    bool m_membership_item_list_isSet;
    bool m_membership_item_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateRoomMembership_request)

#endif // OAIBatchCreateRoomMembership_request_H
