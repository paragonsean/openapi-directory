...
void OAIUserType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("PrivateUser", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserType::PRIVATEUSER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SharedDevice", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserType::SHAREDDEVICE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIUserType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIUserType::PRIVATEUSER:
            val = "PrivateUser";
            break;
        case eOAIUserType::SHAREDDEVICE:
            val = "SharedDevice";
            break;
        default:
            break;
