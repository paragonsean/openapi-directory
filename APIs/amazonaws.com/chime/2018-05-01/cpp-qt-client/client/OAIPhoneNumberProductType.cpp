...
OAIPhoneNumberProductType::OAIPhoneNumberProductType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPhoneNumberProductType::OAIPhoneNumberProductType() {
    this->initializeModel();
}

OAIPhoneNumberProductType::~OAIPhoneNumberProductType() {}

void OAIPhoneNumberProductType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPhoneNumberProductType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPhoneNumberProductType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("BusinessCalling", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberProductType::BUSINESSCALLING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("VoiceConnector", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberProductType::VOICECONNECTOR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SipMediaApplicationDialIn", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberProductType::SIPMEDIAAPPLICATIONDIALIN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPhoneNumberProductType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPhoneNumberProductType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPhoneNumberProductType::BUSINESSCALLING:
            val = "BusinessCalling";
            break;
        case eOAIPhoneNumberProductType::VOICECONNECTOR:
            val = "VoiceConnector";
            break;
        case eOAIPhoneNumberProductType::SIPMEDIAAPPLICATIONDIALIN:
            val = "SipMediaApplicationDialIn";
            break;
        default:
            break;
    }
...
QJsonValue OAIPhoneNumberProductType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPhoneNumberProductType::eOAIPhoneNumberProductType OAIPhoneNumberProductType::getValue() const {
    return m_value;
}

void OAIPhoneNumberProductType::setValue(const OAIPhoneNumberProductType::eOAIPhoneNumberProductType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPhoneNumberProductType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPhoneNumberProductType::isValid() const {
