...
/*
 * OAICreateVoiceConnectorResponse.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorResponse_H
#define OAICreateVoiceConnectorResponse_H
...
class OAICreateVoiceConnectorResponse : public OAIObject {
public:
    OAICreateVoiceConnectorResponse();
    OAICreateVoiceConnectorResponse(QString json);
    ~OAICreateVoiceConnectorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorResponse)

#endif // OAICreateVoiceConnectorResponse_H
