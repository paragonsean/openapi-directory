...
OAIChannelMembershipForAppInstanceUserSummary_ChannelSummary OAIDescribeChannelModeratedByAppInstanceUserResponse_Channel::getChannelSummary() const {
    return m_channel_summary;
}
void OAIDescribeChannelModeratedByAppInstanceUserResponse_Channel::setChannelSummary(const OAIChannelMembershipForAppInstanceUserSummary_ChannelSummary &channel_summary) {
