...
/*
 * OAIUpdateAppInstanceRequest.h
 *
 * 
 */

#ifndef OAIUpdateAppInstanceRequest_H
#define OAIUpdateAppInstanceRequest_H
...
class OAIUpdateAppInstanceRequest : public OAIObject {
public:
    OAIUpdateAppInstanceRequest();
    OAIUpdateAppInstanceRequest(QString json);
    ~OAIUpdateAppInstanceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppInstanceRequest)

#endif // OAIUpdateAppInstanceRequest_H
