...
OAIBatchSuspendUserResponse::OAIBatchSuspendUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchSuspendUserResponse::OAIBatchSuspendUserResponse() {
    this->initializeModel();
}

OAIBatchSuspendUserResponse::~OAIBatchSuspendUserResponse() {}

void OAIBatchSuspendUserResponse::initializeModel() {

    m_user_errors_isSet = false;
    m_user_errors_isValid = false;
}

void OAIBatchSuspendUserResponse::fromJson(QString jsonString) {
...
void OAIBatchSuspendUserResponse::fromJsonObject(QJsonObject json) {

    m_user_errors_isValid = ::OpenAPI::fromJsonValue(m_user_errors, json[QString("UserErrors")]);
    m_user_errors_isSet = !json[QString("UserErrors")].isNull() && m_user_errors_isValid;
}

QString OAIBatchSuspendUserResponse::asJson() const {
...
QJsonObject OAIBatchSuspendUserResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_errors.isSet()) {
        obj.insert(QString("UserErrors"), ::OpenAPI::toJsonValue(m_user_errors));
    }
    return obj;
}

QList OAIBatchSuspendUserResponse::getUserErrors() const {
    return m_user_errors;
}
void OAIBatchSuspendUserResponse::setUserErrors(const QList &user_errors) {
    m_user_errors = user_errors;
    m_user_errors_isSet = true;
}

bool OAIBatchSuspendUserResponse::is_user_errors_Set() const{
    return m_user_errors_isSet;
}

bool OAIBatchSuspendUserResponse::is_user_errors_Valid() const{
    return m_user_errors_isValid;
}

bool OAIBatchSuspendUserResponse::isSet() const {
...
bool OAIBatchSuspendUserResponse::isValid() const {
