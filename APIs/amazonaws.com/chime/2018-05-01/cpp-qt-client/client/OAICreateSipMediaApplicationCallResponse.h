...
/*
 * OAICreateSipMediaApplicationCallResponse.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplicationCallResponse_H
#define OAICreateSipMediaApplicationCallResponse_H
...
namespace OpenAPI {
class OAICreateSipMediaApplicationCallResponse_SipMediaApplicationCall;

class OAICreateSipMediaApplicationCallResponse : public OAIObject {
public:
    OAICreateSipMediaApplicationCallResponse();
    OAICreateSipMediaApplicationCallResponse(QString json);
    ~OAICreateSipMediaApplicationCallResponse() override;
    ...
    OAICreateSipMediaApplicationCallResponse_SipMediaApplicationCall getSipMediaApplicationCall() const;
    void setSipMediaApplicationCall(const OAICreateSipMediaApplicationCallResponse_SipMediaApplicationCall &sip_media_application_call);
...
private:
    ...
    OAICreateSipMediaApplicationCallResponse_SipMediaApplicationCall m_sip_media_application_call;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplicationCallResponse)

#endif // OAICreateSipMediaApplicationCallResponse_H
