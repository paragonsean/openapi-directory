...
/*
 * OAIBatchUpdateUserResponse.h
 *
 * 
 */

#ifndef OAIBatchUpdateUserResponse_H
#define OAIBatchUpdateUserResponse_H
...
class OAIBatchUpdateUserResponse : public OAIObject {
public:
    OAIBatchUpdateUserResponse();
    OAIBatchUpdateUserResponse(QString json);
    ~OAIBatchUpdateUserResponse() override;
    ...
    QList getUserErrors() const;
    void setUserErrors(const QList &user_errors);
    bool is_user_errors_Set() const;
    bool is_user_errors_Valid() const;
...
private:
    ...
    QList m_user_errors;
    bool m_user_errors_isSet;
    bool m_user_errors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdateUserResponse)

#endif // OAIBatchUpdateUserResponse_H
