...
#include "OAIPutVoiceConnectorOrigination_request_Origination.h"
...
OAIPutVoiceConnectorOrigination_request_Origination::OAIPutVoiceConnectorOrigination_request_Origination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorOrigination_request_Origination::OAIPutVoiceConnectorOrigination_request_Origination() {
    this->initializeModel();
}

OAIPutVoiceConnectorOrigination_request_Origination::~OAIPutVoiceConnectorOrigination_request_Origination() {}

void OAIPutVoiceConnectorOrigination_request_Origination::initializeModel() {
...
void OAIPutVoiceConnectorOrigination_request_Origination::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorOrigination_request_Origination::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorOrigination_request_Origination::asJson() const {
...
QJsonObject OAIPutVoiceConnectorOrigination_request_Origination::asJsonObject() const {
    QJsonObject obj;
    if (m_routes.isSet()) {
...
QList OAIPutVoiceConnectorOrigination_request_Origination::getRoutes() const {
    return m_routes;
}
void OAIPutVoiceConnectorOrigination_request_Origination::setRoutes(const QList &routes) {
    m_routes = routes;
    m_routes_isSet = true;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::is_routes_Set() const{
    return m_routes_isSet;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::is_routes_Valid() const{
    return m_routes_isValid;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::getDisabled() const {
    return m_disabled;
}
void OAIPutVoiceConnectorOrigination_request_Origination::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::is_disabled_Valid() const{
    return m_disabled_isValid;
}

bool OAIPutVoiceConnectorOrigination_request_Origination::isSet() const {
...
bool OAIPutVoiceConnectorOrigination_request_Origination::isValid() const {
