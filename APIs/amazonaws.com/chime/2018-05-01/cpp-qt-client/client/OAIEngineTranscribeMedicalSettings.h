...
/*
 * OAIEngineTranscribeMedicalSettings.h
 *
 * Settings specific to the Amazon Transcribe Medical engine.
 */

#ifndef OAIEngineTranscribeMedicalSettings_H
#define OAIEngineTranscribeMedicalSettings_H
...
class OAIEngineTranscribeMedicalSettings : public OAIObject {
public:
    OAIEngineTranscribeMedicalSettings();
    OAIEngineTranscribeMedicalSettings(QString json);
    ~OAIEngineTranscribeMedicalSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEngineTranscribeMedicalSettings)

#endif // OAIEngineTranscribeMedicalSettings_H
