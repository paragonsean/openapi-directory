...
#ifndef OAIMemberError_H
#define OAIMemberError_H
...
class OAIMemberError : public OAIObject {
public:
    OAIMemberError();
    OAIMemberError(QString json);
    ~OAIMemberError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberError)

#endif // OAIMemberError_H
