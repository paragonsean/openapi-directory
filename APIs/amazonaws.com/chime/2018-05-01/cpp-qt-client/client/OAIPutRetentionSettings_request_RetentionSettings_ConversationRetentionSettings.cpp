...
OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings() {
    this->initializeModel();
}

OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::~OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings() {}

void OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::initializeModel() {

    m_retention_days_isSet = false;
    m_retention_days_isValid = false;
}

void OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::fromJson(QString jsonString) {
...
void OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::fromJsonObject(QJsonObject json) {
...
QString OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::asJson() const {
...
QJsonObject OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::getRetentionDays() const {
    return m_retention_days;
}
void OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::setRetentionDays(const qint32 &retention_days) {
    m_retention_days = retention_days;
    m_retention_days_isSet = true;
}

bool OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::is_retention_days_Set() const{
    return m_retention_days_isSet;
}

bool OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::is_retention_days_Valid() const{
    return m_retention_days_isValid;
}

bool OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::isSet() const {
...
bool OAIPutRetentionSettings_request_RetentionSettings_ConversationRetentionSettings::isValid() const {
