...
bool OAIUpdateBot_request::isDisabled() const {
    return m_disabled;
}
void OAIUpdateBot_request::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIUpdateBot_request::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIUpdateBot_request::is_disabled_Valid() const{
