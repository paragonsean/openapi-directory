...
/*
 * OAIPhoneNumberProductType.h
 *
 * 
 */

#ifndef OAIPhoneNumberProductType_H
#define OAIPhoneNumberProductType_H
...
class OAIPhoneNumberProductType : public OAIEnum {
public:
    OAIPhoneNumberProductType();
    OAIPhoneNumberProductType(QString json);
    ~OAIPhoneNumberProductType() override;
    ...
    enum class eOAIPhoneNumberProductType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        BUSINESSCALLING, 
        VOICECONNECTOR, 
        SIPMEDIAAPPLICATIONDIALIN
    };
    OAIPhoneNumberProductType::eOAIPhoneNumberProductType getValue() const;
    void setValue(const OAIPhoneNumberProductType::eOAIPhoneNumberProductType& value);
...
private:
    ...
    eOAIPhoneNumberProductType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberProductType)

#endif // OAIPhoneNumberProductType_H
