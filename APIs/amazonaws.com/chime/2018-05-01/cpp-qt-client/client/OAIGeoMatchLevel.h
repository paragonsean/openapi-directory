...
#ifndef OAIGeoMatchLevel_H
#define OAIGeoMatchLevel_H
...
class OAIGeoMatchLevel : public OAIEnum {
public:
    OAIGeoMatchLevel();
    OAIGeoMatchLevel(QString json);
    ~OAIGeoMatchLevel() override;
    ...
    enum class eOAIGeoMatchLevel {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COUNTRY, 
        AREACODE
    };
    OAIGeoMatchLevel::eOAIGeoMatchLevel getValue() const;
    void setValue(const OAIGeoMatchLevel::eOAIGeoMatchLevel& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoMatchLevel)

#endif // OAIGeoMatchLevel_H
