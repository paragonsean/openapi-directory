...
#include "OAIGetGlobalSettingsResponse_BusinessCalling.h"
...
OAIGetGlobalSettingsResponse_BusinessCalling::OAIGetGlobalSettingsResponse_BusinessCalling(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGlobalSettingsResponse_BusinessCalling::OAIGetGlobalSettingsResponse_BusinessCalling() {
    this->initializeModel();
}

OAIGetGlobalSettingsResponse_BusinessCalling::~OAIGetGlobalSettingsResponse_BusinessCalling() {}

void OAIGetGlobalSettingsResponse_BusinessCalling::initializeModel() {

    m_cdr_bucket_isSet = false;
    m_cdr_bucket_isValid = false;
}

void OAIGetGlobalSettingsResponse_BusinessCalling::fromJson(QString jsonString) {
...
void OAIGetGlobalSettingsResponse_BusinessCalling::fromJsonObject(QJsonObject json) {
...
QString OAIGetGlobalSettingsResponse_BusinessCalling::asJson() const {
...
QJsonObject OAIGetGlobalSettingsResponse_BusinessCalling::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGlobalSettingsResponse_BusinessCalling::getCdrBucket() const {
    return m_cdr_bucket;
}
void OAIGetGlobalSettingsResponse_BusinessCalling::setCdrBucket(const QString &cdr_bucket) {
    m_cdr_bucket = cdr_bucket;
    m_cdr_bucket_isSet = true;
}

bool OAIGetGlobalSettingsResponse_BusinessCalling::is_cdr_bucket_Set() const{
    return m_cdr_bucket_isSet;
}

bool OAIGetGlobalSettingsResponse_BusinessCalling::is_cdr_bucket_Valid() const{
    return m_cdr_bucket_isValid;
}

bool OAIGetGlobalSettingsResponse_BusinessCalling::isSet() const {
...
bool OAIGetGlobalSettingsResponse_BusinessCalling::isValid() const {
