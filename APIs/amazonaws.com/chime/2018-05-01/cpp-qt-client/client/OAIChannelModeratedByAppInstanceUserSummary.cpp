...
OAIChannelMembershipForAppInstanceUserSummary_ChannelSummary OAIChannelModeratedByAppInstanceUserSummary::getChannelSummary() const {
    return m_channel_summary;
}
void OAIChannelModeratedByAppInstanceUserSummary::setChannelSummary(const OAIChannelMembershipForAppInstanceUserSummary_ChannelSummary &channel_summary) {
