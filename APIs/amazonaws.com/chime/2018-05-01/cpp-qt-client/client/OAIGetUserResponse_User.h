...
/*
 * OAIGetUserResponse_User.h
 *
 * 
 */

#ifndef OAIGetUserResponse_User_H
#define OAIGetUserResponse_User_H
...
class OAIGetUserResponse_User : public OAIObject {
public:
    OAIGetUserResponse_User();
    OAIGetUserResponse_User(QString json);
    ~OAIGetUserResponse_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserResponse_User)

#endif // OAIGetUserResponse_User_H
