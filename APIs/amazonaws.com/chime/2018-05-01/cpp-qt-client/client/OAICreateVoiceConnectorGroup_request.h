...
/*
 * OAICreateVoiceConnectorGroup_request.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorGroup_request_H
#define OAICreateVoiceConnectorGroup_request_H

#include <QJsonObject>

#include "OAIVoiceConnectorItem.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIVoiceConnectorItem;

class OAICreateVoiceConnectorGroup_request : public OAIObject {
public:
    OAICreateVoiceConnectorGroup_request();
    OAICreateVoiceConnectorGroup_request(QString json);
    ~OAICreateVoiceConnectorGroup_request() override;
    ...
    QList<OAIVoiceConnectorItem> getVoiceConnectorItems() const;
    void setVoiceConnectorItems(const QList<OAIVoiceConnectorItem> &voice_connector_items);
    bool is_voice_connector_items_Set() const;
    bool is_voice_connector_items_Valid() const;
...
private:
    ...
    QList<OAIVoiceConnectorItem> m_voice_connector_items;
    bool m_voice_connector_items_isSet;
    bool m_voice_connector_items_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorGroup_request)

#endif // OAICreateVoiceConnectorGroup_request_H
