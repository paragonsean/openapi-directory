...
/*
 * OAICreateAccount_request.h
 *
 * 
 */

#ifndef OAICreateAccount_request_H
#define OAICreateAccount_request_H
...
class OAICreateAccount_request : public OAIObject {
public:
    OAICreateAccount_request();
    OAICreateAccount_request(QString json);
    ~OAICreateAccount_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccount_request)

#endif // OAICreateAccount_request_H
