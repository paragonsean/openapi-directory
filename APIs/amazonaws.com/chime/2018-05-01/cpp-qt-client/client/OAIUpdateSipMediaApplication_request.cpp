...
OAIUpdateSipMediaApplication_request::OAIUpdateSipMediaApplication_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSipMediaApplication_request::OAIUpdateSipMediaApplication_request() {
    this->initializeModel();
}

OAIUpdateSipMediaApplication_request::~OAIUpdateSipMediaApplication_request() {}

void OAIUpdateSipMediaApplication_request::initializeModel() {
...
void OAIUpdateSipMediaApplication_request::fromJson(QString jsonString) {
...
void OAIUpdateSipMediaApplication_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSipMediaApplication_request::asJson() const {
...
QJsonObject OAIUpdateSipMediaApplication_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateSipMediaApplication_request::getName() const {
    return m_name;
}
void OAIUpdateSipMediaApplication_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateSipMediaApplication_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateSipMediaApplication_request::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAISipMediaApplicationEndpoint> OAIUpdateSipMediaApplication_request::getEndpoints() const {
    return m_endpoints;
}
void OAIUpdateSipMediaApplication_request::setEndpoints(const QList<OAISipMediaApplicationEndpoint> &endpoints) {
    m_endpoints = endpoints;
    m_endpoints_isSet = true;
}

bool OAIUpdateSipMediaApplication_request::is_endpoints_Set() const{
    return m_endpoints_isSet;
}

bool OAIUpdateSipMediaApplication_request::is_endpoints_Valid() const{
    return m_endpoints_isValid;
}

bool OAIUpdateSipMediaApplication_request::isSet() const {
...
bool OAIUpdateSipMediaApplication_request::isValid() const {
