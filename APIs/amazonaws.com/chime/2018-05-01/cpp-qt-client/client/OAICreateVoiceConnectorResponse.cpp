...
OAICreateVoiceConnectorResponse::OAICreateVoiceConnectorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateVoiceConnectorResponse::OAICreateVoiceConnectorResponse() {
    this->initializeModel();
}

OAICreateVoiceConnectorResponse::~OAICreateVoiceConnectorResponse() {}

void OAICreateVoiceConnectorResponse::initializeModel() {

    m_voice_connector_isSet = false;
    m_voice_connector_isValid = false;
}

void OAICreateVoiceConnectorResponse::fromJson(QString jsonString) {
...
void OAICreateVoiceConnectorResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateVoiceConnectorResponse::asJson() const {
...
QJsonObject OAICreateVoiceConnectorResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateVoiceConnectorResponse_VoiceConnector OAICreateVoiceConnectorResponse::getVoiceConnector() const {
    return m_voice_connector;
}
void OAICreateVoiceConnectorResponse::setVoiceConnector(const OAICreateVoiceConnectorResponse_VoiceConnector &voice_connector) {
    m_voice_connector = voice_connector;
    m_voice_connector_isSet = true;
}

bool OAICreateVoiceConnectorResponse::is_voice_connector_Set() const{
    return m_voice_connector_isSet;
}

bool OAICreateVoiceConnectorResponse::is_voice_connector_Valid() const{
    return m_voice_connector_isValid;
}

bool OAICreateVoiceConnectorResponse::isSet() const {
...
bool OAICreateVoiceConnectorResponse::isValid() const {
