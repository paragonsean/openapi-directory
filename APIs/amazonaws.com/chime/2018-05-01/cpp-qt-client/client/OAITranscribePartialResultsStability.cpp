...
OAITranscribePartialResultsStability::OAITranscribePartialResultsStability(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribePartialResultsStability::OAITranscribePartialResultsStability() {
    this->initializeModel();
}

OAITranscribePartialResultsStability::~OAITranscribePartialResultsStability() {}

void OAITranscribePartialResultsStability::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribePartialResultsStability::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribePartialResultsStability::fromJson(QString jsonString) {
    
    if ( jsonString.compare("low", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribePartialResultsStability::LOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("medium", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribePartialResultsStability::MEDIUM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("high", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribePartialResultsStability::HIGH;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribePartialResultsStability::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribePartialResultsStability::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribePartialResultsStability::LOW:
            val = "low";
            break;
        case eOAITranscribePartialResultsStability::MEDIUM:
            val = "medium";
            break;
        case eOAITranscribePartialResultsStability::HIGH:
            val = "high";
            break;
        default:
            break;
...
QJsonValue OAITranscribePartialResultsStability::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribePartialResultsStability::eOAITranscribePartialResultsStability OAITranscribePartialResultsStability::getValue() const {
    return m_value;
}

void OAITranscribePartialResultsStability::setValue(const OAITranscribePartialResultsStability::eOAITranscribePartialResultsStability& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribePartialResultsStability::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribePartialResultsStability::isValid() const {
