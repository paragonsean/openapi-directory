...
/*
 * OAIPutEventsConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutEventsConfiguration_request_H
#define OAIPutEventsConfiguration_request_H
...
class OAIPutEventsConfiguration_request : public OAIObject {
public:
    OAIPutEventsConfiguration_request();
    OAIPutEventsConfiguration_request(QString json);
    ~OAIPutEventsConfiguration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutEventsConfiguration_request)

#endif // OAIPutEventsConfiguration_request_H
