...
OAIBatchUnsuspendUser_request::OAIBatchUnsuspendUser_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUnsuspendUser_request::OAIBatchUnsuspendUser_request() {
    this->initializeModel();
}

OAIBatchUnsuspendUser_request::~OAIBatchUnsuspendUser_request() {}

void OAIBatchUnsuspendUser_request::initializeModel() {

    m_user_id_list_isSet = false;
    m_user_id_list_isValid = false;
}

void OAIBatchUnsuspendUser_request::fromJson(QString jsonString) {
...
void OAIBatchUnsuspendUser_request::fromJsonObject(QJsonObject json) {

    m_user_id_list_isValid = ::OpenAPI::fromJsonValue(m_user_id_list, json[QString("UserIdList")]);
    m_user_id_list_isSet = !json[QString("UserIdList")].isNull() && m_user_id_list_isValid;
}

QString OAIBatchUnsuspendUser_request::asJson() const {
...
QJsonObject OAIBatchUnsuspendUser_request::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_list.size() > 0) {
        obj.insert(QString("UserIdList"), ::OpenAPI::toJsonValue(m_user_id_list));
    }
    return obj;
}

QList<QString> OAIBatchUnsuspendUser_request::getUserIdList() const {
    return m_user_id_list;
}
void OAIBatchUnsuspendUser_request::setUserIdList(const QList<QString> &user_id_list) {
    m_user_id_list = user_id_list;
    m_user_id_list_isSet = true;
}

bool OAIBatchUnsuspendUser_request::is_user_id_list_Set() const{
    return m_user_id_list_isSet;
}

bool OAIBatchUnsuspendUser_request::is_user_id_list_Valid() const{
    return m_user_id_list_isValid;
}

bool OAIBatchUnsuspendUser_request::isSet() const {
...
bool OAIBatchUnsuspendUser_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_id_list_isValid && true;
}
