...
void OAIUpdateGlobalSettings_request::initializeModel() {
    ...
    m_business_calling_isSet = false;
    m_business_calling_isValid = false;
...
void OAIUpdateGlobalSettings_request::fromJsonObject(QJsonObject json) {
    ...
    m_business_calling_isValid = ::OpenAPI::fromJsonValue(m_business_calling, json[QString("BusinessCalling")]);
    m_business_calling_isSet = !json[QString("BusinessCalling")].isNull() && m_business_calling_isValid;
...
QJsonObject OAIUpdateGlobalSettings_request::asJsonObject() const {
    QJsonObject obj;
    if (m_business_calling.isSet()) {
        obj.insert(QString("BusinessCalling"), ::OpenAPI::toJsonValue(m_business_calling));
    }
...
OAIUpdateGlobalSettings_request_BusinessCalling OAIUpdateGlobalSettings_request::getBusinessCalling() const {
    return m_business_calling;
}
void OAIUpdateGlobalSettings_request::setBusinessCalling(const OAIUpdateGlobalSettings_request_BusinessCalling &business_calling) {
    m_business_calling = business_calling;
    m_business_calling_isSet = true;
}

bool OAIUpdateGlobalSettings_request::is_business_calling_Set() const{
    return m_business_calling_isSet;
}

bool OAIUpdateGlobalSettings_request::is_business_calling_Valid() const{
    return m_business_calling_isValid;
}

OAIUpdateGlobalSettings_request_VoiceConnector OAIUpdateGlobalSettings_request::getVoiceConnector() const {
    return m_voice_connector;
}
void OAIUpdateGlobalSettings_request::setVoiceConnector(const OAIUpdateGlobalSettings_request_VoiceConnector &voice_connector) {
    m_voice_connector = voice_connector;
    m_voice_connector_isSet = true;
}

bool OAIUpdateGlobalSettings_request::is_voice_connector_Set() const{
    return m_voice_connector_isSet;
}

bool OAIUpdateGlobalSettings_request::is_voice_connector_Valid() const{
