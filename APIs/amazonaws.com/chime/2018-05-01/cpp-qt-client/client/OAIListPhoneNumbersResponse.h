...
/*
 * OAIListPhoneNumbersResponse.h
 *
 * 
 */

#ifndef OAIListPhoneNumbersResponse_H
#define OAIListPhoneNumbersResponse_H
...
class OAIListPhoneNumbersResponse : public OAIObject {
public:
    OAIListPhoneNumbersResponse();
    OAIListPhoneNumbersResponse(QString json);
    ~OAIListPhoneNumbersResponse() override;
    ...
    QList getPhoneNumbers() const;
    void setPhoneNumbers(const QList &phone_numbers);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPhoneNumbersResponse)

#endif // OAIListPhoneNumbersResponse_H
