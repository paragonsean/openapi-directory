...
OAICreateRoomMembershipResponse::OAICreateRoomMembershipResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoomMembershipResponse::OAICreateRoomMembershipResponse() {
    this->initializeModel();
}

OAICreateRoomMembershipResponse::~OAICreateRoomMembershipResponse() {}

void OAICreateRoomMembershipResponse::initializeModel() {

    m_room_membership_isSet = false;
    m_room_membership_isValid = false;
}

void OAICreateRoomMembershipResponse::fromJson(QString jsonString) {
...
void OAICreateRoomMembershipResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoomMembershipResponse::asJson() const {
...
QJsonObject OAICreateRoomMembershipResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRoomMembershipResponse_RoomMembership OAICreateRoomMembershipResponse::getRoomMembership() const {
    return m_room_membership;
}
void OAICreateRoomMembershipResponse::setRoomMembership(const OAICreateRoomMembershipResponse_RoomMembership &room_membership) {
    m_room_membership = room_membership;
    m_room_membership_isSet = true;
}

bool OAICreateRoomMembershipResponse::is_room_membership_Set() const{
    return m_room_membership_isSet;
}

bool OAICreateRoomMembershipResponse::is_room_membership_Valid() const{
    return m_room_membership_isValid;
}

bool OAICreateRoomMembershipResponse::isSet() const {
...
bool OAICreateRoomMembershipResponse::isValid() const {
