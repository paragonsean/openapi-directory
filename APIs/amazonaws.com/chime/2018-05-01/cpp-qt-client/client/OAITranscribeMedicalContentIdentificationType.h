...
/*
 * OAITranscribeMedicalContentIdentificationType.h
 *
 * 
 */

#ifndef OAITranscribeMedicalContentIdentificationType_H
#define OAITranscribeMedicalContentIdentificationType_H
...
class OAITranscribeMedicalContentIdentificationType : public OAIEnum {
public:
    OAITranscribeMedicalContentIdentificationType();
    OAITranscribeMedicalContentIdentificationType(QString json);
    ~OAITranscribeMedicalContentIdentificationType() override;
    ...
    enum class eOAITranscribeMedicalContentIdentificationType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PHI
    };
    OAITranscribeMedicalContentIdentificationType::eOAITranscribeMedicalContentIdentificationType getValue() const;
    void setValue(const OAITranscribeMedicalContentIdentificationType::eOAITranscribeMedicalContentIdentificationType& value);
...
private:
    ...
    eOAITranscribeMedicalContentIdentificationType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeMedicalContentIdentificationType)

#endif // OAITranscribeMedicalContentIdentificationType_H
