...
OAIDisassociateSigninDelegateGroupsFromAccount_request::OAIDisassociateSigninDelegateGroupsFromAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateSigninDelegateGroupsFromAccount_request::OAIDisassociateSigninDelegateGroupsFromAccount_request() {
    this->initializeModel();
}

OAIDisassociateSigninDelegateGroupsFromAccount_request::~OAIDisassociateSigninDelegateGroupsFromAccount_request() {}

void OAIDisassociateSigninDelegateGroupsFromAccount_request::initializeModel() {

    m_group_names_isSet = false;
    m_group_names_isValid = false;
}

void OAIDisassociateSigninDelegateGroupsFromAccount_request::fromJson(QString jsonString) {
...
void OAIDisassociateSigninDelegateGroupsFromAccount_request::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateSigninDelegateGroupsFromAccount_request::asJson() const {
...
QJsonObject OAIDisassociateSigninDelegateGroupsFromAccount_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDisassociateSigninDelegateGroupsFromAccount_request::getGroupNames() const {
    return m_group_names;
}
void OAIDisassociateSigninDelegateGroupsFromAccount_request::setGroupNames(const QList<QString> &group_names) {
    m_group_names = group_names;
    m_group_names_isSet = true;
}

bool OAIDisassociateSigninDelegateGroupsFromAccount_request::is_group_names_Set() const{
    return m_group_names_isSet;
}

bool OAIDisassociateSigninDelegateGroupsFromAccount_request::is_group_names_Valid() const{
    return m_group_names_isValid;
}

bool OAIDisassociateSigninDelegateGroupsFromAccount_request::isSet() const {
...
bool OAIDisassociateSigninDelegateGroupsFromAccount_request::isValid() const {
