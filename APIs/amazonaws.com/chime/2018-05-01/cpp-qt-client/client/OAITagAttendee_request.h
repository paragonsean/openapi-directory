...
/*
 * OAITagAttendee_request.h
 *
 * 
 */

#ifndef OAITagAttendee_request_H
#define OAITagAttendee_request_H
...
class OAITagAttendee_request : public OAIObject {
public:
    OAITagAttendee_request();
    OAITagAttendee_request(QString json);
    ~OAITagAttendee_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagAttendee_request)

#endif // OAITagAttendee_request_H
