...
#ifndef OAITermination_H
#define OAITermination_H
...
class OAITermination : public OAIObject {
public:
    OAITermination();
    OAITermination(QString json);
    ~OAITermination() override;
    ...
    qint32 getCpsLimit() const;
    void setCpsLimit(const qint32 &cps_limit);
    bool is_cps_limit_Set() const;
    bool is_cps_limit_Valid() const;

    QString getDefaultPhoneNumber() const;
    void setDefaultPhoneNumber(const QString &default_phone_number);
    bool is_default_phone_number_Set() const;
    bool is_default_phone_number_Valid() const;

    QList getCallingRegions() const;
    void setCallingRegions(const QList &calling_regions);
    bool is_calling_regions_Set() const;
    bool is_calling_regions_Valid() const;

    QList getCidrAllowedList() const;
    void setCidrAllowedList(const QList &cidr_allowed_list);
    bool is_cidr_allowed_list_Set() const;
    bool is_cidr_allowed_list_Valid() const;
...
private:
    ...
    qint32 m_cps_limit;
    bool m_cps_limit_isSet;
    bool m_cps_limit_isValid;

    QString m_default_phone_number;
    bool m_default_phone_number_isSet;
    bool m_default_phone_number_isValid;

    QList m_calling_regions;
    bool m_calling_regions_isSet;
    bool m_calling_regions_isValid;

    QList m_cidr_allowed_list;
    bool m_cidr_allowed_list_isSet;
    bool m_cidr_allowed_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITermination)

#endif // OAITermination_H
