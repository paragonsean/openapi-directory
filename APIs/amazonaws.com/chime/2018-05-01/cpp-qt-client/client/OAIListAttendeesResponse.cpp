...
OAIListAttendeesResponse::OAIListAttendeesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAttendeesResponse::OAIListAttendeesResponse() {
    this->initializeModel();
}

OAIListAttendeesResponse::~OAIListAttendeesResponse() {}

void OAIListAttendeesResponse::initializeModel() {
...
void OAIListAttendeesResponse::fromJson(QString jsonString) {
...
void OAIListAttendeesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListAttendeesResponse::asJson() const {
...
QJsonObject OAIListAttendeesResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListAttendeesResponse::getAttendees() const {
    return m_attendees;
}
void OAIListAttendeesResponse::setAttendees(const QList &attendees) {
    m_attendees = attendees;
    m_attendees_isSet = true;
}

bool OAIListAttendeesResponse::is_attendees_Set() const{
    return m_attendees_isSet;
}

bool OAIListAttendeesResponse::is_attendees_Valid() const{
    return m_attendees_isValid;
}

QString OAIListAttendeesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListAttendeesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListAttendeesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListAttendeesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListAttendeesResponse::isSet() const {
...
bool OAIListAttendeesResponse::isValid() const {
