...
/*
 * OAIOriginationRouteProtocol.h
 *
 * 
 */

#ifndef OAIOriginationRouteProtocol_H
#define OAIOriginationRouteProtocol_H
...
class OAIOriginationRouteProtocol : public OAIEnum {
public:
    OAIOriginationRouteProtocol();
    OAIOriginationRouteProtocol(QString json);
    ~OAIOriginationRouteProtocol() override;
    ...
    enum class eOAIOriginationRouteProtocol {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TCP, 
        UDP
    };
    OAIOriginationRouteProtocol::eOAIOriginationRouteProtocol getValue() const;
    void setValue(const OAIOriginationRouteProtocol::eOAIOriginationRouteProtocol& value);
...
private:
    ...
    eOAIOriginationRouteProtocol m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginationRouteProtocol)

#endif // OAIOriginationRouteProtocol_H
