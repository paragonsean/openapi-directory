...
OAIBatchCreateRoomMembershipResponse::OAIBatchCreateRoomMembershipResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchCreateRoomMembershipResponse::OAIBatchCreateRoomMembershipResponse() {
    this->initializeModel();
}

OAIBatchCreateRoomMembershipResponse::~OAIBatchCreateRoomMembershipResponse() {}

void OAIBatchCreateRoomMembershipResponse::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIBatchCreateRoomMembershipResponse::fromJson(QString jsonString) {
...
void OAIBatchCreateRoomMembershipResponse::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("Errors")]);
    m_errors_isSet = !json[QString("Errors")].isNull() && m_errors_isValid;
}

QString OAIBatchCreateRoomMembershipResponse::asJson() const {
...
QJsonObject OAIBatchCreateRoomMembershipResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.isSet()) {
...
QList OAIBatchCreateRoomMembershipResponse::getErrors() const {
    return m_errors;
}
void OAIBatchCreateRoomMembershipResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchCreateRoomMembershipResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchCreateRoomMembershipResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchCreateRoomMembershipResponse::isSet() const {
...
bool OAIBatchCreateRoomMembershipResponse::isValid() const {
