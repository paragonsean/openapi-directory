...
/*
 * OAICreateProxySessionResponse_ProxySession.h
 *
 * 
 */

#ifndef OAICreateProxySessionResponse_ProxySession_H
#define OAICreateProxySessionResponse_ProxySession_H
...
class OAICreateProxySessionResponse_ProxySession : public OAIObject {
public:
    OAICreateProxySessionResponse_ProxySession();
    OAICreateProxySessionResponse_ProxySession(QString json);
    ~OAICreateProxySessionResponse_ProxySession() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySessionResponse_ProxySession)

#endif // OAICreateProxySessionResponse_ProxySession_H
