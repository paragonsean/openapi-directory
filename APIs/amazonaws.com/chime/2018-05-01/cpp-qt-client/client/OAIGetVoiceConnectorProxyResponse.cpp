...
OAIGetVoiceConnectorProxyResponse::OAIGetVoiceConnectorProxyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorProxyResponse::OAIGetVoiceConnectorProxyResponse() {
    this->initializeModel();
}

OAIGetVoiceConnectorProxyResponse::~OAIGetVoiceConnectorProxyResponse() {}

void OAIGetVoiceConnectorProxyResponse::initializeModel() {

    m_proxy_isSet = false;
    m_proxy_isValid = false;
}

void OAIGetVoiceConnectorProxyResponse::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorProxyResponse::fromJsonObject(QJsonObject json) {

    m_proxy_isValid = ::OpenAPI::fromJsonValue(m_proxy, json[QString("Proxy")]);
    m_proxy_isSet = !json[QString("Proxy")].isNull() && m_proxy_isValid;
}

QString OAIGetVoiceConnectorProxyResponse::asJson() const {
...
QJsonObject OAIGetVoiceConnectorProxyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_proxy.isSet()) {
...
OAIGetVoiceConnectorProxyResponse_Proxy OAIGetVoiceConnectorProxyResponse::getProxy() const {
    return m_proxy;
}
void OAIGetVoiceConnectorProxyResponse::setProxy(const OAIGetVoiceConnectorProxyResponse_Proxy &proxy) {
    m_proxy = proxy;
    m_proxy_isSet = true;
}

bool OAIGetVoiceConnectorProxyResponse::is_proxy_Set() const{
    return m_proxy_isSet;
}

bool OAIGetVoiceConnectorProxyResponse::is_proxy_Valid() const{
    return m_proxy_isValid;
}

bool OAIGetVoiceConnectorProxyResponse::isSet() const {
...
bool OAIGetVoiceConnectorProxyResponse::isValid() const {
