...
/*
 * OAITranscribeMedicalSpecialty.h
 *
 * 
 */

#ifndef OAITranscribeMedicalSpecialty_H
#define OAITranscribeMedicalSpecialty_H
...
class OAITranscribeMedicalSpecialty : public OAIEnum {
public:
    OAITranscribeMedicalSpecialty();
    OAITranscribeMedicalSpecialty(QString json);
    ~OAITranscribeMedicalSpecialty() override;
    ...
    enum class eOAITranscribeMedicalSpecialty {
    ...
    OAITranscribeMedicalSpecialty::eOAITranscribeMedicalSpecialty getValue() const;
    void setValue(const OAITranscribeMedicalSpecialty::eOAITranscribeMedicalSpecialty& value);
...
private:
    ...
    eOAITranscribeMedicalSpecialty m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeMedicalSpecialty)

#endif // OAITranscribeMedicalSpecialty_H
