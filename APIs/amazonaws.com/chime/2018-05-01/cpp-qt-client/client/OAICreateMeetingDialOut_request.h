...
/*
 * OAICreateMeetingDialOut_request.h
 *
 * 
 */

#ifndef OAICreateMeetingDialOut_request_H
#define OAICreateMeetingDialOut_request_H
...
class OAICreateMeetingDialOut_request : public OAIObject {
public:
    OAICreateMeetingDialOut_request();
    OAICreateMeetingDialOut_request(QString json);
    ~OAICreateMeetingDialOut_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingDialOut_request)

#endif // OAICreateMeetingDialOut_request_H
