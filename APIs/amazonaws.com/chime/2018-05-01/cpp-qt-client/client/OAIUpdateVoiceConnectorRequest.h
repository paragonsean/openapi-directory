...
/*
 * OAIUpdateVoiceConnectorRequest.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnectorRequest_H
#define OAIUpdateVoiceConnectorRequest_H
...
class OAIUpdateVoiceConnectorRequest : public OAIObject {
public:
    OAIUpdateVoiceConnectorRequest();
    OAIUpdateVoiceConnectorRequest(QString json);
    ~OAIUpdateVoiceConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnectorRequest)

#endif // OAIUpdateVoiceConnectorRequest_H
