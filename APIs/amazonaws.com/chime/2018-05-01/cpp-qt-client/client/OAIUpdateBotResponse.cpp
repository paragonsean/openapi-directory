...
OAIUpdateBotResponse_Bot OAIUpdateBotResponse::getBot() const {
    return m_bot;
}
void OAIUpdateBotResponse::setBot(const OAIUpdateBotResponse_Bot &bot) {
    m_bot = bot;
    m_bot_isSet = true;
}

bool OAIUpdateBotResponse::is_bot_Set() const{
    return m_bot_isSet;
}

bool OAIUpdateBotResponse::is_bot_Valid() const{
