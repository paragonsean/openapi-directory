...
#include "OAIUntagMeetingRequest.h"
...
OAIUntagMeetingRequest::OAIUntagMeetingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagMeetingRequest::OAIUntagMeetingRequest() {
    this->initializeModel();
}

OAIUntagMeetingRequest::~OAIUntagMeetingRequest() {}

void OAIUntagMeetingRequest::initializeModel() {

    m_tag_keys_isSet = false;
    m_tag_keys_isValid = false;
}

void OAIUntagMeetingRequest::fromJson(QString jsonString) {
...
void OAIUntagMeetingRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUntagMeetingRequest::asJson() const {
...
QJsonObject OAIUntagMeetingRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_tag_keys.isSet()) {
...
QList OAIUntagMeetingRequest::getTagKeys() const {
    return m_tag_keys;
}
void OAIUntagMeetingRequest::setTagKeys(const QList &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIUntagMeetingRequest::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIUntagMeetingRequest::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

bool OAIUntagMeetingRequest::isSet() const {
...
bool OAIUntagMeetingRequest::isValid() const {
