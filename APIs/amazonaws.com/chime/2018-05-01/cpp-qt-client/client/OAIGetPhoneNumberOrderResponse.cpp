...
OAIGetPhoneNumberOrderResponse::OAIGetPhoneNumberOrderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPhoneNumberOrderResponse::OAIGetPhoneNumberOrderResponse() {
    this->initializeModel();
}

OAIGetPhoneNumberOrderResponse::~OAIGetPhoneNumberOrderResponse() {}

void OAIGetPhoneNumberOrderResponse::initializeModel() {

    m_phone_number_order_isSet = false;
    m_phone_number_order_isValid = false;
}

void OAIGetPhoneNumberOrderResponse::fromJson(QString jsonString) {
...
void OAIGetPhoneNumberOrderResponse::fromJsonObject(QJsonObject json) {

    m_phone_number_order_isValid = ::OpenAPI::fromJsonValue(m_phone_number_order, json[QString("PhoneNumberOrder")]);
    m_phone_number_order_isSet = !json[QString("PhoneNumberOrder")].isNull() && m_phone_number_order_isValid;
}

QString OAIGetPhoneNumberOrderResponse::asJson() const {
...
QJsonObject OAIGetPhoneNumberOrderResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_phone_number_order.isSet()) {
        obj.insert(QString("PhoneNumberOrder"), ::OpenAPI::toJsonValue(m_phone_number_order));
    }
    return obj;
}

OAICreatePhoneNumberOrderResponse_PhoneNumberOrder OAIGetPhoneNumberOrderResponse::getPhoneNumberOrder() const {
    return m_phone_number_order;
}
void OAIGetPhoneNumberOrderResponse::setPhoneNumberOrder(const OAICreatePhoneNumberOrderResponse_PhoneNumberOrder &phone_number_order) {
    m_phone_number_order = phone_number_order;
    m_phone_number_order_isSet = true;
}

bool OAIGetPhoneNumberOrderResponse::is_phone_number_order_Set() const{
    return m_phone_number_order_isSet;
}

bool OAIGetPhoneNumberOrderResponse::is_phone_number_order_Valid() const{
    return m_phone_number_order_isValid;
}

bool OAIGetPhoneNumberOrderResponse::isSet() const {
...
bool OAIGetPhoneNumberOrderResponse::isValid() const {
