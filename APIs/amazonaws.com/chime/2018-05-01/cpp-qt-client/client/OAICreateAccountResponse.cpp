...
OAICreateAccountResponse_Account OAICreateAccountResponse::getAccount() const {
    return m_account;
}
void OAICreateAccountResponse::setAccount(const OAICreateAccountResponse_Account &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAICreateAccountResponse::is_account_Set() const{
    return m_account_isSet;
}

bool OAICreateAccountResponse::is_account_Valid() const{
