...
OAIChannelModeratorSummary_Moderator::OAIChannelModeratorSummary_Moderator(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelModeratorSummary_Moderator::OAIChannelModeratorSummary_Moderator() {
    this->initializeModel();
}

OAIChannelModeratorSummary_Moderator::~OAIChannelModeratorSummary_Moderator() {}

void OAIChannelModeratorSummary_Moderator::initializeModel() {
...
void OAIChannelModeratorSummary_Moderator::fromJson(QString jsonString) {
...
void OAIChannelModeratorSummary_Moderator::fromJsonObject(QJsonObject json) {
...
QString OAIChannelModeratorSummary_Moderator::asJson() const {
...
QJsonObject OAIChannelModeratorSummary_Moderator::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIChannelModeratorSummary_Moderator::getArn() const {
    return m_arn;
}
void OAIChannelModeratorSummary_Moderator::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIChannelModeratorSummary_Moderator::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIChannelModeratorSummary_Moderator::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIChannelModeratorSummary_Moderator::getName() const {
    return m_name;
}
void OAIChannelModeratorSummary_Moderator::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChannelModeratorSummary_Moderator::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChannelModeratorSummary_Moderator::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIChannelModeratorSummary_Moderator::isSet() const {
...
bool OAIChannelModeratorSummary_Moderator::isValid() const {
