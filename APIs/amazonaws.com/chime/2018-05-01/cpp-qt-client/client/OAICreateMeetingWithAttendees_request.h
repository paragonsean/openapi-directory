...
/*
 * OAICreateMeetingWithAttendees_request.h
 *
 * 
 */

#ifndef OAICreateMeetingWithAttendees_request_H
#define OAICreateMeetingWithAttendees_request_H
...
class OAICreateMeetingWithAttendees_request : public OAIObject {
public:
    OAICreateMeetingWithAttendees_request();
    OAICreateMeetingWithAttendees_request(QString json);
    ~OAICreateMeetingWithAttendees_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingWithAttendees_request)

#endif // OAICreateMeetingWithAttendees_request_H
