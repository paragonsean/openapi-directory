...
OAILicense OAIUpdateUserRequest::getLicenseType() const {
    return m_license_type;
}
void OAIUpdateUserRequest::setLicenseType(const OAILicense &license_type) {
    m_license_type = license_type;
    m_license_type_isSet = true;
}

bool OAIUpdateUserRequest::is_license_type_Set() const{
    return m_license_type_isSet;
}

bool OAIUpdateUserRequest::is_license_type_Valid() const{
    return m_license_type_isValid;
}

OAIUserType OAIUpdateUserRequest::getUserType() const {
    return m_user_type;
}
void OAIUpdateUserRequest::setUserType(const OAIUserType &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIUpdateUserRequest::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIUpdateUserRequest::is_user_type_Valid() const{
    return m_user_type_isValid;
}

OAIUpdateUserRequestItem_AlexaForBusinessMetadata OAIUpdateUserRequest::getAlexaForBusinessMetadata() const {
    return m_alexa_for_business_metadata;
}
void OAIUpdateUserRequest::setAlexaForBusinessMetadata(const OAIUpdateUserRequestItem_AlexaForBusinessMetadata &alexa_for_business_metadata) {
    m_alexa_for_business_metadata = alexa_for_business_metadata;
    m_alexa_for_business_metadata_isSet = true;
}

bool OAIUpdateUserRequest::is_alexa_for_business_metadata_Set() const{
    return m_alexa_for_business_metadata_isSet;
}

bool OAIUpdateUserRequest::is_alexa_for_business_metadata_Valid() const{
