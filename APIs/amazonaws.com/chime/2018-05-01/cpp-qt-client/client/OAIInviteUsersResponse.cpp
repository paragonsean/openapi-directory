...
OAIInviteUsersResponse::OAIInviteUsersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteUsersResponse::OAIInviteUsersResponse() {
    this->initializeModel();
}

OAIInviteUsersResponse::~OAIInviteUsersResponse() {}

void OAIInviteUsersResponse::initializeModel() {

    m_invites_isSet = false;
    m_invites_isValid = false;
}

void OAIInviteUsersResponse::fromJson(QString jsonString) {
...
void OAIInviteUsersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIInviteUsersResponse::asJson() const {
...
QJsonObject OAIInviteUsersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_invites.isSet()) {
...
QList OAIInviteUsersResponse::getInvites() const {
    return m_invites;
}
void OAIInviteUsersResponse::setInvites(const QList &invites) {
    m_invites = invites;
    m_invites_isSet = true;
}

bool OAIInviteUsersResponse::is_invites_Set() const{
    return m_invites_isSet;
}

bool OAIInviteUsersResponse::is_invites_Valid() const{
    return m_invites_isValid;
}

bool OAIInviteUsersResponse::isSet() const {
...
bool OAIInviteUsersResponse::isValid() const {
