...
/*
 * OAIPhoneNumberAssociationName.h
 *
 * 
 */

#ifndef OAIPhoneNumberAssociationName_H
#define OAIPhoneNumberAssociationName_H
...
class OAIPhoneNumberAssociationName : public OAIEnum {
public:
    OAIPhoneNumberAssociationName();
    OAIPhoneNumberAssociationName(QString json);
    ~OAIPhoneNumberAssociationName() override;
    ...
    enum class eOAIPhoneNumberAssociationName {
    ...
    OAIPhoneNumberAssociationName::eOAIPhoneNumberAssociationName getValue() const;
    void setValue(const OAIPhoneNumberAssociationName::eOAIPhoneNumberAssociationName& value);
...
private:
    ...
    eOAIPhoneNumberAssociationName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberAssociationName)

#endif // OAIPhoneNumberAssociationName_H
