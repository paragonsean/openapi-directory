...
/*
 * OAICreateProxySession_request.h
 *
 * 
 */

#ifndef OAICreateProxySession_request_H
#define OAICreateProxySession_request_H
...
namespace OpenAPI {
class OAICreateProxySession_request_GeoMatchParams;

class OAICreateProxySession_request : public OAIObject {
public:
    OAICreateProxySession_request();
    OAICreateProxySession_request(QString json);
    ~OAICreateProxySession_request() override;
    ...
    QList<QString> getParticipantPhoneNumbers() const;
    void setParticipantPhoneNumbers(const QList<QString> &participant_phone_numbers);
    ...
    QString getNumberSelectionBehavior() const;
    void setNumberSelectionBehavior(const QString &number_selection_behavior);
    bool is_number_selection_behavior_Set() const;
    bool is_number_selection_behavior_Valid() const;

    QString getGeoMatchLevel() const;
    void setGeoMatchLevel(const QString &geo_match_level);
    bool is_geo_match_level_Set() const;
    bool is_geo_match_level_Valid() const;

    OAICreateProxySession_request_GeoMatchParams getGeoMatchParams() const;
    void setGeoMatchParams(const OAICreateProxySession_request_GeoMatchParams &geo_match_params);
...
private:
    ...
    QList<QString> m_participant_phone_numbers;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySession_request)

#endif // OAICreateProxySession_request_H
