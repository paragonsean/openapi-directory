...
/*
 * OAIUpdateAccountSettingsRequest_AccountSettings.h
 *
 * 
 */

#ifndef OAIUpdateAccountSettingsRequest_AccountSettings_H
#define OAIUpdateAccountSettingsRequest_AccountSettings_H
...
class OAIUpdateAccountSettingsRequest_AccountSettings : public OAIObject {
public:
    OAIUpdateAccountSettingsRequest_AccountSettings();
    OAIUpdateAccountSettingsRequest_AccountSettings(QString json);
    ~OAIUpdateAccountSettingsRequest_AccountSettings() override;
    ...
    bool getDisableRemoteControl() const;
    void setDisableRemoteControl(const bool &disable_remote_control);
    bool is_disable_remote_control_Set() const;
    bool is_disable_remote_control_Valid() const;

    bool getEnableDialOut() const;
    void setEnableDialOut(const bool &enable_dial_out);
    bool is_enable_dial_out_Set() const;
    bool is_enable_dial_out_Valid() const;
...
private:
    ...
    bool m_disable_remote_control;
    bool m_disable_remote_control_isSet;
    bool m_disable_remote_control_isValid;

    bool m_enable_dial_out;
    bool m_enable_dial_out_isSet;
    bool m_enable_dial_out_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountSettingsRequest_AccountSettings)

#endif // OAIUpdateAccountSettingsRequest_AccountSettings_H
