...
/*
 * OAICreateVoiceConnectorGroupRequest.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorGroupRequest_H
#define OAICreateVoiceConnectorGroupRequest_H
...
class OAICreateVoiceConnectorGroupRequest : public OAIObject {
public:
    OAICreateVoiceConnectorGroupRequest();
    OAICreateVoiceConnectorGroupRequest(QString json);
    ~OAICreateVoiceConnectorGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorGroupRequest)

#endif // OAICreateVoiceConnectorGroupRequest_H
