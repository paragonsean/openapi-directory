...
/*
 * OAIBatchCreateChannelMembership_request.h
 *
 * 
 */

#ifndef OAIBatchCreateChannelMembership_request_H
#define OAIBatchCreateChannelMembership_request_H
...
class OAIBatchCreateChannelMembership_request : public OAIObject {
public:
    OAIBatchCreateChannelMembership_request();
    OAIBatchCreateChannelMembership_request(QString json);
    ~OAIBatchCreateChannelMembership_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateChannelMembership_request)

#endif // OAIBatchCreateChannelMembership_request_H
