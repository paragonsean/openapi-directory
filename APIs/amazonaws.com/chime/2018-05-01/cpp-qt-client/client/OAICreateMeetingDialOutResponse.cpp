...
OAICreateMeetingDialOutResponse::OAICreateMeetingDialOutResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMeetingDialOutResponse::OAICreateMeetingDialOutResponse() {
    this->initializeModel();
}

OAICreateMeetingDialOutResponse::~OAICreateMeetingDialOutResponse() {}

void OAICreateMeetingDialOutResponse::initializeModel() {

    m_transaction_id_isSet = false;
    m_transaction_id_isValid = false;
}

void OAICreateMeetingDialOutResponse::fromJson(QString jsonString) {
...
void OAICreateMeetingDialOutResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateMeetingDialOutResponse::asJson() const {
...
QJsonObject OAICreateMeetingDialOutResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateMeetingDialOutResponse::getTransactionId() const {
    return m_transaction_id;
}
void OAICreateMeetingDialOutResponse::setTransactionId(const QString &transaction_id) {
    m_transaction_id = transaction_id;
    m_transaction_id_isSet = true;
}

bool OAICreateMeetingDialOutResponse::is_transaction_id_Set() const{
    return m_transaction_id_isSet;
}

bool OAICreateMeetingDialOutResponse::is_transaction_id_Valid() const{
    return m_transaction_id_isValid;
}

bool OAICreateMeetingDialOutResponse::isSet() const {
...
bool OAICreateMeetingDialOutResponse::isValid() const {
