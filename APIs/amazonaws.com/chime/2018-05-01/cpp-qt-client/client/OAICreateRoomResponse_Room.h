...
/*
 * OAICreateRoomResponse_Room.h
 *
 * 
 */

#ifndef OAICreateRoomResponse_Room_H
#define OAICreateRoomResponse_Room_H
...
class OAICreateRoomResponse_Room : public OAIObject {
public:
    OAICreateRoomResponse_Room();
    OAICreateRoomResponse_Room(QString json);
    ~OAICreateRoomResponse_Room() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoomResponse_Room)

#endif // OAICreateRoomResponse_Room_H
