...
/*
 * OAIUpdateRoomMembership_request.h
 *
 * 
 */

#ifndef OAIUpdateRoomMembership_request_H
#define OAIUpdateRoomMembership_request_H
...
class OAIUpdateRoomMembership_request : public OAIObject {
public:
    OAIUpdateRoomMembership_request();
    OAIUpdateRoomMembership_request(QString json);
    ~OAIUpdateRoomMembership_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoomMembership_request)

#endif // OAIUpdateRoomMembership_request_H
