...
OAIArtifactsConfiguration_Video::OAIArtifactsConfiguration_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIArtifactsConfiguration_Video::OAIArtifactsConfiguration_Video() {
    this->initializeModel();
}

OAIArtifactsConfiguration_Video::~OAIArtifactsConfiguration_Video() {}

void OAIArtifactsConfiguration_Video::initializeModel() {
...
void OAIArtifactsConfiguration_Video::fromJson(QString jsonString) {
...
void OAIArtifactsConfiguration_Video::fromJsonObject(QJsonObject json) {
...
QString OAIArtifactsConfiguration_Video::asJson() const {
...
QJsonObject OAIArtifactsConfiguration_Video::asJsonObject() const {
    QJsonObject obj;
    if (m_state.isSet()) {
...
OAIArtifactsState OAIArtifactsConfiguration_Video::getState() const {
    return m_state;
}
void OAIArtifactsConfiguration_Video::setState(const OAIArtifactsState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIArtifactsConfiguration_Video::is_state_Set() const{
    return m_state_isSet;
}

bool OAIArtifactsConfiguration_Video::is_state_Valid() const{
    return m_state_isValid;
}

OAIVideoMuxType OAIArtifactsConfiguration_Video::getMuxType() const {
    return m_mux_type;
}
void OAIArtifactsConfiguration_Video::setMuxType(const OAIVideoMuxType &mux_type) {
    m_mux_type = mux_type;
    m_mux_type_isSet = true;
}

bool OAIArtifactsConfiguration_Video::is_mux_type_Set() const{
    return m_mux_type_isSet;
}

bool OAIArtifactsConfiguration_Video::is_mux_type_Valid() const{
    return m_mux_type_isValid;
}

bool OAIArtifactsConfiguration_Video::isSet() const {
...
bool OAIArtifactsConfiguration_Video::isValid() const {
