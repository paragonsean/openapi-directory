...
bool OAIUpdateBotRequest::getDisabled() const {
    return m_disabled;
}
void OAIUpdateBotRequest::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIUpdateBotRequest::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIUpdateBotRequest::is_disabled_Valid() const{
