...
#include "OAIUpdateAccountResponse_Account.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateAccountResponse_Account;
...
public:
    ...
    OAIUpdateAccountResponse_Account getAccount() const;
    void setAccount(const OAIUpdateAccountResponse_Account &account);
...
private:
    ...
    OAIUpdateAccountResponse_Account m_account;
