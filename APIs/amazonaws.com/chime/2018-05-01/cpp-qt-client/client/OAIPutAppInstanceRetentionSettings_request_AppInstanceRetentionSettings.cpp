...
OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings() {
    this->initializeModel();
}

OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::~OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings() {}

void OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::initializeModel() {

    m_channel_retention_settings_isSet = false;
    m_channel_retention_settings_isValid = false;
}

void OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::fromJson(QString jsonString) {
...
void OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::fromJsonObject(QJsonObject json) {
...
QString OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::asJson() const {
...
QJsonObject OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings_ChannelRetentionSettings OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::getChannelRetentionSettings() const {
    return m_channel_retention_settings;
}
void OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::setChannelRetentionSettings(const OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings_ChannelRetentionSettings &channel_retention_settings) {
    m_channel_retention_settings = channel_retention_settings;
    m_channel_retention_settings_isSet = true;
}

bool OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::is_channel_retention_settings_Set() const{
    return m_channel_retention_settings_isSet;
}

bool OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::is_channel_retention_settings_Valid() const{
    return m_channel_retention_settings_isValid;
}

bool OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::isSet() const {
...
bool OAIPutAppInstanceRetentionSettings_request_AppInstanceRetentionSettings::isValid() const {
