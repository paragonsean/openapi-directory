...
OAIUntagMeeting_request::OAIUntagMeeting_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagMeeting_request::OAIUntagMeeting_request() {
    this->initializeModel();
}

OAIUntagMeeting_request::~OAIUntagMeeting_request() {}

void OAIUntagMeeting_request::initializeModel() {

    m_tag_keys_isSet = false;
    m_tag_keys_isValid = false;
}

void OAIUntagMeeting_request::fromJson(QString jsonString) {
...
void OAIUntagMeeting_request::fromJsonObject(QJsonObject json) {
...
QString OAIUntagMeeting_request::asJson() const {
...
QJsonObject OAIUntagMeeting_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIUntagMeeting_request::getTagKeys() const {
    return m_tag_keys;
}
void OAIUntagMeeting_request::setTagKeys(const QList<QString> &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIUntagMeeting_request::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIUntagMeeting_request::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

bool OAIUntagMeeting_request::isSet() const {
...
bool OAIUntagMeeting_request::isValid() const {
