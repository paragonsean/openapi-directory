...
/*
 * OAIBatchSuspendUserRequest.h
 *
 * 
 */

#ifndef OAIBatchSuspendUserRequest_H
#define OAIBatchSuspendUserRequest_H
...
class OAIBatchSuspendUserRequest : public OAIObject {
public:
    OAIBatchSuspendUserRequest();
    OAIBatchSuspendUserRequest(QString json);
    ~OAIBatchSuspendUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchSuspendUserRequest)

#endif // OAIBatchSuspendUserRequest_H
