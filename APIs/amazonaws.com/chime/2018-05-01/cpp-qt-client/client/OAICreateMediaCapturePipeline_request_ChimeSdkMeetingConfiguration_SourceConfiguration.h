...
/*
 * OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration.h
 *
 * 
 */

#ifndef OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration_H
#define OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration_H
...
class OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration : public OAIObject {
public:
    OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration();
    OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration(QString json);
    ~OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration)

#endif // OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration_H
