...
OAIUpdateVoiceConnectorResponse::OAIUpdateVoiceConnectorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateVoiceConnectorResponse::OAIUpdateVoiceConnectorResponse() {
    this->initializeModel();
}

OAIUpdateVoiceConnectorResponse::~OAIUpdateVoiceConnectorResponse() {}

void OAIUpdateVoiceConnectorResponse::initializeModel() {

    m_voice_connector_isSet = false;
    m_voice_connector_isValid = false;
}

void OAIUpdateVoiceConnectorResponse::fromJson(QString jsonString) {
...
void OAIUpdateVoiceConnectorResponse::fromJsonObject(QJsonObject json) {

    m_voice_connector_isValid = ::OpenAPI::fromJsonValue(m_voice_connector, json[QString("VoiceConnector")]);
    m_voice_connector_isSet = !json[QString("VoiceConnector")].isNull() && m_voice_connector_isValid;
}

QString OAIUpdateVoiceConnectorResponse::asJson() const {
...
QJsonObject OAIUpdateVoiceConnectorResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_voice_connector.isSet()) {
        obj.insert(QString("VoiceConnector"), ::OpenAPI::toJsonValue(m_voice_connector));
    }
    return obj;
}

OAIUpdateVoiceConnectorResponse_VoiceConnector OAIUpdateVoiceConnectorResponse::getVoiceConnector() const {
    return m_voice_connector;
}
void OAIUpdateVoiceConnectorResponse::setVoiceConnector(const OAIUpdateVoiceConnectorResponse_VoiceConnector &voice_connector) {
    m_voice_connector = voice_connector;
    m_voice_connector_isSet = true;
}

bool OAIUpdateVoiceConnectorResponse::is_voice_connector_Set() const{
    return m_voice_connector_isSet;
}

bool OAIUpdateVoiceConnectorResponse::is_voice_connector_Valid() const{
    return m_voice_connector_isValid;
}

bool OAIUpdateVoiceConnectorResponse::isSet() const {
...
bool OAIUpdateVoiceConnectorResponse::isValid() const {
