...
OAIGetUserSettingsResponse::OAIGetUserSettingsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserSettingsResponse::OAIGetUserSettingsResponse() {
    this->initializeModel();
}

OAIGetUserSettingsResponse::~OAIGetUserSettingsResponse() {}

void OAIGetUserSettingsResponse::initializeModel() {

    m_user_settings_isSet = false;
    m_user_settings_isValid = false;
}

void OAIGetUserSettingsResponse::fromJson(QString jsonString) {
...
void OAIGetUserSettingsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserSettingsResponse::asJson() const {
...
QJsonObject OAIGetUserSettingsResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetUserSettingsResponse_UserSettings OAIGetUserSettingsResponse::getUserSettings() const {
    return m_user_settings;
}
void OAIGetUserSettingsResponse::setUserSettings(const OAIGetUserSettingsResponse_UserSettings &user_settings) {
    m_user_settings = user_settings;
    m_user_settings_isSet = true;
}

bool OAIGetUserSettingsResponse::is_user_settings_Set() const{
    return m_user_settings_isSet;
}

bool OAIGetUserSettingsResponse::is_user_settings_Valid() const{
    return m_user_settings_isValid;
}

bool OAIGetUserSettingsResponse::isSet() const {
...
bool OAIGetUserSettingsResponse::isValid() const {
