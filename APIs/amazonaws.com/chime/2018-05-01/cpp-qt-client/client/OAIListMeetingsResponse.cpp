...
OAIListMeetingsResponse::OAIListMeetingsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListMeetingsResponse::OAIListMeetingsResponse() {
    this->initializeModel();
}

OAIListMeetingsResponse::~OAIListMeetingsResponse() {}

void OAIListMeetingsResponse::initializeModel() {

    m_meetings_isSet = false;
    m_meetings_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListMeetingsResponse::fromJson(QString jsonString) {
...
void OAIListMeetingsResponse::fromJsonObject(QJsonObject json) {

    m_meetings_isValid = ::OpenAPI::fromJsonValue(m_meetings, json[QString("Meetings")]);
    m_meetings_isSet = !json[QString("Meetings")].isNull() && m_meetings_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListMeetingsResponse::asJson() const {
...
QJsonObject OAIListMeetingsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_meetings.isSet()) {
        obj.insert(QString("Meetings"), ::OpenAPI::toJsonValue(m_meetings));
    }
...
QList OAIListMeetingsResponse::getMeetings() const {
    return m_meetings;
}
void OAIListMeetingsResponse::setMeetings(const QList &meetings) {
    m_meetings = meetings;
    m_meetings_isSet = true;
}

bool OAIListMeetingsResponse::is_meetings_Set() const{
    return m_meetings_isSet;
}

bool OAIListMeetingsResponse::is_meetings_Valid() const{
    return m_meetings_isValid;
}

QString OAIListMeetingsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListMeetingsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListMeetingsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListMeetingsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListMeetingsResponse::isSet() const {
...
bool OAIListMeetingsResponse::isValid() const {
