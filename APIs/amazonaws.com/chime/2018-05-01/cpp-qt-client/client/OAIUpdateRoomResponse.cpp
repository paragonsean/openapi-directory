...
OAICreateRoomResponse_Room OAIUpdateRoomResponse::getRoom() const {
    return m_room;
}
void OAIUpdateRoomResponse::setRoom(const OAICreateRoomResponse_Room &room) {
    m_room = room;
    m_room_isSet = true;
}

bool OAIUpdateRoomResponse::is_room_Set() const{
    return m_room_isSet;
}

bool OAIUpdateRoomResponse::is_room_Valid() const{
