...
class OAIPhoneNumberStatus : public OAIEnum {
public:
    ...
    enum class eOAIPhoneNumberStatus {
    ...
    OAIPhoneNumberStatus::eOAIPhoneNumberStatus getValue() const;
    void setValue(const OAIPhoneNumberStatus::eOAIPhoneNumberStatus& value);
