...
OAIRegenerateSecurityTokenResponse::OAIRegenerateSecurityTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegenerateSecurityTokenResponse::OAIRegenerateSecurityTokenResponse() {
    this->initializeModel();
}

OAIRegenerateSecurityTokenResponse::~OAIRegenerateSecurityTokenResponse() {}

void OAIRegenerateSecurityTokenResponse::initializeModel() {

    m_bot_isSet = false;
    m_bot_isValid = false;
}

void OAIRegenerateSecurityTokenResponse::fromJson(QString jsonString) {
...
void OAIRegenerateSecurityTokenResponse::fromJsonObject(QJsonObject json) {

    m_bot_isValid = ::OpenAPI::fromJsonValue(m_bot, json[QString("Bot")]);
    m_bot_isSet = !json[QString("Bot")].isNull() && m_bot_isValid;
}

QString OAIRegenerateSecurityTokenResponse::asJson() const {
...
QJsonObject OAIRegenerateSecurityTokenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_bot.isSet()) {
...
OAIRegenerateSecurityTokenResponse_Bot OAIRegenerateSecurityTokenResponse::getBot() const {
    return m_bot;
}
void OAIRegenerateSecurityTokenResponse::setBot(const OAIRegenerateSecurityTokenResponse_Bot &bot) {
    m_bot = bot;
    m_bot_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse::is_bot_Set() const{
    return m_bot_isSet;
}

bool OAIRegenerateSecurityTokenResponse::is_bot_Valid() const{
    return m_bot_isValid;
}

bool OAIRegenerateSecurityTokenResponse::isSet() const {
...
bool OAIRegenerateSecurityTokenResponse::isValid() const {
