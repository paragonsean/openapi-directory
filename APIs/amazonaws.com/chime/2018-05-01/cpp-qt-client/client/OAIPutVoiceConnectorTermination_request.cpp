...
OAIPutVoiceConnectorTermination_request::OAIPutVoiceConnectorTermination_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorTermination_request::OAIPutVoiceConnectorTermination_request() {
    this->initializeModel();
}

OAIPutVoiceConnectorTermination_request::~OAIPutVoiceConnectorTermination_request() {}

void OAIPutVoiceConnectorTermination_request::initializeModel() {

    m_termination_isSet = false;
    m_termination_isValid = false;
}

void OAIPutVoiceConnectorTermination_request::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorTermination_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorTermination_request::asJson() const {
...
QJsonObject OAIPutVoiceConnectorTermination_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorTermination_request_Termination OAIPutVoiceConnectorTermination_request::getTermination() const {
    return m_termination;
}
void OAIPutVoiceConnectorTermination_request::setTermination(const OAIPutVoiceConnectorTermination_request_Termination &termination) {
    m_termination = termination;
    m_termination_isSet = true;
}

bool OAIPutVoiceConnectorTermination_request::is_termination_Set() const{
    return m_termination_isSet;
}

bool OAIPutVoiceConnectorTermination_request::is_termination_Valid() const{
    return m_termination_isValid;
}

bool OAIPutVoiceConnectorTermination_request::isSet() const {
...
bool OAIPutVoiceConnectorTermination_request::isValid() const {
