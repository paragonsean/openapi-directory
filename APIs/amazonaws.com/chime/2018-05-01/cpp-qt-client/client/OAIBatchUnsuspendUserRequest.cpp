...
#include "OAIBatchUnsuspendUserRequest.h"
...
OAIBatchUnsuspendUserRequest::OAIBatchUnsuspendUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUnsuspendUserRequest::OAIBatchUnsuspendUserRequest() {
    this->initializeModel();
}

OAIBatchUnsuspendUserRequest::~OAIBatchUnsuspendUserRequest() {}

void OAIBatchUnsuspendUserRequest::initializeModel() {

    m_user_id_list_isSet = false;
    m_user_id_list_isValid = false;
}

void OAIBatchUnsuspendUserRequest::fromJson(QString jsonString) {
...
void OAIBatchUnsuspendUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUnsuspendUserRequest::asJson() const {
...
QJsonObject OAIBatchUnsuspendUserRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_list.isSet()) {
        obj.insert(QString("UserIdList"), ::OpenAPI::toJsonValue(m_user_id_list));
    }
    return obj;
}

QList OAIBatchUnsuspendUserRequest::getUserIdList() const {
    return m_user_id_list;
}
void OAIBatchUnsuspendUserRequest::setUserIdList(const QList &user_id_list) {
    m_user_id_list = user_id_list;
    m_user_id_list_isSet = true;
}

bool OAIBatchUnsuspendUserRequest::is_user_id_list_Set() const{
    return m_user_id_list_isSet;
}

bool OAIBatchUnsuspendUserRequest::is_user_id_list_Valid() const{
    return m_user_id_list_isValid;
}

bool OAIBatchUnsuspendUserRequest::isSet() const {
...
bool OAIBatchUnsuspendUserRequest::isValid() const {
