...
OAIUpdateProxySessionResponse::OAIUpdateProxySessionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateProxySessionResponse::OAIUpdateProxySessionResponse() {
    this->initializeModel();
}

OAIUpdateProxySessionResponse::~OAIUpdateProxySessionResponse() {}

void OAIUpdateProxySessionResponse::initializeModel() {

    m_proxy_session_isSet = false;
    m_proxy_session_isValid = false;
}

void OAIUpdateProxySessionResponse::fromJson(QString jsonString) {
...
void OAIUpdateProxySessionResponse::fromJsonObject(QJsonObject json) {

    m_proxy_session_isValid = ::OpenAPI::fromJsonValue(m_proxy_session, json[QString("ProxySession")]);
    m_proxy_session_isSet = !json[QString("ProxySession")].isNull() && m_proxy_session_isValid;
}

QString OAIUpdateProxySessionResponse::asJson() const {
...
QJsonObject OAIUpdateProxySessionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_proxy_session.isSet()) {
        obj.insert(QString("ProxySession"), ::OpenAPI::toJsonValue(m_proxy_session));
    }
    return obj;
}

OAICreateProxySessionResponse_ProxySession OAIUpdateProxySessionResponse::getProxySession() const {
    return m_proxy_session;
}
void OAIUpdateProxySessionResponse::setProxySession(const OAICreateProxySessionResponse_ProxySession &proxy_session) {
    m_proxy_session = proxy_session;
    m_proxy_session_isSet = true;
}

bool OAIUpdateProxySessionResponse::is_proxy_session_Set() const{
    return m_proxy_session_isSet;
}

bool OAIUpdateProxySessionResponse::is_proxy_session_Valid() const{
    return m_proxy_session_isValid;
}

bool OAIUpdateProxySessionResponse::isSet() const {
...
bool OAIUpdateProxySessionResponse::isValid() const {
