...
/*
 * OAIBusinessCallingSettings.h
 *
 * The Amazon Chime Business Calling settings for the administrator&#39;s AWS account. Includes any Amazon S3 buckets designated for storing call detail records.
 */

#ifndef OAIBusinessCallingSettings_H
#define OAIBusinessCallingSettings_H
...
class OAIBusinessCallingSettings : public OAIObject {
public:
    OAIBusinessCallingSettings();
    OAIBusinessCallingSettings(QString json);
    ~OAIBusinessCallingSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusinessCallingSettings)

#endif // OAIBusinessCallingSettings_H
