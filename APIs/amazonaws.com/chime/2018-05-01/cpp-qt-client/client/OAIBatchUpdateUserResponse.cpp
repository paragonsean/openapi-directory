...
OAIBatchUpdateUserResponse::OAIBatchUpdateUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUpdateUserResponse::OAIBatchUpdateUserResponse() {
    this->initializeModel();
}

OAIBatchUpdateUserResponse::~OAIBatchUpdateUserResponse() {}

void OAIBatchUpdateUserResponse::initializeModel() {

    m_user_errors_isSet = false;
    m_user_errors_isValid = false;
}

void OAIBatchUpdateUserResponse::fromJson(QString jsonString) {
...
void OAIBatchUpdateUserResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUpdateUserResponse::asJson() const {
...
QJsonObject OAIBatchUpdateUserResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchUpdateUserResponse::getUserErrors() const {
    return m_user_errors;
}
void OAIBatchUpdateUserResponse::setUserErrors(const QList &user_errors) {
    m_user_errors = user_errors;
    m_user_errors_isSet = true;
}

bool OAIBatchUpdateUserResponse::is_user_errors_Set() const{
    return m_user_errors_isSet;
}

bool OAIBatchUpdateUserResponse::is_user_errors_Valid() const{
    return m_user_errors_isValid;
}

bool OAIBatchUpdateUserResponse::isSet() const {
...
bool OAIBatchUpdateUserResponse::isValid() const {
