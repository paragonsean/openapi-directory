...
/*
 * OAIUpdateVoiceConnectorGroup_request.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnectorGroup_request_H
#define OAIUpdateVoiceConnectorGroup_request_H
...
class OAIUpdateVoiceConnectorGroup_request : public OAIObject {
public:
    OAIUpdateVoiceConnectorGroup_request();
    OAIUpdateVoiceConnectorGroup_request(QString json);
    ~OAIUpdateVoiceConnectorGroup_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnectorGroup_request)

#endif // OAIUpdateVoiceConnectorGroup_request_H
