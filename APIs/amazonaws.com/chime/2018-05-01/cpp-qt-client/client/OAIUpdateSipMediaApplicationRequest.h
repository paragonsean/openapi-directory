...
/*
 * OAIUpdateSipMediaApplicationRequest.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationRequest_H
#define OAIUpdateSipMediaApplicationRequest_H
...
class OAIUpdateSipMediaApplicationRequest : public OAIObject {
public:
    OAIUpdateSipMediaApplicationRequest();
    OAIUpdateSipMediaApplicationRequest(QString json);
    ~OAIUpdateSipMediaApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationRequest)

#endif // OAIUpdateSipMediaApplicationRequest_H
