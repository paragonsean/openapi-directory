...
/*
 * OAIBatchUpdateUser_request.h
 *
 * 
 */

#ifndef OAIBatchUpdateUser_request_H
#define OAIBatchUpdateUser_request_H
...
namespace OpenAPI {
class OAIUpdateUserRequestItem;

class OAIBatchUpdateUser_request : public OAIObject {
public:
    OAIBatchUpdateUser_request();
    OAIBatchUpdateUser_request(QString json);
    ~OAIBatchUpdateUser_request() override;
    ...
    QList<OAIUpdateUserRequestItem> getUpdateUserRequestItems() const;
    void setUpdateUserRequestItems(const QList<OAIUpdateUserRequestItem> &update_user_request_items);
    bool is_update_user_request_items_Set() const;
    bool is_update_user_request_items_Valid() const;
...
private:
    ...
    QList<OAIUpdateUserRequestItem> m_update_user_request_items;
    bool m_update_user_request_items_isSet;
    bool m_update_user_request_items_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdateUser_request)

#endif // OAIBatchUpdateUser_request_H
