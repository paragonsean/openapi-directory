...
/*
 * OAIListAppInstanceAdminsResponse.h
 *
 * 
 */

#ifndef OAIListAppInstanceAdminsResponse_H
#define OAIListAppInstanceAdminsResponse_H
...
class OAIListAppInstanceAdminsResponse : public OAIObject {
public:
    OAIListAppInstanceAdminsResponse();
    OAIListAppInstanceAdminsResponse(QString json);
    ~OAIListAppInstanceAdminsResponse() override;
    ...
    QList getAppInstanceAdmins() const;
    void setAppInstanceAdmins(const QList &app_instance_admins);
    bool is_app_instance_admins_Set() const;
    bool is_app_instance_admins_Valid() const;
...
private:
    ...
    QList m_app_instance_admins;
    bool m_app_instance_admins_isSet;
    bool m_app_instance_admins_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppInstanceAdminsResponse)

#endif // OAIListAppInstanceAdminsResponse_H
