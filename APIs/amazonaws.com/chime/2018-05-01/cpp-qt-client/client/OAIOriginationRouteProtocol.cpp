...
OAIOriginationRouteProtocol::OAIOriginationRouteProtocol(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOriginationRouteProtocol::OAIOriginationRouteProtocol() {
    this->initializeModel();
}

OAIOriginationRouteProtocol::~OAIOriginationRouteProtocol() {}

void OAIOriginationRouteProtocol::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOriginationRouteProtocol::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOriginationRouteProtocol::fromJson(QString jsonString) {
    
    if ( jsonString.compare("TCP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginationRouteProtocol::TCP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UDP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOriginationRouteProtocol::UDP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOriginationRouteProtocol::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOriginationRouteProtocol::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOriginationRouteProtocol::TCP:
            val = "TCP";
            break;
        case eOAIOriginationRouteProtocol::UDP:
            val = "UDP";
            break;
        default:
            break;
...
QJsonValue OAIOriginationRouteProtocol::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOriginationRouteProtocol::eOAIOriginationRouteProtocol OAIOriginationRouteProtocol::getValue() const {
    return m_value;
}

void OAIOriginationRouteProtocol::setValue(const OAIOriginationRouteProtocol::eOAIOriginationRouteProtocol& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOriginationRouteProtocol::isSet() const {
    
    return m_value_isSet;
}

bool OAIOriginationRouteProtocol::isValid() const {
