...
OAIBatchCreateAttendeeResponse::OAIBatchCreateAttendeeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchCreateAttendeeResponse::OAIBatchCreateAttendeeResponse() {
    this->initializeModel();
}

OAIBatchCreateAttendeeResponse::~OAIBatchCreateAttendeeResponse() {}

void OAIBatchCreateAttendeeResponse::initializeModel() {
...
void OAIBatchCreateAttendeeResponse::fromJson(QString jsonString) {
...
void OAIBatchCreateAttendeeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchCreateAttendeeResponse::asJson() const {
...
QJsonObject OAIBatchCreateAttendeeResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchCreateAttendeeResponse::getAttendees() const {
    return m_attendees;
}
void OAIBatchCreateAttendeeResponse::setAttendees(const QList &attendees) {
    m_attendees = attendees;
    m_attendees_isSet = true;
}

bool OAIBatchCreateAttendeeResponse::is_attendees_Set() const{
    return m_attendees_isSet;
}

bool OAIBatchCreateAttendeeResponse::is_attendees_Valid() const{
    return m_attendees_isValid;
}

QList OAIBatchCreateAttendeeResponse::getErrors() const {
    return m_errors;
}
void OAIBatchCreateAttendeeResponse::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIBatchCreateAttendeeResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIBatchCreateAttendeeResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIBatchCreateAttendeeResponse::isSet() const {
...
bool OAIBatchCreateAttendeeResponse::isValid() const {
