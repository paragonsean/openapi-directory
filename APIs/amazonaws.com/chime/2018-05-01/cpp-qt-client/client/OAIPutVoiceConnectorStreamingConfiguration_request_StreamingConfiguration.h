...
/*
 * OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration.h
 *
 * The streaming configuration associated with an Amazon Chime Voice Connector. Specifies whether media streaming is enabled for sending to Amazon Kinesis, and shows the retention period for the Amazon Kinesis data, in hours.
 */

#ifndef OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration_H
#define OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration_H
...
class OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration : public OAIObject {
public:
    OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration();
    OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration(QString json);
    ~OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration() override;
    ...
    QList getStreamingNotificationTargets() const;
    void setStreamingNotificationTargets(const QList &streaming_notification_targets);
    bool is_streaming_notification_targets_Set() const;
    bool is_streaming_notification_targets_Valid() const;
...
private:
    ...
    QList m_streaming_notification_targets;
    bool m_streaming_notification_targets_isSet;
    bool m_streaming_notification_targets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration)

#endif // OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration_H
