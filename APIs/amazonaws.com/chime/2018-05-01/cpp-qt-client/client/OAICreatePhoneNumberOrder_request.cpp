...
OAICreatePhoneNumberOrder_request::OAICreatePhoneNumberOrder_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePhoneNumberOrder_request::OAICreatePhoneNumberOrder_request() {
    this->initializeModel();
}

OAICreatePhoneNumberOrder_request::~OAICreatePhoneNumberOrder_request() {}

void OAICreatePhoneNumberOrder_request::initializeModel() {
...
void OAICreatePhoneNumberOrder_request::fromJson(QString jsonString) {
...
void OAICreatePhoneNumberOrder_request::fromJsonObject(QJsonObject json) {
...
QString OAICreatePhoneNumberOrder_request::asJson() const {
...
QJsonObject OAICreatePhoneNumberOrder_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePhoneNumberOrder_request::getProductType() const {
    return m_product_type;
}
void OAICreatePhoneNumberOrder_request::setProductType(const QString &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAICreatePhoneNumberOrder_request::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAICreatePhoneNumberOrder_request::is_product_type_Valid() const{
    return m_product_type_isValid;
}

QList<QString> OAICreatePhoneNumberOrder_request::getE164PhoneNumbers() const {
    return m_e164_phone_numbers;
}
void OAICreatePhoneNumberOrder_request::setE164PhoneNumbers(const QList<QString> &e164_phone_numbers) {
    m_e164_phone_numbers = e164_phone_numbers;
    m_e164_phone_numbers_isSet = true;
}

bool OAICreatePhoneNumberOrder_request::is_e164_phone_numbers_Set() const{
    return m_e164_phone_numbers_isSet;
}

bool OAICreatePhoneNumberOrder_request::is_e164_phone_numbers_Valid() const{
    return m_e164_phone_numbers_isValid;
}

bool OAICreatePhoneNumberOrder_request::isSet() const {
...
bool OAICreatePhoneNumberOrder_request::isValid() const {
