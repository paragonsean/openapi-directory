...
#include "OAIAssociatePhoneNumberWithUserRequest.h"
...
OAIAssociatePhoneNumberWithUserRequest::OAIAssociatePhoneNumberWithUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociatePhoneNumberWithUserRequest::OAIAssociatePhoneNumberWithUserRequest() {
    this->initializeModel();
}

OAIAssociatePhoneNumberWithUserRequest::~OAIAssociatePhoneNumberWithUserRequest() {}

void OAIAssociatePhoneNumberWithUserRequest::initializeModel() {

    m_e164_phone_number_isSet = false;
    m_e164_phone_number_isValid = false;
}

void OAIAssociatePhoneNumberWithUserRequest::fromJson(QString jsonString) {
...
void OAIAssociatePhoneNumberWithUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociatePhoneNumberWithUserRequest::asJson() const {
...
QJsonObject OAIAssociatePhoneNumberWithUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociatePhoneNumberWithUserRequest::getE164PhoneNumber() const {
    return m_e164_phone_number;
}
void OAIAssociatePhoneNumberWithUserRequest::setE164PhoneNumber(const QString &e164_phone_number) {
    m_e164_phone_number = e164_phone_number;
    m_e164_phone_number_isSet = true;
}

bool OAIAssociatePhoneNumberWithUserRequest::is_e164_phone_number_Set() const{
    return m_e164_phone_number_isSet;
}

bool OAIAssociatePhoneNumberWithUserRequest::is_e164_phone_number_Valid() const{
    return m_e164_phone_number_isValid;
}

bool OAIAssociatePhoneNumberWithUserRequest::isSet() const {
...
bool OAIAssociatePhoneNumberWithUserRequest::isValid() const {
