...
void OAIParticipant::initializeModel() {
    ...
    m_proxy_phone_number_isSet = false;
    m_proxy_phone_number_isValid = false;
}
...
void OAIParticipant::fromJsonObject(QJsonObject json) {
    ...
    m_proxy_phone_number_isValid = ::OpenAPI::fromJsonValue(m_proxy_phone_number, json[QString("ProxyPhoneNumber")]);
    m_proxy_phone_number_isSet = !json[QString("ProxyPhoneNumber")].isNull() && m_proxy_phone_number_isValid;
}
...
QJsonObject OAIParticipant::asJsonObject() const {
    ...
    if (m_proxy_phone_number_isSet) {
        obj.insert(QString("ProxyPhoneNumber"), ::OpenAPI::toJsonValue(m_proxy_phone_number));
    }
    return obj;
}

QString OAIParticipant::getPhoneNumber() const {
    return m_phone_number;
}
void OAIParticipant::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIParticipant::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIParticipant::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

QString OAIParticipant::getProxyPhoneNumber() const {
    return m_proxy_phone_number;
}
void OAIParticipant::setProxyPhoneNumber(const QString &proxy_phone_number) {
    m_proxy_phone_number = proxy_phone_number;
    m_proxy_phone_number_isSet = true;
}

bool OAIParticipant::is_proxy_phone_number_Set() const{
    return m_proxy_phone_number_isSet;
}

bool OAIParticipant::is_proxy_phone_number_Valid() const{
    return m_proxy_phone_number_isValid;
}
