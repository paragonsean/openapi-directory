...
#include "OAIUpdateAppInstanceRequest.h"
...
OAIUpdateAppInstanceRequest::OAIUpdateAppInstanceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAppInstanceRequest::OAIUpdateAppInstanceRequest() {
    this->initializeModel();
}

OAIUpdateAppInstanceRequest::~OAIUpdateAppInstanceRequest() {}

void OAIUpdateAppInstanceRequest::initializeModel() {
...
void OAIUpdateAppInstanceRequest::fromJson(QString jsonString) {
...
void OAIUpdateAppInstanceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAppInstanceRequest::asJson() const {
...
QJsonObject OAIUpdateAppInstanceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateAppInstanceRequest::getName() const {
    return m_name;
}
void OAIUpdateAppInstanceRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAppInstanceRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAppInstanceRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateAppInstanceRequest::getMetadata() const {
    return m_metadata;
}
void OAIUpdateAppInstanceRequest::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateAppInstanceRequest::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateAppInstanceRequest::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIUpdateAppInstanceRequest::isSet() const {
...
bool OAIUpdateAppInstanceRequest::isValid() const {
