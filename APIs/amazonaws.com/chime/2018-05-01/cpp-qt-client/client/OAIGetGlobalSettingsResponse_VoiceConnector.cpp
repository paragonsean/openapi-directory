...
OAIGetGlobalSettingsResponse_VoiceConnector::OAIGetGlobalSettingsResponse_VoiceConnector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGlobalSettingsResponse_VoiceConnector::OAIGetGlobalSettingsResponse_VoiceConnector() {
    this->initializeModel();
}

OAIGetGlobalSettingsResponse_VoiceConnector::~OAIGetGlobalSettingsResponse_VoiceConnector() {}

void OAIGetGlobalSettingsResponse_VoiceConnector::initializeModel() {

    m_cdr_bucket_isSet = false;
    m_cdr_bucket_isValid = false;
}

void OAIGetGlobalSettingsResponse_VoiceConnector::fromJson(QString jsonString) {
...
void OAIGetGlobalSettingsResponse_VoiceConnector::fromJsonObject(QJsonObject json) {
...
QString OAIGetGlobalSettingsResponse_VoiceConnector::asJson() const {
...
QJsonObject OAIGetGlobalSettingsResponse_VoiceConnector::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGlobalSettingsResponse_VoiceConnector::getCdrBucket() const {
    return m_cdr_bucket;
}
void OAIGetGlobalSettingsResponse_VoiceConnector::setCdrBucket(const QString &cdr_bucket) {
    m_cdr_bucket = cdr_bucket;
    m_cdr_bucket_isSet = true;
}

bool OAIGetGlobalSettingsResponse_VoiceConnector::is_cdr_bucket_Set() const{
    return m_cdr_bucket_isSet;
}

bool OAIGetGlobalSettingsResponse_VoiceConnector::is_cdr_bucket_Valid() const{
    return m_cdr_bucket_isValid;
}

bool OAIGetGlobalSettingsResponse_VoiceConnector::isSet() const {
...
bool OAIGetGlobalSettingsResponse_VoiceConnector::isValid() const {
