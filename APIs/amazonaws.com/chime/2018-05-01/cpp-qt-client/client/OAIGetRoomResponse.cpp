...
OAICreateRoomResponse_Room OAIGetRoomResponse::getRoom() const {
    return m_room;
}
void OAIGetRoomResponse::setRoom(const OAICreateRoomResponse_Room &room) {
    m_room = room;
    m_room_isSet = true;
}

bool OAIGetRoomResponse::is_room_Set() const{
    return m_room_isSet;
}

bool OAIGetRoomResponse::is_room_Valid() const{
