...
OAIUpdatePhoneNumberSettings_request::OAIUpdatePhoneNumberSettings_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhoneNumberSettings_request::OAIUpdatePhoneNumberSettings_request() {
    this->initializeModel();
}

OAIUpdatePhoneNumberSettings_request::~OAIUpdatePhoneNumberSettings_request() {}

void OAIUpdatePhoneNumberSettings_request::initializeModel() {

    m_calling_name_isSet = false;
    m_calling_name_isValid = false;
}

void OAIUpdatePhoneNumberSettings_request::fromJson(QString jsonString) {
...
void OAIUpdatePhoneNumberSettings_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePhoneNumberSettings_request::asJson() const {
...
QJsonObject OAIUpdatePhoneNumberSettings_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePhoneNumberSettings_request::getCallingName() const {
    return m_calling_name;
}
void OAIUpdatePhoneNumberSettings_request::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIUpdatePhoneNumberSettings_request::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIUpdatePhoneNumberSettings_request::is_calling_name_Valid() const{
    return m_calling_name_isValid;
}

bool OAIUpdatePhoneNumberSettings_request::isSet() const {
...
bool OAIUpdatePhoneNumberSettings_request::isValid() const {
