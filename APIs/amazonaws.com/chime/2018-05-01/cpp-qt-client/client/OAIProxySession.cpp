...
OAIProxySession::OAIProxySession(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProxySession::OAIProxySession() {
    this->initializeModel();
}

OAIProxySession::~OAIProxySession() {}

void OAIProxySession::initializeModel() {
...
void OAIProxySession::fromJson(QString jsonString) {
...
void OAIProxySession::fromJsonObject(QJsonObject json) {
...
QString OAIProxySession::asJson() const {
...
QJsonObject OAIProxySession::asJsonObject() const {
    QJsonObject obj;
...
QString OAIProxySession::getVoiceConnectorId() const {
    return m_voice_connector_id;
}
void OAIProxySession::setVoiceConnectorId(const QString &voice_connector_id) {
    m_voice_connector_id = voice_connector_id;
    m_voice_connector_id_isSet = true;
}

bool OAIProxySession::is_voice_connector_id_Set() const{
    return m_voice_connector_id_isSet;
}

bool OAIProxySession::is_voice_connector_id_Valid() const{
    return m_voice_connector_id_isValid;
}

QString OAIProxySession::getProxySessionId() const {
    return m_proxy_session_id;
}
void OAIProxySession::setProxySessionId(const QString &proxy_session_id) {
    m_proxy_session_id = proxy_session_id;
    m_proxy_session_id_isSet = true;
}

bool OAIProxySession::is_proxy_session_id_Set() const{
    return m_proxy_session_id_isSet;
}

bool OAIProxySession::is_proxy_session_id_Valid() const{
    return m_proxy_session_id_isValid;
}

QString OAIProxySession::getName() const {
    return m_name;
}
void OAIProxySession::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProxySession::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProxySession::is_name_Valid() const{
    return m_name_isValid;
}

OAIProxySessionStatus OAIProxySession::getStatus() const {
    return m_status;
}
void OAIProxySession::setStatus(const OAIProxySessionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIProxySession::is_status_Set() const{
    return m_status_isSet;
}

bool OAIProxySession::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIProxySession::getExpiryMinutes() const {
    return m_expiry_minutes;
}
void OAIProxySession::setExpiryMinutes(const qint32 &expiry_minutes) {
    m_expiry_minutes = expiry_minutes;
    m_expiry_minutes_isSet = true;
}

bool OAIProxySession::is_expiry_minutes_Set() const{
    return m_expiry_minutes_isSet;
}

bool OAIProxySession::is_expiry_minutes_Valid() const{
    return m_expiry_minutes_isValid;
}

QList OAIProxySession::getCapabilities() const {
    return m_capabilities;
}
void OAIProxySession::setCapabilities(const QList &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIProxySession::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIProxySession::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QDateTime OAIProxySession::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIProxySession::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIProxySession::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIProxySession::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIProxySession::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIProxySession::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIProxySession::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIProxySession::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QDateTime OAIProxySession::getEndedTimestamp() const {
    return m_ended_timestamp;
}
void OAIProxySession::setEndedTimestamp(const QDateTime &ended_timestamp) {
    m_ended_timestamp = ended_timestamp;
    m_ended_timestamp_isSet = true;
}

bool OAIProxySession::is_ended_timestamp_Set() const{
    return m_ended_timestamp_isSet;
}

bool OAIProxySession::is_ended_timestamp_Valid() const{
    return m_ended_timestamp_isValid;
}

QList OAIProxySession::getParticipants() const {
    return m_participants;
}
void OAIProxySession::setParticipants(const QList &participants) {
    m_participants = participants;
    m_participants_isSet = true;
}

bool OAIProxySession::is_participants_Set() const{
    return m_participants_isSet;
}

bool OAIProxySession::is_participants_Valid() const{
    return m_participants_isValid;
}

OAINumberSelectionBehavior OAIProxySession::getNumberSelectionBehavior() const {
    return m_number_selection_behavior;
}
void OAIProxySession::setNumberSelectionBehavior(const OAINumberSelectionBehavior &number_selection_behavior) {
    m_number_selection_behavior = number_selection_behavior;
    m_number_selection_behavior_isSet = true;
}

bool OAIProxySession::is_number_selection_behavior_Set() const{
    return m_number_selection_behavior_isSet;
}

bool OAIProxySession::is_number_selection_behavior_Valid() const{
    return m_number_selection_behavior_isValid;
}

OAIGeoMatchLevel OAIProxySession::getGeoMatchLevel() const {
    return m_geo_match_level;
}
void OAIProxySession::setGeoMatchLevel(const OAIGeoMatchLevel &geo_match_level) {
    m_geo_match_level = geo_match_level;
    m_geo_match_level_isSet = true;
}

bool OAIProxySession::is_geo_match_level_Set() const{
    return m_geo_match_level_isSet;
}

bool OAIProxySession::is_geo_match_level_Valid() const{
    return m_geo_match_level_isValid;
}

OAICreateProxySessionRequest_GeoMatchParams OAIProxySession::getGeoMatchParams() const {
    return m_geo_match_params;
}
void OAIProxySession::setGeoMatchParams(const OAICreateProxySessionRequest_GeoMatchParams &geo_match_params) {
    m_geo_match_params = geo_match_params;
    m_geo_match_params_isSet = true;
}

bool OAIProxySession::is_geo_match_params_Set() const{
    return m_geo_match_params_isSet;
}

bool OAIProxySession::is_geo_match_params_Valid() const{
    return m_geo_match_params_isValid;
}

bool OAIProxySession::isSet() const {
...
bool OAIProxySession::isValid() const {
