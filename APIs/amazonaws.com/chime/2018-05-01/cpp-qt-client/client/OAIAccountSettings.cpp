...
bool OAIAccountSettings::getDisableRemoteControl() const {
    return m_disable_remote_control;
}
void OAIAccountSettings::setDisableRemoteControl(const bool &disable_remote_control) {
    m_disable_remote_control = disable_remote_control;
    m_disable_remote_control_isSet = true;
}

bool OAIAccountSettings::is_disable_remote_control_Set() const{
    return m_disable_remote_control_isSet;
}

bool OAIAccountSettings::is_disable_remote_control_Valid() const{
    return m_disable_remote_control_isValid;
}

bool OAIAccountSettings::getEnableDialOut() const {
    return m_enable_dial_out;
}
void OAIAccountSettings::setEnableDialOut(const bool &enable_dial_out) {
    m_enable_dial_out = enable_dial_out;
    m_enable_dial_out_isSet = true;
}

bool OAIAccountSettings::is_enable_dial_out_Set() const{
    return m_enable_dial_out_isSet;
}

bool OAIAccountSettings::is_enable_dial_out_Valid() const{
