...
OAIPutVoiceConnectorTerminationResponse::OAIPutVoiceConnectorTerminationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorTerminationResponse::OAIPutVoiceConnectorTerminationResponse() {
    this->initializeModel();
}

OAIPutVoiceConnectorTerminationResponse::~OAIPutVoiceConnectorTerminationResponse() {}

void OAIPutVoiceConnectorTerminationResponse::initializeModel() {

    m_termination_isSet = false;
    m_termination_isValid = false;
}

void OAIPutVoiceConnectorTerminationResponse::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorTerminationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorTerminationResponse::asJson() const {
...
QJsonObject OAIPutVoiceConnectorTerminationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorTerminationResponse_Termination OAIPutVoiceConnectorTerminationResponse::getTermination() const {
    return m_termination;
}
void OAIPutVoiceConnectorTerminationResponse::setTermination(const OAIPutVoiceConnectorTerminationResponse_Termination &termination) {
    m_termination = termination;
    m_termination_isSet = true;
}

bool OAIPutVoiceConnectorTerminationResponse::is_termination_Set() const{
    return m_termination_isSet;
}

bool OAIPutVoiceConnectorTerminationResponse::is_termination_Valid() const{
    return m_termination_isValid;
}

bool OAIPutVoiceConnectorTerminationResponse::isSet() const {
...
bool OAIPutVoiceConnectorTerminationResponse::isValid() const {
