...
/*
 * OAIPutAppInstanceStreamingConfigurations_request.h
 *
 * 
 */

#ifndef OAIPutAppInstanceStreamingConfigurations_request_H
#define OAIPutAppInstanceStreamingConfigurations_request_H

#include <QJsonObject>

#include "OAIAppInstanceStreamingConfiguration.h"
#include <QList>
...
namespace OpenAPI {
class OAIAppInstanceStreamingConfiguration;

class OAIPutAppInstanceStreamingConfigurations_request : public OAIObject {
public:
    OAIPutAppInstanceStreamingConfigurations_request();
    OAIPutAppInstanceStreamingConfigurations_request(QString json);
    ~OAIPutAppInstanceStreamingConfigurations_request() override;
    ...
    QList<OAIAppInstanceStreamingConfiguration> getAppInstanceStreamingConfigurations() const;
    void setAppInstanceStreamingConfigurations(const QList<OAIAppInstanceStreamingConfiguration> &app_instance_streaming_configurations);
...
private:
    ...
    QList<OAIAppInstanceStreamingConfiguration> m_app_instance_streaming_configurations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutAppInstanceStreamingConfigurations_request)

#endif // OAIPutAppInstanceStreamingConfigurations_request_H
