...
/*
 * OAIUpdateSipMediaApplicationResponse_SipMediaApplication.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationResponse_SipMediaApplication_H
#define OAIUpdateSipMediaApplicationResponse_SipMediaApplication_H
...
class OAIUpdateSipMediaApplicationResponse_SipMediaApplication : public OAIObject {
public:
    OAIUpdateSipMediaApplicationResponse_SipMediaApplication();
    OAIUpdateSipMediaApplicationResponse_SipMediaApplication(QString json);
    ~OAIUpdateSipMediaApplicationResponse_SipMediaApplication() override;
    ...
    QString getSipMediaApplicationId() const;
    void setSipMediaApplicationId(const QString &sip_media_application_id);
    bool is_sip_media_application_id_Set() const;
    bool is_sip_media_application_id_Valid() const;
...
private:
    ...
    QString m_sip_media_application_id;
    bool m_sip_media_application_id_isSet;
    bool m_sip_media_application_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationResponse_SipMediaApplication)

#endif // OAIUpdateSipMediaApplicationResponse_SipMediaApplication_H
