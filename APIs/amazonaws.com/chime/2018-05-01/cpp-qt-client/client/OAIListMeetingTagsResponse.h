...
/*
 * OAIListMeetingTagsResponse.h
 *
 * 
 */

#ifndef OAIListMeetingTagsResponse_H
#define OAIListMeetingTagsResponse_H
...
class OAIListMeetingTagsResponse : public OAIObject {
public:
    OAIListMeetingTagsResponse();
    OAIListMeetingTagsResponse(QString json);
    ~OAIListMeetingTagsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMeetingTagsResponse)

#endif // OAIListMeetingTagsResponse_H
