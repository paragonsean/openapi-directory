...
/*
 * OAIUpdateAccountSettingsRequest.h
 *
 * 
 */

#ifndef OAIUpdateAccountSettingsRequest_H
#define OAIUpdateAccountSettingsRequest_H
...
namespace OpenAPI {
class OAIUpdateAccountSettingsRequest_AccountSettings;

class OAIUpdateAccountSettingsRequest : public OAIObject {
public:
    OAIUpdateAccountSettingsRequest();
    OAIUpdateAccountSettingsRequest(QString json);
    ~OAIUpdateAccountSettingsRequest() override;
    ...
    OAIUpdateAccountSettingsRequest_AccountSettings getAccountSettings() const;
    void setAccountSettings(const OAIUpdateAccountSettingsRequest_AccountSettings &account_settings);
...
private:
    ...
    OAIUpdateAccountSettingsRequest_AccountSettings m_account_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountSettingsRequest)

#endif // OAIUpdateAccountSettingsRequest_H
