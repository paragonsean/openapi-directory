...
/*
 * OAIPutVoiceConnectorEmergencyCallingConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorEmergencyCallingConfiguration_request_H
#define OAIPutVoiceConnectorEmergencyCallingConfiguration_request_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration;

class OAIPutVoiceConnectorEmergencyCallingConfiguration_request : public OAIObject {
public:
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request();
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request(QString json);
    ~OAIPutVoiceConnectorEmergencyCallingConfiguration_request() override;
    ...
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration getEmergencyCallingConfiguration() const;
    void setEmergencyCallingConfiguration(const OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration &emergency_calling_configuration);
...
private:
    ...
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration m_emergency_calling_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorEmergencyCallingConfiguration_request)

#endif // OAIPutVoiceConnectorEmergencyCallingConfiguration_request_H
