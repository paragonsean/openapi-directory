...
void OAIAccountType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Team", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountType::TEAM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EnterpriseDirectory", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountType::ENTERPRISEDIRECTORY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EnterpriseLWA", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountType::ENTERPRISELWA;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EnterpriseOIDC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountType::ENTERPRISEOIDC;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAccountType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAccountType::TEAM:
            val = "Team";
            break;
        case eOAIAccountType::ENTERPRISEDIRECTORY:
            val = "EnterpriseDirectory";
            break;
        case eOAIAccountType::ENTERPRISELWA:
            val = "EnterpriseLWA";
            break;
        case eOAIAccountType::ENTERPRISEOIDC:
            val = "EnterpriseOIDC";
            break;
        default:
            break;
