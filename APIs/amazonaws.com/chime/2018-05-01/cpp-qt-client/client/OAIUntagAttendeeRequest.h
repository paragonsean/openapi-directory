...
/*
 * OAIUntagAttendeeRequest.h
 *
 * 
 */

#ifndef OAIUntagAttendeeRequest_H
#define OAIUntagAttendeeRequest_H
...
class OAIUntagAttendeeRequest : public OAIObject {
public:
    OAIUntagAttendeeRequest();
    OAIUntagAttendeeRequest(QString json);
    ~OAIUntagAttendeeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagAttendeeRequest)

#endif // OAIUntagAttendeeRequest_H
