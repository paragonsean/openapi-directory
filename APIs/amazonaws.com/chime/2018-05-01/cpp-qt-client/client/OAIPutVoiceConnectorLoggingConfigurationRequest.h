...
/*
 * OAIPutVoiceConnectorLoggingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorLoggingConfigurationRequest_H
#define OAIPutVoiceConnectorLoggingConfigurationRequest_H

#include <QJsonObject>

#include "OAIPutVoiceConnectorLoggingConfigurationRequest_LoggingConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutVoiceConnectorLoggingConfigurationRequest_LoggingConfiguration;

class OAIPutVoiceConnectorLoggingConfigurationRequest : public OAIObject {
public:
    OAIPutVoiceConnectorLoggingConfigurationRequest();
    OAIPutVoiceConnectorLoggingConfigurationRequest(QString json);
    ~OAIPutVoiceConnectorLoggingConfigurationRequest() override;
    ...
    OAIPutVoiceConnectorLoggingConfigurationRequest_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIPutVoiceConnectorLoggingConfigurationRequest_LoggingConfiguration &logging_configuration);
...
private:
    ...
    OAIPutVoiceConnectorLoggingConfigurationRequest_LoggingConfiguration m_logging_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorLoggingConfigurationRequest)

#endif // OAIPutVoiceConnectorLoggingConfigurationRequest_H
