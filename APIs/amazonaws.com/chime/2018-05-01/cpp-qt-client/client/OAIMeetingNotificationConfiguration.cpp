...
#include "OAIMeetingNotificationConfiguration.h"
...
OAIMeetingNotificationConfiguration::OAIMeetingNotificationConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMeetingNotificationConfiguration::OAIMeetingNotificationConfiguration() {
    this->initializeModel();
}

OAIMeetingNotificationConfiguration::~OAIMeetingNotificationConfiguration() {}

void OAIMeetingNotificationConfiguration::initializeModel() {
...
void OAIMeetingNotificationConfiguration::fromJson(QString jsonString) {
...
void OAIMeetingNotificationConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIMeetingNotificationConfiguration::asJson() const {
...
QJsonObject OAIMeetingNotificationConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMeetingNotificationConfiguration::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIMeetingNotificationConfiguration::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIMeetingNotificationConfiguration::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIMeetingNotificationConfiguration::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QString OAIMeetingNotificationConfiguration::getSqsQueueArn() const {
    return m_sqs_queue_arn;
}
void OAIMeetingNotificationConfiguration::setSqsQueueArn(const QString &sqs_queue_arn) {
    m_sqs_queue_arn = sqs_queue_arn;
    m_sqs_queue_arn_isSet = true;
}

bool OAIMeetingNotificationConfiguration::is_sqs_queue_arn_Set() const{
    return m_sqs_queue_arn_isSet;
}

bool OAIMeetingNotificationConfiguration::is_sqs_queue_arn_Valid() const{
    return m_sqs_queue_arn_isValid;
}

bool OAIMeetingNotificationConfiguration::isSet() const {
...
bool OAIMeetingNotificationConfiguration::isValid() const {
