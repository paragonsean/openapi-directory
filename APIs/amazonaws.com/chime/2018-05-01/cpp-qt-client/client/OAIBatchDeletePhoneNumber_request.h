...
/*
 * OAIBatchDeletePhoneNumber_request.h
 *
 * 
 */

#ifndef OAIBatchDeletePhoneNumber_request_H
#define OAIBatchDeletePhoneNumber_request_H
...
class OAIBatchDeletePhoneNumber_request : public OAIObject {
public:
    OAIBatchDeletePhoneNumber_request();
    OAIBatchDeletePhoneNumber_request(QString json);
    ~OAIBatchDeletePhoneNumber_request() override;
    ...
    QList<QString> getPhoneNumberIds() const;
    void setPhoneNumberIds(const QList<QString> &phone_number_ids);
    bool is_phone_number_ids_Set() const;
    bool is_phone_number_ids_Valid() const;
...
private:
    ...
    QList<QString> m_phone_number_ids;
    bool m_phone_number_ids_isSet;
    bool m_phone_number_ids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeletePhoneNumber_request)

#endif // OAIBatchDeletePhoneNumber_request_H
