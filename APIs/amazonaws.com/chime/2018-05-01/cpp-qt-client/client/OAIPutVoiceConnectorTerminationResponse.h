...
/*
 * OAIPutVoiceConnectorTerminationResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorTerminationResponse_H
#define OAIPutVoiceConnectorTerminationResponse_H

#include <QJsonObject>

#include "OAIPutVoiceConnectorTerminationResponse_Termination.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutVoiceConnectorTerminationResponse_Termination;

class OAIPutVoiceConnectorTerminationResponse : public OAIObject {
public:
    OAIPutVoiceConnectorTerminationResponse();
    OAIPutVoiceConnectorTerminationResponse(QString json);
    ~OAIPutVoiceConnectorTerminationResponse() override;
    ...
    OAIPutVoiceConnectorTerminationResponse_Termination getTermination() const;
    void setTermination(const OAIPutVoiceConnectorTerminationResponse_Termination &termination);
...
private:
    ...
    OAIPutVoiceConnectorTerminationResponse_Termination m_termination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorTerminationResponse)

#endif // OAIPutVoiceConnectorTerminationResponse_H
