...
OAIGetRetentionSettingsResponse::OAIGetRetentionSettingsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRetentionSettingsResponse::OAIGetRetentionSettingsResponse() {
    this->initializeModel();
}

OAIGetRetentionSettingsResponse::~OAIGetRetentionSettingsResponse() {}

void OAIGetRetentionSettingsResponse::initializeModel() {

    m_retention_settings_isSet = false;
    m_retention_settings_isValid = false;

    m_initiate_deletion_timestamp_isSet = false;
    m_initiate_deletion_timestamp_isValid = false;
}

void OAIGetRetentionSettingsResponse::fromJson(QString jsonString) {
...
void OAIGetRetentionSettingsResponse::fromJsonObject(QJsonObject json) {

    m_retention_settings_isValid = ::OpenAPI::fromJsonValue(m_retention_settings, json[QString("RetentionSettings")]);
    m_retention_settings_isSet = !json[QString("RetentionSettings")].isNull() && m_retention_settings_isValid;
...
QString OAIGetRetentionSettingsResponse::asJson() const {
...
QJsonObject OAIGetRetentionSettingsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_retention_settings.isSet()) {
        obj.insert(QString("RetentionSettings"), ::OpenAPI::toJsonValue(m_retention_settings));
    }
...
OAIGetRetentionSettingsResponse_RetentionSettings OAIGetRetentionSettingsResponse::getRetentionSettings() const {
    return m_retention_settings;
}
void OAIGetRetentionSettingsResponse::setRetentionSettings(const OAIGetRetentionSettingsResponse_RetentionSettings &retention_settings) {
    m_retention_settings = retention_settings;
    m_retention_settings_isSet = true;
}

bool OAIGetRetentionSettingsResponse::is_retention_settings_Set() const{
    return m_retention_settings_isSet;
}

bool OAIGetRetentionSettingsResponse::is_retention_settings_Valid() const{
    return m_retention_settings_isValid;
}

QDateTime OAIGetRetentionSettingsResponse::getInitiateDeletionTimestamp() const {
    return m_initiate_deletion_timestamp;
}
void OAIGetRetentionSettingsResponse::setInitiateDeletionTimestamp(const QDateTime &initiate_deletion_timestamp) {
    m_initiate_deletion_timestamp = initiate_deletion_timestamp;
    m_initiate_deletion_timestamp_isSet = true;
}

bool OAIGetRetentionSettingsResponse::is_initiate_deletion_timestamp_Set() const{
    return m_initiate_deletion_timestamp_isSet;
}

bool OAIGetRetentionSettingsResponse::is_initiate_deletion_timestamp_Valid() const{
    return m_initiate_deletion_timestamp_isValid;
}

bool OAIGetRetentionSettingsResponse::isSet() const {
...
bool OAIGetRetentionSettingsResponse::isValid() const {
