...
/*
 * OAIUpdateSipMediaApplicationCallRequest.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationCallRequest_H
#define OAIUpdateSipMediaApplicationCallRequest_H
...
class OAIUpdateSipMediaApplicationCallRequest : public OAIObject {
public:
    OAIUpdateSipMediaApplicationCallRequest();
    OAIUpdateSipMediaApplicationCallRequest(QString json);
    ~OAIUpdateSipMediaApplicationCallRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationCallRequest)

#endif // OAIUpdateSipMediaApplicationCallRequest_H
