...
QString OAICreateAccountRequest::getName() const {
    return m_name;
}
void OAICreateAccountRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateAccountRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateAccountRequest::is_name_Valid() const{
