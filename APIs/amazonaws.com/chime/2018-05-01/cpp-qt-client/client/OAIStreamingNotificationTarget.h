...
/*
 * OAIStreamingNotificationTarget.h
 *
 * The targeted recipient for a streaming configuration notification.
 */

#ifndef OAIStreamingNotificationTarget_H
#define OAIStreamingNotificationTarget_H
...
class OAIStreamingNotificationTarget : public OAIObject {
public:
    OAIStreamingNotificationTarget();
    OAIStreamingNotificationTarget(QString json);
    ~OAIStreamingNotificationTarget() override;
    ...
    OAINotificationTarget getNotificationTarget() const;
    void setNotificationTarget(const OAINotificationTarget &notification_target);
...
private:
    ...
    OAINotificationTarget m_notification_target;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamingNotificationTarget)

#endif // OAIStreamingNotificationTarget_H
