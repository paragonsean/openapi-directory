...
#include "OAIDeleteVoiceConnectorTerminationCredentialsRequest.h"
...
OAIDeleteVoiceConnectorTerminationCredentialsRequest::OAIDeleteVoiceConnectorTerminationCredentialsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVoiceConnectorTerminationCredentialsRequest::OAIDeleteVoiceConnectorTerminationCredentialsRequest() {
    this->initializeModel();
}

OAIDeleteVoiceConnectorTerminationCredentialsRequest::~OAIDeleteVoiceConnectorTerminationCredentialsRequest() {}

void OAIDeleteVoiceConnectorTerminationCredentialsRequest::initializeModel() {

    m_usernames_isSet = false;
    m_usernames_isValid = false;
}

void OAIDeleteVoiceConnectorTerminationCredentialsRequest::fromJson(QString jsonString) {
...
void OAIDeleteVoiceConnectorTerminationCredentialsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVoiceConnectorTerminationCredentialsRequest::asJson() const {
...
QJsonObject OAIDeleteVoiceConnectorTerminationCredentialsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_usernames.isSet()) {
        obj.insert(QString("Usernames"), ::OpenAPI::toJsonValue(m_usernames));
    }
    return obj;
}

QList OAIDeleteVoiceConnectorTerminationCredentialsRequest::getUsernames() const {
    return m_usernames;
}
void OAIDeleteVoiceConnectorTerminationCredentialsRequest::setUsernames(const QList &usernames) {
    m_usernames = usernames;
    m_usernames_isSet = true;
}

bool OAIDeleteVoiceConnectorTerminationCredentialsRequest::is_usernames_Set() const{
    return m_usernames_isSet;
}

bool OAIDeleteVoiceConnectorTerminationCredentialsRequest::is_usernames_Valid() const{
    return m_usernames_isValid;
}

bool OAIDeleteVoiceConnectorTerminationCredentialsRequest::isSet() const {
...
bool OAIDeleteVoiceConnectorTerminationCredentialsRequest::isValid() const {
