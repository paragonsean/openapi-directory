...
OAICreateAccountResponse_Account OAIGetAccountResponse::getAccount() const {
    return m_account;
}
void OAIGetAccountResponse::setAccount(const OAICreateAccountResponse_Account &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIGetAccountResponse::is_account_Set() const{
    return m_account_isSet;
}

bool OAIGetAccountResponse::is_account_Valid() const{
