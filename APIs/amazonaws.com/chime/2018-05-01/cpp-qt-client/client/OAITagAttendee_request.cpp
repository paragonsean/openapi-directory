...
OAITagAttendee_request::OAITagAttendee_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagAttendee_request::OAITagAttendee_request() {
    this->initializeModel();
}

OAITagAttendee_request::~OAITagAttendee_request() {}

void OAITagAttendee_request::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagAttendee_request::fromJson(QString jsonString) {
...
void OAITagAttendee_request::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagAttendee_request::asJson() const {
...
QJsonObject OAITagAttendee_request::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.size() > 0) {
...
QList<OAITag> OAITagAttendee_request::getTags() const {
    return m_tags;
}
void OAITagAttendee_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagAttendee_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagAttendee_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagAttendee_request::isSet() const {
...
bool OAITagAttendee_request::isValid() const {
