...
/*
 * OAIUpdateSipRule_request.h
 *
 * 
 */

#ifndef OAIUpdateSipRule_request_H
#define OAIUpdateSipRule_request_H
...
namespace OpenAPI {
class OAISipRuleTargetApplication;

class OAIUpdateSipRule_request : public OAIObject {
public:
    OAIUpdateSipRule_request();
    OAIUpdateSipRule_request(QString json);
    ~OAIUpdateSipRule_request() override;
    ...
    QList<OAISipRuleTargetApplication> getTargetApplications() const;
    void setTargetApplications(const QList<OAISipRuleTargetApplication> &target_applications);
...
private:
    ...
    QList<OAISipRuleTargetApplication> m_target_applications;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipRule_request)

#endif // OAIUpdateSipRule_request_H
