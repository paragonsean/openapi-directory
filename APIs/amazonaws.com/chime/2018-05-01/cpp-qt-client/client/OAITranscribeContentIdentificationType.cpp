...
OAITranscribeContentIdentificationType::OAITranscribeContentIdentificationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeContentIdentificationType::OAITranscribeContentIdentificationType() {
    this->initializeModel();
}

OAITranscribeContentIdentificationType::~OAITranscribeContentIdentificationType() {}

void OAITranscribeContentIdentificationType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeContentIdentificationType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeContentIdentificationType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PII", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeContentIdentificationType::PII;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeContentIdentificationType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeContentIdentificationType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeContentIdentificationType::PII:
            val = "PII";
            break;
        default:
            break;
...
QJsonValue OAITranscribeContentIdentificationType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeContentIdentificationType::eOAITranscribeContentIdentificationType OAITranscribeContentIdentificationType::getValue() const {
    return m_value;
}

void OAITranscribeContentIdentificationType::setValue(const OAITranscribeContentIdentificationType::eOAITranscribeContentIdentificationType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeContentIdentificationType::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeContentIdentificationType::isValid() const {
