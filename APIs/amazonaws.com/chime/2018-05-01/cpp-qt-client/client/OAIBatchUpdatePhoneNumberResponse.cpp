...
OAIBatchUpdatePhoneNumberResponse::OAIBatchUpdatePhoneNumberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUpdatePhoneNumberResponse::OAIBatchUpdatePhoneNumberResponse() {
    this->initializeModel();
}

OAIBatchUpdatePhoneNumberResponse::~OAIBatchUpdatePhoneNumberResponse() {}

void OAIBatchUpdatePhoneNumberResponse::initializeModel() {

    m_phone_number_errors_isSet = false;
    m_phone_number_errors_isValid = false;
}

void OAIBatchUpdatePhoneNumberResponse::fromJson(QString jsonString) {
...
void OAIBatchUpdatePhoneNumberResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUpdatePhoneNumberResponse::asJson() const {
...
QJsonObject OAIBatchUpdatePhoneNumberResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchUpdatePhoneNumberResponse::getPhoneNumberErrors() const {
    return m_phone_number_errors;
}
void OAIBatchUpdatePhoneNumberResponse::setPhoneNumberErrors(const QList &phone_number_errors) {
    m_phone_number_errors = phone_number_errors;
    m_phone_number_errors_isSet = true;
}

bool OAIBatchUpdatePhoneNumberResponse::is_phone_number_errors_Set() const{
    return m_phone_number_errors_isSet;
}

bool OAIBatchUpdatePhoneNumberResponse::is_phone_number_errors_Valid() const{
    return m_phone_number_errors_isValid;
}

bool OAIBatchUpdatePhoneNumberResponse::isSet() const {
...
bool OAIBatchUpdatePhoneNumberResponse::isValid() const {
