...
/*
 * OAIUpdatePhoneNumber_request.h
 *
 * 
 */

#ifndef OAIUpdatePhoneNumber_request_H
#define OAIUpdatePhoneNumber_request_H
...
class OAIUpdatePhoneNumber_request : public OAIObject {
public:
    OAIUpdatePhoneNumber_request();
    OAIUpdatePhoneNumber_request(QString json);
    ~OAIUpdatePhoneNumber_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePhoneNumber_request)

#endif // OAIUpdatePhoneNumber_request_H
