...
/*
 * OAIMediaPipelineSinkType.h
 *
 * 
 */

#ifndef OAIMediaPipelineSinkType_H
#define OAIMediaPipelineSinkType_H
...
class OAIMediaPipelineSinkType : public OAIEnum {
public:
    OAIMediaPipelineSinkType();
    OAIMediaPipelineSinkType(QString json);
    ~OAIMediaPipelineSinkType() override;
    ...
    enum class eOAIMediaPipelineSinkType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        S3BUCKET
    };
    OAIMediaPipelineSinkType::eOAIMediaPipelineSinkType getValue() const;
    void setValue(const OAIMediaPipelineSinkType::eOAIMediaPipelineSinkType& value);
...
private:
    ...
    eOAIMediaPipelineSinkType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaPipelineSinkType)

#endif // OAIMediaPipelineSinkType_H
