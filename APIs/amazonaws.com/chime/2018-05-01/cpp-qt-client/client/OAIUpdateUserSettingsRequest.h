...
/*
 * OAIUpdateUserSettingsRequest.h
 *
 * 
 */

#ifndef OAIUpdateUserSettingsRequest_H
#define OAIUpdateUserSettingsRequest_H
...
namespace OpenAPI {
class OAIUpdateUserSettingsRequest_UserSettings;

class OAIUpdateUserSettingsRequest : public OAIObject {
public:
    OAIUpdateUserSettingsRequest();
    OAIUpdateUserSettingsRequest(QString json);
    ~OAIUpdateUserSettingsRequest() override;
    ...
    OAIUpdateUserSettingsRequest_UserSettings getUserSettings() const;
    void setUserSettings(const OAIUpdateUserSettingsRequest_UserSettings &user_settings);
...
private:
    ...
    OAIUpdateUserSettingsRequest_UserSettings m_user_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserSettingsRequest)

#endif // OAIUpdateUserSettingsRequest_H
