...
#include "OAITagAttendeeRequest.h"
...
OAITagAttendeeRequest::OAITagAttendeeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagAttendeeRequest::OAITagAttendeeRequest() {
    this->initializeModel();
}

OAITagAttendeeRequest::~OAITagAttendeeRequest() {}

void OAITagAttendeeRequest::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagAttendeeRequest::fromJson(QString jsonString) {
...
void OAITagAttendeeRequest::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagAttendeeRequest::asJson() const {
...
QJsonObject OAITagAttendeeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QList OAITagAttendeeRequest::getTags() const {
    return m_tags;
}
void OAITagAttendeeRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagAttendeeRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagAttendeeRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagAttendeeRequest::isSet() const {
...
bool OAITagAttendeeRequest::isValid() const {
