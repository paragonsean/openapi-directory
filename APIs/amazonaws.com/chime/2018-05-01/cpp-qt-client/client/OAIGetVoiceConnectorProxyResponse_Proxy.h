...
/*
 * OAIGetVoiceConnectorProxyResponse_Proxy.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorProxyResponse_Proxy_H
#define OAIGetVoiceConnectorProxyResponse_Proxy_H
...
class OAIGetVoiceConnectorProxyResponse_Proxy : public OAIObject {
public:
    OAIGetVoiceConnectorProxyResponse_Proxy();
    OAIGetVoiceConnectorProxyResponse_Proxy(QString json);
    ~OAIGetVoiceConnectorProxyResponse_Proxy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorProxyResponse_Proxy)

#endif // OAIGetVoiceConnectorProxyResponse_Proxy_H
