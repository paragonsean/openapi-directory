...
OAIProxySessionStatus::OAIProxySessionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProxySessionStatus::OAIProxySessionStatus() {
    this->initializeModel();
}

OAIProxySessionStatus::~OAIProxySessionStatus() {}

void OAIProxySessionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIProxySessionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIProxySessionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Open", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProxySessionStatus::OPEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProxySessionStatus::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Closed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProxySessionStatus::CLOSED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIProxySessionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIProxySessionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIProxySessionStatus::OPEN:
            val = "Open";
            break;
        case eOAIProxySessionStatus::INPROGRESS:
            val = "InProgress";
            break;
        case eOAIProxySessionStatus::CLOSED:
            val = "Closed";
            break;
        default:
            break;
...
QJsonValue OAIProxySessionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIProxySessionStatus::eOAIProxySessionStatus OAIProxySessionStatus::getValue() const {
    return m_value;
}

void OAIProxySessionStatus::setValue(const OAIProxySessionStatus::eOAIProxySessionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIProxySessionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIProxySessionStatus::isValid() const {
