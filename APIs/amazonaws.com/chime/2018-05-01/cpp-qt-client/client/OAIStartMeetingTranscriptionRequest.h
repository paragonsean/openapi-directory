...
/*
 * OAIStartMeetingTranscriptionRequest.h
 *
 * 
 */

#ifndef OAIStartMeetingTranscriptionRequest_H
#define OAIStartMeetingTranscriptionRequest_H
...
namespace OpenAPI {
class OAIStartMeetingTranscriptionRequest_TranscriptionConfiguration;

class OAIStartMeetingTranscriptionRequest : public OAIObject {
public:
    OAIStartMeetingTranscriptionRequest();
    OAIStartMeetingTranscriptionRequest(QString json);
    ~OAIStartMeetingTranscriptionRequest() override;
    ...
    OAIStartMeetingTranscriptionRequest_TranscriptionConfiguration getTranscriptionConfiguration() const;
    void setTranscriptionConfiguration(const OAIStartMeetingTranscriptionRequest_TranscriptionConfiguration &transcription_configuration);
    bool is_transcription_configuration_Set() const;
    bool is_transcription_configuration_Valid() const;
...
private:
    ...
    OAIStartMeetingTranscriptionRequest_TranscriptionConfiguration m_transcription_configuration;
    bool m_transcription_configuration_isSet;
    bool m_transcription_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartMeetingTranscriptionRequest)

#endif // OAIStartMeetingTranscriptionRequest_H
