...
/*
 * OAICreateMeetingWithAttendeesResponse.h
 *
 * 
 */

#ifndef OAICreateMeetingWithAttendeesResponse_H
#define OAICreateMeetingWithAttendeesResponse_H
...
namespace OpenAPI {
class OAICreateMeetingWithAttendeesResponse_Meeting;

class OAICreateMeetingWithAttendeesResponse : public OAIObject {
public:
    OAICreateMeetingWithAttendeesResponse();
    OAICreateMeetingWithAttendeesResponse(QString json);
    ~OAICreateMeetingWithAttendeesResponse() override;
    ...
    OAICreateMeetingWithAttendeesResponse_Meeting getMeeting() const;
    void setMeeting(const OAICreateMeetingWithAttendeesResponse_Meeting &meeting);
...
private:
    ...
    OAICreateMeetingWithAttendeesResponse_Meeting m_meeting;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingWithAttendeesResponse)

#endif // OAICreateMeetingWithAttendeesResponse_H
