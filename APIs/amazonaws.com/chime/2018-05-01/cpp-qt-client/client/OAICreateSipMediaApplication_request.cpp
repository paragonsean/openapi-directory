...
OAICreateSipMediaApplication_request::OAICreateSipMediaApplication_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSipMediaApplication_request::OAICreateSipMediaApplication_request() {
    this->initializeModel();
}

OAICreateSipMediaApplication_request::~OAICreateSipMediaApplication_request() {}

void OAICreateSipMediaApplication_request::initializeModel() {
...
void OAICreateSipMediaApplication_request::fromJson(QString jsonString) {
...
void OAICreateSipMediaApplication_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateSipMediaApplication_request::asJson() const {
...
QJsonObject OAICreateSipMediaApplication_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSipMediaApplication_request::getAwsRegion() const {
    return m_aws_region;
}
void OAICreateSipMediaApplication_request::setAwsRegion(const QString &aws_region) {
    m_aws_region = aws_region;
    m_aws_region_isSet = true;
}

bool OAICreateSipMediaApplication_request::is_aws_region_Set() const{
    return m_aws_region_isSet;
}

bool OAICreateSipMediaApplication_request::is_aws_region_Valid() const{
    return m_aws_region_isValid;
}

QString OAICreateSipMediaApplication_request::getName() const {
    return m_name;
}
void OAICreateSipMediaApplication_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateSipMediaApplication_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateSipMediaApplication_request::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAISipMediaApplicationEndpoint> OAICreateSipMediaApplication_request::getEndpoints() const {
    return m_endpoints;
}
void OAICreateSipMediaApplication_request::setEndpoints(const QList<OAISipMediaApplicationEndpoint> &endpoints) {
    m_endpoints = endpoints;
    m_endpoints_isSet = true;
}

bool OAICreateSipMediaApplication_request::is_endpoints_Set() const{
    return m_endpoints_isSet;
}

bool OAICreateSipMediaApplication_request::is_endpoints_Valid() const{
    return m_endpoints_isValid;
}

bool OAICreateSipMediaApplication_request::isSet() const {
...
bool OAICreateSipMediaApplication_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_aws_region_isValid && m_name_isValid && m_endpoints_isValid && true;
}
