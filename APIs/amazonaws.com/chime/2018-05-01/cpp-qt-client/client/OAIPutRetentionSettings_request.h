...
/*
 * OAIPutRetentionSettings_request.h
 *
 * 
 */

#ifndef OAIPutRetentionSettings_request_H
#define OAIPutRetentionSettings_request_H

#include <QJsonObject>

#include "OAIPutRetentionSettings_request_RetentionSettings.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutRetentionSettings_request_RetentionSettings;

class OAIPutRetentionSettings_request : public OAIObject {
public:
    OAIPutRetentionSettings_request();
    OAIPutRetentionSettings_request(QString json);
    ~OAIPutRetentionSettings_request() override;
    ...
    OAIPutRetentionSettings_request_RetentionSettings getRetentionSettings() const;
    void setRetentionSettings(const OAIPutRetentionSettings_request_RetentionSettings &retention_settings);
...
private:
    ...
    OAIPutRetentionSettings_request_RetentionSettings m_retention_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRetentionSettings_request)

#endif // OAIPutRetentionSettings_request_H
