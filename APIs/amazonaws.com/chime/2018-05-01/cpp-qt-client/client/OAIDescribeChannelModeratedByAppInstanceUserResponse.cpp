...
OAIDescribeChannelModeratedByAppInstanceUserResponse::OAIDescribeChannelModeratedByAppInstanceUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeChannelModeratedByAppInstanceUserResponse::OAIDescribeChannelModeratedByAppInstanceUserResponse() {
    this->initializeModel();
}

OAIDescribeChannelModeratedByAppInstanceUserResponse::~OAIDescribeChannelModeratedByAppInstanceUserResponse() {}

void OAIDescribeChannelModeratedByAppInstanceUserResponse::initializeModel() {

    m_channel_isSet = false;
    m_channel_isValid = false;
}

void OAIDescribeChannelModeratedByAppInstanceUserResponse::fromJson(QString jsonString) {
...
void OAIDescribeChannelModeratedByAppInstanceUserResponse::fromJsonObject(QJsonObject json) {

    m_channel_isValid = ::OpenAPI::fromJsonValue(m_channel, json[QString("Channel")]);
    m_channel_isSet = !json[QString("Channel")].isNull() && m_channel_isValid;
}

QString OAIDescribeChannelModeratedByAppInstanceUserResponse::asJson() const {
...
QJsonObject OAIDescribeChannelModeratedByAppInstanceUserResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_channel.isSet()) {
...
OAIDescribeChannelModeratedByAppInstanceUserResponse_Channel OAIDescribeChannelModeratedByAppInstanceUserResponse::getChannel() const {
    return m_channel;
}
void OAIDescribeChannelModeratedByAppInstanceUserResponse::setChannel(const OAIDescribeChannelModeratedByAppInstanceUserResponse_Channel &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIDescribeChannelModeratedByAppInstanceUserResponse::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIDescribeChannelModeratedByAppInstanceUserResponse::is_channel_Valid() const{
    return m_channel_isValid;
}

bool OAIDescribeChannelModeratedByAppInstanceUserResponse::isSet() const {
...
bool OAIDescribeChannelModeratedByAppInstanceUserResponse::isValid() const {
