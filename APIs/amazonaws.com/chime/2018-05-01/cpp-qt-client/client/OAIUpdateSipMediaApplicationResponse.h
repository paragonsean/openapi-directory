...
/*
 * OAIUpdateSipMediaApplicationResponse.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationResponse_H
#define OAIUpdateSipMediaApplicationResponse_H
...
namespace OpenAPI {
class OAIUpdateSipMediaApplicationResponse_SipMediaApplication;

class OAIUpdateSipMediaApplicationResponse : public OAIObject {
public:
    OAIUpdateSipMediaApplicationResponse();
    OAIUpdateSipMediaApplicationResponse(QString json);
    ~OAIUpdateSipMediaApplicationResponse() override;
    ...
    OAIUpdateSipMediaApplicationResponse_SipMediaApplication getSipMediaApplication() const;
    void setSipMediaApplication(const OAIUpdateSipMediaApplicationResponse_SipMediaApplication &sip_media_application);
...
private:
    ...
    OAIUpdateSipMediaApplicationResponse_SipMediaApplication m_sip_media_application;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationResponse)

#endif // OAIUpdateSipMediaApplicationResponse_H
