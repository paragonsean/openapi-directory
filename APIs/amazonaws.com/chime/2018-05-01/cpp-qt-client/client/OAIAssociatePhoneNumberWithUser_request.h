...
/*
 * OAIAssociatePhoneNumberWithUser_request.h
 *
 * 
 */

#ifndef OAIAssociatePhoneNumberWithUser_request_H
#define OAIAssociatePhoneNumberWithUser_request_H
...
class OAIAssociatePhoneNumberWithUser_request : public OAIObject {
public:
    OAIAssociatePhoneNumberWithUser_request();
    OAIAssociatePhoneNumberWithUser_request(QString json);
    ~OAIAssociatePhoneNumberWithUser_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatePhoneNumberWithUser_request)

#endif // OAIAssociatePhoneNumberWithUser_request_H
