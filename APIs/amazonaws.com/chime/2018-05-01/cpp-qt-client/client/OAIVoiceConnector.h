...
#ifndef OAIVoiceConnector_H
#define OAIVoiceConnector_H
...
class OAIVoiceConnector : public OAIObject {
public:
    OAIVoiceConnector();
    OAIVoiceConnector(QString json);
    ~OAIVoiceConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceConnector)

#endif // OAIVoiceConnector_H
