...
/*
 * OAIValidateE911AddressResponse_Address.h
 *
 * 
 */

#ifndef OAIValidateE911AddressResponse_Address_H
#define OAIValidateE911AddressResponse_Address_H
...
class OAIValidateE911AddressResponse_Address : public OAIObject {
public:
    OAIValidateE911AddressResponse_Address();
    OAIValidateE911AddressResponse_Address(QString json);
    ~OAIValidateE911AddressResponse_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidateE911AddressResponse_Address)

#endif // OAIValidateE911AddressResponse_Address_H
