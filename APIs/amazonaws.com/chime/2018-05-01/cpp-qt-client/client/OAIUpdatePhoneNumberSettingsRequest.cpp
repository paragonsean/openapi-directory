...
#include "OAIUpdatePhoneNumberSettingsRequest.h"
...
OAIUpdatePhoneNumberSettingsRequest::OAIUpdatePhoneNumberSettingsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhoneNumberSettingsRequest::OAIUpdatePhoneNumberSettingsRequest() {
    this->initializeModel();
}

OAIUpdatePhoneNumberSettingsRequest::~OAIUpdatePhoneNumberSettingsRequest() {}

void OAIUpdatePhoneNumberSettingsRequest::initializeModel() {

    m_calling_name_isSet = false;
    m_calling_name_isValid = false;
}

void OAIUpdatePhoneNumberSettingsRequest::fromJson(QString jsonString) {
...
void OAIUpdatePhoneNumberSettingsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePhoneNumberSettingsRequest::asJson() const {
...
QJsonObject OAIUpdatePhoneNumberSettingsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePhoneNumberSettingsRequest::getCallingName() const {
    return m_calling_name;
}
void OAIUpdatePhoneNumberSettingsRequest::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIUpdatePhoneNumberSettingsRequest::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIUpdatePhoneNumberSettingsRequest::is_calling_name_Valid() const{
    return m_calling_name_isValid;
}

bool OAIUpdatePhoneNumberSettingsRequest::isSet() const {
...
bool OAIUpdatePhoneNumberSettingsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_calling_name_isValid && true;
}
