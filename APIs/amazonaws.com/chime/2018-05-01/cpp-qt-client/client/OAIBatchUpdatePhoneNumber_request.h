...
/*
 * OAIBatchUpdatePhoneNumber_request.h
 *
 * 
 */

#ifndef OAIBatchUpdatePhoneNumber_request_H
#define OAIBatchUpdatePhoneNumber_request_H

#include <QJsonObject>

#include "OAIUpdatePhoneNumberRequestItem.h"
#include <QList>
...
namespace OpenAPI {
class OAIUpdatePhoneNumberRequestItem;

class OAIBatchUpdatePhoneNumber_request : public OAIObject {
public:
    OAIBatchUpdatePhoneNumber_request();
    OAIBatchUpdatePhoneNumber_request(QString json);
    ~OAIBatchUpdatePhoneNumber_request() override;
    ...
    QList<OAIUpdatePhoneNumberRequestItem> getUpdatePhoneNumberRequestItems() const;
    void setUpdatePhoneNumberRequestItems(const QList<OAIUpdatePhoneNumberRequestItem> &update_phone_number_request_items);
    bool is_update_phone_number_request_items_Set() const;
    bool is_update_phone_number_request_items_Valid() const;
...
private:
    ...
    QList<OAIUpdatePhoneNumberRequestItem> m_update_phone_number_request_items;
    bool m_update_phone_number_request_items_isSet;
    bool m_update_phone_number_request_items_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdatePhoneNumber_request)

#endif // OAIBatchUpdatePhoneNumber_request_H
