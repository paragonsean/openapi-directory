...
/*
 * OAICreateSipMediaApplicationRequest.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplicationRequest_H
#define OAICreateSipMediaApplicationRequest_H
...
class OAICreateSipMediaApplicationRequest : public OAIObject {
public:
    OAICreateSipMediaApplicationRequest();
    OAICreateSipMediaApplicationRequest(QString json);
    ~OAICreateSipMediaApplicationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplicationRequest)

#endif // OAICreateSipMediaApplicationRequest_H
