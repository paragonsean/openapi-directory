...
#include "OAICreateSipMediaApplicationRequest.h"
...
OAICreateSipMediaApplicationRequest::OAICreateSipMediaApplicationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSipMediaApplicationRequest::OAICreateSipMediaApplicationRequest() {
    this->initializeModel();
}

OAICreateSipMediaApplicationRequest::~OAICreateSipMediaApplicationRequest() {}

void OAICreateSipMediaApplicationRequest::initializeModel() {
...
void OAICreateSipMediaApplicationRequest::fromJson(QString jsonString) {
...
void OAICreateSipMediaApplicationRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateSipMediaApplicationRequest::asJson() const {
...
QJsonObject OAICreateSipMediaApplicationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSipMediaApplicationRequest::getAwsRegion() const {
    return m_aws_region;
}
void OAICreateSipMediaApplicationRequest::setAwsRegion(const QString &aws_region) {
    m_aws_region = aws_region;
    m_aws_region_isSet = true;
}

bool OAICreateSipMediaApplicationRequest::is_aws_region_Set() const{
    return m_aws_region_isSet;
}

bool OAICreateSipMediaApplicationRequest::is_aws_region_Valid() const{
    return m_aws_region_isValid;
}

QString OAICreateSipMediaApplicationRequest::getName() const {
    return m_name;
}
void OAICreateSipMediaApplicationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateSipMediaApplicationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateSipMediaApplicationRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateSipMediaApplicationRequest::getEndpoints() const {
    return m_endpoints;
}
void OAICreateSipMediaApplicationRequest::setEndpoints(const QList &endpoints) {
    m_endpoints = endpoints;
    m_endpoints_isSet = true;
}

bool OAICreateSipMediaApplicationRequest::is_endpoints_Set() const{
    return m_endpoints_isSet;
}

bool OAICreateSipMediaApplicationRequest::is_endpoints_Valid() const{
    return m_endpoints_isValid;
}

bool OAICreateSipMediaApplicationRequest::isSet() const {
...
bool OAICreateSipMediaApplicationRequest::isValid() const {
