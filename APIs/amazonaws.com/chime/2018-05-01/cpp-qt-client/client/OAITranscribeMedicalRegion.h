...
/*
 * OAITranscribeMedicalRegion.h
 *
 * 
 */

#ifndef OAITranscribeMedicalRegion_H
#define OAITranscribeMedicalRegion_H
...
class OAITranscribeMedicalRegion : public OAIEnum {
public:
    OAITranscribeMedicalRegion();
    OAITranscribeMedicalRegion(QString json);
    ~OAITranscribeMedicalRegion() override;
    ...
    enum class eOAITranscribeMedicalRegion {
    ...
    OAITranscribeMedicalRegion::eOAITranscribeMedicalRegion getValue() const;
    void setValue(const OAITranscribeMedicalRegion::eOAITranscribeMedicalRegion& value);
...
private:
    ...
    eOAITranscribeMedicalRegion m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeMedicalRegion)

#endif // OAITranscribeMedicalRegion_H
