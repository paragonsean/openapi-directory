...
/*
 * OAIRoomMembership_Member.h
 *
 * 
 */

#ifndef OAIRoomMembership_Member_H
#define OAIRoomMembership_Member_H
...
class OAIRoomMembership_Member : public OAIObject {
public:
    OAIRoomMembership_Member();
    OAIRoomMembership_Member(QString json);
    ~OAIRoomMembership_Member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomMembership_Member)

#endif // OAIRoomMembership_Member_H
