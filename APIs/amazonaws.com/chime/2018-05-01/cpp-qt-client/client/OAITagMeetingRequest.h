...
/*
 * OAITagMeetingRequest.h
 *
 * 
 */

#ifndef OAITagMeetingRequest_H
#define OAITagMeetingRequest_H
...
class OAITagMeetingRequest : public OAIObject {
public:
    OAITagMeetingRequest();
    OAITagMeetingRequest(QString json);
    ~OAITagMeetingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagMeetingRequest)

#endif // OAITagMeetingRequest_H
