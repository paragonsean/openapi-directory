...
/*
 * OAIListChannelMembershipsResponse.h
 *
 * 
 */

#ifndef OAIListChannelMembershipsResponse_H
#define OAIListChannelMembershipsResponse_H
...
class OAIListChannelMembershipsResponse : public OAIObject {
public:
    OAIListChannelMembershipsResponse();
    OAIListChannelMembershipsResponse(QString json);
    ~OAIListChannelMembershipsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListChannelMembershipsResponse)

#endif // OAIListChannelMembershipsResponse_H
