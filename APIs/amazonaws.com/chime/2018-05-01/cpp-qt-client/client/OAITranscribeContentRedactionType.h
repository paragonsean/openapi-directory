...
/*
 * OAITranscribeContentRedactionType.h
 *
 * 
 */

#ifndef OAITranscribeContentRedactionType_H
#define OAITranscribeContentRedactionType_H
...
class OAITranscribeContentRedactionType : public OAIEnum {
public:
    OAITranscribeContentRedactionType();
    OAITranscribeContentRedactionType(QString json);
    ~OAITranscribeContentRedactionType() override;
    ...
    enum class eOAITranscribeContentRedactionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PII
    };
    OAITranscribeContentRedactionType::eOAITranscribeContentRedactionType getValue() const;
    void setValue(const OAITranscribeContentRedactionType::eOAITranscribeContentRedactionType& value);
...
private:
    ...
    eOAITranscribeContentRedactionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeContentRedactionType)

#endif // OAITranscribeContentRedactionType_H
