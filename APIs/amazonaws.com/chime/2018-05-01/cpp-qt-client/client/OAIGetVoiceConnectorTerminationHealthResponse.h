...
/*
 * OAIGetVoiceConnectorTerminationHealthResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorTerminationHealthResponse_H
#define OAIGetVoiceConnectorTerminationHealthResponse_H
...
namespace OpenAPI {
class OAIGetVoiceConnectorTerminationHealthResponse_TerminationHealth;

class OAIGetVoiceConnectorTerminationHealthResponse : public OAIObject {
public:
    OAIGetVoiceConnectorTerminationHealthResponse();
    OAIGetVoiceConnectorTerminationHealthResponse(QString json);
    ~OAIGetVoiceConnectorTerminationHealthResponse() override;
    ...
    OAIGetVoiceConnectorTerminationHealthResponse_TerminationHealth getTerminationHealth() const;
    void setTerminationHealth(const OAIGetVoiceConnectorTerminationHealthResponse_TerminationHealth &termination_health);
    bool is_termination_health_Set() const;
    bool is_termination_health_Valid() const;
...
private:
    ...
    OAIGetVoiceConnectorTerminationHealthResponse_TerminationHealth m_termination_health;
    bool m_termination_health_isSet;
    bool m_termination_health_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorTerminationHealthResponse)

#endif // OAIGetVoiceConnectorTerminationHealthResponse_H
