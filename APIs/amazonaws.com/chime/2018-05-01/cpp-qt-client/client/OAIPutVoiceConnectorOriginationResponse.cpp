...
OAIPutVoiceConnectorOriginationResponse::OAIPutVoiceConnectorOriginationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorOriginationResponse::OAIPutVoiceConnectorOriginationResponse() {
    this->initializeModel();
}

OAIPutVoiceConnectorOriginationResponse::~OAIPutVoiceConnectorOriginationResponse() {}

void OAIPutVoiceConnectorOriginationResponse::initializeModel() {

    m_origination_isSet = false;
    m_origination_isValid = false;
}

void OAIPutVoiceConnectorOriginationResponse::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorOriginationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorOriginationResponse::asJson() const {
...
QJsonObject OAIPutVoiceConnectorOriginationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorOriginationResponse_Origination OAIPutVoiceConnectorOriginationResponse::getOrigination() const {
    return m_origination;
}
void OAIPutVoiceConnectorOriginationResponse::setOrigination(const OAIPutVoiceConnectorOriginationResponse_Origination &origination) {
    m_origination = origination;
    m_origination_isSet = true;
}

bool OAIPutVoiceConnectorOriginationResponse::is_origination_Set() const{
    return m_origination_isSet;
}

bool OAIPutVoiceConnectorOriginationResponse::is_origination_Valid() const{
    return m_origination_isValid;
}

bool OAIPutVoiceConnectorOriginationResponse::isSet() const {
...
bool OAIPutVoiceConnectorOriginationResponse::isValid() const {
