...
/*
 * OAICreateSipMediaApplicationCallRequest.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplicationCallRequest_H
#define OAICreateSipMediaApplicationCallRequest_H
...
class OAICreateSipMediaApplicationCallRequest : public OAIObject {
public:
    OAICreateSipMediaApplicationCallRequest();
    OAICreateSipMediaApplicationCallRequest(QString json);
    ~OAICreateSipMediaApplicationCallRequest() override;
    ...
    QMap getSipHeaders() const;
    void setSipHeaders(const QMap &sip_headers);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplicationCallRequest)

#endif // OAICreateSipMediaApplicationCallRequest_H
