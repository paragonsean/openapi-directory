...
/*
 * OAICreateAppInstanceUserResponse.h
 *
 * 
 */

#ifndef OAICreateAppInstanceUserResponse_H
#define OAICreateAppInstanceUserResponse_H
...
class OAICreateAppInstanceUserResponse : public OAIObject {
public:
    OAICreateAppInstanceUserResponse();
    OAICreateAppInstanceUserResponse(QString json);
    ~OAICreateAppInstanceUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppInstanceUserResponse)

#endif // OAICreateAppInstanceUserResponse_H
