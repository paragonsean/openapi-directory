...
OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings() {
    this->initializeModel();
}

OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::~OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings() {}

void OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::initializeModel() {

    m_retention_days_isSet = false;
    m_retention_days_isValid = false;
}

void OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::fromJson(QString jsonString) {
...
void OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::fromJsonObject(QJsonObject json) {
...
QString OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::asJson() const {
...
QJsonObject OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::getRetentionDays() const {
    return m_retention_days;
}
void OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::setRetentionDays(const qint32 &retention_days) {
    m_retention_days = retention_days;
    m_retention_days_isSet = true;
}

bool OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::is_retention_days_Set() const{
    return m_retention_days_isSet;
}

bool OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::is_retention_days_Valid() const{
    return m_retention_days_isValid;
}

bool OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::isSet() const {
...
bool OAIPutRetentionSettings_request_RetentionSettings_RoomRetentionSettings::isValid() const {
