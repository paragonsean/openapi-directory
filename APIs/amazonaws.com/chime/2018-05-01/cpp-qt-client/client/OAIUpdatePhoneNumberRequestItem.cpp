...
OAIUpdatePhoneNumberRequestItem::OAIUpdatePhoneNumberRequestItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePhoneNumberRequestItem::OAIUpdatePhoneNumberRequestItem() {
    this->initializeModel();
}

OAIUpdatePhoneNumberRequestItem::~OAIUpdatePhoneNumberRequestItem() {}

void OAIUpdatePhoneNumberRequestItem::initializeModel() {
...
void OAIUpdatePhoneNumberRequestItem::fromJson(QString jsonString) {
...
void OAIUpdatePhoneNumberRequestItem::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePhoneNumberRequestItem::asJson() const {
...
QJsonObject OAIUpdatePhoneNumberRequestItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePhoneNumberRequestItem::getPhoneNumberId() const {
    return m_phone_number_id;
}
void OAIUpdatePhoneNumberRequestItem::setPhoneNumberId(const QString &phone_number_id) {
    m_phone_number_id = phone_number_id;
    m_phone_number_id_isSet = true;
}

bool OAIUpdatePhoneNumberRequestItem::is_phone_number_id_Set() const{
    return m_phone_number_id_isSet;
}

bool OAIUpdatePhoneNumberRequestItem::is_phone_number_id_Valid() const{
    return m_phone_number_id_isValid;
}

OAIPhoneNumberProductType OAIUpdatePhoneNumberRequestItem::getProductType() const {
    return m_product_type;
}
void OAIUpdatePhoneNumberRequestItem::setProductType(const OAIPhoneNumberProductType &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAIUpdatePhoneNumberRequestItem::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAIUpdatePhoneNumberRequestItem::is_product_type_Valid() const{
    return m_product_type_isValid;
}

QString OAIUpdatePhoneNumberRequestItem::getCallingName() const {
    return m_calling_name;
}
void OAIUpdatePhoneNumberRequestItem::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIUpdatePhoneNumberRequestItem::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIUpdatePhoneNumberRequestItem::is_calling_name_Valid() const{
    return m_calling_name_isValid;
}

bool OAIUpdatePhoneNumberRequestItem::isSet() const {
...
bool OAIUpdatePhoneNumberRequestItem::isValid() const {
