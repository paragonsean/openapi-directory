...
OAITranscribeMedicalRegion::OAITranscribeMedicalRegion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeMedicalRegion::OAITranscribeMedicalRegion() {
    this->initializeModel();
}

OAITranscribeMedicalRegion::~OAITranscribeMedicalRegion() {}

void OAITranscribeMedicalRegion::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeMedicalRegion::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeMedicalRegion::fromJson(QString jsonString) {
    
    if ( jsonString.compare("us-east-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::US_EAST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("us-east-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::US_EAST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("us-west-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::US_WEST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ap-southeast-2", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::AP_SOUTHEAST_2;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ca-central-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::CA_CENTRAL_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("eu-west-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::EU_WEST_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("auto", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalRegion::AUTO;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeMedicalRegion::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeMedicalRegion::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeMedicalRegion::US_EAST_1:
            val = "us-east-1";
            break;
        case eOAITranscribeMedicalRegion::US_EAST_2:
            val = "us-east-2";
            break;
        case eOAITranscribeMedicalRegion::US_WEST_2:
            val = "us-west-2";
            break;
        case eOAITranscribeMedicalRegion::AP_SOUTHEAST_2:
            val = "ap-southeast-2";
            break;
        case eOAITranscribeMedicalRegion::CA_CENTRAL_1:
            val = "ca-central-1";
            break;
        case eOAITranscribeMedicalRegion::EU_WEST_1:
            val = "eu-west-1";
            break;
        case eOAITranscribeMedicalRegion::AUTO:
            val = "auto";
            break;
        default:
            break;
...
QJsonValue OAITranscribeMedicalRegion::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeMedicalRegion::eOAITranscribeMedicalRegion OAITranscribeMedicalRegion::getValue() const {
    return m_value;
}

void OAITranscribeMedicalRegion::setValue(const OAITranscribeMedicalRegion::eOAITranscribeMedicalRegion& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeMedicalRegion::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeMedicalRegion::isValid() const {
