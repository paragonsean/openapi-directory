...
/*
 * OAICreateProxySession_request_GeoMatchParams.h
 *
 * The country and area code for a proxy phone number in a proxy phone session.
 */

#ifndef OAICreateProxySession_request_GeoMatchParams_H
#define OAICreateProxySession_request_GeoMatchParams_H
...
class OAICreateProxySession_request_GeoMatchParams : public OAIObject {
public:
    OAICreateProxySession_request_GeoMatchParams();
    OAICreateProxySession_request_GeoMatchParams(QString json);
    ~OAICreateProxySession_request_GeoMatchParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySession_request_GeoMatchParams)

#endif // OAICreateProxySession_request_GeoMatchParams_H
