...
#include "OAIVoiceConnectorSettings.h"
...
OAIVoiceConnectorSettings::OAIVoiceConnectorSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVoiceConnectorSettings::OAIVoiceConnectorSettings() {
    this->initializeModel();
}

OAIVoiceConnectorSettings::~OAIVoiceConnectorSettings() {}

void OAIVoiceConnectorSettings::initializeModel() {

    m_cdr_bucket_isSet = false;
    m_cdr_bucket_isValid = false;
}

void OAIVoiceConnectorSettings::fromJson(QString jsonString) {
...
void OAIVoiceConnectorSettings::fromJsonObject(QJsonObject json) {
...
QString OAIVoiceConnectorSettings::asJson() const {
...
QJsonObject OAIVoiceConnectorSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVoiceConnectorSettings::getCdrBucket() const {
    return m_cdr_bucket;
}
void OAIVoiceConnectorSettings::setCdrBucket(const QString &cdr_bucket) {
    m_cdr_bucket = cdr_bucket;
    m_cdr_bucket_isSet = true;
}

bool OAIVoiceConnectorSettings::is_cdr_bucket_Set() const{
    return m_cdr_bucket_isSet;
}

bool OAIVoiceConnectorSettings::is_cdr_bucket_Valid() const{
    return m_cdr_bucket_isValid;
}

bool OAIVoiceConnectorSettings::isSet() const {
...
bool OAIVoiceConnectorSettings::isValid() const {
