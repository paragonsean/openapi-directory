...
/*
 * OAIListVoiceConnectorsResponse.h
 *
 * 
 */

#ifndef OAIListVoiceConnectorsResponse_H
#define OAIListVoiceConnectorsResponse_H
...
class OAIListVoiceConnectorsResponse : public OAIObject {
public:
    OAIListVoiceConnectorsResponse();
    OAIListVoiceConnectorsResponse(QString json);
    ~OAIListVoiceConnectorsResponse() override;
    ...
    QList getVoiceConnectors() const;
    void setVoiceConnectors(const QList &voice_connectors);
    bool is_voice_connectors_Set() const;
    bool is_voice_connectors_Valid() const;
...
private:
    ...
    QList m_voice_connectors;
    bool m_voice_connectors_isSet;
    bool m_voice_connectors_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVoiceConnectorsResponse)

#endif // OAIListVoiceConnectorsResponse_H
