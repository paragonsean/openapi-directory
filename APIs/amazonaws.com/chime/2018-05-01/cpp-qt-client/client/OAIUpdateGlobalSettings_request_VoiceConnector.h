...
/*
 * OAIUpdateGlobalSettings_request_VoiceConnector.h
 *
 * The Amazon Chime Voice Connector settings. Includes any Amazon S3 buckets designated for storing call detail records.
 */

#ifndef OAIUpdateGlobalSettings_request_VoiceConnector_H
#define OAIUpdateGlobalSettings_request_VoiceConnector_H
...
class OAIUpdateGlobalSettings_request_VoiceConnector : public OAIObject {
public:
    OAIUpdateGlobalSettings_request_VoiceConnector();
    OAIUpdateGlobalSettings_request_VoiceConnector(QString json);
    ~OAIUpdateGlobalSettings_request_VoiceConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGlobalSettings_request_VoiceConnector)

#endif // OAIUpdateGlobalSettings_request_VoiceConnector_H
