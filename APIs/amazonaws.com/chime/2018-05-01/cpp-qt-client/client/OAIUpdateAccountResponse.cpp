...
OAIUpdateAccountResponse_Account OAIUpdateAccountResponse::getAccount() const {
    return m_account;
}
void OAIUpdateAccountResponse::setAccount(const OAIUpdateAccountResponse_Account &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIUpdateAccountResponse::is_account_Set() const{
    return m_account_isSet;
}

bool OAIUpdateAccountResponse::is_account_Valid() const{
