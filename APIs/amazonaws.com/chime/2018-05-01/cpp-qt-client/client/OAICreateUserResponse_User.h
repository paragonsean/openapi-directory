...
/*
 * OAICreateUserResponse_User.h
 *
 * 
 */

#ifndef OAICreateUserResponse_User_H
#define OAICreateUserResponse_User_H
...
class OAICreateUserResponse_User : public OAIObject {
public:
    OAICreateUserResponse_User();
    OAICreateUserResponse_User(QString json);
    ~OAICreateUserResponse_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserResponse_User)

#endif // OAICreateUserResponse_User_H
