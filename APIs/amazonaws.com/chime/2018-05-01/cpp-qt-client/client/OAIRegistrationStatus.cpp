...
void OAIRegistrationStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Unregistered", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRegistrationStatus::UNREGISTERED;
        ...
        m_value = eOAIRegistrationStatus::SUSPENDED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIRegistrationStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIRegistrationStatus::UNREGISTERED:
            val = "Unregistered";
            break;
        case eOAIRegistrationStatus::REGISTERED:
            val = "Registered";
            break;
        case eOAIRegistrationStatus::SUSPENDED:
            val = "Suspended";
            break;
        default:
            break;
