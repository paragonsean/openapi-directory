...
OAIPutVoiceConnectorProxyResponse::OAIPutVoiceConnectorProxyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorProxyResponse::OAIPutVoiceConnectorProxyResponse() {
    this->initializeModel();
}

OAIPutVoiceConnectorProxyResponse::~OAIPutVoiceConnectorProxyResponse() {}

void OAIPutVoiceConnectorProxyResponse::initializeModel() {

    m_proxy_isSet = false;
    m_proxy_isValid = false;
}

void OAIPutVoiceConnectorProxyResponse::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorProxyResponse::fromJsonObject(QJsonObject json) {

    m_proxy_isValid = ::OpenAPI::fromJsonValue(m_proxy, json[QString("Proxy")]);
    m_proxy_isSet = !json[QString("Proxy")].isNull() && m_proxy_isValid;
}

QString OAIPutVoiceConnectorProxyResponse::asJson() const {
...
QJsonObject OAIPutVoiceConnectorProxyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_proxy.isSet()) {
...
OAIGetVoiceConnectorProxyResponse_Proxy OAIPutVoiceConnectorProxyResponse::getProxy() const {
    return m_proxy;
}
void OAIPutVoiceConnectorProxyResponse::setProxy(const OAIGetVoiceConnectorProxyResponse_Proxy &proxy) {
    m_proxy = proxy;
    m_proxy_isSet = true;
}

bool OAIPutVoiceConnectorProxyResponse::is_proxy_Set() const{
    return m_proxy_isSet;
}

bool OAIPutVoiceConnectorProxyResponse::is_proxy_Valid() const{
    return m_proxy_isValid;
}

bool OAIPutVoiceConnectorProxyResponse::isSet() const {
...
bool OAIPutVoiceConnectorProxyResponse::isValid() const {
