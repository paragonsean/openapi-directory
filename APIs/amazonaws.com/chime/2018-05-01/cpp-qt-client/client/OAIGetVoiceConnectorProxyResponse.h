...
/*
 * OAIGetVoiceConnectorProxyResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorProxyResponse_H
#define OAIGetVoiceConnectorProxyResponse_H
...
class OAIGetVoiceConnectorProxyResponse : public OAIObject {
public:
    OAIGetVoiceConnectorProxyResponse();
    OAIGetVoiceConnectorProxyResponse(QString json);
    ~OAIGetVoiceConnectorProxyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorProxyResponse)

#endif // OAIGetVoiceConnectorProxyResponse_H
