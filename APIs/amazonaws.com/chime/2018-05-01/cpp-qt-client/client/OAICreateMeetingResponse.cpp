...
OAICreateMeetingResponse::OAICreateMeetingResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMeetingResponse::OAICreateMeetingResponse() {
    this->initializeModel();
}

OAICreateMeetingResponse::~OAICreateMeetingResponse() {}

void OAICreateMeetingResponse::initializeModel() {

    m_meeting_isSet = false;
    m_meeting_isValid = false;
}

void OAICreateMeetingResponse::fromJson(QString jsonString) {
...
void OAICreateMeetingResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateMeetingResponse::asJson() const {
...
QJsonObject OAICreateMeetingResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_meeting.isSet()) {
...
OAICreateMeetingResponse_Meeting OAICreateMeetingResponse::getMeeting() const {
    return m_meeting;
}
void OAICreateMeetingResponse::setMeeting(const OAICreateMeetingResponse_Meeting &meeting) {
    m_meeting = meeting;
    m_meeting_isSet = true;
}

bool OAICreateMeetingResponse::is_meeting_Set() const{
    return m_meeting_isSet;
}

bool OAICreateMeetingResponse::is_meeting_Valid() const{
    return m_meeting_isValid;
}

bool OAICreateMeetingResponse::isSet() const {
...
bool OAICreateMeetingResponse::isValid() const {
