...
#include "OAIPutVoiceConnectorOriginationRequest_Origination.h"
...
OAIPutVoiceConnectorOriginationRequest_Origination::OAIPutVoiceConnectorOriginationRequest_Origination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorOriginationRequest_Origination::OAIPutVoiceConnectorOriginationRequest_Origination() {
    this->initializeModel();
}

OAIPutVoiceConnectorOriginationRequest_Origination::~OAIPutVoiceConnectorOriginationRequest_Origination() {}

void OAIPutVoiceConnectorOriginationRequest_Origination::initializeModel() {
...
void OAIPutVoiceConnectorOriginationRequest_Origination::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorOriginationRequest_Origination::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorOriginationRequest_Origination::asJson() const {
...
QJsonObject OAIPutVoiceConnectorOriginationRequest_Origination::asJsonObject() const {
    QJsonObject obj;
    if (m_routes.isSet()) {
...
QList OAIPutVoiceConnectorOriginationRequest_Origination::getRoutes() const {
    return m_routes;
}
void OAIPutVoiceConnectorOriginationRequest_Origination::setRoutes(const QList &routes) {
    m_routes = routes;
    m_routes_isSet = true;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::is_routes_Set() const{
    return m_routes_isSet;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::is_routes_Valid() const{
    return m_routes_isValid;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::getDisabled() const {
    return m_disabled;
}
void OAIPutVoiceConnectorOriginationRequest_Origination::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::is_disabled_Valid() const{
    return m_disabled_isValid;
}

bool OAIPutVoiceConnectorOriginationRequest_Origination::isSet() const {
...
bool OAIPutVoiceConnectorOriginationRequest_Origination::isValid() const {
