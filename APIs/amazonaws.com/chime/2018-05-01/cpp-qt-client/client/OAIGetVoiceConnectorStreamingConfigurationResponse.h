...
/*
 * OAIGetVoiceConnectorStreamingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorStreamingConfigurationResponse_H
#define OAIGetVoiceConnectorStreamingConfigurationResponse_H
...
namespace OpenAPI {
class OAIGetVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration;

class OAIGetVoiceConnectorStreamingConfigurationResponse : public OAIObject {
public:
    OAIGetVoiceConnectorStreamingConfigurationResponse();
    OAIGetVoiceConnectorStreamingConfigurationResponse(QString json);
    ~OAIGetVoiceConnectorStreamingConfigurationResponse() override;
    ...
    OAIGetVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration getStreamingConfiguration() const;
    void setStreamingConfiguration(const OAIGetVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration &streaming_configuration);
...
private:
    ...
    OAIGetVoiceConnectorStreamingConfigurationResponse_StreamingConfiguration m_streaming_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorStreamingConfigurationResponse)

#endif // OAIGetVoiceConnectorStreamingConfigurationResponse_H
