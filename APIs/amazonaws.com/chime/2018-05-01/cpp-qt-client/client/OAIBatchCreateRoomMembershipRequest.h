...
/*
 * OAIBatchCreateRoomMembershipRequest.h
 *
 * 
 */

#ifndef OAIBatchCreateRoomMembershipRequest_H
#define OAIBatchCreateRoomMembershipRequest_H
...
class OAIBatchCreateRoomMembershipRequest : public OAIObject {
public:
    OAIBatchCreateRoomMembershipRequest();
    OAIBatchCreateRoomMembershipRequest(QString json);
    ~OAIBatchCreateRoomMembershipRequest() override;
    ...
    QList getMembershipItemList() const;
    void setMembershipItemList(const QList &membership_item_list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateRoomMembershipRequest)

#endif // OAIBatchCreateRoomMembershipRequest_H
