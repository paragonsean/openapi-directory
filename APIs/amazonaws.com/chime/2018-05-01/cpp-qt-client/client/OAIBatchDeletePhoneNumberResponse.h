...
/*
 * OAIBatchDeletePhoneNumberResponse.h
 *
 * 
 */

#ifndef OAIBatchDeletePhoneNumberResponse_H
#define OAIBatchDeletePhoneNumberResponse_H
...
class OAIBatchDeletePhoneNumberResponse : public OAIObject {
public:
    OAIBatchDeletePhoneNumberResponse();
    OAIBatchDeletePhoneNumberResponse(QString json);
    ~OAIBatchDeletePhoneNumberResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeletePhoneNumberResponse)

#endif // OAIBatchDeletePhoneNumberResponse_H
