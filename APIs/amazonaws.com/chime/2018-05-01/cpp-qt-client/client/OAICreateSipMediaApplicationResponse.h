...
/*
 * OAICreateSipMediaApplicationResponse.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplicationResponse_H
#define OAICreateSipMediaApplicationResponse_H
...
namespace OpenAPI {
class OAICreateSipMediaApplicationResponse_SipMediaApplication;

class OAICreateSipMediaApplicationResponse : public OAIObject {
public:
    OAICreateSipMediaApplicationResponse();
    OAICreateSipMediaApplicationResponse(QString json);
    ~OAICreateSipMediaApplicationResponse() override;
    ...
    OAICreateSipMediaApplicationResponse_SipMediaApplication getSipMediaApplication() const;
    void setSipMediaApplication(const OAICreateSipMediaApplicationResponse_SipMediaApplication &sip_media_application);
    bool is_sip_media_application_Set() const;
    bool is_sip_media_application_Valid() const;
...
private:
    ...
    OAICreateSipMediaApplicationResponse_SipMediaApplication m_sip_media_application;
    bool m_sip_media_application_isSet;
    bool m_sip_media_application_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplicationResponse)

#endif // OAICreateSipMediaApplicationResponse_H
