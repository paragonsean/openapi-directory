...
/*
 * OAIGetMeetingResponse.h
 *
 * 
 */

#ifndef OAIGetMeetingResponse_H
#define OAIGetMeetingResponse_H
...
namespace OpenAPI {
class OAIGetMeetingResponse_Meeting;

class OAIGetMeetingResponse : public OAIObject {
public:
    OAIGetMeetingResponse();
    OAIGetMeetingResponse(QString json);
    ~OAIGetMeetingResponse() override;
    ...
    OAIGetMeetingResponse_Meeting getMeeting() const;
    void setMeeting(const OAIGetMeetingResponse_Meeting &meeting);
...
private:
    ...
    OAIGetMeetingResponse_Meeting m_meeting;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMeetingResponse)

#endif // OAIGetMeetingResponse_H
