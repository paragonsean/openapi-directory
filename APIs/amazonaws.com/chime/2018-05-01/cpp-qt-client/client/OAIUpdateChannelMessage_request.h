...
/*
 * OAIUpdateChannelMessage_request.h
 *
 * 
 */

#ifndef OAIUpdateChannelMessage_request_H
#define OAIUpdateChannelMessage_request_H
...
class OAIUpdateChannelMessage_request : public OAIObject {
public:
    OAIUpdateChannelMessage_request();
    OAIUpdateChannelMessage_request(QString json);
    ~OAIUpdateChannelMessage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateChannelMessage_request)

#endif // OAIUpdateChannelMessage_request_H
