...
/*
 * OAICreateChannelBanRequest.h
 *
 * 
 */

#ifndef OAICreateChannelBanRequest_H
#define OAICreateChannelBanRequest_H
...
class OAICreateChannelBanRequest : public OAIObject {
public:
    OAICreateChannelBanRequest();
    OAICreateChannelBanRequest(QString json);
    ~OAICreateChannelBanRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelBanRequest)

#endif // OAICreateChannelBanRequest_H
