...
OAIChannelMembership_Member::OAIChannelMembership_Member(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelMembership_Member::OAIChannelMembership_Member() {
    this->initializeModel();
}

OAIChannelMembership_Member::~OAIChannelMembership_Member() {}

void OAIChannelMembership_Member::initializeModel() {
...
void OAIChannelMembership_Member::fromJson(QString jsonString) {
...
void OAIChannelMembership_Member::fromJsonObject(QJsonObject json) {
...
QString OAIChannelMembership_Member::asJson() const {
...
QJsonObject OAIChannelMembership_Member::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIChannelMembership_Member::getArn() const {
    return m_arn;
}
void OAIChannelMembership_Member::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIChannelMembership_Member::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIChannelMembership_Member::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIChannelMembership_Member::getName() const {
    return m_name;
}
void OAIChannelMembership_Member::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChannelMembership_Member::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChannelMembership_Member::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIChannelMembership_Member::isSet() const {
...
bool OAIChannelMembership_Member::isValid() const {
