...
/*
 * OAIInviteUsersResponse.h
 *
 * 
 */

#ifndef OAIInviteUsersResponse_H
#define OAIInviteUsersResponse_H
...
class OAIInviteUsersResponse : public OAIObject {
public:
    OAIInviteUsersResponse();
    OAIInviteUsersResponse(QString json);
    ~OAIInviteUsersResponse() override;
    ...
    QList getInvites() const;
    void setInvites(const QList &invites);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInviteUsersResponse)

#endif // OAIInviteUsersResponse_H
