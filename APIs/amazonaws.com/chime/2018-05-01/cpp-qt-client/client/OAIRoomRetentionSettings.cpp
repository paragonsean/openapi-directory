...
#include "OAIRoomRetentionSettings.h"
...
OAIRoomRetentionSettings::OAIRoomRetentionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoomRetentionSettings::OAIRoomRetentionSettings() {
    this->initializeModel();
}

OAIRoomRetentionSettings::~OAIRoomRetentionSettings() {}

void OAIRoomRetentionSettings::initializeModel() {

    m_retention_days_isSet = false;
    m_retention_days_isValid = false;
}

void OAIRoomRetentionSettings::fromJson(QString jsonString) {
...
void OAIRoomRetentionSettings::fromJsonObject(QJsonObject json) {
...
QString OAIRoomRetentionSettings::asJson() const {
...
QJsonObject OAIRoomRetentionSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIRoomRetentionSettings::getRetentionDays() const {
    return m_retention_days;
}
void OAIRoomRetentionSettings::setRetentionDays(const qint32 &retention_days) {
    m_retention_days = retention_days;
    m_retention_days_isSet = true;
}

bool OAIRoomRetentionSettings::is_retention_days_Set() const{
    return m_retention_days_isSet;
}

bool OAIRoomRetentionSettings::is_retention_days_Valid() const{
    return m_retention_days_isValid;
}

bool OAIRoomRetentionSettings::isSet() const {
...
bool OAIRoomRetentionSettings::isValid() const {
