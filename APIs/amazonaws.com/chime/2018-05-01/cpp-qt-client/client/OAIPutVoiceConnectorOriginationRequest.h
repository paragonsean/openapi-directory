...
/*
 * OAIPutVoiceConnectorOriginationRequest.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorOriginationRequest_H
#define OAIPutVoiceConnectorOriginationRequest_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorOriginationRequest_Origination;

class OAIPutVoiceConnectorOriginationRequest : public OAIObject {
public:
    OAIPutVoiceConnectorOriginationRequest();
    OAIPutVoiceConnectorOriginationRequest(QString json);
    ~OAIPutVoiceConnectorOriginationRequest() override;
    ...
    OAIPutVoiceConnectorOriginationRequest_Origination getOrigination() const;
    void setOrigination(const OAIPutVoiceConnectorOriginationRequest_Origination &origination);
...
private:
    ...
    OAIPutVoiceConnectorOriginationRequest_Origination m_origination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorOriginationRequest)

#endif // OAIPutVoiceConnectorOriginationRequest_H
