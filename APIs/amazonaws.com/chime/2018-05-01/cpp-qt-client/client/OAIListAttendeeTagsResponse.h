...
/*
 * OAIListAttendeeTagsResponse.h
 *
 * 
 */

#ifndef OAIListAttendeeTagsResponse_H
#define OAIListAttendeeTagsResponse_H
...
class OAIListAttendeeTagsResponse : public OAIObject {
public:
    OAIListAttendeeTagsResponse();
    OAIListAttendeeTagsResponse(QString json);
    ~OAIListAttendeeTagsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAttendeeTagsResponse)

#endif // OAIListAttendeeTagsResponse_H
