...
/*
 * OAITranscribeMedicalType.h
 *
 * 
 */

#ifndef OAITranscribeMedicalType_H
#define OAITranscribeMedicalType_H
...
class OAITranscribeMedicalType : public OAIEnum {
public:
    OAITranscribeMedicalType();
    OAITranscribeMedicalType(QString json);
    ~OAITranscribeMedicalType() override;
    ...
    enum class eOAITranscribeMedicalType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CONVERSATION, 
        DICTATION
    };
    OAITranscribeMedicalType::eOAITranscribeMedicalType getValue() const;
    void setValue(const OAITranscribeMedicalType::eOAITranscribeMedicalType& value);
...
private:
    ...
    eOAITranscribeMedicalType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeMedicalType)

#endif // OAITranscribeMedicalType_H
