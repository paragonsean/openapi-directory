...
#ifndef OAIGeoMatchParams_H
#define OAIGeoMatchParams_H
...
class OAIGeoMatchParams : public OAIObject {
public:
    OAIGeoMatchParams();
    OAIGeoMatchParams(QString json);
    ~OAIGeoMatchParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoMatchParams)

#endif // OAIGeoMatchParams_H
