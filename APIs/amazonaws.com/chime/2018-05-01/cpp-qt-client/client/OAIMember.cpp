...
QString OAIMember::getMemberId() const {
    return m_member_id;
}
void OAIMember::setMemberId(const QString &member_id) {
...
OAIMemberType OAIMember::getMemberType() const {
    return m_member_type;
}
void OAIMember::setMemberType(const OAIMemberType &member_type) {
    m_member_type = member_type;
    m_member_type_isSet = true;
}

bool OAIMember::is_member_type_Set() const{
    return m_member_type_isSet;
}

bool OAIMember::is_member_type_Valid() const{
