...
QString OAIAccount::getAwsAccountId() const {
    return m_aws_account_id;
}
void OAIAccount::setAwsAccountId(const QString &aws_account_id) {
    m_aws_account_id = aws_account_id;
    m_aws_account_id_isSet = true;
}

bool OAIAccount::is_aws_account_id_Set() const{
    return m_aws_account_id_isSet;
}

bool OAIAccount::is_aws_account_id_Valid() const{
...
QDateTime OAIAccount::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIAccount::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIAccount::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIAccount::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

OAILicense OAIAccount::getDefaultLicense() const {
    return m_default_license;
}
void OAIAccount::setDefaultLicense(const OAILicense &default_license) {
    m_default_license = default_license;
    m_default_license_isSet = true;
}

bool OAIAccount::is_default_license_Set() const{
    return m_default_license_isSet;
}

bool OAIAccount::is_default_license_Valid() const{
    return m_default_license_isValid;
}

QList OAIAccount::getSupportedLicenses() const {
    return m_supported_licenses;
}
void OAIAccount::setSupportedLicenses(const QList &supported_licenses) {
    m_supported_licenses = supported_licenses;
    m_supported_licenses_isSet = true;
}

bool OAIAccount::is_supported_licenses_Set() const{
    return m_supported_licenses_isSet;
}

bool OAIAccount::is_supported_licenses_Valid() const{
    return m_supported_licenses_isValid;
}

OAIAccountStatus OAIAccount::getAccountStatus() const {
    return m_account_status;
}
void OAIAccount::setAccountStatus(const OAIAccountStatus &account_status) {
...
QList OAIAccount::getSigninDelegateGroups() const {
    return m_signin_delegate_groups;
}
void OAIAccount::setSigninDelegateGroups(const QList &signin_delegate_groups) {
    m_signin_delegate_groups = signin_delegate_groups;
    m_signin_delegate_groups_isSet = true;
}

bool OAIAccount::is_signin_delegate_groups_Set() const{
    return m_signin_delegate_groups_isSet;
}

bool OAIAccount::is_signin_delegate_groups_Valid() const{
