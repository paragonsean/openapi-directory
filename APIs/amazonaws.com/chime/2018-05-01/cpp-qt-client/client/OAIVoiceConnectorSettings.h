...
/*
 * OAIVoiceConnectorSettings.h
 *
 * The Amazon Chime Voice Connector settings. Includes any Amazon S3 buckets designated for storing call detail records.
 */

#ifndef OAIVoiceConnectorSettings_H
#define OAIVoiceConnectorSettings_H
...
class OAIVoiceConnectorSettings : public OAIObject {
public:
    OAIVoiceConnectorSettings();
    OAIVoiceConnectorSettings(QString json);
    ~OAIVoiceConnectorSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceConnectorSettings)

#endif // OAIVoiceConnectorSettings_H
