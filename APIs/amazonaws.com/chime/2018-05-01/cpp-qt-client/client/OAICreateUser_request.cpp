...
QString OAICreateUser_request::getUserType() const {
    return m_user_type;
}
void OAICreateUser_request::setUserType(const QString &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAICreateUser_request::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAICreateUser_request::is_user_type_Valid() const{
