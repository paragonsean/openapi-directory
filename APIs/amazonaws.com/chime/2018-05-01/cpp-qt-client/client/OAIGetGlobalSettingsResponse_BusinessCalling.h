...
/*
 * OAIGetGlobalSettingsResponse_BusinessCalling.h
 *
 * 
 */

#ifndef OAIGetGlobalSettingsResponse_BusinessCalling_H
#define OAIGetGlobalSettingsResponse_BusinessCalling_H
...
class OAIGetGlobalSettingsResponse_BusinessCalling : public OAIObject {
public:
    OAIGetGlobalSettingsResponse_BusinessCalling();
    OAIGetGlobalSettingsResponse_BusinessCalling(QString json);
    ~OAIGetGlobalSettingsResponse_BusinessCalling() override;
    ...
    QString getCdrBucket() const;
    void setCdrBucket(const QString &cdr_bucket);
    bool is_cdr_bucket_Set() const;
    bool is_cdr_bucket_Valid() const;
...
private:
    ...
    QString m_cdr_bucket;
    bool m_cdr_bucket_isSet;
    bool m_cdr_bucket_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetGlobalSettingsResponse_BusinessCalling)

#endif // OAIGetGlobalSettingsResponse_BusinessCalling_H
