...
/*
 * OAIUpdateUser_request_AlexaForBusinessMetadata.h
 *
 * The Alexa for Business metadata associated with an Amazon Chime user, used to integrate Alexa for Business with a device.
 */

#ifndef OAIUpdateUser_request_AlexaForBusinessMetadata_H
#define OAIUpdateUser_request_AlexaForBusinessMetadata_H
...
class OAIUpdateUser_request_AlexaForBusinessMetadata : public OAIObject {
public:
    OAIUpdateUser_request_AlexaForBusinessMetadata();
    OAIUpdateUser_request_AlexaForBusinessMetadata(QString json);
    ~OAIUpdateUser_request_AlexaForBusinessMetadata() override;
    ...
    bool getIsAlexaForBusinessEnabled() const;
    void setIsAlexaForBusinessEnabled(const bool &is_alexa_for_business_enabled);
    bool is_is_alexa_for_business_enabled_Set() const;
    bool is_is_alexa_for_business_enabled_Valid() const;

    QString getAlexaForBusinessRoomArn() const;
    void setAlexaForBusinessRoomArn(const QString &alexa_for_business_room_arn);
    bool is_alexa_for_business_room_arn_Set() const;
    bool is_alexa_for_business_room_arn_Valid() const;
...
private:
    ...
    bool m_is_alexa_for_business_enabled;
    bool m_is_alexa_for_business_enabled_isSet;
    bool m_is_alexa_for_business_enabled_isValid;

    QString m_alexa_for_business_room_arn;
    bool m_alexa_for_business_room_arn_isSet;
    bool m_alexa_for_business_room_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUser_request_AlexaForBusinessMetadata)

#endif // OAIUpdateUser_request_AlexaForBusinessMetadata_H
