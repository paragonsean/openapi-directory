...
/*
 * OAIPhoneNumberError.h
 *
 * If the phone number action fails for one or more of the phone numbers in the request, a list of the phone numbers is returned, along with error codes and error messages.
 */

#ifndef OAIPhoneNumberError_H
#define OAIPhoneNumberError_H
...
class OAIPhoneNumberError : public OAIObject {
public:
    OAIPhoneNumberError();
    OAIPhoneNumberError(QString json);
    ~OAIPhoneNumberError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberError)

#endif // OAIPhoneNumberError_H
