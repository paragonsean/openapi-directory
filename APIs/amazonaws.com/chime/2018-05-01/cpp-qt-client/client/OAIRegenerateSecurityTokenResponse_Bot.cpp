...
#include "OAIRegenerateSecurityTokenResponse_Bot.h"
...
OAIRegenerateSecurityTokenResponse_Bot::OAIRegenerateSecurityTokenResponse_Bot(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegenerateSecurityTokenResponse_Bot::OAIRegenerateSecurityTokenResponse_Bot() {
    this->initializeModel();
}

OAIRegenerateSecurityTokenResponse_Bot::~OAIRegenerateSecurityTokenResponse_Bot() {}

void OAIRegenerateSecurityTokenResponse_Bot::initializeModel() {
...
void OAIRegenerateSecurityTokenResponse_Bot::fromJson(QString jsonString) {
...
void OAIRegenerateSecurityTokenResponse_Bot::fromJsonObject(QJsonObject json) {
...
QString OAIRegenerateSecurityTokenResponse_Bot::asJson() const {
...
QJsonObject OAIRegenerateSecurityTokenResponse_Bot::asJsonObject() const {
    QJsonObject obj;
    if (m_bot_id_isSet) {
...
QString OAIRegenerateSecurityTokenResponse_Bot::getBotId() const {
    return m_bot_id;
}
void OAIRegenerateSecurityTokenResponse_Bot::setBotId(const QString &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

QString OAIRegenerateSecurityTokenResponse_Bot::getUserId() const {
    return m_user_id;
}
void OAIRegenerateSecurityTokenResponse_Bot::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIRegenerateSecurityTokenResponse_Bot::getDisplayName() const {
    return m_display_name;
}
void OAIRegenerateSecurityTokenResponse_Bot::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_display_name_Valid() const{
    return m_display_name_isValid;
}

OAIBotType OAIRegenerateSecurityTokenResponse_Bot::getBotType() const {
    return m_bot_type;
}
void OAIRegenerateSecurityTokenResponse_Bot::setBotType(const OAIBotType &bot_type) {
    m_bot_type = bot_type;
    m_bot_type_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_type_Set() const{
    return m_bot_type_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_type_Valid() const{
    return m_bot_type_isValid;
}

bool OAIRegenerateSecurityTokenResponse_Bot::getDisabled() const {
    return m_disabled;
}
void OAIRegenerateSecurityTokenResponse_Bot::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_disabled_Valid() const{
    return m_disabled_isValid;
}

QDateTime OAIRegenerateSecurityTokenResponse_Bot::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIRegenerateSecurityTokenResponse_Bot::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIRegenerateSecurityTokenResponse_Bot::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIRegenerateSecurityTokenResponse_Bot::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAIRegenerateSecurityTokenResponse_Bot::getBotEmail() const {
    return m_bot_email;
}
void OAIRegenerateSecurityTokenResponse_Bot::setBotEmail(const QString &bot_email) {
    m_bot_email = bot_email;
    m_bot_email_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_email_Set() const{
    return m_bot_email_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_bot_email_Valid() const{
    return m_bot_email_isValid;
}

QString OAIRegenerateSecurityTokenResponse_Bot::getSecurityToken() const {
    return m_security_token;
}
void OAIRegenerateSecurityTokenResponse_Bot::setSecurityToken(const QString &security_token) {
    m_security_token = security_token;
    m_security_token_isSet = true;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_security_token_Set() const{
    return m_security_token_isSet;
}

bool OAIRegenerateSecurityTokenResponse_Bot::is_security_token_Valid() const{
    return m_security_token_isValid;
}

bool OAIRegenerateSecurityTokenResponse_Bot::isSet() const {
...
bool OAIRegenerateSecurityTokenResponse_Bot::isValid() const {
