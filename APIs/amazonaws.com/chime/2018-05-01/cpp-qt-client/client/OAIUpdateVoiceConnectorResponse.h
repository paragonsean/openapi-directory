...
/*
 * OAIUpdateVoiceConnectorResponse.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnectorResponse_H
#define OAIUpdateVoiceConnectorResponse_H

#include <QJsonObject>

#include "OAIUpdateVoiceConnectorResponse_VoiceConnector.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateVoiceConnectorResponse_VoiceConnector;

class OAIUpdateVoiceConnectorResponse : public OAIObject {
public:
    OAIUpdateVoiceConnectorResponse();
    OAIUpdateVoiceConnectorResponse(QString json);
    ~OAIUpdateVoiceConnectorResponse() override;
    ...
    OAIUpdateVoiceConnectorResponse_VoiceConnector getVoiceConnector() const;
    void setVoiceConnector(const OAIUpdateVoiceConnectorResponse_VoiceConnector &voice_connector);
...
private:
    ...
    OAIUpdateVoiceConnectorResponse_VoiceConnector m_voice_connector;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnectorResponse)

#endif // OAIUpdateVoiceConnectorResponse_H
