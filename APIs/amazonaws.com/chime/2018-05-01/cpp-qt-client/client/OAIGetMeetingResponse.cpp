...
OAIGetMeetingResponse::OAIGetMeetingResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetMeetingResponse::OAIGetMeetingResponse() {
    this->initializeModel();
}

OAIGetMeetingResponse::~OAIGetMeetingResponse() {}

void OAIGetMeetingResponse::initializeModel() {

    m_meeting_isSet = false;
    m_meeting_isValid = false;
}

void OAIGetMeetingResponse::fromJson(QString jsonString) {
...
void OAIGetMeetingResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetMeetingResponse::asJson() const {
...
QJsonObject OAIGetMeetingResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_meeting.isSet()) {
...
OAIGetMeetingResponse_Meeting OAIGetMeetingResponse::getMeeting() const {
    return m_meeting;
}
void OAIGetMeetingResponse::setMeeting(const OAIGetMeetingResponse_Meeting &meeting) {
    m_meeting = meeting;
    m_meeting_isSet = true;
}

bool OAIGetMeetingResponse::is_meeting_Set() const{
    return m_meeting_isSet;
}

bool OAIGetMeetingResponse::is_meeting_Valid() const{
    return m_meeting_isValid;
}

bool OAIGetMeetingResponse::isSet() const {
...
bool OAIGetMeetingResponse::isValid() const {
