...
/*
 * OAICreateChannelBan_request.h
 *
 * 
 */

#ifndef OAICreateChannelBan_request_H
#define OAICreateChannelBan_request_H
...
class OAICreateChannelBan_request : public OAIObject {
public:
    OAICreateChannelBan_request();
    OAICreateChannelBan_request(QString json);
    ~OAICreateChannelBan_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelBan_request)

#endif // OAICreateChannelBan_request_H
