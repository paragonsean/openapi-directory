...
OAIGetUserSettingsResponse_UserSettings::OAIGetUserSettingsResponse_UserSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserSettingsResponse_UserSettings::OAIGetUserSettingsResponse_UserSettings() {
    this->initializeModel();
}

OAIGetUserSettingsResponse_UserSettings::~OAIGetUserSettingsResponse_UserSettings() {}

void OAIGetUserSettingsResponse_UserSettings::initializeModel() {

    m_telephony_isSet = false;
    m_telephony_isValid = false;
}

void OAIGetUserSettingsResponse_UserSettings::fromJson(QString jsonString) {
...
void OAIGetUserSettingsResponse_UserSettings::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserSettingsResponse_UserSettings::asJson() const {
...
QJsonObject OAIGetUserSettingsResponse_UserSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateUserSettings_request_UserSettings_Telephony OAIGetUserSettingsResponse_UserSettings::getTelephony() const {
    return m_telephony;
}
void OAIGetUserSettingsResponse_UserSettings::setTelephony(const OAIUpdateUserSettings_request_UserSettings_Telephony &telephony) {
    m_telephony = telephony;
    m_telephony_isSet = true;
}

bool OAIGetUserSettingsResponse_UserSettings::is_telephony_Set() const{
    return m_telephony_isSet;
}

bool OAIGetUserSettingsResponse_UserSettings::is_telephony_Valid() const{
    return m_telephony_isValid;
}

bool OAIGetUserSettingsResponse_UserSettings::isSet() const {
...
bool OAIGetUserSettingsResponse_UserSettings::isValid() const {
