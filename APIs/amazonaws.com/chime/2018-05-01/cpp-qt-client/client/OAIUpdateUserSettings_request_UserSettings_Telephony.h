...
/*
 * OAIUpdateUserSettings_request_UserSettings_Telephony.h
 *
 * 
 */

#ifndef OAIUpdateUserSettings_request_UserSettings_Telephony_H
#define OAIUpdateUserSettings_request_UserSettings_Telephony_H
...
class OAIUpdateUserSettings_request_UserSettings_Telephony : public OAIObject {
public:
    OAIUpdateUserSettings_request_UserSettings_Telephony();
    OAIUpdateUserSettings_request_UserSettings_Telephony(QString json);
    ~OAIUpdateUserSettings_request_UserSettings_Telephony() override;
    ...
    void setInboundCalling(const bool &inbound_calling);
    bool is_inbound_calling_Set() const;
    bool is_inbound_calling_Valid() const;

    bool getOutboundCalling() const;
    void setOutboundCalling(const bool &outbound_calling);
    bool is_outbound_calling_Set() const;
    bool is_outbound_calling_Valid() const;
...
private:
    ...
    bool m_inbound_calling;
    bool m_inbound_calling_isSet;
    bool m_inbound_calling_isValid;

    bool m_outbound_calling;
    bool m_outbound_calling_isSet;
    bool m_outbound_calling_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserSettings_request_UserSettings_Telephony)

#endif // OAIUpdateUserSettings_request_UserSettings_Telephony_H
