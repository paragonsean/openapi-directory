...
OAIPhoneNumberProductType OAIUpdatePhoneNumberRequest::getProductType() const {
    return m_product_type;
}
void OAIUpdatePhoneNumberRequest::setProductType(const OAIPhoneNumberProductType &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAIUpdatePhoneNumberRequest::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAIUpdatePhoneNumberRequest::is_product_type_Valid() const{
    return m_product_type_isValid;
}

QString OAIUpdatePhoneNumberRequest::getCallingName() const {
    return m_calling_name;
}
void OAIUpdatePhoneNumberRequest::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIUpdatePhoneNumberRequest::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIUpdatePhoneNumberRequest::is_calling_name_Valid() const{
