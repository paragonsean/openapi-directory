...
OAIPutRetentionSettingsResponse::OAIPutRetentionSettingsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRetentionSettingsResponse::OAIPutRetentionSettingsResponse() {
    this->initializeModel();
}

OAIPutRetentionSettingsResponse::~OAIPutRetentionSettingsResponse() {}

void OAIPutRetentionSettingsResponse::initializeModel() {
...
void OAIPutRetentionSettingsResponse::fromJson(QString jsonString) {
...
void OAIPutRetentionSettingsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutRetentionSettingsResponse::asJson() const {
...
QJsonObject OAIPutRetentionSettingsResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetRetentionSettingsResponse_RetentionSettings OAIPutRetentionSettingsResponse::getRetentionSettings() const {
    return m_retention_settings;
}
void OAIPutRetentionSettingsResponse::setRetentionSettings(const OAIGetRetentionSettingsResponse_RetentionSettings &retention_settings) {
    m_retention_settings = retention_settings;
    m_retention_settings_isSet = true;
}

bool OAIPutRetentionSettingsResponse::is_retention_settings_Set() const{
    return m_retention_settings_isSet;
}

bool OAIPutRetentionSettingsResponse::is_retention_settings_Valid() const{
    return m_retention_settings_isValid;
}

QDateTime OAIPutRetentionSettingsResponse::getInitiateDeletionTimestamp() const {
    return m_initiate_deletion_timestamp;
}
void OAIPutRetentionSettingsResponse::setInitiateDeletionTimestamp(const QDateTime &initiate_deletion_timestamp) {
    m_initiate_deletion_timestamp = initiate_deletion_timestamp;
    m_initiate_deletion_timestamp_isSet = true;
}

bool OAIPutRetentionSettingsResponse::is_initiate_deletion_timestamp_Set() const{
    return m_initiate_deletion_timestamp_isSet;
}

bool OAIPutRetentionSettingsResponse::is_initiate_deletion_timestamp_Valid() const{
    return m_initiate_deletion_timestamp_isValid;
}

bool OAIPutRetentionSettingsResponse::isSet() const {
...
bool OAIPutRetentionSettingsResponse::isValid() const {
