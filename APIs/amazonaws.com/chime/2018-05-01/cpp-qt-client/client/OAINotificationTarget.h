...
/*
 * OAINotificationTarget.h
 *
 * 
 */

#ifndef OAINotificationTarget_H
#define OAINotificationTarget_H
...
class OAINotificationTarget : public OAIEnum {
public:
    OAINotificationTarget();
    OAINotificationTarget(QString json);
    ~OAINotificationTarget() override;
    ...
    enum class eOAINotificationTarget {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EVENTBRIDGE, 
        SNS, 
        SQS
    };
    OAINotificationTarget::eOAINotificationTarget getValue() const;
    void setValue(const OAINotificationTarget::eOAINotificationTarget& value);
...
private:
    ...
    eOAINotificationTarget m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotificationTarget)

#endif // OAINotificationTarget_H
