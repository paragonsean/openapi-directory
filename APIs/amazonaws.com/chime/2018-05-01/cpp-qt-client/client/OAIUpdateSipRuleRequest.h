...
/*
 * OAIUpdateSipRuleRequest.h
 *
 * 
 */

#ifndef OAIUpdateSipRuleRequest_H
#define OAIUpdateSipRuleRequest_H
...
class OAIUpdateSipRuleRequest : public OAIObject {
public:
    OAIUpdateSipRuleRequest();
    OAIUpdateSipRuleRequest(QString json);
    ~OAIUpdateSipRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipRuleRequest)

#endif // OAIUpdateSipRuleRequest_H
