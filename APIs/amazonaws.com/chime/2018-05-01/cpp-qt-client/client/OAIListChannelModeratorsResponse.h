...
/*
 * OAIListChannelModeratorsResponse.h
 *
 * 
 */

#ifndef OAIListChannelModeratorsResponse_H
#define OAIListChannelModeratorsResponse_H
...
class OAIListChannelModeratorsResponse : public OAIObject {
public:
    OAIListChannelModeratorsResponse();
    OAIListChannelModeratorsResponse(QString json);
    ~OAIListChannelModeratorsResponse() override;
    ...
    QList getChannelModerators() const;
    void setChannelModerators(const QList &channel_moderators);
    bool is_channel_moderators_Set() const;
    bool is_channel_moderators_Valid() const;
...
private:
    ...
    QList m_channel_moderators;
    bool m_channel_moderators_isSet;
    bool m_channel_moderators_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListChannelModeratorsResponse)

#endif // OAIListChannelModeratorsResponse_H
