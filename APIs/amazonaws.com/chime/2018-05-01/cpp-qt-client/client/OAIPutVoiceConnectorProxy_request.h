...
/*
 * OAIPutVoiceConnectorProxy_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorProxy_request_H
#define OAIPutVoiceConnectorProxy_request_H
...
class OAIPutVoiceConnectorProxy_request : public OAIObject {
public:
    OAIPutVoiceConnectorProxy_request();
    OAIPutVoiceConnectorProxy_request(QString json);
    ~OAIPutVoiceConnectorProxy_request() override;
    ...
    QList<QString> getPhoneNumberPoolCountries() const;
    void setPhoneNumberPoolCountries(const QList<QString> &phone_number_pool_countries);
    bool is_phone_number_pool_countries_Set() const;
    bool is_phone_number_pool_countries_Valid() const;
...
private:
    ...
    QList<QString> m_phone_number_pool_countries;
    bool m_phone_number_pool_countries_isSet;
    bool m_phone_number_pool_countries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorProxy_request)

#endif // OAIPutVoiceConnectorProxy_request_H
