...
/*
 * OAIUpdateVoiceConnectorGroupRequest.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnectorGroupRequest_H
#define OAIUpdateVoiceConnectorGroupRequest_H
...
class OAIUpdateVoiceConnectorGroupRequest : public OAIObject {
public:
    OAIUpdateVoiceConnectorGroupRequest();
    OAIUpdateVoiceConnectorGroupRequest(QString json);
    ~OAIUpdateVoiceConnectorGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnectorGroupRequest)

#endif // OAIUpdateVoiceConnectorGroupRequest_H
