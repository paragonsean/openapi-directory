...
OAIGetVoiceConnectorOriginationResponse::OAIGetVoiceConnectorOriginationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorOriginationResponse::OAIGetVoiceConnectorOriginationResponse() {
    this->initializeModel();
}

OAIGetVoiceConnectorOriginationResponse::~OAIGetVoiceConnectorOriginationResponse() {}

void OAIGetVoiceConnectorOriginationResponse::initializeModel() {

    m_origination_isSet = false;
    m_origination_isValid = false;
}

void OAIGetVoiceConnectorOriginationResponse::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorOriginationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetVoiceConnectorOriginationResponse::asJson() const {
...
QJsonObject OAIGetVoiceConnectorOriginationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetVoiceConnectorOriginationResponse_Origination OAIGetVoiceConnectorOriginationResponse::getOrigination() const {
    return m_origination;
}
void OAIGetVoiceConnectorOriginationResponse::setOrigination(const OAIGetVoiceConnectorOriginationResponse_Origination &origination) {
    m_origination = origination;
    m_origination_isSet = true;
}

bool OAIGetVoiceConnectorOriginationResponse::is_origination_Set() const{
    return m_origination_isSet;
}

bool OAIGetVoiceConnectorOriginationResponse::is_origination_Valid() const{
    return m_origination_isValid;
}

bool OAIGetVoiceConnectorOriginationResponse::isSet() const {
...
bool OAIGetVoiceConnectorOriginationResponse::isValid() const {
