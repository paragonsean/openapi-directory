...
OAIPutVoiceConnectorOrigination_request::OAIPutVoiceConnectorOrigination_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorOrigination_request::OAIPutVoiceConnectorOrigination_request() {
    this->initializeModel();
}

OAIPutVoiceConnectorOrigination_request::~OAIPutVoiceConnectorOrigination_request() {}

void OAIPutVoiceConnectorOrigination_request::initializeModel() {

    m_origination_isSet = false;
    m_origination_isValid = false;
}

void OAIPutVoiceConnectorOrigination_request::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorOrigination_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorOrigination_request::asJson() const {
...
QJsonObject OAIPutVoiceConnectorOrigination_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorOrigination_request_Origination OAIPutVoiceConnectorOrigination_request::getOrigination() const {
    return m_origination;
}
void OAIPutVoiceConnectorOrigination_request::setOrigination(const OAIPutVoiceConnectorOrigination_request_Origination &origination) {
    m_origination = origination;
    m_origination_isSet = true;
}

bool OAIPutVoiceConnectorOrigination_request::is_origination_Set() const{
    return m_origination_isSet;
}

bool OAIPutVoiceConnectorOrigination_request::is_origination_Valid() const{
    return m_origination_isValid;
}

bool OAIPutVoiceConnectorOrigination_request::isSet() const {
...
bool OAIPutVoiceConnectorOrigination_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_origination_isValid && true;
}
