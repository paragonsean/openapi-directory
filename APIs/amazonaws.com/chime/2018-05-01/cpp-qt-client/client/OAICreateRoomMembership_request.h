...
/*
 * OAICreateRoomMembership_request.h
 *
 * 
 */

#ifndef OAICreateRoomMembership_request_H
#define OAICreateRoomMembership_request_H
...
class OAICreateRoomMembership_request : public OAIObject {
public:
    OAICreateRoomMembership_request();
    OAICreateRoomMembership_request(QString json);
    ~OAICreateRoomMembership_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoomMembership_request)

#endif // OAICreateRoomMembership_request_H
