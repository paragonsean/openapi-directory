...
#ifndef OAIVoiceConnectorItem_H
#define OAIVoiceConnectorItem_H
...
class OAIVoiceConnectorItem : public OAIObject {
public:
    OAIVoiceConnectorItem();
    OAIVoiceConnectorItem(QString json);
    ~OAIVoiceConnectorItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceConnectorItem)

#endif // OAIVoiceConnectorItem_H
