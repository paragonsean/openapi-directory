...
OAIVoiceConnectorItem::OAIVoiceConnectorItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVoiceConnectorItem::OAIVoiceConnectorItem() {
    this->initializeModel();
}

OAIVoiceConnectorItem::~OAIVoiceConnectorItem() {}

void OAIVoiceConnectorItem::initializeModel() {
...
void OAIVoiceConnectorItem::fromJson(QString jsonString) {
...
void OAIVoiceConnectorItem::fromJsonObject(QJsonObject json) {
...
QString OAIVoiceConnectorItem::asJson() const {
...
QJsonObject OAIVoiceConnectorItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVoiceConnectorItem::getVoiceConnectorId() const {
    return m_voice_connector_id;
}
void OAIVoiceConnectorItem::setVoiceConnectorId(const QString &voice_connector_id) {
    m_voice_connector_id = voice_connector_id;
    m_voice_connector_id_isSet = true;
}

bool OAIVoiceConnectorItem::is_voice_connector_id_Set() const{
    return m_voice_connector_id_isSet;
}

bool OAIVoiceConnectorItem::is_voice_connector_id_Valid() const{
    return m_voice_connector_id_isValid;
}

qint32 OAIVoiceConnectorItem::getPriority() const {
    return m_priority;
}
void OAIVoiceConnectorItem::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIVoiceConnectorItem::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIVoiceConnectorItem::is_priority_Valid() const{
    return m_priority_isValid;
}

bool OAIVoiceConnectorItem::isSet() const {
...
bool OAIVoiceConnectorItem::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_voice_connector_id_isValid && m_priority_isValid && true;
}
