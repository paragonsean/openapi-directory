...
/*
 * OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration.h
 *
 * The emergency calling configuration details associated with an Amazon Chime Voice Connector.
 */

#ifndef OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration_H
#define OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration_H
...
class OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration : public OAIObject {
public:
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration();
    OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration(QString json);
    ~OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration() override;
    ...
    QList getDnis() const;
    void setDnis(const QList &dnis);
    bool is_dnis_Set() const;
    bool is_dnis_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration)

#endif // OAIPutVoiceConnectorEmergencyCallingConfiguration_request_EmergencyCallingConfiguration_H
