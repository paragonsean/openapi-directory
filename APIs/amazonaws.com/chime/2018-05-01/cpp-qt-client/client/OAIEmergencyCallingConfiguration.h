...
/*
 * OAIEmergencyCallingConfiguration.h
 *
 * The emergency calling configuration details associated with an Amazon Chime Voice Connector.
 */

#ifndef OAIEmergencyCallingConfiguration_H
#define OAIEmergencyCallingConfiguration_H
...
class OAIEmergencyCallingConfiguration : public OAIObject {
public:
    OAIEmergencyCallingConfiguration();
    OAIEmergencyCallingConfiguration(QString json);
    ~OAIEmergencyCallingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmergencyCallingConfiguration)

#endif // OAIEmergencyCallingConfiguration_H
