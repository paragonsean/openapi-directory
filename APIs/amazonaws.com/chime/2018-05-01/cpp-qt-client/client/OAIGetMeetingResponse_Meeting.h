...
/*
 * OAIGetMeetingResponse_Meeting.h
 *
 * 
 */

#ifndef OAIGetMeetingResponse_Meeting_H
#define OAIGetMeetingResponse_Meeting_H
...
class OAIGetMeetingResponse_Meeting : public OAIObject {
public:
    OAIGetMeetingResponse_Meeting();
    OAIGetMeetingResponse_Meeting(QString json);
    ~OAIGetMeetingResponse_Meeting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMeetingResponse_Meeting)

#endif // OAIGetMeetingResponse_Meeting_H
