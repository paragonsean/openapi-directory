...
/*
 * OAIArtifactsConfiguration_Video.h
 *
 * 
 */

#ifndef OAIArtifactsConfiguration_Video_H
#define OAIArtifactsConfiguration_Video_H
...
class OAIArtifactsConfiguration_Video : public OAIObject {
public:
    OAIArtifactsConfiguration_Video();
    OAIArtifactsConfiguration_Video(QString json);
    ~OAIArtifactsConfiguration_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtifactsConfiguration_Video)

#endif // OAIArtifactsConfiguration_Video_H
