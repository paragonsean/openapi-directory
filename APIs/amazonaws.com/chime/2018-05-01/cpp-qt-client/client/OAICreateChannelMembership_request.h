...
/*
 * OAICreateChannelMembership_request.h
 *
 * 
 */

#ifndef OAICreateChannelMembership_request_H
#define OAICreateChannelMembership_request_H
...
class OAICreateChannelMembership_request : public OAIObject {
public:
    OAICreateChannelMembership_request();
    OAICreateChannelMembership_request(QString json);
    ~OAICreateChannelMembership_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateChannelMembership_request)

#endif // OAICreateChannelMembership_request_H
