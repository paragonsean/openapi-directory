...
/*
 * OAIUntagMeeting_request.h
 *
 * 
 */

#ifndef OAIUntagMeeting_request_H
#define OAIUntagMeeting_request_H
...
class OAIUntagMeeting_request : public OAIObject {
public:
    OAIUntagMeeting_request();
    OAIUntagMeeting_request(QString json);
    ~OAIUntagMeeting_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagMeeting_request)

#endif // OAIUntagMeeting_request_H
