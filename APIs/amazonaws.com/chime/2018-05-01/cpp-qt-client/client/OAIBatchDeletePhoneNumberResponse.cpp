...
OAIBatchDeletePhoneNumberResponse::OAIBatchDeletePhoneNumberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeletePhoneNumberResponse::OAIBatchDeletePhoneNumberResponse() {
    this->initializeModel();
}

OAIBatchDeletePhoneNumberResponse::~OAIBatchDeletePhoneNumberResponse() {}

void OAIBatchDeletePhoneNumberResponse::initializeModel() {

    m_phone_number_errors_isSet = false;
    m_phone_number_errors_isValid = false;
}

void OAIBatchDeletePhoneNumberResponse::fromJson(QString jsonString) {
...
void OAIBatchDeletePhoneNumberResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchDeletePhoneNumberResponse::asJson() const {
...
QJsonObject OAIBatchDeletePhoneNumberResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchDeletePhoneNumberResponse::getPhoneNumberErrors() const {
    return m_phone_number_errors;
}
void OAIBatchDeletePhoneNumberResponse::setPhoneNumberErrors(const QList &phone_number_errors) {
    m_phone_number_errors = phone_number_errors;
    m_phone_number_errors_isSet = true;
}

bool OAIBatchDeletePhoneNumberResponse::is_phone_number_errors_Set() const{
    return m_phone_number_errors_isSet;
}

bool OAIBatchDeletePhoneNumberResponse::is_phone_number_errors_Valid() const{
    return m_phone_number_errors_isValid;
}

bool OAIBatchDeletePhoneNumberResponse::isSet() const {
...
bool OAIBatchDeletePhoneNumberResponse::isValid() const {
