...
void OAILicense::initializeModel() {
    ...
    m_value = eOAILicense::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILicense::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Basic", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicense::BASIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Plus", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicense::PLUS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Pro", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicense::PRO;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ProTrial", Qt::CaseInsensitive) == 0) {
        m_value = eOAILicense::PROTRIAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILicense::fromJsonValue(QJsonValue json) {
...
QString OAILicense::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAILicense::BASIC:
            val = "Basic";
            break;
        case eOAILicense::PLUS:
            val = "Plus";
            break;
        case eOAILicense::PRO:
            val = "Pro";
            break;
        case eOAILicense::PROTRIAL:
            val = "ProTrial";
            break;
        default:
            break;
...
QJsonValue OAILicense::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILicense::eOAILicense OAILicense::getValue() const {
    return m_value;
}

void OAILicense::setValue(const OAILicense::eOAILicense& value){
    m_value = value;
    m_value_isSet = true;
}
