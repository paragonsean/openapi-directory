...
/*
 * OAIListProxySessionsResponse.h
 *
 * 
 */

#ifndef OAIListProxySessionsResponse_H
#define OAIListProxySessionsResponse_H
...
class OAIListProxySessionsResponse : public OAIObject {
public:
    OAIListProxySessionsResponse();
    OAIListProxySessionsResponse(QString json);
    ~OAIListProxySessionsResponse() override;
    ...
    QList getProxySessions() const;
    void setProxySessions(const QList &proxy_sessions);
    bool is_proxy_sessions_Set() const;
    bool is_proxy_sessions_Valid() const;
...
private:
    ...
    QList m_proxy_sessions;
    bool m_proxy_sessions_isSet;
    bool m_proxy_sessions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProxySessionsResponse)

#endif // OAIListProxySessionsResponse_H
