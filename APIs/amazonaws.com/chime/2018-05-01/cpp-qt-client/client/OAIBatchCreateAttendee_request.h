...
/*
 * OAIBatchCreateAttendee_request.h
 *
 * 
 */

#ifndef OAIBatchCreateAttendee_request_H
#define OAIBatchCreateAttendee_request_H

#include <QJsonObject>

#include "OAICreateAttendeeRequestItem.h"
#include <QList>
...
namespace OpenAPI {
class OAICreateAttendeeRequestItem;

class OAIBatchCreateAttendee_request : public OAIObject {
public:
    OAIBatchCreateAttendee_request();
    OAIBatchCreateAttendee_request(QString json);
    ~OAIBatchCreateAttendee_request() override;
    ...
    QList<OAICreateAttendeeRequestItem> getAttendees() const;
    void setAttendees(const QList<OAICreateAttendeeRequestItem> &attendees);
...
private:
    ...
    QList<OAICreateAttendeeRequestItem> m_attendees;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateAttendee_request)

#endif // OAIBatchCreateAttendee_request_H
