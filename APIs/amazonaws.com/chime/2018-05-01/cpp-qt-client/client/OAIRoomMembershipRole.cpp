...
#include "OAIRoomMembershipRole.h"
...
OAIRoomMembershipRole::OAIRoomMembershipRole(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoomMembershipRole::OAIRoomMembershipRole() {
    this->initializeModel();
}

OAIRoomMembershipRole::~OAIRoomMembershipRole() {}

void OAIRoomMembershipRole::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRoomMembershipRole::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRoomMembershipRole::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Administrator", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRoomMembershipRole::ADMINISTRATOR;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Member", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRoomMembershipRole::MEMBER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRoomMembershipRole::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRoomMembershipRole::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRoomMembershipRole::ADMINISTRATOR:
            val = "Administrator";
            break;
        case eOAIRoomMembershipRole::MEMBER:
            val = "Member";
            break;
        default:
            break;
...
QJsonValue OAIRoomMembershipRole::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRoomMembershipRole::eOAIRoomMembershipRole OAIRoomMembershipRole::getValue() const {
    return m_value;
}

void OAIRoomMembershipRole::setValue(const OAIRoomMembershipRole::eOAIRoomMembershipRole& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRoomMembershipRole::isSet() const {
    
    return m_value_isSet;
}

bool OAIRoomMembershipRole::isValid() const {
