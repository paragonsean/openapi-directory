...
/*
 * OAICreateMeetingRequest_NotificationsConfiguration.h
 *
 * 
 */

#ifndef OAICreateMeetingRequest_NotificationsConfiguration_H
#define OAICreateMeetingRequest_NotificationsConfiguration_H
...
class OAICreateMeetingRequest_NotificationsConfiguration : public OAIObject {
public:
    OAICreateMeetingRequest_NotificationsConfiguration();
    OAICreateMeetingRequest_NotificationsConfiguration(QString json);
    ~OAICreateMeetingRequest_NotificationsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingRequest_NotificationsConfiguration)

#endif // OAICreateMeetingRequest_NotificationsConfiguration_H
