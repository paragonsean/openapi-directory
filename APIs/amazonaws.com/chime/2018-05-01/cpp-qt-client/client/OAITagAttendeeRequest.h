...
/*
 * OAITagAttendeeRequest.h
 *
 * 
 */

#ifndef OAITagAttendeeRequest_H
#define OAITagAttendeeRequest_H
...
class OAITagAttendeeRequest : public OAIObject {
public:
    OAITagAttendeeRequest();
    OAITagAttendeeRequest(QString json);
    ~OAITagAttendeeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagAttendeeRequest)

#endif // OAITagAttendeeRequest_H
