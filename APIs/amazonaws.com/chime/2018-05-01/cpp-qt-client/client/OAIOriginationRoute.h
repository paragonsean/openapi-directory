...
#ifndef OAIOriginationRoute_H
#define OAIOriginationRoute_H

#include <QJsonObject>

#include "OAIOriginationRouteProtocol.h"
#include <QString>
...
class OAIOriginationRoute : public OAIObject {
public:
    OAIOriginationRoute();
    OAIOriginationRoute(QString json);
    ~OAIOriginationRoute() override;
    ...
    OAIOriginationRouteProtocol getProtocol() const;
    void setProtocol(const OAIOriginationRouteProtocol &protocol);
...
private:
    ...
    OAIOriginationRouteProtocol m_protocol;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginationRoute)

#endif // OAIOriginationRoute_H
