...
/*
 * OAIUntagMeetingRequest.h
 *
 * 
 */

#ifndef OAIUntagMeetingRequest_H
#define OAIUntagMeetingRequest_H
...
class OAIUntagMeetingRequest : public OAIObject {
public:
    OAIUntagMeetingRequest();
    OAIUntagMeetingRequest(QString json);
    ~OAIUntagMeetingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagMeetingRequest)

#endif // OAIUntagMeetingRequest_H
