...
/*
 * OAIPhoneNumberCountry.h
 *
 * The phone number country.
 */

#ifndef OAIPhoneNumberCountry_H
#define OAIPhoneNumberCountry_H
...
class OAIPhoneNumberCountry : public OAIObject {
public:
    OAIPhoneNumberCountry();
    OAIPhoneNumberCountry(QString json);
    ~OAIPhoneNumberCountry() override;
    ...
    QList getSupportedPhoneNumberTypes() const;
    void setSupportedPhoneNumberTypes(const QList &supported_phone_number_types);
    bool is_supported_phone_number_types_Set() const;
    bool is_supported_phone_number_types_Valid() const;
...
private:
    ...
    QList m_supported_phone_number_types;
    bool m_supported_phone_number_types_isSet;
    bool m_supported_phone_number_types_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberCountry)

#endif // OAIPhoneNumberCountry_H
