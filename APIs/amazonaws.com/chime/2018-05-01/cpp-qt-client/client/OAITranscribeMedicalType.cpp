...
OAITranscribeMedicalType::OAITranscribeMedicalType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeMedicalType::OAITranscribeMedicalType() {
    this->initializeModel();
}

OAITranscribeMedicalType::~OAITranscribeMedicalType() {}

void OAITranscribeMedicalType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeMedicalType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeMedicalType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CONVERSATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalType::CONVERSATION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DICTATION", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalType::DICTATION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeMedicalType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeMedicalType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeMedicalType::CONVERSATION:
            val = "CONVERSATION";
            break;
        case eOAITranscribeMedicalType::DICTATION:
            val = "DICTATION";
            break;
        default:
            break;
...
QJsonValue OAITranscribeMedicalType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeMedicalType::eOAITranscribeMedicalType OAITranscribeMedicalType::getValue() const {
    return m_value;
}

void OAITranscribeMedicalType::setValue(const OAITranscribeMedicalType::eOAITranscribeMedicalType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeMedicalType::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeMedicalType::isValid() const {
