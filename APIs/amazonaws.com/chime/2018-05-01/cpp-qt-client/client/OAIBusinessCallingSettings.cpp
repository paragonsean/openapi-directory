...
#include "OAIBusinessCallingSettings.h"
...
OAIBusinessCallingSettings::OAIBusinessCallingSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusinessCallingSettings::OAIBusinessCallingSettings() {
    this->initializeModel();
}

OAIBusinessCallingSettings::~OAIBusinessCallingSettings() {}

void OAIBusinessCallingSettings::initializeModel() {

    m_cdr_bucket_isSet = false;
    m_cdr_bucket_isValid = false;
}

void OAIBusinessCallingSettings::fromJson(QString jsonString) {
...
void OAIBusinessCallingSettings::fromJsonObject(QJsonObject json) {
...
QString OAIBusinessCallingSettings::asJson() const {
...
QJsonObject OAIBusinessCallingSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBusinessCallingSettings::getCdrBucket() const {
    return m_cdr_bucket;
}
void OAIBusinessCallingSettings::setCdrBucket(const QString &cdr_bucket) {
    m_cdr_bucket = cdr_bucket;
    m_cdr_bucket_isSet = true;
}

bool OAIBusinessCallingSettings::is_cdr_bucket_Set() const{
    return m_cdr_bucket_isSet;
}

bool OAIBusinessCallingSettings::is_cdr_bucket_Valid() const{
    return m_cdr_bucket_isValid;
}

bool OAIBusinessCallingSettings::isSet() const {
...
bool OAIBusinessCallingSettings::isValid() const {
