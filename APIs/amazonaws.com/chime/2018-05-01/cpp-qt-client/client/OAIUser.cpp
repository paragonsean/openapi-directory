...
QString OAIUser::getPrimaryProvisionedNumber() const {
    return m_primary_provisioned_number;
}
void OAIUser::setPrimaryProvisionedNumber(const QString &primary_provisioned_number) {
    m_primary_provisioned_number = primary_provisioned_number;
    m_primary_provisioned_number_isSet = true;
}

bool OAIUser::is_primary_provisioned_number_Set() const{
    return m_primary_provisioned_number_isSet;
}

bool OAIUser::is_primary_provisioned_number_Valid() const{
...
OAILicense OAIUser::getLicenseType() const {
    return m_license_type;
}
void OAIUser::setLicenseType(const OAILicense &license_type) {
    m_license_type = license_type;
    m_license_type_isSet = true;
}

bool OAIUser::is_license_type_Set() const{
    return m_license_type_isSet;
}

bool OAIUser::is_license_type_Valid() const{
    return m_license_type_isValid;
}

OAIUserType OAIUser::getUserType() const {
    return m_user_type;
}
void OAIUser::setUserType(const OAIUserType &user_type) {
...
OAIRegistrationStatus OAIUser::getUserRegistrationStatus() const {
    return m_user_registration_status;
}
void OAIUser::setUserRegistrationStatus(const OAIRegistrationStatus &user_registration_status) {
    m_user_registration_status = user_registration_status;
    m_user_registration_status_isSet = true;
}

bool OAIUser::is_user_registration_status_Set() const{
    return m_user_registration_status_isSet;
}

bool OAIUser::is_user_registration_status_Valid() const{
    return m_user_registration_status_isValid;
}

OAIInviteStatus OAIUser::getUserInvitationStatus() const {
    return m_user_invitation_status;
}
void OAIUser::setUserInvitationStatus(const OAIInviteStatus &user_invitation_status) {
    m_user_invitation_status = user_invitation_status;
    m_user_invitation_status_isSet = true;
}

bool OAIUser::is_user_invitation_status_Set() const{
    return m_user_invitation_status_isSet;
}

bool OAIUser::is_user_invitation_status_Valid() const{
    return m_user_invitation_status_isValid;
}

QDateTime OAIUser::getRegisteredOn() const {
    return m_registered_on;
}
void OAIUser::setRegisteredOn(const QDateTime &registered_on) {
    m_registered_on = registered_on;
    m_registered_on_isSet = true;
}

bool OAIUser::is_registered_on_Set() const{
    return m_registered_on_isSet;
}

bool OAIUser::is_registered_on_Valid() const{
    return m_registered_on_isValid;
}

QDateTime OAIUser::getInvitedOn() const {
    return m_invited_on;
}
void OAIUser::setInvitedOn(const QDateTime &invited_on) {
    m_invited_on = invited_on;
    m_invited_on_isSet = true;
}

bool OAIUser::is_invited_on_Set() const{
    return m_invited_on_isSet;
}

bool OAIUser::is_invited_on_Valid() const{
    return m_invited_on_isValid;
}

OAIUpdateUserRequestItem_AlexaForBusinessMetadata OAIUser::getAlexaForBusinessMetadata() const {
    return m_alexa_for_business_metadata;
}
void OAIUser::setAlexaForBusinessMetadata(const OAIUpdateUserRequestItem_AlexaForBusinessMetadata &alexa_for_business_metadata) {
    m_alexa_for_business_metadata = alexa_for_business_metadata;
    m_alexa_for_business_metadata_isSet = true;
}

bool OAIUser::is_alexa_for_business_metadata_Set() const{
    return m_alexa_for_business_metadata_isSet;
}

bool OAIUser::is_alexa_for_business_metadata_Valid() const{
    return m_alexa_for_business_metadata_isValid;
}

QString OAIUser::getPersonalPin() const {
    return m_personal_pin;
}
void OAIUser::setPersonalPin(const QString &personal_pin) {
    m_personal_pin = personal_pin;
    m_personal_pin_isSet = true;
}

bool OAIUser::is_personal_pin_Set() const{
    return m_personal_pin_isSet;
}

bool OAIUser::is_personal_pin_Valid() const{
