...
QString OAICreateUserResponse_User::getUserId() const {
    return m_user_id;
}
void OAICreateUserResponse_User::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAICreateUserResponse_User::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAICreateUserResponse_User::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAICreateUserResponse_User::getAccountId() const {
    return m_account_id;
}
void OAICreateUserResponse_User::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAICreateUserResponse_User::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAICreateUserResponse_User::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAICreateUserResponse_User::getPrimaryEmail() const {
    return m_primary_email;
}
void OAICreateUserResponse_User::setPrimaryEmail(const QString &primary_email) {
    m_primary_email = primary_email;
    m_primary_email_isSet = true;
}

bool OAICreateUserResponse_User::is_primary_email_Set() const{
    return m_primary_email_isSet;
}

bool OAICreateUserResponse_User::is_primary_email_Valid() const{
    return m_primary_email_isValid;
}

QString OAICreateUserResponse_User::getPrimaryProvisionedNumber() const {
    return m_primary_provisioned_number;
}
void OAICreateUserResponse_User::setPrimaryProvisionedNumber(const QString &primary_provisioned_number) {
    m_primary_provisioned_number = primary_provisioned_number;
    m_primary_provisioned_number_isSet = true;
}

bool OAICreateUserResponse_User::is_primary_provisioned_number_Set() const{
    return m_primary_provisioned_number_isSet;
}

bool OAICreateUserResponse_User::is_primary_provisioned_number_Valid() const{
    return m_primary_provisioned_number_isValid;
}

QString OAICreateUserResponse_User::getDisplayName() const {
    return m_display_name;
}
void OAICreateUserResponse_User::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAICreateUserResponse_User::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAICreateUserResponse_User::is_display_name_Valid() const{
    return m_display_name_isValid;
}

OAILicense OAICreateUserResponse_User::getLicenseType() const {
    return m_license_type;
}
void OAICreateUserResponse_User::setLicenseType(const OAILicense &license_type) {
    m_license_type = license_type;
    m_license_type_isSet = true;
}

bool OAICreateUserResponse_User::is_license_type_Set() const{
    return m_license_type_isSet;
}

bool OAICreateUserResponse_User::is_license_type_Valid() const{
    return m_license_type_isValid;
}

OAIUserType OAICreateUserResponse_User::getUserType() const {
    return m_user_type;
}
void OAICreateUserResponse_User::setUserType(const OAIUserType &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAICreateUserResponse_User::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAICreateUserResponse_User::is_user_type_Valid() const{
    return m_user_type_isValid;
}

OAIRegistrationStatus OAICreateUserResponse_User::getUserRegistrationStatus() const {
    return m_user_registration_status;
}
void OAICreateUserResponse_User::setUserRegistrationStatus(const OAIRegistrationStatus &user_registration_status) {
    m_user_registration_status = user_registration_status;
    m_user_registration_status_isSet = true;
}

bool OAICreateUserResponse_User::is_user_registration_status_Set() const{
    return m_user_registration_status_isSet;
}

bool OAICreateUserResponse_User::is_user_registration_status_Valid() const{
    return m_user_registration_status_isValid;
}

OAIInviteStatus OAICreateUserResponse_User::getUserInvitationStatus() const {
    return m_user_invitation_status;
}
void OAICreateUserResponse_User::setUserInvitationStatus(const OAIInviteStatus &user_invitation_status) {
    m_user_invitation_status = user_invitation_status;
    m_user_invitation_status_isSet = true;
}

bool OAICreateUserResponse_User::is_user_invitation_status_Set() const{
    return m_user_invitation_status_isSet;
}

bool OAICreateUserResponse_User::is_user_invitation_status_Valid() const{
    return m_user_invitation_status_isValid;
}

QDateTime OAICreateUserResponse_User::getRegisteredOn() const {
    return m_registered_on;
}
void OAICreateUserResponse_User::setRegisteredOn(const QDateTime &registered_on) {
    m_registered_on = registered_on;
    m_registered_on_isSet = true;
}

bool OAICreateUserResponse_User::is_registered_on_Set() const{
    return m_registered_on_isSet;
}

bool OAICreateUserResponse_User::is_registered_on_Valid() const{
    return m_registered_on_isValid;
}

QDateTime OAICreateUserResponse_User::getInvitedOn() const {
    return m_invited_on;
}
void OAICreateUserResponse_User::setInvitedOn(const QDateTime &invited_on) {
    m_invited_on = invited_on;
    m_invited_on_isSet = true;
}

bool OAICreateUserResponse_User::is_invited_on_Set() const{
    return m_invited_on_isSet;
}

bool OAICreateUserResponse_User::is_invited_on_Valid() const{
    return m_invited_on_isValid;
}

OAIUpdateUserRequestItem_AlexaForBusinessMetadata OAICreateUserResponse_User::getAlexaForBusinessMetadata() const {
    return m_alexa_for_business_metadata;
}
void OAICreateUserResponse_User::setAlexaForBusinessMetadata(const OAIUpdateUserRequestItem_AlexaForBusinessMetadata &alexa_for_business_metadata) {
    m_alexa_for_business_metadata = alexa_for_business_metadata;
    m_alexa_for_business_metadata_isSet = true;
}

bool OAICreateUserResponse_User::is_alexa_for_business_metadata_Set() const{
    return m_alexa_for_business_metadata_isSet;
}

bool OAICreateUserResponse_User::is_alexa_for_business_metadata_Valid() const{
    return m_alexa_for_business_metadata_isValid;
}

QString OAICreateUserResponse_User::getPersonalPin() const {
    return m_personal_pin;
}
void OAICreateUserResponse_User::setPersonalPin(const QString &personal_pin) {
    m_personal_pin = personal_pin;
    m_personal_pin_isSet = true;
}

bool OAICreateUserResponse_User::is_personal_pin_Set() const{
    return m_personal_pin_isSet;
}

bool OAICreateUserResponse_User::is_personal_pin_Valid() const{
