...
#include "OAIUpdateGlobalSettings_request_BusinessCalling.h"
...
namespace OpenAPI {
class OAIUpdateGlobalSettings_request_BusinessCalling;
class OAIUpdateGlobalSettings_request_VoiceConnector;
...
public:
    ...
    OAIUpdateGlobalSettings_request_BusinessCalling getBusinessCalling() const;
    void setBusinessCalling(const OAIUpdateGlobalSettings_request_BusinessCalling &business_calling);
    bool is_business_calling_Set() const;
    bool is_business_calling_Valid() const;

    OAIUpdateGlobalSettings_request_VoiceConnector getVoiceConnector() const;
    void setVoiceConnector(const OAIUpdateGlobalSettings_request_VoiceConnector &voice_connector);
...
private:
    ...
    OAIUpdateGlobalSettings_request_BusinessCalling m_business_calling;
    bool m_business_calling_isSet;
    bool m_business_calling_isValid;

    OAIUpdateGlobalSettings_request_VoiceConnector m_voice_connector;
