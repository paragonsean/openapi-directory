...
/*
 * OAIUpdateBotResponse_Bot.h
 *
 * 
 */

#ifndef OAIUpdateBotResponse_Bot_H
#define OAIUpdateBotResponse_Bot_H
...
class OAIUpdateBotResponse_Bot : public OAIObject {
public:
    OAIUpdateBotResponse_Bot();
    OAIUpdateBotResponse_Bot(QString json);
    ~OAIUpdateBotResponse_Bot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBotResponse_Bot)

#endif // OAIUpdateBotResponse_Bot_H
