...
/*
 * OAIBatchCreateAttendeeRequest.h
 *
 * 
 */

#ifndef OAIBatchCreateAttendeeRequest_H
#define OAIBatchCreateAttendeeRequest_H
...
class OAIBatchCreateAttendeeRequest : public OAIObject {
public:
    OAIBatchCreateAttendeeRequest();
    OAIBatchCreateAttendeeRequest(QString json);
    ~OAIBatchCreateAttendeeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateAttendeeRequest)

#endif // OAIBatchCreateAttendeeRequest_H
