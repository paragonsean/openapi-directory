...
OAIUpdateSipRuleResponse::OAIUpdateSipRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSipRuleResponse::OAIUpdateSipRuleResponse() {
    this->initializeModel();
}

OAIUpdateSipRuleResponse::~OAIUpdateSipRuleResponse() {}

void OAIUpdateSipRuleResponse::initializeModel() {

    m_sip_rule_isSet = false;
    m_sip_rule_isValid = false;
}

void OAIUpdateSipRuleResponse::fromJson(QString jsonString) {
...
void OAIUpdateSipRuleResponse::fromJsonObject(QJsonObject json) {

    m_sip_rule_isValid = ::OpenAPI::fromJsonValue(m_sip_rule, json[QString("SipRule")]);
    m_sip_rule_isSet = !json[QString("SipRule")].isNull() && m_sip_rule_isValid;
}

QString OAIUpdateSipRuleResponse::asJson() const {
...
QJsonObject OAIUpdateSipRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_sip_rule.isSet()) {
        obj.insert(QString("SipRule"), ::OpenAPI::toJsonValue(m_sip_rule));
    }
    return obj;
}

OAIUpdateSipRuleResponse_SipRule OAIUpdateSipRuleResponse::getSipRule() const {
    return m_sip_rule;
}
void OAIUpdateSipRuleResponse::setSipRule(const OAIUpdateSipRuleResponse_SipRule &sip_rule) {
    m_sip_rule = sip_rule;
    m_sip_rule_isSet = true;
}

bool OAIUpdateSipRuleResponse::is_sip_rule_Set() const{
    return m_sip_rule_isSet;
}

bool OAIUpdateSipRuleResponse::is_sip_rule_Valid() const{
    return m_sip_rule_isValid;
}

bool OAIUpdateSipRuleResponse::isSet() const {
...
bool OAIUpdateSipRuleResponse::isValid() const {
