...
QString OAIMemberType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIMemberType::USER:
            val = "User";
            break;
        case eOAIMemberType::BOT:
            val = "Bot";
            break;
        case eOAIMemberType::WEBHOOK:
            val = "Webhook";
            break;
        default:
            break;
