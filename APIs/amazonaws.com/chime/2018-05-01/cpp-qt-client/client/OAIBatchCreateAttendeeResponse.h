...
/*
 * OAIBatchCreateAttendeeResponse.h
 *
 * 
 */

#ifndef OAIBatchCreateAttendeeResponse_H
#define OAIBatchCreateAttendeeResponse_H
...
class OAIBatchCreateAttendeeResponse : public OAIObject {
public:
    OAIBatchCreateAttendeeResponse();
    OAIBatchCreateAttendeeResponse(QString json);
    ~OAIBatchCreateAttendeeResponse() override;
    ...
    QList getAttendees() const;
    void setAttendees(const QList &attendees);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateAttendeeResponse)

#endif // OAIBatchCreateAttendeeResponse_H
