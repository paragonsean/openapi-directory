...
/*
 * OAIChannelModerator_Moderator.h
 *
 * 
 */

#ifndef OAIChannelModerator_Moderator_H
#define OAIChannelModerator_Moderator_H
...
class OAIChannelModerator_Moderator : public OAIObject {
public:
    OAIChannelModerator_Moderator();
    OAIChannelModerator_Moderator(QString json);
    ~OAIChannelModerator_Moderator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelModerator_Moderator)

#endif // OAIChannelModerator_Moderator_H
