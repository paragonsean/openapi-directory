...
/*
 * OAINumberSelectionBehavior.h
 *
 * 
 */

#ifndef OAINumberSelectionBehavior_H
#define OAINumberSelectionBehavior_H
...
class OAINumberSelectionBehavior : public OAIEnum {
public:
    OAINumberSelectionBehavior();
    OAINumberSelectionBehavior(QString json);
    ~OAINumberSelectionBehavior() override;
    ...
    enum class eOAINumberSelectionBehavior {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PREFERSTICKY, 
        AVOIDSTICKY
    };
    OAINumberSelectionBehavior::eOAINumberSelectionBehavior getValue() const;
    void setValue(const OAINumberSelectionBehavior::eOAINumberSelectionBehavior& value);
...
private:
    ...
    eOAINumberSelectionBehavior m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberSelectionBehavior)

#endif // OAINumberSelectionBehavior_H
