...
/*
 * OAIUpdatePhoneNumberRequestItem.h
 *
...
#ifndef OAIUpdatePhoneNumberRequestItem_H
#define OAIUpdatePhoneNumberRequestItem_H
...
class OAIUpdatePhoneNumberRequestItem : public OAIObject {
public:
    OAIUpdatePhoneNumberRequestItem();
    OAIUpdatePhoneNumberRequestItem(QString json);
    ~OAIUpdatePhoneNumberRequestItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePhoneNumberRequestItem)

#endif // OAIUpdatePhoneNumberRequestItem_H
