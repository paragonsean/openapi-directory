...
OAIUntagAttendee_request::OAIUntagAttendee_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagAttendee_request::OAIUntagAttendee_request() {
    this->initializeModel();
}

OAIUntagAttendee_request::~OAIUntagAttendee_request() {}

void OAIUntagAttendee_request::initializeModel() {

    m_tag_keys_isSet = false;
    m_tag_keys_isValid = false;
}

void OAIUntagAttendee_request::fromJson(QString jsonString) {
...
void OAIUntagAttendee_request::fromJsonObject(QJsonObject json) {
...
QString OAIUntagAttendee_request::asJson() const {
...
QJsonObject OAIUntagAttendee_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIUntagAttendee_request::getTagKeys() const {
    return m_tag_keys;
}
void OAIUntagAttendee_request::setTagKeys(const QList<QString> &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIUntagAttendee_request::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIUntagAttendee_request::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

bool OAIUntagAttendee_request::isSet() const {
...
bool OAIUntagAttendee_request::isValid() const {
