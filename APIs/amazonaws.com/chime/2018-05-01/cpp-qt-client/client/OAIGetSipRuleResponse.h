...
/*
 * OAIGetSipRuleResponse.h
 *
 * 
 */

#ifndef OAIGetSipRuleResponse_H
#define OAIGetSipRuleResponse_H
...
namespace OpenAPI {
class OAIGetSipRuleResponse_SipRule;

class OAIGetSipRuleResponse : public OAIObject {
public:
    OAIGetSipRuleResponse();
    OAIGetSipRuleResponse(QString json);
    ~OAIGetSipRuleResponse() override;
    ...
    OAIGetSipRuleResponse_SipRule getSipRule() const;
    void setSipRule(const OAIGetSipRuleResponse_SipRule &sip_rule);
    bool is_sip_rule_Set() const;
    bool is_sip_rule_Valid() const;
...
private:
    ...
    OAIGetSipRuleResponse_SipRule m_sip_rule;
    bool m_sip_rule_isSet;
    bool m_sip_rule_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetSipRuleResponse)

#endif // OAIGetSipRuleResponse_H
