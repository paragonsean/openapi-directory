...
/*
 * OAIListMediaCapturePipelinesResponse.h
 *
 * 
 */

#ifndef OAIListMediaCapturePipelinesResponse_H
#define OAIListMediaCapturePipelinesResponse_H
...
class OAIListMediaCapturePipelinesResponse : public OAIObject {
public:
    OAIListMediaCapturePipelinesResponse();
    OAIListMediaCapturePipelinesResponse(QString json);
    ~OAIListMediaCapturePipelinesResponse() override;
    ...
    QList getMediaCapturePipelines() const;
    void setMediaCapturePipelines(const QList &media_capture_pipelines);
    bool is_media_capture_pipelines_Set() const;
    bool is_media_capture_pipelines_Valid() const;
...
private:
    ...
    QList m_media_capture_pipelines;
    bool m_media_capture_pipelines_isSet;
    bool m_media_capture_pipelines_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMediaCapturePipelinesResponse)

#endif // OAIListMediaCapturePipelinesResponse_H
