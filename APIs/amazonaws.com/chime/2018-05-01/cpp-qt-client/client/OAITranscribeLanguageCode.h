...
/*
 * OAITranscribeLanguageCode.h
 *
 * 
 */

#ifndef OAITranscribeLanguageCode_H
#define OAITranscribeLanguageCode_H
...
class OAITranscribeLanguageCode : public OAIEnum {
public:
    OAITranscribeLanguageCode();
    OAITranscribeLanguageCode(QString json);
    ~OAITranscribeLanguageCode() override;
    ...
    enum class eOAITranscribeLanguageCode {
    ...
    OAITranscribeLanguageCode::eOAITranscribeLanguageCode getValue() const;
    void setValue(const OAITranscribeLanguageCode::eOAITranscribeLanguageCode& value);
...
private:
    ...
    eOAITranscribeLanguageCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeLanguageCode)

#endif // OAITranscribeLanguageCode_H
