...
/*
 * OAIUntagAttendee_request.h
 *
 * 
 */

#ifndef OAIUntagAttendee_request_H
#define OAIUntagAttendee_request_H
...
class OAIUntagAttendee_request : public OAIObject {
public:
    OAIUntagAttendee_request();
    OAIUntagAttendee_request(QString json);
    ~OAIUntagAttendee_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUntagAttendee_request)

#endif // OAIUntagAttendee_request_H
