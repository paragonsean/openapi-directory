...
QString OAIUpdatePhoneNumber_request::getProductType() const {
    return m_product_type;
}
void OAIUpdatePhoneNumber_request::setProductType(const QString &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAIUpdatePhoneNumber_request::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAIUpdatePhoneNumber_request::is_product_type_Valid() const{
    return m_product_type_isValid;
}

QString OAIUpdatePhoneNumber_request::getCallingName() const {
    return m_calling_name;
}
void OAIUpdatePhoneNumber_request::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIUpdatePhoneNumber_request::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIUpdatePhoneNumber_request::is_calling_name_Valid() const{
