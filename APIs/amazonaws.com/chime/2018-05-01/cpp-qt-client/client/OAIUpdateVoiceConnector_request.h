...
/*
 * OAIUpdateVoiceConnector_request.h
 *
 * 
 */

#ifndef OAIUpdateVoiceConnector_request_H
#define OAIUpdateVoiceConnector_request_H
...
class OAIUpdateVoiceConnector_request : public OAIObject {
public:
    OAIUpdateVoiceConnector_request();
    OAIUpdateVoiceConnector_request(QString json);
    ~OAIUpdateVoiceConnector_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateVoiceConnector_request)

#endif // OAIUpdateVoiceConnector_request_H
