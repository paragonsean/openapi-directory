...
/*
 * OAIPhoneNumberOrder.h
 *
 * The details of a phone number order created for Amazon Chime.
 */

#ifndef OAIPhoneNumberOrder_H
#define OAIPhoneNumberOrder_H
...
class OAIPhoneNumberOrder : public OAIObject {
public:
    OAIPhoneNumberOrder();
    OAIPhoneNumberOrder(QString json);
    ~OAIPhoneNumberOrder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberOrder)

#endif // OAIPhoneNumberOrder_H
