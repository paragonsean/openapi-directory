...
OAIPutEventsConfiguration_request::OAIPutEventsConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutEventsConfiguration_request::OAIPutEventsConfiguration_request() {
    this->initializeModel();
}

OAIPutEventsConfiguration_request::~OAIPutEventsConfiguration_request() {}

void OAIPutEventsConfiguration_request::initializeModel() {
...
void OAIPutEventsConfiguration_request::fromJson(QString jsonString) {
...
void OAIPutEventsConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutEventsConfiguration_request::asJson() const {
...
QJsonObject OAIPutEventsConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutEventsConfiguration_request::getOutboundEventsHttpsEndpoint() const {
    return m_outbound_events_https_endpoint;
}
void OAIPutEventsConfiguration_request::setOutboundEventsHttpsEndpoint(const QString &outbound_events_https_endpoint) {
    m_outbound_events_https_endpoint = outbound_events_https_endpoint;
    m_outbound_events_https_endpoint_isSet = true;
}

bool OAIPutEventsConfiguration_request::is_outbound_events_https_endpoint_Set() const{
    return m_outbound_events_https_endpoint_isSet;
}

bool OAIPutEventsConfiguration_request::is_outbound_events_https_endpoint_Valid() const{
    return m_outbound_events_https_endpoint_isValid;
}

QString OAIPutEventsConfiguration_request::getLambdaFunctionArn() const {
    return m_lambda_function_arn;
}
void OAIPutEventsConfiguration_request::setLambdaFunctionArn(const QString &lambda_function_arn) {
    m_lambda_function_arn = lambda_function_arn;
    m_lambda_function_arn_isSet = true;
}

bool OAIPutEventsConfiguration_request::is_lambda_function_arn_Set() const{
    return m_lambda_function_arn_isSet;
}

bool OAIPutEventsConfiguration_request::is_lambda_function_arn_Valid() const{
    return m_lambda_function_arn_isValid;
}

bool OAIPutEventsConfiguration_request::isSet() const {
...
bool OAIPutEventsConfiguration_request::isValid() const {
