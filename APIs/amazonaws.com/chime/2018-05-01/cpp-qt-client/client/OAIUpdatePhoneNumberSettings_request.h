...
/*
 * OAIUpdatePhoneNumberSettings_request.h
 *
 * 
 */

#ifndef OAIUpdatePhoneNumberSettings_request_H
#define OAIUpdatePhoneNumberSettings_request_H
...
class OAIUpdatePhoneNumberSettings_request : public OAIObject {
public:
    OAIUpdatePhoneNumberSettings_request();
    OAIUpdatePhoneNumberSettings_request(QString json);
    ~OAIUpdatePhoneNumberSettings_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePhoneNumberSettings_request)

#endif // OAIUpdatePhoneNumberSettings_request_H
