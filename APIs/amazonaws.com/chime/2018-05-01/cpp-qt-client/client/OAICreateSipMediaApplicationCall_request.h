...
/*
 * OAICreateSipMediaApplicationCall_request.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplicationCall_request_H
#define OAICreateSipMediaApplicationCall_request_H
...
class OAICreateSipMediaApplicationCall_request : public OAIObject {
public:
    OAICreateSipMediaApplicationCall_request();
    OAICreateSipMediaApplicationCall_request(QString json);
    ~OAICreateSipMediaApplicationCall_request() override;
    ...
    QString getFromPhoneNumber() const;
    void setFromPhoneNumber(const QString &from_phone_number);
    bool is_from_phone_number_Set() const;
    bool is_from_phone_number_Valid() const;

    QString getToPhoneNumber() const;
    void setToPhoneNumber(const QString &to_phone_number);
    bool is_to_phone_number_Set() const;
    bool is_to_phone_number_Valid() const;

    QMap<QString, QString> getSipHeaders() const;
    void setSipHeaders(const QMap<QString, QString> &sip_headers);
    bool is_sip_headers_Set() const;
    bool is_sip_headers_Valid() const;
...
private:
    ...
    QString m_from_phone_number;
    bool m_from_phone_number_isSet;
    bool m_from_phone_number_isValid;

    QString m_to_phone_number;
    bool m_to_phone_number_isSet;
    bool m_to_phone_number_isValid;

    QMap<QString, QString> m_sip_headers;
    bool m_sip_headers_isSet;
    bool m_sip_headers_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplicationCall_request)

#endif // OAICreateSipMediaApplicationCall_request_H
