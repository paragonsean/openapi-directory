...
/*
 * OAITagMeeting_request.h
 *
 * 
 */

#ifndef OAITagMeeting_request_H
#define OAITagMeeting_request_H
...
class OAITagMeeting_request : public OAIObject {
public:
    OAITagMeeting_request();
    OAITagMeeting_request(QString json);
    ~OAITagMeeting_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagMeeting_request)

#endif // OAITagMeeting_request_H
