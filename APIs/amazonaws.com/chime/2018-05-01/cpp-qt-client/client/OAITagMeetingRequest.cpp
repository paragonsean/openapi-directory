...
#include "OAITagMeetingRequest.h"
...
OAITagMeetingRequest::OAITagMeetingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagMeetingRequest::OAITagMeetingRequest() {
    this->initializeModel();
}

OAITagMeetingRequest::~OAITagMeetingRequest() {}

void OAITagMeetingRequest::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagMeetingRequest::fromJson(QString jsonString) {
...
void OAITagMeetingRequest::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagMeetingRequest::asJson() const {
...
QJsonObject OAITagMeetingRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QList OAITagMeetingRequest::getTags() const {
    return m_tags;
}
void OAITagMeetingRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagMeetingRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagMeetingRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagMeetingRequest::isSet() const {
...
bool OAITagMeetingRequest::isValid() const {
