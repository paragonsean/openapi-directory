...
OAIChannelBan::OAIChannelBan(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelBan::OAIChannelBan() {
    this->initializeModel();
}

OAIChannelBan::~OAIChannelBan() {}

void OAIChannelBan::initializeModel() {
...
void OAIChannelBan::fromJson(QString jsonString) {
...
void OAIChannelBan::fromJsonObject(QJsonObject json) {
...
QString OAIChannelBan::asJson() const {
...
QJsonObject OAIChannelBan::asJsonObject() const {
    QJsonObject obj;
    if (m_member.isSet()) {
...
OAIChannelBan_Member OAIChannelBan::getMember() const {
    return m_member;
}
void OAIChannelBan::setMember(const OAIChannelBan_Member &member) {
    m_member = member;
    m_member_isSet = true;
}

bool OAIChannelBan::is_member_Set() const{
    return m_member_isSet;
}

bool OAIChannelBan::is_member_Valid() const{
    return m_member_isValid;
}

QString OAIChannelBan::getChannelArn() const {
    return m_channel_arn;
}
void OAIChannelBan::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAIChannelBan::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAIChannelBan::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QDateTime OAIChannelBan::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIChannelBan::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIChannelBan::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIChannelBan::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

OAIChannelBan_CreatedBy OAIChannelBan::getCreatedBy() const {
    return m_created_by;
}
void OAIChannelBan::setCreatedBy(const OAIChannelBan_CreatedBy &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIChannelBan::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIChannelBan::is_created_by_Valid() const{
    return m_created_by_isValid;
}

bool OAIChannelBan::isSet() const {
...
bool OAIChannelBan::isValid() const {
