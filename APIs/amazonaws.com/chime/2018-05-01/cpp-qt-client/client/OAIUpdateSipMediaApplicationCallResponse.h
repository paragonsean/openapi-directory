...
/*
 * OAIUpdateSipMediaApplicationCallResponse.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationCallResponse_H
#define OAIUpdateSipMediaApplicationCallResponse_H
...
namespace OpenAPI {
class OAIUpdateSipMediaApplicationCallResponse_SipMediaApplicationCall;

class OAIUpdateSipMediaApplicationCallResponse : public OAIObject {
public:
    OAIUpdateSipMediaApplicationCallResponse();
    OAIUpdateSipMediaApplicationCallResponse(QString json);
    ~OAIUpdateSipMediaApplicationCallResponse() override;
    ...
    OAIUpdateSipMediaApplicationCallResponse_SipMediaApplicationCall getSipMediaApplicationCall() const;
    void setSipMediaApplicationCall(const OAIUpdateSipMediaApplicationCallResponse_SipMediaApplicationCall &sip_media_application_call);
    bool is_sip_media_application_call_Set() const;
    bool is_sip_media_application_call_Valid() const;
...
private:
    ...
    OAIUpdateSipMediaApplicationCallResponse_SipMediaApplicationCall m_sip_media_application_call;
    bool m_sip_media_application_call_isSet;
    bool m_sip_media_application_call_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationCallResponse)

#endif // OAIUpdateSipMediaApplicationCallResponse_H
