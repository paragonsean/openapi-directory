...
OAISipMediaApplicationEndpoint::OAISipMediaApplicationEndpoint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISipMediaApplicationEndpoint::OAISipMediaApplicationEndpoint() {
    this->initializeModel();
}

OAISipMediaApplicationEndpoint::~OAISipMediaApplicationEndpoint() {}

void OAISipMediaApplicationEndpoint::initializeModel() {

    m_lambda_arn_isSet = false;
    m_lambda_arn_isValid = false;
}

void OAISipMediaApplicationEndpoint::fromJson(QString jsonString) {
...
void OAISipMediaApplicationEndpoint::fromJsonObject(QJsonObject json) {
...
QString OAISipMediaApplicationEndpoint::asJson() const {
...
QJsonObject OAISipMediaApplicationEndpoint::asJsonObject() const {
    QJsonObject obj;
...
QString OAISipMediaApplicationEndpoint::getLambdaArn() const {
    return m_lambda_arn;
}
void OAISipMediaApplicationEndpoint::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAISipMediaApplicationEndpoint::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAISipMediaApplicationEndpoint::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

bool OAISipMediaApplicationEndpoint::isSet() const {
...
bool OAISipMediaApplicationEndpoint::isValid() const {
