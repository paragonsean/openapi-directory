...
/*
 * OAIGetVoiceConnectorResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorResponse_H
#define OAIGetVoiceConnectorResponse_H
...
namespace OpenAPI {
class OAICreateVoiceConnectorResponse_VoiceConnector;

class OAIGetVoiceConnectorResponse : public OAIObject {
public:
    OAIGetVoiceConnectorResponse();
    OAIGetVoiceConnectorResponse(QString json);
    ~OAIGetVoiceConnectorResponse() override;
    ...
    OAICreateVoiceConnectorResponse_VoiceConnector getVoiceConnector() const;
    void setVoiceConnector(const OAICreateVoiceConnectorResponse_VoiceConnector &voice_connector);
...
private:
    ...
    OAICreateVoiceConnectorResponse_VoiceConnector m_voice_connector;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorResponse)

#endif // OAIGetVoiceConnectorResponse_H
