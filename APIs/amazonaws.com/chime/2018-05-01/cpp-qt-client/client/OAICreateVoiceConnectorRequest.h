...
/*
 * OAICreateVoiceConnectorRequest.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorRequest_H
#define OAICreateVoiceConnectorRequest_H
...
class OAICreateVoiceConnectorRequest : public OAIObject {
public:
    OAICreateVoiceConnectorRequest();
    OAICreateVoiceConnectorRequest(QString json);
    ~OAICreateVoiceConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorRequest)

#endif // OAICreateVoiceConnectorRequest_H
