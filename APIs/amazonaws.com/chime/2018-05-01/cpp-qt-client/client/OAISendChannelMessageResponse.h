...
/*
 * OAISendChannelMessageResponse.h
 *
 * 
 */

#ifndef OAISendChannelMessageResponse_H
#define OAISendChannelMessageResponse_H
...
class OAISendChannelMessageResponse : public OAIObject {
public:
    OAISendChannelMessageResponse();
    OAISendChannelMessageResponse(QString json);
    ~OAISendChannelMessageResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendChannelMessageResponse)

#endif // OAISendChannelMessageResponse_H
