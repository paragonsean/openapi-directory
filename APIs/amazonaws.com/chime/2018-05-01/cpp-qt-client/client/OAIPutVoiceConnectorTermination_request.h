...
/*
 * OAIPutVoiceConnectorTermination_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorTermination_request_H
#define OAIPutVoiceConnectorTermination_request_H

#include <QJsonObject>

#include "OAIPutVoiceConnectorTermination_request_Termination.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutVoiceConnectorTermination_request_Termination;

class OAIPutVoiceConnectorTermination_request : public OAIObject {
public:
    OAIPutVoiceConnectorTermination_request();
    OAIPutVoiceConnectorTermination_request(QString json);
    ~OAIPutVoiceConnectorTermination_request() override;
    ...
    OAIPutVoiceConnectorTermination_request_Termination getTermination() const;
    void setTermination(const OAIPutVoiceConnectorTermination_request_Termination &termination);
...
private:
    ...
    OAIPutVoiceConnectorTermination_request_Termination m_termination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorTermination_request)

#endif // OAIPutVoiceConnectorTermination_request_H
