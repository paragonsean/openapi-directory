...
/*
 * OAIListAttendeesResponse.h
 *
 * 
 */

#ifndef OAIListAttendeesResponse_H
#define OAIListAttendeesResponse_H
...
class OAIListAttendeesResponse : public OAIObject {
public:
    OAIListAttendeesResponse();
    OAIListAttendeesResponse(QString json);
    ~OAIListAttendeesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAttendeesResponse)

#endif // OAIListAttendeesResponse_H
