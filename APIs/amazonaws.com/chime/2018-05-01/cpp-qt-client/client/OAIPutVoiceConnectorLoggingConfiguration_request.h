...
/*
 * OAIPutVoiceConnectorLoggingConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorLoggingConfiguration_request_H
#define OAIPutVoiceConnectorLoggingConfiguration_request_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration;

class OAIPutVoiceConnectorLoggingConfiguration_request : public OAIObject {
public:
    OAIPutVoiceConnectorLoggingConfiguration_request();
    OAIPutVoiceConnectorLoggingConfiguration_request(QString json);
    ~OAIPutVoiceConnectorLoggingConfiguration_request() override;
    ...
    OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration &logging_configuration);
...
private:
    ...
    OAIPutVoiceConnectorLoggingConfiguration_request_LoggingConfiguration m_logging_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorLoggingConfiguration_request)

#endif // OAIPutVoiceConnectorLoggingConfiguration_request_H
