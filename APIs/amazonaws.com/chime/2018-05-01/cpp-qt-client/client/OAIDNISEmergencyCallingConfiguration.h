...
/*
 * OAIDNISEmergencyCallingConfiguration.h
 *
...
#ifndef OAIDNISEmergencyCallingConfiguration_H
#define OAIDNISEmergencyCallingConfiguration_H
...
class OAIDNISEmergencyCallingConfiguration : public OAIObject {
public:
    OAIDNISEmergencyCallingConfiguration();
    OAIDNISEmergencyCallingConfiguration(QString json);
    ~OAIDNISEmergencyCallingConfiguration() override;
    ...
    QString getEmergencyPhoneNumber() const;
    void setEmergencyPhoneNumber(const QString &emergency_phone_number);
    bool is_emergency_phone_number_Set() const;
    bool is_emergency_phone_number_Valid() const;

    QString getTestPhoneNumber() const;
    void setTestPhoneNumber(const QString &test_phone_number);
    bool is_test_phone_number_Set() const;
    bool is_test_phone_number_Valid() const;

    QString getCallingCountry() const;
    void setCallingCountry(const QString &calling_country);
    bool is_calling_country_Set() const;
    bool is_calling_country_Valid() const;
...
private:
    ...
    QString m_emergency_phone_number;
    bool m_emergency_phone_number_isSet;
    bool m_emergency_phone_number_isValid;

    QString m_test_phone_number;
    bool m_test_phone_number_isSet;
    bool m_test_phone_number_isValid;

    QString m_calling_country;
    bool m_calling_country_isSet;
    bool m_calling_country_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDNISEmergencyCallingConfiguration)

#endif // OAIDNISEmergencyCallingConfiguration_H
