...
#include "OAIGetPhoneNumberResponse_PhoneNumber.h"
...
OAIGetPhoneNumberResponse_PhoneNumber::OAIGetPhoneNumberResponse_PhoneNumber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPhoneNumberResponse_PhoneNumber::OAIGetPhoneNumberResponse_PhoneNumber() {
    this->initializeModel();
}

OAIGetPhoneNumberResponse_PhoneNumber::~OAIGetPhoneNumberResponse_PhoneNumber() {}

void OAIGetPhoneNumberResponse_PhoneNumber::initializeModel() {
...
void OAIGetPhoneNumberResponse_PhoneNumber::fromJson(QString jsonString) {
...
void OAIGetPhoneNumberResponse_PhoneNumber::fromJsonObject(QJsonObject json) {
...
QString OAIGetPhoneNumberResponse_PhoneNumber::asJson() const {
...
QJsonObject OAIGetPhoneNumberResponse_PhoneNumber::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPhoneNumberResponse_PhoneNumber::getPhoneNumberId() const {
    return m_phone_number_id;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setPhoneNumberId(const QString &phone_number_id) {
    m_phone_number_id = phone_number_id;
    m_phone_number_id_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_phone_number_id_Set() const{
    return m_phone_number_id_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_phone_number_id_Valid() const{
    return m_phone_number_id_isValid;
}

QString OAIGetPhoneNumberResponse_PhoneNumber::getE164PhoneNumber() const {
    return m_e164_phone_number;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setE164PhoneNumber(const QString &e164_phone_number) {
    m_e164_phone_number = e164_phone_number;
    m_e164_phone_number_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_e164_phone_number_Set() const{
    return m_e164_phone_number_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_e164_phone_number_Valid() const{
    return m_e164_phone_number_isValid;
}

QString OAIGetPhoneNumberResponse_PhoneNumber::getCountry() const {
    return m_country;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_country_Set() const{
    return m_country_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_country_Valid() const{
    return m_country_isValid;
}

OAIPhoneNumberType OAIGetPhoneNumberResponse_PhoneNumber::getType() const {
    return m_type;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setType(const OAIPhoneNumberType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_type_Valid() const{
    return m_type_isValid;
}

OAIPhoneNumberProductType OAIGetPhoneNumberResponse_PhoneNumber::getProductType() const {
    return m_product_type;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setProductType(const OAIPhoneNumberProductType &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_product_type_Valid() const{
    return m_product_type_isValid;
}

OAIPhoneNumberStatus OAIGetPhoneNumberResponse_PhoneNumber::getStatus() const {
    return m_status;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setStatus(const OAIPhoneNumberStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_status_Valid() const{
    return m_status_isValid;
}

OAIPhoneNumber_Capabilities OAIGetPhoneNumberResponse_PhoneNumber::getCapabilities() const {
    return m_capabilities;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setCapabilities(const OAIPhoneNumber_Capabilities &capabilities) {
    m_capabilities = capabilities;
    m_capabilities_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_capabilities_Set() const{
    return m_capabilities_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_capabilities_Valid() const{
    return m_capabilities_isValid;
}

QList OAIGetPhoneNumberResponse_PhoneNumber::getAssociations() const {
    return m_associations;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setAssociations(const QList &associations) {
    m_associations = associations;
    m_associations_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_associations_Set() const{
    return m_associations_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_associations_Valid() const{
    return m_associations_isValid;
}

QString OAIGetPhoneNumberResponse_PhoneNumber::getCallingName() const {
    return m_calling_name;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setCallingName(const QString &calling_name) {
    m_calling_name = calling_name;
    m_calling_name_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_calling_name_Set() const{
    return m_calling_name_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_calling_name_Valid() const{
    return m_calling_name_isValid;
}

OAICallingNameStatus OAIGetPhoneNumberResponse_PhoneNumber::getCallingNameStatus() const {
    return m_calling_name_status;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setCallingNameStatus(const OAICallingNameStatus &calling_name_status) {
    m_calling_name_status = calling_name_status;
    m_calling_name_status_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_calling_name_status_Set() const{
    return m_calling_name_status_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_calling_name_status_Valid() const{
    return m_calling_name_status_isValid;
}

QDateTime OAIGetPhoneNumberResponse_PhoneNumber::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIGetPhoneNumberResponse_PhoneNumber::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QDateTime OAIGetPhoneNumberResponse_PhoneNumber::getDeletionTimestamp() const {
    return m_deletion_timestamp;
}
void OAIGetPhoneNumberResponse_PhoneNumber::setDeletionTimestamp(const QDateTime &deletion_timestamp) {
    m_deletion_timestamp = deletion_timestamp;
    m_deletion_timestamp_isSet = true;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_deletion_timestamp_Set() const{
    return m_deletion_timestamp_isSet;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::is_deletion_timestamp_Valid() const{
    return m_deletion_timestamp_isValid;
}

bool OAIGetPhoneNumberResponse_PhoneNumber::isSet() const {
...
bool OAIGetPhoneNumberResponse_PhoneNumber::isValid() const {
