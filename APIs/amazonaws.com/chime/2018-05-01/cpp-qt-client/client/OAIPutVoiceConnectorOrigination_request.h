...
/*
 * OAIPutVoiceConnectorOrigination_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorOrigination_request_H
#define OAIPutVoiceConnectorOrigination_request_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorOrigination_request_Origination;

class OAIPutVoiceConnectorOrigination_request : public OAIObject {
public:
    OAIPutVoiceConnectorOrigination_request();
    OAIPutVoiceConnectorOrigination_request(QString json);
    ~OAIPutVoiceConnectorOrigination_request() override;
    ...
    OAIPutVoiceConnectorOrigination_request_Origination getOrigination() const;
    void setOrigination(const OAIPutVoiceConnectorOrigination_request_Origination &origination);
...
private:
    ...
    OAIPutVoiceConnectorOrigination_request_Origination m_origination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorOrigination_request)

#endif // OAIPutVoiceConnectorOrigination_request_H
