...
public:
    ...
    QString getAttendeeId() const;
    void setAttendeeId(const QString &attendee_id);
    bool is_attendee_id_Set() const;
    bool is_attendee_id_Valid() const;

    QString getJoinToken() const;
    void setJoinToken(const QString &join_token);
    bool is_join_token_Set() const;
    bool is_join_token_Valid() const;
...
private:
    ...
    QString m_attendee_id;
    bool m_attendee_id_isSet;
    bool m_attendee_id_isValid;

    QString m_join_token;
    bool m_join_token_isSet;
    bool m_join_token_isValid;
};
