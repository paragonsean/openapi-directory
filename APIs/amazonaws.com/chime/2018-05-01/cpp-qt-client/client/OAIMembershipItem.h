...
#ifndef OAIMembershipItem_H
#define OAIMembershipItem_H
...
class OAIMembershipItem : public OAIObject {
public:
    OAIMembershipItem();
    OAIMembershipItem(QString json);
    ~OAIMembershipItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMembershipItem)

#endif // OAIMembershipItem_H
