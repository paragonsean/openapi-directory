...
OAIListMeetingTagsResponse::OAIListMeetingTagsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListMeetingTagsResponse::OAIListMeetingTagsResponse() {
    this->initializeModel();
}

OAIListMeetingTagsResponse::~OAIListMeetingTagsResponse() {}

void OAIListMeetingTagsResponse::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAIListMeetingTagsResponse::fromJson(QString jsonString) {
...
void OAIListMeetingTagsResponse::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAIListMeetingTagsResponse::asJson() const {
...
QJsonObject OAIListMeetingTagsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.isSet()) {
...
QList OAIListMeetingTagsResponse::getTags() const {
    return m_tags;
}
void OAIListMeetingTagsResponse::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIListMeetingTagsResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIListMeetingTagsResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIListMeetingTagsResponse::isSet() const {
...
bool OAIListMeetingTagsResponse::isValid() const {
