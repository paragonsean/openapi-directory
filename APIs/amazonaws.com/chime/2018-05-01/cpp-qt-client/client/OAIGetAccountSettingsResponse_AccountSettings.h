...
/*
 * OAIGetAccountSettingsResponse_AccountSettings.h
 *
 * 
 */

#ifndef OAIGetAccountSettingsResponse_AccountSettings_H
#define OAIGetAccountSettingsResponse_AccountSettings_H
...
class OAIGetAccountSettingsResponse_AccountSettings : public OAIObject {
public:
    OAIGetAccountSettingsResponse_AccountSettings();
    OAIGetAccountSettingsResponse_AccountSettings(QString json);
    ~OAIGetAccountSettingsResponse_AccountSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAccountSettingsResponse_AccountSettings)

#endif // OAIGetAccountSettingsResponse_AccountSettings_H
