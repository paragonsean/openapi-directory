...
/*
 * OAIListMeetingsResponse.h
 *
 * 
 */

#ifndef OAIListMeetingsResponse_H
#define OAIListMeetingsResponse_H
...
class OAIListMeetingsResponse : public OAIObject {
public:
    OAIListMeetingsResponse();
    OAIListMeetingsResponse(QString json);
    ~OAIListMeetingsResponse() override;
    ...
    QList getMeetings() const;
    void setMeetings(const QList &meetings);
    bool is_meetings_Set() const;
    bool is_meetings_Valid() const;
...
private:
    ...
    QList m_meetings;
    bool m_meetings_isSet;
    bool m_meetings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListMeetingsResponse)

#endif // OAIListMeetingsResponse_H
