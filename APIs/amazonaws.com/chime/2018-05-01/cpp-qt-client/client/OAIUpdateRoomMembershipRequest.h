...
/*
 * OAIUpdateRoomMembershipRequest.h
 *
 * 
 */

#ifndef OAIUpdateRoomMembershipRequest_H
#define OAIUpdateRoomMembershipRequest_H
...
class OAIUpdateRoomMembershipRequest : public OAIObject {
public:
    OAIUpdateRoomMembershipRequest();
    OAIUpdateRoomMembershipRequest(QString json);
    ~OAIUpdateRoomMembershipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoomMembershipRequest)

#endif // OAIUpdateRoomMembershipRequest_H
