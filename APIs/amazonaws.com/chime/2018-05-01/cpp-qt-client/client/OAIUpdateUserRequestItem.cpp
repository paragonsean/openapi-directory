...
#include "OAIUpdateUserRequestItem.h"
...
OAIUpdateUserRequestItem::OAIUpdateUserRequestItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserRequestItem::OAIUpdateUserRequestItem() {
    this->initializeModel();
}

OAIUpdateUserRequestItem::~OAIUpdateUserRequestItem() {}

void OAIUpdateUserRequestItem::initializeModel() {
...
void OAIUpdateUserRequestItem::fromJson(QString jsonString) {
...
void OAIUpdateUserRequestItem::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserRequestItem::asJson() const {
...
QJsonObject OAIUpdateUserRequestItem::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_isSet) {
...
QString OAIUpdateUserRequestItem::getUserId() const {
    return m_user_id;
}
void OAIUpdateUserRequestItem::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUpdateUserRequestItem::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUpdateUserRequestItem::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAILicense OAIUpdateUserRequestItem::getLicenseType() const {
    return m_license_type;
}
void OAIUpdateUserRequestItem::setLicenseType(const OAILicense &license_type) {
    m_license_type = license_type;
    m_license_type_isSet = true;
}

bool OAIUpdateUserRequestItem::is_license_type_Set() const{
    return m_license_type_isSet;
}

bool OAIUpdateUserRequestItem::is_license_type_Valid() const{
    return m_license_type_isValid;
}

OAIUserType OAIUpdateUserRequestItem::getUserType() const {
    return m_user_type;
}
void OAIUpdateUserRequestItem::setUserType(const OAIUserType &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIUpdateUserRequestItem::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIUpdateUserRequestItem::is_user_type_Valid() const{
    return m_user_type_isValid;
}

OAIUpdateUserRequestItem_AlexaForBusinessMetadata OAIUpdateUserRequestItem::getAlexaForBusinessMetadata() const {
    return m_alexa_for_business_metadata;
}
void OAIUpdateUserRequestItem::setAlexaForBusinessMetadata(const OAIUpdateUserRequestItem_AlexaForBusinessMetadata &alexa_for_business_metadata) {
    m_alexa_for_business_metadata = alexa_for_business_metadata;
    m_alexa_for_business_metadata_isSet = true;
}

bool OAIUpdateUserRequestItem::is_alexa_for_business_metadata_Set() const{
    return m_alexa_for_business_metadata_isSet;
}

bool OAIUpdateUserRequestItem::is_alexa_for_business_metadata_Valid() const{
    return m_alexa_for_business_metadata_isValid;
}

bool OAIUpdateUserRequestItem::isSet() const {
...
bool OAIUpdateUserRequestItem::isValid() const {
