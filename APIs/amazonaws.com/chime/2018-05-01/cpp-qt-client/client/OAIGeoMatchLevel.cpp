...
OAIGeoMatchLevel::OAIGeoMatchLevel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeoMatchLevel::OAIGeoMatchLevel() {
    this->initializeModel();
}

OAIGeoMatchLevel::~OAIGeoMatchLevel() {}

void OAIGeoMatchLevel::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIGeoMatchLevel::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIGeoMatchLevel::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Country", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGeoMatchLevel::COUNTRY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AreaCode", Qt::CaseInsensitive) == 0) {
        m_value = eOAIGeoMatchLevel::AREACODE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIGeoMatchLevel::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIGeoMatchLevel::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIGeoMatchLevel::COUNTRY:
            val = "Country";
            break;
        case eOAIGeoMatchLevel::AREACODE:
            val = "AreaCode";
            break;
        default:
            break;
...
QJsonValue OAIGeoMatchLevel::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIGeoMatchLevel::eOAIGeoMatchLevel OAIGeoMatchLevel::getValue() const {
    return m_value;
}

void OAIGeoMatchLevel::setValue(const OAIGeoMatchLevel::eOAIGeoMatchLevel& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIGeoMatchLevel::isSet() const {
    
    return m_value_isSet;
}

bool OAIGeoMatchLevel::isValid() const {
