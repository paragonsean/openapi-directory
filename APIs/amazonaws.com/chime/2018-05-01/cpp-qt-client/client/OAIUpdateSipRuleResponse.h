...
/*
 * OAIUpdateSipRuleResponse.h
 *
 * 
 */

#ifndef OAIUpdateSipRuleResponse_H
#define OAIUpdateSipRuleResponse_H
...
namespace OpenAPI {
class OAIUpdateSipRuleResponse_SipRule;

class OAIUpdateSipRuleResponse : public OAIObject {
public:
    OAIUpdateSipRuleResponse();
    OAIUpdateSipRuleResponse(QString json);
    ~OAIUpdateSipRuleResponse() override;
    ...
    OAIUpdateSipRuleResponse_SipRule getSipRule() const;
    void setSipRule(const OAIUpdateSipRuleResponse_SipRule &sip_rule);
...
private:
    ...
    OAIUpdateSipRuleResponse_SipRule m_sip_rule;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipRuleResponse)

#endif // OAIUpdateSipRuleResponse_H
