...
/*
 * OAIInviteUsers_request.h
 *
 * 
 */

#ifndef OAIInviteUsers_request_H
#define OAIInviteUsers_request_H
...
class OAIInviteUsers_request : public OAIObject {
public:
    OAIInviteUsers_request();
    OAIInviteUsers_request(QString json);
    ~OAIInviteUsers_request() override;
    ...
    QList<QString> getUserEmailList() const;
    void setUserEmailList(const QList<QString> &user_email_list);
...
private:
    ...
    QList<QString> m_user_email_list;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInviteUsers_request)

#endif // OAIInviteUsers_request_H
