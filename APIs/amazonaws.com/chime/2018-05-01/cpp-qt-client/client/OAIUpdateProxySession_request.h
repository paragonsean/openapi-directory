...
/*
 * OAIUpdateProxySession_request.h
 *
 * 
 */

#ifndef OAIUpdateProxySession_request_H
#define OAIUpdateProxySession_request_H
...
class OAIUpdateProxySession_request : public OAIObject {
public:
    OAIUpdateProxySession_request();
    OAIUpdateProxySession_request(QString json);
    ~OAIUpdateProxySession_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProxySession_request)

#endif // OAIUpdateProxySession_request_H
