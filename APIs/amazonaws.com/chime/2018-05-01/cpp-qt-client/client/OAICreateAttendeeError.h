...
/*
 * OAICreateAttendeeError.h
 *
 * The list of errors returned when errors are encountered during the BatchCreateAttendee and CreateAttendee actions. This includes external user IDs, error codes, and error messages.
 */

#ifndef OAICreateAttendeeError_H
#define OAICreateAttendeeError_H
...
class OAICreateAttendeeError : public OAIObject {
public:
    OAICreateAttendeeError();
    OAICreateAttendeeError(QString json);
    ~OAICreateAttendeeError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAttendeeError)

#endif // OAICreateAttendeeError_H
