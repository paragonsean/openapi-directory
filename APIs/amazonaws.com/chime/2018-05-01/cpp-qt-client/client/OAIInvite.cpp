...
void OAIInvite::fromJsonObject(QJsonObject json) {
    ...
    m_invite_id_isValid = ::OpenAPI::fromJsonValue(m_invite_id, json[QString("InviteId")]);
    m_invite_id_isSet = !json[QString("InviteId")].isNull() && m_invite_id_isValid;
    ...
    m_email_status_isValid = ::OpenAPI::fromJsonValue(m_email_status, json[QString("EmailStatus")]);
    m_email_status_isSet = !json[QString("EmailStatus")].isNull() && m_email_status_isValid;
}
...
QJsonObject OAIInvite::asJsonObject() const {
    ...
    if (m_invite_id_isSet) {
        obj.insert(QString("InviteId"), ::OpenAPI::toJsonValue(m_invite_id));
    }
    if (m_status.isSet()) {
    ...
    if (m_email_status.isSet()) {
        obj.insert(QString("EmailStatus"), ::OpenAPI::toJsonValue(m_email_status));
    }
    return obj;
}

QString OAIInvite::getInviteId() const {
    return m_invite_id;
}
void OAIInvite::setInviteId(const QString &invite_id) {
    m_invite_id = invite_id;
    m_invite_id_isSet = true;
}

bool OAIInvite::is_invite_id_Set() const{
    return m_invite_id_isSet;
}

bool OAIInvite::is_invite_id_Valid() const{
    return m_invite_id_isValid;
}

OAIInviteStatus OAIInvite::getStatus() const {
    return m_status;
}
void OAIInvite::setStatus(const OAIInviteStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
QString OAIInvite::getEmailAddress() const {
    return m_email_address;
}
void OAIInvite::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIInvite::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIInvite::is_email_address_Valid() const{
    return m_email_address_isValid;
}

OAIEmailStatus OAIInvite::getEmailStatus() const {
    return m_email_status;
}
void OAIInvite::setEmailStatus(const OAIEmailStatus &email_status) {
    m_email_status = email_status;
    m_email_status_isSet = true;
}

bool OAIInvite::is_email_status_Set() const{
    return m_email_status_isSet;
}

bool OAIInvite::is_email_status_Valid() const{
