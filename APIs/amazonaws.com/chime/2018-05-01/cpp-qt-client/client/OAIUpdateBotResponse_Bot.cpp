...
#include "OAIUpdateBotResponse_Bot.h"
...
OAIUpdateBotResponse_Bot::OAIUpdateBotResponse_Bot(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBotResponse_Bot::OAIUpdateBotResponse_Bot() {
    this->initializeModel();
}

OAIUpdateBotResponse_Bot::~OAIUpdateBotResponse_Bot() {}

void OAIUpdateBotResponse_Bot::initializeModel() {
...
void OAIUpdateBotResponse_Bot::fromJson(QString jsonString) {
...
void OAIUpdateBotResponse_Bot::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBotResponse_Bot::asJson() const {
...
QJsonObject OAIUpdateBotResponse_Bot::asJsonObject() const {
    QJsonObject obj;
    if (m_bot_id_isSet) {
...
QString OAIUpdateBotResponse_Bot::getBotId() const {
    return m_bot_id;
}
void OAIUpdateBotResponse_Bot::setBotId(const QString &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAIUpdateBotResponse_Bot::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

QString OAIUpdateBotResponse_Bot::getUserId() const {
    return m_user_id;
}
void OAIUpdateBotResponse_Bot::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUpdateBotResponse_Bot::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIUpdateBotResponse_Bot::getDisplayName() const {
    return m_display_name;
}
void OAIUpdateBotResponse_Bot::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIUpdateBotResponse_Bot::is_display_name_Valid() const{
    return m_display_name_isValid;
}

OAIBotType OAIUpdateBotResponse_Bot::getBotType() const {
    return m_bot_type;
}
void OAIUpdateBotResponse_Bot::setBotType(const OAIBotType &bot_type) {
    m_bot_type = bot_type;
    m_bot_type_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_bot_type_Set() const{
    return m_bot_type_isSet;
}

bool OAIUpdateBotResponse_Bot::is_bot_type_Valid() const{
    return m_bot_type_isValid;
}

bool OAIUpdateBotResponse_Bot::getDisabled() const {
    return m_disabled;
}
void OAIUpdateBotResponse_Bot::setDisabled(const bool &disabled) {
    m_disabled = disabled;
    m_disabled_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_disabled_Set() const{
    return m_disabled_isSet;
}

bool OAIUpdateBotResponse_Bot::is_disabled_Valid() const{
    return m_disabled_isValid;
}

QDateTime OAIUpdateBotResponse_Bot::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIUpdateBotResponse_Bot::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIUpdateBotResponse_Bot::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIUpdateBotResponse_Bot::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIUpdateBotResponse_Bot::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIUpdateBotResponse_Bot::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAIUpdateBotResponse_Bot::getBotEmail() const {
    return m_bot_email;
}
void OAIUpdateBotResponse_Bot::setBotEmail(const QString &bot_email) {
    m_bot_email = bot_email;
    m_bot_email_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_bot_email_Set() const{
    return m_bot_email_isSet;
}

bool OAIUpdateBotResponse_Bot::is_bot_email_Valid() const{
    return m_bot_email_isValid;
}

QString OAIUpdateBotResponse_Bot::getSecurityToken() const {
    return m_security_token;
}
void OAIUpdateBotResponse_Bot::setSecurityToken(const QString &security_token) {
    m_security_token = security_token;
    m_security_token_isSet = true;
}

bool OAIUpdateBotResponse_Bot::is_security_token_Set() const{
    return m_security_token_isSet;
}

bool OAIUpdateBotResponse_Bot::is_security_token_Valid() const{
    return m_security_token_isValid;
}

bool OAIUpdateBotResponse_Bot::isSet() const {
...
bool OAIUpdateBotResponse_Bot::isValid() const {
