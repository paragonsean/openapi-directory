...
OAIBatchDeletePhoneNumber_request::OAIBatchDeletePhoneNumber_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeletePhoneNumber_request::OAIBatchDeletePhoneNumber_request() {
    this->initializeModel();
}

OAIBatchDeletePhoneNumber_request::~OAIBatchDeletePhoneNumber_request() {}

void OAIBatchDeletePhoneNumber_request::initializeModel() {

    m_phone_number_ids_isSet = false;
    m_phone_number_ids_isValid = false;
}

void OAIBatchDeletePhoneNumber_request::fromJson(QString jsonString) {
...
void OAIBatchDeletePhoneNumber_request::fromJsonObject(QJsonObject json) {

    m_phone_number_ids_isValid = ::OpenAPI::fromJsonValue(m_phone_number_ids, json[QString("PhoneNumberIds")]);
    m_phone_number_ids_isSet = !json[QString("PhoneNumberIds")].isNull() && m_phone_number_ids_isValid;
}

QString OAIBatchDeletePhoneNumber_request::asJson() const {
...
QJsonObject OAIBatchDeletePhoneNumber_request::asJsonObject() const {
    QJsonObject obj;
    if (m_phone_number_ids.size() > 0) {
        obj.insert(QString("PhoneNumberIds"), ::OpenAPI::toJsonValue(m_phone_number_ids));
    }
    return obj;
}

QList<QString> OAIBatchDeletePhoneNumber_request::getPhoneNumberIds() const {
    return m_phone_number_ids;
}
void OAIBatchDeletePhoneNumber_request::setPhoneNumberIds(const QList<QString> &phone_number_ids) {
    m_phone_number_ids = phone_number_ids;
    m_phone_number_ids_isSet = true;
}

bool OAIBatchDeletePhoneNumber_request::is_phone_number_ids_Set() const{
    return m_phone_number_ids_isSet;
}

bool OAIBatchDeletePhoneNumber_request::is_phone_number_ids_Valid() const{
    return m_phone_number_ids_isValid;
}

bool OAIBatchDeletePhoneNumber_request::isSet() const {
...
bool OAIBatchDeletePhoneNumber_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_phone_number_ids_isValid && true;
}
