...
OAIUpdateRoomMembershipResponse::OAIUpdateRoomMembershipResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoomMembershipResponse::OAIUpdateRoomMembershipResponse() {
    this->initializeModel();
}

OAIUpdateRoomMembershipResponse::~OAIUpdateRoomMembershipResponse() {}

void OAIUpdateRoomMembershipResponse::initializeModel() {

    m_room_membership_isSet = false;
    m_room_membership_isValid = false;
}

void OAIUpdateRoomMembershipResponse::fromJson(QString jsonString) {
...
void OAIUpdateRoomMembershipResponse::fromJsonObject(QJsonObject json) {

    m_room_membership_isValid = ::OpenAPI::fromJsonValue(m_room_membership, json[QString("RoomMembership")]);
    m_room_membership_isSet = !json[QString("RoomMembership")].isNull() && m_room_membership_isValid;
}

QString OAIUpdateRoomMembershipResponse::asJson() const {
...
QJsonObject OAIUpdateRoomMembershipResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_room_membership.isSet()) {
        obj.insert(QString("RoomMembership"), ::OpenAPI::toJsonValue(m_room_membership));
    }
    return obj;
}

OAICreateRoomMembershipResponse_RoomMembership OAIUpdateRoomMembershipResponse::getRoomMembership() const {
    return m_room_membership;
}
void OAIUpdateRoomMembershipResponse::setRoomMembership(const OAICreateRoomMembershipResponse_RoomMembership &room_membership) {
    m_room_membership = room_membership;
    m_room_membership_isSet = true;
}

bool OAIUpdateRoomMembershipResponse::is_room_membership_Set() const{
    return m_room_membership_isSet;
}

bool OAIUpdateRoomMembershipResponse::is_room_membership_Valid() const{
    return m_room_membership_isValid;
}

bool OAIUpdateRoomMembershipResponse::isSet() const {
...
bool OAIUpdateRoomMembershipResponse::isValid() const {
