...
/*
 * OAICreateSipRule_request.h
 *
 * 
 */

#ifndef OAICreateSipRule_request_H
#define OAICreateSipRule_request_H
...
class OAICreateSipRule_request : public OAIObject {
public:
    OAICreateSipRule_request();
    OAICreateSipRule_request(QString json);
    ~OAICreateSipRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipRule_request)

#endif // OAICreateSipRule_request_H
