...
/*
 * OAICreateVoiceConnector_request.h
 *
 * 
 */

#ifndef OAICreateVoiceConnector_request_H
#define OAICreateVoiceConnector_request_H
...
class OAICreateVoiceConnector_request : public OAIObject {
public:
    OAICreateVoiceConnector_request();
    OAICreateVoiceConnector_request(QString json);
    ~OAICreateVoiceConnector_request() override;
    ...
    bool isRequireEncryption() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnector_request)

#endif // OAICreateVoiceConnector_request_H
