...
class OAISelectedVideoStreams : public OAIObject {
public:
    OAISelectedVideoStreams();
    OAISelectedVideoStreams(QString json);
    ~OAISelectedVideoStreams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelectedVideoStreams)

#endif // OAISelectedVideoStreams_H
