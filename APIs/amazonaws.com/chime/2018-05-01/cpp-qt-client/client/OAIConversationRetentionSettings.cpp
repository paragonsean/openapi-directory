...
#include "OAIConversationRetentionSettings.h"
...
OAIConversationRetentionSettings::OAIConversationRetentionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConversationRetentionSettings::OAIConversationRetentionSettings() {
    this->initializeModel();
}

OAIConversationRetentionSettings::~OAIConversationRetentionSettings() {}

void OAIConversationRetentionSettings::initializeModel() {

    m_retention_days_isSet = false;
    m_retention_days_isValid = false;
}

void OAIConversationRetentionSettings::fromJson(QString jsonString) {
...
void OAIConversationRetentionSettings::fromJsonObject(QJsonObject json) {
...
QString OAIConversationRetentionSettings::asJson() const {
...
QJsonObject OAIConversationRetentionSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIConversationRetentionSettings::getRetentionDays() const {
    return m_retention_days;
}
void OAIConversationRetentionSettings::setRetentionDays(const qint32 &retention_days) {
    m_retention_days = retention_days;
    m_retention_days_isSet = true;
}

bool OAIConversationRetentionSettings::is_retention_days_Set() const{
    return m_retention_days_isSet;
}

bool OAIConversationRetentionSettings::is_retention_days_Valid() const{
    return m_retention_days_isValid;
}

bool OAIConversationRetentionSettings::isSet() const {
...
bool OAIConversationRetentionSettings::isValid() const {
