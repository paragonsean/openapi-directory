...
/*
 * OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse.h
 *
 * 
 */

#ifndef OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse_H
#define OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse_H
...
class OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse : public OAIObject {
public:
    OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse();
    OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse(QString json);
    ~OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse() override;
    ...
    QList getPhoneNumberErrors() const;
    void setPhoneNumberErrors(const QList &phone_number_errors);
    bool is_phone_number_errors_Set() const;
    bool is_phone_number_errors_Valid() const;
...
private:
    ...
    QList m_phone_number_errors;
    bool m_phone_number_errors_isSet;
    bool m_phone_number_errors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse)

#endif // OAIDisassociatePhoneNumbersFromVoiceConnectorGroupResponse_H
