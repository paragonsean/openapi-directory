...
/*
 * OAICreatePhoneNumberOrderRequest.h
 *
 * 
 */

#ifndef OAICreatePhoneNumberOrderRequest_H
#define OAICreatePhoneNumberOrderRequest_H
...
class OAICreatePhoneNumberOrderRequest : public OAIObject {
public:
    OAICreatePhoneNumberOrderRequest();
    OAICreatePhoneNumberOrderRequest(QString json);
    ~OAICreatePhoneNumberOrderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePhoneNumberOrderRequest)

#endif // OAICreatePhoneNumberOrderRequest_H
