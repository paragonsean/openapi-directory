...
/*
 * OAIResetPersonalPINResponse_User.h
 *
 * 
 */

#ifndef OAIResetPersonalPINResponse_User_H
#define OAIResetPersonalPINResponse_User_H
...
class OAIResetPersonalPINResponse_User : public OAIObject {
public:
    OAIResetPersonalPINResponse_User();
    OAIResetPersonalPINResponse_User(QString json);
    ~OAIResetPersonalPINResponse_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetPersonalPINResponse_User)

#endif // OAIResetPersonalPINResponse_User_H
