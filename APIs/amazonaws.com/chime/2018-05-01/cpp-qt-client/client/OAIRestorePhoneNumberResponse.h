...
/*
 * OAIRestorePhoneNumberResponse.h
 *
 * 
 */

#ifndef OAIRestorePhoneNumberResponse_H
#define OAIRestorePhoneNumberResponse_H
...
class OAIRestorePhoneNumberResponse : public OAIObject {
public:
    OAIRestorePhoneNumberResponse();
    OAIRestorePhoneNumberResponse(QString json);
    ~OAIRestorePhoneNumberResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestorePhoneNumberResponse)

#endif // OAIRestorePhoneNumberResponse_H
