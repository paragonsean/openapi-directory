...
OAIDeleteVoiceConnectorTerminationCredentials_request::OAIDeleteVoiceConnectorTerminationCredentials_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteVoiceConnectorTerminationCredentials_request::OAIDeleteVoiceConnectorTerminationCredentials_request() {
    this->initializeModel();
}

OAIDeleteVoiceConnectorTerminationCredentials_request::~OAIDeleteVoiceConnectorTerminationCredentials_request() {}

void OAIDeleteVoiceConnectorTerminationCredentials_request::initializeModel() {

    m_usernames_isSet = false;
    m_usernames_isValid = false;
}

void OAIDeleteVoiceConnectorTerminationCredentials_request::fromJson(QString jsonString) {
...
void OAIDeleteVoiceConnectorTerminationCredentials_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteVoiceConnectorTerminationCredentials_request::asJson() const {
...
QJsonObject OAIDeleteVoiceConnectorTerminationCredentials_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDeleteVoiceConnectorTerminationCredentials_request::getUsernames() const {
    return m_usernames;
}
void OAIDeleteVoiceConnectorTerminationCredentials_request::setUsernames(const QList<QString> &usernames) {
    m_usernames = usernames;
    m_usernames_isSet = true;
}

bool OAIDeleteVoiceConnectorTerminationCredentials_request::is_usernames_Set() const{
    return m_usernames_isSet;
}

bool OAIDeleteVoiceConnectorTerminationCredentials_request::is_usernames_Valid() const{
    return m_usernames_isValid;
}

bool OAIDeleteVoiceConnectorTerminationCredentials_request::isSet() const {
...
bool OAIDeleteVoiceConnectorTerminationCredentials_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_usernames_isValid && true;
}
