...
/*
 * OAITranscribePartialResultsStability.h
 *
 * 
 */

#ifndef OAITranscribePartialResultsStability_H
#define OAITranscribePartialResultsStability_H
...
class OAITranscribePartialResultsStability : public OAIEnum {
public:
    OAITranscribePartialResultsStability();
    OAITranscribePartialResultsStability(QString json);
    ~OAITranscribePartialResultsStability() override;
    ...
    enum class eOAITranscribePartialResultsStability {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LOW, 
        MEDIUM, 
        HIGH
    };
    OAITranscribePartialResultsStability::eOAITranscribePartialResultsStability getValue() const;
    void setValue(const OAITranscribePartialResultsStability::eOAITranscribePartialResultsStability& value);
...
private:
    ...
    eOAITranscribePartialResultsStability m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribePartialResultsStability)

#endif // OAITranscribePartialResultsStability_H
