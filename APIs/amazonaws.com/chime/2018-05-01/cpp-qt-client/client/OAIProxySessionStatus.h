...
/*
 * OAIProxySessionStatus.h
 *
 * 
 */

#ifndef OAIProxySessionStatus_H
#define OAIProxySessionStatus_H
...
class OAIProxySessionStatus : public OAIEnum {
public:
    OAIProxySessionStatus();
    OAIProxySessionStatus(QString json);
    ~OAIProxySessionStatus() override;
    ...
    enum class eOAIProxySessionStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OPEN, 
        INPROGRESS, 
        CLOSED
    };
    OAIProxySessionStatus::eOAIProxySessionStatus getValue() const;
    void setValue(const OAIProxySessionStatus::eOAIProxySessionStatus& value);
...
private:
    ...
    eOAIProxySessionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProxySessionStatus)

#endif // OAIProxySessionStatus_H
