...
/*
 * OAIUpdateSipMediaApplication_request.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplication_request_H
#define OAIUpdateSipMediaApplication_request_H

#include <QJsonObject>

#include "OAISipMediaApplicationEndpoint.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAISipMediaApplicationEndpoint;

class OAIUpdateSipMediaApplication_request : public OAIObject {
public:
    OAIUpdateSipMediaApplication_request();
    OAIUpdateSipMediaApplication_request(QString json);
    ~OAIUpdateSipMediaApplication_request() override;
    ...
    QList<OAISipMediaApplicationEndpoint> getEndpoints() const;
    void setEndpoints(const QList<OAISipMediaApplicationEndpoint> &endpoints);
...
private:
    ...
    QList<OAISipMediaApplicationEndpoint> m_endpoints;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplication_request)

#endif // OAIUpdateSipMediaApplication_request_H
