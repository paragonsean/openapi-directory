...
/*
 * OAICallingNameStatus.h
 *
 * 
 */

#ifndef OAICallingNameStatus_H
#define OAICallingNameStatus_H
...
class OAICallingNameStatus : public OAIEnum {
public:
    OAICallingNameStatus();
    OAICallingNameStatus(QString json);
    ~OAICallingNameStatus() override;
    ...
    enum class eOAICallingNameStatus {
    ...
    OAICallingNameStatus::eOAICallingNameStatus getValue() const;
    void setValue(const OAICallingNameStatus::eOAICallingNameStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAICallingNameStatus)

#endif // OAICallingNameStatus_H
