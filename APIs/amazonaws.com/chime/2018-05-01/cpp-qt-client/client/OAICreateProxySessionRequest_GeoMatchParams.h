...
/*
 * OAICreateProxySessionRequest_GeoMatchParams.h
 *
 * 
 */

#ifndef OAICreateProxySessionRequest_GeoMatchParams_H
#define OAICreateProxySessionRequest_GeoMatchParams_H
...
class OAICreateProxySessionRequest_GeoMatchParams : public OAIObject {
public:
    OAICreateProxySessionRequest_GeoMatchParams();
    OAICreateProxySessionRequest_GeoMatchParams(QString json);
    ~OAICreateProxySessionRequest_GeoMatchParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySessionRequest_GeoMatchParams)

#endif // OAICreateProxySessionRequest_GeoMatchParams_H
