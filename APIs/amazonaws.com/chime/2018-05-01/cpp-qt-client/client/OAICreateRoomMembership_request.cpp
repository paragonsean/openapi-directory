...
OAICreateRoomMembership_request::OAICreateRoomMembership_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRoomMembership_request::OAICreateRoomMembership_request() {
    this->initializeModel();
}

OAICreateRoomMembership_request::~OAICreateRoomMembership_request() {}

void OAICreateRoomMembership_request::initializeModel() {
...
void OAICreateRoomMembership_request::fromJson(QString jsonString) {
...
void OAICreateRoomMembership_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateRoomMembership_request::asJson() const {
...
QJsonObject OAICreateRoomMembership_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRoomMembership_request::getMemberId() const {
    return m_member_id;
}
void OAICreateRoomMembership_request::setMemberId(const QString &member_id) {
    m_member_id = member_id;
    m_member_id_isSet = true;
}

bool OAICreateRoomMembership_request::is_member_id_Set() const{
    return m_member_id_isSet;
}

bool OAICreateRoomMembership_request::is_member_id_Valid() const{
    return m_member_id_isValid;
}

QString OAICreateRoomMembership_request::getRole() const {
    return m_role;
}
void OAICreateRoomMembership_request::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAICreateRoomMembership_request::is_role_Set() const{
    return m_role_isSet;
}

bool OAICreateRoomMembership_request::is_role_Valid() const{
    return m_role_isValid;
}

bool OAICreateRoomMembership_request::isSet() const {
...
bool OAICreateRoomMembership_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_member_id_isValid && true;
}
