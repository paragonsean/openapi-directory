...
QString OAIUpdateAccountRequest::getName() const {
    return m_name;
}
void OAIUpdateAccountRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAccountRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAccountRequest::is_name_Valid() const{
    return m_name_isValid;
}

OAILicense OAIUpdateAccountRequest::getDefaultLicense() const {
    return m_default_license;
}
void OAIUpdateAccountRequest::setDefaultLicense(const OAILicense &default_license) {
    m_default_license = default_license;
    m_default_license_isSet = true;
}

bool OAIUpdateAccountRequest::is_default_license_Set() const{
    return m_default_license_isSet;
}

bool OAIUpdateAccountRequest::is_default_license_Valid() const{
