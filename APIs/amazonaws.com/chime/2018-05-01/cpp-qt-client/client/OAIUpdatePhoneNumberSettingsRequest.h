...
/*
 * OAIUpdatePhoneNumberSettingsRequest.h
 *
 * 
 */

#ifndef OAIUpdatePhoneNumberSettingsRequest_H
#define OAIUpdatePhoneNumberSettingsRequest_H
...
class OAIUpdatePhoneNumberSettingsRequest : public OAIObject {
public:
    OAIUpdatePhoneNumberSettingsRequest();
    OAIUpdatePhoneNumberSettingsRequest(QString json);
    ~OAIUpdatePhoneNumberSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePhoneNumberSettingsRequest)

#endif // OAIUpdatePhoneNumberSettingsRequest_H
