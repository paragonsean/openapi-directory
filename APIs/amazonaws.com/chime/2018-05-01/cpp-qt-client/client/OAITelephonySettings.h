...
/*
 * OAITelephonySettings.h
 *
 * Settings that allow management of telephony permissions for an Amazon Chime user, such as inbound and outbound calling and text messaging.
 */

#ifndef OAITelephonySettings_H
#define OAITelephonySettings_H
...
class OAITelephonySettings : public OAIObject {
public:
    OAITelephonySettings();
    OAITelephonySettings(QString json);
    ~OAITelephonySettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITelephonySettings)

#endif // OAITelephonySettings_H
