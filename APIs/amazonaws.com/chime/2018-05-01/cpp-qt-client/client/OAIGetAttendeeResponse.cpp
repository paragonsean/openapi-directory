...
OAIGetAttendeeResponse::OAIGetAttendeeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAttendeeResponse::OAIGetAttendeeResponse() {
    this->initializeModel();
}

OAIGetAttendeeResponse::~OAIGetAttendeeResponse() {}

void OAIGetAttendeeResponse::initializeModel() {

    m_attendee_isSet = false;
    m_attendee_isValid = false;
}

void OAIGetAttendeeResponse::fromJson(QString jsonString) {
...
void OAIGetAttendeeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetAttendeeResponse::asJson() const {
...
QJsonObject OAIGetAttendeeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_attendee.isSet()) {
...
OAIGetAttendeeResponse_Attendee OAIGetAttendeeResponse::getAttendee() const {
    return m_attendee;
}
void OAIGetAttendeeResponse::setAttendee(const OAIGetAttendeeResponse_Attendee &attendee) {
    m_attendee = attendee;
    m_attendee_isSet = true;
}

bool OAIGetAttendeeResponse::is_attendee_Set() const{
    return m_attendee_isSet;
}

bool OAIGetAttendeeResponse::is_attendee_Valid() const{
    return m_attendee_isValid;
}

bool OAIGetAttendeeResponse::isSet() const {
...
bool OAIGetAttendeeResponse::isValid() const {
