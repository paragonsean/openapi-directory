...
/*
 * OAIListSipRulesResponse.h
 *
 * 
 */

#ifndef OAIListSipRulesResponse_H
#define OAIListSipRulesResponse_H
...
class OAIListSipRulesResponse : public OAIObject {
public:
    OAIListSipRulesResponse();
    OAIListSipRulesResponse(QString json);
    ~OAIListSipRulesResponse() override;
    ...
    QList getSipRules() const;
    void setSipRules(const QList &sip_rules);
    bool is_sip_rules_Set() const;
    bool is_sip_rules_Valid() const;
...
private:
    ...
    QList m_sip_rules;
    bool m_sip_rules_isSet;
    bool m_sip_rules_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSipRulesResponse)

#endif // OAIListSipRulesResponse_H
