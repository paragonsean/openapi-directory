...
/*
 * OAIVoiceConnectorGroup.h
 *
 * The Amazon Chime Voice Connector group configuration, including associated Amazon Chime Voice Connectors. You can include Amazon Chime Voice Connectors from different AWS Regions in your group. This creates a fault tolerant mechanism for fallback in case of availability events.
 */

#ifndef OAIVoiceConnectorGroup_H
#define OAIVoiceConnectorGroup_H
...
class OAIVoiceConnectorGroup : public OAIObject {
public:
    OAIVoiceConnectorGroup();
    OAIVoiceConnectorGroup(QString json);
    ~OAIVoiceConnectorGroup() override;
    ...
    QString getVoiceConnectorGroupId() const;
    void setVoiceConnectorGroupId(const QString &voice_connector_group_id);
    bool is_voice_connector_group_id_Set() const;
    bool is_voice_connector_group_id_Valid() const;
    ...
    QList getVoiceConnectorItems() const;
    void setVoiceConnectorItems(const QList &voice_connector_items);
    ...
    QString getVoiceConnectorGroupArn() const;
    void setVoiceConnectorGroupArn(const QString &voice_connector_group_arn);
    bool is_voice_connector_group_arn_Set() const;
    bool is_voice_connector_group_arn_Valid() const;
...
private:
    ...
    QString m_voice_connector_group_id;
    bool m_voice_connector_group_id_isSet;
    bool m_voice_connector_group_id_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QList m_voice_connector_items;
    ...
    QString m_voice_connector_group_arn;
    bool m_voice_connector_group_arn_isSet;
    bool m_voice_connector_group_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVoiceConnectorGroup)

#endif // OAIVoiceConnectorGroup_H
