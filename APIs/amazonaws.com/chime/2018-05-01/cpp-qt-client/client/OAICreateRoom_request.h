...
/*
 * OAICreateRoom_request.h
 *
 * 
 */

#ifndef OAICreateRoom_request_H
#define OAICreateRoom_request_H
...
class OAICreateRoom_request : public OAIObject {
public:
    OAICreateRoom_request();
    OAICreateRoom_request(QString json);
    ~OAICreateRoom_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoom_request)

#endif // OAICreateRoom_request_H
