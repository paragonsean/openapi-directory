...
OAIGetPhoneNumberResponse::OAIGetPhoneNumberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPhoneNumberResponse::OAIGetPhoneNumberResponse() {
    this->initializeModel();
}

OAIGetPhoneNumberResponse::~OAIGetPhoneNumberResponse() {}

void OAIGetPhoneNumberResponse::initializeModel() {

    m_phone_number_isSet = false;
    m_phone_number_isValid = false;
}

void OAIGetPhoneNumberResponse::fromJson(QString jsonString) {
...
void OAIGetPhoneNumberResponse::fromJsonObject(QJsonObject json) {

    m_phone_number_isValid = ::OpenAPI::fromJsonValue(m_phone_number, json[QString("PhoneNumber")]);
    m_phone_number_isSet = !json[QString("PhoneNumber")].isNull() && m_phone_number_isValid;
}

QString OAIGetPhoneNumberResponse::asJson() const {
...
QJsonObject OAIGetPhoneNumberResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetPhoneNumberResponse_PhoneNumber OAIGetPhoneNumberResponse::getPhoneNumber() const {
    return m_phone_number;
}
void OAIGetPhoneNumberResponse::setPhoneNumber(const OAIGetPhoneNumberResponse_PhoneNumber &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIGetPhoneNumberResponse::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIGetPhoneNumberResponse::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

bool OAIGetPhoneNumberResponse::isSet() const {
...
bool OAIGetPhoneNumberResponse::isValid() const {
