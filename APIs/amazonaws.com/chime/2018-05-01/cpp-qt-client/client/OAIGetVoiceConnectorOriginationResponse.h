...
/*
 * OAIGetVoiceConnectorOriginationResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorOriginationResponse_H
#define OAIGetVoiceConnectorOriginationResponse_H

#include <QJsonObject>

#include "OAIGetVoiceConnectorOriginationResponse_Origination.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetVoiceConnectorOriginationResponse_Origination;

class OAIGetVoiceConnectorOriginationResponse : public OAIObject {
public:
    OAIGetVoiceConnectorOriginationResponse();
    OAIGetVoiceConnectorOriginationResponse(QString json);
    ~OAIGetVoiceConnectorOriginationResponse() override;
    ...
    OAIGetVoiceConnectorOriginationResponse_Origination getOrigination() const;
    void setOrigination(const OAIGetVoiceConnectorOriginationResponse_Origination &origination);
...
private:
    ...
    OAIGetVoiceConnectorOriginationResponse_Origination m_origination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorOriginationResponse)

#endif // OAIGetVoiceConnectorOriginationResponse_H
