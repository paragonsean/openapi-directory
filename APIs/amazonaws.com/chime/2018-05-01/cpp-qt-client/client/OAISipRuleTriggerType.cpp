...
OAISipRuleTriggerType::OAISipRuleTriggerType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISipRuleTriggerType::OAISipRuleTriggerType() {
    this->initializeModel();
}

OAISipRuleTriggerType::~OAISipRuleTriggerType() {}

void OAISipRuleTriggerType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAISipRuleTriggerType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAISipRuleTriggerType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ToPhoneNumber", Qt::CaseInsensitive) == 0) {
        m_value = eOAISipRuleTriggerType::TOPHONENUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RequestUriHostname", Qt::CaseInsensitive) == 0) {
        m_value = eOAISipRuleTriggerType::REQUESTURIHOSTNAME;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAISipRuleTriggerType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAISipRuleTriggerType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAISipRuleTriggerType::TOPHONENUMBER:
            val = "ToPhoneNumber";
            break;
        case eOAISipRuleTriggerType::REQUESTURIHOSTNAME:
            val = "RequestUriHostname";
            break;
        default:
            break;
    }
...
QJsonValue OAISipRuleTriggerType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAISipRuleTriggerType::eOAISipRuleTriggerType OAISipRuleTriggerType::getValue() const {
    return m_value;
}

void OAISipRuleTriggerType::setValue(const OAISipRuleTriggerType::eOAISipRuleTriggerType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAISipRuleTriggerType::isSet() const {
    
    return m_value_isSet;
}

bool OAISipRuleTriggerType::isValid() const {
