...
/*
 * OAICreateMeeting_request_NotificationsConfiguration.h
 *
...
#ifndef OAICreateMeeting_request_NotificationsConfiguration_H
#define OAICreateMeeting_request_NotificationsConfiguration_H
...
class OAICreateMeeting_request_NotificationsConfiguration : public OAIObject {
public:
    OAICreateMeeting_request_NotificationsConfiguration();
    OAICreateMeeting_request_NotificationsConfiguration(QString json);
    ~OAICreateMeeting_request_NotificationsConfiguration() override;
    ...
    QString getSqsQueueArn() const;
    void setSqsQueueArn(const QString &sqs_queue_arn);
    bool is_sqs_queue_arn_Set() const;
    bool is_sqs_queue_arn_Valid() const;
...
private:
    ...
    QString m_sqs_queue_arn;
    bool m_sqs_queue_arn_isSet;
    bool m_sqs_queue_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateMeeting_request_NotificationsConfiguration)

#endif // OAICreateMeeting_request_NotificationsConfiguration_H
