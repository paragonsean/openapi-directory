...
/*
 * OAIGetBotResponse_Bot.h
 *
 * 
 */

#ifndef OAIGetBotResponse_Bot_H
#define OAIGetBotResponse_Bot_H
...
class OAIGetBotResponse_Bot : public OAIObject {
public:
    OAIGetBotResponse_Bot();
    OAIGetBotResponse_Bot(QString json);
    ~OAIGetBotResponse_Bot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBotResponse_Bot)

#endif // OAIGetBotResponse_Bot_H
