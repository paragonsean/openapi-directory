...
OAIInviteUsers_request::OAIInviteUsers_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteUsers_request::OAIInviteUsers_request() {
    this->initializeModel();
}

OAIInviteUsers_request::~OAIInviteUsers_request() {}

void OAIInviteUsers_request::initializeModel() {
...
void OAIInviteUsers_request::fromJson(QString jsonString) {
...
void OAIInviteUsers_request::fromJsonObject(QJsonObject json) {
...
QString OAIInviteUsers_request::asJson() const {
...
QJsonObject OAIInviteUsers_request::asJsonObject() const {
    QJsonObject obj;
    if (m_user_email_list.size() > 0) {
...
QList<QString> OAIInviteUsers_request::getUserEmailList() const {
    return m_user_email_list;
}
void OAIInviteUsers_request::setUserEmailList(const QList<QString> &user_email_list) {
    m_user_email_list = user_email_list;
    m_user_email_list_isSet = true;
}

bool OAIInviteUsers_request::is_user_email_list_Set() const{
    return m_user_email_list_isSet;
}

bool OAIInviteUsers_request::is_user_email_list_Valid() const{
    return m_user_email_list_isValid;
}

QString OAIInviteUsers_request::getUserType() const {
    return m_user_type;
}
void OAIInviteUsers_request::setUserType(const QString &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIInviteUsers_request::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIInviteUsers_request::is_user_type_Valid() const{
    return m_user_type_isValid;
}

bool OAIInviteUsers_request::isSet() const {
...
bool OAIInviteUsers_request::isValid() const {
