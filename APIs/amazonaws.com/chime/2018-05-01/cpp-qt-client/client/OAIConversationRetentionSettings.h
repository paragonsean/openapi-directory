...
class OAIConversationRetentionSettings : public OAIObject {
public:
    OAIConversationRetentionSettings();
    OAIConversationRetentionSettings(QString json);
    ~OAIConversationRetentionSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversationRetentionSettings)

#endif // OAIConversationRetentionSettings_H
