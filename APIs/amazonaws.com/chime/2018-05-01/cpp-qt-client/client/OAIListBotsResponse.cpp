...
QList OAIListBotsResponse::getBots() const {
    return m_bots;
}
void OAIListBotsResponse::setBots(const QList &bots) {
    m_bots = bots;
    m_bots_isSet = true;
}

bool OAIListBotsResponse::is_bots_Set() const{
    return m_bots_isSet;
}

bool OAIListBotsResponse::is_bots_Valid() const{
