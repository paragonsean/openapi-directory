...
OAICreateBotResponse_Bot OAICreateBotResponse::getBot() const {
    return m_bot;
}
void OAICreateBotResponse::setBot(const OAICreateBotResponse_Bot &bot) {
    m_bot = bot;
    m_bot_isSet = true;
}

bool OAICreateBotResponse::is_bot_Set() const{
    return m_bot_isSet;
}

bool OAICreateBotResponse::is_bot_Valid() const{
