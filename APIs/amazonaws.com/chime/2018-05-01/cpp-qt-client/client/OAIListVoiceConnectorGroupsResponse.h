...
/*
 * OAIListVoiceConnectorGroupsResponse.h
 *
 * 
 */

#ifndef OAIListVoiceConnectorGroupsResponse_H
#define OAIListVoiceConnectorGroupsResponse_H
...
class OAIListVoiceConnectorGroupsResponse : public OAIObject {
public:
    OAIListVoiceConnectorGroupsResponse();
    OAIListVoiceConnectorGroupsResponse(QString json);
    ~OAIListVoiceConnectorGroupsResponse() override;
    ...
    QList getVoiceConnectorGroups() const;
    void setVoiceConnectorGroups(const QList &voice_connector_groups);
    bool is_voice_connector_groups_Set() const;
    bool is_voice_connector_groups_Valid() const;
...
private:
    ...
    QList m_voice_connector_groups;
    bool m_voice_connector_groups_isSet;
    bool m_voice_connector_groups_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVoiceConnectorGroupsResponse)

#endif // OAIListVoiceConnectorGroupsResponse_H
