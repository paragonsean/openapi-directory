...
/*
 * OAICreateProxySessionResponse.h
 *
 * 
 */

#ifndef OAICreateProxySessionResponse_H
#define OAICreateProxySessionResponse_H
...
class OAICreateProxySessionResponse : public OAIObject {
public:
    OAICreateProxySessionResponse();
    OAICreateProxySessionResponse(QString json);
    ~OAICreateProxySessionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProxySessionResponse)

#endif // OAICreateProxySessionResponse_H
