...
/*
 * OAIGetAttendeeResponse.h
 *
 * 
 */

#ifndef OAIGetAttendeeResponse_H
#define OAIGetAttendeeResponse_H
...
namespace OpenAPI {
class OAIGetAttendeeResponse_Attendee;

class OAIGetAttendeeResponse : public OAIObject {
public:
    OAIGetAttendeeResponse();
    OAIGetAttendeeResponse(QString json);
    ~OAIGetAttendeeResponse() override;
    ...
    OAIGetAttendeeResponse_Attendee getAttendee() const;
    void setAttendee(const OAIGetAttendeeResponse_Attendee &attendee);
...
private:
    ...
    OAIGetAttendeeResponse_Attendee m_attendee;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAttendeeResponse)

#endif // OAIGetAttendeeResponse_H
