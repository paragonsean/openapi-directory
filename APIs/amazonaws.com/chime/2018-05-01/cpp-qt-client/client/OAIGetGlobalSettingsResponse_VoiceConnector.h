...
/*
 * OAIGetGlobalSettingsResponse_VoiceConnector.h
 *
 * 
 */

#ifndef OAIGetGlobalSettingsResponse_VoiceConnector_H
#define OAIGetGlobalSettingsResponse_VoiceConnector_H
...
class OAIGetGlobalSettingsResponse_VoiceConnector : public OAIObject {
public:
    OAIGetGlobalSettingsResponse_VoiceConnector();
    OAIGetGlobalSettingsResponse_VoiceConnector(QString json);
    ~OAIGetGlobalSettingsResponse_VoiceConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGlobalSettingsResponse_VoiceConnector)

#endif // OAIGetGlobalSettingsResponse_VoiceConnector_H
