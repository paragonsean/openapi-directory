...
/*
 * OAIChannelMembershipSummary_Member.h
 *
 * 
 */

#ifndef OAIChannelMembershipSummary_Member_H
#define OAIChannelMembershipSummary_Member_H
...
class OAIChannelMembershipSummary_Member : public OAIObject {
public:
    OAIChannelMembershipSummary_Member();
    OAIChannelMembershipSummary_Member(QString json);
    ~OAIChannelMembershipSummary_Member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelMembershipSummary_Member)

#endif // OAIChannelMembershipSummary_Member_H
