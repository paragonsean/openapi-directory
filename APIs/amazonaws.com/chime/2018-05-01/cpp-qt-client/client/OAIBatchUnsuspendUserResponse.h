...
/*
 * OAIBatchUnsuspendUserResponse.h
 *
 * 
 */

#ifndef OAIBatchUnsuspendUserResponse_H
#define OAIBatchUnsuspendUserResponse_H
...
class OAIBatchUnsuspendUserResponse : public OAIObject {
public:
    OAIBatchUnsuspendUserResponse();
    OAIBatchUnsuspendUserResponse(QString json);
    ~OAIBatchUnsuspendUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUnsuspendUserResponse)

#endif // OAIBatchUnsuspendUserResponse_H
