...
/*
 * OAIPutEventsConfigurationResponse.h
 *
 * 
 */

#ifndef OAIPutEventsConfigurationResponse_H
#define OAIPutEventsConfigurationResponse_H
...
namespace OpenAPI {
class OAIPutEventsConfigurationResponse_EventsConfiguration;

class OAIPutEventsConfigurationResponse : public OAIObject {
public:
    OAIPutEventsConfigurationResponse();
    OAIPutEventsConfigurationResponse(QString json);
    ~OAIPutEventsConfigurationResponse() override;
    ...
    OAIPutEventsConfigurationResponse_EventsConfiguration getEventsConfiguration() const;
    void setEventsConfiguration(const OAIPutEventsConfigurationResponse_EventsConfiguration &events_configuration);
    bool is_events_configuration_Set() const;
    bool is_events_configuration_Valid() const;
...
private:
    ...
    OAIPutEventsConfigurationResponse_EventsConfiguration m_events_configuration;
    bool m_events_configuration_isSet;
    bool m_events_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutEventsConfigurationResponse)

#endif // OAIPutEventsConfigurationResponse_H
