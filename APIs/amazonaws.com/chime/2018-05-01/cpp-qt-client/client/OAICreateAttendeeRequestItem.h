...
/*
 * OAICreateAttendeeRequestItem.h
 *
 * The Amazon Chime SDK attendee fields to create, used with the BatchCreateAttendee action.
 */

#ifndef OAICreateAttendeeRequestItem_H
#define OAICreateAttendeeRequestItem_H
...
class OAICreateAttendeeRequestItem : public OAIObject {
public:
    OAICreateAttendeeRequestItem();
    OAICreateAttendeeRequestItem(QString json);
    ~OAICreateAttendeeRequestItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAttendeeRequestItem)

#endif // OAICreateAttendeeRequestItem_H
