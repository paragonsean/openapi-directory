...
/*
 * OAIListPhoneNumberOrdersResponse.h
 *
 * 
 */

#ifndef OAIListPhoneNumberOrdersResponse_H
#define OAIListPhoneNumberOrdersResponse_H
...
class OAIListPhoneNumberOrdersResponse : public OAIObject {
public:
    OAIListPhoneNumberOrdersResponse();
    OAIListPhoneNumberOrdersResponse(QString json);
    ~OAIListPhoneNumberOrdersResponse() override;
    ...
    QList getPhoneNumberOrders() const;
    void setPhoneNumberOrders(const QList &phone_number_orders);
    bool is_phone_number_orders_Set() const;
    bool is_phone_number_orders_Valid() const;
...
private:
    ...
    QList m_phone_number_orders;
    bool m_phone_number_orders_isSet;
    bool m_phone_number_orders_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPhoneNumberOrdersResponse)

#endif // OAIListPhoneNumberOrdersResponse_H
