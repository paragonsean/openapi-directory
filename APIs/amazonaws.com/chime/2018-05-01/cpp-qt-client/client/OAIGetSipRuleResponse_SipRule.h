...
/*
 * OAIGetSipRuleResponse_SipRule.h
 *
 * 
 */

#ifndef OAIGetSipRuleResponse_SipRule_H
#define OAIGetSipRuleResponse_SipRule_H

#include <QJsonObject>

#include "OAISipRuleTriggerType.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIGetSipRuleResponse_SipRule : public OAIObject {
public:
    OAIGetSipRuleResponse_SipRule();
    OAIGetSipRuleResponse_SipRule(QString json);
    ~OAIGetSipRuleResponse_SipRule() override;
    ...
    QString getSipRuleId() const;
    void setSipRuleId(const QString &sip_rule_id);
    bool is_sip_rule_id_Set() const;
    bool is_sip_rule_id_Valid() const;
    ...
    OAISipRuleTriggerType getTriggerType() const;
    void setTriggerType(const OAISipRuleTriggerType &trigger_type);
    ...
    QList getTargetApplications() const;
    void setTargetApplications(const QList &target_applications);
    bool is_target_applications_Set() const;
    bool is_target_applications_Valid() const;
...
private:
    ...
    QString m_sip_rule_id;
    bool m_sip_rule_id_isSet;
    bool m_sip_rule_id_isValid;
    ...
    OAISipRuleTriggerType m_trigger_type;
    ...
    QList m_target_applications;
    bool m_target_applications_isSet;
    bool m_target_applications_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSipRuleResponse_SipRule)

#endif // OAIGetSipRuleResponse_SipRule_H
