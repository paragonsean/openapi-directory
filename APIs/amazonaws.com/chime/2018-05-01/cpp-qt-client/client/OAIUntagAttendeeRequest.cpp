...
#include "OAIUntagAttendeeRequest.h"
...
OAIUntagAttendeeRequest::OAIUntagAttendeeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUntagAttendeeRequest::OAIUntagAttendeeRequest() {
    this->initializeModel();
}

OAIUntagAttendeeRequest::~OAIUntagAttendeeRequest() {}

void OAIUntagAttendeeRequest::initializeModel() {

    m_tag_keys_isSet = false;
    m_tag_keys_isValid = false;
}

void OAIUntagAttendeeRequest::fromJson(QString jsonString) {
...
void OAIUntagAttendeeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUntagAttendeeRequest::asJson() const {
...
QJsonObject OAIUntagAttendeeRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_tag_keys.isSet()) {
...
QList OAIUntagAttendeeRequest::getTagKeys() const {
    return m_tag_keys;
}
void OAIUntagAttendeeRequest::setTagKeys(const QList &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIUntagAttendeeRequest::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIUntagAttendeeRequest::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

bool OAIUntagAttendeeRequest::isSet() const {
...
bool OAIUntagAttendeeRequest::isValid() const {
