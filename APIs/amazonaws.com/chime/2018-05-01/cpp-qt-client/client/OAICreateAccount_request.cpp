...
OAICreateAccount_request::OAICreateAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAccount_request::OAICreateAccount_request() {
    this->initializeModel();
}

OAICreateAccount_request::~OAICreateAccount_request() {}

void OAICreateAccount_request::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAICreateAccount_request::fromJson(QString jsonString) {
...
void OAICreateAccount_request::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAICreateAccount_request::asJson() const {
...
QJsonObject OAICreateAccount_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateAccount_request::getName() const {
    return m_name;
}
void OAICreateAccount_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateAccount_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateAccount_request::is_name_Valid() const{
    return m_name_isValid;
}

bool OAICreateAccount_request::isSet() const {
...
bool OAICreateAccount_request::isValid() const {
