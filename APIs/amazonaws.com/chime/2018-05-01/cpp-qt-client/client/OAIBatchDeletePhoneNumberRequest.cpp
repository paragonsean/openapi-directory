...
#include "OAIBatchDeletePhoneNumberRequest.h"
...
OAIBatchDeletePhoneNumberRequest::OAIBatchDeletePhoneNumberRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchDeletePhoneNumberRequest::OAIBatchDeletePhoneNumberRequest() {
    this->initializeModel();
}

OAIBatchDeletePhoneNumberRequest::~OAIBatchDeletePhoneNumberRequest() {}

void OAIBatchDeletePhoneNumberRequest::initializeModel() {

    m_phone_number_ids_isSet = false;
    m_phone_number_ids_isValid = false;
}

void OAIBatchDeletePhoneNumberRequest::fromJson(QString jsonString) {
...
void OAIBatchDeletePhoneNumberRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchDeletePhoneNumberRequest::asJson() const {
...
QJsonObject OAIBatchDeletePhoneNumberRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_phone_number_ids.isSet()) {
        obj.insert(QString("PhoneNumberIds"), ::OpenAPI::toJsonValue(m_phone_number_ids));
    }
    return obj;
}

QList OAIBatchDeletePhoneNumberRequest::getPhoneNumberIds() const {
    return m_phone_number_ids;
}
void OAIBatchDeletePhoneNumberRequest::setPhoneNumberIds(const QList &phone_number_ids) {
    m_phone_number_ids = phone_number_ids;
    m_phone_number_ids_isSet = true;
}

bool OAIBatchDeletePhoneNumberRequest::is_phone_number_ids_Set() const{
    return m_phone_number_ids_isSet;
}

bool OAIBatchDeletePhoneNumberRequest::is_phone_number_ids_Valid() const{
    return m_phone_number_ids_isValid;
}

bool OAIBatchDeletePhoneNumberRequest::isSet() const {
...
bool OAIBatchDeletePhoneNumberRequest::isValid() const {
