...
/*
 * OAIBatchUpdatePhoneNumberResponse.h
 *
 * 
 */

#ifndef OAIBatchUpdatePhoneNumberResponse_H
#define OAIBatchUpdatePhoneNumberResponse_H
...
class OAIBatchUpdatePhoneNumberResponse : public OAIObject {
public:
    OAIBatchUpdatePhoneNumberResponse();
    OAIBatchUpdatePhoneNumberResponse(QString json);
    ~OAIBatchUpdatePhoneNumberResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdatePhoneNumberResponse)

#endif // OAIBatchUpdatePhoneNumberResponse_H
