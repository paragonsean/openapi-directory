...
/*
 * OAIBatchUpdateUserRequest.h
 *
 * 
 */

#ifndef OAIBatchUpdateUserRequest_H
#define OAIBatchUpdateUserRequest_H
...
class OAIBatchUpdateUserRequest : public OAIObject {
public:
    OAIBatchUpdateUserRequest();
    OAIBatchUpdateUserRequest(QString json);
    ~OAIBatchUpdateUserRequest() override;
    ...
    QList getUpdateUserRequestItems() const;
    void setUpdateUserRequestItems(const QList &update_user_request_items);
...
private:
    ...
    QList m_update_user_request_items;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdateUserRequest)

#endif // OAIBatchUpdateUserRequest_H
