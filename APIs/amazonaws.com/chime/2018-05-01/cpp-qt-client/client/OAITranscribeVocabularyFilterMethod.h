...
/*
 * OAITranscribeVocabularyFilterMethod.h
 *
 * 
 */

#ifndef OAITranscribeVocabularyFilterMethod_H
#define OAITranscribeVocabularyFilterMethod_H
...
class OAITranscribeVocabularyFilterMethod : public OAIEnum {
public:
    OAITranscribeVocabularyFilterMethod();
    OAITranscribeVocabularyFilterMethod(QString json);
    ~OAITranscribeVocabularyFilterMethod() override;
    ...
    enum class eOAITranscribeVocabularyFilterMethod {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REMOVE, 
        MASK, 
        TAG
    };
    OAITranscribeVocabularyFilterMethod::eOAITranscribeVocabularyFilterMethod getValue() const;
    void setValue(const OAITranscribeVocabularyFilterMethod::eOAITranscribeVocabularyFilterMethod& value);
...
private:
    ...
    eOAITranscribeVocabularyFilterMethod m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeVocabularyFilterMethod)

#endif // OAITranscribeVocabularyFilterMethod_H
