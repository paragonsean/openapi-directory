...
/*
 * OAIUpdateAccountResponse_Account.h
 *
 * 
 */

#ifndef OAIUpdateAccountResponse_Account_H
#define OAIUpdateAccountResponse_Account_H
...
class OAIUpdateAccountResponse_Account : public OAIObject {
public:
    OAIUpdateAccountResponse_Account();
    OAIUpdateAccountResponse_Account(QString json);
    ~OAIUpdateAccountResponse_Account() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccountResponse_Account)

#endif // OAIUpdateAccountResponse_Account_H
