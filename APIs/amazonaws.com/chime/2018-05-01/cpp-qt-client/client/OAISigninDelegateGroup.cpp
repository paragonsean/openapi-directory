...
#include "OAISigninDelegateGroup.h"
...
OAISigninDelegateGroup::OAISigninDelegateGroup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISigninDelegateGroup::OAISigninDelegateGroup() {
    this->initializeModel();
}

OAISigninDelegateGroup::~OAISigninDelegateGroup() {}

void OAISigninDelegateGroup::initializeModel() {

    m_group_name_isSet = false;
    m_group_name_isValid = false;
}

void OAISigninDelegateGroup::fromJson(QString jsonString) {
...
void OAISigninDelegateGroup::fromJsonObject(QJsonObject json) {
...
QString OAISigninDelegateGroup::asJson() const {
...
QJsonObject OAISigninDelegateGroup::asJsonObject() const {
    QJsonObject obj;
...
QString OAISigninDelegateGroup::getGroupName() const {
    return m_group_name;
}
void OAISigninDelegateGroup::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAISigninDelegateGroup::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAISigninDelegateGroup::is_group_name_Valid() const{
    return m_group_name_isValid;
}

bool OAISigninDelegateGroup::isSet() const {
...
bool OAISigninDelegateGroup::isValid() const {
