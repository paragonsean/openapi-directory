...
public:
    ...
    void setEnableSipLogs(const bool &enable_sip_logs);
    bool is_enable_sip_logs_Set() const;
    bool is_enable_sip_logs_Valid() const;

    bool getEnableMediaMetricLogs() const;
    void setEnableMediaMetricLogs(const bool &enable_media_metric_logs);
    bool is_enable_media_metric_logs_Set() const;
    bool is_enable_media_metric_logs_Valid() const;
...
private:
    ...
    bool m_enable_sip_logs;
    bool m_enable_sip_logs_isSet;
    bool m_enable_sip_logs_isValid;

    bool m_enable_media_metric_logs;
    bool m_enable_media_metric_logs_isSet;
    bool m_enable_media_metric_logs_isValid;
};
