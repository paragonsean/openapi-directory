...
OAICreateChannelBan_request::OAICreateChannelBan_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateChannelBan_request::OAICreateChannelBan_request() {
    this->initializeModel();
}

OAICreateChannelBan_request::~OAICreateChannelBan_request() {}

void OAICreateChannelBan_request::initializeModel() {

    m_member_arn_isSet = false;
    m_member_arn_isValid = false;
}

void OAICreateChannelBan_request::fromJson(QString jsonString) {
...
void OAICreateChannelBan_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateChannelBan_request::asJson() const {
...
QJsonObject OAICreateChannelBan_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateChannelBan_request::getMemberArn() const {
    return m_member_arn;
}
void OAICreateChannelBan_request::setMemberArn(const QString &member_arn) {
    m_member_arn = member_arn;
    m_member_arn_isSet = true;
}

bool OAICreateChannelBan_request::is_member_arn_Set() const{
    return m_member_arn_isSet;
}

bool OAICreateChannelBan_request::is_member_arn_Valid() const{
    return m_member_arn_isValid;
}

bool OAICreateChannelBan_request::isSet() const {
...
bool OAICreateChannelBan_request::isValid() const {
