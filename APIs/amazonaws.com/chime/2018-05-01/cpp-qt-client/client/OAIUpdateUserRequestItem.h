...
/*
 * OAIUpdateUserRequestItem.h
 *
 * The user ID and user fields to update, used with the &lt;a&gt;BatchUpdateUser&lt;/a&gt; action.
 */

#ifndef OAIUpdateUserRequestItem_H
#define OAIUpdateUserRequestItem_H
...
class OAIUpdateUserRequestItem : public OAIObject {
public:
    OAIUpdateUserRequestItem();
    OAIUpdateUserRequestItem(QString json);
    ~OAIUpdateUserRequestItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserRequestItem)

#endif // OAIUpdateUserRequestItem_H
