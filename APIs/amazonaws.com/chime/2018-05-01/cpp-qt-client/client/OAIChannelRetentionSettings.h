...
/*
 * OAIChannelRetentionSettings.h
 *
 * The details of the retention settings for a channel.
 */

#ifndef OAIChannelRetentionSettings_H
#define OAIChannelRetentionSettings_H
...
class OAIChannelRetentionSettings : public OAIObject {
public:
    OAIChannelRetentionSettings();
    OAIChannelRetentionSettings(QString json);
    ~OAIChannelRetentionSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelRetentionSettings)

#endif // OAIChannelRetentionSettings_H
