...
/*
 * OAIGetPhoneNumberResponse.h
 *
 * 
 */

#ifndef OAIGetPhoneNumberResponse_H
#define OAIGetPhoneNumberResponse_H
...
namespace OpenAPI {
class OAIGetPhoneNumberResponse_PhoneNumber;

class OAIGetPhoneNumberResponse : public OAIObject {
public:
    OAIGetPhoneNumberResponse();
    OAIGetPhoneNumberResponse(QString json);
    ~OAIGetPhoneNumberResponse() override;
    ...
    OAIGetPhoneNumberResponse_PhoneNumber getPhoneNumber() const;
    void setPhoneNumber(const OAIGetPhoneNumberResponse_PhoneNumber &phone_number);
...
private:
    ...
    OAIGetPhoneNumberResponse_PhoneNumber m_phone_number;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPhoneNumberResponse)

#endif // OAIGetPhoneNumberResponse_H
