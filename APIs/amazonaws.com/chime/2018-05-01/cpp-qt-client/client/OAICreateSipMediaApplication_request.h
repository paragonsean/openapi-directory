...
/*
 * OAICreateSipMediaApplication_request.h
 *
 * 
 */

#ifndef OAICreateSipMediaApplication_request_H
#define OAICreateSipMediaApplication_request_H
...
class OAICreateSipMediaApplication_request : public OAIObject {
public:
    OAICreateSipMediaApplication_request();
    OAICreateSipMediaApplication_request(QString json);
    ~OAICreateSipMediaApplication_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipMediaApplication_request)

#endif // OAICreateSipMediaApplication_request_H
