...
/*
 * OAIOrderedPhoneNumberStatus.h
 *
 * 
 */

#ifndef OAIOrderedPhoneNumberStatus_H
#define OAIOrderedPhoneNumberStatus_H
...
class OAIOrderedPhoneNumberStatus : public OAIEnum {
public:
    OAIOrderedPhoneNumberStatus();
    OAIOrderedPhoneNumberStatus(QString json);
    ~OAIOrderedPhoneNumberStatus() override;
    ...
    enum class eOAIOrderedPhoneNumberStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PROCESSING, 
        ACQUIRED, 
        FAILED
    };
    OAIOrderedPhoneNumberStatus::eOAIOrderedPhoneNumberStatus getValue() const;
    void setValue(const OAIOrderedPhoneNumberStatus::eOAIOrderedPhoneNumberStatus& value);
...
private:
    ...
    eOAIOrderedPhoneNumberStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderedPhoneNumberStatus)

#endif // OAIOrderedPhoneNumberStatus_H
