...
QString OAICreateBotRequest::getDisplayName() const {
    return m_display_name;
}
void OAICreateBotRequest::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAICreateBotRequest::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAICreateBotRequest::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAICreateBotRequest::getDomain() const {
    return m_domain;
}
void OAICreateBotRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAICreateBotRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAICreateBotRequest::is_domain_Valid() const{
