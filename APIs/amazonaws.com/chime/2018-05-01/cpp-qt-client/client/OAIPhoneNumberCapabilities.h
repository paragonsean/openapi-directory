...
/*
 * OAIPhoneNumberCapabilities.h
 *
 * The phone number capabilities for Amazon Chime Business Calling phone numbers, such as enabled inbound and outbound calling and text messaging.
 */

#ifndef OAIPhoneNumberCapabilities_H
#define OAIPhoneNumberCapabilities_H
...
class OAIPhoneNumberCapabilities : public OAIObject {
public:
    OAIPhoneNumberCapabilities();
    OAIPhoneNumberCapabilities(QString json);
    ~OAIPhoneNumberCapabilities() override;
    ...
    void setInboundSms(const bool &inbound_sms);
    bool is_inbound_sms_Set() const;
    bool is_inbound_sms_Valid() const;

    bool getOutboundSms() const;
    void setOutboundSms(const bool &outbound_sms);
    bool is_outbound_sms_Set() const;
    bool is_outbound_sms_Valid() const;

    bool getInboundMms() const;
    void setInboundMms(const bool &inbound_mms);
    bool is_inbound_mms_Set() const;
    bool is_inbound_mms_Valid() const;

    bool getOutboundMms() const;
    void setOutboundMms(const bool &outbound_mms);
    bool is_outbound_mms_Set() const;
    bool is_outbound_mms_Valid() const;
...
private:
    ...
    bool m_inbound_sms;
    bool m_inbound_sms_isSet;
    bool m_inbound_sms_isValid;

    bool m_outbound_sms;
    bool m_outbound_sms_isSet;
    bool m_outbound_sms_isValid;

    bool m_inbound_mms;
    bool m_inbound_mms_isSet;
    bool m_inbound_mms_isValid;

    bool m_outbound_mms;
    bool m_outbound_mms_isSet;
    bool m_outbound_mms_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberCapabilities)

#endif // OAIPhoneNumberCapabilities_H
