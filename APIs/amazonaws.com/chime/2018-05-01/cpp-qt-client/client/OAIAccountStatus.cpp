...
void OAIAccountStatus::initializeModel() {
    ...
    m_value = eOAIAccountStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAccountStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Suspended", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountStatus::SUSPENDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Active", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountStatus::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAccountStatus::fromJsonValue(QJsonValue json) {
...
QString OAIAccountStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIAccountStatus::SUSPENDED:
            val = "Suspended";
            break;
        case eOAIAccountStatus::ACTIVE:
            val = "Active";
            break;
        default:
            break;
...
QJsonValue OAIAccountStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAccountStatus::eOAIAccountStatus OAIAccountStatus::getValue() const {
    return m_value;
}

void OAIAccountStatus::setValue(const OAIAccountStatus::eOAIAccountStatus& value){
    m_value = value;
    m_value_isSet = true;
}
