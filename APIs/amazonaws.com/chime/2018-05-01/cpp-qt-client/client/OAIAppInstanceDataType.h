...
/*
 * OAIAppInstanceDataType.h
 *
 * 
 */

#ifndef OAIAppInstanceDataType_H
#define OAIAppInstanceDataType_H
...
class OAIAppInstanceDataType : public OAIEnum {
public:
    OAIAppInstanceDataType();
    OAIAppInstanceDataType(QString json);
    ~OAIAppInstanceDataType() override;
    ...
    enum class eOAIAppInstanceDataType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CHANNEL, 
        CHANNELMESSAGE
    };
    OAIAppInstanceDataType::eOAIAppInstanceDataType getValue() const;
    void setValue(const OAIAppInstanceDataType::eOAIAppInstanceDataType& value);
...
private:
    ...
    eOAIAppInstanceDataType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceDataType)

#endif // OAIAppInstanceDataType_H
