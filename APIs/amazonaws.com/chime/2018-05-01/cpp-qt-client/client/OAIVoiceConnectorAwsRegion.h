...
/*
 * OAIVoiceConnectorAwsRegion.h
 *
 * 
 */

#ifndef OAIVoiceConnectorAwsRegion_H
#define OAIVoiceConnectorAwsRegion_H
...
class OAIVoiceConnectorAwsRegion : public OAIEnum {
public:
    OAIVoiceConnectorAwsRegion();
    OAIVoiceConnectorAwsRegion(QString json);
    ~OAIVoiceConnectorAwsRegion() override;
    ...
    enum class eOAIVoiceConnectorAwsRegion {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EAST_1, 
        WEST_2
    };
    OAIVoiceConnectorAwsRegion::eOAIVoiceConnectorAwsRegion getValue() const;
    void setValue(const OAIVoiceConnectorAwsRegion::eOAIVoiceConnectorAwsRegion& value);
...
private:
    ...
    eOAIVoiceConnectorAwsRegion m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoiceConnectorAwsRegion)

#endif // OAIVoiceConnectorAwsRegion_H
