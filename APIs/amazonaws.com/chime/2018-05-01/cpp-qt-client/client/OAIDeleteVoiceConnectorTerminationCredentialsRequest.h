...
/*
 * OAIDeleteVoiceConnectorTerminationCredentialsRequest.h
 *
 * 
 */

#ifndef OAIDeleteVoiceConnectorTerminationCredentialsRequest_H
#define OAIDeleteVoiceConnectorTerminationCredentialsRequest_H
...
class OAIDeleteVoiceConnectorTerminationCredentialsRequest : public OAIObject {
public:
    OAIDeleteVoiceConnectorTerminationCredentialsRequest();
    OAIDeleteVoiceConnectorTerminationCredentialsRequest(QString json);
    ~OAIDeleteVoiceConnectorTerminationCredentialsRequest() override;
    ...
    void setUsernames(const QList &usernames);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVoiceConnectorTerminationCredentialsRequest)

#endif // OAIDeleteVoiceConnectorTerminationCredentialsRequest_H
