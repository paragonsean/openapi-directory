...
namespace OpenAPI {
class OAIUpdatePhoneNumberResponse_PhoneNumber;
...
public:
    ...
    OAIUpdatePhoneNumberResponse_PhoneNumber getPhoneNumber() const;
    void setPhoneNumber(const OAIUpdatePhoneNumberResponse_PhoneNumber &phone_number);
...
private:
    ...
    OAIUpdatePhoneNumberResponse_PhoneNumber m_phone_number;
