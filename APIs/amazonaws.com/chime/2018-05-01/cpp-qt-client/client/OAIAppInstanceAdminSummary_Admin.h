...
/*
 * OAIAppInstanceAdminSummary_Admin.h
 *
 * 
 */

#ifndef OAIAppInstanceAdminSummary_Admin_H
#define OAIAppInstanceAdminSummary_Admin_H
...
class OAIAppInstanceAdminSummary_Admin : public OAIObject {
public:
    OAIAppInstanceAdminSummary_Admin();
    OAIAppInstanceAdminSummary_Admin(QString json);
    ~OAIAppInstanceAdminSummary_Admin() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceAdminSummary_Admin)

#endif // OAIAppInstanceAdminSummary_Admin_H
