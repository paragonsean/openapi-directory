...
/*
 * OAIEventsConfiguration.h
 *
 * The configuration that allows a bot to receive outgoing events. Can be either an HTTPS endpoint or a Lambda function ARN.
 */

#ifndef OAIEventsConfiguration_H
#define OAIEventsConfiguration_H
...
class OAIEventsConfiguration : public OAIObject {
public:
    OAIEventsConfiguration();
    OAIEventsConfiguration(QString json);
    ~OAIEventsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsConfiguration)

#endif // OAIEventsConfiguration_H
