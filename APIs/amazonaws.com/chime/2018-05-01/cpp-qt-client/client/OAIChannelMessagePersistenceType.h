...
/*
 * OAIChannelMessagePersistenceType.h
 *
 * 
 */

#ifndef OAIChannelMessagePersistenceType_H
#define OAIChannelMessagePersistenceType_H
...
class OAIChannelMessagePersistenceType : public OAIEnum {
public:
    OAIChannelMessagePersistenceType();
    OAIChannelMessagePersistenceType(QString json);
    ~OAIChannelMessagePersistenceType() override;
    ...
    enum class eOAIChannelMessagePersistenceType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PERSISTENT, 
        NON_PERSISTENT
    };
    OAIChannelMessagePersistenceType::eOAIChannelMessagePersistenceType getValue() const;
    void setValue(const OAIChannelMessagePersistenceType::eOAIChannelMessagePersistenceType& value);
...
private:
    ...
    eOAIChannelMessagePersistenceType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelMessagePersistenceType)

#endif // OAIChannelMessagePersistenceType_H
