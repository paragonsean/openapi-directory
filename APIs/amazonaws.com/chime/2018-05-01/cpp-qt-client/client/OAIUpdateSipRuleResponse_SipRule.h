...
/*
 * OAIUpdateSipRuleResponse_SipRule.h
 *
 * 
 */

#ifndef OAIUpdateSipRuleResponse_SipRule_H
#define OAIUpdateSipRuleResponse_SipRule_H
...
class OAIUpdateSipRuleResponse_SipRule : public OAIObject {
public:
    OAIUpdateSipRuleResponse_SipRule();
    OAIUpdateSipRuleResponse_SipRule(QString json);
    ~OAIUpdateSipRuleResponse_SipRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipRuleResponse_SipRule)

#endif // OAIUpdateSipRuleResponse_SipRule_H
