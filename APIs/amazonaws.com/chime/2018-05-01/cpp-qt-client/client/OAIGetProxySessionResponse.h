...
/*
 * OAIGetProxySessionResponse.h
 *
 * 
 */

#ifndef OAIGetProxySessionResponse_H
#define OAIGetProxySessionResponse_H
...
namespace OpenAPI {
class OAICreateProxySessionResponse_ProxySession;

class OAIGetProxySessionResponse : public OAIObject {
public:
    OAIGetProxySessionResponse();
    OAIGetProxySessionResponse(QString json);
    ~OAIGetProxySessionResponse() override;
    ...
    OAICreateProxySessionResponse_ProxySession getProxySession() const;
    void setProxySession(const OAICreateProxySessionResponse_ProxySession &proxy_session);
    bool is_proxy_session_Set() const;
    bool is_proxy_session_Valid() const;
...
private:
    ...
    OAICreateProxySessionResponse_ProxySession m_proxy_session;
    bool m_proxy_session_isSet;
    bool m_proxy_session_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetProxySessionResponse)

#endif // OAIGetProxySessionResponse_H
