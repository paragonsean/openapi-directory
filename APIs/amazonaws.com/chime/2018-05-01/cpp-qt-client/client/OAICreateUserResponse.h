...
namespace OpenAPI {
class OAICreateUserResponse_User;
...
public:
    ...
    OAICreateUserResponse_User getUser() const;
    void setUser(const OAICreateUserResponse_User &user);
...
private:
    ...
    OAICreateUserResponse_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
