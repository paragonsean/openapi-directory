...
/*
 * OAIUpdateRoom_request.h
 *
 * 
 */

#ifndef OAIUpdateRoom_request_H
#define OAIUpdateRoom_request_H
...
class OAIUpdateRoom_request : public OAIObject {
public:
    OAIUpdateRoom_request();
    OAIUpdateRoom_request(QString json);
    ~OAIUpdateRoom_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoom_request)

#endif // OAIUpdateRoom_request_H
