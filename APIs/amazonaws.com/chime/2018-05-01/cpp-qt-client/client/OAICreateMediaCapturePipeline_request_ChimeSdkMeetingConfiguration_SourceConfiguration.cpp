...
OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration() {
    this->initializeModel();
}

OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::~OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration() {}

void OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::initializeModel() {

    m_selected_video_streams_isSet = false;
    m_selected_video_streams_isValid = false;
}

void OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::fromJson(QString jsonString) {
...
void OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::asJson() const {
...
QJsonObject OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAISourceConfiguration_SelectedVideoStreams OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::getSelectedVideoStreams() const {
    return m_selected_video_streams;
}
void OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::setSelectedVideoStreams(const OAISourceConfiguration_SelectedVideoStreams &selected_video_streams) {
    m_selected_video_streams = selected_video_streams;
    m_selected_video_streams_isSet = true;
}

bool OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::is_selected_video_streams_Set() const{
    return m_selected_video_streams_isSet;
}

bool OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::is_selected_video_streams_Valid() const{
    return m_selected_video_streams_isValid;
}

bool OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::isSet() const {
...
bool OAICreateMediaCapturePipeline_request_ChimeSdkMeetingConfiguration_SourceConfiguration::isValid() const {
