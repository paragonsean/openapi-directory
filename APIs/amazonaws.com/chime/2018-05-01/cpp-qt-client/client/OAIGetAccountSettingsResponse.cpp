...
OAIGetAccountSettingsResponse_AccountSettings OAIGetAccountSettingsResponse::getAccountSettings() const {
    return m_account_settings;
}
void OAIGetAccountSettingsResponse::setAccountSettings(const OAIGetAccountSettingsResponse_AccountSettings &account_settings) {
    m_account_settings = account_settings;
    m_account_settings_isSet = true;
}

bool OAIGetAccountSettingsResponse::is_account_settings_Set() const{
    return m_account_settings_isSet;
}

bool OAIGetAccountSettingsResponse::is_account_settings_Valid() const{
