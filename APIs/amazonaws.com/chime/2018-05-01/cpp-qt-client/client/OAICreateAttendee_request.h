...
/*
 * OAICreateAttendee_request.h
 *
 * 
 */

#ifndef OAICreateAttendee_request_H
#define OAICreateAttendee_request_H
...
class OAICreateAttendee_request : public OAIObject {
public:
    OAICreateAttendee_request();
    OAICreateAttendee_request(QString json);
    ~OAICreateAttendee_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAttendee_request)

#endif // OAICreateAttendee_request_H
