...
/*
 * OAIGetVoiceConnectorGroupResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorGroupResponse_H
#define OAIGetVoiceConnectorGroupResponse_H
...
class OAIGetVoiceConnectorGroupResponse : public OAIObject {
public:
    OAIGetVoiceConnectorGroupResponse();
    OAIGetVoiceConnectorGroupResponse(QString json);
    ~OAIGetVoiceConnectorGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorGroupResponse)

#endif // OAIGetVoiceConnectorGroupResponse_H
