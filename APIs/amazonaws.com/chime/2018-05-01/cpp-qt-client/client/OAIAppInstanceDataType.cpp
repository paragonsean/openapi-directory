...
#include "OAIAppInstanceDataType.h"
...
OAIAppInstanceDataType::OAIAppInstanceDataType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppInstanceDataType::OAIAppInstanceDataType() {
    this->initializeModel();
}

OAIAppInstanceDataType::~OAIAppInstanceDataType() {}

void OAIAppInstanceDataType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAppInstanceDataType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAppInstanceDataType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Channel", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAppInstanceDataType::CHANNEL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ChannelMessage", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAppInstanceDataType::CHANNELMESSAGE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAppInstanceDataType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAppInstanceDataType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAppInstanceDataType::CHANNEL:
            val = "Channel";
            break;
        case eOAIAppInstanceDataType::CHANNELMESSAGE:
            val = "ChannelMessage";
            break;
        default:
            break;
...
QJsonValue OAIAppInstanceDataType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAppInstanceDataType::eOAIAppInstanceDataType OAIAppInstanceDataType::getValue() const {
    return m_value;
}

void OAIAppInstanceDataType::setValue(const OAIAppInstanceDataType::eOAIAppInstanceDataType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAppInstanceDataType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAppInstanceDataType::isValid() const {
