...
/*
 * OAIGetVoiceConnectorLoggingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetVoiceConnectorLoggingConfigurationResponse_H
#define OAIGetVoiceConnectorLoggingConfigurationResponse_H
...
namespace OpenAPI {
class OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration;

class OAIGetVoiceConnectorLoggingConfigurationResponse : public OAIObject {
public:
    OAIGetVoiceConnectorLoggingConfigurationResponse();
    OAIGetVoiceConnectorLoggingConfigurationResponse(QString json);
    ~OAIGetVoiceConnectorLoggingConfigurationResponse() override;
    ...
    OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration getLoggingConfiguration() const;
    void setLoggingConfiguration(const OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration &logging_configuration);
...
private:
    ...
    OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration m_logging_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetVoiceConnectorLoggingConfigurationResponse)

#endif // OAIGetVoiceConnectorLoggingConfigurationResponse_H
