...
/*
 * OAIPutVoiceConnectorTerminationCredentials_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorTerminationCredentials_request_H
#define OAIPutVoiceConnectorTerminationCredentials_request_H
...
class OAIPutVoiceConnectorTerminationCredentials_request : public OAIObject {
public:
    OAIPutVoiceConnectorTerminationCredentials_request();
    OAIPutVoiceConnectorTerminationCredentials_request(QString json);
    ~OAIPutVoiceConnectorTerminationCredentials_request() override;
    ...
    QList<OAICredential> getCredentials() const;
    void setCredentials(const QList<OAICredential> &credentials);
...
private:
    ...
    QList<OAICredential> m_credentials;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorTerminationCredentials_request)

#endif // OAIPutVoiceConnectorTerminationCredentials_request_H
