...
/*
 * OAIListSipMediaApplicationsResponse.h
 *
 * 
 */

#ifndef OAIListSipMediaApplicationsResponse_H
#define OAIListSipMediaApplicationsResponse_H
...
class OAIListSipMediaApplicationsResponse : public OAIObject {
public:
    OAIListSipMediaApplicationsResponse();
    OAIListSipMediaApplicationsResponse(QString json);
    ~OAIListSipMediaApplicationsResponse() override;
    ...
    QList getSipMediaApplications() const;
    void setSipMediaApplications(const QList &sip_media_applications);
    bool is_sip_media_applications_Set() const;
    bool is_sip_media_applications_Valid() const;
...
private:
    ...
    QList m_sip_media_applications;
    bool m_sip_media_applications_isSet;
    bool m_sip_media_applications_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSipMediaApplicationsResponse)

#endif // OAIListSipMediaApplicationsResponse_H
