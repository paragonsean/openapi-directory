...
OAICallingNameStatus::OAICallingNameStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICallingNameStatus::OAICallingNameStatus() {
    this->initializeModel();
}

OAICallingNameStatus::~OAICallingNameStatus() {}

void OAICallingNameStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICallingNameStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICallingNameStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Unassigned", Qt::CaseInsensitive) == 0) {
        m_value = eOAICallingNameStatus::UNASSIGNED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UpdateInProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAICallingNameStatus::UPDATEINPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UpdateSucceeded", Qt::CaseInsensitive) == 0) {
        m_value = eOAICallingNameStatus::UPDATESUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UpdateFailed", Qt::CaseInsensitive) == 0) {
        m_value = eOAICallingNameStatus::UPDATEFAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICallingNameStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICallingNameStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICallingNameStatus::UNASSIGNED:
            val = "Unassigned";
            break;
        case eOAICallingNameStatus::UPDATEINPROGRESS:
            val = "UpdateInProgress";
            break;
        case eOAICallingNameStatus::UPDATESUCCEEDED:
            val = "UpdateSucceeded";
            break;
        case eOAICallingNameStatus::UPDATEFAILED:
            val = "UpdateFailed";
            break;
        default:
            break;
...
QJsonValue OAICallingNameStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICallingNameStatus::eOAICallingNameStatus OAICallingNameStatus::getValue() const {
    return m_value;
}

void OAICallingNameStatus::setValue(const OAICallingNameStatus::eOAICallingNameStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICallingNameStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAICallingNameStatus::isValid() const {
