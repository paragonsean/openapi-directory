...
/*
 * OAIBatchSuspendUserResponse.h
 *
 * 
 */

#ifndef OAIBatchSuspendUserResponse_H
#define OAIBatchSuspendUserResponse_H
...
class OAIBatchSuspendUserResponse : public OAIObject {
public:
    OAIBatchSuspendUserResponse();
    OAIBatchSuspendUserResponse(QString json);
    ~OAIBatchSuspendUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchSuspendUserResponse)

#endif // OAIBatchSuspendUserResponse_H
