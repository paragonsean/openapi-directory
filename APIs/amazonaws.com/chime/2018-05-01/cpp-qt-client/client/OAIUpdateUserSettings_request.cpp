...
OAIUpdateUserSettings_request::OAIUpdateUserSettings_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserSettings_request::OAIUpdateUserSettings_request() {
    this->initializeModel();
}

OAIUpdateUserSettings_request::~OAIUpdateUserSettings_request() {}

void OAIUpdateUserSettings_request::initializeModel() {

    m_user_settings_isSet = false;
    m_user_settings_isValid = false;
}

void OAIUpdateUserSettings_request::fromJson(QString jsonString) {
...
void OAIUpdateUserSettings_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserSettings_request::asJson() const {
...
QJsonObject OAIUpdateUserSettings_request::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateUserSettings_request_UserSettings OAIUpdateUserSettings_request::getUserSettings() const {
    return m_user_settings;
}
void OAIUpdateUserSettings_request::setUserSettings(const OAIUpdateUserSettings_request_UserSettings &user_settings) {
    m_user_settings = user_settings;
    m_user_settings_isSet = true;
}

bool OAIUpdateUserSettings_request::is_user_settings_Set() const{
    return m_user_settings_isSet;
}

bool OAIUpdateUserSettings_request::is_user_settings_Valid() const{
    return m_user_settings_isValid;
}

bool OAIUpdateUserSettings_request::isSet() const {
...
bool OAIUpdateUserSettings_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_settings_isValid && true;
}
