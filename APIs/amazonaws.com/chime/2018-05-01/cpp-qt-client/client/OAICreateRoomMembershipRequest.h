...
/*
 * OAICreateRoomMembershipRequest.h
 *
 * 
 */

#ifndef OAICreateRoomMembershipRequest_H
#define OAICreateRoomMembershipRequest_H
...
class OAICreateRoomMembershipRequest : public OAIObject {
public:
    OAICreateRoomMembershipRequest();
    OAICreateRoomMembershipRequest(QString json);
    ~OAICreateRoomMembershipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRoomMembershipRequest)

#endif // OAICreateRoomMembershipRequest_H
