...
OAIUpdateAccountSettingsRequest_AccountSettings OAIUpdateAccountSettingsRequest::getAccountSettings() const {
    return m_account_settings;
}
void OAIUpdateAccountSettingsRequest::setAccountSettings(const OAIUpdateAccountSettingsRequest_AccountSettings &account_settings) {
    m_account_settings = account_settings;
    m_account_settings_isSet = true;
}

bool OAIUpdateAccountSettingsRequest::is_account_settings_Set() const{
    return m_account_settings_isSet;
}

bool OAIUpdateAccountSettingsRequest::is_account_settings_Valid() const{
