...
/*
 * OAISigninDelegateGroup.h
 *
 * An Active Directory (AD) group whose members are granted permission to act as delegates.
 */

#ifndef OAISigninDelegateGroup_H
#define OAISigninDelegateGroup_H
...
class OAISigninDelegateGroup : public OAIObject {
public:
    OAISigninDelegateGroup();
    OAISigninDelegateGroup(QString json);
    ~OAISigninDelegateGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISigninDelegateGroup)

#endif // OAISigninDelegateGroup_H
