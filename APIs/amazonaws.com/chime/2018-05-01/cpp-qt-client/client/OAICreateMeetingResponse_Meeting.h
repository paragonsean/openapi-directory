...
/*
 * OAICreateMeetingResponse_Meeting.h
 *
 * 
 */

#ifndef OAICreateMeetingResponse_Meeting_H
#define OAICreateMeetingResponse_Meeting_H
...
class OAICreateMeetingResponse_Meeting : public OAIObject {
public:
    OAICreateMeetingResponse_Meeting();
    OAICreateMeetingResponse_Meeting(QString json);
    ~OAICreateMeetingResponse_Meeting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingResponse_Meeting)

#endif // OAICreateMeetingResponse_Meeting_H
