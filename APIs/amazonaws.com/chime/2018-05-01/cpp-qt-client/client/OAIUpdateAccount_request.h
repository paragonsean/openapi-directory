...
/*
 * OAIUpdateAccount_request.h
 *
 * 
 */

#ifndef OAIUpdateAccount_request_H
#define OAIUpdateAccount_request_H
...
class OAIUpdateAccount_request : public OAIObject {
public:
    OAIUpdateAccount_request();
    OAIUpdateAccount_request(QString json);
    ~OAIUpdateAccount_request() override;
    ...
    QString getDefaultLicense() const;
    void setDefaultLicense(const QString &default_license);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccount_request)

#endif // OAIUpdateAccount_request_H
