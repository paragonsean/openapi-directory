...
#include "OAIUpdateSipMediaApplicationCallRequest.h"
...
OAIUpdateSipMediaApplicationCallRequest::OAIUpdateSipMediaApplicationCallRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSipMediaApplicationCallRequest::OAIUpdateSipMediaApplicationCallRequest() {
    this->initializeModel();
}

OAIUpdateSipMediaApplicationCallRequest::~OAIUpdateSipMediaApplicationCallRequest() {}

void OAIUpdateSipMediaApplicationCallRequest::initializeModel() {

    m_arguments_isSet = false;
    m_arguments_isValid = false;
}

void OAIUpdateSipMediaApplicationCallRequest::fromJson(QString jsonString) {
...
void OAIUpdateSipMediaApplicationCallRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSipMediaApplicationCallRequest::asJson() const {
...
QJsonObject OAIUpdateSipMediaApplicationCallRequest::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIUpdateSipMediaApplicationCallRequest::getArguments() const {
    return m_arguments;
}
void OAIUpdateSipMediaApplicationCallRequest::setArguments(const QMap &arguments) {
    m_arguments = arguments;
    m_arguments_isSet = true;
}

bool OAIUpdateSipMediaApplicationCallRequest::is_arguments_Set() const{
    return m_arguments_isSet;
}

bool OAIUpdateSipMediaApplicationCallRequest::is_arguments_Valid() const{
    return m_arguments_isValid;
}

bool OAIUpdateSipMediaApplicationCallRequest::isSet() const {
...
bool OAIUpdateSipMediaApplicationCallRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_arguments_isValid && true;
}
