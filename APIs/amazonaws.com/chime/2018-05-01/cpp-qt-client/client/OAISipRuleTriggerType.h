...
/*
 * OAISipRuleTriggerType.h
 *
 * 
 */

#ifndef OAISipRuleTriggerType_H
#define OAISipRuleTriggerType_H
...
class OAISipRuleTriggerType : public OAIEnum {
public:
    OAISipRuleTriggerType();
    OAISipRuleTriggerType(QString json);
    ~OAISipRuleTriggerType() override;
    ...
    enum class eOAISipRuleTriggerType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TOPHONENUMBER, 
        REQUESTURIHOSTNAME
    };
    OAISipRuleTriggerType::eOAISipRuleTriggerType getValue() const;
    void setValue(const OAISipRuleTriggerType::eOAISipRuleTriggerType& value);
...
private:
    ...
    eOAISipRuleTriggerType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISipRuleTriggerType)

#endif // OAISipRuleTriggerType_H
