...
/*
 * OAICreatePhoneNumberOrderResponse_PhoneNumberOrder.h
 *
 * 
 */

#ifndef OAICreatePhoneNumberOrderResponse_PhoneNumberOrder_H
#define OAICreatePhoneNumberOrderResponse_PhoneNumberOrder_H
...
class OAICreatePhoneNumberOrderResponse_PhoneNumberOrder : public OAIObject {
public:
    OAICreatePhoneNumberOrderResponse_PhoneNumberOrder();
    OAICreatePhoneNumberOrderResponse_PhoneNumberOrder(QString json);
    ~OAICreatePhoneNumberOrderResponse_PhoneNumberOrder() override;
    ...
    QString getPhoneNumberOrderId() const;
    void setPhoneNumberOrderId(const QString &phone_number_order_id);
    bool is_phone_number_order_id_Set() const;
    bool is_phone_number_order_id_Valid() const;
    ...
    OAIPhoneNumberOrderStatus getStatus() const;
    void setStatus(const OAIPhoneNumberOrderStatus &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    QList getOrderedPhoneNumbers() const;
    void setOrderedPhoneNumbers(const QList &ordered_phone_numbers);
    bool is_ordered_phone_numbers_Set() const;
    bool is_ordered_phone_numbers_Valid() const;
...
private:
    ...
    QString m_phone_number_order_id;
    bool m_phone_number_order_id_isSet;
    bool m_phone_number_order_id_isValid;

    OAIPhoneNumberProductType m_product_type;
    bool m_product_type_isSet;
    bool m_product_type_isValid;

    OAIPhoneNumberOrderStatus m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    QList m_ordered_phone_numbers;
    bool m_ordered_phone_numbers_isSet;
    bool m_ordered_phone_numbers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePhoneNumberOrderResponse_PhoneNumberOrder)

#endif // OAICreatePhoneNumberOrderResponse_PhoneNumberOrder_H
