...
QString OAIMeeting::getMeetingId() const {
    return m_meeting_id;
}
void OAIMeeting::setMeetingId(const QString &meeting_id) {
    m_meeting_id = meeting_id;
    m_meeting_id_isSet = true;
}

bool OAIMeeting::is_meeting_id_Set() const{
    return m_meeting_id_isSet;
}

bool OAIMeeting::is_meeting_id_Valid() const{
    return m_meeting_id_isValid;
}

QString OAIMeeting::getExternalMeetingId() const {
    return m_external_meeting_id;
}
void OAIMeeting::setExternalMeetingId(const QString &external_meeting_id) {
    m_external_meeting_id = external_meeting_id;
    m_external_meeting_id_isSet = true;
}

bool OAIMeeting::is_external_meeting_id_Set() const{
    return m_external_meeting_id_isSet;
}

bool OAIMeeting::is_external_meeting_id_Valid() const{
    return m_external_meeting_id_isValid;
}

OAIMeeting_MediaPlacement OAIMeeting::getMediaPlacement() const {
    return m_media_placement;
}
void OAIMeeting::setMediaPlacement(const OAIMeeting_MediaPlacement &media_placement) {
    m_media_placement = media_placement;
    m_media_placement_isSet = true;
}

bool OAIMeeting::is_media_placement_Set() const{
    return m_media_placement_isSet;
}

bool OAIMeeting::is_media_placement_Valid() const{
    return m_media_placement_isValid;
}

QString OAIMeeting::getMediaRegion() const {
    return m_media_region;
}
void OAIMeeting::setMediaRegion(const QString &media_region) {
    m_media_region = media_region;
    m_media_region_isSet = true;
}

bool OAIMeeting::is_media_region_Set() const{
    return m_media_region_isSet;
}

bool OAIMeeting::is_media_region_Valid() const{
