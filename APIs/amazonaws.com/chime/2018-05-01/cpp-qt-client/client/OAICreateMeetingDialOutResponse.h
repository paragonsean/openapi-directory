...
/*
 * OAICreateMeetingDialOutResponse.h
 *
 * 
 */

#ifndef OAICreateMeetingDialOutResponse_H
#define OAICreateMeetingDialOutResponse_H
...
class OAICreateMeetingDialOutResponse : public OAIObject {
public:
    OAICreateMeetingDialOutResponse();
    OAICreateMeetingDialOutResponse(QString json);
    ~OAICreateMeetingDialOutResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingDialOutResponse)

#endif // OAICreateMeetingDialOutResponse_H
