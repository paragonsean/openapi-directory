...
/*
 * OAIAppInstanceUser.h
 *
 * The details of an &lt;code&gt;AppInstanceUser&lt;/code&gt;.
 */

#ifndef OAIAppInstanceUser_H
#define OAIAppInstanceUser_H
...
class OAIAppInstanceUser : public OAIObject {
public:
    OAIAppInstanceUser();
    OAIAppInstanceUser(QString json);
    ~OAIAppInstanceUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceUser)

#endif // OAIAppInstanceUser_H
