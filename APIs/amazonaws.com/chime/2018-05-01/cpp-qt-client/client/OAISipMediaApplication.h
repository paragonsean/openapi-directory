...
/*
 * OAISipMediaApplication.h
 *
 * The details of the SIP media application, including name and endpoints. An AWS account can have multiple SIP media applications.
 */

#ifndef OAISipMediaApplication_H
#define OAISipMediaApplication_H
...
class OAISipMediaApplication : public OAIObject {
public:
    OAISipMediaApplication();
    OAISipMediaApplication(QString json);
    ~OAISipMediaApplication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISipMediaApplication)

#endif // OAISipMediaApplication_H
