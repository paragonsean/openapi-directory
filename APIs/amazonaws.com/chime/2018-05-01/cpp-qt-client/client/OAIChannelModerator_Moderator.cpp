...
OAIChannelModerator_Moderator::OAIChannelModerator_Moderator(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelModerator_Moderator::OAIChannelModerator_Moderator() {
    this->initializeModel();
}

OAIChannelModerator_Moderator::~OAIChannelModerator_Moderator() {}

void OAIChannelModerator_Moderator::initializeModel() {
...
void OAIChannelModerator_Moderator::fromJson(QString jsonString) {
...
void OAIChannelModerator_Moderator::fromJsonObject(QJsonObject json) {
...
QString OAIChannelModerator_Moderator::asJson() const {
...
QJsonObject OAIChannelModerator_Moderator::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIChannelModerator_Moderator::getArn() const {
    return m_arn;
}
void OAIChannelModerator_Moderator::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIChannelModerator_Moderator::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIChannelModerator_Moderator::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIChannelModerator_Moderator::getName() const {
    return m_name;
}
void OAIChannelModerator_Moderator::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChannelModerator_Moderator::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChannelModerator_Moderator::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIChannelModerator_Moderator::isSet() const {
...
bool OAIChannelModerator_Moderator::isValid() const {
