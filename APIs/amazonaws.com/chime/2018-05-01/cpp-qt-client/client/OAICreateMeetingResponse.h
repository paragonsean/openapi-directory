...
/*
 * OAICreateMeetingResponse.h
 *
 * 
 */

#ifndef OAICreateMeetingResponse_H
#define OAICreateMeetingResponse_H

#include <QJsonObject>

#include "OAICreateMeetingResponse_Meeting.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateMeetingResponse_Meeting;

class OAICreateMeetingResponse : public OAIObject {
public:
    OAICreateMeetingResponse();
    OAICreateMeetingResponse(QString json);
    ~OAICreateMeetingResponse() override;
    ...
    OAICreateMeetingResponse_Meeting getMeeting() const;
    void setMeeting(const OAICreateMeetingResponse_Meeting &meeting);
...
private:
    ...
    OAICreateMeetingResponse_Meeting m_meeting;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingResponse)

#endif // OAICreateMeetingResponse_H
