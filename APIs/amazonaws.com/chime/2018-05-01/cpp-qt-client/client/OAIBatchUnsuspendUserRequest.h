...
/*
 * OAIBatchUnsuspendUserRequest.h
 *
 * 
 */

#ifndef OAIBatchUnsuspendUserRequest_H
#define OAIBatchUnsuspendUserRequest_H
...
class OAIBatchUnsuspendUserRequest : public OAIObject {
public:
    OAIBatchUnsuspendUserRequest();
    OAIBatchUnsuspendUserRequest(QString json);
    ~OAIBatchUnsuspendUserRequest() override;
    ...
    QList getUserIdList() const;
    void setUserIdList(const QList &user_id_list);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUnsuspendUserRequest)

#endif // OAIBatchUnsuspendUserRequest_H
