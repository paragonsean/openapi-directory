...
/*
 * OAIPutVoiceConnectorStreamingConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorStreamingConfiguration_request_H
#define OAIPutVoiceConnectorStreamingConfiguration_request_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration;

class OAIPutVoiceConnectorStreamingConfiguration_request : public OAIObject {
public:
    OAIPutVoiceConnectorStreamingConfiguration_request();
    OAIPutVoiceConnectorStreamingConfiguration_request(QString json);
    ~OAIPutVoiceConnectorStreamingConfiguration_request() override;
    ...
    OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration getStreamingConfiguration() const;
    void setStreamingConfiguration(const OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration &streaming_configuration);
...
private:
    ...
    OAIPutVoiceConnectorStreamingConfiguration_request_StreamingConfiguration m_streaming_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorStreamingConfiguration_request)

#endif // OAIPutVoiceConnectorStreamingConfiguration_request_H
