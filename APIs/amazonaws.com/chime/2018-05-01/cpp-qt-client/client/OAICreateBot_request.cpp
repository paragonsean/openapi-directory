...
QString OAICreateBot_request::getDisplayName() const {
    return m_display_name;
}
void OAICreateBot_request::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAICreateBot_request::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAICreateBot_request::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAICreateBot_request::getDomain() const {
    return m_domain;
}
void OAICreateBot_request::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAICreateBot_request::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAICreateBot_request::is_domain_Valid() const{
