...
/*
 * OAIResetPersonalPINResponse.h
 *
 * 
 */

#ifndef OAIResetPersonalPINResponse_H
#define OAIResetPersonalPINResponse_H

#include <QJsonObject>

#include "OAIResetPersonalPINResponse_User.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIResetPersonalPINResponse_User;

class OAIResetPersonalPINResponse : public OAIObject {
public:
    OAIResetPersonalPINResponse();
    OAIResetPersonalPINResponse(QString json);
    ~OAIResetPersonalPINResponse() override;
    ...
    OAIResetPersonalPINResponse_User getUser() const;
    void setUser(const OAIResetPersonalPINResponse_User &user);
...
private:
    ...
    OAIResetPersonalPINResponse_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIResetPersonalPINResponse)

#endif // OAIResetPersonalPINResponse_H
