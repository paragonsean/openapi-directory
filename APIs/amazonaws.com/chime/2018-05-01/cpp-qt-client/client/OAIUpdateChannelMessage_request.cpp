...
OAIUpdateChannelMessage_request::OAIUpdateChannelMessage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateChannelMessage_request::OAIUpdateChannelMessage_request() {
    this->initializeModel();
}

OAIUpdateChannelMessage_request::~OAIUpdateChannelMessage_request() {}

void OAIUpdateChannelMessage_request::initializeModel() {
...
void OAIUpdateChannelMessage_request::fromJson(QString jsonString) {
...
void OAIUpdateChannelMessage_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateChannelMessage_request::asJson() const {
...
QJsonObject OAIUpdateChannelMessage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_content_isSet) {
...
QString OAIUpdateChannelMessage_request::getContent() const {
    return m_content;
}
void OAIUpdateChannelMessage_request::setContent(const QString &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIUpdateChannelMessage_request::is_content_Set() const{
    return m_content_isSet;
}

bool OAIUpdateChannelMessage_request::is_content_Valid() const{
    return m_content_isValid;
}

QString OAIUpdateChannelMessage_request::getMetadata() const {
    return m_metadata;
}
void OAIUpdateChannelMessage_request::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateChannelMessage_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateChannelMessage_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIUpdateChannelMessage_request::isSet() const {
...
bool OAIUpdateChannelMessage_request::isValid() const {
