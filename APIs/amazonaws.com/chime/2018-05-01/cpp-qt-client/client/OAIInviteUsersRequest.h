...
/*
 * OAIInviteUsersRequest.h
 *
 * 
 */

#ifndef OAIInviteUsersRequest_H
#define OAIInviteUsersRequest_H
...
class OAIInviteUsersRequest : public OAIObject {
public:
    OAIInviteUsersRequest();
    OAIInviteUsersRequest(QString json);
    ~OAIInviteUsersRequest() override;
    ...
    QList getUserEmailList() const;
    void setUserEmailList(const QList &user_email_list);
    bool is_user_email_list_Set() const;
    bool is_user_email_list_Valid() const;
...
private:
    ...
    QList m_user_email_list;
    bool m_user_email_list_isSet;
    bool m_user_email_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInviteUsersRequest)

#endif // OAIInviteUsersRequest_H
