...
#include "OAIPutVoiceConnectorTerminationRequest.h"
...
OAIPutVoiceConnectorTerminationRequest::OAIPutVoiceConnectorTerminationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorTerminationRequest::OAIPutVoiceConnectorTerminationRequest() {
    this->initializeModel();
}

OAIPutVoiceConnectorTerminationRequest::~OAIPutVoiceConnectorTerminationRequest() {}

void OAIPutVoiceConnectorTerminationRequest::initializeModel() {

    m_termination_isSet = false;
    m_termination_isValid = false;
}

void OAIPutVoiceConnectorTerminationRequest::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorTerminationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorTerminationRequest::asJson() const {
...
QJsonObject OAIPutVoiceConnectorTerminationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_termination.isSet()) {
        obj.insert(QString("Termination"), ::OpenAPI::toJsonValue(m_termination));
    }
    return obj;
}

OAIPutVoiceConnectorTerminationRequest_Termination OAIPutVoiceConnectorTerminationRequest::getTermination() const {
    return m_termination;
}
void OAIPutVoiceConnectorTerminationRequest::setTermination(const OAIPutVoiceConnectorTerminationRequest_Termination &termination) {
    m_termination = termination;
    m_termination_isSet = true;
}

bool OAIPutVoiceConnectorTerminationRequest::is_termination_Set() const{
    return m_termination_isSet;
}

bool OAIPutVoiceConnectorTerminationRequest::is_termination_Valid() const{
    return m_termination_isValid;
}

bool OAIPutVoiceConnectorTerminationRequest::isSet() const {
...
bool OAIPutVoiceConnectorTerminationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_termination_isValid && true;
}
