...
OAICreateRoomResponse_Room OAICreateRoomResponse::getRoom() const {
    return m_room;
}
void OAICreateRoomResponse::setRoom(const OAICreateRoomResponse_Room &room) {
    m_room = room;
    m_room_isSet = true;
}

bool OAICreateRoomResponse::is_room_Set() const{
    return m_room_isSet;
}

bool OAICreateRoomResponse::is_room_Valid() const{
