...
OAIEmailStatus::OAIEmailStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmailStatus::OAIEmailStatus() {
    this->initializeModel();
}

OAIEmailStatus::~OAIEmailStatus() {}

void OAIEmailStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEmailStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEmailStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NotSent", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmailStatus::NOTSENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Sent", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmailStatus::SENT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmailStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEmailStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEmailStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEmailStatus::NOTSENT:
            val = "NotSent";
            break;
        case eOAIEmailStatus::SENT:
            val = "Sent";
            break;
        case eOAIEmailStatus::FAILED:
            val = "Failed";
            break;
        default:
            break;
...
QJsonValue OAIEmailStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEmailStatus::eOAIEmailStatus OAIEmailStatus::getValue() const {
    return m_value;
}

void OAIEmailStatus::setValue(const OAIEmailStatus::eOAIEmailStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEmailStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIEmailStatus::isValid() const {
