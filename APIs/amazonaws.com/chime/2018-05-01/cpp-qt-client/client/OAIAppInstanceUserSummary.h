...
/*
 * OAIAppInstanceUserSummary.h
 *
 * Summary of the details of an &lt;code&gt;AppInstanceUser&lt;/code&gt;.
 */

#ifndef OAIAppInstanceUserSummary_H
#define OAIAppInstanceUserSummary_H
...
class OAIAppInstanceUserSummary : public OAIObject {
public:
    OAIAppInstanceUserSummary();
    OAIAppInstanceUserSummary(QString json);
    ~OAIAppInstanceUserSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppInstanceUserSummary)

#endif // OAIAppInstanceUserSummary_H
