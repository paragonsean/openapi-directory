...
namespace OpenAPI {
class OAICreateAccountResponse_Account;
...
public:
    ...
    OAICreateAccountResponse_Account getAccount() const;
    void setAccount(const OAICreateAccountResponse_Account &account);
...
private:
    ...
    OAICreateAccountResponse_Account m_account;
