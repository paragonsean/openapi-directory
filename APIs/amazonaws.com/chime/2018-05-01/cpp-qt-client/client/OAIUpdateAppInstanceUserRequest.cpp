...
#include "OAIUpdateAppInstanceUserRequest.h"
...
OAIUpdateAppInstanceUserRequest::OAIUpdateAppInstanceUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAppInstanceUserRequest::OAIUpdateAppInstanceUserRequest() {
    this->initializeModel();
}

OAIUpdateAppInstanceUserRequest::~OAIUpdateAppInstanceUserRequest() {}

void OAIUpdateAppInstanceUserRequest::initializeModel() {
...
void OAIUpdateAppInstanceUserRequest::fromJson(QString jsonString) {
...
void OAIUpdateAppInstanceUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAppInstanceUserRequest::asJson() const {
...
QJsonObject OAIUpdateAppInstanceUserRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateAppInstanceUserRequest::getName() const {
    return m_name;
}
void OAIUpdateAppInstanceUserRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAppInstanceUserRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAppInstanceUserRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateAppInstanceUserRequest::getMetadata() const {
    return m_metadata;
}
void OAIUpdateAppInstanceUserRequest::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateAppInstanceUserRequest::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateAppInstanceUserRequest::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIUpdateAppInstanceUserRequest::isSet() const {
...
bool OAIUpdateAppInstanceUserRequest::isValid() const {
