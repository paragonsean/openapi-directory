...
/*
 * OAIGetEventsConfigurationResponse.h
 *
 * 
 */

#ifndef OAIGetEventsConfigurationResponse_H
#define OAIGetEventsConfigurationResponse_H
...
namespace OpenAPI {
class OAIGetEventsConfigurationResponse_EventsConfiguration;

class OAIGetEventsConfigurationResponse : public OAIObject {
public:
    OAIGetEventsConfigurationResponse();
    OAIGetEventsConfigurationResponse(QString json);
    ~OAIGetEventsConfigurationResponse() override;
    ...
    OAIGetEventsConfigurationResponse_EventsConfiguration getEventsConfiguration() const;
    void setEventsConfiguration(const OAIGetEventsConfigurationResponse_EventsConfiguration &events_configuration);
...
private:
    ...
    OAIGetEventsConfigurationResponse_EventsConfiguration m_events_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventsConfigurationResponse)

#endif // OAIGetEventsConfigurationResponse_H
