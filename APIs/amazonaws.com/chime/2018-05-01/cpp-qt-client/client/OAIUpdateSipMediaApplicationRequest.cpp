...
#include "OAIUpdateSipMediaApplicationRequest.h"
...
OAIUpdateSipMediaApplicationRequest::OAIUpdateSipMediaApplicationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSipMediaApplicationRequest::OAIUpdateSipMediaApplicationRequest() {
    this->initializeModel();
}

OAIUpdateSipMediaApplicationRequest::~OAIUpdateSipMediaApplicationRequest() {}

void OAIUpdateSipMediaApplicationRequest::initializeModel() {
...
void OAIUpdateSipMediaApplicationRequest::fromJson(QString jsonString) {
...
void OAIUpdateSipMediaApplicationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSipMediaApplicationRequest::asJson() const {
...
QJsonObject OAIUpdateSipMediaApplicationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateSipMediaApplicationRequest::getName() const {
    return m_name;
}
void OAIUpdateSipMediaApplicationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateSipMediaApplicationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateSipMediaApplicationRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIUpdateSipMediaApplicationRequest::getEndpoints() const {
    return m_endpoints;
}
void OAIUpdateSipMediaApplicationRequest::setEndpoints(const QList &endpoints) {
    m_endpoints = endpoints;
    m_endpoints_isSet = true;
}

bool OAIUpdateSipMediaApplicationRequest::is_endpoints_Set() const{
    return m_endpoints_isSet;
}

bool OAIUpdateSipMediaApplicationRequest::is_endpoints_Valid() const{
    return m_endpoints_isValid;
}

bool OAIUpdateSipMediaApplicationRequest::isSet() const {
...
bool OAIUpdateSipMediaApplicationRequest::isValid() const {
