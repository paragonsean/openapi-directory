...
/*
 * OAIUpdateGlobalSettingsRequest.h
 *
 * 
 */

#ifndef OAIUpdateGlobalSettingsRequest_H
#define OAIUpdateGlobalSettingsRequest_H

#include <QJsonObject>

#include "OAIGetGlobalSettingsResponse_BusinessCalling.h"
#include "OAIGetGlobalSettingsResponse_VoiceConnector.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetGlobalSettingsResponse_BusinessCalling;
class OAIGetGlobalSettingsResponse_VoiceConnector;

class OAIUpdateGlobalSettingsRequest : public OAIObject {
public:
    OAIUpdateGlobalSettingsRequest();
    OAIUpdateGlobalSettingsRequest(QString json);
    ~OAIUpdateGlobalSettingsRequest() override;
    ...
    OAIGetGlobalSettingsResponse_BusinessCalling getBusinessCalling() const;
    void setBusinessCalling(const OAIGetGlobalSettingsResponse_BusinessCalling &business_calling);
    bool is_business_calling_Set() const;
    bool is_business_calling_Valid() const;

    OAIGetGlobalSettingsResponse_VoiceConnector getVoiceConnector() const;
    void setVoiceConnector(const OAIGetGlobalSettingsResponse_VoiceConnector &voice_connector);
    bool is_voice_connector_Set() const;
    bool is_voice_connector_Valid() const;
...
private:
    ...
    OAIGetGlobalSettingsResponse_BusinessCalling m_business_calling;
    bool m_business_calling_isSet;
    bool m_business_calling_isValid;

    OAIGetGlobalSettingsResponse_VoiceConnector m_voice_connector;
    bool m_voice_connector_isSet;
    bool m_voice_connector_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGlobalSettingsRequest)

#endif // OAIUpdateGlobalSettingsRequest_H
