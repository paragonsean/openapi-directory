...
#include "OAICreateAttendeeRequest.h"
...
OAICreateAttendeeRequest::OAICreateAttendeeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAttendeeRequest::OAICreateAttendeeRequest() {
    this->initializeModel();
}

OAICreateAttendeeRequest::~OAICreateAttendeeRequest() {}

void OAICreateAttendeeRequest::initializeModel() {
...
void OAICreateAttendeeRequest::fromJson(QString jsonString) {
...
void OAICreateAttendeeRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateAttendeeRequest::asJson() const {
...
QJsonObject OAICreateAttendeeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAttendeeRequest::getExternalUserId() const {
    return m_external_user_id;
}
void OAICreateAttendeeRequest::setExternalUserId(const QString &external_user_id) {
    m_external_user_id = external_user_id;
    m_external_user_id_isSet = true;
}

bool OAICreateAttendeeRequest::is_external_user_id_Set() const{
    return m_external_user_id_isSet;
}

bool OAICreateAttendeeRequest::is_external_user_id_Valid() const{
    return m_external_user_id_isValid;
}

QList OAICreateAttendeeRequest::getTags() const {
    return m_tags;
}
void OAICreateAttendeeRequest::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAttendeeRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAttendeeRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateAttendeeRequest::isSet() const {
...
bool OAICreateAttendeeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_external_user_id_isValid && true;
}
