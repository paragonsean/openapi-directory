...
/*
 * OAIListRoomMembershipsResponse.h
 *
 * 
 */

#ifndef OAIListRoomMembershipsResponse_H
#define OAIListRoomMembershipsResponse_H
...
class OAIListRoomMembershipsResponse : public OAIObject {
public:
    OAIListRoomMembershipsResponse();
    OAIListRoomMembershipsResponse(QString json);
    ~OAIListRoomMembershipsResponse() override;
    ...
    QList getRoomMemberships() const;
    void setRoomMemberships(const QList &room_memberships);
    bool is_room_memberships_Set() const;
    bool is_room_memberships_Valid() const;
...
private:
    ...
    QList m_room_memberships;
    bool m_room_memberships_isSet;
    bool m_room_memberships_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRoomMembershipsResponse)

#endif // OAIListRoomMembershipsResponse_H
