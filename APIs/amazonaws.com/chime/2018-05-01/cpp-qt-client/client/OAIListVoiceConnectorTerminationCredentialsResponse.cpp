...
OAIListVoiceConnectorTerminationCredentialsResponse::OAIListVoiceConnectorTerminationCredentialsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListVoiceConnectorTerminationCredentialsResponse::OAIListVoiceConnectorTerminationCredentialsResponse() {
    this->initializeModel();
}

OAIListVoiceConnectorTerminationCredentialsResponse::~OAIListVoiceConnectorTerminationCredentialsResponse() {}

void OAIListVoiceConnectorTerminationCredentialsResponse::initializeModel() {

    m_usernames_isSet = false;
    m_usernames_isValid = false;
}

void OAIListVoiceConnectorTerminationCredentialsResponse::fromJson(QString jsonString) {
...
void OAIListVoiceConnectorTerminationCredentialsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListVoiceConnectorTerminationCredentialsResponse::asJson() const {
...
QJsonObject OAIListVoiceConnectorTerminationCredentialsResponse::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListVoiceConnectorTerminationCredentialsResponse::getUsernames() const {
    return m_usernames;
}
void OAIListVoiceConnectorTerminationCredentialsResponse::setUsernames(const QList &usernames) {
    m_usernames = usernames;
    m_usernames_isSet = true;
}

bool OAIListVoiceConnectorTerminationCredentialsResponse::is_usernames_Set() const{
    return m_usernames_isSet;
}

bool OAIListVoiceConnectorTerminationCredentialsResponse::is_usernames_Valid() const{
    return m_usernames_isValid;
}

bool OAIListVoiceConnectorTerminationCredentialsResponse::isSet() const {
...
bool OAIListVoiceConnectorTerminationCredentialsResponse::isValid() const {
