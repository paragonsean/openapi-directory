...
/*
 * OAIAssociatePhoneNumberWithUserRequest.h
 *
 * 
 */

#ifndef OAIAssociatePhoneNumberWithUserRequest_H
#define OAIAssociatePhoneNumberWithUserRequest_H
...
class OAIAssociatePhoneNumberWithUserRequest : public OAIObject {
public:
    OAIAssociatePhoneNumberWithUserRequest();
    OAIAssociatePhoneNumberWithUserRequest(QString json);
    ~OAIAssociatePhoneNumberWithUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatePhoneNumberWithUserRequest)

#endif // OAIAssociatePhoneNumberWithUserRequest_H
