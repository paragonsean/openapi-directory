...
#ifndef OAIRoomMembership_H
#define OAIRoomMembership_H
...
namespace OpenAPI {
class OAIRoomMembership_Member;

class OAIRoomMembership : public OAIObject {
public:
    OAIRoomMembership();
    OAIRoomMembership(QString json);
    ~OAIRoomMembership() override;
    ...
    OAIRoomMembership_Member getMember() const;
    void setMember(const OAIRoomMembership_Member &member);
    bool is_member_Set() const;
    bool is_member_Valid() const;

    OAIRoomMembershipRole getRole() const;
    void setRole(const OAIRoomMembershipRole &role);
...
private:
    ...
    OAIRoomMembership_Member m_member;
    bool m_member_isSet;
    bool m_member_isValid;

    OAIRoomMembershipRole m_role;
    bool m_role_isSet;
    bool m_role_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomMembership)

#endif // OAIRoomMembership_H
