...
/*
 * OAISipRuleTargetApplication.h
 *
 * Target SIP media application and other details, such as priority and AWS Region, to be specified in the SIP rule. Only one SIP rule per AWS Region can be provided.
 */

#ifndef OAISipRuleTargetApplication_H
#define OAISipRuleTargetApplication_H
...
class OAISipRuleTargetApplication : public OAIObject {
public:
    OAISipRuleTargetApplication();
    OAISipRuleTargetApplication(QString json);
    ~OAISipRuleTargetApplication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISipRuleTargetApplication)

#endif // OAISipRuleTargetApplication_H
