...
/*
 * OAIRegenerateSecurityTokenResponse_Bot.h
 *
 * 
 */

#ifndef OAIRegenerateSecurityTokenResponse_Bot_H
#define OAIRegenerateSecurityTokenResponse_Bot_H
...
class OAIRegenerateSecurityTokenResponse_Bot : public OAIObject {
public:
    OAIRegenerateSecurityTokenResponse_Bot();
    OAIRegenerateSecurityTokenResponse_Bot(QString json);
    ~OAIRegenerateSecurityTokenResponse_Bot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegenerateSecurityTokenResponse_Bot)

#endif // OAIRegenerateSecurityTokenResponse_Bot_H
