...
OAIGetVoiceConnectorLoggingConfigurationResponse::OAIGetVoiceConnectorLoggingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorLoggingConfigurationResponse::OAIGetVoiceConnectorLoggingConfigurationResponse() {
    this->initializeModel();
}

OAIGetVoiceConnectorLoggingConfigurationResponse::~OAIGetVoiceConnectorLoggingConfigurationResponse() {}

void OAIGetVoiceConnectorLoggingConfigurationResponse::initializeModel() {

    m_logging_configuration_isSet = false;
    m_logging_configuration_isValid = false;
}

void OAIGetVoiceConnectorLoggingConfigurationResponse::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorLoggingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetVoiceConnectorLoggingConfigurationResponse::asJson() const {
...
QJsonObject OAIGetVoiceConnectorLoggingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration OAIGetVoiceConnectorLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIGetVoiceConnectorLoggingConfigurationResponse::setLoggingConfiguration(const OAIGetVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIGetVoiceConnectorLoggingConfigurationResponse::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIGetVoiceConnectorLoggingConfigurationResponse::is_logging_configuration_Valid() const{
    return m_logging_configuration_isValid;
}

bool OAIGetVoiceConnectorLoggingConfigurationResponse::isSet() const {
...
bool OAIGetVoiceConnectorLoggingConfigurationResponse::isValid() const {
