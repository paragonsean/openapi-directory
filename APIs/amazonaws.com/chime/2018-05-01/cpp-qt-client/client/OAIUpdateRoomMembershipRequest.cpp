...
#include "OAIUpdateRoomMembershipRequest.h"
...
OAIUpdateRoomMembershipRequest::OAIUpdateRoomMembershipRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoomMembershipRequest::OAIUpdateRoomMembershipRequest() {
    this->initializeModel();
}

OAIUpdateRoomMembershipRequest::~OAIUpdateRoomMembershipRequest() {}

void OAIUpdateRoomMembershipRequest::initializeModel() {

    m_role_isSet = false;
    m_role_isValid = false;
}

void OAIUpdateRoomMembershipRequest::fromJson(QString jsonString) {
...
void OAIUpdateRoomMembershipRequest::fromJsonObject(QJsonObject json) {

    m_role_isValid = ::OpenAPI::fromJsonValue(m_role, json[QString("Role")]);
    m_role_isSet = !json[QString("Role")].isNull() && m_role_isValid;
}

QString OAIUpdateRoomMembershipRequest::asJson() const {
...
QJsonObject OAIUpdateRoomMembershipRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_role.isSet()) {
...
OAIRoomMembershipRole OAIUpdateRoomMembershipRequest::getRole() const {
    return m_role;
}
void OAIUpdateRoomMembershipRequest::setRole(const OAIRoomMembershipRole &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIUpdateRoomMembershipRequest::is_role_Set() const{
    return m_role_isSet;
}

bool OAIUpdateRoomMembershipRequest::is_role_Valid() const{
    return m_role_isValid;
}

bool OAIUpdateRoomMembershipRequest::isSet() const {
...
bool OAIUpdateRoomMembershipRequest::isValid() const {
