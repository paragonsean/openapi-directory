...
/*
 * OAIRoomRetentionSettings.h
 *
 * The retention settings that determine how long to retain chat-room messages for an Amazon Chime Enterprise account.
 */

#ifndef OAIRoomRetentionSettings_H
#define OAIRoomRetentionSettings_H
...
class OAIRoomRetentionSettings : public OAIObject {
public:
    OAIRoomRetentionSettings();
    OAIRoomRetentionSettings(QString json);
    ~OAIRoomRetentionSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomRetentionSettings)

#endif // OAIRoomRetentionSettings_H
