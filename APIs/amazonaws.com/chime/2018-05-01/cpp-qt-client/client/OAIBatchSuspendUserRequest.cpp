...
#include "OAIBatchSuspendUserRequest.h"
...
OAIBatchSuspendUserRequest::OAIBatchSuspendUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchSuspendUserRequest::OAIBatchSuspendUserRequest() {
    this->initializeModel();
}

OAIBatchSuspendUserRequest::~OAIBatchSuspendUserRequest() {}

void OAIBatchSuspendUserRequest::initializeModel() {

    m_user_id_list_isSet = false;
    m_user_id_list_isValid = false;
}

void OAIBatchSuspendUserRequest::fromJson(QString jsonString) {
...
void OAIBatchSuspendUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchSuspendUserRequest::asJson() const {
...
QJsonObject OAIBatchSuspendUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchSuspendUserRequest::getUserIdList() const {
    return m_user_id_list;
}
void OAIBatchSuspendUserRequest::setUserIdList(const QList &user_id_list) {
    m_user_id_list = user_id_list;
    m_user_id_list_isSet = true;
}

bool OAIBatchSuspendUserRequest::is_user_id_list_Set() const{
    return m_user_id_list_isSet;
}

bool OAIBatchSuspendUserRequest::is_user_id_list_Valid() const{
    return m_user_id_list_isValid;
}

bool OAIBatchSuspendUserRequest::isSet() const {
...
bool OAIBatchSuspendUserRequest::isValid() const {
