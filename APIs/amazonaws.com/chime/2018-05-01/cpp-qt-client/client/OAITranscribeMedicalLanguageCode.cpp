...
OAITranscribeMedicalLanguageCode::OAITranscribeMedicalLanguageCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeMedicalLanguageCode::OAITranscribeMedicalLanguageCode() {
    this->initializeModel();
}

OAITranscribeMedicalLanguageCode::~OAITranscribeMedicalLanguageCode() {}

void OAITranscribeMedicalLanguageCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeMedicalLanguageCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeMedicalLanguageCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("en-US", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeMedicalLanguageCode::EN_US;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeMedicalLanguageCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeMedicalLanguageCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeMedicalLanguageCode::EN_US:
            val = "en-US";
            break;
        default:
            break;
...
QJsonValue OAITranscribeMedicalLanguageCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeMedicalLanguageCode::eOAITranscribeMedicalLanguageCode OAITranscribeMedicalLanguageCode::getValue() const {
    return m_value;
}

void OAITranscribeMedicalLanguageCode::setValue(const OAITranscribeMedicalLanguageCode::eOAITranscribeMedicalLanguageCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeMedicalLanguageCode::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeMedicalLanguageCode::isValid() const {
