...
/*
 * OAIPutAppInstanceStreamingConfigurationsRequest.h
 *
 * 
 */

#ifndef OAIPutAppInstanceStreamingConfigurationsRequest_H
#define OAIPutAppInstanceStreamingConfigurationsRequest_H
...
class OAIPutAppInstanceStreamingConfigurationsRequest : public OAIObject {
public:
    OAIPutAppInstanceStreamingConfigurationsRequest();
    OAIPutAppInstanceStreamingConfigurationsRequest(QString json);
    ~OAIPutAppInstanceStreamingConfigurationsRequest() override;
    ...
    QList getAppInstanceStreamingConfigurations() const;
    void setAppInstanceStreamingConfigurations(const QList &app_instance_streaming_configurations);
    bool is_app_instance_streaming_configurations_Set() const;
    bool is_app_instance_streaming_configurations_Valid() const;
...
private:
    ...
    QList m_app_instance_streaming_configurations;
    bool m_app_instance_streaming_configurations_isSet;
    bool m_app_instance_streaming_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutAppInstanceStreamingConfigurationsRequest)

#endif // OAIPutAppInstanceStreamingConfigurationsRequest_H
