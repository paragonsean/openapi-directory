...
OAIUpdateAppInstanceUser_request::OAIUpdateAppInstanceUser_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAppInstanceUser_request::OAIUpdateAppInstanceUser_request() {
    this->initializeModel();
}

OAIUpdateAppInstanceUser_request::~OAIUpdateAppInstanceUser_request() {}

void OAIUpdateAppInstanceUser_request::initializeModel() {
...
void OAIUpdateAppInstanceUser_request::fromJson(QString jsonString) {
...
void OAIUpdateAppInstanceUser_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAppInstanceUser_request::asJson() const {
...
QJsonObject OAIUpdateAppInstanceUser_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateAppInstanceUser_request::getName() const {
    return m_name;
}
void OAIUpdateAppInstanceUser_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAppInstanceUser_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAppInstanceUser_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateAppInstanceUser_request::getMetadata() const {
    return m_metadata;
}
void OAIUpdateAppInstanceUser_request::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateAppInstanceUser_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateAppInstanceUser_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

bool OAIUpdateAppInstanceUser_request::isSet() const {
...
bool OAIUpdateAppInstanceUser_request::isValid() const {
