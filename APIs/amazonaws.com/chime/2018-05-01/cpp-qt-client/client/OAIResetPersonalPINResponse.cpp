...
OAIResetPersonalPINResponse::OAIResetPersonalPINResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResetPersonalPINResponse::OAIResetPersonalPINResponse() {
    this->initializeModel();
}

OAIResetPersonalPINResponse::~OAIResetPersonalPINResponse() {}

void OAIResetPersonalPINResponse::initializeModel() {

    m_user_isSet = false;
    m_user_isValid = false;
}

void OAIResetPersonalPINResponse::fromJson(QString jsonString) {
...
void OAIResetPersonalPINResponse::fromJsonObject(QJsonObject json) {

    m_user_isValid = ::OpenAPI::fromJsonValue(m_user, json[QString("User")]);
    m_user_isSet = !json[QString("User")].isNull() && m_user_isValid;
}

QString OAIResetPersonalPINResponse::asJson() const {
...
QJsonObject OAIResetPersonalPINResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user.isSet()) {
...
OAIResetPersonalPINResponse_User OAIResetPersonalPINResponse::getUser() const {
    return m_user;
}
void OAIResetPersonalPINResponse::setUser(const OAIResetPersonalPINResponse_User &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIResetPersonalPINResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIResetPersonalPINResponse::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIResetPersonalPINResponse::isSet() const {
...
bool OAIResetPersonalPINResponse::isValid() const {
