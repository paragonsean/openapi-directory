...
/*
 * OAIRegenerateSecurityTokenResponse.h
 *
 * 
 */

#ifndef OAIRegenerateSecurityTokenResponse_H
#define OAIRegenerateSecurityTokenResponse_H
...
namespace OpenAPI {
class OAIRegenerateSecurityTokenResponse_Bot;

class OAIRegenerateSecurityTokenResponse : public OAIObject {
public:
    OAIRegenerateSecurityTokenResponse();
    OAIRegenerateSecurityTokenResponse(QString json);
    ~OAIRegenerateSecurityTokenResponse() override;
    ...
    OAIRegenerateSecurityTokenResponse_Bot getBot() const;
    void setBot(const OAIRegenerateSecurityTokenResponse_Bot &bot);
...
private:
    ...
    OAIRegenerateSecurityTokenResponse_Bot m_bot;
    bool m_bot_isSet;
    bool m_bot_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegenerateSecurityTokenResponse)

#endif // OAIRegenerateSecurityTokenResponse_H
