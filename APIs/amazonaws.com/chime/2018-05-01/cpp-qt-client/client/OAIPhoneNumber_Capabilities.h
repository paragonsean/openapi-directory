...
/*
 * OAIPhoneNumber_Capabilities.h
 *
 * 
 */

#ifndef OAIPhoneNumber_Capabilities_H
#define OAIPhoneNumber_Capabilities_H
...
class OAIPhoneNumber_Capabilities : public OAIObject {
public:
    OAIPhoneNumber_Capabilities();
    OAIPhoneNumber_Capabilities(QString json);
    ~OAIPhoneNumber_Capabilities() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumber_Capabilities)

#endif // OAIPhoneNumber_Capabilities_H
