...
/*
 * OAICandidateAddress.h
 *
 * A suggested address.
 */

#ifndef OAICandidateAddress_H
#define OAICandidateAddress_H
...
class OAICandidateAddress : public OAIObject {
public:
    OAICandidateAddress();
    OAICandidateAddress(QString json);
    ~OAICandidateAddress() override;
    ...
    QString getStreetInfo() const;
    void setStreetInfo(const QString &street_info);
    bool is_street_info_Set() const;
    bool is_street_info_Valid() const;
...
private:
    ...
    QString m_street_info;
    bool m_street_info_isSet;
    bool m_street_info_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICandidateAddress)

#endif // OAICandidateAddress_H
