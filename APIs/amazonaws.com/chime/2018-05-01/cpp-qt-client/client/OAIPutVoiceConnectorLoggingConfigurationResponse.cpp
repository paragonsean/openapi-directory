...
OAIPutVoiceConnectorLoggingConfigurationResponse::OAIPutVoiceConnectorLoggingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutVoiceConnectorLoggingConfigurationResponse::OAIPutVoiceConnectorLoggingConfigurationResponse() {
    this->initializeModel();
}

OAIPutVoiceConnectorLoggingConfigurationResponse::~OAIPutVoiceConnectorLoggingConfigurationResponse() {}

void OAIPutVoiceConnectorLoggingConfigurationResponse::initializeModel() {

    m_logging_configuration_isSet = false;
    m_logging_configuration_isValid = false;
}

void OAIPutVoiceConnectorLoggingConfigurationResponse::fromJson(QString jsonString) {
...
void OAIPutVoiceConnectorLoggingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutVoiceConnectorLoggingConfigurationResponse::asJson() const {
...
QJsonObject OAIPutVoiceConnectorLoggingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration OAIPutVoiceConnectorLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIPutVoiceConnectorLoggingConfigurationResponse::setLoggingConfiguration(const OAIPutVoiceConnectorLoggingConfigurationResponse_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIPutVoiceConnectorLoggingConfigurationResponse::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIPutVoiceConnectorLoggingConfigurationResponse::is_logging_configuration_Valid() const{
    return m_logging_configuration_isValid;
}

bool OAIPutVoiceConnectorLoggingConfigurationResponse::isSet() const {
...
bool OAIPutVoiceConnectorLoggingConfigurationResponse::isValid() const {
