...
namespace OpenAPI {
class OAIUpdateUser_request_AlexaForBusinessMetadata;
...
public:
    ...
    OAIUpdateUser_request_AlexaForBusinessMetadata getAlexaForBusinessMetadata() const;
    void setAlexaForBusinessMetadata(const OAIUpdateUser_request_AlexaForBusinessMetadata &alexa_for_business_metadata);
...
private:
    ...
    OAIUpdateUser_request_AlexaForBusinessMetadata m_alexa_for_business_metadata;
