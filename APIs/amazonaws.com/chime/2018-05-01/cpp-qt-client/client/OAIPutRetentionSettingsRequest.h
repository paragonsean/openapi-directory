...
/*
 * OAIPutRetentionSettingsRequest.h
 *
 * 
 */

#ifndef OAIPutRetentionSettingsRequest_H
#define OAIPutRetentionSettingsRequest_H
...
class OAIPutRetentionSettingsRequest : public OAIObject {
public:
    OAIPutRetentionSettingsRequest();
    OAIPutRetentionSettingsRequest(QString json);
    ~OAIPutRetentionSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRetentionSettingsRequest)

#endif // OAIPutRetentionSettingsRequest_H
