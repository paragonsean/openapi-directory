...
/*
 * OAICreateSipRuleRequest.h
 *
 * 
 */

#ifndef OAICreateSipRuleRequest_H
#define OAICreateSipRuleRequest_H
...
class OAICreateSipRuleRequest : public OAIObject {
public:
    OAICreateSipRuleRequest();
    OAICreateSipRuleRequest(QString json);
    ~OAICreateSipRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipRuleRequest)

#endif // OAICreateSipRuleRequest_H
