...
OAICreateProxySessionResponse::OAICreateProxySessionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProxySessionResponse::OAICreateProxySessionResponse() {
    this->initializeModel();
}

OAICreateProxySessionResponse::~OAICreateProxySessionResponse() {}

void OAICreateProxySessionResponse::initializeModel() {

    m_proxy_session_isSet = false;
    m_proxy_session_isValid = false;
}

void OAICreateProxySessionResponse::fromJson(QString jsonString) {
...
void OAICreateProxySessionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateProxySessionResponse::asJson() const {
...
QJsonObject OAICreateProxySessionResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateProxySessionResponse_ProxySession OAICreateProxySessionResponse::getProxySession() const {
    return m_proxy_session;
}
void OAICreateProxySessionResponse::setProxySession(const OAICreateProxySessionResponse_ProxySession &proxy_session) {
    m_proxy_session = proxy_session;
    m_proxy_session_isSet = true;
}

bool OAICreateProxySessionResponse::is_proxy_session_Set() const{
    return m_proxy_session_isSet;
}

bool OAICreateProxySessionResponse::is_proxy_session_Valid() const{
    return m_proxy_session_isValid;
}

bool OAICreateProxySessionResponse::isSet() const {
...
bool OAICreateProxySessionResponse::isValid() const {
