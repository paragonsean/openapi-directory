...
OAIGetVoiceConnectorTerminationResponse::OAIGetVoiceConnectorTerminationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVoiceConnectorTerminationResponse::OAIGetVoiceConnectorTerminationResponse() {
    this->initializeModel();
}

OAIGetVoiceConnectorTerminationResponse::~OAIGetVoiceConnectorTerminationResponse() {}

void OAIGetVoiceConnectorTerminationResponse::initializeModel() {

    m_termination_isSet = false;
    m_termination_isValid = false;
}

void OAIGetVoiceConnectorTerminationResponse::fromJson(QString jsonString) {
...
void OAIGetVoiceConnectorTerminationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetVoiceConnectorTerminationResponse::asJson() const {
...
QJsonObject OAIGetVoiceConnectorTerminationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetVoiceConnectorTerminationResponse_Termination OAIGetVoiceConnectorTerminationResponse::getTermination() const {
    return m_termination;
}
void OAIGetVoiceConnectorTerminationResponse::setTermination(const OAIGetVoiceConnectorTerminationResponse_Termination &termination) {
    m_termination = termination;
    m_termination_isSet = true;
}

bool OAIGetVoiceConnectorTerminationResponse::is_termination_Set() const{
    return m_termination_isSet;
}

bool OAIGetVoiceConnectorTerminationResponse::is_termination_Valid() const{
    return m_termination_isValid;
}

bool OAIGetVoiceConnectorTerminationResponse::isSet() const {
...
bool OAIGetVoiceConnectorTerminationResponse::isValid() const {
