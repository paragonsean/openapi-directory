...
/*
 * OAIRoomMembershipRole.h
 *
 * 
 */

#ifndef OAIRoomMembershipRole_H
#define OAIRoomMembershipRole_H
...
class OAIRoomMembershipRole : public OAIEnum {
public:
    OAIRoomMembershipRole();
    OAIRoomMembershipRole(QString json);
    ~OAIRoomMembershipRole() override;
    ...
    enum class eOAIRoomMembershipRole {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ADMINISTRATOR, 
        MEMBER
    };
    OAIRoomMembershipRole::eOAIRoomMembershipRole getValue() const;
    void setValue(const OAIRoomMembershipRole::eOAIRoomMembershipRole& value);
...
private:
    ...
    eOAIRoomMembershipRole m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomMembershipRole)

#endif // OAIRoomMembershipRole_H
