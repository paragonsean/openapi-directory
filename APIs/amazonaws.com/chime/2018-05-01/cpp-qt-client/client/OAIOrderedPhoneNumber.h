...
/*
 * OAIOrderedPhoneNumber.h
 *
 * A phone number for which an order has been placed.
 */

#ifndef OAIOrderedPhoneNumber_H
#define OAIOrderedPhoneNumber_H

#include <QJsonObject>

#include "OAIOrderedPhoneNumberStatus.h"
#include <QString>
...
class OAIOrderedPhoneNumber : public OAIObject {
public:
    OAIOrderedPhoneNumber();
    OAIOrderedPhoneNumber(QString json);
    ~OAIOrderedPhoneNumber() override;
    ...
    OAIOrderedPhoneNumberStatus getStatus() const;
    void setStatus(const OAIOrderedPhoneNumberStatus &status);
...
private:
    ...
    OAIOrderedPhoneNumberStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderedPhoneNumber)

#endif // OAIOrderedPhoneNumber_H
