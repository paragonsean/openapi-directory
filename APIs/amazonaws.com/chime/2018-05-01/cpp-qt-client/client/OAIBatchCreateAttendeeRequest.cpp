...
#include "OAIBatchCreateAttendeeRequest.h"
...
OAIBatchCreateAttendeeRequest::OAIBatchCreateAttendeeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchCreateAttendeeRequest::OAIBatchCreateAttendeeRequest() {
    this->initializeModel();
}

OAIBatchCreateAttendeeRequest::~OAIBatchCreateAttendeeRequest() {}

void OAIBatchCreateAttendeeRequest::initializeModel() {

    m_attendees_isSet = false;
    m_attendees_isValid = false;
}

void OAIBatchCreateAttendeeRequest::fromJson(QString jsonString) {
...
void OAIBatchCreateAttendeeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchCreateAttendeeRequest::asJson() const {
...
QJsonObject OAIBatchCreateAttendeeRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIBatchCreateAttendeeRequest::getAttendees() const {
    return m_attendees;
}
void OAIBatchCreateAttendeeRequest::setAttendees(const QList &attendees) {
    m_attendees = attendees;
    m_attendees_isSet = true;
}

bool OAIBatchCreateAttendeeRequest::is_attendees_Set() const{
    return m_attendees_isSet;
}

bool OAIBatchCreateAttendeeRequest::is_attendees_Valid() const{
    return m_attendees_isValid;
}

bool OAIBatchCreateAttendeeRequest::isSet() const {
...
bool OAIBatchCreateAttendeeRequest::isValid() const {
