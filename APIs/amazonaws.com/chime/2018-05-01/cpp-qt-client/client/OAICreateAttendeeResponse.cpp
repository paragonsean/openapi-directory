...
OAICreateAttendeeResponse::OAICreateAttendeeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAttendeeResponse::OAICreateAttendeeResponse() {
    this->initializeModel();
}

OAICreateAttendeeResponse::~OAICreateAttendeeResponse() {}

void OAICreateAttendeeResponse::initializeModel() {

    m_attendee_isSet = false;
    m_attendee_isValid = false;
}

void OAICreateAttendeeResponse::fromJson(QString jsonString) {
...
void OAICreateAttendeeResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateAttendeeResponse::asJson() const {
...
QJsonObject OAICreateAttendeeResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_attendee.isSet()) {
...
OAICreateAttendeeResponse_Attendee OAICreateAttendeeResponse::getAttendee() const {
    return m_attendee;
}
void OAICreateAttendeeResponse::setAttendee(const OAICreateAttendeeResponse_Attendee &attendee) {
    m_attendee = attendee;
    m_attendee_isSet = true;
}

bool OAICreateAttendeeResponse::is_attendee_Set() const{
    return m_attendee_isSet;
}

bool OAICreateAttendeeResponse::is_attendee_Valid() const{
    return m_attendee_isValid;
}

bool OAICreateAttendeeResponse::isSet() const {
...
bool OAICreateAttendeeResponse::isValid() const {
