...
/*
 * OAIPutVoiceConnectorEmergencyCallingConfigurationResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorEmergencyCallingConfigurationResponse_H
#define OAIPutVoiceConnectorEmergencyCallingConfigurationResponse_H

#include <QJsonObject>

#include "OAIGetVoiceConnectorEmergencyCallingConfigurationResponse_EmergencyCallingConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetVoiceConnectorEmergencyCallingConfigurationResponse_EmergencyCallingConfiguration;

class OAIPutVoiceConnectorEmergencyCallingConfigurationResponse : public OAIObject {
public:
    OAIPutVoiceConnectorEmergencyCallingConfigurationResponse();
    OAIPutVoiceConnectorEmergencyCallingConfigurationResponse(QString json);
    ~OAIPutVoiceConnectorEmergencyCallingConfigurationResponse() override;
    ...
    OAIGetVoiceConnectorEmergencyCallingConfigurationResponse_EmergencyCallingConfiguration getEmergencyCallingConfiguration() const;
    void setEmergencyCallingConfiguration(const OAIGetVoiceConnectorEmergencyCallingConfigurationResponse_EmergencyCallingConfiguration &emergency_calling_configuration);
    bool is_emergency_calling_configuration_Set() const;
    bool is_emergency_calling_configuration_Valid() const;
...
private:
    ...
    OAIGetVoiceConnectorEmergencyCallingConfigurationResponse_EmergencyCallingConfiguration m_emergency_calling_configuration;
    bool m_emergency_calling_configuration_isSet;
    bool m_emergency_calling_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorEmergencyCallingConfigurationResponse)

#endif // OAIPutVoiceConnectorEmergencyCallingConfigurationResponse_H
