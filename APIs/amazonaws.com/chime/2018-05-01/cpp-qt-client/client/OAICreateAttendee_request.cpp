...
OAICreateAttendee_request::OAICreateAttendee_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAttendee_request::OAICreateAttendee_request() {
    this->initializeModel();
}

OAICreateAttendee_request::~OAICreateAttendee_request() {}

void OAICreateAttendee_request::initializeModel() {
...
void OAICreateAttendee_request::fromJson(QString jsonString) {
...
void OAICreateAttendee_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateAttendee_request::asJson() const {
...
QJsonObject OAICreateAttendee_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAttendee_request::getExternalUserId() const {
    return m_external_user_id;
}
void OAICreateAttendee_request::setExternalUserId(const QString &external_user_id) {
    m_external_user_id = external_user_id;
    m_external_user_id_isSet = true;
}

bool OAICreateAttendee_request::is_external_user_id_Set() const{
    return m_external_user_id_isSet;
}

bool OAICreateAttendee_request::is_external_user_id_Valid() const{
    return m_external_user_id_isValid;
}

QList<OAITag> OAICreateAttendee_request::getTags() const {
    return m_tags;
}
void OAICreateAttendee_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAttendee_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAttendee_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateAttendee_request::isSet() const {
...
bool OAICreateAttendee_request::isValid() const {
