...
/*
 * OAICreateAppInstanceAdminResponse.h
 *
 * 
 */

#ifndef OAICreateAppInstanceAdminResponse_H
#define OAICreateAppInstanceAdminResponse_H

#include <QJsonObject>

#include "OAICreateAppInstanceAdminResponse_AppInstanceAdmin.h"
#include <QString>
...
namespace OpenAPI {
class OAICreateAppInstanceAdminResponse_AppInstanceAdmin;

class OAICreateAppInstanceAdminResponse : public OAIObject {
public:
    OAICreateAppInstanceAdminResponse();
    OAICreateAppInstanceAdminResponse(QString json);
    ~OAICreateAppInstanceAdminResponse() override;
    ...
    OAICreateAppInstanceAdminResponse_AppInstanceAdmin getAppInstanceAdmin() const;
    void setAppInstanceAdmin(const OAICreateAppInstanceAdminResponse_AppInstanceAdmin &app_instance_admin);
...
private:
    ...
    OAICreateAppInstanceAdminResponse_AppInstanceAdmin m_app_instance_admin;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppInstanceAdminResponse)

#endif // OAICreateAppInstanceAdminResponse_H
