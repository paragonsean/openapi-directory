...
/*
 * OAIPutVoiceConnectorProxyRequest.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorProxyRequest_H
#define OAIPutVoiceConnectorProxyRequest_H
...
class OAIPutVoiceConnectorProxyRequest : public OAIObject {
public:
    OAIPutVoiceConnectorProxyRequest();
    OAIPutVoiceConnectorProxyRequest(QString json);
    ~OAIPutVoiceConnectorProxyRequest() override;
    ...
    QList getPhoneNumberPoolCountries() const;
    void setPhoneNumberPoolCountries(const QList &phone_number_pool_countries);
...
private:
    ...
    QList m_phone_number_pool_countries;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorProxyRequest)

#endif // OAIPutVoiceConnectorProxyRequest_H
