...
OAIGetProxySessionResponse::OAIGetProxySessionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetProxySessionResponse::OAIGetProxySessionResponse() {
    this->initializeModel();
}

OAIGetProxySessionResponse::~OAIGetProxySessionResponse() {}

void OAIGetProxySessionResponse::initializeModel() {

    m_proxy_session_isSet = false;
    m_proxy_session_isValid = false;
}

void OAIGetProxySessionResponse::fromJson(QString jsonString) {
...
void OAIGetProxySessionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetProxySessionResponse::asJson() const {
...
QJsonObject OAIGetProxySessionResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateProxySessionResponse_ProxySession OAIGetProxySessionResponse::getProxySession() const {
    return m_proxy_session;
}
void OAIGetProxySessionResponse::setProxySession(const OAICreateProxySessionResponse_ProxySession &proxy_session) {
    m_proxy_session = proxy_session;
    m_proxy_session_isSet = true;
}

bool OAIGetProxySessionResponse::is_proxy_session_Set() const{
    return m_proxy_session_isSet;
}

bool OAIGetProxySessionResponse::is_proxy_session_Valid() const{
    return m_proxy_session_isValid;
}

bool OAIGetProxySessionResponse::isSet() const {
...
bool OAIGetProxySessionResponse::isValid() const {
