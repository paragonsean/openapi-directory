...
/*
 * OAICreateVoiceConnectorResponse_VoiceConnector.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorResponse_VoiceConnector_H
#define OAICreateVoiceConnectorResponse_VoiceConnector_H

#include <QJsonObject>

#include "OAIVoiceConnectorAwsRegion.h"
#include <QDateTime>
#include <QString>
...
class OAICreateVoiceConnectorResponse_VoiceConnector : public OAIObject {
public:
    OAICreateVoiceConnectorResponse_VoiceConnector();
    OAICreateVoiceConnectorResponse_VoiceConnector(QString json);
    ~OAICreateVoiceConnectorResponse_VoiceConnector() override;
    ...
    OAIVoiceConnectorAwsRegion getAwsRegion() const;
    void setAwsRegion(const OAIVoiceConnectorAwsRegion &aws_region);
    ...
    QString getOutboundHostName() const;
    void setOutboundHostName(const QString &outbound_host_name);
    bool is_outbound_host_name_Set() const;
    bool is_outbound_host_name_Valid() const;

    bool getRequireEncryption() const;
    void setRequireEncryption(const bool &require_encryption);
    bool is_require_encryption_Set() const;
    bool is_require_encryption_Valid() const;
    ...
    QString getVoiceConnectorArn() const;
    void setVoiceConnectorArn(const QString &voice_connector_arn);
    bool is_voice_connector_arn_Set() const;
    bool is_voice_connector_arn_Valid() const;
...
private:
    ...
    OAIVoiceConnectorAwsRegion m_aws_region;
    ...
    QString m_outbound_host_name;
    bool m_outbound_host_name_isSet;
    bool m_outbound_host_name_isValid;

    bool m_require_encryption;
    bool m_require_encryption_isSet;
    bool m_require_encryption_isValid;
    ...
    QString m_voice_connector_arn;
    bool m_voice_connector_arn_isSet;
    bool m_voice_connector_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorResponse_VoiceConnector)

#endif // OAICreateVoiceConnectorResponse_VoiceConnector_H
