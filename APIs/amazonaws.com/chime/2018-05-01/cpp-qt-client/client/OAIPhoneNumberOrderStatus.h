...
/*
 * OAIPhoneNumberOrderStatus.h
 *
 * 
 */

#ifndef OAIPhoneNumberOrderStatus_H
#define OAIPhoneNumberOrderStatus_H
...
class OAIPhoneNumberOrderStatus : public OAIEnum {
public:
    OAIPhoneNumberOrderStatus();
    OAIPhoneNumberOrderStatus(QString json);
    ~OAIPhoneNumberOrderStatus() override;
    ...
    enum class eOAIPhoneNumberOrderStatus {
    ...
    OAIPhoneNumberOrderStatus::eOAIPhoneNumberOrderStatus getValue() const;
    void setValue(const OAIPhoneNumberOrderStatus::eOAIPhoneNumberOrderStatus& value);
...
private:
    ...
    eOAIPhoneNumberOrderStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberOrderStatus)

#endif // OAIPhoneNumberOrderStatus_H
