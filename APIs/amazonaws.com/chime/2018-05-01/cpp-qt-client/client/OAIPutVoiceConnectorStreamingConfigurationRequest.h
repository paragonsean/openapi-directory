...
/*
 * OAIPutVoiceConnectorStreamingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorStreamingConfigurationRequest_H
#define OAIPutVoiceConnectorStreamingConfigurationRequest_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorStreamingConfigurationRequest_StreamingConfiguration;

class OAIPutVoiceConnectorStreamingConfigurationRequest : public OAIObject {
public:
    OAIPutVoiceConnectorStreamingConfigurationRequest();
    OAIPutVoiceConnectorStreamingConfigurationRequest(QString json);
    ~OAIPutVoiceConnectorStreamingConfigurationRequest() override;
    ...
    OAIPutVoiceConnectorStreamingConfigurationRequest_StreamingConfiguration getStreamingConfiguration() const;
    void setStreamingConfiguration(const OAIPutVoiceConnectorStreamingConfigurationRequest_StreamingConfiguration &streaming_configuration);
...
private:
    ...
    OAIPutVoiceConnectorStreamingConfigurationRequest_StreamingConfiguration m_streaming_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorStreamingConfigurationRequest)

#endif // OAIPutVoiceConnectorStreamingConfigurationRequest_H
