...
/*
 * OAIGetPhoneNumberSettingsResponse.h
 *
 * 
 */

#ifndef OAIGetPhoneNumberSettingsResponse_H
#define OAIGetPhoneNumberSettingsResponse_H
...
class OAIGetPhoneNumberSettingsResponse : public OAIObject {
public:
    OAIGetPhoneNumberSettingsResponse();
    OAIGetPhoneNumberSettingsResponse(QString json);
    ~OAIGetPhoneNumberSettingsResponse() override;
    ...
    QDateTime getCallingNameUpdatedTimestamp() const;
    void setCallingNameUpdatedTimestamp(const QDateTime &calling_name_updated_timestamp);
    bool is_calling_name_updated_timestamp_Set() const;
    bool is_calling_name_updated_timestamp_Valid() const;
...
private:
    ...
    QDateTime m_calling_name_updated_timestamp;
    bool m_calling_name_updated_timestamp_isSet;
    bool m_calling_name_updated_timestamp_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetPhoneNumberSettingsResponse)

#endif // OAIGetPhoneNumberSettingsResponse_H
