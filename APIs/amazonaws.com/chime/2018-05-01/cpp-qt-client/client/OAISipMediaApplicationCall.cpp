...
#include "OAISipMediaApplicationCall.h"
...
OAISipMediaApplicationCall::OAISipMediaApplicationCall(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISipMediaApplicationCall::OAISipMediaApplicationCall() {
    this->initializeModel();
}

OAISipMediaApplicationCall::~OAISipMediaApplicationCall() {}

void OAISipMediaApplicationCall::initializeModel() {

    m_transaction_id_isSet = false;
    m_transaction_id_isValid = false;
}

void OAISipMediaApplicationCall::fromJson(QString jsonString) {
...
void OAISipMediaApplicationCall::fromJsonObject(QJsonObject json) {
...
QString OAISipMediaApplicationCall::asJson() const {
...
QJsonObject OAISipMediaApplicationCall::asJsonObject() const {
    QJsonObject obj;
...
QString OAISipMediaApplicationCall::getTransactionId() const {
    return m_transaction_id;
}
void OAISipMediaApplicationCall::setTransactionId(const QString &transaction_id) {
    m_transaction_id = transaction_id;
    m_transaction_id_isSet = true;
}

bool OAISipMediaApplicationCall::is_transaction_id_Set() const{
    return m_transaction_id_isSet;
}

bool OAISipMediaApplicationCall::is_transaction_id_Valid() const{
    return m_transaction_id_isValid;
}

bool OAISipMediaApplicationCall::isSet() const {
...
bool OAISipMediaApplicationCall::isValid() const {
