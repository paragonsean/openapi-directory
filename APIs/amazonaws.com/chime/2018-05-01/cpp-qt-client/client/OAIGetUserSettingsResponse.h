...
/*
 * OAIGetUserSettingsResponse.h
 *
 * 
 */

#ifndef OAIGetUserSettingsResponse_H
#define OAIGetUserSettingsResponse_H

#include <QJsonObject>

#include "OAIGetUserSettingsResponse_UserSettings.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetUserSettingsResponse_UserSettings;

class OAIGetUserSettingsResponse : public OAIObject {
public:
    OAIGetUserSettingsResponse();
    OAIGetUserSettingsResponse(QString json);
    ~OAIGetUserSettingsResponse() override;
    ...
    OAIGetUserSettingsResponse_UserSettings getUserSettings() const;
    void setUserSettings(const OAIGetUserSettingsResponse_UserSettings &user_settings);
...
private:
    ...
    OAIGetUserSettingsResponse_UserSettings m_user_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserSettingsResponse)

#endif // OAIGetUserSettingsResponse_H
