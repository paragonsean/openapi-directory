...
public:
    ...
    QString getProxyPhoneNumber() const;
    void setProxyPhoneNumber(const QString &proxy_phone_number);
    bool is_proxy_phone_number_Set() const;
    bool is_proxy_phone_number_Valid() const;
...
private:
    ...
    QString m_proxy_phone_number;
    bool m_proxy_phone_number_isSet;
    bool m_proxy_phone_number_isValid;
};
