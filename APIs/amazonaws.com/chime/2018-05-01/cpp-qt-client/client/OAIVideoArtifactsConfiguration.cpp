...
#include "OAIVideoArtifactsConfiguration.h"
...
OAIVideoArtifactsConfiguration::OAIVideoArtifactsConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoArtifactsConfiguration::OAIVideoArtifactsConfiguration() {
    this->initializeModel();
}

OAIVideoArtifactsConfiguration::~OAIVideoArtifactsConfiguration() {}

void OAIVideoArtifactsConfiguration::initializeModel() {
...
void OAIVideoArtifactsConfiguration::fromJson(QString jsonString) {
...
void OAIVideoArtifactsConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIVideoArtifactsConfiguration::asJson() const {
...
QJsonObject OAIVideoArtifactsConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_state.isSet()) {
...
OAIArtifactsState OAIVideoArtifactsConfiguration::getState() const {
    return m_state;
}
void OAIVideoArtifactsConfiguration::setState(const OAIArtifactsState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIVideoArtifactsConfiguration::is_state_Set() const{
    return m_state_isSet;
}

bool OAIVideoArtifactsConfiguration::is_state_Valid() const{
    return m_state_isValid;
}

OAIVideoMuxType OAIVideoArtifactsConfiguration::getMuxType() const {
    return m_mux_type;
}
void OAIVideoArtifactsConfiguration::setMuxType(const OAIVideoMuxType &mux_type) {
    m_mux_type = mux_type;
    m_mux_type_isSet = true;
}

bool OAIVideoArtifactsConfiguration::is_mux_type_Set() const{
    return m_mux_type_isSet;
}

bool OAIVideoArtifactsConfiguration::is_mux_type_Valid() const{
    return m_mux_type_isValid;
}

bool OAIVideoArtifactsConfiguration::isSet() const {
...
bool OAIVideoArtifactsConfiguration::isValid() const {
