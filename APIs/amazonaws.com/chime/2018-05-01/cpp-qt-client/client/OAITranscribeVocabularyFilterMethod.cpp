...
OAITranscribeVocabularyFilterMethod::OAITranscribeVocabularyFilterMethod(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeVocabularyFilterMethod::OAITranscribeVocabularyFilterMethod() {
    this->initializeModel();
}

OAITranscribeVocabularyFilterMethod::~OAITranscribeVocabularyFilterMethod() {}

void OAITranscribeVocabularyFilterMethod::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeVocabularyFilterMethod::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeVocabularyFilterMethod::fromJson(QString jsonString) {
    
    if ( jsonString.compare("remove", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeVocabularyFilterMethod::REMOVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("mask", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeVocabularyFilterMethod::MASK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("tag", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeVocabularyFilterMethod::TAG;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeVocabularyFilterMethod::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeVocabularyFilterMethod::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeVocabularyFilterMethod::REMOVE:
            val = "remove";
            break;
        case eOAITranscribeVocabularyFilterMethod::MASK:
            val = "mask";
            break;
        case eOAITranscribeVocabularyFilterMethod::TAG:
            val = "tag";
            break;
        default:
            break;
...
QJsonValue OAITranscribeVocabularyFilterMethod::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeVocabularyFilterMethod::eOAITranscribeVocabularyFilterMethod OAITranscribeVocabularyFilterMethod::getValue() const {
    return m_value;
}

void OAITranscribeVocabularyFilterMethod::setValue(const OAITranscribeVocabularyFilterMethod::eOAITranscribeVocabularyFilterMethod& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeVocabularyFilterMethod::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeVocabularyFilterMethod::isValid() const {
