...
/*
 * OAIUpdateUserSettingsRequest_UserSettings.h
 *
 * 
 */

#ifndef OAIUpdateUserSettingsRequest_UserSettings_H
#define OAIUpdateUserSettingsRequest_UserSettings_H
...
class OAIUpdateUserSettingsRequest_UserSettings : public OAIObject {
public:
    OAIUpdateUserSettingsRequest_UserSettings();
    OAIUpdateUserSettingsRequest_UserSettings(QString json);
    ~OAIUpdateUserSettingsRequest_UserSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserSettingsRequest_UserSettings)

#endif // OAIUpdateUserSettingsRequest_UserSettings_H
