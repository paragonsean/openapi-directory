...
QString OAIRoom::getRoomId() const {
    return m_room_id;
}
void OAIRoom::setRoomId(const QString &room_id) {
    m_room_id = room_id;
    m_room_id_isSet = true;
}

bool OAIRoom::is_room_id_Set() const{
    return m_room_id_isSet;
}

bool OAIRoom::is_room_id_Valid() const{
...
QString OAIRoom::getAccountId() const {
    return m_account_id;
}
void OAIRoom::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIRoom::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIRoom::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIRoom::getCreatedBy() const {
    return m_created_by;
}
void OAIRoom::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIRoom::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIRoom::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QDateTime OAIRoom::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIRoom::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIRoom::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIRoom::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIRoom::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIRoom::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIRoom::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIRoom::is_updated_timestamp_Valid() const{
