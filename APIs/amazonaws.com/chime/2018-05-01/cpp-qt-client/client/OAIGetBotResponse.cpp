...
OAIGetBotResponse_Bot OAIGetBotResponse::getBot() const {
    return m_bot;
}
void OAIGetBotResponse::setBot(const OAIGetBotResponse_Bot &bot) {
    m_bot = bot;
    m_bot_isSet = true;
}

bool OAIGetBotResponse::is_bot_Set() const{
    return m_bot_isSet;
}

bool OAIGetBotResponse::is_bot_Valid() const{
