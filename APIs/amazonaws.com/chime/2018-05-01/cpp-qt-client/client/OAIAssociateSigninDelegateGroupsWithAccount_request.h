...
/*
 * OAIAssociateSigninDelegateGroupsWithAccount_request.h
 *
 * 
 */

#ifndef OAIAssociateSigninDelegateGroupsWithAccount_request_H
#define OAIAssociateSigninDelegateGroupsWithAccount_request_H
...
namespace OpenAPI {
class OAISigninDelegateGroup;

class OAIAssociateSigninDelegateGroupsWithAccount_request : public OAIObject {
public:
    OAIAssociateSigninDelegateGroupsWithAccount_request();
    OAIAssociateSigninDelegateGroupsWithAccount_request(QString json);
    ~OAIAssociateSigninDelegateGroupsWithAccount_request() override;
    ...
    QList<OAISigninDelegateGroup> getSigninDelegateGroups() const;
    void setSigninDelegateGroups(const QList<OAISigninDelegateGroup> &signin_delegate_groups);
...
private:
    ...
    QList<OAISigninDelegateGroup> m_signin_delegate_groups;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateSigninDelegateGroupsWithAccount_request)

#endif // OAIAssociateSigninDelegateGroupsWithAccount_request_H
