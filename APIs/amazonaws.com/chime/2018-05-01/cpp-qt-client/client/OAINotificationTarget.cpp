...
#include "OAINotificationTarget.h"
...
OAINotificationTarget::OAINotificationTarget(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotificationTarget::OAINotificationTarget() {
    this->initializeModel();
}

OAINotificationTarget::~OAINotificationTarget() {}

void OAINotificationTarget::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAINotificationTarget::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAINotificationTarget::fromJson(QString jsonString) {
    
    if ( jsonString.compare("EventBridge", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationTarget::EVENTBRIDGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SNS", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationTarget::SNS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SQS", Qt::CaseInsensitive) == 0) {
        m_value = eOAINotificationTarget::SQS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAINotificationTarget::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAINotificationTarget::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAINotificationTarget::EVENTBRIDGE:
            val = "EventBridge";
            break;
        case eOAINotificationTarget::SNS:
            val = "SNS";
            break;
        case eOAINotificationTarget::SQS:
            val = "SQS";
            break;
        default:
            break;
...
QJsonValue OAINotificationTarget::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAINotificationTarget::eOAINotificationTarget OAINotificationTarget::getValue() const {
    return m_value;
}

void OAINotificationTarget::setValue(const OAINotificationTarget::eOAINotificationTarget& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAINotificationTarget::isSet() const {
    
    return m_value_isSet;
}

bool OAINotificationTarget::isValid() const {
