...
#include "OAIInviteUsersRequest.h"
...
OAIInviteUsersRequest::OAIInviteUsersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInviteUsersRequest::OAIInviteUsersRequest() {
    this->initializeModel();
}

OAIInviteUsersRequest::~OAIInviteUsersRequest() {}

void OAIInviteUsersRequest::initializeModel() {

    m_user_email_list_isSet = false;
    m_user_email_list_isValid = false;

    m_user_type_isSet = false;
    m_user_type_isValid = false;
}

void OAIInviteUsersRequest::fromJson(QString jsonString) {
...
void OAIInviteUsersRequest::fromJsonObject(QJsonObject json) {

    m_user_email_list_isValid = ::OpenAPI::fromJsonValue(m_user_email_list, json[QString("UserEmailList")]);
    m_user_email_list_isSet = !json[QString("UserEmailList")].isNull() && m_user_email_list_isValid;
...
QString OAIInviteUsersRequest::asJson() const {
...
QJsonObject OAIInviteUsersRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_user_email_list.isSet()) {
        obj.insert(QString("UserEmailList"), ::OpenAPI::toJsonValue(m_user_email_list));
    }
...
QList OAIInviteUsersRequest::getUserEmailList() const {
    return m_user_email_list;
}
void OAIInviteUsersRequest::setUserEmailList(const QList &user_email_list) {
    m_user_email_list = user_email_list;
    m_user_email_list_isSet = true;
}

bool OAIInviteUsersRequest::is_user_email_list_Set() const{
    return m_user_email_list_isSet;
}

bool OAIInviteUsersRequest::is_user_email_list_Valid() const{
    return m_user_email_list_isValid;
}

OAIUserType OAIInviteUsersRequest::getUserType() const {
    return m_user_type;
}
void OAIInviteUsersRequest::setUserType(const OAIUserType &user_type) {
    m_user_type = user_type;
    m_user_type_isSet = true;
}

bool OAIInviteUsersRequest::is_user_type_Set() const{
    return m_user_type_isSet;
}

bool OAIInviteUsersRequest::is_user_type_Valid() const{
    return m_user_type_isValid;
}

bool OAIInviteUsersRequest::isSet() const {
...
bool OAIInviteUsersRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_email_list_isValid && true;
}
