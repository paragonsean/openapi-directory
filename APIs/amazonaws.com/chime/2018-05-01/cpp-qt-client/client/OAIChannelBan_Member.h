...
/*
 * OAIChannelBan_Member.h
 *
 * 
 */

#ifndef OAIChannelBan_Member_H
#define OAIChannelBan_Member_H
...
class OAIChannelBan_Member : public OAIObject {
public:
    OAIChannelBan_Member();
    OAIChannelBan_Member(QString json);
    ~OAIChannelBan_Member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelBan_Member)

#endif // OAIChannelBan_Member_H
