...
/*
 * OAISearchAvailablePhoneNumbersResponse.h
 *
 * 
 */

#ifndef OAISearchAvailablePhoneNumbersResponse_H
#define OAISearchAvailablePhoneNumbersResponse_H
...
class OAISearchAvailablePhoneNumbersResponse : public OAIObject {
public:
    OAISearchAvailablePhoneNumbersResponse();
    OAISearchAvailablePhoneNumbersResponse(QString json);
    ~OAISearchAvailablePhoneNumbersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchAvailablePhoneNumbersResponse)

#endif // OAISearchAvailablePhoneNumbersResponse_H
