...
OAICreateAttendeeRequestItem::OAICreateAttendeeRequestItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAttendeeRequestItem::OAICreateAttendeeRequestItem() {
    this->initializeModel();
}

OAICreateAttendeeRequestItem::~OAICreateAttendeeRequestItem() {}

void OAICreateAttendeeRequestItem::initializeModel() {
...
void OAICreateAttendeeRequestItem::fromJson(QString jsonString) {
...
void OAICreateAttendeeRequestItem::fromJsonObject(QJsonObject json) {
...
QString OAICreateAttendeeRequestItem::asJson() const {
...
QJsonObject OAICreateAttendeeRequestItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAttendeeRequestItem::getExternalUserId() const {
    return m_external_user_id;
}
void OAICreateAttendeeRequestItem::setExternalUserId(const QString &external_user_id) {
    m_external_user_id = external_user_id;
    m_external_user_id_isSet = true;
}

bool OAICreateAttendeeRequestItem::is_external_user_id_Set() const{
    return m_external_user_id_isSet;
}

bool OAICreateAttendeeRequestItem::is_external_user_id_Valid() const{
    return m_external_user_id_isValid;
}

QList OAICreateAttendeeRequestItem::getTags() const {
    return m_tags;
}
void OAICreateAttendeeRequestItem::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateAttendeeRequestItem::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateAttendeeRequestItem::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateAttendeeRequestItem::isSet() const {
...
bool OAICreateAttendeeRequestItem::isValid() const {
