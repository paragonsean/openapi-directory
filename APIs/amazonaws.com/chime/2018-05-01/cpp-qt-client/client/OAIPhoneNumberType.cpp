...
void OAIPhoneNumberType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Local", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberType::LOCAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TollFree", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPhoneNumberType::TOLLFREE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPhoneNumberType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPhoneNumberType::LOCAL:
            val = "Local";
            break;
        case eOAIPhoneNumberType::TOLLFREE:
            val = "TollFree";
            break;
        default:
            break;
