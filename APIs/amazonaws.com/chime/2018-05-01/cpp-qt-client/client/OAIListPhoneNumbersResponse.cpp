...
QList OAIListPhoneNumbersResponse::getPhoneNumbers() const {
    return m_phone_numbers;
}
void OAIListPhoneNumbersResponse::setPhoneNumbers(const QList &phone_numbers) {
    m_phone_numbers = phone_numbers;
    m_phone_numbers_isSet = true;
}

bool OAIListPhoneNumbersResponse::is_phone_numbers_Set() const{
    return m_phone_numbers_isSet;
}

bool OAIListPhoneNumbersResponse::is_phone_numbers_Valid() const{
