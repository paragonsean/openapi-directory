...
/*
 * OAIAlexaForBusinessMetadata.h
 *
 * The Alexa for Business metadata associated with an Amazon Chime user, used to integrate Alexa for Business with a device.
 */

#ifndef OAIAlexaForBusinessMetadata_H
#define OAIAlexaForBusinessMetadata_H
...
class OAIAlexaForBusinessMetadata : public OAIObject {
public:
    OAIAlexaForBusinessMetadata();
    OAIAlexaForBusinessMetadata(QString json);
    ~OAIAlexaForBusinessMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlexaForBusinessMetadata)

#endif // OAIAlexaForBusinessMetadata_H
