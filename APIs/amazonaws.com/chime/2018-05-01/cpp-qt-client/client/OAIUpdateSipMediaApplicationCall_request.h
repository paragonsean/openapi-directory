...
/*
 * OAIUpdateSipMediaApplicationCall_request.h
 *
 * 
 */

#ifndef OAIUpdateSipMediaApplicationCall_request_H
#define OAIUpdateSipMediaApplicationCall_request_H
...
class OAIUpdateSipMediaApplicationCall_request : public OAIObject {
public:
    OAIUpdateSipMediaApplicationCall_request();
    OAIUpdateSipMediaApplicationCall_request(QString json);
    ~OAIUpdateSipMediaApplicationCall_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSipMediaApplicationCall_request)

#endif // OAIUpdateSipMediaApplicationCall_request_H
