...
namespace OpenAPI {
class OAICreateRoomResponse_Room;
...
public:
    ...
    OAICreateRoomResponse_Room getRoom() const;
    void setRoom(const OAICreateRoomResponse_Room &room);
...
private:
    ...
    OAICreateRoomResponse_Room m_room;
    bool m_room_isSet;
    bool m_room_isValid;
};
