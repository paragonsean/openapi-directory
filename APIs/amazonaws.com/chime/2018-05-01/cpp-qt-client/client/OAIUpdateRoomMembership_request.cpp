...
OAIUpdateRoomMembership_request::OAIUpdateRoomMembership_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRoomMembership_request::OAIUpdateRoomMembership_request() {
    this->initializeModel();
}

OAIUpdateRoomMembership_request::~OAIUpdateRoomMembership_request() {}

void OAIUpdateRoomMembership_request::initializeModel() {

    m_role_isSet = false;
    m_role_isValid = false;
}

void OAIUpdateRoomMembership_request::fromJson(QString jsonString) {
...
void OAIUpdateRoomMembership_request::fromJsonObject(QJsonObject json) {

    m_role_isValid = ::OpenAPI::fromJsonValue(m_role, json[QString("Role")]);
    m_role_isSet = !json[QString("Role")].isNull() && m_role_isValid;
}

QString OAIUpdateRoomMembership_request::asJson() const {
...
QJsonObject OAIUpdateRoomMembership_request::asJsonObject() const {
    QJsonObject obj;
    if (m_role_isSet) {
...
QString OAIUpdateRoomMembership_request::getRole() const {
    return m_role;
}
void OAIUpdateRoomMembership_request::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIUpdateRoomMembership_request::is_role_Set() const{
    return m_role_isSet;
}

bool OAIUpdateRoomMembership_request::is_role_Valid() const{
    return m_role_isValid;
}

bool OAIUpdateRoomMembership_request::isSet() const {
...
bool OAIUpdateRoomMembership_request::isValid() const {
