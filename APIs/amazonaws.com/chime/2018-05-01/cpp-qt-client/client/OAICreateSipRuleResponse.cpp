...
OAICreateSipRuleResponse::OAICreateSipRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSipRuleResponse::OAICreateSipRuleResponse() {
    this->initializeModel();
}

OAICreateSipRuleResponse::~OAICreateSipRuleResponse() {}

void OAICreateSipRuleResponse::initializeModel() {

    m_sip_rule_isSet = false;
    m_sip_rule_isValid = false;
}

void OAICreateSipRuleResponse::fromJson(QString jsonString) {
...
void OAICreateSipRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateSipRuleResponse::asJson() const {
...
QJsonObject OAICreateSipRuleResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_sip_rule.isSet()) {
...
OAICreateSipRuleResponse_SipRule OAICreateSipRuleResponse::getSipRule() const {
    return m_sip_rule;
}
void OAICreateSipRuleResponse::setSipRule(const OAICreateSipRuleResponse_SipRule &sip_rule) {
    m_sip_rule = sip_rule;
    m_sip_rule_isSet = true;
}

bool OAICreateSipRuleResponse::is_sip_rule_Set() const{
    return m_sip_rule_isSet;
}

bool OAICreateSipRuleResponse::is_sip_rule_Valid() const{
    return m_sip_rule_isValid;
}

bool OAICreateSipRuleResponse::isSet() const {
...
bool OAICreateSipRuleResponse::isValid() const {
