...
OAIGetUserResponse_User OAIGetUserResponse::getUser() const {
    return m_user;
}
void OAIGetUserResponse::setUser(const OAIGetUserResponse_User &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIGetUserResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIGetUserResponse::is_user_Valid() const{
