...
/*
 * OAICreatePhoneNumberOrder_request.h
 *
 * 
 */

#ifndef OAICreatePhoneNumberOrder_request_H
#define OAICreatePhoneNumberOrder_request_H
...
class OAICreatePhoneNumberOrder_request : public OAIObject {
public:
    OAICreatePhoneNumberOrder_request();
    OAICreatePhoneNumberOrder_request(QString json);
    ~OAICreatePhoneNumberOrder_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePhoneNumberOrder_request)

#endif // OAICreatePhoneNumberOrder_request_H
