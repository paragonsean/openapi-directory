...
/*
 * OAICreateVoiceConnectorGroupResponse.h
 *
 * 
 */

#ifndef OAICreateVoiceConnectorGroupResponse_H
#define OAICreateVoiceConnectorGroupResponse_H
...
namespace OpenAPI {
class OAICreateVoiceConnectorGroupResponse_VoiceConnectorGroup;

class OAICreateVoiceConnectorGroupResponse : public OAIObject {
public:
    OAICreateVoiceConnectorGroupResponse();
    OAICreateVoiceConnectorGroupResponse(QString json);
    ~OAICreateVoiceConnectorGroupResponse() override;
    ...
    OAICreateVoiceConnectorGroupResponse_VoiceConnectorGroup getVoiceConnectorGroup() const;
    void setVoiceConnectorGroup(const OAICreateVoiceConnectorGroupResponse_VoiceConnectorGroup &voice_connector_group);
...
private:
    ...
    OAICreateVoiceConnectorGroupResponse_VoiceConnectorGroup m_voice_connector_group;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVoiceConnectorGroupResponse)

#endif // OAICreateVoiceConnectorGroupResponse_H
