...
/*
 * OAIPutVoiceConnectorOriginationResponse.h
 *
 * 
 */

#ifndef OAIPutVoiceConnectorOriginationResponse_H
#define OAIPutVoiceConnectorOriginationResponse_H
...
namespace OpenAPI {
class OAIPutVoiceConnectorOriginationResponse_Origination;

class OAIPutVoiceConnectorOriginationResponse : public OAIObject {
public:
    OAIPutVoiceConnectorOriginationResponse();
    OAIPutVoiceConnectorOriginationResponse(QString json);
    ~OAIPutVoiceConnectorOriginationResponse() override;
    ...
    OAIPutVoiceConnectorOriginationResponse_Origination getOrigination() const;
    void setOrigination(const OAIPutVoiceConnectorOriginationResponse_Origination &origination);
...
private:
    ...
    OAIPutVoiceConnectorOriginationResponse_Origination m_origination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutVoiceConnectorOriginationResponse)

#endif // OAIPutVoiceConnectorOriginationResponse_H
