...
OAITagMeeting_request::OAITagMeeting_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagMeeting_request::OAITagMeeting_request() {
    this->initializeModel();
}

OAITagMeeting_request::~OAITagMeeting_request() {}

void OAITagMeeting_request::initializeModel() {

    m_tags_isSet = false;
    m_tags_isValid = false;
}

void OAITagMeeting_request::fromJson(QString jsonString) {
...
void OAITagMeeting_request::fromJsonObject(QJsonObject json) {

    m_tags_isValid = ::OpenAPI::fromJsonValue(m_tags, json[QString("Tags")]);
    m_tags_isSet = !json[QString("Tags")].isNull() && m_tags_isValid;
}

QString OAITagMeeting_request::asJson() const {
...
QJsonObject OAITagMeeting_request::asJsonObject() const {
    QJsonObject obj;
    if (m_tags.size() > 0) {
...
QList<OAITag> OAITagMeeting_request::getTags() const {
    return m_tags;
}
void OAITagMeeting_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITagMeeting_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITagMeeting_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAITagMeeting_request::isSet() const {
...
bool OAITagMeeting_request::isValid() const {
