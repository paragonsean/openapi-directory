...
/*
 * OAISipMediaApplicationCall.h
 *
 * A &lt;code&gt;Call&lt;/code&gt; instance for a SIP media application.
 */

#ifndef OAISipMediaApplicationCall_H
#define OAISipMediaApplicationCall_H
...
class OAISipMediaApplicationCall : public OAIObject {
public:
    OAISipMediaApplicationCall();
    OAISipMediaApplicationCall(QString json);
    ~OAISipMediaApplicationCall() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISipMediaApplicationCall)

#endif // OAISipMediaApplicationCall_H
