...
OAIUpdateSipMediaApplicationCall_request::OAIUpdateSipMediaApplicationCall_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSipMediaApplicationCall_request::OAIUpdateSipMediaApplicationCall_request() {
    this->initializeModel();
}

OAIUpdateSipMediaApplicationCall_request::~OAIUpdateSipMediaApplicationCall_request() {}

void OAIUpdateSipMediaApplicationCall_request::initializeModel() {

    m_arguments_isSet = false;
    m_arguments_isValid = false;
}

void OAIUpdateSipMediaApplicationCall_request::fromJson(QString jsonString) {
...
void OAIUpdateSipMediaApplicationCall_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSipMediaApplicationCall_request::asJson() const {
...
QJsonObject OAIUpdateSipMediaApplicationCall_request::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAIUpdateSipMediaApplicationCall_request::getArguments() const {
    return m_arguments;
}
void OAIUpdateSipMediaApplicationCall_request::setArguments(const QMap<QString, QString> &arguments) {
    m_arguments = arguments;
    m_arguments_isSet = true;
}

bool OAIUpdateSipMediaApplicationCall_request::is_arguments_Set() const{
    return m_arguments_isSet;
}

bool OAIUpdateSipMediaApplicationCall_request::is_arguments_Valid() const{
    return m_arguments_isValid;
}

bool OAIUpdateSipMediaApplicationCall_request::isSet() const {
...
bool OAIUpdateSipMediaApplicationCall_request::isValid() const {
