...
OAIMemberError::OAIMemberError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMemberError::OAIMemberError() {
    this->initializeModel();
}

OAIMemberError::~OAIMemberError() {}

void OAIMemberError::initializeModel() {
...
void OAIMemberError::fromJson(QString jsonString) {
...
void OAIMemberError::fromJsonObject(QJsonObject json) {
...
QString OAIMemberError::asJson() const {
...
QJsonObject OAIMemberError::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMemberError::getMemberId() const {
    return m_member_id;
}
void OAIMemberError::setMemberId(const QString &member_id) {
    m_member_id = member_id;
    m_member_id_isSet = true;
}

bool OAIMemberError::is_member_id_Set() const{
    return m_member_id_isSet;
}

bool OAIMemberError::is_member_id_Valid() const{
    return m_member_id_isValid;
}

OAIErrorCode OAIMemberError::getErrorCode() const {
    return m_error_code;
}
void OAIMemberError::setErrorCode(const OAIErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIMemberError::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIMemberError::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIMemberError::getErrorMessage() const {
    return m_error_message;
}
void OAIMemberError::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIMemberError::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIMemberError::is_error_message_Valid() const{
    return m_error_message_isValid;
}

bool OAIMemberError::isSet() const {
...
bool OAIMemberError::isValid() const {
