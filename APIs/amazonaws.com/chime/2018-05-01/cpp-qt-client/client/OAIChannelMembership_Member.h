...
/*
 * OAIChannelMembership_Member.h
 *
 * 
 */

#ifndef OAIChannelMembership_Member_H
#define OAIChannelMembership_Member_H
...
class OAIChannelMembership_Member : public OAIObject {
public:
    OAIChannelMembership_Member();
    OAIChannelMembership_Member(QString json);
    ~OAIChannelMembership_Member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChannelMembership_Member)

#endif // OAIChannelMembership_Member_H
