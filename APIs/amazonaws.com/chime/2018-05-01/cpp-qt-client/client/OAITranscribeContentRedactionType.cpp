...
OAITranscribeContentRedactionType::OAITranscribeContentRedactionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscribeContentRedactionType::OAITranscribeContentRedactionType() {
    this->initializeModel();
}

OAITranscribeContentRedactionType::~OAITranscribeContentRedactionType() {}

void OAITranscribeContentRedactionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITranscribeContentRedactionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITranscribeContentRedactionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PII", Qt::CaseInsensitive) == 0) {
        m_value = eOAITranscribeContentRedactionType::PII;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITranscribeContentRedactionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITranscribeContentRedactionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITranscribeContentRedactionType::PII:
            val = "PII";
            break;
        default:
            break;
...
QJsonValue OAITranscribeContentRedactionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITranscribeContentRedactionType::eOAITranscribeContentRedactionType OAITranscribeContentRedactionType::getValue() const {
    return m_value;
}

void OAITranscribeContentRedactionType::setValue(const OAITranscribeContentRedactionType::eOAITranscribeContentRedactionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITranscribeContentRedactionType::isSet() const {
    
    return m_value_isSet;
}

bool OAITranscribeContentRedactionType::isValid() const {
