...
OAIChannelMode OAIUpdateChannelRequest::getMode() const {
    return m_mode;
}
void OAIUpdateChannelRequest::setMode(const OAIChannelMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIUpdateChannelRequest::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIUpdateChannelRequest::is_mode_Valid() const{
    return m_mode_isValid;
}

QString OAIUpdateChannelRequest::getMetadata() const {
    return m_metadata;
}
void OAIUpdateChannelRequest::setMetadata(const QString &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIUpdateChannelRequest::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIUpdateChannelRequest::is_metadata_Valid() const{
...
bool OAIUpdateChannelRequest::isValid() const {
    ...
    return m_name_isValid && m_mode_isValid && true;
}
