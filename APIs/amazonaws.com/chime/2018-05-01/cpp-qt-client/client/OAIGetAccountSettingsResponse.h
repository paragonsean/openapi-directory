...
namespace OpenAPI {
class OAIGetAccountSettingsResponse_AccountSettings;
...
public:
    ...
    OAIGetAccountSettingsResponse_AccountSettings getAccountSettings() const;
    void setAccountSettings(const OAIGetAccountSettingsResponse_AccountSettings &account_settings);
...
private:
    ...
    OAIGetAccountSettingsResponse_AccountSettings m_account_settings;
