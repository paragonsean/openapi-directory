...
/*
 * OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration.h
 *
 * Logging configuration of the SIP media application.
 */

#ifndef OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration_H
#define OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration_H
...
class OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration : public OAIObject {
public:
    OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration();
    OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration(QString json);
    ~OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration() override;
    ...
    bool getEnableSipMediaApplicationMessageLogs() const;
    void setEnableSipMediaApplicationMessageLogs(const bool &enable_sip_media_application_message_logs);
    bool is_enable_sip_media_application_message_logs_Set() const;
    bool is_enable_sip_media_application_message_logs_Valid() const;
...
private:
    ...
    bool m_enable_sip_media_application_message_logs;
    bool m_enable_sip_media_application_message_logs_isSet;
    bool m_enable_sip_media_application_message_logs_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration)

#endif // OAIPutSipMediaApplicationLoggingConfiguration_request_SipMediaApplicationLoggingConfiguration_H
