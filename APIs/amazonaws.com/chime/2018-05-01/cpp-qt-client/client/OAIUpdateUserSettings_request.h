...
/*
 * OAIUpdateUserSettings_request.h
 *
 * 
 */

#ifndef OAIUpdateUserSettings_request_H
#define OAIUpdateUserSettings_request_H
...
namespace OpenAPI {
class OAIUpdateUserSettings_request_UserSettings;

class OAIUpdateUserSettings_request : public OAIObject {
public:
    OAIUpdateUserSettings_request();
    OAIUpdateUserSettings_request(QString json);
    ~OAIUpdateUserSettings_request() override;
    ...
    OAIUpdateUserSettings_request_UserSettings getUserSettings() const;
    void setUserSettings(const OAIUpdateUserSettings_request_UserSettings &user_settings);
...
private:
    ...
    OAIUpdateUserSettings_request_UserSettings m_user_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserSettings_request)

#endif // OAIUpdateUserSettings_request_H
