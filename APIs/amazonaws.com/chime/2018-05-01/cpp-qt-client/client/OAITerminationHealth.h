...
#ifndef OAITerminationHealth_H
#define OAITerminationHealth_H
...
class OAITerminationHealth : public OAIObject {
public:
    OAITerminationHealth();
    OAITerminationHealth(QString json);
    ~OAITerminationHealth() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITerminationHealth)

#endif // OAITerminationHealth_H
