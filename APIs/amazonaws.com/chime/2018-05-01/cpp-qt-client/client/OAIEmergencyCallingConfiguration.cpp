...
#include "OAIEmergencyCallingConfiguration.h"
...
OAIEmergencyCallingConfiguration::OAIEmergencyCallingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmergencyCallingConfiguration::OAIEmergencyCallingConfiguration() {
    this->initializeModel();
}

OAIEmergencyCallingConfiguration::~OAIEmergencyCallingConfiguration() {}

void OAIEmergencyCallingConfiguration::initializeModel() {

    m_dnis_isSet = false;
    m_dnis_isValid = false;
}

void OAIEmergencyCallingConfiguration::fromJson(QString jsonString) {
...
void OAIEmergencyCallingConfiguration::fromJsonObject(QJsonObject json) {

    m_dnis_isValid = ::OpenAPI::fromJsonValue(m_dnis, json[QString("DNIS")]);
    m_dnis_isSet = !json[QString("DNIS")].isNull() && m_dnis_isValid;
}

QString OAIEmergencyCallingConfiguration::asJson() const {
...
QJsonObject OAIEmergencyCallingConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_dnis.isSet()) {
...
QList OAIEmergencyCallingConfiguration::getDnis() const {
    return m_dnis;
}
void OAIEmergencyCallingConfiguration::setDnis(const QList &dnis) {
    m_dnis = dnis;
    m_dnis_isSet = true;
}

bool OAIEmergencyCallingConfiguration::is_dnis_Set() const{
    return m_dnis_isSet;
}

bool OAIEmergencyCallingConfiguration::is_dnis_Valid() const{
    return m_dnis_isValid;
}

bool OAIEmergencyCallingConfiguration::isSet() const {
...
bool OAIEmergencyCallingConfiguration::isValid() const {
