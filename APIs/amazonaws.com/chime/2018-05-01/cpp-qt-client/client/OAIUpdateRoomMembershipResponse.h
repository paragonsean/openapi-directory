...
/*
 * OAIUpdateRoomMembershipResponse.h
 *
 * 
 */

#ifndef OAIUpdateRoomMembershipResponse_H
#define OAIUpdateRoomMembershipResponse_H

#include <QJsonObject>

#include "OAICreateRoomMembershipResponse_RoomMembership.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateRoomMembershipResponse_RoomMembership;

class OAIUpdateRoomMembershipResponse : public OAIObject {
public:
    OAIUpdateRoomMembershipResponse();
    OAIUpdateRoomMembershipResponse(QString json);
    ~OAIUpdateRoomMembershipResponse() override;
    ...
    OAICreateRoomMembershipResponse_RoomMembership getRoomMembership() const;
    void setRoomMembership(const OAICreateRoomMembershipResponse_RoomMembership &room_membership);
    bool is_room_membership_Set() const;
    bool is_room_membership_Valid() const;
...
private:
    ...
    OAICreateRoomMembershipResponse_RoomMembership m_room_membership;
    bool m_room_membership_isSet;
    bool m_room_membership_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRoomMembershipResponse)

#endif // OAIUpdateRoomMembershipResponse_H
