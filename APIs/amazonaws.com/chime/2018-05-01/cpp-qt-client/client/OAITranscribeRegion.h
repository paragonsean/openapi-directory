...
/*
 * OAITranscribeRegion.h
 *
 * 
 */

#ifndef OAITranscribeRegion_H
#define OAITranscribeRegion_H
...
class OAITranscribeRegion : public OAIEnum {
public:
    OAITranscribeRegion();
    OAITranscribeRegion(QString json);
    ~OAITranscribeRegion() override;
    ...
    enum class eOAITranscribeRegion {
    ...
    OAITranscribeRegion::eOAITranscribeRegion getValue() const;
    void setValue(const OAITranscribeRegion::eOAITranscribeRegion& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscribeRegion)

#endif // OAITranscribeRegion_H
