...
/*
 * OAICreateAttendeeRequest.h
 *
 * 
 */

#ifndef OAICreateAttendeeRequest_H
#define OAICreateAttendeeRequest_H
...
class OAICreateAttendeeRequest : public OAIObject {
public:
    OAICreateAttendeeRequest();
    OAICreateAttendeeRequest(QString json);
    ~OAICreateAttendeeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAttendeeRequest)

#endif // OAICreateAttendeeRequest_H
