...
/*
 * OAIBatchDeletePhoneNumberRequest.h
 *
 * 
 */

#ifndef OAIBatchDeletePhoneNumberRequest_H
#define OAIBatchDeletePhoneNumberRequest_H
...
class OAIBatchDeletePhoneNumberRequest : public OAIObject {
public:
    OAIBatchDeletePhoneNumberRequest();
    OAIBatchDeletePhoneNumberRequest(QString json);
    ~OAIBatchDeletePhoneNumberRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeletePhoneNumberRequest)

#endif // OAIBatchDeletePhoneNumberRequest_H
