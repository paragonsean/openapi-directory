...
/*
 * OAICreateSipRuleResponse_SipRule.h
 *
 * 
 */

#ifndef OAICreateSipRuleResponse_SipRule_H
#define OAICreateSipRuleResponse_SipRule_H
...
class OAICreateSipRuleResponse_SipRule : public OAIObject {
public:
    OAICreateSipRuleResponse_SipRule();
    OAICreateSipRuleResponse_SipRule(QString json);
    ~OAICreateSipRuleResponse_SipRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSipRuleResponse_SipRule)

#endif // OAICreateSipRuleResponse_SipRule_H
