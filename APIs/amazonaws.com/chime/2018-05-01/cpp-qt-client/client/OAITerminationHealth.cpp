...
#include "OAITerminationHealth.h"
...
OAITerminationHealth::OAITerminationHealth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITerminationHealth::OAITerminationHealth() {
    this->initializeModel();
}

OAITerminationHealth::~OAITerminationHealth() {}

void OAITerminationHealth::initializeModel() {
...
void OAITerminationHealth::fromJson(QString jsonString) {
...
void OAITerminationHealth::fromJsonObject(QJsonObject json) {
...
QString OAITerminationHealth::asJson() const {
...
QJsonObject OAITerminationHealth::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAITerminationHealth::getTimestamp() const {
    return m_timestamp;
}
void OAITerminationHealth::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAITerminationHealth::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAITerminationHealth::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

QString OAITerminationHealth::getSource() const {
    return m_source;
}
void OAITerminationHealth::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAITerminationHealth::is_source_Set() const{
    return m_source_isSet;
}

bool OAITerminationHealth::is_source_Valid() const{
    return m_source_isValid;
}

bool OAITerminationHealth::isSet() const {
...
bool OAITerminationHealth::isValid() const {
