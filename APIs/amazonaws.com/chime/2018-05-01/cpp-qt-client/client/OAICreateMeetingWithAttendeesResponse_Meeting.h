...
/*
 * OAICreateMeetingWithAttendeesResponse_Meeting.h
 *
 * 
 */

#ifndef OAICreateMeetingWithAttendeesResponse_Meeting_H
#define OAICreateMeetingWithAttendeesResponse_Meeting_H
...
class OAICreateMeetingWithAttendeesResponse_Meeting : public OAIObject {
public:
    OAICreateMeetingWithAttendeesResponse_Meeting();
    OAICreateMeetingWithAttendeesResponse_Meeting(QString json);
    ~OAICreateMeetingWithAttendeesResponse_Meeting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMeetingWithAttendeesResponse_Meeting)

#endif // OAICreateMeetingWithAttendeesResponse_Meeting_H
