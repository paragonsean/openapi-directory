...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::deleteThingShadowSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::deleteThingShadowSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString thing_name = create(); // QString | The name of the thing.
      ...
      QString name = create(); // QString | The name of the shadow.
      apiInstance.deleteThingShadow(thing_namex_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headersname);
