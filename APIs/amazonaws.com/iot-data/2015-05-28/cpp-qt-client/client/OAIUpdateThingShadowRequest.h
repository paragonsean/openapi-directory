...
/*
 * OAIUpdateThingShadowRequest.h
 *
 * The input for the UpdateThingShadow operation.
 */

#ifndef OAIUpdateThingShadowRequest_H
#define OAIUpdateThingShadowRequest_H
...
class OAIUpdateThingShadowRequest : public OAIObject {
public:
    OAIUpdateThingShadowRequest();
    OAIUpdateThingShadowRequest(QString json);
    ~OAIUpdateThingShadowRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateThingShadowRequest)

#endif // OAIUpdateThingShadowRequest_H
