...
/*
 * OAIUpdateThingShadowResponse.h
 *
 * The output from the UpdateThingShadow operation.
 */

#ifndef OAIUpdateThingShadowResponse_H
#define OAIUpdateThingShadowResponse_H
...
class OAIUpdateThingShadowResponse : public OAIObject {
public:
    OAIUpdateThingShadowResponse();
    OAIUpdateThingShadowResponse(QString json);
    ~OAIUpdateThingShadowResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateThingShadowResponse)

#endif // OAIUpdateThingShadowResponse_H
