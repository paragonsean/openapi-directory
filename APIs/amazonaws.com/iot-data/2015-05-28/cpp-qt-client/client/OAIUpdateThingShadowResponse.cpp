...
OAIUpdateThingShadowResponse::OAIUpdateThingShadowResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateThingShadowResponse::OAIUpdateThingShadowResponse() {
    this->initializeModel();
}

OAIUpdateThingShadowResponse::~OAIUpdateThingShadowResponse() {}

void OAIUpdateThingShadowResponse::initializeModel() {

    m_payload_isSet = false;
    m_payload_isValid = false;
}

void OAIUpdateThingShadowResponse::fromJson(QString jsonString) {
...
void OAIUpdateThingShadowResponse::fromJsonObject(QJsonObject json) {

    m_payload_isValid = ::OpenAPI::fromJsonValue(m_payload, json[QString("payload")]);
    m_payload_isSet = !json[QString("payload")].isNull() && m_payload_isValid;
}

QString OAIUpdateThingShadowResponse::asJson() const {
...
QJsonObject OAIUpdateThingShadowResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QString OAIUpdateThingShadowResponse::getPayload() const {
    return m_payload;
}
void OAIUpdateThingShadowResponse::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIUpdateThingShadowResponse::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIUpdateThingShadowResponse::is_payload_Valid() const{
    return m_payload_isValid;
}

bool OAIUpdateThingShadowResponse::isSet() const {
...
bool OAIUpdateThingShadowResponse::isValid() const {
