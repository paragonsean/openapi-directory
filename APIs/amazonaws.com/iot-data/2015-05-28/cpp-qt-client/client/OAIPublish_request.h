...
/*
 * OAIPublish_request.h
 *
 * 
 */

#ifndef OAIPublish_request_H
#define OAIPublish_request_H
...
class OAIPublish_request : public OAIObject {
public:
    OAIPublish_request();
    OAIPublish_request(QString json);
    ~OAIPublish_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublish_request)

#endif // OAIPublish_request_H
