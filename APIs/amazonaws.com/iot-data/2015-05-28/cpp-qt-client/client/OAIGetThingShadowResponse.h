...
/*
 * OAIGetThingShadowResponse.h
 *
 * The output from the GetThingShadow operation.
 */

#ifndef OAIGetThingShadowResponse_H
#define OAIGetThingShadowResponse_H
...
class OAIGetThingShadowResponse : public OAIObject {
public:
    OAIGetThingShadowResponse();
    OAIGetThingShadowResponse(QString json);
    ~OAIGetThingShadowResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetThingShadowResponse)

#endif // OAIGetThingShadowResponse_H
