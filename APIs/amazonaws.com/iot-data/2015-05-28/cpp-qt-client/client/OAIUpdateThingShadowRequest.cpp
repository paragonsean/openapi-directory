...
#include "OAIUpdateThingShadowRequest.h"
...
OAIUpdateThingShadowRequest::OAIUpdateThingShadowRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateThingShadowRequest::OAIUpdateThingShadowRequest() {
    this->initializeModel();
}

OAIUpdateThingShadowRequest::~OAIUpdateThingShadowRequest() {}

void OAIUpdateThingShadowRequest::initializeModel() {

    m_payload_isSet = false;
    m_payload_isValid = false;
}

void OAIUpdateThingShadowRequest::fromJson(QString jsonString) {
...
void OAIUpdateThingShadowRequest::fromJsonObject(QJsonObject json) {

    m_payload_isValid = ::OpenAPI::fromJsonValue(m_payload, json[QString("payload")]);
    m_payload_isSet = !json[QString("payload")].isNull() && m_payload_isValid;
}

QString OAIUpdateThingShadowRequest::asJson() const {
...
QJsonObject OAIUpdateThingShadowRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QString OAIUpdateThingShadowRequest::getPayload() const {
    return m_payload;
}
void OAIUpdateThingShadowRequest::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIUpdateThingShadowRequest::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIUpdateThingShadowRequest::is_payload_Valid() const{
    return m_payload_isValid;
}

bool OAIUpdateThingShadowRequest::isSet() const {
...
bool OAIUpdateThingShadowRequest::isValid() const {
