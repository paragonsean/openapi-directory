...
/*
 * OAIUpdateThingShadow_request.h
 *
 * 
 */

#ifndef OAIUpdateThingShadow_request_H
#define OAIUpdateThingShadow_request_H
...
class OAIUpdateThingShadow_request : public OAIObject {
public:
    OAIUpdateThingShadow_request();
    OAIUpdateThingShadow_request(QString json);
    ~OAIUpdateThingShadow_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateThingShadow_request)

#endif // OAIUpdateThingShadow_request_H
