...
OAIGetThingShadowResponse::OAIGetThingShadowResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetThingShadowResponse::OAIGetThingShadowResponse() {
    this->initializeModel();
}

OAIGetThingShadowResponse::~OAIGetThingShadowResponse() {}

void OAIGetThingShadowResponse::initializeModel() {

    m_payload_isSet = false;
    m_payload_isValid = false;
}

void OAIGetThingShadowResponse::fromJson(QString jsonString) {
...
void OAIGetThingShadowResponse::fromJsonObject(QJsonObject json) {

    m_payload_isValid = ::OpenAPI::fromJsonValue(m_payload, json[QString("payload")]);
    m_payload_isSet = !json[QString("payload")].isNull() && m_payload_isValid;
}

QString OAIGetThingShadowResponse::asJson() const {
...
QJsonObject OAIGetThingShadowResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QString OAIGetThingShadowResponse::getPayload() const {
    return m_payload;
}
void OAIGetThingShadowResponse::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIGetThingShadowResponse::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIGetThingShadowResponse::is_payload_Valid() const{
    return m_payload_isValid;
}

bool OAIGetThingShadowResponse::isSet() const {
...
bool OAIGetThingShadowResponse::isValid() const {
