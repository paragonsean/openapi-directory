...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.UpdateThingShadowRequest();
  });
  ...
  describe('UpdateThingShadowRequest', function() {
    it('should create an instance of UpdateThingShadowRequest', function() {
      // uncomment below and update the code to test UpdateThingShadowRequest
      //var instance = new AwsIoTDataPlane.UpdateThingShadowRequest();
      //expect(instance).to.be.a(AwsIoTDataPlane.UpdateThingShadowRequest);
    });
