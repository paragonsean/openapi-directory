...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.GetThingShadowResponse();
  });
  ...
  describe('GetThingShadowResponse', function() {
    it('should create an instance of GetThingShadowResponse', function() {
      // uncomment below and update the code to test GetThingShadowResponse
      //var instance = new AwsIoTDataPlane.GetThingShadowResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.GetThingShadowResponse);
    });
