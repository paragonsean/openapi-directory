...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.GetRetainedMessageResponse();
  });
  ...
  describe('GetRetainedMessageResponse', function() {
    it('should create an instance of GetRetainedMessageResponse', function() {
      // uncomment below and update the code to test GetRetainedMessageResponse
      //var instance = new AwsIoTDataPlane.GetRetainedMessageResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.GetRetainedMessageResponse);
    });
