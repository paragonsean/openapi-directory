...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.UpdateThingShadowResponse();
  });
  ...
  describe('UpdateThingShadowResponse', function() {
    it('should create an instance of UpdateThingShadowResponse', function() {
      // uncomment below and update the code to test UpdateThingShadowResponse
      //var instance = new AwsIoTDataPlane.UpdateThingShadowResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.UpdateThingShadowResponse);
    });
