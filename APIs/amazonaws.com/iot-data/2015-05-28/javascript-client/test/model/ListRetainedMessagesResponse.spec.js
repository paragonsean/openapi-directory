...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.ListRetainedMessagesResponse();
  });
  ...
  describe('ListRetainedMessagesResponse', function() {
    it('should create an instance of ListRetainedMessagesResponse', function() {
      // uncomment below and update the code to test ListRetainedMessagesResponse
      //var instance = new AwsIoTDataPlane.ListRetainedMessagesResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.ListRetainedMessagesResponse);
    });

    it('should have the property retainedTopics (base name: "retainedTopics")', function() {
      // uncomment below and update the code to test the property retainedTopics
      //var instance = new AwsIoTDataPlane.ListRetainedMessagesResponse();
