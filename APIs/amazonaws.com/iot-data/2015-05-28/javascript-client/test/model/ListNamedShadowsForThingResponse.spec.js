...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.ListNamedShadowsForThingResponse();
  });
  ...
  describe('ListNamedShadowsForThingResponse', function() {
    it('should create an instance of ListNamedShadowsForThingResponse', function() {
      // uncomment below and update the code to test ListNamedShadowsForThingResponse
      //var instance = new AwsIoTDataPlane.ListNamedShadowsForThingResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.ListNamedShadowsForThingResponse);
    });
