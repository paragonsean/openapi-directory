...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTDataPlane.DeleteThingShadowResponse();
  });
  ...
  describe('DeleteThingShadowResponse', function() {
    it('should create an instance of DeleteThingShadowResponse', function() {
      // uncomment below and update the code to test DeleteThingShadowResponse
      //var instance = new AwsIoTDataPlane.DeleteThingShadowResponse();
      //expect(instance).to.be.a(AwsIoTDataPlane.DeleteThingShadowResponse);
    });
