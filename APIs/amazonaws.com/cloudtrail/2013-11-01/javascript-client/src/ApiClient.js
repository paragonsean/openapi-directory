...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://cloudtrail.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://cloudtrail.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2013-11-01/Javascript'
        };
