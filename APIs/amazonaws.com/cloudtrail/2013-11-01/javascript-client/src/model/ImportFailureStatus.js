...
* @readonly
*/
export default class ImportFailureStatus {
    ...
    /**
    * Returns a <code>ImportFailureStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ImportFailureStatus} The enum <code>ImportFailureStatus</code> value.
    */
