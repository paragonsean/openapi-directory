...
class Destination {
     ...
     * @param type {module:model/DestinationType} 
     * @param location {String} 
     */
    constructor(type, location) { 
        
        Destination.initialize(this, type, location);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Type')) {
                obj['Type'] = ApiClient.convertToType(data['Type'], DestinationType);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Type']) { // data not null
          DestinationType.validateJSON(data['Type']);
        }
...
Destination.RequiredProperties = ["Type", "Location"];

/**
 * @member {module:model/DestinationType} Type
 */
 ...
 */
Destination.prototype['Location'] = undefined;
