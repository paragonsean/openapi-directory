...
class ListTagsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ResourceTagList')) {
                obj['ResourceTagList'] = ApiClient.convertToType(data['ResourceTagList'], Array);
            }
    ...
    static validateJSON(data) {
        // validate the optional field `ResourceTagList`
        if (data['ResourceTagList']) { // data not null
          Array.validateJSON(data['ResourceTagList']);
        }
...
/**
 * @member {Array} ResourceTagList
 */
ListTagsResponse.prototype['ResourceTagList'] = undefined;
