...
* @readonly
*/
export default class LookupAttributeKey {
    ...
    /**
    * Returns a <code>LookupAttributeKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LookupAttributeKey} The enum <code>LookupAttributeKey</code> value.
    */
