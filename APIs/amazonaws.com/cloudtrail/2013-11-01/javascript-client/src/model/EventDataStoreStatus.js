...
* @readonly
*/
export default class EventDataStoreStatus {
    ...
    /**
    * Returns a <code>EventDataStoreStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventDataStoreStatus} The enum <code>EventDataStoreStatus</code> value.
    */
