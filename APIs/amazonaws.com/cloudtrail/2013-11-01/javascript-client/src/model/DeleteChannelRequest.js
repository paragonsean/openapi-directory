 ...
 * @module model/DeleteChannelRequest
 * @version 2013-11-01
 */
class DeleteChannelRequest {
    /**
     * Constructs a new <code>DeleteChannelRequest</code>.
     * @alias module:model/DeleteChannelRequest
     * @param channel {String} 
     */
    constructor(channel) { 
        
        DeleteChannelRequest.initialize(this, channel);
    }
     ...
     * @param {module:model/DeleteChannelRequest} obj Optional instance to populate.
     * @return {module:model/DeleteChannelRequest} The populated <code>DeleteChannelRequest</code> instance.
     */
    ...
    static validateJSON(data) {
        ...
        for (const property of DeleteChannelRequest.RequiredProperties) {
...
DeleteChannelRequest.RequiredProperties = ["Channel"];

/**
 * @member {String} Channel
 */
DeleteChannelRequest.prototype['Channel'] = undefined;
