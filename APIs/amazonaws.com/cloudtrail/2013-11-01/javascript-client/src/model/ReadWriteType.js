...
* @readonly
*/
export default class ReadWriteType {
    ...
    /**
    * Returns a <code>ReadWriteType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReadWriteType} The enum <code>ReadWriteType</code> value.
    */
