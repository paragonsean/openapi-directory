...
(function(root, factory) {
  ...
  describe('ImportFailureStatus', function() {
    it('should create an instance of ImportFailureStatus', function() {
      // uncomment below and update the code to test ImportFailureStatus
      //var instance = new AwsCloudTrail.ImportFailureStatus();
      //expect(instance).to.be.a(AwsCloudTrail.ImportFailureStatus);
    });
