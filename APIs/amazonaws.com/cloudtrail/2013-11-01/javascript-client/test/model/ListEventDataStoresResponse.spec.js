...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListEventDataStoresResponse();
  });
  ...
  describe('ListEventDataStoresResponse', function() {
    it('should create an instance of ListEventDataStoresResponse', function() {
      // uncomment below and update the code to test ListEventDataStoresResponse
      //var instance = new AwsCloudTrail.ListEventDataStoresResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListEventDataStoresResponse);
    });

    it('should have the property eventDataStores (base name: "EventDataStores")', function() {
      // uncomment below and update the code to test the property eventDataStores
      //var instance = new AwsCloudTrail.ListEventDataStoresResponse();
