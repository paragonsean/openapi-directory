...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DeleteResourcePolicyRequest();
  });
  ...
  describe('DeleteResourcePolicyRequest', function() {
    it('should create an instance of DeleteResourcePolicyRequest', function() {
      ...
      //var instance = new AwsCloudTrail.DeleteResourcePolicyRequest();
      //expect(instance).to.be.a(AwsCloudTrail.DeleteResourcePolicyRequest);
    });
