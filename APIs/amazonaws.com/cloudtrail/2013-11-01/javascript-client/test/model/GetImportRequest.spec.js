...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetImportRequest();
  });
  ...
  describe('GetImportRequest', function() {
    it('should create an instance of GetImportRequest', function() {
      // uncomment below and update the code to test GetImportRequest
      //var instance = new AwsCloudTrail.GetImportRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetImportRequest);
    });
