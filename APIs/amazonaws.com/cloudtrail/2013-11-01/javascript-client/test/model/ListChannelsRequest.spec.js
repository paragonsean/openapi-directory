...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListChannelsRequest();
  });
  ...
  describe('ListChannelsRequest', function() {
    it('should create an instance of ListChannelsRequest', function() {
      ...
      //var instance = new AwsCloudTrail.ListChannelsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListChannelsRequest);
    });
