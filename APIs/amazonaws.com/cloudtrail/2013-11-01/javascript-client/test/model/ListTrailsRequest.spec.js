...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListTrailsRequest();
  });
  ...
  describe('ListTrailsRequest', function() {
    it('should create an instance of ListTrailsRequest', function() {
      // uncomment below and update the code to test ListTrailsRequest
      //var instance = new AwsCloudTrail.ListTrailsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListTrailsRequest);
    });
