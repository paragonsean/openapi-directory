...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListImportsResponse();
  });
  ...
  describe('ListImportsResponse', function() {
    it('should create an instance of ListImportsResponse', function() {
      ...
      //var instance = new AwsCloudTrail.ListImportsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListImportsResponse);
    });
