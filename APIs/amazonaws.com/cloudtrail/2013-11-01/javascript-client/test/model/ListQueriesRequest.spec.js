...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListQueriesRequest();
  });
  ...
  describe('ListQueriesRequest', function() {
    it('should create an instance of ListQueriesRequest', function() {
      // uncomment below and update the code to test ListQueriesRequest
      //var instance = new AwsCloudTrail.ListQueriesRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListQueriesRequest);
    });
    ...
    it('should have the property queryStatus (base name: "QueryStatus")', function() {
