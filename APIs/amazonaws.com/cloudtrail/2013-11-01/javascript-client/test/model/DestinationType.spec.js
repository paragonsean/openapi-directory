...
(function(root, factory) {
  ...
  describe('DestinationType', function() {
    it('should create an instance of DestinationType', function() {
      // uncomment below and update the code to test DestinationType
      //var instance = new AwsCloudTrail.DestinationType();
      //expect(instance).to.be.a(AwsCloudTrail.DestinationType);
    });
