...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.CancelQueryRequest();
  });
  ...
  describe('CancelQueryRequest', function() {
    it('should create an instance of CancelQueryRequest', function() {
      // uncomment below and update the code to test CancelQueryRequest
      //var instance = new AwsCloudTrail.CancelQueryRequest();
      //expect(instance).to.be.a(AwsCloudTrail.CancelQueryRequest);
    });
