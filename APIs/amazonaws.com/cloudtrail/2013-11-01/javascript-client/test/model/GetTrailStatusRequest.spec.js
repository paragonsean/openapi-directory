...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetTrailStatusRequest();
  });
  ...
  describe('GetTrailStatusRequest', function() {
    it('should create an instance of GetTrailStatusRequest', function() {
      // uncomment below and update the code to test GetTrailStatusRequest
      //var instance = new AwsCloudTrail.GetTrailStatusRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetTrailStatusRequest);
    });
