...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DeleteChannelRequest();
  });
  ...
  describe('DeleteChannelRequest', function() {
    it('should create an instance of DeleteChannelRequest', function() {
      ...
      //var instance = new AwsCloudTrail.DeleteChannelRequest();
      //expect(instance).to.be.a(AwsCloudTrail.DeleteChannelRequest);
    });
