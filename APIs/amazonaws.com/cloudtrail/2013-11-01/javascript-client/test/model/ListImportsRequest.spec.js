...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListImportsRequest();
  });
  ...
  describe('ListImportsRequest', function() {
    it('should create an instance of ListImportsRequest', function() {
      ...
      //var instance = new AwsCloudTrail.ListImportsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListImportsRequest);
    });
