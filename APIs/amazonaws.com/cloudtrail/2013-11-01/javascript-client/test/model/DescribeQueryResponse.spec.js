...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DescribeQueryResponse();
  });
  ...
  describe('DescribeQueryResponse', function() {
    it('should create an instance of DescribeQueryResponse', function() {
      // uncomment below and update the code to test DescribeQueryResponse
      //var instance = new AwsCloudTrail.DescribeQueryResponse();
      //expect(instance).to.be.a(AwsCloudTrail.DescribeQueryResponse);
    });
    ...
    it('should have the property queryStatistics (base name: "QueryStatistics")', function() {
      // uncomment below and update the code to test the property queryStatistics
      //var instance = new AwsCloudTrail.DescribeQueryResponse();
      //expect(instance).to.be();
    });
