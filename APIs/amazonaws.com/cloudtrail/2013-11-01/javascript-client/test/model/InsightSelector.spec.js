...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.InsightSelector();
  });
  ...
  describe('InsightSelector', function() {
    it('should create an instance of InsightSelector', function() {
      // uncomment below and update the code to test InsightSelector
      //var instance = new AwsCloudTrail.InsightSelector();
      //expect(instance).to.be.a(AwsCloudTrail.InsightSelector);
    });
