...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new AwsCloudTrail.ListChannelsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListChannelsResponse);
    });
