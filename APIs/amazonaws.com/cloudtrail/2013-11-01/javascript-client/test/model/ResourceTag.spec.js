...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ResourceTag();
  });
  ...
  describe('ResourceTag', function() {
    it('should create an instance of ResourceTag', function() {
      // uncomment below and update the code to test ResourceTag
      //var instance = new AwsCloudTrail.ResourceTag();
      //expect(instance).to.be.a(AwsCloudTrail.ResourceTag);
    });
