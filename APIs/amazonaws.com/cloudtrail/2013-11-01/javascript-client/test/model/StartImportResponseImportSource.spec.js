...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StartImportResponseImportSource();
  });
  ...
  describe('StartImportResponseImportSource', function() {
    it('should create an instance of StartImportResponseImportSource', function() {
      // uncomment below and update the code to test StartImportResponseImportSource
      //var instance = new AwsCloudTrail.StartImportResponseImportSource();
      //expect(instance).to.be.a(AwsCloudTrail.StartImportResponseImportSource);
    });
