...
(function(root, factory) {
  ...
  describe('LookupAttributeKey', function() {
    it('should create an instance of LookupAttributeKey', function() {
      // uncomment below and update the code to test LookupAttributeKey
      //var instance = new AwsCloudTrail.LookupAttributeKey();
      //expect(instance).to.be.a(AwsCloudTrail.LookupAttributeKey);
    });
