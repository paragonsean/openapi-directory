...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetEventSelectorsRequest();
  });
  ...
  describe('GetEventSelectorsRequest', function() {
    it('should create an instance of GetEventSelectorsRequest', function() {
      // uncomment below and update the code to test GetEventSelectorsRequest
      //var instance = new AwsCloudTrail.GetEventSelectorsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetEventSelectorsRequest);
    });
