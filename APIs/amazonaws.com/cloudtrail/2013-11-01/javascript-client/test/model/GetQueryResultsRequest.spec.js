...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetQueryResultsRequest();
  });
  ...
  describe('GetQueryResultsRequest', function() {
    it('should create an instance of GetQueryResultsRequest', function() {
      // uncomment below and update the code to test GetQueryResultsRequest
      //var instance = new AwsCloudTrail.GetQueryResultsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetQueryResultsRequest);
    });

    it('should have the property eventDataStore (base name: "EventDataStore")', function() {
      // uncomment below and update the code to test the property eventDataStore
      //var instance = new AwsCloudTrail.GetQueryResultsRequest();
    ...
    it('should have the property maxQueryResults (base name: "MaxQueryResults")', function() {
      // uncomment below and update the code to test the property maxQueryResults
      //var instance = new AwsCloudTrail.GetQueryResultsRequest();
      //expect(instance).to.be();
    });
