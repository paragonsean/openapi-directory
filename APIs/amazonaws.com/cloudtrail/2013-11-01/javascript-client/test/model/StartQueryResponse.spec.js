...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StartQueryResponse();
  });
  ...
  describe('StartQueryResponse', function() {
    it('should create an instance of StartQueryResponse', function() {
      ...
      //var instance = new AwsCloudTrail.StartQueryResponse();
      //expect(instance).to.be.a(AwsCloudTrail.StartQueryResponse);
    });
