...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.LookupEventsRequest();
  });
  ...
  describe('LookupEventsRequest', function() {
    it('should create an instance of LookupEventsRequest', function() {
      // uncomment below and update the code to test LookupEventsRequest
      //var instance = new AwsCloudTrail.LookupEventsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.LookupEventsRequest);
    });

    it('should have the property lookupAttributes (base name: "LookupAttributes")', function() {
      // uncomment below and update the code to test the property lookupAttributes
      //var instance = new AwsCloudTrail.LookupEventsRequest();
