...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StopLoggingRequest();
  });
  ...
  describe('StopLoggingRequest', function() {
    it('should create an instance of StopLoggingRequest', function() {
      // uncomment below and update the code to test StopLoggingRequest
      //var instance = new AwsCloudTrail.StopLoggingRequest();
      //expect(instance).to.be.a(AwsCloudTrail.StopLoggingRequest);
    });
