...
(function(root, factory) {
  ...
  describe('EventDataStoreStatus', function() {
    it('should create an instance of EventDataStoreStatus', function() {
      // uncomment below and update the code to test EventDataStoreStatus
      //var instance = new AwsCloudTrail.EventDataStoreStatus();
      //expect(instance).to.be.a(AwsCloudTrail.EventDataStoreStatus);
    });
