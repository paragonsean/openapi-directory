...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StopImportRequest();
  });
  ...
  describe('StopImportRequest', function() {
    it('should create an instance of StopImportRequest', function() {
      // uncomment below and update the code to test StopImportRequest
      //var instance = new AwsCloudTrail.StopImportRequest();
      //expect(instance).to.be.a(AwsCloudTrail.StopImportRequest);
    });
