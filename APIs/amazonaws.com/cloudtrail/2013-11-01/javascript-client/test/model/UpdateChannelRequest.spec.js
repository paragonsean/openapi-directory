...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.UpdateChannelRequest();
  });
  ...
  describe('UpdateChannelRequest', function() {
    it('should create an instance of UpdateChannelRequest', function() {
      ...
      //var instance = new AwsCloudTrail.UpdateChannelRequest();
      //expect(instance).to.be.a(AwsCloudTrail.UpdateChannelRequest);
    });
