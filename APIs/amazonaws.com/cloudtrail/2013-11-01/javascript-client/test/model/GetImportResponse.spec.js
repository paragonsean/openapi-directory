...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetImportResponse();
  });
  ...
  describe('GetImportResponse', function() {
    it('should create an instance of GetImportResponse', function() {
      // uncomment below and update the code to test GetImportResponse
      //var instance = new AwsCloudTrail.GetImportResponse();
      //expect(instance).to.be.a(AwsCloudTrail.GetImportResponse);
    });
