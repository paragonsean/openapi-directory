...
(function(root, factory) {
  ...
  describe('QueryStatus', function() {
    it('should create an instance of QueryStatus', function() {
      // uncomment below and update the code to test QueryStatus
      //var instance = new AwsCloudTrail.QueryStatus();
      //expect(instance).to.be.a(AwsCloudTrail.QueryStatus);
    });
