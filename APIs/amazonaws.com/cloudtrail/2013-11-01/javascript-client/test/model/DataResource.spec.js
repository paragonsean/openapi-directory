...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DataResource();
  });
  ...
  describe('DataResource', function() {
    it('should create an instance of DataResource', function() {
      // uncomment below and update the code to test DataResource
      //var instance = new AwsCloudTrail.DataResource();
      //expect(instance).to.be.a(AwsCloudTrail.DataResource);
    });
