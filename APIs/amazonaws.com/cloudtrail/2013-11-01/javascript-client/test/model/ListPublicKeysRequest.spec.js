...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListPublicKeysRequest();
  });
  ...
  describe('ListPublicKeysRequest', function() {
    it('should create an instance of ListPublicKeysRequest', function() {
      // uncomment below and update the code to test ListPublicKeysRequest
      //var instance = new AwsCloudTrail.ListPublicKeysRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListPublicKeysRequest);
    });
