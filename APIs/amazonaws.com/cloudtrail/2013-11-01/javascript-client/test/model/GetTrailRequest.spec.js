...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetTrailRequest();
  });
  ...
  describe('GetTrailRequest', function() {
    it('should create an instance of GetTrailRequest', function() {
      // uncomment below and update the code to test GetTrailRequest
      //var instance = new AwsCloudTrail.GetTrailRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetTrailRequest);
    });
