...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetTrailResponse();
  });
  ...
  describe('GetTrailResponse', function() {
    it('should create an instance of GetTrailResponse', function() {
      // uncomment below and update the code to test GetTrailResponse
      //var instance = new AwsCloudTrail.GetTrailResponse();
      //expect(instance).to.be.a(AwsCloudTrail.GetTrailResponse);
    });

    it('should have the property trail (base name: "Trail")', function() {
      // uncomment below and update the code to test the property trail
      //var instance = new AwsCloudTrail.GetTrailResponse();
