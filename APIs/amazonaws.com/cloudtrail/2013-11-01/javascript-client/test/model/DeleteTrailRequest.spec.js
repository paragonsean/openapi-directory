...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DeleteTrailRequest();
  });
  ...
  describe('DeleteTrailRequest', function() {
    it('should create an instance of DeleteTrailRequest', function() {
      // uncomment below and update the code to test DeleteTrailRequest
      //var instance = new AwsCloudTrail.DeleteTrailRequest();
      //expect(instance).to.be.a(AwsCloudTrail.DeleteTrailRequest);
    });
