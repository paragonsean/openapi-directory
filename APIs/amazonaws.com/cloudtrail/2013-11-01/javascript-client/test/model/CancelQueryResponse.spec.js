...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.CancelQueryResponse();
  });
  ...
  describe('CancelQueryResponse', function() {
    it('should create an instance of CancelQueryResponse', function() {
      // uncomment below and update the code to test CancelQueryResponse
      //var instance = new AwsCloudTrail.CancelQueryResponse();
      //expect(instance).to.be.a(AwsCloudTrail.CancelQueryResponse);
    });
