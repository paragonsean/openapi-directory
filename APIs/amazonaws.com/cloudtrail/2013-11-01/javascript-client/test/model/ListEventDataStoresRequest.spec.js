...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListEventDataStoresRequest();
  });
  ...
  describe('ListEventDataStoresRequest', function() {
    it('should create an instance of ListEventDataStoresRequest', function() {
      // uncomment below and update the code to test ListEventDataStoresRequest
      //var instance = new AwsCloudTrail.ListEventDataStoresRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListEventDataStoresRequest);
    });
