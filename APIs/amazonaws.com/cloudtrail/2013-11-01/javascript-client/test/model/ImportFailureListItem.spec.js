...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ImportFailureListItem();
  });
  ...
  describe('ImportFailureListItem', function() {
    it('should create an instance of ImportFailureListItem', function() {
      // uncomment below and update the code to test ImportFailureListItem
      //var instance = new AwsCloudTrail.ImportFailureListItem();
      //expect(instance).to.be.a(AwsCloudTrail.ImportFailureListItem);
    });
