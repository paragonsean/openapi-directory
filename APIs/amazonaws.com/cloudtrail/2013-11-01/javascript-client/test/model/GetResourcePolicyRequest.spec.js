...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetResourcePolicyRequest();
  });
  ...
  describe('GetResourcePolicyRequest', function() {
    it('should create an instance of GetResourcePolicyRequest', function() {
      // uncomment below and update the code to test GetResourcePolicyRequest
      //var instance = new AwsCloudTrail.GetResourcePolicyRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetResourcePolicyRequest);
    });
