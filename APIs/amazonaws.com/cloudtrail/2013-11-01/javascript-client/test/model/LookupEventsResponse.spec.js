...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.LookupEventsResponse();
  });
  ...
  describe('LookupEventsResponse', function() {
    it('should create an instance of LookupEventsResponse', function() {
      // uncomment below and update the code to test LookupEventsResponse
      //var instance = new AwsCloudTrail.LookupEventsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.LookupEventsResponse);
    });
