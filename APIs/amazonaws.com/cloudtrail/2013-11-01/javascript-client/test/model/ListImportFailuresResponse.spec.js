...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListImportFailuresResponse();
  });
  ...
  describe('ListImportFailuresResponse', function() {
    it('should create an instance of ListImportFailuresResponse', function() {
      // uncomment below and update the code to test ListImportFailuresResponse
      //var instance = new AwsCloudTrail.ListImportFailuresResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListImportFailuresResponse);
    });
