...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.CreateChannelRequest();
  });
  ...
  describe('CreateChannelRequest', function() {
    it('should create an instance of CreateChannelRequest', function() {
      ...
      //var instance = new AwsCloudTrail.CreateChannelRequest();
      //expect(instance).to.be.a(AwsCloudTrail.CreateChannelRequest);
    });
