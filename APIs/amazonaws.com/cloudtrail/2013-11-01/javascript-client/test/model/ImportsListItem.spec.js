...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ImportsListItem();
  });
  ...
  describe('ImportsListItem', function() {
    it('should create an instance of ImportsListItem', function() {
      // uncomment below and update the code to test ImportsListItem
      //var instance = new AwsCloudTrail.ImportsListItem();
      //expect(instance).to.be.a(AwsCloudTrail.ImportsListItem);
    });
