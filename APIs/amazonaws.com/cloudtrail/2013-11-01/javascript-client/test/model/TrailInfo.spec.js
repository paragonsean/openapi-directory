...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.TrailInfo();
  });
  ...
  describe('TrailInfo', function() {
    it('should create an instance of TrailInfo', function() {
      // uncomment below and update the code to test TrailInfo
      //var instance = new AwsCloudTrail.TrailInfo();
      //expect(instance).to.be.a(AwsCloudTrail.TrailInfo);
    });
