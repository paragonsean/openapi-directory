...
(function(root, factory) {
  ...
  describe('ReadWriteType', function() {
    it('should create an instance of ReadWriteType', function() {
      // uncomment below and update the code to test ReadWriteType
      //var instance = new AwsCloudTrail.ReadWriteType();
      //expect(instance).to.be.a(AwsCloudTrail.ReadWriteType);
    });
