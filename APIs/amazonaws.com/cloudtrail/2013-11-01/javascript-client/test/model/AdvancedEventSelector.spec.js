...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.AdvancedEventSelector();
  });
  ...
  describe('AdvancedEventSelector', function() {
    it('should create an instance of AdvancedEventSelector', function() {
      // uncomment below and update the code to test AdvancedEventSelector
      //var instance = new AwsCloudTrail.AdvancedEventSelector();
      //expect(instance).to.be.a(AwsCloudTrail.AdvancedEventSelector);
    });
    ...
    it('should have the property fieldSelectors (base name: "FieldSelectors")', function() {
      // uncomment below and update the code to test the property fieldSelectors
      //var instance = new AwsCloudTrail.AdvancedEventSelector();
      //expect(instance).to.be();
    });
