...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListTagsRequest();
  });
  ...
  describe('ListTagsRequest', function() {
    it('should create an instance of ListTagsRequest', function() {
      // uncomment below and update the code to test ListTagsRequest
      //var instance = new AwsCloudTrail.ListTagsRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListTagsRequest);
    });

    it('should have the property resourceIdList (base name: "ResourceIdList")', function() {
      // uncomment below and update the code to test the property resourceIdList
      //var instance = new AwsCloudTrail.ListTagsRequest();
