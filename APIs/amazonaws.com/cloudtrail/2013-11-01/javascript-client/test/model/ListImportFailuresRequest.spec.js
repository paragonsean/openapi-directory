...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListImportFailuresRequest();
  });
  ...
  describe('ListImportFailuresRequest', function() {
    it('should create an instance of ListImportFailuresRequest', function() {
      // uncomment below and update the code to test ListImportFailuresRequest
      //var instance = new AwsCloudTrail.ListImportFailuresRequest();
      //expect(instance).to.be.a(AwsCloudTrail.ListImportFailuresRequest);
    });
