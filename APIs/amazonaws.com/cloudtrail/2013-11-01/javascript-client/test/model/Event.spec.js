...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new AwsCloudTrail.Event();
      //expect(instance).to.be.a(AwsCloudTrail.Event);
    });
    ...
    it('should have the property cloudTrailEvent (base name: "CloudTrailEvent")', function() {
      // uncomment below and update the code to test the property cloudTrailEvent
      //var instance = new AwsCloudTrail.Event();
      //expect(instance).to.be();
    });
