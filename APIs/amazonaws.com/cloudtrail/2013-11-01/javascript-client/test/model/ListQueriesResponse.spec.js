...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListQueriesResponse();
  });
  ...
  describe('ListQueriesResponse', function() {
    it('should create an instance of ListQueriesResponse', function() {
      // uncomment below and update the code to test ListQueriesResponse
      //var instance = new AwsCloudTrail.ListQueriesResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListQueriesResponse);
    });
