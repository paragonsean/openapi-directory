...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetChannelRequest();
  });
  ...
  describe('GetChannelRequest', function() {
    it('should create an instance of GetChannelRequest', function() {
      // uncomment below and update the code to test GetChannelRequest
      //var instance = new AwsCloudTrail.GetChannelRequest();
      //expect(instance).to.be.a(AwsCloudTrail.GetChannelRequest);
    });
