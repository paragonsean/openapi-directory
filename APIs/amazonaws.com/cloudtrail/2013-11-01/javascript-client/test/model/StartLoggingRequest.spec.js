...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StartLoggingRequest();
  });
  ...
  describe('StartLoggingRequest', function() {
    it('should create an instance of StartLoggingRequest', function() {
      // uncomment below and update the code to test StartLoggingRequest
      //var instance = new AwsCloudTrail.StartLoggingRequest();
      //expect(instance).to.be.a(AwsCloudTrail.StartLoggingRequest);
    });
