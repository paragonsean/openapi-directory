...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListTrailsResponse();
  });
  ...
  describe('ListTrailsResponse', function() {
    it('should create an instance of ListTrailsResponse', function() {
      // uncomment below and update the code to test ListTrailsResponse
      //var instance = new AwsCloudTrail.ListTrailsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListTrailsResponse);
    });

    it('should have the property trails (base name: "Trails")', function() {
      // uncomment below and update the code to test the property trails
      //var instance = new AwsCloudTrail.ListTrailsResponse();
