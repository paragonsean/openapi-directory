...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DescribeTrailsResponse();
  });
  ...
  describe('DescribeTrailsResponse', function() {
    it('should create an instance of DescribeTrailsResponse', function() {
      // uncomment below and update the code to test DescribeTrailsResponse
      //var instance = new AwsCloudTrail.DescribeTrailsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.DescribeTrailsResponse);
    });

    it('should have the property trailList (base name: "trailList")', function() {
      // uncomment below and update the code to test the property trailList
      //var instance = new AwsCloudTrail.DescribeTrailsResponse();
