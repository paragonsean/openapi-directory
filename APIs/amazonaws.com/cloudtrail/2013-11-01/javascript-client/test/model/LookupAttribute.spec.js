...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.LookupAttribute();
  });
  ...
  describe('LookupAttribute', function() {
    it('should create an instance of LookupAttribute', function() {
      // uncomment below and update the code to test LookupAttribute
      //var instance = new AwsCloudTrail.LookupAttribute();
      //expect(instance).to.be.a(AwsCloudTrail.LookupAttribute);
    });
