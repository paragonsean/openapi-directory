...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.DescribeQueryRequest();
  });
  ...
  describe('DescribeQueryRequest', function() {
    it('should create an instance of DescribeQueryRequest', function() {
      // uncomment below and update the code to test DescribeQueryRequest
      //var instance = new AwsCloudTrail.DescribeQueryRequest();
      //expect(instance).to.be.a(AwsCloudTrail.DescribeQueryRequest);
    });
