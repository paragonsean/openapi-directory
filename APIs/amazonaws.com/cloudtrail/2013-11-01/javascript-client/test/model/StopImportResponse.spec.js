...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StopImportResponse();
  });
  ...
  describe('StopImportResponse', function() {
    it('should create an instance of StopImportResponse', function() {
      // uncomment below and update the code to test StopImportResponse
      //var instance = new AwsCloudTrail.StopImportResponse();
      //expect(instance).to.be.a(AwsCloudTrail.StopImportResponse);
    });
    ...
    it('should have the property importSource (base name: "ImportSource")', function() {
      // uncomment below and update the code to test the property importSource
      //var instance = new AwsCloudTrail.StopImportResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property startEventTime (base name: "StartEventTime")', function() {
      // uncomment below and update the code to test the property startEventTime
      //var instance = new AwsCloudTrail.StopImportResponse();
      //expect(instance).to.be();
    });

    it('should have the property endEventTime (base name: "EndEventTime")', function() {
      // uncomment below and update the code to test the property endEventTime
      //var instance = new AwsCloudTrail.StopImportResponse();
      //expect(instance).to.be();
    });

    it('should have the property importStatistics (base name: "ImportStatistics")', function() {
      // uncomment below and update the code to test the property importStatistics
      //var instance = new AwsCloudTrail.StopImportResponse();
      //expect(instance).to.be();
    });
