...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.GetImportResponseImportSource();
  });
  ...
  describe('GetImportResponseImportSource', function() {
    it('should create an instance of GetImportResponseImportSource', function() {
      // uncomment below and update the code to test GetImportResponseImportSource
      //var instance = new AwsCloudTrail.GetImportResponseImportSource();
      //expect(instance).to.be.a(AwsCloudTrail.GetImportResponseImportSource);
    });
