...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.ListTagsResponse();
  });
  ...
  describe('ListTagsResponse', function() {
    it('should create an instance of ListTagsResponse', function() {
      ...
      //var instance = new AwsCloudTrail.ListTagsResponse();
      //expect(instance).to.be.a(AwsCloudTrail.ListTagsResponse);
    });

    it('should have the property resourceTagList (base name: "ResourceTagList")', function() {
      // uncomment below and update the code to test the property resourceTagList
      //var instance = new AwsCloudTrail.ListTagsResponse();
