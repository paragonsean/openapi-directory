...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloudTrail.StartImportRequestImportSource();
  });
  ...
  describe('StartImportRequestImportSource', function() {
    it('should create an instance of StartImportRequestImportSource', function() {
      // uncomment below and update the code to test StartImportRequestImportSource
      //var instance = new AwsCloudTrail.StartImportRequestImportSource();
      //expect(instance).to.be.a(AwsCloudTrail.StartImportRequestImportSource);
    });
