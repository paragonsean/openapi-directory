...
public class RestoreEventDataStoreResponse {
  ...
  public RestoreEventDataStoreResponse eventDataStoreArn(String eventDataStoreArn) {
  ...
  public RestoreEventDataStoreResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RestoreEventDataStoreResponse status(EventDataStoreStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RestoreEventDataStoreResponse advancedEventSelectors(List advancedEventSelectors) {
  ...
  public RestoreEventDataStoreResponse multiRegionEnabled(Boolean multiRegionEnabled) {
  ...
  public RestoreEventDataStoreResponse organizationEnabled(Boolean organizationEnabled) {
  ...
  public RestoreEventDataStoreResponse retentionPeriod(Integer retentionPeriod) {
  ...
  public RestoreEventDataStoreResponse terminationProtectionEnabled(Boolean terminationProtectionEnabled) {
  ...
  public RestoreEventDataStoreResponse createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public RestoreEventDataStoreResponse updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public RestoreEventDataStoreResponse kmsKeyId(String kmsKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    RestoreEventDataStoreResponse restoreEventDataStoreResponse = (RestoreEventDataStoreResponse) o;
    return Objects.equals(this.eventDataStoreArn, restoreEventDataStoreResponse.eventDataStoreArn) &&
        Objects.equals(this.name, restoreEventDataStoreResponse.name) &&
        Objects.equals(this.status, restoreEventDataStoreResponse.status) &&
        Objects.equals(this.advancedEventSelectors, restoreEventDataStoreResponse.advancedEventSelectors) &&
        Objects.equals(this.multiRegionEnabled, restoreEventDataStoreResponse.multiRegionEnabled) &&
        Objects.equals(this.organizationEnabled, restoreEventDataStoreResponse.organizationEnabled) &&
        Objects.equals(this.retentionPeriod, restoreEventDataStoreResponse.retentionPeriod) &&
        Objects.equals(this.terminationProtectionEnabled, restoreEventDataStoreResponse.terminationProtectionEnabled) &&
        Objects.equals(this.createdTimestamp, restoreEventDataStoreResponse.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, restoreEventDataStoreResponse.updatedTimestamp) &&
        Objects.equals(this.kmsKeyId, restoreEventDataStoreResponse.kmsKeyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestoreEventDataStoreResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestoreEventDataStoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestoreEventDataStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestoreEventDataStoreResponse is not found in the empty JSON string", RestoreEventDataStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RestoreEventDataStoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestoreEventDataStoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestoreEventDataStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestoreEventDataStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestoreEventDataStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestoreEventDataStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RestoreEventDataStoreResponse>() {
           @Override
           public void write(JsonWriter out, RestoreEventDataStoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RestoreEventDataStoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RestoreEventDataStoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RestoreEventDataStoreResponse
   * @throws IOException if the JSON string is invalid with respect to RestoreEventDataStoreResponse
   */
  public static RestoreEventDataStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestoreEventDataStoreResponse.class);
  }

  /**
   * Convert an instance of RestoreEventDataStoreResponse to an JSON string
   *
   * @return JSON string
   */
