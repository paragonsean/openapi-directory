...
/**
 * Gets or Sets EventDataStoreStatus
 */
@JsonAdapter(EventDataStoreStatus.Adapter.class)
public enum EventDataStoreStatus {
  ...
  EventDataStoreStatus(String value) {
    this.value = value;
  }
  ...
  public static EventDataStoreStatus fromValue(String value) {
    for (EventDataStoreStatus b : EventDataStoreStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<EventDataStoreStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final EventDataStoreStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EventDataStoreStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EventDataStoreStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EventDataStoreStatus.fromValue(value);
  }
}
