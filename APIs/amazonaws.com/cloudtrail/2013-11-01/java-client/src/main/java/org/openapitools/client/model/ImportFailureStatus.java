...
/**
 * Gets or Sets ImportFailureStatus
 */
@JsonAdapter(ImportFailureStatus.Adapter.class)
public enum ImportFailureStatus {
  ...
  ImportFailureStatus(String value) {
    this.value = value;
  }
  ...
  public static ImportFailureStatus fromValue(String value) {
    for (ImportFailureStatus b : ImportFailureStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ImportFailureStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ImportFailureStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ImportFailureStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ImportFailureStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ImportFailureStatus.fromValue(value);
  }
}
