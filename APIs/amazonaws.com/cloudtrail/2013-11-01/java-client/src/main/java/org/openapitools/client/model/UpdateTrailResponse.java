...
public class UpdateTrailResponse {
  ...
  public UpdateTrailResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateTrailResponse s3BucketName(String s3BucketName) {
  ...
  public UpdateTrailResponse s3KeyPrefix(String s3KeyPrefix) {
  ...
  public UpdateTrailResponse snsTopicName(String snsTopicName) {
  ...
  public UpdateTrailResponse snsTopicARN(String snsTopicARN) {
  ...
  public UpdateTrailResponse includeGlobalServiceEvents(Boolean includeGlobalServiceEvents) {
  ...
  public UpdateTrailResponse isMultiRegionTrail(Boolean isMultiRegionTrail) {
  ...
  public UpdateTrailResponse trailARN(String trailARN) {
  ...
  public UpdateTrailResponse logFileValidationEnabled(Boolean logFileValidationEnabled) {
  ...
  public UpdateTrailResponse cloudWatchLogsLogGroupArn(String cloudWatchLogsLogGroupArn) {
  ...
  public UpdateTrailResponse cloudWatchLogsRoleArn(String cloudWatchLogsRoleArn) {
  ...
  public UpdateTrailResponse kmsKeyId(String kmsKeyId) {
  ...
  public UpdateTrailResponse isOrganizationTrail(Boolean isOrganizationTrail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateTrailResponse.name) &&
        Objects.equals(this.s3BucketName, updateTrailResponse.s3BucketName) &&
        Objects.equals(this.s3KeyPrefix, updateTrailResponse.s3KeyPrefix) &&
        Objects.equals(this.snsTopicName, updateTrailResponse.snsTopicName) &&
        Objects.equals(this.snsTopicARN, updateTrailResponse.snsTopicARN) &&
        Objects.equals(this.includeGlobalServiceEvents, updateTrailResponse.includeGlobalServiceEvents) &&
        Objects.equals(this.isMultiRegionTrail, updateTrailResponse.isMultiRegionTrail) &&
        Objects.equals(this.trailARN, updateTrailResponse.trailARN) &&
        Objects.equals(this.logFileValidationEnabled, updateTrailResponse.logFileValidationEnabled) &&
        Objects.equals(this.cloudWatchLogsLogGroupArn, updateTrailResponse.cloudWatchLogsLogGroupArn) &&
        Objects.equals(this.cloudWatchLogsRoleArn, updateTrailResponse.cloudWatchLogsRoleArn) &&
        Objects.equals(this.kmsKeyId, updateTrailResponse.kmsKeyId) &&
        Objects.equals(this.isOrganizationTrail, updateTrailResponse.isOrganizationTrail);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateTrailResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTrailResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateTrailResponse is not found in the empty JSON string", UpdateTrailResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateTrailResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateTrailResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateTrailResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateTrailResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateTrailResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateTrailResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateTrailResponse>() {
           @Override
           public void write(JsonWriter out, UpdateTrailResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateTrailResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateTrailResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateTrailResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateTrailResponse
   */
  public static UpdateTrailResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateTrailResponse.class);
  }

  /**
   * Convert an instance of UpdateTrailResponse to an JSON string
   *
   * @return JSON string
   */
