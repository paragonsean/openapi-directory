...
public class UpdateEventDataStoreResponse {
  ...
  public UpdateEventDataStoreResponse eventDataStoreArn(String eventDataStoreArn) {
  ...
  public UpdateEventDataStoreResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateEventDataStoreResponse status(EventDataStoreStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateEventDataStoreResponse advancedEventSelectors(List advancedEventSelectors) {
  ...
  public UpdateEventDataStoreResponse multiRegionEnabled(Boolean multiRegionEnabled) {
  ...
  public UpdateEventDataStoreResponse organizationEnabled(Boolean organizationEnabled) {
  ...
  public UpdateEventDataStoreResponse retentionPeriod(Integer retentionPeriod) {
  ...
  public UpdateEventDataStoreResponse terminationProtectionEnabled(Boolean terminationProtectionEnabled) {
  ...
  public UpdateEventDataStoreResponse createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public UpdateEventDataStoreResponse updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public UpdateEventDataStoreResponse kmsKeyId(String kmsKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEventDataStoreResponse updateEventDataStoreResponse = (UpdateEventDataStoreResponse) o;
    return Objects.equals(this.eventDataStoreArn, updateEventDataStoreResponse.eventDataStoreArn) &&
        Objects.equals(this.name, updateEventDataStoreResponse.name) &&
        Objects.equals(this.status, updateEventDataStoreResponse.status) &&
        Objects.equals(this.advancedEventSelectors, updateEventDataStoreResponse.advancedEventSelectors) &&
        Objects.equals(this.multiRegionEnabled, updateEventDataStoreResponse.multiRegionEnabled) &&
        Objects.equals(this.organizationEnabled, updateEventDataStoreResponse.organizationEnabled) &&
        Objects.equals(this.retentionPeriod, updateEventDataStoreResponse.retentionPeriod) &&
        Objects.equals(this.terminationProtectionEnabled, updateEventDataStoreResponse.terminationProtectionEnabled) &&
        Objects.equals(this.createdTimestamp, updateEventDataStoreResponse.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, updateEventDataStoreResponse.updatedTimestamp) &&
        Objects.equals(this.kmsKeyId, updateEventDataStoreResponse.kmsKeyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEventDataStoreResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEventDataStoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEventDataStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEventDataStoreResponse is not found in the empty JSON string", UpdateEventDataStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEventDataStoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEventDataStoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEventDataStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEventDataStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEventDataStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEventDataStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEventDataStoreResponse>() {
           @Override
           public void write(JsonWriter out, UpdateEventDataStoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEventDataStoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEventDataStoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEventDataStoreResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateEventDataStoreResponse
   */
  public static UpdateEventDataStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEventDataStoreResponse.class);
  }

  /**
   * Convert an instance of UpdateEventDataStoreResponse to an JSON string
   *
   * @return JSON string
   */
