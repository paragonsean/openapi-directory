...
public class EventDataStore {
  ...
  public EventDataStore eventDataStoreArn(String eventDataStoreArn) {
  ...
  public EventDataStore name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EventDataStore terminationProtectionEnabled(Boolean terminationProtectionEnabled) {
  ...
  public EventDataStore status(EventDataStoreStatus status) {
    this.status = status;
    return this;
  }
  ...
  public EventDataStore advancedEventSelectors(List advancedEventSelectors) {
  ...
  public EventDataStore multiRegionEnabled(Boolean multiRegionEnabled) {
  ...
  public EventDataStore organizationEnabled(Boolean organizationEnabled) {
  ...
  public EventDataStore retentionPeriod(Integer retentionPeriod) {
  ...
  public EventDataStore createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public EventDataStore updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public boolean equals(Object o) {
    ...
    EventDataStore eventDataStore = (EventDataStore) o;
    return Objects.equals(this.eventDataStoreArn, eventDataStore.eventDataStoreArn) &&
        Objects.equals(this.name, eventDataStore.name) &&
        Objects.equals(this.terminationProtectionEnabled, eventDataStore.terminationProtectionEnabled) &&
        Objects.equals(this.status, eventDataStore.status) &&
        Objects.equals(this.advancedEventSelectors, eventDataStore.advancedEventSelectors) &&
        Objects.equals(this.multiRegionEnabled, eventDataStore.multiRegionEnabled) &&
        Objects.equals(this.organizationEnabled, eventDataStore.organizationEnabled) &&
        Objects.equals(this.retentionPeriod, eventDataStore.retentionPeriod) &&
        Objects.equals(this.createdTimestamp, eventDataStore.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, eventDataStore.updatedTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventDataStoreArn, name, terminationProtectionEnabled, status, advancedEventSelectors, multiRegionEnabled, organizationEnabled, retentionPeriod, createdTimestamp, updatedTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventDataStore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventDataStore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDataStore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventDataStore is not found in the empty JSON string", EventDataStore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventDataStore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventDataStore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventDataStore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventDataStore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventDataStore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDataStore.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDataStore>() {
           @Override
           public void write(JsonWriter out, EventDataStore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventDataStore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventDataStore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventDataStore
   * @throws IOException if the JSON string is invalid with respect to EventDataStore
   */
  public static EventDataStore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventDataStore.class);
  }

  /**
   * Convert an instance of EventDataStore to an JSON string
   *
   * @return JSON string
   */
