...
public class ApiClient {
    ...
    private String basePath = "http://cloudtrail.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2013-11-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://cloudtrail.us-east-1.amazonaws.com
