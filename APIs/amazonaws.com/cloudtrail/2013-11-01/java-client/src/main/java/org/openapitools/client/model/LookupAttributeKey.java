...
/**
 * Gets or Sets LookupAttributeKey
 */
@JsonAdapter(LookupAttributeKey.Adapter.class)
public enum LookupAttributeKey {
  ...
  LookupAttributeKey(String value) {
    this.value = value;
  }
  ...
  public static LookupAttributeKey fromValue(String value) {
    for (LookupAttributeKey b : LookupAttributeKey.values()) {
  ...
  public static class Adapter extends TypeAdapter<LookupAttributeKey> {
    @Override
    public void write(final JsonWriter jsonWriter, final LookupAttributeKey enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LookupAttributeKey read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LookupAttributeKey.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LookupAttributeKey.fromValue(value);
  }
}
