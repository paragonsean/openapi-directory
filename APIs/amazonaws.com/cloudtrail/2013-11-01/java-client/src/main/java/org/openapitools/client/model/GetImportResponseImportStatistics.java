...
public class GetImportResponseImportStatistics {
  ...
  public GetImportResponseImportStatistics() {
  }

  public GetImportResponseImportStatistics prefixesFound(Integer prefixesFound) {
  ...
  public GetImportResponseImportStatistics prefixesCompleted(Integer prefixesCompleted) {
  ...
  public GetImportResponseImportStatistics filesCompleted(Integer filesCompleted) {
  ...
  public GetImportResponseImportStatistics eventsCompleted(Integer eventsCompleted) {
  ...
  public GetImportResponseImportStatistics failedEntries(Integer failedEntries) {
  ...
  public boolean equals(Object o) {
    ...
    GetImportResponseImportStatistics getImportResponseImportStatistics = (GetImportResponseImportStatistics) o;
    return Objects.equals(this.prefixesFound, getImportResponseImportStatistics.prefixesFound) &&
        Objects.equals(this.prefixesCompleted, getImportResponseImportStatistics.prefixesCompleted) &&
        Objects.equals(this.filesCompleted, getImportResponseImportStatistics.filesCompleted) &&
        Objects.equals(this.eventsCompleted, getImportResponseImportStatistics.eventsCompleted) &&
        Objects.equals(this.failedEntries, getImportResponseImportStatistics.failedEntries);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetImportResponseImportStatistics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImportResponseImportStatistics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImportResponseImportStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImportResponseImportStatistics is not found in the empty JSON string", GetImportResponseImportStatistics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImportResponseImportStatistics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImportResponseImportStatistics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImportResponseImportStatistics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImportResponseImportStatistics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImportResponseImportStatistics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImportResponseImportStatistics.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImportResponseImportStatistics>() {
           @Override
           public void write(JsonWriter out, GetImportResponseImportStatistics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImportResponseImportStatistics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImportResponseImportStatistics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImportResponseImportStatistics
   * @throws IOException if the JSON string is invalid with respect to GetImportResponseImportStatistics
   */
  public static GetImportResponseImportStatistics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImportResponseImportStatistics.class);
  }

  /**
   * Convert an instance of GetImportResponseImportStatistics to an JSON string
   *
   * @return JSON string
   */
