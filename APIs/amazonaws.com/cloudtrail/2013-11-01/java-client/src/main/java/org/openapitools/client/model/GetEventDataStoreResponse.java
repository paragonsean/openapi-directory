...
public class GetEventDataStoreResponse {
  ...
  public GetEventDataStoreResponse eventDataStoreArn(String eventDataStoreArn) {
  ...
  public GetEventDataStoreResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetEventDataStoreResponse status(EventDataStoreStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetEventDataStoreResponse advancedEventSelectors(List advancedEventSelectors) {
  ...
  public GetEventDataStoreResponse multiRegionEnabled(Boolean multiRegionEnabled) {
  ...
  public GetEventDataStoreResponse organizationEnabled(Boolean organizationEnabled) {
  ...
  public GetEventDataStoreResponse retentionPeriod(Integer retentionPeriod) {
  ...
  public GetEventDataStoreResponse terminationProtectionEnabled(Boolean terminationProtectionEnabled) {
  ...
  public GetEventDataStoreResponse createdTimestamp(OffsetDateTime createdTimestamp) {
  ...
  public GetEventDataStoreResponse updatedTimestamp(OffsetDateTime updatedTimestamp) {
  ...
  public GetEventDataStoreResponse kmsKeyId(String kmsKeyId) {
  ...
  public boolean equals(Object o) {
    ...
    GetEventDataStoreResponse getEventDataStoreResponse = (GetEventDataStoreResponse) o;
    return Objects.equals(this.eventDataStoreArn, getEventDataStoreResponse.eventDataStoreArn) &&
        Objects.equals(this.name, getEventDataStoreResponse.name) &&
        Objects.equals(this.status, getEventDataStoreResponse.status) &&
        Objects.equals(this.advancedEventSelectors, getEventDataStoreResponse.advancedEventSelectors) &&
        Objects.equals(this.multiRegionEnabled, getEventDataStoreResponse.multiRegionEnabled) &&
        Objects.equals(this.organizationEnabled, getEventDataStoreResponse.organizationEnabled) &&
        Objects.equals(this.retentionPeriod, getEventDataStoreResponse.retentionPeriod) &&
        Objects.equals(this.terminationProtectionEnabled, getEventDataStoreResponse.terminationProtectionEnabled) &&
        Objects.equals(this.createdTimestamp, getEventDataStoreResponse.createdTimestamp) &&
        Objects.equals(this.updatedTimestamp, getEventDataStoreResponse.updatedTimestamp) &&
        Objects.equals(this.kmsKeyId, getEventDataStoreResponse.kmsKeyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventDataStoreArn, name, status, advancedEventSelectors, multiRegionEnabled, organizationEnabled, retentionPeriod, terminationProtectionEnabled, createdTimestamp, updatedTimestamp, kmsKeyId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetEventDataStoreResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEventDataStoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEventDataStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEventDataStoreResponse is not found in the empty JSON string", GetEventDataStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEventDataStoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEventDataStoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEventDataStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEventDataStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEventDataStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEventDataStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEventDataStoreResponse>() {
           @Override
           public void write(JsonWriter out, GetEventDataStoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEventDataStoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEventDataStoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEventDataStoreResponse
   * @throws IOException if the JSON string is invalid with respect to GetEventDataStoreResponse
   */
  public static GetEventDataStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEventDataStoreResponse.class);
  }

  /**
   * Convert an instance of GetEventDataStoreResponse to an JSON string
   *
   * @return JSON string
   */
