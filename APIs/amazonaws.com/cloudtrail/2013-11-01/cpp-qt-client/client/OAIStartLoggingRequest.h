...
/*
 * OAIStartLoggingRequest.h
 *
 * The request to CloudTrail to start logging Amazon Web Services API calls for an account.
 */

#ifndef OAIStartLoggingRequest_H
#define OAIStartLoggingRequest_H
...
class OAIStartLoggingRequest : public OAIObject {
public:
    OAIStartLoggingRequest();
    OAIStartLoggingRequest(QString json);
    ~OAIStartLoggingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLoggingRequest)

#endif // OAIStartLoggingRequest_H
