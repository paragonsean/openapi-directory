...
/*
 * OAICreateEventDataStoreResponse.h
 *
 * 
 */

#ifndef OAICreateEventDataStoreResponse_H
#define OAICreateEventDataStoreResponse_H
...
class OAICreateEventDataStoreResponse : public OAIObject {
public:
    OAICreateEventDataStoreResponse();
    OAICreateEventDataStoreResponse(QString json);
    ~OAICreateEventDataStoreResponse() override;
    ...
    OAIEventDataStoreStatus getStatus() const;
    void setStatus(const OAIEventDataStoreStatus &status);
    ...
    QList<OAITag> getTagsList() const;
    void setTagsList(const QList<OAITag> &tags_list);
...
private:
    ...
    OAIEventDataStoreStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDataStoreResponse)

#endif // OAICreateEventDataStoreResponse_H
