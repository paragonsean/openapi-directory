...
/*
 * OAIGetQueryResultsRequest.h
 *
 * 
 */

#ifndef OAIGetQueryResultsRequest_H
#define OAIGetQueryResultsRequest_H
...
class OAIGetQueryResultsRequest : public OAIObject {
public:
    OAIGetQueryResultsRequest();
    OAIGetQueryResultsRequest(QString json);
    ~OAIGetQueryResultsRequest() override;
    ...
    qint32 getMaxQueryResults() const;
    void setMaxQueryResults(const qint32 &max_query_results);
    bool is_max_query_results_Set() const;
    bool is_max_query_results_Valid() const;
...
private:
    ...
    qint32 m_max_query_results;
    bool m_max_query_results_isSet;
    bool m_max_query_results_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetQueryResultsRequest)

#endif // OAIGetQueryResultsRequest_H
