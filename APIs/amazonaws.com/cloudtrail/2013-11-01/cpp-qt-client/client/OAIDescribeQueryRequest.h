...
/*
 * OAIDescribeQueryRequest.h
 *
 * 
 */

#ifndef OAIDescribeQueryRequest_H
#define OAIDescribeQueryRequest_H
...
class OAIDescribeQueryRequest : public OAIObject {
public:
    OAIDescribeQueryRequest();
    OAIDescribeQueryRequest(QString json);
    ~OAIDescribeQueryRequest() override;
    ...
    QString getQueryAlias() const;
    void setQueryAlias(const QString &query_alias);
    bool is_query_alias_Set() const;
    bool is_query_alias_Valid() const;
...
private:
    ...
    QString m_query_alias;
    bool m_query_alias_isSet;
    bool m_query_alias_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeQueryRequest)

#endif // OAIDescribeQueryRequest_H
