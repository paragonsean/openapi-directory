...
/*
 * OAIDeleteChannelRequest.h
 *
 * 
 */

#ifndef OAIDeleteChannelRequest_H
#define OAIDeleteChannelRequest_H
...
class OAIDeleteChannelRequest : public OAIObject {
public:
    OAIDeleteChannelRequest();
    OAIDeleteChannelRequest(QString json);
    ~OAIDeleteChannelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteChannelRequest)

#endif // OAIDeleteChannelRequest_H
