...
/*
 * OAIDeleteTrailRequest.h
 *
 * The request that specifies the name of a trail to delete.
 */

#ifndef OAIDeleteTrailRequest_H
#define OAIDeleteTrailRequest_H
...
class OAIDeleteTrailRequest : public OAIObject {
public:
    OAIDeleteTrailRequest();
    OAIDeleteTrailRequest(QString json);
    ~OAIDeleteTrailRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTrailRequest)

#endif // OAIDeleteTrailRequest_H
