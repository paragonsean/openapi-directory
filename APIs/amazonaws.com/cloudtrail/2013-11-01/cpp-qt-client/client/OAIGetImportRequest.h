...
/*
 * OAIGetImportRequest.h
 *
 * 
 */

#ifndef OAIGetImportRequest_H
#define OAIGetImportRequest_H
...
class OAIGetImportRequest : public OAIObject {
public:
    OAIGetImportRequest();
    OAIGetImportRequest(QString json);
    ~OAIGetImportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImportRequest)

#endif // OAIGetImportRequest_H
