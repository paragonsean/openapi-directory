...
/*
 * OAIListImportFailuresRequest.h
 *
 * 
 */

#ifndef OAIListImportFailuresRequest_H
#define OAIListImportFailuresRequest_H
...
class OAIListImportFailuresRequest : public OAIObject {
public:
    OAIListImportFailuresRequest();
    OAIListImportFailuresRequest(QString json);
    ~OAIListImportFailuresRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListImportFailuresRequest)

#endif // OAIListImportFailuresRequest_H
