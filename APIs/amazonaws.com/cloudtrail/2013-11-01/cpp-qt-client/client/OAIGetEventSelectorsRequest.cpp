...
OAIGetEventSelectorsRequest::OAIGetEventSelectorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEventSelectorsRequest::OAIGetEventSelectorsRequest() {
    this->initializeModel();
}

OAIGetEventSelectorsRequest::~OAIGetEventSelectorsRequest() {}

void OAIGetEventSelectorsRequest::initializeModel() {

    m_trail_name_isSet = false;
    m_trail_name_isValid = false;
}

void OAIGetEventSelectorsRequest::fromJson(QString jsonString) {
...
void OAIGetEventSelectorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetEventSelectorsRequest::asJson() const {
...
QJsonObject OAIGetEventSelectorsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetEventSelectorsRequest::getTrailName() const {
    return m_trail_name;
}
void OAIGetEventSelectorsRequest::setTrailName(const QString &trail_name) {
    m_trail_name = trail_name;
    m_trail_name_isSet = true;
}

bool OAIGetEventSelectorsRequest::is_trail_name_Set() const{
    return m_trail_name_isSet;
}

bool OAIGetEventSelectorsRequest::is_trail_name_Valid() const{
    return m_trail_name_isValid;
}

bool OAIGetEventSelectorsRequest::isSet() const {
...
bool OAIGetEventSelectorsRequest::isValid() const {
