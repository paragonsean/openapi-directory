...
OAIUpdateEventDataStoreResponse::OAIUpdateEventDataStoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateEventDataStoreResponse::OAIUpdateEventDataStoreResponse() {
    this->initializeModel();
}

OAIUpdateEventDataStoreResponse::~OAIUpdateEventDataStoreResponse() {}

void OAIUpdateEventDataStoreResponse::initializeModel() {
...
void OAIUpdateEventDataStoreResponse::fromJson(QString jsonString) {
...
void OAIUpdateEventDataStoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateEventDataStoreResponse::asJson() const {
...
QJsonObject OAIUpdateEventDataStoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateEventDataStoreResponse::getEventDataStoreArn() const {
    return m_event_data_store_arn;
}
void OAIUpdateEventDataStoreResponse::setEventDataStoreArn(const QString &event_data_store_arn) {
    m_event_data_store_arn = event_data_store_arn;
    m_event_data_store_arn_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_event_data_store_arn_Set() const{
    return m_event_data_store_arn_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_event_data_store_arn_Valid() const{
    return m_event_data_store_arn_isValid;
}

QString OAIUpdateEventDataStoreResponse::getName() const {
    return m_name;
}
void OAIUpdateEventDataStoreResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIEventDataStoreStatus OAIUpdateEventDataStoreResponse::getStatus() const {
    return m_status;
}
void OAIUpdateEventDataStoreResponse::setStatus(const OAIEventDataStoreStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIUpdateEventDataStoreResponse::getAdvancedEventSelectors() const {
    return m_advanced_event_selectors;
}
void OAIUpdateEventDataStoreResponse::setAdvancedEventSelectors(const QList &advanced_event_selectors) {
    m_advanced_event_selectors = advanced_event_selectors;
    m_advanced_event_selectors_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_advanced_event_selectors_Set() const{
    return m_advanced_event_selectors_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_advanced_event_selectors_Valid() const{
    return m_advanced_event_selectors_isValid;
}

bool OAIUpdateEventDataStoreResponse::getMultiRegionEnabled() const {
    return m_multi_region_enabled;
}
void OAIUpdateEventDataStoreResponse::setMultiRegionEnabled(const bool &multi_region_enabled) {
    m_multi_region_enabled = multi_region_enabled;
    m_multi_region_enabled_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_multi_region_enabled_Set() const{
    return m_multi_region_enabled_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_multi_region_enabled_Valid() const{
    return m_multi_region_enabled_isValid;
}

bool OAIUpdateEventDataStoreResponse::getOrganizationEnabled() const {
    return m_organization_enabled;
}
void OAIUpdateEventDataStoreResponse::setOrganizationEnabled(const bool &organization_enabled) {
    m_organization_enabled = organization_enabled;
    m_organization_enabled_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_organization_enabled_Set() const{
    return m_organization_enabled_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_organization_enabled_Valid() const{
    return m_organization_enabled_isValid;
}

qint32 OAIUpdateEventDataStoreResponse::getRetentionPeriod() const {
    return m_retention_period;
}
void OAIUpdateEventDataStoreResponse::setRetentionPeriod(const qint32 &retention_period) {
    m_retention_period = retention_period;
    m_retention_period_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_retention_period_Set() const{
    return m_retention_period_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_retention_period_Valid() const{
    return m_retention_period_isValid;
}

bool OAIUpdateEventDataStoreResponse::getTerminationProtectionEnabled() const {
    return m_termination_protection_enabled;
}
void OAIUpdateEventDataStoreResponse::setTerminationProtectionEnabled(const bool &termination_protection_enabled) {
    m_termination_protection_enabled = termination_protection_enabled;
    m_termination_protection_enabled_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_termination_protection_enabled_Set() const{
    return m_termination_protection_enabled_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_termination_protection_enabled_Valid() const{
    return m_termination_protection_enabled_isValid;
}

QDateTime OAIUpdateEventDataStoreResponse::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIUpdateEventDataStoreResponse::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIUpdateEventDataStoreResponse::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIUpdateEventDataStoreResponse::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAIUpdateEventDataStoreResponse::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIUpdateEventDataStoreResponse::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIUpdateEventDataStoreResponse::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIUpdateEventDataStoreResponse::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIUpdateEventDataStoreResponse::isSet() const {
...
bool OAIUpdateEventDataStoreResponse::isValid() const {
