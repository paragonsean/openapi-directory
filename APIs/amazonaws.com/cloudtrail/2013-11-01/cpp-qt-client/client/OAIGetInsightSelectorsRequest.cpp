...
OAIGetInsightSelectorsRequest::OAIGetInsightSelectorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetInsightSelectorsRequest::OAIGetInsightSelectorsRequest() {
    this->initializeModel();
}

OAIGetInsightSelectorsRequest::~OAIGetInsightSelectorsRequest() {}

void OAIGetInsightSelectorsRequest::initializeModel() {

    m_trail_name_isSet = false;
    m_trail_name_isValid = false;
}

void OAIGetInsightSelectorsRequest::fromJson(QString jsonString) {
...
void OAIGetInsightSelectorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetInsightSelectorsRequest::asJson() const {
...
QJsonObject OAIGetInsightSelectorsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetInsightSelectorsRequest::getTrailName() const {
    return m_trail_name;
}
void OAIGetInsightSelectorsRequest::setTrailName(const QString &trail_name) {
    m_trail_name = trail_name;
    m_trail_name_isSet = true;
}

bool OAIGetInsightSelectorsRequest::is_trail_name_Set() const{
    return m_trail_name_isSet;
}

bool OAIGetInsightSelectorsRequest::is_trail_name_Valid() const{
    return m_trail_name_isValid;
}

bool OAIGetInsightSelectorsRequest::isSet() const {
...
bool OAIGetInsightSelectorsRequest::isValid() const {
