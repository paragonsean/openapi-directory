...
/*
 * OAIGetTrailRequest.h
 *
 * 
 */

#ifndef OAIGetTrailRequest_H
#define OAIGetTrailRequest_H
...
class OAIGetTrailRequest : public OAIObject {
public:
    OAIGetTrailRequest();
    OAIGetTrailRequest(QString json);
    ~OAIGetTrailRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTrailRequest)

#endif // OAIGetTrailRequest_H
