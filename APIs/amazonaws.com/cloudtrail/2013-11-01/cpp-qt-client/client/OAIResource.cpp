...
QString OAIResource::getResourceName() const {
    return m_resource_name;
}
void OAIResource::setResourceName(const QString &resource_name) {
    m_resource_name = resource_name;
    m_resource_name_isSet = true;
}

bool OAIResource::is_resource_name_Set() const{
    return m_resource_name_isSet;
}

bool OAIResource::is_resource_name_Valid() const{
