...
/*
 * OAIRestoreEventDataStoreRequest.h
 *
 * 
 */

#ifndef OAIRestoreEventDataStoreRequest_H
#define OAIRestoreEventDataStoreRequest_H
...
class OAIRestoreEventDataStoreRequest : public OAIObject {
public:
    OAIRestoreEventDataStoreRequest();
    OAIRestoreEventDataStoreRequest(QString json);
    ~OAIRestoreEventDataStoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreEventDataStoreRequest)

#endif // OAIRestoreEventDataStoreRequest_H
