...
#ifndef OAIEventDataStore_H
#define OAIEventDataStore_H
...
class OAIEventDataStore : public OAIObject {
public:
    OAIEventDataStore();
    OAIEventDataStore(QString json);
    ~OAIEventDataStore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventDataStore)

#endif // OAIEventDataStore_H
