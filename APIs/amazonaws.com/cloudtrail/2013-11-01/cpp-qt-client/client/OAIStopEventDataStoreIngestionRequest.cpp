...
OAIStopEventDataStoreIngestionRequest::OAIStopEventDataStoreIngestionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopEventDataStoreIngestionRequest::OAIStopEventDataStoreIngestionRequest() {
    this->initializeModel();
}

OAIStopEventDataStoreIngestionRequest::~OAIStopEventDataStoreIngestionRequest() {}

void OAIStopEventDataStoreIngestionRequest::initializeModel() {

    m_event_data_store_isSet = false;
    m_event_data_store_isValid = false;
}

void OAIStopEventDataStoreIngestionRequest::fromJson(QString jsonString) {
...
void OAIStopEventDataStoreIngestionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopEventDataStoreIngestionRequest::asJson() const {
...
QJsonObject OAIStopEventDataStoreIngestionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopEventDataStoreIngestionRequest::getEventDataStore() const {
    return m_event_data_store;
}
void OAIStopEventDataStoreIngestionRequest::setEventDataStore(const QString &event_data_store) {
    m_event_data_store = event_data_store;
    m_event_data_store_isSet = true;
}

bool OAIStopEventDataStoreIngestionRequest::is_event_data_store_Set() const{
    return m_event_data_store_isSet;
}

bool OAIStopEventDataStoreIngestionRequest::is_event_data_store_Valid() const{
    return m_event_data_store_isValid;
}

bool OAIStopEventDataStoreIngestionRequest::isSet() const {
...
bool OAIStopEventDataStoreIngestionRequest::isValid() const {
