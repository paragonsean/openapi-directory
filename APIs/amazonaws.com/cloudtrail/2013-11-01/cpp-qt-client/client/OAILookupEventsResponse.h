...
/*
 * OAILookupEventsResponse.h
 *
 * Contains a response to a LookupEvents action.
 */

#ifndef OAILookupEventsResponse_H
#define OAILookupEventsResponse_H
...
class OAILookupEventsResponse : public OAIObject {
public:
    OAILookupEventsResponse();
    OAILookupEventsResponse(QString json);
    ~OAILookupEventsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILookupEventsResponse)

#endif // OAILookupEventsResponse_H
