...
OAIUpdateTrailResponse::OAIUpdateTrailResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateTrailResponse::OAIUpdateTrailResponse() {
    this->initializeModel();
}

OAIUpdateTrailResponse::~OAIUpdateTrailResponse() {}

void OAIUpdateTrailResponse::initializeModel() {
...
void OAIUpdateTrailResponse::fromJson(QString jsonString) {
...
void OAIUpdateTrailResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateTrailResponse::asJson() const {
...
QJsonObject OAIUpdateTrailResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateTrailResponse::getName() const {
    return m_name;
}
void OAIUpdateTrailResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateTrailResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateTrailResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateTrailResponse::getS3BucketName() const {
    return m_s3_bucket_name;
}
void OAIUpdateTrailResponse::setS3BucketName(const QString &s3_bucket_name) {
    m_s3_bucket_name = s3_bucket_name;
    m_s3_bucket_name_isSet = true;
}

bool OAIUpdateTrailResponse::is_s3_bucket_name_Set() const{
    return m_s3_bucket_name_isSet;
}

bool OAIUpdateTrailResponse::is_s3_bucket_name_Valid() const{
    return m_s3_bucket_name_isValid;
}

QString OAIUpdateTrailResponse::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAIUpdateTrailResponse::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAIUpdateTrailResponse::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAIUpdateTrailResponse::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

QString OAIUpdateTrailResponse::getSnsTopicName() const {
    return m_sns_topic_name;
}
void OAIUpdateTrailResponse::setSnsTopicName(const QString &sns_topic_name) {
    m_sns_topic_name = sns_topic_name;
    m_sns_topic_name_isSet = true;
}

bool OAIUpdateTrailResponse::is_sns_topic_name_Set() const{
    return m_sns_topic_name_isSet;
}

bool OAIUpdateTrailResponse::is_sns_topic_name_Valid() const{
    return m_sns_topic_name_isValid;
}

QString OAIUpdateTrailResponse::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIUpdateTrailResponse::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIUpdateTrailResponse::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIUpdateTrailResponse::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

bool OAIUpdateTrailResponse::getIncludeGlobalServiceEvents() const {
    return m_include_global_service_events;
}
void OAIUpdateTrailResponse::setIncludeGlobalServiceEvents(const bool &include_global_service_events) {
    m_include_global_service_events = include_global_service_events;
    m_include_global_service_events_isSet = true;
}

bool OAIUpdateTrailResponse::is_include_global_service_events_Set() const{
    return m_include_global_service_events_isSet;
}

bool OAIUpdateTrailResponse::is_include_global_service_events_Valid() const{
    return m_include_global_service_events_isValid;
}

bool OAIUpdateTrailResponse::getIsMultiRegionTrail() const {
    return m_is_multi_region_trail;
}
void OAIUpdateTrailResponse::setIsMultiRegionTrail(const bool &is_multi_region_trail) {
    m_is_multi_region_trail = is_multi_region_trail;
    m_is_multi_region_trail_isSet = true;
}

bool OAIUpdateTrailResponse::is_is_multi_region_trail_Set() const{
    return m_is_multi_region_trail_isSet;
}

bool OAIUpdateTrailResponse::is_is_multi_region_trail_Valid() const{
    return m_is_multi_region_trail_isValid;
}

QString OAIUpdateTrailResponse::getTrailArn() const {
    return m_trail_arn;
}
void OAIUpdateTrailResponse::setTrailArn(const QString &trail_arn) {
    m_trail_arn = trail_arn;
    m_trail_arn_isSet = true;
}

bool OAIUpdateTrailResponse::is_trail_arn_Set() const{
    return m_trail_arn_isSet;
}

bool OAIUpdateTrailResponse::is_trail_arn_Valid() const{
    return m_trail_arn_isValid;
}

bool OAIUpdateTrailResponse::getLogFileValidationEnabled() const {
    return m_log_file_validation_enabled;
}
void OAIUpdateTrailResponse::setLogFileValidationEnabled(const bool &log_file_validation_enabled) {
    m_log_file_validation_enabled = log_file_validation_enabled;
    m_log_file_validation_enabled_isSet = true;
}

bool OAIUpdateTrailResponse::is_log_file_validation_enabled_Set() const{
    return m_log_file_validation_enabled_isSet;
}

bool OAIUpdateTrailResponse::is_log_file_validation_enabled_Valid() const{
    return m_log_file_validation_enabled_isValid;
}

QString OAIUpdateTrailResponse::getCloudWatchLogsLogGroupArn() const {
    return m_cloud_watch_logs_log_group_arn;
}
void OAIUpdateTrailResponse::setCloudWatchLogsLogGroupArn(const QString &cloud_watch_logs_log_group_arn) {
    m_cloud_watch_logs_log_group_arn = cloud_watch_logs_log_group_arn;
    m_cloud_watch_logs_log_group_arn_isSet = true;
}

bool OAIUpdateTrailResponse::is_cloud_watch_logs_log_group_arn_Set() const{
    return m_cloud_watch_logs_log_group_arn_isSet;
}

bool OAIUpdateTrailResponse::is_cloud_watch_logs_log_group_arn_Valid() const{
    return m_cloud_watch_logs_log_group_arn_isValid;
}

QString OAIUpdateTrailResponse::getCloudWatchLogsRoleArn() const {
    return m_cloud_watch_logs_role_arn;
}
void OAIUpdateTrailResponse::setCloudWatchLogsRoleArn(const QString &cloud_watch_logs_role_arn) {
    m_cloud_watch_logs_role_arn = cloud_watch_logs_role_arn;
    m_cloud_watch_logs_role_arn_isSet = true;
}

bool OAIUpdateTrailResponse::is_cloud_watch_logs_role_arn_Set() const{
    return m_cloud_watch_logs_role_arn_isSet;
}

bool OAIUpdateTrailResponse::is_cloud_watch_logs_role_arn_Valid() const{
    return m_cloud_watch_logs_role_arn_isValid;
}

QString OAIUpdateTrailResponse::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIUpdateTrailResponse::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIUpdateTrailResponse::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIUpdateTrailResponse::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIUpdateTrailResponse::getIsOrganizationTrail() const {
    return m_is_organization_trail;
}
void OAIUpdateTrailResponse::setIsOrganizationTrail(const bool &is_organization_trail) {
    m_is_organization_trail = is_organization_trail;
    m_is_organization_trail_isSet = true;
}

bool OAIUpdateTrailResponse::is_is_organization_trail_Set() const{
    return m_is_organization_trail_isSet;
}

bool OAIUpdateTrailResponse::is_is_organization_trail_Valid() const{
    return m_is_organization_trail_isValid;
}

bool OAIUpdateTrailResponse::isSet() const {
...
bool OAIUpdateTrailResponse::isValid() const {
