...
/*
 * OAIListEventDataStoresRequest.h
 *
 * 
 */

#ifndef OAIListEventDataStoresRequest_H
#define OAIListEventDataStoresRequest_H
...
class OAIListEventDataStoresRequest : public OAIObject {
public:
    OAIListEventDataStoresRequest();
    OAIListEventDataStoresRequest(QString json);
    ~OAIListEventDataStoresRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventDataStoresRequest)

#endif // OAIListEventDataStoresRequest_H
