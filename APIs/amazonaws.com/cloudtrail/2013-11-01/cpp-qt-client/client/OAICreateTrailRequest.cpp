...
OAICreateTrailRequest::OAICreateTrailRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateTrailRequest::OAICreateTrailRequest() {
    this->initializeModel();
}

OAICreateTrailRequest::~OAICreateTrailRequest() {}

void OAICreateTrailRequest::initializeModel() {
...
void OAICreateTrailRequest::fromJson(QString jsonString) {
...
void OAICreateTrailRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateTrailRequest::asJson() const {
...
QJsonObject OAICreateTrailRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateTrailRequest::getName() const {
    return m_name;
}
void OAICreateTrailRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateTrailRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateTrailRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateTrailRequest::getS3BucketName() const {
    return m_s3_bucket_name;
}
void OAICreateTrailRequest::setS3BucketName(const QString &s3_bucket_name) {
    m_s3_bucket_name = s3_bucket_name;
    m_s3_bucket_name_isSet = true;
}

bool OAICreateTrailRequest::is_s3_bucket_name_Set() const{
    return m_s3_bucket_name_isSet;
}

bool OAICreateTrailRequest::is_s3_bucket_name_Valid() const{
    return m_s3_bucket_name_isValid;
}

QString OAICreateTrailRequest::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAICreateTrailRequest::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAICreateTrailRequest::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAICreateTrailRequest::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

QString OAICreateTrailRequest::getSnsTopicName() const {
    return m_sns_topic_name;
}
void OAICreateTrailRequest::setSnsTopicName(const QString &sns_topic_name) {
    m_sns_topic_name = sns_topic_name;
    m_sns_topic_name_isSet = true;
}

bool OAICreateTrailRequest::is_sns_topic_name_Set() const{
    return m_sns_topic_name_isSet;
}

bool OAICreateTrailRequest::is_sns_topic_name_Valid() const{
    return m_sns_topic_name_isValid;
}

bool OAICreateTrailRequest::getIncludeGlobalServiceEvents() const {
    return m_include_global_service_events;
}
void OAICreateTrailRequest::setIncludeGlobalServiceEvents(const bool &include_global_service_events) {
    m_include_global_service_events = include_global_service_events;
    m_include_global_service_events_isSet = true;
}

bool OAICreateTrailRequest::is_include_global_service_events_Set() const{
    return m_include_global_service_events_isSet;
}

bool OAICreateTrailRequest::is_include_global_service_events_Valid() const{
    return m_include_global_service_events_isValid;
}

bool OAICreateTrailRequest::getIsMultiRegionTrail() const {
    return m_is_multi_region_trail;
}
void OAICreateTrailRequest::setIsMultiRegionTrail(const bool &is_multi_region_trail) {
    m_is_multi_region_trail = is_multi_region_trail;
    m_is_multi_region_trail_isSet = true;
}

bool OAICreateTrailRequest::is_is_multi_region_trail_Set() const{
    return m_is_multi_region_trail_isSet;
}

bool OAICreateTrailRequest::is_is_multi_region_trail_Valid() const{
    return m_is_multi_region_trail_isValid;
}

bool OAICreateTrailRequest::getEnableLogFileValidation() const {
    return m_enable_log_file_validation;
}
void OAICreateTrailRequest::setEnableLogFileValidation(const bool &enable_log_file_validation) {
    m_enable_log_file_validation = enable_log_file_validation;
    m_enable_log_file_validation_isSet = true;
}

bool OAICreateTrailRequest::is_enable_log_file_validation_Set() const{
    return m_enable_log_file_validation_isSet;
}

bool OAICreateTrailRequest::is_enable_log_file_validation_Valid() const{
    return m_enable_log_file_validation_isValid;
}

QString OAICreateTrailRequest::getCloudWatchLogsLogGroupArn() const {
    return m_cloud_watch_logs_log_group_arn;
}
void OAICreateTrailRequest::setCloudWatchLogsLogGroupArn(const QString &cloud_watch_logs_log_group_arn) {
    m_cloud_watch_logs_log_group_arn = cloud_watch_logs_log_group_arn;
    m_cloud_watch_logs_log_group_arn_isSet = true;
}

bool OAICreateTrailRequest::is_cloud_watch_logs_log_group_arn_Set() const{
    return m_cloud_watch_logs_log_group_arn_isSet;
}

bool OAICreateTrailRequest::is_cloud_watch_logs_log_group_arn_Valid() const{
    return m_cloud_watch_logs_log_group_arn_isValid;
}

QString OAICreateTrailRequest::getCloudWatchLogsRoleArn() const {
    return m_cloud_watch_logs_role_arn;
}
void OAICreateTrailRequest::setCloudWatchLogsRoleArn(const QString &cloud_watch_logs_role_arn) {
    m_cloud_watch_logs_role_arn = cloud_watch_logs_role_arn;
    m_cloud_watch_logs_role_arn_isSet = true;
}

bool OAICreateTrailRequest::is_cloud_watch_logs_role_arn_Set() const{
    return m_cloud_watch_logs_role_arn_isSet;
}

bool OAICreateTrailRequest::is_cloud_watch_logs_role_arn_Valid() const{
    return m_cloud_watch_logs_role_arn_isValid;
}

QString OAICreateTrailRequest::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAICreateTrailRequest::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAICreateTrailRequest::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAICreateTrailRequest::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAICreateTrailRequest::getIsOrganizationTrail() const {
    return m_is_organization_trail;
}
void OAICreateTrailRequest::setIsOrganizationTrail(const bool &is_organization_trail) {
    m_is_organization_trail = is_organization_trail;
    m_is_organization_trail_isSet = true;
}

bool OAICreateTrailRequest::is_is_organization_trail_Set() const{
    return m_is_organization_trail_isSet;
}

bool OAICreateTrailRequest::is_is_organization_trail_Valid() const{
    return m_is_organization_trail_isValid;
}

QList<OAITag> OAICreateTrailRequest::getTagsList() const {
    return m_tags_list;
}
void OAICreateTrailRequest::setTagsList(const QList<OAITag> &tags_list) {
    m_tags_list = tags_list;
    m_tags_list_isSet = true;
}

bool OAICreateTrailRequest::is_tags_list_Set() const{
    return m_tags_list_isSet;
}

bool OAICreateTrailRequest::is_tags_list_Valid() const{
    return m_tags_list_isValid;
}

bool OAICreateTrailRequest::isSet() const {
...
bool OAICreateTrailRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_name_isValid && m_s3_bucket_name_isValid && true;
}
