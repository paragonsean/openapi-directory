...
/*
 * OAIImportSource_S3.h
 *
 * 
 */

#ifndef OAIImportSource_S3_H
#define OAIImportSource_S3_H
...
class OAIImportSource_S3 : public OAIObject {
public:
    OAIImportSource_S3();
    OAIImportSource_S3(QString json);
    ~OAIImportSource_S3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportSource_S3)

#endif // OAIImportSource_S3_H
