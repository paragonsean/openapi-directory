...
/*
 * OAIStartEventDataStoreIngestionRequest.h
 *
 * 
 */

#ifndef OAIStartEventDataStoreIngestionRequest_H
#define OAIStartEventDataStoreIngestionRequest_H
...
class OAIStartEventDataStoreIngestionRequest : public OAIObject {
public:
    OAIStartEventDataStoreIngestionRequest();
    OAIStartEventDataStoreIngestionRequest(QString json);
    ~OAIStartEventDataStoreIngestionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartEventDataStoreIngestionRequest)

#endif // OAIStartEventDataStoreIngestionRequest_H
