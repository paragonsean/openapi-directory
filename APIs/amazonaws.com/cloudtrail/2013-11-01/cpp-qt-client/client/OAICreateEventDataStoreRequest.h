...
/*
 * OAICreateEventDataStoreRequest.h
 *
 * 
 */

#ifndef OAICreateEventDataStoreRequest_H
#define OAICreateEventDataStoreRequest_H
...
class OAICreateEventDataStoreRequest : public OAIObject {
public:
    OAICreateEventDataStoreRequest();
    OAICreateEventDataStoreRequest(QString json);
    ~OAICreateEventDataStoreRequest() override;
    ...
    void setStartIngestion(const bool &start_ingestion);
    bool is_start_ingestion_Set() const;
    bool is_start_ingestion_Valid() const;
...
private:
    ...
    bool m_start_ingestion;
    bool m_start_ingestion_isSet;
    bool m_start_ingestion_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateEventDataStoreRequest)

#endif // OAICreateEventDataStoreRequest_H
