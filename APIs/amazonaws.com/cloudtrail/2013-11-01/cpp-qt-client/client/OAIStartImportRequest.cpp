...
QList OAIStartImportRequest::getDestinations() const {
    return m_destinations;
}
void OAIStartImportRequest::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIStartImportRequest::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIStartImportRequest::is_destinations_Valid() const{
    return m_destinations_isValid;
}

OAIStartImportRequest_ImportSource OAIStartImportRequest::getImportSource() const {
    return m_import_source;
}
void OAIStartImportRequest::setImportSource(const OAIStartImportRequest_ImportSource &import_source) {
    m_import_source = import_source;
    m_import_source_isSet = true;
}

bool OAIStartImportRequest::is_import_source_Set() const{
    return m_import_source_isSet;
}

bool OAIStartImportRequest::is_import_source_Valid() const{
    return m_import_source_isValid;
}

QDateTime OAIStartImportRequest::getStartEventTime() const {
    return m_start_event_time;
}
void OAIStartImportRequest::setStartEventTime(const QDateTime &start_event_time) {
    m_start_event_time = start_event_time;
    m_start_event_time_isSet = true;
}

bool OAIStartImportRequest::is_start_event_time_Set() const{
    return m_start_event_time_isSet;
}

bool OAIStartImportRequest::is_start_event_time_Valid() const{
    return m_start_event_time_isValid;
}

QDateTime OAIStartImportRequest::getEndEventTime() const {
    return m_end_event_time;
}
void OAIStartImportRequest::setEndEventTime(const QDateTime &end_event_time) {
    m_end_event_time = end_event_time;
    m_end_event_time_isSet = true;
}

bool OAIStartImportRequest::is_end_event_time_Set() const{
    return m_end_event_time_isSet;
}

bool OAIStartImportRequest::is_end_event_time_Valid() const{
