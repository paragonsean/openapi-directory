...
QString OAIGetResourcePolicyResponse::getResourceArn() const {
    return m_resource_arn;
}
void OAIGetResourcePolicyResponse::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIGetResourcePolicyResponse::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIGetResourcePolicyResponse::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIGetResourcePolicyResponse::getResourcePolicy() const {
    return m_resource_policy;
}
void OAIGetResourcePolicyResponse::setResourcePolicy(const QString &resource_policy) {
    m_resource_policy = resource_policy;
    m_resource_policy_isSet = true;
}

bool OAIGetResourcePolicyResponse::is_resource_policy_Set() const{
    return m_resource_policy_isSet;
}

bool OAIGetResourcePolicyResponse::is_resource_policy_Valid() const{
