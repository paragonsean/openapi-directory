...
OAIGetImportRequest::OAIGetImportRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImportRequest::OAIGetImportRequest() {
    this->initializeModel();
}

OAIGetImportRequest::~OAIGetImportRequest() {}

void OAIGetImportRequest::initializeModel() {

    m_import_id_isSet = false;
    m_import_id_isValid = false;
}

void OAIGetImportRequest::fromJson(QString jsonString) {
...
void OAIGetImportRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetImportRequest::asJson() const {
...
QJsonObject OAIGetImportRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetImportRequest::getImportId() const {
    return m_import_id;
}
void OAIGetImportRequest::setImportId(const QString &import_id) {
    m_import_id = import_id;
    m_import_id_isSet = true;
}

bool OAIGetImportRequest::is_import_id_Set() const{
    return m_import_id_isSet;
}

bool OAIGetImportRequest::is_import_id_Valid() const{
    return m_import_id_isValid;
}

bool OAIGetImportRequest::isSet() const {
...
bool OAIGetImportRequest::isValid() const {
