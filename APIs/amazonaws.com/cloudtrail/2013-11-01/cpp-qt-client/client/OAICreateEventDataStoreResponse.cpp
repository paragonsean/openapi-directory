...
OAICreateEventDataStoreResponse::OAICreateEventDataStoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateEventDataStoreResponse::OAICreateEventDataStoreResponse() {
    this->initializeModel();
}

OAICreateEventDataStoreResponse::~OAICreateEventDataStoreResponse() {}

void OAICreateEventDataStoreResponse::initializeModel() {
...
void OAICreateEventDataStoreResponse::fromJson(QString jsonString) {
...
void OAICreateEventDataStoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateEventDataStoreResponse::asJson() const {
...
QJsonObject OAICreateEventDataStoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateEventDataStoreResponse::getEventDataStoreArn() const {
    return m_event_data_store_arn;
}
void OAICreateEventDataStoreResponse::setEventDataStoreArn(const QString &event_data_store_arn) {
    m_event_data_store_arn = event_data_store_arn;
    m_event_data_store_arn_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_event_data_store_arn_Set() const{
    return m_event_data_store_arn_isSet;
}

bool OAICreateEventDataStoreResponse::is_event_data_store_arn_Valid() const{
    return m_event_data_store_arn_isValid;
}

QString OAICreateEventDataStoreResponse::getName() const {
    return m_name;
}
void OAICreateEventDataStoreResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateEventDataStoreResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIEventDataStoreStatus OAICreateEventDataStoreResponse::getStatus() const {
    return m_status;
}
void OAICreateEventDataStoreResponse::setStatus(const OAIEventDataStoreStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateEventDataStoreResponse::is_status_Valid() const{
    return m_status_isValid;
}

QList OAICreateEventDataStoreResponse::getAdvancedEventSelectors() const {
    return m_advanced_event_selectors;
}
void OAICreateEventDataStoreResponse::setAdvancedEventSelectors(const QList &advanced_event_selectors) {
    m_advanced_event_selectors = advanced_event_selectors;
    m_advanced_event_selectors_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_advanced_event_selectors_Set() const{
    return m_advanced_event_selectors_isSet;
}

bool OAICreateEventDataStoreResponse::is_advanced_event_selectors_Valid() const{
    return m_advanced_event_selectors_isValid;
}

bool OAICreateEventDataStoreResponse::getMultiRegionEnabled() const {
    return m_multi_region_enabled;
}
void OAICreateEventDataStoreResponse::setMultiRegionEnabled(const bool &multi_region_enabled) {
    m_multi_region_enabled = multi_region_enabled;
    m_multi_region_enabled_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_multi_region_enabled_Set() const{
    return m_multi_region_enabled_isSet;
}

bool OAICreateEventDataStoreResponse::is_multi_region_enabled_Valid() const{
    return m_multi_region_enabled_isValid;
}

bool OAICreateEventDataStoreResponse::getOrganizationEnabled() const {
    return m_organization_enabled;
}
void OAICreateEventDataStoreResponse::setOrganizationEnabled(const bool &organization_enabled) {
    m_organization_enabled = organization_enabled;
    m_organization_enabled_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_organization_enabled_Set() const{
    return m_organization_enabled_isSet;
}

bool OAICreateEventDataStoreResponse::is_organization_enabled_Valid() const{
    return m_organization_enabled_isValid;
}

qint32 OAICreateEventDataStoreResponse::getRetentionPeriod() const {
    return m_retention_period;
}
void OAICreateEventDataStoreResponse::setRetentionPeriod(const qint32 &retention_period) {
    m_retention_period = retention_period;
    m_retention_period_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_retention_period_Set() const{
    return m_retention_period_isSet;
}

bool OAICreateEventDataStoreResponse::is_retention_period_Valid() const{
    return m_retention_period_isValid;
}

bool OAICreateEventDataStoreResponse::getTerminationProtectionEnabled() const {
    return m_termination_protection_enabled;
}
void OAICreateEventDataStoreResponse::setTerminationProtectionEnabled(const bool &termination_protection_enabled) {
    m_termination_protection_enabled = termination_protection_enabled;
    m_termination_protection_enabled_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_termination_protection_enabled_Set() const{
    return m_termination_protection_enabled_isSet;
}

bool OAICreateEventDataStoreResponse::is_termination_protection_enabled_Valid() const{
    return m_termination_protection_enabled_isValid;
}

QList<OAITag> OAICreateEventDataStoreResponse::getTagsList() const {
    return m_tags_list;
}
void OAICreateEventDataStoreResponse::setTagsList(const QList<OAITag> &tags_list) {
    m_tags_list = tags_list;
    m_tags_list_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_tags_list_Set() const{
    return m_tags_list_isSet;
}

bool OAICreateEventDataStoreResponse::is_tags_list_Valid() const{
    return m_tags_list_isValid;
}

QDateTime OAICreateEventDataStoreResponse::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAICreateEventDataStoreResponse::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAICreateEventDataStoreResponse::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAICreateEventDataStoreResponse::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAICreateEventDataStoreResponse::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAICreateEventDataStoreResponse::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAICreateEventDataStoreResponse::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAICreateEventDataStoreResponse::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAICreateEventDataStoreResponse::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAICreateEventDataStoreResponse::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAICreateEventDataStoreResponse::isSet() const {
...
bool OAICreateEventDataStoreResponse::isValid() const {
