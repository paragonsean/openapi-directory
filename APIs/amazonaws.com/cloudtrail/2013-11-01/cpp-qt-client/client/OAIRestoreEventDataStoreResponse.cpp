...
OAIRestoreEventDataStoreResponse::OAIRestoreEventDataStoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreEventDataStoreResponse::OAIRestoreEventDataStoreResponse() {
    this->initializeModel();
}

OAIRestoreEventDataStoreResponse::~OAIRestoreEventDataStoreResponse() {}

void OAIRestoreEventDataStoreResponse::initializeModel() {
...
void OAIRestoreEventDataStoreResponse::fromJson(QString jsonString) {
...
void OAIRestoreEventDataStoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreEventDataStoreResponse::asJson() const {
...
QJsonObject OAIRestoreEventDataStoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRestoreEventDataStoreResponse::getEventDataStoreArn() const {
    return m_event_data_store_arn;
}
void OAIRestoreEventDataStoreResponse::setEventDataStoreArn(const QString &event_data_store_arn) {
    m_event_data_store_arn = event_data_store_arn;
    m_event_data_store_arn_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_event_data_store_arn_Set() const{
    return m_event_data_store_arn_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_event_data_store_arn_Valid() const{
    return m_event_data_store_arn_isValid;
}

QString OAIRestoreEventDataStoreResponse::getName() const {
    return m_name;
}
void OAIRestoreEventDataStoreResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIEventDataStoreStatus OAIRestoreEventDataStoreResponse::getStatus() const {
    return m_status;
}
void OAIRestoreEventDataStoreResponse::setStatus(const OAIEventDataStoreStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIRestoreEventDataStoreResponse::getAdvancedEventSelectors() const {
    return m_advanced_event_selectors;
}
void OAIRestoreEventDataStoreResponse::setAdvancedEventSelectors(const QList &advanced_event_selectors) {
    m_advanced_event_selectors = advanced_event_selectors;
    m_advanced_event_selectors_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_advanced_event_selectors_Set() const{
    return m_advanced_event_selectors_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_advanced_event_selectors_Valid() const{
    return m_advanced_event_selectors_isValid;
}

bool OAIRestoreEventDataStoreResponse::getMultiRegionEnabled() const {
    return m_multi_region_enabled;
}
void OAIRestoreEventDataStoreResponse::setMultiRegionEnabled(const bool &multi_region_enabled) {
    m_multi_region_enabled = multi_region_enabled;
    m_multi_region_enabled_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_multi_region_enabled_Set() const{
    return m_multi_region_enabled_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_multi_region_enabled_Valid() const{
    return m_multi_region_enabled_isValid;
}

bool OAIRestoreEventDataStoreResponse::getOrganizationEnabled() const {
    return m_organization_enabled;
}
void OAIRestoreEventDataStoreResponse::setOrganizationEnabled(const bool &organization_enabled) {
    m_organization_enabled = organization_enabled;
    m_organization_enabled_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_organization_enabled_Set() const{
    return m_organization_enabled_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_organization_enabled_Valid() const{
    return m_organization_enabled_isValid;
}

qint32 OAIRestoreEventDataStoreResponse::getRetentionPeriod() const {
    return m_retention_period;
}
void OAIRestoreEventDataStoreResponse::setRetentionPeriod(const qint32 &retention_period) {
    m_retention_period = retention_period;
    m_retention_period_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_retention_period_Set() const{
    return m_retention_period_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_retention_period_Valid() const{
    return m_retention_period_isValid;
}

bool OAIRestoreEventDataStoreResponse::getTerminationProtectionEnabled() const {
    return m_termination_protection_enabled;
}
void OAIRestoreEventDataStoreResponse::setTerminationProtectionEnabled(const bool &termination_protection_enabled) {
    m_termination_protection_enabled = termination_protection_enabled;
    m_termination_protection_enabled_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_termination_protection_enabled_Set() const{
    return m_termination_protection_enabled_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_termination_protection_enabled_Valid() const{
    return m_termination_protection_enabled_isValid;
}

QDateTime OAIRestoreEventDataStoreResponse::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIRestoreEventDataStoreResponse::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIRestoreEventDataStoreResponse::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIRestoreEventDataStoreResponse::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAIRestoreEventDataStoreResponse::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIRestoreEventDataStoreResponse::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIRestoreEventDataStoreResponse::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIRestoreEventDataStoreResponse::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIRestoreEventDataStoreResponse::isSet() const {
...
bool OAIRestoreEventDataStoreResponse::isValid() const {
