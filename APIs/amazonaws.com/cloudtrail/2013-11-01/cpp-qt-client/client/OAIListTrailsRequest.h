...
/*
 * OAIListTrailsRequest.h
 *
 * 
 */

#ifndef OAIListTrailsRequest_H
#define OAIListTrailsRequest_H
...
class OAIListTrailsRequest : public OAIObject {
public:
    OAIListTrailsRequest();
    OAIListTrailsRequest(QString json);
    ~OAIListTrailsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListTrailsRequest)

#endif // OAIListTrailsRequest_H
