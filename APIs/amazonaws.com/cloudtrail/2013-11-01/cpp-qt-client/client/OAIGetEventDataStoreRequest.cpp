...
OAIGetEventDataStoreRequest::OAIGetEventDataStoreRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEventDataStoreRequest::OAIGetEventDataStoreRequest() {
    this->initializeModel();
}

OAIGetEventDataStoreRequest::~OAIGetEventDataStoreRequest() {}

void OAIGetEventDataStoreRequest::initializeModel() {

    m_event_data_store_isSet = false;
    m_event_data_store_isValid = false;
}

void OAIGetEventDataStoreRequest::fromJson(QString jsonString) {
...
void OAIGetEventDataStoreRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetEventDataStoreRequest::asJson() const {
...
QJsonObject OAIGetEventDataStoreRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetEventDataStoreRequest::getEventDataStore() const {
    return m_event_data_store;
}
void OAIGetEventDataStoreRequest::setEventDataStore(const QString &event_data_store) {
    m_event_data_store = event_data_store;
    m_event_data_store_isSet = true;
}

bool OAIGetEventDataStoreRequest::is_event_data_store_Set() const{
    return m_event_data_store_isSet;
}

bool OAIGetEventDataStoreRequest::is_event_data_store_Valid() const{
    return m_event_data_store_isValid;
}

bool OAIGetEventDataStoreRequest::isSet() const {
...
bool OAIGetEventDataStoreRequest::isValid() const {
