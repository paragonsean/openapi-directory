...
/*
 * OAIGetChannelResponse_SourceConfig.h
 *
 * 
 */

#ifndef OAIGetChannelResponse_SourceConfig_H
#define OAIGetChannelResponse_SourceConfig_H
...
class OAIGetChannelResponse_SourceConfig : public OAIObject {
public:
    OAIGetChannelResponse_SourceConfig();
    OAIGetChannelResponse_SourceConfig(QString json);
    ~OAIGetChannelResponse_SourceConfig() override;
    ...
    void setApplyToAllRegions(const bool &apply_to_all_regions);
    bool is_apply_to_all_regions_Set() const;
    bool is_apply_to_all_regions_Valid() const;
...
private:
    ...
    bool m_apply_to_all_regions;
    bool m_apply_to_all_regions_isSet;
    bool m_apply_to_all_regions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChannelResponse_SourceConfig)

#endif // OAIGetChannelResponse_SourceConfig_H
