...
OAIGetEventDataStoreResponse::OAIGetEventDataStoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEventDataStoreResponse::OAIGetEventDataStoreResponse() {
    this->initializeModel();
}

OAIGetEventDataStoreResponse::~OAIGetEventDataStoreResponse() {}

void OAIGetEventDataStoreResponse::initializeModel() {
...
void OAIGetEventDataStoreResponse::fromJson(QString jsonString) {
...
void OAIGetEventDataStoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetEventDataStoreResponse::asJson() const {
...
QJsonObject OAIGetEventDataStoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetEventDataStoreResponse::getEventDataStoreArn() const {
    return m_event_data_store_arn;
}
void OAIGetEventDataStoreResponse::setEventDataStoreArn(const QString &event_data_store_arn) {
    m_event_data_store_arn = event_data_store_arn;
    m_event_data_store_arn_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_event_data_store_arn_Set() const{
    return m_event_data_store_arn_isSet;
}

bool OAIGetEventDataStoreResponse::is_event_data_store_arn_Valid() const{
    return m_event_data_store_arn_isValid;
}

QString OAIGetEventDataStoreResponse::getName() const {
    return m_name;
}
void OAIGetEventDataStoreResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetEventDataStoreResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIEventDataStoreStatus OAIGetEventDataStoreResponse::getStatus() const {
    return m_status;
}
void OAIGetEventDataStoreResponse::setStatus(const OAIEventDataStoreStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetEventDataStoreResponse::is_status_Valid() const{
    return m_status_isValid;
}

QList OAIGetEventDataStoreResponse::getAdvancedEventSelectors() const {
    return m_advanced_event_selectors;
}
void OAIGetEventDataStoreResponse::setAdvancedEventSelectors(const QList &advanced_event_selectors) {
    m_advanced_event_selectors = advanced_event_selectors;
    m_advanced_event_selectors_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_advanced_event_selectors_Set() const{
    return m_advanced_event_selectors_isSet;
}

bool OAIGetEventDataStoreResponse::is_advanced_event_selectors_Valid() const{
    return m_advanced_event_selectors_isValid;
}

bool OAIGetEventDataStoreResponse::getMultiRegionEnabled() const {
    return m_multi_region_enabled;
}
void OAIGetEventDataStoreResponse::setMultiRegionEnabled(const bool &multi_region_enabled) {
    m_multi_region_enabled = multi_region_enabled;
    m_multi_region_enabled_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_multi_region_enabled_Set() const{
    return m_multi_region_enabled_isSet;
}

bool OAIGetEventDataStoreResponse::is_multi_region_enabled_Valid() const{
    return m_multi_region_enabled_isValid;
}

bool OAIGetEventDataStoreResponse::getOrganizationEnabled() const {
    return m_organization_enabled;
}
void OAIGetEventDataStoreResponse::setOrganizationEnabled(const bool &organization_enabled) {
    m_organization_enabled = organization_enabled;
    m_organization_enabled_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_organization_enabled_Set() const{
    return m_organization_enabled_isSet;
}

bool OAIGetEventDataStoreResponse::is_organization_enabled_Valid() const{
    return m_organization_enabled_isValid;
}

qint32 OAIGetEventDataStoreResponse::getRetentionPeriod() const {
    return m_retention_period;
}
void OAIGetEventDataStoreResponse::setRetentionPeriod(const qint32 &retention_period) {
    m_retention_period = retention_period;
    m_retention_period_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_retention_period_Set() const{
    return m_retention_period_isSet;
}

bool OAIGetEventDataStoreResponse::is_retention_period_Valid() const{
    return m_retention_period_isValid;
}

bool OAIGetEventDataStoreResponse::getTerminationProtectionEnabled() const {
    return m_termination_protection_enabled;
}
void OAIGetEventDataStoreResponse::setTerminationProtectionEnabled(const bool &termination_protection_enabled) {
    m_termination_protection_enabled = termination_protection_enabled;
    m_termination_protection_enabled_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_termination_protection_enabled_Set() const{
    return m_termination_protection_enabled_isSet;
}

bool OAIGetEventDataStoreResponse::is_termination_protection_enabled_Valid() const{
    return m_termination_protection_enabled_isValid;
}

QDateTime OAIGetEventDataStoreResponse::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIGetEventDataStoreResponse::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIGetEventDataStoreResponse::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIGetEventDataStoreResponse::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIGetEventDataStoreResponse::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIGetEventDataStoreResponse::is_updated_timestamp_Valid() const{
    return m_updated_timestamp_isValid;
}

QString OAIGetEventDataStoreResponse::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIGetEventDataStoreResponse::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIGetEventDataStoreResponse::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIGetEventDataStoreResponse::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIGetEventDataStoreResponse::isSet() const {
...
bool OAIGetEventDataStoreResponse::isValid() const {
