...
/*
 * OAIGetEventDataStoreRequest.h
 *
 * 
 */

#ifndef OAIGetEventDataStoreRequest_H
#define OAIGetEventDataStoreRequest_H
...
class OAIGetEventDataStoreRequest : public OAIObject {
public:
    OAIGetEventDataStoreRequest();
    OAIGetEventDataStoreRequest(QString json);
    ~OAIGetEventDataStoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventDataStoreRequest)

#endif // OAIGetEventDataStoreRequest_H
