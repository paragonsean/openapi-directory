...
/*
 * OAIGetEventDataStoreResponse.h
 *
 * 
 */

#ifndef OAIGetEventDataStoreResponse_H
#define OAIGetEventDataStoreResponse_H
...
class OAIGetEventDataStoreResponse : public OAIObject {
public:
    OAIGetEventDataStoreResponse();
    OAIGetEventDataStoreResponse(QString json);
    ~OAIGetEventDataStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEventDataStoreResponse)

#endif // OAIGetEventDataStoreResponse_H
