...
QString OAICreateChannelResponse::getChannelArn() const {
    return m_channel_arn;
}
void OAICreateChannelResponse::setChannelArn(const QString &channel_arn) {
    m_channel_arn = channel_arn;
    m_channel_arn_isSet = true;
}

bool OAICreateChannelResponse::is_channel_arn_Set() const{
    return m_channel_arn_isSet;
}

bool OAICreateChannelResponse::is_channel_arn_Valid() const{
    return m_channel_arn_isValid;
}

QString OAICreateChannelResponse::getName() const {
    return m_name;
}
void OAICreateChannelResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateChannelResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateChannelResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateChannelResponse::getSource() const {
    return m_source;
}
void OAICreateChannelResponse::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAICreateChannelResponse::is_source_Set() const{
    return m_source_isSet;
}

bool OAICreateChannelResponse::is_source_Valid() const{
    return m_source_isValid;
}

QList OAICreateChannelResponse::getDestinations() const {
    return m_destinations;
}
void OAICreateChannelResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAICreateChannelResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAICreateChannelResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

QList<OAITag> OAICreateChannelResponse::getTags() const {
    return m_tags;
}
void OAICreateChannelResponse::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
