...
QList OAIStartImportResponse::getDestinations() const {
    return m_destinations;
}
void OAIStartImportResponse::setDestinations(const QList &destinations) {
    m_destinations = destinations;
    m_destinations_isSet = true;
}

bool OAIStartImportResponse::is_destinations_Set() const{
    return m_destinations_isSet;
}

bool OAIStartImportResponse::is_destinations_Valid() const{
    return m_destinations_isValid;
}

OAIStartImportResponse_ImportSource OAIStartImportResponse::getImportSource() const {
    return m_import_source;
}
void OAIStartImportResponse::setImportSource(const OAIStartImportResponse_ImportSource &import_source) {
    m_import_source = import_source;
    m_import_source_isSet = true;
}

bool OAIStartImportResponse::is_import_source_Set() const{
    return m_import_source_isSet;
}

bool OAIStartImportResponse::is_import_source_Valid() const{
    return m_import_source_isValid;
}

QDateTime OAIStartImportResponse::getStartEventTime() const {
    return m_start_event_time;
}
void OAIStartImportResponse::setStartEventTime(const QDateTime &start_event_time) {
    m_start_event_time = start_event_time;
    m_start_event_time_isSet = true;
}

bool OAIStartImportResponse::is_start_event_time_Set() const{
    return m_start_event_time_isSet;
}

bool OAIStartImportResponse::is_start_event_time_Valid() const{
    return m_start_event_time_isValid;
}

QDateTime OAIStartImportResponse::getEndEventTime() const {
    return m_end_event_time;
}
void OAIStartImportResponse::setEndEventTime(const QDateTime &end_event_time) {
    m_end_event_time = end_event_time;
    m_end_event_time_isSet = true;
}

bool OAIStartImportResponse::is_end_event_time_Set() const{
    return m_end_event_time_isSet;
}

bool OAIStartImportResponse::is_end_event_time_Valid() const{
...
QDateTime OAIStartImportResponse::getCreatedTimestamp() const {
    return m_created_timestamp;
}
void OAIStartImportResponse::setCreatedTimestamp(const QDateTime &created_timestamp) {
    m_created_timestamp = created_timestamp;
    m_created_timestamp_isSet = true;
}

bool OAIStartImportResponse::is_created_timestamp_Set() const{
    return m_created_timestamp_isSet;
}

bool OAIStartImportResponse::is_created_timestamp_Valid() const{
    return m_created_timestamp_isValid;
}

QDateTime OAIStartImportResponse::getUpdatedTimestamp() const {
    return m_updated_timestamp;
}
void OAIStartImportResponse::setUpdatedTimestamp(const QDateTime &updated_timestamp) {
    m_updated_timestamp = updated_timestamp;
    m_updated_timestamp_isSet = true;
}

bool OAIStartImportResponse::is_updated_timestamp_Set() const{
    return m_updated_timestamp_isSet;
}

bool OAIStartImportResponse::is_updated_timestamp_Valid() const{
