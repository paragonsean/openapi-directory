...
OAIImportStatistics::OAIImportStatistics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportStatistics::OAIImportStatistics() {
    this->initializeModel();
}

OAIImportStatistics::~OAIImportStatistics() {}

void OAIImportStatistics::initializeModel() {
...
void OAIImportStatistics::fromJson(QString jsonString) {
...
void OAIImportStatistics::fromJsonObject(QJsonObject json) {
...
QString OAIImportStatistics::asJson() const {
...
QJsonObject OAIImportStatistics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIImportStatistics::getPrefixesFound() const {
    return m_prefixes_found;
}
void OAIImportStatistics::setPrefixesFound(const qint32 &prefixes_found) {
    m_prefixes_found = prefixes_found;
    m_prefixes_found_isSet = true;
}

bool OAIImportStatistics::is_prefixes_found_Set() const{
    return m_prefixes_found_isSet;
}

bool OAIImportStatistics::is_prefixes_found_Valid() const{
    return m_prefixes_found_isValid;
}

qint32 OAIImportStatistics::getPrefixesCompleted() const {
    return m_prefixes_completed;
}
void OAIImportStatistics::setPrefixesCompleted(const qint32 &prefixes_completed) {
    m_prefixes_completed = prefixes_completed;
    m_prefixes_completed_isSet = true;
}

bool OAIImportStatistics::is_prefixes_completed_Set() const{
    return m_prefixes_completed_isSet;
}

bool OAIImportStatistics::is_prefixes_completed_Valid() const{
    return m_prefixes_completed_isValid;
}

qint32 OAIImportStatistics::getFilesCompleted() const {
    return m_files_completed;
}
void OAIImportStatistics::setFilesCompleted(const qint32 &files_completed) {
    m_files_completed = files_completed;
    m_files_completed_isSet = true;
}

bool OAIImportStatistics::is_files_completed_Set() const{
    return m_files_completed_isSet;
}

bool OAIImportStatistics::is_files_completed_Valid() const{
    return m_files_completed_isValid;
}

qint32 OAIImportStatistics::getEventsCompleted() const {
    return m_events_completed;
}
void OAIImportStatistics::setEventsCompleted(const qint32 &events_completed) {
    m_events_completed = events_completed;
    m_events_completed_isSet = true;
}

bool OAIImportStatistics::is_events_completed_Set() const{
    return m_events_completed_isSet;
}

bool OAIImportStatistics::is_events_completed_Valid() const{
    return m_events_completed_isValid;
}

qint32 OAIImportStatistics::getFailedEntries() const {
    return m_failed_entries;
}
void OAIImportStatistics::setFailedEntries(const qint32 &failed_entries) {
    m_failed_entries = failed_entries;
    m_failed_entries_isSet = true;
}

bool OAIImportStatistics::is_failed_entries_Set() const{
    return m_failed_entries_isSet;
}

bool OAIImportStatistics::is_failed_entries_Valid() const{
    return m_failed_entries_isValid;
}

bool OAIImportStatistics::isSet() const {
...
bool OAIImportStatistics::isValid() const {
