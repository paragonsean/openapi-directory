...
/*
 * OAICancelQueryResponse.h
 *
 * 
 */

#ifndef OAICancelQueryResponse_H
#define OAICancelQueryResponse_H
...
class OAICancelQueryResponse : public OAIObject {
public:
    OAICancelQueryResponse();
    OAICancelQueryResponse(QString json);
    ~OAICancelQueryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelQueryResponse)

#endif // OAICancelQueryResponse_H
