...
/*
 * OAIStopImportRequest.h
 *
 * 
 */

#ifndef OAIStopImportRequest_H
#define OAIStopImportRequest_H
...
class OAIStopImportRequest : public OAIObject {
public:
    OAIStopImportRequest();
    OAIStopImportRequest(QString json);
    ~OAIStopImportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopImportRequest)

#endif // OAIStopImportRequest_H
