...
/*
 * OAIGetTrailStatusRequest.h
 *
 * The name of a trail about which you want the current status.
 */

#ifndef OAIGetTrailStatusRequest_H
#define OAIGetTrailStatusRequest_H
...
class OAIGetTrailStatusRequest : public OAIObject {
public:
    OAIGetTrailStatusRequest();
    OAIGetTrailStatusRequest(QString json);
    ~OAIGetTrailStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTrailStatusRequest)

#endif // OAIGetTrailStatusRequest_H
