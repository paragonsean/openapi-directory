...
#ifndef OAIImportStatistics_H
#define OAIImportStatistics_H
...
class OAIImportStatistics : public OAIObject {
public:
    OAIImportStatistics();
    OAIImportStatistics(QString json);
    ~OAIImportStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportStatistics)

#endif // OAIImportStatistics_H
