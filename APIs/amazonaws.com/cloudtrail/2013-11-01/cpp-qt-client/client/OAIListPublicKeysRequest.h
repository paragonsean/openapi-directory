...
/*
 * OAIListPublicKeysRequest.h
 *
 * Requests the public keys for a specified time range.
 */

#ifndef OAIListPublicKeysRequest_H
#define OAIListPublicKeysRequest_H
...
class OAIListPublicKeysRequest : public OAIObject {
public:
    OAIListPublicKeysRequest();
    OAIListPublicKeysRequest(QString json);
    ~OAIListPublicKeysRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPublicKeysRequest)

#endif // OAIListPublicKeysRequest_H
