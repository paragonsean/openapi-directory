...
/*
 * OAIUpdateEventDataStoreResponse.h
 *
 * 
 */

#ifndef OAIUpdateEventDataStoreResponse_H
#define OAIUpdateEventDataStoreResponse_H
...
class OAIUpdateEventDataStoreResponse : public OAIObject {
public:
    OAIUpdateEventDataStoreResponse();
    OAIUpdateEventDataStoreResponse(QString json);
    ~OAIUpdateEventDataStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventDataStoreResponse)

#endif // OAIUpdateEventDataStoreResponse_H
