...
OAIStopImportRequest::OAIStopImportRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopImportRequest::OAIStopImportRequest() {
    this->initializeModel();
}

OAIStopImportRequest::~OAIStopImportRequest() {}

void OAIStopImportRequest::initializeModel() {

    m_import_id_isSet = false;
    m_import_id_isValid = false;
}

void OAIStopImportRequest::fromJson(QString jsonString) {
...
void OAIStopImportRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopImportRequest::asJson() const {
...
QJsonObject OAIStopImportRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopImportRequest::getImportId() const {
    return m_import_id;
}
void OAIStopImportRequest::setImportId(const QString &import_id) {
    m_import_id = import_id;
    m_import_id_isSet = true;
}

bool OAIStopImportRequest::is_import_id_Set() const{
    return m_import_id_isSet;
}

bool OAIStopImportRequest::is_import_id_Valid() const{
    return m_import_id_isValid;
}

bool OAIStopImportRequest::isSet() const {
...
bool OAIStopImportRequest::isValid() const {
