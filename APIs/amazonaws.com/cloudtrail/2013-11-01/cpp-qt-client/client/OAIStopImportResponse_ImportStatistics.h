...
/*
 * OAIStopImportResponse_ImportStatistics.h
 *
 * 
 */

#ifndef OAIStopImportResponse_ImportStatistics_H
#define OAIStopImportResponse_ImportStatistics_H
...
class OAIStopImportResponse_ImportStatistics : public OAIObject {
public:
    OAIStopImportResponse_ImportStatistics();
    OAIStopImportResponse_ImportStatistics(QString json);
    ~OAIStopImportResponse_ImportStatistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopImportResponse_ImportStatistics)

#endif // OAIStopImportResponse_ImportStatistics_H
