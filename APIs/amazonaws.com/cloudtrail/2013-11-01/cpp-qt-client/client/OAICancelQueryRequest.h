...
/*
 * OAICancelQueryRequest.h
 *
 * 
 */

#ifndef OAICancelQueryRequest_H
#define OAICancelQueryRequest_H
...
class OAICancelQueryRequest : public OAIObject {
public:
    OAICancelQueryRequest();
    OAICancelQueryRequest(QString json);
    ~OAICancelQueryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICancelQueryRequest)

#endif // OAICancelQueryRequest_H
