...
OAIStartEventDataStoreIngestionRequest::OAIStartEventDataStoreIngestionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartEventDataStoreIngestionRequest::OAIStartEventDataStoreIngestionRequest() {
    this->initializeModel();
}

OAIStartEventDataStoreIngestionRequest::~OAIStartEventDataStoreIngestionRequest() {}

void OAIStartEventDataStoreIngestionRequest::initializeModel() {

    m_event_data_store_isSet = false;
    m_event_data_store_isValid = false;
}

void OAIStartEventDataStoreIngestionRequest::fromJson(QString jsonString) {
...
void OAIStartEventDataStoreIngestionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartEventDataStoreIngestionRequest::asJson() const {
...
QJsonObject OAIStartEventDataStoreIngestionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartEventDataStoreIngestionRequest::getEventDataStore() const {
    return m_event_data_store;
}
void OAIStartEventDataStoreIngestionRequest::setEventDataStore(const QString &event_data_store) {
    m_event_data_store = event_data_store;
    m_event_data_store_isSet = true;
}

bool OAIStartEventDataStoreIngestionRequest::is_event_data_store_Set() const{
    return m_event_data_store_isSet;
}

bool OAIStartEventDataStoreIngestionRequest::is_event_data_store_Valid() const{
    return m_event_data_store_isValid;
}

bool OAIStartEventDataStoreIngestionRequest::isSet() const {
...
bool OAIStartEventDataStoreIngestionRequest::isValid() const {
