...
/*
 * OAIListImportFailuresResponse.h
 *
 * 
 */

#ifndef OAIListImportFailuresResponse_H
#define OAIListImportFailuresResponse_H
...
class OAIListImportFailuresResponse : public OAIObject {
public:
    OAIListImportFailuresResponse();
    OAIListImportFailuresResponse(QString json);
    ~OAIListImportFailuresResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListImportFailuresResponse)

#endif // OAIListImportFailuresResponse_H
