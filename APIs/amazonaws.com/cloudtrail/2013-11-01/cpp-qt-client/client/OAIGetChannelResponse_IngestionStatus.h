...
/*
 * OAIGetChannelResponse_IngestionStatus.h
 *
 * 
 */

#ifndef OAIGetChannelResponse_IngestionStatus_H
#define OAIGetChannelResponse_IngestionStatus_H
...
class OAIGetChannelResponse_IngestionStatus : public OAIObject {
public:
    OAIGetChannelResponse_IngestionStatus();
    OAIGetChannelResponse_IngestionStatus(QString json);
    ~OAIGetChannelResponse_IngestionStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChannelResponse_IngestionStatus)

#endif // OAIGetChannelResponse_IngestionStatus_H
