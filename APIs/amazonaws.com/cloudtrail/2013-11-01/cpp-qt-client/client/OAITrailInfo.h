...
#ifndef OAITrailInfo_H
#define OAITrailInfo_H
...
class OAITrailInfo : public OAIObject {
public:
    OAITrailInfo();
    OAITrailInfo(QString json);
    ~OAITrailInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrailInfo)

#endif // OAITrailInfo_H
