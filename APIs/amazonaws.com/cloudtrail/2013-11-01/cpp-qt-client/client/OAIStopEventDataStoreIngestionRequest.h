...
/*
 * OAIStopEventDataStoreIngestionRequest.h
 *
 * 
 */

#ifndef OAIStopEventDataStoreIngestionRequest_H
#define OAIStopEventDataStoreIngestionRequest_H
...
class OAIStopEventDataStoreIngestionRequest : public OAIObject {
public:
    OAIStopEventDataStoreIngestionRequest();
    OAIStopEventDataStoreIngestionRequest(QString json);
    ~OAIStopEventDataStoreIngestionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopEventDataStoreIngestionRequest)

#endif // OAIStopEventDataStoreIngestionRequest_H
