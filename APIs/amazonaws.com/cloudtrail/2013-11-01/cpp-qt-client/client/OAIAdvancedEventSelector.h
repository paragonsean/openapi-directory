...
#ifndef OAIAdvancedEventSelector_H
#define OAIAdvancedEventSelector_H
...
class OAIAdvancedEventSelector : public OAIObject {
public:
    OAIAdvancedEventSelector();
    OAIAdvancedEventSelector(QString json);
    ~OAIAdvancedEventSelector() override;
    ...
    QList getFieldSelectors() const;
    void setFieldSelectors(const QList &field_selectors);
    bool is_field_selectors_Set() const;
    bool is_field_selectors_Valid() const;
...
private:
    ...
    QList m_field_selectors;
    bool m_field_selectors_isSet;
    bool m_field_selectors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedEventSelector)

#endif // OAIAdvancedEventSelector_H
