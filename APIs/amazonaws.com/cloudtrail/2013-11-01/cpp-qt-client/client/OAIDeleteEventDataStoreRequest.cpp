...
OAIDeleteEventDataStoreRequest::OAIDeleteEventDataStoreRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteEventDataStoreRequest::OAIDeleteEventDataStoreRequest() {
    this->initializeModel();
}

OAIDeleteEventDataStoreRequest::~OAIDeleteEventDataStoreRequest() {}

void OAIDeleteEventDataStoreRequest::initializeModel() {

    m_event_data_store_isSet = false;
    m_event_data_store_isValid = false;
}

void OAIDeleteEventDataStoreRequest::fromJson(QString jsonString) {
...
void OAIDeleteEventDataStoreRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteEventDataStoreRequest::asJson() const {
...
QJsonObject OAIDeleteEventDataStoreRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteEventDataStoreRequest::getEventDataStore() const {
    return m_event_data_store;
}
void OAIDeleteEventDataStoreRequest::setEventDataStore(const QString &event_data_store) {
    m_event_data_store = event_data_store;
    m_event_data_store_isSet = true;
}

bool OAIDeleteEventDataStoreRequest::is_event_data_store_Set() const{
    return m_event_data_store_isSet;
}

bool OAIDeleteEventDataStoreRequest::is_event_data_store_Valid() const{
    return m_event_data_store_isValid;
}

bool OAIDeleteEventDataStoreRequest::isSet() const {
...
bool OAIDeleteEventDataStoreRequest::isValid() const {
