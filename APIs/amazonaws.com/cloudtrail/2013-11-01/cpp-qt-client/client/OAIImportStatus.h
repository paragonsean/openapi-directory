...
#ifndef OAIImportStatus_H
#define OAIImportStatus_H
...
class OAIImportStatus : public OAIEnum {
public:
    OAIImportStatus();
    OAIImportStatus(QString json);
    ~OAIImportStatus() override;
    ...
    OAIImportStatus::eOAIImportStatus getValue() const;
    void setValue(const OAIImportStatus::eOAIImportStatus& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportStatus)

#endif // OAIImportStatus_H
