...
/*
 * OAIRestoreEventDataStoreResponse.h
 *
 * 
 */

#ifndef OAIRestoreEventDataStoreResponse_H
#define OAIRestoreEventDataStoreResponse_H
...
class OAIRestoreEventDataStoreResponse : public OAIObject {
public:
    OAIRestoreEventDataStoreResponse();
    OAIRestoreEventDataStoreResponse(QString json);
    ~OAIRestoreEventDataStoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreEventDataStoreResponse)

#endif // OAIRestoreEventDataStoreResponse_H
