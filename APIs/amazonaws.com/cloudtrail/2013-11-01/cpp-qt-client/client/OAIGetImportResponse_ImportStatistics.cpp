...
OAIGetImportResponse_ImportStatistics::OAIGetImportResponse_ImportStatistics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImportResponse_ImportStatistics::OAIGetImportResponse_ImportStatistics() {
    this->initializeModel();
}

OAIGetImportResponse_ImportStatistics::~OAIGetImportResponse_ImportStatistics() {}

void OAIGetImportResponse_ImportStatistics::initializeModel() {
...
void OAIGetImportResponse_ImportStatistics::fromJson(QString jsonString) {
...
void OAIGetImportResponse_ImportStatistics::fromJsonObject(QJsonObject json) {
...
QString OAIGetImportResponse_ImportStatistics::asJson() const {
...
QJsonObject OAIGetImportResponse_ImportStatistics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIGetImportResponse_ImportStatistics::getPrefixesFound() const {
    return m_prefixes_found;
}
void OAIGetImportResponse_ImportStatistics::setPrefixesFound(const qint32 &prefixes_found) {
    m_prefixes_found = prefixes_found;
    m_prefixes_found_isSet = true;
}

bool OAIGetImportResponse_ImportStatistics::is_prefixes_found_Set() const{
    return m_prefixes_found_isSet;
}

bool OAIGetImportResponse_ImportStatistics::is_prefixes_found_Valid() const{
    return m_prefixes_found_isValid;
}

qint32 OAIGetImportResponse_ImportStatistics::getPrefixesCompleted() const {
    return m_prefixes_completed;
}
void OAIGetImportResponse_ImportStatistics::setPrefixesCompleted(const qint32 &prefixes_completed) {
    m_prefixes_completed = prefixes_completed;
    m_prefixes_completed_isSet = true;
}

bool OAIGetImportResponse_ImportStatistics::is_prefixes_completed_Set() const{
    return m_prefixes_completed_isSet;
}

bool OAIGetImportResponse_ImportStatistics::is_prefixes_completed_Valid() const{
    return m_prefixes_completed_isValid;
}

qint32 OAIGetImportResponse_ImportStatistics::getFilesCompleted() const {
    return m_files_completed;
}
void OAIGetImportResponse_ImportStatistics::setFilesCompleted(const qint32 &files_completed) {
    m_files_completed = files_completed;
    m_files_completed_isSet = true;
}

bool OAIGetImportResponse_ImportStatistics::is_files_completed_Set() const{
    return m_files_completed_isSet;
}

bool OAIGetImportResponse_ImportStatistics::is_files_completed_Valid() const{
    return m_files_completed_isValid;
}

qint32 OAIGetImportResponse_ImportStatistics::getEventsCompleted() const {
    return m_events_completed;
}
void OAIGetImportResponse_ImportStatistics::setEventsCompleted(const qint32 &events_completed) {
    m_events_completed = events_completed;
    m_events_completed_isSet = true;
}

bool OAIGetImportResponse_ImportStatistics::is_events_completed_Set() const{
    return m_events_completed_isSet;
}

bool OAIGetImportResponse_ImportStatistics::is_events_completed_Valid() const{
    return m_events_completed_isValid;
}

qint32 OAIGetImportResponse_ImportStatistics::getFailedEntries() const {
    return m_failed_entries;
}
void OAIGetImportResponse_ImportStatistics::setFailedEntries(const qint32 &failed_entries) {
    m_failed_entries = failed_entries;
    m_failed_entries_isSet = true;
}

bool OAIGetImportResponse_ImportStatistics::is_failed_entries_Set() const{
    return m_failed_entries_isSet;
}

bool OAIGetImportResponse_ImportStatistics::is_failed_entries_Valid() const{
    return m_failed_entries_isValid;
}

bool OAIGetImportResponse_ImportStatistics::isSet() const {
...
bool OAIGetImportResponse_ImportStatistics::isValid() const {
