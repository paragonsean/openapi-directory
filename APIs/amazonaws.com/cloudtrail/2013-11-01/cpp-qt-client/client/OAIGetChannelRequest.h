...
/*
 * OAIGetChannelRequest.h
 *
 * 
 */

#ifndef OAIGetChannelRequest_H
#define OAIGetChannelRequest_H
...
class OAIGetChannelRequest : public OAIObject {
public:
    OAIGetChannelRequest();
    OAIGetChannelRequest(QString json);
    ~OAIGetChannelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetChannelRequest)

#endif // OAIGetChannelRequest_H
