...
OAIGetEventSelectorsResponse::OAIGetEventSelectorsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEventSelectorsResponse::OAIGetEventSelectorsResponse() {
    this->initializeModel();
}

OAIGetEventSelectorsResponse::~OAIGetEventSelectorsResponse() {}

void OAIGetEventSelectorsResponse::initializeModel() {
...
void OAIGetEventSelectorsResponse::fromJson(QString jsonString) {
...
void OAIGetEventSelectorsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetEventSelectorsResponse::asJson() const {
...
QJsonObject OAIGetEventSelectorsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetEventSelectorsResponse::getTrailArn() const {
    return m_trail_arn;
}
void OAIGetEventSelectorsResponse::setTrailArn(const QString &trail_arn) {
    m_trail_arn = trail_arn;
    m_trail_arn_isSet = true;
}

bool OAIGetEventSelectorsResponse::is_trail_arn_Set() const{
    return m_trail_arn_isSet;
}

bool OAIGetEventSelectorsResponse::is_trail_arn_Valid() const{
    return m_trail_arn_isValid;
}

QList OAIGetEventSelectorsResponse::getEventSelectors() const {
    return m_event_selectors;
}
void OAIGetEventSelectorsResponse::setEventSelectors(const QList &event_selectors) {
    m_event_selectors = event_selectors;
    m_event_selectors_isSet = true;
}

bool OAIGetEventSelectorsResponse::is_event_selectors_Set() const{
    return m_event_selectors_isSet;
}

bool OAIGetEventSelectorsResponse::is_event_selectors_Valid() const{
    return m_event_selectors_isValid;
}

QList OAIGetEventSelectorsResponse::getAdvancedEventSelectors() const {
    return m_advanced_event_selectors;
}
void OAIGetEventSelectorsResponse::setAdvancedEventSelectors(const QList &advanced_event_selectors) {
    m_advanced_event_selectors = advanced_event_selectors;
    m_advanced_event_selectors_isSet = true;
}

bool OAIGetEventSelectorsResponse::is_advanced_event_selectors_Set() const{
    return m_advanced_event_selectors_isSet;
}

bool OAIGetEventSelectorsResponse::is_advanced_event_selectors_Valid() const{
    return m_advanced_event_selectors_isValid;
}

bool OAIGetEventSelectorsResponse::isSet() const {
...
bool OAIGetEventSelectorsResponse::isValid() const {
