...
class S3ImportSource(Model):
    ...
    def __init__(self, s3_location_uri: str=None, s3_bucket_region: str=None, s3_bucket_access_role_arn: str=None):
        """S3ImportSource - a model defined in OpenAPI

        :param s3_location_uri: The s3_location_uri of this S3ImportSource.
        :param s3_bucket_region: The s3_bucket_region of this S3ImportSource.
        :param s3_bucket_access_role_arn: The s3_bucket_access_role_arn of this S3ImportSource.
        """
        self.openapi_types = {
            's3_location_uri': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'S3ImportSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The S3ImportSource of this S3ImportSource.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_location_uri(self):
        """Gets the s3_location_uri of this S3ImportSource.


        :return: The s3_location_uri of this S3ImportSource.
        :rtype: str
        """
    ...
    def s3_location_uri(self, s3_location_uri):
        """Sets the s3_location_uri of this S3ImportSource.
    ...
    def s3_bucket_region(self):
        """Gets the s3_bucket_region of this S3ImportSource.


        :return: The s3_bucket_region of this S3ImportSource.
        :rtype: str
        """
    ...
    def s3_bucket_region(self, s3_bucket_region):
        """Sets the s3_bucket_region of this S3ImportSource.
    ...
    def s3_bucket_access_role_arn(self):
        """Gets the s3_bucket_access_role_arn of this S3ImportSource.


        :return: The s3_bucket_access_role_arn of this S3ImportSource.
        :rtype: str
        """
    ...
    def s3_bucket_access_role_arn(self, s3_bucket_access_role_arn):
        """Sets the s3_bucket_access_role_arn of this S3ImportSource.
