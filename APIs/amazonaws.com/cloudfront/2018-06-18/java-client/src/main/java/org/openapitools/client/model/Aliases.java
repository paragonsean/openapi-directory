...
public class Aliases {
  ...
  public Aliases quantity(Integer quantity) {
  ...
  public Aliases items(List items) {
    this.items = items;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quantity, aliases.quantity) &&
        Objects.equals(this.items, aliases.items);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Aliases.openapiRequiredFields) {
