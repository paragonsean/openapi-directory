...
public class CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig() {
  }

  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig callerReference(String callerReference) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig aliases(CreateDistribution20180618RequestDistributionConfigAliases aliases) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig defaultRootObject(String defaultRootObject) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig origins(CreateDistribution20180618RequestDistributionConfigOrigins origins) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig defaultCacheBehavior(CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior defaultCacheBehavior) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig cacheBehaviors(CreateDistribution20180618RequestDistributionConfigCacheBehaviors cacheBehaviors) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig customErrorResponses(CreateDistribution20180618RequestDistributionConfigCustomErrorResponses customErrorResponses) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig comment(String comment) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig logging(CreateDistribution20180618RequestDistributionConfigLogging logging) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig priceClass(PriceClass priceClass) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig enabled(Boolean enabled) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig viewerCertificate(ViewerCertificate viewerCertificate) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig restrictions(Restrictions restrictions) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig webACLId(String webACLId) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig httpVersion(HttpVersion httpVersion) {
  ...
  public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig isIPV6Enabled(Boolean isIPV6Enabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig = (CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig) o;
    return Objects.equals(this.callerReference, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.callerReference) &&
        Objects.equals(this.aliases, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.aliases) &&
        Objects.equals(this.defaultRootObject, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.defaultRootObject) &&
        Objects.equals(this.origins, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.origins) &&
        Objects.equals(this.defaultCacheBehavior, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.defaultCacheBehavior) &&
        Objects.equals(this.cacheBehaviors, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.cacheBehaviors) &&
        Objects.equals(this.customErrorResponses, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.customErrorResponses) &&
        Objects.equals(this.comment, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.comment) &&
        Objects.equals(this.logging, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.logging) &&
        Objects.equals(this.priceClass, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.priceClass) &&
        Objects.equals(this.enabled, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.enabled) &&
        Objects.equals(this.viewerCertificate, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.viewerCertificate) &&
        Objects.equals(this.restrictions, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.restrictions) &&
        Objects.equals(this.webACLId, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.webACLId) &&
        Objects.equals(this.httpVersion, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.httpVersion) &&
        Objects.equals(this.isIPV6Enabled, createDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.isIPV6Enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig is not found in the empty JSON string", CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig>() {
           @Override
           public void write(JsonWriter out, CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig
   * @throws IOException if the JSON string is invalid with respect to CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig
   */
  public static CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig.class);
  }

  /**
   * Convert an instance of CreateDistributionWithTags20180618RequestDistributionConfigWithTagsDistributionConfig to an JSON string
   *
   * @return JSON string
   */
