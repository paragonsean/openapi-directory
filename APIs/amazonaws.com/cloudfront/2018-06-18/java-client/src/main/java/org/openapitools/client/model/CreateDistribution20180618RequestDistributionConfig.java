...
public class CreateDistribution20180618RequestDistributionConfig {
  ...
  public CreateDistribution20180618RequestDistributionConfig() {
  }

  public CreateDistribution20180618RequestDistributionConfig callerReference(String callerReference) {
  ...
  public CreateDistribution20180618RequestDistributionConfig aliases(CreateDistribution20180618RequestDistributionConfigAliases aliases) {
  ...
  public CreateDistribution20180618RequestDistributionConfig defaultRootObject(String defaultRootObject) {
  ...
  public CreateDistribution20180618RequestDistributionConfig origins(CreateDistribution20180618RequestDistributionConfigOrigins origins) {
  ...
  public CreateDistribution20180618RequestDistributionConfig defaultCacheBehavior(CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior defaultCacheBehavior) {
  ...
  public CreateDistribution20180618RequestDistributionConfig cacheBehaviors(CreateDistribution20180618RequestDistributionConfigCacheBehaviors cacheBehaviors) {
  ...
  public CreateDistribution20180618RequestDistributionConfig customErrorResponses(CreateDistribution20180618RequestDistributionConfigCustomErrorResponses customErrorResponses) {
  ...
  public CreateDistribution20180618RequestDistributionConfig comment(String comment) {
  ...
  public CreateDistribution20180618RequestDistributionConfig logging(CreateDistribution20180618RequestDistributionConfigLogging logging) {
  ...
  public CreateDistribution20180618RequestDistributionConfig priceClass(PriceClass priceClass) {
  ...
  public CreateDistribution20180618RequestDistributionConfig enabled(Boolean enabled) {
  ...
  public CreateDistribution20180618RequestDistributionConfig viewerCertificate(ViewerCertificate viewerCertificate) {
  ...
  public CreateDistribution20180618RequestDistributionConfig restrictions(Restrictions restrictions) {
  ...
  public CreateDistribution20180618RequestDistributionConfig webACLId(String webACLId) {
  ...
  public CreateDistribution20180618RequestDistributionConfig httpVersion(HttpVersion httpVersion) {
  ...
  public CreateDistribution20180618RequestDistributionConfig isIPV6Enabled(Boolean isIPV6Enabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDistribution20180618RequestDistributionConfig createDistribution20180618RequestDistributionConfig = (CreateDistribution20180618RequestDistributionConfig) o;
    return Objects.equals(this.callerReference, createDistribution20180618RequestDistributionConfig.callerReference) &&
        Objects.equals(this.aliases, createDistribution20180618RequestDistributionConfig.aliases) &&
        Objects.equals(this.defaultRootObject, createDistribution20180618RequestDistributionConfig.defaultRootObject) &&
        Objects.equals(this.origins, createDistribution20180618RequestDistributionConfig.origins) &&
        Objects.equals(this.defaultCacheBehavior, createDistribution20180618RequestDistributionConfig.defaultCacheBehavior) &&
        Objects.equals(this.cacheBehaviors, createDistribution20180618RequestDistributionConfig.cacheBehaviors) &&
        Objects.equals(this.customErrorResponses, createDistribution20180618RequestDistributionConfig.customErrorResponses) &&
        Objects.equals(this.comment, createDistribution20180618RequestDistributionConfig.comment) &&
        Objects.equals(this.logging, createDistribution20180618RequestDistributionConfig.logging) &&
        Objects.equals(this.priceClass, createDistribution20180618RequestDistributionConfig.priceClass) &&
        Objects.equals(this.enabled, createDistribution20180618RequestDistributionConfig.enabled) &&
        Objects.equals(this.viewerCertificate, createDistribution20180618RequestDistributionConfig.viewerCertificate) &&
        Objects.equals(this.restrictions, createDistribution20180618RequestDistributionConfig.restrictions) &&
        Objects.equals(this.webACLId, createDistribution20180618RequestDistributionConfig.webACLId) &&
        Objects.equals(this.httpVersion, createDistribution20180618RequestDistributionConfig.httpVersion) &&
        Objects.equals(this.isIPV6Enabled, createDistribution20180618RequestDistributionConfig.isIPV6Enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDistribution20180618RequestDistributionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDistribution20180618RequestDistributionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDistribution20180618RequestDistributionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDistribution20180618RequestDistributionConfig is not found in the empty JSON string", CreateDistribution20180618RequestDistributionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDistribution20180618RequestDistributionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDistribution20180618RequestDistributionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDistribution20180618RequestDistributionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDistribution20180618RequestDistributionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDistribution20180618RequestDistributionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDistribution20180618RequestDistributionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDistribution20180618RequestDistributionConfig>() {
           @Override
           public void write(JsonWriter out, CreateDistribution20180618RequestDistributionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDistribution20180618RequestDistributionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDistribution20180618RequestDistributionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDistribution20180618RequestDistributionConfig
   * @throws IOException if the JSON string is invalid with respect to CreateDistribution20180618RequestDistributionConfig
   */
  public static CreateDistribution20180618RequestDistributionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDistribution20180618RequestDistributionConfig.class);
  }

  /**
   * Convert an instance of CreateDistribution20180618RequestDistributionConfig to an JSON string
   *
   * @return JSON string
   */
