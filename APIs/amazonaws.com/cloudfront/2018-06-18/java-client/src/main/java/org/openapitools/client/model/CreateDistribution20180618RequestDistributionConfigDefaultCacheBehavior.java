...
public class CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior() {
  }

  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior targetOriginId(String targetOriginId) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior forwardedValues(DefaultCacheBehaviorForwardedValues forwardedValues) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior trustedSigners(DefaultCacheBehaviorTrustedSigners trustedSigners) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior viewerProtocolPolicy(ViewerProtocolPolicy viewerProtocolPolicy) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior minTTL(Integer minTTL) {
    this.minTTL = minTTL;
    return this;
  }
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior allowedMethods(AllowedMethods allowedMethods) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior smoothStreaming(Boolean smoothStreaming) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior defaultTTL(Integer defaultTTL) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior maxTTL(Integer maxTTL) {
    this.maxTTL = maxTTL;
    return this;
  }
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior compress(Boolean compress) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior lambdaFunctionAssociations(DefaultCacheBehaviorLambdaFunctionAssociations lambdaFunctionAssociations) {
  ...
  public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior fieldLevelEncryptionId(String fieldLevelEncryptionId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior createDistribution20180618RequestDistributionConfigDefaultCacheBehavior = (CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior) o;
    return Objects.equals(this.targetOriginId, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.targetOriginId) &&
        Objects.equals(this.forwardedValues, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.forwardedValues) &&
        Objects.equals(this.trustedSigners, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.trustedSigners) &&
        Objects.equals(this.viewerProtocolPolicy, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.viewerProtocolPolicy) &&
        Objects.equals(this.minTTL, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.minTTL) &&
        Objects.equals(this.allowedMethods, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.allowedMethods) &&
        Objects.equals(this.smoothStreaming, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.smoothStreaming) &&
        Objects.equals(this.defaultTTL, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.defaultTTL) &&
        Objects.equals(this.maxTTL, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.maxTTL) &&
        Objects.equals(this.compress, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.compress) &&
        Objects.equals(this.lambdaFunctionAssociations, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.lambdaFunctionAssociations) &&
        Objects.equals(this.fieldLevelEncryptionId, createDistribution20180618RequestDistributionConfigDefaultCacheBehavior.fieldLevelEncryptionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior is not found in the empty JSON string", CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior>() {
           @Override
           public void write(JsonWriter out, CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior
   * @throws IOException if the JSON string is invalid with respect to CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior
   */
  public static CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior.class);
  }

  /**
   * Convert an instance of CreateDistribution20180618RequestDistributionConfigDefaultCacheBehavior to an JSON string
   *
   * @return JSON string
   */
