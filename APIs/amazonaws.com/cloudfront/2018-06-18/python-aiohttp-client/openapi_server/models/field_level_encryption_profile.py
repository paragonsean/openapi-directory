...
class FieldLevelEncryptionProfile(Model):
    ...
    def __init__(self, id: str=None, last_modified_time: datetime=None, field_level_encryption_profile_config: FieldLevelEncryptionProfileFieldLevelEncryptionProfileConfig=None):
        """FieldLevelEncryptionProfile - a model defined in OpenAPI

        :param id: The id of this FieldLevelEncryptionProfile.
        :param last_modified_time: The last_modified_time of this FieldLevelEncryptionProfile.
        :param field_level_encryption_profile_config: The field_level_encryption_profile_config of this FieldLevelEncryptionProfile.
        """
        self.openapi_types = {
            'id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FieldLevelEncryptionProfile':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FieldLevelEncryptionProfile of this FieldLevelEncryptionProfile.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this FieldLevelEncryptionProfile.


        :return: The id of this FieldLevelEncryptionProfile.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FieldLevelEncryptionProfile.
    ...
    def last_modified_time(self):
        """Gets the last_modified_time of this FieldLevelEncryptionProfile.


        :return: The last_modified_time of this FieldLevelEncryptionProfile.
        :rtype: datetime
        """
    ...
    def last_modified_time(self, last_modified_time):
        """Sets the last_modified_time of this FieldLevelEncryptionProfile.
    ...
    def field_level_encryption_profile_config(self):
        """Gets the field_level_encryption_profile_config of this FieldLevelEncryptionProfile.


        :return: The field_level_encryption_profile_config of this FieldLevelEncryptionProfile.
    ...
    def field_level_encryption_profile_config(self, field_level_encryption_profile_config):
        """Sets the field_level_encryption_profile_config of this FieldLevelEncryptionProfile.
