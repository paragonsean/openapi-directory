...
OAICreateDistribution2018_06_18_request_DistributionConfig_Aliases OAIDistributionSummaryList_inner::getAliases() const {
    return m_aliases;
}
void OAIDistributionSummaryList_inner::setAliases(const OAICreateDistribution2018_06_18_request_DistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateDistribution2018_06_18_request_DistributionConfig_DefaultCacheBehavior OAIDistributionSummaryList_inner::getDefaultCacheBehavior() const {
    return m_default_cache_behavior;
}
void OAIDistributionSummaryList_inner::setDefaultCacheBehavior(const OAICreateDistribution2018_06_18_request_DistributionConfig_DefaultCacheBehavior &default_cache_behavior) {
