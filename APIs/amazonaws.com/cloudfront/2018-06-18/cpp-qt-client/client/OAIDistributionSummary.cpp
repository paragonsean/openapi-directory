...
OAICreateDistribution2018_06_18_request_DistributionConfig_Aliases OAIDistributionSummary::getAliases() const {
    return m_aliases;
}
void OAIDistributionSummary::setAliases(const OAICreateDistribution2018_06_18_request_DistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateDistribution2018_06_18_request_DistributionConfig_DefaultCacheBehavior OAIDistributionSummary::getDefaultCacheBehavior() const {
    return m_default_cache_behavior;
}
void OAIDistributionSummary::setDefaultCacheBehavior(const OAICreateDistribution2018_06_18_request_DistributionConfig_DefaultCacheBehavior &default_cache_behavior) {
...
OAIViewerCertificate OAIDistributionSummary::getViewerCertificate() const {
    return m_viewer_certificate;
}
void OAIDistributionSummary::setViewerCertificate(const OAIViewerCertificate &viewer_certificate) {
...
OAIRestrictions OAIDistributionSummary::getRestrictions() const {
    return m_restrictions;
}
void OAIDistributionSummary::setRestrictions(const OAIRestrictions &restrictions) {
