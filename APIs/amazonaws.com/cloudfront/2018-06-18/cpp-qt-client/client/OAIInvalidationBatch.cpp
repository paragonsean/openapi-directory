...
OAICreateInvalidation2018_06_18_request_InvalidationBatch_Paths OAIInvalidationBatch::getPaths() const {
    return m_paths;
}
void OAIInvalidationBatch::setPaths(const OAICreateInvalidation2018_06_18_request_InvalidationBatch_Paths &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}
