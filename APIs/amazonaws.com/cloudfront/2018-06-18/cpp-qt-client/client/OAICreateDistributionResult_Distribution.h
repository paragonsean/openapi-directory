...
/*
 * OAICreateDistributionResult_Distribution.h
 *
 * 
 */

#ifndef OAICreateDistributionResult_Distribution_H
#define OAICreateDistributionResult_Distribution_H
...
class OAICreateDistributionResult_Distribution : public OAIObject {
public:
    OAICreateDistributionResult_Distribution();
    OAICreateDistributionResult_Distribution(QString json);
    ~OAICreateDistributionResult_Distribution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDistributionResult_Distribution)

#endif // OAICreateDistributionResult_Distribution_H
