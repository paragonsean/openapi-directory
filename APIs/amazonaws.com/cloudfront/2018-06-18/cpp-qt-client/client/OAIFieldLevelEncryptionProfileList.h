...
/*
 * OAIFieldLevelEncryptionProfileList.h
 *
 * List of field-level encryption profiles.
 */

#ifndef OAIFieldLevelEncryptionProfileList_H
#define OAIFieldLevelEncryptionProfileList_H
...
class OAIFieldLevelEncryptionProfileList : public OAIObject {
public:
    OAIFieldLevelEncryptionProfileList();
    OAIFieldLevelEncryptionProfileList(QString json);
    ~OAIFieldLevelEncryptionProfileList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldLevelEncryptionProfileList)

#endif // OAIFieldLevelEncryptionProfileList_H
