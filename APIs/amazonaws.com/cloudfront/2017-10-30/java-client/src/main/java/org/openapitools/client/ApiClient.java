...
public class ApiClient {
    ...
    private String basePath = "https://cloudfront.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-10-30/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloudfront.amazonaws.com
