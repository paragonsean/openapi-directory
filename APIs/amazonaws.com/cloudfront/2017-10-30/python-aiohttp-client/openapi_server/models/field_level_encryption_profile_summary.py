...
class FieldLevelEncryptionProfileSummary(Model):
    ...
    def __init__(self, id: str=None, last_modified_time: datetime=None, name: str=None, encryption_entities: CreateFieldLevelEncryptionProfile20171030RequestFieldLevelEncryptionProfileConfigEncryptionEntities=None, comment: str=None):
