...
class CacheBehaviorListInner {
    ...
    static validateJSON(data) {
        ...
        if (data['FieldLevelEncryptionId'] && !(typeof data['FieldLevelEncryptionId'] === 'string' || data['FieldLevelEncryptionId'] instanceof String)) {
            throw new Error("Expected the field `FieldLevelEncryptionId` to be a primitive type in the JSON string but got " + data['FieldLevelEncryptionId']);
        }
 ...
 */
CacheBehaviorListInner.prototype['FieldLevelEncryptionId'] = undefined;
