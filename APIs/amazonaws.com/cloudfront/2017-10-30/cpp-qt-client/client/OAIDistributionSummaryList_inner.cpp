...
OAICreateDistribution2017_10_30_request_DistributionConfig_Aliases OAIDistributionSummaryList_inner::getAliases() const {
    return m_aliases;
}
void OAIDistributionSummaryList_inner::setAliases(const OAICreateDistribution2017_10_30_request_DistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateDistribution2017_10_30_request_DistributionConfig_DefaultCacheBehavior OAIDistributionSummaryList_inner::getDefaultCacheBehavior() const {
    return m_default_cache_behavior;
}
void OAIDistributionSummaryList_inner::setDefaultCacheBehavior(const OAICreateDistribution2017_10_30_request_DistributionConfig_DefaultCacheBehavior &default_cache_behavior) {
