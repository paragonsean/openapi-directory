...
#ifndef OAICacheBehavior_H
#define OAICacheBehavior_H
...
class OAICacheBehavior : public OAIObject {
public:
    OAICacheBehavior();
    OAICacheBehavior(QString json);
    ~OAICacheBehavior() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICacheBehavior)

#endif // OAICacheBehavior_H
