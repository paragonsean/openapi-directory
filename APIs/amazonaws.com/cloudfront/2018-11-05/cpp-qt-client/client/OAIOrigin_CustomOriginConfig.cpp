...
OAIOrigin_CustomOriginConfig::OAIOrigin_CustomOriginConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrigin_CustomOriginConfig::OAIOrigin_CustomOriginConfig() {
    this->initializeModel();
}

OAIOrigin_CustomOriginConfig::~OAIOrigin_CustomOriginConfig() {}

void OAIOrigin_CustomOriginConfig::initializeModel() {
...
void OAIOrigin_CustomOriginConfig::fromJson(QString jsonString) {
...
void OAIOrigin_CustomOriginConfig::fromJsonObject(QJsonObject json) {
...
QString OAIOrigin_CustomOriginConfig::asJson() const {
...
QJsonObject OAIOrigin_CustomOriginConfig::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIOrigin_CustomOriginConfig::getHttpPort() const {
    return m_http_port;
}
void OAIOrigin_CustomOriginConfig::setHttpPort(const qint32 &http_port) {
    m_http_port = http_port;
    m_http_port_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_http_port_Set() const{
    return m_http_port_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_http_port_Valid() const{
    return m_http_port_isValid;
}

qint32 OAIOrigin_CustomOriginConfig::getHttpsPort() const {
    return m_https_port;
}
void OAIOrigin_CustomOriginConfig::setHttpsPort(const qint32 &https_port) {
    m_https_port = https_port;
    m_https_port_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_https_port_Set() const{
    return m_https_port_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_https_port_Valid() const{
    return m_https_port_isValid;
}

OAIOriginProtocolPolicy OAIOrigin_CustomOriginConfig::getOriginProtocolPolicy() const {
    return m_origin_protocol_policy;
}
void OAIOrigin_CustomOriginConfig::setOriginProtocolPolicy(const OAIOriginProtocolPolicy &origin_protocol_policy) {
    m_origin_protocol_policy = origin_protocol_policy;
    m_origin_protocol_policy_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_origin_protocol_policy_Set() const{
    return m_origin_protocol_policy_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_origin_protocol_policy_Valid() const{
    return m_origin_protocol_policy_isValid;
}

OAICustomOriginConfig_OriginSslProtocols OAIOrigin_CustomOriginConfig::getOriginSslProtocols() const {
    return m_origin_ssl_protocols;
}
void OAIOrigin_CustomOriginConfig::setOriginSslProtocols(const OAICustomOriginConfig_OriginSslProtocols &origin_ssl_protocols) {
    m_origin_ssl_protocols = origin_ssl_protocols;
    m_origin_ssl_protocols_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_origin_ssl_protocols_Set() const{
    return m_origin_ssl_protocols_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_origin_ssl_protocols_Valid() const{
    return m_origin_ssl_protocols_isValid;
}

qint32 OAIOrigin_CustomOriginConfig::getOriginReadTimeout() const {
    return m_origin_read_timeout;
}
void OAIOrigin_CustomOriginConfig::setOriginReadTimeout(const qint32 &origin_read_timeout) {
    m_origin_read_timeout = origin_read_timeout;
    m_origin_read_timeout_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_origin_read_timeout_Set() const{
    return m_origin_read_timeout_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_origin_read_timeout_Valid() const{
    return m_origin_read_timeout_isValid;
}

qint32 OAIOrigin_CustomOriginConfig::getOriginKeepaliveTimeout() const {
    return m_origin_keepalive_timeout;
}
void OAIOrigin_CustomOriginConfig::setOriginKeepaliveTimeout(const qint32 &origin_keepalive_timeout) {
    m_origin_keepalive_timeout = origin_keepalive_timeout;
    m_origin_keepalive_timeout_isSet = true;
}

bool OAIOrigin_CustomOriginConfig::is_origin_keepalive_timeout_Set() const{
    return m_origin_keepalive_timeout_isSet;
}

bool OAIOrigin_CustomOriginConfig::is_origin_keepalive_timeout_Valid() const{
    return m_origin_keepalive_timeout_isValid;
}

bool OAIOrigin_CustomOriginConfig::isSet() const {
...
bool OAIOrigin_CustomOriginConfig::isValid() const {
