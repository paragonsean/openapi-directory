...
/*
 * OAIForwardedValues.h
 *
 * A complex type that specifies how CloudFront handles query strings and cookies.
 */

#ifndef OAIForwardedValues_H
#define OAIForwardedValues_H
...
class OAIForwardedValues : public OAIObject {
public:
    OAIForwardedValues();
    OAIForwardedValues(QString json);
    ~OAIForwardedValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForwardedValues)

#endif // OAIForwardedValues_H
