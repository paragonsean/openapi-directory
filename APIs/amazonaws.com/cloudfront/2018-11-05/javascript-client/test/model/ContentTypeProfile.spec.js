...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudFront.ContentTypeProfile();
  });
  ...
  describe('ContentTypeProfile', function() {
    it('should create an instance of ContentTypeProfile', function() {
      // uncomment below and update the code to test ContentTypeProfile
      //var instance = new AmazonCloudFront.ContentTypeProfile();
      //expect(instance).to.be.a(AmazonCloudFront.ContentTypeProfile);
    });
