...
OAICreateDistribution2016_11_25_request_DistributionConfig_Aliases OAIDistributionSummary::getAliases() const {
    return m_aliases;
}
void OAIDistributionSummary::setAliases(const OAICreateDistribution2016_11_25_request_DistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateDistribution2016_11_25_request_DistributionConfig_DefaultCacheBehavior OAIDistributionSummary::getDefaultCacheBehavior() const {
    return m_default_cache_behavior;
}
void OAIDistributionSummary::setDefaultCacheBehavior(const OAICreateDistribution2016_11_25_request_DistributionConfig_DefaultCacheBehavior &default_cache_behavior) {
