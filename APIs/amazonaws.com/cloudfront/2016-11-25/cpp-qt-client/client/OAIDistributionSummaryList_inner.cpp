...
OAICreateDistribution2016_11_25_request_DistributionConfig_Aliases OAIDistributionSummaryList_inner::getAliases() const {
    return m_aliases;
}
void OAIDistributionSummaryList_inner::setAliases(const OAICreateDistribution2016_11_25_request_DistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateDistribution2016_11_25_request_DistributionConfig_DefaultCacheBehavior OAIDistributionSummaryList_inner::getDefaultCacheBehavior() const {
    return m_default_cache_behavior;
}
void OAIDistributionSummaryList_inner::setDefaultCacheBehavior(const OAICreateDistribution2016_11_25_request_DistributionConfig_DefaultCacheBehavior &default_cache_behavior) {
