...
#include "OAICacheBehaviorList_inner.h"
...
OAICacheBehaviorList_inner::OAICacheBehaviorList_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICacheBehaviorList_inner::OAICacheBehaviorList_inner() {
    this->initializeModel();
}

OAICacheBehaviorList_inner::~OAICacheBehaviorList_inner() {}

void OAICacheBehaviorList_inner::initializeModel() {
...
void OAICacheBehaviorList_inner::fromJson(QString jsonString) {
...
void OAICacheBehaviorList_inner::fromJsonObject(QJsonObject json) {
...
QString OAICacheBehaviorList_inner::asJson() const {
...
QJsonObject OAICacheBehaviorList_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAICacheBehaviorList_inner::getPathPattern() const {
    return m_path_pattern;
}
void OAICacheBehaviorList_inner::setPathPattern(const QString &path_pattern) {
    m_path_pattern = path_pattern;
    m_path_pattern_isSet = true;
}

bool OAICacheBehaviorList_inner::is_path_pattern_Set() const{
    return m_path_pattern_isSet;
}

bool OAICacheBehaviorList_inner::is_path_pattern_Valid() const{
    return m_path_pattern_isValid;
}

QString OAICacheBehaviorList_inner::getTargetOriginId() const {
    return m_target_origin_id;
}
void OAICacheBehaviorList_inner::setTargetOriginId(const QString &target_origin_id) {
    m_target_origin_id = target_origin_id;
    m_target_origin_id_isSet = true;
}

bool OAICacheBehaviorList_inner::is_target_origin_id_Set() const{
    return m_target_origin_id_isSet;
}

bool OAICacheBehaviorList_inner::is_target_origin_id_Valid() const{
    return m_target_origin_id_isValid;
}

OAIDefaultCacheBehavior_ForwardedValues OAICacheBehaviorList_inner::getForwardedValues() const {
    return m_forwarded_values;
}
void OAICacheBehaviorList_inner::setForwardedValues(const OAIDefaultCacheBehavior_ForwardedValues &forwarded_values) {
    m_forwarded_values = forwarded_values;
    m_forwarded_values_isSet = true;
}

bool OAICacheBehaviorList_inner::is_forwarded_values_Set() const{
    return m_forwarded_values_isSet;
}

bool OAICacheBehaviorList_inner::is_forwarded_values_Valid() const{
    return m_forwarded_values_isValid;
}

OAIDefaultCacheBehavior_TrustedSigners OAICacheBehaviorList_inner::getTrustedSigners() const {
    return m_trusted_signers;
}
void OAICacheBehaviorList_inner::setTrustedSigners(const OAIDefaultCacheBehavior_TrustedSigners &trusted_signers) {
    m_trusted_signers = trusted_signers;
    m_trusted_signers_isSet = true;
}

bool OAICacheBehaviorList_inner::is_trusted_signers_Set() const{
    return m_trusted_signers_isSet;
}

bool OAICacheBehaviorList_inner::is_trusted_signers_Valid() const{
    return m_trusted_signers_isValid;
}

OAIViewerProtocolPolicy OAICacheBehaviorList_inner::getViewerProtocolPolicy() const {
    return m_viewer_protocol_policy;
}
void OAICacheBehaviorList_inner::setViewerProtocolPolicy(const OAIViewerProtocolPolicy &viewer_protocol_policy) {
    m_viewer_protocol_policy = viewer_protocol_policy;
    m_viewer_protocol_policy_isSet = true;
}

bool OAICacheBehaviorList_inner::is_viewer_protocol_policy_Set() const{
    return m_viewer_protocol_policy_isSet;
}

bool OAICacheBehaviorList_inner::is_viewer_protocol_policy_Valid() const{
    return m_viewer_protocol_policy_isValid;
}

qint32 OAICacheBehaviorList_inner::getMinTtl() const {
    return m_min_ttl;
}
void OAICacheBehaviorList_inner::setMinTtl(const qint32 &min_ttl) {
    m_min_ttl = min_ttl;
    m_min_ttl_isSet = true;
}

bool OAICacheBehaviorList_inner::is_min_ttl_Set() const{
    return m_min_ttl_isSet;
}

bool OAICacheBehaviorList_inner::is_min_ttl_Valid() const{
    return m_min_ttl_isValid;
}

OAIAllowedMethods OAICacheBehaviorList_inner::getAllowedMethods() const {
    return m_allowed_methods;
}
void OAICacheBehaviorList_inner::setAllowedMethods(const OAIAllowedMethods &allowed_methods) {
    m_allowed_methods = allowed_methods;
    m_allowed_methods_isSet = true;
}

bool OAICacheBehaviorList_inner::is_allowed_methods_Set() const{
    return m_allowed_methods_isSet;
}

bool OAICacheBehaviorList_inner::is_allowed_methods_Valid() const{
    return m_allowed_methods_isValid;
}

bool OAICacheBehaviorList_inner::getSmoothStreaming() const {
    return m_smooth_streaming;
}
void OAICacheBehaviorList_inner::setSmoothStreaming(const bool &smooth_streaming) {
    m_smooth_streaming = smooth_streaming;
    m_smooth_streaming_isSet = true;
}

bool OAICacheBehaviorList_inner::is_smooth_streaming_Set() const{
    return m_smooth_streaming_isSet;
}

bool OAICacheBehaviorList_inner::is_smooth_streaming_Valid() const{
    return m_smooth_streaming_isValid;
}

qint32 OAICacheBehaviorList_inner::getDefaultTtl() const {
    return m_default_ttl;
}
void OAICacheBehaviorList_inner::setDefaultTtl(const qint32 &default_ttl) {
    m_default_ttl = default_ttl;
    m_default_ttl_isSet = true;
}

bool OAICacheBehaviorList_inner::is_default_ttl_Set() const{
    return m_default_ttl_isSet;
}

bool OAICacheBehaviorList_inner::is_default_ttl_Valid() const{
    return m_default_ttl_isValid;
}

qint32 OAICacheBehaviorList_inner::getMaxTtl() const {
    return m_max_ttl;
}
void OAICacheBehaviorList_inner::setMaxTtl(const qint32 &max_ttl) {
    m_max_ttl = max_ttl;
    m_max_ttl_isSet = true;
}

bool OAICacheBehaviorList_inner::is_max_ttl_Set() const{
    return m_max_ttl_isSet;
}

bool OAICacheBehaviorList_inner::is_max_ttl_Valid() const{
    return m_max_ttl_isValid;
}

bool OAICacheBehaviorList_inner::getCompress() const {
    return m_compress;
}
void OAICacheBehaviorList_inner::setCompress(const bool &compress) {
    m_compress = compress;
    m_compress_isSet = true;
}

bool OAICacheBehaviorList_inner::is_compress_Set() const{
    return m_compress_isSet;
}

bool OAICacheBehaviorList_inner::is_compress_Valid() const{
    return m_compress_isValid;
}

OAIDefaultCacheBehavior_LambdaFunctionAssociations OAICacheBehaviorList_inner::getLambdaFunctionAssociations() const {
    return m_lambda_function_associations;
}
void OAICacheBehaviorList_inner::setLambdaFunctionAssociations(const OAIDefaultCacheBehavior_LambdaFunctionAssociations &lambda_function_associations) {
    m_lambda_function_associations = lambda_function_associations;
    m_lambda_function_associations_isSet = true;
}

bool OAICacheBehaviorList_inner::is_lambda_function_associations_Set() const{
    return m_lambda_function_associations_isSet;
}

bool OAICacheBehaviorList_inner::is_lambda_function_associations_Valid() const{
    return m_lambda_function_associations_isValid;
}

bool OAICacheBehaviorList_inner::isSet() const {
...
bool OAICacheBehaviorList_inner::isValid() const {
