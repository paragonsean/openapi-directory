...
async def test_create_cloud_front_origin_access_identity20161125(client):
    """Test case for create_cloud_front_origin_access_identity20161125

    
    """
    body = openapi_server.CreateCloudFrontOriginAccessIdentity20161125Request()
    headers = { 
        'Accept': 'text/xml',
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/origin-access-identity/cloudfront',
        headers=headers,
        json=body,
        )
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_create_distribution20161125(client):
    """Test case for create_distribution20161125

    
    """
    body = openapi_server.CreateDistribution20161125Request()
    headers = { 
        'Accept': 'text/xml',
        'Content-Type': 'text/xml',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_create_distribution_with_tags20161125(client):
    """Test case for create_distribution_with_tags20161125

    
    """
    body = openapi_server.CreateDistributionWithTags20161125Request()
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/distribution#WithTags',
        headers=headers,
        json=body,
        params=params,
        )
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_create_invalidation20161125(client):
    """Test case for create_invalidation20161125

    
    """
    body = openapi_server.CreateInvalidation20161125Request()
    headers = { 
        'Accept': 'text/xml',
        'Content-Type': 'text/xml',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/distribution/{distribution_id}/invalidation'.format(distribution_id='distribution_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_create_streaming_distribution20161125(client):
    """Test case for create_streaming_distribution20161125

    
    """
    body = openapi_server.CreateStreamingDistribution20161125Request()
    headers = { 
        'Accept': 'text/xml',
        'Content-Type': 'text/xml',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/streaming-distribution',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_create_streaming_distribution_with_tags20161125(client):
    """Test case for create_streaming_distribution_with_tags20161125

    
    """
    body = openapi_server.CreateStreamingDistributionWithTags20161125Request()
    params = [('WithTags', True)]
    headers = { 
        'Accept': 'text/xml',
        'Content-Type': 'text/xml',
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/streaming-distribution#WithTags',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_delete_cloud_front_origin_access_identity20161125(client):
    """Test case for delete_cloud_front_origin_access_identity20161125
    ...
    response = await client.request(
        method='DELETE',
        path='/2016-11-25/origin-access-identity/cloudfront/{id}'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_distribution20161125(client):
    """Test case for delete_distribution20161125
    ...
    response = await client.request(
        method='DELETE',
        path='/2016-11-25/distribution/{id}'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_streaming_distribution20161125(client):
    """Test case for delete_streaming_distribution20161125
    ...
    response = await client.request(
        method='DELETE',
        path='/2016-11-25/streaming-distribution/{id}'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_cloud_front_origin_access_identity20161125(client):
    """Test case for get_cloud_front_origin_access_identity20161125
...
async def test_get_cloud_front_origin_access_identity_config20161125(client):
    """Test case for get_cloud_front_origin_access_identity_config20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/origin-access-identity/cloudfront/{id}/config'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_distribution20161125(client):
    """Test case for get_distribution20161125
...
async def test_get_distribution_config20161125(client):
    """Test case for get_distribution_config20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/distribution/{id}/config'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_invalidation20161125(client):
    """Test case for get_invalidation20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/distribution/{distribution_id}/invalidation/{id}'.format(distribution_id='distribution_id_example', id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_streaming_distribution20161125(client):
    """Test case for get_streaming_distribution20161125
...
async def test_get_streaming_distribution_config20161125(client):
    """Test case for get_streaming_distribution_config20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/streaming-distribution/{id}/config'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_cloud_front_origin_access_identities20161125(client):
    """Test case for list_cloud_front_origin_access_identities20161125
...
async def test_list_distributions20161125(client):
    """Test case for list_distributions20161125
...
async def test_list_distributions_by_web_aclid20161125(client):
    """Test case for list_distributions_by_web_aclid20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/distributionsByWebACLId/{web_aclid}'.format(web_aclid='web_aclid_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_invalidations20161125(client):
    """Test case for list_invalidations20161125
...
async def test_list_streaming_distributions20161125(client):
    """Test case for list_streaming_distributions20161125
...
async def test_list_tags_for_resource20161125(client):
    """Test case for list_tags_for_resource20161125
    ...
    response = await client.request(
        method='GET',
        path='/2016-11-25/tagging#Resource',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_tag_resource20161125(client):
    """Test case for tag_resource20161125

    
    """
    body = openapi_server.TagResource20161125Request()
    params = [('Resource', 'resource_example'),
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/tagging#Operation=Tag&Resource',
        headers=headers,
        json=body,
        params=params,
        )
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_untag_resource20161125(client):
    """Test case for untag_resource20161125

    
    """
    body = openapi_server.UntagResource20161125Request()
    params = [('Resource', 'resource_example'),
                    ('Operation', 'operation_example')]
    headers = { 
        'Accept': 'text/xml',
    ...
    response = await client.request(
        method='POST',
        path='/2016-11-25/tagging#Operation=Untag&Resource',
        headers=headers,
        json=body,
        params=params,
        )
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_update_cloud_front_origin_access_identity20161125(client):
    """Test case for update_cloud_front_origin_access_identity20161125
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_update_distribution20161125(client):
    """Test case for update_distribution20161125
...
@pytest.mark.skip("text/xml not supported by Connexion")
async def test_update_streaming_distribution20161125(client):
    """Test case for update_streaming_distribution20161125
