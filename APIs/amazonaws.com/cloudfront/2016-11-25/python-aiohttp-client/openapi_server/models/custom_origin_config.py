...
class CustomOriginConfig(Model):
    ...
    def __init__(self, http_port: int=None, https_port: int=None, origin_protocol_policy: OriginProtocolPolicy=None, origin_ssl_protocols: CustomOriginConfigOriginSslProtocols=None):
        """CustomOriginConfig - a model defined in OpenAPI

        :param http_port: The http_port of this CustomOriginConfig.
        :param https_port: The https_port of this CustomOriginConfig.
        :param origin_protocol_policy: The origin_protocol_policy of this CustomOriginConfig.
        :param origin_ssl_protocols: The origin_ssl_protocols of this CustomOriginConfig.
        """
        self.openapi_types = {
            'http_port': int,
            'https_port': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomOriginConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomOriginConfig of this CustomOriginConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def http_port(self):
        """Gets the http_port of this CustomOriginConfig.


        :return: The http_port of this CustomOriginConfig.
        :rtype: int
        """
    ...
    def http_port(self, http_port):
        """Sets the http_port of this CustomOriginConfig.
    ...
    @property
    def https_port(self):
        """Gets the https_port of this CustomOriginConfig.


        :return: The https_port of this CustomOriginConfig.
        :rtype: int
        """
    ...
    def https_port(self, https_port):
        """Sets the https_port of this CustomOriginConfig.
    ...
    def origin_protocol_policy(self):
        """Gets the origin_protocol_policy of this CustomOriginConfig.


        :return: The origin_protocol_policy of this CustomOriginConfig.
    ...
    def origin_protocol_policy(self, origin_protocol_policy):
        """Sets the origin_protocol_policy of this CustomOriginConfig.
    ...
    def origin_ssl_protocols(self):
        """Gets the origin_ssl_protocols of this CustomOriginConfig.


        :return: The origin_ssl_protocols of this CustomOriginConfig.
    ...
    def origin_ssl_protocols(self, origin_ssl_protocols):
        """Sets the origin_ssl_protocols of this CustomOriginConfig.
