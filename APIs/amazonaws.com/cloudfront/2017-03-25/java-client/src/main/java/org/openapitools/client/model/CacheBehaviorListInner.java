...
public class CacheBehaviorListInner {
  ...
  public CacheBehaviorListInner trustedSigners(DefaultCacheBehaviorTrustedSigners trustedSigners) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pathPattern, targetOriginId, forwardedValues, trustedSigners, viewerProtocolPolicy, minTTL, allowedMethods, smoothStreaming, defaultTTL, maxTTL, compress, lambdaFunctionAssociations);
  }
