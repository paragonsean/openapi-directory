...
OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_S3Origin OAIStreamingDistributionConfig::getS3Origin() const {
    return m_s3_origin;
}
void OAIStreamingDistributionConfig::setS3Origin(const OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_S3Origin &s3_origin) {
...
OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_Aliases OAIStreamingDistributionConfig::getAliases() const {
    return m_aliases;
}
void OAIStreamingDistributionConfig::setAliases(const OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
...
OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_Logging OAIStreamingDistributionConfig::getLogging() const {
    return m_logging;
}
void OAIStreamingDistributionConfig::setLogging(const OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_Logging &logging) {
    m_logging = logging;
...
OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_TrustedSigners OAIStreamingDistributionConfig::getTrustedSigners() const {
    return m_trusted_signers;
}
void OAIStreamingDistributionConfig::setTrustedSigners(const OAICreateStreamingDistribution2017_03_25_request_StreamingDistributionConfig_TrustedSigners &trusted_signers) {
