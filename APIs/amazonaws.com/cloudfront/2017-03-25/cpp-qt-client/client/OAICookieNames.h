...
#ifndef OAICookieNames_H
#define OAICookieNames_H
...
class OAICookieNames : public OAIObject {
public:
    OAICookieNames();
    OAICookieNames(QString json);
    ~OAICookieNames() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICookieNames)

#endif // OAICookieNames_H
