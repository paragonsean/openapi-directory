...
#ifndef OAIInvalidationList_H
#define OAIInvalidationList_H
...
class OAIInvalidationList : public OAIObject {
public:
    OAIInvalidationList();
    OAIInvalidationList(QString json);
    ~OAIInvalidationList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvalidationList)

#endif // OAIInvalidationList_H
