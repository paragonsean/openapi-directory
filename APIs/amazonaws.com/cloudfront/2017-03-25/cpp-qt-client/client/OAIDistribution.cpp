...
QString OAIDistribution::getId() const {
    return m_id;
}
void OAIDistribution::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDistribution::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDistribution::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDistribution::getArn() const {
    return m_arn;
}
void OAIDistribution::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDistribution::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDistribution::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDistribution::getStatus() const {
    return m_status;
}
void OAIDistribution::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDistribution::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDistribution::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDistribution::getLastModifiedTime() const {
    return m_last_modified_time;
}
void OAIDistribution::setLastModifiedTime(const QDateTime &last_modified_time) {
    m_last_modified_time = last_modified_time;
    m_last_modified_time_isSet = true;
}

bool OAIDistribution::is_last_modified_time_Set() const{
    return m_last_modified_time_isSet;
}

bool OAIDistribution::is_last_modified_time_Valid() const{
    return m_last_modified_time_isValid;
}

qint32 OAIDistribution::getInProgressInvalidationBatches() const {
    return m_in_progress_invalidation_batches;
}
void OAIDistribution::setInProgressInvalidationBatches(const qint32 &in_progress_invalidation_batches) {
    m_in_progress_invalidation_batches = in_progress_invalidation_batches;
    m_in_progress_invalidation_batches_isSet = true;
}

bool OAIDistribution::is_in_progress_invalidation_batches_Set() const{
    return m_in_progress_invalidation_batches_isSet;
}

bool OAIDistribution::is_in_progress_invalidation_batches_Valid() const{
    return m_in_progress_invalidation_batches_isValid;
}

QString OAIDistribution::getDomainName() const {
    return m_domain_name;
}
void OAIDistribution::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIDistribution::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIDistribution::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

OAIDistribution_ActiveTrustedSigners OAIDistribution::getActiveTrustedSigners() const {
    return m_active_trusted_signers;
}
void OAIDistribution::setActiveTrustedSigners(const OAIDistribution_ActiveTrustedSigners &active_trusted_signers) {
    m_active_trusted_signers = active_trusted_signers;
    m_active_trusted_signers_isSet = true;
}

bool OAIDistribution::is_active_trusted_signers_Set() const{
    return m_active_trusted_signers_isSet;
}

bool OAIDistribution::is_active_trusted_signers_Valid() const{
    return m_active_trusted_signers_isValid;
}

OAIDistribution_DistributionConfig OAIDistribution::getDistributionConfig() const {
    return m_distribution_config;
}
void OAIDistribution::setDistributionConfig(const OAIDistribution_DistributionConfig &distribution_config) {
    m_distribution_config = distribution_config;
    m_distribution_config_isSet = true;
}

bool OAIDistribution::is_distribution_config_Set() const{
    return m_distribution_config_isSet;
}

bool OAIDistribution::is_distribution_config_Valid() const{
