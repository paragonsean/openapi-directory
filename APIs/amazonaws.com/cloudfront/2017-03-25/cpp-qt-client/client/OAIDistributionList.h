...
/*
 * OAIDistributionList.h
 *
 * A distribution list.
 */

#ifndef OAIDistributionList_H
#define OAIDistributionList_H
...
class OAIDistributionList : public OAIObject {
public:
    OAIDistributionList();
    OAIDistributionList(QString json);
    ~OAIDistributionList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributionList)

#endif // OAIDistributionList_H
