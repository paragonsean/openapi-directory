...
/**
 * The InvalidationList model module.
 * @module model/InvalidationList
 * @version 2017-03-25
 */
class InvalidationList {
    /**
     * Constructs a new <code>InvalidationList</code>.
     ...
     * @alias module:model/InvalidationList
     * @param marker {String} 
    ...
    /**
     * Constructs a <code>InvalidationList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvalidationList} obj Optional instance to populate.
     * @return {module:model/InvalidationList} The populated <code>InvalidationList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvalidationList();
    ...
    /**
     * Validates the JSON data with respect to <code>InvalidationList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvalidationList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InvalidationList.RequiredProperties) {
...
InvalidationList.RequiredProperties = ["Marker", "MaxItems", "IsTruncated", "Quantity"];
...
export default InvalidationList;
