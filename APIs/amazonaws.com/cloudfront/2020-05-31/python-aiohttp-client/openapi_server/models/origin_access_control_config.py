...
class OriginAccessControlConfig(Model):
    ...
    def __init__(self, name: str=None, description: str=None, signing_protocol: OriginAccessControlSigningProtocols=None, signing_behavior: OriginAccessControlSigningBehaviors=None, origin_access_control_origin_type: OriginAccessControlOriginTypes=None):
        """OriginAccessControlConfig - a model defined in OpenAPI

        :param name: The name of this OriginAccessControlConfig.
        :param description: The description of this OriginAccessControlConfig.
        :param signing_protocol: The signing_protocol of this OriginAccessControlConfig.
        :param signing_behavior: The signing_behavior of this OriginAccessControlConfig.
        :param origin_access_control_origin_type: The origin_access_control_origin_type of this OriginAccessControlConfig.
        """
        self.openapi_types = {
            'name': str,
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OriginAccessControlConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OriginAccessControlConfig of this OriginAccessControlConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this OriginAccessControlConfig.


        :return: The name of this OriginAccessControlConfig.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OriginAccessControlConfig.
    ...
    def description(self):
        """Gets the description of this OriginAccessControlConfig.


        :return: The description of this OriginAccessControlConfig.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this OriginAccessControlConfig.
    ...
    def signing_protocol(self):
        """Gets the signing_protocol of this OriginAccessControlConfig.


        :return: The signing_protocol of this OriginAccessControlConfig.
    ...
    def signing_protocol(self, signing_protocol):
        """Sets the signing_protocol of this OriginAccessControlConfig.
    ...
    def signing_behavior(self):
        """Gets the signing_behavior of this OriginAccessControlConfig.


        :return: The signing_behavior of this OriginAccessControlConfig.
    ...
    def signing_behavior(self, signing_behavior):
        """Sets the signing_behavior of this OriginAccessControlConfig.
    ...
    def origin_access_control_origin_type(self):
        """Gets the origin_access_control_origin_type of this OriginAccessControlConfig.


        :return: The origin_access_control_origin_type of this OriginAccessControlConfig.
    ...
    def origin_access_control_origin_type(self, origin_access_control_origin_type):
        """Sets the origin_access_control_origin_type of this OriginAccessControlConfig.
