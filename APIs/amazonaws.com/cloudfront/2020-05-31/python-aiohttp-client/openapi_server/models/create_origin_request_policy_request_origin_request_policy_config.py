...
class CreateOriginRequestPolicyRequestOriginRequestPolicyConfig(Model):
    ...
    def __init__(self, comment: str=None, name: str=None, headers_config: CreateOriginRequestPolicy20200531RequestOriginRequestPolicyConfigHeadersConfig=None, cookies_config: CreateOriginRequestPolicy20200531RequestOriginRequestPolicyConfigCookiesConfig=None, query_strings_config: CreateOriginRequestPolicy20200531RequestOriginRequestPolicyConfigQueryStringsConfig=None):
        """CreateOriginRequestPolicyRequestOriginRequestPolicyConfig - a model defined in OpenAPI

        :param comment: The comment of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :param name: The name of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :param headers_config: The headers_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :param cookies_config: The cookies_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :param query_strings_config: The query_strings_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        """
        self.openapi_types = {
            'comment': str,
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateOriginRequestPolicyRequestOriginRequestPolicyConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateOriginRequestPolicyRequest_OriginRequestPolicyConfig of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def comment(self):
        """Gets the comment of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.


        :return: The comment of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    @property
    def name(self):
        """Gets the name of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.


        :return: The name of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def headers_config(self):
        """Gets the headers_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.


        :return: The headers_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def headers_config(self, headers_config):
        """Sets the headers_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def cookies_config(self):
        """Gets the cookies_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.


        :return: The cookies_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def cookies_config(self, cookies_config):
        """Sets the cookies_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def query_strings_config(self):
        """Gets the query_strings_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.


        :return: The query_strings_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
    ...
    def query_strings_config(self, query_strings_config):
        """Sets the query_strings_config of this CreateOriginRequestPolicyRequestOriginRequestPolicyConfig.
