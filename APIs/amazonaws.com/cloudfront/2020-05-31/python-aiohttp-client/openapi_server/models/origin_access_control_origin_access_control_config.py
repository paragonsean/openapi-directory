...
class OriginAccessControlOriginAccessControlConfig(Model):
    ...
    def __init__(self, name: str=None, description: str=None, signing_protocol: OriginAccessControlSigningProtocols=None, signing_behavior: OriginAccessControlSigningBehaviors=None, origin_access_control_origin_type: OriginAccessControlOriginTypes=None):
        """OriginAccessControlOriginAccessControlConfig - a model defined in OpenAPI

        :param name: The name of this OriginAccessControlOriginAccessControlConfig.
        :param description: The description of this OriginAccessControlOriginAccessControlConfig.
        :param signing_protocol: The signing_protocol of this OriginAccessControlOriginAccessControlConfig.
        :param signing_behavior: The signing_behavior of this OriginAccessControlOriginAccessControlConfig.
        :param origin_access_control_origin_type: The origin_access_control_origin_type of this OriginAccessControlOriginAccessControlConfig.
        """
        self.openapi_types = {
            'name': str,
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'OriginAccessControlOriginAccessControlConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The OriginAccessControl_OriginAccessControlConfig of this OriginAccessControlOriginAccessControlConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this OriginAccessControlOriginAccessControlConfig.


        :return: The name of this OriginAccessControlOriginAccessControlConfig.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OriginAccessControlOriginAccessControlConfig.
    ...
    def description(self):
        """Gets the description of this OriginAccessControlOriginAccessControlConfig.


        :return: The description of this OriginAccessControlOriginAccessControlConfig.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this OriginAccessControlOriginAccessControlConfig.
    ...
    def signing_protocol(self):
        """Gets the signing_protocol of this OriginAccessControlOriginAccessControlConfig.


        :return: The signing_protocol of this OriginAccessControlOriginAccessControlConfig.
    ...
    def signing_protocol(self, signing_protocol):
        """Sets the signing_protocol of this OriginAccessControlOriginAccessControlConfig.
    ...
    def signing_behavior(self):
        """Gets the signing_behavior of this OriginAccessControlOriginAccessControlConfig.


        :return: The signing_behavior of this OriginAccessControlOriginAccessControlConfig.
    ...
    def signing_behavior(self, signing_behavior):
        """Sets the signing_behavior of this OriginAccessControlOriginAccessControlConfig.
    ...
    def origin_access_control_origin_type(self):
        """Gets the origin_access_control_origin_type of this OriginAccessControlOriginAccessControlConfig.


        :return: The origin_access_control_origin_type of this OriginAccessControlOriginAccessControlConfig.
    ...
    def origin_access_control_origin_type(self, origin_access_control_origin_type):
        """Sets the origin_access_control_origin_type of this OriginAccessControlOriginAccessControlConfig.
