...
class ContentTypeProfileConfig(Model):
    ...
    def __init__(self, forward_when_content_type_is_unknown: bool=None, content_type_profiles: ContentTypeProfileConfigContentTypeProfiles=None):
        """ContentTypeProfileConfig - a model defined in OpenAPI

        :param forward_when_content_type_is_unknown: The forward_when_content_type_is_unknown of this ContentTypeProfileConfig.
        :param content_type_profiles: The content_type_profiles of this ContentTypeProfileConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ContentTypeProfileConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ContentTypeProfileConfig of this ContentTypeProfileConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def forward_when_content_type_is_unknown(self):
        """Gets the forward_when_content_type_is_unknown of this ContentTypeProfileConfig.


        :return: The forward_when_content_type_is_unknown of this ContentTypeProfileConfig.
        :rtype: bool
        """
    ...
    def forward_when_content_type_is_unknown(self, forward_when_content_type_is_unknown):
        """Sets the forward_when_content_type_is_unknown of this ContentTypeProfileConfig.
    ...
    def content_type_profiles(self):
        """Gets the content_type_profiles of this ContentTypeProfileConfig.


        :return: The content_type_profiles of this ContentTypeProfileConfig.
    ...
    def content_type_profiles(self, content_type_profiles):
        """Sets the content_type_profiles of this ContentTypeProfileConfig.
