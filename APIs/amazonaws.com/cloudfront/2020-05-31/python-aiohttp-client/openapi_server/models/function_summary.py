...
class FunctionSummary(Model):
    ...
    def __init__(self, name: str=None, status: str=None, function_config: FunctionSummaryFunctionConfig=None, function_metadata: FunctionSummaryFunctionMetadata=None):
        """FunctionSummary - a model defined in OpenAPI

        :param name: The name of this FunctionSummary.
        :param status: The status of this FunctionSummary.
        :param function_config: The function_config of this FunctionSummary.
        :param function_metadata: The function_metadata of this FunctionSummary.
        """
        self.openapi_types = {
            'name': str,
            'status': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FunctionSummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FunctionSummary of this FunctionSummary.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this FunctionSummary.


        :return: The name of this FunctionSummary.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FunctionSummary.
    ...
    @property
    def status(self):
        """Gets the status of this FunctionSummary.


        :return: The status of this FunctionSummary.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this FunctionSummary.
    ...
    def function_config(self):
        """Gets the function_config of this FunctionSummary.


        :return: The function_config of this FunctionSummary.
    ...
    def function_config(self, function_config):
        """Sets the function_config of this FunctionSummary.
    ...
    def function_metadata(self):
        """Gets the function_metadata of this FunctionSummary.


        :return: The function_metadata of this FunctionSummary.
    ...
    def function_metadata(self, function_metadata):
        """Sets the function_metadata of this FunctionSummary.
