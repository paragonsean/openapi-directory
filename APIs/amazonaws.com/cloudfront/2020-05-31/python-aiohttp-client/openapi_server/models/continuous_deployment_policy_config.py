...
class ContinuousDeploymentPolicyConfig(Model):
    ...
    def __init__(self, staging_distribution_dns_names: CreateContinuousDeploymentPolicy20200531RequestContinuousDeploymentPolicyConfigStagingDistributionDnsNames=None, enabled: bool=None, traffic_config: CreateContinuousDeploymentPolicy20200531RequestContinuousDeploymentPolicyConfigTrafficConfig=None):
        """ContinuousDeploymentPolicyConfig - a model defined in OpenAPI

        :param staging_distribution_dns_names: The staging_distribution_dns_names of this ContinuousDeploymentPolicyConfig.
        :param enabled: The enabled of this ContinuousDeploymentPolicyConfig.
        :param traffic_config: The traffic_config of this ContinuousDeploymentPolicyConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ContinuousDeploymentPolicyConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ContinuousDeploymentPolicyConfig of this ContinuousDeploymentPolicyConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def staging_distribution_dns_names(self):
        """Gets the staging_distribution_dns_names of this ContinuousDeploymentPolicyConfig.


        :return: The staging_distribution_dns_names of this ContinuousDeploymentPolicyConfig.
    ...
    def staging_distribution_dns_names(self, staging_distribution_dns_names):
        """Sets the staging_distribution_dns_names of this ContinuousDeploymentPolicyConfig.
    ...
    @property
    def enabled(self):
        """Gets the enabled of this ContinuousDeploymentPolicyConfig.


        :return: The enabled of this ContinuousDeploymentPolicyConfig.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this ContinuousDeploymentPolicyConfig.
    ...
    def traffic_config(self):
        """Gets the traffic_config of this ContinuousDeploymentPolicyConfig.


        :return: The traffic_config of this ContinuousDeploymentPolicyConfig.
    ...
    def traffic_config(self, traffic_config):
        """Sets the traffic_config of this ContinuousDeploymentPolicyConfig.
