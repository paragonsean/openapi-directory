...
class CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig(Model):
    ...
    def __init__(self, staging_distribution_dns_names: CreateContinuousDeploymentPolicy20200531RequestContinuousDeploymentPolicyConfigStagingDistributionDnsNames=None, enabled: bool=None, traffic_config: CreateContinuousDeploymentPolicy20200531RequestContinuousDeploymentPolicyConfigTrafficConfig=None):
        """CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig - a model defined in OpenAPI

        :param staging_distribution_dns_names: The staging_distribution_dns_names of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
        :param enabled: The enabled of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
        :param traffic_config: The traffic_config of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateContinuousDeploymentPolicyRequest_ContinuousDeploymentPolicyConfig of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def staging_distribution_dns_names(self):
        """Gets the staging_distribution_dns_names of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.


        :return: The staging_distribution_dns_names of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
    ...
    def staging_distribution_dns_names(self, staging_distribution_dns_names):
        """Sets the staging_distribution_dns_names of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
    ...
    @property
    def enabled(self):
        """Gets the enabled of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.


        :return: The enabled of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
    ...
    def traffic_config(self):
        """Gets the traffic_config of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.


        :return: The traffic_config of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
    ...
    def traffic_config(self, traffic_config):
        """Sets the traffic_config of this CreateContinuousDeploymentPolicyRequestContinuousDeploymentPolicyConfig.
