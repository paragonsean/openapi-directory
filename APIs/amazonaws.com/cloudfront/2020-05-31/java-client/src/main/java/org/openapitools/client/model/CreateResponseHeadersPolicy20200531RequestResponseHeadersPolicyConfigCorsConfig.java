...
public class CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig() {
  }

  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlAllowOrigins(ResponseHeadersPolicyCorsConfigAccessControlAllowOrigins accessControlAllowOrigins) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlAllowHeaders(ResponseHeadersPolicyCorsConfigAccessControlAllowHeaders accessControlAllowHeaders) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlAllowMethods(ResponseHeadersPolicyCorsConfigAccessControlAllowMethods accessControlAllowMethods) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlAllowCredentials(Boolean accessControlAllowCredentials) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlExposeHeaders(ResponseHeadersPolicyCorsConfigAccessControlExposeHeaders accessControlExposeHeaders) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig accessControlMaxAgeSec(Integer accessControlMaxAgeSec) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig originOverride(Boolean originOverride) {
  ...
  public boolean equals(Object o) {
    ...
    CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig = (CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig) o;
    return Objects.equals(this.accessControlAllowOrigins, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlAllowOrigins) &&
        Objects.equals(this.accessControlAllowHeaders, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlAllowHeaders) &&
        Objects.equals(this.accessControlAllowMethods, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlAllowMethods) &&
        Objects.equals(this.accessControlAllowCredentials, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlAllowCredentials) &&
        Objects.equals(this.accessControlExposeHeaders, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlExposeHeaders) &&
        Objects.equals(this.accessControlMaxAgeSec, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.accessControlMaxAgeSec) &&
        Objects.equals(this.originOverride, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.originOverride);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig is not found in the empty JSON string", CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig>() {
           @Override
           public void write(JsonWriter out, CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig
   * @throws IOException if the JSON string is invalid with respect to CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig
   */
  public static CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig.class);
  }

  /**
   * Convert an instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigCorsConfig to an JSON string
   *
   * @return JSON string
   */
