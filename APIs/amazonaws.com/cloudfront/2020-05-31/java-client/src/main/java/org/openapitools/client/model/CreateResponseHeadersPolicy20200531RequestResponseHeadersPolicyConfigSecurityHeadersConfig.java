...
public class CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig() {
  }

  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig xsSProtection(ResponseHeadersPolicySecurityHeadersConfigXSSProtection xsSProtection) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig frameOptions(ResponseHeadersPolicySecurityHeadersConfigFrameOptions frameOptions) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig referrerPolicy(ResponseHeadersPolicySecurityHeadersConfigReferrerPolicy referrerPolicy) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig contentSecurityPolicy(ResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicy contentSecurityPolicy) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig contentTypeOptions(ResponseHeadersPolicySecurityHeadersConfigContentTypeOptions contentTypeOptions) {
  ...
  public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig strictTransportSecurity(ResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurity strictTransportSecurity) {
  ...
  public boolean equals(Object o) {
    ...
    CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig = (CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig) o;
    return Objects.equals(this.xsSProtection, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.xsSProtection) &&
        Objects.equals(this.frameOptions, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.frameOptions) &&
        Objects.equals(this.referrerPolicy, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.referrerPolicy) &&
        Objects.equals(this.contentSecurityPolicy, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.contentSecurityPolicy) &&
        Objects.equals(this.contentTypeOptions, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.contentTypeOptions) &&
        Objects.equals(this.strictTransportSecurity, createResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.strictTransportSecurity);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig is not found in the empty JSON string", CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig>() {
           @Override
           public void write(JsonWriter out, CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig
   * @throws IOException if the JSON string is invalid with respect to CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig
   */
  public static CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig.class);
  }

  /**
   * Convert an instance of CreateResponseHeadersPolicy20200531RequestResponseHeadersPolicyConfigSecurityHeadersConfig to an JSON string
   *
   * @return JSON string
   */
