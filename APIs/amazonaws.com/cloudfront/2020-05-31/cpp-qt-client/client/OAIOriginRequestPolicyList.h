...
/*
 * OAIOriginRequestPolicyList.h
 *
 * A list of origin request policies.
 */

#ifndef OAIOriginRequestPolicyList_H
#define OAIOriginRequestPolicyList_H
...
class OAIOriginRequestPolicyList : public OAIObject {
public:
    OAIOriginRequestPolicyList();
    OAIOriginRequestPolicyList(QString json);
    ~OAIOriginRequestPolicyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginRequestPolicyList)

#endif // OAIOriginRequestPolicyList_H
