...
/*
 * OAIListKeyGroupsResult_KeyGroupList.h
 *
 * 
 */

#ifndef OAIListKeyGroupsResult_KeyGroupList_H
#define OAIListKeyGroupsResult_KeyGroupList_H
...
class OAIListKeyGroupsResult_KeyGroupList : public OAIObject {
public:
    OAIListKeyGroupsResult_KeyGroupList();
    OAIListKeyGroupsResult_KeyGroupList(QString json);
    ~OAIListKeyGroupsResult_KeyGroupList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListKeyGroupsResult_KeyGroupList)

#endif // OAIListKeyGroupsResult_KeyGroupList_H
