...
void OAICreateDistributionResult_Distribution::initializeModel() {
    ...
    m_active_trusted_key_groups_isSet = false;
    m_active_trusted_key_groups_isValid = false;
...
void OAICreateDistributionResult_Distribution::fromJsonObject(QJsonObject json) {
    ...
    m_active_trusted_key_groups_isValid = ::OpenAPI::fromJsonValue(m_active_trusted_key_groups, json[QString("ActiveTrustedKeyGroups")]);
    m_active_trusted_key_groups_isSet = !json[QString("ActiveTrustedKeyGroups")].isNull() && m_active_trusted_key_groups_isValid;
...
QJsonObject OAICreateDistributionResult_Distribution::asJsonObject() const {
    ...
    if (m_active_trusted_key_groups.isSet()) {
        obj.insert(QString("ActiveTrustedKeyGroups"), ::OpenAPI::toJsonValue(m_active_trusted_key_groups));
    }
...
OAIDistribution_ActiveTrustedKeyGroups OAICreateDistributionResult_Distribution::getActiveTrustedKeyGroups() const {
    return m_active_trusted_key_groups;
}
void OAICreateDistributionResult_Distribution::setActiveTrustedKeyGroups(const OAIDistribution_ActiveTrustedKeyGroups &active_trusted_key_groups) {
    m_active_trusted_key_groups = active_trusted_key_groups;
    m_active_trusted_key_groups_isSet = true;
}

bool OAICreateDistributionResult_Distribution::is_active_trusted_key_groups_Set() const{
    return m_active_trusted_key_groups_isSet;
}

bool OAICreateDistributionResult_Distribution::is_active_trusted_key_groups_Valid() const{
    return m_active_trusted_key_groups_isValid;
}
...
bool OAICreateDistributionResult_Distribution::isValid() const {
    ...
    return m_id_isValid && m_arn_isValid && m_status_isValid && m_last_modified_time_isValid && m_in_progress_invalidation_batches_isValid && m_domain_name_isValid && m_distribution_config_isValid && true;
}
