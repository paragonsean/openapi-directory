...
/*
 * OAIDistributionIdList.h
 *
 * A list of distribution IDs.
 */

#ifndef OAIDistributionIdList_H
#define OAIDistributionIdList_H
...
class OAIDistributionIdList : public OAIObject {
public:
    OAIDistributionIdList();
    OAIDistributionIdList(QString json);
    ~OAIDistributionIdList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributionIdList)

#endif // OAIDistributionIdList_H
