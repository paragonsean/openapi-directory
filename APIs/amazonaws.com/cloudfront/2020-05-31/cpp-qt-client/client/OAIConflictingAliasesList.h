...
/*
 * OAIConflictingAliasesList.h
 *
 * A list of aliases (also called CNAMEs) and the CloudFront distributions and Amazon Web Services accounts that they are associated with. In the list, the distribution and account IDs are partially hidden, which allows you to identify the distributions and accounts that you own, but helps to protect the information of ones that you don&#39;t own.
 */

#ifndef OAIConflictingAliasesList_H
#define OAIConflictingAliasesList_H
...
class OAIConflictingAliasesList : public OAIObject {
public:
    OAIConflictingAliasesList();
    OAIConflictingAliasesList(QString json);
    ~OAIConflictingAliasesList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConflictingAliasesList)

#endif // OAIConflictingAliasesList_H
