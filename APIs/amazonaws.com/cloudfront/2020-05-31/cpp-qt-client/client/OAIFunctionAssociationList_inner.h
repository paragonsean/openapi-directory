...
/*
 * OAIFunctionAssociationList_inner.h
 *
 * 
 */

#ifndef OAIFunctionAssociationList_inner_H
#define OAIFunctionAssociationList_inner_H
...
class OAIFunctionAssociationList_inner : public OAIObject {
public:
    OAIFunctionAssociationList_inner();
    OAIFunctionAssociationList_inner(QString json);
    ~OAIFunctionAssociationList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFunctionAssociationList_inner)

#endif // OAIFunctionAssociationList_inner_H
