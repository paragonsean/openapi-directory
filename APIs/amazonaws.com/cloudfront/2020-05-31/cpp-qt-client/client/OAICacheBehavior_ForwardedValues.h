...
/*
 * OAICacheBehavior_ForwardedValues.h
 *
 * 
 */

#ifndef OAICacheBehavior_ForwardedValues_H
#define OAICacheBehavior_ForwardedValues_H
...
class OAICacheBehavior_ForwardedValues : public OAIObject {
public:
    OAICacheBehavior_ForwardedValues();
    OAICacheBehavior_ForwardedValues(QString json);
    ~OAICacheBehavior_ForwardedValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICacheBehavior_ForwardedValues)

#endif // OAICacheBehavior_ForwardedValues_H
