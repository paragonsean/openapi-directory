...
/*
 * OAICachePolicyList.h
 *
 * A list of cache policies.
 */

#ifndef OAICachePolicyList_H
#define OAICachePolicyList_H
...
class OAICachePolicyList : public OAIObject {
public:
    OAICachePolicyList();
    OAICachePolicyList(QString json);
    ~OAICachePolicyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICachePolicyList)

#endif // OAICachePolicyList_H
