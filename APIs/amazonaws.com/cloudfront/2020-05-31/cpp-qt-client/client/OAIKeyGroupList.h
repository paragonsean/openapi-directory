...
#ifndef OAIKeyGroupList_H
#define OAIKeyGroupList_H
...
class OAIKeyGroupList : public OAIObject {
public:
    OAIKeyGroupList();
    OAIKeyGroupList(QString json);
    ~OAIKeyGroupList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyGroupList)

#endif // OAIKeyGroupList_H
