...
#ifndef OAIPublicKeyList_H
#define OAIPublicKeyList_H
...
class OAIPublicKeyList : public OAIObject {
public:
    OAIPublicKeyList();
    OAIPublicKeyList(QString json);
    ~OAIPublicKeyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublicKeyList)

#endif // OAIPublicKeyList_H
