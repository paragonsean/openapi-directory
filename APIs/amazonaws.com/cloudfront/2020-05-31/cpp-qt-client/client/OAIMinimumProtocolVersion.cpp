...
void OAIMinimumProtocolVersion::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("TLSv1.2_2021", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMinimumProtocolVersion::TLSV1_2_2021;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIMinimumProtocolVersion::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIMinimumProtocolVersion::TLSV1_2_2019:
            val = "TLSv1.2_2019";
            break;
        case eOAIMinimumProtocolVersion::TLSV1_2_2021:
            val = "TLSv1.2_2021";
            break;
        default:
            break;
