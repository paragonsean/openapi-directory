...
OAIOrigin_OriginShield OAIOriginList_inner::getOriginShield() const {
    return m_origin_shield;
}
void OAIOriginList_inner::setOriginShield(const OAIOrigin_OriginShield &origin_shield) {
    m_origin_shield = origin_shield;
    m_origin_shield_isSet = true;
}

bool OAIOriginList_inner::is_origin_shield_Set() const{
    return m_origin_shield_isSet;
}

bool OAIOriginList_inner::is_origin_shield_Valid() const{
    return m_origin_shield_isValid;
}

QString OAIOriginList_inner::getOriginAccessControlId() const {
    return m_origin_access_control_id;
}
void OAIOriginList_inner::setOriginAccessControlId(const QString &origin_access_control_id) {
    m_origin_access_control_id = origin_access_control_id;
    m_origin_access_control_id_isSet = true;
}

bool OAIOriginList_inner::is_origin_access_control_id_Set() const{
    return m_origin_access_control_id_isSet;
}

bool OAIOriginList_inner::is_origin_access_control_id_Valid() const{
