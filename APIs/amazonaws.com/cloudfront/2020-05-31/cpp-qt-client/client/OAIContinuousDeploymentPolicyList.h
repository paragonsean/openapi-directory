...
/*
 * OAIContinuousDeploymentPolicyList.h
 *
 * Contains a list of continuous deployment policies.
 */

#ifndef OAIContinuousDeploymentPolicyList_H
#define OAIContinuousDeploymentPolicyList_H
...
class OAIContinuousDeploymentPolicyList : public OAIObject {
public:
    OAIContinuousDeploymentPolicyList();
    OAIContinuousDeploymentPolicyList(QString json);
    ~OAIContinuousDeploymentPolicyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContinuousDeploymentPolicyList)

#endif // OAIContinuousDeploymentPolicyList_H
