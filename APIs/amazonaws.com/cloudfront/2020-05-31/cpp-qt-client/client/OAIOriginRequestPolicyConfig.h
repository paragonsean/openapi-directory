...
/*
 * OAIOriginRequestPolicyConfig.h
 *
...
#ifndef OAIOriginRequestPolicyConfig_H
#define OAIOriginRequestPolicyConfig_H
...
class OAIOriginRequestPolicyConfig : public OAIObject {
public:
    OAIOriginRequestPolicyConfig();
    OAIOriginRequestPolicyConfig(QString json);
    ~OAIOriginRequestPolicyConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginRequestPolicyConfig)

#endif // OAIOriginRequestPolicyConfig_H
