...
/*
 * OAIOriginAccessControlList.h
 *
 * A list of CloudFront origin access controls.
 */

#ifndef OAIOriginAccessControlList_H
#define OAIOriginAccessControlList_H
...
class OAIOriginAccessControlList : public OAIObject {
public:
    OAIOriginAccessControlList();
    OAIOriginAccessControlList(QString json);
    ~OAIOriginAccessControlList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginAccessControlList)

#endif // OAIOriginAccessControlList_H
