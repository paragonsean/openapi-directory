...
/*
 * OAIFieldLevelEncryptionList.h
 *
 * List of field-level encrpytion configurations.
 */

#ifndef OAIFieldLevelEncryptionList_H
#define OAIFieldLevelEncryptionList_H
...
class OAIFieldLevelEncryptionList : public OAIObject {
public:
    OAIFieldLevelEncryptionList();
    OAIFieldLevelEncryptionList(QString json);
    ~OAIFieldLevelEncryptionList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldLevelEncryptionList)

#endif // OAIFieldLevelEncryptionList_H
