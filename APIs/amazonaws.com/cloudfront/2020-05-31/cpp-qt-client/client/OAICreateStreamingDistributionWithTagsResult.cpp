...
OAICreateStreamingDistributionResult_StreamingDistribution OAICreateStreamingDistributionWithTagsResult::getStreamingDistribution() const {
    return m_streaming_distribution;
}
void OAICreateStreamingDistributionWithTagsResult::setStreamingDistribution(const OAICreateStreamingDistributionResult_StreamingDistribution &streaming_distribution) {
