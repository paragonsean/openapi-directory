...
/*
 * OAIRealtimeLogConfigs.h
 *
 * A list of real-time log configurations.
 */

#ifndef OAIRealtimeLogConfigs_H
#define OAIRealtimeLogConfigs_H
...
class OAIRealtimeLogConfigs : public OAIObject {
public:
    OAIRealtimeLogConfigs();
    OAIRealtimeLogConfigs(QString json);
    ~OAIRealtimeLogConfigs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRealtimeLogConfigs)

#endif // OAIRealtimeLogConfigs_H
