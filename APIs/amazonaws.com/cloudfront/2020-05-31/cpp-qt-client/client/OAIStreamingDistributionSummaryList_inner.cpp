...
OAICreateStreamingDistribution2020_05_31_request_StreamingDistributionConfig_S3Origin OAIStreamingDistributionSummaryList_inner::getS3Origin() const {
    return m_s3_origin;
}
void OAIStreamingDistributionSummaryList_inner::setS3Origin(const OAICreateStreamingDistribution2020_05_31_request_StreamingDistributionConfig_S3Origin &s3_origin) {
...
OAICreateStreamingDistribution2020_05_31_request_StreamingDistributionConfig_Aliases OAIStreamingDistributionSummaryList_inner::getAliases() const {
    return m_aliases;
}
void OAIStreamingDistributionSummaryList_inner::setAliases(const OAICreateStreamingDistribution2020_05_31_request_StreamingDistributionConfig_Aliases &aliases) {
    m_aliases = aliases;
