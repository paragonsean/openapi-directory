...
#ifndef OAIKeyGroupConfig_H
#define OAIKeyGroupConfig_H
...
class OAIKeyGroupConfig : public OAIObject {
public:
    OAIKeyGroupConfig();
    OAIKeyGroupConfig(QString json);
    ~OAIKeyGroupConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyGroupConfig)

#endif // OAIKeyGroupConfig_H
