...
OAICacheBehavior_TrustedSigners OAICacheBehavior::getTrustedSigners() const {
    return m_trusted_signers;
}
void OAICacheBehavior::setTrustedSigners(const OAICacheBehavior_TrustedSigners &trusted_signers) {
...
OAIDefaultCacheBehavior_TrustedKeyGroups OAICacheBehavior::getTrustedKeyGroups() const {
    return m_trusted_key_groups;
}
void OAICacheBehavior::setTrustedKeyGroups(const OAIDefaultCacheBehavior_TrustedKeyGroups &trusted_key_groups) {
    m_trusted_key_groups = trusted_key_groups;
    m_trusted_key_groups_isSet = true;
}

bool OAICacheBehavior::is_trusted_key_groups_Set() const{
    return m_trusted_key_groups_isSet;
}

bool OAICacheBehavior::is_trusted_key_groups_Valid() const{
...
OAIDefaultCacheBehavior_FunctionAssociations OAICacheBehavior::getFunctionAssociations() const {
    return m_function_associations;
}
void OAICacheBehavior::setFunctionAssociations(const OAIDefaultCacheBehavior_FunctionAssociations &function_associations) {
    m_function_associations = function_associations;
    m_function_associations_isSet = true;
}

bool OAICacheBehavior::is_function_associations_Set() const{
    return m_function_associations_isSet;
}

bool OAICacheBehavior::is_function_associations_Valid() const{
...
QString OAICacheBehavior::getRealtimeLogConfigArn() const {
    return m_realtime_log_config_arn;
}
void OAICacheBehavior::setRealtimeLogConfigArn(const QString &realtime_log_config_arn) {
    m_realtime_log_config_arn = realtime_log_config_arn;
    m_realtime_log_config_arn_isSet = true;
}

bool OAICacheBehavior::is_realtime_log_config_arn_Set() const{
    return m_realtime_log_config_arn_isSet;
}

bool OAICacheBehavior::is_realtime_log_config_arn_Valid() const{
    return m_realtime_log_config_arn_isValid;
}

QString OAICacheBehavior::getCachePolicyId() const {
    return m_cache_policy_id;
}
void OAICacheBehavior::setCachePolicyId(const QString &cache_policy_id) {
    m_cache_policy_id = cache_policy_id;
    m_cache_policy_id_isSet = true;
}

bool OAICacheBehavior::is_cache_policy_id_Set() const{
    return m_cache_policy_id_isSet;
}

bool OAICacheBehavior::is_cache_policy_id_Valid() const{
    return m_cache_policy_id_isValid;
}

QString OAICacheBehavior::getOriginRequestPolicyId() const {
    return m_origin_request_policy_id;
}
void OAICacheBehavior::setOriginRequestPolicyId(const QString &origin_request_policy_id) {
    m_origin_request_policy_id = origin_request_policy_id;
    m_origin_request_policy_id_isSet = true;
}

bool OAICacheBehavior::is_origin_request_policy_id_Set() const{
    return m_origin_request_policy_id_isSet;
}

bool OAICacheBehavior::is_origin_request_policy_id_Valid() const{
    return m_origin_request_policy_id_isValid;
}

QString OAICacheBehavior::getResponseHeadersPolicyId() const {
    return m_response_headers_policy_id;
}
void OAICacheBehavior::setResponseHeadersPolicyId(const QString &response_headers_policy_id) {
    m_response_headers_policy_id = response_headers_policy_id;
    m_response_headers_policy_id_isSet = true;
}

bool OAICacheBehavior::is_response_headers_policy_id_Set() const{
    return m_response_headers_policy_id_isSet;
}

bool OAICacheBehavior::is_response_headers_policy_id_Valid() const{
    return m_response_headers_policy_id_isValid;
}

OAICacheBehavior_ForwardedValues OAICacheBehavior::getForwardedValues() const {
    return m_forwarded_values;
}
void OAICacheBehavior::setForwardedValues(const OAICacheBehavior_ForwardedValues &forwarded_values) {
...
bool OAICacheBehavior::isValid() const {
    ...
    return m_path_pattern_isValid && m_target_origin_id_isValid && m_viewer_protocol_policy_isValid && true;
}
