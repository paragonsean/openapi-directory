...
OAIDefaultCacheBehavior_TrustedKeyGroups OAIDefaultCacheBehavior::getTrustedKeyGroups() const {
    return m_trusted_key_groups;
}
void OAIDefaultCacheBehavior::setTrustedKeyGroups(const OAIDefaultCacheBehavior_TrustedKeyGroups &trusted_key_groups) {
    m_trusted_key_groups = trusted_key_groups;
    m_trusted_key_groups_isSet = true;
}

bool OAIDefaultCacheBehavior::is_trusted_key_groups_Set() const{
    return m_trusted_key_groups_isSet;
}

bool OAIDefaultCacheBehavior::is_trusted_key_groups_Valid() const{
...
OAIDefaultCacheBehavior_FunctionAssociations OAIDefaultCacheBehavior::getFunctionAssociations() const {
    return m_function_associations;
}
void OAIDefaultCacheBehavior::setFunctionAssociations(const OAIDefaultCacheBehavior_FunctionAssociations &function_associations) {
    m_function_associations = function_associations;
    m_function_associations_isSet = true;
}

bool OAIDefaultCacheBehavior::is_function_associations_Set() const{
    return m_function_associations_isSet;
}

bool OAIDefaultCacheBehavior::is_function_associations_Valid() const{
    return m_function_associations_isValid;
}

QString OAIDefaultCacheBehavior::getFieldLevelEncryptionId() const {
    return m_field_level_encryption_id;
}
void OAIDefaultCacheBehavior::setFieldLevelEncryptionId(const QString &field_level_encryption_id) {
    m_field_level_encryption_id = field_level_encryption_id;
    m_field_level_encryption_id_isSet = true;
}

bool OAIDefaultCacheBehavior::is_field_level_encryption_id_Set() const{
    return m_field_level_encryption_id_isSet;
}

bool OAIDefaultCacheBehavior::is_field_level_encryption_id_Valid() const{
    return m_field_level_encryption_id_isValid;
}

QString OAIDefaultCacheBehavior::getRealtimeLogConfigArn() const {
    return m_realtime_log_config_arn;
}
void OAIDefaultCacheBehavior::setRealtimeLogConfigArn(const QString &realtime_log_config_arn) {
    m_realtime_log_config_arn = realtime_log_config_arn;
    m_realtime_log_config_arn_isSet = true;
}

bool OAIDefaultCacheBehavior::is_realtime_log_config_arn_Set() const{
    return m_realtime_log_config_arn_isSet;
}

bool OAIDefaultCacheBehavior::is_realtime_log_config_arn_Valid() const{
    return m_realtime_log_config_arn_isValid;
}

QString OAIDefaultCacheBehavior::getCachePolicyId() const {
    return m_cache_policy_id;
}
void OAIDefaultCacheBehavior::setCachePolicyId(const QString &cache_policy_id) {
    m_cache_policy_id = cache_policy_id;
    m_cache_policy_id_isSet = true;
}

bool OAIDefaultCacheBehavior::is_cache_policy_id_Set() const{
    return m_cache_policy_id_isSet;
}

bool OAIDefaultCacheBehavior::is_cache_policy_id_Valid() const{
    return m_cache_policy_id_isValid;
}

QString OAIDefaultCacheBehavior::getOriginRequestPolicyId() const {
    return m_origin_request_policy_id;
}
void OAIDefaultCacheBehavior::setOriginRequestPolicyId(const QString &origin_request_policy_id) {
    m_origin_request_policy_id = origin_request_policy_id;
    m_origin_request_policy_id_isSet = true;
}

bool OAIDefaultCacheBehavior::is_origin_request_policy_id_Set() const{
    return m_origin_request_policy_id_isSet;
}

bool OAIDefaultCacheBehavior::is_origin_request_policy_id_Valid() const{
    return m_origin_request_policy_id_isValid;
}

QString OAIDefaultCacheBehavior::getResponseHeadersPolicyId() const {
    return m_response_headers_policy_id;
}
void OAIDefaultCacheBehavior::setResponseHeadersPolicyId(const QString &response_headers_policy_id) {
    m_response_headers_policy_id = response_headers_policy_id;
    m_response_headers_policy_id_isSet = true;
}

bool OAIDefaultCacheBehavior::is_response_headers_policy_id_Set() const{
    return m_response_headers_policy_id_isSet;
}

bool OAIDefaultCacheBehavior::is_response_headers_policy_id_Valid() const{
