...
OAICreateDistributionWithTags2020_05_31_request_DistributionConfigWithTags_Tags OAIListTagsForResourceResult::getTags() const {
    return m_tags;
}
void OAIListTagsForResourceResult::setTags(const OAICreateDistributionWithTags2020_05_31_request_DistributionConfigWithTags_Tags &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
