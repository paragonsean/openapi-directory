...
OAICreateDistributionWithTags2020_05_31_request_DistributionConfigWithTags_Tags OAITagResourceRequest::getTags() const {
    return m_tags;
}
void OAITagResourceRequest::setTags(const OAICreateDistributionWithTags2020_05_31_request_DistributionConfigWithTags_Tags &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
