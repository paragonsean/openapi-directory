...
/*
 * OAIResponseHeadersPolicyList.h
 *
 * A list of response headers policies.
 */

#ifndef OAIResponseHeadersPolicyList_H
#define OAIResponseHeadersPolicyList_H
...
class OAIResponseHeadersPolicyList : public OAIObject {
public:
    OAIResponseHeadersPolicyList();
    OAIResponseHeadersPolicyList(QString json);
    ~OAIResponseHeadersPolicyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseHeadersPolicyList)

#endif // OAIResponseHeadersPolicyList_H
