...
class OAICacheBehavior_ForwardedValues;
...
public:
    ...
    OAICacheBehavior_ForwardedValues getForwardedValues() const;
    void setForwardedValues(const OAICacheBehavior_ForwardedValues &forwarded_values);
...
private:
    ...
    OAICacheBehavior_ForwardedValues m_forwarded_values;
