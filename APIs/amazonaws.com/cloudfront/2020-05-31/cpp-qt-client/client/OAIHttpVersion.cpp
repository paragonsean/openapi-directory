...
void OAIHttpVersion::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("http3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHttpVersion::HTTP3;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("http2and3", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHttpVersion::HTTP2AND3;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIHttpVersion::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIHttpVersion::HTTP2:
            val = "http2";
            break;
        case eOAIHttpVersion::HTTP3:
            val = "http3";
            break;
        case eOAIHttpVersion::HTTP2AND3:
            val = "http2and3";
            break;
        default:
            break;
