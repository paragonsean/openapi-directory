...
/*
 * OAICreateCachePolicyResult_CachePolicy.h
 *
 * 
 */

#ifndef OAICreateCachePolicyResult_CachePolicy_H
#define OAICreateCachePolicyResult_CachePolicy_H
...
class OAICreateCachePolicyResult_CachePolicy : public OAIObject {
public:
    OAICreateCachePolicyResult_CachePolicy();
    OAICreateCachePolicyResult_CachePolicy(QString json);
    ~OAICreateCachePolicyResult_CachePolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCachePolicyResult_CachePolicy)

#endif // OAICreateCachePolicyResult_CachePolicy_H
