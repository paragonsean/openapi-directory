...
/*
 * OAIFunctionMetadata.h
 *
 * Contains metadata about a CloudFront function.
 */

#ifndef OAIFunctionMetadata_H
#define OAIFunctionMetadata_H
...
class OAIFunctionMetadata : public OAIObject {
public:
    OAIFunctionMetadata();
    OAIFunctionMetadata(QString json);
    ~OAIFunctionMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFunctionMetadata)

#endif // OAIFunctionMetadata_H
