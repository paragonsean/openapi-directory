...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudFront.FunctionMetadata();
  });
  ...
  describe('FunctionMetadata', function() {
    it('should create an instance of FunctionMetadata', function() {
      // uncomment below and update the code to test FunctionMetadata
      //var instance = new AmazonCloudFront.FunctionMetadata();
      //expect(instance).to.be.a(AmazonCloudFront.FunctionMetadata);
    });
