...
/**
 * The DistributionList model module.
 * @module model/DistributionList
 * @version 2019-03-26
 */
class DistributionList {
    /**
     * Constructs a new <code>DistributionList</code>.
     * A distribution list.
     * @alias module:model/DistributionList
     * @param marker {String} 
    ...
    /**
     * Constructs a <code>DistributionList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DistributionList} obj Optional instance to populate.
     * @return {module:model/DistributionList} The populated <code>DistributionList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DistributionList();
    ...
    /**
     * Validates the JSON data with respect to <code>DistributionList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DistributionList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DistributionList.RequiredProperties) {
...
DistributionList.RequiredProperties = ["Marker", "MaxItems", "IsTruncated", "Quantity"];
