...
/**
 * The CreateDistributionWithTagsResultDistribution model module.
 * @module model/CreateDistributionWithTagsResultDistribution
 * @version 2019-03-26
 */
class CreateDistributionWithTagsResultDistribution {
    /**
     * Constructs a new <code>CreateDistributionWithTagsResultDistribution</code>.
     * @alias module:model/CreateDistributionWithTagsResultDistribution
    ...
    constructor(id, ARN, status, lastModifiedTime, inProgressInvalidationBatches, domainName, activeTrustedSigners, distributionConfig) { 
        ...
        CreateDistributionWithTagsResultDistribution.initialize(this, id, ARN, status, lastModifiedTime, inProgressInvalidationBatches, domainName, activeTrustedSigners, distributionConfig);
    }
    ...
    /**
     * Constructs a <code>CreateDistributionWithTagsResultDistribution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDistributionWithTagsResultDistribution} obj Optional instance to populate.
     * @return {module:model/CreateDistributionWithTagsResultDistribution} The populated <code>CreateDistributionWithTagsResultDistribution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDistributionWithTagsResultDistribution();
            ...
            if (data.hasOwnProperty('AliasICPRecordals')) {
                obj['AliasICPRecordals'] = ApiClient.convertToType(data['AliasICPRecordals'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDistributionWithTagsResultDistribution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDistributionWithTagsResultDistribution</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDistributionWithTagsResultDistribution.RequiredProperties) {
        ...
        if (data['AliasICPRecordals']) { // data not null
          Array.validateJSON(data['AliasICPRecordals']);
        }
...
CreateDistributionWithTagsResultDistribution.RequiredProperties = ["Id", "ARN", "Status", "LastModifiedTime", "InProgressInvalidationBatches", "DomainName", "ActiveTrustedSigners", "DistributionConfig"];

/**
 * @member {String} Id
 */
CreateDistributionWithTagsResultDistribution.prototype['Id'] = undefined;

/**
 * @member {String} ARN
 */
CreateDistributionWithTagsResultDistribution.prototype['ARN'] = undefined;

/**
 * @member {String} Status
 */
CreateDistributionWithTagsResultDistribution.prototype['Status'] = undefined;

/**
 * @member {Date} LastModifiedTime
 */
CreateDistributionWithTagsResultDistribution.prototype['LastModifiedTime'] = undefined;

/**
 * @member {Number} InProgressInvalidationBatches
 */
CreateDistributionWithTagsResultDistribution.prototype['InProgressInvalidationBatches'] = undefined;

/**
 * @member {String} DomainName
 */
CreateDistributionWithTagsResultDistribution.prototype['DomainName'] = undefined;

/**
 * @member {module:model/DistributionActiveTrustedSigners} ActiveTrustedSigners
 */
CreateDistributionWithTagsResultDistribution.prototype['ActiveTrustedSigners'] = undefined;

/**
 * @member {module:model/DistributionDistributionConfig} DistributionConfig
 */
CreateDistributionWithTagsResultDistribution.prototype['DistributionConfig'] = undefined;

/**
 * @member {Array} AliasICPRecordals
 */
CreateDistributionWithTagsResultDistribution.prototype['AliasICPRecordals'] = undefined;
 ...
 * @member {Array} AliasICPRecordals
 */
Distribution.prototype['AliasICPRecordals'] = undefined;




export default CreateDistributionWithTagsResultDistribution;
