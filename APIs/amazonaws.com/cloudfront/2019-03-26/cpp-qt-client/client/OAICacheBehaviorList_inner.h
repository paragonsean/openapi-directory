...
class OAICacheBehavior_TrustedSigners;
...
public:
    ...
    OAICacheBehavior_TrustedSigners getTrustedSigners() const;
    void setTrustedSigners(const OAICacheBehavior_TrustedSigners &trusted_signers);
...
private:
    ...
    OAICacheBehavior_TrustedSigners m_trusted_signers;
