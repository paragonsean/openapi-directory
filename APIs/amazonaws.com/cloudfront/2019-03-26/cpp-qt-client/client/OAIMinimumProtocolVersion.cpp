...
void OAIMinimumProtocolVersion::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("TLSv1.2_2019", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMinimumProtocolVersion::TLSV1_2_2019;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIMinimumProtocolVersion::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIMinimumProtocolVersion::TLSV1_2_2018:
            val = "TLSv1.2_2018";
            break;
        case eOAIMinimumProtocolVersion::TLSV1_2_2019:
            val = "TLSv1.2_2019";
            break;
        default:
            break;
