...
QList OAIDistribution::getAliasIcpRecordals() const {
    return m_alias_icp_recordals;
}
void OAIDistribution::setAliasIcpRecordals(const QList &alias_icp_recordals) {
    m_alias_icp_recordals = alias_icp_recordals;
    m_alias_icp_recordals_isSet = true;
}

bool OAIDistribution::is_alias_icp_recordals_Set() const{
    return m_alias_icp_recordals_isSet;
}

bool OAIDistribution::is_alias_icp_recordals_Valid() const{
