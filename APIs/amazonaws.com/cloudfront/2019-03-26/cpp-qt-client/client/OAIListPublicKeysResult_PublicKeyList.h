...
/*
 * OAIListPublicKeysResult_PublicKeyList.h
 *
 * 
 */

#ifndef OAIListPublicKeysResult_PublicKeyList_H
#define OAIListPublicKeysResult_PublicKeyList_H
...
class OAIListPublicKeysResult_PublicKeyList : public OAIObject {
public:
    OAIListPublicKeysResult_PublicKeyList();
    OAIListPublicKeysResult_PublicKeyList(QString json);
    ~OAIListPublicKeysResult_PublicKeyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPublicKeysResult_PublicKeyList)

#endif // OAIListPublicKeysResult_PublicKeyList_H
