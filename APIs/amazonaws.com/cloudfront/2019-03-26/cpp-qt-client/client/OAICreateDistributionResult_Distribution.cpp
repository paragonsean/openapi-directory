...
QList OAICreateDistributionResult_Distribution::getAliasIcpRecordals() const {
    return m_alias_icp_recordals;
}
void OAICreateDistributionResult_Distribution::setAliasIcpRecordals(const QList &alias_icp_recordals) {
    m_alias_icp_recordals = alias_icp_recordals;
    m_alias_icp_recordals_isSet = true;
}

bool OAICreateDistributionResult_Distribution::is_alias_icp_recordals_Set() const{
    return m_alias_icp_recordals_isSet;
}

bool OAICreateDistributionResult_Distribution::is_alias_icp_recordals_Valid() const{
