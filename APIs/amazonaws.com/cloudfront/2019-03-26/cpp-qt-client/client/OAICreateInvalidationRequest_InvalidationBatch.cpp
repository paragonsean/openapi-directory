...
OAICreateInvalidation2019_03_26_request_InvalidationBatch_Paths OAICreateInvalidationRequest_InvalidationBatch::getPaths() const {
    return m_paths;
}
void OAICreateInvalidationRequest_InvalidationBatch::setPaths(const OAICreateInvalidation2019_03_26_request_InvalidationBatch_Paths &paths) {
    m_paths = paths;
    m_paths_isSet = true;
}
