...
#ifndef OAIKeyPairIds_H
#define OAIKeyPairIds_H
...
class OAIKeyPairIds : public OAIObject {
public:
    OAIKeyPairIds();
    OAIKeyPairIds(QString json);
    ~OAIKeyPairIds() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeyPairIds)

#endif // OAIKeyPairIds_H
