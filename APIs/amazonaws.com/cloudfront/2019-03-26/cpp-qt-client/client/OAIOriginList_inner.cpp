...
qint32 OAIOriginList_inner::getConnectionAttempts() const {
    return m_connection_attempts;
}
void OAIOriginList_inner::setConnectionAttempts(const qint32 &connection_attempts) {
    m_connection_attempts = connection_attempts;
    m_connection_attempts_isSet = true;
}

bool OAIOriginList_inner::is_connection_attempts_Set() const{
    return m_connection_attempts_isSet;
}

bool OAIOriginList_inner::is_connection_attempts_Valid() const{
    return m_connection_attempts_isValid;
}

qint32 OAIOriginList_inner::getConnectionTimeout() const {
    return m_connection_timeout;
}
void OAIOriginList_inner::setConnectionTimeout(const qint32 &connection_timeout) {
    m_connection_timeout = connection_timeout;
    m_connection_timeout_isSet = true;
}

bool OAIOriginList_inner::is_connection_timeout_Set() const{
    return m_connection_timeout_isSet;
}

bool OAIOriginList_inner::is_connection_timeout_Valid() const{
