...
class CreateDistributionWithTagsResultDistribution(Model):
    ...
    def __init__(self, id: str=None, arn: str=None, status: str=None, last_modified_time: datetime=None, in_progress_invalidation_batches: int=None, domain_name: str=None, active_trusted_signers: DistributionActiveTrustedSigners=None, distribution_config: DistributionDistributionConfig=None, alias_icp_recordals: List=None):
        ...
        :param alias_icp_recordals: The alias_icp_recordals of this CreateDistributionWithTagsResultDistribution.
        """
        self.openapi_types = {
            'id': str,
            'arn': str,
    ...
    def alias_icp_recordals(self):
        """Gets the alias_icp_recordals of this CreateDistributionWithTagsResultDistribution.


        :return: The alias_icp_recordals of this CreateDistributionWithTagsResultDistribution.
        :rtype: List
        """
    ...
    def alias_icp_recordals(self, alias_icp_recordals):
        """Sets the alias_icp_recordals of this CreateDistributionWithTagsResultDistribution.
