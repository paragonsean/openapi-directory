...
class ForwardedValues(Model):
    ...
    def __init__(self, query_string: bool=None, cookies: ForwardedValuesCookies=None, headers: ForwardedValuesHeaders=None, query_string_cache_keys: ForwardedValuesQueryStringCacheKeys=None):
        """ForwardedValues - a model defined in OpenAPI

        :param query_string: The query_string of this ForwardedValues.
        :param cookies: The cookies of this ForwardedValues.
        :param headers: The headers of this ForwardedValues.
        :param query_string_cache_keys: The query_string_cache_keys of this ForwardedValues.
        """
        self.openapi_types = {
            'query_string': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ForwardedValues':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ForwardedValues of this ForwardedValues.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def query_string(self):
        """Gets the query_string of this ForwardedValues.


        :return: The query_string of this ForwardedValues.
        :rtype: bool
        """
    ...
    def query_string(self, query_string):
        """Sets the query_string of this ForwardedValues.
    ...
    @property
    def cookies(self):
        """Gets the cookies of this ForwardedValues.


        :return: The cookies of this ForwardedValues.
    ...
    def cookies(self, cookies):
        """Sets the cookies of this ForwardedValues.
    ...
    @property
    def headers(self):
        """Gets the headers of this ForwardedValues.


        :return: The headers of this ForwardedValues.
    ...
    def headers(self, headers):
        """Sets the headers of this ForwardedValues.
    ...
    def query_string_cache_keys(self):
        """Gets the query_string_cache_keys of this ForwardedValues.


        :return: The query_string_cache_keys of this ForwardedValues.
    ...
    def query_string_cache_keys(self, query_string_cache_keys):
        """Sets the query_string_cache_keys of this ForwardedValues.
