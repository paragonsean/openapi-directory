...
|------------ | ------------- | ------------- | -------------|
|**cloudFrontOriginAccessIdentityConfig** | [**CreateCloudFrontOriginAccessIdentityRequestCloudFrontOriginAccessIdentityConfig**](CreateCloudFrontOriginAccessIdentityRequestCloudFrontOriginAccessIdentityConfig.md) |  |  |
