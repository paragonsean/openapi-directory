...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://personalize-events.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://personalize-events.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-03-22/Javascript'
        };
