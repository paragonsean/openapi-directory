...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonPersonalizeEvents.PutItemsRequest();
  });
  ...
  describe('PutItemsRequest', function() {
    it('should create an instance of PutItemsRequest', function() {
      // uncomment below and update the code to test PutItemsRequest
      //var instance = new AmazonPersonalizeEvents.PutItemsRequest();
      //expect(instance).to.be.a(AmazonPersonalizeEvents.PutItemsRequest);
    });
