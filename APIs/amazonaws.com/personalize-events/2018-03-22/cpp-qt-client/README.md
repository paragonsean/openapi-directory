...
OAIPutEvents_request Example::create(){
    OAIPutEvents_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::putEventsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::putEventsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIPutEvents_request oai_put_events_request = create(); // OAIPutEvents_request | 
      ...
      apiInstance.putEvents(oai_put_events_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
