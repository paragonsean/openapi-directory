...
import org.openapitools.client.model.DisassociateExternalConnectionResultRepository;
...
public class DisassociateExternalConnectionResult {
  ...
  private DisassociateExternalConnectionResultRepository repository;

  public DisassociateExternalConnectionResult() {
  }

  public DisassociateExternalConnectionResult repository(DisassociateExternalConnectionResultRepository repository) {
  ...
  public DisassociateExternalConnectionResultRepository getRepository() {
    return repository;
  }

  public void setRepository(DisassociateExternalConnectionResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    DisassociateExternalConnectionResult disassociateExternalConnectionResult = (DisassociateExternalConnectionResult) o;
    return Objects.equals(this.repository, disassociateExternalConnectionResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateExternalConnectionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateExternalConnectionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateExternalConnectionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateExternalConnectionResult is not found in the empty JSON string", DisassociateExternalConnectionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateExternalConnectionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateExternalConnectionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        DisassociateExternalConnectionResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateExternalConnectionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateExternalConnectionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateExternalConnectionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateExternalConnectionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateExternalConnectionResult>() {
           @Override
           public void write(JsonWriter out, DisassociateExternalConnectionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateExternalConnectionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateExternalConnectionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateExternalConnectionResult
   * @throws IOException if the JSON string is invalid with respect to DisassociateExternalConnectionResult
   */
  public static DisassociateExternalConnectionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateExternalConnectionResult.class);
  }

  /**
   * Convert an instance of DisassociateExternalConnectionResult to an JSON string
   *
   * @return JSON string
   */
