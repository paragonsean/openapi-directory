...
public class ListPackageVersionsResult {
  public static final String SERIALIZED_NAME_DEFAULT_DISPLAY_VERSION = "defaultDisplayVersion";
  @SerializedName(SERIALIZED_NAME_DEFAULT_DISPLAY_VERSION)
  ...
  public ListPackageVersionsResult defaultDisplayVersion(String defaultDisplayVersion) {
    this.defaultDisplayVersion = defaultDisplayVersion;
    return this;
  }

  /**
   * Get defaultDisplayVersion
  ...
  public ListPackageVersionsResult format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ListPackageVersionsResult namespace(String namespace) {
  ...
  public ListPackageVersionsResult _package(String _package) {
  ...
  public ListPackageVersionsResult versions(List versions) {
  ...
  public ListPackageVersionsResult nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPackageVersionsResult listPackageVersionsResult = (ListPackageVersionsResult) o;
    return Objects.equals(this.defaultDisplayVersion, listPackageVersionsResult.defaultDisplayVersion) &&
        Objects.equals(this.format, listPackageVersionsResult.format) &&
        Objects.equals(this.namespace, listPackageVersionsResult.namespace) &&
        Objects.equals(this._package, listPackageVersionsResult._package) &&
        Objects.equals(this.versions, listPackageVersionsResult.versions) &&
        Objects.equals(this.nextToken, listPackageVersionsResult.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultDisplayVersion, format, namespace, _package, versions, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPackageVersionsResult {\n");
    sb.append("    defaultDisplayVersion: ").append(toIndentedString(defaultDisplayVersion)).append("\n");
  ...
  static {
    ...
    openapiFields.add("defaultDisplayVersion");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPackageVersionsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPackageVersionsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPackageVersionsResult is not found in the empty JSON string", ListPackageVersionsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPackageVersionsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPackageVersionsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `defaultDisplayVersion`
      if (jsonObj.get("defaultDisplayVersion") != null && !jsonObj.get("defaultDisplayVersion").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("defaultDisplayVersion"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPackageVersionsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPackageVersionsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPackageVersionsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPackageVersionsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPackageVersionsResult>() {
           @Override
           public void write(JsonWriter out, ListPackageVersionsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPackageVersionsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPackageVersionsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPackageVersionsResult
   * @throws IOException if the JSON string is invalid with respect to ListPackageVersionsResult
   */
  public static ListPackageVersionsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPackageVersionsResult.class);
  }

  /**
   * Convert an instance of ListPackageVersionsResult to an JSON string
   *
   * @return JSON string
   */
