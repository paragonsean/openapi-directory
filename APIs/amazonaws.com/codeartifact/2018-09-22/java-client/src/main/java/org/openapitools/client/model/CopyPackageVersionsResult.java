...
public class CopyPackageVersionsResult {
  ...
  public CopyPackageVersionsResult() {
  }

  public CopyPackageVersionsResult successfulVersions(Map successfulVersions) {
  ...
  public CopyPackageVersionsResult failedVersions(Map failedVersions) {
  ...
  public boolean equals(Object o) {
    ...
    CopyPackageVersionsResult copyPackageVersionsResult = (CopyPackageVersionsResult) o;
    return Objects.equals(this.successfulVersions, copyPackageVersionsResult.successfulVersions) &&
        Objects.equals(this.failedVersions, copyPackageVersionsResult.failedVersions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyPackageVersionsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyPackageVersionsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyPackageVersionsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyPackageVersionsResult is not found in the empty JSON string", CopyPackageVersionsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyPackageVersionsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyPackageVersionsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyPackageVersionsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyPackageVersionsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyPackageVersionsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyPackageVersionsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyPackageVersionsResult>() {
           @Override
           public void write(JsonWriter out, CopyPackageVersionsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyPackageVersionsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyPackageVersionsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyPackageVersionsResult
   * @throws IOException if the JSON string is invalid with respect to CopyPackageVersionsResult
   */
  public static CopyPackageVersionsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyPackageVersionsResult.class);
  }

  /**
   * Convert an instance of CopyPackageVersionsResult to an JSON string
   *
   * @return JSON string
   */
