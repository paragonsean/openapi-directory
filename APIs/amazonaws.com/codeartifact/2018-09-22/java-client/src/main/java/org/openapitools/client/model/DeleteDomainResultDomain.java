...
public class DeleteDomainResultDomain {
  ...
  public DeleteDomainResultDomain() {
  }

  public DeleteDomainResultDomain name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteDomainResultDomain owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public DeleteDomainResultDomain arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteDomainResultDomain status(DomainStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteDomainResultDomain createdTime(OffsetDateTime createdTime) {
  ...
  public DeleteDomainResultDomain encryptionKey(String encryptionKey) {
  ...
  public DeleteDomainResultDomain repositoryCount(Integer repositoryCount) {
  ...
  public DeleteDomainResultDomain assetSizeBytes(Integer assetSizeBytes) {
  ...
  public DeleteDomainResultDomain s3BucketArn(String s3BucketArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteDomainResultDomain deleteDomainResultDomain = (DeleteDomainResultDomain) o;
    return Objects.equals(this.name, deleteDomainResultDomain.name) &&
        Objects.equals(this.owner, deleteDomainResultDomain.owner) &&
        Objects.equals(this.arn, deleteDomainResultDomain.arn) &&
        Objects.equals(this.status, deleteDomainResultDomain.status) &&
        Objects.equals(this.createdTime, deleteDomainResultDomain.createdTime) &&
        Objects.equals(this.encryptionKey, deleteDomainResultDomain.encryptionKey) &&
        Objects.equals(this.repositoryCount, deleteDomainResultDomain.repositoryCount) &&
        Objects.equals(this.assetSizeBytes, deleteDomainResultDomain.assetSizeBytes) &&
        Objects.equals(this.s3BucketArn, deleteDomainResultDomain.s3BucketArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteDomainResultDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDomainResultDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDomainResultDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDomainResultDomain is not found in the empty JSON string", DeleteDomainResultDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDomainResultDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDomainResultDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDomainResultDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDomainResultDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDomainResultDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDomainResultDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDomainResultDomain>() {
           @Override
           public void write(JsonWriter out, DeleteDomainResultDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDomainResultDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDomainResultDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDomainResultDomain
   * @throws IOException if the JSON string is invalid with respect to DeleteDomainResultDomain
   */
  public static DeleteDomainResultDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDomainResultDomain.class);
  }

  /**
   * Convert an instance of DeleteDomainResultDomain to an JSON string
   *
   * @return JSON string
   */
