...
public class AssetSummary {
  ...
  public AssetSummary size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public AssetSummary hashes(Map hashes) {
    this.hashes = hashes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, assetSummary.name) &&
        Objects.equals(this.size, assetSummary.size) &&
        Objects.equals(this.hashes, assetSummary.hashes);
  }
