...
public class DescribePackageVersionResultPackageVersion {
  ...
  public DescribePackageVersionResultPackageVersion() {
  }

  public DescribePackageVersionResultPackageVersion format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public DescribePackageVersionResultPackageVersion namespace(String namespace) {
  ...
  public DescribePackageVersionResultPackageVersion packageName(String packageName) {
  ...
  public DescribePackageVersionResultPackageVersion displayName(String displayName) {
  ...
  public DescribePackageVersionResultPackageVersion version(String version) {
  ...
  public DescribePackageVersionResultPackageVersion summary(String summary) {
  ...
  public DescribePackageVersionResultPackageVersion homePage(String homePage) {
  ...
  public DescribePackageVersionResultPackageVersion sourceCodeRepository(String sourceCodeRepository) {
  ...
  public DescribePackageVersionResultPackageVersion publishedTime(OffsetDateTime publishedTime) {
  ...
  public DescribePackageVersionResultPackageVersion licenses(List licenses) {
  ...
  public DescribePackageVersionResultPackageVersion revision(String revision) {
  ...
  public DescribePackageVersionResultPackageVersion status(PackageVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribePackageVersionResultPackageVersion origin(PackageVersionDescriptionOrigin origin) {
    this.origin = origin;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribePackageVersionResultPackageVersion describePackageVersionResultPackageVersion = (DescribePackageVersionResultPackageVersion) o;
    return Objects.equals(this.format, describePackageVersionResultPackageVersion.format) &&
        Objects.equals(this.namespace, describePackageVersionResultPackageVersion.namespace) &&
        Objects.equals(this.packageName, describePackageVersionResultPackageVersion.packageName) &&
        Objects.equals(this.displayName, describePackageVersionResultPackageVersion.displayName) &&
        Objects.equals(this.version, describePackageVersionResultPackageVersion.version) &&
        Objects.equals(this.summary, describePackageVersionResultPackageVersion.summary) &&
        Objects.equals(this.homePage, describePackageVersionResultPackageVersion.homePage) &&
        Objects.equals(this.sourceCodeRepository, describePackageVersionResultPackageVersion.sourceCodeRepository) &&
        Objects.equals(this.publishedTime, describePackageVersionResultPackageVersion.publishedTime) &&
        Objects.equals(this.licenses, describePackageVersionResultPackageVersion.licenses) &&
        Objects.equals(this.revision, describePackageVersionResultPackageVersion.revision) &&
        Objects.equals(this.status, describePackageVersionResultPackageVersion.status) &&
        Objects.equals(this.origin, describePackageVersionResultPackageVersion.origin);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePackageVersionResultPackageVersion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePackageVersionResultPackageVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePackageVersionResultPackageVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePackageVersionResultPackageVersion is not found in the empty JSON string", DescribePackageVersionResultPackageVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePackageVersionResultPackageVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePackageVersionResultPackageVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePackageVersionResultPackageVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePackageVersionResultPackageVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePackageVersionResultPackageVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePackageVersionResultPackageVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePackageVersionResultPackageVersion>() {
           @Override
           public void write(JsonWriter out, DescribePackageVersionResultPackageVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePackageVersionResultPackageVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePackageVersionResultPackageVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePackageVersionResultPackageVersion
   * @throws IOException if the JSON string is invalid with respect to DescribePackageVersionResultPackageVersion
   */
  public static DescribePackageVersionResultPackageVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePackageVersionResultPackageVersion.class);
  }

  /**
   * Convert an instance of DescribePackageVersionResultPackageVersion to an JSON string
   *
   * @return JSON string
   */
