...
/**
 * Gets or Sets AllowUpstream
 */
@JsonAdapter(AllowUpstream.Adapter.class)
public enum AllowUpstream {
  ...
  public static AllowUpstream fromValue(String value) {
    for (AllowUpstream b : AllowUpstream.values()) {
  ...
  public static class Adapter extends TypeAdapter<AllowUpstream> {
    @Override
    public void write(final JsonWriter jsonWriter, final AllowUpstream enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AllowUpstream read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AllowUpstream.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AllowUpstream.fromValue(value);
  }
}
