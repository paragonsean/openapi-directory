...
/**
 * Gets or Sets PackageVersionErrorCode
 */
@JsonAdapter(PackageVersionErrorCode.Adapter.class)
public enum PackageVersionErrorCode {
  ...
  PackageVersionErrorCode(String value) {
    this.value = value;
  }
  ...
  public static PackageVersionErrorCode fromValue(String value) {
    for (PackageVersionErrorCode b : PackageVersionErrorCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<PackageVersionErrorCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final PackageVersionErrorCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PackageVersionErrorCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PackageVersionErrorCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PackageVersionErrorCode.fromValue(value);
  }
}
