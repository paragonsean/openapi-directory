...
import org.openapitools.client.model.PackageOriginConfigurationRestrictions;
...
public class PackageSummaryOriginConfiguration {
  public static final String SERIALIZED_NAME_RESTRICTIONS = "restrictions";
  @SerializedName(SERIALIZED_NAME_RESTRICTIONS)
  private PackageOriginConfigurationRestrictions restrictions;

  public PackageSummaryOriginConfiguration() {
  }

  public PackageSummaryOriginConfiguration restrictions(PackageOriginConfigurationRestrictions restrictions) {
  ...
  public PackageOriginConfigurationRestrictions getRestrictions() {
    return restrictions;
  }

  public void setRestrictions(PackageOriginConfigurationRestrictions restrictions) {
    this.restrictions = restrictions;
  }
  ...
  public boolean equals(Object o) {
    ...
    PackageSummaryOriginConfiguration packageSummaryOriginConfiguration = (PackageSummaryOriginConfiguration) o;
    return Objects.equals(this.restrictions, packageSummaryOriginConfiguration.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageSummaryOriginConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageSummaryOriginConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageSummaryOriginConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageSummaryOriginConfiguration is not found in the empty JSON string", PackageSummaryOriginConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageSummaryOriginConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageSummaryOriginConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `restrictions`
      if (jsonObj.get("restrictions") != null && !jsonObj.get("restrictions").isJsonNull()) {
        PackageOriginConfigurationRestrictions.validateJsonElement(jsonObj.get("restrictions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageSummaryOriginConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageSummaryOriginConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageSummaryOriginConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageSummaryOriginConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageSummaryOriginConfiguration>() {
           @Override
           public void write(JsonWriter out, PackageSummaryOriginConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageSummaryOriginConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageSummaryOriginConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageSummaryOriginConfiguration
   * @throws IOException if the JSON string is invalid with respect to PackageSummaryOriginConfiguration
   */
  public static PackageSummaryOriginConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageSummaryOriginConfiguration.class);
  }

  /**
   * Convert an instance of PackageSummaryOriginConfiguration to an JSON string
   *
   * @return JSON string
   */
