...
public class PackageDependency {
  ...
  public PackageDependency namespace(String namespace) {
  ...
  public PackageDependency _package(String _package) {
  ...
  public PackageDependency dependencyType(String dependencyType) {
  ...
  public PackageDependency versionRequirement(String versionRequirement) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.namespace, packageDependency.namespace) &&
        Objects.equals(this._package, packageDependency._package) &&
        Objects.equals(this.dependencyType, packageDependency.dependencyType) &&
        Objects.equals(this.versionRequirement, packageDependency.versionRequirement);
  }

  @Override
  public int hashCode() {
    return Objects.hash(namespace, _package, dependencyType, versionRequirement);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageDependency
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageDependency.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageDependency is not found in the empty JSON string", PackageDependency.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageDependency.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageDependency` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dependencyType") != null && !jsonObj.get("dependencyType").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("dependencyType"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageDependency.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageDependency' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageDependency> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageDependency.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageDependency>() {
           @Override
           public void write(JsonWriter out, PackageDependency value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageDependency read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageDependency given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageDependency
   * @throws IOException if the JSON string is invalid with respect to PackageDependency
   */
  public static PackageDependency fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageDependency.class);
  }

  /**
   * Convert an instance of PackageDependency to an JSON string
   *
   * @return JSON string
   */
