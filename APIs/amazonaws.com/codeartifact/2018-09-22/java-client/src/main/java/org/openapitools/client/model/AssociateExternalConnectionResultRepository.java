...
public class AssociateExternalConnectionResultRepository {
  ...
  public AssociateExternalConnectionResultRepository() {
  }

  public AssociateExternalConnectionResultRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssociateExternalConnectionResultRepository administratorAccount(String administratorAccount) {
  ...
  public AssociateExternalConnectionResultRepository domainName(String domainName) {
  ...
  public AssociateExternalConnectionResultRepository domainOwner(String domainOwner) {
  ...
  public AssociateExternalConnectionResultRepository arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public AssociateExternalConnectionResultRepository description(String description) {
  ...
  public AssociateExternalConnectionResultRepository upstreams(List upstreams) {
  ...
  public AssociateExternalConnectionResultRepository externalConnections(List externalConnections) {
  ...
  public AssociateExternalConnectionResultRepository createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    AssociateExternalConnectionResultRepository associateExternalConnectionResultRepository = (AssociateExternalConnectionResultRepository) o;
    return Objects.equals(this.name, associateExternalConnectionResultRepository.name) &&
        Objects.equals(this.administratorAccount, associateExternalConnectionResultRepository.administratorAccount) &&
        Objects.equals(this.domainName, associateExternalConnectionResultRepository.domainName) &&
        Objects.equals(this.domainOwner, associateExternalConnectionResultRepository.domainOwner) &&
        Objects.equals(this.arn, associateExternalConnectionResultRepository.arn) &&
        Objects.equals(this.description, associateExternalConnectionResultRepository.description) &&
        Objects.equals(this.upstreams, associateExternalConnectionResultRepository.upstreams) &&
        Objects.equals(this.externalConnections, associateExternalConnectionResultRepository.externalConnections) &&
        Objects.equals(this.createdTime, associateExternalConnectionResultRepository.createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateExternalConnectionResultRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateExternalConnectionResultRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateExternalConnectionResultRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateExternalConnectionResultRepository is not found in the empty JSON string", AssociateExternalConnectionResultRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateExternalConnectionResultRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateExternalConnectionResultRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateExternalConnectionResultRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateExternalConnectionResultRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateExternalConnectionResultRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateExternalConnectionResultRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateExternalConnectionResultRepository>() {
           @Override
           public void write(JsonWriter out, AssociateExternalConnectionResultRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateExternalConnectionResultRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateExternalConnectionResultRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateExternalConnectionResultRepository
   * @throws IOException if the JSON string is invalid with respect to AssociateExternalConnectionResultRepository
   */
  public static AssociateExternalConnectionResultRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateExternalConnectionResultRepository.class);
  }

  /**
   * Convert an instance of AssociateExternalConnectionResultRepository to an JSON string
   *
   * @return JSON string
   */
