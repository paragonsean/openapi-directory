...
public class GetDomainPermissionsPolicyResult {
  ...
  public GetDomainPermissionsPolicyResult() {
  }

  public GetDomainPermissionsPolicyResult policy(GetDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainPermissionsPolicyResult getDomainPermissionsPolicyResult = (GetDomainPermissionsPolicyResult) o;
    return Objects.equals(this.policy, getDomainPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDomainPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDomainPermissionsPolicyResult is not found in the empty JSON string", GetDomainPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDomainPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, GetDomainPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to GetDomainPermissionsPolicyResult
   */
  public static GetDomainPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of GetDomainPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
