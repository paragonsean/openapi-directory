...
public class DeletePackageVersionsRequest {
  ...
  public DeletePackageVersionsRequest() {
  }

  public DeletePackageVersionsRequest versions(List<String> versions) {
    this.versions = versions;
    return this;
  }

  public DeletePackageVersionsRequest addVersionsItem(String versionsItem) {
  ...
  public DeletePackageVersionsRequest expectedStatus(ExpectedStatusEnum expectedStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePackageVersionsRequest deletePackageVersionsRequest = (DeletePackageVersionsRequest) o;
    return Objects.equals(this.versions, deletePackageVersionsRequest.versions) &&
        Objects.equals(this.expectedStatus, deletePackageVersionsRequest.expectedStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(versions, expectedStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePackageVersionsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePackageVersionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePackageVersionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePackageVersionsRequest is not found in the empty JSON string", DeletePackageVersionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePackageVersionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePackageVersionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePackageVersionsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePackageVersionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePackageVersionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePackageVersionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePackageVersionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePackageVersionsRequest>() {
           @Override
           public void write(JsonWriter out, DeletePackageVersionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePackageVersionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePackageVersionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePackageVersionsRequest
   * @throws IOException if the JSON string is invalid with respect to DeletePackageVersionsRequest
   */
  public static DeletePackageVersionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePackageVersionsRequest.class);
  }

  /**
   * Convert an instance of DeletePackageVersionsRequest to an JSON string
   *
   * @return JSON string
   */
