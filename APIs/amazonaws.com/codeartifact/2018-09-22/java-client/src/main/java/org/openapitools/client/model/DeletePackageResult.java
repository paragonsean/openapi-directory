...
import org.openapitools.client.model.PackageSummary;
...
public class DeletePackageResult {
  public static final String SERIALIZED_NAME_DELETED_PACKAGE = "deletedPackage";
  @SerializedName(SERIALIZED_NAME_DELETED_PACKAGE)
  private PackageSummary deletedPackage;

  public DeletePackageResult() {
  }

  public DeletePackageResult deletedPackage(PackageSummary deletedPackage) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePackageResult deletePackageResult = (DeletePackageResult) o;
    return Objects.equals(this.deletedPackage, deletePackageResult.deletedPackage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deletedPackage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePackageResult {\n");
    sb.append("    deletedPackage: ").append(toIndentedString(deletedPackage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("deletedPackage");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePackageResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePackageResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePackageResult is not found in the empty JSON string", DeletePackageResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePackageResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePackageResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `deletedPackage`
      if (jsonObj.get("deletedPackage") != null && !jsonObj.get("deletedPackage").isJsonNull()) {
        PackageSummary.validateJsonElement(jsonObj.get("deletedPackage"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePackageResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePackageResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePackageResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePackageResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePackageResult>() {
           @Override
           public void write(JsonWriter out, DeletePackageResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePackageResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePackageResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePackageResult
   * @throws IOException if the JSON string is invalid with respect to DeletePackageResult
   */
  public static DeletePackageResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePackageResult.class);
  }

  /**
   * Convert an instance of DeletePackageResult to an JSON string
   *
   * @return JSON string
   */
