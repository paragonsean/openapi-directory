...
public class PackageDescriptionOriginConfiguration {
  public static final String SERIALIZED_NAME_RESTRICTIONS = "restrictions";
  @SerializedName(SERIALIZED_NAME_RESTRICTIONS)
  private PackageOriginConfigurationRestrictions restrictions;

  public PackageDescriptionOriginConfiguration() {
  }

  public PackageDescriptionOriginConfiguration restrictions(PackageOriginConfigurationRestrictions restrictions) {
  ...
  public boolean equals(Object o) {
    ...
    PackageDescriptionOriginConfiguration packageDescriptionOriginConfiguration = (PackageDescriptionOriginConfiguration) o;
    return Objects.equals(this.restrictions, packageDescriptionOriginConfiguration.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageDescriptionOriginConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageDescriptionOriginConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageDescriptionOriginConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageDescriptionOriginConfiguration is not found in the empty JSON string", PackageDescriptionOriginConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageDescriptionOriginConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageDescriptionOriginConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageDescriptionOriginConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageDescriptionOriginConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageDescriptionOriginConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageDescriptionOriginConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageDescriptionOriginConfiguration>() {
           @Override
           public void write(JsonWriter out, PackageDescriptionOriginConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageDescriptionOriginConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageDescriptionOriginConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageDescriptionOriginConfiguration
   * @throws IOException if the JSON string is invalid with respect to PackageDescriptionOriginConfiguration
   */
  public static PackageDescriptionOriginConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageDescriptionOriginConfiguration.class);
  }

  /**
   * Convert an instance of PackageDescriptionOriginConfiguration to an JSON string
   *
   * @return JSON string
   */
