...
public class UpstreamRepositoryInfo {
  ...
  public UpstreamRepositoryInfo() {
  }

  public UpstreamRepositoryInfo repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    UpstreamRepositoryInfo upstreamRepositoryInfo = (UpstreamRepositoryInfo) o;
    return Objects.equals(this.repositoryName, upstreamRepositoryInfo.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpstreamRepositoryInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpstreamRepositoryInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpstreamRepositoryInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpstreamRepositoryInfo is not found in the empty JSON string", UpstreamRepositoryInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpstreamRepositoryInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpstreamRepositoryInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpstreamRepositoryInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpstreamRepositoryInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpstreamRepositoryInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpstreamRepositoryInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<UpstreamRepositoryInfo>() {
           @Override
           public void write(JsonWriter out, UpstreamRepositoryInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpstreamRepositoryInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpstreamRepositoryInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpstreamRepositoryInfo
   * @throws IOException if the JSON string is invalid with respect to UpstreamRepositoryInfo
   */
  public static UpstreamRepositoryInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpstreamRepositoryInfo.class);
  }

  /**
   * Convert an instance of UpstreamRepositoryInfo to an JSON string
   *
   * @return JSON string
   */
