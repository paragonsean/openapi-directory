...
public class DomainSummary {
  ...
  public DomainSummary owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public DomainSummary status(DomainStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DomainSummary createdTime(OffsetDateTime createdTime) {
  ...
  public DomainSummary encryptionKey(String encryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, domainSummary.name) &&
        Objects.equals(this.owner, domainSummary.owner) &&
        Objects.equals(this.arn, domainSummary.arn) &&
        Objects.equals(this.status, domainSummary.status) &&
        Objects.equals(this.createdTime, domainSummary.createdTime) &&
        Objects.equals(this.encryptionKey, domainSummary.encryptionKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, owner, arn, status, createdTime, encryptionKey);
  }
