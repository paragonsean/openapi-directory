...
public class PackageOriginConfiguration {
  ...
  public PackageOriginConfiguration() {
  }

  public PackageOriginConfiguration restrictions(PackageOriginConfigurationRestrictions restrictions) {
  ...
  public boolean equals(Object o) {
    ...
    PackageOriginConfiguration packageOriginConfiguration = (PackageOriginConfiguration) o;
    return Objects.equals(this.restrictions, packageOriginConfiguration.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageOriginConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageOriginConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageOriginConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageOriginConfiguration is not found in the empty JSON string", PackageOriginConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageOriginConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageOriginConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageOriginConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageOriginConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageOriginConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageOriginConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageOriginConfiguration>() {
           @Override
           public void write(JsonWriter out, PackageOriginConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageOriginConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageOriginConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageOriginConfiguration
   * @throws IOException if the JSON string is invalid with respect to PackageOriginConfiguration
   */
  public static PackageOriginConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageOriginConfiguration.class);
  }

  /**
   * Convert an instance of PackageOriginConfiguration to an JSON string
   *
   * @return JSON string
   */
