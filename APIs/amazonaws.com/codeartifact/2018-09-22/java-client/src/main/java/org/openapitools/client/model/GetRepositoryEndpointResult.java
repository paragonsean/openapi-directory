...
public class GetRepositoryEndpointResult {
  public static final String SERIALIZED_NAME_REPOSITORY_ENDPOINT = "repositoryEndpoint";
  @SerializedName(SERIALIZED_NAME_REPOSITORY_ENDPOINT)
  private String repositoryEndpoint;

  public GetRepositoryEndpointResult() {
  }

  public GetRepositoryEndpointResult repositoryEndpoint(String repositoryEndpoint) {
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryEndpointResult getRepositoryEndpointResult = (GetRepositoryEndpointResult) o;
    return Objects.equals(this.repositoryEndpoint, getRepositoryEndpointResult.repositoryEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetRepositoryEndpointResult {\n");
    sb.append("    repositoryEndpoint: ").append(toIndentedString(repositoryEndpoint)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("repositoryEndpoint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryEndpointResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryEndpointResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryEndpointResult is not found in the empty JSON string", GetRepositoryEndpointResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryEndpointResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryEndpointResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repositoryEndpoint`
      if (jsonObj.get("repositoryEndpoint") != null && !jsonObj.get("repositoryEndpoint").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("repositoryEndpoint"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryEndpointResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryEndpointResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryEndpointResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryEndpointResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryEndpointResult>() {
           @Override
           public void write(JsonWriter out, GetRepositoryEndpointResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryEndpointResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryEndpointResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryEndpointResult
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryEndpointResult
   */
  public static GetRepositoryEndpointResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryEndpointResult.class);
  }

  /**
   * Convert an instance of GetRepositoryEndpointResult to an JSON string
   *
   * @return JSON string
   */
