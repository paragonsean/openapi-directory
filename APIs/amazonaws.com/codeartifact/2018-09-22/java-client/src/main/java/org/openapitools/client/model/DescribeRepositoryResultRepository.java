...
public class DescribeRepositoryResultRepository {
  ...
  public DescribeRepositoryResultRepository() {
  }

  public DescribeRepositoryResultRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeRepositoryResultRepository administratorAccount(String administratorAccount) {
  ...
  public DescribeRepositoryResultRepository domainName(String domainName) {
  ...
  public DescribeRepositoryResultRepository domainOwner(String domainOwner) {
  ...
  public DescribeRepositoryResultRepository arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DescribeRepositoryResultRepository description(String description) {
  ...
  public DescribeRepositoryResultRepository upstreams(List upstreams) {
  ...
  public DescribeRepositoryResultRepository externalConnections(List externalConnections) {
  ...
  public DescribeRepositoryResultRepository createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeRepositoryResultRepository describeRepositoryResultRepository = (DescribeRepositoryResultRepository) o;
    return Objects.equals(this.name, describeRepositoryResultRepository.name) &&
        Objects.equals(this.administratorAccount, describeRepositoryResultRepository.administratorAccount) &&
        Objects.equals(this.domainName, describeRepositoryResultRepository.domainName) &&
        Objects.equals(this.domainOwner, describeRepositoryResultRepository.domainOwner) &&
        Objects.equals(this.arn, describeRepositoryResultRepository.arn) &&
        Objects.equals(this.description, describeRepositoryResultRepository.description) &&
        Objects.equals(this.upstreams, describeRepositoryResultRepository.upstreams) &&
        Objects.equals(this.externalConnections, describeRepositoryResultRepository.externalConnections) &&
        Objects.equals(this.createdTime, describeRepositoryResultRepository.createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeRepositoryResultRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRepositoryResultRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRepositoryResultRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRepositoryResultRepository is not found in the empty JSON string", DescribeRepositoryResultRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRepositoryResultRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRepositoryResultRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRepositoryResultRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRepositoryResultRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRepositoryResultRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRepositoryResultRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRepositoryResultRepository>() {
           @Override
           public void write(JsonWriter out, DescribeRepositoryResultRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRepositoryResultRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRepositoryResultRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRepositoryResultRepository
   * @throws IOException if the JSON string is invalid with respect to DescribeRepositoryResultRepository
   */
  public static DescribeRepositoryResultRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRepositoryResultRepository.class);
  }

  /**
   * Convert an instance of DescribeRepositoryResultRepository to an JSON string
   *
   * @return JSON string
   */
