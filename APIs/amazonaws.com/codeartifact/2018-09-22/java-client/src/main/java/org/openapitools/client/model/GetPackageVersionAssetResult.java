...
public class GetPackageVersionAssetResult {
  ...
  public GetPackageVersionAssetResult asset(String asset) {
    this.asset = asset;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPackageVersionAssetResult getPackageVersionAssetResult = (GetPackageVersionAssetResult) o;
    return Objects.equals(this.asset, getPackageVersionAssetResult.asset);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPackageVersionAssetResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPackageVersionAssetResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPackageVersionAssetResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPackageVersionAssetResult is not found in the empty JSON string", GetPackageVersionAssetResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPackageVersionAssetResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPackageVersionAssetResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `asset`
      if (jsonObj.get("asset") != null && !jsonObj.get("asset").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("asset"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPackageVersionAssetResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPackageVersionAssetResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPackageVersionAssetResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPackageVersionAssetResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPackageVersionAssetResult>() {
           @Override
           public void write(JsonWriter out, GetPackageVersionAssetResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPackageVersionAssetResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPackageVersionAssetResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPackageVersionAssetResult
   * @throws IOException if the JSON string is invalid with respect to GetPackageVersionAssetResult
   */
  public static GetPackageVersionAssetResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPackageVersionAssetResult.class);
  }

  /**
   * Convert an instance of GetPackageVersionAssetResult to an JSON string
   *
   * @return JSON string
   */
