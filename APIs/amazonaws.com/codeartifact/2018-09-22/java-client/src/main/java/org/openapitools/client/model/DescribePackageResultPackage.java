...
import org.openapitools.client.model.PackageDescriptionOriginConfiguration;
...
public class DescribePackageResultPackage {
  ...
  public static final String SERIALIZED_NAME_ORIGIN_CONFIGURATION = "originConfiguration";
  @SerializedName(SERIALIZED_NAME_ORIGIN_CONFIGURATION)
  private PackageDescriptionOriginConfiguration originConfiguration;

  public DescribePackageResultPackage() {
  }

  public DescribePackageResultPackage format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public DescribePackageResultPackage namespace(String namespace) {
  ...
  public DescribePackageResultPackage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribePackageResultPackage originConfiguration(PackageDescriptionOriginConfiguration originConfiguration) {
    this.originConfiguration = originConfiguration;
    return this;
  }

  /**
   * Get originConfiguration
   * @return originConfiguration
   */
  @javax.annotation.Nullable
  public PackageDescriptionOriginConfiguration getOriginConfiguration() {
    return originConfiguration;
  }

  public void setOriginConfiguration(PackageDescriptionOriginConfiguration originConfiguration) {
    this.originConfiguration = originConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribePackageResultPackage describePackageResultPackage = (DescribePackageResultPackage) o;
    return Objects.equals(this.format, describePackageResultPackage.format) &&
        Objects.equals(this.namespace, describePackageResultPackage.namespace) &&
        Objects.equals(this.name, describePackageResultPackage.name) &&
        Objects.equals(this.originConfiguration, describePackageResultPackage.originConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, name, originConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribePackageResultPackage {\n");
    sb.append("    format: ").append(toIndentedString(format)).append("\n");
    sb.append("    namespace: ").append(toIndentedString(namespace)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    originConfiguration: ").append(toIndentedString(originConfiguration)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("originConfiguration");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePackageResultPackage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePackageResultPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePackageResultPackage is not found in the empty JSON string", DescribePackageResultPackage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePackageResultPackage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePackageResultPackage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("originConfiguration") != null && !jsonObj.get("originConfiguration").isJsonNull()) {
        PackageDescriptionOriginConfiguration.validateJsonElement(jsonObj.get("originConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePackageResultPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePackageResultPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePackageResultPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePackageResultPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePackageResultPackage>() {
           @Override
           public void write(JsonWriter out, DescribePackageResultPackage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePackageResultPackage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePackageResultPackage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePackageResultPackage
   * @throws IOException if the JSON string is invalid with respect to DescribePackageResultPackage
   */
  public static DescribePackageResultPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePackageResultPackage.class);
  }

  /**
   * Convert an instance of DescribePackageResultPackage to an JSON string
   *
   * @return JSON string
   */
