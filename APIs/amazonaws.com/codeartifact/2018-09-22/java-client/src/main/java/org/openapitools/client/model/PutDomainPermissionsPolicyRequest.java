...
public class PutDomainPermissionsPolicyRequest {
  ...
  public static final String SERIALIZED_NAME_POLICY_REVISION = "policyRevision";
  @SerializedName(SERIALIZED_NAME_POLICY_REVISION)
  ...
  public PutDomainPermissionsPolicyRequest() {
  }

  public PutDomainPermissionsPolicyRequest domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public PutDomainPermissionsPolicyRequest domainOwner(String domainOwner) {
  ...
  public PutDomainPermissionsPolicyRequest policyRevision(String policyRevision) {
  ...
  public PutDomainPermissionsPolicyRequest policyDocument(String policyDocument) {
  ...
  public boolean equals(Object o) {
    ...
    PutDomainPermissionsPolicyRequest putDomainPermissionsPolicyRequest = (PutDomainPermissionsPolicyRequest) o;
    return Objects.equals(this.domain, putDomainPermissionsPolicyRequest.domain) &&
        Objects.equals(this.domainOwner, putDomainPermissionsPolicyRequest.domainOwner) &&
        Objects.equals(this.policyRevision, putDomainPermissionsPolicyRequest.policyRevision) &&
        Objects.equals(this.policyDocument, putDomainPermissionsPolicyRequest.policyDocument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, domainOwner, policyRevision, policyDocument);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutDomainPermissionsPolicyRequest {\n");
  ...
  static {
    ...
    openapiFields.add("policyRevision");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDomainPermissionsPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDomainPermissionsPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDomainPermissionsPolicyRequest is not found in the empty JSON string", PutDomainPermissionsPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDomainPermissionsPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDomainPermissionsPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutDomainPermissionsPolicyRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("domainOwner") != null && !jsonObj.get("domainOwner").isJsonNull()) && !jsonObj.get("domainOwner").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `domainOwner` to be a primitive type in the JSON string but got `%s`", jsonObj.get("domainOwner").toString()));
      }
      if ((jsonObj.get("policyRevision") != null && !jsonObj.get("policyRevision").isJsonNull()) && !jsonObj.get("policyRevision").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `policyRevision` to be a primitive type in the JSON string but got `%s`", jsonObj.get("policyRevision").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDomainPermissionsPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDomainPermissionsPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDomainPermissionsPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDomainPermissionsPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDomainPermissionsPolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutDomainPermissionsPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDomainPermissionsPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDomainPermissionsPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDomainPermissionsPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutDomainPermissionsPolicyRequest
   */
  public static PutDomainPermissionsPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDomainPermissionsPolicyRequest.class);
  }

  /**
   * Convert an instance of PutDomainPermissionsPolicyRequest to an JSON string
   *
   * @return JSON string
   */
