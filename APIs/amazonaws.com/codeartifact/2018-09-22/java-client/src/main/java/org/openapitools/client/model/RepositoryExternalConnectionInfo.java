...
import org.openapitools.client.model.ExternalConnectionStatus;
...
public class RepositoryExternalConnectionInfo {
  ...
  public static final String SERIALIZED_NAME_PACKAGE_FORMAT = "packageFormat";
  ...
  public RepositoryExternalConnectionInfo() {
  }

  public RepositoryExternalConnectionInfo externalConnectionName(String externalConnectionName) {
  ...
  public RepositoryExternalConnectionInfo packageFormat(PackageFormat packageFormat) {
  ...
  public RepositoryExternalConnectionInfo status(ExternalConnectionStatus status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ExternalConnectionStatus getStatus() {
    return status;
  }
  ...
  public boolean equals(Object o) {
    ...
    RepositoryExternalConnectionInfo repositoryExternalConnectionInfo = (RepositoryExternalConnectionInfo) o;
    return Objects.equals(this.externalConnectionName, repositoryExternalConnectionInfo.externalConnectionName) &&
        Objects.equals(this.packageFormat, repositoryExternalConnectionInfo.packageFormat) &&
        Objects.equals(this.status, repositoryExternalConnectionInfo.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalConnectionName, packageFormat, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RepositoryExternalConnectionInfo {\n");
  ...
  static {
    ...
    openapiFields.add("packageFormat");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryExternalConnectionInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryExternalConnectionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryExternalConnectionInfo is not found in the empty JSON string", RepositoryExternalConnectionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryExternalConnectionInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryExternalConnectionInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("packageFormat") != null && !jsonObj.get("packageFormat").isJsonNull()) {
        PackageFormat.validateJsonElement(jsonObj.get("packageFormat"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        ExternalConnectionStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryExternalConnectionInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryExternalConnectionInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryExternalConnectionInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryExternalConnectionInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryExternalConnectionInfo>() {
           @Override
           public void write(JsonWriter out, RepositoryExternalConnectionInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryExternalConnectionInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryExternalConnectionInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryExternalConnectionInfo
   * @throws IOException if the JSON string is invalid with respect to RepositoryExternalConnectionInfo
   */
  public static RepositoryExternalConnectionInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryExternalConnectionInfo.class);
  }

  /**
   * Convert an instance of RepositoryExternalConnectionInfo to an JSON string
   *
   * @return JSON string
   */
