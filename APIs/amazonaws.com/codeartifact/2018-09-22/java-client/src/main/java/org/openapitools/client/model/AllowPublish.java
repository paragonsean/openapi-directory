...
/**
 * Gets or Sets AllowPublish
 */
@JsonAdapter(AllowPublish.Adapter.class)
public enum AllowPublish {
  ...
  public static AllowPublish fromValue(String value) {
    for (AllowPublish b : AllowPublish.values()) {
  ...
  public static class Adapter extends TypeAdapter<AllowPublish> {
    @Override
    public void write(final JsonWriter jsonWriter, final AllowPublish enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AllowPublish read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AllowPublish.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AllowPublish.fromValue(value);
  }
}
