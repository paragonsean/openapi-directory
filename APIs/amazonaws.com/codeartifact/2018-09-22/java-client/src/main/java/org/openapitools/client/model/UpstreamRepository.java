...
public class UpstreamRepository {
  ...
  public UpstreamRepository repositoryName(String repositoryName) {
  ...
  public boolean equals(Object o) {
    ...
    UpstreamRepository upstreamRepository = (UpstreamRepository) o;
    return Objects.equals(this.repositoryName, upstreamRepository.repositoryName);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpstreamRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpstreamRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpstreamRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpstreamRepository is not found in the empty JSON string", UpstreamRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpstreamRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpstreamRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpstreamRepository.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpstreamRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpstreamRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpstreamRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpstreamRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<UpstreamRepository>() {
           @Override
           public void write(JsonWriter out, UpstreamRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpstreamRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpstreamRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpstreamRepository
   * @throws IOException if the JSON string is invalid with respect to UpstreamRepository
   */
  public static UpstreamRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpstreamRepository.class);
  }

  /**
   * Convert an instance of UpstreamRepository to an JSON string
   *
   * @return JSON string
   */
