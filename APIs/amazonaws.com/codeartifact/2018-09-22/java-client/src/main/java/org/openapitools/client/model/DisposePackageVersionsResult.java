...
public class DisposePackageVersionsResult {
  ...
  public DisposePackageVersionsResult successfulVersions(Map successfulVersions) {
  ...
  public DisposePackageVersionsResult failedVersions(Map failedVersions) {
  ...
  public boolean equals(Object o) {
    ...
    DisposePackageVersionsResult disposePackageVersionsResult = (DisposePackageVersionsResult) o;
    return Objects.equals(this.successfulVersions, disposePackageVersionsResult.successfulVersions) &&
        Objects.equals(this.failedVersions, disposePackageVersionsResult.failedVersions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisposePackageVersionsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisposePackageVersionsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisposePackageVersionsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisposePackageVersionsResult is not found in the empty JSON string", DisposePackageVersionsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisposePackageVersionsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisposePackageVersionsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisposePackageVersionsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisposePackageVersionsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisposePackageVersionsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisposePackageVersionsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DisposePackageVersionsResult>() {
           @Override
           public void write(JsonWriter out, DisposePackageVersionsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisposePackageVersionsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisposePackageVersionsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisposePackageVersionsResult
   * @throws IOException if the JSON string is invalid with respect to DisposePackageVersionsResult
   */
  public static DisposePackageVersionsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisposePackageVersionsResult.class);
  }

  /**
   * Convert an instance of DisposePackageVersionsResult to an JSON string
   *
   * @return JSON string
   */
