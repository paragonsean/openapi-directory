...
public class ListRepositoriesResult {
  ...
  public ListRepositoriesResult repositories(List repositories) {
  ...
  public ListRepositoriesResult nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListRepositoriesResult listRepositoriesResult = (ListRepositoriesResult) o;
    return Objects.equals(this.repositories, listRepositoriesResult.repositories) &&
        Objects.equals(this.nextToken, listRepositoriesResult.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListRepositoriesResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRepositoriesResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRepositoriesResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRepositoriesResult is not found in the empty JSON string", ListRepositoriesResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRepositoriesResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRepositoriesResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRepositoriesResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRepositoriesResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRepositoriesResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRepositoriesResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRepositoriesResult>() {
           @Override
           public void write(JsonWriter out, ListRepositoriesResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRepositoriesResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRepositoriesResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRepositoriesResult
   * @throws IOException if the JSON string is invalid with respect to ListRepositoriesResult
   */
  public static ListRepositoriesResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRepositoriesResult.class);
  }

  /**
   * Convert an instance of ListRepositoriesResult to an JSON string
   *
   * @return JSON string
   */
