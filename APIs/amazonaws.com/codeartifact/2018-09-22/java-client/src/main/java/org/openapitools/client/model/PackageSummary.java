...
public class PackageSummary {
  ...
  private PackageSummaryOriginConfiguration originConfiguration;

  public PackageSummary() {
  }

  public PackageSummary format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public PackageSummary namespace(String namespace) {
  ...
  public PackageSummary _package(String _package) {
  ...
  public PackageSummary originConfiguration(PackageSummaryOriginConfiguration originConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public PackageSummaryOriginConfiguration getOriginConfiguration() {
    return originConfiguration;
  }

  public void setOriginConfiguration(PackageSummaryOriginConfiguration originConfiguration) {
    this.originConfiguration = originConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, packageSummary.format) &&
        Objects.equals(this.namespace, packageSummary.namespace) &&
        Objects.equals(this._package, packageSummary._package) &&
        Objects.equals(this.originConfiguration, packageSummary.originConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, _package, originConfiguration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("originConfiguration") != null && !jsonObj.get("originConfiguration").isJsonNull()) {
        PackageSummaryOriginConfiguration.validateJsonElement(jsonObj.get("originConfiguration"));
      }
  }
