...
public class DeleteRepositoryPermissionsPolicyResultPolicy {
  ...
  public DeleteRepositoryPermissionsPolicyResultPolicy() {
  }

  public DeleteRepositoryPermissionsPolicyResultPolicy resourceArn(String resourceArn) {
  ...
  public DeleteRepositoryPermissionsPolicyResultPolicy revision(String revision) {
  ...
  public DeleteRepositoryPermissionsPolicyResultPolicy document(String document) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteRepositoryPermissionsPolicyResultPolicy deleteRepositoryPermissionsPolicyResultPolicy = (DeleteRepositoryPermissionsPolicyResultPolicy) o;
    return Objects.equals(this.resourceArn, deleteRepositoryPermissionsPolicyResultPolicy.resourceArn) &&
        Objects.equals(this.revision, deleteRepositoryPermissionsPolicyResultPolicy.revision) &&
        Objects.equals(this.document, deleteRepositoryPermissionsPolicyResultPolicy.document);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRepositoryPermissionsPolicyResultPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRepositoryPermissionsPolicyResultPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRepositoryPermissionsPolicyResultPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRepositoryPermissionsPolicyResultPolicy is not found in the empty JSON string", DeleteRepositoryPermissionsPolicyResultPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRepositoryPermissionsPolicyResultPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRepositoryPermissionsPolicyResultPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRepositoryPermissionsPolicyResultPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRepositoryPermissionsPolicyResultPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRepositoryPermissionsPolicyResultPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRepositoryPermissionsPolicyResultPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRepositoryPermissionsPolicyResultPolicy>() {
           @Override
           public void write(JsonWriter out, DeleteRepositoryPermissionsPolicyResultPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRepositoryPermissionsPolicyResultPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRepositoryPermissionsPolicyResultPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRepositoryPermissionsPolicyResultPolicy
   * @throws IOException if the JSON string is invalid with respect to DeleteRepositoryPermissionsPolicyResultPolicy
   */
  public static DeleteRepositoryPermissionsPolicyResultPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRepositoryPermissionsPolicyResultPolicy.class);
  }

  /**
   * Convert an instance of DeleteRepositoryPermissionsPolicyResultPolicy to an JSON string
   *
   * @return JSON string
   */
