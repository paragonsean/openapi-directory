...
public class PackageVersionSummary {
  ...
  public PackageVersionSummary() {
  }

  public PackageVersionSummary version(String version) {
  ...
  public PackageVersionSummary revision(String revision) {
  ...
  public PackageVersionSummary status(PackageVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PackageVersionSummary origin(PackageVersionDescriptionOrigin origin) {
    this.origin = origin;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PackageVersionSummary packageVersionSummary = (PackageVersionSummary) o;
    return Objects.equals(this.version, packageVersionSummary.version) &&
        Objects.equals(this.revision, packageVersionSummary.revision) &&
        Objects.equals(this.status, packageVersionSummary.status) &&
        Objects.equals(this.origin, packageVersionSummary.origin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, revision, status, origin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PackageVersionSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageVersionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageVersionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageVersionSummary is not found in the empty JSON string", PackageVersionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageVersionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageVersionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PackageVersionSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageVersionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageVersionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageVersionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageVersionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageVersionSummary>() {
           @Override
           public void write(JsonWriter out, PackageVersionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageVersionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageVersionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageVersionSummary
   * @throws IOException if the JSON string is invalid with respect to PackageVersionSummary
   */
  public static PackageVersionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageVersionSummary.class);
  }

  /**
   * Convert an instance of PackageVersionSummary to an JSON string
   *
   * @return JSON string
   */
