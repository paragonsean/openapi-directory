...
public class PackageVersionOrigin {
  ...
  public PackageVersionOrigin domainEntryPoint(PackageVersionOriginDomainEntryPoint domainEntryPoint) {
  ...
  public PackageVersionOrigin originType(PackageVersionOriginType originType) {
  ...
  public boolean equals(Object o) {
    ...
    PackageVersionOrigin packageVersionOrigin = (PackageVersionOrigin) o;
    return Objects.equals(this.domainEntryPoint, packageVersionOrigin.domainEntryPoint) &&
        Objects.equals(this.originType, packageVersionOrigin.originType);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageVersionOrigin {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageVersionOrigin
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageVersionOrigin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageVersionOrigin is not found in the empty JSON string", PackageVersionOrigin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageVersionOrigin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageVersionOrigin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageVersionOrigin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageVersionOrigin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageVersionOrigin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageVersionOrigin.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageVersionOrigin>() {
           @Override
           public void write(JsonWriter out, PackageVersionOrigin value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageVersionOrigin read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageVersionOrigin given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageVersionOrigin
   * @throws IOException if the JSON string is invalid with respect to PackageVersionOrigin
   */
  public static PackageVersionOrigin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageVersionOrigin.class);
  }

  /**
   * Convert an instance of PackageVersionOrigin to an JSON string
   *
   * @return JSON string
   */
