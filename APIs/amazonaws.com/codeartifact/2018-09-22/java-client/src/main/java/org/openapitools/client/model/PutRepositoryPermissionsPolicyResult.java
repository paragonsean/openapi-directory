...
import org.openapitools.client.model.PutDomainPermissionsPolicyResultPolicy;
...
public class PutRepositoryPermissionsPolicyResult {
  ...
  private PutDomainPermissionsPolicyResultPolicy policy;

  public PutRepositoryPermissionsPolicyResult() {
  }

  public PutRepositoryPermissionsPolicyResult policy(PutDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public PutDomainPermissionsPolicyResultPolicy getPolicy() {
    return policy;
  }

  public void setPolicy(PutDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutRepositoryPermissionsPolicyResult putRepositoryPermissionsPolicyResult = (PutRepositoryPermissionsPolicyResult) o;
    return Objects.equals(this.policy, putRepositoryPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutRepositoryPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutRepositoryPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutRepositoryPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutRepositoryPermissionsPolicyResult is not found in the empty JSON string", PutRepositoryPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutRepositoryPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutRepositoryPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `policy`
      if (jsonObj.get("policy") != null && !jsonObj.get("policy").isJsonNull()) {
        PutDomainPermissionsPolicyResultPolicy.validateJsonElement(jsonObj.get("policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutRepositoryPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutRepositoryPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutRepositoryPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutRepositoryPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PutRepositoryPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, PutRepositoryPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutRepositoryPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutRepositoryPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutRepositoryPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to PutRepositoryPermissionsPolicyResult
   */
  public static PutRepositoryPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutRepositoryPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of PutRepositoryPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
