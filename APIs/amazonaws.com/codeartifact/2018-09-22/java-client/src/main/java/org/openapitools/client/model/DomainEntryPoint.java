...
public class DomainEntryPoint {
  ...
  public DomainEntryPoint repositoryName(String repositoryName) {
  ...
  public DomainEntryPoint externalConnectionName(String externalConnectionName) {
  ...
  public boolean equals(Object o) {
    ...
    DomainEntryPoint domainEntryPoint = (DomainEntryPoint) o;
    return Objects.equals(this.repositoryName, domainEntryPoint.repositoryName) &&
        Objects.equals(this.externalConnectionName, domainEntryPoint.externalConnectionName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainEntryPoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainEntryPoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainEntryPoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainEntryPoint is not found in the empty JSON string", DomainEntryPoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainEntryPoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainEntryPoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainEntryPoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainEntryPoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainEntryPoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainEntryPoint.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainEntryPoint>() {
           @Override
           public void write(JsonWriter out, DomainEntryPoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainEntryPoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainEntryPoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainEntryPoint
   * @throws IOException if the JSON string is invalid with respect to DomainEntryPoint
   */
  public static DomainEntryPoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainEntryPoint.class);
  }

  /**
   * Convert an instance of DomainEntryPoint to an JSON string
   *
   * @return JSON string
   */
