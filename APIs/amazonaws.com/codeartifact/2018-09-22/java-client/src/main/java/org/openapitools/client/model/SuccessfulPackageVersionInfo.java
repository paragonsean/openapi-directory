...
public class SuccessfulPackageVersionInfo {
  ...
  public SuccessfulPackageVersionInfo() {
  }

  public SuccessfulPackageVersionInfo revision(String revision) {
  ...
  public SuccessfulPackageVersionInfo status(PackageVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SuccessfulPackageVersionInfo successfulPackageVersionInfo = (SuccessfulPackageVersionInfo) o;
    return Objects.equals(this.revision, successfulPackageVersionInfo.revision) &&
        Objects.equals(this.status, successfulPackageVersionInfo.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuccessfulPackageVersionInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuccessfulPackageVersionInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuccessfulPackageVersionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuccessfulPackageVersionInfo is not found in the empty JSON string", SuccessfulPackageVersionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuccessfulPackageVersionInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuccessfulPackageVersionInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuccessfulPackageVersionInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuccessfulPackageVersionInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuccessfulPackageVersionInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuccessfulPackageVersionInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SuccessfulPackageVersionInfo>() {
           @Override
           public void write(JsonWriter out, SuccessfulPackageVersionInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuccessfulPackageVersionInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuccessfulPackageVersionInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuccessfulPackageVersionInfo
   * @throws IOException if the JSON string is invalid with respect to SuccessfulPackageVersionInfo
   */
  public static SuccessfulPackageVersionInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuccessfulPackageVersionInfo.class);
  }

  /**
   * Convert an instance of SuccessfulPackageVersionInfo to an JSON string
   *
   * @return JSON string
   */
