...
/**
 * Gets or Sets PackageVersionSortType
 */
@JsonAdapter(PackageVersionSortType.Adapter.class)
public enum PackageVersionSortType {
  ...
  PackageVersionSortType(String value) {
    this.value = value;
  }
  ...
  public static PackageVersionSortType fromValue(String value) {
    for (PackageVersionSortType b : PackageVersionSortType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PackageVersionSortType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PackageVersionSortType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PackageVersionSortType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PackageVersionSortType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PackageVersionSortType.fromValue(value);
  }
}
