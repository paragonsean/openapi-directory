...
import org.openapitools.client.model.PublishPackageVersionResultAsset;
...
public class PublishPackageVersionResult {
  ...
  private PublishPackageVersionResultAsset asset;

  public PublishPackageVersionResult() {
  }

  public PublishPackageVersionResult format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public PublishPackageVersionResult namespace(String namespace) {
  ...
  public PublishPackageVersionResult _package(String _package) {
  ...
  public PublishPackageVersionResult version(String version) {
  ...
  public PublishPackageVersionResult versionRevision(String versionRevision) {
  ...
  public PublishPackageVersionResult status(PackageVersionStatus status) {
    this.status = status;
    return this;
  }
  ...
  public PublishPackageVersionResult asset(PublishPackageVersionResultAsset asset) {
    this.asset = asset;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PublishPackageVersionResultAsset getAsset() {
    return asset;
  }

  public void setAsset(PublishPackageVersionResultAsset asset) {
    this.asset = asset;
  }
  ...
  public boolean equals(Object o) {
    ...
    PublishPackageVersionResult publishPackageVersionResult = (PublishPackageVersionResult) o;
    return Objects.equals(this.format, publishPackageVersionResult.format) &&
        Objects.equals(this.namespace, publishPackageVersionResult.namespace) &&
        Objects.equals(this._package, publishPackageVersionResult._package) &&
        Objects.equals(this.version, publishPackageVersionResult.version) &&
        Objects.equals(this.versionRevision, publishPackageVersionResult.versionRevision) &&
        Objects.equals(this.status, publishPackageVersionResult.status) &&
        Objects.equals(this.asset, publishPackageVersionResult.asset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, _package, version, versionRevision, status, asset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublishPackageVersionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublishPackageVersionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishPackageVersionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishPackageVersionResult is not found in the empty JSON string", PublishPackageVersionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublishPackageVersionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublishPackageVersionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("asset") != null && !jsonObj.get("asset").isJsonNull()) {
        PublishPackageVersionResultAsset.validateJsonElement(jsonObj.get("asset"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublishPackageVersionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublishPackageVersionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublishPackageVersionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublishPackageVersionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PublishPackageVersionResult>() {
           @Override
           public void write(JsonWriter out, PublishPackageVersionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublishPackageVersionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublishPackageVersionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublishPackageVersionResult
   * @throws IOException if the JSON string is invalid with respect to PublishPackageVersionResult
   */
  public static PublishPackageVersionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublishPackageVersionResult.class);
  }

  /**
   * Convert an instance of PublishPackageVersionResult to an JSON string
   *
   * @return JSON string
   */
