...
import org.openapitools.client.model.CreateDomainResultDomain;
...
public class CreateDomainResult {
  ...
  private CreateDomainResultDomain domain;

  public CreateDomainResult() {
  }

  public CreateDomainResult domain(CreateDomainResultDomain domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CreateDomainResultDomain getDomain() {
    return domain;
  }

  public void setDomain(CreateDomainResultDomain domain) {
    this.domain = domain;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, createDomainResult.domain);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("domain") != null && !jsonObj.get("domain").isJsonNull()) {
        CreateDomainResultDomain.validateJsonElement(jsonObj.get("domain"));
      }
  }
