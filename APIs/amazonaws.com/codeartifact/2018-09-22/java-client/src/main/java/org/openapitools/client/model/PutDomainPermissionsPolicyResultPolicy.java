...
public class PutDomainPermissionsPolicyResultPolicy {
  ...
  public PutDomainPermissionsPolicyResultPolicy() {
  }

  public PutDomainPermissionsPolicyResultPolicy resourceArn(String resourceArn) {
  ...
  public PutDomainPermissionsPolicyResultPolicy revision(String revision) {
  ...
  public PutDomainPermissionsPolicyResultPolicy document(String document) {
  ...
  public boolean equals(Object o) {
    ...
    PutDomainPermissionsPolicyResultPolicy putDomainPermissionsPolicyResultPolicy = (PutDomainPermissionsPolicyResultPolicy) o;
    return Objects.equals(this.resourceArn, putDomainPermissionsPolicyResultPolicy.resourceArn) &&
        Objects.equals(this.revision, putDomainPermissionsPolicyResultPolicy.revision) &&
        Objects.equals(this.document, putDomainPermissionsPolicyResultPolicy.document);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDomainPermissionsPolicyResultPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDomainPermissionsPolicyResultPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDomainPermissionsPolicyResultPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDomainPermissionsPolicyResultPolicy is not found in the empty JSON string", PutDomainPermissionsPolicyResultPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDomainPermissionsPolicyResultPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDomainPermissionsPolicyResultPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDomainPermissionsPolicyResultPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDomainPermissionsPolicyResultPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDomainPermissionsPolicyResultPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDomainPermissionsPolicyResultPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDomainPermissionsPolicyResultPolicy>() {
           @Override
           public void write(JsonWriter out, PutDomainPermissionsPolicyResultPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDomainPermissionsPolicyResultPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDomainPermissionsPolicyResultPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDomainPermissionsPolicyResultPolicy
   * @throws IOException if the JSON string is invalid with respect to PutDomainPermissionsPolicyResultPolicy
   */
  public static PutDomainPermissionsPolicyResultPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDomainPermissionsPolicyResultPolicy.class);
  }

  /**
   * Convert an instance of PutDomainPermissionsPolicyResultPolicy to an JSON string
   *
   * @return JSON string
   */
