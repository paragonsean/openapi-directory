...
public class PublishPackageVersionRequest {
  public static final String SERIALIZED_NAME_ASSET_CONTENT = "assetContent";
  @SerializedName(SERIALIZED_NAME_ASSET_CONTENT)
  private String assetContent;

  public PublishPackageVersionRequest() {
  }

  public PublishPackageVersionRequest assetContent(String assetContent) {
  ...
  public boolean equals(Object o) {
    ...
    PublishPackageVersionRequest publishPackageVersionRequest = (PublishPackageVersionRequest) o;
    return Objects.equals(this.assetContent, publishPackageVersionRequest.assetContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assetContent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublishPackageVersionRequest {\n");
  ...
  static {
    ...
    openapiFields.add("assetContent");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("assetContent");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublishPackageVersionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishPackageVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishPackageVersionRequest is not found in the empty JSON string", PublishPackageVersionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublishPackageVersionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublishPackageVersionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublishPackageVersionRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("assetContent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `assetContent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("assetContent").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublishPackageVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublishPackageVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublishPackageVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublishPackageVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PublishPackageVersionRequest>() {
           @Override
           public void write(JsonWriter out, PublishPackageVersionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublishPackageVersionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublishPackageVersionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublishPackageVersionRequest
   * @throws IOException if the JSON string is invalid with respect to PublishPackageVersionRequest
   */
  public static PublishPackageVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublishPackageVersionRequest.class);
  }

  /**
   * Convert an instance of PublishPackageVersionRequest to an JSON string
   *
   * @return JSON string
   */
