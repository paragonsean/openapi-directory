...
public class ListRepositoriesInDomainResult {
  ...
  public ListRepositoriesInDomainResult() {
  }

  public ListRepositoriesInDomainResult repositories(List repositories) {
  ...
  public ListRepositoriesInDomainResult nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListRepositoriesInDomainResult listRepositoriesInDomainResult = (ListRepositoriesInDomainResult) o;
    return Objects.equals(this.repositories, listRepositoriesInDomainResult.repositories) &&
        Objects.equals(this.nextToken, listRepositoriesInDomainResult.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListRepositoriesInDomainResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListRepositoriesInDomainResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRepositoriesInDomainResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListRepositoriesInDomainResult is not found in the empty JSON string", ListRepositoriesInDomainResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRepositoriesInDomainResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListRepositoriesInDomainResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListRepositoriesInDomainResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListRepositoriesInDomainResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListRepositoriesInDomainResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListRepositoriesInDomainResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListRepositoriesInDomainResult>() {
           @Override
           public void write(JsonWriter out, ListRepositoriesInDomainResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListRepositoriesInDomainResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListRepositoriesInDomainResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListRepositoriesInDomainResult
   * @throws IOException if the JSON string is invalid with respect to ListRepositoriesInDomainResult
   */
  public static ListRepositoriesInDomainResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListRepositoriesInDomainResult.class);
  }

  /**
   * Convert an instance of ListRepositoriesInDomainResult to an JSON string
   *
   * @return JSON string
   */
