...
public class PackageOriginConfigurationRestrictions {
  ...
  public PackageOriginConfigurationRestrictions() {
  }

  public PackageOriginConfigurationRestrictions publish(AllowPublish publish) {
  ...
  public PackageOriginConfigurationRestrictions upstream(AllowUpstream upstream) {
  ...
  public boolean equals(Object o) {
    ...
    PackageOriginConfigurationRestrictions packageOriginConfigurationRestrictions = (PackageOriginConfigurationRestrictions) o;
    return Objects.equals(this.publish, packageOriginConfigurationRestrictions.publish) &&
        Objects.equals(this.upstream, packageOriginConfigurationRestrictions.upstream);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageOriginConfigurationRestrictions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageOriginConfigurationRestrictions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageOriginConfigurationRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageOriginConfigurationRestrictions is not found in the empty JSON string", PackageOriginConfigurationRestrictions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageOriginConfigurationRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageOriginConfigurationRestrictions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PackageOriginConfigurationRestrictions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageOriginConfigurationRestrictions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageOriginConfigurationRestrictions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageOriginConfigurationRestrictions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageOriginConfigurationRestrictions.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageOriginConfigurationRestrictions>() {
           @Override
           public void write(JsonWriter out, PackageOriginConfigurationRestrictions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageOriginConfigurationRestrictions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageOriginConfigurationRestrictions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageOriginConfigurationRestrictions
   * @throws IOException if the JSON string is invalid with respect to PackageOriginConfigurationRestrictions
   */
  public static PackageOriginConfigurationRestrictions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageOriginConfigurationRestrictions.class);
  }

  /**
   * Convert an instance of PackageOriginConfigurationRestrictions to an JSON string
   *
   * @return JSON string
   */
