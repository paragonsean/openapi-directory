...
public class GetAuthorizationTokenResult {
  ...
  public GetAuthorizationTokenResult() {
  }
  ...
  public GetAuthorizationTokenResult expiration(OffsetDateTime expiration) {
  ...
  public boolean equals(Object o) {
    ...
    GetAuthorizationTokenResult getAuthorizationTokenResult = (GetAuthorizationTokenResult) o;
    return Objects.equals(this.authorizationToken, getAuthorizationTokenResult.authorizationToken) &&
        Objects.equals(this.expiration, getAuthorizationTokenResult.expiration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationToken, expiration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAuthorizationTokenResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAuthorizationTokenResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAuthorizationTokenResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAuthorizationTokenResult is not found in the empty JSON string", GetAuthorizationTokenResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAuthorizationTokenResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAuthorizationTokenResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAuthorizationTokenResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAuthorizationTokenResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAuthorizationTokenResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAuthorizationTokenResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAuthorizationTokenResult>() {
           @Override
           public void write(JsonWriter out, GetAuthorizationTokenResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAuthorizationTokenResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAuthorizationTokenResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAuthorizationTokenResult
   * @throws IOException if the JSON string is invalid with respect to GetAuthorizationTokenResult
   */
  public static GetAuthorizationTokenResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAuthorizationTokenResult.class);
  }

  /**
   * Convert an instance of GetAuthorizationTokenResult to an JSON string
   *
   * @return JSON string
   */
