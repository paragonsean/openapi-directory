...
public class PackageVersionOriginDomainEntryPoint {
  ...
  public static final String SERIALIZED_NAME_EXTERNAL_CONNECTION_NAME = "externalConnectionName";
  @SerializedName(SERIALIZED_NAME_EXTERNAL_CONNECTION_NAME)
  private String externalConnectionName;

  public PackageVersionOriginDomainEntryPoint() {
  }

  public PackageVersionOriginDomainEntryPoint repositoryName(String repositoryName) {
  ...
  public PackageVersionOriginDomainEntryPoint externalConnectionName(String externalConnectionName) {
    this.externalConnectionName = externalConnectionName;
    return this;
  }

  /**
   * Get externalConnectionName
  ...
  public boolean equals(Object o) {
    ...
    PackageVersionOriginDomainEntryPoint packageVersionOriginDomainEntryPoint = (PackageVersionOriginDomainEntryPoint) o;
    return Objects.equals(this.repositoryName, packageVersionOriginDomainEntryPoint.repositoryName) &&
        Objects.equals(this.externalConnectionName, packageVersionOriginDomainEntryPoint.externalConnectionName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repositoryName, externalConnectionName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PackageVersionOriginDomainEntryPoint {\n");
    sb.append("    repositoryName: ").append(toIndentedString(repositoryName)).append("\n");
    sb.append("    externalConnectionName: ").append(toIndentedString(externalConnectionName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("externalConnectionName");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageVersionOriginDomainEntryPoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageVersionOriginDomainEntryPoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageVersionOriginDomainEntryPoint is not found in the empty JSON string", PackageVersionOriginDomainEntryPoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageVersionOriginDomainEntryPoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageVersionOriginDomainEntryPoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `externalConnectionName`
      if (jsonObj.get("externalConnectionName") != null && !jsonObj.get("externalConnectionName").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("externalConnectionName"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageVersionOriginDomainEntryPoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageVersionOriginDomainEntryPoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageVersionOriginDomainEntryPoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageVersionOriginDomainEntryPoint.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageVersionOriginDomainEntryPoint>() {
           @Override
           public void write(JsonWriter out, PackageVersionOriginDomainEntryPoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageVersionOriginDomainEntryPoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageVersionOriginDomainEntryPoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageVersionOriginDomainEntryPoint
   * @throws IOException if the JSON string is invalid with respect to PackageVersionOriginDomainEntryPoint
   */
  public static PackageVersionOriginDomainEntryPoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageVersionOriginDomainEntryPoint.class);
  }

  /**
   * Convert an instance of PackageVersionOriginDomainEntryPoint to an JSON string
   *
   * @return JSON string
   */
