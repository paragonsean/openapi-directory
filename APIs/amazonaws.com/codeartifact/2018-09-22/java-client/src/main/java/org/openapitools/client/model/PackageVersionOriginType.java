...
/**
 * Gets or Sets PackageVersionOriginType
 */
@JsonAdapter(PackageVersionOriginType.Adapter.class)
public enum PackageVersionOriginType {
  ...
  PackageVersionOriginType(String value) {
    this.value = value;
  }
  ...
  public static PackageVersionOriginType fromValue(String value) {
    for (PackageVersionOriginType b : PackageVersionOriginType.values()) {
  ...
  public static class Adapter extends TypeAdapter<PackageVersionOriginType> {
    @Override
    public void write(final JsonWriter jsonWriter, final PackageVersionOriginType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PackageVersionOriginType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PackageVersionOriginType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PackageVersionOriginType.fromValue(value);
  }
}
