...
public class PackageVersionError {
  ...
  private PackageVersionErrorCode errorCode;

  public static final String SERIALIZED_NAME_ERROR_MESSAGE = "errorMessage";
  @SerializedName(SERIALIZED_NAME_ERROR_MESSAGE)
  private String errorMessage;

  public PackageVersionError() {
  }

  public PackageVersionError errorCode(PackageVersionErrorCode errorCode) {
  ...
  public PackageVersionErrorCode getErrorCode() {
    return errorCode;
  }
  ...
  public PackageVersionError errorMessage(String errorMessage) {
  ...
  public boolean equals(Object o) {
    ...
    PackageVersionError packageVersionError = (PackageVersionError) o;
    return Objects.equals(this.errorCode, packageVersionError.errorCode) &&
        Objects.equals(this.errorMessage, packageVersionError.errorMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class PackageVersionError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageVersionError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageVersionError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageVersionError is not found in the empty JSON string", PackageVersionError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageVersionError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageVersionError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `errorCode`
      if (jsonObj.get("errorCode") != null && !jsonObj.get("errorCode").isJsonNull()) {
        PackageVersionErrorCode.validateJsonElement(jsonObj.get("errorCode"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageVersionError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageVersionError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageVersionError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageVersionError.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageVersionError>() {
           @Override
           public void write(JsonWriter out, PackageVersionError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageVersionError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageVersionError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageVersionError
   * @throws IOException if the JSON string is invalid with respect to PackageVersionError
   */
  public static PackageVersionError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageVersionError.class);
  }

  /**
   * Convert an instance of PackageVersionError to an JSON string
   *
   * @return JSON string
   */
