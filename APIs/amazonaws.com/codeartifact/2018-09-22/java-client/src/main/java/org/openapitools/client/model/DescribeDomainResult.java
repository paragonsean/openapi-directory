...
import org.openapitools.client.model.DomainDescription;
...
public class DescribeDomainResult {
  ...
  public DescribeDomainResult() {
  }

  public DescribeDomainResult domain(DomainDescription domain) {
    this.domain = domain;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeDomainResult describeDomainResult = (DescribeDomainResult) o;
    return Objects.equals(this.domain, describeDomainResult.domain);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeDomainResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDomainResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDomainResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDomainResult is not found in the empty JSON string", DescribeDomainResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDomainResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDomainResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `domain`
      if (jsonObj.get("domain") != null && !jsonObj.get("domain").isJsonNull()) {
        DomainDescription.validateJsonElement(jsonObj.get("domain"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDomainResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDomainResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDomainResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDomainResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDomainResult>() {
           @Override
           public void write(JsonWriter out, DescribeDomainResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDomainResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDomainResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDomainResult
   * @throws IOException if the JSON string is invalid with respect to DescribeDomainResult
   */
  public static DescribeDomainResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDomainResult.class);
  }

  /**
   * Convert an instance of DescribeDomainResult to an JSON string
   *
   * @return JSON string
   */
