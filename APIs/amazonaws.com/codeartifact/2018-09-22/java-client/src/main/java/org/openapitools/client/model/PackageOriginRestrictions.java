...
public class PackageOriginRestrictions {
  ...
  private AllowPublish publish;

  public static final String SERIALIZED_NAME_UPSTREAM = "upstream";
  @SerializedName(SERIALIZED_NAME_UPSTREAM)
  private AllowUpstream upstream;

  public PackageOriginRestrictions() {
  }

  public PackageOriginRestrictions publish(AllowPublish publish) {
  ...
  public AllowPublish getPublish() {
    return publish;
  }

  public void setPublish(AllowPublish publish) {
    this.publish = publish;
  }


  public PackageOriginRestrictions upstream(AllowUpstream upstream) {
   ...
   */
  @javax.annotation.Nonnull
  public AllowUpstream getUpstream() {
    return upstream;
  }

  public void setUpstream(AllowUpstream upstream) {
    this.upstream = upstream;
  }
  ...
  public boolean equals(Object o) {
    ...
    PackageOriginRestrictions packageOriginRestrictions = (PackageOriginRestrictions) o;
    return Objects.equals(this.publish, packageOriginRestrictions.publish) &&
        Objects.equals(this.upstream, packageOriginRestrictions.upstream);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publish, upstream);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PackageOriginRestrictions {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("upstream");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageOriginRestrictions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageOriginRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageOriginRestrictions is not found in the empty JSON string", PackageOriginRestrictions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageOriginRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageOriginRestrictions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PackageOriginRestrictions.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `publish`
      AllowPublish.validateJsonElement(jsonObj.get("publish"));
      // validate the required field `upstream`
      AllowUpstream.validateJsonElement(jsonObj.get("upstream"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageOriginRestrictions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageOriginRestrictions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageOriginRestrictions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageOriginRestrictions.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageOriginRestrictions>() {
           @Override
           public void write(JsonWriter out, PackageOriginRestrictions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageOriginRestrictions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageOriginRestrictions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageOriginRestrictions
   * @throws IOException if the JSON string is invalid with respect to PackageOriginRestrictions
   */
  public static PackageOriginRestrictions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageOriginRestrictions.class);
  }

  /**
   * Convert an instance of PackageOriginRestrictions to an JSON string
   *
   * @return JSON string
   */
