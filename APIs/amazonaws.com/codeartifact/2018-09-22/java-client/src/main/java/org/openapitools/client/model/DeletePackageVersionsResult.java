...
public class DeletePackageVersionsResult {
  ...
  public DeletePackageVersionsResult successfulVersions(Map successfulVersions) {
  ...
  public DeletePackageVersionsResult failedVersions(Map failedVersions) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePackageVersionsResult deletePackageVersionsResult = (DeletePackageVersionsResult) o;
    return Objects.equals(this.successfulVersions, deletePackageVersionsResult.successfulVersions) &&
        Objects.equals(this.failedVersions, deletePackageVersionsResult.failedVersions);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePackageVersionsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePackageVersionsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePackageVersionsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePackageVersionsResult is not found in the empty JSON string", DeletePackageVersionsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePackageVersionsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePackageVersionsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePackageVersionsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePackageVersionsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePackageVersionsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePackageVersionsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePackageVersionsResult>() {
           @Override
           public void write(JsonWriter out, DeletePackageVersionsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePackageVersionsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePackageVersionsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePackageVersionsResult
   * @throws IOException if the JSON string is invalid with respect to DeletePackageVersionsResult
   */
  public static DeletePackageVersionsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePackageVersionsResult.class);
  }

  /**
   * Convert an instance of DeletePackageVersionsResult to an JSON string
   *
   * @return JSON string
   */
