...
public class DeleteRepositoryResultRepository {
  ...
  public DeleteRepositoryResultRepository() {
  }

  public DeleteRepositoryResultRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteRepositoryResultRepository administratorAccount(String administratorAccount) {
  ...
  public DeleteRepositoryResultRepository domainName(String domainName) {
  ...
  public DeleteRepositoryResultRepository domainOwner(String domainOwner) {
  ...
  public DeleteRepositoryResultRepository arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteRepositoryResultRepository description(String description) {
  ...
  public DeleteRepositoryResultRepository upstreams(List upstreams) {
  ...
  public DeleteRepositoryResultRepository externalConnections(List externalConnections) {
  ...
  public DeleteRepositoryResultRepository createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteRepositoryResultRepository deleteRepositoryResultRepository = (DeleteRepositoryResultRepository) o;
    return Objects.equals(this.name, deleteRepositoryResultRepository.name) &&
        Objects.equals(this.administratorAccount, deleteRepositoryResultRepository.administratorAccount) &&
        Objects.equals(this.domainName, deleteRepositoryResultRepository.domainName) &&
        Objects.equals(this.domainOwner, deleteRepositoryResultRepository.domainOwner) &&
        Objects.equals(this.arn, deleteRepositoryResultRepository.arn) &&
        Objects.equals(this.description, deleteRepositoryResultRepository.description) &&
        Objects.equals(this.upstreams, deleteRepositoryResultRepository.upstreams) &&
        Objects.equals(this.externalConnections, deleteRepositoryResultRepository.externalConnections) &&
        Objects.equals(this.createdTime, deleteRepositoryResultRepository.createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRepositoryResultRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRepositoryResultRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRepositoryResultRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRepositoryResultRepository is not found in the empty JSON string", DeleteRepositoryResultRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRepositoryResultRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRepositoryResultRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRepositoryResultRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRepositoryResultRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRepositoryResultRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRepositoryResultRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRepositoryResultRepository>() {
           @Override
           public void write(JsonWriter out, DeleteRepositoryResultRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRepositoryResultRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRepositoryResultRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRepositoryResultRepository
   * @throws IOException if the JSON string is invalid with respect to DeleteRepositoryResultRepository
   */
  public static DeleteRepositoryResultRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRepositoryResultRepository.class);
  }

  /**
   * Convert an instance of DeleteRepositoryResultRepository to an JSON string
   *
   * @return JSON string
   */
