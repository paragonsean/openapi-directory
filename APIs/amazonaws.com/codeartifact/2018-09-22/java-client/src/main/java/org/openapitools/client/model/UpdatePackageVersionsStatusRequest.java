...
public class UpdatePackageVersionsStatusRequest {
  ...
  public UpdatePackageVersionsStatusRequest() {
  }

  public UpdatePackageVersionsStatusRequest versions(List<String> versions) {
    this.versions = versions;
    return this;
  }

  public UpdatePackageVersionsStatusRequest addVersionsItem(String versionsItem) {
  ...
  public UpdatePackageVersionsStatusRequest versionRevisions(Map<String, String> versionRevisions) {
    this.versionRevisions = versionRevisions;
    return this;
  }

  public UpdatePackageVersionsStatusRequest putVersionRevisionsItem(String key, String versionRevisionsItem) {
  ...
  public UpdatePackageVersionsStatusRequest expectedStatus(ExpectedStatusEnum expectedStatus) {
  ...
  public UpdatePackageVersionsStatusRequest targetStatus(TargetStatusEnum targetStatus) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePackageVersionsStatusRequest updatePackageVersionsStatusRequest = (UpdatePackageVersionsStatusRequest) o;
    return Objects.equals(this.versions, updatePackageVersionsStatusRequest.versions) &&
        Objects.equals(this.versionRevisions, updatePackageVersionsStatusRequest.versionRevisions) &&
        Objects.equals(this.expectedStatus, updatePackageVersionsStatusRequest.expectedStatus) &&
        Objects.equals(this.targetStatus, updatePackageVersionsStatusRequest.targetStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(versions, versionRevisions, expectedStatus, targetStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePackageVersionsStatusRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePackageVersionsStatusRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePackageVersionsStatusRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePackageVersionsStatusRequest is not found in the empty JSON string", UpdatePackageVersionsStatusRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePackageVersionsStatusRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePackageVersionsStatusRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePackageVersionsStatusRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePackageVersionsStatusRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePackageVersionsStatusRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePackageVersionsStatusRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePackageVersionsStatusRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePackageVersionsStatusRequest>() {
           @Override
           public void write(JsonWriter out, UpdatePackageVersionsStatusRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePackageVersionsStatusRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePackageVersionsStatusRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePackageVersionsStatusRequest
   * @throws IOException if the JSON string is invalid with respect to UpdatePackageVersionsStatusRequest
   */
  public static UpdatePackageVersionsStatusRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePackageVersionsStatusRequest.class);
  }

  /**
   * Convert an instance of UpdatePackageVersionsStatusRequest to an JSON string
   *
   * @return JSON string
   */
