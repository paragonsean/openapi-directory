...
import org.openapitools.client.model.PackageVersionOriginDomainEntryPoint;
import org.openapitools.client.model.PackageVersionOriginType;
...
public class PackageVersionDescriptionOrigin {
  public static final String SERIALIZED_NAME_DOMAIN_ENTRY_POINT = "domainEntryPoint";
  @SerializedName(SERIALIZED_NAME_DOMAIN_ENTRY_POINT)
  private PackageVersionOriginDomainEntryPoint domainEntryPoint;

  public static final String SERIALIZED_NAME_ORIGIN_TYPE = "originType";
  @SerializedName(SERIALIZED_NAME_ORIGIN_TYPE)
  private PackageVersionOriginType originType;

  public PackageVersionDescriptionOrigin() {
  }

  public PackageVersionDescriptionOrigin domainEntryPoint(PackageVersionOriginDomainEntryPoint domainEntryPoint) {
  ...
  public PackageVersionOriginDomainEntryPoint getDomainEntryPoint() {
    return domainEntryPoint;
  }

  public void setDomainEntryPoint(PackageVersionOriginDomainEntryPoint domainEntryPoint) {
    this.domainEntryPoint = domainEntryPoint;
  }


  public PackageVersionDescriptionOrigin originType(PackageVersionOriginType originType) {
   ...
   */
  @javax.annotation.Nullable
  public PackageVersionOriginType getOriginType() {
    return originType;
  }

  public void setOriginType(PackageVersionOriginType originType) {
    this.originType = originType;
  }
  ...
  public boolean equals(Object o) {
    ...
    PackageVersionDescriptionOrigin packageVersionDescriptionOrigin = (PackageVersionDescriptionOrigin) o;
    return Objects.equals(this.domainEntryPoint, packageVersionDescriptionOrigin.domainEntryPoint) &&
        Objects.equals(this.originType, packageVersionDescriptionOrigin.originType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainEntryPoint, originType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PackageVersionDescriptionOrigin {\n");
    sb.append("    domainEntryPoint: ").append(toIndentedString(domainEntryPoint)).append("\n");
  ...
  static {
    ...
    openapiFields.add("domainEntryPoint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageVersionDescriptionOrigin
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageVersionDescriptionOrigin.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageVersionDescriptionOrigin is not found in the empty JSON string", PackageVersionDescriptionOrigin.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageVersionDescriptionOrigin.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageVersionDescriptionOrigin` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `domainEntryPoint`
      if (jsonObj.get("domainEntryPoint") != null && !jsonObj.get("domainEntryPoint").isJsonNull()) {
        PackageVersionOriginDomainEntryPoint.validateJsonElement(jsonObj.get("domainEntryPoint"));
      }
      // validate the optional field `originType`
      if (jsonObj.get("originType") != null && !jsonObj.get("originType").isJsonNull()) {
        PackageVersionOriginType.validateJsonElement(jsonObj.get("originType"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageVersionDescriptionOrigin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageVersionDescriptionOrigin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageVersionDescriptionOrigin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageVersionDescriptionOrigin.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageVersionDescriptionOrigin>() {
           @Override
           public void write(JsonWriter out, PackageVersionDescriptionOrigin value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageVersionDescriptionOrigin read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageVersionDescriptionOrigin given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageVersionDescriptionOrigin
   * @throws IOException if the JSON string is invalid with respect to PackageVersionDescriptionOrigin
   */
  public static PackageVersionDescriptionOrigin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageVersionDescriptionOrigin.class);
  }

  /**
   * Convert an instance of PackageVersionDescriptionOrigin to an JSON string
   *
   * @return JSON string
   */
