...
import org.openapitools.client.model.DeleteDomainResultDomain;
...
public class DeleteDomainResult {
  ...
  private DeleteDomainResultDomain domain;

  public DeleteDomainResult() {
  }

  public DeleteDomainResult domain(DeleteDomainResultDomain domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DeleteDomainResultDomain getDomain() {
    return domain;
  }

  public void setDomain(DeleteDomainResultDomain domain) {
    this.domain = domain;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteDomainResult deleteDomainResult = (DeleteDomainResult) o;
    return Objects.equals(this.domain, deleteDomainResult.domain);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteDomainResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDomainResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDomainResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDomainResult is not found in the empty JSON string", DeleteDomainResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDomainResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDomainResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `domain`
      if (jsonObj.get("domain") != null && !jsonObj.get("domain").isJsonNull()) {
        DeleteDomainResultDomain.validateJsonElement(jsonObj.get("domain"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDomainResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDomainResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDomainResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDomainResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDomainResult>() {
           @Override
           public void write(JsonWriter out, DeleteDomainResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDomainResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDomainResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDomainResult
   * @throws IOException if the JSON string is invalid with respect to DeleteDomainResult
   */
  public static DeleteDomainResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDomainResult.class);
  }

  /**
   * Convert an instance of DeleteDomainResult to an JSON string
   *
   * @return JSON string
   */
