...
import org.openapitools.client.model.DeleteDomainPermissionsPolicyResultPolicy;
...
public class DeleteDomainPermissionsPolicyResult {
  ...
  private DeleteDomainPermissionsPolicyResultPolicy policy;

  public DeleteDomainPermissionsPolicyResult() {
  }

  public DeleteDomainPermissionsPolicyResult policy(DeleteDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public DeleteDomainPermissionsPolicyResultPolicy getPolicy() {
    return policy;
  }

  public void setPolicy(DeleteDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteDomainPermissionsPolicyResult deleteDomainPermissionsPolicyResult = (DeleteDomainPermissionsPolicyResult) o;
    return Objects.equals(this.policy, deleteDomainPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteDomainPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDomainPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDomainPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDomainPermissionsPolicyResult is not found in the empty JSON string", DeleteDomainPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDomainPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDomainPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `policy`
      if (jsonObj.get("policy") != null && !jsonObj.get("policy").isJsonNull()) {
        DeleteDomainPermissionsPolicyResultPolicy.validateJsonElement(jsonObj.get("policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDomainPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDomainPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDomainPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDomainPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDomainPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, DeleteDomainPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDomainPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDomainPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDomainPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to DeleteDomainPermissionsPolicyResult
   */
  public static DeleteDomainPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDomainPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of DeleteDomainPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
