...
public class UpdatePackageVersionsStatusResult {
  public static final String SERIALIZED_NAME_SUCCESSFUL_VERSIONS = "successfulVersions";
  @SerializedName(SERIALIZED_NAME_SUCCESSFUL_VERSIONS)
  private Map successfulVersions;

  public static final String SERIALIZED_NAME_FAILED_VERSIONS = "failedVersions";
  @SerializedName(SERIALIZED_NAME_FAILED_VERSIONS)
  private Map failedVersions;

  public UpdatePackageVersionsStatusResult() {
  }

  public UpdatePackageVersionsStatusResult successfulVersions(Map successfulVersions) {
    this.successfulVersions = successfulVersions;
    return this;
  }

  /**
   * Get successfulVersions
   * @return successfulVersions
   */
  @javax.annotation.Nullable
  public Map getSuccessfulVersions() {
    return successfulVersions;
  }

  public void setSuccessfulVersions(Map successfulVersions) {
    this.successfulVersions = successfulVersions;
  }


  public UpdatePackageVersionsStatusResult failedVersions(Map failedVersions) {
   ...
   */
  @javax.annotation.Nullable
  public Map getFailedVersions() {
    return failedVersions;
  }

  public void setFailedVersions(Map failedVersions) {
    this.failedVersions = failedVersions;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePackageVersionsStatusResult updatePackageVersionsStatusResult = (UpdatePackageVersionsStatusResult) o;
    return Objects.equals(this.successfulVersions, updatePackageVersionsStatusResult.successfulVersions) &&
        Objects.equals(this.failedVersions, updatePackageVersionsStatusResult.failedVersions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(successfulVersions, failedVersions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePackageVersionsStatusResult {\n");
    sb.append("    successfulVersions: ").append(toIndentedString(successfulVersions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("successfulVersions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePackageVersionsStatusResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePackageVersionsStatusResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePackageVersionsStatusResult is not found in the empty JSON string", UpdatePackageVersionsStatusResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePackageVersionsStatusResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePackageVersionsStatusResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `successfulVersions`
      if (jsonObj.get("successfulVersions") != null && !jsonObj.get("successfulVersions").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("successfulVersions"));
      }
      // validate the optional field `failedVersions`
      if (jsonObj.get("failedVersions") != null && !jsonObj.get("failedVersions").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("failedVersions"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePackageVersionsStatusResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePackageVersionsStatusResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePackageVersionsStatusResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePackageVersionsStatusResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePackageVersionsStatusResult>() {
           @Override
           public void write(JsonWriter out, UpdatePackageVersionsStatusResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePackageVersionsStatusResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePackageVersionsStatusResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePackageVersionsStatusResult
   * @throws IOException if the JSON string is invalid with respect to UpdatePackageVersionsStatusResult
   */
  public static UpdatePackageVersionsStatusResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePackageVersionsStatusResult.class);
  }

  /**
   * Convert an instance of UpdatePackageVersionsStatusResult to an JSON string
   *
   * @return JSON string
   */
