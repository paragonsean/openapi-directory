...
import org.openapitools.client.model.DeleteRepositoryResultRepository;
...
public class DeleteRepositoryResult {
  ...
  private DeleteRepositoryResultRepository repository;

  public DeleteRepositoryResult() {
  }

  public DeleteRepositoryResult repository(DeleteRepositoryResultRepository repository) {
  ...
  public DeleteRepositoryResultRepository getRepository() {
    return repository;
  }

  public void setRepository(DeleteRepositoryResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRepositoryResult deleteRepositoryResult = (DeleteRepositoryResult) o;
    return Objects.equals(this.repository, deleteRepositoryResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRepositoryResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRepositoryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRepositoryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRepositoryResult is not found in the empty JSON string", DeleteRepositoryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRepositoryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRepositoryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        DeleteRepositoryResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRepositoryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRepositoryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRepositoryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRepositoryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRepositoryResult>() {
           @Override
           public void write(JsonWriter out, DeleteRepositoryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRepositoryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRepositoryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRepositoryResult
   * @throws IOException if the JSON string is invalid with respect to DeleteRepositoryResult
   */
  public static DeleteRepositoryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRepositoryResult.class);
  }

  /**
   * Convert an instance of DeleteRepositoryResult to an JSON string
   *
   * @return JSON string
   */
