...
public class PutPackageOriginConfigurationResultOriginConfiguration {
  public static final String SERIALIZED_NAME_RESTRICTIONS = "restrictions";
  @SerializedName(SERIALIZED_NAME_RESTRICTIONS)
  private PackageOriginConfigurationRestrictions restrictions;

  public PutPackageOriginConfigurationResultOriginConfiguration() {
  }

  public PutPackageOriginConfigurationResultOriginConfiguration restrictions(PackageOriginConfigurationRestrictions restrictions) {
  ...
  public boolean equals(Object o) {
    ...
    PutPackageOriginConfigurationResultOriginConfiguration putPackageOriginConfigurationResultOriginConfiguration = (PutPackageOriginConfigurationResultOriginConfiguration) o;
    return Objects.equals(this.restrictions, putPackageOriginConfigurationResultOriginConfiguration.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutPackageOriginConfigurationResultOriginConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutPackageOriginConfigurationResultOriginConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutPackageOriginConfigurationResultOriginConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutPackageOriginConfigurationResultOriginConfiguration is not found in the empty JSON string", PutPackageOriginConfigurationResultOriginConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutPackageOriginConfigurationResultOriginConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutPackageOriginConfigurationResultOriginConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutPackageOriginConfigurationResultOriginConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutPackageOriginConfigurationResultOriginConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutPackageOriginConfigurationResultOriginConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutPackageOriginConfigurationResultOriginConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PutPackageOriginConfigurationResultOriginConfiguration>() {
           @Override
           public void write(JsonWriter out, PutPackageOriginConfigurationResultOriginConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutPackageOriginConfigurationResultOriginConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutPackageOriginConfigurationResultOriginConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutPackageOriginConfigurationResultOriginConfiguration
   * @throws IOException if the JSON string is invalid with respect to PutPackageOriginConfigurationResultOriginConfiguration
   */
  public static PutPackageOriginConfigurationResultOriginConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutPackageOriginConfigurationResultOriginConfiguration.class);
  }

  /**
   * Convert an instance of PutPackageOriginConfigurationResultOriginConfiguration to an JSON string
   *
   * @return JSON string
   */
