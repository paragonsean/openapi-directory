...
import org.openapitools.client.model.PutPackageOriginConfigurationResultOriginConfiguration;
...
public class PutPackageOriginConfigurationResult {
  ...
  private PutPackageOriginConfigurationResultOriginConfiguration originConfiguration;

  public PutPackageOriginConfigurationResult() {
  }

  public PutPackageOriginConfigurationResult originConfiguration(PutPackageOriginConfigurationResultOriginConfiguration originConfiguration) {
  ...
  public PutPackageOriginConfigurationResultOriginConfiguration getOriginConfiguration() {
    return originConfiguration;
  }

  public void setOriginConfiguration(PutPackageOriginConfigurationResultOriginConfiguration originConfiguration) {
    this.originConfiguration = originConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutPackageOriginConfigurationResult putPackageOriginConfigurationResult = (PutPackageOriginConfigurationResult) o;
    return Objects.equals(this.originConfiguration, putPackageOriginConfigurationResult.originConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(originConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutPackageOriginConfigurationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutPackageOriginConfigurationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutPackageOriginConfigurationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutPackageOriginConfigurationResult is not found in the empty JSON string", PutPackageOriginConfigurationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutPackageOriginConfigurationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutPackageOriginConfigurationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("originConfiguration") != null && !jsonObj.get("originConfiguration").isJsonNull()) {
        PutPackageOriginConfigurationResultOriginConfiguration.validateJsonElement(jsonObj.get("originConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutPackageOriginConfigurationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutPackageOriginConfigurationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutPackageOriginConfigurationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutPackageOriginConfigurationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PutPackageOriginConfigurationResult>() {
           @Override
           public void write(JsonWriter out, PutPackageOriginConfigurationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutPackageOriginConfigurationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutPackageOriginConfigurationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutPackageOriginConfigurationResult
   * @throws IOException if the JSON string is invalid with respect to PutPackageOriginConfigurationResult
   */
  public static PutPackageOriginConfigurationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutPackageOriginConfigurationResult.class);
  }

  /**
   * Convert an instance of PutPackageOriginConfigurationResult to an JSON string
   *
   * @return JSON string
   */
