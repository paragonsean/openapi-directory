...
import org.openapitools.client.model.DescribeRepositoryResultRepository;
...
public class DescribeRepositoryResult {
  ...
  private DescribeRepositoryResultRepository repository;

  public DescribeRepositoryResult() {
  }

  public DescribeRepositoryResult repository(DescribeRepositoryResultRepository repository) {
  ...
  public DescribeRepositoryResultRepository getRepository() {
    return repository;
  }

  public void setRepository(DescribeRepositoryResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeRepositoryResult describeRepositoryResult = (DescribeRepositoryResult) o;
    return Objects.equals(this.repository, describeRepositoryResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeRepositoryResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeRepositoryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeRepositoryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeRepositoryResult is not found in the empty JSON string", DescribeRepositoryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeRepositoryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeRepositoryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        DescribeRepositoryResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeRepositoryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeRepositoryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeRepositoryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeRepositoryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeRepositoryResult>() {
           @Override
           public void write(JsonWriter out, DescribeRepositoryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeRepositoryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeRepositoryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeRepositoryResult
   * @throws IOException if the JSON string is invalid with respect to DescribeRepositoryResult
   */
  public static DescribeRepositoryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeRepositoryResult.class);
  }

  /**
   * Convert an instance of DescribeRepositoryResult to an JSON string
   *
   * @return JSON string
   */
