...
public class PutPackageOriginConfigurationRequestRestrictions {
  ...
  public PutPackageOriginConfigurationRequestRestrictions() {
  }

  public PutPackageOriginConfigurationRequestRestrictions publish(AllowPublish publish) {
  ...
  public PutPackageOriginConfigurationRequestRestrictions upstream(AllowUpstream upstream) {
  ...
  public boolean equals(Object o) {
    ...
    PutPackageOriginConfigurationRequestRestrictions putPackageOriginConfigurationRequestRestrictions = (PutPackageOriginConfigurationRequestRestrictions) o;
    return Objects.equals(this.publish, putPackageOriginConfigurationRequestRestrictions.publish) &&
        Objects.equals(this.upstream, putPackageOriginConfigurationRequestRestrictions.upstream);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutPackageOriginConfigurationRequestRestrictions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutPackageOriginConfigurationRequestRestrictions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutPackageOriginConfigurationRequestRestrictions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutPackageOriginConfigurationRequestRestrictions is not found in the empty JSON string", PutPackageOriginConfigurationRequestRestrictions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutPackageOriginConfigurationRequestRestrictions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutPackageOriginConfigurationRequestRestrictions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutPackageOriginConfigurationRequestRestrictions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutPackageOriginConfigurationRequestRestrictions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutPackageOriginConfigurationRequestRestrictions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutPackageOriginConfigurationRequestRestrictions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutPackageOriginConfigurationRequestRestrictions.class));

       return (TypeAdapter<T>) new TypeAdapter<PutPackageOriginConfigurationRequestRestrictions>() {
           @Override
           public void write(JsonWriter out, PutPackageOriginConfigurationRequestRestrictions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutPackageOriginConfigurationRequestRestrictions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutPackageOriginConfigurationRequestRestrictions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutPackageOriginConfigurationRequestRestrictions
   * @throws IOException if the JSON string is invalid with respect to PutPackageOriginConfigurationRequestRestrictions
   */
  public static PutPackageOriginConfigurationRequestRestrictions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutPackageOriginConfigurationRequestRestrictions.class);
  }

  /**
   * Convert an instance of PutPackageOriginConfigurationRequestRestrictions to an JSON string
   *
   * @return JSON string
   */
