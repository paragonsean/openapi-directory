...
public class UpdateRepositoryResultRepository {
  ...
  public UpdateRepositoryResultRepository() {
  }

  public UpdateRepositoryResultRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateRepositoryResultRepository administratorAccount(String administratorAccount) {
  ...
  public UpdateRepositoryResultRepository domainName(String domainName) {
  ...
  public UpdateRepositoryResultRepository domainOwner(String domainOwner) {
  ...
  public UpdateRepositoryResultRepository arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateRepositoryResultRepository description(String description) {
  ...
  public UpdateRepositoryResultRepository upstreams(List upstreams) {
  ...
  public UpdateRepositoryResultRepository externalConnections(List externalConnections) {
  ...
  public UpdateRepositoryResultRepository createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRepositoryResultRepository updateRepositoryResultRepository = (UpdateRepositoryResultRepository) o;
    return Objects.equals(this.name, updateRepositoryResultRepository.name) &&
        Objects.equals(this.administratorAccount, updateRepositoryResultRepository.administratorAccount) &&
        Objects.equals(this.domainName, updateRepositoryResultRepository.domainName) &&
        Objects.equals(this.domainOwner, updateRepositoryResultRepository.domainOwner) &&
        Objects.equals(this.arn, updateRepositoryResultRepository.arn) &&
        Objects.equals(this.description, updateRepositoryResultRepository.description) &&
        Objects.equals(this.upstreams, updateRepositoryResultRepository.upstreams) &&
        Objects.equals(this.externalConnections, updateRepositoryResultRepository.externalConnections) &&
        Objects.equals(this.createdTime, updateRepositoryResultRepository.createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRepositoryResultRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRepositoryResultRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRepositoryResultRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRepositoryResultRepository is not found in the empty JSON string", UpdateRepositoryResultRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRepositoryResultRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRepositoryResultRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRepositoryResultRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRepositoryResultRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRepositoryResultRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRepositoryResultRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRepositoryResultRepository>() {
           @Override
           public void write(JsonWriter out, UpdateRepositoryResultRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRepositoryResultRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRepositoryResultRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRepositoryResultRepository
   * @throws IOException if the JSON string is invalid with respect to UpdateRepositoryResultRepository
   */
  public static UpdateRepositoryResultRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRepositoryResultRepository.class);
  }

  /**
   * Convert an instance of UpdateRepositoryResultRepository to an JSON string
   *
   * @return JSON string
   */
