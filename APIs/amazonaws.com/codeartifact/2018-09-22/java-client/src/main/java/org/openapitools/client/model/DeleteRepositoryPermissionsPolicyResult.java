...
import org.openapitools.client.model.DeleteRepositoryPermissionsPolicyResultPolicy;
...
public class DeleteRepositoryPermissionsPolicyResult {
  ...
  private DeleteRepositoryPermissionsPolicyResultPolicy policy;

  public DeleteRepositoryPermissionsPolicyResult() {
  }

  public DeleteRepositoryPermissionsPolicyResult policy(DeleteRepositoryPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public DeleteRepositoryPermissionsPolicyResultPolicy getPolicy() {
    return policy;
  }

  public void setPolicy(DeleteRepositoryPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRepositoryPermissionsPolicyResult deleteRepositoryPermissionsPolicyResult = (DeleteRepositoryPermissionsPolicyResult) o;
    return Objects.equals(this.policy, deleteRepositoryPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRepositoryPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRepositoryPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRepositoryPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRepositoryPermissionsPolicyResult is not found in the empty JSON string", DeleteRepositoryPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRepositoryPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRepositoryPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `policy`
      if (jsonObj.get("policy") != null && !jsonObj.get("policy").isJsonNull()) {
        DeleteRepositoryPermissionsPolicyResultPolicy.validateJsonElement(jsonObj.get("policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRepositoryPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRepositoryPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRepositoryPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRepositoryPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRepositoryPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, DeleteRepositoryPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRepositoryPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRepositoryPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRepositoryPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to DeleteRepositoryPermissionsPolicyResult
   */
  public static DeleteRepositoryPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRepositoryPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of DeleteRepositoryPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
