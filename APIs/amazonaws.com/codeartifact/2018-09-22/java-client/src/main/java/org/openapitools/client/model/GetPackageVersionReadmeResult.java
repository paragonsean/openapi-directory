...
public class GetPackageVersionReadmeResult {
  ...
  public GetPackageVersionReadmeResult format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public GetPackageVersionReadmeResult namespace(String namespace) {
  ...
  public GetPackageVersionReadmeResult _package(String _package) {
  ...
  public GetPackageVersionReadmeResult version(String version) {
  ...
  public GetPackageVersionReadmeResult versionRevision(String versionRevision) {
  ...
  public GetPackageVersionReadmeResult readme(String readme) {
    this.readme = readme;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPackageVersionReadmeResult getPackageVersionReadmeResult = (GetPackageVersionReadmeResult) o;
    return Objects.equals(this.format, getPackageVersionReadmeResult.format) &&
        Objects.equals(this.namespace, getPackageVersionReadmeResult.namespace) &&
        Objects.equals(this._package, getPackageVersionReadmeResult._package) &&
        Objects.equals(this.version, getPackageVersionReadmeResult.version) &&
        Objects.equals(this.versionRevision, getPackageVersionReadmeResult.versionRevision) &&
        Objects.equals(this.readme, getPackageVersionReadmeResult.readme);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, _package, version, versionRevision, readme);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPackageVersionReadmeResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPackageVersionReadmeResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPackageVersionReadmeResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPackageVersionReadmeResult is not found in the empty JSON string", GetPackageVersionReadmeResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPackageVersionReadmeResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPackageVersionReadmeResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("readme") != null && !jsonObj.get("readme").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("readme"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPackageVersionReadmeResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPackageVersionReadmeResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPackageVersionReadmeResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPackageVersionReadmeResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPackageVersionReadmeResult>() {
           @Override
           public void write(JsonWriter out, GetPackageVersionReadmeResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPackageVersionReadmeResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPackageVersionReadmeResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPackageVersionReadmeResult
   * @throws IOException if the JSON string is invalid with respect to GetPackageVersionReadmeResult
   */
  public static GetPackageVersionReadmeResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPackageVersionReadmeResult.class);
  }

  /**
   * Convert an instance of GetPackageVersionReadmeResult to an JSON string
   *
   * @return JSON string
   */
