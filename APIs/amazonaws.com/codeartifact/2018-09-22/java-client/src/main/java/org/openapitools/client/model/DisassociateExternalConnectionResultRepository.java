...
public class DisassociateExternalConnectionResultRepository {
  ...
  public DisassociateExternalConnectionResultRepository() {
  }

  public DisassociateExternalConnectionResultRepository name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DisassociateExternalConnectionResultRepository administratorAccount(String administratorAccount) {
  ...
  public DisassociateExternalConnectionResultRepository domainName(String domainName) {
  ...
  public DisassociateExternalConnectionResultRepository domainOwner(String domainOwner) {
  ...
  public DisassociateExternalConnectionResultRepository arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DisassociateExternalConnectionResultRepository description(String description) {
  ...
  public DisassociateExternalConnectionResultRepository upstreams(List upstreams) {
  ...
  public DisassociateExternalConnectionResultRepository externalConnections(List externalConnections) {
  ...
  public DisassociateExternalConnectionResultRepository createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    DisassociateExternalConnectionResultRepository disassociateExternalConnectionResultRepository = (DisassociateExternalConnectionResultRepository) o;
    return Objects.equals(this.name, disassociateExternalConnectionResultRepository.name) &&
        Objects.equals(this.administratorAccount, disassociateExternalConnectionResultRepository.administratorAccount) &&
        Objects.equals(this.domainName, disassociateExternalConnectionResultRepository.domainName) &&
        Objects.equals(this.domainOwner, disassociateExternalConnectionResultRepository.domainOwner) &&
        Objects.equals(this.arn, disassociateExternalConnectionResultRepository.arn) &&
        Objects.equals(this.description, disassociateExternalConnectionResultRepository.description) &&
        Objects.equals(this.upstreams, disassociateExternalConnectionResultRepository.upstreams) &&
        Objects.equals(this.externalConnections, disassociateExternalConnectionResultRepository.externalConnections) &&
        Objects.equals(this.createdTime, disassociateExternalConnectionResultRepository.createdTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisassociateExternalConnectionResultRepository {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisassociateExternalConnectionResultRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisassociateExternalConnectionResultRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisassociateExternalConnectionResultRepository is not found in the empty JSON string", DisassociateExternalConnectionResultRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisassociateExternalConnectionResultRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisassociateExternalConnectionResultRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisassociateExternalConnectionResultRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisassociateExternalConnectionResultRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisassociateExternalConnectionResultRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisassociateExternalConnectionResultRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<DisassociateExternalConnectionResultRepository>() {
           @Override
           public void write(JsonWriter out, DisassociateExternalConnectionResultRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisassociateExternalConnectionResultRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisassociateExternalConnectionResultRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisassociateExternalConnectionResultRepository
   * @throws IOException if the JSON string is invalid with respect to DisassociateExternalConnectionResultRepository
   */
  public static DisassociateExternalConnectionResultRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisassociateExternalConnectionResultRepository.class);
  }

  /**
   * Convert an instance of DisassociateExternalConnectionResultRepository to an JSON string
   *
   * @return JSON string
   */
