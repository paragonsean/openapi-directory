...
public class ListPackageVersionDependenciesResult {
  ...
  public static final String SERIALIZED_NAME_VERSION_REVISION = "versionRevision";
  @SerializedName(SERIALIZED_NAME_VERSION_REVISION)
  ...
  public ListPackageVersionDependenciesResult format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ListPackageVersionDependenciesResult namespace(String namespace) {
  ...
  public ListPackageVersionDependenciesResult _package(String _package) {
  ...
  public ListPackageVersionDependenciesResult version(String version) {
  ...
  public ListPackageVersionDependenciesResult versionRevision(String versionRevision) {
  ...
  public ListPackageVersionDependenciesResult nextToken(String nextToken) {
  ...
  public ListPackageVersionDependenciesResult dependencies(List dependencies) {
  ...
  public boolean equals(Object o) {
    ...
    ListPackageVersionDependenciesResult listPackageVersionDependenciesResult = (ListPackageVersionDependenciesResult) o;
    return Objects.equals(this.format, listPackageVersionDependenciesResult.format) &&
        Objects.equals(this.namespace, listPackageVersionDependenciesResult.namespace) &&
        Objects.equals(this._package, listPackageVersionDependenciesResult._package) &&
        Objects.equals(this.version, listPackageVersionDependenciesResult.version) &&
        Objects.equals(this.versionRevision, listPackageVersionDependenciesResult.versionRevision) &&
        Objects.equals(this.nextToken, listPackageVersionDependenciesResult.nextToken) &&
        Objects.equals(this.dependencies, listPackageVersionDependenciesResult.dependencies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, _package, version, versionRevision, nextToken, dependencies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPackageVersionDependenciesResult {\n");
  ...
  static {
    ...
    openapiFields.add("versionRevision");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPackageVersionDependenciesResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPackageVersionDependenciesResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPackageVersionDependenciesResult is not found in the empty JSON string", ListPackageVersionDependenciesResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPackageVersionDependenciesResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPackageVersionDependenciesResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("package") != null && !jsonObj.get("package").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("package"));
      }
      // validate the optional field `version`
      if (jsonObj.get("version") != null && !jsonObj.get("version").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("version"));
      }
      // validate the optional field `versionRevision`
      if (jsonObj.get("versionRevision") != null && !jsonObj.get("versionRevision").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("versionRevision"));
      }
      ...
      if (jsonObj.get("dependencies") != null && !jsonObj.get("dependencies").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("dependencies"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPackageVersionDependenciesResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPackageVersionDependenciesResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPackageVersionDependenciesResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPackageVersionDependenciesResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPackageVersionDependenciesResult>() {
           @Override
           public void write(JsonWriter out, ListPackageVersionDependenciesResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPackageVersionDependenciesResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPackageVersionDependenciesResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPackageVersionDependenciesResult
   * @throws IOException if the JSON string is invalid with respect to ListPackageVersionDependenciesResult
   */
  public static ListPackageVersionDependenciesResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPackageVersionDependenciesResult.class);
  }

  /**
   * Convert an instance of ListPackageVersionDependenciesResult to an JSON string
   *
   * @return JSON string
   */
