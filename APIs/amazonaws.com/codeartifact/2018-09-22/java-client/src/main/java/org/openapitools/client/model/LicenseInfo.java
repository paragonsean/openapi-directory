...
public class LicenseInfo {
  ...
  public LicenseInfo name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LicenseInfo url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, licenseInfo.name) &&
        Objects.equals(this.url, licenseInfo.url);
  }
