...
public class PackageDescription {
  ...
  public PackageDescription format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public PackageDescription namespace(String namespace) {
  ...
  public PackageDescription name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PackageDescription originConfiguration(PackageDescriptionOriginConfiguration originConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, packageDescription.format) &&
        Objects.equals(this.namespace, packageDescription.namespace) &&
        Objects.equals(this.name, packageDescription.name) &&
        Objects.equals(this.originConfiguration, packageDescription.originConfiguration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageDescription is not found in the empty JSON string", PackageDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageDescription>() {
           @Override
           public void write(JsonWriter out, PackageDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageDescription
   * @throws IOException if the JSON string is invalid with respect to PackageDescription
   */
  public static PackageDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageDescription.class);
  }

  /**
   * Convert an instance of PackageDescription to an JSON string
   *
   * @return JSON string
   */
