...
public class PutRepositoryPermissionsPolicyRequest {
  ...
  public PutRepositoryPermissionsPolicyRequest policyRevision(String policyRevision) {
  ...
  public PutRepositoryPermissionsPolicyRequest policyDocument(String policyDocument) {
  ...
  public boolean equals(Object o) {
    ...
    PutRepositoryPermissionsPolicyRequest putRepositoryPermissionsPolicyRequest = (PutRepositoryPermissionsPolicyRequest) o;
    return Objects.equals(this.policyRevision, putRepositoryPermissionsPolicyRequest.policyRevision) &&
        Objects.equals(this.policyDocument, putRepositoryPermissionsPolicyRequest.policyDocument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyRevision, policyDocument);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutRepositoryPermissionsPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutRepositoryPermissionsPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutRepositoryPermissionsPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutRepositoryPermissionsPolicyRequest is not found in the empty JSON string", PutRepositoryPermissionsPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutRepositoryPermissionsPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutRepositoryPermissionsPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutRepositoryPermissionsPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutRepositoryPermissionsPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutRepositoryPermissionsPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutRepositoryPermissionsPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutRepositoryPermissionsPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutRepositoryPermissionsPolicyRequest>() {
           @Override
           public void write(JsonWriter out, PutRepositoryPermissionsPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutRepositoryPermissionsPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutRepositoryPermissionsPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutRepositoryPermissionsPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to PutRepositoryPermissionsPolicyRequest
   */
  public static PutRepositoryPermissionsPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutRepositoryPermissionsPolicyRequest.class);
  }

  /**
   * Convert an instance of PutRepositoryPermissionsPolicyRequest to an JSON string
   *
   * @return JSON string
   */
