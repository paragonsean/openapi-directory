...
public class ListPackagesResult {
  ...
  public ListPackagesResult packages(List packages) {
  ...
  public ListPackagesResult nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListPackagesResult listPackagesResult = (ListPackagesResult) o;
    return Objects.equals(this.packages, listPackagesResult.packages) &&
        Objects.equals(this.nextToken, listPackagesResult.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(packages, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPackagesResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPackagesResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPackagesResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPackagesResult is not found in the empty JSON string", ListPackagesResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPackagesResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPackagesResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPackagesResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPackagesResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPackagesResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPackagesResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPackagesResult>() {
           @Override
           public void write(JsonWriter out, ListPackagesResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPackagesResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPackagesResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPackagesResult
   * @throws IOException if the JSON string is invalid with respect to ListPackagesResult
   */
  public static ListPackagesResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPackagesResult.class);
  }

  /**
   * Convert an instance of ListPackagesResult to an JSON string
   *
   * @return JSON string
   */
