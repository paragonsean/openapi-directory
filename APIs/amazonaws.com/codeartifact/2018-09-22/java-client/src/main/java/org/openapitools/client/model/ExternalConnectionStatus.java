...
/**
 * Gets or Sets ExternalConnectionStatus
 */
@JsonAdapter(ExternalConnectionStatus.Adapter.class)
public enum ExternalConnectionStatus {
  ...
  ExternalConnectionStatus(String value) {
    this.value = value;
  }
  ...
  public static ExternalConnectionStatus fromValue(String value) {
    for (ExternalConnectionStatus b : ExternalConnectionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExternalConnectionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExternalConnectionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExternalConnectionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExternalConnectionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExternalConnectionStatus.fromValue(value);
  }
}
