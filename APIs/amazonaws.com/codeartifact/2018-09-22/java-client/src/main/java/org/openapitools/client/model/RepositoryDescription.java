...
public class RepositoryDescription {
  ...
  public RepositoryDescription name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RepositoryDescription administratorAccount(String administratorAccount) {
  ...
  public RepositoryDescription domainName(String domainName) {
  ...
  public RepositoryDescription domainOwner(String domainOwner) {
  ...
  public RepositoryDescription arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public RepositoryDescription upstreams(List upstreams) {
  ...
  public RepositoryDescription externalConnections(List externalConnections) {
  ...
  public RepositoryDescription createdTime(OffsetDateTime createdTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, repositoryDescription.name) &&
        Objects.equals(this.administratorAccount, repositoryDescription.administratorAccount) &&
        Objects.equals(this.domainName, repositoryDescription.domainName) &&
        Objects.equals(this.domainOwner, repositoryDescription.domainOwner) &&
        Objects.equals(this.arn, repositoryDescription.arn) &&
        Objects.equals(this.description, repositoryDescription.description) &&
        Objects.equals(this.upstreams, repositoryDescription.upstreams) &&
        Objects.equals(this.externalConnections, repositoryDescription.externalConnections) &&
        Objects.equals(this.createdTime, repositoryDescription.createdTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RepositoryDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryDescription is not found in the empty JSON string", RepositoryDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RepositoryDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RepositoryDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryDescription>() {
           @Override
           public void write(JsonWriter out, RepositoryDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RepositoryDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RepositoryDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RepositoryDescription
   * @throws IOException if the JSON string is invalid with respect to RepositoryDescription
   */
  public static RepositoryDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryDescription.class);
  }

  /**
   * Convert an instance of RepositoryDescription to an JSON string
   *
   * @return JSON string
   */
