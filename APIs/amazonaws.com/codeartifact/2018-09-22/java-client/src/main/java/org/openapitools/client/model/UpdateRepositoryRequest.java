...
public class UpdateRepositoryRequest {
  ...
  private List<UpstreamRepository> upstreams = new ArrayList<>();
  ...
  public UpdateRepositoryRequest upstreams(List<UpstreamRepository> upstreams) {
    this.upstreams = upstreams;
    return this;
  }

  public UpdateRepositoryRequest addUpstreamsItem(UpstreamRepository upstreamsItem) {
  ...
  public void setUpstreams(List<UpstreamRepository> upstreams) {
    this.upstreams = upstreams;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, updateRepositoryRequest.description) &&
        Objects.equals(this.upstreams, updateRepositoryRequest.upstreams);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, upstreams);
  }
      ...
      if (jsonObj.get("upstreams") != null && !jsonObj.get("upstreams").isJsonNull()) {
        ...
        if (jsonArrayupstreams != null) {
          ...
          for (int i = 0; i < jsonArrayupstreams.size(); i++) {
            UpstreamRepository.validateJsonElement(jsonArrayupstreams.get(i));
          };
        }
      }
  }
