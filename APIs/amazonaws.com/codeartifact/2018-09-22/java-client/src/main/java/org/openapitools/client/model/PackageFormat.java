 ...
 */
@JsonAdapter(PackageFormat.Adapter.class)
public enum PackageFormat {
  ...
  public static PackageFormat fromValue(String value) {
    for (PackageFormat b : PackageFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<PackageFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final PackageFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PackageFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PackageFormat.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PackageFormat.fromValue(value);
  }
}
