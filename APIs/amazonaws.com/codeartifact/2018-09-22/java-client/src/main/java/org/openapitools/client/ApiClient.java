...
public class ApiClient {
    ...
    private String basePath = "http://codeartifact.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://codeartifact.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://codeartifact.{region}.amazonaws.com",
      "The CodeArtifact multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://codeartifact.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://codeartifact.{region}.amazonaws.com.cn",
      "The CodeArtifact endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-09-22/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://codeartifact.us-east-1.amazonaws.com
