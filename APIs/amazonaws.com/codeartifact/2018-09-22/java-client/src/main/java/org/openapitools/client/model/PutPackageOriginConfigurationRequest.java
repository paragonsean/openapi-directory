...
import org.openapitools.client.model.PutPackageOriginConfigurationRequestRestrictions;
...
public class PutPackageOriginConfigurationRequest {
  ...
  private PutPackageOriginConfigurationRequestRestrictions restrictions;

  public PutPackageOriginConfigurationRequest() {
  }

  public PutPackageOriginConfigurationRequest restrictions(PutPackageOriginConfigurationRequestRestrictions restrictions) {
  ...
  public PutPackageOriginConfigurationRequestRestrictions getRestrictions() {
    return restrictions;
  }

  public void setRestrictions(PutPackageOriginConfigurationRequestRestrictions restrictions) {
    this.restrictions = restrictions;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutPackageOriginConfigurationRequest putPackageOriginConfigurationRequest = (PutPackageOriginConfigurationRequest) o;
    return Objects.equals(this.restrictions, putPackageOriginConfigurationRequest.restrictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutPackageOriginConfigurationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutPackageOriginConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutPackageOriginConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutPackageOriginConfigurationRequest is not found in the empty JSON string", PutPackageOriginConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutPackageOriginConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutPackageOriginConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutPackageOriginConfigurationRequest.openapiRequiredFields) {
      ...
      PutPackageOriginConfigurationRequestRestrictions.validateJsonElement(jsonObj.get("restrictions"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutPackageOriginConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutPackageOriginConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutPackageOriginConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutPackageOriginConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutPackageOriginConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, PutPackageOriginConfigurationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutPackageOriginConfigurationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutPackageOriginConfigurationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutPackageOriginConfigurationRequest
   * @throws IOException if the JSON string is invalid with respect to PutPackageOriginConfigurationRequest
   */
  public static PutPackageOriginConfigurationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutPackageOriginConfigurationRequest.class);
  }

  /**
   * Convert an instance of PutPackageOriginConfigurationRequest to an JSON string
   *
   * @return JSON string
   */
