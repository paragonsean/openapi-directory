...
public class ListPackageVersionAssetsResult {
  ...
  public ListPackageVersionAssetsResult() {
  }

  public ListPackageVersionAssetsResult format(PackageFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ListPackageVersionAssetsResult namespace(String namespace) {
  ...
  public ListPackageVersionAssetsResult _package(String _package) {
  ...
  public ListPackageVersionAssetsResult version(String version) {
  ...
  public ListPackageVersionAssetsResult versionRevision(String versionRevision) {
  ...
  public ListPackageVersionAssetsResult nextToken(String nextToken) {
  ...
  public ListPackageVersionAssetsResult assets(List assets) {
    this.assets = assets;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListPackageVersionAssetsResult listPackageVersionAssetsResult = (ListPackageVersionAssetsResult) o;
    return Objects.equals(this.format, listPackageVersionAssetsResult.format) &&
        Objects.equals(this.namespace, listPackageVersionAssetsResult.namespace) &&
        Objects.equals(this._package, listPackageVersionAssetsResult._package) &&
        Objects.equals(this.version, listPackageVersionAssetsResult.version) &&
        Objects.equals(this.versionRevision, listPackageVersionAssetsResult.versionRevision) &&
        Objects.equals(this.nextToken, listPackageVersionAssetsResult.nextToken) &&
        Objects.equals(this.assets, listPackageVersionAssetsResult.assets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, namespace, _package, version, versionRevision, nextToken, assets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPackageVersionAssetsResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPackageVersionAssetsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPackageVersionAssetsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPackageVersionAssetsResult is not found in the empty JSON string", ListPackageVersionAssetsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPackageVersionAssetsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPackageVersionAssetsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPackageVersionAssetsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPackageVersionAssetsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPackageVersionAssetsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPackageVersionAssetsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPackageVersionAssetsResult>() {
           @Override
           public void write(JsonWriter out, ListPackageVersionAssetsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPackageVersionAssetsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPackageVersionAssetsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPackageVersionAssetsResult
   * @throws IOException if the JSON string is invalid with respect to ListPackageVersionAssetsResult
   */
  public static ListPackageVersionAssetsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPackageVersionAssetsResult.class);
  }

  /**
   * Convert an instance of ListPackageVersionAssetsResult to an JSON string
   *
   * @return JSON string
   */
