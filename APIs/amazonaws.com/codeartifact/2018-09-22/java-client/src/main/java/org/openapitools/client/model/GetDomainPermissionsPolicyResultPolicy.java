...
public class GetDomainPermissionsPolicyResultPolicy {
  ...
  public GetDomainPermissionsPolicyResultPolicy() {
  }

  public GetDomainPermissionsPolicyResultPolicy resourceArn(String resourceArn) {
  ...
  public GetDomainPermissionsPolicyResultPolicy revision(String revision) {
  ...
  public GetDomainPermissionsPolicyResultPolicy document(String document) {
  ...
  public boolean equals(Object o) {
    ...
    GetDomainPermissionsPolicyResultPolicy getDomainPermissionsPolicyResultPolicy = (GetDomainPermissionsPolicyResultPolicy) o;
    return Objects.equals(this.resourceArn, getDomainPermissionsPolicyResultPolicy.resourceArn) &&
        Objects.equals(this.revision, getDomainPermissionsPolicyResultPolicy.revision) &&
        Objects.equals(this.document, getDomainPermissionsPolicyResultPolicy.document);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetDomainPermissionsPolicyResultPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainPermissionsPolicyResultPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainPermissionsPolicyResultPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDomainPermissionsPolicyResultPolicy is not found in the empty JSON string", GetDomainPermissionsPolicyResultPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainPermissionsPolicyResultPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDomainPermissionsPolicyResultPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainPermissionsPolicyResultPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainPermissionsPolicyResultPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainPermissionsPolicyResultPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainPermissionsPolicyResultPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainPermissionsPolicyResultPolicy>() {
           @Override
           public void write(JsonWriter out, GetDomainPermissionsPolicyResultPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainPermissionsPolicyResultPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainPermissionsPolicyResultPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainPermissionsPolicyResultPolicy
   * @throws IOException if the JSON string is invalid with respect to GetDomainPermissionsPolicyResultPolicy
   */
  public static GetDomainPermissionsPolicyResultPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainPermissionsPolicyResultPolicy.class);
  }

  /**
   * Convert an instance of GetDomainPermissionsPolicyResultPolicy to an JSON string
   *
   * @return JSON string
   */
