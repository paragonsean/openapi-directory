...
import org.openapitools.client.model.CreateRepositoryResultRepository;
...
public class CreateRepositoryResult {
  ...
  private CreateRepositoryResultRepository repository;

  public CreateRepositoryResult() {
  }

  public CreateRepositoryResult repository(CreateRepositoryResultRepository repository) {
  ...
  public CreateRepositoryResultRepository getRepository() {
    return repository;
  }

  public void setRepository(CreateRepositoryResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateRepositoryResult createRepositoryResult = (CreateRepositoryResult) o;
    return Objects.equals(this.repository, createRepositoryResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRepositoryResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRepositoryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRepositoryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRepositoryResult is not found in the empty JSON string", CreateRepositoryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRepositoryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRepositoryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        CreateRepositoryResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRepositoryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRepositoryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRepositoryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRepositoryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRepositoryResult>() {
           @Override
           public void write(JsonWriter out, CreateRepositoryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRepositoryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRepositoryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRepositoryResult
   * @throws IOException if the JSON string is invalid with respect to CreateRepositoryResult
   */
  public static CreateRepositoryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRepositoryResult.class);
  }

  /**
   * Convert an instance of CreateRepositoryResult to an JSON string
   *
   * @return JSON string
   */
