...
public class CreateDomainResultDomain {
  ...
  public CreateDomainResultDomain() {
  }

  public CreateDomainResultDomain name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateDomainResultDomain owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public CreateDomainResultDomain arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateDomainResultDomain status(DomainStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CreateDomainResultDomain createdTime(OffsetDateTime createdTime) {
  ...
  public CreateDomainResultDomain encryptionKey(String encryptionKey) {
  ...
  public CreateDomainResultDomain repositoryCount(Integer repositoryCount) {
  ...
  public CreateDomainResultDomain assetSizeBytes(Integer assetSizeBytes) {
  ...
  public CreateDomainResultDomain s3BucketArn(String s3BucketArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainResultDomain createDomainResultDomain = (CreateDomainResultDomain) o;
    return Objects.equals(this.name, createDomainResultDomain.name) &&
        Objects.equals(this.owner, createDomainResultDomain.owner) &&
        Objects.equals(this.arn, createDomainResultDomain.arn) &&
        Objects.equals(this.status, createDomainResultDomain.status) &&
        Objects.equals(this.createdTime, createDomainResultDomain.createdTime) &&
        Objects.equals(this.encryptionKey, createDomainResultDomain.encryptionKey) &&
        Objects.equals(this.repositoryCount, createDomainResultDomain.repositoryCount) &&
        Objects.equals(this.assetSizeBytes, createDomainResultDomain.assetSizeBytes) &&
        Objects.equals(this.s3BucketArn, createDomainResultDomain.s3BucketArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDomainResultDomain {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainResultDomain
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainResultDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainResultDomain is not found in the empty JSON string", CreateDomainResultDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainResultDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainResultDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainResultDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainResultDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainResultDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainResultDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainResultDomain>() {
           @Override
           public void write(JsonWriter out, CreateDomainResultDomain value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainResultDomain read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainResultDomain given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainResultDomain
   * @throws IOException if the JSON string is invalid with respect to CreateDomainResultDomain
   */
  public static CreateDomainResultDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainResultDomain.class);
  }

  /**
   * Convert an instance of CreateDomainResultDomain to an JSON string
   *
   * @return JSON string
   */
