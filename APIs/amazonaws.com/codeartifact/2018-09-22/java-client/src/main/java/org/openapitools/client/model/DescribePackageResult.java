...
import org.openapitools.client.model.DescribePackageResultPackage;
...
public class DescribePackageResult {
  ...
  private DescribePackageResultPackage _package;

  public DescribePackageResult() {
  }

  public DescribePackageResult _package(DescribePackageResultPackage _package) {
  ...
  public DescribePackageResultPackage getPackage() {
    return _package;
  }

  public void setPackage(DescribePackageResultPackage _package) {
    this._package = _package;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribePackageResult describePackageResult = (DescribePackageResult) o;
    return Objects.equals(this._package, describePackageResult._package);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePackageResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePackageResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePackageResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePackageResult is not found in the empty JSON string", DescribePackageResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePackageResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePackageResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribePackageResult.openapiRequiredFields) {
      ...
      DescribePackageResultPackage.validateJsonElement(jsonObj.get("package"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePackageResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePackageResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePackageResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePackageResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePackageResult>() {
           @Override
           public void write(JsonWriter out, DescribePackageResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePackageResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePackageResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePackageResult
   * @throws IOException if the JSON string is invalid with respect to DescribePackageResult
   */
  public static DescribePackageResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePackageResult.class);
  }

  /**
   * Convert an instance of DescribePackageResult to an JSON string
   *
   * @return JSON string
   */
