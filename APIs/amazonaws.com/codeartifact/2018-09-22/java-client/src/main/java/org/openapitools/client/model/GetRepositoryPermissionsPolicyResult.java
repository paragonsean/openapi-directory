...
import org.openapitools.client.model.GetDomainPermissionsPolicyResultPolicy;
...
public class GetRepositoryPermissionsPolicyResult {
  ...
  private GetDomainPermissionsPolicyResultPolicy policy;

  public GetRepositoryPermissionsPolicyResult() {
  }

  public GetRepositoryPermissionsPolicyResult policy(GetDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public GetDomainPermissionsPolicyResultPolicy getPolicy() {
    return policy;
  }

  public void setPolicy(GetDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRepositoryPermissionsPolicyResult getRepositoryPermissionsPolicyResult = (GetRepositoryPermissionsPolicyResult) o;
    return Objects.equals(this.policy, getRepositoryPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRepositoryPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRepositoryPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRepositoryPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRepositoryPermissionsPolicyResult is not found in the empty JSON string", GetRepositoryPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRepositoryPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRepositoryPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `policy`
      if (jsonObj.get("policy") != null && !jsonObj.get("policy").isJsonNull()) {
        GetDomainPermissionsPolicyResultPolicy.validateJsonElement(jsonObj.get("policy"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRepositoryPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRepositoryPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRepositoryPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRepositoryPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRepositoryPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, GetRepositoryPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRepositoryPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRepositoryPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRepositoryPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to GetRepositoryPermissionsPolicyResult
   */
  public static GetRepositoryPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRepositoryPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of GetRepositoryPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
