...
import org.openapitools.client.model.DescribePackageVersionResultPackageVersion;
...
public class DescribePackageVersionResult {
  ...
  private DescribePackageVersionResultPackageVersion packageVersion;

  public DescribePackageVersionResult() {
  }

  public DescribePackageVersionResult packageVersion(DescribePackageVersionResultPackageVersion packageVersion) {
  ...
  public DescribePackageVersionResultPackageVersion getPackageVersion() {
    return packageVersion;
  }

  public void setPackageVersion(DescribePackageVersionResultPackageVersion packageVersion) {
    this.packageVersion = packageVersion;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribePackageVersionResult describePackageVersionResult = (DescribePackageVersionResult) o;
    return Objects.equals(this.packageVersion, describePackageVersionResult.packageVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribePackageVersionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribePackageVersionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribePackageVersionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribePackageVersionResult is not found in the empty JSON string", DescribePackageVersionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribePackageVersionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribePackageVersionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribePackageVersionResult.openapiRequiredFields) {
      ...
      DescribePackageVersionResultPackageVersion.validateJsonElement(jsonObj.get("packageVersion"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribePackageVersionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribePackageVersionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribePackageVersionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribePackageVersionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribePackageVersionResult>() {
           @Override
           public void write(JsonWriter out, DescribePackageVersionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribePackageVersionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribePackageVersionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribePackageVersionResult
   * @throws IOException if the JSON string is invalid with respect to DescribePackageVersionResult
   */
  public static DescribePackageVersionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribePackageVersionResult.class);
  }

  /**
   * Convert an instance of DescribePackageVersionResult to an JSON string
   *
   * @return JSON string
   */
