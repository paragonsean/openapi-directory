...
import org.openapitools.client.model.UpdateRepositoryResultRepository;
...
public class UpdateRepositoryResult {
  ...
  private UpdateRepositoryResultRepository repository;

  public UpdateRepositoryResult() {
  }

  public UpdateRepositoryResult repository(UpdateRepositoryResultRepository repository) {
  ...
  public UpdateRepositoryResultRepository getRepository() {
    return repository;
  }

  public void setRepository(UpdateRepositoryResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateRepositoryResult updateRepositoryResult = (UpdateRepositoryResult) o;
    return Objects.equals(this.repository, updateRepositoryResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRepositoryResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRepositoryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRepositoryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRepositoryResult is not found in the empty JSON string", UpdateRepositoryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRepositoryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRepositoryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        UpdateRepositoryResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRepositoryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRepositoryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRepositoryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRepositoryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRepositoryResult>() {
           @Override
           public void write(JsonWriter out, UpdateRepositoryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRepositoryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRepositoryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRepositoryResult
   * @throws IOException if the JSON string is invalid with respect to UpdateRepositoryResult
   */
  public static UpdateRepositoryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRepositoryResult.class);
  }

  /**
   * Convert an instance of UpdateRepositoryResult to an JSON string
   *
   * @return JSON string
   */
