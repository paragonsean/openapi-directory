...
import org.openapitools.client.model.AssociateExternalConnectionResultRepository;
...
public class AssociateExternalConnectionResult {
  ...
  private AssociateExternalConnectionResultRepository repository;

  public AssociateExternalConnectionResult() {
  }

  public AssociateExternalConnectionResult repository(AssociateExternalConnectionResultRepository repository) {
  ...
  public AssociateExternalConnectionResultRepository getRepository() {
    return repository;
  }

  public void setRepository(AssociateExternalConnectionResultRepository repository) {
    this.repository = repository;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssociateExternalConnectionResult associateExternalConnectionResult = (AssociateExternalConnectionResult) o;
    return Objects.equals(this.repository, associateExternalConnectionResult.repository);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssociateExternalConnectionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateExternalConnectionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateExternalConnectionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociateExternalConnectionResult is not found in the empty JSON string", AssociateExternalConnectionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssociateExternalConnectionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssociateExternalConnectionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `repository`
      if (jsonObj.get("repository") != null && !jsonObj.get("repository").isJsonNull()) {
        AssociateExternalConnectionResultRepository.validateJsonElement(jsonObj.get("repository"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociateExternalConnectionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociateExternalConnectionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociateExternalConnectionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociateExternalConnectionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociateExternalConnectionResult>() {
           @Override
           public void write(JsonWriter out, AssociateExternalConnectionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssociateExternalConnectionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssociateExternalConnectionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssociateExternalConnectionResult
   * @throws IOException if the JSON string is invalid with respect to AssociateExternalConnectionResult
   */
  public static AssociateExternalConnectionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociateExternalConnectionResult.class);
  }

  /**
   * Convert an instance of AssociateExternalConnectionResult to an JSON string
   *
   * @return JSON string
   */
