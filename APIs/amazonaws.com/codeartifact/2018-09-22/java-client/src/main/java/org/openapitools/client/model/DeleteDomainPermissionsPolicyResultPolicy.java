...
public class DeleteDomainPermissionsPolicyResultPolicy {
  ...
  public DeleteDomainPermissionsPolicyResultPolicy() {
  }

  public DeleteDomainPermissionsPolicyResultPolicy resourceArn(String resourceArn) {
  ...
  public DeleteDomainPermissionsPolicyResultPolicy revision(String revision) {
  ...
  public DeleteDomainPermissionsPolicyResultPolicy document(String document) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteDomainPermissionsPolicyResultPolicy deleteDomainPermissionsPolicyResultPolicy = (DeleteDomainPermissionsPolicyResultPolicy) o;
    return Objects.equals(this.resourceArn, deleteDomainPermissionsPolicyResultPolicy.resourceArn) &&
        Objects.equals(this.revision, deleteDomainPermissionsPolicyResultPolicy.revision) &&
        Objects.equals(this.document, deleteDomainPermissionsPolicyResultPolicy.document);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceArn, revision, document);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteDomainPermissionsPolicyResultPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDomainPermissionsPolicyResultPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDomainPermissionsPolicyResultPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDomainPermissionsPolicyResultPolicy is not found in the empty JSON string", DeleteDomainPermissionsPolicyResultPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDomainPermissionsPolicyResultPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDomainPermissionsPolicyResultPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDomainPermissionsPolicyResultPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDomainPermissionsPolicyResultPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDomainPermissionsPolicyResultPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDomainPermissionsPolicyResultPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDomainPermissionsPolicyResultPolicy>() {
           @Override
           public void write(JsonWriter out, DeleteDomainPermissionsPolicyResultPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDomainPermissionsPolicyResultPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDomainPermissionsPolicyResultPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDomainPermissionsPolicyResultPolicy
   * @throws IOException if the JSON string is invalid with respect to DeleteDomainPermissionsPolicyResultPolicy
   */
  public static DeleteDomainPermissionsPolicyResultPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDomainPermissionsPolicyResultPolicy.class);
  }

  /**
   * Convert an instance of DeleteDomainPermissionsPolicyResultPolicy to an JSON string
   *
   * @return JSON string
   */
