...
public class PutDomainPermissionsPolicyResult {
  ...
  public PutDomainPermissionsPolicyResult() {
  }

  public PutDomainPermissionsPolicyResult policy(PutDomainPermissionsPolicyResultPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutDomainPermissionsPolicyResult putDomainPermissionsPolicyResult = (PutDomainPermissionsPolicyResult) o;
    return Objects.equals(this.policy, putDomainPermissionsPolicyResult.policy);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutDomainPermissionsPolicyResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutDomainPermissionsPolicyResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutDomainPermissionsPolicyResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutDomainPermissionsPolicyResult is not found in the empty JSON string", PutDomainPermissionsPolicyResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutDomainPermissionsPolicyResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutDomainPermissionsPolicyResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutDomainPermissionsPolicyResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutDomainPermissionsPolicyResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutDomainPermissionsPolicyResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutDomainPermissionsPolicyResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PutDomainPermissionsPolicyResult>() {
           @Override
           public void write(JsonWriter out, PutDomainPermissionsPolicyResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutDomainPermissionsPolicyResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutDomainPermissionsPolicyResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutDomainPermissionsPolicyResult
   * @throws IOException if the JSON string is invalid with respect to PutDomainPermissionsPolicyResult
   */
  public static PutDomainPermissionsPolicyResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutDomainPermissionsPolicyResult.class);
  }

  /**
   * Convert an instance of PutDomainPermissionsPolicyResult to an JSON string
   *
   * @return JSON string
   */
