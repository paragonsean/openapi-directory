...
class ListDomainsRequest(Model):
    ...
    def __init__(self, max_results: int=None, next_token: str=None):
        ...
        :param max_results: The max_results of this ListDomainsRequest.
    ...
    def from_dict(cls, dikt: dict) -> 'ListDomainsRequest':
        ...
        :param dikt: A dict.
        :return: The ListDomains_request of this ListDomainsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_results(self):
        """Gets the max_results of this ListDomainsRequest.

         The maximum number of results to return per page. 

        :return: The max_results of this ListDomainsRequest.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this ListDomainsRequest.
