...
/**
 * The PackageOriginConfiguration model module.
 * @module model/PackageOriginConfiguration
 * @version 2018-09-22
 */
class PackageOriginConfiguration {
    /**
     * Constructs a new <code>PackageOriginConfiguration</code>.
     * Details about the package origin configuration of a package.
     * @alias module:model/PackageOriginConfiguration
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PackageOriginConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageOriginConfiguration} obj Optional instance to populate.
     * @return {module:model/PackageOriginConfiguration} The populated <code>PackageOriginConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageOriginConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageOriginConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageOriginConfiguration</code>.
     */
...
export default PackageOriginConfiguration;
