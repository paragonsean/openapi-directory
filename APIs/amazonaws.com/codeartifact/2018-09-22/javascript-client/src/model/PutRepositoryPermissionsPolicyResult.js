...
import PutDomainPermissionsPolicyResultPolicy from './PutDomainPermissionsPolicyResultPolicy';

/**
 * The PutRepositoryPermissionsPolicyResult model module.
 * @module model/PutRepositoryPermissionsPolicyResult
 * @version 2018-09-22
 */
class PutRepositoryPermissionsPolicyResult {
    /**
     * Constructs a new <code>PutRepositoryPermissionsPolicyResult</code>.
     * @alias module:model/PutRepositoryPermissionsPolicyResult
     */
    constructor() { 
        
        PutRepositoryPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutRepositoryPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutRepositoryPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/PutRepositoryPermissionsPolicyResult} The populated <code>PutRepositoryPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutRepositoryPermissionsPolicyResult();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = PutDomainPermissionsPolicyResultPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutRepositoryPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutRepositoryPermissionsPolicyResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          PutDomainPermissionsPolicyResultPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/PutDomainPermissionsPolicyResultPolicy} policy
 */
PutRepositoryPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default PutRepositoryPermissionsPolicyResult;
