...
import PackageSummaryOriginConfiguration from './PackageSummaryOriginConfiguration';

/**
 * The PackageSummary model module.
 * @module model/PackageSummary
 * @version 2018-09-22
 */
class PackageSummary {
    /**
     * Constructs a new <code>PackageSummary</code>.
     *  Details about a package, including its format, namespace, and name. 
     * @alias module:model/PackageSummary
     */
    constructor() { 
        
        PackageSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageSummary} obj Optional instance to populate.
     * @return {module:model/PackageSummary} The populated <code>PackageSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageSummary();
            ...
            if (data.hasOwnProperty('originConfiguration')) {
                obj['originConfiguration'] = PackageSummaryOriginConfiguration.constructFromObject(data['originConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PackageSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageSummary</code>.
     */
    static validateJSON(data) {
        ...
        if (data['originConfiguration']) { // data not null
          PackageSummaryOriginConfiguration.validateJSON(data['originConfiguration']);
        }
 ...
 */
PackageSummary.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
PackageSummary.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
PackageSummary.prototype['package'] = undefined;

/**
 * @member {module:model/PackageSummaryOriginConfiguration} originConfiguration
 */
PackageSummary.prototype['originConfiguration'] = undefined;
