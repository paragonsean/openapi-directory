...
/**
 * The CreateRepositoryResultRepository model module.
 * @module model/CreateRepositoryResultRepository
 * @version 2018-09-22
 */
class CreateRepositoryResultRepository {
    /**
     * Constructs a new <code>CreateRepositoryResultRepository</code>.
     * @alias module:model/CreateRepositoryResultRepository
     * @implements module:model/RepositoryDescription
     */
    constructor() { 
        RepositoryDescription.initialize(this);
        CreateRepositoryResultRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRepositoryResultRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRepositoryResultRepository} obj Optional instance to populate.
     * @return {module:model/CreateRepositoryResultRepository} The populated <code>CreateRepositoryResultRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRepositoryResultRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRepositoryResultRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRepositoryResultRepository</code>.
     */
 ...
 * @member {String} name
 */
CreateRepositoryResultRepository.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
CreateRepositoryResultRepository.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
CreateRepositoryResultRepository.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
CreateRepositoryResultRepository.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
CreateRepositoryResultRepository.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
CreateRepositoryResultRepository.prototype['description'] = undefined;

/**
 * @member {Array} upstreams
 */
CreateRepositoryResultRepository.prototype['upstreams'] = undefined;

/**
 * @member {Array} externalConnections
 */
CreateRepositoryResultRepository.prototype['externalConnections'] = undefined;

/**
 * @member {Date} createdTime
 */
CreateRepositoryResultRepository.prototype['createdTime'] = undefined;
...
export default CreateRepositoryResultRepository;
