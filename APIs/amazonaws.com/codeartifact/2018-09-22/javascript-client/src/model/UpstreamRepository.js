...
/**
 * The UpstreamRepository model module.
 * @module model/UpstreamRepository
 * @version 2018-09-22
 */
class UpstreamRepository {
    /**
     * Constructs a new <code>UpstreamRepository</code>.
     ...
     * @alias module:model/UpstreamRepository
     * @param repositoryName {String} 
     */
    constructor(repositoryName) { 
        
        UpstreamRepository.initialize(this, repositoryName);
    }
    ...
    /**
     * Constructs a <code>UpstreamRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpstreamRepository} obj Optional instance to populate.
     * @return {module:model/UpstreamRepository} The populated <code>UpstreamRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpstreamRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>UpstreamRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpstreamRepository</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpstreamRepository.RequiredProperties) {
...
UpstreamRepository.RequiredProperties = ["repositoryName"];

/**
 * @member {String} repositoryName
 */
UpstreamRepository.prototype['repositoryName'] = undefined;
...
export default UpstreamRepository;
