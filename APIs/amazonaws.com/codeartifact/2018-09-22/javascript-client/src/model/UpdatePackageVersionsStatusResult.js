...
/**
 * The UpdatePackageVersionsStatusResult model module.
 * @module model/UpdatePackageVersionsStatusResult
 * @version 2018-09-22
 */
class UpdatePackageVersionsStatusResult {
    /**
     * Constructs a new <code>UpdatePackageVersionsStatusResult</code>.
     * @alias module:model/UpdatePackageVersionsStatusResult
     */
    constructor() { 
        
        UpdatePackageVersionsStatusResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePackageVersionsStatusResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePackageVersionsStatusResult} obj Optional instance to populate.
     * @return {module:model/UpdatePackageVersionsStatusResult} The populated <code>UpdatePackageVersionsStatusResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePackageVersionsStatusResult();

            if (data.hasOwnProperty('successfulVersions')) {
                obj['successfulVersions'] = ApiClient.convertToType(data['successfulVersions'], Object);
            }
            if (data.hasOwnProperty('failedVersions')) {
                obj['failedVersions'] = ApiClient.convertToType(data['failedVersions'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePackageVersionsStatusResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePackageVersionsStatusResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `successfulVersions`
        if (data['successfulVersions']) { // data not null
          Object.validateJSON(data['successfulVersions']);
        }
        // validate the optional field `failedVersions`
        if (data['failedVersions']) { // data not null
          Object.validateJSON(data['failedVersions']);
        }
...
/**
 * @member {Object} successfulVersions
 */
UpdatePackageVersionsStatusResult.prototype['successfulVersions'] = undefined;

/**
 * @member {Object} failedVersions
 */
UpdatePackageVersionsStatusResult.prototype['failedVersions'] = undefined;
...
export default UpdatePackageVersionsStatusResult;
