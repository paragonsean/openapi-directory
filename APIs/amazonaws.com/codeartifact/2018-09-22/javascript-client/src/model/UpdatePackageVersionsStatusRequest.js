...
/**
 * The UpdatePackageVersionsStatusRequest model module.
 * @module model/UpdatePackageVersionsStatusRequest
 * @version 2018-09-22
 */
class UpdatePackageVersionsStatusRequest {
    /**
     * Constructs a new <code>UpdatePackageVersionsStatusRequest</code>.
     * @alias module:model/UpdatePackageVersionsStatusRequest
     * @param versions {Array.<String>}  An array of strings that specify the versions of the package with the statuses to update. 
     * @param targetStatus {module:model/UpdatePackageVersionsStatusRequest.TargetStatusEnum}  The status you want to change the package version status to. 
     */
    constructor(versions, targetStatus) { 
        
        UpdatePackageVersionsStatusRequest.initialize(this, versions, targetStatus);
    }
     ...
     */
    static initialize(obj, versions, targetStatus) { 
        obj['versions'] = versions;
        obj['targetStatus'] = targetStatus;
    }

    /**
     * Constructs a <code>UpdatePackageVersionsStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePackageVersionsStatusRequest} obj Optional instance to populate.
     * @return {module:model/UpdatePackageVersionsStatusRequest} The populated <code>UpdatePackageVersionsStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePackageVersionsStatusRequest();

            if (data.hasOwnProperty('versions')) {
                obj['versions'] = ApiClient.convertToType(data['versions'], ['String']);
            }
            if (data.hasOwnProperty('versionRevisions')) {
                obj['versionRevisions'] = ApiClient.convertToType(data['versionRevisions'], {'String': 'String'});
            }
            if (data.hasOwnProperty('expectedStatus')) {
                obj['expectedStatus'] = ApiClient.convertToType(data['expectedStatus'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePackageVersionsStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePackageVersionsStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePackageVersionsStatusRequest.RequiredProperties) {
        ...
        if (data['expectedStatus'] && !(typeof data['expectedStatus'] === 'string' || data['expectedStatus'] instanceof String)) {
            throw new Error("Expected the field `expectedStatus` to be a primitive type in the JSON string but got " + data['expectedStatus']);
        }
        // ensure the json data is a string
...
UpdatePackageVersionsStatusRequest.RequiredProperties = ["versions", "targetStatus"];

/**
 *  An array of strings that specify the versions of the package with the statuses to update. 
 * @member {Array.<String>} versions
 */
UpdatePackageVersionsStatusRequest.prototype['versions'] = undefined;
 ...
 * @member {Object.<String, String>} versionRevisions
 */
UpdatePackageVersionsStatusRequest.prototype['versionRevisions'] = undefined;
 ...
 * @member {module:model/UpdatePackageVersionsStatusRequest.ExpectedStatusEnum} expectedStatus
 */
UpdatePackageVersionsStatusRequest.prototype['expectedStatus'] = undefined;

/**
 *  The status you want to change the package version status to. 
 * @member {module:model/UpdatePackageVersionsStatusRequest.TargetStatusEnum} targetStatus
 */
UpdatePackageVersionsStatusRequest.prototype['targetStatus'] = undefined;
...
/**
 * Allowed values for the <code>expectedStatus</code> property.
 * @enum {String}
 * @readonly
 */
UpdatePackageVersionsStatusRequest['ExpectedStatusEnum'] = {
 ...
 * @readonly
 */
UpdatePackageVersionsStatusRequest['TargetStatusEnum'] = {
...
export default UpdatePackageVersionsStatusRequest;
