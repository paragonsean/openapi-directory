...
import DescribeRepositoryResultRepository from './DescribeRepositoryResultRepository';

/**
 * The DescribeRepositoryResult model module.
 * @module model/DescribeRepositoryResult
 * @version 2018-09-22
 */
class DescribeRepositoryResult {
    /**
     * Constructs a new <code>DescribeRepositoryResult</code>.
     * @alias module:model/DescribeRepositoryResult
     */
    constructor() { 
        
        DescribeRepositoryResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRepositoryResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRepositoryResult} obj Optional instance to populate.
     * @return {module:model/DescribeRepositoryResult} The populated <code>DescribeRepositoryResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRepositoryResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = DescribeRepositoryResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRepositoryResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRepositoryResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          DescribeRepositoryResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/DescribeRepositoryResultRepository} repository
 */
DescribeRepositoryResult.prototype['repository'] = undefined;
...
export default DescribeRepositoryResult;
