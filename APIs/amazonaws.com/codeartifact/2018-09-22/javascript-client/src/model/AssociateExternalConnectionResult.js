...
import AssociateExternalConnectionResultRepository from './AssociateExternalConnectionResultRepository';

/**
 * The AssociateExternalConnectionResult model module.
 * @module model/AssociateExternalConnectionResult
 * @version 2018-09-22
 */
class AssociateExternalConnectionResult {
    /**
     * Constructs a new <code>AssociateExternalConnectionResult</code>.
     * @alias module:model/AssociateExternalConnectionResult
     */
    constructor() { 
        
        AssociateExternalConnectionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateExternalConnectionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateExternalConnectionResult} obj Optional instance to populate.
     * @return {module:model/AssociateExternalConnectionResult} The populated <code>AssociateExternalConnectionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateExternalConnectionResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = AssociateExternalConnectionResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateExternalConnectionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateExternalConnectionResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          AssociateExternalConnectionResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/AssociateExternalConnectionResultRepository} repository
 */
AssociateExternalConnectionResult.prototype['repository'] = undefined;
...
export default AssociateExternalConnectionResult;
