...
import Tag from './Tag';
import UpstreamRepository from './UpstreamRepository';
...
class CreateRepositoryRequest {
    ...
    constructor() { 
        ...
        CreateRepositoryRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('upstreams')) {
                obj['upstreams'] = ApiClient.convertToType(data['upstreams'], [UpstreamRepository]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['upstreams']) { // data not null
            ...
            for (const item of data['upstreams']) {
                UpstreamRepository.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/UpstreamRepository>} upstreams
 */
CreateRepositoryRequest.prototype['upstreams'] = undefined;
