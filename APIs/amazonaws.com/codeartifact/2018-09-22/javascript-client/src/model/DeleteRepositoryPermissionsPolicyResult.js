...
import DeleteRepositoryPermissionsPolicyResultPolicy from './DeleteRepositoryPermissionsPolicyResultPolicy';

/**
 * The DeleteRepositoryPermissionsPolicyResult model module.
 * @module model/DeleteRepositoryPermissionsPolicyResult
 * @version 2018-09-22
 */
class DeleteRepositoryPermissionsPolicyResult {
    /**
     * Constructs a new <code>DeleteRepositoryPermissionsPolicyResult</code>.
     * @alias module:model/DeleteRepositoryPermissionsPolicyResult
     */
    constructor() { 
        
        DeleteRepositoryPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRepositoryPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRepositoryPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/DeleteRepositoryPermissionsPolicyResult} The populated <code>DeleteRepositoryPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRepositoryPermissionsPolicyResult();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = DeleteRepositoryPermissionsPolicyResultPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRepositoryPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRepositoryPermissionsPolicyResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          DeleteRepositoryPermissionsPolicyResultPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/DeleteRepositoryPermissionsPolicyResultPolicy} policy
 */
DeleteRepositoryPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default DeleteRepositoryPermissionsPolicyResult;
