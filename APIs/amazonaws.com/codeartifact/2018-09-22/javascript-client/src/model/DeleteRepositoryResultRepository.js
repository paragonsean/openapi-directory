...
/**
 * The DeleteRepositoryResultRepository model module.
 * @module model/DeleteRepositoryResultRepository
 * @version 2018-09-22
 */
class DeleteRepositoryResultRepository {
    /**
     * Constructs a new <code>DeleteRepositoryResultRepository</code>.
     * @alias module:model/DeleteRepositoryResultRepository
     * @implements module:model/RepositoryDescription
     */
    constructor() { 
        RepositoryDescription.initialize(this);
        DeleteRepositoryResultRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRepositoryResultRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRepositoryResultRepository} obj Optional instance to populate.
     * @return {module:model/DeleteRepositoryResultRepository} The populated <code>DeleteRepositoryResultRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRepositoryResultRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRepositoryResultRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRepositoryResultRepository</code>.
     */
 ...
 * @member {String} name
 */
DeleteRepositoryResultRepository.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
DeleteRepositoryResultRepository.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
DeleteRepositoryResultRepository.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
DeleteRepositoryResultRepository.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
DeleteRepositoryResultRepository.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
DeleteRepositoryResultRepository.prototype['description'] = undefined;

/**
 * @member {Array} upstreams
 */
DeleteRepositoryResultRepository.prototype['upstreams'] = undefined;

/**
 * @member {Array} externalConnections
 */
DeleteRepositoryResultRepository.prototype['externalConnections'] = undefined;

/**
 * @member {Date} createdTime
 */
DeleteRepositoryResultRepository.prototype['createdTime'] = undefined;
...
export default DeleteRepositoryResultRepository;
