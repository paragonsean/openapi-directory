...
class UpdateRepositoryRequest {
    ...
    constructor() { 
        ...
        UpdateRepositoryRequest.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRepositoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRepositoryRequest</code>.
     */
 ...
 */
UpdateRepositoryRequest.prototype['upstreams'] = undefined;
