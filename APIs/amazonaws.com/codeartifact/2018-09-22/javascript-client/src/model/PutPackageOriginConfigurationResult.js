...
import PutPackageOriginConfigurationResultOriginConfiguration from './PutPackageOriginConfigurationResultOriginConfiguration';

/**
 * The PutPackageOriginConfigurationResult model module.
 * @module model/PutPackageOriginConfigurationResult
 * @version 2018-09-22
 */
class PutPackageOriginConfigurationResult {
    /**
     * Constructs a new <code>PutPackageOriginConfigurationResult</code>.
     * @alias module:model/PutPackageOriginConfigurationResult
     */
    constructor() { 
        
        PutPackageOriginConfigurationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutPackageOriginConfigurationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutPackageOriginConfigurationResult} obj Optional instance to populate.
     * @return {module:model/PutPackageOriginConfigurationResult} The populated <code>PutPackageOriginConfigurationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutPackageOriginConfigurationResult();

            if (data.hasOwnProperty('originConfiguration')) {
                obj['originConfiguration'] = PutPackageOriginConfigurationResultOriginConfiguration.constructFromObject(data['originConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutPackageOriginConfigurationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutPackageOriginConfigurationResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `originConfiguration`
        if (data['originConfiguration']) { // data not null
          PutPackageOriginConfigurationResultOriginConfiguration.validateJSON(data['originConfiguration']);
        }
...
/**
 * @member {module:model/PutPackageOriginConfigurationResultOriginConfiguration} originConfiguration
 */
PutPackageOriginConfigurationResult.prototype['originConfiguration'] = undefined;
...
export default PutPackageOriginConfigurationResult;
