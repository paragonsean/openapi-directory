...
/**
 * The RepositorySummary model module.
 * @module model/RepositorySummary
 * @version 2018-09-22
 */
class RepositorySummary {
    /**
     * Constructs a new <code>RepositorySummary</code>.
     ...
     * @alias module:model/RepositorySummary
     */
    constructor() { 
        
        RepositorySummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepositorySummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositorySummary} obj Optional instance to populate.
     * @return {module:model/RepositorySummary} The populated <code>RepositorySummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositorySummary();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositorySummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositorySummary</code>.
     */
 ...
 * @member {String} name
 */
RepositorySummary.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
RepositorySummary.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
RepositorySummary.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
RepositorySummary.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
RepositorySummary.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
RepositorySummary.prototype['description'] = undefined;

/**
 * @member {Date} createdTime
 */
RepositorySummary.prototype['createdTime'] = undefined;
