...
/**
 * The DeletePackageVersionsResult model module.
 * @module model/DeletePackageVersionsResult
 * @version 2018-09-22
 */
class DeletePackageVersionsResult {
    /**
     * Constructs a new <code>DeletePackageVersionsResult</code>.
     * @alias module:model/DeletePackageVersionsResult
     */
    constructor() { 
        
        DeletePackageVersionsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeletePackageVersionsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePackageVersionsResult} obj Optional instance to populate.
     * @return {module:model/DeletePackageVersionsResult} The populated <code>DeletePackageVersionsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePackageVersionsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePackageVersionsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePackageVersionsResult</code>.
     */
 ...
 */
DeletePackageVersionsResult.prototype['successfulVersions'] = undefined;

/**
 * @member {Object} failedVersions
 */
DeletePackageVersionsResult.prototype['failedVersions'] = undefined;
...
export default DeletePackageVersionsResult;
