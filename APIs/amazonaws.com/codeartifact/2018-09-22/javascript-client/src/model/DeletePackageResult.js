...
/**
 * The DeletePackageResult model module.
 * @module model/DeletePackageResult
 * @version 2018-09-22
 */
class DeletePackageResult {
    /**
     * Constructs a new <code>DeletePackageResult</code>.
     * @alias module:model/DeletePackageResult
     */
    constructor() { 
        
        DeletePackageResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeletePackageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePackageResult} obj Optional instance to populate.
     * @return {module:model/DeletePackageResult} The populated <code>DeletePackageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePackageResult();

            if (data.hasOwnProperty('deletedPackage')) {
                obj['deletedPackage'] = PackageSummary.constructFromObject(data['deletedPackage']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePackageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePackageResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `deletedPackage`
        if (data['deletedPackage']) { // data not null
          PackageSummary.validateJSON(data['deletedPackage']);
        }
...
/**
 * @member {module:model/PackageSummary} deletedPackage
 */
DeletePackageResult.prototype['deletedPackage'] = undefined;
...
export default DeletePackageResult;
