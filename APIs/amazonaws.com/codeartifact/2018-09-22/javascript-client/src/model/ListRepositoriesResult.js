...
/**
 * The ListRepositoriesResult model module.
 * @module model/ListRepositoriesResult
 * @version 2018-09-22
 */
class ListRepositoriesResult {
    /**
     * Constructs a new <code>ListRepositoriesResult</code>.
     * @alias module:model/ListRepositoriesResult
     */
    constructor() { 
        
        ListRepositoriesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRepositoriesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRepositoriesResult} obj Optional instance to populate.
     * @return {module:model/ListRepositoriesResult} The populated <code>ListRepositoriesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRepositoriesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRepositoriesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRepositoriesResult</code>.
     */
 ...
 */
ListRepositoriesResult.prototype['repositories'] = undefined;

/**
 * @member {String} nextToken
 */
ListRepositoriesResult.prototype['nextToken'] = undefined;
...
export default ListRepositoriesResult;
