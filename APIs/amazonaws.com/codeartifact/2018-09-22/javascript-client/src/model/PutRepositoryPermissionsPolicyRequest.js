...
/**
 * The PutRepositoryPermissionsPolicyRequest model module.
 * @module model/PutRepositoryPermissionsPolicyRequest
 * @version 2018-09-22
 */
class PutRepositoryPermissionsPolicyRequest {
    /**
     * Constructs a new <code>PutRepositoryPermissionsPolicyRequest</code>.
     * @alias module:model/PutRepositoryPermissionsPolicyRequest
     * @param policyDocument {String}  A valid displayable JSON Aspen policy string to be set as the access control resource policy on the provided repository. 
     */
    constructor(policyDocument) { 
        
        PutRepositoryPermissionsPolicyRequest.initialize(this, policyDocument);
    }
     ...
     */
    static initialize(obj, policyDocument) { 
        obj['policyDocument'] = policyDocument;
    }

    /**
     * Constructs a <code>PutRepositoryPermissionsPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutRepositoryPermissionsPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutRepositoryPermissionsPolicyRequest} The populated <code>PutRepositoryPermissionsPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutRepositoryPermissionsPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutRepositoryPermissionsPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutRepositoryPermissionsPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutRepositoryPermissionsPolicyRequest.RequiredProperties) {
...
PutRepositoryPermissionsPolicyRequest.RequiredProperties = ["policyDocument"];

/**
 *  Sets the revision of the resource policy that specifies permissions to access the repository. This revision is used for optimistic locking, which prevents others from overwriting your changes to the repository's resource policy. 
 * @member {String} policyRevision
 */
PutRepositoryPermissionsPolicyRequest.prototype['policyRevision'] = undefined;

/**
 *  A valid displayable JSON Aspen policy string to be set as the access control resource policy on the provided repository. 
 * @member {String} policyDocument
 */
PutRepositoryPermissionsPolicyRequest.prototype['policyDocument'] = undefined;
...
export default PutRepositoryPermissionsPolicyRequest;
