...
import PutPackageOriginConfigurationRequestRestrictions from './PutPackageOriginConfigurationRequestRestrictions';

/**
 * The PutPackageOriginConfigurationRequest model module.
 * @module model/PutPackageOriginConfigurationRequest
 * @version 2018-09-22
 */
class PutPackageOriginConfigurationRequest {
    /**
     * Constructs a new <code>PutPackageOriginConfigurationRequest</code>.
     * @alias module:model/PutPackageOriginConfigurationRequest
     * @param restrictions {module:model/PutPackageOriginConfigurationRequestRestrictions} 
     */
    constructor(restrictions) { 
        
        PutPackageOriginConfigurationRequest.initialize(this, restrictions);
    }
     ...
     */
    static initialize(obj, restrictions) { 
        obj['restrictions'] = restrictions;
    }

    /**
     * Constructs a <code>PutPackageOriginConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutPackageOriginConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/PutPackageOriginConfigurationRequest} The populated <code>PutPackageOriginConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutPackageOriginConfigurationRequest();

            if (data.hasOwnProperty('restrictions')) {
                obj['restrictions'] = PutPackageOriginConfigurationRequestRestrictions.constructFromObject(data['restrictions']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutPackageOriginConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutPackageOriginConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutPackageOriginConfigurationRequest.RequiredProperties) {
        ...
        if (data['restrictions']) { // data not null
          PutPackageOriginConfigurationRequestRestrictions.validateJSON(data['restrictions']);
        }
...
PutPackageOriginConfigurationRequest.RequiredProperties = ["restrictions"];

/**
 * @member {module:model/PutPackageOriginConfigurationRequestRestrictions} restrictions
 */
PutPackageOriginConfigurationRequest.prototype['restrictions'] = undefined;
...
export default PutPackageOriginConfigurationRequest;
