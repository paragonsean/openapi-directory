...
/**
 * The DisposePackageVersionsResult model module.
 * @module model/DisposePackageVersionsResult
 * @version 2018-09-22
 */
class DisposePackageVersionsResult {
    /**
     * Constructs a new <code>DisposePackageVersionsResult</code>.
     * @alias module:model/DisposePackageVersionsResult
     */
    constructor() { 
        
        DisposePackageVersionsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisposePackageVersionsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisposePackageVersionsResult} obj Optional instance to populate.
     * @return {module:model/DisposePackageVersionsResult} The populated <code>DisposePackageVersionsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisposePackageVersionsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>DisposePackageVersionsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisposePackageVersionsResult</code>.
     */
 ...
 */
DisposePackageVersionsResult.prototype['successfulVersions'] = undefined;

/**
 * @member {Object} failedVersions
 */
DisposePackageVersionsResult.prototype['failedVersions'] = undefined;
...
export default DisposePackageVersionsResult;
