...
import CreateDomainResultDomain from './CreateDomainResultDomain';

/**
 * The CreateDomainResult model module.
 * @module model/CreateDomainResult
 * @version 2018-09-22
 */
class CreateDomainResult {
    /**
     * Constructs a new <code>CreateDomainResult</code>.
     * @alias module:model/CreateDomainResult
     */
    constructor() { 
        
        CreateDomainResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDomainResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDomainResult} obj Optional instance to populate.
     * @return {module:model/CreateDomainResult} The populated <code>CreateDomainResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDomainResult();

            if (data.hasOwnProperty('domain')) {
                obj['domain'] = CreateDomainResultDomain.constructFromObject(data['domain']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDomainResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDomainResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `domain`
        if (data['domain']) { // data not null
          CreateDomainResultDomain.validateJSON(data['domain']);
        }
...
/**
 * @member {module:model/CreateDomainResultDomain} domain
 */
CreateDomainResult.prototype['domain'] = undefined;
...
export default CreateDomainResult;
