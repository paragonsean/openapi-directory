...
/**
 * The SuccessfulPackageVersionInfo model module.
 * @module model/SuccessfulPackageVersionInfo
 * @version 2018-09-22
 */
class SuccessfulPackageVersionInfo {
    /**
     * Constructs a new <code>SuccessfulPackageVersionInfo</code>.
     *  Contains the revision and status of a package version. 
     * @alias module:model/SuccessfulPackageVersionInfo
     */
    constructor() { 
        
        SuccessfulPackageVersionInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuccessfulPackageVersionInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuccessfulPackageVersionInfo} obj Optional instance to populate.
     * @return {module:model/SuccessfulPackageVersionInfo} The populated <code>SuccessfulPackageVersionInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuccessfulPackageVersionInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>SuccessfulPackageVersionInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuccessfulPackageVersionInfo</code>.
     */
 ...
 */
SuccessfulPackageVersionInfo.prototype['revision'] = undefined;

/**
 * @member {module:model/PackageVersionStatus} status
 */
SuccessfulPackageVersionInfo.prototype['status'] = undefined;
...
export default SuccessfulPackageVersionInfo;
