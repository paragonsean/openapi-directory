...
/**
 * The PackageDependency model module.
 * @module model/PackageDependency
 * @version 2018-09-22
 */
class PackageDependency {
    /**
     * Constructs a new <code>PackageDependency</code>.
     *  Details about a package dependency. 
     * @alias module:model/PackageDependency
     */
    constructor() { 
        
        PackageDependency.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageDependency</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageDependency} obj Optional instance to populate.
     * @return {module:model/PackageDependency} The populated <code>PackageDependency</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageDependency();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageDependency</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageDependency</code>.
     */
    static validateJSON(data) {
        ...
        if (data['dependencyType']) { // data not null
          String.validateJSON(data['dependencyType']);
        }
 ...
 */
PackageDependency.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
PackageDependency.prototype['package'] = undefined;

/**
 * @member {String} dependencyType
 */
PackageDependency.prototype['dependencyType'] = undefined;

/**
 * @member {String} versionRequirement
 */
PackageDependency.prototype['versionRequirement'] = undefined;
