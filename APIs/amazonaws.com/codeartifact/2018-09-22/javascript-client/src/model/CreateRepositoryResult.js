...
import CreateRepositoryResultRepository from './CreateRepositoryResultRepository';

/**
 * The CreateRepositoryResult model module.
 * @module model/CreateRepositoryResult
 * @version 2018-09-22
 */
class CreateRepositoryResult {
    /**
     * Constructs a new <code>CreateRepositoryResult</code>.
     * @alias module:model/CreateRepositoryResult
     */
    constructor() { 
        
        CreateRepositoryResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRepositoryResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRepositoryResult} obj Optional instance to populate.
     * @return {module:model/CreateRepositoryResult} The populated <code>CreateRepositoryResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRepositoryResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = CreateRepositoryResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRepositoryResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRepositoryResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          CreateRepositoryResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/CreateRepositoryResultRepository} repository
 */
CreateRepositoryResult.prototype['repository'] = undefined;
...
export default CreateRepositoryResult;
