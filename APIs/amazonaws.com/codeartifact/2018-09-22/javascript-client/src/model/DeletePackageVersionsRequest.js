...
/**
 * The DeletePackageVersionsRequest model module.
 * @module model/DeletePackageVersionsRequest
 * @version 2018-09-22
 */
class DeletePackageVersionsRequest {
    /**
     * Constructs a new <code>DeletePackageVersionsRequest</code>.
     * @alias module:model/DeletePackageVersionsRequest
     * @param versions {Array.<String>}  An array of strings that specify the versions of the package to delete. 
     */
    constructor(versions) { 
        
        DeletePackageVersionsRequest.initialize(this, versions);
    }
    ...
    /**
     * Constructs a <code>DeletePackageVersionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePackageVersionsRequest} obj Optional instance to populate.
     * @return {module:model/DeletePackageVersionsRequest} The populated <code>DeletePackageVersionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePackageVersionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePackageVersionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePackageVersionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePackageVersionsRequest.RequiredProperties) {
...
DeletePackageVersionsRequest.RequiredProperties = ["versions"];

/**
 *  An array of strings that specify the versions of the package to delete. 
 * @member {Array.<String>} versions
 */
DeletePackageVersionsRequest.prototype['versions'] = undefined;

/**
 *  The expected status of the package version to delete. 
 * @member {module:model/DeletePackageVersionsRequest.ExpectedStatusEnum} expectedStatus
 */
DeletePackageVersionsRequest.prototype['expectedStatus'] = undefined;
 ...
 * @readonly
 */
DeletePackageVersionsRequest['ExpectedStatusEnum'] = {
...
export default DeletePackageVersionsRequest;
