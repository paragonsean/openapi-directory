...
/**
 * The PublishPackageVersionRequest model module.
 * @module model/PublishPackageVersionRequest
 * @version 2018-09-22
 */
class PublishPackageVersionRequest {
    /**
     * Constructs a new <code>PublishPackageVersionRequest</code>.
     * @alias module:model/PublishPackageVersionRequest
     * @param assetContent {String} The content of the asset to publish.
     */
    constructor(assetContent) { 
        
        PublishPackageVersionRequest.initialize(this, assetContent);
    }
     ...
     */
    static initialize(obj, assetContent) { 
        obj['assetContent'] = assetContent;
    }

    /**
     * Constructs a <code>PublishPackageVersionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishPackageVersionRequest} obj Optional instance to populate.
     * @return {module:model/PublishPackageVersionRequest} The populated <code>PublishPackageVersionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishPackageVersionRequest();

            if (data.hasOwnProperty('assetContent')) {
                obj['assetContent'] = ApiClient.convertToType(data['assetContent'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PublishPackageVersionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishPackageVersionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublishPackageVersionRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['assetContent'] && !(typeof data['assetContent'] === 'string' || data['assetContent'] instanceof String)) {
            throw new Error("Expected the field `assetContent` to be a primitive type in the JSON string but got " + data['assetContent']);
        }
...
PublishPackageVersionRequest.RequiredProperties = ["assetContent"];

/**
 * The content of the asset to publish.
 * @member {String} assetContent
 */
PublishPackageVersionRequest.prototype['assetContent'] = undefined;
...
export default PublishPackageVersionRequest;
