...
/**
 * The PutDomainPermissionsPolicyResultPolicy model module.
 * @module model/PutDomainPermissionsPolicyResultPolicy
 * @version 2018-09-22
 */
class PutDomainPermissionsPolicyResultPolicy {
    /**
     * Constructs a new <code>PutDomainPermissionsPolicyResultPolicy</code>.
     * @alias module:model/PutDomainPermissionsPolicyResultPolicy
     * @implements module:model/ResourcePolicy
     */
    constructor() { 
        ResourcePolicy.initialize(this);
        PutDomainPermissionsPolicyResultPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutDomainPermissionsPolicyResultPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDomainPermissionsPolicyResultPolicy} obj Optional instance to populate.
     * @return {module:model/PutDomainPermissionsPolicyResultPolicy} The populated <code>PutDomainPermissionsPolicyResultPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDomainPermissionsPolicyResultPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>PutDomainPermissionsPolicyResultPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDomainPermissionsPolicyResultPolicy</code>.
     */
 ...
 */
PutDomainPermissionsPolicyResultPolicy.prototype['resourceArn'] = undefined;

/**
 * @member {String} revision
 */
PutDomainPermissionsPolicyResultPolicy.prototype['revision'] = undefined;

/**
 * @member {String} document
 */
PutDomainPermissionsPolicyResultPolicy.prototype['document'] = undefined;
...
export default PutDomainPermissionsPolicyResultPolicy;
