...
import AllowPublish from './AllowPublish';
import AllowUpstream from './AllowUpstream';
import PackageOriginRestrictions from './PackageOriginRestrictions';

/**
 * The PackageOriginConfigurationRestrictions model module.
 * @module model/PackageOriginConfigurationRestrictions
 * @version 2018-09-22
 */
class PackageOriginConfigurationRestrictions {
    /**
     * Constructs a new <code>PackageOriginConfigurationRestrictions</code>.
     * @alias module:model/PackageOriginConfigurationRestrictions
     * @implements module:model/PackageOriginRestrictions
     * @param publish {module:model/AllowPublish} 
     * @param upstream {module:model/AllowUpstream} 
     */
    constructor(publish, upstream) { 
        PackageOriginRestrictions.initialize(this, publish, upstream);
        PackageOriginConfigurationRestrictions.initialize(this, publish, upstream);
    }
     ...
     */
    static initialize(obj, publish, upstream) { 
        obj['publish'] = publish;
        obj['upstream'] = upstream;
    }

    /**
     * Constructs a <code>PackageOriginConfigurationRestrictions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageOriginConfigurationRestrictions} obj Optional instance to populate.
     * @return {module:model/PackageOriginConfigurationRestrictions} The populated <code>PackageOriginConfigurationRestrictions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageOriginConfigurationRestrictions();
            PackageOriginRestrictions.constructFromObject(data, obj);

            if (data.hasOwnProperty('publish')) {
                obj['publish'] = ApiClient.convertToType(data['publish'], AllowPublish);
            }
            if (data.hasOwnProperty('upstream')) {
                obj['upstream'] = ApiClient.convertToType(data['upstream'], AllowUpstream);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PackageOriginConfigurationRestrictions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageOriginConfigurationRestrictions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PackageOriginConfigurationRestrictions.RequiredProperties) {
        ...
        if (data['publish']) { // data not null
          AllowPublish.validateJSON(data['publish']);
        }
        // validate the optional field `upstream`
        if (data['upstream']) { // data not null
          AllowUpstream.validateJSON(data['upstream']);
        }
...
PackageOriginConfigurationRestrictions.RequiredProperties = ["publish", "upstream"];

/**
 * @member {module:model/AllowPublish} publish
 */
PackageOriginConfigurationRestrictions.prototype['publish'] = undefined;

/**
 * @member {module:model/AllowUpstream} upstream
 */
PackageOriginConfigurationRestrictions.prototype['upstream'] = undefined;


// Implement PackageOriginRestrictions interface:
/**
 * @member {module:model/AllowPublish} publish
 */
PackageOriginRestrictions.prototype['publish'] = undefined;
/**
 * @member {module:model/AllowUpstream} upstream
 */
PackageOriginRestrictions.prototype['upstream'] = undefined;




export default PackageOriginConfigurationRestrictions;
