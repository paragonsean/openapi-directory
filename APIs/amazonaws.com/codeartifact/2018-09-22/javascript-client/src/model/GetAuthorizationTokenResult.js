...
/**
 * The GetAuthorizationTokenResult model module.
 * @module model/GetAuthorizationTokenResult
 * @version 2018-09-22
 */
class GetAuthorizationTokenResult {
    /**
     * Constructs a new <code>GetAuthorizationTokenResult</code>.
     * @alias module:model/GetAuthorizationTokenResult
     */
    constructor() { 
        
        GetAuthorizationTokenResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAuthorizationTokenResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAuthorizationTokenResult} obj Optional instance to populate.
     * @return {module:model/GetAuthorizationTokenResult} The populated <code>GetAuthorizationTokenResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAuthorizationTokenResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAuthorizationTokenResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAuthorizationTokenResult</code>.
     */
 ...
 */
GetAuthorizationTokenResult.prototype['authorizationToken'] = undefined;

/**
 * @member {Date} expiration
 */
GetAuthorizationTokenResult.prototype['expiration'] = undefined;
...
export default GetAuthorizationTokenResult;
