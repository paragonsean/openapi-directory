...
import UpdateRepositoryResultRepository from './UpdateRepositoryResultRepository';

/**
 * The UpdateRepositoryResult model module.
 * @module model/UpdateRepositoryResult
 * @version 2018-09-22
 */
class UpdateRepositoryResult {
    /**
     * Constructs a new <code>UpdateRepositoryResult</code>.
     * @alias module:model/UpdateRepositoryResult
     */
    constructor() { 
        
        UpdateRepositoryResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateRepositoryResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateRepositoryResult} obj Optional instance to populate.
     * @return {module:model/UpdateRepositoryResult} The populated <code>UpdateRepositoryResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateRepositoryResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = UpdateRepositoryResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateRepositoryResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateRepositoryResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          UpdateRepositoryResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/UpdateRepositoryResultRepository} repository
 */
UpdateRepositoryResult.prototype['repository'] = undefined;
...
export default UpdateRepositoryResult;
