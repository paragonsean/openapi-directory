...
/**
 * The ListPackageVersionDependenciesResult model module.
 * @module model/ListPackageVersionDependenciesResult
 * @version 2018-09-22
 */
class ListPackageVersionDependenciesResult {
    /**
     * Constructs a new <code>ListPackageVersionDependenciesResult</code>.
     * @alias module:model/ListPackageVersionDependenciesResult
     */
    constructor() { 
        
        ListPackageVersionDependenciesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPackageVersionDependenciesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPackageVersionDependenciesResult} obj Optional instance to populate.
     * @return {module:model/ListPackageVersionDependenciesResult} The populated <code>ListPackageVersionDependenciesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPackageVersionDependenciesResult();
            ...
            if (data.hasOwnProperty('dependencies')) {
                obj['dependencies'] = ApiClient.convertToType(data['dependencies'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPackageVersionDependenciesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPackageVersionDependenciesResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['dependencies']) { // data not null
          Array.validateJSON(data['dependencies']);
        }
 ...
 */
ListPackageVersionDependenciesResult.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
ListPackageVersionDependenciesResult.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
ListPackageVersionDependenciesResult.prototype['package'] = undefined;

/**
 * @member {String} version
 */
ListPackageVersionDependenciesResult.prototype['version'] = undefined;

/**
 * @member {String} versionRevision
 */
ListPackageVersionDependenciesResult.prototype['versionRevision'] = undefined;

/**
 * @member {String} nextToken
 */
ListPackageVersionDependenciesResult.prototype['nextToken'] = undefined;

/**
 * @member {Array} dependencies
 */
ListPackageVersionDependenciesResult.prototype['dependencies'] = undefined;
...
export default ListPackageVersionDependenciesResult;
