...
/**
 * The GetDomainPermissionsPolicyResultPolicy model module.
 * @module model/GetDomainPermissionsPolicyResultPolicy
 * @version 2018-09-22
 */
class GetDomainPermissionsPolicyResultPolicy {
    /**
     * Constructs a new <code>GetDomainPermissionsPolicyResultPolicy</code>.
     * @alias module:model/GetDomainPermissionsPolicyResultPolicy
     * @implements module:model/ResourcePolicy
     */
    constructor() { 
        ResourcePolicy.initialize(this);
        GetDomainPermissionsPolicyResultPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDomainPermissionsPolicyResultPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDomainPermissionsPolicyResultPolicy} obj Optional instance to populate.
     * @return {module:model/GetDomainPermissionsPolicyResultPolicy} The populated <code>GetDomainPermissionsPolicyResultPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDomainPermissionsPolicyResultPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDomainPermissionsPolicyResultPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDomainPermissionsPolicyResultPolicy</code>.
     */
 ...
 */
GetDomainPermissionsPolicyResultPolicy.prototype['resourceArn'] = undefined;

/**
 * @member {String} revision
 */
GetDomainPermissionsPolicyResultPolicy.prototype['revision'] = undefined;

/**
 * @member {String} document
 */
GetDomainPermissionsPolicyResultPolicy.prototype['document'] = undefined;
...
export default GetDomainPermissionsPolicyResultPolicy;
