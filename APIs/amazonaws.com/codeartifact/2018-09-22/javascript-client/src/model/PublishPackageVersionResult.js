...
import PublishPackageVersionResultAsset from './PublishPackageVersionResultAsset';

/**
 * The PublishPackageVersionResult model module.
 * @module model/PublishPackageVersionResult
 * @version 2018-09-22
 */
class PublishPackageVersionResult {
    /**
     * Constructs a new <code>PublishPackageVersionResult</code>.
     * @alias module:model/PublishPackageVersionResult
     */
    constructor() { 
        
        PublishPackageVersionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublishPackageVersionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishPackageVersionResult} obj Optional instance to populate.
     * @return {module:model/PublishPackageVersionResult} The populated <code>PublishPackageVersionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishPackageVersionResult();
            ...
            if (data.hasOwnProperty('asset')) {
                obj['asset'] = PublishPackageVersionResultAsset.constructFromObject(data['asset']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PublishPackageVersionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishPackageVersionResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['asset']) { // data not null
          PublishPackageVersionResultAsset.validateJSON(data['asset']);
        }
 ...
 */
PublishPackageVersionResult.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
PublishPackageVersionResult.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
PublishPackageVersionResult.prototype['package'] = undefined;

/**
 * @member {String} version
 */
PublishPackageVersionResult.prototype['version'] = undefined;

/**
 * @member {String} versionRevision
 */
PublishPackageVersionResult.prototype['versionRevision'] = undefined;

/**
 * @member {module:model/PackageVersionStatus} status
 */
PublishPackageVersionResult.prototype['status'] = undefined;

/**
 * @member {module:model/PublishPackageVersionResultAsset} asset
 */
PublishPackageVersionResult.prototype['asset'] = undefined;
...
export default PublishPackageVersionResult;
