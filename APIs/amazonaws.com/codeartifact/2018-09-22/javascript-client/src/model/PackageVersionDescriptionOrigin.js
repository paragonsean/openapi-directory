...
import PackageVersionOrigin from './PackageVersionOrigin';
...
/**
 * The PackageVersionDescriptionOrigin model module.
 * @module model/PackageVersionDescriptionOrigin
 * @version 2018-09-22
 */
class PackageVersionDescriptionOrigin {
    /**
     * Constructs a new <code>PackageVersionDescriptionOrigin</code>.
     * @alias module:model/PackageVersionDescriptionOrigin
     * @implements module:model/PackageVersionOrigin
     */
    constructor() { 
        PackageVersionOrigin.initialize(this);
        PackageVersionDescriptionOrigin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageVersionDescriptionOrigin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionDescriptionOrigin} obj Optional instance to populate.
     * @return {module:model/PackageVersionDescriptionOrigin} The populated <code>PackageVersionDescriptionOrigin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionDescriptionOrigin();
            PackageVersionOrigin.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionDescriptionOrigin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionDescriptionOrigin</code>.
     */
 ...
 */
PackageVersionDescriptionOrigin.prototype['domainEntryPoint'] = undefined;

/**
 * @member {module:model/PackageVersionOriginType} originType
 */
PackageVersionDescriptionOrigin.prototype['originType'] = undefined;


// Implement PackageVersionOrigin interface:
/**
 * @member {module:model/PackageVersionOriginDomainEntryPoint} domainEntryPoint
 */
...
export default PackageVersionDescriptionOrigin;
