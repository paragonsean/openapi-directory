...
import PackageVersionErrorCode from './PackageVersionErrorCode';

/**
 * The PackageVersionError model module.
 * @module model/PackageVersionError
 * @version 2018-09-22
 */
class PackageVersionError {
    /**
     * Constructs a new <code>PackageVersionError</code>.
     * l An error associated with package. 
     * @alias module:model/PackageVersionError
     */
    constructor() { 
        
        PackageVersionError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageVersionError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionError} obj Optional instance to populate.
     * @return {module:model/PackageVersionError} The populated <code>PackageVersionError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionError();

            if (data.hasOwnProperty('errorCode')) {
                obj['errorCode'] = ApiClient.convertToType(data['errorCode'], PackageVersionErrorCode);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionError</code>.
     */
    static validateJSON(data) {
        // validate the optional field `errorCode`
        if (data['errorCode']) { // data not null
          PackageVersionErrorCode.validateJSON(data['errorCode']);
        }
...
/**
 * @member {module:model/PackageVersionErrorCode} errorCode
 */
PackageVersionError.prototype['errorCode'] = undefined;

/**
 * @member {String} errorMessage
 */
PackageVersionError.prototype['errorMessage'] = undefined;
...
export default PackageVersionError;
