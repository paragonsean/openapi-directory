...
/**
 * The DescribeDomainResult model module.
 * @module model/DescribeDomainResult
 * @version 2018-09-22
 */
class DescribeDomainResult {
    /**
     * Constructs a new <code>DescribeDomainResult</code>.
     * @alias module:model/DescribeDomainResult
     */
    constructor() { 
        
        DescribeDomainResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeDomainResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeDomainResult} obj Optional instance to populate.
     * @return {module:model/DescribeDomainResult} The populated <code>DescribeDomainResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeDomainResult();

            if (data.hasOwnProperty('domain')) {
                obj['domain'] = DomainDescription.constructFromObject(data['domain']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeDomainResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeDomainResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `domain`
        if (data['domain']) { // data not null
          DomainDescription.validateJSON(data['domain']);
        }
...
/**
 * @member {module:model/DomainDescription} domain
 */
DescribeDomainResult.prototype['domain'] = undefined;
...
export default DescribeDomainResult;
