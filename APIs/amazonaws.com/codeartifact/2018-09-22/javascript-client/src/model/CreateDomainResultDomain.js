...
/**
 * The CreateDomainResultDomain model module.
 * @module model/CreateDomainResultDomain
 * @version 2018-09-22
 */
class CreateDomainResultDomain {
    /**
     * Constructs a new <code>CreateDomainResultDomain</code>.
     * @alias module:model/CreateDomainResultDomain
     * @implements module:model/DomainDescription
     */
    constructor() { 
        DomainDescription.initialize(this);
        CreateDomainResultDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDomainResultDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDomainResultDomain} obj Optional instance to populate.
     * @return {module:model/CreateDomainResultDomain} The populated <code>CreateDomainResultDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDomainResultDomain();
            DomainDescription.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('repositoryCount')) {
                obj['repositoryCount'] = ApiClient.convertToType(data['repositoryCount'], 'Number');
            }
            if (data.hasOwnProperty('assetSizeBytes')) {
                obj['assetSizeBytes'] = ApiClient.convertToType(data['assetSizeBytes'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDomainResultDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDomainResultDomain</code>.
     */
    static validateJSON(data) {
        ...
        if (data['repositoryCount']) { // data not null
          Number.validateJSON(data['repositoryCount']);
        }
        // validate the optional field `assetSizeBytes`
        if (data['assetSizeBytes']) { // data not null
          Number.validateJSON(data['assetSizeBytes']);
        }
 ...
 * @member {String} name
 */
CreateDomainResultDomain.prototype['name'] = undefined;

/**
 * @member {String} owner
 */
CreateDomainResultDomain.prototype['owner'] = undefined;

/**
 * @member {String} arn
 */
CreateDomainResultDomain.prototype['arn'] = undefined;

/**
 * @member {module:model/DomainStatus} status
 */
CreateDomainResultDomain.prototype['status'] = undefined;

/**
 * @member {Date} createdTime
 */
CreateDomainResultDomain.prototype['createdTime'] = undefined;

/**
 * @member {String} encryptionKey
 */
CreateDomainResultDomain.prototype['encryptionKey'] = undefined;

/**
 * @member {Number} repositoryCount
 */
CreateDomainResultDomain.prototype['repositoryCount'] = undefined;

/**
 * @member {Number} assetSizeBytes
 */
CreateDomainResultDomain.prototype['assetSizeBytes'] = undefined;

/**
 * @member {String} s3BucketArn
 */
CreateDomainResultDomain.prototype['s3BucketArn'] = undefined;


// Implement DomainDescription interface:
/**
 * @member {String} name
 */
DomainDescription.prototype['name'] = undefined;
/**
 * @member {String} owner
 */
DomainDescription.prototype['owner'] = undefined;
/**
 * @member {String} arn
 */
DomainDescription.prototype['arn'] = undefined;
/**
 * @member {module:model/DomainStatus} status
 */
DomainDescription.prototype['status'] = undefined;
/**
 * @member {Date} createdTime
 */
DomainDescription.prototype['createdTime'] = undefined;
/**
 * @member {String} encryptionKey
 */
DomainDescription.prototype['encryptionKey'] = undefined;
/**
 * @member {Number} repositoryCount
 */
DomainDescription.prototype['repositoryCount'] = undefined;
/**
 * @member {Number} assetSizeBytes
 */
DomainDescription.prototype['assetSizeBytes'] = undefined;
/**
 * @member {String} s3BucketArn
 */
DomainDescription.prototype['s3BucketArn'] = undefined;




export default CreateDomainResultDomain;
