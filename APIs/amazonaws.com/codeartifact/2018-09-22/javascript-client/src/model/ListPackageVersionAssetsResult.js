...
/**
 * The ListPackageVersionAssetsResult model module.
 * @module model/ListPackageVersionAssetsResult
 * @version 2018-09-22
 */
class ListPackageVersionAssetsResult {
    /**
     * Constructs a new <code>ListPackageVersionAssetsResult</code>.
     * @alias module:model/ListPackageVersionAssetsResult
     */
    constructor() { 
        
        ListPackageVersionAssetsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPackageVersionAssetsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPackageVersionAssetsResult} obj Optional instance to populate.
     * @return {module:model/ListPackageVersionAssetsResult} The populated <code>ListPackageVersionAssetsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPackageVersionAssetsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPackageVersionAssetsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPackageVersionAssetsResult</code>.
     */
 ...
 */
ListPackageVersionAssetsResult.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
ListPackageVersionAssetsResult.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
ListPackageVersionAssetsResult.prototype['package'] = undefined;

/**
 * @member {String} version
 */
ListPackageVersionAssetsResult.prototype['version'] = undefined;

/**
 * @member {String} versionRevision
 */
ListPackageVersionAssetsResult.prototype['versionRevision'] = undefined;

/**
 * @member {String} nextToken
 */
ListPackageVersionAssetsResult.prototype['nextToken'] = undefined;

/**
 * @member {Array} assets
 */
ListPackageVersionAssetsResult.prototype['assets'] = undefined;
...
export default ListPackageVersionAssetsResult;
