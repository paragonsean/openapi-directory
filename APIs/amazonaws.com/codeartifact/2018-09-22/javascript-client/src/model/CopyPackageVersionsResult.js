...
/**
 * The CopyPackageVersionsResult model module.
 * @module model/CopyPackageVersionsResult
 * @version 2018-09-22
 */
class CopyPackageVersionsResult {
    /**
     * Constructs a new <code>CopyPackageVersionsResult</code>.
     * @alias module:model/CopyPackageVersionsResult
     */
    constructor() { 
        
        CopyPackageVersionsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CopyPackageVersionsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyPackageVersionsResult} obj Optional instance to populate.
     * @return {module:model/CopyPackageVersionsResult} The populated <code>CopyPackageVersionsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyPackageVersionsResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyPackageVersionsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyPackageVersionsResult</code>.
     */
 ...
 */
CopyPackageVersionsResult.prototype['successfulVersions'] = undefined;

/**
 * @member {Object} failedVersions
 */
CopyPackageVersionsResult.prototype['failedVersions'] = undefined;
...
export default CopyPackageVersionsResult;
