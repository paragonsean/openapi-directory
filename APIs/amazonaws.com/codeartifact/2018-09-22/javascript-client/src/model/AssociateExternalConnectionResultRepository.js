...
/**
 * The AssociateExternalConnectionResultRepository model module.
 * @module model/AssociateExternalConnectionResultRepository
 * @version 2018-09-22
 */
class AssociateExternalConnectionResultRepository {
    /**
     * Constructs a new <code>AssociateExternalConnectionResultRepository</code>.
     * @alias module:model/AssociateExternalConnectionResultRepository
     * @implements module:model/RepositoryDescription
     */
    constructor() { 
        RepositoryDescription.initialize(this);
        AssociateExternalConnectionResultRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateExternalConnectionResultRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateExternalConnectionResultRepository} obj Optional instance to populate.
     * @return {module:model/AssociateExternalConnectionResultRepository} The populated <code>AssociateExternalConnectionResultRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateExternalConnectionResultRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateExternalConnectionResultRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateExternalConnectionResultRepository</code>.
     */
 ...
 * @member {String} name
 */
AssociateExternalConnectionResultRepository.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
AssociateExternalConnectionResultRepository.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
AssociateExternalConnectionResultRepository.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
AssociateExternalConnectionResultRepository.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
AssociateExternalConnectionResultRepository.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
AssociateExternalConnectionResultRepository.prototype['description'] = undefined;

/**
 * @member {Array} upstreams
 */
AssociateExternalConnectionResultRepository.prototype['upstreams'] = undefined;

/**
 * @member {Array} externalConnections
 */
AssociateExternalConnectionResultRepository.prototype['externalConnections'] = undefined;

/**
 * @member {Date} createdTime
 */
AssociateExternalConnectionResultRepository.prototype['createdTime'] = undefined;
...
export default AssociateExternalConnectionResultRepository;
