...
/**
 * The DeleteDomainResultDomain model module.
 * @module model/DeleteDomainResultDomain
 * @version 2018-09-22
 */
class DeleteDomainResultDomain {
    /**
     * Constructs a new <code>DeleteDomainResultDomain</code>.
     * @alias module:model/DeleteDomainResultDomain
     * @implements module:model/DomainDescription
     */
    constructor() { 
        DomainDescription.initialize(this);
        DeleteDomainResultDomain.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteDomainResultDomain</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDomainResultDomain} obj Optional instance to populate.
     * @return {module:model/DeleteDomainResultDomain} The populated <code>DeleteDomainResultDomain</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDomainResultDomain();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDomainResultDomain</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDomainResultDomain</code>.
     */
 ...
 * @member {String} name
 */
DeleteDomainResultDomain.prototype['name'] = undefined;

/**
 * @member {String} owner
 */
DeleteDomainResultDomain.prototype['owner'] = undefined;

/**
 * @member {String} arn
 */
DeleteDomainResultDomain.prototype['arn'] = undefined;

/**
 * @member {module:model/DomainStatus} status
 */
DeleteDomainResultDomain.prototype['status'] = undefined;

/**
 * @member {Date} createdTime
 */
DeleteDomainResultDomain.prototype['createdTime'] = undefined;

/**
 * @member {String} encryptionKey
 */
DeleteDomainResultDomain.prototype['encryptionKey'] = undefined;

/**
 * @member {Number} repositoryCount
 */
DeleteDomainResultDomain.prototype['repositoryCount'] = undefined;

/**
 * @member {Number} assetSizeBytes
 */
DeleteDomainResultDomain.prototype['assetSizeBytes'] = undefined;

/**
 * @member {String} s3BucketArn
 */
DeleteDomainResultDomain.prototype['s3BucketArn'] = undefined;
...
export default DeleteDomainResultDomain;
