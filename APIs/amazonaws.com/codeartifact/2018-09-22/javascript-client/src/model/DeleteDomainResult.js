...
import DeleteDomainResultDomain from './DeleteDomainResultDomain';

/**
 * The DeleteDomainResult model module.
 * @module model/DeleteDomainResult
 * @version 2018-09-22
 */
class DeleteDomainResult {
    /**
     * Constructs a new <code>DeleteDomainResult</code>.
     * @alias module:model/DeleteDomainResult
     */
    constructor() { 
        
        DeleteDomainResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteDomainResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDomainResult} obj Optional instance to populate.
     * @return {module:model/DeleteDomainResult} The populated <code>DeleteDomainResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDomainResult();

            if (data.hasOwnProperty('domain')) {
                obj['domain'] = DeleteDomainResultDomain.constructFromObject(data['domain']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDomainResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDomainResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `domain`
        if (data['domain']) { // data not null
          DeleteDomainResultDomain.validateJSON(data['domain']);
        }
...
/**
 * @member {module:model/DeleteDomainResultDomain} domain
 */
DeleteDomainResult.prototype['domain'] = undefined;
...
export default DeleteDomainResult;
