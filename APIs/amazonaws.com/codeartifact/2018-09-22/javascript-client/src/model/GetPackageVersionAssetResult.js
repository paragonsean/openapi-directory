...
/**
 * The GetPackageVersionAssetResult model module.
 * @module model/GetPackageVersionAssetResult
 * @version 2018-09-22
 */
class GetPackageVersionAssetResult {
    /**
     * Constructs a new <code>GetPackageVersionAssetResult</code>.
     * @alias module:model/GetPackageVersionAssetResult
     */
    constructor() { 
        
        GetPackageVersionAssetResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPackageVersionAssetResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPackageVersionAssetResult} obj Optional instance to populate.
     * @return {module:model/GetPackageVersionAssetResult} The populated <code>GetPackageVersionAssetResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPackageVersionAssetResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPackageVersionAssetResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPackageVersionAssetResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `asset`
        if (data['asset']) { // data not null
          String.validateJSON(data['asset']);
        }
 ...
 * @member {String} asset
 */
GetPackageVersionAssetResult.prototype['asset'] = undefined;
...
export default GetPackageVersionAssetResult;
