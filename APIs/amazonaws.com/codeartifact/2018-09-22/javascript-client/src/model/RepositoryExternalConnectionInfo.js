...
import ExternalConnectionStatus from './ExternalConnectionStatus';
import PackageFormat from './PackageFormat';

/**
 * The RepositoryExternalConnectionInfo model module.
 * @module model/RepositoryExternalConnectionInfo
 * @version 2018-09-22
 */
class RepositoryExternalConnectionInfo {
    /**
     * Constructs a new <code>RepositoryExternalConnectionInfo</code>.
     *  Contains information about the external connection of a repository. 
     * @alias module:model/RepositoryExternalConnectionInfo
     */
    constructor() { 
        
        RepositoryExternalConnectionInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RepositoryExternalConnectionInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryExternalConnectionInfo} obj Optional instance to populate.
     * @return {module:model/RepositoryExternalConnectionInfo} The populated <code>RepositoryExternalConnectionInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryExternalConnectionInfo();

            if (data.hasOwnProperty('externalConnectionName')) {
                obj['externalConnectionName'] = ApiClient.convertToType(data['externalConnectionName'], 'String');
            }
            if (data.hasOwnProperty('packageFormat')) {
                obj['packageFormat'] = ApiClient.convertToType(data['packageFormat'], PackageFormat);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], ExternalConnectionStatus);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryExternalConnectionInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryExternalConnectionInfo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `externalConnectionName`
        if (data['externalConnectionName']) { // data not null
          String.validateJSON(data['externalConnectionName']);
        }
        // validate the optional field `packageFormat`
        if (data['packageFormat']) { // data not null
          PackageFormat.validateJSON(data['packageFormat']);
        }
        // validate the optional field `status`
        if (data['status']) { // data not null
          ExternalConnectionStatus.validateJSON(data['status']);
        }
...
/**
 * @member {String} externalConnectionName
 */
RepositoryExternalConnectionInfo.prototype['externalConnectionName'] = undefined;

/**
 * @member {module:model/PackageFormat} packageFormat
 */
RepositoryExternalConnectionInfo.prototype['packageFormat'] = undefined;

/**
 * @member {module:model/ExternalConnectionStatus} status
 */
RepositoryExternalConnectionInfo.prototype['status'] = undefined;
...
export default RepositoryExternalConnectionInfo;
