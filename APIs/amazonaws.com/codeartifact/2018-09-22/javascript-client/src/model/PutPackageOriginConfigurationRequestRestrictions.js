...
/**
 * The PutPackageOriginConfigurationRequestRestrictions model module.
 * @module model/PutPackageOriginConfigurationRequestRestrictions
 * @version 2018-09-22
 */
class PutPackageOriginConfigurationRequestRestrictions {
    /**
     * Constructs a new <code>PutPackageOriginConfigurationRequestRestrictions</code>.
     * @alias module:model/PutPackageOriginConfigurationRequestRestrictions
    ...
    constructor(publish, upstream) { 
        ...
        PutPackageOriginConfigurationRequestRestrictions.initialize(this, publish, upstream);
    }
    ...
    /**
     * Constructs a <code>PutPackageOriginConfigurationRequestRestrictions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutPackageOriginConfigurationRequestRestrictions} obj Optional instance to populate.
     * @return {module:model/PutPackageOriginConfigurationRequestRestrictions} The populated <code>PutPackageOriginConfigurationRequestRestrictions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutPackageOriginConfigurationRequestRestrictions();
    ...
    /**
     * Validates the JSON data with respect to <code>PutPackageOriginConfigurationRequestRestrictions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutPackageOriginConfigurationRequestRestrictions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutPackageOriginConfigurationRequestRestrictions.RequiredProperties) {
...
PutPackageOriginConfigurationRequestRestrictions.RequiredProperties = ["publish", "upstream"];

/**
 * @member {module:model/AllowPublish} publish
 */
PutPackageOriginConfigurationRequestRestrictions.prototype['publish'] = undefined;

/**
 * @member {module:model/AllowUpstream} upstream
 */
PutPackageOriginConfigurationRequestRestrictions.prototype['upstream'] = undefined;
...
export default PutPackageOriginConfigurationRequestRestrictions;
