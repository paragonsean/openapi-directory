...
import DeleteRepositoryResultRepository from './DeleteRepositoryResultRepository';

/**
 * The DeleteRepositoryResult model module.
 * @module model/DeleteRepositoryResult
 * @version 2018-09-22
 */
class DeleteRepositoryResult {
    /**
     * Constructs a new <code>DeleteRepositoryResult</code>.
     * @alias module:model/DeleteRepositoryResult
     */
    constructor() { 
        
        DeleteRepositoryResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRepositoryResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRepositoryResult} obj Optional instance to populate.
     * @return {module:model/DeleteRepositoryResult} The populated <code>DeleteRepositoryResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRepositoryResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = DeleteRepositoryResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRepositoryResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRepositoryResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          DeleteRepositoryResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/DeleteRepositoryResultRepository} repository
 */
DeleteRepositoryResult.prototype['repository'] = undefined;
...
export default DeleteRepositoryResult;
