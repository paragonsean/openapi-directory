...
/**
 * The UpstreamRepositoryInfo model module.
 * @module model/UpstreamRepositoryInfo
 * @version 2018-09-22
 */
class UpstreamRepositoryInfo {
    /**
     * Constructs a new <code>UpstreamRepositoryInfo</code>.
     *  Information about an upstream repository. 
     * @alias module:model/UpstreamRepositoryInfo
     */
    constructor() { 
        
        UpstreamRepositoryInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpstreamRepositoryInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpstreamRepositoryInfo} obj Optional instance to populate.
     * @return {module:model/UpstreamRepositoryInfo} The populated <code>UpstreamRepositoryInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpstreamRepositoryInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>UpstreamRepositoryInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpstreamRepositoryInfo</code>.
     */
 ...
 */
UpstreamRepositoryInfo.prototype['repositoryName'] = undefined;
...
export default UpstreamRepositoryInfo;
