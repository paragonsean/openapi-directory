...
import DeleteDomainPermissionsPolicyResultPolicy from './DeleteDomainPermissionsPolicyResultPolicy';

/**
 * The DeleteDomainPermissionsPolicyResult model module.
 * @module model/DeleteDomainPermissionsPolicyResult
 * @version 2018-09-22
 */
class DeleteDomainPermissionsPolicyResult {
    /**
     * Constructs a new <code>DeleteDomainPermissionsPolicyResult</code>.
     * @alias module:model/DeleteDomainPermissionsPolicyResult
     */
    constructor() { 
        
        DeleteDomainPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteDomainPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDomainPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/DeleteDomainPermissionsPolicyResult} The populated <code>DeleteDomainPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDomainPermissionsPolicyResult();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = DeleteDomainPermissionsPolicyResultPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDomainPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDomainPermissionsPolicyResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          DeleteDomainPermissionsPolicyResultPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/DeleteDomainPermissionsPolicyResultPolicy} policy
 */
DeleteDomainPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default DeleteDomainPermissionsPolicyResult;
