...
/**
 * The ListRepositoriesInDomainResult model module.
 * @module model/ListRepositoriesInDomainResult
 * @version 2018-09-22
 */
class ListRepositoriesInDomainResult {
    /**
     * Constructs a new <code>ListRepositoriesInDomainResult</code>.
     * @alias module:model/ListRepositoriesInDomainResult
     */
    constructor() { 
        
        ListRepositoriesInDomainResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListRepositoriesInDomainResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListRepositoriesInDomainResult} obj Optional instance to populate.
     * @return {module:model/ListRepositoriesInDomainResult} The populated <code>ListRepositoriesInDomainResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListRepositoriesInDomainResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListRepositoriesInDomainResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListRepositoriesInDomainResult</code>.
     */
 ...
 */
ListRepositoriesInDomainResult.prototype['repositories'] = undefined;

/**
 * @member {String} nextToken
 */
ListRepositoriesInDomainResult.prototype['nextToken'] = undefined;
...
export default ListRepositoriesInDomainResult;
