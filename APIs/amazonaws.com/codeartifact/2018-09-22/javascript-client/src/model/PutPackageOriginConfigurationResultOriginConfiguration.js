...
import PackageOriginConfiguration from './PackageOriginConfiguration';
import PackageOriginConfigurationRestrictions from './PackageOriginConfigurationRestrictions';

/**
 * The PutPackageOriginConfigurationResultOriginConfiguration model module.
 * @module model/PutPackageOriginConfigurationResultOriginConfiguration
 * @version 2018-09-22
 */
class PutPackageOriginConfigurationResultOriginConfiguration {
    /**
     * Constructs a new <code>PutPackageOriginConfigurationResultOriginConfiguration</code>.
     * @alias module:model/PutPackageOriginConfigurationResultOriginConfiguration
     * @implements module:model/PackageOriginConfiguration
     */
    constructor() { 
        PackageOriginConfiguration.initialize(this);
        PutPackageOriginConfigurationResultOriginConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutPackageOriginConfigurationResultOriginConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutPackageOriginConfigurationResultOriginConfiguration} obj Optional instance to populate.
     * @return {module:model/PutPackageOriginConfigurationResultOriginConfiguration} The populated <code>PutPackageOriginConfigurationResultOriginConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutPackageOriginConfigurationResultOriginConfiguration();
            PackageOriginConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('restrictions')) {
                obj['restrictions'] = PackageOriginConfigurationRestrictions.constructFromObject(data['restrictions']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutPackageOriginConfigurationResultOriginConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutPackageOriginConfigurationResultOriginConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `restrictions`
        if (data['restrictions']) { // data not null
          PackageOriginConfigurationRestrictions.validateJSON(data['restrictions']);
        }
...
/**
 * @member {module:model/PackageOriginConfigurationRestrictions} restrictions
 */
PutPackageOriginConfigurationResultOriginConfiguration.prototype['restrictions'] = undefined;


// Implement PackageOriginConfiguration interface:
/**
 * @member {module:model/PackageOriginConfigurationRestrictions} restrictions
 */
PackageOriginConfiguration.prototype['restrictions'] = undefined;




export default PutPackageOriginConfigurationResultOriginConfiguration;
