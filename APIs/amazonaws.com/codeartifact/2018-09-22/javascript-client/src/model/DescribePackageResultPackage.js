...
import PackageDescriptionOriginConfiguration from './PackageDescriptionOriginConfiguration';
import PackageFormat from './PackageFormat';

/**
 * The DescribePackageResultPackage model module.
 * @module model/DescribePackageResultPackage
 * @version 2018-09-22
 */
class DescribePackageResultPackage {
    /**
     * Constructs a new <code>DescribePackageResultPackage</code>.
     * @alias module:model/DescribePackageResultPackage
     * @implements module:model/PackageDescription
     */
    constructor() { 
        PackageDescription.initialize(this);
        DescribePackageResultPackage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePackageResultPackage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePackageResultPackage} obj Optional instance to populate.
     * @return {module:model/DescribePackageResultPackage} The populated <code>DescribePackageResultPackage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePackageResultPackage();
            PackageDescription.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('originConfiguration')) {
                obj['originConfiguration'] = PackageDescriptionOriginConfiguration.constructFromObject(data['originConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePackageResultPackage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePackageResultPackage</code>.
     */
    static validateJSON(data) {
        ...
        if (data['originConfiguration']) { // data not null
          PackageDescriptionOriginConfiguration.validateJSON(data['originConfiguration']);
        }
 ...
 */
DescribePackageResultPackage.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
DescribePackageResultPackage.prototype['namespace'] = undefined;

/**
 * @member {String} name
 */
DescribePackageResultPackage.prototype['name'] = undefined;

/**
 * @member {module:model/PackageDescriptionOriginConfiguration} originConfiguration
 */
DescribePackageResultPackage.prototype['originConfiguration'] = undefined;


// Implement PackageDescription interface:
/**
 * @member {module:model/PackageFormat} format
 */
PackageDescription.prototype['format'] = undefined;
/**
 * @member {String} namespace
 */
PackageDescription.prototype['namespace'] = undefined;
/**
 * @member {String} name
 */
PackageDescription.prototype['name'] = undefined;
/**
 * @member {module:model/PackageDescriptionOriginConfiguration} originConfiguration
 */
PackageDescription.prototype['originConfiguration'] = undefined;




export default DescribePackageResultPackage;
