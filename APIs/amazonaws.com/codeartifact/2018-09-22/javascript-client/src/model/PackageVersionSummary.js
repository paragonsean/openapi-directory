...
import PackageVersionDescriptionOrigin from './PackageVersionDescriptionOrigin';
import PackageVersionStatus from './PackageVersionStatus';

/**
 * The PackageVersionSummary model module.
 * @module model/PackageVersionSummary
 * @version 2018-09-22
 */
class PackageVersionSummary {
    /**
     * Constructs a new <code>PackageVersionSummary</code>.
     ...
     * @alias module:model/PackageVersionSummary
     * @param version {String} 
     * @param status {module:model/PackageVersionStatus} 
     */
    constructor(version, status) { 
        
        PackageVersionSummary.initialize(this, version, status);
    }
     ...
     */
    static initialize(obj, version, status) { 
        obj['version'] = version;
        obj['status'] = status;
    }

    /**
     * Constructs a <code>PackageVersionSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionSummary} obj Optional instance to populate.
     * @return {module:model/PackageVersionSummary} The populated <code>PackageVersionSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionSummary();
            ...
            if (data.hasOwnProperty('origin')) {
                obj['origin'] = PackageVersionDescriptionOrigin.constructFromObject(data['origin']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PackageVersionSummary.RequiredProperties) {
        ...
        if (data['origin']) { // data not null
          PackageVersionDescriptionOrigin.validateJSON(data['origin']);
        }
...
PackageVersionSummary.RequiredProperties = ["version", "status"];

/**
 * @member {String} version
 */
PackageVersionSummary.prototype['version'] = undefined;

/**
 * @member {String} revision
 */
PackageVersionSummary.prototype['revision'] = undefined;

/**
 * @member {module:model/PackageVersionStatus} status
 */
PackageVersionSummary.prototype['status'] = undefined;

/**
 * @member {module:model/PackageVersionDescriptionOrigin} origin
 */
PackageVersionSummary.prototype['origin'] = undefined;
...
export default PackageVersionSummary;
