...
import DisassociateExternalConnectionResultRepository from './DisassociateExternalConnectionResultRepository';

/**
 * The DisassociateExternalConnectionResult model module.
 * @module model/DisassociateExternalConnectionResult
 * @version 2018-09-22
 */
class DisassociateExternalConnectionResult {
    /**
     * Constructs a new <code>DisassociateExternalConnectionResult</code>.
     * @alias module:model/DisassociateExternalConnectionResult
     */
    constructor() { 
        
        DisassociateExternalConnectionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateExternalConnectionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateExternalConnectionResult} obj Optional instance to populate.
     * @return {module:model/DisassociateExternalConnectionResult} The populated <code>DisassociateExternalConnectionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateExternalConnectionResult();

            if (data.hasOwnProperty('repository')) {
                obj['repository'] = DisassociateExternalConnectionResultRepository.constructFromObject(data['repository']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateExternalConnectionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateExternalConnectionResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repository`
        if (data['repository']) { // data not null
          DisassociateExternalConnectionResultRepository.validateJSON(data['repository']);
        }
...
/**
 * @member {module:model/DisassociateExternalConnectionResultRepository} repository
 */
DisassociateExternalConnectionResult.prototype['repository'] = undefined;
...
export default DisassociateExternalConnectionResult;
