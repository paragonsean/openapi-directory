...
/**
 * The RepositoryDescription model module.
 * @module model/RepositoryDescription
 * @version 2018-09-22
 */
class RepositoryDescription {
    /**
     * Constructs a new <code>RepositoryDescription</code>.
     ...
     * @alias module:model/RepositoryDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RepositoryDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RepositoryDescription} obj Optional instance to populate.
     * @return {module:model/RepositoryDescription} The populated <code>RepositoryDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RepositoryDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>RepositoryDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RepositoryDescription</code>.
     */
