...
/**
 * The PublishPackageVersionResultAsset model module.
 * @module model/PublishPackageVersionResultAsset
 * @version 2018-09-22
 */
class PublishPackageVersionResultAsset {
    /**
     * Constructs a new <code>PublishPackageVersionResultAsset</code>.
     * @alias module:model/PublishPackageVersionResultAsset
     * @implements module:model/AssetSummary
     * @param name {String} 
     */
    constructor(name) { 
        AssetSummary.initialize(this, name);
        PublishPackageVersionResultAsset.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>PublishPackageVersionResultAsset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishPackageVersionResultAsset} obj Optional instance to populate.
     * @return {module:model/PublishPackageVersionResultAsset} The populated <code>PublishPackageVersionResultAsset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishPackageVersionResultAsset();
            AssetSummary.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('hashes')) {
                obj['hashes'] = ApiClient.convertToType(data['hashes'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PublishPackageVersionResultAsset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishPackageVersionResultAsset</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublishPackageVersionResultAsset.RequiredProperties) {
        ...
        if (data['hashes']) { // data not null
          Object.validateJSON(data['hashes']);
        }
...
PublishPackageVersionResultAsset.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
PublishPackageVersionResultAsset.prototype['name'] = undefined;

/**
 * @member {Number} size
 */
PublishPackageVersionResultAsset.prototype['size'] = undefined;

/**
 * @member {Object} hashes
 */
PublishPackageVersionResultAsset.prototype['hashes'] = undefined;


// Implement AssetSummary interface:
/**
 * @member {String} name
 */
 ...
 * @member {Number} size
 */
AssetSummary.prototype['size'] = undefined;
/**
 * @member {Object} hashes
 */
AssetSummary.prototype['hashes'] = undefined;




export default PublishPackageVersionResultAsset;
