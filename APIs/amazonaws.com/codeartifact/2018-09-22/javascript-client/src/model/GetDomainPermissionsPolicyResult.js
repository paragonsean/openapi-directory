...
/**
 * The GetDomainPermissionsPolicyResult model module.
 * @module model/GetDomainPermissionsPolicyResult
 * @version 2018-09-22
 */
class GetDomainPermissionsPolicyResult {
    /**
     * Constructs a new <code>GetDomainPermissionsPolicyResult</code>.
     * @alias module:model/GetDomainPermissionsPolicyResult
     */
    constructor() { 
        
        GetDomainPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDomainPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDomainPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/GetDomainPermissionsPolicyResult} The populated <code>GetDomainPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDomainPermissionsPolicyResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDomainPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDomainPermissionsPolicyResult</code>.
     */
 ...
 */
GetDomainPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default GetDomainPermissionsPolicyResult;
