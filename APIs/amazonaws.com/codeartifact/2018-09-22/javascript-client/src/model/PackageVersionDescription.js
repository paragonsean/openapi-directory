...
/**
 * The PackageVersionDescription model module.
 * @module model/PackageVersionDescription
 * @version 2018-09-22
 */
class PackageVersionDescription {
    /**
     * Constructs a new <code>PackageVersionDescription</code>.
     *  Details about a package version. 
     * @alias module:model/PackageVersionDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PackageVersionDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionDescription} obj Optional instance to populate.
     * @return {module:model/PackageVersionDescription} The populated <code>PackageVersionDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionDescription</code>.
     */
...
export default PackageVersionDescription;
