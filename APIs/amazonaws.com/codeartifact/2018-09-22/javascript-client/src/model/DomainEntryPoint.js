...
/**
 * The DomainEntryPoint model module.
 * @module model/DomainEntryPoint
 * @version 2018-09-22
 */
class DomainEntryPoint {
    /**
     * Constructs a new <code>DomainEntryPoint</code>.
     ...
     * @alias module:model/DomainEntryPoint
     */
    constructor() { 
        
        DomainEntryPoint.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainEntryPoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainEntryPoint} obj Optional instance to populate.
     * @return {module:model/DomainEntryPoint} The populated <code>DomainEntryPoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainEntryPoint();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainEntryPoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainEntryPoint</code>.
     */
 ...
 */
DomainEntryPoint.prototype['repositoryName'] = undefined;

/**
 * @member {String} externalConnectionName
 */
DomainEntryPoint.prototype['externalConnectionName'] = undefined;
...
export default DomainEntryPoint;
