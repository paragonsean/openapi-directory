...
import DomainEntryPoint from './DomainEntryPoint';

/**
 * The PackageVersionOriginDomainEntryPoint model module.
 * @module model/PackageVersionOriginDomainEntryPoint
 * @version 2018-09-22
 */
class PackageVersionOriginDomainEntryPoint {
    /**
     * Constructs a new <code>PackageVersionOriginDomainEntryPoint</code>.
     * @alias module:model/PackageVersionOriginDomainEntryPoint
     * @implements module:model/DomainEntryPoint
     */
    constructor() { 
        DomainEntryPoint.initialize(this);
        PackageVersionOriginDomainEntryPoint.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageVersionOriginDomainEntryPoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionOriginDomainEntryPoint} obj Optional instance to populate.
     * @return {module:model/PackageVersionOriginDomainEntryPoint} The populated <code>PackageVersionOriginDomainEntryPoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionOriginDomainEntryPoint();
            DomainEntryPoint.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionOriginDomainEntryPoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionOriginDomainEntryPoint</code>.
     */
 ...
 */
PackageVersionOriginDomainEntryPoint.prototype['repositoryName'] = undefined;

/**
 * @member {String} externalConnectionName
 */
PackageVersionOriginDomainEntryPoint.prototype['externalConnectionName'] = undefined;


// Implement DomainEntryPoint interface:
/**
 * @member {String} repositoryName
 */
...
export default PackageVersionOriginDomainEntryPoint;
