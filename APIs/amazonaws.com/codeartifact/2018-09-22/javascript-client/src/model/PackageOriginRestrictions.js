...
/**
 * The PackageOriginRestrictions model module.
 * @module model/PackageOriginRestrictions
 * @version 2018-09-22
 */
class PackageOriginRestrictions {
    /**
     * Constructs a new <code>PackageOriginRestrictions</code>.
     ...
     * @alias module:model/PackageOriginRestrictions
    ...
    /**
     * Constructs a <code>PackageOriginRestrictions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageOriginRestrictions} obj Optional instance to populate.
     * @return {module:model/PackageOriginRestrictions} The populated <code>PackageOriginRestrictions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageOriginRestrictions();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageOriginRestrictions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageOriginRestrictions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PackageOriginRestrictions.RequiredProperties) {
...
PackageOriginRestrictions.RequiredProperties = ["publish", "upstream"];
...
export default PackageOriginRestrictions;
