...
/**
 * The DisposePackageVersionsRequest model module.
 * @module model/DisposePackageVersionsRequest
 * @version 2018-09-22
 */
class DisposePackageVersionsRequest {
    /**
     * Constructs a new <code>DisposePackageVersionsRequest</code>.
     * @alias module:model/DisposePackageVersionsRequest
     * @param versions {Array.<String>}  The versions of the package you want to dispose. 
     */
    constructor(versions) { 
        
        DisposePackageVersionsRequest.initialize(this, versions);
    }
    ...
    /**
     * Constructs a <code>DisposePackageVersionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisposePackageVersionsRequest} obj Optional instance to populate.
     * @return {module:model/DisposePackageVersionsRequest} The populated <code>DisposePackageVersionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisposePackageVersionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DisposePackageVersionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisposePackageVersionsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DisposePackageVersionsRequest.RequiredProperties) {
...
DisposePackageVersionsRequest.RequiredProperties = ["versions"];

/**
 *  The versions of the package you want to dispose. 
 * @member {Array.<String>} versions
 */
DisposePackageVersionsRequest.prototype['versions'] = undefined;

/**
 *  The revisions of the package versions you want to dispose. 
 * @member {Object.<String, String>} versionRevisions
 */
DisposePackageVersionsRequest.prototype['versionRevisions'] = undefined;

/**
 *  The expected status of the package version to dispose. 
 * @member {module:model/DisposePackageVersionsRequest.ExpectedStatusEnum} expectedStatus
 */
DisposePackageVersionsRequest.prototype['expectedStatus'] = undefined;
 ...
 * @readonly
 */
DisposePackageVersionsRequest['ExpectedStatusEnum'] = {
...
export default DisposePackageVersionsRequest;
