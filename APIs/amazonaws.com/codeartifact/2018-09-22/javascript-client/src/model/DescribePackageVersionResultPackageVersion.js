...
import PackageVersionDescription from './PackageVersionDescription';
...
/**
 * The DescribePackageVersionResultPackageVersion model module.
 * @module model/DescribePackageVersionResultPackageVersion
 * @version 2018-09-22
 */
class DescribePackageVersionResultPackageVersion {
    /**
     * Constructs a new <code>DescribePackageVersionResultPackageVersion</code>.
     * @alias module:model/DescribePackageVersionResultPackageVersion
     * @implements module:model/PackageVersionDescription
     */
    constructor() { 
        PackageVersionDescription.initialize(this);
        DescribePackageVersionResultPackageVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribePackageVersionResultPackageVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePackageVersionResultPackageVersion} obj Optional instance to populate.
     * @return {module:model/DescribePackageVersionResultPackageVersion} The populated <code>DescribePackageVersionResultPackageVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePackageVersionResultPackageVersion();
            PackageVersionDescription.constructFromObject(data, obj);

            if (data.hasOwnProperty('format')) {
                obj['format'] = ApiClient.convertToType(data['format'], PackageFormat);
            }
            ...
            if (data.hasOwnProperty('sourceCodeRepository')) {
                obj['sourceCodeRepository'] = ApiClient.convertToType(data['sourceCodeRepository'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePackageVersionResultPackageVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePackageVersionResultPackageVersion</code>.
     */
    static validateJSON(data) {
        // validate the optional field `format`
        if (data['format']) { // data not null
          PackageFormat.validateJSON(data['format']);
        }
        ...
        if (data['homePage']) { // data not null
          String.validateJSON(data['homePage']);
        }
        // validate the optional field `sourceCodeRepository`
        if (data['sourceCodeRepository']) { // data not null
          String.validateJSON(data['sourceCodeRepository']);
        }
        // validate the optional field `publishedTime`
        if (data['publishedTime']) { // data not null
          Date.validateJSON(data['publishedTime']);
        }
...
/**
 * @member {module:model/PackageFormat} format
 */
DescribePackageVersionResultPackageVersion.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
DescribePackageVersionResultPackageVersion.prototype['namespace'] = undefined;

/**
 * @member {String} packageName
 */
DescribePackageVersionResultPackageVersion.prototype['packageName'] = undefined;

/**
 * @member {String} displayName
 */
DescribePackageVersionResultPackageVersion.prototype['displayName'] = undefined;

/**
 * @member {String} version
 */
DescribePackageVersionResultPackageVersion.prototype['version'] = undefined;

/**
 * @member {String} summary
 */
DescribePackageVersionResultPackageVersion.prototype['summary'] = undefined;

/**
 * @member {String} homePage
 */
DescribePackageVersionResultPackageVersion.prototype['homePage'] = undefined;

/**
 * @member {String} sourceCodeRepository
 */
DescribePackageVersionResultPackageVersion.prototype['sourceCodeRepository'] = undefined;

/**
 * @member {Date} publishedTime
 */
DescribePackageVersionResultPackageVersion.prototype['publishedTime'] = undefined;

/**
 * @member {Array} licenses
 */
DescribePackageVersionResultPackageVersion.prototype['licenses'] = undefined;

/**
 * @member {String} revision
 */
DescribePackageVersionResultPackageVersion.prototype['revision'] = undefined;

/**
 * @member {module:model/PackageVersionStatus} status
 */
DescribePackageVersionResultPackageVersion.prototype['status'] = undefined;

/**
 * @member {module:model/PackageVersionDescriptionOrigin} origin
 */
DescribePackageVersionResultPackageVersion.prototype['origin'] = undefined;


// Implement PackageVersionDescription interface:
/**
 * @member {module:model/PackageFormat} format
 */
PackageVersionDescription.prototype['format'] = undefined;
/**
 * @member {String} namespace
 */
PackageVersionDescription.prototype['namespace'] = undefined;
/**
 * @member {String} packageName
 */
PackageVersionDescription.prototype['packageName'] = undefined;
/**
 * @member {String} displayName
 */
PackageVersionDescription.prototype['displayName'] = undefined;
/**
 * @member {String} version
 */
PackageVersionDescription.prototype['version'] = undefined;
/**
 * @member {String} summary
 */
PackageVersionDescription.prototype['summary'] = undefined;
/**
 * @member {String} homePage
 */
PackageVersionDescription.prototype['homePage'] = undefined;
/**
 * @member {String} sourceCodeRepository
 */
PackageVersionDescription.prototype['sourceCodeRepository'] = undefined;
/**
 * @member {Date} publishedTime
 */
PackageVersionDescription.prototype['publishedTime'] = undefined;
/**
 * @member {Array} licenses
 */
PackageVersionDescription.prototype['licenses'] = undefined;
/**
 * @member {String} revision
 */
PackageVersionDescription.prototype['revision'] = undefined;
/**
 * @member {module:model/PackageVersionStatus} status
 */
PackageVersionDescription.prototype['status'] = undefined;
/**
 * @member {module:model/PackageVersionDescriptionOrigin} origin
 */
PackageVersionDescription.prototype['origin'] = undefined;




export default DescribePackageVersionResultPackageVersion;
