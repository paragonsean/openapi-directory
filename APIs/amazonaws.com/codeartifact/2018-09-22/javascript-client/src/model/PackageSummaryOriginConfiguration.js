...
/**
 * The PackageSummaryOriginConfiguration model module.
 * @module model/PackageSummaryOriginConfiguration
 * @version 2018-09-22
 */
class PackageSummaryOriginConfiguration {
    /**
     * Constructs a new <code>PackageSummaryOriginConfiguration</code>.
     * @alias module:model/PackageSummaryOriginConfiguration
     * @implements module:model/PackageOriginConfiguration
     */
    constructor() { 
        PackageOriginConfiguration.initialize(this);
        PackageSummaryOriginConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageSummaryOriginConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageSummaryOriginConfiguration} obj Optional instance to populate.
     * @return {module:model/PackageSummaryOriginConfiguration} The populated <code>PackageSummaryOriginConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageSummaryOriginConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageSummaryOriginConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageSummaryOriginConfiguration</code>.
     */
 ...
 */
PackageSummaryOriginConfiguration.prototype['restrictions'] = undefined;
...
export default PackageSummaryOriginConfiguration;
