...
/**
 * The PutDomainPermissionsPolicyResult model module.
 * @module model/PutDomainPermissionsPolicyResult
 * @version 2018-09-22
 */
class PutDomainPermissionsPolicyResult {
    /**
     * Constructs a new <code>PutDomainPermissionsPolicyResult</code>.
     * @alias module:model/PutDomainPermissionsPolicyResult
     */
    constructor() { 
        
        PutDomainPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutDomainPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDomainPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/PutDomainPermissionsPolicyResult} The populated <code>PutDomainPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDomainPermissionsPolicyResult();
    ...
    /**
     * Validates the JSON data with respect to <code>PutDomainPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDomainPermissionsPolicyResult</code>.
     */
 ...
 */
PutDomainPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default PutDomainPermissionsPolicyResult;
