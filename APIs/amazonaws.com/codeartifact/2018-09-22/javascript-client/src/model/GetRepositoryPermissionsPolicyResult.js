...
import GetDomainPermissionsPolicyResultPolicy from './GetDomainPermissionsPolicyResultPolicy';

/**
 * The GetRepositoryPermissionsPolicyResult model module.
 * @module model/GetRepositoryPermissionsPolicyResult
 * @version 2018-09-22
 */
class GetRepositoryPermissionsPolicyResult {
    /**
     * Constructs a new <code>GetRepositoryPermissionsPolicyResult</code>.
     * @alias module:model/GetRepositoryPermissionsPolicyResult
     */
    constructor() { 
        
        GetRepositoryPermissionsPolicyResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryPermissionsPolicyResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryPermissionsPolicyResult} obj Optional instance to populate.
     * @return {module:model/GetRepositoryPermissionsPolicyResult} The populated <code>GetRepositoryPermissionsPolicyResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryPermissionsPolicyResult();

            if (data.hasOwnProperty('policy')) {
                obj['policy'] = GetDomainPermissionsPolicyResultPolicy.constructFromObject(data['policy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryPermissionsPolicyResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryPermissionsPolicyResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `policy`
        if (data['policy']) { // data not null
          GetDomainPermissionsPolicyResultPolicy.validateJSON(data['policy']);
        }
...
/**
 * @member {module:model/GetDomainPermissionsPolicyResultPolicy} policy
 */
GetRepositoryPermissionsPolicyResult.prototype['policy'] = undefined;
...
export default GetRepositoryPermissionsPolicyResult;
