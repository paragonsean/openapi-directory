...
/**
 * The GetRepositoryEndpointResult model module.
 * @module model/GetRepositoryEndpointResult
 * @version 2018-09-22
 */
class GetRepositoryEndpointResult {
    /**
     * Constructs a new <code>GetRepositoryEndpointResult</code>.
     * @alias module:model/GetRepositoryEndpointResult
     */
    constructor() { 
        
        GetRepositoryEndpointResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRepositoryEndpointResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRepositoryEndpointResult} obj Optional instance to populate.
     * @return {module:model/GetRepositoryEndpointResult} The populated <code>GetRepositoryEndpointResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRepositoryEndpointResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRepositoryEndpointResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRepositoryEndpointResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `repositoryEndpoint`
        if (data['repositoryEndpoint']) { // data not null
          String.validateJSON(data['repositoryEndpoint']);
        }
 ...
 */
GetRepositoryEndpointResult.prototype['repositoryEndpoint'] = undefined;
...
export default GetRepositoryEndpointResult;
