...
* @readonly
*/
export default class PackageFormat {
    ...
    /**
    * Returns a <code>PackageFormat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PackageFormat} The enum <code>PackageFormat</code> value.
    */
