...
* @readonly
*/
export default class PackageVersionErrorCode {
    ...
    /**
    * Returns a <code>PackageVersionErrorCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PackageVersionErrorCode} The enum <code>PackageVersionErrorCode</code> value.
    */
