...
/**
 * The DeleteDomainPermissionsPolicyResultPolicy model module.
 * @module model/DeleteDomainPermissionsPolicyResultPolicy
 * @version 2018-09-22
 */
class DeleteDomainPermissionsPolicyResultPolicy {
    /**
     * Constructs a new <code>DeleteDomainPermissionsPolicyResultPolicy</code>.
     * @alias module:model/DeleteDomainPermissionsPolicyResultPolicy
     * @implements module:model/ResourcePolicy
     */
    constructor() { 
        ResourcePolicy.initialize(this);
        DeleteDomainPermissionsPolicyResultPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteDomainPermissionsPolicyResultPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDomainPermissionsPolicyResultPolicy} obj Optional instance to populate.
     * @return {module:model/DeleteDomainPermissionsPolicyResultPolicy} The populated <code>DeleteDomainPermissionsPolicyResultPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDomainPermissionsPolicyResultPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDomainPermissionsPolicyResultPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDomainPermissionsPolicyResultPolicy</code>.
     */
 ...
 */
DeleteDomainPermissionsPolicyResultPolicy.prototype['resourceArn'] = undefined;

/**
 * @member {String} revision
 */
DeleteDomainPermissionsPolicyResultPolicy.prototype['revision'] = undefined;

/**
 * @member {String} document
 */
DeleteDomainPermissionsPolicyResultPolicy.prototype['document'] = undefined;
...
export default DeleteDomainPermissionsPolicyResultPolicy;
