...
import DescribePackageVersionResultPackageVersion from './DescribePackageVersionResultPackageVersion';

/**
 * The DescribePackageVersionResult model module.
 * @module model/DescribePackageVersionResult
 * @version 2018-09-22
 */
class DescribePackageVersionResult {
    /**
     * Constructs a new <code>DescribePackageVersionResult</code>.
     * @alias module:model/DescribePackageVersionResult
     * @param packageVersion {module:model/DescribePackageVersionResultPackageVersion} 
     */
    constructor(packageVersion) { 
        
        DescribePackageVersionResult.initialize(this, packageVersion);
    }
     ...
     */
    static initialize(obj, packageVersion) { 
        obj['packageVersion'] = packageVersion;
    }

    /**
     * Constructs a <code>DescribePackageVersionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePackageVersionResult} obj Optional instance to populate.
     * @return {module:model/DescribePackageVersionResult} The populated <code>DescribePackageVersionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePackageVersionResult();

            if (data.hasOwnProperty('packageVersion')) {
                obj['packageVersion'] = DescribePackageVersionResultPackageVersion.constructFromObject(data['packageVersion']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePackageVersionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePackageVersionResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePackageVersionResult.RequiredProperties) {
        ...
        if (data['packageVersion']) { // data not null
          DescribePackageVersionResultPackageVersion.validateJSON(data['packageVersion']);
        }
...
DescribePackageVersionResult.RequiredProperties = ["packageVersion"];

/**
 * @member {module:model/DescribePackageVersionResultPackageVersion} packageVersion
 */
DescribePackageVersionResult.prototype['packageVersion'] = undefined;
...
export default DescribePackageVersionResult;
