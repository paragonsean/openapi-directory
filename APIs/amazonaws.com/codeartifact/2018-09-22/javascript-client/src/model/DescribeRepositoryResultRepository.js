...
/**
 * The DescribeRepositoryResultRepository model module.
 * @module model/DescribeRepositoryResultRepository
 * @version 2018-09-22
 */
class DescribeRepositoryResultRepository {
    /**
     * Constructs a new <code>DescribeRepositoryResultRepository</code>.
     * @alias module:model/DescribeRepositoryResultRepository
     * @implements module:model/RepositoryDescription
     */
    constructor() { 
        RepositoryDescription.initialize(this);
        DescribeRepositoryResultRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeRepositoryResultRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRepositoryResultRepository} obj Optional instance to populate.
     * @return {module:model/DescribeRepositoryResultRepository} The populated <code>DescribeRepositoryResultRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRepositoryResultRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRepositoryResultRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRepositoryResultRepository</code>.
     */
 ...
 * @member {String} name
 */
DescribeRepositoryResultRepository.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
DescribeRepositoryResultRepository.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
DescribeRepositoryResultRepository.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
DescribeRepositoryResultRepository.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
DescribeRepositoryResultRepository.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
DescribeRepositoryResultRepository.prototype['description'] = undefined;

/**
 * @member {Array} upstreams
 */
DescribeRepositoryResultRepository.prototype['upstreams'] = undefined;

/**
 * @member {Array} externalConnections
 */
DescribeRepositoryResultRepository.prototype['externalConnections'] = undefined;

/**
 * @member {Date} createdTime
 */
DescribeRepositoryResultRepository.prototype['createdTime'] = undefined;
...
export default DescribeRepositoryResultRepository;
