...
/**
 * The DomainDescription model module.
 * @module model/DomainDescription
 * @version 2018-09-22
 */
class DomainDescription {
    /**
     * Constructs a new <code>DomainDescription</code>.
     *  Information about a domain. A domain is a container for repositories. When you create a domain, it is empty until you add one or more repositories. 
     * @alias module:model/DomainDescription
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DomainDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainDescription} obj Optional instance to populate.
     * @return {module:model/DomainDescription} The populated <code>DomainDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainDescription</code>.
     */
