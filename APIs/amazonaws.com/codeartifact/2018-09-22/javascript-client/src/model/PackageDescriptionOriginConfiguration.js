...
/**
 * The PackageDescriptionOriginConfiguration model module.
 * @module model/PackageDescriptionOriginConfiguration
 * @version 2018-09-22
 */
class PackageDescriptionOriginConfiguration {
    /**
     * Constructs a new <code>PackageDescriptionOriginConfiguration</code>.
     * @alias module:model/PackageDescriptionOriginConfiguration
     * @implements module:model/PackageOriginConfiguration
     */
    constructor() { 
        PackageOriginConfiguration.initialize(this);
        PackageDescriptionOriginConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageDescriptionOriginConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageDescriptionOriginConfiguration} obj Optional instance to populate.
     * @return {module:model/PackageDescriptionOriginConfiguration} The populated <code>PackageDescriptionOriginConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageDescriptionOriginConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageDescriptionOriginConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageDescriptionOriginConfiguration</code>.
     */
 ...
 */
PackageDescriptionOriginConfiguration.prototype['restrictions'] = undefined;
...
export default PackageDescriptionOriginConfiguration;
