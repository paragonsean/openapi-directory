...
/**
 * The PutDomainPermissionsPolicyRequest model module.
 * @module model/PutDomainPermissionsPolicyRequest
 * @version 2018-09-22
 */
class PutDomainPermissionsPolicyRequest {
    /**
     * Constructs a new <code>PutDomainPermissionsPolicyRequest</code>.
     * @alias module:model/PutDomainPermissionsPolicyRequest
     * @param domain {String}  The name of the domain on which to set the resource policy. 
     * @param policyDocument {String}  A valid displayable JSON Aspen policy string to be set as the access control resource policy on the provided domain. 
     */
    constructor(domain, policyDocument) { 
        
        PutDomainPermissionsPolicyRequest.initialize(this, domain, policyDocument);
    }
     ...
     */
    static initialize(obj, domain, policyDocument) { 
        obj['domain'] = domain;
        obj['policyDocument'] = policyDocument;
    }

    /**
     * Constructs a <code>PutDomainPermissionsPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutDomainPermissionsPolicyRequest} obj Optional instance to populate.
     * @return {module:model/PutDomainPermissionsPolicyRequest} The populated <code>PutDomainPermissionsPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutDomainPermissionsPolicyRequest();
            ...
            if (data.hasOwnProperty('policyRevision')) {
                obj['policyRevision'] = ApiClient.convertToType(data['policyRevision'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PutDomainPermissionsPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutDomainPermissionsPolicyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutDomainPermissionsPolicyRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['domainOwner'] && !(typeof data['domainOwner'] === 'string' || data['domainOwner'] instanceof String)) {
            throw new Error("Expected the field `domainOwner` to be a primitive type in the JSON string but got " + data['domainOwner']);
        }
        // ensure the json data is a string
        if (data['policyRevision'] && !(typeof data['policyRevision'] === 'string' || data['policyRevision'] instanceof String)) {
            throw new Error("Expected the field `policyRevision` to be a primitive type in the JSON string but got " + data['policyRevision']);
        }
        // ensure the json data is a string
...
PutDomainPermissionsPolicyRequest.RequiredProperties = ["domain", "policyDocument"];

/**
 *  The name of the domain on which to set the resource policy. 
 * @member {String} domain
 */
PutDomainPermissionsPolicyRequest.prototype['domain'] = undefined;

/**
 *  The 12-digit account number of the Amazon Web Services account that owns the domain. It does not include dashes or spaces. 
 * @member {String} domainOwner
 */
PutDomainPermissionsPolicyRequest.prototype['domainOwner'] = undefined;

/**
 *  The current revision of the resource policy to be set. This revision is used for optimistic locking, which prevents others from overwriting your changes to the domain's resource policy. 
 * @member {String} policyRevision
 */
PutDomainPermissionsPolicyRequest.prototype['policyRevision'] = undefined;

/**
 *  A valid displayable JSON Aspen policy string to be set as the access control resource policy on the provided domain. 
 * @member {String} policyDocument
 */
PutDomainPermissionsPolicyRequest.prototype['policyDocument'] = undefined;
...
export default PutDomainPermissionsPolicyRequest;
