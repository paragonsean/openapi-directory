...
/**
 * The DeleteRepositoryPermissionsPolicyResultPolicy model module.
 * @module model/DeleteRepositoryPermissionsPolicyResultPolicy
 * @version 2018-09-22
 */
class DeleteRepositoryPermissionsPolicyResultPolicy {
    /**
     * Constructs a new <code>DeleteRepositoryPermissionsPolicyResultPolicy</code>.
     * @alias module:model/DeleteRepositoryPermissionsPolicyResultPolicy
     * @implements module:model/ResourcePolicy
     */
    constructor() { 
        ResourcePolicy.initialize(this);
        DeleteRepositoryPermissionsPolicyResultPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteRepositoryPermissionsPolicyResultPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteRepositoryPermissionsPolicyResultPolicy} obj Optional instance to populate.
     * @return {module:model/DeleteRepositoryPermissionsPolicyResultPolicy} The populated <code>DeleteRepositoryPermissionsPolicyResultPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteRepositoryPermissionsPolicyResultPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteRepositoryPermissionsPolicyResultPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteRepositoryPermissionsPolicyResultPolicy</code>.
     */
    static validateJSON(data) {
        ...
        if (data['revision']) { // data not null
          String.validateJSON(data['revision']);
        }
 ...
 */
DeleteRepositoryPermissionsPolicyResultPolicy.prototype['resourceArn'] = undefined;

/**
 * @member {String} revision
 */
DeleteRepositoryPermissionsPolicyResultPolicy.prototype['revision'] = undefined;

/**
 * @member {String} document
 */
DeleteRepositoryPermissionsPolicyResultPolicy.prototype['document'] = undefined;
 ...
 * @member {String} resourceArn
 */
ResourcePolicy.prototype['resourceArn'] = undefined;
/**
 * @member {String} revision
 */
ResourcePolicy.prototype['revision'] = undefined;
/**
 * @member {String} document
 */
ResourcePolicy.prototype['document'] = undefined;




export default DeleteRepositoryPermissionsPolicyResultPolicy;
