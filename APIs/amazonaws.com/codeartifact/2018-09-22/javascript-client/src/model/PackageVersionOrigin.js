...
import PackageVersionOriginDomainEntryPoint from './PackageVersionOriginDomainEntryPoint';
import PackageVersionOriginType from './PackageVersionOriginType';

/**
 * The PackageVersionOrigin model module.
 * @module model/PackageVersionOrigin
 * @version 2018-09-22
 */
class PackageVersionOrigin {
    /**
     * Constructs a new <code>PackageVersionOrigin</code>.
     * Information about how a package version was added to a repository.
     * @alias module:model/PackageVersionOrigin
     */
    constructor() { 
        
        PackageVersionOrigin.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageVersionOrigin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageVersionOrigin} obj Optional instance to populate.
     * @return {module:model/PackageVersionOrigin} The populated <code>PackageVersionOrigin</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageVersionOrigin();

            if (data.hasOwnProperty('domainEntryPoint')) {
                obj['domainEntryPoint'] = PackageVersionOriginDomainEntryPoint.constructFromObject(data['domainEntryPoint']);
            }
            if (data.hasOwnProperty('originType')) {
                obj['originType'] = ApiClient.convertToType(data['originType'], PackageVersionOriginType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PackageVersionOrigin</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageVersionOrigin</code>.
     */
    static validateJSON(data) {
        // validate the optional field `domainEntryPoint`
        if (data['domainEntryPoint']) { // data not null
          PackageVersionOriginDomainEntryPoint.validateJSON(data['domainEntryPoint']);
        }
        // validate the optional field `originType`
        if (data['originType']) { // data not null
          PackageVersionOriginType.validateJSON(data['originType']);
        }
...
/**
 * @member {module:model/PackageVersionOriginDomainEntryPoint} domainEntryPoint
 */
PackageVersionOrigin.prototype['domainEntryPoint'] = undefined;

/**
 * @member {module:model/PackageVersionOriginType} originType
 */
PackageVersionOrigin.prototype['originType'] = undefined;
...
export default PackageVersionOrigin;
