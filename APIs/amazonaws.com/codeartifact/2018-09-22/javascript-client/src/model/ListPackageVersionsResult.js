...
/**
 * The ListPackageVersionsResult model module.
 * @module model/ListPackageVersionsResult
 * @version 2018-09-22
 */
class ListPackageVersionsResult {
    /**
     * Constructs a new <code>ListPackageVersionsResult</code>.
     * @alias module:model/ListPackageVersionsResult
     */
    constructor() { 
        
        ListPackageVersionsResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPackageVersionsResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPackageVersionsResult} obj Optional instance to populate.
     * @return {module:model/ListPackageVersionsResult} The populated <code>ListPackageVersionsResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPackageVersionsResult();

            if (data.hasOwnProperty('defaultDisplayVersion')) {
                obj['defaultDisplayVersion'] = ApiClient.convertToType(data['defaultDisplayVersion'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPackageVersionsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPackageVersionsResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `defaultDisplayVersion`
        if (data['defaultDisplayVersion']) { // data not null
          String.validateJSON(data['defaultDisplayVersion']);
        }
        ...
        if (data['package']) { // data not null
          String.validateJSON(data['package']);
        }
...
/**
 * @member {String} defaultDisplayVersion
 */
ListPackageVersionsResult.prototype['defaultDisplayVersion'] = undefined;

/**
 * @member {module:model/PackageFormat} format
 */
ListPackageVersionsResult.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
ListPackageVersionsResult.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
ListPackageVersionsResult.prototype['package'] = undefined;

/**
 * @member {Array} versions
 */
ListPackageVersionsResult.prototype['versions'] = undefined;

/**
 * @member {String} nextToken
 */
ListPackageVersionsResult.prototype['nextToken'] = undefined;
...
export default ListPackageVersionsResult;
