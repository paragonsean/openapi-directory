...
/**
 * The DisassociateExternalConnectionResultRepository model module.
 * @module model/DisassociateExternalConnectionResultRepository
 * @version 2018-09-22
 */
class DisassociateExternalConnectionResultRepository {
    /**
     * Constructs a new <code>DisassociateExternalConnectionResultRepository</code>.
     * @alias module:model/DisassociateExternalConnectionResultRepository
     * @implements module:model/RepositoryDescription
     */
    constructor() { 
        RepositoryDescription.initialize(this);
        DisassociateExternalConnectionResultRepository.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisassociateExternalConnectionResultRepository</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisassociateExternalConnectionResultRepository} obj Optional instance to populate.
     * @return {module:model/DisassociateExternalConnectionResultRepository} The populated <code>DisassociateExternalConnectionResultRepository</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisassociateExternalConnectionResultRepository();
    ...
    /**
     * Validates the JSON data with respect to <code>DisassociateExternalConnectionResultRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisassociateExternalConnectionResultRepository</code>.
     */
 ...
 * @member {String} name
 */
DisassociateExternalConnectionResultRepository.prototype['name'] = undefined;

/**
 * @member {String} administratorAccount
 */
DisassociateExternalConnectionResultRepository.prototype['administratorAccount'] = undefined;

/**
 * @member {String} domainName
 */
DisassociateExternalConnectionResultRepository.prototype['domainName'] = undefined;

/**
 * @member {String} domainOwner
 */
DisassociateExternalConnectionResultRepository.prototype['domainOwner'] = undefined;

/**
 * @member {String} arn
 */
DisassociateExternalConnectionResultRepository.prototype['arn'] = undefined;

/**
 * @member {String} description
 */
DisassociateExternalConnectionResultRepository.prototype['description'] = undefined;

/**
 * @member {Array} upstreams
 */
DisassociateExternalConnectionResultRepository.prototype['upstreams'] = undefined;

/**
 * @member {Array} externalConnections
 */
DisassociateExternalConnectionResultRepository.prototype['externalConnections'] = undefined;

/**
 * @member {Date} createdTime
 */
DisassociateExternalConnectionResultRepository.prototype['createdTime'] = undefined;
...
export default DisassociateExternalConnectionResultRepository;
