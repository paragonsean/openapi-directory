...
/**
 * The ListPackagesResult model module.
 * @module model/ListPackagesResult
 * @version 2018-09-22
 */
class ListPackagesResult {
    /**
     * Constructs a new <code>ListPackagesResult</code>.
     * @alias module:model/ListPackagesResult
     */
    constructor() { 
        
        ListPackagesResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPackagesResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPackagesResult} obj Optional instance to populate.
     * @return {module:model/ListPackagesResult} The populated <code>ListPackagesResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPackagesResult();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPackagesResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPackagesResult</code>.
     */
 ...
 */
ListPackagesResult.prototype['packages'] = undefined;

/**
 * @member {String} nextToken
 */
ListPackagesResult.prototype['nextToken'] = undefined;
...
export default ListPackagesResult;
