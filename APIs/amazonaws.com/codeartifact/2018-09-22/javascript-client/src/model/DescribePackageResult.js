...
import DescribePackageResultPackage from './DescribePackageResultPackage';

/**
 * The DescribePackageResult model module.
 * @module model/DescribePackageResult
 * @version 2018-09-22
 */
class DescribePackageResult {
    /**
     * Constructs a new <code>DescribePackageResult</code>.
     * @alias module:model/DescribePackageResult
     * @param _package {module:model/DescribePackageResultPackage} 
     */
    constructor(_package) { 
        
        DescribePackageResult.initialize(this, _package);
    }
    ...
    /**
     * Constructs a <code>DescribePackageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribePackageResult} obj Optional instance to populate.
     * @return {module:model/DescribePackageResult} The populated <code>DescribePackageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribePackageResult();

            if (data.hasOwnProperty('package')) {
                obj['package'] = DescribePackageResultPackage.constructFromObject(data['package']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribePackageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribePackageResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribePackageResult.RequiredProperties) {
        ...
        if (data['package']) { // data not null
          DescribePackageResultPackage.validateJSON(data['package']);
        }
...
DescribePackageResult.RequiredProperties = ["package"];

/**
 * @member {module:model/DescribePackageResultPackage} package
 */
DescribePackageResult.prototype['package'] = undefined;
...
export default DescribePackageResult;
