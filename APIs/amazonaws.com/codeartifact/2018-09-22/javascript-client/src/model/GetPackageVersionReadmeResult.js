...
/**
 * The GetPackageVersionReadmeResult model module.
 * @module model/GetPackageVersionReadmeResult
 * @version 2018-09-22
 */
class GetPackageVersionReadmeResult {
    /**
     * Constructs a new <code>GetPackageVersionReadmeResult</code>.
     * @alias module:model/GetPackageVersionReadmeResult
     */
    constructor() { 
        
        GetPackageVersionReadmeResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPackageVersionReadmeResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPackageVersionReadmeResult} obj Optional instance to populate.
     * @return {module:model/GetPackageVersionReadmeResult} The populated <code>GetPackageVersionReadmeResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPackageVersionReadmeResult();
            ...
            if (data.hasOwnProperty('versionRevision')) {
                obj['versionRevision'] = ApiClient.convertToType(data['versionRevision'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPackageVersionReadmeResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPackageVersionReadmeResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['versionRevision']) { // data not null
          String.validateJSON(data['versionRevision']);
        }
        // validate the optional field `readme`
        if (data['readme']) { // data not null
          String.validateJSON(data['readme']);
        }
 ...
 */
GetPackageVersionReadmeResult.prototype['format'] = undefined;

/**
 * @member {String} namespace
 */
GetPackageVersionReadmeResult.prototype['namespace'] = undefined;

/**
 * @member {String} package
 */
GetPackageVersionReadmeResult.prototype['package'] = undefined;

/**
 * @member {String} version
 */
GetPackageVersionReadmeResult.prototype['version'] = undefined;

/**
 * @member {String} versionRevision
 */
GetPackageVersionReadmeResult.prototype['versionRevision'] = undefined;

/**
 * @member {String} readme
 */
GetPackageVersionReadmeResult.prototype['readme'] = undefined;
...
export default GetPackageVersionReadmeResult;
