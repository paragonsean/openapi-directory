...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeletePackageResult();
  });
  ...
  describe('DeletePackageResult', function() {
    it('should create an instance of DeletePackageResult', function() {
      // uncomment below and update the code to test DeletePackageResult
      //var instance = new CodeArtifact.DeletePackageResult();
      //expect(instance).to.be.a(CodeArtifact.DeletePackageResult);
    });

    it('should have the property deletedPackage (base name: "deletedPackage")', function() {
      // uncomment below and update the code to test the property deletedPackage
      //var instance = new CodeArtifact.DeletePackageResult();
