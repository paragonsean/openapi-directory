...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.GetDomainPermissionsPolicyResult();
  });
  ...
  describe('GetDomainPermissionsPolicyResult', function() {
    it('should create an instance of GetDomainPermissionsPolicyResult', function() {
      // uncomment below and update the code to test GetDomainPermissionsPolicyResult
      //var instance = new CodeArtifact.GetDomainPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.GetDomainPermissionsPolicyResult);
    });
