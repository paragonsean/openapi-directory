...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.CodeArtifact);
  }
}(this, function(expect, CodeArtifact) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new CodeArtifact.UpdatePackageVersionsStatusResult();
  });
  ...
  describe('UpdatePackageVersionsStatusResult', function() {
    it('should create an instance of UpdatePackageVersionsStatusResult', function() {
      // uncomment below and update the code to test UpdatePackageVersionsStatusResult
      //var instance = new CodeArtifact.UpdatePackageVersionsStatusResult();
      //expect(instance).to.be.a(CodeArtifact.UpdatePackageVersionsStatusResult);
    });

    it('should have the property successfulVersions (base name: "successfulVersions")', function() {
      // uncomment below and update the code to test the property successfulVersions
      //var instance = new CodeArtifact.UpdatePackageVersionsStatusResult();
      //expect(instance).to.be();
    });

    it('should have the property failedVersions (base name: "failedVersions")', function() {
      // uncomment below and update the code to test the property failedVersions
      //var instance = new CodeArtifact.UpdatePackageVersionsStatusResult();
      //expect(instance).to.be();
    });
