...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteRepositoryPermissionsPolicyResultPolicy();
  });
  ...
  describe('DeleteRepositoryPermissionsPolicyResultPolicy', function() {
    it('should create an instance of DeleteRepositoryPermissionsPolicyResultPolicy', function() {
      // uncomment below and update the code to test DeleteRepositoryPermissionsPolicyResultPolicy
      //var instance = new CodeArtifact.DeleteRepositoryPermissionsPolicyResultPolicy();
      //expect(instance).to.be.a(CodeArtifact.DeleteRepositoryPermissionsPolicyResultPolicy);
    });
