...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PublishPackageVersionResult();
  });
  ...
  describe('PublishPackageVersionResult', function() {
    it('should create an instance of PublishPackageVersionResult', function() {
      // uncomment below and update the code to test PublishPackageVersionResult
      //var instance = new CodeArtifact.PublishPackageVersionResult();
      //expect(instance).to.be.a(CodeArtifact.PublishPackageVersionResult);
    });
    ...
    it('should have the property versionRevision (base name: "versionRevision")', function() {
      // uncomment below and update the code to test the property versionRevision
      //var instance = new CodeArtifact.PublishPackageVersionResult();
      //expect(instance).to.be();
    });
