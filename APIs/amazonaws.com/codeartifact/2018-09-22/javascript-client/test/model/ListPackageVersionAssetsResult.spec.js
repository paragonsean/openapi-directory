...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListPackageVersionAssetsResult();
  });
  ...
  describe('ListPackageVersionAssetsResult', function() {
    it('should create an instance of ListPackageVersionAssetsResult', function() {
      // uncomment below and update the code to test ListPackageVersionAssetsResult
      //var instance = new CodeArtifact.ListPackageVersionAssetsResult();
      //expect(instance).to.be.a(CodeArtifact.ListPackageVersionAssetsResult);
    });
