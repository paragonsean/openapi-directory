...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteDomainResultDomain();
  });
  ...
  describe('DeleteDomainResultDomain', function() {
    it('should create an instance of DeleteDomainResultDomain', function() {
      // uncomment below and update the code to test DeleteDomainResultDomain
      //var instance = new CodeArtifact.DeleteDomainResultDomain();
      //expect(instance).to.be.a(CodeArtifact.DeleteDomainResultDomain);
    });
    ...
    it('should have the property repositoryCount (base name: "repositoryCount")', function() {
      // uncomment below and update the code to test the property repositoryCount
      //var instance = new CodeArtifact.DeleteDomainResultDomain();
      //expect(instance).to.be();
    });

    it('should have the property assetSizeBytes (base name: "assetSizeBytes")', function() {
      // uncomment below and update the code to test the property assetSizeBytes
      //var instance = new CodeArtifact.DeleteDomainResultDomain();
      //expect(instance).to.be();
    });
