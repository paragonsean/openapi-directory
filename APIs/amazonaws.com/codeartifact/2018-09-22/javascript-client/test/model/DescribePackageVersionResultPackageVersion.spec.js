...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribePackageVersionResultPackageVersion();
  });
  ...
  describe('DescribePackageVersionResultPackageVersion', function() {
    it('should create an instance of DescribePackageVersionResultPackageVersion', function() {
      // uncomment below and update the code to test DescribePackageVersionResultPackageVersion
      //var instance = new CodeArtifact.DescribePackageVersionResultPackageVersion();
      //expect(instance).to.be.a(CodeArtifact.DescribePackageVersionResultPackageVersion);
    });
