...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.GetDomainPermissionsPolicyResultPolicy();
  });
  ...
  describe('GetDomainPermissionsPolicyResultPolicy', function() {
    it('should create an instance of GetDomainPermissionsPolicyResultPolicy', function() {
      // uncomment below and update the code to test GetDomainPermissionsPolicyResultPolicy
      //var instance = new CodeArtifact.GetDomainPermissionsPolicyResultPolicy();
      //expect(instance).to.be.a(CodeArtifact.GetDomainPermissionsPolicyResultPolicy);
    });
