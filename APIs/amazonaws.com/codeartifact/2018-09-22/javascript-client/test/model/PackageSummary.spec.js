...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageSummary();
  });
  ...
  describe('PackageSummary', function() {
    it('should create an instance of PackageSummary', function() {
      // uncomment below and update the code to test PackageSummary
      //var instance = new CodeArtifact.PackageSummary();
      //expect(instance).to.be.a(CodeArtifact.PackageSummary);
    });
    ...
    it('should have the property originConfiguration (base name: "originConfiguration")', function() {
      // uncomment below and update the code to test the property originConfiguration
      //var instance = new CodeArtifact.PackageSummary();
      //expect(instance).to.be();
    });
