...
(function(root, factory) {
  ...
  describe('AllowUpstream', function() {
    it('should create an instance of AllowUpstream', function() {
      // uncomment below and update the code to test AllowUpstream
      //var instance = new CodeArtifact.AllowUpstream();
      //expect(instance).to.be.a(CodeArtifact.AllowUpstream);
    });
