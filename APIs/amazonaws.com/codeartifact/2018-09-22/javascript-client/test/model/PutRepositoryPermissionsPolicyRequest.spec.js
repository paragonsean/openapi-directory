...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutRepositoryPermissionsPolicyRequest();
  });
  ...
  describe('PutRepositoryPermissionsPolicyRequest', function() {
    it('should create an instance of PutRepositoryPermissionsPolicyRequest', function() {
      // uncomment below and update the code to test PutRepositoryPermissionsPolicyRequest
      //var instance = new CodeArtifact.PutRepositoryPermissionsPolicyRequest();
      //expect(instance).to.be.a(CodeArtifact.PutRepositoryPermissionsPolicyRequest);
    });
