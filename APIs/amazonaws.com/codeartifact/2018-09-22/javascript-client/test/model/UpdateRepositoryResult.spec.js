...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpdateRepositoryResult();
  });
  ...
  describe('UpdateRepositoryResult', function() {
    it('should create an instance of UpdateRepositoryResult', function() {
      // uncomment below and update the code to test UpdateRepositoryResult
      //var instance = new CodeArtifact.UpdateRepositoryResult();
      //expect(instance).to.be.a(CodeArtifact.UpdateRepositoryResult);
    });
