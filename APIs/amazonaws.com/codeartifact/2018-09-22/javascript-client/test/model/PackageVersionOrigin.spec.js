...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionOrigin();
  });
  ...
  describe('PackageVersionOrigin', function() {
    it('should create an instance of PackageVersionOrigin', function() {
      // uncomment below and update the code to test PackageVersionOrigin
      //var instance = new CodeArtifact.PackageVersionOrigin();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionOrigin);
    });

    it('should have the property domainEntryPoint (base name: "domainEntryPoint")', function() {
      // uncomment below and update the code to test the property domainEntryPoint
      //var instance = new CodeArtifact.PackageVersionOrigin();
