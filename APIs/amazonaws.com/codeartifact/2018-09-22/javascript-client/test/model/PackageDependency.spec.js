...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageDependency();
  });
  ...
  describe('PackageDependency', function() {
    it('should create an instance of PackageDependency', function() {
      // uncomment below and update the code to test PackageDependency
      //var instance = new CodeArtifact.PackageDependency();
      //expect(instance).to.be.a(CodeArtifact.PackageDependency);
    });
    ...
    it('should have the property versionRequirement (base name: "versionRequirement")', function() {
      // uncomment below and update the code to test the property versionRequirement
      //var instance = new CodeArtifact.PackageDependency();
      //expect(instance).to.be();
    });
