...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionError();
  });
  ...
  describe('PackageVersionError', function() {
    it('should create an instance of PackageVersionError', function() {
      // uncomment below and update the code to test PackageVersionError
      //var instance = new CodeArtifact.PackageVersionError();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionError);
    });
