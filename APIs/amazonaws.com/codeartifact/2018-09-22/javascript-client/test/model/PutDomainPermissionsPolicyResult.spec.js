...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutDomainPermissionsPolicyResult();
  });
  ...
  describe('PutDomainPermissionsPolicyResult', function() {
    it('should create an instance of PutDomainPermissionsPolicyResult', function() {
      // uncomment below and update the code to test PutDomainPermissionsPolicyResult
      //var instance = new CodeArtifact.PutDomainPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.PutDomainPermissionsPolicyResult);
    });
