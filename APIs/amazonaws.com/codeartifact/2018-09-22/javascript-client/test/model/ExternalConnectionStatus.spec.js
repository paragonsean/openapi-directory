...
(function(root, factory) {
  ...
  describe('ExternalConnectionStatus', function() {
    it('should create an instance of ExternalConnectionStatus', function() {
      // uncomment below and update the code to test ExternalConnectionStatus
      //var instance = new CodeArtifact.ExternalConnectionStatus();
      //expect(instance).to.be.a(CodeArtifact.ExternalConnectionStatus);
    });
