...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PublishPackageVersionResultAsset();
  });
  ...
  describe('PublishPackageVersionResultAsset', function() {
    it('should create an instance of PublishPackageVersionResultAsset', function() {
      // uncomment below and update the code to test PublishPackageVersionResultAsset
      //var instance = new CodeArtifact.PublishPackageVersionResultAsset();
      //expect(instance).to.be.a(CodeArtifact.PublishPackageVersionResultAsset);
    });
