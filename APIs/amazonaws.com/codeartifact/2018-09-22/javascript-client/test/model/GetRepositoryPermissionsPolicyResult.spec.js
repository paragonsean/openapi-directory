...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.GetRepositoryPermissionsPolicyResult();
  });
  ...
  describe('GetRepositoryPermissionsPolicyResult', function() {
    it('should create an instance of GetRepositoryPermissionsPolicyResult', function() {
      // uncomment below and update the code to test GetRepositoryPermissionsPolicyResult
      //var instance = new CodeArtifact.GetRepositoryPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.GetRepositoryPermissionsPolicyResult);
    });
