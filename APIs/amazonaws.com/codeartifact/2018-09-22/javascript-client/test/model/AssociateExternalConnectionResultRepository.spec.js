...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.AssociateExternalConnectionResultRepository();
  });
  ...
  describe('AssociateExternalConnectionResultRepository', function() {
    it('should create an instance of AssociateExternalConnectionResultRepository', function() {
      // uncomment below and update the code to test AssociateExternalConnectionResultRepository
      //var instance = new CodeArtifact.AssociateExternalConnectionResultRepository();
      //expect(instance).to.be.a(CodeArtifact.AssociateExternalConnectionResultRepository);
    });
