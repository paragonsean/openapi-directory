...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribeRepositoryResultRepository();
  });
  ...
  describe('DescribeRepositoryResultRepository', function() {
    it('should create an instance of DescribeRepositoryResultRepository', function() {
      // uncomment below and update the code to test DescribeRepositoryResultRepository
      //var instance = new CodeArtifact.DescribeRepositoryResultRepository();
      //expect(instance).to.be.a(CodeArtifact.DescribeRepositoryResultRepository);
    });
