...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DisassociateExternalConnectionResult();
  });
  ...
  describe('DisassociateExternalConnectionResult', function() {
    it('should create an instance of DisassociateExternalConnectionResult', function() {
      // uncomment below and update the code to test DisassociateExternalConnectionResult
      //var instance = new CodeArtifact.DisassociateExternalConnectionResult();
      //expect(instance).to.be.a(CodeArtifact.DisassociateExternalConnectionResult);
    });
