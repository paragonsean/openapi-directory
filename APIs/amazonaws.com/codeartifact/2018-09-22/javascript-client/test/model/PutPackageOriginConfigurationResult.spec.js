...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutPackageOriginConfigurationResult();
  });
  ...
  describe('PutPackageOriginConfigurationResult', function() {
    it('should create an instance of PutPackageOriginConfigurationResult', function() {
      // uncomment below and update the code to test PutPackageOriginConfigurationResult
      //var instance = new CodeArtifact.PutPackageOriginConfigurationResult();
      //expect(instance).to.be.a(CodeArtifact.PutPackageOriginConfigurationResult);
    });
