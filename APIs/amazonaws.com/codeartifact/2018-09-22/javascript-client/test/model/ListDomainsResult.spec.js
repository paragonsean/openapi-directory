...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListDomainsResult();
  });
  ...
  describe('ListDomainsResult', function() {
    it('should create an instance of ListDomainsResult', function() {
      // uncomment below and update the code to test ListDomainsResult
      //var instance = new CodeArtifact.ListDomainsResult();
      //expect(instance).to.be.a(CodeArtifact.ListDomainsResult);
    });
