...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateDomainRequest();
  });
  ...
  describe('CreateDomainRequest', function() {
    it('should create an instance of CreateDomainRequest', function() {
      ...
      //var instance = new CodeArtifact.CreateDomainRequest();
      //expect(instance).to.be.a(CodeArtifact.CreateDomainRequest);
    });
