...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListPackagesResult();
  });
  ...
  describe('ListPackagesResult', function() {
    it('should create an instance of ListPackagesResult', function() {
      // uncomment below and update the code to test ListPackagesResult
      //var instance = new CodeArtifact.ListPackagesResult();
      //expect(instance).to.be.a(CodeArtifact.ListPackagesResult);
    });
