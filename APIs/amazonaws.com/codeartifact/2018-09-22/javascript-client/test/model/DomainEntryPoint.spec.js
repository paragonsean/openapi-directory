...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DomainEntryPoint();
  });
  ...
  describe('DomainEntryPoint', function() {
    it('should create an instance of DomainEntryPoint', function() {
      // uncomment below and update the code to test DomainEntryPoint
      //var instance = new CodeArtifact.DomainEntryPoint();
      //expect(instance).to.be.a(CodeArtifact.DomainEntryPoint);
    });
