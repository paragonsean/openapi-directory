...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpdateRepositoryResultRepository();
  });
  ...
  describe('UpdateRepositoryResultRepository', function() {
    it('should create an instance of UpdateRepositoryResultRepository', function() {
      // uncomment below and update the code to test UpdateRepositoryResultRepository
      //var instance = new CodeArtifact.UpdateRepositoryResultRepository();
      //expect(instance).to.be.a(CodeArtifact.UpdateRepositoryResultRepository);
    });
