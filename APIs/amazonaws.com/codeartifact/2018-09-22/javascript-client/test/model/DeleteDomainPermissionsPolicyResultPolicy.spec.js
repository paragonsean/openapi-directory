...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteDomainPermissionsPolicyResultPolicy();
  });
  ...
  describe('DeleteDomainPermissionsPolicyResultPolicy', function() {
    it('should create an instance of DeleteDomainPermissionsPolicyResultPolicy', function() {
      // uncomment below and update the code to test DeleteDomainPermissionsPolicyResultPolicy
      //var instance = new CodeArtifact.DeleteDomainPermissionsPolicyResultPolicy();
      //expect(instance).to.be.a(CodeArtifact.DeleteDomainPermissionsPolicyResultPolicy);
    });
