...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutDomainPermissionsPolicyResultPolicy();
  });
  ...
  describe('PutDomainPermissionsPolicyResultPolicy', function() {
    it('should create an instance of PutDomainPermissionsPolicyResultPolicy', function() {
      // uncomment below and update the code to test PutDomainPermissionsPolicyResultPolicy
      //var instance = new CodeArtifact.PutDomainPermissionsPolicyResultPolicy();
      //expect(instance).to.be.a(CodeArtifact.PutDomainPermissionsPolicyResultPolicy);
    });
