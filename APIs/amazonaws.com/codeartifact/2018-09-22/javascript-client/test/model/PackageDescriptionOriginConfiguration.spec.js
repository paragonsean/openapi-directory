...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageDescriptionOriginConfiguration();
  });
  ...
  describe('PackageDescriptionOriginConfiguration', function() {
    it('should create an instance of PackageDescriptionOriginConfiguration', function() {
      // uncomment below and update the code to test PackageDescriptionOriginConfiguration
      //var instance = new CodeArtifact.PackageDescriptionOriginConfiguration();
      //expect(instance).to.be.a(CodeArtifact.PackageDescriptionOriginConfiguration);
    });
