...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteDomainResult();
  });
  ...
  describe('DeleteDomainResult', function() {
    it('should create an instance of DeleteDomainResult', function() {
      // uncomment below and update the code to test DeleteDomainResult
      //var instance = new CodeArtifact.DeleteDomainResult();
      //expect(instance).to.be.a(CodeArtifact.DeleteDomainResult);
    });
