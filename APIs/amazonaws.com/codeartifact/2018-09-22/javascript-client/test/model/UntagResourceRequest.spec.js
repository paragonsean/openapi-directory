...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new CodeArtifact.UntagResourceRequest();
      //expect(instance).to.be.a(CodeArtifact.UntagResourceRequest);
    });
