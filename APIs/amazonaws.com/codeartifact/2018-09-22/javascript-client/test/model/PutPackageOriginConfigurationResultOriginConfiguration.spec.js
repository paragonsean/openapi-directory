...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutPackageOriginConfigurationResultOriginConfiguration();
  });
  ...
  describe('PutPackageOriginConfigurationResultOriginConfiguration', function() {
    it('should create an instance of PutPackageOriginConfigurationResultOriginConfiguration', function() {
      // uncomment below and update the code to test PutPackageOriginConfigurationResultOriginConfiguration
      //var instance = new CodeArtifact.PutPackageOriginConfigurationResultOriginConfiguration();
      //expect(instance).to.be.a(CodeArtifact.PutPackageOriginConfigurationResultOriginConfiguration);
    });
