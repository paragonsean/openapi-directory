...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageOriginConfigurationRestrictions();
  });
  ...
  describe('PackageOriginConfigurationRestrictions', function() {
    it('should create an instance of PackageOriginConfigurationRestrictions', function() {
      // uncomment below and update the code to test PackageOriginConfigurationRestrictions
      //var instance = new CodeArtifact.PackageOriginConfigurationRestrictions();
      //expect(instance).to.be.a(CodeArtifact.PackageOriginConfigurationRestrictions);
    });
