...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutPackageOriginConfigurationRequestRestrictions();
  });
  ...
  describe('PutPackageOriginConfigurationRequestRestrictions', function() {
    it('should create an instance of PutPackageOriginConfigurationRequestRestrictions', function() {
      // uncomment below and update the code to test PutPackageOriginConfigurationRequestRestrictions
      //var instance = new CodeArtifact.PutPackageOriginConfigurationRequestRestrictions();
      //expect(instance).to.be.a(CodeArtifact.PutPackageOriginConfigurationRequestRestrictions);
    });
