...
(function(root, factory) {
  ...
  describe('PackageVersionStatus', function() {
    it('should create an instance of PackageVersionStatus', function() {
      // uncomment below and update the code to test PackageVersionStatus
      //var instance = new CodeArtifact.PackageVersionStatus();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionStatus);
    });
