...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageOriginConfiguration();
  });
  ...
  describe('PackageOriginConfiguration', function() {
    it('should create an instance of PackageOriginConfiguration', function() {
      // uncomment below and update the code to test PackageOriginConfiguration
      //var instance = new CodeArtifact.PackageOriginConfiguration();
      //expect(instance).to.be.a(CodeArtifact.PackageOriginConfiguration);
    });
