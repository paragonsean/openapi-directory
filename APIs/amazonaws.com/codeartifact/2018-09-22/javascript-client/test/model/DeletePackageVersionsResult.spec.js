...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeletePackageVersionsResult();
  });
  ...
  describe('DeletePackageVersionsResult', function() {
    it('should create an instance of DeletePackageVersionsResult', function() {
      // uncomment below and update the code to test DeletePackageVersionsResult
      //var instance = new CodeArtifact.DeletePackageVersionsResult();
      //expect(instance).to.be.a(CodeArtifact.DeletePackageVersionsResult);
    });
