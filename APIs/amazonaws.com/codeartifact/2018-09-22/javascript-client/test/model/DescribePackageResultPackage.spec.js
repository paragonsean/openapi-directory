...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribePackageResultPackage();
  });
  ...
  describe('DescribePackageResultPackage', function() {
    it('should create an instance of DescribePackageResultPackage', function() {
      // uncomment below and update the code to test DescribePackageResultPackage
      //var instance = new CodeArtifact.DescribePackageResultPackage();
      //expect(instance).to.be.a(CodeArtifact.DescribePackageResultPackage);
    });
