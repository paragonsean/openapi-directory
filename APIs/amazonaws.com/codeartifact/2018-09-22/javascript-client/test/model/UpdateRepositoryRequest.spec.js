...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpdateRepositoryRequest();
  });
  ...
  describe('UpdateRepositoryRequest', function() {
    it('should create an instance of UpdateRepositoryRequest', function() {
      ...
      //var instance = new CodeArtifact.UpdateRepositoryRequest();
      //expect(instance).to.be.a(CodeArtifact.UpdateRepositoryRequest);
    });
