...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribePackageVersionResult();
  });
  ...
  describe('DescribePackageVersionResult', function() {
    it('should create an instance of DescribePackageVersionResult', function() {
      // uncomment below and update the code to test DescribePackageVersionResult
      //var instance = new CodeArtifact.DescribePackageVersionResult();
      //expect(instance).to.be.a(CodeArtifact.DescribePackageVersionResult);
    });
