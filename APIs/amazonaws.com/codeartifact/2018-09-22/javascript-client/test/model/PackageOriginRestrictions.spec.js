...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageOriginRestrictions();
  });
  ...
  describe('PackageOriginRestrictions', function() {
    it('should create an instance of PackageOriginRestrictions', function() {
      // uncomment below and update the code to test PackageOriginRestrictions
      //var instance = new CodeArtifact.PackageOriginRestrictions();
      //expect(instance).to.be.a(CodeArtifact.PackageOriginRestrictions);
    });
