...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.GetAuthorizationTokenResult();
  });
  ...
  describe('GetAuthorizationTokenResult', function() {
    it('should create an instance of GetAuthorizationTokenResult', function() {
      // uncomment below and update the code to test GetAuthorizationTokenResult
      //var instance = new CodeArtifact.GetAuthorizationTokenResult();
      //expect(instance).to.be.a(CodeArtifact.GetAuthorizationTokenResult);
    });
