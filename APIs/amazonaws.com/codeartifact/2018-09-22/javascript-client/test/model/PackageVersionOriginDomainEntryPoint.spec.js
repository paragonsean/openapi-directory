...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionOriginDomainEntryPoint();
  });
  ...
  describe('PackageVersionOriginDomainEntryPoint', function() {
    it('should create an instance of PackageVersionOriginDomainEntryPoint', function() {
      // uncomment below and update the code to test PackageVersionOriginDomainEntryPoint
      //var instance = new CodeArtifact.PackageVersionOriginDomainEntryPoint();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionOriginDomainEntryPoint);
    });
