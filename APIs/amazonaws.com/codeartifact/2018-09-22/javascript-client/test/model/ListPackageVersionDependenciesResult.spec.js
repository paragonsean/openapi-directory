...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListPackageVersionDependenciesResult();
  });
  ...
  describe('ListPackageVersionDependenciesResult', function() {
    it('should create an instance of ListPackageVersionDependenciesResult', function() {
      // uncomment below and update the code to test ListPackageVersionDependenciesResult
      //var instance = new CodeArtifact.ListPackageVersionDependenciesResult();
      //expect(instance).to.be.a(CodeArtifact.ListPackageVersionDependenciesResult);
    });
