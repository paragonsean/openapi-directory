...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutRepositoryPermissionsPolicyResult();
  });
  ...
  describe('PutRepositoryPermissionsPolicyResult', function() {
    it('should create an instance of PutRepositoryPermissionsPolicyResult', function() {
      // uncomment below and update the code to test PutRepositoryPermissionsPolicyResult
      //var instance = new CodeArtifact.PutRepositoryPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.PutRepositoryPermissionsPolicyResult);
    });
