...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListRepositoriesInDomainResult();
  });
  ...
  describe('ListRepositoriesInDomainResult', function() {
    it('should create an instance of ListRepositoriesInDomainResult', function() {
      // uncomment below and update the code to test ListRepositoriesInDomainResult
      //var instance = new CodeArtifact.ListRepositoriesInDomainResult();
      //expect(instance).to.be.a(CodeArtifact.ListRepositoriesInDomainResult);
    });
