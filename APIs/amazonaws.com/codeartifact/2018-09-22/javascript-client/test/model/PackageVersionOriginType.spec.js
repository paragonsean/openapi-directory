...
(function(root, factory) {
  ...
  describe('PackageVersionOriginType', function() {
    it('should create an instance of PackageVersionOriginType', function() {
      // uncomment below and update the code to test PackageVersionOriginType
      //var instance = new CodeArtifact.PackageVersionOriginType();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionOriginType);
    });
