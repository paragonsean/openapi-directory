...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DisposePackageVersionsResult();
  });
  ...
  describe('DisposePackageVersionsResult', function() {
    it('should create an instance of DisposePackageVersionsResult', function() {
      // uncomment below and update the code to test DisposePackageVersionsResult
      //var instance = new CodeArtifact.DisposePackageVersionsResult();
      //expect(instance).to.be.a(CodeArtifact.DisposePackageVersionsResult);
    });
