...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpdatePackageVersionsStatusRequest();
  });
  ...
  describe('UpdatePackageVersionsStatusRequest', function() {
    it('should create an instance of UpdatePackageVersionsStatusRequest', function() {
      // uncomment below and update the code to test UpdatePackageVersionsStatusRequest
      //var instance = new CodeArtifact.UpdatePackageVersionsStatusRequest();
      //expect(instance).to.be.a(CodeArtifact.UpdatePackageVersionsStatusRequest);
    });
