...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.RepositoryExternalConnectionInfo();
  });
  ...
  describe('RepositoryExternalConnectionInfo', function() {
    it('should create an instance of RepositoryExternalConnectionInfo', function() {
      // uncomment below and update the code to test RepositoryExternalConnectionInfo
      //var instance = new CodeArtifact.RepositoryExternalConnectionInfo();
      //expect(instance).to.be.a(CodeArtifact.RepositoryExternalConnectionInfo);
    });

    it('should have the property externalConnectionName (base name: "externalConnectionName")', function() {
      // uncomment below and update the code to test the property externalConnectionName
      //var instance = new CodeArtifact.RepositoryExternalConnectionInfo();
      //expect(instance).to.be();
    });

    it('should have the property packageFormat (base name: "packageFormat")', function() {
