...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeletePackageVersionsRequest();
  });
  ...
  describe('DeletePackageVersionsRequest', function() {
    it('should create an instance of DeletePackageVersionsRequest', function() {
      // uncomment below and update the code to test DeletePackageVersionsRequest
      //var instance = new CodeArtifact.DeletePackageVersionsRequest();
      //expect(instance).to.be.a(CodeArtifact.DeletePackageVersionsRequest);
    });
