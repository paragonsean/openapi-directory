...
(function(root, factory) {
  ...
  describe('PackageFormat', function() {
    it('should create an instance of PackageFormat', function() {
      // uncomment below and update the code to test PackageFormat
      //var instance = new CodeArtifact.PackageFormat();
      //expect(instance).to.be.a(CodeArtifact.PackageFormat);
    });
