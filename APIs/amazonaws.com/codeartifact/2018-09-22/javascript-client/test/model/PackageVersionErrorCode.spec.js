...
(function(root, factory) {
  ...
  describe('PackageVersionErrorCode', function() {
    it('should create an instance of PackageVersionErrorCode', function() {
      // uncomment below and update the code to test PackageVersionErrorCode
      //var instance = new CodeArtifact.PackageVersionErrorCode();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionErrorCode);
    });
