...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteRepositoryResultRepository();
  });
  ...
  describe('DeleteRepositoryResultRepository', function() {
    it('should create an instance of DeleteRepositoryResultRepository', function() {
      // uncomment below and update the code to test DeleteRepositoryResultRepository
      //var instance = new CodeArtifact.DeleteRepositoryResultRepository();
      //expect(instance).to.be.a(CodeArtifact.DeleteRepositoryResultRepository);
    });
