...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.RepositoryDescription();
  });
  ...
  describe('RepositoryDescription', function() {
    it('should create an instance of RepositoryDescription', function() {
      // uncomment below and update the code to test RepositoryDescription
      //var instance = new CodeArtifact.RepositoryDescription();
      //expect(instance).to.be.a(CodeArtifact.RepositoryDescription);
    });
