...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PublishPackageVersionRequest();
  });
  ...
  describe('PublishPackageVersionRequest', function() {
    it('should create an instance of PublishPackageVersionRequest', function() {
      // uncomment below and update the code to test PublishPackageVersionRequest
      //var instance = new CodeArtifact.PublishPackageVersionRequest();
      //expect(instance).to.be.a(CodeArtifact.PublishPackageVersionRequest);
    });

    it('should have the property assetContent (base name: "assetContent")', function() {
      // uncomment below and update the code to test the property assetContent
      //var instance = new CodeArtifact.PublishPackageVersionRequest();
