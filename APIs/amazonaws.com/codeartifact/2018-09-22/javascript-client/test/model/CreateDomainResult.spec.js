...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateDomainResult();
  });
  ...
  describe('CreateDomainResult', function() {
    it('should create an instance of CreateDomainResult', function() {
      // uncomment below and update the code to test CreateDomainResult
      //var instance = new CodeArtifact.CreateDomainResult();
      //expect(instance).to.be.a(CodeArtifact.CreateDomainResult);
    });
