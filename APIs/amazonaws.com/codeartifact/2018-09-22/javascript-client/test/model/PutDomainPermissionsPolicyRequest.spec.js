...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutDomainPermissionsPolicyRequest();
  });
  ...
  describe('PutDomainPermissionsPolicyRequest', function() {
    it('should create an instance of PutDomainPermissionsPolicyRequest', function() {
      // uncomment below and update the code to test PutDomainPermissionsPolicyRequest
      //var instance = new CodeArtifact.PutDomainPermissionsPolicyRequest();
      //expect(instance).to.be.a(CodeArtifact.PutDomainPermissionsPolicyRequest);
    });
    ...
    it('should have the property policyRevision (base name: "policyRevision")', function() {
      // uncomment below and update the code to test the property policyRevision
      //var instance = new CodeArtifact.PutDomainPermissionsPolicyRequest();
      //expect(instance).to.be();
    });
