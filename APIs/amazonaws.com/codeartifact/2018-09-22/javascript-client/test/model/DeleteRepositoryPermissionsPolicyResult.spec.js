...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteRepositoryPermissionsPolicyResult();
  });
  ...
  describe('DeleteRepositoryPermissionsPolicyResult', function() {
    it('should create an instance of DeleteRepositoryPermissionsPolicyResult', function() {
      // uncomment below and update the code to test DeleteRepositoryPermissionsPolicyResult
      //var instance = new CodeArtifact.DeleteRepositoryPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.DeleteRepositoryPermissionsPolicyResult);
    });
