...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionSummary();
  });
  ...
  describe('PackageVersionSummary', function() {
    it('should create an instance of PackageVersionSummary', function() {
      // uncomment below and update the code to test PackageVersionSummary
      //var instance = new CodeArtifact.PackageVersionSummary();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionSummary);
    });
