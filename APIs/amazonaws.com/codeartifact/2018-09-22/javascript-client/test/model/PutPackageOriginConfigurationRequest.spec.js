...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PutPackageOriginConfigurationRequest();
  });
  ...
  describe('PutPackageOriginConfigurationRequest', function() {
    it('should create an instance of PutPackageOriginConfigurationRequest', function() {
      // uncomment below and update the code to test PutPackageOriginConfigurationRequest
      //var instance = new CodeArtifact.PutPackageOriginConfigurationRequest();
      //expect(instance).to.be.a(CodeArtifact.PutPackageOriginConfigurationRequest);
    });
