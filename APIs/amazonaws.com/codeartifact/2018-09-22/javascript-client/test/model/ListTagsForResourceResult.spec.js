...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListTagsForResourceResult();
  });
  ...
  describe('ListTagsForResourceResult', function() {
    it('should create an instance of ListTagsForResourceResult', function() {
      ...
      //var instance = new CodeArtifact.ListTagsForResourceResult();
      //expect(instance).to.be.a(CodeArtifact.ListTagsForResourceResult);
    });
