...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CopyPackageVersionsRequest();
  });
  ...
  describe('CopyPackageVersionsRequest', function() {
    it('should create an instance of CopyPackageVersionsRequest', function() {
      // uncomment below and update the code to test CopyPackageVersionsRequest
      //var instance = new CodeArtifact.CopyPackageVersionsRequest();
      //expect(instance).to.be.a(CodeArtifact.CopyPackageVersionsRequest);
    });
    ...
    it('should have the property includeFromUpstream (base name: "includeFromUpstream")', function() {
      // uncomment below and update the code to test the property includeFromUpstream
      //var instance = new CodeArtifact.CopyPackageVersionsRequest();
      //expect(instance).to.be();
    });
