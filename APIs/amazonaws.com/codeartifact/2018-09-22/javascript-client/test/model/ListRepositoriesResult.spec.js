...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListRepositoriesResult();
  });
  ...
  describe('ListRepositoriesResult', function() {
    it('should create an instance of ListRepositoriesResult', function() {
      // uncomment below and update the code to test ListRepositoriesResult
      //var instance = new CodeArtifact.ListRepositoriesResult();
      //expect(instance).to.be.a(CodeArtifact.ListRepositoriesResult);
    });
