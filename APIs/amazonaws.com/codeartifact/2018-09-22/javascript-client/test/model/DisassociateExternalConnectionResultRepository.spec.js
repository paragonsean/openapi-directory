...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DisassociateExternalConnectionResultRepository();
  });
  ...
  describe('DisassociateExternalConnectionResultRepository', function() {
    it('should create an instance of DisassociateExternalConnectionResultRepository', function() {
      // uncomment below and update the code to test DisassociateExternalConnectionResultRepository
      //var instance = new CodeArtifact.DisassociateExternalConnectionResultRepository();
      //expect(instance).to.be.a(CodeArtifact.DisassociateExternalConnectionResultRepository);
    });
    ...
    it('should have the property domainOwner (base name: "domainOwner")', function() {
      // uncomment below and update the code to test the property domainOwner
      //var instance = new CodeArtifact.DisassociateExternalConnectionResultRepository();
      //expect(instance).to.be();
    });
