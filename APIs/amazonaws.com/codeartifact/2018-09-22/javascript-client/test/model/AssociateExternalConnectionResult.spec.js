...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.AssociateExternalConnectionResult();
  });
  ...
  describe('AssociateExternalConnectionResult', function() {
    it('should create an instance of AssociateExternalConnectionResult', function() {
      // uncomment below and update the code to test AssociateExternalConnectionResult
      //var instance = new CodeArtifact.AssociateExternalConnectionResult();
      //expect(instance).to.be.a(CodeArtifact.AssociateExternalConnectionResult);
    });
