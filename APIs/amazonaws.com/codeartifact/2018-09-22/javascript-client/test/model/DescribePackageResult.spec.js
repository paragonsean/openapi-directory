...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribePackageResult();
  });
  ...
  describe('DescribePackageResult', function() {
    it('should create an instance of DescribePackageResult', function() {
      // uncomment below and update the code to test DescribePackageResult
      //var instance = new CodeArtifact.DescribePackageResult();
      //expect(instance).to.be.a(CodeArtifact.DescribePackageResult);
    });
