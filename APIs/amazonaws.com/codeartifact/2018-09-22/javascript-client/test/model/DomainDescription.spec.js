...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DomainDescription();
  });
  ...
  describe('DomainDescription', function() {
    it('should create an instance of DomainDescription', function() {
      // uncomment below and update the code to test DomainDescription
      //var instance = new CodeArtifact.DomainDescription();
      //expect(instance).to.be.a(CodeArtifact.DomainDescription);
    });
