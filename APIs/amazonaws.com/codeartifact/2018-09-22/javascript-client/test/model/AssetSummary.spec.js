...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.AssetSummary();
  });
  ...
  describe('AssetSummary', function() {
    it('should create an instance of AssetSummary', function() {
      // uncomment below and update the code to test AssetSummary
      //var instance = new CodeArtifact.AssetSummary();
      //expect(instance).to.be.a(CodeArtifact.AssetSummary);
    });
