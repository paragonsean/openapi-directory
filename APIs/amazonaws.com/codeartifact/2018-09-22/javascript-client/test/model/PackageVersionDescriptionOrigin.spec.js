...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionDescriptionOrigin();
  });
  ...
  describe('PackageVersionDescriptionOrigin', function() {
    it('should create an instance of PackageVersionDescriptionOrigin', function() {
      // uncomment below and update the code to test PackageVersionDescriptionOrigin
      //var instance = new CodeArtifact.PackageVersionDescriptionOrigin();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionDescriptionOrigin);
    });
