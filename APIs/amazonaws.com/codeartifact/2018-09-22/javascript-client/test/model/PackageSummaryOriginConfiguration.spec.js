...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageSummaryOriginConfiguration();
  });
  ...
  describe('PackageSummaryOriginConfiguration', function() {
    it('should create an instance of PackageSummaryOriginConfiguration', function() {
      // uncomment below and update the code to test PackageSummaryOriginConfiguration
      //var instance = new CodeArtifact.PackageSummaryOriginConfiguration();
      //expect(instance).to.be.a(CodeArtifact.PackageSummaryOriginConfiguration);
    });
