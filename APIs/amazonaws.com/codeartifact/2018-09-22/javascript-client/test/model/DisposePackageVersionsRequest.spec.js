...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DisposePackageVersionsRequest();
  });
  ...
  describe('DisposePackageVersionsRequest', function() {
    it('should create an instance of DisposePackageVersionsRequest', function() {
      // uncomment below and update the code to test DisposePackageVersionsRequest
      //var instance = new CodeArtifact.DisposePackageVersionsRequest();
      //expect(instance).to.be.a(CodeArtifact.DisposePackageVersionsRequest);
    });
    ...
    it('should have the property versionRevisions (base name: "versionRevisions")', function() {
      // uncomment below and update the code to test the property versionRevisions
      //var instance = new CodeArtifact.DisposePackageVersionsRequest();
      //expect(instance).to.be();
    });

    it('should have the property expectedStatus (base name: "expectedStatus")', function() {
      // uncomment below and update the code to test the property expectedStatus
      //var instance = new CodeArtifact.DisposePackageVersionsRequest();
      //expect(instance).to.be();
    });
