...
(function(root, factory) {
  ...
  describe('AllowPublish', function() {
    it('should create an instance of AllowPublish', function() {
      // uncomment below and update the code to test AllowPublish
      //var instance = new CodeArtifact.AllowPublish();
      //expect(instance).to.be.a(CodeArtifact.AllowPublish);
    });
