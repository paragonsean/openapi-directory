...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DescribeDomainResult();
  });
  ...
  describe('DescribeDomainResult', function() {
    it('should create an instance of DescribeDomainResult', function() {
      // uncomment below and update the code to test DescribeDomainResult
      //var instance = new CodeArtifact.DescribeDomainResult();
      //expect(instance).to.be.a(CodeArtifact.DescribeDomainResult);
    });
