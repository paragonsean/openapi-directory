...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateDomainResultDomain();
  });
  ...
  describe('CreateDomainResultDomain', function() {
    it('should create an instance of CreateDomainResultDomain', function() {
      // uncomment below and update the code to test CreateDomainResultDomain
      //var instance = new CodeArtifact.CreateDomainResultDomain();
      //expect(instance).to.be.a(CodeArtifact.CreateDomainResultDomain);
    });
