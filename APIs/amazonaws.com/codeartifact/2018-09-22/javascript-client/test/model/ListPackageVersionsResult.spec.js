...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.ListPackageVersionsResult();
  });
  ...
  describe('ListPackageVersionsResult', function() {
    it('should create an instance of ListPackageVersionsResult', function() {
      // uncomment below and update the code to test ListPackageVersionsResult
      //var instance = new CodeArtifact.ListPackageVersionsResult();
      //expect(instance).to.be.a(CodeArtifact.ListPackageVersionsResult);
    });

    it('should have the property defaultDisplayVersion (base name: "defaultDisplayVersion")', function() {
      // uncomment below and update the code to test the property defaultDisplayVersion
      //var instance = new CodeArtifact.ListPackageVersionsResult();
