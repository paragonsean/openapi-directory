...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateRepositoryRequest();
  });
  ...
  describe('CreateRepositoryRequest', function() {
    it('should create an instance of CreateRepositoryRequest', function() {
      ...
      //var instance = new CodeArtifact.CreateRepositoryRequest();
      //expect(instance).to.be.a(CodeArtifact.CreateRepositoryRequest);
    });
