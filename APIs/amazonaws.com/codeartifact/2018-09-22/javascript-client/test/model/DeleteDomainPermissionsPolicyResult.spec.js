...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteDomainPermissionsPolicyResult();
  });
  ...
  describe('DeleteDomainPermissionsPolicyResult', function() {
    it('should create an instance of DeleteDomainPermissionsPolicyResult', function() {
      // uncomment below and update the code to test DeleteDomainPermissionsPolicyResult
      //var instance = new CodeArtifact.DeleteDomainPermissionsPolicyResult();
      //expect(instance).to.be.a(CodeArtifact.DeleteDomainPermissionsPolicyResult);
    });
