...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpstreamRepository();
  });
  ...
  describe('UpstreamRepository', function() {
    it('should create an instance of UpstreamRepository', function() {
      // uncomment below and update the code to test UpstreamRepository
      //var instance = new CodeArtifact.UpstreamRepository();
      //expect(instance).to.be.a(CodeArtifact.UpstreamRepository);
    });
