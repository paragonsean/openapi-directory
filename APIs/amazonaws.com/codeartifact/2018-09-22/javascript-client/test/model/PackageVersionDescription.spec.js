...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.PackageVersionDescription();
  });
  ...
  describe('PackageVersionDescription', function() {
    it('should create an instance of PackageVersionDescription', function() {
      // uncomment below and update the code to test PackageVersionDescription
      //var instance = new CodeArtifact.PackageVersionDescription();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionDescription);
    });
    ...
    it('should have the property sourceCodeRepository (base name: "sourceCodeRepository")', function() {
      // uncomment below and update the code to test the property sourceCodeRepository
      //var instance = new CodeArtifact.PackageVersionDescription();
      //expect(instance).to.be();
    });
