...
(function(root, factory) {
  ...
  describe('PackageVersionSortType', function() {
    it('should create an instance of PackageVersionSortType', function() {
      // uncomment below and update the code to test PackageVersionSortType
      //var instance = new CodeArtifact.PackageVersionSortType();
      //expect(instance).to.be.a(CodeArtifact.PackageVersionSortType);
    });
