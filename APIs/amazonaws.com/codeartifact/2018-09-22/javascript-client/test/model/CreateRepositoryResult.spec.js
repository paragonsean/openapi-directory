...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateRepositoryResult();
  });
  ...
  describe('CreateRepositoryResult', function() {
    it('should create an instance of CreateRepositoryResult', function() {
      // uncomment below and update the code to test CreateRepositoryResult
      //var instance = new CodeArtifact.CreateRepositoryResult();
      //expect(instance).to.be.a(CodeArtifact.CreateRepositoryResult);
    });
