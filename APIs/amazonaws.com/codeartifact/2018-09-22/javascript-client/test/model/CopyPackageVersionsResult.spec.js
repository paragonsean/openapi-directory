...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CopyPackageVersionsResult();
  });
  ...
  describe('CopyPackageVersionsResult', function() {
    it('should create an instance of CopyPackageVersionsResult', function() {
      // uncomment below and update the code to test CopyPackageVersionsResult
      //var instance = new CodeArtifact.CopyPackageVersionsResult();
      //expect(instance).to.be.a(CodeArtifact.CopyPackageVersionsResult);
    });
