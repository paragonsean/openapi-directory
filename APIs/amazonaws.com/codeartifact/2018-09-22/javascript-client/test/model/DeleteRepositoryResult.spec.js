...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.DeleteRepositoryResult();
  });
  ...
  describe('DeleteRepositoryResult', function() {
    it('should create an instance of DeleteRepositoryResult', function() {
      // uncomment below and update the code to test DeleteRepositoryResult
      //var instance = new CodeArtifact.DeleteRepositoryResult();
      //expect(instance).to.be.a(CodeArtifact.DeleteRepositoryResult);
    });
