...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.UpstreamRepositoryInfo();
  });
  ...
  describe('UpstreamRepositoryInfo', function() {
    it('should create an instance of UpstreamRepositoryInfo', function() {
      // uncomment below and update the code to test UpstreamRepositoryInfo
      //var instance = new CodeArtifact.UpstreamRepositoryInfo();
      //expect(instance).to.be.a(CodeArtifact.UpstreamRepositoryInfo);
    });
