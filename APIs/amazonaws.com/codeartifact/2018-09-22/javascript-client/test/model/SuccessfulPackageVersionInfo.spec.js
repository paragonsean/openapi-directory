...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.SuccessfulPackageVersionInfo();
  });
  ...
  describe('SuccessfulPackageVersionInfo', function() {
    it('should create an instance of SuccessfulPackageVersionInfo', function() {
      // uncomment below and update the code to test SuccessfulPackageVersionInfo
      //var instance = new CodeArtifact.SuccessfulPackageVersionInfo();
      //expect(instance).to.be.a(CodeArtifact.SuccessfulPackageVersionInfo);
    });
