...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.GetPackageVersionAssetResult();
  });
  ...
  describe('GetPackageVersionAssetResult', function() {
    it('should create an instance of GetPackageVersionAssetResult', function() {
      // uncomment below and update the code to test GetPackageVersionAssetResult
      //var instance = new CodeArtifact.GetPackageVersionAssetResult();
      //expect(instance).to.be.a(CodeArtifact.GetPackageVersionAssetResult);
    });
