...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CodeArtifact.CreateRepositoryResultRepository();
  });
  ...
  describe('CreateRepositoryResultRepository', function() {
    it('should create an instance of CreateRepositoryResultRepository', function() {
      // uncomment below and update the code to test CreateRepositoryResultRepository
      //var instance = new CodeArtifact.CreateRepositoryResultRepository();
      //expect(instance).to.be.a(CodeArtifact.CreateRepositoryResultRepository);
    });
