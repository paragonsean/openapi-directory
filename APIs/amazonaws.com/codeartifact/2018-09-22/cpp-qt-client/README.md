...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::associateExternalConnectionSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::associateExternalConnectionSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString domain = create(); // QString | The name of the domain that contains the repository.
      ...
      QString repository = create(); // QString |  The name of the repository to which the external connection is added. 
      ...
      QString domain_owner = create(); // QString |  The 12-digit account number of the Amazon Web Services account that owns the domain. It does not include dashes or spaces. 
      apiInstance.associateExternalConnection(domainrepositoryexternal_connectionx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headersdomain_owner);
