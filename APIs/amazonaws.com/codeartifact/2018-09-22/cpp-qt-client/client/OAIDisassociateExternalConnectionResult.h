...
/*
 * OAIDisassociateExternalConnectionResult.h
 *
 * 
 */

#ifndef OAIDisassociateExternalConnectionResult_H
#define OAIDisassociateExternalConnectionResult_H
...
namespace OpenAPI {
class OAIDisassociateExternalConnectionResult_repository;

class OAIDisassociateExternalConnectionResult : public OAIObject {
public:
    OAIDisassociateExternalConnectionResult();
    OAIDisassociateExternalConnectionResult(QString json);
    ~OAIDisassociateExternalConnectionResult() override;
    ...
    OAIDisassociateExternalConnectionResult_repository getRepository() const;
    void setRepository(const OAIDisassociateExternalConnectionResult_repository &repository);
...
private:
    ...
    OAIDisassociateExternalConnectionResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateExternalConnectionResult)

#endif // OAIDisassociateExternalConnectionResult_H
