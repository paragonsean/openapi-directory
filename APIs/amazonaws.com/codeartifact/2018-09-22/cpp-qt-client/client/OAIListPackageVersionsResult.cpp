...
OAIListPackageVersionsResult::OAIListPackageVersionsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPackageVersionsResult::OAIListPackageVersionsResult() {
    this->initializeModel();
}

OAIListPackageVersionsResult::~OAIListPackageVersionsResult() {}

void OAIListPackageVersionsResult::initializeModel() {

    m_default_display_version_isSet = false;
    m_default_display_version_isValid = false;
...
void OAIListPackageVersionsResult::fromJson(QString jsonString) {
...
void OAIListPackageVersionsResult::fromJsonObject(QJsonObject json) {

    m_default_display_version_isValid = ::OpenAPI::fromJsonValue(m_default_display_version, json[QString("defaultDisplayVersion")]);
    m_default_display_version_isSet = !json[QString("defaultDisplayVersion")].isNull() && m_default_display_version_isValid;
...
QString OAIListPackageVersionsResult::asJson() const {
...
QJsonObject OAIListPackageVersionsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_default_display_version_isSet) {
        obj.insert(QString("defaultDisplayVersion"), ::OpenAPI::toJsonValue(m_default_display_version));
    }
    if (m_format.isSet()) {
...
QString OAIListPackageVersionsResult::getDefaultDisplayVersion() const {
    return m_default_display_version;
}
void OAIListPackageVersionsResult::setDefaultDisplayVersion(const QString &default_display_version) {
    m_default_display_version = default_display_version;
    m_default_display_version_isSet = true;
}

bool OAIListPackageVersionsResult::is_default_display_version_Set() const{
    return m_default_display_version_isSet;
}

bool OAIListPackageVersionsResult::is_default_display_version_Valid() const{
    return m_default_display_version_isValid;
}

OAIPackageFormat OAIListPackageVersionsResult::getFormat() const {
    return m_format;
}
void OAIListPackageVersionsResult::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIListPackageVersionsResult::is_format_Set() const{
    return m_format_isSet;
}

bool OAIListPackageVersionsResult::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIListPackageVersionsResult::getRNamespace() const {
    return m_r_namespace;
}
void OAIListPackageVersionsResult::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIListPackageVersionsResult::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIListPackageVersionsResult::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIListPackageVersionsResult::getPackage() const {
    return m_package;
}
void OAIListPackageVersionsResult::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIListPackageVersionsResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIListPackageVersionsResult::is_package_Valid() const{
    return m_package_isValid;
}

QList OAIListPackageVersionsResult::getVersions() const {
    return m_versions;
}
void OAIListPackageVersionsResult::setVersions(const QList &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIListPackageVersionsResult::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIListPackageVersionsResult::is_versions_Valid() const{
    return m_versions_isValid;
}

QString OAIListPackageVersionsResult::getNextToken() const {
    return m_next_token;
}
void OAIListPackageVersionsResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPackageVersionsResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPackageVersionsResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPackageVersionsResult::isSet() const {
...
bool OAIListPackageVersionsResult::isValid() const {
