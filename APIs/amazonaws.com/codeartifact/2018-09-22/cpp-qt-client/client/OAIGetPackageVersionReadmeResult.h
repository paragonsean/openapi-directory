...
/*
 * OAIGetPackageVersionReadmeResult.h
 *
 * 
 */

#ifndef OAIGetPackageVersionReadmeResult_H
#define OAIGetPackageVersionReadmeResult_H
...
class OAIGetPackageVersionReadmeResult : public OAIObject {
public:
    OAIGetPackageVersionReadmeResult();
    OAIGetPackageVersionReadmeResult(QString json);
    ~OAIGetPackageVersionReadmeResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPackageVersionReadmeResult)

#endif // OAIGetPackageVersionReadmeResult_H
