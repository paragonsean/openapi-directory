...
/*
 * OAICopyPackageVersionsRequest.h
 *
 * 
 */

#ifndef OAICopyPackageVersionsRequest_H
#define OAICopyPackageVersionsRequest_H
...
class OAICopyPackageVersionsRequest : public OAIObject {
public:
    OAICopyPackageVersionsRequest();
    OAICopyPackageVersionsRequest(QString json);
    ~OAICopyPackageVersionsRequest() override;
    ...
    void setIncludeFromUpstream(const bool &include_from_upstream);
    bool is_include_from_upstream_Set() const;
    bool is_include_from_upstream_Valid() const;
...
private:
    ...
    bool m_include_from_upstream;
    bool m_include_from_upstream_isSet;
    bool m_include_from_upstream_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICopyPackageVersionsRequest)

#endif // OAICopyPackageVersionsRequest_H
