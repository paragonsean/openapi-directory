...
#include "OAIPutRepositoryPermissionsPolicyRequest.h"
...
OAIPutRepositoryPermissionsPolicyRequest::OAIPutRepositoryPermissionsPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRepositoryPermissionsPolicyRequest::OAIPutRepositoryPermissionsPolicyRequest() {
    this->initializeModel();
}

OAIPutRepositoryPermissionsPolicyRequest::~OAIPutRepositoryPermissionsPolicyRequest() {}

void OAIPutRepositoryPermissionsPolicyRequest::initializeModel() {
...
void OAIPutRepositoryPermissionsPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutRepositoryPermissionsPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutRepositoryPermissionsPolicyRequest::asJson() const {
...
QJsonObject OAIPutRepositoryPermissionsPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutRepositoryPermissionsPolicyRequest::getPolicyRevision() const {
    return m_policy_revision;
}
void OAIPutRepositoryPermissionsPolicyRequest::setPolicyRevision(const QString &policy_revision) {
    m_policy_revision = policy_revision;
    m_policy_revision_isSet = true;
}

bool OAIPutRepositoryPermissionsPolicyRequest::is_policy_revision_Set() const{
    return m_policy_revision_isSet;
}

bool OAIPutRepositoryPermissionsPolicyRequest::is_policy_revision_Valid() const{
    return m_policy_revision_isValid;
}

QString OAIPutRepositoryPermissionsPolicyRequest::getPolicyDocument() const {
    return m_policy_document;
}
void OAIPutRepositoryPermissionsPolicyRequest::setPolicyDocument(const QString &policy_document) {
    m_policy_document = policy_document;
    m_policy_document_isSet = true;
}

bool OAIPutRepositoryPermissionsPolicyRequest::is_policy_document_Set() const{
    return m_policy_document_isSet;
}

bool OAIPutRepositoryPermissionsPolicyRequest::is_policy_document_Valid() const{
    return m_policy_document_isValid;
}

bool OAIPutRepositoryPermissionsPolicyRequest::isSet() const {
...
bool OAIPutRepositoryPermissionsPolicyRequest::isValid() const {
