...
/*
 * OAIPackageOriginConfiguration_restrictions.h
 *
 * 
 */

#ifndef OAIPackageOriginConfiguration_restrictions_H
#define OAIPackageOriginConfiguration_restrictions_H
...
class OAIPackageOriginConfiguration_restrictions : public OAIObject {
public:
    OAIPackageOriginConfiguration_restrictions();
    OAIPackageOriginConfiguration_restrictions(QString json);
    ~OAIPackageOriginConfiguration_restrictions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageOriginConfiguration_restrictions)

#endif // OAIPackageOriginConfiguration_restrictions_H
