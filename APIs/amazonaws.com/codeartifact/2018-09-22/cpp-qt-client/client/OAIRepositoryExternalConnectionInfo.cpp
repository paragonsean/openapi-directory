...
#include "OAIRepositoryExternalConnectionInfo.h"
...
OAIRepositoryExternalConnectionInfo::OAIRepositoryExternalConnectionInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryExternalConnectionInfo::OAIRepositoryExternalConnectionInfo() {
    this->initializeModel();
}

OAIRepositoryExternalConnectionInfo::~OAIRepositoryExternalConnectionInfo() {}

void OAIRepositoryExternalConnectionInfo::initializeModel() {

    m_external_connection_name_isSet = false;
    m_external_connection_name_isValid = false;
...
void OAIRepositoryExternalConnectionInfo::fromJson(QString jsonString) {
...
void OAIRepositoryExternalConnectionInfo::fromJsonObject(QJsonObject json) {

    m_external_connection_name_isValid = ::OpenAPI::fromJsonValue(m_external_connection_name, json[QString("externalConnectionName")]);
    m_external_connection_name_isSet = !json[QString("externalConnectionName")].isNull() && m_external_connection_name_isValid;

    m_package_format_isValid = ::OpenAPI::fromJsonValue(m_package_format, json[QString("packageFormat")]);
    m_package_format_isSet = !json[QString("packageFormat")].isNull() && m_package_format_isValid;

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIRepositoryExternalConnectionInfo::asJson() const {
...
QJsonObject OAIRepositoryExternalConnectionInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_external_connection_name_isSet) {
        obj.insert(QString("externalConnectionName"), ::OpenAPI::toJsonValue(m_external_connection_name));
    }
    if (m_package_format.isSet()) {
        obj.insert(QString("packageFormat"), ::OpenAPI::toJsonValue(m_package_format));
    }
    if (m_status.isSet()) {
...
QString OAIRepositoryExternalConnectionInfo::getExternalConnectionName() const {
    return m_external_connection_name;
}
void OAIRepositoryExternalConnectionInfo::setExternalConnectionName(const QString &external_connection_name) {
    m_external_connection_name = external_connection_name;
    m_external_connection_name_isSet = true;
}

bool OAIRepositoryExternalConnectionInfo::is_external_connection_name_Set() const{
    return m_external_connection_name_isSet;
}

bool OAIRepositoryExternalConnectionInfo::is_external_connection_name_Valid() const{
    return m_external_connection_name_isValid;
}

OAIPackageFormat OAIRepositoryExternalConnectionInfo::getPackageFormat() const {
    return m_package_format;
}
void OAIRepositoryExternalConnectionInfo::setPackageFormat(const OAIPackageFormat &package_format) {
    m_package_format = package_format;
    m_package_format_isSet = true;
}

bool OAIRepositoryExternalConnectionInfo::is_package_format_Set() const{
    return m_package_format_isSet;
}

bool OAIRepositoryExternalConnectionInfo::is_package_format_Valid() const{
    return m_package_format_isValid;
}

OAIExternalConnectionStatus OAIRepositoryExternalConnectionInfo::getStatus() const {
    return m_status;
}
void OAIRepositoryExternalConnectionInfo::setStatus(const OAIExternalConnectionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRepositoryExternalConnectionInfo::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRepositoryExternalConnectionInfo::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIRepositoryExternalConnectionInfo::isSet() const {
...
bool OAIRepositoryExternalConnectionInfo::isValid() const {
