...
/*
 * OAIUpdateRepositoryRequest.h
 *
 * 
 */

#ifndef OAIUpdateRepositoryRequest_H
#define OAIUpdateRepositoryRequest_H
...
class OAIUpdateRepositoryRequest : public OAIObject {
public:
    OAIUpdateRepositoryRequest();
    OAIUpdateRepositoryRequest(QString json);
    ~OAIUpdateRepositoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepositoryRequest)

#endif // OAIUpdateRepositoryRequest_H
