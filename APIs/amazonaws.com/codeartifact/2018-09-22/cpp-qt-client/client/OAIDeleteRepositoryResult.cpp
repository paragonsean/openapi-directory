...
OAIDeleteRepositoryResult::OAIDeleteRepositoryResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRepositoryResult::OAIDeleteRepositoryResult() {
    this->initializeModel();
}

OAIDeleteRepositoryResult::~OAIDeleteRepositoryResult() {}

void OAIDeleteRepositoryResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAIDeleteRepositoryResult::fromJson(QString jsonString) {
...
void OAIDeleteRepositoryResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRepositoryResult::asJson() const {
...
QJsonObject OAIDeleteRepositoryResult::asJsonObject() const {
    QJsonObject obj;
...
OAIDeleteRepositoryResult_repository OAIDeleteRepositoryResult::getRepository() const {
    return m_repository;
}
void OAIDeleteRepositoryResult::setRepository(const OAIDeleteRepositoryResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIDeleteRepositoryResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIDeleteRepositoryResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAIDeleteRepositoryResult::isSet() const {
...
bool OAIDeleteRepositoryResult::isValid() const {
