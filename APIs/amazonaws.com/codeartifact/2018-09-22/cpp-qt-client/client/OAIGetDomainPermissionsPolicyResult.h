...
/*
 * OAIGetDomainPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIGetDomainPermissionsPolicyResult_H
#define OAIGetDomainPermissionsPolicyResult_H
...
class OAIGetDomainPermissionsPolicyResult : public OAIObject {
public:
    OAIGetDomainPermissionsPolicyResult();
    OAIGetDomainPermissionsPolicyResult(QString json);
    ~OAIGetDomainPermissionsPolicyResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDomainPermissionsPolicyResult)

#endif // OAIGetDomainPermissionsPolicyResult_H
