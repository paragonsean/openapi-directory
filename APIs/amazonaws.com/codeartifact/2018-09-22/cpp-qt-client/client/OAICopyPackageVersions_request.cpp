...
OAICopyPackageVersions_request::OAICopyPackageVersions_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyPackageVersions_request::OAICopyPackageVersions_request() {
    this->initializeModel();
}

OAICopyPackageVersions_request::~OAICopyPackageVersions_request() {}

void OAICopyPackageVersions_request::initializeModel() {
...
void OAICopyPackageVersions_request::fromJson(QString jsonString) {
...
void OAICopyPackageVersions_request::fromJsonObject(QJsonObject json) {
...
QString OAICopyPackageVersions_request::asJson() const {
...
QJsonObject OAICopyPackageVersions_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICopyPackageVersions_request::getVersions() const {
    return m_versions;
}
void OAICopyPackageVersions_request::setVersions(const QList<QString> &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAICopyPackageVersions_request::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAICopyPackageVersions_request::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap<QString, QString> OAICopyPackageVersions_request::getVersionRevisions() const {
    return m_version_revisions;
}
void OAICopyPackageVersions_request::setVersionRevisions(const QMap<QString, QString> &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAICopyPackageVersions_request::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAICopyPackageVersions_request::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

bool OAICopyPackageVersions_request::isAllowOverwrite() const {
    return m_allow_overwrite;
}
void OAICopyPackageVersions_request::setAllowOverwrite(const bool &allow_overwrite) {
    m_allow_overwrite = allow_overwrite;
    m_allow_overwrite_isSet = true;
}

bool OAICopyPackageVersions_request::is_allow_overwrite_Set() const{
    return m_allow_overwrite_isSet;
}

bool OAICopyPackageVersions_request::is_allow_overwrite_Valid() const{
    return m_allow_overwrite_isValid;
}

bool OAICopyPackageVersions_request::isIncludeFromUpstream() const {
    return m_include_from_upstream;
}
void OAICopyPackageVersions_request::setIncludeFromUpstream(const bool &include_from_upstream) {
    m_include_from_upstream = include_from_upstream;
    m_include_from_upstream_isSet = true;
}

bool OAICopyPackageVersions_request::is_include_from_upstream_Set() const{
    return m_include_from_upstream_isSet;
}

bool OAICopyPackageVersions_request::is_include_from_upstream_Valid() const{
    return m_include_from_upstream_isValid;
}

bool OAICopyPackageVersions_request::isSet() const {
...
bool OAICopyPackageVersions_request::isValid() const {
