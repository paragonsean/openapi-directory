...
#ifndef OAIPackageSummary_H
#define OAIPackageSummary_H
...
namespace OpenAPI {
class OAIPackageSummary_originConfiguration;

class OAIPackageSummary : public OAIObject {
public:
    OAIPackageSummary();
    OAIPackageSummary(QString json);
    ~OAIPackageSummary() override;
    ...
    OAIPackageSummary_originConfiguration getOriginConfiguration() const;
    void setOriginConfiguration(const OAIPackageSummary_originConfiguration &origin_configuration);
    bool is_origin_configuration_Set() const;
    bool is_origin_configuration_Valid() const;
...
private:
    ...
    OAIPackageSummary_originConfiguration m_origin_configuration;
    bool m_origin_configuration_isSet;
    bool m_origin_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPackageSummary)

#endif // OAIPackageSummary_H
