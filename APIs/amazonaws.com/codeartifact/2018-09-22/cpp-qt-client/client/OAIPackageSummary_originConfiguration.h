...
/*
 * OAIPackageSummary_originConfiguration.h
 *
 * 
 */

#ifndef OAIPackageSummary_originConfiguration_H
#define OAIPackageSummary_originConfiguration_H
...
class OAIPackageSummary_originConfiguration : public OAIObject {
public:
    OAIPackageSummary_originConfiguration();
    OAIPackageSummary_originConfiguration(QString json);
    ~OAIPackageSummary_originConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageSummary_originConfiguration)

#endif // OAIPackageSummary_originConfiguration_H
