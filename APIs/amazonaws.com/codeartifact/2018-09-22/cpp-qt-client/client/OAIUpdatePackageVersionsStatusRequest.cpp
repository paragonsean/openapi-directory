...
#include "OAIUpdatePackageVersionsStatusRequest.h"
...
OAIUpdatePackageVersionsStatusRequest::OAIUpdatePackageVersionsStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePackageVersionsStatusRequest::OAIUpdatePackageVersionsStatusRequest() {
    this->initializeModel();
}

OAIUpdatePackageVersionsStatusRequest::~OAIUpdatePackageVersionsStatusRequest() {}

void OAIUpdatePackageVersionsStatusRequest::initializeModel() {
...
void OAIUpdatePackageVersionsStatusRequest::fromJson(QString jsonString) {
...
void OAIUpdatePackageVersionsStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePackageVersionsStatusRequest::asJson() const {
...
QJsonObject OAIUpdatePackageVersionsStatusRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_versions.isSet()) {
...
QList OAIUpdatePackageVersionsStatusRequest::getVersions() const {
    return m_versions;
}
void OAIUpdatePackageVersionsStatusRequest::setVersions(const QList &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIUpdatePackageVersionsStatusRequest::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIUpdatePackageVersionsStatusRequest::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap OAIUpdatePackageVersionsStatusRequest::getVersionRevisions() const {
    return m_version_revisions;
}
void OAIUpdatePackageVersionsStatusRequest::setVersionRevisions(const QMap &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAIUpdatePackageVersionsStatusRequest::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAIUpdatePackageVersionsStatusRequest::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

OAIPackageVersionStatus OAIUpdatePackageVersionsStatusRequest::getExpectedStatus() const {
    return m_expected_status;
}
void OAIUpdatePackageVersionsStatusRequest::setExpectedStatus(const OAIPackageVersionStatus &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIUpdatePackageVersionsStatusRequest::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIUpdatePackageVersionsStatusRequest::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

OAIPackageVersionStatus OAIUpdatePackageVersionsStatusRequest::getTargetStatus() const {
    return m_target_status;
}
void OAIUpdatePackageVersionsStatusRequest::setTargetStatus(const OAIPackageVersionStatus &target_status) {
    m_target_status = target_status;
    m_target_status_isSet = true;
}

bool OAIUpdatePackageVersionsStatusRequest::is_target_status_Set() const{
    return m_target_status_isSet;
}

bool OAIUpdatePackageVersionsStatusRequest::is_target_status_Valid() const{
    return m_target_status_isValid;
}

bool OAIUpdatePackageVersionsStatusRequest::isSet() const {
...
bool OAIUpdatePackageVersionsStatusRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_versions_isValid && m_target_status_isValid && true;
}
