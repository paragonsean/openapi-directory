...
#include "OAIDescribeRepositoryResult_repository.h"
...
OAIDescribeRepositoryResult_repository::OAIDescribeRepositoryResult_repository(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRepositoryResult_repository::OAIDescribeRepositoryResult_repository() {
    this->initializeModel();
}

OAIDescribeRepositoryResult_repository::~OAIDescribeRepositoryResult_repository() {}

void OAIDescribeRepositoryResult_repository::initializeModel() {
...
void OAIDescribeRepositoryResult_repository::fromJson(QString jsonString) {
...
void OAIDescribeRepositoryResult_repository::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRepositoryResult_repository::asJson() const {
...
QJsonObject OAIDescribeRepositoryResult_repository::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDescribeRepositoryResult_repository::getName() const {
    return m_name;
}
void OAIDescribeRepositoryResult_repository::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDescribeRepositoryResult_repository::getAdministratorAccount() const {
    return m_administrator_account;
}
void OAIDescribeRepositoryResult_repository::setAdministratorAccount(const QString &administrator_account) {
    m_administrator_account = administrator_account;
    m_administrator_account_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_administrator_account_Set() const{
    return m_administrator_account_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_administrator_account_Valid() const{
    return m_administrator_account_isValid;
}

QString OAIDescribeRepositoryResult_repository::getDomainName() const {
    return m_domain_name;
}
void OAIDescribeRepositoryResult_repository::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIDescribeRepositoryResult_repository::getDomainOwner() const {
    return m_domain_owner;
}
void OAIDescribeRepositoryResult_repository::setDomainOwner(const QString &domain_owner) {
    m_domain_owner = domain_owner;
    m_domain_owner_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_domain_owner_Set() const{
    return m_domain_owner_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_domain_owner_Valid() const{
    return m_domain_owner_isValid;
}

QString OAIDescribeRepositoryResult_repository::getArn() const {
    return m_arn;
}
void OAIDescribeRepositoryResult_repository::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDescribeRepositoryResult_repository::getDescription() const {
    return m_description;
}
void OAIDescribeRepositoryResult_repository::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIDescribeRepositoryResult_repository::getUpstreams() const {
    return m_upstreams;
}
void OAIDescribeRepositoryResult_repository::setUpstreams(const QList &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_upstreams_Valid() const{
    return m_upstreams_isValid;
}

QList OAIDescribeRepositoryResult_repository::getExternalConnections() const {
    return m_external_connections;
}
void OAIDescribeRepositoryResult_repository::setExternalConnections(const QList &external_connections) {
    m_external_connections = external_connections;
    m_external_connections_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_external_connections_Set() const{
    return m_external_connections_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_external_connections_Valid() const{
    return m_external_connections_isValid;
}

QDateTime OAIDescribeRepositoryResult_repository::getCreatedTime() const {
    return m_created_time;
}
void OAIDescribeRepositoryResult_repository::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDescribeRepositoryResult_repository::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDescribeRepositoryResult_repository::is_created_time_Valid() const{
    return m_created_time_isValid;
}

bool OAIDescribeRepositoryResult_repository::isSet() const {
...
bool OAIDescribeRepositoryResult_repository::isValid() const {
