...
OAICopyPackageVersionsResult::OAICopyPackageVersionsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyPackageVersionsResult::OAICopyPackageVersionsResult() {
    this->initializeModel();
}

OAICopyPackageVersionsResult::~OAICopyPackageVersionsResult() {}

void OAICopyPackageVersionsResult::initializeModel() {
...
void OAICopyPackageVersionsResult::fromJson(QString jsonString) {
...
void OAICopyPackageVersionsResult::fromJsonObject(QJsonObject json) {
...
QString OAICopyPackageVersionsResult::asJson() const {
...
QJsonObject OAICopyPackageVersionsResult::asJsonObject() const {
    QJsonObject obj;
...
QMap OAICopyPackageVersionsResult::getSuccessfulVersions() const {
    return m_successful_versions;
}
void OAICopyPackageVersionsResult::setSuccessfulVersions(const QMap &successful_versions) {
    m_successful_versions = successful_versions;
    m_successful_versions_isSet = true;
}

bool OAICopyPackageVersionsResult::is_successful_versions_Set() const{
    return m_successful_versions_isSet;
}

bool OAICopyPackageVersionsResult::is_successful_versions_Valid() const{
    return m_successful_versions_isValid;
}

QMap OAICopyPackageVersionsResult::getFailedVersions() const {
    return m_failed_versions;
}
void OAICopyPackageVersionsResult::setFailedVersions(const QMap &failed_versions) {
    m_failed_versions = failed_versions;
    m_failed_versions_isSet = true;
}

bool OAICopyPackageVersionsResult::is_failed_versions_Set() const{
    return m_failed_versions_isSet;
}

bool OAICopyPackageVersionsResult::is_failed_versions_Valid() const{
    return m_failed_versions_isValid;
}

bool OAICopyPackageVersionsResult::isSet() const {
...
bool OAICopyPackageVersionsResult::isValid() const {
