...
/*
 * OAIDeleteDomainPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIDeleteDomainPermissionsPolicyResult_H
#define OAIDeleteDomainPermissionsPolicyResult_H

#include <QJsonObject>

#include "OAIDeleteDomainPermissionsPolicyResult_policy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeleteDomainPermissionsPolicyResult_policy;

class OAIDeleteDomainPermissionsPolicyResult : public OAIObject {
public:
    OAIDeleteDomainPermissionsPolicyResult();
    OAIDeleteDomainPermissionsPolicyResult(QString json);
    ~OAIDeleteDomainPermissionsPolicyResult() override;
    ...
    OAIDeleteDomainPermissionsPolicyResult_policy getPolicy() const;
    void setPolicy(const OAIDeleteDomainPermissionsPolicyResult_policy &policy);
...
private:
    ...
    OAIDeleteDomainPermissionsPolicyResult_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDomainPermissionsPolicyResult)

#endif // OAIDeleteDomainPermissionsPolicyResult_H
