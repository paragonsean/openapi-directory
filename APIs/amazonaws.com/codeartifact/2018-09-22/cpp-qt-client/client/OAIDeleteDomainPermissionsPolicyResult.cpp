...
OAIDeleteDomainPermissionsPolicyResult::OAIDeleteDomainPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDomainPermissionsPolicyResult::OAIDeleteDomainPermissionsPolicyResult() {
    this->initializeModel();
}

OAIDeleteDomainPermissionsPolicyResult::~OAIDeleteDomainPermissionsPolicyResult() {}

void OAIDeleteDomainPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIDeleteDomainPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIDeleteDomainPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIDeleteDomainPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIDeleteDomainPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIDeleteDomainPermissionsPolicyResult_policy OAIDeleteDomainPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIDeleteDomainPermissionsPolicyResult::setPolicy(const OAIDeleteDomainPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIDeleteDomainPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIDeleteDomainPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIDeleteDomainPermissionsPolicyResult::isSet() const {
...
bool OAIDeleteDomainPermissionsPolicyResult::isValid() const {
