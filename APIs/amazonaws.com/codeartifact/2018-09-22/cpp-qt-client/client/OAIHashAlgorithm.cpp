...
void OAIHashAlgorithm::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("MD5", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHashAlgorithm::MD5;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHA-1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHashAlgorithm::SHA_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHA-256", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHashAlgorithm::SHA_256;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHA-512", Qt::CaseInsensitive) == 0) {
        m_value = eOAIHashAlgorithm::SHA_512;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIHashAlgorithm::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIHashAlgorithm::MD5:
            val = "MD5";
            break;
        case eOAIHashAlgorithm::SHA_1:
            val = "SHA-1";
            break;
        case eOAIHashAlgorithm::SHA_256:
            val = "SHA-256";
            break;
        case eOAIHashAlgorithm::SHA_512:
            val = "SHA-512";
            break;
        default:
            break;
