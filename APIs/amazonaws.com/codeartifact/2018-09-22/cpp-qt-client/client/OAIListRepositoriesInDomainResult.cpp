...
OAIListRepositoriesInDomainResult::OAIListRepositoriesInDomainResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRepositoriesInDomainResult::OAIListRepositoriesInDomainResult() {
    this->initializeModel();
}

OAIListRepositoriesInDomainResult::~OAIListRepositoriesInDomainResult() {}

void OAIListRepositoriesInDomainResult::initializeModel() {
...
void OAIListRepositoriesInDomainResult::fromJson(QString jsonString) {
...
void OAIListRepositoriesInDomainResult::fromJsonObject(QJsonObject json) {
...
QString OAIListRepositoriesInDomainResult::asJson() const {
...
QJsonObject OAIListRepositoriesInDomainResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListRepositoriesInDomainResult::getRepositories() const {
    return m_repositories;
}
void OAIListRepositoriesInDomainResult::setRepositories(const QList &repositories) {
    m_repositories = repositories;
    m_repositories_isSet = true;
}

bool OAIListRepositoriesInDomainResult::is_repositories_Set() const{
    return m_repositories_isSet;
}

bool OAIListRepositoriesInDomainResult::is_repositories_Valid() const{
    return m_repositories_isValid;
}

QString OAIListRepositoriesInDomainResult::getNextToken() const {
    return m_next_token;
}
void OAIListRepositoriesInDomainResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRepositoriesInDomainResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRepositoriesInDomainResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRepositoriesInDomainResult::isSet() const {
...
bool OAIListRepositoriesInDomainResult::isValid() const {
