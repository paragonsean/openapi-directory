...
OAIAssociateExternalConnectionResult::OAIAssociateExternalConnectionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateExternalConnectionResult::OAIAssociateExternalConnectionResult() {
    this->initializeModel();
}

OAIAssociateExternalConnectionResult::~OAIAssociateExternalConnectionResult() {}

void OAIAssociateExternalConnectionResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAIAssociateExternalConnectionResult::fromJson(QString jsonString) {
...
void OAIAssociateExternalConnectionResult::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateExternalConnectionResult::asJson() const {
...
QJsonObject OAIAssociateExternalConnectionResult::asJsonObject() const {
    QJsonObject obj;
...
OAIAssociateExternalConnectionResult_repository OAIAssociateExternalConnectionResult::getRepository() const {
    return m_repository;
}
void OAIAssociateExternalConnectionResult::setRepository(const OAIAssociateExternalConnectionResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIAssociateExternalConnectionResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIAssociateExternalConnectionResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAIAssociateExternalConnectionResult::isSet() const {
...
bool OAIAssociateExternalConnectionResult::isValid() const {
