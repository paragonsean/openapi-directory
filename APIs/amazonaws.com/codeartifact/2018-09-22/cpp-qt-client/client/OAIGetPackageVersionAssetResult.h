...
/*
 * OAIGetPackageVersionAssetResult.h
 *
 * 
 */

#ifndef OAIGetPackageVersionAssetResult_H
#define OAIGetPackageVersionAssetResult_H
...
class OAIGetPackageVersionAssetResult : public OAIObject {
public:
    OAIGetPackageVersionAssetResult();
    OAIGetPackageVersionAssetResult(QString json);
    ~OAIGetPackageVersionAssetResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPackageVersionAssetResult)

#endif // OAIGetPackageVersionAssetResult_H
