...
QString OAIResourcePolicy::getResourceArn() const {
    return m_resource_arn;
}
void OAIResourcePolicy::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIResourcePolicy::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIResourcePolicy::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIResourcePolicy::getRevision() const {
    return m_revision;
}
void OAIResourcePolicy::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIResourcePolicy::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIResourcePolicy::is_revision_Valid() const{
    return m_revision_isValid;
}

QString OAIResourcePolicy::getDocument() const {
    return m_document;
}
void OAIResourcePolicy::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIResourcePolicy::is_document_Set() const{
    return m_document_isSet;
}

bool OAIResourcePolicy::is_document_Valid() const{
