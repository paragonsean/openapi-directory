...
/*
 * OAIGetAuthorizationTokenResult.h
 *
 * 
 */

#ifndef OAIGetAuthorizationTokenResult_H
#define OAIGetAuthorizationTokenResult_H
...
class OAIGetAuthorizationTokenResult : public OAIObject {
public:
    OAIGetAuthorizationTokenResult();
    OAIGetAuthorizationTokenResult(QString json);
    ~OAIGetAuthorizationTokenResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAuthorizationTokenResult)

#endif // OAIGetAuthorizationTokenResult_H
