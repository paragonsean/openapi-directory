...
/*
 * OAIPackageVersionSortType.h
 *
 * 
 */

#ifndef OAIPackageVersionSortType_H
#define OAIPackageVersionSortType_H
...
class OAIPackageVersionSortType : public OAIEnum {
public:
    OAIPackageVersionSortType();
    OAIPackageVersionSortType(QString json);
    ~OAIPackageVersionSortType() override;
    ...
    enum class eOAIPackageVersionSortType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PUBLISHED_TIME
    };
    OAIPackageVersionSortType::eOAIPackageVersionSortType getValue() const;
    void setValue(const OAIPackageVersionSortType::eOAIPackageVersionSortType& value);
...
private:
    ...
    eOAIPackageVersionSortType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionSortType)

#endif // OAIPackageVersionSortType_H
