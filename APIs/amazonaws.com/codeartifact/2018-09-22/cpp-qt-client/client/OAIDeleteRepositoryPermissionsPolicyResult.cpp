...
OAIDeleteRepositoryPermissionsPolicyResult::OAIDeleteRepositoryPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRepositoryPermissionsPolicyResult::OAIDeleteRepositoryPermissionsPolicyResult() {
    this->initializeModel();
}

OAIDeleteRepositoryPermissionsPolicyResult::~OAIDeleteRepositoryPermissionsPolicyResult() {}

void OAIDeleteRepositoryPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIDeleteRepositoryPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIDeleteRepositoryPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIDeleteRepositoryPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIDeleteRepositoryPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIDeleteRepositoryPermissionsPolicyResult_policy OAIDeleteRepositoryPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIDeleteRepositoryPermissionsPolicyResult::setPolicy(const OAIDeleteRepositoryPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIDeleteRepositoryPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIDeleteRepositoryPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIDeleteRepositoryPermissionsPolicyResult::isSet() const {
...
bool OAIDeleteRepositoryPermissionsPolicyResult::isValid() const {
