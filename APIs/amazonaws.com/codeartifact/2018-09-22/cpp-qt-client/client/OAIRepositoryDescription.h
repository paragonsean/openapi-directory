...
#ifndef OAIRepositoryDescription_H
#define OAIRepositoryDescription_H
...
class OAIRepositoryDescription : public OAIObject {
public:
    OAIRepositoryDescription();
    OAIRepositoryDescription(QString json);
    ~OAIRepositoryDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryDescription)

#endif // OAIRepositoryDescription_H
