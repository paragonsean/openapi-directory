...
QString OAIDomainSummary::getOwner() const {
    return m_owner;
}
void OAIDomainSummary::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIDomainSummary::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIDomainSummary::is_owner_Valid() const{
...
OAIDomainStatus OAIDomainSummary::getStatus() const {
    return m_status;
}
void OAIDomainSummary::setStatus(const OAIDomainStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDomainSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDomainSummary::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDomainSummary::getCreatedTime() const {
    return m_created_time;
}
void OAIDomainSummary::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDomainSummary::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDomainSummary::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDomainSummary::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIDomainSummary::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIDomainSummary::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIDomainSummary::is_encryption_key_Valid() const{
