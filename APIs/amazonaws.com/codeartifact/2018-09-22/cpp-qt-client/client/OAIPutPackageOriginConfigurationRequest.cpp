...
#include "OAIPutPackageOriginConfigurationRequest.h"
...
OAIPutPackageOriginConfigurationRequest::OAIPutPackageOriginConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutPackageOriginConfigurationRequest::OAIPutPackageOriginConfigurationRequest() {
    this->initializeModel();
}

OAIPutPackageOriginConfigurationRequest::~OAIPutPackageOriginConfigurationRequest() {}

void OAIPutPackageOriginConfigurationRequest::initializeModel() {

    m_restrictions_isSet = false;
    m_restrictions_isValid = false;
}

void OAIPutPackageOriginConfigurationRequest::fromJson(QString jsonString) {
...
void OAIPutPackageOriginConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutPackageOriginConfigurationRequest::asJson() const {
...
QJsonObject OAIPutPackageOriginConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIPutPackageOriginConfigurationRequest_restrictions OAIPutPackageOriginConfigurationRequest::getRestrictions() const {
    return m_restrictions;
}
void OAIPutPackageOriginConfigurationRequest::setRestrictions(const OAIPutPackageOriginConfigurationRequest_restrictions &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIPutPackageOriginConfigurationRequest::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIPutPackageOriginConfigurationRequest::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

bool OAIPutPackageOriginConfigurationRequest::isSet() const {
...
bool OAIPutPackageOriginConfigurationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_restrictions_isValid && true;
}
