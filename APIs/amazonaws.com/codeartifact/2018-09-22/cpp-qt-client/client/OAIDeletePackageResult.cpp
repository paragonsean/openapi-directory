...
OAIDeletePackageResult::OAIDeletePackageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePackageResult::OAIDeletePackageResult() {
    this->initializeModel();
}

OAIDeletePackageResult::~OAIDeletePackageResult() {}

void OAIDeletePackageResult::initializeModel() {

    m_deleted_package_isSet = false;
    m_deleted_package_isValid = false;
}

void OAIDeletePackageResult::fromJson(QString jsonString) {
...
void OAIDeletePackageResult::fromJsonObject(QJsonObject json) {

    m_deleted_package_isValid = ::OpenAPI::fromJsonValue(m_deleted_package, json[QString("deletedPackage")]);
    m_deleted_package_isSet = !json[QString("deletedPackage")].isNull() && m_deleted_package_isValid;
}

QString OAIDeletePackageResult::asJson() const {
...
QJsonObject OAIDeletePackageResult::asJsonObject() const {
    QJsonObject obj;
    if (m_deleted_package.isSet()) {
        obj.insert(QString("deletedPackage"), ::OpenAPI::toJsonValue(m_deleted_package));
    }
    return obj;
}

OAIPackageSummary OAIDeletePackageResult::getDeletedPackage() const {
    return m_deleted_package;
}
void OAIDeletePackageResult::setDeletedPackage(const OAIPackageSummary &deleted_package) {
    m_deleted_package = deleted_package;
    m_deleted_package_isSet = true;
}

bool OAIDeletePackageResult::is_deleted_package_Set() const{
    return m_deleted_package_isSet;
}

bool OAIDeletePackageResult::is_deleted_package_Valid() const{
    return m_deleted_package_isValid;
}

bool OAIDeletePackageResult::isSet() const {
...
bool OAIDeletePackageResult::isValid() const {
