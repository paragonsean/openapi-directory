...
/*
 * OAICopyPackageVersionsResult.h
 *
 * 
 */

#ifndef OAICopyPackageVersionsResult_H
#define OAICopyPackageVersionsResult_H
...
class OAICopyPackageVersionsResult : public OAIObject {
public:
    OAICopyPackageVersionsResult();
    OAICopyPackageVersionsResult(QString json);
    ~OAICopyPackageVersionsResult() override;
    ...
    QMap getSuccessfulVersions() const;
    void setSuccessfulVersions(const QMap &successful_versions);
    bool is_successful_versions_Set() const;
    bool is_successful_versions_Valid() const;

    QMap getFailedVersions() const;
    void setFailedVersions(const QMap &failed_versions);
...
private:
    ...
    QMap m_successful_versions;
    bool m_successful_versions_isSet;
    bool m_successful_versions_isValid;

    QMap m_failed_versions;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyPackageVersionsResult)

#endif // OAICopyPackageVersionsResult_H
