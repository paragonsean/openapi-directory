...
/*
 * OAIPutPackageOriginConfigurationResult.h
 *
 * 
 */

#ifndef OAIPutPackageOriginConfigurationResult_H
#define OAIPutPackageOriginConfigurationResult_H
...
namespace OpenAPI {
class OAIPutPackageOriginConfigurationResult_originConfiguration;

class OAIPutPackageOriginConfigurationResult : public OAIObject {
public:
    OAIPutPackageOriginConfigurationResult();
    OAIPutPackageOriginConfigurationResult(QString json);
    ~OAIPutPackageOriginConfigurationResult() override;
    ...
    OAIPutPackageOriginConfigurationResult_originConfiguration getOriginConfiguration() const;
    void setOriginConfiguration(const OAIPutPackageOriginConfigurationResult_originConfiguration &origin_configuration);
...
private:
    ...
    OAIPutPackageOriginConfigurationResult_originConfiguration m_origin_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfigurationResult)

#endif // OAIPutPackageOriginConfigurationResult_H
