...
/*
 * OAIPublishPackageVersionRequest.h
 *
 * 
 */

#ifndef OAIPublishPackageVersionRequest_H
#define OAIPublishPackageVersionRequest_H
...
class OAIPublishPackageVersionRequest : public OAIObject {
public:
    OAIPublishPackageVersionRequest();
    OAIPublishPackageVersionRequest(QString json);
    ~OAIPublishPackageVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishPackageVersionRequest)

#endif // OAIPublishPackageVersionRequest_H
