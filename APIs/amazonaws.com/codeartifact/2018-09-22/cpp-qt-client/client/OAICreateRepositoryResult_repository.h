...
/*
 * OAICreateRepositoryResult_repository.h
 *
 * 
 */

#ifndef OAICreateRepositoryResult_repository_H
#define OAICreateRepositoryResult_repository_H
...
class OAICreateRepositoryResult_repository : public OAIObject {
public:
    OAICreateRepositoryResult_repository();
    OAICreateRepositoryResult_repository(QString json);
    ~OAICreateRepositoryResult_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryResult_repository)

#endif // OAICreateRepositoryResult_repository_H
