...
OAIPackageVersionOrigin_domainEntryPoint::OAIPackageVersionOrigin_domainEntryPoint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionOrigin_domainEntryPoint::OAIPackageVersionOrigin_domainEntryPoint() {
    this->initializeModel();
}

OAIPackageVersionOrigin_domainEntryPoint::~OAIPackageVersionOrigin_domainEntryPoint() {}

void OAIPackageVersionOrigin_domainEntryPoint::initializeModel() {
...
void OAIPackageVersionOrigin_domainEntryPoint::fromJson(QString jsonString) {
...
void OAIPackageVersionOrigin_domainEntryPoint::fromJsonObject(QJsonObject json) {
...
QString OAIPackageVersionOrigin_domainEntryPoint::asJson() const {
...
QJsonObject OAIPackageVersionOrigin_domainEntryPoint::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPackageVersionOrigin_domainEntryPoint::getRepositoryName() const {
    return m_repository_name;
}
void OAIPackageVersionOrigin_domainEntryPoint::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIPackageVersionOrigin_domainEntryPoint::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIPackageVersionOrigin_domainEntryPoint::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIPackageVersionOrigin_domainEntryPoint::getExternalConnectionName() const {
    return m_external_connection_name;
}
void OAIPackageVersionOrigin_domainEntryPoint::setExternalConnectionName(const QString &external_connection_name) {
    m_external_connection_name = external_connection_name;
    m_external_connection_name_isSet = true;
}

bool OAIPackageVersionOrigin_domainEntryPoint::is_external_connection_name_Set() const{
    return m_external_connection_name_isSet;
}

bool OAIPackageVersionOrigin_domainEntryPoint::is_external_connection_name_Valid() const{
    return m_external_connection_name_isValid;
}

bool OAIPackageVersionOrigin_domainEntryPoint::isSet() const {
...
bool OAIPackageVersionOrigin_domainEntryPoint::isValid() const {
