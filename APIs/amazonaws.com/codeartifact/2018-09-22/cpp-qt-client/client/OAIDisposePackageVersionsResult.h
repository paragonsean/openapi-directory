...
/*
 * OAIDisposePackageVersionsResult.h
 *
 * 
 */

#ifndef OAIDisposePackageVersionsResult_H
#define OAIDisposePackageVersionsResult_H
...
class OAIDisposePackageVersionsResult : public OAIObject {
public:
    OAIDisposePackageVersionsResult();
    OAIDisposePackageVersionsResult(QString json);
    ~OAIDisposePackageVersionsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisposePackageVersionsResult)

#endif // OAIDisposePackageVersionsResult_H
