...
#include "OAIDeleteDomainResult_domain.h"
...
OAIDeleteDomainResult_domain::OAIDeleteDomainResult_domain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDomainResult_domain::OAIDeleteDomainResult_domain() {
    this->initializeModel();
}

OAIDeleteDomainResult_domain::~OAIDeleteDomainResult_domain() {}

void OAIDeleteDomainResult_domain::initializeModel() {
...
void OAIDeleteDomainResult_domain::fromJson(QString jsonString) {
...
void OAIDeleteDomainResult_domain::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDomainResult_domain::asJson() const {
...
QJsonObject OAIDeleteDomainResult_domain::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDeleteDomainResult_domain::getName() const {
    return m_name;
}
void OAIDeleteDomainResult_domain::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteDomainResult_domain::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDeleteDomainResult_domain::getOwner() const {
    return m_owner;
}
void OAIDeleteDomainResult_domain::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIDeleteDomainResult_domain::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIDeleteDomainResult_domain::getArn() const {
    return m_arn;
}
void OAIDeleteDomainResult_domain::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDeleteDomainResult_domain::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDomainStatus OAIDeleteDomainResult_domain::getStatus() const {
    return m_status;
}
void OAIDeleteDomainResult_domain::setStatus(const OAIDomainStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDeleteDomainResult_domain::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDeleteDomainResult_domain::getCreatedTime() const {
    return m_created_time;
}
void OAIDeleteDomainResult_domain::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDeleteDomainResult_domain::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDeleteDomainResult_domain::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIDeleteDomainResult_domain::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIDeleteDomainResult_domain::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

qint32 OAIDeleteDomainResult_domain::getRepositoryCount() const {
    return m_repository_count;
}
void OAIDeleteDomainResult_domain::setRepositoryCount(const qint32 &repository_count) {
    m_repository_count = repository_count;
    m_repository_count_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_repository_count_Set() const{
    return m_repository_count_isSet;
}

bool OAIDeleteDomainResult_domain::is_repository_count_Valid() const{
    return m_repository_count_isValid;
}

qint32 OAIDeleteDomainResult_domain::getAssetSizeBytes() const {
    return m_asset_size_bytes;
}
void OAIDeleteDomainResult_domain::setAssetSizeBytes(const qint32 &asset_size_bytes) {
    m_asset_size_bytes = asset_size_bytes;
    m_asset_size_bytes_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_asset_size_bytes_Set() const{
    return m_asset_size_bytes_isSet;
}

bool OAIDeleteDomainResult_domain::is_asset_size_bytes_Valid() const{
    return m_asset_size_bytes_isValid;
}

QString OAIDeleteDomainResult_domain::getS3BucketArn() const {
    return m_s3_bucket_arn;
}
void OAIDeleteDomainResult_domain::setS3BucketArn(const QString &s3_bucket_arn) {
    m_s3_bucket_arn = s3_bucket_arn;
    m_s3_bucket_arn_isSet = true;
}

bool OAIDeleteDomainResult_domain::is_s3_bucket_arn_Set() const{
    return m_s3_bucket_arn_isSet;
}

bool OAIDeleteDomainResult_domain::is_s3_bucket_arn_Valid() const{
    return m_s3_bucket_arn_isValid;
}

bool OAIDeleteDomainResult_domain::isSet() const {
...
bool OAIDeleteDomainResult_domain::isValid() const {
