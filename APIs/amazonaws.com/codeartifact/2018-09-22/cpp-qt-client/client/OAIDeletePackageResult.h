...
/*
 * OAIDeletePackageResult.h
 *
 * 
 */

#ifndef OAIDeletePackageResult_H
#define OAIDeletePackageResult_H

#include <QJsonObject>

#include "OAIPackageSummary.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPackageSummary;

class OAIDeletePackageResult : public OAIObject {
public:
    OAIDeletePackageResult();
    OAIDeletePackageResult(QString json);
    ~OAIDeletePackageResult() override;
    ...
    OAIPackageSummary getDeletedPackage() const;
    void setDeletedPackage(const OAIPackageSummary &deleted_package);
    bool is_deleted_package_Set() const;
    bool is_deleted_package_Valid() const;
...
private:
    ...
    OAIPackageSummary m_deleted_package;
    bool m_deleted_package_isSet;
    bool m_deleted_package_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeletePackageResult)

#endif // OAIDeletePackageResult_H
