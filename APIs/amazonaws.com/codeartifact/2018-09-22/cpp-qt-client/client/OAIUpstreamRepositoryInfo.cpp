...
#include "OAIUpstreamRepositoryInfo.h"
...
OAIUpstreamRepositoryInfo::OAIUpstreamRepositoryInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpstreamRepositoryInfo::OAIUpstreamRepositoryInfo() {
    this->initializeModel();
}

OAIUpstreamRepositoryInfo::~OAIUpstreamRepositoryInfo() {}

void OAIUpstreamRepositoryInfo::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;
}

void OAIUpstreamRepositoryInfo::fromJson(QString jsonString) {
...
void OAIUpstreamRepositoryInfo::fromJsonObject(QJsonObject json) {
...
QString OAIUpstreamRepositoryInfo::asJson() const {
...
QJsonObject OAIUpstreamRepositoryInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpstreamRepositoryInfo::getRepositoryName() const {
    return m_repository_name;
}
void OAIUpstreamRepositoryInfo::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIUpstreamRepositoryInfo::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIUpstreamRepositoryInfo::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIUpstreamRepositoryInfo::isSet() const {
...
bool OAIUpstreamRepositoryInfo::isValid() const {
