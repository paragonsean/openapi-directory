...
#include "OAIPublishPackageVersionRequest.h"
...
OAIPublishPackageVersionRequest::OAIPublishPackageVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishPackageVersionRequest::OAIPublishPackageVersionRequest() {
    this->initializeModel();
}

OAIPublishPackageVersionRequest::~OAIPublishPackageVersionRequest() {}

void OAIPublishPackageVersionRequest::initializeModel() {

    m_asset_content_isSet = false;
    m_asset_content_isValid = false;
}

void OAIPublishPackageVersionRequest::fromJson(QString jsonString) {
...
void OAIPublishPackageVersionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPublishPackageVersionRequest::asJson() const {
...
QJsonObject OAIPublishPackageVersionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPublishPackageVersionRequest::getAssetContent() const {
    return m_asset_content;
}
void OAIPublishPackageVersionRequest::setAssetContent(const QString &asset_content) {
    m_asset_content = asset_content;
    m_asset_content_isSet = true;
}

bool OAIPublishPackageVersionRequest::is_asset_content_Set() const{
    return m_asset_content_isSet;
}

bool OAIPublishPackageVersionRequest::is_asset_content_Valid() const{
    return m_asset_content_isValid;
}

bool OAIPublishPackageVersionRequest::isSet() const {
...
bool OAIPublishPackageVersionRequest::isValid() const {
