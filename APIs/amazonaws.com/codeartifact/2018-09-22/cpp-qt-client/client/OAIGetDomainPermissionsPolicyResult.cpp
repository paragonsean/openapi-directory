...
OAIGetDomainPermissionsPolicyResult::OAIGetDomainPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDomainPermissionsPolicyResult::OAIGetDomainPermissionsPolicyResult() {
    this->initializeModel();
}

OAIGetDomainPermissionsPolicyResult::~OAIGetDomainPermissionsPolicyResult() {}

void OAIGetDomainPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIGetDomainPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIGetDomainPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIGetDomainPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIGetDomainPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIGetDomainPermissionsPolicyResult_policy OAIGetDomainPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIGetDomainPermissionsPolicyResult::setPolicy(const OAIGetDomainPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIGetDomainPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIGetDomainPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIGetDomainPermissionsPolicyResult::isSet() const {
...
bool OAIGetDomainPermissionsPolicyResult::isValid() const {
