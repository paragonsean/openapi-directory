...
OAIGetPackageVersionAssetResult::OAIGetPackageVersionAssetResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPackageVersionAssetResult::OAIGetPackageVersionAssetResult() {
    this->initializeModel();
}

OAIGetPackageVersionAssetResult::~OAIGetPackageVersionAssetResult() {}

void OAIGetPackageVersionAssetResult::initializeModel() {

    m_asset_isSet = false;
    m_asset_isValid = false;
}

void OAIGetPackageVersionAssetResult::fromJson(QString jsonString) {
...
void OAIGetPackageVersionAssetResult::fromJsonObject(QJsonObject json) {

    m_asset_isValid = ::OpenAPI::fromJsonValue(m_asset, json[QString("asset")]);
    m_asset_isSet = !json[QString("asset")].isNull() && m_asset_isValid;
}

QString OAIGetPackageVersionAssetResult::asJson() const {
...
QJsonObject OAIGetPackageVersionAssetResult::asJsonObject() const {
    QJsonObject obj;
    if (m_asset_isSet) {
...
QString OAIGetPackageVersionAssetResult::getAsset() const {
    return m_asset;
}
void OAIGetPackageVersionAssetResult::setAsset(const QString &asset) {
    m_asset = asset;
    m_asset_isSet = true;
}

bool OAIGetPackageVersionAssetResult::is_asset_Set() const{
    return m_asset_isSet;
}

bool OAIGetPackageVersionAssetResult::is_asset_Valid() const{
    return m_asset_isValid;
}

bool OAIGetPackageVersionAssetResult::isSet() const {
...
bool OAIGetPackageVersionAssetResult::isValid() const {
