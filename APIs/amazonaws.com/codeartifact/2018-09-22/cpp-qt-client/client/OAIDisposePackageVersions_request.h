...
/*
 * OAIDisposePackageVersions_request.h
 *
 * 
 */

#ifndef OAIDisposePackageVersions_request_H
#define OAIDisposePackageVersions_request_H
...
class OAIDisposePackageVersions_request : public OAIObject {
public:
    OAIDisposePackageVersions_request();
    OAIDisposePackageVersions_request(QString json);
    ~OAIDisposePackageVersions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisposePackageVersions_request)

#endif // OAIDisposePackageVersions_request_H
