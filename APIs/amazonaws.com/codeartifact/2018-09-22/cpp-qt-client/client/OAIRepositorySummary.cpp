...
#include "OAIRepositorySummary.h"
...
OAIRepositorySummary::OAIRepositorySummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositorySummary::OAIRepositorySummary() {
    this->initializeModel();
}

OAIRepositorySummary::~OAIRepositorySummary() {}

void OAIRepositorySummary::initializeModel() {
...
void OAIRepositorySummary::fromJson(QString jsonString) {
...
void OAIRepositorySummary::fromJsonObject(QJsonObject json) {
...
QString OAIRepositorySummary::asJson() const {
...
QJsonObject OAIRepositorySummary::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIRepositorySummary::getName() const {
    return m_name;
}
void OAIRepositorySummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRepositorySummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRepositorySummary::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRepositorySummary::getAdministratorAccount() const {
    return m_administrator_account;
}
void OAIRepositorySummary::setAdministratorAccount(const QString &administrator_account) {
    m_administrator_account = administrator_account;
    m_administrator_account_isSet = true;
}

bool OAIRepositorySummary::is_administrator_account_Set() const{
    return m_administrator_account_isSet;
}

bool OAIRepositorySummary::is_administrator_account_Valid() const{
    return m_administrator_account_isValid;
}

QString OAIRepositorySummary::getDomainName() const {
    return m_domain_name;
}
void OAIRepositorySummary::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIRepositorySummary::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIRepositorySummary::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIRepositorySummary::getDomainOwner() const {
    return m_domain_owner;
}
void OAIRepositorySummary::setDomainOwner(const QString &domain_owner) {
    m_domain_owner = domain_owner;
    m_domain_owner_isSet = true;
}

bool OAIRepositorySummary::is_domain_owner_Set() const{
    return m_domain_owner_isSet;
}

bool OAIRepositorySummary::is_domain_owner_Valid() const{
    return m_domain_owner_isValid;
}

QString OAIRepositorySummary::getArn() const {
    return m_arn;
}
void OAIRepositorySummary::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRepositorySummary::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRepositorySummary::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIRepositorySummary::getDescription() const {
    return m_description;
}
void OAIRepositorySummary::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRepositorySummary::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRepositorySummary::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIRepositorySummary::getCreatedTime() const {
    return m_created_time;
}
void OAIRepositorySummary::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRepositorySummary::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRepositorySummary::is_created_time_Valid() const{
    return m_created_time_isValid;
}

bool OAIRepositorySummary::isSet() const {
...
bool OAIRepositorySummary::isValid() const {
