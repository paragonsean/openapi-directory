...
#include "OAISuccessfulPackageVersionInfo.h"
...
OAISuccessfulPackageVersionInfo::OAISuccessfulPackageVersionInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISuccessfulPackageVersionInfo::OAISuccessfulPackageVersionInfo() {
    this->initializeModel();
}

OAISuccessfulPackageVersionInfo::~OAISuccessfulPackageVersionInfo() {}

void OAISuccessfulPackageVersionInfo::initializeModel() {
...
void OAISuccessfulPackageVersionInfo::fromJson(QString jsonString) {
...
void OAISuccessfulPackageVersionInfo::fromJsonObject(QJsonObject json) {
...
QString OAISuccessfulPackageVersionInfo::asJson() const {
...
QJsonObject OAISuccessfulPackageVersionInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_revision_isSet) {
...
QString OAISuccessfulPackageVersionInfo::getRevision() const {
    return m_revision;
}
void OAISuccessfulPackageVersionInfo::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAISuccessfulPackageVersionInfo::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAISuccessfulPackageVersionInfo::is_revision_Valid() const{
    return m_revision_isValid;
}

OAIPackageVersionStatus OAISuccessfulPackageVersionInfo::getStatus() const {
    return m_status;
}
void OAISuccessfulPackageVersionInfo::setStatus(const OAIPackageVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISuccessfulPackageVersionInfo::is_status_Set() const{
    return m_status_isSet;
}

bool OAISuccessfulPackageVersionInfo::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISuccessfulPackageVersionInfo::isSet() const {
...
bool OAISuccessfulPackageVersionInfo::isValid() const {
