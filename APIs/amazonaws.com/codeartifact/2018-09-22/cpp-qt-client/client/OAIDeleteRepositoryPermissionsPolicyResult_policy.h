...
/*
 * OAIDeleteRepositoryPermissionsPolicyResult_policy.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryPermissionsPolicyResult_policy_H
#define OAIDeleteRepositoryPermissionsPolicyResult_policy_H
...
class OAIDeleteRepositoryPermissionsPolicyResult_policy : public OAIObject {
public:
    OAIDeleteRepositoryPermissionsPolicyResult_policy();
    OAIDeleteRepositoryPermissionsPolicyResult_policy(QString json);
    ~OAIDeleteRepositoryPermissionsPolicyResult_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryPermissionsPolicyResult_policy)

#endif // OAIDeleteRepositoryPermissionsPolicyResult_policy_H
