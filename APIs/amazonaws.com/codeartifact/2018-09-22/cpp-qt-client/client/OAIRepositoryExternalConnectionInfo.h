...
/*
 * OAIRepositoryExternalConnectionInfo.h
 *
 *  Contains information about the external connection of a repository. 
 */

#ifndef OAIRepositoryExternalConnectionInfo_H
#define OAIRepositoryExternalConnectionInfo_H
...
class OAIRepositoryExternalConnectionInfo : public OAIObject {
public:
    OAIRepositoryExternalConnectionInfo();
    OAIRepositoryExternalConnectionInfo(QString json);
    ~OAIRepositoryExternalConnectionInfo() override;
    ...
    OAIPackageFormat getPackageFormat() const;
    void setPackageFormat(const OAIPackageFormat &package_format);
    bool is_package_format_Set() const;
    bool is_package_format_Valid() const;

    OAIExternalConnectionStatus getStatus() const;
    void setStatus(const OAIExternalConnectionStatus &status);
...
private:
    ...
    OAIPackageFormat m_package_format;
    bool m_package_format_isSet;
    bool m_package_format_isValid;

    OAIExternalConnectionStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositoryExternalConnectionInfo)

#endif // OAIRepositoryExternalConnectionInfo_H
