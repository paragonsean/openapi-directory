...
/*
 * OAICreateDomainResult.h
 *
 * 
 */

#ifndef OAICreateDomainResult_H
#define OAICreateDomainResult_H

#include <QJsonObject>

#include "OAICreateDomainResult_domain.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateDomainResult_domain;

class OAICreateDomainResult : public OAIObject {
public:
    OAICreateDomainResult();
    OAICreateDomainResult(QString json);
    ~OAICreateDomainResult() override;
    ...
    OAICreateDomainResult_domain getDomain() const;
    void setDomain(const OAICreateDomainResult_domain &domain);
...
private:
    ...
    OAICreateDomainResult_domain m_domain;
    bool m_domain_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainResult)

#endif // OAICreateDomainResult_H
