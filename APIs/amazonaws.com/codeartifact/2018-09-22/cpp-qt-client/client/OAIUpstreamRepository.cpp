...
OAIUpstreamRepository::OAIUpstreamRepository(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpstreamRepository::OAIUpstreamRepository() {
    this->initializeModel();
}

OAIUpstreamRepository::~OAIUpstreamRepository() {}

void OAIUpstreamRepository::initializeModel() {

    m_repository_name_isSet = false;
    m_repository_name_isValid = false;
}

void OAIUpstreamRepository::fromJson(QString jsonString) {
...
void OAIUpstreamRepository::fromJsonObject(QJsonObject json) {
...
QString OAIUpstreamRepository::asJson() const {
...
QJsonObject OAIUpstreamRepository::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpstreamRepository::getRepositoryName() const {
    return m_repository_name;
}
void OAIUpstreamRepository::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIUpstreamRepository::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIUpstreamRepository::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

bool OAIUpstreamRepository::isSet() const {
...
bool OAIUpstreamRepository::isValid() const {
