...
#include "OAIPackageOriginRestrictions.h"
...
OAIPackageOriginRestrictions::OAIPackageOriginRestrictions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageOriginRestrictions::OAIPackageOriginRestrictions() {
    this->initializeModel();
}

OAIPackageOriginRestrictions::~OAIPackageOriginRestrictions() {}

void OAIPackageOriginRestrictions::initializeModel() {
...
void OAIPackageOriginRestrictions::fromJson(QString jsonString) {
...
void OAIPackageOriginRestrictions::fromJsonObject(QJsonObject json) {
...
QString OAIPackageOriginRestrictions::asJson() const {
...
QJsonObject OAIPackageOriginRestrictions::asJsonObject() const {
    QJsonObject obj;
    if (m_publish.isSet()) {
...
OAIAllowPublish OAIPackageOriginRestrictions::getPublish() const {
    return m_publish;
}
void OAIPackageOriginRestrictions::setPublish(const OAIAllowPublish &publish) {
    m_publish = publish;
    m_publish_isSet = true;
}

bool OAIPackageOriginRestrictions::is_publish_Set() const{
    return m_publish_isSet;
}

bool OAIPackageOriginRestrictions::is_publish_Valid() const{
    return m_publish_isValid;
}

OAIAllowUpstream OAIPackageOriginRestrictions::getUpstream() const {
    return m_upstream;
}
void OAIPackageOriginRestrictions::setUpstream(const OAIAllowUpstream &upstream) {
    m_upstream = upstream;
    m_upstream_isSet = true;
}

bool OAIPackageOriginRestrictions::is_upstream_Set() const{
    return m_upstream_isSet;
}

bool OAIPackageOriginRestrictions::is_upstream_Valid() const{
    return m_upstream_isValid;
}

bool OAIPackageOriginRestrictions::isSet() const {
...
bool OAIPackageOriginRestrictions::isValid() const {
