...
OAIAllowUpstream::OAIAllowUpstream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllowUpstream::OAIAllowUpstream() {
    this->initializeModel();
}

OAIAllowUpstream::~OAIAllowUpstream() {}

void OAIAllowUpstream::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAllowUpstream::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAllowUpstream::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAllowUpstream::ALLOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BLOCK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAllowUpstream::BLOCK;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAllowUpstream::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAllowUpstream::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAllowUpstream::ALLOW:
            val = "ALLOW";
            break;
        case eOAIAllowUpstream::BLOCK:
            val = "BLOCK";
            break;
        default:
            break;
...
QJsonValue OAIAllowUpstream::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAllowUpstream::eOAIAllowUpstream OAIAllowUpstream::getValue() const {
    return m_value;
}

void OAIAllowUpstream::setValue(const OAIAllowUpstream::eOAIAllowUpstream& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAllowUpstream::isSet() const {
    
    return m_value_isSet;
}

bool OAIAllowUpstream::isValid() const {
