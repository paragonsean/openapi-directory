...
OAIDisassociateExternalConnectionResult::OAIDisassociateExternalConnectionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociateExternalConnectionResult::OAIDisassociateExternalConnectionResult() {
    this->initializeModel();
}

OAIDisassociateExternalConnectionResult::~OAIDisassociateExternalConnectionResult() {}

void OAIDisassociateExternalConnectionResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAIDisassociateExternalConnectionResult::fromJson(QString jsonString) {
...
void OAIDisassociateExternalConnectionResult::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociateExternalConnectionResult::asJson() const {
...
QJsonObject OAIDisassociateExternalConnectionResult::asJsonObject() const {
    QJsonObject obj;
...
OAIDisassociateExternalConnectionResult_repository OAIDisassociateExternalConnectionResult::getRepository() const {
    return m_repository;
}
void OAIDisassociateExternalConnectionResult::setRepository(const OAIDisassociateExternalConnectionResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIDisassociateExternalConnectionResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIDisassociateExternalConnectionResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAIDisassociateExternalConnectionResult::isSet() const {
...
bool OAIDisassociateExternalConnectionResult::isValid() const {
