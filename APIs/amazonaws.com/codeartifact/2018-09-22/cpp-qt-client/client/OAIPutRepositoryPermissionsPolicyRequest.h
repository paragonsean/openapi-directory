...
/*
 * OAIPutRepositoryPermissionsPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutRepositoryPermissionsPolicyRequest_H
#define OAIPutRepositoryPermissionsPolicyRequest_H
...
class OAIPutRepositoryPermissionsPolicyRequest : public OAIObject {
public:
    OAIPutRepositoryPermissionsPolicyRequest();
    OAIPutRepositoryPermissionsPolicyRequest(QString json);
    ~OAIPutRepositoryPermissionsPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryPermissionsPolicyRequest)

#endif // OAIPutRepositoryPermissionsPolicyRequest_H
