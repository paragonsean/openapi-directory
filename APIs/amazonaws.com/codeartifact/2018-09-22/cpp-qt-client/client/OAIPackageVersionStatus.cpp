...
void OAIPackageVersionStatus::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("Published", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::PUBLISHED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Unfinished", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::UNFINISHED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Unlisted", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::UNLISTED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Archived", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::ARCHIVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Disposed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::DISPOSED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Deleted", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionStatus::DELETED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPackageVersionStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPackageVersionStatus::PUBLISHED:
            val = "Published";
            break;
        case eOAIPackageVersionStatus::UNFINISHED:
            val = "Unfinished";
            break;
        case eOAIPackageVersionStatus::UNLISTED:
            val = "Unlisted";
            break;
        case eOAIPackageVersionStatus::ARCHIVED:
            val = "Archived";
            break;
        case eOAIPackageVersionStatus::DISPOSED:
            val = "Disposed";
            break;
        case eOAIPackageVersionStatus::DELETED:
            val = "Deleted";
            break;
        default:
            break;
