...
#include "OAICopyPackageVersionsRequest.h"
...
OAICopyPackageVersionsRequest::OAICopyPackageVersionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyPackageVersionsRequest::OAICopyPackageVersionsRequest() {
    this->initializeModel();
}

OAICopyPackageVersionsRequest::~OAICopyPackageVersionsRequest() {}

void OAICopyPackageVersionsRequest::initializeModel() {
    ...
    m_include_from_upstream_isSet = false;
    m_include_from_upstream_isValid = false;
}

void OAICopyPackageVersionsRequest::fromJson(QString jsonString) {
...
void OAICopyPackageVersionsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_include_from_upstream_isValid = ::OpenAPI::fromJsonValue(m_include_from_upstream, json[QString("includeFromUpstream")]);
    m_include_from_upstream_isSet = !json[QString("includeFromUpstream")].isNull() && m_include_from_upstream_isValid;
}

QString OAICopyPackageVersionsRequest::asJson() const {
...
QJsonObject OAICopyPackageVersionsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_versions.isSet()) {
        obj.insert(QString("versions"), ::OpenAPI::toJsonValue(m_versions));
    }
    if (m_version_revisions.isSet()) {
    ...
    if (m_include_from_upstream_isSet) {
        obj.insert(QString("includeFromUpstream"), ::OpenAPI::toJsonValue(m_include_from_upstream));
    }
    return obj;
}

QList OAICopyPackageVersionsRequest::getVersions() const {
    return m_versions;
}
void OAICopyPackageVersionsRequest::setVersions(const QList &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAICopyPackageVersionsRequest::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAICopyPackageVersionsRequest::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap OAICopyPackageVersionsRequest::getVersionRevisions() const {
    return m_version_revisions;
}
void OAICopyPackageVersionsRequest::setVersionRevisions(const QMap &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAICopyPackageVersionsRequest::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAICopyPackageVersionsRequest::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

bool OAICopyPackageVersionsRequest::getAllowOverwrite() const {
    return m_allow_overwrite;
}
void OAICopyPackageVersionsRequest::setAllowOverwrite(const bool &allow_overwrite) {
    m_allow_overwrite = allow_overwrite;
    m_allow_overwrite_isSet = true;
}

bool OAICopyPackageVersionsRequest::is_allow_overwrite_Set() const{
    return m_allow_overwrite_isSet;
}

bool OAICopyPackageVersionsRequest::is_allow_overwrite_Valid() const{
    return m_allow_overwrite_isValid;
}

bool OAICopyPackageVersionsRequest::getIncludeFromUpstream() const {
    return m_include_from_upstream;
}
void OAICopyPackageVersionsRequest::setIncludeFromUpstream(const bool &include_from_upstream) {
    m_include_from_upstream = include_from_upstream;
    m_include_from_upstream_isSet = true;
}

bool OAICopyPackageVersionsRequest::is_include_from_upstream_Set() const{
    return m_include_from_upstream_isSet;
}

bool OAICopyPackageVersionsRequest::is_include_from_upstream_Valid() const{
    return m_include_from_upstream_isValid;
}

bool OAICopyPackageVersionsRequest::isSet() const {
...
bool OAICopyPackageVersionsRequest::isValid() const {
