...
OAIPutRepositoryPermissionsPolicyResult::OAIPutRepositoryPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRepositoryPermissionsPolicyResult::OAIPutRepositoryPermissionsPolicyResult() {
    this->initializeModel();
}

OAIPutRepositoryPermissionsPolicyResult::~OAIPutRepositoryPermissionsPolicyResult() {}

void OAIPutRepositoryPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIPutRepositoryPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIPutRepositoryPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIPutRepositoryPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIPutRepositoryPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIPutDomainPermissionsPolicyResult_policy OAIPutRepositoryPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIPutRepositoryPermissionsPolicyResult::setPolicy(const OAIPutDomainPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutRepositoryPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutRepositoryPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutRepositoryPermissionsPolicyResult::isSet() const {
...
bool OAIPutRepositoryPermissionsPolicyResult::isValid() const {
