...
#include "OAIPackageOriginConfiguration.h"
...
OAIPackageOriginConfiguration::OAIPackageOriginConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageOriginConfiguration::OAIPackageOriginConfiguration() {
    this->initializeModel();
}

OAIPackageOriginConfiguration::~OAIPackageOriginConfiguration() {}

void OAIPackageOriginConfiguration::initializeModel() {

    m_restrictions_isSet = false;
    m_restrictions_isValid = false;
}

void OAIPackageOriginConfiguration::fromJson(QString jsonString) {
...
void OAIPackageOriginConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPackageOriginConfiguration::asJson() const {
...
QJsonObject OAIPackageOriginConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIPackageOriginConfiguration_restrictions OAIPackageOriginConfiguration::getRestrictions() const {
    return m_restrictions;
}
void OAIPackageOriginConfiguration::setRestrictions(const OAIPackageOriginConfiguration_restrictions &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIPackageOriginConfiguration::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIPackageOriginConfiguration::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

bool OAIPackageOriginConfiguration::isSet() const {
...
bool OAIPackageOriginConfiguration::isValid() const {
