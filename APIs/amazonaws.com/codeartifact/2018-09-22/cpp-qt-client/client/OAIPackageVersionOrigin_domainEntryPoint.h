...
/*
 * OAIPackageVersionOrigin_domainEntryPoint.h
 *
 * 
 */

#ifndef OAIPackageVersionOrigin_domainEntryPoint_H
#define OAIPackageVersionOrigin_domainEntryPoint_H
...
class OAIPackageVersionOrigin_domainEntryPoint : public OAIObject {
public:
    OAIPackageVersionOrigin_domainEntryPoint();
    OAIPackageVersionOrigin_domainEntryPoint(QString json);
    ~OAIPackageVersionOrigin_domainEntryPoint() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionOrigin_domainEntryPoint)

#endif // OAIPackageVersionOrigin_domainEntryPoint_H
