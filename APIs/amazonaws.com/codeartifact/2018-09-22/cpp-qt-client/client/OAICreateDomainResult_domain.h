...
/*
 * OAICreateDomainResult_domain.h
 *
 * 
 */

#ifndef OAICreateDomainResult_domain_H
#define OAICreateDomainResult_domain_H
...
class OAICreateDomainResult_domain : public OAIObject {
public:
    OAICreateDomainResult_domain();
    OAICreateDomainResult_domain(QString json);
    ~OAICreateDomainResult_domain() override;
    ...
    qint32 getAssetSizeBytes() const;
    void setAssetSizeBytes(const qint32 &asset_size_bytes);
    bool is_asset_size_bytes_Set() const;
    bool is_asset_size_bytes_Valid() const;
...
private:
    ...
    qint32 m_asset_size_bytes;
    bool m_asset_size_bytes_isSet;
    bool m_asset_size_bytes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainResult_domain)

#endif // OAICreateDomainResult_domain_H
