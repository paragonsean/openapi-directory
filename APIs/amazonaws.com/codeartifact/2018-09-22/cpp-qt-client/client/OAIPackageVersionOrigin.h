...
/*
 * OAIPackageVersionOrigin.h
 *
 * Information about how a package version was added to a repository.
 */

#ifndef OAIPackageVersionOrigin_H
#define OAIPackageVersionOrigin_H
...
class OAIPackageVersionOrigin : public OAIObject {
public:
    OAIPackageVersionOrigin();
    OAIPackageVersionOrigin(QString json);
    ~OAIPackageVersionOrigin() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionOrigin)

#endif // OAIPackageVersionOrigin_H
