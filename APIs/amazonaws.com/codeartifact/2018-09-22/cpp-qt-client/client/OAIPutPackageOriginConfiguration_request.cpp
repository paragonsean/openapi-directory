...
OAIPutPackageOriginConfiguration_request::OAIPutPackageOriginConfiguration_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutPackageOriginConfiguration_request::OAIPutPackageOriginConfiguration_request() {
    this->initializeModel();
}

OAIPutPackageOriginConfiguration_request::~OAIPutPackageOriginConfiguration_request() {}

void OAIPutPackageOriginConfiguration_request::initializeModel() {

    m_restrictions_isSet = false;
    m_restrictions_isValid = false;
}

void OAIPutPackageOriginConfiguration_request::fromJson(QString jsonString) {
...
void OAIPutPackageOriginConfiguration_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutPackageOriginConfiguration_request::asJson() const {
...
QJsonObject OAIPutPackageOriginConfiguration_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPutPackageOriginConfiguration_request_restrictions OAIPutPackageOriginConfiguration_request::getRestrictions() const {
    return m_restrictions;
}
void OAIPutPackageOriginConfiguration_request::setRestrictions(const OAIPutPackageOriginConfiguration_request_restrictions &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIPutPackageOriginConfiguration_request::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIPutPackageOriginConfiguration_request::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

bool OAIPutPackageOriginConfiguration_request::isSet() const {
...
bool OAIPutPackageOriginConfiguration_request::isValid() const {
