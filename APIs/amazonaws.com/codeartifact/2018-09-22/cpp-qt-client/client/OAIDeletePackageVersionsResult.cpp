...
OAIDeletePackageVersionsResult::OAIDeletePackageVersionsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePackageVersionsResult::OAIDeletePackageVersionsResult() {
    this->initializeModel();
}

OAIDeletePackageVersionsResult::~OAIDeletePackageVersionsResult() {}

void OAIDeletePackageVersionsResult::initializeModel() {
...
void OAIDeletePackageVersionsResult::fromJson(QString jsonString) {
...
void OAIDeletePackageVersionsResult::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePackageVersionsResult::asJson() const {
...
QJsonObject OAIDeletePackageVersionsResult::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIDeletePackageVersionsResult::getSuccessfulVersions() const {
    return m_successful_versions;
}
void OAIDeletePackageVersionsResult::setSuccessfulVersions(const QMap &successful_versions) {
    m_successful_versions = successful_versions;
    m_successful_versions_isSet = true;
}

bool OAIDeletePackageVersionsResult::is_successful_versions_Set() const{
    return m_successful_versions_isSet;
}

bool OAIDeletePackageVersionsResult::is_successful_versions_Valid() const{
    return m_successful_versions_isValid;
}

QMap OAIDeletePackageVersionsResult::getFailedVersions() const {
    return m_failed_versions;
}
void OAIDeletePackageVersionsResult::setFailedVersions(const QMap &failed_versions) {
    m_failed_versions = failed_versions;
    m_failed_versions_isSet = true;
}

bool OAIDeletePackageVersionsResult::is_failed_versions_Set() const{
    return m_failed_versions_isSet;
}

bool OAIDeletePackageVersionsResult::is_failed_versions_Valid() const{
    return m_failed_versions_isValid;
}

bool OAIDeletePackageVersionsResult::isSet() const {
...
bool OAIDeletePackageVersionsResult::isValid() const {
