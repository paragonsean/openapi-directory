...
/*
 * OAIGetDomainPermissionsPolicyResult_policy.h
 *
 * 
 */

#ifndef OAIGetDomainPermissionsPolicyResult_policy_H
#define OAIGetDomainPermissionsPolicyResult_policy_H
...
class OAIGetDomainPermissionsPolicyResult_policy : public OAIObject {
public:
    OAIGetDomainPermissionsPolicyResult_policy();
    OAIGetDomainPermissionsPolicyResult_policy(QString json);
    ~OAIGetDomainPermissionsPolicyResult_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDomainPermissionsPolicyResult_policy)

#endif // OAIGetDomainPermissionsPolicyResult_policy_H
