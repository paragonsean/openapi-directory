...
#ifndef OAIAllowPublish_H
#define OAIAllowPublish_H
...
class OAIAllowPublish : public OAIEnum {
public:
    OAIAllowPublish();
    OAIAllowPublish(QString json);
    ~OAIAllowPublish() override;
    ...
    enum class eOAIAllowPublish {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALLOW, 
        BLOCK
    };
    OAIAllowPublish::eOAIAllowPublish getValue() const;
    void setValue(const OAIAllowPublish::eOAIAllowPublish& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowPublish)

#endif // OAIAllowPublish_H
