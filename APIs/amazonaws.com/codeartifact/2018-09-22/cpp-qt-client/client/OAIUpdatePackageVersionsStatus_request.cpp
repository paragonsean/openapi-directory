...
OAIUpdatePackageVersionsStatus_request::OAIUpdatePackageVersionsStatus_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePackageVersionsStatus_request::OAIUpdatePackageVersionsStatus_request() {
    this->initializeModel();
}

OAIUpdatePackageVersionsStatus_request::~OAIUpdatePackageVersionsStatus_request() {}

void OAIUpdatePackageVersionsStatus_request::initializeModel() {
...
void OAIUpdatePackageVersionsStatus_request::fromJson(QString jsonString) {
...
void OAIUpdatePackageVersionsStatus_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePackageVersionsStatus_request::asJson() const {
...
QJsonObject OAIUpdatePackageVersionsStatus_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIUpdatePackageVersionsStatus_request::getVersions() const {
    return m_versions;
}
void OAIUpdatePackageVersionsStatus_request::setVersions(const QList<QString> &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIUpdatePackageVersionsStatus_request::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIUpdatePackageVersionsStatus_request::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap<QString, QString> OAIUpdatePackageVersionsStatus_request::getVersionRevisions() const {
    return m_version_revisions;
}
void OAIUpdatePackageVersionsStatus_request::setVersionRevisions(const QMap<QString, QString> &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAIUpdatePackageVersionsStatus_request::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAIUpdatePackageVersionsStatus_request::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

QString OAIUpdatePackageVersionsStatus_request::getExpectedStatus() const {
    return m_expected_status;
}
void OAIUpdatePackageVersionsStatus_request::setExpectedStatus(const QString &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIUpdatePackageVersionsStatus_request::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIUpdatePackageVersionsStatus_request::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

QString OAIUpdatePackageVersionsStatus_request::getTargetStatus() const {
    return m_target_status;
}
void OAIUpdatePackageVersionsStatus_request::setTargetStatus(const QString &target_status) {
    m_target_status = target_status;
    m_target_status_isSet = true;
}

bool OAIUpdatePackageVersionsStatus_request::is_target_status_Set() const{
    return m_target_status_isSet;
}

bool OAIUpdatePackageVersionsStatus_request::is_target_status_Valid() const{
    return m_target_status_isValid;
}

bool OAIUpdatePackageVersionsStatus_request::isSet() const {
...
bool OAIUpdatePackageVersionsStatus_request::isValid() const {
