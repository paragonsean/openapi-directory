...
/*
 * OAIUpdatePackageVersionsStatusResult.h
 *
 * 
 */

#ifndef OAIUpdatePackageVersionsStatusResult_H
#define OAIUpdatePackageVersionsStatusResult_H
...
class OAIUpdatePackageVersionsStatusResult : public OAIObject {
public:
    OAIUpdatePackageVersionsStatusResult();
    OAIUpdatePackageVersionsStatusResult(QString json);
    ~OAIUpdatePackageVersionsStatusResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePackageVersionsStatusResult)

#endif // OAIUpdatePackageVersionsStatusResult_H
