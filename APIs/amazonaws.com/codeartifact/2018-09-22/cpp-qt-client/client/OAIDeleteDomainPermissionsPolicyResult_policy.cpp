...
OAIDeleteDomainPermissionsPolicyResult_policy::OAIDeleteDomainPermissionsPolicyResult_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDomainPermissionsPolicyResult_policy::OAIDeleteDomainPermissionsPolicyResult_policy() {
    this->initializeModel();
}

OAIDeleteDomainPermissionsPolicyResult_policy::~OAIDeleteDomainPermissionsPolicyResult_policy() {}

void OAIDeleteDomainPermissionsPolicyResult_policy::initializeModel() {
...
void OAIDeleteDomainPermissionsPolicyResult_policy::fromJson(QString jsonString) {
...
void OAIDeleteDomainPermissionsPolicyResult_policy::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDomainPermissionsPolicyResult_policy::asJson() const {
...
QJsonObject OAIDeleteDomainPermissionsPolicyResult_policy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteDomainPermissionsPolicyResult_policy::getResourceArn() const {
    return m_resource_arn;
}
void OAIDeleteDomainPermissionsPolicyResult_policy::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIDeleteDomainPermissionsPolicyResult_policy::getRevision() const {
    return m_revision;
}
void OAIDeleteDomainPermissionsPolicyResult_policy::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_revision_Valid() const{
    return m_revision_isValid;
}

QString OAIDeleteDomainPermissionsPolicyResult_policy::getDocument() const {
    return m_document;
}
void OAIDeleteDomainPermissionsPolicyResult_policy::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_document_Set() const{
    return m_document_isSet;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::is_document_Valid() const{
    return m_document_isValid;
}

bool OAIDeleteDomainPermissionsPolicyResult_policy::isSet() const {
...
bool OAIDeleteDomainPermissionsPolicyResult_policy::isValid() const {
