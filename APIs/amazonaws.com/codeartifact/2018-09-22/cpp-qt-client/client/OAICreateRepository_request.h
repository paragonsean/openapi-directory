...
/*
 * OAICreateRepository_request.h
 *
 * 
 */

#ifndef OAICreateRepository_request_H
#define OAICreateRepository_request_H

#include <QJsonObject>

#include "OAITag.h"
#include "OAIUpstreamRepository.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpstreamRepository;
class OAITag;

class OAICreateRepository_request : public OAIObject {
public:
    OAICreateRepository_request();
    OAICreateRepository_request(QString json);
    ~OAICreateRepository_request() override;
    ...
    QList<OAIUpstreamRepository> getUpstreams() const;
    void setUpstreams(const QList<OAIUpstreamRepository> &upstreams);
...
private:
    ...
    QList<OAIUpstreamRepository> m_upstreams;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepository_request)

#endif // OAICreateRepository_request_H
