...
QList OAIListDomainsResult::getDomains() const {
    return m_domains;
}
void OAIListDomainsResult::setDomains(const QList &domains) {
    m_domains = domains;
    m_domains_isSet = true;
}

bool OAIListDomainsResult::is_domains_Set() const{
    return m_domains_isSet;
}

bool OAIListDomainsResult::is_domains_Valid() const{
