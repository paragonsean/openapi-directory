...
#include "OAIPutPackageOriginConfigurationRequest_restrictions.h"
...
OAIPutPackageOriginConfigurationRequest_restrictions::OAIPutPackageOriginConfigurationRequest_restrictions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutPackageOriginConfigurationRequest_restrictions::OAIPutPackageOriginConfigurationRequest_restrictions() {
    this->initializeModel();
}

OAIPutPackageOriginConfigurationRequest_restrictions::~OAIPutPackageOriginConfigurationRequest_restrictions() {}

void OAIPutPackageOriginConfigurationRequest_restrictions::initializeModel() {
...
void OAIPutPackageOriginConfigurationRequest_restrictions::fromJson(QString jsonString) {
...
void OAIPutPackageOriginConfigurationRequest_restrictions::fromJsonObject(QJsonObject json) {
...
QString OAIPutPackageOriginConfigurationRequest_restrictions::asJson() const {
...
QJsonObject OAIPutPackageOriginConfigurationRequest_restrictions::asJsonObject() const {
    QJsonObject obj;
    if (m_publish.isSet()) {
...
OAIAllowPublish OAIPutPackageOriginConfigurationRequest_restrictions::getPublish() const {
    return m_publish;
}
void OAIPutPackageOriginConfigurationRequest_restrictions::setPublish(const OAIAllowPublish &publish) {
    m_publish = publish;
    m_publish_isSet = true;
}

bool OAIPutPackageOriginConfigurationRequest_restrictions::is_publish_Set() const{
    return m_publish_isSet;
}

bool OAIPutPackageOriginConfigurationRequest_restrictions::is_publish_Valid() const{
    return m_publish_isValid;
}

OAIAllowUpstream OAIPutPackageOriginConfigurationRequest_restrictions::getUpstream() const {
    return m_upstream;
}
void OAIPutPackageOriginConfigurationRequest_restrictions::setUpstream(const OAIAllowUpstream &upstream) {
    m_upstream = upstream;
    m_upstream_isSet = true;
}

bool OAIPutPackageOriginConfigurationRequest_restrictions::is_upstream_Set() const{
    return m_upstream_isSet;
}

bool OAIPutPackageOriginConfigurationRequest_restrictions::is_upstream_Valid() const{
    return m_upstream_isValid;
}

bool OAIPutPackageOriginConfigurationRequest_restrictions::isSet() const {
...
bool OAIPutPackageOriginConfigurationRequest_restrictions::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_publish_isValid && m_upstream_isValid && true;
}
