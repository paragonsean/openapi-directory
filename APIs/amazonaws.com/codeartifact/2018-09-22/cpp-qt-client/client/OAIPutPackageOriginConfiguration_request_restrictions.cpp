...
OAIPutPackageOriginConfiguration_request_restrictions::OAIPutPackageOriginConfiguration_request_restrictions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutPackageOriginConfiguration_request_restrictions::OAIPutPackageOriginConfiguration_request_restrictions() {
    this->initializeModel();
}

OAIPutPackageOriginConfiguration_request_restrictions::~OAIPutPackageOriginConfiguration_request_restrictions() {}

void OAIPutPackageOriginConfiguration_request_restrictions::initializeModel() {
...
void OAIPutPackageOriginConfiguration_request_restrictions::fromJson(QString jsonString) {
...
void OAIPutPackageOriginConfiguration_request_restrictions::fromJsonObject(QJsonObject json) {
...
QString OAIPutPackageOriginConfiguration_request_restrictions::asJson() const {
...
QJsonObject OAIPutPackageOriginConfiguration_request_restrictions::asJsonObject() const {
    QJsonObject obj;
    if (m_publish.isSet()) {
...
OAIAllowPublish OAIPutPackageOriginConfiguration_request_restrictions::getPublish() const {
    return m_publish;
}
void OAIPutPackageOriginConfiguration_request_restrictions::setPublish(const OAIAllowPublish &publish) {
    m_publish = publish;
    m_publish_isSet = true;
}

bool OAIPutPackageOriginConfiguration_request_restrictions::is_publish_Set() const{
    return m_publish_isSet;
}

bool OAIPutPackageOriginConfiguration_request_restrictions::is_publish_Valid() const{
    return m_publish_isValid;
}

OAIAllowUpstream OAIPutPackageOriginConfiguration_request_restrictions::getUpstream() const {
    return m_upstream;
}
void OAIPutPackageOriginConfiguration_request_restrictions::setUpstream(const OAIAllowUpstream &upstream) {
    m_upstream = upstream;
    m_upstream_isSet = true;
}

bool OAIPutPackageOriginConfiguration_request_restrictions::is_upstream_Set() const{
    return m_upstream_isSet;
}

bool OAIPutPackageOriginConfiguration_request_restrictions::is_upstream_Valid() const{
    return m_upstream_isValid;
}

bool OAIPutPackageOriginConfiguration_request_restrictions::isSet() const {
...
bool OAIPutPackageOriginConfiguration_request_restrictions::isValid() const {
