...
/*
 * OAIPutPackageOriginConfiguration_request.h
 *
 * 
 */

#ifndef OAIPutPackageOriginConfiguration_request_H
#define OAIPutPackageOriginConfiguration_request_H

#include <QJsonObject>

#include "OAIPutPackageOriginConfiguration_request_restrictions.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutPackageOriginConfiguration_request_restrictions;

class OAIPutPackageOriginConfiguration_request : public OAIObject {
public:
    OAIPutPackageOriginConfiguration_request();
    OAIPutPackageOriginConfiguration_request(QString json);
    ~OAIPutPackageOriginConfiguration_request() override;
    ...
    OAIPutPackageOriginConfiguration_request_restrictions getRestrictions() const;
    void setRestrictions(const OAIPutPackageOriginConfiguration_request_restrictions &restrictions);
...
private:
    ...
    OAIPutPackageOriginConfiguration_request_restrictions m_restrictions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfiguration_request)

#endif // OAIPutPackageOriginConfiguration_request_H
