...
QString OAICreateDomain_request::getEncryptionKey() const {
    return m_encryption_key;
}
void OAICreateDomain_request::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAICreateDomain_request::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAICreateDomain_request::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

QList<OAITag> OAICreateDomain_request::getTags() const {
    return m_tags;
}
void OAICreateDomain_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
