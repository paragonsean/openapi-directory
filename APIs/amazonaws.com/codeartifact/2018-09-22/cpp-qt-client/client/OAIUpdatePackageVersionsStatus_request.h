...
/*
 * OAIUpdatePackageVersionsStatus_request.h
 *
 * 
 */

#ifndef OAIUpdatePackageVersionsStatus_request_H
#define OAIUpdatePackageVersionsStatus_request_H
...
class OAIUpdatePackageVersionsStatus_request : public OAIObject {
public:
    OAIUpdatePackageVersionsStatus_request();
    OAIUpdatePackageVersionsStatus_request(QString json);
    ~OAIUpdatePackageVersionsStatus_request() override;
    ...
    QMap<QString, QString> getVersionRevisions() const;
    void setVersionRevisions(const QMap<QString, QString> &version_revisions);
    bool is_version_revisions_Set() const;
    bool is_version_revisions_Valid() const;

    QString getExpectedStatus() const;
    void setExpectedStatus(const QString &expected_status);
    bool is_expected_status_Set() const;
    bool is_expected_status_Valid() const;
...
private:
    ...
    QMap<QString, QString> m_version_revisions;
    bool m_version_revisions_isSet;
    bool m_version_revisions_isValid;

    QString m_expected_status;
    bool m_expected_status_isSet;
    bool m_expected_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePackageVersionsStatus_request)

#endif // OAIUpdatePackageVersionsStatus_request_H
