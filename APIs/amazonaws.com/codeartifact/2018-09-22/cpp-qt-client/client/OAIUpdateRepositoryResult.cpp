...
OAIUpdateRepositoryResult::OAIUpdateRepositoryResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRepositoryResult::OAIUpdateRepositoryResult() {
    this->initializeModel();
}

OAIUpdateRepositoryResult::~OAIUpdateRepositoryResult() {}

void OAIUpdateRepositoryResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAIUpdateRepositoryResult::fromJson(QString jsonString) {
...
void OAIUpdateRepositoryResult::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRepositoryResult::asJson() const {
...
QJsonObject OAIUpdateRepositoryResult::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateRepositoryResult_repository OAIUpdateRepositoryResult::getRepository() const {
    return m_repository;
}
void OAIUpdateRepositoryResult::setRepository(const OAIUpdateRepositoryResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIUpdateRepositoryResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIUpdateRepositoryResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAIUpdateRepositoryResult::isSet() const {
...
bool OAIUpdateRepositoryResult::isValid() const {
