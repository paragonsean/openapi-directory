...
OAIListRepositoriesResult::OAIListRepositoriesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRepositoriesResult::OAIListRepositoriesResult() {
    this->initializeModel();
}

OAIListRepositoriesResult::~OAIListRepositoriesResult() {}

void OAIListRepositoriesResult::initializeModel() {
...
void OAIListRepositoriesResult::fromJson(QString jsonString) {
...
void OAIListRepositoriesResult::fromJsonObject(QJsonObject json) {
...
QString OAIListRepositoriesResult::asJson() const {
...
QJsonObject OAIListRepositoriesResult::asJsonObject() const {
    QJsonObject obj;
...
QList OAIListRepositoriesResult::getRepositories() const {
    return m_repositories;
}
void OAIListRepositoriesResult::setRepositories(const QList &repositories) {
    m_repositories = repositories;
    m_repositories_isSet = true;
}

bool OAIListRepositoriesResult::is_repositories_Set() const{
    return m_repositories_isSet;
}

bool OAIListRepositoriesResult::is_repositories_Valid() const{
    return m_repositories_isValid;
}

QString OAIListRepositoriesResult::getNextToken() const {
    return m_next_token;
}
void OAIListRepositoriesResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListRepositoriesResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListRepositoriesResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListRepositoriesResult::isSet() const {
...
bool OAIListRepositoriesResult::isValid() const {
