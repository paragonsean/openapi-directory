...
#include "OAIPackageDescription.h"
...
OAIPackageDescription::OAIPackageDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageDescription::OAIPackageDescription() {
    this->initializeModel();
}

OAIPackageDescription::~OAIPackageDescription() {}

void OAIPackageDescription::initializeModel() {
...
void OAIPackageDescription::fromJson(QString jsonString) {
...
void OAIPackageDescription::fromJsonObject(QJsonObject json) {
...
QString OAIPackageDescription::asJson() const {
...
QJsonObject OAIPackageDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIPackageDescription::getFormat() const {
    return m_format;
}
void OAIPackageDescription::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPackageDescription::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPackageDescription::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPackageDescription::getRNamespace() const {
    return m_r_namespace;
}
void OAIPackageDescription::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIPackageDescription::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIPackageDescription::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIPackageDescription::getName() const {
    return m_name;
}
void OAIPackageDescription::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPackageDescription::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPackageDescription::is_name_Valid() const{
    return m_name_isValid;
}

OAIPackageDescription_originConfiguration OAIPackageDescription::getOriginConfiguration() const {
    return m_origin_configuration;
}
void OAIPackageDescription::setOriginConfiguration(const OAIPackageDescription_originConfiguration &origin_configuration) {
    m_origin_configuration = origin_configuration;
    m_origin_configuration_isSet = true;
}

bool OAIPackageDescription::is_origin_configuration_Set() const{
    return m_origin_configuration_isSet;
}

bool OAIPackageDescription::is_origin_configuration_Valid() const{
    return m_origin_configuration_isValid;
}

bool OAIPackageDescription::isSet() const {
...
bool OAIPackageDescription::isValid() const {
