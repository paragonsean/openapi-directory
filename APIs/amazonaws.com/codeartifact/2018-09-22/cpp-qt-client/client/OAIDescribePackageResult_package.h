...
/*
 * OAIDescribePackageResult_package.h
 *
 * 
 */

#ifndef OAIDescribePackageResult_package_H
#define OAIDescribePackageResult_package_H

#include <QJsonObject>

#include "OAIPackageDescription_originConfiguration.h"
...
namespace OpenAPI {
class OAIPackageDescription_originConfiguration;

class OAIDescribePackageResult_package : public OAIObject {
public:
    OAIDescribePackageResult_package();
    OAIDescribePackageResult_package(QString json);
    ~OAIDescribePackageResult_package() override;
    ...
    OAIPackageDescription_originConfiguration getOriginConfiguration() const;
    void setOriginConfiguration(const OAIPackageDescription_originConfiguration &origin_configuration);
...
private:
    ...
    OAIPackageDescription_originConfiguration m_origin_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePackageResult_package)

#endif // OAIDescribePackageResult_package_H
