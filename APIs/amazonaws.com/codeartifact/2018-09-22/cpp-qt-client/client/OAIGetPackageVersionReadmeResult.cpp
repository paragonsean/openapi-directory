...
OAIGetPackageVersionReadmeResult::OAIGetPackageVersionReadmeResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPackageVersionReadmeResult::OAIGetPackageVersionReadmeResult() {
    this->initializeModel();
}

OAIGetPackageVersionReadmeResult::~OAIGetPackageVersionReadmeResult() {}

void OAIGetPackageVersionReadmeResult::initializeModel() {
...
void OAIGetPackageVersionReadmeResult::fromJson(QString jsonString) {
...
void OAIGetPackageVersionReadmeResult::fromJsonObject(QJsonObject json) {
...
QString OAIGetPackageVersionReadmeResult::asJson() const {
...
QJsonObject OAIGetPackageVersionReadmeResult::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIGetPackageVersionReadmeResult::getFormat() const {
    return m_format;
}
void OAIGetPackageVersionReadmeResult::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIGetPackageVersionReadmeResult::getRNamespace() const {
    return m_r_namespace;
}
void OAIGetPackageVersionReadmeResult::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIGetPackageVersionReadmeResult::getPackage() const {
    return m_package;
}
void OAIGetPackageVersionReadmeResult::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_package_Valid() const{
    return m_package_isValid;
}

QString OAIGetPackageVersionReadmeResult::getVersion() const {
    return m_version;
}
void OAIGetPackageVersionReadmeResult::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_version_Set() const{
    return m_version_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIGetPackageVersionReadmeResult::getVersionRevision() const {
    return m_version_revision;
}
void OAIGetPackageVersionReadmeResult::setVersionRevision(const QString &version_revision) {
    m_version_revision = version_revision;
    m_version_revision_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_version_revision_Set() const{
    return m_version_revision_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_version_revision_Valid() const{
    return m_version_revision_isValid;
}

QString OAIGetPackageVersionReadmeResult::getReadme() const {
    return m_readme;
}
void OAIGetPackageVersionReadmeResult::setReadme(const QString &readme) {
    m_readme = readme;
    m_readme_isSet = true;
}

bool OAIGetPackageVersionReadmeResult::is_readme_Set() const{
    return m_readme_isSet;
}

bool OAIGetPackageVersionReadmeResult::is_readme_Valid() const{
    return m_readme_isValid;
}

bool OAIGetPackageVersionReadmeResult::isSet() const {
...
bool OAIGetPackageVersionReadmeResult::isValid() const {
