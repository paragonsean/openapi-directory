...
OAIGetRepositoryEndpointResult::OAIGetRepositoryEndpointResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRepositoryEndpointResult::OAIGetRepositoryEndpointResult() {
    this->initializeModel();
}

OAIGetRepositoryEndpointResult::~OAIGetRepositoryEndpointResult() {}

void OAIGetRepositoryEndpointResult::initializeModel() {

    m_repository_endpoint_isSet = false;
    m_repository_endpoint_isValid = false;
}

void OAIGetRepositoryEndpointResult::fromJson(QString jsonString) {
...
void OAIGetRepositoryEndpointResult::fromJsonObject(QJsonObject json) {

    m_repository_endpoint_isValid = ::OpenAPI::fromJsonValue(m_repository_endpoint, json[QString("repositoryEndpoint")]);
    m_repository_endpoint_isSet = !json[QString("repositoryEndpoint")].isNull() && m_repository_endpoint_isValid;
}

QString OAIGetRepositoryEndpointResult::asJson() const {
...
QJsonObject OAIGetRepositoryEndpointResult::asJsonObject() const {
    QJsonObject obj;
    if (m_repository_endpoint_isSet) {
        obj.insert(QString("repositoryEndpoint"), ::OpenAPI::toJsonValue(m_repository_endpoint));
    }
    return obj;
}

QString OAIGetRepositoryEndpointResult::getRepositoryEndpoint() const {
    return m_repository_endpoint;
}
void OAIGetRepositoryEndpointResult::setRepositoryEndpoint(const QString &repository_endpoint) {
    m_repository_endpoint = repository_endpoint;
    m_repository_endpoint_isSet = true;
}

bool OAIGetRepositoryEndpointResult::is_repository_endpoint_Set() const{
    return m_repository_endpoint_isSet;
}

bool OAIGetRepositoryEndpointResult::is_repository_endpoint_Valid() const{
    return m_repository_endpoint_isValid;
}

bool OAIGetRepositoryEndpointResult::isSet() const {
...
bool OAIGetRepositoryEndpointResult::isValid() const {
