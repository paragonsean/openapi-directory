...
/*
 * OAIPackageDependency.h
 *
 *  Details about a package dependency. 
 */

#ifndef OAIPackageDependency_H
#define OAIPackageDependency_H
...
class OAIPackageDependency : public OAIObject {
public:
    OAIPackageDependency();
    OAIPackageDependency(QString json);
    ~OAIPackageDependency() override;
    ...
    QString getVersionRequirement() const;
    void setVersionRequirement(const QString &version_requirement);
    bool is_version_requirement_Set() const;
    bool is_version_requirement_Valid() const;
...
private:
    ...
    QString m_version_requirement;
    bool m_version_requirement_isSet;
    bool m_version_requirement_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPackageDependency)

#endif // OAIPackageDependency_H
