...
OAIDomainEntryPoint::OAIDomainEntryPoint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainEntryPoint::OAIDomainEntryPoint() {
    this->initializeModel();
}

OAIDomainEntryPoint::~OAIDomainEntryPoint() {}

void OAIDomainEntryPoint::initializeModel() {
...
void OAIDomainEntryPoint::fromJson(QString jsonString) {
...
void OAIDomainEntryPoint::fromJsonObject(QJsonObject json) {
...
QString OAIDomainEntryPoint::asJson() const {
...
QJsonObject OAIDomainEntryPoint::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDomainEntryPoint::getRepositoryName() const {
    return m_repository_name;
}
void OAIDomainEntryPoint::setRepositoryName(const QString &repository_name) {
    m_repository_name = repository_name;
    m_repository_name_isSet = true;
}

bool OAIDomainEntryPoint::is_repository_name_Set() const{
    return m_repository_name_isSet;
}

bool OAIDomainEntryPoint::is_repository_name_Valid() const{
    return m_repository_name_isValid;
}

QString OAIDomainEntryPoint::getExternalConnectionName() const {
    return m_external_connection_name;
}
void OAIDomainEntryPoint::setExternalConnectionName(const QString &external_connection_name) {
    m_external_connection_name = external_connection_name;
    m_external_connection_name_isSet = true;
}

bool OAIDomainEntryPoint::is_external_connection_name_Set() const{
    return m_external_connection_name_isSet;
}

bool OAIDomainEntryPoint::is_external_connection_name_Valid() const{
    return m_external_connection_name_isValid;
}

bool OAIDomainEntryPoint::isSet() const {
...
bool OAIDomainEntryPoint::isValid() const {
