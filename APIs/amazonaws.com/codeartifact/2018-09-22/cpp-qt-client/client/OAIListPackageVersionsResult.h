...
/*
 * OAIListPackageVersionsResult.h
 *
 * 
 */

#ifndef OAIListPackageVersionsResult_H
#define OAIListPackageVersionsResult_H
...
class OAIListPackageVersionsResult : public OAIObject {
public:
    OAIListPackageVersionsResult();
    OAIListPackageVersionsResult(QString json);
    ~OAIListPackageVersionsResult() override;
    ...
    QString getDefaultDisplayVersion() const;
    void setDefaultDisplayVersion(const QString &default_display_version);
    bool is_default_display_version_Set() const;
    bool is_default_display_version_Valid() const;
...
private:
    ...
    QString m_default_display_version;
    bool m_default_display_version_isSet;
    bool m_default_display_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPackageVersionsResult)

#endif // OAIListPackageVersionsResult_H
