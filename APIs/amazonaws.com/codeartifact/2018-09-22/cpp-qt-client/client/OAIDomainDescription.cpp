...
#include "OAIDomainDescription.h"
...
OAIDomainDescription::OAIDomainDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainDescription::OAIDomainDescription() {
    this->initializeModel();
}

OAIDomainDescription::~OAIDomainDescription() {}

void OAIDomainDescription::initializeModel() {
    ...
    m_asset_size_bytes_isSet = false;
    m_asset_size_bytes_isValid = false;

    m_s3_bucket_arn_isSet = false;
    m_s3_bucket_arn_isValid = false;
}

void OAIDomainDescription::fromJson(QString jsonString) {
...
void OAIDomainDescription::fromJsonObject(QJsonObject json) {
    ...
    m_repository_count_isValid = ::OpenAPI::fromJsonValue(m_repository_count, json[QString("repositoryCount")]);
    m_repository_count_isSet = !json[QString("repositoryCount")].isNull() && m_repository_count_isValid;

    m_asset_size_bytes_isValid = ::OpenAPI::fromJsonValue(m_asset_size_bytes, json[QString("assetSizeBytes")]);
    m_asset_size_bytes_isSet = !json[QString("assetSizeBytes")].isNull() && m_asset_size_bytes_isValid;
...
QString OAIDomainDescription::asJson() const {
...
QJsonObject OAIDomainDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
    ...
    if (m_repository_count_isSet) {
        obj.insert(QString("repositoryCount"), ::OpenAPI::toJsonValue(m_repository_count));
    }
    if (m_asset_size_bytes_isSet) {
        obj.insert(QString("assetSizeBytes"), ::OpenAPI::toJsonValue(m_asset_size_bytes));
    }
...
QString OAIDomainDescription::getName() const {
    return m_name;
}
void OAIDomainDescription::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDomainDescription::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDomainDescription::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDomainDescription::getOwner() const {
    return m_owner;
}
void OAIDomainDescription::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIDomainDescription::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIDomainDescription::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIDomainDescription::getArn() const {
    return m_arn;
}
void OAIDomainDescription::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDomainDescription::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDomainDescription::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDomainStatus OAIDomainDescription::getStatus() const {
    return m_status;
}
void OAIDomainDescription::setStatus(const OAIDomainStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDomainDescription::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDomainDescription::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDomainDescription::getCreatedTime() const {
    return m_created_time;
}
void OAIDomainDescription::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDomainDescription::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDomainDescription::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAIDomainDescription::getEncryptionKey() const {
    return m_encryption_key;
}
void OAIDomainDescription::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAIDomainDescription::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAIDomainDescription::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

qint32 OAIDomainDescription::getRepositoryCount() const {
    return m_repository_count;
}
void OAIDomainDescription::setRepositoryCount(const qint32 &repository_count) {
    m_repository_count = repository_count;
    m_repository_count_isSet = true;
}

bool OAIDomainDescription::is_repository_count_Set() const{
    return m_repository_count_isSet;
}

bool OAIDomainDescription::is_repository_count_Valid() const{
    return m_repository_count_isValid;
}

qint32 OAIDomainDescription::getAssetSizeBytes() const {
    return m_asset_size_bytes;
}
void OAIDomainDescription::setAssetSizeBytes(const qint32 &asset_size_bytes) {
    m_asset_size_bytes = asset_size_bytes;
    m_asset_size_bytes_isSet = true;
}

bool OAIDomainDescription::is_asset_size_bytes_Set() const{
    return m_asset_size_bytes_isSet;
}

bool OAIDomainDescription::is_asset_size_bytes_Valid() const{
    return m_asset_size_bytes_isValid;
}

QString OAIDomainDescription::getS3BucketArn() const {
    return m_s3_bucket_arn;
}
void OAIDomainDescription::setS3BucketArn(const QString &s3_bucket_arn) {
    m_s3_bucket_arn = s3_bucket_arn;
    m_s3_bucket_arn_isSet = true;
}

bool OAIDomainDescription::is_s3_bucket_arn_Set() const{
    return m_s3_bucket_arn_isSet;
}

bool OAIDomainDescription::is_s3_bucket_arn_Valid() const{
    return m_s3_bucket_arn_isValid;
}

bool OAIDomainDescription::isSet() const {
...
bool OAIDomainDescription::isValid() const {
