...
OAIPackageSummary::OAIPackageSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageSummary::OAIPackageSummary() {
    this->initializeModel();
}

OAIPackageSummary::~OAIPackageSummary() {}

void OAIPackageSummary::initializeModel() {
...
void OAIPackageSummary::fromJson(QString jsonString) {
...
void OAIPackageSummary::fromJsonObject(QJsonObject json) {
...
QString OAIPackageSummary::asJson() const {
...
QJsonObject OAIPackageSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIPackageSummary::getFormat() const {
    return m_format;
}
void OAIPackageSummary::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPackageSummary::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPackageSummary::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPackageSummary::getRNamespace() const {
    return m_r_namespace;
}
void OAIPackageSummary::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIPackageSummary::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIPackageSummary::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIPackageSummary::getPackage() const {
    return m_package;
}
void OAIPackageSummary::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIPackageSummary::is_package_Set() const{
    return m_package_isSet;
}

bool OAIPackageSummary::is_package_Valid() const{
    return m_package_isValid;
}

OAIPackageSummary_originConfiguration OAIPackageSummary::getOriginConfiguration() const {
    return m_origin_configuration;
}
void OAIPackageSummary::setOriginConfiguration(const OAIPackageSummary_originConfiguration &origin_configuration) {
    m_origin_configuration = origin_configuration;
    m_origin_configuration_isSet = true;
}

bool OAIPackageSummary::is_origin_configuration_Set() const{
    return m_origin_configuration_isSet;
}

bool OAIPackageSummary::is_origin_configuration_Valid() const{
    return m_origin_configuration_isValid;
}

bool OAIPackageSummary::isSet() const {
...
bool OAIPackageSummary::isValid() const {
