...
/*
 * OAIExternalConnectionStatus.h
 *
 * 
 */

#ifndef OAIExternalConnectionStatus_H
#define OAIExternalConnectionStatus_H
...
class OAIExternalConnectionStatus : public OAIEnum {
public:
    OAIExternalConnectionStatus();
    OAIExternalConnectionStatus(QString json);
    ~OAIExternalConnectionStatus() override;
    ...
    enum class eOAIExternalConnectionStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AVAILABLE
    };
    OAIExternalConnectionStatus::eOAIExternalConnectionStatus getValue() const;
    void setValue(const OAIExternalConnectionStatus::eOAIExternalConnectionStatus& value);
...
private:
    ...
    eOAIExternalConnectionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalConnectionStatus)

#endif // OAIExternalConnectionStatus_H
