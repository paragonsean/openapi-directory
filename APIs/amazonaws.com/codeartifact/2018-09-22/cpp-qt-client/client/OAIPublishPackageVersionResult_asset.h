...
/*
 * OAIPublishPackageVersionResult_asset.h
 *
 * 
 */

#ifndef OAIPublishPackageVersionResult_asset_H
#define OAIPublishPackageVersionResult_asset_H
...
class OAIPublishPackageVersionResult_asset : public OAIObject {
public:
    OAIPublishPackageVersionResult_asset();
    OAIPublishPackageVersionResult_asset(QString json);
    ~OAIPublishPackageVersionResult_asset() override;
    ...
    QMap getHashes() const;
    void setHashes(const QMap &hashes);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishPackageVersionResult_asset)

#endif // OAIPublishPackageVersionResult_asset_H
