...
/*
 * OAIDisposePackageVersionsRequest.h
 *
 * 
 */

#ifndef OAIDisposePackageVersionsRequest_H
#define OAIDisposePackageVersionsRequest_H
...
class OAIDisposePackageVersionsRequest : public OAIObject {
public:
    OAIDisposePackageVersionsRequest();
    OAIDisposePackageVersionsRequest(QString json);
    ~OAIDisposePackageVersionsRequest() override;
    ...
    QMap getVersionRevisions() const;
    void setVersionRevisions(const QMap &version_revisions);
    bool is_version_revisions_Set() const;
    bool is_version_revisions_Valid() const;

    OAIPackageVersionStatus getExpectedStatus() const;
    void setExpectedStatus(const OAIPackageVersionStatus &expected_status);
...
private:
    ...
    QMap m_version_revisions;
    bool m_version_revisions_isSet;
    bool m_version_revisions_isValid;

    OAIPackageVersionStatus m_expected_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisposePackageVersionsRequest)

#endif // OAIDisposePackageVersionsRequest_H
