...
#ifndef OAIPackageFormat_H
#define OAIPackageFormat_H
...
class OAIPackageFormat : public OAIEnum {
public:
    OAIPackageFormat();
    OAIPackageFormat(QString json);
    ~OAIPackageFormat() override;
    ...
    OAIPackageFormat::eOAIPackageFormat getValue() const;
    void setValue(const OAIPackageFormat::eOAIPackageFormat& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageFormat)

#endif // OAIPackageFormat_H
