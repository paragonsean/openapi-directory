...
/*
 * OAIGetRepositoryEndpointResult.h
 *
 * 
 */

#ifndef OAIGetRepositoryEndpointResult_H
#define OAIGetRepositoryEndpointResult_H
...
class OAIGetRepositoryEndpointResult : public OAIObject {
public:
    OAIGetRepositoryEndpointResult();
    OAIGetRepositoryEndpointResult(QString json);
    ~OAIGetRepositoryEndpointResult() override;
    ...
    QString getRepositoryEndpoint() const;
    void setRepositoryEndpoint(const QString &repository_endpoint);
    bool is_repository_endpoint_Set() const;
    bool is_repository_endpoint_Valid() const;
...
private:
    ...
    QString m_repository_endpoint;
    bool m_repository_endpoint_isSet;
    bool m_repository_endpoint_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryEndpointResult)

#endif // OAIGetRepositoryEndpointResult_H
