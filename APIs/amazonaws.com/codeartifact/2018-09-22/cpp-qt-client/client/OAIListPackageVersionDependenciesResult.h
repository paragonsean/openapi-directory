...
/*
 * OAIListPackageVersionDependenciesResult.h
 *
 * 
 */

#ifndef OAIListPackageVersionDependenciesResult_H
#define OAIListPackageVersionDependenciesResult_H
...
class OAIListPackageVersionDependenciesResult : public OAIObject {
public:
    OAIListPackageVersionDependenciesResult();
    OAIListPackageVersionDependenciesResult(QString json);
    ~OAIListPackageVersionDependenciesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPackageVersionDependenciesResult)

#endif // OAIListPackageVersionDependenciesResult_H
