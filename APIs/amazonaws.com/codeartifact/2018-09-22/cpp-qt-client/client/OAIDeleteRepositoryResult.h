...
/*
 * OAIDeleteRepositoryResult.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryResult_H
#define OAIDeleteRepositoryResult_H

#include <QJsonObject>

#include "OAIDeleteRepositoryResult_repository.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDeleteRepositoryResult_repository;

class OAIDeleteRepositoryResult : public OAIObject {
public:
    OAIDeleteRepositoryResult();
    OAIDeleteRepositoryResult(QString json);
    ~OAIDeleteRepositoryResult() override;
    ...
    OAIDeleteRepositoryResult_repository getRepository() const;
    void setRepository(const OAIDeleteRepositoryResult_repository &repository);
...
private:
    ...
    OAIDeleteRepositoryResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryResult)

#endif // OAIDeleteRepositoryResult_H
