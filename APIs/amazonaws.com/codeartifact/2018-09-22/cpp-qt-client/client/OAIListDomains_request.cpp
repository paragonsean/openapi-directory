...
OAIListDomains_request::OAIListDomains_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDomains_request::OAIListDomains_request() {
    this->initializeModel();
}

OAIListDomains_request::~OAIListDomains_request() {}

void OAIListDomains_request::initializeModel() {
...
void OAIListDomains_request::fromJson(QString jsonString) {
...
void OAIListDomains_request::fromJsonObject(QJsonObject json) {
...
QString OAIListDomains_request::asJson() const {
...
QJsonObject OAIListDomains_request::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIListDomains_request::getMaxResults() const {
    return m_max_results;
}
void OAIListDomains_request::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDomains_request::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDomains_request::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListDomains_request::getNextToken() const {
    return m_next_token;
}
void OAIListDomains_request::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDomains_request::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDomains_request::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDomains_request::isSet() const {
...
bool OAIListDomains_request::isValid() const {
