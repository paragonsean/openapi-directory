...
/*
 * OAIUpdateRepository_request.h
 *
 * 
 */

#ifndef OAIUpdateRepository_request_H
#define OAIUpdateRepository_request_H
...
class OAIUpdateRepository_request : public OAIObject {
public:
    OAIUpdateRepository_request();
    OAIUpdateRepository_request(QString json);
    ~OAIUpdateRepository_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepository_request)

#endif // OAIUpdateRepository_request_H
