...
OAIDescribeRepositoryResult::OAIDescribeRepositoryResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRepositoryResult::OAIDescribeRepositoryResult() {
    this->initializeModel();
}

OAIDescribeRepositoryResult::~OAIDescribeRepositoryResult() {}

void OAIDescribeRepositoryResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAIDescribeRepositoryResult::fromJson(QString jsonString) {
...
void OAIDescribeRepositoryResult::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRepositoryResult::asJson() const {
...
QJsonObject OAIDescribeRepositoryResult::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeRepositoryResult_repository OAIDescribeRepositoryResult::getRepository() const {
    return m_repository;
}
void OAIDescribeRepositoryResult::setRepository(const OAIDescribeRepositoryResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIDescribeRepositoryResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIDescribeRepositoryResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAIDescribeRepositoryResult::isSet() const {
...
bool OAIDescribeRepositoryResult::isValid() const {
