...
/*
 * OAIListPackagesResult.h
 *
 * 
 */

#ifndef OAIListPackagesResult_H
#define OAIListPackagesResult_H
...
class OAIListPackagesResult : public OAIObject {
public:
    OAIListPackagesResult();
    OAIListPackagesResult(QString json);
    ~OAIListPackagesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPackagesResult)

#endif // OAIListPackagesResult_H
