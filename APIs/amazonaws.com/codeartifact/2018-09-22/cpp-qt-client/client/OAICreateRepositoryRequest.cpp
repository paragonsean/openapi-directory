...
QString OAICreateRepositoryRequest::getDescription() const {
    return m_description;
}
void OAICreateRepositoryRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateRepositoryRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateRepositoryRequest::is_description_Valid() const{
    return m_description_isValid;
}

QList OAICreateRepositoryRequest::getUpstreams() const {
    return m_upstreams;
}
void OAICreateRepositoryRequest::setUpstreams(const QList &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAICreateRepositoryRequest::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAICreateRepositoryRequest::is_upstreams_Valid() const{
