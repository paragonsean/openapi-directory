...
/*
 * OAIListDomainsResult.h
 *
 * 
 */

#ifndef OAIListDomainsResult_H
#define OAIListDomainsResult_H
...
class OAIListDomainsResult : public OAIObject {
public:
    OAIListDomainsResult();
    OAIListDomainsResult(QString json);
    ~OAIListDomainsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDomainsResult)

#endif // OAIListDomainsResult_H
