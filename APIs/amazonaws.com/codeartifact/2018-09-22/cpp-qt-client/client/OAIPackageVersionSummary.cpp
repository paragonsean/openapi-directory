...
#include "OAIPackageVersionSummary.h"
...
OAIPackageVersionSummary::OAIPackageVersionSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionSummary::OAIPackageVersionSummary() {
    this->initializeModel();
}

OAIPackageVersionSummary::~OAIPackageVersionSummary() {}

void OAIPackageVersionSummary::initializeModel() {
...
void OAIPackageVersionSummary::fromJson(QString jsonString) {
...
void OAIPackageVersionSummary::fromJsonObject(QJsonObject json) {
...
QString OAIPackageVersionSummary::asJson() const {
...
QJsonObject OAIPackageVersionSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_version_isSet) {
...
QString OAIPackageVersionSummary::getVersion() const {
    return m_version;
}
void OAIPackageVersionSummary::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPackageVersionSummary::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPackageVersionSummary::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIPackageVersionSummary::getRevision() const {
    return m_revision;
}
void OAIPackageVersionSummary::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIPackageVersionSummary::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIPackageVersionSummary::is_revision_Valid() const{
    return m_revision_isValid;
}

OAIPackageVersionStatus OAIPackageVersionSummary::getStatus() const {
    return m_status;
}
void OAIPackageVersionSummary::setStatus(const OAIPackageVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPackageVersionSummary::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPackageVersionSummary::is_status_Valid() const{
    return m_status_isValid;
}

OAIPackageVersionDescription_origin OAIPackageVersionSummary::getOrigin() const {
    return m_origin;
}
void OAIPackageVersionSummary::setOrigin(const OAIPackageVersionDescription_origin &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIPackageVersionSummary::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIPackageVersionSummary::is_origin_Valid() const{
    return m_origin_isValid;
}

bool OAIPackageVersionSummary::isSet() const {
...
bool OAIPackageVersionSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_version_isValid && m_status_isValid && true;
}
