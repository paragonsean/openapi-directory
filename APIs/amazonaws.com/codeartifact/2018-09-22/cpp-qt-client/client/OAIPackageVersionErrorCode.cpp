...
#include "OAIPackageVersionErrorCode.h"
...
OAIPackageVersionErrorCode::OAIPackageVersionErrorCode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionErrorCode::OAIPackageVersionErrorCode() {
    this->initializeModel();
}

OAIPackageVersionErrorCode::~OAIPackageVersionErrorCode() {}

void OAIPackageVersionErrorCode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPackageVersionErrorCode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPackageVersionErrorCode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALREADY_EXISTS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::ALREADY_EXISTS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MISMATCHED_REVISION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::MISMATCHED_REVISION;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MISMATCHED_STATUS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::MISMATCHED_STATUS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NOT_ALLOWED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::NOT_ALLOWED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SKIPPED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionErrorCode::SKIPPED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPackageVersionErrorCode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPackageVersionErrorCode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPackageVersionErrorCode::ALREADY_EXISTS:
            val = "ALREADY_EXISTS";
            break;
        case eOAIPackageVersionErrorCode::MISMATCHED_REVISION:
            val = "MISMATCHED_REVISION";
            break;
        case eOAIPackageVersionErrorCode::MISMATCHED_STATUS:
            val = "MISMATCHED_STATUS";
            break;
        case eOAIPackageVersionErrorCode::NOT_ALLOWED:
            val = "NOT_ALLOWED";
            break;
        case eOAIPackageVersionErrorCode::NOT_FOUND:
            val = "NOT_FOUND";
            break;
        case eOAIPackageVersionErrorCode::SKIPPED:
            val = "SKIPPED";
            break;
        default:
            break;
...
QJsonValue OAIPackageVersionErrorCode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPackageVersionErrorCode::eOAIPackageVersionErrorCode OAIPackageVersionErrorCode::getValue() const {
    return m_value;
}

void OAIPackageVersionErrorCode::setValue(const OAIPackageVersionErrorCode::eOAIPackageVersionErrorCode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPackageVersionErrorCode::isSet() const {
    
    return m_value_isSet;
}

bool OAIPackageVersionErrorCode::isValid() const {
