...
#include "OAIPackageVersionError.h"
...
OAIPackageVersionError::OAIPackageVersionError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionError::OAIPackageVersionError() {
    this->initializeModel();
}

OAIPackageVersionError::~OAIPackageVersionError() {}

void OAIPackageVersionError::initializeModel() {
...
void OAIPackageVersionError::fromJson(QString jsonString) {
...
void OAIPackageVersionError::fromJsonObject(QJsonObject json) {
...
QString OAIPackageVersionError::asJson() const {
...
QJsonObject OAIPackageVersionError::asJsonObject() const {
    QJsonObject obj;
...
OAIPackageVersionErrorCode OAIPackageVersionError::getErrorCode() const {
    return m_error_code;
}
void OAIPackageVersionError::setErrorCode(const OAIPackageVersionErrorCode &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAIPackageVersionError::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAIPackageVersionError::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QString OAIPackageVersionError::getErrorMessage() const {
    return m_error_message;
}
void OAIPackageVersionError::setErrorMessage(const QString &error_message) {
    m_error_message = error_message;
    m_error_message_isSet = true;
}

bool OAIPackageVersionError::is_error_message_Set() const{
    return m_error_message_isSet;
}

bool OAIPackageVersionError::is_error_message_Valid() const{
    return m_error_message_isValid;
}

bool OAIPackageVersionError::isSet() const {
...
bool OAIPackageVersionError::isValid() const {
