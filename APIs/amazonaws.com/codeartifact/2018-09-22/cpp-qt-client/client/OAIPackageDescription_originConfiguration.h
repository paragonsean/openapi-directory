...
/*
 * OAIPackageDescription_originConfiguration.h
 *
 * 
 */

#ifndef OAIPackageDescription_originConfiguration_H
#define OAIPackageDescription_originConfiguration_H
...
namespace OpenAPI {
class OAIPackageOriginConfiguration_restrictions;

class OAIPackageDescription_originConfiguration : public OAIObject {
public:
    OAIPackageDescription_originConfiguration();
    OAIPackageDescription_originConfiguration(QString json);
    ~OAIPackageDescription_originConfiguration() override;
    ...
    OAIPackageOriginConfiguration_restrictions getRestrictions() const;
    void setRestrictions(const OAIPackageOriginConfiguration_restrictions &restrictions);
...
private:
    ...
    OAIPackageOriginConfiguration_restrictions m_restrictions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageDescription_originConfiguration)

#endif // OAIPackageDescription_originConfiguration_H
