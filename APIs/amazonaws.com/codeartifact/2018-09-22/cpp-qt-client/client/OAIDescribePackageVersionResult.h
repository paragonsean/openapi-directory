...
/*
 * OAIDescribePackageVersionResult.h
 *
 * 
 */

#ifndef OAIDescribePackageVersionResult_H
#define OAIDescribePackageVersionResult_H
...
namespace OpenAPI {
class OAIDescribePackageVersionResult_packageVersion;

class OAIDescribePackageVersionResult : public OAIObject {
public:
    OAIDescribePackageVersionResult();
    OAIDescribePackageVersionResult(QString json);
    ~OAIDescribePackageVersionResult() override;
    ...
    OAIDescribePackageVersionResult_packageVersion getPackageVersion() const;
    void setPackageVersion(const OAIDescribePackageVersionResult_packageVersion &package_version);
...
private:
    ...
    OAIDescribePackageVersionResult_packageVersion m_package_version;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePackageVersionResult)

#endif // OAIDescribePackageVersionResult_H
