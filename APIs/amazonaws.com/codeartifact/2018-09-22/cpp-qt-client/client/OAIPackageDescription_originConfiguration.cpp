...
OAIPackageDescription_originConfiguration::OAIPackageDescription_originConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageDescription_originConfiguration::OAIPackageDescription_originConfiguration() {
    this->initializeModel();
}

OAIPackageDescription_originConfiguration::~OAIPackageDescription_originConfiguration() {}

void OAIPackageDescription_originConfiguration::initializeModel() {

    m_restrictions_isSet = false;
    m_restrictions_isValid = false;
}

void OAIPackageDescription_originConfiguration::fromJson(QString jsonString) {
...
void OAIPackageDescription_originConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPackageDescription_originConfiguration::asJson() const {
...
QJsonObject OAIPackageDescription_originConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIPackageOriginConfiguration_restrictions OAIPackageDescription_originConfiguration::getRestrictions() const {
    return m_restrictions;
}
void OAIPackageDescription_originConfiguration::setRestrictions(const OAIPackageOriginConfiguration_restrictions &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIPackageDescription_originConfiguration::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIPackageDescription_originConfiguration::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

bool OAIPackageDescription_originConfiguration::isSet() const {
...
bool OAIPackageDescription_originConfiguration::isValid() const {
