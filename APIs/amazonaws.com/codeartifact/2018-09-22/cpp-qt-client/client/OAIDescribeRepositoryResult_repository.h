...
/*
 * OAIDescribeRepositoryResult_repository.h
 *
 * 
 */

#ifndef OAIDescribeRepositoryResult_repository_H
#define OAIDescribeRepositoryResult_repository_H
...
class OAIDescribeRepositoryResult_repository : public OAIObject {
public:
    OAIDescribeRepositoryResult_repository();
    OAIDescribeRepositoryResult_repository(QString json);
    ~OAIDescribeRepositoryResult_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRepositoryResult_repository)

#endif // OAIDescribeRepositoryResult_repository_H
