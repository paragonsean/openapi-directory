...
#include "OAIGetDomainPermissionsPolicyResult_policy.h"
...
OAIGetDomainPermissionsPolicyResult_policy::OAIGetDomainPermissionsPolicyResult_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDomainPermissionsPolicyResult_policy::OAIGetDomainPermissionsPolicyResult_policy() {
    this->initializeModel();
}

OAIGetDomainPermissionsPolicyResult_policy::~OAIGetDomainPermissionsPolicyResult_policy() {}

void OAIGetDomainPermissionsPolicyResult_policy::initializeModel() {
...
void OAIGetDomainPermissionsPolicyResult_policy::fromJson(QString jsonString) {
...
void OAIGetDomainPermissionsPolicyResult_policy::fromJsonObject(QJsonObject json) {
...
QString OAIGetDomainPermissionsPolicyResult_policy::asJson() const {
...
QJsonObject OAIGetDomainPermissionsPolicyResult_policy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDomainPermissionsPolicyResult_policy::getResourceArn() const {
    return m_resource_arn;
}
void OAIGetDomainPermissionsPolicyResult_policy::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIGetDomainPermissionsPolicyResult_policy::getRevision() const {
    return m_revision;
}
void OAIGetDomainPermissionsPolicyResult_policy::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_revision_Valid() const{
    return m_revision_isValid;
}

QString OAIGetDomainPermissionsPolicyResult_policy::getDocument() const {
    return m_document;
}
void OAIGetDomainPermissionsPolicyResult_policy::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_document_Set() const{
    return m_document_isSet;
}

bool OAIGetDomainPermissionsPolicyResult_policy::is_document_Valid() const{
    return m_document_isValid;
}

bool OAIGetDomainPermissionsPolicyResult_policy::isSet() const {
...
bool OAIGetDomainPermissionsPolicyResult_policy::isValid() const {
