...
/*
 * OAIDescribePackageVersionResult_packageVersion.h
 *
 * 
 */

#ifndef OAIDescribePackageVersionResult_packageVersion_H
#define OAIDescribePackageVersionResult_packageVersion_H

#include <QJsonObject>

#include "OAIPackageFormat.h"
#include "OAIPackageVersionDescription_origin.h"
...
namespace OpenAPI {
class OAIPackageVersionDescription_origin;

class OAIDescribePackageVersionResult_packageVersion : public OAIObject {
public:
    OAIDescribePackageVersionResult_packageVersion();
    OAIDescribePackageVersionResult_packageVersion(QString json);
    ~OAIDescribePackageVersionResult_packageVersion() override;
    ...
    QString getSourceCodeRepository() const;
    void setSourceCodeRepository(const QString &source_code_repository);
    bool is_source_code_repository_Set() const;
    bool is_source_code_repository_Valid() const;
    ...
    OAIPackageVersionDescription_origin getOrigin() const;
    void setOrigin(const OAIPackageVersionDescription_origin &origin);
...
private:
    ...
    QString m_source_code_repository;
    bool m_source_code_repository_isSet;
    bool m_source_code_repository_isValid;
    ...
    OAIPackageVersionDescription_origin m_origin;
    bool m_origin_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePackageVersionResult_packageVersion)

#endif // OAIDescribePackageVersionResult_packageVersion_H
