...
/*
 * OAIListRepositoriesInDomainResult.h
 *
 * 
 */

#ifndef OAIListRepositoriesInDomainResult_H
#define OAIListRepositoriesInDomainResult_H
...
class OAIListRepositoriesInDomainResult : public OAIObject {
public:
    OAIListRepositoriesInDomainResult();
    OAIListRepositoriesInDomainResult(QString json);
    ~OAIListRepositoriesInDomainResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRepositoriesInDomainResult)

#endif // OAIListRepositoriesInDomainResult_H
