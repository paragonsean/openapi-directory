...
#include "OAIPackageVersionOrigin.h"
...
OAIPackageVersionOrigin::OAIPackageVersionOrigin(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionOrigin::OAIPackageVersionOrigin() {
    this->initializeModel();
}

OAIPackageVersionOrigin::~OAIPackageVersionOrigin() {}

void OAIPackageVersionOrigin::initializeModel() {

    m_domain_entry_point_isSet = false;
    m_domain_entry_point_isValid = false;

    m_origin_type_isSet = false;
    m_origin_type_isValid = false;
}

void OAIPackageVersionOrigin::fromJson(QString jsonString) {
...
void OAIPackageVersionOrigin::fromJsonObject(QJsonObject json) {

    m_domain_entry_point_isValid = ::OpenAPI::fromJsonValue(m_domain_entry_point, json[QString("domainEntryPoint")]);
    m_domain_entry_point_isSet = !json[QString("domainEntryPoint")].isNull() && m_domain_entry_point_isValid;
...
QString OAIPackageVersionOrigin::asJson() const {
...
QJsonObject OAIPackageVersionOrigin::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_entry_point.isSet()) {
        obj.insert(QString("domainEntryPoint"), ::OpenAPI::toJsonValue(m_domain_entry_point));
    }
...
OAIPackageVersionOrigin_domainEntryPoint OAIPackageVersionOrigin::getDomainEntryPoint() const {
    return m_domain_entry_point;
}
void OAIPackageVersionOrigin::setDomainEntryPoint(const OAIPackageVersionOrigin_domainEntryPoint &domain_entry_point) {
    m_domain_entry_point = domain_entry_point;
    m_domain_entry_point_isSet = true;
}

bool OAIPackageVersionOrigin::is_domain_entry_point_Set() const{
    return m_domain_entry_point_isSet;
}

bool OAIPackageVersionOrigin::is_domain_entry_point_Valid() const{
    return m_domain_entry_point_isValid;
}

OAIPackageVersionOriginType OAIPackageVersionOrigin::getOriginType() const {
    return m_origin_type;
}
void OAIPackageVersionOrigin::setOriginType(const OAIPackageVersionOriginType &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAIPackageVersionOrigin::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAIPackageVersionOrigin::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

bool OAIPackageVersionOrigin::isSet() const {
...
bool OAIPackageVersionOrigin::isValid() const {
