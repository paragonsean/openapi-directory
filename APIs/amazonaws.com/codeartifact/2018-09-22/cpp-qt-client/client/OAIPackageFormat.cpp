...
OAIPackageFormat::OAIPackageFormat(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageFormat::OAIPackageFormat() {
    this->initializeModel();
}

OAIPackageFormat::~OAIPackageFormat() {}

void OAIPackageFormat::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPackageFormat::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPackageFormat::fromJson(QString jsonString) {
    
    if ( jsonString.compare("npm", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageFormat::NPM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("pypi", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageFormat::PYPI;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("maven", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageFormat::MAVEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("nuget", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageFormat::NUGET;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("generic", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageFormat::GENERIC;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPackageFormat::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPackageFormat::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPackageFormat::NPM:
            val = "npm";
            break;
        case eOAIPackageFormat::PYPI:
            val = "pypi";
            break;
        case eOAIPackageFormat::MAVEN:
            val = "maven";
            break;
        case eOAIPackageFormat::NUGET:
            val = "nuget";
            break;
        case eOAIPackageFormat::GENERIC:
            val = "generic";
            break;
        default:
            break;
...
QJsonValue OAIPackageFormat::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPackageFormat::eOAIPackageFormat OAIPackageFormat::getValue() const {
    return m_value;
}

void OAIPackageFormat::setValue(const OAIPackageFormat::eOAIPackageFormat& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPackageFormat::isSet() const {
    
    return m_value_isSet;
}

bool OAIPackageFormat::isValid() const {
