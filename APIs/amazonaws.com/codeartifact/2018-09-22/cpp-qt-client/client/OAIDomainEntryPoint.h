...
#ifndef OAIDomainEntryPoint_H
#define OAIDomainEntryPoint_H
...
class OAIDomainEntryPoint : public OAIObject {
public:
    OAIDomainEntryPoint();
    OAIDomainEntryPoint(QString json);
    ~OAIDomainEntryPoint() override;
    ...
    QString getExternalConnectionName() const;
    void setExternalConnectionName(const QString &external_connection_name);
    bool is_external_connection_name_Set() const;
    bool is_external_connection_name_Valid() const;
...
private:
    ...
    QString m_external_connection_name;
    bool m_external_connection_name_isSet;
    bool m_external_connection_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDomainEntryPoint)

#endif // OAIDomainEntryPoint_H
