...
/*
 * OAIUpstreamRepositoryInfo.h
 *
 *  Information about an upstream repository. 
 */

#ifndef OAIUpstreamRepositoryInfo_H
#define OAIUpstreamRepositoryInfo_H
...
class OAIUpstreamRepositoryInfo : public OAIObject {
public:
    OAIUpstreamRepositoryInfo();
    OAIUpstreamRepositoryInfo(QString json);
    ~OAIUpstreamRepositoryInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpstreamRepositoryInfo)

#endif // OAIUpstreamRepositoryInfo_H
