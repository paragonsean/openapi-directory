...
OAIDescribePackageResult::OAIDescribePackageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePackageResult::OAIDescribePackageResult() {
    this->initializeModel();
}

OAIDescribePackageResult::~OAIDescribePackageResult() {}

void OAIDescribePackageResult::initializeModel() {

    m_package_isSet = false;
    m_package_isValid = false;
}

void OAIDescribePackageResult::fromJson(QString jsonString) {
...
void OAIDescribePackageResult::fromJsonObject(QJsonObject json) {
...
QString OAIDescribePackageResult::asJson() const {
...
QJsonObject OAIDescribePackageResult::asJsonObject() const {
    QJsonObject obj;
    if (m_package.isSet()) {
...
OAIDescribePackageResult_package OAIDescribePackageResult::getPackage() const {
    return m_package;
}
void OAIDescribePackageResult::setPackage(const OAIDescribePackageResult_package &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIDescribePackageResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIDescribePackageResult::is_package_Valid() const{
    return m_package_isValid;
}

bool OAIDescribePackageResult::isSet() const {
...
bool OAIDescribePackageResult::isValid() const {
