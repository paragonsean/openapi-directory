...
/*
 * OAIPackageVersionDescription.h
 *
 *  Details about a package version. 
 */

#ifndef OAIPackageVersionDescription_H
#define OAIPackageVersionDescription_H
...
class OAIPackageVersionDescription : public OAIObject {
public:
    OAIPackageVersionDescription();
    OAIPackageVersionDescription(QString json);
    ~OAIPackageVersionDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionDescription)

#endif // OAIPackageVersionDescription_H
