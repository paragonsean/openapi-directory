...
OAIPutDomainPermissionsPolicy_request::OAIPutDomainPermissionsPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDomainPermissionsPolicy_request::OAIPutDomainPermissionsPolicy_request() {
    this->initializeModel();
}

OAIPutDomainPermissionsPolicy_request::~OAIPutDomainPermissionsPolicy_request() {}

void OAIPutDomainPermissionsPolicy_request::initializeModel() {
    ...
    m_policy_revision_isSet = false;
    m_policy_revision_isValid = false;

    m_policy_document_isSet = false;
    m_policy_document_isValid = false;
}

void OAIPutDomainPermissionsPolicy_request::fromJson(QString jsonString) {
...
void OAIPutDomainPermissionsPolicy_request::fromJsonObject(QJsonObject json) {
    ...
    m_policy_revision_isValid = ::OpenAPI::fromJsonValue(m_policy_revision, json[QString("policyRevision")]);
    m_policy_revision_isSet = !json[QString("policyRevision")].isNull() && m_policy_revision_isValid;
...
QString OAIPutDomainPermissionsPolicy_request::asJson() const {
...
QJsonObject OAIPutDomainPermissionsPolicy_request::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
    ...
    if (m_policy_revision_isSet) {
        obj.insert(QString("policyRevision"), ::OpenAPI::toJsonValue(m_policy_revision));
    }
...
QString OAIPutDomainPermissionsPolicy_request::getDomain() const {
    return m_domain;
}
void OAIPutDomainPermissionsPolicy_request::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIPutDomainPermissionsPolicy_request::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIPutDomainPermissionsPolicy_request::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIPutDomainPermissionsPolicy_request::getDomainOwner() const {
    return m_domain_owner;
}
void OAIPutDomainPermissionsPolicy_request::setDomainOwner(const QString &domain_owner) {
    m_domain_owner = domain_owner;
    m_domain_owner_isSet = true;
}

bool OAIPutDomainPermissionsPolicy_request::is_domain_owner_Set() const{
    return m_domain_owner_isSet;
}

bool OAIPutDomainPermissionsPolicy_request::is_domain_owner_Valid() const{
    return m_domain_owner_isValid;
}

QString OAIPutDomainPermissionsPolicy_request::getPolicyRevision() const {
    return m_policy_revision;
}
void OAIPutDomainPermissionsPolicy_request::setPolicyRevision(const QString &policy_revision) {
    m_policy_revision = policy_revision;
    m_policy_revision_isSet = true;
}

bool OAIPutDomainPermissionsPolicy_request::is_policy_revision_Set() const{
    return m_policy_revision_isSet;
}

bool OAIPutDomainPermissionsPolicy_request::is_policy_revision_Valid() const{
    return m_policy_revision_isValid;
}

QString OAIPutDomainPermissionsPolicy_request::getPolicyDocument() const {
    return m_policy_document;
}
void OAIPutDomainPermissionsPolicy_request::setPolicyDocument(const QString &policy_document) {
    m_policy_document = policy_document;
    m_policy_document_isSet = true;
}

bool OAIPutDomainPermissionsPolicy_request::is_policy_document_Set() const{
    return m_policy_document_isSet;
}

bool OAIPutDomainPermissionsPolicy_request::is_policy_document_Valid() const{
    return m_policy_document_isValid;
}

bool OAIPutDomainPermissionsPolicy_request::isSet() const {
...
bool OAIPutDomainPermissionsPolicy_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_domain_isValid && m_policy_document_isValid && true;
}
