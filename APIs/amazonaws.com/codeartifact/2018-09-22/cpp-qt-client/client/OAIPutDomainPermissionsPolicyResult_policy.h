...
/*
 * OAIPutDomainPermissionsPolicyResult_policy.h
 *
 * 
 */

#ifndef OAIPutDomainPermissionsPolicyResult_policy_H
#define OAIPutDomainPermissionsPolicyResult_policy_H
...
class OAIPutDomainPermissionsPolicyResult_policy : public OAIObject {
public:
    OAIPutDomainPermissionsPolicyResult_policy();
    OAIPutDomainPermissionsPolicyResult_policy(QString json);
    ~OAIPutDomainPermissionsPolicyResult_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDomainPermissionsPolicyResult_policy)

#endif // OAIPutDomainPermissionsPolicyResult_policy_H
