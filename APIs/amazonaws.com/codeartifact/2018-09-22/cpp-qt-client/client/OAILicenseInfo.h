...
#ifndef OAILicenseInfo_H
#define OAILicenseInfo_H
...
class OAILicenseInfo : public OAIObject {
public:
    OAILicenseInfo();
    OAILicenseInfo(QString json);
    ~OAILicenseInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicenseInfo)

#endif // OAILicenseInfo_H
