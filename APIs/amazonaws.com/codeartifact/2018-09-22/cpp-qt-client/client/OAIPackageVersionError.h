...
/*
 * OAIPackageVersionError.h
 *
 * l An error associated with package. 
 */

#ifndef OAIPackageVersionError_H
#define OAIPackageVersionError_H
...
class OAIPackageVersionError : public OAIObject {
public:
    OAIPackageVersionError();
    OAIPackageVersionError(QString json);
    ~OAIPackageVersionError() override;
    ...
    OAIPackageVersionErrorCode getErrorCode() const;
    void setErrorCode(const OAIPackageVersionErrorCode &error_code);
...
private:
    ...
    OAIPackageVersionErrorCode m_error_code;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionError)

#endif // OAIPackageVersionError_H
