...
#include "OAIDeletePackageVersionsRequest.h"
...
OAIDeletePackageVersionsRequest::OAIDeletePackageVersionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePackageVersionsRequest::OAIDeletePackageVersionsRequest() {
    this->initializeModel();
}

OAIDeletePackageVersionsRequest::~OAIDeletePackageVersionsRequest() {}

void OAIDeletePackageVersionsRequest::initializeModel() {

    m_versions_isSet = false;
    m_versions_isValid = false;

    m_expected_status_isSet = false;
    m_expected_status_isValid = false;
}

void OAIDeletePackageVersionsRequest::fromJson(QString jsonString) {
...
void OAIDeletePackageVersionsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_expected_status_isValid = ::OpenAPI::fromJsonValue(m_expected_status, json[QString("expectedStatus")]);
    m_expected_status_isSet = !json[QString("expectedStatus")].isNull() && m_expected_status_isValid;
}

QString OAIDeletePackageVersionsRequest::asJson() const {
...
QJsonObject OAIDeletePackageVersionsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_versions.isSet()) {
        obj.insert(QString("versions"), ::OpenAPI::toJsonValue(m_versions));
    }
    if (m_expected_status.isSet()) {
        obj.insert(QString("expectedStatus"), ::OpenAPI::toJsonValue(m_expected_status));
    }
    return obj;
}

QList OAIDeletePackageVersionsRequest::getVersions() const {
    return m_versions;
}
void OAIDeletePackageVersionsRequest::setVersions(const QList &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIDeletePackageVersionsRequest::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIDeletePackageVersionsRequest::is_versions_Valid() const{
    return m_versions_isValid;
}

OAIPackageVersionStatus OAIDeletePackageVersionsRequest::getExpectedStatus() const {
    return m_expected_status;
}
void OAIDeletePackageVersionsRequest::setExpectedStatus(const OAIPackageVersionStatus &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIDeletePackageVersionsRequest::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIDeletePackageVersionsRequest::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

bool OAIDeletePackageVersionsRequest::isSet() const {
...
bool OAIDeletePackageVersionsRequest::isValid() const {
