...
OAIPublishPackageVersionResult_asset::OAIPublishPackageVersionResult_asset(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishPackageVersionResult_asset::OAIPublishPackageVersionResult_asset() {
    this->initializeModel();
}

OAIPublishPackageVersionResult_asset::~OAIPublishPackageVersionResult_asset() {}

void OAIPublishPackageVersionResult_asset::initializeModel() {
...
void OAIPublishPackageVersionResult_asset::fromJson(QString jsonString) {
...
void OAIPublishPackageVersionResult_asset::fromJsonObject(QJsonObject json) {
...
QString OAIPublishPackageVersionResult_asset::asJson() const {
...
QJsonObject OAIPublishPackageVersionResult_asset::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPublishPackageVersionResult_asset::getName() const {
    return m_name;
}
void OAIPublishPackageVersionResult_asset::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPublishPackageVersionResult_asset::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPublishPackageVersionResult_asset::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIPublishPackageVersionResult_asset::getSize() const {
    return m_size;
}
void OAIPublishPackageVersionResult_asset::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIPublishPackageVersionResult_asset::is_size_Set() const{
    return m_size_isSet;
}

bool OAIPublishPackageVersionResult_asset::is_size_Valid() const{
    return m_size_isValid;
}

QMap OAIPublishPackageVersionResult_asset::getHashes() const {
    return m_hashes;
}
void OAIPublishPackageVersionResult_asset::setHashes(const QMap &hashes) {
    m_hashes = hashes;
    m_hashes_isSet = true;
}

bool OAIPublishPackageVersionResult_asset::is_hashes_Set() const{
    return m_hashes_isSet;
}

bool OAIPublishPackageVersionResult_asset::is_hashes_Valid() const{
    return m_hashes_isValid;
}

bool OAIPublishPackageVersionResult_asset::isSet() const {
...
bool OAIPublishPackageVersionResult_asset::isValid() const {
