...
/*
 * OAIPublishPackageVersionResult.h
 *
 * 
 */

#ifndef OAIPublishPackageVersionResult_H
#define OAIPublishPackageVersionResult_H

#include <QJsonObject>

#include "OAIPackageFormat.h"
#include "OAIPackageVersionStatus.h"
#include "OAIPublishPackageVersionResult_asset.h"
#include <QString>
...
namespace OpenAPI {
class OAIPublishPackageVersionResult_asset;

class OAIPublishPackageVersionResult : public OAIObject {
public:
    OAIPublishPackageVersionResult();
    OAIPublishPackageVersionResult(QString json);
    ~OAIPublishPackageVersionResult() override;
    ...
    OAIPackageFormat getFormat() const;
    void setFormat(const OAIPackageFormat &format);
    ...
    QString getVersionRevision() const;
    void setVersionRevision(const QString &version_revision);
    bool is_version_revision_Set() const;
    bool is_version_revision_Valid() const;
    ...
    OAIPublishPackageVersionResult_asset getAsset() const;
    void setAsset(const OAIPublishPackageVersionResult_asset &asset);
...
private:
    ...
    QString m_version_revision;
    bool m_version_revision_isSet;
    bool m_version_revision_isValid;

    OAIPackageVersionStatus m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIPublishPackageVersionResult_asset m_asset;
    bool m_asset_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishPackageVersionResult)

#endif // OAIPublishPackageVersionResult_H
