...
OAIPublishPackageVersionResult::OAIPublishPackageVersionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishPackageVersionResult::OAIPublishPackageVersionResult() {
    this->initializeModel();
}

OAIPublishPackageVersionResult::~OAIPublishPackageVersionResult() {}

void OAIPublishPackageVersionResult::initializeModel() {
...
void OAIPublishPackageVersionResult::fromJson(QString jsonString) {
...
void OAIPublishPackageVersionResult::fromJsonObject(QJsonObject json) {
...
QString OAIPublishPackageVersionResult::asJson() const {
...
QJsonObject OAIPublishPackageVersionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIPublishPackageVersionResult::getFormat() const {
    return m_format;
}
void OAIPublishPackageVersionResult::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPublishPackageVersionResult::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPublishPackageVersionResult::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPublishPackageVersionResult::getRNamespace() const {
    return m_r_namespace;
}
void OAIPublishPackageVersionResult::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIPublishPackageVersionResult::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIPublishPackageVersionResult::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIPublishPackageVersionResult::getPackage() const {
    return m_package;
}
void OAIPublishPackageVersionResult::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIPublishPackageVersionResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIPublishPackageVersionResult::is_package_Valid() const{
    return m_package_isValid;
}

QString OAIPublishPackageVersionResult::getVersion() const {
    return m_version;
}
void OAIPublishPackageVersionResult::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPublishPackageVersionResult::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPublishPackageVersionResult::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIPublishPackageVersionResult::getVersionRevision() const {
    return m_version_revision;
}
void OAIPublishPackageVersionResult::setVersionRevision(const QString &version_revision) {
    m_version_revision = version_revision;
    m_version_revision_isSet = true;
}

bool OAIPublishPackageVersionResult::is_version_revision_Set() const{
    return m_version_revision_isSet;
}

bool OAIPublishPackageVersionResult::is_version_revision_Valid() const{
    return m_version_revision_isValid;
}

OAIPackageVersionStatus OAIPublishPackageVersionResult::getStatus() const {
    return m_status;
}
void OAIPublishPackageVersionResult::setStatus(const OAIPackageVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPublishPackageVersionResult::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPublishPackageVersionResult::is_status_Valid() const{
    return m_status_isValid;
}

OAIPublishPackageVersionResult_asset OAIPublishPackageVersionResult::getAsset() const {
    return m_asset;
}
void OAIPublishPackageVersionResult::setAsset(const OAIPublishPackageVersionResult_asset &asset) {
    m_asset = asset;
    m_asset_isSet = true;
}

bool OAIPublishPackageVersionResult::is_asset_Set() const{
    return m_asset_isSet;
}

bool OAIPublishPackageVersionResult::is_asset_Valid() const{
    return m_asset_isValid;
}

bool OAIPublishPackageVersionResult::isSet() const {
...
bool OAIPublishPackageVersionResult::isValid() const {
