...
OAIAssetSummary::OAIAssetSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssetSummary::OAIAssetSummary() {
    this->initializeModel();
}

OAIAssetSummary::~OAIAssetSummary() {}

void OAIAssetSummary::initializeModel() {
...
void OAIAssetSummary::fromJson(QString jsonString) {
...
void OAIAssetSummary::fromJsonObject(QJsonObject json) {
...
QString OAIAssetSummary::asJson() const {
...
QJsonObject OAIAssetSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIAssetSummary::getName() const {
    return m_name;
}
void OAIAssetSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAssetSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAssetSummary::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIAssetSummary::getSize() const {
    return m_size;
}
void OAIAssetSummary::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIAssetSummary::is_size_Set() const{
    return m_size_isSet;
}

bool OAIAssetSummary::is_size_Valid() const{
    return m_size_isValid;
}

QMap OAIAssetSummary::getHashes() const {
    return m_hashes;
}
void OAIAssetSummary::setHashes(const QMap &hashes) {
    m_hashes = hashes;
    m_hashes_isSet = true;
}

bool OAIAssetSummary::is_hashes_Set() const{
    return m_hashes_isSet;
}

bool OAIAssetSummary::is_hashes_Valid() const{
    return m_hashes_isValid;
}

bool OAIAssetSummary::isSet() const {
...
bool OAIAssetSummary::isValid() const {
