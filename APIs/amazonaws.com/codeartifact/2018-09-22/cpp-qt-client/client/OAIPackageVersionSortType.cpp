...
#include "OAIPackageVersionSortType.h"
...
OAIPackageVersionSortType::OAIPackageVersionSortType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionSortType::OAIPackageVersionSortType() {
    this->initializeModel();
}

OAIPackageVersionSortType::~OAIPackageVersionSortType() {}

void OAIPackageVersionSortType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPackageVersionSortType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPackageVersionSortType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("PUBLISHED_TIME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionSortType::PUBLISHED_TIME;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPackageVersionSortType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPackageVersionSortType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPackageVersionSortType::PUBLISHED_TIME:
            val = "PUBLISHED_TIME";
            break;
        default:
            break;
...
QJsonValue OAIPackageVersionSortType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPackageVersionSortType::eOAIPackageVersionSortType OAIPackageVersionSortType::getValue() const {
    return m_value;
}

void OAIPackageVersionSortType::setValue(const OAIPackageVersionSortType::eOAIPackageVersionSortType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPackageVersionSortType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPackageVersionSortType::isValid() const {
