...
#include "OAIDisposePackageVersionsRequest.h"
...
OAIDisposePackageVersionsRequest::OAIDisposePackageVersionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisposePackageVersionsRequest::OAIDisposePackageVersionsRequest() {
    this->initializeModel();
}

OAIDisposePackageVersionsRequest::~OAIDisposePackageVersionsRequest() {}

void OAIDisposePackageVersionsRequest::initializeModel() {
...
void OAIDisposePackageVersionsRequest::fromJson(QString jsonString) {
...
void OAIDisposePackageVersionsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDisposePackageVersionsRequest::asJson() const {
...
QJsonObject OAIDisposePackageVersionsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_versions.isSet()) {
...
QList OAIDisposePackageVersionsRequest::getVersions() const {
    return m_versions;
}
void OAIDisposePackageVersionsRequest::setVersions(const QList &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIDisposePackageVersionsRequest::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIDisposePackageVersionsRequest::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap OAIDisposePackageVersionsRequest::getVersionRevisions() const {
    return m_version_revisions;
}
void OAIDisposePackageVersionsRequest::setVersionRevisions(const QMap &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAIDisposePackageVersionsRequest::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAIDisposePackageVersionsRequest::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

OAIPackageVersionStatus OAIDisposePackageVersionsRequest::getExpectedStatus() const {
    return m_expected_status;
}
void OAIDisposePackageVersionsRequest::setExpectedStatus(const OAIPackageVersionStatus &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIDisposePackageVersionsRequest::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIDisposePackageVersionsRequest::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

bool OAIDisposePackageVersionsRequest::isSet() const {
...
bool OAIDisposePackageVersionsRequest::isValid() const {
