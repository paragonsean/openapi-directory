...
/*
 * OAIDeleteRepositoryPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryPermissionsPolicyResult_H
#define OAIDeleteRepositoryPermissionsPolicyResult_H
...
namespace OpenAPI {
class OAIDeleteRepositoryPermissionsPolicyResult_policy;

class OAIDeleteRepositoryPermissionsPolicyResult : public OAIObject {
public:
    OAIDeleteRepositoryPermissionsPolicyResult();
    OAIDeleteRepositoryPermissionsPolicyResult(QString json);
    ~OAIDeleteRepositoryPermissionsPolicyResult() override;
    ...
    OAIDeleteRepositoryPermissionsPolicyResult_policy getPolicy() const;
    void setPolicy(const OAIDeleteRepositoryPermissionsPolicyResult_policy &policy);
...
private:
    ...
    OAIDeleteRepositoryPermissionsPolicyResult_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryPermissionsPolicyResult)

#endif // OAIDeleteRepositoryPermissionsPolicyResult_H
