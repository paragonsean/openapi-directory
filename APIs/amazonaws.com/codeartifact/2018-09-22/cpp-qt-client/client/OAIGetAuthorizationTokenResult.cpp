...
OAIGetAuthorizationTokenResult::OAIGetAuthorizationTokenResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAuthorizationTokenResult::OAIGetAuthorizationTokenResult() {
    this->initializeModel();
}

OAIGetAuthorizationTokenResult::~OAIGetAuthorizationTokenResult() {}

void OAIGetAuthorizationTokenResult::initializeModel() {
...
void OAIGetAuthorizationTokenResult::fromJson(QString jsonString) {
...
void OAIGetAuthorizationTokenResult::fromJsonObject(QJsonObject json) {
...
QString OAIGetAuthorizationTokenResult::asJson() const {
...
QJsonObject OAIGetAuthorizationTokenResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetAuthorizationTokenResult::getAuthorizationToken() const {
    return m_authorization_token;
}
void OAIGetAuthorizationTokenResult::setAuthorizationToken(const QString &authorization_token) {
    m_authorization_token = authorization_token;
    m_authorization_token_isSet = true;
}

bool OAIGetAuthorizationTokenResult::is_authorization_token_Set() const{
    return m_authorization_token_isSet;
}

bool OAIGetAuthorizationTokenResult::is_authorization_token_Valid() const{
    return m_authorization_token_isValid;
}

QDateTime OAIGetAuthorizationTokenResult::getExpiration() const {
    return m_expiration;
}
void OAIGetAuthorizationTokenResult::setExpiration(const QDateTime &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAIGetAuthorizationTokenResult::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAIGetAuthorizationTokenResult::is_expiration_Valid() const{
    return m_expiration_isValid;
}

bool OAIGetAuthorizationTokenResult::isSet() const {
...
bool OAIGetAuthorizationTokenResult::isValid() const {
