...
/*
 * OAIPackageVersionErrorCode.h
 *
 * 
 */

#ifndef OAIPackageVersionErrorCode_H
#define OAIPackageVersionErrorCode_H
...
class OAIPackageVersionErrorCode : public OAIEnum {
public:
    OAIPackageVersionErrorCode();
    OAIPackageVersionErrorCode(QString json);
    ~OAIPackageVersionErrorCode() override;
    ...
    enum class eOAIPackageVersionErrorCode {
    ...
    OAIPackageVersionErrorCode::eOAIPackageVersionErrorCode getValue() const;
    void setValue(const OAIPackageVersionErrorCode::eOAIPackageVersionErrorCode& value);
...
private:
    ...
    eOAIPackageVersionErrorCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionErrorCode)

#endif // OAIPackageVersionErrorCode_H
