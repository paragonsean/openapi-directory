...
OAIPutDomainPermissionsPolicyResult::OAIPutDomainPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDomainPermissionsPolicyResult::OAIPutDomainPermissionsPolicyResult() {
    this->initializeModel();
}

OAIPutDomainPermissionsPolicyResult::~OAIPutDomainPermissionsPolicyResult() {}

void OAIPutDomainPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIPutDomainPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIPutDomainPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIPutDomainPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIPutDomainPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIPutDomainPermissionsPolicyResult_policy OAIPutDomainPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIPutDomainPermissionsPolicyResult::setPolicy(const OAIPutDomainPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIPutDomainPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIPutDomainPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIPutDomainPermissionsPolicyResult::isSet() const {
...
bool OAIPutDomainPermissionsPolicyResult::isValid() const {
