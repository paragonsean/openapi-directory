...
#ifndef OAIPackageVersionSummary_H
#define OAIPackageVersionSummary_H
...
class OAIPackageVersionSummary : public OAIObject {
public:
    OAIPackageVersionSummary();
    OAIPackageVersionSummary(QString json);
    ~OAIPackageVersionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionSummary)

#endif // OAIPackageVersionSummary_H
