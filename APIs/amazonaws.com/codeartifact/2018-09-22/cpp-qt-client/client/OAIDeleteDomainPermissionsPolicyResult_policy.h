...
/*
 * OAIDeleteDomainPermissionsPolicyResult_policy.h
 *
 * 
 */

#ifndef OAIDeleteDomainPermissionsPolicyResult_policy_H
#define OAIDeleteDomainPermissionsPolicyResult_policy_H
...
class OAIDeleteDomainPermissionsPolicyResult_policy : public OAIObject {
public:
    OAIDeleteDomainPermissionsPolicyResult_policy();
    OAIDeleteDomainPermissionsPolicyResult_policy(QString json);
    ~OAIDeleteDomainPermissionsPolicyResult_policy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDomainPermissionsPolicyResult_policy)

#endif // OAIDeleteDomainPermissionsPolicyResult_policy_H
