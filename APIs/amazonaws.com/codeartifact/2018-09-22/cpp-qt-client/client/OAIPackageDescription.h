...
/*
 * OAIPackageDescription.h
 *
 * Details about a package.
 */

#ifndef OAIPackageDescription_H
#define OAIPackageDescription_H
...
class OAIPackageDescription : public OAIObject {
public:
    OAIPackageDescription();
    OAIPackageDescription(QString json);
    ~OAIPackageDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageDescription)

#endif // OAIPackageDescription_H
