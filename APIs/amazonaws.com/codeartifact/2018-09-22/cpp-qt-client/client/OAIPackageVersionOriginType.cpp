...
OAIPackageVersionOriginType::OAIPackageVersionOriginType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionOriginType::OAIPackageVersionOriginType() {
    this->initializeModel();
}

OAIPackageVersionOriginType::~OAIPackageVersionOriginType() {}

void OAIPackageVersionOriginType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPackageVersionOriginType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPackageVersionOriginType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INTERNAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionOriginType::INTERNAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EXTERNAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionOriginType::EXTERNAL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPackageVersionOriginType::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPackageVersionOriginType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPackageVersionOriginType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPackageVersionOriginType::INTERNAL:
            val = "INTERNAL";
            break;
        case eOAIPackageVersionOriginType::EXTERNAL:
            val = "EXTERNAL";
            break;
        case eOAIPackageVersionOriginType::UNKNOWN:
            val = "UNKNOWN";
            break;
        default:
            break;
...
QJsonValue OAIPackageVersionOriginType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPackageVersionOriginType::eOAIPackageVersionOriginType OAIPackageVersionOriginType::getValue() const {
    return m_value;
}

void OAIPackageVersionOriginType::setValue(const OAIPackageVersionOriginType::eOAIPackageVersionOriginType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPackageVersionOriginType::isSet() const {
    
    return m_value_isSet;
}

bool OAIPackageVersionOriginType::isValid() const {
