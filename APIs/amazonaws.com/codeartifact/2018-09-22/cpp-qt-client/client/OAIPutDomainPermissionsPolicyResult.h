...
/*
 * OAIPutDomainPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIPutDomainPermissionsPolicyResult_H
#define OAIPutDomainPermissionsPolicyResult_H
...
class OAIPutDomainPermissionsPolicyResult : public OAIObject {
public:
    OAIPutDomainPermissionsPolicyResult();
    OAIPutDomainPermissionsPolicyResult(QString json);
    ~OAIPutDomainPermissionsPolicyResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDomainPermissionsPolicyResult)

#endif // OAIPutDomainPermissionsPolicyResult_H
