...
/*
 * OAIDescribeDomainResult.h
 *
 * 
 */

#ifndef OAIDescribeDomainResult_H
#define OAIDescribeDomainResult_H
...
namespace OpenAPI {
class OAIDomainDescription;

class OAIDescribeDomainResult : public OAIObject {
public:
    OAIDescribeDomainResult();
    OAIDescribeDomainResult(QString json);
    ~OAIDescribeDomainResult() override;
    ...
    OAIDomainDescription getDomain() const;
    void setDomain(const OAIDomainDescription &domain);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDomainResult)

#endif // OAIDescribeDomainResult_H
