...
OAIPutDomainPermissionsPolicyResult_policy::OAIPutDomainPermissionsPolicyResult_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDomainPermissionsPolicyResult_policy::OAIPutDomainPermissionsPolicyResult_policy() {
    this->initializeModel();
}

OAIPutDomainPermissionsPolicyResult_policy::~OAIPutDomainPermissionsPolicyResult_policy() {}

void OAIPutDomainPermissionsPolicyResult_policy::initializeModel() {
...
void OAIPutDomainPermissionsPolicyResult_policy::fromJson(QString jsonString) {
...
void OAIPutDomainPermissionsPolicyResult_policy::fromJsonObject(QJsonObject json) {
...
QString OAIPutDomainPermissionsPolicyResult_policy::asJson() const {
...
QJsonObject OAIPutDomainPermissionsPolicyResult_policy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutDomainPermissionsPolicyResult_policy::getResourceArn() const {
    return m_resource_arn;
}
void OAIPutDomainPermissionsPolicyResult_policy::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIPutDomainPermissionsPolicyResult_policy::getRevision() const {
    return m_revision;
}
void OAIPutDomainPermissionsPolicyResult_policy::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_revision_Valid() const{
    return m_revision_isValid;
}

QString OAIPutDomainPermissionsPolicyResult_policy::getDocument() const {
    return m_document;
}
void OAIPutDomainPermissionsPolicyResult_policy::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_document_Set() const{
    return m_document_isSet;
}

bool OAIPutDomainPermissionsPolicyResult_policy::is_document_Valid() const{
    return m_document_isValid;
}

bool OAIPutDomainPermissionsPolicyResult_policy::isSet() const {
...
bool OAIPutDomainPermissionsPolicyResult_policy::isValid() const {
