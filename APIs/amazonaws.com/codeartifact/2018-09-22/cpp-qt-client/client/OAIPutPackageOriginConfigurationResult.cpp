...
OAIPutPackageOriginConfigurationResult::OAIPutPackageOriginConfigurationResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutPackageOriginConfigurationResult::OAIPutPackageOriginConfigurationResult() {
    this->initializeModel();
}

OAIPutPackageOriginConfigurationResult::~OAIPutPackageOriginConfigurationResult() {}

void OAIPutPackageOriginConfigurationResult::initializeModel() {

    m_origin_configuration_isSet = false;
    m_origin_configuration_isValid = false;
}

void OAIPutPackageOriginConfigurationResult::fromJson(QString jsonString) {
...
void OAIPutPackageOriginConfigurationResult::fromJsonObject(QJsonObject json) {
...
QString OAIPutPackageOriginConfigurationResult::asJson() const {
...
QJsonObject OAIPutPackageOriginConfigurationResult::asJsonObject() const {
    QJsonObject obj;
...
OAIPutPackageOriginConfigurationResult_originConfiguration OAIPutPackageOriginConfigurationResult::getOriginConfiguration() const {
    return m_origin_configuration;
}
void OAIPutPackageOriginConfigurationResult::setOriginConfiguration(const OAIPutPackageOriginConfigurationResult_originConfiguration &origin_configuration) {
    m_origin_configuration = origin_configuration;
    m_origin_configuration_isSet = true;
}

bool OAIPutPackageOriginConfigurationResult::is_origin_configuration_Set() const{
    return m_origin_configuration_isSet;
}

bool OAIPutPackageOriginConfigurationResult::is_origin_configuration_Valid() const{
    return m_origin_configuration_isValid;
}

bool OAIPutPackageOriginConfigurationResult::isSet() const {
...
bool OAIPutPackageOriginConfigurationResult::isValid() const {
