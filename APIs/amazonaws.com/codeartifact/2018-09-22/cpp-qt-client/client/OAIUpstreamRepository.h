...
#ifndef OAIUpstreamRepository_H
#define OAIUpstreamRepository_H
...
class OAIUpstreamRepository : public OAIObject {
public:
    OAIUpstreamRepository();
    OAIUpstreamRepository(QString json);
    ~OAIUpstreamRepository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpstreamRepository)

#endif // OAIUpstreamRepository_H
