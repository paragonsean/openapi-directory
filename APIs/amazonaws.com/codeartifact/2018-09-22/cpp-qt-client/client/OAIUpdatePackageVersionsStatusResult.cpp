...
OAIUpdatePackageVersionsStatusResult::OAIUpdatePackageVersionsStatusResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePackageVersionsStatusResult::OAIUpdatePackageVersionsStatusResult() {
    this->initializeModel();
}

OAIUpdatePackageVersionsStatusResult::~OAIUpdatePackageVersionsStatusResult() {}

void OAIUpdatePackageVersionsStatusResult::initializeModel() {

    m_successful_versions_isSet = false;
    m_successful_versions_isValid = false;

    m_failed_versions_isSet = false;
    m_failed_versions_isValid = false;
}

void OAIUpdatePackageVersionsStatusResult::fromJson(QString jsonString) {
...
void OAIUpdatePackageVersionsStatusResult::fromJsonObject(QJsonObject json) {

    m_successful_versions_isValid = ::OpenAPI::fromJsonValue(m_successful_versions, json[QString("successfulVersions")]);
    m_successful_versions_isSet = !json[QString("successfulVersions")].isNull() && m_successful_versions_isValid;
...
QString OAIUpdatePackageVersionsStatusResult::asJson() const {
...
QJsonObject OAIUpdatePackageVersionsStatusResult::asJsonObject() const {
    QJsonObject obj;
    if (m_successful_versions.isSet()) {
        obj.insert(QString("successfulVersions"), ::OpenAPI::toJsonValue(m_successful_versions));
    }
    if (m_failed_versions.isSet()) {
        obj.insert(QString("failedVersions"), ::OpenAPI::toJsonValue(m_failed_versions));
    }
    return obj;
}

QMap OAIUpdatePackageVersionsStatusResult::getSuccessfulVersions() const {
    return m_successful_versions;
}
void OAIUpdatePackageVersionsStatusResult::setSuccessfulVersions(const QMap &successful_versions) {
    m_successful_versions = successful_versions;
    m_successful_versions_isSet = true;
}

bool OAIUpdatePackageVersionsStatusResult::is_successful_versions_Set() const{
    return m_successful_versions_isSet;
}

bool OAIUpdatePackageVersionsStatusResult::is_successful_versions_Valid() const{
    return m_successful_versions_isValid;
}

QMap OAIUpdatePackageVersionsStatusResult::getFailedVersions() const {
    return m_failed_versions;
}
void OAIUpdatePackageVersionsStatusResult::setFailedVersions(const QMap &failed_versions) {
    m_failed_versions = failed_versions;
    m_failed_versions_isSet = true;
}

bool OAIUpdatePackageVersionsStatusResult::is_failed_versions_Set() const{
    return m_failed_versions_isSet;
}

bool OAIUpdatePackageVersionsStatusResult::is_failed_versions_Valid() const{
    return m_failed_versions_isValid;
}

bool OAIUpdatePackageVersionsStatusResult::isSet() const {
...
bool OAIUpdatePackageVersionsStatusResult::isValid() const {
