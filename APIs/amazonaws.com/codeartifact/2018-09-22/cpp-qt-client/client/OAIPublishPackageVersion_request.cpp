...
OAIPublishPackageVersion_request::OAIPublishPackageVersion_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublishPackageVersion_request::OAIPublishPackageVersion_request() {
    this->initializeModel();
}

OAIPublishPackageVersion_request::~OAIPublishPackageVersion_request() {}

void OAIPublishPackageVersion_request::initializeModel() {

    m_asset_content_isSet = false;
    m_asset_content_isValid = false;
}

void OAIPublishPackageVersion_request::fromJson(QString jsonString) {
...
void OAIPublishPackageVersion_request::fromJsonObject(QJsonObject json) {

    m_asset_content_isValid = ::OpenAPI::fromJsonValue(m_asset_content, json[QString("assetContent")]);
    m_asset_content_isSet = !json[QString("assetContent")].isNull() && m_asset_content_isValid;
}

QString OAIPublishPackageVersion_request::asJson() const {
...
QJsonObject OAIPublishPackageVersion_request::asJsonObject() const {
    QJsonObject obj;
    if (m_asset_content_isSet) {
        obj.insert(QString("assetContent"), ::OpenAPI::toJsonValue(m_asset_content));
    }
    return obj;
}

QString OAIPublishPackageVersion_request::getAssetContent() const {
    return m_asset_content;
}
void OAIPublishPackageVersion_request::setAssetContent(const QString &asset_content) {
    m_asset_content = asset_content;
    m_asset_content_isSet = true;
}

bool OAIPublishPackageVersion_request::is_asset_content_Set() const{
    return m_asset_content_isSet;
}

bool OAIPublishPackageVersion_request::is_asset_content_Valid() const{
    return m_asset_content_isValid;
}

bool OAIPublishPackageVersion_request::isSet() const {
...
bool OAIPublishPackageVersion_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_asset_content_isValid && true;
}
