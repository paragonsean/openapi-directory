...
OAIListPackageVersionDependenciesResult::OAIListPackageVersionDependenciesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPackageVersionDependenciesResult::OAIListPackageVersionDependenciesResult() {
    this->initializeModel();
}

OAIListPackageVersionDependenciesResult::~OAIListPackageVersionDependenciesResult() {}

void OAIListPackageVersionDependenciesResult::initializeModel() {
...
void OAIListPackageVersionDependenciesResult::fromJson(QString jsonString) {
...
void OAIListPackageVersionDependenciesResult::fromJsonObject(QJsonObject json) {
...
QString OAIListPackageVersionDependenciesResult::asJson() const {
...
QJsonObject OAIListPackageVersionDependenciesResult::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIListPackageVersionDependenciesResult::getFormat() const {
    return m_format;
}
void OAIListPackageVersionDependenciesResult::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_format_Set() const{
    return m_format_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIListPackageVersionDependenciesResult::getRNamespace() const {
    return m_r_namespace;
}
void OAIListPackageVersionDependenciesResult::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIListPackageVersionDependenciesResult::getPackage() const {
    return m_package;
}
void OAIListPackageVersionDependenciesResult::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_package_Valid() const{
    return m_package_isValid;
}

QString OAIListPackageVersionDependenciesResult::getVersion() const {
    return m_version;
}
void OAIListPackageVersionDependenciesResult::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_version_Set() const{
    return m_version_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIListPackageVersionDependenciesResult::getVersionRevision() const {
    return m_version_revision;
}
void OAIListPackageVersionDependenciesResult::setVersionRevision(const QString &version_revision) {
    m_version_revision = version_revision;
    m_version_revision_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_version_revision_Set() const{
    return m_version_revision_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_version_revision_Valid() const{
    return m_version_revision_isValid;
}

QString OAIListPackageVersionDependenciesResult::getNextToken() const {
    return m_next_token;
}
void OAIListPackageVersionDependenciesResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListPackageVersionDependenciesResult::getDependencies() const {
    return m_dependencies;
}
void OAIListPackageVersionDependenciesResult::setDependencies(const QList &dependencies) {
    m_dependencies = dependencies;
    m_dependencies_isSet = true;
}

bool OAIListPackageVersionDependenciesResult::is_dependencies_Set() const{
    return m_dependencies_isSet;
}

bool OAIListPackageVersionDependenciesResult::is_dependencies_Valid() const{
    return m_dependencies_isValid;
}

bool OAIListPackageVersionDependenciesResult::isSet() const {
...
bool OAIListPackageVersionDependenciesResult::isValid() const {
