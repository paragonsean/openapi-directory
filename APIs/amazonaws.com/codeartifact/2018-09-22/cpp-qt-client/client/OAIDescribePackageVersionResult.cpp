...
OAIDescribePackageVersionResult::OAIDescribePackageVersionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePackageVersionResult::OAIDescribePackageVersionResult() {
    this->initializeModel();
}

OAIDescribePackageVersionResult::~OAIDescribePackageVersionResult() {}

void OAIDescribePackageVersionResult::initializeModel() {

    m_package_version_isSet = false;
    m_package_version_isValid = false;
}

void OAIDescribePackageVersionResult::fromJson(QString jsonString) {
...
void OAIDescribePackageVersionResult::fromJsonObject(QJsonObject json) {
...
QString OAIDescribePackageVersionResult::asJson() const {
...
QJsonObject OAIDescribePackageVersionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_package_version.isSet()) {
        obj.insert(QString("packageVersion"), ::OpenAPI::toJsonValue(m_package_version));
    }
    return obj;
}

OAIDescribePackageVersionResult_packageVersion OAIDescribePackageVersionResult::getPackageVersion() const {
    return m_package_version;
}
void OAIDescribePackageVersionResult::setPackageVersion(const OAIDescribePackageVersionResult_packageVersion &package_version) {
    m_package_version = package_version;
    m_package_version_isSet = true;
}

bool OAIDescribePackageVersionResult::is_package_version_Set() const{
    return m_package_version_isSet;
}

bool OAIDescribePackageVersionResult::is_package_version_Valid() const{
    return m_package_version_isValid;
}

bool OAIDescribePackageVersionResult::isSet() const {
...
bool OAIDescribePackageVersionResult::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_package_version_isValid && true;
}
