...
OAIDeleteDomainResult::OAIDeleteDomainResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDomainResult::OAIDeleteDomainResult() {
    this->initializeModel();
}

OAIDeleteDomainResult::~OAIDeleteDomainResult() {}

void OAIDeleteDomainResult::initializeModel() {

    m_domain_isSet = false;
    m_domain_isValid = false;
}

void OAIDeleteDomainResult::fromJson(QString jsonString) {
...
void OAIDeleteDomainResult::fromJsonObject(QJsonObject json) {

    m_domain_isValid = ::OpenAPI::fromJsonValue(m_domain, json[QString("domain")]);
    m_domain_isSet = !json[QString("domain")].isNull() && m_domain_isValid;
}

QString OAIDeleteDomainResult::asJson() const {
...
QJsonObject OAIDeleteDomainResult::asJsonObject() const {
    QJsonObject obj;
    if (m_domain.isSet()) {
...
OAIDeleteDomainResult_domain OAIDeleteDomainResult::getDomain() const {
    return m_domain;
}
void OAIDeleteDomainResult::setDomain(const OAIDeleteDomainResult_domain &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDeleteDomainResult::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDeleteDomainResult::is_domain_Valid() const{
    return m_domain_isValid;
}

bool OAIDeleteDomainResult::isSet() const {
...
bool OAIDeleteDomainResult::isValid() const {
