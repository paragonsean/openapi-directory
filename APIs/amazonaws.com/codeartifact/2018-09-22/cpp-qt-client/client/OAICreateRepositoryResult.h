...
/*
 * OAICreateRepositoryResult.h
 *
 * 
 */

#ifndef OAICreateRepositoryResult_H
#define OAICreateRepositoryResult_H

#include <QJsonObject>

#include "OAICreateRepositoryResult_repository.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateRepositoryResult_repository;

class OAICreateRepositoryResult : public OAIObject {
public:
    OAICreateRepositoryResult();
    OAICreateRepositoryResult(QString json);
    ~OAICreateRepositoryResult() override;
    ...
    OAICreateRepositoryResult_repository getRepository() const;
    void setRepository(const OAICreateRepositoryResult_repository &repository);
...
private:
    ...
    OAICreateRepositoryResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRepositoryResult)

#endif // OAICreateRepositoryResult_H
