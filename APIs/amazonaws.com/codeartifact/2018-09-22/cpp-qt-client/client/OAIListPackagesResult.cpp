...
OAIListPackagesResult::OAIListPackagesResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPackagesResult::OAIListPackagesResult() {
    this->initializeModel();
}

OAIListPackagesResult::~OAIListPackagesResult() {}

void OAIListPackagesResult::initializeModel() {
...
void OAIListPackagesResult::fromJson(QString jsonString) {
...
void OAIListPackagesResult::fromJsonObject(QJsonObject json) {
...
QString OAIListPackagesResult::asJson() const {
...
QJsonObject OAIListPackagesResult::asJsonObject() const {
    QJsonObject obj;
    if (m_packages.isSet()) {
...
QList OAIListPackagesResult::getPackages() const {
    return m_packages;
}
void OAIListPackagesResult::setPackages(const QList &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIListPackagesResult::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIListPackagesResult::is_packages_Valid() const{
    return m_packages_isValid;
}

QString OAIListPackagesResult::getNextToken() const {
    return m_next_token;
}
void OAIListPackagesResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPackagesResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPackagesResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListPackagesResult::isSet() const {
...
bool OAIListPackagesResult::isValid() const {
