...
/*
 * OAISuccessfulPackageVersionInfo.h
 *
 *  Contains the revision and status of a package version. 
 */

#ifndef OAISuccessfulPackageVersionInfo_H
#define OAISuccessfulPackageVersionInfo_H
...
class OAISuccessfulPackageVersionInfo : public OAIObject {
public:
    OAISuccessfulPackageVersionInfo();
    OAISuccessfulPackageVersionInfo(QString json);
    ~OAISuccessfulPackageVersionInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuccessfulPackageVersionInfo)

#endif // OAISuccessfulPackageVersionInfo_H
