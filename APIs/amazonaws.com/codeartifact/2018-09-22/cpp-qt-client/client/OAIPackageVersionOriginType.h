...
/*
 * OAIPackageVersionOriginType.h
 *
 * 
 */

#ifndef OAIPackageVersionOriginType_H
#define OAIPackageVersionOriginType_H
...
class OAIPackageVersionOriginType : public OAIEnum {
public:
    OAIPackageVersionOriginType();
    OAIPackageVersionOriginType(QString json);
    ~OAIPackageVersionOriginType() override;
    ...
    enum class eOAIPackageVersionOriginType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INTERNAL, 
        EXTERNAL, 
        UNKNOWN
    };
    OAIPackageVersionOriginType::eOAIPackageVersionOriginType getValue() const;
    void setValue(const OAIPackageVersionOriginType::eOAIPackageVersionOriginType& value);
...
private:
    ...
    eOAIPackageVersionOriginType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionOriginType)

#endif // OAIPackageVersionOriginType_H
