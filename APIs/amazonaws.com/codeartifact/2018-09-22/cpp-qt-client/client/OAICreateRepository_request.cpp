...
OAICreateRepository_request::OAICreateRepository_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRepository_request::OAICreateRepository_request() {
    this->initializeModel();
}

OAICreateRepository_request::~OAICreateRepository_request() {}

void OAICreateRepository_request::initializeModel() {
...
void OAICreateRepository_request::fromJson(QString jsonString) {
...
void OAICreateRepository_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateRepository_request::asJson() const {
...
QJsonObject OAICreateRepository_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateRepository_request::getDescription() const {
    return m_description;
}
void OAICreateRepository_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateRepository_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateRepository_request::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIUpstreamRepository> OAICreateRepository_request::getUpstreams() const {
    return m_upstreams;
}
void OAICreateRepository_request::setUpstreams(const QList<OAIUpstreamRepository> &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAICreateRepository_request::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAICreateRepository_request::is_upstreams_Valid() const{
    return m_upstreams_isValid;
}

QList<OAITag> OAICreateRepository_request::getTags() const {
    return m_tags;
}
void OAICreateRepository_request::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateRepository_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateRepository_request::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateRepository_request::isSet() const {
...
bool OAICreateRepository_request::isValid() const {
