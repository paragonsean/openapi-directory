...
/*
 * OAIUpdateRepositoryResult.h
 *
 * 
 */

#ifndef OAIUpdateRepositoryResult_H
#define OAIUpdateRepositoryResult_H
...
namespace OpenAPI {
class OAIUpdateRepositoryResult_repository;

class OAIUpdateRepositoryResult : public OAIObject {
public:
    OAIUpdateRepositoryResult();
    OAIUpdateRepositoryResult(QString json);
    ~OAIUpdateRepositoryResult() override;
    ...
    OAIUpdateRepositoryResult_repository getRepository() const;
    void setRepository(const OAIUpdateRepositoryResult_repository &repository);
...
private:
    ...
    OAIUpdateRepositoryResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepositoryResult)

#endif // OAIUpdateRepositoryResult_H
