...
/*
 * OAIPutPackageOriginConfigurationRequest.h
 *
 * 
 */

#ifndef OAIPutPackageOriginConfigurationRequest_H
#define OAIPutPackageOriginConfigurationRequest_H
...
namespace OpenAPI {
class OAIPutPackageOriginConfigurationRequest_restrictions;

class OAIPutPackageOriginConfigurationRequest : public OAIObject {
public:
    OAIPutPackageOriginConfigurationRequest();
    OAIPutPackageOriginConfigurationRequest(QString json);
    ~OAIPutPackageOriginConfigurationRequest() override;
    ...
    OAIPutPackageOriginConfigurationRequest_restrictions getRestrictions() const;
    void setRestrictions(const OAIPutPackageOriginConfigurationRequest_restrictions &restrictions);
...
private:
    ...
    OAIPutPackageOriginConfigurationRequest_restrictions m_restrictions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfigurationRequest)

#endif // OAIPutPackageOriginConfigurationRequest_H
