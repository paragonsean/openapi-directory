...
OAIDisposePackageVersions_request::OAIDisposePackageVersions_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisposePackageVersions_request::OAIDisposePackageVersions_request() {
    this->initializeModel();
}

OAIDisposePackageVersions_request::~OAIDisposePackageVersions_request() {}

void OAIDisposePackageVersions_request::initializeModel() {

    m_versions_isSet = false;
    m_versions_isValid = false;

    m_version_revisions_isSet = false;
    m_version_revisions_isValid = false;

    m_expected_status_isSet = false;
    m_expected_status_isValid = false;
}

void OAIDisposePackageVersions_request::fromJson(QString jsonString) {
...
void OAIDisposePackageVersions_request::fromJsonObject(QJsonObject json) {
    ...
    m_version_revisions_isValid = ::OpenAPI::fromJsonValue(m_version_revisions, json[QString("versionRevisions")]);
    m_version_revisions_isSet = !json[QString("versionRevisions")].isNull() && m_version_revisions_isValid;
...
QString OAIDisposePackageVersions_request::asJson() const {
...
QJsonObject OAIDisposePackageVersions_request::asJsonObject() const {
    QJsonObject obj;
    if (m_versions.size() > 0) {
        obj.insert(QString("versions"), ::OpenAPI::toJsonValue(m_versions));
    }
    if (m_version_revisions.size() > 0) {
        obj.insert(QString("versionRevisions"), ::OpenAPI::toJsonValue(m_version_revisions));
    }
    if (m_expected_status_isSet) {
        obj.insert(QString("expectedStatus"), ::OpenAPI::toJsonValue(m_expected_status));
    }
    return obj;
}

QList<QString> OAIDisposePackageVersions_request::getVersions() const {
    return m_versions;
}
void OAIDisposePackageVersions_request::setVersions(const QList<QString> &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIDisposePackageVersions_request::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIDisposePackageVersions_request::is_versions_Valid() const{
    return m_versions_isValid;
}

QMap<QString, QString> OAIDisposePackageVersions_request::getVersionRevisions() const {
    return m_version_revisions;
}
void OAIDisposePackageVersions_request::setVersionRevisions(const QMap<QString, QString> &version_revisions) {
    m_version_revisions = version_revisions;
    m_version_revisions_isSet = true;
}

bool OAIDisposePackageVersions_request::is_version_revisions_Set() const{
    return m_version_revisions_isSet;
}

bool OAIDisposePackageVersions_request::is_version_revisions_Valid() const{
    return m_version_revisions_isValid;
}

QString OAIDisposePackageVersions_request::getExpectedStatus() const {
    return m_expected_status;
}
void OAIDisposePackageVersions_request::setExpectedStatus(const QString &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIDisposePackageVersions_request::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIDisposePackageVersions_request::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

bool OAIDisposePackageVersions_request::isSet() const {
...
bool OAIDisposePackageVersions_request::isValid() const {
