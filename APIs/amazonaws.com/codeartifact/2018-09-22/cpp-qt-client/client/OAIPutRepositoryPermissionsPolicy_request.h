...
/*
 * OAIPutRepositoryPermissionsPolicy_request.h
 *
 * 
 */

#ifndef OAIPutRepositoryPermissionsPolicy_request_H
#define OAIPutRepositoryPermissionsPolicy_request_H
...
class OAIPutRepositoryPermissionsPolicy_request : public OAIObject {
public:
    OAIPutRepositoryPermissionsPolicy_request();
    OAIPutRepositoryPermissionsPolicy_request(QString json);
    ~OAIPutRepositoryPermissionsPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryPermissionsPolicy_request)

#endif // OAIPutRepositoryPermissionsPolicy_request_H
