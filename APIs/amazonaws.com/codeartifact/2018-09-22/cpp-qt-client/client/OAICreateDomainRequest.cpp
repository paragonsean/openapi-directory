...
QString OAICreateDomainRequest::getEncryptionKey() const {
    return m_encryption_key;
}
void OAICreateDomainRequest::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAICreateDomainRequest::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAICreateDomainRequest::is_encryption_key_Valid() const{
