...
/*
 * OAIPackageOriginRestrictions.h
 *
...
#ifndef OAIPackageOriginRestrictions_H
#define OAIPackageOriginRestrictions_H
...
class OAIPackageOriginRestrictions : public OAIObject {
public:
    OAIPackageOriginRestrictions();
    OAIPackageOriginRestrictions(QString json);
    ~OAIPackageOriginRestrictions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageOriginRestrictions)

#endif // OAIPackageOriginRestrictions_H
