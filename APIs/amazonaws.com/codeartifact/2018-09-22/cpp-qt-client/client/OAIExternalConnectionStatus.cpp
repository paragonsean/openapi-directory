...
#include "OAIExternalConnectionStatus.h"
...
OAIExternalConnectionStatus::OAIExternalConnectionStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExternalConnectionStatus::OAIExternalConnectionStatus() {
    this->initializeModel();
}

OAIExternalConnectionStatus::~OAIExternalConnectionStatus() {}

void OAIExternalConnectionStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIExternalConnectionStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIExternalConnectionStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Available", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExternalConnectionStatus::AVAILABLE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIExternalConnectionStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIExternalConnectionStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIExternalConnectionStatus::AVAILABLE:
            val = "Available";
            break;
        default:
            break;
...
QJsonValue OAIExternalConnectionStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIExternalConnectionStatus::eOAIExternalConnectionStatus OAIExternalConnectionStatus::getValue() const {
    return m_value;
}

void OAIExternalConnectionStatus::setValue(const OAIExternalConnectionStatus::eOAIExternalConnectionStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIExternalConnectionStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIExternalConnectionStatus::isValid() const {
