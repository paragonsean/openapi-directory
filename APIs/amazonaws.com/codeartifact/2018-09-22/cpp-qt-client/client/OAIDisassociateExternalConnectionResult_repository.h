...
/*
 * OAIDisassociateExternalConnectionResult_repository.h
 *
 * 
 */

#ifndef OAIDisassociateExternalConnectionResult_repository_H
#define OAIDisassociateExternalConnectionResult_repository_H
...
class OAIDisassociateExternalConnectionResult_repository : public OAIObject {
public:
    OAIDisassociateExternalConnectionResult_repository();
    OAIDisassociateExternalConnectionResult_repository(QString json);
    ~OAIDisassociateExternalConnectionResult_repository() override;
    ...
    QString getAdministratorAccount() const;
    void setAdministratorAccount(const QString &administrator_account);
    ...
    QString getDomainOwner() const;
    void setDomainOwner(const QString &domain_owner);
    bool is_domain_owner_Set() const;
    bool is_domain_owner_Valid() const;
    ...
    QList getUpstreams() const;
    void setUpstreams(const QList &upstreams);
    bool is_upstreams_Set() const;
    bool is_upstreams_Valid() const;

    QList getExternalConnections() const;
    void setExternalConnections(const QList &external_connections);
...
private:
    ...
    QString m_administrator_account;
    ...
    QString m_domain_owner;
    bool m_domain_owner_isSet;
    bool m_domain_owner_isValid;
    ...
    QList m_upstreams;
    bool m_upstreams_isSet;
    bool m_upstreams_isValid;

    QList m_external_connections;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateExternalConnectionResult_repository)

#endif // OAIDisassociateExternalConnectionResult_repository_H
