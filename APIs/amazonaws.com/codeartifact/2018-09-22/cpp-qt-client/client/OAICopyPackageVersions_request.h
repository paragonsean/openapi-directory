...
/*
 * OAICopyPackageVersions_request.h
 *
 * 
 */

#ifndef OAICopyPackageVersions_request_H
#define OAICopyPackageVersions_request_H
...
class OAICopyPackageVersions_request : public OAIObject {
public:
    OAICopyPackageVersions_request();
    OAICopyPackageVersions_request(QString json);
    ~OAICopyPackageVersions_request() override;
    ...
    bool isIncludeFromUpstream() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyPackageVersions_request)

#endif // OAICopyPackageVersions_request_H
