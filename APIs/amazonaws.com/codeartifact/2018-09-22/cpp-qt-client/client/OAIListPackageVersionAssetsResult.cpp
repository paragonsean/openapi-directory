...
OAIListPackageVersionAssetsResult::OAIListPackageVersionAssetsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPackageVersionAssetsResult::OAIListPackageVersionAssetsResult() {
    this->initializeModel();
}

OAIListPackageVersionAssetsResult::~OAIListPackageVersionAssetsResult() {}

void OAIListPackageVersionAssetsResult::initializeModel() {
    ...
    m_version_revision_isSet = false;
    m_version_revision_isValid = false;
...
void OAIListPackageVersionAssetsResult::fromJson(QString jsonString) {
...
void OAIListPackageVersionAssetsResult::fromJsonObject(QJsonObject json) {
    ...
    m_version_revision_isValid = ::OpenAPI::fromJsonValue(m_version_revision, json[QString("versionRevision")]);
    m_version_revision_isSet = !json[QString("versionRevision")].isNull() && m_version_revision_isValid;
...
QString OAIListPackageVersionAssetsResult::asJson() const {
...
QJsonObject OAIListPackageVersionAssetsResult::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
    ...
    if (m_version_revision_isSet) {
        obj.insert(QString("versionRevision"), ::OpenAPI::toJsonValue(m_version_revision));
    }
...
OAIPackageFormat OAIListPackageVersionAssetsResult::getFormat() const {
    return m_format;
}
void OAIListPackageVersionAssetsResult::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_format_Set() const{
    return m_format_isSet;
}

bool OAIListPackageVersionAssetsResult::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIListPackageVersionAssetsResult::getRNamespace() const {
    return m_r_namespace;
}
void OAIListPackageVersionAssetsResult::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIListPackageVersionAssetsResult::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIListPackageVersionAssetsResult::getPackage() const {
    return m_package;
}
void OAIListPackageVersionAssetsResult::setPackage(const QString &package) {
    m_package = package;
    m_package_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_package_Set() const{
    return m_package_isSet;
}

bool OAIListPackageVersionAssetsResult::is_package_Valid() const{
    return m_package_isValid;
}

QString OAIListPackageVersionAssetsResult::getVersion() const {
    return m_version;
}
void OAIListPackageVersionAssetsResult::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_version_Set() const{
    return m_version_isSet;
}

bool OAIListPackageVersionAssetsResult::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIListPackageVersionAssetsResult::getVersionRevision() const {
    return m_version_revision;
}
void OAIListPackageVersionAssetsResult::setVersionRevision(const QString &version_revision) {
    m_version_revision = version_revision;
    m_version_revision_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_version_revision_Set() const{
    return m_version_revision_isSet;
}

bool OAIListPackageVersionAssetsResult::is_version_revision_Valid() const{
    return m_version_revision_isValid;
}

QString OAIListPackageVersionAssetsResult::getNextToken() const {
    return m_next_token;
}
void OAIListPackageVersionAssetsResult::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPackageVersionAssetsResult::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListPackageVersionAssetsResult::getAssets() const {
    return m_assets;
}
void OAIListPackageVersionAssetsResult::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAIListPackageVersionAssetsResult::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAIListPackageVersionAssetsResult::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAIListPackageVersionAssetsResult::isSet() const {
...
bool OAIListPackageVersionAssetsResult::isValid() const {
