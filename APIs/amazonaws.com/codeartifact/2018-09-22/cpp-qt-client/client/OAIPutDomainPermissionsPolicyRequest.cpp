...
#include "OAIPutDomainPermissionsPolicyRequest.h"
...
OAIPutDomainPermissionsPolicyRequest::OAIPutDomainPermissionsPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutDomainPermissionsPolicyRequest::OAIPutDomainPermissionsPolicyRequest() {
    this->initializeModel();
}

OAIPutDomainPermissionsPolicyRequest::~OAIPutDomainPermissionsPolicyRequest() {}

void OAIPutDomainPermissionsPolicyRequest::initializeModel() {
...
void OAIPutDomainPermissionsPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutDomainPermissionsPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutDomainPermissionsPolicyRequest::asJson() const {
...
QJsonObject OAIPutDomainPermissionsPolicyRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAIPutDomainPermissionsPolicyRequest::getDomain() const {
    return m_domain;
}
void OAIPutDomainPermissionsPolicyRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIPutDomainPermissionsPolicyRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIPutDomainPermissionsPolicyRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIPutDomainPermissionsPolicyRequest::getDomainOwner() const {
    return m_domain_owner;
}
void OAIPutDomainPermissionsPolicyRequest::setDomainOwner(const QString &domain_owner) {
    m_domain_owner = domain_owner;
    m_domain_owner_isSet = true;
}

bool OAIPutDomainPermissionsPolicyRequest::is_domain_owner_Set() const{
    return m_domain_owner_isSet;
}

bool OAIPutDomainPermissionsPolicyRequest::is_domain_owner_Valid() const{
    return m_domain_owner_isValid;
}

QString OAIPutDomainPermissionsPolicyRequest::getPolicyRevision() const {
    return m_policy_revision;
}
void OAIPutDomainPermissionsPolicyRequest::setPolicyRevision(const QString &policy_revision) {
    m_policy_revision = policy_revision;
    m_policy_revision_isSet = true;
}

bool OAIPutDomainPermissionsPolicyRequest::is_policy_revision_Set() const{
    return m_policy_revision_isSet;
}

bool OAIPutDomainPermissionsPolicyRequest::is_policy_revision_Valid() const{
    return m_policy_revision_isValid;
}

QString OAIPutDomainPermissionsPolicyRequest::getPolicyDocument() const {
    return m_policy_document;
}
void OAIPutDomainPermissionsPolicyRequest::setPolicyDocument(const QString &policy_document) {
    m_policy_document = policy_document;
    m_policy_document_isSet = true;
}

bool OAIPutDomainPermissionsPolicyRequest::is_policy_document_Set() const{
    return m_policy_document_isSet;
}

bool OAIPutDomainPermissionsPolicyRequest::is_policy_document_Valid() const{
    return m_policy_document_isValid;
}

bool OAIPutDomainPermissionsPolicyRequest::isSet() const {
...
bool OAIPutDomainPermissionsPolicyRequest::isValid() const {
