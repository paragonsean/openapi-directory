...
#include "OAIUpdateRepositoryRequest.h"
...
OAIUpdateRepositoryRequest::OAIUpdateRepositoryRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRepositoryRequest::OAIUpdateRepositoryRequest() {
    this->initializeModel();
}

OAIUpdateRepositoryRequest::~OAIUpdateRepositoryRequest() {}

void OAIUpdateRepositoryRequest::initializeModel() {
...
void OAIUpdateRepositoryRequest::fromJson(QString jsonString) {
...
void OAIUpdateRepositoryRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRepositoryRequest::asJson() const {
...
QJsonObject OAIUpdateRepositoryRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRepositoryRequest::getDescription() const {
    return m_description;
}
void OAIUpdateRepositoryRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateRepositoryRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateRepositoryRequest::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIUpdateRepositoryRequest::getUpstreams() const {
    return m_upstreams;
}
void OAIUpdateRepositoryRequest::setUpstreams(const QList &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAIUpdateRepositoryRequest::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAIUpdateRepositoryRequest::is_upstreams_Valid() const{
    return m_upstreams_isValid;
}

bool OAIUpdateRepositoryRequest::isSet() const {
...
bool OAIUpdateRepositoryRequest::isValid() const {
