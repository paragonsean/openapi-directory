...
/*
 * OAIDomainDescription.h
 *
 *  Information about a domain. A domain is a container for repositories. When you create a domain, it is empty until you add one or more repositories. 
 */

#ifndef OAIDomainDescription_H
#define OAIDomainDescription_H
...
class OAIDomainDescription : public OAIObject {
public:
    OAIDomainDescription();
    OAIDomainDescription(QString json);
    ~OAIDomainDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainDescription)

#endif // OAIDomainDescription_H
