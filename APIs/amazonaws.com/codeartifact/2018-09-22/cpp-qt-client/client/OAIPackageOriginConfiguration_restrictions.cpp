...
#include "OAIPackageOriginConfiguration_restrictions.h"
...
OAIPackageOriginConfiguration_restrictions::OAIPackageOriginConfiguration_restrictions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageOriginConfiguration_restrictions::OAIPackageOriginConfiguration_restrictions() {
    this->initializeModel();
}

OAIPackageOriginConfiguration_restrictions::~OAIPackageOriginConfiguration_restrictions() {}

void OAIPackageOriginConfiguration_restrictions::initializeModel() {
...
void OAIPackageOriginConfiguration_restrictions::fromJson(QString jsonString) {
...
void OAIPackageOriginConfiguration_restrictions::fromJsonObject(QJsonObject json) {
...
QString OAIPackageOriginConfiguration_restrictions::asJson() const {
...
QJsonObject OAIPackageOriginConfiguration_restrictions::asJsonObject() const {
    QJsonObject obj;
    if (m_publish.isSet()) {
...
OAIAllowPublish OAIPackageOriginConfiguration_restrictions::getPublish() const {
    return m_publish;
}
void OAIPackageOriginConfiguration_restrictions::setPublish(const OAIAllowPublish &publish) {
    m_publish = publish;
    m_publish_isSet = true;
}

bool OAIPackageOriginConfiguration_restrictions::is_publish_Set() const{
    return m_publish_isSet;
}

bool OAIPackageOriginConfiguration_restrictions::is_publish_Valid() const{
    return m_publish_isValid;
}

OAIAllowUpstream OAIPackageOriginConfiguration_restrictions::getUpstream() const {
    return m_upstream;
}
void OAIPackageOriginConfiguration_restrictions::setUpstream(const OAIAllowUpstream &upstream) {
    m_upstream = upstream;
    m_upstream_isSet = true;
}

bool OAIPackageOriginConfiguration_restrictions::is_upstream_Set() const{
    return m_upstream_isSet;
}

bool OAIPackageOriginConfiguration_restrictions::is_upstream_Valid() const{
    return m_upstream_isValid;
}

bool OAIPackageOriginConfiguration_restrictions::isSet() const {
...
bool OAIPackageOriginConfiguration_restrictions::isValid() const {
