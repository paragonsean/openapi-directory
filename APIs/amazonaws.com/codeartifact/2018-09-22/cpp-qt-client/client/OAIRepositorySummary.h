...
#ifndef OAIRepositorySummary_H
#define OAIRepositorySummary_H
...
class OAIRepositorySummary : public OAIObject {
public:
    OAIRepositorySummary();
    OAIRepositorySummary(QString json);
    ~OAIRepositorySummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepositorySummary)

#endif // OAIRepositorySummary_H
