...
#include "OAIDescribePackageResult_package.h"
...
OAIDescribePackageResult_package::OAIDescribePackageResult_package(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribePackageResult_package::OAIDescribePackageResult_package() {
    this->initializeModel();
}

OAIDescribePackageResult_package::~OAIDescribePackageResult_package() {}

void OAIDescribePackageResult_package::initializeModel() {
    ...
    m_origin_configuration_isSet = false;
    m_origin_configuration_isValid = false;
}

void OAIDescribePackageResult_package::fromJson(QString jsonString) {
...
void OAIDescribePackageResult_package::fromJsonObject(QJsonObject json) {
    ...
    m_origin_configuration_isValid = ::OpenAPI::fromJsonValue(m_origin_configuration, json[QString("originConfiguration")]);
    m_origin_configuration_isSet = !json[QString("originConfiguration")].isNull() && m_origin_configuration_isValid;
}

QString OAIDescribePackageResult_package::asJson() const {
...
QJsonObject OAIDescribePackageResult_package::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
    ...
    if (m_origin_configuration.isSet()) {
        obj.insert(QString("originConfiguration"), ::OpenAPI::toJsonValue(m_origin_configuration));
    }
    return obj;
}

OAIPackageFormat OAIDescribePackageResult_package::getFormat() const {
    return m_format;
}
void OAIDescribePackageResult_package::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDescribePackageResult_package::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDescribePackageResult_package::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDescribePackageResult_package::getRNamespace() const {
    return m_r_namespace;
}
void OAIDescribePackageResult_package::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIDescribePackageResult_package::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIDescribePackageResult_package::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIDescribePackageResult_package::getName() const {
    return m_name;
}
void OAIDescribePackageResult_package::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribePackageResult_package::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribePackageResult_package::is_name_Valid() const{
    return m_name_isValid;
}

OAIPackageDescription_originConfiguration OAIDescribePackageResult_package::getOriginConfiguration() const {
    return m_origin_configuration;
}
void OAIDescribePackageResult_package::setOriginConfiguration(const OAIPackageDescription_originConfiguration &origin_configuration) {
    m_origin_configuration = origin_configuration;
    m_origin_configuration_isSet = true;
}

bool OAIDescribePackageResult_package::is_origin_configuration_Set() const{
    return m_origin_configuration_isSet;
}

bool OAIDescribePackageResult_package::is_origin_configuration_Valid() const{
    return m_origin_configuration_isValid;
}

bool OAIDescribePackageResult_package::isSet() const {
...
bool OAIDescribePackageResult_package::isValid() const {
