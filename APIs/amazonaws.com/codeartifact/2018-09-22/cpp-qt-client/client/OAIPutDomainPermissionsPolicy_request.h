...
/*
 * OAIPutDomainPermissionsPolicy_request.h
 *
 * 
 */

#ifndef OAIPutDomainPermissionsPolicy_request_H
#define OAIPutDomainPermissionsPolicy_request_H
...
class OAIPutDomainPermissionsPolicy_request : public OAIObject {
public:
    OAIPutDomainPermissionsPolicy_request();
    OAIPutDomainPermissionsPolicy_request(QString json);
    ~OAIPutDomainPermissionsPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDomainPermissionsPolicy_request)

#endif // OAIPutDomainPermissionsPolicy_request_H
