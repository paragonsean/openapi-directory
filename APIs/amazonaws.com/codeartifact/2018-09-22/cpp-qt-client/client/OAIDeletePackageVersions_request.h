...
/*
 * OAIDeletePackageVersions_request.h
 *
 * 
 */

#ifndef OAIDeletePackageVersions_request_H
#define OAIDeletePackageVersions_request_H
...
class OAIDeletePackageVersions_request : public OAIObject {
public:
    OAIDeletePackageVersions_request();
    OAIDeletePackageVersions_request(QString json);
    ~OAIDeletePackageVersions_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePackageVersions_request)

#endif // OAIDeletePackageVersions_request_H
