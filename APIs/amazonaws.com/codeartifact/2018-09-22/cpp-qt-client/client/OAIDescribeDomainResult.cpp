...
OAIDescribeDomainResult::OAIDescribeDomainResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeDomainResult::OAIDescribeDomainResult() {
    this->initializeModel();
}

OAIDescribeDomainResult::~OAIDescribeDomainResult() {}

void OAIDescribeDomainResult::initializeModel() {

    m_domain_isSet = false;
    m_domain_isValid = false;
}

void OAIDescribeDomainResult::fromJson(QString jsonString) {
...
void OAIDescribeDomainResult::fromJsonObject(QJsonObject json) {

    m_domain_isValid = ::OpenAPI::fromJsonValue(m_domain, json[QString("domain")]);
    m_domain_isSet = !json[QString("domain")].isNull() && m_domain_isValid;
}

QString OAIDescribeDomainResult::asJson() const {
...
QJsonObject OAIDescribeDomainResult::asJsonObject() const {
    QJsonObject obj;
    if (m_domain.isSet()) {
...
OAIDomainDescription OAIDescribeDomainResult::getDomain() const {
    return m_domain;
}
void OAIDescribeDomainResult::setDomain(const OAIDomainDescription &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDescribeDomainResult::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDescribeDomainResult::is_domain_Valid() const{
    return m_domain_isValid;
}

bool OAIDescribeDomainResult::isSet() const {
...
bool OAIDescribeDomainResult::isValid() const {
