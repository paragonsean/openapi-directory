...
/*
 * OAIListRepositoriesResult.h
 *
 * 
 */

#ifndef OAIListRepositoriesResult_H
#define OAIListRepositoriesResult_H
...
class OAIListRepositoriesResult : public OAIObject {
public:
    OAIListRepositoriesResult();
    OAIListRepositoriesResult(QString json);
    ~OAIListRepositoriesResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRepositoriesResult)

#endif // OAIListRepositoriesResult_H
