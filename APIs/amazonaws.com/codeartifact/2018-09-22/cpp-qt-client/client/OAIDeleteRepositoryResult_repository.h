...
/*
 * OAIDeleteRepositoryResult_repository.h
 *
 * 
 */

#ifndef OAIDeleteRepositoryResult_repository_H
#define OAIDeleteRepositoryResult_repository_H
...
class OAIDeleteRepositoryResult_repository : public OAIObject {
public:
    OAIDeleteRepositoryResult_repository();
    OAIDeleteRepositoryResult_repository(QString json);
    ~OAIDeleteRepositoryResult_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRepositoryResult_repository)

#endif // OAIDeleteRepositoryResult_repository_H
