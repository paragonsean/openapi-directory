...
/*
 * OAIUpdatePackageVersionsStatusRequest.h
 *
 * 
 */

#ifndef OAIUpdatePackageVersionsStatusRequest_H
#define OAIUpdatePackageVersionsStatusRequest_H
...
class OAIUpdatePackageVersionsStatusRequest : public OAIObject {
public:
    OAIUpdatePackageVersionsStatusRequest();
    OAIUpdatePackageVersionsStatusRequest(QString json);
    ~OAIUpdatePackageVersionsStatusRequest() override;
    ...
    OAIPackageVersionStatus getTargetStatus() const;
    void setTargetStatus(const OAIPackageVersionStatus &target_status);
...
private:
    ...
    OAIPackageVersionStatus m_target_status;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePackageVersionsStatusRequest)

#endif // OAIUpdatePackageVersionsStatusRequest_H
