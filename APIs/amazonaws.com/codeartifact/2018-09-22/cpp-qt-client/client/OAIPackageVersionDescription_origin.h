...
/*
 * OAIPackageVersionDescription_origin.h
 *
 * 
 */

#ifndef OAIPackageVersionDescription_origin_H
#define OAIPackageVersionDescription_origin_H

#include <QJsonObject>

#include "OAIPackageVersionOriginType.h"
#include "OAIPackageVersionOrigin_domainEntryPoint.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPackageVersionOrigin_domainEntryPoint;

class OAIPackageVersionDescription_origin : public OAIObject {
public:
    OAIPackageVersionDescription_origin();
    OAIPackageVersionDescription_origin(QString json);
    ~OAIPackageVersionDescription_origin() override;
    ...
    OAIPackageVersionOrigin_domainEntryPoint getDomainEntryPoint() const;
    void setDomainEntryPoint(const OAIPackageVersionOrigin_domainEntryPoint &domain_entry_point);
    bool is_domain_entry_point_Set() const;
    bool is_domain_entry_point_Valid() const;

    OAIPackageVersionOriginType getOriginType() const;
    void setOriginType(const OAIPackageVersionOriginType &origin_type);
...
private:
    ...
    OAIPackageVersionOrigin_domainEntryPoint m_domain_entry_point;
    bool m_domain_entry_point_isSet;
    bool m_domain_entry_point_isValid;

    OAIPackageVersionOriginType m_origin_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionDescription_origin)

#endif // OAIPackageVersionDescription_origin_H
