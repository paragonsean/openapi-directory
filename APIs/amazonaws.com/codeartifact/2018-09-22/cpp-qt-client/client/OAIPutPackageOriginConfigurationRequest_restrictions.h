...
/*
 * OAIPutPackageOriginConfigurationRequest_restrictions.h
 *
 * 
 */

#ifndef OAIPutPackageOriginConfigurationRequest_restrictions_H
#define OAIPutPackageOriginConfigurationRequest_restrictions_H

#include <QJsonObject>

#include "OAIAllowPublish.h"
#include "OAIAllowUpstream.h"
...
class OAIPutPackageOriginConfigurationRequest_restrictions : public OAIObject {
public:
    OAIPutPackageOriginConfigurationRequest_restrictions();
    OAIPutPackageOriginConfigurationRequest_restrictions(QString json);
    ~OAIPutPackageOriginConfigurationRequest_restrictions() override;
    ...
    OAIAllowPublish getPublish() const;
    void setPublish(const OAIAllowPublish &publish);
    bool is_publish_Set() const;
    bool is_publish_Valid() const;

    OAIAllowUpstream getUpstream() const;
    void setUpstream(const OAIAllowUpstream &upstream);
...
private:
    ...
    OAIAllowPublish m_publish;
    bool m_publish_isSet;
    bool m_publish_isValid;

    OAIAllowUpstream m_upstream;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfigurationRequest_restrictions)

#endif // OAIPutPackageOriginConfigurationRequest_restrictions_H
