...
/*
 * OAIPublishPackageVersion_request.h
 *
 * 
 */

#ifndef OAIPublishPackageVersion_request_H
#define OAIPublishPackageVersion_request_H
...
class OAIPublishPackageVersion_request : public OAIObject {
public:
    OAIPublishPackageVersion_request();
    OAIPublishPackageVersion_request(QString json);
    ~OAIPublishPackageVersion_request() override;
    ...
    QString getAssetContent() const;
    void setAssetContent(const QString &asset_content);
    bool is_asset_content_Set() const;
    bool is_asset_content_Valid() const;
...
private:
    ...
    QString m_asset_content;
    bool m_asset_content_isSet;
    bool m_asset_content_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPublishPackageVersion_request)

#endif // OAIPublishPackageVersion_request_H
