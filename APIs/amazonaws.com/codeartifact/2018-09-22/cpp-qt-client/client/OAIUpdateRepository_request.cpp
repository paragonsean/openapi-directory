...
OAIUpdateRepository_request::OAIUpdateRepository_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateRepository_request::OAIUpdateRepository_request() {
    this->initializeModel();
}

OAIUpdateRepository_request::~OAIUpdateRepository_request() {}

void OAIUpdateRepository_request::initializeModel() {
...
void OAIUpdateRepository_request::fromJson(QString jsonString) {
...
void OAIUpdateRepository_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateRepository_request::asJson() const {
...
QJsonObject OAIUpdateRepository_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateRepository_request::getDescription() const {
    return m_description;
}
void OAIUpdateRepository_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateRepository_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateRepository_request::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIUpstreamRepository> OAIUpdateRepository_request::getUpstreams() const {
    return m_upstreams;
}
void OAIUpdateRepository_request::setUpstreams(const QList<OAIUpstreamRepository> &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAIUpdateRepository_request::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAIUpdateRepository_request::is_upstreams_Valid() const{
    return m_upstreams_isValid;
}

bool OAIUpdateRepository_request::isSet() const {
...
bool OAIUpdateRepository_request::isValid() const {
