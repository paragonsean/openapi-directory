...
/*
 * OAIPutPackageOriginConfigurationResult_originConfiguration.h
 *
 * 
 */

#ifndef OAIPutPackageOriginConfigurationResult_originConfiguration_H
#define OAIPutPackageOriginConfigurationResult_originConfiguration_H
...
class OAIPutPackageOriginConfigurationResult_originConfiguration : public OAIObject {
public:
    OAIPutPackageOriginConfigurationResult_originConfiguration();
    OAIPutPackageOriginConfigurationResult_originConfiguration(QString json);
    ~OAIPutPackageOriginConfigurationResult_originConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfigurationResult_originConfiguration)

#endif // OAIPutPackageOriginConfigurationResult_originConfiguration_H
