...
/*
 * OAIDescribePackageResult.h
 *
 * 
 */

#ifndef OAIDescribePackageResult_H
#define OAIDescribePackageResult_H
...
namespace OpenAPI {
class OAIDescribePackageResult_package;

class OAIDescribePackageResult : public OAIObject {
public:
    OAIDescribePackageResult();
    OAIDescribePackageResult(QString json);
    ~OAIDescribePackageResult() override;
    ...
    OAIDescribePackageResult_package getPackage() const;
    void setPackage(const OAIDescribePackageResult_package &package);
...
private:
    ...
    OAIDescribePackageResult_package m_package;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePackageResult)

#endif // OAIDescribePackageResult_H
