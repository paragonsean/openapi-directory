...
OAIPutRepositoryPermissionsPolicy_request::OAIPutRepositoryPermissionsPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutRepositoryPermissionsPolicy_request::OAIPutRepositoryPermissionsPolicy_request() {
    this->initializeModel();
}

OAIPutRepositoryPermissionsPolicy_request::~OAIPutRepositoryPermissionsPolicy_request() {}

void OAIPutRepositoryPermissionsPolicy_request::initializeModel() {
...
void OAIPutRepositoryPermissionsPolicy_request::fromJson(QString jsonString) {
...
void OAIPutRepositoryPermissionsPolicy_request::fromJsonObject(QJsonObject json) {
...
QString OAIPutRepositoryPermissionsPolicy_request::asJson() const {
...
QJsonObject OAIPutRepositoryPermissionsPolicy_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutRepositoryPermissionsPolicy_request::getPolicyRevision() const {
    return m_policy_revision;
}
void OAIPutRepositoryPermissionsPolicy_request::setPolicyRevision(const QString &policy_revision) {
    m_policy_revision = policy_revision;
    m_policy_revision_isSet = true;
}

bool OAIPutRepositoryPermissionsPolicy_request::is_policy_revision_Set() const{
    return m_policy_revision_isSet;
}

bool OAIPutRepositoryPermissionsPolicy_request::is_policy_revision_Valid() const{
    return m_policy_revision_isValid;
}

QString OAIPutRepositoryPermissionsPolicy_request::getPolicyDocument() const {
    return m_policy_document;
}
void OAIPutRepositoryPermissionsPolicy_request::setPolicyDocument(const QString &policy_document) {
    m_policy_document = policy_document;
    m_policy_document_isSet = true;
}

bool OAIPutRepositoryPermissionsPolicy_request::is_policy_document_Set() const{
    return m_policy_document_isSet;
}

bool OAIPutRepositoryPermissionsPolicy_request::is_policy_document_Valid() const{
    return m_policy_document_isValid;
}

bool OAIPutRepositoryPermissionsPolicy_request::isSet() const {
...
bool OAIPutRepositoryPermissionsPolicy_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_document_isValid && true;
}
