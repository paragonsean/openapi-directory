...
/*
 * OAIListPackageVersionAssetsResult.h
 *
 * 
 */

#ifndef OAIListPackageVersionAssetsResult_H
#define OAIListPackageVersionAssetsResult_H
...
class OAIListPackageVersionAssetsResult : public OAIObject {
public:
    OAIListPackageVersionAssetsResult();
    OAIListPackageVersionAssetsResult(QString json);
    ~OAIListPackageVersionAssetsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPackageVersionAssetsResult)

#endif // OAIListPackageVersionAssetsResult_H
