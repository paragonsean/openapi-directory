...
/*
 * OAIGetRepositoryPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIGetRepositoryPermissionsPolicyResult_H
#define OAIGetRepositoryPermissionsPolicyResult_H
...
namespace OpenAPI {
class OAIGetDomainPermissionsPolicyResult_policy;

class OAIGetRepositoryPermissionsPolicyResult : public OAIObject {
public:
    OAIGetRepositoryPermissionsPolicyResult();
    OAIGetRepositoryPermissionsPolicyResult(QString json);
    ~OAIGetRepositoryPermissionsPolicyResult() override;
    ...
    OAIGetDomainPermissionsPolicyResult_policy getPolicy() const;
    void setPolicy(const OAIGetDomainPermissionsPolicyResult_policy &policy);
...
private:
    ...
    OAIGetDomainPermissionsPolicyResult_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRepositoryPermissionsPolicyResult)

#endif // OAIGetRepositoryPermissionsPolicyResult_H
