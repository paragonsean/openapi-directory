...
OAILicenseInfo::OAILicenseInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicenseInfo::OAILicenseInfo() {
    this->initializeModel();
}

OAILicenseInfo::~OAILicenseInfo() {}

void OAILicenseInfo::initializeModel() {
...
void OAILicenseInfo::fromJson(QString jsonString) {
...
void OAILicenseInfo::fromJsonObject(QJsonObject json) {
...
QString OAILicenseInfo::asJson() const {
...
QJsonObject OAILicenseInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAILicenseInfo::getName() const {
    return m_name;
}
void OAILicenseInfo::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILicenseInfo::is_name_Set() const{
    return m_name_isSet;
}

bool OAILicenseInfo::is_name_Valid() const{
    return m_name_isValid;
}

QString OAILicenseInfo::getUrl() const {
    return m_url;
}
void OAILicenseInfo::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAILicenseInfo::is_url_Set() const{
    return m_url_isSet;
}

bool OAILicenseInfo::is_url_Valid() const{
    return m_url_isValid;
}

bool OAILicenseInfo::isSet() const {
...
bool OAILicenseInfo::isValid() const {
