...
OAIAllowPublish::OAIAllowPublish(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllowPublish::OAIAllowPublish() {
    this->initializeModel();
}

OAIAllowPublish::~OAIAllowPublish() {}

void OAIAllowPublish::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAllowPublish::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAllowPublish::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALLOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAllowPublish::ALLOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("BLOCK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAllowPublish::BLOCK;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAllowPublish::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAllowPublish::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAllowPublish::ALLOW:
            val = "ALLOW";
            break;
        case eOAIAllowPublish::BLOCK:
            val = "BLOCK";
            break;
        default:
            break;
...
QJsonValue OAIAllowPublish::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAllowPublish::eOAIAllowPublish OAIAllowPublish::getValue() const {
    return m_value;
}

void OAIAllowPublish::setValue(const OAIAllowPublish::eOAIAllowPublish& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAllowPublish::isSet() const {
    
    return m_value_isSet;
}

bool OAIAllowPublish::isValid() const {
