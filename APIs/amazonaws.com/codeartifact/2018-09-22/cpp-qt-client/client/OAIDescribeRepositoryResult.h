...
/*
 * OAIDescribeRepositoryResult.h
 *
 * 
 */

#ifndef OAIDescribeRepositoryResult_H
#define OAIDescribeRepositoryResult_H
...
namespace OpenAPI {
class OAIDescribeRepositoryResult_repository;

class OAIDescribeRepositoryResult : public OAIObject {
public:
    OAIDescribeRepositoryResult();
    OAIDescribeRepositoryResult(QString json);
    ~OAIDescribeRepositoryResult() override;
    ...
    OAIDescribeRepositoryResult_repository getRepository() const;
    void setRepository(const OAIDescribeRepositoryResult_repository &repository);
...
private:
    ...
    OAIDescribeRepositoryResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRepositoryResult)

#endif // OAIDescribeRepositoryResult_H
