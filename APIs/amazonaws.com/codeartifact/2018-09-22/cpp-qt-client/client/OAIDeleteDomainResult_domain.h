...
/*
 * OAIDeleteDomainResult_domain.h
 *
 * 
 */

#ifndef OAIDeleteDomainResult_domain_H
#define OAIDeleteDomainResult_domain_H
...
class OAIDeleteDomainResult_domain : public OAIObject {
public:
    OAIDeleteDomainResult_domain();
    OAIDeleteDomainResult_domain(QString json);
    ~OAIDeleteDomainResult_domain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDomainResult_domain)

#endif // OAIDeleteDomainResult_domain_H
