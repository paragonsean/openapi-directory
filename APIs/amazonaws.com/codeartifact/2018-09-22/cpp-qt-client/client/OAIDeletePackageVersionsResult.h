...
/*
 * OAIDeletePackageVersionsResult.h
 *
 * 
 */

#ifndef OAIDeletePackageVersionsResult_H
#define OAIDeletePackageVersionsResult_H
...
class OAIDeletePackageVersionsResult : public OAIObject {
public:
    OAIDeletePackageVersionsResult();
    OAIDeletePackageVersionsResult(QString json);
    ~OAIDeletePackageVersionsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePackageVersionsResult)

#endif // OAIDeletePackageVersionsResult_H
