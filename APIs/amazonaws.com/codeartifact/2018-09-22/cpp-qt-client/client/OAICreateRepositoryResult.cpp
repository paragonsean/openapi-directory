...
OAICreateRepositoryResult::OAICreateRepositoryResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRepositoryResult::OAICreateRepositoryResult() {
    this->initializeModel();
}

OAICreateRepositoryResult::~OAICreateRepositoryResult() {}

void OAICreateRepositoryResult::initializeModel() {

    m_repository_isSet = false;
    m_repository_isValid = false;
}

void OAICreateRepositoryResult::fromJson(QString jsonString) {
...
void OAICreateRepositoryResult::fromJsonObject(QJsonObject json) {
...
QString OAICreateRepositoryResult::asJson() const {
...
QJsonObject OAICreateRepositoryResult::asJsonObject() const {
    QJsonObject obj;
...
OAICreateRepositoryResult_repository OAICreateRepositoryResult::getRepository() const {
    return m_repository;
}
void OAICreateRepositoryResult::setRepository(const OAICreateRepositoryResult_repository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAICreateRepositoryResult::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAICreateRepositoryResult::is_repository_Valid() const{
    return m_repository_isValid;
}

bool OAICreateRepositoryResult::isSet() const {
...
bool OAICreateRepositoryResult::isValid() const {
