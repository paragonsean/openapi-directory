...
OAICreateDomainResult_domain::OAICreateDomainResult_domain(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDomainResult_domain::OAICreateDomainResult_domain() {
    this->initializeModel();
}

OAICreateDomainResult_domain::~OAICreateDomainResult_domain() {}

void OAICreateDomainResult_domain::initializeModel() {
...
void OAICreateDomainResult_domain::fromJson(QString jsonString) {
...
void OAICreateDomainResult_domain::fromJsonObject(QJsonObject json) {
...
QString OAICreateDomainResult_domain::asJson() const {
...
QJsonObject OAICreateDomainResult_domain::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateDomainResult_domain::getName() const {
    return m_name;
}
void OAICreateDomainResult_domain::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateDomainResult_domain::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateDomainResult_domain::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateDomainResult_domain::getOwner() const {
    return m_owner;
}
void OAICreateDomainResult_domain::setOwner(const QString &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAICreateDomainResult_domain::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAICreateDomainResult_domain::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAICreateDomainResult_domain::getArn() const {
    return m_arn;
}
void OAICreateDomainResult_domain::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateDomainResult_domain::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateDomainResult_domain::is_arn_Valid() const{
    return m_arn_isValid;
}

OAIDomainStatus OAICreateDomainResult_domain::getStatus() const {
    return m_status;
}
void OAICreateDomainResult_domain::setStatus(const OAIDomainStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateDomainResult_domain::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateDomainResult_domain::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAICreateDomainResult_domain::getCreatedTime() const {
    return m_created_time;
}
void OAICreateDomainResult_domain::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICreateDomainResult_domain::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICreateDomainResult_domain::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QString OAICreateDomainResult_domain::getEncryptionKey() const {
    return m_encryption_key;
}
void OAICreateDomainResult_domain::setEncryptionKey(const QString &encryption_key) {
    m_encryption_key = encryption_key;
    m_encryption_key_isSet = true;
}

bool OAICreateDomainResult_domain::is_encryption_key_Set() const{
    return m_encryption_key_isSet;
}

bool OAICreateDomainResult_domain::is_encryption_key_Valid() const{
    return m_encryption_key_isValid;
}

qint32 OAICreateDomainResult_domain::getRepositoryCount() const {
    return m_repository_count;
}
void OAICreateDomainResult_domain::setRepositoryCount(const qint32 &repository_count) {
    m_repository_count = repository_count;
    m_repository_count_isSet = true;
}

bool OAICreateDomainResult_domain::is_repository_count_Set() const{
    return m_repository_count_isSet;
}

bool OAICreateDomainResult_domain::is_repository_count_Valid() const{
    return m_repository_count_isValid;
}

qint32 OAICreateDomainResult_domain::getAssetSizeBytes() const {
    return m_asset_size_bytes;
}
void OAICreateDomainResult_domain::setAssetSizeBytes(const qint32 &asset_size_bytes) {
    m_asset_size_bytes = asset_size_bytes;
    m_asset_size_bytes_isSet = true;
}

bool OAICreateDomainResult_domain::is_asset_size_bytes_Set() const{
    return m_asset_size_bytes_isSet;
}

bool OAICreateDomainResult_domain::is_asset_size_bytes_Valid() const{
    return m_asset_size_bytes_isValid;
}

QString OAICreateDomainResult_domain::getS3BucketArn() const {
    return m_s3_bucket_arn;
}
void OAICreateDomainResult_domain::setS3BucketArn(const QString &s3_bucket_arn) {
    m_s3_bucket_arn = s3_bucket_arn;
    m_s3_bucket_arn_isSet = true;
}

bool OAICreateDomainResult_domain::is_s3_bucket_arn_Set() const{
    return m_s3_bucket_arn_isSet;
}

bool OAICreateDomainResult_domain::is_s3_bucket_arn_Valid() const{
    return m_s3_bucket_arn_isValid;
}

bool OAICreateDomainResult_domain::isSet() const {
...
bool OAICreateDomainResult_domain::isValid() const {
