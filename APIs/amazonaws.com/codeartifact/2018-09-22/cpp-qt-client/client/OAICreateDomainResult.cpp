...
OAICreateDomainResult::OAICreateDomainResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDomainResult::OAICreateDomainResult() {
    this->initializeModel();
}

OAICreateDomainResult::~OAICreateDomainResult() {}

void OAICreateDomainResult::initializeModel() {

    m_domain_isSet = false;
    m_domain_isValid = false;
}

void OAICreateDomainResult::fromJson(QString jsonString) {
...
void OAICreateDomainResult::fromJsonObject(QJsonObject json) {

    m_domain_isValid = ::OpenAPI::fromJsonValue(m_domain, json[QString("domain")]);
    m_domain_isSet = !json[QString("domain")].isNull() && m_domain_isValid;
}

QString OAICreateDomainResult::asJson() const {
...
QJsonObject OAICreateDomainResult::asJsonObject() const {
    QJsonObject obj;
    if (m_domain.isSet()) {
...
OAICreateDomainResult_domain OAICreateDomainResult::getDomain() const {
    return m_domain;
}
void OAICreateDomainResult::setDomain(const OAICreateDomainResult_domain &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAICreateDomainResult::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAICreateDomainResult::is_domain_Valid() const{
    return m_domain_isValid;
}

bool OAICreateDomainResult::isSet() const {
...
bool OAICreateDomainResult::isValid() const {
