...
/*
 * OAIPackageOriginConfiguration.h
 *
 * Details about the package origin configuration of a package.
 */

#ifndef OAIPackageOriginConfiguration_H
#define OAIPackageOriginConfiguration_H
...
class OAIPackageOriginConfiguration : public OAIObject {
public:
    OAIPackageOriginConfiguration();
    OAIPackageOriginConfiguration(QString json);
    ~OAIPackageOriginConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageOriginConfiguration)

#endif // OAIPackageOriginConfiguration_H
