...
#ifndef OAIAllowUpstream_H
#define OAIAllowUpstream_H
...
class OAIAllowUpstream : public OAIEnum {
public:
    OAIAllowUpstream();
    OAIAllowUpstream(QString json);
    ~OAIAllowUpstream() override;
    ...
    enum class eOAIAllowUpstream {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALLOW, 
        BLOCK
    };
    OAIAllowUpstream::eOAIAllowUpstream getValue() const;
    void setValue(const OAIAllowUpstream::eOAIAllowUpstream& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllowUpstream)

#endif // OAIAllowUpstream_H
