...
/*
 * OAIAssociateExternalConnectionResult_repository.h
 *
 * 
 */

#ifndef OAIAssociateExternalConnectionResult_repository_H
#define OAIAssociateExternalConnectionResult_repository_H
...
class OAIAssociateExternalConnectionResult_repository : public OAIObject {
public:
    OAIAssociateExternalConnectionResult_repository();
    OAIAssociateExternalConnectionResult_repository(QString json);
    ~OAIAssociateExternalConnectionResult_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateExternalConnectionResult_repository)

#endif // OAIAssociateExternalConnectionResult_repository_H
