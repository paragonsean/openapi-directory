...
/*
 * OAIDeleteDomainResult.h
 *
 * 
 */

#ifndef OAIDeleteDomainResult_H
#define OAIDeleteDomainResult_H
...
namespace OpenAPI {
class OAIDeleteDomainResult_domain;

class OAIDeleteDomainResult : public OAIObject {
public:
    OAIDeleteDomainResult();
    OAIDeleteDomainResult(QString json);
    ~OAIDeleteDomainResult() override;
    ...
    OAIDeleteDomainResult_domain getDomain() const;
    void setDomain(const OAIDeleteDomainResult_domain &domain);
...
private:
    ...
    OAIDeleteDomainResult_domain m_domain;
    bool m_domain_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDomainResult)

#endif // OAIDeleteDomainResult_H
