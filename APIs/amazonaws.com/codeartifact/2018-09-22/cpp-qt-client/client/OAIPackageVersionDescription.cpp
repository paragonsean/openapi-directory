...
#include "OAIPackageVersionDescription.h"
...
OAIPackageVersionDescription::OAIPackageVersionDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionDescription::OAIPackageVersionDescription() {
    this->initializeModel();
}

OAIPackageVersionDescription::~OAIPackageVersionDescription() {}

void OAIPackageVersionDescription::initializeModel() {
...
void OAIPackageVersionDescription::fromJson(QString jsonString) {
...
void OAIPackageVersionDescription::fromJsonObject(QJsonObject json) {
...
QString OAIPackageVersionDescription::asJson() const {
...
QJsonObject OAIPackageVersionDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_format.isSet()) {
...
OAIPackageFormat OAIPackageVersionDescription::getFormat() const {
    return m_format;
}
void OAIPackageVersionDescription::setFormat(const OAIPackageFormat &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPackageVersionDescription::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPackageVersionDescription::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPackageVersionDescription::getRNamespace() const {
    return m_r_namespace;
}
void OAIPackageVersionDescription::setRNamespace(const QString &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIPackageVersionDescription::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIPackageVersionDescription::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIPackageVersionDescription::getPackageName() const {
    return m_package_name;
}
void OAIPackageVersionDescription::setPackageName(const QString &package_name) {
    m_package_name = package_name;
    m_package_name_isSet = true;
}

bool OAIPackageVersionDescription::is_package_name_Set() const{
    return m_package_name_isSet;
}

bool OAIPackageVersionDescription::is_package_name_Valid() const{
    return m_package_name_isValid;
}

QString OAIPackageVersionDescription::getDisplayName() const {
    return m_display_name;
}
void OAIPackageVersionDescription::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIPackageVersionDescription::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIPackageVersionDescription::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIPackageVersionDescription::getVersion() const {
    return m_version;
}
void OAIPackageVersionDescription::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIPackageVersionDescription::is_version_Set() const{
    return m_version_isSet;
}

bool OAIPackageVersionDescription::is_version_Valid() const{
    return m_version_isValid;
}

QString OAIPackageVersionDescription::getSummary() const {
    return m_summary;
}
void OAIPackageVersionDescription::setSummary(const QString &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIPackageVersionDescription::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIPackageVersionDescription::is_summary_Valid() const{
    return m_summary_isValid;
}

QString OAIPackageVersionDescription::getHomePage() const {
    return m_home_page;
}
void OAIPackageVersionDescription::setHomePage(const QString &home_page) {
    m_home_page = home_page;
    m_home_page_isSet = true;
}

bool OAIPackageVersionDescription::is_home_page_Set() const{
    return m_home_page_isSet;
}

bool OAIPackageVersionDescription::is_home_page_Valid() const{
    return m_home_page_isValid;
}

QString OAIPackageVersionDescription::getSourceCodeRepository() const {
    return m_source_code_repository;
}
void OAIPackageVersionDescription::setSourceCodeRepository(const QString &source_code_repository) {
    m_source_code_repository = source_code_repository;
    m_source_code_repository_isSet = true;
}

bool OAIPackageVersionDescription::is_source_code_repository_Set() const{
    return m_source_code_repository_isSet;
}

bool OAIPackageVersionDescription::is_source_code_repository_Valid() const{
    return m_source_code_repository_isValid;
}

QDateTime OAIPackageVersionDescription::getPublishedTime() const {
    return m_published_time;
}
void OAIPackageVersionDescription::setPublishedTime(const QDateTime &published_time) {
    m_published_time = published_time;
    m_published_time_isSet = true;
}

bool OAIPackageVersionDescription::is_published_time_Set() const{
    return m_published_time_isSet;
}

bool OAIPackageVersionDescription::is_published_time_Valid() const{
    return m_published_time_isValid;
}

QList OAIPackageVersionDescription::getLicenses() const {
    return m_licenses;
}
void OAIPackageVersionDescription::setLicenses(const QList &licenses) {
    m_licenses = licenses;
    m_licenses_isSet = true;
}

bool OAIPackageVersionDescription::is_licenses_Set() const{
    return m_licenses_isSet;
}

bool OAIPackageVersionDescription::is_licenses_Valid() const{
    return m_licenses_isValid;
}

QString OAIPackageVersionDescription::getRevision() const {
    return m_revision;
}
void OAIPackageVersionDescription::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIPackageVersionDescription::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIPackageVersionDescription::is_revision_Valid() const{
    return m_revision_isValid;
}

OAIPackageVersionStatus OAIPackageVersionDescription::getStatus() const {
    return m_status;
}
void OAIPackageVersionDescription::setStatus(const OAIPackageVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPackageVersionDescription::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPackageVersionDescription::is_status_Valid() const{
    return m_status_isValid;
}

OAIPackageVersionDescription_origin OAIPackageVersionDescription::getOrigin() const {
    return m_origin;
}
void OAIPackageVersionDescription::setOrigin(const OAIPackageVersionDescription_origin &origin) {
    m_origin = origin;
    m_origin_isSet = true;
}

bool OAIPackageVersionDescription::is_origin_Set() const{
    return m_origin_isSet;
}

bool OAIPackageVersionDescription::is_origin_Valid() const{
    return m_origin_isValid;
}

bool OAIPackageVersionDescription::isSet() const {
...
bool OAIPackageVersionDescription::isValid() const {
