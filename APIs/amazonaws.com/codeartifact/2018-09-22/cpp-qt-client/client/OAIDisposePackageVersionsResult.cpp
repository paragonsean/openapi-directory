...
OAIDisposePackageVersionsResult::OAIDisposePackageVersionsResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisposePackageVersionsResult::OAIDisposePackageVersionsResult() {
    this->initializeModel();
}

OAIDisposePackageVersionsResult::~OAIDisposePackageVersionsResult() {}

void OAIDisposePackageVersionsResult::initializeModel() {
...
void OAIDisposePackageVersionsResult::fromJson(QString jsonString) {
...
void OAIDisposePackageVersionsResult::fromJsonObject(QJsonObject json) {
...
QString OAIDisposePackageVersionsResult::asJson() const {
...
QJsonObject OAIDisposePackageVersionsResult::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIDisposePackageVersionsResult::getSuccessfulVersions() const {
    return m_successful_versions;
}
void OAIDisposePackageVersionsResult::setSuccessfulVersions(const QMap &successful_versions) {
    m_successful_versions = successful_versions;
    m_successful_versions_isSet = true;
}

bool OAIDisposePackageVersionsResult::is_successful_versions_Set() const{
    return m_successful_versions_isSet;
}

bool OAIDisposePackageVersionsResult::is_successful_versions_Valid() const{
    return m_successful_versions_isValid;
}

QMap OAIDisposePackageVersionsResult::getFailedVersions() const {
    return m_failed_versions;
}
void OAIDisposePackageVersionsResult::setFailedVersions(const QMap &failed_versions) {
    m_failed_versions = failed_versions;
    m_failed_versions_isSet = true;
}

bool OAIDisposePackageVersionsResult::is_failed_versions_Set() const{
    return m_failed_versions_isSet;
}

bool OAIDisposePackageVersionsResult::is_failed_versions_Valid() const{
    return m_failed_versions_isValid;
}

bool OAIDisposePackageVersionsResult::isSet() const {
...
bool OAIDisposePackageVersionsResult::isValid() const {
