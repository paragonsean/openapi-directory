...
/*
 * OAIPackageVersionStatus.h
 *
 * 
 */

#ifndef OAIPackageVersionStatus_H
#define OAIPackageVersionStatus_H
...
class OAIPackageVersionStatus : public OAIEnum {
public:
    OAIPackageVersionStatus();
    OAIPackageVersionStatus(QString json);
    ~OAIPackageVersionStatus() override;
    ...
    enum class eOAIPackageVersionStatus {
    ...
    OAIPackageVersionStatus::eOAIPackageVersionStatus getValue() const;
    void setValue(const OAIPackageVersionStatus::eOAIPackageVersionStatus& value);
...
private:
    ...
    eOAIPackageVersionStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageVersionStatus)

#endif // OAIPackageVersionStatus_H
