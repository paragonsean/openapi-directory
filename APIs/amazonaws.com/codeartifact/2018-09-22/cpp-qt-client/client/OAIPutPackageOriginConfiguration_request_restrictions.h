...
/*
 * OAIPutPackageOriginConfiguration_request_restrictions.h
 *
...
#ifndef OAIPutPackageOriginConfiguration_request_restrictions_H
#define OAIPutPackageOriginConfiguration_request_restrictions_H
...
class OAIPutPackageOriginConfiguration_request_restrictions : public OAIObject {
public:
    OAIPutPackageOriginConfiguration_request_restrictions();
    OAIPutPackageOriginConfiguration_request_restrictions(QString json);
    ~OAIPutPackageOriginConfiguration_request_restrictions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPackageOriginConfiguration_request_restrictions)

#endif // OAIPutPackageOriginConfiguration_request_restrictions_H
