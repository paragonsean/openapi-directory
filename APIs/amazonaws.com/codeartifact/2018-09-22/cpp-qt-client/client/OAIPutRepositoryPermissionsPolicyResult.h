...
/*
 * OAIPutRepositoryPermissionsPolicyResult.h
 *
 * 
 */

#ifndef OAIPutRepositoryPermissionsPolicyResult_H
#define OAIPutRepositoryPermissionsPolicyResult_H

#include <QJsonObject>

#include "OAIPutDomainPermissionsPolicyResult_policy.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPutDomainPermissionsPolicyResult_policy;

class OAIPutRepositoryPermissionsPolicyResult : public OAIObject {
public:
    OAIPutRepositoryPermissionsPolicyResult();
    OAIPutRepositoryPermissionsPolicyResult(QString json);
    ~OAIPutRepositoryPermissionsPolicyResult() override;
    ...
    OAIPutDomainPermissionsPolicyResult_policy getPolicy() const;
    void setPolicy(const OAIPutDomainPermissionsPolicyResult_policy &policy);
...
private:
    ...
    OAIPutDomainPermissionsPolicyResult_policy m_policy;
    bool m_policy_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutRepositoryPermissionsPolicyResult)

#endif // OAIPutRepositoryPermissionsPolicyResult_H
