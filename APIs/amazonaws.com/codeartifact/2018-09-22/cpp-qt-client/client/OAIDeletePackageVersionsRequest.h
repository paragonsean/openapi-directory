...
/*
 * OAIDeletePackageVersionsRequest.h
 *
 * 
 */

#ifndef OAIDeletePackageVersionsRequest_H
#define OAIDeletePackageVersionsRequest_H
...
class OAIDeletePackageVersionsRequest : public OAIObject {
public:
    OAIDeletePackageVersionsRequest();
    OAIDeletePackageVersionsRequest(QString json);
    ~OAIDeletePackageVersionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePackageVersionsRequest)

#endif // OAIDeletePackageVersionsRequest_H
