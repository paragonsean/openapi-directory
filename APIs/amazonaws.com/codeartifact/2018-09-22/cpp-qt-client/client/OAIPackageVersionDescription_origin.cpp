...
OAIPackageVersionDescription_origin::OAIPackageVersionDescription_origin(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageVersionDescription_origin::OAIPackageVersionDescription_origin() {
    this->initializeModel();
}

OAIPackageVersionDescription_origin::~OAIPackageVersionDescription_origin() {}

void OAIPackageVersionDescription_origin::initializeModel() {
...
void OAIPackageVersionDescription_origin::fromJson(QString jsonString) {
...
void OAIPackageVersionDescription_origin::fromJsonObject(QJsonObject json) {
...
QString OAIPackageVersionDescription_origin::asJson() const {
...
QJsonObject OAIPackageVersionDescription_origin::asJsonObject() const {
    QJsonObject obj;
...
OAIPackageVersionOrigin_domainEntryPoint OAIPackageVersionDescription_origin::getDomainEntryPoint() const {
    return m_domain_entry_point;
}
void OAIPackageVersionDescription_origin::setDomainEntryPoint(const OAIPackageVersionOrigin_domainEntryPoint &domain_entry_point) {
    m_domain_entry_point = domain_entry_point;
    m_domain_entry_point_isSet = true;
}

bool OAIPackageVersionDescription_origin::is_domain_entry_point_Set() const{
    return m_domain_entry_point_isSet;
}

bool OAIPackageVersionDescription_origin::is_domain_entry_point_Valid() const{
    return m_domain_entry_point_isValid;
}

OAIPackageVersionOriginType OAIPackageVersionDescription_origin::getOriginType() const {
    return m_origin_type;
}
void OAIPackageVersionDescription_origin::setOriginType(const OAIPackageVersionOriginType &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAIPackageVersionDescription_origin::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAIPackageVersionDescription_origin::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

bool OAIPackageVersionDescription_origin::isSet() const {
...
bool OAIPackageVersionDescription_origin::isValid() const {
