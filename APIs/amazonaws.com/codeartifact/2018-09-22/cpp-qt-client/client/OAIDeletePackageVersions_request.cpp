...
OAIDeletePackageVersions_request::OAIDeletePackageVersions_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePackageVersions_request::OAIDeletePackageVersions_request() {
    this->initializeModel();
}

OAIDeletePackageVersions_request::~OAIDeletePackageVersions_request() {}

void OAIDeletePackageVersions_request::initializeModel() {
...
void OAIDeletePackageVersions_request::fromJson(QString jsonString) {
...
void OAIDeletePackageVersions_request::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePackageVersions_request::asJson() const {
...
QJsonObject OAIDeletePackageVersions_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIDeletePackageVersions_request::getVersions() const {
    return m_versions;
}
void OAIDeletePackageVersions_request::setVersions(const QList<QString> &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIDeletePackageVersions_request::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIDeletePackageVersions_request::is_versions_Valid() const{
    return m_versions_isValid;
}

QString OAIDeletePackageVersions_request::getExpectedStatus() const {
    return m_expected_status;
}
void OAIDeletePackageVersions_request::setExpectedStatus(const QString &expected_status) {
    m_expected_status = expected_status;
    m_expected_status_isSet = true;
}

bool OAIDeletePackageVersions_request::is_expected_status_Set() const{
    return m_expected_status_isSet;
}

bool OAIDeletePackageVersions_request::is_expected_status_Valid() const{
    return m_expected_status_isValid;
}

bool OAIDeletePackageVersions_request::isSet() const {
...
bool OAIDeletePackageVersions_request::isValid() const {
