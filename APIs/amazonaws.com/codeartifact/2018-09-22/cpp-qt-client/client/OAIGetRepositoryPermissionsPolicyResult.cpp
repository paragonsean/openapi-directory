...
OAIGetRepositoryPermissionsPolicyResult::OAIGetRepositoryPermissionsPolicyResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRepositoryPermissionsPolicyResult::OAIGetRepositoryPermissionsPolicyResult() {
    this->initializeModel();
}

OAIGetRepositoryPermissionsPolicyResult::~OAIGetRepositoryPermissionsPolicyResult() {}

void OAIGetRepositoryPermissionsPolicyResult::initializeModel() {

    m_policy_isSet = false;
    m_policy_isValid = false;
}

void OAIGetRepositoryPermissionsPolicyResult::fromJson(QString jsonString) {
...
void OAIGetRepositoryPermissionsPolicyResult::fromJsonObject(QJsonObject json) {

    m_policy_isValid = ::OpenAPI::fromJsonValue(m_policy, json[QString("policy")]);
    m_policy_isSet = !json[QString("policy")].isNull() && m_policy_isValid;
}

QString OAIGetRepositoryPermissionsPolicyResult::asJson() const {
...
QJsonObject OAIGetRepositoryPermissionsPolicyResult::asJsonObject() const {
    QJsonObject obj;
    if (m_policy.isSet()) {
...
OAIGetDomainPermissionsPolicyResult_policy OAIGetRepositoryPermissionsPolicyResult::getPolicy() const {
    return m_policy;
}
void OAIGetRepositoryPermissionsPolicyResult::setPolicy(const OAIGetDomainPermissionsPolicyResult_policy &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIGetRepositoryPermissionsPolicyResult::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIGetRepositoryPermissionsPolicyResult::is_policy_Valid() const{
    return m_policy_isValid;
}

bool OAIGetRepositoryPermissionsPolicyResult::isSet() const {
...
bool OAIGetRepositoryPermissionsPolicyResult::isValid() const {
