...
/*
 * OAIPutDomainPermissionsPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutDomainPermissionsPolicyRequest_H
#define OAIPutDomainPermissionsPolicyRequest_H
...
class OAIPutDomainPermissionsPolicyRequest : public OAIObject {
public:
    OAIPutDomainPermissionsPolicyRequest();
    OAIPutDomainPermissionsPolicyRequest(QString json);
    ~OAIPutDomainPermissionsPolicyRequest() override;
    ...
    QString getPolicyRevision() const;
    void setPolicyRevision(const QString &policy_revision);
    bool is_policy_revision_Set() const;
    bool is_policy_revision_Valid() const;
...
private:
    ...
    QString m_policy_revision;
    bool m_policy_revision_isSet;
    bool m_policy_revision_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutDomainPermissionsPolicyRequest)

#endif // OAIPutDomainPermissionsPolicyRequest_H
