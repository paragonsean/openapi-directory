...
#include "OAIDeleteRepositoryPermissionsPolicyResult_policy.h"
...
OAIDeleteRepositoryPermissionsPolicyResult_policy::OAIDeleteRepositoryPermissionsPolicyResult_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRepositoryPermissionsPolicyResult_policy::OAIDeleteRepositoryPermissionsPolicyResult_policy() {
    this->initializeModel();
}

OAIDeleteRepositoryPermissionsPolicyResult_policy::~OAIDeleteRepositoryPermissionsPolicyResult_policy() {}

void OAIDeleteRepositoryPermissionsPolicyResult_policy::initializeModel() {
...
void OAIDeleteRepositoryPermissionsPolicyResult_policy::fromJson(QString jsonString) {
...
void OAIDeleteRepositoryPermissionsPolicyResult_policy::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRepositoryPermissionsPolicyResult_policy::asJson() const {
...
QJsonObject OAIDeleteRepositoryPermissionsPolicyResult_policy::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRepositoryPermissionsPolicyResult_policy::getResourceArn() const {
    return m_resource_arn;
}
void OAIDeleteRepositoryPermissionsPolicyResult_policy::setResourceArn(const QString &resource_arn) {
    m_resource_arn = resource_arn;
    m_resource_arn_isSet = true;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_resource_arn_Set() const{
    return m_resource_arn_isSet;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_resource_arn_Valid() const{
    return m_resource_arn_isValid;
}

QString OAIDeleteRepositoryPermissionsPolicyResult_policy::getRevision() const {
    return m_revision;
}
void OAIDeleteRepositoryPermissionsPolicyResult_policy::setRevision(const QString &revision) {
    m_revision = revision;
    m_revision_isSet = true;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_revision_Set() const{
    return m_revision_isSet;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_revision_Valid() const{
    return m_revision_isValid;
}

QString OAIDeleteRepositoryPermissionsPolicyResult_policy::getDocument() const {
    return m_document;
}
void OAIDeleteRepositoryPermissionsPolicyResult_policy::setDocument(const QString &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_document_Set() const{
    return m_document_isSet;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::is_document_Valid() const{
    return m_document_isValid;
}

bool OAIDeleteRepositoryPermissionsPolicyResult_policy::isSet() const {
...
bool OAIDeleteRepositoryPermissionsPolicyResult_policy::isValid() const {
