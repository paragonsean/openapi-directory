...
/*
 * OAIUpdateRepositoryResult_repository.h
 *
 * 
 */

#ifndef OAIUpdateRepositoryResult_repository_H
#define OAIUpdateRepositoryResult_repository_H
...
class OAIUpdateRepositoryResult_repository : public OAIObject {
public:
    OAIUpdateRepositoryResult_repository();
    OAIUpdateRepositoryResult_repository(QString json);
    ~OAIUpdateRepositoryResult_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRepositoryResult_repository)

#endif // OAIUpdateRepositoryResult_repository_H
