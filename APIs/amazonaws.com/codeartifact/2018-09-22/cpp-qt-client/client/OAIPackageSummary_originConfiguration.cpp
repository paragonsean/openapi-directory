...
#include "OAIPackageSummary_originConfiguration.h"
...
OAIPackageSummary_originConfiguration::OAIPackageSummary_originConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPackageSummary_originConfiguration::OAIPackageSummary_originConfiguration() {
    this->initializeModel();
}

OAIPackageSummary_originConfiguration::~OAIPackageSummary_originConfiguration() {}

void OAIPackageSummary_originConfiguration::initializeModel() {

    m_restrictions_isSet = false;
    m_restrictions_isValid = false;
}

void OAIPackageSummary_originConfiguration::fromJson(QString jsonString) {
...
void OAIPackageSummary_originConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPackageSummary_originConfiguration::asJson() const {
...
QJsonObject OAIPackageSummary_originConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIPackageOriginConfiguration_restrictions OAIPackageSummary_originConfiguration::getRestrictions() const {
    return m_restrictions;
}
void OAIPackageSummary_originConfiguration::setRestrictions(const OAIPackageOriginConfiguration_restrictions &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIPackageSummary_originConfiguration::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIPackageSummary_originConfiguration::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

bool OAIPackageSummary_originConfiguration::isSet() const {
...
bool OAIPackageSummary_originConfiguration::isValid() const {
