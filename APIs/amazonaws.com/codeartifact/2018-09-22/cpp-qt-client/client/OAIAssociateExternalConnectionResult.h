...
/*
 * OAIAssociateExternalConnectionResult.h
 *
 * 
 */

#ifndef OAIAssociateExternalConnectionResult_H
#define OAIAssociateExternalConnectionResult_H
...
namespace OpenAPI {
class OAIAssociateExternalConnectionResult_repository;

class OAIAssociateExternalConnectionResult : public OAIObject {
public:
    OAIAssociateExternalConnectionResult();
    OAIAssociateExternalConnectionResult(QString json);
    ~OAIAssociateExternalConnectionResult() override;
    ...
    OAIAssociateExternalConnectionResult_repository getRepository() const;
    void setRepository(const OAIAssociateExternalConnectionResult_repository &repository);
...
private:
    ...
    OAIAssociateExternalConnectionResult_repository m_repository;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateExternalConnectionResult)

#endif // OAIAssociateExternalConnectionResult_H
