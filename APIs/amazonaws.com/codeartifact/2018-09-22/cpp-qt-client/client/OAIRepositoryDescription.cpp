...
#include "OAIRepositoryDescription.h"
...
OAIRepositoryDescription::OAIRepositoryDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryDescription::OAIRepositoryDescription() {
    this->initializeModel();
}

OAIRepositoryDescription::~OAIRepositoryDescription() {}

void OAIRepositoryDescription::initializeModel() {
...
void OAIRepositoryDescription::fromJson(QString jsonString) {
...
void OAIRepositoryDescription::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryDescription::asJson() const {
...
QJsonObject OAIRepositoryDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIRepositoryDescription::getName() const {
    return m_name;
}
void OAIRepositoryDescription::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRepositoryDescription::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRepositoryDescription::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIRepositoryDescription::getAdministratorAccount() const {
    return m_administrator_account;
}
void OAIRepositoryDescription::setAdministratorAccount(const QString &administrator_account) {
    m_administrator_account = administrator_account;
    m_administrator_account_isSet = true;
}

bool OAIRepositoryDescription::is_administrator_account_Set() const{
    return m_administrator_account_isSet;
}

bool OAIRepositoryDescription::is_administrator_account_Valid() const{
    return m_administrator_account_isValid;
}

QString OAIRepositoryDescription::getDomainName() const {
    return m_domain_name;
}
void OAIRepositoryDescription::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIRepositoryDescription::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIRepositoryDescription::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QString OAIRepositoryDescription::getDomainOwner() const {
    return m_domain_owner;
}
void OAIRepositoryDescription::setDomainOwner(const QString &domain_owner) {
    m_domain_owner = domain_owner;
    m_domain_owner_isSet = true;
}

bool OAIRepositoryDescription::is_domain_owner_Set() const{
    return m_domain_owner_isSet;
}

bool OAIRepositoryDescription::is_domain_owner_Valid() const{
    return m_domain_owner_isValid;
}

QString OAIRepositoryDescription::getArn() const {
    return m_arn;
}
void OAIRepositoryDescription::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIRepositoryDescription::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIRepositoryDescription::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIRepositoryDescription::getDescription() const {
    return m_description;
}
void OAIRepositoryDescription::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRepositoryDescription::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRepositoryDescription::is_description_Valid() const{
    return m_description_isValid;
}

QList OAIRepositoryDescription::getUpstreams() const {
    return m_upstreams;
}
void OAIRepositoryDescription::setUpstreams(const QList &upstreams) {
    m_upstreams = upstreams;
    m_upstreams_isSet = true;
}

bool OAIRepositoryDescription::is_upstreams_Set() const{
    return m_upstreams_isSet;
}

bool OAIRepositoryDescription::is_upstreams_Valid() const{
    return m_upstreams_isValid;
}

QList OAIRepositoryDescription::getExternalConnections() const {
    return m_external_connections;
}
void OAIRepositoryDescription::setExternalConnections(const QList &external_connections) {
    m_external_connections = external_connections;
    m_external_connections_isSet = true;
}

bool OAIRepositoryDescription::is_external_connections_Set() const{
    return m_external_connections_isSet;
}

bool OAIRepositoryDescription::is_external_connections_Valid() const{
    return m_external_connections_isValid;
}

QDateTime OAIRepositoryDescription::getCreatedTime() const {
    return m_created_time;
}
void OAIRepositoryDescription::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIRepositoryDescription::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIRepositoryDescription::is_created_time_Valid() const{
    return m_created_time_isValid;
}

bool OAIRepositoryDescription::isSet() const {
...
bool OAIRepositoryDescription::isValid() const {
