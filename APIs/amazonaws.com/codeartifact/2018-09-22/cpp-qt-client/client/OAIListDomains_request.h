...
/*
 * OAIListDomains_request.h
 *
 * 
 */

#ifndef OAIListDomains_request_H
#define OAIListDomains_request_H
...
class OAIListDomains_request : public OAIObject {
public:
    OAIListDomains_request();
    OAIListDomains_request(QString json);
    ~OAIListDomains_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDomains_request)

#endif // OAIListDomains_request_H
