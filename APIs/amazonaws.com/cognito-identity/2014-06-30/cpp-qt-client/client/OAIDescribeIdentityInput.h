...
/*
 * OAIDescribeIdentityInput.h
 *
 * Input to the &lt;code&gt;DescribeIdentity&lt;/code&gt; action.
 */

#ifndef OAIDescribeIdentityInput_H
#define OAIDescribeIdentityInput_H
...
class OAIDescribeIdentityInput : public OAIObject {
public:
    OAIDescribeIdentityInput();
    OAIDescribeIdentityInput(QString json);
    ~OAIDescribeIdentityInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeIdentityInput)

#endif // OAIDescribeIdentityInput_H
