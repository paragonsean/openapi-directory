...
/*
 * OAIGetCredentialsForIdentityResponse_Credentials.h
 *
 * 
 */

#ifndef OAIGetCredentialsForIdentityResponse_Credentials_H
#define OAIGetCredentialsForIdentityResponse_Credentials_H
...
class OAIGetCredentialsForIdentityResponse_Credentials : public OAIObject {
public:
    OAIGetCredentialsForIdentityResponse_Credentials();
    OAIGetCredentialsForIdentityResponse_Credentials(QString json);
    ~OAIGetCredentialsForIdentityResponse_Credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCredentialsForIdentityResponse_Credentials)

#endif // OAIGetCredentialsForIdentityResponse_Credentials_H
