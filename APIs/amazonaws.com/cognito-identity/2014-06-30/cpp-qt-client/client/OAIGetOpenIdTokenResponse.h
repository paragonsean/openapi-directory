...
/*
 * OAIGetOpenIdTokenResponse.h
 *
 * Returned in response to a successful GetOpenIdToken request.
 */

#ifndef OAIGetOpenIdTokenResponse_H
#define OAIGetOpenIdTokenResponse_H
...
class OAIGetOpenIdTokenResponse : public OAIObject {
public:
    OAIGetOpenIdTokenResponse();
    OAIGetOpenIdTokenResponse(QString json);
    ~OAIGetOpenIdTokenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOpenIdTokenResponse)

#endif // OAIGetOpenIdTokenResponse_H
