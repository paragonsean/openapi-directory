...
/*
 * OAIUnprocessedIdentityId.h
 *
 * An array of UnprocessedIdentityId objects, each of which contains an ErrorCode and IdentityId.
 */

#ifndef OAIUnprocessedIdentityId_H
#define OAIUnprocessedIdentityId_H
...
class OAIUnprocessedIdentityId : public OAIObject {
public:
    OAIUnprocessedIdentityId();
    OAIUnprocessedIdentityId(QString json);
    ~OAIUnprocessedIdentityId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnprocessedIdentityId)

#endif // OAIUnprocessedIdentityId_H
