...
#ifndef OAIGetIdResponse_H
#define OAIGetIdResponse_H
...
class OAIGetIdResponse : public OAIObject {
public:
    OAIGetIdResponse();
    OAIGetIdResponse(QString json);
    ~OAIGetIdResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdResponse)

#endif // OAIGetIdResponse_H
