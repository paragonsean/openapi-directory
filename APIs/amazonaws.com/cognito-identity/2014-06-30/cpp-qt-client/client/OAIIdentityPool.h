...
#ifndef OAIIdentityPool_H
#define OAIIdentityPool_H
...
class OAIIdentityPool : public OAIObject {
public:
    OAIIdentityPool();
    OAIIdentityPool(QString json);
    ~OAIIdentityPool() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityPool)

#endif // OAIIdentityPool_H
