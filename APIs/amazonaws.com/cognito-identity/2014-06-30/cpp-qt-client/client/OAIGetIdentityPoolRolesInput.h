...
/*
 * OAIGetIdentityPoolRolesInput.h
 *
 * Input to the &lt;code&gt;GetIdentityPoolRoles&lt;/code&gt; action.
 */

#ifndef OAIGetIdentityPoolRolesInput_H
#define OAIGetIdentityPoolRolesInput_H
...
class OAIGetIdentityPoolRolesInput : public OAIObject {
public:
    OAIGetIdentityPoolRolesInput();
    OAIGetIdentityPoolRolesInput(QString json);
    ~OAIGetIdentityPoolRolesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentityPoolRolesInput)

#endif // OAIGetIdentityPoolRolesInput_H
