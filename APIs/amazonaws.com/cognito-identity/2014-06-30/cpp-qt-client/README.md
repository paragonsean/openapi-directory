...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateIdentityPoolInput create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateIdentityPoolInput Example::create(){
    OAICreateIdentityPoolInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createIdentityPoolSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createIdentityPoolSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateIdentityPoolInput oai_create_identity_pool_input = create(); // OAICreateIdentityPoolInput | 
      ...
      apiInstance.createIdentityPool(x_amz_targetoai_create_identity_pool_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
