...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.LookupDeveloperIdentityInput();
  });
  ...
  describe('LookupDeveloperIdentityInput', function() {
    it('should create an instance of LookupDeveloperIdentityInput', function() {
      // uncomment below and update the code to test LookupDeveloperIdentityInput
      //var instance = new AmazonCognitoIdentity.LookupDeveloperIdentityInput();
      //expect(instance).to.be.a(AmazonCognitoIdentity.LookupDeveloperIdentityInput);
    });
    ...
    it('should have the property developerUserIdentifier (base name: "DeveloperUserIdentifier")', function() {
      // uncomment below and update the code to test the property developerUserIdentifier
      //var instance = new AmazonCognitoIdentity.LookupDeveloperIdentityInput();
      //expect(instance).to.be();
    });
