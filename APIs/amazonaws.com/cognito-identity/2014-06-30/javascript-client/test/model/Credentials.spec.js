...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.Credentials();
  });
  ...
  describe('Credentials', function() {
    it('should create an instance of Credentials', function() {
      ...
      //var instance = new AmazonCognitoIdentity.Credentials();
      //expect(instance).to.be.a(AmazonCognitoIdentity.Credentials);
    });
