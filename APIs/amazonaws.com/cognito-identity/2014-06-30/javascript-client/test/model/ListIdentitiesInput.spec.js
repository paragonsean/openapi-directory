...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.ListIdentitiesInput();
  });
  ...
  describe('ListIdentitiesInput', function() {
    it('should create an instance of ListIdentitiesInput', function() {
      // uncomment below and update the code to test ListIdentitiesInput
      //var instance = new AmazonCognitoIdentity.ListIdentitiesInput();
      //expect(instance).to.be.a(AmazonCognitoIdentity.ListIdentitiesInput);
    });
    ...
    it('should have the property hideDisabled (base name: "HideDisabled")', function() {
      // uncomment below and update the code to test the property hideDisabled
      //var instance = new AmazonCognitoIdentity.ListIdentitiesInput();
      //expect(instance).to.be();
    });
