...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.ListIdentityPoolsInput();
  });
  ...
  describe('ListIdentityPoolsInput', function() {
    it('should create an instance of ListIdentityPoolsInput', function() {
      // uncomment below and update the code to test ListIdentityPoolsInput
      //var instance = new AmazonCognitoIdentity.ListIdentityPoolsInput();
      //expect(instance).to.be.a(AmazonCognitoIdentity.ListIdentityPoolsInput);
    });
