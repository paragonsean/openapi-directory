...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.SetIdentityPoolRolesInput();
  });
  ...
  describe('SetIdentityPoolRolesInput', function() {
    it('should create an instance of SetIdentityPoolRolesInput', function() {
      // uncomment below and update the code to test SetIdentityPoolRolesInput
      //var instance = new AmazonCognitoIdentity.SetIdentityPoolRolesInput();
      //expect(instance).to.be.a(AmazonCognitoIdentity.SetIdentityPoolRolesInput);
    });
