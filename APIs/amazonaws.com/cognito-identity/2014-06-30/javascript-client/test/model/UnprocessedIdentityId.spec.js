...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.UnprocessedIdentityId();
  });
  ...
  describe('UnprocessedIdentityId', function() {
    it('should create an instance of UnprocessedIdentityId', function() {
      // uncomment below and update the code to test UnprocessedIdentityId
      //var instance = new AmazonCognitoIdentity.UnprocessedIdentityId();
      //expect(instance).to.be.a(AmazonCognitoIdentity.UnprocessedIdentityId);
    });
