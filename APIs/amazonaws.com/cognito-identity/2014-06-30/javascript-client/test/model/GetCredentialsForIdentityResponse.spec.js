...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.GetCredentialsForIdentityResponse();
  });
  ...
  describe('GetCredentialsForIdentityResponse', function() {
    it('should create an instance of GetCredentialsForIdentityResponse', function() {
      // uncomment below and update the code to test GetCredentialsForIdentityResponse
      //var instance = new AmazonCognitoIdentity.GetCredentialsForIdentityResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentity.GetCredentialsForIdentityResponse);
    });
