...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.IdentityDescription();
  });
  ...
  describe('IdentityDescription', function() {
    it('should create an instance of IdentityDescription', function() {
      // uncomment below and update the code to test IdentityDescription
      //var instance = new AmazonCognitoIdentity.IdentityDescription();
      //expect(instance).to.be.a(AmazonCognitoIdentity.IdentityDescription);
    });
