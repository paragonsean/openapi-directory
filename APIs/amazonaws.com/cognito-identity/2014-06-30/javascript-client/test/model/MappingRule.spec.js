...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.MappingRule();
  });
  ...
  describe('MappingRule', function() {
    it('should create an instance of MappingRule', function() {
      ...
      //var instance = new AmazonCognitoIdentity.MappingRule();
      //expect(instance).to.be.a(AmazonCognitoIdentity.MappingRule);
    });
