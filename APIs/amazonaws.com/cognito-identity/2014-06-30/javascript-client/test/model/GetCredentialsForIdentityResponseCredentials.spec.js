...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.GetCredentialsForIdentityResponseCredentials();
  });
  ...
  describe('GetCredentialsForIdentityResponseCredentials', function() {
    it('should create an instance of GetCredentialsForIdentityResponseCredentials', function() {
      // uncomment below and update the code to test GetCredentialsForIdentityResponseCredentials
      //var instance = new AmazonCognitoIdentity.GetCredentialsForIdentityResponseCredentials();
      //expect(instance).to.be.a(AmazonCognitoIdentity.GetCredentialsForIdentityResponseCredentials);
    });
