...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.GetIdentityPoolRolesResponse();
  });
  ...
  describe('GetIdentityPoolRolesResponse', function() {
    it('should create an instance of GetIdentityPoolRolesResponse', function() {
      // uncomment below and update the code to test GetIdentityPoolRolesResponse
      //var instance = new AmazonCognitoIdentity.GetIdentityPoolRolesResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentity.GetIdentityPoolRolesResponse);
    });
