...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.GetIdResponse();
  });
  ...
  describe('GetIdResponse', function() {
    it('should create an instance of GetIdResponse', function() {
      // uncomment below and update the code to test GetIdResponse
      //var instance = new AmazonCognitoIdentity.GetIdResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentity.GetIdResponse);
    });
