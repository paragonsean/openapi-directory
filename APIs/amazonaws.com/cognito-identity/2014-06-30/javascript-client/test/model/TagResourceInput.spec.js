...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentity.TagResourceInput();
  });
  ...
  describe('TagResourceInput', function() {
    it('should create an instance of TagResourceInput', function() {
      ...
      //var instance = new AmazonCognitoIdentity.TagResourceInput();
      //expect(instance).to.be.a(AmazonCognitoIdentity.TagResourceInput);
    });
