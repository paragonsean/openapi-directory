...
/**
 * The CreateIdentityPoolInput model module.
 * @module model/CreateIdentityPoolInput
 * @version 2014-06-30
 */
class CreateIdentityPoolInput {
    /**
     * Constructs a new <code>CreateIdentityPoolInput</code>.
     * Input to the CreateIdentityPool action.
     * @alias module:model/CreateIdentityPoolInput
     * @param identityPoolName {String} 
     * @param allowUnauthenticatedIdentities {Boolean} 
     */
    constructor(identityPoolName, allowUnauthenticatedIdentities) { 
        
        CreateIdentityPoolInput.initialize(this, identityPoolName, allowUnauthenticatedIdentities);
    }
     ...
     */
    static initialize(obj, identityPoolName, allowUnauthenticatedIdentities) { 
        obj['IdentityPoolName'] = identityPoolName;
        obj['AllowUnauthenticatedIdentities'] = allowUnauthenticatedIdentities;
    }

    /**
     * Constructs a <code>CreateIdentityPoolInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentityPoolInput} obj Optional instance to populate.
     * @return {module:model/CreateIdentityPoolInput} The populated <code>CreateIdentityPoolInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentityPoolInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentityPoolInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentityPoolInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateIdentityPoolInput.RequiredProperties) {
...
CreateIdentityPoolInput.RequiredProperties = ["IdentityPoolName", "AllowUnauthenticatedIdentities"];

/**
 * @member {String} IdentityPoolName
 */
CreateIdentityPoolInput.prototype['IdentityPoolName'] = undefined;

/**
 * @member {Boolean} AllowUnauthenticatedIdentities
 */
CreateIdentityPoolInput.prototype['AllowUnauthenticatedIdentities'] = undefined;

/**
 * @member {Boolean} AllowClassicFlow
 */
CreateIdentityPoolInput.prototype['AllowClassicFlow'] = undefined;

/**
 * @member {Object} SupportedLoginProviders
 */
CreateIdentityPoolInput.prototype['SupportedLoginProviders'] = undefined;

/**
 * @member {String} DeveloperProviderName
 */
CreateIdentityPoolInput.prototype['DeveloperProviderName'] = undefined;

/**
 * @member {Array} OpenIdConnectProviderARNs
 */
CreateIdentityPoolInput.prototype['OpenIdConnectProviderARNs'] = undefined;

/**
 * @member {Array} CognitoIdentityProviders
 */
CreateIdentityPoolInput.prototype['CognitoIdentityProviders'] = undefined;

/**
 * @member {Array} SamlProviderARNs
 */
CreateIdentityPoolInput.prototype['SamlProviderARNs'] = undefined;

/**
 * @member {Object} IdentityPoolTags
 */
CreateIdentityPoolInput.prototype['IdentityPoolTags'] = undefined;
...
export default CreateIdentityPoolInput;
