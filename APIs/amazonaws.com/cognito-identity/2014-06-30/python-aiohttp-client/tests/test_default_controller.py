...
async def test_create_identity_pool(client):
    """Test case for create_identity_pool

    
    """
    body = {"CognitoIdentityProviders":"","DeveloperProviderName":"","IdentityPoolName":"","AllowUnauthenticatedIdentities":"","SupportedLoginProviders":"","AllowClassicFlow":"","OpenIdConnectProviderARNs":"","SamlProviderARNs":"","IdentityPoolTags":""}
    headers = { 
...
async def test_delete_identities(client):
...
async def test_delete_identity_pool(client):
    """Test case for delete_identity_pool
...
async def test_describe_identity(client):
    """Test case for describe_identity
...
async def test_describe_identity_pool(client):
    """Test case for describe_identity_pool
...
async def test_get_credentials_for_identity(client):
    """Test case for get_credentials_for_identity

    
    """
    body = {"CustomRoleArn":"","Logins":"","IdentityId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_id(client):
    ...
    """
    body = {"AccountId":"","Logins":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSCognitoIdentityService.GetId',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_identity_pool_roles(client):
    """Test case for get_identity_pool_roles
...
async def test_get_open_id_token(client):
    """Test case for get_open_id_token

    
    """
    body = {"Logins":"","IdentityId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_open_id_token_for_developer_identity(client):
    """Test case for get_open_id_token_for_developer_identity

    
    """
    body = {"PrincipalTags":"","Logins":"","TokenDuration":"","IdentityId":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_get_principal_tag_attribute_map(client):
    """Test case for get_principal_tag_attribute_map

    
    """
    body = {"IdentityProviderName":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_identities(client):
    ...
    """
    body = {"NextToken":"","MaxResults":"","IdentityPoolId":"","HideDisabled":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSCognitoIdentityService.ListIdentities',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_identity_pools(client):
    """Test case for list_identity_pools
...
async def test_lookup_developer_identity(client):
    """Test case for lookup_developer_identity

    
    """
    body = {"NextToken":"","MaxResults":"","IdentityId":"","DeveloperUserIdentifier":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_merge_developer_identities(client):
    """Test case for merge_developer_identities

    
    """
    body = {"SourceUserIdentifier":"","DeveloperProviderName":"","IdentityPoolId":"","DestinationUserIdentifier":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_set_identity_pool_roles(client):
    """Test case for set_identity_pool_roles

    
    """
    body = {"RoleMappings":"","IdentityPoolId":"","Roles":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_set_principal_tag_attribute_map(client):
    """Test case for set_principal_tag_attribute_map

    
    """
    body = {"PrincipalTags":"","UseDefaults":"","IdentityProviderName":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_unlink_developer_identity(client):
    """Test case for unlink_developer_identity

    
    """
    body = {"DeveloperProviderName":"","IdentityId":"","DeveloperUserIdentifier":"","IdentityPoolId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_unlink_identity(client):
    """Test case for unlink_identity

    
    """
    body = {"Logins":"","IdentityId":"","LoginsToRemove":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_identity_pool(client):
    """Test case for update_identity_pool

    
    """
    body = {"CognitoIdentityProviders":"","DeveloperProviderName":"","IdentityPoolId":"","IdentityPoolName":"","AllowUnauthenticatedIdentities":"","SupportedLoginProviders":"","AllowClassicFlow":"","OpenIdConnectProviderARNs":"","SamlProviderARNs":"","IdentityPoolTags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
