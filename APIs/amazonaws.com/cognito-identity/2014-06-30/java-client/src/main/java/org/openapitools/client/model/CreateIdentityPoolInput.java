...
public class CreateIdentityPoolInput {
  ...
  public CreateIdentityPoolInput() {
  }

  public CreateIdentityPoolInput identityPoolName(String identityPoolName) {
  ...
  public CreateIdentityPoolInput allowUnauthenticatedIdentities(Boolean allowUnauthenticatedIdentities) {
  ...
  public CreateIdentityPoolInput allowClassicFlow(Boolean allowClassicFlow) {
  ...
  public CreateIdentityPoolInput supportedLoginProviders(Map supportedLoginProviders) {
  ...
  public CreateIdentityPoolInput developerProviderName(String developerProviderName) {
  ...
  public CreateIdentityPoolInput openIdConnectProviderARNs(List openIdConnectProviderARNs) {
  ...
  public CreateIdentityPoolInput cognitoIdentityProviders(List cognitoIdentityProviders) {
  ...
  public CreateIdentityPoolInput samlProviderARNs(List samlProviderARNs) {
  ...
  public CreateIdentityPoolInput identityPoolTags(Map identityPoolTags) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIdentityPoolInput createIdentityPoolInput = (CreateIdentityPoolInput) o;
    return Objects.equals(this.identityPoolName, createIdentityPoolInput.identityPoolName) &&
        Objects.equals(this.allowUnauthenticatedIdentities, createIdentityPoolInput.allowUnauthenticatedIdentities) &&
        Objects.equals(this.allowClassicFlow, createIdentityPoolInput.allowClassicFlow) &&
        Objects.equals(this.supportedLoginProviders, createIdentityPoolInput.supportedLoginProviders) &&
        Objects.equals(this.developerProviderName, createIdentityPoolInput.developerProviderName) &&
        Objects.equals(this.openIdConnectProviderARNs, createIdentityPoolInput.openIdConnectProviderARNs) &&
        Objects.equals(this.cognitoIdentityProviders, createIdentityPoolInput.cognitoIdentityProviders) &&
        Objects.equals(this.samlProviderARNs, createIdentityPoolInput.samlProviderARNs) &&
        Objects.equals(this.identityPoolTags, createIdentityPoolInput.identityPoolTags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identityPoolName, allowUnauthenticatedIdentities, allowClassicFlow, supportedLoginProviders, developerProviderName, openIdConnectProviderARNs, cognitoIdentityProviders, samlProviderARNs, identityPoolTags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateIdentityPoolInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIdentityPoolInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIdentityPoolInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIdentityPoolInput is not found in the empty JSON string", CreateIdentityPoolInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIdentityPoolInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIdentityPoolInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIdentityPoolInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIdentityPoolInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIdentityPoolInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIdentityPoolInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIdentityPoolInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIdentityPoolInput>() {
           @Override
           public void write(JsonWriter out, CreateIdentityPoolInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIdentityPoolInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIdentityPoolInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIdentityPoolInput
   * @throws IOException if the JSON string is invalid with respect to CreateIdentityPoolInput
   */
  public static CreateIdentityPoolInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIdentityPoolInput.class);
  }

  /**
   * Convert an instance of CreateIdentityPoolInput to an JSON string
   *
   * @return JSON string
   */
