...
public class GetImageFrameResponse {
  public static final String SERIALIZED_NAME_IMAGE_FRAME_BLOB = "imageFrameBlob";
  @SerializedName(SERIALIZED_NAME_IMAGE_FRAME_BLOB)
  private String imageFrameBlob;

  public GetImageFrameResponse() {
  }

  public GetImageFrameResponse imageFrameBlob(String imageFrameBlob) {
  ...
  /**
   * Get imageFrameBlob
   * @return imageFrameBlob
   */
  @javax.annotation.Nonnull
  public String getImageFrameBlob() {
    return imageFrameBlob;
  }

  public void setImageFrameBlob(String imageFrameBlob) {
    this.imageFrameBlob = imageFrameBlob;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetImageFrameResponse getImageFrameResponse = (GetImageFrameResponse) o;
    return Objects.equals(this.imageFrameBlob, getImageFrameResponse.imageFrameBlob);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageFrameBlob);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetImageFrameResponse {\n");
    sb.append("    imageFrameBlob: ").append(toIndentedString(imageFrameBlob)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("imageFrameBlob");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageFrameBlob");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImageFrameResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImageFrameResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImageFrameResponse is not found in the empty JSON string", GetImageFrameResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImageFrameResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImageFrameResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetImageFrameResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageFrameBlob`
      String.validateJsonElement(jsonObj.get("imageFrameBlob"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImageFrameResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImageFrameResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImageFrameResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImageFrameResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImageFrameResponse>() {
           @Override
           public void write(JsonWriter out, GetImageFrameResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImageFrameResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImageFrameResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImageFrameResponse
   * @throws IOException if the JSON string is invalid with respect to GetImageFrameResponse
   */
  public static GetImageFrameResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImageFrameResponse.class);
  }

  /**
   * Convert an instance of GetImageFrameResponse to an JSON string
   *
   * @return JSON string
   */
