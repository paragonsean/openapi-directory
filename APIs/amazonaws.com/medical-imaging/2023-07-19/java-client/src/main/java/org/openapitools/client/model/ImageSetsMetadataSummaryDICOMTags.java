...
public class ImageSetsMetadataSummaryDICOMTags {
  ...
  public ImageSetsMetadataSummaryDICOMTags() {
  }

  public ImageSetsMetadataSummaryDICOMTags diCOMPatientId(String diCOMPatientId) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMPatientName(String diCOMPatientName) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMPatientBirthDate(String diCOMPatientBirthDate) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMPatientSex(String diCOMPatientSex) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMStudyInstanceUID(String diCOMStudyInstanceUID) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMStudyId(String diCOMStudyId) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMStudyDescription(String diCOMStudyDescription) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMNumberOfStudyRelatedSeries(Integer diCOMNumberOfStudyRelatedSeries) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMNumberOfStudyRelatedInstances(Integer diCOMNumberOfStudyRelatedInstances) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMAccessionNumber(String diCOMAccessionNumber) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMStudyDate(String diCOMStudyDate) {
  ...
  public ImageSetsMetadataSummaryDICOMTags diCOMStudyTime(String diCOMStudyTime) {
  ...
  public boolean equals(Object o) {
    ...
    ImageSetsMetadataSummaryDICOMTags imageSetsMetadataSummaryDICOMTags = (ImageSetsMetadataSummaryDICOMTags) o;
    return Objects.equals(this.diCOMPatientId, imageSetsMetadataSummaryDICOMTags.diCOMPatientId) &&
        Objects.equals(this.diCOMPatientName, imageSetsMetadataSummaryDICOMTags.diCOMPatientName) &&
        Objects.equals(this.diCOMPatientBirthDate, imageSetsMetadataSummaryDICOMTags.diCOMPatientBirthDate) &&
        Objects.equals(this.diCOMPatientSex, imageSetsMetadataSummaryDICOMTags.diCOMPatientSex) &&
        Objects.equals(this.diCOMStudyInstanceUID, imageSetsMetadataSummaryDICOMTags.diCOMStudyInstanceUID) &&
        Objects.equals(this.diCOMStudyId, imageSetsMetadataSummaryDICOMTags.diCOMStudyId) &&
        Objects.equals(this.diCOMStudyDescription, imageSetsMetadataSummaryDICOMTags.diCOMStudyDescription) &&
        Objects.equals(this.diCOMNumberOfStudyRelatedSeries, imageSetsMetadataSummaryDICOMTags.diCOMNumberOfStudyRelatedSeries) &&
        Objects.equals(this.diCOMNumberOfStudyRelatedInstances, imageSetsMetadataSummaryDICOMTags.diCOMNumberOfStudyRelatedInstances) &&
        Objects.equals(this.diCOMAccessionNumber, imageSetsMetadataSummaryDICOMTags.diCOMAccessionNumber) &&
        Objects.equals(this.diCOMStudyDate, imageSetsMetadataSummaryDICOMTags.diCOMStudyDate) &&
        Objects.equals(this.diCOMStudyTime, imageSetsMetadataSummaryDICOMTags.diCOMStudyTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageSetsMetadataSummaryDICOMTags {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageSetsMetadataSummaryDICOMTags
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageSetsMetadataSummaryDICOMTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageSetsMetadataSummaryDICOMTags is not found in the empty JSON string", ImageSetsMetadataSummaryDICOMTags.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageSetsMetadataSummaryDICOMTags.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageSetsMetadataSummaryDICOMTags` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageSetsMetadataSummaryDICOMTags.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageSetsMetadataSummaryDICOMTags' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageSetsMetadataSummaryDICOMTags> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageSetsMetadataSummaryDICOMTags.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageSetsMetadataSummaryDICOMTags>() {
           @Override
           public void write(JsonWriter out, ImageSetsMetadataSummaryDICOMTags value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageSetsMetadataSummaryDICOMTags read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageSetsMetadataSummaryDICOMTags given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageSetsMetadataSummaryDICOMTags
   * @throws IOException if the JSON string is invalid with respect to ImageSetsMetadataSummaryDICOMTags
   */
  public static ImageSetsMetadataSummaryDICOMTags fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageSetsMetadataSummaryDICOMTags.class);
  }

  /**
   * Convert an instance of ImageSetsMetadataSummaryDICOMTags to an JSON string
   *
   * @return JSON string
   */
