...
import org.openapitools.client.model.GetDICOMImportJobResponseJobProperties;
...
public class GetDICOMImportJobResponse {
  ...
  private GetDICOMImportJobResponseJobProperties jobProperties;

  public GetDICOMImportJobResponse() {
  }

  public GetDICOMImportJobResponse jobProperties(GetDICOMImportJobResponseJobProperties jobProperties) {
  ...
  public GetDICOMImportJobResponseJobProperties getJobProperties() {
    return jobProperties;
  }

  public void setJobProperties(GetDICOMImportJobResponseJobProperties jobProperties) {
    this.jobProperties = jobProperties;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDICOMImportJobResponse getDICOMImportJobResponse = (GetDICOMImportJobResponse) o;
    return Objects.equals(this.jobProperties, getDICOMImportJobResponse.jobProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDICOMImportJobResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("jobProperties");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDICOMImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDICOMImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDICOMImportJobResponse is not found in the empty JSON string", GetDICOMImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDICOMImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDICOMImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDICOMImportJobResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `jobProperties`
      GetDICOMImportJobResponseJobProperties.validateJsonElement(jsonObj.get("jobProperties"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDICOMImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDICOMImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDICOMImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDICOMImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDICOMImportJobResponse>() {
           @Override
           public void write(JsonWriter out, GetDICOMImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDICOMImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDICOMImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDICOMImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to GetDICOMImportJobResponse
   */
  public static GetDICOMImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDICOMImportJobResponse.class);
  }

  /**
   * Convert an instance of GetDICOMImportJobResponse to an JSON string
   *
   * @return JSON string
   */
