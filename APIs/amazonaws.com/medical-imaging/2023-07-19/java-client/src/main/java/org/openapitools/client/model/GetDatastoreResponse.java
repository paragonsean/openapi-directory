...
import org.openapitools.client.model.GetDatastoreResponseDatastoreProperties;
...
public class GetDatastoreResponse {
  public static final String SERIALIZED_NAME_DATASTORE_PROPERTIES = "datastoreProperties";
  @SerializedName(SERIALIZED_NAME_DATASTORE_PROPERTIES)
  private GetDatastoreResponseDatastoreProperties datastoreProperties;

  public GetDatastoreResponse() {
  }

  public GetDatastoreResponse datastoreProperties(GetDatastoreResponseDatastoreProperties datastoreProperties) {
    this.datastoreProperties = datastoreProperties;
    return this;
  }

  /**
   * Get datastoreProperties
   * @return datastoreProperties
   */
  @javax.annotation.Nonnull
  public GetDatastoreResponseDatastoreProperties getDatastoreProperties() {
    return datastoreProperties;
  }

  public void setDatastoreProperties(GetDatastoreResponseDatastoreProperties datastoreProperties) {
    this.datastoreProperties = datastoreProperties;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDatastoreResponse getDatastoreResponse = (GetDatastoreResponse) o;
    return Objects.equals(this.datastoreProperties, getDatastoreResponse.datastoreProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDatastoreResponse {\n");
    sb.append("    datastoreProperties: ").append(toIndentedString(datastoreProperties)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("datastoreProperties");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("datastoreProperties");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDatastoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDatastoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDatastoreResponse is not found in the empty JSON string", GetDatastoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDatastoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDatastoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetDatastoreResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `datastoreProperties`
      GetDatastoreResponseDatastoreProperties.validateJsonElement(jsonObj.get("datastoreProperties"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDatastoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDatastoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDatastoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDatastoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDatastoreResponse>() {
           @Override
           public void write(JsonWriter out, GetDatastoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDatastoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDatastoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDatastoreResponse
   * @throws IOException if the JSON string is invalid with respect to GetDatastoreResponse
   */
  public static GetDatastoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDatastoreResponse.class);
  }

  /**
   * Convert an instance of GetDatastoreResponse to an JSON string
   *
   * @return JSON string
   */
