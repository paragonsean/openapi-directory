...
public class GetImageSetMetadataResponse {
  public static final String SERIALIZED_NAME_IMAGE_SET_METADATA_BLOB = "imageSetMetadataBlob";
  @SerializedName(SERIALIZED_NAME_IMAGE_SET_METADATA_BLOB)
  private String imageSetMetadataBlob;

  public GetImageSetMetadataResponse() {
  }

  public GetImageSetMetadataResponse imageSetMetadataBlob(String imageSetMetadataBlob) {
    this.imageSetMetadataBlob = imageSetMetadataBlob;
    return this;
  }

  /**
   * Get imageSetMetadataBlob
   * @return imageSetMetadataBlob
   */
  @javax.annotation.Nonnull
  public String getImageSetMetadataBlob() {
    return imageSetMetadataBlob;
  }

  public void setImageSetMetadataBlob(String imageSetMetadataBlob) {
    this.imageSetMetadataBlob = imageSetMetadataBlob;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetImageSetMetadataResponse getImageSetMetadataResponse = (GetImageSetMetadataResponse) o;
    return Objects.equals(this.imageSetMetadataBlob, getImageSetMetadataResponse.imageSetMetadataBlob);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageSetMetadataBlob);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetImageSetMetadataResponse {\n");
    sb.append("    imageSetMetadataBlob: ").append(toIndentedString(imageSetMetadataBlob)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("imageSetMetadataBlob");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageSetMetadataBlob");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImageSetMetadataResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImageSetMetadataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImageSetMetadataResponse is not found in the empty JSON string", GetImageSetMetadataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImageSetMetadataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImageSetMetadataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetImageSetMetadataResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageSetMetadataBlob`
      String.validateJsonElement(jsonObj.get("imageSetMetadataBlob"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImageSetMetadataResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImageSetMetadataResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImageSetMetadataResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImageSetMetadataResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImageSetMetadataResponse>() {
           @Override
           public void write(JsonWriter out, GetImageSetMetadataResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImageSetMetadataResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImageSetMetadataResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImageSetMetadataResponse
   * @throws IOException if the JSON string is invalid with respect to GetImageSetMetadataResponse
   */
  public static GetImageSetMetadataResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImageSetMetadataResponse.class);
  }

  /**
   * Convert an instance of GetImageSetMetadataResponse to an JSON string
   *
   * @return JSON string
   */
