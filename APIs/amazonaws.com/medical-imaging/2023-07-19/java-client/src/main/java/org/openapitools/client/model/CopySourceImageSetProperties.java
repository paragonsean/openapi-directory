...
public class CopySourceImageSetProperties {
  ...
  public CopySourceImageSetProperties() {
  }

  public CopySourceImageSetProperties imageSetId(String imageSetId) {
  ...
  public CopySourceImageSetProperties latestVersionId(String latestVersionId) {
  ...
  public CopySourceImageSetProperties imageSetState(ImageSetState imageSetState) {
  ...
  public CopySourceImageSetProperties imageSetWorkflowStatus(ImageSetWorkflowStatus imageSetWorkflowStatus) {
  ...
  public CopySourceImageSetProperties createdAt(OffsetDateTime createdAt) {
  ...
  public CopySourceImageSetProperties updatedAt(OffsetDateTime updatedAt) {
  ...
  public CopySourceImageSetProperties imageSetArn(String imageSetArn) {
  ...
  public boolean equals(Object o) {
    ...
    CopySourceImageSetProperties copySourceImageSetProperties = (CopySourceImageSetProperties) o;
    return Objects.equals(this.imageSetId, copySourceImageSetProperties.imageSetId) &&
        Objects.equals(this.latestVersionId, copySourceImageSetProperties.latestVersionId) &&
        Objects.equals(this.imageSetState, copySourceImageSetProperties.imageSetState) &&
        Objects.equals(this.imageSetWorkflowStatus, copySourceImageSetProperties.imageSetWorkflowStatus) &&
        Objects.equals(this.createdAt, copySourceImageSetProperties.createdAt) &&
        Objects.equals(this.updatedAt, copySourceImageSetProperties.updatedAt) &&
        Objects.equals(this.imageSetArn, copySourceImageSetProperties.imageSetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopySourceImageSetProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopySourceImageSetProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopySourceImageSetProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopySourceImageSetProperties is not found in the empty JSON string", CopySourceImageSetProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopySourceImageSetProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopySourceImageSetProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopySourceImageSetProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopySourceImageSetProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopySourceImageSetProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopySourceImageSetProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopySourceImageSetProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<CopySourceImageSetProperties>() {
           @Override
           public void write(JsonWriter out, CopySourceImageSetProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopySourceImageSetProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopySourceImageSetProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopySourceImageSetProperties
   * @throws IOException if the JSON string is invalid with respect to CopySourceImageSetProperties
   */
  public static CopySourceImageSetProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopySourceImageSetProperties.class);
  }

  /**
   * Convert an instance of CopySourceImageSetProperties to an JSON string
   *
   * @return JSON string
   */
