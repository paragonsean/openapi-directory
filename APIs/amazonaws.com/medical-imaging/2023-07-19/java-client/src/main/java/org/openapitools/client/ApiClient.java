...
public class ApiClient {
    ...
    private String basePath = "http://medical-imaging.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://medical-imaging.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "http://medical-imaging.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://medical-imaging.{region}.amazonaws.com.cn",
      "The AWS Health Imaging endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    public ApiClient() {
        ...
        authentications.put("hmac", new ApiKeyAuth("header", "Authorization"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2023-07-19/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://medical-imaging.us-east-1.amazonaws.com
