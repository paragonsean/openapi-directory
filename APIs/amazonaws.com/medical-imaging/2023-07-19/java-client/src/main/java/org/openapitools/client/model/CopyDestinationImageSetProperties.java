...
public class CopyDestinationImageSetProperties {
  ...
  public CopyDestinationImageSetProperties() {
  }

  public CopyDestinationImageSetProperties imageSetId(String imageSetId) {
  ...
  public CopyDestinationImageSetProperties latestVersionId(String latestVersionId) {
  ...
  public CopyDestinationImageSetProperties imageSetState(ImageSetState imageSetState) {
  ...
  public CopyDestinationImageSetProperties imageSetWorkflowStatus(ImageSetWorkflowStatus imageSetWorkflowStatus) {
  ...
  public CopyDestinationImageSetProperties createdAt(OffsetDateTime createdAt) {
  ...
  public CopyDestinationImageSetProperties updatedAt(OffsetDateTime updatedAt) {
  ...
  public CopyDestinationImageSetProperties imageSetArn(String imageSetArn) {
  ...
  public boolean equals(Object o) {
    ...
    CopyDestinationImageSetProperties copyDestinationImageSetProperties = (CopyDestinationImageSetProperties) o;
    return Objects.equals(this.imageSetId, copyDestinationImageSetProperties.imageSetId) &&
        Objects.equals(this.latestVersionId, copyDestinationImageSetProperties.latestVersionId) &&
        Objects.equals(this.imageSetState, copyDestinationImageSetProperties.imageSetState) &&
        Objects.equals(this.imageSetWorkflowStatus, copyDestinationImageSetProperties.imageSetWorkflowStatus) &&
        Objects.equals(this.createdAt, copyDestinationImageSetProperties.createdAt) &&
        Objects.equals(this.updatedAt, copyDestinationImageSetProperties.updatedAt) &&
        Objects.equals(this.imageSetArn, copyDestinationImageSetProperties.imageSetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyDestinationImageSetProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyDestinationImageSetProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyDestinationImageSetProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyDestinationImageSetProperties is not found in the empty JSON string", CopyDestinationImageSetProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyDestinationImageSetProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyDestinationImageSetProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyDestinationImageSetProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyDestinationImageSetProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyDestinationImageSetProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyDestinationImageSetProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyDestinationImageSetProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyDestinationImageSetProperties>() {
           @Override
           public void write(JsonWriter out, CopyDestinationImageSetProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyDestinationImageSetProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyDestinationImageSetProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyDestinationImageSetProperties
   * @throws IOException if the JSON string is invalid with respect to CopyDestinationImageSetProperties
   */
  public static CopyDestinationImageSetProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyDestinationImageSetProperties.class);
  }

  /**
   * Convert an instance of CopyDestinationImageSetProperties to an JSON string
   *
   * @return JSON string
   */
