...
public class CopyImageSetRequestCopyImageSetInformationDestinationImageSet {
  ...
  public CopyImageSetRequestCopyImageSetInformationDestinationImageSet() {
  }

  public CopyImageSetRequestCopyImageSetInformationDestinationImageSet imageSetId(String imageSetId) {
  ...
  public CopyImageSetRequestCopyImageSetInformationDestinationImageSet latestVersionId(String latestVersionId) {
  ...
  public boolean equals(Object o) {
    ...
    CopyImageSetRequestCopyImageSetInformationDestinationImageSet copyImageSetRequestCopyImageSetInformationDestinationImageSet = (CopyImageSetRequestCopyImageSetInformationDestinationImageSet) o;
    return Objects.equals(this.imageSetId, copyImageSetRequestCopyImageSetInformationDestinationImageSet.imageSetId) &&
        Objects.equals(this.latestVersionId, copyImageSetRequestCopyImageSetInformationDestinationImageSet.latestVersionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageSetId, latestVersionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CopyImageSetRequestCopyImageSetInformationDestinationImageSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyImageSetRequestCopyImageSetInformationDestinationImageSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyImageSetRequestCopyImageSetInformationDestinationImageSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyImageSetRequestCopyImageSetInformationDestinationImageSet is not found in the empty JSON string", CopyImageSetRequestCopyImageSetInformationDestinationImageSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyImageSetRequestCopyImageSetInformationDestinationImageSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyImageSetRequestCopyImageSetInformationDestinationImageSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyImageSetRequestCopyImageSetInformationDestinationImageSet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyImageSetRequestCopyImageSetInformationDestinationImageSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyImageSetRequestCopyImageSetInformationDestinationImageSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyImageSetRequestCopyImageSetInformationDestinationImageSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyImageSetRequestCopyImageSetInformationDestinationImageSet.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyImageSetRequestCopyImageSetInformationDestinationImageSet>() {
           @Override
           public void write(JsonWriter out, CopyImageSetRequestCopyImageSetInformationDestinationImageSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyImageSetRequestCopyImageSetInformationDestinationImageSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyImageSetRequestCopyImageSetInformationDestinationImageSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyImageSetRequestCopyImageSetInformationDestinationImageSet
   * @throws IOException if the JSON string is invalid with respect to CopyImageSetRequestCopyImageSetInformationDestinationImageSet
   */
  public static CopyImageSetRequestCopyImageSetInformationDestinationImageSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyImageSetRequestCopyImageSetInformationDestinationImageSet.class);
  }

  /**
   * Convert an instance of CopyImageSetRequestCopyImageSetInformationDestinationImageSet to an JSON string
   *
   * @return JSON string
   */
