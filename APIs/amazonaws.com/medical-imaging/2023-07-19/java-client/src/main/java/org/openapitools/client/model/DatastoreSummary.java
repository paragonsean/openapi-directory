...
public class DatastoreSummary {
  ...
  public DatastoreSummary datastoreId(String datastoreId) {
  ...
  public DatastoreSummary datastoreName(String datastoreName) {
  ...
  public DatastoreSummary datastoreStatus(DatastoreStatus datastoreStatus) {
  ...
  public DatastoreSummary datastoreArn(String datastoreArn) {
  ...
  public DatastoreSummary createdAt(OffsetDateTime createdAt) {
  ...
  public DatastoreSummary updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    DatastoreSummary datastoreSummary = (DatastoreSummary) o;
    return Objects.equals(this.datastoreId, datastoreSummary.datastoreId) &&
        Objects.equals(this.datastoreName, datastoreSummary.datastoreName) &&
        Objects.equals(this.datastoreStatus, datastoreSummary.datastoreStatus) &&
        Objects.equals(this.datastoreArn, datastoreSummary.datastoreArn) &&
        Objects.equals(this.createdAt, datastoreSummary.createdAt) &&
        Objects.equals(this.updatedAt, datastoreSummary.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreId, datastoreName, datastoreStatus, datastoreArn, createdAt, updatedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatastoreSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatastoreSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatastoreSummary is not found in the empty JSON string", DatastoreSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatastoreSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatastoreSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatastoreSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatastoreSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatastoreSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatastoreSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatastoreSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<DatastoreSummary>() {
           @Override
           public void write(JsonWriter out, DatastoreSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatastoreSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatastoreSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatastoreSummary
   * @throws IOException if the JSON string is invalid with respect to DatastoreSummary
   */
  public static DatastoreSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatastoreSummary.class);
  }

  /**
   * Convert an instance of DatastoreSummary to an JSON string
   *
   * @return JSON string
   */
