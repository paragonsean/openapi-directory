...
public class SearchImageSetsRequestSearchCriteria {
  public static final String SERIALIZED_NAME_FILTERS = "filters";
  @SerializedName(SERIALIZED_NAME_FILTERS)
  private List filters;

  public SearchImageSetsRequestSearchCriteria() {
  }

  public SearchImageSetsRequestSearchCriteria filters(List filters) {
  ...
  public boolean equals(Object o) {
    ...
    SearchImageSetsRequestSearchCriteria searchImageSetsRequestSearchCriteria = (SearchImageSetsRequestSearchCriteria) o;
    return Objects.equals(this.filters, searchImageSetsRequestSearchCriteria.filters);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchImageSetsRequestSearchCriteria {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchImageSetsRequestSearchCriteria
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchImageSetsRequestSearchCriteria.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchImageSetsRequestSearchCriteria is not found in the empty JSON string", SearchImageSetsRequestSearchCriteria.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchImageSetsRequestSearchCriteria.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchImageSetsRequestSearchCriteria` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchImageSetsRequestSearchCriteria.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchImageSetsRequestSearchCriteria' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchImageSetsRequestSearchCriteria> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchImageSetsRequestSearchCriteria.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchImageSetsRequestSearchCriteria>() {
           @Override
           public void write(JsonWriter out, SearchImageSetsRequestSearchCriteria value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchImageSetsRequestSearchCriteria read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchImageSetsRequestSearchCriteria given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchImageSetsRequestSearchCriteria
   * @throws IOException if the JSON string is invalid with respect to SearchImageSetsRequestSearchCriteria
   */
  public static SearchImageSetsRequestSearchCriteria fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchImageSetsRequestSearchCriteria.class);
  }

  /**
   * Convert an instance of SearchImageSetsRequestSearchCriteria to an JSON string
   *
   * @return JSON string
   */
