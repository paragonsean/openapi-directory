...
public class GetImageFrameRequestImageFrameInformation {
  ...
  public GetImageFrameRequestImageFrameInformation() {
  }

  public GetImageFrameRequestImageFrameInformation imageFrameId(String imageFrameId) {
  ...
  public boolean equals(Object o) {
    ...
    GetImageFrameRequestImageFrameInformation getImageFrameRequestImageFrameInformation = (GetImageFrameRequestImageFrameInformation) o;
    return Objects.equals(this.imageFrameId, getImageFrameRequestImageFrameInformation.imageFrameId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetImageFrameRequestImageFrameInformation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImageFrameRequestImageFrameInformation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImageFrameRequestImageFrameInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImageFrameRequestImageFrameInformation is not found in the empty JSON string", GetImageFrameRequestImageFrameInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImageFrameRequestImageFrameInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImageFrameRequestImageFrameInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetImageFrameRequestImageFrameInformation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImageFrameRequestImageFrameInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImageFrameRequestImageFrameInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImageFrameRequestImageFrameInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImageFrameRequestImageFrameInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImageFrameRequestImageFrameInformation>() {
           @Override
           public void write(JsonWriter out, GetImageFrameRequestImageFrameInformation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImageFrameRequestImageFrameInformation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImageFrameRequestImageFrameInformation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImageFrameRequestImageFrameInformation
   * @throws IOException if the JSON string is invalid with respect to GetImageFrameRequestImageFrameInformation
   */
  public static GetImageFrameRequestImageFrameInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImageFrameRequestImageFrameInformation.class);
  }

  /**
   * Convert an instance of GetImageFrameRequestImageFrameInformation to an JSON string
   *
   * @return JSON string
   */
