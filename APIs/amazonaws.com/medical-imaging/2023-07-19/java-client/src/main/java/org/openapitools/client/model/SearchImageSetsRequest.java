...
import org.openapitools.client.model.SearchImageSetsRequestSearchCriteria;
...
public class SearchImageSetsRequest {
  ...
  private SearchImageSetsRequestSearchCriteria searchCriteria;

  public SearchImageSetsRequest() {
  }

  public SearchImageSetsRequest searchCriteria(SearchImageSetsRequestSearchCriteria searchCriteria) {
  ...
  public SearchImageSetsRequestSearchCriteria getSearchCriteria() {
    return searchCriteria;
  }

  public void setSearchCriteria(SearchImageSetsRequestSearchCriteria searchCriteria) {
    this.searchCriteria = searchCriteria;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchImageSetsRequest searchImageSetsRequest = (SearchImageSetsRequest) o;
    return Objects.equals(this.searchCriteria, searchImageSetsRequest.searchCriteria);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchImageSetsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchImageSetsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchImageSetsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchImageSetsRequest is not found in the empty JSON string", SearchImageSetsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchImageSetsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchImageSetsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("searchCriteria") != null && !jsonObj.get("searchCriteria").isJsonNull()) {
        SearchImageSetsRequestSearchCriteria.validateJsonElement(jsonObj.get("searchCriteria"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchImageSetsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchImageSetsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchImageSetsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchImageSetsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchImageSetsRequest>() {
           @Override
           public void write(JsonWriter out, SearchImageSetsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchImageSetsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchImageSetsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchImageSetsRequest
   * @throws IOException if the JSON string is invalid with respect to SearchImageSetsRequest
   */
  public static SearchImageSetsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchImageSetsRequest.class);
  }

  /**
   * Convert an instance of SearchImageSetsRequest to an JSON string
   *
   * @return JSON string
   */
