...
public class SearchByAttributeValueDICOMStudyDateAndTime {
  ...
  public SearchByAttributeValueDICOMStudyDateAndTime() {
  }

  public SearchByAttributeValueDICOMStudyDateAndTime diCOMStudyDate(String diCOMStudyDate) {
  ...
  public SearchByAttributeValueDICOMStudyDateAndTime diCOMStudyTime(String diCOMStudyTime) {
  ...
  public boolean equals(Object o) {
    ...
    SearchByAttributeValueDICOMStudyDateAndTime searchByAttributeValueDICOMStudyDateAndTime = (SearchByAttributeValueDICOMStudyDateAndTime) o;
    return Objects.equals(this.diCOMStudyDate, searchByAttributeValueDICOMStudyDateAndTime.diCOMStudyDate) &&
        Objects.equals(this.diCOMStudyTime, searchByAttributeValueDICOMStudyDateAndTime.diCOMStudyTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(diCOMStudyDate, diCOMStudyTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchByAttributeValueDICOMStudyDateAndTime {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("DICOMStudyDate");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchByAttributeValueDICOMStudyDateAndTime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchByAttributeValueDICOMStudyDateAndTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchByAttributeValueDICOMStudyDateAndTime is not found in the empty JSON string", SearchByAttributeValueDICOMStudyDateAndTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchByAttributeValueDICOMStudyDateAndTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchByAttributeValueDICOMStudyDateAndTime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchByAttributeValueDICOMStudyDateAndTime.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `DICOMStudyDate`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchByAttributeValueDICOMStudyDateAndTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchByAttributeValueDICOMStudyDateAndTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchByAttributeValueDICOMStudyDateAndTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchByAttributeValueDICOMStudyDateAndTime.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchByAttributeValueDICOMStudyDateAndTime>() {
           @Override
           public void write(JsonWriter out, SearchByAttributeValueDICOMStudyDateAndTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchByAttributeValueDICOMStudyDateAndTime read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchByAttributeValueDICOMStudyDateAndTime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchByAttributeValueDICOMStudyDateAndTime
   * @throws IOException if the JSON string is invalid with respect to SearchByAttributeValueDICOMStudyDateAndTime
   */
  public static SearchByAttributeValueDICOMStudyDateAndTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchByAttributeValueDICOMStudyDateAndTime.class);
  }

  /**
   * Convert an instance of SearchByAttributeValueDICOMStudyDateAndTime to an JSON string
   *
   * @return JSON string
   */
