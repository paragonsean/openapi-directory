...
public class CopyImageSetResponseDestinationImageSetProperties {
  ...
  public CopyImageSetResponseDestinationImageSetProperties() {
  }

  public CopyImageSetResponseDestinationImageSetProperties imageSetId(String imageSetId) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties latestVersionId(String latestVersionId) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties imageSetState(ImageSetState imageSetState) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties imageSetWorkflowStatus(ImageSetWorkflowStatus imageSetWorkflowStatus) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties createdAt(OffsetDateTime createdAt) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties updatedAt(OffsetDateTime updatedAt) {
  ...
  public CopyImageSetResponseDestinationImageSetProperties imageSetArn(String imageSetArn) {
  ...
  public boolean equals(Object o) {
    ...
    CopyImageSetResponseDestinationImageSetProperties copyImageSetResponseDestinationImageSetProperties = (CopyImageSetResponseDestinationImageSetProperties) o;
    return Objects.equals(this.imageSetId, copyImageSetResponseDestinationImageSetProperties.imageSetId) &&
        Objects.equals(this.latestVersionId, copyImageSetResponseDestinationImageSetProperties.latestVersionId) &&
        Objects.equals(this.imageSetState, copyImageSetResponseDestinationImageSetProperties.imageSetState) &&
        Objects.equals(this.imageSetWorkflowStatus, copyImageSetResponseDestinationImageSetProperties.imageSetWorkflowStatus) &&
        Objects.equals(this.createdAt, copyImageSetResponseDestinationImageSetProperties.createdAt) &&
        Objects.equals(this.updatedAt, copyImageSetResponseDestinationImageSetProperties.updatedAt) &&
        Objects.equals(this.imageSetArn, copyImageSetResponseDestinationImageSetProperties.imageSetArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyImageSetResponseDestinationImageSetProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyImageSetResponseDestinationImageSetProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyImageSetResponseDestinationImageSetProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyImageSetResponseDestinationImageSetProperties is not found in the empty JSON string", CopyImageSetResponseDestinationImageSetProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyImageSetResponseDestinationImageSetProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyImageSetResponseDestinationImageSetProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyImageSetResponseDestinationImageSetProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyImageSetResponseDestinationImageSetProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyImageSetResponseDestinationImageSetProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyImageSetResponseDestinationImageSetProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyImageSetResponseDestinationImageSetProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyImageSetResponseDestinationImageSetProperties>() {
           @Override
           public void write(JsonWriter out, CopyImageSetResponseDestinationImageSetProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyImageSetResponseDestinationImageSetProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyImageSetResponseDestinationImageSetProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyImageSetResponseDestinationImageSetProperties
   * @throws IOException if the JSON string is invalid with respect to CopyImageSetResponseDestinationImageSetProperties
   */
  public static CopyImageSetResponseDestinationImageSetProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyImageSetResponseDestinationImageSetProperties.class);
  }

  /**
   * Convert an instance of CopyImageSetResponseDestinationImageSetProperties to an JSON string
   *
   * @return JSON string
   */
