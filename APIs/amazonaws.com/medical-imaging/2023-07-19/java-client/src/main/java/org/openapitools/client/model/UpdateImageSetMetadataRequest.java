...
import org.openapitools.client.model.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates;
...
public class UpdateImageSetMetadataRequest {
  public static final String SERIALIZED_NAME_UPDATE_IMAGE_SET_METADATA_UPDATES = "updateImageSetMetadataUpdates";
  @SerializedName(SERIALIZED_NAME_UPDATE_IMAGE_SET_METADATA_UPDATES)
  private UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates updateImageSetMetadataUpdates;

  public UpdateImageSetMetadataRequest() {
  }

  public UpdateImageSetMetadataRequest updateImageSetMetadataUpdates(UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates updateImageSetMetadataUpdates) {
    this.updateImageSetMetadataUpdates = updateImageSetMetadataUpdates;
    return this;
  }

  /**
   * Get updateImageSetMetadataUpdates
   * @return updateImageSetMetadataUpdates
   */
  @javax.annotation.Nonnull
  public UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates getUpdateImageSetMetadataUpdates() {
    return updateImageSetMetadataUpdates;
  }

  public void setUpdateImageSetMetadataUpdates(UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates updateImageSetMetadataUpdates) {
    this.updateImageSetMetadataUpdates = updateImageSetMetadataUpdates;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateImageSetMetadataRequest updateImageSetMetadataRequest = (UpdateImageSetMetadataRequest) o;
    return Objects.equals(this.updateImageSetMetadataUpdates, updateImageSetMetadataRequest.updateImageSetMetadataUpdates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateImageSetMetadataUpdates);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateImageSetMetadataRequest {\n");
    sb.append("    updateImageSetMetadataUpdates: ").append(toIndentedString(updateImageSetMetadataUpdates)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("updateImageSetMetadataUpdates");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("updateImageSetMetadataUpdates");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateImageSetMetadataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateImageSetMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateImageSetMetadataRequest is not found in the empty JSON string", UpdateImageSetMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateImageSetMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateImageSetMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateImageSetMetadataRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `updateImageSetMetadataUpdates`
      UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates.validateJsonElement(jsonObj.get("updateImageSetMetadataUpdates"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateImageSetMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateImageSetMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateImageSetMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateImageSetMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateImageSetMetadataRequest>() {
           @Override
           public void write(JsonWriter out, UpdateImageSetMetadataRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateImageSetMetadataRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateImageSetMetadataRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateImageSetMetadataRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateImageSetMetadataRequest
   */
  public static UpdateImageSetMetadataRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateImageSetMetadataRequest.class);
  }

  /**
   * Convert an instance of UpdateImageSetMetadataRequest to an JSON string
   *
   * @return JSON string
   */
