...
public class DICOMStudyDateAndTime {
  ...
  public DICOMStudyDateAndTime() {
  }

  public DICOMStudyDateAndTime diCOMStudyDate(String diCOMStudyDate) {
  ...
  public DICOMStudyDateAndTime diCOMStudyTime(String diCOMStudyTime) {
  ...
  public boolean equals(Object o) {
    ...
    DICOMStudyDateAndTime diCOMStudyDateAndTime = (DICOMStudyDateAndTime) o;
    return Objects.equals(this.diCOMStudyDate, diCOMStudyDateAndTime.diCOMStudyDate) &&
        Objects.equals(this.diCOMStudyTime, diCOMStudyDateAndTime.diCOMStudyTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DICOMStudyDateAndTime {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DICOMStudyDateAndTime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DICOMStudyDateAndTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DICOMStudyDateAndTime is not found in the empty JSON string", DICOMStudyDateAndTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DICOMStudyDateAndTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DICOMStudyDateAndTime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DICOMStudyDateAndTime.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DICOMStudyDateAndTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DICOMStudyDateAndTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DICOMStudyDateAndTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DICOMStudyDateAndTime.class));

       return (TypeAdapter<T>) new TypeAdapter<DICOMStudyDateAndTime>() {
           @Override
           public void write(JsonWriter out, DICOMStudyDateAndTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DICOMStudyDateAndTime read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DICOMStudyDateAndTime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DICOMStudyDateAndTime
   * @throws IOException if the JSON string is invalid with respect to DICOMStudyDateAndTime
   */
  public static DICOMStudyDateAndTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DICOMStudyDateAndTime.class);
  }

  /**
   * Convert an instance of DICOMStudyDateAndTime to an JSON string
   *
   * @return JSON string
   */
