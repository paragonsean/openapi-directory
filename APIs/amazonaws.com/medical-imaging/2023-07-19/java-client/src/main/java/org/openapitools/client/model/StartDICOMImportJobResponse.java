...
public class StartDICOMImportJobResponse {
  ...
  public StartDICOMImportJobResponse() {
  }

  public StartDICOMImportJobResponse datastoreId(String datastoreId) {
  ...
  public StartDICOMImportJobResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public StartDICOMImportJobResponse jobStatus(JobStatus jobStatus) {
  ...
  public StartDICOMImportJobResponse submittedAt(OffsetDateTime submittedAt) {
  ...
  public boolean equals(Object o) {
    ...
    StartDICOMImportJobResponse startDICOMImportJobResponse = (StartDICOMImportJobResponse) o;
    return Objects.equals(this.datastoreId, startDICOMImportJobResponse.datastoreId) &&
        Objects.equals(this.jobId, startDICOMImportJobResponse.jobId) &&
        Objects.equals(this.jobStatus, startDICOMImportJobResponse.jobStatus) &&
        Objects.equals(this.submittedAt, startDICOMImportJobResponse.submittedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreId, jobId, jobStatus, submittedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StartDICOMImportJobResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartDICOMImportJobResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartDICOMImportJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartDICOMImportJobResponse is not found in the empty JSON string", StartDICOMImportJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartDICOMImportJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartDICOMImportJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StartDICOMImportJobResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartDICOMImportJobResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartDICOMImportJobResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartDICOMImportJobResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartDICOMImportJobResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StartDICOMImportJobResponse>() {
           @Override
           public void write(JsonWriter out, StartDICOMImportJobResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartDICOMImportJobResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartDICOMImportJobResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartDICOMImportJobResponse
   * @throws IOException if the JSON string is invalid with respect to StartDICOMImportJobResponse
   */
  public static StartDICOMImportJobResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartDICOMImportJobResponse.class);
  }

  /**
   * Convert an instance of StartDICOMImportJobResponse to an JSON string
   *
   * @return JSON string
   */
