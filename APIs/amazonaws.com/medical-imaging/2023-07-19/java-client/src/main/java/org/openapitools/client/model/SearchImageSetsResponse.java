...
public class SearchImageSetsResponse {
  public static final String SERIALIZED_NAME_IMAGE_SETS_METADATA_SUMMARIES = "imageSetsMetadataSummaries";
  @SerializedName(SERIALIZED_NAME_IMAGE_SETS_METADATA_SUMMARIES)
  private List imageSetsMetadataSummaries;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "nextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public SearchImageSetsResponse() {
  }

  public SearchImageSetsResponse imageSetsMetadataSummaries(List imageSetsMetadataSummaries) {
    this.imageSetsMetadataSummaries = imageSetsMetadataSummaries;
    return this;
  }

  /**
   * Get imageSetsMetadataSummaries
   * @return imageSetsMetadataSummaries
   */
  @javax.annotation.Nonnull
  public List getImageSetsMetadataSummaries() {
    return imageSetsMetadataSummaries;
  }

  public void setImageSetsMetadataSummaries(List imageSetsMetadataSummaries) {
    this.imageSetsMetadataSummaries = imageSetsMetadataSummaries;
  }


  public SearchImageSetsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    SearchImageSetsResponse searchImageSetsResponse = (SearchImageSetsResponse) o;
    return Objects.equals(this.imageSetsMetadataSummaries, searchImageSetsResponse.imageSetsMetadataSummaries) &&
        Objects.equals(this.nextToken, searchImageSetsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageSetsMetadataSummaries, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchImageSetsResponse {\n");
    sb.append("    imageSetsMetadataSummaries: ").append(toIndentedString(imageSetsMetadataSummaries)).append("\n");
  ...
  static {
    ...
    openapiFields.add("imageSetsMetadataSummaries");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageSetsMetadataSummaries");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchImageSetsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchImageSetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchImageSetsResponse is not found in the empty JSON string", SearchImageSetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchImageSetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchImageSetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchImageSetsResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageSetsMetadataSummaries`
      List.validateJsonElement(jsonObj.get("imageSetsMetadataSummaries"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchImageSetsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchImageSetsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchImageSetsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchImageSetsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchImageSetsResponse>() {
           @Override
           public void write(JsonWriter out, SearchImageSetsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchImageSetsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchImageSetsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchImageSetsResponse
   * @throws IOException if the JSON string is invalid with respect to SearchImageSetsResponse
   */
  public static SearchImageSetsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchImageSetsResponse.class);
  }

  /**
   * Convert an instance of SearchImageSetsResponse to an JSON string
   *
   * @return JSON string
   */
