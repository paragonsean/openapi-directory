...
public class DICOMUpdates {
  public static final String SERIALIZED_NAME_REMOVABLE_ATTRIBUTES = "removableAttributes";
  @SerializedName(SERIALIZED_NAME_REMOVABLE_ATTRIBUTES)
  private String removableAttributes;

  public static final String SERIALIZED_NAME_UPDATABLE_ATTRIBUTES = "updatableAttributes";
  @SerializedName(SERIALIZED_NAME_UPDATABLE_ATTRIBUTES)
  private String updatableAttributes;

  public DICOMUpdates() {
  }

  public DICOMUpdates removableAttributes(String removableAttributes) {
    this.removableAttributes = removableAttributes;
    return this;
  }

  /**
   * Get removableAttributes
   * @return removableAttributes
   */
  @javax.annotation.Nullable
  public String getRemovableAttributes() {
    return removableAttributes;
  }

  public void setRemovableAttributes(String removableAttributes) {
    this.removableAttributes = removableAttributes;
  }


  public DICOMUpdates updatableAttributes(String updatableAttributes) {
  ...
  public void setUpdatableAttributes(String updatableAttributes) {
    this.updatableAttributes = updatableAttributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    DICOMUpdates diCOMUpdates = (DICOMUpdates) o;
    return Objects.equals(this.removableAttributes, diCOMUpdates.removableAttributes) &&
        Objects.equals(this.updatableAttributes, diCOMUpdates.updatableAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(removableAttributes, updatableAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DICOMUpdates {\n");
    sb.append("    removableAttributes: ").append(toIndentedString(removableAttributes)).append("\n");
    sb.append("    updatableAttributes: ").append(toIndentedString(updatableAttributes)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("removableAttributes");
    openapiFields.add("updatableAttributes");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DICOMUpdates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DICOMUpdates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DICOMUpdates is not found in the empty JSON string", DICOMUpdates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DICOMUpdates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DICOMUpdates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `removableAttributes`
      if (jsonObj.get("removableAttributes") != null && !jsonObj.get("removableAttributes").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("removableAttributes"));
      }
      // validate the optional field `updatableAttributes`
      if (jsonObj.get("updatableAttributes") != null && !jsonObj.get("updatableAttributes").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("updatableAttributes"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DICOMUpdates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DICOMUpdates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DICOMUpdates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DICOMUpdates.class));

       return (TypeAdapter<T>) new TypeAdapter<DICOMUpdates>() {
           @Override
           public void write(JsonWriter out, DICOMUpdates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DICOMUpdates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DICOMUpdates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DICOMUpdates
   * @throws IOException if the JSON string is invalid with respect to DICOMUpdates
   */
  public static DICOMUpdates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DICOMUpdates.class);
  }

  /**
   * Convert an instance of DICOMUpdates to an JSON string
   *
   * @return JSON string
   */
