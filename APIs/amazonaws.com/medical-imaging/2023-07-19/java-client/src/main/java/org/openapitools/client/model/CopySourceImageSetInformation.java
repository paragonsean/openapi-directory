...
public class CopySourceImageSetInformation {
  ...
  public CopySourceImageSetInformation() {
  }

  public CopySourceImageSetInformation latestVersionId(String latestVersionId) {
  ...
  public boolean equals(Object o) {
    ...
    CopySourceImageSetInformation copySourceImageSetInformation = (CopySourceImageSetInformation) o;
    return Objects.equals(this.latestVersionId, copySourceImageSetInformation.latestVersionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopySourceImageSetInformation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopySourceImageSetInformation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopySourceImageSetInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopySourceImageSetInformation is not found in the empty JSON string", CopySourceImageSetInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopySourceImageSetInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopySourceImageSetInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopySourceImageSetInformation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopySourceImageSetInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopySourceImageSetInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopySourceImageSetInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopySourceImageSetInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<CopySourceImageSetInformation>() {
           @Override
           public void write(JsonWriter out, CopySourceImageSetInformation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopySourceImageSetInformation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopySourceImageSetInformation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopySourceImageSetInformation
   * @throws IOException if the JSON string is invalid with respect to CopySourceImageSetInformation
   */
  public static CopySourceImageSetInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopySourceImageSetInformation.class);
  }

  /**
   * Convert an instance of CopySourceImageSetInformation to an JSON string
   *
   * @return JSON string
   */
