...
public class ListImageSetVersionsResponse {
  public static final String SERIALIZED_NAME_IMAGE_SET_PROPERTIES_LIST = "imageSetPropertiesList";
  @SerializedName(SERIALIZED_NAME_IMAGE_SET_PROPERTIES_LIST)
  private List imageSetPropertiesList;

  public static final String SERIALIZED_NAME_NEXT_TOKEN = "nextToken";
  @SerializedName(SERIALIZED_NAME_NEXT_TOKEN)
  private String nextToken;

  public ListImageSetVersionsResponse() {
  }

  public ListImageSetVersionsResponse imageSetPropertiesList(List imageSetPropertiesList) {
    this.imageSetPropertiesList = imageSetPropertiesList;
    return this;
  }

  /**
   * Get imageSetPropertiesList
   * @return imageSetPropertiesList
   */
  @javax.annotation.Nonnull
  public List getImageSetPropertiesList() {
    return imageSetPropertiesList;
  }

  public void setImageSetPropertiesList(List imageSetPropertiesList) {
    this.imageSetPropertiesList = imageSetPropertiesList;
  }


  public ListImageSetVersionsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListImageSetVersionsResponse listImageSetVersionsResponse = (ListImageSetVersionsResponse) o;
    return Objects.equals(this.imageSetPropertiesList, listImageSetVersionsResponse.imageSetPropertiesList) &&
        Objects.equals(this.nextToken, listImageSetVersionsResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageSetPropertiesList, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListImageSetVersionsResponse {\n");
    sb.append("    imageSetPropertiesList: ").append(toIndentedString(imageSetPropertiesList)).append("\n");
  ...
  static {
    ...
    openapiFields.add("imageSetPropertiesList");
    openapiFields.add("nextToken");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageSetPropertiesList");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListImageSetVersionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListImageSetVersionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListImageSetVersionsResponse is not found in the empty JSON string", ListImageSetVersionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListImageSetVersionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListImageSetVersionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListImageSetVersionsResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageSetPropertiesList`
      List.validateJsonElement(jsonObj.get("imageSetPropertiesList"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListImageSetVersionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListImageSetVersionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListImageSetVersionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListImageSetVersionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListImageSetVersionsResponse>() {
           @Override
           public void write(JsonWriter out, ListImageSetVersionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListImageSetVersionsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListImageSetVersionsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListImageSetVersionsResponse
   * @throws IOException if the JSON string is invalid with respect to ListImageSetVersionsResponse
   */
  public static ListImageSetVersionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListImageSetVersionsResponse.class);
  }

  /**
   * Convert an instance of ListImageSetVersionsResponse to an JSON string
   *
   * @return JSON string
   */
