...
public class CopyImageSetRequestCopyImageSetInformationSourceImageSet {
  ...
  public CopyImageSetRequestCopyImageSetInformationSourceImageSet() {
  }

  public CopyImageSetRequestCopyImageSetInformationSourceImageSet latestVersionId(String latestVersionId) {
  ...
  public boolean equals(Object o) {
    ...
    CopyImageSetRequestCopyImageSetInformationSourceImageSet copyImageSetRequestCopyImageSetInformationSourceImageSet = (CopyImageSetRequestCopyImageSetInformationSourceImageSet) o;
    return Objects.equals(this.latestVersionId, copyImageSetRequestCopyImageSetInformationSourceImageSet.latestVersionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latestVersionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CopyImageSetRequestCopyImageSetInformationSourceImageSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyImageSetRequestCopyImageSetInformationSourceImageSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyImageSetRequestCopyImageSetInformationSourceImageSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyImageSetRequestCopyImageSetInformationSourceImageSet is not found in the empty JSON string", CopyImageSetRequestCopyImageSetInformationSourceImageSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyImageSetRequestCopyImageSetInformationSourceImageSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyImageSetRequestCopyImageSetInformationSourceImageSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyImageSetRequestCopyImageSetInformationSourceImageSet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyImageSetRequestCopyImageSetInformationSourceImageSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyImageSetRequestCopyImageSetInformationSourceImageSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyImageSetRequestCopyImageSetInformationSourceImageSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyImageSetRequestCopyImageSetInformationSourceImageSet.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyImageSetRequestCopyImageSetInformationSourceImageSet>() {
           @Override
           public void write(JsonWriter out, CopyImageSetRequestCopyImageSetInformationSourceImageSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyImageSetRequestCopyImageSetInformationSourceImageSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyImageSetRequestCopyImageSetInformationSourceImageSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyImageSetRequestCopyImageSetInformationSourceImageSet
   * @throws IOException if the JSON string is invalid with respect to CopyImageSetRequestCopyImageSetInformationSourceImageSet
   */
  public static CopyImageSetRequestCopyImageSetInformationSourceImageSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyImageSetRequestCopyImageSetInformationSourceImageSet.class);
  }

  /**
   * Convert an instance of CopyImageSetRequestCopyImageSetInformationSourceImageSet to an JSON string
   *
   * @return JSON string
   */
