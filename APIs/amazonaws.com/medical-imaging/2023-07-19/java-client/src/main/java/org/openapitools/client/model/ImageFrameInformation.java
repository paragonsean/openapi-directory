...
public class ImageFrameInformation {
  public static final String SERIALIZED_NAME_IMAGE_FRAME_ID = "imageFrameId";
  @SerializedName(SERIALIZED_NAME_IMAGE_FRAME_ID)
  private String imageFrameId;

  public ImageFrameInformation() {
  }

  public ImageFrameInformation imageFrameId(String imageFrameId) {
  ...
  public boolean equals(Object o) {
    ...
    ImageFrameInformation imageFrameInformation = (ImageFrameInformation) o;
    return Objects.equals(this.imageFrameId, imageFrameInformation.imageFrameId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageFrameId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImageFrameInformation {\n");
  ...
  static {
    ...
    openapiFields.add("imageFrameId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageFrameId");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageFrameInformation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageFrameInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageFrameInformation is not found in the empty JSON string", ImageFrameInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageFrameInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageFrameInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageFrameInformation.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageFrameId`
      String.validateJsonElement(jsonObj.get("imageFrameId"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageFrameInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageFrameInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageFrameInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageFrameInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageFrameInformation>() {
           @Override
           public void write(JsonWriter out, ImageFrameInformation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageFrameInformation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageFrameInformation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageFrameInformation
   * @throws IOException if the JSON string is invalid with respect to ImageFrameInformation
   */
  public static ImageFrameInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageFrameInformation.class);
  }

  /**
   * Convert an instance of ImageFrameInformation to an JSON string
   *
   * @return JSON string
   */
