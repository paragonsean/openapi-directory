...
public class UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates {
  ...
  public UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates() {
  }

  public UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates removableAttributes(String removableAttributes) {
  ...
  public UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates updatableAttributes(String updatableAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates updateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates = (UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates) o;
    return Objects.equals(this.removableAttributes, updateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.removableAttributes) &&
        Objects.equals(this.updatableAttributes, updateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.updatableAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates is not found in the empty JSON string", UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates>() {
           @Override
           public void write(JsonWriter out, UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
   * @throws IOException if the JSON string is invalid with respect to UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
   */
  public static UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.class);
  }

  /**
   * Convert an instance of UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates to an JSON string
   *
   * @return JSON string
   */
