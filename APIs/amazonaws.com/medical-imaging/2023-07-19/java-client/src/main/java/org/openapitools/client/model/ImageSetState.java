...
/**
 * Gets or Sets ImageSetState
 */
@JsonAdapter(ImageSetState.Adapter.class)
public enum ImageSetState {
  ...
  public static ImageSetState fromValue(String value) {
    for (ImageSetState b : ImageSetState.values()) {
  ...
  public static class Adapter extends TypeAdapter<ImageSetState> {
    @Override
    public void write(final JsonWriter jsonWriter, final ImageSetState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ImageSetState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ImageSetState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ImageSetState.fromValue(value);
  }
}
