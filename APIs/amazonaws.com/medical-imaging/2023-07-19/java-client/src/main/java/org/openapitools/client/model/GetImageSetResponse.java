...
public class GetImageSetResponse {
  ...
  public GetImageSetResponse() {
  }

  public GetImageSetResponse datastoreId(String datastoreId) {
  ...
  public GetImageSetResponse imageSetId(String imageSetId) {
  ...
  public GetImageSetResponse versionId(String versionId) {
  ...
  public GetImageSetResponse imageSetState(ImageSetState imageSetState) {
  ...
  public GetImageSetResponse imageSetWorkflowStatus(ImageSetWorkflowStatus imageSetWorkflowStatus) {
  ...
  public GetImageSetResponse createdAt(OffsetDateTime createdAt) {
  ...
  public GetImageSetResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  public GetImageSetResponse deletedAt(OffsetDateTime deletedAt) {
  ...
  public GetImageSetResponse message(String message) {
  ...
  public GetImageSetResponse imageSetArn(String imageSetArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetImageSetResponse getImageSetResponse = (GetImageSetResponse) o;
    return Objects.equals(this.datastoreId, getImageSetResponse.datastoreId) &&
        Objects.equals(this.imageSetId, getImageSetResponse.imageSetId) &&
        Objects.equals(this.versionId, getImageSetResponse.versionId) &&
        Objects.equals(this.imageSetState, getImageSetResponse.imageSetState) &&
        Objects.equals(this.imageSetWorkflowStatus, getImageSetResponse.imageSetWorkflowStatus) &&
        Objects.equals(this.createdAt, getImageSetResponse.createdAt) &&
        Objects.equals(this.updatedAt, getImageSetResponse.updatedAt) &&
        Objects.equals(this.deletedAt, getImageSetResponse.deletedAt) &&
        Objects.equals(this.message, getImageSetResponse.message) &&
        Objects.equals(this.imageSetArn, getImageSetResponse.imageSetArn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreId, imageSetId, versionId, imageSetState, imageSetWorkflowStatus, createdAt, updatedAt, deletedAt, message, imageSetArn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetImageSetResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImageSetResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImageSetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImageSetResponse is not found in the empty JSON string", GetImageSetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImageSetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImageSetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetImageSetResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImageSetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImageSetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImageSetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImageSetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImageSetResponse>() {
           @Override
           public void write(JsonWriter out, GetImageSetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImageSetResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImageSetResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImageSetResponse
   * @throws IOException if the JSON string is invalid with respect to GetImageSetResponse
   */
  public static GetImageSetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImageSetResponse.class);
  }

  /**
   * Convert an instance of GetImageSetResponse to an JSON string
   *
   * @return JSON string
   */
