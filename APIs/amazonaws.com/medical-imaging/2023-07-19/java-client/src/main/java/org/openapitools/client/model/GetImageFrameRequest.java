...
import org.openapitools.client.model.GetImageFrameRequestImageFrameInformation;
...
public class GetImageFrameRequest {
  public static final String SERIALIZED_NAME_IMAGE_FRAME_INFORMATION = "imageFrameInformation";
  @SerializedName(SERIALIZED_NAME_IMAGE_FRAME_INFORMATION)
  private GetImageFrameRequestImageFrameInformation imageFrameInformation;

  public GetImageFrameRequest() {
  }

  public GetImageFrameRequest imageFrameInformation(GetImageFrameRequestImageFrameInformation imageFrameInformation) {
    this.imageFrameInformation = imageFrameInformation;
    return this;
  }

  /**
   * Get imageFrameInformation
   * @return imageFrameInformation
   */
  @javax.annotation.Nonnull
  public GetImageFrameRequestImageFrameInformation getImageFrameInformation() {
    return imageFrameInformation;
  }

  public void setImageFrameInformation(GetImageFrameRequestImageFrameInformation imageFrameInformation) {
    this.imageFrameInformation = imageFrameInformation;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetImageFrameRequest getImageFrameRequest = (GetImageFrameRequest) o;
    return Objects.equals(this.imageFrameInformation, getImageFrameRequest.imageFrameInformation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageFrameInformation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetImageFrameRequest {\n");
    sb.append("    imageFrameInformation: ").append(toIndentedString(imageFrameInformation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("imageFrameInformation");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("imageFrameInformation");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetImageFrameRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetImageFrameRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetImageFrameRequest is not found in the empty JSON string", GetImageFrameRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetImageFrameRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetImageFrameRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetImageFrameRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `imageFrameInformation`
      GetImageFrameRequestImageFrameInformation.validateJsonElement(jsonObj.get("imageFrameInformation"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetImageFrameRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetImageFrameRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetImageFrameRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetImageFrameRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetImageFrameRequest>() {
           @Override
           public void write(JsonWriter out, GetImageFrameRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetImageFrameRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetImageFrameRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetImageFrameRequest
   * @throws IOException if the JSON string is invalid with respect to GetImageFrameRequest
   */
  public static GetImageFrameRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetImageFrameRequest.class);
  }

  /**
   * Convert an instance of GetImageFrameRequest to an JSON string
   *
   * @return JSON string
   */
