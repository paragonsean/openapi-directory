...
public class MetadataUpdates {
  ...
  public MetadataUpdates diCOMUpdates(UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates diCOMUpdates) {
  ...
  public boolean equals(Object o) {
    ...
    MetadataUpdates metadataUpdates = (MetadataUpdates) o;
    return Objects.equals(this.diCOMUpdates, metadataUpdates.diCOMUpdates);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetadataUpdates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetadataUpdates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetadataUpdates is not found in the empty JSON string", MetadataUpdates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetadataUpdates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataUpdates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetadataUpdates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetadataUpdates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetadataUpdates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetadataUpdates.class));

       return (TypeAdapter<T>) new TypeAdapter<MetadataUpdates>() {
           @Override
           public void write(JsonWriter out, MetadataUpdates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MetadataUpdates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MetadataUpdates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetadataUpdates
   * @throws IOException if the JSON string is invalid with respect to MetadataUpdates
   */
  public static MetadataUpdates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetadataUpdates.class);
  }

  /**
   * Convert an instance of MetadataUpdates to an JSON string
   *
   * @return JSON string
   */
