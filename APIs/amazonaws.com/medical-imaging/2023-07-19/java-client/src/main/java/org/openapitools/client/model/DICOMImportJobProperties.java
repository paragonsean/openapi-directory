...
public class DICOMImportJobProperties {
  ...
  public DICOMImportJobProperties() {
  }

  public DICOMImportJobProperties jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public DICOMImportJobProperties jobName(String jobName) {
  ...
  public DICOMImportJobProperties jobStatus(JobStatus jobStatus) {
  ...
  public DICOMImportJobProperties datastoreId(String datastoreId) {
  ...
  public DICOMImportJobProperties dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public DICOMImportJobProperties endedAt(OffsetDateTime endedAt) {
  ...
  public DICOMImportJobProperties submittedAt(OffsetDateTime submittedAt) {
  ...
  public DICOMImportJobProperties inputS3Uri(String inputS3Uri) {
  ...
  public DICOMImportJobProperties outputS3Uri(String outputS3Uri) {
  ...
  public DICOMImportJobProperties message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    DICOMImportJobProperties diCOMImportJobProperties = (DICOMImportJobProperties) o;
    return Objects.equals(this.jobId, diCOMImportJobProperties.jobId) &&
        Objects.equals(this.jobName, diCOMImportJobProperties.jobName) &&
        Objects.equals(this.jobStatus, diCOMImportJobProperties.jobStatus) &&
        Objects.equals(this.datastoreId, diCOMImportJobProperties.datastoreId) &&
        Objects.equals(this.dataAccessRoleArn, diCOMImportJobProperties.dataAccessRoleArn) &&
        Objects.equals(this.endedAt, diCOMImportJobProperties.endedAt) &&
        Objects.equals(this.submittedAt, diCOMImportJobProperties.submittedAt) &&
        Objects.equals(this.inputS3Uri, diCOMImportJobProperties.inputS3Uri) &&
        Objects.equals(this.outputS3Uri, diCOMImportJobProperties.outputS3Uri) &&
        Objects.equals(this.message, diCOMImportJobProperties.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DICOMImportJobProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DICOMImportJobProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DICOMImportJobProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DICOMImportJobProperties is not found in the empty JSON string", DICOMImportJobProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DICOMImportJobProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DICOMImportJobProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DICOMImportJobProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DICOMImportJobProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DICOMImportJobProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DICOMImportJobProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DICOMImportJobProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<DICOMImportJobProperties>() {
           @Override
           public void write(JsonWriter out, DICOMImportJobProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DICOMImportJobProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DICOMImportJobProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DICOMImportJobProperties
   * @throws IOException if the JSON string is invalid with respect to DICOMImportJobProperties
   */
  public static DICOMImportJobProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DICOMImportJobProperties.class);
  }

  /**
   * Convert an instance of DICOMImportJobProperties to an JSON string
   *
   * @return JSON string
   */
