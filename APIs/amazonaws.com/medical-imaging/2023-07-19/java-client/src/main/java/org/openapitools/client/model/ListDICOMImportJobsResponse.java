...
public class ListDICOMImportJobsResponse {
  ...
  public ListDICOMImportJobsResponse() {
  }

  public ListDICOMImportJobsResponse jobSummaries(List jobSummaries) {
  ...
  public ListDICOMImportJobsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListDICOMImportJobsResponse listDICOMImportJobsResponse = (ListDICOMImportJobsResponse) o;
    return Objects.equals(this.jobSummaries, listDICOMImportJobsResponse.jobSummaries) &&
        Objects.equals(this.nextToken, listDICOMImportJobsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListDICOMImportJobsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDICOMImportJobsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDICOMImportJobsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDICOMImportJobsResponse is not found in the empty JSON string", ListDICOMImportJobsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDICOMImportJobsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDICOMImportJobsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListDICOMImportJobsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDICOMImportJobsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDICOMImportJobsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDICOMImportJobsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDICOMImportJobsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDICOMImportJobsResponse>() {
           @Override
           public void write(JsonWriter out, ListDICOMImportJobsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDICOMImportJobsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDICOMImportJobsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDICOMImportJobsResponse
   * @throws IOException if the JSON string is invalid with respect to ListDICOMImportJobsResponse
   */
  public static ListDICOMImportJobsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDICOMImportJobsResponse.class);
  }

  /**
   * Convert an instance of ListDICOMImportJobsResponse to an JSON string
   *
   * @return JSON string
   */
