...
public class DeleteDatastoreResponse {
  ...
  public DeleteDatastoreResponse datastoreId(String datastoreId) {
  ...
  public DeleteDatastoreResponse datastoreStatus(DatastoreStatus datastoreStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteDatastoreResponse deleteDatastoreResponse = (DeleteDatastoreResponse) o;
    return Objects.equals(this.datastoreId, deleteDatastoreResponse.datastoreId) &&
        Objects.equals(this.datastoreStatus, deleteDatastoreResponse.datastoreStatus);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteDatastoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteDatastoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteDatastoreResponse is not found in the empty JSON string", DeleteDatastoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteDatastoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteDatastoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteDatastoreResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteDatastoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteDatastoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteDatastoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteDatastoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteDatastoreResponse>() {
           @Override
           public void write(JsonWriter out, DeleteDatastoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteDatastoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteDatastoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteDatastoreResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteDatastoreResponse
   */
  public static DeleteDatastoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteDatastoreResponse.class);
  }

  /**
   * Convert an instance of DeleteDatastoreResponse to an JSON string
   *
   * @return JSON string
   */
