...
public class CopyImageSetRequest {
  public static final String SERIALIZED_NAME_COPY_IMAGE_SET_INFORMATION = "copyImageSetInformation";
  @SerializedName(SERIALIZED_NAME_COPY_IMAGE_SET_INFORMATION)
  private CopyImageSetRequestCopyImageSetInformation copyImageSetInformation;

  public CopyImageSetRequest() {
  }

  public CopyImageSetRequest copyImageSetInformation(CopyImageSetRequestCopyImageSetInformation copyImageSetInformation) {
    this.copyImageSetInformation = copyImageSetInformation;
    return this;
  }

  /**
   * Get copyImageSetInformation
   * @return copyImageSetInformation
   */
  @javax.annotation.Nonnull
  public CopyImageSetRequestCopyImageSetInformation getCopyImageSetInformation() {
    return copyImageSetInformation;
  }

  public void setCopyImageSetInformation(CopyImageSetRequestCopyImageSetInformation copyImageSetInformation) {
    this.copyImageSetInformation = copyImageSetInformation;
  }
  ...
  public boolean equals(Object o) {
    ...
    CopyImageSetRequest copyImageSetRequest = (CopyImageSetRequest) o;
    return Objects.equals(this.copyImageSetInformation, copyImageSetRequest.copyImageSetInformation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(copyImageSetInformation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CopyImageSetRequest {\n");
    sb.append("    copyImageSetInformation: ").append(toIndentedString(copyImageSetInformation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("copyImageSetInformation");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("copyImageSetInformation");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyImageSetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyImageSetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyImageSetRequest is not found in the empty JSON string", CopyImageSetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyImageSetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyImageSetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyImageSetRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `copyImageSetInformation`
      CopyImageSetRequestCopyImageSetInformation.validateJsonElement(jsonObj.get("copyImageSetInformation"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyImageSetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyImageSetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyImageSetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyImageSetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyImageSetRequest>() {
           @Override
           public void write(JsonWriter out, CopyImageSetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyImageSetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyImageSetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyImageSetRequest
   * @throws IOException if the JSON string is invalid with respect to CopyImageSetRequest
   */
  public static CopyImageSetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyImageSetRequest.class);
  }

  /**
   * Convert an instance of CopyImageSetRequest to an JSON string
   *
   * @return JSON string
   */
