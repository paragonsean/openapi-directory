...
public class CopyImageSetResponse {
  ...
  public static final String SERIALIZED_NAME_SOURCE_IMAGE_SET_PROPERTIES = "sourceImageSetProperties";
  @SerializedName(SERIALIZED_NAME_SOURCE_IMAGE_SET_PROPERTIES)
  private CopyImageSetResponseSourceImageSetProperties sourceImageSetProperties;

  public static final String SERIALIZED_NAME_DESTINATION_IMAGE_SET_PROPERTIES = "destinationImageSetProperties";
  @SerializedName(SERIALIZED_NAME_DESTINATION_IMAGE_SET_PROPERTIES)
  private CopyImageSetResponseDestinationImageSetProperties destinationImageSetProperties;

  public CopyImageSetResponse() {
  }

  public CopyImageSetResponse datastoreId(String datastoreId) {
  ...
  public CopyImageSetResponse sourceImageSetProperties(CopyImageSetResponseSourceImageSetProperties sourceImageSetProperties) {
    this.sourceImageSetProperties = sourceImageSetProperties;
    return this;
  }

  /**
   * Get sourceImageSetProperties
   * @return sourceImageSetProperties
   */
  @javax.annotation.Nonnull
  public CopyImageSetResponseSourceImageSetProperties getSourceImageSetProperties() {
    return sourceImageSetProperties;
  }

  public void setSourceImageSetProperties(CopyImageSetResponseSourceImageSetProperties sourceImageSetProperties) {
    this.sourceImageSetProperties = sourceImageSetProperties;
  }


  public CopyImageSetResponse destinationImageSetProperties(CopyImageSetResponseDestinationImageSetProperties destinationImageSetProperties) {
    this.destinationImageSetProperties = destinationImageSetProperties;
    return this;
  }

  /**
   * Get destinationImageSetProperties
   * @return destinationImageSetProperties
   */
  @javax.annotation.Nonnull
  public CopyImageSetResponseDestinationImageSetProperties getDestinationImageSetProperties() {
    return destinationImageSetProperties;
  }

  public void setDestinationImageSetProperties(CopyImageSetResponseDestinationImageSetProperties destinationImageSetProperties) {
    this.destinationImageSetProperties = destinationImageSetProperties;
  }
  ...
  public boolean equals(Object o) {
    ...
    CopyImageSetResponse copyImageSetResponse = (CopyImageSetResponse) o;
    return Objects.equals(this.datastoreId, copyImageSetResponse.datastoreId) &&
        Objects.equals(this.sourceImageSetProperties, copyImageSetResponse.sourceImageSetProperties) &&
        Objects.equals(this.destinationImageSetProperties, copyImageSetResponse.destinationImageSetProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreId, sourceImageSetProperties, destinationImageSetProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CopyImageSetResponse {\n");
    sb.append("    datastoreId: ").append(toIndentedString(datastoreId)).append("\n");
    sb.append("    sourceImageSetProperties: ").append(toIndentedString(sourceImageSetProperties)).append("\n");
    sb.append("    destinationImageSetProperties: ").append(toIndentedString(destinationImageSetProperties)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("sourceImageSetProperties");
    openapiFields.add("destinationImageSetProperties");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("datastoreId");
    openapiRequiredFields.add("sourceImageSetProperties");
    openapiRequiredFields.add("destinationImageSetProperties");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyImageSetResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyImageSetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CopyImageSetResponse is not found in the empty JSON string", CopyImageSetResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyImageSetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CopyImageSetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CopyImageSetResponse.openapiRequiredFields) {
      ...
      // validate the required field `sourceImageSetProperties`
      CopyImageSetResponseSourceImageSetProperties.validateJsonElement(jsonObj.get("sourceImageSetProperties"));
      // validate the required field `destinationImageSetProperties`
      CopyImageSetResponseDestinationImageSetProperties.validateJsonElement(jsonObj.get("destinationImageSetProperties"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyImageSetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyImageSetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyImageSetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyImageSetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyImageSetResponse>() {
           @Override
           public void write(JsonWriter out, CopyImageSetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyImageSetResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyImageSetResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyImageSetResponse
   * @throws IOException if the JSON string is invalid with respect to CopyImageSetResponse
   */
  public static CopyImageSetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyImageSetResponse.class);
  }

  /**
   * Convert an instance of CopyImageSetResponse to an JSON string
   *
   * @return JSON string
   */
