...
public class CreateDatastoreResponse {
  ...
  public CreateDatastoreResponse datastoreId(String datastoreId) {
  ...
  public CreateDatastoreResponse datastoreStatus(DatastoreStatus datastoreStatus) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDatastoreResponse createDatastoreResponse = (CreateDatastoreResponse) o;
    return Objects.equals(this.datastoreId, createDatastoreResponse.datastoreId) &&
        Objects.equals(this.datastoreStatus, createDatastoreResponse.datastoreStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreId, datastoreStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateDatastoreResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDatastoreResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDatastoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDatastoreResponse is not found in the empty JSON string", CreateDatastoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDatastoreResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDatastoreResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDatastoreResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDatastoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDatastoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDatastoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDatastoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDatastoreResponse>() {
           @Override
           public void write(JsonWriter out, CreateDatastoreResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDatastoreResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDatastoreResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDatastoreResponse
   * @throws IOException if the JSON string is invalid with respect to CreateDatastoreResponse
   */
  public static CreateDatastoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDatastoreResponse.class);
  }

  /**
   * Convert an instance of CreateDatastoreResponse to an JSON string
   *
   * @return JSON string
   */
