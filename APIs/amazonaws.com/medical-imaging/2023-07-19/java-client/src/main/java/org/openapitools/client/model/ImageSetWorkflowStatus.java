...
/**
 * Gets or Sets ImageSetWorkflowStatus
 */
@JsonAdapter(ImageSetWorkflowStatus.Adapter.class)
public enum ImageSetWorkflowStatus {
  ...
  ImageSetWorkflowStatus(String value) {
    this.value = value;
  }
  ...
  public static ImageSetWorkflowStatus fromValue(String value) {
    for (ImageSetWorkflowStatus b : ImageSetWorkflowStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ImageSetWorkflowStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ImageSetWorkflowStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ImageSetWorkflowStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ImageSetWorkflowStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ImageSetWorkflowStatus.fromValue(value);
  }
}
