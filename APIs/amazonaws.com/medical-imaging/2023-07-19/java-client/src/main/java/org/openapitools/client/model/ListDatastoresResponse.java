...
public class ListDatastoresResponse {
  public static final String SERIALIZED_NAME_DATASTORE_SUMMARIES = "datastoreSummaries";
  @SerializedName(SERIALIZED_NAME_DATASTORE_SUMMARIES)
  private List datastoreSummaries;
  ...
  public ListDatastoresResponse datastoreSummaries(List datastoreSummaries) {
    this.datastoreSummaries = datastoreSummaries;
    return this;
  }

  /**
   * Get datastoreSummaries
   * @return datastoreSummaries
   */
  @javax.annotation.Nullable
  public List getDatastoreSummaries() {
    return datastoreSummaries;
  }

  public void setDatastoreSummaries(List datastoreSummaries) {
    this.datastoreSummaries = datastoreSummaries;
  }


  public ListDatastoresResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datastoreSummaries, listDatastoresResponse.datastoreSummaries) &&
        Objects.equals(this.nextToken, listDatastoresResponse.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datastoreSummaries, nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    datastoreSummaries: ").append(toIndentedString(datastoreSummaries)).append("\n");
  ...
  static {
    ...
    openapiFields.add("datastoreSummaries");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDatastoresResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDatastoresResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDatastoresResponse is not found in the empty JSON string", ListDatastoresResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDatastoresResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDatastoresResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `datastoreSummaries`
      if (jsonObj.get("datastoreSummaries") != null && !jsonObj.get("datastoreSummaries").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("datastoreSummaries"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDatastoresResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDatastoresResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDatastoresResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDatastoresResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDatastoresResponse>() {
           @Override
           public void write(JsonWriter out, ListDatastoresResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDatastoresResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDatastoresResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDatastoresResponse
   * @throws IOException if the JSON string is invalid with respect to ListDatastoresResponse
   */
  public static ListDatastoresResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDatastoresResponse.class);
  }

  /**
   * Convert an instance of ListDatastoresResponse to an JSON string
   *
   * @return JSON string
   */
