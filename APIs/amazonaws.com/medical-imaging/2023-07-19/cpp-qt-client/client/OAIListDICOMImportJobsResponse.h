...
/*
 * OAIListDICOMImportJobsResponse.h
 *
 * 
 */

#ifndef OAIListDICOMImportJobsResponse_H
#define OAIListDICOMImportJobsResponse_H
...
class OAIListDICOMImportJobsResponse : public OAIObject {
public:
    OAIListDICOMImportJobsResponse();
    OAIListDICOMImportJobsResponse(QString json);
    ~OAIListDICOMImportJobsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDICOMImportJobsResponse)

#endif // OAIListDICOMImportJobsResponse_H
