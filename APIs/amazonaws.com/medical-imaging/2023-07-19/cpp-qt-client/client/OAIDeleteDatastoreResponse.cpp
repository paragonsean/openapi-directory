...
OAIDeleteDatastoreResponse::OAIDeleteDatastoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteDatastoreResponse::OAIDeleteDatastoreResponse() {
    this->initializeModel();
}

OAIDeleteDatastoreResponse::~OAIDeleteDatastoreResponse() {}

void OAIDeleteDatastoreResponse::initializeModel() {
...
void OAIDeleteDatastoreResponse::fromJson(QString jsonString) {
...
void OAIDeleteDatastoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteDatastoreResponse::asJson() const {
...
QJsonObject OAIDeleteDatastoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteDatastoreResponse::getDatastoreId() const {
    return m_datastore_id;
}
void OAIDeleteDatastoreResponse::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIDeleteDatastoreResponse::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIDeleteDatastoreResponse::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

OAIDatastoreStatus OAIDeleteDatastoreResponse::getDatastoreStatus() const {
    return m_datastore_status;
}
void OAIDeleteDatastoreResponse::setDatastoreStatus(const OAIDatastoreStatus &datastore_status) {
    m_datastore_status = datastore_status;
    m_datastore_status_isSet = true;
}

bool OAIDeleteDatastoreResponse::is_datastore_status_Set() const{
    return m_datastore_status_isSet;
}

bool OAIDeleteDatastoreResponse::is_datastore_status_Valid() const{
    return m_datastore_status_isValid;
}

bool OAIDeleteDatastoreResponse::isSet() const {
...
bool OAIDeleteDatastoreResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_datastore_id_isValid && m_datastore_status_isValid && true;
}
