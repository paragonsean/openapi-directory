...
#include "OAISearchImageSets_request_searchCriteria.h"
...
OAISearchImageSets_request_searchCriteria::OAISearchImageSets_request_searchCriteria(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchImageSets_request_searchCriteria::OAISearchImageSets_request_searchCriteria() {
    this->initializeModel();
}

OAISearchImageSets_request_searchCriteria::~OAISearchImageSets_request_searchCriteria() {}

void OAISearchImageSets_request_searchCriteria::initializeModel() {

    m_filters_isSet = false;
    m_filters_isValid = false;
}

void OAISearchImageSets_request_searchCriteria::fromJson(QString jsonString) {
...
void OAISearchImageSets_request_searchCriteria::fromJsonObject(QJsonObject json) {

    m_filters_isValid = ::OpenAPI::fromJsonValue(m_filters, json[QString("filters")]);
    m_filters_isSet = !json[QString("filters")].isNull() && m_filters_isValid;
}

QString OAISearchImageSets_request_searchCriteria::asJson() const {
...
QJsonObject OAISearchImageSets_request_searchCriteria::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAISearchImageSets_request_searchCriteria::getFilters() const {
    return m_filters;
}
void OAISearchImageSets_request_searchCriteria::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAISearchImageSets_request_searchCriteria::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAISearchImageSets_request_searchCriteria::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAISearchImageSets_request_searchCriteria::isSet() const {
...
bool OAISearchImageSets_request_searchCriteria::isValid() const {
