...
/*
 * OAICopyDestinationImageSet.h
 *
 * Copy the destination image set.
 */

#ifndef OAICopyDestinationImageSet_H
#define OAICopyDestinationImageSet_H
...
class OAICopyDestinationImageSet : public OAIObject {
public:
    OAICopyDestinationImageSet();
    OAICopyDestinationImageSet(QString json);
    ~OAICopyDestinationImageSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyDestinationImageSet)

#endif // OAICopyDestinationImageSet_H
