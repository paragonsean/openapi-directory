...
/*
 * OAIGetDatastoreResponse_datastoreProperties.h
 *
 * 
 */

#ifndef OAIGetDatastoreResponse_datastoreProperties_H
#define OAIGetDatastoreResponse_datastoreProperties_H
...
class OAIGetDatastoreResponse_datastoreProperties : public OAIObject {
public:
    OAIGetDatastoreResponse_datastoreProperties();
    OAIGetDatastoreResponse_datastoreProperties(QString json);
    ~OAIGetDatastoreResponse_datastoreProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDatastoreResponse_datastoreProperties)

#endif // OAIGetDatastoreResponse_datastoreProperties_H
