...
/*
 * OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates.h
 *
 * 
 */

#ifndef OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates_H
#define OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates_H
...
class OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates : public OAIObject {
public:
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates();
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates(QString json);
    ~OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates() override;
    ...
    QString getRemovableAttributes() const;
    void setRemovableAttributes(const QString &removable_attributes);
    bool is_removable_attributes_Set() const;
    bool is_removable_attributes_Valid() const;

    QString getUpdatableAttributes() const;
    void setUpdatableAttributes(const QString &updatable_attributes);
    bool is_updatable_attributes_Set() const;
    bool is_updatable_attributes_Valid() const;
...
private:
    ...
    QString m_removable_attributes;
    bool m_removable_attributes_isSet;
    bool m_removable_attributes_isValid;

    QString m_updatable_attributes;
    bool m_updatable_attributes_isSet;
    bool m_updatable_attributes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates)

#endif // OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates_H
