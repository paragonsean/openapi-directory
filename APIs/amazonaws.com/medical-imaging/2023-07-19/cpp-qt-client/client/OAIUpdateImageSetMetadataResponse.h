...
/*
 * OAIUpdateImageSetMetadataResponse.h
 *
 * 
 */

#ifndef OAIUpdateImageSetMetadataResponse_H
#define OAIUpdateImageSetMetadataResponse_H
...
class OAIUpdateImageSetMetadataResponse : public OAIObject {
public:
    OAIUpdateImageSetMetadataResponse();
    OAIUpdateImageSetMetadataResponse(QString json);
    ~OAIUpdateImageSetMetadataResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadataResponse)

#endif // OAIUpdateImageSetMetadataResponse_H
