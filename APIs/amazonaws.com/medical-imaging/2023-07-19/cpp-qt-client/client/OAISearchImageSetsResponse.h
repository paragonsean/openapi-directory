...
/*
 * OAISearchImageSetsResponse.h
 *
 * 
 */

#ifndef OAISearchImageSetsResponse_H
#define OAISearchImageSetsResponse_H
...
class OAISearchImageSetsResponse : public OAIObject {
public:
    OAISearchImageSetsResponse();
    OAISearchImageSetsResponse(QString json);
    ~OAISearchImageSetsResponse() override;
    ...
    QList getImageSetsMetadataSummaries() const;
    void setImageSetsMetadataSummaries(const QList &image_sets_metadata_summaries);
    bool is_image_sets_metadata_summaries_Set() const;
    bool is_image_sets_metadata_summaries_Valid() const;
...
private:
    ...
    QList m_image_sets_metadata_summaries;
    bool m_image_sets_metadata_summaries_isSet;
    bool m_image_sets_metadata_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchImageSetsResponse)

#endif // OAISearchImageSetsResponse_H
