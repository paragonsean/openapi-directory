...
OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates() {
    this->initializeModel();
}

OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::~OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates() {}

void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::initializeModel() {
...
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::fromJson(QString jsonString) {
...
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::asJson() const {
...
QJsonObject OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::getRemovableAttributes() const {
    return m_removable_attributes;
}
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::setRemovableAttributes(const QString &removable_attributes) {
    m_removable_attributes = removable_attributes;
    m_removable_attributes_isSet = true;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::is_removable_attributes_Set() const{
    return m_removable_attributes_isSet;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::is_removable_attributes_Valid() const{
    return m_removable_attributes_isValid;
}

QString OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::getUpdatableAttributes() const {
    return m_updatable_attributes;
}
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::setUpdatableAttributes(const QString &updatable_attributes) {
    m_updatable_attributes = updatable_attributes;
    m_updatable_attributes_isSet = true;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::is_updatable_attributes_Set() const{
    return m_updatable_attributes_isSet;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::is_updatable_attributes_Valid() const{
    return m_updatable_attributes_isValid;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::isSet() const {
...
bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates::isValid() const {
