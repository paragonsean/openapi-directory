...
/*
 * OAIImageFrameInformation.h
 *
 * Information about the image frame (pixel data) identifier.
 */

#ifndef OAIImageFrameInformation_H
#define OAIImageFrameInformation_H
...
class OAIImageFrameInformation : public OAIObject {
public:
    OAIImageFrameInformation();
    OAIImageFrameInformation(QString json);
    ~OAIImageFrameInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageFrameInformation)

#endif // OAIImageFrameInformation_H
