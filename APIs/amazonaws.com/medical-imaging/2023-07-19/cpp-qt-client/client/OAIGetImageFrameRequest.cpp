...
#include "OAIGetImageFrameRequest.h"
...
OAIGetImageFrameRequest::OAIGetImageFrameRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageFrameRequest::OAIGetImageFrameRequest() {
    this->initializeModel();
}

OAIGetImageFrameRequest::~OAIGetImageFrameRequest() {}

void OAIGetImageFrameRequest::initializeModel() {

    m_image_frame_information_isSet = false;
    m_image_frame_information_isValid = false;
}

void OAIGetImageFrameRequest::fromJson(QString jsonString) {
...
void OAIGetImageFrameRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetImageFrameRequest::asJson() const {
...
QJsonObject OAIGetImageFrameRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIGetImageFrameRequest_imageFrameInformation OAIGetImageFrameRequest::getImageFrameInformation() const {
    return m_image_frame_information;
}
void OAIGetImageFrameRequest::setImageFrameInformation(const OAIGetImageFrameRequest_imageFrameInformation &image_frame_information) {
    m_image_frame_information = image_frame_information;
    m_image_frame_information_isSet = true;
}

bool OAIGetImageFrameRequest::is_image_frame_information_Set() const{
    return m_image_frame_information_isSet;
}

bool OAIGetImageFrameRequest::is_image_frame_information_Valid() const{
    return m_image_frame_information_isValid;
}

bool OAIGetImageFrameRequest::isSet() const {
...
bool OAIGetImageFrameRequest::isValid() const {
