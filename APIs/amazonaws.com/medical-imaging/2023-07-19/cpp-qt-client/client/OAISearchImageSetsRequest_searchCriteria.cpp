...
OAISearchImageSetsRequest_searchCriteria::OAISearchImageSetsRequest_searchCriteria(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchImageSetsRequest_searchCriteria::OAISearchImageSetsRequest_searchCriteria() {
    this->initializeModel();
}

OAISearchImageSetsRequest_searchCriteria::~OAISearchImageSetsRequest_searchCriteria() {}

void OAISearchImageSetsRequest_searchCriteria::initializeModel() {

    m_filters_isSet = false;
    m_filters_isValid = false;
}

void OAISearchImageSetsRequest_searchCriteria::fromJson(QString jsonString) {
...
void OAISearchImageSetsRequest_searchCriteria::fromJsonObject(QJsonObject json) {

    m_filters_isValid = ::OpenAPI::fromJsonValue(m_filters, json[QString("filters")]);
    m_filters_isSet = !json[QString("filters")].isNull() && m_filters_isValid;
}

QString OAISearchImageSetsRequest_searchCriteria::asJson() const {
...
QJsonObject OAISearchImageSetsRequest_searchCriteria::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
QList OAISearchImageSetsRequest_searchCriteria::getFilters() const {
    return m_filters;
}
void OAISearchImageSetsRequest_searchCriteria::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAISearchImageSetsRequest_searchCriteria::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAISearchImageSetsRequest_searchCriteria::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAISearchImageSetsRequest_searchCriteria::isSet() const {
...
bool OAISearchImageSetsRequest_searchCriteria::isValid() const {
