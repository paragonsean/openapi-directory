...
OAIGetImageFrameRequest_imageFrameInformation::OAIGetImageFrameRequest_imageFrameInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageFrameRequest_imageFrameInformation::OAIGetImageFrameRequest_imageFrameInformation() {
    this->initializeModel();
}

OAIGetImageFrameRequest_imageFrameInformation::~OAIGetImageFrameRequest_imageFrameInformation() {}

void OAIGetImageFrameRequest_imageFrameInformation::initializeModel() {

    m_image_frame_id_isSet = false;
    m_image_frame_id_isValid = false;
}

void OAIGetImageFrameRequest_imageFrameInformation::fromJson(QString jsonString) {
...
void OAIGetImageFrameRequest_imageFrameInformation::fromJsonObject(QJsonObject json) {

    m_image_frame_id_isValid = ::OpenAPI::fromJsonValue(m_image_frame_id, json[QString("imageFrameId")]);
    m_image_frame_id_isSet = !json[QString("imageFrameId")].isNull() && m_image_frame_id_isValid;
}

QString OAIGetImageFrameRequest_imageFrameInformation::asJson() const {
...
QJsonObject OAIGetImageFrameRequest_imageFrameInformation::asJsonObject() const {
    QJsonObject obj;
    if (m_image_frame_id_isSet) {
        obj.insert(QString("imageFrameId"), ::OpenAPI::toJsonValue(m_image_frame_id));
    }
    return obj;
}

QString OAIGetImageFrameRequest_imageFrameInformation::getImageFrameId() const {
    return m_image_frame_id;
}
void OAIGetImageFrameRequest_imageFrameInformation::setImageFrameId(const QString &image_frame_id) {
    m_image_frame_id = image_frame_id;
    m_image_frame_id_isSet = true;
}

bool OAIGetImageFrameRequest_imageFrameInformation::is_image_frame_id_Set() const{
    return m_image_frame_id_isSet;
}

bool OAIGetImageFrameRequest_imageFrameInformation::is_image_frame_id_Valid() const{
    return m_image_frame_id_isValid;
}

bool OAIGetImageFrameRequest_imageFrameInformation::isSet() const {
...
bool OAIGetImageFrameRequest_imageFrameInformation::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_frame_id_isValid && true;
}
