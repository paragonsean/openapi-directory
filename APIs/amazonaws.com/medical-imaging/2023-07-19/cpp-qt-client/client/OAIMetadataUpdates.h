...
/*
 * OAIMetadataUpdates.h
 *
 * Contains DICOMUpdates.
 */

#ifndef OAIMetadataUpdates_H
#define OAIMetadataUpdates_H
...
class OAIMetadataUpdates : public OAIObject {
public:
    OAIMetadataUpdates();
    OAIMetadataUpdates(QString json);
    ~OAIMetadataUpdates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetadataUpdates)

#endif // OAIMetadataUpdates_H
