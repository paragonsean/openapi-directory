...
/*
 * OAIDatastoreSummary.h
 *
 * List of summaries of data stores.
 */

#ifndef OAIDatastoreSummary_H
#define OAIDatastoreSummary_H
...
class OAIDatastoreSummary : public OAIObject {
public:
    OAIDatastoreSummary();
    OAIDatastoreSummary(QString json);
    ~OAIDatastoreSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatastoreSummary)

#endif // OAIDatastoreSummary_H
