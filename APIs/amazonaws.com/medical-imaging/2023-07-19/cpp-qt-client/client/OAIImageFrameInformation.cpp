...
#include "OAIImageFrameInformation.h"
...
OAIImageFrameInformation::OAIImageFrameInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImageFrameInformation::OAIImageFrameInformation() {
    this->initializeModel();
}

OAIImageFrameInformation::~OAIImageFrameInformation() {}

void OAIImageFrameInformation::initializeModel() {

    m_image_frame_id_isSet = false;
    m_image_frame_id_isValid = false;
}

void OAIImageFrameInformation::fromJson(QString jsonString) {
...
void OAIImageFrameInformation::fromJsonObject(QJsonObject json) {
...
QString OAIImageFrameInformation::asJson() const {
...
QJsonObject OAIImageFrameInformation::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImageFrameInformation::getImageFrameId() const {
    return m_image_frame_id;
}
void OAIImageFrameInformation::setImageFrameId(const QString &image_frame_id) {
    m_image_frame_id = image_frame_id;
    m_image_frame_id_isSet = true;
}

bool OAIImageFrameInformation::is_image_frame_id_Set() const{
    return m_image_frame_id_isSet;
}

bool OAIImageFrameInformation::is_image_frame_id_Valid() const{
    return m_image_frame_id_isValid;
}

bool OAIImageFrameInformation::isSet() const {
...
bool OAIImageFrameInformation::isValid() const {
