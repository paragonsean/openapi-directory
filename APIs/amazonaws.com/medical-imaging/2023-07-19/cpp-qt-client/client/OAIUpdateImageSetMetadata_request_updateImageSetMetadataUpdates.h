...
/*
 * OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates.h
 *
 * Contains DICOMUpdates.
 */

#ifndef OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_H
#define OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_H
...
class OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates : public OAIObject {
public:
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates();
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates(QString json);
    ~OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates)

#endif // OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_H
