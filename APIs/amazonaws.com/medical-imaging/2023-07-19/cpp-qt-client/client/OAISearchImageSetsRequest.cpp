...
#include "OAISearchImageSetsRequest.h"
...
OAISearchImageSetsRequest::OAISearchImageSetsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchImageSetsRequest::OAISearchImageSetsRequest() {
    this->initializeModel();
}

OAISearchImageSetsRequest::~OAISearchImageSetsRequest() {}

void OAISearchImageSetsRequest::initializeModel() {

    m_search_criteria_isSet = false;
    m_search_criteria_isValid = false;
}

void OAISearchImageSetsRequest::fromJson(QString jsonString) {
...
void OAISearchImageSetsRequest::fromJsonObject(QJsonObject json) {
...
QString OAISearchImageSetsRequest::asJson() const {
...
QJsonObject OAISearchImageSetsRequest::asJsonObject() const {
    QJsonObject obj;
...
OAISearchImageSetsRequest_searchCriteria OAISearchImageSetsRequest::getSearchCriteria() const {
    return m_search_criteria;
}
void OAISearchImageSetsRequest::setSearchCriteria(const OAISearchImageSetsRequest_searchCriteria &search_criteria) {
    m_search_criteria = search_criteria;
    m_search_criteria_isSet = true;
}

bool OAISearchImageSetsRequest::is_search_criteria_Set() const{
    return m_search_criteria_isSet;
}

bool OAISearchImageSetsRequest::is_search_criteria_Valid() const{
    return m_search_criteria_isValid;
}

bool OAISearchImageSetsRequest::isSet() const {
...
bool OAISearchImageSetsRequest::isValid() const {
