...
OAIGetDatastoreResponse::OAIGetDatastoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDatastoreResponse::OAIGetDatastoreResponse() {
    this->initializeModel();
}

OAIGetDatastoreResponse::~OAIGetDatastoreResponse() {}

void OAIGetDatastoreResponse::initializeModel() {

    m_datastore_properties_isSet = false;
    m_datastore_properties_isValid = false;
}

void OAIGetDatastoreResponse::fromJson(QString jsonString) {
...
void OAIGetDatastoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetDatastoreResponse::asJson() const {
...
QJsonObject OAIGetDatastoreResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetDatastoreResponse_datastoreProperties OAIGetDatastoreResponse::getDatastoreProperties() const {
    return m_datastore_properties;
}
void OAIGetDatastoreResponse::setDatastoreProperties(const OAIGetDatastoreResponse_datastoreProperties &datastore_properties) {
    m_datastore_properties = datastore_properties;
    m_datastore_properties_isSet = true;
}

bool OAIGetDatastoreResponse::is_datastore_properties_Set() const{
    return m_datastore_properties_isSet;
}

bool OAIGetDatastoreResponse::is_datastore_properties_Valid() const{
    return m_datastore_properties_isValid;
}

bool OAIGetDatastoreResponse::isSet() const {
...
bool OAIGetDatastoreResponse::isValid() const {
