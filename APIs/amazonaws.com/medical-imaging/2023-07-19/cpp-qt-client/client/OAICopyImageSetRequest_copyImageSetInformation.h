...
/*
 * OAICopyImageSetRequest_copyImageSetInformation.h
 *
 * 
 */

#ifndef OAICopyImageSetRequest_copyImageSetInformation_H
#define OAICopyImageSetRequest_copyImageSetInformation_H
...
class OAICopyImageSetRequest_copyImageSetInformation : public OAIObject {
public:
    OAICopyImageSetRequest_copyImageSetInformation();
    OAICopyImageSetRequest_copyImageSetInformation(QString json);
    ~OAICopyImageSetRequest_copyImageSetInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetRequest_copyImageSetInformation)

#endif // OAICopyImageSetRequest_copyImageSetInformation_H
