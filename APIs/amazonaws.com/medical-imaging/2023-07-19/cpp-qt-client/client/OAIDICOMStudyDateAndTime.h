...
/*
 * OAIDICOMStudyDateAndTime.h
 *
 * The aggregated structure to store DICOM study date and study time for search capabilities.
 */

#ifndef OAIDICOMStudyDateAndTime_H
#define OAIDICOMStudyDateAndTime_H
...
class OAIDICOMStudyDateAndTime : public OAIObject {
public:
    OAIDICOMStudyDateAndTime();
    OAIDICOMStudyDateAndTime(QString json);
    ~OAIDICOMStudyDateAndTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDICOMStudyDateAndTime)

#endif // OAIDICOMStudyDateAndTime_H
