...
OAISearchImageSets_request::OAISearchImageSets_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchImageSets_request::OAISearchImageSets_request() {
    this->initializeModel();
}

OAISearchImageSets_request::~OAISearchImageSets_request() {}

void OAISearchImageSets_request::initializeModel() {

    m_search_criteria_isSet = false;
    m_search_criteria_isValid = false;
}

void OAISearchImageSets_request::fromJson(QString jsonString) {
...
void OAISearchImageSets_request::fromJsonObject(QJsonObject json) {
...
QString OAISearchImageSets_request::asJson() const {
...
QJsonObject OAISearchImageSets_request::asJsonObject() const {
    QJsonObject obj;
...
OAISearchImageSets_request_searchCriteria OAISearchImageSets_request::getSearchCriteria() const {
    return m_search_criteria;
}
void OAISearchImageSets_request::setSearchCriteria(const OAISearchImageSets_request_searchCriteria &search_criteria) {
    m_search_criteria = search_criteria;
    m_search_criteria_isSet = true;
}

bool OAISearchImageSets_request::is_search_criteria_Set() const{
    return m_search_criteria_isSet;
}

bool OAISearchImageSets_request::is_search_criteria_Valid() const{
    return m_search_criteria_isValid;
}

bool OAISearchImageSets_request::isSet() const {
...
bool OAISearchImageSets_request::isValid() const {
