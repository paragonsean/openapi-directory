...
OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::OAICopyImageSet_request_copyImageSetInformation_destinationImageSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::OAICopyImageSet_request_copyImageSetInformation_destinationImageSet() {
    this->initializeModel();
}

OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::~OAICopyImageSet_request_copyImageSetInformation_destinationImageSet() {}

void OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::initializeModel() {
...
void OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::fromJson(QString jsonString) {
...
void OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::fromJsonObject(QJsonObject json) {
...
QString OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::asJson() const {
...
QJsonObject OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::getImageSetId() const {
    return m_image_set_id;
}
void OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::setImageSetId(const QString &image_set_id) {
    m_image_set_id = image_set_id;
    m_image_set_id_isSet = true;
}

bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::is_image_set_id_Set() const{
    return m_image_set_id_isSet;
}

bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::is_image_set_id_Valid() const{
    return m_image_set_id_isValid;
}

QString OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::getLatestVersionId() const {
    return m_latest_version_id;
}
void OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::setLatestVersionId(const QString &latest_version_id) {
    m_latest_version_id = latest_version_id;
    m_latest_version_id_isSet = true;
}

bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::is_latest_version_id_Set() const{
    return m_latest_version_id_isSet;
}

bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::is_latest_version_id_Valid() const{
    return m_latest_version_id_isValid;
}

bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::isSet() const {
...
bool OAICopyImageSet_request_copyImageSetInformation_destinationImageSet::isValid() const {
