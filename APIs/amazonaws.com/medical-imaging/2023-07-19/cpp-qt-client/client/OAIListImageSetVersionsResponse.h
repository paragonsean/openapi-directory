...
/*
 * OAIListImageSetVersionsResponse.h
 *
 * 
 */

#ifndef OAIListImageSetVersionsResponse_H
#define OAIListImageSetVersionsResponse_H
...
class OAIListImageSetVersionsResponse : public OAIObject {
public:
    OAIListImageSetVersionsResponse();
    OAIListImageSetVersionsResponse(QString json);
    ~OAIListImageSetVersionsResponse() override;
    ...
    QList getImageSetPropertiesList() const;
    void setImageSetPropertiesList(const QList &image_set_properties_list);
    bool is_image_set_properties_list_Set() const;
    bool is_image_set_properties_list_Valid() const;
...
private:
    ...
    QList m_image_set_properties_list;
    bool m_image_set_properties_list_isSet;
    bool m_image_set_properties_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListImageSetVersionsResponse)

#endif // OAIListImageSetVersionsResponse_H
