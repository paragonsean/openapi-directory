...
/*
 * OAIImageSetsMetadataSummary.h
 *
 * Summary of the image set metadata.
 */

#ifndef OAIImageSetsMetadataSummary_H
#define OAIImageSetsMetadataSummary_H
...
namespace OpenAPI {
class OAIImageSetsMetadataSummary_DICOMTags;

class OAIImageSetsMetadataSummary : public OAIObject {
public:
    OAIImageSetsMetadataSummary();
    OAIImageSetsMetadataSummary(QString json);
    ~OAIImageSetsMetadataSummary() override;
    ...
    OAIImageSetsMetadataSummary_DICOMTags getDicomTags() const;
    void setDicomTags(const OAIImageSetsMetadataSummary_DICOMTags &dicom_tags);
    bool is_dicom_tags_Set() const;
    bool is_dicom_tags_Valid() const;
...
private:
    ...
    OAIImageSetsMetadataSummary_DICOMTags m_dicom_tags;
    bool m_dicom_tags_isSet;
    bool m_dicom_tags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIImageSetsMetadataSummary)

#endif // OAIImageSetsMetadataSummary_H
