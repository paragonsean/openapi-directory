...
OAISearchImageSetsResponse::OAISearchImageSetsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchImageSetsResponse::OAISearchImageSetsResponse() {
    this->initializeModel();
}

OAISearchImageSetsResponse::~OAISearchImageSetsResponse() {}

void OAISearchImageSetsResponse::initializeModel() {

    m_image_sets_metadata_summaries_isSet = false;
    m_image_sets_metadata_summaries_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAISearchImageSetsResponse::fromJson(QString jsonString) {
...
void OAISearchImageSetsResponse::fromJsonObject(QJsonObject json) {

    m_image_sets_metadata_summaries_isValid = ::OpenAPI::fromJsonValue(m_image_sets_metadata_summaries, json[QString("imageSetsMetadataSummaries")]);
    m_image_sets_metadata_summaries_isSet = !json[QString("imageSetsMetadataSummaries")].isNull() && m_image_sets_metadata_summaries_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAISearchImageSetsResponse::asJson() const {
...
QJsonObject OAISearchImageSetsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_image_sets_metadata_summaries.isSet()) {
        obj.insert(QString("imageSetsMetadataSummaries"), ::OpenAPI::toJsonValue(m_image_sets_metadata_summaries));
    }
...
QList OAISearchImageSetsResponse::getImageSetsMetadataSummaries() const {
    return m_image_sets_metadata_summaries;
}
void OAISearchImageSetsResponse::setImageSetsMetadataSummaries(const QList &image_sets_metadata_summaries) {
    m_image_sets_metadata_summaries = image_sets_metadata_summaries;
    m_image_sets_metadata_summaries_isSet = true;
}

bool OAISearchImageSetsResponse::is_image_sets_metadata_summaries_Set() const{
    return m_image_sets_metadata_summaries_isSet;
}

bool OAISearchImageSetsResponse::is_image_sets_metadata_summaries_Valid() const{
    return m_image_sets_metadata_summaries_isValid;
}

QString OAISearchImageSetsResponse::getNextToken() const {
    return m_next_token;
}
void OAISearchImageSetsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAISearchImageSetsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAISearchImageSetsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAISearchImageSetsResponse::isSet() const {
...
bool OAISearchImageSetsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_sets_metadata_summaries_isValid && true;
}
