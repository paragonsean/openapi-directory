...
/*
 * OAIGetImageSetMetadataResponse.h
 *
 * 
 */

#ifndef OAIGetImageSetMetadataResponse_H
#define OAIGetImageSetMetadataResponse_H
...
class OAIGetImageSetMetadataResponse : public OAIObject {
public:
    OAIGetImageSetMetadataResponse();
    OAIGetImageSetMetadataResponse(QString json);
    ~OAIGetImageSetMetadataResponse() override;
    ...
    QString getImageSetMetadataBlob() const;
    void setImageSetMetadataBlob(const QString &image_set_metadata_blob);
    bool is_image_set_metadata_blob_Set() const;
    bool is_image_set_metadata_blob_Valid() const;
...
private:
    ...
    QString m_image_set_metadata_blob;
    bool m_image_set_metadata_blob_isSet;
    bool m_image_set_metadata_blob_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetImageSetMetadataResponse)

#endif // OAIGetImageSetMetadataResponse_H
