...
/*
 * OAIGetDICOMImportJobResponse_jobProperties.h
 *
 * 
 */

#ifndef OAIGetDICOMImportJobResponse_jobProperties_H
#define OAIGetDICOMImportJobResponse_jobProperties_H
...
class OAIGetDICOMImportJobResponse_jobProperties : public OAIObject {
public:
    OAIGetDICOMImportJobResponse_jobProperties();
    OAIGetDICOMImportJobResponse_jobProperties(QString json);
    ~OAIGetDICOMImportJobResponse_jobProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDICOMImportJobResponse_jobProperties)

#endif // OAIGetDICOMImportJobResponse_jobProperties_H
