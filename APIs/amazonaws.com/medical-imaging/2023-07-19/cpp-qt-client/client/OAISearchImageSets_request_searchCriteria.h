...
/*
 * OAISearchImageSets_request_searchCriteria.h
 *
 * The search criteria.
 */

#ifndef OAISearchImageSets_request_searchCriteria_H
#define OAISearchImageSets_request_searchCriteria_H
...
class OAISearchImageSets_request_searchCriteria : public OAIObject {
public:
    OAISearchImageSets_request_searchCriteria();
    OAISearchImageSets_request_searchCriteria(QString json);
    ~OAISearchImageSets_request_searchCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchImageSets_request_searchCriteria)

#endif // OAISearchImageSets_request_searchCriteria_H
