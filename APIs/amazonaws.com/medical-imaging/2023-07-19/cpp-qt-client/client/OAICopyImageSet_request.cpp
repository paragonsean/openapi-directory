...
OAICopyImageSet_request::OAICopyImageSet_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSet_request::OAICopyImageSet_request() {
    this->initializeModel();
}

OAICopyImageSet_request::~OAICopyImageSet_request() {}

void OAICopyImageSet_request::initializeModel() {

    m_copy_image_set_information_isSet = false;
    m_copy_image_set_information_isValid = false;
}

void OAICopyImageSet_request::fromJson(QString jsonString) {
...
void OAICopyImageSet_request::fromJsonObject(QJsonObject json) {
...
QString OAICopyImageSet_request::asJson() const {
...
QJsonObject OAICopyImageSet_request::asJsonObject() const {
    QJsonObject obj;
...
OAICopyImageSet_request_copyImageSetInformation OAICopyImageSet_request::getCopyImageSetInformation() const {
    return m_copy_image_set_information;
}
void OAICopyImageSet_request::setCopyImageSetInformation(const OAICopyImageSet_request_copyImageSetInformation &copy_image_set_information) {
    m_copy_image_set_information = copy_image_set_information;
    m_copy_image_set_information_isSet = true;
}

bool OAICopyImageSet_request::is_copy_image_set_information_Set() const{
    return m_copy_image_set_information_isSet;
}

bool OAICopyImageSet_request::is_copy_image_set_information_Valid() const{
    return m_copy_image_set_information_isValid;
}

bool OAICopyImageSet_request::isSet() const {
...
bool OAICopyImageSet_request::isValid() const {
