...
/*
 * OAISearchImageSetsRequest_searchCriteria.h
 *
 * 
 */

#ifndef OAISearchImageSetsRequest_searchCriteria_H
#define OAISearchImageSetsRequest_searchCriteria_H
...
class OAISearchImageSetsRequest_searchCriteria : public OAIObject {
public:
    OAISearchImageSetsRequest_searchCriteria();
    OAISearchImageSetsRequest_searchCriteria(QString json);
    ~OAISearchImageSetsRequest_searchCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchImageSetsRequest_searchCriteria)

#endif // OAISearchImageSetsRequest_searchCriteria_H
