...
OAIDeleteImageSetResponse::OAIDeleteImageSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteImageSetResponse::OAIDeleteImageSetResponse() {
    this->initializeModel();
}

OAIDeleteImageSetResponse::~OAIDeleteImageSetResponse() {}

void OAIDeleteImageSetResponse::initializeModel() {
...
void OAIDeleteImageSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteImageSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteImageSetResponse::asJson() const {
...
QJsonObject OAIDeleteImageSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteImageSetResponse::getDatastoreId() const {
    return m_datastore_id;
}
void OAIDeleteImageSetResponse::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIDeleteImageSetResponse::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIDeleteImageSetResponse::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIDeleteImageSetResponse::getImageSetId() const {
    return m_image_set_id;
}
void OAIDeleteImageSetResponse::setImageSetId(const QString &image_set_id) {
    m_image_set_id = image_set_id;
    m_image_set_id_isSet = true;
}

bool OAIDeleteImageSetResponse::is_image_set_id_Set() const{
    return m_image_set_id_isSet;
}

bool OAIDeleteImageSetResponse::is_image_set_id_Valid() const{
    return m_image_set_id_isValid;
}

OAIImageSetState OAIDeleteImageSetResponse::getImageSetState() const {
    return m_image_set_state;
}
void OAIDeleteImageSetResponse::setImageSetState(const OAIImageSetState &image_set_state) {
    m_image_set_state = image_set_state;
    m_image_set_state_isSet = true;
}

bool OAIDeleteImageSetResponse::is_image_set_state_Set() const{
    return m_image_set_state_isSet;
}

bool OAIDeleteImageSetResponse::is_image_set_state_Valid() const{
    return m_image_set_state_isValid;
}

OAIImageSetWorkflowStatus OAIDeleteImageSetResponse::getImageSetWorkflowStatus() const {
    return m_image_set_workflow_status;
}
void OAIDeleteImageSetResponse::setImageSetWorkflowStatus(const OAIImageSetWorkflowStatus &image_set_workflow_status) {
    m_image_set_workflow_status = image_set_workflow_status;
    m_image_set_workflow_status_isSet = true;
}

bool OAIDeleteImageSetResponse::is_image_set_workflow_status_Set() const{
    return m_image_set_workflow_status_isSet;
}

bool OAIDeleteImageSetResponse::is_image_set_workflow_status_Valid() const{
    return m_image_set_workflow_status_isValid;
}

bool OAIDeleteImageSetResponse::isSet() const {
...
bool OAIDeleteImageSetResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_datastore_id_isValid && m_image_set_id_isValid && m_image_set_state_isValid && m_image_set_workflow_status_isValid && true;
}
