...
OAIListDatastoresResponse::OAIListDatastoresResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatastoresResponse::OAIListDatastoresResponse() {
    this->initializeModel();
}

OAIListDatastoresResponse::~OAIListDatastoresResponse() {}

void OAIListDatastoresResponse::initializeModel() {

    m_datastore_summaries_isSet = false;
    m_datastore_summaries_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListDatastoresResponse::fromJson(QString jsonString) {
...
void OAIListDatastoresResponse::fromJsonObject(QJsonObject json) {

    m_datastore_summaries_isValid = ::OpenAPI::fromJsonValue(m_datastore_summaries, json[QString("datastoreSummaries")]);
    m_datastore_summaries_isSet = !json[QString("datastoreSummaries")].isNull() && m_datastore_summaries_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListDatastoresResponse::asJson() const {
...
QJsonObject OAIListDatastoresResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_datastore_summaries.isSet()) {
        obj.insert(QString("datastoreSummaries"), ::OpenAPI::toJsonValue(m_datastore_summaries));
    }
...
QList OAIListDatastoresResponse::getDatastoreSummaries() const {
    return m_datastore_summaries;
}
void OAIListDatastoresResponse::setDatastoreSummaries(const QList &datastore_summaries) {
    m_datastore_summaries = datastore_summaries;
    m_datastore_summaries_isSet = true;
}

bool OAIListDatastoresResponse::is_datastore_summaries_Set() const{
    return m_datastore_summaries_isSet;
}

bool OAIListDatastoresResponse::is_datastore_summaries_Valid() const{
    return m_datastore_summaries_isValid;
}

QString OAIListDatastoresResponse::getNextToken() const {
    return m_next_token;
}
void OAIListDatastoresResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatastoresResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatastoresResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListDatastoresResponse::isSet() const {
...
bool OAIListDatastoresResponse::isValid() const {
