...
/*
 * OAIGetImageFrameRequest_imageFrameInformation.h
 *
 * 
 */

#ifndef OAIGetImageFrameRequest_imageFrameInformation_H
#define OAIGetImageFrameRequest_imageFrameInformation_H
...
class OAIGetImageFrameRequest_imageFrameInformation : public OAIObject {
public:
    OAIGetImageFrameRequest_imageFrameInformation();
    OAIGetImageFrameRequest_imageFrameInformation(QString json);
    ~OAIGetImageFrameRequest_imageFrameInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImageFrameRequest_imageFrameInformation)

#endif // OAIGetImageFrameRequest_imageFrameInformation_H
