...
OAIGetImageFrame_request_imageFrameInformation::OAIGetImageFrame_request_imageFrameInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageFrame_request_imageFrameInformation::OAIGetImageFrame_request_imageFrameInformation() {
    this->initializeModel();
}

OAIGetImageFrame_request_imageFrameInformation::~OAIGetImageFrame_request_imageFrameInformation() {}

void OAIGetImageFrame_request_imageFrameInformation::initializeModel() {

    m_image_frame_id_isSet = false;
    m_image_frame_id_isValid = false;
}

void OAIGetImageFrame_request_imageFrameInformation::fromJson(QString jsonString) {
...
void OAIGetImageFrame_request_imageFrameInformation::fromJsonObject(QJsonObject json) {
...
QString OAIGetImageFrame_request_imageFrameInformation::asJson() const {
...
QJsonObject OAIGetImageFrame_request_imageFrameInformation::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetImageFrame_request_imageFrameInformation::getImageFrameId() const {
    return m_image_frame_id;
}
void OAIGetImageFrame_request_imageFrameInformation::setImageFrameId(const QString &image_frame_id) {
    m_image_frame_id = image_frame_id;
    m_image_frame_id_isSet = true;
}

bool OAIGetImageFrame_request_imageFrameInformation::is_image_frame_id_Set() const{
    return m_image_frame_id_isSet;
}

bool OAIGetImageFrame_request_imageFrameInformation::is_image_frame_id_Valid() const{
    return m_image_frame_id_isValid;
}

bool OAIGetImageFrame_request_imageFrameInformation::isSet() const {
...
bool OAIGetImageFrame_request_imageFrameInformation::isValid() const {
