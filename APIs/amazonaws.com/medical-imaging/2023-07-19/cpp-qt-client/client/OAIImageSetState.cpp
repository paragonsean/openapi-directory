...
OAIImageSetState::OAIImageSetState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImageSetState::OAIImageSetState() {
    this->initializeModel();
}

OAIImageSetState::~OAIImageSetState() {}

void OAIImageSetState::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIImageSetState::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIImageSetState::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImageSetState::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOCKED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImageSetState::LOCKED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIImageSetState::DELETED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIImageSetState::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIImageSetState::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIImageSetState::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIImageSetState::LOCKED:
            val = "LOCKED";
            break;
        case eOAIImageSetState::DELETED:
            val = "DELETED";
            break;
        default:
            break;
...
QJsonValue OAIImageSetState::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIImageSetState::eOAIImageSetState OAIImageSetState::getValue() const {
    return m_value;
}

void OAIImageSetState::setValue(const OAIImageSetState::eOAIImageSetState& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIImageSetState::isSet() const {
    
    return m_value_isSet;
}

bool OAIImageSetState::isValid() const {
