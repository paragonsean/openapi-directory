...
#include "OAICopyImageSetRequest.h"
...
OAICopyImageSetRequest::OAICopyImageSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSetRequest::OAICopyImageSetRequest() {
    this->initializeModel();
}

OAICopyImageSetRequest::~OAICopyImageSetRequest() {}

void OAICopyImageSetRequest::initializeModel() {

    m_copy_image_set_information_isSet = false;
    m_copy_image_set_information_isValid = false;
}

void OAICopyImageSetRequest::fromJson(QString jsonString) {
...
void OAICopyImageSetRequest::fromJsonObject(QJsonObject json) {

    m_copy_image_set_information_isValid = ::OpenAPI::fromJsonValue(m_copy_image_set_information, json[QString("copyImageSetInformation")]);
    m_copy_image_set_information_isSet = !json[QString("copyImageSetInformation")].isNull() && m_copy_image_set_information_isValid;
}

QString OAICopyImageSetRequest::asJson() const {
...
QJsonObject OAICopyImageSetRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_copy_image_set_information.isSet()) {
        obj.insert(QString("copyImageSetInformation"), ::OpenAPI::toJsonValue(m_copy_image_set_information));
    }
    return obj;
}

OAICopyImageSetRequest_copyImageSetInformation OAICopyImageSetRequest::getCopyImageSetInformation() const {
    return m_copy_image_set_information;
}
void OAICopyImageSetRequest::setCopyImageSetInformation(const OAICopyImageSetRequest_copyImageSetInformation &copy_image_set_information) {
    m_copy_image_set_information = copy_image_set_information;
    m_copy_image_set_information_isSet = true;
}

bool OAICopyImageSetRequest::is_copy_image_set_information_Set() const{
    return m_copy_image_set_information_isSet;
}

bool OAICopyImageSetRequest::is_copy_image_set_information_Valid() const{
    return m_copy_image_set_information_isValid;
}

bool OAICopyImageSetRequest::isSet() const {
...
bool OAICopyImageSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_copy_image_set_information_isValid && true;
}
