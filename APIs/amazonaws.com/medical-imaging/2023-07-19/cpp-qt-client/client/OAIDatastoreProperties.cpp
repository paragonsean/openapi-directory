...
QString OAIDatastoreProperties::getDatastoreId() const {
    return m_datastore_id;
}
void OAIDatastoreProperties::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIDatastoreProperties::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIDatastoreProperties::getDatastoreName() const {
    return m_datastore_name;
}
void OAIDatastoreProperties::setDatastoreName(const QString &datastore_name) {
    m_datastore_name = datastore_name;
    m_datastore_name_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_name_Set() const{
    return m_datastore_name_isSet;
}

bool OAIDatastoreProperties::is_datastore_name_Valid() const{
    return m_datastore_name_isValid;
}

OAIDatastoreStatus OAIDatastoreProperties::getDatastoreStatus() const {
    return m_datastore_status;
}
void OAIDatastoreProperties::setDatastoreStatus(const OAIDatastoreStatus &datastore_status) {
    m_datastore_status = datastore_status;
    m_datastore_status_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_status_Set() const{
    return m_datastore_status_isSet;
}

bool OAIDatastoreProperties::is_datastore_status_Valid() const{
    return m_datastore_status_isValid;
}

QString OAIDatastoreProperties::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIDatastoreProperties::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIDatastoreProperties::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIDatastoreProperties::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

QString OAIDatastoreProperties::getDatastoreArn() const {
    return m_datastore_arn;
}
void OAIDatastoreProperties::setDatastoreArn(const QString &datastore_arn) {
    m_datastore_arn = datastore_arn;
    m_datastore_arn_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_arn_Set() const{
    return m_datastore_arn_isSet;
}

bool OAIDatastoreProperties::is_datastore_arn_Valid() const{
    return m_datastore_arn_isValid;
}

QDateTime OAIDatastoreProperties::getCreatedAt() const {
    return m_created_at;
}
void OAIDatastoreProperties::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDatastoreProperties::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDatastoreProperties::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIDatastoreProperties::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDatastoreProperties::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDatastoreProperties::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDatastoreProperties::is_updated_at_Valid() const{
