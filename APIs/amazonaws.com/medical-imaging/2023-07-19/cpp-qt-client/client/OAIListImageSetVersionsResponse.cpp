...
OAIListImageSetVersionsResponse::OAIListImageSetVersionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListImageSetVersionsResponse::OAIListImageSetVersionsResponse() {
    this->initializeModel();
}

OAIListImageSetVersionsResponse::~OAIListImageSetVersionsResponse() {}

void OAIListImageSetVersionsResponse::initializeModel() {

    m_image_set_properties_list_isSet = false;
    m_image_set_properties_list_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListImageSetVersionsResponse::fromJson(QString jsonString) {
...
void OAIListImageSetVersionsResponse::fromJsonObject(QJsonObject json) {

    m_image_set_properties_list_isValid = ::OpenAPI::fromJsonValue(m_image_set_properties_list, json[QString("imageSetPropertiesList")]);
    m_image_set_properties_list_isSet = !json[QString("imageSetPropertiesList")].isNull() && m_image_set_properties_list_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;
}

QString OAIListImageSetVersionsResponse::asJson() const {
...
QJsonObject OAIListImageSetVersionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_image_set_properties_list.isSet()) {
        obj.insert(QString("imageSetPropertiesList"), ::OpenAPI::toJsonValue(m_image_set_properties_list));
    }
...
QList OAIListImageSetVersionsResponse::getImageSetPropertiesList() const {
    return m_image_set_properties_list;
}
void OAIListImageSetVersionsResponse::setImageSetPropertiesList(const QList &image_set_properties_list) {
    m_image_set_properties_list = image_set_properties_list;
    m_image_set_properties_list_isSet = true;
}

bool OAIListImageSetVersionsResponse::is_image_set_properties_list_Set() const{
    return m_image_set_properties_list_isSet;
}

bool OAIListImageSetVersionsResponse::is_image_set_properties_list_Valid() const{
    return m_image_set_properties_list_isValid;
}

QString OAIListImageSetVersionsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListImageSetVersionsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListImageSetVersionsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListImageSetVersionsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListImageSetVersionsResponse::isSet() const {
...
bool OAIListImageSetVersionsResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_set_properties_list_isValid && true;
}
