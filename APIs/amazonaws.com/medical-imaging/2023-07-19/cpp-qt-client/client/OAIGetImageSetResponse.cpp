...
OAIGetImageSetResponse::OAIGetImageSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageSetResponse::OAIGetImageSetResponse() {
    this->initializeModel();
}

OAIGetImageSetResponse::~OAIGetImageSetResponse() {}

void OAIGetImageSetResponse::initializeModel() {
...
void OAIGetImageSetResponse::fromJson(QString jsonString) {
...
void OAIGetImageSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetImageSetResponse::asJson() const {
...
QJsonObject OAIGetImageSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetImageSetResponse::getDatastoreId() const {
    return m_datastore_id;
}
void OAIGetImageSetResponse::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIGetImageSetResponse::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIGetImageSetResponse::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIGetImageSetResponse::getImageSetId() const {
    return m_image_set_id;
}
void OAIGetImageSetResponse::setImageSetId(const QString &image_set_id) {
    m_image_set_id = image_set_id;
    m_image_set_id_isSet = true;
}

bool OAIGetImageSetResponse::is_image_set_id_Set() const{
    return m_image_set_id_isSet;
}

bool OAIGetImageSetResponse::is_image_set_id_Valid() const{
    return m_image_set_id_isValid;
}

QString OAIGetImageSetResponse::getVersionId() const {
    return m_version_id;
}
void OAIGetImageSetResponse::setVersionId(const QString &version_id) {
    m_version_id = version_id;
    m_version_id_isSet = true;
}

bool OAIGetImageSetResponse::is_version_id_Set() const{
    return m_version_id_isSet;
}

bool OAIGetImageSetResponse::is_version_id_Valid() const{
    return m_version_id_isValid;
}

OAIImageSetState OAIGetImageSetResponse::getImageSetState() const {
    return m_image_set_state;
}
void OAIGetImageSetResponse::setImageSetState(const OAIImageSetState &image_set_state) {
    m_image_set_state = image_set_state;
    m_image_set_state_isSet = true;
}

bool OAIGetImageSetResponse::is_image_set_state_Set() const{
    return m_image_set_state_isSet;
}

bool OAIGetImageSetResponse::is_image_set_state_Valid() const{
    return m_image_set_state_isValid;
}

OAIImageSetWorkflowStatus OAIGetImageSetResponse::getImageSetWorkflowStatus() const {
    return m_image_set_workflow_status;
}
void OAIGetImageSetResponse::setImageSetWorkflowStatus(const OAIImageSetWorkflowStatus &image_set_workflow_status) {
    m_image_set_workflow_status = image_set_workflow_status;
    m_image_set_workflow_status_isSet = true;
}

bool OAIGetImageSetResponse::is_image_set_workflow_status_Set() const{
    return m_image_set_workflow_status_isSet;
}

bool OAIGetImageSetResponse::is_image_set_workflow_status_Valid() const{
    return m_image_set_workflow_status_isValid;
}

QDateTime OAIGetImageSetResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIGetImageSetResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetImageSetResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetImageSetResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIGetImageSetResponse::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGetImageSetResponse::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGetImageSetResponse::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGetImageSetResponse::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QDateTime OAIGetImageSetResponse::getDeletedAt() const {
    return m_deleted_at;
}
void OAIGetImageSetResponse::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIGetImageSetResponse::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIGetImageSetResponse::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

QString OAIGetImageSetResponse::getMessage() const {
    return m_message;
}
void OAIGetImageSetResponse::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIGetImageSetResponse::is_message_Set() const{
    return m_message_isSet;
}

bool OAIGetImageSetResponse::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIGetImageSetResponse::getImageSetArn() const {
    return m_image_set_arn;
}
void OAIGetImageSetResponse::setImageSetArn(const QString &image_set_arn) {
    m_image_set_arn = image_set_arn;
    m_image_set_arn_isSet = true;
}

bool OAIGetImageSetResponse::is_image_set_arn_Set() const{
    return m_image_set_arn_isSet;
}

bool OAIGetImageSetResponse::is_image_set_arn_Valid() const{
    return m_image_set_arn_isValid;
}

bool OAIGetImageSetResponse::isSet() const {
...
bool OAIGetImageSetResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_datastore_id_isValid && m_image_set_id_isValid && m_version_id_isValid && m_image_set_state_isValid && true;
}
