...
/*
 * OAICopyImageSetResponse.h
 *
 * 
 */

#ifndef OAICopyImageSetResponse_H
#define OAICopyImageSetResponse_H
...
namespace OpenAPI {
class OAICopyImageSetResponse_sourceImageSetProperties;
class OAICopyImageSetResponse_destinationImageSetProperties;

class OAICopyImageSetResponse : public OAIObject {
public:
    OAICopyImageSetResponse();
    OAICopyImageSetResponse(QString json);
    ~OAICopyImageSetResponse() override;
    ...
    OAICopyImageSetResponse_sourceImageSetProperties getSourceImageSetProperties() const;
    void setSourceImageSetProperties(const OAICopyImageSetResponse_sourceImageSetProperties &source_image_set_properties);
    bool is_source_image_set_properties_Set() const;
    bool is_source_image_set_properties_Valid() const;

    OAICopyImageSetResponse_destinationImageSetProperties getDestinationImageSetProperties() const;
    void setDestinationImageSetProperties(const OAICopyImageSetResponse_destinationImageSetProperties &destination_image_set_properties);
    bool is_destination_image_set_properties_Set() const;
    bool is_destination_image_set_properties_Valid() const;
...
private:
    ...
    OAICopyImageSetResponse_sourceImageSetProperties m_source_image_set_properties;
    bool m_source_image_set_properties_isSet;
    bool m_source_image_set_properties_isValid;

    OAICopyImageSetResponse_destinationImageSetProperties m_destination_image_set_properties;
    bool m_destination_image_set_properties_isSet;
    bool m_destination_image_set_properties_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetResponse)

#endif // OAICopyImageSetResponse_H
