...
/*
 * OAICreateDatastore_request.h
 *
 * 
 */

#ifndef OAICreateDatastore_request_H
#define OAICreateDatastore_request_H
...
class OAICreateDatastore_request : public OAIObject {
public:
    OAICreateDatastore_request();
    OAICreateDatastore_request(QString json);
    ~OAICreateDatastore_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDatastore_request)

#endif // OAICreateDatastore_request_H
