...
#ifndef OAIDICOMTags_H
#define OAIDICOMTags_H
...
class OAIDICOMTags : public OAIObject {
public:
    OAIDICOMTags();
    OAIDICOMTags(QString json);
    ~OAIDICOMTags() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDICOMTags)

#endif // OAIDICOMTags_H
