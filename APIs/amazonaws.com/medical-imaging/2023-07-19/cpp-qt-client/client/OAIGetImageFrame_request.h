...
/*
 * OAIGetImageFrame_request.h
 *
 * 
 */

#ifndef OAIGetImageFrame_request_H
#define OAIGetImageFrame_request_H

#include <QJsonObject>

#include "OAIGetImageFrame_request_imageFrameInformation.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetImageFrame_request_imageFrameInformation;

class OAIGetImageFrame_request : public OAIObject {
public:
    OAIGetImageFrame_request();
    OAIGetImageFrame_request(QString json);
    ~OAIGetImageFrame_request() override;
    ...
    OAIGetImageFrame_request_imageFrameInformation getImageFrameInformation() const;
    void setImageFrameInformation(const OAIGetImageFrame_request_imageFrameInformation &image_frame_information);
...
private:
    ...
    OAIGetImageFrame_request_imageFrameInformation m_image_frame_information;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImageFrame_request)

#endif // OAIGetImageFrame_request_H
