...
/*
 * OAIGetImageFrame_request_imageFrameInformation.h
 *
 * Information about the image frame (pixel data) identifier.
 */

#ifndef OAIGetImageFrame_request_imageFrameInformation_H
#define OAIGetImageFrame_request_imageFrameInformation_H
...
class OAIGetImageFrame_request_imageFrameInformation : public OAIObject {
public:
    OAIGetImageFrame_request_imageFrameInformation();
    OAIGetImageFrame_request_imageFrameInformation(QString json);
    ~OAIGetImageFrame_request_imageFrameInformation() override;
    ...
    QString getImageFrameId() const;
    void setImageFrameId(const QString &image_frame_id);
    bool is_image_frame_id_Set() const;
    bool is_image_frame_id_Valid() const;
...
private:
    ...
    QString m_image_frame_id;
    bool m_image_frame_id_isSet;
    bool m_image_frame_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetImageFrame_request_imageFrameInformation)

#endif // OAIGetImageFrame_request_imageFrameInformation_H
