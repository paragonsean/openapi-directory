...
/*
 * OAIImageSetWorkflowStatus.h
 *
 * 
 */

#ifndef OAIImageSetWorkflowStatus_H
#define OAIImageSetWorkflowStatus_H
...
class OAIImageSetWorkflowStatus : public OAIEnum {
public:
    OAIImageSetWorkflowStatus();
    OAIImageSetWorkflowStatus(QString json);
    ~OAIImageSetWorkflowStatus() override;
    ...
    enum class eOAIImageSetWorkflowStatus {
    ...
    OAIImageSetWorkflowStatus::eOAIImageSetWorkflowStatus getValue() const;
    void setValue(const OAIImageSetWorkflowStatus::eOAIImageSetWorkflowStatus& value);
...
private:
    ...
    eOAIImageSetWorkflowStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSetWorkflowStatus)

#endif // OAIImageSetWorkflowStatus_H
