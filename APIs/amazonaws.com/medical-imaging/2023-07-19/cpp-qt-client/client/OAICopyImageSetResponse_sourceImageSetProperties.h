...
/*
 * OAICopyImageSetResponse_sourceImageSetProperties.h
 *
 * 
 */

#ifndef OAICopyImageSetResponse_sourceImageSetProperties_H
#define OAICopyImageSetResponse_sourceImageSetProperties_H
...
class OAICopyImageSetResponse_sourceImageSetProperties : public OAIObject {
public:
    OAICopyImageSetResponse_sourceImageSetProperties();
    OAICopyImageSetResponse_sourceImageSetProperties(QString json);
    ~OAICopyImageSetResponse_sourceImageSetProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetResponse_sourceImageSetProperties)

#endif // OAICopyImageSetResponse_sourceImageSetProperties_H
