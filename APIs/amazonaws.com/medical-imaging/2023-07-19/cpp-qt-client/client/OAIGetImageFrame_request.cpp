...
OAIGetImageFrame_request::OAIGetImageFrame_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageFrame_request::OAIGetImageFrame_request() {
    this->initializeModel();
}

OAIGetImageFrame_request::~OAIGetImageFrame_request() {}

void OAIGetImageFrame_request::initializeModel() {

    m_image_frame_information_isSet = false;
    m_image_frame_information_isValid = false;
}

void OAIGetImageFrame_request::fromJson(QString jsonString) {
...
void OAIGetImageFrame_request::fromJsonObject(QJsonObject json) {

    m_image_frame_information_isValid = ::OpenAPI::fromJsonValue(m_image_frame_information, json[QString("imageFrameInformation")]);
    m_image_frame_information_isSet = !json[QString("imageFrameInformation")].isNull() && m_image_frame_information_isValid;
}

QString OAIGetImageFrame_request::asJson() const {
...
QJsonObject OAIGetImageFrame_request::asJsonObject() const {
    QJsonObject obj;
    if (m_image_frame_information.isSet()) {
        obj.insert(QString("imageFrameInformation"), ::OpenAPI::toJsonValue(m_image_frame_information));
    }
    return obj;
}

OAIGetImageFrame_request_imageFrameInformation OAIGetImageFrame_request::getImageFrameInformation() const {
    return m_image_frame_information;
}
void OAIGetImageFrame_request::setImageFrameInformation(const OAIGetImageFrame_request_imageFrameInformation &image_frame_information) {
    m_image_frame_information = image_frame_information;
    m_image_frame_information_isSet = true;
}

bool OAIGetImageFrame_request::is_image_frame_information_Set() const{
    return m_image_frame_information_isSet;
}

bool OAIGetImageFrame_request::is_image_frame_information_Valid() const{
    return m_image_frame_information_isValid;
}

bool OAIGetImageFrame_request::isSet() const {
...
bool OAIGetImageFrame_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_frame_information_isValid && true;
}
