...
/*
 * OAIStartDICOMImportJob_request.h
 *
 * 
 */

#ifndef OAIStartDICOMImportJob_request_H
#define OAIStartDICOMImportJob_request_H
...
class OAIStartDICOMImportJob_request : public OAIObject {
public:
    OAIStartDICOMImportJob_request();
    OAIStartDICOMImportJob_request(QString json);
    ~OAIStartDICOMImportJob_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDICOMImportJob_request)

#endif // OAIStartDICOMImportJob_request_H
