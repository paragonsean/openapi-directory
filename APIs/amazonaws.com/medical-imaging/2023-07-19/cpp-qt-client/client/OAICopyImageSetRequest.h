...
/*
 * OAICopyImageSetRequest.h
 *
 * 
 */

#ifndef OAICopyImageSetRequest_H
#define OAICopyImageSetRequest_H
...
namespace OpenAPI {
class OAICopyImageSetRequest_copyImageSetInformation;

class OAICopyImageSetRequest : public OAIObject {
public:
    OAICopyImageSetRequest();
    OAICopyImageSetRequest(QString json);
    ~OAICopyImageSetRequest() override;
    ...
    OAICopyImageSetRequest_copyImageSetInformation getCopyImageSetInformation() const;
    void setCopyImageSetInformation(const OAICopyImageSetRequest_copyImageSetInformation &copy_image_set_information);
...
private:
    ...
    OAICopyImageSetRequest_copyImageSetInformation m_copy_image_set_information;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetRequest)

#endif // OAICopyImageSetRequest_H
