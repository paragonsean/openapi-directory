...
/*
 * OAICopySourceImageSetProperties.h
 *
 * Copy source image set properties.
 */

#ifndef OAICopySourceImageSetProperties_H
#define OAICopySourceImageSetProperties_H
...
class OAICopySourceImageSetProperties : public OAIObject {
public:
    OAICopySourceImageSetProperties();
    OAICopySourceImageSetProperties(QString json);
    ~OAICopySourceImageSetProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopySourceImageSetProperties)

#endif // OAICopySourceImageSetProperties_H
