...
/*
 * OAIGetImageFrameResponse.h
 *
 * 
 */

#ifndef OAIGetImageFrameResponse_H
#define OAIGetImageFrameResponse_H
...
class OAIGetImageFrameResponse : public OAIObject {
public:
    OAIGetImageFrameResponse();
    OAIGetImageFrameResponse(QString json);
    ~OAIGetImageFrameResponse() override;
    ...
    QString getImageFrameBlob() const;
    void setImageFrameBlob(const QString &image_frame_blob);
    bool is_image_frame_blob_Set() const;
    bool is_image_frame_blob_Valid() const;
...
private:
    ...
    QString m_image_frame_blob;
    bool m_image_frame_blob_isSet;
    bool m_image_frame_blob_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetImageFrameResponse)

#endif // OAIGetImageFrameResponse_H
