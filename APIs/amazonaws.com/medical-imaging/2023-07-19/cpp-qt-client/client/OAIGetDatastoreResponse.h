...
/*
 * OAIGetDatastoreResponse.h
 *
 * 
 */

#ifndef OAIGetDatastoreResponse_H
#define OAIGetDatastoreResponse_H
...
namespace OpenAPI {
class OAIGetDatastoreResponse_datastoreProperties;

class OAIGetDatastoreResponse : public OAIObject {
public:
    OAIGetDatastoreResponse();
    OAIGetDatastoreResponse(QString json);
    ~OAIGetDatastoreResponse() override;
    ...
    OAIGetDatastoreResponse_datastoreProperties getDatastoreProperties() const;
    void setDatastoreProperties(const OAIGetDatastoreResponse_datastoreProperties &datastore_properties);
...
private:
    ...
    OAIGetDatastoreResponse_datastoreProperties m_datastore_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDatastoreResponse)

#endif // OAIGetDatastoreResponse_H
