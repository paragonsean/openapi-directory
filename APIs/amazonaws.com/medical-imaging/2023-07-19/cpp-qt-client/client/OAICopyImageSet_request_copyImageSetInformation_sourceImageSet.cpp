...
OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::OAICopyImageSet_request_copyImageSetInformation_sourceImageSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::OAICopyImageSet_request_copyImageSetInformation_sourceImageSet() {
    this->initializeModel();
}

OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::~OAICopyImageSet_request_copyImageSetInformation_sourceImageSet() {}

void OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::initializeModel() {

    m_latest_version_id_isSet = false;
    m_latest_version_id_isValid = false;
}

void OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::fromJson(QString jsonString) {
...
void OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::fromJsonObject(QJsonObject json) {
...
QString OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::asJson() const {
...
QJsonObject OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::getLatestVersionId() const {
    return m_latest_version_id;
}
void OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::setLatestVersionId(const QString &latest_version_id) {
    m_latest_version_id = latest_version_id;
    m_latest_version_id_isSet = true;
}

bool OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::is_latest_version_id_Set() const{
    return m_latest_version_id_isSet;
}

bool OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::is_latest_version_id_Valid() const{
    return m_latest_version_id_isValid;
}

bool OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::isSet() const {
...
bool OAICopyImageSet_request_copyImageSetInformation_sourceImageSet::isValid() const {
