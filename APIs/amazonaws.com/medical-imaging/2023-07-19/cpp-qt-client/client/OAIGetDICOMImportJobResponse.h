...
/*
 * OAIGetDICOMImportJobResponse.h
 *
 * 
 */

#ifndef OAIGetDICOMImportJobResponse_H
#define OAIGetDICOMImportJobResponse_H
...
namespace OpenAPI {
class OAIGetDICOMImportJobResponse_jobProperties;

class OAIGetDICOMImportJobResponse : public OAIObject {
public:
    OAIGetDICOMImportJobResponse();
    OAIGetDICOMImportJobResponse(QString json);
    ~OAIGetDICOMImportJobResponse() override;
    ...
    OAIGetDICOMImportJobResponse_jobProperties getJobProperties() const;
    void setJobProperties(const OAIGetDICOMImportJobResponse_jobProperties &job_properties);
    bool is_job_properties_Set() const;
    bool is_job_properties_Valid() const;
...
private:
    ...
    OAIGetDICOMImportJobResponse_jobProperties m_job_properties;
    bool m_job_properties_isSet;
    bool m_job_properties_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetDICOMImportJobResponse)

#endif // OAIGetDICOMImportJobResponse_H
