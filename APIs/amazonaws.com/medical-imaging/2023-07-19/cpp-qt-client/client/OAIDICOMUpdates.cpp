...
OAIDICOMUpdates::OAIDICOMUpdates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDICOMUpdates::OAIDICOMUpdates() {
    this->initializeModel();
}

OAIDICOMUpdates::~OAIDICOMUpdates() {}

void OAIDICOMUpdates::initializeModel() {

    m_removable_attributes_isSet = false;
    m_removable_attributes_isValid = false;

    m_updatable_attributes_isSet = false;
    m_updatable_attributes_isValid = false;
}

void OAIDICOMUpdates::fromJson(QString jsonString) {
...
void OAIDICOMUpdates::fromJsonObject(QJsonObject json) {

    m_removable_attributes_isValid = ::OpenAPI::fromJsonValue(m_removable_attributes, json[QString("removableAttributes")]);
    m_removable_attributes_isSet = !json[QString("removableAttributes")].isNull() && m_removable_attributes_isValid;

    m_updatable_attributes_isValid = ::OpenAPI::fromJsonValue(m_updatable_attributes, json[QString("updatableAttributes")]);
    m_updatable_attributes_isSet = !json[QString("updatableAttributes")].isNull() && m_updatable_attributes_isValid;
}

QString OAIDICOMUpdates::asJson() const {
...
QJsonObject OAIDICOMUpdates::asJsonObject() const {
    QJsonObject obj;
    if (m_removable_attributes_isSet) {
        obj.insert(QString("removableAttributes"), ::OpenAPI::toJsonValue(m_removable_attributes));
    }
    if (m_updatable_attributes_isSet) {
        obj.insert(QString("updatableAttributes"), ::OpenAPI::toJsonValue(m_updatable_attributes));
    }
    return obj;
}

QString OAIDICOMUpdates::getRemovableAttributes() const {
    return m_removable_attributes;
}
void OAIDICOMUpdates::setRemovableAttributes(const QString &removable_attributes) {
    m_removable_attributes = removable_attributes;
    m_removable_attributes_isSet = true;
}

bool OAIDICOMUpdates::is_removable_attributes_Set() const{
    return m_removable_attributes_isSet;
}

bool OAIDICOMUpdates::is_removable_attributes_Valid() const{
    return m_removable_attributes_isValid;
}

QString OAIDICOMUpdates::getUpdatableAttributes() const {
    return m_updatable_attributes;
}
void OAIDICOMUpdates::setUpdatableAttributes(const QString &updatable_attributes) {
    m_updatable_attributes = updatable_attributes;
    m_updatable_attributes_isSet = true;
}

bool OAIDICOMUpdates::is_updatable_attributes_Set() const{
    return m_updatable_attributes_isSet;
}

bool OAIDICOMUpdates::is_updatable_attributes_Valid() const{
    return m_updatable_attributes_isValid;
}

bool OAIDICOMUpdates::isSet() const {
...
bool OAIDICOMUpdates::isValid() const {
