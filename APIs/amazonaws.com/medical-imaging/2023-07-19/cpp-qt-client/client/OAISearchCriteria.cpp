...
QList OAISearchCriteria::getFilters() const {
    return m_filters;
}
void OAISearchCriteria::setFilters(const QList &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAISearchCriteria::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAISearchCriteria::is_filters_Valid() const{
