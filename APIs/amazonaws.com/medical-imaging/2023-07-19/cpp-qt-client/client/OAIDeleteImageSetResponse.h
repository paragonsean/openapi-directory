...
/*
 * OAIDeleteImageSetResponse.h
 *
 * 
 */

#ifndef OAIDeleteImageSetResponse_H
#define OAIDeleteImageSetResponse_H
...
class OAIDeleteImageSetResponse : public OAIObject {
public:
    OAIDeleteImageSetResponse();
    OAIDeleteImageSetResponse(QString json);
    ~OAIDeleteImageSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteImageSetResponse)

#endif // OAIDeleteImageSetResponse_H
