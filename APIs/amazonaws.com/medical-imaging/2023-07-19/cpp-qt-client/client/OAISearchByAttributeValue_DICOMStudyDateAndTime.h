...
/*
 * OAISearchByAttributeValue_DICOMStudyDateAndTime.h
 *
 * 
 */

#ifndef OAISearchByAttributeValue_DICOMStudyDateAndTime_H
#define OAISearchByAttributeValue_DICOMStudyDateAndTime_H
...
class OAISearchByAttributeValue_DICOMStudyDateAndTime : public OAIObject {
public:
    OAISearchByAttributeValue_DICOMStudyDateAndTime();
    OAISearchByAttributeValue_DICOMStudyDateAndTime(QString json);
    ~OAISearchByAttributeValue_DICOMStudyDateAndTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchByAttributeValue_DICOMStudyDateAndTime)

#endif // OAISearchByAttributeValue_DICOMStudyDateAndTime_H
