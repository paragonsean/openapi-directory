...
OAIGetImageSetMetadataResponse::OAIGetImageSetMetadataResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageSetMetadataResponse::OAIGetImageSetMetadataResponse() {
    this->initializeModel();
}

OAIGetImageSetMetadataResponse::~OAIGetImageSetMetadataResponse() {}

void OAIGetImageSetMetadataResponse::initializeModel() {

    m_image_set_metadata_blob_isSet = false;
    m_image_set_metadata_blob_isValid = false;
}

void OAIGetImageSetMetadataResponse::fromJson(QString jsonString) {
...
void OAIGetImageSetMetadataResponse::fromJsonObject(QJsonObject json) {

    m_image_set_metadata_blob_isValid = ::OpenAPI::fromJsonValue(m_image_set_metadata_blob, json[QString("imageSetMetadataBlob")]);
    m_image_set_metadata_blob_isSet = !json[QString("imageSetMetadataBlob")].isNull() && m_image_set_metadata_blob_isValid;
}

QString OAIGetImageSetMetadataResponse::asJson() const {
...
QJsonObject OAIGetImageSetMetadataResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_image_set_metadata_blob_isSet) {
        obj.insert(QString("imageSetMetadataBlob"), ::OpenAPI::toJsonValue(m_image_set_metadata_blob));
    }
    return obj;
}

QString OAIGetImageSetMetadataResponse::getImageSetMetadataBlob() const {
    return m_image_set_metadata_blob;
}
void OAIGetImageSetMetadataResponse::setImageSetMetadataBlob(const QString &image_set_metadata_blob) {
    m_image_set_metadata_blob = image_set_metadata_blob;
    m_image_set_metadata_blob_isSet = true;
}

bool OAIGetImageSetMetadataResponse::is_image_set_metadata_blob_Set() const{
    return m_image_set_metadata_blob_isSet;
}

bool OAIGetImageSetMetadataResponse::is_image_set_metadata_blob_Valid() const{
    return m_image_set_metadata_blob_isValid;
}

bool OAIGetImageSetMetadataResponse::isSet() const {
...
bool OAIGetImageSetMetadataResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_set_metadata_blob_isValid && true;
}
