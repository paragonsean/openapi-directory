...
/*
 * OAICreateDatastoreRequest.h
 *
 * 
 */

#ifndef OAICreateDatastoreRequest_H
#define OAICreateDatastoreRequest_H
...
class OAICreateDatastoreRequest : public OAIObject {
public:
    OAICreateDatastoreRequest();
    OAICreateDatastoreRequest(QString json);
    ~OAICreateDatastoreRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDatastoreRequest)

#endif // OAICreateDatastoreRequest_H
