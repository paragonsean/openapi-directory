...
/*
 * OAICopyImageSetResponse_destinationImageSetProperties.h
 *
 * 
 */

#ifndef OAICopyImageSetResponse_destinationImageSetProperties_H
#define OAICopyImageSetResponse_destinationImageSetProperties_H

#include <QJsonObject>

#include "OAIImageSetState.h"
...
class OAICopyImageSetResponse_destinationImageSetProperties : public OAIObject {
public:
    OAICopyImageSetResponse_destinationImageSetProperties();
    OAICopyImageSetResponse_destinationImageSetProperties(QString json);
    ~OAICopyImageSetResponse_destinationImageSetProperties() override;
    ...
    QString getImageSetId() const;
    void setImageSetId(const QString &image_set_id);
    bool is_image_set_id_Set() const;
    bool is_image_set_id_Valid() const;

    QString getLatestVersionId() const;
    void setLatestVersionId(const QString &latest_version_id);
    bool is_latest_version_id_Set() const;
    bool is_latest_version_id_Valid() const;

    OAIImageSetState getImageSetState() const;
    void setImageSetState(const OAIImageSetState &image_set_state);
    bool is_image_set_state_Set() const;
    bool is_image_set_state_Valid() const;

    OAIImageSetWorkflowStatus getImageSetWorkflowStatus() const;
    void setImageSetWorkflowStatus(const OAIImageSetWorkflowStatus &image_set_workflow_status);
    bool is_image_set_workflow_status_Set() const;
    bool is_image_set_workflow_status_Valid() const;
    ...
    QString getImageSetArn() const;
    void setImageSetArn(const QString &image_set_arn);
    bool is_image_set_arn_Set() const;
    bool is_image_set_arn_Valid() const;
...
private:
    ...
    QString m_image_set_id;
    bool m_image_set_id_isSet;
    bool m_image_set_id_isValid;

    QString m_latest_version_id;
    bool m_latest_version_id_isSet;
    bool m_latest_version_id_isValid;

    OAIImageSetState m_image_set_state;
    bool m_image_set_state_isSet;
    bool m_image_set_state_isValid;

    OAIImageSetWorkflowStatus m_image_set_workflow_status;
    bool m_image_set_workflow_status_isSet;
    bool m_image_set_workflow_status_isValid;
    ...
    QString m_image_set_arn;
    bool m_image_set_arn_isSet;
    bool m_image_set_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetResponse_destinationImageSetProperties)

#endif // OAICopyImageSetResponse_destinationImageSetProperties_H
