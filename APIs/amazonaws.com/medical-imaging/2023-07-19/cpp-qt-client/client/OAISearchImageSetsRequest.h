...
/*
 * OAISearchImageSetsRequest.h
 *
 * 
 */

#ifndef OAISearchImageSetsRequest_H
#define OAISearchImageSetsRequest_H

#include <QJsonObject>

#include "OAISearchImageSetsRequest_searchCriteria.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAISearchImageSetsRequest_searchCriteria;

class OAISearchImageSetsRequest : public OAIObject {
public:
    OAISearchImageSetsRequest();
    OAISearchImageSetsRequest(QString json);
    ~OAISearchImageSetsRequest() override;
    ...
    OAISearchImageSetsRequest_searchCriteria getSearchCriteria() const;
    void setSearchCriteria(const OAISearchImageSetsRequest_searchCriteria &search_criteria);
...
private:
    ...
    OAISearchImageSetsRequest_searchCriteria m_search_criteria;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchImageSetsRequest)

#endif // OAISearchImageSetsRequest_H
