...
OAIUpdateImageSetMetadata_request::OAIUpdateImageSetMetadata_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateImageSetMetadata_request::OAIUpdateImageSetMetadata_request() {
    this->initializeModel();
}

OAIUpdateImageSetMetadata_request::~OAIUpdateImageSetMetadata_request() {}

void OAIUpdateImageSetMetadata_request::initializeModel() {

    m_update_image_set_metadata_updates_isSet = false;
    m_update_image_set_metadata_updates_isValid = false;
}

void OAIUpdateImageSetMetadata_request::fromJson(QString jsonString) {
...
void OAIUpdateImageSetMetadata_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateImageSetMetadata_request::asJson() const {
...
QJsonObject OAIUpdateImageSetMetadata_request::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates OAIUpdateImageSetMetadata_request::getUpdateImageSetMetadataUpdates() const {
    return m_update_image_set_metadata_updates;
}
void OAIUpdateImageSetMetadata_request::setUpdateImageSetMetadataUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates &update_image_set_metadata_updates) {
    m_update_image_set_metadata_updates = update_image_set_metadata_updates;
    m_update_image_set_metadata_updates_isSet = true;
}

bool OAIUpdateImageSetMetadata_request::is_update_image_set_metadata_updates_Set() const{
    return m_update_image_set_metadata_updates_isSet;
}

bool OAIUpdateImageSetMetadata_request::is_update_image_set_metadata_updates_Valid() const{
    return m_update_image_set_metadata_updates_isValid;
}

bool OAIUpdateImageSetMetadata_request::isSet() const {
...
bool OAIUpdateImageSetMetadata_request::isValid() const {
