...
#include "OAIDICOMImportJobSummary.h"
...
OAIDICOMImportJobSummary::OAIDICOMImportJobSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDICOMImportJobSummary::OAIDICOMImportJobSummary() {
    this->initializeModel();
}

OAIDICOMImportJobSummary::~OAIDICOMImportJobSummary() {}

void OAIDICOMImportJobSummary::initializeModel() {
...
void OAIDICOMImportJobSummary::fromJson(QString jsonString) {
...
void OAIDICOMImportJobSummary::fromJsonObject(QJsonObject json) {
...
QString OAIDICOMImportJobSummary::asJson() const {
...
QJsonObject OAIDICOMImportJobSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIDICOMImportJobSummary::getJobId() const {
    return m_job_id;
}
void OAIDICOMImportJobSummary::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIDICOMImportJobSummary::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIDICOMImportJobSummary::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAIDICOMImportJobSummary::getJobName() const {
    return m_job_name;
}
void OAIDICOMImportJobSummary::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAIDICOMImportJobSummary::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAIDICOMImportJobSummary::is_job_name_Valid() const{
    return m_job_name_isValid;
}

OAIJobStatus OAIDICOMImportJobSummary::getJobStatus() const {
    return m_job_status;
}
void OAIDICOMImportJobSummary::setJobStatus(const OAIJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIDICOMImportJobSummary::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIDICOMImportJobSummary::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIDICOMImportJobSummary::getDatastoreId() const {
    return m_datastore_id;
}
void OAIDICOMImportJobSummary::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIDICOMImportJobSummary::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIDICOMImportJobSummary::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIDICOMImportJobSummary::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIDICOMImportJobSummary::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIDICOMImportJobSummary::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIDICOMImportJobSummary::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

QDateTime OAIDICOMImportJobSummary::getEndedAt() const {
    return m_ended_at;
}
void OAIDICOMImportJobSummary::setEndedAt(const QDateTime &ended_at) {
    m_ended_at = ended_at;
    m_ended_at_isSet = true;
}

bool OAIDICOMImportJobSummary::is_ended_at_Set() const{
    return m_ended_at_isSet;
}

bool OAIDICOMImportJobSummary::is_ended_at_Valid() const{
    return m_ended_at_isValid;
}

QDateTime OAIDICOMImportJobSummary::getSubmittedAt() const {
    return m_submitted_at;
}
void OAIDICOMImportJobSummary::setSubmittedAt(const QDateTime &submitted_at) {
    m_submitted_at = submitted_at;
    m_submitted_at_isSet = true;
}

bool OAIDICOMImportJobSummary::is_submitted_at_Set() const{
    return m_submitted_at_isSet;
}

bool OAIDICOMImportJobSummary::is_submitted_at_Valid() const{
    return m_submitted_at_isValid;
}

QString OAIDICOMImportJobSummary::getMessage() const {
    return m_message;
}
void OAIDICOMImportJobSummary::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDICOMImportJobSummary::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDICOMImportJobSummary::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIDICOMImportJobSummary::isSet() const {
...
bool OAIDICOMImportJobSummary::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_job_id_isValid && m_job_name_isValid && m_job_status_isValid && m_datastore_id_isValid && true;
}
