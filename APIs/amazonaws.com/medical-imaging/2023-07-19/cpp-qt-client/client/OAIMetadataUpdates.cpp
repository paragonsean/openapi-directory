...
OAIMetadataUpdates::OAIMetadataUpdates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetadataUpdates::OAIMetadataUpdates() {
    this->initializeModel();
}

OAIMetadataUpdates::~OAIMetadataUpdates() {}

void OAIMetadataUpdates::initializeModel() {

    m_dicom_updates_isSet = false;
    m_dicom_updates_isValid = false;
}

void OAIMetadataUpdates::fromJson(QString jsonString) {
...
void OAIMetadataUpdates::fromJsonObject(QJsonObject json) {
...
QString OAIMetadataUpdates::asJson() const {
...
QJsonObject OAIMetadataUpdates::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates OAIMetadataUpdates::getDicomUpdates() const {
    return m_dicom_updates;
}
void OAIMetadataUpdates::setDicomUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates &dicom_updates) {
    m_dicom_updates = dicom_updates;
    m_dicom_updates_isSet = true;
}

bool OAIMetadataUpdates::is_dicom_updates_Set() const{
    return m_dicom_updates_isSet;
}

bool OAIMetadataUpdates::is_dicom_updates_Valid() const{
    return m_dicom_updates_isValid;
}

bool OAIMetadataUpdates::isSet() const {
...
bool OAIMetadataUpdates::isValid() const {
