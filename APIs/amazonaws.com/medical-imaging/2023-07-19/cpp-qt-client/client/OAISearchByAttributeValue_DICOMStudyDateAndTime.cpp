...
OAISearchByAttributeValue_DICOMStudyDateAndTime::OAISearchByAttributeValue_DICOMStudyDateAndTime(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchByAttributeValue_DICOMStudyDateAndTime::OAISearchByAttributeValue_DICOMStudyDateAndTime() {
    this->initializeModel();
}

OAISearchByAttributeValue_DICOMStudyDateAndTime::~OAISearchByAttributeValue_DICOMStudyDateAndTime() {}

void OAISearchByAttributeValue_DICOMStudyDateAndTime::initializeModel() {
...
void OAISearchByAttributeValue_DICOMStudyDateAndTime::fromJson(QString jsonString) {
...
void OAISearchByAttributeValue_DICOMStudyDateAndTime::fromJsonObject(QJsonObject json) {
...
QString OAISearchByAttributeValue_DICOMStudyDateAndTime::asJson() const {
...
QJsonObject OAISearchByAttributeValue_DICOMStudyDateAndTime::asJsonObject() const {
    QJsonObject obj;
...
QString OAISearchByAttributeValue_DICOMStudyDateAndTime::getDicomStudyDate() const {
    return m_dicom_study_date;
}
void OAISearchByAttributeValue_DICOMStudyDateAndTime::setDicomStudyDate(const QString &dicom_study_date) {
    m_dicom_study_date = dicom_study_date;
    m_dicom_study_date_isSet = true;
}

bool OAISearchByAttributeValue_DICOMStudyDateAndTime::is_dicom_study_date_Set() const{
    return m_dicom_study_date_isSet;
}

bool OAISearchByAttributeValue_DICOMStudyDateAndTime::is_dicom_study_date_Valid() const{
    return m_dicom_study_date_isValid;
}

QString OAISearchByAttributeValue_DICOMStudyDateAndTime::getDicomStudyTime() const {
    return m_dicom_study_time;
}
void OAISearchByAttributeValue_DICOMStudyDateAndTime::setDicomStudyTime(const QString &dicom_study_time) {
    m_dicom_study_time = dicom_study_time;
    m_dicom_study_time_isSet = true;
}

bool OAISearchByAttributeValue_DICOMStudyDateAndTime::is_dicom_study_time_Set() const{
    return m_dicom_study_time_isSet;
}

bool OAISearchByAttributeValue_DICOMStudyDateAndTime::is_dicom_study_time_Valid() const{
    return m_dicom_study_time_isValid;
}

bool OAISearchByAttributeValue_DICOMStudyDateAndTime::isSet() const {
...
bool OAISearchByAttributeValue_DICOMStudyDateAndTime::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_dicom_study_date_isValid && true;
}
