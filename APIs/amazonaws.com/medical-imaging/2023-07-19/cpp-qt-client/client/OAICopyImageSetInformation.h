...
/*
 * OAICopyImageSetInformation.h
 *
 * Copy image set information.
 */

#ifndef OAICopyImageSetInformation_H
#define OAICopyImageSetInformation_H
...
class OAICopyImageSetInformation : public OAIObject {
public:
    OAICopyImageSetInformation();
    OAICopyImageSetInformation(QString json);
    ~OAICopyImageSetInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSetInformation)

#endif // OAICopyImageSetInformation_H
