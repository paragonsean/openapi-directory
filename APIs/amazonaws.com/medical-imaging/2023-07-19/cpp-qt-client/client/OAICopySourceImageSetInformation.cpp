...
#include "OAICopySourceImageSetInformation.h"
...
OAICopySourceImageSetInformation::OAICopySourceImageSetInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopySourceImageSetInformation::OAICopySourceImageSetInformation() {
    this->initializeModel();
}

OAICopySourceImageSetInformation::~OAICopySourceImageSetInformation() {}

void OAICopySourceImageSetInformation::initializeModel() {

    m_latest_version_id_isSet = false;
    m_latest_version_id_isValid = false;
}

void OAICopySourceImageSetInformation::fromJson(QString jsonString) {
...
void OAICopySourceImageSetInformation::fromJsonObject(QJsonObject json) {
...
QString OAICopySourceImageSetInformation::asJson() const {
...
QJsonObject OAICopySourceImageSetInformation::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopySourceImageSetInformation::getLatestVersionId() const {
    return m_latest_version_id;
}
void OAICopySourceImageSetInformation::setLatestVersionId(const QString &latest_version_id) {
    m_latest_version_id = latest_version_id;
    m_latest_version_id_isSet = true;
}

bool OAICopySourceImageSetInformation::is_latest_version_id_Set() const{
    return m_latest_version_id_isSet;
}

bool OAICopySourceImageSetInformation::is_latest_version_id_Valid() const{
    return m_latest_version_id_isValid;
}

bool OAICopySourceImageSetInformation::isSet() const {
...
bool OAICopySourceImageSetInformation::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_latest_version_id_isValid && true;
}
