...
/*
 * OAICopyDestinationImageSetProperties.h
 *
 * Copy the image set properties of the destination image set.
 */

#ifndef OAICopyDestinationImageSetProperties_H
#define OAICopyDestinationImageSetProperties_H
...
class OAICopyDestinationImageSetProperties : public OAIObject {
public:
    OAICopyDestinationImageSetProperties();
    OAICopyDestinationImageSetProperties(QString json);
    ~OAICopyDestinationImageSetProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyDestinationImageSetProperties)

#endif // OAICopyDestinationImageSetProperties_H
