...
/*
 * OAIGetImageFrameRequest.h
 *
 * 
 */

#ifndef OAIGetImageFrameRequest_H
#define OAIGetImageFrameRequest_H

#include <QJsonObject>

#include "OAIGetImageFrameRequest_imageFrameInformation.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetImageFrameRequest_imageFrameInformation;

class OAIGetImageFrameRequest : public OAIObject {
public:
    OAIGetImageFrameRequest();
    OAIGetImageFrameRequest(QString json);
    ~OAIGetImageFrameRequest() override;
    ...
    OAIGetImageFrameRequest_imageFrameInformation getImageFrameInformation() const;
    void setImageFrameInformation(const OAIGetImageFrameRequest_imageFrameInformation &image_frame_information);
    bool is_image_frame_information_Set() const;
    bool is_image_frame_information_Valid() const;
...
private:
    ...
    OAIGetImageFrameRequest_imageFrameInformation m_image_frame_information;
    bool m_image_frame_information_isSet;
    bool m_image_frame_information_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetImageFrameRequest)

#endif // OAIGetImageFrameRequest_H
