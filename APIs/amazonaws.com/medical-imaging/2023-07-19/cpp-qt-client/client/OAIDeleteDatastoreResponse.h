...
/*
 * OAIDeleteDatastoreResponse.h
 *
 * 
 */

#ifndef OAIDeleteDatastoreResponse_H
#define OAIDeleteDatastoreResponse_H
...
class OAIDeleteDatastoreResponse : public OAIObject {
public:
    OAIDeleteDatastoreResponse();
    OAIDeleteDatastoreResponse(QString json);
    ~OAIDeleteDatastoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDatastoreResponse)

#endif // OAIDeleteDatastoreResponse_H
