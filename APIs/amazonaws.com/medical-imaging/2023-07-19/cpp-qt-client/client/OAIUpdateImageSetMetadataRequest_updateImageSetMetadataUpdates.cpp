...
OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates() {
    this->initializeModel();
}

OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::~OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates() {}

void OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::initializeModel() {

    m_dicom_updates_isSet = false;
    m_dicom_updates_isValid = false;
}

void OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::fromJson(QString jsonString) {
...
void OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::asJson() const {
...
QJsonObject OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::getDicomUpdates() const {
    return m_dicom_updates;
}
void OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::setDicomUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates &dicom_updates) {
    m_dicom_updates = dicom_updates;
    m_dicom_updates_isSet = true;
}

bool OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::is_dicom_updates_Set() const{
    return m_dicom_updates_isSet;
}

bool OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::is_dicom_updates_Valid() const{
    return m_dicom_updates_isValid;
}

bool OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::isSet() const {
...
bool OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates::isValid() const {
