...
/*
 * OAIStartDICOMImportJobResponse.h
 *
 * 
 */

#ifndef OAIStartDICOMImportJobResponse_H
#define OAIStartDICOMImportJobResponse_H
...
class OAIStartDICOMImportJobResponse : public OAIObject {
public:
    OAIStartDICOMImportJobResponse();
    OAIStartDICOMImportJobResponse(QString json);
    ~OAIStartDICOMImportJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDICOMImportJobResponse)

#endif // OAIStartDICOMImportJobResponse_H
