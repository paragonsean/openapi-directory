...
/*
 * OAIListDatastoresResponse.h
 *
 * 
 */

#ifndef OAIListDatastoresResponse_H
#define OAIListDatastoresResponse_H
...
class OAIListDatastoresResponse : public OAIObject {
public:
    OAIListDatastoresResponse();
    OAIListDatastoresResponse(QString json);
    ~OAIListDatastoresResponse() override;
    ...
    QList getDatastoreSummaries() const;
    void setDatastoreSummaries(const QList &datastore_summaries);
    bool is_datastore_summaries_Set() const;
    bool is_datastore_summaries_Valid() const;
...
private:
    ...
    QList m_datastore_summaries;
    bool m_datastore_summaries_isSet;
    bool m_datastore_summaries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatastoresResponse)

#endif // OAIListDatastoresResponse_H
