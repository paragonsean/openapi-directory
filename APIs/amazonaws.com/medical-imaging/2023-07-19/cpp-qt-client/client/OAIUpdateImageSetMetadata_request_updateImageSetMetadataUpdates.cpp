...
#include "OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates.h"
...
OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates() {
    this->initializeModel();
}

OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::~OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates() {}

void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::initializeModel() {

    m_dicom_updates_isSet = false;
    m_dicom_updates_isValid = false;
}

void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::fromJson(QString jsonString) {
...
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::fromJsonObject(QJsonObject json) {

    m_dicom_updates_isValid = ::OpenAPI::fromJsonValue(m_dicom_updates, json[QString("DICOMUpdates")]);
    m_dicom_updates_isSet = !json[QString("DICOMUpdates")].isNull() && m_dicom_updates_isValid;
}

QString OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::asJson() const {
...
QJsonObject OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::asJsonObject() const {
    QJsonObject obj;
    if (m_dicom_updates.isSet()) {
        obj.insert(QString("DICOMUpdates"), ::OpenAPI::toJsonValue(m_dicom_updates));
    }
    return obj;
}

OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::getDicomUpdates() const {
    return m_dicom_updates;
}
void OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::setDicomUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates &dicom_updates) {
    m_dicom_updates = dicom_updates;
    m_dicom_updates_isSet = true;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::is_dicom_updates_Set() const{
    return m_dicom_updates_isSet;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::is_dicom_updates_Valid() const{
    return m_dicom_updates_isValid;
}

bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::isSet() const {
...
bool OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates::isValid() const {
