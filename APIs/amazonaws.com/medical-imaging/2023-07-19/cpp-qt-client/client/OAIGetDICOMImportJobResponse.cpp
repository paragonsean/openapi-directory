...
OAIGetDICOMImportJobResponse::OAIGetDICOMImportJobResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDICOMImportJobResponse::OAIGetDICOMImportJobResponse() {
    this->initializeModel();
}

OAIGetDICOMImportJobResponse::~OAIGetDICOMImportJobResponse() {}

void OAIGetDICOMImportJobResponse::initializeModel() {

    m_job_properties_isSet = false;
    m_job_properties_isValid = false;
}

void OAIGetDICOMImportJobResponse::fromJson(QString jsonString) {
...
void OAIGetDICOMImportJobResponse::fromJsonObject(QJsonObject json) {

    m_job_properties_isValid = ::OpenAPI::fromJsonValue(m_job_properties, json[QString("jobProperties")]);
    m_job_properties_isSet = !json[QString("jobProperties")].isNull() && m_job_properties_isValid;
}

QString OAIGetDICOMImportJobResponse::asJson() const {
...
QJsonObject OAIGetDICOMImportJobResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_job_properties.isSet()) {
        obj.insert(QString("jobProperties"), ::OpenAPI::toJsonValue(m_job_properties));
    }
    return obj;
}

OAIGetDICOMImportJobResponse_jobProperties OAIGetDICOMImportJobResponse::getJobProperties() const {
    return m_job_properties;
}
void OAIGetDICOMImportJobResponse::setJobProperties(const OAIGetDICOMImportJobResponse_jobProperties &job_properties) {
    m_job_properties = job_properties;
    m_job_properties_isSet = true;
}

bool OAIGetDICOMImportJobResponse::is_job_properties_Set() const{
    return m_job_properties_isSet;
}

bool OAIGetDICOMImportJobResponse::is_job_properties_Valid() const{
    return m_job_properties_isValid;
}

bool OAIGetDICOMImportJobResponse::isSet() const {
...
bool OAIGetDICOMImportJobResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_job_properties_isValid && true;
}
