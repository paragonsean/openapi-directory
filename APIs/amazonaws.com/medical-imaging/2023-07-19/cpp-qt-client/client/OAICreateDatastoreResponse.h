...
/*
 * OAICreateDatastoreResponse.h
 *
 * 
 */

#ifndef OAICreateDatastoreResponse_H
#define OAICreateDatastoreResponse_H
...
class OAICreateDatastoreResponse : public OAIObject {
public:
    OAICreateDatastoreResponse();
    OAICreateDatastoreResponse(QString json);
    ~OAICreateDatastoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDatastoreResponse)

#endif // OAICreateDatastoreResponse_H
