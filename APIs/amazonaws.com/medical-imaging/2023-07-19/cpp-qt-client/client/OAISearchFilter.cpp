...
OAIOperator OAISearchFilter::getROperator() const {
    return m_r_operator;
}
void OAISearchFilter::setROperator(const OAIOperator &r_operator) {
...
bool OAISearchFilter::isValid() const {
    ...
    return m_values_isValid && m_r_operator_isValid && true;
}
