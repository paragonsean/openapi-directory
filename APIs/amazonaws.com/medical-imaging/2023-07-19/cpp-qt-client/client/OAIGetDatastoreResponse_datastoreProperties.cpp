...
#include "OAIGetDatastoreResponse_datastoreProperties.h"
...
OAIGetDatastoreResponse_datastoreProperties::OAIGetDatastoreResponse_datastoreProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetDatastoreResponse_datastoreProperties::OAIGetDatastoreResponse_datastoreProperties() {
    this->initializeModel();
}

OAIGetDatastoreResponse_datastoreProperties::~OAIGetDatastoreResponse_datastoreProperties() {}

void OAIGetDatastoreResponse_datastoreProperties::initializeModel() {
...
void OAIGetDatastoreResponse_datastoreProperties::fromJson(QString jsonString) {
...
void OAIGetDatastoreResponse_datastoreProperties::fromJsonObject(QJsonObject json) {
...
QString OAIGetDatastoreResponse_datastoreProperties::asJson() const {
...
QJsonObject OAIGetDatastoreResponse_datastoreProperties::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetDatastoreResponse_datastoreProperties::getDatastoreId() const {
    return m_datastore_id;
}
void OAIGetDatastoreResponse_datastoreProperties::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIGetDatastoreResponse_datastoreProperties::getDatastoreName() const {
    return m_datastore_name;
}
void OAIGetDatastoreResponse_datastoreProperties::setDatastoreName(const QString &datastore_name) {
    m_datastore_name = datastore_name;
    m_datastore_name_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_name_Set() const{
    return m_datastore_name_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_name_Valid() const{
    return m_datastore_name_isValid;
}

OAIDatastoreStatus OAIGetDatastoreResponse_datastoreProperties::getDatastoreStatus() const {
    return m_datastore_status;
}
void OAIGetDatastoreResponse_datastoreProperties::setDatastoreStatus(const OAIDatastoreStatus &datastore_status) {
    m_datastore_status = datastore_status;
    m_datastore_status_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_status_Set() const{
    return m_datastore_status_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_status_Valid() const{
    return m_datastore_status_isValid;
}

QString OAIGetDatastoreResponse_datastoreProperties::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIGetDatastoreResponse_datastoreProperties::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

QString OAIGetDatastoreResponse_datastoreProperties::getDatastoreArn() const {
    return m_datastore_arn;
}
void OAIGetDatastoreResponse_datastoreProperties::setDatastoreArn(const QString &datastore_arn) {
    m_datastore_arn = datastore_arn;
    m_datastore_arn_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_arn_Set() const{
    return m_datastore_arn_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_datastore_arn_Valid() const{
    return m_datastore_arn_isValid;
}

QDateTime OAIGetDatastoreResponse_datastoreProperties::getCreatedAt() const {
    return m_created_at;
}
void OAIGetDatastoreResponse_datastoreProperties::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIGetDatastoreResponse_datastoreProperties::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGetDatastoreResponse_datastoreProperties::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGetDatastoreResponse_datastoreProperties::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIGetDatastoreResponse_datastoreProperties::isSet() const {
...
bool OAIGetDatastoreResponse_datastoreProperties::isValid() const {
