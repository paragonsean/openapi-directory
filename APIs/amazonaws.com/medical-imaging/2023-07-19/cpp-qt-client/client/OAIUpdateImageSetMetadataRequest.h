...
/*
 * OAIUpdateImageSetMetadataRequest.h
 *
 * 
 */

#ifndef OAIUpdateImageSetMetadataRequest_H
#define OAIUpdateImageSetMetadataRequest_H

#include <QJsonObject>

#include "OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates;

class OAIUpdateImageSetMetadataRequest : public OAIObject {
public:
    OAIUpdateImageSetMetadataRequest();
    OAIUpdateImageSetMetadataRequest(QString json);
    ~OAIUpdateImageSetMetadataRequest() override;
    ...
    OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates getUpdateImageSetMetadataUpdates() const;
    void setUpdateImageSetMetadataUpdates(const OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates &update_image_set_metadata_updates);
    bool is_update_image_set_metadata_updates_Set() const;
    bool is_update_image_set_metadata_updates_Valid() const;
...
private:
    ...
    OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates m_update_image_set_metadata_updates;
    bool m_update_image_set_metadata_updates_isSet;
    bool m_update_image_set_metadata_updates_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadataRequest)

#endif // OAIUpdateImageSetMetadataRequest_H
