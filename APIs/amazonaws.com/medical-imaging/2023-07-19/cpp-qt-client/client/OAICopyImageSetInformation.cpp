...
#include "OAICopyImageSetInformation.h"
...
OAICopyImageSetInformation::OAICopyImageSetInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSetInformation::OAICopyImageSetInformation() {
    this->initializeModel();
}

OAICopyImageSetInformation::~OAICopyImageSetInformation() {}

void OAICopyImageSetInformation::initializeModel() {

    m_source_image_set_isSet = false;
    m_source_image_set_isValid = false;

    m_destination_image_set_isSet = false;
    m_destination_image_set_isValid = false;
}

void OAICopyImageSetInformation::fromJson(QString jsonString) {
...
void OAICopyImageSetInformation::fromJsonObject(QJsonObject json) {

    m_source_image_set_isValid = ::OpenAPI::fromJsonValue(m_source_image_set, json[QString("sourceImageSet")]);
    m_source_image_set_isSet = !json[QString("sourceImageSet")].isNull() && m_source_image_set_isValid;

    m_destination_image_set_isValid = ::OpenAPI::fromJsonValue(m_destination_image_set, json[QString("destinationImageSet")]);
    m_destination_image_set_isSet = !json[QString("destinationImageSet")].isNull() && m_destination_image_set_isValid;
}

QString OAICopyImageSetInformation::asJson() const {
...
QJsonObject OAICopyImageSetInformation::asJsonObject() const {
    QJsonObject obj;
    if (m_source_image_set.isSet()) {
        obj.insert(QString("sourceImageSet"), ::OpenAPI::toJsonValue(m_source_image_set));
    }
    if (m_destination_image_set.isSet()) {
        obj.insert(QString("destinationImageSet"), ::OpenAPI::toJsonValue(m_destination_image_set));
    }
    return obj;
}

OAICopyImageSet_request_copyImageSetInformation_sourceImageSet OAICopyImageSetInformation::getSourceImageSet() const {
    return m_source_image_set;
}
void OAICopyImageSetInformation::setSourceImageSet(const OAICopyImageSet_request_copyImageSetInformation_sourceImageSet &source_image_set) {
    m_source_image_set = source_image_set;
    m_source_image_set_isSet = true;
}

bool OAICopyImageSetInformation::is_source_image_set_Set() const{
    return m_source_image_set_isSet;
}

bool OAICopyImageSetInformation::is_source_image_set_Valid() const{
    return m_source_image_set_isValid;
}

OAICopyImageSet_request_copyImageSetInformation_destinationImageSet OAICopyImageSetInformation::getDestinationImageSet() const {
    return m_destination_image_set;
}
void OAICopyImageSetInformation::setDestinationImageSet(const OAICopyImageSet_request_copyImageSetInformation_destinationImageSet &destination_image_set) {
    m_destination_image_set = destination_image_set;
    m_destination_image_set_isSet = true;
}

bool OAICopyImageSetInformation::is_destination_image_set_Set() const{
    return m_destination_image_set_isSet;
}

bool OAICopyImageSetInformation::is_destination_image_set_Valid() const{
    return m_destination_image_set_isValid;
}

bool OAICopyImageSetInformation::isSet() const {
...
bool OAICopyImageSetInformation::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_source_image_set_isValid && true;
}
