...
/*
 * OAICopyImageSet_request_copyImageSetInformation.h
 *
 * Copy image set information.
 */

#ifndef OAICopyImageSet_request_copyImageSetInformation_H
#define OAICopyImageSet_request_copyImageSetInformation_H

#include <QJsonObject>

#include "OAICopyImageSet_request_copyImageSetInformation_destinationImageSet.h"
#include "OAICopyImageSet_request_copyImageSetInformation_sourceImageSet.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICopyImageSet_request_copyImageSetInformation_sourceImageSet;
class OAICopyImageSet_request_copyImageSetInformation_destinationImageSet;

class OAICopyImageSet_request_copyImageSetInformation : public OAIObject {
public:
    OAICopyImageSet_request_copyImageSetInformation();
    OAICopyImageSet_request_copyImageSetInformation(QString json);
    ~OAICopyImageSet_request_copyImageSetInformation() override;
    ...
    OAICopyImageSet_request_copyImageSetInformation_sourceImageSet getSourceImageSet() const;
    void setSourceImageSet(const OAICopyImageSet_request_copyImageSetInformation_sourceImageSet &source_image_set);
    bool is_source_image_set_Set() const;
    bool is_source_image_set_Valid() const;

    OAICopyImageSet_request_copyImageSetInformation_destinationImageSet getDestinationImageSet() const;
    void setDestinationImageSet(const OAICopyImageSet_request_copyImageSetInformation_destinationImageSet &destination_image_set);
    bool is_destination_image_set_Set() const;
    bool is_destination_image_set_Valid() const;
...
private:
    ...
    OAICopyImageSet_request_copyImageSetInformation_sourceImageSet m_source_image_set;
    bool m_source_image_set_isSet;
    bool m_source_image_set_isValid;

    OAICopyImageSet_request_copyImageSetInformation_destinationImageSet m_destination_image_set;
    bool m_destination_image_set_isSet;
    bool m_destination_image_set_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSet_request_copyImageSetInformation)

#endif // OAICopyImageSet_request_copyImageSetInformation_H
