...
/*
 * OAIUpdateImageSetMetadata_request.h
 *
 * 
 */

#ifndef OAIUpdateImageSetMetadata_request_H
#define OAIUpdateImageSetMetadata_request_H
...
namespace OpenAPI {
class OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates;

class OAIUpdateImageSetMetadata_request : public OAIObject {
public:
    OAIUpdateImageSetMetadata_request();
    OAIUpdateImageSetMetadata_request(QString json);
    ~OAIUpdateImageSetMetadata_request() override;
    ...
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates getUpdateImageSetMetadataUpdates() const;
    void setUpdateImageSetMetadataUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates &update_image_set_metadata_updates);
...
private:
    ...
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates m_update_image_set_metadata_updates;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadata_request)

#endif // OAIUpdateImageSetMetadata_request_H
