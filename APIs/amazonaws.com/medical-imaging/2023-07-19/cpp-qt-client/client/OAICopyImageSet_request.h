...
/*
 * OAICopyImageSet_request.h
 *
 * 
 */

#ifndef OAICopyImageSet_request_H
#define OAICopyImageSet_request_H
...
namespace OpenAPI {
class OAICopyImageSet_request_copyImageSetInformation;

class OAICopyImageSet_request : public OAIObject {
public:
    OAICopyImageSet_request();
    OAICopyImageSet_request(QString json);
    ~OAICopyImageSet_request() override;
    ...
    OAICopyImageSet_request_copyImageSetInformation getCopyImageSetInformation() const;
    void setCopyImageSetInformation(const OAICopyImageSet_request_copyImageSetInformation &copy_image_set_information);
    bool is_copy_image_set_information_Set() const;
    bool is_copy_image_set_information_Valid() const;
...
private:
    ...
    OAICopyImageSet_request_copyImageSetInformation m_copy_image_set_information;
    bool m_copy_image_set_information_isSet;
    bool m_copy_image_set_information_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSet_request)

#endif // OAICopyImageSet_request_H
