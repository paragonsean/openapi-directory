...
OAIGetImageFrameResponse::OAIGetImageFrameResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetImageFrameResponse::OAIGetImageFrameResponse() {
    this->initializeModel();
}

OAIGetImageFrameResponse::~OAIGetImageFrameResponse() {}

void OAIGetImageFrameResponse::initializeModel() {

    m_image_frame_blob_isSet = false;
    m_image_frame_blob_isValid = false;
}

void OAIGetImageFrameResponse::fromJson(QString jsonString) {
...
void OAIGetImageFrameResponse::fromJsonObject(QJsonObject json) {

    m_image_frame_blob_isValid = ::OpenAPI::fromJsonValue(m_image_frame_blob, json[QString("imageFrameBlob")]);
    m_image_frame_blob_isSet = !json[QString("imageFrameBlob")].isNull() && m_image_frame_blob_isValid;
}

QString OAIGetImageFrameResponse::asJson() const {
...
QJsonObject OAIGetImageFrameResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_image_frame_blob_isSet) {
        obj.insert(QString("imageFrameBlob"), ::OpenAPI::toJsonValue(m_image_frame_blob));
    }
    return obj;
}

QString OAIGetImageFrameResponse::getImageFrameBlob() const {
    return m_image_frame_blob;
}
void OAIGetImageFrameResponse::setImageFrameBlob(const QString &image_frame_blob) {
    m_image_frame_blob = image_frame_blob;
    m_image_frame_blob_isSet = true;
}

bool OAIGetImageFrameResponse::is_image_frame_blob_Set() const{
    return m_image_frame_blob_isSet;
}

bool OAIGetImageFrameResponse::is_image_frame_blob_Valid() const{
    return m_image_frame_blob_isValid;
}

bool OAIGetImageFrameResponse::isSet() const {
...
bool OAIGetImageFrameResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_image_frame_blob_isValid && true;
}
