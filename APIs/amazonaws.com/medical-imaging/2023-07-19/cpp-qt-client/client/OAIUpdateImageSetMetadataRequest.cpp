...
#include "OAIUpdateImageSetMetadataRequest.h"
...
OAIUpdateImageSetMetadataRequest::OAIUpdateImageSetMetadataRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateImageSetMetadataRequest::OAIUpdateImageSetMetadataRequest() {
    this->initializeModel();
}

OAIUpdateImageSetMetadataRequest::~OAIUpdateImageSetMetadataRequest() {}

void OAIUpdateImageSetMetadataRequest::initializeModel() {

    m_update_image_set_metadata_updates_isSet = false;
    m_update_image_set_metadata_updates_isValid = false;
}

void OAIUpdateImageSetMetadataRequest::fromJson(QString jsonString) {
...
void OAIUpdateImageSetMetadataRequest::fromJsonObject(QJsonObject json) {

    m_update_image_set_metadata_updates_isValid = ::OpenAPI::fromJsonValue(m_update_image_set_metadata_updates, json[QString("updateImageSetMetadataUpdates")]);
    m_update_image_set_metadata_updates_isSet = !json[QString("updateImageSetMetadataUpdates")].isNull() && m_update_image_set_metadata_updates_isValid;
}

QString OAIUpdateImageSetMetadataRequest::asJson() const {
...
QJsonObject OAIUpdateImageSetMetadataRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_update_image_set_metadata_updates.isSet()) {
        obj.insert(QString("updateImageSetMetadataUpdates"), ::OpenAPI::toJsonValue(m_update_image_set_metadata_updates));
    }
    return obj;
}

OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates OAIUpdateImageSetMetadataRequest::getUpdateImageSetMetadataUpdates() const {
    return m_update_image_set_metadata_updates;
}
void OAIUpdateImageSetMetadataRequest::setUpdateImageSetMetadataUpdates(const OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates &update_image_set_metadata_updates) {
    m_update_image_set_metadata_updates = update_image_set_metadata_updates;
    m_update_image_set_metadata_updates_isSet = true;
}

bool OAIUpdateImageSetMetadataRequest::is_update_image_set_metadata_updates_Set() const{
    return m_update_image_set_metadata_updates_isSet;
}

bool OAIUpdateImageSetMetadataRequest::is_update_image_set_metadata_updates_Valid() const{
    return m_update_image_set_metadata_updates_isValid;
}

bool OAIUpdateImageSetMetadataRequest::isSet() const {
...
bool OAIUpdateImageSetMetadataRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_update_image_set_metadata_updates_isValid && true;
}
