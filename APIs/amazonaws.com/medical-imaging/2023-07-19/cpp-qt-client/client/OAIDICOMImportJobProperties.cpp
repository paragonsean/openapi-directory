...
#include "OAIDICOMImportJobProperties.h"
...
OAIDICOMImportJobProperties::OAIDICOMImportJobProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDICOMImportJobProperties::OAIDICOMImportJobProperties() {
    this->initializeModel();
}

OAIDICOMImportJobProperties::~OAIDICOMImportJobProperties() {}

void OAIDICOMImportJobProperties::initializeModel() {
...
void OAIDICOMImportJobProperties::fromJson(QString jsonString) {
...
void OAIDICOMImportJobProperties::fromJsonObject(QJsonObject json) {
...
QString OAIDICOMImportJobProperties::asJson() const {
...
QJsonObject OAIDICOMImportJobProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIDICOMImportJobProperties::getJobId() const {
    return m_job_id;
}
void OAIDICOMImportJobProperties::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIDICOMImportJobProperties::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIDICOMImportJobProperties::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAIDICOMImportJobProperties::getJobName() const {
    return m_job_name;
}
void OAIDICOMImportJobProperties::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAIDICOMImportJobProperties::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAIDICOMImportJobProperties::is_job_name_Valid() const{
    return m_job_name_isValid;
}

OAIJobStatus OAIDICOMImportJobProperties::getJobStatus() const {
    return m_job_status;
}
void OAIDICOMImportJobProperties::setJobStatus(const OAIJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIDICOMImportJobProperties::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIDICOMImportJobProperties::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIDICOMImportJobProperties::getDatastoreId() const {
    return m_datastore_id;
}
void OAIDICOMImportJobProperties::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAIDICOMImportJobProperties::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAIDICOMImportJobProperties::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

QString OAIDICOMImportJobProperties::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIDICOMImportJobProperties::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIDICOMImportJobProperties::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIDICOMImportJobProperties::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

QDateTime OAIDICOMImportJobProperties::getEndedAt() const {
    return m_ended_at;
}
void OAIDICOMImportJobProperties::setEndedAt(const QDateTime &ended_at) {
    m_ended_at = ended_at;
    m_ended_at_isSet = true;
}

bool OAIDICOMImportJobProperties::is_ended_at_Set() const{
    return m_ended_at_isSet;
}

bool OAIDICOMImportJobProperties::is_ended_at_Valid() const{
    return m_ended_at_isValid;
}

QDateTime OAIDICOMImportJobProperties::getSubmittedAt() const {
    return m_submitted_at;
}
void OAIDICOMImportJobProperties::setSubmittedAt(const QDateTime &submitted_at) {
    m_submitted_at = submitted_at;
    m_submitted_at_isSet = true;
}

bool OAIDICOMImportJobProperties::is_submitted_at_Set() const{
    return m_submitted_at_isSet;
}

bool OAIDICOMImportJobProperties::is_submitted_at_Valid() const{
    return m_submitted_at_isValid;
}

QString OAIDICOMImportJobProperties::getInputS3Uri() const {
    return m_input_s3_uri;
}
void OAIDICOMImportJobProperties::setInputS3Uri(const QString &input_s3_uri) {
    m_input_s3_uri = input_s3_uri;
    m_input_s3_uri_isSet = true;
}

bool OAIDICOMImportJobProperties::is_input_s3_uri_Set() const{
    return m_input_s3_uri_isSet;
}

bool OAIDICOMImportJobProperties::is_input_s3_uri_Valid() const{
    return m_input_s3_uri_isValid;
}

QString OAIDICOMImportJobProperties::getOutputS3Uri() const {
    return m_output_s3_uri;
}
void OAIDICOMImportJobProperties::setOutputS3Uri(const QString &output_s3_uri) {
    m_output_s3_uri = output_s3_uri;
    m_output_s3_uri_isSet = true;
}

bool OAIDICOMImportJobProperties::is_output_s3_uri_Set() const{
    return m_output_s3_uri_isSet;
}

bool OAIDICOMImportJobProperties::is_output_s3_uri_Valid() const{
    return m_output_s3_uri_isValid;
}

QString OAIDICOMImportJobProperties::getMessage() const {
    return m_message;
}
void OAIDICOMImportJobProperties::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDICOMImportJobProperties::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDICOMImportJobProperties::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIDICOMImportJobProperties::isSet() const {
...
bool OAIDICOMImportJobProperties::isValid() const {
