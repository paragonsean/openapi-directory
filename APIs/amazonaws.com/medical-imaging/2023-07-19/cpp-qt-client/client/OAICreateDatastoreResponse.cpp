...
OAICreateDatastoreResponse::OAICreateDatastoreResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDatastoreResponse::OAICreateDatastoreResponse() {
    this->initializeModel();
}

OAICreateDatastoreResponse::~OAICreateDatastoreResponse() {}

void OAICreateDatastoreResponse::initializeModel() {
...
void OAICreateDatastoreResponse::fromJson(QString jsonString) {
...
void OAICreateDatastoreResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateDatastoreResponse::asJson() const {
...
QJsonObject OAICreateDatastoreResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateDatastoreResponse::getDatastoreId() const {
    return m_datastore_id;
}
void OAICreateDatastoreResponse::setDatastoreId(const QString &datastore_id) {
    m_datastore_id = datastore_id;
    m_datastore_id_isSet = true;
}

bool OAICreateDatastoreResponse::is_datastore_id_Set() const{
    return m_datastore_id_isSet;
}

bool OAICreateDatastoreResponse::is_datastore_id_Valid() const{
    return m_datastore_id_isValid;
}

OAIDatastoreStatus OAICreateDatastoreResponse::getDatastoreStatus() const {
    return m_datastore_status;
}
void OAICreateDatastoreResponse::setDatastoreStatus(const OAIDatastoreStatus &datastore_status) {
    m_datastore_status = datastore_status;
    m_datastore_status_isSet = true;
}

bool OAICreateDatastoreResponse::is_datastore_status_Set() const{
    return m_datastore_status_isSet;
}

bool OAICreateDatastoreResponse::is_datastore_status_Valid() const{
    return m_datastore_status_isValid;
}

bool OAICreateDatastoreResponse::isSet() const {
...
bool OAICreateDatastoreResponse::isValid() const {
