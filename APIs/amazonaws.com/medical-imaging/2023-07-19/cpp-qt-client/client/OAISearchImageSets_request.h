...
/*
 * OAISearchImageSets_request.h
 *
 * 
 */

#ifndef OAISearchImageSets_request_H
#define OAISearchImageSets_request_H
...
namespace OpenAPI {
class OAISearchImageSets_request_searchCriteria;

class OAISearchImageSets_request : public OAIObject {
public:
    OAISearchImageSets_request();
    OAISearchImageSets_request(QString json);
    ~OAISearchImageSets_request() override;
    ...
    OAISearchImageSets_request_searchCriteria getSearchCriteria() const;
    void setSearchCriteria(const OAISearchImageSets_request_searchCriteria &search_criteria);
...
private:
    ...
    OAISearchImageSets_request_searchCriteria m_search_criteria;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchImageSets_request)

#endif // OAISearchImageSets_request_H
