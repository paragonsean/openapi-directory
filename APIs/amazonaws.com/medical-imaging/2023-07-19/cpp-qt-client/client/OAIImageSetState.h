...
#ifndef OAIImageSetState_H
#define OAIImageSetState_H
...
class OAIImageSetState : public OAIEnum {
public:
    OAIImageSetState();
    OAIImageSetState(QString json);
    ~OAIImageSetState() override;
    ...
    enum class eOAIImageSetState {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        LOCKED, 
        DELETED
    };
    OAIImageSetState::eOAIImageSetState getValue() const;
    void setValue(const OAIImageSetState::eOAIImageSetState& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSetState)

#endif // OAIImageSetState_H
