...
/*
 * OAISearchByAttributeValue.h
 *
 * The search input attribute value.
 */

#ifndef OAISearchByAttributeValue_H
#define OAISearchByAttributeValue_H

#include <QJsonObject>

#include "OAISearchByAttributeValue_DICOMStudyDateAndTime.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAISearchByAttributeValue_DICOMStudyDateAndTime;

class OAISearchByAttributeValue : public OAIObject {
public:
    OAISearchByAttributeValue();
    OAISearchByAttributeValue(QString json);
    ~OAISearchByAttributeValue() override;
    ...
    OAISearchByAttributeValue_DICOMStudyDateAndTime getDicomStudyDateAndTime() const;
    void setDicomStudyDateAndTime(const OAISearchByAttributeValue_DICOMStudyDateAndTime &dicom_study_date_and_time);
    bool is_dicom_study_date_and_time_Set() const;
    bool is_dicom_study_date_and_time_Valid() const;
...
private:
    ...
    OAISearchByAttributeValue_DICOMStudyDateAndTime m_dicom_study_date_and_time;
    bool m_dicom_study_date_and_time_isSet;
    bool m_dicom_study_date_and_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchByAttributeValue)

#endif // OAISearchByAttributeValue_H
