...
OAIStartDICOMImportJob_request::OAIStartDICOMImportJob_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartDICOMImportJob_request::OAIStartDICOMImportJob_request() {
    this->initializeModel();
}

OAIStartDICOMImportJob_request::~OAIStartDICOMImportJob_request() {}

void OAIStartDICOMImportJob_request::initializeModel() {
...
void OAIStartDICOMImportJob_request::fromJson(QString jsonString) {
...
void OAIStartDICOMImportJob_request::fromJsonObject(QJsonObject json) {
...
QString OAIStartDICOMImportJob_request::asJson() const {
...
QJsonObject OAIStartDICOMImportJob_request::asJsonObject() const {
    QJsonObject obj;
    if (m_job_name_isSet) {
...
QString OAIStartDICOMImportJob_request::getJobName() const {
    return m_job_name;
}
void OAIStartDICOMImportJob_request::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAIStartDICOMImportJob_request::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAIStartDICOMImportJob_request::is_job_name_Valid() const{
    return m_job_name_isValid;
}

QString OAIStartDICOMImportJob_request::getDataAccessRoleArn() const {
    return m_data_access_role_arn;
}
void OAIStartDICOMImportJob_request::setDataAccessRoleArn(const QString &data_access_role_arn) {
    m_data_access_role_arn = data_access_role_arn;
    m_data_access_role_arn_isSet = true;
}

bool OAIStartDICOMImportJob_request::is_data_access_role_arn_Set() const{
    return m_data_access_role_arn_isSet;
}

bool OAIStartDICOMImportJob_request::is_data_access_role_arn_Valid() const{
    return m_data_access_role_arn_isValid;
}

QString OAIStartDICOMImportJob_request::getClientToken() const {
    return m_client_token;
}
void OAIStartDICOMImportJob_request::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIStartDICOMImportJob_request::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIStartDICOMImportJob_request::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QString OAIStartDICOMImportJob_request::getInputS3Uri() const {
    return m_input_s3_uri;
}
void OAIStartDICOMImportJob_request::setInputS3Uri(const QString &input_s3_uri) {
    m_input_s3_uri = input_s3_uri;
    m_input_s3_uri_isSet = true;
}

bool OAIStartDICOMImportJob_request::is_input_s3_uri_Set() const{
    return m_input_s3_uri_isSet;
}

bool OAIStartDICOMImportJob_request::is_input_s3_uri_Valid() const{
    return m_input_s3_uri_isValid;
}

QString OAIStartDICOMImportJob_request::getOutputS3Uri() const {
    return m_output_s3_uri;
}
void OAIStartDICOMImportJob_request::setOutputS3Uri(const QString &output_s3_uri) {
    m_output_s3_uri = output_s3_uri;
    m_output_s3_uri_isSet = true;
}

bool OAIStartDICOMImportJob_request::is_output_s3_uri_Set() const{
    return m_output_s3_uri_isSet;
}

bool OAIStartDICOMImportJob_request::is_output_s3_uri_Valid() const{
    return m_output_s3_uri_isValid;
}

bool OAIStartDICOMImportJob_request::isSet() const {
...
bool OAIStartDICOMImportJob_request::isValid() const {
