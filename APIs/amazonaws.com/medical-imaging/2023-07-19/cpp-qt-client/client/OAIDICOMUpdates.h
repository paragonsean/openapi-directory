...
#ifndef OAIDICOMUpdates_H
#define OAIDICOMUpdates_H
...
class OAIDICOMUpdates : public OAIObject {
public:
    OAIDICOMUpdates();
    OAIDICOMUpdates(QString json);
    ~OAIDICOMUpdates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDICOMUpdates)

#endif // OAIDICOMUpdates_H
