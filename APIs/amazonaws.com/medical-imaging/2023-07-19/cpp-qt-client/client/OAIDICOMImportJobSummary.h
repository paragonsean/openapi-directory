...
/*
 * OAIDICOMImportJobSummary.h
 *
 * Summary of import job.
 */

#ifndef OAIDICOMImportJobSummary_H
#define OAIDICOMImportJobSummary_H
...
class OAIDICOMImportJobSummary : public OAIObject {
public:
    OAIDICOMImportJobSummary();
    OAIDICOMImportJobSummary(QString json);
    ~OAIDICOMImportJobSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDICOMImportJobSummary)

#endif // OAIDICOMImportJobSummary_H
