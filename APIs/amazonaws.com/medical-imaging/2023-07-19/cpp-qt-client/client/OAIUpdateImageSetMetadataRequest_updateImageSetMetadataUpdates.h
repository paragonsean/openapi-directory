...
/*
 * OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates.h
 *
 * 
 */

#ifndef OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates_H
#define OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates_H

#include <QJsonObject>

#include "OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates;

class OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates : public OAIObject {
public:
    OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates();
    OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates(QString json);
    ~OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates() override;
    ...
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates getDicomUpdates() const;
    void setDicomUpdates(const OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates &dicom_updates);
    bool is_dicom_updates_Set() const;
    bool is_dicom_updates_Valid() const;
...
private:
    ...
    OAIUpdateImageSetMetadata_request_updateImageSetMetadataUpdates_DICOMUpdates m_dicom_updates;
    bool m_dicom_updates_isSet;
    bool m_dicom_updates_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates)

#endif // OAIUpdateImageSetMetadataRequest_updateImageSetMetadataUpdates_H
