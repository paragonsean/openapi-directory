...
#include "OAICopySourceImageSetProperties.h"
...
OAICopySourceImageSetProperties::OAICopySourceImageSetProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopySourceImageSetProperties::OAICopySourceImageSetProperties() {
    this->initializeModel();
}

OAICopySourceImageSetProperties::~OAICopySourceImageSetProperties() {}

void OAICopySourceImageSetProperties::initializeModel() {
...
void OAICopySourceImageSetProperties::fromJson(QString jsonString) {
...
void OAICopySourceImageSetProperties::fromJsonObject(QJsonObject json) {
...
QString OAICopySourceImageSetProperties::asJson() const {
...
QJsonObject OAICopySourceImageSetProperties::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopySourceImageSetProperties::getImageSetId() const {
    return m_image_set_id;
}
void OAICopySourceImageSetProperties::setImageSetId(const QString &image_set_id) {
    m_image_set_id = image_set_id;
    m_image_set_id_isSet = true;
}

bool OAICopySourceImageSetProperties::is_image_set_id_Set() const{
    return m_image_set_id_isSet;
}

bool OAICopySourceImageSetProperties::is_image_set_id_Valid() const{
    return m_image_set_id_isValid;
}

QString OAICopySourceImageSetProperties::getLatestVersionId() const {
    return m_latest_version_id;
}
void OAICopySourceImageSetProperties::setLatestVersionId(const QString &latest_version_id) {
    m_latest_version_id = latest_version_id;
    m_latest_version_id_isSet = true;
}

bool OAICopySourceImageSetProperties::is_latest_version_id_Set() const{
    return m_latest_version_id_isSet;
}

bool OAICopySourceImageSetProperties::is_latest_version_id_Valid() const{
    return m_latest_version_id_isValid;
}

OAIImageSetState OAICopySourceImageSetProperties::getImageSetState() const {
    return m_image_set_state;
}
void OAICopySourceImageSetProperties::setImageSetState(const OAIImageSetState &image_set_state) {
    m_image_set_state = image_set_state;
    m_image_set_state_isSet = true;
}

bool OAICopySourceImageSetProperties::is_image_set_state_Set() const{
    return m_image_set_state_isSet;
}

bool OAICopySourceImageSetProperties::is_image_set_state_Valid() const{
    return m_image_set_state_isValid;
}

OAIImageSetWorkflowStatus OAICopySourceImageSetProperties::getImageSetWorkflowStatus() const {
    return m_image_set_workflow_status;
}
void OAICopySourceImageSetProperties::setImageSetWorkflowStatus(const OAIImageSetWorkflowStatus &image_set_workflow_status) {
    m_image_set_workflow_status = image_set_workflow_status;
    m_image_set_workflow_status_isSet = true;
}

bool OAICopySourceImageSetProperties::is_image_set_workflow_status_Set() const{
    return m_image_set_workflow_status_isSet;
}

bool OAICopySourceImageSetProperties::is_image_set_workflow_status_Valid() const{
    return m_image_set_workflow_status_isValid;
}

QDateTime OAICopySourceImageSetProperties::getCreatedAt() const {
    return m_created_at;
}
void OAICopySourceImageSetProperties::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICopySourceImageSetProperties::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICopySourceImageSetProperties::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAICopySourceImageSetProperties::getUpdatedAt() const {
    return m_updated_at;
}
void OAICopySourceImageSetProperties::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAICopySourceImageSetProperties::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAICopySourceImageSetProperties::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAICopySourceImageSetProperties::getImageSetArn() const {
    return m_image_set_arn;
}
void OAICopySourceImageSetProperties::setImageSetArn(const QString &image_set_arn) {
    m_image_set_arn = image_set_arn;
    m_image_set_arn_isSet = true;
}

bool OAICopySourceImageSetProperties::is_image_set_arn_Set() const{
    return m_image_set_arn_isSet;
}

bool OAICopySourceImageSetProperties::is_image_set_arn_Valid() const{
    return m_image_set_arn_isValid;
}

bool OAICopySourceImageSetProperties::isSet() const {
...
bool OAICopySourceImageSetProperties::isValid() const {
