...
#include "OAICopyDestinationImageSet.h"
...
OAICopyDestinationImageSet::OAICopyDestinationImageSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyDestinationImageSet::OAICopyDestinationImageSet() {
    this->initializeModel();
}

OAICopyDestinationImageSet::~OAICopyDestinationImageSet() {}

void OAICopyDestinationImageSet::initializeModel() {
...
void OAICopyDestinationImageSet::fromJson(QString jsonString) {
...
void OAICopyDestinationImageSet::fromJsonObject(QJsonObject json) {
...
QString OAICopyDestinationImageSet::asJson() const {
...
QJsonObject OAICopyDestinationImageSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyDestinationImageSet::getImageSetId() const {
    return m_image_set_id;
}
void OAICopyDestinationImageSet::setImageSetId(const QString &image_set_id) {
    m_image_set_id = image_set_id;
    m_image_set_id_isSet = true;
}

bool OAICopyDestinationImageSet::is_image_set_id_Set() const{
    return m_image_set_id_isSet;
}

bool OAICopyDestinationImageSet::is_image_set_id_Valid() const{
    return m_image_set_id_isValid;
}

QString OAICopyDestinationImageSet::getLatestVersionId() const {
    return m_latest_version_id;
}
void OAICopyDestinationImageSet::setLatestVersionId(const QString &latest_version_id) {
    m_latest_version_id = latest_version_id;
    m_latest_version_id_isSet = true;
}

bool OAICopyDestinationImageSet::is_latest_version_id_Set() const{
    return m_latest_version_id_isSet;
}

bool OAICopyDestinationImageSet::is_latest_version_id_Valid() const{
    return m_latest_version_id_isValid;
}

bool OAICopyDestinationImageSet::isSet() const {
...
bool OAICopyDestinationImageSet::isValid() const {
