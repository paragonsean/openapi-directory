...
/*
 * OAICopyImageSet_request_copyImageSetInformation_destinationImageSet.h
 *
 * 
 */

#ifndef OAICopyImageSet_request_copyImageSetInformation_destinationImageSet_H
#define OAICopyImageSet_request_copyImageSetInformation_destinationImageSet_H
...
class OAICopyImageSet_request_copyImageSetInformation_destinationImageSet : public OAIObject {
public:
    OAICopyImageSet_request_copyImageSetInformation_destinationImageSet();
    OAICopyImageSet_request_copyImageSetInformation_destinationImageSet(QString json);
    ~OAICopyImageSet_request_copyImageSetInformation_destinationImageSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyImageSet_request_copyImageSetInformation_destinationImageSet)

#endif // OAICopyImageSet_request_copyImageSetInformation_destinationImageSet_H
