...
/*
 * OAICopySourceImageSetInformation.h
 *
 * Copy source image set information.
 */

#ifndef OAICopySourceImageSetInformation_H
#define OAICopySourceImageSetInformation_H
...
class OAICopySourceImageSetInformation : public OAIObject {
public:
    OAICopySourceImageSetInformation();
    OAICopySourceImageSetInformation(QString json);
    ~OAICopySourceImageSetInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopySourceImageSetInformation)

#endif // OAICopySourceImageSetInformation_H
