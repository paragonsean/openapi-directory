...
#include "OAICopyImageSetRequest_copyImageSetInformation.h"
...
OAICopyImageSetRequest_copyImageSetInformation::OAICopyImageSetRequest_copyImageSetInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSetRequest_copyImageSetInformation::OAICopyImageSetRequest_copyImageSetInformation() {
    this->initializeModel();
}

OAICopyImageSetRequest_copyImageSetInformation::~OAICopyImageSetRequest_copyImageSetInformation() {}

void OAICopyImageSetRequest_copyImageSetInformation::initializeModel() {
...
void OAICopyImageSetRequest_copyImageSetInformation::fromJson(QString jsonString) {
...
void OAICopyImageSetRequest_copyImageSetInformation::fromJsonObject(QJsonObject json) {
...
QString OAICopyImageSetRequest_copyImageSetInformation::asJson() const {
...
QJsonObject OAICopyImageSetRequest_copyImageSetInformation::asJsonObject() const {
    QJsonObject obj;
...
OAICopyImageSet_request_copyImageSetInformation_sourceImageSet OAICopyImageSetRequest_copyImageSetInformation::getSourceImageSet() const {
    return m_source_image_set;
}
void OAICopyImageSetRequest_copyImageSetInformation::setSourceImageSet(const OAICopyImageSet_request_copyImageSetInformation_sourceImageSet &source_image_set) {
    m_source_image_set = source_image_set;
    m_source_image_set_isSet = true;
}

bool OAICopyImageSetRequest_copyImageSetInformation::is_source_image_set_Set() const{
    return m_source_image_set_isSet;
}

bool OAICopyImageSetRequest_copyImageSetInformation::is_source_image_set_Valid() const{
    return m_source_image_set_isValid;
}

OAICopyImageSet_request_copyImageSetInformation_destinationImageSet OAICopyImageSetRequest_copyImageSetInformation::getDestinationImageSet() const {
    return m_destination_image_set;
}
void OAICopyImageSetRequest_copyImageSetInformation::setDestinationImageSet(const OAICopyImageSet_request_copyImageSetInformation_destinationImageSet &destination_image_set) {
    m_destination_image_set = destination_image_set;
    m_destination_image_set_isSet = true;
}

bool OAICopyImageSetRequest_copyImageSetInformation::is_destination_image_set_Set() const{
    return m_destination_image_set_isSet;
}

bool OAICopyImageSetRequest_copyImageSetInformation::is_destination_image_set_Valid() const{
    return m_destination_image_set_isValid;
}

bool OAICopyImageSetRequest_copyImageSetInformation::isSet() const {
...
bool OAICopyImageSetRequest_copyImageSetInformation::isValid() const {
