...
#include "OAICopyImageSet_request_copyImageSetInformation.h"
...
OAICopyImageSet_request_copyImageSetInformation::OAICopyImageSet_request_copyImageSetInformation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyImageSet_request_copyImageSetInformation::OAICopyImageSet_request_copyImageSetInformation() {
    this->initializeModel();
}

OAICopyImageSet_request_copyImageSetInformation::~OAICopyImageSet_request_copyImageSetInformation() {}

void OAICopyImageSet_request_copyImageSetInformation::initializeModel() {
...
void OAICopyImageSet_request_copyImageSetInformation::fromJson(QString jsonString) {
...
void OAICopyImageSet_request_copyImageSetInformation::fromJsonObject(QJsonObject json) {
...
QString OAICopyImageSet_request_copyImageSetInformation::asJson() const {
...
QJsonObject OAICopyImageSet_request_copyImageSetInformation::asJsonObject() const {
    QJsonObject obj;
...
OAICopyImageSet_request_copyImageSetInformation_sourceImageSet OAICopyImageSet_request_copyImageSetInformation::getSourceImageSet() const {
    return m_source_image_set;
}
void OAICopyImageSet_request_copyImageSetInformation::setSourceImageSet(const OAICopyImageSet_request_copyImageSetInformation_sourceImageSet &source_image_set) {
    m_source_image_set = source_image_set;
    m_source_image_set_isSet = true;
}

bool OAICopyImageSet_request_copyImageSetInformation::is_source_image_set_Set() const{
    return m_source_image_set_isSet;
}

bool OAICopyImageSet_request_copyImageSetInformation::is_source_image_set_Valid() const{
    return m_source_image_set_isValid;
}

OAICopyImageSet_request_copyImageSetInformation_destinationImageSet OAICopyImageSet_request_copyImageSetInformation::getDestinationImageSet() const {
    return m_destination_image_set;
}
void OAICopyImageSet_request_copyImageSetInformation::setDestinationImageSet(const OAICopyImageSet_request_copyImageSetInformation_destinationImageSet &destination_image_set) {
    m_destination_image_set = destination_image_set;
    m_destination_image_set_isSet = true;
}

bool OAICopyImageSet_request_copyImageSetInformation::is_destination_image_set_Set() const{
    return m_destination_image_set_isSet;
}

bool OAICopyImageSet_request_copyImageSetInformation::is_destination_image_set_Valid() const{
    return m_destination_image_set_isValid;
}

bool OAICopyImageSet_request_copyImageSetInformation::isSet() const {
...
bool OAICopyImageSet_request_copyImageSetInformation::isValid() const {
