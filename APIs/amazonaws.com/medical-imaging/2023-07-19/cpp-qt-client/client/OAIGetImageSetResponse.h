...
/*
 * OAIGetImageSetResponse.h
 *
 * 
 */

#ifndef OAIGetImageSetResponse_H
#define OAIGetImageSetResponse_H
...
class OAIGetImageSetResponse : public OAIObject {
public:
    OAIGetImageSetResponse();
    OAIGetImageSetResponse(QString json);
    ~OAIGetImageSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetImageSetResponse)

#endif // OAIGetImageSetResponse_H
