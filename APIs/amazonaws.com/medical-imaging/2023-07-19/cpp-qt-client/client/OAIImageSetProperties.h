...
/*
 * OAIImageSetProperties.h
 *
 * The image set properties.
 */

#ifndef OAIImageSetProperties_H
#define OAIImageSetProperties_H
...
class OAIImageSetProperties : public OAIObject {
public:
    OAIImageSetProperties();
    OAIImageSetProperties(QString json);
    ~OAIImageSetProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSetProperties)

#endif // OAIImageSetProperties_H
