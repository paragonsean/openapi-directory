...
class Example : public QObject {
    ...
    QString create();
    QString create();
    OAICopyImageSet_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICopyImageSet_request Example::create(){
    OAICopyImageSet_request obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::copyImageSetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::copyImageSetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString datastore_id = create(); // QString | The data store identifier.
      ...
      QString source_image_set_id = create(); // QString | The source image set identifier.
      ...
      OAICopyImageSet_request oai_copy_image_set_request = create(); // OAICopyImageSet_request | 
      ...
      apiInstance.copyImageSet(datastore_idsource_image_set_idoai_copy_image_set_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
