...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetDatastoreResponse();
  });
  ...
  describe('GetDatastoreResponse', function() {
    it('should create an instance of GetDatastoreResponse', function() {
      // uncomment below and update the code to test GetDatastoreResponse
      //var instance = new AwsHealthImaging.GetDatastoreResponse();
      //expect(instance).to.be.a(AwsHealthImaging.GetDatastoreResponse);
    });
