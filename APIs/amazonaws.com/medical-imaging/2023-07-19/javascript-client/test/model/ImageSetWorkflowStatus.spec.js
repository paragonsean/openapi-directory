...
(function(root, factory) {
  ...
  describe('ImageSetWorkflowStatus', function() {
    it('should create an instance of ImageSetWorkflowStatus', function() {
      // uncomment below and update the code to test ImageSetWorkflowStatus
      //var instance = new AwsHealthImaging.ImageSetWorkflowStatus();
      //expect(instance).to.be.a(AwsHealthImaging.ImageSetWorkflowStatus);
    });
