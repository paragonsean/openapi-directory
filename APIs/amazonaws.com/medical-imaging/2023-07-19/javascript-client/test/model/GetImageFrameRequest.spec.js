...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetImageFrameRequest();
  });
  ...
  describe('GetImageFrameRequest', function() {
    it('should create an instance of GetImageFrameRequest', function() {
      // uncomment below and update the code to test GetImageFrameRequest
      //var instance = new AwsHealthImaging.GetImageFrameRequest();
      //expect(instance).to.be.a(AwsHealthImaging.GetImageFrameRequest);
    });

    it('should have the property imageFrameInformation (base name: "imageFrameInformation")', function() {
      // uncomment below and update the code to test the property imageFrameInformation
      //var instance = new AwsHealthImaging.GetImageFrameRequest();
