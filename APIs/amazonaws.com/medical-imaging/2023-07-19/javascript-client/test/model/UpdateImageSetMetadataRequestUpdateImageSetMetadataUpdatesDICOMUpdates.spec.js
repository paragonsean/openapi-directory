...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates();
  });
  ...
  describe('UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates', function() {
    it('should create an instance of UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates', function() {
      // uncomment below and update the code to test UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates();
      //expect(instance).to.be.a(AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates);
    });

    it('should have the property removableAttributes (base name: "removableAttributes")', function() {
      // uncomment below and update the code to test the property removableAttributes
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates();
      //expect(instance).to.be();
    });

    it('should have the property updatableAttributes (base name: "updatableAttributes")', function() {
      // uncomment below and update the code to test the property updatableAttributes
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates();
      //expect(instance).to.be();
    });
