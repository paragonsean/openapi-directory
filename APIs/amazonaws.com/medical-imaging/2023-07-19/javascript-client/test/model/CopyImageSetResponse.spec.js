...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetResponse();
  });
  ...
  describe('CopyImageSetResponse', function() {
    it('should create an instance of CopyImageSetResponse', function() {
      // uncomment below and update the code to test CopyImageSetResponse
      //var instance = new AwsHealthImaging.CopyImageSetResponse();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetResponse);
    });
    ...
    it('should have the property sourceImageSetProperties (base name: "sourceImageSetProperties")', function() {
      // uncomment below and update the code to test the property sourceImageSetProperties
      //var instance = new AwsHealthImaging.CopyImageSetResponse();
      //expect(instance).to.be();
    });

    it('should have the property destinationImageSetProperties (base name: "destinationImageSetProperties")', function() {
      // uncomment below and update the code to test the property destinationImageSetProperties
      //var instance = new AwsHealthImaging.CopyImageSetResponse();
      //expect(instance).to.be();
    });
