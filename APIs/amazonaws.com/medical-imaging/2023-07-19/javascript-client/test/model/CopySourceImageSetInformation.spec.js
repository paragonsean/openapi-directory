...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopySourceImageSetInformation();
  });
  ...
  describe('CopySourceImageSetInformation', function() {
    it('should create an instance of CopySourceImageSetInformation', function() {
      // uncomment below and update the code to test CopySourceImageSetInformation
      //var instance = new AwsHealthImaging.CopySourceImageSetInformation();
      //expect(instance).to.be.a(AwsHealthImaging.CopySourceImageSetInformation);
    });
