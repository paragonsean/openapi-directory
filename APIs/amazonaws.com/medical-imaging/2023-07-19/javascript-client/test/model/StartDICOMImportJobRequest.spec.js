...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.StartDICOMImportJobRequest();
  });
  ...
  describe('StartDICOMImportJobRequest', function() {
    it('should create an instance of StartDICOMImportJobRequest', function() {
      // uncomment below and update the code to test StartDICOMImportJobRequest
      //var instance = new AwsHealthImaging.StartDICOMImportJobRequest();
      //expect(instance).to.be.a(AwsHealthImaging.StartDICOMImportJobRequest);
    });
