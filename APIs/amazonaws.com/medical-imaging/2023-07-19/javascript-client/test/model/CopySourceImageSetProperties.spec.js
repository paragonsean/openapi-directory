...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopySourceImageSetProperties();
  });
  ...
  describe('CopySourceImageSetProperties', function() {
    it('should create an instance of CopySourceImageSetProperties', function() {
      // uncomment below and update the code to test CopySourceImageSetProperties
      //var instance = new AwsHealthImaging.CopySourceImageSetProperties();
      //expect(instance).to.be.a(AwsHealthImaging.CopySourceImageSetProperties);
    });
