...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.StartDICOMImportJobResponse();
  });
  ...
  describe('StartDICOMImportJobResponse', function() {
    it('should create an instance of StartDICOMImportJobResponse', function() {
      // uncomment below and update the code to test StartDICOMImportJobResponse
      //var instance = new AwsHealthImaging.StartDICOMImportJobResponse();
      //expect(instance).to.be.a(AwsHealthImaging.StartDICOMImportJobResponse);
    });
