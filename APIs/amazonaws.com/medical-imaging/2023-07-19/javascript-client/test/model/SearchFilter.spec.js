...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchFilter();
  });
  ...
  describe('SearchFilter', function() {
    it('should create an instance of SearchFilter', function() {
      // uncomment below and update the code to test SearchFilter
      //var instance = new AwsHealthImaging.SearchFilter();
      //expect(instance).to.be.a(AwsHealthImaging.SearchFilter);
    });
