...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationDestinationImageSet();
  });
  ...
  describe('CopyImageSetRequestCopyImageSetInformationDestinationImageSet', function() {
    it('should create an instance of CopyImageSetRequestCopyImageSetInformationDestinationImageSet', function() {
      // uncomment below and update the code to test CopyImageSetRequestCopyImageSetInformationDestinationImageSet
      //var instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationDestinationImageSet();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationDestinationImageSet);
    });
