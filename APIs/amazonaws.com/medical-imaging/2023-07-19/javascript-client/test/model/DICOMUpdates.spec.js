...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DICOMUpdates();
  });
  ...
  describe('DICOMUpdates', function() {
    it('should create an instance of DICOMUpdates', function() {
      // uncomment below and update the code to test DICOMUpdates
      //var instance = new AwsHealthImaging.DICOMUpdates();
      //expect(instance).to.be.a(AwsHealthImaging.DICOMUpdates);
    });
