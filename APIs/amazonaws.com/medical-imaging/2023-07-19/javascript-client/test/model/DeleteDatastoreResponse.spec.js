...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DeleteDatastoreResponse();
  });
  ...
  describe('DeleteDatastoreResponse', function() {
    it('should create an instance of DeleteDatastoreResponse', function() {
      // uncomment below and update the code to test DeleteDatastoreResponse
      //var instance = new AwsHealthImaging.DeleteDatastoreResponse();
      //expect(instance).to.be.a(AwsHealthImaging.DeleteDatastoreResponse);
    });
