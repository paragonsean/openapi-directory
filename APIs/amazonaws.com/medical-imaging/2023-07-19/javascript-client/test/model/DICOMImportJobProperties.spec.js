...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DICOMImportJobProperties();
  });
  ...
  describe('DICOMImportJobProperties', function() {
    it('should create an instance of DICOMImportJobProperties', function() {
      // uncomment below and update the code to test DICOMImportJobProperties
      //var instance = new AwsHealthImaging.DICOMImportJobProperties();
      //expect(instance).to.be.a(AwsHealthImaging.DICOMImportJobProperties);
    });
