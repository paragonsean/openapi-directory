...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationSourceImageSet();
  });
  ...
  describe('CopyImageSetRequestCopyImageSetInformationSourceImageSet', function() {
    it('should create an instance of CopyImageSetRequestCopyImageSetInformationSourceImageSet', function() {
      // uncomment below and update the code to test CopyImageSetRequestCopyImageSetInformationSourceImageSet
      //var instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationSourceImageSet();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetRequestCopyImageSetInformationSourceImageSet);
    });
