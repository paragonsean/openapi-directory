...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetDICOMImportJobResponse();
  });
  ...
  describe('GetDICOMImportJobResponse', function() {
    it('should create an instance of GetDICOMImportJobResponse', function() {
      // uncomment below and update the code to test GetDICOMImportJobResponse
      //var instance = new AwsHealthImaging.GetDICOMImportJobResponse();
      //expect(instance).to.be.a(AwsHealthImaging.GetDICOMImportJobResponse);
    });

    it('should have the property jobProperties (base name: "jobProperties")', function() {
      // uncomment below and update the code to test the property jobProperties
      //var instance = new AwsHealthImaging.GetDICOMImportJobResponse();
