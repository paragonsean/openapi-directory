...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetRequest();
  });
  ...
  describe('CopyImageSetRequest', function() {
    it('should create an instance of CopyImageSetRequest', function() {
      // uncomment below and update the code to test CopyImageSetRequest
      //var instance = new AwsHealthImaging.CopyImageSetRequest();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetRequest);
    });

    it('should have the property copyImageSetInformation (base name: "copyImageSetInformation")', function() {
      // uncomment below and update the code to test the property copyImageSetInformation
      //var instance = new AwsHealthImaging.CopyImageSetRequest();
