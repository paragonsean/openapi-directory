...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsHealthImaging.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsHealthImaging.ListTagsForResourceResponse);
    });
