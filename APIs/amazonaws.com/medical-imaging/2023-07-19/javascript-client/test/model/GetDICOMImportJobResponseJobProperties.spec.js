...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetDICOMImportJobResponseJobProperties();
  });
  ...
  describe('GetDICOMImportJobResponseJobProperties', function() {
    it('should create an instance of GetDICOMImportJobResponseJobProperties', function() {
      // uncomment below and update the code to test GetDICOMImportJobResponseJobProperties
      //var instance = new AwsHealthImaging.GetDICOMImportJobResponseJobProperties();
      //expect(instance).to.be.a(AwsHealthImaging.GetDICOMImportJobResponseJobProperties);
    });
    ...
    it('should have the property inputS3Uri (base name: "inputS3Uri")', function() {
      // uncomment below and update the code to test the property inputS3Uri
      //var instance = new AwsHealthImaging.GetDICOMImportJobResponseJobProperties();
      //expect(instance).to.be();
    });
