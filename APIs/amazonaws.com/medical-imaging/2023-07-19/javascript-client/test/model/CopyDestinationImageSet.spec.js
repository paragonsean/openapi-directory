...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyDestinationImageSet();
  });
  ...
  describe('CopyDestinationImageSet', function() {
    it('should create an instance of CopyDestinationImageSet', function() {
      // uncomment below and update the code to test CopyDestinationImageSet
      //var instance = new AwsHealthImaging.CopyDestinationImageSet();
      //expect(instance).to.be.a(AwsHealthImaging.CopyDestinationImageSet);
    });
