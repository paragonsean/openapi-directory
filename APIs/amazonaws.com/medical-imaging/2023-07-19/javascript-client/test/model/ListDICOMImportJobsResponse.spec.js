...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ListDICOMImportJobsResponse();
  });
  ...
  describe('ListDICOMImportJobsResponse', function() {
    it('should create an instance of ListDICOMImportJobsResponse', function() {
      // uncomment below and update the code to test ListDICOMImportJobsResponse
      //var instance = new AwsHealthImaging.ListDICOMImportJobsResponse();
      //expect(instance).to.be.a(AwsHealthImaging.ListDICOMImportJobsResponse);
    });
