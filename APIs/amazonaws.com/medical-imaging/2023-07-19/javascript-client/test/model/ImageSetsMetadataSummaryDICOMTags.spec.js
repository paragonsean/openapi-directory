...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ImageSetsMetadataSummaryDICOMTags();
  });
  ...
  describe('ImageSetsMetadataSummaryDICOMTags', function() {
    it('should create an instance of ImageSetsMetadataSummaryDICOMTags', function() {
      // uncomment below and update the code to test ImageSetsMetadataSummaryDICOMTags
      //var instance = new AwsHealthImaging.ImageSetsMetadataSummaryDICOMTags();
      //expect(instance).to.be.a(AwsHealthImaging.ImageSetsMetadataSummaryDICOMTags);
    });
