...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DICOMTags();
  });
  ...
  describe('DICOMTags', function() {
    it('should create an instance of DICOMTags', function() {
      // uncomment below and update the code to test DICOMTags
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be.a(AwsHealthImaging.DICOMTags);
    });
    ...
    it('should have the property dICOMPatientName (base name: "DICOMPatientName")', function() {
      // uncomment below and update the code to test the property dICOMPatientName
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });

    it('should have the property dICOMPatientBirthDate (base name: "DICOMPatientBirthDate")', function() {
      // uncomment below and update the code to test the property dICOMPatientBirthDate
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });

    it('should have the property dICOMPatientSex (base name: "DICOMPatientSex")', function() {
      // uncomment below and update the code to test the property dICOMPatientSex
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dICOMStudyDescription (base name: "DICOMStudyDescription")', function() {
      // uncomment below and update the code to test the property dICOMStudyDescription
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });

    it('should have the property dICOMNumberOfStudyRelatedSeries (base name: "DICOMNumberOfStudyRelatedSeries")', function() {
      // uncomment below and update the code to test the property dICOMNumberOfStudyRelatedSeries
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });

    it('should have the property dICOMNumberOfStudyRelatedInstances (base name: "DICOMNumberOfStudyRelatedInstances")', function() {
      // uncomment below and update the code to test the property dICOMNumberOfStudyRelatedInstances
      //var instance = new AwsHealthImaging.DICOMTags();
      //expect(instance).to.be();
    });
