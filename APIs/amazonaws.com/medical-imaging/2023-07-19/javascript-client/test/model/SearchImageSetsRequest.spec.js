...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchImageSetsRequest();
  });
  ...
  describe('SearchImageSetsRequest', function() {
    it('should create an instance of SearchImageSetsRequest', function() {
      // uncomment below and update the code to test SearchImageSetsRequest
      //var instance = new AwsHealthImaging.SearchImageSetsRequest();
      //expect(instance).to.be.a(AwsHealthImaging.SearchImageSetsRequest);
    });
