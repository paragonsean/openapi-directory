...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates();
  });
  ...
  describe('UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates', function() {
    it('should create an instance of UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates', function() {
      // uncomment below and update the code to test UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates();
      //expect(instance).to.be.a(AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates);
    });

    it('should have the property dICOMUpdates (base name: "DICOMUpdates")', function() {
      // uncomment below and update the code to test the property dICOMUpdates
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates();
