...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetResponseDestinationImageSetProperties();
  });
  ...
  describe('CopyImageSetResponseDestinationImageSetProperties', function() {
    it('should create an instance of CopyImageSetResponseDestinationImageSetProperties', function() {
      // uncomment below and update the code to test CopyImageSetResponseDestinationImageSetProperties
      //var instance = new AwsHealthImaging.CopyImageSetResponseDestinationImageSetProperties();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetResponseDestinationImageSetProperties);
    });
