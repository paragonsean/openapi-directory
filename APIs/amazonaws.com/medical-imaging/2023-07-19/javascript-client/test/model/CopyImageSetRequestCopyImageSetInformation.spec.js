...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformation();
  });
  ...
  describe('CopyImageSetRequestCopyImageSetInformation', function() {
    it('should create an instance of CopyImageSetRequestCopyImageSetInformation', function() {
      // uncomment below and update the code to test CopyImageSetRequestCopyImageSetInformation
      //var instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformation();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetRequestCopyImageSetInformation);
    });

    it('should have the property sourceImageSet (base name: "sourceImageSet")', function() {
      // uncomment below and update the code to test the property sourceImageSet
      //var instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformation();
      //expect(instance).to.be();
    });

    it('should have the property destinationImageSet (base name: "destinationImageSet")', function() {
      // uncomment below and update the code to test the property destinationImageSet
      //var instance = new AwsHealthImaging.CopyImageSetRequestCopyImageSetInformation();
      //expect(instance).to.be();
    });
