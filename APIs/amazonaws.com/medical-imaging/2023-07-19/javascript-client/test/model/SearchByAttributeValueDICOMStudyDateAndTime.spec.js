...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchByAttributeValueDICOMStudyDateAndTime();
  });
  ...
  describe('SearchByAttributeValueDICOMStudyDateAndTime', function() {
    it('should create an instance of SearchByAttributeValueDICOMStudyDateAndTime', function() {
      // uncomment below and update the code to test SearchByAttributeValueDICOMStudyDateAndTime
      //var instance = new AwsHealthImaging.SearchByAttributeValueDICOMStudyDateAndTime();
      //expect(instance).to.be.a(AwsHealthImaging.SearchByAttributeValueDICOMStudyDateAndTime);
    });
