...
(function(root, factory) {
  ...
  describe('ImageSetState', function() {
    it('should create an instance of ImageSetState', function() {
      // uncomment below and update the code to test ImageSetState
      //var instance = new AwsHealthImaging.ImageSetState();
      //expect(instance).to.be.a(AwsHealthImaging.ImageSetState);
    });
