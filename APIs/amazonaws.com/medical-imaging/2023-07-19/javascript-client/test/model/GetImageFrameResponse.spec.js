...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetImageFrameResponse();
  });
  ...
  describe('GetImageFrameResponse', function() {
    it('should create an instance of GetImageFrameResponse', function() {
      // uncomment below and update the code to test GetImageFrameResponse
      //var instance = new AwsHealthImaging.GetImageFrameResponse();
      //expect(instance).to.be.a(AwsHealthImaging.GetImageFrameResponse);
    });

    it('should have the property imageFrameBlob (base name: "imageFrameBlob")', function() {
      // uncomment below and update the code to test the property imageFrameBlob
      //var instance = new AwsHealthImaging.GetImageFrameResponse();
