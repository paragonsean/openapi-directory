...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetDatastoreResponseDatastoreProperties();
  });
  ...
  describe('GetDatastoreResponseDatastoreProperties', function() {
    it('should create an instance of GetDatastoreResponseDatastoreProperties', function() {
      // uncomment below and update the code to test GetDatastoreResponseDatastoreProperties
      //var instance = new AwsHealthImaging.GetDatastoreResponseDatastoreProperties();
      //expect(instance).to.be.a(AwsHealthImaging.GetDatastoreResponseDatastoreProperties);
    });
