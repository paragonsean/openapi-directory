...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DICOMStudyDateAndTime();
  });
  ...
  describe('DICOMStudyDateAndTime', function() {
    it('should create an instance of DICOMStudyDateAndTime', function() {
      // uncomment below and update the code to test DICOMStudyDateAndTime
      //var instance = new AwsHealthImaging.DICOMStudyDateAndTime();
      //expect(instance).to.be.a(AwsHealthImaging.DICOMStudyDateAndTime);
    });

    it('should have the property dICOMStudyDate (base name: "DICOMStudyDate")', function() {
      // uncomment below and update the code to test the property dICOMStudyDate
      //var instance = new AwsHealthImaging.DICOMStudyDateAndTime();
      //expect(instance).to.be();
    });

    it('should have the property dICOMStudyTime (base name: "DICOMStudyTime")', function() {
      // uncomment below and update the code to test the property dICOMStudyTime
      //var instance = new AwsHealthImaging.DICOMStudyDateAndTime();
      //expect(instance).to.be();
    });
