...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsHealthImaging.TagResourceRequest();
      //expect(instance).to.be.a(AwsHealthImaging.TagResourceRequest);
    });
