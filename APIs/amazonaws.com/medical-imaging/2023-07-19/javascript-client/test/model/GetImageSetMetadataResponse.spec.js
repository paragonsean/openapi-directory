...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetImageSetMetadataResponse();
  });
  ...
  describe('GetImageSetMetadataResponse', function() {
    it('should create an instance of GetImageSetMetadataResponse', function() {
      // uncomment below and update the code to test GetImageSetMetadataResponse
      //var instance = new AwsHealthImaging.GetImageSetMetadataResponse();
      //expect(instance).to.be.a(AwsHealthImaging.GetImageSetMetadataResponse);
    });

    it('should have the property imageSetMetadataBlob (base name: "imageSetMetadataBlob")', function() {
      // uncomment below and update the code to test the property imageSetMetadataBlob
      //var instance = new AwsHealthImaging.GetImageSetMetadataResponse();
