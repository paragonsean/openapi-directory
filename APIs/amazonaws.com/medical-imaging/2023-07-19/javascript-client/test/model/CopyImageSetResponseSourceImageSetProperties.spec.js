...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
  });
  ...
  describe('CopyImageSetResponseSourceImageSetProperties', function() {
    it('should create an instance of CopyImageSetResponseSourceImageSetProperties', function() {
      // uncomment below and update the code to test CopyImageSetResponseSourceImageSetProperties
      //var instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties);
    });

    it('should have the property imageSetId (base name: "imageSetId")', function() {
      // uncomment below and update the code to test the property imageSetId
      //var instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
    ...
    it('should have the property imageSetState (base name: "imageSetState")', function() {
      // uncomment below and update the code to test the property imageSetState
      //var instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
      //expect(instance).to.be();
    });

    it('should have the property imageSetWorkflowStatus (base name: "imageSetWorkflowStatus")', function() {
      // uncomment below and update the code to test the property imageSetWorkflowStatus
      //var instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property imageSetArn (base name: "imageSetArn")', function() {
      // uncomment below and update the code to test the property imageSetArn
      //var instance = new AwsHealthImaging.CopyImageSetResponseSourceImageSetProperties();
      //expect(instance).to.be();
    });
