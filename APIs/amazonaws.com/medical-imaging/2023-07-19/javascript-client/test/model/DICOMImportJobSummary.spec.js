...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DICOMImportJobSummary();
  });
  ...
  describe('DICOMImportJobSummary', function() {
    it('should create an instance of DICOMImportJobSummary', function() {
      // uncomment below and update the code to test DICOMImportJobSummary
      //var instance = new AwsHealthImaging.DICOMImportJobSummary();
      //expect(instance).to.be.a(AwsHealthImaging.DICOMImportJobSummary);
    });
