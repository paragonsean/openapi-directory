...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchByAttributeValue();
  });
  ...
  describe('SearchByAttributeValue', function() {
    it('should create an instance of SearchByAttributeValue', function() {
      // uncomment below and update the code to test SearchByAttributeValue
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be.a(AwsHealthImaging.SearchByAttributeValue);
    });

    it('should have the property dICOMPatientId (base name: "DICOMPatientId")', function() {
      // uncomment below and update the code to test the property dICOMPatientId
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be();
    });

    it('should have the property dICOMAccessionNumber (base name: "DICOMAccessionNumber")', function() {
      // uncomment below and update the code to test the property dICOMAccessionNumber
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be();
    });

    it('should have the property dICOMStudyId (base name: "DICOMStudyId")', function() {
      // uncomment below and update the code to test the property dICOMStudyId
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be();
    });

    it('should have the property dICOMStudyInstanceUID (base name: "DICOMStudyInstanceUID")', function() {
      // uncomment below and update the code to test the property dICOMStudyInstanceUID
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dICOMStudyDateAndTime (base name: "DICOMStudyDateAndTime")', function() {
      // uncomment below and update the code to test the property dICOMStudyDateAndTime
      //var instance = new AwsHealthImaging.SearchByAttributeValue();
      //expect(instance).to.be();
    });
