...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ImageFrameInformation();
  });
  ...
  describe('ImageFrameInformation', function() {
    it('should create an instance of ImageFrameInformation', function() {
      // uncomment below and update the code to test ImageFrameInformation
      //var instance = new AwsHealthImaging.ImageFrameInformation();
      //expect(instance).to.be.a(AwsHealthImaging.ImageFrameInformation);
    });

    it('should have the property imageFrameId (base name: "imageFrameId")', function() {
      // uncomment below and update the code to test the property imageFrameId
      //var instance = new AwsHealthImaging.ImageFrameInformation();
