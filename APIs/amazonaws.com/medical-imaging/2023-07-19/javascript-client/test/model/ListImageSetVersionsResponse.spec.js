...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ListImageSetVersionsResponse();
  });
  ...
  describe('ListImageSetVersionsResponse', function() {
    it('should create an instance of ListImageSetVersionsResponse', function() {
      // uncomment below and update the code to test ListImageSetVersionsResponse
      //var instance = new AwsHealthImaging.ListImageSetVersionsResponse();
      //expect(instance).to.be.a(AwsHealthImaging.ListImageSetVersionsResponse);
    });

    it('should have the property imageSetPropertiesList (base name: "imageSetPropertiesList")', function() {
      // uncomment below and update the code to test the property imageSetPropertiesList
      //var instance = new AwsHealthImaging.ListImageSetVersionsResponse();
