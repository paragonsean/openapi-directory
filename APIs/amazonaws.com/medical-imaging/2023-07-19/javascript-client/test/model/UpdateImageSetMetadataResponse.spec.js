...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.UpdateImageSetMetadataResponse();
  });
  ...
  describe('UpdateImageSetMetadataResponse', function() {
    it('should create an instance of UpdateImageSetMetadataResponse', function() {
      // uncomment below and update the code to test UpdateImageSetMetadataResponse
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataResponse();
      //expect(instance).to.be.a(AwsHealthImaging.UpdateImageSetMetadataResponse);
    });
