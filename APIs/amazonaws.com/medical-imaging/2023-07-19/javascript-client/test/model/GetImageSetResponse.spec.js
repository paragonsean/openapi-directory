...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetImageSetResponse();
  });
  ...
  describe('GetImageSetResponse', function() {
    it('should create an instance of GetImageSetResponse', function() {
      // uncomment below and update the code to test GetImageSetResponse
      //var instance = new AwsHealthImaging.GetImageSetResponse();
      //expect(instance).to.be.a(AwsHealthImaging.GetImageSetResponse);
    });
