...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DeleteImageSetResponse();
  });
  ...
  describe('DeleteImageSetResponse', function() {
    it('should create an instance of DeleteImageSetResponse', function() {
      // uncomment below and update the code to test DeleteImageSetResponse
      //var instance = new AwsHealthImaging.DeleteImageSetResponse();
      //expect(instance).to.be.a(AwsHealthImaging.DeleteImageSetResponse);
    });
