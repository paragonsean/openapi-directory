...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DatastoreSummary();
  });
  ...
  describe('DatastoreSummary', function() {
    it('should create an instance of DatastoreSummary', function() {
      // uncomment below and update the code to test DatastoreSummary
      //var instance = new AwsHealthImaging.DatastoreSummary();
      //expect(instance).to.be.a(AwsHealthImaging.DatastoreSummary);
    });
