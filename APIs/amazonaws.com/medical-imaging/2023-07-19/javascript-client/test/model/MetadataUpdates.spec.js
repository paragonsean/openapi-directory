...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.MetadataUpdates();
  });
  ...
  describe('MetadataUpdates', function() {
    it('should create an instance of MetadataUpdates', function() {
      // uncomment below and update the code to test MetadataUpdates
      //var instance = new AwsHealthImaging.MetadataUpdates();
      //expect(instance).to.be.a(AwsHealthImaging.MetadataUpdates);
    });
