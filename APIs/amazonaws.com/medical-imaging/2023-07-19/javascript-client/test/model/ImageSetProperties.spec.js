...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ImageSetProperties();
  });
  ...
  describe('ImageSetProperties', function() {
    it('should create an instance of ImageSetProperties', function() {
      // uncomment below and update the code to test ImageSetProperties
      //var instance = new AwsHealthImaging.ImageSetProperties();
      //expect(instance).to.be.a(AwsHealthImaging.ImageSetProperties);
    });
