...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.DatastoreProperties();
  });
  ...
  describe('DatastoreProperties', function() {
    it('should create an instance of DatastoreProperties', function() {
      ...
      //var instance = new AwsHealthImaging.DatastoreProperties();
      //expect(instance).to.be.a(AwsHealthImaging.DatastoreProperties);
    });
