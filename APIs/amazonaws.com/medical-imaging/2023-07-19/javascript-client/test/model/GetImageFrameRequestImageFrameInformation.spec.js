...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.GetImageFrameRequestImageFrameInformation();
  });
  ...
  describe('GetImageFrameRequestImageFrameInformation', function() {
    it('should create an instance of GetImageFrameRequestImageFrameInformation', function() {
      // uncomment below and update the code to test GetImageFrameRequestImageFrameInformation
      //var instance = new AwsHealthImaging.GetImageFrameRequestImageFrameInformation();
      //expect(instance).to.be.a(AwsHealthImaging.GetImageFrameRequestImageFrameInformation);
    });
