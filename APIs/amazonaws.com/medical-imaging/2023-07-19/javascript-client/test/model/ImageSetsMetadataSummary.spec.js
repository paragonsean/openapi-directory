...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ImageSetsMetadataSummary();
  });
  ...
  describe('ImageSetsMetadataSummary', function() {
    it('should create an instance of ImageSetsMetadataSummary', function() {
      // uncomment below and update the code to test ImageSetsMetadataSummary
      //var instance = new AwsHealthImaging.ImageSetsMetadataSummary();
      //expect(instance).to.be.a(AwsHealthImaging.ImageSetsMetadataSummary);
    });
    ...
    it('should have the property dICOMTags (base name: "DICOMTags")', function() {
      // uncomment below and update the code to test the property dICOMTags
      //var instance = new AwsHealthImaging.ImageSetsMetadataSummary();
      //expect(instance).to.be();
    });
