...
(function(root, factory) {
  ...
  describe('DatastoreStatus', function() {
    it('should create an instance of DatastoreStatus', function() {
      // uncomment below and update the code to test DatastoreStatus
      //var instance = new AwsHealthImaging.DatastoreStatus();
      //expect(instance).to.be.a(AwsHealthImaging.DatastoreStatus);
    });
