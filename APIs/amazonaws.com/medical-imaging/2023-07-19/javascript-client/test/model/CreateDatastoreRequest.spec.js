...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CreateDatastoreRequest();
  });
  ...
  describe('CreateDatastoreRequest', function() {
    it('should create an instance of CreateDatastoreRequest', function() {
      // uncomment below and update the code to test CreateDatastoreRequest
      //var instance = new AwsHealthImaging.CreateDatastoreRequest();
      //expect(instance).to.be.a(AwsHealthImaging.CreateDatastoreRequest);
    });
