...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CreateDatastoreResponse();
  });
  ...
  describe('CreateDatastoreResponse', function() {
    it('should create an instance of CreateDatastoreResponse', function() {
      // uncomment below and update the code to test CreateDatastoreResponse
      //var instance = new AwsHealthImaging.CreateDatastoreResponse();
      //expect(instance).to.be.a(AwsHealthImaging.CreateDatastoreResponse);
    });
