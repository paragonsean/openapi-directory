...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyDestinationImageSetProperties();
  });
  ...
  describe('CopyDestinationImageSetProperties', function() {
    it('should create an instance of CopyDestinationImageSetProperties', function() {
      // uncomment below and update the code to test CopyDestinationImageSetProperties
      //var instance = new AwsHealthImaging.CopyDestinationImageSetProperties();
      //expect(instance).to.be.a(AwsHealthImaging.CopyDestinationImageSetProperties);
    });
