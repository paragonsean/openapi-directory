...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchImageSetsRequestSearchCriteria();
  });
  ...
  describe('SearchImageSetsRequestSearchCriteria', function() {
    it('should create an instance of SearchImageSetsRequestSearchCriteria', function() {
      // uncomment below and update the code to test SearchImageSetsRequestSearchCriteria
      //var instance = new AwsHealthImaging.SearchImageSetsRequestSearchCriteria();
      //expect(instance).to.be.a(AwsHealthImaging.SearchImageSetsRequestSearchCriteria);
    });
