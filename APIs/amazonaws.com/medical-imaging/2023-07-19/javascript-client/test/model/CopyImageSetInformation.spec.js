...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.CopyImageSetInformation();
  });
  ...
  describe('CopyImageSetInformation', function() {
    it('should create an instance of CopyImageSetInformation', function() {
      // uncomment below and update the code to test CopyImageSetInformation
      //var instance = new AwsHealthImaging.CopyImageSetInformation();
      //expect(instance).to.be.a(AwsHealthImaging.CopyImageSetInformation);
    });
