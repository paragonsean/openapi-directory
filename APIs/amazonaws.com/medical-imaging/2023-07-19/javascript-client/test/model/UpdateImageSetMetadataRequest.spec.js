...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.UpdateImageSetMetadataRequest();
  });
  ...
  describe('UpdateImageSetMetadataRequest', function() {
    it('should create an instance of UpdateImageSetMetadataRequest', function() {
      // uncomment below and update the code to test UpdateImageSetMetadataRequest
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequest();
      //expect(instance).to.be.a(AwsHealthImaging.UpdateImageSetMetadataRequest);
    });

    it('should have the property updateImageSetMetadataUpdates (base name: "updateImageSetMetadataUpdates")', function() {
      // uncomment below and update the code to test the property updateImageSetMetadataUpdates
      //var instance = new AwsHealthImaging.UpdateImageSetMetadataRequest();
