...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.ListDatastoresResponse();
  });
  ...
  describe('ListDatastoresResponse', function() {
    it('should create an instance of ListDatastoresResponse', function() {
      // uncomment below and update the code to test ListDatastoresResponse
      //var instance = new AwsHealthImaging.ListDatastoresResponse();
      //expect(instance).to.be.a(AwsHealthImaging.ListDatastoresResponse);
    });

    it('should have the property datastoreSummaries (base name: "datastoreSummaries")', function() {
      // uncomment below and update the code to test the property datastoreSummaries
      //var instance = new AwsHealthImaging.ListDatastoresResponse();
