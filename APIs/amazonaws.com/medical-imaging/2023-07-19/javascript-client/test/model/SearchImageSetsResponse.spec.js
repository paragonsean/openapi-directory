...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsHealthImaging.SearchImageSetsResponse();
  });
  ...
  describe('SearchImageSetsResponse', function() {
    it('should create an instance of SearchImageSetsResponse', function() {
      // uncomment below and update the code to test SearchImageSetsResponse
      //var instance = new AwsHealthImaging.SearchImageSetsResponse();
      //expect(instance).to.be.a(AwsHealthImaging.SearchImageSetsResponse);
    });

    it('should have the property imageSetsMetadataSummaries (base name: "imageSetsMetadataSummaries")', function() {
      // uncomment below and update the code to test the property imageSetsMetadataSummaries
      //var instance = new AwsHealthImaging.SearchImageSetsResponse();
