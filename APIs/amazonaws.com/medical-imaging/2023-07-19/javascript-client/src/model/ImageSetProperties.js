...
/**
 * The ImageSetProperties model module.
 * @module model/ImageSetProperties
 * @version 2023-07-19
 */
class ImageSetProperties {
    /**
     * Constructs a new <code>ImageSetProperties</code>.
     * The image set properties.
     * @alias module:model/ImageSetProperties
     * @param imageSetId {String} 
     * @param versionId {String} 
     * @param imageSetState {module:model/ImageSetState} 
     */
    constructor(imageSetId, versionId, imageSetState) { 
        
        ImageSetProperties.initialize(this, imageSetId, versionId, imageSetState);
    }
     ...
     */
    static initialize(obj, imageSetId, versionId, imageSetState) { 
    ...
    /**
     * Constructs a <code>ImageSetProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageSetProperties} obj Optional instance to populate.
     * @return {module:model/ImageSetProperties} The populated <code>ImageSetProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageSetProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageSetProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageSetProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageSetProperties.RequiredProperties) {
...
ImageSetProperties.RequiredProperties = ["imageSetId", "versionId", "imageSetState"];

/**
 * @member {String} imageSetId
 */
ImageSetProperties.prototype['imageSetId'] = undefined;

/**
 * @member {String} versionId
 */
ImageSetProperties.prototype['versionId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
ImageSetProperties.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} ImageSetWorkflowStatus
 */
ImageSetProperties.prototype['ImageSetWorkflowStatus'] = undefined;

/**
 * @member {Date} createdAt
 */
ImageSetProperties.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
ImageSetProperties.prototype['updatedAt'] = undefined;

/**
 * @member {Date} deletedAt
 */
ImageSetProperties.prototype['deletedAt'] = undefined;

/**
 * @member {String} message
 */
ImageSetProperties.prototype['message'] = undefined;
...
export default ImageSetProperties;
