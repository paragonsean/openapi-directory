...
/**
 * The CopyImageSetInformation model module.
 * @module model/CopyImageSetInformation
 * @version 2023-07-19
 */
class CopyImageSetInformation {
    /**
     * Constructs a new <code>CopyImageSetInformation</code>.
     * Copy image set information.
     * @alias module:model/CopyImageSetInformation
    ...
    /**
     * Constructs a <code>CopyImageSetInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetInformation} obj Optional instance to populate.
     * @return {module:model/CopyImageSetInformation} The populated <code>CopyImageSetInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetInformation();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetInformation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetInformation.RequiredProperties) {
...
CopyImageSetInformation.RequiredProperties = ["sourceImageSet"];
...
export default CopyImageSetInformation;
