...
/**
 * The CreateDatastoreResponse model module.
 * @module model/CreateDatastoreResponse
 * @version 2023-07-19
 */
class CreateDatastoreResponse {
    /**
     * Constructs a new <code>CreateDatastoreResponse</code>.
     * @alias module:model/CreateDatastoreResponse
     * @param datastoreId {String} 
     * @param datastoreStatus {module:model/DatastoreStatus} 
     */
    constructor(datastoreId, datastoreStatus) { 
        
        CreateDatastoreResponse.initialize(this, datastoreId, datastoreStatus);
    }
     ...
     */
    static initialize(obj, datastoreId, datastoreStatus) { 
        obj['datastoreId'] = datastoreId;
        obj['datastoreStatus'] = datastoreStatus;
    }

    /**
     * Constructs a <code>CreateDatastoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDatastoreResponse} obj Optional instance to populate.
     * @return {module:model/CreateDatastoreResponse} The populated <code>CreateDatastoreResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDatastoreResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDatastoreResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDatastoreResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDatastoreResponse.RequiredProperties) {
...
CreateDatastoreResponse.RequiredProperties = ["datastoreId", "datastoreStatus"];

/**
 * @member {String} datastoreId
 */
CreateDatastoreResponse.prototype['datastoreId'] = undefined;

/**
 * @member {module:model/DatastoreStatus} datastoreStatus
 */
CreateDatastoreResponse.prototype['datastoreStatus'] = undefined;
...
export default CreateDatastoreResponse;
