...
/**
 * The DICOMStudyDateAndTime model module.
 * @module model/DICOMStudyDateAndTime
 * @version 2023-07-19
 */
class DICOMStudyDateAndTime {
    /**
     * Constructs a new <code>DICOMStudyDateAndTime</code>.
     * The aggregated structure to store DICOM study date and study time for search capabilities.
     * @alias module:model/DICOMStudyDateAndTime
    ...
    /**
     * Constructs a <code>DICOMStudyDateAndTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DICOMStudyDateAndTime} obj Optional instance to populate.
     * @return {module:model/DICOMStudyDateAndTime} The populated <code>DICOMStudyDateAndTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DICOMStudyDateAndTime();
    ...
    /**
     * Validates the JSON data with respect to <code>DICOMStudyDateAndTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DICOMStudyDateAndTime</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DICOMStudyDateAndTime.RequiredProperties) {
...
DICOMStudyDateAndTime.RequiredProperties = ["DICOMStudyDate"];
...
export default DICOMStudyDateAndTime;
