...
import DICOMStudyDateAndTime from './DICOMStudyDateAndTime';

/**
 * The SearchByAttributeValueDICOMStudyDateAndTime model module.
 * @module model/SearchByAttributeValueDICOMStudyDateAndTime
 * @version 2023-07-19
 */
class SearchByAttributeValueDICOMStudyDateAndTime {
    /**
     * Constructs a new <code>SearchByAttributeValueDICOMStudyDateAndTime</code>.
     * @alias module:model/SearchByAttributeValueDICOMStudyDateAndTime
     * @implements module:model/DICOMStudyDateAndTime
     * @param dICOMStudyDate {String} 
     */
    constructor(dICOMStudyDate) { 
        DICOMStudyDateAndTime.initialize(this, dICOMStudyDate);
        SearchByAttributeValueDICOMStudyDateAndTime.initialize(this, dICOMStudyDate);
    }
     ...
     */
    static initialize(obj, dICOMStudyDate) { 
        obj['DICOMStudyDate'] = dICOMStudyDate;
    }

    /**
     * Constructs a <code>SearchByAttributeValueDICOMStudyDateAndTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchByAttributeValueDICOMStudyDateAndTime} obj Optional instance to populate.
     * @return {module:model/SearchByAttributeValueDICOMStudyDateAndTime} The populated <code>SearchByAttributeValueDICOMStudyDateAndTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchByAttributeValueDICOMStudyDateAndTime();
            DICOMStudyDateAndTime.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchByAttributeValueDICOMStudyDateAndTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchByAttributeValueDICOMStudyDateAndTime</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchByAttributeValueDICOMStudyDateAndTime.RequiredProperties) {
...
SearchByAttributeValueDICOMStudyDateAndTime.RequiredProperties = ["DICOMStudyDate"];

/**
 * @member {String} DICOMStudyDate
 */
SearchByAttributeValueDICOMStudyDateAndTime.prototype['DICOMStudyDate'] = undefined;

/**
 * @member {String} DICOMStudyTime
 */
SearchByAttributeValueDICOMStudyDateAndTime.prototype['DICOMStudyTime'] = undefined;


// Implement DICOMStudyDateAndTime interface:
/**
 * @member {String} DICOMStudyDate
 */
DICOMStudyDateAndTime.prototype['DICOMStudyDate'] = undefined;
/**
 * @member {String} DICOMStudyTime
 */
DICOMStudyDateAndTime.prototype['DICOMStudyTime'] = undefined;




export default SearchByAttributeValueDICOMStudyDateAndTime;
