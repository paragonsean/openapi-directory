...
import GetDICOMImportJobResponseJobProperties from './GetDICOMImportJobResponseJobProperties';

/**
 * The GetDICOMImportJobResponse model module.
 * @module model/GetDICOMImportJobResponse
 * @version 2023-07-19
 */
class GetDICOMImportJobResponse {
    /**
     * Constructs a new <code>GetDICOMImportJobResponse</code>.
     * @alias module:model/GetDICOMImportJobResponse
     * @param jobProperties {module:model/GetDICOMImportJobResponseJobProperties} 
     */
    constructor(jobProperties) { 
        
        GetDICOMImportJobResponse.initialize(this, jobProperties);
    }
     ...
     */
    static initialize(obj, jobProperties) { 
        obj['jobProperties'] = jobProperties;
    }

    /**
     * Constructs a <code>GetDICOMImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDICOMImportJobResponse} obj Optional instance to populate.
     * @return {module:model/GetDICOMImportJobResponse} The populated <code>GetDICOMImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDICOMImportJobResponse();

            if (data.hasOwnProperty('jobProperties')) {
                obj['jobProperties'] = GetDICOMImportJobResponseJobProperties.constructFromObject(data['jobProperties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDICOMImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDICOMImportJobResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDICOMImportJobResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `jobProperties`
        if (data['jobProperties']) { // data not null
          GetDICOMImportJobResponseJobProperties.validateJSON(data['jobProperties']);
        }
...
GetDICOMImportJobResponse.RequiredProperties = ["jobProperties"];

/**
 * @member {module:model/GetDICOMImportJobResponseJobProperties} jobProperties
 */
GetDICOMImportJobResponse.prototype['jobProperties'] = undefined;
...
export default GetDICOMImportJobResponse;
