...
/**
 * The DICOMImportJobProperties model module.
 * @module model/DICOMImportJobProperties
 * @version 2023-07-19
 */
class DICOMImportJobProperties {
    /**
     * Constructs a new <code>DICOMImportJobProperties</code>.
     * Properties of the import job.
     * @alias module:model/DICOMImportJobProperties
     * @param jobId {String} 
    ...
    /**
     * Constructs a <code>DICOMImportJobProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DICOMImportJobProperties} obj Optional instance to populate.
     * @return {module:model/DICOMImportJobProperties} The populated <code>DICOMImportJobProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DICOMImportJobProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>DICOMImportJobProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DICOMImportJobProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DICOMImportJobProperties.RequiredProperties) {
...
DICOMImportJobProperties.RequiredProperties = ["jobId", "jobName", "jobStatus", "datastoreId", "dataAccessRoleArn", "inputS3Uri", "outputS3Uri"];
...
export default DICOMImportJobProperties;
