...
/**
 * The SearchImageSetsRequestSearchCriteria model module.
 * @module model/SearchImageSetsRequestSearchCriteria
 * @version 2023-07-19
 */
class SearchImageSetsRequestSearchCriteria {
    /**
     * Constructs a new <code>SearchImageSetsRequestSearchCriteria</code>.
     * @alias module:model/SearchImageSetsRequestSearchCriteria
     * @implements module:model/SearchCriteria
     */
    constructor() { 
        SearchCriteria.initialize(this);
        SearchImageSetsRequestSearchCriteria.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchImageSetsRequestSearchCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchImageSetsRequestSearchCriteria} obj Optional instance to populate.
     * @return {module:model/SearchImageSetsRequestSearchCriteria} The populated <code>SearchImageSetsRequestSearchCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchImageSetsRequestSearchCriteria();
            SearchCriteria.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SearchImageSetsRequestSearchCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchImageSetsRequestSearchCriteria</code>.
     */
 ...
 */
SearchImageSetsRequestSearchCriteria.prototype['filters'] = undefined;


// Implement SearchCriteria interface:
/**
 * @member {Array} filters
 */
SearchCriteria.prototype['filters'] = undefined;




export default SearchImageSetsRequestSearchCriteria;
