...
/**
 * The ListImageSetVersionsResponse model module.
 * @module model/ListImageSetVersionsResponse
 * @version 2023-07-19
 */
class ListImageSetVersionsResponse {
    /**
     * Constructs a new <code>ListImageSetVersionsResponse</code>.
     * @alias module:model/ListImageSetVersionsResponse
     * @param imageSetPropertiesList {Array} 
     */
    constructor(imageSetPropertiesList) { 
        
        ListImageSetVersionsResponse.initialize(this, imageSetPropertiesList);
    }
     ...
     */
    static initialize(obj, imageSetPropertiesList) { 
        obj['imageSetPropertiesList'] = imageSetPropertiesList;
    }

    /**
     * Constructs a <code>ListImageSetVersionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListImageSetVersionsResponse} obj Optional instance to populate.
     * @return {module:model/ListImageSetVersionsResponse} The populated <code>ListImageSetVersionsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListImageSetVersionsResponse();

            if (data.hasOwnProperty('imageSetPropertiesList')) {
                obj['imageSetPropertiesList'] = ApiClient.convertToType(data['imageSetPropertiesList'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListImageSetVersionsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListImageSetVersionsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListImageSetVersionsResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageSetPropertiesList`
        if (data['imageSetPropertiesList']) { // data not null
          Array.validateJSON(data['imageSetPropertiesList']);
        }
...
ListImageSetVersionsResponse.RequiredProperties = ["imageSetPropertiesList"];

/**
 * @member {Array} imageSetPropertiesList
 */
ListImageSetVersionsResponse.prototype['imageSetPropertiesList'] = undefined;

/**
 * @member {String} nextToken
 */
ListImageSetVersionsResponse.prototype['nextToken'] = undefined;
...
export default ListImageSetVersionsResponse;
