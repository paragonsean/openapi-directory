...
/**
 * The DICOMUpdates model module.
 * @module model/DICOMUpdates
 * @version 2023-07-19
 */
class DICOMUpdates {
    /**
     * Constructs a new <code>DICOMUpdates</code>.
     * The object containing &lt;code&gt;removableAttributes&lt;/code&gt; and &lt;code&gt;updatableAttributes&lt;/code&gt;.
     * @alias module:model/DICOMUpdates
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DICOMUpdates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DICOMUpdates} obj Optional instance to populate.
     * @return {module:model/DICOMUpdates} The populated <code>DICOMUpdates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DICOMUpdates();
    ...
    /**
     * Validates the JSON data with respect to <code>DICOMUpdates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DICOMUpdates</code>.
     */
