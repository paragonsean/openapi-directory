...
import CopyImageSetRequestCopyImageSetInformation from './CopyImageSetRequestCopyImageSetInformation';

/**
 * The CopyImageSetRequest model module.
 * @module model/CopyImageSetRequest
 * @version 2023-07-19
 */
class CopyImageSetRequest {
    /**
     * Constructs a new <code>CopyImageSetRequest</code>.
     * @alias module:model/CopyImageSetRequest
     * @param copyImageSetInformation {module:model/CopyImageSetRequestCopyImageSetInformation} 
     */
    constructor(copyImageSetInformation) { 
        
        CopyImageSetRequest.initialize(this, copyImageSetInformation);
    }
     ...
     */
    static initialize(obj, copyImageSetInformation) { 
        obj['copyImageSetInformation'] = copyImageSetInformation;
    }

    /**
     * Constructs a <code>CopyImageSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetRequest} obj Optional instance to populate.
     * @return {module:model/CopyImageSetRequest} The populated <code>CopyImageSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetRequest();

            if (data.hasOwnProperty('copyImageSetInformation')) {
                obj['copyImageSetInformation'] = CopyImageSetRequestCopyImageSetInformation.constructFromObject(data['copyImageSetInformation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `copyImageSetInformation`
        if (data['copyImageSetInformation']) { // data not null
          CopyImageSetRequestCopyImageSetInformation.validateJSON(data['copyImageSetInformation']);
        }
...
CopyImageSetRequest.RequiredProperties = ["copyImageSetInformation"];

/**
 * @member {module:model/CopyImageSetRequestCopyImageSetInformation} copyImageSetInformation
 */
CopyImageSetRequest.prototype['copyImageSetInformation'] = undefined;
...
export default CopyImageSetRequest;
