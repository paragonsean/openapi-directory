...
/**
 * The ListDICOMImportJobsResponse model module.
 * @module model/ListDICOMImportJobsResponse
 * @version 2023-07-19
 */
class ListDICOMImportJobsResponse {
    /**
     * Constructs a new <code>ListDICOMImportJobsResponse</code>.
     * @alias module:model/ListDICOMImportJobsResponse
     * @param jobSummaries {Array} 
     */
    constructor(jobSummaries) { 
        
        ListDICOMImportJobsResponse.initialize(this, jobSummaries);
    }
    ...
    /**
     * Constructs a <code>ListDICOMImportJobsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDICOMImportJobsResponse} obj Optional instance to populate.
     * @return {module:model/ListDICOMImportJobsResponse} The populated <code>ListDICOMImportJobsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDICOMImportJobsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListDICOMImportJobsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDICOMImportJobsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListDICOMImportJobsResponse.RequiredProperties) {
...
ListDICOMImportJobsResponse.RequiredProperties = ["jobSummaries"];

/**
 * @member {Array} jobSummaries
 */
ListDICOMImportJobsResponse.prototype['jobSummaries'] = undefined;

/**
 * @member {String} nextToken
 */
ListDICOMImportJobsResponse.prototype['nextToken'] = undefined;
...
export default ListDICOMImportJobsResponse;
