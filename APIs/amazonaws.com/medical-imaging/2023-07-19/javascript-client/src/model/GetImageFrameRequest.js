...
import GetImageFrameRequestImageFrameInformation from './GetImageFrameRequestImageFrameInformation';

/**
 * The GetImageFrameRequest model module.
 * @module model/GetImageFrameRequest
 * @version 2023-07-19
 */
class GetImageFrameRequest {
    /**
     * Constructs a new <code>GetImageFrameRequest</code>.
     * @alias module:model/GetImageFrameRequest
     * @param imageFrameInformation {module:model/GetImageFrameRequestImageFrameInformation} 
     */
    constructor(imageFrameInformation) { 
        
        GetImageFrameRequest.initialize(this, imageFrameInformation);
    }
     ...
     */
    static initialize(obj, imageFrameInformation) { 
        obj['imageFrameInformation'] = imageFrameInformation;
    }

    /**
     * Constructs a <code>GetImageFrameRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImageFrameRequest} obj Optional instance to populate.
     * @return {module:model/GetImageFrameRequest} The populated <code>GetImageFrameRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImageFrameRequest();

            if (data.hasOwnProperty('imageFrameInformation')) {
                obj['imageFrameInformation'] = GetImageFrameRequestImageFrameInformation.constructFromObject(data['imageFrameInformation']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetImageFrameRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImageFrameRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImageFrameRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageFrameInformation`
        if (data['imageFrameInformation']) { // data not null
          GetImageFrameRequestImageFrameInformation.validateJSON(data['imageFrameInformation']);
        }
...
GetImageFrameRequest.RequiredProperties = ["imageFrameInformation"];

/**
 * @member {module:model/GetImageFrameRequestImageFrameInformation} imageFrameInformation
 */
GetImageFrameRequest.prototype['imageFrameInformation'] = undefined;
...
export default GetImageFrameRequest;
