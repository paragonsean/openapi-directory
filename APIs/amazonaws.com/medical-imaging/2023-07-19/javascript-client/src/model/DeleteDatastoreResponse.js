...
/**
 * The DeleteDatastoreResponse model module.
 * @module model/DeleteDatastoreResponse
 * @version 2023-07-19
 */
class DeleteDatastoreResponse {
    /**
     * Constructs a new <code>DeleteDatastoreResponse</code>.
     * @alias module:model/DeleteDatastoreResponse
     * @param datastoreId {String} 
     * @param datastoreStatus {module:model/DatastoreStatus} 
     */
    constructor(datastoreId, datastoreStatus) { 
        
        DeleteDatastoreResponse.initialize(this, datastoreId, datastoreStatus);
    }
    ...
    /**
     * Constructs a <code>DeleteDatastoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteDatastoreResponse} obj Optional instance to populate.
     * @return {module:model/DeleteDatastoreResponse} The populated <code>DeleteDatastoreResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteDatastoreResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteDatastoreResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteDatastoreResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteDatastoreResponse.RequiredProperties) {
...
DeleteDatastoreResponse.RequiredProperties = ["datastoreId", "datastoreStatus"];

/**
 * @member {String} datastoreId
 */
DeleteDatastoreResponse.prototype['datastoreId'] = undefined;

/**
 * @member {module:model/DatastoreStatus} datastoreStatus
 */
DeleteDatastoreResponse.prototype['datastoreStatus'] = undefined;
...
export default DeleteDatastoreResponse;
