...
import UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates from './UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates';

/**
 * The UpdateImageSetMetadataRequest model module.
 * @module model/UpdateImageSetMetadataRequest
 * @version 2023-07-19
 */
class UpdateImageSetMetadataRequest {
    /**
     * Constructs a new <code>UpdateImageSetMetadataRequest</code>.
     * @alias module:model/UpdateImageSetMetadataRequest
     * @param updateImageSetMetadataUpdates {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates} 
     */
    constructor(updateImageSetMetadataUpdates) { 
        
        UpdateImageSetMetadataRequest.initialize(this, updateImageSetMetadataUpdates);
    }
     ...
     */
    static initialize(obj, updateImageSetMetadataUpdates) { 
        obj['updateImageSetMetadataUpdates'] = updateImageSetMetadataUpdates;
    }

    /**
     * Constructs a <code>UpdateImageSetMetadataRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateImageSetMetadataRequest} obj Optional instance to populate.
     * @return {module:model/UpdateImageSetMetadataRequest} The populated <code>UpdateImageSetMetadataRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateImageSetMetadataRequest();

            if (data.hasOwnProperty('updateImageSetMetadataUpdates')) {
                obj['updateImageSetMetadataUpdates'] = UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates.constructFromObject(data['updateImageSetMetadataUpdates']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateImageSetMetadataRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateImageSetMetadataRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateImageSetMetadataRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `updateImageSetMetadataUpdates`
        if (data['updateImageSetMetadataUpdates']) { // data not null
          UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates.validateJSON(data['updateImageSetMetadataUpdates']);
        }
...
UpdateImageSetMetadataRequest.RequiredProperties = ["updateImageSetMetadataUpdates"];

/**
 * @member {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates} updateImageSetMetadataUpdates
 */
UpdateImageSetMetadataRequest.prototype['updateImageSetMetadataUpdates'] = undefined;
...
export default UpdateImageSetMetadataRequest;
