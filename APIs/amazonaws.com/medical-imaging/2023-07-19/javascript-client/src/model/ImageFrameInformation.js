...
/**
 * The ImageFrameInformation model module.
 * @module model/ImageFrameInformation
 * @version 2023-07-19
 */
class ImageFrameInformation {
    /**
     * Constructs a new <code>ImageFrameInformation</code>.
     * Information about the image frame (pixel data) identifier.
     * @alias module:model/ImageFrameInformation
    ...
    /**
     * Constructs a <code>ImageFrameInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageFrameInformation} obj Optional instance to populate.
     * @return {module:model/ImageFrameInformation} The populated <code>ImageFrameInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageFrameInformation();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageFrameInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageFrameInformation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageFrameInformation.RequiredProperties) {
...
ImageFrameInformation.RequiredProperties = ["imageFrameId"];
...
export default ImageFrameInformation;
