...
* @readonly
*/
export default class ImageSetWorkflowStatus {
        ...
        /**
         * value: "COPYING_WITH_READ_ONLY_ACCESS"
         * @const
         */
    ...
    /**
    * Returns a <code>ImageSetWorkflowStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ImageSetWorkflowStatus} The enum <code>ImageSetWorkflowStatus</code> value.
    */
