...
/**
 * The GetImageSetResponse model module.
 * @module model/GetImageSetResponse
 * @version 2023-07-19
 */
class GetImageSetResponse {
    /**
     * Constructs a new <code>GetImageSetResponse</code>.
     * @alias module:model/GetImageSetResponse
     * @param datastoreId {String} 
     * @param imageSetId {String} 
     * @param versionId {String} 
     * @param imageSetState {module:model/ImageSetState} 
     */
    constructor(datastoreId, imageSetId, versionId, imageSetState) { 
        
        GetImageSetResponse.initialize(this, datastoreId, imageSetId, versionId, imageSetState);
    }
     ...
     */
    static initialize(obj, datastoreId, imageSetId, versionId, imageSetState) { 
    ...
    /**
     * Constructs a <code>GetImageSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImageSetResponse} obj Optional instance to populate.
     * @return {module:model/GetImageSetResponse} The populated <code>GetImageSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImageSetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetImageSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImageSetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImageSetResponse.RequiredProperties) {
...
GetImageSetResponse.RequiredProperties = ["datastoreId", "imageSetId", "versionId", "imageSetState"];

/**
 * @member {String} datastoreId
 */
GetImageSetResponse.prototype['datastoreId'] = undefined;

/**
 * @member {String} imageSetId
 */
GetImageSetResponse.prototype['imageSetId'] = undefined;

/**
 * @member {String} versionId
 */
GetImageSetResponse.prototype['versionId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
GetImageSetResponse.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
GetImageSetResponse.prototype['imageSetWorkflowStatus'] = undefined;

/**
 * @member {Date} createdAt
 */
GetImageSetResponse.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
GetImageSetResponse.prototype['updatedAt'] = undefined;

/**
 * @member {Date} deletedAt
 */
GetImageSetResponse.prototype['deletedAt'] = undefined;

/**
 * @member {String} message
 */
GetImageSetResponse.prototype['message'] = undefined;

/**
 * @member {String} imageSetArn
 */
GetImageSetResponse.prototype['imageSetArn'] = undefined;
...
export default GetImageSetResponse;
