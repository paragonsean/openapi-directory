...
import SearchImageSetsRequestSearchCriteria from './SearchImageSetsRequestSearchCriteria';

/**
 * The SearchImageSetsRequest model module.
 * @module model/SearchImageSetsRequest
 * @version 2023-07-19
 */
class SearchImageSetsRequest {
    /**
     * Constructs a new <code>SearchImageSetsRequest</code>.
     * @alias module:model/SearchImageSetsRequest
     */
    constructor() { 
        
        SearchImageSetsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchImageSetsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchImageSetsRequest} obj Optional instance to populate.
     * @return {module:model/SearchImageSetsRequest} The populated <code>SearchImageSetsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchImageSetsRequest();

            if (data.hasOwnProperty('searchCriteria')) {
                obj['searchCriteria'] = SearchImageSetsRequestSearchCriteria.constructFromObject(data['searchCriteria']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchImageSetsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchImageSetsRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `searchCriteria`
        if (data['searchCriteria']) { // data not null
          SearchImageSetsRequestSearchCriteria.validateJSON(data['searchCriteria']);
        }
...
/**
 * @member {module:model/SearchImageSetsRequestSearchCriteria} searchCriteria
 */
SearchImageSetsRequest.prototype['searchCriteria'] = undefined;
...
export default SearchImageSetsRequest;
