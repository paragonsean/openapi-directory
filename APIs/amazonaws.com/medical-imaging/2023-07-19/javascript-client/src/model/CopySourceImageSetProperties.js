...
/**
 * The CopySourceImageSetProperties model module.
 * @module model/CopySourceImageSetProperties
 * @version 2023-07-19
 */
class CopySourceImageSetProperties {
    /**
     * Constructs a new <code>CopySourceImageSetProperties</code>.
     * Copy source image set properties.
     * @alias module:model/CopySourceImageSetProperties
     * @param imageSetId {String} 
     * @param latestVersionId {String} 
     */
    constructor(imageSetId, latestVersionId) { 
        
        CopySourceImageSetProperties.initialize(this, imageSetId, latestVersionId);
    }
     ...
     */
    static initialize(obj, imageSetId, latestVersionId) { 
        obj['imageSetId'] = imageSetId;
        obj['latestVersionId'] = latestVersionId;
    }

    /**
     * Constructs a <code>CopySourceImageSetProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopySourceImageSetProperties} obj Optional instance to populate.
     * @return {module:model/CopySourceImageSetProperties} The populated <code>CopySourceImageSetProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopySourceImageSetProperties();
            ...
            if (data.hasOwnProperty('imageSetArn')) {
                obj['imageSetArn'] = ApiClient.convertToType(data['imageSetArn'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CopySourceImageSetProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopySourceImageSetProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopySourceImageSetProperties.RequiredProperties) {
        ...
        if (data['imageSetArn']) { // data not null
          String.validateJSON(data['imageSetArn']);
        }
...
CopySourceImageSetProperties.RequiredProperties = ["imageSetId", "latestVersionId"];

/**
 * @member {String} imageSetId
 */
CopySourceImageSetProperties.prototype['imageSetId'] = undefined;

/**
 * @member {String} latestVersionId
 */
CopySourceImageSetProperties.prototype['latestVersionId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
CopySourceImageSetProperties.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
CopySourceImageSetProperties.prototype['imageSetWorkflowStatus'] = undefined;

/**
 * @member {Date} createdAt
 */
CopySourceImageSetProperties.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
CopySourceImageSetProperties.prototype['updatedAt'] = undefined;

/**
 * @member {String} imageSetArn
 */
CopySourceImageSetProperties.prototype['imageSetArn'] = undefined;
...
export default CopySourceImageSetProperties;
