...
/**
 * The StartDICOMImportJobResponse model module.
 * @module model/StartDICOMImportJobResponse
 * @version 2023-07-19
 */
class StartDICOMImportJobResponse {
    /**
     * Constructs a new <code>StartDICOMImportJobResponse</code>.
     * @alias module:model/StartDICOMImportJobResponse
     * @param datastoreId {String} 
     * @param jobId {String} 
     * @param jobStatus {module:model/JobStatus} 
     * @param submittedAt {Date} 
     */
    constructor(datastoreId, jobId, jobStatus, submittedAt) { 
        
        StartDICOMImportJobResponse.initialize(this, datastoreId, jobId, jobStatus, submittedAt);
    }
     ...
     */
    static initialize(obj, datastoreId, jobId, jobStatus, submittedAt) { 
    ...
    /**
     * Constructs a <code>StartDICOMImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartDICOMImportJobResponse} obj Optional instance to populate.
     * @return {module:model/StartDICOMImportJobResponse} The populated <code>StartDICOMImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartDICOMImportJobResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartDICOMImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartDICOMImportJobResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartDICOMImportJobResponse.RequiredProperties) {
...
StartDICOMImportJobResponse.RequiredProperties = ["datastoreId", "jobId", "jobStatus", "submittedAt"];

/**
 * @member {String} datastoreId
 */
StartDICOMImportJobResponse.prototype['datastoreId'] = undefined;

/**
 * @member {String} jobId
 */
StartDICOMImportJobResponse.prototype['jobId'] = undefined;

/**
 * @member {module:model/JobStatus} jobStatus
 */
StartDICOMImportJobResponse.prototype['jobStatus'] = undefined;

/**
 * @member {Date} submittedAt
 */
StartDICOMImportJobResponse.prototype['submittedAt'] = undefined;
...
export default StartDICOMImportJobResponse;
