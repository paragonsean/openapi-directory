...
/**
 * The DeleteImageSetResponse model module.
 * @module model/DeleteImageSetResponse
 * @version 2023-07-19
 */
class DeleteImageSetResponse {
    /**
     * Constructs a new <code>DeleteImageSetResponse</code>.
     * @alias module:model/DeleteImageSetResponse
     * @param datastoreId {String} 
     * @param imageSetId {String} 
     * @param imageSetState {module:model/ImageSetState} 
     * @param imageSetWorkflowStatus {module:model/ImageSetWorkflowStatus} 
     */
    constructor(datastoreId, imageSetId, imageSetState, imageSetWorkflowStatus) { 
        
        DeleteImageSetResponse.initialize(this, datastoreId, imageSetId, imageSetState, imageSetWorkflowStatus);
    }
     ...
     */
    static initialize(obj, datastoreId, imageSetId, imageSetState, imageSetWorkflowStatus) { 
        obj['datastoreId'] = datastoreId;
        obj['imageSetId'] = imageSetId;
        obj['imageSetState'] = imageSetState;
        obj['imageSetWorkflowStatus'] = imageSetWorkflowStatus;
    }

    /**
     * Constructs a <code>DeleteImageSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteImageSetResponse} obj Optional instance to populate.
     * @return {module:model/DeleteImageSetResponse} The populated <code>DeleteImageSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteImageSetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteImageSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteImageSetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteImageSetResponse.RequiredProperties) {
...
DeleteImageSetResponse.RequiredProperties = ["datastoreId", "imageSetId", "imageSetState", "imageSetWorkflowStatus"];

/**
 * @member {String} datastoreId
 */
DeleteImageSetResponse.prototype['datastoreId'] = undefined;

/**
 * @member {String} imageSetId
 */
DeleteImageSetResponse.prototype['imageSetId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
DeleteImageSetResponse.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
DeleteImageSetResponse.prototype['imageSetWorkflowStatus'] = undefined;
...
export default DeleteImageSetResponse;
