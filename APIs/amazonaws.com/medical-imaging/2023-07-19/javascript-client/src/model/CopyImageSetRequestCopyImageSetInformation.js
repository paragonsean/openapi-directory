...
import CopyImageSetInformation from './CopyImageSetInformation';
import CopyImageSetRequestCopyImageSetInformationDestinationImageSet from './CopyImageSetRequestCopyImageSetInformationDestinationImageSet';
import CopyImageSetRequestCopyImageSetInformationSourceImageSet from './CopyImageSetRequestCopyImageSetInformationSourceImageSet';

/**
 * The CopyImageSetRequestCopyImageSetInformation model module.
 * @module model/CopyImageSetRequestCopyImageSetInformation
 * @version 2023-07-19
 */
class CopyImageSetRequestCopyImageSetInformation {
    /**
     * Constructs a new <code>CopyImageSetRequestCopyImageSetInformation</code>.
     * @alias module:model/CopyImageSetRequestCopyImageSetInformation
     * @implements module:model/CopyImageSetInformation
     * @param sourceImageSet {module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet} 
     */
    constructor(sourceImageSet) { 
        CopyImageSetInformation.initialize(this, sourceImageSet);
        CopyImageSetRequestCopyImageSetInformation.initialize(this, sourceImageSet);
    }
     ...
     */
    static initialize(obj, sourceImageSet) { 
        obj['sourceImageSet'] = sourceImageSet;
    }

    /**
     * Constructs a <code>CopyImageSetRequestCopyImageSetInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetRequestCopyImageSetInformation} obj Optional instance to populate.
     * @return {module:model/CopyImageSetRequestCopyImageSetInformation} The populated <code>CopyImageSetRequestCopyImageSetInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetRequestCopyImageSetInformation();
            CopyImageSetInformation.constructFromObject(data, obj);

            if (data.hasOwnProperty('sourceImageSet')) {
                obj['sourceImageSet'] = CopyImageSetRequestCopyImageSetInformationSourceImageSet.constructFromObject(data['sourceImageSet']);
            }
            if (data.hasOwnProperty('destinationImageSet')) {
                obj['destinationImageSet'] = CopyImageSetRequestCopyImageSetInformationDestinationImageSet.constructFromObject(data['destinationImageSet']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetRequestCopyImageSetInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetRequestCopyImageSetInformation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetRequestCopyImageSetInformation.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `sourceImageSet`
        if (data['sourceImageSet']) { // data not null
          CopyImageSetRequestCopyImageSetInformationSourceImageSet.validateJSON(data['sourceImageSet']);
        }
        // validate the optional field `destinationImageSet`
        if (data['destinationImageSet']) { // data not null
          CopyImageSetRequestCopyImageSetInformationDestinationImageSet.validateJSON(data['destinationImageSet']);
        }
...
CopyImageSetRequestCopyImageSetInformation.RequiredProperties = ["sourceImageSet"];

/**
 * @member {module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet} sourceImageSet
 */
CopyImageSetRequestCopyImageSetInformation.prototype['sourceImageSet'] = undefined;

/**
 * @member {module:model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet} destinationImageSet
 */
CopyImageSetRequestCopyImageSetInformation.prototype['destinationImageSet'] = undefined;


// Implement CopyImageSetInformation interface:
/**
 * @member {module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet} sourceImageSet
 */
CopyImageSetInformation.prototype['sourceImageSet'] = undefined;
/**
 * @member {module:model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet} destinationImageSet
 */
CopyImageSetInformation.prototype['destinationImageSet'] = undefined;




export default CopyImageSetRequestCopyImageSetInformation;
