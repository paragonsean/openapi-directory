...
/**
 * The CopySourceImageSetInformation model module.
 * @module model/CopySourceImageSetInformation
 * @version 2023-07-19
 */
class CopySourceImageSetInformation {
    /**
     * Constructs a new <code>CopySourceImageSetInformation</code>.
     * Copy source image set information.
     * @alias module:model/CopySourceImageSetInformation
    ...
    /**
     * Constructs a <code>CopySourceImageSetInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopySourceImageSetInformation} obj Optional instance to populate.
     * @return {module:model/CopySourceImageSetInformation} The populated <code>CopySourceImageSetInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopySourceImageSetInformation();
    ...
    /**
     * Validates the JSON data with respect to <code>CopySourceImageSetInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopySourceImageSetInformation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopySourceImageSetInformation.RequiredProperties) {
...
CopySourceImageSetInformation.RequiredProperties = ["latestVersionId"];
...
export default CopySourceImageSetInformation;
