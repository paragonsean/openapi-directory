...
/**
 * The StartDICOMImportJobRequest model module.
 * @module model/StartDICOMImportJobRequest
 * @version 2023-07-19
 */
class StartDICOMImportJobRequest {
    /**
     * Constructs a new <code>StartDICOMImportJobRequest</code>.
     * @alias module:model/StartDICOMImportJobRequest
     * @param dataAccessRoleArn {String} The Amazon Resource Name (ARN) of the IAM role that grants permission to access medical imaging resources.
     * @param clientToken {String} A unique identifier for API idempotency.
     * @param inputS3Uri {String} The input prefix path for the S3 bucket that contains the DICOM files to be imported.
     * @param outputS3Uri {String} The output prefix of the S3 bucket to upload the results of the DICOM import job.
     */
    constructor(dataAccessRoleArn, clientToken, inputS3Uri, outputS3Uri) { 
        
        StartDICOMImportJobRequest.initialize(this, dataAccessRoleArn, clientToken, inputS3Uri, outputS3Uri);
    }
     ...
     */
    static initialize(obj, dataAccessRoleArn, clientToken, inputS3Uri, outputS3Uri) { 
    ...
    /**
     * Constructs a <code>StartDICOMImportJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartDICOMImportJobRequest} obj Optional instance to populate.
     * @return {module:model/StartDICOMImportJobRequest} The populated <code>StartDICOMImportJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartDICOMImportJobRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartDICOMImportJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartDICOMImportJobRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartDICOMImportJobRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['dataAccessRoleArn'] && !(typeof data['dataAccessRoleArn'] === 'string' || data['dataAccessRoleArn'] instanceof String)) {
            throw new Error("Expected the field `dataAccessRoleArn` to be a primitive type in the JSON string but got " + data['dataAccessRoleArn']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['inputS3Uri'] && !(typeof data['inputS3Uri'] === 'string' || data['inputS3Uri'] instanceof String)) {
            throw new Error("Expected the field `inputS3Uri` to be a primitive type in the JSON string but got " + data['inputS3Uri']);
        }
        // ensure the json data is a string
        if (data['outputS3Uri'] && !(typeof data['outputS3Uri'] === 'string' || data['outputS3Uri'] instanceof String)) {
            throw new Error("Expected the field `outputS3Uri` to be a primitive type in the JSON string but got " + data['outputS3Uri']);
        }
...
StartDICOMImportJobRequest.RequiredProperties = ["dataAccessRoleArn", "clientToken", "inputS3Uri", "outputS3Uri"];

/**
 * The import job name.
 * @member {String} jobName
 */
StartDICOMImportJobRequest.prototype['jobName'] = undefined;
 ...
 */
StartDICOMImportJobRequest.prototype['dataAccessRoleArn'] = undefined;

/**
 * A unique identifier for API idempotency.
 * @member {String} clientToken
 */
StartDICOMImportJobRequest.prototype['clientToken'] = undefined;

/**
 * The input prefix path for the S3 bucket that contains the DICOM files to be imported.
 * @member {String} inputS3Uri
 */
StartDICOMImportJobRequest.prototype['inputS3Uri'] = undefined;

/**
 * The output prefix of the S3 bucket to upload the results of the DICOM import job.
 * @member {String} outputS3Uri
 */
StartDICOMImportJobRequest.prototype['outputS3Uri'] = undefined;
...
export default StartDICOMImportJobRequest;
