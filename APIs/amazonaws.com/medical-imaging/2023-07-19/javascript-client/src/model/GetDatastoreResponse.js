...
import GetDatastoreResponseDatastoreProperties from './GetDatastoreResponseDatastoreProperties';

/**
 * The GetDatastoreResponse model module.
 * @module model/GetDatastoreResponse
 * @version 2023-07-19
 */
class GetDatastoreResponse {
    /**
     * Constructs a new <code>GetDatastoreResponse</code>.
     * @alias module:model/GetDatastoreResponse
     * @param datastoreProperties {module:model/GetDatastoreResponseDatastoreProperties} 
     */
    constructor(datastoreProperties) { 
        
        GetDatastoreResponse.initialize(this, datastoreProperties);
    }
    ...
    /**
     * Constructs a <code>GetDatastoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDatastoreResponse} obj Optional instance to populate.
     * @return {module:model/GetDatastoreResponse} The populated <code>GetDatastoreResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDatastoreResponse();

            if (data.hasOwnProperty('datastoreProperties')) {
                obj['datastoreProperties'] = GetDatastoreResponseDatastoreProperties.constructFromObject(data['datastoreProperties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDatastoreResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDatastoreResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDatastoreResponse.RequiredProperties) {
        ...
        if (data['datastoreProperties']) { // data not null
          GetDatastoreResponseDatastoreProperties.validateJSON(data['datastoreProperties']);
        }
...
GetDatastoreResponse.RequiredProperties = ["datastoreProperties"];

/**
 * @member {module:model/GetDatastoreResponseDatastoreProperties} datastoreProperties
 */
GetDatastoreResponse.prototype['datastoreProperties'] = undefined;
...
export default GetDatastoreResponse;
