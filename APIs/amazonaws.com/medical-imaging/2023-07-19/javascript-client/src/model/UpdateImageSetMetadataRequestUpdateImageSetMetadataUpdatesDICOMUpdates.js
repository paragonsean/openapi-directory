...
import DICOMUpdates from './DICOMUpdates';

/**
 * The UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates model module.
 * @module model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
 * @version 2023-07-19
 */
class UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates {
    /**
     * Constructs a new <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates</code>.
     * @alias module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates
     * @implements module:model/DICOMUpdates
     */
    constructor() { 
        DICOMUpdates.initialize(this);
        UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates} obj Optional instance to populate.
     * @return {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates} The populated <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates();
            DICOMUpdates.constructFromObject(data, obj);

            if (data.hasOwnProperty('removableAttributes')) {
                obj['removableAttributes'] = ApiClient.convertToType(data['removableAttributes'], 'String');
            }
            if (data.hasOwnProperty('updatableAttributes')) {
                obj['updatableAttributes'] = ApiClient.convertToType(data['updatableAttributes'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates</code>.
     */
    static validateJSON(data) {
        // validate the optional field `removableAttributes`
        if (data['removableAttributes']) { // data not null
          String.validateJSON(data['removableAttributes']);
        }
        // validate the optional field `updatableAttributes`
        if (data['updatableAttributes']) { // data not null
          String.validateJSON(data['updatableAttributes']);
        }
...
/**
 * @member {String} removableAttributes
 */
UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.prototype['removableAttributes'] = undefined;

/**
 * @member {String} updatableAttributes
 */
UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.prototype['updatableAttributes'] = undefined;


// Implement DICOMUpdates interface:
/**
 * @member {String} removableAttributes
 */
DICOMUpdates.prototype['removableAttributes'] = undefined;
/**
 * @member {String} updatableAttributes
 */
DICOMUpdates.prototype['updatableAttributes'] = undefined;




export default UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates;
