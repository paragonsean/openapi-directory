...
/**
 * The DatastoreSummary model module.
 * @module model/DatastoreSummary
 * @version 2023-07-19
 */
class DatastoreSummary {
    /**
     * Constructs a new <code>DatastoreSummary</code>.
     * List of summaries of data stores.
     * @alias module:model/DatastoreSummary
    ...
    constructor(datastoreId, datastoreName, datastoreStatus) { 
        ...
        DatastoreSummary.initialize(this, datastoreId, datastoreName, datastoreStatus);
    }
    ...
    /**
     * Constructs a <code>DatastoreSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatastoreSummary} obj Optional instance to populate.
     * @return {module:model/DatastoreSummary} The populated <code>DatastoreSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatastoreSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DatastoreSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatastoreSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatastoreSummary.RequiredProperties) {
...
DatastoreSummary.RequiredProperties = ["datastoreId", "datastoreName", "datastoreStatus"];

/**
 * @member {String} datastoreId
 */
DatastoreSummary.prototype['datastoreId'] = undefined;

/**
 * @member {String} datastoreName
 */
DatastoreSummary.prototype['datastoreName'] = undefined;

/**
 * @member {module:model/DatastoreStatus} datastoreStatus
 */
DatastoreSummary.prototype['datastoreStatus'] = undefined;

/**
 * @member {String} datastoreArn
 */
DatastoreSummary.prototype['datastoreArn'] = undefined;

/**
 * @member {Date} createdAt
 */
DatastoreSummary.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
DatastoreSummary.prototype['updatedAt'] = undefined;
...
export default DatastoreSummary;
