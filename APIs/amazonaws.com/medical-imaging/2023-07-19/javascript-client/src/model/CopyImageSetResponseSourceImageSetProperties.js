...
import CopySourceImageSetProperties from './CopySourceImageSetProperties';
import ImageSetState from './ImageSetState';
import ImageSetWorkflowStatus from './ImageSetWorkflowStatus';

/**
 * The CopyImageSetResponseSourceImageSetProperties model module.
 * @module model/CopyImageSetResponseSourceImageSetProperties
 * @version 2023-07-19
 */
class CopyImageSetResponseSourceImageSetProperties {
    /**
     * Constructs a new <code>CopyImageSetResponseSourceImageSetProperties</code>.
     * @alias module:model/CopyImageSetResponseSourceImageSetProperties
     * @implements module:model/CopySourceImageSetProperties
    ...
    constructor(imageSetId, latestVersionId) { 
        ...
        CopyImageSetResponseSourceImageSetProperties.initialize(this, imageSetId, latestVersionId);
    }
    ...
    /**
     * Constructs a <code>CopyImageSetResponseSourceImageSetProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetResponseSourceImageSetProperties} obj Optional instance to populate.
     * @return {module:model/CopyImageSetResponseSourceImageSetProperties} The populated <code>CopyImageSetResponseSourceImageSetProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetResponseSourceImageSetProperties();
            CopySourceImageSetProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetResponseSourceImageSetProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetResponseSourceImageSetProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetResponseSourceImageSetProperties.RequiredProperties) {
...
CopyImageSetResponseSourceImageSetProperties.RequiredProperties = ["imageSetId", "latestVersionId"];

/**
 * @member {String} imageSetId
 */
CopyImageSetResponseSourceImageSetProperties.prototype['imageSetId'] = undefined;

/**
 * @member {String} latestVersionId
 */
CopyImageSetResponseSourceImageSetProperties.prototype['latestVersionId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
CopyImageSetResponseSourceImageSetProperties.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
CopyImageSetResponseSourceImageSetProperties.prototype['imageSetWorkflowStatus'] = undefined;

/**
 * @member {Date} createdAt
 */
CopyImageSetResponseSourceImageSetProperties.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
CopyImageSetResponseSourceImageSetProperties.prototype['updatedAt'] = undefined;

/**
 * @member {String} imageSetArn
 */
CopyImageSetResponseSourceImageSetProperties.prototype['imageSetArn'] = undefined;


// Implement CopySourceImageSetProperties interface:
/**
 * @member {String} imageSetId
 */
...
export default CopyImageSetResponseSourceImageSetProperties;
