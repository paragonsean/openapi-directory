...
/**
 * The ListDatastoresResponse model module.
 * @module model/ListDatastoresResponse
 * @version 2023-07-19
 */
class ListDatastoresResponse {
    /**
     * Constructs a new <code>ListDatastoresResponse</code>.
     * @alias module:model/ListDatastoresResponse
     */
    constructor() { 
        
        ListDatastoresResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListDatastoresResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListDatastoresResponse} obj Optional instance to populate.
     * @return {module:model/ListDatastoresResponse} The populated <code>ListDatastoresResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListDatastoresResponse();

            if (data.hasOwnProperty('datastoreSummaries')) {
                obj['datastoreSummaries'] = ApiClient.convertToType(data['datastoreSummaries'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListDatastoresResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListDatastoresResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `datastoreSummaries`
        if (data['datastoreSummaries']) { // data not null
          Array.validateJSON(data['datastoreSummaries']);
        }
...
/**
 * @member {Array} datastoreSummaries
 */
ListDatastoresResponse.prototype['datastoreSummaries'] = undefined;

/**
 * @member {String} nextToken
 */
ListDatastoresResponse.prototype['nextToken'] = undefined;
...
export default ListDatastoresResponse;
