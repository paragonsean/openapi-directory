...
import CopyDestinationImageSetProperties from './CopyDestinationImageSetProperties';
import ImageSetState from './ImageSetState';
import ImageSetWorkflowStatus from './ImageSetWorkflowStatus';

/**
 * The CopyImageSetResponseDestinationImageSetProperties model module.
 * @module model/CopyImageSetResponseDestinationImageSetProperties
 * @version 2023-07-19
 */
class CopyImageSetResponseDestinationImageSetProperties {
    /**
     * Constructs a new <code>CopyImageSetResponseDestinationImageSetProperties</code>.
     * @alias module:model/CopyImageSetResponseDestinationImageSetProperties
     * @implements module:model/CopyDestinationImageSetProperties
     * @param imageSetId {String} 
     * @param latestVersionId {String} 
     */
    constructor(imageSetId, latestVersionId) { 
        CopyDestinationImageSetProperties.initialize(this, imageSetId, latestVersionId);
        CopyImageSetResponseDestinationImageSetProperties.initialize(this, imageSetId, latestVersionId);
    }
    ...
    /**
     * Constructs a <code>CopyImageSetResponseDestinationImageSetProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetResponseDestinationImageSetProperties} obj Optional instance to populate.
     * @return {module:model/CopyImageSetResponseDestinationImageSetProperties} The populated <code>CopyImageSetResponseDestinationImageSetProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetResponseDestinationImageSetProperties();
            CopyDestinationImageSetProperties.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetResponseDestinationImageSetProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetResponseDestinationImageSetProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetResponseDestinationImageSetProperties.RequiredProperties) {
...
CopyImageSetResponseDestinationImageSetProperties.RequiredProperties = ["imageSetId", "latestVersionId"];

/**
 * @member {String} imageSetId
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['imageSetId'] = undefined;

/**
 * @member {String} latestVersionId
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['latestVersionId'] = undefined;

/**
 * @member {module:model/ImageSetState} imageSetState
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['imageSetState'] = undefined;

/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['imageSetWorkflowStatus'] = undefined;

/**
 * @member {Date} createdAt
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['updatedAt'] = undefined;

/**
 * @member {String} imageSetArn
 */
CopyImageSetResponseDestinationImageSetProperties.prototype['imageSetArn'] = undefined;


// Implement CopyDestinationImageSetProperties interface:
/**
 * @member {String} imageSetId
 */
CopyDestinationImageSetProperties.prototype['imageSetId'] = undefined;
/**
 * @member {String} latestVersionId
 */
CopyDestinationImageSetProperties.prototype['latestVersionId'] = undefined;
/**
 * @member {module:model/ImageSetState} imageSetState
 */
CopyDestinationImageSetProperties.prototype['imageSetState'] = undefined;
/**
 * @member {module:model/ImageSetWorkflowStatus} imageSetWorkflowStatus
 */
CopyDestinationImageSetProperties.prototype['imageSetWorkflowStatus'] = undefined;
/**
 * @member {Date} createdAt
 */
CopyDestinationImageSetProperties.prototype['createdAt'] = undefined;
/**
 * @member {Date} updatedAt
 */
CopyDestinationImageSetProperties.prototype['updatedAt'] = undefined;
/**
 * @member {String} imageSetArn
 */
CopyDestinationImageSetProperties.prototype['imageSetArn'] = undefined;




export default CopyImageSetResponseDestinationImageSetProperties;
