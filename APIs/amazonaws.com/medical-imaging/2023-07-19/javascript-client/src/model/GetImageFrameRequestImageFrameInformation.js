...
import ImageFrameInformation from './ImageFrameInformation';

/**
 * The GetImageFrameRequestImageFrameInformation model module.
 * @module model/GetImageFrameRequestImageFrameInformation
 * @version 2023-07-19
 */
class GetImageFrameRequestImageFrameInformation {
    /**
     * Constructs a new <code>GetImageFrameRequestImageFrameInformation</code>.
     * @alias module:model/GetImageFrameRequestImageFrameInformation
     * @implements module:model/ImageFrameInformation
     * @param imageFrameId {String} 
     */
    constructor(imageFrameId) { 
        ImageFrameInformation.initialize(this, imageFrameId);
        GetImageFrameRequestImageFrameInformation.initialize(this, imageFrameId);
    }
     ...
     */
    static initialize(obj, imageFrameId) { 
        obj['imageFrameId'] = imageFrameId;
    }

    /**
     * Constructs a <code>GetImageFrameRequestImageFrameInformation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImageFrameRequestImageFrameInformation} obj Optional instance to populate.
     * @return {module:model/GetImageFrameRequestImageFrameInformation} The populated <code>GetImageFrameRequestImageFrameInformation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImageFrameRequestImageFrameInformation();
            ImageFrameInformation.constructFromObject(data, obj);

            if (data.hasOwnProperty('imageFrameId')) {
                obj['imageFrameId'] = ApiClient.convertToType(data['imageFrameId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetImageFrameRequestImageFrameInformation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImageFrameRequestImageFrameInformation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImageFrameRequestImageFrameInformation.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageFrameId`
        if (data['imageFrameId']) { // data not null
          String.validateJSON(data['imageFrameId']);
        }
...
GetImageFrameRequestImageFrameInformation.RequiredProperties = ["imageFrameId"];

/**
 * @member {String} imageFrameId
 */
GetImageFrameRequestImageFrameInformation.prototype['imageFrameId'] = undefined;


// Implement ImageFrameInformation interface:
/**
 * @member {String} imageFrameId
 */
ImageFrameInformation.prototype['imageFrameId'] = undefined;




export default GetImageFrameRequestImageFrameInformation;
