...
import MetadataUpdates from './MetadataUpdates';
import UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates from './UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates';

/**
 * The UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates model module.
 * @module model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates
 * @version 2023-07-19
 */
class UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates {
    /**
     * Constructs a new <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates</code>.
     * @alias module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates
     * @implements module:model/MetadataUpdates
     */
    constructor() { 
        MetadataUpdates.initialize(this);
        UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates} obj Optional instance to populate.
     * @return {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates} The populated <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates();
            MetadataUpdates.constructFromObject(data, obj);

            if (data.hasOwnProperty('DICOMUpdates')) {
                obj['DICOMUpdates'] = UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.constructFromObject(data['DICOMUpdates']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DICOMUpdates`
        if (data['DICOMUpdates']) { // data not null
          UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates.validateJSON(data['DICOMUpdates']);
        }
...
/**
 * @member {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates} DICOMUpdates
 */
UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates.prototype['DICOMUpdates'] = undefined;


// Implement MetadataUpdates interface:
/**
 * @member {module:model/UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdatesDICOMUpdates} DICOMUpdates
 */
MetadataUpdates.prototype['DICOMUpdates'] = undefined;




export default UpdateImageSetMetadataRequestUpdateImageSetMetadataUpdates;
