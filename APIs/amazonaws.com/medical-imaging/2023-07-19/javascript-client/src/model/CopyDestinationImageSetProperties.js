...
/**
 * The CopyDestinationImageSetProperties model module.
 * @module model/CopyDestinationImageSetProperties
 * @version 2023-07-19
 */
class CopyDestinationImageSetProperties {
    /**
     * Constructs a new <code>CopyDestinationImageSetProperties</code>.
     * Copy the image set properties of the destination image set.
     * @alias module:model/CopyDestinationImageSetProperties
    ...
    /**
     * Constructs a <code>CopyDestinationImageSetProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyDestinationImageSetProperties} obj Optional instance to populate.
     * @return {module:model/CopyDestinationImageSetProperties} The populated <code>CopyDestinationImageSetProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyDestinationImageSetProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyDestinationImageSetProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyDestinationImageSetProperties</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyDestinationImageSetProperties.RequiredProperties) {
...
CopyDestinationImageSetProperties.RequiredProperties = ["imageSetId", "latestVersionId"];
...
export default CopyDestinationImageSetProperties;
