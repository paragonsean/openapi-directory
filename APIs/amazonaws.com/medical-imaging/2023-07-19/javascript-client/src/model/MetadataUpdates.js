...
/**
 * The MetadataUpdates model module.
 * @module model/MetadataUpdates
 * @version 2023-07-19
 */
class MetadataUpdates {
    /**
     * Constructs a new <code>MetadataUpdates</code>.
     * Contains DICOMUpdates.
     * @alias module:model/MetadataUpdates
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MetadataUpdates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetadataUpdates} obj Optional instance to populate.
     * @return {module:model/MetadataUpdates} The populated <code>MetadataUpdates</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetadataUpdates();
    ...
    /**
     * Validates the JSON data with respect to <code>MetadataUpdates</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetadataUpdates</code>.
     */
...
export default MetadataUpdates;
