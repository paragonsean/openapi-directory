...
import CopySourceImageSetInformation from './CopySourceImageSetInformation';

/**
 * The CopyImageSetRequestCopyImageSetInformationSourceImageSet model module.
 * @module model/CopyImageSetRequestCopyImageSetInformationSourceImageSet
 * @version 2023-07-19
 */
class CopyImageSetRequestCopyImageSetInformationSourceImageSet {
    /**
     * Constructs a new <code>CopyImageSetRequestCopyImageSetInformationSourceImageSet</code>.
     * @alias module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet
     * @implements module:model/CopySourceImageSetInformation
     * @param latestVersionId {String} 
     */
    constructor(latestVersionId) { 
        CopySourceImageSetInformation.initialize(this, latestVersionId);
        CopyImageSetRequestCopyImageSetInformationSourceImageSet.initialize(this, latestVersionId);
    }
     ...
     */
    static initialize(obj, latestVersionId) { 
        obj['latestVersionId'] = latestVersionId;
    }

    /**
     * Constructs a <code>CopyImageSetRequestCopyImageSetInformationSourceImageSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet} obj Optional instance to populate.
     * @return {module:model/CopyImageSetRequestCopyImageSetInformationSourceImageSet} The populated <code>CopyImageSetRequestCopyImageSetInformationSourceImageSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetRequestCopyImageSetInformationSourceImageSet();
            CopySourceImageSetInformation.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetRequestCopyImageSetInformationSourceImageSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetRequestCopyImageSetInformationSourceImageSet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetRequestCopyImageSetInformationSourceImageSet.RequiredProperties) {
...
CopyImageSetRequestCopyImageSetInformationSourceImageSet.RequiredProperties = ["latestVersionId"];

/**
 * @member {String} latestVersionId
 */
CopyImageSetRequestCopyImageSetInformationSourceImageSet.prototype['latestVersionId'] = undefined;


// Implement CopySourceImageSetInformation interface:
/**
 * @member {String} latestVersionId
 */
CopySourceImageSetInformation.prototype['latestVersionId'] = undefined;




export default CopyImageSetRequestCopyImageSetInformationSourceImageSet;
