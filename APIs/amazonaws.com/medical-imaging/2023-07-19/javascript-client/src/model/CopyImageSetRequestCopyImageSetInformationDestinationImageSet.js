...
import CopyDestinationImageSet from './CopyDestinationImageSet';

/**
 * The CopyImageSetRequestCopyImageSetInformationDestinationImageSet model module.
 * @module model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet
 * @version 2023-07-19
 */
class CopyImageSetRequestCopyImageSetInformationDestinationImageSet {
    /**
     * Constructs a new <code>CopyImageSetRequestCopyImageSetInformationDestinationImageSet</code>.
     * @alias module:model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet
     * @implements module:model/CopyDestinationImageSet
     * @param imageSetId {String} 
     * @param latestVersionId {String} 
     */
    constructor(imageSetId, latestVersionId) { 
        CopyDestinationImageSet.initialize(this, imageSetId, latestVersionId);
        CopyImageSetRequestCopyImageSetInformationDestinationImageSet.initialize(this, imageSetId, latestVersionId);
    }
    ...
    /**
     * Constructs a <code>CopyImageSetRequestCopyImageSetInformationDestinationImageSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet} obj Optional instance to populate.
     * @return {module:model/CopyImageSetRequestCopyImageSetInformationDestinationImageSet} The populated <code>CopyImageSetRequestCopyImageSetInformationDestinationImageSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetRequestCopyImageSetInformationDestinationImageSet();
            CopyDestinationImageSet.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetRequestCopyImageSetInformationDestinationImageSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetRequestCopyImageSetInformationDestinationImageSet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetRequestCopyImageSetInformationDestinationImageSet.RequiredProperties) {
...
CopyImageSetRequestCopyImageSetInformationDestinationImageSet.RequiredProperties = ["imageSetId", "latestVersionId"];

/**
 * @member {String} imageSetId
 */
CopyImageSetRequestCopyImageSetInformationDestinationImageSet.prototype['imageSetId'] = undefined;

/**
 * @member {String} latestVersionId
 */
CopyImageSetRequestCopyImageSetInformationDestinationImageSet.prototype['latestVersionId'] = undefined;


// Implement CopyDestinationImageSet interface:
/**
 * @member {String} imageSetId
 */
CopyDestinationImageSet.prototype['imageSetId'] = undefined;
/**
 * @member {String} latestVersionId
 */
CopyDestinationImageSet.prototype['latestVersionId'] = undefined;




export default CopyImageSetRequestCopyImageSetInformationDestinationImageSet;
