...
* @readonly
*/
export default class ImageSetState {
    ...
    /**
    * Returns a <code>ImageSetState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ImageSetState} The enum <code>ImageSetState</code> value.
    */
