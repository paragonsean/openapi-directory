...
import SearchByAttributeValueDICOMStudyDateAndTime from './SearchByAttributeValueDICOMStudyDateAndTime';

/**
 * The SearchByAttributeValue model module.
 * @module model/SearchByAttributeValue
 * @version 2023-07-19
 */
class SearchByAttributeValue {
    /**
     * Constructs a new <code>SearchByAttributeValue</code>.
     * The search input attribute value.
     * @alias module:model/SearchByAttributeValue
     */
    constructor() { 
        
        SearchByAttributeValue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchByAttributeValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchByAttributeValue} obj Optional instance to populate.
     * @return {module:model/SearchByAttributeValue} The populated <code>SearchByAttributeValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchByAttributeValue();
            ...
            if (data.hasOwnProperty('DICOMStudyDateAndTime')) {
                obj['DICOMStudyDateAndTime'] = SearchByAttributeValueDICOMStudyDateAndTime.constructFromObject(data['DICOMStudyDateAndTime']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchByAttributeValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchByAttributeValue</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DICOMStudyDateAndTime']) { // data not null
          SearchByAttributeValueDICOMStudyDateAndTime.validateJSON(data['DICOMStudyDateAndTime']);
        }
 ...
 */
SearchByAttributeValue.prototype['DICOMPatientId'] = undefined;

/**
 * @member {String} DICOMAccessionNumber
 */
SearchByAttributeValue.prototype['DICOMAccessionNumber'] = undefined;

/**
 * @member {String} DICOMStudyId
 */
SearchByAttributeValue.prototype['DICOMStudyId'] = undefined;

/**
 * @member {String} DICOMStudyInstanceUID
 */
SearchByAttributeValue.prototype['DICOMStudyInstanceUID'] = undefined;

/**
 * @member {Date} createdAt
 */
SearchByAttributeValue.prototype['createdAt'] = undefined;

/**
 * @member {module:model/SearchByAttributeValueDICOMStudyDateAndTime} DICOMStudyDateAndTime
 */
SearchByAttributeValue.prototype['DICOMStudyDateAndTime'] = undefined;
...
export default SearchByAttributeValue;
