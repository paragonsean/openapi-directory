...
/**
 * The DICOMImportJobSummary model module.
 * @module model/DICOMImportJobSummary
 * @version 2023-07-19
 */
class DICOMImportJobSummary {
    /**
     * Constructs a new <code>DICOMImportJobSummary</code>.
     * Summary of import job.
     * @alias module:model/DICOMImportJobSummary
     * @param jobId {String} 
     * @param jobName {String} 
     * @param jobStatus {module:model/JobStatus} 
     * @param datastoreId {String} 
     */
    constructor(jobId, jobName, jobStatus, datastoreId) { 
        
        DICOMImportJobSummary.initialize(this, jobId, jobName, jobStatus, datastoreId);
    }
     ...
     */
    static initialize(obj, jobId, jobName, jobStatus, datastoreId) { 
        obj['jobId'] = jobId;
        obj['jobName'] = jobName;
    ...
    /**
     * Constructs a <code>DICOMImportJobSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DICOMImportJobSummary} obj Optional instance to populate.
     * @return {module:model/DICOMImportJobSummary} The populated <code>DICOMImportJobSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DICOMImportJobSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DICOMImportJobSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DICOMImportJobSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DICOMImportJobSummary.RequiredProperties) {
...
DICOMImportJobSummary.RequiredProperties = ["jobId", "jobName", "jobStatus", "datastoreId"];

/**
 * @member {String} jobId
 */
DICOMImportJobSummary.prototype['jobId'] = undefined;

/**
 * @member {String} jobName
 */
DICOMImportJobSummary.prototype['jobName'] = undefined;

/**
 * @member {module:model/JobStatus} jobStatus
 */
DICOMImportJobSummary.prototype['jobStatus'] = undefined;

/**
 * @member {String} datastoreId
 */
DICOMImportJobSummary.prototype['datastoreId'] = undefined;

/**
 * @member {String} dataAccessRoleArn
 */
DICOMImportJobSummary.prototype['dataAccessRoleArn'] = undefined;

/**
 * @member {Date} endedAt
 */
DICOMImportJobSummary.prototype['endedAt'] = undefined;

/**
 * @member {Date} submittedAt
 */
DICOMImportJobSummary.prototype['submittedAt'] = undefined;

/**
 * @member {String} message
 */
DICOMImportJobSummary.prototype['message'] = undefined;
...
export default DICOMImportJobSummary;
