...
import ImageSetsMetadataSummaryDICOMTags from './ImageSetsMetadataSummaryDICOMTags';

/**
 * The ImageSetsMetadataSummary model module.
 * @module model/ImageSetsMetadataSummary
 * @version 2023-07-19
 */
class ImageSetsMetadataSummary {
    /**
     * Constructs a new <code>ImageSetsMetadataSummary</code>.
     * Summary of the image set metadata.
     * @alias module:model/ImageSetsMetadataSummary
     * @param imageSetId {String} 
     */
    constructor(imageSetId) { 
        
        ImageSetsMetadataSummary.initialize(this, imageSetId);
    }
     ...
     */
    static initialize(obj, imageSetId) { 
        obj['imageSetId'] = imageSetId;
    }

    /**
     * Constructs a <code>ImageSetsMetadataSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageSetsMetadataSummary} obj Optional instance to populate.
     * @return {module:model/ImageSetsMetadataSummary} The populated <code>ImageSetsMetadataSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageSetsMetadataSummary();
            ...
            if (data.hasOwnProperty('DICOMTags')) {
                obj['DICOMTags'] = ImageSetsMetadataSummaryDICOMTags.constructFromObject(data['DICOMTags']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImageSetsMetadataSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageSetsMetadataSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImageSetsMetadataSummary.RequiredProperties) {
        ...
        if (data['DICOMTags']) { // data not null
          ImageSetsMetadataSummaryDICOMTags.validateJSON(data['DICOMTags']);
        }
...
ImageSetsMetadataSummary.RequiredProperties = ["imageSetId"];

/**
 * @member {String} imageSetId
 */
ImageSetsMetadataSummary.prototype['imageSetId'] = undefined;

/**
 * @member {Number} version
 */
ImageSetsMetadataSummary.prototype['version'] = undefined;

/**
 * @member {Date} createdAt
 */
ImageSetsMetadataSummary.prototype['createdAt'] = undefined;

/**
 * @member {Date} updatedAt
 */
ImageSetsMetadataSummary.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/ImageSetsMetadataSummaryDICOMTags} DICOMTags
 */
ImageSetsMetadataSummary.prototype['DICOMTags'] = undefined;
...
export default ImageSetsMetadataSummary;
