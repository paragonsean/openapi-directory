...
/**
 * The GetImageSetMetadataResponse model module.
 * @module model/GetImageSetMetadataResponse
 * @version 2023-07-19
 */
class GetImageSetMetadataResponse {
    /**
     * Constructs a new <code>GetImageSetMetadataResponse</code>.
     * @alias module:model/GetImageSetMetadataResponse
     * @param imageSetMetadataBlob {String} 
     */
    constructor(imageSetMetadataBlob) { 
        
        GetImageSetMetadataResponse.initialize(this, imageSetMetadataBlob);
    }
     ...
     */
    static initialize(obj, imageSetMetadataBlob) { 
        obj['imageSetMetadataBlob'] = imageSetMetadataBlob;
    }

    /**
     * Constructs a <code>GetImageSetMetadataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImageSetMetadataResponse} obj Optional instance to populate.
     * @return {module:model/GetImageSetMetadataResponse} The populated <code>GetImageSetMetadataResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImageSetMetadataResponse();

            if (data.hasOwnProperty('imageSetMetadataBlob')) {
                obj['imageSetMetadataBlob'] = ApiClient.convertToType(data['imageSetMetadataBlob'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetImageSetMetadataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImageSetMetadataResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImageSetMetadataResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageSetMetadataBlob`
        if (data['imageSetMetadataBlob']) { // data not null
          String.validateJSON(data['imageSetMetadataBlob']);
        }
...
GetImageSetMetadataResponse.RequiredProperties = ["imageSetMetadataBlob"];

/**
 * @member {String} imageSetMetadataBlob
 */
GetImageSetMetadataResponse.prototype['imageSetMetadataBlob'] = undefined;
...
export default GetImageSetMetadataResponse;
