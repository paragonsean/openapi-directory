...
/**
 * The CreateDatastoreRequest model module.
 * @module model/CreateDatastoreRequest
 * @version 2023-07-19
 */
class CreateDatastoreRequest {
    /**
     * Constructs a new <code>CreateDatastoreRequest</code>.
     * @alias module:model/CreateDatastoreRequest
     * @param clientToken {String} A unique identifier for API idempotency.
     */
    constructor(clientToken) { 
        
        CreateDatastoreRequest.initialize(this, clientToken);
    }
    ...
    /**
     * Constructs a <code>CreateDatastoreRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDatastoreRequest} obj Optional instance to populate.
     * @return {module:model/CreateDatastoreRequest} The populated <code>CreateDatastoreRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDatastoreRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDatastoreRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDatastoreRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateDatastoreRequest.RequiredProperties) {
...
CreateDatastoreRequest.RequiredProperties = ["clientToken"];

/**
 * The data store name.
 * @member {String} datastoreName
 */
CreateDatastoreRequest.prototype['datastoreName'] = undefined;

/**
 * A unique identifier for API idempotency.
 * @member {String} clientToken
 */
CreateDatastoreRequest.prototype['clientToken'] = undefined;

/**
 * The tags provided when creating a data store.
 * @member {Object.<String, String>} tags
 */
CreateDatastoreRequest.prototype['tags'] = undefined;

/**
 * ARN referencing a KMS key or KMS key alias.
 * @member {String} kmsKeyArn
 */
CreateDatastoreRequest.prototype['kmsKeyArn'] = undefined;
...
export default CreateDatastoreRequest;
