...
import CopyImageSetResponseDestinationImageSetProperties from './CopyImageSetResponseDestinationImageSetProperties';
import CopyImageSetResponseSourceImageSetProperties from './CopyImageSetResponseSourceImageSetProperties';

/**
 * The CopyImageSetResponse model module.
 * @module model/CopyImageSetResponse
 * @version 2023-07-19
 */
class CopyImageSetResponse {
    /**
     * Constructs a new <code>CopyImageSetResponse</code>.
     * @alias module:model/CopyImageSetResponse
     * @param datastoreId {String} 
     * @param sourceImageSetProperties {module:model/CopyImageSetResponseSourceImageSetProperties} 
     * @param destinationImageSetProperties {module:model/CopyImageSetResponseDestinationImageSetProperties} 
     */
    constructor(datastoreId, sourceImageSetProperties, destinationImageSetProperties) { 
        
        CopyImageSetResponse.initialize(this, datastoreId, sourceImageSetProperties, destinationImageSetProperties);
    }
     ...
     */
    static initialize(obj, datastoreId, sourceImageSetProperties, destinationImageSetProperties) { 
        obj['datastoreId'] = datastoreId;
        obj['sourceImageSetProperties'] = sourceImageSetProperties;
        obj['destinationImageSetProperties'] = destinationImageSetProperties;
    }

    /**
     * Constructs a <code>CopyImageSetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyImageSetResponse} obj Optional instance to populate.
     * @return {module:model/CopyImageSetResponse} The populated <code>CopyImageSetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyImageSetResponse();

            if (data.hasOwnProperty('datastoreId')) {
                obj['datastoreId'] = ApiClient.convertToType(data['datastoreId'], 'String');
            }
            if (data.hasOwnProperty('sourceImageSetProperties')) {
                obj['sourceImageSetProperties'] = CopyImageSetResponseSourceImageSetProperties.constructFromObject(data['sourceImageSetProperties']);
            }
            if (data.hasOwnProperty('destinationImageSetProperties')) {
                obj['destinationImageSetProperties'] = CopyImageSetResponseDestinationImageSetProperties.constructFromObject(data['destinationImageSetProperties']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CopyImageSetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyImageSetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyImageSetResponse.RequiredProperties) {
        ...
        // validate the optional field `sourceImageSetProperties`
        if (data['sourceImageSetProperties']) { // data not null
          CopyImageSetResponseSourceImageSetProperties.validateJSON(data['sourceImageSetProperties']);
        }
        // validate the optional field `destinationImageSetProperties`
        if (data['destinationImageSetProperties']) { // data not null
          CopyImageSetResponseDestinationImageSetProperties.validateJSON(data['destinationImageSetProperties']);
        }
...
CopyImageSetResponse.RequiredProperties = ["datastoreId", "sourceImageSetProperties", "destinationImageSetProperties"];

/**
 * @member {String} datastoreId
 */
CopyImageSetResponse.prototype['datastoreId'] = undefined;

/**
 * @member {module:model/CopyImageSetResponseSourceImageSetProperties} sourceImageSetProperties
 */
CopyImageSetResponse.prototype['sourceImageSetProperties'] = undefined;

/**
 * @member {module:model/CopyImageSetResponseDestinationImageSetProperties} destinationImageSetProperties
 */
CopyImageSetResponse.prototype['destinationImageSetProperties'] = undefined;
...
export default CopyImageSetResponse;
