...
/**
 * The GetImageFrameResponse model module.
 * @module model/GetImageFrameResponse
 * @version 2023-07-19
 */
class GetImageFrameResponse {
    /**
     * Constructs a new <code>GetImageFrameResponse</code>.
     * @alias module:model/GetImageFrameResponse
     * @param imageFrameBlob {String} 
     */
    constructor(imageFrameBlob) { 
        
        GetImageFrameResponse.initialize(this, imageFrameBlob);
    }
     ...
     */
    static initialize(obj, imageFrameBlob) { 
        obj['imageFrameBlob'] = imageFrameBlob;
    }

    /**
     * Constructs a <code>GetImageFrameResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetImageFrameResponse} obj Optional instance to populate.
     * @return {module:model/GetImageFrameResponse} The populated <code>GetImageFrameResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetImageFrameResponse();

            if (data.hasOwnProperty('imageFrameBlob')) {
                obj['imageFrameBlob'] = ApiClient.convertToType(data['imageFrameBlob'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetImageFrameResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetImageFrameResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetImageFrameResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageFrameBlob`
        if (data['imageFrameBlob']) { // data not null
          String.validateJSON(data['imageFrameBlob']);
        }
...
GetImageFrameResponse.RequiredProperties = ["imageFrameBlob"];

/**
 * @member {String} imageFrameBlob
 */
GetImageFrameResponse.prototype['imageFrameBlob'] = undefined;
...
export default GetImageFrameResponse;
