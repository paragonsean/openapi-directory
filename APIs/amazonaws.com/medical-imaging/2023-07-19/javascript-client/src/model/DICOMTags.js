...
class DICOMTags {
    ...
    /**
     * Constructs a <code>DICOMTags</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DICOMTags} obj Optional instance to populate.
     * @return {module:model/DICOMTags} The populated <code>DICOMTags</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DICOMTags();
    ...
    /**
     * Validates the JSON data with respect to <code>DICOMTags</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DICOMTags</code>.
     */
