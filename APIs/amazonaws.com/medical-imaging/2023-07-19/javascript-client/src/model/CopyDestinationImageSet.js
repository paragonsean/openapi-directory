...
/**
 * The CopyDestinationImageSet model module.
 * @module model/CopyDestinationImageSet
 * @version 2023-07-19
 */
class CopyDestinationImageSet {
    /**
     * Constructs a new <code>CopyDestinationImageSet</code>.
     * Copy the destination image set.
     * @alias module:model/CopyDestinationImageSet
    ...
    /**
     * Constructs a <code>CopyDestinationImageSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyDestinationImageSet} obj Optional instance to populate.
     * @return {module:model/CopyDestinationImageSet} The populated <code>CopyDestinationImageSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyDestinationImageSet();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyDestinationImageSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyDestinationImageSet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CopyDestinationImageSet.RequiredProperties) {
...
CopyDestinationImageSet.RequiredProperties = ["imageSetId", "latestVersionId"];
...
export default CopyDestinationImageSet;
