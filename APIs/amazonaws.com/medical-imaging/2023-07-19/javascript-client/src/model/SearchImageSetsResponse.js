...
/**
 * The SearchImageSetsResponse model module.
 * @module model/SearchImageSetsResponse
 * @version 2023-07-19
 */
class SearchImageSetsResponse {
    /**
     * Constructs a new <code>SearchImageSetsResponse</code>.
     * @alias module:model/SearchImageSetsResponse
     * @param imageSetsMetadataSummaries {Array} 
     */
    constructor(imageSetsMetadataSummaries) { 
        
        SearchImageSetsResponse.initialize(this, imageSetsMetadataSummaries);
    }
     ...
     */
    static initialize(obj, imageSetsMetadataSummaries) { 
        obj['imageSetsMetadataSummaries'] = imageSetsMetadataSummaries;
    }

    /**
     * Constructs a <code>SearchImageSetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchImageSetsResponse} obj Optional instance to populate.
     * @return {module:model/SearchImageSetsResponse} The populated <code>SearchImageSetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchImageSetsResponse();

            if (data.hasOwnProperty('imageSetsMetadataSummaries')) {
                obj['imageSetsMetadataSummaries'] = ApiClient.convertToType(data['imageSetsMetadataSummaries'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SearchImageSetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchImageSetsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchImageSetsResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `imageSetsMetadataSummaries`
        if (data['imageSetsMetadataSummaries']) { // data not null
          Array.validateJSON(data['imageSetsMetadataSummaries']);
        }
...
SearchImageSetsResponse.RequiredProperties = ["imageSetsMetadataSummaries"];

/**
 * @member {Array} imageSetsMetadataSummaries
 */
SearchImageSetsResponse.prototype['imageSetsMetadataSummaries'] = undefined;

/**
 * @member {String} nextToken
 */
SearchImageSetsResponse.prototype['nextToken'] = undefined;
...
export default SearchImageSetsResponse;
