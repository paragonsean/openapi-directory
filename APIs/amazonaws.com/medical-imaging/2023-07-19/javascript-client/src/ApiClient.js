...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://medical-imaging.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://medical-imaging.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2023-07-19/Javascript'
        };
