...
public class GetSystemInstanceResponseDescription {
  ...
  public GetSystemInstanceResponseDescription() {
  }

  public GetSystemInstanceResponseDescription summary(SystemInstanceDescriptionSummary summary) {
  ...
  public GetSystemInstanceResponseDescription definition(DefinitionDocument definition) {
  ...
  public GetSystemInstanceResponseDescription s3BucketName(String s3BucketName) {
  ...
  public GetSystemInstanceResponseDescription metricsConfiguration(MetricsConfiguration metricsConfiguration) {
  ...
  public GetSystemInstanceResponseDescription validatedNamespaceVersion(Integer validatedNamespaceVersion) {
  ...
  public GetSystemInstanceResponseDescription validatedDependencyRevisions(List validatedDependencyRevisions) {
  ...
  public GetSystemInstanceResponseDescription flowActionsRoleArn(String flowActionsRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetSystemInstanceResponseDescription getSystemInstanceResponseDescription = (GetSystemInstanceResponseDescription) o;
    return Objects.equals(this.summary, getSystemInstanceResponseDescription.summary) &&
        Objects.equals(this.definition, getSystemInstanceResponseDescription.definition) &&
        Objects.equals(this.s3BucketName, getSystemInstanceResponseDescription.s3BucketName) &&
        Objects.equals(this.metricsConfiguration, getSystemInstanceResponseDescription.metricsConfiguration) &&
        Objects.equals(this.validatedNamespaceVersion, getSystemInstanceResponseDescription.validatedNamespaceVersion) &&
        Objects.equals(this.validatedDependencyRevisions, getSystemInstanceResponseDescription.validatedDependencyRevisions) &&
        Objects.equals(this.flowActionsRoleArn, getSystemInstanceResponseDescription.flowActionsRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSystemInstanceResponseDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSystemInstanceResponseDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSystemInstanceResponseDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSystemInstanceResponseDescription is not found in the empty JSON string", GetSystemInstanceResponseDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSystemInstanceResponseDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSystemInstanceResponseDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSystemInstanceResponseDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSystemInstanceResponseDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSystemInstanceResponseDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSystemInstanceResponseDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSystemInstanceResponseDescription>() {
           @Override
           public void write(JsonWriter out, GetSystemInstanceResponseDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSystemInstanceResponseDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSystemInstanceResponseDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSystemInstanceResponseDescription
   * @throws IOException if the JSON string is invalid with respect to GetSystemInstanceResponseDescription
   */
  public static GetSystemInstanceResponseDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSystemInstanceResponseDescription.class);
  }

  /**
   * Convert an instance of GetSystemInstanceResponseDescription to an JSON string
   *
   * @return JSON string
   */
