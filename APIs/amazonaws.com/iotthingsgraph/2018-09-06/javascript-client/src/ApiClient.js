...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://iotthingsgraph.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://iotthingsgraph.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-09-06/Javascript'
        };
