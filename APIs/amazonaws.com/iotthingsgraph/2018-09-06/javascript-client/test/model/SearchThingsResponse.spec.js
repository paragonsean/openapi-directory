...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SearchThingsResponse();
  });
  ...
  describe('SearchThingsResponse', function() {
    it('should create an instance of SearchThingsResponse', function() {
      // uncomment below and update the code to test SearchThingsResponse
      //var instance = new AwsIoTThingsGraph.SearchThingsResponse();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SearchThingsResponse);
    });
