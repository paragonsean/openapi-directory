...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.ListFlowExecutionMessagesRequest();
  });
  ...
  describe('ListFlowExecutionMessagesRequest', function() {
    it('should create an instance of ListFlowExecutionMessagesRequest', function() {
      // uncomment below and update the code to test ListFlowExecutionMessagesRequest
      //var instance = new AwsIoTThingsGraph.ListFlowExecutionMessagesRequest();
      //expect(instance).to.be.a(AwsIoTThingsGraph.ListFlowExecutionMessagesRequest);
    });
