...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.EntityDescription();
  });
  ...
  describe('EntityDescription', function() {
    it('should create an instance of EntityDescription', function() {
      // uncomment below and update the code to test EntityDescription
      //var instance = new AwsIoTThingsGraph.EntityDescription();
      //expect(instance).to.be.a(AwsIoTThingsGraph.EntityDescription);
    });
