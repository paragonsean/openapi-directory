...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SearchSystemTemplatesRequest();
  });
  ...
  describe('SearchSystemTemplatesRequest', function() {
    it('should create an instance of SearchSystemTemplatesRequest', function() {
      // uncomment below and update the code to test SearchSystemTemplatesRequest
      //var instance = new AwsIoTThingsGraph.SearchSystemTemplatesRequest();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SearchSystemTemplatesRequest);
    });
