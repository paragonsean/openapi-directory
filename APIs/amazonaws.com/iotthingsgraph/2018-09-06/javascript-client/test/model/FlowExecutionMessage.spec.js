...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.FlowExecutionMessage();
  });
  ...
  describe('FlowExecutionMessage', function() {
    it('should create an instance of FlowExecutionMessage', function() {
      // uncomment below and update the code to test FlowExecutionMessage
      //var instance = new AwsIoTThingsGraph.FlowExecutionMessage();
      //expect(instance).to.be.a(AwsIoTThingsGraph.FlowExecutionMessage);
    });
