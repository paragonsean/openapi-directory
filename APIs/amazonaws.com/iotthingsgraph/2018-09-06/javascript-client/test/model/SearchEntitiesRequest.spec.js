...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SearchEntitiesRequest();
  });
  ...
  describe('SearchEntitiesRequest', function() {
    it('should create an instance of SearchEntitiesRequest', function() {
      // uncomment below and update the code to test SearchEntitiesRequest
      //var instance = new AwsIoTThingsGraph.SearchEntitiesRequest();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SearchEntitiesRequest);
    });
