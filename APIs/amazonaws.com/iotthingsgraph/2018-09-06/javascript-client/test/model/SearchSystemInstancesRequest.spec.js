...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SearchSystemInstancesRequest();
  });
  ...
  describe('SearchSystemInstancesRequest', function() {
    it('should create an instance of SearchSystemInstancesRequest', function() {
      // uncomment below and update the code to test SearchSystemInstancesRequest
      //var instance = new AwsIoTThingsGraph.SearchSystemInstancesRequest();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SearchSystemInstancesRequest);
    });
