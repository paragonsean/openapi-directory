...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.FlowTemplateSummary();
  });
  ...
  describe('FlowTemplateSummary', function() {
    it('should create an instance of FlowTemplateSummary', function() {
      // uncomment below and update the code to test FlowTemplateSummary
      //var instance = new AwsIoTThingsGraph.FlowTemplateSummary();
      //expect(instance).to.be.a(AwsIoTThingsGraph.FlowTemplateSummary);
    });
