...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SystemTemplateSummary();
  });
  ...
  describe('SystemTemplateSummary', function() {
    it('should create an instance of SystemTemplateSummary', function() {
      // uncomment below and update the code to test SystemTemplateSummary
      //var instance = new AwsIoTThingsGraph.SystemTemplateSummary();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SystemTemplateSummary);
    });
