...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTThingsGraph.SearchFlowExecutionsRequest();
  });
  ...
  describe('SearchFlowExecutionsRequest', function() {
    it('should create an instance of SearchFlowExecutionsRequest', function() {
      // uncomment below and update the code to test SearchFlowExecutionsRequest
      //var instance = new AwsIoTThingsGraph.SearchFlowExecutionsRequest();
      //expect(instance).to.be.a(AwsIoTThingsGraph.SearchFlowExecutionsRequest);
    });
