...
/*
 * OAIAssociateEntityToThingRequest.h
 *
 * 
 */

#ifndef OAIAssociateEntityToThingRequest_H
#define OAIAssociateEntityToThingRequest_H
...
class OAIAssociateEntityToThingRequest : public OAIObject {
public:
    OAIAssociateEntityToThingRequest();
    OAIAssociateEntityToThingRequest(QString json);
    ~OAIAssociateEntityToThingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateEntityToThingRequest)

#endif // OAIAssociateEntityToThingRequest_H
