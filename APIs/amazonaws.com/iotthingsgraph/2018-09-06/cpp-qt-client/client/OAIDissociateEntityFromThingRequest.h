...
/*
 * OAIDissociateEntityFromThingRequest.h
 *
 * 
 */

#ifndef OAIDissociateEntityFromThingRequest_H
#define OAIDissociateEntityFromThingRequest_H
...
class OAIDissociateEntityFromThingRequest : public OAIObject {
public:
    OAIDissociateEntityFromThingRequest();
    OAIDissociateEntityFromThingRequest(QString json);
    ~OAIDissociateEntityFromThingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDissociateEntityFromThingRequest)

#endif // OAIDissociateEntityFromThingRequest_H
