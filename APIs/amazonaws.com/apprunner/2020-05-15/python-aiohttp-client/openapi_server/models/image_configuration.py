...
class ImageConfiguration(Model):
    ...
    def __init__(self, runtime_environment_variables: Dict=None, start_command: str=None, port: str=None, runtime_environment_secrets: Dict=None):
        ...
        :param runtime_environment_variables: The runtime_environment_variables of this ImageConfiguration.
        :param start_command: The start_command of this ImageConfiguration.
        :param port: The port of this ImageConfiguration.
        :param runtime_environment_secrets: The runtime_environment_secrets of this ImageConfiguration.
        """
        self.openapi_types = {
    ...
    def runtime_environment_variables(self):
        """Gets the runtime_environment_variables of this ImageConfiguration.


        :return: The runtime_environment_variables of this ImageConfiguration.
        :rtype: Dict
        """
    ...
    def runtime_environment_variables(self, runtime_environment_variables):
        """Sets the runtime_environment_variables of this ImageConfiguration.
    ...
    def start_command(self):
        """Gets the start_command of this ImageConfiguration.


        :return: The start_command of this ImageConfiguration.
        :rtype: str
        """
    ...
    def start_command(self, start_command):
        """Sets the start_command of this ImageConfiguration.
    ...
    @property
    def port(self):
        """Gets the port of this ImageConfiguration.


        :return: The port of this ImageConfiguration.
        :rtype: str
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this ImageConfiguration.
    ...
    def runtime_environment_secrets(self):
        """Gets the runtime_environment_secrets of this ImageConfiguration.


        :return: The runtime_environment_secrets of this ImageConfiguration.
        :rtype: Dict
        """
    ...
    def runtime_environment_secrets(self, runtime_environment_secrets):
        """Sets the runtime_environment_secrets of this ImageConfiguration.
