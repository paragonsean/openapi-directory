...
class ServiceNetworkConfiguration(Model):
    ...
    def __init__(self, egress_configuration: NetworkConfigurationEgressConfiguration=None, ingress_configuration: NetworkConfigurationIngressConfiguration=None):
        """ServiceNetworkConfiguration - a model defined in OpenAPI

        :param egress_configuration: The egress_configuration of this ServiceNetworkConfiguration.
        :param ingress_configuration: The ingress_configuration of this ServiceNetworkConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ServiceNetworkConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Service_NetworkConfiguration of this ServiceNetworkConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def egress_configuration(self):
        """Gets the egress_configuration of this ServiceNetworkConfiguration.


        :return: The egress_configuration of this ServiceNetworkConfiguration.
    ...
    def egress_configuration(self, egress_configuration):
        """Sets the egress_configuration of this ServiceNetworkConfiguration.
    ...
    def ingress_configuration(self):
        """Gets the ingress_configuration of this ServiceNetworkConfiguration.


        :return: The ingress_configuration of this ServiceNetworkConfiguration.
    ...
    def ingress_configuration(self, ingress_configuration):
        """Sets the ingress_configuration of this ServiceNetworkConfiguration.
