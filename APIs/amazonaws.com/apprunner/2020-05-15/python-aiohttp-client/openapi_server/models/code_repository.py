...
class CodeRepository(Model):
    ...
    def __init__(self, repository_url: str=None, source_code_version: CodeRepositorySourceCodeVersion=None, code_configuration: CodeRepositoryCodeConfiguration=None):
        ...
        :param source_code_version: The source_code_version of this CodeRepository.
        :param code_configuration: The code_configuration of this CodeRepository.
        """
        self.openapi_types = {
            'repository_url': str,
    ...
    def source_code_version(self):
        """Gets the source_code_version of this CodeRepository.


        :return: The source_code_version of this CodeRepository.
    ...
    def source_code_version(self, source_code_version):
        """Sets the source_code_version of this CodeRepository.
    ...
    def code_configuration(self):
        """Gets the code_configuration of this CodeRepository.


        :return: The code_configuration of this CodeRepository.
    ...
    def code_configuration(self, code_configuration):
        """Sets the code_configuration of this CodeRepository.
