...
export default class ConfigurationSource {
    ...
    /**
    * Returns a <code>ConfigurationSource</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ConfigurationSource} The enum <code>ConfigurationSource</code> value.
    */
