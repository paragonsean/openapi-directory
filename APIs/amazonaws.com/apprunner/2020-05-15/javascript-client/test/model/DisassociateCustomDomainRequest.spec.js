...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.DisassociateCustomDomainRequest();
  });
  ...
  describe('DisassociateCustomDomainRequest', function() {
    it('should create an instance of DisassociateCustomDomainRequest', function() {
      // uncomment below and update the code to test DisassociateCustomDomainRequest
      //var instance = new AwsAppRunner.DisassociateCustomDomainRequest();
      //expect(instance).to.be.a(AwsAppRunner.DisassociateCustomDomainRequest);
    });
