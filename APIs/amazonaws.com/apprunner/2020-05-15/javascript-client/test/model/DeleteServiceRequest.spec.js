...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.DeleteServiceRequest();
  });
  ...
  describe('DeleteServiceRequest', function() {
    it('should create an instance of DeleteServiceRequest', function() {
      // uncomment below and update the code to test DeleteServiceRequest
      //var instance = new AwsAppRunner.DeleteServiceRequest();
      //expect(instance).to.be.a(AwsAppRunner.DeleteServiceRequest);
    });
