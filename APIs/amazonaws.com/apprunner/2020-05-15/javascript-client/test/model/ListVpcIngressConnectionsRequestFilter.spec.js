...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListVpcIngressConnectionsRequestFilter();
  });
  ...
  describe('ListVpcIngressConnectionsRequestFilter', function() {
    it('should create an instance of ListVpcIngressConnectionsRequestFilter', function() {
      // uncomment below and update the code to test ListVpcIngressConnectionsRequestFilter
      //var instance = new AwsAppRunner.ListVpcIngressConnectionsRequestFilter();
      //expect(instance).to.be.a(AwsAppRunner.ListVpcIngressConnectionsRequestFilter);
    });
