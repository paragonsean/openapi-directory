...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListServicesRequest();
  });
  ...
  describe('ListServicesRequest', function() {
    it('should create an instance of ListServicesRequest', function() {
      ...
      //var instance = new AwsAppRunner.ListServicesRequest();
      //expect(instance).to.be.a(AwsAppRunner.ListServicesRequest);
    });
