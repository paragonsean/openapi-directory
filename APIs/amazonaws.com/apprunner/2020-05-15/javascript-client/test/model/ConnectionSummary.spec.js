...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ConnectionSummary();
  });
  ...
  describe('ConnectionSummary', function() {
    it('should create an instance of ConnectionSummary', function() {
      // uncomment below and update the code to test ConnectionSummary
      //var instance = new AwsAppRunner.ConnectionSummary();
      //expect(instance).to.be.a(AwsAppRunner.ConnectionSummary);
    });
