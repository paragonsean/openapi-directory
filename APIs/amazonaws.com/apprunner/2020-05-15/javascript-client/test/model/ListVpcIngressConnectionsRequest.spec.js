...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListVpcIngressConnectionsRequest();
  });
  ...
  describe('ListVpcIngressConnectionsRequest', function() {
    it('should create an instance of ListVpcIngressConnectionsRequest', function() {
      // uncomment below and update the code to test ListVpcIngressConnectionsRequest
      //var instance = new AwsAppRunner.ListVpcIngressConnectionsRequest();
      //expect(instance).to.be.a(AwsAppRunner.ListVpcIngressConnectionsRequest);
    });
