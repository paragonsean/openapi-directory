...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ResumeServiceRequest();
  });
  ...
  describe('ResumeServiceRequest', function() {
    it('should create an instance of ResumeServiceRequest', function() {
      // uncomment below and update the code to test ResumeServiceRequest
      //var instance = new AwsAppRunner.ResumeServiceRequest();
      //expect(instance).to.be.a(AwsAppRunner.ResumeServiceRequest);
    });
