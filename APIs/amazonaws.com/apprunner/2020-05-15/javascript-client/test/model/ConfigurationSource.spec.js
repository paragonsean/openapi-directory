...
(function(root, factory) {
  ...
  describe('ConfigurationSource', function() {
    it('should create an instance of ConfigurationSource', function() {
      // uncomment below and update the code to test ConfigurationSource
      //var instance = new AwsAppRunner.ConfigurationSource();
      //expect(instance).to.be.a(AwsAppRunner.ConfigurationSource);
    });
