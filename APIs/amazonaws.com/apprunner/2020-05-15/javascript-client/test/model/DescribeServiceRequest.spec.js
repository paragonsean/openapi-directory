...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.DescribeServiceRequest();
  });
  ...
  describe('DescribeServiceRequest', function() {
    it('should create an instance of DescribeServiceRequest', function() {
      // uncomment below and update the code to test DescribeServiceRequest
      //var instance = new AwsAppRunner.DescribeServiceRequest();
      //expect(instance).to.be.a(AwsAppRunner.DescribeServiceRequest);
    });
