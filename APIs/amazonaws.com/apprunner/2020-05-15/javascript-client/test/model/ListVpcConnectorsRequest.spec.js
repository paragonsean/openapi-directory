...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListVpcConnectorsRequest();
  });
  ...
  describe('ListVpcConnectorsRequest', function() {
    it('should create an instance of ListVpcConnectorsRequest', function() {
      // uncomment below and update the code to test ListVpcConnectorsRequest
      //var instance = new AwsAppRunner.ListVpcConnectorsRequest();
      //expect(instance).to.be.a(AwsAppRunner.ListVpcConnectorsRequest);
    });
