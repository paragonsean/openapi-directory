...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListVpcIngressConnectionsFilter();
  });
  ...
  describe('ListVpcIngressConnectionsFilter', function() {
    it('should create an instance of ListVpcIngressConnectionsFilter', function() {
      // uncomment below and update the code to test ListVpcIngressConnectionsFilter
      //var instance = new AwsAppRunner.ListVpcIngressConnectionsFilter();
      //expect(instance).to.be.a(AwsAppRunner.ListVpcIngressConnectionsFilter);
    });
