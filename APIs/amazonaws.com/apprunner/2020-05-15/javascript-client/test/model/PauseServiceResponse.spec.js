...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.PauseServiceResponse();
  });
  ...
  describe('PauseServiceResponse', function() {
    it('should create an instance of PauseServiceResponse', function() {
      // uncomment below and update the code to test PauseServiceResponse
      //var instance = new AwsAppRunner.PauseServiceResponse();
      //expect(instance).to.be.a(AwsAppRunner.PauseServiceResponse);
    });
