...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.TraceConfiguration();
  });
  ...
  describe('TraceConfiguration', function() {
    it('should create an instance of TraceConfiguration', function() {
      // uncomment below and update the code to test TraceConfiguration
      //var instance = new AwsAppRunner.TraceConfiguration();
      //expect(instance).to.be.a(AwsAppRunner.TraceConfiguration);
    });
