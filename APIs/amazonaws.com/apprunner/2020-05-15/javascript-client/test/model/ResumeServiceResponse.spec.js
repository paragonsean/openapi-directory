...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ResumeServiceResponse();
  });
  ...
  describe('ResumeServiceResponse', function() {
    it('should create an instance of ResumeServiceResponse', function() {
      // uncomment below and update the code to test ResumeServiceResponse
      //var instance = new AwsAppRunner.ResumeServiceResponse();
      //expect(instance).to.be.a(AwsAppRunner.ResumeServiceResponse);
    });
