...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.ListOperationsRequest();
  });
  ...
  describe('ListOperationsRequest', function() {
    it('should create an instance of ListOperationsRequest', function() {
      ...
      //var instance = new AwsAppRunner.ListOperationsRequest();
      //expect(instance).to.be.a(AwsAppRunner.ListOperationsRequest);
    });
