...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.IngressVpcConfiguration();
  });
  ...
  describe('IngressVpcConfiguration', function() {
    it('should create an instance of IngressVpcConfiguration', function() {
      // uncomment below and update the code to test IngressVpcConfiguration
      //var instance = new AwsAppRunner.IngressVpcConfiguration();
      //expect(instance).to.be.a(AwsAppRunner.IngressVpcConfiguration);
    });
