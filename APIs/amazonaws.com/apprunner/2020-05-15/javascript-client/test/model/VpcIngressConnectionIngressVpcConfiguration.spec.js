...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.VpcIngressConnectionIngressVpcConfiguration();
  });
  ...
  describe('VpcIngressConnectionIngressVpcConfiguration', function() {
    it('should create an instance of VpcIngressConnectionIngressVpcConfiguration', function() {
      // uncomment below and update the code to test VpcIngressConnectionIngressVpcConfiguration
      //var instance = new AwsAppRunner.VpcIngressConnectionIngressVpcConfiguration();
      //expect(instance).to.be.a(AwsAppRunner.VpcIngressConnectionIngressVpcConfiguration);
    });
