...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.CreateServiceResponse();
  });
  ...
  describe('CreateServiceResponse', function() {
    it('should create an instance of CreateServiceResponse', function() {
      ...
      //var instance = new AwsAppRunner.CreateServiceResponse();
      //expect(instance).to.be.a(AwsAppRunner.CreateServiceResponse);
    });
