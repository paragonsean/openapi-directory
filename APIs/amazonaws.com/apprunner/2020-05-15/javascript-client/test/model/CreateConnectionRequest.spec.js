...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.CreateConnectionRequest();
  });
  ...
  describe('CreateConnectionRequest', function() {
    it('should create an instance of CreateConnectionRequest', function() {
      ...
      //var instance = new AwsAppRunner.CreateConnectionRequest();
      //expect(instance).to.be.a(AwsAppRunner.CreateConnectionRequest);
    });
