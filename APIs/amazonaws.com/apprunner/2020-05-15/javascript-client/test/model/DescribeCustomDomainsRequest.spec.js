...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.DescribeCustomDomainsRequest();
  });
  ...
  describe('DescribeCustomDomainsRequest', function() {
    it('should create an instance of DescribeCustomDomainsRequest', function() {
      // uncomment below and update the code to test DescribeCustomDomainsRequest
      //var instance = new AwsAppRunner.DescribeCustomDomainsRequest();
      //expect(instance).to.be.a(AwsAppRunner.DescribeCustomDomainsRequest);
    });
