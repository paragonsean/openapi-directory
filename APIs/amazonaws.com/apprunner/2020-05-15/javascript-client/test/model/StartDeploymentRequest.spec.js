...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.StartDeploymentRequest();
  });
  ...
  describe('StartDeploymentRequest', function() {
    it('should create an instance of StartDeploymentRequest', function() {
      // uncomment below and update the code to test StartDeploymentRequest
      //var instance = new AwsAppRunner.StartDeploymentRequest();
      //expect(instance).to.be.a(AwsAppRunner.StartDeploymentRequest);
    });
