...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.StartDeploymentResponse();
  });
  ...
  describe('StartDeploymentResponse', function() {
    it('should create an instance of StartDeploymentResponse', function() {
      // uncomment below and update the code to test StartDeploymentResponse
      //var instance = new AwsAppRunner.StartDeploymentResponse();
      //expect(instance).to.be.a(AwsAppRunner.StartDeploymentResponse);
    });
