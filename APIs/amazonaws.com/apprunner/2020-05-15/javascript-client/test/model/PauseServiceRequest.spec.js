...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.PauseServiceRequest();
  });
  ...
  describe('PauseServiceRequest', function() {
    it('should create an instance of PauseServiceRequest', function() {
      // uncomment below and update the code to test PauseServiceRequest
      //var instance = new AwsAppRunner.PauseServiceRequest();
      //expect(instance).to.be.a(AwsAppRunner.PauseServiceRequest);
    });
