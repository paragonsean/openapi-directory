...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAppRunner.VpcDNSTarget();
  });
  ...
  describe('VpcDNSTarget', function() {
    it('should create an instance of VpcDNSTarget', function() {
      // uncomment below and update the code to test VpcDNSTarget
      //var instance = new AwsAppRunner.VpcDNSTarget();
      //expect(instance).to.be.a(AwsAppRunner.VpcDNSTarget);
    });
