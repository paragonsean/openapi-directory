...
/*
 * OAICreateServiceRequest_HealthCheckConfiguration.h
 *
 * 
 */

#ifndef OAICreateServiceRequest_HealthCheckConfiguration_H
#define OAICreateServiceRequest_HealthCheckConfiguration_H
...
class OAICreateServiceRequest_HealthCheckConfiguration : public OAIObject {
public:
    OAICreateServiceRequest_HealthCheckConfiguration();
    OAICreateServiceRequest_HealthCheckConfiguration(QString json);
    ~OAICreateServiceRequest_HealthCheckConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceRequest_HealthCheckConfiguration)

#endif // OAICreateServiceRequest_HealthCheckConfiguration_H
