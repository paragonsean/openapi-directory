...
/*
 * OAIUpdateServiceRequest_InstanceConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateServiceRequest_InstanceConfiguration_H
#define OAIUpdateServiceRequest_InstanceConfiguration_H
...
class OAIUpdateServiceRequest_InstanceConfiguration : public OAIObject {
public:
    OAIUpdateServiceRequest_InstanceConfiguration();
    OAIUpdateServiceRequest_InstanceConfiguration(QString json);
    ~OAIUpdateServiceRequest_InstanceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateServiceRequest_InstanceConfiguration)

#endif // OAIUpdateServiceRequest_InstanceConfiguration_H
