...
OAIService_SourceConfiguration::OAIService_SourceConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIService_SourceConfiguration::OAIService_SourceConfiguration() {
    this->initializeModel();
}

OAIService_SourceConfiguration::~OAIService_SourceConfiguration() {}

void OAIService_SourceConfiguration::initializeModel() {
...
void OAIService_SourceConfiguration::fromJson(QString jsonString) {
...
void OAIService_SourceConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIService_SourceConfiguration::asJson() const {
...
QJsonObject OAIService_SourceConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAISourceConfiguration_CodeRepository OAIService_SourceConfiguration::getCodeRepository() const {
    return m_code_repository;
}
void OAIService_SourceConfiguration::setCodeRepository(const OAISourceConfiguration_CodeRepository &code_repository) {
    m_code_repository = code_repository;
    m_code_repository_isSet = true;
}

bool OAIService_SourceConfiguration::is_code_repository_Set() const{
    return m_code_repository_isSet;
}

bool OAIService_SourceConfiguration::is_code_repository_Valid() const{
    return m_code_repository_isValid;
}

OAISourceConfiguration_ImageRepository OAIService_SourceConfiguration::getImageRepository() const {
    return m_image_repository;
}
void OAIService_SourceConfiguration::setImageRepository(const OAISourceConfiguration_ImageRepository &image_repository) {
    m_image_repository = image_repository;
    m_image_repository_isSet = true;
}

bool OAIService_SourceConfiguration::is_image_repository_Set() const{
    return m_image_repository_isSet;
}

bool OAIService_SourceConfiguration::is_image_repository_Valid() const{
    return m_image_repository_isValid;
}

bool OAIService_SourceConfiguration::getAutoDeploymentsEnabled() const {
    return m_auto_deployments_enabled;
}
void OAIService_SourceConfiguration::setAutoDeploymentsEnabled(const bool &auto_deployments_enabled) {
    m_auto_deployments_enabled = auto_deployments_enabled;
    m_auto_deployments_enabled_isSet = true;
}

bool OAIService_SourceConfiguration::is_auto_deployments_enabled_Set() const{
    return m_auto_deployments_enabled_isSet;
}

bool OAIService_SourceConfiguration::is_auto_deployments_enabled_Valid() const{
    return m_auto_deployments_enabled_isValid;
}

OAISourceConfiguration_AuthenticationConfiguration OAIService_SourceConfiguration::getAuthenticationConfiguration() const {
    return m_authentication_configuration;
}
void OAIService_SourceConfiguration::setAuthenticationConfiguration(const OAISourceConfiguration_AuthenticationConfiguration &authentication_configuration) {
    m_authentication_configuration = authentication_configuration;
    m_authentication_configuration_isSet = true;
}

bool OAIService_SourceConfiguration::is_authentication_configuration_Set() const{
    return m_authentication_configuration_isSet;
}

bool OAIService_SourceConfiguration::is_authentication_configuration_Valid() const{
    return m_authentication_configuration_isValid;
}

bool OAIService_SourceConfiguration::isSet() const {
...
bool OAIService_SourceConfiguration::isValid() const {
