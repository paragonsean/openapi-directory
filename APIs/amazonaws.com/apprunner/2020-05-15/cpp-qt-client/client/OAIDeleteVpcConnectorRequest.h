...
/*
 * OAIDeleteVpcConnectorRequest.h
 *
 * 
 */

#ifndef OAIDeleteVpcConnectorRequest_H
#define OAIDeleteVpcConnectorRequest_H
...
class OAIDeleteVpcConnectorRequest : public OAIObject {
public:
    OAIDeleteVpcConnectorRequest();
    OAIDeleteVpcConnectorRequest(QString json);
    ~OAIDeleteVpcConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteVpcConnectorRequest)

#endif // OAIDeleteVpcConnectorRequest_H
