...
/*
 * OAIDescribeVpcConnectorResponse_VpcConnector.h
 *
 * 
 */

#ifndef OAIDescribeVpcConnectorResponse_VpcConnector_H
#define OAIDescribeVpcConnectorResponse_VpcConnector_H
...
class OAIDescribeVpcConnectorResponse_VpcConnector : public OAIObject {
public:
    OAIDescribeVpcConnectorResponse_VpcConnector();
    OAIDescribeVpcConnectorResponse_VpcConnector(QString json);
    ~OAIDescribeVpcConnectorResponse_VpcConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVpcConnectorResponse_VpcConnector)

#endif // OAIDescribeVpcConnectorResponse_VpcConnector_H
