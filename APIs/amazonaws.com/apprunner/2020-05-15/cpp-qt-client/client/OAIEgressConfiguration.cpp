...
#include "OAIEgressConfiguration.h"
...
OAIEgressConfiguration::OAIEgressConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEgressConfiguration::OAIEgressConfiguration() {
    this->initializeModel();
}

OAIEgressConfiguration::~OAIEgressConfiguration() {}

void OAIEgressConfiguration::initializeModel() {
...
void OAIEgressConfiguration::fromJson(QString jsonString) {
...
void OAIEgressConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIEgressConfiguration::asJson() const {
...
QJsonObject OAIEgressConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIEgressType OAIEgressConfiguration::getEgressType() const {
    return m_egress_type;
}
void OAIEgressConfiguration::setEgressType(const OAIEgressType &egress_type) {
    m_egress_type = egress_type;
    m_egress_type_isSet = true;
}

bool OAIEgressConfiguration::is_egress_type_Set() const{
    return m_egress_type_isSet;
}

bool OAIEgressConfiguration::is_egress_type_Valid() const{
    return m_egress_type_isValid;
}

QString OAIEgressConfiguration::getVpcConnectorArn() const {
    return m_vpc_connector_arn;
}
void OAIEgressConfiguration::setVpcConnectorArn(const QString &vpc_connector_arn) {
    m_vpc_connector_arn = vpc_connector_arn;
    m_vpc_connector_arn_isSet = true;
}

bool OAIEgressConfiguration::is_vpc_connector_arn_Set() const{
    return m_vpc_connector_arn_isSet;
}

bool OAIEgressConfiguration::is_vpc_connector_arn_Valid() const{
    return m_vpc_connector_arn_isValid;
}

bool OAIEgressConfiguration::isSet() const {
...
bool OAIEgressConfiguration::isValid() const {
