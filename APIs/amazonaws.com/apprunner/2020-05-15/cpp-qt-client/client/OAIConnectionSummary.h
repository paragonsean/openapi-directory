...
/*
 * OAIConnectionSummary.h
 *
 * Provides summary information about an App Runner connection resource.
 */

#ifndef OAIConnectionSummary_H
#define OAIConnectionSummary_H
...
class OAIConnectionSummary : public OAIObject {
public:
    OAIConnectionSummary();
    OAIConnectionSummary(QString json);
    ~OAIConnectionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionSummary)

#endif // OAIConnectionSummary_H
