...
/*
 * OAIListVpcIngressConnectionsRequest_Filter.h
 *
 * 
 */

#ifndef OAIListVpcIngressConnectionsRequest_Filter_H
#define OAIListVpcIngressConnectionsRequest_Filter_H
...
class OAIListVpcIngressConnectionsRequest_Filter : public OAIObject {
public:
    OAIListVpcIngressConnectionsRequest_Filter();
    OAIListVpcIngressConnectionsRequest_Filter(QString json);
    ~OAIListVpcIngressConnectionsRequest_Filter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVpcIngressConnectionsRequest_Filter)

#endif // OAIListVpcIngressConnectionsRequest_Filter_H
