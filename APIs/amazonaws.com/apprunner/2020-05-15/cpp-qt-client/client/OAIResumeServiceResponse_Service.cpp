...
#include "OAIResumeServiceResponse_Service.h"
...
OAIResumeServiceResponse_Service::OAIResumeServiceResponse_Service(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResumeServiceResponse_Service::OAIResumeServiceResponse_Service() {
    this->initializeModel();
}

OAIResumeServiceResponse_Service::~OAIResumeServiceResponse_Service() {}

void OAIResumeServiceResponse_Service::initializeModel() {
...
void OAIResumeServiceResponse_Service::fromJson(QString jsonString) {
...
void OAIResumeServiceResponse_Service::fromJsonObject(QJsonObject json) {
...
QString OAIResumeServiceResponse_Service::asJson() const {
...
QJsonObject OAIResumeServiceResponse_Service::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResumeServiceResponse_Service::getServiceName() const {
    return m_service_name;
}
void OAIResumeServiceResponse_Service::setServiceName(const QString &service_name) {
    m_service_name = service_name;
    m_service_name_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_service_name_Set() const{
    return m_service_name_isSet;
}

bool OAIResumeServiceResponse_Service::is_service_name_Valid() const{
    return m_service_name_isValid;
}

QString OAIResumeServiceResponse_Service::getServiceId() const {
    return m_service_id;
}
void OAIResumeServiceResponse_Service::setServiceId(const QString &service_id) {
    m_service_id = service_id;
    m_service_id_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_service_id_Set() const{
    return m_service_id_isSet;
}

bool OAIResumeServiceResponse_Service::is_service_id_Valid() const{
    return m_service_id_isValid;
}

QString OAIResumeServiceResponse_Service::getServiceArn() const {
    return m_service_arn;
}
void OAIResumeServiceResponse_Service::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIResumeServiceResponse_Service::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

QString OAIResumeServiceResponse_Service::getServiceUrl() const {
    return m_service_url;
}
void OAIResumeServiceResponse_Service::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIResumeServiceResponse_Service::is_service_url_Valid() const{
    return m_service_url_isValid;
}

QDateTime OAIResumeServiceResponse_Service::getCreatedAt() const {
    return m_created_at;
}
void OAIResumeServiceResponse_Service::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIResumeServiceResponse_Service::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIResumeServiceResponse_Service::getUpdatedAt() const {
    return m_updated_at;
}
void OAIResumeServiceResponse_Service::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIResumeServiceResponse_Service::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QDateTime OAIResumeServiceResponse_Service::getDeletedAt() const {
    return m_deleted_at;
}
void OAIResumeServiceResponse_Service::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIResumeServiceResponse_Service::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

OAIServiceStatus OAIResumeServiceResponse_Service::getStatus() const {
    return m_status;
}
void OAIResumeServiceResponse_Service::setStatus(const OAIServiceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_status_Set() const{
    return m_status_isSet;
}

bool OAIResumeServiceResponse_Service::is_status_Valid() const{
    return m_status_isValid;
}

OAIService_SourceConfiguration OAIResumeServiceResponse_Service::getSourceConfiguration() const {
    return m_source_configuration;
}
void OAIResumeServiceResponse_Service::setSourceConfiguration(const OAIService_SourceConfiguration &source_configuration) {
    m_source_configuration = source_configuration;
    m_source_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_source_configuration_Set() const{
    return m_source_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_source_configuration_Valid() const{
    return m_source_configuration_isValid;
}

OAIService_InstanceConfiguration OAIResumeServiceResponse_Service::getInstanceConfiguration() const {
    return m_instance_configuration;
}
void OAIResumeServiceResponse_Service::setInstanceConfiguration(const OAIService_InstanceConfiguration &instance_configuration) {
    m_instance_configuration = instance_configuration;
    m_instance_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_instance_configuration_Set() const{
    return m_instance_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_instance_configuration_Valid() const{
    return m_instance_configuration_isValid;
}

OAIService_EncryptionConfiguration OAIResumeServiceResponse_Service::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIResumeServiceResponse_Service::setEncryptionConfiguration(const OAIService_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIService_HealthCheckConfiguration OAIResumeServiceResponse_Service::getHealthCheckConfiguration() const {
    return m_health_check_configuration;
}
void OAIResumeServiceResponse_Service::setHealthCheckConfiguration(const OAIService_HealthCheckConfiguration &health_check_configuration) {
    m_health_check_configuration = health_check_configuration;
    m_health_check_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_health_check_configuration_Set() const{
    return m_health_check_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_health_check_configuration_Valid() const{
    return m_health_check_configuration_isValid;
}

OAIService_AutoScalingConfigurationSummary OAIResumeServiceResponse_Service::getAutoScalingConfigurationSummary() const {
    return m_auto_scaling_configuration_summary;
}
void OAIResumeServiceResponse_Service::setAutoScalingConfigurationSummary(const OAIService_AutoScalingConfigurationSummary &auto_scaling_configuration_summary) {
    m_auto_scaling_configuration_summary = auto_scaling_configuration_summary;
    m_auto_scaling_configuration_summary_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_auto_scaling_configuration_summary_Set() const{
    return m_auto_scaling_configuration_summary_isSet;
}

bool OAIResumeServiceResponse_Service::is_auto_scaling_configuration_summary_Valid() const{
    return m_auto_scaling_configuration_summary_isValid;
}

OAIService_NetworkConfiguration OAIResumeServiceResponse_Service::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIResumeServiceResponse_Service::setNetworkConfiguration(const OAIService_NetworkConfiguration &network_configuration) {
    m_network_configuration = network_configuration;
    m_network_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_network_configuration_Set() const{
    return m_network_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_network_configuration_Valid() const{
    return m_network_configuration_isValid;
}

OAIService_ObservabilityConfiguration OAIResumeServiceResponse_Service::getObservabilityConfiguration() const {
    return m_observability_configuration;
}
void OAIResumeServiceResponse_Service::setObservabilityConfiguration(const OAIService_ObservabilityConfiguration &observability_configuration) {
    m_observability_configuration = observability_configuration;
    m_observability_configuration_isSet = true;
}

bool OAIResumeServiceResponse_Service::is_observability_configuration_Set() const{
    return m_observability_configuration_isSet;
}

bool OAIResumeServiceResponse_Service::is_observability_configuration_Valid() const{
    return m_observability_configuration_isValid;
}

bool OAIResumeServiceResponse_Service::isSet() const {
...
bool OAIResumeServiceResponse_Service::isValid() const {
