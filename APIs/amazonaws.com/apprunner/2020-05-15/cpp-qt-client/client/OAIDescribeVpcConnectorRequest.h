...
/*
 * OAIDescribeVpcConnectorRequest.h
 *
 * 
 */

#ifndef OAIDescribeVpcConnectorRequest_H
#define OAIDescribeVpcConnectorRequest_H
...
class OAIDescribeVpcConnectorRequest : public OAIObject {
public:
    OAIDescribeVpcConnectorRequest();
    OAIDescribeVpcConnectorRequest(QString json);
    ~OAIDescribeVpcConnectorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeVpcConnectorRequest)

#endif // OAIDescribeVpcConnectorRequest_H
