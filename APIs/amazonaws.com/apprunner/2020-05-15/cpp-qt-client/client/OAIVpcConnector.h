...
#ifndef OAIVpcConnector_H
#define OAIVpcConnector_H
...
class OAIVpcConnector : public OAIObject {
public:
    OAIVpcConnector();
    OAIVpcConnector(QString json);
    ~OAIVpcConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcConnector)

#endif // OAIVpcConnector_H
