...
/*
 * OAIStartDeploymentResponse.h
 *
 * 
 */

#ifndef OAIStartDeploymentResponse_H
#define OAIStartDeploymentResponse_H
...
class OAIStartDeploymentResponse : public OAIObject {
public:
    OAIStartDeploymentResponse();
    OAIStartDeploymentResponse(QString json);
    ~OAIStartDeploymentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartDeploymentResponse)

#endif // OAIStartDeploymentResponse_H
