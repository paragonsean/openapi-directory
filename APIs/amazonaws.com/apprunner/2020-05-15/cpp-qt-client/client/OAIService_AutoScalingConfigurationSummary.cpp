...
OAIService_AutoScalingConfigurationSummary::OAIService_AutoScalingConfigurationSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIService_AutoScalingConfigurationSummary::OAIService_AutoScalingConfigurationSummary() {
    this->initializeModel();
}

OAIService_AutoScalingConfigurationSummary::~OAIService_AutoScalingConfigurationSummary() {}

void OAIService_AutoScalingConfigurationSummary::initializeModel() {
...
void OAIService_AutoScalingConfigurationSummary::fromJson(QString jsonString) {
...
void OAIService_AutoScalingConfigurationSummary::fromJsonObject(QJsonObject json) {
...
QString OAIService_AutoScalingConfigurationSummary::asJson() const {
...
QJsonObject OAIService_AutoScalingConfigurationSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIService_AutoScalingConfigurationSummary::getAutoScalingConfigurationArn() const {
    return m_auto_scaling_configuration_arn;
}
void OAIService_AutoScalingConfigurationSummary::setAutoScalingConfigurationArn(const QString &auto_scaling_configuration_arn) {
    m_auto_scaling_configuration_arn = auto_scaling_configuration_arn;
    m_auto_scaling_configuration_arn_isSet = true;
}

bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_arn_Set() const{
    return m_auto_scaling_configuration_arn_isSet;
}

bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_arn_Valid() const{
    return m_auto_scaling_configuration_arn_isValid;
}

QString OAIService_AutoScalingConfigurationSummary::getAutoScalingConfigurationName() const {
    return m_auto_scaling_configuration_name;
}
void OAIService_AutoScalingConfigurationSummary::setAutoScalingConfigurationName(const QString &auto_scaling_configuration_name) {
    m_auto_scaling_configuration_name = auto_scaling_configuration_name;
    m_auto_scaling_configuration_name_isSet = true;
}

bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_name_Set() const{
    return m_auto_scaling_configuration_name_isSet;
}

bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_name_Valid() const{
    return m_auto_scaling_configuration_name_isValid;
}

qint32 OAIService_AutoScalingConfigurationSummary::getAutoScalingConfigurationRevision() const {
    return m_auto_scaling_configuration_revision;
}
void OAIService_AutoScalingConfigurationSummary::setAutoScalingConfigurationRevision(const qint32 &auto_scaling_configuration_revision) {
...
bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_revision_Set() const{
    return m_auto_scaling_configuration_revision_isSet;
}

bool OAIService_AutoScalingConfigurationSummary::is_auto_scaling_configuration_revision_Valid() const{
    return m_auto_scaling_configuration_revision_isValid;
}

bool OAIService_AutoScalingConfigurationSummary::isSet() const {
...
bool OAIService_AutoScalingConfigurationSummary::isValid() const {
