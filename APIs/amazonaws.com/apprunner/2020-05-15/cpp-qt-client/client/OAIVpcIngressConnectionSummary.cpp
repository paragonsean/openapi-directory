...
#include "OAIVpcIngressConnectionSummary.h"
...
OAIVpcIngressConnectionSummary::OAIVpcIngressConnectionSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcIngressConnectionSummary::OAIVpcIngressConnectionSummary() {
    this->initializeModel();
}

OAIVpcIngressConnectionSummary::~OAIVpcIngressConnectionSummary() {}

void OAIVpcIngressConnectionSummary::initializeModel() {
...
void OAIVpcIngressConnectionSummary::fromJson(QString jsonString) {
...
void OAIVpcIngressConnectionSummary::fromJsonObject(QJsonObject json) {
...
QString OAIVpcIngressConnectionSummary::asJson() const {
...
QJsonObject OAIVpcIngressConnectionSummary::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVpcIngressConnectionSummary::getVpcIngressConnectionArn() const {
    return m_vpc_ingress_connection_arn;
}
void OAIVpcIngressConnectionSummary::setVpcIngressConnectionArn(const QString &vpc_ingress_connection_arn) {
    m_vpc_ingress_connection_arn = vpc_ingress_connection_arn;
    m_vpc_ingress_connection_arn_isSet = true;
}

bool OAIVpcIngressConnectionSummary::is_vpc_ingress_connection_arn_Set() const{
    return m_vpc_ingress_connection_arn_isSet;
}

bool OAIVpcIngressConnectionSummary::is_vpc_ingress_connection_arn_Valid() const{
    return m_vpc_ingress_connection_arn_isValid;
}

QString OAIVpcIngressConnectionSummary::getServiceArn() const {
    return m_service_arn;
}
void OAIVpcIngressConnectionSummary::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIVpcIngressConnectionSummary::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIVpcIngressConnectionSummary::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

bool OAIVpcIngressConnectionSummary::isSet() const {
...
bool OAIVpcIngressConnectionSummary::isValid() const {
