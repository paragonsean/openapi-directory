...
/*
 * OAIInstanceConfiguration.h
 *
 * Describes the runtime configuration of an App Runner service instance (scaling unit).
 */

#ifndef OAIInstanceConfiguration_H
#define OAIInstanceConfiguration_H
...
class OAIInstanceConfiguration : public OAIObject {
public:
    OAIInstanceConfiguration();
    OAIInstanceConfiguration(QString json);
    ~OAIInstanceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceConfiguration)

#endif // OAIInstanceConfiguration_H
