...
/*
 * OAIImageRepository_ImageConfiguration.h
 *
 * 
 */

#ifndef OAIImageRepository_ImageConfiguration_H
#define OAIImageRepository_ImageConfiguration_H
...
class OAIImageRepository_ImageConfiguration : public OAIObject {
public:
    OAIImageRepository_ImageConfiguration();
    OAIImageRepository_ImageConfiguration(QString json);
    ~OAIImageRepository_ImageConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageRepository_ImageConfiguration)

#endif // OAIImageRepository_ImageConfiguration_H
