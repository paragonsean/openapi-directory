...
#ifndef OAIIngressVpcConfiguration_H
#define OAIIngressVpcConfiguration_H
...
class OAIIngressVpcConfiguration : public OAIObject {
public:
    OAIIngressVpcConfiguration();
    OAIIngressVpcConfiguration(QString json);
    ~OAIIngressVpcConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngressVpcConfiguration)

#endif // OAIIngressVpcConfiguration_H
