...
/*
 * OAIService_HealthCheckConfiguration.h
 *
 * 
 */

#ifndef OAIService_HealthCheckConfiguration_H
#define OAIService_HealthCheckConfiguration_H
...
class OAIService_HealthCheckConfiguration : public OAIObject {
public:
    OAIService_HealthCheckConfiguration();
    OAIService_HealthCheckConfiguration(QString json);
    ~OAIService_HealthCheckConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIService_HealthCheckConfiguration)

#endif // OAIService_HealthCheckConfiguration_H
