...
/*
 * OAICreateVpcConnectorResponse_VpcConnector.h
 *
 * 
 */

#ifndef OAICreateVpcConnectorResponse_VpcConnector_H
#define OAICreateVpcConnectorResponse_VpcConnector_H
...
class OAICreateVpcConnectorResponse_VpcConnector : public OAIObject {
public:
    OAICreateVpcConnectorResponse_VpcConnector();
    OAICreateVpcConnectorResponse_VpcConnector(QString json);
    ~OAICreateVpcConnectorResponse_VpcConnector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcConnectorResponse_VpcConnector)

#endif // OAICreateVpcConnectorResponse_VpcConnector_H
