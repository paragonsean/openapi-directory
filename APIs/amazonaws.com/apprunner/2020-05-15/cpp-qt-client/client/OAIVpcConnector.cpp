...
OAIVpcConnector::OAIVpcConnector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVpcConnector::OAIVpcConnector() {
    this->initializeModel();
}

OAIVpcConnector::~OAIVpcConnector() {}

void OAIVpcConnector::initializeModel() {
...
void OAIVpcConnector::fromJson(QString jsonString) {
...
void OAIVpcConnector::fromJsonObject(QJsonObject json) {
...
QString OAIVpcConnector::asJson() const {
...
QJsonObject OAIVpcConnector::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVpcConnector::getVpcConnectorName() const {
    return m_vpc_connector_name;
}
void OAIVpcConnector::setVpcConnectorName(const QString &vpc_connector_name) {
    m_vpc_connector_name = vpc_connector_name;
    m_vpc_connector_name_isSet = true;
}

bool OAIVpcConnector::is_vpc_connector_name_Set() const{
    return m_vpc_connector_name_isSet;
}

bool OAIVpcConnector::is_vpc_connector_name_Valid() const{
    return m_vpc_connector_name_isValid;
}

QString OAIVpcConnector::getVpcConnectorArn() const {
    return m_vpc_connector_arn;
}
void OAIVpcConnector::setVpcConnectorArn(const QString &vpc_connector_arn) {
    m_vpc_connector_arn = vpc_connector_arn;
    m_vpc_connector_arn_isSet = true;
}

bool OAIVpcConnector::is_vpc_connector_arn_Set() const{
    return m_vpc_connector_arn_isSet;
}

bool OAIVpcConnector::is_vpc_connector_arn_Valid() const{
    return m_vpc_connector_arn_isValid;
}

qint32 OAIVpcConnector::getVpcConnectorRevision() const {
    return m_vpc_connector_revision;
}
void OAIVpcConnector::setVpcConnectorRevision(const qint32 &vpc_connector_revision) {
    m_vpc_connector_revision = vpc_connector_revision;
    m_vpc_connector_revision_isSet = true;
}

bool OAIVpcConnector::is_vpc_connector_revision_Set() const{
    return m_vpc_connector_revision_isSet;
}

bool OAIVpcConnector::is_vpc_connector_revision_Valid() const{
    return m_vpc_connector_revision_isValid;
}

QList OAIVpcConnector::getSubnets() const {
    return m_subnets;
}
void OAIVpcConnector::setSubnets(const QList &subnets) {
    m_subnets = subnets;
    m_subnets_isSet = true;
}

bool OAIVpcConnector::is_subnets_Set() const{
    return m_subnets_isSet;
}

bool OAIVpcConnector::is_subnets_Valid() const{
    return m_subnets_isValid;
}

QList OAIVpcConnector::getSecurityGroups() const {
    return m_security_groups;
}
void OAIVpcConnector::setSecurityGroups(const QList &security_groups) {
    m_security_groups = security_groups;
    m_security_groups_isSet = true;
}

bool OAIVpcConnector::is_security_groups_Set() const{
    return m_security_groups_isSet;
}

bool OAIVpcConnector::is_security_groups_Valid() const{
    return m_security_groups_isValid;
}

OAIVpcConnectorStatus OAIVpcConnector::getStatus() const {
    return m_status;
}
void OAIVpcConnector::setStatus(const OAIVpcConnectorStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVpcConnector::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVpcConnector::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIVpcConnector::getCreatedAt() const {
    return m_created_at;
}
void OAIVpcConnector::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIVpcConnector::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIVpcConnector::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIVpcConnector::getDeletedAt() const {
    return m_deleted_at;
}
void OAIVpcConnector::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIVpcConnector::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIVpcConnector::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

bool OAIVpcConnector::isSet() const {
...
bool OAIVpcConnector::isValid() const {
