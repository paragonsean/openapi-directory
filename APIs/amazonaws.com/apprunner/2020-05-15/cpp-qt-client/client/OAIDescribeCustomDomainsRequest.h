...
/*
 * OAIDescribeCustomDomainsRequest.h
 *
 * 
 */

#ifndef OAIDescribeCustomDomainsRequest_H
#define OAIDescribeCustomDomainsRequest_H
...
class OAIDescribeCustomDomainsRequest : public OAIObject {
public:
    OAIDescribeCustomDomainsRequest();
    OAIDescribeCustomDomainsRequest(QString json);
    ~OAIDescribeCustomDomainsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomDomainsRequest)

#endif // OAIDescribeCustomDomainsRequest_H
