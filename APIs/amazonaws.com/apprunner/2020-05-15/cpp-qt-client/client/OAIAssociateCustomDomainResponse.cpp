...
OAIAssociateCustomDomainResponse::OAIAssociateCustomDomainResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateCustomDomainResponse::OAIAssociateCustomDomainResponse() {
    this->initializeModel();
}

OAIAssociateCustomDomainResponse::~OAIAssociateCustomDomainResponse() {}

void OAIAssociateCustomDomainResponse::initializeModel() {
...
void OAIAssociateCustomDomainResponse::fromJson(QString jsonString) {
...
void OAIAssociateCustomDomainResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateCustomDomainResponse::asJson() const {
...
QJsonObject OAIAssociateCustomDomainResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateCustomDomainResponse::getDnsTarget() const {
    return m_dns_target;
}
void OAIAssociateCustomDomainResponse::setDnsTarget(const QString &dns_target) {
    m_dns_target = dns_target;
    m_dns_target_isSet = true;
}

bool OAIAssociateCustomDomainResponse::is_dns_target_Set() const{
    return m_dns_target_isSet;
}

bool OAIAssociateCustomDomainResponse::is_dns_target_Valid() const{
    return m_dns_target_isValid;
}

QString OAIAssociateCustomDomainResponse::getServiceArn() const {
    return m_service_arn;
}
void OAIAssociateCustomDomainResponse::setServiceArn(const QString &service_arn) {
    m_service_arn = service_arn;
    m_service_arn_isSet = true;
}

bool OAIAssociateCustomDomainResponse::is_service_arn_Set() const{
    return m_service_arn_isSet;
}

bool OAIAssociateCustomDomainResponse::is_service_arn_Valid() const{
    return m_service_arn_isValid;
}

OAIAssociateCustomDomainResponse_CustomDomain OAIAssociateCustomDomainResponse::getCustomDomain() const {
    return m_custom_domain;
}
void OAIAssociateCustomDomainResponse::setCustomDomain(const OAIAssociateCustomDomainResponse_CustomDomain &custom_domain) {
    m_custom_domain = custom_domain;
    m_custom_domain_isSet = true;
}

bool OAIAssociateCustomDomainResponse::is_custom_domain_Set() const{
    return m_custom_domain_isSet;
}

bool OAIAssociateCustomDomainResponse::is_custom_domain_Valid() const{
    return m_custom_domain_isValid;
}

QList OAIAssociateCustomDomainResponse::getVpcDnsTargets() const {
    return m_vpc_dns_targets;
}
void OAIAssociateCustomDomainResponse::setVpcDnsTargets(const QList &vpc_dns_targets) {
    m_vpc_dns_targets = vpc_dns_targets;
    m_vpc_dns_targets_isSet = true;
}

bool OAIAssociateCustomDomainResponse::is_vpc_dns_targets_Set() const{
    return m_vpc_dns_targets_isSet;
}

bool OAIAssociateCustomDomainResponse::is_vpc_dns_targets_Valid() const{
    return m_vpc_dns_targets_isValid;
}

bool OAIAssociateCustomDomainResponse::isSet() const {
...
bool OAIAssociateCustomDomainResponse::isValid() const {
