...
/*
 * OAIService_NetworkConfiguration.h
 *
 * 
 */

#ifndef OAIService_NetworkConfiguration_H
#define OAIService_NetworkConfiguration_H
...
class OAIService_NetworkConfiguration : public OAIObject {
public:
    OAIService_NetworkConfiguration();
    OAIService_NetworkConfiguration(QString json);
    ~OAIService_NetworkConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIService_NetworkConfiguration)

#endif // OAIService_NetworkConfiguration_H
