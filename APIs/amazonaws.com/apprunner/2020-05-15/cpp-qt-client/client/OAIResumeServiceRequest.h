...
/*
 * OAIResumeServiceRequest.h
 *
 * 
 */

#ifndef OAIResumeServiceRequest_H
#define OAIResumeServiceRequest_H
...
class OAIResumeServiceRequest : public OAIObject {
public:
    OAIResumeServiceRequest();
    OAIResumeServiceRequest(QString json);
    ~OAIResumeServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeServiceRequest)

#endif // OAIResumeServiceRequest_H
