...
/*
 * OAIService_InstanceConfiguration.h
 *
 * 
 */

#ifndef OAIService_InstanceConfiguration_H
#define OAIService_InstanceConfiguration_H
...
class OAIService_InstanceConfiguration : public OAIObject {
public:
    OAIService_InstanceConfiguration();
    OAIService_InstanceConfiguration(QString json);
    ~OAIService_InstanceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIService_InstanceConfiguration)

#endif // OAIService_InstanceConfiguration_H
