...
/*
 * OAICreateServiceRequest_InstanceConfiguration.h
 *
 * 
 */

#ifndef OAICreateServiceRequest_InstanceConfiguration_H
#define OAICreateServiceRequest_InstanceConfiguration_H
...
class OAICreateServiceRequest_InstanceConfiguration : public OAIObject {
public:
    OAICreateServiceRequest_InstanceConfiguration();
    OAICreateServiceRequest_InstanceConfiguration(QString json);
    ~OAICreateServiceRequest_InstanceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceRequest_InstanceConfiguration)

#endif // OAICreateServiceRequest_InstanceConfiguration_H
