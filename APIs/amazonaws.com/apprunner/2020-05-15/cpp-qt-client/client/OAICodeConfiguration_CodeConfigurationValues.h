...
/*
 * OAICodeConfiguration_CodeConfigurationValues.h
 *
 * 
 */

#ifndef OAICodeConfiguration_CodeConfigurationValues_H
#define OAICodeConfiguration_CodeConfigurationValues_H
...
class OAICodeConfiguration_CodeConfigurationValues : public OAIObject {
public:
    OAICodeConfiguration_CodeConfigurationValues();
    OAICodeConfiguration_CodeConfigurationValues(QString json);
    ~OAICodeConfiguration_CodeConfigurationValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeConfiguration_CodeConfigurationValues)

#endif // OAICodeConfiguration_CodeConfigurationValues_H
