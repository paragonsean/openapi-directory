...
QString OAIUpdateServiceResponse_Service::getServiceId() const {
    return m_service_id;
}
void OAIUpdateServiceResponse_Service::setServiceId(const QString &service_id) {
    m_service_id = service_id;
    m_service_id_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_service_id_Set() const{
    return m_service_id_isSet;
}

bool OAIUpdateServiceResponse_Service::is_service_id_Valid() const{
...
QString OAIUpdateServiceResponse_Service::getServiceUrl() const {
    return m_service_url;
}
void OAIUpdateServiceResponse_Service::setServiceUrl(const QString &service_url) {
    m_service_url = service_url;
    m_service_url_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_service_url_Set() const{
    return m_service_url_isSet;
}

bool OAIUpdateServiceResponse_Service::is_service_url_Valid() const{
...
QDateTime OAIUpdateServiceResponse_Service::getUpdatedAt() const {
    return m_updated_at;
}
void OAIUpdateServiceResponse_Service::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIUpdateServiceResponse_Service::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QDateTime OAIUpdateServiceResponse_Service::getDeletedAt() const {
    return m_deleted_at;
}
void OAIUpdateServiceResponse_Service::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIUpdateServiceResponse_Service::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

OAIServiceStatus OAIUpdateServiceResponse_Service::getStatus() const {
    return m_status;
}
void OAIUpdateServiceResponse_Service::setStatus(const OAIServiceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
OAIService_SourceConfiguration OAIUpdateServiceResponse_Service::getSourceConfiguration() const {
    return m_source_configuration;
}
void OAIUpdateServiceResponse_Service::setSourceConfiguration(const OAIService_SourceConfiguration &source_configuration) {
    m_source_configuration = source_configuration;
    m_source_configuration_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_source_configuration_Set() const{
    return m_source_configuration_isSet;
}

bool OAIUpdateServiceResponse_Service::is_source_configuration_Valid() const{
    return m_source_configuration_isValid;
}

OAIService_InstanceConfiguration OAIUpdateServiceResponse_Service::getInstanceConfiguration() const {
    return m_instance_configuration;
}
void OAIUpdateServiceResponse_Service::setInstanceConfiguration(const OAIService_InstanceConfiguration &instance_configuration) {
    m_instance_configuration = instance_configuration;
    m_instance_configuration_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_instance_configuration_Set() const{
    return m_instance_configuration_isSet;
}

bool OAIUpdateServiceResponse_Service::is_instance_configuration_Valid() const{
    return m_instance_configuration_isValid;
}

OAIService_EncryptionConfiguration OAIUpdateServiceResponse_Service::getEncryptionConfiguration() const {
    return m_encryption_configuration;
}
void OAIUpdateServiceResponse_Service::setEncryptionConfiguration(const OAIService_EncryptionConfiguration &encryption_configuration) {
    m_encryption_configuration = encryption_configuration;
    m_encryption_configuration_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_encryption_configuration_Set() const{
    return m_encryption_configuration_isSet;
}

bool OAIUpdateServiceResponse_Service::is_encryption_configuration_Valid() const{
    return m_encryption_configuration_isValid;
}

OAIService_HealthCheckConfiguration OAIUpdateServiceResponse_Service::getHealthCheckConfiguration() const {
    return m_health_check_configuration;
}
void OAIUpdateServiceResponse_Service::setHealthCheckConfiguration(const OAIService_HealthCheckConfiguration &health_check_configuration) {
    m_health_check_configuration = health_check_configuration;
    m_health_check_configuration_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_health_check_configuration_Set() const{
    return m_health_check_configuration_isSet;
}

bool OAIUpdateServiceResponse_Service::is_health_check_configuration_Valid() const{
    return m_health_check_configuration_isValid;
}

OAIService_AutoScalingConfigurationSummary OAIUpdateServiceResponse_Service::getAutoScalingConfigurationSummary() const {
    return m_auto_scaling_configuration_summary;
}
void OAIUpdateServiceResponse_Service::setAutoScalingConfigurationSummary(const OAIService_AutoScalingConfigurationSummary &auto_scaling_configuration_summary) {
    m_auto_scaling_configuration_summary = auto_scaling_configuration_summary;
    m_auto_scaling_configuration_summary_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_auto_scaling_configuration_summary_Set() const{
    return m_auto_scaling_configuration_summary_isSet;
}

bool OAIUpdateServiceResponse_Service::is_auto_scaling_configuration_summary_Valid() const{
    return m_auto_scaling_configuration_summary_isValid;
}

OAIService_NetworkConfiguration OAIUpdateServiceResponse_Service::getNetworkConfiguration() const {
    return m_network_configuration;
}
void OAIUpdateServiceResponse_Service::setNetworkConfiguration(const OAIService_NetworkConfiguration &network_configuration) {
...
OAIService_ObservabilityConfiguration OAIUpdateServiceResponse_Service::getObservabilityConfiguration() const {
    return m_observability_configuration;
}
void OAIUpdateServiceResponse_Service::setObservabilityConfiguration(const OAIService_ObservabilityConfiguration &observability_configuration) {
    m_observability_configuration = observability_configuration;
    m_observability_configuration_isSet = true;
}

bool OAIUpdateServiceResponse_Service::is_observability_configuration_Set() const{
    return m_observability_configuration_isSet;
}

bool OAIUpdateServiceResponse_Service::is_observability_configuration_Valid() const{
