...
QString OAIDeleteServiceResponse::getOperationId() const {
    return m_operation_id;
}
void OAIDeleteServiceResponse::setOperationId(const QString &operation_id) {
    m_operation_id = operation_id;
    m_operation_id_isSet = true;
}

bool OAIDeleteServiceResponse::is_operation_id_Set() const{
    return m_operation_id_isSet;
}

bool OAIDeleteServiceResponse::is_operation_id_Valid() const{
