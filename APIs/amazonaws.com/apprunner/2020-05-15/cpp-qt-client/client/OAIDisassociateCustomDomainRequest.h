...
/*
 * OAIDisassociateCustomDomainRequest.h
 *
 * 
 */

#ifndef OAIDisassociateCustomDomainRequest_H
#define OAIDisassociateCustomDomainRequest_H
...
class OAIDisassociateCustomDomainRequest : public OAIObject {
public:
    OAIDisassociateCustomDomainRequest();
    OAIDisassociateCustomDomainRequest(QString json);
    ~OAIDisassociateCustomDomainRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateCustomDomainRequest)

#endif // OAIDisassociateCustomDomainRequest_H
