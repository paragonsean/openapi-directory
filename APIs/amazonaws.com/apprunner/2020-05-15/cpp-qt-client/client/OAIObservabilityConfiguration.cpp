...
#include "OAIObservabilityConfiguration.h"
...
OAIObservabilityConfiguration::OAIObservabilityConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObservabilityConfiguration::OAIObservabilityConfiguration() {
    this->initializeModel();
}

OAIObservabilityConfiguration::~OAIObservabilityConfiguration() {}

void OAIObservabilityConfiguration::initializeModel() {
...
void OAIObservabilityConfiguration::fromJson(QString jsonString) {
...
void OAIObservabilityConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIObservabilityConfiguration::asJson() const {
...
QJsonObject OAIObservabilityConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIObservabilityConfiguration::getObservabilityConfigurationArn() const {
    return m_observability_configuration_arn;
}
void OAIObservabilityConfiguration::setObservabilityConfigurationArn(const QString &observability_configuration_arn) {
    m_observability_configuration_arn = observability_configuration_arn;
    m_observability_configuration_arn_isSet = true;
}

bool OAIObservabilityConfiguration::is_observability_configuration_arn_Set() const{
    return m_observability_configuration_arn_isSet;
}

bool OAIObservabilityConfiguration::is_observability_configuration_arn_Valid() const{
    return m_observability_configuration_arn_isValid;
}

QString OAIObservabilityConfiguration::getObservabilityConfigurationName() const {
    return m_observability_configuration_name;
}
void OAIObservabilityConfiguration::setObservabilityConfigurationName(const QString &observability_configuration_name) {
    m_observability_configuration_name = observability_configuration_name;
    m_observability_configuration_name_isSet = true;
}

bool OAIObservabilityConfiguration::is_observability_configuration_name_Set() const{
    return m_observability_configuration_name_isSet;
}

bool OAIObservabilityConfiguration::is_observability_configuration_name_Valid() const{
    return m_observability_configuration_name_isValid;
}

OAIObservabilityConfiguration_TraceConfiguration OAIObservabilityConfiguration::getTraceConfiguration() const {
    return m_trace_configuration;
}
void OAIObservabilityConfiguration::setTraceConfiguration(const OAIObservabilityConfiguration_TraceConfiguration &trace_configuration) {
    m_trace_configuration = trace_configuration;
    m_trace_configuration_isSet = true;
}

bool OAIObservabilityConfiguration::is_trace_configuration_Set() const{
    return m_trace_configuration_isSet;
}

bool OAIObservabilityConfiguration::is_trace_configuration_Valid() const{
    return m_trace_configuration_isValid;
}

qint32 OAIObservabilityConfiguration::getObservabilityConfigurationRevision() const {
    return m_observability_configuration_revision;
}
void OAIObservabilityConfiguration::setObservabilityConfigurationRevision(const qint32 &observability_configuration_revision) {
...
bool OAIObservabilityConfiguration::is_observability_configuration_revision_Set() const{
    return m_observability_configuration_revision_isSet;
}

bool OAIObservabilityConfiguration::is_observability_configuration_revision_Valid() const{
    return m_observability_configuration_revision_isValid;
}

bool OAIObservabilityConfiguration::getLatest() const {
    return m_latest;
}
void OAIObservabilityConfiguration::setLatest(const bool &latest) {
    m_latest = latest;
    m_latest_isSet = true;
}

bool OAIObservabilityConfiguration::is_latest_Set() const{
    return m_latest_isSet;
}

bool OAIObservabilityConfiguration::is_latest_Valid() const{
    return m_latest_isValid;
}

OAIObservabilityConfigurationStatus OAIObservabilityConfiguration::getStatus() const {
    return m_status;
}
void OAIObservabilityConfiguration::setStatus(const OAIObservabilityConfigurationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIObservabilityConfiguration::is_status_Set() const{
    return m_status_isSet;
}

bool OAIObservabilityConfiguration::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIObservabilityConfiguration::getCreatedAt() const {
    return m_created_at;
}
void OAIObservabilityConfiguration::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIObservabilityConfiguration::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIObservabilityConfiguration::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIObservabilityConfiguration::getDeletedAt() const {
    return m_deleted_at;
}
void OAIObservabilityConfiguration::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIObservabilityConfiguration::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIObservabilityConfiguration::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

bool OAIObservabilityConfiguration::isSet() const {
...
bool OAIObservabilityConfiguration::isValid() const {
